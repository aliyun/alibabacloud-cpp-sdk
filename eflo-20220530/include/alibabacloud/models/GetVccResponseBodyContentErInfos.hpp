...
#ifndef ALIBABACLOUD_MODELS_GETVCCRESPONSEBODYCONTENTERINFOS_HPP_
#define ALIBABACLOUD_MODELS_GETVCCRESPONSEBODYCONTENTERINFOS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetVccResponseBodyContentErInfos& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetVccResponseBodyContentErInfos& obj) { 
    ...
    GetVccResponseBodyContentErInfos() = default ;
    GetVccResponseBodyContentErInfos(const GetVccResponseBodyContentErInfos &) = default ;
    GetVccResponseBodyContentErInfos(GetVccResponseBodyContentErInfos &&) = default ;
    GetVccResponseBodyContentErInfos(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetVccResponseBodyContentErInfos() = default ;
    GetVccResponseBodyContentErInfos& operator=(const GetVccResponseBodyContentErInfos &) = default ;
    GetVccResponseBodyContentErInfos& operator=(GetVccResponseBodyContentErInfos &&) = default ;
    ...
    inline GetVccResponseBodyContentErInfos& setConnections(int64_t connections) { DARABONBA_PTR_SET_VALUE(connections_, connections) };
    ...
    inline GetVccResponseBodyContentErInfos& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline GetVccResponseBodyContentErInfos& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline GetVccResponseBodyContentErInfos& setErId(string erId) { DARABONBA_PTR_SET_VALUE(erId_, erId) };
    ...
    inline GetVccResponseBodyContentErInfos& setErName(string erName) { DARABONBA_PTR_SET_VALUE(erName_, erName) };
    ...
    inline GetVccResponseBodyContentErInfos& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline GetVccResponseBodyContentErInfos& setMasterZoneId(string masterZoneId) { DARABONBA_PTR_SET_VALUE(masterZoneId_, masterZoneId) };
    ...
    inline GetVccResponseBodyContentErInfos& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetVccResponseBodyContentErInfos& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline GetVccResponseBodyContentErInfos& setRouteMaps(int64_t routeMaps) { DARABONBA_PTR_SET_VALUE(routeMaps_, routeMaps) };
    ...
    inline GetVccResponseBodyContentErInfos& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetVccResponseBodyContentErInfos& setTenantId(string tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
