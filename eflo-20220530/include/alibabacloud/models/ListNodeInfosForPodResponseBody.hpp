...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListNodeInfosForPodResponseBodyContent> & content() const { DARABONBA_PTR_GET_CONST(content_, vector<ListNodeInfosForPodResponseBodyContent>) };
    inline vector<ListNodeInfosForPodResponseBodyContent> content() { DARABONBA_PTR_GET(content_, vector<ListNodeInfosForPodResponseBodyContent>) };
    inline ListNodeInfosForPodResponseBody& setContent(const vector<ListNodeInfosForPodResponseBodyContent> & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListNodeInfosForPodResponseBody& setContent(vector<ListNodeInfosForPodResponseBodyContent> && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // Response body
    std::shared_ptr<vector<ListNodeInfosForPodResponseBodyContent>> content_ = nullptr;
