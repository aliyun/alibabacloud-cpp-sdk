...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstancesByNcdResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, ListInstancesByNcdResponseBodyContent) };
    inline ListInstancesByNcdResponseBodyContent content() { DARABONBA_PTR_GET(content_, ListInstancesByNcdResponseBodyContent) };
    inline ListInstancesByNcdResponseBody& setContent(const ListInstancesByNcdResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListInstancesByNcdResponseBody& setContent(ListInstancesByNcdResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<ListInstancesByNcdResponseBodyContent> content_ = nullptr;
