...
namespace Models
{
  ...
  public:
    ...
    inline const ListSubnetsResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, ListSubnetsResponseBodyContent) };
    inline ListSubnetsResponseBodyContent content() { DARABONBA_PTR_GET(content_, ListSubnetsResponseBodyContent) };
    inline ListSubnetsResponseBody& setContent(const ListSubnetsResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListSubnetsResponseBody& setContent(ListSubnetsResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<ListSubnetsResponseBodyContent> content_ = nullptr;
