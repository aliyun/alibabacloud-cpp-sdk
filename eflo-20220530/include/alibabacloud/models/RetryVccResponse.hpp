...
namespace Models
{
  ...
  public:
    ...
    inline const RetryVccResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RetryVccResponseBody) };
    inline RetryVccResponseBody getBody() { DARABONBA_PTR_GET(body_, RetryVccResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RetryVccResponseBody> body_ {};
  };
