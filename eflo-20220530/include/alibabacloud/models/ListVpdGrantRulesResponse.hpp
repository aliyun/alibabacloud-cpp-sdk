...
namespace Models
{
  ...
  public:
    ...
    inline const ListVpdGrantRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListVpdGrantRulesResponseBody) };
    inline ListVpdGrantRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListVpdGrantRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListVpdGrantRulesResponseBody> body_ {};
  };
