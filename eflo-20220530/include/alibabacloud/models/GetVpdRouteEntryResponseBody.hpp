...
namespace Models
{
  ...
  public:
    ...
    inline const GetVpdRouteEntryResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, GetVpdRouteEntryResponseBodyContent) };
    inline GetVpdRouteEntryResponseBodyContent content() { DARABONBA_PTR_GET(content_, GetVpdRouteEntryResponseBodyContent) };
    inline GetVpdRouteEntryResponseBody& setContent(const GetVpdRouteEntryResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline GetVpdRouteEntryResponseBody& setContent(GetVpdRouteEntryResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<GetVpdRouteEntryResponseBodyContent> content_ = nullptr;
