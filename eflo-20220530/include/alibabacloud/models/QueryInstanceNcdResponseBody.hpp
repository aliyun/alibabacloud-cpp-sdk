...
namespace Models
{
  ...
  public:
    ...
    inline const QueryInstanceNcdResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, QueryInstanceNcdResponseBodyContent) };
    inline QueryInstanceNcdResponseBodyContent content() { DARABONBA_PTR_GET(content_, QueryInstanceNcdResponseBodyContent) };
    inline QueryInstanceNcdResponseBody& setContent(const QueryInstanceNcdResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline QueryInstanceNcdResponseBody& setContent(QueryInstanceNcdResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<QueryInstanceNcdResponseBodyContent> content_ = nullptr;
