...
namespace Models
{
  ...
  public:
    ...
    inline const GetErRouteEntryResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, GetErRouteEntryResponseBodyContent) };
    inline GetErRouteEntryResponseBodyContent content() { DARABONBA_PTR_GET(content_, GetErRouteEntryResponseBodyContent) };
    inline GetErRouteEntryResponseBody& setContent(const GetErRouteEntryResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline GetErRouteEntryResponseBody& setContent(GetErRouteEntryResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetErRouteEntryResponseBodyContent> content_ = nullptr;
