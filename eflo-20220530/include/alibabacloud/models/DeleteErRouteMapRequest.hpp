...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->erId_ == nullptr
        && this->erRouteMapId_ == nullptr && this->erRouteMapIds_ == nullptr && this->regionId_ == nullptr; };
    ...
    inline const vector<string> & getErRouteMapIds() const { DARABONBA_PTR_GET_CONST(erRouteMapIds_, vector<string>) };
    inline vector<string> getErRouteMapIds() { DARABONBA_PTR_GET(erRouteMapIds_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> erRouteMapIds_ {};
    // The region ID.
    // 
    // This parameter is required.
