...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSubnetResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, CreateSubnetResponseBodyContent) };
    inline CreateSubnetResponseBodyContent content() { DARABONBA_PTR_GET(content_, CreateSubnetResponseBodyContent) };
    inline CreateSubnetResponseBody& setContent(const CreateSubnetResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline CreateSubnetResponseBody& setContent(CreateSubnetResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<CreateSubnetResponseBodyContent> content_ = nullptr;
