...
namespace Models
{
  ...
  public:
    ...
    inline const GetVccResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, GetVccResponseBodyContent) };
    inline GetVccResponseBodyContent content() { DARABONBA_PTR_GET(content_, GetVccResponseBodyContent) };
    inline GetVccResponseBody& setContent(const GetVccResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline GetVccResponseBody& setContent(GetVccResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<GetVccResponseBodyContent> content_ = nullptr;
