...
namespace Models
{
  ...
  public:
    ...
    inline const GetVccRouteEntryResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, GetVccRouteEntryResponseBodyContent) };
    inline GetVccRouteEntryResponseBodyContent content() { DARABONBA_PTR_GET(content_, GetVccRouteEntryResponseBodyContent) };
    inline GetVccRouteEntryResponseBody& setContent(const GetVccRouteEntryResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline GetVccRouteEntryResponseBody& setContent(GetVccRouteEntryResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<GetVccRouteEntryResponseBodyContent> content_ = nullptr;
