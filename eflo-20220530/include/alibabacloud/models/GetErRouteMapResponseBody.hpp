...
namespace Models
{
  ...
  public:
    ...
    inline const GetErRouteMapResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, GetErRouteMapResponseBodyContent) };
    inline GetErRouteMapResponseBodyContent content() { DARABONBA_PTR_GET(content_, GetErRouteMapResponseBodyContent) };
    inline GetErRouteMapResponseBody& setContent(const GetErRouteMapResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline GetErRouteMapResponseBody& setContent(GetErRouteMapResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetErRouteMapResponseBodyContent> content_ = nullptr;
