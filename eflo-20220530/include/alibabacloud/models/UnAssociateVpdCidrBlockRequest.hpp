...
#ifndef ALIBABACLOUD_MODELS_UNASSOCIATEVPDCIDRBLOCKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UNASSOCIATEVPDCIDRBLOCKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UnAssociateVpdCidrBlockRequest& obj) { 
      DARABONBA_PTR_TO_JSON(RegionId, regionId_);
      DARABONBA_PTR_TO_JSON(SecondaryCidrBlock, secondaryCidrBlock_);
      DARABONBA_PTR_TO_JSON(VpdId, vpdId_);
    };
    friend void from_json(const Darabonba::Json& j, UnAssociateVpdCidrBlockRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(RegionId, regionId_);
      DARABONBA_PTR_FROM_JSON(SecondaryCidrBlock, secondaryCidrBlock_);
      DARABONBA_PTR_FROM_JSON(VpdId, vpdId_);
    };
    UnAssociateVpdCidrBlockRequest() = default ;
    UnAssociateVpdCidrBlockRequest(const UnAssociateVpdCidrBlockRequest &) = default ;
    UnAssociateVpdCidrBlockRequest(UnAssociateVpdCidrBlockRequest &&) = default ;
    UnAssociateVpdCidrBlockRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UnAssociateVpdCidrBlockRequest() = default ;
    UnAssociateVpdCidrBlockRequest& operator=(const UnAssociateVpdCidrBlockRequest &) = default ;
    UnAssociateVpdCidrBlockRequest& operator=(UnAssociateVpdCidrBlockRequest &&) = default ;
