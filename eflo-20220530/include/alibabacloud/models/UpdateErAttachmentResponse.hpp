...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateErAttachmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateErAttachmentResponseBody) };
    inline UpdateErAttachmentResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateErAttachmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateErAttachmentResponseBody> body_ {};
  };
