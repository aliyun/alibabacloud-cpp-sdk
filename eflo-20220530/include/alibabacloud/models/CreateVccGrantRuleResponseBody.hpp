...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVccGrantRuleResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, CreateVccGrantRuleResponseBodyContent) };
    inline CreateVccGrantRuleResponseBodyContent content() { DARABONBA_PTR_GET(content_, CreateVccGrantRuleResponseBodyContent) };
    inline CreateVccGrantRuleResponseBody& setContent(const CreateVccGrantRuleResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline CreateVccGrantRuleResponseBody& setContent(CreateVccGrantRuleResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<CreateVccGrantRuleResponseBodyContent> content_ = nullptr;
