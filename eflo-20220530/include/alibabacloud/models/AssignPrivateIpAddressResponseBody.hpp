...
namespace Models
{
  ...
  public:
    ...
    inline const AssignPrivateIpAddressResponseBody::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, AssignPrivateIpAddressResponseBody::Content) };
    inline AssignPrivateIpAddressResponseBody::Content getContent() { DARABONBA_PTR_GET(content_, AssignPrivateIpAddressResponseBody::Content) };
    inline AssignPrivateIpAddressResponseBody& setContent(const AssignPrivateIpAddressResponseBody::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline AssignPrivateIpAddressResponseBody& setContent(AssignPrivateIpAddressResponseBody::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The response data.
    shared_ptr<AssignPrivateIpAddressResponseBody::Content> content_ {};
