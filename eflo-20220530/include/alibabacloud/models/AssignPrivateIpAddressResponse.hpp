...
namespace Models
{
  ...
  public:
    ...
    inline const AssignPrivateIpAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AssignPrivateIpAddressResponseBody) };
    inline AssignPrivateIpAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, AssignPrivateIpAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AssignPrivateIpAddressResponseBody> body_ {};
  };
