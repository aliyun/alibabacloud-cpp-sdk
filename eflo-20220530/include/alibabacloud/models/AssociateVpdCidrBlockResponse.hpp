...
namespace Models
{
  ...
  public:
    ...
    inline const AssociateVpdCidrBlockResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AssociateVpdCidrBlockResponseBody) };
    inline AssociateVpdCidrBlockResponseBody getBody() { DARABONBA_PTR_GET(body_, AssociateVpdCidrBlockResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AssociateVpdCidrBlockResponseBody> body_ {};
  };
