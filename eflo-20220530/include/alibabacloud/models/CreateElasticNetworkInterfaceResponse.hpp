...
namespace Models
{
  ...
  public:
    ...
    inline const CreateElasticNetworkInterfaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateElasticNetworkInterfaceResponseBody) };
    inline CreateElasticNetworkInterfaceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateElasticNetworkInterfaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateElasticNetworkInterfaceResponseBody> body_ {};
  };
