...
namespace Models
{
  ...
  public:
    ...
    inline const GetDestinationCidrBlockResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, GetDestinationCidrBlockResponseBodyContent) };
    inline GetDestinationCidrBlockResponseBodyContent content() { DARABONBA_PTR_GET(content_, GetDestinationCidrBlockResponseBodyContent) };
    inline GetDestinationCidrBlockResponseBody& setContent(const GetDestinationCidrBlockResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline GetDestinationCidrBlockResponseBody& setContent(GetDestinationCidrBlockResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // Response content
    std::shared_ptr<GetDestinationCidrBlockResponseBodyContent> content_ = nullptr;
