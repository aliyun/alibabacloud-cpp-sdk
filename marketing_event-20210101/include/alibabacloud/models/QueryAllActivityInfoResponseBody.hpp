...
#ifndef ALIBABACLOUD_MODELS_QUERYALLACTIVITYINFORESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYALLACTIVITYINFORESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryAllActivityInfoResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryAllActivityInfoResponseBody& obj) { 
    ...
    QueryAllActivityInfoResponseBody() = default ;
    QueryAllActivityInfoResponseBody(const QueryAllActivityInfoResponseBody &) = default ;
    QueryAllActivityInfoResponseBody(QueryAllActivityInfoResponseBody &&) = default ;
    QueryAllActivityInfoResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryAllActivityInfoResponseBody() = default ;
    QueryAllActivityInfoResponseBody& operator=(const QueryAllActivityInfoResponseBody &) = default ;
    QueryAllActivityInfoResponseBody& operator=(QueryAllActivityInfoResponseBody &&) = default ;
    ...
    inline QueryAllActivityInfoResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline QueryAllActivityInfoResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<QueryAllActivityInfoResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryAllActivityInfoResponseBody::Data>) };
    inline vector<QueryAllActivityInfoResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<QueryAllActivityInfoResponseBody::Data>) };
    inline QueryAllActivityInfoResponseBody& setData(const vector<QueryAllActivityInfoResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryAllActivityInfoResponseBody& setData(vector<QueryAllActivityInfoResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryAllActivityInfoResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline QueryAllActivityInfoResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline QueryAllActivityInfoResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryAllActivityInfoResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> accessDeniedDetail_ {};
    shared_ptr<string> code_ {};
    shared_ptr<vector<QueryAllActivityInfoResponseBody::Data>> data_ {};
