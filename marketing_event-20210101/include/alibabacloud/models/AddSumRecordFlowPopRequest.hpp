...
#ifndef ALIBABACLOUD_MODELS_ADDSUMRECORDFLOWPOPREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ADDSUMRECORDFLOWPOPREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddSumRecordFlowPopRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddSumRecordFlowPopRequest& obj) { 
    ...
    AddSumRecordFlowPopRequest() = default ;
    AddSumRecordFlowPopRequest(const AddSumRecordFlowPopRequest &) = default ;
    AddSumRecordFlowPopRequest(AddSumRecordFlowPopRequest &&) = default ;
    AddSumRecordFlowPopRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddSumRecordFlowPopRequest() = default ;
    AddSumRecordFlowPopRequest& operator=(const AddSumRecordFlowPopRequest &) = default ;
    AddSumRecordFlowPopRequest& operator=(AddSumRecordFlowPopRequest &&) = default ;
