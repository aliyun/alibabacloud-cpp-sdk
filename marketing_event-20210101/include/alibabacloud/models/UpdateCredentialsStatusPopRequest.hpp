...
namespace Models
{
  ...
  public:
    ...
    inline string getProxyRecipientName() const { DARABONBA_PTR_GET_DEFAULT(proxyRecipientName_, "") };
    ...
    inline string getProxyRecipientPhoneNumber() const { DARABONBA_PTR_GET_DEFAULT(proxyRecipientPhoneNumber_, "") };
    ...
    inline string getReceiptLocation() const { DARABONBA_PTR_GET_DEFAULT(receiptLocation_, "") };
  ...
  protected:
    ...
    shared_ptr<string> proxyRecipientName_ {};
    shared_ptr<string> proxyRecipientPhoneNumber_ {};
    shared_ptr<string> receiptLocation_ {};
