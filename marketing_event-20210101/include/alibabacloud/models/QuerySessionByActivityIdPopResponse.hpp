...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySessionByActivityIdPopResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QuerySessionByActivityIdPopResponseBody) };
    inline QuerySessionByActivityIdPopResponseBody getBody() { DARABONBA_PTR_GET(body_, QuerySessionByActivityIdPopResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QuerySessionByActivityIdPopResponseBody> body_ {};
  };
