...
namespace Models
{
  ...
  public:
    ...
    inline const CheckNFCBindPopResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CheckNFCBindPopResponseBodyData) };
    inline CheckNFCBindPopResponseBodyData data() { DARABONBA_PTR_GET(data_, CheckNFCBindPopResponseBodyData) };
    inline CheckNFCBindPopResponseBody& setData(const CheckNFCBindPopResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CheckNFCBindPopResponseBody& setData(CheckNFCBindPopResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CheckNFCBindPopResponseBodyData> data_ = nullptr;
