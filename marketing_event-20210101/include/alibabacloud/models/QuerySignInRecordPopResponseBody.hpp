...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QuerySignInRecordPopResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QuerySignInRecordPopResponseBodyData>) };
    inline vector<QuerySignInRecordPopResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QuerySignInRecordPopResponseBodyData>) };
    inline QuerySignInRecordPopResponseBody& setData(const vector<QuerySignInRecordPopResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QuerySignInRecordPopResponseBody& setData(vector<QuerySignInRecordPopResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QuerySignInRecordPopResponseBodyData>> data_ = nullptr;
