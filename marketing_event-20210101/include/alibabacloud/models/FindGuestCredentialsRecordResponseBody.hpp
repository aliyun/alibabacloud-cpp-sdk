...
#ifndef ALIBABACLOUD_MODELS_FINDGUESTCREDENTIALSRECORDRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_FINDGUESTCREDENTIALSRECORDRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FindGuestCredentialsRecordResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FindGuestCredentialsRecordResponseBody& obj) { 
    ...
    FindGuestCredentialsRecordResponseBody() = default ;
    FindGuestCredentialsRecordResponseBody(const FindGuestCredentialsRecordResponseBody &) = default ;
    FindGuestCredentialsRecordResponseBody(FindGuestCredentialsRecordResponseBody &&) = default ;
    FindGuestCredentialsRecordResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FindGuestCredentialsRecordResponseBody() = default ;
    FindGuestCredentialsRecordResponseBody& operator=(const FindGuestCredentialsRecordResponseBody &) = default ;
    FindGuestCredentialsRecordResponseBody& operator=(FindGuestCredentialsRecordResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->admin_ == nullptr
      ...
      inline       const Darabonba::Json & getAdmin() const { DARABONBA_GET(admin_) };
      Darabonba::Json & getAdmin() { DARABONBA_GET(admin_) };
      inline Data& setAdmin(const Darabonba::Json & admin) { DARABONBA_SET_VALUE(admin_, admin) };
      inline Data& setAdmin(Darabonba::Json && admin) { DARABONBA_SET_RVALUE(admin_, admin) };
      ...
      void deleteChannelId() { this->channelId_ = nullptr;};
      inline int64_t getChannelId() const { DARABONBA_PTR_GET_DEFAULT(channelId_, 0L) };
      inline Data& setChannelId(int64_t channelId) { DARABONBA_PTR_SET_VALUE(channelId_, channelId) };
      ...
      inline string getCredentialsCode() const { DARABONBA_PTR_GET_DEFAULT(credentialsCode_, "") };
      inline Data& setCredentialsCode(string credentialsCode) { DARABONBA_PTR_SET_VALUE(credentialsCode_, credentialsCode) };
      ...
      inline string getCredentialsName() const { DARABONBA_PTR_GET_DEFAULT(credentialsName_, "") };
      inline Data& setCredentialsName(string credentialsName) { DARABONBA_PTR_SET_VALUE(credentialsName_, credentialsName) };
    ...
    protected:
      Darabonba::Json admin_ {};
      shared_ptr<int64_t> channelId_ {};
      shared_ptr<Data::ChannelLevelInfo> channelLevelInfo_ {};
      shared_ptr<string> companyName_ {};
      shared_ptr<string> credentialsCode_ {};
      shared_ptr<string> credentialsName_ {};
    ...
    inline const vector<FindGuestCredentialsRecordResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<FindGuestCredentialsRecordResponseBody::Data>) };
    inline vector<FindGuestCredentialsRecordResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<FindGuestCredentialsRecordResponseBody::Data>) };
    inline FindGuestCredentialsRecordResponseBody& setData(const vector<FindGuestCredentialsRecordResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline FindGuestCredentialsRecordResponseBody& setData(vector<FindGuestCredentialsRecordResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline FindGuestCredentialsRecordResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline FindGuestCredentialsRecordResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline FindGuestCredentialsRecordResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline FindGuestCredentialsRecordResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<vector<FindGuestCredentialsRecordResponseBody::Data>> data_ {};
