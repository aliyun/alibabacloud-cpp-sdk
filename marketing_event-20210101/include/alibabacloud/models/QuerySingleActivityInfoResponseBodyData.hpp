...
#ifndef ALIBABACLOUD_MODELS_QUERYSINGLEACTIVITYINFORESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_QUERYSINGLEACTIVITYINFORESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QuerySingleActivityInfoResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QuerySingleActivityInfoResponseBodyData& obj) { 
    ...
    QuerySingleActivityInfoResponseBodyData() = default ;
    QuerySingleActivityInfoResponseBodyData(const QuerySingleActivityInfoResponseBodyData &) = default ;
    QuerySingleActivityInfoResponseBodyData(QuerySingleActivityInfoResponseBodyData &&) = default ;
    QuerySingleActivityInfoResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QuerySingleActivityInfoResponseBodyData() = default ;
    QuerySingleActivityInfoResponseBodyData& operator=(const QuerySingleActivityInfoResponseBodyData &) = default ;
    QuerySingleActivityInfoResponseBodyData& operator=(QuerySingleActivityInfoResponseBodyData &&) = default ;
    ...
    inline QuerySingleActivityInfoResponseBodyData& setActivityId(int64_t activityId) { DARABONBA_PTR_SET_VALUE(activityId_, activityId) };
    ...
    inline QuerySingleActivityInfoResponseBodyData& setChannelName(string channelName) { DARABONBA_PTR_SET_VALUE(channelName_, channelName) };
    ...
    inline QuerySingleActivityInfoResponseBodyData& setCompanyName(string companyName) { DARABONBA_PTR_SET_VALUE(companyName_, companyName) };
    ...
    inline QuerySingleActivityInfoResponseBodyData& setCustomerName(string customerName) { DARABONBA_PTR_SET_VALUE(customerName_, customerName) };
    ...
    inline QuerySingleActivityInfoResponseBodyData& setEmail(string email) { DARABONBA_PTR_SET_VALUE(email_, email) };
    ...
    inline QuerySingleActivityInfoResponseBodyData& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline QuerySingleActivityInfoResponseBodyData& setIsVipCustomer(string isVipCustomer) { DARABONBA_PTR_SET_VALUE(isVipCustomer_, isVipCustomer) };
    ...
    inline QuerySingleActivityInfoResponseBodyData& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline QuerySingleActivityInfoResponseBodyData& setQRCode(string QRCode) { DARABONBA_PTR_SET_VALUE(QRCode_, QRCode) };
    ...
    inline QuerySingleActivityInfoResponseBodyData& setReportFields(string reportFields) { DARABONBA_PTR_SET_VALUE(reportFields_, reportFields) };
