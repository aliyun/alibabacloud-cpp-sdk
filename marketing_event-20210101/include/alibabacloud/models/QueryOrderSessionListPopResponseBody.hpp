...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryOrderSessionListPopResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryOrderSessionListPopResponseBodyData>) };
    inline vector<QueryOrderSessionListPopResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryOrderSessionListPopResponseBodyData>) };
    inline QueryOrderSessionListPopResponseBody& setData(const vector<QueryOrderSessionListPopResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryOrderSessionListPopResponseBody& setData(vector<QueryOrderSessionListPopResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryOrderSessionListPopResponseBodyData>> data_ = nullptr;
