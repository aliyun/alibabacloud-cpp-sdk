...
namespace Models
{
  ...
  public:
    ...
    inline const vector<FindGuestTicketRecordResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<FindGuestTicketRecordResponseBodyData>) };
    inline vector<FindGuestTicketRecordResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<FindGuestTicketRecordResponseBodyData>) };
    inline FindGuestTicketRecordResponseBody& setData(const vector<FindGuestTicketRecordResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline FindGuestTicketRecordResponseBody& setData(vector<FindGuestTicketRecordResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<FindGuestTicketRecordResponseBodyData>> data_ = nullptr;
