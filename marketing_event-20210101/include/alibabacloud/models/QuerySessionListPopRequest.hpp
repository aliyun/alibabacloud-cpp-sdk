...
#ifndef ALIBABACLOUD_MODELS_QUERYSESSIONLISTPOPREQUEST_HPP_
#define ALIBABACLOUD_MODELS_QUERYSESSIONLISTPOPREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QuerySessionListPopRequest& obj) { 
      DARABONBA_PTR_TO_JSON(ActivityId, activityId_);
      DARABONBA_PTR_TO_JSON(NfcId, nfcId_);
    };
    friend void from_json(const Darabonba::Json& j, QuerySessionListPopRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(ActivityId, activityId_);
      DARABONBA_PTR_FROM_JSON(NfcId, nfcId_);
    };
    QuerySessionListPopRequest() = default ;
    QuerySessionListPopRequest(const QuerySessionListPopRequest &) = default ;
    QuerySessionListPopRequest(QuerySessionListPopRequest &&) = default ;
    QuerySessionListPopRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QuerySessionListPopRequest() = default ;
    QuerySessionListPopRequest& operator=(const QuerySessionListPopRequest &) = default ;
    QuerySessionListPopRequest& operator=(QuerySessionListPopRequest &&) = default ;
