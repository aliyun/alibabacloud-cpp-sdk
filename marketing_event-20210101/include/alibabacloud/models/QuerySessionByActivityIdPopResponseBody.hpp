...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QuerySessionByActivityIdPopResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QuerySessionByActivityIdPopResponseBodyData>) };
    inline vector<QuerySessionByActivityIdPopResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QuerySessionByActivityIdPopResponseBodyData>) };
    inline QuerySessionByActivityIdPopResponseBody& setData(const vector<QuerySessionByActivityIdPopResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QuerySessionByActivityIdPopResponseBody& setData(vector<QuerySessionByActivityIdPopResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QuerySessionByActivityIdPopResponseBodyData>> data_ = nullptr;
