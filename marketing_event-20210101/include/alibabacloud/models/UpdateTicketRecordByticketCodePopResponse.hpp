...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTicketRecordByticketCodePopResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTicketRecordByticketCodePopResponseBody) };
    inline UpdateTicketRecordByticketCodePopResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTicketRecordByticketCodePopResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTicketRecordByticketCodePopResponseBody> body_ {};
  };
