...
namespace Models
{
  ...
  public:
    ...
    inline const CheckNFCBindPopResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckNFCBindPopResponseBody) };
    inline CheckNFCBindPopResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckNFCBindPopResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckNFCBindPopResponseBody> body_ {};
  };
