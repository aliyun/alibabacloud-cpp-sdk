...
namespace Models
{
  ...
  public:
    ...
    inline const SyncSignInInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SyncSignInInfoResponseBody) };
    inline SyncSignInInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, SyncSignInInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SyncSignInInfoResponseBody> body_ {};
  };
