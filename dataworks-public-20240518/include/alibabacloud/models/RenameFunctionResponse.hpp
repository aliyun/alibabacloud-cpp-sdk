...
namespace Models
{
  ...
  public:
    ...
    inline const RenameFunctionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RenameFunctionResponseBody) };
    inline RenameFunctionResponseBody getBody() { DARABONBA_PTR_GET(body_, RenameFunctionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RenameFunctionResponseBody> body_ {};
  };
