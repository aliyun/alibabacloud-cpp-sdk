...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetFileResponseBodyData) };
    inline GetFileResponseBodyData data() { DARABONBA_PTR_GET(data_, GetFileResponseBodyData) };
    inline GetFileResponseBody& setData(const GetFileResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetFileResponseBody& setData(GetFileResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetFileResponseBodyData> data_ = nullptr;
    // The error code.
