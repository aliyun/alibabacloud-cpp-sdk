  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline Parameters& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
        ...
        inline Parameters& setCreateUser(string createUser) { DARABONBA_PTR_SET_VALUE(createUser_, createUser) };
        ...
        inline Parameters& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
        ...
        inline Parameters& setModifyTime(int64_t modifyTime) { DARABONBA_PTR_SET_VALUE(modifyTime_, modifyTime) };
        ...
        inline Parameters& setModifyUser(string modifyUser) { DARABONBA_PTR_SET_VALUE(modifyUser_, modifyUser) };
        ...
        inline Parameters& setOwner(string owner) { DARABONBA_PTR_SET_VALUE(owner_, owner) };
        ...
        inline Parameters& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };


        // properties Field Functions 
        bool hasProperties() const { return this->properties_ != nullptr;};
        void deleteProperties() { this->properties_ = nullptr;};
        inline const vector<Parameters::Properties> & getProperties() const { DARABONBA_PTR_GET_CONST(properties_, vector<Parameters::Properties>) };
        inline vector<Parameters::Properties> getProperties() { DARABONBA_PTR_GET(properties_, vector<Parameters::Properties>) };
        inline Parameters& setProperties(const vector<Parameters::Properties> & properties) { DARABONBA_PTR_SET_VALUE(properties_, properties) };
        inline Parameters& setProperties(vector<Parameters::Properties> && properties) { DARABONBA_PTR_SET_RVALUE(properties_, properties) };
        ...
        inline Parameters& setScope(string scope) { DARABONBA_PTR_SET_VALUE(scope_, scope) };
        ...
        inline Parameters& setVersion(int32_t version) { DARABONBA_PTR_SET_VALUE(version_, version) };
      ...
      virtual bool empty() const override { return this->pageNumber_ == nullptr
        && this->pageSize_ == nullptr && this->parameters_ == nullptr && this->totalCount_ == nullptr; };
      ...
      inline const vector<PagingInfo::Parameters> & getParameters() const { DARABONBA_PTR_GET_CONST(parameters_, vector<PagingInfo::Parameters>) };
      inline vector<PagingInfo::Parameters> getParameters() { DARABONBA_PTR_GET(parameters_, vector<PagingInfo::Parameters>) };
      inline PagingInfo& setParameters(const vector<PagingInfo::Parameters> & parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
      inline PagingInfo& setParameters(vector<PagingInfo::Parameters> && parameters) { DARABONBA_PTR_SET_RVALUE(parameters_, parameters) };
    ...
    inline const ListParametersResponseBody::PagingInfo & getPagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListParametersResponseBody::PagingInfo) };
    inline ListParametersResponseBody::PagingInfo getPagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListParametersResponseBody::PagingInfo) };
    inline ListParametersResponseBody& setPagingInfo(const ListParametersResponseBody::PagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListParametersResponseBody& setPagingInfo(ListParametersResponseBody::PagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
