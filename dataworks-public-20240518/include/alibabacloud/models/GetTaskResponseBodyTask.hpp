...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->baselineId_ == nullptr
        && return this->createTime_ == nullptr && return this->createUser_ == nullptr && return this->dataSource_ == nullptr && return this->dependencies_ == nullptr && return this->description_ == nullptr
        && return this->envType_ == nullptr && return this->id_ == nullptr && return this->inputs_ == nullptr && return this->instanceMode_ == nullptr && return this->modifyTime_ == nullptr
        && return this->modifyUser_ == nullptr && return this->name_ == nullptr && return this->outputs_ == nullptr && return this->owner_ == nullptr && return this->priority_ == nullptr
        && return this->projectEnv_ == nullptr && return this->projectId_ == nullptr && return this->rerunInterval_ == nullptr && return this->rerunMode_ == nullptr && return this->rerunTimes_ == nullptr
        && return this->runtimeResource_ == nullptr && return this->script_ == nullptr && return this->subTasks_ == nullptr && return this->tags_ == nullptr && return this->timeout_ == nullptr
