...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline PagingInfo& setColumns(const vector<Column> & columns) { DARABONBA_PTR_SET_VALUE(columns_, columns) };
      inline PagingInfo& setColumns(vector<Column> && columns) { DARABONBA_PTR_SET_RVALUE(columns_, columns) };
    ...
    inline const ListColumnsResponseBody::PagingInfo & getPagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListColumnsResponseBody::PagingInfo) };
    inline ListColumnsResponseBody::PagingInfo getPagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListColumnsResponseBody::PagingInfo) };
    inline ListColumnsResponseBody& setPagingInfo(const ListColumnsResponseBody::PagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListColumnsResponseBody& setPagingInfo(ListColumnsResponseBody::PagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
