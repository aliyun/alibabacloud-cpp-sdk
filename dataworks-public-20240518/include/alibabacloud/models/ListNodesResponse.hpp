...
namespace Models
{
  ...
  public:
    ...
    inline const ListNodesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNodesResponseBody) };
    inline ListNodesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNodesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNodesResponseBody> body_ {};
  };
