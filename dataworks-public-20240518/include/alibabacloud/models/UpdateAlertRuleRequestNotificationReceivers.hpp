...
#ifndef ALIBABACLOUD_MODELS_UPDATEALERTRULEREQUESTNOTIFICATIONRECEIVERS_HPP_
#define ALIBABACLOUD_MODELS_UPDATEALERTRULEREQUESTNOTIFICATIONRECEIVERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateAlertRuleRequestNotificationReceivers& obj) { 
      DARABONBA_PTR_TO_JSON(Extension, extension_);
      DARABONBA_PTR_TO_JSON(ReceiverType, receiverType_);
      DARABONBA_PTR_TO_JSON(ReceiverValues, receiverValues_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateAlertRuleRequestNotificationReceivers& obj) { 
      DARABONBA_PTR_FROM_JSON(Extension, extension_);
      DARABONBA_PTR_FROM_JSON(ReceiverType, receiverType_);
      DARABONBA_PTR_FROM_JSON(ReceiverValues, receiverValues_);
    };
    UpdateAlertRuleRequestNotificationReceivers() = default ;
    UpdateAlertRuleRequestNotificationReceivers(const UpdateAlertRuleRequestNotificationReceivers &) = default ;
    UpdateAlertRuleRequestNotificationReceivers(UpdateAlertRuleRequestNotificationReceivers &&) = default ;
    UpdateAlertRuleRequestNotificationReceivers(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateAlertRuleRequestNotificationReceivers() = default ;
    UpdateAlertRuleRequestNotificationReceivers& operator=(const UpdateAlertRuleRequestNotificationReceivers &) = default ;
    UpdateAlertRuleRequestNotificationReceivers& operator=(UpdateAlertRuleRequestNotificationReceivers &&) = default ;
    ...
    inline UpdateAlertRuleRequestNotificationReceivers& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
    ...
    inline UpdateAlertRuleRequestNotificationReceivers& setReceiverType(string receiverType) { DARABONBA_PTR_SET_VALUE(receiverType_, receiverType) };
    ...
    inline UpdateAlertRuleRequestNotificationReceivers& setReceiverValues(const vector<string> & receiverValues) { DARABONBA_PTR_SET_VALUE(receiverValues_, receiverValues) };
    inline UpdateAlertRuleRequestNotificationReceivers& setReceiverValues(vector<string> && receiverValues) { DARABONBA_PTR_SET_RVALUE(receiverValues_, receiverValues) };
