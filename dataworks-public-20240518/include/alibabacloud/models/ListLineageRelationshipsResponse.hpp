...
namespace Models
{
  ...
  public:
    ...
    inline const ListLineageRelationshipsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLineageRelationshipsResponseBody) };
    inline ListLineageRelationshipsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLineageRelationshipsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLineageRelationshipsResponseBody> body_ {};
  };
