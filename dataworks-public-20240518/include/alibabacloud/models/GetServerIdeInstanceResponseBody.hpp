...
#ifndef ALIBABACLOUD_MODELS_GETSERVERIDEINSTANCERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETSERVERIDEINSTANCERESPONSEBODY_HPP_
...
namespace Models
{
  class GetServerIdeInstanceResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetServerIdeInstanceResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Instance, instance_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetServerIdeInstanceResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Instance, instance_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    GetServerIdeInstanceResponseBody() = default ;
    GetServerIdeInstanceResponseBody(const GetServerIdeInstanceResponseBody &) = default ;
    GetServerIdeInstanceResponseBody(GetServerIdeInstanceResponseBody &&) = default ;
    GetServerIdeInstanceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetServerIdeInstanceResponseBody() = default ;
    GetServerIdeInstanceResponseBody& operator=(const GetServerIdeInstanceResponseBody &) = default ;
    GetServerIdeInstanceResponseBody& operator=(GetServerIdeInstanceResponseBody &&) = default ;
    ...
    public:
      ...
      inline const Instance::CredentialConfig & getCredentialConfig() const { DARABONBA_PTR_GET_CONST(credentialConfig_, Instance::CredentialConfig) };
      inline Instance::CredentialConfig getCredentialConfig() { DARABONBA_PTR_GET(credentialConfig_, Instance::CredentialConfig) };
      inline Instance& setCredentialConfig(const Instance::CredentialConfig & credentialConfig) { DARABONBA_PTR_SET_VALUE(credentialConfig_, credentialConfig) };
      inline Instance& setCredentialConfig(Instance::CredentialConfig && credentialConfig) { DARABONBA_PTR_SET_RVALUE(credentialConfig_, credentialConfig) };
      ...
      inline Instance& setCu(int32_t cu) { DARABONBA_PTR_SET_VALUE(cu_, cu) };


      // datasets Field Functions 
      bool hasDatasets() const { return this->datasets_ != nullptr;};
      void deleteDatasets() { this->datasets_ = nullptr;};
      inline const vector<Instance::Datasets> & getDatasets() const { DARABONBA_PTR_GET_CONST(datasets_, vector<Instance::Datasets>) };
      inline vector<Instance::Datasets> getDatasets() { DARABONBA_PTR_GET(datasets_, vector<Instance::Datasets>) };
      inline Instance& setDatasets(const vector<Instance::Datasets> & datasets) { DARABONBA_PTR_SET_VALUE(datasets_, datasets) };
      inline Instance& setDatasets(vector<Instance::Datasets> && datasets) { DARABONBA_PTR_SET_RVALUE(datasets_, datasets) };
      ...
      inline Instance& setFailReason(string failReason) { DARABONBA_PTR_SET_VALUE(failReason_, failReason) };
      ...
      inline Instance& setImageName(string imageName) { DARABONBA_PTR_SET_VALUE(imageName_, imageName) };
      ...
      inline Instance& setImageUrl(string imageUrl) { DARABONBA_PTR_SET_VALUE(imageUrl_, imageUrl) };
      ...
      inline Instance& setOwnerId(string ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
      ...
      inline Instance& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
      ...
      inline Instance& setProjectName(string projectName) { DARABONBA_PTR_SET_VALUE(projectName_, projectName) };
      ...
      inline Instance& setResourceGroupId(int64_t resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
      ...
      inline Instance& setResourceGroupName(string resourceGroupName) { DARABONBA_PTR_SET_VALUE(resourceGroupName_, resourceGroupName) };
      ...
      inline Instance& setUpdateTime(int64_t updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };


      // userVpc Field Functions 
      bool hasUserVpc() const { return this->userVpc_ != nullptr;};
      void deleteUserVpc() { this->userVpc_ = nullptr;};
      inline const Instance::UserVpc & getUserVpc() const { DARABONBA_PTR_GET_CONST(userVpc_, Instance::UserVpc) };
      inline Instance::UserVpc getUserVpc() { DARABONBA_PTR_GET(userVpc_, Instance::UserVpc) };
      inline Instance& setUserVpc(const Instance::UserVpc & userVpc) { DARABONBA_PTR_SET_VALUE(userVpc_, userVpc) };
      inline Instance& setUserVpc(Instance::UserVpc && userVpc) { DARABONBA_PTR_SET_RVALUE(userVpc_, userVpc) };
    ...
    protected:
      ...
      shared_ptr<Instance::UserVpc> userVpc_ {};
    };
    ...
    inline const GetServerIdeInstanceResponseBody::Instance & getInstance() const { DARABONBA_PTR_GET_CONST(instance_, GetServerIdeInstanceResponseBody::Instance) };
    inline GetServerIdeInstanceResponseBody::Instance getInstance() { DARABONBA_PTR_GET(instance_, GetServerIdeInstanceResponseBody::Instance) };
    inline GetServerIdeInstanceResponseBody& setInstance(const GetServerIdeInstanceResponseBody::Instance & instance) { DARABONBA_PTR_SET_VALUE(instance_, instance) };
    inline GetServerIdeInstanceResponseBody& setInstance(GetServerIdeInstanceResponseBody::Instance && instance) { DARABONBA_PTR_SET_RVALUE(instance_, instance) };
    ...
    inline GetServerIdeInstanceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the personal development environment instance.
    shared_ptr<GetServerIdeInstanceResponseBody::Instance> instance_ {};
    // The request ID.
