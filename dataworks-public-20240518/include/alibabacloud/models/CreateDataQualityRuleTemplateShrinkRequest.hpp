...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->checkingConfigShrink_ == nullptr
        && return this->directoryPath_ == nullptr && return this->name_ == nullptr && return this->projectId_ == nullptr && return this->samplingConfigShrink_ == nullptr && return this->visibleScope_ == nullptr; };
