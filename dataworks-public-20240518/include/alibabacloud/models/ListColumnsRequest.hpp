...
namespace Models
{
  ...
  public:
    ...
    inline ListColumnsRequest& setOrder(string order) { DARABONBA_PTR_SET_VALUE(order_, order) };
    ...
    inline ListColumnsRequest& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListColumnsRequest& setSortBy(string sortBy) { DARABONBA_PTR_SET_VALUE(sortBy_, sortBy) };
