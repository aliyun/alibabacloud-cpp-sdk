...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataQualityEvaluationTaskInstancesResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListDataQualityEvaluationTaskInstancesResponseBodyPagingInfo) };
    inline ListDataQualityEvaluationTaskInstancesResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListDataQualityEvaluationTaskInstancesResponseBodyPagingInfo) };
    inline ListDataQualityEvaluationTaskInstancesResponseBody& setPagingInfo(const ListDataQualityEvaluationTaskInstancesResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListDataQualityEvaluationTaskInstancesResponseBody& setPagingInfo(ListDataQualityEvaluationTaskInstancesResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataQualityEvaluationTaskInstancesResponseBodyPagingInfo> pagingInfo_ = nullptr;
    // The request ID.
