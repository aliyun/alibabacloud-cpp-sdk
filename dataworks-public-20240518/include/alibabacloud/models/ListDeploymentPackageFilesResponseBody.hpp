...
namespace Models
{
  ...
  public:
    ...
    inline const ListDeploymentPackageFilesResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListDeploymentPackageFilesResponseBodyPagingInfo) };
    inline ListDeploymentPackageFilesResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListDeploymentPackageFilesResponseBodyPagingInfo) };
    inline ListDeploymentPackageFilesResponseBody& setPagingInfo(const ListDeploymentPackageFilesResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListDeploymentPackageFilesResponseBody& setPagingInfo(ListDeploymentPackageFilesResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ListDeploymentPackageFilesResponseBodyPagingInfo> pagingInfo_ = nullptr;
    // The request ID.
