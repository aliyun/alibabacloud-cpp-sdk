...
namespace Models
{
  ...
  public:
    ...
    inline const ListDIJobEventsResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListDIJobEventsResponseBodyPagingInfo) };
    inline ListDIJobEventsResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListDIJobEventsResponseBodyPagingInfo) };
    inline ListDIJobEventsResponseBody& setPagingInfo(const ListDIJobEventsResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListDIJobEventsResponseBody& setPagingInfo(ListDIJobEventsResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ListDIJobEventsResponseBodyPagingInfo> pagingInfo_ = nullptr;
