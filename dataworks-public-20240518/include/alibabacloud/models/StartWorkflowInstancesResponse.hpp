...
namespace Models
{
  ...
  public:
    ...
    inline const StartWorkflowInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartWorkflowInstancesResponseBody) };
    inline StartWorkflowInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, StartWorkflowInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartWorkflowInstancesResponseBody> body_ {};
  };
