...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataQualityRulesShrink_ == nullptr
        && return this->dataSourceId_ == nullptr && return this->description_ == nullptr && return this->hooksShrink_ == nullptr && return this->id_ == nullptr && return this->name_ == nullptr
        && return this->notificationsShrink_ == nullptr && return this->projectId_ == nullptr && return this->runtimeConf_ == nullptr && return this->targetShrink_ == nullptr && return this->triggerShrink_ == nullptr; };
