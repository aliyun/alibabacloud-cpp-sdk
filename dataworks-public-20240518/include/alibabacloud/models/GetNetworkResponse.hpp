...
namespace Models
{
  ...
  public:
    ...
    inline const GetNetworkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetNetworkResponseBody) };
    inline GetNetworkResponseBody getBody() { DARABONBA_PTR_GET(body_, GetNetworkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetNetworkResponseBody> body_ {};
  };
