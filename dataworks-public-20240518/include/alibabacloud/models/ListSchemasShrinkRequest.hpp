...
#ifndef ALIBABACLOUD_MODELS_LISTSCHEMASSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTSCHEMASSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListSchemasShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListSchemasShrinkRequest& obj) { 
    ...
    ListSchemasShrinkRequest() = default ;
    ListSchemasShrinkRequest(const ListSchemasShrinkRequest &) = default ;
    ListSchemasShrinkRequest(ListSchemasShrinkRequest &&) = default ;
    ListSchemasShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListSchemasShrinkRequest() = default ;
    ListSchemasShrinkRequest& operator=(const ListSchemasShrinkRequest &) = default ;
    ListSchemasShrinkRequest& operator=(ListSchemasShrinkRequest &&) = default ;
    ...
    inline ListSchemasShrinkRequest& setComment(string comment) { DARABONBA_PTR_SET_VALUE(comment_, comment) };
    ...
    inline ListSchemasShrinkRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListSchemasShrinkRequest& setOrder(string order) { DARABONBA_PTR_SET_VALUE(order_, order) };
    ...
    inline ListSchemasShrinkRequest& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListSchemasShrinkRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListSchemasShrinkRequest& setParentMetaEntityId(string parentMetaEntityId) { DARABONBA_PTR_SET_VALUE(parentMetaEntityId_, parentMetaEntityId) };
    ...
    inline ListSchemasShrinkRequest& setSortBy(string sortBy) { DARABONBA_PTR_SET_VALUE(sortBy_, sortBy) };
    ...
    inline ListSchemasShrinkRequest& setTypesShrink(string typesShrink) { DARABONBA_PTR_SET_VALUE(typesShrink_, typesShrink) };
