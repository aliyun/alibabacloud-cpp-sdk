...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoStartEnabled_ == nullptr
        && this->comment_ == nullptr && this->defaultRunPropertiesShrink_ == nullptr && this->envType_ == nullptr && this->name_ == nullptr && this->periodsShrink_ == nullptr
        && this->projectId_ == nullptr && this->tagCreationPolicy_ == nullptr && this->tagsShrink_ == nullptr && this->taskParameters_ == nullptr && this->type_ == nullptr
    ...
    inline string getDefaultRunPropertiesShrink() const { DARABONBA_PTR_GET_DEFAULT(defaultRunPropertiesShrink_, "") };
    ...
    inline string getPeriodsShrink() const { DARABONBA_PTR_GET_DEFAULT(periodsShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> periodsShrink_ {};
    // The project ID.
    // 
    // This parameter is required.
