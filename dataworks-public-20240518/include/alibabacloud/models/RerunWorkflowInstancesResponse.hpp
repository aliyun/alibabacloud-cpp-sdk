...
namespace Models
{
  ...
  public:
    ...
    inline const RerunWorkflowInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RerunWorkflowInstancesResponseBody) };
    inline RerunWorkflowInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, RerunWorkflowInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RerunWorkflowInstancesResponseBody> body_ {};
  };
