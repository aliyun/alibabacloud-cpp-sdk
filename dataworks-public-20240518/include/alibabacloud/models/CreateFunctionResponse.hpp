...
namespace Models
{
  ...
  public:
    ...
    inline const CreateFunctionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateFunctionResponseBody) };
    inline CreateFunctionResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateFunctionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateFunctionResponseBody> body_ {};
  };
