...
namespace Models
{
  ...
  public:
    ...
    inline const ListWorkflowInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListWorkflowInstancesResponseBody) };
    inline ListWorkflowInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListWorkflowInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListWorkflowInstancesResponseBody> body_ {};
  };
