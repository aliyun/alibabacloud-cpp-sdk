...
#ifndef ALIBABACLOUD_MODELS_LISTDEPLOYMENTPACKAGEFILESSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTDEPLOYMENTPACKAGEFILESSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDeploymentPackageFilesShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDeploymentPackageFilesShrinkRequest& obj) { 
    ...
    ListDeploymentPackageFilesShrinkRequest() = default ;
    ListDeploymentPackageFilesShrinkRequest(const ListDeploymentPackageFilesShrinkRequest &) = default ;
    ListDeploymentPackageFilesShrinkRequest(ListDeploymentPackageFilesShrinkRequest &&) = default ;
    ListDeploymentPackageFilesShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDeploymentPackageFilesShrinkRequest() = default ;
    ListDeploymentPackageFilesShrinkRequest& operator=(const ListDeploymentPackageFilesShrinkRequest &) = default ;
    ListDeploymentPackageFilesShrinkRequest& operator=(ListDeploymentPackageFilesShrinkRequest &&) = default ;
    ...
    inline ListDeploymentPackageFilesShrinkRequest& setBusinessId(int64_t businessId) { DARABONBA_PTR_SET_VALUE(businessId_, businessId) };
    ...
    inline ListDeploymentPackageFilesShrinkRequest& setChangeType(int32_t changeType) { DARABONBA_PTR_SET_VALUE(changeType_, changeType) };
    ...
    inline ListDeploymentPackageFilesShrinkRequest& setCommitFrom(string commitFrom) { DARABONBA_PTR_SET_VALUE(commitFrom_, commitFrom) };
    ...
    inline ListDeploymentPackageFilesShrinkRequest& setCommitTo(string commitTo) { DARABONBA_PTR_SET_VALUE(commitTo_, commitTo) };
    ...
    inline ListDeploymentPackageFilesShrinkRequest& setCommitUserId(string commitUserId) { DARABONBA_PTR_SET_VALUE(commitUserId_, commitUserId) };
    ...
    inline ListDeploymentPackageFilesShrinkRequest& setFileIdsShrink(string fileIdsShrink) { DARABONBA_PTR_SET_VALUE(fileIdsShrink_, fileIdsShrink) };
    ...
    inline ListDeploymentPackageFilesShrinkRequest& setFileName(string fileName) { DARABONBA_PTR_SET_VALUE(fileName_, fileName) };
    ...
    inline ListDeploymentPackageFilesShrinkRequest& setFileType(int32_t fileType) { DARABONBA_PTR_SET_VALUE(fileType_, fileType) };
    ...
    inline ListDeploymentPackageFilesShrinkRequest& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListDeploymentPackageFilesShrinkRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListDeploymentPackageFilesShrinkRequest& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline ListDeploymentPackageFilesShrinkRequest& setSolutionId(int64_t solutionId) { DARABONBA_PTR_SET_VALUE(solutionId_, solutionId) };
