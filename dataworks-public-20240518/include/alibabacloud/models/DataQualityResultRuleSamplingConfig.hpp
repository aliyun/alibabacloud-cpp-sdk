...
#ifndef ALIBABACLOUD_MODELS_DATAQUALITYRESULTRULESAMPLINGCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DATAQUALITYRESULTRULESAMPLINGCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DataQualityResultRuleSamplingConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DataQualityResultRuleSamplingConfig& obj) { 
    ...
    DataQualityResultRuleSamplingConfig() = default ;
    DataQualityResultRuleSamplingConfig(const DataQualityResultRuleSamplingConfig &) = default ;
    DataQualityResultRuleSamplingConfig(DataQualityResultRuleSamplingConfig &&) = default ;
    DataQualityResultRuleSamplingConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DataQualityResultRuleSamplingConfig() = default ;
    DataQualityResultRuleSamplingConfig& operator=(const DataQualityResultRuleSamplingConfig &) = default ;
    DataQualityResultRuleSamplingConfig& operator=(DataQualityResultRuleSamplingConfig &&) = default ;
    ...
    inline DataQualityResultRuleSamplingConfig& setMetric(string metric) { DARABONBA_PTR_SET_VALUE(metric_, metric) };
    ...
    inline DataQualityResultRuleSamplingConfig& setMetricParameters(string metricParameters) { DARABONBA_PTR_SET_VALUE(metricParameters_, metricParameters) };
    ...
    inline DataQualityResultRuleSamplingConfig& setSamplingFilter(string samplingFilter) { DARABONBA_PTR_SET_VALUE(samplingFilter_, samplingFilter) };
    ...
    inline DataQualityResultRuleSamplingConfig& setSettingConfig(string settingConfig) { DARABONBA_PTR_SET_VALUE(settingConfig_, settingConfig) };
