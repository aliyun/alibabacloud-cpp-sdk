...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      class DownstreamTaskInstances : public Darabonba::Model {
      public:
        friend void to_json(Darabonba::Json& j, const DownstreamTaskInstances& obj) { 
          DARABONBA_PTR_TO_JSON(DependencyType, dependencyType_);
          DARABONBA_PTR_TO_JSON(TaskInstance, taskInstance_);
        };
        friend void from_json(const Darabonba::Json& j, DownstreamTaskInstances& obj) { 
          DARABONBA_PTR_FROM_JSON(DependencyType, dependencyType_);
          DARABONBA_PTR_FROM_JSON(TaskInstance, taskInstance_);
        };
        DownstreamTaskInstances() = default ;
        DownstreamTaskInstances(const DownstreamTaskInstances &) = default ;
        DownstreamTaskInstances(DownstreamTaskInstances &&) = default ;
        DownstreamTaskInstances(const Darabonba::Json & obj) { from_json(obj, *this); };
        virtual ~DownstreamTaskInstances() = default ;
        DownstreamTaskInstances& operator=(const DownstreamTaskInstances &) = default ;
        DownstreamTaskInstances& operator=(DownstreamTaskInstances &&) = default ;
        virtual void validate() const override {
        };
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        ...
        inline DownstreamTaskInstances& setDependencyType(string dependencyType) { DARABONBA_PTR_SET_VALUE(dependencyType_, dependencyType) };
        ...
        inline const DownstreamTaskInstances::TaskInstance & getTaskInstance() const { DARABONBA_PTR_GET_CONST(taskInstance_, DownstreamTaskInstances::TaskInstance) };
        inline DownstreamTaskInstances::TaskInstance getTaskInstance() { DARABONBA_PTR_GET(taskInstance_, DownstreamTaskInstances::TaskInstance) };
        inline DownstreamTaskInstances& setTaskInstance(const DownstreamTaskInstances::TaskInstance & taskInstance) { DARABONBA_PTR_SET_VALUE(taskInstance_, taskInstance) };
        inline DownstreamTaskInstances& setTaskInstance(DownstreamTaskInstances::TaskInstance && taskInstance) { DARABONBA_PTR_SET_RVALUE(taskInstance_, taskInstance) };
      ...
      virtual bool empty() const override { return this->downstreamTaskInstances_ == nullptr
        && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->taskInstances_ == nullptr && this->totalCount_ == nullptr; };
      ...
      inline const vector<PagingInfo::DownstreamTaskInstances> & getDownstreamTaskInstances() const { DARABONBA_PTR_GET_CONST(downstreamTaskInstances_, vector<PagingInfo::DownstreamTaskInstances>) };
      inline vector<PagingInfo::DownstreamTaskInstances> getDownstreamTaskInstances() { DARABONBA_PTR_GET(downstreamTaskInstances_, vector<PagingInfo::DownstreamTaskInstances>) };
      inline PagingInfo& setDownstreamTaskInstances(const vector<PagingInfo::DownstreamTaskInstances> & downstreamTaskInstances) { DARABONBA_PTR_SET_VALUE(downstreamTaskInstances_, downstreamTaskInstances) };
      inline PagingInfo& setDownstreamTaskInstances(vector<PagingInfo::DownstreamTaskInstances> && downstreamTaskInstances) { DARABONBA_PTR_SET_RVALUE(downstreamTaskInstances_, downstreamTaskInstances) };
    ...
    protected:
      ...
      shared_ptr<vector<PagingInfo::DownstreamTaskInstances>> downstreamTaskInstances_ {};
      // The page number.
    ...
    inline const ListDownstreamTaskInstancesResponseBody::PagingInfo & getPagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListDownstreamTaskInstancesResponseBody::PagingInfo) };
    inline ListDownstreamTaskInstancesResponseBody::PagingInfo getPagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListDownstreamTaskInstancesResponseBody::PagingInfo) };
    inline ListDownstreamTaskInstancesResponseBody& setPagingInfo(const ListDownstreamTaskInstancesResponseBody::PagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListDownstreamTaskInstancesResponseBody& setPagingInfo(ListDownstreamTaskInstancesResponseBody::PagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    shared_ptr<ListDownstreamTaskInstancesResponseBody::PagingInfo> pagingInfo_ {};
    // The request ID.
