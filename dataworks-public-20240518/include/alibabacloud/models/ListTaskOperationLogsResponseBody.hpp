...
namespace Models
{
  ...
  public:
    ...
    inline const ListTaskOperationLogsResponseBody::PagingInfo & getPagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListTaskOperationLogsResponseBody::PagingInfo) };
    inline ListTaskOperationLogsResponseBody::PagingInfo getPagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListTaskOperationLogsResponseBody::PagingInfo) };
    inline ListTaskOperationLogsResponseBody& setPagingInfo(const ListTaskOperationLogsResponseBody::PagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListTaskOperationLogsResponseBody& setPagingInfo(ListTaskOperationLogsResponseBody::PagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
