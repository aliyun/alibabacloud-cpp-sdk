...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTableBusinessMetadataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTableBusinessMetadataResponseBody) };
    inline UpdateTableBusinessMetadataResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTableBusinessMetadataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTableBusinessMetadataResponseBody> body_ {};
  };
