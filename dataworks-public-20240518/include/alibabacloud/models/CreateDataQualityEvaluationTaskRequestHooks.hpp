...
#ifndef ALIBABACLOUD_MODELS_CREATEDATAQUALITYEVALUATIONTASKREQUESTHOOKS_HPP_
#define ALIBABACLOUD_MODELS_CREATEDATAQUALITYEVALUATIONTASKREQUESTHOOKS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateDataQualityEvaluationTaskRequestHooks& obj) { 
      DARABONBA_PTR_TO_JSON(Condition, condition_);
      DARABONBA_PTR_TO_JSON(Type, type_);
    };
    friend void from_json(const Darabonba::Json& j, CreateDataQualityEvaluationTaskRequestHooks& obj) { 
      DARABONBA_PTR_FROM_JSON(Condition, condition_);
      DARABONBA_PTR_FROM_JSON(Type, type_);
    };
    CreateDataQualityEvaluationTaskRequestHooks() = default ;
    CreateDataQualityEvaluationTaskRequestHooks(const CreateDataQualityEvaluationTaskRequestHooks &) = default ;
    CreateDataQualityEvaluationTaskRequestHooks(CreateDataQualityEvaluationTaskRequestHooks &&) = default ;
    CreateDataQualityEvaluationTaskRequestHooks(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateDataQualityEvaluationTaskRequestHooks() = default ;
    CreateDataQualityEvaluationTaskRequestHooks& operator=(const CreateDataQualityEvaluationTaskRequestHooks &) = default ;
    CreateDataQualityEvaluationTaskRequestHooks& operator=(CreateDataQualityEvaluationTaskRequestHooks &&) = default ;
    ...
    inline CreateDataQualityEvaluationTaskRequestHooks& setCondition(string condition) { DARABONBA_PTR_SET_VALUE(condition_, condition) };
    ...
    inline CreateDataQualityEvaluationTaskRequestHooks& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
