...
namespace Models
{
  ...
  public:
    ...
    inline const ListFileVersionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFileVersionsResponseBody) };
    inline ListFileVersionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFileVersionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFileVersionsResponseBody> body_ {};
  };
