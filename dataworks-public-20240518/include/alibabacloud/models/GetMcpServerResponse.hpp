...
namespace Models
{
  ...
  public:
    ...
    inline const GetMcpServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMcpServerResponseBody) };
    inline GetMcpServerResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMcpServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMcpServerResponseBody> body_ {};
  };
