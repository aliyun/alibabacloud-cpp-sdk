...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getDataQualityEvaluationTaskInstanceId() const { DARABONBA_PTR_GET_DEFAULT(dataQualityEvaluationTaskInstanceId_, 0L) };
    ...
    inline int64_t getDataQualityRuleId() const { DARABONBA_PTR_GET_DEFAULT(dataQualityRuleId_, 0L) };
  ...
  protected:
    ...
    shared_ptr<int64_t> dataQualityEvaluationTaskInstanceId_ {};
    // The ID of the data quality monitoring rule.
    shared_ptr<int64_t> dataQualityRuleId_ {};
