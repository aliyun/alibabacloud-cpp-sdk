...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline PagingInfo& setDatasetVersions(const vector<DatasetVersion> & datasetVersions) { DARABONBA_PTR_SET_VALUE(datasetVersions_, datasetVersions) };
      inline PagingInfo& setDatasetVersions(vector<DatasetVersion> && datasetVersions) { DARABONBA_PTR_SET_RVALUE(datasetVersions_, datasetVersions) };
    ...
    inline const ListDatasetVersionsResponseBody::PagingInfo & getPagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListDatasetVersionsResponseBody::PagingInfo) };
    inline ListDatasetVersionsResponseBody::PagingInfo getPagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListDatasetVersionsResponseBody::PagingInfo) };
    inline ListDatasetVersionsResponseBody& setPagingInfo(const ListDatasetVersionsResponseBody::PagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListDatasetVersionsResponseBody& setPagingInfo(ListDatasetVersionsResponseBody::PagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    shared_ptr<ListDatasetVersionsResponseBody::PagingInfo> pagingInfo_ {};
    // RequestId
