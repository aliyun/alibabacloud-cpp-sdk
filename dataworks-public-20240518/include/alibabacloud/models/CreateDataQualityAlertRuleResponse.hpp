...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDataQualityAlertRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDataQualityAlertRuleResponseBody) };
    inline CreateDataQualityAlertRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDataQualityAlertRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDataQualityAlertRuleResponseBody> body_ {};
  };
