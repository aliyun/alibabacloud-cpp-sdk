...
namespace Models
{
  ...
  public:
    ...
    inline const ListNodesResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListNodesResponseBodyPagingInfo) };
    inline ListNodesResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListNodesResponseBodyPagingInfo) };
    inline ListNodesResponseBody& setPagingInfo(const ListNodesResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListNodesResponseBody& setPagingInfo(ListNodesResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ListNodesResponseBodyPagingInfo> pagingInfo_ = nullptr;
    // The request ID.
