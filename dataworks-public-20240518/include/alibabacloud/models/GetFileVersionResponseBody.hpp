...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileVersionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetFileVersionResponseBodyData) };
    inline GetFileVersionResponseBodyData data() { DARABONBA_PTR_GET(data_, GetFileVersionResponseBodyData) };
    inline GetFileVersionResponseBody& setData(const GetFileVersionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetFileVersionResponseBody& setData(GetFileVersionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetFileVersionResponseBodyData> data_ = nullptr;
    // The error code.
