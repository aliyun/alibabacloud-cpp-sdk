...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBusinessResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBusinessResponseBody) };
    inline CreateBusinessResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBusinessResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBusinessResponseBody> body_ {};
  };
