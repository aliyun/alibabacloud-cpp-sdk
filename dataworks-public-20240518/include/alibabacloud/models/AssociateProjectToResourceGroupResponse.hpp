...
namespace Models
{
  ...
  public:
    ...
    inline const AssociateProjectToResourceGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AssociateProjectToResourceGroupResponseBody) };
    inline AssociateProjectToResourceGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, AssociateProjectToResourceGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AssociateProjectToResourceGroupResponseBody> body_ {};
  };
