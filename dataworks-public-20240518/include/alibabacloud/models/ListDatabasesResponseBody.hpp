...
namespace Models
{
  ...
  public:
    ...
    inline const ListDatabasesResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListDatabasesResponseBodyPagingInfo) };
    inline ListDatabasesResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListDatabasesResponseBodyPagingInfo) };
    inline ListDatabasesResponseBody& setPagingInfo(const ListDatabasesResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListDatabasesResponseBody& setPagingInfo(ListDatabasesResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ListDatabasesResponseBodyPagingInfo> pagingInfo_ = nullptr;
    // The request ID.
