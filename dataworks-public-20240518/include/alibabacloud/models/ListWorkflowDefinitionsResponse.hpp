...
namespace Models
{
  ...
  public:
    ...
    inline const ListWorkflowDefinitionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListWorkflowDefinitionsResponseBody) };
    inline ListWorkflowDefinitionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListWorkflowDefinitionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListWorkflowDefinitionsResponseBody> body_ {};
  };
