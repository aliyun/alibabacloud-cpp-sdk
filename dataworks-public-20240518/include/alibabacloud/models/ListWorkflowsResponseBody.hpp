...
namespace Models
{
  ...
  public:
    ...
    inline const ListWorkflowsResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListWorkflowsResponseBodyPagingInfo) };
    inline ListWorkflowsResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListWorkflowsResponseBodyPagingInfo) };
    inline ListWorkflowsResponseBody& setPagingInfo(const ListWorkflowsResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListWorkflowsResponseBody& setPagingInfo(ListWorkflowsResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ListWorkflowsResponseBodyPagingInfo> pagingInfo_ = nullptr;
    // The request ID.
