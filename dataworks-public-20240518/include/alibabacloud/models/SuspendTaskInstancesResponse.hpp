...
namespace Models
{
  ...
  public:
    ...
    inline const SuspendTaskInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SuspendTaskInstancesResponseBody) };
    inline SuspendTaskInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, SuspendTaskInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SuspendTaskInstancesResponseBody> body_ {};
  };
