...
namespace Models
{
  ...
  public:
    ...
    inline const GetDeploymentPackageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDeploymentPackageResponseBodyData) };
    inline GetDeploymentPackageResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDeploymentPackageResponseBodyData) };
    inline GetDeploymentPackageResponseBody& setData(const GetDeploymentPackageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDeploymentPackageResponseBody& setData(GetDeploymentPackageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<GetDeploymentPackageResponseBodyData> data_ = nullptr;
