...
namespace Models
{
  ...
  public:
    ...
    inline const GetDIJobResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, GetDIJobResponseBodyPagingInfo) };
    inline GetDIJobResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, GetDIJobResponseBodyPagingInfo) };
    inline GetDIJobResponseBody& setPagingInfo(const GetDIJobResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline GetDIJobResponseBody& setPagingInfo(GetDIJobResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetDIJobResponseBodyPagingInfo> pagingInfo_ = nullptr;
