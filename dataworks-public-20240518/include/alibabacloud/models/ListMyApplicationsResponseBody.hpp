...
#ifndef ALIBABACLOUD_MODELS_LISTMYAPPLICATIONSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTMYAPPLICATIONSRESPONSEBODY_HPP_
...
namespace Models
{
  class ListMyApplicationsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListMyApplicationsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListMyApplicationsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ListMyApplicationsResponseBody() = default ;
    ListMyApplicationsResponseBody(const ListMyApplicationsResponseBody &) = default ;
    ListMyApplicationsResponseBody(ListMyApplicationsResponseBody &&) = default ;
    ListMyApplicationsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListMyApplicationsResponseBody() = default ;
    ListMyApplicationsResponseBody& operator=(const ListMyApplicationsResponseBody &) = default ;
    ListMyApplicationsResponseBody& operator=(ListMyApplicationsResponseBody &&) = default ;
    ...
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ListMyApplicationsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListMyApplicationsResponseBody::Data) };
    inline ListMyApplicationsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListMyApplicationsResponseBody::Data) };
    inline ListMyApplicationsResponseBody& setData(const ListMyApplicationsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListMyApplicationsResponseBody& setData(ListMyApplicationsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListMyApplicationsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
