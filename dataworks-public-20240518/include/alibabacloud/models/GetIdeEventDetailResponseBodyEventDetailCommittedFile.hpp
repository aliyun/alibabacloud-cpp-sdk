...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->changeType_ == nullptr
        && return this->comment_ == nullptr && return this->committor_ == nullptr && return this->content_ == nullptr && return this->fileId_ == nullptr && return this->fileName_ == nullptr
        && return this->filePropertyContent_ == nullptr && return this->fileType_ == nullptr && return this->nodeConfiguration_ == nullptr && return this->nodeId_ == nullptr && return this->useType_ == nullptr; };
