...
namespace Models
{
  ...
  public:
    ...
    inline const ListNodeDependenciesResponseBody::PagingInfo & getPagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListNodeDependenciesResponseBody::PagingInfo) };
    inline ListNodeDependenciesResponseBody::PagingInfo getPagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListNodeDependenciesResponseBody::PagingInfo) };
    inline ListNodeDependenciesResponseBody& setPagingInfo(const ListNodeDependenciesResponseBody::PagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListNodeDependenciesResponseBody& setPagingInfo(ListNodeDependenciesResponseBody::PagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
