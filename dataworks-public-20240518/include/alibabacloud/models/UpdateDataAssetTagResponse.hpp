...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDataAssetTagResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateDataAssetTagResponseBody) };
    inline UpdateDataAssetTagResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateDataAssetTagResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateDataAssetTagResponseBody> body_ {};
  };
