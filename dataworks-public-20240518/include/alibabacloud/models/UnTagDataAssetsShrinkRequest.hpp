...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataAssetIdsShrink_ == nullptr
        && return this->dataAssetType_ == nullptr && return this->envType_ == nullptr && return this->projectId_ == nullptr && return this->tagsShrink_ == nullptr; };
