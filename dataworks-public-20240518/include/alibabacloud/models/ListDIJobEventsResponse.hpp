...
namespace Models
{
  ...
  public:
    ...
    inline const ListDIJobEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDIJobEventsResponseBody) };
    inline ListDIJobEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDIJobEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDIJobEventsResponseBody> body_ {};
  };
