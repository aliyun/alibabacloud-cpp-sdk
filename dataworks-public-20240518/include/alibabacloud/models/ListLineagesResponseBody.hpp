...
namespace Models
{
  ...
  public:
    ...
    inline const ListLineagesResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListLineagesResponseBodyPagingInfo) };
    inline ListLineagesResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListLineagesResponseBodyPagingInfo) };
    inline ListLineagesResponseBody& setPagingInfo(const ListLineagesResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListLineagesResponseBody& setPagingInfo(ListLineagesResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    std::shared_ptr<ListLineagesResponseBodyPagingInfo> pagingInfo_ = nullptr;
