...
#ifndef ALIBABACLOUD_MODELS_LISTPENDINGAPPROVALSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTPENDINGAPPROVALSRESPONSEBODY_HPP_
...
namespace Models
{
  class ListPendingApprovalsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListPendingApprovalsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListPendingApprovalsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ListPendingApprovalsResponseBody() = default ;
    ListPendingApprovalsResponseBody(const ListPendingApprovalsResponseBody &) = default ;
    ListPendingApprovalsResponseBody(ListPendingApprovalsResponseBody &&) = default ;
    ListPendingApprovalsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPendingApprovalsResponseBody() = default ;
    ListPendingApprovalsResponseBody& operator=(const ListPendingApprovalsResponseBody &) = default ;
    ListPendingApprovalsResponseBody& operator=(ListPendingApprovalsResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline DataItem& setApplicationTime(int64_t applicationTime) { DARABONBA_PTR_SET_VALUE(applicationTime_, applicationTime) };


        // contents Field Functions 
        bool hasContents() const { return this->contents_ != nullptr;};
        void deleteContents() { this->contents_ = nullptr;};
        inline const vector<DataItem::Contents> & getContents() const { DARABONBA_PTR_GET_CONST(contents_, vector<DataItem::Contents>) };
        inline vector<DataItem::Contents> getContents() { DARABONBA_PTR_GET(contents_, vector<DataItem::Contents>) };
        inline DataItem& setContents(const vector<DataItem::Contents> & contents) { DARABONBA_PTR_SET_VALUE(contents_, contents) };
        inline DataItem& setContents(vector<DataItem::Contents> && contents) { DARABONBA_PTR_SET_RVALUE(contents_, contents) };
        ...
        void deleteDefSchema() { this->defSchema_ = nullptr;};
        inline string getDefSchema() const { DARABONBA_PTR_GET_DEFAULT(defSchema_, "") };
        inline DataItem& setDefSchema(string defSchema) { DARABONBA_PTR_SET_VALUE(defSchema_, defSchema) };
        ...
        void deleteProcessInstanceId() { this->processInstanceId_ = nullptr;};
        inline string getProcessInstanceId() const { DARABONBA_PTR_GET_DEFAULT(processInstanceId_, "") };
        inline DataItem& setProcessInstanceId(string processInstanceId) { DARABONBA_PTR_SET_VALUE(processInstanceId_, processInstanceId) };
        ...
        inline DataItem& setReason(string reason) { DARABONBA_PTR_SET_VALUE(reason_, reason) };
      ...
      virtual bool empty() const override { return this->data_ == nullptr
        && this->hasMore_ == nullptr && this->nextToken_ == nullptr && this->pageSize_ == nullptr; };
    ...
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ListPendingApprovalsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListPendingApprovalsResponseBody::Data) };
    inline ListPendingApprovalsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListPendingApprovalsResponseBody::Data) };
    inline ListPendingApprovalsResponseBody& setData(const ListPendingApprovalsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListPendingApprovalsResponseBody& setData(ListPendingApprovalsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListPendingApprovalsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<ListPendingApprovalsResponseBody::Data> data_ {};
