...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveTaskInstanceDependenciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveTaskInstanceDependenciesResponseBody) };
    inline RemoveTaskInstanceDependenciesResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveTaskInstanceDependenciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveTaskInstanceDependenciesResponseBody> body_ {};
  };
