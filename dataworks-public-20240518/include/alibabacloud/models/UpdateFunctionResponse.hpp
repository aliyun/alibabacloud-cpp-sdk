...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFunctionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateFunctionResponseBody) };
    inline UpdateFunctionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateFunctionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateFunctionResponseBody> body_ {};
  };
