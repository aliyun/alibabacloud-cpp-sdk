...
namespace Models
{
  ...
  public:
    ...
    inline const ListTaskOperationLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTaskOperationLogsResponseBody) };
    inline ListTaskOperationLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTaskOperationLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTaskOperationLogsResponseBody> body_ {};
  };
