...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataQualityScansResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataQualityScansResponseBody) };
    inline ListDataQualityScansResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataQualityScansResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataQualityScansResponseBody> body_ {};
  };
