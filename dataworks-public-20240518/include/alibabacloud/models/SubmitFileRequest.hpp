...
namespace Models
{
  ...
  public:
    ...
    inline bool getSkipAllDeployFileExtensions() const { DARABONBA_PTR_GET_DEFAULT(skipAllDeployFileExtensions_, false) };
  ...
  protected:
    ...
    shared_ptr<bool> skipAllDeployFileExtensions_ {};
  };
