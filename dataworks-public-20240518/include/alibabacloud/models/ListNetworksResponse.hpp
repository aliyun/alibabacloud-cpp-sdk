...
namespace Models
{
  ...
  public:
    ...
    inline const ListNetworksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNetworksResponseBody) };
    inline ListNetworksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNetworksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNetworksResponseBody> body_ {};
  };
