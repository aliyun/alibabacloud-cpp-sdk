...
namespace Models
{
  ...
  public:
    ...
    inline const ListCrawlerTypesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCrawlerTypesResponseBody) };
    inline ListCrawlerTypesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCrawlerTypesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCrawlerTypesResponseBody> body_ {};
  };
