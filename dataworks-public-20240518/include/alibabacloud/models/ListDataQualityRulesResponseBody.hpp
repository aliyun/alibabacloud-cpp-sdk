...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataQualityRulesResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListDataQualityRulesResponseBodyPagingInfo) };
    inline ListDataQualityRulesResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListDataQualityRulesResponseBodyPagingInfo) };
    inline ListDataQualityRulesResponseBody& setPagingInfo(const ListDataQualityRulesResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListDataQualityRulesResponseBody& setPagingInfo(ListDataQualityRulesResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataQualityRulesResponseBodyPagingInfo> pagingInfo_ = nullptr;
    // The request ID.
