...
#ifndef ALIBABACLOUD_MODELS_CREATEDATAQUALITYRULEREQUESTSAMPLINGCONFIG_HPP_
#define ALIBABACLOUD_MODELS_CREATEDATAQUALITYRULEREQUESTSAMPLINGCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateDataQualityRuleRequestSamplingConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateDataQualityRuleRequestSamplingConfig& obj) { 
    ...
    CreateDataQualityRuleRequestSamplingConfig() = default ;
    CreateDataQualityRuleRequestSamplingConfig(const CreateDataQualityRuleRequestSamplingConfig &) = default ;
    CreateDataQualityRuleRequestSamplingConfig(CreateDataQualityRuleRequestSamplingConfig &&) = default ;
    CreateDataQualityRuleRequestSamplingConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateDataQualityRuleRequestSamplingConfig() = default ;
    CreateDataQualityRuleRequestSamplingConfig& operator=(const CreateDataQualityRuleRequestSamplingConfig &) = default ;
    CreateDataQualityRuleRequestSamplingConfig& operator=(CreateDataQualityRuleRequestSamplingConfig &&) = default ;
    ...
    inline CreateDataQualityRuleRequestSamplingConfig& setMetric(string metric) { DARABONBA_PTR_SET_VALUE(metric_, metric) };
    ...
    inline CreateDataQualityRuleRequestSamplingConfig& setMetricParameters(string metricParameters) { DARABONBA_PTR_SET_VALUE(metricParameters_, metricParameters) };
    ...
    inline CreateDataQualityRuleRequestSamplingConfig& setSamplingFilter(string samplingFilter) { DARABONBA_PTR_SET_VALUE(samplingFilter_, samplingFilter) };
    ...
    inline CreateDataQualityRuleRequestSamplingConfig& setSettingConfig(string settingConfig) { DARABONBA_PTR_SET_VALUE(settingConfig_, settingConfig) };
