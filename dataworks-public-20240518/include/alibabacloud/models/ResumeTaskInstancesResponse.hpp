...
namespace Models
{
  ...
  public:
    ...
    inline const ResumeTaskInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResumeTaskInstancesResponseBody) };
    inline ResumeTaskInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, ResumeTaskInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResumeTaskInstancesResponseBody> body_ {};
  };
