...
namespace Models
{
  ...
  public:
    ...
    inline const ListDIJobRunDetailsResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListDIJobRunDetailsResponseBodyPagingInfo) };
    inline ListDIJobRunDetailsResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListDIJobRunDetailsResponseBodyPagingInfo) };
    inline ListDIJobRunDetailsResponseBody& setPagingInfo(const ListDIJobRunDetailsResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListDIJobRunDetailsResponseBody& setPagingInfo(ListDIJobRunDetailsResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ListDIJobRunDetailsResponseBodyPagingInfo> pagingInfo_ = nullptr;
