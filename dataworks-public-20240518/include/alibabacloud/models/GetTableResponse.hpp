...
namespace Models
{
  ...
  public:
    ...
    inline const GetTableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTableResponseBody) };
    inline GetTableResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTableResponseBody> body_ {};
  };
