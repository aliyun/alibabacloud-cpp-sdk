...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetResourceResponseBody) };
    inline GetResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetResourceResponseBody> body_ {};
  };
