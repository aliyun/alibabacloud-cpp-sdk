...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateColumnBusinessMetadataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateColumnBusinessMetadataResponseBody) };
    inline UpdateColumnBusinessMetadataResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateColumnBusinessMetadataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateColumnBusinessMetadataResponseBody> body_ {};
  };
