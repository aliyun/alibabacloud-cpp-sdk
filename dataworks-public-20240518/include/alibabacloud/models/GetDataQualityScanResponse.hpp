...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataQualityScanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDataQualityScanResponseBody) };
    inline GetDataQualityScanResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDataQualityScanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDataQualityScanResponseBody> body_ {};
  };
