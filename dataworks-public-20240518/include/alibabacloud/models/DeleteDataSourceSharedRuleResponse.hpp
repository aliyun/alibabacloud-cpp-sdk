...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDataSourceSharedRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDataSourceSharedRuleResponseBody) };
    inline DeleteDataSourceSharedRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDataSourceSharedRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDataSourceSharedRuleResponseBody> body_ {};
  };
