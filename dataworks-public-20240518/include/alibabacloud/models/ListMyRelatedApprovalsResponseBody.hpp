...
#ifndef ALIBABACLOUD_MODELS_LISTMYRELATEDAPPROVALSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTMYRELATEDAPPROVALSRESPONSEBODY_HPP_
...
namespace Models
{
  class ListMyRelatedApprovalsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListMyRelatedApprovalsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListMyRelatedApprovalsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ListMyRelatedApprovalsResponseBody() = default ;
    ListMyRelatedApprovalsResponseBody(const ListMyRelatedApprovalsResponseBody &) = default ;
    ListMyRelatedApprovalsResponseBody(ListMyRelatedApprovalsResponseBody &&) = default ;
    ListMyRelatedApprovalsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListMyRelatedApprovalsResponseBody() = default ;
    ListMyRelatedApprovalsResponseBody& operator=(const ListMyRelatedApprovalsResponseBody &) = default ;
    ListMyRelatedApprovalsResponseBody& operator=(ListMyRelatedApprovalsResponseBody &&) = default ;
    ...
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ListMyRelatedApprovalsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListMyRelatedApprovalsResponseBody::Data) };
    inline ListMyRelatedApprovalsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListMyRelatedApprovalsResponseBody::Data) };
    inline ListMyRelatedApprovalsResponseBody& setData(const ListMyRelatedApprovalsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListMyRelatedApprovalsResponseBody& setData(ListMyRelatedApprovalsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListMyRelatedApprovalsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
