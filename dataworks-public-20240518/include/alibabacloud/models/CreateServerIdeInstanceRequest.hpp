...
#ifndef ALIBABACLOUD_MODELS_CREATESERVERIDEINSTANCEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATESERVERIDEINSTANCEREQUEST_HPP_
...
namespace Models
{
  class CreateServerIdeInstanceRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateServerIdeInstanceRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateServerIdeInstanceRequest& obj) { 
    ...
    CreateServerIdeInstanceRequest() = default ;
    CreateServerIdeInstanceRequest(const CreateServerIdeInstanceRequest &) = default ;
    CreateServerIdeInstanceRequest(CreateServerIdeInstanceRequest &&) = default ;
    CreateServerIdeInstanceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateServerIdeInstanceRequest() = default ;
    CreateServerIdeInstanceRequest& operator=(const CreateServerIdeInstanceRequest &) = default ;
    CreateServerIdeInstanceRequest& operator=(CreateServerIdeInstanceRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->credentialConfig_ == nullptr
        && this->cu_ == nullptr && this->datasets_ == nullptr && this->imageId_ == nullptr && this->imageUrl_ == nullptr && this->instanceName_ == nullptr
        && this->owner_ == nullptr && this->projectId_ == nullptr && this->resourceGroupId_ == nullptr && this->userCommand_ == nullptr && this->userVpc_ == nullptr; };
    // credentialConfig Field Functions 
    bool hasCredentialConfig() const { return this->credentialConfig_ != nullptr;};
    void deleteCredentialConfig() { this->credentialConfig_ = nullptr;};
    inline const CreateServerIdeInstanceRequest::CredentialConfig & getCredentialConfig() const { DARABONBA_PTR_GET_CONST(credentialConfig_, CreateServerIdeInstanceRequest::CredentialConfig) };
    inline CreateServerIdeInstanceRequest::CredentialConfig getCredentialConfig() { DARABONBA_PTR_GET(credentialConfig_, CreateServerIdeInstanceRequest::CredentialConfig) };
    inline CreateServerIdeInstanceRequest& setCredentialConfig(const CreateServerIdeInstanceRequest::CredentialConfig & credentialConfig) { DARABONBA_PTR_SET_VALUE(credentialConfig_, credentialConfig) };
    inline CreateServerIdeInstanceRequest& setCredentialConfig(CreateServerIdeInstanceRequest::CredentialConfig && credentialConfig) { DARABONBA_PTR_SET_RVALUE(credentialConfig_, credentialConfig) };
    ...
    inline CreateServerIdeInstanceRequest& setCu(int32_t cu) { DARABONBA_PTR_SET_VALUE(cu_, cu) };


    // datasets Field Functions 
    bool hasDatasets() const { return this->datasets_ != nullptr;};
    void deleteDatasets() { this->datasets_ = nullptr;};
    inline const vector<CreateServerIdeInstanceRequest::Datasets> & getDatasets() const { DARABONBA_PTR_GET_CONST(datasets_, vector<CreateServerIdeInstanceRequest::Datasets>) };
    inline vector<CreateServerIdeInstanceRequest::Datasets> getDatasets() { DARABONBA_PTR_GET(datasets_, vector<CreateServerIdeInstanceRequest::Datasets>) };
    inline CreateServerIdeInstanceRequest& setDatasets(const vector<CreateServerIdeInstanceRequest::Datasets> & datasets) { DARABONBA_PTR_SET_VALUE(datasets_, datasets) };
    inline CreateServerIdeInstanceRequest& setDatasets(vector<CreateServerIdeInstanceRequest::Datasets> && datasets) { DARABONBA_PTR_SET_RVALUE(datasets_, datasets) };
    ...
    inline CreateServerIdeInstanceRequest& setImageId(string imageId) { DARABONBA_PTR_SET_VALUE(imageId_, imageId) };
    ...
    inline CreateServerIdeInstanceRequest& setImageUrl(string imageUrl) { DARABONBA_PTR_SET_VALUE(imageUrl_, imageUrl) };
    ...
    inline CreateServerIdeInstanceRequest& setInstanceName(string instanceName) { DARABONBA_PTR_SET_VALUE(instanceName_, instanceName) };
    ...
    inline CreateServerIdeInstanceRequest& setOwner(string owner) { DARABONBA_PTR_SET_VALUE(owner_, owner) };
    ...
    inline CreateServerIdeInstanceRequest& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline CreateServerIdeInstanceRequest& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline const CreateServerIdeInstanceRequest::UserCommand & getUserCommand() const { DARABONBA_PTR_GET_CONST(userCommand_, CreateServerIdeInstanceRequest::UserCommand) };
    inline CreateServerIdeInstanceRequest::UserCommand getUserCommand() { DARABONBA_PTR_GET(userCommand_, CreateServerIdeInstanceRequest::UserCommand) };
    inline CreateServerIdeInstanceRequest& setUserCommand(const CreateServerIdeInstanceRequest::UserCommand & userCommand) { DARABONBA_PTR_SET_VALUE(userCommand_, userCommand) };
    inline CreateServerIdeInstanceRequest& setUserCommand(CreateServerIdeInstanceRequest::UserCommand && userCommand) { DARABONBA_PTR_SET_RVALUE(userCommand_, userCommand) };


    // userVpc Field Functions 
    bool hasUserVpc() const { return this->userVpc_ != nullptr;};
    void deleteUserVpc() { this->userVpc_ = nullptr;};
    inline const CreateServerIdeInstanceRequest::UserVpc & getUserVpc() const { DARABONBA_PTR_GET_CONST(userVpc_, CreateServerIdeInstanceRequest::UserVpc) };
    inline CreateServerIdeInstanceRequest::UserVpc getUserVpc() { DARABONBA_PTR_GET(userVpc_, CreateServerIdeInstanceRequest::UserVpc) };
    inline CreateServerIdeInstanceRequest& setUserVpc(const CreateServerIdeInstanceRequest::UserVpc & userVpc) { DARABONBA_PTR_SET_VALUE(userVpc_, userVpc) };
    inline CreateServerIdeInstanceRequest& setUserVpc(CreateServerIdeInstanceRequest::UserVpc && userVpc) { DARABONBA_PTR_SET_RVALUE(userVpc_, userVpc) };
  ...
  protected:
    ...
    shared_ptr<CreateServerIdeInstanceRequest::CredentialConfig> credentialConfig_ {};
    // The number of CUs used by the instance.
    shared_ptr<int32_t> cu_ {};
    // The list of datasets mounted to the instance.
    shared_ptr<vector<CreateServerIdeInstanceRequest::Datasets>> datasets_ {};
    ...
    shared_ptr<CreateServerIdeInstanceRequest::UserCommand> userCommand_ {};
    // The Virtual Private Cloud (VPC) configuration used by the instance.
    shared_ptr<CreateServerIdeInstanceRequest::UserVpc> userVpc_ {};
  };
