...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDataQualityAlertRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateDataQualityAlertRuleResponseBody) };
    inline UpdateDataQualityAlertRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateDataQualityAlertRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateDataQualityAlertRuleResponseBody> body_ {};
  };
