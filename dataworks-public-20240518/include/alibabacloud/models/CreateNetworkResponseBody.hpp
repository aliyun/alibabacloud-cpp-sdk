...
namespace Models
{
  ...
  public:
    ...
    inline CreateNetworkResponseBody& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline CreateNetworkResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
