...
namespace Models
{
  ...
  public:
    ...
    inline const vector<TagDataAssetsRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<TagDataAssetsRequest::Tags>) };
    inline vector<TagDataAssetsRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<TagDataAssetsRequest::Tags>) };
    inline TagDataAssetsRequest& setTags(const vector<TagDataAssetsRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline TagDataAssetsRequest& setTags(vector<TagDataAssetsRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<TagDataAssetsRequest::Tags>> tags_ {};
  };
