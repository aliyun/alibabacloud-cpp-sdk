...
#ifndef ALIBABACLOUD_MODELS_LISTSECURITYSTRATEGIESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTSECURITYSTRATEGIESRESPONSEBODY_HPP_
...
namespace Models
{
  class ListSecurityStrategiesResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListSecurityStrategiesResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(PagingInfo, pagingInfo_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListSecurityStrategiesResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(PagingInfo, pagingInfo_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ListSecurityStrategiesResponseBody() = default ;
    ListSecurityStrategiesResponseBody(const ListSecurityStrategiesResponseBody &) = default ;
    ListSecurityStrategiesResponseBody(ListSecurityStrategiesResponseBody &&) = default ;
    ListSecurityStrategiesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListSecurityStrategiesResponseBody() = default ;
    ListSecurityStrategiesResponseBody& operator=(const ListSecurityStrategiesResponseBody &) = default ;
    ListSecurityStrategiesResponseBody& operator=(ListSecurityStrategiesResponseBody &&) = default ;
    ...
    public:
      friend void to_json(Darabonba::Json& j, const PagingInfo& obj) { 
        ...
        DARABONBA_PTR_TO_JSON(SecurityStrategies, securityStrategies_);
        DARABONBA_PTR_TO_JSON(TotalCount, totalCount_);
      };
      friend void from_json(const Darabonba::Json& j, PagingInfo& obj) { 
        DARABONBA_PTR_FROM_JSON(PageNumber, pageNumber_);
        DARABONBA_PTR_FROM_JSON(PageSize, pageSize_);
        DARABONBA_PTR_FROM_JSON(SecurityStrategies, securityStrategies_);
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      class SecurityStrategies : public Darabonba::Model {
      public:
        friend void to_json(Darabonba::Json& j, const SecurityStrategies& obj) { 
        ...
        friend void from_json(const Darabonba::Json& j, SecurityStrategies& obj) { 
        ...
        SecurityStrategies() = default ;
        SecurityStrategies(const SecurityStrategies &) = default ;
        SecurityStrategies(SecurityStrategies &&) = default ;
        SecurityStrategies(const Darabonba::Json & obj) { from_json(obj, *this); };
        virtual ~SecurityStrategies() = default ;
        SecurityStrategies& operator=(const SecurityStrategies &) = default ;
        SecurityStrategies& operator=(SecurityStrategies &&) = default ;
        virtual void validate() const override {
        };
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        ...
        inline const SecurityStrategies::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, SecurityStrategies::Content) };
        inline SecurityStrategies::Content getContent() { DARABONBA_PTR_GET(content_, SecurityStrategies::Content) };
        inline SecurityStrategies& setContent(const SecurityStrategies::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
        inline SecurityStrategies& setContent(SecurityStrategies::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
        ...
        void deleteControlDwScope() { this->controlDwScope_ = nullptr;};
        inline string getControlDwScope() const { DARABONBA_PTR_GET_DEFAULT(controlDwScope_, "") };
        inline SecurityStrategies& setControlDwScope(string controlDwScope) { DARABONBA_PTR_SET_VALUE(controlDwScope_, controlDwScope) };
        ...
        void deleteControlModule() { this->controlModule_ = nullptr;};
        inline string getControlModule() const { DARABONBA_PTR_GET_DEFAULT(controlModule_, "") };
        inline SecurityStrategies& setControlModule(string controlModule) { DARABONBA_PTR_SET_VALUE(controlModule_, controlModule) };
        ...
        void deleteControlSubModule() { this->controlSubModule_ = nullptr;};
        inline string getControlSubModule() const { DARABONBA_PTR_GET_DEFAULT(controlSubModule_, "") };
        inline SecurityStrategies& setControlSubModule(string controlSubModule) { DARABONBA_PTR_SET_VALUE(controlSubModule_, controlSubModule) };
        ...
        inline SecurityStrategies& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
        ...
        inline SecurityStrategies& setCreator(string creator) { DARABONBA_PTR_SET_VALUE(creator_, creator) };
        ...
        inline SecurityStrategies& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
        ...
        inline SecurityStrategies& setEnabled(bool enabled) { DARABONBA_PTR_SET_VALUE(enabled_, enabled) };
        ...
        inline SecurityStrategies& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
        ...
        void deleteName() { this->name_ = nullptr;};
        inline string getName() const { DARABONBA_PTR_GET_DEFAULT(name_, "") };
        inline SecurityStrategies& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
        ...
        inline SecurityStrategies& setOriginPolicyId(int64_t originPolicyId) { DARABONBA_PTR_SET_VALUE(originPolicyId_, originPolicyId) };
        ...
        inline SecurityStrategies& setSchemaName(string schemaName) { DARABONBA_PTR_SET_VALUE(schemaName_, schemaName) };
        ...
        inline SecurityStrategies& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
        ...
        inline SecurityStrategies& setUpdater(string updater) { DARABONBA_PTR_SET_VALUE(updater_, updater) };
        ...
        inline SecurityStrategies& setWorkspaces(const vector<int64_t> & workspaces) { DARABONBA_PTR_SET_VALUE(workspaces_, workspaces) };
        inline SecurityStrategies& setWorkspaces(vector<int64_t> && workspaces) { DARABONBA_PTR_SET_RVALUE(workspaces_, workspaces) };
      ...
      virtual bool empty() const override { return this->pageNumber_ == nullptr
        && this->pageSize_ == nullptr && this->securityStrategies_ == nullptr && this->totalCount_ == nullptr; };
      ...
      // securityStrategies Field Functions 
      bool hasSecurityStrategies() const { return this->securityStrategies_ != nullptr;};
      void deleteSecurityStrategies() { this->securityStrategies_ = nullptr;};
      inline const vector<PagingInfo::SecurityStrategies> & getSecurityStrategies() const { DARABONBA_PTR_GET_CONST(securityStrategies_, vector<PagingInfo::SecurityStrategies>) };
      inline vector<PagingInfo::SecurityStrategies> getSecurityStrategies() { DARABONBA_PTR_GET(securityStrategies_, vector<PagingInfo::SecurityStrategies>) };
      inline PagingInfo& setSecurityStrategies(const vector<PagingInfo::SecurityStrategies> & securityStrategies) { DARABONBA_PTR_SET_VALUE(securityStrategies_, securityStrategies) };
      inline PagingInfo& setSecurityStrategies(vector<PagingInfo::SecurityStrategies> && securityStrategies) { DARABONBA_PTR_SET_RVALUE(securityStrategies_, securityStrategies) };
    ...
    inline const ListSecurityStrategiesResponseBody::PagingInfo & getPagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListSecurityStrategiesResponseBody::PagingInfo) };
    inline ListSecurityStrategiesResponseBody::PagingInfo getPagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListSecurityStrategiesResponseBody::PagingInfo) };
    inline ListSecurityStrategiesResponseBody& setPagingInfo(const ListSecurityStrategiesResponseBody::PagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListSecurityStrategiesResponseBody& setPagingInfo(ListSecurityStrategiesResponseBody::PagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
    ...
    inline ListSecurityStrategiesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
