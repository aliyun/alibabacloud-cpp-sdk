...
#ifndef ALIBABACLOUD_MODELS_UPDATEDATAQUALITYEVALUATIONTASKREQUESTHOOKS_HPP_
#define ALIBABACLOUD_MODELS_UPDATEDATAQUALITYEVALUATIONTASKREQUESTHOOKS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateDataQualityEvaluationTaskRequestHooks& obj) { 
      DARABONBA_PTR_TO_JSON(Condition, condition_);
      DARABONBA_PTR_TO_JSON(Type, type_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateDataQualityEvaluationTaskRequestHooks& obj) { 
      DARABONBA_PTR_FROM_JSON(Condition, condition_);
      DARABONBA_PTR_FROM_JSON(Type, type_);
    };
    UpdateDataQualityEvaluationTaskRequestHooks() = default ;
    UpdateDataQualityEvaluationTaskRequestHooks(const UpdateDataQualityEvaluationTaskRequestHooks &) = default ;
    UpdateDataQualityEvaluationTaskRequestHooks(UpdateDataQualityEvaluationTaskRequestHooks &&) = default ;
    UpdateDataQualityEvaluationTaskRequestHooks(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateDataQualityEvaluationTaskRequestHooks() = default ;
    UpdateDataQualityEvaluationTaskRequestHooks& operator=(const UpdateDataQualityEvaluationTaskRequestHooks &) = default ;
    UpdateDataQualityEvaluationTaskRequestHooks& operator=(UpdateDataQualityEvaluationTaskRequestHooks &&) = default ;
    ...
    inline UpdateDataQualityEvaluationTaskRequestHooks& setCondition(string condition) { DARABONBA_PTR_SET_VALUE(condition_, condition) };
    ...
    inline UpdateDataQualityEvaluationTaskRequestHooks& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
