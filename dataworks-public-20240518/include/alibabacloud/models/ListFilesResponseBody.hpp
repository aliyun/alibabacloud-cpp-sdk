...
namespace Models
{
  ...
  public:
    ...
    inline const ListFilesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListFilesResponseBodyData) };
    inline ListFilesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListFilesResponseBodyData) };
    inline ListFilesResponseBody& setData(const ListFilesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListFilesResponseBody& setData(ListFilesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<ListFilesResponseBodyData> data_ = nullptr;
