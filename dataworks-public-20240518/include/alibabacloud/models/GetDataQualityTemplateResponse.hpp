...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataQualityTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDataQualityTemplateResponseBody) };
    inline GetDataQualityTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDataQualityTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDataQualityTemplateResponseBody> body_ {};
  };
