...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDIJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDIJobResponseBody) };
    inline DeleteDIJobResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDIJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDIJobResponseBody> body_ {};
  };
