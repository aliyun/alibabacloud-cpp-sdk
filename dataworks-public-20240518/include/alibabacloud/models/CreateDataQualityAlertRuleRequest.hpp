...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->condition_ == nullptr
        && this->notification_ == nullptr && this->projectId_ == nullptr && this->target_ == nullptr; };
    ...
    inline const CreateDataQualityAlertRuleRequest::Notification & getNotification() const { DARABONBA_PTR_GET_CONST(notification_, CreateDataQualityAlertRuleRequest::Notification) };
    inline CreateDataQualityAlertRuleRequest::Notification getNotification() { DARABONBA_PTR_GET(notification_, CreateDataQualityAlertRuleRequest::Notification) };
    inline CreateDataQualityAlertRuleRequest& setNotification(const CreateDataQualityAlertRuleRequest::Notification & notification) { DARABONBA_PTR_SET_VALUE(notification_, notification) };
    inline CreateDataQualityAlertRuleRequest& setNotification(CreateDataQualityAlertRuleRequest::Notification && notification) { DARABONBA_PTR_SET_RVALUE(notification_, notification) };
    ...
    inline const CreateDataQualityAlertRuleRequest::Target & getTarget() const { DARABONBA_PTR_GET_CONST(target_, CreateDataQualityAlertRuleRequest::Target) };
    inline CreateDataQualityAlertRuleRequest::Target getTarget() { DARABONBA_PTR_GET(target_, CreateDataQualityAlertRuleRequest::Target) };
    inline CreateDataQualityAlertRuleRequest& setTarget(const CreateDataQualityAlertRuleRequest::Target & target) { DARABONBA_PTR_SET_VALUE(target_, target) };
    inline CreateDataQualityAlertRuleRequest& setTarget(CreateDataQualityAlertRuleRequest::Target && target) { DARABONBA_PTR_SET_RVALUE(target_, target) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<CreateDataQualityAlertRuleRequest::Notification> notification_ {};
    // The project ID.
    // 
    // This parameter is required.
    ...
    // 
    // This parameter is required.
    shared_ptr<CreateDataQualityAlertRuleRequest::Target> target_ {};
  };
