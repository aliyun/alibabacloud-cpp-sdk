...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataQualityEvaluationTasksResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListDataQualityEvaluationTasksResponseBodyPagingInfo) };
    inline ListDataQualityEvaluationTasksResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListDataQualityEvaluationTasksResponseBodyPagingInfo) };
    inline ListDataQualityEvaluationTasksResponseBody& setPagingInfo(const ListDataQualityEvaluationTasksResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListDataQualityEvaluationTasksResponseBody& setPagingInfo(ListDataQualityEvaluationTasksResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataQualityEvaluationTasksResponseBodyPagingInfo> pagingInfo_ = nullptr;
    // The request ID.
