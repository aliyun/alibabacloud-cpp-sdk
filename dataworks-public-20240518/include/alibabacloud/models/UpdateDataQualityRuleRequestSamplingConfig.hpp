...
#ifndef ALIBABACLOUD_MODELS_UPDATEDATAQUALITYRULEREQUESTSAMPLINGCONFIG_HPP_
#define ALIBABACLOUD_MODELS_UPDATEDATAQUALITYRULEREQUESTSAMPLINGCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateDataQualityRuleRequestSamplingConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateDataQualityRuleRequestSamplingConfig& obj) { 
    ...
    UpdateDataQualityRuleRequestSamplingConfig() = default ;
    UpdateDataQualityRuleRequestSamplingConfig(const UpdateDataQualityRuleRequestSamplingConfig &) = default ;
    UpdateDataQualityRuleRequestSamplingConfig(UpdateDataQualityRuleRequestSamplingConfig &&) = default ;
    UpdateDataQualityRuleRequestSamplingConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateDataQualityRuleRequestSamplingConfig() = default ;
    UpdateDataQualityRuleRequestSamplingConfig& operator=(const UpdateDataQualityRuleRequestSamplingConfig &) = default ;
    UpdateDataQualityRuleRequestSamplingConfig& operator=(UpdateDataQualityRuleRequestSamplingConfig &&) = default ;
    ...
    inline UpdateDataQualityRuleRequestSamplingConfig& setMetric(string metric) { DARABONBA_PTR_SET_VALUE(metric_, metric) };
    ...
    inline UpdateDataQualityRuleRequestSamplingConfig& setMetricParameters(string metricParameters) { DARABONBA_PTR_SET_VALUE(metricParameters_, metricParameters) };
    ...
    inline UpdateDataQualityRuleRequestSamplingConfig& setSamplingFilter(string samplingFilter) { DARABONBA_PTR_SET_VALUE(samplingFilter_, samplingFilter) };
    ...
    inline UpdateDataQualityRuleRequestSamplingConfig& setSettingConfig(string settingConfig) { DARABONBA_PTR_SET_VALUE(settingConfig_, settingConfig) };
