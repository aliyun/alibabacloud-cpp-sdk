...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataQualityRules_ == nullptr
        && return this->dataSourceId_ == nullptr && return this->description_ == nullptr && return this->hooks_ == nullptr && return this->id_ == nullptr && return this->name_ == nullptr
        && return this->notifications_ == nullptr && return this->projectId_ == nullptr && return this->runtimeConf_ == nullptr && return this->target_ == nullptr && return this->trigger_ == nullptr; };
