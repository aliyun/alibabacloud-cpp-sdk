...
namespace Models
{
  ...
  public:
    ...
    inline const ListDeploymentPackageFilesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDeploymentPackageFilesResponseBody) };
    inline ListDeploymentPackageFilesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDeploymentPackageFilesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDeploymentPackageFilesResponseBody> body_ {};
  };
