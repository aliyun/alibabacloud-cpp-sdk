...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->comment_ == nullptr
        && this->id_ == nullptr && this->upstreamTaskInstanceIdsShrink_ == nullptr; };
    ...
    inline string getUpstreamTaskInstanceIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(upstreamTaskInstanceIdsShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> upstreamTaskInstanceIdsShrink_ {};
  };
