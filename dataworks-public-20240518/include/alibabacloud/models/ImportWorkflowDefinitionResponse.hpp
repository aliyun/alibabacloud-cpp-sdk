...
namespace Models
{
  ...
  public:
    ...
    inline const ImportWorkflowDefinitionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ImportWorkflowDefinitionResponseBody) };
    inline ImportWorkflowDefinitionResponseBody getBody() { DARABONBA_PTR_GET(body_, ImportWorkflowDefinitionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ImportWorkflowDefinitionResponseBody> body_ {};
  };
