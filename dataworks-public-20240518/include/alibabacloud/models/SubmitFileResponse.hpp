...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitFileResponseBody) };
    inline SubmitFileResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitFileResponseBody> body_ {};
  };
