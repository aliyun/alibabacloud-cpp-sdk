...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAlertRuleRequest::Notification & getNotification() const { DARABONBA_PTR_GET_CONST(notification_, UpdateAlertRuleRequest::Notification) };
    inline UpdateAlertRuleRequest::Notification getNotification() { DARABONBA_PTR_GET(notification_, UpdateAlertRuleRequest::Notification) };
    inline UpdateAlertRuleRequest& setNotification(const UpdateAlertRuleRequest::Notification & notification) { DARABONBA_PTR_SET_VALUE(notification_, notification) };
    inline UpdateAlertRuleRequest& setNotification(UpdateAlertRuleRequest::Notification && notification) { DARABONBA_PTR_SET_RVALUE(notification_, notification) };
    ...
    inline const UpdateAlertRuleRequest::TriggerCondition & getTriggerCondition() const { DARABONBA_PTR_GET_CONST(triggerCondition_, UpdateAlertRuleRequest::TriggerCondition) };
    inline UpdateAlertRuleRequest::TriggerCondition getTriggerCondition() { DARABONBA_PTR_GET(triggerCondition_, UpdateAlertRuleRequest::TriggerCondition) };
    inline UpdateAlertRuleRequest& setTriggerCondition(const UpdateAlertRuleRequest::TriggerCondition & triggerCondition) { DARABONBA_PTR_SET_VALUE(triggerCondition_, triggerCondition) };
    inline UpdateAlertRuleRequest& setTriggerCondition(UpdateAlertRuleRequest::TriggerCondition && triggerCondition) { DARABONBA_PTR_SET_RVALUE(triggerCondition_, triggerCondition) };
  ...
  protected:
    ...
    shared_ptr<UpdateAlertRuleRequest::Notification> notification_ {};
    // The ID of the Alibaba Cloud account used by the owner of the rule.
    shared_ptr<string> owner_ {};
    // The alert triggering condition.
    shared_ptr<UpdateAlertRuleRequest::TriggerCondition> triggerCondition_ {};
  };
