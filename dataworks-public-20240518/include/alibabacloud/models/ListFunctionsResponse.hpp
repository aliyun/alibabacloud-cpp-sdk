...
namespace Models
{
  ...
  public:
    ...
    inline const ListFunctionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFunctionsResponseBody) };
    inline ListFunctionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFunctionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFunctionsResponseBody> body_ {};
  };
