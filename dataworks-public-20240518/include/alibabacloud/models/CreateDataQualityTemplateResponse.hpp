...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDataQualityTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDataQualityTemplateResponseBody) };
    inline CreateDataQualityTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDataQualityTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDataQualityTemplateResponseBody> body_ {};
  };
