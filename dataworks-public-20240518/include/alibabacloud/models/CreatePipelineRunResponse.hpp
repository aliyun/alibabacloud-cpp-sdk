...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePipelineRunResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePipelineRunResponseBody) };
    inline CreatePipelineRunResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePipelineRunResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePipelineRunResponseBody> body_ {};
  };
