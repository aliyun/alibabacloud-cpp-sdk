...
namespace Models
{
  ...
  public:
    ...
    inline const UnTagDataAssetsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnTagDataAssetsResponseBody) };
    inline UnTagDataAssetsResponseBody getBody() { DARABONBA_PTR_GET(body_, UnTagDataAssetsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnTagDataAssetsResponseBody> body_ {};
  };
