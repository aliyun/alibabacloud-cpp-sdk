...
#ifndef ALIBABACLOUD_MODELS_UPDATESECURITYSTRATEGYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATESECURITYSTRATEGYREQUEST_HPP_
...
namespace Models
{
  class UpdateSecurityStrategyRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateSecurityStrategyRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateSecurityStrategyRequest& obj) { 
    ...
    UpdateSecurityStrategyRequest() = default ;
    UpdateSecurityStrategyRequest(const UpdateSecurityStrategyRequest &) = default ;
    UpdateSecurityStrategyRequest(UpdateSecurityStrategyRequest &&) = default ;
    UpdateSecurityStrategyRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateSecurityStrategyRequest() = default ;
    UpdateSecurityStrategyRequest& operator=(const UpdateSecurityStrategyRequest &) = default ;
    UpdateSecurityStrategyRequest& operator=(UpdateSecurityStrategyRequest &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->controllers_ == nullptr; };
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->content_ == nullptr && this->description_ == nullptr && this->id_ == nullptr && this->name_ == nullptr && this->workspaces_ == nullptr; };
    // clientToken Field Functions 
    bool hasClientToken() const { return this->clientToken_ != nullptr;};
    void deleteClientToken() { this->clientToken_ = nullptr;};
    inline string getClientToken() const { DARABONBA_PTR_GET_DEFAULT(clientToken_, "") };
    inline UpdateSecurityStrategyRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };


    // content Field Functions 
    bool hasContent() const { return this->content_ != nullptr;};
    void deleteContent() { this->content_ = nullptr;};
    inline const UpdateSecurityStrategyRequest::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, UpdateSecurityStrategyRequest::Content) };
    inline UpdateSecurityStrategyRequest::Content getContent() { DARABONBA_PTR_GET(content_, UpdateSecurityStrategyRequest::Content) };
    inline UpdateSecurityStrategyRequest& setContent(const UpdateSecurityStrategyRequest::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline UpdateSecurityStrategyRequest& setContent(UpdateSecurityStrategyRequest::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
    ...
    inline UpdateSecurityStrategyRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline UpdateSecurityStrategyRequest& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline UpdateSecurityStrategyRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline UpdateSecurityStrategyRequest& setWorkspaces(const vector<int64_t> & workspaces) { DARABONBA_PTR_SET_VALUE(workspaces_, workspaces) };
    inline UpdateSecurityStrategyRequest& setWorkspaces(vector<int64_t> && workspaces) { DARABONBA_PTR_SET_RVALUE(workspaces_, workspaces) };
