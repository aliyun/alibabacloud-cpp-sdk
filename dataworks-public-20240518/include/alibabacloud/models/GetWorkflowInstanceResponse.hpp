...
namespace Models
{
  ...
  public:
    ...
    inline const GetWorkflowInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetWorkflowInstanceResponseBody) };
    inline GetWorkflowInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetWorkflowInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetWorkflowInstanceResponseBody> body_ {};
  };
