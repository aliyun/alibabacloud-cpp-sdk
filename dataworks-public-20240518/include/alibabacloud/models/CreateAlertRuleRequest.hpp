...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAlertRuleRequest::Notification & getNotification() const { DARABONBA_PTR_GET_CONST(notification_, CreateAlertRuleRequest::Notification) };
    inline CreateAlertRuleRequest::Notification getNotification() { DARABONBA_PTR_GET(notification_, CreateAlertRuleRequest::Notification) };
    inline CreateAlertRuleRequest& setNotification(const CreateAlertRuleRequest::Notification & notification) { DARABONBA_PTR_SET_VALUE(notification_, notification) };
    inline CreateAlertRuleRequest& setNotification(CreateAlertRuleRequest::Notification && notification) { DARABONBA_PTR_SET_RVALUE(notification_, notification) };
    ...
    inline const CreateAlertRuleRequest::TriggerCondition & getTriggerCondition() const { DARABONBA_PTR_GET_CONST(triggerCondition_, CreateAlertRuleRequest::TriggerCondition) };
    inline CreateAlertRuleRequest::TriggerCondition getTriggerCondition() { DARABONBA_PTR_GET(triggerCondition_, CreateAlertRuleRequest::TriggerCondition) };
    inline CreateAlertRuleRequest& setTriggerCondition(const CreateAlertRuleRequest::TriggerCondition & triggerCondition) { DARABONBA_PTR_SET_VALUE(triggerCondition_, triggerCondition) };
    inline CreateAlertRuleRequest& setTriggerCondition(CreateAlertRuleRequest::TriggerCondition && triggerCondition) { DARABONBA_PTR_SET_RVALUE(triggerCondition_, triggerCondition) };
