...
namespace Models
{
  ...
  public:
    ...
    inline const ListUpstreamTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUpstreamTasksResponseBody) };
    inline ListUpstreamTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUpstreamTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUpstreamTasksResponseBody> body_ {};
  };
