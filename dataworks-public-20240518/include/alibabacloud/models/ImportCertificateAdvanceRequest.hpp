...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ImportCertificateAdvanceRequest& obj) { 
      // certificateFileObject_ is stream
    ...
    inline shared_ptr<Darabonba::IStream> getCertificateFileObject() const { DARABONBA_GET(certificateFileObject_) };
  ...
  protected:
    ...
    shared_ptr<Darabonba::IStream> certificateFileObject_ {};
