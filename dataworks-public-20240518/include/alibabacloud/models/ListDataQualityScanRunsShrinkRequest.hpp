...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->createTimeFrom_ == nullptr
        && return this->createTimeTo_ == nullptr && return this->dataQualityScanId_ == nullptr && return this->filterShrink_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr
        && return this->projectId_ == nullptr && return this->sortBy_ == nullptr && return this->status_ == nullptr; };
