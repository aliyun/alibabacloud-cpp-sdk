...
namespace Models
{
  ...
  public:
    ...
    inline const AbolishPipelineRunResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AbolishPipelineRunResponseBody) };
    inline AbolishPipelineRunResponseBody getBody() { DARABONBA_PTR_GET(body_, AbolishPipelineRunResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AbolishPipelineRunResponseBody> body_ {};
  };
