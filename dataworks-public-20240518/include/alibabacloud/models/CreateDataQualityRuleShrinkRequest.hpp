...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->checkingConfigShrink_ == nullptr
        && this->description_ == nullptr && this->enabled_ == nullptr && this->errorHandlersShrink_ == nullptr && this->name_ == nullptr && this->projectId_ == nullptr
        && this->samplingConfigShrink_ == nullptr && this->severity_ == nullptr && this->targetShrink_ == nullptr && this->templateCode_ == nullptr; };
    ...
    inline string getErrorHandlersShrink() const { DARABONBA_PTR_GET_DEFAULT(errorHandlersShrink_, "") };
