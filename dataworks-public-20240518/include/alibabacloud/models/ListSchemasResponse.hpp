...
namespace Models
{
  ...
  public:
    ...
    inline const ListSchemasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSchemasResponseBody) };
    inline ListSchemasResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSchemasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSchemasResponseBody> body_ {};
  };
