...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->baselineId_ == nullptr
        ...
        && return this->rerunTimes_ == nullptr && return this->runtimeResource_ == nullptr && return this->timeout_ == nullptr && return this->trigger_ == nullptr && return this->type_ == nullptr
