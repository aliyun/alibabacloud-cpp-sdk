...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveEntityFromMetaCollectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveEntityFromMetaCollectionResponseBody) };
    inline RemoveEntityFromMetaCollectionResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveEntityFromMetaCollectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveEntityFromMetaCollectionResponseBody> body_ {};
  };
