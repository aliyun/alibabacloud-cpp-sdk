...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLineageRelationshipResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLineageRelationshipResponseBody) };
    inline CreateLineageRelationshipResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLineageRelationshipResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLineageRelationshipResponseBody> body_ {};
  };
