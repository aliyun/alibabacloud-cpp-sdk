...
#ifndef ALIBABACLOUD_MODELS_ATTACHDATAQUALITYRULESTOEVALUATIONTASKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ATTACHDATAQUALITYRULESTOEVALUATIONTASKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AttachDataQualityRulesToEvaluationTaskRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AttachDataQualityRulesToEvaluationTaskRequest& obj) { 
    ...
    AttachDataQualityRulesToEvaluationTaskRequest() = default ;
    AttachDataQualityRulesToEvaluationTaskRequest(const AttachDataQualityRulesToEvaluationTaskRequest &) = default ;
    AttachDataQualityRulesToEvaluationTaskRequest(AttachDataQualityRulesToEvaluationTaskRequest &&) = default ;
    AttachDataQualityRulesToEvaluationTaskRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AttachDataQualityRulesToEvaluationTaskRequest() = default ;
    AttachDataQualityRulesToEvaluationTaskRequest& operator=(const AttachDataQualityRulesToEvaluationTaskRequest &) = default ;
    AttachDataQualityRulesToEvaluationTaskRequest& operator=(AttachDataQualityRulesToEvaluationTaskRequest &&) = default ;
