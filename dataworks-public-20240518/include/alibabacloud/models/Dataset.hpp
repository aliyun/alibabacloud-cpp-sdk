...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->comment_ == nullptr
        && this->createTime_ == nullptr && this->creatorId_ == nullptr && this->dataType_ == nullptr && this->id_ == nullptr && this->labels_ == nullptr
        && this->latestVersion_ == nullptr && this->modifyTime_ == nullptr && this->name_ == nullptr && this->origin_ == nullptr && this->projectId_ == nullptr
        && this->readme_ == nullptr && this->storageType_ == nullptr; };
    ...
    inline const vector<DatasetLabel> & getLabels() const { DARABONBA_PTR_GET_CONST(labels_, vector<DatasetLabel>) };
    inline vector<DatasetLabel> getLabels() { DARABONBA_PTR_GET(labels_, vector<DatasetLabel>) };
