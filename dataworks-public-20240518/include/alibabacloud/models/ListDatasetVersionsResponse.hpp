...
namespace Models
{
  ...
  public:
    ...
    inline const ListDatasetVersionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDatasetVersionsResponseBody) };
    inline ListDatasetVersionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDatasetVersionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDatasetVersionsResponseBody> body_ {};
  };
