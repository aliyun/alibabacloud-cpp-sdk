...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDataQualityScanRunResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDataQualityScanRunResponseBody) };
    inline CreateDataQualityScanRunResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDataQualityScanRunResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDataQualityScanRunResponseBody> body_ {};
  };
