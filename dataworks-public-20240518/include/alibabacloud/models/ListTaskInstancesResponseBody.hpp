...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->triggerRecurrence_ == nullptr && this->triggerTime_ == nullptr && this->triggerType_ == nullptr && this->unifiedWorkflowInstanceId_ == nullptr && this->waitingResourceTime_ == nullptr
        && this->waitingTriggerTime_ == nullptr && this->workflowId_ == nullptr && this->workflowInstanceId_ == nullptr && this->workflowInstanceType_ == nullptr && this->workflowName_ == nullptr; };
        ...
        inline TaskInstances& setScriptParameters(string scriptParameters) { DARABONBA_PTR_SET_VALUE(scriptParameters_, scriptParameters) };
        ...
        inline TaskInstances& setUnifiedWorkflowInstanceId(int64_t unifiedWorkflowInstanceId) { DARABONBA_PTR_SET_VALUE(unifiedWorkflowInstanceId_, unifiedWorkflowInstanceId) };
        ...
        inline TaskInstances& setWaitingResourceTime(int64_t waitingResourceTime) { DARABONBA_PTR_SET_VALUE(waitingResourceTime_, waitingResourceTime) };
        ...
        inline TaskInstances& setWaitingTriggerTime(int64_t waitingTriggerTime) { DARABONBA_PTR_SET_VALUE(waitingTriggerTime_, waitingTriggerTime) };
    ...
    inline const ListTaskInstancesResponseBody::PagingInfo & getPagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListTaskInstancesResponseBody::PagingInfo) };
    inline ListTaskInstancesResponseBody::PagingInfo getPagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListTaskInstancesResponseBody::PagingInfo) };
    inline ListTaskInstancesResponseBody& setPagingInfo(const ListTaskInstancesResponseBody::PagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListTaskInstancesResponseBody& setPagingInfo(ListTaskInstancesResponseBody::PagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    shared_ptr<ListTaskInstancesResponseBody::PagingInfo> pagingInfo_ {};
    // The request ID.
