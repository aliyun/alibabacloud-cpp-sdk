...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CrawlerType> & getCrawlerTypes() const { DARABONBA_PTR_GET_CONST(crawlerTypes_, vector<CrawlerType>) };
    inline vector<CrawlerType> getCrawlerTypes() { DARABONBA_PTR_GET(crawlerTypes_, vector<CrawlerType>) };
  ...
  protected:
    ...
    shared_ptr<vector<CrawlerType>> crawlerTypes_ {};
    // The request ID.
