...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataAssetIds_ == nullptr
        && return this->dataAssetType_ == nullptr && return this->envType_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->projectId_ == nullptr
