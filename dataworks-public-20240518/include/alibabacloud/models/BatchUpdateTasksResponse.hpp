...
namespace Models
{
  ...
  public:
    ...
    inline const BatchUpdateTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchUpdateTasksResponseBody) };
    inline BatchUpdateTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchUpdateTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchUpdateTasksResponseBody> body_ {};
  };
