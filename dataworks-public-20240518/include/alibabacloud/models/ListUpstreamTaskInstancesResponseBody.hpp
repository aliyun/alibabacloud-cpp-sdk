...
namespace Models
{
  ...
  public:
    ...
    inline const ListUpstreamTaskInstancesResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListUpstreamTaskInstancesResponseBodyPagingInfo) };
    inline ListUpstreamTaskInstancesResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListUpstreamTaskInstancesResponseBodyPagingInfo) };
    inline ListUpstreamTaskInstancesResponseBody& setPagingInfo(const ListUpstreamTaskInstancesResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListUpstreamTaskInstancesResponseBody& setPagingInfo(ListUpstreamTaskInstancesResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ListUpstreamTaskInstancesResponseBodyPagingInfo> pagingInfo_ = nullptr;
    // The request ID.
