  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->pageNumber_ == nullptr
        && this->pageSize_ == nullptr && this->tables_ == nullptr && this->totalCount_ == nullptr; };
      ...
      inline const vector<Table> & getTables() const { DARABONBA_PTR_GET_CONST(tables_, vector<Table>) };
      inline vector<Table> getTables() { DARABONBA_PTR_GET(tables_, vector<Table>) };
      inline PagingInfo& setTables(const vector<Table> & tables) { DARABONBA_PTR_SET_VALUE(tables_, tables) };
      inline PagingInfo& setTables(vector<Table> && tables) { DARABONBA_PTR_SET_RVALUE(tables_, tables) };
    ...
    inline const ListTablesResponseBody::PagingInfo & getPagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListTablesResponseBody::PagingInfo) };
    inline ListTablesResponseBody::PagingInfo getPagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListTablesResponseBody::PagingInfo) };
    inline ListTablesResponseBody& setPagingInfo(const ListTablesResponseBody::PagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListTablesResponseBody& setPagingInfo(ListTablesResponseBody::PagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
