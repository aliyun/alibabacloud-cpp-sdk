...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteProjectResponseBody) };
    inline DeleteProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteProjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteProjectResponseBody> body_ {};
  };
