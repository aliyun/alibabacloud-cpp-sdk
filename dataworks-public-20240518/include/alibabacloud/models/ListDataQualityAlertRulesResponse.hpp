...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataQualityAlertRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataQualityAlertRulesResponseBody) };
    inline ListDataQualityAlertRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataQualityAlertRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataQualityAlertRulesResponseBody> body_ {};
  };
