...
namespace Models
{
  ...
  public:
    ...
    inline const Partition & getPartition() const { DARABONBA_PTR_GET_CONST(partition_, Partition) };
    inline Partition getPartition() { DARABONBA_PTR_GET(partition_, Partition) };
  ...
  protected:
    // Partition details.
    shared_ptr<Partition> partition_ {};
    // The request ID.
