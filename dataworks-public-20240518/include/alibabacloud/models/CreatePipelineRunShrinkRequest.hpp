...
#ifndef ALIBABACLOUD_MODELS_CREATEPIPELINERUNSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEPIPELINERUNSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePipelineRunShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePipelineRunShrinkRequest& obj) { 
    ...
    CreatePipelineRunShrinkRequest() = default ;
    CreatePipelineRunShrinkRequest(const CreatePipelineRunShrinkRequest &) = default ;
    CreatePipelineRunShrinkRequest(CreatePipelineRunShrinkRequest &&) = default ;
    CreatePipelineRunShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePipelineRunShrinkRequest() = default ;
    CreatePipelineRunShrinkRequest& operator=(const CreatePipelineRunShrinkRequest &) = default ;
    CreatePipelineRunShrinkRequest& operator=(CreatePipelineRunShrinkRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->autoRunUntilStage_ == nullptr
        && this->description_ == nullptr && this->objectIdsShrink_ == nullptr && this->projectId_ == nullptr && this->runMode_ == nullptr && this->type_ == nullptr; };
    ...
    inline CreatePipelineRunShrinkRequest& setAutoRunUntilStage(string autoRunUntilStage) { DARABONBA_PTR_SET_VALUE(autoRunUntilStage_, autoRunUntilStage) };
    ...
    inline CreatePipelineRunShrinkRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreatePipelineRunShrinkRequest& setObjectIdsShrink(string objectIdsShrink) { DARABONBA_PTR_SET_VALUE(objectIdsShrink_, objectIdsShrink) };
    ...
    inline CreatePipelineRunShrinkRequest& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline CreatePipelineRunShrinkRequest& setRunMode(string runMode) { DARABONBA_PTR_SET_VALUE(runMode_, runMode) };
    ...
    inline CreatePipelineRunShrinkRequest& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
