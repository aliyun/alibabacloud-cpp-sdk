...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDataQualityAlertRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDataQualityAlertRuleResponseBody) };
    inline DeleteDataQualityAlertRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDataQualityAlertRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDataQualityAlertRuleResponseBody> body_ {};
  };
