...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->createTimeFrom_ != nullptr
        && this->createTimeTo_ != nullptr && this->dataQualityScanId_ != nullptr && this->pageNumber_ != nullptr && this->pageSize_ != nullptr && this->projectId_ != nullptr
