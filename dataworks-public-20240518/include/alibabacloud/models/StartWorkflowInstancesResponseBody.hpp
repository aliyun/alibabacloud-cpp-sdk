...
#ifndef ALIBABACLOUD_MODELS_STARTWORKFLOWINSTANCESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_STARTWORKFLOWINSTANCESRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartWorkflowInstancesResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(SuccessInfo, successInfo_);
    };
    friend void from_json(const Darabonba::Json& j, StartWorkflowInstancesResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(SuccessInfo, successInfo_);
    };
    StartWorkflowInstancesResponseBody() = default ;
    StartWorkflowInstancesResponseBody(const StartWorkflowInstancesResponseBody &) = default ;
    StartWorkflowInstancesResponseBody(StartWorkflowInstancesResponseBody &&) = default ;
    StartWorkflowInstancesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartWorkflowInstancesResponseBody() = default ;
    StartWorkflowInstancesResponseBody& operator=(const StartWorkflowInstancesResponseBody &) = default ;
    StartWorkflowInstancesResponseBody& operator=(StartWorkflowInstancesResponseBody &&) = default ;
