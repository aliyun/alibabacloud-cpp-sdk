...
namespace Models
{
  ...
  public:
    ...
    inline const PreviewDatasetVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PreviewDatasetVersionResponseBody) };
    inline PreviewDatasetVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, PreviewDatasetVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PreviewDatasetVersionResponseBody> body_ {};
  };
