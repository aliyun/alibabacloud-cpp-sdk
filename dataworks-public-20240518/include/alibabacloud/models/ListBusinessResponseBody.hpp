...
namespace Models
{
  ...
  public:
    ...
    inline const ListBusinessResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListBusinessResponseBodyData) };
    inline ListBusinessResponseBodyData data() { DARABONBA_PTR_GET(data_, ListBusinessResponseBodyData) };
    inline ListBusinessResponseBody& setData(const ListBusinessResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListBusinessResponseBody& setData(ListBusinessResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<ListBusinessResponseBodyData> data_ = nullptr;
