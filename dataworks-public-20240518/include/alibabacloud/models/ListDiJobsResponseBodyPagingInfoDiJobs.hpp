...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DIJobId_ == nullptr
        && return this->destinationDataSourceType_ == nullptr && return this->id_ == nullptr && return this->jobName_ == nullptr && return this->jobStatus_ == nullptr && return this->migrationType_ == nullptr
        && return this->projectId_ == nullptr && return this->sourceDataSourceType_ == nullptr; };
