...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline ImageList& setAccessibility(string accessibility) { DARABONBA_PTR_SET_VALUE(accessibility_, accessibility) };
        ...
        inline ImageList& setAcrAssociatedVpcId(string acrAssociatedVpcId) { DARABONBA_PTR_SET_VALUE(acrAssociatedVpcId_, acrAssociatedVpcId) };
        ...
        inline ImageList& setAcrEndpoint(string acrEndpoint) { DARABONBA_PTR_SET_VALUE(acrEndpoint_, acrEndpoint) };
        ...
        inline ImageList& setAcrInstanceId(string acrInstanceId) { DARABONBA_PTR_SET_VALUE(acrInstanceId_, acrInstanceId) };
        ...
        inline const ImageList::BuildConfig & getBuildConfig() const { DARABONBA_PTR_GET_CONST(buildConfig_, ImageList::BuildConfig) };
        inline ImageList::BuildConfig getBuildConfig() { DARABONBA_PTR_GET(buildConfig_, ImageList::BuildConfig) };
        inline ImageList& setBuildConfig(const ImageList::BuildConfig & buildConfig) { DARABONBA_PTR_SET_VALUE(buildConfig_, buildConfig) };
        inline ImageList& setBuildConfig(ImageList::BuildConfig && buildConfig) { DARABONBA_PTR_SET_RVALUE(buildConfig_, buildConfig) };
        ...
        inline ImageList& setCreatedTime(int64_t createdTime) { DARABONBA_PTR_SET_VALUE(createdTime_, createdTime) };
        ...
        inline ImageList& setCreator(string creator) { DARABONBA_PTR_SET_VALUE(creator_, creator) };
        ...
        inline ImageList& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
        ...
        inline ImageList& setEnableSyncMaxCompute(bool enableSyncMaxCompute) { DARABONBA_PTR_SET_VALUE(enableSyncMaxCompute_, enableSyncMaxCompute) };
        ...
        inline ImageList& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
        ...
        inline ImageList& setImageTag(string imageTag) { DARABONBA_PTR_SET_VALUE(imageTag_, imageTag) };
        ...
        inline ImageList& setImageUri(string imageUri) { DARABONBA_PTR_SET_VALUE(imageUri_, imageUri) };
        ...
        inline ImageList& setImageVpcUri(string imageVpcUri) { DARABONBA_PTR_SET_VALUE(imageVpcUri_, imageVpcUri) };
        ...
        inline ImageList& setIsDefault(bool isDefault) { DARABONBA_PTR_SET_VALUE(isDefault_, isDefault) };
        ...
        inline ImageList& setLastModifiedTime(int64_t lastModifiedTime) { DARABONBA_PTR_SET_VALUE(lastModifiedTime_, lastModifiedTime) };
        ...
        inline ImageList& setModifier(string modifier) { DARABONBA_PTR_SET_VALUE(modifier_, modifier) };
        ...
        inline ImageList& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
        ...
        inline ImageList& setNamespace(string _namespace) { DARABONBA_PTR_SET_VALUE(namespace_, _namespace) };
        ...
        inline ImageList& setOfficial(bool official) { DARABONBA_PTR_SET_VALUE(official_, official) };
        ...
        inline ImageList& setProviderImageId(string providerImageId) { DARABONBA_PTR_SET_VALUE(providerImageId_, providerImageId) };
        ...
        inline ImageList& setProviderType(string providerType) { DARABONBA_PTR_SET_VALUE(providerType_, providerType) };
        ...
        inline ImageList& setPublishStage(string publishStage) { DARABONBA_PTR_SET_VALUE(publishStage_, publishStage) };
        ...
        inline ImageList& setRepositoryName(string repositoryName) { DARABONBA_PTR_SET_VALUE(repositoryName_, repositoryName) };
        ...
        inline ImageList& setSize(string size) { DARABONBA_PTR_SET_VALUE(size_, size) };
        ...
        inline ImageList& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
        ...
        inline const ImageList::Supported & getSupported() const { DARABONBA_PTR_GET_CONST(supported_, ImageList::Supported) };
        inline ImageList::Supported getSupported() { DARABONBA_PTR_GET(supported_, ImageList::Supported) };
        inline ImageList& setSupported(const ImageList::Supported & supported) { DARABONBA_PTR_SET_VALUE(supported_, supported) };
        inline ImageList& setSupported(ImageList::Supported && supported) { DARABONBA_PTR_SET_RVALUE(supported_, supported) };
        ...
        inline ImageList& setVersion(string version) { DARABONBA_PTR_SET_VALUE(version_, version) };
      ...
      protected:
        ...
        shared_ptr<ImageList::BuildConfig> buildConfig_ {};
        ...
        shared_ptr<ImageList::Supported> supported_ {};
      ...
      inline const vector<PagingInfo::ImageList> & getImageList() const { DARABONBA_PTR_GET_CONST(imageList_, vector<PagingInfo::ImageList>) };
      inline vector<PagingInfo::ImageList> getImageList() { DARABONBA_PTR_GET(imageList_, vector<PagingInfo::ImageList>) };
      inline PagingInfo& setImageList(const vector<PagingInfo::ImageList> & imageList) { DARABONBA_PTR_SET_VALUE(imageList_, imageList) };
      inline PagingInfo& setImageList(vector<PagingInfo::ImageList> && imageList) { DARABONBA_PTR_SET_RVALUE(imageList_, imageList) };
    ...
    protected:
      shared_ptr<vector<PagingInfo::ImageList>> imageList_ {};
    ...
    inline const ListImagesResponseBody::PagingInfo & getPagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListImagesResponseBody::PagingInfo) };
    inline ListImagesResponseBody::PagingInfo getPagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListImagesResponseBody::PagingInfo) };
    inline ListImagesResponseBody& setPagingInfo(const ListImagesResponseBody::PagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListImagesResponseBody& setPagingInfo(ListImagesResponseBody::PagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    shared_ptr<ListImagesResponseBody::PagingInfo> pagingInfo_ {};
