...
#ifndef ALIBABACLOUD_MODELS_GETALERTRULERESPONSEBODYALERTRULENOTIFICATIONRECEIVERS_HPP_
#define ALIBABACLOUD_MODELS_GETALERTRULERESPONSEBODYALERTRULENOTIFICATIONRECEIVERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAlertRuleResponseBodyAlertRuleNotificationReceivers& obj) { 
      DARABONBA_PTR_TO_JSON(Extension, extension_);
      DARABONBA_PTR_TO_JSON(ReceiverType, receiverType_);
      DARABONBA_PTR_TO_JSON(ReceiverValues, receiverValues_);
    };
    friend void from_json(const Darabonba::Json& j, GetAlertRuleResponseBodyAlertRuleNotificationReceivers& obj) { 
      DARABONBA_PTR_FROM_JSON(Extension, extension_);
      DARABONBA_PTR_FROM_JSON(ReceiverType, receiverType_);
      DARABONBA_PTR_FROM_JSON(ReceiverValues, receiverValues_);
    };
    GetAlertRuleResponseBodyAlertRuleNotificationReceivers() = default ;
    GetAlertRuleResponseBodyAlertRuleNotificationReceivers(const GetAlertRuleResponseBodyAlertRuleNotificationReceivers &) = default ;
    GetAlertRuleResponseBodyAlertRuleNotificationReceivers(GetAlertRuleResponseBodyAlertRuleNotificationReceivers &&) = default ;
    GetAlertRuleResponseBodyAlertRuleNotificationReceivers(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAlertRuleResponseBodyAlertRuleNotificationReceivers() = default ;
    GetAlertRuleResponseBodyAlertRuleNotificationReceivers& operator=(const GetAlertRuleResponseBodyAlertRuleNotificationReceivers &) = default ;
    GetAlertRuleResponseBodyAlertRuleNotificationReceivers& operator=(GetAlertRuleResponseBodyAlertRuleNotificationReceivers &&) = default ;
    ...
    inline GetAlertRuleResponseBodyAlertRuleNotificationReceivers& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
    ...
    inline GetAlertRuleResponseBodyAlertRuleNotificationReceivers& setReceiverType(string receiverType) { DARABONBA_PTR_SET_VALUE(receiverType_, receiverType) };
    ...
    inline GetAlertRuleResponseBodyAlertRuleNotificationReceivers& setReceiverValues(const vector<string> & receiverValues) { DARABONBA_PTR_SET_VALUE(receiverValues_, receiverValues) };
    inline GetAlertRuleResponseBodyAlertRuleNotificationReceivers& setReceiverValues(vector<string> && receiverValues) { DARABONBA_PTR_SET_RVALUE(receiverValues_, receiverValues) };
