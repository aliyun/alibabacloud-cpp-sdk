  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->body_ == nullptr
        && this->creatorId_ == nullptr && this->description_ == nullptr && this->gmtCreateTime_ == nullptr && this->gmtModifiedTime_ == nullptr && this->modifierId_ == nullptr
    ...
    inline const UpdateSkillResponseBody::Skill & getSkill() const { DARABONBA_PTR_GET_CONST(skill_, UpdateSkillResponseBody::Skill) };
    inline UpdateSkillResponseBody::Skill getSkill() { DARABONBA_PTR_GET(skill_, UpdateSkillResponseBody::Skill) };
    inline UpdateSkillResponseBody& setSkill(const UpdateSkillResponseBody::Skill & skill) { DARABONBA_PTR_SET_VALUE(skill_, skill) };
    inline UpdateSkillResponseBody& setSkill(UpdateSkillResponseBody::Skill && skill) { DARABONBA_PTR_SET_RVALUE(skill_, skill) };
