...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->comment_ == nullptr
        && this->createTime_ == nullptr && this->creatorId_ == nullptr && this->datasetId_ == nullptr && this->id_ == nullptr && this->importInfo_ == nullptr
        && this->labels_ == nullptr && this->modifyTime_ == nullptr && this->mountPath_ == nullptr && this->storageType_ == nullptr && this->url_ == nullptr
        && this->versionNumber_ == nullptr; };
    ...
    inline int32_t getVersionNumber() const { DARABONBA_PTR_GET_DEFAULT(versionNumber_, 0) };
