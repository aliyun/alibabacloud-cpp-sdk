...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDataQualityRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDataQualityRuleResponseBody) };
    inline DeleteDataQualityRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDataQualityRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDataQualityRuleResponseBody> body_ {};
  };
