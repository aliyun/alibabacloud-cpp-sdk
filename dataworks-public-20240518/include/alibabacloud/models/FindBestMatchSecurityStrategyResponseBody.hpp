...
#ifndef ALIBABACLOUD_MODELS_FINDBESTMATCHSECURITYSTRATEGYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_FINDBESTMATCHSECURITYSTRATEGYRESPONSEBODY_HPP_
...
namespace Models
{
  class FindBestMatchSecurityStrategyResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const FindBestMatchSecurityStrategyResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, FindBestMatchSecurityStrategyResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    FindBestMatchSecurityStrategyResponseBody() = default ;
    FindBestMatchSecurityStrategyResponseBody(const FindBestMatchSecurityStrategyResponseBody &) = default ;
    FindBestMatchSecurityStrategyResponseBody(FindBestMatchSecurityStrategyResponseBody &&) = default ;
    FindBestMatchSecurityStrategyResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FindBestMatchSecurityStrategyResponseBody() = default ;
    FindBestMatchSecurityStrategyResponseBody& operator=(const FindBestMatchSecurityStrategyResponseBody &) = default ;
    FindBestMatchSecurityStrategyResponseBody& operator=(FindBestMatchSecurityStrategyResponseBody &&) = default ;
    ...
    public:
      friend void to_json(Darabonba::Json& j, const Data& obj) { 
        ...
        DARABONBA_PTR_TO_JSON(EditionDisplayName, editionDisplayName_);
        DARABONBA_PTR_TO_JSON(SecurityStrategy, securityStrategy_);
      };
      friend void from_json(const Darabonba::Json& j, Data& obj) { 
        DARABONBA_PTR_FROM_JSON(Edition, edition_);
        DARABONBA_PTR_FROM_JSON(EditionDisplayName, editionDisplayName_);
      ...
      virtual bool empty() const override { return this->edition_ == nullptr
        && this->editionDisplayName_ == nullptr && this->securityStrategy_ == nullptr; };
      ...
      // editionDisplayName Field Functions 
      bool hasEditionDisplayName() const { return this->editionDisplayName_ != nullptr;};
      void deleteEditionDisplayName() { this->editionDisplayName_ = nullptr;};
      inline string getEditionDisplayName() const { DARABONBA_PTR_GET_DEFAULT(editionDisplayName_, "") };
      inline Data& setEditionDisplayName(string editionDisplayName) { DARABONBA_PTR_SET_VALUE(editionDisplayName_, editionDisplayName) };
      ...
      inline const Data::SecurityStrategy & getSecurityStrategy() const { DARABONBA_PTR_GET_CONST(securityStrategy_, Data::SecurityStrategy) };
      inline Data::SecurityStrategy getSecurityStrategy() { DARABONBA_PTR_GET(securityStrategy_, Data::SecurityStrategy) };
      inline Data& setSecurityStrategy(const Data::SecurityStrategy & securityStrategy) { DARABONBA_PTR_SET_VALUE(securityStrategy_, securityStrategy) };
      inline Data& setSecurityStrategy(Data::SecurityStrategy && securityStrategy) { DARABONBA_PTR_SET_RVALUE(securityStrategy_, securityStrategy) };
    ...
    inline const FindBestMatchSecurityStrategyResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, FindBestMatchSecurityStrategyResponseBody::Data) };
    inline FindBestMatchSecurityStrategyResponseBody::Data getData() { DARABONBA_PTR_GET(data_, FindBestMatchSecurityStrategyResponseBody::Data) };
    inline FindBestMatchSecurityStrategyResponseBody& setData(const FindBestMatchSecurityStrategyResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline FindBestMatchSecurityStrategyResponseBody& setData(FindBestMatchSecurityStrategyResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline FindBestMatchSecurityStrategyResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
