...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->bizdate_ != nullptr
        && this->id_ != nullptr && this->ids_ != nullptr && this->owner_ != nullptr && this->pageNumber_ != nullptr && this->pageSize_ != nullptr
        && this->projectEnv_ != nullptr && this->projectId_ != nullptr && this->runtimeResource_ != nullptr && this->sortBy_ != nullptr && this->status_ != nullptr
        && this->taskId_ != nullptr && this->taskIds_ != nullptr && this->taskName_ != nullptr && this->taskType_ != nullptr && this->triggerRecurrence_ != nullptr
