...
namespace Models
{
  ...
  public:
    ...
    inline const AddEntityIntoMetaCollectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddEntityIntoMetaCollectionResponseBody) };
    inline AddEntityIntoMetaCollectionResponseBody getBody() { DARABONBA_PTR_GET(body_, AddEntityIntoMetaCollectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddEntityIntoMetaCollectionResponseBody> body_ {};
  };
