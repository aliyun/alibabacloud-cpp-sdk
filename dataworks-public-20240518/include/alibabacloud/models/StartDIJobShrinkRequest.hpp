...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DIJobId_ == nullptr
        && this->forceToRerun_ == nullptr && this->id_ == nullptr && this->realtimeStartSettingsShrink_ == nullptr; };
    ...
    inline string getRealtimeStartSettingsShrink() const { DARABONBA_PTR_GET_DEFAULT(realtimeStartSettingsShrink_, "") };
  ...
  protected:
    ...
    //     }
    shared_ptr<string> realtimeStartSettingsShrink_ {};
  };
