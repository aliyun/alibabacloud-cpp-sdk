...
#ifndef ALIBABACLOUD_MODELS_LISTPROJECTSRESPONSEBODYPAGINGINFOPROJECTS_HPP_
#define ALIBABACLOUD_MODELS_LISTPROJECTSRESPONSEBODYPAGINGINFOPROJECTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListProjectsResponseBodyPagingInfoProjects& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListProjectsResponseBodyPagingInfoProjects& obj) { 
    ...
    ListProjectsResponseBodyPagingInfoProjects() = default ;
    ListProjectsResponseBodyPagingInfoProjects(const ListProjectsResponseBodyPagingInfoProjects &) = default ;
    ListProjectsResponseBodyPagingInfoProjects(ListProjectsResponseBodyPagingInfoProjects &&) = default ;
    ListProjectsResponseBodyPagingInfoProjects(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListProjectsResponseBodyPagingInfoProjects() = default ;
    ListProjectsResponseBodyPagingInfoProjects& operator=(const ListProjectsResponseBodyPagingInfoProjects &) = default ;
    ListProjectsResponseBodyPagingInfoProjects& operator=(ListProjectsResponseBodyPagingInfoProjects &&) = default ;
    ...
    inline ListProjectsResponseBodyPagingInfoProjects& setAliyunResourceGroupId(string aliyunResourceGroupId) { DARABONBA_PTR_SET_VALUE(aliyunResourceGroupId_, aliyunResourceGroupId) };
    ...
    inline const vector<Models::ListProjectsResponseBodyPagingInfoProjectsAliyunResourceTags> & aliyunResourceTags() const { DARABONBA_PTR_GET_CONST(aliyunResourceTags_, vector<Models::ListProjectsResponseBodyPagingInfoProjectsAliyunResourceTags>) };
    inline vector<Models::ListProjectsResponseBodyPagingInfoProjectsAliyunResourceTags> aliyunResourceTags() { DARABONBA_PTR_GET(aliyunResourceTags_, vector<Models::ListProjectsResponseBodyPagingInfoProjectsAliyunResourceTags>) };
    inline ListProjectsResponseBodyPagingInfoProjects& setAliyunResourceTags(const vector<Models::ListProjectsResponseBodyPagingInfoProjectsAliyunResourceTags> & aliyunResourceTags) { DARABONBA_PTR_SET_VALUE(aliyunResourceTags_, aliyunResourceTags) };
    inline ListProjectsResponseBodyPagingInfoProjects& setAliyunResourceTags(vector<Models::ListProjectsResponseBodyPagingInfoProjectsAliyunResourceTags> && aliyunResourceTags) { DARABONBA_PTR_SET_RVALUE(aliyunResourceTags_, aliyunResourceTags) };
    ...
    inline ListProjectsResponseBodyPagingInfoProjects& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListProjectsResponseBodyPagingInfoProjects& setDevEnvironmentEnabled(bool devEnvironmentEnabled) { DARABONBA_PTR_SET_VALUE(devEnvironmentEnabled_, devEnvironmentEnabled) };
    ...
    inline ListProjectsResponseBodyPagingInfoProjects& setDevRoleDisabled(bool devRoleDisabled) { DARABONBA_PTR_SET_VALUE(devRoleDisabled_, devRoleDisabled) };
    ...
    inline ListProjectsResponseBodyPagingInfoProjects& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
    ...
    inline ListProjectsResponseBodyPagingInfoProjects& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListProjectsResponseBodyPagingInfoProjects& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListProjectsResponseBodyPagingInfoProjects& setOwner(string owner) { DARABONBA_PTR_SET_VALUE(owner_, owner) };
    ...
    inline ListProjectsResponseBodyPagingInfoProjects& setPaiTaskEnabled(bool paiTaskEnabled) { DARABONBA_PTR_SET_VALUE(paiTaskEnabled_, paiTaskEnabled) };
    ...
    inline ListProjectsResponseBodyPagingInfoProjects& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
  ...
  protected:
    ...
    // The tags.
    std::shared_ptr<vector<Models::ListProjectsResponseBodyPagingInfoProjectsAliyunResourceTags>> aliyunResourceTags_ = nullptr;
