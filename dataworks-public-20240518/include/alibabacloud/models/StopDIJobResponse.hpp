...
namespace Models
{
  ...
  public:
    ...
    inline const StopDIJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopDIJobResponseBody) };
    inline StopDIJobResponseBody getBody() { DARABONBA_PTR_GET(body_, StopDIJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopDIJobResponseBody> body_ {};
  };
