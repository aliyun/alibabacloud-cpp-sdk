...
namespace Models
{
  ...
  public:
    ...
    inline const ListNodeDependenciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNodeDependenciesResponseBody) };
    inline ListNodeDependenciesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNodeDependenciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNodeDependenciesResponseBody> body_ {};
  };
