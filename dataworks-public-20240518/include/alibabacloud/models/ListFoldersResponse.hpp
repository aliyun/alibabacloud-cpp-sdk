...
namespace Models
{
  ...
  public:
    ...
    inline const ListFoldersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFoldersResponseBody) };
    inline ListFoldersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFoldersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFoldersResponseBody> body_ {};
  };
