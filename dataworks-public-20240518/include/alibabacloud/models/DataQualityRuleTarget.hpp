...
#ifndef ALIBABACLOUD_MODELS_DATAQUALITYRULETARGET_HPP_
#define ALIBABACLOUD_MODELS_DATAQUALITYRULETARGET_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DataQualityRuleTarget& obj) { 
      DARABONBA_PTR_TO_JSON(DatabaseType, databaseType_);
      DARABONBA_PTR_TO_JSON(PartitionSpec, partitionSpec_);
      DARABONBA_PTR_TO_JSON(TableGuid, tableGuid_);
      DARABONBA_PTR_TO_JSON(Type, type_);
    };
    friend void from_json(const Darabonba::Json& j, DataQualityRuleTarget& obj) { 
      DARABONBA_PTR_FROM_JSON(DatabaseType, databaseType_);
      DARABONBA_PTR_FROM_JSON(PartitionSpec, partitionSpec_);
      DARABONBA_PTR_FROM_JSON(TableGuid, tableGuid_);
      DARABONBA_PTR_FROM_JSON(Type, type_);
    };
    DataQualityRuleTarget() = default ;
    DataQualityRuleTarget(const DataQualityRuleTarget &) = default ;
    DataQualityRuleTarget(DataQualityRuleTarget &&) = default ;
    DataQualityRuleTarget(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DataQualityRuleTarget() = default ;
    DataQualityRuleTarget& operator=(const DataQualityRuleTarget &) = default ;
    DataQualityRuleTarget& operator=(DataQualityRuleTarget &&) = default ;
    ...
    inline DataQualityRuleTarget& setDatabaseType(string databaseType) { DARABONBA_PTR_SET_VALUE(databaseType_, databaseType) };
    ...
    inline DataQualityRuleTarget& setPartitionSpec(string partitionSpec) { DARABONBA_PTR_SET_VALUE(partitionSpec_, partitionSpec) };
    ...
    inline DataQualityRuleTarget& setTableGuid(string tableGuid) { DARABONBA_PTR_SET_VALUE(tableGuid_, tableGuid) };
    ...
    inline DataQualityRuleTarget& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
