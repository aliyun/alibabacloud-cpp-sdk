...
namespace Models
{
  ...
  public:
    ...
    inline const ListFileVersionsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListFileVersionsResponseBodyData) };
    inline ListFileVersionsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListFileVersionsResponseBodyData) };
    inline ListFileVersionsResponseBody& setData(const ListFileVersionsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListFileVersionsResponseBody& setData(ListFileVersionsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListFileVersionsResponseBodyData> data_ = nullptr;
    // The error code.
