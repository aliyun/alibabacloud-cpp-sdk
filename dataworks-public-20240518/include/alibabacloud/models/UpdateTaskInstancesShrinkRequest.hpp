...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->comment_ == nullptr
        && this->taskInstancesShrink_ == nullptr; };
    ...
    inline string getTaskInstancesShrink() const { DARABONBA_PTR_GET_DEFAULT(taskInstancesShrink_, "") };
  ...
  protected:
    ...
    // The instances.
    shared_ptr<string> taskInstancesShrink_ {};
  };
