...
namespace Models
{
  ...
  public:
    ...
    inline const ListProjectRolesResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListProjectRolesResponseBodyPagingInfo) };
    inline ListProjectRolesResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListProjectRolesResponseBodyPagingInfo) };
    inline ListProjectRolesResponseBody& setPagingInfo(const ListProjectRolesResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListProjectRolesResponseBody& setPagingInfo(ListProjectRolesResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ListProjectRolesResponseBodyPagingInfo> pagingInfo_ = nullptr;
    // The request ID.
