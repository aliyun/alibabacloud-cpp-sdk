...
namespace Models
{
  ...
  public:
    ...
    inline DeleteCertificateRequest& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline DeleteCertificateRequest& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
