...
namespace Models
{
  ...
  public:
    ...
    inline const ListPipelineRunItemsResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListPipelineRunItemsResponseBodyPagingInfo) };
    inline ListPipelineRunItemsResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListPipelineRunItemsResponseBodyPagingInfo) };
    inline ListPipelineRunItemsResponseBody& setPagingInfo(const ListPipelineRunItemsResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListPipelineRunItemsResponseBody& setPagingInfo(ListPipelineRunItemsResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ListPipelineRunItemsResponseBodyPagingInfo> pagingInfo_ = nullptr;
