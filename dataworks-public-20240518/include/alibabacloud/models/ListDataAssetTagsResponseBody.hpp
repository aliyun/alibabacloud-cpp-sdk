...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataAssetTagsResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListDataAssetTagsResponseBodyPagingInfo) };
    inline ListDataAssetTagsResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListDataAssetTagsResponseBodyPagingInfo) };
    inline ListDataAssetTagsResponseBody& setPagingInfo(const ListDataAssetTagsResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListDataAssetTagsResponseBody& setPagingInfo(ListDataAssetTagsResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataAssetTagsResponseBodyPagingInfo> pagingInfo_ = nullptr;
    // The request ID.
