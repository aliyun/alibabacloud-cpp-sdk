...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->resourceGroup_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const GetResourceGroupResponseBodyResourceGroup & resourceGroup() const { DARABONBA_PTR_GET_CONST(resourceGroup_, GetResourceGroupResponseBodyResourceGroup) };
    inline GetResourceGroupResponseBodyResourceGroup resourceGroup() { DARABONBA_PTR_GET(resourceGroup_, GetResourceGroupResponseBodyResourceGroup) };
    inline GetResourceGroupResponseBody& setResourceGroup(const GetResourceGroupResponseBodyResourceGroup & resourceGroup) { DARABONBA_PTR_SET_VALUE(resourceGroup_, resourceGroup) };
    inline GetResourceGroupResponseBody& setResourceGroup(GetResourceGroupResponseBodyResourceGroup && resourceGroup) { DARABONBA_PTR_SET_RVALUE(resourceGroup_, resourceGroup) };
  ...
  protected:
    ...
    std::shared_ptr<GetResourceGroupResponseBodyResourceGroup> resourceGroup_ = nullptr;
