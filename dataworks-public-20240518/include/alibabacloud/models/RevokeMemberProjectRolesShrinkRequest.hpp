...
#ifndef ALIBABACLOUD_MODELS_REVOKEMEMBERPROJECTROLESSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_REVOKEMEMBERPROJECTROLESSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RevokeMemberProjectRolesShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(ProjectId, projectId_);
      DARABONBA_PTR_TO_JSON(RoleCodes, roleCodesShrink_);
      DARABONBA_PTR_TO_JSON(UserId, userId_);
    };
    friend void from_json(const Darabonba::Json& j, RevokeMemberProjectRolesShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(ProjectId, projectId_);
      DARABONBA_PTR_FROM_JSON(RoleCodes, roleCodesShrink_);
      DARABONBA_PTR_FROM_JSON(UserId, userId_);
    };
    RevokeMemberProjectRolesShrinkRequest() = default ;
    RevokeMemberProjectRolesShrinkRequest(const RevokeMemberProjectRolesShrinkRequest &) = default ;
    RevokeMemberProjectRolesShrinkRequest(RevokeMemberProjectRolesShrinkRequest &&) = default ;
    RevokeMemberProjectRolesShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RevokeMemberProjectRolesShrinkRequest() = default ;
    RevokeMemberProjectRolesShrinkRequest& operator=(const RevokeMemberProjectRolesShrinkRequest &) = default ;
    RevokeMemberProjectRolesShrinkRequest& operator=(RevokeMemberProjectRolesShrinkRequest &&) = default ;
    ...
    inline RevokeMemberProjectRolesShrinkRequest& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline RevokeMemberProjectRolesShrinkRequest& setRoleCodesShrink(string roleCodesShrink) { DARABONBA_PTR_SET_VALUE(roleCodesShrink_, roleCodesShrink) };
    ...
    inline RevokeMemberProjectRolesShrinkRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
