...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      class DownstreamTasks : public Darabonba::Model {
      public:
        friend void to_json(Darabonba::Json& j, const DownstreamTasks& obj) { 
          DARABONBA_PTR_TO_JSON(DependencyType, dependencyType_);
          DARABONBA_PTR_TO_JSON(Task, task_);
        };
        friend void from_json(const Darabonba::Json& j, DownstreamTasks& obj) { 
          DARABONBA_PTR_FROM_JSON(DependencyType, dependencyType_);
          DARABONBA_PTR_FROM_JSON(Task, task_);
        };
        DownstreamTasks() = default ;
        DownstreamTasks(const DownstreamTasks &) = default ;
        DownstreamTasks(DownstreamTasks &&) = default ;
        DownstreamTasks(const Darabonba::Json & obj) { from_json(obj, *this); };
        virtual ~DownstreamTasks() = default ;
        DownstreamTasks& operator=(const DownstreamTasks &) = default ;
        DownstreamTasks& operator=(DownstreamTasks &&) = default ;
        virtual void validate() const override {
        };
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        ...
        inline DownstreamTasks& setDependencyType(string dependencyType) { DARABONBA_PTR_SET_VALUE(dependencyType_, dependencyType) };


        // task Field Functions 
        bool hasTask() const { return this->task_ != nullptr;};
        void deleteTask() { this->task_ = nullptr;};
        inline const DownstreamTasks::Task & getTask() const { DARABONBA_PTR_GET_CONST(task_, DownstreamTasks::Task) };
        inline DownstreamTasks::Task getTask() { DARABONBA_PTR_GET(task_, DownstreamTasks::Task) };
        inline DownstreamTasks& setTask(const DownstreamTasks::Task & task) { DARABONBA_PTR_SET_VALUE(task_, task) };
        inline DownstreamTasks& setTask(DownstreamTasks::Task && task) { DARABONBA_PTR_SET_RVALUE(task_, task) };
      ...
      protected:
        ...
        shared_ptr<DownstreamTasks::Task> task_ {};
      };
      ...
      inline const vector<PagingInfo::DownstreamTasks> & getDownstreamTasks() const { DARABONBA_PTR_GET_CONST(downstreamTasks_, vector<PagingInfo::DownstreamTasks>) };
      inline vector<PagingInfo::DownstreamTasks> getDownstreamTasks() { DARABONBA_PTR_GET(downstreamTasks_, vector<PagingInfo::DownstreamTasks>) };
      inline PagingInfo& setDownstreamTasks(const vector<PagingInfo::DownstreamTasks> & downstreamTasks) { DARABONBA_PTR_SET_VALUE(downstreamTasks_, downstreamTasks) };
      inline PagingInfo& setDownstreamTasks(vector<PagingInfo::DownstreamTasks> && downstreamTasks) { DARABONBA_PTR_SET_RVALUE(downstreamTasks_, downstreamTasks) };
    ...
    protected:
      ...
      shared_ptr<vector<PagingInfo::DownstreamTasks>> downstreamTasks_ {};
      // The page number.
    ...
    inline const ListDownstreamTasksResponseBody::PagingInfo & getPagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListDownstreamTasksResponseBody::PagingInfo) };
    inline ListDownstreamTasksResponseBody::PagingInfo getPagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListDownstreamTasksResponseBody::PagingInfo) };
    inline ListDownstreamTasksResponseBody& setPagingInfo(const ListDownstreamTasksResponseBody::PagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListDownstreamTasksResponseBody& setPagingInfo(ListDownstreamTasksResponseBody::PagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    ...
    shared_ptr<ListDownstreamTasksResponseBody::PagingInfo> pagingInfo_ {};
    // The request ID.
