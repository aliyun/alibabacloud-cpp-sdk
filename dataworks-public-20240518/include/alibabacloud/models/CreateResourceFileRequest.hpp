...
#ifndef ALIBABACLOUD_MODELS_CREATERESOURCEFILEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATERESOURCEFILEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateResourceFileRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateResourceFileRequest& obj) { 
    ...
    CreateResourceFileRequest(const CreateResourceFileRequest &) = default ;
    CreateResourceFileRequest(CreateResourceFileRequest &&) = default ;
    CreateResourceFileRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateResourceFileRequest() = default ;
    CreateResourceFileRequest& operator=(const CreateResourceFileRequest &) = default ;
    CreateResourceFileRequest& operator=(CreateResourceFileRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->content_ == nullptr
        ...
        && return this->owner_ == nullptr && return this->projectId_ == nullptr && return this->registerToCalcEngine_ == nullptr && return this->resourceFile_ == nullptr && return this->storageURL_ == nullptr
