...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateWorkflowDefinitionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateWorkflowDefinitionResponseBody) };
    inline UpdateWorkflowDefinitionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateWorkflowDefinitionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateWorkflowDefinitionResponseBody> body_ {};
  };
