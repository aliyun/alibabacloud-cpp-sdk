...
namespace Models
{
  ...
  public:
    ...
    inline const ListPipelineRunsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPipelineRunsResponseBody) };
    inline ListPipelineRunsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPipelineRunsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPipelineRunsResponseBody> body_ {};
  };
