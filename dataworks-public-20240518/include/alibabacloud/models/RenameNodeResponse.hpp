...
namespace Models
{
  ...
  public:
    ...
    inline const RenameNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RenameNodeResponseBody) };
    inline RenameNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, RenameNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RenameNodeResponseBody> body_ {};
  };
