...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->id_ == nullptr
        && return this->projectId_ == nullptr && return this->resourceFile_ == nullptr && return this->spec_ == nullptr; };
    // id Field Functions 
    bool hasId() const { return this->id_ != nullptr;};
    void deleteId() { this->id_ = nullptr;};
    inline int64_t id() const { DARABONBA_PTR_GET_DEFAULT(id_, 0L) };
    inline UpdateResourceRequest& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline UpdateResourceRequest& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline UpdateResourceRequest& setResourceFile(string resourceFile) { DARABONBA_PTR_SET_VALUE(resourceFile_, resourceFile) };
    ...
    inline UpdateResourceRequest& setSpec(string spec) { DARABONBA_PTR_SET_VALUE(spec_, spec) };
