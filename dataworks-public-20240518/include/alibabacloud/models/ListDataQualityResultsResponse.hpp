...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataQualityResultsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataQualityResultsResponseBody) };
    inline ListDataQualityResultsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataQualityResultsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataQualityResultsResponseBody> body_ {};
  };
