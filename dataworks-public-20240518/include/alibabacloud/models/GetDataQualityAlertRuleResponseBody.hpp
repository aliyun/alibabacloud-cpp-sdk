...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->dataQualityAlertRule_ != nullptr
    ...
    inline const GetDataQualityAlertRuleResponseBodyDataQualityAlertRule & dataQualityAlertRule() const { DARABONBA_PTR_GET_CONST(dataQualityAlertRule_, GetDataQualityAlertRuleResponseBodyDataQualityAlertRule) };
    inline GetDataQualityAlertRuleResponseBodyDataQualityAlertRule dataQualityAlertRule() { DARABONBA_PTR_GET(dataQualityAlertRule_, GetDataQualityAlertRuleResponseBodyDataQualityAlertRule) };
    inline GetDataQualityAlertRuleResponseBody& setDataQualityAlertRule(const GetDataQualityAlertRuleResponseBodyDataQualityAlertRule & dataQualityAlertRule) { DARABONBA_PTR_SET_VALUE(dataQualityAlertRule_, dataQualityAlertRule) };
    inline GetDataQualityAlertRuleResponseBody& setDataQualityAlertRule(GetDataQualityAlertRuleResponseBodyDataQualityAlertRule && dataQualityAlertRule) { DARABONBA_PTR_SET_RVALUE(dataQualityAlertRule_, dataQualityAlertRule) };
  ...
  protected:
    ...
    std::shared_ptr<GetDataQualityAlertRuleResponseBodyDataQualityAlertRule> dataQualityAlertRule_ = nullptr;
    // The request ID.
