...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataQualityScansResponseBodyPageInfo & pageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, ListDataQualityScansResponseBodyPageInfo) };
    inline ListDataQualityScansResponseBodyPageInfo pageInfo() { DARABONBA_PTR_GET(pageInfo_, ListDataQualityScansResponseBodyPageInfo) };
    inline ListDataQualityScansResponseBody& setPageInfo(const ListDataQualityScansResponseBodyPageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline ListDataQualityScansResponseBody& setPageInfo(ListDataQualityScansResponseBodyPageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataQualityScansResponseBodyPageInfo> pageInfo_ = nullptr;
