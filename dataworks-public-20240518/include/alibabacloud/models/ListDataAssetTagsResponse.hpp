...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataAssetTagsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataAssetTagsResponseBody) };
    inline ListDataAssetTagsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataAssetTagsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataAssetTagsResponseBody> body_ {};
  };
