...
namespace Models
{
  ...
  public:
    ...
    inline const ListPartitionsResponseBodyPagingInfo & pagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListPartitionsResponseBodyPagingInfo) };
    inline ListPartitionsResponseBodyPagingInfo pagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListPartitionsResponseBodyPagingInfo) };
    inline ListPartitionsResponseBody& setPagingInfo(const ListPartitionsResponseBodyPagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListPartitionsResponseBody& setPagingInfo(ListPartitionsResponseBodyPagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
  ...
  protected:
    std::shared_ptr<ListPartitionsResponseBodyPagingInfo> pagingInfo_ = nullptr;
