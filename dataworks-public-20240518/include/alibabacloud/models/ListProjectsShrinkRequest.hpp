...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->aliyunResourceGroupId_ != nullptr
        && this->aliyunResourceTagsShrink_ != nullptr && this->devEnvironmentEnabled_ != nullptr && this->devRoleDisabled_ != nullptr && this->idsShrink_ != nullptr && this->namesShrink_ != nullptr
