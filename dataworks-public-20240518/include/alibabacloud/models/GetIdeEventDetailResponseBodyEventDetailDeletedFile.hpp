...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessId_ == nullptr
        && return this->content_ == nullptr && return this->currentVersion_ == nullptr && return this->dataSourceName_ == nullptr && return this->fileId_ == nullptr && return this->fileName_ == nullptr
        && return this->fileType_ == nullptr && return this->folderId_ == nullptr && return this->nodeId_ == nullptr && return this->owner_ == nullptr && return this->parentFileId_ == nullptr
