...
namespace Models
{
  ...
  public:
    ...
    inline const GetCatalogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCatalogResponseBody) };
    inline GetCatalogResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCatalogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCatalogResponseBody> body_ {};
  };
