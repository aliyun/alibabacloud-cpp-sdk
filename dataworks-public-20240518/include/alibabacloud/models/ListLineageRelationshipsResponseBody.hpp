...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const vector<LineageRelationship> & getLineageRelationships() const { DARABONBA_PTR_GET_CONST(lineageRelationships_, vector<LineageRelationship>) };
      inline vector<LineageRelationship> getLineageRelationships() { DARABONBA_PTR_GET(lineageRelationships_, vector<LineageRelationship>) };
      inline PagingInfo& setLineageRelationships(const vector<LineageRelationship> & lineageRelationships) { DARABONBA_PTR_SET_VALUE(lineageRelationships_, lineageRelationships) };
      inline PagingInfo& setLineageRelationships(vector<LineageRelationship> && lineageRelationships) { DARABONBA_PTR_SET_RVALUE(lineageRelationships_, lineageRelationships) };
    ...
    inline const ListLineageRelationshipsResponseBody::PagingInfo & getPagingInfo() const { DARABONBA_PTR_GET_CONST(pagingInfo_, ListLineageRelationshipsResponseBody::PagingInfo) };
    inline ListLineageRelationshipsResponseBody::PagingInfo getPagingInfo() { DARABONBA_PTR_GET(pagingInfo_, ListLineageRelationshipsResponseBody::PagingInfo) };
    inline ListLineageRelationshipsResponseBody& setPagingInfo(const ListLineageRelationshipsResponseBody::PagingInfo & pagingInfo) { DARABONBA_PTR_SET_VALUE(pagingInfo_, pagingInfo) };
    inline ListLineageRelationshipsResponseBody& setPagingInfo(ListLineageRelationshipsResponseBody::PagingInfo && pagingInfo) { DARABONBA_PTR_SET_RVALUE(pagingInfo_, pagingInfo) };
