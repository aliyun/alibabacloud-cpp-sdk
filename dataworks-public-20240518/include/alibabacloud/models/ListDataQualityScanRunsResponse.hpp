...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataQualityScanRunsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataQualityScanRunsResponseBody) };
    inline ListDataQualityScanRunsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataQualityScanRunsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataQualityScanRunsResponseBody> body_ {};
  };
