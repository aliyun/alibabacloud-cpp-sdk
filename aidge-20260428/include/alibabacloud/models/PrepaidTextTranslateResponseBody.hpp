...
#ifndef ALIBABACLOUD_MODELS_PREPAIDTEXTTRANSLATERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_PREPAIDTEXTTRANSLATERESPONSEBODY_HPP_
...
namespace Models
{
  class PrepaidTextTranslateResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const PrepaidTextTranslateResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PrepaidTextTranslateResponseBody& obj) { 
    ...
    PrepaidTextTranslateResponseBody() = default ;
    PrepaidTextTranslateResponseBody(const PrepaidTextTranslateResponseBody &) = default ;
    PrepaidTextTranslateResponseBody(PrepaidTextTranslateResponseBody &&) = default ;
    PrepaidTextTranslateResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PrepaidTextTranslateResponseBody() = default ;
    PrepaidTextTranslateResponseBody& operator=(const PrepaidTextTranslateResponseBody &) = default ;
    PrepaidTextTranslateResponseBody& operator=(PrepaidTextTranslateResponseBody &&) = default ;
    ...
    inline PrepaidTextTranslateResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const PrepaidTextTranslateResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, PrepaidTextTranslateResponseBody::Data) };
    inline PrepaidTextTranslateResponseBody::Data getData() { DARABONBA_PTR_GET(data_, PrepaidTextTranslateResponseBody::Data) };
    inline PrepaidTextTranslateResponseBody& setData(const PrepaidTextTranslateResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline PrepaidTextTranslateResponseBody& setData(PrepaidTextTranslateResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline PrepaidTextTranslateResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline PrepaidTextTranslateResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline PrepaidTextTranslateResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    shared_ptr<PrepaidTextTranslateResponseBody::Data> data_ {};
