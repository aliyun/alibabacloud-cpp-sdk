    ...
    public:
      ...
      public:
        friend void to_json(Darabonba::Json& j, const EditInfo& obj) { 
          ...
          DARABONBA_PTR_TO_JSON(GoodsUrl, goodsUrl_);
          DARABONBA_PTR_TO_JSON(Languages, languages_);
          DARABONBA_PTR_TO_JSON(PictUrl, pictUrl_);
          DARABONBA_PTR_TO_JSON(RepairedUrl, repairedUrl_);
          DARABONBA_PTR_TO_JSON(RepairedUrls, repairedUrls_);
          DARABONBA_PTR_TO_JSON(ResultImageIds, resultImageIds_);
          DARABONBA_PTR_TO_JSON(ResultUrls, resultUrls_);
        ...
        friend void from_json(const Darabonba::Json& j, EditInfo& obj) { 
          ...
          DARABONBA_PTR_FROM_JSON(GoodsUrl, goodsUrl_);
          DARABONBA_PTR_FROM_JSON(Languages, languages_);
          DARABONBA_PTR_FROM_JSON(PictUrl, pictUrl_);
          DARABONBA_PTR_FROM_JSON(RepairedUrl, repairedUrl_);
          DARABONBA_PTR_FROM_JSON(RepairedUrls, repairedUrls_);
          DARABONBA_PTR_FROM_JSON(ResultImageIds, resultImageIds_);
          DARABONBA_PTR_FROM_JSON(ResultUrls, resultUrls_);
        ...
        && this->goodsRects_ == nullptr && this->goodsUrl_ == nullptr && this->languages_ == nullptr && this->pictUrl_ == nullptr && this->repairedUrl_ == nullptr
        && this->repairedUrls_ == nullptr && this->resultImageIds_ == nullptr && this->resultUrls_ == nullptr && this->textAreas_ == nullptr; };
        ...
        // goodsUrl Field Functions 
        bool hasGoodsUrl() const { return this->goodsUrl_ != nullptr;};
        void deleteGoodsUrl() { this->goodsUrl_ = nullptr;};
        inline string getGoodsUrl() const { DARABONBA_PTR_GET_DEFAULT(goodsUrl_, "") };
        inline EditInfo& setGoodsUrl(string goodsUrl) { DARABONBA_PTR_SET_VALUE(goodsUrl_, goodsUrl) };
        ...
        // pictUrl Field Functions 
        bool hasPictUrl() const { return this->pictUrl_ != nullptr;};
        void deletePictUrl() { this->pictUrl_ = nullptr;};
        inline string getPictUrl() const { DARABONBA_PTR_GET_DEFAULT(pictUrl_, "") };
        inline EditInfo& setPictUrl(string pictUrl) { DARABONBA_PTR_SET_VALUE(pictUrl_, pictUrl) };
        ...
        // repairedUrls Field Functions 
        bool hasRepairedUrls() const { return this->repairedUrls_ != nullptr;};
        void deleteRepairedUrls() { this->repairedUrls_ = nullptr;};
        inline const vector<string> & getRepairedUrls() const { DARABONBA_PTR_GET_CONST(repairedUrls_, vector<string>) };
        inline vector<string> getRepairedUrls() { DARABONBA_PTR_GET(repairedUrls_, vector<string>) };
        inline EditInfo& setRepairedUrls(const vector<string> & repairedUrls) { DARABONBA_PTR_SET_VALUE(repairedUrls_, repairedUrls) };
        inline EditInfo& setRepairedUrls(vector<string> && repairedUrls) { DARABONBA_PTR_SET_RVALUE(repairedUrls_, repairedUrls) };
        ...
        // resultUrls Field Functions 
        bool hasResultUrls() const { return this->resultUrls_ != nullptr;};
        void deleteResultUrls() { this->resultUrls_ = nullptr;};
        inline const vector<string> & getResultUrls() const { DARABONBA_PTR_GET_CONST(resultUrls_, vector<string>) };
        inline vector<string> getResultUrls() { DARABONBA_PTR_GET(resultUrls_, vector<string>) };
        inline EditInfo& setResultUrls(const vector<string> & resultUrls) { DARABONBA_PTR_SET_VALUE(resultUrls_, resultUrls) };
        inline EditInfo& setResultUrls(vector<string> && resultUrls) { DARABONBA_PTR_SET_RVALUE(resultUrls_, resultUrls) };
      ...
      protected:
        ...
        shared_ptr<vector<string>> resultUrls_ {};
      ...
      virtual bool empty() const override { return this->editInfo_ == nullptr
        && this->imageUrl_ == nullptr && this->usageMap_ == nullptr; };
      // editInfo Field Functions 
      bool hasEditInfo() const { return this->editInfo_ != nullptr;};
      void deleteEditInfo() { this->editInfo_ = nullptr;};
      inline const Data::EditInfo & getEditInfo() const { DARABONBA_PTR_GET_CONST(editInfo_, Data::EditInfo) };
      inline Data::EditInfo getEditInfo() { DARABONBA_PTR_GET(editInfo_, Data::EditInfo) };
      inline Data& setEditInfo(const Data::EditInfo & editInfo) { DARABONBA_PTR_SET_VALUE(editInfo_, editInfo) };
      inline Data& setEditInfo(Data::EditInfo && editInfo) { DARABONBA_PTR_SET_RVALUE(editInfo_, editInfo) };
