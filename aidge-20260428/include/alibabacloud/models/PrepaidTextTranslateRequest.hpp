...
#ifndef ALIBABACLOUD_MODELS_PREPAIDTEXTTRANSLATEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_PREPAIDTEXTTRANSLATEREQUEST_HPP_
...
namespace Models
{
  class PrepaidTextTranslateRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const PrepaidTextTranslateRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PrepaidTextTranslateRequest& obj) { 
    ...
    PrepaidTextTranslateRequest() = default ;
    PrepaidTextTranslateRequest(const PrepaidTextTranslateRequest &) = default ;
    PrepaidTextTranslateRequest(PrepaidTextTranslateRequest &&) = default ;
    PrepaidTextTranslateRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PrepaidTextTranslateRequest() = default ;
    PrepaidTextTranslateRequest& operator=(const PrepaidTextTranslateRequest &) = default ;
    PrepaidTextTranslateRequest& operator=(PrepaidTextTranslateRequest &&) = default ;
    ...
    inline PrepaidTextTranslateRequest& setBizName(string bizName) { DARABONBA_PTR_SET_VALUE(bizName_, bizName) };
    ...
    inline PrepaidTextTranslateRequest& setFormatType(string formatType) { DARABONBA_PTR_SET_VALUE(formatType_, formatType) };
    ...
    inline PrepaidTextTranslateRequest& setGlossary(string glossary) { DARABONBA_PTR_SET_VALUE(glossary_, glossary) };
    ...
    inline PrepaidTextTranslateRequest& setSourceLanguage(string sourceLanguage) { DARABONBA_PTR_SET_VALUE(sourceLanguage_, sourceLanguage) };
    ...
    inline PrepaidTextTranslateRequest& setSourceTextList(const vector<string> & sourceTextList) { DARABONBA_PTR_SET_VALUE(sourceTextList_, sourceTextList) };
    inline PrepaidTextTranslateRequest& setSourceTextList(vector<string> && sourceTextList) { DARABONBA_PTR_SET_RVALUE(sourceTextList_, sourceTextList) };
    ...
    inline PrepaidTextTranslateRequest& setTargetLanguage(string targetLanguage) { DARABONBA_PTR_SET_VALUE(targetLanguage_, targetLanguage) };
    ...
    inline PrepaidTextTranslateRequest& setTranslateScene(string translateScene) { DARABONBA_PTR_SET_VALUE(translateScene_, translateScene) };
