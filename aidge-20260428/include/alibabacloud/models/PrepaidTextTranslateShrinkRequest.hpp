...
#ifndef ALIBABACLOUD_MODELS_PREPAIDTEXTTRANSLATESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_PREPAIDTEXTTRANSLATESHRINKREQUEST_HPP_
...
namespace Models
{
  class PrepaidTextTranslateShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const PrepaidTextTranslateShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PrepaidTextTranslateShrinkRequest& obj) { 
    ...
    PrepaidTextTranslateShrinkRequest() = default ;
    PrepaidTextTranslateShrinkRequest(const PrepaidTextTranslateShrinkRequest &) = default ;
    PrepaidTextTranslateShrinkRequest(PrepaidTextTranslateShrinkRequest &&) = default ;
    PrepaidTextTranslateShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PrepaidTextTranslateShrinkRequest() = default ;
    PrepaidTextTranslateShrinkRequest& operator=(const PrepaidTextTranslateShrinkRequest &) = default ;
    PrepaidTextTranslateShrinkRequest& operator=(PrepaidTextTranslateShrinkRequest &&) = default ;
    ...
    inline PrepaidTextTranslateShrinkRequest& setBizName(string bizName) { DARABONBA_PTR_SET_VALUE(bizName_, bizName) };
    ...
    inline PrepaidTextTranslateShrinkRequest& setFormatType(string formatType) { DARABONBA_PTR_SET_VALUE(formatType_, formatType) };
    ...
    inline PrepaidTextTranslateShrinkRequest& setGlossary(string glossary) { DARABONBA_PTR_SET_VALUE(glossary_, glossary) };
    ...
    inline PrepaidTextTranslateShrinkRequest& setSourceLanguage(string sourceLanguage) { DARABONBA_PTR_SET_VALUE(sourceLanguage_, sourceLanguage) };
    ...
    inline PrepaidTextTranslateShrinkRequest& setSourceTextListShrink(string sourceTextListShrink) { DARABONBA_PTR_SET_VALUE(sourceTextListShrink_, sourceTextListShrink) };
    ...
    inline PrepaidTextTranslateShrinkRequest& setTargetLanguage(string targetLanguage) { DARABONBA_PTR_SET_VALUE(targetLanguage_, targetLanguage) };
    ...
    inline PrepaidTextTranslateShrinkRequest& setTranslateScene(string translateScene) { DARABONBA_PTR_SET_VALUE(translateScene_, translateScene) };
