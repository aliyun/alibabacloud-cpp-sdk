...
#ifndef ALIBABACLOUD_MODELS_CATEGORYMATCHREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CATEGORYMATCHREQUEST_HPP_
...
namespace Models
{
  class CategoryMatchRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CategoryMatchRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CategoryMatchRequest& obj) { 
    ...
    CategoryMatchRequest() = default ;
    CategoryMatchRequest(const CategoryMatchRequest &) = default ;
    CategoryMatchRequest(CategoryMatchRequest &&) = default ;
    CategoryMatchRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CategoryMatchRequest() = default ;
    CategoryMatchRequest& operator=(const CategoryMatchRequest &) = default ;
    CategoryMatchRequest& operator=(CategoryMatchRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->description_ == nullptr
        && this->itemSpec_ == nullptr && this->sku_ == nullptr && this->sourceCategory_ == nullptr && this->sourcePlatform_ == nullptr && this->targetPlatform_ == nullptr
        && this->title_ == nullptr; };
    // description Field Functions 
    bool hasDescription() const { return this->description_ != nullptr;};
    void deleteDescription() { this->description_ = nullptr;};
    inline string getDescription() const { DARABONBA_PTR_GET_DEFAULT(description_, "") };
    inline CategoryMatchRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CategoryMatchRequest& setItemSpec(string itemSpec) { DARABONBA_PTR_SET_VALUE(itemSpec_, itemSpec) };
    ...
    inline CategoryMatchRequest& setSku(string sku) { DARABONBA_PTR_SET_VALUE(sku_, sku) };
    ...
    inline CategoryMatchRequest& setSourceCategory(string sourceCategory) { DARABONBA_PTR_SET_VALUE(sourceCategory_, sourceCategory) };
    ...
    inline CategoryMatchRequest& setSourcePlatform(string sourcePlatform) { DARABONBA_PTR_SET_VALUE(sourcePlatform_, sourcePlatform) };
    ...
    inline CategoryMatchRequest& setTargetPlatform(string targetPlatform) { DARABONBA_PTR_SET_VALUE(targetPlatform_, targetPlatform) };
    ...
    inline CategoryMatchRequest& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
