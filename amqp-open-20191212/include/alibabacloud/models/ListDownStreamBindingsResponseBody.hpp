...
#ifndef ALIBABACLOUD_MODELS_LISTDOWNSTREAMBINDINGSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTDOWNSTREAMBINDINGSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDownStreamBindingsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDownStreamBindingsResponseBody& obj) { 
    ...
    ListDownStreamBindingsResponseBody() = default ;
    ListDownStreamBindingsResponseBody(const ListDownStreamBindingsResponseBody &) = default ;
    ListDownStreamBindingsResponseBody(ListDownStreamBindingsResponseBody &&) = default ;
    ListDownStreamBindingsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDownStreamBindingsResponseBody() = default ;
    ListDownStreamBindingsResponseBody& operator=(const ListDownStreamBindingsResponseBody &) = default ;
    ListDownStreamBindingsResponseBody& operator=(ListDownStreamBindingsResponseBody &&) = default ;
    ...
    inline ListDownStreamBindingsResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ListDownStreamBindingsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListDownStreamBindingsResponseBody::Data) };
    inline ListDownStreamBindingsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListDownStreamBindingsResponseBody::Data) };
    inline ListDownStreamBindingsResponseBody& setData(const ListDownStreamBindingsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDownStreamBindingsResponseBody& setData(ListDownStreamBindingsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListDownStreamBindingsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListDownStreamBindingsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListDownStreamBindingsResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    // The returned data.
    shared_ptr<ListDownStreamBindingsResponseBody::Data> data_ {};
