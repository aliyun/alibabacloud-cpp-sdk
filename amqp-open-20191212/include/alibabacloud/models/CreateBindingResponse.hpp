...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBindingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBindingResponseBody) };
    inline CreateBindingResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBindingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBindingResponseBody> body_ {};
  };
