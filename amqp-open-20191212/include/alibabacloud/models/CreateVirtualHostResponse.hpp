...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVirtualHostResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVirtualHostResponseBody) };
    inline CreateVirtualHostResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVirtualHostResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVirtualHostResponseBody> body_ {};
  };
