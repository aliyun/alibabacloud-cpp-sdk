...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetadataAmountResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMetadataAmountResponseBodyData) };
    inline GetMetadataAmountResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMetadataAmountResponseBodyData) };
    inline GetMetadataAmountResponseBody& setData(const GetMetadataAmountResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMetadataAmountResponseBody& setData(GetMetadataAmountResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<GetMetadataAmountResponseBodyData> data_ = nullptr;
    // The request ID.
