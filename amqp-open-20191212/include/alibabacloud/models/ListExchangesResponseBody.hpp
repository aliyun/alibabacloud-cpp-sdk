...
namespace Models
{
  ...
  public:
    ...
    inline const ListExchangesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListExchangesResponseBodyData) };
    inline ListExchangesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListExchangesResponseBodyData) };
    inline ListExchangesResponseBody& setData(const ListExchangesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListExchangesResponseBody& setData(ListExchangesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<ListExchangesResponseBodyData> data_ = nullptr;
    // The request ID.
