...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->exchangeName_ != nullptr
        && this->instanceId_ != nullptr && this->maxResults_ != nullptr && this->nextToken_ != nullptr && this->virtualHost_ != nullptr; };
