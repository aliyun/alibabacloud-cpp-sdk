...
namespace Models
{
  ...
  public:
    ...
    inline CreateInstanceRequest& setAuthModel(string authModel) { DARABONBA_PTR_SET_VALUE(authModel_, authModel) };
    ...
    inline CreateInstanceRequest& setListenerMode(string listenerMode) { DARABONBA_PTR_SET_VALUE(listenerMode_, listenerMode) };
    ...
    inline CreateInstanceRequest& setServerlessSwitch(bool serverlessSwitch) { DARABONBA_PTR_SET_VALUE(serverlessSwitch_, serverlessSwitch) };
