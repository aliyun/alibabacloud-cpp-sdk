...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->autoRenew_ != nullptr
        && this->autoRenewPeriod_ != nullptr && this->clientToken_ != nullptr && this->edition_ != nullptr && this->encryptedInstance_ != nullptr && this->instanceName_ != nullptr
        && this->instanceType_ != nullptr && this->kmsKeyId_ != nullptr && this->maxConnections_ != nullptr && this->maxEipTps_ != nullptr && this->maxPrivateTps_ != nullptr
        && this->paymentType_ != nullptr && this->period_ != nullptr && this->periodCycle_ != nullptr && this->provisionedCapacity_ != nullptr && this->queueCapacity_ != nullptr
        && this->renewStatus_ != nullptr && this->renewalDurationUnit_ != nullptr && this->resourceGroupId_ != nullptr && this->serverlessChargeType_ != nullptr && this->storageSize_ != nullptr
        && this->supportEip_ != nullptr && this->supportTracing_ != nullptr && this->tracingStorageTime_ != nullptr; };
