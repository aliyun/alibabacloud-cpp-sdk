...
namespace Models
{
  ...
  public:
    ...
    inline const ListQueueConsumersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListQueueConsumersResponseBody) };
    inline ListQueueConsumersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListQueueConsumersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListQueueConsumersResponseBody> body_ {};
  };
