...
namespace Models
{
  ...
  public:
    ...
    inline const ListVirtualHostsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListVirtualHostsResponseBodyData) };
    inline ListVirtualHostsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListVirtualHostsResponseBodyData) };
    inline ListVirtualHostsResponseBody& setData(const ListVirtualHostsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListVirtualHostsResponseBody& setData(ListVirtualHostsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<ListVirtualHostsResponseBodyData> data_ = nullptr;
    // The request ID.
