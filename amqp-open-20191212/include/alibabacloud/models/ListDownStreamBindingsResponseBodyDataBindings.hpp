...
#ifndef ALIBABACLOUD_MODELS_LISTDOWNSTREAMBINDINGSRESPONSEBODYDATABINDINGS_HPP_
#define ALIBABACLOUD_MODELS_LISTDOWNSTREAMBINDINGSRESPONSEBODYDATABINDINGS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDownStreamBindingsResponseBodyDataBindings& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDownStreamBindingsResponseBodyDataBindings& obj) { 
    ...
    ListDownStreamBindingsResponseBodyDataBindings() = default ;
    ListDownStreamBindingsResponseBodyDataBindings(const ListDownStreamBindingsResponseBodyDataBindings &) = default ;
    ListDownStreamBindingsResponseBodyDataBindings(ListDownStreamBindingsResponseBodyDataBindings &&) = default ;
    ListDownStreamBindingsResponseBodyDataBindings(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDownStreamBindingsResponseBodyDataBindings() = default ;
    ListDownStreamBindingsResponseBodyDataBindings& operator=(const ListDownStreamBindingsResponseBodyDataBindings &) = default ;
    ListDownStreamBindingsResponseBodyDataBindings& operator=(ListDownStreamBindingsResponseBodyDataBindings &&) = default ;
    ...
    inline ListDownStreamBindingsResponseBodyDataBindings& setArgument(string argument) { DARABONBA_PTR_SET_VALUE(argument_, argument) };
    ...
    inline ListDownStreamBindingsResponseBodyDataBindings& setBindingKey(string bindingKey) { DARABONBA_PTR_SET_VALUE(bindingKey_, bindingKey) };
    ...
    inline ListDownStreamBindingsResponseBodyDataBindings& setBindingType(string bindingType) { DARABONBA_PTR_SET_VALUE(bindingType_, bindingType) };
    ...
    inline ListDownStreamBindingsResponseBodyDataBindings& setDestinationName(string destinationName) { DARABONBA_PTR_SET_VALUE(destinationName_, destinationName) };
    ...
    inline ListDownStreamBindingsResponseBodyDataBindings& setSourceExchange(string sourceExchange) { DARABONBA_PTR_SET_VALUE(sourceExchange_, sourceExchange) };
