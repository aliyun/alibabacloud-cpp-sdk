...
namespace Models
{
  ...
  public:
    ...
    inline const ListExchangeUpStreamBindingsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListExchangeUpStreamBindingsResponseBody::Data) };
    inline ListExchangeUpStreamBindingsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListExchangeUpStreamBindingsResponseBody::Data) };
    inline ListExchangeUpStreamBindingsResponseBody& setData(const ListExchangeUpStreamBindingsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListExchangeUpStreamBindingsResponseBody& setData(ListExchangeUpStreamBindingsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    shared_ptr<ListExchangeUpStreamBindingsResponseBody::Data> data_ {};
