...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->autoRenewInstance_ != nullptr
        ...
        && this->instanceName_ != nullptr && this->instanceType_ != nullptr && this->kmsKeyId_ != nullptr && this->maxEipTps_ != nullptr && this->maxQueue_ != nullptr
        && this->maxTps_ != nullptr && this->maxVhost_ != nullptr && this->orderCreateTime_ != nullptr && this->orderType_ != nullptr && this->privateEndpoint_ != nullptr
        && this->provisionedCapacity_ != nullptr && this->publicEndpoint_ != nullptr && this->resourceGroupId_ != nullptr && this->status_ != nullptr && this->storageSize_ != nullptr
