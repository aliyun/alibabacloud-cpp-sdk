...
namespace Models
{
  ...
  public:
    ...
    inline CreateInstanceResponseBody& setData(const Darabonba::Json & data) { DARABONBA_SET_VALUE(data_, data) };
    inline CreateInstanceResponseBody& setData(Darabonba::Json & data) { DARABONBA_SET_RVALUE(data_, data) };
