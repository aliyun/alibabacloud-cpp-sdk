...
namespace Models
{
  ...
  public:
    ...
    inline const ListDownStreamBindingsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDownStreamBindingsResponseBody) };
    inline ListDownStreamBindingsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDownStreamBindingsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDownStreamBindingsResponseBody> body_ {};
  };
