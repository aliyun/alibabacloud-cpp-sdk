...
#ifndef ALIBABACLOUD_MODELS_LISTEXCHANGEUPSTREAMBINDINGSRESPONSEBODYDATABINDINGS_HPP_
#define ALIBABACLOUD_MODELS_LISTEXCHANGEUPSTREAMBINDINGSRESPONSEBODYDATABINDINGS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListExchangeUpStreamBindingsResponseBodyDataBindings& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListExchangeUpStreamBindingsResponseBodyDataBindings& obj) { 
    ...
    ListExchangeUpStreamBindingsResponseBodyDataBindings() = default ;
    ListExchangeUpStreamBindingsResponseBodyDataBindings(const ListExchangeUpStreamBindingsResponseBodyDataBindings &) = default ;
    ListExchangeUpStreamBindingsResponseBodyDataBindings(ListExchangeUpStreamBindingsResponseBodyDataBindings &&) = default ;
    ListExchangeUpStreamBindingsResponseBodyDataBindings(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListExchangeUpStreamBindingsResponseBodyDataBindings() = default ;
    ListExchangeUpStreamBindingsResponseBodyDataBindings& operator=(const ListExchangeUpStreamBindingsResponseBodyDataBindings &) = default ;
    ListExchangeUpStreamBindingsResponseBodyDataBindings& operator=(ListExchangeUpStreamBindingsResponseBodyDataBindings &&) = default ;
    ...
    inline ListExchangeUpStreamBindingsResponseBodyDataBindings& setArgument(string argument) { DARABONBA_PTR_SET_VALUE(argument_, argument) };
    ...
    inline ListExchangeUpStreamBindingsResponseBodyDataBindings& setBindingKey(string bindingKey) { DARABONBA_PTR_SET_VALUE(bindingKey_, bindingKey) };
    ...
    inline ListExchangeUpStreamBindingsResponseBodyDataBindings& setBindingType(string bindingType) { DARABONBA_PTR_SET_VALUE(bindingType_, bindingType) };
    ...
    inline ListExchangeUpStreamBindingsResponseBodyDataBindings& setDestinationName(string destinationName) { DARABONBA_PTR_SET_VALUE(destinationName_, destinationName) };
    ...
    inline ListExchangeUpStreamBindingsResponseBodyDataBindings& setSourceExchange(string sourceExchange) { DARABONBA_PTR_SET_VALUE(sourceExchange_, sourceExchange) };
