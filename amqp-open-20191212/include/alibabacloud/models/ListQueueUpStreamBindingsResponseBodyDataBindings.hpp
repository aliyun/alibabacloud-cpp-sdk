...
#ifndef ALIBABACLOUD_MODELS_LISTQUEUEUPSTREAMBINDINGSRESPONSEBODYDATABINDINGS_HPP_
#define ALIBABACLOUD_MODELS_LISTQUEUEUPSTREAMBINDINGSRESPONSEBODYDATABINDINGS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListQueueUpStreamBindingsResponseBodyDataBindings& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListQueueUpStreamBindingsResponseBodyDataBindings& obj) { 
    ...
    ListQueueUpStreamBindingsResponseBodyDataBindings() = default ;
    ListQueueUpStreamBindingsResponseBodyDataBindings(const ListQueueUpStreamBindingsResponseBodyDataBindings &) = default ;
    ListQueueUpStreamBindingsResponseBodyDataBindings(ListQueueUpStreamBindingsResponseBodyDataBindings &&) = default ;
    ListQueueUpStreamBindingsResponseBodyDataBindings(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListQueueUpStreamBindingsResponseBodyDataBindings() = default ;
    ListQueueUpStreamBindingsResponseBodyDataBindings& operator=(const ListQueueUpStreamBindingsResponseBodyDataBindings &) = default ;
    ListQueueUpStreamBindingsResponseBodyDataBindings& operator=(ListQueueUpStreamBindingsResponseBodyDataBindings &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->argument_ == nullptr
        && return this->bindingKey_ == nullptr && return this->bindingType_ == nullptr && return this->destinationName_ == nullptr && return this->sourceExchange_ == nullptr; };
    ...
    inline ListQueueUpStreamBindingsResponseBodyDataBindings& setArgument(string argument) { DARABONBA_PTR_SET_VALUE(argument_, argument) };
    ...
    inline ListQueueUpStreamBindingsResponseBodyDataBindings& setBindingKey(string bindingKey) { DARABONBA_PTR_SET_VALUE(bindingKey_, bindingKey) };
    ...
    inline ListQueueUpStreamBindingsResponseBodyDataBindings& setBindingType(string bindingType) { DARABONBA_PTR_SET_VALUE(bindingType_, bindingType) };
    ...
    inline ListQueueUpStreamBindingsResponseBodyDataBindings& setDestinationName(string destinationName) { DARABONBA_PTR_SET_VALUE(destinationName_, destinationName) };
    ...
    inline ListQueueUpStreamBindingsResponseBodyDataBindings& setSourceExchange(string sourceExchange) { DARABONBA_PTR_SET_VALUE(sourceExchange_, sourceExchange) };
