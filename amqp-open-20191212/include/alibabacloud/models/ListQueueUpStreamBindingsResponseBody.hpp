...
namespace Models
{
  ...
  public:
    ...
    inline const ListQueueUpStreamBindingsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListQueueUpStreamBindingsResponseBody::Data) };
    inline ListQueueUpStreamBindingsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListQueueUpStreamBindingsResponseBody::Data) };
    inline ListQueueUpStreamBindingsResponseBody& setData(const ListQueueUpStreamBindingsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListQueueUpStreamBindingsResponseBody& setData(ListQueueUpStreamBindingsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    shared_ptr<ListQueueUpStreamBindingsResponseBody::Data> data_ {};
    // The request ID.
