...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteBindingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteBindingResponseBody) };
    inline DeleteBindingResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteBindingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteBindingResponseBody> body_ {};
  };
