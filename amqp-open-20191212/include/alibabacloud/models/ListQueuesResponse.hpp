...
namespace Models
{
  ...
  public:
    ...
    inline const ListQueuesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListQueuesResponseBody) };
    inline ListQueuesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListQueuesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListQueuesResponseBody> body_ {};
  };
