...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitSymbolicResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitSymbolicResponseBody) };
    inline SubmitSymbolicResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitSymbolicResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitSymbolicResponseBody> body_ {};
  };
