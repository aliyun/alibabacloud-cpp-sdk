...
namespace Models
{
  ...
  public:
    ...
    inline const GetIssuesResponseBodyModel & model() const { DARABONBA_PTR_GET_CONST(model_, GetIssuesResponseBodyModel) };
    inline GetIssuesResponseBodyModel model() { DARABONBA_PTR_GET(model_, GetIssuesResponseBodyModel) };
    inline GetIssuesResponseBody& setModel(const GetIssuesResponseBodyModel & model) { DARABONBA_PTR_SET_VALUE(model_, model) };
    inline GetIssuesResponseBody& setModel(GetIssuesResponseBodyModel && model) { DARABONBA_PTR_SET_RVALUE(model_, model) };
  ...
  protected:
    ...
    std::shared_ptr<GetIssuesResponseBodyModel> model_ = nullptr;
