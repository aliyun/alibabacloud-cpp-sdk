...
namespace Models
{
  ...
  public:
    ...
    inline const GetIssuesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetIssuesResponseBody) };
    inline GetIssuesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetIssuesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetIssuesResponseBody> body_ {};
  };
