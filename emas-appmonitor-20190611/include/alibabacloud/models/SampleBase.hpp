...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->fullSampleDeviceIds_ == nullptr
    ...
    inline const vector<FullSampleItem> & getFullSampleDeviceIds() const { DARABONBA_PTR_GET_CONST(fullSampleDeviceIds_, vector<FullSampleItem>) };
    inline vector<FullSampleItem> getFullSampleDeviceIds() { DARABONBA_PTR_GET(fullSampleDeviceIds_, vector<FullSampleItem>) };
    ...
    inline const vector<FullSampleItem> & getFullSampleUsers() const { DARABONBA_PTR_GET_CONST(fullSampleUsers_, vector<FullSampleItem>) };
    inline vector<FullSampleItem> getFullSampleUsers() { DARABONBA_PTR_GET(fullSampleUsers_, vector<FullSampleItem>) };
    ...
    inline string getSampleMethod() const { DARABONBA_PTR_GET_DEFAULT(sampleMethod_, "") };
  ...
  protected:
    shared_ptr<vector<FullSampleItem>> fullSampleDeviceIds_ {};
    shared_ptr<vector<FullSampleItem>> fullSampleUsers_ {};
    shared_ptr<string> sampleMethod_ {};
