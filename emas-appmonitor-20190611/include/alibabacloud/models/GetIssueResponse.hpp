...
namespace Models
{
  ...
  public:
    ...
    inline const GetIssueResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetIssueResponseBody) };
    inline GetIssueResponseBody getBody() { DARABONBA_PTR_GET(body_, GetIssueResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetIssueResponseBody> body_ {};
  };
