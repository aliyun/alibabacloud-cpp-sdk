...
namespace Models
{
  ...
  public:
    ...
    inline const GetSymbolicFilesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSymbolicFilesResponseBody) };
    inline GetSymbolicFilesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSymbolicFilesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSymbolicFilesResponseBody> body_ {};
  };
