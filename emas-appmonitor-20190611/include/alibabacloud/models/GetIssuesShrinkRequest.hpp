...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetIssuesShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetIssuesShrinkRequest& obj) { 
    ...
    GetIssuesShrinkRequest() = default ;
    GetIssuesShrinkRequest(const GetIssuesShrinkRequest &) = default ;
    GetIssuesShrinkRequest(GetIssuesShrinkRequest &&) = default ;
    GetIssuesShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetIssuesShrinkRequest() = default ;
    GetIssuesShrinkRequest& operator=(const GetIssuesShrinkRequest &) = default ;
    GetIssuesShrinkRequest& operator=(GetIssuesShrinkRequest &&) = default ;
