...
namespace Models
{
  ...
  public:
    ...
    inline const GetErrorsShrinkRequest::TimeRange & getTimeRange() const { DARABONBA_PTR_GET_CONST(timeRange_, GetErrorsShrinkRequest::TimeRange) };
    inline GetErrorsShrinkRequest::TimeRange getTimeRange() { DARABONBA_PTR_GET(timeRange_, GetErrorsShrinkRequest::TimeRange) };
    inline GetErrorsShrinkRequest& setTimeRange(const GetErrorsShrinkRequest::TimeRange & timeRange) { DARABONBA_PTR_SET_VALUE(timeRange_, timeRange) };
    inline GetErrorsShrinkRequest& setTimeRange(GetErrorsShrinkRequest::TimeRange && timeRange) { DARABONBA_PTR_SET_RVALUE(timeRange_, timeRange) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<GetErrorsShrinkRequest::TimeRange> timeRange_ {};
    // utdid
