...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->callerContext_ == nullptr
        && this->id_ == nullptr && this->jsonrpc_ == nullptr && this->params_ == nullptr; };
    ...
    inline PromptAgentSessionRequest& setCallerContext(string callerContext) { DARABONBA_PTR_SET_VALUE(callerContext_, callerContext) };
