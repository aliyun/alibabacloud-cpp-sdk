...
namespace Models
{
  ...
  public:
    ...
    inline const GetIqsUsageResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetIqsUsageResult) };
    inline GetIqsUsageResult getBody() { DARABONBA_PTR_GET(body_, GetIqsUsageResult) };
  ...
  protected:
    ...
    shared_ptr<GetIqsUsageResult> body_ {};
  };
