...
namespace Models
{
  ...
  public:
    ...
    inline const ReadPageScrapeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReadPageScrapeResponseBody) };
    inline ReadPageScrapeResponseBody getBody() { DARABONBA_PTR_GET(body_, ReadPageScrapeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReadPageScrapeResponseBody> body_ {};
  };
