...
namespace Models
{
  ...
  public:
    ...
    inline const GlobalSearchResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, GlobalSearchResult) };
    inline GlobalSearchResult getBody() { DARABONBA_PTR_GET(body_, GlobalSearchResult) };
  ...
  protected:
    ...
    shared_ptr<GlobalSearchResult> body_ {};
  };
