...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorMessage_ == nullptr
        && this->html_ == nullptr && this->markdown_ == nullptr && this->rawHtml_ == nullptr && this->screenshot_ == nullptr && this->statusCode_ == nullptr
        && this->text_ == nullptr; };
    ...
    inline string getMarkdown() const { DARABONBA_PTR_GET_DEFAULT(markdown_, "") };
    ...
    inline string getRawHtml() const { DARABONBA_PTR_GET_DEFAULT(rawHtml_, "") };
