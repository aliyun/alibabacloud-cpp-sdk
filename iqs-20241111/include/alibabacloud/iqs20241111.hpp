...
public:
  ...
  shared_ptr<long> billingQps{};
  shared_ptr<string> date{};
  shared_ptr<string> engineType{};
  shared_ptr<long> failedCalls{};
  shared_ptr<string> ladderType{};
  shared_ptr<string> mainAccountId{};
  shared_ptr<string> subAccountId{};
  shared_ptr<long> successCalls{};
  shared_ptr<long> totalCalls{};
  shared_ptr<long> valueAddedAdvanced{};
  shared_ptr<long> valueAddedSummary{};

  GetIqsUsageResultRecords() {}

  explicit GetIqsUsageResultRecords(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (billingQps) {
      res["billingQps"] = boost::any(*billingQps);
    }
    if (date) {
    ...
    if (ladderType) {
      res["ladderType"] = boost::any(*ladderType);
    }
    if (mainAccountId) {
      res["mainAccountId"] = boost::any(*mainAccountId);
    }
    if (subAccountId) {
      res["subAccountId"] = boost::any(*subAccountId);
    }
    if (successCalls) {
      res["successCalls"] = boost::any(*successCalls);
    }
    if (totalCalls) {
      res["totalCalls"] = boost::any(*totalCalls);
    }
    if (valueAddedAdvanced) {
      res["valueAddedAdvanced"] = boost::any(*valueAddedAdvanced);
    }
    if (valueAddedSummary) {
      res["valueAddedSummary"] = boost::any(*valueAddedSummary);
    }
    return res;
  }
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("billingQps") != m.end() && !m["billingQps"].empty()) {
      billingQps = make_shared<long>(boost::any_cast<long>(m["billingQps"]));
    }
    ...
    if (m.find("ladderType") != m.end() && !m["ladderType"].empty()) {
      ladderType = make_shared<string>(boost::any_cast<string>(m["ladderType"]));
    }
    if (m.find("mainAccountId") != m.end() && !m["mainAccountId"].empty()) {
      mainAccountId = make_shared<string>(boost::any_cast<string>(m["mainAccountId"]));
    }
    if (m.find("subAccountId") != m.end() && !m["subAccountId"].empty()) {
      subAccountId = make_shared<string>(boost::any_cast<string>(m["subAccountId"]));
    }
    if (m.find("successCalls") != m.end() && !m["successCalls"].empty()) {
      successCalls = make_shared<long>(boost::any_cast<long>(m["successCalls"]));
    }
    if (m.find("totalCalls") != m.end() && !m["totalCalls"].empty()) {
      totalCalls = make_shared<long>(boost::any_cast<long>(m["totalCalls"]));
    }
    if (m.find("valueAddedAdvanced") != m.end() && !m["valueAddedAdvanced"].empty()) {
      valueAddedAdvanced = make_shared<long>(boost::any_cast<long>(m["valueAddedAdvanced"]));
    }
    if (m.find("valueAddedSummary") != m.end() && !m["valueAddedSummary"].empty()) {
      valueAddedSummary = make_shared<long>(boost::any_cast<long>(m["valueAddedSummary"]));
    }
  }
...
public:
  shared_ptr<vector<GetIqsUsageResultRecords>> records{};

  GetIqsUsageResult() {}

  explicit GetIqsUsageResult(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("records") != m.end() && !m["records"].empty()) {
      if (typeid(vector<boost::any>) == m["records"].type()) {
        vector<GetIqsUsageResultRecords> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["records"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            GetIqsUsageResultRecords model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        records = make_shared<vector<GetIqsUsageResultRecords>>(expect1);
      }
    }
  }
...
public:
  ...
  explicit UnifiedSearchInput(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  explicit UnifiedSearchOutput(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  explicit GetIqsUsageRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<GetIqsUsageResult> body{};

  GetIqsUsageResponse() {}

  explicit GetIqsUsageResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        GetIqsUsageResult model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<GetIqsUsageResult>(model1);
      }
    }
  }
...
public:
  shared_ptr<UnifiedSearchInput> body{};
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        UnifiedSearchInput model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<UnifiedSearchInput>(model1);
      }
    }
  }
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<UnifiedSearchOutput> body{};
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        UnifiedSearchOutput model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<UnifiedSearchOutput>(model1);
      }
    }
  }
...
public:
  ...
  GetIqsUsageResponse getIqsUsageWithOptions(shared_ptr<GetIqsUsageRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  GetIqsUsageResponse getIqsUsage(shared_ptr<GetIqsUsageRequest> request);
  ...
  UnifiedSearchResponse unifiedSearchWithOptions(shared_ptr<UnifiedSearchRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  UnifiedSearchResponse unifiedSearch(shared_ptr<UnifiedSearchRequest> request);
