...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataInterval_ == nullptr
        && return this->domainName_ == nullptr && return this->endTime_ == nullptr && return this->realTimeSrcTrafficDataPerInterval_ == nullptr && return this->requestId_ == nullptr && return this->startTime_ == nullptr; };
    ...
    inline const DescribeDomainRealTimeSrcTrafficDataResponseBodyRealTimeSrcTrafficDataPerInterval & realTimeSrcTrafficDataPerInterval() const { DARABONBA_PTR_GET_CONST(realTimeSrcTrafficDataPerInterval_, DescribeDomainRealTimeSrcTrafficDataResponseBodyRealTimeSrcTrafficDataPerInterval) };
    inline DescribeDomainRealTimeSrcTrafficDataResponseBodyRealTimeSrcTrafficDataPerInterval realTimeSrcTrafficDataPerInterval() { DARABONBA_PTR_GET(realTimeSrcTrafficDataPerInterval_, DescribeDomainRealTimeSrcTrafficDataResponseBodyRealTimeSrcTrafficDataPerInterval) };
    inline DescribeDomainRealTimeSrcTrafficDataResponseBody& setRealTimeSrcTrafficDataPerInterval(const DescribeDomainRealTimeSrcTrafficDataResponseBodyRealTimeSrcTrafficDataPerInterval & realTimeSrcTrafficDataPerInterval) { DARABONBA_PTR_SET_VALUE(realTimeSrcTrafficDataPerInterval_, realTimeSrcTrafficDataPerInterval) };
    inline DescribeDomainRealTimeSrcTrafficDataResponseBody& setRealTimeSrcTrafficDataPerInterval(DescribeDomainRealTimeSrcTrafficDataResponseBodyRealTimeSrcTrafficDataPerInterval && realTimeSrcTrafficDataPerInterval) { DARABONBA_PTR_SET_RVALUE(realTimeSrcTrafficDataPerInterval_, realTimeSrcTrafficDataPerInterval) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDomainRealTimeSrcTrafficDataResponseBodyRealTimeSrcTrafficDataPerInterval> realTimeSrcTrafficDataPerInterval_ = nullptr;
