...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnDomainLogsExTtlResponseBody::DomainLogDetails & getDomainLogDetails() const { DARABONBA_PTR_GET_CONST(domainLogDetails_, DescribeCdnDomainLogsExTtlResponseBody::DomainLogDetails) };
    inline DescribeCdnDomainLogsExTtlResponseBody::DomainLogDetails getDomainLogDetails() { DARABONBA_PTR_GET(domainLogDetails_, DescribeCdnDomainLogsExTtlResponseBody::DomainLogDetails) };
    inline DescribeCdnDomainLogsExTtlResponseBody& setDomainLogDetails(const DescribeCdnDomainLogsExTtlResponseBody::DomainLogDetails & domainLogDetails) { DARABONBA_PTR_SET_VALUE(domainLogDetails_, domainLogDetails) };
    inline DescribeCdnDomainLogsExTtlResponseBody& setDomainLogDetails(DescribeCdnDomainLogsExTtlResponseBody::DomainLogDetails && domainLogDetails) { DARABONBA_PTR_SET_RVALUE(domainLogDetails_, domainLogDetails) };
  ...
  protected:
    shared_ptr<DescribeCdnDomainLogsExTtlResponseBody::DomainLogDetails> domainLogDetails_ {};
