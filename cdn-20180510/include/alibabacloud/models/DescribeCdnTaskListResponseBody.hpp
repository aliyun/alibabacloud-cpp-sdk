...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECDNTASKLISTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECDNTASKLISTRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeCdnTaskListResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeCdnTaskListResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Content, content_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeCdnTaskListResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Content, content_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DescribeCdnTaskListResponseBody() = default ;
    DescribeCdnTaskListResponseBody(const DescribeCdnTaskListResponseBody &) = default ;
    DescribeCdnTaskListResponseBody(DescribeCdnTaskListResponseBody &&) = default ;
    DescribeCdnTaskListResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeCdnTaskListResponseBody() = default ;
    DescribeCdnTaskListResponseBody& operator=(const DescribeCdnTaskListResponseBody &) = default ;
    DescribeCdnTaskListResponseBody& operator=(DescribeCdnTaskListResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->count_ == nullptr
        && this->list_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr; };
      // count Field Functions 
      bool hasCount() const { return this->count_ != nullptr;};
      void deleteCount() { this->count_ = nullptr;};
      inline int64_t getCount() const { DARABONBA_PTR_GET_DEFAULT(count_, 0L) };
      inline Content& setCount(int64_t count) { DARABONBA_PTR_SET_VALUE(count_, count) };
    ...
    inline const DescribeCdnTaskListResponseBody::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, DescribeCdnTaskListResponseBody::Content) };
    inline DescribeCdnTaskListResponseBody::Content getContent() { DARABONBA_PTR_GET(content_, DescribeCdnTaskListResponseBody::Content) };
    inline DescribeCdnTaskListResponseBody& setContent(const DescribeCdnTaskListResponseBody::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline DescribeCdnTaskListResponseBody& setContent(DescribeCdnTaskListResponseBody::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
    ...
    inline DescribeCdnTaskListResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<DescribeCdnTaskListResponseBody::Content> content_ {};
