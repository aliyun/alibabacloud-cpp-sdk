...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnDomainByCertificateResponseBody::CertInfos & getCertInfos() const { DARABONBA_PTR_GET_CONST(certInfos_, DescribeCdnDomainByCertificateResponseBody::CertInfos) };
    inline DescribeCdnDomainByCertificateResponseBody::CertInfos getCertInfos() { DARABONBA_PTR_GET(certInfos_, DescribeCdnDomainByCertificateResponseBody::CertInfos) };
    inline DescribeCdnDomainByCertificateResponseBody& setCertInfos(const DescribeCdnDomainByCertificateResponseBody::CertInfos & certInfos) { DARABONBA_PTR_SET_VALUE(certInfos_, certInfos) };
    inline DescribeCdnDomainByCertificateResponseBody& setCertInfos(DescribeCdnDomainByCertificateResponseBody::CertInfos && certInfos) { DARABONBA_PTR_SET_RVALUE(certInfos_, certInfos) };
  ...
  protected:
    shared_ptr<DescribeCdnDomainByCertificateResponseBody::CertInfos> certInfos_ {};
