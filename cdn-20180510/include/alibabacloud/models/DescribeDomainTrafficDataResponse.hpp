...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainTrafficDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainTrafficDataResponseBody) };
    inline DescribeDomainTrafficDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainTrafficDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainTrafficDataResponseBody> body_ {};
  };
