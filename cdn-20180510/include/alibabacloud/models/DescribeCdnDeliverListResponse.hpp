...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnDeliverListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnDeliverListResponseBody) };
    inline DescribeCdnDeliverListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnDeliverListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnDeliverListResponseBody> body_ {};
  };
