...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserVipsByDomainResponseBody::Vips & getVips() const { DARABONBA_PTR_GET_CONST(vips_, DescribeUserVipsByDomainResponseBody::Vips) };
    inline DescribeUserVipsByDomainResponseBody::Vips getVips() { DARABONBA_PTR_GET(vips_, DescribeUserVipsByDomainResponseBody::Vips) };
    inline DescribeUserVipsByDomainResponseBody& setVips(const DescribeUserVipsByDomainResponseBody::Vips & vips) { DARABONBA_PTR_SET_VALUE(vips_, vips) };
    inline DescribeUserVipsByDomainResponseBody& setVips(DescribeUserVipsByDomainResponseBody::Vips && vips) { DARABONBA_PTR_SET_RVALUE(vips_, vips) };
  ...
  protected:
    ...
    shared_ptr<DescribeUserVipsByDomainResponseBody::Vips> vips_ {};
  };
