...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataInterval_ == nullptr
        && return this->domainName_ == nullptr && return this->endTime_ == nullptr && return this->layer_ == nullptr && return this->qpsDataInterval_ == nullptr && return this->requestId_ == nullptr
    ...
    inline const DescribeDomainQpsDataByLayerResponseBodyQpsDataInterval & qpsDataInterval() const { DARABONBA_PTR_GET_CONST(qpsDataInterval_, DescribeDomainQpsDataByLayerResponseBodyQpsDataInterval) };
    inline DescribeDomainQpsDataByLayerResponseBodyQpsDataInterval qpsDataInterval() { DARABONBA_PTR_GET(qpsDataInterval_, DescribeDomainQpsDataByLayerResponseBodyQpsDataInterval) };
    inline DescribeDomainQpsDataByLayerResponseBody& setQpsDataInterval(const DescribeDomainQpsDataByLayerResponseBodyQpsDataInterval & qpsDataInterval) { DARABONBA_PTR_SET_VALUE(qpsDataInterval_, qpsDataInterval) };
    inline DescribeDomainQpsDataByLayerResponseBody& setQpsDataInterval(DescribeDomainQpsDataByLayerResponseBodyQpsDataInterval && qpsDataInterval) { DARABONBA_PTR_SET_RVALUE(qpsDataInterval_, qpsDataInterval) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDomainQpsDataByLayerResponseBodyQpsDataInterval> qpsDataInterval_ = nullptr;
