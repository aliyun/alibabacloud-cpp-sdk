...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainRealTimeHttpCodeDataResponseBody::RealTimeHttpCodeData & getRealTimeHttpCodeData() const { DARABONBA_PTR_GET_CONST(realTimeHttpCodeData_, DescribeDomainRealTimeHttpCodeDataResponseBody::RealTimeHttpCodeData) };
    inline DescribeDomainRealTimeHttpCodeDataResponseBody::RealTimeHttpCodeData getRealTimeHttpCodeData() { DARABONBA_PTR_GET(realTimeHttpCodeData_, DescribeDomainRealTimeHttpCodeDataResponseBody::RealTimeHttpCodeData) };
    inline DescribeDomainRealTimeHttpCodeDataResponseBody& setRealTimeHttpCodeData(const DescribeDomainRealTimeHttpCodeDataResponseBody::RealTimeHttpCodeData & realTimeHttpCodeData) { DARABONBA_PTR_SET_VALUE(realTimeHttpCodeData_, realTimeHttpCodeData) };
    inline DescribeDomainRealTimeHttpCodeDataResponseBody& setRealTimeHttpCodeData(DescribeDomainRealTimeHttpCodeDataResponseBody::RealTimeHttpCodeData && realTimeHttpCodeData) { DARABONBA_PTR_SET_RVALUE(realTimeHttpCodeData_, realTimeHttpCodeData) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainRealTimeHttpCodeDataResponseBody::RealTimeHttpCodeData> realTimeHttpCodeData_ {};
