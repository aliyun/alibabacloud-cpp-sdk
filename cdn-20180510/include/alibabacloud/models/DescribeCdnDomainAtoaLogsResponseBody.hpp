...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnDomainAtoaLogsResponseBody::DomainLogDetails & getDomainLogDetails() const { DARABONBA_PTR_GET_CONST(domainLogDetails_, DescribeCdnDomainAtoaLogsResponseBody::DomainLogDetails) };
    inline DescribeCdnDomainAtoaLogsResponseBody::DomainLogDetails getDomainLogDetails() { DARABONBA_PTR_GET(domainLogDetails_, DescribeCdnDomainAtoaLogsResponseBody::DomainLogDetails) };
    inline DescribeCdnDomainAtoaLogsResponseBody& setDomainLogDetails(const DescribeCdnDomainAtoaLogsResponseBody::DomainLogDetails & domainLogDetails) { DARABONBA_PTR_SET_VALUE(domainLogDetails_, domainLogDetails) };
    inline DescribeCdnDomainAtoaLogsResponseBody& setDomainLogDetails(DescribeCdnDomainAtoaLogsResponseBody::DomainLogDetails && domainLogDetails) { DARABONBA_PTR_SET_RVALUE(domainLogDetails_, domainLogDetails) };
  ...
  protected:
    shared_ptr<DescribeCdnDomainAtoaLogsResponseBody::DomainLogDetails> domainLogDetails_ {};
