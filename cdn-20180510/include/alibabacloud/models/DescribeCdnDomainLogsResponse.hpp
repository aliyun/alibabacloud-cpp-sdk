...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnDomainLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnDomainLogsResponseBody) };
    inline DescribeCdnDomainLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnDomainLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnDomainLogsResponseBody> body_ {};
  };
