...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->area_ == nullptr
        && return this->domainName_ == nullptr && return this->endTime_ == nullptr && return this->httpCode_ == nullptr && return this->isOverseas_ == nullptr && return this->reportId_ == nullptr
