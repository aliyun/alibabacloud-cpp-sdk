...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeCdnConditionIPBInfoResponseBody::Datas> & getDatas() const { DARABONBA_PTR_GET_CONST(datas_, vector<DescribeCdnConditionIPBInfoResponseBody::Datas>) };
    inline vector<DescribeCdnConditionIPBInfoResponseBody::Datas> getDatas() { DARABONBA_PTR_GET(datas_, vector<DescribeCdnConditionIPBInfoResponseBody::Datas>) };
    inline DescribeCdnConditionIPBInfoResponseBody& setDatas(const vector<DescribeCdnConditionIPBInfoResponseBody::Datas> & datas) { DARABONBA_PTR_SET_VALUE(datas_, datas) };
    inline DescribeCdnConditionIPBInfoResponseBody& setDatas(vector<DescribeCdnConditionIPBInfoResponseBody::Datas> && datas) { DARABONBA_PTR_SET_RVALUE(datas_, datas) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeCdnConditionIPBInfoResponseBody::Datas>> datas_ {};
    // The request ID.
