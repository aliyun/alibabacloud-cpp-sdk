...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allowPct_ == nullptr
        && this->domainName_ == nullptr && this->gapTime_ == nullptr && this->maxTimeWait_ == nullptr && this->waitUri_ == nullptr && this->waitUrl_ == nullptr; };
    // allowPct Field Functions 
    bool hasAllowPct() const { return this->allowPct_ != nullptr;};
    void deleteAllowPct() { this->allowPct_ = nullptr;};
    inline int32_t getAllowPct() const { DARABONBA_PTR_GET_DEFAULT(allowPct_, 0) };
    ...
    inline int32_t getGapTime() const { DARABONBA_PTR_GET_DEFAULT(gapTime_, 0) };
    ...
    inline int32_t getMaxTimeWait() const { DARABONBA_PTR_GET_DEFAULT(maxTimeWait_, 0) };
    ...
    inline string getWaitUri() const { DARABONBA_PTR_GET_DEFAULT(waitUri_, "") };
    ...
    inline string getWaitUrl() const { DARABONBA_PTR_GET_DEFAULT(waitUrl_, "") };
