...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteUserUsageDataExportTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteUserUsageDataExportTaskResponseBody) };
    inline DeleteUserUsageDataExportTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteUserUsageDataExportTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteUserUsageDataExportTaskResponseBody> body_ {};
  };
