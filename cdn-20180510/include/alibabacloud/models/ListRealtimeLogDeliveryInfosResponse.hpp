...
namespace Models
{
  ...
  public:
    ...
    inline const ListRealtimeLogDeliveryInfosResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRealtimeLogDeliveryInfosResponseBody) };
    inline ListRealtimeLogDeliveryInfosResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRealtimeLogDeliveryInfosResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRealtimeLogDeliveryInfosResponseBody> body_ {};
  };
