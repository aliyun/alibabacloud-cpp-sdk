...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFCTriggerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateFCTriggerResponseBody) };
    inline UpdateFCTriggerResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateFCTriggerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateFCTriggerResponseBody> body_ {};
  };
