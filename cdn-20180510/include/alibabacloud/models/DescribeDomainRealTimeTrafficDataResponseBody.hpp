...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainRealTimeTrafficDataResponseBody::RealTimeTrafficDataPerInterval & getRealTimeTrafficDataPerInterval() const { DARABONBA_PTR_GET_CONST(realTimeTrafficDataPerInterval_, DescribeDomainRealTimeTrafficDataResponseBody::RealTimeTrafficDataPerInterval) };
    inline DescribeDomainRealTimeTrafficDataResponseBody::RealTimeTrafficDataPerInterval getRealTimeTrafficDataPerInterval() { DARABONBA_PTR_GET(realTimeTrafficDataPerInterval_, DescribeDomainRealTimeTrafficDataResponseBody::RealTimeTrafficDataPerInterval) };
    inline DescribeDomainRealTimeTrafficDataResponseBody& setRealTimeTrafficDataPerInterval(const DescribeDomainRealTimeTrafficDataResponseBody::RealTimeTrafficDataPerInterval & realTimeTrafficDataPerInterval) { DARABONBA_PTR_SET_VALUE(realTimeTrafficDataPerInterval_, realTimeTrafficDataPerInterval) };
    inline DescribeDomainRealTimeTrafficDataResponseBody& setRealTimeTrafficDataPerInterval(DescribeDomainRealTimeTrafficDataResponseBody::RealTimeTrafficDataPerInterval && realTimeTrafficDataPerInterval) { DARABONBA_PTR_SET_RVALUE(realTimeTrafficDataPerInterval_, realTimeTrafficDataPerInterval) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainRealTimeTrafficDataResponseBody::RealTimeTrafficDataPerInterval> realTimeTrafficDataPerInterval_ {};
