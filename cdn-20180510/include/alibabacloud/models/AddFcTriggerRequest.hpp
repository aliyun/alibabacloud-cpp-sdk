...
#ifndef ALIBABACLOUD_MODELS_ADDFCTRIGGERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ADDFCTRIGGERREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddFCTriggerRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddFCTriggerRequest& obj) { 
    ...
    AddFCTriggerRequest() = default ;
    AddFCTriggerRequest(const AddFCTriggerRequest &) = default ;
    AddFCTriggerRequest(AddFCTriggerRequest &&) = default ;
    AddFCTriggerRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddFCTriggerRequest() = default ;
    AddFCTriggerRequest& operator=(const AddFCTriggerRequest &) = default ;
    AddFCTriggerRequest& operator=(AddFCTriggerRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->eventMetaName_ == nullptr
        && return this->eventMetaVersion_ == nullptr && return this->functionARN_ == nullptr && return this->notes_ == nullptr && return this->roleARN_ == nullptr && return this->sourceARN_ == nullptr
        && return this->triggerARN_ == nullptr; };
    ...
    inline AddFCTriggerRequest& setEventMetaName(string eventMetaName) { DARABONBA_PTR_SET_VALUE(eventMetaName_, eventMetaName) };
    ...
    inline AddFCTriggerRequest& setEventMetaVersion(string eventMetaVersion) { DARABONBA_PTR_SET_VALUE(eventMetaVersion_, eventMetaVersion) };
    ...
    inline AddFCTriggerRequest& setFunctionARN(string functionARN) { DARABONBA_PTR_SET_VALUE(functionARN_, functionARN) };
    ...
    inline AddFCTriggerRequest& setNotes(string notes) { DARABONBA_PTR_SET_VALUE(notes_, notes) };
    ...
    inline AddFCTriggerRequest& setRoleARN(string roleARN) { DARABONBA_PTR_SET_VALUE(roleARN_, roleARN) };
    ...
    inline AddFCTriggerRequest& setSourceARN(string sourceARN) { DARABONBA_PTR_SET_VALUE(sourceARN_, sourceARN) };
    ...
    inline AddFCTriggerRequest& setTriggerARN(string triggerARN) { DARABONBA_PTR_SET_VALUE(triggerARN_, triggerARN) };
