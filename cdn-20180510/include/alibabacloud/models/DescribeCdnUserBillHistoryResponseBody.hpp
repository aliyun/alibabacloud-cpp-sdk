...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnUserBillHistoryResponseBody::BillHistoryData & getBillHistoryData() const { DARABONBA_PTR_GET_CONST(billHistoryData_, DescribeCdnUserBillHistoryResponseBody::BillHistoryData) };
    inline DescribeCdnUserBillHistoryResponseBody::BillHistoryData getBillHistoryData() { DARABONBA_PTR_GET(billHistoryData_, DescribeCdnUserBillHistoryResponseBody::BillHistoryData) };
    inline DescribeCdnUserBillHistoryResponseBody& setBillHistoryData(const DescribeCdnUserBillHistoryResponseBody::BillHistoryData & billHistoryData) { DARABONBA_PTR_SET_VALUE(billHistoryData_, billHistoryData) };
    inline DescribeCdnUserBillHistoryResponseBody& setBillHistoryData(DescribeCdnUserBillHistoryResponseBody::BillHistoryData && billHistoryData) { DARABONBA_PTR_SET_RVALUE(billHistoryData_, billHistoryData) };
  ...
  protected:
    shared_ptr<DescribeCdnUserBillHistoryResponseBody::BillHistoryData> billHistoryData_ {};
