...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline float getMaxBps() const { DARABONBA_PTR_GET_DEFAULT(maxBps_, 0.0) };
        inline TopDomain& setMaxBps(float maxBps) { DARABONBA_PTR_SET_VALUE(maxBps_, maxBps) };
    ...
    inline const DescribeTopDomainsByFlowResponseBody::TopDomains & getTopDomains() const { DARABONBA_PTR_GET_CONST(topDomains_, DescribeTopDomainsByFlowResponseBody::TopDomains) };
    inline DescribeTopDomainsByFlowResponseBody::TopDomains getTopDomains() { DARABONBA_PTR_GET(topDomains_, DescribeTopDomainsByFlowResponseBody::TopDomains) };
    inline DescribeTopDomainsByFlowResponseBody& setTopDomains(const DescribeTopDomainsByFlowResponseBody::TopDomains & topDomains) { DARABONBA_PTR_SET_VALUE(topDomains_, topDomains) };
    inline DescribeTopDomainsByFlowResponseBody& setTopDomains(DescribeTopDomainsByFlowResponseBody::TopDomains && topDomains) { DARABONBA_PTR_SET_RVALUE(topDomains_, topDomains) };
  ...
  protected:
    ...
    shared_ptr<DescribeTopDomainsByFlowResponseBody::TopDomains> topDomains_ {};
  };
