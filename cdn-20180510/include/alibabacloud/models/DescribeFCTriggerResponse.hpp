...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeFCTriggerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeFCTriggerResponseBody) };
    inline DescribeFCTriggerResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeFCTriggerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeFCTriggerResponseBody> body_ {};
  };
