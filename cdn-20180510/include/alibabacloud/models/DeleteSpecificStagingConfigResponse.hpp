...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSpecificStagingConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSpecificStagingConfigResponseBody) };
    inline DeleteSpecificStagingConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSpecificStagingConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSpecificStagingConfigResponseBody> body_ {};
  };
