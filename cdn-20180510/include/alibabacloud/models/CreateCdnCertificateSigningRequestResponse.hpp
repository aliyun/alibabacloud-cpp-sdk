...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCdnCertificateSigningRequestResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCdnCertificateSigningRequestResponseBody) };
    inline CreateCdnCertificateSigningRequestResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCdnCertificateSigningRequestResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCdnCertificateSigningRequestResponseBody> body_ {};
  };
