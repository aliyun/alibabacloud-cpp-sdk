...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTagResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTagResourcesResponseBody) };
    inline DescribeTagResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTagResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTagResourcesResponseBody> body_ {};
  };
