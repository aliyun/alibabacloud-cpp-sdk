...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnCertificateListResponseBody::CertificateListModel & getCertificateListModel() const { DARABONBA_PTR_GET_CONST(certificateListModel_, DescribeCdnCertificateListResponseBody::CertificateListModel) };
    inline DescribeCdnCertificateListResponseBody::CertificateListModel getCertificateListModel() { DARABONBA_PTR_GET(certificateListModel_, DescribeCdnCertificateListResponseBody::CertificateListModel) };
    inline DescribeCdnCertificateListResponseBody& setCertificateListModel(const DescribeCdnCertificateListResponseBody::CertificateListModel & certificateListModel) { DARABONBA_PTR_SET_VALUE(certificateListModel_, certificateListModel) };
    inline DescribeCdnCertificateListResponseBody& setCertificateListModel(DescribeCdnCertificateListResponseBody::CertificateListModel && certificateListModel) { DARABONBA_PTR_SET_RVALUE(certificateListModel_, certificateListModel) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnCertificateListResponseBody::CertificateListModel> certificateListModel_ {};
