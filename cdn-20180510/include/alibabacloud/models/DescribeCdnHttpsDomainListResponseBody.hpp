...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnHttpsDomainListResponseBody::CertInfos & getCertInfos() const { DARABONBA_PTR_GET_CONST(certInfos_, DescribeCdnHttpsDomainListResponseBody::CertInfos) };
    inline DescribeCdnHttpsDomainListResponseBody::CertInfos getCertInfos() { DARABONBA_PTR_GET(certInfos_, DescribeCdnHttpsDomainListResponseBody::CertInfos) };
    inline DescribeCdnHttpsDomainListResponseBody& setCertInfos(const DescribeCdnHttpsDomainListResponseBody::CertInfos & certInfos) { DARABONBA_PTR_SET_VALUE(certInfos_, certInfos) };
    inline DescribeCdnHttpsDomainListResponseBody& setCertInfos(DescribeCdnHttpsDomainListResponseBody::CertInfos && certInfos) { DARABONBA_PTR_SET_RVALUE(certInfos_, certInfos) };
  ...
  protected:
    shared_ptr<DescribeCdnHttpsDomainListResponseBody::CertInfos> certInfos_ {};
