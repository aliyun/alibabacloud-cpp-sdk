...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainMultiUsageDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainMultiUsageDataResponseBody) };
    inline DescribeDomainMultiUsageDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainMultiUsageDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainMultiUsageDataResponseBody> body_ {};
  };
