...
namespace Models
{
  ...
  public:
    ...
    inline const EnableRealtimeLogDeliveryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableRealtimeLogDeliveryResponseBody) };
    inline EnableRealtimeLogDeliveryResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableRealtimeLogDeliveryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableRealtimeLogDeliveryResponseBody> body_ {};
  };
