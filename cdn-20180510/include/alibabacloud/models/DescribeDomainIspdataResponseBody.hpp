...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainISPDataResponseBodyValue & value() const { DARABONBA_PTR_GET_CONST(value_, DescribeDomainISPDataResponseBodyValue) };
    inline DescribeDomainISPDataResponseBodyValue value() { DARABONBA_PTR_GET(value_, DescribeDomainISPDataResponseBodyValue) };
    inline DescribeDomainISPDataResponseBody& setValue(const DescribeDomainISPDataResponseBodyValue & value) { DARABONBA_PTR_SET_VALUE(value_, value) };
    inline DescribeDomainISPDataResponseBody& setValue(DescribeDomainISPDataResponseBodyValue && value) { DARABONBA_PTR_SET_RVALUE(value_, value) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDomainISPDataResponseBodyValue> value_ = nullptr;
  };
