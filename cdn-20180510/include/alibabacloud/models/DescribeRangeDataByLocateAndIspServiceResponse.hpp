...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRangeDataByLocateAndIspServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRangeDataByLocateAndIspServiceResponseBody) };
    inline DescribeRangeDataByLocateAndIspServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRangeDataByLocateAndIspServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRangeDataByLocateAndIspServiceResponseBody> body_ {};
  };
