...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainRealTimeSrcTrafficDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainRealTimeSrcTrafficDataResponseBody) };
    inline DescribeDomainRealTimeSrcTrafficDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainRealTimeSrcTrafficDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainRealTimeSrcTrafficDataResponseBody> body_ {};
  };
