...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnOrderCommodityCodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnOrderCommodityCodeResponseBody) };
    inline DescribeCdnOrderCommodityCodeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnOrderCommodityCodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnOrderCommodityCodeResponseBody> body_ {};
  };
