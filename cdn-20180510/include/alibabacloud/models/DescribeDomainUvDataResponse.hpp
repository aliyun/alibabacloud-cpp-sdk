...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainUvDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainUvDataResponseBody) };
    inline DescribeDomainUvDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainUvDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainUvDataResponseBody> body_ {};
  };
