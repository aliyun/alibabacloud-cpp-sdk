...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTopDomainsByFlowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTopDomainsByFlowResponseBody) };
    inline DescribeTopDomainsByFlowResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTopDomainsByFlowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTopDomainsByFlowResponseBody> body_ {};
  };
