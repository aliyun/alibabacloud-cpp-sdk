...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserUsageDetailDataExportTaskResponseBody::UsageDataPerPage & getUsageDataPerPage() const { DARABONBA_PTR_GET_CONST(usageDataPerPage_, DescribeUserUsageDetailDataExportTaskResponseBody::UsageDataPerPage) };
    inline DescribeUserUsageDetailDataExportTaskResponseBody::UsageDataPerPage getUsageDataPerPage() { DARABONBA_PTR_GET(usageDataPerPage_, DescribeUserUsageDetailDataExportTaskResponseBody::UsageDataPerPage) };
    inline DescribeUserUsageDetailDataExportTaskResponseBody& setUsageDataPerPage(const DescribeUserUsageDetailDataExportTaskResponseBody::UsageDataPerPage & usageDataPerPage) { DARABONBA_PTR_SET_VALUE(usageDataPerPage_, usageDataPerPage) };
    inline DescribeUserUsageDetailDataExportTaskResponseBody& setUsageDataPerPage(DescribeUserUsageDetailDataExportTaskResponseBody::UsageDataPerPage && usageDataPerPage) { DARABONBA_PTR_SET_RVALUE(usageDataPerPage_, usageDataPerPage) };
  ...
  protected:
    ...
    shared_ptr<DescribeUserUsageDetailDataExportTaskResponseBody::UsageDataPerPage> usageDataPerPage_ {};
  };
