...
namespace Models
{
  ...
  public:
    ...
    inline const ListFCTriggerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFCTriggerResponseBody) };
    inline ListFCTriggerResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFCTriggerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFCTriggerResponseBody> body_ {};
  };
