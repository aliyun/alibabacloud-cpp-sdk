...
namespace Models
{
  ...
  public:
    ...
    inline const ListRealtimeLogDeliveryDomainsResponseBody::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, ListRealtimeLogDeliveryDomainsResponseBody::Content) };
    inline ListRealtimeLogDeliveryDomainsResponseBody::Content getContent() { DARABONBA_PTR_GET(content_, ListRealtimeLogDeliveryDomainsResponseBody::Content) };
    inline ListRealtimeLogDeliveryDomainsResponseBody& setContent(const ListRealtimeLogDeliveryDomainsResponseBody::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListRealtimeLogDeliveryDomainsResponseBody& setContent(ListRealtimeLogDeliveryDomainsResponseBody::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    shared_ptr<ListRealtimeLogDeliveryDomainsResponseBody::Content> content_ {};
