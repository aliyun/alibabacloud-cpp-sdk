...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->certExpireTime_ == nullptr
        && return this->certIdentifier_ == nullptr && return this->certName_ == nullptr && return this->certOrg_ == nullptr && return this->commonName_ == nullptr && return this->encryptCertificate_ == nullptr
        && return this->requestId_ == nullptr && return this->sans_ == nullptr && return this->signCertificate_ == nullptr; };
