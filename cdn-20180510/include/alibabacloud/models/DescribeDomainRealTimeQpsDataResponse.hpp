...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainRealTimeQpsDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainRealTimeQpsDataResponseBody) };
    inline DescribeDomainRealTimeQpsDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainRealTimeQpsDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainRealTimeQpsDataResponseBody> body_ {};
  };
