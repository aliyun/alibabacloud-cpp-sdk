...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDOMAINQPSDATARESPONSEBODYQPSDATAINTERVALDATAMODULE_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDOMAINQPSDATARESPONSEBODYQPSDATAINTERVALDATAMODULE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& obj) { 
    ...
    DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule() = default ;
    DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule(const DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule &) = default ;
    DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule(DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule &&) = default ;
    DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule() = default ;
    DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& operator=(const DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule &) = default ;
    DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& operator=(DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule &&) = default ;
    ...
    inline DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& setAccDomesticValue(string accDomesticValue) { DARABONBA_PTR_SET_VALUE(accDomesticValue_, accDomesticValue) };
    ...
    inline DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& setAccOverseasValue(string accOverseasValue) { DARABONBA_PTR_SET_VALUE(accOverseasValue_, accOverseasValue) };
    ...
    inline DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& setAccValue(string accValue) { DARABONBA_PTR_SET_VALUE(accValue_, accValue) };
    ...
    inline DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& setDomesticValue(string domesticValue) { DARABONBA_PTR_SET_VALUE(domesticValue_, domesticValue) };
    ...
    inline DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& setHttpsAccDomesticValue(string httpsAccDomesticValue) { DARABONBA_PTR_SET_VALUE(httpsAccDomesticValue_, httpsAccDomesticValue) };
    ...
    inline DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& setHttpsAccOverseasValue(string httpsAccOverseasValue) { DARABONBA_PTR_SET_VALUE(httpsAccOverseasValue_, httpsAccOverseasValue) };
    ...
    inline DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& setHttpsAccValue(string httpsAccValue) { DARABONBA_PTR_SET_VALUE(httpsAccValue_, httpsAccValue) };
    ...
    inline DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& setHttpsDomesticValue(string httpsDomesticValue) { DARABONBA_PTR_SET_VALUE(httpsDomesticValue_, httpsDomesticValue) };
    ...
    inline DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& setHttpsOverseasValue(string httpsOverseasValue) { DARABONBA_PTR_SET_VALUE(httpsOverseasValue_, httpsOverseasValue) };
    ...
    inline DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& setHttpsValue(string httpsValue) { DARABONBA_PTR_SET_VALUE(httpsValue_, httpsValue) };
    ...
    inline DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& setOverseasValue(string overseasValue) { DARABONBA_PTR_SET_VALUE(overseasValue_, overseasValue) };
    ...
    inline DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& setTimeStamp(string timeStamp) { DARABONBA_PTR_SET_VALUE(timeStamp_, timeStamp) };
    ...
    inline DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
