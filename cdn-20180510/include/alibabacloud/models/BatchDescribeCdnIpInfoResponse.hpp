...
namespace Models
{
  ...
  public:
    ...
    inline const BatchDescribeCdnIpInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchDescribeCdnIpInfoResponseBody) };
    inline BatchDescribeCdnIpInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchDescribeCdnIpInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchDescribeCdnIpInfoResponseBody> body_ {};
  };
