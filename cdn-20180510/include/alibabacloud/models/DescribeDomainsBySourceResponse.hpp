...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainsBySourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainsBySourceResponseBody) };
    inline DescribeDomainsBySourceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainsBySourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainsBySourceResponseBody> body_ {};
  };
