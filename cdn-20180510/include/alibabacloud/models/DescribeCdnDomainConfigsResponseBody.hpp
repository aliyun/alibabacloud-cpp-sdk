...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnDomainConfigsResponseBody::DomainConfigs & getDomainConfigs() const { DARABONBA_PTR_GET_CONST(domainConfigs_, DescribeCdnDomainConfigsResponseBody::DomainConfigs) };
    inline DescribeCdnDomainConfigsResponseBody::DomainConfigs getDomainConfigs() { DARABONBA_PTR_GET(domainConfigs_, DescribeCdnDomainConfigsResponseBody::DomainConfigs) };
    inline DescribeCdnDomainConfigsResponseBody& setDomainConfigs(const DescribeCdnDomainConfigsResponseBody::DomainConfigs & domainConfigs) { DARABONBA_PTR_SET_VALUE(domainConfigs_, domainConfigs) };
    inline DescribeCdnDomainConfigsResponseBody& setDomainConfigs(DescribeCdnDomainConfigsResponseBody::DomainConfigs && domainConfigs) { DARABONBA_PTR_SET_RVALUE(domainConfigs_, domainConfigs) };
  ...
  protected:
    shared_ptr<DescribeCdnDomainConfigsResponseBody::DomainConfigs> domainConfigs_ {};
