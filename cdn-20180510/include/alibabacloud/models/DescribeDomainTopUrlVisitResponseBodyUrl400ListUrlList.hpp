...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDOMAINTOPURLVISITRESPONSEBODYURL400LISTURLLIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDOMAINTOPURLVISITRESPONSEBODYURL400LISTURLLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList& obj) { 
    ...
    DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList() = default ;
    DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList(const DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList &) = default ;
    DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList(DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList &&) = default ;
    DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList() = default ;
    DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList& operator=(const DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList &) = default ;
    DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList& operator=(DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList &&) = default ;
    ...
    inline DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList& setFlow(string flow) { DARABONBA_PTR_SET_VALUE(flow_, flow) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList& setFlowProportion(float flowProportion) { DARABONBA_PTR_SET_VALUE(flowProportion_, flowProportion) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList& setUrlDetail(string urlDetail) { DARABONBA_PTR_SET_VALUE(urlDetail_, urlDetail) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList& setVisitData(string visitData) { DARABONBA_PTR_SET_VALUE(visitData_, visitData) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyUrl400ListUrlList& setVisitProportion(float visitProportion) { DARABONBA_PTR_SET_VALUE(visitProportion_, visitProportion) };
