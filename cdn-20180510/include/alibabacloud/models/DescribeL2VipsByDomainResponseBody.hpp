...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeL2VipsByDomainResponseBody::Vips & getVips() const { DARABONBA_PTR_GET_CONST(vips_, DescribeL2VipsByDomainResponseBody::Vips) };
    inline DescribeL2VipsByDomainResponseBody::Vips getVips() { DARABONBA_PTR_GET(vips_, DescribeL2VipsByDomainResponseBody::Vips) };
    inline DescribeL2VipsByDomainResponseBody& setVips(const DescribeL2VipsByDomainResponseBody::Vips & vips) { DARABONBA_PTR_SET_VALUE(vips_, vips) };
    inline DescribeL2VipsByDomainResponseBody& setVips(DescribeL2VipsByDomainResponseBody::Vips && vips) { DARABONBA_PTR_SET_RVALUE(vips_, vips) };
  ...
  protected:
    ...
    shared_ptr<DescribeL2VipsByDomainResponseBody::Vips> vips_ {};
  };
