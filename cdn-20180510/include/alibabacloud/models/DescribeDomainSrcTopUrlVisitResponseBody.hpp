...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainSrcTopUrlVisitResponseBody::AllUrlList & getAllUrlList() const { DARABONBA_PTR_GET_CONST(allUrlList_, DescribeDomainSrcTopUrlVisitResponseBody::AllUrlList) };
    inline DescribeDomainSrcTopUrlVisitResponseBody::AllUrlList getAllUrlList() { DARABONBA_PTR_GET(allUrlList_, DescribeDomainSrcTopUrlVisitResponseBody::AllUrlList) };
    inline DescribeDomainSrcTopUrlVisitResponseBody& setAllUrlList(const DescribeDomainSrcTopUrlVisitResponseBody::AllUrlList & allUrlList) { DARABONBA_PTR_SET_VALUE(allUrlList_, allUrlList) };
    inline DescribeDomainSrcTopUrlVisitResponseBody& setAllUrlList(DescribeDomainSrcTopUrlVisitResponseBody::AllUrlList && allUrlList) { DARABONBA_PTR_SET_RVALUE(allUrlList_, allUrlList) };
    ...
    inline const DescribeDomainSrcTopUrlVisitResponseBody::Url200List & getUrl200List() const { DARABONBA_PTR_GET_CONST(url200List_, DescribeDomainSrcTopUrlVisitResponseBody::Url200List) };
    inline DescribeDomainSrcTopUrlVisitResponseBody::Url200List getUrl200List() { DARABONBA_PTR_GET(url200List_, DescribeDomainSrcTopUrlVisitResponseBody::Url200List) };
    inline DescribeDomainSrcTopUrlVisitResponseBody& setUrl200List(const DescribeDomainSrcTopUrlVisitResponseBody::Url200List & url200List) { DARABONBA_PTR_SET_VALUE(url200List_, url200List) };
    inline DescribeDomainSrcTopUrlVisitResponseBody& setUrl200List(DescribeDomainSrcTopUrlVisitResponseBody::Url200List && url200List) { DARABONBA_PTR_SET_RVALUE(url200List_, url200List) };
    ...
    inline const DescribeDomainSrcTopUrlVisitResponseBody::Url300List & getUrl300List() const { DARABONBA_PTR_GET_CONST(url300List_, DescribeDomainSrcTopUrlVisitResponseBody::Url300List) };
    inline DescribeDomainSrcTopUrlVisitResponseBody::Url300List getUrl300List() { DARABONBA_PTR_GET(url300List_, DescribeDomainSrcTopUrlVisitResponseBody::Url300List) };
    inline DescribeDomainSrcTopUrlVisitResponseBody& setUrl300List(const DescribeDomainSrcTopUrlVisitResponseBody::Url300List & url300List) { DARABONBA_PTR_SET_VALUE(url300List_, url300List) };
    inline DescribeDomainSrcTopUrlVisitResponseBody& setUrl300List(DescribeDomainSrcTopUrlVisitResponseBody::Url300List && url300List) { DARABONBA_PTR_SET_RVALUE(url300List_, url300List) };
    ...
    inline const DescribeDomainSrcTopUrlVisitResponseBody::Url400List & getUrl400List() const { DARABONBA_PTR_GET_CONST(url400List_, DescribeDomainSrcTopUrlVisitResponseBody::Url400List) };
    inline DescribeDomainSrcTopUrlVisitResponseBody::Url400List getUrl400List() { DARABONBA_PTR_GET(url400List_, DescribeDomainSrcTopUrlVisitResponseBody::Url400List) };
    inline DescribeDomainSrcTopUrlVisitResponseBody& setUrl400List(const DescribeDomainSrcTopUrlVisitResponseBody::Url400List & url400List) { DARABONBA_PTR_SET_VALUE(url400List_, url400List) };
    inline DescribeDomainSrcTopUrlVisitResponseBody& setUrl400List(DescribeDomainSrcTopUrlVisitResponseBody::Url400List && url400List) { DARABONBA_PTR_SET_RVALUE(url400List_, url400List) };
    ...
    inline const DescribeDomainSrcTopUrlVisitResponseBody::Url500List & getUrl500List() const { DARABONBA_PTR_GET_CONST(url500List_, DescribeDomainSrcTopUrlVisitResponseBody::Url500List) };
    inline DescribeDomainSrcTopUrlVisitResponseBody::Url500List getUrl500List() { DARABONBA_PTR_GET(url500List_, DescribeDomainSrcTopUrlVisitResponseBody::Url500List) };
    inline DescribeDomainSrcTopUrlVisitResponseBody& setUrl500List(const DescribeDomainSrcTopUrlVisitResponseBody::Url500List & url500List) { DARABONBA_PTR_SET_VALUE(url500List_, url500List) };
    inline DescribeDomainSrcTopUrlVisitResponseBody& setUrl500List(DescribeDomainSrcTopUrlVisitResponseBody::Url500List && url500List) { DARABONBA_PTR_SET_RVALUE(url500List_, url500List) };


  protected:
    shared_ptr<DescribeDomainSrcTopUrlVisitResponseBody::AllUrlList> allUrlList_ {};
    ...
    shared_ptr<DescribeDomainSrcTopUrlVisitResponseBody::Url200List> url200List_ {};
    shared_ptr<DescribeDomainSrcTopUrlVisitResponseBody::Url300List> url300List_ {};
    shared_ptr<DescribeDomainSrcTopUrlVisitResponseBody::Url400List> url400List_ {};
    shared_ptr<DescribeDomainSrcTopUrlVisitResponseBody::Url500List> url500List_ {};
  };
