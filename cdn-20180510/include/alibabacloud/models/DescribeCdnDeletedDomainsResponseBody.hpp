...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnDeletedDomainsResponseBody::Domains & getDomains() const { DARABONBA_PTR_GET_CONST(domains_, DescribeCdnDeletedDomainsResponseBody::Domains) };
    inline DescribeCdnDeletedDomainsResponseBody::Domains getDomains() { DARABONBA_PTR_GET(domains_, DescribeCdnDeletedDomainsResponseBody::Domains) };
    inline DescribeCdnDeletedDomainsResponseBody& setDomains(const DescribeCdnDeletedDomainsResponseBody::Domains & domains) { DARABONBA_PTR_SET_VALUE(domains_, domains) };
    inline DescribeCdnDeletedDomainsResponseBody& setDomains(DescribeCdnDeletedDomainsResponseBody::Domains && domains) { DARABONBA_PTR_SET_RVALUE(domains_, domains) };
  ...
  protected:
    shared_ptr<DescribeCdnDeletedDomainsResponseBody::Domains> domains_ {};
