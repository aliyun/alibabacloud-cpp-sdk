...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->funcId_ == nullptr
        && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->resourceGroupId_ == nullptr; };
