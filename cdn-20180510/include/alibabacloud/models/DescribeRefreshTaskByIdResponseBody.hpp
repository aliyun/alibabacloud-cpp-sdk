...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeRefreshTaskByIdResponseBody::Tasks> & getTasks() const { DARABONBA_PTR_GET_CONST(tasks_, vector<DescribeRefreshTaskByIdResponseBody::Tasks>) };
    inline vector<DescribeRefreshTaskByIdResponseBody::Tasks> getTasks() { DARABONBA_PTR_GET(tasks_, vector<DescribeRefreshTaskByIdResponseBody::Tasks>) };
    inline DescribeRefreshTaskByIdResponseBody& setTasks(const vector<DescribeRefreshTaskByIdResponseBody::Tasks> & tasks) { DARABONBA_PTR_SET_VALUE(tasks_, tasks) };
    inline DescribeRefreshTaskByIdResponseBody& setTasks(vector<DescribeRefreshTaskByIdResponseBody::Tasks> && tasks) { DARABONBA_PTR_SET_RVALUE(tasks_, tasks) };
  ...
  protected:
    ...
    // Details about tasks.
    shared_ptr<vector<DescribeRefreshTaskByIdResponseBody::Tasks>> tasks_ {};
