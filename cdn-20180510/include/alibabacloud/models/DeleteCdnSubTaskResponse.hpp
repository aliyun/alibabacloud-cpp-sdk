...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCdnSubTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCdnSubTaskResponseBody) };
    inline DeleteCdnSubTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCdnSubTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCdnSubTaskResponseBody> body_ {};
  };
