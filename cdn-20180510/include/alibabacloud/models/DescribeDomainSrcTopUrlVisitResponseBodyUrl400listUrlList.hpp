...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDOMAINSRCTOPURLVISITRESPONSEBODYURL400LISTURLLIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDOMAINSRCTOPURLVISITRESPONSEBODYURL400LISTURLLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList& obj) { 
    ...
    DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList() = default ;
    DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList(const DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList &) = default ;
    DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList(DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList &&) = default ;
    DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList() = default ;
    DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList& operator=(const DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList &) = default ;
    DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList& operator=(DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList &&) = default ;
    ...
    inline DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList& setFlow(string flow) { DARABONBA_PTR_SET_VALUE(flow_, flow) };
    ...
    inline DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList& setFlowProportion(float flowProportion) { DARABONBA_PTR_SET_VALUE(flowProportion_, flowProportion) };
    ...
    inline DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList& setUrlDetail(string urlDetail) { DARABONBA_PTR_SET_VALUE(urlDetail_, urlDetail) };
    ...
    inline DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList& setVisitData(string visitData) { DARABONBA_PTR_SET_VALUE(visitData_, visitData) };
    ...
    inline DescribeDomainSrcTopUrlVisitResponseBodyUrl400ListUrlList& setVisitProportion(float visitProportion) { DARABONBA_PTR_SET_VALUE(visitProportion_, visitProportion) };
