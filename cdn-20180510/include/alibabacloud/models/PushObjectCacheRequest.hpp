...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->area_ == nullptr
        && this->consistencyHash_ == nullptr && this->l2Preload_ == nullptr && this->objectPath_ == nullptr && this->ownerId_ == nullptr && this->queryHashkey_ == nullptr
        && this->securityToken_ == nullptr && this->withHeader_ == nullptr; };
    ...
    inline bool getConsistencyHash() const { DARABONBA_PTR_GET_DEFAULT(consistencyHash_, false) };
  ...
  protected:
    ...
    shared_ptr<bool> consistencyHash_ {};
