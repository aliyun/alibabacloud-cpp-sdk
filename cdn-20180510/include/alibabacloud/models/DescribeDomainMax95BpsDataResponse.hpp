...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainMax95BpsDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainMax95BpsDataResponseBody) };
    inline DescribeDomainMax95BpsDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainMax95BpsDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainMax95BpsDataResponseBody> body_ {};
  };
