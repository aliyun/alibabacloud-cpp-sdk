...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnSSLCertificateListResponseBody::CertificateListModel & getCertificateListModel() const { DARABONBA_PTR_GET_CONST(certificateListModel_, DescribeCdnSSLCertificateListResponseBody::CertificateListModel) };
    inline DescribeCdnSSLCertificateListResponseBody::CertificateListModel getCertificateListModel() { DARABONBA_PTR_GET(certificateListModel_, DescribeCdnSSLCertificateListResponseBody::CertificateListModel) };
    inline DescribeCdnSSLCertificateListResponseBody& setCertificateListModel(const DescribeCdnSSLCertificateListResponseBody::CertificateListModel & certificateListModel) { DARABONBA_PTR_SET_VALUE(certificateListModel_, certificateListModel) };
    inline DescribeCdnSSLCertificateListResponseBody& setCertificateListModel(DescribeCdnSSLCertificateListResponseBody::CertificateListModel && certificateListModel) { DARABONBA_PTR_SET_RVALUE(certificateListModel_, certificateListModel) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnSSLCertificateListResponseBody::CertificateListModel> certificateListModel_ {};
