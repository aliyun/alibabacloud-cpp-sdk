...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline PageData& setCdnType(string cdnType) { DARABONBA_PTR_SET_VALUE(cdnType_, cdnType) };
    ...
    inline const DescribeCdnUserDomainsByFuncResponseBody::Domains & getDomains() const { DARABONBA_PTR_GET_CONST(domains_, DescribeCdnUserDomainsByFuncResponseBody::Domains) };
    inline DescribeCdnUserDomainsByFuncResponseBody::Domains getDomains() { DARABONBA_PTR_GET(domains_, DescribeCdnUserDomainsByFuncResponseBody::Domains) };
    inline DescribeCdnUserDomainsByFuncResponseBody& setDomains(const DescribeCdnUserDomainsByFuncResponseBody::Domains & domains) { DARABONBA_PTR_SET_VALUE(domains_, domains) };
    inline DescribeCdnUserDomainsByFuncResponseBody& setDomains(DescribeCdnUserDomainsByFuncResponseBody::Domains && domains) { DARABONBA_PTR_SET_RVALUE(domains_, domains) };
  ...
  protected:
    shared_ptr<DescribeCdnUserDomainsByFuncResponseBody::Domains> domains_ {};
