...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline RegionProportionData& setReqErrRate(string reqErrRate) { DARABONBA_PTR_SET_VALUE(reqErrRate_, reqErrRate) };
    ...
    inline const DescribeDomainRegionDataResponseBody::Value & getValue() const { DARABONBA_PTR_GET_CONST(value_, DescribeDomainRegionDataResponseBody::Value) };
    inline DescribeDomainRegionDataResponseBody::Value getValue() { DARABONBA_PTR_GET(value_, DescribeDomainRegionDataResponseBody::Value) };
    inline DescribeDomainRegionDataResponseBody& setValue(const DescribeDomainRegionDataResponseBody::Value & value) { DARABONBA_PTR_SET_VALUE(value_, value) };
    inline DescribeDomainRegionDataResponseBody& setValue(DescribeDomainRegionDataResponseBody::Value && value) { DARABONBA_PTR_SET_RVALUE(value_, value) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainRegionDataResponseBody::Value> value_ {};
  };
