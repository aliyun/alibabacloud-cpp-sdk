...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataInterval_ == nullptr
        && return this->domainName_ == nullptr && return this->endTime_ == nullptr && return this->requestId_ == nullptr && return this->srcQpsDataPerInterval_ == nullptr && return this->startTime_ == nullptr; };
    ...
    inline const DescribeDomainSrcQpsDataResponseBodySrcQpsDataPerInterval & srcQpsDataPerInterval() const { DARABONBA_PTR_GET_CONST(srcQpsDataPerInterval_, DescribeDomainSrcQpsDataResponseBodySrcQpsDataPerInterval) };
    inline DescribeDomainSrcQpsDataResponseBodySrcQpsDataPerInterval srcQpsDataPerInterval() { DARABONBA_PTR_GET(srcQpsDataPerInterval_, DescribeDomainSrcQpsDataResponseBodySrcQpsDataPerInterval) };
    inline DescribeDomainSrcQpsDataResponseBody& setSrcQpsDataPerInterval(const DescribeDomainSrcQpsDataResponseBodySrcQpsDataPerInterval & srcQpsDataPerInterval) { DARABONBA_PTR_SET_VALUE(srcQpsDataPerInterval_, srcQpsDataPerInterval) };
    inline DescribeDomainSrcQpsDataResponseBody& setSrcQpsDataPerInterval(DescribeDomainSrcQpsDataResponseBodySrcQpsDataPerInterval && srcQpsDataPerInterval) { DARABONBA_PTR_SET_RVALUE(srcQpsDataPerInterval_, srcQpsDataPerInterval) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDomainSrcQpsDataResponseBodySrcQpsDataPerInterval> srcQpsDataPerInterval_ = nullptr;
