...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeStagingIpResponseBody::IPV4s & getIPV4s() const { DARABONBA_PTR_GET_CONST(IPV4s_, DescribeStagingIpResponseBody::IPV4s) };
    inline DescribeStagingIpResponseBody::IPV4s getIPV4s() { DARABONBA_PTR_GET(IPV4s_, DescribeStagingIpResponseBody::IPV4s) };
    inline DescribeStagingIpResponseBody& setIPV4s(const DescribeStagingIpResponseBody::IPV4s & iPV4s) { DARABONBA_PTR_SET_VALUE(IPV4s_, iPV4s) };
    inline DescribeStagingIpResponseBody& setIPV4s(DescribeStagingIpResponseBody::IPV4s && iPV4s) { DARABONBA_PTR_SET_RVALUE(IPV4s_, iPV4s) };
  ...
  protected:
    shared_ptr<DescribeStagingIpResponseBody::IPV4s> IPV4s_ {};
