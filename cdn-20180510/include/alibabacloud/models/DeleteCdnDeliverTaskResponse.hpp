...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCdnDeliverTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCdnDeliverTaskResponseBody) };
    inline DeleteCdnDeliverTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCdnDeliverTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCdnDeliverTaskResponseBody> body_ {};
  };
