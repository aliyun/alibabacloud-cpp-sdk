...
namespace Models
{
  ...
  public:
    ...
    inline const GetGrayDomainFunctionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetGrayDomainFunctionResponseBody) };
    inline GetGrayDomainFunctionResponseBody getBody() { DARABONBA_PTR_GET(body_, GetGrayDomainFunctionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetGrayDomainFunctionResponseBody> body_ {};
  };
