...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainSrcHttpCodeDataResponseBody::HttpCodeData & getHttpCodeData() const { DARABONBA_PTR_GET_CONST(httpCodeData_, DescribeDomainSrcHttpCodeDataResponseBody::HttpCodeData) };
    inline DescribeDomainSrcHttpCodeDataResponseBody::HttpCodeData getHttpCodeData() { DARABONBA_PTR_GET(httpCodeData_, DescribeDomainSrcHttpCodeDataResponseBody::HttpCodeData) };
    inline DescribeDomainSrcHttpCodeDataResponseBody& setHttpCodeData(const DescribeDomainSrcHttpCodeDataResponseBody::HttpCodeData & httpCodeData) { DARABONBA_PTR_SET_VALUE(httpCodeData_, httpCodeData) };
    inline DescribeDomainSrcHttpCodeDataResponseBody& setHttpCodeData(DescribeDomainSrcHttpCodeDataResponseBody::HttpCodeData && httpCodeData) { DARABONBA_PTR_SET_RVALUE(httpCodeData_, httpCodeData) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainSrcHttpCodeDataResponseBody::HttpCodeData> httpCodeData_ {};
