...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnTypesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnTypesResponseBody) };
    inline DescribeCdnTypesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnTypesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnTypesResponseBody> body_ {};
  };
