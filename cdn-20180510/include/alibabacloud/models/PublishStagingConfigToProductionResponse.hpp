...
namespace Models
{
  ...
  public:
    ...
    inline const PublishStagingConfigToProductionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PublishStagingConfigToProductionResponseBody) };
    inline PublishStagingConfigToProductionResponseBody getBody() { DARABONBA_PTR_GET(body_, PublishStagingConfigToProductionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PublishStagingConfigToProductionResponseBody> body_ {};
  };
