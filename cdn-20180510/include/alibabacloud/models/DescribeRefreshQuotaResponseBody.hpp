...
namespace Models
{
  ...
  public:
    ...
    inline string getIgnoreParamsQuota() const { DARABONBA_PTR_GET_DEFAULT(ignoreParamsQuota_, "") };
    ...
    inline string getIgnoreParamsRemain() const { DARABONBA_PTR_GET_DEFAULT(ignoreParamsRemain_, "") };
    ...
    inline string getPreloadEdgeQuota() const { DARABONBA_PTR_GET_DEFAULT(preloadEdgeQuota_, "") };
    ...
    inline string getPreloadEdgeRemain() const { DARABONBA_PTR_GET_DEFAULT(preloadEdgeRemain_, "") };
    ...
    inline string getRegexQuota() const { DARABONBA_PTR_GET_DEFAULT(regexQuota_, "") };
    ...
    inline string getRegexRemain() const { DARABONBA_PTR_GET_DEFAULT(regexRemain_, "") };
