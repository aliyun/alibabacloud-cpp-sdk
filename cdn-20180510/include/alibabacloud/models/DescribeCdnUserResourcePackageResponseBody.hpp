...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnUserResourcePackageResponseBody::ResourcePackageInfos & getResourcePackageInfos() const { DARABONBA_PTR_GET_CONST(resourcePackageInfos_, DescribeCdnUserResourcePackageResponseBody::ResourcePackageInfos) };
    inline DescribeCdnUserResourcePackageResponseBody::ResourcePackageInfos getResourcePackageInfos() { DARABONBA_PTR_GET(resourcePackageInfos_, DescribeCdnUserResourcePackageResponseBody::ResourcePackageInfos) };
    inline DescribeCdnUserResourcePackageResponseBody& setResourcePackageInfos(const DescribeCdnUserResourcePackageResponseBody::ResourcePackageInfos & resourcePackageInfos) { DARABONBA_PTR_SET_VALUE(resourcePackageInfos_, resourcePackageInfos) };
    inline DescribeCdnUserResourcePackageResponseBody& setResourcePackageInfos(DescribeCdnUserResourcePackageResponseBody::ResourcePackageInfos && resourcePackageInfos) { DARABONBA_PTR_SET_RVALUE(resourcePackageInfos_, resourcePackageInfos) };


  protected:
    // The ID of the request.
    shared_ptr<string> requestId_ {};
    shared_ptr<DescribeCdnUserResourcePackageResponseBody::ResourcePackageInfos> resourcePackageInfos_ {};
  };
