...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnDomainLogsResponseBody::DomainLogDetails & getDomainLogDetails() const { DARABONBA_PTR_GET_CONST(domainLogDetails_, DescribeCdnDomainLogsResponseBody::DomainLogDetails) };
    inline DescribeCdnDomainLogsResponseBody::DomainLogDetails getDomainLogDetails() { DARABONBA_PTR_GET(domainLogDetails_, DescribeCdnDomainLogsResponseBody::DomainLogDetails) };
    inline DescribeCdnDomainLogsResponseBody& setDomainLogDetails(const DescribeCdnDomainLogsResponseBody::DomainLogDetails & domainLogDetails) { DARABONBA_PTR_SET_VALUE(domainLogDetails_, domainLogDetails) };
    inline DescribeCdnDomainLogsResponseBody& setDomainLogDetails(DescribeCdnDomainLogsResponseBody::DomainLogDetails && domainLogDetails) { DARABONBA_PTR_SET_RVALUE(domainLogDetails_, domainLogDetails) };
  ...
  protected:
    shared_ptr<DescribeCdnDomainLogsResponseBody::DomainLogDetails> domainLogDetails_ {};
