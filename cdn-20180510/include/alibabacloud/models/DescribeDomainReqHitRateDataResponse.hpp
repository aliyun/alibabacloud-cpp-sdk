...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainReqHitRateDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainReqHitRateDataResponseBody) };
    inline DescribeDomainReqHitRateDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainReqHitRateDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainReqHitRateDataResponseBody> body_ {};
  };
