...
namespace Models
{
  ...
  public:
    ...
    inline const ListDomainsByLogConfigIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDomainsByLogConfigIdResponseBody) };
    inline ListDomainsByLogConfigIdResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDomainsByLogConfigIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDomainsByLogConfigIdResponseBody> body_ {};
  };
