...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainRealTimeByteHitRateDataResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeDomainRealTimeByteHitRateDataResponseBody::Data) };
    inline DescribeDomainRealTimeByteHitRateDataResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeDomainRealTimeByteHitRateDataResponseBody::Data) };
    inline DescribeDomainRealTimeByteHitRateDataResponseBody& setData(const DescribeDomainRealTimeByteHitRateDataResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDomainRealTimeByteHitRateDataResponseBody& setData(DescribeDomainRealTimeByteHitRateDataResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    shared_ptr<DescribeDomainRealTimeByteHitRateDataResponseBody::Data> data_ {};
