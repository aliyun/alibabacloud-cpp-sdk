...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDomainCcActivityLogResponseBody::ActivityLog> & getActivityLog() const { DARABONBA_PTR_GET_CONST(activityLog_, vector<DescribeDomainCcActivityLogResponseBody::ActivityLog>) };
    inline vector<DescribeDomainCcActivityLogResponseBody::ActivityLog> getActivityLog() { DARABONBA_PTR_GET(activityLog_, vector<DescribeDomainCcActivityLogResponseBody::ActivityLog>) };
    inline DescribeDomainCcActivityLogResponseBody& setActivityLog(const vector<DescribeDomainCcActivityLogResponseBody::ActivityLog> & activityLog) { DARABONBA_PTR_SET_VALUE(activityLog_, activityLog) };
    inline DescribeDomainCcActivityLogResponseBody& setActivityLog(vector<DescribeDomainCcActivityLogResponseBody::ActivityLog> && activityLog) { DARABONBA_PTR_SET_RVALUE(activityLog_, activityLog) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeDomainCcActivityLogResponseBody::ActivityLog>> activityLog_ {};
