...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainSrcHttpCodeDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainSrcHttpCodeDataResponseBody) };
    inline DescribeDomainSrcHttpCodeDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainSrcHttpCodeDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainSrcHttpCodeDataResponseBody> body_ {};
  };
