...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnUserBillPredictionResponseBody::BillPredictionData & getBillPredictionData() const { DARABONBA_PTR_GET_CONST(billPredictionData_, DescribeCdnUserBillPredictionResponseBody::BillPredictionData) };
    inline DescribeCdnUserBillPredictionResponseBody::BillPredictionData getBillPredictionData() { DARABONBA_PTR_GET(billPredictionData_, DescribeCdnUserBillPredictionResponseBody::BillPredictionData) };
    inline DescribeCdnUserBillPredictionResponseBody& setBillPredictionData(const DescribeCdnUserBillPredictionResponseBody::BillPredictionData & billPredictionData) { DARABONBA_PTR_SET_VALUE(billPredictionData_, billPredictionData) };
    inline DescribeCdnUserBillPredictionResponseBody& setBillPredictionData(DescribeCdnUserBillPredictionResponseBody::BillPredictionData && billPredictionData) { DARABONBA_PTR_SET_RVALUE(billPredictionData_, billPredictionData) };
  ...
  protected:
    shared_ptr<DescribeCdnUserBillPredictionResponseBody::BillPredictionData> billPredictionData_ {};
    // The metering method.
    // 
