...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bytesHitRate_ == nullptr
        && return this->maxBps_ == nullptr && return this->maxBpsTime_ == nullptr && return this->maxSrcBps_ == nullptr && return this->maxSrcBpsTime_ == nullptr && return this->requestHitRate_ == nullptr
        && return this->totalAccess_ == nullptr && return this->totalTraffic_ == nullptr; };
