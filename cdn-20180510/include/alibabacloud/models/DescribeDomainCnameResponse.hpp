...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainCnameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainCnameResponseBody) };
    inline DescribeDomainCnameResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainCnameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainCnameResponseBody> body_ {};
  };
