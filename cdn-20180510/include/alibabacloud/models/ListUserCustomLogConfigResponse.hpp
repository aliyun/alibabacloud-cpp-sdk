...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserCustomLogConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUserCustomLogConfigResponseBody) };
    inline ListUserCustomLogConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUserCustomLogConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUserCustomLogConfigResponseBody> body_ {};
  };
