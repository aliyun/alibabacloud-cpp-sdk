...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnDomainByCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnDomainByCertificateResponseBody) };
    inline DescribeCdnDomainByCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnDomainByCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnDomainByCertificateResponseBody> body_ {};
  };
