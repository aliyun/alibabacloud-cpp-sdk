...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBlockedRegionsResponseBody::InfoList & getInfoList() const { DARABONBA_PTR_GET_CONST(infoList_, DescribeBlockedRegionsResponseBody::InfoList) };
    inline DescribeBlockedRegionsResponseBody::InfoList getInfoList() { DARABONBA_PTR_GET(infoList_, DescribeBlockedRegionsResponseBody::InfoList) };
    inline DescribeBlockedRegionsResponseBody& setInfoList(const DescribeBlockedRegionsResponseBody::InfoList & infoList) { DARABONBA_PTR_SET_VALUE(infoList_, infoList) };
    inline DescribeBlockedRegionsResponseBody& setInfoList(DescribeBlockedRegionsResponseBody::InfoList && infoList) { DARABONBA_PTR_SET_RVALUE(infoList_, infoList) };
  ...
  protected:
    shared_ptr<DescribeBlockedRegionsResponseBody::InfoList> infoList_ {};
