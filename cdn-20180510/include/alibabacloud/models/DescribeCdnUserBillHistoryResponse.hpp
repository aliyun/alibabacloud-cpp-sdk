...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnUserBillHistoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnUserBillHistoryResponseBody) };
    inline DescribeCdnUserBillHistoryResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnUserBillHistoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnUserBillHistoryResponseBody> body_ {};
  };
