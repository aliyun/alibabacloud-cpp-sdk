...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainTrafficDataResponseBody::TrafficDataPerInterval & getTrafficDataPerInterval() const { DARABONBA_PTR_GET_CONST(trafficDataPerInterval_, DescribeDomainTrafficDataResponseBody::TrafficDataPerInterval) };
    inline DescribeDomainTrafficDataResponseBody::TrafficDataPerInterval getTrafficDataPerInterval() { DARABONBA_PTR_GET(trafficDataPerInterval_, DescribeDomainTrafficDataResponseBody::TrafficDataPerInterval) };
    inline DescribeDomainTrafficDataResponseBody& setTrafficDataPerInterval(const DescribeDomainTrafficDataResponseBody::TrafficDataPerInterval & trafficDataPerInterval) { DARABONBA_PTR_SET_VALUE(trafficDataPerInterval_, trafficDataPerInterval) };
    inline DescribeDomainTrafficDataResponseBody& setTrafficDataPerInterval(DescribeDomainTrafficDataResponseBody::TrafficDataPerInterval && trafficDataPerInterval) { DARABONBA_PTR_SET_RVALUE(trafficDataPerInterval_, trafficDataPerInterval) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainTrafficDataResponseBody::TrafficDataPerInterval> trafficDataPerInterval_ {};
  };
