...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->cdnType_ != nullptr
        && this->cname_ != nullptr && this->coverage_ != nullptr && this->description_ != nullptr && this->domainId_ != nullptr && this->domainName_ != nullptr
        && this->domainStatus_ != nullptr && this->gmtCreated_ != nullptr && this->gmtModified_ != nullptr && this->resourceGroupId_ != nullptr && this->sandbox_ != nullptr
        && this->sources_ != nullptr && this->sslProtocol_ != nullptr; };
