...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainBpsDataByLayerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainBpsDataByLayerResponseBody) };
    inline DescribeDomainBpsDataByLayerResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainBpsDataByLayerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainBpsDataByLayerResponseBody> body_ {};
  };
