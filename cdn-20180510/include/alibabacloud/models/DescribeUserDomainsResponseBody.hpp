...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEUSERDOMAINSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEUSERDOMAINSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeUserDomainsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeUserDomainsResponseBody& obj) { 
    ...
    DescribeUserDomainsResponseBody() = default ;
    DescribeUserDomainsResponseBody(const DescribeUserDomainsResponseBody &) = default ;
    DescribeUserDomainsResponseBody(DescribeUserDomainsResponseBody &&) = default ;
    DescribeUserDomainsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeUserDomainsResponseBody() = default ;
    DescribeUserDomainsResponseBody& operator=(const DescribeUserDomainsResponseBody &) = default ;
    DescribeUserDomainsResponseBody& operator=(DescribeUserDomainsResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline PageData& setCoverage(string coverage) { DARABONBA_PTR_SET_VALUE(coverage_, coverage) };
    ...
    inline const DescribeUserDomainsResponseBody::Domains & getDomains() const { DARABONBA_PTR_GET_CONST(domains_, DescribeUserDomainsResponseBody::Domains) };
    inline DescribeUserDomainsResponseBody::Domains getDomains() { DARABONBA_PTR_GET(domains_, DescribeUserDomainsResponseBody::Domains) };
    inline DescribeUserDomainsResponseBody& setDomains(const DescribeUserDomainsResponseBody::Domains & domains) { DARABONBA_PTR_SET_VALUE(domains_, domains) };
    inline DescribeUserDomainsResponseBody& setDomains(DescribeUserDomainsResponseBody::Domains && domains) { DARABONBA_PTR_SET_RVALUE(domains_, domains) };
    ...
    inline DescribeUserDomainsResponseBody& setPageNumber(int64_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline DescribeUserDomainsResponseBody& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline DescribeUserDomainsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeUserDomainsResponseBody& setTotalCount(int64_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };


  protected:
    shared_ptr<DescribeUserDomainsResponseBody::Domains> domains_ {};
