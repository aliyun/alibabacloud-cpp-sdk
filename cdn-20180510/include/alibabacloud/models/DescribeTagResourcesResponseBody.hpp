...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeTagResourcesResponseBody::TagResources> & getTagResources() const { DARABONBA_PTR_GET_CONST(tagResources_, vector<DescribeTagResourcesResponseBody::TagResources>) };
    inline vector<DescribeTagResourcesResponseBody::TagResources> getTagResources() { DARABONBA_PTR_GET(tagResources_, vector<DescribeTagResourcesResponseBody::TagResources>) };
    inline DescribeTagResourcesResponseBody& setTagResources(const vector<DescribeTagResourcesResponseBody::TagResources> & tagResources) { DARABONBA_PTR_SET_VALUE(tagResources_, tagResources) };
    inline DescribeTagResourcesResponseBody& setTagResources(vector<DescribeTagResourcesResponseBody::TagResources> && tagResources) { DARABONBA_PTR_SET_RVALUE(tagResources_, tagResources) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeTagResourcesResponseBody::TagResources>> tagResources_ {};
  };
