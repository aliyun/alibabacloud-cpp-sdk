...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainRealTimeReqHitRateDataResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeDomainRealTimeReqHitRateDataResponseBody::Data) };
    inline DescribeDomainRealTimeReqHitRateDataResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeDomainRealTimeReqHitRateDataResponseBody::Data) };
    inline DescribeDomainRealTimeReqHitRateDataResponseBody& setData(const DescribeDomainRealTimeReqHitRateDataResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDomainRealTimeReqHitRateDataResponseBody& setData(DescribeDomainRealTimeReqHitRateDataResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    shared_ptr<DescribeDomainRealTimeReqHitRateDataResponseBody::Data> data_ {};
