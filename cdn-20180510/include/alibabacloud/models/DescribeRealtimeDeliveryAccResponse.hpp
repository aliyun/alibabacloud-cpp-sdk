...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRealtimeDeliveryAccResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRealtimeDeliveryAccResponseBody) };
    inline DescribeRealtimeDeliveryAccResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRealtimeDeliveryAccResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRealtimeDeliveryAccResponseBody> body_ {};
  };
