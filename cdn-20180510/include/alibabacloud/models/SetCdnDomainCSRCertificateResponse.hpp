...
namespace Models
{
  ...
  public:
    ...
    inline const SetCdnDomainCSRCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetCdnDomainCSRCertificateResponseBody) };
    inline SetCdnDomainCSRCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, SetCdnDomainCSRCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetCdnDomainCSRCertificateResponseBody> body_ {};
  };
