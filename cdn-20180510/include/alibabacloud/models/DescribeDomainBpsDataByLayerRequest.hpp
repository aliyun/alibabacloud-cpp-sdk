...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDOMAINBPSDATABYLAYERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDOMAINBPSDATABYLAYERREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDomainBpsDataByLayerRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDomainBpsDataByLayerRequest& obj) { 
    ...
    DescribeDomainBpsDataByLayerRequest() = default ;
    DescribeDomainBpsDataByLayerRequest(const DescribeDomainBpsDataByLayerRequest &) = default ;
    DescribeDomainBpsDataByLayerRequest(DescribeDomainBpsDataByLayerRequest &&) = default ;
    DescribeDomainBpsDataByLayerRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDomainBpsDataByLayerRequest() = default ;
    DescribeDomainBpsDataByLayerRequest& operator=(const DescribeDomainBpsDataByLayerRequest &) = default ;
    DescribeDomainBpsDataByLayerRequest& operator=(DescribeDomainBpsDataByLayerRequest &&) = default ;
    ...
    inline DescribeDomainBpsDataByLayerRequest& setDomainName(string domainName) { DARABONBA_PTR_SET_VALUE(domainName_, domainName) };
    ...
    inline DescribeDomainBpsDataByLayerRequest& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline DescribeDomainBpsDataByLayerRequest& setInterval(string interval) { DARABONBA_PTR_SET_VALUE(interval_, interval) };
    ...
    inline DescribeDomainBpsDataByLayerRequest& setIspNameEn(string ispNameEn) { DARABONBA_PTR_SET_VALUE(ispNameEn_, ispNameEn) };
    ...
    inline DescribeDomainBpsDataByLayerRequest& setLayer(string layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline DescribeDomainBpsDataByLayerRequest& setLocationNameEn(string locationNameEn) { DARABONBA_PTR_SET_VALUE(locationNameEn_, locationNameEn) };
    ...
    inline DescribeDomainBpsDataByLayerRequest& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
