...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDOMAINSRCTOPURLVISITRESPONSEBODYURL300LISTURLLIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDOMAINSRCTOPURLVISITRESPONSEBODYURL300LISTURLLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList& obj) { 
    ...
    DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList() = default ;
    DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList(const DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList &) = default ;
    DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList(DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList &&) = default ;
    DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList() = default ;
    DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList& operator=(const DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList &) = default ;
    DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList& operator=(DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList &&) = default ;
    ...
    inline DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList& setFlow(string flow) { DARABONBA_PTR_SET_VALUE(flow_, flow) };
    ...
    inline DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList& setFlowProportion(float flowProportion) { DARABONBA_PTR_SET_VALUE(flowProportion_, flowProportion) };
    ...
    inline DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList& setUrlDetail(string urlDetail) { DARABONBA_PTR_SET_VALUE(urlDetail_, urlDetail) };
    ...
    inline DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList& setVisitData(string visitData) { DARABONBA_PTR_SET_VALUE(visitData_, visitData) };
    ...
    inline DescribeDomainSrcTopUrlVisitResponseBodyUrl300ListUrlList& setVisitProportion(float visitProportion) { DARABONBA_PTR_SET_VALUE(visitProportion_, visitProportion) };
