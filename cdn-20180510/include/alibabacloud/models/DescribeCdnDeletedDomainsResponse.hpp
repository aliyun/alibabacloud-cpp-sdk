...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnDeletedDomainsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnDeletedDomainsResponseBody) };
    inline DescribeCdnDeletedDomainsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnDeletedDomainsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnDeletedDomainsResponseBody> body_ {};
  };
