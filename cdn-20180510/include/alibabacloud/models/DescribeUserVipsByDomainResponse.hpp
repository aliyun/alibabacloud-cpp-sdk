...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserVipsByDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUserVipsByDomainResponseBody) };
    inline DescribeUserVipsByDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUserVipsByDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUserVipsByDomainResponseBody> body_ {};
  };
