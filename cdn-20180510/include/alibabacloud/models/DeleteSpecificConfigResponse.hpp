...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSpecificConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSpecificConfigResponseBody) };
    inline DeleteSpecificConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSpecificConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSpecificConfigResponseBody> body_ {};
  };
