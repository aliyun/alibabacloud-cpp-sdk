...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline ContentItem& setDomainName(string domainName) { DARABONBA_PTR_SET_VALUE(domainName_, domainName) };
        ...
        inline ContentItem& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
        ...
        inline ContentItem& setSampleRate(float sampleRate) { DARABONBA_PTR_SET_VALUE(sampleRate_, sampleRate) };
      ...
      inline const vector<Content::ContentItem> & getContent() const { DARABONBA_PTR_GET_CONST(content_, vector<Content::ContentItem>) };
      inline vector<Content::ContentItem> getContent() { DARABONBA_PTR_GET(content_, vector<Content::ContentItem>) };
      inline Content& setContent(const vector<Content::ContentItem> & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
      inline Content& setContent(vector<Content::ContentItem> && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };


    protected:
      shared_ptr<vector<Content::ContentItem>> content_ {};
    };
    ...
    bool hasContent() const { return this->content_ != nullptr;};
    void deleteContent() { this->content_ = nullptr;};
    inline const ModifyCustomDomainSampleRateResponseBody::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, ModifyCustomDomainSampleRateResponseBody::Content) };
    inline ModifyCustomDomainSampleRateResponseBody::Content getContent() { DARABONBA_PTR_GET(content_, ModifyCustomDomainSampleRateResponseBody::Content) };
    inline ModifyCustomDomainSampleRateResponseBody& setContent(const ModifyCustomDomainSampleRateResponseBody::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ModifyCustomDomainSampleRateResponseBody& setContent(ModifyCustomDomainSampleRateResponseBody::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    shared_ptr<ModifyCustomDomainSampleRateResponseBody::Content> content_ {};
