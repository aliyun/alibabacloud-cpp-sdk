...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainHttpCodeDataResponseBodyHttpCodeData & httpCodeData() const { DARABONBA_PTR_GET_CONST(httpCodeData_, DescribeDomainHttpCodeDataResponseBodyHttpCodeData) };
    inline DescribeDomainHttpCodeDataResponseBodyHttpCodeData httpCodeData() { DARABONBA_PTR_GET(httpCodeData_, DescribeDomainHttpCodeDataResponseBodyHttpCodeData) };
    inline DescribeDomainHttpCodeDataResponseBody& setHttpCodeData(const DescribeDomainHttpCodeDataResponseBodyHttpCodeData & httpCodeData) { DARABONBA_PTR_SET_VALUE(httpCodeData_, httpCodeData) };
    inline DescribeDomainHttpCodeDataResponseBody& setHttpCodeData(DescribeDomainHttpCodeDataResponseBodyHttpCodeData && httpCodeData) { DARABONBA_PTR_SET_RVALUE(httpCodeData_, httpCodeData) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDomainHttpCodeDataResponseBodyHttpCodeData> httpCodeData_ = nullptr;
