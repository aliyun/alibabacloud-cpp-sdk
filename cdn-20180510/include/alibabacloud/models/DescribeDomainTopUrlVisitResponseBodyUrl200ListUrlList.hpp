...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDOMAINTOPURLVISITRESPONSEBODYURL200LISTURLLIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDOMAINTOPURLVISITRESPONSEBODYURL200LISTURLLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList& obj) { 
    ...
    DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList() = default ;
    DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList(const DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList &) = default ;
    DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList(DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList &&) = default ;
    DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList() = default ;
    DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList& operator=(const DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList &) = default ;
    DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList& operator=(DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList &&) = default ;
    ...
    inline DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList& setFlow(string flow) { DARABONBA_PTR_SET_VALUE(flow_, flow) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList& setFlowProportion(float flowProportion) { DARABONBA_PTR_SET_VALUE(flowProportion_, flowProportion) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList& setUrlDetail(string urlDetail) { DARABONBA_PTR_SET_VALUE(urlDetail_, urlDetail) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList& setVisitData(string visitData) { DARABONBA_PTR_SET_VALUE(visitData_, visitData) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyUrl200ListUrlList& setVisitProportion(float visitProportion) { DARABONBA_PTR_SET_VALUE(visitProportion_, visitProportion) };
