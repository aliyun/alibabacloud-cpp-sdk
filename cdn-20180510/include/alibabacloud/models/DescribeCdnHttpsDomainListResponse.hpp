...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnHttpsDomainListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnHttpsDomainListResponseBody) };
    inline DescribeCdnHttpsDomainListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnHttpsDomainListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnHttpsDomainListResponseBody> body_ {};
  };
