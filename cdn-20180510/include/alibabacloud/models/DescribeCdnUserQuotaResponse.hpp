...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnUserQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnUserQuotaResponseBody) };
    inline DescribeCdnUserQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnUserQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnUserQuotaResponseBody> body_ {};
  };
