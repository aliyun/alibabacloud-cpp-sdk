...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDOMAINTOPURLVISITRESPONSEBODYALLURLLISTURLLIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDOMAINTOPURLVISITRESPONSEBODYALLURLLISTURLLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList& obj) { 
    ...
    DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList() = default ;
    DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList(const DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList &) = default ;
    DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList(DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList &&) = default ;
    DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList() = default ;
    DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList& operator=(const DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList &) = default ;
    DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList& operator=(DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList &&) = default ;
    ...
    inline DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList& setFlow(string flow) { DARABONBA_PTR_SET_VALUE(flow_, flow) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList& setFlowProportion(float flowProportion) { DARABONBA_PTR_SET_VALUE(flowProportion_, flowProportion) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList& setUrlDetail(string urlDetail) { DARABONBA_PTR_SET_VALUE(urlDetail_, urlDetail) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList& setVisitData(string visitData) { DARABONBA_PTR_SET_VALUE(visitData_, visitData) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyAllUrlListUrlList& setVisitProportion(float visitProportion) { DARABONBA_PTR_SET_VALUE(visitProportion_, visitProportion) };
