...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnReportListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnReportListResponseBody) };
    inline DescribeCdnReportListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnReportListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnReportListResponseBody> body_ {};
  };
