...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBlockedRegionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBlockedRegionsResponseBody) };
    inline DescribeBlockedRegionsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBlockedRegionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBlockedRegionsResponseBody> body_ {};
  };
