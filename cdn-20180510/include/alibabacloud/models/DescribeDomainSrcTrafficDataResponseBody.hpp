...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainSrcTrafficDataResponseBody::SrcTrafficDataPerInterval & getSrcTrafficDataPerInterval() const { DARABONBA_PTR_GET_CONST(srcTrafficDataPerInterval_, DescribeDomainSrcTrafficDataResponseBody::SrcTrafficDataPerInterval) };
    inline DescribeDomainSrcTrafficDataResponseBody::SrcTrafficDataPerInterval getSrcTrafficDataPerInterval() { DARABONBA_PTR_GET(srcTrafficDataPerInterval_, DescribeDomainSrcTrafficDataResponseBody::SrcTrafficDataPerInterval) };
    inline DescribeDomainSrcTrafficDataResponseBody& setSrcTrafficDataPerInterval(const DescribeDomainSrcTrafficDataResponseBody::SrcTrafficDataPerInterval & srcTrafficDataPerInterval) { DARABONBA_PTR_SET_VALUE(srcTrafficDataPerInterval_, srcTrafficDataPerInterval) };
    inline DescribeDomainSrcTrafficDataResponseBody& setSrcTrafficDataPerInterval(DescribeDomainSrcTrafficDataResponseBody::SrcTrafficDataPerInterval && srcTrafficDataPerInterval) { DARABONBA_PTR_SET_RVALUE(srcTrafficDataPerInterval_, srcTrafficDataPerInterval) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainSrcTrafficDataResponseBody::SrcTrafficDataPerInterval> srcTrafficDataPerInterval_ {};
