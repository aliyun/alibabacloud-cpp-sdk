...
namespace Models
{
  ...
  public:
    ...
    inline const ListRealtimeLogDeliveryInfosResponseBody::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, ListRealtimeLogDeliveryInfosResponseBody::Content) };
    inline ListRealtimeLogDeliveryInfosResponseBody::Content getContent() { DARABONBA_PTR_GET(content_, ListRealtimeLogDeliveryInfosResponseBody::Content) };
    inline ListRealtimeLogDeliveryInfosResponseBody& setContent(const ListRealtimeLogDeliveryInfosResponseBody::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListRealtimeLogDeliveryInfosResponseBody& setContent(ListRealtimeLogDeliveryInfosResponseBody::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    shared_ptr<ListRealtimeLogDeliveryInfosResponseBody::Content> content_ {};
