...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDOMAINTOPURLVISITRESPONSEBODYURL300LISTURLLIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDOMAINTOPURLVISITRESPONSEBODYURL300LISTURLLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList& obj) { 
    ...
    DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList() = default ;
    DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList(const DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList &) = default ;
    DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList(DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList &&) = default ;
    DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList() = default ;
    DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList& operator=(const DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList &) = default ;
    DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList& operator=(DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList &&) = default ;
    ...
    inline DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList& setFlow(string flow) { DARABONBA_PTR_SET_VALUE(flow_, flow) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList& setFlowProportion(float flowProportion) { DARABONBA_PTR_SET_VALUE(flowProportion_, flowProportion) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList& setUrlDetail(string urlDetail) { DARABONBA_PTR_SET_VALUE(urlDetail_, urlDetail) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList& setVisitData(string visitData) { DARABONBA_PTR_SET_VALUE(visitData_, visitData) };
    ...
    inline DescribeDomainTopUrlVisitResponseBodyUrl300ListUrlList& setVisitProportion(float visitProportion) { DARABONBA_PTR_SET_VALUE(visitProportion_, visitProportion) };
