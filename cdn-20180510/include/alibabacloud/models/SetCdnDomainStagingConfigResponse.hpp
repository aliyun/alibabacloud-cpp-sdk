...
namespace Models
{
  ...
  public:
    ...
    inline const SetCdnDomainStagingConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetCdnDomainStagingConfigResponseBody) };
    inline SetCdnDomainStagingConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, SetCdnDomainStagingConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetCdnDomainStagingConfigResponseBody> body_ {};
  };
