...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRefreshQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRefreshQuotaResponseBody) };
    inline DescribeRefreshQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRefreshQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRefreshQuotaResponseBody> body_ {};
  };
