...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainSrcQpsDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainSrcQpsDataResponseBody) };
    inline DescribeDomainSrcQpsDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainSrcQpsDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainSrcQpsDataResponseBody> body_ {};
  };
