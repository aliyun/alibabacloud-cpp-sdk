...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainQpsDataResponseBody::QpsDataInterval & getQpsDataInterval() const { DARABONBA_PTR_GET_CONST(qpsDataInterval_, DescribeDomainQpsDataResponseBody::QpsDataInterval) };
    inline DescribeDomainQpsDataResponseBody::QpsDataInterval getQpsDataInterval() { DARABONBA_PTR_GET(qpsDataInterval_, DescribeDomainQpsDataResponseBody::QpsDataInterval) };
    inline DescribeDomainQpsDataResponseBody& setQpsDataInterval(const DescribeDomainQpsDataResponseBody::QpsDataInterval & qpsDataInterval) { DARABONBA_PTR_SET_VALUE(qpsDataInterval_, qpsDataInterval) };
    inline DescribeDomainQpsDataResponseBody& setQpsDataInterval(DescribeDomainQpsDataResponseBody::QpsDataInterval && qpsDataInterval) { DARABONBA_PTR_SET_RVALUE(qpsDataInterval_, qpsDataInterval) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainQpsDataResponseBody::QpsDataInterval> qpsDataInterval_ {};
