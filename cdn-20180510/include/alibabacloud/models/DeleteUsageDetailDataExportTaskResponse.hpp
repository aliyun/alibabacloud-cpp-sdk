...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteUsageDetailDataExportTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteUsageDetailDataExportTaskResponseBody) };
    inline DeleteUsageDetailDataExportTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteUsageDetailDataExportTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteUsageDetailDataExportTaskResponseBody> body_ {};
  };
