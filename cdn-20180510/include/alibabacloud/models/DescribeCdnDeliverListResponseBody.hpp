...
#include <alibabacloud/models/DescribeCdnDeliverListResponseBodyContent.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnDeliverListResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, DescribeCdnDeliverListResponseBodyContent) };
    inline DescribeCdnDeliverListResponseBodyContent content() { DARABONBA_PTR_GET(content_, DescribeCdnDeliverListResponseBodyContent) };
    inline DescribeCdnDeliverListResponseBody& setContent(const DescribeCdnDeliverListResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline DescribeCdnDeliverListResponseBody& setContent(DescribeCdnDeliverListResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCdnDeliverListResponseBodyContent> content_ = nullptr;
