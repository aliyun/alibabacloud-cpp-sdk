...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->blockInterval_ == nullptr
    ...
    inline int32_t getBlockInterval() const { DARABONBA_PTR_GET_DEFAULT(blockInterval_, 0) };
  ...
  protected:
    ...
    shared_ptr<int32_t> blockInterval_ {};
