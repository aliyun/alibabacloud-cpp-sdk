...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnReportResponseBody) };
    inline DescribeCdnReportResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnReportResponseBody> body_ {};
  };
