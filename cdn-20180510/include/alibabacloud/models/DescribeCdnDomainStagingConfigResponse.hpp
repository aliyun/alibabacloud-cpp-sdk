...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnDomainStagingConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnDomainStagingConfigResponseBody) };
    inline DescribeCdnDomainStagingConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnDomainStagingConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnDomainStagingConfigResponseBody> body_ {};
  };
