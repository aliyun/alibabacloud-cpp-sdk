...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCdnDomainSchdmByPropertyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCdnDomainSchdmByPropertyResponseBody) };
    inline ModifyCdnDomainSchdmByPropertyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCdnDomainSchdmByPropertyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCdnDomainSchdmByPropertyResponseBody> body_ {};
  };
