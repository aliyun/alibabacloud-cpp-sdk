...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnCertificateListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnCertificateListResponseBody) };
    inline DescribeCdnCertificateListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnCertificateListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnCertificateListResponseBody> body_ {};
  };
