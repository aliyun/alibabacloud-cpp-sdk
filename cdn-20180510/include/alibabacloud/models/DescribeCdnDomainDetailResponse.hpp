...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnDomainDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnDomainDetailResponseBody) };
    inline DescribeCdnDomainDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnDomainDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnDomainDetailResponseBody> body_ {};
  };
