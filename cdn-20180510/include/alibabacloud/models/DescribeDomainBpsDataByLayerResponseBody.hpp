...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainBpsDataByLayerResponseBody::BpsDataInterval & getBpsDataInterval() const { DARABONBA_PTR_GET_CONST(bpsDataInterval_, DescribeDomainBpsDataByLayerResponseBody::BpsDataInterval) };
    inline DescribeDomainBpsDataByLayerResponseBody::BpsDataInterval getBpsDataInterval() { DARABONBA_PTR_GET(bpsDataInterval_, DescribeDomainBpsDataByLayerResponseBody::BpsDataInterval) };
    inline DescribeDomainBpsDataByLayerResponseBody& setBpsDataInterval(const DescribeDomainBpsDataByLayerResponseBody::BpsDataInterval & bpsDataInterval) { DARABONBA_PTR_SET_VALUE(bpsDataInterval_, bpsDataInterval) };
    inline DescribeDomainBpsDataByLayerResponseBody& setBpsDataInterval(DescribeDomainBpsDataByLayerResponseBody::BpsDataInterval && bpsDataInterval) { DARABONBA_PTR_SET_RVALUE(bpsDataInterval_, bpsDataInterval) };
  ...
  protected:
    shared_ptr<DescribeDomainBpsDataByLayerResponseBody::BpsDataInterval> bpsDataInterval_ {};
