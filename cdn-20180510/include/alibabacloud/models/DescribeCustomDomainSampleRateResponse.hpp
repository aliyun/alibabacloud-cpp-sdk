...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCustomDomainSampleRateResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeCustomDomainSampleRateResponseBody) };
    inline DescribeCustomDomainSampleRateResponseBody body() { DARABONBA_PTR_GET(body_, DescribeCustomDomainSampleRateResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCustomDomainSampleRateResponseBody> body_ = nullptr;
  };
