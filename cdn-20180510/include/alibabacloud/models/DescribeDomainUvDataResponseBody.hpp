...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainUvDataResponseBody::UvDataInterval & getUvDataInterval() const { DARABONBA_PTR_GET_CONST(uvDataInterval_, DescribeDomainUvDataResponseBody::UvDataInterval) };
    inline DescribeDomainUvDataResponseBody::UvDataInterval getUvDataInterval() { DARABONBA_PTR_GET(uvDataInterval_, DescribeDomainUvDataResponseBody::UvDataInterval) };
    inline DescribeDomainUvDataResponseBody& setUvDataInterval(const DescribeDomainUvDataResponseBody::UvDataInterval & uvDataInterval) { DARABONBA_PTR_SET_VALUE(uvDataInterval_, uvDataInterval) };
    inline DescribeDomainUvDataResponseBody& setUvDataInterval(DescribeDomainUvDataResponseBody::UvDataInterval && uvDataInterval) { DARABONBA_PTR_SET_RVALUE(uvDataInterval_, uvDataInterval) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainUvDataResponseBody::UvDataInterval> uvDataInterval_ {};
  };
