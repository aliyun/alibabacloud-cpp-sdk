...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainCcActivityLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainCcActivityLogResponseBody) };
    inline DescribeDomainCcActivityLogResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainCcActivityLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainCcActivityLogResponseBody> body_ {};
  };
