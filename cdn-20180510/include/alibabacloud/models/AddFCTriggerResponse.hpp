...
namespace Models
{
  ...
  public:
    ...
    inline const AddFCTriggerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddFCTriggerResponseBody) };
    inline AddFCTriggerResponseBody getBody() { DARABONBA_PTR_GET(body_, AddFCTriggerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddFCTriggerResponseBody> body_ {};
  };
