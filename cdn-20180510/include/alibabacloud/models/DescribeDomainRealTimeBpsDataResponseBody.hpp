...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainRealTimeBpsDataResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeDomainRealTimeBpsDataResponseBodyData) };
    inline DescribeDomainRealTimeBpsDataResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeDomainRealTimeBpsDataResponseBodyData) };
    inline DescribeDomainRealTimeBpsDataResponseBody& setData(const DescribeDomainRealTimeBpsDataResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDomainRealTimeBpsDataResponseBody& setData(DescribeDomainRealTimeBpsDataResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<DescribeDomainRealTimeBpsDataResponseBodyData> data_ = nullptr;
