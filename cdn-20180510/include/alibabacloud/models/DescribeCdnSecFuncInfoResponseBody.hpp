...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeCdnSecFuncInfoResponseBody::Content> & getContent() const { DARABONBA_PTR_GET_CONST(content_, vector<DescribeCdnSecFuncInfoResponseBody::Content>) };
    inline vector<DescribeCdnSecFuncInfoResponseBody::Content> getContent() { DARABONBA_PTR_GET(content_, vector<DescribeCdnSecFuncInfoResponseBody::Content>) };
    inline DescribeCdnSecFuncInfoResponseBody& setContent(const vector<DescribeCdnSecFuncInfoResponseBody::Content> & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline DescribeCdnSecFuncInfoResponseBody& setContent(vector<DescribeCdnSecFuncInfoResponseBody::Content> && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    // Queried data.
    shared_ptr<vector<DescribeCdnSecFuncInfoResponseBody::Content>> content_ {};
    // The description.
