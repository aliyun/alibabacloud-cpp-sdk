...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnSMCertificateDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnSMCertificateDetailResponseBody) };
    inline DescribeCdnSMCertificateDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnSMCertificateDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnSMCertificateDetailResponseBody> body_ {};
  };
