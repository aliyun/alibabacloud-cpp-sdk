...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDOMAINSRCTOPURLVISITRESPONSEBODYURL200LISTURLLIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDOMAINSRCTOPURLVISITRESPONSEBODYURL200LISTURLLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList& obj) { 
    ...
    DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList() = default ;
    DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList(const DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList &) = default ;
    DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList(DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList &&) = default ;
    DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList() = default ;
    DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList& operator=(const DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList &) = default ;
    DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList& operator=(DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList &&) = default ;
    ...
    inline DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList& setFlow(string flow) { DARABONBA_PTR_SET_VALUE(flow_, flow) };
    ...
    inline DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList& setFlowProportion(float flowProportion) { DARABONBA_PTR_SET_VALUE(flowProportion_, flowProportion) };
    ...
    inline DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList& setUrlDetail(string urlDetail) { DARABONBA_PTR_SET_VALUE(urlDetail_, urlDetail) };
    ...
    inline DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList& setVisitData(string visitData) { DARABONBA_PTR_SET_VALUE(visitData_, visitData) };
    ...
    inline DescribeDomainSrcTopUrlVisitResponseBodyUrl200ListUrlList& setVisitProportion(float visitProportion) { DARABONBA_PTR_SET_VALUE(visitProportion_, visitProportion) };
