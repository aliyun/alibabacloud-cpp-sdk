...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdnFullDomainsBlockIPConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdnFullDomainsBlockIPConfigResponseBody) };
    inline DescribeCdnFullDomainsBlockIPConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdnFullDomainsBlockIPConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdnFullDomainsBlockIPConfigResponseBody> body_ {};
  };
