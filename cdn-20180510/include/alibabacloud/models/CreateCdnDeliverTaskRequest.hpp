...
#ifndef ALIBABACLOUD_MODELS_CREATECDNDELIVERTASKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATECDNDELIVERTASKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateCdnDeliverTaskRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateCdnDeliverTaskRequest& obj) { 
    ...
    CreateCdnDeliverTaskRequest() = default ;
    CreateCdnDeliverTaskRequest(const CreateCdnDeliverTaskRequest &) = default ;
    CreateCdnDeliverTaskRequest(CreateCdnDeliverTaskRequest &&) = default ;
    CreateCdnDeliverTaskRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateCdnDeliverTaskRequest() = default ;
    CreateCdnDeliverTaskRequest& operator=(const CreateCdnDeliverTaskRequest &) = default ;
    CreateCdnDeliverTaskRequest& operator=(CreateCdnDeliverTaskRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->deliver_ == nullptr
        && return this->domainName_ == nullptr && return this->name_ == nullptr && return this->reports_ == nullptr && return this->schedule_ == nullptr; };
    ...
    inline CreateCdnDeliverTaskRequest& setDeliver(string deliver) { DARABONBA_PTR_SET_VALUE(deliver_, deliver) };
    ...
    inline CreateCdnDeliverTaskRequest& setDomainName(string domainName) { DARABONBA_PTR_SET_VALUE(domainName_, domainName) };
    ...
    inline CreateCdnDeliverTaskRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline CreateCdnDeliverTaskRequest& setReports(string reports) { DARABONBA_PTR_SET_VALUE(reports_, reports) };
    ...
    inline CreateCdnDeliverTaskRequest& setSchedule(string schedule) { DARABONBA_PTR_SET_VALUE(schedule_, schedule) };
