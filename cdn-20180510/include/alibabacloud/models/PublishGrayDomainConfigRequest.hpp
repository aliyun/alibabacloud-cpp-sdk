...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->customCountryId_ == nullptr
        && this->customPercent_ == nullptr && this->customProvinceId_ == nullptr && this->domainName_ == nullptr && this->publishMode_ == nullptr; };
    ...
    inline int32_t getCustomCountryId() const { DARABONBA_PTR_GET_DEFAULT(customCountryId_, 0) };
    ...
    inline int32_t getCustomPercent() const { DARABONBA_PTR_GET_DEFAULT(customPercent_, 0) };
    ...
    inline int32_t getCustomProvinceId() const { DARABONBA_PTR_GET_DEFAULT(customProvinceId_, 0) };
  ...
  protected:
    shared_ptr<int32_t> customCountryId_ {};
    shared_ptr<int32_t> customPercent_ {};
    shared_ptr<int32_t> customProvinceId_ {};
