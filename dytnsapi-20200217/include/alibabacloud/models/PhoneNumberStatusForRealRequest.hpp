...
#ifndef ALIBABACLOUD_MODELS_PHONENUMBERSTATUSFORREALREQUEST_HPP_
#define ALIBABACLOUD_MODELS_PHONENUMBERSTATUSFORREALREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PhoneNumberStatusForRealRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PhoneNumberStatusForRealRequest& obj) { 
    ...
    PhoneNumberStatusForRealRequest() = default ;
    PhoneNumberStatusForRealRequest(const PhoneNumberStatusForRealRequest &) = default ;
    PhoneNumberStatusForRealRequest(PhoneNumberStatusForRealRequest &&) = default ;
    PhoneNumberStatusForRealRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PhoneNumberStatusForRealRequest() = default ;
    PhoneNumberStatusForRealRequest& operator=(const PhoneNumberStatusForRealRequest &) = default ;
    PhoneNumberStatusForRealRequest& operator=(PhoneNumberStatusForRealRequest &&) = default ;
    ...
    inline PhoneNumberStatusForRealRequest& setAuthCode(string authCode) { DARABONBA_PTR_SET_VALUE(authCode_, authCode) };
    ...
    inline PhoneNumberStatusForRealRequest& setInputNumber(string inputNumber) { DARABONBA_PTR_SET_VALUE(inputNumber_, inputNumber) };
    ...
    inline PhoneNumberStatusForRealRequest& setMask(string mask) { DARABONBA_PTR_SET_VALUE(mask_, mask) };
    ...
    inline PhoneNumberStatusForRealRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline PhoneNumberStatusForRealRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline PhoneNumberStatusForRealRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
