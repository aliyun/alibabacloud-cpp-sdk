...
#ifndef ALIBABACLOUD_MODELS_COMPANYTHREEELEMENTSVERIFICATIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_COMPANYTHREEELEMENTSVERIFICATIONRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CompanyThreeElementsVerificationResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CompanyThreeElementsVerificationResponseBody& obj) { 
    ...
    CompanyThreeElementsVerificationResponseBody() = default ;
    CompanyThreeElementsVerificationResponseBody(const CompanyThreeElementsVerificationResponseBody &) = default ;
    CompanyThreeElementsVerificationResponseBody(CompanyThreeElementsVerificationResponseBody &&) = default ;
    CompanyThreeElementsVerificationResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CompanyThreeElementsVerificationResponseBody() = default ;
    CompanyThreeElementsVerificationResponseBody& operator=(const CompanyThreeElementsVerificationResponseBody &) = default ;
    CompanyThreeElementsVerificationResponseBody& operator=(CompanyThreeElementsVerificationResponseBody &&) = default ;
    ...
    inline CompanyThreeElementsVerificationResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline CompanyThreeElementsVerificationResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CompanyThreeElementsVerificationResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CompanyThreeElementsVerificationResponseBody::Data) };
    inline CompanyThreeElementsVerificationResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CompanyThreeElementsVerificationResponseBody::Data) };
    inline CompanyThreeElementsVerificationResponseBody& setData(const CompanyThreeElementsVerificationResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CompanyThreeElementsVerificationResponseBody& setData(CompanyThreeElementsVerificationResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CompanyThreeElementsVerificationResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CompanyThreeElementsVerificationResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
