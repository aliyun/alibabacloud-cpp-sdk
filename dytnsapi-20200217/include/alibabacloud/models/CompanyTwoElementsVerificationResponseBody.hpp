...
#ifndef ALIBABACLOUD_MODELS_COMPANYTWOELEMENTSVERIFICATIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_COMPANYTWOELEMENTSVERIFICATIONRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CompanyTwoElementsVerificationResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CompanyTwoElementsVerificationResponseBody& obj) { 
    ...
    CompanyTwoElementsVerificationResponseBody() = default ;
    CompanyTwoElementsVerificationResponseBody(const CompanyTwoElementsVerificationResponseBody &) = default ;
    CompanyTwoElementsVerificationResponseBody(CompanyTwoElementsVerificationResponseBody &&) = default ;
    CompanyTwoElementsVerificationResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CompanyTwoElementsVerificationResponseBody() = default ;
    CompanyTwoElementsVerificationResponseBody& operator=(const CompanyTwoElementsVerificationResponseBody &) = default ;
    CompanyTwoElementsVerificationResponseBody& operator=(CompanyTwoElementsVerificationResponseBody &&) = default ;
    ...
    inline CompanyTwoElementsVerificationResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline CompanyTwoElementsVerificationResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CompanyTwoElementsVerificationResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CompanyTwoElementsVerificationResponseBody::Data) };
    inline CompanyTwoElementsVerificationResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CompanyTwoElementsVerificationResponseBody::Data) };
    inline CompanyTwoElementsVerificationResponseBody& setData(const CompanyTwoElementsVerificationResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CompanyTwoElementsVerificationResponseBody& setData(CompanyTwoElementsVerificationResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CompanyTwoElementsVerificationResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CompanyTwoElementsVerificationResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
