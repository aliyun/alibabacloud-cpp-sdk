...
#ifndef ALIBABACLOUD_MODELS_PHONENUMBERSTATUSFORSMSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_PHONENUMBERSTATUSFORSMSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PhoneNumberStatusForSmsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PhoneNumberStatusForSmsRequest& obj) { 
    ...
    PhoneNumberStatusForSmsRequest(const PhoneNumberStatusForSmsRequest &) = default ;
    PhoneNumberStatusForSmsRequest(PhoneNumberStatusForSmsRequest &&) = default ;
    PhoneNumberStatusForSmsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PhoneNumberStatusForSmsRequest() = default ;
    PhoneNumberStatusForSmsRequest& operator=(const PhoneNumberStatusForSmsRequest &) = default ;
    PhoneNumberStatusForSmsRequest& operator=(PhoneNumberStatusForSmsRequest &&) = default ;
    ...
    inline PhoneNumberStatusForSmsRequest& setAuthCode(string authCode) { DARABONBA_PTR_SET_VALUE(authCode_, authCode) };
    ...
    inline PhoneNumberStatusForSmsRequest& setInputNumber(string inputNumber) { DARABONBA_PTR_SET_VALUE(inputNumber_, inputNumber) };
    ...
    inline PhoneNumberStatusForSmsRequest& setMask(string mask) { DARABONBA_PTR_SET_VALUE(mask_, mask) };
    ...
    inline PhoneNumberStatusForSmsRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline PhoneNumberStatusForSmsRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline PhoneNumberStatusForSmsRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
