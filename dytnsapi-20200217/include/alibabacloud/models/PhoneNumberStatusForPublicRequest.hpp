...
#ifndef ALIBABACLOUD_MODELS_PHONENUMBERSTATUSFORPUBLICREQUEST_HPP_
#define ALIBABACLOUD_MODELS_PHONENUMBERSTATUSFORPUBLICREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PhoneNumberStatusForPublicRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PhoneNumberStatusForPublicRequest& obj) { 
    ...
    PhoneNumberStatusForPublicRequest() = default ;
    PhoneNumberStatusForPublicRequest(const PhoneNumberStatusForPublicRequest &) = default ;
    PhoneNumberStatusForPublicRequest(PhoneNumberStatusForPublicRequest &&) = default ;
    PhoneNumberStatusForPublicRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PhoneNumberStatusForPublicRequest() = default ;
    PhoneNumberStatusForPublicRequest& operator=(const PhoneNumberStatusForPublicRequest &) = default ;
    PhoneNumberStatusForPublicRequest& operator=(PhoneNumberStatusForPublicRequest &&) = default ;
    ...
    inline PhoneNumberStatusForPublicRequest& setAuthCode(string authCode) { DARABONBA_PTR_SET_VALUE(authCode_, authCode) };
    ...
    inline PhoneNumberStatusForPublicRequest& setInputNumber(string inputNumber) { DARABONBA_PTR_SET_VALUE(inputNumber_, inputNumber) };
    ...
    inline PhoneNumberStatusForPublicRequest& setMask(string mask) { DARABONBA_PTR_SET_VALUE(mask_, mask) };
    ...
    inline PhoneNumberStatusForPublicRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline PhoneNumberStatusForPublicRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline PhoneNumberStatusForPublicRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
