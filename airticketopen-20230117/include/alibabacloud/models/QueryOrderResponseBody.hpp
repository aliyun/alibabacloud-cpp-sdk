...
#ifndef ALIBABACLOUD_MODELS_QUERYORDERRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYORDERRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryOrderResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryOrderResponseBody& obj) { 
    ...
    QueryOrderResponseBody() = default ;
    QueryOrderResponseBody(const QueryOrderResponseBody &) = default ;
    QueryOrderResponseBody(QueryOrderResponseBody &&) = default ;
    QueryOrderResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryOrderResponseBody() = default ;
    QueryOrderResponseBody& operator=(const QueryOrderResponseBody &) = default ;
    QueryOrderResponseBody& operator=(QueryOrderResponseBody &&) = default ;
    ...
    inline const QueryOrderResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryOrderResponseBody::Data) };
    inline QueryOrderResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryOrderResponseBody::Data) };
    inline QueryOrderResponseBody& setData(const QueryOrderResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryOrderResponseBody& setData(QueryOrderResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryOrderResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline QueryOrderResponseBody& setErrorMsg(string errorMsg) { DARABONBA_PTR_SET_VALUE(errorMsg_, errorMsg) };
    ...
    inline QueryOrderResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryOrderResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    void deleteTracerId() { this->tracerId_ = nullptr;};
    inline string getTracerId() const { DARABONBA_PTR_GET_DEFAULT(tracerId_, "") };
    inline QueryOrderResponseBody& setTracerId(string tracerId) { DARABONBA_PTR_SET_VALUE(tracerId_, tracerId) };


  protected:
    shared_ptr<QueryOrderResponseBody::Data> data_ {};
