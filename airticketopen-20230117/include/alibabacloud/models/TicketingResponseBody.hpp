...
namespace Models
{
  ...
  public:
    ...
    inline const TicketingResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, TicketingResponseBodyData) };
    inline TicketingResponseBodyData data() { DARABONBA_PTR_GET(data_, TicketingResponseBodyData) };
    inline TicketingResponseBody& setData(const TicketingResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline TicketingResponseBody& setData(TicketingResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // data
    std::shared_ptr<TicketingResponseBodyData> data_ = nullptr;
    // error code
