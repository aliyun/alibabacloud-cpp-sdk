...
namespace Models
{
  ...
  public:
    ...
    inline const AncillarySuggestResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AncillarySuggestResponseBody) };
    inline AncillarySuggestResponseBody getBody() { DARABONBA_PTR_GET(body_, AncillarySuggestResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AncillarySuggestResponseBody> body_ {};
  };
