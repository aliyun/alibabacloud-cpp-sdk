...
namespace Models
{
  ...
  public:
    ...
    inline const SearchResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SearchResponseBody::Data) };
    inline SearchResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SearchResponseBody::Data) };
    inline SearchResponseBody& setData(const SearchResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SearchResponseBody& setData(SearchResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline SearchResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline SearchResponseBody& setErrorData(const Darabonba::Json & errorData) { DARABONBA_SET_VALUE(errorData_, errorData) };
    inline SearchResponseBody& setErrorData(Darabonba::Json && errorData) { DARABONBA_SET_RVALUE(errorData_, errorData) };
    ...
    inline SearchResponseBody& setErrorMsg(string errorMsg) { DARABONBA_PTR_SET_VALUE(errorMsg_, errorMsg) };
    ...
    inline SearchResponseBody& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
  ...
  protected:
    ...
    shared_ptr<SearchResponseBody::Data> data_ {};
