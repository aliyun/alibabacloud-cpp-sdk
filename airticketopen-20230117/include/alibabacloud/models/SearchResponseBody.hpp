...
namespace Models
{
  ...
  public:
    ...
    inline const SearchResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SearchResponseBodyData) };
    inline SearchResponseBodyData data() { DARABONBA_PTR_GET(data_, SearchResponseBodyData) };
    inline SearchResponseBody& setData(const SearchResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SearchResponseBody& setData(SearchResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // data
    std::shared_ptr<SearchResponseBodyData> data_ = nullptr;
    // error code
