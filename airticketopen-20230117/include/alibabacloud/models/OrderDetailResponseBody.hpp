...
namespace Models
{
  ...
  public:
    ...
    inline const OrderDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, OrderDetailResponseBodyData) };
    inline OrderDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, OrderDetailResponseBodyData) };
    inline OrderDetailResponseBody& setData(const OrderDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline OrderDetailResponseBody& setData(OrderDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // data
    std::shared_ptr<OrderDetailResponseBodyData> data_ = nullptr;
    // error code
