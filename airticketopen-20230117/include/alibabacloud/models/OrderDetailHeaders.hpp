...
#ifndef ALIBABACLOUD_MODELS_ORDERDETAILHEADERS_HPP_
#define ALIBABACLOUD_MODELS_ORDERDETAILHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const OrderDetailHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, OrderDetailHeaders& obj) { 
    ...
    OrderDetailHeaders() = default ;
    OrderDetailHeaders(const OrderDetailHeaders &) = default ;
    OrderDetailHeaders(OrderDetailHeaders &&) = default ;
    OrderDetailHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~OrderDetailHeaders() = default ;
    OrderDetailHeaders& operator=(const OrderDetailHeaders &) = default ;
    OrderDetailHeaders& operator=(OrderDetailHeaders &&) = default ;
    ...
    inline OrderDetailHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline OrderDetailHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline OrderDetailHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline OrderDetailHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
