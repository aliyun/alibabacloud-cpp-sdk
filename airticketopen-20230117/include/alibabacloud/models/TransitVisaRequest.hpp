...
namespace Models
{
  ...
  public:
    ...
    inline const vector<TransitVisaRequest::FlightSegmentParamList> & getFlightSegmentParamList() const { DARABONBA_PTR_GET_CONST(flightSegmentParamList_, vector<TransitVisaRequest::FlightSegmentParamList>) };
    inline vector<TransitVisaRequest::FlightSegmentParamList> getFlightSegmentParamList() { DARABONBA_PTR_GET(flightSegmentParamList_, vector<TransitVisaRequest::FlightSegmentParamList>) };
    inline TransitVisaRequest& setFlightSegmentParamList(const vector<TransitVisaRequest::FlightSegmentParamList> & flightSegmentParamList) { DARABONBA_PTR_SET_VALUE(flightSegmentParamList_, flightSegmentParamList) };
    inline TransitVisaRequest& setFlightSegmentParamList(vector<TransitVisaRequest::FlightSegmentParamList> && flightSegmentParamList) { DARABONBA_PTR_SET_RVALUE(flightSegmentParamList_, flightSegmentParamList) };


  protected:
    // The list of flight segments that constitute an itinerary. Maximum size: 2.
    shared_ptr<vector<TransitVisaRequest::FlightSegmentParamList>> flightSegmentParamList_ {};
  };
