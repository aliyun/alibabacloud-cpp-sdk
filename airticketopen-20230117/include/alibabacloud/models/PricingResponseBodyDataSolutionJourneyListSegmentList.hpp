...
#ifndef ALIBABACLOUD_MODELS_PRICINGRESPONSEBODYDATASOLUTIONJOURNEYLISTSEGMENTLIST_HPP_
#define ALIBABACLOUD_MODELS_PRICINGRESPONSEBODYDATASOLUTIONJOURNEYLISTSEGMENTLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PricingResponseBodyDataSolutionJourneyListSegmentList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PricingResponseBodyDataSolutionJourneyListSegmentList& obj) { 
    ...
    PricingResponseBodyDataSolutionJourneyListSegmentList() = default ;
    PricingResponseBodyDataSolutionJourneyListSegmentList(const PricingResponseBodyDataSolutionJourneyListSegmentList &) = default ;
    PricingResponseBodyDataSolutionJourneyListSegmentList(PricingResponseBodyDataSolutionJourneyListSegmentList &&) = default ;
    PricingResponseBodyDataSolutionJourneyListSegmentList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PricingResponseBodyDataSolutionJourneyListSegmentList() = default ;
    PricingResponseBodyDataSolutionJourneyListSegmentList& operator=(const PricingResponseBodyDataSolutionJourneyListSegmentList &) = default ;
    PricingResponseBodyDataSolutionJourneyListSegmentList& operator=(PricingResponseBodyDataSolutionJourneyListSegmentList &&) = default ;
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setArrivalAirport(string arrivalAirport) { DARABONBA_PTR_SET_VALUE(arrivalAirport_, arrivalAirport) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setArrivalCity(string arrivalCity) { DARABONBA_PTR_SET_VALUE(arrivalCity_, arrivalCity) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setArrivalTerminal(string arrivalTerminal) { DARABONBA_PTR_SET_VALUE(arrivalTerminal_, arrivalTerminal) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setArrivalTime(string arrivalTime) { DARABONBA_PTR_SET_VALUE(arrivalTime_, arrivalTime) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setAvailability(string availability) { DARABONBA_PTR_SET_VALUE(availability_, availability) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setCabinClass(string cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setCodeShare(bool codeShare) { DARABONBA_PTR_SET_VALUE(codeShare_, codeShare) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setDepartureAirport(string departureAirport) { DARABONBA_PTR_SET_VALUE(departureAirport_, departureAirport) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setDepartureCity(string departureCity) { DARABONBA_PTR_SET_VALUE(departureCity_, departureCity) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setDepartureTerminal(string departureTerminal) { DARABONBA_PTR_SET_VALUE(departureTerminal_, departureTerminal) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setDepartureTime(string departureTime) { DARABONBA_PTR_SET_VALUE(departureTime_, departureTime) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setEquipType(string equipType) { DARABONBA_PTR_SET_VALUE(equipType_, equipType) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setFlightDuration(int32_t flightDuration) { DARABONBA_PTR_SET_VALUE(flightDuration_, flightDuration) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setMarketingAirline(string marketingAirline) { DARABONBA_PTR_SET_VALUE(marketingAirline_, marketingAirline) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setMarketingFlightNo(string marketingFlightNo) { DARABONBA_PTR_SET_VALUE(marketingFlightNo_, marketingFlightNo) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setMarketingFlightNoInt(int32_t marketingFlightNoInt) { DARABONBA_PTR_SET_VALUE(marketingFlightNoInt_, marketingFlightNoInt) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setOperatingAirline(string operatingAirline) { DARABONBA_PTR_SET_VALUE(operatingAirline_, operatingAirline) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setOperatingFlightNo(string operatingFlightNo) { DARABONBA_PTR_SET_VALUE(operatingFlightNo_, operatingFlightNo) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setSegmentId(string segmentId) { DARABONBA_PTR_SET_VALUE(segmentId_, segmentId) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setStopCityList(string stopCityList) { DARABONBA_PTR_SET_VALUE(stopCityList_, stopCityList) };
    ...
    inline PricingResponseBodyDataSolutionJourneyListSegmentList& setStopQuantity(int32_t stopQuantity) { DARABONBA_PTR_SET_VALUE(stopQuantity_, stopQuantity) };
