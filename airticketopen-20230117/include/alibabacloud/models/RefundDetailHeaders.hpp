...
#ifndef ALIBABACLOUD_MODELS_REFUNDDETAILHEADERS_HPP_
#define ALIBABACLOUD_MODELS_REFUNDDETAILHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RefundDetailHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RefundDetailHeaders& obj) { 
    ...
    RefundDetailHeaders() = default ;
    RefundDetailHeaders(const RefundDetailHeaders &) = default ;
    RefundDetailHeaders(RefundDetailHeaders &&) = default ;
    RefundDetailHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RefundDetailHeaders() = default ;
    RefundDetailHeaders& operator=(const RefundDetailHeaders &) = default ;
    RefundDetailHeaders& operator=(RefundDetailHeaders &&) = default ;
    ...
    inline RefundDetailHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline RefundDetailHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline RefundDetailHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline RefundDetailHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
