...
#ifndef ALIBABACLOUD_MODELS_DATABAGGAGEALLOWANCEMAPVALUE_HPP_
#define ALIBABACLOUD_MODELS_DATABAGGAGEALLOWANCEMAPVALUE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DataBaggageAllowanceMapValue& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DataBaggageAllowanceMapValue& obj) { 
    ...
    DataBaggageAllowanceMapValue() = default ;
    DataBaggageAllowanceMapValue(const DataBaggageAllowanceMapValue &) = default ;
    DataBaggageAllowanceMapValue(DataBaggageAllowanceMapValue &&) = default ;
    DataBaggageAllowanceMapValue(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DataBaggageAllowanceMapValue() = default ;
    DataBaggageAllowanceMapValue& operator=(const DataBaggageAllowanceMapValue &) = default ;
    DataBaggageAllowanceMapValue& operator=(DataBaggageAllowanceMapValue &&) = default ;
    ...
    inline DataBaggageAllowanceMapValue& setBaggageAmount(int32_t baggageAmount) { DARABONBA_PTR_SET_VALUE(baggageAmount_, baggageAmount) };
    ...
    inline DataBaggageAllowanceMapValue& setBaggageWeight(int32_t baggageWeight) { DARABONBA_PTR_SET_VALUE(baggageWeight_, baggageWeight) };
    ...
    inline DataBaggageAllowanceMapValue& setBaggageWeightUnit(string baggageWeightUnit) { DARABONBA_PTR_SET_VALUE(baggageWeightUnit_, baggageWeightUnit) };
    ...
    inline DataBaggageAllowanceMapValue& setIsAllWeight(bool isAllWeight) { DARABONBA_PTR_SET_VALUE(isAllWeight_, isAllWeight) };
    ...
    inline DataBaggageAllowanceMapValue& setCarryOnAmount(int32_t carryOnAmount) { DARABONBA_PTR_SET_VALUE(carryOnAmount_, carryOnAmount) };
    ...
    inline DataBaggageAllowanceMapValue& setCarryOnWeight(int32_t carryOnWeight) { DARABONBA_PTR_SET_VALUE(carryOnWeight_, carryOnWeight) };
    ...
    inline DataBaggageAllowanceMapValue& setCarryOnWeightUnit(string carryOnWeightUnit) { DARABONBA_PTR_SET_VALUE(carryOnWeightUnit_, carryOnWeightUnit) };
    ...
    inline DataBaggageAllowanceMapValue& setIsAllCarryOnWeight(bool isAllCarryOnWeight) { DARABONBA_PTR_SET_VALUE(isAllCarryOnWeight_, isAllCarryOnWeight) };
    ...
    inline DataBaggageAllowanceMapValue& setCarryLength(int32_t carryLength) { DARABONBA_PTR_SET_VALUE(carryLength_, carryLength) };
    ...
    inline DataBaggageAllowanceMapValue& setCarryWidth(int32_t carryWidth) { DARABONBA_PTR_SET_VALUE(carryWidth_, carryWidth) };
    ...
    inline DataBaggageAllowanceMapValue& setCarryHeight(int32_t carryHeight) { DARABONBA_PTR_SET_VALUE(carryHeight_, carryHeight) };
    ...
    inline DataBaggageAllowanceMapValue& setCarrySumOfLengthWidthHeight(int32_t carrySumOfLengthWidthHeight) { DARABONBA_PTR_SET_VALUE(carrySumOfLengthWidthHeight_, carrySumOfLengthWidthHeight) };
    ...
    inline DataBaggageAllowanceMapValue& setLength(int32_t length) { DARABONBA_PTR_SET_VALUE(length_, length) };
    ...
    inline DataBaggageAllowanceMapValue& setWidth(int32_t width) { DARABONBA_PTR_SET_VALUE(width_, width) };
    ...
    inline DataBaggageAllowanceMapValue& setHeight(int32_t height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline DataBaggageAllowanceMapValue& setSumOfLengthWidthHeight(int32_t sumOfLengthWidthHeight) { DARABONBA_PTR_SET_VALUE(sumOfLengthWidthHeight_, sumOfLengthWidthHeight) };
