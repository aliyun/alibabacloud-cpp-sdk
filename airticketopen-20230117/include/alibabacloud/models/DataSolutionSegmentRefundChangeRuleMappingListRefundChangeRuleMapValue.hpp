...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::RefundRuleAllUnusedList> & getRefundRuleAllUnusedList() const { DARABONBA_PTR_GET_CONST(refundRuleAllUnusedList_, vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::RefundRuleAllUnusedList>) };
    inline vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::RefundRuleAllUnusedList> getRefundRuleAllUnusedList() { DARABONBA_PTR_GET(refundRuleAllUnusedList_, vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::RefundRuleAllUnusedList>) };
    inline DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue& setRefundRuleAllUnusedList(const vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::RefundRuleAllUnusedList> & refundRuleAllUnusedList) { DARABONBA_PTR_SET_VALUE(refundRuleAllUnusedList_, refundRuleAllUnusedList) };
    inline DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue& setRefundRuleAllUnusedList(vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::RefundRuleAllUnusedList> && refundRuleAllUnusedList) { DARABONBA_PTR_SET_RVALUE(refundRuleAllUnusedList_, refundRuleAllUnusedList) };
    ...
    inline const vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::RefundRulePartUnusedList> & getRefundRulePartUnusedList() const { DARABONBA_PTR_GET_CONST(refundRulePartUnusedList_, vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::RefundRulePartUnusedList>) };
    inline vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::RefundRulePartUnusedList> getRefundRulePartUnusedList() { DARABONBA_PTR_GET(refundRulePartUnusedList_, vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::RefundRulePartUnusedList>) };
    inline DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue& setRefundRulePartUnusedList(const vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::RefundRulePartUnusedList> & refundRulePartUnusedList) { DARABONBA_PTR_SET_VALUE(refundRulePartUnusedList_, refundRulePartUnusedList) };
    inline DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue& setRefundRulePartUnusedList(vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::RefundRulePartUnusedList> && refundRulePartUnusedList) { DARABONBA_PTR_SET_RVALUE(refundRulePartUnusedList_, refundRulePartUnusedList) };
    ...
    inline const vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::ChangeRuleInUnusedList> & getChangeRuleInUnusedList() const { DARABONBA_PTR_GET_CONST(changeRuleInUnusedList_, vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::ChangeRuleInUnusedList>) };
    inline vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::ChangeRuleInUnusedList> getChangeRuleInUnusedList() { DARABONBA_PTR_GET(changeRuleInUnusedList_, vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::ChangeRuleInUnusedList>) };
    inline DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue& setChangeRuleInUnusedList(const vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::ChangeRuleInUnusedList> & changeRuleInUnusedList) { DARABONBA_PTR_SET_VALUE(changeRuleInUnusedList_, changeRuleInUnusedList) };
    inline DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue& setChangeRuleInUnusedList(vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::ChangeRuleInUnusedList> && changeRuleInUnusedList) { DARABONBA_PTR_SET_RVALUE(changeRuleInUnusedList_, changeRuleInUnusedList) };
    ...
    inline const vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::ChangeRuleOutUnusedList> & getChangeRuleOutUnusedList() const { DARABONBA_PTR_GET_CONST(changeRuleOutUnusedList_, vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::ChangeRuleOutUnusedList>) };
    inline vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::ChangeRuleOutUnusedList> getChangeRuleOutUnusedList() { DARABONBA_PTR_GET(changeRuleOutUnusedList_, vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::ChangeRuleOutUnusedList>) };
    inline DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue& setChangeRuleOutUnusedList(const vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::ChangeRuleOutUnusedList> & changeRuleOutUnusedList) { DARABONBA_PTR_SET_VALUE(changeRuleOutUnusedList_, changeRuleOutUnusedList) };
    inline DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue& setChangeRuleOutUnusedList(vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::ChangeRuleOutUnusedList> && changeRuleOutUnusedList) { DARABONBA_PTR_SET_RVALUE(changeRuleOutUnusedList_, changeRuleOutUnusedList) };


  protected:
    // 全程未使用退票规则
    shared_ptr<vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::RefundRuleAllUnusedList>> refundRuleAllUnusedList_ {};
    // 部分未使用退票规则
    shared_ptr<vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::RefundRulePartUnusedList>> refundRulePartUnusedList_ {};
    // 回程未使用改签规则
    shared_ptr<vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::ChangeRuleInUnusedList>> changeRuleInUnusedList_ {};
    // 去程未使用改签规则
    shared_ptr<vector<DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue::ChangeRuleOutUnusedList>> changeRuleOutUnusedList_ {};
  };
