...
#ifndef ALIBABACLOUD_MODELS_CHANGEDETAILLISTOFORDERNUMRESPONSEBODYDATALISTCHANGEDJOURNEYSSEGMENTLIST_HPP_
#define ALIBABACLOUD_MODELS_CHANGEDETAILLISTOFORDERNUMRESPONSEBODYDATALISTCHANGEDJOURNEYSSEGMENTLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& obj) { 
    ...
    ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList() = default ;
    ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList(const ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList &) = default ;
    ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList(ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList &&) = default ;
    ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList() = default ;
    ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& operator=(const ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList &) = default ;
    ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& operator=(ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList &&) = default ;
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setArrivalAirport(string arrivalAirport) { DARABONBA_PTR_SET_VALUE(arrivalAirport_, arrivalAirport) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setArrivalCity(string arrivalCity) { DARABONBA_PTR_SET_VALUE(arrivalCity_, arrivalCity) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setArrivalTerminal(string arrivalTerminal) { DARABONBA_PTR_SET_VALUE(arrivalTerminal_, arrivalTerminal) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setArrivalTime(string arrivalTime) { DARABONBA_PTR_SET_VALUE(arrivalTime_, arrivalTime) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setAvailability(string availability) { DARABONBA_PTR_SET_VALUE(availability_, availability) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setCabinClass(string cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setCodeShare(bool codeShare) { DARABONBA_PTR_SET_VALUE(codeShare_, codeShare) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setDepartureAirport(string departureAirport) { DARABONBA_PTR_SET_VALUE(departureAirport_, departureAirport) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setDepartureCity(string departureCity) { DARABONBA_PTR_SET_VALUE(departureCity_, departureCity) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setDepartureTerminal(string departureTerminal) { DARABONBA_PTR_SET_VALUE(departureTerminal_, departureTerminal) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setDepartureTime(string departureTime) { DARABONBA_PTR_SET_VALUE(departureTime_, departureTime) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setEquipType(string equipType) { DARABONBA_PTR_SET_VALUE(equipType_, equipType) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setFlightDuration(int32_t flightDuration) { DARABONBA_PTR_SET_VALUE(flightDuration_, flightDuration) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setMarketingAirline(string marketingAirline) { DARABONBA_PTR_SET_VALUE(marketingAirline_, marketingAirline) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setMarketingFlightNo(string marketingFlightNo) { DARABONBA_PTR_SET_VALUE(marketingFlightNo_, marketingFlightNo) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setMarketingFlightNoInt(int32_t marketingFlightNoInt) { DARABONBA_PTR_SET_VALUE(marketingFlightNoInt_, marketingFlightNoInt) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setOperatingAirline(string operatingAirline) { DARABONBA_PTR_SET_VALUE(operatingAirline_, operatingAirline) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setOperatingFlightNo(string operatingFlightNo) { DARABONBA_PTR_SET_VALUE(operatingFlightNo_, operatingFlightNo) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setSegmentId(string segmentId) { DARABONBA_PTR_SET_VALUE(segmentId_, segmentId) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setStopCityList(string stopCityList) { DARABONBA_PTR_SET_VALUE(stopCityList_, stopCityList) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListChangedJourneysSegmentList& setStopQuantity(int32_t stopQuantity) { DARABONBA_PTR_SET_VALUE(stopQuantity_, stopQuantity) };
