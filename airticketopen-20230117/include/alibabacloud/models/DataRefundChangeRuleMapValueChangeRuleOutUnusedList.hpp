...
#ifndef ALIBABACLOUD_MODELS_DATAREFUNDCHANGERULEMAPVALUECHANGERULEOUTUNUSEDLIST_HPP_
#define ALIBABACLOUD_MODELS_DATAREFUNDCHANGERULEMAPVALUECHANGERULEOUTUNUSEDLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DataRefundChangeRuleMapValueChangeRuleOutUnusedList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DataRefundChangeRuleMapValueChangeRuleOutUnusedList& obj) { 
    ...
    DataRefundChangeRuleMapValueChangeRuleOutUnusedList() = default ;
    DataRefundChangeRuleMapValueChangeRuleOutUnusedList(const DataRefundChangeRuleMapValueChangeRuleOutUnusedList &) = default ;
    DataRefundChangeRuleMapValueChangeRuleOutUnusedList(DataRefundChangeRuleMapValueChangeRuleOutUnusedList &&) = default ;
    DataRefundChangeRuleMapValueChangeRuleOutUnusedList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DataRefundChangeRuleMapValueChangeRuleOutUnusedList() = default ;
    DataRefundChangeRuleMapValueChangeRuleOutUnusedList& operator=(const DataRefundChangeRuleMapValueChangeRuleOutUnusedList &) = default ;
    DataRefundChangeRuleMapValueChangeRuleOutUnusedList& operator=(DataRefundChangeRuleMapValueChangeRuleOutUnusedList &&) = default ;
    ...
    inline DataRefundChangeRuleMapValueChangeRuleOutUnusedList& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DataRefundChangeRuleMapValueChangeRuleOutUnusedList& setTimeUnit(string timeUnit) { DARABONBA_PTR_SET_VALUE(timeUnit_, timeUnit) };
    ...
    inline DataRefundChangeRuleMapValueChangeRuleOutUnusedList& setRuleStartTime(int32_t ruleStartTime) { DARABONBA_PTR_SET_VALUE(ruleStartTime_, ruleStartTime) };
    ...
    inline DataRefundChangeRuleMapValueChangeRuleOutUnusedList& setRuleEndTime(int32_t ruleEndTime) { DARABONBA_PTR_SET_VALUE(ruleEndTime_, ruleEndTime) };
    ...
    inline DataRefundChangeRuleMapValueChangeRuleOutUnusedList& setCanChange(bool canChange) { DARABONBA_PTR_SET_VALUE(canChange_, canChange) };
    ...
    inline DataRefundChangeRuleMapValueChangeRuleOutUnusedList& setChangeFee(double changeFee) { DARABONBA_PTR_SET_VALUE(changeFee_, changeFee) };
