...
#ifndef ALIBABACLOUD_MODELS_TICKETAPPLYREFUNDREQUEST_HPP_
#define ALIBABACLOUD_MODELS_TICKETAPPLYREFUNDREQUEST_HPP_
...
namespace Models
{
  class TicketApplyRefundRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const TicketApplyRefundRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TicketApplyRefundRequest& obj) { 
    ...
    TicketApplyRefundRequest() = default ;
    TicketApplyRefundRequest(const TicketApplyRefundRequest &) = default ;
    TicketApplyRefundRequest(TicketApplyRefundRequest &&) = default ;
    TicketApplyRefundRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TicketApplyRefundRequest() = default ;
    TicketApplyRefundRequest& operator=(const TicketApplyRefundRequest &) = default ;
    TicketApplyRefundRequest& operator=(TicketApplyRefundRequest &&) = default ;
    ...
    inline TicketApplyRefundRequest& setAccountNo(int64_t accountNo) { DARABONBA_PTR_SET_VALUE(accountNo_, accountNo) };
    ...
    inline TicketApplyRefundRequest& setDistributorOrderId(string distributorOrderId) { DARABONBA_PTR_SET_VALUE(distributorOrderId_, distributorOrderId) };
    ...
    inline TicketApplyRefundRequest& setRefundReason(string refundReason) { DARABONBA_PTR_SET_VALUE(refundReason_, refundReason) };
    ...
    inline TicketApplyRefundRequest& setRefundRemark(string refundRemark) { DARABONBA_PTR_SET_VALUE(refundRemark_, refundRemark) };
