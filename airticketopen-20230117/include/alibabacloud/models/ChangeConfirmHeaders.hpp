...
#ifndef ALIBABACLOUD_MODELS_CHANGECONFIRMHEADERS_HPP_
#define ALIBABACLOUD_MODELS_CHANGECONFIRMHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChangeConfirmHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChangeConfirmHeaders& obj) { 
    ...
    ChangeConfirmHeaders() = default ;
    ChangeConfirmHeaders(const ChangeConfirmHeaders &) = default ;
    ChangeConfirmHeaders(ChangeConfirmHeaders &&) = default ;
    ChangeConfirmHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChangeConfirmHeaders() = default ;
    ChangeConfirmHeaders& operator=(const ChangeConfirmHeaders &) = default ;
    ChangeConfirmHeaders& operator=(ChangeConfirmHeaders &&) = default ;
    ...
    inline ChangeConfirmHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline ChangeConfirmHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline ChangeConfirmHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline ChangeConfirmHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
