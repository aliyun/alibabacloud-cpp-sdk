...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeApplyResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ChangeApplyResponseBodyData) };
    inline ChangeApplyResponseBodyData data() { DARABONBA_PTR_GET(data_, ChangeApplyResponseBodyData) };
    inline ChangeApplyResponseBody& setData(const ChangeApplyResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ChangeApplyResponseBody& setData(ChangeApplyResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ChangeApplyResponseBodyData> data_ = nullptr;
