...
#ifndef ALIBABACLOUD_MODELS_GLOBALHOTELCANCELORREFUNDRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GLOBALHOTELCANCELORREFUNDRESPONSEBODY_HPP_
...
namespace Models
{
  class GlobalHotelCancelOrRefundResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GlobalHotelCancelOrRefundResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GlobalHotelCancelOrRefundResponseBody& obj) { 
    ...
    GlobalHotelCancelOrRefundResponseBody() = default ;
    GlobalHotelCancelOrRefundResponseBody(const GlobalHotelCancelOrRefundResponseBody &) = default ;
    GlobalHotelCancelOrRefundResponseBody(GlobalHotelCancelOrRefundResponseBody &&) = default ;
    GlobalHotelCancelOrRefundResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GlobalHotelCancelOrRefundResponseBody() = default ;
    GlobalHotelCancelOrRefundResponseBody& operator=(const GlobalHotelCancelOrRefundResponseBody &) = default ;
    GlobalHotelCancelOrRefundResponseBody& operator=(GlobalHotelCancelOrRefundResponseBody &&) = default ;
    ...
    public:
      friend void to_json(Darabonba::Json& j, const Data& obj) { 
        DARABONBA_PTR_TO_JSON(RefundOrderId, refundOrderId_);
      ...
      friend void from_json(const Darabonba::Json& j, Data& obj) { 
        DARABONBA_PTR_FROM_JSON(RefundOrderId, refundOrderId_);
      ...
      virtual bool empty() const override { return this->refundOrderId_ == nullptr
      ...
      inline string getRefundOrderId() const { DARABONBA_PTR_GET_DEFAULT(refundOrderId_, "") };
      inline Data& setRefundOrderId(string refundOrderId) { DARABONBA_PTR_SET_VALUE(refundOrderId_, refundOrderId) };
    ...
    inline const GlobalHotelCancelOrRefundResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GlobalHotelCancelOrRefundResponseBody::Data) };
    inline GlobalHotelCancelOrRefundResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GlobalHotelCancelOrRefundResponseBody::Data) };
    inline GlobalHotelCancelOrRefundResponseBody& setData(const GlobalHotelCancelOrRefundResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GlobalHotelCancelOrRefundResponseBody& setData(GlobalHotelCancelOrRefundResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GlobalHotelCancelOrRefundResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline GlobalHotelCancelOrRefundResponseBody& setErrorMsg(string errorMsg) { DARABONBA_PTR_SET_VALUE(errorMsg_, errorMsg) };
    ...
    inline GlobalHotelCancelOrRefundResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GlobalHotelCancelOrRefundResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    void deleteTracerId() { this->tracerId_ = nullptr;};
    inline string getTracerId() const { DARABONBA_PTR_GET_DEFAULT(tracerId_, "") };
    inline GlobalHotelCancelOrRefundResponseBody& setTracerId(string tracerId) { DARABONBA_PTR_SET_VALUE(tracerId_, tracerId) };
