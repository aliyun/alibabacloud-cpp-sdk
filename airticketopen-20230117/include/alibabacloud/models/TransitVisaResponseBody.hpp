...
namespace Models
{
  ...
  public:
    ...
    inline const vector<TransitVisaResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<TransitVisaResponseBodyData>) };
    inline vector<TransitVisaResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<TransitVisaResponseBodyData>) };
    inline TransitVisaResponseBody& setData(const vector<TransitVisaResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline TransitVisaResponseBody& setData(vector<TransitVisaResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<TransitVisaResponseBodyData>> data_ = nullptr;
