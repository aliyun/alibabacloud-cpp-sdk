...
#ifndef ALIBABACLOUD_MODELS_LUGGAGEDIRECTREQUESTFLIGHTSEGMENTPARAMLIST_HPP_
#define ALIBABACLOUD_MODELS_LUGGAGEDIRECTREQUESTFLIGHTSEGMENTPARAMLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const LuggageDirectRequestFlightSegmentParamList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, LuggageDirectRequestFlightSegmentParamList& obj) { 
    ...
    LuggageDirectRequestFlightSegmentParamList() = default ;
    LuggageDirectRequestFlightSegmentParamList(const LuggageDirectRequestFlightSegmentParamList &) = default ;
    LuggageDirectRequestFlightSegmentParamList(LuggageDirectRequestFlightSegmentParamList &&) = default ;
    LuggageDirectRequestFlightSegmentParamList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~LuggageDirectRequestFlightSegmentParamList() = default ;
    LuggageDirectRequestFlightSegmentParamList& operator=(const LuggageDirectRequestFlightSegmentParamList &) = default ;
    LuggageDirectRequestFlightSegmentParamList& operator=(LuggageDirectRequestFlightSegmentParamList &&) = default ;
    ...
    inline LuggageDirectRequestFlightSegmentParamList& setArrivalAirport(string arrivalAirport) { DARABONBA_PTR_SET_VALUE(arrivalAirport_, arrivalAirport) };
    ...
    inline LuggageDirectRequestFlightSegmentParamList& setArrivalTerminal(string arrivalTerminal) { DARABONBA_PTR_SET_VALUE(arrivalTerminal_, arrivalTerminal) };
    ...
    inline LuggageDirectRequestFlightSegmentParamList& setArrivalTime(int64_t arrivalTime) { DARABONBA_PTR_SET_VALUE(arrivalTime_, arrivalTime) };
    ...
    inline LuggageDirectRequestFlightSegmentParamList& setCodeShare(bool codeShare) { DARABONBA_PTR_SET_VALUE(codeShare_, codeShare) };
    ...
    inline LuggageDirectRequestFlightSegmentParamList& setDepartureAirport(string departureAirport) { DARABONBA_PTR_SET_VALUE(departureAirport_, departureAirport) };
    ...
    inline LuggageDirectRequestFlightSegmentParamList& setDepartureTerminal(string departureTerminal) { DARABONBA_PTR_SET_VALUE(departureTerminal_, departureTerminal) };
    ...
    inline LuggageDirectRequestFlightSegmentParamList& setDepartureTime(int64_t departureTime) { DARABONBA_PTR_SET_VALUE(departureTime_, departureTime) };
    ...
    inline LuggageDirectRequestFlightSegmentParamList& setMarketingAirline(string marketingAirline) { DARABONBA_PTR_SET_VALUE(marketingAirline_, marketingAirline) };
    ...
    inline LuggageDirectRequestFlightSegmentParamList& setMarketingFlightNo(string marketingFlightNo) { DARABONBA_PTR_SET_VALUE(marketingFlightNo_, marketingFlightNo) };
    ...
    inline LuggageDirectRequestFlightSegmentParamList& setOperatingAirline(string operatingAirline) { DARABONBA_PTR_SET_VALUE(operatingAirline_, operatingAirline) };
    ...
    inline LuggageDirectRequestFlightSegmentParamList& setStopCityList(string stopCityList) { DARABONBA_PTR_SET_VALUE(stopCityList_, stopCityList) };
    ...
    inline LuggageDirectRequestFlightSegmentParamList& setTicketingAirline(string ticketingAirline) { DARABONBA_PTR_SET_VALUE(ticketingAirline_, ticketingAirline) };
