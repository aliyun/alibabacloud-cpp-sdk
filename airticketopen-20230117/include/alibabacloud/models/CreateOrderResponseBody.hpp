...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOrderResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateOrderResponseBody::Data) };
    inline CreateOrderResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateOrderResponseBody::Data) };
    inline CreateOrderResponseBody& setData(const CreateOrderResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateOrderResponseBody& setData(CreateOrderResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateOrderResponseBody& setErrorMsg(string errorMsg) { DARABONBA_PTR_SET_VALUE(errorMsg_, errorMsg) };
    ...
    void deleteTracerId() { this->tracerId_ = nullptr;};
    inline string getTracerId() const { DARABONBA_PTR_GET_DEFAULT(tracerId_, "") };
    inline CreateOrderResponseBody& setTracerId(string tracerId) { DARABONBA_PTR_SET_VALUE(tracerId_, tracerId) };


  protected:
    shared_ptr<CreateOrderResponseBody::Data> data_ {};
