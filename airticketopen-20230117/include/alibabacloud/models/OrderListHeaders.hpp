...
#ifndef ALIBABACLOUD_MODELS_ORDERLISTHEADERS_HPP_
#define ALIBABACLOUD_MODELS_ORDERLISTHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const OrderListHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, OrderListHeaders& obj) { 
    ...
    OrderListHeaders() = default ;
    OrderListHeaders(const OrderListHeaders &) = default ;
    OrderListHeaders(OrderListHeaders &&) = default ;
    OrderListHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~OrderListHeaders() = default ;
    OrderListHeaders& operator=(const OrderListHeaders &) = default ;
    OrderListHeaders& operator=(OrderListHeaders &&) = default ;
    ...
    inline OrderListHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline OrderListHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline OrderListHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline OrderListHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
