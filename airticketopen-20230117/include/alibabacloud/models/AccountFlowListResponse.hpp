...
namespace Models
{
  ...
  public:
    ...
    inline const AccountFlowListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AccountFlowListResponseBody) };
    inline AccountFlowListResponseBody getBody() { DARABONBA_PTR_GET(body_, AccountFlowListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AccountFlowListResponseBody> body_ {};
  };
