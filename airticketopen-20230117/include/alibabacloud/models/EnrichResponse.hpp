...
namespace Models
{
  ...
  public:
    ...
    inline const EnrichResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnrichResponseBody) };
    inline EnrichResponseBody getBody() { DARABONBA_PTR_GET(body_, EnrichResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnrichResponseBody> body_ {};
  };
