...
namespace Models
{
  ...
  public:
    ...
    inline PricingResponseBodyDataSolution& setProductTypeDescription(string productTypeDescription) { DARABONBA_PTR_SET_VALUE(productTypeDescription_, productTypeDescription) };
    ...
    inline PricingResponseBodyDataSolution& setRefundTicketCouponDescription(string refundTicketCouponDescription) { DARABONBA_PTR_SET_VALUE(refundTicketCouponDescription_, refundTicketCouponDescription) };
