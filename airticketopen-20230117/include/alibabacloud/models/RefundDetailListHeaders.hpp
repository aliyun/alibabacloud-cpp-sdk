...
#ifndef ALIBABACLOUD_MODELS_REFUNDDETAILLISTHEADERS_HPP_
#define ALIBABACLOUD_MODELS_REFUNDDETAILLISTHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RefundDetailListHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RefundDetailListHeaders& obj) { 
    ...
    RefundDetailListHeaders() = default ;
    RefundDetailListHeaders(const RefundDetailListHeaders &) = default ;
    RefundDetailListHeaders(RefundDetailListHeaders &&) = default ;
    RefundDetailListHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RefundDetailListHeaders() = default ;
    RefundDetailListHeaders& operator=(const RefundDetailListHeaders &) = default ;
    RefundDetailListHeaders& operator=(RefundDetailListHeaders &&) = default ;
    ...
    inline RefundDetailListHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline RefundDetailListHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline RefundDetailListHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline RefundDetailListHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
