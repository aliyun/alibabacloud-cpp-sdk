...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeCancelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ChangeCancelResponseBody) };
    inline ChangeCancelResponseBody getBody() { DARABONBA_PTR_GET(body_, ChangeCancelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ChangeCancelResponseBody> body_ {};
  };
