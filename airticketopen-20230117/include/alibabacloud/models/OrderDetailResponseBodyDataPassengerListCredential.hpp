...
#ifndef ALIBABACLOUD_MODELS_ORDERDETAILRESPONSEBODYDATAPASSENGERLISTCREDENTIAL_HPP_
#define ALIBABACLOUD_MODELS_ORDERDETAILRESPONSEBODYDATAPASSENGERLISTCREDENTIAL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const OrderDetailResponseBodyDataPassengerListCredential& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, OrderDetailResponseBodyDataPassengerListCredential& obj) { 
    ...
    OrderDetailResponseBodyDataPassengerListCredential() = default ;
    OrderDetailResponseBodyDataPassengerListCredential(const OrderDetailResponseBodyDataPassengerListCredential &) = default ;
    OrderDetailResponseBodyDataPassengerListCredential(OrderDetailResponseBodyDataPassengerListCredential &&) = default ;
    OrderDetailResponseBodyDataPassengerListCredential(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~OrderDetailResponseBodyDataPassengerListCredential() = default ;
    OrderDetailResponseBodyDataPassengerListCredential& operator=(const OrderDetailResponseBodyDataPassengerListCredential &) = default ;
    OrderDetailResponseBodyDataPassengerListCredential& operator=(OrderDetailResponseBodyDataPassengerListCredential &&) = default ;
    ...
    inline OrderDetailResponseBodyDataPassengerListCredential& setCertIssuePlace(string certIssuePlace) { DARABONBA_PTR_SET_VALUE(certIssuePlace_, certIssuePlace) };
    ...
    inline OrderDetailResponseBodyDataPassengerListCredential& setCredentialNum(string credentialNum) { DARABONBA_PTR_SET_VALUE(credentialNum_, credentialNum) };
    ...
    inline OrderDetailResponseBodyDataPassengerListCredential& setCredentialType(int32_t credentialType) { DARABONBA_PTR_SET_VALUE(credentialType_, credentialType) };
    ...
    inline OrderDetailResponseBodyDataPassengerListCredential& setExpireDate(string expireDate) { DARABONBA_PTR_SET_VALUE(expireDate_, expireDate) };
