...
#ifndef ALIBABACLOUD_MODELS_BATCHGETHOTELDETAILRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_BATCHGETHOTELDETAILRESPONSEBODY_HPP_
...
namespace Models
{
  class BatchGetHotelDetailResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const BatchGetHotelDetailResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, BatchGetHotelDetailResponseBody& obj) { 
    ...
    BatchGetHotelDetailResponseBody() = default ;
    BatchGetHotelDetailResponseBody(const BatchGetHotelDetailResponseBody &) = default ;
    BatchGetHotelDetailResponseBody(BatchGetHotelDetailResponseBody &&) = default ;
    BatchGetHotelDetailResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BatchGetHotelDetailResponseBody() = default ;
    BatchGetHotelDetailResponseBody& operator=(const BatchGetHotelDetailResponseBody &) = default ;
    BatchGetHotelDetailResponseBody& operator=(BatchGetHotelDetailResponseBody &&) = default ;
    ...
    inline const BatchGetHotelDetailResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, BatchGetHotelDetailResponseBody::Data) };
    inline BatchGetHotelDetailResponseBody::Data getData() { DARABONBA_PTR_GET(data_, BatchGetHotelDetailResponseBody::Data) };
    inline BatchGetHotelDetailResponseBody& setData(const BatchGetHotelDetailResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BatchGetHotelDetailResponseBody& setData(BatchGetHotelDetailResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    void deleteErrorCode() { this->errorCode_ = nullptr;};
    inline string getErrorCode() const { DARABONBA_PTR_GET_DEFAULT(errorCode_, "") };
    inline BatchGetHotelDetailResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline BatchGetHotelDetailResponseBody& setErrorMsg(string errorMsg) { DARABONBA_PTR_SET_VALUE(errorMsg_, errorMsg) };
    ...
    inline BatchGetHotelDetailResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline BatchGetHotelDetailResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline BatchGetHotelDetailResponseBody& setTracerId(string tracerId) { DARABONBA_PTR_SET_VALUE(tracerId_, tracerId) };


  protected:
    shared_ptr<BatchGetHotelDetailResponseBody::Data> data_ {};
    shared_ptr<string> errorCode_ {};
