...
#ifndef ALIBABACLOUD_MODELS_DATAREFUNDCHANGERULEMAPVALUECHANGERULEINUNUSEDLIST_HPP_
#define ALIBABACLOUD_MODELS_DATAREFUNDCHANGERULEMAPVALUECHANGERULEINUNUSEDLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DataRefundChangeRuleMapValueChangeRuleInUnusedList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DataRefundChangeRuleMapValueChangeRuleInUnusedList& obj) { 
    ...
    DataRefundChangeRuleMapValueChangeRuleInUnusedList() = default ;
    DataRefundChangeRuleMapValueChangeRuleInUnusedList(const DataRefundChangeRuleMapValueChangeRuleInUnusedList &) = default ;
    DataRefundChangeRuleMapValueChangeRuleInUnusedList(DataRefundChangeRuleMapValueChangeRuleInUnusedList &&) = default ;
    DataRefundChangeRuleMapValueChangeRuleInUnusedList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DataRefundChangeRuleMapValueChangeRuleInUnusedList() = default ;
    DataRefundChangeRuleMapValueChangeRuleInUnusedList& operator=(const DataRefundChangeRuleMapValueChangeRuleInUnusedList &) = default ;
    DataRefundChangeRuleMapValueChangeRuleInUnusedList& operator=(DataRefundChangeRuleMapValueChangeRuleInUnusedList &&) = default ;
    ...
    inline DataRefundChangeRuleMapValueChangeRuleInUnusedList& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DataRefundChangeRuleMapValueChangeRuleInUnusedList& setTimeUnit(string timeUnit) { DARABONBA_PTR_SET_VALUE(timeUnit_, timeUnit) };
    ...
    inline DataRefundChangeRuleMapValueChangeRuleInUnusedList& setRuleStartTime(int32_t ruleStartTime) { DARABONBA_PTR_SET_VALUE(ruleStartTime_, ruleStartTime) };
    ...
    inline DataRefundChangeRuleMapValueChangeRuleInUnusedList& setRuleEndTime(int32_t ruleEndTime) { DARABONBA_PTR_SET_VALUE(ruleEndTime_, ruleEndTime) };
    ...
    inline DataRefundChangeRuleMapValueChangeRuleInUnusedList& setCanChange(bool canChange) { DARABONBA_PTR_SET_VALUE(canChange_, canChange) };
    ...
    inline DataRefundChangeRuleMapValueChangeRuleInUnusedList& setChangeFee(double changeFee) { DARABONBA_PTR_SET_VALUE(changeFee_, changeFee) };
