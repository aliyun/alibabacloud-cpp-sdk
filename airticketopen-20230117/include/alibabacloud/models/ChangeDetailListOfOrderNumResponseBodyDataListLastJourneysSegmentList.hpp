...
#ifndef ALIBABACLOUD_MODELS_CHANGEDETAILLISTOFORDERNUMRESPONSEBODYDATALISTLASTJOURNEYSSEGMENTLIST_HPP_
#define ALIBABACLOUD_MODELS_CHANGEDETAILLISTOFORDERNUMRESPONSEBODYDATALISTLASTJOURNEYSSEGMENTLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& obj) { 
    ...
    ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList() = default ;
    ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList(const ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList &) = default ;
    ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList(ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList &&) = default ;
    ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList() = default ;
    ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& operator=(const ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList &) = default ;
    ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& operator=(ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList &&) = default ;
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setArrivalAirport(string arrivalAirport) { DARABONBA_PTR_SET_VALUE(arrivalAirport_, arrivalAirport) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setArrivalCity(string arrivalCity) { DARABONBA_PTR_SET_VALUE(arrivalCity_, arrivalCity) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setArrivalTerminal(string arrivalTerminal) { DARABONBA_PTR_SET_VALUE(arrivalTerminal_, arrivalTerminal) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setArrivalTime(string arrivalTime) { DARABONBA_PTR_SET_VALUE(arrivalTime_, arrivalTime) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setAvailability(string availability) { DARABONBA_PTR_SET_VALUE(availability_, availability) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setCabinClass(string cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setCodeShare(bool codeShare) { DARABONBA_PTR_SET_VALUE(codeShare_, codeShare) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setDepartureAirport(string departureAirport) { DARABONBA_PTR_SET_VALUE(departureAirport_, departureAirport) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setDepartureCity(string departureCity) { DARABONBA_PTR_SET_VALUE(departureCity_, departureCity) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setDepartureTerminal(string departureTerminal) { DARABONBA_PTR_SET_VALUE(departureTerminal_, departureTerminal) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setDepartureTime(string departureTime) { DARABONBA_PTR_SET_VALUE(departureTime_, departureTime) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setEquipType(string equipType) { DARABONBA_PTR_SET_VALUE(equipType_, equipType) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setFlightDuration(int32_t flightDuration) { DARABONBA_PTR_SET_VALUE(flightDuration_, flightDuration) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setMarketingAirline(string marketingAirline) { DARABONBA_PTR_SET_VALUE(marketingAirline_, marketingAirline) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setMarketingFlightNo(string marketingFlightNo) { DARABONBA_PTR_SET_VALUE(marketingFlightNo_, marketingFlightNo) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setMarketingFlightNoInt(int32_t marketingFlightNoInt) { DARABONBA_PTR_SET_VALUE(marketingFlightNoInt_, marketingFlightNoInt) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setOperatingAirline(string operatingAirline) { DARABONBA_PTR_SET_VALUE(operatingAirline_, operatingAirline) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setOperatingFlightNo(string operatingFlightNo) { DARABONBA_PTR_SET_VALUE(operatingFlightNo_, operatingFlightNo) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setSegmentId(string segmentId) { DARABONBA_PTR_SET_VALUE(segmentId_, segmentId) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setStopCityList(string stopCityList) { DARABONBA_PTR_SET_VALUE(stopCityList_, stopCityList) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListLastJourneysSegmentList& setStopQuantity(int32_t stopQuantity) { DARABONBA_PTR_SET_VALUE(stopQuantity_, stopQuantity) };
