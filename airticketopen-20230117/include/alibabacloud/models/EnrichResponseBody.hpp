...
namespace Models
{
  ...
  public:
    ...
    inline const EnrichResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, EnrichResponseBodyData) };
    inline EnrichResponseBodyData data() { DARABONBA_PTR_GET(data_, EnrichResponseBodyData) };
    inline EnrichResponseBody& setData(const EnrichResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline EnrichResponseBody& setData(EnrichResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // data
    std::shared_ptr<EnrichResponseBodyData> data_ = nullptr;
    // error code
