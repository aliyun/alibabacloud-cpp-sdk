...
namespace Models
{
  ...
  public:
    ...
    inline const AccountFlowListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AccountFlowListResponseBodyData) };
    inline AccountFlowListResponseBodyData data() { DARABONBA_PTR_GET(data_, AccountFlowListResponseBodyData) };
    inline AccountFlowListResponseBody& setData(const AccountFlowListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AccountFlowListResponseBody& setData(AccountFlowListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<AccountFlowListResponseBodyData> data_ = nullptr;
