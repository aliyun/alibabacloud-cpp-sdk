...
#ifndef ALIBABACLOUD_MODELS_SEARCHRESPONSEBODYDATASOLUTIONLISTSEGMENTBAGGAGEMAPPINGLIST_HPP_
#define ALIBABACLOUD_MODELS_SEARCHRESPONSEBODYDATASOLUTIONLISTSEGMENTBAGGAGEMAPPINGLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SearchResponseBodyDataSolutionListSegmentBaggageMappingList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SearchResponseBodyDataSolutionListSegmentBaggageMappingList& obj) { 
    ...
    SearchResponseBodyDataSolutionListSegmentBaggageMappingList() = default ;
    SearchResponseBodyDataSolutionListSegmentBaggageMappingList(const SearchResponseBodyDataSolutionListSegmentBaggageMappingList &) = default ;
    SearchResponseBodyDataSolutionListSegmentBaggageMappingList(SearchResponseBodyDataSolutionListSegmentBaggageMappingList &&) = default ;
    SearchResponseBodyDataSolutionListSegmentBaggageMappingList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SearchResponseBodyDataSolutionListSegmentBaggageMappingList() = default ;
    SearchResponseBodyDataSolutionListSegmentBaggageMappingList& operator=(const SearchResponseBodyDataSolutionListSegmentBaggageMappingList &) = default ;
    SearchResponseBodyDataSolutionListSegmentBaggageMappingList& operator=(SearchResponseBodyDataSolutionListSegmentBaggageMappingList &&) = default ;
    ...
    inline SearchResponseBodyDataSolutionListSegmentBaggageMappingList& setSegmentIdList(const vector<string> & segmentIdList) { DARABONBA_PTR_SET_VALUE(segmentIdList_, segmentIdList) };
    inline SearchResponseBodyDataSolutionListSegmentBaggageMappingList& setSegmentIdList(vector<string> && segmentIdList) { DARABONBA_PTR_SET_RVALUE(segmentIdList_, segmentIdList) };
