...
#ifndef ALIBABACLOUD_MODELS_SEARCHHEADERS_HPP_
#define ALIBABACLOUD_MODELS_SEARCHHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SearchHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SearchHeaders& obj) { 
    ...
    SearchHeaders() = default ;
    SearchHeaders(const SearchHeaders &) = default ;
    SearchHeaders(SearchHeaders &&) = default ;
    SearchHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SearchHeaders() = default ;
    SearchHeaders& operator=(const SearchHeaders &) = default ;
    SearchHeaders& operator=(SearchHeaders &&) = default ;
    ...
    inline SearchHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline SearchHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline SearchHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline SearchHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
