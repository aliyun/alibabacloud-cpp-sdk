...
namespace Models
{
  ...
  public:
    ...
    inline const BookResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BookResponseBody) };
    inline BookResponseBody getBody() { DARABONBA_PTR_GET(body_, BookResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BookResponseBody> body_ {};
  };
