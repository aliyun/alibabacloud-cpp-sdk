...
#ifndef ALIBABACLOUD_MODELS_CANCELREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CANCELREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CancelRequest& obj) { 
      DARABONBA_PTR_TO_JSON(order_num, orderNum_);
    };
    friend void from_json(const Darabonba::Json& j, CancelRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(order_num, orderNum_);
    };
    CancelRequest() = default ;
    CancelRequest(const CancelRequest &) = default ;
    CancelRequest(CancelRequest &&) = default ;
    CancelRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CancelRequest() = default ;
    CancelRequest& operator=(const CancelRequest &) = default ;
    CancelRequest& operator=(CancelRequest &&) = default ;
