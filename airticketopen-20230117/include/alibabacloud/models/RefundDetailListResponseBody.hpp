...
namespace Models
{
  ...
  public:
    ...
    inline const RefundDetailListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, RefundDetailListResponseBodyData) };
    inline RefundDetailListResponseBodyData data() { DARABONBA_PTR_GET(data_, RefundDetailListResponseBodyData) };
    inline RefundDetailListResponseBody& setData(const RefundDetailListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RefundDetailListResponseBody& setData(RefundDetailListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // data
    std::shared_ptr<RefundDetailListResponseBodyData> data_ = nullptr;
    // error code
