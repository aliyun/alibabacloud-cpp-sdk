...
namespace Models
{
  ...
  public:
    ...
    inline const vector<FlightChangeOfOrderResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<FlightChangeOfOrderResponseBodyData>) };
    inline vector<FlightChangeOfOrderResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<FlightChangeOfOrderResponseBodyData>) };
    inline FlightChangeOfOrderResponseBody& setData(const vector<FlightChangeOfOrderResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline FlightChangeOfOrderResponseBody& setData(vector<FlightChangeOfOrderResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<FlightChangeOfOrderResponseBodyData>> data_ = nullptr;
