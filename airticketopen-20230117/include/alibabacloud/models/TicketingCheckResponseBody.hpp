...
namespace Models
{
  ...
  public:
    ...
    inline const TicketingCheckResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, TicketingCheckResponseBodyData) };
    inline TicketingCheckResponseBodyData data() { DARABONBA_PTR_GET(data_, TicketingCheckResponseBodyData) };
    inline TicketingCheckResponseBody& setData(const TicketingCheckResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline TicketingCheckResponseBody& setData(TicketingCheckResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // data
    std::shared_ptr<TicketingCheckResponseBodyData> data_ = nullptr;
    // error code
