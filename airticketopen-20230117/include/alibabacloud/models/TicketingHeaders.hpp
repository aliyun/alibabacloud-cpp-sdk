...
#ifndef ALIBABACLOUD_MODELS_TICKETINGHEADERS_HPP_
#define ALIBABACLOUD_MODELS_TICKETINGHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TicketingHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TicketingHeaders& obj) { 
    ...
    TicketingHeaders() = default ;
    TicketingHeaders(const TicketingHeaders &) = default ;
    TicketingHeaders(TicketingHeaders &&) = default ;
    TicketingHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TicketingHeaders() = default ;
    TicketingHeaders& operator=(const TicketingHeaders &) = default ;
    TicketingHeaders& operator=(TicketingHeaders &&) = default ;
    ...
    inline TicketingHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline TicketingHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline TicketingHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline TicketingHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
