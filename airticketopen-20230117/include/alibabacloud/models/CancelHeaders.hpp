...
#ifndef ALIBABACLOUD_MODELS_CANCELHEADERS_HPP_
#define ALIBABACLOUD_MODELS_CANCELHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CancelHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CancelHeaders& obj) { 
    ...
    CancelHeaders() = default ;
    CancelHeaders(const CancelHeaders &) = default ;
    CancelHeaders(CancelHeaders &&) = default ;
    CancelHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CancelHeaders() = default ;
    CancelHeaders& operator=(const CancelHeaders &) = default ;
    CancelHeaders& operator=(CancelHeaders &&) = default ;
    ...
    inline CancelHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline CancelHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline CancelHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline CancelHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
  ...
  protected:
    ...
    // The language. The buyer account configuration is used by default.
