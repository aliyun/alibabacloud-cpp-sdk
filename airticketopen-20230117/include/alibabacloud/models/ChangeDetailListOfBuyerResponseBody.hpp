...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChangeDetailListOfBuyerResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChangeDetailListOfBuyerResponseBody& obj) { 
    ...
    ChangeDetailListOfBuyerResponseBody() = default ;
    ChangeDetailListOfBuyerResponseBody(const ChangeDetailListOfBuyerResponseBody &) = default ;
    ChangeDetailListOfBuyerResponseBody(ChangeDetailListOfBuyerResponseBody &&) = default ;
    ChangeDetailListOfBuyerResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChangeDetailListOfBuyerResponseBody() = default ;
    ChangeDetailListOfBuyerResponseBody& operator=(const ChangeDetailListOfBuyerResponseBody &) = default ;
    ChangeDetailListOfBuyerResponseBody& operator=(ChangeDetailListOfBuyerResponseBody &&) = default ;
