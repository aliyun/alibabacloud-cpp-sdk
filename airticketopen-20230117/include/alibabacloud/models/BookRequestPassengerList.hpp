...
#ifndef ALIBABACLOUD_MODELS_BOOKREQUESTPASSENGERLIST_HPP_
#define ALIBABACLOUD_MODELS_BOOKREQUESTPASSENGERLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const BookRequestPassengerList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, BookRequestPassengerList& obj) { 
    ...
    BookRequestPassengerList() = default ;
    BookRequestPassengerList(const BookRequestPassengerList &) = default ;
    BookRequestPassengerList(BookRequestPassengerList &&) = default ;
    BookRequestPassengerList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BookRequestPassengerList() = default ;
    BookRequestPassengerList& operator=(const BookRequestPassengerList &) = default ;
    BookRequestPassengerList& operator=(BookRequestPassengerList &&) = default ;
    ...
    inline BookRequestPassengerList& setBirthday(string birthday) { DARABONBA_PTR_SET_VALUE(birthday_, birthday) };
    ...
    inline const Models::BookRequestPassengerListCredential & credential() const { DARABONBA_PTR_GET_CONST(credential_, Models::BookRequestPassengerListCredential) };
    inline Models::BookRequestPassengerListCredential credential() { DARABONBA_PTR_GET(credential_, Models::BookRequestPassengerListCredential) };
    inline BookRequestPassengerList& setCredential(const Models::BookRequestPassengerListCredential & credential) { DARABONBA_PTR_SET_VALUE(credential_, credential) };
    inline BookRequestPassengerList& setCredential(Models::BookRequestPassengerListCredential && credential) { DARABONBA_PTR_SET_RVALUE(credential_, credential) };
    ...
    inline BookRequestPassengerList& setFirstName(string firstName) { DARABONBA_PTR_SET_VALUE(firstName_, firstName) };
    ...
    inline BookRequestPassengerList& setGender(int32_t gender) { DARABONBA_PTR_SET_VALUE(gender_, gender) };
    ...
    inline BookRequestPassengerList& setLastName(string lastName) { DARABONBA_PTR_SET_VALUE(lastName_, lastName) };
    ...
    inline BookRequestPassengerList& setMobileCountryCode(string mobileCountryCode) { DARABONBA_PTR_SET_VALUE(mobileCountryCode_, mobileCountryCode) };
    ...
    inline BookRequestPassengerList& setMobilePhoneNumber(string mobilePhoneNumber) { DARABONBA_PTR_SET_VALUE(mobilePhoneNumber_, mobilePhoneNumber) };
    ...
    inline BookRequestPassengerList& setNationality(string nationality) { DARABONBA_PTR_SET_VALUE(nationality_, nationality) };
    ...
    inline BookRequestPassengerList& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
  ...
  protected:
    ...
    // travel document
    std::shared_ptr<Models::BookRequestPassengerListCredential> credential_ = nullptr;
    // first name
    // 
