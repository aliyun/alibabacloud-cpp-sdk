...
namespace Models
{
  ...
  public:
    ...
    inline const OrderListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, OrderListResponseBodyData) };
    inline OrderListResponseBodyData data() { DARABONBA_PTR_GET(data_, OrderListResponseBodyData) };
    inline OrderListResponseBody& setData(const OrderListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline OrderListResponseBody& setData(OrderListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // data
    std::shared_ptr<OrderListResponseBodyData> data_ = nullptr;
    // error code
