...
#ifndef ALIBABACLOUD_MODELS_PRICINGHEADERS_HPP_
#define ALIBABACLOUD_MODELS_PRICINGHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PricingHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PricingHeaders& obj) { 
    ...
    PricingHeaders() = default ;
    PricingHeaders(const PricingHeaders &) = default ;
    PricingHeaders(PricingHeaders &&) = default ;
    PricingHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PricingHeaders() = default ;
    PricingHeaders& operator=(const PricingHeaders &) = default ;
    PricingHeaders& operator=(PricingHeaders &&) = default ;
    ...
    inline PricingHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline PricingHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline PricingHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline PricingHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
