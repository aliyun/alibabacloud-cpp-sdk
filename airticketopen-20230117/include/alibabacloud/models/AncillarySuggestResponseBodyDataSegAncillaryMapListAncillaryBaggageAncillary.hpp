...
#ifndef ALIBABACLOUD_MODELS_ANCILLARYSUGGESTRESPONSEBODYDATASEGANCILLARYMAPLISTANCILLARYBAGGAGEANCILLARY_HPP_
#define ALIBABACLOUD_MODELS_ANCILLARYSUGGESTRESPONSEBODYDATASEGANCILLARYMAPLISTANCILLARYBAGGAGEANCILLARY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary& obj) { 
    ...
    AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary() = default ;
    AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary(const AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary &) = default ;
    AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary(AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary &&) = default ;
    AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary() = default ;
    AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary& operator=(const AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary &) = default ;
    AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary& operator=(AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary &&) = default ;
    ...
    inline AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary& setBaggageAmount(int32_t baggageAmount) { DARABONBA_PTR_SET_VALUE(baggageAmount_, baggageAmount) };
    ...
    inline AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary& setBaggageWeight(int32_t baggageWeight) { DARABONBA_PTR_SET_VALUE(baggageWeight_, baggageWeight) };
    ...
    inline AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary& setBaggageWeightUnit(string baggageWeightUnit) { DARABONBA_PTR_SET_VALUE(baggageWeightUnit_, baggageWeightUnit) };
    ...
    inline AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary& setIsAllWeight(bool isAllWeight) { DARABONBA_PTR_SET_VALUE(isAllWeight_, isAllWeight) };
    ...
    inline AncillarySuggestResponseBodyDataSegAncillaryMapListAncillaryBaggageAncillary& setPrice(double price) { DARABONBA_PTR_SET_VALUE(price_, price) };
