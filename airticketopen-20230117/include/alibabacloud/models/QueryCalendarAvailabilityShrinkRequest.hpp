...
#ifndef ALIBABACLOUD_MODELS_QUERYCALENDARAVAILABILITYSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_QUERYCALENDARAVAILABILITYSHRINKREQUEST_HPP_
...
namespace Models
{
  class QueryCalendarAvailabilityShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryCalendarAvailabilityShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryCalendarAvailabilityShrinkRequest& obj) { 
    ...
    QueryCalendarAvailabilityShrinkRequest() = default ;
    QueryCalendarAvailabilityShrinkRequest(const QueryCalendarAvailabilityShrinkRequest &) = default ;
    QueryCalendarAvailabilityShrinkRequest(QueryCalendarAvailabilityShrinkRequest &&) = default ;
    QueryCalendarAvailabilityShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryCalendarAvailabilityShrinkRequest() = default ;
    QueryCalendarAvailabilityShrinkRequest& operator=(const QueryCalendarAvailabilityShrinkRequest &) = default ;
    QueryCalendarAvailabilityShrinkRequest& operator=(QueryCalendarAvailabilityShrinkRequest &&) = default ;
    ...
    inline QueryCalendarAvailabilityShrinkRequest& setAccountNo(int64_t accountNo) { DARABONBA_PTR_SET_VALUE(accountNo_, accountNo) };
    ...
    inline QueryCalendarAvailabilityShrinkRequest& setAdultCount(int32_t adultCount) { DARABONBA_PTR_SET_VALUE(adultCount_, adultCount) };
    ...
    inline QueryCalendarAvailabilityShrinkRequest& setCheckInDateEnd(string checkInDateEnd) { DARABONBA_PTR_SET_VALUE(checkInDateEnd_, checkInDateEnd) };
    ...
    inline QueryCalendarAvailabilityShrinkRequest& setCheckInDateStart(string checkInDateStart) { DARABONBA_PTR_SET_VALUE(checkInDateStart_, checkInDateStart) };
    ...
    inline QueryCalendarAvailabilityShrinkRequest& setChildCount(int32_t childCount) { DARABONBA_PTR_SET_VALUE(childCount_, childCount) };
    ...
    inline QueryCalendarAvailabilityShrinkRequest& setChildrenAgesShrink(string childrenAgesShrink) { DARABONBA_PTR_SET_VALUE(childrenAgesShrink_, childrenAgesShrink) };
    ...
    inline QueryCalendarAvailabilityShrinkRequest& setRoomCount(int32_t roomCount) { DARABONBA_PTR_SET_VALUE(roomCount_, roomCount) };
    ...
    inline QueryCalendarAvailabilityShrinkRequest& setStandardHotelIdsShrink(string standardHotelIdsShrink) { DARABONBA_PTR_SET_VALUE(standardHotelIdsShrink_, standardHotelIdsShrink) };
    ...
    inline QueryCalendarAvailabilityShrinkRequest& setTracerId(string tracerId) { DARABONBA_PTR_SET_VALUE(tracerId_, tracerId) };
