...
#ifndef ALIBABACLOUD_MODELS_FILEUPLOADHEADERS_HPP_
#define ALIBABACLOUD_MODELS_FILEUPLOADHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FileUploadHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FileUploadHeaders& obj) { 
    ...
    FileUploadHeaders() = default ;
    FileUploadHeaders(const FileUploadHeaders &) = default ;
    FileUploadHeaders(FileUploadHeaders &&) = default ;
    FileUploadHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FileUploadHeaders() = default ;
    FileUploadHeaders& operator=(const FileUploadHeaders &) = default ;
    FileUploadHeaders& operator=(FileUploadHeaders &&) = default ;
    ...
    inline FileUploadHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline FileUploadHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline FileUploadHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline FileUploadHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
