...
#ifndef ALIBABACLOUD_MODELS_GLOBALHOTELQUERYCALENDARAVAILABILITYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GLOBALHOTELQUERYCALENDARAVAILABILITYREQUEST_HPP_
...
namespace Models
{
  class GlobalHotelQueryCalendarAvailabilityRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GlobalHotelQueryCalendarAvailabilityRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GlobalHotelQueryCalendarAvailabilityRequest& obj) { 
    ...
    GlobalHotelQueryCalendarAvailabilityRequest() = default ;
    GlobalHotelQueryCalendarAvailabilityRequest(const GlobalHotelQueryCalendarAvailabilityRequest &) = default ;
    GlobalHotelQueryCalendarAvailabilityRequest(GlobalHotelQueryCalendarAvailabilityRequest &&) = default ;
    GlobalHotelQueryCalendarAvailabilityRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GlobalHotelQueryCalendarAvailabilityRequest() = default ;
    GlobalHotelQueryCalendarAvailabilityRequest& operator=(const GlobalHotelQueryCalendarAvailabilityRequest &) = default ;
    GlobalHotelQueryCalendarAvailabilityRequest& operator=(GlobalHotelQueryCalendarAvailabilityRequest &&) = default ;
    ...
    inline GlobalHotelQueryCalendarAvailabilityRequest& setAccountNo(int64_t accountNo) { DARABONBA_PTR_SET_VALUE(accountNo_, accountNo) };
    ...
    inline GlobalHotelQueryCalendarAvailabilityRequest& setAdultCount(int32_t adultCount) { DARABONBA_PTR_SET_VALUE(adultCount_, adultCount) };
    ...
    inline GlobalHotelQueryCalendarAvailabilityRequest& setCheckInDateEnd(string checkInDateEnd) { DARABONBA_PTR_SET_VALUE(checkInDateEnd_, checkInDateEnd) };
    ...
    inline GlobalHotelQueryCalendarAvailabilityRequest& setCheckInDateStart(string checkInDateStart) { DARABONBA_PTR_SET_VALUE(checkInDateStart_, checkInDateStart) };
    ...
    inline GlobalHotelQueryCalendarAvailabilityRequest& setChildCount(int32_t childCount) { DARABONBA_PTR_SET_VALUE(childCount_, childCount) };
    ...
    inline GlobalHotelQueryCalendarAvailabilityRequest& setChildrenAges(const vector<int32_t> & childrenAges) { DARABONBA_PTR_SET_VALUE(childrenAges_, childrenAges) };
    inline GlobalHotelQueryCalendarAvailabilityRequest& setChildrenAges(vector<int32_t> && childrenAges) { DARABONBA_PTR_SET_RVALUE(childrenAges_, childrenAges) };
    ...
    inline GlobalHotelQueryCalendarAvailabilityRequest& setRoomCount(int32_t roomCount) { DARABONBA_PTR_SET_VALUE(roomCount_, roomCount) };
    ...
    inline GlobalHotelQueryCalendarAvailabilityRequest& setStandardHotelIds(const vector<string> & standardHotelIds) { DARABONBA_PTR_SET_VALUE(standardHotelIds_, standardHotelIds) };
    inline GlobalHotelQueryCalendarAvailabilityRequest& setStandardHotelIds(vector<string> && standardHotelIds) { DARABONBA_PTR_SET_RVALUE(standardHotelIds_, standardHotelIds) };
    ...
    inline GlobalHotelQueryCalendarAvailabilityRequest& setTracerId(string tracerId) { DARABONBA_PTR_SET_VALUE(tracerId_, tracerId) };
