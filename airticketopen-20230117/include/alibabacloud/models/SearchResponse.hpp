...
namespace Models
{
  ...
  public:
    ...
    inline const SearchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchResponseBody) };
    inline SearchResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchResponseBody> body_ {};
  };
