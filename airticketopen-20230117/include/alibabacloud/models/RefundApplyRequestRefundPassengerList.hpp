...
#ifndef ALIBABACLOUD_MODELS_REFUNDAPPLYREQUESTREFUNDPASSENGERLIST_HPP_
#define ALIBABACLOUD_MODELS_REFUNDAPPLYREQUESTREFUNDPASSENGERLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RefundApplyRequestRefundPassengerList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RefundApplyRequestRefundPassengerList& obj) { 
    ...
    RefundApplyRequestRefundPassengerList() = default ;
    RefundApplyRequestRefundPassengerList(const RefundApplyRequestRefundPassengerList &) = default ;
    RefundApplyRequestRefundPassengerList(RefundApplyRequestRefundPassengerList &&) = default ;
    RefundApplyRequestRefundPassengerList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RefundApplyRequestRefundPassengerList() = default ;
    RefundApplyRequestRefundPassengerList& operator=(const RefundApplyRequestRefundPassengerList &) = default ;
    RefundApplyRequestRefundPassengerList& operator=(RefundApplyRequestRefundPassengerList &&) = default ;
    ...
    inline RefundApplyRequestRefundPassengerList& setDocument(string document) { DARABONBA_PTR_SET_VALUE(document_, document) };
    ...
    inline RefundApplyRequestRefundPassengerList& setFirstName(string firstName) { DARABONBA_PTR_SET_VALUE(firstName_, firstName) };
    ...
    inline RefundApplyRequestRefundPassengerList& setLastName(string lastName) { DARABONBA_PTR_SET_VALUE(lastName_, lastName) };
