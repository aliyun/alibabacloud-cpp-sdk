...
#ifndef ALIBABACLOUD_MODELS_TICKETINGCHECKHEADERS_HPP_
#define ALIBABACLOUD_MODELS_TICKETINGCHECKHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TicketingCheckHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TicketingCheckHeaders& obj) { 
    ...
    TicketingCheckHeaders() = default ;
    TicketingCheckHeaders(const TicketingCheckHeaders &) = default ;
    TicketingCheckHeaders(TicketingCheckHeaders &&) = default ;
    TicketingCheckHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TicketingCheckHeaders() = default ;
    TicketingCheckHeaders& operator=(const TicketingCheckHeaders &) = default ;
    TicketingCheckHeaders& operator=(TicketingCheckHeaders &&) = default ;
    ...
    inline TicketingCheckHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline TicketingCheckHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline TicketingCheckHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline TicketingCheckHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
