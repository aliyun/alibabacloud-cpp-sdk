...
namespace Models
{
  ...
  public:
    ...
    inline const AncillarySuggestResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AncillarySuggestResponseBodyData) };
    inline AncillarySuggestResponseBodyData data() { DARABONBA_PTR_GET(data_, AncillarySuggestResponseBodyData) };
    inline AncillarySuggestResponseBody& setData(const AncillarySuggestResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AncillarySuggestResponseBody& setData(AncillarySuggestResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<AncillarySuggestResponseBodyData> data_ = nullptr;
    // error code
