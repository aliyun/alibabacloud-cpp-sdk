...
#ifndef ALIBABACLOUD_MODELS_CANCELORREFUNDRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CANCELORREFUNDRESPONSEBODY_HPP_
...
namespace Models
{
  class CancelOrRefundResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CancelOrRefundResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CancelOrRefundResponseBody& obj) { 
    ...
    CancelOrRefundResponseBody() = default ;
    CancelOrRefundResponseBody(const CancelOrRefundResponseBody &) = default ;
    CancelOrRefundResponseBody(CancelOrRefundResponseBody &&) = default ;
    CancelOrRefundResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CancelOrRefundResponseBody() = default ;
    CancelOrRefundResponseBody& operator=(const CancelOrRefundResponseBody &) = default ;
    CancelOrRefundResponseBody& operator=(CancelOrRefundResponseBody &&) = default ;
    ...
    inline const CancelOrRefundResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CancelOrRefundResponseBody::Data) };
    inline CancelOrRefundResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CancelOrRefundResponseBody::Data) };
    inline CancelOrRefundResponseBody& setData(const CancelOrRefundResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CancelOrRefundResponseBody& setData(CancelOrRefundResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CancelOrRefundResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline CancelOrRefundResponseBody& setErrorMsg(string errorMsg) { DARABONBA_PTR_SET_VALUE(errorMsg_, errorMsg) };
    ...
    inline CancelOrRefundResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CancelOrRefundResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    void deleteTracerId() { this->tracerId_ = nullptr;};
    inline string getTracerId() const { DARABONBA_PTR_GET_DEFAULT(tracerId_, "") };
    inline CancelOrRefundResponseBody& setTracerId(string tracerId) { DARABONBA_PTR_SET_VALUE(tracerId_, tracerId) };


  protected:
    shared_ptr<CancelOrRefundResponseBody::Data> data_ {};
