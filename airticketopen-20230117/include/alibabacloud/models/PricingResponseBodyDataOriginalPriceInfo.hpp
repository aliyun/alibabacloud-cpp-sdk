...
#ifndef ALIBABACLOUD_MODELS_PRICINGRESPONSEBODYDATAORIGINALPRICEINFO_HPP_
#define ALIBABACLOUD_MODELS_PRICINGRESPONSEBODYDATAORIGINALPRICEINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PricingResponseBodyDataOriginalPriceInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PricingResponseBodyDataOriginalPriceInfo& obj) { 
    ...
    PricingResponseBodyDataOriginalPriceInfo() = default ;
    PricingResponseBodyDataOriginalPriceInfo(const PricingResponseBodyDataOriginalPriceInfo &) = default ;
    PricingResponseBodyDataOriginalPriceInfo(PricingResponseBodyDataOriginalPriceInfo &&) = default ;
    PricingResponseBodyDataOriginalPriceInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PricingResponseBodyDataOriginalPriceInfo() = default ;
    PricingResponseBodyDataOriginalPriceInfo& operator=(const PricingResponseBodyDataOriginalPriceInfo &) = default ;
    PricingResponseBodyDataOriginalPriceInfo& operator=(PricingResponseBodyDataOriginalPriceInfo &&) = default ;
    ...
    inline PricingResponseBodyDataOriginalPriceInfo& setAdultPrice(double adultPrice) { DARABONBA_PTR_SET_VALUE(adultPrice_, adultPrice) };
    ...
    inline PricingResponseBodyDataOriginalPriceInfo& setAdultTax(double adultTax) { DARABONBA_PTR_SET_VALUE(adultTax_, adultTax) };
    ...
    inline PricingResponseBodyDataOriginalPriceInfo& setChildPrice(double childPrice) { DARABONBA_PTR_SET_VALUE(childPrice_, childPrice) };
    ...
    inline PricingResponseBodyDataOriginalPriceInfo& setChildTax(double childTax) { DARABONBA_PTR_SET_VALUE(childTax_, childTax) };
    ...
    inline PricingResponseBodyDataOriginalPriceInfo& setInfantPrice(double infantPrice) { DARABONBA_PTR_SET_VALUE(infantPrice_, infantPrice) };
    ...
    inline PricingResponseBodyDataOriginalPriceInfo& setInfantTax(double infantTax) { DARABONBA_PTR_SET_VALUE(infantTax_, infantTax) };
