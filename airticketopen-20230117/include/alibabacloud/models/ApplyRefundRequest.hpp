...
#ifndef ALIBABACLOUD_MODELS_APPLYREFUNDREQUEST_HPP_
#define ALIBABACLOUD_MODELS_APPLYREFUNDREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ApplyRefundRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ApplyRefundRequest& obj) { 
    ...
    ApplyRefundRequest() = default ;
    ApplyRefundRequest(const ApplyRefundRequest &) = default ;
    ApplyRefundRequest(ApplyRefundRequest &&) = default ;
    ApplyRefundRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ApplyRefundRequest() = default ;
    ApplyRefundRequest& operator=(const ApplyRefundRequest &) = default ;
    ApplyRefundRequest& operator=(ApplyRefundRequest &&) = default ;
    ...
    inline ApplyRefundRequest& setAccountNo(int64_t accountNo) { DARABONBA_PTR_SET_VALUE(accountNo_, accountNo) };
    ...
    inline ApplyRefundRequest& setOrderNo(string orderNo) { DARABONBA_PTR_SET_VALUE(orderNo_, orderNo) };
    ...
    inline ApplyRefundRequest& setRefundReason(string refundReason) { DARABONBA_PTR_SET_VALUE(refundReason_, refundReason) };
    ...
    inline ApplyRefundRequest& setTracerId(string tracerId) { DARABONBA_PTR_SET_VALUE(tracerId_, tracerId) };
