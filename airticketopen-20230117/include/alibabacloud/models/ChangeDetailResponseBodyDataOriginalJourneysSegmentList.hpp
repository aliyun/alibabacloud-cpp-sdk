...
#ifndef ALIBABACLOUD_MODELS_CHANGEDETAILRESPONSEBODYDATAORIGINALJOURNEYSSEGMENTLIST_HPP_
#define ALIBABACLOUD_MODELS_CHANGEDETAILRESPONSEBODYDATAORIGINALJOURNEYSSEGMENTLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChangeDetailResponseBodyDataOriginalJourneysSegmentList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChangeDetailResponseBodyDataOriginalJourneysSegmentList& obj) { 
    ...
    ChangeDetailResponseBodyDataOriginalJourneysSegmentList() = default ;
    ChangeDetailResponseBodyDataOriginalJourneysSegmentList(const ChangeDetailResponseBodyDataOriginalJourneysSegmentList &) = default ;
    ChangeDetailResponseBodyDataOriginalJourneysSegmentList(ChangeDetailResponseBodyDataOriginalJourneysSegmentList &&) = default ;
    ChangeDetailResponseBodyDataOriginalJourneysSegmentList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChangeDetailResponseBodyDataOriginalJourneysSegmentList() = default ;
    ChangeDetailResponseBodyDataOriginalJourneysSegmentList& operator=(const ChangeDetailResponseBodyDataOriginalJourneysSegmentList &) = default ;
    ChangeDetailResponseBodyDataOriginalJourneysSegmentList& operator=(ChangeDetailResponseBodyDataOriginalJourneysSegmentList &&) = default ;
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setArrivalAirport(string arrivalAirport) { DARABONBA_PTR_SET_VALUE(arrivalAirport_, arrivalAirport) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setArrivalCity(string arrivalCity) { DARABONBA_PTR_SET_VALUE(arrivalCity_, arrivalCity) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setArrivalTerminal(string arrivalTerminal) { DARABONBA_PTR_SET_VALUE(arrivalTerminal_, arrivalTerminal) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setArrivalTime(string arrivalTime) { DARABONBA_PTR_SET_VALUE(arrivalTime_, arrivalTime) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setAvailability(string availability) { DARABONBA_PTR_SET_VALUE(availability_, availability) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setCabinClass(string cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setCodeShare(bool codeShare) { DARABONBA_PTR_SET_VALUE(codeShare_, codeShare) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setDepartureAirport(string departureAirport) { DARABONBA_PTR_SET_VALUE(departureAirport_, departureAirport) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setDepartureCity(string departureCity) { DARABONBA_PTR_SET_VALUE(departureCity_, departureCity) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setDepartureTerminal(string departureTerminal) { DARABONBA_PTR_SET_VALUE(departureTerminal_, departureTerminal) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setDepartureTime(string departureTime) { DARABONBA_PTR_SET_VALUE(departureTime_, departureTime) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setEquipType(string equipType) { DARABONBA_PTR_SET_VALUE(equipType_, equipType) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setFlightDuration(int32_t flightDuration) { DARABONBA_PTR_SET_VALUE(flightDuration_, flightDuration) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setMarketingAirline(string marketingAirline) { DARABONBA_PTR_SET_VALUE(marketingAirline_, marketingAirline) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setMarketingFlightNo(string marketingFlightNo) { DARABONBA_PTR_SET_VALUE(marketingFlightNo_, marketingFlightNo) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setMarketingFlightNoInt(int32_t marketingFlightNoInt) { DARABONBA_PTR_SET_VALUE(marketingFlightNoInt_, marketingFlightNoInt) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setOperatingAirline(string operatingAirline) { DARABONBA_PTR_SET_VALUE(operatingAirline_, operatingAirline) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setOperatingFlightNo(string operatingFlightNo) { DARABONBA_PTR_SET_VALUE(operatingFlightNo_, operatingFlightNo) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setSegmentId(string segmentId) { DARABONBA_PTR_SET_VALUE(segmentId_, segmentId) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setStopCityList(string stopCityList) { DARABONBA_PTR_SET_VALUE(stopCityList_, stopCityList) };
    ...
    inline ChangeDetailResponseBodyDataOriginalJourneysSegmentList& setStopQuantity(int32_t stopQuantity) { DARABONBA_PTR_SET_VALUE(stopQuantity_, stopQuantity) };
