...
#ifndef ALIBABACLOUD_MODELS_QUERYCALENDARAVAILABILITYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYCALENDARAVAILABILITYRESPONSEBODY_HPP_
...
namespace Models
{
  class QueryCalendarAvailabilityResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryCalendarAvailabilityResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryCalendarAvailabilityResponseBody& obj) { 
    ...
    QueryCalendarAvailabilityResponseBody() = default ;
    QueryCalendarAvailabilityResponseBody(const QueryCalendarAvailabilityResponseBody &) = default ;
    QueryCalendarAvailabilityResponseBody(QueryCalendarAvailabilityResponseBody &&) = default ;
    QueryCalendarAvailabilityResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryCalendarAvailabilityResponseBody() = default ;
    QueryCalendarAvailabilityResponseBody& operator=(const QueryCalendarAvailabilityResponseBody &) = default ;
    QueryCalendarAvailabilityResponseBody& operator=(QueryCalendarAvailabilityResponseBody &&) = default ;
    ...
    inline const QueryCalendarAvailabilityResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryCalendarAvailabilityResponseBody::Data) };
    inline QueryCalendarAvailabilityResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryCalendarAvailabilityResponseBody::Data) };
    inline QueryCalendarAvailabilityResponseBody& setData(const QueryCalendarAvailabilityResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryCalendarAvailabilityResponseBody& setData(QueryCalendarAvailabilityResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    void deleteErrorCode() { this->errorCode_ = nullptr;};
    inline string getErrorCode() const { DARABONBA_PTR_GET_DEFAULT(errorCode_, "") };
    inline QueryCalendarAvailabilityResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline QueryCalendarAvailabilityResponseBody& setErrorMsg(string errorMsg) { DARABONBA_PTR_SET_VALUE(errorMsg_, errorMsg) };
    ...
    inline QueryCalendarAvailabilityResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryCalendarAvailabilityResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    void deleteTracerId() { this->tracerId_ = nullptr;};
    inline string getTracerId() const { DARABONBA_PTR_GET_DEFAULT(tracerId_, "") };
    inline QueryCalendarAvailabilityResponseBody& setTracerId(string tracerId) { DARABONBA_PTR_SET_VALUE(tracerId_, tracerId) };


  protected:
    shared_ptr<QueryCalendarAvailabilityResponseBody::Data> data_ {};
    shared_ptr<string> errorCode_ {};
