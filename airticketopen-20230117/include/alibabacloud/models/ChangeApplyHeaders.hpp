...
#ifndef ALIBABACLOUD_MODELS_CHANGEAPPLYHEADERS_HPP_
#define ALIBABACLOUD_MODELS_CHANGEAPPLYHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChangeApplyHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChangeApplyHeaders& obj) { 
    ...
    ChangeApplyHeaders() = default ;
    ChangeApplyHeaders(const ChangeApplyHeaders &) = default ;
    ChangeApplyHeaders(ChangeApplyHeaders &&) = default ;
    ChangeApplyHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChangeApplyHeaders() = default ;
    ChangeApplyHeaders& operator=(const ChangeApplyHeaders &) = default ;
    ChangeApplyHeaders& operator=(ChangeApplyHeaders &&) = default ;
    ...
    inline ChangeApplyHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline ChangeApplyHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline ChangeApplyHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline ChangeApplyHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
