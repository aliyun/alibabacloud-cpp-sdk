...
#ifndef ALIBABACLOUD_MODELS_DATAREFUNDCHANGERULEMAPVALUEREFUNDRULEPARTUNUSEDLIST_HPP_
#define ALIBABACLOUD_MODELS_DATAREFUNDCHANGERULEMAPVALUEREFUNDRULEPARTUNUSEDLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DataRefundChangeRuleMapValueRefundRulePartUnusedList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DataRefundChangeRuleMapValueRefundRulePartUnusedList& obj) { 
    ...
    DataRefundChangeRuleMapValueRefundRulePartUnusedList() = default ;
    DataRefundChangeRuleMapValueRefundRulePartUnusedList(const DataRefundChangeRuleMapValueRefundRulePartUnusedList &) = default ;
    DataRefundChangeRuleMapValueRefundRulePartUnusedList(DataRefundChangeRuleMapValueRefundRulePartUnusedList &&) = default ;
    DataRefundChangeRuleMapValueRefundRulePartUnusedList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DataRefundChangeRuleMapValueRefundRulePartUnusedList() = default ;
    DataRefundChangeRuleMapValueRefundRulePartUnusedList& operator=(const DataRefundChangeRuleMapValueRefundRulePartUnusedList &) = default ;
    DataRefundChangeRuleMapValueRefundRulePartUnusedList& operator=(DataRefundChangeRuleMapValueRefundRulePartUnusedList &&) = default ;
    ...
    inline DataRefundChangeRuleMapValueRefundRulePartUnusedList& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DataRefundChangeRuleMapValueRefundRulePartUnusedList& setTimeUnit(string timeUnit) { DARABONBA_PTR_SET_VALUE(timeUnit_, timeUnit) };
    ...
    inline DataRefundChangeRuleMapValueRefundRulePartUnusedList& setRuleStartTime(int32_t ruleStartTime) { DARABONBA_PTR_SET_VALUE(ruleStartTime_, ruleStartTime) };
    ...
    inline DataRefundChangeRuleMapValueRefundRulePartUnusedList& setRuleEndTime(int32_t ruleEndTime) { DARABONBA_PTR_SET_VALUE(ruleEndTime_, ruleEndTime) };
    ...
    inline DataRefundChangeRuleMapValueRefundRulePartUnusedList& setCanRefund(bool canRefund) { DARABONBA_PTR_SET_VALUE(canRefund_, canRefund) };
    ...
    inline DataRefundChangeRuleMapValueRefundRulePartUnusedList& setRefundFee(double refundFee) { DARABONBA_PTR_SET_VALUE(refundFee_, refundFee) };
    ...
    inline DataRefundChangeRuleMapValueRefundRulePartUnusedList& setCanReturnAllTax(bool canReturnAllTax) { DARABONBA_PTR_SET_VALUE(canReturnAllTax_, canReturnAllTax) };
    ...
    inline DataRefundChangeRuleMapValueRefundRulePartUnusedList& setReturnPartTaxFee(double returnPartTaxFee) { DARABONBA_PTR_SET_VALUE(returnPartTaxFee_, returnPartTaxFee) };
