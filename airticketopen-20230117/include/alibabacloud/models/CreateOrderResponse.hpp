...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateOrderResponseBody) };
    inline CreateOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateOrderResponseBody> body_ {};
  };
