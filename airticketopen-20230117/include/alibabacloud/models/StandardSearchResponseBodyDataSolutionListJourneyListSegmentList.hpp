...
#ifndef ALIBABACLOUD_MODELS_STANDARDSEARCHRESPONSEBODYDATASOLUTIONLISTJOURNEYLISTSEGMENTLIST_HPP_
#define ALIBABACLOUD_MODELS_STANDARDSEARCHRESPONSEBODYDATASOLUTIONLISTJOURNEYLISTSEGMENTLIST_HPP_
...
namespace Models
{
  class StandardSearchResponseBodyDataSolutionListJourneyListSegmentList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& obj) { 
    ...
    StandardSearchResponseBodyDataSolutionListJourneyListSegmentList() = default ;
    StandardSearchResponseBodyDataSolutionListJourneyListSegmentList(const StandardSearchResponseBodyDataSolutionListJourneyListSegmentList &) = default ;
    StandardSearchResponseBodyDataSolutionListJourneyListSegmentList(StandardSearchResponseBodyDataSolutionListJourneyListSegmentList &&) = default ;
    StandardSearchResponseBodyDataSolutionListJourneyListSegmentList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StandardSearchResponseBodyDataSolutionListJourneyListSegmentList() = default ;
    StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& operator=(const StandardSearchResponseBodyDataSolutionListJourneyListSegmentList &) = default ;
    StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& operator=(StandardSearchResponseBodyDataSolutionListJourneyListSegmentList &&) = default ;
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setArrivalAirport(string arrivalAirport) { DARABONBA_PTR_SET_VALUE(arrivalAirport_, arrivalAirport) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setArrivalCity(string arrivalCity) { DARABONBA_PTR_SET_VALUE(arrivalCity_, arrivalCity) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setArrivalTerminal(string arrivalTerminal) { DARABONBA_PTR_SET_VALUE(arrivalTerminal_, arrivalTerminal) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setArrivalTime(string arrivalTime) { DARABONBA_PTR_SET_VALUE(arrivalTime_, arrivalTime) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setAvailability(string availability) { DARABONBA_PTR_SET_VALUE(availability_, availability) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setCabinClass(string cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setCodeShare(bool codeShare) { DARABONBA_PTR_SET_VALUE(codeShare_, codeShare) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setDepartureAirport(string departureAirport) { DARABONBA_PTR_SET_VALUE(departureAirport_, departureAirport) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setDepartureCity(string departureCity) { DARABONBA_PTR_SET_VALUE(departureCity_, departureCity) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setDepartureTerminal(string departureTerminal) { DARABONBA_PTR_SET_VALUE(departureTerminal_, departureTerminal) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setDepartureTime(string departureTime) { DARABONBA_PTR_SET_VALUE(departureTime_, departureTime) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setEquipType(string equipType) { DARABONBA_PTR_SET_VALUE(equipType_, equipType) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setFlightDuration(int32_t flightDuration) { DARABONBA_PTR_SET_VALUE(flightDuration_, flightDuration) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setMarketingAirline(string marketingAirline) { DARABONBA_PTR_SET_VALUE(marketingAirline_, marketingAirline) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setMarketingFlightNo(string marketingFlightNo) { DARABONBA_PTR_SET_VALUE(marketingFlightNo_, marketingFlightNo) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setMarketingFlightNoInt(int32_t marketingFlightNoInt) { DARABONBA_PTR_SET_VALUE(marketingFlightNoInt_, marketingFlightNoInt) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setOperatingAirline(string operatingAirline) { DARABONBA_PTR_SET_VALUE(operatingAirline_, operatingAirline) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setOperatingFlightNo(string operatingFlightNo) { DARABONBA_PTR_SET_VALUE(operatingFlightNo_, operatingFlightNo) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setSegmentId(string segmentId) { DARABONBA_PTR_SET_VALUE(segmentId_, segmentId) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setStopCityList(string stopCityList) { DARABONBA_PTR_SET_VALUE(stopCityList_, stopCityList) };
    ...
    inline StandardSearchResponseBodyDataSolutionListJourneyListSegmentList& setStopQuantity(int32_t stopQuantity) { DARABONBA_PTR_SET_VALUE(stopQuantity_, stopQuantity) };
