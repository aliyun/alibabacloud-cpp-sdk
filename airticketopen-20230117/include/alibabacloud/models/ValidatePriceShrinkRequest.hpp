...
#ifndef ALIBABACLOUD_MODELS_VALIDATEPRICESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_VALIDATEPRICESHRINKREQUEST_HPP_
...
namespace Models
{
  class ValidatePriceShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ValidatePriceShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ValidatePriceShrinkRequest& obj) { 
    ...
    ValidatePriceShrinkRequest() = default ;
    ValidatePriceShrinkRequest(const ValidatePriceShrinkRequest &) = default ;
    ValidatePriceShrinkRequest(ValidatePriceShrinkRequest &&) = default ;
    ValidatePriceShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ValidatePriceShrinkRequest() = default ;
    ValidatePriceShrinkRequest& operator=(const ValidatePriceShrinkRequest &) = default ;
    ValidatePriceShrinkRequest& operator=(ValidatePriceShrinkRequest &&) = default ;
    ...
    inline ValidatePriceShrinkRequest& setAccountNo(int64_t accountNo) { DARABONBA_PTR_SET_VALUE(accountNo_, accountNo) };
    ...
    inline ValidatePriceShrinkRequest& setAdults(int32_t adults) { DARABONBA_PTR_SET_VALUE(adults_, adults) };
    ...
    inline ValidatePriceShrinkRequest& setChildren(int32_t children) { DARABONBA_PTR_SET_VALUE(children_, children) };
    ...
    inline ValidatePriceShrinkRequest& setChildrenAgesShrink(string childrenAgesShrink) { DARABONBA_PTR_SET_VALUE(childrenAgesShrink_, childrenAgesShrink) };
    ...
    inline ValidatePriceShrinkRequest& setItemOfferKey(string itemOfferKey) { DARABONBA_PTR_SET_VALUE(itemOfferKey_, itemOfferKey) };
    ...
    inline ValidatePriceShrinkRequest& setRoomCount(int32_t roomCount) { DARABONBA_PTR_SET_VALUE(roomCount_, roomCount) };
    ...
    inline ValidatePriceShrinkRequest& setTracerId(string tracerId) { DARABONBA_PTR_SET_VALUE(tracerId_, tracerId) };
