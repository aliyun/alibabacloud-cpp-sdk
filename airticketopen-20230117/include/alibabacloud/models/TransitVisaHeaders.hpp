...
#ifndef ALIBABACLOUD_MODELS_TRANSITVISAHEADERS_HPP_
#define ALIBABACLOUD_MODELS_TRANSITVISAHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TransitVisaHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TransitVisaHeaders& obj) { 
    ...
    TransitVisaHeaders() = default ;
    TransitVisaHeaders(const TransitVisaHeaders &) = default ;
    TransitVisaHeaders(TransitVisaHeaders &&) = default ;
    TransitVisaHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TransitVisaHeaders() = default ;
    TransitVisaHeaders& operator=(const TransitVisaHeaders &) = default ;
    TransitVisaHeaders& operator=(TransitVisaHeaders &&) = default ;
    ...
    inline TransitVisaHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline TransitVisaHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline TransitVisaHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline TransitVisaHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
