...
#ifndef ALIBABACLOUD_MODELS_CHANGEAPPLYREQUESTCHANGEPASSENGERLIST_HPP_
#define ALIBABACLOUD_MODELS_CHANGEAPPLYREQUESTCHANGEPASSENGERLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChangeApplyRequestChangePassengerList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChangeApplyRequestChangePassengerList& obj) { 
    ...
    ChangeApplyRequestChangePassengerList() = default ;
    ChangeApplyRequestChangePassengerList(const ChangeApplyRequestChangePassengerList &) = default ;
    ChangeApplyRequestChangePassengerList(ChangeApplyRequestChangePassengerList &&) = default ;
    ChangeApplyRequestChangePassengerList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChangeApplyRequestChangePassengerList() = default ;
    ChangeApplyRequestChangePassengerList& operator=(const ChangeApplyRequestChangePassengerList &) = default ;
    ChangeApplyRequestChangePassengerList& operator=(ChangeApplyRequestChangePassengerList &&) = default ;
    ...
    inline ChangeApplyRequestChangePassengerList& setDocument(string document) { DARABONBA_PTR_SET_VALUE(document_, document) };
    ...
    inline ChangeApplyRequestChangePassengerList& setFirstName(string firstName) { DARABONBA_PTR_SET_VALUE(firstName_, firstName) };
    ...
    inline ChangeApplyRequestChangePassengerList& setLastName(string lastName) { DARABONBA_PTR_SET_VALUE(lastName_, lastName) };
