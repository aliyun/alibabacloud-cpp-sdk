...
#ifndef ALIBABACLOUD_MODELS_VALIDATEPRICERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_VALIDATEPRICERESPONSEBODY_HPP_
...
namespace Models
{
  class ValidatePriceResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ValidatePriceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ValidatePriceResponseBody& obj) { 
    ...
    ValidatePriceResponseBody() = default ;
    ValidatePriceResponseBody(const ValidatePriceResponseBody &) = default ;
    ValidatePriceResponseBody(ValidatePriceResponseBody &&) = default ;
    ValidatePriceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ValidatePriceResponseBody() = default ;
    ValidatePriceResponseBody& operator=(const ValidatePriceResponseBody &) = default ;
    ValidatePriceResponseBody& operator=(ValidatePriceResponseBody &&) = default ;
    ...
    inline const ValidatePriceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ValidatePriceResponseBody::Data) };
    inline ValidatePriceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ValidatePriceResponseBody::Data) };
    inline ValidatePriceResponseBody& setData(const ValidatePriceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ValidatePriceResponseBody& setData(ValidatePriceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ValidatePriceResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline ValidatePriceResponseBody& setErrorMsg(string errorMsg) { DARABONBA_PTR_SET_VALUE(errorMsg_, errorMsg) };
    ...
    inline ValidatePriceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ValidatePriceResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    void deleteTracerId() { this->tracerId_ = nullptr;};
    inline string getTracerId() const { DARABONBA_PTR_GET_DEFAULT(tracerId_, "") };
    inline ValidatePriceResponseBody& setTracerId(string tracerId) { DARABONBA_PTR_SET_VALUE(tracerId_, tracerId) };


  protected:
    shared_ptr<ValidatePriceResponseBody::Data> data_ {};
