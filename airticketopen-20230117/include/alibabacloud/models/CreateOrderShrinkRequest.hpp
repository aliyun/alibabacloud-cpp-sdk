...
namespace Models
{
  ...
  public:
    ...
    inline CreateOrderShrinkRequest& setAccountNo(int64_t accountNo) { DARABONBA_PTR_SET_VALUE(accountNo_, accountNo) };
    ...
    inline CreateOrderShrinkRequest& setContactShrink(string contactShrink) { DARABONBA_PTR_SET_VALUE(contactShrink_, contactShrink) };
    ...
    inline CreateOrderShrinkRequest& setExternalOrderNo(string externalOrderNo) { DARABONBA_PTR_SET_VALUE(externalOrderNo_, externalOrderNo) };
    ...
    inline CreateOrderShrinkRequest& setGuestsShrink(string guestsShrink) { DARABONBA_PTR_SET_VALUE(guestsShrink_, guestsShrink) };
    ...
    inline CreateOrderShrinkRequest& setItemOfferId(string itemOfferId) { DARABONBA_PTR_SET_VALUE(itemOfferId_, itemOfferId) };
    ...
    inline CreateOrderShrinkRequest& setRoomCount(int32_t roomCount) { DARABONBA_PTR_SET_VALUE(roomCount_, roomCount) };
    ...
    inline CreateOrderShrinkRequest& setTracerId(string tracerId) { DARABONBA_PTR_SET_VALUE(tracerId_, tracerId) };
