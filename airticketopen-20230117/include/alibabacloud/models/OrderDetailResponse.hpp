...
namespace Models
{
  ...
  public:
    ...
    inline const OrderDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OrderDetailResponseBody) };
    inline OrderDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, OrderDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OrderDetailResponseBody> body_ {};
  };
