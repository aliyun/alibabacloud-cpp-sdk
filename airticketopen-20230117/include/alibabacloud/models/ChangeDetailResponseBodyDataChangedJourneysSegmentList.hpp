...
#ifndef ALIBABACLOUD_MODELS_CHANGEDETAILRESPONSEBODYDATACHANGEDJOURNEYSSEGMENTLIST_HPP_
#define ALIBABACLOUD_MODELS_CHANGEDETAILRESPONSEBODYDATACHANGEDJOURNEYSSEGMENTLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChangeDetailResponseBodyDataChangedJourneysSegmentList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChangeDetailResponseBodyDataChangedJourneysSegmentList& obj) { 
    ...
    ChangeDetailResponseBodyDataChangedJourneysSegmentList() = default ;
    ChangeDetailResponseBodyDataChangedJourneysSegmentList(const ChangeDetailResponseBodyDataChangedJourneysSegmentList &) = default ;
    ChangeDetailResponseBodyDataChangedJourneysSegmentList(ChangeDetailResponseBodyDataChangedJourneysSegmentList &&) = default ;
    ChangeDetailResponseBodyDataChangedJourneysSegmentList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChangeDetailResponseBodyDataChangedJourneysSegmentList() = default ;
    ChangeDetailResponseBodyDataChangedJourneysSegmentList& operator=(const ChangeDetailResponseBodyDataChangedJourneysSegmentList &) = default ;
    ChangeDetailResponseBodyDataChangedJourneysSegmentList& operator=(ChangeDetailResponseBodyDataChangedJourneysSegmentList &&) = default ;
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setArrivalAirport(string arrivalAirport) { DARABONBA_PTR_SET_VALUE(arrivalAirport_, arrivalAirport) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setArrivalCity(string arrivalCity) { DARABONBA_PTR_SET_VALUE(arrivalCity_, arrivalCity) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setArrivalTerminal(string arrivalTerminal) { DARABONBA_PTR_SET_VALUE(arrivalTerminal_, arrivalTerminal) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setArrivalTime(string arrivalTime) { DARABONBA_PTR_SET_VALUE(arrivalTime_, arrivalTime) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setAvailability(string availability) { DARABONBA_PTR_SET_VALUE(availability_, availability) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setCabinClass(string cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setCodeShare(bool codeShare) { DARABONBA_PTR_SET_VALUE(codeShare_, codeShare) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setDepartureAirport(string departureAirport) { DARABONBA_PTR_SET_VALUE(departureAirport_, departureAirport) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setDepartureCity(string departureCity) { DARABONBA_PTR_SET_VALUE(departureCity_, departureCity) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setDepartureTerminal(string departureTerminal) { DARABONBA_PTR_SET_VALUE(departureTerminal_, departureTerminal) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setDepartureTime(string departureTime) { DARABONBA_PTR_SET_VALUE(departureTime_, departureTime) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setEquipType(string equipType) { DARABONBA_PTR_SET_VALUE(equipType_, equipType) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setFlightDuration(int32_t flightDuration) { DARABONBA_PTR_SET_VALUE(flightDuration_, flightDuration) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setMarketingAirline(string marketingAirline) { DARABONBA_PTR_SET_VALUE(marketingAirline_, marketingAirline) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setMarketingFlightNo(string marketingFlightNo) { DARABONBA_PTR_SET_VALUE(marketingFlightNo_, marketingFlightNo) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setMarketingFlightNoInt(int32_t marketingFlightNoInt) { DARABONBA_PTR_SET_VALUE(marketingFlightNoInt_, marketingFlightNoInt) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setOperatingAirline(string operatingAirline) { DARABONBA_PTR_SET_VALUE(operatingAirline_, operatingAirline) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setOperatingFlightNo(string operatingFlightNo) { DARABONBA_PTR_SET_VALUE(operatingFlightNo_, operatingFlightNo) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setSegmentId(string segmentId) { DARABONBA_PTR_SET_VALUE(segmentId_, segmentId) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setStopCityList(string stopCityList) { DARABONBA_PTR_SET_VALUE(stopCityList_, stopCityList) };
    ...
    inline ChangeDetailResponseBodyDataChangedJourneysSegmentList& setStopQuantity(int32_t stopQuantity) { DARABONBA_PTR_SET_VALUE(stopQuantity_, stopQuantity) };
