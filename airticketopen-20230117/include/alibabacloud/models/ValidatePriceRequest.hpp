...
#ifndef ALIBABACLOUD_MODELS_VALIDATEPRICEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_VALIDATEPRICEREQUEST_HPP_
...
namespace Models
{
  class ValidatePriceRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ValidatePriceRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ValidatePriceRequest& obj) { 
    ...
    ValidatePriceRequest() = default ;
    ValidatePriceRequest(const ValidatePriceRequest &) = default ;
    ValidatePriceRequest(ValidatePriceRequest &&) = default ;
    ValidatePriceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ValidatePriceRequest() = default ;
    ValidatePriceRequest& operator=(const ValidatePriceRequest &) = default ;
    ValidatePriceRequest& operator=(ValidatePriceRequest &&) = default ;
    ...
    inline ValidatePriceRequest& setAccountNo(int64_t accountNo) { DARABONBA_PTR_SET_VALUE(accountNo_, accountNo) };
    ...
    inline ValidatePriceRequest& setAdults(int32_t adults) { DARABONBA_PTR_SET_VALUE(adults_, adults) };
    ...
    inline ValidatePriceRequest& setChildren(int32_t children) { DARABONBA_PTR_SET_VALUE(children_, children) };
    ...
    inline ValidatePriceRequest& setChildrenAges(const vector<int32_t> & childrenAges) { DARABONBA_PTR_SET_VALUE(childrenAges_, childrenAges) };
    inline ValidatePriceRequest& setChildrenAges(vector<int32_t> && childrenAges) { DARABONBA_PTR_SET_RVALUE(childrenAges_, childrenAges) };
    ...
    inline ValidatePriceRequest& setItemOfferKey(string itemOfferKey) { DARABONBA_PTR_SET_VALUE(itemOfferKey_, itemOfferKey) };
    ...
    inline ValidatePriceRequest& setRoomCount(int32_t roomCount) { DARABONBA_PTR_SET_VALUE(roomCount_, roomCount) };
    ...
    inline ValidatePriceRequest& setTracerId(string tracerId) { DARABONBA_PTR_SET_VALUE(tracerId_, tracerId) };
