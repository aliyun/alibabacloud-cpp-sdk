...
#ifndef ALIBABACLOUD_MODELS_CHANGEDETAILLISTOFORDERNUMRESPONSEBODYDATALISTORIGINALJOURNEYSSEGMENTLIST_HPP_
#define ALIBABACLOUD_MODELS_CHANGEDETAILLISTOFORDERNUMRESPONSEBODYDATALISTORIGINALJOURNEYSSEGMENTLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& obj) { 
    ...
    ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList() = default ;
    ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList(const ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList &) = default ;
    ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList(ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList &&) = default ;
    ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList() = default ;
    ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& operator=(const ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList &) = default ;
    ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& operator=(ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList &&) = default ;
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setArrivalAirport(string arrivalAirport) { DARABONBA_PTR_SET_VALUE(arrivalAirport_, arrivalAirport) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setArrivalCity(string arrivalCity) { DARABONBA_PTR_SET_VALUE(arrivalCity_, arrivalCity) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setArrivalTerminal(string arrivalTerminal) { DARABONBA_PTR_SET_VALUE(arrivalTerminal_, arrivalTerminal) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setArrivalTime(string arrivalTime) { DARABONBA_PTR_SET_VALUE(arrivalTime_, arrivalTime) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setAvailability(string availability) { DARABONBA_PTR_SET_VALUE(availability_, availability) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setCabinClass(string cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setCodeShare(bool codeShare) { DARABONBA_PTR_SET_VALUE(codeShare_, codeShare) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setDepartureAirport(string departureAirport) { DARABONBA_PTR_SET_VALUE(departureAirport_, departureAirport) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setDepartureCity(string departureCity) { DARABONBA_PTR_SET_VALUE(departureCity_, departureCity) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setDepartureTerminal(string departureTerminal) { DARABONBA_PTR_SET_VALUE(departureTerminal_, departureTerminal) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setDepartureTime(string departureTime) { DARABONBA_PTR_SET_VALUE(departureTime_, departureTime) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setEquipType(string equipType) { DARABONBA_PTR_SET_VALUE(equipType_, equipType) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setFlightDuration(int32_t flightDuration) { DARABONBA_PTR_SET_VALUE(flightDuration_, flightDuration) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setMarketingAirline(string marketingAirline) { DARABONBA_PTR_SET_VALUE(marketingAirline_, marketingAirline) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setMarketingFlightNo(string marketingFlightNo) { DARABONBA_PTR_SET_VALUE(marketingFlightNo_, marketingFlightNo) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setMarketingFlightNoInt(int32_t marketingFlightNoInt) { DARABONBA_PTR_SET_VALUE(marketingFlightNoInt_, marketingFlightNoInt) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setOperatingAirline(string operatingAirline) { DARABONBA_PTR_SET_VALUE(operatingAirline_, operatingAirline) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setOperatingFlightNo(string operatingFlightNo) { DARABONBA_PTR_SET_VALUE(operatingFlightNo_, operatingFlightNo) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setSegmentId(string segmentId) { DARABONBA_PTR_SET_VALUE(segmentId_, segmentId) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setStopCityList(string stopCityList) { DARABONBA_PTR_SET_VALUE(stopCityList_, stopCityList) };
    ...
    inline ChangeDetailListOfOrderNumResponseBodyDataListOriginalJourneysSegmentList& setStopQuantity(int32_t stopQuantity) { DARABONBA_PTR_SET_VALUE(stopQuantity_, stopQuantity) };
