...
#ifndef ALIBABACLOUD_MODELS_ENRICHHEADERS_HPP_
#define ALIBABACLOUD_MODELS_ENRICHHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const EnrichHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EnrichHeaders& obj) { 
    ...
    EnrichHeaders() = default ;
    EnrichHeaders(const EnrichHeaders &) = default ;
    EnrichHeaders(EnrichHeaders &&) = default ;
    EnrichHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EnrichHeaders() = default ;
    EnrichHeaders& operator=(const EnrichHeaders &) = default ;
    EnrichHeaders& operator=(EnrichHeaders &&) = default ;
    ...
    inline EnrichHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline EnrichHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline EnrichHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline EnrichHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
