...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeConfirmResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ChangeConfirmResponseBodyData) };
    inline ChangeConfirmResponseBodyData data() { DARABONBA_PTR_GET(data_, ChangeConfirmResponseBodyData) };
    inline ChangeConfirmResponseBody& setData(const ChangeConfirmResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ChangeConfirmResponseBody& setData(ChangeConfirmResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ChangeConfirmResponseBodyData> data_ = nullptr;
