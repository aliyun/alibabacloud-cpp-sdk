...
namespace Models
{
  ...
  public:
    ...
    inline const RefundDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, RefundDetailResponseBodyData) };
    inline RefundDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, RefundDetailResponseBodyData) };
    inline RefundDetailResponseBody& setData(const RefundDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RefundDetailResponseBody& setData(RefundDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
