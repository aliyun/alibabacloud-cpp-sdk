...
namespace Models
{
  ...
  public:
    ...
    inline const PricingResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, PricingResponseBodyData) };
    inline PricingResponseBodyData data() { DARABONBA_PTR_GET(data_, PricingResponseBodyData) };
    inline PricingResponseBody& setData(const PricingResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline PricingResponseBody& setData(PricingResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // data
    std::shared_ptr<PricingResponseBodyData> data_ = nullptr;
    // error code
