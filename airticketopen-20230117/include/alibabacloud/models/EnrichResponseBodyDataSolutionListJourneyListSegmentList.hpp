...
#ifndef ALIBABACLOUD_MODELS_ENRICHRESPONSEBODYDATASOLUTIONLISTJOURNEYLISTSEGMENTLIST_HPP_
#define ALIBABACLOUD_MODELS_ENRICHRESPONSEBODYDATASOLUTIONLISTJOURNEYLISTSEGMENTLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const EnrichResponseBodyDataSolutionListJourneyListSegmentList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EnrichResponseBodyDataSolutionListJourneyListSegmentList& obj) { 
    ...
    EnrichResponseBodyDataSolutionListJourneyListSegmentList() = default ;
    EnrichResponseBodyDataSolutionListJourneyListSegmentList(const EnrichResponseBodyDataSolutionListJourneyListSegmentList &) = default ;
    EnrichResponseBodyDataSolutionListJourneyListSegmentList(EnrichResponseBodyDataSolutionListJourneyListSegmentList &&) = default ;
    EnrichResponseBodyDataSolutionListJourneyListSegmentList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EnrichResponseBodyDataSolutionListJourneyListSegmentList() = default ;
    EnrichResponseBodyDataSolutionListJourneyListSegmentList& operator=(const EnrichResponseBodyDataSolutionListJourneyListSegmentList &) = default ;
    EnrichResponseBodyDataSolutionListJourneyListSegmentList& operator=(EnrichResponseBodyDataSolutionListJourneyListSegmentList &&) = default ;
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setArrivalAirport(string arrivalAirport) { DARABONBA_PTR_SET_VALUE(arrivalAirport_, arrivalAirport) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setArrivalCity(string arrivalCity) { DARABONBA_PTR_SET_VALUE(arrivalCity_, arrivalCity) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setArrivalTerminal(string arrivalTerminal) { DARABONBA_PTR_SET_VALUE(arrivalTerminal_, arrivalTerminal) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setArrivalTime(string arrivalTime) { DARABONBA_PTR_SET_VALUE(arrivalTime_, arrivalTime) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setAvailability(string availability) { DARABONBA_PTR_SET_VALUE(availability_, availability) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setCabinClass(string cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setCodeShare(bool codeShare) { DARABONBA_PTR_SET_VALUE(codeShare_, codeShare) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setDepartureAirport(string departureAirport) { DARABONBA_PTR_SET_VALUE(departureAirport_, departureAirport) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setDepartureCity(string departureCity) { DARABONBA_PTR_SET_VALUE(departureCity_, departureCity) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setDepartureTerminal(string departureTerminal) { DARABONBA_PTR_SET_VALUE(departureTerminal_, departureTerminal) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setDepartureTime(string departureTime) { DARABONBA_PTR_SET_VALUE(departureTime_, departureTime) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setEquipType(string equipType) { DARABONBA_PTR_SET_VALUE(equipType_, equipType) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setFlightDuration(int32_t flightDuration) { DARABONBA_PTR_SET_VALUE(flightDuration_, flightDuration) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setMarketingAirline(string marketingAirline) { DARABONBA_PTR_SET_VALUE(marketingAirline_, marketingAirline) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setMarketingFlightNo(string marketingFlightNo) { DARABONBA_PTR_SET_VALUE(marketingFlightNo_, marketingFlightNo) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setMarketingFlightNoInt(int32_t marketingFlightNoInt) { DARABONBA_PTR_SET_VALUE(marketingFlightNoInt_, marketingFlightNoInt) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setOperatingAirline(string operatingAirline) { DARABONBA_PTR_SET_VALUE(operatingAirline_, operatingAirline) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setOperatingFlightNo(string operatingFlightNo) { DARABONBA_PTR_SET_VALUE(operatingFlightNo_, operatingFlightNo) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setSegmentId(string segmentId) { DARABONBA_PTR_SET_VALUE(segmentId_, segmentId) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setStopCityList(string stopCityList) { DARABONBA_PTR_SET_VALUE(stopCityList_, stopCityList) };
    ...
    inline EnrichResponseBodyDataSolutionListJourneyListSegmentList& setStopQuantity(int32_t stopQuantity) { DARABONBA_PTR_SET_VALUE(stopQuantity_, stopQuantity) };
