...
#ifndef ALIBABACLOUD_MODELS_SEARCHRESPONSEBODYDATASOLUTIONLISTJOURNEYLISTSEGMENTLIST_HPP_
#define ALIBABACLOUD_MODELS_SEARCHRESPONSEBODYDATASOLUTIONLISTJOURNEYLISTSEGMENTLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SearchResponseBodyDataSolutionListJourneyListSegmentList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SearchResponseBodyDataSolutionListJourneyListSegmentList& obj) { 
    ...
    SearchResponseBodyDataSolutionListJourneyListSegmentList() = default ;
    SearchResponseBodyDataSolutionListJourneyListSegmentList(const SearchResponseBodyDataSolutionListJourneyListSegmentList &) = default ;
    SearchResponseBodyDataSolutionListJourneyListSegmentList(SearchResponseBodyDataSolutionListJourneyListSegmentList &&) = default ;
    SearchResponseBodyDataSolutionListJourneyListSegmentList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SearchResponseBodyDataSolutionListJourneyListSegmentList() = default ;
    SearchResponseBodyDataSolutionListJourneyListSegmentList& operator=(const SearchResponseBodyDataSolutionListJourneyListSegmentList &) = default ;
    SearchResponseBodyDataSolutionListJourneyListSegmentList& operator=(SearchResponseBodyDataSolutionListJourneyListSegmentList &&) = default ;
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setArrivalAirport(string arrivalAirport) { DARABONBA_PTR_SET_VALUE(arrivalAirport_, arrivalAirport) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setArrivalCity(string arrivalCity) { DARABONBA_PTR_SET_VALUE(arrivalCity_, arrivalCity) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setArrivalTerminal(string arrivalTerminal) { DARABONBA_PTR_SET_VALUE(arrivalTerminal_, arrivalTerminal) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setArrivalTime(string arrivalTime) { DARABONBA_PTR_SET_VALUE(arrivalTime_, arrivalTime) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setAvailability(string availability) { DARABONBA_PTR_SET_VALUE(availability_, availability) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setCabinClass(string cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setCodeShare(bool codeShare) { DARABONBA_PTR_SET_VALUE(codeShare_, codeShare) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setDepartureAirport(string departureAirport) { DARABONBA_PTR_SET_VALUE(departureAirport_, departureAirport) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setDepartureCity(string departureCity) { DARABONBA_PTR_SET_VALUE(departureCity_, departureCity) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setDepartureTerminal(string departureTerminal) { DARABONBA_PTR_SET_VALUE(departureTerminal_, departureTerminal) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setDepartureTime(string departureTime) { DARABONBA_PTR_SET_VALUE(departureTime_, departureTime) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setEquipType(string equipType) { DARABONBA_PTR_SET_VALUE(equipType_, equipType) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setFlightDuration(int32_t flightDuration) { DARABONBA_PTR_SET_VALUE(flightDuration_, flightDuration) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setMarketingAirline(string marketingAirline) { DARABONBA_PTR_SET_VALUE(marketingAirline_, marketingAirline) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setMarketingFlightNo(string marketingFlightNo) { DARABONBA_PTR_SET_VALUE(marketingFlightNo_, marketingFlightNo) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setMarketingFlightNoInt(int32_t marketingFlightNoInt) { DARABONBA_PTR_SET_VALUE(marketingFlightNoInt_, marketingFlightNoInt) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setOperatingAirline(string operatingAirline) { DARABONBA_PTR_SET_VALUE(operatingAirline_, operatingAirline) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setOperatingFlightNo(string operatingFlightNo) { DARABONBA_PTR_SET_VALUE(operatingFlightNo_, operatingFlightNo) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setSegmentId(string segmentId) { DARABONBA_PTR_SET_VALUE(segmentId_, segmentId) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setStopCityList(string stopCityList) { DARABONBA_PTR_SET_VALUE(stopCityList_, stopCityList) };
    ...
    inline SearchResponseBodyDataSolutionListJourneyListSegmentList& setStopQuantity(int32_t stopQuantity) { DARABONBA_PTR_SET_VALUE(stopQuantity_, stopQuantity) };
