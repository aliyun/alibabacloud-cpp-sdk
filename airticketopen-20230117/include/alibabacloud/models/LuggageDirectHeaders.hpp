...
#ifndef ALIBABACLOUD_MODELS_LUGGAGEDIRECTHEADERS_HPP_
#define ALIBABACLOUD_MODELS_LUGGAGEDIRECTHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const LuggageDirectHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, LuggageDirectHeaders& obj) { 
    ...
    LuggageDirectHeaders() = default ;
    LuggageDirectHeaders(const LuggageDirectHeaders &) = default ;
    LuggageDirectHeaders(LuggageDirectHeaders &&) = default ;
    LuggageDirectHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~LuggageDirectHeaders() = default ;
    LuggageDirectHeaders& operator=(const LuggageDirectHeaders &) = default ;
    LuggageDirectHeaders& operator=(LuggageDirectHeaders &&) = default ;
    ...
    inline LuggageDirectHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline LuggageDirectHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline LuggageDirectHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline LuggageDirectHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
