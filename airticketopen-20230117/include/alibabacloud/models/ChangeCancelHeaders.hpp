...
#ifndef ALIBABACLOUD_MODELS_CHANGECANCELHEADERS_HPP_
#define ALIBABACLOUD_MODELS_CHANGECANCELHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChangeCancelHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChangeCancelHeaders& obj) { 
    ...
    ChangeCancelHeaders() = default ;
    ChangeCancelHeaders(const ChangeCancelHeaders &) = default ;
    ChangeCancelHeaders(ChangeCancelHeaders &&) = default ;
    ChangeCancelHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChangeCancelHeaders() = default ;
    ChangeCancelHeaders& operator=(const ChangeCancelHeaders &) = default ;
    ChangeCancelHeaders& operator=(ChangeCancelHeaders &&) = default ;
    ...
    inline ChangeCancelHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline ChangeCancelHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline ChangeCancelHeaders& setXAcsAirticketAccessToken(string xAcsAirticketAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAirticketAccessToken_, xAcsAirticketAccessToken) };
    ...
    inline ChangeCancelHeaders& setXAcsAirticketLanguage(string xAcsAirticketLanguage) { DARABONBA_PTR_SET_VALUE(xAcsAirticketLanguage_, xAcsAirticketLanguage) };
