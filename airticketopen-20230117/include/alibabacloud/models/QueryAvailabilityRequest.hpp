...
#ifndef ALIBABACLOUD_MODELS_QUERYAVAILABILITYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_QUERYAVAILABILITYREQUEST_HPP_
...
namespace Models
{
  class QueryAvailabilityRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryAvailabilityRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryAvailabilityRequest& obj) { 
    ...
    QueryAvailabilityRequest() = default ;
    QueryAvailabilityRequest(const QueryAvailabilityRequest &) = default ;
    QueryAvailabilityRequest(QueryAvailabilityRequest &&) = default ;
    QueryAvailabilityRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryAvailabilityRequest() = default ;
    QueryAvailabilityRequest& operator=(const QueryAvailabilityRequest &) = default ;
    QueryAvailabilityRequest& operator=(QueryAvailabilityRequest &&) = default ;
    ...
    inline QueryAvailabilityRequest& setAccountNo(int64_t accountNo) { DARABONBA_PTR_SET_VALUE(accountNo_, accountNo) };
    ...
    inline QueryAvailabilityRequest& setAdultCount(int32_t adultCount) { DARABONBA_PTR_SET_VALUE(adultCount_, adultCount) };
    ...
    inline QueryAvailabilityRequest& setCheckInDate(string checkInDate) { DARABONBA_PTR_SET_VALUE(checkInDate_, checkInDate) };
    ...
    inline QueryAvailabilityRequest& setCheckOutDate(string checkOutDate) { DARABONBA_PTR_SET_VALUE(checkOutDate_, checkOutDate) };
    ...
    inline QueryAvailabilityRequest& setChildCount(int32_t childCount) { DARABONBA_PTR_SET_VALUE(childCount_, childCount) };
    ...
    inline QueryAvailabilityRequest& setChildrenAges(const vector<int32_t> & childrenAges) { DARABONBA_PTR_SET_VALUE(childrenAges_, childrenAges) };
    inline QueryAvailabilityRequest& setChildrenAges(vector<int32_t> && childrenAges) { DARABONBA_PTR_SET_RVALUE(childrenAges_, childrenAges) };
    ...
    inline QueryAvailabilityRequest& setRoomCount(int32_t roomCount) { DARABONBA_PTR_SET_VALUE(roomCount_, roomCount) };
    ...
    inline QueryAvailabilityRequest& setStandardHotelIds(const vector<string> & standardHotelIds) { DARABONBA_PTR_SET_VALUE(standardHotelIds_, standardHotelIds) };
    inline QueryAvailabilityRequest& setStandardHotelIds(vector<string> && standardHotelIds) { DARABONBA_PTR_SET_RVALUE(standardHotelIds_, standardHotelIds) };
    ...
    inline QueryAvailabilityRequest& setTracerId(string tracerId) { DARABONBA_PTR_SET_VALUE(tracerId_, tracerId) };
