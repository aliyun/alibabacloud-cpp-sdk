...
#ifndef ALIBABACLOUD_MODELS_STANDARDSEARCHRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_STANDARDSEARCHRESPONSEBODY_HPP_
...
namespace Models
{
  class StandardSearchResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const StandardSearchResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StandardSearchResponseBody& obj) { 
    ...
    StandardSearchResponseBody() = default ;
    StandardSearchResponseBody(const StandardSearchResponseBody &) = default ;
    StandardSearchResponseBody(StandardSearchResponseBody &&) = default ;
    StandardSearchResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StandardSearchResponseBody() = default ;
    StandardSearchResponseBody& operator=(const StandardSearchResponseBody &) = default ;
    StandardSearchResponseBody& operator=(StandardSearchResponseBody &&) = default ;
    ...
    inline StandardSearchResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const StandardSearchResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, StandardSearchResponseBody::Data) };
    inline StandardSearchResponseBody::Data getData() { DARABONBA_PTR_GET(data_, StandardSearchResponseBody::Data) };
    inline StandardSearchResponseBody& setData(const StandardSearchResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline StandardSearchResponseBody& setData(StandardSearchResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline StandardSearchResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline StandardSearchResponseBody& setErrorData(const Darabonba::Json & errorData) { DARABONBA_SET_VALUE(errorData_, errorData) };
    inline StandardSearchResponseBody& setErrorData(Darabonba::Json && errorData) { DARABONBA_SET_RVALUE(errorData_, errorData) };
    ...
    inline StandardSearchResponseBody& setErrorMsg(string errorMsg) { DARABONBA_PTR_SET_VALUE(errorMsg_, errorMsg) };
    ...
    inline StandardSearchResponseBody& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline StandardSearchResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    shared_ptr<StandardSearchResponseBody::Data> data_ {};
    // Business error code
