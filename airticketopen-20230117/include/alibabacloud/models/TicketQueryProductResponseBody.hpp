...
#ifndef ALIBABACLOUD_MODELS_TICKETQUERYPRODUCTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_TICKETQUERYPRODUCTRESPONSEBODY_HPP_
...
namespace Models
{
  class TicketQueryProductResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const TicketQueryProductResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TicketQueryProductResponseBody& obj) { 
    ...
    TicketQueryProductResponseBody() = default ;
    TicketQueryProductResponseBody(const TicketQueryProductResponseBody &) = default ;
    TicketQueryProductResponseBody(TicketQueryProductResponseBody &&) = default ;
    TicketQueryProductResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TicketQueryProductResponseBody() = default ;
    TicketQueryProductResponseBody& operator=(const TicketQueryProductResponseBody &) = default ;
    TicketQueryProductResponseBody& operator=(TicketQueryProductResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline Product& setBookingType(int32_t bookingType) { DARABONBA_PTR_SET_VALUE(bookingType_, bookingType) };


        // buyRule Field Functions 
        bool hasBuyRule() const { return this->buyRule_ != nullptr;};
        void deleteBuyRule() { this->buyRule_ = nullptr;};
        inline const Product::BuyRule & getBuyRule() const { DARABONBA_PTR_GET_CONST(buyRule_, Product::BuyRule) };
        inline Product::BuyRule getBuyRule() { DARABONBA_PTR_GET(buyRule_, Product::BuyRule) };
        inline Product& setBuyRule(const Product::BuyRule & buyRule) { DARABONBA_PTR_SET_VALUE(buyRule_, buyRule) };
        inline Product& setBuyRule(Product::BuyRule && buyRule) { DARABONBA_PTR_SET_RVALUE(buyRule_, buyRule) };
        ...
        inline Product& setCostIncludeRemark(string costIncludeRemark) { DARABONBA_PTR_SET_VALUE(costIncludeRemark_, costIncludeRemark) };
        ...
        inline Product& setDeliverGuaranteeMinutes(int32_t deliverGuaranteeMinutes) { DARABONBA_PTR_SET_VALUE(deliverGuaranteeMinutes_, deliverGuaranteeMinutes) };
        ...
        inline Product& setInvoiceIssuerType(int32_t invoiceIssuerType) { DARABONBA_PTR_SET_VALUE(invoiceIssuerType_, invoiceIssuerType) };
        ...
        inline Product& setPaymentLimitMinutes(int32_t paymentLimitMinutes) { DARABONBA_PTR_SET_VALUE(paymentLimitMinutes_, paymentLimitMinutes) };
        ...
        inline const Product::RefundRule & getRefundRule() const { DARABONBA_PTR_GET_CONST(refundRule_, Product::RefundRule) };
        inline Product::RefundRule getRefundRule() { DARABONBA_PTR_GET(refundRule_, Product::RefundRule) };
        inline Product& setRefundRule(const Product::RefundRule & refundRule) { DARABONBA_PTR_SET_VALUE(refundRule_, refundRule) };
        inline Product& setRefundRule(Product::RefundRule && refundRule) { DARABONBA_PTR_SET_RVALUE(refundRule_, refundRule) };


        // region Field Functions 
        bool hasRegion() const { return this->region_ != nullptr;};
        void deleteRegion() { this->region_ = nullptr;};
        inline const Product::Region & getRegion() const { DARABONBA_PTR_GET_CONST(region_, Product::Region) };
        inline Product::Region getRegion() { DARABONBA_PTR_GET(region_, Product::Region) };
        inline Product& setRegion(const Product::Region & region) { DARABONBA_PTR_SET_VALUE(region_, region) };
        inline Product& setRegion(Product::Region && region) { DARABONBA_PTR_SET_RVALUE(region_, region) };
        ...
        inline Product& setScenicId(int64_t scenicId) { DARABONBA_PTR_SET_VALUE(scenicId_, scenicId) };
        ...
        inline const Product::SellerAgent & getSellerAgent() const { DARABONBA_PTR_GET_CONST(sellerAgent_, Product::SellerAgent) };
        inline Product::SellerAgent getSellerAgent() { DARABONBA_PTR_GET(sellerAgent_, Product::SellerAgent) };
        inline Product& setSellerAgent(const Product::SellerAgent & sellerAgent) { DARABONBA_PTR_SET_VALUE(sellerAgent_, sellerAgent) };
        inline Product& setSellerAgent(Product::SellerAgent && sellerAgent) { DARABONBA_PTR_SET_RVALUE(sellerAgent_, sellerAgent) };


        // session Field Functions 
        bool hasSession() const { return this->session_ != nullptr;};
        void deleteSession() { this->session_ = nullptr;};
        inline const Product::Session & getSession() const { DARABONBA_PTR_GET_CONST(session_, Product::Session) };
        inline Product::Session getSession() { DARABONBA_PTR_GET(session_, Product::Session) };
        inline Product& setSession(const Product::Session & session) { DARABONBA_PTR_SET_VALUE(session_, session) };
        inline Product& setSession(Product::Session && session) { DARABONBA_PTR_SET_RVALUE(session_, session) };
        ...
        inline Product& setSettlePriceCalculateType(int32_t settlePriceCalculateType) { DARABONBA_PTR_SET_VALUE(settlePriceCalculateType_, settlePriceCalculateType) };


        // spu Field Functions 
        bool hasSpu() const { return this->spu_ != nullptr;};
        void deleteSpu() { this->spu_ = nullptr;};
        inline const Product::Spu & getSpu() const { DARABONBA_PTR_GET_CONST(spu_, Product::Spu) };
        inline Product::Spu getSpu() { DARABONBA_PTR_GET(spu_, Product::Spu) };
        inline Product& setSpu(const Product::Spu & spu) { DARABONBA_PTR_SET_VALUE(spu_, spu) };
        inline Product& setSpu(Product::Spu && spu) { DARABONBA_PTR_SET_RVALUE(spu_, spu) };
        ...
        inline const Product::TicketKind & getTicketKind() const { DARABONBA_PTR_GET_CONST(ticketKind_, Product::TicketKind) };
        inline Product::TicketKind getTicketKind() { DARABONBA_PTR_GET(ticketKind_, Product::TicketKind) };
        inline Product& setTicketKind(const Product::TicketKind & ticketKind) { DARABONBA_PTR_SET_VALUE(ticketKind_, ticketKind) };
        inline Product& setTicketKind(Product::TicketKind && ticketKind) { DARABONBA_PTR_SET_RVALUE(ticketKind_, ticketKind) };


        // useRule Field Functions 
        bool hasUseRule() const { return this->useRule_ != nullptr;};
        void deleteUseRule() { this->useRule_ = nullptr;};
        inline const Product::UseRule & getUseRule() const { DARABONBA_PTR_GET_CONST(useRule_, Product::UseRule) };
        inline Product::UseRule getUseRule() { DARABONBA_PTR_GET(useRule_, Product::UseRule) };
        inline Product& setUseRule(const Product::UseRule & useRule) { DARABONBA_PTR_SET_VALUE(useRule_, useRule) };
        inline Product& setUseRule(Product::UseRule && useRule) { DARABONBA_PTR_SET_RVALUE(useRule_, useRule) };


      protected:
        shared_ptr<int32_t> bookingType_ {};
        shared_ptr<Product::BuyRule> buyRule_ {};
        ...
        shared_ptr<Product::RefundRule> refundRule_ {};
        shared_ptr<Product::Region> region_ {};
        shared_ptr<int64_t> scenicId_ {};
        shared_ptr<Product::SellerAgent> sellerAgent_ {};
        shared_ptr<Product::Session> session_ {};
        shared_ptr<int32_t> settlePriceCalculateType_ {};
        shared_ptr<Product::Spu> spu_ {};
        shared_ptr<Product::TicketKind> ticketKind_ {};
        shared_ptr<Product::UseRule> useRule_ {};
      };
    ...
    inline const TicketQueryProductResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, TicketQueryProductResponseBody::Data) };
    inline TicketQueryProductResponseBody::Data getData() { DARABONBA_PTR_GET(data_, TicketQueryProductResponseBody::Data) };
    inline TicketQueryProductResponseBody& setData(const TicketQueryProductResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline TicketQueryProductResponseBody& setData(TicketQueryProductResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline TicketQueryProductResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline TicketQueryProductResponseBody& setErrorMsg(string errorMsg) { DARABONBA_PTR_SET_VALUE(errorMsg_, errorMsg) };
    ...
    inline TicketQueryProductResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline TicketQueryProductResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<TicketQueryProductResponseBody::Data> data_ {};
