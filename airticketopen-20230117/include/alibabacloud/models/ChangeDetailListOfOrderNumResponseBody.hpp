...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeDetailListOfOrderNumResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ChangeDetailListOfOrderNumResponseBodyData) };
    inline ChangeDetailListOfOrderNumResponseBodyData data() { DARABONBA_PTR_GET(data_, ChangeDetailListOfOrderNumResponseBodyData) };
    inline ChangeDetailListOfOrderNumResponseBody& setData(const ChangeDetailListOfOrderNumResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ChangeDetailListOfOrderNumResponseBody& setData(ChangeDetailListOfOrderNumResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ChangeDetailListOfOrderNumResponseBodyData> data_ = nullptr;
