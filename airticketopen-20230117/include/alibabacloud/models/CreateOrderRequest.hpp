...
namespace Models
{
  ...
  public:
    ...
    inline CreateOrderRequest& setAccountNo(int64_t accountNo) { DARABONBA_PTR_SET_VALUE(accountNo_, accountNo) };


    // contact Field Functions 
    bool hasContact() const { return this->contact_ != nullptr;};
    void deleteContact() { this->contact_ = nullptr;};
    inline const CreateOrderRequest::Contact & getContact() const { DARABONBA_PTR_GET_CONST(contact_, CreateOrderRequest::Contact) };
    inline CreateOrderRequest::Contact getContact() { DARABONBA_PTR_GET(contact_, CreateOrderRequest::Contact) };
    inline CreateOrderRequest& setContact(const CreateOrderRequest::Contact & contact) { DARABONBA_PTR_SET_VALUE(contact_, contact) };
    inline CreateOrderRequest& setContact(CreateOrderRequest::Contact && contact) { DARABONBA_PTR_SET_RVALUE(contact_, contact) };
    ...
    inline CreateOrderRequest& setExternalOrderNo(string externalOrderNo) { DARABONBA_PTR_SET_VALUE(externalOrderNo_, externalOrderNo) };


    // guests Field Functions 
    bool hasGuests() const { return this->guests_ != nullptr;};
    void deleteGuests() { this->guests_ = nullptr;};
    inline const vector<vector<CreateOrderRequest::Guests>> & getGuests() const { DARABONBA_PTR_GET_CONST(guests_, vector<vector<CreateOrderRequest::Guests>>) };
    inline vector<vector<CreateOrderRequest::Guests>> getGuests() { DARABONBA_PTR_GET(guests_, vector<vector<CreateOrderRequest::Guests>>) };
    inline CreateOrderRequest& setGuests(const vector<vector<CreateOrderRequest::Guests>> & guests) { DARABONBA_PTR_SET_VALUE(guests_, guests) };
    inline CreateOrderRequest& setGuests(vector<vector<CreateOrderRequest::Guests>> && guests) { DARABONBA_PTR_SET_RVALUE(guests_, guests) };
    ...
    inline CreateOrderRequest& setItemOfferId(string itemOfferId) { DARABONBA_PTR_SET_VALUE(itemOfferId_, itemOfferId) };
    ...
    inline CreateOrderRequest& setRoomCount(int32_t roomCount) { DARABONBA_PTR_SET_VALUE(roomCount_, roomCount) };
    ...
    void deleteTracerId() { this->tracerId_ = nullptr;};
    inline string getTracerId() const { DARABONBA_PTR_GET_DEFAULT(tracerId_, "") };
    inline CreateOrderRequest& setTracerId(string tracerId) { DARABONBA_PTR_SET_VALUE(tracerId_, tracerId) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<CreateOrderRequest::Contact> contact_ {};
    shared_ptr<string> externalOrderNo_ {};
    // This parameter is required.
    shared_ptr<vector<vector<CreateOrderRequest::Guests>>> guests_ {};
    // This parameter is required.
