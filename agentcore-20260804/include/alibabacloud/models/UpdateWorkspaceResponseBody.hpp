  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->authorizationStatus_ == nullptr
        && this->bucketName_ == nullptr && this->name_ == nullptr && this->networkConfiguration_ == nullptr && this->regionId_ == nullptr && this->status_ == nullptr
        && this->storageType_ == nullptr && this->tenantId_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline UpdateWorkspaceResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline UpdateWorkspaceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline UpdateWorkspaceResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UpdateWorkspaceResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
