...
#ifndef ALIBABACLOUD_MODELS_UPDATEMCPTEMPLATECONFIGREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEMCPTEMPLATECONFIGREQUEST_HPP_
...
namespace Models
{
  class UpdateMcpTemplateConfigRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateMcpTemplateConfigRequest& obj) { 
      DARABONBA_PTR_TO_JSON(body, body_);
      DARABONBA_PTR_TO_JSON(clientToken, clientToken_);
      DARABONBA_PTR_TO_JSON(templateVersion, templateVersion_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateMcpTemplateConfigRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(body, body_);
      DARABONBA_PTR_FROM_JSON(clientToken, clientToken_);
      DARABONBA_PTR_FROM_JSON(templateVersion, templateVersion_);
    };
    UpdateMcpTemplateConfigRequest() = default ;
    UpdateMcpTemplateConfigRequest(const UpdateMcpTemplateConfigRequest &) = default ;
    UpdateMcpTemplateConfigRequest(UpdateMcpTemplateConfigRequest &&) = default ;
    UpdateMcpTemplateConfigRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateMcpTemplateConfigRequest() = default ;
    UpdateMcpTemplateConfigRequest& operator=(const UpdateMcpTemplateConfigRequest &) = default ;
    UpdateMcpTemplateConfigRequest& operator=(UpdateMcpTemplateConfigRequest &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->addresses_ == nullptr
        && this->auth_ == nullptr && this->deploymentConfig_ == nullptr && this->description_ == nullptr && this->swaggerConfig_ == nullptr; };
    ...
    inline const UpdateMcpTemplateConfigRequest::Body & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateMcpTemplateConfigRequest::Body) };
    inline UpdateMcpTemplateConfigRequest::Body getBody() { DARABONBA_PTR_GET(body_, UpdateMcpTemplateConfigRequest::Body) };
    inline UpdateMcpTemplateConfigRequest& setBody(const UpdateMcpTemplateConfigRequest::Body & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline UpdateMcpTemplateConfigRequest& setBody(UpdateMcpTemplateConfigRequest::Body && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
    ...
    inline UpdateMcpTemplateConfigRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline UpdateMcpTemplateConfigRequest& setTemplateVersion(string templateVersion) { DARABONBA_PTR_SET_VALUE(templateVersion_, templateVersion) };
  ...
  protected:
    ...
    shared_ptr<UpdateMcpTemplateConfigRequest::Body> body_ {};
