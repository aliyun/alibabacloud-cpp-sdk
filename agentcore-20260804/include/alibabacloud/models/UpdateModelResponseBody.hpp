...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateModelResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateModelResponseBody::Data) };
    inline UpdateModelResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateModelResponseBody::Data) };
    inline UpdateModelResponseBody& setData(const UpdateModelResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateModelResponseBody& setData(UpdateModelResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UpdateModelResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
