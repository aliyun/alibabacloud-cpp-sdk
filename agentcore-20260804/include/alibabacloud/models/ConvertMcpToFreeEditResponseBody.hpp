...
#ifndef ALIBABACLOUD_MODELS_CONVERTMCPTOFREEEDITRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CONVERTMCPTOFREEEDITRESPONSEBODY_HPP_
...
namespace Models
{
  class ConvertMcpToFreeEditResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ConvertMcpToFreeEditResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ConvertMcpToFreeEditResponseBody& obj) { 
    ...
    ConvertMcpToFreeEditResponseBody() = default ;
    ConvertMcpToFreeEditResponseBody(const ConvertMcpToFreeEditResponseBody &) = default ;
    ConvertMcpToFreeEditResponseBody(ConvertMcpToFreeEditResponseBody &&) = default ;
    ConvertMcpToFreeEditResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ConvertMcpToFreeEditResponseBody() = default ;
    ConvertMcpToFreeEditResponseBody& operator=(const ConvertMcpToFreeEditResponseBody &) = default ;
    ConvertMcpToFreeEditResponseBody& operator=(ConvertMcpToFreeEditResponseBody &&) = default ;
    ...
    inline ConvertMcpToFreeEditResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ConvertMcpToFreeEditResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ConvertMcpToFreeEditResponseBody::Data) };
    inline ConvertMcpToFreeEditResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ConvertMcpToFreeEditResponseBody::Data) };
    inline ConvertMcpToFreeEditResponseBody& setData(const ConvertMcpToFreeEditResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ConvertMcpToFreeEditResponseBody& setData(ConvertMcpToFreeEditResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ConvertMcpToFreeEditResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ConvertMcpToFreeEditResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ConvertMcpToFreeEditResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ConvertMcpToFreeEditResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    // The response data.
    shared_ptr<ConvertMcpToFreeEditResponseBody::Data> data_ {};
