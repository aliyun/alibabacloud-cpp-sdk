  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->agents_ == nullptr
        && this->description_ == nullptr && this->name_ == nullptr && this->users_ == nullptr; };
    ...
    inline const CreateTeamRequest::Body & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTeamRequest::Body) };
    inline CreateTeamRequest::Body getBody() { DARABONBA_PTR_GET(body_, CreateTeamRequest::Body) };
    inline CreateTeamRequest& setBody(const CreateTeamRequest::Body & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline CreateTeamRequest& setBody(CreateTeamRequest::Body && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
