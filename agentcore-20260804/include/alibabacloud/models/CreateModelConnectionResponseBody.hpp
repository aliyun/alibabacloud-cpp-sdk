...
#ifndef ALIBABACLOUD_MODELS_CREATEMODELCONNECTIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEMODELCONNECTIONRESPONSEBODY_HPP_
...
namespace Models
{
  class CreateModelConnectionResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateModelConnectionResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateModelConnectionResponseBody& obj) { 
    ...
    CreateModelConnectionResponseBody() = default ;
    CreateModelConnectionResponseBody(const CreateModelConnectionResponseBody &) = default ;
    CreateModelConnectionResponseBody(CreateModelConnectionResponseBody &&) = default ;
    CreateModelConnectionResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateModelConnectionResponseBody() = default ;
    CreateModelConnectionResponseBody& operator=(const CreateModelConnectionResponseBody &) = default ;
    CreateModelConnectionResponseBody& operator=(CreateModelConnectionResponseBody &&) = default ;
    ...
    inline CreateModelConnectionResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateModelConnectionResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateModelConnectionResponseBody::Data) };
    inline CreateModelConnectionResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateModelConnectionResponseBody::Data) };
    inline CreateModelConnectionResponseBody& setData(const CreateModelConnectionResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateModelConnectionResponseBody& setData(CreateModelConnectionResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateModelConnectionResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline CreateModelConnectionResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateModelConnectionResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CreateModelConnectionResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<CreateModelConnectionResponseBody::Data> data_ {};
