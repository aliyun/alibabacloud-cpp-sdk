...
namespace Models
{
  ...
  public:
    ...
    inline DeleteUserResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DeleteUserResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteUserResponseBody::Data) };
    inline DeleteUserResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteUserResponseBody::Data) };
    inline DeleteUserResponseBody& setData(const DeleteUserResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteUserResponseBody& setData(DeleteUserResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DeleteUserResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
