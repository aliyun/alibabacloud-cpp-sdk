  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->addresses_ == nullptr
        && this->auth_ == nullptr && this->customTags_ == nullptr && this->deploymentConfig_ == nullptr && this->description_ == nullptr && this->swaggerConfig_ == nullptr; };
      ...
      inline const Body::DeploymentConfig & getDeploymentConfig() const { DARABONBA_PTR_GET_CONST(deploymentConfig_, Body::DeploymentConfig) };
      inline Body::DeploymentConfig getDeploymentConfig() { DARABONBA_PTR_GET(deploymentConfig_, Body::DeploymentConfig) };
      inline Body& setDeploymentConfig(const Body::DeploymentConfig & deploymentConfig) { DARABONBA_PTR_SET_VALUE(deploymentConfig_, deploymentConfig) };
      inline Body& setDeploymentConfig(Body::DeploymentConfig && deploymentConfig) { DARABONBA_PTR_SET_RVALUE(deploymentConfig_, deploymentConfig) };
