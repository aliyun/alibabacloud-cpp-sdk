...
#ifndef ALIBABACLOUD_MODELS_DELETEEXTERNALAGENTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DELETEEXTERNALAGENTRESPONSEBODY_HPP_
...
namespace Models
{
  class DeleteExternalAgentResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DeleteExternalAgentResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeleteExternalAgentResponseBody& obj) { 
    ...
    DeleteExternalAgentResponseBody() = default ;
    DeleteExternalAgentResponseBody(const DeleteExternalAgentResponseBody &) = default ;
    DeleteExternalAgentResponseBody(DeleteExternalAgentResponseBody &&) = default ;
    DeleteExternalAgentResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteExternalAgentResponseBody() = default ;
    DeleteExternalAgentResponseBody& operator=(const DeleteExternalAgentResponseBody &) = default ;
    DeleteExternalAgentResponseBody& operator=(DeleteExternalAgentResponseBody &&) = default ;
    ...
    inline DeleteExternalAgentResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DeleteExternalAgentResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteExternalAgentResponseBody::Data) };
    inline DeleteExternalAgentResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteExternalAgentResponseBody::Data) };
    inline DeleteExternalAgentResponseBody& setData(const DeleteExternalAgentResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteExternalAgentResponseBody& setData(DeleteExternalAgentResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DeleteExternalAgentResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline DeleteExternalAgentResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DeleteExternalAgentResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DeleteExternalAgentResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
