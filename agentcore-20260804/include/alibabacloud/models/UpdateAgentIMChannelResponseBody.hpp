...
#ifndef ALIBABACLOUD_MODELS_UPDATEAGENTIMCHANNELRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATEAGENTIMCHANNELRESPONSEBODY_HPP_
...
namespace Models
{
  class UpdateAgentIMChannelResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateAgentIMChannelResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateAgentIMChannelResponseBody& obj) { 
    ...
    UpdateAgentIMChannelResponseBody() = default ;
    UpdateAgentIMChannelResponseBody(const UpdateAgentIMChannelResponseBody &) = default ;
    UpdateAgentIMChannelResponseBody(UpdateAgentIMChannelResponseBody &&) = default ;
    UpdateAgentIMChannelResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateAgentIMChannelResponseBody() = default ;
    UpdateAgentIMChannelResponseBody& operator=(const UpdateAgentIMChannelResponseBody &) = default ;
    UpdateAgentIMChannelResponseBody& operator=(UpdateAgentIMChannelResponseBody &&) = default ;
    ...
    inline UpdateAgentIMChannelResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const UpdateAgentIMChannelResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateAgentIMChannelResponseBody::Data) };
    inline UpdateAgentIMChannelResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateAgentIMChannelResponseBody::Data) };
    inline UpdateAgentIMChannelResponseBody& setData(const UpdateAgentIMChannelResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateAgentIMChannelResponseBody& setData(UpdateAgentIMChannelResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UpdateAgentIMChannelResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline UpdateAgentIMChannelResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UpdateAgentIMChannelResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline UpdateAgentIMChannelResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
