...
#ifndef ALIBABACLOUD_MODELS_INSTALLMCPMARKETITEMRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_INSTALLMCPMARKETITEMRESPONSEBODY_HPP_
...
namespace Models
{
  class InstallMcpMarketItemResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const InstallMcpMarketItemResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, InstallMcpMarketItemResponseBody& obj) { 
    ...
    InstallMcpMarketItemResponseBody() = default ;
    InstallMcpMarketItemResponseBody(const InstallMcpMarketItemResponseBody &) = default ;
    InstallMcpMarketItemResponseBody(InstallMcpMarketItemResponseBody &&) = default ;
    InstallMcpMarketItemResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~InstallMcpMarketItemResponseBody() = default ;
    InstallMcpMarketItemResponseBody& operator=(const InstallMcpMarketItemResponseBody &) = default ;
    InstallMcpMarketItemResponseBody& operator=(InstallMcpMarketItemResponseBody &&) = default ;
    ...
    inline InstallMcpMarketItemResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const InstallMcpMarketItemResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, InstallMcpMarketItemResponseBody::Data) };
    inline InstallMcpMarketItemResponseBody::Data getData() { DARABONBA_PTR_GET(data_, InstallMcpMarketItemResponseBody::Data) };
    inline InstallMcpMarketItemResponseBody& setData(const InstallMcpMarketItemResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline InstallMcpMarketItemResponseBody& setData(InstallMcpMarketItemResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline InstallMcpMarketItemResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline InstallMcpMarketItemResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline InstallMcpMarketItemResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline InstallMcpMarketItemResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    // The response data.
    shared_ptr<InstallMcpMarketItemResponseBody::Data> data_ {};
