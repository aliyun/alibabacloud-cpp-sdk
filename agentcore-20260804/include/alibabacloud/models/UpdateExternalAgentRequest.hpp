...
#ifndef ALIBABACLOUD_MODELS_UPDATEEXTERNALAGENTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEEXTERNALAGENTREQUEST_HPP_
...
namespace Models
{
  class UpdateExternalAgentRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateExternalAgentRequest& obj) { 
      DARABONBA_PTR_TO_JSON(body, body_);
      DARABONBA_PTR_TO_JSON(clientToken, clientToken_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateExternalAgentRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(body, body_);
      DARABONBA_PTR_FROM_JSON(clientToken, clientToken_);
    };
    UpdateExternalAgentRequest() = default ;
    UpdateExternalAgentRequest(const UpdateExternalAgentRequest &) = default ;
    UpdateExternalAgentRequest(UpdateExternalAgentRequest &&) = default ;
    UpdateExternalAgentRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateExternalAgentRequest() = default ;
    UpdateExternalAgentRequest& operator=(const UpdateExternalAgentRequest &) = default ;
    UpdateExternalAgentRequest& operator=(UpdateExternalAgentRequest &&) = default ;
    ...
    inline const UpdateExternalAgentRequest::Body & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateExternalAgentRequest::Body) };
    inline UpdateExternalAgentRequest::Body getBody() { DARABONBA_PTR_GET(body_, UpdateExternalAgentRequest::Body) };
    inline UpdateExternalAgentRequest& setBody(const UpdateExternalAgentRequest::Body & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline UpdateExternalAgentRequest& setBody(UpdateExternalAgentRequest::Body && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
    ...
    inline UpdateExternalAgentRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };


  protected:
    // The request body.
    shared_ptr<UpdateExternalAgentRequest::Body> body_ {};
