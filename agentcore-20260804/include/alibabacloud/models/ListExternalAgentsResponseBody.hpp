...
#ifndef ALIBABACLOUD_MODELS_LISTEXTERNALAGENTSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTEXTERNALAGENTSRESPONSEBODY_HPP_
...
namespace Models
{
  class ListExternalAgentsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListExternalAgentsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListExternalAgentsResponseBody& obj) { 
    ...
    ListExternalAgentsResponseBody() = default ;
    ListExternalAgentsResponseBody(const ListExternalAgentsResponseBody &) = default ;
    ListExternalAgentsResponseBody(ListExternalAgentsResponseBody &&) = default ;
    ListExternalAgentsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListExternalAgentsResponseBody() = default ;
    ListExternalAgentsResponseBody& operator=(const ListExternalAgentsResponseBody &) = default ;
    ListExternalAgentsResponseBody& operator=(ListExternalAgentsResponseBody &&) = default ;
    ...
    inline ListExternalAgentsResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ListExternalAgentsResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };


    // items Field Functions 
    bool hasItems() const { return this->items_ != nullptr;};
    void deleteItems() { this->items_ = nullptr;};
    inline const vector<ListExternalAgentsResponseBody::Items> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<ListExternalAgentsResponseBody::Items>) };
    inline vector<ListExternalAgentsResponseBody::Items> getItems() { DARABONBA_PTR_GET(items_, vector<ListExternalAgentsResponseBody::Items>) };
    inline ListExternalAgentsResponseBody& setItems(const vector<ListExternalAgentsResponseBody::Items> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline ListExternalAgentsResponseBody& setItems(vector<ListExternalAgentsResponseBody::Items> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
    ...
    inline ListExternalAgentsResponseBody& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline ListExternalAgentsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListExternalAgentsResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ListExternalAgentsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListExternalAgentsResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline ListExternalAgentsResponseBody& setTotalCount(int64_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
  ...
  protected:
    ...
    shared_ptr<vector<ListExternalAgentsResponseBody::Items>> items_ {};
