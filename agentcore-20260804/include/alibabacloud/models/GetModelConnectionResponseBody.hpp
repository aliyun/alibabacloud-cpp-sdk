...
#ifndef ALIBABACLOUD_MODELS_GETMODELCONNECTIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETMODELCONNECTIONRESPONSEBODY_HPP_
...
namespace Models
{
  class GetModelConnectionResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetModelConnectionResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetModelConnectionResponseBody& obj) { 
    ...
    GetModelConnectionResponseBody() = default ;
    GetModelConnectionResponseBody(const GetModelConnectionResponseBody &) = default ;
    GetModelConnectionResponseBody(GetModelConnectionResponseBody &&) = default ;
    GetModelConnectionResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetModelConnectionResponseBody() = default ;
    GetModelConnectionResponseBody& operator=(const GetModelConnectionResponseBody &) = default ;
    GetModelConnectionResponseBody& operator=(GetModelConnectionResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->apiKeyCount_ == nullptr
        && this->apiKeys_ == nullptr && this->connectionId_ == nullptr && this->createdAt_ == nullptr && this->credentialConfigured_ == nullptr && this->description_ == nullptr
        && this->endpoint_ == nullptr && this->name_ == nullptr && this->protocol_ == nullptr && this->providerType_ == nullptr && this->regionId_ == nullptr
        && this->status_ == nullptr && this->statusReason_ == nullptr && this->updatedAt_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline GetModelConnectionResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetModelConnectionResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetModelConnectionResponseBody::Data) };
    inline GetModelConnectionResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetModelConnectionResponseBody::Data) };
    inline GetModelConnectionResponseBody& setData(const GetModelConnectionResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetModelConnectionResponseBody& setData(GetModelConnectionResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetModelConnectionResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline GetModelConnectionResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetModelConnectionResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetModelConnectionResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
