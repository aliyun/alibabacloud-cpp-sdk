...
namespace Models
{
  ...
  public:
    ...
    inline const ListSandboxesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSandboxesResponseBody) };
    inline ListSandboxesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSandboxesResponseBody) };
    inline ListSandboxesResponse& setBody(const ListSandboxesResponseBody & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline ListSandboxesResponse& setBody(ListSandboxesResponseBody && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<map<string, string>> headers_ {};
    shared_ptr<int32_t> statusCode_ {};
    shared_ptr<ListSandboxesResponseBody> body_ {};
  };
