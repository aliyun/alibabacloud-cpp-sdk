  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->agentCoreUserId_ == nullptr
        && this->authMethod_ == nullptr && this->createdAt_ == nullptr && this->displayName_ == nullptr && this->email_ == nullptr && this->initialPassword_ == nullptr
        && this->name_ == nullptr && this->note_ == nullptr && this->regionId_ == nullptr && this->status_ == nullptr && this->updatedAt_ == nullptr
      ...
      inline Data& setInitialPassword(string initialPassword) { DARABONBA_PTR_SET_VALUE(initialPassword_, initialPassword) };
