...
#ifndef ALIBABACLOUD_MODELS_GETAGENTIMCHANNELRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETAGENTIMCHANNELRESPONSEBODY_HPP_
...
namespace Models
{
  class GetAgentIMChannelResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetAgentIMChannelResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAgentIMChannelResponseBody& obj) { 
    ...
    GetAgentIMChannelResponseBody() = default ;
    GetAgentIMChannelResponseBody(const GetAgentIMChannelResponseBody &) = default ;
    GetAgentIMChannelResponseBody(GetAgentIMChannelResponseBody &&) = default ;
    GetAgentIMChannelResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAgentIMChannelResponseBody() = default ;
    GetAgentIMChannelResponseBody& operator=(const GetAgentIMChannelResponseBody &) = default ;
    GetAgentIMChannelResponseBody& operator=(GetAgentIMChannelResponseBody &&) = default ;
    ...
    inline GetAgentIMChannelResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetAgentIMChannelResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetAgentIMChannelResponseBody::Data) };
    inline GetAgentIMChannelResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetAgentIMChannelResponseBody::Data) };
    inline GetAgentIMChannelResponseBody& setData(const GetAgentIMChannelResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAgentIMChannelResponseBody& setData(GetAgentIMChannelResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetAgentIMChannelResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline GetAgentIMChannelResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetAgentIMChannelResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetAgentIMChannelResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    shared_ptr<GetAgentIMChannelResponseBody::Data> data_ {};
