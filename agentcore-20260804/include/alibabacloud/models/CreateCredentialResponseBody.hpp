...
namespace Models
{
  ...
  public:
    ...
    inline CreateCredentialResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateCredentialResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateCredentialResponseBody::Data) };
    inline CreateCredentialResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateCredentialResponseBody::Data) };
    inline CreateCredentialResponseBody& setData(const CreateCredentialResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateCredentialResponseBody& setData(CreateCredentialResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateCredentialResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline CreateCredentialResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateCredentialResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
