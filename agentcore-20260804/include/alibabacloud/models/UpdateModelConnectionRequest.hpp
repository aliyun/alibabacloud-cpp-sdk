...
#ifndef ALIBABACLOUD_MODELS_UPDATEMODELCONNECTIONREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEMODELCONNECTIONREQUEST_HPP_
...
namespace Models
{
  class UpdateModelConnectionRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateModelConnectionRequest& obj) { 
      DARABONBA_PTR_TO_JSON(body, body_);
      DARABONBA_PTR_TO_JSON(clientToken, clientToken_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateModelConnectionRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(body, body_);
      DARABONBA_PTR_FROM_JSON(clientToken, clientToken_);
    };
    UpdateModelConnectionRequest() = default ;
    UpdateModelConnectionRequest(const UpdateModelConnectionRequest &) = default ;
    UpdateModelConnectionRequest(UpdateModelConnectionRequest &&) = default ;
    UpdateModelConnectionRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateModelConnectionRequest() = default ;
    UpdateModelConnectionRequest& operator=(const UpdateModelConnectionRequest &) = default ;
    UpdateModelConnectionRequest& operator=(UpdateModelConnectionRequest &&) = default ;
    ...
    inline const UpdateModelConnectionRequest::Body & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateModelConnectionRequest::Body) };
    inline UpdateModelConnectionRequest::Body getBody() { DARABONBA_PTR_GET(body_, UpdateModelConnectionRequest::Body) };
    inline UpdateModelConnectionRequest& setBody(const UpdateModelConnectionRequest::Body & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline UpdateModelConnectionRequest& setBody(UpdateModelConnectionRequest::Body && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
    ...
    inline UpdateModelConnectionRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
