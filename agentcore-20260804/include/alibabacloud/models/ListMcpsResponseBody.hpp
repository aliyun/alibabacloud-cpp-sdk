  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->addresses_ == nullptr
        ...
        && this->endpoint_ == nullptr && this->functionName_ == nullptr && this->marketSource_ == nullptr && this->mcpServerId_ == nullptr && this->name_ == nullptr
        && this->officialTag_ == nullptr && this->protocol_ == nullptr && this->status_ == nullptr && this->statusReason_ == nullptr && this->swaggerConfig_ == nullptr
        && this->type_ == nullptr && this->updatedAt_ == nullptr && this->usageActive_ == nullptr; };
      ...
      inline Items& setCustomTags(const vector<string> & customTags) { DARABONBA_PTR_SET_VALUE(customTags_, customTags) };
      inline Items& setCustomTags(vector<string> && customTags) { DARABONBA_PTR_SET_RVALUE(customTags_, customTags) };
      ...
      inline const Items::DeploymentConfig & getDeploymentConfig() const { DARABONBA_PTR_GET_CONST(deploymentConfig_, Items::DeploymentConfig) };
      inline Items::DeploymentConfig getDeploymentConfig() { DARABONBA_PTR_GET(deploymentConfig_, Items::DeploymentConfig) };
      inline Items& setDeploymentConfig(const Items::DeploymentConfig & deploymentConfig) { DARABONBA_PTR_SET_VALUE(deploymentConfig_, deploymentConfig) };
      inline Items& setDeploymentConfig(Items::DeploymentConfig && deploymentConfig) { DARABONBA_PTR_SET_RVALUE(deploymentConfig_, deploymentConfig) };
      ...
      inline Items& setFunctionName(string functionName) { DARABONBA_PTR_SET_VALUE(functionName_, functionName) };
      ...
      inline const Items::MarketSource & getMarketSource() const { DARABONBA_PTR_GET_CONST(marketSource_, Items::MarketSource) };
      inline Items::MarketSource getMarketSource() { DARABONBA_PTR_GET(marketSource_, Items::MarketSource) };
      inline Items& setMarketSource(const Items::MarketSource & marketSource) { DARABONBA_PTR_SET_VALUE(marketSource_, marketSource) };
      inline Items& setMarketSource(Items::MarketSource && marketSource) { DARABONBA_PTR_SET_RVALUE(marketSource_, marketSource) };
      ...
      inline Items& setUsageActive(bool usageActive) { DARABONBA_PTR_SET_VALUE(usageActive_, usageActive) };
    ...
    protected:
      ...
      shared_ptr<Items::DeploymentConfig> deploymentConfig_ {};
      // The description.
      shared_ptr<string> description_ {};
      ...
      shared_ptr<Items::MarketSource> marketSource_ {};
      // The MCP service ID.
