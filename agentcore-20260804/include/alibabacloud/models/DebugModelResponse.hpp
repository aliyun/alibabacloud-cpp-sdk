...
namespace Models
{
  ...
  public:
    ...
    inline const DebugModelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DebugModelResponseBody) };
    inline DebugModelResponseBody getBody() { DARABONBA_PTR_GET(body_, DebugModelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DebugModelResponseBody> body_ {};
  };
