...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->capabilities_ == nullptr
        ...
        && this->modelId_ == nullptr && this->modelName_ == nullptr && this->regionId_ == nullptr && this->updatedAt_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline GetModelResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetModelResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetModelResponseBody::Data) };
    inline GetModelResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetModelResponseBody::Data) };
    inline GetModelResponseBody& setData(const GetModelResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetModelResponseBody& setData(GetModelResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetModelResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline GetModelResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetModelResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    // The model details.
    shared_ptr<GetModelResponseBody::Data> data_ {};
