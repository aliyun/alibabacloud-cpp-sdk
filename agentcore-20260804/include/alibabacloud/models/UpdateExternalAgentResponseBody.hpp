...
#ifndef ALIBABACLOUD_MODELS_UPDATEEXTERNALAGENTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATEEXTERNALAGENTRESPONSEBODY_HPP_
...
namespace Models
{
  class UpdateExternalAgentResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateExternalAgentResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateExternalAgentResponseBody& obj) { 
    ...
    UpdateExternalAgentResponseBody() = default ;
    UpdateExternalAgentResponseBody(const UpdateExternalAgentResponseBody &) = default ;
    UpdateExternalAgentResponseBody(UpdateExternalAgentResponseBody &&) = default ;
    UpdateExternalAgentResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateExternalAgentResponseBody() = default ;
    UpdateExternalAgentResponseBody& operator=(const UpdateExternalAgentResponseBody &) = default ;
    UpdateExternalAgentResponseBody& operator=(UpdateExternalAgentResponseBody &&) = default ;
    ...
    inline UpdateExternalAgentResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const UpdateExternalAgentResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateExternalAgentResponseBody::Data) };
    inline UpdateExternalAgentResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateExternalAgentResponseBody::Data) };
    inline UpdateExternalAgentResponseBody& setData(const UpdateExternalAgentResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateExternalAgentResponseBody& setData(UpdateExternalAgentResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UpdateExternalAgentResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline UpdateExternalAgentResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UpdateExternalAgentResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline UpdateExternalAgentResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
