...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMcpRequest::Body & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMcpRequest::Body) };
    inline CreateMcpRequest::Body getBody() { DARABONBA_PTR_GET(body_, CreateMcpRequest::Body) };
    inline CreateMcpRequest& setBody(const CreateMcpRequest::Body & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline CreateMcpRequest& setBody(CreateMcpRequest::Body && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
