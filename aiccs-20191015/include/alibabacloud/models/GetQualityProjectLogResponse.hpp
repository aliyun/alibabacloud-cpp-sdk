...
namespace Models
{
  ...
  public:
    ...
    inline const GetQualityProjectLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetQualityProjectLogResponseBody) };
    inline GetQualityProjectLogResponseBody getBody() { DARABONBA_PTR_GET(body_, GetQualityProjectLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetQualityProjectLogResponseBody> body_ {};
  };
