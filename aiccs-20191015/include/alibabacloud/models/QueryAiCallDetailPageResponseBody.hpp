...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAiCallDetailPageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryAiCallDetailPageResponseBodyData) };
    inline QueryAiCallDetailPageResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryAiCallDetailPageResponseBodyData) };
    inline QueryAiCallDetailPageResponseBody& setData(const QueryAiCallDetailPageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryAiCallDetailPageResponseBody& setData(QueryAiCallDetailPageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryAiCallDetailPageResponseBodyData> data_ = nullptr;
