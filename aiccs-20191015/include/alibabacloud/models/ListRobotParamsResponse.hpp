...
namespace Models
{
  ...
  public:
    ...
    inline const ListRobotParamsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRobotParamsResponseBody) };
    inline ListRobotParamsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRobotParamsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRobotParamsResponseBody> body_ {};
  };
