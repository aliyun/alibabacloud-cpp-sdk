...
#ifndef ALIBABACLOUD_MODELS_GETSKILLGROUPAGENTSTATUSDETAILSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETSKILLGROUPAGENTSTATUSDETAILSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSkillGroupAgentStatusDetailsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSkillGroupAgentStatusDetailsRequest& obj) { 
    ...
    GetSkillGroupAgentStatusDetailsRequest() = default ;
    GetSkillGroupAgentStatusDetailsRequest(const GetSkillGroupAgentStatusDetailsRequest &) = default ;
    GetSkillGroupAgentStatusDetailsRequest(GetSkillGroupAgentStatusDetailsRequest &&) = default ;
    GetSkillGroupAgentStatusDetailsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSkillGroupAgentStatusDetailsRequest() = default ;
    GetSkillGroupAgentStatusDetailsRequest& operator=(const GetSkillGroupAgentStatusDetailsRequest &) = default ;
    GetSkillGroupAgentStatusDetailsRequest& operator=(GetSkillGroupAgentStatusDetailsRequest &&) = default ;
    ...
    inline GetSkillGroupAgentStatusDetailsRequest& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline GetSkillGroupAgentStatusDetailsRequest& setDepIds(const vector<int64_t> & depIds) { DARABONBA_PTR_SET_VALUE(depIds_, depIds) };
    inline GetSkillGroupAgentStatusDetailsRequest& setDepIds(vector<int64_t> && depIds) { DARABONBA_PTR_SET_RVALUE(depIds_, depIds) };
    ...
    inline GetSkillGroupAgentStatusDetailsRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetSkillGroupAgentStatusDetailsRequest& setExistDepartmentGrouping(bool existDepartmentGrouping) { DARABONBA_PTR_SET_VALUE(existDepartmentGrouping_, existDepartmentGrouping) };
    ...
    inline GetSkillGroupAgentStatusDetailsRequest& setExistSkillGroupGrouping(bool existSkillGroupGrouping) { DARABONBA_PTR_SET_VALUE(existSkillGroupGrouping_, existSkillGroupGrouping) };
    ...
    inline GetSkillGroupAgentStatusDetailsRequest& setGroupIds(const vector<int64_t> & groupIds) { DARABONBA_PTR_SET_VALUE(groupIds_, groupIds) };
    inline GetSkillGroupAgentStatusDetailsRequest& setGroupIds(vector<int64_t> && groupIds) { DARABONBA_PTR_SET_RVALUE(groupIds_, groupIds) };
    ...
    inline GetSkillGroupAgentStatusDetailsRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetSkillGroupAgentStatusDetailsRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetSkillGroupAgentStatusDetailsRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
