...
namespace Models
{
  ...
  public:
    ...
    inline const GetAgentByIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAgentByIdResponseBody) };
    inline GetAgentByIdResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAgentByIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAgentByIdResponseBody> body_ {};
  };
