...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveAgentFromSkillGroupResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, RemoveAgentFromSkillGroupResponseBodyData) };
    inline RemoveAgentFromSkillGroupResponseBodyData data() { DARABONBA_PTR_GET(data_, RemoveAgentFromSkillGroupResponseBodyData) };
    inline RemoveAgentFromSkillGroupResponseBody& setData(const RemoveAgentFromSkillGroupResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RemoveAgentFromSkillGroupResponseBody& setData(RemoveAgentFromSkillGroupResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<RemoveAgentFromSkillGroupResponseBodyData> data_ = nullptr;
