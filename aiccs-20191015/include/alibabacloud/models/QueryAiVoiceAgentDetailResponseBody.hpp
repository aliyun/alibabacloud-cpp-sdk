...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAiVoiceAgentDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryAiVoiceAgentDetailResponseBodyData) };
    inline QueryAiVoiceAgentDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryAiVoiceAgentDetailResponseBodyData) };
    inline QueryAiVoiceAgentDetailResponseBody& setData(const QueryAiVoiceAgentDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryAiVoiceAgentDetailResponseBody& setData(QueryAiVoiceAgentDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryAiVoiceAgentDetailResponseBodyData> data_ = nullptr;
