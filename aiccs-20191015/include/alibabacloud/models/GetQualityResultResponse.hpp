...
namespace Models
{
  ...
  public:
    ...
    inline const GetQualityResultResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetQualityResultResponseBody) };
    inline GetQualityResultResponseBody body() { DARABONBA_PTR_GET(body_, GetQualityResultResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetQualityResultResponseBody> body_ = nullptr;
  };
