...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->encryptionType_ == nullptr
        ...
        && this->resourceOwnerId_ == nullptr && this->taskId_ == nullptr && this->variablesShrink_ == nullptr; };
    ...
    inline ImportOneTaskPhoneNumberShrinkRequest& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
