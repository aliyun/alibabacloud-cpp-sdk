...
namespace Models
{
  ...
  public:
    ...
    inline const GetQualityProjectListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetQualityProjectListResponseBody) };
    inline GetQualityProjectListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetQualityProjectListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetQualityProjectListResponseBody> body_ {};
  };
