...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->resultData_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const QueryTouchListResponseBodyResultData & resultData() const { DARABONBA_PTR_GET_CONST(resultData_, QueryTouchListResponseBodyResultData) };
    inline QueryTouchListResponseBodyResultData resultData() { DARABONBA_PTR_GET(resultData_, QueryTouchListResponseBodyResultData) };
    inline QueryTouchListResponseBody& setResultData(const QueryTouchListResponseBodyResultData & resultData) { DARABONBA_PTR_SET_VALUE(resultData_, resultData) };
    inline QueryTouchListResponseBody& setResultData(QueryTouchListResponseBodyResultData && resultData) { DARABONBA_PTR_SET_RVALUE(resultData_, resultData) };
  ...
  protected:
    ...
    std::shared_ptr<QueryTouchListResponseBodyResultData> resultData_ = nullptr;
