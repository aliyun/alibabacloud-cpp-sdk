...
namespace Models
{
  ...
  public:
    ...
    inline const ListChatRecordDetailResponseBodyResultData & resultData() const { DARABONBA_PTR_GET_CONST(resultData_, ListChatRecordDetailResponseBodyResultData) };
    inline ListChatRecordDetailResponseBodyResultData resultData() { DARABONBA_PTR_GET(resultData_, ListChatRecordDetailResponseBodyResultData) };
    inline ListChatRecordDetailResponseBody& setResultData(const ListChatRecordDetailResponseBodyResultData & resultData) { DARABONBA_PTR_SET_VALUE(resultData_, resultData) };
    inline ListChatRecordDetailResponseBody& setResultData(ListChatRecordDetailResponseBodyResultData && resultData) { DARABONBA_PTR_SET_RVALUE(resultData_, resultData) };
  ...
  protected:
    ...
    std::shared_ptr<ListChatRecordDetailResponseBodyResultData> resultData_ = nullptr;
