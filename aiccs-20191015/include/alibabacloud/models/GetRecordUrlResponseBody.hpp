...
namespace Models
{
  ...
  public:
    ...
    inline const GetRecordUrlResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRecordUrlResponseBodyData) };
    inline GetRecordUrlResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRecordUrlResponseBodyData) };
    inline GetRecordUrlResponseBody& setData(const GetRecordUrlResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRecordUrlResponseBody& setData(GetRecordUrlResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<GetRecordUrlResponseBodyData> data_ = nullptr;
