...
#include <alibabacloud/models/GetOutbounNumListResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetOutbounNumListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetOutbounNumListResponseBodyData) };
    inline GetOutbounNumListResponseBodyData data() { DARABONBA_PTR_GET(data_, GetOutbounNumListResponseBodyData) };
    inline GetOutbounNumListResponseBody& setData(const GetOutbounNumListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetOutbounNumListResponseBody& setData(GetOutbounNumListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetOutbounNumListResponseBodyData> data_ = nullptr;
