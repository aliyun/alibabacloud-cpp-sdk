...
namespace Models
{
  ...
  public:
    ...
    inline const GetSkillGroupServiceStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSkillGroupServiceStatusResponseBody) };
    inline GetSkillGroupServiceStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSkillGroupServiceStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSkillGroupServiceStatusResponseBody> body_ {};
  };
