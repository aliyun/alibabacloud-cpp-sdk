...
namespace Models
{
  ...
  public:
    ...
    inline const GetSkillGroupStatusTotalResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSkillGroupStatusTotalResponseBody) };
    inline GetSkillGroupStatusTotalResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSkillGroupStatusTotalResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSkillGroupStatusTotalResponseBody> body_ {};
  };
