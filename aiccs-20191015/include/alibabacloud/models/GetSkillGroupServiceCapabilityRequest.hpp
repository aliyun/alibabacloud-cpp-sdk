...
#ifndef ALIBABACLOUD_MODELS_GETSKILLGROUPSERVICECAPABILITYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETSKILLGROUPSERVICECAPABILITYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSkillGroupServiceCapabilityRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSkillGroupServiceCapabilityRequest& obj) { 
    ...
    GetSkillGroupServiceCapabilityRequest() = default ;
    GetSkillGroupServiceCapabilityRequest(const GetSkillGroupServiceCapabilityRequest &) = default ;
    GetSkillGroupServiceCapabilityRequest(GetSkillGroupServiceCapabilityRequest &&) = default ;
    GetSkillGroupServiceCapabilityRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSkillGroupServiceCapabilityRequest() = default ;
    GetSkillGroupServiceCapabilityRequest& operator=(const GetSkillGroupServiceCapabilityRequest &) = default ;
    GetSkillGroupServiceCapabilityRequest& operator=(GetSkillGroupServiceCapabilityRequest &&) = default ;
