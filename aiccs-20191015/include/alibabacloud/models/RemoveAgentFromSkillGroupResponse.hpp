...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveAgentFromSkillGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveAgentFromSkillGroupResponseBody) };
    inline RemoveAgentFromSkillGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveAgentFromSkillGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveAgentFromSkillGroupResponseBody> body_ {};
  };
