...
namespace Models
{
  ...
  public:
    ...
    inline const GetOnlineServiceVolumeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOnlineServiceVolumeResponseBody) };
    inline GetOnlineServiceVolumeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOnlineServiceVolumeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOnlineServiceVolumeResponseBody> body_ {};
  };
