...
namespace Models
{
  ...
  public:
    ...
    inline CreateAiCallTaskRequest& setLineEncoding(string lineEncoding) { DARABONBA_PTR_SET_VALUE(lineEncoding_, lineEncoding) };
    ...
    inline CreateAiCallTaskRequest& setLinePhoneNum(string linePhoneNum) { DARABONBA_PTR_SET_VALUE(linePhoneNum_, linePhoneNum) };
    ...
    inline CreateAiCallTaskRequest& setPhoneType(int64_t phoneType) { DARABONBA_PTR_SET_VALUE(phoneType_, phoneType) };
    ...
    inline CreateAiCallTaskRequest& setSource(int64_t source) { DARABONBA_PTR_SET_VALUE(source_, source) };
