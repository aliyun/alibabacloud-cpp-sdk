...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListSkillGroupResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListSkillGroupResponseBodyData>) };
    inline vector<ListSkillGroupResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListSkillGroupResponseBodyData>) };
    inline ListSkillGroupResponseBody& setData(const vector<ListSkillGroupResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListSkillGroupResponseBody& setData(vector<ListSkillGroupResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListSkillGroupResponseBodyData>> data_ = nullptr;
