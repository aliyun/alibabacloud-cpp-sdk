...
namespace Models
{
  ...
  public:
    ...
    inline const CreateThirdSsoAgentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateThirdSsoAgentResponseBody) };
    inline CreateThirdSsoAgentResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateThirdSsoAgentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateThirdSsoAgentResponseBody> body_ {};
  };
