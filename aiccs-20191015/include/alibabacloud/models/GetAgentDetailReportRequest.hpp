...
#ifndef ALIBABACLOUD_MODELS_GETAGENTDETAILREPORTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETAGENTDETAILREPORTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAgentDetailReportRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAgentDetailReportRequest& obj) { 
    ...
    GetAgentDetailReportRequest() = default ;
    GetAgentDetailReportRequest(const GetAgentDetailReportRequest &) = default ;
    GetAgentDetailReportRequest(GetAgentDetailReportRequest &&) = default ;
    GetAgentDetailReportRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAgentDetailReportRequest() = default ;
    GetAgentDetailReportRequest& operator=(const GetAgentDetailReportRequest &) = default ;
    GetAgentDetailReportRequest& operator=(GetAgentDetailReportRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->agentIds_ == nullptr
        && return this->currentPage_ == nullptr && return this->depIds_ == nullptr && return this->endDate_ == nullptr && return this->existAgentGrouping_ == nullptr && return this->existDepartmentGrouping_ == nullptr
    ...
    inline GetAgentDetailReportRequest& setAgentIds(const vector<int64_t> & agentIds) { DARABONBA_PTR_SET_VALUE(agentIds_, agentIds) };
    inline GetAgentDetailReportRequest& setAgentIds(vector<int64_t> && agentIds) { DARABONBA_PTR_SET_RVALUE(agentIds_, agentIds) };
    ...
    inline GetAgentDetailReportRequest& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline GetAgentDetailReportRequest& setDepIds(const vector<int64_t> & depIds) { DARABONBA_PTR_SET_VALUE(depIds_, depIds) };
    inline GetAgentDetailReportRequest& setDepIds(vector<int64_t> && depIds) { DARABONBA_PTR_SET_RVALUE(depIds_, depIds) };
    ...
    inline GetAgentDetailReportRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetAgentDetailReportRequest& setExistAgentGrouping(bool existAgentGrouping) { DARABONBA_PTR_SET_VALUE(existAgentGrouping_, existAgentGrouping) };
    ...
    inline GetAgentDetailReportRequest& setExistDepartmentGrouping(bool existDepartmentGrouping) { DARABONBA_PTR_SET_VALUE(existDepartmentGrouping_, existDepartmentGrouping) };
    ...
    inline GetAgentDetailReportRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetAgentDetailReportRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetAgentDetailReportRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
    ...
    inline GetAgentDetailReportRequest& setTimeLatitudeType(string timeLatitudeType) { DARABONBA_PTR_SET_VALUE(timeLatitudeType_, timeLatitudeType) };
