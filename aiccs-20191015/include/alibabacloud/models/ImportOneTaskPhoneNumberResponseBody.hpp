...
namespace Models
{
  ...
  public:
    ...
    inline const ImportOneTaskPhoneNumberResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ImportOneTaskPhoneNumberResponseBodyData) };
    inline ImportOneTaskPhoneNumberResponseBodyData data() { DARABONBA_PTR_GET(data_, ImportOneTaskPhoneNumberResponseBodyData) };
    inline ImportOneTaskPhoneNumberResponseBody& setData(const ImportOneTaskPhoneNumberResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ImportOneTaskPhoneNumberResponseBody& setData(ImportOneTaskPhoneNumberResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ImportOneTaskPhoneNumberResponseBodyData> data_ = nullptr;
