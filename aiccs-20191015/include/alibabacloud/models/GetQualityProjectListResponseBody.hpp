...
namespace Models
{
  ...
  public:
    ...
    inline const GetQualityProjectListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQualityProjectListResponseBodyData) };
    inline GetQualityProjectListResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQualityProjectListResponseBodyData) };
    inline GetQualityProjectListResponseBody& setData(const GetQualityProjectListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQualityProjectListResponseBody& setData(GetQualityProjectListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetQualityProjectListResponseBodyData> data_ = nullptr;
