...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountId_ == nullptr
        && return this->accountName_ == nullptr && return this->clientId_ == nullptr && return this->clientToken_ == nullptr && return this->displayName_ == nullptr && return this->instanceId_ == nullptr
        && return this->roleIds_ == nullptr && return this->skillGroupIds_ == nullptr; };
    ...
    inline const vector<int64_t> & roleIds() const { DARABONBA_PTR_GET_CONST(roleIds_, vector<int64_t>) };
    inline vector<int64_t> roleIds() { DARABONBA_PTR_GET(roleIds_, vector<int64_t>) };
    ...
    inline const vector<int64_t> & skillGroupIds() const { DARABONBA_PTR_GET_CONST(skillGroupIds_, vector<int64_t>) };
    inline vector<int64_t> skillGroupIds() { DARABONBA_PTR_GET(skillGroupIds_, vector<int64_t>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<int64_t>> roleIds_ = nullptr;
    std::shared_ptr<vector<int64_t>> skillGroupIds_ = nullptr;
  };
