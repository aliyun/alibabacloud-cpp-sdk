...
namespace Models
{
  ...
  public:
    ...
    inline const QueryOutboundTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryOutboundTaskResponseBodyData) };
    inline QueryOutboundTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryOutboundTaskResponseBodyData) };
    inline QueryOutboundTaskResponseBody& setData(const QueryOutboundTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryOutboundTaskResponseBody& setData(QueryOutboundTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryOutboundTaskResponseBodyData> data_ = nullptr;
