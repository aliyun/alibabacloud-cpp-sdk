...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->batchId_ == nullptr
        && return this->detailIdListShrink_ == nullptr && return this->ownerId_ == nullptr && return this->phoneNumbersShrink_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr
    ...
    inline string detailIdListShrink() const { DARABONBA_PTR_GET_DEFAULT(detailIdListShrink_, "") };
    ...
    inline string phoneNumbersShrink() const { DARABONBA_PTR_GET_DEFAULT(phoneNumbersShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> detailIdListShrink_ = nullptr;
    std::shared_ptr<int64_t> ownerId_ = nullptr;
    std::shared_ptr<string> phoneNumbersShrink_ = nullptr;
