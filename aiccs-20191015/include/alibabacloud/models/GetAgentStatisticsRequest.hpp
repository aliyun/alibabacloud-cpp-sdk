...
#ifndef ALIBABACLOUD_MODELS_GETAGENTSTATISTICSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETAGENTSTATISTICSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAgentStatisticsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAgentStatisticsRequest& obj) { 
    ...
    GetAgentStatisticsRequest() = default ;
    GetAgentStatisticsRequest(const GetAgentStatisticsRequest &) = default ;
    GetAgentStatisticsRequest(GetAgentStatisticsRequest &&) = default ;
    GetAgentStatisticsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAgentStatisticsRequest() = default ;
    GetAgentStatisticsRequest& operator=(const GetAgentStatisticsRequest &) = default ;
    GetAgentStatisticsRequest& operator=(GetAgentStatisticsRequest &&) = default ;
    ...
    inline GetAgentStatisticsRequest& setAgentIds(const vector<int64_t> & agentIds) { DARABONBA_PTR_SET_VALUE(agentIds_, agentIds) };
    inline GetAgentStatisticsRequest& setAgentIds(vector<int64_t> && agentIds) { DARABONBA_PTR_SET_RVALUE(agentIds_, agentIds) };
    ...
    inline GetAgentStatisticsRequest& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline GetAgentStatisticsRequest& setDepIds(const vector<int64_t> & depIds) { DARABONBA_PTR_SET_VALUE(depIds_, depIds) };
    inline GetAgentStatisticsRequest& setDepIds(vector<int64_t> && depIds) { DARABONBA_PTR_SET_RVALUE(depIds_, depIds) };
    ...
    inline GetAgentStatisticsRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetAgentStatisticsRequest& setExistAgentGrouping(bool existAgentGrouping) { DARABONBA_PTR_SET_VALUE(existAgentGrouping_, existAgentGrouping) };
    ...
    inline GetAgentStatisticsRequest& setExistDepartmentGrouping(bool existDepartmentGrouping) { DARABONBA_PTR_SET_VALUE(existDepartmentGrouping_, existDepartmentGrouping) };
    ...
    inline GetAgentStatisticsRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetAgentStatisticsRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetAgentStatisticsRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
    ...
    inline GetAgentStatisticsRequest& setTimeLatitudeType(string timeLatitudeType) { DARABONBA_PTR_SET_VALUE(timeLatitudeType_, timeLatitudeType) };
