...
namespace Models
{
  ...
  public:
    ...
    inline const GetAiOutboundTaskBizDataResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAiOutboundTaskBizDataResponseBodyData) };
    inline GetAiOutboundTaskBizDataResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAiOutboundTaskBizDataResponseBodyData) };
    inline GetAiOutboundTaskBizDataResponseBody& setData(const GetAiOutboundTaskBizDataResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAiOutboundTaskBizDataResponseBody& setData(GetAiOutboundTaskBizDataResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAiOutboundTaskBizDataResponseBodyData> data_ = nullptr;
