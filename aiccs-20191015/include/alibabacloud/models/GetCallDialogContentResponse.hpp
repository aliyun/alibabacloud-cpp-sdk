...
namespace Models
{
  ...
  public:
    ...
    inline const GetCallDialogContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCallDialogContentResponseBody) };
    inline GetCallDialogContentResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCallDialogContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCallDialogContentResponseBody> body_ {};
  };
