...
#ifndef ALIBABACLOUD_MODELS_GETONLINESERVICEVOLUMEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETONLINESERVICEVOLUMEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetOnlineServiceVolumeRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetOnlineServiceVolumeRequest& obj) { 
    ...
    GetOnlineServiceVolumeRequest() = default ;
    GetOnlineServiceVolumeRequest(const GetOnlineServiceVolumeRequest &) = default ;
    GetOnlineServiceVolumeRequest(GetOnlineServiceVolumeRequest &&) = default ;
    GetOnlineServiceVolumeRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetOnlineServiceVolumeRequest() = default ;
    GetOnlineServiceVolumeRequest& operator=(const GetOnlineServiceVolumeRequest &) = default ;
    GetOnlineServiceVolumeRequest& operator=(GetOnlineServiceVolumeRequest &&) = default ;
    ...
    inline GetOnlineServiceVolumeRequest& setAgentIds(const vector<int64_t> & agentIds) { DARABONBA_PTR_SET_VALUE(agentIds_, agentIds) };
    inline GetOnlineServiceVolumeRequest& setAgentIds(vector<int64_t> && agentIds) { DARABONBA_PTR_SET_RVALUE(agentIds_, agentIds) };
    ...
    inline GetOnlineServiceVolumeRequest& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline GetOnlineServiceVolumeRequest& setDepIds(const vector<int64_t> & depIds) { DARABONBA_PTR_SET_VALUE(depIds_, depIds) };
    inline GetOnlineServiceVolumeRequest& setDepIds(vector<int64_t> && depIds) { DARABONBA_PTR_SET_RVALUE(depIds_, depIds) };
    ...
    inline GetOnlineServiceVolumeRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetOnlineServiceVolumeRequest& setExistAgentGrouping(bool existAgentGrouping) { DARABONBA_PTR_SET_VALUE(existAgentGrouping_, existAgentGrouping) };
    ...
    inline GetOnlineServiceVolumeRequest& setExistDepartmentGrouping(bool existDepartmentGrouping) { DARABONBA_PTR_SET_VALUE(existDepartmentGrouping_, existDepartmentGrouping) };
    ...
    inline GetOnlineServiceVolumeRequest& setExistSkillGroupGrouping(bool existSkillGroupGrouping) { DARABONBA_PTR_SET_VALUE(existSkillGroupGrouping_, existSkillGroupGrouping) };
    ...
    inline GetOnlineServiceVolumeRequest& setGroupIds(const vector<int64_t> & groupIds) { DARABONBA_PTR_SET_VALUE(groupIds_, groupIds) };
    inline GetOnlineServiceVolumeRequest& setGroupIds(vector<int64_t> && groupIds) { DARABONBA_PTR_SET_RVALUE(groupIds_, groupIds) };
    ...
    inline GetOnlineServiceVolumeRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetOnlineServiceVolumeRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetOnlineServiceVolumeRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
    ...
    inline GetOnlineServiceVolumeRequest& setTimeLatitudeType(string timeLatitudeType) { DARABONBA_PTR_SET_VALUE(timeLatitudeType_, timeLatitudeType) };
