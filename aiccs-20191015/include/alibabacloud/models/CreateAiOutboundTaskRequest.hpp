...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->concurrentRate_ == nullptr
        ...
        && return this->name_ == nullptr && return this->numRepeated_ == nullptr && return this->outboundNums_ == nullptr && return this->recallRule_ == nullptr && return this->type_ == nullptr; };
    ...
    inline const CreateAiOutboundTaskRequestRecallRule & recallRule() const { DARABONBA_PTR_GET_CONST(recallRule_, CreateAiOutboundTaskRequestRecallRule) };
    inline CreateAiOutboundTaskRequestRecallRule recallRule() { DARABONBA_PTR_GET(recallRule_, CreateAiOutboundTaskRequestRecallRule) };
    inline CreateAiOutboundTaskRequest& setRecallRule(const CreateAiOutboundTaskRequestRecallRule & recallRule) { DARABONBA_PTR_SET_VALUE(recallRule_, recallRule) };
    inline CreateAiOutboundTaskRequest& setRecallRule(CreateAiOutboundTaskRequestRecallRule && recallRule) { DARABONBA_PTR_SET_RVALUE(recallRule_, recallRule) };
  ...
  protected:
    ...
    std::shared_ptr<CreateAiOutboundTaskRequestRecallRule> recallRule_ = nullptr;
    // This parameter is required.
