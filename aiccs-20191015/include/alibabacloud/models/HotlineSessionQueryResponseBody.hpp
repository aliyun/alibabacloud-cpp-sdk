...
namespace Models
{
  ...
  public:
    ...
    inline const HotlineSessionQueryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, HotlineSessionQueryResponseBodyData) };
    inline HotlineSessionQueryResponseBodyData data() { DARABONBA_PTR_GET(data_, HotlineSessionQueryResponseBodyData) };
    inline HotlineSessionQueryResponseBody& setData(const HotlineSessionQueryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline HotlineSessionQueryResponseBody& setData(HotlineSessionQueryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<HotlineSessionQueryResponseBodyData> data_ = nullptr;
