...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetQualityRuleTagListResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetQualityRuleTagListResponseBodyData>) };
    inline vector<GetQualityRuleTagListResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetQualityRuleTagListResponseBodyData>) };
    inline GetQualityRuleTagListResponseBody& setData(const vector<GetQualityRuleTagListResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQualityRuleTagListResponseBody& setData(vector<GetQualityRuleTagListResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetQualityRuleTagListResponseBodyData>> data_ = nullptr;
