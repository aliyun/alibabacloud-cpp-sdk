...
namespace Models
{
  ...
  public:
    ...
    inline const GetCallDialogContentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetCallDialogContentResponseBodyData) };
    inline GetCallDialogContentResponseBodyData data() { DARABONBA_PTR_GET(data_, GetCallDialogContentResponseBodyData) };
    inline GetCallDialogContentResponseBody& setData(const GetCallDialogContentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCallDialogContentResponseBody& setData(GetCallDialogContentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetCallDialogContentResponseBodyData> data_ = nullptr;
