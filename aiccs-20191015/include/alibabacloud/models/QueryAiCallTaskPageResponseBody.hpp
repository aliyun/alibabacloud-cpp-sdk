...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAiCallTaskPageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryAiCallTaskPageResponseBodyData) };
    inline QueryAiCallTaskPageResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryAiCallTaskPageResponseBodyData) };
    inline QueryAiCallTaskPageResponseBody& setData(const QueryAiCallTaskPageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryAiCallTaskPageResponseBody& setData(QueryAiCallTaskPageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryAiCallTaskPageResponseBodyData> data_ = nullptr;
