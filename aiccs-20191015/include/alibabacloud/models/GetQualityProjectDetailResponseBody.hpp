...
namespace Models
{
  ...
  public:
    ...
    inline const GetQualityProjectDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQualityProjectDetailResponseBodyData) };
    inline GetQualityProjectDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQualityProjectDetailResponseBodyData) };
    inline GetQualityProjectDetailResponseBody& setData(const GetQualityProjectDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQualityProjectDetailResponseBody& setData(GetQualityProjectDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetQualityProjectDetailResponseBodyData> data_ = nullptr;
