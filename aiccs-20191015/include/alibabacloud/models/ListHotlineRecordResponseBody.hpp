...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHotlineRecordResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListHotlineRecordResponseBodyData>) };
    inline vector<ListHotlineRecordResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListHotlineRecordResponseBodyData>) };
    inline ListHotlineRecordResponseBody& setData(const vector<ListHotlineRecordResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListHotlineRecordResponseBody& setData(vector<ListHotlineRecordResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListHotlineRecordResponseBodyData>> data_ = nullptr;
