...
#ifndef ALIBABACLOUD_MODELS_GETSKILLGROUPLATITUDESTATESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETSKILLGROUPLATITUDESTATESHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSkillGroupLatitudeStateShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSkillGroupLatitudeStateShrinkRequest& obj) { 
    ...
    GetSkillGroupLatitudeStateShrinkRequest() = default ;
    GetSkillGroupLatitudeStateShrinkRequest(const GetSkillGroupLatitudeStateShrinkRequest &) = default ;
    GetSkillGroupLatitudeStateShrinkRequest(GetSkillGroupLatitudeStateShrinkRequest &&) = default ;
    GetSkillGroupLatitudeStateShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSkillGroupLatitudeStateShrinkRequest() = default ;
    GetSkillGroupLatitudeStateShrinkRequest& operator=(const GetSkillGroupLatitudeStateShrinkRequest &) = default ;
    GetSkillGroupLatitudeStateShrinkRequest& operator=(GetSkillGroupLatitudeStateShrinkRequest &&) = default ;
