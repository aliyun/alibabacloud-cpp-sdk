...
#include <alibabacloud/models/GetRecordDataResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetRecordDataResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRecordDataResponseBodyData) };
    inline GetRecordDataResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRecordDataResponseBodyData) };
    inline GetRecordDataResponseBody& setData(const GetRecordDataResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRecordDataResponseBody& setData(GetRecordDataResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetRecordDataResponseBodyData> data_ = nullptr;
