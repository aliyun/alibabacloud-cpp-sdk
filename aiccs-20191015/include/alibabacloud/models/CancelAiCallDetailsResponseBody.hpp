...
#include <alibabacloud/models/CancelAiCallDetailsResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const CancelAiCallDetailsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CancelAiCallDetailsResponseBodyData) };
    inline CancelAiCallDetailsResponseBodyData data() { DARABONBA_PTR_GET(data_, CancelAiCallDetailsResponseBodyData) };
    inline CancelAiCallDetailsResponseBody& setData(const CancelAiCallDetailsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CancelAiCallDetailsResponseBody& setData(CancelAiCallDetailsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CancelAiCallDetailsResponseBodyData> data_ = nullptr;
