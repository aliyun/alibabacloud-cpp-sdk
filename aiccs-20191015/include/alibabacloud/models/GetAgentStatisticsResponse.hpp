...
namespace Models
{
  ...
  public:
    ...
    inline const GetAgentStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAgentStatisticsResponseBody) };
    inline GetAgentStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAgentStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAgentStatisticsResponseBody> body_ {};
  };
