...
namespace Models
{
  ...
  public:
    ...
    inline const GetCustomerInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetCustomerInfoResponseBodyData) };
    inline GetCustomerInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, GetCustomerInfoResponseBodyData) };
    inline GetCustomerInfoResponseBody& setData(const GetCustomerInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCustomerInfoResponseBody& setData(GetCustomerInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetCustomerInfoResponseBodyData> data_ = nullptr;
