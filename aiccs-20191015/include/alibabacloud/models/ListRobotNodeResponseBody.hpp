...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListRobotNodeResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListRobotNodeResponseBodyData>) };
    inline vector<ListRobotNodeResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListRobotNodeResponseBodyData>) };
    inline ListRobotNodeResponseBody& setData(const vector<ListRobotNodeResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListRobotNodeResponseBody& setData(vector<ListRobotNodeResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListRobotNodeResponseBodyData>> data_ = nullptr;
