...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAvailableTtsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAvailableTtsResponseBodyData>) };
    inline vector<ListAvailableTtsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAvailableTtsResponseBodyData>) };
    inline ListAvailableTtsResponseBody& setData(const vector<ListAvailableTtsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAvailableTtsResponseBody& setData(vector<ListAvailableTtsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAvailableTtsResponseBodyData>> data_ = nullptr;
