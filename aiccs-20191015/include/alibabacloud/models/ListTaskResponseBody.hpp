...
namespace Models
{
  ...
  public:
    ...
    inline const ListTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListTaskResponseBodyData) };
    inline ListTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, ListTaskResponseBodyData) };
    inline ListTaskResponseBody& setData(const ListTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListTaskResponseBody& setData(ListTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListTaskResponseBodyData> data_ = nullptr;
