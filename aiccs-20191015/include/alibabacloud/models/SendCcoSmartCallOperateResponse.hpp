...
namespace Models
{
  ...
  public:
    ...
    inline const SendCcoSmartCallOperateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendCcoSmartCallOperateResponseBody) };
    inline SendCcoSmartCallOperateResponseBody getBody() { DARABONBA_PTR_GET(body_, SendCcoSmartCallOperateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendCcoSmartCallOperateResponseBody> body_ {};
  };
