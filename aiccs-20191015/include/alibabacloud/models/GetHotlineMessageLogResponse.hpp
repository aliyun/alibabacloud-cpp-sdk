...
namespace Models
{
  ...
  public:
    ...
    inline const GetHotlineMessageLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHotlineMessageLogResponseBody) };
    inline GetHotlineMessageLogResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHotlineMessageLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHotlineMessageLogResponseBody> body_ {};
  };
