...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDepartmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDepartmentResponseBody) };
    inline DeleteDepartmentResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDepartmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDepartmentResponseBody> body_ {};
  };
