...
namespace Models
{
  ...
  public:
    ...
    inline const AiccsSmartCallOperateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AiccsSmartCallOperateResponseBody) };
    inline AiccsSmartCallOperateResponseBody getBody() { DARABONBA_PTR_GET(body_, AiccsSmartCallOperateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AiccsSmartCallOperateResponseBody> body_ {};
  };
