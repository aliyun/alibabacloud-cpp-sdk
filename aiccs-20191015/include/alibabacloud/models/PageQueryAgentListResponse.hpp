...
namespace Models
{
  ...
  public:
    ...
    inline const PageQueryAgentListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PageQueryAgentListResponseBody) };
    inline PageQueryAgentListResponseBody getBody() { DARABONBA_PTR_GET(body_, PageQueryAgentListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PageQueryAgentListResponseBody> body_ {};
  };
