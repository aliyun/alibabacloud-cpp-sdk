...
namespace Models
{
  ...
  public:
    ...
    inline const GetAgentStatisticsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetAgentStatisticsResponseBody::Data) };
    inline GetAgentStatisticsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetAgentStatisticsResponseBody::Data) };
    inline GetAgentStatisticsResponseBody& setData(const GetAgentStatisticsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAgentStatisticsResponseBody& setData(GetAgentStatisticsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<GetAgentStatisticsResponseBody::Data> data_ {};
