...
#include <alibabacloud/models/GetQualityRuleDetailResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetQualityRuleDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQualityRuleDetailResponseBodyData) };
    inline GetQualityRuleDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQualityRuleDetailResponseBodyData) };
    inline GetQualityRuleDetailResponseBody& setData(const GetQualityRuleDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQualityRuleDetailResponseBody& setData(GetQualityRuleDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetQualityRuleDetailResponseBodyData> data_ = nullptr;
