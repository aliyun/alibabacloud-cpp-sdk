...
#include <alibabacloud/models/GetAiOutboundTaskListResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetAiOutboundTaskListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAiOutboundTaskListResponseBodyData) };
    inline GetAiOutboundTaskListResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAiOutboundTaskListResponseBodyData) };
    inline GetAiOutboundTaskListResponseBody& setData(const GetAiOutboundTaskListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAiOutboundTaskListResponseBody& setData(GetAiOutboundTaskListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAiOutboundTaskListResponseBodyData> data_ = nullptr;
