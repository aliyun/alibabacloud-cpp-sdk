...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDepartmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateDepartmentResponseBody) };
    inline UpdateDepartmentResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateDepartmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateDepartmentResponseBody> body_ {};
  };
