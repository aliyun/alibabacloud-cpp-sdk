...
namespace Models
{
  ...
  public:
    ...
    inline const HoldCallResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, HoldCallResponseBody) };
    inline HoldCallResponseBody body() { DARABONBA_PTR_GET(body_, HoldCallResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<HoldCallResponseBody> body_ = nullptr;
  };
