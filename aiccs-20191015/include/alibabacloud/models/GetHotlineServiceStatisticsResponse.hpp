...
namespace Models
{
  ...
  public:
    ...
    inline const GetHotlineServiceStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHotlineServiceStatisticsResponseBody) };
    inline GetHotlineServiceStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHotlineServiceStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHotlineServiceStatisticsResponseBody> body_ {};
  };
