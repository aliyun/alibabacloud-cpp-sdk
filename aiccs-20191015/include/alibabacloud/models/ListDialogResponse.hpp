...
namespace Models
{
  ...
  public:
    ...
    inline const ListDialogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDialogResponseBody) };
    inline ListDialogResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDialogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDialogResponseBody> body_ {};
  };
