...
#include <alibabacloud/models/GetHotlineCallActionResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetHotlineCallActionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetHotlineCallActionResponseBodyData) };
    inline GetHotlineCallActionResponseBodyData data() { DARABONBA_PTR_GET(data_, GetHotlineCallActionResponseBodyData) };
    inline GetHotlineCallActionResponseBody& setData(const GetHotlineCallActionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHotlineCallActionResponseBody& setData(GetHotlineCallActionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetHotlineCallActionResponseBodyData> data_ = nullptr;
