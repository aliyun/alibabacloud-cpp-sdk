...
namespace Models
{
  ...
  public:
    ...
    inline const LlmSmartCallEncryptResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, LlmSmartCallEncryptResponseBodyData) };
    inline LlmSmartCallEncryptResponseBodyData data() { DARABONBA_PTR_GET(data_, LlmSmartCallEncryptResponseBodyData) };
    inline LlmSmartCallEncryptResponseBody& setData(const LlmSmartCallEncryptResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline LlmSmartCallEncryptResponseBody& setData(LlmSmartCallEncryptResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<LlmSmartCallEncryptResponseBodyData> data_ = nullptr;
