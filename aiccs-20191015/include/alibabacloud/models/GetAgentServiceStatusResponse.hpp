...
namespace Models
{
  ...
  public:
    ...
    inline const GetAgentServiceStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAgentServiceStatusResponseBody) };
    inline GetAgentServiceStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAgentServiceStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAgentServiceStatusResponseBody> body_ {};
  };
