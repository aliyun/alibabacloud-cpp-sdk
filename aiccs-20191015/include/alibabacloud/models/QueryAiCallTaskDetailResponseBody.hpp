...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAiCallTaskDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryAiCallTaskDetailResponseBodyData) };
    inline QueryAiCallTaskDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryAiCallTaskDetailResponseBodyData) };
    inline QueryAiCallTaskDetailResponseBody& setData(const QueryAiCallTaskDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryAiCallTaskDetailResponseBody& setData(QueryAiCallTaskDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryAiCallTaskDetailResponseBodyData> data_ = nullptr;
