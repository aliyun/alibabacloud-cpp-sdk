...
namespace Models
{
  ...
  public:
    ...
    inline const GetHotlineGroupDetailReportResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetHotlineGroupDetailReportResponseBodyData) };
    inline GetHotlineGroupDetailReportResponseBodyData data() { DARABONBA_PTR_GET(data_, GetHotlineGroupDetailReportResponseBodyData) };
    inline GetHotlineGroupDetailReportResponseBody& setData(const GetHotlineGroupDetailReportResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHotlineGroupDetailReportResponseBody& setData(GetHotlineGroupDetailReportResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetHotlineGroupDetailReportResponseBodyData> data_ = nullptr;
