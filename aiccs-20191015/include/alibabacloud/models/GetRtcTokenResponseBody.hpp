...
namespace Models
{
  ...
  public:
    ...
    inline const GetRtcTokenResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRtcTokenResponseBodyData) };
    inline GetRtcTokenResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRtcTokenResponseBodyData) };
    inline GetRtcTokenResponseBody& setData(const GetRtcTokenResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRtcTokenResponseBody& setData(GetRtcTokenResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetRtcTokenResponseBodyData> data_ = nullptr;
