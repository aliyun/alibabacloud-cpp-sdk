...
#include <alibabacloud/models/GetAgentByIdResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetAgentByIdResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAgentByIdResponseBodyData) };
    inline GetAgentByIdResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAgentByIdResponseBodyData) };
    inline GetAgentByIdResponseBody& setData(const GetAgentByIdResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAgentByIdResponseBody& setData(GetAgentByIdResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAgentByIdResponseBodyData> data_ = nullptr;
