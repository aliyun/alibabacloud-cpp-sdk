...
namespace Models
{
  ...
  public:
    ...
    inline const GetSeatInformationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSeatInformationResponseBodyData) };
    inline GetSeatInformationResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSeatInformationResponseBodyData) };
    inline GetSeatInformationResponseBody& setData(const GetSeatInformationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSeatInformationResponseBody& setData(GetSeatInformationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetSeatInformationResponseBodyData> data_ = nullptr;
