...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTaskDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryTaskDetailResponseBodyData) };
    inline QueryTaskDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryTaskDetailResponseBodyData) };
    inline QueryTaskDetailResponseBody& setData(const QueryTaskDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryTaskDetailResponseBody& setData(QueryTaskDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryTaskDetailResponseBodyData> data_ = nullptr;
