...
namespace Models
{
  ...
  public:
    ...
    inline const LlmSmartCallResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, LlmSmartCallResponseBody) };
    inline LlmSmartCallResponseBody getBody() { DARABONBA_PTR_GET(body_, LlmSmartCallResponseBody) };
  ...
  protected:
    ...
    shared_ptr<LlmSmartCallResponseBody> body_ {};
  };
