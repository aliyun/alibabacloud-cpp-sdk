...
namespace Models
{
  ...
  public:
    ...
    inline const InsertAiOutboundPhoneNumsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, InsertAiOutboundPhoneNumsResponseBodyData) };
    inline InsertAiOutboundPhoneNumsResponseBodyData data() { DARABONBA_PTR_GET(data_, InsertAiOutboundPhoneNumsResponseBodyData) };
    inline InsertAiOutboundPhoneNumsResponseBody& setData(const InsertAiOutboundPhoneNumsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline InsertAiOutboundPhoneNumsResponseBody& setData(InsertAiOutboundPhoneNumsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<InsertAiOutboundPhoneNumsResponseBodyData> data_ = nullptr;
