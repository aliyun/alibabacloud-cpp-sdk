...
namespace Models
{
  ...
  public:
    ...
    inline const GetQualityRuleTagListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetQualityRuleTagListResponseBody) };
    inline GetQualityRuleTagListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetQualityRuleTagListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetQualityRuleTagListResponseBody> body_ {};
  };
