...
#include <alibabacloud/models/ListHotlineRecordDetailResponseBodyResultData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->resultData_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const ListHotlineRecordDetailResponseBodyResultData & resultData() const { DARABONBA_PTR_GET_CONST(resultData_, ListHotlineRecordDetailResponseBodyResultData) };
    inline ListHotlineRecordDetailResponseBodyResultData resultData() { DARABONBA_PTR_GET(resultData_, ListHotlineRecordDetailResponseBodyResultData) };
    inline ListHotlineRecordDetailResponseBody& setResultData(const ListHotlineRecordDetailResponseBodyResultData & resultData) { DARABONBA_PTR_SET_VALUE(resultData_, resultData) };
    inline ListHotlineRecordDetailResponseBody& setResultData(ListHotlineRecordDetailResponseBodyResultData && resultData) { DARABONBA_PTR_SET_RVALUE(resultData_, resultData) };
  ...
  protected:
    ...
    std::shared_ptr<ListHotlineRecordDetailResponseBodyResultData> resultData_ = nullptr;
