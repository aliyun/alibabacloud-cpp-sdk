...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentIdsShrink_ == nullptr
        && return this->currentPage_ == nullptr && return this->depIdsShrink_ == nullptr && return this->endDate_ == nullptr && return this->existAgentGrouping_ == nullptr && return this->existChannelInstanceGrouping_ == nullptr
        && return this->existDepartmentGrouping_ == nullptr && return this->existRobotInstanceGrouping_ == nullptr && return this->existSkillGroupGrouping_ == nullptr && return this->groupIdsShrink_ == nullptr && return this->instanceId_ == nullptr
