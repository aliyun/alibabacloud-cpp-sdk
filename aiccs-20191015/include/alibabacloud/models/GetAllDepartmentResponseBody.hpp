...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetAllDepartmentResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetAllDepartmentResponseBodyData>) };
    inline vector<GetAllDepartmentResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetAllDepartmentResponseBodyData>) };
    inline GetAllDepartmentResponseBody& setData(const vector<GetAllDepartmentResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAllDepartmentResponseBody& setData(vector<GetAllDepartmentResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetAllDepartmentResponseBodyData>> data_ = nullptr;
