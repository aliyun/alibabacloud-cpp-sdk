...
namespace Models
{
  ...
  public:
    ...
    inline const HotlineSessionQueryResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, HotlineSessionQueryResponseBody) };
    inline HotlineSessionQueryResponseBody body() { DARABONBA_PTR_GET(body_, HotlineSessionQueryResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<HotlineSessionQueryResponseBody> body_ = nullptr;
  };
