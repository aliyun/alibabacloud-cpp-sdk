...
#ifndef ALIBABACLOUD_MODELS_GETSKILLGROUPSTATUSTOTALSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETSKILLGROUPSTATUSTOTALSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSkillGroupStatusTotalShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSkillGroupStatusTotalShrinkRequest& obj) { 
    ...
    GetSkillGroupStatusTotalShrinkRequest() = default ;
    GetSkillGroupStatusTotalShrinkRequest(const GetSkillGroupStatusTotalShrinkRequest &) = default ;
    GetSkillGroupStatusTotalShrinkRequest(GetSkillGroupStatusTotalShrinkRequest &&) = default ;
    GetSkillGroupStatusTotalShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSkillGroupStatusTotalShrinkRequest() = default ;
    GetSkillGroupStatusTotalShrinkRequest& operator=(const GetSkillGroupStatusTotalShrinkRequest &) = default ;
    GetSkillGroupStatusTotalShrinkRequest& operator=(GetSkillGroupStatusTotalShrinkRequest &&) = default ;
    ...
    inline GetSkillGroupStatusTotalShrinkRequest& setAgentIdsShrink(string agentIdsShrink) { DARABONBA_PTR_SET_VALUE(agentIdsShrink_, agentIdsShrink) };
    ...
    inline GetSkillGroupStatusTotalShrinkRequest& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline GetSkillGroupStatusTotalShrinkRequest& setDepIdsShrink(string depIdsShrink) { DARABONBA_PTR_SET_VALUE(depIdsShrink_, depIdsShrink) };
    ...
    inline GetSkillGroupStatusTotalShrinkRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetSkillGroupStatusTotalShrinkRequest& setExistAgentGrouping(bool existAgentGrouping) { DARABONBA_PTR_SET_VALUE(existAgentGrouping_, existAgentGrouping) };
    ...
    inline GetSkillGroupStatusTotalShrinkRequest& setExistDepartmentGrouping(bool existDepartmentGrouping) { DARABONBA_PTR_SET_VALUE(existDepartmentGrouping_, existDepartmentGrouping) };
    ...
    inline GetSkillGroupStatusTotalShrinkRequest& setExistSkillGroupGrouping(bool existSkillGroupGrouping) { DARABONBA_PTR_SET_VALUE(existSkillGroupGrouping_, existSkillGroupGrouping) };
    ...
    inline GetSkillGroupStatusTotalShrinkRequest& setGroupIdsShrink(string groupIdsShrink) { DARABONBA_PTR_SET_VALUE(groupIdsShrink_, groupIdsShrink) };
    ...
    inline GetSkillGroupStatusTotalShrinkRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetSkillGroupStatusTotalShrinkRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetSkillGroupStatusTotalShrinkRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
    ...
    inline GetSkillGroupStatusTotalShrinkRequest& setTimeLatitudeType(string timeLatitudeType) { DARABONBA_PTR_SET_VALUE(timeLatitudeType_, timeLatitudeType) };
