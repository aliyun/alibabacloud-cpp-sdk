...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteHotlineNumberResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteHotlineNumberResponseBody) };
    inline DeleteHotlineNumberResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteHotlineNumberResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteHotlineNumberResponseBody> body_ {};
  };
