...
namespace Models
{
  ...
  public:
    ...
    inline const QueryConversationDetailInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryConversationDetailInfoResponseBody) };
    inline QueryConversationDetailInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryConversationDetailInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryConversationDetailInfoResponseBody> body_ {};
  };
