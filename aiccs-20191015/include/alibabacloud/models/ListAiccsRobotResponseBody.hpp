...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAiccsRobotResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAiccsRobotResponseBodyData>) };
    inline vector<ListAiccsRobotResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAiccsRobotResponseBodyData>) };
    inline ListAiccsRobotResponseBody& setData(const vector<ListAiccsRobotResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAiccsRobotResponseBody& setData(vector<ListAiccsRobotResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAiccsRobotResponseBodyData>> data_ = nullptr;
