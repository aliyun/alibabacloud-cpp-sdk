...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAiOutboundTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAiOutboundTaskResponseBody) };
    inline UpdateAiOutboundTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAiOutboundTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAiOutboundTaskResponseBody> body_ {};
  };
