...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTouchListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryTouchListResponseBody) };
    inline QueryTouchListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryTouchListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryTouchListResponseBody> body_ {};
  };
