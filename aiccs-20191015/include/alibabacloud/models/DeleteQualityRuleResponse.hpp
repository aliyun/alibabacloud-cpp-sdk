...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteQualityRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteQualityRuleResponseBody) };
    inline DeleteQualityRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteQualityRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteQualityRuleResponseBody> body_ {};
  };
