...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->called_ == nullptr
        && this->id_ == nullptr && this->ownerId_ == nullptr && this->pageNo_ == nullptr && this->pageSize_ == nullptr && this->resourceOwnerAccount_ == nullptr
        && this->resourceOwnerId_ == nullptr && this->status_ == nullptr && this->statusCode_ == nullptr && this->taskId_ == nullptr; };
