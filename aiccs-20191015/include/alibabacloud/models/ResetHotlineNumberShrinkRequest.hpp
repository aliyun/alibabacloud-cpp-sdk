...
#ifndef ALIBABACLOUD_MODELS_RESETHOTLINENUMBERSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_RESETHOTLINENUMBERSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ResetHotlineNumberShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ResetHotlineNumberShrinkRequest& obj) { 
    ...
    ResetHotlineNumberShrinkRequest() = default ;
    ResetHotlineNumberShrinkRequest(const ResetHotlineNumberShrinkRequest &) = default ;
    ResetHotlineNumberShrinkRequest(ResetHotlineNumberShrinkRequest &&) = default ;
    ResetHotlineNumberShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ResetHotlineNumberShrinkRequest() = default ;
    ResetHotlineNumberShrinkRequest& operator=(const ResetHotlineNumberShrinkRequest &) = default ;
    ResetHotlineNumberShrinkRequest& operator=(ResetHotlineNumberShrinkRequest &&) = default ;
