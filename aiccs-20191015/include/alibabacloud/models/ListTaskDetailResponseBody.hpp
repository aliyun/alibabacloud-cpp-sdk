...
namespace Models
{
  ...
  public:
    ...
    inline const ListTaskDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListTaskDetailResponseBodyData) };
    inline ListTaskDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, ListTaskDetailResponseBodyData) };
    inline ListTaskDetailResponseBody& setData(const ListTaskDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListTaskDetailResponseBody& setData(ListTaskDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListTaskDetailResponseBodyData> data_ = nullptr;
