...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetHotlineMessageLogResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetHotlineMessageLogResponseBodyData>) };
    inline vector<GetHotlineMessageLogResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetHotlineMessageLogResponseBodyData>) };
    inline GetHotlineMessageLogResponseBody& setData(const vector<GetHotlineMessageLogResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHotlineMessageLogResponseBody& setData(vector<GetHotlineMessageLogResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetHotlineMessageLogResponseBodyData>> data_ = nullptr;
