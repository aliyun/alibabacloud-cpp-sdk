...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteQualityProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteQualityProjectResponseBody) };
    inline DeleteQualityProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteQualityProjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteQualityProjectResponseBody> body_ {};
  };
