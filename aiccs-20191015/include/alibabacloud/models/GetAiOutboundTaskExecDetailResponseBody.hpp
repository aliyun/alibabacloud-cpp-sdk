...
#include <alibabacloud/models/GetAiOutboundTaskExecDetailResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetAiOutboundTaskExecDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAiOutboundTaskExecDetailResponseBodyData) };
    inline GetAiOutboundTaskExecDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAiOutboundTaskExecDetailResponseBodyData) };
    inline GetAiOutboundTaskExecDetailResponseBody& setData(const GetAiOutboundTaskExecDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAiOutboundTaskExecDetailResponseBody& setData(GetAiOutboundTaskExecDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAiOutboundTaskExecDetailResponseBodyData> data_ = nullptr;
