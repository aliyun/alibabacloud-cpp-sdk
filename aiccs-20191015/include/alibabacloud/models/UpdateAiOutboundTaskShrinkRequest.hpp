...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->concurrentRate_ == nullptr
        ...
        && return this->name_ == nullptr && return this->numRepeated_ == nullptr && return this->outboundNumsShrink_ == nullptr && return this->recallRuleShrink_ == nullptr && return this->taskId_ == nullptr; };
