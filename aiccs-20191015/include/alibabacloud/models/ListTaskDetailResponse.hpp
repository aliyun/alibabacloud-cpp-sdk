...
namespace Models
{
  ...
  public:
    ...
    inline const ListTaskDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTaskDetailResponseBody) };
    inline ListTaskDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTaskDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTaskDetailResponseBody> body_ {};
  };
