...
namespace Models
{
  ...
  public:
    ...
    inline const GetQueueInformationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQueueInformationResponseBodyData) };
    inline GetQueueInformationResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQueueInformationResponseBodyData) };
    inline GetQueueInformationResponseBody& setData(const GetQueueInformationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQueueInformationResponseBody& setData(GetQueueInformationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetQueueInformationResponseBodyData> data_ = nullptr;
