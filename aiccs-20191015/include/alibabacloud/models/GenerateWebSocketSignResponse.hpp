...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateWebSocketSignResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateWebSocketSignResponseBody) };
    inline GenerateWebSocketSignResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateWebSocketSignResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateWebSocketSignResponseBody> body_ {};
  };
