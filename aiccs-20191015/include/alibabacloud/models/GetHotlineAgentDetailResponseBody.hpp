...
namespace Models
{
  ...
  public:
    ...
    inline const GetHotlineAgentDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetHotlineAgentDetailResponseBodyData) };
    inline GetHotlineAgentDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetHotlineAgentDetailResponseBodyData) };
    inline GetHotlineAgentDetailResponseBody& setData(const GetHotlineAgentDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHotlineAgentDetailResponseBody& setData(GetHotlineAgentDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetHotlineAgentDetailResponseBodyData> data_ = nullptr;
