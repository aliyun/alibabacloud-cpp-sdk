...
namespace Models
{
  ...
  public:
    ...
    inline const ImportTaskNumberDatasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ImportTaskNumberDatasResponseBody) };
    inline ImportTaskNumberDatasResponseBody getBody() { DARABONBA_PTR_GET(body_, ImportTaskNumberDatasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ImportTaskNumberDatasResponseBody> body_ {};
  };
