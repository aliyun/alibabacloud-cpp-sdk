...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataType_ == nullptr
        && return this->ossFileName_ == nullptr && return this->ownerId_ == nullptr && return this->phoneNumberList_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr
