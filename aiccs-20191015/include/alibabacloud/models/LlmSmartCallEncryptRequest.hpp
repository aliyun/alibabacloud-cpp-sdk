...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicationCode_ == nullptr
        && this->callerNumber_ == nullptr && this->encryptCalledNumber_ == nullptr && this->outId_ == nullptr && this->ownerId_ == nullptr && this->promptParam_ == nullptr
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->startWordParam_ == nullptr; };
    ...
    inline     const Darabonba::Json & getPromptParam() const { DARABONBA_GET(promptParam_) };
    Darabonba::Json & getPromptParam() { DARABONBA_GET(promptParam_) };
