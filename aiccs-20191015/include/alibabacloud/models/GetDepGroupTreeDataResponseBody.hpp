...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetDepGroupTreeDataResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetDepGroupTreeDataResponseBodyData>) };
    inline vector<GetDepGroupTreeDataResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetDepGroupTreeDataResponseBodyData>) };
    inline GetDepGroupTreeDataResponseBody& setData(const vector<GetDepGroupTreeDataResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDepGroupTreeDataResponseBody& setData(vector<GetDepGroupTreeDataResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetDepGroupTreeDataResponseBodyData>> data_ = nullptr;
