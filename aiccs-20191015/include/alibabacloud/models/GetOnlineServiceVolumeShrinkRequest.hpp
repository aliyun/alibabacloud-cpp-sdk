...
#ifndef ALIBABACLOUD_MODELS_GETONLINESERVICEVOLUMESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETONLINESERVICEVOLUMESHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetOnlineServiceVolumeShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetOnlineServiceVolumeShrinkRequest& obj) { 
    ...
    GetOnlineServiceVolumeShrinkRequest() = default ;
    GetOnlineServiceVolumeShrinkRequest(const GetOnlineServiceVolumeShrinkRequest &) = default ;
    GetOnlineServiceVolumeShrinkRequest(GetOnlineServiceVolumeShrinkRequest &&) = default ;
    GetOnlineServiceVolumeShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetOnlineServiceVolumeShrinkRequest() = default ;
    GetOnlineServiceVolumeShrinkRequest& operator=(const GetOnlineServiceVolumeShrinkRequest &) = default ;
    GetOnlineServiceVolumeShrinkRequest& operator=(GetOnlineServiceVolumeShrinkRequest &&) = default ;
    ...
    inline GetOnlineServiceVolumeShrinkRequest& setAgentIdsShrink(string agentIdsShrink) { DARABONBA_PTR_SET_VALUE(agentIdsShrink_, agentIdsShrink) };
    ...
    inline GetOnlineServiceVolumeShrinkRequest& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline GetOnlineServiceVolumeShrinkRequest& setDepIdsShrink(string depIdsShrink) { DARABONBA_PTR_SET_VALUE(depIdsShrink_, depIdsShrink) };
    ...
    inline GetOnlineServiceVolumeShrinkRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetOnlineServiceVolumeShrinkRequest& setExistAgentGrouping(bool existAgentGrouping) { DARABONBA_PTR_SET_VALUE(existAgentGrouping_, existAgentGrouping) };
    ...
    inline GetOnlineServiceVolumeShrinkRequest& setExistDepartmentGrouping(bool existDepartmentGrouping) { DARABONBA_PTR_SET_VALUE(existDepartmentGrouping_, existDepartmentGrouping) };
    ...
    inline GetOnlineServiceVolumeShrinkRequest& setExistSkillGroupGrouping(bool existSkillGroupGrouping) { DARABONBA_PTR_SET_VALUE(existSkillGroupGrouping_, existSkillGroupGrouping) };
    ...
    inline GetOnlineServiceVolumeShrinkRequest& setGroupIdsShrink(string groupIdsShrink) { DARABONBA_PTR_SET_VALUE(groupIdsShrink_, groupIdsShrink) };
    ...
    inline GetOnlineServiceVolumeShrinkRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetOnlineServiceVolumeShrinkRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetOnlineServiceVolumeShrinkRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
    ...
    inline GetOnlineServiceVolumeShrinkRequest& setTimeLatitudeType(string timeLatitudeType) { DARABONBA_PTR_SET_VALUE(timeLatitudeType_, timeLatitudeType) };
