...
namespace Models
{
  ...
  public:
    ...
    inline const TerminateAiOutboundTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TerminateAiOutboundTaskResponseBody) };
    inline TerminateAiOutboundTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, TerminateAiOutboundTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TerminateAiOutboundTaskResponseBody> body_ {};
  };
