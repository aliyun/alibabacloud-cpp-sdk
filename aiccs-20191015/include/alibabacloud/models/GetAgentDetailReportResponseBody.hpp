...
namespace Models
{
  ...
  public:
    ...
    inline const GetAgentDetailReportResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetAgentDetailReportResponseBody::Data) };
    inline GetAgentDetailReportResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetAgentDetailReportResponseBody::Data) };
    inline GetAgentDetailReportResponseBody& setData(const GetAgentDetailReportResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAgentDetailReportResponseBody& setData(GetAgentDetailReportResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<GetAgentDetailReportResponseBody::Data> data_ {};
