...
namespace Models
{
  ...
  public:
    ...
    inline const GetQualityRuleListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQualityRuleListResponseBodyData) };
    inline GetQualityRuleListResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQualityRuleListResponseBodyData) };
    inline GetQualityRuleListResponseBody& setData(const GetQualityRuleListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQualityRuleListResponseBody& setData(GetQualityRuleListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetQualityRuleListResponseBodyData> data_ = nullptr;
