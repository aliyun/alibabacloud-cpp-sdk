...
namespace Models
{
  ...
  public:
    ...
    inline const QueryHotlineNumberResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryHotlineNumberResponseBodyData) };
    inline QueryHotlineNumberResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryHotlineNumberResponseBodyData) };
    inline QueryHotlineNumberResponseBody& setData(const QueryHotlineNumberResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryHotlineNumberResponseBody& setData(QueryHotlineNumberResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryHotlineNumberResponseBodyData> data_ = nullptr;
