...
#ifndef ALIBABACLOUD_MODELS_GETHOTLINESERVICESTATISTICSSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETHOTLINESERVICESTATISTICSSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetHotlineServiceStatisticsShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetHotlineServiceStatisticsShrinkRequest& obj) { 
    ...
    GetHotlineServiceStatisticsShrinkRequest() = default ;
    GetHotlineServiceStatisticsShrinkRequest(const GetHotlineServiceStatisticsShrinkRequest &) = default ;
    GetHotlineServiceStatisticsShrinkRequest(GetHotlineServiceStatisticsShrinkRequest &&) = default ;
    GetHotlineServiceStatisticsShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetHotlineServiceStatisticsShrinkRequest() = default ;
    GetHotlineServiceStatisticsShrinkRequest& operator=(const GetHotlineServiceStatisticsShrinkRequest &) = default ;
    GetHotlineServiceStatisticsShrinkRequest& operator=(GetHotlineServiceStatisticsShrinkRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->agentIdsShrink_ == nullptr
        ...
        && return this->existSkillGroupGrouping_ == nullptr && return this->groupIdsShrink_ == nullptr && return this->instanceId_ == nullptr && return this->pageSize_ == nullptr && return this->startDate_ == nullptr
    ...
    inline GetHotlineServiceStatisticsShrinkRequest& setAgentIdsShrink(string agentIdsShrink) { DARABONBA_PTR_SET_VALUE(agentIdsShrink_, agentIdsShrink) };
    ...
    inline GetHotlineServiceStatisticsShrinkRequest& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline GetHotlineServiceStatisticsShrinkRequest& setDepIdsShrink(string depIdsShrink) { DARABONBA_PTR_SET_VALUE(depIdsShrink_, depIdsShrink) };
    ...
    inline GetHotlineServiceStatisticsShrinkRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetHotlineServiceStatisticsShrinkRequest& setExistAgentGrouping(bool existAgentGrouping) { DARABONBA_PTR_SET_VALUE(existAgentGrouping_, existAgentGrouping) };
    ...
    inline GetHotlineServiceStatisticsShrinkRequest& setExistDepartmentGrouping(bool existDepartmentGrouping) { DARABONBA_PTR_SET_VALUE(existDepartmentGrouping_, existDepartmentGrouping) };
    ...
    inline GetHotlineServiceStatisticsShrinkRequest& setExistSkillGroupGrouping(bool existSkillGroupGrouping) { DARABONBA_PTR_SET_VALUE(existSkillGroupGrouping_, existSkillGroupGrouping) };
    ...
    inline GetHotlineServiceStatisticsShrinkRequest& setGroupIdsShrink(string groupIdsShrink) { DARABONBA_PTR_SET_VALUE(groupIdsShrink_, groupIdsShrink) };
    ...
    inline GetHotlineServiceStatisticsShrinkRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetHotlineServiceStatisticsShrinkRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetHotlineServiceStatisticsShrinkRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
    ...
    inline GetHotlineServiceStatisticsShrinkRequest& setTimeLatitudeType(string timeLatitudeType) { DARABONBA_PTR_SET_VALUE(timeLatitudeType_, timeLatitudeType) };
