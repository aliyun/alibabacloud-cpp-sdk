...
namespace Models
{
  ...
  public:
    ...
    inline const GetDepartmentalLatitudeAgentStatusResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetDepartmentalLatitudeAgentStatusResponseBody::Data) };
    inline GetDepartmentalLatitudeAgentStatusResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetDepartmentalLatitudeAgentStatusResponseBody::Data) };
    inline GetDepartmentalLatitudeAgentStatusResponseBody& setData(const GetDepartmentalLatitudeAgentStatusResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDepartmentalLatitudeAgentStatusResponseBody& setData(GetDepartmentalLatitudeAgentStatusResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<GetDepartmentalLatitudeAgentStatusResponseBody::Data> data_ {};
