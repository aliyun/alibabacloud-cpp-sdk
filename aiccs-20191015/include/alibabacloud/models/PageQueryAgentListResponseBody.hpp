...
namespace Models
{
  ...
  public:
    ...
    inline const PageQueryAgentListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, PageQueryAgentListResponseBodyData) };
    inline PageQueryAgentListResponseBodyData data() { DARABONBA_PTR_GET(data_, PageQueryAgentListResponseBodyData) };
    inline PageQueryAgentListResponseBody& setData(const PageQueryAgentListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline PageQueryAgentListResponseBody& setData(PageQueryAgentListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<PageQueryAgentListResponseBodyData> data_ = nullptr;
