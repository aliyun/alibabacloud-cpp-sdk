...
#ifndef ALIBABACLOUD_MODELS_GETQUEUEINFORMATIONREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETQUEUEINFORMATIONREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetQueueInformationRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetQueueInformationRequest& obj) { 
    ...
    GetQueueInformationRequest() = default ;
    GetQueueInformationRequest(const GetQueueInformationRequest &) = default ;
    GetQueueInformationRequest(GetQueueInformationRequest &&) = default ;
    GetQueueInformationRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetQueueInformationRequest() = default ;
    GetQueueInformationRequest& operator=(const GetQueueInformationRequest &) = default ;
    GetQueueInformationRequest& operator=(GetQueueInformationRequest &&) = default ;
    ...
    inline GetQueueInformationRequest& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline GetQueueInformationRequest& setDepIds(const vector<int64_t> & depIds) { DARABONBA_PTR_SET_VALUE(depIds_, depIds) };
    inline GetQueueInformationRequest& setDepIds(vector<int64_t> && depIds) { DARABONBA_PTR_SET_RVALUE(depIds_, depIds) };
    ...
    inline GetQueueInformationRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetQueueInformationRequest& setExistDepartmentGrouping(bool existDepartmentGrouping) { DARABONBA_PTR_SET_VALUE(existDepartmentGrouping_, existDepartmentGrouping) };
    ...
    inline GetQueueInformationRequest& setExistSkillGroupGrouping(bool existSkillGroupGrouping) { DARABONBA_PTR_SET_VALUE(existSkillGroupGrouping_, existSkillGroupGrouping) };
    ...
    inline GetQueueInformationRequest& setGroupIds(const vector<int64_t> & groupIds) { DARABONBA_PTR_SET_VALUE(groupIds_, groupIds) };
    inline GetQueueInformationRequest& setGroupIds(vector<int64_t> && groupIds) { DARABONBA_PTR_SET_RVALUE(groupIds_, groupIds) };
    ...
    inline GetQueueInformationRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetQueueInformationRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetQueueInformationRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
