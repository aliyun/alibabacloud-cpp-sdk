...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getAcidList() const { DARABONBA_PTR_GET_CONST(acidList_, vector<string>) };
    inline vector<string> getAcidList() { DARABONBA_PTR_GET(acidList_, vector<string>) };
    ...
    inline const vector<string> & getCallResultList() const { DARABONBA_PTR_GET_CONST(callResultList_, vector<string>) };
    inline vector<string> getCallResultList() { DARABONBA_PTR_GET(callResultList_, vector<string>) };
    ...
    inline const vector<int32_t> & getCallTypeList() const { DARABONBA_PTR_GET_CONST(callTypeList_, vector<int32_t>) };
    inline vector<int32_t> getCallTypeList() { DARABONBA_PTR_GET(callTypeList_, vector<int32_t>) };
    ...
    inline const vector<string> & getCalledNumberList() const { DARABONBA_PTR_GET_CONST(calledNumberList_, vector<string>) };
    inline vector<string> getCalledNumberList() { DARABONBA_PTR_GET(calledNumberList_, vector<string>) };
    ...
    inline const vector<string> & getCallingNumberList() const { DARABONBA_PTR_GET_CONST(callingNumberList_, vector<string>) };
    inline vector<string> getCallingNumberList() { DARABONBA_PTR_GET(callingNumberList_, vector<string>) };
    ...
    inline const vector<string> & getMemberIdList() const { DARABONBA_PTR_GET_CONST(memberIdList_, vector<string>) };
    inline vector<string> getMemberIdList() { DARABONBA_PTR_GET(memberIdList_, vector<string>) };
    ...
    inline const vector<string> & getServicerIdList() const { DARABONBA_PTR_GET_CONST(servicerIdList_, vector<string>) };
    inline vector<string> getServicerIdList() { DARABONBA_PTR_GET(servicerIdList_, vector<string>) };
