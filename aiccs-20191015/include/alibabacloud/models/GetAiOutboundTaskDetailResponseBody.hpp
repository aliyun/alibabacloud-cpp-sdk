...
#include <alibabacloud/models/GetAiOutboundTaskDetailResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetAiOutboundTaskDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAiOutboundTaskDetailResponseBodyData) };
    inline GetAiOutboundTaskDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAiOutboundTaskDetailResponseBodyData) };
    inline GetAiOutboundTaskDetailResponseBody& setData(const GetAiOutboundTaskDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAiOutboundTaskDetailResponseBody& setData(GetAiOutboundTaskDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAiOutboundTaskDetailResponseBodyData> data_ = nullptr;
