...
namespace Models
{
  ...
  public:
    ...
    inline const GetSkillGroupServiceCapabilityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSkillGroupServiceCapabilityResponseBody) };
    inline GetSkillGroupServiceCapabilityResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSkillGroupServiceCapabilityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSkillGroupServiceCapabilityResponseBody> body_ {};
  };
