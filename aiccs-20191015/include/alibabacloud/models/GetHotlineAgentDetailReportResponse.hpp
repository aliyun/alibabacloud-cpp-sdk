...
namespace Models
{
  ...
  public:
    ...
    inline const GetHotlineAgentDetailReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHotlineAgentDetailReportResponseBody) };
    inline GetHotlineAgentDetailReportResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHotlineAgentDetailReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHotlineAgentDetailReportResponseBody> body_ {};
  };
