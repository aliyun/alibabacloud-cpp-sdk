...
namespace Models
{
  ...
  public:
    ...
    inline const GetAiOutboundTaskProgressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAiOutboundTaskProgressResponseBody) };
    inline GetAiOutboundTaskProgressResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAiOutboundTaskProgressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAiOutboundTaskProgressResponseBody> body_ {};
  };
