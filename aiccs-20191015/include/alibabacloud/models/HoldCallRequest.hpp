...
namespace Models
{
  ...
  public:
    ...
    inline HoldCallRequest& setAccountName(string accountName) { DARABONBA_PTR_SET_VALUE(accountName_, accountName) };
    ...
    inline HoldCallRequest& setCallId(string callId) { DARABONBA_PTR_SET_VALUE(callId_, callId) };
    ...
    inline HoldCallRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline HoldCallRequest& setConnectionId(string connectionId) { DARABONBA_PTR_SET_VALUE(connectionId_, connectionId) };
