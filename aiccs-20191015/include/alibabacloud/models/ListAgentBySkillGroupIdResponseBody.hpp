...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAgentBySkillGroupIdResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAgentBySkillGroupIdResponseBodyData>) };
    inline vector<ListAgentBySkillGroupIdResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAgentBySkillGroupIdResponseBodyData>) };
    inline ListAgentBySkillGroupIdResponseBody& setData(const vector<ListAgentBySkillGroupIdResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAgentBySkillGroupIdResponseBody& setData(vector<ListAgentBySkillGroupIdResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAgentBySkillGroupIdResponseBodyData>> data_ = nullptr;
