...
#ifndef ALIBABACLOUD_MODELS_GETSKILLGROUPAGENTSTATUSDETAILSSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETSKILLGROUPAGENTSTATUSDETAILSSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSkillGroupAgentStatusDetailsShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSkillGroupAgentStatusDetailsShrinkRequest& obj) { 
    ...
    GetSkillGroupAgentStatusDetailsShrinkRequest() = default ;
    GetSkillGroupAgentStatusDetailsShrinkRequest(const GetSkillGroupAgentStatusDetailsShrinkRequest &) = default ;
    GetSkillGroupAgentStatusDetailsShrinkRequest(GetSkillGroupAgentStatusDetailsShrinkRequest &&) = default ;
    GetSkillGroupAgentStatusDetailsShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSkillGroupAgentStatusDetailsShrinkRequest() = default ;
    GetSkillGroupAgentStatusDetailsShrinkRequest& operator=(const GetSkillGroupAgentStatusDetailsShrinkRequest &) = default ;
    GetSkillGroupAgentStatusDetailsShrinkRequest& operator=(GetSkillGroupAgentStatusDetailsShrinkRequest &&) = default ;
    ...
    inline GetSkillGroupAgentStatusDetailsShrinkRequest& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline GetSkillGroupAgentStatusDetailsShrinkRequest& setDepIdsShrink(string depIdsShrink) { DARABONBA_PTR_SET_VALUE(depIdsShrink_, depIdsShrink) };
    ...
    inline GetSkillGroupAgentStatusDetailsShrinkRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetSkillGroupAgentStatusDetailsShrinkRequest& setExistDepartmentGrouping(bool existDepartmentGrouping) { DARABONBA_PTR_SET_VALUE(existDepartmentGrouping_, existDepartmentGrouping) };
    ...
    inline GetSkillGroupAgentStatusDetailsShrinkRequest& setExistSkillGroupGrouping(bool existSkillGroupGrouping) { DARABONBA_PTR_SET_VALUE(existSkillGroupGrouping_, existSkillGroupGrouping) };
    ...
    inline GetSkillGroupAgentStatusDetailsShrinkRequest& setGroupIdsShrink(string groupIdsShrink) { DARABONBA_PTR_SET_VALUE(groupIdsShrink_, groupIdsShrink) };
    ...
    inline GetSkillGroupAgentStatusDetailsShrinkRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetSkillGroupAgentStatusDetailsShrinkRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetSkillGroupAgentStatusDetailsShrinkRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
