...
#ifndef ALIBABACLOUD_MODELS_GETAGENTSTATISTICSSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETAGENTSTATISTICSSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAgentStatisticsShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAgentStatisticsShrinkRequest& obj) { 
    ...
    GetAgentStatisticsShrinkRequest() = default ;
    GetAgentStatisticsShrinkRequest(const GetAgentStatisticsShrinkRequest &) = default ;
    GetAgentStatisticsShrinkRequest(GetAgentStatisticsShrinkRequest &&) = default ;
    GetAgentStatisticsShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAgentStatisticsShrinkRequest() = default ;
    GetAgentStatisticsShrinkRequest& operator=(const GetAgentStatisticsShrinkRequest &) = default ;
    GetAgentStatisticsShrinkRequest& operator=(GetAgentStatisticsShrinkRequest &&) = default ;
    ...
    inline GetAgentStatisticsShrinkRequest& setAgentIdsShrink(string agentIdsShrink) { DARABONBA_PTR_SET_VALUE(agentIdsShrink_, agentIdsShrink) };
    ...
    inline GetAgentStatisticsShrinkRequest& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline GetAgentStatisticsShrinkRequest& setDepIdsShrink(string depIdsShrink) { DARABONBA_PTR_SET_VALUE(depIdsShrink_, depIdsShrink) };
    ...
    inline GetAgentStatisticsShrinkRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetAgentStatisticsShrinkRequest& setExistAgentGrouping(bool existAgentGrouping) { DARABONBA_PTR_SET_VALUE(existAgentGrouping_, existAgentGrouping) };
    ...
    inline GetAgentStatisticsShrinkRequest& setExistDepartmentGrouping(bool existDepartmentGrouping) { DARABONBA_PTR_SET_VALUE(existDepartmentGrouping_, existDepartmentGrouping) };
    ...
    inline GetAgentStatisticsShrinkRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetAgentStatisticsShrinkRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetAgentStatisticsShrinkRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
    ...
    inline GetAgentStatisticsShrinkRequest& setTimeLatitudeType(string timeLatitudeType) { DARABONBA_PTR_SET_VALUE(timeLatitudeType_, timeLatitudeType) };
