...
#ifndef ALIBABACLOUD_MODELS_GETSKILLGROUPSTATUSTOTALREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETSKILLGROUPSTATUSTOTALREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSkillGroupStatusTotalRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSkillGroupStatusTotalRequest& obj) { 
    ...
    GetSkillGroupStatusTotalRequest() = default ;
    GetSkillGroupStatusTotalRequest(const GetSkillGroupStatusTotalRequest &) = default ;
    GetSkillGroupStatusTotalRequest(GetSkillGroupStatusTotalRequest &&) = default ;
    GetSkillGroupStatusTotalRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSkillGroupStatusTotalRequest() = default ;
    GetSkillGroupStatusTotalRequest& operator=(const GetSkillGroupStatusTotalRequest &) = default ;
    GetSkillGroupStatusTotalRequest& operator=(GetSkillGroupStatusTotalRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->agentIds_ == nullptr
        ...
        && return this->existSkillGroupGrouping_ == nullptr && return this->groupIds_ == nullptr && return this->instanceId_ == nullptr && return this->pageSize_ == nullptr && return this->startDate_ == nullptr
        && return this->timeLatitudeType_ == nullptr; };
    ...
    inline GetSkillGroupStatusTotalRequest& setAgentIds(const vector<int64_t> & agentIds) { DARABONBA_PTR_SET_VALUE(agentIds_, agentIds) };
    inline GetSkillGroupStatusTotalRequest& setAgentIds(vector<int64_t> && agentIds) { DARABONBA_PTR_SET_RVALUE(agentIds_, agentIds) };
    ...
    inline GetSkillGroupStatusTotalRequest& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline GetSkillGroupStatusTotalRequest& setDepIds(const vector<int64_t> & depIds) { DARABONBA_PTR_SET_VALUE(depIds_, depIds) };
    inline GetSkillGroupStatusTotalRequest& setDepIds(vector<int64_t> && depIds) { DARABONBA_PTR_SET_RVALUE(depIds_, depIds) };
    ...
    inline GetSkillGroupStatusTotalRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetSkillGroupStatusTotalRequest& setExistAgentGrouping(bool existAgentGrouping) { DARABONBA_PTR_SET_VALUE(existAgentGrouping_, existAgentGrouping) };
    ...
    inline GetSkillGroupStatusTotalRequest& setExistDepartmentGrouping(bool existDepartmentGrouping) { DARABONBA_PTR_SET_VALUE(existDepartmentGrouping_, existDepartmentGrouping) };
    ...
    inline GetSkillGroupStatusTotalRequest& setExistSkillGroupGrouping(bool existSkillGroupGrouping) { DARABONBA_PTR_SET_VALUE(existSkillGroupGrouping_, existSkillGroupGrouping) };
    ...
    inline GetSkillGroupStatusTotalRequest& setGroupIds(const vector<int64_t> & groupIds) { DARABONBA_PTR_SET_VALUE(groupIds_, groupIds) };
    inline GetSkillGroupStatusTotalRequest& setGroupIds(vector<int64_t> && groupIds) { DARABONBA_PTR_SET_RVALUE(groupIds_, groupIds) };
    ...
    inline GetSkillGroupStatusTotalRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetSkillGroupStatusTotalRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetSkillGroupStatusTotalRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
    ...
    inline GetSkillGroupStatusTotalRequest& setTimeLatitudeType(string timeLatitudeType) { DARABONBA_PTR_SET_VALUE(timeLatitudeType_, timeLatitudeType) };
