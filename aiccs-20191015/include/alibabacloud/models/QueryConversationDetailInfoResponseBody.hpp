...
namespace Models
{
  ...
  public:
    ...
    inline const QueryConversationDetailInfoResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryConversationDetailInfoResponseBody::Data) };
    inline QueryConversationDetailInfoResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryConversationDetailInfoResponseBody::Data) };
    inline QueryConversationDetailInfoResponseBody& setData(const QueryConversationDetailInfoResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryConversationDetailInfoResponseBody& setData(QueryConversationDetailInfoResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
