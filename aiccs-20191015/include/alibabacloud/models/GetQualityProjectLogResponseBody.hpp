...
#include <vector>
#include <alibabacloud/models/GetQualityProjectLogResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetQualityProjectLogResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetQualityProjectLogResponseBodyData>) };
    inline vector<GetQualityProjectLogResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetQualityProjectLogResponseBodyData>) };
    inline GetQualityProjectLogResponseBody& setData(const vector<GetQualityProjectLogResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQualityProjectLogResponseBody& setData(vector<GetQualityProjectLogResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetQualityProjectLogResponseBodyData>> data_ = nullptr;
