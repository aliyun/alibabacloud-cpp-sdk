...
#ifndef ALIBABACLOUD_MODELS_GETSKILLGROUPLATITUDESTATEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETSKILLGROUPLATITUDESTATEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSkillGroupLatitudeStateRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSkillGroupLatitudeStateRequest& obj) { 
    ...
    GetSkillGroupLatitudeStateRequest() = default ;
    GetSkillGroupLatitudeStateRequest(const GetSkillGroupLatitudeStateRequest &) = default ;
    GetSkillGroupLatitudeStateRequest(GetSkillGroupLatitudeStateRequest &&) = default ;
    GetSkillGroupLatitudeStateRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSkillGroupLatitudeStateRequest() = default ;
    GetSkillGroupLatitudeStateRequest& operator=(const GetSkillGroupLatitudeStateRequest &) = default ;
    GetSkillGroupLatitudeStateRequest& operator=(GetSkillGroupLatitudeStateRequest &&) = default ;
    ...
    inline GetSkillGroupLatitudeStateRequest& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline GetSkillGroupLatitudeStateRequest& setDepIds(const vector<int64_t> & depIds) { DARABONBA_PTR_SET_VALUE(depIds_, depIds) };
    inline GetSkillGroupLatitudeStateRequest& setDepIds(vector<int64_t> && depIds) { DARABONBA_PTR_SET_RVALUE(depIds_, depIds) };
    ...
    inline GetSkillGroupLatitudeStateRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetSkillGroupLatitudeStateRequest& setExistDepartmentGrouping(bool existDepartmentGrouping) { DARABONBA_PTR_SET_VALUE(existDepartmentGrouping_, existDepartmentGrouping) };
    ...
    inline GetSkillGroupLatitudeStateRequest& setExistSkillGroupGrouping(bool existSkillGroupGrouping) { DARABONBA_PTR_SET_VALUE(existSkillGroupGrouping_, existSkillGroupGrouping) };
    ...
    inline GetSkillGroupLatitudeStateRequest& setGroupIds(const vector<int64_t> & groupIds) { DARABONBA_PTR_SET_VALUE(groupIds_, groupIds) };
    inline GetSkillGroupLatitudeStateRequest& setGroupIds(vector<int64_t> && groupIds) { DARABONBA_PTR_SET_RVALUE(groupIds_, groupIds) };
    ...
    inline GetSkillGroupLatitudeStateRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetSkillGroupLatitudeStateRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetSkillGroupLatitudeStateRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
