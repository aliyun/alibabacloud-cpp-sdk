...
namespace Models
{
  ...
  public:
    ...
    inline const GetAllDepartmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAllDepartmentResponseBody) };
    inline GetAllDepartmentResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAllDepartmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAllDepartmentResponseBody> body_ {};
  };
