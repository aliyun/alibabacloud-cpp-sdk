...
namespace Models
{
  ...
  public:
    ...
    inline const StartAiOutboundTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartAiOutboundTaskResponseBody) };
    inline StartAiOutboundTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, StartAiOutboundTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartAiOutboundTaskResponseBody> body_ {};
  };
