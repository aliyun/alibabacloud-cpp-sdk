...
namespace Models
{
  ...
  public:
    ...
    inline const GetQueueInformationResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetQueueInformationResponseBody) };
    inline GetQueueInformationResponseBody body() { DARABONBA_PTR_GET(body_, GetQueueInformationResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetQueueInformationResponseBody> body_ = nullptr;
  };
