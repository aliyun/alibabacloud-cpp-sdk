...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentId_ == nullptr
        && this->applicationCode_ == nullptr && this->applicationName_ == nullptr && this->callDayShrink_ == nullptr && this->callRetryInterval_ == nullptr && this->callRetryReasonShrink_ == nullptr
        && this->callRetryTimes_ == nullptr && this->callTimeShrink_ == nullptr && this->lineEncoding_ == nullptr && this->linePhoneNum_ == nullptr && this->missCallRetry_ == nullptr
    ...
    inline CreateAiCallTaskShrinkRequest& setApplicationName(string applicationName) { DARABONBA_PTR_SET_VALUE(applicationName_, applicationName) };
