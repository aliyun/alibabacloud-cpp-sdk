...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentId_ == nullptr
        && this->applicationCode_ == nullptr && this->callDayShrink_ == nullptr && this->callExpireDate_ == nullptr && this->callExpireMinutes_ == nullptr && this->callExpireType_ == nullptr
        && this->callRetryInterval_ == nullptr && this->callRetryReasonShrink_ == nullptr && this->callRetryTimes_ == nullptr && this->callTimeShrink_ == nullptr && this->callableTimeShrink_ == nullptr
    ...
    inline CreateAiCallTaskShrinkRequest& setApplicationCode(string applicationCode) { DARABONBA_PTR_SET_VALUE(applicationCode_, applicationCode) };
    ...
    inline CreateAiCallTaskShrinkRequest& setCallExpireDate(string callExpireDate) { DARABONBA_PTR_SET_VALUE(callExpireDate_, callExpireDate) };
    ...
    inline CreateAiCallTaskShrinkRequest& setCallExpireMinutes(int64_t callExpireMinutes) { DARABONBA_PTR_SET_VALUE(callExpireMinutes_, callExpireMinutes) };
    ...
    inline CreateAiCallTaskShrinkRequest& setCallExpireType(int64_t callExpireType) { DARABONBA_PTR_SET_VALUE(callExpireType_, callExpireType) };
    ...
    inline CreateAiCallTaskShrinkRequest& setCallableTimeShrink(string callableTimeShrink) { DARABONBA_PTR_SET_VALUE(callableTimeShrink_, callableTimeShrink) };
    ...
    inline CreateAiCallTaskShrinkRequest& setLineEncoding(string lineEncoding) { DARABONBA_PTR_SET_VALUE(lineEncoding_, lineEncoding) };
    ...
    inline CreateAiCallTaskShrinkRequest& setLinePhoneNum(string linePhoneNum) { DARABONBA_PTR_SET_VALUE(linePhoneNum_, linePhoneNum) };
    ...
    inline CreateAiCallTaskShrinkRequest& setPhoneType(int64_t phoneType) { DARABONBA_PTR_SET_VALUE(phoneType_, phoneType) };
    ...
    inline CreateAiCallTaskShrinkRequest& setSource(int64_t source) { DARABONBA_PTR_SET_VALUE(source_, source) };
