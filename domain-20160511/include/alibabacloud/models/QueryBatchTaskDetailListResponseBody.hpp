...
#ifndef ALIBABACLOUD_MODELS_QUERYBATCHTASKDETAILLISTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYBATCHTASKDETAILLISTRESPONSEBODY_HPP_
...
namespace Models
{
  class QueryBatchTaskDetailListResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryBatchTaskDetailListResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryBatchTaskDetailListResponseBody& obj) { 
    ...
    QueryBatchTaskDetailListResponseBody() = default ;
    QueryBatchTaskDetailListResponseBody(const QueryBatchTaskDetailListResponseBody &) = default ;
    QueryBatchTaskDetailListResponseBody(QueryBatchTaskDetailListResponseBody &&) = default ;
    QueryBatchTaskDetailListResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryBatchTaskDetailListResponseBody() = default ;
    QueryBatchTaskDetailListResponseBody& operator=(const QueryBatchTaskDetailListResponseBody &) = default ;
    QueryBatchTaskDetailListResponseBody& operator=(QueryBatchTaskDetailListResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->errorMsg_ == nullptr && this->taskNo_ == nullptr && this->taskStatus_ == nullptr && this->taskType_ == nullptr && this->tryCount_ == nullptr
    ...
    inline QueryBatchTaskDetailListResponseBody& setCurrentPageNum(int32_t currentPageNum) { DARABONBA_PTR_SET_VALUE(currentPageNum_, currentPageNum) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const QueryBatchTaskDetailListResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryBatchTaskDetailListResponseBody::Data) };
    inline QueryBatchTaskDetailListResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryBatchTaskDetailListResponseBody::Data) };
    inline QueryBatchTaskDetailListResponseBody& setData(const QueryBatchTaskDetailListResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryBatchTaskDetailListResponseBody& setData(QueryBatchTaskDetailListResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryBatchTaskDetailListResponseBody& setNextPage(bool nextPage) { DARABONBA_PTR_SET_VALUE(nextPage_, nextPage) };
    ...
    inline QueryBatchTaskDetailListResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline QueryBatchTaskDetailListResponseBody& setPrePage(bool prePage) { DARABONBA_PTR_SET_VALUE(prePage_, prePage) };
    ...
    inline QueryBatchTaskDetailListResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryBatchTaskDetailListResponseBody& setTotalItemNum(int32_t totalItemNum) { DARABONBA_PTR_SET_VALUE(totalItemNum_, totalItemNum) };
    ...
    inline QueryBatchTaskDetailListResponseBody& setTotalPageNum(int32_t totalPageNum) { DARABONBA_PTR_SET_VALUE(totalPageNum_, totalPageNum) };


  protected:
    shared_ptr<int32_t> currentPageNum_ {};
    shared_ptr<QueryBatchTaskDetailListResponseBody::Data> data_ {};
