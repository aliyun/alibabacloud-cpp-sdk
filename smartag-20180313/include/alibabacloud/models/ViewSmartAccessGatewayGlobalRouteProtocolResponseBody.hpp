...
#ifndef ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYGLOBALROUTEPROTOCOLRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYGLOBALROUTEPROTOCOLRESPONSEBODY_HPP_
...
namespace Models
{
  class ViewSmartAccessGatewayGlobalRouteProtocolResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ViewSmartAccessGatewayGlobalRouteProtocolResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(RouteProtocol, routeProtocol_);
      DARABONBA_PTR_TO_JSON(TaskStates, taskStates_);
    };
    friend void from_json(const Darabonba::Json& j, ViewSmartAccessGatewayGlobalRouteProtocolResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(RouteProtocol, routeProtocol_);
      DARABONBA_PTR_FROM_JSON(TaskStates, taskStates_);
    };
    ViewSmartAccessGatewayGlobalRouteProtocolResponseBody() = default ;
    ViewSmartAccessGatewayGlobalRouteProtocolResponseBody(const ViewSmartAccessGatewayGlobalRouteProtocolResponseBody &) = default ;
    ViewSmartAccessGatewayGlobalRouteProtocolResponseBody(ViewSmartAccessGatewayGlobalRouteProtocolResponseBody &&) = default ;
    ViewSmartAccessGatewayGlobalRouteProtocolResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ViewSmartAccessGatewayGlobalRouteProtocolResponseBody() = default ;
    ViewSmartAccessGatewayGlobalRouteProtocolResponseBody& operator=(const ViewSmartAccessGatewayGlobalRouteProtocolResponseBody &) = default ;
    ViewSmartAccessGatewayGlobalRouteProtocolResponseBody& operator=(ViewSmartAccessGatewayGlobalRouteProtocolResponseBody &&) = default ;
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && this->routeProtocol_ == nullptr && this->taskStates_ == nullptr; };
    // requestId Field Functions 
    bool hasRequestId() const { return this->requestId_ != nullptr;};
    void deleteRequestId() { this->requestId_ = nullptr;};
    inline string getRequestId() const { DARABONBA_PTR_GET_DEFAULT(requestId_, "") };
    inline ViewSmartAccessGatewayGlobalRouteProtocolResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ViewSmartAccessGatewayGlobalRouteProtocolResponseBody& setRouteProtocol(string routeProtocol) { DARABONBA_PTR_SET_VALUE(routeProtocol_, routeProtocol) };
    ...
    inline const vector<ViewSmartAccessGatewayGlobalRouteProtocolResponseBody::TaskStates> & getTaskStates() const { DARABONBA_PTR_GET_CONST(taskStates_, vector<ViewSmartAccessGatewayGlobalRouteProtocolResponseBody::TaskStates>) };
    inline vector<ViewSmartAccessGatewayGlobalRouteProtocolResponseBody::TaskStates> getTaskStates() { DARABONBA_PTR_GET(taskStates_, vector<ViewSmartAccessGatewayGlobalRouteProtocolResponseBody::TaskStates>) };
    inline ViewSmartAccessGatewayGlobalRouteProtocolResponseBody& setTaskStates(const vector<ViewSmartAccessGatewayGlobalRouteProtocolResponseBody::TaskStates> & taskStates) { DARABONBA_PTR_SET_VALUE(taskStates_, taskStates) };
    inline ViewSmartAccessGatewayGlobalRouteProtocolResponseBody& setTaskStates(vector<ViewSmartAccessGatewayGlobalRouteProtocolResponseBody::TaskStates> && taskStates) { DARABONBA_PTR_SET_RVALUE(taskStates_, taskStates) };
  ...
  protected:
    ...
    shared_ptr<vector<ViewSmartAccessGatewayGlobalRouteProtocolResponseBody::TaskStates>> taskStates_ {};
  };
