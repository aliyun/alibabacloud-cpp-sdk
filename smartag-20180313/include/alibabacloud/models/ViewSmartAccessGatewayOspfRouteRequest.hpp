...
#ifndef ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYOSPFROUTEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYOSPFROUTEREQUEST_HPP_
...
namespace Models
{
  class ViewSmartAccessGatewayOspfRouteRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ViewSmartAccessGatewayOspfRouteRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ViewSmartAccessGatewayOspfRouteRequest& obj) { 
    ...
    ViewSmartAccessGatewayOspfRouteRequest() = default ;
    ViewSmartAccessGatewayOspfRouteRequest(const ViewSmartAccessGatewayOspfRouteRequest &) = default ;
    ViewSmartAccessGatewayOspfRouteRequest(ViewSmartAccessGatewayOspfRouteRequest &&) = default ;
    ViewSmartAccessGatewayOspfRouteRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ViewSmartAccessGatewayOspfRouteRequest() = default ;
    ViewSmartAccessGatewayOspfRouteRequest& operator=(const ViewSmartAccessGatewayOspfRouteRequest &) = default ;
    ViewSmartAccessGatewayOspfRouteRequest& operator=(ViewSmartAccessGatewayOspfRouteRequest &&) = default ;
    ...
    inline ViewSmartAccessGatewayOspfRouteRequest& setCrossAccount(bool crossAccount) { DARABONBA_PTR_SET_VALUE(crossAccount_, crossAccount) };
    ...
    inline ViewSmartAccessGatewayOspfRouteRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline ViewSmartAccessGatewayOspfRouteRequest& setResourceUid(string resourceUid) { DARABONBA_PTR_SET_VALUE(resourceUid_, resourceUid) };
    ...
    inline ViewSmartAccessGatewayOspfRouteRequest& setSagInsId(string sagInsId) { DARABONBA_PTR_SET_VALUE(sagInsId_, sagInsId) };
    ...
    inline ViewSmartAccessGatewayOspfRouteRequest& setSagSn(string sagSn) { DARABONBA_PTR_SET_VALUE(sagSn_, sagSn) };
