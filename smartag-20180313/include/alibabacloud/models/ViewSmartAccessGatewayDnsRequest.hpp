...
#ifndef ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYDNSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYDNSREQUEST_HPP_
...
namespace Models
{
  class ViewSmartAccessGatewayDnsRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ViewSmartAccessGatewayDnsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ViewSmartAccessGatewayDnsRequest& obj) { 
    ...
    ViewSmartAccessGatewayDnsRequest() = default ;
    ViewSmartAccessGatewayDnsRequest(const ViewSmartAccessGatewayDnsRequest &) = default ;
    ViewSmartAccessGatewayDnsRequest(ViewSmartAccessGatewayDnsRequest &&) = default ;
    ViewSmartAccessGatewayDnsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ViewSmartAccessGatewayDnsRequest() = default ;
    ViewSmartAccessGatewayDnsRequest& operator=(const ViewSmartAccessGatewayDnsRequest &) = default ;
    ViewSmartAccessGatewayDnsRequest& operator=(ViewSmartAccessGatewayDnsRequest &&) = default ;
    ...
    inline ViewSmartAccessGatewayDnsRequest& setCrossAccount(bool crossAccount) { DARABONBA_PTR_SET_VALUE(crossAccount_, crossAccount) };
    ...
    inline ViewSmartAccessGatewayDnsRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline ViewSmartAccessGatewayDnsRequest& setResourceUid(string resourceUid) { DARABONBA_PTR_SET_VALUE(resourceUid_, resourceUid) };
    ...
    inline ViewSmartAccessGatewayDnsRequest& setSagInsId(string sagInsId) { DARABONBA_PTR_SET_VALUE(sagInsId_, sagInsId) };
    ...
    inline ViewSmartAccessGatewayDnsRequest& setSagSn(string sagSn) { DARABONBA_PTR_SET_VALUE(sagSn_, sagSn) };
