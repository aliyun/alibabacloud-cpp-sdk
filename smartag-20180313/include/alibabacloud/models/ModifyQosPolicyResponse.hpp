...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyQosPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyQosPolicyResponseBody) };
    inline ModifyQosPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyQosPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyQosPolicyResponseBody> body_ {};
  };
