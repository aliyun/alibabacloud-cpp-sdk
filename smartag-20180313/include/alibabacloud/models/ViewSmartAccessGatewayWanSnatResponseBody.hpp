...
#ifndef ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYWANSNATRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYWANSNATRESPONSEBODY_HPP_
...
namespace Models
{
  class ViewSmartAccessGatewayWanSnatResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ViewSmartAccessGatewayWanSnatResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Snat, snat_);
      DARABONBA_PTR_TO_JSON(TaskStates, taskStates_);
    };
    friend void from_json(const Darabonba::Json& j, ViewSmartAccessGatewayWanSnatResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Snat, snat_);
      DARABONBA_PTR_FROM_JSON(TaskStates, taskStates_);
    };
    ViewSmartAccessGatewayWanSnatResponseBody() = default ;
    ViewSmartAccessGatewayWanSnatResponseBody(const ViewSmartAccessGatewayWanSnatResponseBody &) = default ;
    ViewSmartAccessGatewayWanSnatResponseBody(ViewSmartAccessGatewayWanSnatResponseBody &&) = default ;
    ViewSmartAccessGatewayWanSnatResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ViewSmartAccessGatewayWanSnatResponseBody() = default ;
    ViewSmartAccessGatewayWanSnatResponseBody& operator=(const ViewSmartAccessGatewayWanSnatResponseBody &) = default ;
    ViewSmartAccessGatewayWanSnatResponseBody& operator=(ViewSmartAccessGatewayWanSnatResponseBody &&) = default ;
    ...
    inline ViewSmartAccessGatewayWanSnatResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ViewSmartAccessGatewayWanSnatResponseBody& setSnat(string snat) { DARABONBA_PTR_SET_VALUE(snat_, snat) };
    ...
    inline const vector<ViewSmartAccessGatewayWanSnatResponseBody::TaskStates> & getTaskStates() const { DARABONBA_PTR_GET_CONST(taskStates_, vector<ViewSmartAccessGatewayWanSnatResponseBody::TaskStates>) };
    inline vector<ViewSmartAccessGatewayWanSnatResponseBody::TaskStates> getTaskStates() { DARABONBA_PTR_GET(taskStates_, vector<ViewSmartAccessGatewayWanSnatResponseBody::TaskStates>) };
    inline ViewSmartAccessGatewayWanSnatResponseBody& setTaskStates(const vector<ViewSmartAccessGatewayWanSnatResponseBody::TaskStates> & taskStates) { DARABONBA_PTR_SET_VALUE(taskStates_, taskStates) };
    inline ViewSmartAccessGatewayWanSnatResponseBody& setTaskStates(vector<ViewSmartAccessGatewayWanSnatResponseBody::TaskStates> && taskStates) { DARABONBA_PTR_SET_RVALUE(taskStates_, taskStates) };
  ...
  protected:
    ...
    shared_ptr<vector<ViewSmartAccessGatewayWanSnatResponseBody::TaskStates>> taskStates_ {};
  };
