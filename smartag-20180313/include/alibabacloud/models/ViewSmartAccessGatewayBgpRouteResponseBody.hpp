...
#ifndef ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYBGPROUTERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYBGPROUTERESPONSEBODY_HPP_
...
namespace Models
{
  class ViewSmartAccessGatewayBgpRouteResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ViewSmartAccessGatewayBgpRouteResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ViewSmartAccessGatewayBgpRouteResponseBody& obj) { 
    ...
    ViewSmartAccessGatewayBgpRouteResponseBody() = default ;
    ViewSmartAccessGatewayBgpRouteResponseBody(const ViewSmartAccessGatewayBgpRouteResponseBody &) = default ;
    ViewSmartAccessGatewayBgpRouteResponseBody(ViewSmartAccessGatewayBgpRouteResponseBody &&) = default ;
    ViewSmartAccessGatewayBgpRouteResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ViewSmartAccessGatewayBgpRouteResponseBody() = default ;
    ViewSmartAccessGatewayBgpRouteResponseBody& operator=(const ViewSmartAccessGatewayBgpRouteResponseBody &) = default ;
    ViewSmartAccessGatewayBgpRouteResponseBody& operator=(ViewSmartAccessGatewayBgpRouteResponseBody &&) = default ;
    ...
    inline ViewSmartAccessGatewayBgpRouteResponseBody& setHoldTime(int32_t holdTime) { DARABONBA_PTR_SET_VALUE(holdTime_, holdTime) };
    ...
    inline ViewSmartAccessGatewayBgpRouteResponseBody& setKeepAlive(int32_t keepAlive) { DARABONBA_PTR_SET_VALUE(keepAlive_, keepAlive) };
    ...
    inline ViewSmartAccessGatewayBgpRouteResponseBody& setLocalAs(int32_t localAs) { DARABONBA_PTR_SET_VALUE(localAs_, localAs) };
    ...
    inline ViewSmartAccessGatewayBgpRouteResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ViewSmartAccessGatewayBgpRouteResponseBody& setRouterId(string routerId) { DARABONBA_PTR_SET_VALUE(routerId_, routerId) };
    ...
    inline const vector<ViewSmartAccessGatewayBgpRouteResponseBody::TaskStates> & getTaskStates() const { DARABONBA_PTR_GET_CONST(taskStates_, vector<ViewSmartAccessGatewayBgpRouteResponseBody::TaskStates>) };
    inline vector<ViewSmartAccessGatewayBgpRouteResponseBody::TaskStates> getTaskStates() { DARABONBA_PTR_GET(taskStates_, vector<ViewSmartAccessGatewayBgpRouteResponseBody::TaskStates>) };
    inline ViewSmartAccessGatewayBgpRouteResponseBody& setTaskStates(const vector<ViewSmartAccessGatewayBgpRouteResponseBody::TaskStates> & taskStates) { DARABONBA_PTR_SET_VALUE(taskStates_, taskStates) };
    inline ViewSmartAccessGatewayBgpRouteResponseBody& setTaskStates(vector<ViewSmartAccessGatewayBgpRouteResponseBody::TaskStates> && taskStates) { DARABONBA_PTR_SET_RVALUE(taskStates_, taskStates) };
  ...
  protected:
    ...
    shared_ptr<vector<ViewSmartAccessGatewayBgpRouteResponseBody::TaskStates>> taskStates_ {};
  };
