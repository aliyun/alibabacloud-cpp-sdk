...
#ifndef ALIBABACLOUD_MODELS_DESCRIBESAGUSERDNSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBESAGUSERDNSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeSagUserDnsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeSagUserDnsResponseBody& obj) { 
    ...
    DescribeSagUserDnsResponseBody() = default ;
    DescribeSagUserDnsResponseBody(const DescribeSagUserDnsResponseBody &) = default ;
    DescribeSagUserDnsResponseBody(DescribeSagUserDnsResponseBody &&) = default ;
    DescribeSagUserDnsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeSagUserDnsResponseBody() = default ;
    DescribeSagUserDnsResponseBody& operator=(const DescribeSagUserDnsResponseBody &) = default ;
    DescribeSagUserDnsResponseBody& operator=(DescribeSagUserDnsResponseBody &&) = default ;
    ...
    inline DescribeSagUserDnsResponseBody& setMasterDns(string masterDns) { DARABONBA_PTR_SET_VALUE(masterDns_, masterDns) };
    ...
    inline DescribeSagUserDnsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeSagUserDnsResponseBody& setSlaveDns(string slaveDns) { DARABONBA_PTR_SET_VALUE(slaveDns_, slaveDns) };
    ...
    inline const vector<DescribeSagUserDnsResponseBody::TaskStates> & getTaskStates() const { DARABONBA_PTR_GET_CONST(taskStates_, vector<DescribeSagUserDnsResponseBody::TaskStates>) };
    inline vector<DescribeSagUserDnsResponseBody::TaskStates> getTaskStates() { DARABONBA_PTR_GET(taskStates_, vector<DescribeSagUserDnsResponseBody::TaskStates>) };
    inline DescribeSagUserDnsResponseBody& setTaskStates(const vector<DescribeSagUserDnsResponseBody::TaskStates> & taskStates) { DARABONBA_PTR_SET_VALUE(taskStates_, taskStates) };
    inline DescribeSagUserDnsResponseBody& setTaskStates(vector<DescribeSagUserDnsResponseBody::TaskStates> && taskStates) { DARABONBA_PTR_SET_RVALUE(taskStates_, taskStates) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeSagUserDnsResponseBody::TaskStates>> taskStates_ {};
  };
