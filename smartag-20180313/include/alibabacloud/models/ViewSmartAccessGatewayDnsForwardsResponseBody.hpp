...
#ifndef ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYDNSFORWARDSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYDNSFORWARDSRESPONSEBODY_HPP_
...
namespace Models
{
  class ViewSmartAccessGatewayDnsForwardsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ViewSmartAccessGatewayDnsForwardsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ViewSmartAccessGatewayDnsForwardsResponseBody& obj) { 
    ...
    ViewSmartAccessGatewayDnsForwardsResponseBody() = default ;
    ViewSmartAccessGatewayDnsForwardsResponseBody(const ViewSmartAccessGatewayDnsForwardsResponseBody &) = default ;
    ViewSmartAccessGatewayDnsForwardsResponseBody(ViewSmartAccessGatewayDnsForwardsResponseBody &&) = default ;
    ViewSmartAccessGatewayDnsForwardsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ViewSmartAccessGatewayDnsForwardsResponseBody() = default ;
    ViewSmartAccessGatewayDnsForwardsResponseBody& operator=(const ViewSmartAccessGatewayDnsForwardsResponseBody &) = default ;
    ViewSmartAccessGatewayDnsForwardsResponseBody& operator=(ViewSmartAccessGatewayDnsForwardsResponseBody &&) = default ;
    ...
    inline ViewSmartAccessGatewayDnsForwardsResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ViewSmartAccessGatewayDnsForwardsResponseBody& setCount(int32_t count) { DARABONBA_PTR_SET_VALUE(count_, count) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<ViewSmartAccessGatewayDnsForwardsResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ViewSmartAccessGatewayDnsForwardsResponseBody::Data>) };
    inline vector<ViewSmartAccessGatewayDnsForwardsResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ViewSmartAccessGatewayDnsForwardsResponseBody::Data>) };
    inline ViewSmartAccessGatewayDnsForwardsResponseBody& setData(const vector<ViewSmartAccessGatewayDnsForwardsResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ViewSmartAccessGatewayDnsForwardsResponseBody& setData(vector<ViewSmartAccessGatewayDnsForwardsResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ViewSmartAccessGatewayDnsForwardsResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ViewSmartAccessGatewayDnsForwardsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ViewSmartAccessGatewayDnsForwardsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ViewSmartAccessGatewayDnsForwardsResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    shared_ptr<vector<ViewSmartAccessGatewayDnsForwardsResponseBody::Data>> data_ {};
