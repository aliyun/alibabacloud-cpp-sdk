...
#ifndef ALIBABACLOUD_MODELS_ADDDNATENTRYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ADDDNATENTRYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddDnatEntryRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddDnatEntryRequest& obj) { 
    ...
    AddDnatEntryRequest() = default ;
    AddDnatEntryRequest(const AddDnatEntryRequest &) = default ;
    AddDnatEntryRequest(AddDnatEntryRequest &&) = default ;
    AddDnatEntryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddDnatEntryRequest() = default ;
    AddDnatEntryRequest& operator=(const AddDnatEntryRequest &) = default ;
    AddDnatEntryRequest& operator=(AddDnatEntryRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->externalIp_ == nullptr
        && this->externalPort_ == nullptr && this->internalIp_ == nullptr && this->internalPort_ == nullptr && this->ipProtocol_ == nullptr && this->ownerAccount_ == nullptr
    ...
    inline AddDnatEntryRequest& setExternalIp(string externalIp) { DARABONBA_PTR_SET_VALUE(externalIp_, externalIp) };
    ...
    inline AddDnatEntryRequest& setExternalPort(string externalPort) { DARABONBA_PTR_SET_VALUE(externalPort_, externalPort) };
    ...
    inline AddDnatEntryRequest& setInternalIp(string internalIp) { DARABONBA_PTR_SET_VALUE(internalIp_, internalIp) };
    ...
    inline AddDnatEntryRequest& setInternalPort(string internalPort) { DARABONBA_PTR_SET_VALUE(internalPort_, internalPort) };
    ...
    inline AddDnatEntryRequest& setIpProtocol(string ipProtocol) { DARABONBA_PTR_SET_VALUE(ipProtocol_, ipProtocol) };
    ...
    inline AddDnatEntryRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline AddDnatEntryRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline AddDnatEntryRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline AddDnatEntryRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline AddDnatEntryRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline AddDnatEntryRequest& setSagId(string sagId) { DARABONBA_PTR_SET_VALUE(sagId_, sagId) };
    ...
    inline AddDnatEntryRequest& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
