...
namespace Models
{
  ...
  public:
    ...
    inline const CreateQosPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateQosPolicyResponseBody) };
    inline CreateQosPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateQosPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateQosPolicyResponseBody> body_ {};
  };
