...
#ifndef ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYBGPROUTEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYBGPROUTEREQUEST_HPP_
...
namespace Models
{
  class ViewSmartAccessGatewayBgpRouteRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ViewSmartAccessGatewayBgpRouteRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ViewSmartAccessGatewayBgpRouteRequest& obj) { 
    ...
    ViewSmartAccessGatewayBgpRouteRequest() = default ;
    ViewSmartAccessGatewayBgpRouteRequest(const ViewSmartAccessGatewayBgpRouteRequest &) = default ;
    ViewSmartAccessGatewayBgpRouteRequest(ViewSmartAccessGatewayBgpRouteRequest &&) = default ;
    ViewSmartAccessGatewayBgpRouteRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ViewSmartAccessGatewayBgpRouteRequest() = default ;
    ViewSmartAccessGatewayBgpRouteRequest& operator=(const ViewSmartAccessGatewayBgpRouteRequest &) = default ;
    ViewSmartAccessGatewayBgpRouteRequest& operator=(ViewSmartAccessGatewayBgpRouteRequest &&) = default ;
    ...
    inline ViewSmartAccessGatewayBgpRouteRequest& setCrossAccount(bool crossAccount) { DARABONBA_PTR_SET_VALUE(crossAccount_, crossAccount) };
    ...
    inline ViewSmartAccessGatewayBgpRouteRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline ViewSmartAccessGatewayBgpRouteRequest& setResourceUid(string resourceUid) { DARABONBA_PTR_SET_VALUE(resourceUid_, resourceUid) };
    ...
    inline ViewSmartAccessGatewayBgpRouteRequest& setSagInsId(string sagInsId) { DARABONBA_PTR_SET_VALUE(sagInsId_, sagInsId) };
    ...
    inline ViewSmartAccessGatewayBgpRouteRequest& setSagSn(string sagSn) { DARABONBA_PTR_SET_VALUE(sagSn_, sagSn) };
