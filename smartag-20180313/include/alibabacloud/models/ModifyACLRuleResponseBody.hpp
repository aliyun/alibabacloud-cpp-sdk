...
#ifndef ALIBABACLOUD_MODELS_MODIFYACLRULERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_MODIFYACLRULERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyACLRuleResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyACLRuleResponseBody& obj) { 
    ...
    ModifyACLRuleResponseBody() = default ;
    ModifyACLRuleResponseBody(const ModifyACLRuleResponseBody &) = default ;
    ModifyACLRuleResponseBody(ModifyACLRuleResponseBody &&) = default ;
    ModifyACLRuleResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyACLRuleResponseBody() = default ;
    ModifyACLRuleResponseBody& operator=(const ModifyACLRuleResponseBody &) = default ;
    ModifyACLRuleResponseBody& operator=(ModifyACLRuleResponseBody &&) = default ;
    ...
    inline ModifyACLRuleResponseBody& setAclId(string aclId) { DARABONBA_PTR_SET_VALUE(aclId_, aclId) };
    ...
    inline ModifyACLRuleResponseBody& setAcrId(string acrId) { DARABONBA_PTR_SET_VALUE(acrId_, acrId) };
    ...
    inline ModifyACLRuleResponseBody& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ModifyACLRuleResponseBody& setDestCidr(string destCidr) { DARABONBA_PTR_SET_VALUE(destCidr_, destCidr) };
    ...
    inline ModifyACLRuleResponseBody& setDestPortRange(string destPortRange) { DARABONBA_PTR_SET_VALUE(destPortRange_, destPortRange) };
    ...
    inline ModifyACLRuleResponseBody& setDirection(string direction) { DARABONBA_PTR_SET_VALUE(direction_, direction) };
    ...
    inline const ModifyACLRuleResponseBody::DpiGroupIds & getDpiGroupIds() const { DARABONBA_PTR_GET_CONST(dpiGroupIds_, ModifyACLRuleResponseBody::DpiGroupIds) };
    inline ModifyACLRuleResponseBody::DpiGroupIds getDpiGroupIds() { DARABONBA_PTR_GET(dpiGroupIds_, ModifyACLRuleResponseBody::DpiGroupIds) };
    inline ModifyACLRuleResponseBody& setDpiGroupIds(const ModifyACLRuleResponseBody::DpiGroupIds & dpiGroupIds) { DARABONBA_PTR_SET_VALUE(dpiGroupIds_, dpiGroupIds) };
    inline ModifyACLRuleResponseBody& setDpiGroupIds(ModifyACLRuleResponseBody::DpiGroupIds && dpiGroupIds) { DARABONBA_PTR_SET_RVALUE(dpiGroupIds_, dpiGroupIds) };
    ...
    inline const ModifyACLRuleResponseBody::DpiSignatureIds & getDpiSignatureIds() const { DARABONBA_PTR_GET_CONST(dpiSignatureIds_, ModifyACLRuleResponseBody::DpiSignatureIds) };
    inline ModifyACLRuleResponseBody::DpiSignatureIds getDpiSignatureIds() { DARABONBA_PTR_GET(dpiSignatureIds_, ModifyACLRuleResponseBody::DpiSignatureIds) };
    inline ModifyACLRuleResponseBody& setDpiSignatureIds(const ModifyACLRuleResponseBody::DpiSignatureIds & dpiSignatureIds) { DARABONBA_PTR_SET_VALUE(dpiSignatureIds_, dpiSignatureIds) };
    inline ModifyACLRuleResponseBody& setDpiSignatureIds(ModifyACLRuleResponseBody::DpiSignatureIds && dpiSignatureIds) { DARABONBA_PTR_SET_RVALUE(dpiSignatureIds_, dpiSignatureIds) };
    ...
    inline ModifyACLRuleResponseBody& setGmtCreate(int64_t gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline ModifyACLRuleResponseBody& setIpProtocol(string ipProtocol) { DARABONBA_PTR_SET_VALUE(ipProtocol_, ipProtocol) };
    ...
    inline ModifyACLRuleResponseBody& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ModifyACLRuleResponseBody& setPolicy(string policy) { DARABONBA_PTR_SET_VALUE(policy_, policy) };
    ...
    inline ModifyACLRuleResponseBody& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline ModifyACLRuleResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ModifyACLRuleResponseBody& setSourceCidr(string sourceCidr) { DARABONBA_PTR_SET_VALUE(sourceCidr_, sourceCidr) };
    ...
    inline ModifyACLRuleResponseBody& setSourcePortRange(string sourcePortRange) { DARABONBA_PTR_SET_VALUE(sourcePortRange_, sourcePortRange) };
