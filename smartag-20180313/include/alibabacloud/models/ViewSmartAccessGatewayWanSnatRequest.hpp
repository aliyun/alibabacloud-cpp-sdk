...
#ifndef ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYWANSNATREQUEST_HPP_
#define ALIBABACLOUD_MODELS_VIEWSMARTACCESSGATEWAYWANSNATREQUEST_HPP_
...
namespace Models
{
  class ViewSmartAccessGatewayWanSnatRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ViewSmartAccessGatewayWanSnatRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ViewSmartAccessGatewayWanSnatRequest& obj) { 
    ...
    ViewSmartAccessGatewayWanSnatRequest() = default ;
    ViewSmartAccessGatewayWanSnatRequest(const ViewSmartAccessGatewayWanSnatRequest &) = default ;
    ViewSmartAccessGatewayWanSnatRequest(ViewSmartAccessGatewayWanSnatRequest &&) = default ;
    ViewSmartAccessGatewayWanSnatRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ViewSmartAccessGatewayWanSnatRequest() = default ;
    ViewSmartAccessGatewayWanSnatRequest& operator=(const ViewSmartAccessGatewayWanSnatRequest &) = default ;
    ViewSmartAccessGatewayWanSnatRequest& operator=(ViewSmartAccessGatewayWanSnatRequest &&) = default ;
    ...
    inline ViewSmartAccessGatewayWanSnatRequest& setCrossAccount(bool crossAccount) { DARABONBA_PTR_SET_VALUE(crossAccount_, crossAccount) };
    ...
    inline ViewSmartAccessGatewayWanSnatRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline ViewSmartAccessGatewayWanSnatRequest& setResourceUid(string resourceUid) { DARABONBA_PTR_SET_VALUE(resourceUid_, resourceUid) };
    ...
    inline ViewSmartAccessGatewayWanSnatRequest& setSagInsId(string sagInsId) { DARABONBA_PTR_SET_VALUE(sagInsId_, sagInsId) };
    ...
    inline ViewSmartAccessGatewayWanSnatRequest& setSagSn(string sagSn) { DARABONBA_PTR_SET_VALUE(sagSn_, sagSn) };
