...
#ifndef ALIBABACLOUD_MODELS_DESCRIBESAGGLOBALROUTEPROTOCOLRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBESAGGLOBALROUTEPROTOCOLRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeSagGlobalRouteProtocolResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(RouteProtocol, routeProtocol_);
      DARABONBA_PTR_TO_JSON(TaskStates, taskStates_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeSagGlobalRouteProtocolResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(RouteProtocol, routeProtocol_);
      DARABONBA_PTR_FROM_JSON(TaskStates, taskStates_);
    };
    DescribeSagGlobalRouteProtocolResponseBody() = default ;
    DescribeSagGlobalRouteProtocolResponseBody(const DescribeSagGlobalRouteProtocolResponseBody &) = default ;
    DescribeSagGlobalRouteProtocolResponseBody(DescribeSagGlobalRouteProtocolResponseBody &&) = default ;
    DescribeSagGlobalRouteProtocolResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeSagGlobalRouteProtocolResponseBody() = default ;
    DescribeSagGlobalRouteProtocolResponseBody& operator=(const DescribeSagGlobalRouteProtocolResponseBody &) = default ;
    DescribeSagGlobalRouteProtocolResponseBody& operator=(DescribeSagGlobalRouteProtocolResponseBody &&) = default ;
    ...
    inline DescribeSagGlobalRouteProtocolResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeSagGlobalRouteProtocolResponseBody& setRouteProtocol(string routeProtocol) { DARABONBA_PTR_SET_VALUE(routeProtocol_, routeProtocol) };
    ...
    inline const vector<DescribeSagGlobalRouteProtocolResponseBody::TaskStates> & getTaskStates() const { DARABONBA_PTR_GET_CONST(taskStates_, vector<DescribeSagGlobalRouteProtocolResponseBody::TaskStates>) };
    inline vector<DescribeSagGlobalRouteProtocolResponseBody::TaskStates> getTaskStates() { DARABONBA_PTR_GET(taskStates_, vector<DescribeSagGlobalRouteProtocolResponseBody::TaskStates>) };
    inline DescribeSagGlobalRouteProtocolResponseBody& setTaskStates(const vector<DescribeSagGlobalRouteProtocolResponseBody::TaskStates> & taskStates) { DARABONBA_PTR_SET_VALUE(taskStates_, taskStates) };
    inline DescribeSagGlobalRouteProtocolResponseBody& setTaskStates(vector<DescribeSagGlobalRouteProtocolResponseBody::TaskStates> && taskStates) { DARABONBA_PTR_SET_RVALUE(taskStates_, taskStates) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeSagGlobalRouteProtocolResponseBody::TaskStates>> taskStates_ {};
  };
