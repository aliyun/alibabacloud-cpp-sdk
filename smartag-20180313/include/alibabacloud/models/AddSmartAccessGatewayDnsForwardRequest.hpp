...
#ifndef ALIBABACLOUD_MODELS_ADDSMARTACCESSGATEWAYDNSFORWARDREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ADDSMARTACCESSGATEWAYDNSFORWARDREQUEST_HPP_
...
namespace Models
{
  class AddSmartAccessGatewayDnsForwardRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const AddSmartAccessGatewayDnsForwardRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddSmartAccessGatewayDnsForwardRequest& obj) { 
    ...
    AddSmartAccessGatewayDnsForwardRequest() = default ;
    AddSmartAccessGatewayDnsForwardRequest(const AddSmartAccessGatewayDnsForwardRequest &) = default ;
    AddSmartAccessGatewayDnsForwardRequest(AddSmartAccessGatewayDnsForwardRequest &&) = default ;
    AddSmartAccessGatewayDnsForwardRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddSmartAccessGatewayDnsForwardRequest() = default ;
    AddSmartAccessGatewayDnsForwardRequest& operator=(const AddSmartAccessGatewayDnsForwardRequest &) = default ;
    AddSmartAccessGatewayDnsForwardRequest& operator=(AddSmartAccessGatewayDnsForwardRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->domain_ == nullptr
        && this->masterIp_ == nullptr && this->mode_ == nullptr && this->outboundPortIndex_ == nullptr && this->outboundPortName_ == nullptr && this->outboundPortType_ == nullptr
        && this->regionId_ == nullptr && this->sagInsId_ == nullptr && this->sagSn_ == nullptr && this->slaveIp_ == nullptr; };
    // domain Field Functions 
    bool hasDomain() const { return this->domain_ != nullptr;};
    void deleteDomain() { this->domain_ = nullptr;};
    inline string getDomain() const { DARABONBA_PTR_GET_DEFAULT(domain_, "") };
    inline AddSmartAccessGatewayDnsForwardRequest& setDomain(string domain) { DARABONBA_PTR_SET_VALUE(domain_, domain) };
    ...
    inline AddSmartAccessGatewayDnsForwardRequest& setMasterIp(string masterIp) { DARABONBA_PTR_SET_VALUE(masterIp_, masterIp) };
    ...
    inline AddSmartAccessGatewayDnsForwardRequest& setMode(string mode) { DARABONBA_PTR_SET_VALUE(mode_, mode) };
    ...
    inline string getOutboundPortIndex() const { DARABONBA_PTR_GET_DEFAULT(outboundPortIndex_, "") };
    inline AddSmartAccessGatewayDnsForwardRequest& setOutboundPortIndex(string outboundPortIndex) { DARABONBA_PTR_SET_VALUE(outboundPortIndex_, outboundPortIndex) };
    ...
    inline AddSmartAccessGatewayDnsForwardRequest& setOutboundPortName(string outboundPortName) { DARABONBA_PTR_SET_VALUE(outboundPortName_, outboundPortName) };
    ...
    inline AddSmartAccessGatewayDnsForwardRequest& setOutboundPortType(string outboundPortType) { DARABONBA_PTR_SET_VALUE(outboundPortType_, outboundPortType) };
    ...
    inline AddSmartAccessGatewayDnsForwardRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline AddSmartAccessGatewayDnsForwardRequest& setSagInsId(string sagInsId) { DARABONBA_PTR_SET_VALUE(sagInsId_, sagInsId) };
    ...
    inline AddSmartAccessGatewayDnsForwardRequest& setSagSn(string sagSn) { DARABONBA_PTR_SET_VALUE(sagSn_, sagSn) };
    ...
    inline AddSmartAccessGatewayDnsForwardRequest& setSlaveIp(string slaveIp) { DARABONBA_PTR_SET_VALUE(slaveIp_, slaveIp) };
  ...
  protected:
    ...
    shared_ptr<string> outboundPortIndex_ {};
    // The egress port.
    // 
    // > 
    // *   This parameter is optional if OutboundPortType is set to PhysicalPort. Ignore this parameter if OutboundPortType is set to Tunnel.
