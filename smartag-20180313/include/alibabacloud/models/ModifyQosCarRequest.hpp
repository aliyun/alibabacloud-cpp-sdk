...
#ifndef ALIBABACLOUD_MODELS_MODIFYQOSCARREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MODIFYQOSCARREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyQosCarRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyQosCarRequest& obj) { 
    ...
    ModifyQosCarRequest() = default ;
    ModifyQosCarRequest(const ModifyQosCarRequest &) = default ;
    ModifyQosCarRequest(ModifyQosCarRequest &&) = default ;
    ModifyQosCarRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyQosCarRequest() = default ;
    ModifyQosCarRequest& operator=(const ModifyQosCarRequest &) = default ;
    ModifyQosCarRequest& operator=(ModifyQosCarRequest &&) = default ;
    ...
    inline ModifyQosCarRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ModifyQosCarRequest& setLimitType(string limitType) { DARABONBA_PTR_SET_VALUE(limitType_, limitType) };
    ...
    inline ModifyQosCarRequest& setMaxBandwidthAbs(int32_t maxBandwidthAbs) { DARABONBA_PTR_SET_VALUE(maxBandwidthAbs_, maxBandwidthAbs) };
    ...
    inline ModifyQosCarRequest& setMaxBandwidthPercent(int32_t maxBandwidthPercent) { DARABONBA_PTR_SET_VALUE(maxBandwidthPercent_, maxBandwidthPercent) };
    ...
    inline ModifyQosCarRequest& setMinBandwidthAbs(int32_t minBandwidthAbs) { DARABONBA_PTR_SET_VALUE(minBandwidthAbs_, minBandwidthAbs) };
    ...
    inline ModifyQosCarRequest& setMinBandwidthPercent(int32_t minBandwidthPercent) { DARABONBA_PTR_SET_VALUE(minBandwidthPercent_, minBandwidthPercent) };
    ...
    inline ModifyQosCarRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ModifyQosCarRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline ModifyQosCarRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline ModifyQosCarRequest& setPercentSourceType(string percentSourceType) { DARABONBA_PTR_SET_VALUE(percentSourceType_, percentSourceType) };
    ...
    inline ModifyQosCarRequest& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline ModifyQosCarRequest& setQosCarId(string qosCarId) { DARABONBA_PTR_SET_VALUE(qosCarId_, qosCarId) };
    ...
    inline ModifyQosCarRequest& setQosId(string qosId) { DARABONBA_PTR_SET_VALUE(qosId_, qosId) };
    ...
    inline ModifyQosCarRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline ModifyQosCarRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline ModifyQosCarRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
