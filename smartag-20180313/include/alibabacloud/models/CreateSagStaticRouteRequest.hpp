...
#ifndef ALIBABACLOUD_MODELS_CREATESAGSTATICROUTEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATESAGSTATICROUTEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateSagStaticRouteRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateSagStaticRouteRequest& obj) { 
    ...
    CreateSagStaticRouteRequest() = default ;
    CreateSagStaticRouteRequest(const CreateSagStaticRouteRequest &) = default ;
    CreateSagStaticRouteRequest(CreateSagStaticRouteRequest &&) = default ;
    CreateSagStaticRouteRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateSagStaticRouteRequest() = default ;
    CreateSagStaticRouteRequest& operator=(const CreateSagStaticRouteRequest &) = default ;
    CreateSagStaticRouteRequest& operator=(CreateSagStaticRouteRequest &&) = default ;
    ...
    inline CreateSagStaticRouteRequest& setDestinationCidr(string destinationCidr) { DARABONBA_PTR_SET_VALUE(destinationCidr_, destinationCidr) };
    ...
    inline CreateSagStaticRouteRequest& setNextHop(string nextHop) { DARABONBA_PTR_SET_VALUE(nextHop_, nextHop) };
    ...
    inline CreateSagStaticRouteRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline CreateSagStaticRouteRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline CreateSagStaticRouteRequest& setPortName(string portName) { DARABONBA_PTR_SET_VALUE(portName_, portName) };
    ...
    inline CreateSagStaticRouteRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline CreateSagStaticRouteRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline CreateSagStaticRouteRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline CreateSagStaticRouteRequest& setSmartAGId(string smartAGId) { DARABONBA_PTR_SET_VALUE(smartAGId_, smartAGId) };
    ...
    inline CreateSagStaticRouteRequest& setSmartAGSn(string smartAGSn) { DARABONBA_PTR_SET_VALUE(smartAGSn_, smartAGSn) };
    ...
    inline CreateSagStaticRouteRequest& setVlan(string vlan) { DARABONBA_PTR_SET_VALUE(vlan_, vlan) };
