...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activeAging_ == nullptr
        && this->description_ == nullptr && this->inactiveAging_ == nullptr && this->logstoreName_ == nullptr && this->name_ == nullptr && this->netflowServerIp_ == nullptr
        && this->netflowServerPort_ == nullptr && this->netflowVersion_ == nullptr && this->outputType_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr
        && this->projectName_ == nullptr && this->regionId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->slsRegionId_ == nullptr; };
    ...
    inline CreateFlowLogRequest& setActiveAging(int32_t activeAging) { DARABONBA_PTR_SET_VALUE(activeAging_, activeAging) };
    ...
    inline CreateFlowLogRequest& setInactiveAging(int32_t inactiveAging) { DARABONBA_PTR_SET_VALUE(inactiveAging_, inactiveAging) };
    ...
    inline CreateFlowLogRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline CreateFlowLogRequest& setNetflowServerIp(string netflowServerIp) { DARABONBA_PTR_SET_VALUE(netflowServerIp_, netflowServerIp) };
    ...
    inline CreateFlowLogRequest& setNetflowServerPort(int32_t netflowServerPort) { DARABONBA_PTR_SET_VALUE(netflowServerPort_, netflowServerPort) };
    ...
    inline CreateFlowLogRequest& setNetflowVersion(string netflowVersion) { DARABONBA_PTR_SET_VALUE(netflowVersion_, netflowVersion) };
    ...
    inline CreateFlowLogRequest& setOutputType(string outputType) { DARABONBA_PTR_SET_VALUE(outputType_, outputType) };
    ...
    inline CreateFlowLogRequest& setSlsRegionId(string slsRegionId) { DARABONBA_PTR_SET_VALUE(slsRegionId_, slsRegionId) };
