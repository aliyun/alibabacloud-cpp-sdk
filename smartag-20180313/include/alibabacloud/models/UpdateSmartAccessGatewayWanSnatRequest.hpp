...
#ifndef ALIBABACLOUD_MODELS_UPDATESMARTACCESSGATEWAYWANSNATREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATESMARTACCESSGATEWAYWANSNATREQUEST_HPP_
...
namespace Models
{
  class UpdateSmartAccessGatewayWanSnatRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateSmartAccessGatewayWanSnatRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateSmartAccessGatewayWanSnatRequest& obj) { 
    ...
    UpdateSmartAccessGatewayWanSnatRequest() = default ;
    UpdateSmartAccessGatewayWanSnatRequest(const UpdateSmartAccessGatewayWanSnatRequest &) = default ;
    UpdateSmartAccessGatewayWanSnatRequest(UpdateSmartAccessGatewayWanSnatRequest &&) = default ;
    UpdateSmartAccessGatewayWanSnatRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateSmartAccessGatewayWanSnatRequest() = default ;
    UpdateSmartAccessGatewayWanSnatRequest& operator=(const UpdateSmartAccessGatewayWanSnatRequest &) = default ;
    UpdateSmartAccessGatewayWanSnatRequest& operator=(UpdateSmartAccessGatewayWanSnatRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->crossAccount_ == nullptr
        && this->regionId_ == nullptr && this->resourceUid_ == nullptr && this->sagInsId_ == nullptr && this->sagSn_ == nullptr && this->snat_ == nullptr; };
    ...
    inline UpdateSmartAccessGatewayWanSnatRequest& setCrossAccount(bool crossAccount) { DARABONBA_PTR_SET_VALUE(crossAccount_, crossAccount) };
    ...
    inline UpdateSmartAccessGatewayWanSnatRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline UpdateSmartAccessGatewayWanSnatRequest& setResourceUid(string resourceUid) { DARABONBA_PTR_SET_VALUE(resourceUid_, resourceUid) };
    ...
    inline UpdateSmartAccessGatewayWanSnatRequest& setSagInsId(string sagInsId) { DARABONBA_PTR_SET_VALUE(sagInsId_, sagInsId) };
    ...
    inline UpdateSmartAccessGatewayWanSnatRequest& setSagSn(string sagSn) { DARABONBA_PTR_SET_VALUE(sagSn_, sagSn) };
    ...
    inline UpdateSmartAccessGatewayWanSnatRequest& setSnat(string snat) { DARABONBA_PTR_SET_VALUE(snat_, snat) };
