...
namespace Models
{
  ...
  public:
    ...
    inline const BuildStsAK2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BuildStsAK2ResponseBody) };
    inline BuildStsAK2ResponseBody getBody() { DARABONBA_PTR_GET(body_, BuildStsAK2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BuildStsAK2ResponseBody> body_ {};
  };
