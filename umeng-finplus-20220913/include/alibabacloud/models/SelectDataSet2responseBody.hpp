...
namespace Models
{
  ...
  public:
    ...
    inline const SelectDataSet2ResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SelectDataSet2ResponseBodyData) };
    inline SelectDataSet2ResponseBodyData data() { DARABONBA_PTR_GET(data_, SelectDataSet2ResponseBodyData) };
    inline SelectDataSet2ResponseBody& setData(const SelectDataSet2ResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SelectDataSet2ResponseBody& setData(SelectDataSet2ResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SelectDataSet2ResponseBodyData> data_ = nullptr;
