...
namespace Models
{
  ...
  public:
    ...
    inline const SelectComputeTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SelectComputeTaskResponseBody) };
    inline SelectComputeTaskResponseBody body() { DARABONBA_PTR_GET(body_, SelectComputeTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SelectComputeTaskResponseBody> body_ = nullptr;
  };
