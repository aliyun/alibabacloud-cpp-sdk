...
namespace Models
{
  ...
  public:
    ...
    inline const CreateComputeTask2ResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateComputeTask2ResponseBody) };
    inline CreateComputeTask2ResponseBody body() { DARABONBA_PTR_GET(body_, CreateComputeTask2ResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateComputeTask2ResponseBody> body_ = nullptr;
  };
