...
namespace Models
{
  ...
  public:
    ...
    inline CancelTaskResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline CancelTaskResponseBody& setData(bool data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline CancelTaskResponseBody& setMsg(string msg) { DARABONBA_PTR_SET_VALUE(msg_, msg) };
    ...
    inline CancelTaskResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
