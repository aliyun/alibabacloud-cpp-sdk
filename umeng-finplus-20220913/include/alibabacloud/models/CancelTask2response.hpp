...
namespace Models
{
  ...
  public:
    ...
    inline const CancelTask2ResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CancelTask2ResponseBody) };
    inline CancelTask2ResponseBody body() { DARABONBA_PTR_GET(body_, CancelTask2ResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CancelTask2ResponseBody> body_ = nullptr;
  };
