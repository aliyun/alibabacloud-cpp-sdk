...
namespace Models
{
  ...
  public:
    ...
    inline const BuildStsAKResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BuildStsAKResponseBody) };
    inline BuildStsAKResponseBody getBody() { DARABONBA_PTR_GET(body_, BuildStsAKResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BuildStsAKResponseBody> body_ {};
  };
