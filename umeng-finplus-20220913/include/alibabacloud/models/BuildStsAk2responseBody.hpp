...
namespace Models
{
  ...
  public:
    ...
    inline const BuildStsAK2ResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, BuildStsAK2ResponseBodyData) };
    inline BuildStsAK2ResponseBodyData data() { DARABONBA_PTR_GET(data_, BuildStsAK2ResponseBodyData) };
    inline BuildStsAK2ResponseBody& setData(const BuildStsAK2ResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BuildStsAK2ResponseBody& setData(BuildStsAK2ResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<BuildStsAK2ResponseBodyData> data_ = nullptr;
