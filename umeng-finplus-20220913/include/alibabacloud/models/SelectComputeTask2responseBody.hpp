...
namespace Models
{
  ...
  public:
    ...
    inline const SelectComputeTask2ResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SelectComputeTask2ResponseBodyData) };
    inline SelectComputeTask2ResponseBodyData data() { DARABONBA_PTR_GET(data_, SelectComputeTask2ResponseBodyData) };
    inline SelectComputeTask2ResponseBody& setData(const SelectComputeTask2ResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SelectComputeTask2ResponseBody& setData(SelectComputeTask2ResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SelectComputeTask2ResponseBodyData> data_ = nullptr;
