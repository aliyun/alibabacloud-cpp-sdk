...
namespace Models
{
  ...
  public:
    ...
    inline const SelectComputeTask2ResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SelectComputeTask2ResponseBody) };
    inline SelectComputeTask2ResponseBody body() { DARABONBA_PTR_GET(body_, SelectComputeTask2ResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SelectComputeTask2ResponseBody> body_ = nullptr;
  };
