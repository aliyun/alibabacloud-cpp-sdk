...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetKnowledgeDataResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetKnowledgeDataResponseBodyData>) };
    inline vector<GetKnowledgeDataResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetKnowledgeDataResponseBodyData>) };
    inline GetKnowledgeDataResponseBody& setData(const vector<GetKnowledgeDataResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetKnowledgeDataResponseBody& setData(vector<GetKnowledgeDataResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetKnowledgeDataResponseBodyData>> data_ = nullptr;
