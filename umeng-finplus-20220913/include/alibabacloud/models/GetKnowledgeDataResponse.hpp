...
namespace Models
{
  ...
  public:
    ...
    inline const GetKnowledgeDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetKnowledgeDataResponseBody) };
    inline GetKnowledgeDataResponseBody getBody() { DARABONBA_PTR_GET(body_, GetKnowledgeDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetKnowledgeDataResponseBody> body_ {};
  };
