...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListComputeTaskResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListComputeTaskResponseBody::Data>) };
    inline vector<ListComputeTaskResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListComputeTaskResponseBody::Data>) };
    inline ListComputeTaskResponseBody& setData(const vector<ListComputeTaskResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListComputeTaskResponseBody& setData(vector<ListComputeTaskResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<vector<ListComputeTaskResponseBody::Data>> data_ {};
