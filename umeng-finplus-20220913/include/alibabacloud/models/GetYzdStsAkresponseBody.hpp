...
namespace Models
{
  ...
  public:
    ...
    inline const GetYzdStsAKResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetYzdStsAKResponseBodyData) };
    inline GetYzdStsAKResponseBodyData data() { DARABONBA_PTR_GET(data_, GetYzdStsAKResponseBodyData) };
    inline GetYzdStsAKResponseBody& setData(const GetYzdStsAKResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetYzdStsAKResponseBody& setData(GetYzdStsAKResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetYzdStsAKResponseBodyData> data_ = nullptr;
