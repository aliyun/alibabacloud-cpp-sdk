...
namespace Models
{
  ...
  public:
    ...
    inline const EncryptInvokeResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, EncryptInvokeResponseBodyData) };
    inline EncryptInvokeResponseBodyData data() { DARABONBA_PTR_GET(data_, EncryptInvokeResponseBodyData) };
    inline EncryptInvokeResponseBody& setData(const EncryptInvokeResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline EncryptInvokeResponseBody& setData(EncryptInvokeResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<EncryptInvokeResponseBodyData> data_ = nullptr;
