...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bcConfirm_ == nullptr
    ...
    inline bool getBcConfirm() const { DARABONBA_PTR_GET_DEFAULT(bcConfirm_, false) };
