...
namespace Models
{
  ...
  public:
    ...
    inline const EncryptInvokeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EncryptInvokeResponseBody) };
    inline EncryptInvokeResponseBody getBody() { DARABONBA_PTR_GET(body_, EncryptInvokeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EncryptInvokeResponseBody> body_ {};
  };
