...
namespace Models
{
  ...
  public:
    ...
    inline CreateDataSetResponseBody& setData(int64_t data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline CreateDataSetResponseBody& setMsg(string msg) { DARABONBA_PTR_SET_VALUE(msg_, msg) };
