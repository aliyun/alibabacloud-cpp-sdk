...
namespace Models
{
  ...
  public:
    ...
    inline const SaveCrowdDatasetAndBindingDatasetResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SaveCrowdDatasetAndBindingDatasetResponseBodyData) };
    inline SaveCrowdDatasetAndBindingDatasetResponseBodyData data() { DARABONBA_PTR_GET(data_, SaveCrowdDatasetAndBindingDatasetResponseBodyData) };
    inline SaveCrowdDatasetAndBindingDatasetResponseBody& setData(const SaveCrowdDatasetAndBindingDatasetResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SaveCrowdDatasetAndBindingDatasetResponseBody& setData(SaveCrowdDatasetAndBindingDatasetResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SaveCrowdDatasetAndBindingDatasetResponseBodyData> data_ = nullptr;
