...
namespace Models
{
  ...
  public:
    ...
    inline const SelectDataSetResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SelectDataSetResponseBodyData) };
    inline SelectDataSetResponseBodyData data() { DARABONBA_PTR_GET(data_, SelectDataSetResponseBodyData) };
    inline SelectDataSetResponseBody& setData(const SelectDataSetResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SelectDataSetResponseBody& setData(SelectDataSetResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SelectDataSetResponseBodyData> data_ = nullptr;
