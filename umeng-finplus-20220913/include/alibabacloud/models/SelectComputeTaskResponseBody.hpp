...
namespace Models
{
  ...
  public:
    ...
    inline const SelectComputeTaskResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SelectComputeTaskResponseBody::Data) };
    inline SelectComputeTaskResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SelectComputeTaskResponseBody::Data) };
    inline SelectComputeTaskResponseBody& setData(const SelectComputeTaskResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SelectComputeTaskResponseBody& setData(SelectComputeTaskResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<SelectComputeTaskResponseBody::Data> data_ {};
