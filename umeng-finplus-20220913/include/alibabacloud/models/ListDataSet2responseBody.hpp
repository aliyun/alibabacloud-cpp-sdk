...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataSet2ResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListDataSet2ResponseBodyData) };
    inline ListDataSet2ResponseBodyData data() { DARABONBA_PTR_GET(data_, ListDataSet2ResponseBodyData) };
    inline ListDataSet2ResponseBody& setData(const ListDataSet2ResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDataSet2ResponseBody& setData(ListDataSet2ResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataSet2ResponseBodyData> data_ = nullptr;
