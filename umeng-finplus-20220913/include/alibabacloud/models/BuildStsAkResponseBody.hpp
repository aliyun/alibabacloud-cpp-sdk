...
namespace Models
{
  ...
  public:
    ...
    inline const BuildStsAKResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, BuildStsAKResponseBody::Data) };
    inline BuildStsAKResponseBody::Data getData() { DARABONBA_PTR_GET(data_, BuildStsAKResponseBody::Data) };
    inline BuildStsAKResponseBody& setData(const BuildStsAKResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BuildStsAKResponseBody& setData(BuildStsAKResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<BuildStsAKResponseBody::Data> data_ {};
