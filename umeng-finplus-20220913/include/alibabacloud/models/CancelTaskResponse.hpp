...
namespace Models
{
  ...
  public:
    ...
    inline const CancelTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelTaskResponseBody) };
    inline CancelTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelTaskResponseBody> body_ {};
  };
