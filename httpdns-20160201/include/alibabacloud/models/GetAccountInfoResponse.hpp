...
namespace Models
{
  ...
  public:
    ...
    inline const GetAccountInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAccountInfoResponseBody) };
    inline GetAccountInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAccountInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAccountInfoResponseBody> body_ {};
  };
