...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainsResponseBody) };
    inline DescribeDomainsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainsResponseBody> body_ {};
  };
