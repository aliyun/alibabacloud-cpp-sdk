...
namespace Models
{
  ...
  public:
    ...
    inline const ListTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTasksResponseBody) };
    inline ListTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTasksResponseBody> body_ {};
  };
