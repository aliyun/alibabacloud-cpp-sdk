...
namespace Models
{
  ...
  public:
    ...
    inline DisassociatePrincipalFromPortfolioRequest& setPrincipalPattern(string principalPattern) { DARABONBA_PTR_SET_VALUE(principalPattern_, principalPattern) };
