...
#ifndef ALIBABACLOUD_MODELS_UPDATETAGOPTIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATETAGOPTIONRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateTagOptionResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(TagOptionDetail, tagOptionDetail_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateTagOptionResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(TagOptionDetail, tagOptionDetail_);
    };
    UpdateTagOptionResponseBody() = default ;
    UpdateTagOptionResponseBody(const UpdateTagOptionResponseBody &) = default ;
    UpdateTagOptionResponseBody(UpdateTagOptionResponseBody &&) = default ;
    UpdateTagOptionResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateTagOptionResponseBody() = default ;
    UpdateTagOptionResponseBody& operator=(const UpdateTagOptionResponseBody &) = default ;
    UpdateTagOptionResponseBody& operator=(UpdateTagOptionResponseBody &&) = default ;
    ...
    inline UpdateTagOptionResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline const UpdateTagOptionResponseBody::TagOptionDetail & getTagOptionDetail() const { DARABONBA_PTR_GET_CONST(tagOptionDetail_, UpdateTagOptionResponseBody::TagOptionDetail) };
    inline UpdateTagOptionResponseBody::TagOptionDetail getTagOptionDetail() { DARABONBA_PTR_GET(tagOptionDetail_, UpdateTagOptionResponseBody::TagOptionDetail) };
    inline UpdateTagOptionResponseBody& setTagOptionDetail(const UpdateTagOptionResponseBody::TagOptionDetail & tagOptionDetail) { DARABONBA_PTR_SET_VALUE(tagOptionDetail_, tagOptionDetail) };
    inline UpdateTagOptionResponseBody& setTagOptionDetail(UpdateTagOptionResponseBody::TagOptionDetail && tagOptionDetail) { DARABONBA_PTR_SET_RVALUE(tagOptionDetail_, tagOptionDetail) };
  ...
  protected:
    ...
    shared_ptr<UpdateTagOptionResponseBody::TagOptionDetail> tagOptionDetail_ {};
  };
