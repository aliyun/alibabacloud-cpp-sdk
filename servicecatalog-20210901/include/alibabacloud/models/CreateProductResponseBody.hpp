...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->productId_ == nullptr
        && this->productVersionId_ == nullptr && this->requestId_ == nullptr; };
    ...
    inline CreateProductResponseBody& setProductVersionId(string productVersionId) { DARABONBA_PTR_SET_VALUE(productVersionId_, productVersionId) };
