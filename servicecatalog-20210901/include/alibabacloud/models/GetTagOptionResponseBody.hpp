...
#ifndef ALIBABACLOUD_MODELS_GETTAGOPTIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETTAGOPTIONRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetTagOptionResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(TagOptionDetail, tagOptionDetail_);
    };
    friend void from_json(const Darabonba::Json& j, GetTagOptionResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(TagOptionDetail, tagOptionDetail_);
    };
    GetTagOptionResponseBody() = default ;
    GetTagOptionResponseBody(const GetTagOptionResponseBody &) = default ;
    GetTagOptionResponseBody(GetTagOptionResponseBody &&) = default ;
    GetTagOptionResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetTagOptionResponseBody() = default ;
    GetTagOptionResponseBody& operator=(const GetTagOptionResponseBody &) = default ;
    GetTagOptionResponseBody& operator=(GetTagOptionResponseBody &&) = default ;
    ...
    inline GetTagOptionResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline const GetTagOptionResponseBody::TagOptionDetail & getTagOptionDetail() const { DARABONBA_PTR_GET_CONST(tagOptionDetail_, GetTagOptionResponseBody::TagOptionDetail) };
    inline GetTagOptionResponseBody::TagOptionDetail getTagOptionDetail() { DARABONBA_PTR_GET(tagOptionDetail_, GetTagOptionResponseBody::TagOptionDetail) };
    inline GetTagOptionResponseBody& setTagOptionDetail(const GetTagOptionResponseBody::TagOptionDetail & tagOptionDetail) { DARABONBA_PTR_SET_VALUE(tagOptionDetail_, tagOptionDetail) };
    inline GetTagOptionResponseBody& setTagOptionDetail(GetTagOptionResponseBody::TagOptionDetail && tagOptionDetail) { DARABONBA_PTR_SET_RVALUE(tagOptionDetail_, tagOptionDetail) };
  ...
  protected:
    ...
    shared_ptr<GetTagOptionResponseBody::TagOptionDetail> tagOptionDetail_ {};
  };
