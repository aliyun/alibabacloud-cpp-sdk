...
namespace Models
{
  ...
  public:
    ...
    inline const CreateProductResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateProductResponseBody) };
    inline CreateProductResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateProductResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateProductResponseBody> body_ {};
  };
