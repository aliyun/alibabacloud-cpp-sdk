...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->b_ == nullptr
        && return this->cropType_ == nullptr && return this->fillType_ == nullptr && return this->g_ == nullptr && return this->height_ == nullptr && return this->r_ == nullptr
        && return this->tightness_ == nullptr && return this->videoUrl_ == nullptr && return this->width_ == nullptr; };
    // b Field Functions 
