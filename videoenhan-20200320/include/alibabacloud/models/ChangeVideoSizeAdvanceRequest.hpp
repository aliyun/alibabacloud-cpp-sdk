...
#ifndef ALIBABACLOUD_MODELS_CHANGEVIDEOSIZEADVANCEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CHANGEVIDEOSIZEADVANCEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChangeVideoSizeAdvanceRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChangeVideoSizeAdvanceRequest& obj) { 
    ...
    ChangeVideoSizeAdvanceRequest() = default ;
    ChangeVideoSizeAdvanceRequest(const ChangeVideoSizeAdvanceRequest &) = default ;
    ChangeVideoSizeAdvanceRequest(ChangeVideoSizeAdvanceRequest &&) = default ;
    ChangeVideoSizeAdvanceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChangeVideoSizeAdvanceRequest() = default ;
    ChangeVideoSizeAdvanceRequest& operator=(const ChangeVideoSizeAdvanceRequest &) = default ;
    ChangeVideoSizeAdvanceRequest& operator=(ChangeVideoSizeAdvanceRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->b_ == nullptr
        ...
        && return this->tightness_ == nullptr && return this->videoUrlObject_ == nullptr && return this->width_ == nullptr; };
    // b Field Functions 
    bool hasB() const { return this->b_ != nullptr;};
    void deleteB() { this->b_ = nullptr;};
    inline int32_t b() const { DARABONBA_PTR_GET_DEFAULT(b_, 0) };
    inline ChangeVideoSizeAdvanceRequest& setB(int32_t b) { DARABONBA_PTR_SET_VALUE(b_, b) };
    ...
    inline ChangeVideoSizeAdvanceRequest& setCropType(string cropType) { DARABONBA_PTR_SET_VALUE(cropType_, cropType) };
    ...
    inline ChangeVideoSizeAdvanceRequest& setFillType(string fillType) { DARABONBA_PTR_SET_VALUE(fillType_, fillType) };
    ...
    inline ChangeVideoSizeAdvanceRequest& setG(int32_t g) { DARABONBA_PTR_SET_VALUE(g_, g) };
    ...
    inline ChangeVideoSizeAdvanceRequest& setHeight(int32_t height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline ChangeVideoSizeAdvanceRequest& setR(int32_t r) { DARABONBA_PTR_SET_VALUE(r_, r) };
    ...
    inline ChangeVideoSizeAdvanceRequest& setTightness(float tightness) { DARABONBA_PTR_SET_VALUE(tightness_, tightness) };
    ...
    inline ChangeVideoSizeAdvanceRequest& setVideoUrlObject(shared_ptr<Darabonba::IStream> videoUrlObject) { DARABONBA_SET_VALUE(videoUrlObject_, videoUrlObject) };
    ...
    inline ChangeVideoSizeAdvanceRequest& setWidth(int32_t width) { DARABONBA_PTR_SET_VALUE(width_, width) };
