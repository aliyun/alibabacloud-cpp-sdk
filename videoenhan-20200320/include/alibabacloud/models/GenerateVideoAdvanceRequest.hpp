...
#ifndef ALIBABACLOUD_MODELS_GENERATEVIDEOADVANCEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GENERATEVIDEOADVANCEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GenerateVideoAdvanceRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GenerateVideoAdvanceRequest& obj) { 
    ...
    GenerateVideoAdvanceRequest() = default ;
    GenerateVideoAdvanceRequest(const GenerateVideoAdvanceRequest &) = default ;
    GenerateVideoAdvanceRequest(GenerateVideoAdvanceRequest &&) = default ;
    GenerateVideoAdvanceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GenerateVideoAdvanceRequest() = default ;
    GenerateVideoAdvanceRequest& operator=(const GenerateVideoAdvanceRequest &) = default ;
    GenerateVideoAdvanceRequest& operator=(GenerateVideoAdvanceRequest &&) = default ;
    ...
    inline GenerateVideoAdvanceRequest& setDuration(float duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
    ...
    inline GenerateVideoAdvanceRequest& setDurationAdaption(bool durationAdaption) { DARABONBA_PTR_SET_VALUE(durationAdaption_, durationAdaption) };


    // fileList Field Functions 
    bool hasFileList() const { return this->fileList_ != nullptr;};
    void deleteFileList() { this->fileList_ = nullptr;};
    inline const vector<GenerateVideoAdvanceRequestFileList> & fileList() const { DARABONBA_PTR_GET_CONST(fileList_, vector<GenerateVideoAdvanceRequestFileList>) };
    inline vector<GenerateVideoAdvanceRequestFileList> fileList() { DARABONBA_PTR_GET(fileList_, vector<GenerateVideoAdvanceRequestFileList>) };
    inline GenerateVideoAdvanceRequest& setFileList(const vector<GenerateVideoAdvanceRequestFileList> & fileList) { DARABONBA_PTR_SET_VALUE(fileList_, fileList) };
    inline GenerateVideoAdvanceRequest& setFileList(vector<GenerateVideoAdvanceRequestFileList> && fileList) { DARABONBA_PTR_SET_RVALUE(fileList_, fileList) };
    ...
    inline GenerateVideoAdvanceRequest& setHeight(int32_t height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline GenerateVideoAdvanceRequest& setMute(bool mute) { DARABONBA_PTR_SET_VALUE(mute_, mute) };
    ...
    inline GenerateVideoAdvanceRequest& setPuzzleEffect(bool puzzleEffect) { DARABONBA_PTR_SET_VALUE(puzzleEffect_, puzzleEffect) };
    ...
    inline GenerateVideoAdvanceRequest& setScene(string scene) { DARABONBA_PTR_SET_VALUE(scene_, scene) };
    ...
    inline GenerateVideoAdvanceRequest& setSmartEffect(bool smartEffect) { DARABONBA_PTR_SET_VALUE(smartEffect_, smartEffect) };
    ...
    inline GenerateVideoAdvanceRequest& setStyle(string style) { DARABONBA_PTR_SET_VALUE(style_, style) };
    ...
    inline GenerateVideoAdvanceRequest& setTransitionStyle(string transitionStyle) { DARABONBA_PTR_SET_VALUE(transitionStyle_, transitionStyle) };
    ...
    inline GenerateVideoAdvanceRequest& setWidth(int32_t width) { DARABONBA_PTR_SET_VALUE(width_, width) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GenerateVideoAdvanceRequestFileList>> fileList_ = nullptr;
