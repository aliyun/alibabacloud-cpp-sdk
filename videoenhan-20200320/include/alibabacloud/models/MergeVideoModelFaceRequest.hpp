...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addWatermark_ == nullptr
        && return this->enhance_ == nullptr && return this->faceImageURL_ == nullptr && return this->mergeInfos_ == nullptr && return this->templateId_ == nullptr && return this->watermarkType_ == nullptr; };
