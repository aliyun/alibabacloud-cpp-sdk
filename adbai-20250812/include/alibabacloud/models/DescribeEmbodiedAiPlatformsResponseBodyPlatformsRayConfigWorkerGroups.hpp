...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEEMBODIEDAIPLATFORMSRESPONSEBODYPLATFORMSRAYCONFIGWORKERGROUPS_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEEMBODIEDAIPLATFORMSRESPONSEBODYPLATFORMSRAYCONFIGWORKERGROUPS_HPP_
...
namespace Models
{
  class DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups& obj) { 
    ...
    DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups() = default ;
    DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups(const DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups &) = default ;
    DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups(DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups &&) = default ;
    DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups() = default ;
    DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups& operator=(const DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups &) = default ;
    DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups& operator=(DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups &&) = default ;
    ...
    inline DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups& setAllocateUnit(string allocateUnit) { DARABONBA_PTR_SET_VALUE(allocateUnit_, allocateUnit) };
    ...
    inline DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups& setGroupName(string groupName) { DARABONBA_PTR_SET_VALUE(groupName_, groupName) };
    ...
    inline DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups& setMaxWorkerQuantity(int32_t maxWorkerQuantity) { DARABONBA_PTR_SET_VALUE(maxWorkerQuantity_, maxWorkerQuantity) };
    ...
    inline DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups& setMinWorkerQuantity(int32_t minWorkerQuantity) { DARABONBA_PTR_SET_VALUE(minWorkerQuantity_, minWorkerQuantity) };
    ...
    inline DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups& setWorkerDiskCapacity(string workerDiskCapacity) { DARABONBA_PTR_SET_VALUE(workerDiskCapacity_, workerDiskCapacity) };
    ...
    inline DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups& setWorkerSpecName(string workerSpecName) { DARABONBA_PTR_SET_VALUE(workerSpecName_, workerSpecName) };
    ...
    inline DescribeEmbodiedAIPlatformsResponseBodyPlatformsRayConfigWorkerGroups& setWorkerSpecType(string workerSpecType) { DARABONBA_PTR_SET_VALUE(workerSpecType_, workerSpecType) };
