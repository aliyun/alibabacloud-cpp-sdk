...
#ifndef ALIBABACLOUD_MODELS_CREATEEMBODIEDAIPLATFORMREQUESTRAYCONFIGWORKERGROUPS_HPP_
#define ALIBABACLOUD_MODELS_CREATEEMBODIEDAIPLATFORMREQUESTRAYCONFIGWORKERGROUPS_HPP_
...
namespace Models
{
  class CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups& obj) { 
    ...
    CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups() = default ;
    CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups(const CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups &) = default ;
    CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups(CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups &&) = default ;
    CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups() = default ;
    CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups& operator=(const CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups &) = default ;
    CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups& operator=(CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups &&) = default ;
    ...
    inline CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups& setAllocateUnit(string allocateUnit) { DARABONBA_PTR_SET_VALUE(allocateUnit_, allocateUnit) };
    ...
    inline CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups& setGroupName(string groupName) { DARABONBA_PTR_SET_VALUE(groupName_, groupName) };
    ...
    inline CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups& setMaxWorkerQuantity(int32_t maxWorkerQuantity) { DARABONBA_PTR_SET_VALUE(maxWorkerQuantity_, maxWorkerQuantity) };
    ...
    inline CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups& setMinWorkerQuantity(int32_t minWorkerQuantity) { DARABONBA_PTR_SET_VALUE(minWorkerQuantity_, minWorkerQuantity) };
    ...
    inline CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups& setWorkerDiskCapacity(string workerDiskCapacity) { DARABONBA_PTR_SET_VALUE(workerDiskCapacity_, workerDiskCapacity) };
    ...
    inline CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups& setWorkerSpecName(string workerSpecName) { DARABONBA_PTR_SET_VALUE(workerSpecName_, workerSpecName) };
    ...
    inline CreateEmbodiedAIPlatformRequestRayConfigWorkerGroups& setWorkerSpecType(string workerSpecType) { DARABONBA_PTR_SET_VALUE(workerSpecType_, workerSpecType) };
