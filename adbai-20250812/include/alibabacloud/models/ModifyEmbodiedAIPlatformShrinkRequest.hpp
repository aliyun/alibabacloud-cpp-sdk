...
namespace Models
{
  ...
  public:
    ...
    inline ModifyEmbodiedAIPlatformShrinkRequest& setRayTrainConfigShrink(string rayTrainConfigShrink) { DARABONBA_PTR_SET_VALUE(rayTrainConfigShrink_, rayTrainConfigShrink) };
