...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->maxResults_ == nullptr
        && return this->nextToken_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->platforms_ == nullptr && return this->requestId_ == nullptr
    ...
    inline const vector<DescribeEmbodiedAIPlatformsResponseBodyPlatforms> & platforms() const { DARABONBA_PTR_GET_CONST(platforms_, vector<DescribeEmbodiedAIPlatformsResponseBodyPlatforms>) };
    inline vector<DescribeEmbodiedAIPlatformsResponseBodyPlatforms> platforms() { DARABONBA_PTR_GET(platforms_, vector<DescribeEmbodiedAIPlatformsResponseBodyPlatforms>) };
    inline DescribeEmbodiedAIPlatformsResponseBody& setPlatforms(const vector<DescribeEmbodiedAIPlatformsResponseBodyPlatforms> & platforms) { DARABONBA_PTR_SET_VALUE(platforms_, platforms) };
    inline DescribeEmbodiedAIPlatformsResponseBody& setPlatforms(vector<DescribeEmbodiedAIPlatformsResponseBodyPlatforms> && platforms) { DARABONBA_PTR_SET_RVALUE(platforms_, platforms) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeEmbodiedAIPlatformsResponseBodyPlatforms>> platforms_ = nullptr;
