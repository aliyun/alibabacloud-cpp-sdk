...
#ifndef ALIBABACLOUD_MODELS_MODIFYAGENTPLATFORMREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MODIFYAGENTPLATFORMREQUEST_HPP_
...
namespace Models
{
  class ModifyAgentPlatformRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModifyAgentPlatformRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AiPlatformConfig, aiPlatformConfig_);
      DARABONBA_PTR_TO_JSON(DBClusterId, DBClusterId_);
      DARABONBA_PTR_TO_JSON(Name, name_);
      DARABONBA_PTR_TO_JSON(RegionId, regionId_);
    };
    friend void from_json(const Darabonba::Json& j, ModifyAgentPlatformRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AiPlatformConfig, aiPlatformConfig_);
      DARABONBA_PTR_FROM_JSON(DBClusterId, DBClusterId_);
      DARABONBA_PTR_FROM_JSON(Name, name_);
      DARABONBA_PTR_FROM_JSON(RegionId, regionId_);
    };
    ModifyAgentPlatformRequest() = default ;
    ModifyAgentPlatformRequest(const ModifyAgentPlatformRequest &) = default ;
    ModifyAgentPlatformRequest(ModifyAgentPlatformRequest &&) = default ;
    ModifyAgentPlatformRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyAgentPlatformRequest() = default ;
    ModifyAgentPlatformRequest& operator=(const ModifyAgentPlatformRequest &) = default ;
    ModifyAgentPlatformRequest& operator=(ModifyAgentPlatformRequest &&) = default ;
    ...
    inline const ModifyAgentPlatformRequest::AiPlatformConfig & getAiPlatformConfig() const { DARABONBA_PTR_GET_CONST(aiPlatformConfig_, ModifyAgentPlatformRequest::AiPlatformConfig) };
    inline ModifyAgentPlatformRequest::AiPlatformConfig getAiPlatformConfig() { DARABONBA_PTR_GET(aiPlatformConfig_, ModifyAgentPlatformRequest::AiPlatformConfig) };
    inline ModifyAgentPlatformRequest& setAiPlatformConfig(const ModifyAgentPlatformRequest::AiPlatformConfig & aiPlatformConfig) { DARABONBA_PTR_SET_VALUE(aiPlatformConfig_, aiPlatformConfig) };
    inline ModifyAgentPlatformRequest& setAiPlatformConfig(ModifyAgentPlatformRequest::AiPlatformConfig && aiPlatformConfig) { DARABONBA_PTR_SET_RVALUE(aiPlatformConfig_, aiPlatformConfig) };
    ...
    inline ModifyAgentPlatformRequest& setDBClusterId(string DBClusterId) { DARABONBA_PTR_SET_VALUE(DBClusterId_, DBClusterId) };
    ...
    inline ModifyAgentPlatformRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ModifyAgentPlatformRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
