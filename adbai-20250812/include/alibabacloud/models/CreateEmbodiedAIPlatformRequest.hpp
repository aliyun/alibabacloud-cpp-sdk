...
namespace Models
{
  ...
  public:
    ...
    inline CreateEmbodiedAIPlatformRequest& setDeviceCount(int32_t deviceCount) { DARABONBA_PTR_SET_VALUE(deviceCount_, deviceCount) };
    ...
    inline const CreateEmbodiedAIPlatformRequest::RayTrainConfig & getRayTrainConfig() const { DARABONBA_PTR_GET_CONST(rayTrainConfig_, CreateEmbodiedAIPlatformRequest::RayTrainConfig) };
    inline CreateEmbodiedAIPlatformRequest::RayTrainConfig getRayTrainConfig() { DARABONBA_PTR_GET(rayTrainConfig_, CreateEmbodiedAIPlatformRequest::RayTrainConfig) };
    inline CreateEmbodiedAIPlatformRequest& setRayTrainConfig(const CreateEmbodiedAIPlatformRequest::RayTrainConfig & rayTrainConfig) { DARABONBA_PTR_SET_VALUE(rayTrainConfig_, rayTrainConfig) };
    inline CreateEmbodiedAIPlatformRequest& setRayTrainConfig(CreateEmbodiedAIPlatformRequest::RayTrainConfig && rayTrainConfig) { DARABONBA_PTR_SET_RVALUE(rayTrainConfig_, rayTrainConfig) };
