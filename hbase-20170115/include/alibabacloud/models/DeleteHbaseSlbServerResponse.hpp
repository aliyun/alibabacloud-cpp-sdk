...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteHbaseSlbServerResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteHbaseSlbServerResponseBody) };
    inline DeleteHbaseSlbServerResponseBody body() { DARABONBA_PTR_GET(body_, DeleteHbaseSlbServerResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteHbaseSlbServerResponseBody> body_ = nullptr;
  };
