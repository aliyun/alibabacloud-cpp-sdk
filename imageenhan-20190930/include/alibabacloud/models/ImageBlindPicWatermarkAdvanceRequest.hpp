...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->functionType_ != nullptr
        && this->logoURLObject_ != nullptr && this->originImageURLObject_ != nullptr && this->outputFileType_ != nullptr && this->qualityFactor_ != nullptr && this->watermarkImageURLObject_ != nullptr; };
