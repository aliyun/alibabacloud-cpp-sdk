...
#ifndef ALIBABACLOUD_MODELS_GETBATCHTRANSLATEBYVPCREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETBATCHTRANSLATEBYVPCREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetBatchTranslateByVPCRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetBatchTranslateByVPCRequest& obj) { 
    ...
    GetBatchTranslateByVPCRequest() = default ;
    GetBatchTranslateByVPCRequest(const GetBatchTranslateByVPCRequest &) = default ;
    GetBatchTranslateByVPCRequest(GetBatchTranslateByVPCRequest &&) = default ;
    GetBatchTranslateByVPCRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetBatchTranslateByVPCRequest() = default ;
    GetBatchTranslateByVPCRequest& operator=(const GetBatchTranslateByVPCRequest &) = default ;
    GetBatchTranslateByVPCRequest& operator=(GetBatchTranslateByVPCRequest &&) = default ;
    ...
    inline GetBatchTranslateByVPCRequest& setApiType(string apiType) { DARABONBA_PTR_SET_VALUE(apiType_, apiType) };
    ...
    inline GetBatchTranslateByVPCRequest& setFormatType(string formatType) { DARABONBA_PTR_SET_VALUE(formatType_, formatType) };
    ...
    inline GetBatchTranslateByVPCRequest& setScene(string scene) { DARABONBA_PTR_SET_VALUE(scene_, scene) };
    ...
    inline GetBatchTranslateByVPCRequest& setSourceLanguage(string sourceLanguage) { DARABONBA_PTR_SET_VALUE(sourceLanguage_, sourceLanguage) };
    ...
    inline GetBatchTranslateByVPCRequest& setSourceText(string sourceText) { DARABONBA_PTR_SET_VALUE(sourceText_, sourceText) };
    ...
    inline GetBatchTranslateByVPCRequest& setTargetLanguage(string targetLanguage) { DARABONBA_PTR_SET_VALUE(targetLanguage_, targetLanguage) };
