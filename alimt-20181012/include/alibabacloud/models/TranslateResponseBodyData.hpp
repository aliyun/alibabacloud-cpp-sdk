...
#ifndef ALIBABACLOUD_MODELS_TRANSLATERESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_TRANSLATERESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TranslateResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TranslateResponseBodyData& obj) { 
    ...
    TranslateResponseBodyData() = default ;
    TranslateResponseBodyData(const TranslateResponseBodyData &) = default ;
    TranslateResponseBodyData(TranslateResponseBodyData &&) = default ;
    TranslateResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TranslateResponseBodyData() = default ;
    TranslateResponseBodyData& operator=(const TranslateResponseBodyData &) = default ;
    TranslateResponseBodyData& operator=(TranslateResponseBodyData &&) = default ;
    ...
    inline TranslateResponseBodyData& setDetectedLanguage(string detectedLanguage) { DARABONBA_PTR_SET_VALUE(detectedLanguage_, detectedLanguage) };
    ...
    inline TranslateResponseBodyData& setTranslated(string translated) { DARABONBA_PTR_SET_VALUE(translated_, translated) };
    ...
    inline TranslateResponseBodyData& setWordCount(string wordCount) { DARABONBA_PTR_SET_VALUE(wordCount_, wordCount) };
