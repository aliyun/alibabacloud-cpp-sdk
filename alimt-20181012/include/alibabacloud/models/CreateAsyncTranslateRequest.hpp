...
#ifndef ALIBABACLOUD_MODELS_CREATEASYNCTRANSLATEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEASYNCTRANSLATEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateAsyncTranslateRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateAsyncTranslateRequest& obj) { 
    ...
    CreateAsyncTranslateRequest() = default ;
    CreateAsyncTranslateRequest(const CreateAsyncTranslateRequest &) = default ;
    CreateAsyncTranslateRequest(CreateAsyncTranslateRequest &&) = default ;
    CreateAsyncTranslateRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAsyncTranslateRequest() = default ;
    CreateAsyncTranslateRequest& operator=(const CreateAsyncTranslateRequest &) = default ;
    CreateAsyncTranslateRequest& operator=(CreateAsyncTranslateRequest &&) = default ;
    ...
    inline CreateAsyncTranslateRequest& setApiType(string apiType) { DARABONBA_PTR_SET_VALUE(apiType_, apiType) };
    ...
    inline CreateAsyncTranslateRequest& setFormatType(string formatType) { DARABONBA_PTR_SET_VALUE(formatType_, formatType) };
    ...
    inline CreateAsyncTranslateRequest& setScene(string scene) { DARABONBA_PTR_SET_VALUE(scene_, scene) };
    ...
    inline CreateAsyncTranslateRequest& setSourceLanguage(string sourceLanguage) { DARABONBA_PTR_SET_VALUE(sourceLanguage_, sourceLanguage) };
    ...
    inline CreateAsyncTranslateRequest& setSourceText(string sourceText) { DARABONBA_PTR_SET_VALUE(sourceText_, sourceText) };
    ...
    inline CreateAsyncTranslateRequest& setTargetLanguage(string targetLanguage) { DARABONBA_PTR_SET_VALUE(targetLanguage_, targetLanguage) };
