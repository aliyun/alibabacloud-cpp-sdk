...
#ifndef ALIBABACLOUD_MODELS_GETBATCHTRANSLATEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETBATCHTRANSLATEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetBatchTranslateRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetBatchTranslateRequest& obj) { 
    ...
    GetBatchTranslateRequest() = default ;
    GetBatchTranslateRequest(const GetBatchTranslateRequest &) = default ;
    GetBatchTranslateRequest(GetBatchTranslateRequest &&) = default ;
    GetBatchTranslateRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetBatchTranslateRequest() = default ;
    GetBatchTranslateRequest& operator=(const GetBatchTranslateRequest &) = default ;
    GetBatchTranslateRequest& operator=(GetBatchTranslateRequest &&) = default ;
    ...
    inline GetBatchTranslateRequest& setApiType(string apiType) { DARABONBA_PTR_SET_VALUE(apiType_, apiType) };
    ...
    inline GetBatchTranslateRequest& setFormatType(string formatType) { DARABONBA_PTR_SET_VALUE(formatType_, formatType) };
    ...
    inline GetBatchTranslateRequest& setScene(string scene) { DARABONBA_PTR_SET_VALUE(scene_, scene) };
    ...
    inline GetBatchTranslateRequest& setSourceLanguage(string sourceLanguage) { DARABONBA_PTR_SET_VALUE(sourceLanguage_, sourceLanguage) };
    ...
    inline GetBatchTranslateRequest& setSourceText(string sourceText) { DARABONBA_PTR_SET_VALUE(sourceText_, sourceText) };
    ...
    inline GetBatchTranslateRequest& setTargetLanguage(string targetLanguage) { DARABONBA_PTR_SET_VALUE(targetLanguage_, targetLanguage) };
