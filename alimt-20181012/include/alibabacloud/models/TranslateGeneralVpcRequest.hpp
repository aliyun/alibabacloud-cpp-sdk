...
#ifndef ALIBABACLOUD_MODELS_TRANSLATEGENERALVPCREQUEST_HPP_
#define ALIBABACLOUD_MODELS_TRANSLATEGENERALVPCREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TranslateGeneralVpcRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TranslateGeneralVpcRequest& obj) { 
    ...
    TranslateGeneralVpcRequest() = default ;
    TranslateGeneralVpcRequest(const TranslateGeneralVpcRequest &) = default ;
    TranslateGeneralVpcRequest(TranslateGeneralVpcRequest &&) = default ;
    TranslateGeneralVpcRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TranslateGeneralVpcRequest() = default ;
    TranslateGeneralVpcRequest& operator=(const TranslateGeneralVpcRequest &) = default ;
    TranslateGeneralVpcRequest& operator=(TranslateGeneralVpcRequest &&) = default ;
    ...
    inline TranslateGeneralVpcRequest& setContext(string context) { DARABONBA_PTR_SET_VALUE(context_, context) };
    ...
    inline TranslateGeneralVpcRequest& setFormatType(string formatType) { DARABONBA_PTR_SET_VALUE(formatType_, formatType) };
    ...
    inline TranslateGeneralVpcRequest& setScene(string scene) { DARABONBA_PTR_SET_VALUE(scene_, scene) };
    ...
    inline TranslateGeneralVpcRequest& setSourceLanguage(string sourceLanguage) { DARABONBA_PTR_SET_VALUE(sourceLanguage_, sourceLanguage) };
    ...
    inline TranslateGeneralVpcRequest& setSourceText(string sourceText) { DARABONBA_PTR_SET_VALUE(sourceText_, sourceText) };
    ...
    inline TranslateGeneralVpcRequest& setTargetLanguage(string targetLanguage) { DARABONBA_PTR_SET_VALUE(targetLanguage_, targetLanguage) };
