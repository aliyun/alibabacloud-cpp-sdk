...
#ifndef ALIBABACLOUD_MODELS_TRANSLATEGENERALRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_TRANSLATEGENERALRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TranslateGeneralResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TranslateGeneralResponseBodyData& obj) { 
    ...
    TranslateGeneralResponseBodyData() = default ;
    TranslateGeneralResponseBodyData(const TranslateGeneralResponseBodyData &) = default ;
    TranslateGeneralResponseBodyData(TranslateGeneralResponseBodyData &&) = default ;
    TranslateGeneralResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TranslateGeneralResponseBodyData() = default ;
    TranslateGeneralResponseBodyData& operator=(const TranslateGeneralResponseBodyData &) = default ;
    TranslateGeneralResponseBodyData& operator=(TranslateGeneralResponseBodyData &&) = default ;
    ...
    inline TranslateGeneralResponseBodyData& setDetectedLanguage(string detectedLanguage) { DARABONBA_PTR_SET_VALUE(detectedLanguage_, detectedLanguage) };
    ...
    inline TranslateGeneralResponseBodyData& setTranslated(string translated) { DARABONBA_PTR_SET_VALUE(translated_, translated) };
    ...
    inline TranslateGeneralResponseBodyData& setWordCount(string wordCount) { DARABONBA_PTR_SET_VALUE(wordCount_, wordCount) };
