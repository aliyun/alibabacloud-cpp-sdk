...
#ifndef ALIBABACLOUD_MODELS_UPDATEHOTELREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEHOTELREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateHotelRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateHotelRequest& obj) { 
    ...
    UpdateHotelRequest() = default ;
    UpdateHotelRequest(const UpdateHotelRequest &) = default ;
    UpdateHotelRequest(UpdateHotelRequest &&) = default ;
    UpdateHotelRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateHotelRequest() = default ;
    UpdateHotelRequest& operator=(const UpdateHotelRequest &) = default ;
    UpdateHotelRequest& operator=(UpdateHotelRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->appKey_ == nullptr
        ...
        && this->phoneNumber_ == nullptr && this->relatedPks_ == nullptr && this->remark_ == nullptr && this->roomNum_ == nullptr && this->tbOpenId_ == nullptr; };
    // appKey Field Functions 
    bool hasAppKey() const { return this->appKey_ != nullptr;};
    void deleteAppKey() { this->appKey_ = nullptr;};
    inline string getAppKey() const { DARABONBA_PTR_GET_DEFAULT(appKey_, "") };
    inline UpdateHotelRequest& setAppKey(string appKey) { DARABONBA_PTR_SET_VALUE(appKey_, appKey) };
    ...
    inline UpdateHotelRequest& setEstOpenTime(string estOpenTime) { DARABONBA_PTR_SET_VALUE(estOpenTime_, estOpenTime) };
    ...
    inline UpdateHotelRequest& setHotelAddress(string hotelAddress) { DARABONBA_PTR_SET_VALUE(hotelAddress_, hotelAddress) };
    ...
    inline UpdateHotelRequest& setHotelEmail(string hotelEmail) { DARABONBA_PTR_SET_VALUE(hotelEmail_, hotelEmail) };
    ...
    inline UpdateHotelRequest& setHotelId(string hotelId) { DARABONBA_PTR_SET_VALUE(hotelId_, hotelId) };
    ...
    inline UpdateHotelRequest& setHotelName(string hotelName) { DARABONBA_PTR_SET_VALUE(hotelName_, hotelName) };
    ...
    inline UpdateHotelRequest& setPhoneNumber(string phoneNumber) { DARABONBA_PTR_SET_VALUE(phoneNumber_, phoneNumber) };
    ...
    inline UpdateHotelRequest& setRelatedPks(const vector<string> & relatedPks) { DARABONBA_PTR_SET_VALUE(relatedPks_, relatedPks) };
    inline UpdateHotelRequest& setRelatedPks(vector<string> && relatedPks) { DARABONBA_PTR_SET_RVALUE(relatedPks_, relatedPks) };
    ...
    inline UpdateHotelRequest& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline UpdateHotelRequest& setRoomNum(int32_t roomNum) { DARABONBA_PTR_SET_VALUE(roomNum_, roomNum) };
    ...
    inline UpdateHotelRequest& setTbOpenId(string tbOpenId) { DARABONBA_PTR_SET_VALUE(tbOpenId_, tbOpenId) };
