...
#ifndef ALIBABACLOUD_MODELS_CREATERCUSCENEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATERCUSCENEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateRcuSceneRequest& obj) { 
      DARABONBA_PTR_TO_JSON(HotelId, hotelId_);
      DARABONBA_PTR_TO_JSON(SceneId, sceneId_);
      DARABONBA_PTR_TO_JSON(SceneRelationExtDTO, sceneRelationExtDTO_);
    };
    friend void from_json(const Darabonba::Json& j, CreateRcuSceneRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(HotelId, hotelId_);
      DARABONBA_PTR_FROM_JSON(SceneId, sceneId_);
      DARABONBA_PTR_FROM_JSON(SceneRelationExtDTO, sceneRelationExtDTO_);
    };
    CreateRcuSceneRequest() = default ;
    CreateRcuSceneRequest(const CreateRcuSceneRequest &) = default ;
    CreateRcuSceneRequest(CreateRcuSceneRequest &&) = default ;
    CreateRcuSceneRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateRcuSceneRequest() = default ;
    CreateRcuSceneRequest& operator=(const CreateRcuSceneRequest &) = default ;
    CreateRcuSceneRequest& operator=(CreateRcuSceneRequest &&) = default ;
    ...
    inline CreateRcuSceneRequest& setHotelId(string hotelId) { DARABONBA_PTR_SET_VALUE(hotelId_, hotelId) };
    ...
    inline CreateRcuSceneRequest& setSceneId(string sceneId) { DARABONBA_PTR_SET_VALUE(sceneId_, sceneId) };
    ...
    inline const CreateRcuSceneRequest::SceneRelationExtDTO & getSceneRelationExtDTO() const { DARABONBA_PTR_GET_CONST(sceneRelationExtDTO_, CreateRcuSceneRequest::SceneRelationExtDTO) };
    inline CreateRcuSceneRequest::SceneRelationExtDTO getSceneRelationExtDTO() { DARABONBA_PTR_GET(sceneRelationExtDTO_, CreateRcuSceneRequest::SceneRelationExtDTO) };
    inline CreateRcuSceneRequest& setSceneRelationExtDTO(const CreateRcuSceneRequest::SceneRelationExtDTO & sceneRelationExtDTO) { DARABONBA_PTR_SET_VALUE(sceneRelationExtDTO_, sceneRelationExtDTO) };
    inline CreateRcuSceneRequest& setSceneRelationExtDTO(CreateRcuSceneRequest::SceneRelationExtDTO && sceneRelationExtDTO) { DARABONBA_PTR_SET_RVALUE(sceneRelationExtDTO_, sceneRelationExtDTO) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<CreateRcuSceneRequest::SceneRelationExtDTO> sceneRelationExtDTO_ {};
  };
