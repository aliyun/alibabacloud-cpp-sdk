...
#ifndef ALIBABACLOUD_MODELS_ROOMCHECKOUTSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ROOMCHECKOUTSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RoomCheckOutShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(DeviceInfo, deviceInfoShrink_);
      DARABONBA_PTR_TO_JSON(UserInfo, userInfoShrink_);
    };
    friend void from_json(const Darabonba::Json& j, RoomCheckOutShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(DeviceInfo, deviceInfoShrink_);
      DARABONBA_PTR_FROM_JSON(UserInfo, userInfoShrink_);
    };
    RoomCheckOutShrinkRequest() = default ;
    RoomCheckOutShrinkRequest(const RoomCheckOutShrinkRequest &) = default ;
    RoomCheckOutShrinkRequest(RoomCheckOutShrinkRequest &&) = default ;
    RoomCheckOutShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RoomCheckOutShrinkRequest() = default ;
    RoomCheckOutShrinkRequest& operator=(const RoomCheckOutShrinkRequest &) = default ;
    RoomCheckOutShrinkRequest& operator=(RoomCheckOutShrinkRequest &&) = default ;
    ...
    inline RoomCheckOutShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline RoomCheckOutShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
