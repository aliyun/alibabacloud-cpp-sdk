...
#ifndef ALIBABACLOUD_MODELS_CREATEHOTELSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEHOTELSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateHotelShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateHotelShrinkRequest& obj) { 
    ...
    CreateHotelShrinkRequest() = default ;
    CreateHotelShrinkRequest(const CreateHotelShrinkRequest &) = default ;
    CreateHotelShrinkRequest(CreateHotelShrinkRequest &&) = default ;
    CreateHotelShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateHotelShrinkRequest() = default ;
    CreateHotelShrinkRequest& operator=(const CreateHotelShrinkRequest &) = default ;
    CreateHotelShrinkRequest& operator=(CreateHotelShrinkRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->appKey_ == nullptr
        ...
        && this->relatedPk_ == nullptr && this->relatedPksShrink_ == nullptr && this->remark_ == nullptr && this->roomNum_ == nullptr && this->tbOpenId_ == nullptr; };
    // appKey Field Functions 
    bool hasAppKey() const { return this->appKey_ != nullptr;};
    void deleteAppKey() { this->appKey_ = nullptr;};
    inline string getAppKey() const { DARABONBA_PTR_GET_DEFAULT(appKey_, "") };
    inline CreateHotelShrinkRequest& setAppKey(string appKey) { DARABONBA_PTR_SET_VALUE(appKey_, appKey) };
    ...
    inline CreateHotelShrinkRequest& setEstOpenTime(string estOpenTime) { DARABONBA_PTR_SET_VALUE(estOpenTime_, estOpenTime) };
    ...
    inline CreateHotelShrinkRequest& setHotelAddress(string hotelAddress) { DARABONBA_PTR_SET_VALUE(hotelAddress_, hotelAddress) };
    ...
    inline CreateHotelShrinkRequest& setHotelEmail(string hotelEmail) { DARABONBA_PTR_SET_VALUE(hotelEmail_, hotelEmail) };
    ...
    inline CreateHotelShrinkRequest& setHotelName(string hotelName) { DARABONBA_PTR_SET_VALUE(hotelName_, hotelName) };
    ...
    inline CreateHotelShrinkRequest& setPhoneNumber(string phoneNumber) { DARABONBA_PTR_SET_VALUE(phoneNumber_, phoneNumber) };
    ...
    inline CreateHotelShrinkRequest& setRelatedPk(string relatedPk) { DARABONBA_PTR_SET_VALUE(relatedPk_, relatedPk) };
    ...
    inline CreateHotelShrinkRequest& setRelatedPksShrink(string relatedPksShrink) { DARABONBA_PTR_SET_VALUE(relatedPksShrink_, relatedPksShrink) };
    ...
    inline CreateHotelShrinkRequest& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline CreateHotelShrinkRequest& setRoomNum(int32_t roomNum) { DARABONBA_PTR_SET_VALUE(roomNum_, roomNum) };
    ...
    inline CreateHotelShrinkRequest& setTbOpenId(string tbOpenId) { DARABONBA_PTR_SET_VALUE(tbOpenId_, tbOpenId) };
