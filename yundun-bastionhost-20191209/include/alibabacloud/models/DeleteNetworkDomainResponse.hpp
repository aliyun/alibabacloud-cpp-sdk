...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteNetworkDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteNetworkDomainResponseBody) };
    inline DeleteNetworkDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteNetworkDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteNetworkDomainResponseBody> body_ {};
  };
