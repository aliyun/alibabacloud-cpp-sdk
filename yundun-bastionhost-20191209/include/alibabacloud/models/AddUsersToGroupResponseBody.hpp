...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AddUsersToGroupResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<AddUsersToGroupResponseBody::Results>) };
    inline vector<AddUsersToGroupResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<AddUsersToGroupResponseBody::Results>) };
    inline AddUsersToGroupResponseBody& setResults(const vector<AddUsersToGroupResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline AddUsersToGroupResponseBody& setResults(vector<AddUsersToGroupResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
  ...
  protected:
    ...
    shared_ptr<vector<AddUsersToGroupResponseBody::Results>> results_ {};
  };
