...
namespace Models
{
  ...
  public:
    ...
    inline const RejectOperationTicketResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RejectOperationTicketResponseBody) };
    inline RejectOperationTicketResponseBody getBody() { DARABONBA_PTR_GET(body_, RejectOperationTicketResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RejectOperationTicketResponseBody> body_ {};
  };
