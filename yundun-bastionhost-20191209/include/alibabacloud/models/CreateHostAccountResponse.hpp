...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHostAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateHostAccountResponseBody) };
    inline CreateHostAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateHostAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateHostAccountResponseBody> body_ {};
  };
