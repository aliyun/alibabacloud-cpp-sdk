...
namespace Models
{
  ...
  public:
    ...
    inline const vector<RemoveDatabasesFromGroupResponseBodyResults> & results() const { DARABONBA_PTR_GET_CONST(results_, vector<RemoveDatabasesFromGroupResponseBodyResults>) };
    inline vector<RemoveDatabasesFromGroupResponseBodyResults> results() { DARABONBA_PTR_GET(results_, vector<RemoveDatabasesFromGroupResponseBodyResults>) };
    inline RemoveDatabasesFromGroupResponseBody& setResults(const vector<RemoveDatabasesFromGroupResponseBodyResults> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline RemoveDatabasesFromGroupResponseBody& setResults(vector<RemoveDatabasesFromGroupResponseBodyResults> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
  ...
  protected:
    ...
    std::shared_ptr<vector<RemoveDatabasesFromGroupResponseBodyResults>> results_ = nullptr;
  };
