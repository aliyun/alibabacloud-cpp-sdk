...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->databases_ == nullptr
        && return this->hostGroups_ == nullptr && return this->hosts_ == nullptr && return this->instanceId_ == nullptr && return this->policyId_ == nullptr && return this->regionId_ == nullptr
        && return this->scopeType_ == nullptr; };
