...
namespace Models
{
  ...
  public:
    ...
    inline const CreateUserPublicKeyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateUserPublicKeyResponseBody) };
    inline CreateUserPublicKeyResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateUserPublicKeyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateUserPublicKeyResponseBody> body_ {};
  };
