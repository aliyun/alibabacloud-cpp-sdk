...
namespace Models
{
  ...
  public:
    ...
    inline const ListDatabasesForUserGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDatabasesForUserGroupResponseBody) };
    inline ListDatabasesForUserGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDatabasesForUserGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDatabasesForUserGroupResponseBody> body_ {};
  };
