...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHostResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateHostResponseBody) };
    inline CreateHostResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateHostResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateHostResponseBody> body_ {};
  };
