...
namespace Models
{
  ...
  public:
    ...
    inline const ListDatabasesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDatabasesResponseBody) };
    inline ListDatabasesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDatabasesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDatabasesResponseBody> body_ {};
  };
