...
namespace Models
{
  ...
  public:
    ...
    inline const ListHostGroupsForUserGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHostGroupsForUserGroupResponseBody) };
    inline ListHostGroupsForUserGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHostGroupsForUserGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHostGroupsForUserGroupResponseBody> body_ {};
  };
