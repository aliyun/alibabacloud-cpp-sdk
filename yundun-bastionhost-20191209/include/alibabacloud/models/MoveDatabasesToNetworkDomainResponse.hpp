...
namespace Models
{
  ...
  public:
    ...
    inline const MoveDatabasesToNetworkDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MoveDatabasesToNetworkDomainResponseBody) };
    inline MoveDatabasesToNetworkDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, MoveDatabasesToNetworkDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MoveDatabasesToNetworkDomainResponseBody> body_ {};
  };
