...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListOperationDatabasesResponseBodyDatabases> & databases() const { DARABONBA_PTR_GET_CONST(databases_, vector<ListOperationDatabasesResponseBodyDatabases>) };
    inline vector<ListOperationDatabasesResponseBodyDatabases> databases() { DARABONBA_PTR_GET(databases_, vector<ListOperationDatabasesResponseBodyDatabases>) };
    inline ListOperationDatabasesResponseBody& setDatabases(const vector<ListOperationDatabasesResponseBodyDatabases> & databases) { DARABONBA_PTR_SET_VALUE(databases_, databases) };
    inline ListOperationDatabasesResponseBody& setDatabases(vector<ListOperationDatabasesResponseBodyDatabases> && databases) { DARABONBA_PTR_SET_RVALUE(databases_, databases) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListOperationDatabasesResponseBodyDatabases>> databases_ = nullptr;
