...
namespace Models
{
  ...
  public:
    ...
    inline const MoveHostsToNetworkDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MoveHostsToNetworkDomainResponseBody) };
    inline MoveHostsToNetworkDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, MoveHostsToNetworkDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MoveHostsToNetworkDomainResponseBody> body_ {};
  };
