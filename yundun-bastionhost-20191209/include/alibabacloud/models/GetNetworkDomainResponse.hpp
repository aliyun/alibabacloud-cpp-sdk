...
namespace Models
{
  ...
  public:
    ...
    inline const GetNetworkDomainResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetNetworkDomainResponseBody) };
    inline GetNetworkDomainResponseBody body() { DARABONBA_PTR_GET(body_, GetNetworkDomainResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetNetworkDomainResponseBody> body_ = nullptr;
  };
