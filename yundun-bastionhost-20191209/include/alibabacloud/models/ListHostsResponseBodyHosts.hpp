...
#ifndef ALIBABACLOUD_MODELS_LISTHOSTSRESPONSEBODYHOSTS_HPP_
#define ALIBABACLOUD_MODELS_LISTHOSTSRESPONSEBODYHOSTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListHostsResponseBodyHosts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListHostsResponseBodyHosts& obj) { 
    ...
    ListHostsResponseBodyHosts() = default ;
    ListHostsResponseBodyHosts(const ListHostsResponseBodyHosts &) = default ;
    ListHostsResponseBodyHosts(ListHostsResponseBodyHosts &&) = default ;
    ListHostsResponseBodyHosts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListHostsResponseBodyHosts() = default ;
    ListHostsResponseBodyHosts& operator=(const ListHostsResponseBodyHosts &) = default ;
    ListHostsResponseBodyHosts& operator=(ListHostsResponseBodyHosts &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->activeAddressType_ == nullptr
        && return this->comment_ == nullptr && return this->hostAccountCount_ == nullptr && return this->hostId_ == nullptr && return this->hostName_ == nullptr && return this->hostPrivateAddress_ == nullptr
        && return this->hostPublicAddress_ == nullptr && return this->OSType_ == nullptr && return this->source_ == nullptr && return this->sourceInstanceId_ == nullptr && return this->sourceInstanceState_ == nullptr; };
    ...
    inline ListHostsResponseBodyHosts& setActiveAddressType(string activeAddressType) { DARABONBA_PTR_SET_VALUE(activeAddressType_, activeAddressType) };
    ...
    inline ListHostsResponseBodyHosts& setComment(string comment) { DARABONBA_PTR_SET_VALUE(comment_, comment) };
    ...
    inline int32_t hostAccountCount() const { DARABONBA_PTR_GET_DEFAULT(hostAccountCount_, 0) };
    inline ListHostsResponseBodyHosts& setHostAccountCount(int32_t hostAccountCount) { DARABONBA_PTR_SET_VALUE(hostAccountCount_, hostAccountCount) };
    ...
    inline ListHostsResponseBodyHosts& setHostId(string hostId) { DARABONBA_PTR_SET_VALUE(hostId_, hostId) };
    ...
    inline ListHostsResponseBodyHosts& setHostName(string hostName) { DARABONBA_PTR_SET_VALUE(hostName_, hostName) };
    ...
    inline ListHostsResponseBodyHosts& setHostPrivateAddress(string hostPrivateAddress) { DARABONBA_PTR_SET_VALUE(hostPrivateAddress_, hostPrivateAddress) };
    ...
    inline ListHostsResponseBodyHosts& setHostPublicAddress(string hostPublicAddress) { DARABONBA_PTR_SET_VALUE(hostPublicAddress_, hostPublicAddress) };
    ...
    inline ListHostsResponseBodyHosts& setOSType(string OSType) { DARABONBA_PTR_SET_VALUE(OSType_, OSType) };
    ...
    inline ListHostsResponseBodyHosts& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    ...
    inline ListHostsResponseBodyHosts& setSourceInstanceId(string sourceInstanceId) { DARABONBA_PTR_SET_VALUE(sourceInstanceId_, sourceInstanceId) };
    ...
    inline ListHostsResponseBodyHosts& setSourceInstanceState(string sourceInstanceState) { DARABONBA_PTR_SET_VALUE(sourceInstanceState_, sourceInstanceState) };
  ...
  protected:
    ...
    std::shared_ptr<int32_t> hostAccountCount_ = nullptr;
    // The ID of the host.
