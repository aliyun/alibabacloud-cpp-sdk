...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyNetworkDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyNetworkDomainResponseBody) };
    inline ModifyNetworkDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyNetworkDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyNetworkDomainResponseBody> body_ {};
  };
