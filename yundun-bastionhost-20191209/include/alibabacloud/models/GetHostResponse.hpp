...
namespace Models
{
  ...
  public:
    ...
    inline const GetHostResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHostResponseBody) };
    inline GetHostResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHostResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHostResponseBody> body_ {};
  };
