...
namespace Models
{
  ...
  public:
    ...
    inline const vector<MoveHostsToNetworkDomainResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<MoveHostsToNetworkDomainResponseBody::Results>) };
    inline vector<MoveHostsToNetworkDomainResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<MoveHostsToNetworkDomainResponseBody::Results>) };
    inline MoveHostsToNetworkDomainResponseBody& setResults(const vector<MoveHostsToNetworkDomainResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline MoveHostsToNetworkDomainResponseBody& setResults(vector<MoveHostsToNetworkDomainResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
  ...
  protected:
    ...
    shared_ptr<vector<MoveHostsToNetworkDomainResponseBody::Results>> results_ {};
  };
