...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->hostShareKeyId_ == nullptr
        && return this->hostShareKeyName_ == nullptr && return this->instanceId_ == nullptr && return this->passPhrase_ == nullptr && return this->privateKey_ == nullptr && return this->regionId_ == nullptr; };
