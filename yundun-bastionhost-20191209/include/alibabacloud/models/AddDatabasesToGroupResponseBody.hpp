...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AddDatabasesToGroupResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<AddDatabasesToGroupResponseBody::Results>) };
    inline vector<AddDatabasesToGroupResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<AddDatabasesToGroupResponseBody::Results>) };
    inline AddDatabasesToGroupResponseBody& setResults(const vector<AddDatabasesToGroupResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline AddDatabasesToGroupResponseBody& setResults(vector<AddDatabasesToGroupResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
  ...
  protected:
    ...
    // The data returned.
    shared_ptr<vector<AddDatabasesToGroupResponseBody::Results>> results_ {};
  };
