...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AttachDatabaseAccountsToUserResponseBodyResults> & results() const { DARABONBA_PTR_GET_CONST(results_, vector<AttachDatabaseAccountsToUserResponseBodyResults>) };
    inline vector<AttachDatabaseAccountsToUserResponseBodyResults> results() { DARABONBA_PTR_GET(results_, vector<AttachDatabaseAccountsToUserResponseBodyResults>) };
    inline AttachDatabaseAccountsToUserResponseBody& setResults(const vector<AttachDatabaseAccountsToUserResponseBodyResults> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline AttachDatabaseAccountsToUserResponseBody& setResults(vector<AttachDatabaseAccountsToUserResponseBodyResults> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
  ...
  protected:
    ...
    std::shared_ptr<vector<AttachDatabaseAccountsToUserResponseBodyResults>> results_ = nullptr;
  };
