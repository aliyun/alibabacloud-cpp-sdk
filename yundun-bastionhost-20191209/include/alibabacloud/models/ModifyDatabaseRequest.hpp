...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activeAddressType_ == nullptr
        ...
        && return this->databasePublicAddress_ == nullptr && return this->instanceId_ == nullptr && return this->networkDomainId_ == nullptr && return this->regionId_ == nullptr && return this->sourceInstanceId_ == nullptr; };
