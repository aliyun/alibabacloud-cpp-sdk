...
namespace Models
{
  ...
  public:
    ...
    inline const DetachDatabaseAccountsFromUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachDatabaseAccountsFromUserResponseBody) };
    inline DetachDatabaseAccountsFromUserResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachDatabaseAccountsFromUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachDatabaseAccountsFromUserResponseBody> body_ {};
  };
