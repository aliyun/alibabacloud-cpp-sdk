...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyUserPublicKeyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyUserPublicKeyResponseBody) };
    inline ModifyUserPublicKeyResponseBody body() { DARABONBA_PTR_GET(body_, ModifyUserPublicKeyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyUserPublicKeyResponseBody> body_ = nullptr;
  };
