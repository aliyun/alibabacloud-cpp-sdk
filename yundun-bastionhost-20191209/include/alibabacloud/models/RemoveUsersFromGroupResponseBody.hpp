...
namespace Models
{
  ...
  public:
    ...
    inline const vector<RemoveUsersFromGroupResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<RemoveUsersFromGroupResponseBody::Results>) };
    inline vector<RemoveUsersFromGroupResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<RemoveUsersFromGroupResponseBody::Results>) };
    inline RemoveUsersFromGroupResponseBody& setResults(const vector<RemoveUsersFromGroupResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline RemoveUsersFromGroupResponseBody& setResults(vector<RemoveUsersFromGroupResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
  ...
  protected:
    ...
    shared_ptr<vector<RemoveUsersFromGroupResponseBody::Results>> results_ {};
  };
