...
namespace Models
{
  ...
  public:
    ...
    inline const ListHostShareKeysResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHostShareKeysResponseBody) };
    inline ListHostShareKeysResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHostShareKeysResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHostShareKeysResponseBody> body_ {};
  };
