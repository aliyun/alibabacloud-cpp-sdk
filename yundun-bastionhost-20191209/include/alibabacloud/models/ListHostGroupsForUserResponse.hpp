...
namespace Models
{
  ...
  public:
    ...
    inline const ListHostGroupsForUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHostGroupsForUserResponseBody) };
    inline ListHostGroupsForUserResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHostGroupsForUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHostGroupsForUserResponseBody> body_ {};
  };
