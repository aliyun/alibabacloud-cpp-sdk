...
namespace Models
{
  ...
  public:
    ...
    inline const ListHostAccountsForUserGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHostAccountsForUserGroupResponseBody) };
    inline ListHostAccountsForUserGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHostAccountsForUserGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHostAccountsForUserGroupResponseBody> body_ {};
  };
