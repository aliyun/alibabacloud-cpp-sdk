...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyHostsPortResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyHostsPortResponseBody) };
    inline ModifyHostsPortResponseBody body() { DARABONBA_PTR_GET(body_, ModifyHostsPortResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyHostsPortResponseBody> body_ = nullptr;
  };
