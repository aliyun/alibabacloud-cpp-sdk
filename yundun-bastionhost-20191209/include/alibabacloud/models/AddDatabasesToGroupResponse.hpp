...
namespace Models
{
  ...
  public:
    ...
    inline const AddDatabasesToGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddDatabasesToGroupResponseBody) };
    inline AddDatabasesToGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, AddDatabasesToGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddDatabasesToGroupResponseBody> body_ {};
  };
