...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDatabasesResponseBodyDatabases> & databases() const { DARABONBA_PTR_GET_CONST(databases_, vector<ListDatabasesResponseBodyDatabases>) };
    inline vector<ListDatabasesResponseBodyDatabases> databases() { DARABONBA_PTR_GET(databases_, vector<ListDatabasesResponseBodyDatabases>) };
    inline ListDatabasesResponseBody& setDatabases(const vector<ListDatabasesResponseBodyDatabases> & databases) { DARABONBA_PTR_SET_VALUE(databases_, databases) };
    inline ListDatabasesResponseBody& setDatabases(vector<ListDatabasesResponseBodyDatabases> && databases) { DARABONBA_PTR_SET_RVALUE(databases_, databases) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListDatabasesResponseBodyDatabases>> databases_ = nullptr;
    // The request ID.
