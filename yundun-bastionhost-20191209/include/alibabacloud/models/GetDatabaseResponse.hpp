...
namespace Models
{
  ...
  public:
    ...
    inline const GetDatabaseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDatabaseResponseBody) };
    inline GetDatabaseResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDatabaseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDatabaseResponseBody> body_ {};
  };
