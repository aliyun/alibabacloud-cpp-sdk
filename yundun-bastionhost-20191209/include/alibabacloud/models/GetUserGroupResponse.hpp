...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUserGroupResponseBody) };
    inline GetUserGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUserGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUserGroupResponseBody> body_ {};
  };
