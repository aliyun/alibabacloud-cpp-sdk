...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->code_ == nullptr
        && this->hostGroupId_ == nullptr && this->hostId_ == nullptr && this->message_ == nullptr; };
    ...
    inline const vector<RemoveHostsFromGroupResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<RemoveHostsFromGroupResponseBody::Results>) };
    inline vector<RemoveHostsFromGroupResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<RemoveHostsFromGroupResponseBody::Results>) };
    inline RemoveHostsFromGroupResponseBody& setResults(const vector<RemoveHostsFromGroupResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline RemoveHostsFromGroupResponseBody& setResults(vector<RemoveHostsFromGroupResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
  ...
  protected:
    ...
    shared_ptr<vector<RemoveHostsFromGroupResponseBody::Results>> results_ {};
  };
