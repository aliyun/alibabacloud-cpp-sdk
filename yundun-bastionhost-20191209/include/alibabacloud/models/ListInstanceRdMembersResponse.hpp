...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceRdMembersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstanceRdMembersResponseBody) };
    inline ListInstanceRdMembersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInstanceRdMembersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInstanceRdMembersResponseBody> body_ {};
  };
