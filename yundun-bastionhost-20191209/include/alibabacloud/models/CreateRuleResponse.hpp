...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRuleResponseBody) };
    inline CreateRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRuleResponseBody> body_ {};
  };
