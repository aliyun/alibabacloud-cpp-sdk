...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activeAddressType_ == nullptr
        ...
        && return this->networkDomainId_ == nullptr && return this->OSType_ == nullptr && return this->prefKex_ == nullptr && return this->protocols_ == nullptr && return this->source_ == nullptr
        && return this->sourceInstanceId_ == nullptr && return this->sourceInstanceState_ == nullptr; };
