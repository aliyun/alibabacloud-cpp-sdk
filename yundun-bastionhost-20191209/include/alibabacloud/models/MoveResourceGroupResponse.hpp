...
namespace Models
{
  ...
  public:
    ...
    inline const MoveResourceGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MoveResourceGroupResponseBody) };
    inline MoveResourceGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, MoveResourceGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MoveResourceGroupResponseBody> body_ {};
  };
