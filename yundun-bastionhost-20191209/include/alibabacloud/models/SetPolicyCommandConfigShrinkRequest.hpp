...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->commandConfigShrink_ != nullptr
    ...
    inline string commandConfigShrink() const { DARABONBA_PTR_GET_DEFAULT(commandConfigShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> commandConfigShrink_ = nullptr;
    // The bastion host ID.
    // 
