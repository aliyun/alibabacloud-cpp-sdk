...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceADAuthServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceADAuthServerResponseBody) };
    inline GetInstanceADAuthServerResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInstanceADAuthServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInstanceADAuthServerResponseBody> body_ {};
  };
