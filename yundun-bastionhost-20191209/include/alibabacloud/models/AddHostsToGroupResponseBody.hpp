...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AddHostsToGroupResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<AddHostsToGroupResponseBody::Results>) };
    inline vector<AddHostsToGroupResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<AddHostsToGroupResponseBody::Results>) };
    inline AddHostsToGroupResponseBody& setResults(const vector<AddHostsToGroupResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline AddHostsToGroupResponseBody& setResults(vector<AddHostsToGroupResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
  ...
  protected:
    ...
    shared_ptr<vector<AddHostsToGroupResponseBody::Results>> results_ {};
  };
