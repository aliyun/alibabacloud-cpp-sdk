...
namespace Models
{
  ...
  public:
    ...
    inline const DetachHostGroupAccountsFromUserGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DetachHostGroupAccountsFromUserGroupResponseBody) };
    inline DetachHostGroupAccountsFromUserGroupResponseBody body() { DARABONBA_PTR_GET(body_, DetachHostGroupAccountsFromUserGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DetachHostGroupAccountsFromUserGroupResponseBody> body_ = nullptr;
  };
