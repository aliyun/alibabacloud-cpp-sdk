...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteRuleResponseBody) };
    inline DeleteRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteRuleResponseBody> body_ {};
  };
