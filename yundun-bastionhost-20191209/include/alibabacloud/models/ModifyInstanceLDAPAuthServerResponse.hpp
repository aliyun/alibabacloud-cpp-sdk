...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceLDAPAuthServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyInstanceLDAPAuthServerResponseBody) };
    inline ModifyInstanceLDAPAuthServerResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyInstanceLDAPAuthServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyInstanceLDAPAuthServerResponseBody> body_ {};
  };
