...
namespace Models
{
  ...
  public:
    ...
    inline const AttachDatabaseAccountsToUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachDatabaseAccountsToUserResponseBody) };
    inline AttachDatabaseAccountsToUserResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachDatabaseAccountsToUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachDatabaseAccountsToUserResponseBody> body_ {};
  };
