...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyHostsActiveAddressTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyHostsActiveAddressTypeResponseBody) };
    inline ModifyHostsActiveAddressTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyHostsActiveAddressTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyHostsActiveAddressTypeResponseBody> body_ {};
  };
