...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceLDAPAuthServerResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceLDAPAuthServerResponseBody) };
    inline GetInstanceLDAPAuthServerResponseBody body() { DARABONBA_PTR_GET(body_, GetInstanceLDAPAuthServerResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetInstanceLDAPAuthServerResponseBody> body_ = nullptr;
  };
