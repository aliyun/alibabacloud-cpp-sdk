...
namespace Models
{
  ...
  public:
    ...
    inline const StartInstanceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, StartInstanceResponseBody) };
    inline StartInstanceResponseBody body() { DARABONBA_PTR_GET(body_, StartInstanceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<StartInstanceResponseBody> body_ = nullptr;
  };
