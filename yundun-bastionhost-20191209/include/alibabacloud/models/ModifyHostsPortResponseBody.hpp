...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ModifyHostsPortResponseBodyResults> & results() const { DARABONBA_PTR_GET_CONST(results_, vector<ModifyHostsPortResponseBodyResults>) };
    inline vector<ModifyHostsPortResponseBodyResults> results() { DARABONBA_PTR_GET(results_, vector<ModifyHostsPortResponseBodyResults>) };
    inline ModifyHostsPortResponseBody& setResults(const vector<ModifyHostsPortResponseBodyResults> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline ModifyHostsPortResponseBody& setResults(vector<ModifyHostsPortResponseBodyResults> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ModifyHostsPortResponseBodyResults>> results_ = nullptr;
  };
