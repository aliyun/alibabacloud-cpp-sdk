...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveUsersFromGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveUsersFromGroupResponseBody) };
    inline RemoveUsersFromGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveUsersFromGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveUsersFromGroupResponseBody> body_ {};
  };
