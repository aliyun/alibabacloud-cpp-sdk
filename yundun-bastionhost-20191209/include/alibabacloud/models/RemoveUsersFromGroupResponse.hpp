...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveUsersFromGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RemoveUsersFromGroupResponseBody) };
    inline RemoveUsersFromGroupResponseBody body() { DARABONBA_PTR_GET(body_, RemoveUsersFromGroupResponseBody) };
    inline RemoveUsersFromGroupResponse& setBody(const RemoveUsersFromGroupResponseBody & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline RemoveUsersFromGroupResponse& setBody(RemoveUsersFromGroupResponseBody && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<RemoveUsersFromGroupResponseBody> body_ = nullptr;
  };
