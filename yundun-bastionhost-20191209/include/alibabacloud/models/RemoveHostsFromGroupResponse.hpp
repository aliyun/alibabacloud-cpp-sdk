...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveHostsFromGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveHostsFromGroupResponseBody) };
    inline RemoveHostsFromGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveHostsFromGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveHostsFromGroupResponseBody> body_ {};
  };
