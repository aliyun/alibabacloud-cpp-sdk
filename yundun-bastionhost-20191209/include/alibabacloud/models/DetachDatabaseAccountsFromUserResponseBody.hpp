...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DetachDatabaseAccountsFromUserResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<DetachDatabaseAccountsFromUserResponseBody::Results>) };
    inline vector<DetachDatabaseAccountsFromUserResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<DetachDatabaseAccountsFromUserResponseBody::Results>) };
    inline DetachDatabaseAccountsFromUserResponseBody& setResults(const vector<DetachDatabaseAccountsFromUserResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline DetachDatabaseAccountsFromUserResponseBody& setResults(vector<DetachDatabaseAccountsFromUserResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
  ...
  protected:
    ...
    shared_ptr<vector<DetachDatabaseAccountsFromUserResponseBody::Results>> results_ {};
  };
