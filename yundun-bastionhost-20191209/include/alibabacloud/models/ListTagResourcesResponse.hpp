...
namespace Models
{
  ...
  public:
    ...
    inline const ListTagResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTagResourcesResponseBody) };
    inline ListTagResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTagResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTagResourcesResponseBody> body_ {};
  };
