...
#ifndef ALIBABACLOUD_MODELS_LISTHOSTSFORUSERGROUPRESPONSEBODYHOSTS_HPP_
#define ALIBABACLOUD_MODELS_LISTHOSTSFORUSERGROUPRESPONSEBODYHOSTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListHostsForUserGroupResponseBodyHosts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListHostsForUserGroupResponseBodyHosts& obj) { 
    ...
    ListHostsForUserGroupResponseBodyHosts() = default ;
    ListHostsForUserGroupResponseBodyHosts(const ListHostsForUserGroupResponseBodyHosts &) = default ;
    ListHostsForUserGroupResponseBodyHosts(ListHostsForUserGroupResponseBodyHosts &&) = default ;
    ListHostsForUserGroupResponseBodyHosts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListHostsForUserGroupResponseBodyHosts() = default ;
    ListHostsForUserGroupResponseBodyHosts& operator=(const ListHostsForUserGroupResponseBodyHosts &) = default ;
    ListHostsForUserGroupResponseBodyHosts& operator=(ListHostsForUserGroupResponseBodyHosts &&) = default ;
    ...
    inline ListHostsForUserGroupResponseBodyHosts& setActiveAddressType(string activeAddressType) { DARABONBA_PTR_SET_VALUE(activeAddressType_, activeAddressType) };
    ...
    inline ListHostsForUserGroupResponseBodyHosts& setComment(string comment) { DARABONBA_PTR_SET_VALUE(comment_, comment) };
    ...
    inline ListHostsForUserGroupResponseBodyHosts& setHostId(string hostId) { DARABONBA_PTR_SET_VALUE(hostId_, hostId) };
    ...
    inline ListHostsForUserGroupResponseBodyHosts& setHostName(string hostName) { DARABONBA_PTR_SET_VALUE(hostName_, hostName) };
    ...
    inline ListHostsForUserGroupResponseBodyHosts& setHostPrivateAddress(string hostPrivateAddress) { DARABONBA_PTR_SET_VALUE(hostPrivateAddress_, hostPrivateAddress) };
    ...
    inline ListHostsForUserGroupResponseBodyHosts& setHostPublicAddress(string hostPublicAddress) { DARABONBA_PTR_SET_VALUE(hostPublicAddress_, hostPublicAddress) };
    ...
    inline ListHostsForUserGroupResponseBodyHosts& setOSType(string OSType) { DARABONBA_PTR_SET_VALUE(OSType_, OSType) };
