...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDatabaseAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDatabaseAccountResponseBody) };
    inline CreateDatabaseAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDatabaseAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDatabaseAccountResponseBody> body_ {};
  };
