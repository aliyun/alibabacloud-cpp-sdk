...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DetachHostGroupAccountsFromUserResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<DetachHostGroupAccountsFromUserResponseBody::Results>) };
    inline vector<DetachHostGroupAccountsFromUserResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<DetachHostGroupAccountsFromUserResponseBody::Results>) };
    inline DetachHostGroupAccountsFromUserResponseBody& setResults(const vector<DetachHostGroupAccountsFromUserResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline DetachHostGroupAccountsFromUserResponseBody& setResults(vector<DetachHostGroupAccountsFromUserResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
  ...
  protected:
    ...
    shared_ptr<vector<DetachHostGroupAccountsFromUserResponseBody::Results>> results_ {};
  };
