...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyPolicyResponseBody) };
    inline ModifyPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyPolicyResponseBody> body_ {};
  };
