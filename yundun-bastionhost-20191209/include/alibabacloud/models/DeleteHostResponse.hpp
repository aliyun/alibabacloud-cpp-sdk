...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteHostResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteHostResponseBody) };
    inline DeleteHostResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteHostResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteHostResponseBody> body_ {};
  };
