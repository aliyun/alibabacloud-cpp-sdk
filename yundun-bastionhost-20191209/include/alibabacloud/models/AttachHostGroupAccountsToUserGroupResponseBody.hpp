...
#ifndef ALIBABACLOUD_MODELS_ATTACHHOSTGROUPACCOUNTSTOUSERGROUPRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ATTACHHOSTGROUPACCOUNTSTOUSERGROUPRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AttachHostGroupAccountsToUserGroupResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Results, results_);
    };
    friend void from_json(const Darabonba::Json& j, AttachHostGroupAccountsToUserGroupResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Results, results_);
    };
    AttachHostGroupAccountsToUserGroupResponseBody() = default ;
    AttachHostGroupAccountsToUserGroupResponseBody(const AttachHostGroupAccountsToUserGroupResponseBody &) = default ;
    AttachHostGroupAccountsToUserGroupResponseBody(AttachHostGroupAccountsToUserGroupResponseBody &&) = default ;
    AttachHostGroupAccountsToUserGroupResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AttachHostGroupAccountsToUserGroupResponseBody() = default ;
    AttachHostGroupAccountsToUserGroupResponseBody& operator=(const AttachHostGroupAccountsToUserGroupResponseBody &) = default ;
    AttachHostGroupAccountsToUserGroupResponseBody& operator=(AttachHostGroupAccountsToUserGroupResponseBody &&) = default ;
    ...
    inline AttachHostGroupAccountsToUserGroupResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // results Field Functions 
    bool hasResults() const { return this->results_ != nullptr;};
    void deleteResults() { this->results_ = nullptr;};
    inline const vector<AttachHostGroupAccountsToUserGroupResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<AttachHostGroupAccountsToUserGroupResponseBody::Results>) };
    inline vector<AttachHostGroupAccountsToUserGroupResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<AttachHostGroupAccountsToUserGroupResponseBody::Results>) };
    inline AttachHostGroupAccountsToUserGroupResponseBody& setResults(const vector<AttachHostGroupAccountsToUserGroupResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline AttachHostGroupAccountsToUserGroupResponseBody& setResults(vector<AttachHostGroupAccountsToUserGroupResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
  ...
  protected:
    ...
    shared_ptr<vector<AttachHostGroupAccountsToUserGroupResponseBody::Results>> results_ {};
  };
