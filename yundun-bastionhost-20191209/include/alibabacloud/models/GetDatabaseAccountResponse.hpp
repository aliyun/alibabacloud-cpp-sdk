...
namespace Models
{
  ...
  public:
    ...
    inline const GetDatabaseAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDatabaseAccountResponseBody) };
    inline GetDatabaseAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDatabaseAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDatabaseAccountResponseBody> body_ {};
  };
