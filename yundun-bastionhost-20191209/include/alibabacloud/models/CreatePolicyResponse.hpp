...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePolicyResponseBody) };
    inline CreatePolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePolicyResponseBody> body_ {};
  };
