...
namespace Models
{
  ...
  public:
    ...
    inline const ListApproveCommandsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApproveCommandsResponseBody) };
    inline ListApproveCommandsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApproveCommandsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApproveCommandsResponseBody> body_ {};
  };
