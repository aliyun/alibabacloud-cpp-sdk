...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AttachHostAccountsToUserGroupResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<AttachHostAccountsToUserGroupResponseBody::Results>) };
    inline vector<AttachHostAccountsToUserGroupResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<AttachHostAccountsToUserGroupResponseBody::Results>) };
    inline AttachHostAccountsToUserGroupResponseBody& setResults(const vector<AttachHostAccountsToUserGroupResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline AttachHostAccountsToUserGroupResponseBody& setResults(vector<AttachHostAccountsToUserGroupResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
  ...
  protected:
    ...
    shared_ptr<vector<AttachHostAccountsToUserGroupResponseBody::Results>> results_ {};
  };
