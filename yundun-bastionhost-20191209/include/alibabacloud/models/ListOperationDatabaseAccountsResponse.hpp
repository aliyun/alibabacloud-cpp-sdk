...
namespace Models
{
  ...
  public:
    ...
    inline const ListOperationDatabaseAccountsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOperationDatabaseAccountsResponseBody) };
    inline ListOperationDatabaseAccountsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOperationDatabaseAccountsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOperationDatabaseAccountsResponseBody> body_ {};
  };
