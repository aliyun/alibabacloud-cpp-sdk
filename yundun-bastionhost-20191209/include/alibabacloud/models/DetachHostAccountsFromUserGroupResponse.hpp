...
namespace Models
{
  ...
  public:
    ...
    inline const DetachHostAccountsFromUserGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachHostAccountsFromUserGroupResponseBody) };
    inline DetachHostAccountsFromUserGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachHostAccountsFromUserGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachHostAccountsFromUserGroupResponseBody> body_ {};
  };
