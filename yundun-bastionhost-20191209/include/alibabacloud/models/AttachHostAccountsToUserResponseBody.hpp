...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AttachHostAccountsToUserResponseBodyResults> & results() const { DARABONBA_PTR_GET_CONST(results_, vector<AttachHostAccountsToUserResponseBodyResults>) };
    inline vector<AttachHostAccountsToUserResponseBodyResults> results() { DARABONBA_PTR_GET(results_, vector<AttachHostAccountsToUserResponseBodyResults>) };
    inline AttachHostAccountsToUserResponseBody& setResults(const vector<AttachHostAccountsToUserResponseBodyResults> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline AttachHostAccountsToUserResponseBody& setResults(vector<AttachHostAccountsToUserResponseBodyResults> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
  ...
  protected:
    ...
    std::shared_ptr<vector<AttachHostAccountsToUserResponseBodyResults>> results_ = nullptr;
  };
