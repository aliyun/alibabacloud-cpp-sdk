...
namespace Models
{
  ...
  public:
    ...
    inline string getAccessTimeRangeConfigShrink() const { DARABONBA_PTR_GET_DEFAULT(accessTimeRangeConfigShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> accessTimeRangeConfigShrink_ {};
    // The bastion host ID.
    // 
