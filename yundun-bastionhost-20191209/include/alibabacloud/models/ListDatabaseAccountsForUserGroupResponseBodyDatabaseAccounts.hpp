...
#ifndef ALIBABACLOUD_MODELS_LISTDATABASEACCOUNTSFORUSERGROUPRESPONSEBODYDATABASEACCOUNTS_HPP_
#define ALIBABACLOUD_MODELS_LISTDATABASEACCOUNTSFORUSERGROUPRESPONSEBODYDATABASEACCOUNTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts& obj) { 
    ...
    ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts() = default ;
    ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts(const ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts &) = default ;
    ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts(ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts &&) = default ;
    ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts() = default ;
    ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts& operator=(const ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts &) = default ;
    ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts& operator=(ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts &&) = default ;
    ...
    inline ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts& setDatabaseAccountId(string databaseAccountId) { DARABONBA_PTR_SET_VALUE(databaseAccountId_, databaseAccountId) };
    ...
    inline ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts& setDatabaseAccountName(string databaseAccountName) { DARABONBA_PTR_SET_VALUE(databaseAccountName_, databaseAccountName) };
    ...
    inline ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts& setDatabaseId(string databaseId) { DARABONBA_PTR_SET_VALUE(databaseId_, databaseId) };
    ...
    inline ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts& setIsAuthorized(bool isAuthorized) { DARABONBA_PTR_SET_VALUE(isAuthorized_, isAuthorized) };
    ...
    inline ListDatabaseAccountsForUserGroupResponseBodyDatabaseAccounts& setProtocolName(string protocolName) { DARABONBA_PTR_SET_VALUE(protocolName_, protocolName) };
