...
#ifndef ALIBABACLOUD_MODELS_GETPOLICYASSETSCOPERESPONSEBODYASSETSCOPEDATABASES_HPP_
#define ALIBABACLOUD_MODELS_GETPOLICYASSETSCOPERESPONSEBODYASSETSCOPEDATABASES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetPolicyAssetScopeResponseBodyAssetScopeDatabases& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetPolicyAssetScopeResponseBodyAssetScopeDatabases& obj) { 
    ...
    GetPolicyAssetScopeResponseBodyAssetScopeDatabases() = default ;
    GetPolicyAssetScopeResponseBodyAssetScopeDatabases(const GetPolicyAssetScopeResponseBodyAssetScopeDatabases &) = default ;
    GetPolicyAssetScopeResponseBodyAssetScopeDatabases(GetPolicyAssetScopeResponseBodyAssetScopeDatabases &&) = default ;
    GetPolicyAssetScopeResponseBodyAssetScopeDatabases(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetPolicyAssetScopeResponseBodyAssetScopeDatabases() = default ;
    GetPolicyAssetScopeResponseBodyAssetScopeDatabases& operator=(const GetPolicyAssetScopeResponseBodyAssetScopeDatabases &) = default ;
    GetPolicyAssetScopeResponseBodyAssetScopeDatabases& operator=(GetPolicyAssetScopeResponseBodyAssetScopeDatabases &&) = default ;
    ...
    inline GetPolicyAssetScopeResponseBodyAssetScopeDatabases& setAccountScopeType(string accountScopeType) { DARABONBA_PTR_SET_VALUE(accountScopeType_, accountScopeType) };
    ...
    inline GetPolicyAssetScopeResponseBodyAssetScopeDatabases& setDatabaseAccountIds(const vector<string> & databaseAccountIds) { DARABONBA_PTR_SET_VALUE(databaseAccountIds_, databaseAccountIds) };
    inline GetPolicyAssetScopeResponseBodyAssetScopeDatabases& setDatabaseAccountIds(vector<string> && databaseAccountIds) { DARABONBA_PTR_SET_RVALUE(databaseAccountIds_, databaseAccountIds) };
    ...
    inline GetPolicyAssetScopeResponseBodyAssetScopeDatabases& setDatabaseId(string databaseId) { DARABONBA_PTR_SET_VALUE(databaseId_, databaseId) };
