...
namespace Models
{
  ...
  public:
    ...
    inline const GetRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRuleResponseBody) };
    inline GetRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRuleResponseBody> body_ {};
  };
