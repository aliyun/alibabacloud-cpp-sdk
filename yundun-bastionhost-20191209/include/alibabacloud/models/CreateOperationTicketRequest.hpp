...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getEffectEndTime() const { DARABONBA_PTR_GET_DEFAULT(effectEndTime_, 0L) };
    ...
    inline int64_t getEffectStartTime() const { DARABONBA_PTR_GET_DEFAULT(effectStartTime_, 0L) };
    ...
    inline bool getIsOneTimeEffect() const { DARABONBA_PTR_GET_DEFAULT(isOneTimeEffect_, false) };
  ...
  protected:
    ...
    shared_ptr<int64_t> effectEndTime_ {};
    shared_ptr<int64_t> effectStartTime_ {};
    // This parameter is required.
    shared_ptr<string> instanceId_ {};
    shared_ptr<bool> isOneTimeEffect_ {};
    // This parameter is required.
