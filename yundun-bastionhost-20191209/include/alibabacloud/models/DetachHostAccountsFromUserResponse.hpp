...
namespace Models
{
  ...
  public:
    ...
    inline const DetachHostAccountsFromUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachHostAccountsFromUserResponseBody) };
    inline DetachHostAccountsFromUserResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachHostAccountsFromUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachHostAccountsFromUserResponseBody> body_ {};
  };
