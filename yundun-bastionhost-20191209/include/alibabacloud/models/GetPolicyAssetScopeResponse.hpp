...
namespace Models
{
  ...
  public:
    ...
    inline const GetPolicyAssetScopeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPolicyAssetScopeResponseBody) };
    inline GetPolicyAssetScopeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPolicyAssetScopeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPolicyAssetScopeResponseBody> body_ {};
  };
