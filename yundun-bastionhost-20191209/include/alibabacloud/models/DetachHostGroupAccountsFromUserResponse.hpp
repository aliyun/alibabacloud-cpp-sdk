...
namespace Models
{
  ...
  public:
    ...
    inline const DetachHostGroupAccountsFromUserResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DetachHostGroupAccountsFromUserResponseBody) };
    inline DetachHostGroupAccountsFromUserResponseBody body() { DARABONBA_PTR_GET(body_, DetachHostGroupAccountsFromUserResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DetachHostGroupAccountsFromUserResponseBody> body_ = nullptr;
  };
