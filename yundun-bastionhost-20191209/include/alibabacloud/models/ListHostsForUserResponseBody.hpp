...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHostsForUserResponseBody::Hosts> & getHosts() const { DARABONBA_PTR_GET_CONST(hosts_, vector<ListHostsForUserResponseBody::Hosts>) };
    inline vector<ListHostsForUserResponseBody::Hosts> getHosts() { DARABONBA_PTR_GET(hosts_, vector<ListHostsForUserResponseBody::Hosts>) };
    inline ListHostsForUserResponseBody& setHosts(const vector<ListHostsForUserResponseBody::Hosts> & hosts) { DARABONBA_PTR_SET_VALUE(hosts_, hosts) };
    inline ListHostsForUserResponseBody& setHosts(vector<ListHostsForUserResponseBody::Hosts> && hosts) { DARABONBA_PTR_SET_RVALUE(hosts_, hosts) };
  ...
  protected:
    // The hosts returned.
    shared_ptr<vector<ListHostsForUserResponseBody::Hosts>> hosts_ {};
    // The request ID.
