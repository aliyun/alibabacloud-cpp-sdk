...
namespace Models
{
  ...
  public:
    ...
    inline const ListHostGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHostGroupsResponseBody) };
    inline ListHostGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHostGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHostGroupsResponseBody> body_ {};
  };
