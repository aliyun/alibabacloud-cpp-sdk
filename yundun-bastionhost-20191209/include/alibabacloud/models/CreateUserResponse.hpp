...
namespace Models
{
  ...
  public:
    ...
    inline const CreateUserResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateUserResponseBody) };
    inline CreateUserResponseBody body() { DARABONBA_PTR_GET(body_, CreateUserResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateUserResponseBody> body_ = nullptr;
  };
