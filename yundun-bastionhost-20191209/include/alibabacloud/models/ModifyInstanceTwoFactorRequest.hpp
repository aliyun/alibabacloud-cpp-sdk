...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->enableTwoFactor_ == nullptr
        && return this->instanceId_ == nullptr && return this->regionId_ == nullptr && return this->skipTwoFactorTime_ == nullptr && return this->twoFactorMethods_ == nullptr; };
    ...
    inline string enableTwoFactor() const { DARABONBA_PTR_GET_DEFAULT(enableTwoFactor_, "") };
    ...
    inline string skipTwoFactorTime() const { DARABONBA_PTR_GET_DEFAULT(skipTwoFactorTime_, "") };
    ...
    inline string twoFactorMethods() const { DARABONBA_PTR_GET_DEFAULT(twoFactorMethods_, "") };
  ...
  protected:
    ...
    // *   **true**: yes
    // *   **false**: no
    std::shared_ptr<string> enableTwoFactor_ = nullptr;
    ...
    std::shared_ptr<string> skipTwoFactorTime_ = nullptr;
    ...
    std::shared_ptr<string> twoFactorMethods_ = nullptr;
  };
