...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUserGroupsResponseBody) };
    inline ListUserGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUserGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUserGroupsResponseBody> body_ {};
  };
