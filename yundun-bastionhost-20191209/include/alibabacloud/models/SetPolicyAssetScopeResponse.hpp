...
namespace Models
{
  ...
  public:
    ...
    inline const SetPolicyAssetScopeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetPolicyAssetScopeResponseBody) };
    inline SetPolicyAssetScopeResponseBody getBody() { DARABONBA_PTR_GET(body_, SetPolicyAssetScopeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetPolicyAssetScopeResponseBody> body_ {};
  };
