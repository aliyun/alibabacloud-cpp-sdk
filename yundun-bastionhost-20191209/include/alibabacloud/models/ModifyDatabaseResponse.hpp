...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDatabaseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDatabaseResponseBody) };
    inline ModifyDatabaseResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDatabaseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDatabaseResponseBody> body_ {};
  };
