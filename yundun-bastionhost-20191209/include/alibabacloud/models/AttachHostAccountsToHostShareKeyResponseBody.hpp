...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AttachHostAccountsToHostShareKeyResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<AttachHostAccountsToHostShareKeyResponseBody::Results>) };
    inline vector<AttachHostAccountsToHostShareKeyResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<AttachHostAccountsToHostShareKeyResponseBody::Results>) };
    inline AttachHostAccountsToHostShareKeyResponseBody& setResults(const vector<AttachHostAccountsToHostShareKeyResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline AttachHostAccountsToHostShareKeyResponseBody& setResults(vector<AttachHostAccountsToHostShareKeyResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
  ...
  protected:
    ...
    shared_ptr<vector<AttachHostAccountsToHostShareKeyResponseBody::Results>> results_ {};
  };
