...
namespace Models
{
  ...
  public:
    ...
    inline const VerifyInstanceADAuthServerResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, VerifyInstanceADAuthServerResponseBody) };
    inline VerifyInstanceADAuthServerResponseBody body() { DARABONBA_PTR_GET(body_, VerifyInstanceADAuthServerResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<VerifyInstanceADAuthServerResponseBody> body_ = nullptr;
  };
