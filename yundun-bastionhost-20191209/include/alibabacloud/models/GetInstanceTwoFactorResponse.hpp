...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceTwoFactorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceTwoFactorResponseBody) };
    inline GetInstanceTwoFactorResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInstanceTwoFactorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInstanceTwoFactorResponseBody> body_ {};
  };
