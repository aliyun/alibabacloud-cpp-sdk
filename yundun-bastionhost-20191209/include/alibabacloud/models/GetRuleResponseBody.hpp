...
namespace Models
{
  ...
  public:
    ...
    inline const GetRuleResponseBodyRule & rule() const { DARABONBA_PTR_GET_CONST(rule_, GetRuleResponseBodyRule) };
    inline GetRuleResponseBodyRule rule() { DARABONBA_PTR_GET(rule_, GetRuleResponseBodyRule) };
    inline GetRuleResponseBody& setRule(const GetRuleResponseBodyRule & rule) { DARABONBA_PTR_SET_VALUE(rule_, rule) };
    inline GetRuleResponseBody& setRule(GetRuleResponseBodyRule && rule) { DARABONBA_PTR_SET_RVALUE(rule_, rule) };
  ...
  protected:
    ...
    std::shared_ptr<GetRuleResponseBodyRule> rule_ = nullptr;
  };
