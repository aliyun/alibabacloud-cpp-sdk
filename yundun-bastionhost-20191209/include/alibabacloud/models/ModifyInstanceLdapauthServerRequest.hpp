...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->account_ != nullptr
        && this->baseDN_ != nullptr && this->emailMapping_ != nullptr && this->filter_ != nullptr && this->instanceId_ != nullptr && this->isSSL_ != nullptr
        && this->loginNameMapping_ != nullptr && this->mobileMapping_ != nullptr && this->nameMapping_ != nullptr && this->password_ != nullptr && this->port_ != nullptr
