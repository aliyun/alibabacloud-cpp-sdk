...
namespace Models
{
  ...
  public:
    ...
    inline CreateProductResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline CreateProductResponseBody& setData(bool data) { DARABONBA_PTR_SET_VALUE(data_, data) };
