...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSchemeConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSchemeConfigResponseBody) };
    inline CreateSchemeConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSchemeConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSchemeConfigResponseBody> body_ {};
  };
