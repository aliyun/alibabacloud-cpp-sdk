...
namespace Models
{
  ...
  public:
    ...
    inline QuerySceneListResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline QuerySceneListResponseBody& setData(string data) { DARABONBA_PTR_SET_VALUE(data_, data) };
