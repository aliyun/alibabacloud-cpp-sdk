...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ownerId_ == nullptr
        && this->prodCode_ == nullptr && this->prodId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr; };
    // ownerId Field Functions 
    bool hasOwnerId() const { return this->ownerId_ != nullptr;};
    void deleteOwnerId() { this->ownerId_ = nullptr;};
    inline int64_t getOwnerId() const { DARABONBA_PTR_GET_DEFAULT(ownerId_, 0L) };
    inline CreateProductRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline CreateProductRequest& setProdCode(string prodCode) { DARABONBA_PTR_SET_VALUE(prodCode_, prodCode) };


    // prodId Field Functions 
    bool hasProdId() const { return this->prodId_ != nullptr;};
    void deleteProdId() { this->prodId_ = nullptr;};
    inline string getProdId() const { DARABONBA_PTR_GET_DEFAULT(prodId_, "") };
    inline CreateProductRequest& setProdId(string prodId) { DARABONBA_PTR_SET_VALUE(prodId_, prodId) };
    ...
    inline CreateProductRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline CreateProductRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
