...
namespace Models
{
  ...
  public:
    ...
    inline const ListCategoriesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListCategoriesResponseBody::Data) };
    inline ListCategoriesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListCategoriesResponseBody::Data) };
    inline ListCategoriesResponseBody& setData(const ListCategoriesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCategoriesResponseBody& setData(ListCategoriesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<ListCategoriesResponseBody::Data> data_ {};
