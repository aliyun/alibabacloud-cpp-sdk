...
namespace Models
{
  ...
  public:
    ...
    inline const CloseTicketResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CloseTicketResponseBody) };
    inline CloseTicketResponseBody getBody() { DARABONBA_PTR_GET(body_, CloseTicketResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CloseTicketResponseBody> body_ {};
  };
