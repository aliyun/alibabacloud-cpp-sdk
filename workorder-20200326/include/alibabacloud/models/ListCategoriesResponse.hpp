...
namespace Models
{
  ...
  public:
    ...
    inline const ListCategoriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCategoriesResponseBody) };
    inline ListCategoriesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCategoriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCategoriesResponseBody> body_ {};
  };
