...
namespace Models
{
  ...
  public:
    ...
    inline const GetPurchaseControlRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPurchaseControlRecordResponseBody) };
    inline GetPurchaseControlRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPurchaseControlRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPurchaseControlRecordResponseBody> body_ {};
  };
