...
namespace Models
{
  ...
  public:
    ...
    inline const SetWarningThresholdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetWarningThresholdResponseBody) };
    inline SetWarningThresholdResponseBody getBody() { DARABONBA_PTR_GET(body_, SetWarningThresholdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetWarningThresholdResponseBody> body_ {};
  };
