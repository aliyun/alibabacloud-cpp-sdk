...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetPurchaseControlRecordResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetPurchaseControlRecordResponseBodyData>) };
    inline vector<GetPurchaseControlRecordResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetPurchaseControlRecordResponseBodyData>) };
    inline GetPurchaseControlRecordResponseBody& setData(const vector<GetPurchaseControlRecordResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPurchaseControlRecordResponseBody& setData(vector<GetPurchaseControlRecordResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetPurchaseControlRecordResponseBodyData>> data_ = nullptr;
