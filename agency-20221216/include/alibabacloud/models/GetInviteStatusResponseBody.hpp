...
namespace Models
{
  ...
  public:
    ...
    inline const GetInviteStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetInviteStatusResponseBodyData) };
    inline GetInviteStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, GetInviteStatusResponseBodyData) };
    inline GetInviteStatusResponseBody& setData(const GetInviteStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetInviteStatusResponseBody& setData(GetInviteStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetInviteStatusResponseBodyData> data_ = nullptr;
