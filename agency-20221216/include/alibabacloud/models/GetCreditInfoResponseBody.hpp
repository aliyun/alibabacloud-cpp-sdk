...
namespace Models
{
  ...
  public:
    ...
    inline const GetCreditInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetCreditInfoResponseBodyData) };
    inline GetCreditInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, GetCreditInfoResponseBodyData) };
    inline GetCreditInfoResponseBody& setData(const GetCreditInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCreditInfoResponseBody& setData(GetCreditInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetCreditInfoResponseBodyData> data_ = nullptr;
    // Message Information
