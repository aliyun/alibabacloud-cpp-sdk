...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCouponTemplateResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateCouponTemplateResponseBodyData) };
    inline CreateCouponTemplateResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateCouponTemplateResponseBodyData) };
    inline CreateCouponTemplateResponseBody& setData(const CreateCouponTemplateResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateCouponTemplateResponseBody& setData(CreateCouponTemplateResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateCouponTemplateResponseBodyData> data_ = nullptr;
