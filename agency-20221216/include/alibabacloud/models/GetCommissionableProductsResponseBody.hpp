...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetCommissionableProductsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetCommissionableProductsResponseBodyData>) };
    inline vector<GetCommissionableProductsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetCommissionableProductsResponseBodyData>) };
    inline GetCommissionableProductsResponseBody& setData(const vector<GetCommissionableProductsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCommissionableProductsResponseBody& setData(vector<GetCommissionableProductsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetCommissionableProductsResponseBodyData>> data_ = nullptr;
