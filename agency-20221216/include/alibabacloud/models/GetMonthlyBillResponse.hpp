...
namespace Models
{
  ...
  public:
    ...
    inline const GetMonthlyBillResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetMonthlyBillResponseBody) };
    inline GetMonthlyBillResponseBody body() { DARABONBA_PTR_GET(body_, GetMonthlyBillResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetMonthlyBillResponseBody> body_ = nullptr;
  };
