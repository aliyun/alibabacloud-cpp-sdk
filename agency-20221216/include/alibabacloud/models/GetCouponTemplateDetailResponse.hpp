...
namespace Models
{
  ...
  public:
    ...
    inline const GetCouponTemplateDetailResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetCouponTemplateDetailResponseBody) };
    inline GetCouponTemplateDetailResponseBody body() { DARABONBA_PTR_GET(body_, GetCouponTemplateDetailResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetCouponTemplateDetailResponseBody> body_ = nullptr;
  };
