...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->customerAccount_ == nullptr
        && this->customerManager_ == nullptr && this->customerUid_ == nullptr && this->endDate_ == nullptr && this->orderId_ == nullptr && this->orderSource_ == nullptr
        && this->orderStatus_ == nullptr && this->orderType_ == nullptr && this->pageNo_ == nullptr && this->pageSize_ == nullptr && this->productType_ == nullptr
        && this->startDate_ == nullptr && this->timeType_ == nullptr; };
    ...
    inline int32_t getOrderSource() const { DARABONBA_PTR_GET_DEFAULT(orderSource_, 0) };
  ...
  protected:
    ...
    shared_ptr<int32_t> orderSource_ {};
