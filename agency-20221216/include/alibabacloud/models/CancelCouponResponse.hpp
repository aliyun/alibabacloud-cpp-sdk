...
namespace Models
{
  ...
  public:
    ...
    inline const CancelCouponResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CancelCouponResponseBody) };
    inline CancelCouponResponseBody body() { DARABONBA_PTR_GET(body_, CancelCouponResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CancelCouponResponseBody> body_ = nullptr;
  };
