...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetCoupondeductProductCodeResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetCoupondeductProductCodeResponseBodyData>) };
    inline vector<GetCoupondeductProductCodeResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetCoupondeductProductCodeResponseBodyData>) };
    inline GetCoupondeductProductCodeResponseBody& setData(const vector<GetCoupondeductProductCodeResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCoupondeductProductCodeResponseBody& setData(vector<GetCoupondeductProductCodeResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetCoupondeductProductCodeResponseBodyData>> data_ = nullptr;
