...
namespace Models
{
  ...
  public:
    ...
    inline const GetCouponTemplateDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetCouponTemplateDetailResponseBodyData) };
    inline GetCouponTemplateDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetCouponTemplateDetailResponseBodyData) };
    inline GetCouponTemplateDetailResponseBody& setData(const GetCouponTemplateDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCouponTemplateDetailResponseBody& setData(GetCouponTemplateDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetCouponTemplateDetailResponseBodyData> data_ = nullptr;
