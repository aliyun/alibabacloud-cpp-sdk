...
namespace Models
{
  ...
  public:
    ...
    inline const InviteSubAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InviteSubAccountResponseBody) };
    inline InviteSubAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, InviteSubAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InviteSubAccountResponseBody> body_ {};
  };
