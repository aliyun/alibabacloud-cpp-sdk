...
namespace Models
{
  ...
  public:
    ...
    inline const GetMonthlyBillResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMonthlyBillResponseBodyData) };
    inline GetMonthlyBillResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMonthlyBillResponseBodyData) };
    inline GetMonthlyBillResponseBody& setData(const GetMonthlyBillResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMonthlyBillResponseBody& setData(GetMonthlyBillResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetMonthlyBillResponseBodyData> data_ = nullptr;
