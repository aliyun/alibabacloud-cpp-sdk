...
namespace Models
{
  ...
  public:
    ...
    inline const ListExportTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListExportTasksResponseBody) };
    inline ListExportTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListExportTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListExportTasksResponseBody> body_ {};
  };
