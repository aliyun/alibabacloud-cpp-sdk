...
#ifndef ALIBABACLOUD_MODELS_CREATECOUPONTEMPLATESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATECOUPONTEMPLATESHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateCouponTemplateShrinkRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(ProductType, productTypeShrink_);
    ...
    friend void from_json(const Darabonba::Json& j, CreateCouponTemplateShrinkRequest& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(ProductType, productTypeShrink_);
    ...
    CreateCouponTemplateShrinkRequest() = default ;
    CreateCouponTemplateShrinkRequest(const CreateCouponTemplateShrinkRequest &) = default ;
    CreateCouponTemplateShrinkRequest(CreateCouponTemplateShrinkRequest &&) = default ;
    CreateCouponTemplateShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateCouponTemplateShrinkRequest() = default ;
    CreateCouponTemplateShrinkRequest& operator=(const CreateCouponTemplateShrinkRequest &) = default ;
    CreateCouponTemplateShrinkRequest& operator=(CreateCouponTemplateShrinkRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        ...
        && return this->productTypeShrink_ == nullptr && return this->purchaseType_ == nullptr && return this->reasonForApplication_ == nullptr && return this->templateName_ == nullptr && return this->vailddate_ == nullptr
    ...
    inline CreateCouponTemplateShrinkRequest& setAcceptLanguage(string acceptLanguage) { DARABONBA_PTR_SET_VALUE(acceptLanguage_, acceptLanguage) };
    ...
    inline CreateCouponTemplateShrinkRequest& setApplicableProducts(string applicableProducts) { DARABONBA_PTR_SET_VALUE(applicableProducts_, applicableProducts) };
    ...
    inline CreateCouponTemplateShrinkRequest& setCostBearer(string costBearer) { DARABONBA_PTR_SET_VALUE(costBearer_, costBearer) };
    ...
    inline CreateCouponTemplateShrinkRequest& setCouponDescription(string couponDescription) { DARABONBA_PTR_SET_VALUE(couponDescription_, couponDescription) };
    ...
    inline CreateCouponTemplateShrinkRequest& setExpireddate(string expireddate) { DARABONBA_PTR_SET_VALUE(expireddate_, expireddate) };
    ...
    inline CreateCouponTemplateShrinkRequest& setLimitPerPerson(string limitPerPerson) { DARABONBA_PTR_SET_VALUE(limitPerPerson_, limitPerPerson) };


    // productTypeShrink Field Functions 
    bool hasProductTypeShrink() const { return this->productTypeShrink_ != nullptr;};
    void deleteProductTypeShrink() { this->productTypeShrink_ = nullptr;};
    inline string productTypeShrink() const { DARABONBA_PTR_GET_DEFAULT(productTypeShrink_, "") };
    inline CreateCouponTemplateShrinkRequest& setProductTypeShrink(string productTypeShrink) { DARABONBA_PTR_SET_VALUE(productTypeShrink_, productTypeShrink) };
    ...
    inline CreateCouponTemplateShrinkRequest& setPurchaseType(string purchaseType) { DARABONBA_PTR_SET_VALUE(purchaseType_, purchaseType) };
    ...
    inline CreateCouponTemplateShrinkRequest& setReasonForApplication(string reasonForApplication) { DARABONBA_PTR_SET_VALUE(reasonForApplication_, reasonForApplication) };
    ...
    inline CreateCouponTemplateShrinkRequest& setTemplateName(string templateName) { DARABONBA_PTR_SET_VALUE(templateName_, templateName) };
    ...
    inline CreateCouponTemplateShrinkRequest& setVailddate(string vailddate) { DARABONBA_PTR_SET_VALUE(vailddate_, vailddate) };
    ...
    inline CreateCouponTemplateShrinkRequest& setVaildperioddays(string vaildperioddays) { DARABONBA_PTR_SET_VALUE(vaildperioddays_, vaildperioddays) };
    ...
    inline CreateCouponTemplateShrinkRequest& setValidUntil(string validUntil) { DARABONBA_PTR_SET_VALUE(validUntil_, validUntil) };
    ...
    inline CreateCouponTemplateShrinkRequest& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
  ...
  protected:
    ...
    std::shared_ptr<string> productTypeShrink_ = nullptr;
