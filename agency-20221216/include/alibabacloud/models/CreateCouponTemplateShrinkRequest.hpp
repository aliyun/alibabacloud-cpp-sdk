...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        ...
        && this->productTypeShrink_ == nullptr && this->purchaseType_ == nullptr && this->reasonForApplication_ == nullptr && this->templateName_ == nullptr && this->vailddate_ == nullptr
    ...
    inline string getProductTypeShrink() const { DARABONBA_PTR_GET_DEFAULT(productTypeShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> productTypeShrink_ {};
