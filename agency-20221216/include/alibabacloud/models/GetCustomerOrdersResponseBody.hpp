...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->data_ == nullptr && return this->message_ == nullptr && return this->msg_ == nullptr && return this->pageNo_ == nullptr && return this->pageSize_ == nullptr
    ...
    inline const vector<GetCustomerOrdersResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetCustomerOrdersResponseBodyData>) };
    inline vector<GetCustomerOrdersResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetCustomerOrdersResponseBodyData>) };
    inline GetCustomerOrdersResponseBody& setData(const vector<GetCustomerOrdersResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCustomerOrdersResponseBody& setData(vector<GetCustomerOrdersResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetCustomerOrdersResponseBodyData>> data_ = nullptr;
