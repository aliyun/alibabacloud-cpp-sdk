...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListExportTasksResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListExportTasksResponseBodyData>) };
    inline vector<ListExportTasksResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListExportTasksResponseBodyData>) };
    inline ListExportTasksResponseBody& setData(const vector<ListExportTasksResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListExportTasksResponseBody& setData(vector<ListExportTasksResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListExportTasksResponseBodyData>> data_ = nullptr;
