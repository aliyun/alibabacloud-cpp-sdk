...
#ifndef ALIBABACLOUD_MODELS_GETDAILYBILLRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETDAILYBILLRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetDailyBillResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetDailyBillResponseBody& obj) { 
    ...
    GetDailyBillResponseBody() = default ;
    GetDailyBillResponseBody(const GetDailyBillResponseBody &) = default ;
    GetDailyBillResponseBody(GetDailyBillResponseBody &&) = default ;
    GetDailyBillResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDailyBillResponseBody() = default ;
    GetDailyBillResponseBody& operator=(const GetDailyBillResponseBody &) = default ;
    GetDailyBillResponseBody& operator=(GetDailyBillResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->billLinkCSV_ == nullptr
        && this->billLinkXLSX_ == nullptr && this->billOwner_ == nullptr && this->billType_ == nullptr && this->spendingTime_ == nullptr; };
    ...
    inline GetDailyBillResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetDailyBillResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetDailyBillResponseBody::Data) };
    inline GetDailyBillResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetDailyBillResponseBody::Data) };
    inline GetDailyBillResponseBody& setData(const GetDailyBillResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDailyBillResponseBody& setData(GetDailyBillResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetDailyBillResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetDailyBillResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetDailyBillResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    // The returned data.
    shared_ptr<GetDailyBillResponseBody::Data> data_ {};
