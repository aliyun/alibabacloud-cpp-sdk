...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryReversedDeductionHistoryResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryReversedDeductionHistoryResponseBodyData>) };
    inline vector<QueryReversedDeductionHistoryResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryReversedDeductionHistoryResponseBodyData>) };
    inline QueryReversedDeductionHistoryResponseBody& setData(const vector<QueryReversedDeductionHistoryResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryReversedDeductionHistoryResponseBody& setData(vector<QueryReversedDeductionHistoryResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryReversedDeductionHistoryResponseBodyData>> data_ = nullptr;
