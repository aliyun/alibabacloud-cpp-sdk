...
namespace Models
{
  ...
  public:
    ...
    inline const CancelSubscriptionBillResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelSubscriptionBillResponseBody) };
    inline CancelSubscriptionBillResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelSubscriptionBillResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelSubscriptionBillResponseBody> body_ {};
  };
