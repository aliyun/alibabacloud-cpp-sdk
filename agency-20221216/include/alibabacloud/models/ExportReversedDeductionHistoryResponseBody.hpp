...
namespace Models
{
  ...
  public:
    ...
    inline const ExportReversedDeductionHistoryResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ExportReversedDeductionHistoryResponseBody::Data) };
    inline ExportReversedDeductionHistoryResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ExportReversedDeductionHistoryResponseBody::Data) };
    inline ExportReversedDeductionHistoryResponseBody& setData(const ExportReversedDeductionHistoryResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ExportReversedDeductionHistoryResponseBody& setData(ExportReversedDeductionHistoryResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<ExportReversedDeductionHistoryResponseBody::Data> data_ {};
