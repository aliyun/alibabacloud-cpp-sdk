...
namespace Models
{
  ...
  public:
    ...
    inline const GetInviteStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetInviteStatusResponseBody) };
    inline GetInviteStatusResponseBody body() { DARABONBA_PTR_GET(body_, GetInviteStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetInviteStatusResponseBody> body_ = nullptr;
  };
