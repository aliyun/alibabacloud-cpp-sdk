...
namespace Models
{
  ...
  public:
    ...
    inline const GetRealtimeCampaignStatsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRealtimeCampaignStatsResponseBody) };
    inline GetRealtimeCampaignStatsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRealtimeCampaignStatsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRealtimeCampaignStatsResponseBody> body_ {};
  };
