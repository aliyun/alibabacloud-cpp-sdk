...
namespace Models
{
  ...
  public:
    ...
    inline const SaveRTCStatsV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveRTCStatsV2ResponseBody) };
    inline SaveRTCStatsV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveRTCStatsV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveRTCStatsV2ResponseBody> body_ {};
  };
