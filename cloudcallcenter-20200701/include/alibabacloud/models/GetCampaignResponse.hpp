...
namespace Models
{
  ...
  public:
    ...
    inline const GetCampaignResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCampaignResponseBody) };
    inline GetCampaignResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCampaignResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCampaignResponseBody> body_ {};
  };
