...
namespace Models
{
  ...
  public:
    ...
    inline const ListCasesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCasesResponseBody) };
    inline ListCasesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCasesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCasesResponseBody> body_ {};
  };
