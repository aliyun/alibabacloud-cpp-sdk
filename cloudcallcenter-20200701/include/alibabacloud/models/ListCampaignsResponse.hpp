...
namespace Models
{
  ...
  public:
    ...
    inline const ListCampaignsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCampaignsResponseBody) };
    inline ListCampaignsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCampaignsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCampaignsResponseBody> body_ {};
  };
