...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->campaignId_ == nullptr
        && this->instanceId_ == nullptr && this->phoneNumberListShrink_ == nullptr; };
    ...
    inline AbortCasesShrinkRequest& setPhoneNumberListShrink(string phoneNumberListShrink) { DARABONBA_PTR_SET_VALUE(phoneNumberListShrink_, phoneNumberListShrink) };
