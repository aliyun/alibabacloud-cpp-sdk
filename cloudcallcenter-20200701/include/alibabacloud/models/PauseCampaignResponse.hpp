...
namespace Models
{
  ...
  public:
    ...
    inline const PauseCampaignResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PauseCampaignResponseBody) };
    inline PauseCampaignResponseBody getBody() { DARABONBA_PTR_GET(body_, PauseCampaignResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PauseCampaignResponseBody> body_ {};
  };
