...
namespace Models
{
  ...
  public:
    ...
    inline const SendNotificationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendNotificationResponseBody) };
    inline SendNotificationResponseBody getBody() { DARABONBA_PTR_GET(body_, SendNotificationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendNotificationResponseBody> body_ {};
  };
