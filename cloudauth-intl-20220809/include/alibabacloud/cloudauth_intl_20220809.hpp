...
public:
  ...
  explicit KeepaliveIntlResponseBodyResult(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  shared_ptr<string> message{};
  shared_ptr<string> requestId{};
  shared_ptr<KeepaliveIntlResponseBodyResult> result{};

  KeepaliveIntlResponseBody() {}

  explicit KeepaliveIntlResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("Result") != m.end() && !m["Result"].empty()) {
      if (typeid(map<string, boost::any>) == m["Result"].type()) {
        KeepaliveIntlResponseBodyResult model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["Result"]));
        result = make_shared<KeepaliveIntlResponseBodyResult>(model1);
      }
    }
  }
...
class KeepaliveIntlResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<KeepaliveIntlResponseBody> body{};

  KeepaliveIntlResponse() {}

  explicit KeepaliveIntlResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        KeepaliveIntlResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<KeepaliveIntlResponseBody>(model1);
      }
    }
  }


  virtual ~KeepaliveIntlResponse() = default;
};
...
public:
  ...
  explicit Mobile2MetaVerifyIntlRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  explicit Mobile2MetaVerifyIntlResponseBodyResult(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  shared_ptr<string> message{};
  shared_ptr<string> requestId{};
  shared_ptr<Mobile2MetaVerifyIntlResponseBodyResult> result{};

  Mobile2MetaVerifyIntlResponseBody() {}

  explicit Mobile2MetaVerifyIntlResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("Result") != m.end() && !m["Result"].empty()) {
      if (typeid(map<string, boost::any>) == m["Result"].type()) {
        Mobile2MetaVerifyIntlResponseBodyResult model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["Result"]));
        result = make_shared<Mobile2MetaVerifyIntlResponseBodyResult>(model1);
      }
    }
  }
...
class Mobile2MetaVerifyIntlResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<Mobile2MetaVerifyIntlResponseBody> body{};

  Mobile2MetaVerifyIntlResponse() {}

  explicit Mobile2MetaVerifyIntlResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        Mobile2MetaVerifyIntlResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<Mobile2MetaVerifyIntlResponseBody>(model1);
      }
    }
  }


  virtual ~Mobile2MetaVerifyIntlResponse() = default;
};
...
public:
  ...
  KeepaliveIntlResponse keepaliveIntlWithOptions(shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  KeepaliveIntlResponse keepaliveIntl();
  Mobile2MetaVerifyIntlResponse mobile2MetaVerifyIntlWithOptions(shared_ptr<Mobile2MetaVerifyIntlRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  Mobile2MetaVerifyIntlResponse mobile2MetaVerifyIntl(shared_ptr<Mobile2MetaVerifyIntlRequest> request);
