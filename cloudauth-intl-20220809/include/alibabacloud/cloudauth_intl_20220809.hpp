...
public:
  shared_ptr<string> deletePicAfterQuery{};
  shared_ptr<string> transactionId{};
  ...
  map<string, boost::any> toMap() override {
    map<string, boost::any> res;
    if (deletePicAfterQuery) {
      res["DeletePicAfterQuery"] = boost::any(*deletePicAfterQuery);
    }
    if (transactionId) {
      res["TransactionId"] = boost::any(*transactionId);
    }
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("DeletePicAfterQuery") != m.end() && !m["DeletePicAfterQuery"].empty()) {
      deletePicAfterQuery = make_shared<string>(boost::any_cast<string>(m["DeletePicAfterQuery"]));
    }
    if (m.find("TransactionId") != m.end() && !m["TransactionId"].empty()) {
      transactionId = make_shared<string>(boost::any_cast<string>(m["TransactionId"]));
    }
...
class DeletePictureResponseBodyResult : public Darabonba::Model {
public:
  shared_ptr<string> deleteResult{};
  shared_ptr<string> transactionId{};

  DeletePictureResponseBodyResult() {}

  explicit DeletePictureResponseBodyResult(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DeletePictureResponseBodyResult() = default;
};
...
public:
  ...
  shared_ptr<string> message{};
  shared_ptr<string> requestId{};
  shared_ptr<DeletePictureResponseBodyResult> result{};
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("Result") != m.end() && !m["Result"].empty()) {
      if (typeid(map<string, boost::any>) == m["Result"].type()) {
        DeletePictureResponseBodyResult model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["Result"]));
        result = make_shared<DeletePictureResponseBodyResult>(model1);
      }
    }
  }
