...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bankCard_ == nullptr
        && return this->identifyNum_ == nullptr && return this->identityType_ == nullptr && return this->mobile_ == nullptr && return this->paramType_ == nullptr && return this->productCode_ == nullptr
        && return this->productType_ == nullptr && return this->userName_ == nullptr && return this->verifyMode_ == nullptr; };
