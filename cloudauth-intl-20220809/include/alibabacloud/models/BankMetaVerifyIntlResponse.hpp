...
namespace Models
{
  ...
  public:
    ...
    inline const BankMetaVerifyIntlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BankMetaVerifyIntlResponseBody) };
    inline BankMetaVerifyIntlResponseBody getBody() { DARABONBA_PTR_GET(body_, BankMetaVerifyIntlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BankMetaVerifyIntlResponseBody> body_ {};
  };
