...
namespace Models
{
  ...
  public:
    ...
    inline const CheckVerifyLogResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, CheckVerifyLogResponseBodyResult) };
    inline CheckVerifyLogResponseBodyResult result() { DARABONBA_PTR_GET(result_, CheckVerifyLogResponseBodyResult) };
    inline CheckVerifyLogResponseBody& setResult(const CheckVerifyLogResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CheckVerifyLogResponseBody& setResult(CheckVerifyLogResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // Return result.
    std::shared_ptr<CheckVerifyLogResponseBodyResult> result_ = nullptr;
  };
