...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->facePictureBase64_ == nullptr
        && this->facePictureFileObject_ == nullptr && this->facePictureUrl_ == nullptr && this->faceQualityCheck_ == nullptr && this->merchantBizId_ == nullptr && this->merchantUserId_ == nullptr
