...
#ifndef ALIBABACLOUD_MODELS_FACELIVENESSV2ADVANCEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_FACELIVENESSV2ADVANCEREQUEST_HPP_
...
namespace Models
{
  class FaceLivenessV2AdvanceRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const FaceLivenessV2AdvanceRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FaceLivenessV2AdvanceRequest& obj) { 
    ...
    FaceLivenessV2AdvanceRequest() = default ;
    FaceLivenessV2AdvanceRequest(const FaceLivenessV2AdvanceRequest &) = default ;
    FaceLivenessV2AdvanceRequest(FaceLivenessV2AdvanceRequest &&) = default ;
    FaceLivenessV2AdvanceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FaceLivenessV2AdvanceRequest() = default ;
    FaceLivenessV2AdvanceRequest& operator=(const FaceLivenessV2AdvanceRequest &) = default ;
    FaceLivenessV2AdvanceRequest& operator=(FaceLivenessV2AdvanceRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->faceAttributeCheck_ == nullptr
        && this->facePictureBase64_ == nullptr && this->facePictureFileObject_ == nullptr && this->facePictureUrl_ == nullptr && this->faceQualityCheck_ == nullptr && this->merchantBizId_ == nullptr
    ...
    inline FaceLivenessV2AdvanceRequest& setFaceAttributeCheck(string faceAttributeCheck) { DARABONBA_PTR_SET_VALUE(faceAttributeCheck_, faceAttributeCheck) };
    ...
    inline FaceLivenessV2AdvanceRequest& setFacePictureBase64(string facePictureBase64) { DARABONBA_PTR_SET_VALUE(facePictureBase64_, facePictureBase64) };
    ...
    inline FaceLivenessV2AdvanceRequest& setFacePictureFileObject(shared_ptr<Darabonba::IStream> facePictureFileObject) { DARABONBA_SET_VALUE(facePictureFileObject_, facePictureFileObject) };
    ...
    inline FaceLivenessV2AdvanceRequest& setFacePictureUrl(string facePictureUrl) { DARABONBA_PTR_SET_VALUE(facePictureUrl_, facePictureUrl) };
    ...
    inline FaceLivenessV2AdvanceRequest& setFaceQualityCheck(string faceQualityCheck) { DARABONBA_PTR_SET_VALUE(faceQualityCheck_, faceQualityCheck) };
    ...
    inline FaceLivenessV2AdvanceRequest& setMerchantBizId(string merchantBizId) { DARABONBA_PTR_SET_VALUE(merchantBizId_, merchantBizId) };
    ...
    inline FaceLivenessV2AdvanceRequest& setMerchantUserId(string merchantUserId) { DARABONBA_PTR_SET_VALUE(merchantUserId_, merchantUserId) };
    ...
    inline FaceLivenessV2AdvanceRequest& setProductCode(string productCode) { DARABONBA_PTR_SET_VALUE(productCode_, productCode) };
