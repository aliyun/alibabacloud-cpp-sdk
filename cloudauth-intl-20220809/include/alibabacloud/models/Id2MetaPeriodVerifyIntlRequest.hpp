...
namespace Models
{
  ...
  public:
    ...
    inline string getValidityEndDate() const { DARABONBA_PTR_GET_DEFAULT(validityEndDate_, "") };
    ...
    inline string getValidityStartDate() const { DARABONBA_PTR_GET_DEFAULT(validityStartDate_, "") };
