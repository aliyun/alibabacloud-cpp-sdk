...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bizType_ == nullptr
        && return this->code_ == nullptr && return this->downloadMode_ == nullptr && return this->param_ == nullptr && return this->productType_ == nullptr; };
    ...
    inline string downloadMode() const { DARABONBA_PTR_GET_DEFAULT(downloadMode_, "") };
  ...
  protected:
    ...
    // - **async**: Asynchronous
    // - **sync**: Synchronous
    std::shared_ptr<string> downloadMode_ = nullptr;
