...
namespace Models
{
  ...
  public:
    ...
    inline const TempAccessTokenIntlResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, TempAccessTokenIntlResponseBodyData) };
    inline TempAccessTokenIntlResponseBodyData data() { DARABONBA_PTR_GET(data_, TempAccessTokenIntlResponseBodyData) };
    inline TempAccessTokenIntlResponseBody& setData(const TempAccessTokenIntlResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline TempAccessTokenIntlResponseBody& setData(TempAccessTokenIntlResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<TempAccessTokenIntlResponseBodyData> data_ = nullptr;
