...
namespace Models
{
  ...
  public:
    ...
    inline const FaceCompareResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, FaceCompareResponseBodyResult) };
    inline FaceCompareResponseBodyResult result() { DARABONBA_PTR_GET(result_, FaceCompareResponseBodyResult) };
    inline FaceCompareResponseBody& setResult(const FaceCompareResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline FaceCompareResponseBody& setResult(FaceCompareResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
