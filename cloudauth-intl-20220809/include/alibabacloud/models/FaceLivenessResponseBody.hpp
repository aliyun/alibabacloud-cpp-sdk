...
namespace Models
{
  ...
  public:
    ...
    inline const FaceLivenessResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, FaceLivenessResponseBodyResult) };
    inline FaceLivenessResponseBodyResult result() { DARABONBA_PTR_GET(result_, FaceLivenessResponseBodyResult) };
    inline FaceLivenessResponseBody& setResult(const FaceLivenessResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline FaceLivenessResponseBody& setResult(FaceLivenessResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
