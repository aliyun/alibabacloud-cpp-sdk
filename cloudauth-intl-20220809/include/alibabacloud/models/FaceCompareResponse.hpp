...
namespace Models
{
  ...
  public:
    ...
    inline const FaceCompareResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FaceCompareResponseBody) };
    inline FaceCompareResponseBody getBody() { DARABONBA_PTR_GET(body_, FaceCompareResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FaceCompareResponseBody> body_ {};
  };
