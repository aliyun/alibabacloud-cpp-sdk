...
namespace Models
{
  ...
  public:
    ...
    inline const Mobile2MetaVerifyIntlResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, Mobile2MetaVerifyIntlResponseBodyResult) };
    inline Mobile2MetaVerifyIntlResponseBodyResult result() { DARABONBA_PTR_GET(result_, Mobile2MetaVerifyIntlResponseBodyResult) };
    inline Mobile2MetaVerifyIntlResponseBody& setResult(const Mobile2MetaVerifyIntlResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline Mobile2MetaVerifyIntlResponseBody& setResult(Mobile2MetaVerifyIntlResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
