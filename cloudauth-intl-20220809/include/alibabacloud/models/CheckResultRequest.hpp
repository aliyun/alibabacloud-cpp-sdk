...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->extraImageControlList_ == nullptr
        && return this->isReturnImage_ == nullptr && return this->merchantBizId_ == nullptr && return this->returnFiveCategorySpoofResult_ == nullptr && return this->transactionId_ == nullptr; };
    ...
    inline string extraImageControlList() const { DARABONBA_PTR_GET_DEFAULT(extraImageControlList_, "") };
    ...
    inline string isReturnImage() const { DARABONBA_PTR_GET_DEFAULT(isReturnImage_, "") };
    ...
    inline string returnFiveCategorySpoofResult() const { DARABONBA_PTR_GET_DEFAULT(returnFiveCategorySpoofResult_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> extraImageControlList_ = nullptr;
    // Whether to return images.
    // - Y: Return
    // - N: Do not return
    std::shared_ptr<string> isReturnImage_ = nullptr;
    ...
    std::shared_ptr<string> returnFiveCategorySpoofResult_ = nullptr;
    // Authentication ID.
