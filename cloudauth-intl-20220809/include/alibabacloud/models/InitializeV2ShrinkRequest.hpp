...
#ifndef ALIBABACLOUD_MODELS_INITIALIZEV2SHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_INITIALIZEV2SHRINKREQUEST_HPP_
...
namespace Models
{
  class InitializeV2ShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const InitializeV2ShrinkRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(DocPageConfig, docPageConfigShrink_);
    ...
    friend void from_json(const Darabonba::Json& j, InitializeV2ShrinkRequest& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(DocPageConfig, docPageConfigShrink_);
    ...
    InitializeV2ShrinkRequest() = default ;
    InitializeV2ShrinkRequest(const InitializeV2ShrinkRequest &) = default ;
    InitializeV2ShrinkRequest(InitializeV2ShrinkRequest &&) = default ;
    InitializeV2ShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~InitializeV2ShrinkRequest() = default ;
    InitializeV2ShrinkRequest& operator=(const InitializeV2ShrinkRequest &) = default ;
    InitializeV2ShrinkRequest& operator=(InitializeV2ShrinkRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->appQualityCheck_ == nullptr
        ...
        && this->docNo_ == nullptr && this->docPageConfigShrink_ == nullptr && this->docScanMode_ == nullptr && this->docType_ == nullptr && this->docVideo_ == nullptr
    ...
    inline InitializeV2ShrinkRequest& setAppQualityCheck(string appQualityCheck) { DARABONBA_PTR_SET_VALUE(appQualityCheck_, appQualityCheck) };
    ...
    inline InitializeV2ShrinkRequest& setAuthorize(string authorize) { DARABONBA_PTR_SET_VALUE(authorize_, authorize) };
    ...
    inline InitializeV2ShrinkRequest& setAutoDocPageConfig(string autoDocPageConfig) { DARABONBA_PTR_SET_VALUE(autoDocPageConfig_, autoDocPageConfig) };
    ...
    inline InitializeV2ShrinkRequest& setAutoRegistration(string autoRegistration) { DARABONBA_PTR_SET_VALUE(autoRegistration_, autoRegistration) };
    ...
    inline InitializeV2ShrinkRequest& setCallbackToken(string callbackToken) { DARABONBA_PTR_SET_VALUE(callbackToken_, callbackToken) };
    ...
    inline InitializeV2ShrinkRequest& setCallbackUrl(string callbackUrl) { DARABONBA_PTR_SET_VALUE(callbackUrl_, callbackUrl) };
    ...
    inline InitializeV2ShrinkRequest& setChameleonFrameEnable(string chameleonFrameEnable) { DARABONBA_PTR_SET_VALUE(chameleonFrameEnable_, chameleonFrameEnable) };
    ...
    inline InitializeV2ShrinkRequest& setCrop(string crop) { DARABONBA_PTR_SET_VALUE(crop_, crop) };
    ...
    inline InitializeV2ShrinkRequest& setDateOfBirth(string dateOfBirth) { DARABONBA_PTR_SET_VALUE(dateOfBirth_, dateOfBirth) };
    ...
    inline InitializeV2ShrinkRequest& setDateOfExpiry(string dateOfExpiry) { DARABONBA_PTR_SET_VALUE(dateOfExpiry_, dateOfExpiry) };
    ...
    inline InitializeV2ShrinkRequest& setDocName(string docName) { DARABONBA_PTR_SET_VALUE(docName_, docName) };
    ...
    inline InitializeV2ShrinkRequest& setDocNo(string docNo) { DARABONBA_PTR_SET_VALUE(docNo_, docNo) };


    // docPageConfigShrink Field Functions 
    bool hasDocPageConfigShrink() const { return this->docPageConfigShrink_ != nullptr;};
    void deleteDocPageConfigShrink() { this->docPageConfigShrink_ = nullptr;};
    inline string getDocPageConfigShrink() const { DARABONBA_PTR_GET_DEFAULT(docPageConfigShrink_, "") };
    inline InitializeV2ShrinkRequest& setDocPageConfigShrink(string docPageConfigShrink) { DARABONBA_PTR_SET_VALUE(docPageConfigShrink_, docPageConfigShrink) };
    ...
    inline InitializeV2ShrinkRequest& setDocScanMode(string docScanMode) { DARABONBA_PTR_SET_VALUE(docScanMode_, docScanMode) };
    ...
    inline InitializeV2ShrinkRequest& setDocType(string docType) { DARABONBA_PTR_SET_VALUE(docType_, docType) };
    ...
    inline InitializeV2ShrinkRequest& setDocVideo(string docVideo) { DARABONBA_PTR_SET_VALUE(docVideo_, docVideo) };
    ...
    inline InitializeV2ShrinkRequest& setDocumentNumber(string documentNumber) { DARABONBA_PTR_SET_VALUE(documentNumber_, documentNumber) };
    ...
    inline InitializeV2ShrinkRequest& setEditOcrResult(string editOcrResult) { DARABONBA_PTR_SET_VALUE(editOcrResult_, editOcrResult) };
    ...
    inline InitializeV2ShrinkRequest& setEmail(string email) { DARABONBA_PTR_SET_VALUE(email_, email) };
    ...
    inline InitializeV2ShrinkRequest& setExperienceCode(string experienceCode) { DARABONBA_PTR_SET_VALUE(experienceCode_, experienceCode) };
    ...
    inline InitializeV2ShrinkRequest& setFaceAttributeCheck(string faceAttributeCheck) { DARABONBA_PTR_SET_VALUE(faceAttributeCheck_, faceAttributeCheck) };
    ...
    inline InitializeV2ShrinkRequest& setFaceGroupCodes(string faceGroupCodes) { DARABONBA_PTR_SET_VALUE(faceGroupCodes_, faceGroupCodes) };
    ...
    inline InitializeV2ShrinkRequest& setFacePictureBase64(string facePictureBase64) { DARABONBA_PTR_SET_VALUE(facePictureBase64_, facePictureBase64) };
    ...
    inline InitializeV2ShrinkRequest& setFacePictureFile(string facePictureFile) { DARABONBA_PTR_SET_VALUE(facePictureFile_, facePictureFile) };
    ...
    inline InitializeV2ShrinkRequest& setFacePictureUrl(string facePictureUrl) { DARABONBA_PTR_SET_VALUE(facePictureUrl_, facePictureUrl) };
    ...
    inline InitializeV2ShrinkRequest& setFaceRegisterGroupCode(string faceRegisterGroupCode) { DARABONBA_PTR_SET_VALUE(faceRegisterGroupCode_, faceRegisterGroupCode) };
    ...
    inline InitializeV2ShrinkRequest& setFaceVerifyThreshold(string faceVerifyThreshold) { DARABONBA_PTR_SET_VALUE(faceVerifyThreshold_, faceVerifyThreshold) };
    ...
    inline InitializeV2ShrinkRequest& setIdFaceQuality(string idFaceQuality) { DARABONBA_PTR_SET_VALUE(idFaceQuality_, idFaceQuality) };
    ...
    inline InitializeV2ShrinkRequest& setIdSpoof(string idSpoof) { DARABONBA_PTR_SET_VALUE(idSpoof_, idSpoof) };
    ...
    inline InitializeV2ShrinkRequest& setIdThreshold(string idThreshold) { DARABONBA_PTR_SET_VALUE(idThreshold_, idThreshold) };
    ...
    inline InitializeV2ShrinkRequest& setLanguageConfig(string languageConfig) { DARABONBA_PTR_SET_VALUE(languageConfig_, languageConfig) };
    ...
    inline InitializeV2ShrinkRequest& setMRTDInput(string MRTDInput) { DARABONBA_PTR_SET_VALUE(MRTDInput_, MRTDInput) };
    ...
    inline InitializeV2ShrinkRequest& setMerchantBizId(string merchantBizId) { DARABONBA_PTR_SET_VALUE(merchantBizId_, merchantBizId) };
    ...
    inline InitializeV2ShrinkRequest& setMerchantUserId(string merchantUserId) { DARABONBA_PTR_SET_VALUE(merchantUserId_, merchantUserId) };
    ...
    inline InitializeV2ShrinkRequest& setMetaInfo(string metaInfo) { DARABONBA_PTR_SET_VALUE(metaInfo_, metaInfo) };
    ...
    inline InitializeV2ShrinkRequest& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline InitializeV2ShrinkRequest& setModel(string model) { DARABONBA_PTR_SET_VALUE(model_, model) };
    ...
    inline InitializeV2ShrinkRequest& setOcr(string ocr) { DARABONBA_PTR_SET_VALUE(ocr_, ocr) };
    ...
    inline InitializeV2ShrinkRequest& setOcrValueStandard(string ocrValueStandard) { DARABONBA_PTR_SET_VALUE(ocrValueStandard_, ocrValueStandard) };
    ...
    inline InitializeV2ShrinkRequest& setPages(string pages) { DARABONBA_PTR_SET_VALUE(pages_, pages) };
    ...
    inline InitializeV2ShrinkRequest& setProcedurePriority(string procedurePriority) { DARABONBA_PTR_SET_VALUE(procedurePriority_, procedurePriority) };
    ...
    inline InitializeV2ShrinkRequest& setProductCode(string productCode) { DARABONBA_PTR_SET_VALUE(productCode_, productCode) };
    ...
    inline InitializeV2ShrinkRequest& setProductFlow(string productFlow) { DARABONBA_PTR_SET_VALUE(productFlow_, productFlow) };
    ...
    inline InitializeV2ShrinkRequest& setReturnFaces(string returnFaces) { DARABONBA_PTR_SET_VALUE(returnFaces_, returnFaces) };
    ...
    inline InitializeV2ShrinkRequest& setReturnUrl(string returnUrl) { DARABONBA_PTR_SET_VALUE(returnUrl_, returnUrl) };
    ...
    inline InitializeV2ShrinkRequest& setSaveFacePicture(string saveFacePicture) { DARABONBA_PTR_SET_VALUE(saveFacePicture_, saveFacePicture) };
    ...
    inline InitializeV2ShrinkRequest& setSceneCode(string sceneCode) { DARABONBA_PTR_SET_VALUE(sceneCode_, sceneCode) };
    ...
    inline InitializeV2ShrinkRequest& setSecurityLevel(string securityLevel) { DARABONBA_PTR_SET_VALUE(securityLevel_, securityLevel) };
    ...
    inline InitializeV2ShrinkRequest& setShowAlbumIcon(string showAlbumIcon) { DARABONBA_PTR_SET_VALUE(showAlbumIcon_, showAlbumIcon) };
    ...
    inline InitializeV2ShrinkRequest& setShowGuidePage(string showGuidePage) { DARABONBA_PTR_SET_VALUE(showGuidePage_, showGuidePage) };
    ...
    inline InitializeV2ShrinkRequest& setShowOcrResult(string showOcrResult) { DARABONBA_PTR_SET_VALUE(showOcrResult_, showOcrResult) };
    ...
    inline InitializeV2ShrinkRequest& setStyleConfig(string styleConfig) { DARABONBA_PTR_SET_VALUE(styleConfig_, styleConfig) };
    ...
    inline InitializeV2ShrinkRequest& setTargetFacePicture(string targetFacePicture) { DARABONBA_PTR_SET_VALUE(targetFacePicture_, targetFacePicture) };
    ...
    inline InitializeV2ShrinkRequest& setTargetFacePictureFile(string targetFacePictureFile) { DARABONBA_PTR_SET_VALUE(targetFacePictureFile_, targetFacePictureFile) };
    ...
    inline InitializeV2ShrinkRequest& setTargetFacePictureUrl(string targetFacePictureUrl) { DARABONBA_PTR_SET_VALUE(targetFacePictureUrl_, targetFacePictureUrl) };
    ...
    inline InitializeV2ShrinkRequest& setTemplateConfig(string templateConfig) { DARABONBA_PTR_SET_VALUE(templateConfig_, templateConfig) };
    ...
    inline InitializeV2ShrinkRequest& setTemplateRanCount(string templateRanCount) { DARABONBA_PTR_SET_VALUE(templateRanCount_, templateRanCount) };
    ...
    inline InitializeV2ShrinkRequest& setTemplateType(string templateType) { DARABONBA_PTR_SET_VALUE(templateType_, templateType) };
    ...
    inline InitializeV2ShrinkRequest& setUpdateFaceIfUserExists(string updateFaceIfUserExists) { DARABONBA_PTR_SET_VALUE(updateFaceIfUserExists_, updateFaceIfUserExists) };
    ...
    inline InitializeV2ShrinkRequest& setUseNFC(string useNFC) { DARABONBA_PTR_SET_VALUE(useNFC_, useNFC) };
    ...
    inline InitializeV2ShrinkRequest& setVerifyModel(string verifyModel) { DARABONBA_PTR_SET_VALUE(verifyModel_, verifyModel) };
  ...
  protected:
    ...
    shared_ptr<string> docPageConfigShrink_ {};
