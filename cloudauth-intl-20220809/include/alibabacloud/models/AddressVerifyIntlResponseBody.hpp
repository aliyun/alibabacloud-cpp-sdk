...
#ifndef ALIBABACLOUD_MODELS_ADDRESSVERIFYINTLRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ADDRESSVERIFYINTLRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddressVerifyIntlResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Code, code_);
      DARABONBA_PTR_TO_JSON(Message, message_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(ResultObject, resultObject_);
    };
    friend void from_json(const Darabonba::Json& j, AddressVerifyIntlResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Code, code_);
      DARABONBA_PTR_FROM_JSON(Message, message_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(ResultObject, resultObject_);
    };
    AddressVerifyIntlResponseBody() = default ;
    AddressVerifyIntlResponseBody(const AddressVerifyIntlResponseBody &) = default ;
    AddressVerifyIntlResponseBody(AddressVerifyIntlResponseBody &&) = default ;
    AddressVerifyIntlResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddressVerifyIntlResponseBody() = default ;
    AddressVerifyIntlResponseBody& operator=(const AddressVerifyIntlResponseBody &) = default ;
    AddressVerifyIntlResponseBody& operator=(AddressVerifyIntlResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->addressInfo_ == nullptr
        && this->ispName_ == nullptr && this->passed_ == nullptr && this->subCode_ == nullptr && this->transactionId_ == nullptr; };
      ...
      inline string getAddressInfo() const { DARABONBA_PTR_GET_DEFAULT(addressInfo_, "") };
      inline ResultObject& setAddressInfo(string addressInfo) { DARABONBA_PTR_SET_VALUE(addressInfo_, addressInfo) };
    ...
    inline AddressVerifyIntlResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline AddressVerifyIntlResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline AddressVerifyIntlResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // resultObject Field Functions 
    bool hasResultObject() const { return this->resultObject_ != nullptr;};
    void deleteResultObject() { this->resultObject_ = nullptr;};
    inline const AddressVerifyIntlResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, AddressVerifyIntlResponseBody::ResultObject) };
    inline AddressVerifyIntlResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, AddressVerifyIntlResponseBody::ResultObject) };
    inline AddressVerifyIntlResponseBody& setResultObject(const AddressVerifyIntlResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline AddressVerifyIntlResponseBody& setResultObject(AddressVerifyIntlResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
