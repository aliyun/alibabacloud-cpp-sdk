...
namespace Models
{
  ...
  public:
    ...
    inline const KeepaliveIntlResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, KeepaliveIntlResponseBodyResult) };
    inline KeepaliveIntlResponseBodyResult result() { DARABONBA_PTR_GET(result_, KeepaliveIntlResponseBodyResult) };
    inline KeepaliveIntlResponseBody& setResult(const KeepaliveIntlResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline KeepaliveIntlResponseBody& setResult(KeepaliveIntlResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
