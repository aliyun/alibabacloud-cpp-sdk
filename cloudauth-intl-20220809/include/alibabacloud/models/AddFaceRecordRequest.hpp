...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->faceGroupCode_ == nullptr
        && return this->facePicture_ == nullptr && return this->facePictureFile_ == nullptr && return this->facePictureUrl_ == nullptr && return this->faceQualityCheck_ == nullptr && return this->merchantUserId_ == nullptr
    ...
    inline string facePictureFile() const { DARABONBA_PTR_GET_DEFAULT(facePictureFile_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> facePictureFile_ = nullptr;
