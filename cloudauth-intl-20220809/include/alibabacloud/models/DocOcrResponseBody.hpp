...
namespace Models
{
  ...
  public:
    ...
    inline const DocOcrResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DocOcrResponseBodyResult) };
    inline DocOcrResponseBodyResult result() { DARABONBA_PTR_GET(result_, DocOcrResponseBodyResult) };
    inline DocOcrResponseBody& setResult(const DocOcrResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DocOcrResponseBody& setResult(DocOcrResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // Return result
    std::shared_ptr<DocOcrResponseBodyResult> result_ = nullptr;
  };
