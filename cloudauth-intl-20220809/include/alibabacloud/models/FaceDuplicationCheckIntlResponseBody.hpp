...
namespace Models
{
  ...
  public:
    ...
    inline const FaceDuplicationCheckIntlResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, FaceDuplicationCheckIntlResponseBodyResult) };
    inline FaceDuplicationCheckIntlResponseBodyResult result() { DARABONBA_PTR_GET(result_, FaceDuplicationCheckIntlResponseBodyResult) };
    inline FaceDuplicationCheckIntlResponseBody& setResult(const FaceDuplicationCheckIntlResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline FaceDuplicationCheckIntlResponseBody& setResult(FaceDuplicationCheckIntlResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // Return result.
    std::shared_ptr<FaceDuplicationCheckIntlResponseBodyResult> result_ = nullptr;
  };
