...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVerifyResultResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteVerifyResultResponseBody) };
    inline DeleteVerifyResultResponseBody body() { DARABONBA_PTR_GET(body_, DeleteVerifyResultResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteVerifyResultResponseBody> body_ = nullptr;
  };
