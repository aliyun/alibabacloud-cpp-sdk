...
#ifndef ALIBABACLOUD_MODELS_DOCOCRRESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_DOCOCRRESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DocOcrResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DocOcrResponseBodyResult& obj) { 
    ...
    DocOcrResponseBodyResult() = default ;
    DocOcrResponseBodyResult(const DocOcrResponseBodyResult &) = default ;
    DocOcrResponseBodyResult(DocOcrResponseBodyResult &&) = default ;
    DocOcrResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DocOcrResponseBodyResult() = default ;
    DocOcrResponseBodyResult& operator=(const DocOcrResponseBodyResult &) = default ;
    DocOcrResponseBodyResult& operator=(DocOcrResponseBodyResult &&) = default ;
    ...
    inline DocOcrResponseBodyResult& setExtIdInfo(string extIdInfo) { DARABONBA_PTR_SET_VALUE(extIdInfo_, extIdInfo) };
    ...
    inline DocOcrResponseBodyResult& setPassed(string passed) { DARABONBA_PTR_SET_VALUE(passed_, passed) };
    ...
    inline DocOcrResponseBodyResult& setSubCode(string subCode) { DARABONBA_PTR_SET_VALUE(subCode_, subCode) };
    ...
    inline DocOcrResponseBodyResult& setTransactionId(string transactionId) { DARABONBA_PTR_SET_VALUE(transactionId_, transactionId) };
