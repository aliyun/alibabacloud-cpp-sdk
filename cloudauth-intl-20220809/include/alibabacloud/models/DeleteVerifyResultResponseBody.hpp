...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVerifyResultResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DeleteVerifyResultResponseBodyResult) };
    inline DeleteVerifyResultResponseBodyResult result() { DARABONBA_PTR_GET(result_, DeleteVerifyResultResponseBodyResult) };
    inline DeleteVerifyResultResponseBody& setResult(const DeleteVerifyResultResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DeleteVerifyResultResponseBody& setResult(DeleteVerifyResultResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // Return result
    std::shared_ptr<DeleteVerifyResultResponseBodyResult> result_ = nullptr;
  };
