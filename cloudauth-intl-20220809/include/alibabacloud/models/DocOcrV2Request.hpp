...
#ifndef ALIBABACLOUD_MODELS_DOCOCRV2REQUEST_HPP_
#define ALIBABACLOUD_MODELS_DOCOCRV2REQUEST_HPP_
...
namespace Models
{
  class DocOcrV2Request : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DocOcrV2Request& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DocOcrV2Request& obj) { 
    ...
    DocOcrV2Request() = default ;
    DocOcrV2Request(const DocOcrV2Request &) = default ;
    DocOcrV2Request(DocOcrV2Request &&) = default ;
    DocOcrV2Request(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DocOcrV2Request() = default ;
    DocOcrV2Request& operator=(const DocOcrV2Request &) = default ;
    DocOcrV2Request& operator=(DocOcrV2Request &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->cardSide_ == nullptr
        && this->docType_ == nullptr && this->idFaceQuality_ == nullptr && this->idOcrPictureBase64_ == nullptr && this->idOcrPictureFile_ == nullptr && this->idOcrPictureUrl_ == nullptr
    ...
    inline DocOcrV2Request& setCardSide(string cardSide) { DARABONBA_PTR_SET_VALUE(cardSide_, cardSide) };
    ...
    inline DocOcrV2Request& setDocType(string docType) { DARABONBA_PTR_SET_VALUE(docType_, docType) };
    ...
    inline DocOcrV2Request& setIdFaceQuality(string idFaceQuality) { DARABONBA_PTR_SET_VALUE(idFaceQuality_, idFaceQuality) };
    ...
    inline DocOcrV2Request& setIdOcrPictureBase64(string idOcrPictureBase64) { DARABONBA_PTR_SET_VALUE(idOcrPictureBase64_, idOcrPictureBase64) };
    ...
    inline DocOcrV2Request& setIdOcrPictureFile(string idOcrPictureFile) { DARABONBA_PTR_SET_VALUE(idOcrPictureFile_, idOcrPictureFile) };
    ...
    inline DocOcrV2Request& setIdOcrPictureUrl(string idOcrPictureUrl) { DARABONBA_PTR_SET_VALUE(idOcrPictureUrl_, idOcrPictureUrl) };
    ...
    inline DocOcrV2Request& setIdThreshold(string idThreshold) { DARABONBA_PTR_SET_VALUE(idThreshold_, idThreshold) };
    ...
    inline DocOcrV2Request& setMerchantBizId(string merchantBizId) { DARABONBA_PTR_SET_VALUE(merchantBizId_, merchantBizId) };
    ...
    inline DocOcrV2Request& setMerchantUserId(string merchantUserId) { DARABONBA_PTR_SET_VALUE(merchantUserId_, merchantUserId) };
    ...
    inline DocOcrV2Request& setOcr(string ocr) { DARABONBA_PTR_SET_VALUE(ocr_, ocr) };
    ...
    inline DocOcrV2Request& setProductCode(string productCode) { DARABONBA_PTR_SET_VALUE(productCode_, productCode) };
    ...
    inline DocOcrV2Request& setSpoof(string spoof) { DARABONBA_PTR_SET_VALUE(spoof_, spoof) };
