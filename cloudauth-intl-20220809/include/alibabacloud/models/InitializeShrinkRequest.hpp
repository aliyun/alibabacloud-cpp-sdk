...
#ifndef ALIBABACLOUD_MODELS_INITIALIZESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_INITIALIZESHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const InitializeShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, InitializeShrinkRequest& obj) { 
    ...
    InitializeShrinkRequest() = default ;
    InitializeShrinkRequest(const InitializeShrinkRequest &) = default ;
    InitializeShrinkRequest(InitializeShrinkRequest &&) = default ;
    InitializeShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~InitializeShrinkRequest() = default ;
    InitializeShrinkRequest& operator=(const InitializeShrinkRequest &) = default ;
    InitializeShrinkRequest& operator=(InitializeShrinkRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->appQualityCheck_ == nullptr
        ...
        && this->updateFaceIfUserExists_ == nullptr && this->useNFC_ == nullptr && this->verifyModel_ == nullptr; };
    ...
    inline InitializeShrinkRequest& setAppQualityCheck(string appQualityCheck) { DARABONBA_PTR_SET_VALUE(appQualityCheck_, appQualityCheck) };
    ...
    inline InitializeShrinkRequest& setAuthorize(string authorize) { DARABONBA_PTR_SET_VALUE(authorize_, authorize) };
    ...
    inline InitializeShrinkRequest& setAutoDocPageConfig(string autoDocPageConfig) { DARABONBA_PTR_SET_VALUE(autoDocPageConfig_, autoDocPageConfig) };
    ...
    inline InitializeShrinkRequest& setAutoRegistration(string autoRegistration) { DARABONBA_PTR_SET_VALUE(autoRegistration_, autoRegistration) };
    ...
    inline InitializeShrinkRequest& setCallbackToken(string callbackToken) { DARABONBA_PTR_SET_VALUE(callbackToken_, callbackToken) };
    ...
    inline InitializeShrinkRequest& setCallbackUrl(string callbackUrl) { DARABONBA_PTR_SET_VALUE(callbackUrl_, callbackUrl) };
    ...
    inline InitializeShrinkRequest& setChameleonFrameEnable(string chameleonFrameEnable) { DARABONBA_PTR_SET_VALUE(chameleonFrameEnable_, chameleonFrameEnable) };
    ...
    inline InitializeShrinkRequest& setCrop(string crop) { DARABONBA_PTR_SET_VALUE(crop_, crop) };
    ...
    inline InitializeShrinkRequest& setDateOfBirth(string dateOfBirth) { DARABONBA_PTR_SET_VALUE(dateOfBirth_, dateOfBirth) };
    ...
    inline InitializeShrinkRequest& setDateOfExpiry(string dateOfExpiry) { DARABONBA_PTR_SET_VALUE(dateOfExpiry_, dateOfExpiry) };
    ...
    inline InitializeShrinkRequest& setDocName(string docName) { DARABONBA_PTR_SET_VALUE(docName_, docName) };
    ...
    inline InitializeShrinkRequest& setDocNo(string docNo) { DARABONBA_PTR_SET_VALUE(docNo_, docNo) };
    ...
    inline InitializeShrinkRequest& setDocPageConfigShrink(string docPageConfigShrink) { DARABONBA_PTR_SET_VALUE(docPageConfigShrink_, docPageConfigShrink) };
    ...
    inline InitializeShrinkRequest& setDocScanMode(string docScanMode) { DARABONBA_PTR_SET_VALUE(docScanMode_, docScanMode) };
    ...
    inline InitializeShrinkRequest& setDocType(string docType) { DARABONBA_PTR_SET_VALUE(docType_, docType) };
    ...
    inline InitializeShrinkRequest& setDocVideo(string docVideo) { DARABONBA_PTR_SET_VALUE(docVideo_, docVideo) };
    ...
    inline InitializeShrinkRequest& setEmail(string email) { DARABONBA_PTR_SET_VALUE(email_, email) };
    ...
    inline InitializeShrinkRequest& setExperienceCode(string experienceCode) { DARABONBA_PTR_SET_VALUE(experienceCode_, experienceCode) };
    ...
    inline InitializeShrinkRequest& setFaceAttributeCheck(string faceAttributeCheck) { DARABONBA_PTR_SET_VALUE(faceAttributeCheck_, faceAttributeCheck) };
    ...
    inline InitializeShrinkRequest& setFaceGroupCodes(string faceGroupCodes) { DARABONBA_PTR_SET_VALUE(faceGroupCodes_, faceGroupCodes) };
    ...
    inline InitializeShrinkRequest& setFacePictureBase64(string facePictureBase64) { DARABONBA_PTR_SET_VALUE(facePictureBase64_, facePictureBase64) };
    ...
    inline InitializeShrinkRequest& setFacePictureUrl(string facePictureUrl) { DARABONBA_PTR_SET_VALUE(facePictureUrl_, facePictureUrl) };
    ...
    inline InitializeShrinkRequest& setFaceRegisterGroupCode(string faceRegisterGroupCode) { DARABONBA_PTR_SET_VALUE(faceRegisterGroupCode_, faceRegisterGroupCode) };
    ...
    inline InitializeShrinkRequest& setFaceVerifyThreshold(string faceVerifyThreshold) { DARABONBA_PTR_SET_VALUE(faceVerifyThreshold_, faceVerifyThreshold) };
    ...
    inline InitializeShrinkRequest& setIdFaceQuality(string idFaceQuality) { DARABONBA_PTR_SET_VALUE(idFaceQuality_, idFaceQuality) };
    ...
    inline InitializeShrinkRequest& setIdSpoof(string idSpoof) { DARABONBA_PTR_SET_VALUE(idSpoof_, idSpoof) };
    ...
    inline InitializeShrinkRequest& setIdThreshold(string idThreshold) { DARABONBA_PTR_SET_VALUE(idThreshold_, idThreshold) };
    ...
    inline InitializeShrinkRequest& setLanguageConfig(string languageConfig) { DARABONBA_PTR_SET_VALUE(languageConfig_, languageConfig) };
    ...
    inline InitializeShrinkRequest& setMRTDInput(string MRTDInput) { DARABONBA_PTR_SET_VALUE(MRTDInput_, MRTDInput) };
    ...
    inline InitializeShrinkRequest& setMerchantBizId(string merchantBizId) { DARABONBA_PTR_SET_VALUE(merchantBizId_, merchantBizId) };
    ...
    inline InitializeShrinkRequest& setMerchantUserId(string merchantUserId) { DARABONBA_PTR_SET_VALUE(merchantUserId_, merchantUserId) };
    ...
    inline InitializeShrinkRequest& setMetaInfo(string metaInfo) { DARABONBA_PTR_SET_VALUE(metaInfo_, metaInfo) };
    ...
    inline InitializeShrinkRequest& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline InitializeShrinkRequest& setModel(string model) { DARABONBA_PTR_SET_VALUE(model_, model) };
    ...
    inline InitializeShrinkRequest& setPages(string pages) { DARABONBA_PTR_SET_VALUE(pages_, pages) };
    ...
    inline InitializeShrinkRequest& setProcedurePriority(string procedurePriority) { DARABONBA_PTR_SET_VALUE(procedurePriority_, procedurePriority) };
    ...
    inline InitializeShrinkRequest& setProductCode(string productCode) { DARABONBA_PTR_SET_VALUE(productCode_, productCode) };
    ...
    inline InitializeShrinkRequest& setProductFlow(string productFlow) { DARABONBA_PTR_SET_VALUE(productFlow_, productFlow) };
    ...
    inline InitializeShrinkRequest& setReturnFaces(string returnFaces) { DARABONBA_PTR_SET_VALUE(returnFaces_, returnFaces) };
    ...
    inline InitializeShrinkRequest& setReturnUrl(string returnUrl) { DARABONBA_PTR_SET_VALUE(returnUrl_, returnUrl) };
    ...
    inline InitializeShrinkRequest& setSaveFacePicture(string saveFacePicture) { DARABONBA_PTR_SET_VALUE(saveFacePicture_, saveFacePicture) };
    ...
    inline InitializeShrinkRequest& setSceneCode(string sceneCode) { DARABONBA_PTR_SET_VALUE(sceneCode_, sceneCode) };
    ...
    inline InitializeShrinkRequest& setSecurityLevel(string securityLevel) { DARABONBA_PTR_SET_VALUE(securityLevel_, securityLevel) };
    ...
    inline InitializeShrinkRequest& setShowAlbumIcon(string showAlbumIcon) { DARABONBA_PTR_SET_VALUE(showAlbumIcon_, showAlbumIcon) };
    ...
    inline InitializeShrinkRequest& setShowGuidePage(string showGuidePage) { DARABONBA_PTR_SET_VALUE(showGuidePage_, showGuidePage) };
    ...
    inline InitializeShrinkRequest& setShowOcrResult(string showOcrResult) { DARABONBA_PTR_SET_VALUE(showOcrResult_, showOcrResult) };
    ...
    inline InitializeShrinkRequest& setStyleConfig(string styleConfig) { DARABONBA_PTR_SET_VALUE(styleConfig_, styleConfig) };
    ...
    inline InitializeShrinkRequest& setTargetFacePicture(string targetFacePicture) { DARABONBA_PTR_SET_VALUE(targetFacePicture_, targetFacePicture) };
    ...
    inline InitializeShrinkRequest& setTargetFacePictureUrl(string targetFacePictureUrl) { DARABONBA_PTR_SET_VALUE(targetFacePictureUrl_, targetFacePictureUrl) };
    ...
    inline InitializeShrinkRequest& setTemplateConfig(string templateConfig) { DARABONBA_PTR_SET_VALUE(templateConfig_, templateConfig) };
    ...
    inline InitializeShrinkRequest& setTemplateRanCount(string templateRanCount) { DARABONBA_PTR_SET_VALUE(templateRanCount_, templateRanCount) };
    ...
    inline InitializeShrinkRequest& setTemplateType(string templateType) { DARABONBA_PTR_SET_VALUE(templateType_, templateType) };
    ...
    inline InitializeShrinkRequest& setUpdateFaceIfUserExists(string updateFaceIfUserExists) { DARABONBA_PTR_SET_VALUE(updateFaceIfUserExists_, updateFaceIfUserExists) };
    ...
    inline InitializeShrinkRequest& setUseNFC(string useNFC) { DARABONBA_PTR_SET_VALUE(useNFC_, useNFC) };
    ...
    inline InitializeShrinkRequest& setVerifyModel(string verifyModel) { DARABONBA_PTR_SET_VALUE(verifyModel_, verifyModel) };
