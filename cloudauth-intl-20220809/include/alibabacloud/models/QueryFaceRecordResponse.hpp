...
namespace Models
{
  ...
  public:
    ...
    inline const QueryFaceRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryFaceRecordResponseBody) };
    inline QueryFaceRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryFaceRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryFaceRecordResponseBody> body_ {};
  };
