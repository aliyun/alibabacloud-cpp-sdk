...
namespace Models
{
  ...
  public:
    ...
    inline const Mobile3MetaVerifyIntlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, Mobile3MetaVerifyIntlResponseBody) };
    inline Mobile3MetaVerifyIntlResponseBody getBody() { DARABONBA_PTR_GET(body_, Mobile3MetaVerifyIntlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<Mobile3MetaVerifyIntlResponseBody> body_ {};
  };
