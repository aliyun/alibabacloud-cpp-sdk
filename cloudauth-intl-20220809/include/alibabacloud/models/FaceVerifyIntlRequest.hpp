...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoRegistration_ == nullptr
        ...
        && this->merchantUserId_ == nullptr && this->productCode_ == nullptr && this->returnFaces_ == nullptr && this->sourceFacePicture_ == nullptr && this->sourceFacePictureFile_ == nullptr
        && this->sourceFacePictureUrl_ == nullptr && this->targetFacePicture_ == nullptr && this->targetFacePictureFile_ == nullptr && this->targetFacePictureUrl_ == nullptr && this->updateFaceIfUserExists_ == nullptr
    ...
    inline FaceVerifyIntlRequest& setFaceAttributeCheck(string faceAttributeCheck) { DARABONBA_PTR_SET_VALUE(faceAttributeCheck_, faceAttributeCheck) };
    ...
    inline FaceVerifyIntlRequest& setUpdateFaceIfUserExists(string updateFaceIfUserExists) { DARABONBA_PTR_SET_VALUE(updateFaceIfUserExists_, updateFaceIfUserExists) };
