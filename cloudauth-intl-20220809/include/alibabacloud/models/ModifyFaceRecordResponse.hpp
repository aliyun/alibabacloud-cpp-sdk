...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyFaceRecordResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyFaceRecordResponseBody) };
    inline ModifyFaceRecordResponseBody body() { DARABONBA_PTR_GET(body_, ModifyFaceRecordResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyFaceRecordResponseBody> body_ = nullptr;
  };
