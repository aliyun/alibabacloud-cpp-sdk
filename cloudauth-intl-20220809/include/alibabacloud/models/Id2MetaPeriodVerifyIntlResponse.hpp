...
namespace Models
{
  ...
  public:
    ...
    inline const Id2MetaPeriodVerifyIntlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, Id2MetaPeriodVerifyIntlResponseBody) };
    inline Id2MetaPeriodVerifyIntlResponseBody getBody() { DARABONBA_PTR_GET(body_, Id2MetaPeriodVerifyIntlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<Id2MetaPeriodVerifyIntlResponseBody> body_ {};
  };
