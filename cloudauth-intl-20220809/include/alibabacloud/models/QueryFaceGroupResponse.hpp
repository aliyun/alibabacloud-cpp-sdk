...
namespace Models
{
  ...
  public:
    ...
    inline const QueryFaceGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryFaceGroupResponseBody) };
    inline QueryFaceGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryFaceGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryFaceGroupResponseBody> body_ {};
  };
