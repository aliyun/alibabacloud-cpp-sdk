...
namespace Models
{
  ...
  public:
    ...
    inline const AddFaceRecordResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, AddFaceRecordResponseBodyResult) };
    inline AddFaceRecordResponseBodyResult result() { DARABONBA_PTR_GET(result_, AddFaceRecordResponseBodyResult) };
    inline AddFaceRecordResponseBody& setResult(const AddFaceRecordResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline AddFaceRecordResponseBody& setResult(AddFaceRecordResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<AddFaceRecordResponseBodyResult> result_ = nullptr;
  };
