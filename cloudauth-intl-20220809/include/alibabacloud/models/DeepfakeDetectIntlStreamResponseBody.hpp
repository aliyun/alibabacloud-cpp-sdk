...
namespace Models
{
  ...
  public:
    ...
    inline const DeepfakeDetectIntlStreamResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DeepfakeDetectIntlStreamResponseBodyResultObject) };
    inline DeepfakeDetectIntlStreamResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DeepfakeDetectIntlStreamResponseBodyResultObject) };
    inline DeepfakeDetectIntlStreamResponseBody& setResultObject(const DeepfakeDetectIntlStreamResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DeepfakeDetectIntlStreamResponseBody& setResultObject(DeepfakeDetectIntlStreamResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    std::shared_ptr<DeepfakeDetectIntlStreamResponseBodyResultObject> resultObject_ = nullptr;
  };
