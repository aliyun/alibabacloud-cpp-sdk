...
namespace Models
{
  ...
  public:
    ...
    inline const FaceGuardRiskResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, FaceGuardRiskResponseBodyResult) };
    inline FaceGuardRiskResponseBodyResult result() { DARABONBA_PTR_GET(result_, FaceGuardRiskResponseBodyResult) };
    inline FaceGuardRiskResponseBody& setResult(const FaceGuardRiskResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline FaceGuardRiskResponseBody& setResult(FaceGuardRiskResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
