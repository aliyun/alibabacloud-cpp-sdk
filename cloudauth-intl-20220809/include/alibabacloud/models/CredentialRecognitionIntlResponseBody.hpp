...
namespace Models
{
  ...
  public:
    ...
    inline const CredentialRecognitionIntlResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, CredentialRecognitionIntlResponseBodyResult) };
    inline CredentialRecognitionIntlResponseBodyResult result() { DARABONBA_PTR_GET(result_, CredentialRecognitionIntlResponseBodyResult) };
    inline CredentialRecognitionIntlResponseBody& setResult(const CredentialRecognitionIntlResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CredentialRecognitionIntlResponseBody& setResult(CredentialRecognitionIntlResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
