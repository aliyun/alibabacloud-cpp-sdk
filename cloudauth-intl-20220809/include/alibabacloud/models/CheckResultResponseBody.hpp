...
namespace Models
{
  ...
  public:
    ...
    inline const CheckResultResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, CheckResultResponseBodyResult) };
    inline CheckResultResponseBodyResult result() { DARABONBA_PTR_GET(result_, CheckResultResponseBodyResult) };
    inline CheckResultResponseBody& setResult(const CheckResultResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CheckResultResponseBody& setResult(CheckResultResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // Return result.
    std::shared_ptr<CheckResultResponseBodyResult> result_ = nullptr;
  };
