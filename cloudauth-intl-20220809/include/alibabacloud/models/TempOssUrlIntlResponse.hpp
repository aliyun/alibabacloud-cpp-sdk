...
namespace Models
{
  ...
  public:
    ...
    inline const TempOssUrlIntlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TempOssUrlIntlResponseBody) };
    inline TempOssUrlIntlResponseBody getBody() { DARABONBA_PTR_GET(body_, TempOssUrlIntlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TempOssUrlIntlResponseBody> body_ {};
  };
