...
namespace Models
{
  ...
  public:
    ...
    inline const AddressVerifyV2IntlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddressVerifyV2IntlResponseBody) };
    inline AddressVerifyV2IntlResponseBody getBody() { DARABONBA_PTR_GET(body_, AddressVerifyV2IntlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddressVerifyV2IntlResponseBody> body_ {};
  };
