...
#ifndef ALIBABACLOUD_MODELS_EKYCVERIFYV2RESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_EKYCVERIFYV2RESPONSEBODY_HPP_
...
namespace Models
{
  class EkycVerifyV2ResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const EkycVerifyV2ResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Code, code_);
      DARABONBA_PTR_TO_JSON(Message, message_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Result, result_);
    };
    friend void from_json(const Darabonba::Json& j, EkycVerifyV2ResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Code, code_);
      DARABONBA_PTR_FROM_JSON(Message, message_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Result, result_);
    };
    EkycVerifyV2ResponseBody() = default ;
    EkycVerifyV2ResponseBody(const EkycVerifyV2ResponseBody &) = default ;
    EkycVerifyV2ResponseBody(EkycVerifyV2ResponseBody &&) = default ;
    EkycVerifyV2ResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EkycVerifyV2ResponseBody() = default ;
    EkycVerifyV2ResponseBody& operator=(const EkycVerifyV2ResponseBody &) = default ;
    EkycVerifyV2ResponseBody& operator=(EkycVerifyV2ResponseBody &&) = default ;
    ...
    inline EkycVerifyV2ResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline EkycVerifyV2ResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline EkycVerifyV2ResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const EkycVerifyV2ResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, EkycVerifyV2ResponseBody::Result) };
    inline EkycVerifyV2ResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, EkycVerifyV2ResponseBody::Result) };
    inline EkycVerifyV2ResponseBody& setResult(const EkycVerifyV2ResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline EkycVerifyV2ResponseBody& setResult(EkycVerifyV2ResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
