...
namespace Models
{
  ...
  public:
    ...
    inline const AddressCompareIntlResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, AddressCompareIntlResponseBodyResult) };
    inline AddressCompareIntlResponseBodyResult result() { DARABONBA_PTR_GET(result_, AddressCompareIntlResponseBodyResult) };
    inline AddressCompareIntlResponseBody& setResult(const AddressCompareIntlResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline AddressCompareIntlResponseBody& setResult(AddressCompareIntlResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // Return result.
    std::shared_ptr<AddressCompareIntlResponseBodyResult> result_ = nullptr;
  };
