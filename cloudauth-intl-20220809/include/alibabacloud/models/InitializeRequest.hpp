...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appQualityCheck_ == nullptr
        ...
        && return this->docPageConfig_ == nullptr && return this->docScanMode_ == nullptr && return this->docType_ == nullptr && return this->docVideo_ == nullptr && return this->documentNumber_ == nullptr
