...
#ifndef ALIBABACLOUD_MODELS_IDNAUTHORITYVERIFYINTLREQUEST_HPP_
#define ALIBABACLOUD_MODELS_IDNAUTHORITYVERIFYINTLREQUEST_HPP_
...
namespace Models
{
  class IdnAuthorityVerifyIntlRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IdnAuthorityVerifyIntlRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IdnAuthorityVerifyIntlRequest& obj) { 
    ...
    IdnAuthorityVerifyIntlRequest() = default ;
    IdnAuthorityVerifyIntlRequest(const IdnAuthorityVerifyIntlRequest &) = default ;
    IdnAuthorityVerifyIntlRequest(IdnAuthorityVerifyIntlRequest &&) = default ;
    IdnAuthorityVerifyIntlRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IdnAuthorityVerifyIntlRequest() = default ;
    IdnAuthorityVerifyIntlRequest& operator=(const IdnAuthorityVerifyIntlRequest &) = default ;
    IdnAuthorityVerifyIntlRequest& operator=(IdnAuthorityVerifyIntlRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->birthDate_ == nullptr
        ...
        && this->mobile_ == nullptr && this->productCode_ == nullptr && this->sceneCode_ == nullptr && this->sourceFacePicture_ == nullptr && this->sourceFacePictureFile_ == nullptr
    ...
    inline IdnAuthorityVerifyIntlRequest& setBirthDate(string birthDate) { DARABONBA_PTR_SET_VALUE(birthDate_, birthDate) };
    ...
    inline IdnAuthorityVerifyIntlRequest& setEmail(string email) { DARABONBA_PTR_SET_VALUE(email_, email) };
    ...
    inline IdnAuthorityVerifyIntlRequest& setFullName(string fullName) { DARABONBA_PTR_SET_VALUE(fullName_, fullName) };
    ...
    inline IdnAuthorityVerifyIntlRequest& setIdNumber(string idNumber) { DARABONBA_PTR_SET_VALUE(idNumber_, idNumber) };
    ...
    inline IdnAuthorityVerifyIntlRequest& setMerchantBizId(string merchantBizId) { DARABONBA_PTR_SET_VALUE(merchantBizId_, merchantBizId) };
    ...
    inline IdnAuthorityVerifyIntlRequest& setMerchantUserId(string merchantUserId) { DARABONBA_PTR_SET_VALUE(merchantUserId_, merchantUserId) };
    ...
    inline IdnAuthorityVerifyIntlRequest& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline IdnAuthorityVerifyIntlRequest& setProductCode(string productCode) { DARABONBA_PTR_SET_VALUE(productCode_, productCode) };
    ...
    inline IdnAuthorityVerifyIntlRequest& setSceneCode(string sceneCode) { DARABONBA_PTR_SET_VALUE(sceneCode_, sceneCode) };
    ...
    inline IdnAuthorityVerifyIntlRequest& setSourceFacePicture(string sourceFacePicture) { DARABONBA_PTR_SET_VALUE(sourceFacePicture_, sourceFacePicture) };
    ...
    inline IdnAuthorityVerifyIntlRequest& setSourceFacePictureFile(string sourceFacePictureFile) { DARABONBA_PTR_SET_VALUE(sourceFacePictureFile_, sourceFacePictureFile) };
    ...
    inline IdnAuthorityVerifyIntlRequest& setSourceFacePictureUrl(string sourceFacePictureUrl) { DARABONBA_PTR_SET_VALUE(sourceFacePictureUrl_, sourceFacePictureUrl) };
    ...
    inline IdnAuthorityVerifyIntlRequest& setTimestamp(string timestamp) { DARABONBA_PTR_SET_VALUE(timestamp_, timestamp) };
