...
#ifndef ALIBABACLOUD_MODELS_DEEPFAKEDETECTINTLRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DEEPFAKEDETECTINTLRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeepfakeDetectIntlResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Code, code_);
      DARABONBA_PTR_TO_JSON(Message, message_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(ResultObject, resultObject_);
    };
    friend void from_json(const Darabonba::Json& j, DeepfakeDetectIntlResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Code, code_);
      DARABONBA_PTR_FROM_JSON(Message, message_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(ResultObject, resultObject_);
    };
    DeepfakeDetectIntlResponseBody() = default ;
    DeepfakeDetectIntlResponseBody(const DeepfakeDetectIntlResponseBody &) = default ;
    DeepfakeDetectIntlResponseBody(DeepfakeDetectIntlResponseBody &&) = default ;
    DeepfakeDetectIntlResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeepfakeDetectIntlResponseBody() = default ;
    DeepfakeDetectIntlResponseBody& operator=(const DeepfakeDetectIntlResponseBody &) = default ;
    DeepfakeDetectIntlResponseBody& operator=(DeepfakeDetectIntlResponseBody &&) = default ;
    ...
    inline DeepfakeDetectIntlResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DeepfakeDetectIntlResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DeepfakeDetectIntlResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // resultObject Field Functions 
    bool hasResultObject() const { return this->resultObject_ != nullptr;};
    void deleteResultObject() { this->resultObject_ = nullptr;};
    inline const DeepfakeDetectIntlResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DeepfakeDetectIntlResponseBody::ResultObject) };
    inline DeepfakeDetectIntlResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, DeepfakeDetectIntlResponseBody::ResultObject) };
    inline DeepfakeDetectIntlResponseBody& setResultObject(const DeepfakeDetectIntlResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DeepfakeDetectIntlResponseBody& setResultObject(DeepfakeDetectIntlResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    shared_ptr<DeepfakeDetectIntlResponseBody::ResultObject> resultObject_ {};
  };
