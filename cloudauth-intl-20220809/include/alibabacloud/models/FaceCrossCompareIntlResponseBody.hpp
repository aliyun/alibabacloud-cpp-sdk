...
namespace Models
{
  ...
  public:
    ...
    inline const FaceCrossCompareIntlResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, FaceCrossCompareIntlResponseBodyResult) };
    inline FaceCrossCompareIntlResponseBodyResult result() { DARABONBA_PTR_GET(result_, FaceCrossCompareIntlResponseBodyResult) };
    inline FaceCrossCompareIntlResponseBody& setResult(const FaceCrossCompareIntlResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline FaceCrossCompareIntlResponseBody& setResult(FaceCrossCompareIntlResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<FaceCrossCompareIntlResponseBodyResult> result_ = nullptr;
  };
