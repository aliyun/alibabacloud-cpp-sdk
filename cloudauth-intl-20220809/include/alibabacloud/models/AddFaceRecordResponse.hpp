...
namespace Models
{
  ...
  public:
    ...
    inline const AddFaceRecordResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddFaceRecordResponseBody) };
    inline AddFaceRecordResponseBody body() { DARABONBA_PTR_GET(body_, AddFaceRecordResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddFaceRecordResponseBody> body_ = nullptr;
  };
