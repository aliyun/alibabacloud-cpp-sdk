...
namespace Models
{
  ...
  public:
    ...
    inline const CredentialRecognitionIntlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CredentialRecognitionIntlResponseBody) };
    inline CredentialRecognitionIntlResponseBody getBody() { DARABONBA_PTR_GET(body_, CredentialRecognitionIntlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CredentialRecognitionIntlResponseBody> body_ {};
  };
