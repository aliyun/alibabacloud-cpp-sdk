...
namespace Models
{
  ...
  public:
    ...
    inline const CheckVerifyLogResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CheckVerifyLogResponseBody) };
    inline CheckVerifyLogResponseBody body() { DARABONBA_PTR_GET(body_, CheckVerifyLogResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CheckVerifyLogResponseBody> body_ = nullptr;
  };
