...
namespace Models
{
  ...
  public:
    ...
    inline const CredentialGetResultIntlResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, CredentialGetResultIntlResponseBodyResult) };
    inline CredentialGetResultIntlResponseBodyResult result() { DARABONBA_PTR_GET(result_, CredentialGetResultIntlResponseBodyResult) };
    inline CredentialGetResultIntlResponseBody& setResult(const CredentialGetResultIntlResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CredentialGetResultIntlResponseBody& setResult(CredentialGetResultIntlResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<CredentialGetResultIntlResponseBodyResult> result_ = nullptr;
  };
