...
namespace Models
{
  ...
  public:
    ...
    inline const FraudResultCallBackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FraudResultCallBackResponseBody) };
    inline FraudResultCallBackResponseBody getBody() { DARABONBA_PTR_GET(body_, FraudResultCallBackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FraudResultCallBackResponseBody> body_ {};
  };
