...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyFaceGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyFaceGroupResponseBody) };
    inline ModifyFaceGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyFaceGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyFaceGroupResponseBody> body_ {};
  };
