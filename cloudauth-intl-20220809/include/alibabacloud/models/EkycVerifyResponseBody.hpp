...
namespace Models
{
  ...
  public:
    ...
    inline const EkycVerifyResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, EkycVerifyResponseBodyResult) };
    inline EkycVerifyResponseBodyResult result() { DARABONBA_PTR_GET(result_, EkycVerifyResponseBodyResult) };
    inline EkycVerifyResponseBody& setResult(const EkycVerifyResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline EkycVerifyResponseBody& setResult(EkycVerifyResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
