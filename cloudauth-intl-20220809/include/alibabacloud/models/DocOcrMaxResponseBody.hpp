...
namespace Models
{
  ...
  public:
    ...
    inline const DocOcrMaxResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DocOcrMaxResponseBodyResult) };
    inline DocOcrMaxResponseBodyResult result() { DARABONBA_PTR_GET(result_, DocOcrMaxResponseBodyResult) };
    inline DocOcrMaxResponseBody& setResult(const DocOcrMaxResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DocOcrMaxResponseBody& setResult(DocOcrMaxResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // Return result
    std::shared_ptr<DocOcrMaxResponseBodyResult> result_ = nullptr;
  };
