...
namespace Models
{
  ...
  public:
    ...
    inline const AddressVerifyIntlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddressVerifyIntlResponseBody) };
    inline AddressVerifyIntlResponseBody getBody() { DARABONBA_PTR_GET(body_, AddressVerifyIntlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddressVerifyIntlResponseBody> body_ {};
  };
