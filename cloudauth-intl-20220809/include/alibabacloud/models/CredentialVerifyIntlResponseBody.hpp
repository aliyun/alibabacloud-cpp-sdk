...
namespace Models
{
  ...
  public:
    ...
    inline const CredentialVerifyIntlResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, CredentialVerifyIntlResponseBody::ResultObject) };
    inline CredentialVerifyIntlResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, CredentialVerifyIntlResponseBody::ResultObject) };
    inline CredentialVerifyIntlResponseBody& setResultObject(const CredentialVerifyIntlResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline CredentialVerifyIntlResponseBody& setResultObject(CredentialVerifyIntlResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
