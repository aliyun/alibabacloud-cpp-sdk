...
namespace Models
{
  ...
  public:
    ...
    inline const FaceLivenessResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FaceLivenessResponseBody) };
    inline FaceLivenessResponseBody getBody() { DARABONBA_PTR_GET(body_, FaceLivenessResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FaceLivenessResponseBody> body_ {};
  };
