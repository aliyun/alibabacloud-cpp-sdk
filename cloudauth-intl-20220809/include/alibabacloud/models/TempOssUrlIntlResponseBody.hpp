...
namespace Models
{
  ...
  public:
    ...
    inline const TempOssUrlIntlResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, TempOssUrlIntlResponseBodyData) };
    inline TempOssUrlIntlResponseBodyData data() { DARABONBA_PTR_GET(data_, TempOssUrlIntlResponseBodyData) };
    inline TempOssUrlIntlResponseBody& setData(const TempOssUrlIntlResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline TempOssUrlIntlResponseBody& setData(TempOssUrlIntlResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<TempOssUrlIntlResponseBodyData> data_ = nullptr;
