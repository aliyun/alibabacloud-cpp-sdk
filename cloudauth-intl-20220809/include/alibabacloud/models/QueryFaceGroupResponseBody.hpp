...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryFaceGroupResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<QueryFaceGroupResponseBodyItems>) };
    inline vector<QueryFaceGroupResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<QueryFaceGroupResponseBodyItems>) };
    inline QueryFaceGroupResponseBody& setItems(const vector<QueryFaceGroupResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline QueryFaceGroupResponseBody& setItems(vector<QueryFaceGroupResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryFaceGroupResponseBodyItems>> items_ = nullptr;
