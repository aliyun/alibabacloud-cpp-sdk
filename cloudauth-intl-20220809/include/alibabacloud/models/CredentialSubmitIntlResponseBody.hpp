...
namespace Models
{
  ...
  public:
    ...
    inline const CredentialSubmitIntlResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, CredentialSubmitIntlResponseBodyResult) };
    inline CredentialSubmitIntlResponseBodyResult result() { DARABONBA_PTR_GET(result_, CredentialSubmitIntlResponseBodyResult) };
    inline CredentialSubmitIntlResponseBody& setResult(const CredentialSubmitIntlResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CredentialSubmitIntlResponseBody& setResult(CredentialSubmitIntlResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // Return result.
    std::shared_ptr<CredentialSubmitIntlResponseBodyResult> result_ = nullptr;
  };
