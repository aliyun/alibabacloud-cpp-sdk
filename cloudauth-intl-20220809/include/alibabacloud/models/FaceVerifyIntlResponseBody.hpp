...
#ifndef ALIBABACLOUD_MODELS_FACEVERIFYINTLRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_FACEVERIFYINTLRESPONSEBODY_HPP_
...
namespace Models
{
  class FaceVerifyIntlResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const FaceVerifyIntlResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Code, code_);
      DARABONBA_PTR_TO_JSON(Message, message_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Result, result_);
    };
    friend void from_json(const Darabonba::Json& j, FaceVerifyIntlResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Code, code_);
      DARABONBA_PTR_FROM_JSON(Message, message_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Result, result_);
    };
    FaceVerifyIntlResponseBody() = default ;
    FaceVerifyIntlResponseBody(const FaceVerifyIntlResponseBody &) = default ;
    FaceVerifyIntlResponseBody(FaceVerifyIntlResponseBody &&) = default ;
    FaceVerifyIntlResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FaceVerifyIntlResponseBody() = default ;
    FaceVerifyIntlResponseBody& operator=(const FaceVerifyIntlResponseBody &) = default ;
    FaceVerifyIntlResponseBody& operator=(FaceVerifyIntlResponseBody &&) = default ;
    ...
    public:
      ...
      inline Result& setFaceAge(int64_t faceAge) { DARABONBA_PTR_SET_VALUE(faceAge_, faceAge) };
      ...
      inline double getFaceAttackScore() const { DARABONBA_PTR_GET_DEFAULT(faceAttackScore_, 0.0) };
      inline Result& setFaceAttackScore(double faceAttackScore) { DARABONBA_PTR_SET_VALUE(faceAttackScore_, faceAttackScore) };
      ...
      inline int64_t getFaceRegistrationResult() const { DARABONBA_PTR_GET_DEFAULT(faceRegistrationResult_, 0L) };
      inline Result& setFaceRegistrationResult(int64_t faceRegistrationResult) { DARABONBA_PTR_SET_VALUE(faceRegistrationResult_, faceRegistrationResult) };
    ...
    inline FaceVerifyIntlResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline FaceVerifyIntlResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline FaceVerifyIntlResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const FaceVerifyIntlResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, FaceVerifyIntlResponseBody::Result) };
    inline FaceVerifyIntlResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, FaceVerifyIntlResponseBody::Result) };
    inline FaceVerifyIntlResponseBody& setResult(const FaceVerifyIntlResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline FaceVerifyIntlResponseBody& setResult(FaceVerifyIntlResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
