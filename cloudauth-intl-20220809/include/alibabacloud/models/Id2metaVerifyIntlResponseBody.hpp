...
namespace Models
{
  ...
  public:
    ...
    inline const Id2MetaVerifyIntlResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, Id2MetaVerifyIntlResponseBodyResult) };
    inline Id2MetaVerifyIntlResponseBodyResult result() { DARABONBA_PTR_GET(result_, Id2MetaVerifyIntlResponseBodyResult) };
    inline Id2MetaVerifyIntlResponseBody& setResult(const Id2MetaVerifyIntlResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline Id2MetaVerifyIntlResponseBody& setResult(Id2MetaVerifyIntlResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
