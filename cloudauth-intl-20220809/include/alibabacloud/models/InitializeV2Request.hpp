...
namespace Models
{
  ...
  public:
    ...
    inline InitializeV2Request& setUpdateFaceIfUserExists(string updateFaceIfUserExists) { DARABONBA_PTR_SET_VALUE(updateFaceIfUserExists_, updateFaceIfUserExists) };
