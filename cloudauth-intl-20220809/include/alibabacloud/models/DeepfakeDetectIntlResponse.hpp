...
namespace Models
{
  ...
  public:
    ...
    inline const DeepfakeDetectIntlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeepfakeDetectIntlResponseBody) };
    inline DeepfakeDetectIntlResponseBody getBody() { DARABONBA_PTR_GET(body_, DeepfakeDetectIntlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeepfakeDetectIntlResponseBody> body_ {};
  };
