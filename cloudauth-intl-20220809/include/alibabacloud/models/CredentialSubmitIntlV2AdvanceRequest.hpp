...
#ifndef ALIBABACLOUD_MODELS_CREDENTIALSUBMITINTLV2ADVANCEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREDENTIALSUBMITINTLV2ADVANCEREQUEST_HPP_
...
namespace Models
{
  class CredentialSubmitIntlV2AdvanceRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CredentialSubmitIntlV2AdvanceRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CredentialSubmitIntlV2AdvanceRequest& obj) { 
    ...
    CredentialSubmitIntlV2AdvanceRequest() = default ;
    CredentialSubmitIntlV2AdvanceRequest(const CredentialSubmitIntlV2AdvanceRequest &) = default ;
    CredentialSubmitIntlV2AdvanceRequest(CredentialSubmitIntlV2AdvanceRequest &&) = default ;
    CredentialSubmitIntlV2AdvanceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CredentialSubmitIntlV2AdvanceRequest() = default ;
    CredentialSubmitIntlV2AdvanceRequest& operator=(const CredentialSubmitIntlV2AdvanceRequest &) = default ;
    CredentialSubmitIntlV2AdvanceRequest& operator=(CredentialSubmitIntlV2AdvanceRequest &&) = default ;
    ...
    inline CredentialSubmitIntlV2AdvanceRequest& setCheckRuleConfig(string checkRuleConfig) { DARABONBA_PTR_SET_VALUE(checkRuleConfig_, checkRuleConfig) };
    ...
    inline CredentialSubmitIntlV2AdvanceRequest& setCredentialOcrPictureBase64(string credentialOcrPictureBase64) { DARABONBA_PTR_SET_VALUE(credentialOcrPictureBase64_, credentialOcrPictureBase64) };
    ...
    inline CredentialSubmitIntlV2AdvanceRequest& setCredentialOcrPictureFileObject(shared_ptr<Darabonba::IStream> credentialOcrPictureFileObject) { DARABONBA_SET_VALUE(credentialOcrPictureFileObject_, credentialOcrPictureFileObject) };
    ...
    inline CredentialSubmitIntlV2AdvanceRequest& setCredentialOcrPictureUrl(string credentialOcrPictureUrl) { DARABONBA_PTR_SET_VALUE(credentialOcrPictureUrl_, credentialOcrPictureUrl) };
    ...
    inline CredentialSubmitIntlV2AdvanceRequest& setDocType(string docType) { DARABONBA_PTR_SET_VALUE(docType_, docType) };
    ...
    inline CredentialSubmitIntlV2AdvanceRequest& setFileInputType(string fileInputType) { DARABONBA_PTR_SET_VALUE(fileInputType_, fileInputType) };
    ...
    inline CredentialSubmitIntlV2AdvanceRequest& setFraudCheck(string fraudCheck) { DARABONBA_PTR_SET_VALUE(fraudCheck_, fraudCheck) };
    ...
    inline CredentialSubmitIntlV2AdvanceRequest& setIdQuality(string idQuality) { DARABONBA_PTR_SET_VALUE(idQuality_, idQuality) };
    ...
    inline CredentialSubmitIntlV2AdvanceRequest& setMerchantBizId(string merchantBizId) { DARABONBA_PTR_SET_VALUE(merchantBizId_, merchantBizId) };
    ...
    inline CredentialSubmitIntlV2AdvanceRequest& setOcrArea(string ocrArea) { DARABONBA_PTR_SET_VALUE(ocrArea_, ocrArea) };
    ...
    inline CredentialSubmitIntlV2AdvanceRequest& setOcrTranslation(string ocrTranslation) { DARABONBA_PTR_SET_VALUE(ocrTranslation_, ocrTranslation) };
    ...
    inline CredentialSubmitIntlV2AdvanceRequest& setOcrValueStandard(string ocrValueStandard) { DARABONBA_PTR_SET_VALUE(ocrValueStandard_, ocrValueStandard) };
    ...
    inline CredentialSubmitIntlV2AdvanceRequest& setProductCode(string productCode) { DARABONBA_PTR_SET_VALUE(productCode_, productCode) };
    ...
    inline CredentialSubmitIntlV2AdvanceRequest& setSceneCode(string sceneCode) { DARABONBA_PTR_SET_VALUE(sceneCode_, sceneCode) };
