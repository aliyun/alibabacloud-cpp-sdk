...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBackgroundPicResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateBackgroundPicResponseBody::Data) };
    inline CreateBackgroundPicResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateBackgroundPicResponseBody::Data) };
    inline CreateBackgroundPicResponseBody& setData(const CreateBackgroundPicResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateBackgroundPicResponseBody& setData(CreateBackgroundPicResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<CreateBackgroundPicResponseBody::Data> data_ {};
