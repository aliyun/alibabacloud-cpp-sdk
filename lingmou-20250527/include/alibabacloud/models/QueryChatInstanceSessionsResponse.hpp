...
namespace Models
{
  ...
  public:
    ...
    inline const QueryChatInstanceSessionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryChatInstanceSessionsResponseBody) };
    inline QueryChatInstanceSessionsResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryChatInstanceSessionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryChatInstanceSessionsResponseBody> body_ {};
  };
