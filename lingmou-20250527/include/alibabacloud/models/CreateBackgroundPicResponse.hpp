...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBackgroundPicResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBackgroundPicResponseBody) };
    inline CreateBackgroundPicResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBackgroundPicResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBackgroundPicResponseBody> body_ {};
  };
