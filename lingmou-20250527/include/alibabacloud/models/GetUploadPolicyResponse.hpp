...
namespace Models
{
  ...
  public:
    ...
    inline const GetUploadPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUploadPolicyResponseBody) };
    inline GetUploadPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUploadPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUploadPolicyResponseBody> body_ {};
  };
