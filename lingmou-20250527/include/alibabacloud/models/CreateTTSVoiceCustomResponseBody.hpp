...
#ifndef ALIBABACLOUD_MODELS_CREATETTSVOICECUSTOMRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATETTSVOICECUSTOMRESPONSEBODY_HPP_
...
namespace Models
{
  class CreateTTSVoiceCustomResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateTTSVoiceCustomResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateTTSVoiceCustomResponseBody& obj) { 
    ...
    CreateTTSVoiceCustomResponseBody() = default ;
    CreateTTSVoiceCustomResponseBody(const CreateTTSVoiceCustomResponseBody &) = default ;
    CreateTTSVoiceCustomResponseBody(CreateTTSVoiceCustomResponseBody &&) = default ;
    CreateTTSVoiceCustomResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTTSVoiceCustomResponseBody() = default ;
    CreateTTSVoiceCustomResponseBody& operator=(const CreateTTSVoiceCustomResponseBody &) = default ;
    CreateTTSVoiceCustomResponseBody& operator=(CreateTTSVoiceCustomResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->audioURL_ == nullptr
        && this->censorStatus_ == nullptr && this->common_ == nullptr && this->createTime_ == nullptr && this->description_ == nullptr && this->errorDetail_ == nullptr
        && this->gender_ == nullptr && this->id_ == nullptr && this->language_ == nullptr && this->modifiedTime_ == nullptr && this->name_ == nullptr
        && this->pitchRate_ == nullptr && this->remainSeconds_ == nullptr && this->speechRate_ == nullptr && this->status_ == nullptr && this->text_ == nullptr
        && this->voiceKey_ == nullptr; };
      ...
      inline Data& setPitchRate(float pitchRate) { DARABONBA_PTR_SET_VALUE(pitchRate_, pitchRate) };
      ...
      inline Data& setSpeechRate(float speechRate) { DARABONBA_PTR_SET_VALUE(speechRate_, speechRate) };
    ...
    inline CreateTTSVoiceCustomResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateTTSVoiceCustomResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateTTSVoiceCustomResponseBody::Data) };
    inline CreateTTSVoiceCustomResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateTTSVoiceCustomResponseBody::Data) };
    inline CreateTTSVoiceCustomResponseBody& setData(const CreateTTSVoiceCustomResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateTTSVoiceCustomResponseBody& setData(CreateTTSVoiceCustomResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateTTSVoiceCustomResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline CreateTTSVoiceCustomResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateTTSVoiceCustomResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CreateTTSVoiceCustomResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<CreateTTSVoiceCustomResponseBody::Data> data_ {};
