...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->expressiveness_ == nullptr
        && this->gender_ == nullptr && this->generateAssets_ == nullptr && this->imageOssPath_ == nullptr && this->jwtToken_ == nullptr && this->name_ == nullptr
    ...
    inline string getExpressiveness() const { DARABONBA_PTR_GET_DEFAULT(expressiveness_, "") };
  ...
  protected:
    shared_ptr<string> expressiveness_ {};
