...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTTSVoiceCustomResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTTSVoiceCustomResponseBody) };
    inline CreateTTSVoiceCustomResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTTSVoiceCustomResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTTSVoiceCustomResponseBody> body_ {};
  };
