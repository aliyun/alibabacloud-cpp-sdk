...
namespace Models
{
  ...
  public:
    ...
    inline const ListTemplateMaterialResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTemplateMaterialResponseBody) };
    inline ListTemplateMaterialResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTemplateMaterialResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTemplateMaterialResponseBody> body_ {};
  };
