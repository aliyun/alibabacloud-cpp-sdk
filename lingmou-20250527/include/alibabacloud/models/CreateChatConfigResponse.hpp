...
namespace Models
{
  ...
  public:
    ...
    inline const CreateChatConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateChatConfigResponseBody) };
    inline CreateChatConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateChatConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateChatConfigResponseBody> body_ {};
  };
