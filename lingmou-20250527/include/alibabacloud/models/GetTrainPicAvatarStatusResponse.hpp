...
namespace Models
{
  ...
  public:
    ...
    inline const GetTrainPicAvatarStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTrainPicAvatarStatusResponseBody) };
    inline GetTrainPicAvatarStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTrainPicAvatarStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTrainPicAvatarStatusResponseBody> body_ {};
  };
