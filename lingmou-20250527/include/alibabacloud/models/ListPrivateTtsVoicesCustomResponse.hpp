...
namespace Models
{
  ...
  public:
    ...
    inline const ListPrivateTTSVoicesCustomResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPrivateTTSVoicesCustomResponseBody) };
    inline ListPrivateTTSVoicesCustomResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPrivateTTSVoicesCustomResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPrivateTTSVoicesCustomResponseBody> body_ {};
  };
