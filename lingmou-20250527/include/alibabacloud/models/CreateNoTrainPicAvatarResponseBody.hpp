...
namespace Models
{
  ...
  public:
    ...
    inline const CreateNoTrainPicAvatarResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateNoTrainPicAvatarResponseBodyData) };
    inline CreateNoTrainPicAvatarResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateNoTrainPicAvatarResponseBodyData) };
    inline CreateNoTrainPicAvatarResponseBody& setData(const CreateNoTrainPicAvatarResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateNoTrainPicAvatarResponseBody& setData(CreateNoTrainPicAvatarResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateNoTrainPicAvatarResponseBodyData> data_ = nullptr;
