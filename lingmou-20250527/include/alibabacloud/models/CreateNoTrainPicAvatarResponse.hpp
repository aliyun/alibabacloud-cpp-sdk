...
namespace Models
{
  ...
  public:
    ...
    inline const CreateNoTrainPicAvatarResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateNoTrainPicAvatarResponseBody) };
    inline CreateNoTrainPicAvatarResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateNoTrainPicAvatarResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateNoTrainPicAvatarResponseBody> body_ {};
  };
