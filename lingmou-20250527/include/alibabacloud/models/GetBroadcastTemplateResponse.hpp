...
namespace Models
{
  ...
  public:
    ...
    inline const GetBroadcastTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetBroadcastTemplateResponseBody) };
    inline GetBroadcastTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetBroadcastTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetBroadcastTemplateResponseBody> body_ {};
  };
