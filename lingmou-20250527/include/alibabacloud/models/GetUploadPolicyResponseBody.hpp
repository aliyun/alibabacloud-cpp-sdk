...
namespace Models
{
  ...
  public:
    ...
    inline const GetUploadPolicyResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetUploadPolicyResponseBodyData) };
    inline GetUploadPolicyResponseBodyData data() { DARABONBA_PTR_GET(data_, GetUploadPolicyResponseBodyData) };
    inline GetUploadPolicyResponseBody& setData(const GetUploadPolicyResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetUploadPolicyResponseBody& setData(GetUploadPolicyResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetUploadPolicyResponseBodyData> data_ = nullptr;
