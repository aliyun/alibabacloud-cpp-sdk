...
namespace Models
{
  ...
  public:
    ...
    inline const ListBroadcastVideosByIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListBroadcastVideosByIdResponseBody) };
    inline ListBroadcastVideosByIdResponseBody getBody() { DARABONBA_PTR_GET(body_, ListBroadcastVideosByIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListBroadcastVideosByIdResponseBody> body_ {};
  };
