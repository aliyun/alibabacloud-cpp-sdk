...
namespace Models
{
  ...
  public:
    ...
    inline const GetTTSVoiceByIdCustomResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTTSVoiceByIdCustomResponseBodyData) };
    inline GetTTSVoiceByIdCustomResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTTSVoiceByIdCustomResponseBodyData) };
    inline GetTTSVoiceByIdCustomResponseBody& setData(const GetTTSVoiceByIdCustomResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTTSVoiceByIdCustomResponseBody& setData(GetTTSVoiceByIdCustomResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetTTSVoiceByIdCustomResponseBodyData> data_ = nullptr;
