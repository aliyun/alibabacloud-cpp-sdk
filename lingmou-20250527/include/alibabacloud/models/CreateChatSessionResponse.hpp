...
namespace Models
{
  ...
  public:
    ...
    inline const CreateChatSessionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateChatSessionResponseBody) };
    inline CreateChatSessionResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateChatSessionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateChatSessionResponseBody> body_ {};
  };
