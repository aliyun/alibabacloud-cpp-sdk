...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alignmentFileURL_ == nullptr
        && this->captionURL_ == nullptr && this->coverURL_ == nullptr && this->createTime_ == nullptr && this->id_ == nullptr && this->modifiedTime_ == nullptr
        && this->name_ == nullptr && this->status_ == nullptr && this->videoURL_ == nullptr; };
    ...
    inline string getAlignmentFileURL() const { DARABONBA_PTR_GET_DEFAULT(alignmentFileURL_, "") };
    ...
    inline string getCaptionURL() const { DARABONBA_PTR_GET_DEFAULT(captionURL_, "") };
  ...
  protected:
    shared_ptr<string> alignmentFileURL_ {};
    shared_ptr<string> captionURL_ {};
