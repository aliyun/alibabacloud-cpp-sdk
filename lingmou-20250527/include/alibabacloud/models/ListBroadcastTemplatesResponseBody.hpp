...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        ...
        && this->page_ == nullptr && this->requestId_ == nullptr && this->size_ == nullptr && this->success_ == nullptr; };
    ...
    inline const vector<BroadcastTemplate> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<BroadcastTemplate>) };
    inline vector<BroadcastTemplate> getData() { DARABONBA_PTR_GET(data_, vector<BroadcastTemplate>) };
  ...
  protected:
    ...
    shared_ptr<vector<BroadcastTemplate>> data_ {};
