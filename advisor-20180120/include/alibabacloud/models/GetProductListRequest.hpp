...
namespace Models
{
  ...
  public:
    ...
    inline GetProductListRequest& setLanguage(string language) { DARABONBA_PTR_SET_VALUE(language_, language) };
    ...
    inline GetProductListRequest& setToken(string token) { DARABONBA_PTR_SET_VALUE(token_, token) };
