...
namespace Models
{
  ...
  public:
    ...
    inline const GetProductListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetProductListResponseBody) };
    inline GetProductListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetProductListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetProductListResponseBody> body_ {};
  };
