...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEADVICESPAGERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEADVICESPAGERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeAdvicesPageResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeAdvicesPageResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DescribeAdvicesPageResponseBody() = default ;
    DescribeAdvicesPageResponseBody(const DescribeAdvicesPageResponseBody &) = default ;
    DescribeAdvicesPageResponseBody(DescribeAdvicesPageResponseBody &&) = default ;
    DescribeAdvicesPageResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeAdvicesPageResponseBody() = default ;
    DescribeAdvicesPageResponseBody& operator=(const DescribeAdvicesPageResponseBody &) = default ;
    DescribeAdvicesPageResponseBody& operator=(DescribeAdvicesPageResponseBody &&) = default ;
    ...
    inline const DescribeAdvicesPageResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeAdvicesPageResponseBody::Data) };
    inline DescribeAdvicesPageResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeAdvicesPageResponseBody::Data) };
    inline DescribeAdvicesPageResponseBody& setData(const DescribeAdvicesPageResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAdvicesPageResponseBody& setData(DescribeAdvicesPageResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeAdvicesPageResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<DescribeAdvicesPageResponseBody::Data> data_ {};
