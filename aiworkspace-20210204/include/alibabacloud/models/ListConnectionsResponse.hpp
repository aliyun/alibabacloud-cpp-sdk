...
namespace Models
{
  ...
  public:
    ...
    inline const ListConnectionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListConnectionsResponseBody) };
    inline ListConnectionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListConnectionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListConnectionsResponseBody> body_ {};
  };
