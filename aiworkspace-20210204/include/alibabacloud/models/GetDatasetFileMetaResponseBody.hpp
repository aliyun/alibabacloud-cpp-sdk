...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->datasetFileMeta_ == nullptr
        && this->datasetId_ == nullptr && this->datasetVersion_ == nullptr && this->requestId_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline const DatasetFileMetaContentGet & getDatasetFileMeta() const { DARABONBA_PTR_GET_CONST(datasetFileMeta_, DatasetFileMetaContentGet) };
    inline DatasetFileMetaContentGet getDatasetFileMeta() { DARABONBA_PTR_GET(datasetFileMeta_, DatasetFileMetaContentGet) };
