...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteModelVersionLabelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteModelVersionLabelsResponseBody) };
    inline DeleteModelVersionLabelsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteModelVersionLabelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteModelVersionLabelsResponseBody> body_ {};
  };
