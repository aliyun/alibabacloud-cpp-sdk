...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDatasetVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDatasetVersionResponseBody) };
    inline CreateDatasetVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDatasetVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDatasetVersionResponseBody> body_ {};
  };
