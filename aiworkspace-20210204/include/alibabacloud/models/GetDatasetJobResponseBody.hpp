...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->completedFileCount_ == nullptr
        && return this->createTime_ == nullptr && return this->description_ == nullptr && return this->failedFileCount_ == nullptr && return this->finishTime_ == nullptr && return this->jobAction_ == nullptr
        && return this->jobMode_ == nullptr && return this->jobSpec_ == nullptr && return this->logs_ == nullptr && return this->requestId_ == nullptr && return this->status_ == nullptr
        && return this->totalFileCount_ == nullptr; };
