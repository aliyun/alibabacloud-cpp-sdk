...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateModelVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateModelVersionResponseBody) };
    inline UpdateModelVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateModelVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateModelVersionResponseBody> body_ {};
  };
