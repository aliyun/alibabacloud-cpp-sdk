...
namespace Models
{
  ...
  public:
    ...
    inline const SetUserConfigsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetUserConfigsResponseBody) };
    inline SetUserConfigsResponseBody getBody() { DARABONBA_PTR_GET(body_, SetUserConfigsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetUserConfigsResponseBody> body_ {};
  };
