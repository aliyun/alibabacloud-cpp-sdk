...
namespace Models
{
  ...
  public:
    ...
    inline const ListMembersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMembersResponseBody) };
    inline ListMembersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMembersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMembersResponseBody> body_ {};
  };
