...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCodeSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCodeSourceResponseBody) };
    inline DeleteCodeSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCodeSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCodeSourceResponseBody> body_ {};
  };
