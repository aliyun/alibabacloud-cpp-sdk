...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->collections_ == nullptr
        && return this->conditions_ == nullptr && return this->domain_ == nullptr && return this->label_ == nullptr && return this->modelName_ == nullptr && return this->modelType_ == nullptr
        ...
        && return this->query_ == nullptr && return this->sortBy_ == nullptr && return this->tag_ == nullptr && return this->task_ == nullptr && return this->workspaceId_ == nullptr; };
    ...
    inline const vector<ListModelsRequestConditions> & conditions() const { DARABONBA_PTR_GET_CONST(conditions_, vector<ListModelsRequestConditions>) };
    inline vector<ListModelsRequestConditions> conditions() { DARABONBA_PTR_GET(conditions_, vector<ListModelsRequestConditions>) };
    inline ListModelsRequest& setConditions(const vector<ListModelsRequestConditions> & conditions) { DARABONBA_PTR_SET_VALUE(conditions_, conditions) };
    inline ListModelsRequest& setConditions(vector<ListModelsRequestConditions> && conditions) { DARABONBA_PTR_SET_RVALUE(conditions_, conditions) };
    ...
    inline const vector<ListModelsRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<ListModelsRequestTag>) };
    inline vector<ListModelsRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<ListModelsRequestTag>) };
    inline ListModelsRequest& setTag(const vector<ListModelsRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline ListModelsRequest& setTag(vector<ListModelsRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListModelsRequestConditions>> conditions_ = nullptr;
    ...
    std::shared_ptr<vector<ListModelsRequestTag>> tag_ = nullptr;
