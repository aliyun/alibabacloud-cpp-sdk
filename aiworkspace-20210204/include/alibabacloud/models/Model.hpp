...
namespace Models
{
  ...
  public:
    ...
    inline Model& setAccessibility(string accessibility) { DARABONBA_PTR_SET_VALUE(accessibility_, accessibility) };
    ...
    inline Model& setExtraInfo(const Darabonba::Json & extraInfo) { DARABONBA_SET_VALUE(extraInfo_, extraInfo) };
    inline Model& setExtraInfo(Darabonba::Json & extraInfo) { DARABONBA_SET_RVALUE(extraInfo_, extraInfo) };
    ...
    inline Model& setGmtCreateTime(string gmtCreateTime) { DARABONBA_PTR_SET_VALUE(gmtCreateTime_, gmtCreateTime) };
    ...
    inline Model& setGmtLatestVersionModifiedTime(string gmtLatestVersionModifiedTime) { DARABONBA_PTR_SET_VALUE(gmtLatestVersionModifiedTime_, gmtLatestVersionModifiedTime) };
    ...
    inline Model& setGmtModifiedTime(string gmtModifiedTime) { DARABONBA_PTR_SET_VALUE(gmtModifiedTime_, gmtModifiedTime) };
    ...
    inline Model& setLabels(const vector<Label> & labels) { DARABONBA_PTR_SET_VALUE(labels_, labels) };
    inline Model& setLabels(vector<Label> && labels) { DARABONBA_PTR_SET_RVALUE(labels_, labels) };
    ...
    inline Model& setLatestVersion(const ModelVersion & latestVersion) { DARABONBA_PTR_SET_VALUE(latestVersion_, latestVersion) };
    inline Model& setLatestVersion(ModelVersion && latestVersion) { DARABONBA_PTR_SET_RVALUE(latestVersion_, latestVersion) };
    ...
    inline Model& setModelDescription(string modelDescription) { DARABONBA_PTR_SET_VALUE(modelDescription_, modelDescription) };
    ...
    inline Model& setModelDoc(string modelDoc) { DARABONBA_PTR_SET_VALUE(modelDoc_, modelDoc) };
    ...
    inline Model& setModelType(string modelType) { DARABONBA_PTR_SET_VALUE(modelType_, modelType) };
    ...
    inline Model& setOrderNumber(int64_t orderNumber) { DARABONBA_PTR_SET_VALUE(orderNumber_, orderNumber) };
    ...
    inline Model& setOrigin(string origin) { DARABONBA_PTR_SET_VALUE(origin_, origin) };
    ...
    inline Model& setOwnerId(string ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline Model& setParameterSize(int64_t parameterSize) { DARABONBA_PTR_SET_VALUE(parameterSize_, parameterSize) };
    ...
    inline const vector<Label> & tags() const { DARABONBA_PTR_GET_CONST(tags_, vector<Label>) };
    inline vector<Label> tags() { DARABONBA_PTR_GET(tags_, vector<Label>) };
    inline Model& setTags(const vector<Label> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline Model& setTags(vector<Label> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
    ...
    inline Model& setTask(string task) { DARABONBA_PTR_SET_VALUE(task_, task) };
    ...
    inline Model& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Label>> tags_ = nullptr;
