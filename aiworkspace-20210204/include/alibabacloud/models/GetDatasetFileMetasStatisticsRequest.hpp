...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aggregateBy_ == nullptr
        && return this->datasetVersion_ == nullptr && return this->maxResults_ == nullptr && return this->workspaceId_ == nullptr; };
    ...
    inline string aggregateBy() const { DARABONBA_PTR_GET_DEFAULT(aggregateBy_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> aggregateBy_ = nullptr;
    // The dataset version.
    // 
