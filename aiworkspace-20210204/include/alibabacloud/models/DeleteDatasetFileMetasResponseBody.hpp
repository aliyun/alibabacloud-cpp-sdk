...
#ifndef ALIBABACLOUD_MODELS_DELETEDATASETFILEMETASRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DELETEDATASETFILEMETASRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteDatasetFileMetasResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(FailedDetails, failedDetails_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Status, status_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteDatasetFileMetasResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(FailedDetails, failedDetails_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Status, status_);
    };
    DeleteDatasetFileMetasResponseBody() = default ;
    DeleteDatasetFileMetasResponseBody(const DeleteDatasetFileMetasResponseBody &) = default ;
    DeleteDatasetFileMetasResponseBody(DeleteDatasetFileMetasResponseBody &&) = default ;
    DeleteDatasetFileMetasResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteDatasetFileMetasResponseBody() = default ;
    DeleteDatasetFileMetasResponseBody& operator=(const DeleteDatasetFileMetasResponseBody &) = default ;
    DeleteDatasetFileMetasResponseBody& operator=(DeleteDatasetFileMetasResponseBody &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->failedDetails_ != nullptr
