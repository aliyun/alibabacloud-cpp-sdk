...
namespace Models
{
  ...
  public:
    ...
    inline const ListImagesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListImagesResponseBody) };
    inline ListImagesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListImagesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListImagesResponseBody> body_ {};
  };
