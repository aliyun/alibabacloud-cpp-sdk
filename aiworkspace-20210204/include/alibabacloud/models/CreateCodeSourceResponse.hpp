...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCodeSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCodeSourceResponseBody) };
    inline CreateCodeSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCodeSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCodeSourceResponseBody> body_ {};
  };
