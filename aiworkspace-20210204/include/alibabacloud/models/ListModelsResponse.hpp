...
namespace Models
{
  ...
  public:
    ...
    inline const ListModelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListModelsResponseBody) };
    inline ListModelsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListModelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListModelsResponseBody> body_ {};
  };
