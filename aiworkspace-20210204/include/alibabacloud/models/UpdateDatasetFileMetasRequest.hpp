...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->datasetFileMetas_ == nullptr
        && return this->datasetVersion_ == nullptr && return this->tagJobId_ == nullptr && return this->workspaceId_ == nullptr; };
    ...
    inline const vector<DatasetFileMetaConentUpdate> & datasetFileMetas() const { DARABONBA_PTR_GET_CONST(datasetFileMetas_, vector<DatasetFileMetaConentUpdate>) };
    inline vector<DatasetFileMetaConentUpdate> datasetFileMetas() { DARABONBA_PTR_GET(datasetFileMetas_, vector<DatasetFileMetaConentUpdate>) };
    ...
    inline string tagJobId() const { DARABONBA_PTR_GET_DEFAULT(tagJobId_, "") };
  ...
  protected:
    ...
    std::shared_ptr<vector<DatasetFileMetaConentUpdate>> datasetFileMetas_ = nullptr;
    // The dataset version.
    ...
    std::shared_ptr<string> tagJobId_ = nullptr;
