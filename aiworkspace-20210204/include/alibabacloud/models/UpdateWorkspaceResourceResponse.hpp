...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateWorkspaceResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateWorkspaceResourceResponseBody) };
    inline UpdateWorkspaceResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateWorkspaceResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateWorkspaceResourceResponseBody> body_ {};
  };
