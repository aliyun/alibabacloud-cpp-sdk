...
namespace Models
{
  ...
  public:
    ...
    inline const SetExperimentLabelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetExperimentLabelsResponseBody) };
    inline SetExperimentLabelsResponseBody getBody() { DARABONBA_PTR_GET(body_, SetExperimentLabelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetExperimentLabelsResponseBody> body_ {};
  };
