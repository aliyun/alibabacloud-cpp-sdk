...
namespace Models
{
  ...
  public:
    ...
    inline const StopDatasetJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopDatasetJobResponseBody) };
    inline StopDatasetJobResponseBody getBody() { DARABONBA_PTR_GET(body_, StopDatasetJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopDatasetJobResponseBody> body_ {};
  };
