...
namespace Models
{
  ...
  public:
    ...
    inline const GetPermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPermissionResponseBody) };
    inline GetPermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPermissionResponseBody> body_ {};
  };
