...
namespace Models
{
  ...
  public:
    ...
    inline const GetDatasetJobConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDatasetJobConfigResponseBody) };
    inline GetDatasetJobConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDatasetJobConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDatasetJobConfigResponseBody> body_ {};
  };
