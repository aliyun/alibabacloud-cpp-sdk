...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Darabonba::Json> & getLabels() const { DARABONBA_PTR_GET_CONST(labels_, vector<Darabonba::Json>) };
    inline vector<Darabonba::Json> getLabels() { DARABONBA_PTR_GET(labels_, vector<Darabonba::Json>) };
