...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRunResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateRunResponseBody) };
    inline CreateRunResponseBody body() { DARABONBA_PTR_GET(body_, CreateRunResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateRunResponseBody> body_ = nullptr;
  };
