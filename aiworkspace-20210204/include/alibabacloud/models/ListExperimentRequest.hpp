...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline string getMatchNameExactly() const { DARABONBA_PTR_GET_DEFAULT(matchNameExactly_, "") };
      inline Options& setMatchNameExactly(string matchNameExactly) { DARABONBA_PTR_SET_VALUE(matchNameExactly_, matchNameExactly) };


    protected:
      // Specifies whether to exactly match the experiment by name. Valid values: true and false.
      shared_ptr<string> matchNameExactly_ {};
    };
    ...
    inline const ListExperimentRequest::Options & getOptions() const { DARABONBA_PTR_GET_CONST(options_, ListExperimentRequest::Options) };
    inline ListExperimentRequest::Options getOptions() { DARABONBA_PTR_GET(options_, ListExperimentRequest::Options) };
    inline ListExperimentRequest& setOptions(const ListExperimentRequest::Options & options) { DARABONBA_PTR_SET_VALUE(options_, options) };
    inline ListExperimentRequest& setOptions(ListExperimentRequest::Options && options) { DARABONBA_PTR_SET_RVALUE(options_, options) };
  ...
  protected:
    ...
    shared_ptr<ListExperimentRequest::Options> options_ {};
