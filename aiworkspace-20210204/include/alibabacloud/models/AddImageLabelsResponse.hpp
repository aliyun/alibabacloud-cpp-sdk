...
namespace Models
{
  ...
  public:
    ...
    inline const AddImageLabelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddImageLabelsResponseBody) };
    inline AddImageLabelsResponseBody getBody() { DARABONBA_PTR_GET(body_, AddImageLabelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddImageLabelsResponseBody> body_ {};
  };
