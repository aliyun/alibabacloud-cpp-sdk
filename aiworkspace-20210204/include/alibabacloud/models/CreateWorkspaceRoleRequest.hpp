...
#ifndef ALIBABACLOUD_MODELS_CREATEWORKSPACEROLEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEWORKSPACEROLEREQUEST_HPP_
...
namespace Models
{
  class CreateWorkspaceRoleRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateWorkspaceRoleRequest& obj) { 
    ...
    CreateWorkspaceRoleRequest(CreateWorkspaceRoleRequest &&) = default ;
    CreateWorkspaceRoleRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateWorkspaceRoleRequest() = default ;
    CreateWorkspaceRoleRequest& operator=(const CreateWorkspaceRoleRequest &) = default ;
    CreateWorkspaceRoleRequest& operator=(CreateWorkspaceRoleRequest &&) = default ;
    ...
    inline const vector<CreateWorkspaceRoleRequest::ModulePermissions> & getModulePermissions() const { DARABONBA_PTR_GET_CONST(modulePermissions_, vector<CreateWorkspaceRoleRequest::ModulePermissions>) };
    inline vector<CreateWorkspaceRoleRequest::ModulePermissions> getModulePermissions() { DARABONBA_PTR_GET(modulePermissions_, vector<CreateWorkspaceRoleRequest::ModulePermissions>) };
    inline CreateWorkspaceRoleRequest& setModulePermissions(const vector<CreateWorkspaceRoleRequest::ModulePermissions> & modulePermissions) { DARABONBA_PTR_SET_VALUE(modulePermissions_, modulePermissions) };
    inline CreateWorkspaceRoleRequest& setModulePermissions(vector<CreateWorkspaceRoleRequest::ModulePermissions> && modulePermissions) { DARABONBA_PTR_SET_RVALUE(modulePermissions_, modulePermissions) };
    ...
    inline CreateWorkspaceRoleRequest& setRoleName(string roleName) { DARABONBA_PTR_SET_VALUE(roleName_, roleName) };
