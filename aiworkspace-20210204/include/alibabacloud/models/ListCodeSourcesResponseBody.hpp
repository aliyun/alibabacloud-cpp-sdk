...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->codeSources_ == nullptr
    ...
    inline const vector<CodeSourceItem> & getCodeSources() const { DARABONBA_PTR_GET_CONST(codeSources_, vector<CodeSourceItem>) };
    inline vector<CodeSourceItem> getCodeSources() { DARABONBA_PTR_GET(codeSources_, vector<CodeSourceItem>) };
