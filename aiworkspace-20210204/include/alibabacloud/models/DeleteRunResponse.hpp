...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRunResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteRunResponseBody) };
    inline DeleteRunResponseBody body() { DARABONBA_PTR_GET(body_, DeleteRunResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteRunResponseBody> body_ = nullptr;
  };
