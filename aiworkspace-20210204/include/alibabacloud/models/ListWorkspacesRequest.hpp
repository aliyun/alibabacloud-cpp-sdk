...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->fields_ == nullptr
        ...
        && this->resourceGroupId_ == nullptr && this->sortBy_ == nullptr && this->status_ == nullptr && this->userId_ == nullptr && this->verbose_ == nullptr
    ...
    inline string getModuleList() const { DARABONBA_PTR_GET_DEFAULT(moduleList_, "") };
