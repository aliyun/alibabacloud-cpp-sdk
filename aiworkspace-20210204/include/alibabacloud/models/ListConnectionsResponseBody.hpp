...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Connection> & getConnections() const { DARABONBA_PTR_GET_CONST(connections_, vector<Connection>) };
    inline vector<Connection> getConnections() { DARABONBA_PTR_GET(connections_, vector<Connection>) };
