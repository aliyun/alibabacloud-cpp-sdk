...
namespace Models
{
  ...
  public:
    ...
    inline const GetDatasetJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetDatasetJobResponseBody) };
    inline GetDatasetJobResponseBody body() { DARABONBA_PTR_GET(body_, GetDatasetJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetDatasetJobResponseBody> body_ = nullptr;
  };
