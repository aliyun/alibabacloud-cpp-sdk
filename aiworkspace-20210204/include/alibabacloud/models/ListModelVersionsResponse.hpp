...
namespace Models
{
  ...
  public:
    ...
    inline const ListModelVersionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListModelVersionsResponseBody) };
    inline ListModelVersionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListModelVersionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListModelVersionsResponseBody> body_ {};
  };
