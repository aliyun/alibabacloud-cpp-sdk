...
namespace Models
{
  ...
  public:
    ...
    inline ListWorkspaceUsersRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline ListWorkspaceUsersRequest& setUserName(string userName) { DARABONBA_PTR_SET_VALUE(userName_, userName) };
