...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->approvalStatus_ == nullptr
        && return this->compressionSpec_ == nullptr && return this->distillationSpec_ == nullptr && return this->evaluationSpec_ == nullptr && return this->extraInfo_ == nullptr && return this->inferenceSpec_ == nullptr
        && return this->metrics_ == nullptr && return this->options_ == nullptr && return this->sourceId_ == nullptr && return this->sourceType_ == nullptr && return this->trainingSpec_ == nullptr
