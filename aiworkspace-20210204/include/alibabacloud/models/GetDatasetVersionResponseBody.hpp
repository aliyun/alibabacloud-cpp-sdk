...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataCount_ == nullptr
        && return this->dataSize_ == nullptr && return this->dataSourceType_ == nullptr && return this->datasetId_ == nullptr && return this->description_ == nullptr && return this->gmtCreateTime_ == nullptr
        && return this->gmtModifiedTime_ == nullptr && return this->importInfo_ == nullptr && return this->labels_ == nullptr && return this->mountAccess_ == nullptr && return this->options_ == nullptr
        && return this->property_ == nullptr && return this->requestId_ == nullptr && return this->sourceId_ == nullptr && return this->sourceType_ == nullptr && return this->uri_ == nullptr
