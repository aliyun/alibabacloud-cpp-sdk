...
namespace Models
{
  ...
  public:
    ...
    inline const ListDatasetFileMetasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDatasetFileMetasResponseBody) };
    inline ListDatasetFileMetasResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDatasetFileMetasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDatasetFileMetasResponseBody> body_ {};
  };
