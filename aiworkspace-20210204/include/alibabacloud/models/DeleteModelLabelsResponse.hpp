...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteModelLabelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteModelLabelsResponseBody) };
    inline DeleteModelLabelsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteModelLabelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteModelLabelsResponseBody> body_ {};
  };
