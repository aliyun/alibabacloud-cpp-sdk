...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDatasetVersionLabelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDatasetVersionLabelsResponseBody) };
    inline DeleteDatasetVersionLabelsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDatasetVersionLabelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDatasetVersionLabelsResponseBody> body_ {};
  };
