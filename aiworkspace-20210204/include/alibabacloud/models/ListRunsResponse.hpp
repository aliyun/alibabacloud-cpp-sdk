...
namespace Models
{
  ...
  public:
    ...
    inline const ListRunsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRunsResponseBody) };
    inline ListRunsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRunsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRunsResponseBody> body_ {};
  };
