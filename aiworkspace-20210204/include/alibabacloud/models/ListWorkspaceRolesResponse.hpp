...
namespace Models
{
  ...
  public:
    ...
    inline const ListWorkspaceRolesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListWorkspaceRolesResponseBody) };
    inline ListWorkspaceRolesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListWorkspaceRolesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListWorkspaceRolesResponseBody> body_ {};
  };
