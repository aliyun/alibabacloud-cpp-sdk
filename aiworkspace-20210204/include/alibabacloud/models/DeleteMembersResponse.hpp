...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMembersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMembersResponseBody) };
    inline DeleteMembersResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMembersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMembersResponseBody> body_ {};
  };
