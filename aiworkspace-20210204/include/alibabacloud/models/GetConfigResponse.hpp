...
namespace Models
{
  ...
  public:
    ...
    inline const GetConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetConfigResponseBody) };
    inline GetConfigResponseBody body() { DARABONBA_PTR_GET(body_, GetConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetConfigResponseBody> body_ = nullptr;
  };
