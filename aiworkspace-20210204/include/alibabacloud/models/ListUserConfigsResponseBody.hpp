...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListUserConfigsResponseBodyConfigs> & configs() const { DARABONBA_PTR_GET_CONST(configs_, vector<ListUserConfigsResponseBodyConfigs>) };
    inline vector<ListUserConfigsResponseBodyConfigs> configs() { DARABONBA_PTR_GET(configs_, vector<ListUserConfigsResponseBodyConfigs>) };
    inline ListUserConfigsResponseBody& setConfigs(const vector<ListUserConfigsResponseBodyConfigs> & configs) { DARABONBA_PTR_SET_VALUE(configs_, configs) };
    inline ListUserConfigsResponseBody& setConfigs(vector<ListUserConfigsResponseBodyConfigs> && configs) { DARABONBA_PTR_SET_RVALUE(configs_, configs) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListUserConfigsResponseBodyConfigs>> configs_ = nullptr;
    // The request ID.
