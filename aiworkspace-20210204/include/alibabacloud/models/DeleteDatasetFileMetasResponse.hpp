...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDatasetFileMetasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDatasetFileMetasResponseBody) };
    inline DeleteDatasetFileMetasResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDatasetFileMetasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDatasetFileMetasResponseBody> body_ {};
  };
