...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDatasetFileMetasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDatasetFileMetasResponseBody) };
    inline CreateDatasetFileMetasResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDatasetFileMetasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDatasetFileMetasResponseBody> body_ {};
  };
