...
namespace Models
{
  ...
  public:
    ...
    inline const GetDatasetFileMetasStatisticsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetDatasetFileMetasStatisticsResponseBody) };
    inline GetDatasetFileMetasStatisticsResponseBody body() { DARABONBA_PTR_GET(body_, GetDatasetFileMetasStatisticsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetDatasetFileMetasStatisticsResponseBody> body_ = nullptr;
  };
