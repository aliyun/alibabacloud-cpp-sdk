...
namespace Models
{
  ...
  public:
    ...
    inline const GetMemberResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMemberResponseBody) };
    inline GetMemberResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMemberResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMemberResponseBody> body_ {};
  };
