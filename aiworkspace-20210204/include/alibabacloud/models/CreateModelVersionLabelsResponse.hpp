...
namespace Models
{
  ...
  public:
    ...
    inline const CreateModelVersionLabelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateModelVersionLabelsResponseBody) };
    inline CreateModelVersionLabelsResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateModelVersionLabelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateModelVersionLabelsResponseBody> body_ {};
  };
