...
namespace Models
{
  ...
  public:
    ...
    inline const GetConnectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetConnectionResponseBody) };
    inline GetConnectionResponseBody getBody() { DARABONBA_PTR_GET(body_, GetConnectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetConnectionResponseBody> body_ {};
  };
