...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->memberName_ == nullptr
        && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->roles_ == nullptr; };
    ...
    inline string roles() const { DARABONBA_PTR_GET_DEFAULT(roles_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> roles_ = nullptr;
  };
