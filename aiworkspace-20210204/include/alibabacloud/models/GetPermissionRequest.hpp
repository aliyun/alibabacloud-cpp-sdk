...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessibility_ == nullptr
        ...
        && this->labels_ == nullptr && this->option_ == nullptr && this->resource_ == nullptr && this->securityToken_ == nullptr; };
    ...
    inline GetPermissionRequest& setCallerAccessKeyId(string callerAccessKeyId) { DARABONBA_PTR_SET_VALUE(callerAccessKeyId_, callerAccessKeyId) };
    ...
    inline GetPermissionRequest& setCallerSecurityToken(string callerSecurityToken) { DARABONBA_PTR_SET_VALUE(callerSecurityToken_, callerSecurityToken) };
