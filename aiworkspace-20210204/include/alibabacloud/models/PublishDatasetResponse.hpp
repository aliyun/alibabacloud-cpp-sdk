...
namespace Models
{
  ...
  public:
    ...
    inline const PublishDatasetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PublishDatasetResponseBody) };
    inline PublishDatasetResponseBody getBody() { DARABONBA_PTR_GET(body_, PublishDatasetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PublishDatasetResponseBody> body_ {};
  };
