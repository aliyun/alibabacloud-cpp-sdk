...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->nextPageToken_ == nullptr
        && return this->runs_ == nullptr && return this->totalCount_ == nullptr && return this->requestId_ == nullptr; };
    ...
    inline const vector<Run> & runs() const { DARABONBA_PTR_GET_CONST(runs_, vector<Run>) };
    inline vector<Run> runs() { DARABONBA_PTR_GET(runs_, vector<Run>) };
  ...
  protected:
    ...
    // The runs.
    std::shared_ptr<vector<Run>> runs_ = nullptr;
