...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ExperimentLabel> & getLabels() const { DARABONBA_PTR_GET_CONST(labels_, vector<ExperimentLabel>) };
    inline vector<ExperimentLabel> getLabels() { DARABONBA_PTR_GET(labels_, vector<ExperimentLabel>) };
    ...
    inline const Run & getLatestRun() const { DARABONBA_PTR_GET_CONST(latestRun_, Run) };
    inline Run getLatestRun() { DARABONBA_PTR_GET(latestRun_, Run) };
    ...
    inline string getTensorboardLogUri() const { DARABONBA_PTR_GET_DEFAULT(tensorboardLogUri_, "") };
