...
class DeleteSymRecordsRequest : public Darabonba::Model {
public:
  ...
  explicit DeleteSymRecordsRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DeleteSymRecordsRequest() = default;
};
class DeleteSymRecordsShrinkRequest : public Darabonba::Model {
public:
  shared_ptr<string> appVersionsShrink{};
  shared_ptr<string> dataSourceId{};
  shared_ptr<long> fileType{};

  DeleteSymRecordsShrinkRequest() {}

  explicit DeleteSymRecordsShrinkRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    map<string, boost::any> res;
    if (appVersionsShrink) {
      res["appVersions"] = boost::any(*appVersionsShrink);
    }
    if (dataSourceId) {
      res["dataSourceId"] = boost::any(*dataSourceId);
    }
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("appVersions") != m.end() && !m["appVersions"].empty()) {
      appVersionsShrink = make_shared<string>(boost::any_cast<string>(m["appVersions"]));
    }
    if (m.find("dataSourceId") != m.end() && !m["dataSourceId"].empty()) {
      dataSourceId = make_shared<string>(boost::any_cast<string>(m["dataSourceId"]));
    }
  ...
  virtual ~DeleteSymRecordsShrinkRequest() = default;
};
class DeleteSymRecordsResponseBody : public Darabonba::Model {
public:
  ...
  DeleteSymRecordsResponseBody() {}

  explicit DeleteSymRecordsResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DeleteSymRecordsResponseBody() = default;
};
class DeleteSymRecordsResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<DeleteSymRecordsResponseBody> body{};

  DeleteSymRecordsResponse() {}

  explicit DeleteSymRecordsResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        DeleteSymRecordsResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<DeleteSymRecordsResponseBody>(model1);
      }
    }
  }
