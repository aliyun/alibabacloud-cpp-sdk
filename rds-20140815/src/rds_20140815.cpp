...
CheckCreateDdrDBInstanceResponse Alibabacloud_Rds20140815::Client::checkCreateDdrDBInstanceWithOptions(shared_ptr<CheckCreateDdrDBInstanceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  if (!Darabonba_Util::Client::isUnset<string>(request->binlogName)) {
    query->insert(pair<string, string>("BinlogName", *request->binlogName));
  }
  if (!Darabonba_Util::Client::isUnset<string>(request->binlogPosition)) {
    query->insert(pair<string, string>("BinlogPosition", *request->binlogPosition));
  }
  if (!Darabonba_Util::Client::isUnset<string>(request->binlogRole)) {
...
CreateNotifyResponse Alibabacloud_Rds20140815::Client::createNotifyWithOptions(shared_ptr<CreateNotifyRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> body = make_shared<map<string, boost::any>>(map<string, boost::any>());
  ...
  if (!Darabonba_Util::Client::isUnset<string>(request->notifyElement)) {
    body->insert(pair<string, string>("NotifyElement", *request->notifyElement));
  }
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("CreateNotify"))},
    {"version", boost::any(string("2014-08-15"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return CreateNotifyResponse(callApi(params, req, runtime));
}

CreateNotifyResponse Alibabacloud_Rds20140815::Client::createNotify(shared_ptr<CreateNotifyRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
...
ModifyDBInstanceSpecResponse Alibabacloud_Rds20140815::Client::modifyDBInstanceSpecWithOptions(shared_ptr<ModifyDBInstanceSpecRequest> tmpReq, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  if (!Darabonba_Util::Client::isUnset<ModifyDBInstanceSpecRequestServerlessConfiguration>(tmpReq->serverlessConfiguration)) {
    request->serverlessConfigurationShrink = make_shared<string>(Alibabacloud_OpenApiUtil::Client::arrayToStringWithSpecifiedStyle(make_shared<map<string, boost::any>>(tmpReq->serverlessConfiguration->toMap()), make_shared<string>("ServerlessConfiguration"), make_shared<string>("json")));
  }
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<string>(request->category)) {
    query->insert(pair<string, string>("Category", *request->category));
