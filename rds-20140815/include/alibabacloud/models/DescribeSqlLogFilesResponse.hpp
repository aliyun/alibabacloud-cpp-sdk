...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSQLLogFilesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSQLLogFilesResponseBody) };
    inline DescribeSQLLogFilesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSQLLogFilesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSQLLogFilesResponseBody> body_ {};
  };
