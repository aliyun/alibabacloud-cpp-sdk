...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->babelfishPort_ == nullptr
        && this->connectionStringPrefix_ == nullptr && this->DBInstanceId_ == nullptr && this->generalGroupName_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr
        && this->PGBouncerPort_ == nullptr && this->port_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr; };
