...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->babelfishPort_ == nullptr
        && return this->connectionStringPrefix_ == nullptr && return this->DBInstanceId_ == nullptr && return this->generalGroupName_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr
        && return this->PGBouncerPort_ == nullptr && return this->port_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr; };
    ...
    inline AllocateInstancePublicConnectionRequest& setBabelfishPort(string babelfishPort) { DARABONBA_PTR_SET_VALUE(babelfishPort_, babelfishPort) };
    ...
    inline AllocateInstancePublicConnectionRequest& setGeneralGroupName(string generalGroupName) { DARABONBA_PTR_SET_VALUE(generalGroupName_, generalGroupName) };
    ...
    inline AllocateInstancePublicConnectionRequest& setPGBouncerPort(string PGBouncerPort) { DARABONBA_PTR_SET_VALUE(PGBouncerPort_, PGBouncerPort) };
