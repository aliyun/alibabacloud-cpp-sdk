...
#ifndef ALIBABACLOUD_MODELS_REBUILDDBINSTANCERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_REBUILDDBINSTANCERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RebuildDBInstanceResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(MigrationId, migrationId_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(TaskId, taskId_);
    };
    friend void from_json(const Darabonba::Json& j, RebuildDBInstanceResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(MigrationId, migrationId_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(TaskId, taskId_);
    };
    RebuildDBInstanceResponseBody() = default ;
    RebuildDBInstanceResponseBody(const RebuildDBInstanceResponseBody &) = default ;
    RebuildDBInstanceResponseBody(RebuildDBInstanceResponseBody &&) = default ;
    RebuildDBInstanceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RebuildDBInstanceResponseBody() = default ;
    RebuildDBInstanceResponseBody& operator=(const RebuildDBInstanceResponseBody &) = default ;
    RebuildDBInstanceResponseBody& operator=(RebuildDBInstanceResponseBody &&) = default ;
