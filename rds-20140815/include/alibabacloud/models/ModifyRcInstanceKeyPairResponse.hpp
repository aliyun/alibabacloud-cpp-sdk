...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyRCInstanceKeyPairResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyRCInstanceKeyPairResponseBody) };
    inline ModifyRCInstanceKeyPairResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyRCInstanceKeyPairResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyRCInstanceKeyPairResponseBody> body_ {};
  };
