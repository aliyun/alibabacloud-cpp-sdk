...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstancesByPerformanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBInstancesByPerformanceResponseBody) };
    inline DescribeDBInstancesByPerformanceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBInstancesByPerformanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBInstancesByPerformanceResponseBody> body_ {};
  };
