...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBInstanceEndpointAddressResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ModifyDBInstanceEndpointAddressResponseBodyData) };
    inline ModifyDBInstanceEndpointAddressResponseBodyData data() { DARABONBA_PTR_GET(data_, ModifyDBInstanceEndpointAddressResponseBodyData) };
    inline ModifyDBInstanceEndpointAddressResponseBody& setData(const ModifyDBInstanceEndpointAddressResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyDBInstanceEndpointAddressResponseBody& setData(ModifyDBInstanceEndpointAddressResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<ModifyDBInstanceEndpointAddressResponseBodyData> data_ = nullptr;
