...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->configDBProxyService_ == nullptr
        && this->DBInstanceId_ == nullptr && this->DBProxyEngineType_ == nullptr && this->DBProxyInstanceNum_ == nullptr && this->DBProxyInstanceType_ == nullptr && this->DBProxyNodesShrink_ == nullptr
