...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backupJobId_ == nullptr
        && this->backupJobStatus_ == nullptr && this->backupMode_ == nullptr && this->clientToken_ == nullptr && this->DBInstanceId_ == nullptr && this->flag_ == nullptr
    ...
    inline int32_t getBackupJobId() const { DARABONBA_PTR_GET_DEFAULT(backupJobId_, 0) };
    ...
    inline string getBackupJobStatus() const { DARABONBA_PTR_GET_DEFAULT(backupJobStatus_, "") };
