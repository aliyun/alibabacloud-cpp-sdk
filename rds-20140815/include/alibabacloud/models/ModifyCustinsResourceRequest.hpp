...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->adjustDeadline_ == nullptr
        && this->DBInstanceId_ == nullptr && this->increaseRatio_ == nullptr && this->resourceOwnerId_ == nullptr && this->resourceType_ == nullptr && this->restoreOriginalSpecification_ == nullptr
    ...
    inline string getAdjustDeadline() const { DARABONBA_PTR_GET_DEFAULT(adjustDeadline_, "") };
    ...
    inline string getIncreaseRatio() const { DARABONBA_PTR_GET_DEFAULT(increaseRatio_, "") };
    ...
    inline string getRestoreOriginalSpecification() const { DARABONBA_PTR_GET_DEFAULT(restoreOriginalSpecification_, "") };
