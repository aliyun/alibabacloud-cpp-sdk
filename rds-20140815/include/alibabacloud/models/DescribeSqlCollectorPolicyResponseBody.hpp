...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->SQLCollectorStatus_ == nullptr && return this->storagePeriod_ == nullptr; };
    ...
    inline int32_t storagePeriod() const { DARABONBA_PTR_GET_DEFAULT(storagePeriod_, 0) };
  ...
  protected:
    ...
    std::shared_ptr<int32_t> storagePeriod_ = nullptr;
  };
