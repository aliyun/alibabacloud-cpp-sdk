...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->collation_ == nullptr
        && return this->DBInstanceId_ == nullptr && return this->ownerId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->timezone_ == nullptr; };
