...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountName_ == nullptr
        && this->clientToken_ == nullptr && this->DBInstanceId_ == nullptr && this->DBNames_ == nullptr && this->extensions_ == nullptr && this->ownerAccount_ == nullptr
        && this->ownerId_ == nullptr && this->resourceGroupId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->riskConfirmed_ == nullptr
        && this->sourceDatabase_ == nullptr; };
    ...
    inline bool getRiskConfirmed() const { DARABONBA_PTR_GET_DEFAULT(riskConfirmed_, false) };
    ...
    inline string getSourceDatabase() const { DARABONBA_PTR_GET_DEFAULT(sourceDatabase_, "") };
  ...
  protected:
    ...
    shared_ptr<bool> riskConfirmed_ {};
    ...
    shared_ptr<string> sourceDatabase_ {};
  };
