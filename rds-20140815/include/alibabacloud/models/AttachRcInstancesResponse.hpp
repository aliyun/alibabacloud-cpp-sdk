...
namespace Models
{
  ...
  public:
    ...
    inline const AttachRCInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachRCInstancesResponseBody) };
    inline AttachRCInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachRCInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachRCInstancesResponseBody> body_ {};
  };
