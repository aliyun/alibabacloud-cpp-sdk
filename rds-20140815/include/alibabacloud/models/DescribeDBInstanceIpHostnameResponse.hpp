...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceIpHostnameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBInstanceIpHostnameResponseBody) };
    inline DescribeDBInstanceIpHostnameResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBInstanceIpHostnameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBInstanceIpHostnameResponseBody> body_ {};
  };
