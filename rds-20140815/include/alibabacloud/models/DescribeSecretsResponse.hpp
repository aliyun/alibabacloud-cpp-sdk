...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecretsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSecretsResponseBody) };
    inline DescribeSecretsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSecretsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSecretsResponseBody> body_ = nullptr;
  };
