...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeRCSecurityGroupListResponseBodyRCSecurityGroups> & RCSecurityGroups() const { DARABONBA_PTR_GET_CONST(RCSecurityGroups_, vector<DescribeRCSecurityGroupListResponseBodyRCSecurityGroups>) };
    inline vector<DescribeRCSecurityGroupListResponseBodyRCSecurityGroups> RCSecurityGroups() { DARABONBA_PTR_GET(RCSecurityGroups_, vector<DescribeRCSecurityGroupListResponseBodyRCSecurityGroups>) };
    inline DescribeRCSecurityGroupListResponseBody& setRCSecurityGroups(const vector<DescribeRCSecurityGroupListResponseBodyRCSecurityGroups> & RCSecurityGroups) { DARABONBA_PTR_SET_VALUE(RCSecurityGroups_, RCSecurityGroups) };
    inline DescribeRCSecurityGroupListResponseBody& setRCSecurityGroups(vector<DescribeRCSecurityGroupListResponseBodyRCSecurityGroups> && RCSecurityGroups) { DARABONBA_PTR_SET_RVALUE(RCSecurityGroups_, RCSecurityGroups) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeRCSecurityGroupListResponseBodyRCSecurityGroups>> RCSecurityGroups_ = nullptr;
