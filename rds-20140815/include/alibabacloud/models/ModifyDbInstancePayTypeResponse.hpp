...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBInstancePayTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBInstancePayTypeResponseBody) };
    inline ModifyDBInstancePayTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBInstancePayTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBInstancePayTypeResponseBody> body_ {};
  };
