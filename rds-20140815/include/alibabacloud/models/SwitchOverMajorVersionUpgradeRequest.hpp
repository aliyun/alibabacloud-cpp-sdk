...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->DBInstanceName_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->regionId_.empty() && this->resourceGroupId_ == nullptr
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->switchoverTimeout_ == nullptr && this->type_ == nullptr; };
    ...
    inline int32_t getSwitchoverTimeout() const { DARABONBA_PTR_GET_DEFAULT(switchoverTimeout_, 0) };
