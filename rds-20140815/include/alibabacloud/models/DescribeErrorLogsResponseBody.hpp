...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeErrorLogsResponseBodyItems & items() const { DARABONBA_PTR_GET_CONST(items_, DescribeErrorLogsResponseBodyItems) };
    inline DescribeErrorLogsResponseBodyItems items() { DARABONBA_PTR_GET(items_, DescribeErrorLogsResponseBodyItems) };
    inline DescribeErrorLogsResponseBody& setItems(const DescribeErrorLogsResponseBodyItems & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeErrorLogsResponseBody& setItems(DescribeErrorLogsResponseBodyItems && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeErrorLogsResponseBodyItems> items_ = nullptr;
    // The page number.
