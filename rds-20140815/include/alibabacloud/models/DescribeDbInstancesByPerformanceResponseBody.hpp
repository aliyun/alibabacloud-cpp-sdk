...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstancesByPerformanceResponseBodyItems & items() const { DARABONBA_PTR_GET_CONST(items_, DescribeDBInstancesByPerformanceResponseBodyItems) };
    inline DescribeDBInstancesByPerformanceResponseBodyItems items() { DARABONBA_PTR_GET(items_, DescribeDBInstancesByPerformanceResponseBodyItems) };
    inline DescribeDBInstancesByPerformanceResponseBody& setItems(const DescribeDBInstancesByPerformanceResponseBodyItems & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeDBInstancesByPerformanceResponseBody& setItems(DescribeDBInstancesByPerformanceResponseBodyItems && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDBInstancesByPerformanceResponseBodyItems> items_ = nullptr;
