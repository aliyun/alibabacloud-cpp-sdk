...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceName_ == nullptr
        ...
        && this->regionId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->ruleConfig_ == nullptr && this->ruleName_ == nullptr; };
    ...
    inline const ModifyMaskingRulesRequest::RuleConfig & getRuleConfig() const { DARABONBA_PTR_GET_CONST(ruleConfig_, ModifyMaskingRulesRequest::RuleConfig) };
    inline ModifyMaskingRulesRequest::RuleConfig getRuleConfig() { DARABONBA_PTR_GET(ruleConfig_, ModifyMaskingRulesRequest::RuleConfig) };
    inline ModifyMaskingRulesRequest& setRuleConfig(const ModifyMaskingRulesRequest::RuleConfig & ruleConfig) { DARABONBA_PTR_SET_VALUE(ruleConfig_, ruleConfig) };
    inline ModifyMaskingRulesRequest& setRuleConfig(ModifyMaskingRulesRequest::RuleConfig && ruleConfig) { DARABONBA_PTR_SET_RVALUE(ruleConfig_, ruleConfig) };
