...
namespace Models
{
  ...
  public:
    ...
    inline const CreateReplicationLinkResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateReplicationLinkResponseBody) };
    inline CreateReplicationLinkResponseBody body() { DARABONBA_PTR_GET(body_, CreateReplicationLinkResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateReplicationLinkResponseBody> body_ = nullptr;
  };
