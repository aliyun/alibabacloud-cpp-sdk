...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterId_ == nullptr
        && return this->regionId_ == nullptr && return this->supportDiskPerformanceLevelShrink_ == nullptr; };
    ...
    inline string supportDiskPerformanceLevelShrink() const { DARABONBA_PTR_GET_DEFAULT(supportDiskPerformanceLevelShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> supportDiskPerformanceLevelShrink_ = nullptr;
  };
