...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->archiveBackupKeepCount_ == nullptr
        && this->archiveBackupKeepPolicy_ == nullptr && this->archiveBackupRetentionPeriod_ == nullptr && this->backupInterval_ == nullptr && this->backupLog_ == nullptr && this->backupMethod_ == nullptr
        && this->backupPriority_ == nullptr && this->backupRetentionPeriod_ == nullptr && this->category_ == nullptr && this->compressType_ == nullptr && this->enableBackupLog_ == nullptr
        && this->enableIncrementDataBackup_ == nullptr && this->enablePitrProtection_ == nullptr && this->highSpaceUsageProtection_ == nullptr && this->localLogRetentionHours_ == nullptr && this->localLogRetentionSpace_ == nullptr
        && this->logBackupFrequency_ == nullptr && this->logBackupLocalRetentionNumber_ == nullptr && this->logBackupRetentionPeriod_ == nullptr && this->pitrRetentionPeriod_ == nullptr && this->preferredBackupPeriod_ == nullptr
        && this->preferredBackupTime_ == nullptr && this->preferredNextBackupTime_ == nullptr && this->releasedKeepPolicy_ == nullptr && this->requestId_ == nullptr && this->supportModifyBackupPriority_ == nullptr
        && this->supportReleasedKeep_ == nullptr && this->supportVolumeShadowCopy_ == nullptr && this->supportsHighFrequencyBackup_ == nullptr; };
