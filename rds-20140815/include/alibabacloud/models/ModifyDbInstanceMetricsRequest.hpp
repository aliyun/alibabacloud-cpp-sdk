...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceName_ == nullptr
        && return this->metricsConfig_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->scope_ == nullptr; };
    ...
    inline string metricsConfig() const { DARABONBA_PTR_GET_DEFAULT(metricsConfig_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> metricsConfig_ = nullptr;
