...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAccountMaskingPrivilegeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyAccountMaskingPrivilegeResponseBody) };
    inline ModifyAccountMaskingPrivilegeResponseBody body() { DARABONBA_PTR_GET(body_, ModifyAccountMaskingPrivilegeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyAccountMaskingPrivilegeResponseBody> body_ = nullptr;
  };
