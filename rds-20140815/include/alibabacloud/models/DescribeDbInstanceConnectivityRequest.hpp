...
namespace Models
{
  ...
  public:
    ...
    inline DescribeDBInstanceConnectivityRequest& setDbInstanceName(string dbInstanceName) { DARABONBA_PTR_SET_VALUE(dbInstanceName_, dbInstanceName) };
    ...
    inline DescribeDBInstanceConnectivityRequest& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline DescribeDBInstanceConnectivityRequest& setSourceIpAddress(string sourceIpAddress) { DARABONBA_PTR_SET_VALUE(sourceIpAddress_, sourceIpAddress) };
