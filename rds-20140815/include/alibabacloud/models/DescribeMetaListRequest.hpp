...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backupSetID_ == nullptr
        && return this->clientToken_ == nullptr && return this->DBInstanceId_ == nullptr && return this->getDbName_ == nullptr && return this->ownerId_ == nullptr && return this->pageIndex_ == nullptr
        && return this->pageSize_ == nullptr && return this->pattern_ == nullptr && return this->resourceGroupId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr
        && return this->restoreTime_ == nullptr && return this->restoreType_ == nullptr; };
    ...
    inline string getDbName() const { DARABONBA_PTR_GET_DEFAULT(getDbName_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> getDbName_ = nullptr;
