...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyParameterGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyParameterGroupResponseBody) };
    inline ModifyParameterGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyParameterGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyParameterGroupResponseBody> body_ {};
  };
