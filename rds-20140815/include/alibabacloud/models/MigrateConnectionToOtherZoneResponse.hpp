...
namespace Models
{
  ...
  public:
    ...
    inline const MigrateConnectionToOtherZoneResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MigrateConnectionToOtherZoneResponseBody) };
    inline MigrateConnectionToOtherZoneResponseBody getBody() { DARABONBA_PTR_GET(body_, MigrateConnectionToOtherZoneResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MigrateConnectionToOtherZoneResponseBody> body_ {};
  };
