...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAccountMaskingPrivilegeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeAccountMaskingPrivilegeResponseBody) };
    inline DescribeAccountMaskingPrivilegeResponseBody body() { DARABONBA_PTR_GET(body_, DescribeAccountMaskingPrivilegeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAccountMaskingPrivilegeResponseBody> body_ = nullptr;
  };
