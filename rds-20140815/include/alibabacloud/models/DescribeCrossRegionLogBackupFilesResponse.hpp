...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCrossRegionLogBackupFilesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCrossRegionLogBackupFilesResponseBody) };
    inline DescribeCrossRegionLogBackupFilesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCrossRegionLogBackupFilesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCrossRegionLogBackupFilesResponseBody> body_ {};
  };
