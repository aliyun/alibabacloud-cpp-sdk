...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceNetInfoForChannelResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBInstanceNetInfoForChannelResponseBody) };
    inline DescribeDBInstanceNetInfoForChannelResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDBInstanceNetInfoForChannelResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDBInstanceNetInfoForChannelResponseBody> body_ = nullptr;
  };
