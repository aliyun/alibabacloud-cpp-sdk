...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAccountSecurityPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyAccountSecurityPolicyResponseBody) };
    inline ModifyAccountSecurityPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyAccountSecurityPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyAccountSecurityPolicyResponseBody> body_ {};
  };
