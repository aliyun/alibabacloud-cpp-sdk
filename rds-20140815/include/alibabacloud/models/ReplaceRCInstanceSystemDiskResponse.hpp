...
namespace Models
{
  ...
  public:
    ...
    inline const ReplaceRCInstanceSystemDiskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReplaceRCInstanceSystemDiskResponseBody) };
    inline ReplaceRCInstanceSystemDiskResponseBody getBody() { DARABONBA_PTR_GET(body_, ReplaceRCInstanceSystemDiskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReplaceRCInstanceSystemDiskResponseBody> body_ {};
  };
