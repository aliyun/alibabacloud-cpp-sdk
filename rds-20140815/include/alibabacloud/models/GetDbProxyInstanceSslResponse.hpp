...
namespace Models
{
  ...
  public:
    ...
    inline const GetDbProxyInstanceSslResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDbProxyInstanceSslResponseBody) };
    inline GetDbProxyInstanceSslResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDbProxyInstanceSslResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDbProxyInstanceSslResponseBody> body_ {};
  };
