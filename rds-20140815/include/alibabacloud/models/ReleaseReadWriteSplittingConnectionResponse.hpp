...
namespace Models
{
  ...
  public:
    ...
    inline const ReleaseReadWriteSplittingConnectionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ReleaseReadWriteSplittingConnectionResponseBody) };
    inline ReleaseReadWriteSplittingConnectionResponseBody body() { DARABONBA_PTR_GET(body_, ReleaseReadWriteSplittingConnectionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ReleaseReadWriteSplittingConnectionResponseBody> body_ = nullptr;
  };
