...
namespace Models
{
  ...
  public:
    ...
    inline DetachWhitelistTemplateToInstanceRequest& setInsName(string insName) { DARABONBA_PTR_SET_VALUE(insName_, insName) };
    ...
    inline DetachWhitelistTemplateToInstanceRequest& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline DetachWhitelistTemplateToInstanceRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline DetachWhitelistTemplateToInstanceRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline DetachWhitelistTemplateToInstanceRequest& setTemplateId(int32_t templateId) { DARABONBA_PTR_SET_VALUE(templateId_, templateId) };
