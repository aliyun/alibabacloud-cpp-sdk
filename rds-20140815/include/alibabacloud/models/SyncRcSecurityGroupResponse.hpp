...
namespace Models
{
  ...
  public:
    ...
    inline const SyncRCSecurityGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SyncRCSecurityGroupResponseBody) };
    inline SyncRCSecurityGroupResponseBody body() { DARABONBA_PTR_GET(body_, SyncRCSecurityGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SyncRCSecurityGroupResponseBody> body_ = nullptr;
  };
