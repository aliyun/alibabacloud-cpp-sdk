...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEAVAILABLEMETRICSRESPONSEBODYITEMS_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEAVAILABLEMETRICSRESPONSEBODYITEMS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeAvailableMetricsResponseBodyItems& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeAvailableMetricsResponseBodyItems& obj) { 
    ...
    DescribeAvailableMetricsResponseBodyItems() = default ;
    DescribeAvailableMetricsResponseBodyItems(const DescribeAvailableMetricsResponseBodyItems &) = default ;
    DescribeAvailableMetricsResponseBodyItems(DescribeAvailableMetricsResponseBodyItems &&) = default ;
    DescribeAvailableMetricsResponseBodyItems(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeAvailableMetricsResponseBodyItems() = default ;
    DescribeAvailableMetricsResponseBodyItems& operator=(const DescribeAvailableMetricsResponseBodyItems &) = default ;
    DescribeAvailableMetricsResponseBodyItems& operator=(DescribeAvailableMetricsResponseBodyItems &&) = default ;
    ...
    inline DescribeAvailableMetricsResponseBodyItems& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline DescribeAvailableMetricsResponseBodyItems& setDimension(string dimension) { DARABONBA_PTR_SET_VALUE(dimension_, dimension) };
    ...
    inline DescribeAvailableMetricsResponseBodyItems& setGroupKey(string groupKey) { DARABONBA_PTR_SET_VALUE(groupKey_, groupKey) };
    ...
    inline DescribeAvailableMetricsResponseBodyItems& setGroupKeyType(string groupKeyType) { DARABONBA_PTR_SET_VALUE(groupKeyType_, groupKeyType) };
    ...
    inline DescribeAvailableMetricsResponseBodyItems& setMethod(string method) { DARABONBA_PTR_SET_VALUE(method_, method) };
    ...
    inline DescribeAvailableMetricsResponseBodyItems& setMetricsKey(string metricsKey) { DARABONBA_PTR_SET_VALUE(metricsKey_, metricsKey) };
    ...
    inline DescribeAvailableMetricsResponseBodyItems& setMetricsKeyAlias(string metricsKeyAlias) { DARABONBA_PTR_SET_VALUE(metricsKeyAlias_, metricsKeyAlias) };
    ...
    inline DescribeAvailableMetricsResponseBodyItems& setSortRule(int32_t sortRule) { DARABONBA_PTR_SET_VALUE(sortRule_, sortRule) };
    ...
    inline DescribeAvailableMetricsResponseBodyItems& setUnit(string unit) { DARABONBA_PTR_SET_VALUE(unit_, unit) };
