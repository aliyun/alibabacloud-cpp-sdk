...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBInstanceEndpointResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ModifyDBInstanceEndpointResponseBody::Data) };
    inline ModifyDBInstanceEndpointResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ModifyDBInstanceEndpointResponseBody::Data) };
    inline ModifyDBInstanceEndpointResponseBody& setData(const ModifyDBInstanceEndpointResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyDBInstanceEndpointResponseBody& setData(ModifyDBInstanceEndpointResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
