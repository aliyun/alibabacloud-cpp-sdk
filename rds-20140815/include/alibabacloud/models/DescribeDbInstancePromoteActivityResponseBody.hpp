...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aliUid_ == nullptr
        && this->bid_ == nullptr && this->DBInstanceId_ == nullptr && this->DBInstanceName_ == nullptr && this->DBType_ == nullptr && this->isActivity_ == nullptr
    ...
    inline string getIsActivity() const { DARABONBA_PTR_GET_DEFAULT(isActivity_, "") };
