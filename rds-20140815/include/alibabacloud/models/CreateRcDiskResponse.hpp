...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRCDiskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateRCDiskResponseBody) };
    inline CreateRCDiskResponseBody body() { DARABONBA_PTR_GET(body_, CreateRCDiskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateRCDiskResponseBody> body_ = nullptr;
  };
