...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMigrateTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateMigrateTaskResponseBody) };
    inline CreateMigrateTaskResponseBody body() { DARABONBA_PTR_GET(body_, CreateMigrateTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateMigrateTaskResponseBody> body_ = nullptr;
  };
