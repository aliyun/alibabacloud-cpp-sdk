...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->certificate_ == nullptr
        && this->DBInstanceId_ == nullptr && this->DBName_ == nullptr && this->encryptionKey_ == nullptr && this->isRotate_ == nullptr && this->ownerAccount_ == nullptr
        && this->ownerId_ == nullptr && this->passWord_ == nullptr && this->privateKey_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr
        && this->roleArn_ == nullptr && this->TDEStatus_ == nullptr; };
