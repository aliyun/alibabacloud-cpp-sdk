...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyWhitelistTemplateResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ModifyWhitelistTemplateResponseBodyData) };
    inline ModifyWhitelistTemplateResponseBodyData data() { DARABONBA_PTR_GET(data_, ModifyWhitelistTemplateResponseBodyData) };
    inline ModifyWhitelistTemplateResponseBody& setData(const ModifyWhitelistTemplateResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyWhitelistTemplateResponseBody& setData(ModifyWhitelistTemplateResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<ModifyWhitelistTemplateResponseBodyData> data_ = nullptr;
