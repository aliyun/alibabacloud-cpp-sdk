...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSupportOnlineResizeDiskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSupportOnlineResizeDiskResponseBody) };
    inline DescribeSupportOnlineResizeDiskResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSupportOnlineResizeDiskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSupportOnlineResizeDiskResponseBody> body_ {};
  };
