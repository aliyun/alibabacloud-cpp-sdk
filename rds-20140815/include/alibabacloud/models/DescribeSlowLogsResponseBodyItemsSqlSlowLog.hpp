...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->avgExecutionTime_ == nullptr
        && return this->avgIOWriteCounts_ == nullptr && return this->avgLastRowsAffectedCounts_ == nullptr && return this->avgLogicalReadCounts_ == nullptr && return this->avgPhysicalReadCounts_ == nullptr && return this->avgRowsAffectedCounts_ == nullptr
        && return this->createTime_ == nullptr && return this->DBName_ == nullptr && return this->maxExecutionTime_ == nullptr && return this->maxExecutionTimeMS_ == nullptr && return this->maxIOWriteCounts_ == nullptr
        && return this->maxLastRowsAffectedCounts_ == nullptr && return this->maxLockTime_ == nullptr && return this->maxLockTimeMS_ == nullptr && return this->maxLogicalReadCounts_ == nullptr && return this->maxPhysicalReadCounts_ == nullptr
        && return this->maxRowsAffectedCounts_ == nullptr && return this->minIOWriteCounts_ == nullptr && return this->minLastRowsAffectedCounts_ == nullptr && return this->minLogicalReadCounts_ == nullptr && return this->minPhysicalReadCounts_ == nullptr
        && return this->minRowsAffectedCounts_ == nullptr && return this->mySQLTotalExecutionCounts_ == nullptr && return this->mySQLTotalExecutionTimes_ == nullptr && return this->parseMaxRowCount_ == nullptr && return this->parseTotalRowCounts_ == nullptr
        && return this->reportTime_ == nullptr && return this->returnMaxRowCount_ == nullptr && return this->returnTotalRowCounts_ == nullptr && return this->SQLHASH_ == nullptr && return this->SQLIdStr_ == nullptr
        && return this->SQLServerAvgCpuTime_ == nullptr && return this->SQLServerAvgExecutionTime_ == nullptr && return this->SQLServerMaxCpuTime_ == nullptr && return this->SQLServerMinCpuTime_ == nullptr && return this->SQLServerMinExecutionTime_ == nullptr
        && return this->SQLServerTotalCpuTime_ == nullptr && return this->SQLServerTotalExecutionCounts_ == nullptr && return this->SQLServerTotalExecutionTimes_ == nullptr && return this->SQLText_ == nullptr && return this->slowLogId_ == nullptr
        && return this->totalIOWriteCounts_ == nullptr && return this->totalLastRowsAffectedCounts_ == nullptr && return this->totalLockTimes_ == nullptr && return this->totalLogicalReadCounts_ == nullptr && return this->totalPhysicalReadCounts_ == nullptr
        && return this->totalRowsAffectedCounts_ == nullptr; };
    ...
    inline int64_t avgExecutionTime() const { DARABONBA_PTR_GET_DEFAULT(avgExecutionTime_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setAvgExecutionTime(int64_t avgExecutionTime) { DARABONBA_PTR_SET_VALUE(avgExecutionTime_, avgExecutionTime) };
    ...
    inline int64_t avgIOWriteCounts() const { DARABONBA_PTR_GET_DEFAULT(avgIOWriteCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setAvgIOWriteCounts(int64_t avgIOWriteCounts) { DARABONBA_PTR_SET_VALUE(avgIOWriteCounts_, avgIOWriteCounts) };
    ...
    inline int64_t avgLastRowsAffectedCounts() const { DARABONBA_PTR_GET_DEFAULT(avgLastRowsAffectedCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setAvgLastRowsAffectedCounts(int64_t avgLastRowsAffectedCounts) { DARABONBA_PTR_SET_VALUE(avgLastRowsAffectedCounts_, avgLastRowsAffectedCounts) };
    ...
    inline int64_t avgLogicalReadCounts() const { DARABONBA_PTR_GET_DEFAULT(avgLogicalReadCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setAvgLogicalReadCounts(int64_t avgLogicalReadCounts) { DARABONBA_PTR_SET_VALUE(avgLogicalReadCounts_, avgLogicalReadCounts) };
    ...
    inline int64_t avgPhysicalReadCounts() const { DARABONBA_PTR_GET_DEFAULT(avgPhysicalReadCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setAvgPhysicalReadCounts(int64_t avgPhysicalReadCounts) { DARABONBA_PTR_SET_VALUE(avgPhysicalReadCounts_, avgPhysicalReadCounts) };
    ...
    inline int64_t avgRowsAffectedCounts() const { DARABONBA_PTR_GET_DEFAULT(avgRowsAffectedCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setAvgRowsAffectedCounts(int64_t avgRowsAffectedCounts) { DARABONBA_PTR_SET_VALUE(avgRowsAffectedCounts_, avgRowsAffectedCounts) };
    ...
    inline int64_t maxExecutionTimeMS() const { DARABONBA_PTR_GET_DEFAULT(maxExecutionTimeMS_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setMaxExecutionTimeMS(int64_t maxExecutionTimeMS) { DARABONBA_PTR_SET_VALUE(maxExecutionTimeMS_, maxExecutionTimeMS) };
    ...
    inline int64_t maxIOWriteCounts() const { DARABONBA_PTR_GET_DEFAULT(maxIOWriteCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setMaxIOWriteCounts(int64_t maxIOWriteCounts) { DARABONBA_PTR_SET_VALUE(maxIOWriteCounts_, maxIOWriteCounts) };
    ...
    inline int64_t maxLastRowsAffectedCounts() const { DARABONBA_PTR_GET_DEFAULT(maxLastRowsAffectedCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setMaxLastRowsAffectedCounts(int64_t maxLastRowsAffectedCounts) { DARABONBA_PTR_SET_VALUE(maxLastRowsAffectedCounts_, maxLastRowsAffectedCounts) };
    ...
    inline int64_t maxLockTimeMS() const { DARABONBA_PTR_GET_DEFAULT(maxLockTimeMS_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setMaxLockTimeMS(int64_t maxLockTimeMS) { DARABONBA_PTR_SET_VALUE(maxLockTimeMS_, maxLockTimeMS) };
    ...
    inline int64_t maxLogicalReadCounts() const { DARABONBA_PTR_GET_DEFAULT(maxLogicalReadCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setMaxLogicalReadCounts(int64_t maxLogicalReadCounts) { DARABONBA_PTR_SET_VALUE(maxLogicalReadCounts_, maxLogicalReadCounts) };
    ...
    inline int64_t maxPhysicalReadCounts() const { DARABONBA_PTR_GET_DEFAULT(maxPhysicalReadCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setMaxPhysicalReadCounts(int64_t maxPhysicalReadCounts) { DARABONBA_PTR_SET_VALUE(maxPhysicalReadCounts_, maxPhysicalReadCounts) };
    ...
    inline int64_t maxRowsAffectedCounts() const { DARABONBA_PTR_GET_DEFAULT(maxRowsAffectedCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setMaxRowsAffectedCounts(int64_t maxRowsAffectedCounts) { DARABONBA_PTR_SET_VALUE(maxRowsAffectedCounts_, maxRowsAffectedCounts) };
    ...
    inline int64_t minIOWriteCounts() const { DARABONBA_PTR_GET_DEFAULT(minIOWriteCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setMinIOWriteCounts(int64_t minIOWriteCounts) { DARABONBA_PTR_SET_VALUE(minIOWriteCounts_, minIOWriteCounts) };
    ...
    inline int64_t minLastRowsAffectedCounts() const { DARABONBA_PTR_GET_DEFAULT(minLastRowsAffectedCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setMinLastRowsAffectedCounts(int64_t minLastRowsAffectedCounts) { DARABONBA_PTR_SET_VALUE(minLastRowsAffectedCounts_, minLastRowsAffectedCounts) };
    ...
    inline int64_t minLogicalReadCounts() const { DARABONBA_PTR_GET_DEFAULT(minLogicalReadCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setMinLogicalReadCounts(int64_t minLogicalReadCounts) { DARABONBA_PTR_SET_VALUE(minLogicalReadCounts_, minLogicalReadCounts) };
    ...
    inline int64_t minPhysicalReadCounts() const { DARABONBA_PTR_GET_DEFAULT(minPhysicalReadCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setMinPhysicalReadCounts(int64_t minPhysicalReadCounts) { DARABONBA_PTR_SET_VALUE(minPhysicalReadCounts_, minPhysicalReadCounts) };
    ...
    inline int64_t minRowsAffectedCounts() const { DARABONBA_PTR_GET_DEFAULT(minRowsAffectedCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setMinRowsAffectedCounts(int64_t minRowsAffectedCounts) { DARABONBA_PTR_SET_VALUE(minRowsAffectedCounts_, minRowsAffectedCounts) };
    ...
    inline int64_t mySQLTotalExecutionCounts() const { DARABONBA_PTR_GET_DEFAULT(mySQLTotalExecutionCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setMySQLTotalExecutionCounts(int64_t mySQLTotalExecutionCounts) { DARABONBA_PTR_SET_VALUE(mySQLTotalExecutionCounts_, mySQLTotalExecutionCounts) };
    ...
    inline int64_t mySQLTotalExecutionTimes() const { DARABONBA_PTR_GET_DEFAULT(mySQLTotalExecutionTimes_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setMySQLTotalExecutionTimes(int64_t mySQLTotalExecutionTimes) { DARABONBA_PTR_SET_VALUE(mySQLTotalExecutionTimes_, mySQLTotalExecutionTimes) };
    ...
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setReportTime(string reportTime) { DARABONBA_PTR_SET_VALUE(reportTime_, reportTime) };
    ...
    inline string SQLIdStr() const { DARABONBA_PTR_GET_DEFAULT(SQLIdStr_, "") };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setSQLIdStr(string SQLIdStr) { DARABONBA_PTR_SET_VALUE(SQLIdStr_, SQLIdStr) };
    ...
    inline int64_t SQLServerAvgCpuTime() const { DARABONBA_PTR_GET_DEFAULT(SQLServerAvgCpuTime_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setSQLServerAvgCpuTime(int64_t SQLServerAvgCpuTime) { DARABONBA_PTR_SET_VALUE(SQLServerAvgCpuTime_, SQLServerAvgCpuTime) };
    ...
    inline int64_t SQLServerAvgExecutionTime() const { DARABONBA_PTR_GET_DEFAULT(SQLServerAvgExecutionTime_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setSQLServerAvgExecutionTime(int64_t SQLServerAvgExecutionTime) { DARABONBA_PTR_SET_VALUE(SQLServerAvgExecutionTime_, SQLServerAvgExecutionTime) };
    ...
    inline int64_t SQLServerMaxCpuTime() const { DARABONBA_PTR_GET_DEFAULT(SQLServerMaxCpuTime_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setSQLServerMaxCpuTime(int64_t SQLServerMaxCpuTime) { DARABONBA_PTR_SET_VALUE(SQLServerMaxCpuTime_, SQLServerMaxCpuTime) };
    ...
    inline int64_t SQLServerMinCpuTime() const { DARABONBA_PTR_GET_DEFAULT(SQLServerMinCpuTime_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setSQLServerMinCpuTime(int64_t SQLServerMinCpuTime) { DARABONBA_PTR_SET_VALUE(SQLServerMinCpuTime_, SQLServerMinCpuTime) };
    ...
    inline int64_t SQLServerMinExecutionTime() const { DARABONBA_PTR_GET_DEFAULT(SQLServerMinExecutionTime_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setSQLServerMinExecutionTime(int64_t SQLServerMinExecutionTime) { DARABONBA_PTR_SET_VALUE(SQLServerMinExecutionTime_, SQLServerMinExecutionTime) };
    ...
    inline int64_t SQLServerTotalCpuTime() const { DARABONBA_PTR_GET_DEFAULT(SQLServerTotalCpuTime_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setSQLServerTotalCpuTime(int64_t SQLServerTotalCpuTime) { DARABONBA_PTR_SET_VALUE(SQLServerTotalCpuTime_, SQLServerTotalCpuTime) };
    ...
    inline int64_t SQLServerTotalExecutionCounts() const { DARABONBA_PTR_GET_DEFAULT(SQLServerTotalExecutionCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setSQLServerTotalExecutionCounts(int64_t SQLServerTotalExecutionCounts) { DARABONBA_PTR_SET_VALUE(SQLServerTotalExecutionCounts_, SQLServerTotalExecutionCounts) };
    ...
    inline int64_t SQLServerTotalExecutionTimes() const { DARABONBA_PTR_GET_DEFAULT(SQLServerTotalExecutionTimes_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setSQLServerTotalExecutionTimes(int64_t SQLServerTotalExecutionTimes) { DARABONBA_PTR_SET_VALUE(SQLServerTotalExecutionTimes_, SQLServerTotalExecutionTimes) };
    ...
    inline int64_t slowLogId() const { DARABONBA_PTR_GET_DEFAULT(slowLogId_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setSlowLogId(int64_t slowLogId) { DARABONBA_PTR_SET_VALUE(slowLogId_, slowLogId) };
    ...
    inline int64_t totalIOWriteCounts() const { DARABONBA_PTR_GET_DEFAULT(totalIOWriteCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setTotalIOWriteCounts(int64_t totalIOWriteCounts) { DARABONBA_PTR_SET_VALUE(totalIOWriteCounts_, totalIOWriteCounts) };
    ...
    inline int64_t totalLastRowsAffectedCounts() const { DARABONBA_PTR_GET_DEFAULT(totalLastRowsAffectedCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setTotalLastRowsAffectedCounts(int64_t totalLastRowsAffectedCounts) { DARABONBA_PTR_SET_VALUE(totalLastRowsAffectedCounts_, totalLastRowsAffectedCounts) };
    ...
    inline int64_t totalLogicalReadCounts() const { DARABONBA_PTR_GET_DEFAULT(totalLogicalReadCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setTotalLogicalReadCounts(int64_t totalLogicalReadCounts) { DARABONBA_PTR_SET_VALUE(totalLogicalReadCounts_, totalLogicalReadCounts) };
    ...
    inline int64_t totalPhysicalReadCounts() const { DARABONBA_PTR_GET_DEFAULT(totalPhysicalReadCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setTotalPhysicalReadCounts(int64_t totalPhysicalReadCounts) { DARABONBA_PTR_SET_VALUE(totalPhysicalReadCounts_, totalPhysicalReadCounts) };
    ...
    inline int64_t totalRowsAffectedCounts() const { DARABONBA_PTR_GET_DEFAULT(totalRowsAffectedCounts_, 0L) };
    inline DescribeSlowLogsResponseBodyItemsSQLSlowLog& setTotalRowsAffectedCounts(int64_t totalRowsAffectedCounts) { DARABONBA_PTR_SET_VALUE(totalRowsAffectedCounts_, totalRowsAffectedCounts) };
  ...
  protected:
    ...
    std::shared_ptr<int64_t> mySQLTotalExecutionCounts_ = nullptr;
    ...
    std::shared_ptr<int64_t> mySQLTotalExecutionTimes_ = nullptr;
    ...
    std::shared_ptr<int64_t> SQLServerTotalExecutionCounts_ = nullptr;
    ...
    std::shared_ptr<int64_t> SQLServerTotalExecutionTimes_ = nullptr;
