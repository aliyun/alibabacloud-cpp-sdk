...
namespace Models
{
  ...
  public:
    ...
    inline const RdsCustomInitResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RdsCustomInitResponseBody) };
    inline RdsCustomInitResponseBody getBody() { DARABONBA_PTR_GET(body_, RdsCustomInitResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RdsCustomInitResponseBody> body_ {};
  };
