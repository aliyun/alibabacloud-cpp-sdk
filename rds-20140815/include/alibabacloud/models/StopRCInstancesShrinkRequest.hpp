...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->batchOptimization_ == nullptr
        && this->forceStop_ == nullptr && this->instanceIdsShrink_ == nullptr && this->regionId_ == nullptr && this->stoppedMode_ == nullptr; };
    ...
    inline StopRCInstancesShrinkRequest& setStoppedMode(string stoppedMode) { DARABONBA_PTR_SET_VALUE(stoppedMode_, stoppedMode) };
