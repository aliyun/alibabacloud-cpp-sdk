...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstancePromoteActivityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBInstancePromoteActivityResponseBody) };
    inline DescribeDBInstancePromoteActivityResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBInstancePromoteActivityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBInstancePromoteActivityResponseBody> body_ {};
  };
