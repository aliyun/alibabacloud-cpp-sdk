...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePostgresExtensionsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreatePostgresExtensionsResponseBody) };
    inline CreatePostgresExtensionsResponseBody body() { DARABONBA_PTR_GET(body_, CreatePostgresExtensionsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreatePostgresExtensionsResponseBody> body_ = nullptr;
  };
