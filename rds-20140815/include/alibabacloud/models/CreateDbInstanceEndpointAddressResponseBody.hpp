...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDBInstanceEndpointAddressResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateDBInstanceEndpointAddressResponseBodyData) };
    inline CreateDBInstanceEndpointAddressResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateDBInstanceEndpointAddressResponseBodyData) };
    inline CreateDBInstanceEndpointAddressResponseBody& setData(const CreateDBInstanceEndpointAddressResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateDBInstanceEndpointAddressResponseBody& setData(CreateDBInstanceEndpointAddressResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<CreateDBInstanceEndpointAddressResponseBodyData> data_ = nullptr;
