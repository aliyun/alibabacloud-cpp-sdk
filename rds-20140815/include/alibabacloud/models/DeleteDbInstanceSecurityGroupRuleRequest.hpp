...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        ...
        && return this->resourceOwnerId_ == nullptr && return this->securityGroupRuleIds_ == nullptr; };
    ...
    inline string securityGroupRuleIds() const { DARABONBA_PTR_GET_DEFAULT(securityGroupRuleIds_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> securityGroupRuleIds_ = nullptr;
  };
