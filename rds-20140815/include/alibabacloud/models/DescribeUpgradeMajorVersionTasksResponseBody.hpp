...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeUpgradeMajorVersionTasksResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeUpgradeMajorVersionTasksResponseBodyItems>) };
    inline vector<DescribeUpgradeMajorVersionTasksResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeUpgradeMajorVersionTasksResponseBodyItems>) };
    inline DescribeUpgradeMajorVersionTasksResponseBody& setItems(const vector<DescribeUpgradeMajorVersionTasksResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeUpgradeMajorVersionTasksResponseBody& setItems(vector<DescribeUpgradeMajorVersionTasksResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeUpgradeMajorVersionTasksResponseBodyItems>> items_ = nullptr;
    // The page number.
