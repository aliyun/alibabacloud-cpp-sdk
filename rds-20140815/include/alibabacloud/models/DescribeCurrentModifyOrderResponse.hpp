...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCurrentModifyOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCurrentModifyOrderResponseBody) };
    inline DescribeCurrentModifyOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCurrentModifyOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCurrentModifyOrderResponseBody> body_ {};
  };
