...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHistoryEventsStatResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHistoryEventsStatResponseBody) };
    inline DescribeHistoryEventsStatResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHistoryEventsStatResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHistoryEventsStatResponseBody> body_ {};
  };
