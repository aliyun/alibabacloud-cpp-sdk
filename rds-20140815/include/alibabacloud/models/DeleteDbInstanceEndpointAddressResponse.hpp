...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDBInstanceEndpointAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDBInstanceEndpointAddressResponseBody) };
    inline DeleteDBInstanceEndpointAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDBInstanceEndpointAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDBInstanceEndpointAddressResponseBody> body_ {};
  };
