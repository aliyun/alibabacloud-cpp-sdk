...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->hasServiceLinkedRole_ == nullptr
        && this->registerUidSuccess_ == nullptr && this->requestId_ == nullptr && this->requireServiceLinkedRole_ == nullptr; };
    ...
    inline string getRequireServiceLinkedRole() const { DARABONBA_PTR_GET_DEFAULT(requireServiceLinkedRole_, "") };
