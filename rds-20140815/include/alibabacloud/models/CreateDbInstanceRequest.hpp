...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->amount_ == nullptr
        ...
        && return this->resourceOwnerId_ == nullptr && return this->roleARN_ == nullptr && return this->securityIPList_ == nullptr && return this->serverlessConfig_ == nullptr && return this->storageAutoScale_ == nullptr
    ...
    inline CreateDBInstanceRequest& setAmount(int32_t amount) { DARABONBA_PTR_SET_VALUE(amount_, amount) };
    ...
    inline CreateDBInstanceRequest& setAutoCreateProxy(bool autoCreateProxy) { DARABONBA_PTR_SET_VALUE(autoCreateProxy_, autoCreateProxy) };
    ...
    inline CreateDBInstanceRequest& setAutoPay(bool autoPay) { DARABONBA_PTR_SET_VALUE(autoPay_, autoPay) };
    ...
    inline CreateDBInstanceRequest& setAutoUseCoupon(bool autoUseCoupon) { DARABONBA_PTR_SET_VALUE(autoUseCoupon_, autoUseCoupon) };
    ...
    inline CreateDBInstanceRequest& setBabelfishConfig(string babelfishConfig) { DARABONBA_PTR_SET_VALUE(babelfishConfig_, babelfishConfig) };
    ...
    inline CreateDBInstanceRequest& setBpeEnabled(string bpeEnabled) { DARABONBA_PTR_SET_VALUE(bpeEnabled_, bpeEnabled) };
    ...
    inline CreateDBInstanceRequest& setBurstingEnabled(bool burstingEnabled) { DARABONBA_PTR_SET_VALUE(burstingEnabled_, burstingEnabled) };
    ...
    inline CreateDBInstanceRequest& setColdDataEnabled(bool coldDataEnabled) { DARABONBA_PTR_SET_VALUE(coldDataEnabled_, coldDataEnabled) };
    ...
    inline CreateDBInstanceRequest& setConnectionMode(string connectionMode) { DARABONBA_PTR_SET_VALUE(connectionMode_, connectionMode) };
    ...
    inline CreateDBInstanceRequest& setCreateStrategy(string createStrategy) { DARABONBA_PTR_SET_VALUE(createStrategy_, createStrategy) };
    ...
    inline CreateDBInstanceRequest& setCustomExtraInfo(string customExtraInfo) { DARABONBA_PTR_SET_VALUE(customExtraInfo_, customExtraInfo) };
    ...
    inline CreateDBInstanceRequest& setDBInstanceNetType(string DBInstanceNetType) { DARABONBA_PTR_SET_VALUE(DBInstanceNetType_, DBInstanceNetType) };
    ...
    inline CreateDBInstanceRequest& setDBInstanceStorageType(string DBInstanceStorageType) { DARABONBA_PTR_SET_VALUE(DBInstanceStorageType_, DBInstanceStorageType) };
    ...
    inline CreateDBInstanceRequest& setDBIsIgnoreCase(string DBIsIgnoreCase) { DARABONBA_PTR_SET_VALUE(DBIsIgnoreCase_, DBIsIgnoreCase) };
    ...
    inline CreateDBInstanceRequest& setDBParamGroupId(string DBParamGroupId) { DARABONBA_PTR_SET_VALUE(DBParamGroupId_, DBParamGroupId) };
    ...
    inline CreateDBInstanceRequest& setDedicatedHostGroupId(string dedicatedHostGroupId) { DARABONBA_PTR_SET_VALUE(dedicatedHostGroupId_, dedicatedHostGroupId) };
    ...
    inline CreateDBInstanceRequest& setDeletionProtection(bool deletionProtection) { DARABONBA_PTR_SET_VALUE(deletionProtection_, deletionProtection) };
    ...
    inline CreateDBInstanceRequest& setDryRun(bool dryRun) { DARABONBA_PTR_SET_VALUE(dryRun_, dryRun) };
    ...
    inline CreateDBInstanceRequest& setExternalReplication(bool externalReplication) { DARABONBA_PTR_SET_VALUE(externalReplication_, externalReplication) };
    ...
    inline CreateDBInstanceRequest& setIoAccelerationEnabled(string ioAccelerationEnabled) { DARABONBA_PTR_SET_VALUE(ioAccelerationEnabled_, ioAccelerationEnabled) };
    ...
    inline CreateDBInstanceRequest& setOptimizedWrites(string optimizedWrites) { DARABONBA_PTR_SET_VALUE(optimizedWrites_, optimizedWrites) };
    ...
    inline CreateDBInstanceRequest& setPort(string port) { DARABONBA_PTR_SET_VALUE(port_, port) };
    ...
    inline CreateDBInstanceRequest& setPromotionCode(string promotionCode) { DARABONBA_PTR_SET_VALUE(promotionCode_, promotionCode) };
    ...
    inline CreateDBInstanceRequest& setRoleARN(string roleARN) { DARABONBA_PTR_SET_VALUE(roleARN_, roleARN) };
    ...
    inline const CreateDBInstanceRequestServerlessConfig & serverlessConfig() const { DARABONBA_PTR_GET_CONST(serverlessConfig_, CreateDBInstanceRequestServerlessConfig) };
    inline CreateDBInstanceRequestServerlessConfig serverlessConfig() { DARABONBA_PTR_GET(serverlessConfig_, CreateDBInstanceRequestServerlessConfig) };
    inline CreateDBInstanceRequest& setServerlessConfig(const CreateDBInstanceRequestServerlessConfig & serverlessConfig) { DARABONBA_PTR_SET_VALUE(serverlessConfig_, serverlessConfig) };
    inline CreateDBInstanceRequest& setServerlessConfig(CreateDBInstanceRequestServerlessConfig && serverlessConfig) { DARABONBA_PTR_SET_RVALUE(serverlessConfig_, serverlessConfig) };
    ...
    inline CreateDBInstanceRequest& setStorageAutoScale(string storageAutoScale) { DARABONBA_PTR_SET_VALUE(storageAutoScale_, storageAutoScale) };
    ...
    inline CreateDBInstanceRequest& setStorageThreshold(int32_t storageThreshold) { DARABONBA_PTR_SET_VALUE(storageThreshold_, storageThreshold) };
    ...
    inline CreateDBInstanceRequest& setStorageUpperBound(int32_t storageUpperBound) { DARABONBA_PTR_SET_VALUE(storageUpperBound_, storageUpperBound) };
    ...
    inline CreateDBInstanceRequest& setSystemDBCharset(string systemDBCharset) { DARABONBA_PTR_SET_VALUE(systemDBCharset_, systemDBCharset) };
    ...
    inline CreateDBInstanceRequest& setTargetDedicatedHostIdForLog(string targetDedicatedHostIdForLog) { DARABONBA_PTR_SET_VALUE(targetDedicatedHostIdForLog_, targetDedicatedHostIdForLog) };
    ...
    inline CreateDBInstanceRequest& setTargetDedicatedHostIdForMaster(string targetDedicatedHostIdForMaster) { DARABONBA_PTR_SET_VALUE(targetDedicatedHostIdForMaster_, targetDedicatedHostIdForMaster) };
    ...
    inline CreateDBInstanceRequest& setTargetDedicatedHostIdForSlave(string targetDedicatedHostIdForSlave) { DARABONBA_PTR_SET_VALUE(targetDedicatedHostIdForSlave_, targetDedicatedHostIdForSlave) };
    ...
    inline CreateDBInstanceRequest& setTargetMinorVersion(string targetMinorVersion) { DARABONBA_PTR_SET_VALUE(targetMinorVersion_, targetMinorVersion) };
    ...
    inline CreateDBInstanceRequest& setUserBackupId(string userBackupId) { DARABONBA_PTR_SET_VALUE(userBackupId_, userBackupId) };
    ...
    inline CreateDBInstanceRequest& setWhitelistTemplateList(string whitelistTemplateList) { DARABONBA_PTR_SET_VALUE(whitelistTemplateList_, whitelistTemplateList) };
    ...
    inline CreateDBInstanceRequest& setZoneIdSlave1(string zoneIdSlave1) { DARABONBA_PTR_SET_VALUE(zoneIdSlave1_, zoneIdSlave1) };
    ...
    inline CreateDBInstanceRequest& setZoneIdSlave2(string zoneIdSlave2) { DARABONBA_PTR_SET_VALUE(zoneIdSlave2_, zoneIdSlave2) };
  ...
  protected:
    ...
    // 
    // >  ApsaraDB RDS for MariaDB does not support serverless instances.
    std::shared_ptr<CreateDBInstanceRequestServerlessConfig> serverlessConfig_ = nullptr;
