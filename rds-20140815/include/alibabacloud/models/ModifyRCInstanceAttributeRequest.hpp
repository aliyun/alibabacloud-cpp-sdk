...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->deletionProtection_ == nullptr
        && this->enableJumboFrame_ == nullptr && this->hostName_ == nullptr && this->instanceId_ == nullptr && this->instanceIds_ == nullptr && this->instanceName_ == nullptr
        && this->password_ == nullptr && this->reboot_ == nullptr && this->regionId_ == nullptr && this->securityGroupId_ == nullptr && this->securityGroupIds_ == nullptr; };
    ...
    inline ModifyRCInstanceAttributeRequest& setEnableJumboFrame(bool enableJumboFrame) { DARABONBA_PTR_SET_VALUE(enableJumboFrame_, enableJumboFrame) };
