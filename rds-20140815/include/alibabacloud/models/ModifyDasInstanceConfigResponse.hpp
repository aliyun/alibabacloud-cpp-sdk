...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDasInstanceConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDasInstanceConfigResponseBody) };
    inline ModifyDasInstanceConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDasInstanceConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDasInstanceConfigResponseBody> body_ {};
  };
