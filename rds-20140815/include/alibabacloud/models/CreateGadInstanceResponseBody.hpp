...
namespace Models
{
  ...
  public:
    ...
    inline const CreateGADInstanceResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, CreateGADInstanceResponseBodyResult) };
    inline CreateGADInstanceResponseBodyResult result() { DARABONBA_PTR_GET(result_, CreateGADInstanceResponseBodyResult) };
    inline CreateGADInstanceResponseBody& setResult(const CreateGADInstanceResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CreateGADInstanceResponseBody& setResult(CreateGADInstanceResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<CreateGADInstanceResponseBodyResult> result_ = nullptr;
  };
