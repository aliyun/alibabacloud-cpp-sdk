...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAccountMaskingPrivilegeResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeAccountMaskingPrivilegeResponseBodyData) };
    inline DescribeAccountMaskingPrivilegeResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeAccountMaskingPrivilegeResponseBodyData) };
    inline DescribeAccountMaskingPrivilegeResponseBody& setData(const DescribeAccountMaskingPrivilegeResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAccountMaskingPrivilegeResponseBody& setData(DescribeAccountMaskingPrivilegeResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeAccountMaskingPrivilegeResponseBodyData> data_ = nullptr;
