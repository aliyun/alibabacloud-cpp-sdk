...
namespace Models
{
  ...
  public:
    ...
    inline const AllocateInstancePublicConnectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AllocateInstancePublicConnectionResponseBody) };
    inline AllocateInstancePublicConnectionResponseBody getBody() { DARABONBA_PTR_GET(body_, AllocateInstancePublicConnectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AllocateInstancePublicConnectionResponseBody> body_ {};
  };
