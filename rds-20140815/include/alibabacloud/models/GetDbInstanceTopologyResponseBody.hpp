...
namespace Models
{
  ...
  public:
    ...
    inline const GetDBInstanceTopologyResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDBInstanceTopologyResponseBodyData) };
    inline GetDBInstanceTopologyResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDBInstanceTopologyResponseBodyData) };
    inline GetDBInstanceTopologyResponseBody& setData(const GetDBInstanceTopologyResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDBInstanceTopologyResponseBody& setData(GetDBInstanceTopologyResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDBInstanceTopologyResponseBodyData> data_ = nullptr;
    // An internal parameter. You can ignore this parameter.
