...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyRCInstanceVpcAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyRCInstanceVpcAttributeResponseBody) };
    inline ModifyRCInstanceVpcAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyRCInstanceVpcAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyRCInstanceVpcAttributeResponseBody> body_ {};
  };
