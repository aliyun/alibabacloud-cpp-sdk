...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRdsResourceSettingsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeRdsResourceSettingsResponseBody) };
    inline DescribeRdsResourceSettingsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeRdsResourceSettingsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeRdsResourceSettingsResponseBody> body_ = nullptr;
  };
