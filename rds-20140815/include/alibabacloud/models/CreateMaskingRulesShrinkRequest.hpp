...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceName_ == nullptr
        ...
        && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->ruleConfigShrink_ == nullptr && return this->ruleName_ == nullptr; };
    ...
    inline string ruleConfigShrink() const { DARABONBA_PTR_GET_DEFAULT(ruleConfigShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> ruleConfigShrink_ = nullptr;
    // This parameter is required.
