...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRCDeploymentSetsResponseBodyDeploymentSets & deploymentSets() const { DARABONBA_PTR_GET_CONST(deploymentSets_, DescribeRCDeploymentSetsResponseBodyDeploymentSets) };
    inline DescribeRCDeploymentSetsResponseBodyDeploymentSets deploymentSets() { DARABONBA_PTR_GET(deploymentSets_, DescribeRCDeploymentSetsResponseBodyDeploymentSets) };
    inline DescribeRCDeploymentSetsResponseBody& setDeploymentSets(const DescribeRCDeploymentSetsResponseBodyDeploymentSets & deploymentSets) { DARABONBA_PTR_SET_VALUE(deploymentSets_, deploymentSets) };
    inline DescribeRCDeploymentSetsResponseBody& setDeploymentSets(DescribeRCDeploymentSetsResponseBodyDeploymentSets && deploymentSets) { DARABONBA_PTR_SET_RVALUE(deploymentSets_, deploymentSets) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeRCDeploymentSetsResponseBodyDeploymentSets> deploymentSets_ = nullptr;
    // The page number.
