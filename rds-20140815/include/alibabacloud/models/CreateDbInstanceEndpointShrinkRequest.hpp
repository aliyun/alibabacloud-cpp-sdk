...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && return this->connectionStringPrefix_ == nullptr && return this->DBInstanceEndpointDescription_ == nullptr && return this->DBInstanceEndpointType_ == nullptr && return this->DBInstanceId_ == nullptr && return this->nodeItemsShrink_ == nullptr
    ...
    inline string nodeItemsShrink() const { DARABONBA_PTR_GET_DEFAULT(nodeItemsShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> nodeItemsShrink_ = nullptr;
