...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRCAvailableResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRCAvailableResourceResponseBody) };
    inline DescribeRCAvailableResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRCAvailableResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRCAvailableResourceResponseBody> body_ {};
  };
