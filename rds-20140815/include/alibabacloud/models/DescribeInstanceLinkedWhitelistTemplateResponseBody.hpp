...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceLinkedWhitelistTemplateResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeInstanceLinkedWhitelistTemplateResponseBodyData) };
    inline DescribeInstanceLinkedWhitelistTemplateResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeInstanceLinkedWhitelistTemplateResponseBodyData) };
    inline DescribeInstanceLinkedWhitelistTemplateResponseBody& setData(const DescribeInstanceLinkedWhitelistTemplateResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeInstanceLinkedWhitelistTemplateResponseBody& setData(DescribeInstanceLinkedWhitelistTemplateResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeInstanceLinkedWhitelistTemplateResponseBodyData> data_ = nullptr;
