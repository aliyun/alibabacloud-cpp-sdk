...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyHADiagnoseConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyHADiagnoseConfigResponseBody) };
    inline ModifyHADiagnoseConfigResponseBody body() { DARABONBA_PTR_GET(body_, ModifyHADiagnoseConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyHADiagnoseConfigResponseBody> body_ = nullptr;
  };
