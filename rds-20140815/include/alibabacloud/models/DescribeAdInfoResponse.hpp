...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeADInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeADInfoResponseBody) };
    inline DescribeADInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeADInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeADInfoResponseBody> body_ {};
  };
