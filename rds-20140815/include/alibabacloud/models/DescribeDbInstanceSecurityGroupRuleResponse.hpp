...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceSecurityGroupRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBInstanceSecurityGroupRuleResponseBody) };
    inline DescribeDBInstanceSecurityGroupRuleResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDBInstanceSecurityGroupRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDBInstanceSecurityGroupRuleResponseBody> body_ = nullptr;
  };
