...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOssDownloadsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeOssDownloadsResponseBody) };
    inline DescribeOssDownloadsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeOssDownloadsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeOssDownloadsResponseBody> body_ {};
  };
