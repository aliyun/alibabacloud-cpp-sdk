...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->confirmor_ == nullptr
        && return this->notifyIdList_ == nullptr; };
    ...
    inline const vector<int64_t> & notifyIdList() const { DARABONBA_PTR_GET_CONST(notifyIdList_, vector<int64_t>) };
    inline vector<int64_t> notifyIdList() { DARABONBA_PTR_GET(notifyIdList_, vector<int64_t>) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<vector<int64_t>> notifyIdList_ = nullptr;
  };
