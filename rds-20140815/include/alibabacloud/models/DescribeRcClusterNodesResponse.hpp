...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRCClusterNodesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeRCClusterNodesResponseBody) };
    inline DescribeRCClusterNodesResponseBody body() { DARABONBA_PTR_GET(body_, DescribeRCClusterNodesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeRCClusterNodesResponseBody> body_ = nullptr;
  };
