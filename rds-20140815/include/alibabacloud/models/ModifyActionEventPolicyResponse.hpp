...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyActionEventPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyActionEventPolicyResponseBody) };
    inline ModifyActionEventPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyActionEventPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyActionEventPolicyResponseBody> body_ {};
  };
