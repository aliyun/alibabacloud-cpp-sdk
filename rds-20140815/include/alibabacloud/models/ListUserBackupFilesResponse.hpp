...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserBackupFilesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListUserBackupFilesResponseBody) };
    inline ListUserBackupFilesResponseBody body() { DARABONBA_PTR_GET(body_, ListUserBackupFilesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListUserBackupFilesResponseBody> body_ = nullptr;
  };
