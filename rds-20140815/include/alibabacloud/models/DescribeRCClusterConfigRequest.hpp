...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->regionId_ == nullptr
        && this->temporaryDurationMinutes_ == nullptr && this->vpcId_ == nullptr; };
    ...
    inline int32_t getTemporaryDurationMinutes() const { DARABONBA_PTR_GET_DEFAULT(temporaryDurationMinutes_, 0) };
