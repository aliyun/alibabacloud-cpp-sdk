...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->confirmor_ == nullptr
        && return this->notifyIdListShrink_ == nullptr; };
    ...
    inline string notifyIdListShrink() const { DARABONBA_PTR_GET_DEFAULT(notifyIdListShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> notifyIdListShrink_ = nullptr;
  };
