  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->backupJobId_ == nullptr && this->backupProgressStatus_ == nullptr && this->backupStatus_ == nullptr && this->jobMode_ == nullptr && this->process_ == nullptr
        && this->taskAction_ == nullptr; };
        // backupId Field Functions 
        bool hasBackupId() const { return this->backupId_ != nullptr;};
        void deleteBackupId() { this->backupId_ = nullptr;};
        inline string getBackupId() const { DARABONBA_PTR_GET_DEFAULT(backupId_, "") };
        inline BackupJob& setBackupId(string backupId) { DARABONBA_PTR_SET_VALUE(backupId_, backupId) };
