...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->hasServiceLinkedRole_ == nullptr
        && return this->requestId_ == nullptr && return this->requireServiceLinkedRole_ == nullptr; };
    ...
    inline CheckServiceLinkedRoleResponseBody& setRequireServiceLinkedRole(string requireServiceLinkedRole) { DARABONBA_PTR_SET_VALUE(requireServiceLinkedRole_, requireServiceLinkedRole) };
