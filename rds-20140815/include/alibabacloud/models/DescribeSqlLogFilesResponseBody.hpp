...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSQLLogFilesResponseBodyItems & items() const { DARABONBA_PTR_GET_CONST(items_, DescribeSQLLogFilesResponseBodyItems) };
    inline DescribeSQLLogFilesResponseBodyItems items() { DARABONBA_PTR_GET(items_, DescribeSQLLogFilesResponseBodyItems) };
    inline DescribeSQLLogFilesResponseBody& setItems(const DescribeSQLLogFilesResponseBodyItems & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeSQLLogFilesResponseBody& setItems(DescribeSQLLogFilesResponseBodyItems && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSQLLogFilesResponseBodyItems> items_ = nullptr;
