  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->DBInstanceId_ == nullptr && this->DBInstanceType_ == nullptr && this->role_ == nullptr && this->weight_ == nullptr; };
            ...
            inline DBInstanceWeight& setRole(string role) { DARABONBA_PTR_SET_VALUE(role_, role) };
        ...
        && this->connectionString_ == nullptr && this->connectionStringType_ == nullptr && this->DBInstanceWeights_ == nullptr && this->distributionType_ == nullptr && this->expiredTime_ == nullptr
        && this->IPAddress_ == nullptr && this->IPType_ == nullptr && this->maxDelayTime_ == nullptr && this->PGBouncerPort_ == nullptr && this->port_ == nullptr
        && this->securityIPGroups_ == nullptr && this->upgradeable_ == nullptr && this->VPCId_ == nullptr && this->vSwitchId_ == nullptr; };
        ...
        inline DBInstanceNetInfo& setBabelfishPort(string babelfishPort) { DARABONBA_PTR_SET_VALUE(babelfishPort_, babelfishPort) };
        ...
        inline DBInstanceNetInfo& setPGBouncerPort(string PGBouncerPort) { DARABONBA_PTR_SET_VALUE(PGBouncerPort_, PGBouncerPort) };
    ...
    virtual bool empty() const override { return this->DBInstanceNetInfos_ == nullptr
        && this->instanceNetworkType_ == nullptr && this->requestId_ == nullptr && this->securityIPMode_ == nullptr; };
