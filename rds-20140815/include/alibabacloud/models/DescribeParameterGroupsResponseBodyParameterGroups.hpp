...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Models::DescribeParameterGroupsResponseBodyParameterGroupsParameterGroup> & parameterGroup() const { DARABONBA_PTR_GET_CONST(parameterGroup_, vector<Models::DescribeParameterGroupsResponseBodyParameterGroupsParameterGroup>) };
    inline vector<Models::DescribeParameterGroupsResponseBodyParameterGroupsParameterGroup> parameterGroup() { DARABONBA_PTR_GET(parameterGroup_, vector<Models::DescribeParameterGroupsResponseBodyParameterGroupsParameterGroup>) };
    inline DescribeParameterGroupsResponseBodyParameterGroups& setParameterGroup(const vector<Models::DescribeParameterGroupsResponseBodyParameterGroupsParameterGroup> & parameterGroup) { DARABONBA_PTR_SET_VALUE(parameterGroup_, parameterGroup) };
    inline DescribeParameterGroupsResponseBodyParameterGroups& setParameterGroup(vector<Models::DescribeParameterGroupsResponseBodyParameterGroupsParameterGroup> && parameterGroup) { DARABONBA_PTR_SET_RVALUE(parameterGroup_, parameterGroup) };


  protected:
    std::shared_ptr<vector<Models::DescribeParameterGroupsResponseBodyParameterGroupsParameterGroup>> parameterGroup_ = nullptr;
  };
