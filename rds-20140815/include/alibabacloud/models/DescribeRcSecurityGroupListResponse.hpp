...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRCSecurityGroupListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeRCSecurityGroupListResponseBody) };
    inline DescribeRCSecurityGroupListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeRCSecurityGroupListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeRCSecurityGroupListResponseBody> body_ = nullptr;
  };
