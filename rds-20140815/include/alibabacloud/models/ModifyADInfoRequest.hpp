...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ADAccountName_ == nullptr
        && this->ADDNS_ == nullptr && this->ADPassword_ == nullptr && this->ADServerIpAddress_ == nullptr && this->clientToken_ == nullptr && this->DBInstanceId_ == nullptr
    ...
    inline string getADAccountName() const { DARABONBA_PTR_GET_DEFAULT(ADAccountName_, "") };
