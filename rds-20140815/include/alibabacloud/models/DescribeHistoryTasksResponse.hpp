...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHistoryTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHistoryTasksResponseBody) };
    inline DescribeHistoryTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHistoryTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHistoryTasksResponseBody> body_ {};
  };
