...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECROSSREGIONBACKUPDBINSTANCERESPONSEBODYITEMSITEM_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECROSSREGIONBACKUPDBINSTANCERESPONSEBODYITEMSITEM_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& obj) { 
    ...
    DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem() = default ;
    DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem(const DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem &) = default ;
    DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem(DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem &&) = default ;
    DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem() = default ;
    DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& operator=(const DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem &) = default ;
    DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& operator=(DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem &&) = default ;
    ...
    virtual bool empty() const override { return this->backupEnabled_ == nullptr
        ...
        && return this->logBackupEnabledTime_ == nullptr && return this->retentType_ == nullptr && return this->retention_ == nullptr; };
    ...
    inline DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& setBackupEnabled(string backupEnabled) { DARABONBA_PTR_SET_VALUE(backupEnabled_, backupEnabled) };
    ...
    inline DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& setBackupEnabledTime(string backupEnabledTime) { DARABONBA_PTR_SET_VALUE(backupEnabledTime_, backupEnabledTime) };
    ...
    inline DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& setCrossBackupRegion(string crossBackupRegion) { DARABONBA_PTR_SET_VALUE(crossBackupRegion_, crossBackupRegion) };
    ...
    inline DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& setCrossBackupType(string crossBackupType) { DARABONBA_PTR_SET_VALUE(crossBackupType_, crossBackupType) };
    ...
    inline DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& setDBInstanceDescription(string DBInstanceDescription) { DARABONBA_PTR_SET_VALUE(DBInstanceDescription_, DBInstanceDescription) };
    ...
    inline DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& setDBInstanceId(string DBInstanceId) { DARABONBA_PTR_SET_VALUE(DBInstanceId_, DBInstanceId) };
    ...
    inline DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& setDBInstanceStatus(string DBInstanceStatus) { DARABONBA_PTR_SET_VALUE(DBInstanceStatus_, DBInstanceStatus) };
    ...
    inline DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& setEngine(string engine) { DARABONBA_PTR_SET_VALUE(engine_, engine) };
    ...
    inline DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& setEngineVersion(string engineVersion) { DARABONBA_PTR_SET_VALUE(engineVersion_, engineVersion) };
    ...
    inline DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& setLockMode(string lockMode) { DARABONBA_PTR_SET_VALUE(lockMode_, lockMode) };
    ...
    inline DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& setLogBackupEnabled(string logBackupEnabled) { DARABONBA_PTR_SET_VALUE(logBackupEnabled_, logBackupEnabled) };
    ...
    inline DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& setLogBackupEnabledTime(string logBackupEnabledTime) { DARABONBA_PTR_SET_VALUE(logBackupEnabledTime_, logBackupEnabledTime) };
    ...
    inline DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& setRetentType(int32_t retentType) { DARABONBA_PTR_SET_VALUE(retentType_, retentType) };
    ...
    inline DescribeCrossRegionBackupDBInstanceResponseBodyItemsItem& setRetention(int32_t retention) { DARABONBA_PTR_SET_VALUE(retention_, retention) };
