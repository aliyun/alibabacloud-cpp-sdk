...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstancesForCloneResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBInstancesForCloneResponseBody) };
    inline DescribeDBInstancesForCloneResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBInstancesForCloneResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBInstancesForCloneResponseBody> body_ {};
  };
