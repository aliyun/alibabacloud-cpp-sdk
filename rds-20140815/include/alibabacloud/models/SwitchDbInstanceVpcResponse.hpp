...
namespace Models
{
  ...
  public:
    ...
    inline const SwitchDBInstanceVpcResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SwitchDBInstanceVpcResponseBody) };
    inline SwitchDBInstanceVpcResponseBody getBody() { DARABONBA_PTR_GET(body_, SwitchDBInstanceVpcResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SwitchDBInstanceVpcResponseBody> body_ {};
  };
