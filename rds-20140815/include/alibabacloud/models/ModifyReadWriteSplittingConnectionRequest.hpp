...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->connectionStringPrefix_ == nullptr
        && return this->DBInstanceId_ == nullptr && return this->distributionType_ == nullptr && return this->maxDelayTime_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr
        && return this->port_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->weight_ == nullptr; };
