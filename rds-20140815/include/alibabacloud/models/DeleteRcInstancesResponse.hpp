...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRCInstancesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteRCInstancesResponseBody) };
    inline DeleteRCInstancesResponseBody body() { DARABONBA_PTR_GET(body_, DeleteRCInstancesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteRCInstancesResponseBody> body_ = nullptr;
  };
