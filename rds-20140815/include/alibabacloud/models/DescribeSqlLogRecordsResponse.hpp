...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSQLLogRecordsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSQLLogRecordsResponseBody) };
    inline DescribeSQLLogRecordsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSQLLogRecordsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSQLLogRecordsResponseBody> body_ = nullptr;
  };
