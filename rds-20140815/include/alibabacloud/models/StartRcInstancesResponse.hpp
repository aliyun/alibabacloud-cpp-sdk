...
namespace Models
{
  ...
  public:
    ...
    inline const StartRCInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartRCInstancesResponseBody) };
    inline StartRCInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, StartRCInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartRCInstancesResponseBody> body_ {};
  };
