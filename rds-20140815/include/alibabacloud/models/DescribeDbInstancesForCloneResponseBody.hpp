...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstancesForCloneResponseBodyItems & items() const { DARABONBA_PTR_GET_CONST(items_, DescribeDBInstancesForCloneResponseBodyItems) };
    inline DescribeDBInstancesForCloneResponseBodyItems items() { DARABONBA_PTR_GET(items_, DescribeDBInstancesForCloneResponseBodyItems) };
    inline DescribeDBInstancesForCloneResponseBody& setItems(const DescribeDBInstancesForCloneResponseBodyItems & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeDBInstancesForCloneResponseBody& setItems(DescribeDBInstancesForCloneResponseBodyItems && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDBInstancesForCloneResponseBodyItems> items_ = nullptr;
