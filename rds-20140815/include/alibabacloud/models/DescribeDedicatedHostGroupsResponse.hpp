...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDedicatedHostGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDedicatedHostGroupsResponseBody) };
    inline DescribeDedicatedHostGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDedicatedHostGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDedicatedHostGroupsResponseBody> body_ {};
  };
