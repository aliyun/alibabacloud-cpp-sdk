...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAllWhitelistTemplateResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeAllWhitelistTemplateResponseBodyData) };
    inline DescribeAllWhitelistTemplateResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeAllWhitelistTemplateResponseBodyData) };
    inline DescribeAllWhitelistTemplateResponseBody& setData(const DescribeAllWhitelistTemplateResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAllWhitelistTemplateResponseBody& setData(DescribeAllWhitelistTemplateResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeAllWhitelistTemplateResponseBodyData> data_ = nullptr;
