...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->modifyMode_ == nullptr
        && return this->ownerId_ == nullptr && return this->parameterGroupDesc_ == nullptr && return this->parameterGroupId_ == nullptr && return this->parameterGroupName_ == nullptr && return this->parameters_ == nullptr
