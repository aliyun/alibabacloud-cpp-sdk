...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourceDetailsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeResourceDetailsResponseBody) };
    inline DescribeResourceDetailsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeResourceDetailsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeResourceDetailsResponseBody> body_ {};
  };
