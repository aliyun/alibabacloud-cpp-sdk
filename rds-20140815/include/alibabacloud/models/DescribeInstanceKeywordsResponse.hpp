...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceKeywordsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceKeywordsResponseBody) };
    inline DescribeInstanceKeywordsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceKeywordsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceKeywordsResponseBody> body_ {};
  };
