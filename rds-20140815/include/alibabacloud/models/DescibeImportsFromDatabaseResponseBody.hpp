...
namespace Models
{
  ...
  public:
    ...
    inline const DescibeImportsFromDatabaseResponseBodyItems & items() const { DARABONBA_PTR_GET_CONST(items_, DescibeImportsFromDatabaseResponseBodyItems) };
    inline DescibeImportsFromDatabaseResponseBodyItems items() { DARABONBA_PTR_GET(items_, DescibeImportsFromDatabaseResponseBodyItems) };
    inline DescibeImportsFromDatabaseResponseBody& setItems(const DescibeImportsFromDatabaseResponseBodyItems & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescibeImportsFromDatabaseResponseBody& setItems(DescibeImportsFromDatabaseResponseBodyItems && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    // The migration tasks.
    std::shared_ptr<DescibeImportsFromDatabaseResponseBodyItems> items_ = nullptr;
    // The page number.
