  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->fileSize_ == nullptr && this->intranetDownloadLink_ == nullptr && this->linkExpiredTime_ == nullptr && this->logBeginTime_ == nullptr && this->logEndTime_ == nullptr; };
    ...
    inline const DescribeLogBackupFilesResponseBody::Items & getItems() const { DARABONBA_PTR_GET_CONST(items_, DescribeLogBackupFilesResponseBody::Items) };
    inline DescribeLogBackupFilesResponseBody::Items getItems() { DARABONBA_PTR_GET(items_, DescribeLogBackupFilesResponseBody::Items) };
    inline DescribeLogBackupFilesResponseBody& setItems(const DescribeLogBackupFilesResponseBody::Items & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeLogBackupFilesResponseBody& setItems(DescribeLogBackupFilesResponseBody::Items && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
