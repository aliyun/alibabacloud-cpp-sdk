...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSecretResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSecretResponseBody) };
    inline DeleteSecretResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSecretResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSecretResponseBody> body_ {};
  };
