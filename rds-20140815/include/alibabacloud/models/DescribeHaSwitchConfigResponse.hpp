...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHASwitchConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHASwitchConfigResponseBody) };
    inline DescribeHASwitchConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHASwitchConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHASwitchConfigResponseBody> body_ {};
  };
