...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->imageId_ == nullptr
        && this->instanceId_ == nullptr && this->isLocalDisk_ == nullptr && this->keyPairName_ == nullptr && this->password_ == nullptr && this->regionId_ == nullptr; };
    ...
    inline bool getIsLocalDisk() const { DARABONBA_PTR_GET_DEFAULT(isLocalDisk_, false) };
