...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ownerAccount_ == nullptr
        && this->ownerId_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->product_ == nullptr && this->regionId_ == nullptr
        && this->resourceGroupId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->securityToken_ == nullptr && this->vpcId_ == nullptr
    ...
    inline DescribeVpcsRequest& setProduct(string product) { DARABONBA_PTR_SET_VALUE(product_, product) };
    ...
    inline DescribeVpcsRequest& setSecurityToken(string securityToken) { DARABONBA_PTR_SET_VALUE(securityToken_, securityToken) };
    ...
    inline DescribeVpcsRequest& setZoneId(string zoneId) { DARABONBA_PTR_SET_VALUE(zoneId_, zoneId) };
