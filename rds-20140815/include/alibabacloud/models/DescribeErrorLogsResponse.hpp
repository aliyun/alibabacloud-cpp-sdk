...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeErrorLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeErrorLogsResponseBody) };
    inline DescribeErrorLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeErrorLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeErrorLogsResponseBody> body_ {};
  };
