...
namespace Models
{
  ...
  public:
    ...
    inline const DetachRCDiskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DetachRCDiskResponseBody) };
    inline DetachRCDiskResponseBody body() { DARABONBA_PTR_GET(body_, DetachRCDiskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DetachRCDiskResponseBody> body_ = nullptr;
  };
