...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeRCImageListResponseBodyImages> & images() const { DARABONBA_PTR_GET_CONST(images_, vector<DescribeRCImageListResponseBodyImages>) };
    inline vector<DescribeRCImageListResponseBodyImages> images() { DARABONBA_PTR_GET(images_, vector<DescribeRCImageListResponseBodyImages>) };
    inline DescribeRCImageListResponseBody& setImages(const vector<DescribeRCImageListResponseBodyImages> & images) { DARABONBA_PTR_SET_VALUE(images_, images) };
    inline DescribeRCImageListResponseBody& setImages(vector<DescribeRCImageListResponseBodyImages> && images) { DARABONBA_PTR_SET_RVALUE(images_, images) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeRCImageListResponseBodyImages>> images_ = nullptr;
    // The page number.
