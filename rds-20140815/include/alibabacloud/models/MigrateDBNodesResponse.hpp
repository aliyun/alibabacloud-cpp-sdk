...
namespace Models
{
  ...
  public:
    ...
    inline const MigrateDBNodesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MigrateDBNodesResponseBody) };
    inline MigrateDBNodesResponseBody getBody() { DARABONBA_PTR_GET(body_, MigrateDBNodesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MigrateDBNodesResponseBody> body_ {};
  };
