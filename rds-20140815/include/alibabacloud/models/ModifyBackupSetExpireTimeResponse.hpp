...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyBackupSetExpireTimeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyBackupSetExpireTimeResponseBody) };
    inline ModifyBackupSetExpireTimeResponseBody body() { DARABONBA_PTR_GET(body_, ModifyBackupSetExpireTimeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyBackupSetExpireTimeResponseBody> body_ = nullptr;
  };
