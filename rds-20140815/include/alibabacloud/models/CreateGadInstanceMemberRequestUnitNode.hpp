...
#ifndef ALIBABACLOUD_MODELS_CREATEGADINSTANCEMEMBERREQUESTUNITNODE_HPP_
#define ALIBABACLOUD_MODELS_CREATEGADINSTANCEMEMBERREQUESTUNITNODE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateGadInstanceMemberRequestUnitNode& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateGadInstanceMemberRequestUnitNode& obj) { 
    ...
    CreateGadInstanceMemberRequestUnitNode() = default ;
    CreateGadInstanceMemberRequestUnitNode(const CreateGadInstanceMemberRequestUnitNode &) = default ;
    CreateGadInstanceMemberRequestUnitNode(CreateGadInstanceMemberRequestUnitNode &&) = default ;
    CreateGadInstanceMemberRequestUnitNode(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateGadInstanceMemberRequestUnitNode() = default ;
    CreateGadInstanceMemberRequestUnitNode& operator=(const CreateGadInstanceMemberRequestUnitNode &) = default ;
    CreateGadInstanceMemberRequestUnitNode& operator=(CreateGadInstanceMemberRequestUnitNode &&) = default ;
    ...
    virtual bool empty() const override { return this->DBInstanceDescription_ == nullptr
        ...
        && return this->engine_ == nullptr && return this->engineVersion_ == nullptr && return this->regionID_ == nullptr && return this->securityIPList_ == nullptr && return this->vSwitchID_ == nullptr
        && return this->vpcID_ == nullptr && return this->zoneID_ == nullptr && return this->zoneIDSlave1_ == nullptr && return this->zoneIDSlave2_ == nullptr; };
    ...
    inline CreateGadInstanceMemberRequestUnitNode& setDBInstanceDescription(string DBInstanceDescription) { DARABONBA_PTR_SET_VALUE(DBInstanceDescription_, DBInstanceDescription) };
    ...
    inline CreateGadInstanceMemberRequestUnitNode& setDBInstanceStorage(int64_t DBInstanceStorage) { DARABONBA_PTR_SET_VALUE(DBInstanceStorage_, DBInstanceStorage) };
    ...
    inline CreateGadInstanceMemberRequestUnitNode& setDBInstanceStorageType(string DBInstanceStorageType) { DARABONBA_PTR_SET_VALUE(DBInstanceStorageType_, DBInstanceStorageType) };
    ...
    inline CreateGadInstanceMemberRequestUnitNode& setDbInstanceClass(string dbInstanceClass) { DARABONBA_PTR_SET_VALUE(dbInstanceClass_, dbInstanceClass) };
    ...
    inline CreateGadInstanceMemberRequestUnitNode& setDtsConflict(string dtsConflict) { DARABONBA_PTR_SET_VALUE(dtsConflict_, dtsConflict) };
    ...
    inline CreateGadInstanceMemberRequestUnitNode& setDtsInstanceClass(string dtsInstanceClass) { DARABONBA_PTR_SET_VALUE(dtsInstanceClass_, dtsInstanceClass) };
    ...
    inline CreateGadInstanceMemberRequestUnitNode& setEngine(string engine) { DARABONBA_PTR_SET_VALUE(engine_, engine) };
    ...
    inline CreateGadInstanceMemberRequestUnitNode& setEngineVersion(string engineVersion) { DARABONBA_PTR_SET_VALUE(engineVersion_, engineVersion) };
    ...
    inline CreateGadInstanceMemberRequestUnitNode& setRegionID(string regionID) { DARABONBA_PTR_SET_VALUE(regionID_, regionID) };
    ...
    inline CreateGadInstanceMemberRequestUnitNode& setSecurityIPList(string securityIPList) { DARABONBA_PTR_SET_VALUE(securityIPList_, securityIPList) };
    ...
    inline CreateGadInstanceMemberRequestUnitNode& setVSwitchID(string vSwitchID) { DARABONBA_PTR_SET_VALUE(vSwitchID_, vSwitchID) };
    ...
    inline CreateGadInstanceMemberRequestUnitNode& setVpcID(string vpcID) { DARABONBA_PTR_SET_VALUE(vpcID_, vpcID) };
    ...
    inline CreateGadInstanceMemberRequestUnitNode& setZoneID(string zoneID) { DARABONBA_PTR_SET_VALUE(zoneID_, zoneID) };
    ...
    inline CreateGadInstanceMemberRequestUnitNode& setZoneIDSlave1(string zoneIDSlave1) { DARABONBA_PTR_SET_VALUE(zoneIDSlave1_, zoneIDSlave1) };
    ...
    inline CreateGadInstanceMemberRequestUnitNode& setZoneIDSlave2(string zoneIDSlave2) { DARABONBA_PTR_SET_VALUE(zoneIDSlave2_, zoneIDSlave2) };
