...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceId_ == nullptr
        && return this->dedicatedHostGroupId_ == nullptr && return this->engine_ == nullptr && return this->engineVersion_ == nullptr && return this->minorVersionTag_ == nullptr && return this->nodeType_ == nullptr
        && return this->regionId_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->storageType_ == nullptr; };
    ...
    inline string minorVersionTag() const { DARABONBA_PTR_GET_DEFAULT(minorVersionTag_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> minorVersionTag_ = nullptr;
