...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceByTagsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBInstanceByTagsResponseBody) };
    inline DescribeDBInstanceByTagsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDBInstanceByTagsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDBInstanceByTagsResponseBody> body_ = nullptr;
  };
