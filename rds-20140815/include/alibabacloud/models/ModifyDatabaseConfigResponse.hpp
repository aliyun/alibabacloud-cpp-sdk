...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDatabaseConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyDatabaseConfigResponseBody) };
    inline ModifyDatabaseConfigResponseBody body() { DARABONBA_PTR_GET(body_, ModifyDatabaseConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyDatabaseConfigResponseBody> body_ = nullptr;
  };
