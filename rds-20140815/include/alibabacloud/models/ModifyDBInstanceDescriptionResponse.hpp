...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBInstanceDescriptionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBInstanceDescriptionResponseBody) };
    inline ModifyDBInstanceDescriptionResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBInstanceDescriptionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBInstanceDescriptionResponseBody> body_ {};
  };
