...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDBInstanceSecurityGroupRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDBInstanceSecurityGroupRuleResponseBody) };
    inline CreateDBInstanceSecurityGroupRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDBInstanceSecurityGroupRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDBInstanceSecurityGroupRuleResponseBody> body_ {};
  };
