...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeDBInstanceEngineVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeDBInstanceEngineVersionResponseBody) };
    inline UpgradeDBInstanceEngineVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeDBInstanceEngineVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeDBInstanceEngineVersionResponseBody> body_ {};
  };
