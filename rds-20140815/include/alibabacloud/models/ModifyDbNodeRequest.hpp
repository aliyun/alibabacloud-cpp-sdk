...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoPay_ == nullptr
        && return this->clientToken_ == nullptr && return this->DBInstanceId_ == nullptr && return this->DBInstanceStorage_ == nullptr && return this->DBInstanceStorageType_ == nullptr && return this->DBNode_ == nullptr
    ...
    inline const vector<ModifyDBNodeRequestDBNode> & DBNode() const { DARABONBA_PTR_GET_CONST(DBNode_, vector<ModifyDBNodeRequestDBNode>) };
    inline vector<ModifyDBNodeRequestDBNode> DBNode() { DARABONBA_PTR_GET(DBNode_, vector<ModifyDBNodeRequestDBNode>) };
    inline ModifyDBNodeRequest& setDBNode(const vector<ModifyDBNodeRequestDBNode> & DBNode) { DARABONBA_PTR_SET_VALUE(DBNode_, DBNode) };
    inline ModifyDBNodeRequest& setDBNode(vector<ModifyDBNodeRequestDBNode> && DBNode) { DARABONBA_PTR_SET_RVALUE(DBNode_, DBNode) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ModifyDBNodeRequestDBNode>> DBNode_ = nullptr;
