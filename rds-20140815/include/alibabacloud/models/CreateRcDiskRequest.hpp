...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoPay_ == nullptr
        && return this->autoRenew_ == nullptr && return this->description_ == nullptr && return this->diskCategory_ == nullptr && return this->diskName_ == nullptr && return this->instanceChargeType_ == nullptr
        && return this->instanceId_ == nullptr && return this->performanceLevel_ == nullptr && return this->period_ == nullptr && return this->periodUnit_ == nullptr && return this->regionId_ == nullptr
        && return this->resourceGroupId_ == nullptr && return this->size_ == nullptr && return this->snapshotId_ == nullptr && return this->tag_ == nullptr && return this->zoneId_ == nullptr; };
    ...
    inline const vector<CreateRCDiskRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateRCDiskRequestTag>) };
    inline vector<CreateRCDiskRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<CreateRCDiskRequestTag>) };
    inline CreateRCDiskRequest& setTag(const vector<CreateRCDiskRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateRCDiskRequest& setTag(vector<CreateRCDiskRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // The list of tags.
    std::shared_ptr<vector<CreateRCDiskRequestTag>> tag_ = nullptr;
    // The zone ID.
    // 
