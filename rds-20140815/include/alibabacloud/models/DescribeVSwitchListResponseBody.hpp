...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->availableIpAddressCount_ == nullptr
        && this->cidrBlock_ == nullptr && this->description_ == nullptr && this->gmtCreate_ == nullptr && this->isDefault_ == nullptr && this->izNo_ == nullptr
        && this->shareType_ == nullptr && this->status_ == nullptr && this->vSwitchId_ == nullptr && this->vSwitchName_ == nullptr; };
      ...
      inline VSwitches& setAvailableIpAddressCount(string availableIpAddressCount) { DARABONBA_PTR_SET_VALUE(availableIpAddressCount_, availableIpAddressCount) };
      ...
      inline VSwitches& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
      ...
      inline VSwitches& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
      ...
      inline VSwitches& setIsDefault(string isDefault) { DARABONBA_PTR_SET_VALUE(isDefault_, isDefault) };
      ...
      inline VSwitches& setIzNo(string izNo) { DARABONBA_PTR_SET_VALUE(izNo_, izNo) };
      ...
      inline VSwitches& setShareType(string shareType) { DARABONBA_PTR_SET_VALUE(shareType_, shareType) };
      ...
      inline VSwitches& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline const vector<DescribeVSwitchListResponseBody::VSwitches> & getVSwitches() const { DARABONBA_PTR_GET_CONST(vSwitches_, vector<DescribeVSwitchListResponseBody::VSwitches>) };
    inline vector<DescribeVSwitchListResponseBody::VSwitches> getVSwitches() { DARABONBA_PTR_GET(vSwitches_, vector<DescribeVSwitchListResponseBody::VSwitches>) };
    inline DescribeVSwitchListResponseBody& setVSwitches(const vector<DescribeVSwitchListResponseBody::VSwitches> & vSwitches) { DARABONBA_PTR_SET_VALUE(vSwitches_, vSwitches) };
    inline DescribeVSwitchListResponseBody& setVSwitches(vector<DescribeVSwitchListResponseBody::VSwitches> && vSwitches) { DARABONBA_PTR_SET_RVALUE(vSwitches_, vSwitches) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeVSwitchListResponseBody::VSwitches>> vSwitches_ {};
  };
