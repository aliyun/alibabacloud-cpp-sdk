...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeVSwitchListResponseBodyVSwitches> & vSwitches() const { DARABONBA_PTR_GET_CONST(vSwitches_, vector<DescribeVSwitchListResponseBodyVSwitches>) };
    inline vector<DescribeVSwitchListResponseBodyVSwitches> vSwitches() { DARABONBA_PTR_GET(vSwitches_, vector<DescribeVSwitchListResponseBodyVSwitches>) };
    inline DescribeVSwitchListResponseBody& setVSwitches(const vector<DescribeVSwitchListResponseBodyVSwitches> & vSwitches) { DARABONBA_PTR_SET_VALUE(vSwitches_, vSwitches) };
    inline DescribeVSwitchListResponseBody& setVSwitches(vector<DescribeVSwitchListResponseBodyVSwitches> && vSwitches) { DARABONBA_PTR_SET_RVALUE(vSwitches_, vSwitches) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeVSwitchListResponseBodyVSwitches>> vSwitches_ = nullptr;
  };
