...
namespace Models
{
  ...
  public:
    ...
    inline const ResizeRCInstanceDiskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResizeRCInstanceDiskResponseBody) };
    inline ResizeRCInstanceDiskResponseBody getBody() { DARABONBA_PTR_GET(body_, ResizeRCInstanceDiskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResizeRCInstanceDiskResponseBody> body_ {};
  };
