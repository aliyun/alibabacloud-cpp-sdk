...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceId_ == nullptr
        && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->RWAddressType_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr; };
    ...
    inline string getRWAddressType() const { DARABONBA_PTR_GET_DEFAULT(RWAddressType_, "") };
  ...
  protected:
    ...
    shared_ptr<string> RWAddressType_ {};
