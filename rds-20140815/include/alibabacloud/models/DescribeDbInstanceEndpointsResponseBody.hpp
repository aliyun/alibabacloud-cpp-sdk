...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceEndpointsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeDBInstanceEndpointsResponseBodyData) };
    inline DescribeDBInstanceEndpointsResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeDBInstanceEndpointsResponseBodyData) };
    inline DescribeDBInstanceEndpointsResponseBody& setData(const DescribeDBInstanceEndpointsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDBInstanceEndpointsResponseBody& setData(DescribeDBInstanceEndpointsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<DescribeDBInstanceEndpointsResponseBodyData> data_ = nullptr;
