...
namespace Models
{
  ...
  public:
    ...
    inline const DescibeImportsFromDatabaseResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescibeImportsFromDatabaseResponseBody) };
    inline DescibeImportsFromDatabaseResponseBody body() { DARABONBA_PTR_GET(body_, DescibeImportsFromDatabaseResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescibeImportsFromDatabaseResponseBody> body_ = nullptr;
  };
