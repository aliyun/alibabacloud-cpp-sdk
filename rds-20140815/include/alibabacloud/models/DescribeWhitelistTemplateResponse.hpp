...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWhitelistTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeWhitelistTemplateResponseBody) };
    inline DescribeWhitelistTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeWhitelistTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeWhitelistTemplateResponseBody> body_ {};
  };
