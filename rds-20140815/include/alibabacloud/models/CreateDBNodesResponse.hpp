...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDBNodesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDBNodesResponseBody) };
    inline CreateDBNodesResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDBNodesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDBNodesResponseBody> body_ {};
  };
