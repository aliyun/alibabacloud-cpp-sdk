...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteReplicationLinkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteReplicationLinkResponseBody) };
    inline DeleteReplicationLinkResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteReplicationLinkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteReplicationLinkResponseBody> body_ {};
  };
