...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->deploymentSetIds_ == nullptr
        && this->deploymentSetName_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->regionId_ == nullptr && this->strategy_ == nullptr
        && this->tag_ == nullptr; };
    ...
    inline string getDeploymentSetIds() const { DARABONBA_PTR_GET_DEFAULT(deploymentSetIds_, "") };
