...
namespace Models
{
  ...
  public:
    ...
    inline const CheckCreateDdrDBInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckCreateDdrDBInstanceResponseBody) };
    inline CheckCreateDdrDBInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckCreateDdrDBInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckCreateDdrDBInstanceResponseBody> body_ {};
  };
