...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSQLLogRecordsResponseBodyItems & items() const { DARABONBA_PTR_GET_CONST(items_, DescribeSQLLogRecordsResponseBodyItems) };
    inline DescribeSQLLogRecordsResponseBodyItems items() { DARABONBA_PTR_GET(items_, DescribeSQLLogRecordsResponseBodyItems) };
    inline DescribeSQLLogRecordsResponseBody& setItems(const DescribeSQLLogRecordsResponseBodyItems & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeSQLLogRecordsResponseBody& setItems(DescribeSQLLogRecordsResponseBodyItems && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSQLLogRecordsResponseBodyItems> items_ = nullptr;
