  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->DBName_ == nullptr && this->executeTime_ == nullptr && this->hostAddress_ == nullptr && this->returnRowCounts_ == nullptr && this->SQLText_ == nullptr
        && this->threadID_ == nullptr && this->totalExecutionTimes_ == nullptr; };
        ...
        inline SQLRecord& setSQLText(string SQLText) { DARABONBA_PTR_SET_VALUE(SQLText_, SQLText) };
    ...
    inline const DescribeSQLLogRecordsResponseBody::Items & getItems() const { DARABONBA_PTR_GET_CONST(items_, DescribeSQLLogRecordsResponseBody::Items) };
    inline DescribeSQLLogRecordsResponseBody::Items getItems() { DARABONBA_PTR_GET(items_, DescribeSQLLogRecordsResponseBody::Items) };
    inline DescribeSQLLogRecordsResponseBody& setItems(const DescribeSQLLogRecordsResponseBody::Items & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeSQLLogRecordsResponseBody& setItems(DescribeSQLLogRecordsResponseBody::Items && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
    ...
    inline DescribeSQLLogRecordsResponseBody& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline DescribeSQLLogRecordsResponseBody& setPageRecordCount(int32_t pageRecordCount) { DARABONBA_PTR_SET_VALUE(pageRecordCount_, pageRecordCount) };
    ...
    inline DescribeSQLLogRecordsResponseBody& setTotalRecordCount(int64_t totalRecordCount) { DARABONBA_PTR_SET_VALUE(totalRecordCount_, totalRecordCount) };
