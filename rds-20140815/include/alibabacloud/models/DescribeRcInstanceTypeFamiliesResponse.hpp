...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRCInstanceTypeFamiliesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRCInstanceTypeFamiliesResponseBody) };
    inline DescribeRCInstanceTypeFamiliesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRCInstanceTypeFamiliesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRCInstanceTypeFamiliesResponseBody> body_ {};
  };
