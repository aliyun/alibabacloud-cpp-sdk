...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBInstanceNetworkExpireTimeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBInstanceNetworkExpireTimeResponseBody) };
    inline ModifyDBInstanceNetworkExpireTimeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBInstanceNetworkExpireTimeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBInstanceNetworkExpireTimeResponseBody> body_ {};
  };
