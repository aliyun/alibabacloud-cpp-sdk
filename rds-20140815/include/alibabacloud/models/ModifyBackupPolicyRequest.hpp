...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->archiveBackupKeepCount_ == nullptr
        ...
        && this->backupPolicyMode_ == nullptr && this->backupPriority_ == nullptr && this->backupRetentionPeriod_ == nullptr && this->category_ == nullptr && this->compressType_ == nullptr
        && this->DBInstanceId_ == nullptr && this->enableBackupLog_ == nullptr && this->enableIncrementDataBackup_ == nullptr && this->highSpaceUsageProtection_ == nullptr && this->localLogRetentionHours_ == nullptr
        && this->localLogRetentionSpace_ == nullptr && this->logBackupFrequency_ == nullptr && this->logBackupLocalRetentionNumber_ == nullptr && this->logBackupRetentionPeriod_ == nullptr && this->ownerAccount_ == nullptr
        && this->ownerId_ == nullptr && this->preferredBackupPeriod_ == nullptr && this->preferredBackupTime_ == nullptr && this->releasedKeepPolicy_ == nullptr && this->resourceOwnerAccount_ == nullptr
