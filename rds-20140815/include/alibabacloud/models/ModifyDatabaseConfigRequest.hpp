...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceId_ == nullptr
        && return this->DBName_ == nullptr && return this->databasePropertyName_ == nullptr && return this->databasePropertyValue_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr
    ...
    inline string databasePropertyName() const { DARABONBA_PTR_GET_DEFAULT(databasePropertyName_, "") };
    ...
    inline string databasePropertyValue() const { DARABONBA_PTR_GET_DEFAULT(databasePropertyValue_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> databasePropertyName_ = nullptr;
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> databasePropertyValue_ = nullptr;
