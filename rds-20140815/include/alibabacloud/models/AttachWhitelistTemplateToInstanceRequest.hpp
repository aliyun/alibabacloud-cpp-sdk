...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->insName_ == nullptr
        && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->templateId_ == nullptr; };
    ...
    inline AttachWhitelistTemplateToInstanceRequest& setInsName(string insName) { DARABONBA_PTR_SET_VALUE(insName_, insName) };
    ...
    inline AttachWhitelistTemplateToInstanceRequest& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline AttachWhitelistTemplateToInstanceRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline AttachWhitelistTemplateToInstanceRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline AttachWhitelistTemplateToInstanceRequest& setTemplateId(int32_t templateId) { DARABONBA_PTR_SET_VALUE(templateId_, templateId) };
