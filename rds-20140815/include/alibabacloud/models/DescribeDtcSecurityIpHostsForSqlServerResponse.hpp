...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDTCSecurityIpHostsForSQLServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDTCSecurityIpHostsForSQLServerResponseBody) };
    inline DescribeDTCSecurityIpHostsForSQLServerResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDTCSecurityIpHostsForSQLServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDTCSecurityIpHostsForSQLServerResponseBody> body_ {};
  };
