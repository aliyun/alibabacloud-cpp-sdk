...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceIPArrayListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBInstanceIPArrayListResponseBody) };
    inline DescribeDBInstanceIPArrayListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBInstanceIPArrayListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBInstanceIPArrayListResponseBody> body_ {};
  };
