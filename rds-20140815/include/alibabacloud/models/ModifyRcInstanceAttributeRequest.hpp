...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->deletionProtection_ == nullptr
        && return this->hostName_ == nullptr && return this->instanceId_ == nullptr && return this->instanceIds_ == nullptr && return this->instanceName_ == nullptr && return this->password_ == nullptr
        && return this->reboot_ == nullptr && return this->regionId_ == nullptr && return this->securityGroupId_ == nullptr && return this->securityGroupIds_ == nullptr; };
