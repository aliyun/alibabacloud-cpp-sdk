...
namespace Models
{
  class SyncRCKeyPairResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const SyncRCKeyPairResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, SyncRCKeyPairResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    SyncRCKeyPairResponseBody() = default ;
    SyncRCKeyPairResponseBody(const SyncRCKeyPairResponseBody &) = default ;
    SyncRCKeyPairResponseBody(SyncRCKeyPairResponseBody &&) = default ;
    SyncRCKeyPairResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SyncRCKeyPairResponseBody() = default ;
    SyncRCKeyPairResponseBody& operator=(const SyncRCKeyPairResponseBody &) = default ;
    SyncRCKeyPairResponseBody& operator=(SyncRCKeyPairResponseBody &&) = default ;
