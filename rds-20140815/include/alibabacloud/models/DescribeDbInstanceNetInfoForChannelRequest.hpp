...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && return this->DBInstanceId_ == nullptr && return this->DBInstanceNetRWSplitType_ == nullptr && return this->flag_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr
    ...
    inline string DBInstanceNetRWSplitType() const { DARABONBA_PTR_GET_DEFAULT(DBInstanceNetRWSplitType_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> DBInstanceNetRWSplitType_ = nullptr;
