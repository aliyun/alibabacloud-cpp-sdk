...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRCNodePoolResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteRCNodePoolResponseBody) };
    inline DeleteRCNodePoolResponseBody body() { DARABONBA_PTR_GET(body_, DeleteRCNodePoolResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteRCNodePoolResponseBody> body_ = nullptr;
  };
