...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backupEnabled_ == nullptr
        && this->crossBackupRegion_ == nullptr && this->crossBackupType_ == nullptr && this->DBInstanceId_ == nullptr && this->logBackupEnabled_ == nullptr && this->regionId_ == nullptr
        && this->requestId_ == nullptr && this->retentType_ == nullptr && this->retention_ == nullptr; };
