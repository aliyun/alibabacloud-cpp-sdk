...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRCInvocationResultsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeRCInvocationResultsResponseBody) };
    inline DescribeRCInvocationResultsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeRCInvocationResultsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeRCInvocationResultsResponseBody> body_ = nullptr;
  };
