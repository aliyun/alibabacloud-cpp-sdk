...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceId_ == nullptr
        && return this->DBProxyEngineType_ == nullptr && return this->DBProxyInstanceNum_ == nullptr && return this->DBProxyInstanceType_ == nullptr && return this->DBProxyNodes_ == nullptr && return this->effectiveSpecificTime_ == nullptr
        && return this->effectiveTime_ == nullptr && return this->migrateAZ_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr && return this->resourceOwnerAccount_ == nullptr
    ...
    inline const vector<ModifyDBProxyInstanceRequestDBProxyNodes> & DBProxyNodes() const { DARABONBA_PTR_GET_CONST(DBProxyNodes_, vector<ModifyDBProxyInstanceRequestDBProxyNodes>) };
    inline vector<ModifyDBProxyInstanceRequestDBProxyNodes> DBProxyNodes() { DARABONBA_PTR_GET(DBProxyNodes_, vector<ModifyDBProxyInstanceRequestDBProxyNodes>) };
    inline ModifyDBProxyInstanceRequest& setDBProxyNodes(const vector<ModifyDBProxyInstanceRequestDBProxyNodes> & DBProxyNodes) { DARABONBA_PTR_SET_VALUE(DBProxyNodes_, DBProxyNodes) };
    inline ModifyDBProxyInstanceRequest& setDBProxyNodes(vector<ModifyDBProxyInstanceRequestDBProxyNodes> && DBProxyNodes) { DARABONBA_PTR_SET_RVALUE(DBProxyNodes_, DBProxyNodes) };
    ...
    inline const vector<ModifyDBProxyInstanceRequestMigrateAZ> & migrateAZ() const { DARABONBA_PTR_GET_CONST(migrateAZ_, vector<ModifyDBProxyInstanceRequestMigrateAZ>) };
    inline vector<ModifyDBProxyInstanceRequestMigrateAZ> migrateAZ() { DARABONBA_PTR_GET(migrateAZ_, vector<ModifyDBProxyInstanceRequestMigrateAZ>) };
    inline ModifyDBProxyInstanceRequest& setMigrateAZ(const vector<ModifyDBProxyInstanceRequestMigrateAZ> & migrateAZ) { DARABONBA_PTR_SET_VALUE(migrateAZ_, migrateAZ) };
    inline ModifyDBProxyInstanceRequest& setMigrateAZ(vector<ModifyDBProxyInstanceRequestMigrateAZ> && migrateAZ) { DARABONBA_PTR_SET_RVALUE(migrateAZ_, migrateAZ) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ModifyDBProxyInstanceRequestDBProxyNodes>> DBProxyNodes_ = nullptr;
    ...
    std::shared_ptr<vector<ModifyDBProxyInstanceRequestMigrateAZ>> migrateAZ_ = nullptr;
