...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecurityGroupConfigurationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSecurityGroupConfigurationResponseBody) };
    inline DescribeSecurityGroupConfigurationResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSecurityGroupConfigurationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSecurityGroupConfigurationResponseBody> body_ {};
  };
