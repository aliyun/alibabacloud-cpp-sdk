...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMigrateTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMigrateTasksResponseBody) };
    inline DescribeMigrateTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMigrateTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMigrateTasksResponseBody> body_ {};
  };
