...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceCrossBackupPolicyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceCrossBackupPolicyResponseBody) };
    inline DescribeInstanceCrossBackupPolicyResponseBody body() { DARABONBA_PTR_GET(body_, DescribeInstanceCrossBackupPolicyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeInstanceCrossBackupPolicyResponseBody> body_ = nullptr;
  };
