...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeUpgradeMajorVersionPrecheckTaskResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeUpgradeMajorVersionPrecheckTaskResponseBodyItems>) };
    inline vector<DescribeUpgradeMajorVersionPrecheckTaskResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeUpgradeMajorVersionPrecheckTaskResponseBodyItems>) };
    inline DescribeUpgradeMajorVersionPrecheckTaskResponseBody& setItems(const vector<DescribeUpgradeMajorVersionPrecheckTaskResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeUpgradeMajorVersionPrecheckTaskResponseBody& setItems(vector<DescribeUpgradeMajorVersionPrecheckTaskResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeUpgradeMajorVersionPrecheckTaskResponseBodyItems>> items_ = nullptr;
    // The page number.
