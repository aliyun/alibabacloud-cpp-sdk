...
namespace Models
{
  ...
  public:
    ...
    inline const DestroyDBInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DestroyDBInstanceResponseBody) };
    inline DestroyDBInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, DestroyDBInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DestroyDBInstanceResponseBody> body_ {};
  };
