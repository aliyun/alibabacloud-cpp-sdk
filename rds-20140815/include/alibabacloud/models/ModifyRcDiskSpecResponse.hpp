...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyRCDiskSpecResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyRCDiskSpecResponseBody) };
    inline ModifyRCDiskSpecResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyRCDiskSpecResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyRCDiskSpecResponseBody> body_ {};
  };
