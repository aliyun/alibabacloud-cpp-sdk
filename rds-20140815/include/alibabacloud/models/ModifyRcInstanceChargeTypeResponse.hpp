...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyRCInstanceChargeTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyRCInstanceChargeTypeResponseBody) };
    inline ModifyRCInstanceChargeTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyRCInstanceChargeTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyRCInstanceChargeTypeResponseBody> body_ {};
  };
