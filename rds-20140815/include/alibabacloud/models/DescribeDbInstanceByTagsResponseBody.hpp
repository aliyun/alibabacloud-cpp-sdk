...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceByTagsResponseBodyItems & items() const { DARABONBA_PTR_GET_CONST(items_, DescribeDBInstanceByTagsResponseBodyItems) };
    inline DescribeDBInstanceByTagsResponseBodyItems items() { DARABONBA_PTR_GET(items_, DescribeDBInstanceByTagsResponseBodyItems) };
    inline DescribeDBInstanceByTagsResponseBody& setItems(const DescribeDBInstanceByTagsResponseBodyItems & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeDBInstanceByTagsResponseBody& setItems(DescribeDBInstanceByTagsResponseBodyItems && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDBInstanceByTagsResponseBodyItems> items_ = nullptr;
    // The page number.
