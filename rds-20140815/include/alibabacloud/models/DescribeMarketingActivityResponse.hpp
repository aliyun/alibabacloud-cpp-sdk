...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMarketingActivityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMarketingActivityResponseBody) };
    inline DescribeMarketingActivityResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMarketingActivityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMarketingActivityResponseBody> body_ {};
  };
