...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoPay_ == nullptr
        && return this->diskId_ == nullptr && return this->dryRun_ == nullptr && return this->instanceId_ == nullptr && return this->newSize_ == nullptr && return this->regionId_ == nullptr
    ...
    inline int64_t newSize() const { DARABONBA_PTR_GET_DEFAULT(newSize_, 0L) };
  ...
  protected:
    ...
    std::shared_ptr<int64_t> newSize_ = nullptr;
