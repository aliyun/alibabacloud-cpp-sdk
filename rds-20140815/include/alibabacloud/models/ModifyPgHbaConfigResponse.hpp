...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyPGHbaConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyPGHbaConfigResponseBody) };
    inline ModifyPGHbaConfigResponseBody body() { DARABONBA_PTR_GET(body_, ModifyPGHbaConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyPGHbaConfigResponseBody> body_ = nullptr;
  };
