...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDTCSecurityIpHostsForSQLServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDTCSecurityIpHostsForSQLServerResponseBody) };
    inline ModifyDTCSecurityIpHostsForSQLServerResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDTCSecurityIpHostsForSQLServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDTCSecurityIpHostsForSQLServerResponseBody> body_ {};
  };
