...
namespace Models
{
  ...
  public:
    ...
    inline const CopyDatabaseBetweenInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CopyDatabaseBetweenInstancesResponseBody) };
    inline CopyDatabaseBetweenInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, CopyDatabaseBetweenInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CopyDatabaseBetweenInstancesResponseBody> body_ {};
  };
