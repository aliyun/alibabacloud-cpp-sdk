...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->amount_ == nullptr
        ...
        && this->resourceOwnerId_ == nullptr && this->roleARN_ == nullptr && this->securityIPList_ == nullptr && this->serverlessConfig_ == nullptr && this->storageAutoScale_ == nullptr
    ...
    inline const CreateDBInstanceRequest::ServerlessConfig & getServerlessConfig() const { DARABONBA_PTR_GET_CONST(serverlessConfig_, CreateDBInstanceRequest::ServerlessConfig) };
    inline CreateDBInstanceRequest::ServerlessConfig getServerlessConfig() { DARABONBA_PTR_GET(serverlessConfig_, CreateDBInstanceRequest::ServerlessConfig) };
    inline CreateDBInstanceRequest& setServerlessConfig(const CreateDBInstanceRequest::ServerlessConfig & serverlessConfig) { DARABONBA_PTR_SET_VALUE(serverlessConfig_, serverlessConfig) };
    inline CreateDBInstanceRequest& setServerlessConfig(CreateDBInstanceRequest::ServerlessConfig && serverlessConfig) { DARABONBA_PTR_SET_RVALUE(serverlessConfig_, serverlessConfig) };
  ...
  protected:
    ...
    // 
    // >  ApsaraDB RDS for MariaDB does not support serverless instances.
    shared_ptr<CreateDBInstanceRequest::ServerlessConfig> serverlessConfig_ {};
