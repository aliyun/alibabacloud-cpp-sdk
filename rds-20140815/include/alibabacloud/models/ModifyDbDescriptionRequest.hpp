...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBDescription_ == nullptr
    ...
    inline ModifyDBDescriptionRequest& setDBInstanceId(string DBInstanceId) { DARABONBA_PTR_SET_VALUE(DBInstanceId_, DBInstanceId) };
