...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backupMode_ == nullptr
        && return this->createTime_ == nullptr && return this->DBInstanceName_ == nullptr && return this->DBName_ == nullptr && return this->description_ == nullptr && return this->endTime_ == nullptr
        && return this->isDBReplaced_ == nullptr && return this->migrateTaskId_ == nullptr && return this->requestId_ == nullptr && return this->status_ == nullptr; };
