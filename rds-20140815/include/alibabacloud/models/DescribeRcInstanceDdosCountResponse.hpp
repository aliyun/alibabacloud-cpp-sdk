...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRCInstanceDdosCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRCInstanceDdosCountResponseBody) };
    inline DescribeRCInstanceDdosCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRCInstanceDdosCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRCInstanceDdosCountResponseBody> body_ {};
  };
