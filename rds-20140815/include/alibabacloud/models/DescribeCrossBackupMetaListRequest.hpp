...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backupSetId_ == nullptr
        && return this->getDbName_ == nullptr && return this->ownerId_ == nullptr && return this->pageIndex_ == nullptr && return this->pageSize_ == nullptr && return this->pattern_ == nullptr
        && return this->region_ == nullptr && return this->resourceGroupId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr; };
