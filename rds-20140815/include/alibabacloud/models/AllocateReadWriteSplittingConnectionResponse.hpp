...
namespace Models
{
  ...
  public:
    ...
    inline const AllocateReadWriteSplittingConnectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AllocateReadWriteSplittingConnectionResponseBody) };
    inline AllocateReadWriteSplittingConnectionResponseBody getBody() { DARABONBA_PTR_GET(body_, AllocateReadWriteSplittingConnectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AllocateReadWriteSplittingConnectionResponseBody> body_ {};
  };
