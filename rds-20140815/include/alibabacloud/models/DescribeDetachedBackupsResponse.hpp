...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDetachedBackupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDetachedBackupsResponseBody) };
    inline DescribeDetachedBackupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDetachedBackupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDetachedBackupsResponseBody> body_ {};
  };
