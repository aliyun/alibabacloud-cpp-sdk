...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDBInstanceEndpointAddressResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteDBInstanceEndpointAddressResponseBody::Data) };
    inline DeleteDBInstanceEndpointAddressResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteDBInstanceEndpointAddressResponseBody::Data) };
    inline DeleteDBInstanceEndpointAddressResponseBody& setData(const DeleteDBInstanceEndpointAddressResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteDBInstanceEndpointAddressResponseBody& setData(DeleteDBInstanceEndpointAddressResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
