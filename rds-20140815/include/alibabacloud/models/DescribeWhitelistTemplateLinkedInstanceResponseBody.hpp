...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWhitelistTemplateLinkedInstanceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeWhitelistTemplateLinkedInstanceResponseBodyData) };
    inline DescribeWhitelistTemplateLinkedInstanceResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeWhitelistTemplateLinkedInstanceResponseBodyData) };
    inline DescribeWhitelistTemplateLinkedInstanceResponseBody& setData(const DescribeWhitelistTemplateLinkedInstanceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeWhitelistTemplateLinkedInstanceResponseBody& setData(DescribeWhitelistTemplateLinkedInstanceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeWhitelistTemplateLinkedInstanceResponseBodyData> data_ = nullptr;
