...
namespace Models
{
  ...
  public:
    ...
    inline const AcceptRCInquiredSystemEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AcceptRCInquiredSystemEventResponseBody) };
    inline AcceptRCInquiredSystemEventResponseBody getBody() { DARABONBA_PTR_GET(body_, AcceptRCInquiredSystemEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AcceptRCInquiredSystemEventResponseBody> body_ {};
  };
