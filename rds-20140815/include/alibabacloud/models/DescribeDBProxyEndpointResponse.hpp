...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBProxyEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBProxyEndpointResponseBody) };
    inline DescribeDBProxyEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBProxyEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBProxyEndpointResponseBody> body_ {};
  };
