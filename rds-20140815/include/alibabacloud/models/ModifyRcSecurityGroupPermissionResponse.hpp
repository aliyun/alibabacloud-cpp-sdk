...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyRCSecurityGroupPermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyRCSecurityGroupPermissionResponseBody) };
    inline ModifyRCSecurityGroupPermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyRCSecurityGroupPermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyRCSecurityGroupPermissionResponseBody> body_ {};
  };
