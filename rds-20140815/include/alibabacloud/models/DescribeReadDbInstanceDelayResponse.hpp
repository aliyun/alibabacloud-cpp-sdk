...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeReadDBInstanceDelayResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeReadDBInstanceDelayResponseBody) };
    inline DescribeReadDBInstanceDelayResponseBody body() { DARABONBA_PTR_GET(body_, DescribeReadDBInstanceDelayResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeReadDBInstanceDelayResponseBody> body_ = nullptr;
  };
