...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTasksResponseBodyItems & items() const { DARABONBA_PTR_GET_CONST(items_, DescribeTasksResponseBodyItems) };
    inline DescribeTasksResponseBodyItems items() { DARABONBA_PTR_GET(items_, DescribeTasksResponseBodyItems) };
    inline DescribeTasksResponseBody& setItems(const DescribeTasksResponseBodyItems & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeTasksResponseBody& setItems(DescribeTasksResponseBodyItems && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeTasksResponseBodyItems> items_ = nullptr;
    // The page number.
