...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBInstanceReplicationSwitchResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBInstanceReplicationSwitchResponseBody) };
    inline ModifyDBInstanceReplicationSwitchResponseBody body() { DARABONBA_PTR_GET(body_, ModifyDBInstanceReplicationSwitchResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyDBInstanceReplicationSwitchResponseBody> body_ = nullptr;
  };
