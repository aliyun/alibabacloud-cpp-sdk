...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cpuShar_ == nullptr
        && this->cpuZoom_ == nullptr && this->iopsZoom_ == nullptr && this->maxConnZoom_ == nullptr && this->memoryZoom_ == nullptr && this->requestId_ == nullptr; };
    // cpuShar Field Functions 
    bool hasCpuShar() const { return this->cpuShar_ != nullptr;};
    void deleteCpuShar() { this->cpuShar_ = nullptr;};
    inline int32_t getCpuShar() const { DARABONBA_PTR_GET_DEFAULT(cpuShar_, 0) };
    ...
    inline int32_t getCpuZoom() const { DARABONBA_PTR_GET_DEFAULT(cpuZoom_, 0) };
    ...
    inline int32_t getIopsZoom() const { DARABONBA_PTR_GET_DEFAULT(iopsZoom_, 0) };
    ...
    inline int32_t getMaxConnZoom() const { DARABONBA_PTR_GET_DEFAULT(maxConnZoom_, 0) };
    ...
    inline int32_t getMemoryZoom() const { DARABONBA_PTR_GET_DEFAULT(memoryZoom_, 0) };
