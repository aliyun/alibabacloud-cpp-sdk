...
#ifndef ALIBABACLOUD_MODELS_CREATEIMPORTTASKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEIMPORTTASKREQUEST_HPP_
...
namespace Models
{
  class CreateImportTaskRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateImportTaskRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateImportTaskRequest& obj) { 
    ...
    CreateImportTaskRequest(const CreateImportTaskRequest &) = default ;
    CreateImportTaskRequest(CreateImportTaskRequest &&) = default ;
    CreateImportTaskRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateImportTaskRequest() = default ;
    CreateImportTaskRequest& operator=(const CreateImportTaskRequest &) = default ;
    CreateImportTaskRequest& operator=(CreateImportTaskRequest &&) = default ;
    ...
    inline CreateImportTaskRequest& setDbInstanceId(string dbInstanceId) { DARABONBA_PTR_SET_VALUE(dbInstanceId_, dbInstanceId) };
    ...
    inline CreateImportTaskRequest& setEstimatedSize(int32_t estimatedSize) { DARABONBA_PTR_SET_VALUE(estimatedSize_, estimatedSize) };
    ...
    inline CreateImportTaskRequest& setHost(string host) { DARABONBA_PTR_SET_VALUE(host_, host) };
    ...
    inline CreateImportTaskRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline CreateImportTaskRequest& setPassword(string password) { DARABONBA_PTR_SET_VALUE(password_, password) };
    ...
    inline CreateImportTaskRequest& setPort(int32_t port) { DARABONBA_PTR_SET_VALUE(port_, port) };
    ...
    inline CreateImportTaskRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline CreateImportTaskRequest& setSourceInstanceId(string sourceInstanceId) { DARABONBA_PTR_SET_VALUE(sourceInstanceId_, sourceInstanceId) };
    ...
    inline CreateImportTaskRequest& setSourcePlatform(string sourcePlatform) { DARABONBA_PTR_SET_VALUE(sourcePlatform_, sourcePlatform) };
    ...
    inline CreateImportTaskRequest& setStreamPort(int32_t streamPort) { DARABONBA_PTR_SET_VALUE(streamPort_, streamPort) };
    ...
    inline CreateImportTaskRequest& setUser(string user) { DARABONBA_PTR_SET_VALUE(user_, user) };
    ...
    inline CreateImportTaskRequest& setXtrabackupPath(string xtrabackupPath) { DARABONBA_PTR_SET_VALUE(xtrabackupPath_, xtrabackupPath) };
