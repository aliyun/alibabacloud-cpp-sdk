...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDBInstanceSecurityGroupRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteDBInstanceSecurityGroupRuleResponseBody) };
    inline DeleteDBInstanceSecurityGroupRuleResponseBody body() { DARABONBA_PTR_GET(body_, DeleteDBInstanceSecurityGroupRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteDBInstanceSecurityGroupRuleResponseBody> body_ = nullptr;
  };
