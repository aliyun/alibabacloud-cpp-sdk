...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backupSetId_ == nullptr
        && return this->backupSetRegion_ == nullptr && return this->clientToken_ == nullptr && return this->connectionMode_ == nullptr && return this->DBInstanceClass_ == nullptr && return this->DBInstanceDescription_ == nullptr
        && return this->DBInstanceNetType_ == nullptr && return this->DBInstanceStorage_ == nullptr && return this->DBInstanceStorageType_ == nullptr && return this->encryptionKey_ == nullptr && return this->engine_ == nullptr
        && return this->engineVersion_ == nullptr && return this->instanceNetworkType_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->payType_ == nullptr
        && return this->period_ == nullptr && return this->privateIpAddress_ == nullptr && return this->regionId_ == nullptr && return this->resourceGroupId_ == nullptr && return this->resourceOwnerAccount_ == nullptr
        && return this->resourceOwnerId_ == nullptr && return this->restoreTime_ == nullptr && return this->restoreType_ == nullptr && return this->roleARN_ == nullptr && return this->securityIPList_ == nullptr
        && return this->sourceDBInstanceName_ == nullptr && return this->sourceRegion_ == nullptr && return this->systemDBCharset_ == nullptr && return this->usedTime_ == nullptr && return this->VPCId_ == nullptr
    ...
    inline string backupSetRegion() const { DARABONBA_PTR_GET_DEFAULT(backupSetRegion_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> backupSetRegion_ = nullptr;
