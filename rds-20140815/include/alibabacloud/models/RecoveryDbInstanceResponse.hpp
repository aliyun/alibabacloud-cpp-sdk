...
namespace Models
{
  ...
  public:
    ...
    inline const RecoveryDBInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RecoveryDBInstanceResponseBody) };
    inline RecoveryDBInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, RecoveryDBInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RecoveryDBInstanceResponseBody> body_ {};
  };
