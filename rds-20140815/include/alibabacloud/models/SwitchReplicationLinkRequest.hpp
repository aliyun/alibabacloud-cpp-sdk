...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceId_ == nullptr
        && this->ownerId_ == nullptr && this->targetInstanceName_ == nullptr && this->targetInstanceRegionId_ == nullptr; };
    ...
    inline string getTargetInstanceRegionId() const { DARABONBA_PTR_GET_DEFAULT(targetInstanceRegionId_, "") };
