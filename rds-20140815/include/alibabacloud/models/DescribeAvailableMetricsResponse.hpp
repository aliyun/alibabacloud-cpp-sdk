...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAvailableMetricsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAvailableMetricsResponseBody) };
    inline DescribeAvailableMetricsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAvailableMetricsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAvailableMetricsResponseBody> body_ {};
  };
