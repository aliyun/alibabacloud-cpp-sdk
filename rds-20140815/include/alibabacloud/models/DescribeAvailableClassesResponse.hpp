...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAvailableClassesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAvailableClassesResponseBody) };
    inline DescribeAvailableClassesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAvailableClassesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAvailableClassesResponseBody> body_ {};
  };
