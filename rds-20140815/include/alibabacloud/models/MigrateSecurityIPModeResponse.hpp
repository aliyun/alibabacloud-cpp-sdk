...
namespace Models
{
  ...
  public:
    ...
    inline const MigrateSecurityIPModeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MigrateSecurityIPModeResponseBody) };
    inline MigrateSecurityIPModeResponseBody getBody() { DARABONBA_PTR_GET(body_, MigrateSecurityIPModeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MigrateSecurityIPModeResponseBody> body_ {};
  };
