...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWhitelistTemplateResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeWhitelistTemplateResponseBodyData) };
    inline DescribeWhitelistTemplateResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeWhitelistTemplateResponseBodyData) };
    inline DescribeWhitelistTemplateResponseBody& setData(const DescribeWhitelistTemplateResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeWhitelistTemplateResponseBody& setData(DescribeWhitelistTemplateResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeWhitelistTemplateResponseBodyData> data_ = nullptr;
