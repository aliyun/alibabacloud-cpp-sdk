...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeRCInvocationResultsRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<DescribeRCInvocationResultsRequestTag>) };
    inline vector<DescribeRCInvocationResultsRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<DescribeRCInvocationResultsRequestTag>) };
    inline DescribeRCInvocationResultsRequest& setTag(const vector<DescribeRCInvocationResultsRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline DescribeRCInvocationResultsRequest& setTag(vector<DescribeRCInvocationResultsRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeRCInvocationResultsRequestTag>> tag_ = nullptr;
  };
