...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDBInstanceEndpointResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateDBInstanceEndpointResponseBody::Data) };
    inline CreateDBInstanceEndpointResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateDBInstanceEndpointResponseBody::Data) };
    inline CreateDBInstanceEndpointResponseBody& setData(const CreateDBInstanceEndpointResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateDBInstanceEndpointResponseBody& setData(CreateDBInstanceEndpointResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
