...
namespace Models
{
  ...
  public:
    ...
    inline const vector<RemoveTagsFromResourceRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<RemoveTagsFromResourceRequest::Tag>) };
    inline vector<RemoveTagsFromResourceRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<RemoveTagsFromResourceRequest::Tag>) };
    inline RemoveTagsFromResourceRequest& setTag(const vector<RemoveTagsFromResourceRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline RemoveTagsFromResourceRequest& setTag(vector<RemoveTagsFromResourceRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
