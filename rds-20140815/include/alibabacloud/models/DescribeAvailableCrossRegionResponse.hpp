...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAvailableCrossRegionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAvailableCrossRegionResponseBody) };
    inline DescribeAvailableCrossRegionResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAvailableCrossRegionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAvailableCrossRegionResponseBody> body_ {};
  };
