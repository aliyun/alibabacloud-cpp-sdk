...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->computeBurstConfig_ == nullptr
        && return this->computeBurstEnabled_ == nullptr && return this->requestId_ == nullptr; };
    ...
    inline     const Darabonba::Json & computeBurstConfig() const { DARABONBA_GET(computeBurstConfig_) };
    Darabonba::Json & computeBurstConfig() { DARABONBA_GET(computeBurstConfig_) };
  ...
  protected:
    ...
    Darabonba::Json computeBurstConfig_ = nullptr;
