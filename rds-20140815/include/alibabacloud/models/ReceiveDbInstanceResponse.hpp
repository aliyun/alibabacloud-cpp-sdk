...
namespace Models
{
  ...
  public:
    ...
    inline const ReceiveDBInstanceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ReceiveDBInstanceResponseBody) };
    inline ReceiveDBInstanceResponseBody body() { DARABONBA_PTR_GET(body_, ReceiveDBInstanceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ReceiveDBInstanceResponseBody> body_ = nullptr;
  };
