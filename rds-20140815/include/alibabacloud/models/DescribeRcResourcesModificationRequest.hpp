...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & conditionss() const { DARABONBA_PTR_GET_CONST(conditionss_, vector<string>) };
    inline vector<string> conditionss() { DARABONBA_PTR_GET(conditionss_, vector<string>) };
  ...
  protected:
    std::shared_ptr<vector<string>> conditionss_ = nullptr;
