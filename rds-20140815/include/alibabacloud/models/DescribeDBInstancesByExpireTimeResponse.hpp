...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstancesByExpireTimeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBInstancesByExpireTimeResponseBody) };
    inline DescribeDBInstancesByExpireTimeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBInstancesByExpireTimeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBInstancesByExpireTimeResponseBody> body_ {};
  };
