...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRCImageListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRCImageListResponseBody) };
    inline DescribeRCImageListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRCImageListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRCImageListResponseBody> body_ {};
  };
