...
namespace Models
{
  ...
  public:
    ...
    inline const RebuildDBInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RebuildDBInstanceResponseBody) };
    inline RebuildDBInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, RebuildDBInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RebuildDBInstanceResponseBody> body_ {};
  };
