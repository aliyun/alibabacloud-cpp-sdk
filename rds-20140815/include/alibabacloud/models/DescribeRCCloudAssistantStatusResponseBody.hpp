...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline int32_t getActiveTaskCount() const { DARABONBA_PTR_GET_DEFAULT(activeTaskCount_, 0) };
      inline InstanceCloudAssistantStatusSet& setActiveTaskCount(int32_t activeTaskCount) { DARABONBA_PTR_SET_VALUE(activeTaskCount_, activeTaskCount) };
      ...
      inline InstanceCloudAssistantStatusSet& setCloudAssistantStatus(string cloudAssistantStatus) { DARABONBA_PTR_SET_VALUE(cloudAssistantStatus_, cloudAssistantStatus) };
      ...
      inline InstanceCloudAssistantStatusSet& setCloudAssistantVersion(string cloudAssistantVersion) { DARABONBA_PTR_SET_VALUE(cloudAssistantVersion_, cloudAssistantVersion) };
      ...
      inline InstanceCloudAssistantStatusSet& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
      ...
      inline int32_t getInvocationCount() const { DARABONBA_PTR_GET_DEFAULT(invocationCount_, 0) };
      inline InstanceCloudAssistantStatusSet& setInvocationCount(int32_t invocationCount) { DARABONBA_PTR_SET_VALUE(invocationCount_, invocationCount) };
      ...
      inline InstanceCloudAssistantStatusSet& setLastHeartbeatTime(string lastHeartbeatTime) { DARABONBA_PTR_SET_VALUE(lastHeartbeatTime_, lastHeartbeatTime) };
      ...
      inline InstanceCloudAssistantStatusSet& setLastInvokedTime(string lastInvokedTime) { DARABONBA_PTR_SET_VALUE(lastInvokedTime_, lastInvokedTime) };
      ...
      inline InstanceCloudAssistantStatusSet& setOSType(string OSType) { DARABONBA_PTR_SET_VALUE(OSType_, OSType) };
      ...
      inline InstanceCloudAssistantStatusSet& setSupportSessionManager(bool supportSessionManager) { DARABONBA_PTR_SET_VALUE(supportSessionManager_, supportSessionManager) };
    ...
    inline const vector<DescribeRCCloudAssistantStatusResponseBody::InstanceCloudAssistantStatusSet> & getInstanceCloudAssistantStatusSet() const { DARABONBA_PTR_GET_CONST(instanceCloudAssistantStatusSet_, vector<DescribeRCCloudAssistantStatusResponseBody::InstanceCloudAssistantStatusSet>) };
    inline vector<DescribeRCCloudAssistantStatusResponseBody::InstanceCloudAssistantStatusSet> getInstanceCloudAssistantStatusSet() { DARABONBA_PTR_GET(instanceCloudAssistantStatusSet_, vector<DescribeRCCloudAssistantStatusResponseBody::InstanceCloudAssistantStatusSet>) };
    inline DescribeRCCloudAssistantStatusResponseBody& setInstanceCloudAssistantStatusSet(const vector<DescribeRCCloudAssistantStatusResponseBody::InstanceCloudAssistantStatusSet> & instanceCloudAssistantStatusSet) { DARABONBA_PTR_SET_VALUE(instanceCloudAssistantStatusSet_, instanceCloudAssistantStatusSet) };
    inline DescribeRCCloudAssistantStatusResponseBody& setInstanceCloudAssistantStatusSet(vector<DescribeRCCloudAssistantStatusResponseBody::InstanceCloudAssistantStatusSet> && instanceCloudAssistantStatusSet) { DARABONBA_PTR_SET_RVALUE(instanceCloudAssistantStatusSet_, instanceCloudAssistantStatusSet) };
