...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAvailableMetricsResponseBody::Items> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeAvailableMetricsResponseBody::Items>) };
    inline vector<DescribeAvailableMetricsResponseBody::Items> getItems() { DARABONBA_PTR_GET(items_, vector<DescribeAvailableMetricsResponseBody::Items>) };
    inline DescribeAvailableMetricsResponseBody& setItems(const vector<DescribeAvailableMetricsResponseBody::Items> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeAvailableMetricsResponseBody& setItems(vector<DescribeAvailableMetricsResponseBody::Items> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
