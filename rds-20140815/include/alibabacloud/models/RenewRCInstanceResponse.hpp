...
namespace Models
{
  ...
  public:
    ...
    inline const RenewRCInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RenewRCInstanceResponseBody) };
    inline RenewRCInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, RenewRCInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RenewRCInstanceResponseBody> body_ {};
  };
