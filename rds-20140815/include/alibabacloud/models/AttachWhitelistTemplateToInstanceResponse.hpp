...
namespace Models
{
  ...
  public:
    ...
    inline const AttachWhitelistTemplateToInstanceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AttachWhitelistTemplateToInstanceResponseBody) };
    inline AttachWhitelistTemplateToInstanceResponseBody body() { DARABONBA_PTR_GET(body_, AttachWhitelistTemplateToInstanceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AttachWhitelistTemplateToInstanceResponseBody> body_ = nullptr;
  };
