...
#ifndef ALIBABACLOUD_MODELS_SUBMITAVATARVIDEOTASKSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SUBMITAVATARVIDEOTASKSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SubmitAvatarVideoTaskShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SubmitAvatarVideoTaskShrinkRequest& obj) { 
    ...
    SubmitAvatarVideoTaskShrinkRequest() = default ;
    SubmitAvatarVideoTaskShrinkRequest(const SubmitAvatarVideoTaskShrinkRequest &) = default ;
    SubmitAvatarVideoTaskShrinkRequest(SubmitAvatarVideoTaskShrinkRequest &&) = default ;
    SubmitAvatarVideoTaskShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SubmitAvatarVideoTaskShrinkRequest() = default ;
    SubmitAvatarVideoTaskShrinkRequest& operator=(const SubmitAvatarVideoTaskShrinkRequest &) = default ;
    SubmitAvatarVideoTaskShrinkRequest& operator=(SubmitAvatarVideoTaskShrinkRequest &&) = default ;
    ...
    inline SubmitAvatarVideoTaskShrinkRequest& setAppShrink(string appShrink) { DARABONBA_PTR_SET_VALUE(appShrink_, appShrink) };
    ...
    inline SubmitAvatarVideoTaskShrinkRequest& setCallback(bool callback) { DARABONBA_PTR_SET_VALUE(callback_, callback) };
    ...
    inline SubmitAvatarVideoTaskShrinkRequest& setCallbackParams(string callbackParams) { DARABONBA_PTR_SET_VALUE(callbackParams_, callbackParams) };
    ...
    inline SubmitAvatarVideoTaskShrinkRequest& setExtParams(string extParams) { DARABONBA_PTR_SET_VALUE(extParams_, extParams) };
    ...
    inline SubmitAvatarVideoTaskShrinkRequest& setTenantId(int64_t tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
    ...
    inline SubmitAvatarVideoTaskShrinkRequest& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline SubmitAvatarVideoTaskShrinkRequest& setVideoParams(string videoParams) { DARABONBA_PTR_SET_VALUE(videoParams_, videoParams) };
