...
#ifndef ALIBABACLOUD_MODELS_SUBMITAUDIOTO2DAVATARVIDEOTASKSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SUBMITAUDIOTO2DAVATARVIDEOTASKSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SubmitAudioTo2DAvatarVideoTaskShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SubmitAudioTo2DAvatarVideoTaskShrinkRequest& obj) { 
    ...
    SubmitAudioTo2DAvatarVideoTaskShrinkRequest() = default ;
    SubmitAudioTo2DAvatarVideoTaskShrinkRequest(const SubmitAudioTo2DAvatarVideoTaskShrinkRequest &) = default ;
    SubmitAudioTo2DAvatarVideoTaskShrinkRequest(SubmitAudioTo2DAvatarVideoTaskShrinkRequest &&) = default ;
    SubmitAudioTo2DAvatarVideoTaskShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SubmitAudioTo2DAvatarVideoTaskShrinkRequest() = default ;
    SubmitAudioTo2DAvatarVideoTaskShrinkRequest& operator=(const SubmitAudioTo2DAvatarVideoTaskShrinkRequest &) = default ;
    SubmitAudioTo2DAvatarVideoTaskShrinkRequest& operator=(SubmitAudioTo2DAvatarVideoTaskShrinkRequest &&) = default ;
    ...
    inline SubmitAudioTo2DAvatarVideoTaskShrinkRequest& setAppShrink(string appShrink) { DARABONBA_PTR_SET_VALUE(appShrink_, appShrink) };
    ...
    inline SubmitAudioTo2DAvatarVideoTaskShrinkRequest& setAudioInfoShrink(string audioInfoShrink) { DARABONBA_PTR_SET_VALUE(audioInfoShrink_, audioInfoShrink) };
    ...
    inline SubmitAudioTo2DAvatarVideoTaskShrinkRequest& setAvatarInfoShrink(string avatarInfoShrink) { DARABONBA_PTR_SET_VALUE(avatarInfoShrink_, avatarInfoShrink) };
    ...
    inline SubmitAudioTo2DAvatarVideoTaskShrinkRequest& setCallback(bool callback) { DARABONBA_PTR_SET_VALUE(callback_, callback) };
    ...
    inline SubmitAudioTo2DAvatarVideoTaskShrinkRequest& setCallbackParams(string callbackParams) { DARABONBA_PTR_SET_VALUE(callbackParams_, callbackParams) };
    ...
    inline SubmitAudioTo2DAvatarVideoTaskShrinkRequest& setExtParams(string extParams) { DARABONBA_PTR_SET_VALUE(extParams_, extParams) };
    ...
    inline SubmitAudioTo2DAvatarVideoTaskShrinkRequest& setTenantId(int64_t tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
    ...
    inline SubmitAudioTo2DAvatarVideoTaskShrinkRequest& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline SubmitAudioTo2DAvatarVideoTaskShrinkRequest& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
    ...
    inline SubmitAudioTo2DAvatarVideoTaskShrinkRequest& setVideoInfoShrink(string videoInfoShrink) { DARABONBA_PTR_SET_VALUE(videoInfoShrink_, videoInfoShrink) };
