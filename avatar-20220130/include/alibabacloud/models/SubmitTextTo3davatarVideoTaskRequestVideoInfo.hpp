...
#ifndef ALIBABACLOUD_MODELS_SUBMITTEXTTO3DAVATARVIDEOTASKREQUESTVIDEOINFO_HPP_
#define ALIBABACLOUD_MODELS_SUBMITTEXTTO3DAVATARVIDEOTASKREQUESTVIDEOINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SubmitTextTo3DAvatarVideoTaskRequestVideoInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SubmitTextTo3DAvatarVideoTaskRequestVideoInfo& obj) { 
    ...
    SubmitTextTo3DAvatarVideoTaskRequestVideoInfo() = default ;
    SubmitTextTo3DAvatarVideoTaskRequestVideoInfo(const SubmitTextTo3DAvatarVideoTaskRequestVideoInfo &) = default ;
    SubmitTextTo3DAvatarVideoTaskRequestVideoInfo(SubmitTextTo3DAvatarVideoTaskRequestVideoInfo &&) = default ;
    SubmitTextTo3DAvatarVideoTaskRequestVideoInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SubmitTextTo3DAvatarVideoTaskRequestVideoInfo() = default ;
    SubmitTextTo3DAvatarVideoTaskRequestVideoInfo& operator=(const SubmitTextTo3DAvatarVideoTaskRequestVideoInfo &) = default ;
    SubmitTextTo3DAvatarVideoTaskRequestVideoInfo& operator=(SubmitTextTo3DAvatarVideoTaskRequestVideoInfo &&) = default ;
    ...
    inline SubmitTextTo3DAvatarVideoTaskRequestVideoInfo& setAlphaFormat(int32_t alphaFormat) { DARABONBA_PTR_SET_VALUE(alphaFormat_, alphaFormat) };
    ...
    inline SubmitTextTo3DAvatarVideoTaskRequestVideoInfo& setBackgroundImageUrl(string backgroundImageUrl) { DARABONBA_PTR_SET_VALUE(backgroundImageUrl_, backgroundImageUrl) };
    ...
    inline SubmitTextTo3DAvatarVideoTaskRequestVideoInfo& setIsAlpha(bool isAlpha) { DARABONBA_PTR_SET_VALUE(isAlpha_, isAlpha) };
    ...
    inline SubmitTextTo3DAvatarVideoTaskRequestVideoInfo& setIsSubtitles(bool isSubtitles) { DARABONBA_PTR_SET_VALUE(isSubtitles_, isSubtitles) };
    ...
    inline SubmitTextTo3DAvatarVideoTaskRequestVideoInfo& setResolution(int32_t resolution) { DARABONBA_PTR_SET_VALUE(resolution_, resolution) };
    ...
    inline SubmitTextTo3DAvatarVideoTaskRequestVideoInfo& setSubtitleEmbedded(bool subtitleEmbedded) { DARABONBA_PTR_SET_VALUE(subtitleEmbedded_, subtitleEmbedded) };
    ...
    inline const Models::SubmitTextTo3DAvatarVideoTaskRequestVideoInfoSubtitleStyle & subtitleStyle() const { DARABONBA_PTR_GET_CONST(subtitleStyle_, Models::SubmitTextTo3DAvatarVideoTaskRequestVideoInfoSubtitleStyle) };
    inline Models::SubmitTextTo3DAvatarVideoTaskRequestVideoInfoSubtitleStyle subtitleStyle() { DARABONBA_PTR_GET(subtitleStyle_, Models::SubmitTextTo3DAvatarVideoTaskRequestVideoInfoSubtitleStyle) };
    inline SubmitTextTo3DAvatarVideoTaskRequestVideoInfo& setSubtitleStyle(const Models::SubmitTextTo3DAvatarVideoTaskRequestVideoInfoSubtitleStyle & subtitleStyle) { DARABONBA_PTR_SET_VALUE(subtitleStyle_, subtitleStyle) };
    inline SubmitTextTo3DAvatarVideoTaskRequestVideoInfo& setSubtitleStyle(Models::SubmitTextTo3DAvatarVideoTaskRequestVideoInfoSubtitleStyle && subtitleStyle) { DARABONBA_PTR_SET_RVALUE(subtitleStyle_, subtitleStyle) };
  ...
  protected:
    ...
    std::shared_ptr<Models::SubmitTextTo3DAvatarVideoTaskRequestVideoInfoSubtitleStyle> subtitleStyle_ = nullptr;
  };
