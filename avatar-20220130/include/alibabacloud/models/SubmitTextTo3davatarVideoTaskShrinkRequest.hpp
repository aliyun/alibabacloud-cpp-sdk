...
#ifndef ALIBABACLOUD_MODELS_SUBMITTEXTTO3DAVATARVIDEOTASKSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SUBMITTEXTTO3DAVATARVIDEOTASKSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SubmitTextTo3DAvatarVideoTaskShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SubmitTextTo3DAvatarVideoTaskShrinkRequest& obj) { 
    ...
    SubmitTextTo3DAvatarVideoTaskShrinkRequest() = default ;
    SubmitTextTo3DAvatarVideoTaskShrinkRequest(const SubmitTextTo3DAvatarVideoTaskShrinkRequest &) = default ;
    SubmitTextTo3DAvatarVideoTaskShrinkRequest(SubmitTextTo3DAvatarVideoTaskShrinkRequest &&) = default ;
    SubmitTextTo3DAvatarVideoTaskShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SubmitTextTo3DAvatarVideoTaskShrinkRequest() = default ;
    SubmitTextTo3DAvatarVideoTaskShrinkRequest& operator=(const SubmitTextTo3DAvatarVideoTaskShrinkRequest &) = default ;
    SubmitTextTo3DAvatarVideoTaskShrinkRequest& operator=(SubmitTextTo3DAvatarVideoTaskShrinkRequest &&) = default ;
    ...
    inline SubmitTextTo3DAvatarVideoTaskShrinkRequest& setAppShrink(string appShrink) { DARABONBA_PTR_SET_VALUE(appShrink_, appShrink) };
    ...
    inline SubmitTextTo3DAvatarVideoTaskShrinkRequest& setAudioInfoShrink(string audioInfoShrink) { DARABONBA_PTR_SET_VALUE(audioInfoShrink_, audioInfoShrink) };
    ...
    inline SubmitTextTo3DAvatarVideoTaskShrinkRequest& setAvatarInfoShrink(string avatarInfoShrink) { DARABONBA_PTR_SET_VALUE(avatarInfoShrink_, avatarInfoShrink) };
    ...
    inline SubmitTextTo3DAvatarVideoTaskShrinkRequest& setCallback(bool callback) { DARABONBA_PTR_SET_VALUE(callback_, callback) };
    ...
    inline SubmitTextTo3DAvatarVideoTaskShrinkRequest& setCallbackParams(string callbackParams) { DARABONBA_PTR_SET_VALUE(callbackParams_, callbackParams) };
    ...
    inline SubmitTextTo3DAvatarVideoTaskShrinkRequest& setExtParams(string extParams) { DARABONBA_PTR_SET_VALUE(extParams_, extParams) };
    ...
    inline SubmitTextTo3DAvatarVideoTaskShrinkRequest& setTenantId(int64_t tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
    ...
    inline SubmitTextTo3DAvatarVideoTaskShrinkRequest& setText(string text) { DARABONBA_PTR_SET_VALUE(text_, text) };
    ...
    inline SubmitTextTo3DAvatarVideoTaskShrinkRequest& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline SubmitTextTo3DAvatarVideoTaskShrinkRequest& setVideoInfoShrink(string videoInfoShrink) { DARABONBA_PTR_SET_VALUE(videoInfoShrink_, videoInfoShrink) };
