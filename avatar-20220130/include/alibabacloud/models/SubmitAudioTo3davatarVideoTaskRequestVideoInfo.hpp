...
#ifndef ALIBABACLOUD_MODELS_SUBMITAUDIOTO3DAVATARVIDEOTASKREQUESTVIDEOINFO_HPP_
#define ALIBABACLOUD_MODELS_SUBMITAUDIOTO3DAVATARVIDEOTASKREQUESTVIDEOINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo& obj) { 
    ...
    SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo() = default ;
    SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo(const SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo &) = default ;
    SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo(SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo &&) = default ;
    SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo() = default ;
    SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo& operator=(const SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo &) = default ;
    SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo& operator=(SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo &&) = default ;
    ...
    inline SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo& setAlphaFormat(int32_t alphaFormat) { DARABONBA_PTR_SET_VALUE(alphaFormat_, alphaFormat) };
    ...
    inline SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo& setBackgroundImageUrl(string backgroundImageUrl) { DARABONBA_PTR_SET_VALUE(backgroundImageUrl_, backgroundImageUrl) };
    ...
    inline SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo& setIsAlpha(bool isAlpha) { DARABONBA_PTR_SET_VALUE(isAlpha_, isAlpha) };
    ...
    inline SubmitAudioTo3DAvatarVideoTaskRequestVideoInfo& setResolution(int32_t resolution) { DARABONBA_PTR_SET_VALUE(resolution_, resolution) };
