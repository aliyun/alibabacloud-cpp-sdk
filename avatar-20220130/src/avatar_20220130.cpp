...
ClientUnbindDeviceResponse Alibabacloud_Avatar20220130::Client::clientUnbindDeviceWithOptions(shared_ptr<ClientUnbindDeviceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<string>(request->deviceId)) {
    query->insert(pair<string, string>("DeviceId", *request->deviceId));
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("ClientUnbindDevice"))},
    {"version", boost::any(string("2022-01-30"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return ClientUnbindDeviceResponse(callApi(params, req, runtime));
}

ClientUnbindDeviceResponse Alibabacloud_Avatar20220130::Client::clientUnbindDevice(shared_ptr<ClientUnbindDeviceRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
