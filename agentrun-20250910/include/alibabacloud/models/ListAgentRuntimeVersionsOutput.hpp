...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AgentRuntimeVersion> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<AgentRuntimeVersion>) };
    inline vector<AgentRuntimeVersion> items() { DARABONBA_PTR_GET(items_, vector<AgentRuntimeVersion>) };
  ...
  protected:
    std::shared_ptr<vector<AgentRuntimeVersion>> items_ = nullptr;
