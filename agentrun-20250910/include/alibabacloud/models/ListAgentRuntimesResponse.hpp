...
namespace Models
{
  ...
  public:
    ...
    inline const ListAgentRuntimesResult & body() const { DARABONBA_PTR_GET_CONST(body_, ListAgentRuntimesResult) };
    inline ListAgentRuntimesResult body() { DARABONBA_PTR_GET(body_, ListAgentRuntimesResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListAgentRuntimesResult> body_ = nullptr;
  };
