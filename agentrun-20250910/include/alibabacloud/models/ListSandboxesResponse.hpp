...
namespace Models
{
  ...
  public:
    ...
    inline const ListSandboxesResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSandboxesResult) };
    inline ListSandboxesResult getBody() { DARABONBA_PTR_GET(body_, ListSandboxesResult) };
  ...
  protected:
    ...
    shared_ptr<ListSandboxesResult> body_ {};
  };
