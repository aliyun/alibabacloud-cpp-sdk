...
namespace Models
{
  ...
  public:
    ...
    inline const ListTemplatesOutput & data() const { DARABONBA_PTR_GET_CONST(data_, ListTemplatesOutput) };
    inline ListTemplatesOutput data() { DARABONBA_PTR_GET(data_, ListTemplatesOutput) };
  ...
  protected:
    ...
    // 模板列表的详细信息
    std::shared_ptr<ListTemplatesOutput> data_ = nullptr;
    // 唯一的请求标识符，用于问题追踪
