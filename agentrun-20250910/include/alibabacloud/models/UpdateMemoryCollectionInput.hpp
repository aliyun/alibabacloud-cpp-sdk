...
#ifndef ALIBABACLOUD_MODELS_UPDATEMEMORYCOLLECTIONINPUT_HPP_
#define ALIBABACLOUD_MODELS_UPDATEMEMORYCOLLECTIONINPUT_HPP_
...
namespace Models
{
  class UpdateMemoryCollectionInput : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateMemoryCollectionInput& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateMemoryCollectionInput& obj) { 
    ...
    UpdateMemoryCollectionInput() = default ;
    UpdateMemoryCollectionInput(const UpdateMemoryCollectionInput &) = default ;
    UpdateMemoryCollectionInput(UpdateMemoryCollectionInput &&) = default ;
    UpdateMemoryCollectionInput(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateMemoryCollectionInput() = default ;
    UpdateMemoryCollectionInput& operator=(const UpdateMemoryCollectionInput &) = default ;
    UpdateMemoryCollectionInput& operator=(UpdateMemoryCollectionInput &&) = default ;
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        ...
        && this->networkConfiguration_ == nullptr && this->vectorStoreConfig_ == nullptr && this->workspaceId_ == nullptr; };
    // description Field Functions 
    bool hasDescription() const { return this->description_ != nullptr;};
    void deleteDescription() { this->description_ = nullptr;};
    inline string getDescription() const { DARABONBA_PTR_GET_DEFAULT(description_, "") };
    inline UpdateMemoryCollectionInput& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline UpdateMemoryCollectionInput& setEmbedderConfig(const EmbedderConfig & embedderConfig) { DARABONBA_PTR_SET_VALUE(embedderConfig_, embedderConfig) };
    inline UpdateMemoryCollectionInput& setEmbedderConfig(EmbedderConfig && embedderConfig) { DARABONBA_PTR_SET_RVALUE(embedderConfig_, embedderConfig) };
    ...
    inline UpdateMemoryCollectionInput& setEnableConversationHistory(bool enableConversationHistory) { DARABONBA_PTR_SET_VALUE(enableConversationHistory_, enableConversationHistory) };
    ...
    inline UpdateMemoryCollectionInput& setEnableConversationState(bool enableConversationState) { DARABONBA_PTR_SET_VALUE(enableConversationState_, enableConversationState) };
    ...
    inline UpdateMemoryCollectionInput& setExecutionRoleArn(string executionRoleArn) { DARABONBA_PTR_SET_VALUE(executionRoleArn_, executionRoleArn) };
    ...
    inline UpdateMemoryCollectionInput& setLlmConfig(const LLMConfig & llmConfig) { DARABONBA_PTR_SET_VALUE(llmConfig_, llmConfig) };
    inline UpdateMemoryCollectionInput& setLlmConfig(LLMConfig && llmConfig) { DARABONBA_PTR_SET_RVALUE(llmConfig_, llmConfig) };
    ...
    inline UpdateMemoryCollectionInput& setNetworkConfiguration(const NetworkConfiguration & networkConfiguration) { DARABONBA_PTR_SET_VALUE(networkConfiguration_, networkConfiguration) };
    inline UpdateMemoryCollectionInput& setNetworkConfiguration(NetworkConfiguration && networkConfiguration) { DARABONBA_PTR_SET_RVALUE(networkConfiguration_, networkConfiguration) };
    ...
    inline UpdateMemoryCollectionInput& setVectorStoreConfig(const VectorStoreConfig & vectorStoreConfig) { DARABONBA_PTR_SET_VALUE(vectorStoreConfig_, vectorStoreConfig) };
    inline UpdateMemoryCollectionInput& setVectorStoreConfig(VectorStoreConfig && vectorStoreConfig) { DARABONBA_PTR_SET_RVALUE(vectorStoreConfig_, vectorStoreConfig) };
    ...
    inline UpdateMemoryCollectionInput& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
