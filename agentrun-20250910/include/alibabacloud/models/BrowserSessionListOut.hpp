...
namespace Models
{
  ...
  public:
    ...
    inline const vector<BrowserSessionOut> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<BrowserSessionOut>) };
    inline vector<BrowserSessionOut> getItems() { DARABONBA_PTR_GET(items_, vector<BrowserSessionOut>) };
