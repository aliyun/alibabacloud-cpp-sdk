...
namespace Models
{
  ...
  public:
    ...
    inline Credential& setCreatedAt(string createdAt) { DARABONBA_PTR_SET_VALUE(createdAt_, createdAt) };
    ...
    inline Credential& setCredentialAuthType(string credentialAuthType) { DARABONBA_PTR_SET_VALUE(credentialAuthType_, credentialAuthType) };
    ...
    inline Credential& setCredentialSecret(string credentialSecret) { DARABONBA_PTR_SET_VALUE(credentialSecret_, credentialSecret) };
    ...
    inline Credential& setCredentialSourceType(string credentialSourceType) { DARABONBA_PTR_SET_VALUE(credentialSourceType_, credentialSourceType) };
    ...
    inline Credential& setEnabled(bool enabled) { DARABONBA_PTR_SET_VALUE(enabled_, enabled) };
    ...
    inline Credential& setRelatedResources(const vector<RelatedResource> & relatedResources) { DARABONBA_PTR_SET_VALUE(relatedResources_, relatedResources) };
    inline Credential& setRelatedResources(vector<RelatedResource> && relatedResources) { DARABONBA_PTR_SET_RVALUE(relatedResources_, relatedResources) };
