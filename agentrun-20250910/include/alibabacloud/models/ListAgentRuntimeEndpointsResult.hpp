...
namespace Models
{
  ...
  public:
    ...
    inline const ListAgentRuntimeEndpointsOutput & getData() const { DARABONBA_PTR_GET_CONST(data_, ListAgentRuntimeEndpointsOutput) };
    inline ListAgentRuntimeEndpointsOutput getData() { DARABONBA_PTR_GET(data_, ListAgentRuntimeEndpointsOutput) };
  ...
  protected:
    ...
    // 智能体运行时端点列表的详细信息
    shared_ptr<ListAgentRuntimeEndpointsOutput> data_ {};
    // 唯一的请求标识符，用于问题追踪
