...
namespace Models
{
  ...
  public:
    ...
    inline const Credential & data() const { DARABONBA_PTR_GET_CONST(data_, Credential) };
    inline Credential data() { DARABONBA_PTR_GET(data_, Credential) };
  ...
  protected:
    ...
    std::shared_ptr<Credential> data_ = nullptr;
