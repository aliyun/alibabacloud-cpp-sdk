...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->artifactType_ == nullptr
        && this->codeConfiguration_ == nullptr && this->containerConfiguration_ == nullptr && this->cpu_ == nullptr && this->createMethod_ == nullptr && this->createdAt_ == nullptr
        && this->credentialName_ == nullptr && this->description_ == nullptr && this->environmentVariables_ == nullptr && this->executionRoleArn_ == nullptr && this->logConfiguration_ == nullptr
        && this->mcpConfig_ == nullptr && this->memory_ == nullptr && this->nasConfig_ == nullptr && this->networkConfiguration_ == nullptr && this->ossMountConfig_ == nullptr
        && this->port_ == nullptr && this->protocolSpec_ == nullptr && this->status_ == nullptr && this->statusReason_ == nullptr && this->timeout_ == nullptr
        && this->toolId_ == nullptr && this->toolName_ == nullptr && this->toolType_ == nullptr && this->updatedAt_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline Tool& setArtifactType(string artifactType) { DARABONBA_PTR_SET_VALUE(artifactType_, artifactType) };
    ...
    inline Tool& setCodeConfiguration(const CodeConfiguration & codeConfiguration) { DARABONBA_PTR_SET_VALUE(codeConfiguration_, codeConfiguration) };
    inline Tool& setCodeConfiguration(CodeConfiguration && codeConfiguration) { DARABONBA_PTR_SET_RVALUE(codeConfiguration_, codeConfiguration) };
    ...
    inline Tool& setContainerConfiguration(const ContainerConfiguration & containerConfiguration) { DARABONBA_PTR_SET_VALUE(containerConfiguration_, containerConfiguration) };
    inline Tool& setContainerConfiguration(ContainerConfiguration && containerConfiguration) { DARABONBA_PTR_SET_RVALUE(containerConfiguration_, containerConfiguration) };
    ...
    inline Tool& setCpu(float cpu) { DARABONBA_PTR_SET_VALUE(cpu_, cpu) };
    ...
    inline Tool& setCreateMethod(string createMethod) { DARABONBA_PTR_SET_VALUE(createMethod_, createMethod) };
    ...
    inline Tool& setCreatedAt(string createdAt) { DARABONBA_PTR_SET_VALUE(createdAt_, createdAt) };
    ...
    inline Tool& setCredentialName(string credentialName) { DARABONBA_PTR_SET_VALUE(credentialName_, credentialName) };
    ...
    inline Tool& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline Tool& setEnvironmentVariables(const map<string, string> & environmentVariables) { DARABONBA_PTR_SET_VALUE(environmentVariables_, environmentVariables) };
    inline Tool& setEnvironmentVariables(map<string, string> && environmentVariables) { DARABONBA_PTR_SET_RVALUE(environmentVariables_, environmentVariables) };
    ...
    inline Tool& setExecutionRoleArn(string executionRoleArn) { DARABONBA_PTR_SET_VALUE(executionRoleArn_, executionRoleArn) };
    ...
    inline Tool& setLogConfiguration(const LogConfiguration & logConfiguration) { DARABONBA_PTR_SET_VALUE(logConfiguration_, logConfiguration) };
    inline Tool& setLogConfiguration(LogConfiguration && logConfiguration) { DARABONBA_PTR_SET_RVALUE(logConfiguration_, logConfiguration) };
    ...
    inline Tool& setMcpConfig(const McpConfig & mcpConfig) { DARABONBA_PTR_SET_VALUE(mcpConfig_, mcpConfig) };
    inline Tool& setMcpConfig(McpConfig && mcpConfig) { DARABONBA_PTR_SET_RVALUE(mcpConfig_, mcpConfig) };
    ...
    inline Tool& setMemory(int32_t memory) { DARABONBA_PTR_SET_VALUE(memory_, memory) };
    ...
    inline Tool& setNasConfig(const NASConfig & nasConfig) { DARABONBA_PTR_SET_VALUE(nasConfig_, nasConfig) };
    inline Tool& setNasConfig(NASConfig && nasConfig) { DARABONBA_PTR_SET_RVALUE(nasConfig_, nasConfig) };
    ...
    inline Tool& setNetworkConfiguration(const NetworkConfiguration & networkConfiguration) { DARABONBA_PTR_SET_VALUE(networkConfiguration_, networkConfiguration) };
    inline Tool& setNetworkConfiguration(NetworkConfiguration && networkConfiguration) { DARABONBA_PTR_SET_RVALUE(networkConfiguration_, networkConfiguration) };
    ...
    inline Tool& setOssMountConfig(const OSSMountConfig & ossMountConfig) { DARABONBA_PTR_SET_VALUE(ossMountConfig_, ossMountConfig) };
    inline Tool& setOssMountConfig(OSSMountConfig && ossMountConfig) { DARABONBA_PTR_SET_RVALUE(ossMountConfig_, ossMountConfig) };
    ...
    inline Tool& setPort(int32_t port) { DARABONBA_PTR_SET_VALUE(port_, port) };
    ...
    inline Tool& setProtocolSpec(string protocolSpec) { DARABONBA_PTR_SET_VALUE(protocolSpec_, protocolSpec) };
    ...
    inline Tool& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline Tool& setStatusReason(string statusReason) { DARABONBA_PTR_SET_VALUE(statusReason_, statusReason) };
    ...
    inline Tool& setTimeout(int32_t timeout) { DARABONBA_PTR_SET_VALUE(timeout_, timeout) };
    ...
    inline Tool& setToolType(string toolType) { DARABONBA_PTR_SET_VALUE(toolType_, toolType) };
    ...
    inline Tool& setUpdatedAt(string updatedAt) { DARABONBA_PTR_SET_VALUE(updatedAt_, updatedAt) };
    ...
    inline Tool& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
