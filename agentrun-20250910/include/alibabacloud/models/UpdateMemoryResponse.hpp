...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMemoryResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateMemoryResponseBody) };
    inline UpdateMemoryResponseBody body() { DARABONBA_PTR_GET(body_, UpdateMemoryResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateMemoryResponseBody> body_ = nullptr;
  };
