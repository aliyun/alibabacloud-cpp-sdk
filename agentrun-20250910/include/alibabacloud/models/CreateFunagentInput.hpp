...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->adminName_ == nullptr
        ...
        && this->description_ == nullptr && this->funAgentName_ == nullptr && this->memory_ == nullptr && this->regionId_ == nullptr && this->replicas_ == nullptr
    ...
    inline CreateFunagentInput& setDbInstanceId(string dbInstanceId) { DARABONBA_PTR_SET_VALUE(dbInstanceId_, dbInstanceId) };
