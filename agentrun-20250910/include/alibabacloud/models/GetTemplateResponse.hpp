...
namespace Models
{
  ...
  public:
    ...
    inline GetTemplateResponse& setBody(const TemplateResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline GetTemplateResponse& setBody(TemplateResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
