...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->armsConfiguration_ == nullptr
        && return this->containerConfiguration_ == nullptr && return this->cpu_ == nullptr && return this->credentialConfiguration_ == nullptr && return this->description_ == nullptr && return this->environmentVariables_ == nullptr
        && return this->executionRoleArn_ == nullptr && return this->logConfiguration_ == nullptr && return this->memory_ == nullptr && return this->networkConfiguration_ == nullptr && return this->ossConfiguration_ == nullptr
        && return this->sandboxIdleTimeoutInSeconds_ == nullptr && return this->sandboxTTLInSeconds_ == nullptr && return this->templateConfiguration_ == nullptr; };
