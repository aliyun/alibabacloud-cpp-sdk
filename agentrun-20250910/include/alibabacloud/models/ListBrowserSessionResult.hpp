...
namespace Models
{
  ...
  public:
    ...
    inline const BrowserSessionListOut & getData() const { DARABONBA_PTR_GET_CONST(data_, BrowserSessionListOut) };
    inline BrowserSessionListOut getData() { DARABONBA_PTR_GET(data_, BrowserSessionListOut) };
  ...
  protected:
    ...
    shared_ptr<BrowserSessionListOut> data_ {};
