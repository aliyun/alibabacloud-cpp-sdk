...
#include <alibabacloud/models/UpdateFlowInput.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFlowInput & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateFlowInput) };
    inline UpdateFlowInput getBody() { DARABONBA_PTR_GET(body_, UpdateFlowInput) };
    inline UpdateFlowRequest& setBody(const UpdateFlowInput & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline UpdateFlowRequest& setBody(UpdateFlowInput && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
