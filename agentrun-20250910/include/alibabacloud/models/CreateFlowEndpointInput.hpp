...
namespace Models
{
  ...
  public:
    ...
    inline CreateFlowEndpointInput& setTags(const vector<string> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline CreateFlowEndpointInput& setTags(vector<string> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
