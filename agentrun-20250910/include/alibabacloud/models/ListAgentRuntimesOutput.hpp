...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AgentRuntime> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<AgentRuntime>) };
    inline vector<AgentRuntime> items() { DARABONBA_PTR_GET(items_, vector<AgentRuntime>) };
  ...
  protected:
    std::shared_ptr<vector<AgentRuntime>> items_ = nullptr;
