...
namespace Models
{
  ...
  public:
    ...
    inline const ListModelServicesResult & body() const { DARABONBA_PTR_GET_CONST(body_, ListModelServicesResult) };
    inline ListModelServicesResult body() { DARABONBA_PTR_GET(body_, ListModelServicesResult) };
    inline ListModelServicesResponse& setBody(const ListModelServicesResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline ListModelServicesResponse& setBody(ListModelServicesResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<ListModelServicesResult> body_ = nullptr;
  };
