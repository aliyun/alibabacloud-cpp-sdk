...
namespace Models
{
  ...
  public:
    ...
    inline const ListModelServicesResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListModelServicesResult) };
    inline ListModelServicesResult getBody() { DARABONBA_PTR_GET(body_, ListModelServicesResult) };
  ...
  protected:
    ...
    shared_ptr<ListModelServicesResult> body_ {};
  };
