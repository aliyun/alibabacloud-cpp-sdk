...
namespace Models
{
  ...
  public:
    ...
    inline DeleteFlowVersionResponse& setBody(const CommonResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline DeleteFlowVersionResponse& setBody(CommonResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
