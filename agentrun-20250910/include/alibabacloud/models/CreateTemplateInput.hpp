...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allowAnonymousManage_ == nullptr
        ...
        && this->logConfiguration_ == nullptr && this->memory_ == nullptr && this->nasConfig_ == nullptr && this->networkConfiguration_ == nullptr && this->ossConfiguration_ == nullptr
        && this->preStopTimeoutInSeconds_ == nullptr && this->sandboxIdleTimeoutInSeconds_ == nullptr && this->sandboxTTLInSeconds_ == nullptr && this->scalingConfig_ == nullptr && this->templateConfiguration_ == nullptr
        && this->templateName_ == nullptr && this->templateType_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline CreateTemplateInput& setAllowAnonymousManage(bool allowAnonymousManage) { DARABONBA_PTR_SET_VALUE(allowAnonymousManage_, allowAnonymousManage) };
    ...
    inline CreateTemplateInput& setEnablePreStop(bool enablePreStop) { DARABONBA_PTR_SET_VALUE(enablePreStop_, enablePreStop) };
    ...
    inline CreateTemplateInput& setPreStopTimeoutInSeconds(int32_t preStopTimeoutInSeconds) { DARABONBA_PTR_SET_VALUE(preStopTimeoutInSeconds_, preStopTimeoutInSeconds) };
