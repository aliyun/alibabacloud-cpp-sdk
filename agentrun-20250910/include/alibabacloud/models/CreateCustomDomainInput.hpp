...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->certConfig_ == nullptr
        && this->description_ == nullptr && this->domainName_ == nullptr && this->domainType_ == nullptr && this->protocol_ == nullptr && this->routeConfig_ == nullptr
        && this->tlsConfig_ == nullptr; };
    ...
    inline CreateCustomDomainInput& setDomainType(string domainType) { DARABONBA_PTR_SET_VALUE(domainType_, domainType) };
