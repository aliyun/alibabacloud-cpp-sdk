...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AgentRuntimeEndpoint> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<AgentRuntimeEndpoint>) };
    inline vector<AgentRuntimeEndpoint> getItems() { DARABONBA_PTR_GET(items_, vector<AgentRuntimeEndpoint>) };
  ...
  protected:
    shared_ptr<vector<AgentRuntimeEndpoint>> items_ {};
