...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Browser> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<Browser>) };
    inline vector<Browser> getItems() { DARABONBA_PTR_GET(items_, vector<Browser>) };
