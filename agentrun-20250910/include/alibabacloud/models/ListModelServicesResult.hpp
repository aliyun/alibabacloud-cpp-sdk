...
namespace Models
{
  ...
  public:
    ...
    inline const ListModelServicesOutput & data() const { DARABONBA_PTR_GET_CONST(data_, ListModelServicesOutput) };
    inline ListModelServicesOutput data() { DARABONBA_PTR_GET(data_, ListModelServicesOutput) };
  ...
  protected:
    ...
    std::shared_ptr<ListModelServicesOutput> data_ = nullptr;
