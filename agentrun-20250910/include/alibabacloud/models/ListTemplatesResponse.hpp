...
namespace Models
{
  ...
  public:
    ...
    inline const ListTemplatesResult & body() const { DARABONBA_PTR_GET_CONST(body_, ListTemplatesResult) };
    inline ListTemplatesResult body() { DARABONBA_PTR_GET(body_, ListTemplatesResult) };
    inline ListTemplatesResponse& setBody(const ListTemplatesResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline ListTemplatesResponse& setBody(ListTemplatesResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<ListTemplatesResult> body_ = nullptr;
  };
