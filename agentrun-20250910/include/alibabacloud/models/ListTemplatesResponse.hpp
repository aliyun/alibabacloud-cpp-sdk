...
namespace Models
{
  ...
  public:
    ...
    inline const ListTemplatesResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTemplatesResult) };
    inline ListTemplatesResult getBody() { DARABONBA_PTR_GET(body_, ListTemplatesResult) };
  ...
  protected:
    ...
    shared_ptr<ListTemplatesResult> body_ {};
  };
