...
namespace Models
{
  ...
  public:
    ...
    inline const StopSandboxResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopSandboxResult) };
    inline StopSandboxResult getBody() { DARABONBA_PTR_GET(body_, StopSandboxResult) };
  ...
  protected:
    ...
    shared_ptr<StopSandboxResult> body_ {};
  };
