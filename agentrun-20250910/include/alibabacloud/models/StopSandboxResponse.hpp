...
namespace Models
{
  ...
  public:
    ...
    inline StopSandboxResponse& setBody(const DeleteSandboxResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline StopSandboxResponse& setBody(DeleteSandboxResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
