...
namespace Models
{
  ...
  public:
    ...
    inline const ListCodeInterpretersOutput & getData() const { DARABONBA_PTR_GET_CONST(data_, ListCodeInterpretersOutput) };
    inline ListCodeInterpretersOutput getData() { DARABONBA_PTR_GET(data_, ListCodeInterpretersOutput) };
  ...
  protected:
    ...
    // 代码解释器列表的详细信息
    shared_ptr<ListCodeInterpretersOutput> data_ {};
    // 唯一的请求标识符，用于问题追踪
