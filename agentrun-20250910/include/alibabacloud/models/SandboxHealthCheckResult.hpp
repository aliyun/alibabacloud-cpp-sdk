...
namespace Models
{
  ...
  public:
    ...
    inline const SandboxHealthCheckOut & getData() const { DARABONBA_PTR_GET_CONST(data_, SandboxHealthCheckOut) };
    inline SandboxHealthCheckOut getData() { DARABONBA_PTR_GET(data_, SandboxHealthCheckOut) };
  ...
  protected:
    ...
    shared_ptr<SandboxHealthCheckOut> data_ {};
    // 唯一的请求标识符，用于问题追踪
