...
namespace Models
{
  ...
  public:
    ...
    inline DeleteKnowledgeBaseResponse& setBody(const KnowledgeBaseResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline DeleteKnowledgeBaseResponse& setBody(KnowledgeBaseResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
