...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->agentRuntimeName_ != nullptr
        && this->artifactType_ != nullptr && this->codeConfiguration_ != nullptr && this->containerConfiguration_ != nullptr && this->cpu_ != nullptr && this->description_ != nullptr
        && this->environmentVariables_ != nullptr && this->executionRoleArn_ != nullptr && this->healthCheckConfiguration_ != nullptr && this->logConfiguration_ != nullptr && this->memory_ != nullptr
