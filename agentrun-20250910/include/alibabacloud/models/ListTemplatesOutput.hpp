...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Template> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<Template>) };
    inline vector<Template> items() { DARABONBA_PTR_GET(items_, vector<Template>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Template>> items_ = nullptr;
    // This parameter is required.
