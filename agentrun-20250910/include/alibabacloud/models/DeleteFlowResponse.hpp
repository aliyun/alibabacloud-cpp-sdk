...
namespace Models
{
  ...
  public:
    ...
    inline const CommonResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, CommonResult) };
    inline CommonResult getBody() { DARABONBA_PTR_GET(body_, CommonResult) };
    inline DeleteFlowResponse& setBody(const CommonResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline DeleteFlowResponse& setBody(CommonResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<map<string, string>> headers_ {};
    shared_ptr<int32_t> statusCode_ {};
    shared_ptr<CommonResult> body_ {};
  };
