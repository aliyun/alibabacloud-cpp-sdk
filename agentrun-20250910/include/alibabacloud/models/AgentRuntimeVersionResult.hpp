...
namespace Models
{
  ...
  public:
    ...
    inline const AgentRuntimeVersion & getData() const { DARABONBA_PTR_GET_CONST(data_, AgentRuntimeVersion) };
    inline AgentRuntimeVersion getData() { DARABONBA_PTR_GET(data_, AgentRuntimeVersion) };
  ...
  protected:
    ...
    // 智能体运行时版本的详细信息
    shared_ptr<AgentRuntimeVersion> data_ {};
    // 唯一的请求标识符，用于问题追踪
