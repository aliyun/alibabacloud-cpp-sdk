...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentRuntimeName_ == nullptr
        ...
        && this->credentialId_ == nullptr && this->credentialName_ == nullptr && this->description_ == nullptr && this->disableOndemand_ == nullptr && this->disableSessionAffinity_ == nullptr
        ...
        && this->externalAgentEndpointUrl_ == nullptr && this->headerFieldName_ == nullptr && this->healthCheckConfiguration_ == nullptr && this->logConfiguration_ == nullptr && this->memory_ == nullptr
        ...
        && this->resourceGroupId_ == nullptr && this->sessionAffinityType_ == nullptr && this->sessionConcurrencyLimitPerInstance_ == nullptr && this->sessionIdleTimeoutSeconds_ == nullptr && this->systemTags_ == nullptr
    ...
    inline CreateAgentRuntimeInput& setDisableOndemand(bool disableOndemand) { DARABONBA_PTR_SET_VALUE(disableOndemand_, disableOndemand) };
    ...
    inline CreateAgentRuntimeInput& setDisableSessionAffinity(bool disableSessionAffinity) { DARABONBA_PTR_SET_VALUE(disableSessionAffinity_, disableSessionAffinity) };
    ...
    inline CreateAgentRuntimeInput& setHeaderFieldName(string headerFieldName) { DARABONBA_PTR_SET_VALUE(headerFieldName_, headerFieldName) };
    ...
    inline CreateAgentRuntimeInput& setSessionAffinityType(string sessionAffinityType) { DARABONBA_PTR_SET_VALUE(sessionAffinityType_, sessionAffinityType) };
