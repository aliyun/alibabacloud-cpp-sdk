...
namespace Models
{
  ...
  public:
    ...
    inline UpdateFlowEndpointInput& setDisablePublicNetworkAccess(bool disablePublicNetworkAccess) { DARABONBA_PTR_SET_VALUE(disablePublicNetworkAccess_, disablePublicNetworkAccess) };
