...
#ifndef ALIBABACLOUD_MODELS_CREATEMODELINPUT_HPP_
#define ALIBABACLOUD_MODELS_CREATEMODELINPUT_HPP_
...
namespace Models
{
  class CreateModelInput : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateModelInput& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateModelInput& obj) { 
    ...
    CreateModelInput() = default ;
    CreateModelInput(const CreateModelInput &) = default ;
    CreateModelInput(CreateModelInput &&) = default ;
    CreateModelInput(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateModelInput() = default ;
    CreateModelInput& operator=(const CreateModelInput &) = default ;
    CreateModelInput& operator=(CreateModelInput &&) = default ;
