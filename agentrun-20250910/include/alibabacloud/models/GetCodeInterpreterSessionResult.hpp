...
namespace Models
{
  ...
  public:
    ...
    inline const CodeInterpreterSessionOut & getData() const { DARABONBA_PTR_GET_CONST(data_, CodeInterpreterSessionOut) };
    inline CodeInterpreterSessionOut getData() { DARABONBA_PTR_GET(data_, CodeInterpreterSessionOut) };
  ...
  protected:
    ...
    shared_ptr<CodeInterpreterSessionOut> data_ {};
