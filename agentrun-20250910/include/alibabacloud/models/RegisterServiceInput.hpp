...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->credentialName_ == nullptr
        && this->protocol_ == nullptr && this->resourceName_ == nullptr && this->serviceBackendEndpoint_ == nullptr && this->serviceName_ == nullptr && this->serviceType_ == nullptr
    ...
    inline string getServiceBackendEndpoint() const { DARABONBA_PTR_GET_DEFAULT(serviceBackendEndpoint_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> serviceBackendEndpoint_ {};
    // 服务名称，在租户内唯一
    // 
    // This parameter is required.
