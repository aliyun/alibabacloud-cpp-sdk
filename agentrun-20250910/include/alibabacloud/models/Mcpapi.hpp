...
namespace Models
{
  ...
  public:
    ...
    inline const MCPBackendConfig & getBackendConfig() const { DARABONBA_PTR_GET_CONST(backendConfig_, MCPBackendConfig) };
    inline MCPBackendConfig getBackendConfig() { DARABONBA_PTR_GET(backendConfig_, MCPBackendConfig) };
    ...
    inline const MCPMatch & getMatch() const { DARABONBA_PTR_GET_CONST(match_, MCPMatch) };
    inline MCPMatch getMatch() { DARABONBA_PTR_GET(match_, MCPMatch) };
