...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const Flow& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(flowArn, flowArn_);
    ...
    friend void from_json(const Darabonba::Json& j, Flow& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(flowArn, flowArn_);
    ...
    virtual bool empty() const override { return this->createdAt_ == nullptr
        && this->definition_ == nullptr && this->description_ == nullptr && this->environmentConfiguration_ == nullptr && this->executionRoleArn_ == nullptr && this->externalStorageLocation_ == nullptr
        && this->flowArn_ == nullptr && this->flowId_ == nullptr && this->flowName_ == nullptr && this->lastUpdatedAt_ == nullptr && this->loggingConfiguration_ == nullptr
        && this->resourceGroupId_ == nullptr && this->tags_ == nullptr && this->tracingConfiguration_ == nullptr && this->workspaceId_ == nullptr; };
    // createdAt Field Functions 
    bool hasCreatedAt() const { return this->createdAt_ != nullptr;};
    void deleteCreatedAt() { this->createdAt_ = nullptr;};
    inline string getCreatedAt() const { DARABONBA_PTR_GET_DEFAULT(createdAt_, "") };
    inline Flow& setCreatedAt(string createdAt) { DARABONBA_PTR_SET_VALUE(createdAt_, createdAt) };
    ...
    inline Flow& setExecutionRoleArn(string executionRoleArn) { DARABONBA_PTR_SET_VALUE(executionRoleArn_, executionRoleArn) };
    ...
    inline Flow& setExternalStorageLocation(string externalStorageLocation) { DARABONBA_PTR_SET_VALUE(externalStorageLocation_, externalStorageLocation) };


    // flowArn Field Functions 
    bool hasFlowArn() const { return this->flowArn_ != nullptr;};
    void deleteFlowArn() { this->flowArn_ = nullptr;};
    inline string getFlowArn() const { DARABONBA_PTR_GET_DEFAULT(flowArn_, "") };
    inline Flow& setFlowArn(string flowArn) { DARABONBA_PTR_SET_VALUE(flowArn_, flowArn) };
    ...
    inline Flow& setLastUpdatedAt(string lastUpdatedAt) { DARABONBA_PTR_SET_VALUE(lastUpdatedAt_, lastUpdatedAt) };
    ...
    inline Flow& setLoggingConfiguration(const LoggingConfiguration & loggingConfiguration) { DARABONBA_PTR_SET_VALUE(loggingConfiguration_, loggingConfiguration) };
    inline Flow& setLoggingConfiguration(LoggingConfiguration && loggingConfiguration) { DARABONBA_PTR_SET_RVALUE(loggingConfiguration_, loggingConfiguration) };
    ...
    inline Flow& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline Flow& setTags(const vector<string> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline Flow& setTags(vector<string> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
    ...
    inline Flow& setTracingConfiguration(const TracingConfiguration & tracingConfiguration) { DARABONBA_PTR_SET_VALUE(tracingConfiguration_, tracingConfiguration) };
    inline Flow& setTracingConfiguration(TracingConfiguration && tracingConfiguration) { DARABONBA_PTR_SET_RVALUE(tracingConfiguration_, tracingConfiguration) };
