...
namespace Models
{
  ...
  public:
    ...
    inline const ListWorkspacesResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListWorkspacesResult) };
    inline ListWorkspacesResult getBody() { DARABONBA_PTR_GET(body_, ListWorkspacesResult) };
    inline ListWorkspacesResponse& setBody(const ListWorkspacesResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline ListWorkspacesResponse& setBody(ListWorkspacesResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<map<string, string>> headers_ {};
    shared_ptr<int32_t> statusCode_ {};
    shared_ptr<ListWorkspacesResult> body_ {};
  };
