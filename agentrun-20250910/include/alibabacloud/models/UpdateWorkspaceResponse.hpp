...
namespace Models
{
  ...
  public:
    ...
    inline UpdateWorkspaceResponse& setBody(const WorkspaceResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline UpdateWorkspaceResponse& setBody(WorkspaceResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
