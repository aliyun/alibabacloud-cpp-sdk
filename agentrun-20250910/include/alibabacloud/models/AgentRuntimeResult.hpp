...
namespace Models
{
  ...
  public:
    ...
    inline const AgentRuntime & getData() const { DARABONBA_PTR_GET_CONST(data_, AgentRuntime) };
    inline AgentRuntime getData() { DARABONBA_PTR_GET(data_, AgentRuntime) };
