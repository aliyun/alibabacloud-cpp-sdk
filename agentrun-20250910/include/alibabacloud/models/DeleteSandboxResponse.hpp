...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSandboxResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSandboxResult) };
    inline DeleteSandboxResult getBody() { DARABONBA_PTR_GET(body_, DeleteSandboxResult) };
  ...
  protected:
    ...
    shared_ptr<DeleteSandboxResult> body_ {};
  };
