...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomDomainsResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCustomDomainsResult) };
    inline ListCustomDomainsResult getBody() { DARABONBA_PTR_GET(body_, ListCustomDomainsResult) };
    inline ListCustomDomainsResponse& setBody(const ListCustomDomainsResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline ListCustomDomainsResponse& setBody(ListCustomDomainsResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<map<string, string>> headers_ {};
    shared_ptr<int32_t> statusCode_ {};
    shared_ptr<ListCustomDomainsResult> body_ {};
  };
