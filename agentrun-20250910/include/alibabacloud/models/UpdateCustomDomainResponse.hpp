...
namespace Models
{
  ...
  public:
    ...
    inline UpdateCustomDomainResponse& setBody(const CustomDomainResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline UpdateCustomDomainResponse& setBody(CustomDomainResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
