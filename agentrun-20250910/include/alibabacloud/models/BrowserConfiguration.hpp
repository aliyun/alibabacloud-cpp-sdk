...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->browserType_ == nullptr
        && return this->enableExtension_ == nullptr && return this->headless_ == nullptr && return this->userAgent_ == nullptr && return this->viewPort_ == nullptr; };
    ...
    inline string browserType() const { DARABONBA_PTR_GET_DEFAULT(browserType_, "") };
    ...
    inline const vector<string> & enableExtension() const { DARABONBA_PTR_GET_CONST(enableExtension_, vector<string>) };
    inline vector<string> enableExtension() { DARABONBA_PTR_GET(enableExtension_, vector<string>) };
    ...
    inline bool headless() const { DARABONBA_PTR_GET_DEFAULT(headless_, false) };
    ...
    inline const ViewPortConfiguration & viewPort() const { DARABONBA_PTR_GET_CONST(viewPort_, ViewPortConfiguration) };
    inline ViewPortConfiguration viewPort() { DARABONBA_PTR_GET(viewPort_, ViewPortConfiguration) };
  ...
  protected:
    std::shared_ptr<string> browserType_ = nullptr;
    // 要启用的浏览器扩展列表
    std::shared_ptr<vector<string>> enableExtension_ = nullptr;
    // 是否以无头模式运行浏览器
    std::shared_ptr<bool> headless_ = nullptr;
    // 浏览器用户代理字符串
    std::shared_ptr<string> userAgent_ = nullptr;
    std::shared_ptr<ViewPortConfiguration> viewPort_ = nullptr;
  };
