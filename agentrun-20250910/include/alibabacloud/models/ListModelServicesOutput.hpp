...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ModelService> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<ModelService>) };
    inline vector<ModelService> getItems() { DARABONBA_PTR_GET(items_, vector<ModelService>) };
  ...
  protected:
    shared_ptr<vector<ModelService>> items_ {};
