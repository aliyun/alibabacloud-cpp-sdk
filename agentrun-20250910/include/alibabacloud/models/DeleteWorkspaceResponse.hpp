...
namespace Models
{
  ...
  public:
    ...
    inline DeleteWorkspaceResponse& setBody(const WorkspaceResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline DeleteWorkspaceResponse& setBody(WorkspaceResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
