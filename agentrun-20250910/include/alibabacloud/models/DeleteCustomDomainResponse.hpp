...
namespace Models
{
  ...
  public:
    ...
    inline DeleteCustomDomainResponse& setBody(const CustomDomainResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline DeleteCustomDomainResponse& setBody(CustomDomainResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
