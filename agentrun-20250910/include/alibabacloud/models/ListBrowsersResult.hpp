...
namespace Models
{
  ...
  public:
    ...
    inline const ListBrowsersOutput & getData() const { DARABONBA_PTR_GET_CONST(data_, ListBrowsersOutput) };
    inline ListBrowsersOutput getData() { DARABONBA_PTR_GET(data_, ListBrowsersOutput) };
