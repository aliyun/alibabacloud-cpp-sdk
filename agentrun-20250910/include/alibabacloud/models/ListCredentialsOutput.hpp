...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CredentialListItem> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<CredentialListItem>) };
    inline vector<CredentialListItem> getItems() { DARABONBA_PTR_GET(items_, vector<CredentialListItem>) };
  ...
  protected:
    shared_ptr<vector<CredentialListItem>> items_ {};
