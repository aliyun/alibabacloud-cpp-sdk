...
namespace Models
{
  ...
  public:
    ...
    inline AgentRuntime& setEdition(string edition) { DARABONBA_PTR_SET_VALUE(edition_, edition) };
    ...
    inline AgentRuntime& setEnableSessionIsolation(bool enableSessionIsolation) { DARABONBA_PTR_SET_VALUE(enableSessionIsolation_, enableSessionIsolation) };
