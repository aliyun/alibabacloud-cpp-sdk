...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateToolData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateToolData) };
    inline UpdateToolData data() { DARABONBA_PTR_GET(data_, UpdateToolData) };
  ...
  protected:
    std::shared_ptr<UpdateToolData> data_ = nullptr;
