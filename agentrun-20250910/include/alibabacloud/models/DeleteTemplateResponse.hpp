...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTemplateResult & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteTemplateResult) };
    inline DeleteTemplateResult body() { DARABONBA_PTR_GET(body_, DeleteTemplateResult) };
    inline DeleteTemplateResponse& setBody(const DeleteTemplateResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline DeleteTemplateResponse& setBody(DeleteTemplateResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<DeleteTemplateResult> body_ = nullptr;
  };
