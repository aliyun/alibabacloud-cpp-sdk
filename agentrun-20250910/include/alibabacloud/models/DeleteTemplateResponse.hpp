...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTemplateResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTemplateResult) };
    inline DeleteTemplateResult getBody() { DARABONBA_PTR_GET(body_, DeleteTemplateResult) };
  ...
  protected:
    ...
    shared_ptr<DeleteTemplateResult> body_ {};
  };
