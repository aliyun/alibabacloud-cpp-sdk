...
namespace Models
{
  ...
  public:
    ...
    inline const vector<MCPServiceConfig> & services() const { DARABONBA_PTR_GET_CONST(services_, vector<MCPServiceConfig>) };
    inline vector<MCPServiceConfig> services() { DARABONBA_PTR_GET(services_, vector<MCPServiceConfig>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<MCPServiceConfig>> services_ = nullptr;
  };
