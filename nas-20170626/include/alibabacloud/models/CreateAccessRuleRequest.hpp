...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessGroupName_ == nullptr
        && return this->fileSystemType_ == nullptr && return this->ipv6SourceCidrIp_ == nullptr && return this->priority_ == nullptr && return this->RWAccessType_ == nullptr && return this->sourceCidrIp_ == nullptr
        && return this->userAccessType_ == nullptr; };
