...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataFlowSubTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDataFlowSubTasksResponseBody) };
    inline DescribeDataFlowSubTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDataFlowSubTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDataFlowSubTasksResponseBody> body_ {};
  };
