...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeFileSystemsResponseBodyFileSystems & fileSystems() const { DARABONBA_PTR_GET_CONST(fileSystems_, DescribeFileSystemsResponseBodyFileSystems) };
    inline DescribeFileSystemsResponseBodyFileSystems fileSystems() { DARABONBA_PTR_GET(fileSystems_, DescribeFileSystemsResponseBodyFileSystems) };
    inline DescribeFileSystemsResponseBody& setFileSystems(const DescribeFileSystemsResponseBodyFileSystems & fileSystems) { DARABONBA_PTR_SET_VALUE(fileSystems_, fileSystems) };
    inline DescribeFileSystemsResponseBody& setFileSystems(DescribeFileSystemsResponseBodyFileSystems && fileSystems) { DARABONBA_PTR_SET_RVALUE(fileSystems_, fileSystems) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeFileSystemsResponseBodyFileSystems> fileSystems_ = nullptr;
    // The page number.
