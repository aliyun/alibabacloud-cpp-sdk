...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDirQuotasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDirQuotasResponseBody) };
    inline DescribeDirQuotasResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDirQuotasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDirQuotasResponseBody> body_ {};
  };
