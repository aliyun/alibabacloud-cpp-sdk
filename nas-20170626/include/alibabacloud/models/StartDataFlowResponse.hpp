...
namespace Models
{
  ...
  public:
    ...
    inline const StartDataFlowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartDataFlowResponseBody) };
    inline StartDataFlowResponseBody getBody() { DARABONBA_PTR_GET(body_, StartDataFlowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartDataFlowResponseBody> body_ {};
  };
