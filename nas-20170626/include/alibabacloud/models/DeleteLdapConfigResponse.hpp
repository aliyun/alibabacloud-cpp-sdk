...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLDAPConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLDAPConfigResponseBody) };
    inline DeleteLDAPConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLDAPConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLDAPConfigResponseBody> body_ {};
  };
