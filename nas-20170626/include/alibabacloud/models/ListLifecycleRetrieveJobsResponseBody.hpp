...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->lifecycleRetrieveJobs_ != nullptr
    ...
    inline const vector<ListLifecycleRetrieveJobsResponseBodyLifecycleRetrieveJobs> & lifecycleRetrieveJobs() const { DARABONBA_PTR_GET_CONST(lifecycleRetrieveJobs_, vector<ListLifecycleRetrieveJobsResponseBodyLifecycleRetrieveJobs>) };
    inline vector<ListLifecycleRetrieveJobsResponseBodyLifecycleRetrieveJobs> lifecycleRetrieveJobs() { DARABONBA_PTR_GET(lifecycleRetrieveJobs_, vector<ListLifecycleRetrieveJobsResponseBodyLifecycleRetrieveJobs>) };
    inline ListLifecycleRetrieveJobsResponseBody& setLifecycleRetrieveJobs(const vector<ListLifecycleRetrieveJobsResponseBodyLifecycleRetrieveJobs> & lifecycleRetrieveJobs) { DARABONBA_PTR_SET_VALUE(lifecycleRetrieveJobs_, lifecycleRetrieveJobs) };
    inline ListLifecycleRetrieveJobsResponseBody& setLifecycleRetrieveJobs(vector<ListLifecycleRetrieveJobsResponseBodyLifecycleRetrieveJobs> && lifecycleRetrieveJobs) { DARABONBA_PTR_SET_RVALUE(lifecycleRetrieveJobs_, lifecycleRetrieveJobs) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListLifecycleRetrieveJobsResponseBodyLifecycleRetrieveJobs>> lifecycleRetrieveJobs_ = nullptr;
