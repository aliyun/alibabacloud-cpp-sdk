...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessGroupName_ == nullptr
        && return this->clientMasterNodes_ == nullptr && return this->dualStackMountTargetDomain_ == nullptr && return this->mountTargetDomain_ == nullptr && return this->networkType_ == nullptr && return this->status_ == nullptr
        && return this->tags_ == nullptr && return this->vpcId_ == nullptr && return this->vswId_ == nullptr; };
