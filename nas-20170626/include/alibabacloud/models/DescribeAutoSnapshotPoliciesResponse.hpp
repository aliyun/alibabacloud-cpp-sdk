...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAutoSnapshotPoliciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAutoSnapshotPoliciesResponseBody) };
    inline DescribeAutoSnapshotPoliciesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAutoSnapshotPoliciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAutoSnapshotPoliciesResponseBody> body_ {};
  };
