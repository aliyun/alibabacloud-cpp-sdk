...
#ifndef ALIBABACLOUD_MODELS_GETAGENTICSPACERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETAGENTICSPACERESPONSEBODY_HPP_
...
namespace Models
{
  class GetAgenticSpaceResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetAgenticSpaceResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AgenticSpace, agenticSpace_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetAgenticSpaceResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AgenticSpace, agenticSpace_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    GetAgenticSpaceResponseBody() = default ;
    GetAgenticSpaceResponseBody(const GetAgenticSpaceResponseBody &) = default ;
    GetAgenticSpaceResponseBody(GetAgenticSpaceResponseBody &&) = default ;
    GetAgenticSpaceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAgenticSpaceResponseBody() = default ;
    GetAgenticSpaceResponseBody& operator=(const GetAgenticSpaceResponseBody &) = default ;
    GetAgenticSpaceResponseBody& operator=(GetAgenticSpaceResponseBody &&) = default ;
    ...
    inline const GetAgenticSpaceResponseBody::AgenticSpace & getAgenticSpace() const { DARABONBA_PTR_GET_CONST(agenticSpace_, GetAgenticSpaceResponseBody::AgenticSpace) };
    inline GetAgenticSpaceResponseBody::AgenticSpace getAgenticSpace() { DARABONBA_PTR_GET(agenticSpace_, GetAgenticSpaceResponseBody::AgenticSpace) };
    inline GetAgenticSpaceResponseBody& setAgenticSpace(const GetAgenticSpaceResponseBody::AgenticSpace & agenticSpace) { DARABONBA_PTR_SET_VALUE(agenticSpace_, agenticSpace) };
    inline GetAgenticSpaceResponseBody& setAgenticSpace(GetAgenticSpaceResponseBody::AgenticSpace && agenticSpace) { DARABONBA_PTR_SET_RVALUE(agenticSpace_, agenticSpace) };
    ...
    inline GetAgenticSpaceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
