...
namespace Models
{
  ...
  public:
    ...
    inline const CancelFilesetQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelFilesetQuotaResponseBody) };
    inline CancelFilesetQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelFilesetQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelFilesetQuotaResponseBody> body_ {};
  };
