...
namespace Models
{
  ...
  public:
    ...
    inline const SetDirQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetDirQuotaResponseBody) };
    inline SetDirQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, SetDirQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetDirQuotaResponseBody> body_ {};
  };
