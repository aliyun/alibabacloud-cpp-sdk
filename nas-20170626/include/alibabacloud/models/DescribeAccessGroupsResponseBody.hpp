...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->accessGroups_ != nullptr
    ...
    inline const DescribeAccessGroupsResponseBodyAccessGroups & accessGroups() const { DARABONBA_PTR_GET_CONST(accessGroups_, DescribeAccessGroupsResponseBodyAccessGroups) };
    inline DescribeAccessGroupsResponseBodyAccessGroups accessGroups() { DARABONBA_PTR_GET(accessGroups_, DescribeAccessGroupsResponseBodyAccessGroups) };
    inline DescribeAccessGroupsResponseBody& setAccessGroups(const DescribeAccessGroupsResponseBodyAccessGroups & accessGroups) { DARABONBA_PTR_SET_VALUE(accessGroups_, accessGroups) };
    inline DescribeAccessGroupsResponseBody& setAccessGroups(DescribeAccessGroupsResponseBodyAccessGroups && accessGroups) { DARABONBA_PTR_SET_RVALUE(accessGroups_, accessGroups) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAccessGroupsResponseBodyAccessGroups> accessGroups_ = nullptr;
    // The page number.
