...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DetachVscFromFilesystemsRequestResourceIds> & resourceIds() const { DARABONBA_PTR_GET_CONST(resourceIds_, vector<DetachVscFromFilesystemsRequestResourceIds>) };
    inline vector<DetachVscFromFilesystemsRequestResourceIds> resourceIds() { DARABONBA_PTR_GET(resourceIds_, vector<DetachVscFromFilesystemsRequestResourceIds>) };
    inline DetachVscFromFilesystemsRequest& setResourceIds(const vector<DetachVscFromFilesystemsRequestResourceIds> & resourceIds) { DARABONBA_PTR_SET_VALUE(resourceIds_, resourceIds) };
    inline DetachVscFromFilesystemsRequest& setResourceIds(vector<DetachVscFromFilesystemsRequestResourceIds> && resourceIds) { DARABONBA_PTR_SET_RVALUE(resourceIds_, resourceIds) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DetachVscFromFilesystemsRequestResourceIds>> resourceIds_ = nullptr;
  };
