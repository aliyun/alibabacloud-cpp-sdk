...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DetachVscFromFilesystemsRequest::RoleChain> & getRoleChain() const { DARABONBA_PTR_GET_CONST(roleChain_, vector<DetachVscFromFilesystemsRequest::RoleChain>) };
    inline vector<DetachVscFromFilesystemsRequest::RoleChain> getRoleChain() { DARABONBA_PTR_GET(roleChain_, vector<DetachVscFromFilesystemsRequest::RoleChain>) };
    inline DetachVscFromFilesystemsRequest& setRoleChain(const vector<DetachVscFromFilesystemsRequest::RoleChain> & roleChain) { DARABONBA_PTR_SET_VALUE(roleChain_, roleChain) };
    inline DetachVscFromFilesystemsRequest& setRoleChain(vector<DetachVscFromFilesystemsRequest::RoleChain> && roleChain) { DARABONBA_PTR_SET_RVALUE(roleChain_, roleChain) };
  ...
  protected:
    ...
    shared_ptr<vector<DetachVscFromFilesystemsRequest::RoleChain>> roleChain_ {};
  };
