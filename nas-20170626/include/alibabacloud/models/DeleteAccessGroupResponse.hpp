...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAccessGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAccessGroupResponseBody) };
    inline DeleteAccessGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAccessGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAccessGroupResponseBody> body_ {};
  };
