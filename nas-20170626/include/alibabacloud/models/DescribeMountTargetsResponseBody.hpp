...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMountTargetsResponseBodyMountTargets & mountTargets() const { DARABONBA_PTR_GET_CONST(mountTargets_, DescribeMountTargetsResponseBodyMountTargets) };
    inline DescribeMountTargetsResponseBodyMountTargets mountTargets() { DARABONBA_PTR_GET(mountTargets_, DescribeMountTargetsResponseBodyMountTargets) };
    inline DescribeMountTargetsResponseBody& setMountTargets(const DescribeMountTargetsResponseBodyMountTargets & mountTargets) { DARABONBA_PTR_SET_VALUE(mountTargets_, mountTargets) };
    inline DescribeMountTargetsResponseBody& setMountTargets(DescribeMountTargetsResponseBodyMountTargets && mountTargets) { DARABONBA_PTR_SET_RVALUE(mountTargets_, mountTargets) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeMountTargetsResponseBodyMountTargets> mountTargets_ = nullptr;
    // The page number.
