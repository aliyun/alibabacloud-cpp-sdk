...
namespace Models
{
  ...
  public:
    ...
    inline const ListRecycleBinJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRecycleBinJobsResponseBody) };
    inline ListRecycleBinJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRecycleBinJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRecycleBinJobsResponseBody> body_ {};
  };
