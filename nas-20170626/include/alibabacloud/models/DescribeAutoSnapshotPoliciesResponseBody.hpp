...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAutoSnapshotPoliciesResponseBodyAutoSnapshotPolicies & autoSnapshotPolicies() const { DARABONBA_PTR_GET_CONST(autoSnapshotPolicies_, DescribeAutoSnapshotPoliciesResponseBodyAutoSnapshotPolicies) };
    inline DescribeAutoSnapshotPoliciesResponseBodyAutoSnapshotPolicies autoSnapshotPolicies() { DARABONBA_PTR_GET(autoSnapshotPolicies_, DescribeAutoSnapshotPoliciesResponseBodyAutoSnapshotPolicies) };
    inline DescribeAutoSnapshotPoliciesResponseBody& setAutoSnapshotPolicies(const DescribeAutoSnapshotPoliciesResponseBodyAutoSnapshotPolicies & autoSnapshotPolicies) { DARABONBA_PTR_SET_VALUE(autoSnapshotPolicies_, autoSnapshotPolicies) };
    inline DescribeAutoSnapshotPoliciesResponseBody& setAutoSnapshotPolicies(DescribeAutoSnapshotPoliciesResponseBodyAutoSnapshotPolicies && autoSnapshotPolicies) { DARABONBA_PTR_SET_RVALUE(autoSnapshotPolicies_, autoSnapshotPolicies) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAutoSnapshotPoliciesResponseBodyAutoSnapshotPolicies> autoSnapshotPolicies_ = nullptr;
    // The page number.
