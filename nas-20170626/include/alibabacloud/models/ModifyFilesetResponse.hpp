...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyFilesetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyFilesetResponseBody) };
    inline ModifyFilesetResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyFilesetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyFilesetResponseBody> body_ {};
  };
