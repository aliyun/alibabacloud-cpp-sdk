...
namespace Models
{
  ...
  public:
    ...
    inline const ListDirectoriesAndFilesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDirectoriesAndFilesResponseBody) };
    inline ListDirectoriesAndFilesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDirectoriesAndFilesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDirectoriesAndFilesResponseBody> body_ {};
  };
