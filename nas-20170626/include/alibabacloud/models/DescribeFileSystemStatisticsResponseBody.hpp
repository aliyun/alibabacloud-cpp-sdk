...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->fileSystemStatistics_ == nullptr
        && return this->fileSystems_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->totalCount_ == nullptr; };
