...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAccessPointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyAccessPointResponseBody) };
    inline ModifyAccessPointResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyAccessPointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyAccessPointResponseBody> body_ {};
  };
