...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLogAnalysisResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLogAnalysisResponseBody) };
    inline CreateLogAnalysisResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLogAnalysisResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLogAnalysisResponseBody> body_ {};
  };
