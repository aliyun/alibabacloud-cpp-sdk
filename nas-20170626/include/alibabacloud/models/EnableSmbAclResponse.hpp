...
namespace Models
{
  ...
  public:
    ...
    inline const EnableSmbAclResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableSmbAclResponseBody) };
    inline EnableSmbAclResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableSmbAclResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableSmbAclResponseBody> body_ {};
  };
