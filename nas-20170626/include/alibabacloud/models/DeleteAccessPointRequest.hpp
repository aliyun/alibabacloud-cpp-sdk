...
#ifndef ALIBABACLOUD_MODELS_DELETEACCESSPOINTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DELETEACCESSPOINTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteAccessPointRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AccessPointId, accessPointId_);
      DARABONBA_PTR_TO_JSON(FileSystemId, fileSystemId_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteAccessPointRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessPointId, accessPointId_);
      DARABONBA_PTR_FROM_JSON(FileSystemId, fileSystemId_);
    };
    DeleteAccessPointRequest() = default ;
    DeleteAccessPointRequest(const DeleteAccessPointRequest &) = default ;
    DeleteAccessPointRequest(DeleteAccessPointRequest &&) = default ;
    DeleteAccessPointRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteAccessPointRequest() = default ;
    DeleteAccessPointRequest& operator=(const DeleteAccessPointRequest &) = default ;
    DeleteAccessPointRequest& operator=(DeleteAccessPointRequest &&) = default ;
