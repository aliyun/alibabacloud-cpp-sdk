...
namespace Models
{
  ...
  public:
    ...
    inline const DisableNfsAclResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableNfsAclResponseBody) };
    inline DisableNfsAclResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableNfsAclResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableNfsAclResponseBody> body_ {};
  };
