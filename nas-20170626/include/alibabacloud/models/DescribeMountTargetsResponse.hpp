...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMountTargetsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMountTargetsResponseBody) };
    inline DescribeMountTargetsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMountTargetsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMountTargetsResponseBody> body_ {};
  };
