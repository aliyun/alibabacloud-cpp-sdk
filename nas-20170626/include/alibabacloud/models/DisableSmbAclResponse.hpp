...
namespace Models
{
  ...
  public:
    ...
    inline const DisableSmbAclResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableSmbAclResponseBody) };
    inline DisableSmbAclResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableSmbAclResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableSmbAclResponseBody> body_ {};
  };
