...
namespace Models
{
  ...
  public:
    ...
    inline const GetDirectoryOrFilePropertiesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDirectoryOrFilePropertiesResponseBody) };
    inline GetDirectoryOrFilePropertiesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDirectoryOrFilePropertiesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDirectoryOrFilePropertiesResponseBody> body_ {};
  };
