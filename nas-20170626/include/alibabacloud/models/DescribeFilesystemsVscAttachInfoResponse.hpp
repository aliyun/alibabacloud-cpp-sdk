...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeFilesystemsVscAttachInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeFilesystemsVscAttachInfoResponseBody) };
    inline DescribeFilesystemsVscAttachInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeFilesystemsVscAttachInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeFilesystemsVscAttachInfoResponseBody> body_ {};
  };
