...
namespace Models
{
  ...
  public:
    ...
    inline const CreateFileSystemResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateFileSystemResponseBody) };
    inline CreateFileSystemResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateFileSystemResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateFileSystemResponseBody> body_ {};
  };
