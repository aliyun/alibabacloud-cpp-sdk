...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRecycleBinDeleteJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRecycleBinDeleteJobResponseBody) };
    inline CreateRecycleBinDeleteJobResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRecycleBinDeleteJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRecycleBinDeleteJobResponseBody> body_ {};
  };
