...
namespace Models
{
  ...
  public:
    ...
    inline const ApplyDataFlowAutoRefreshResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ApplyDataFlowAutoRefreshResponseBody) };
    inline ApplyDataFlowAutoRefreshResponseBody getBody() { DARABONBA_PTR_GET(body_, ApplyDataFlowAutoRefreshResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ApplyDataFlowAutoRefreshResponseBody> body_ {};
  };
