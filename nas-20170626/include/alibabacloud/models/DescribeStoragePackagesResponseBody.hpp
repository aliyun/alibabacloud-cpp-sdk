...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->packages_ != nullptr
    ...
    inline const DescribeStoragePackagesResponseBodyPackages & packages() const { DARABONBA_PTR_GET_CONST(packages_, DescribeStoragePackagesResponseBodyPackages) };
    inline DescribeStoragePackagesResponseBodyPackages packages() { DARABONBA_PTR_GET(packages_, DescribeStoragePackagesResponseBodyPackages) };
    inline DescribeStoragePackagesResponseBody& setPackages(const DescribeStoragePackagesResponseBodyPackages & packages) { DARABONBA_PTR_SET_VALUE(packages_, packages) };
    inline DescribeStoragePackagesResponseBody& setPackages(DescribeStoragePackagesResponseBodyPackages && packages) { DARABONBA_PTR_SET_RVALUE(packages_, packages) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeStoragePackagesResponseBodyPackages> packages_ = nullptr;
