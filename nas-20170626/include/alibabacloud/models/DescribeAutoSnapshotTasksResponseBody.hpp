...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->autoSnapshotTasks_ != nullptr
    ...
    inline const DescribeAutoSnapshotTasksResponseBodyAutoSnapshotTasks & autoSnapshotTasks() const { DARABONBA_PTR_GET_CONST(autoSnapshotTasks_, DescribeAutoSnapshotTasksResponseBodyAutoSnapshotTasks) };
    inline DescribeAutoSnapshotTasksResponseBodyAutoSnapshotTasks autoSnapshotTasks() { DARABONBA_PTR_GET(autoSnapshotTasks_, DescribeAutoSnapshotTasksResponseBodyAutoSnapshotTasks) };
    inline DescribeAutoSnapshotTasksResponseBody& setAutoSnapshotTasks(const DescribeAutoSnapshotTasksResponseBodyAutoSnapshotTasks & autoSnapshotTasks) { DARABONBA_PTR_SET_VALUE(autoSnapshotTasks_, autoSnapshotTasks) };
    inline DescribeAutoSnapshotTasksResponseBody& setAutoSnapshotTasks(DescribeAutoSnapshotTasksResponseBodyAutoSnapshotTasks && autoSnapshotTasks) { DARABONBA_PTR_SET_RVALUE(autoSnapshotTasks_, autoSnapshotTasks) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAutoSnapshotTasksResponseBodyAutoSnapshotTasks> autoSnapshotTasks_ = nullptr;
    // The page number.
