...
namespace Models
{
  ...
  public:
    ...
    inline const CreateProtocolServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateProtocolServiceResponseBody) };
    inline CreateProtocolServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateProtocolServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateProtocolServiceResponseBody> body_ {};
  };
