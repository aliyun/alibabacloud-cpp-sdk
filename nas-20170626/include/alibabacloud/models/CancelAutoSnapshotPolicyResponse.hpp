...
namespace Models
{
  ...
  public:
    ...
    inline const CancelAutoSnapshotPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelAutoSnapshotPolicyResponseBody) };
    inline CancelAutoSnapshotPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelAutoSnapshotPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelAutoSnapshotPolicyResponseBody> body_ {};
  };
