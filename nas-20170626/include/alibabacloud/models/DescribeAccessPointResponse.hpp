...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAccessPointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAccessPointResponseBody) };
    inline DescribeAccessPointResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAccessPointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAccessPointResponseBody> body_ {};
  };
