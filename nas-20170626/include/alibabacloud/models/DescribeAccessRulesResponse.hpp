...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAccessRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAccessRulesResponseBody) };
    inline DescribeAccessRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAccessRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAccessRulesResponseBody> body_ {};
  };
