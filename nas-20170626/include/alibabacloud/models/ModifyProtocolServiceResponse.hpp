...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyProtocolServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyProtocolServiceResponseBody) };
    inline ModifyProtocolServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyProtocolServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyProtocolServiceResponseBody> body_ {};
  };
