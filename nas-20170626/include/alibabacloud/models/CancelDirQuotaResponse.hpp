...
namespace Models
{
  ...
  public:
    ...
    inline const CancelDirQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelDirQuotaResponseBody) };
    inline CancelDirQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelDirQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelDirQuotaResponseBody> body_ {};
  };
