...
namespace Models
{
  ...
  public:
    ...
    inline const AddClientToBlackListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddClientToBlackListResponseBody) };
    inline AddClientToBlackListResponseBody getBody() { DARABONBA_PTR_GET(body_, AddClientToBlackListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddClientToBlackListResponseBody> body_ {};
  };
