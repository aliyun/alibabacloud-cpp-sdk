...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudCenterInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCloudCenterInstancesResponseBody) };
    inline DescribeCloudCenterInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCloudCenterInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCloudCenterInstancesResponseBody> body_ {};
  };
