...
namespace Models
{
  ...
  public:
    ...
    inline const BatchDeleteMaliciousFileWhitelistConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchDeleteMaliciousFileWhitelistConfigResponseBody) };
    inline BatchDeleteMaliciousFileWhitelistConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchDeleteMaliciousFileWhitelistConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchDeleteMaliciousFileWhitelistConfigResponseBody> body_ {};
  };
