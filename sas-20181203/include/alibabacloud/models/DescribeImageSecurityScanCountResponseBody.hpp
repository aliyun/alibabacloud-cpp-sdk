...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageSecurityScanCountResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeImageSecurityScanCountResponseBodyData) };
    inline DescribeImageSecurityScanCountResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeImageSecurityScanCountResponseBodyData) };
    inline DescribeImageSecurityScanCountResponseBody& setData(const DescribeImageSecurityScanCountResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeImageSecurityScanCountResponseBody& setData(DescribeImageSecurityScanCountResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<DescribeImageSecurityScanCountResponseBodyData> data_ = nullptr;
    // The request ID.
