...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecurityCheckScheduleConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSecurityCheckScheduleConfigResponseBody) };
    inline DescribeSecurityCheckScheduleConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSecurityCheckScheduleConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSecurityCheckScheduleConfigResponseBody> body_ {};
  };
