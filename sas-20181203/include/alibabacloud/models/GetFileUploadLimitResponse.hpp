...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileUploadLimitResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetFileUploadLimitResponseBody) };
    inline GetFileUploadLimitResponseBody getBody() { DARABONBA_PTR_GET(body_, GetFileUploadLimitResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetFileUploadLimitResponseBody> body_ {};
  };
