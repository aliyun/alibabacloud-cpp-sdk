...
namespace Models
{
  ...
  public:
    ...
    inline const SaveCustomizeReportConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveCustomizeReportConfigResponseBody) };
    inline SaveCustomizeReportConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveCustomizeReportConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveCustomizeReportConfigResponseBody> body_ {};
  };
