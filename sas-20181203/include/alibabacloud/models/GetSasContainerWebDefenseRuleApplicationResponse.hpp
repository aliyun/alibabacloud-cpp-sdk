...
namespace Models
{
  ...
  public:
    ...
    inline const GetSasContainerWebDefenseRuleApplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSasContainerWebDefenseRuleApplicationResponseBody) };
    inline GetSasContainerWebDefenseRuleApplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSasContainerWebDefenseRuleApplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSasContainerWebDefenseRuleApplicationResponseBody> body_ {};
  };
