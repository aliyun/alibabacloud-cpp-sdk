...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSasTrialResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSasTrialResponseBody) };
    inline CreateSasTrialResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSasTrialResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSasTrialResponseBody> body_ {};
  };
