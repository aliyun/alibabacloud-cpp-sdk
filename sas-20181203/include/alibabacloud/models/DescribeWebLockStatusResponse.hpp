...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWebLockStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeWebLockStatusResponseBody) };
    inline DescribeWebLockStatusResponseBody body() { DARABONBA_PTR_GET(body_, DescribeWebLockStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeWebLockStatusResponseBody> body_ = nullptr;
  };
