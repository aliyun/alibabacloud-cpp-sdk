...
namespace Models
{
  ...
  public:
    ...
    inline const SetBuildRiskDefineRuleConfigResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SetBuildRiskDefineRuleConfigResponseBody::Data) };
    inline SetBuildRiskDefineRuleConfigResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SetBuildRiskDefineRuleConfigResponseBody::Data) };
    inline SetBuildRiskDefineRuleConfigResponseBody& setData(const SetBuildRiskDefineRuleConfigResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SetBuildRiskDefineRuleConfigResponseBody& setData(SetBuildRiskDefineRuleConfigResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    shared_ptr<SetBuildRiskDefineRuleConfigResponseBody::Data> data_ {};
