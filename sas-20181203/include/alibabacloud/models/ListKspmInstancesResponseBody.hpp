...
#ifndef ALIBABACLOUD_MODELS_LISTKSPMINSTANCESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTKSPMINSTANCESRESPONSEBODY_HPP_
...
namespace Models
{
  class ListKspmInstancesResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListKspmInstancesResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Instances, instances_);
      DARABONBA_PTR_TO_JSON(PageInfo, pageInfo_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Success, success_);
    };
    friend void from_json(const Darabonba::Json& j, ListKspmInstancesResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Instances, instances_);
      DARABONBA_PTR_FROM_JSON(PageInfo, pageInfo_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
    };
    ListKspmInstancesResponseBody() = default ;
    ListKspmInstancesResponseBody(const ListKspmInstancesResponseBody &) = default ;
    ListKspmInstancesResponseBody(ListKspmInstancesResponseBody &&) = default ;
    ListKspmInstancesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListKspmInstancesResponseBody() = default ;
    ListKspmInstancesResponseBody& operator=(const ListKspmInstancesResponseBody &) = default ;
    ListKspmInstancesResponseBody& operator=(ListKspmInstancesResponseBody &&) = default ;
    ...
    inline const vector<ListKspmInstancesResponseBody::Instances> & getInstances() const { DARABONBA_PTR_GET_CONST(instances_, vector<ListKspmInstancesResponseBody::Instances>) };
    inline vector<ListKspmInstancesResponseBody::Instances> getInstances() { DARABONBA_PTR_GET(instances_, vector<ListKspmInstancesResponseBody::Instances>) };
    inline ListKspmInstancesResponseBody& setInstances(const vector<ListKspmInstancesResponseBody::Instances> & instances) { DARABONBA_PTR_SET_VALUE(instances_, instances) };
    inline ListKspmInstancesResponseBody& setInstances(vector<ListKspmInstancesResponseBody::Instances> && instances) { DARABONBA_PTR_SET_RVALUE(instances_, instances) };


    // pageInfo Field Functions 
    bool hasPageInfo() const { return this->pageInfo_ != nullptr;};
    void deletePageInfo() { this->pageInfo_ = nullptr;};
    inline const ListKspmInstancesResponseBody::PageInfo & getPageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, ListKspmInstancesResponseBody::PageInfo) };
    inline ListKspmInstancesResponseBody::PageInfo getPageInfo() { DARABONBA_PTR_GET(pageInfo_, ListKspmInstancesResponseBody::PageInfo) };
    inline ListKspmInstancesResponseBody& setPageInfo(const ListKspmInstancesResponseBody::PageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline ListKspmInstancesResponseBody& setPageInfo(ListKspmInstancesResponseBody::PageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
    ...
    inline ListKspmInstancesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListKspmInstancesResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // List of Kubernetes asset information.
    shared_ptr<vector<ListKspmInstancesResponseBody::Instances>> instances_ {};
    // Page information for pagination queries.
    shared_ptr<ListKspmInstancesResponseBody::PageInfo> pageInfo_ {};
