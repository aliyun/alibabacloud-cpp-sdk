...
namespace Models
{
  ...
  public:
    ...
    inline const OperateBucketScanTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OperateBucketScanTaskResponseBody) };
    inline OperateBucketScanTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, OperateBucketScanTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OperateBucketScanTaskResponseBody> body_ {};
  };
