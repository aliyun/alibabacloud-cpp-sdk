...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSoarStrategyTaskParamsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSoarStrategyTaskParamsResponseBody) };
    inline DescribeSoarStrategyTaskParamsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSoarStrategyTaskParamsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSoarStrategyTaskParamsResponseBody> body_ {};
  };
