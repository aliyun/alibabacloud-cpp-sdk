...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSoarPlaybookTaskDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSoarPlaybookTaskDetailResponseBody) };
    inline DescribeSoarPlaybookTaskDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSoarPlaybookTaskDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSoarPlaybookTaskDetailResponseBody> body_ {};
  };
