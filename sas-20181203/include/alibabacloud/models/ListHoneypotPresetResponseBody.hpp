...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHoneypotPresetResponseBodyList> & list() const { DARABONBA_PTR_GET_CONST(list_, vector<ListHoneypotPresetResponseBodyList>) };
    inline vector<ListHoneypotPresetResponseBodyList> list() { DARABONBA_PTR_GET(list_, vector<ListHoneypotPresetResponseBodyList>) };
    inline ListHoneypotPresetResponseBody& setList(const vector<ListHoneypotPresetResponseBodyList> & list) { DARABONBA_PTR_SET_VALUE(list_, list) };
    inline ListHoneypotPresetResponseBody& setList(vector<ListHoneypotPresetResponseBodyList> && list) { DARABONBA_PTR_SET_RVALUE(list_, list) };
    ...
    inline const ListHoneypotPresetResponseBodyPageInfo & pageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, ListHoneypotPresetResponseBodyPageInfo) };
    inline ListHoneypotPresetResponseBodyPageInfo pageInfo() { DARABONBA_PTR_GET(pageInfo_, ListHoneypotPresetResponseBodyPageInfo) };
    inline ListHoneypotPresetResponseBody& setPageInfo(const ListHoneypotPresetResponseBodyPageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline ListHoneypotPresetResponseBody& setPageInfo(ListHoneypotPresetResponseBodyPageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListHoneypotPresetResponseBodyList>> list_ = nullptr;
    // The message returned.
    std::shared_ptr<string> message_ = nullptr;
    // The pagination information.
    std::shared_ptr<ListHoneypotPresetResponseBodyPageInfo> pageInfo_ = nullptr;
