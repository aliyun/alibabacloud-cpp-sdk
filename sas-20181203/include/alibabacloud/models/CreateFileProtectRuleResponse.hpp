...
namespace Models
{
  ...
  public:
    ...
    inline const CreateFileProtectRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateFileProtectRuleResponseBody) };
    inline CreateFileProtectRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateFileProtectRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateFileProtectRuleResponseBody> body_ {};
  };
