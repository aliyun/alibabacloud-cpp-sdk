...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSoarStrategyTasksResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSoarStrategyTasksResponseBody) };
    inline DescribeSoarStrategyTasksResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSoarStrategyTasksResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSoarStrategyTasksResponseBody> body_ = nullptr;
  };
