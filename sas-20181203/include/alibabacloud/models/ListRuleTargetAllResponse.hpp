...
namespace Models
{
  ...
  public:
    ...
    inline const ListRuleTargetAllResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRuleTargetAllResponseBody) };
    inline ListRuleTargetAllResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRuleTargetAllResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRuleTargetAllResponseBody> body_ {};
  };
