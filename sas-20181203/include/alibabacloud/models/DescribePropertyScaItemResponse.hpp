...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePropertyScaItemResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePropertyScaItemResponseBody) };
    inline DescribePropertyScaItemResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePropertyScaItemResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePropertyScaItemResponseBody> body_ {};
  };
