...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBackupClientsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBackupClientsResponseBody) };
    inline DescribeBackupClientsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBackupClientsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBackupClientsResponseBody> body_ {};
  };
