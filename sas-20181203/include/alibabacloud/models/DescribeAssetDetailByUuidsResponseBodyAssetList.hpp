...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEASSETDETAILBYUUIDSRESPONSEBODYASSETLIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEASSETDETAILBYUUIDSRESPONSEBODYASSETLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeAssetDetailByUuidsResponseBodyAssetList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeAssetDetailByUuidsResponseBodyAssetList& obj) { 
    ...
    DescribeAssetDetailByUuidsResponseBodyAssetList() = default ;
    DescribeAssetDetailByUuidsResponseBodyAssetList(const DescribeAssetDetailByUuidsResponseBodyAssetList &) = default ;
    DescribeAssetDetailByUuidsResponseBodyAssetList(DescribeAssetDetailByUuidsResponseBodyAssetList &&) = default ;
    DescribeAssetDetailByUuidsResponseBodyAssetList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeAssetDetailByUuidsResponseBodyAssetList() = default ;
    DescribeAssetDetailByUuidsResponseBodyAssetList& operator=(const DescribeAssetDetailByUuidsResponseBodyAssetList &) = default ;
    DescribeAssetDetailByUuidsResponseBodyAssetList& operator=(DescribeAssetDetailByUuidsResponseBodyAssetList &&) = default ;
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setAssetType(string assetType) { DARABONBA_PTR_SET_VALUE(assetType_, assetType) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setAuthModifyTime(int64_t authModifyTime) { DARABONBA_PTR_SET_VALUE(authModifyTime_, authModifyTime) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setAuthVersion(int32_t authVersion) { DARABONBA_PTR_SET_VALUE(authVersion_, authVersion) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setBind(bool bind) { DARABONBA_PTR_SET_VALUE(bind_, bind) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setClientStatus(string clientStatus) { DARABONBA_PTR_SET_VALUE(clientStatus_, clientStatus) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setClientVersion(string clientVersion) { DARABONBA_PTR_SET_VALUE(clientVersion_, clientVersion) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setCpu(int32_t cpu) { DARABONBA_PTR_SET_VALUE(cpu_, cpu) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setCpuInfo(string cpuInfo) { DARABONBA_PTR_SET_VALUE(cpuInfo_, cpuInfo) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setDiskInfoList(const vector<string> & diskInfoList) { DARABONBA_PTR_SET_VALUE(diskInfoList_, diskInfoList) };
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setDiskInfoList(vector<string> && diskInfoList) { DARABONBA_PTR_SET_RVALUE(diskInfoList_, diskInfoList) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setFlag(int32_t flag) { DARABONBA_PTR_SET_VALUE(flag_, flag) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setGroupTrace(string groupTrace) { DARABONBA_PTR_SET_VALUE(groupTrace_, groupTrace) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setHostName(string hostName) { DARABONBA_PTR_SET_VALUE(hostName_, hostName) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setInstanceName(string instanceName) { DARABONBA_PTR_SET_VALUE(instanceName_, instanceName) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setInternetIp(string internetIp) { DARABONBA_PTR_SET_VALUE(internetIp_, internetIp) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setIntranetIp(string intranetIp) { DARABONBA_PTR_SET_VALUE(intranetIp_, intranetIp) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setIp(string ip) { DARABONBA_PTR_SET_VALUE(ip_, ip) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setIpList(const vector<string> & ipList) { DARABONBA_PTR_SET_VALUE(ipList_, ipList) };
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setIpList(vector<string> && ipList) { DARABONBA_PTR_SET_RVALUE(ipList_, ipList) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setKernel(string kernel) { DARABONBA_PTR_SET_VALUE(kernel_, kernel) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setMacList(const vector<string> & macList) { DARABONBA_PTR_SET_VALUE(macList_, macList) };
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setMacList(vector<string> && macList) { DARABONBA_PTR_SET_RVALUE(macList_, macList) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setMem(int32_t mem) { DARABONBA_PTR_SET_VALUE(mem_, mem) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setMemory(int64_t memory) { DARABONBA_PTR_SET_VALUE(memory_, memory) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setOs(string os) { DARABONBA_PTR_SET_VALUE(os_, os) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setOsDetail(string osDetail) { DARABONBA_PTR_SET_VALUE(osDetail_, osDetail) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setOsName(string osName) { DARABONBA_PTR_SET_VALUE(osName_, osName) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setRegion(string region) { DARABONBA_PTR_SET_VALUE(region_, region) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setRegionName(string regionName) { DARABONBA_PTR_SET_VALUE(regionName_, regionName) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setSysInfo(string sysInfo) { DARABONBA_PTR_SET_VALUE(sysInfo_, sysInfo) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setTag(string tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setUuid(string uuid) { DARABONBA_PTR_SET_VALUE(uuid_, uuid) };
    ...
    inline DescribeAssetDetailByUuidsResponseBodyAssetList& setVpcInstanceId(string vpcInstanceId) { DARABONBA_PTR_SET_VALUE(vpcInstanceId_, vpcInstanceId) };
