...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateK8sAccessInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateK8sAccessInfoResponseBody) };
    inline GenerateK8sAccessInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateK8sAccessInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateK8sAccessInfoResponseBody> body_ {};
  };
