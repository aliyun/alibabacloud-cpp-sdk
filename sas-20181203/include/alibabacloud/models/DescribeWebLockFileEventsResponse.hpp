...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWebLockFileEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeWebLockFileEventsResponseBody) };
    inline DescribeWebLockFileEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeWebLockFileEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeWebLockFileEventsResponseBody> body_ {};
  };
