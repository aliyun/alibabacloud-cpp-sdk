...
namespace Models
{
  ...
  public:
    ...
    inline const GetAuthSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAuthSummaryResponseBody) };
    inline GetAuthSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAuthSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAuthSummaryResponseBody> body_ {};
  };
