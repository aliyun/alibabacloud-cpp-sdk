...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteHybridProxyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteHybridProxyResponseBody) };
    inline DeleteHybridProxyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteHybridProxyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteHybridProxyResponseBody> body_ {};
  };
