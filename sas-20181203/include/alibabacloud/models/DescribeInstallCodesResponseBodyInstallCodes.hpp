...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->captchaCode_ == nullptr
        && return this->expiredDate_ == nullptr && return this->groupId_ == nullptr && return this->groupName_ == nullptr && return this->onlyImage_ == nullptr && return this->os_ == nullptr
        && return this->privateLinkEndpointId_ == nullptr && return this->proxyCluster_ == nullptr && return this->vendorName_ == nullptr; };
