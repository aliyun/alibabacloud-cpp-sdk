...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNeedAsyncQueryResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeNeedAsyncQueryResponseBody) };
    inline DescribeNeedAsyncQueryResponseBody body() { DARABONBA_PTR_GET(body_, DescribeNeedAsyncQueryResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeNeedAsyncQueryResponseBody> body_ = nullptr;
  };
