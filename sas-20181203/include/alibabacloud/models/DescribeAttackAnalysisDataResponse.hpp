...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAttackAnalysisDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAttackAnalysisDataResponseBody) };
    inline DescribeAttackAnalysisDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAttackAnalysisDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAttackAnalysisDataResponseBody> body_ {};
  };
