...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateHoneypotResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateHoneypotResponseBody) };
    inline UpdateHoneypotResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateHoneypotResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateHoneypotResponseBody> body_ {};
  };
