...
namespace Models
{
  ...
  public:
    ...
    inline const PageImageRegistryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PageImageRegistryResponseBody) };
    inline PageImageRegistryResponseBody getBody() { DARABONBA_PTR_GET(body_, PageImageRegistryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PageImageRegistryResponseBody> body_ {};
  };
