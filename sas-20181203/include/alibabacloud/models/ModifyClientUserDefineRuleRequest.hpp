...
#ifndef ALIBABACLOUD_MODELS_MODIFYCLIENTUSERDEFINERULEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MODIFYCLIENTUSERDEFINERULEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyClientUserDefineRuleRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyClientUserDefineRuleRequest& obj) { 
    ...
    ModifyClientUserDefineRuleRequest() = default ;
    ModifyClientUserDefineRuleRequest(const ModifyClientUserDefineRuleRequest &) = default ;
    ModifyClientUserDefineRuleRequest(ModifyClientUserDefineRuleRequest &&) = default ;
    ModifyClientUserDefineRuleRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyClientUserDefineRuleRequest() = default ;
    ModifyClientUserDefineRuleRequest& operator=(const ModifyClientUserDefineRuleRequest &) = default ;
    ModifyClientUserDefineRuleRequest& operator=(ModifyClientUserDefineRuleRequest &&) = default ;
