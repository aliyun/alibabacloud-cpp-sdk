...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWebLockInclusiveFileTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeWebLockInclusiveFileTypeResponseBody) };
    inline DescribeWebLockInclusiveFileTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeWebLockInclusiveFileTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeWebLockInclusiveFileTypeResponseBody> body_ {};
  };
