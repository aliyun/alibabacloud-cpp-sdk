...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->checkId_ == nullptr
        && this->checkIds_ == nullptr && this->clientToken_ == nullptr && this->dryRun_ == nullptr && this->instanceIds_ == nullptr && this->taskSource_ == nullptr; };
    ...
    inline VerifyCheckInstanceResultRequest& setDryRun(bool dryRun) { DARABONBA_PTR_SET_VALUE(dryRun_, dryRun) };
