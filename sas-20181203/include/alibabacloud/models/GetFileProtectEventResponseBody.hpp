...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileProtectEventResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetFileProtectEventResponseBodyData) };
    inline GetFileProtectEventResponseBodyData data() { DARABONBA_PTR_GET(data_, GetFileProtectEventResponseBodyData) };
    inline GetFileProtectEventResponseBody& setData(const GetFileProtectEventResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetFileProtectEventResponseBody& setData(GetFileProtectEventResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetFileProtectEventResponseBodyData> data_ = nullptr;
    // The request ID.
