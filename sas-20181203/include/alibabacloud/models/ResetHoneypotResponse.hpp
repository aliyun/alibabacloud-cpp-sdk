...
namespace Models
{
  ...
  public:
    ...
    inline const ResetHoneypotResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResetHoneypotResponseBody) };
    inline ResetHoneypotResponseBody getBody() { DARABONBA_PTR_GET(body_, ResetHoneypotResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResetHoneypotResponseBody> body_ {};
  };
