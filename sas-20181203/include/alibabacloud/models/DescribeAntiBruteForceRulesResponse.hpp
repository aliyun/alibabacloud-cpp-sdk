...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAntiBruteForceRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAntiBruteForceRulesResponseBody) };
    inline DescribeAntiBruteForceRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAntiBruteForceRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAntiBruteForceRulesResponseBody> body_ {};
  };
