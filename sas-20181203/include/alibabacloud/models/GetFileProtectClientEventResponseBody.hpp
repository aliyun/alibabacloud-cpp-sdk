...
#ifndef ALIBABACLOUD_MODELS_GETFILEPROTECTCLIENTEVENTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETFILEPROTECTCLIENTEVENTRESPONSEBODY_HPP_
...
namespace Models
{
  class GetFileProtectClientEventResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetFileProtectClientEventResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetFileProtectClientEventResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    GetFileProtectClientEventResponseBody() = default ;
    GetFileProtectClientEventResponseBody(const GetFileProtectClientEventResponseBody &) = default ;
    GetFileProtectClientEventResponseBody(GetFileProtectClientEventResponseBody &&) = default ;
    GetFileProtectClientEventResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetFileProtectClientEventResponseBody() = default ;
    GetFileProtectClientEventResponseBody& operator=(const GetFileProtectClientEventResponseBody &) = default ;
    GetFileProtectClientEventResponseBody& operator=(GetFileProtectClientEventResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->alertLevel_ == nullptr
        && this->cmdLine_ == nullptr && this->count_ == nullptr && this->filePath_ == nullptr && this->filePermission_ == nullptr && this->firstTime_ == nullptr
        && this->handleTime_ == nullptr && this->id_ == nullptr && this->instanceName_ == nullptr && this->internetIp_ == nullptr && this->intranetIp_ == nullptr
        && this->latestTime_ == nullptr && this->operation_ == nullptr && this->platform_ == nullptr && this->procPath_ == nullptr && this->processId_ == nullptr
        && this->remark_ == nullptr && this->ruleAction_ == nullptr && this->ruleName_ == nullptr && this->status_ == nullptr && this->userId_ == nullptr
        && this->userName_ == nullptr && this->uuid_ == nullptr; };
    ...
    inline const GetFileProtectClientEventResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetFileProtectClientEventResponseBody::Data) };
    inline GetFileProtectClientEventResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetFileProtectClientEventResponseBody::Data) };
    inline GetFileProtectClientEventResponseBody& setData(const GetFileProtectClientEventResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetFileProtectClientEventResponseBody& setData(GetFileProtectClientEventResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetFileProtectClientEventResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
