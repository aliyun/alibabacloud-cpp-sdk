...
namespace Models
{
  ...
  public:
    ...
    inline const CreateJenkinsImageScanTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateJenkinsImageScanTaskResponseBodyData) };
    inline CreateJenkinsImageScanTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateJenkinsImageScanTaskResponseBodyData) };
    inline CreateJenkinsImageScanTaskResponseBody& setData(const CreateJenkinsImageScanTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateJenkinsImageScanTaskResponseBody& setData(CreateJenkinsImageScanTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<CreateJenkinsImageScanTaskResponseBodyData> data_ = nullptr;
    // The request ID.
