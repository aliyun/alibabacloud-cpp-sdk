...
namespace Models
{
  ...
  public:
    ...
    inline const ResetHoneypotResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ResetHoneypotResponseBodyData) };
    inline ResetHoneypotResponseBodyData data() { DARABONBA_PTR_GET(data_, ResetHoneypotResponseBodyData) };
    inline ResetHoneypotResponseBody& setData(const ResetHoneypotResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ResetHoneypotResponseBody& setData(ResetHoneypotResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ResetHoneypotResponseBodyData> data_ = nullptr;
    // The request ID.
