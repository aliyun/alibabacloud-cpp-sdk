...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainCountResponseBody) };
    inline DescribeDomainCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainCountResponseBody> body_ {};
  };
