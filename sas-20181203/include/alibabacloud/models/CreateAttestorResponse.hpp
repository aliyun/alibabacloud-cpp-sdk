...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAttestorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAttestorResponseBody) };
    inline CreateAttestorResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAttestorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAttestorResponseBody> body_ {};
  };
