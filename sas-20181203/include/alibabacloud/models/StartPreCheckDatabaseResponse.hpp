...
namespace Models
{
  ...
  public:
    ...
    inline const StartPreCheckDatabaseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartPreCheckDatabaseResponseBody) };
    inline StartPreCheckDatabaseResponseBody getBody() { DARABONBA_PTR_GET(body_, StartPreCheckDatabaseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartPreCheckDatabaseResponseBody> body_ {};
  };
