...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeGroupedInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeGroupedInstancesResponseBody) };
    inline DescribeGroupedInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeGroupedInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeGroupedInstancesResponseBody> body_ {};
  };
