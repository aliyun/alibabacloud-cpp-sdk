...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainSecureSuggestsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainSecureSuggestsResponseBody) };
    inline DescribeDomainSecureSuggestsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDomainSecureSuggestsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDomainSecureSuggestsResponseBody> body_ = nullptr;
  };
