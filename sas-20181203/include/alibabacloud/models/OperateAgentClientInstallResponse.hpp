...
namespace Models
{
  ...
  public:
    ...
    inline const OperateAgentClientInstallResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OperateAgentClientInstallResponseBody) };
    inline OperateAgentClientInstallResponseBody getBody() { DARABONBA_PTR_GET(body_, OperateAgentClientInstallResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OperateAgentClientInstallResponseBody> body_ {};
  };
