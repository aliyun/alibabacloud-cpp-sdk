...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageBaselineStrategyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeImageBaselineStrategyResponseBody) };
    inline DescribeImageBaselineStrategyResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeImageBaselineStrategyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeImageBaselineStrategyResponseBody> body_ {};
  };
