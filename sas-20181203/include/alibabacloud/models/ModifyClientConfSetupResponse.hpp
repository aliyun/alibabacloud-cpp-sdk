...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyClientConfSetupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyClientConfSetupResponseBody) };
    inline ModifyClientConfSetupResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyClientConfSetupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyClientConfSetupResponseBody> body_ {};
  };
