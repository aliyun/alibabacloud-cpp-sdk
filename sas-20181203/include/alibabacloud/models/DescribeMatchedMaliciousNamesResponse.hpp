...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMatchedMaliciousNamesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMatchedMaliciousNamesResponseBody) };
    inline DescribeMatchedMaliciousNamesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMatchedMaliciousNamesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMatchedMaliciousNamesResponseBody> body_ {};
  };
