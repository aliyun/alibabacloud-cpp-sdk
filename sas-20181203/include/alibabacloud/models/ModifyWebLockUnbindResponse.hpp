...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyWebLockUnbindResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyWebLockUnbindResponseBody) };
    inline ModifyWebLockUnbindResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyWebLockUnbindResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyWebLockUnbindResponseBody> body_ {};
  };
