...
namespace Models
{
  ...
  public:
    ...
    inline const GetHoneypotProbeResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetHoneypotProbeResponseBodyData) };
    inline GetHoneypotProbeResponseBodyData data() { DARABONBA_PTR_GET(data_, GetHoneypotProbeResponseBodyData) };
    inline GetHoneypotProbeResponseBody& setData(const GetHoneypotProbeResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHoneypotProbeResponseBody& setData(GetHoneypotProbeResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetHoneypotProbeResponseBodyData> data_ = nullptr;
