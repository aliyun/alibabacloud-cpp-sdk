...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeContainerGroupedFieldDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeContainerGroupedFieldDetailResponseBodyData) };
    inline DescribeContainerGroupedFieldDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeContainerGroupedFieldDetailResponseBodyData) };
    inline DescribeContainerGroupedFieldDetailResponseBody& setData(const DescribeContainerGroupedFieldDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeContainerGroupedFieldDetailResponseBody& setData(DescribeContainerGroupedFieldDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<DescribeContainerGroupedFieldDetailResponseBodyData> data_ = nullptr;
    // The request ID.
