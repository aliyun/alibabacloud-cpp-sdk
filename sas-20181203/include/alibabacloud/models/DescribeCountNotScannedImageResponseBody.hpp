...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->notScannedCnt_ == nullptr
    ...
    inline int32_t getNotScannedCnt() const { DARABONBA_PTR_GET_DEFAULT(notScannedCnt_, 0) };
  ...
  protected:
    ...
    shared_ptr<int32_t> notScannedCnt_ {};
