...
namespace Models
{
  ...
  public:
    ...
    inline const OperateVirusEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OperateVirusEventsResponseBody) };
    inline OperateVirusEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, OperateVirusEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OperateVirusEventsResponseBody> body_ {};
  };
