...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteUniBackupPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteUniBackupPolicyResponseBody) };
    inline DeleteUniBackupPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteUniBackupPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteUniBackupPolicyResponseBody> body_ {};
  };
