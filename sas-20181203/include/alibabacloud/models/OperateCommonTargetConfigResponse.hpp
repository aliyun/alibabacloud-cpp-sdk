...
namespace Models
{
  ...
  public:
    ...
    inline const OperateCommonTargetConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OperateCommonTargetConfigResponseBody) };
    inline OperateCommonTargetConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, OperateCommonTargetConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OperateCommonTargetConfigResponseBody> body_ {};
  };
