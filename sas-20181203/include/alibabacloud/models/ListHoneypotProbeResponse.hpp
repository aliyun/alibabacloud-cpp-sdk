...
namespace Models
{
  ...
  public:
    ...
    inline const ListHoneypotProbeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHoneypotProbeResponseBody) };
    inline ListHoneypotProbeResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHoneypotProbeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHoneypotProbeResponseBody> body_ {};
  };
