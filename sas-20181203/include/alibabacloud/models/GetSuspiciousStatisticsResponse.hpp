...
namespace Models
{
  ...
  public:
    ...
    inline const GetSuspiciousStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSuspiciousStatisticsResponseBody) };
    inline GetSuspiciousStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSuspiciousStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSuspiciousStatisticsResponseBody> body_ {};
  };
