...
namespace Models
{
  ...
  public:
    ...
    inline const QueryJenkinsImageRegistryPersistenceDayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryJenkinsImageRegistryPersistenceDayResponseBody) };
    inline QueryJenkinsImageRegistryPersistenceDayResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryJenkinsImageRegistryPersistenceDayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryJenkinsImageRegistryPersistenceDayResponseBody> body_ {};
  };
