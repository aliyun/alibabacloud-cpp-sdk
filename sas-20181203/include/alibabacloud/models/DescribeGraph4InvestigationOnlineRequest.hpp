...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->anomalyId_ == nullptr
        && return this->anomalyUuid_ == nullptr && return this->lang_ == nullptr && return this->namespace_ == nullptr && return this->vertexId_ == nullptr; };
    ...
    inline string anomalyId() const { DARABONBA_PTR_GET_DEFAULT(anomalyId_, "") };
    ...
    inline string anomalyUuid() const { DARABONBA_PTR_GET_DEFAULT(anomalyUuid_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> anomalyId_ = nullptr;
    ...
    std::shared_ptr<string> anomalyUuid_ = nullptr;
