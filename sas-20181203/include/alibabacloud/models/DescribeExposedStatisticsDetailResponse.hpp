...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExposedStatisticsDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeExposedStatisticsDetailResponseBody) };
    inline DescribeExposedStatisticsDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeExposedStatisticsDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeExposedStatisticsDetailResponseBody> body_ {};
  };
