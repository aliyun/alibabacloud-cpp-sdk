...
namespace Models
{
  ...
  public:
    ...
    inline const GetVirusScanLatestTaskStatisticResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetVirusScanLatestTaskStatisticResponseBody) };
    inline GetVirusScanLatestTaskStatisticResponseBody getBody() { DARABONBA_PTR_GET(body_, GetVirusScanLatestTaskStatisticResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetVirusScanLatestTaskStatisticResponseBody> body_ {};
  };
