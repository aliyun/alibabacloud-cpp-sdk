...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageListByBuildRiskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeImageListByBuildRiskResponseBody) };
    inline DescribeImageListByBuildRiskResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeImageListByBuildRiskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeImageListByBuildRiskResponseBody> body_ {};
  };
