...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUniBackupStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUniBackupStatisticsResponseBody) };
    inline DescribeUniBackupStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUniBackupStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUniBackupStatisticsResponseBody> body_ {};
  };
