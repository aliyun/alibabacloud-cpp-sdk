...
namespace Models
{
  ...
  public:
    ...
    protected:
      ...
      // The time when the current entity type was modified. Unit: milliseconds.
      ...
      // The rule template ID. You can call ListSystemClientRules to obtain the template ID.
      shared_ptr<string> ruleTemplateId_ {};
      // The rule template name.
      shared_ptr<string> ruleTemplateName_ {};
      // The list of selected rule policies.
    ...
    protected:
      ...
      // The maximum number of entries returned per page in a paginated query.
