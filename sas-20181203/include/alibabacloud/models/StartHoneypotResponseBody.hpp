...
namespace Models
{
  ...
  public:
    ...
    inline const StartHoneypotResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, StartHoneypotResponseBody::Data) };
    inline StartHoneypotResponseBody::Data getData() { DARABONBA_PTR_GET(data_, StartHoneypotResponseBody::Data) };
    inline StartHoneypotResponseBody& setData(const StartHoneypotResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline StartHoneypotResponseBody& setData(StartHoneypotResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<StartHoneypotResponseBody::Data> data_ {};
    // The request ID.
