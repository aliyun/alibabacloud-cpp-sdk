...
namespace Models
{
  ...
  public:
    ...
    inline const InstallPmAgentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InstallPmAgentResponseBody) };
    inline InstallPmAgentResponseBody getBody() { DARABONBA_PTR_GET(body_, InstallPmAgentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InstallPmAgentResponseBody> body_ {};
  };
