...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAllEntityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAllEntityResponseBody) };
    inline DescribeAllEntityResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAllEntityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAllEntityResponseBody> body_ {};
  };
