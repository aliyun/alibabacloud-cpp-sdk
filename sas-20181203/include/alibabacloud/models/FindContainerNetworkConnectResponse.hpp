...
namespace Models
{
  ...
  public:
    ...
    inline const FindContainerNetworkConnectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FindContainerNetworkConnectResponseBody) };
    inline FindContainerNetworkConnectResponseBody getBody() { DARABONBA_PTR_GET(body_, FindContainerNetworkConnectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FindContainerNetworkConnectResponseBody> body_ {};
  };
