...
namespace Models
{
  ...
  public:
    ...
    inline const AddContainerPluginRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AddContainerPluginRuleResponseBodyData) };
    inline AddContainerPluginRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, AddContainerPluginRuleResponseBodyData) };
    inline AddContainerPluginRuleResponseBody& setData(const AddContainerPluginRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AddContainerPluginRuleResponseBody& setData(AddContainerPluginRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<AddContainerPluginRuleResponseBodyData> data_ = nullptr;
    // The request ID.
