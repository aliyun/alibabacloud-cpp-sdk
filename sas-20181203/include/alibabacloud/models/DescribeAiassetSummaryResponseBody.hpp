...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAIAssetSummaryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeAIAssetSummaryResponseBodyData) };
    inline DescribeAIAssetSummaryResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeAIAssetSummaryResponseBodyData) };
    inline DescribeAIAssetSummaryResponseBody& setData(const DescribeAIAssetSummaryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAIAssetSummaryResponseBody& setData(DescribeAIAssetSummaryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<DescribeAIAssetSummaryResponseBodyData> data_ = nullptr;
    // The request ID.
