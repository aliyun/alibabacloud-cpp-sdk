...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeCheckCustomConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ChangeCheckCustomConfigResponseBody) };
    inline ChangeCheckCustomConfigResponseBody body() { DARABONBA_PTR_GET(body_, ChangeCheckCustomConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ChangeCheckCustomConfigResponseBody> body_ = nullptr;
  };
