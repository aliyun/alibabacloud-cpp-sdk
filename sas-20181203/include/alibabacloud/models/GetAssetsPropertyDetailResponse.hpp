...
namespace Models
{
  ...
  public:
    ...
    inline const GetAssetsPropertyDetailResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetAssetsPropertyDetailResponseBody) };
    inline GetAssetsPropertyDetailResponseBody body() { DARABONBA_PTR_GET(body_, GetAssetsPropertyDetailResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetAssetsPropertyDetailResponseBody> body_ = nullptr;
  };
