...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTargetListByBatchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTargetListByBatchResponseBody) };
    inline UpdateTargetListByBatchResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTargetListByBatchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTargetListByBatchResponseBody> body_ {};
  };
