...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePropertyUsageTopResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribePropertyUsageTopResponseBody) };
    inline DescribePropertyUsageTopResponseBody body() { DARABONBA_PTR_GET(body_, DescribePropertyUsageTopResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribePropertyUsageTopResponseBody> body_ = nullptr;
  };
