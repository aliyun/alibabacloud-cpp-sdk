...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alarmUniqueInfo_ == nullptr
        ...
        && return this->resourceDirectoryAccountId_ == nullptr && return this->sortColumn_ == nullptr && return this->sortType_ == nullptr && return this->source_ == nullptr && return this->sourceAliUidsShrink_ == nullptr
