...
namespace Models
{
  ...
  public:
    ...
    inline const GetSupportedModulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSupportedModulesResponseBody) };
    inline GetSupportedModulesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSupportedModulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSupportedModulesResponseBody> body_ {};
  };
