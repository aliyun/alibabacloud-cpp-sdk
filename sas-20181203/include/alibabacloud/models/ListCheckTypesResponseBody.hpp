...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListCheckTypesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListCheckTypesResponseBodyData>) };
    inline vector<ListCheckTypesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListCheckTypesResponseBodyData>) };
    inline ListCheckTypesResponseBody& setData(const vector<ListCheckTypesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCheckTypesResponseBody& setData(vector<ListCheckTypesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<vector<ListCheckTypesResponseBodyData>> data_ = nullptr;
