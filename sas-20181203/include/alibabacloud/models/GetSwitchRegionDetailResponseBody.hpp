...
namespace Models
{
  ...
  public:
    ...
    inline const GetSwitchRegionDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSwitchRegionDetailResponseBodyData) };
    inline GetSwitchRegionDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSwitchRegionDetailResponseBodyData) };
    inline GetSwitchRegionDetailResponseBody& setData(const GetSwitchRegionDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSwitchRegionDetailResponseBody& setData(GetSwitchRegionDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetSwitchRegionDetailResponseBodyData> data_ = nullptr;
    // The request ID.
