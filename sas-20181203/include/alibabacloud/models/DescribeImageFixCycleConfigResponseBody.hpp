...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageFixCycleConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeImageFixCycleConfigResponseBodyData) };
    inline DescribeImageFixCycleConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeImageFixCycleConfigResponseBodyData) };
    inline DescribeImageFixCycleConfigResponseBody& setData(const DescribeImageFixCycleConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeImageFixCycleConfigResponseBody& setData(DescribeImageFixCycleConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeImageFixCycleConfigResponseBodyData> data_ = nullptr;
    // The request ID.
