...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCustomBlockInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCustomBlockInstancesResponseBody) };
    inline DescribeCustomBlockInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCustomBlockInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCustomBlockInstancesResponseBody> body_ {};
  };
