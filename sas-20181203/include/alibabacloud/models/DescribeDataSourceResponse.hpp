...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDataSourceResponseBody) };
    inline DescribeDataSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDataSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDataSourceResponseBody> body_ {};
  };
