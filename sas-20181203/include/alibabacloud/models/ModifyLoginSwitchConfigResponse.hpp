...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLoginSwitchConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyLoginSwitchConfigResponseBody) };
    inline ModifyLoginSwitchConfigResponseBody body() { DARABONBA_PTR_GET(body_, ModifyLoginSwitchConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyLoginSwitchConfigResponseBody> body_ = nullptr;
  };
