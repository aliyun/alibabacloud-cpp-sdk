...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHybridProxyListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHybridProxyListResponseBody) };
    inline DescribeHybridProxyListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHybridProxyListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHybridProxyListResponseBody> body_ {};
  };
