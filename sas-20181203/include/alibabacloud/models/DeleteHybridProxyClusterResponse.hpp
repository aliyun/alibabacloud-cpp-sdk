...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteHybridProxyClusterResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteHybridProxyClusterResponseBody) };
    inline DeleteHybridProxyClusterResponseBody body() { DARABONBA_PTR_GET(body_, DeleteHybridProxyClusterResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteHybridProxyClusterResponseBody> body_ = nullptr;
  };
