...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOpaStrategyNewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateOpaStrategyNewResponseBody) };
    inline CreateOpaStrategyNewResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateOpaStrategyNewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateOpaStrategyNewResponseBody> body_ {};
  };
