...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyWebLockStartResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyWebLockStartResponseBody) };
    inline ModifyWebLockStartResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyWebLockStartResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyWebLockStartResponseBody> body_ {};
  };
