...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAffectedMaliciousFileImagesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAffectedMaliciousFileImagesResponseBody) };
    inline DescribeAffectedMaliciousFileImagesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAffectedMaliciousFileImagesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAffectedMaliciousFileImagesResponseBody> body_ {};
  };
