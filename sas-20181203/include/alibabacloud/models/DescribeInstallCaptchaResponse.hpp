...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstallCaptchaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstallCaptchaResponseBody) };
    inline DescribeInstallCaptchaResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstallCaptchaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstallCaptchaResponseBody> body_ {};
  };
