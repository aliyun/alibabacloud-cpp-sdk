...
namespace Models
{
  ...
  public:
    ...
    inline const GetAssetDetailByUuidResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAssetDetailByUuidResponseBody) };
    inline GetAssetDetailByUuidResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAssetDetailByUuidResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAssetDetailByUuidResponseBody> body_ {};
  };
