  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->canTry_ == nullptr
        && this->deductPackageList_ == nullptr && this->trialVersion_ == nullptr; };
      ...
      inline Data& setTrialVersion(int32_t trialVersion) { DARABONBA_PTR_SET_VALUE(trialVersion_, trialVersion) };
