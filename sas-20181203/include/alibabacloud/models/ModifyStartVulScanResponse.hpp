...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyStartVulScanResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyStartVulScanResponseBody) };
    inline ModifyStartVulScanResponseBody body() { DARABONBA_PTR_GET(body_, ModifyStartVulScanResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyStartVulScanResponseBody> body_ = nullptr;
  };
