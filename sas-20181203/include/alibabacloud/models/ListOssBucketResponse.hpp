...
namespace Models
{
  ...
  public:
    ...
    inline const ListOssBucketResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOssBucketResponseBody) };
    inline ListOssBucketResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOssBucketResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOssBucketResponseBody> body_ {};
  };
