...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePrivateRegistryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePrivateRegistryResponseBody) };
    inline DeletePrivateRegistryResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePrivateRegistryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePrivateRegistryResponseBody> body_ {};
  };
