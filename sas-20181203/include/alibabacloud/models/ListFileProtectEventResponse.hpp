...
namespace Models
{
  ...
  public:
    ...
    inline const ListFileProtectEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFileProtectEventResponseBody) };
    inline ListFileProtectEventResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFileProtectEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFileProtectEventResponseBody> body_ {};
  };
