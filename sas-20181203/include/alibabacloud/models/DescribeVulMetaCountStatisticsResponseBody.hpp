...
namespace Models
{
  ...
  public:
    ...
    inline int32_t getRaspDefendCount() const { DARABONBA_PTR_GET_DEFAULT(raspDefendCount_, 0) };
    ...
    inline int32_t getSysCount() const { DARABONBA_PTR_GET_DEFAULT(sysCount_, 0) };
  ...
  protected:
    ...
    shared_ptr<int32_t> raspDefendCount_ {};
    // The request ID.
    shared_ptr<string> requestId_ {};
    // The number of Windows system vulnerabilities.
    shared_ptr<int32_t> sysCount_ {};
  };
