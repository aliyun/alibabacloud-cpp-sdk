...
#ifndef ALIBABACLOUD_MODELS_CREATEHONEYPOTRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_CREATEHONEYPOTRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateHoneypotResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateHoneypotResponseBodyData& obj) { 
    ...
    CreateHoneypotResponseBodyData() = default ;
    CreateHoneypotResponseBodyData(const CreateHoneypotResponseBodyData &) = default ;
    CreateHoneypotResponseBodyData(CreateHoneypotResponseBodyData &&) = default ;
    CreateHoneypotResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateHoneypotResponseBodyData() = default ;
    CreateHoneypotResponseBodyData& operator=(const CreateHoneypotResponseBodyData &) = default ;
    CreateHoneypotResponseBodyData& operator=(CreateHoneypotResponseBodyData &&) = default ;
    ...
    inline CreateHoneypotResponseBodyData& setControlNodeName(string controlNodeName) { DARABONBA_PTR_SET_VALUE(controlNodeName_, controlNodeName) };
    ...
    inline CreateHoneypotResponseBodyData& setHoneypotId(string honeypotId) { DARABONBA_PTR_SET_VALUE(honeypotId_, honeypotId) };
    ...
    inline CreateHoneypotResponseBodyData& setHoneypotImageDisplayName(string honeypotImageDisplayName) { DARABONBA_PTR_SET_VALUE(honeypotImageDisplayName_, honeypotImageDisplayName) };
    ...
    inline CreateHoneypotResponseBodyData& setHoneypotImageName(string honeypotImageName) { DARABONBA_PTR_SET_VALUE(honeypotImageName_, honeypotImageName) };
    ...
    inline CreateHoneypotResponseBodyData& setHoneypotName(string honeypotName) { DARABONBA_PTR_SET_VALUE(honeypotName_, honeypotName) };
    ...
    inline CreateHoneypotResponseBodyData& setNodeId(string nodeId) { DARABONBA_PTR_SET_VALUE(nodeId_, nodeId) };
    ...
    inline CreateHoneypotResponseBodyData& setPresetId(string presetId) { DARABONBA_PTR_SET_VALUE(presetId_, presetId) };
    ...
    inline CreateHoneypotResponseBodyData& setState(const vector<string> & state) { DARABONBA_PTR_SET_VALUE(state_, state) };
    inline CreateHoneypotResponseBodyData& setState(vector<string> && state) { DARABONBA_PTR_SET_RVALUE(state_, state) };
