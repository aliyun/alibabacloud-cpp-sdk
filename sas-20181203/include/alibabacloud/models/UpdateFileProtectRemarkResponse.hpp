...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFileProtectRemarkResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateFileProtectRemarkResponseBody) };
    inline UpdateFileProtectRemarkResponseBody body() { DARABONBA_PTR_GET(body_, UpdateFileProtectRemarkResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateFileProtectRemarkResponseBody> body_ = nullptr;
  };
