...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCanAccessVpcSaleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCanAccessVpcSaleResponseBody) };
    inline DescribeCanAccessVpcSaleResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCanAccessVpcSaleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCanAccessVpcSaleResponseBody> body_ {};
  };
