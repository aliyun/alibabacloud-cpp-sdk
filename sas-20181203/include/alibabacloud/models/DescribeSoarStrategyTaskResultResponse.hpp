...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSoarStrategyTaskResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSoarStrategyTaskResultResponseBody) };
    inline DescribeSoarStrategyTaskResultResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSoarStrategyTaskResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSoarStrategyTaskResultResponseBody> body_ {};
  };
