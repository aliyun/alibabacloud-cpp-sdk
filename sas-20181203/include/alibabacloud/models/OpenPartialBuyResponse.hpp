...
namespace Models
{
  ...
  public:
    ...
    inline const OpenPartialBuyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, OpenPartialBuyResponseBody) };
    inline OpenPartialBuyResponseBody body() { DARABONBA_PTR_GET(body_, OpenPartialBuyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<OpenPartialBuyResponseBody> body_ = nullptr;
  };
