...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->honeypotProbe_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const CreateHoneypotProbeResponseBodyHoneypotProbe & honeypotProbe() const { DARABONBA_PTR_GET_CONST(honeypotProbe_, CreateHoneypotProbeResponseBodyHoneypotProbe) };
    inline CreateHoneypotProbeResponseBodyHoneypotProbe honeypotProbe() { DARABONBA_PTR_GET(honeypotProbe_, CreateHoneypotProbeResponseBodyHoneypotProbe) };
    inline CreateHoneypotProbeResponseBody& setHoneypotProbe(const CreateHoneypotProbeResponseBodyHoneypotProbe & honeypotProbe) { DARABONBA_PTR_SET_VALUE(honeypotProbe_, honeypotProbe) };
    inline CreateHoneypotProbeResponseBody& setHoneypotProbe(CreateHoneypotProbeResponseBodyHoneypotProbe && honeypotProbe) { DARABONBA_PTR_SET_RVALUE(honeypotProbe_, honeypotProbe) };
  ...
  protected:
    ...
    std::shared_ptr<CreateHoneypotProbeResponseBodyHoneypotProbe> honeypotProbe_ = nullptr;
