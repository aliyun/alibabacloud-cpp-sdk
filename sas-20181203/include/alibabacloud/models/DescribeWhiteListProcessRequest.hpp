...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentPage_ == nullptr
        && return this->desc_ == nullptr && return this->lang_ == nullptr && return this->orderBy_ == nullptr && return this->pageSize_ == nullptr && return this->processName_ == nullptr
        && return this->processType_ == nullptr && return this->sourceIp_ == nullptr && return this->strategyId_ == nullptr; };
    ...
    inline int32_t desc() const { DARABONBA_PTR_GET_DEFAULT(desc_, 0) };
    ...
    inline int32_t orderBy() const { DARABONBA_PTR_GET_DEFAULT(orderBy_, 0) };
  ...
  protected:
    ...
    // *   **1**: ascending order
    // *   **2**: descending order
    std::shared_ptr<int32_t> desc_ = nullptr;
    ...
    std::shared_ptr<int32_t> orderBy_ = nullptr;
