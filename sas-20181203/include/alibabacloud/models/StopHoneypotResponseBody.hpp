...
#ifndef ALIBABACLOUD_MODELS_STOPHONEYPOTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_STOPHONEYPOTRESPONSEBODY_HPP_
...
namespace Models
{
  class StopHoneypotResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const StopHoneypotResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StopHoneypotResponseBody& obj) { 
    ...
    StopHoneypotResponseBody() = default ;
    StopHoneypotResponseBody(const StopHoneypotResponseBody &) = default ;
    StopHoneypotResponseBody(StopHoneypotResponseBody &&) = default ;
    StopHoneypotResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StopHoneypotResponseBody() = default ;
    StopHoneypotResponseBody& operator=(const StopHoneypotResponseBody &) = default ;
    StopHoneypotResponseBody& operator=(StopHoneypotResponseBody &&) = default ;
    ...
    inline StopHoneypotResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const StopHoneypotResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, StopHoneypotResponseBody::Data) };
    inline StopHoneypotResponseBody::Data getData() { DARABONBA_PTR_GET(data_, StopHoneypotResponseBody::Data) };
    inline StopHoneypotResponseBody& setData(const StopHoneypotResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline StopHoneypotResponseBody& setData(StopHoneypotResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline StopHoneypotResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline StopHoneypotResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline StopHoneypotResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline StopHoneypotResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    // The data returned.
    shared_ptr<StopHoneypotResponseBody::Data> data_ {};
