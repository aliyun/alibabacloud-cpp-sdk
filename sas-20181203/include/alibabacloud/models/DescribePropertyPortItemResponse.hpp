...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePropertyPortItemResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePropertyPortItemResponseBody) };
    inline DescribePropertyPortItemResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePropertyPortItemResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePropertyPortItemResponseBody> body_ {};
  };
