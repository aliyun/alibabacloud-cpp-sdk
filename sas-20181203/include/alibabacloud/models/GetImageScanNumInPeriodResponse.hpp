...
namespace Models
{
  ...
  public:
    ...
    inline const GetImageScanNumInPeriodResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetImageScanNumInPeriodResponseBody) };
    inline GetImageScanNumInPeriodResponseBody getBody() { DARABONBA_PTR_GET(body_, GetImageScanNumInPeriodResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetImageScanNumInPeriodResponseBody> body_ {};
  };
