...
namespace Models
{
  ...
  public:
    ...
    inline const GetContainerDefenseRuleDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetContainerDefenseRuleDetailResponseBody) };
    inline GetContainerDefenseRuleDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetContainerDefenseRuleDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetContainerDefenseRuleDetailResponseBody> body_ {};
  };
