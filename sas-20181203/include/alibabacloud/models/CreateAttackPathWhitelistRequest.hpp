...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->attackPathAssetList_ == nullptr
        && return this->pathName_ == nullptr && return this->pathType_ == nullptr && return this->remark_ == nullptr && return this->whitelistName_ == nullptr && return this->whitelistType_ == nullptr; };
