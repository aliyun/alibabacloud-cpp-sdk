...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->downloadUrl_ == nullptr
        && return this->exportDate_ == nullptr && return this->exportId_ == nullptr && return this->exportStatus_ == nullptr && return this->reportId_ == nullptr && return this->requestId_ == nullptr
        && return this->urlExpiredTime_ == nullptr; };
