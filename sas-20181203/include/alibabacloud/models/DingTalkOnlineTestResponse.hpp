...
namespace Models
{
  ...
  public:
    ...
    inline const DingTalkOnlineTestResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DingTalkOnlineTestResponseBody) };
    inline DingTalkOnlineTestResponseBody getBody() { DARABONBA_PTR_GET(body_, DingTalkOnlineTestResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DingTalkOnlineTestResponseBody> body_ {};
  };
