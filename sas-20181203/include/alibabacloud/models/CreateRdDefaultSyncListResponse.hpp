...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRdDefaultSyncListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateRdDefaultSyncListResponseBody) };
    inline CreateRdDefaultSyncListResponseBody body() { DARABONBA_PTR_GET(body_, CreateRdDefaultSyncListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateRdDefaultSyncListResponseBody> body_ = nullptr;
  };
