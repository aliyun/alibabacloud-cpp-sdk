...
namespace Models
{
  ...
  public:
    ...
    inline const GetHoneyPotUploadPolicyInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetHoneyPotUploadPolicyInfoResponseBodyData) };
    inline GetHoneyPotUploadPolicyInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, GetHoneyPotUploadPolicyInfoResponseBodyData) };
    inline GetHoneyPotUploadPolicyInfoResponseBody& setData(const GetHoneyPotUploadPolicyInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHoneyPotUploadPolicyInfoResponseBody& setData(GetHoneyPotUploadPolicyInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetHoneyPotUploadPolicyInfoResponseBodyData> data_ = nullptr;
