...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetOpaStrategyTemplateSummaryResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetOpaStrategyTemplateSummaryResponseBodyData>) };
    inline vector<GetOpaStrategyTemplateSummaryResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetOpaStrategyTemplateSummaryResponseBodyData>) };
    inline GetOpaStrategyTemplateSummaryResponseBody& setData(const vector<GetOpaStrategyTemplateSummaryResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetOpaStrategyTemplateSummaryResponseBody& setData(vector<GetOpaStrategyTemplateSummaryResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetOpaStrategyTemplateSummaryResponseBodyData>> data_ = nullptr;
