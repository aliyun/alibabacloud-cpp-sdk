...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->attackPathSensitiveAssetConfig_ != nullptr
    ...
    inline const CreateAttackPathSensitiveAssetConfigResponseBodyAttackPathSensitiveAssetConfig & attackPathSensitiveAssetConfig() const { DARABONBA_PTR_GET_CONST(attackPathSensitiveAssetConfig_, CreateAttackPathSensitiveAssetConfigResponseBodyAttackPathSensitiveAssetConfig) };
    inline CreateAttackPathSensitiveAssetConfigResponseBodyAttackPathSensitiveAssetConfig attackPathSensitiveAssetConfig() { DARABONBA_PTR_GET(attackPathSensitiveAssetConfig_, CreateAttackPathSensitiveAssetConfigResponseBodyAttackPathSensitiveAssetConfig) };
    inline CreateAttackPathSensitiveAssetConfigResponseBody& setAttackPathSensitiveAssetConfig(const CreateAttackPathSensitiveAssetConfigResponseBodyAttackPathSensitiveAssetConfig & attackPathSensitiveAssetConfig) { DARABONBA_PTR_SET_VALUE(attackPathSensitiveAssetConfig_, attackPathSensitiveAssetConfig) };
    inline CreateAttackPathSensitiveAssetConfigResponseBody& setAttackPathSensitiveAssetConfig(CreateAttackPathSensitiveAssetConfigResponseBodyAttackPathSensitiveAssetConfig && attackPathSensitiveAssetConfig) { DARABONBA_PTR_SET_RVALUE(attackPathSensitiveAssetConfig_, attackPathSensitiveAssetConfig) };
  ...
  protected:
    ...
    std::shared_ptr<CreateAttackPathSensitiveAssetConfigResponseBodyAttackPathSensitiveAssetConfig> attackPathSensitiveAssetConfig_ = nullptr;
