...
namespace Models
{
  ...
  public:
    ...
    inline const QueryGroupIdByGroupNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryGroupIdByGroupNameResponseBody) };
    inline QueryGroupIdByGroupNameResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryGroupIdByGroupNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryGroupIdByGroupNameResponseBody> body_ {};
  };
