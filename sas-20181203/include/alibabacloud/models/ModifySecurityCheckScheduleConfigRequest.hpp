...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->daysOfWeek_ == nullptr
        && return this->endTime_ == nullptr && return this->lang_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->sourceIp_ == nullptr && return this->startTime_ == nullptr; };
