...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitTenantCheckResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SubmitTenantCheckResponseBody::Data) };
    inline SubmitTenantCheckResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SubmitTenantCheckResponseBody::Data) };
    inline SubmitTenantCheckResponseBody& setData(const SubmitTenantCheckResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitTenantCheckResponseBody& setData(SubmitTenantCheckResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    shared_ptr<SubmitTenantCheckResponseBody::Data> data_ {};
    // The request ID.
