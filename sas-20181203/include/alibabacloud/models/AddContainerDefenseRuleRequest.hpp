...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AddContainerDefenseRuleRequest::Scope> & getScope() const { DARABONBA_PTR_GET_CONST(scope_, vector<AddContainerDefenseRuleRequest::Scope>) };
    inline vector<AddContainerDefenseRuleRequest::Scope> getScope() { DARABONBA_PTR_GET(scope_, vector<AddContainerDefenseRuleRequest::Scope>) };
    inline AddContainerDefenseRuleRequest& setScope(const vector<AddContainerDefenseRuleRequest::Scope> & scope) { DARABONBA_PTR_SET_VALUE(scope_, scope) };
    inline AddContainerDefenseRuleRequest& setScope(vector<AddContainerDefenseRuleRequest::Scope> && scope) { DARABONBA_PTR_SET_RVALUE(scope_, scope) };


    // whitelist Field Functions 
    bool hasWhitelist() const { return this->whitelist_ != nullptr;};
    void deleteWhitelist() { this->whitelist_ = nullptr;};
    inline const AddContainerDefenseRuleRequest::Whitelist & getWhitelist() const { DARABONBA_PTR_GET_CONST(whitelist_, AddContainerDefenseRuleRequest::Whitelist) };
    inline AddContainerDefenseRuleRequest::Whitelist getWhitelist() { DARABONBA_PTR_GET(whitelist_, AddContainerDefenseRuleRequest::Whitelist) };
    inline AddContainerDefenseRuleRequest& setWhitelist(const AddContainerDefenseRuleRequest::Whitelist & whitelist) { DARABONBA_PTR_SET_VALUE(whitelist_, whitelist) };
    inline AddContainerDefenseRuleRequest& setWhitelist(AddContainerDefenseRuleRequest::Whitelist && whitelist) { DARABONBA_PTR_SET_RVALUE(whitelist_, whitelist) };
