...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->checkWarnings_ != nullptr
    ...
    inline const vector<DescribeCheckWarningsResponseBodyCheckWarnings> & checkWarnings() const { DARABONBA_PTR_GET_CONST(checkWarnings_, vector<DescribeCheckWarningsResponseBodyCheckWarnings>) };
    inline vector<DescribeCheckWarningsResponseBodyCheckWarnings> checkWarnings() { DARABONBA_PTR_GET(checkWarnings_, vector<DescribeCheckWarningsResponseBodyCheckWarnings>) };
    inline DescribeCheckWarningsResponseBody& setCheckWarnings(const vector<DescribeCheckWarningsResponseBodyCheckWarnings> & checkWarnings) { DARABONBA_PTR_SET_VALUE(checkWarnings_, checkWarnings) };
    inline DescribeCheckWarningsResponseBody& setCheckWarnings(vector<DescribeCheckWarningsResponseBodyCheckWarnings> && checkWarnings) { DARABONBA_PTR_SET_RVALUE(checkWarnings_, checkWarnings) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeCheckWarningsResponseBodyCheckWarnings>> checkWarnings_ = nullptr;
