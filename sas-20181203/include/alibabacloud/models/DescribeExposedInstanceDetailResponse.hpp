...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExposedInstanceDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeExposedInstanceDetailResponseBody) };
    inline DescribeExposedInstanceDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeExposedInstanceDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeExposedInstanceDetailResponseBody> body_ {};
  };
