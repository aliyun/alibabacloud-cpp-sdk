...
namespace Models
{
  ...
  public:
    ...
    inline const CancelOnceTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelOnceTaskResponseBody) };
    inline CancelOnceTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelOnceTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelOnceTaskResponseBody> body_ {};
  };
