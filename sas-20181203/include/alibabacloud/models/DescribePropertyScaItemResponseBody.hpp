...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->bizType_ == nullptr
        && this->count_ == nullptr && this->name_ == nullptr && this->typeDisplay_ == nullptr; };
      // bizType Field Functions 
      bool hasBizType() const { return this->bizType_ != nullptr;};
      void deleteBizType() { this->bizType_ = nullptr;};
      inline string getBizType() const { DARABONBA_PTR_GET_DEFAULT(bizType_, "") };
      inline PropertyItems& setBizType(string bizType) { DARABONBA_PTR_SET_VALUE(bizType_, bizType) };
      ...
      inline string getTypeDisplay() const { DARABONBA_PTR_GET_DEFAULT(typeDisplay_, "") };
      inline PropertyItems& setTypeDisplay(string typeDisplay) { DARABONBA_PTR_SET_VALUE(typeDisplay_, typeDisplay) };
    ...
    protected:
      ...
      shared_ptr<string> typeDisplay_ {};
    };
    ...
    inline const DescribePropertyScaItemResponseBody::PageInfo & getPageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, DescribePropertyScaItemResponseBody::PageInfo) };
    inline DescribePropertyScaItemResponseBody::PageInfo getPageInfo() { DARABONBA_PTR_GET(pageInfo_, DescribePropertyScaItemResponseBody::PageInfo) };
    inline DescribePropertyScaItemResponseBody& setPageInfo(const DescribePropertyScaItemResponseBody::PageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline DescribePropertyScaItemResponseBody& setPageInfo(DescribePropertyScaItemResponseBody::PageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
    ...
    inline const vector<DescribePropertyScaItemResponseBody::PropertyItems> & getPropertyItems() const { DARABONBA_PTR_GET_CONST(propertyItems_, vector<DescribePropertyScaItemResponseBody::PropertyItems>) };
    inline vector<DescribePropertyScaItemResponseBody::PropertyItems> getPropertyItems() { DARABONBA_PTR_GET(propertyItems_, vector<DescribePropertyScaItemResponseBody::PropertyItems>) };
    inline DescribePropertyScaItemResponseBody& setPropertyItems(const vector<DescribePropertyScaItemResponseBody::PropertyItems> & propertyItems) { DARABONBA_PTR_SET_VALUE(propertyItems_, propertyItems) };
    inline DescribePropertyScaItemResponseBody& setPropertyItems(vector<DescribePropertyScaItemResponseBody::PropertyItems> && propertyItems) { DARABONBA_PTR_SET_RVALUE(propertyItems_, propertyItems) };
  ...
  protected:
    ...
    shared_ptr<DescribePropertyScaItemResponseBody::PageInfo> pageInfo_ {};
    // An array that consists of the information about middleware fingerprints.
    shared_ptr<vector<DescribePropertyScaItemResponseBody::PropertyItems>> propertyItems_ {};
