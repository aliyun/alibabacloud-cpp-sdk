...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListClusterPluginInfoResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListClusterPluginInfoResponseBodyData>) };
    inline vector<ListClusterPluginInfoResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListClusterPluginInfoResponseBodyData>) };
    inline ListClusterPluginInfoResponseBody& setData(const vector<ListClusterPluginInfoResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListClusterPluginInfoResponseBody& setData(vector<ListClusterPluginInfoResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListClusterPluginInfoResponseBodyData>> data_ = nullptr;
    // The request ID.
