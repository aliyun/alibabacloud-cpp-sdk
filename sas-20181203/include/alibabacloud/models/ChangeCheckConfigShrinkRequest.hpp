...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ChangeCheckConfigShrinkRequestAddedCheck> & addedCheck() const { DARABONBA_PTR_GET_CONST(addedCheck_, vector<ChangeCheckConfigShrinkRequestAddedCheck>) };
    inline vector<ChangeCheckConfigShrinkRequestAddedCheck> addedCheck() { DARABONBA_PTR_GET(addedCheck_, vector<ChangeCheckConfigShrinkRequestAddedCheck>) };
    inline ChangeCheckConfigShrinkRequest& setAddedCheck(const vector<ChangeCheckConfigShrinkRequestAddedCheck> & addedCheck) { DARABONBA_PTR_SET_VALUE(addedCheck_, addedCheck) };
    inline ChangeCheckConfigShrinkRequest& setAddedCheck(vector<ChangeCheckConfigShrinkRequestAddedCheck> && addedCheck) { DARABONBA_PTR_SET_RVALUE(addedCheck_, addedCheck) };
    ...
    inline string configRequirementIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(configRequirementIdsShrink_, "") };
    ...
    inline string configStandardIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(configStandardIdsShrink_, "") };
    ...
    inline const vector<ChangeCheckConfigShrinkRequestRemovedCheck> & removedCheck() const { DARABONBA_PTR_GET_CONST(removedCheck_, vector<ChangeCheckConfigShrinkRequestRemovedCheck>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ChangeCheckConfigShrinkRequestAddedCheck>> addedCheck_ = nullptr;
    ...
    std::shared_ptr<string> configRequirementIdsShrink_ = nullptr;
    ...
    std::shared_ptr<string> configStandardIdsShrink_ = nullptr;
