...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePropertySoftwareItemResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribePropertySoftwareItemResponseBody) };
    inline DescribePropertySoftwareItemResponseBody body() { DARABONBA_PTR_GET(body_, DescribePropertySoftwareItemResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribePropertySoftwareItemResponseBody> body_ = nullptr;
  };
