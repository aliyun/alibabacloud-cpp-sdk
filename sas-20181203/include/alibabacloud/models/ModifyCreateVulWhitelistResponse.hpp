...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCreateVulWhitelistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCreateVulWhitelistResponseBody) };
    inline ModifyCreateVulWhitelistResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCreateVulWhitelistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCreateVulWhitelistResponseBody> body_ {};
  };
