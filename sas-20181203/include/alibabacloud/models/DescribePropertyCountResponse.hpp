...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePropertyCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePropertyCountResponseBody) };
    inline DescribePropertyCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePropertyCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePropertyCountResponseBody> body_ {};
  };
