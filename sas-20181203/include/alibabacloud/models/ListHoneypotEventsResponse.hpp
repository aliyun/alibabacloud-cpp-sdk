...
namespace Models
{
  ...
  public:
    ...
    inline const ListHoneypotEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHoneypotEventsResponseBody) };
    inline ListHoneypotEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHoneypotEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHoneypotEventsResponseBody> body_ {};
  };
