...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageInfoListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeImageInfoListResponseBody) };
    inline DescribeImageInfoListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeImageInfoListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeImageInfoListResponseBody> body_ {};
  };
