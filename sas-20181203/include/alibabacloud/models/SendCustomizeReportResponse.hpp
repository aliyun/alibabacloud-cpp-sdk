...
namespace Models
{
  ...
  public:
    ...
    inline const SendCustomizeReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendCustomizeReportResponseBody) };
    inline SendCustomizeReportResponseBody getBody() { DARABONBA_PTR_GET(body_, SendCustomizeReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendCustomizeReportResponseBody> body_ {};
  };
