...
namespace Models
{
  ...
  public:
    ...
    inline const SaveImageBaselineStrategyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveImageBaselineStrategyResponseBody) };
    inline SaveImageBaselineStrategyResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveImageBaselineStrategyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveImageBaselineStrategyResponseBody> body_ {};
  };
