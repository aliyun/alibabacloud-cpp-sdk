...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCheckWarningSummaryResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeCheckWarningSummaryResponseBody) };
    inline DescribeCheckWarningSummaryResponseBody body() { DARABONBA_PTR_GET(body_, DescribeCheckWarningSummaryResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCheckWarningSummaryResponseBody> body_ = nullptr;
  };
