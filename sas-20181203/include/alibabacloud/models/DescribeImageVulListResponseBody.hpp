...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentPage_ == nullptr
        && this->pageSize_ == nullptr && this->requestId_ == nullptr && this->totalCount_ == nullptr && this->vulRecords_ == nullptr; };
    ...
    inline const vector<DescribeImageVulListResponseBody::VulRecords> & getVulRecords() const { DARABONBA_PTR_GET_CONST(vulRecords_, vector<DescribeImageVulListResponseBody::VulRecords>) };
    inline vector<DescribeImageVulListResponseBody::VulRecords> getVulRecords() { DARABONBA_PTR_GET(vulRecords_, vector<DescribeImageVulListResponseBody::VulRecords>) };
    inline DescribeImageVulListResponseBody& setVulRecords(const vector<DescribeImageVulListResponseBody::VulRecords> & vulRecords) { DARABONBA_PTR_SET_VALUE(vulRecords_, vulRecords) };
    inline DescribeImageVulListResponseBody& setVulRecords(vector<DescribeImageVulListResponseBody::VulRecords> && vulRecords) { DARABONBA_PTR_SET_RVALUE(vulRecords_, vulRecords) };
