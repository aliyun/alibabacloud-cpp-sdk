...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWhiteListStrategyStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeWhiteListStrategyStatisticsResponseBody) };
    inline DescribeWhiteListStrategyStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeWhiteListStrategyStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeWhiteListStrategyStatisticsResponseBody> body_ {};
  };
