...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getYundunUuids() const { DARABONBA_PTR_GET_CONST(yundunUuids_, vector<string>) };
    inline vector<string> getYundunUuids() { DARABONBA_PTR_GET(yundunUuids_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> yundunUuids_ {};
  };
