...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVulWhitelistTargetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyVulWhitelistTargetResponseBody) };
    inline ModifyVulWhitelistTargetResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyVulWhitelistTargetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyVulWhitelistTargetResponseBody> body_ {};
  };
