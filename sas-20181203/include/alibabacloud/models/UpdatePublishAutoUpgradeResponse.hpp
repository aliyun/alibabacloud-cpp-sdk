...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePublishAutoUpgradeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdatePublishAutoUpgradeResponseBody) };
    inline UpdatePublishAutoUpgradeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdatePublishAutoUpgradeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdatePublishAutoUpgradeResponseBody> body_ {};
  };
