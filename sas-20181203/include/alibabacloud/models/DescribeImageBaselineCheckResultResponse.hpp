...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageBaselineCheckResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeImageBaselineCheckResultResponseBody) };
    inline DescribeImageBaselineCheckResultResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeImageBaselineCheckResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeImageBaselineCheckResultResponseBody> body_ {};
  };
