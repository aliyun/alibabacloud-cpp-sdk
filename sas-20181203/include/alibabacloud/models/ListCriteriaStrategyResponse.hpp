...
namespace Models
{
  ...
  public:
    ...
    inline const ListCriteriaStrategyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCriteriaStrategyResponseBody) };
    inline ListCriteriaStrategyResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCriteriaStrategyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCriteriaStrategyResponseBody> body_ {};
  };
