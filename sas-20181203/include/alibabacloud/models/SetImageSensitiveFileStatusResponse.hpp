...
namespace Models
{
  ...
  public:
    ...
    inline const SetImageSensitiveFileStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SetImageSensitiveFileStatusResponseBody) };
    inline SetImageSensitiveFileStatusResponseBody body() { DARABONBA_PTR_GET(body_, SetImageSensitiveFileStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SetImageSensitiveFileStatusResponseBody> body_ = nullptr;
  };
