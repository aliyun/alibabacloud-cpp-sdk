...
namespace Models
{
  ...
  public:
    ...
    inline const AddImageEventOperationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AddImageEventOperationResponseBodyData) };
    inline AddImageEventOperationResponseBodyData data() { DARABONBA_PTR_GET(data_, AddImageEventOperationResponseBodyData) };
    inline AddImageEventOperationResponseBody& setData(const AddImageEventOperationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AddImageEventOperationResponseBody& setData(AddImageEventOperationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<AddImageEventOperationResponseBodyData> data_ = nullptr;
