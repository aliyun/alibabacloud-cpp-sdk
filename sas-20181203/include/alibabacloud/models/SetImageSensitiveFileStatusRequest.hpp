...
#ifndef ALIBABACLOUD_MODELS_SETIMAGESENSITIVEFILESTATUSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SETIMAGESENSITIVEFILESTATUSREQUEST_HPP_
...
namespace Models
{
  class SetImageSensitiveFileStatusRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const SetImageSensitiveFileStatusRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SetImageSensitiveFileStatusRequest& obj) { 
    ...
    SetImageSensitiveFileStatusRequest() = default ;
    SetImageSensitiveFileStatusRequest(const SetImageSensitiveFileStatusRequest &) = default ;
    SetImageSensitiveFileStatusRequest(SetImageSensitiveFileStatusRequest &&) = default ;
    SetImageSensitiveFileStatusRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SetImageSensitiveFileStatusRequest() = default ;
    SetImageSensitiveFileStatusRequest& operator=(const SetImageSensitiveFileStatusRequest &) = default ;
    SetImageSensitiveFileStatusRequest& operator=(SetImageSensitiveFileStatusRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->idList_ != nullptr
