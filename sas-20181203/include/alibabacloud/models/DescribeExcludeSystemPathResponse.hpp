...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExcludeSystemPathResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeExcludeSystemPathResponseBody) };
    inline DescribeExcludeSystemPathResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeExcludeSystemPathResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeExcludeSystemPathResponseBody> body_ {};
  };
