...
namespace Models
{
  ...
  public:
    ...
    inline int32_t getExposedAsapVulCount() const { DARABONBA_PTR_GET_DEFAULT(exposedAsapVulCount_, 0) };
    ...
    inline int32_t getExposedComponentCount() const { DARABONBA_PTR_GET_DEFAULT(exposedComponentCount_, 0) };
    ...
    inline int32_t getExposedDdsCount() const { DARABONBA_PTR_GET_DEFAULT(exposedDdsCount_, 0) };
    ...
    inline int32_t getExposedEcsCount() const { DARABONBA_PTR_GET_DEFAULT(exposedEcsCount_, 0) };
    ...
    inline int32_t getExposedIpCount() const { DARABONBA_PTR_GET_DEFAULT(exposedIpCount_, 0) };
    ...
    inline int32_t getExposedKvstoreCount() const { DARABONBA_PTR_GET_DEFAULT(exposedKvstoreCount_, 0) };
    ...
    inline int32_t getExposedLaterVulCount() const { DARABONBA_PTR_GET_DEFAULT(exposedLaterVulCount_, 0) };
    ...
    inline int32_t getExposedNntfVulCount() const { DARABONBA_PTR_GET_DEFAULT(exposedNntfVulCount_, 0) };
    ...
    inline int32_t getExposedPortCount() const { DARABONBA_PTR_GET_DEFAULT(exposedPortCount_, 0) };
    ...
    inline int32_t getExposedRdsCount() const { DARABONBA_PTR_GET_DEFAULT(exposedRdsCount_, 0) };
    ...
    inline int32_t getExposedWeekPasswordMachineCount() const { DARABONBA_PTR_GET_DEFAULT(exposedWeekPasswordMachineCount_, 0) };
    ...
    inline int32_t getGatewayAssetCount() const { DARABONBA_PTR_GET_DEFAULT(gatewayAssetCount_, 0) };
  ...
  protected:
    ...
    shared_ptr<int32_t> gatewayAssetCount_ {};
