...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && this->rootDomainsCount_ == nullptr && this->subDomainsCount_ == nullptr && this->totalDomainsCount_ == nullptr; };
    ...
    inline int32_t getRootDomainsCount() const { DARABONBA_PTR_GET_DEFAULT(rootDomainsCount_, 0) };
    ...
    inline int32_t getSubDomainsCount() const { DARABONBA_PTR_GET_DEFAULT(subDomainsCount_, 0) };
    ...
    inline int32_t getTotalDomainsCount() const { DARABONBA_PTR_GET_DEFAULT(totalDomainsCount_, 0) };
  ...
  protected:
    ...
    shared_ptr<int32_t> rootDomainsCount_ {};
    // The number of subdomains.
    shared_ptr<int32_t> subDomainsCount_ {};
    // The total number of entries returned.
    shared_ptr<int32_t> totalDomainsCount_ {};
  };
