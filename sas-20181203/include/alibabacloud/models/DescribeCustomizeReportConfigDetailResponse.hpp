...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCustomizeReportConfigDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCustomizeReportConfigDetailResponseBody) };
    inline DescribeCustomizeReportConfigDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCustomizeReportConfigDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCustomizeReportConfigDetailResponseBody> body_ {};
  };
