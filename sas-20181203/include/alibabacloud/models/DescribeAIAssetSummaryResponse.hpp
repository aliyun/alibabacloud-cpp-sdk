...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAIAssetSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAIAssetSummaryResponseBody) };
    inline DescribeAIAssetSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAIAssetSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAIAssetSummaryResponseBody> body_ {};
  };
