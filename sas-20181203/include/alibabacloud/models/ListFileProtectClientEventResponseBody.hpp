...
#ifndef ALIBABACLOUD_MODELS_LISTFILEPROTECTCLIENTEVENTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTFILEPROTECTCLIENTEVENTRESPONSEBODY_HPP_
...
namespace Models
{
  class ListFileProtectClientEventResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListFileProtectClientEventResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(EventList, eventList_);
      DARABONBA_PTR_TO_JSON(PageInfo, pageInfo_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListFileProtectClientEventResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(EventList, eventList_);
      DARABONBA_PTR_FROM_JSON(PageInfo, pageInfo_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ListFileProtectClientEventResponseBody() = default ;
    ListFileProtectClientEventResponseBody(const ListFileProtectClientEventResponseBody &) = default ;
    ListFileProtectClientEventResponseBody(ListFileProtectClientEventResponseBody &&) = default ;
    ListFileProtectClientEventResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListFileProtectClientEventResponseBody() = default ;
    ListFileProtectClientEventResponseBody& operator=(const ListFileProtectClientEventResponseBody &) = default ;
    ListFileProtectClientEventResponseBody& operator=(ListFileProtectClientEventResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->alertLevel_ == nullptr
        && this->cmdLine_ == nullptr && this->count_ == nullptr && this->filePath_ == nullptr && this->firstTime_ == nullptr && this->handleTime_ == nullptr
        && this->id_ == nullptr && this->instanceName_ == nullptr && this->internetIp_ == nullptr && this->intranetIp_ == nullptr && this->latestTime_ == nullptr
        && this->operation_ == nullptr && this->platform_ == nullptr && this->procPath_ == nullptr && this->procPermission_ == nullptr && this->processId_ == nullptr
        && this->remark_ == nullptr && this->ruleAction_ == nullptr && this->ruleName_ == nullptr && this->status_ == nullptr && this->uuid_ == nullptr; };
      ...
      inline EventList& setCount(int32_t count) { DARABONBA_PTR_SET_VALUE(count_, count) };
      ...
      inline EventList& setFirstTime(int64_t firstTime) { DARABONBA_PTR_SET_VALUE(firstTime_, firstTime) };
      ...
      inline EventList& setRuleAction(string ruleAction) { DARABONBA_PTR_SET_VALUE(ruleAction_, ruleAction) };
    ...
    inline const vector<ListFileProtectClientEventResponseBody::EventList> & getEventList() const { DARABONBA_PTR_GET_CONST(eventList_, vector<ListFileProtectClientEventResponseBody::EventList>) };
    inline vector<ListFileProtectClientEventResponseBody::EventList> getEventList() { DARABONBA_PTR_GET(eventList_, vector<ListFileProtectClientEventResponseBody::EventList>) };
    inline ListFileProtectClientEventResponseBody& setEventList(const vector<ListFileProtectClientEventResponseBody::EventList> & eventList) { DARABONBA_PTR_SET_VALUE(eventList_, eventList) };
    inline ListFileProtectClientEventResponseBody& setEventList(vector<ListFileProtectClientEventResponseBody::EventList> && eventList) { DARABONBA_PTR_SET_RVALUE(eventList_, eventList) };


    // pageInfo Field Functions 
    bool hasPageInfo() const { return this->pageInfo_ != nullptr;};
    void deletePageInfo() { this->pageInfo_ = nullptr;};
    inline const ListFileProtectClientEventResponseBody::PageInfo & getPageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, ListFileProtectClientEventResponseBody::PageInfo) };
    inline ListFileProtectClientEventResponseBody::PageInfo getPageInfo() { DARABONBA_PTR_GET(pageInfo_, ListFileProtectClientEventResponseBody::PageInfo) };
    inline ListFileProtectClientEventResponseBody& setPageInfo(const ListFileProtectClientEventResponseBody::PageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline ListFileProtectClientEventResponseBody& setPageInfo(ListFileProtectClientEventResponseBody::PageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
    ...
    inline ListFileProtectClientEventResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
