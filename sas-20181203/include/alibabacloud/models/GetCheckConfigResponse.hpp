...
namespace Models
{
  ...
  public:
    ...
    inline const GetCheckConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCheckConfigResponseBody) };
    inline GetCheckConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCheckConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCheckConfigResponseBody> body_ {};
  };
