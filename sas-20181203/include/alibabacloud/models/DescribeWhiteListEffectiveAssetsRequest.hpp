...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentPage_ == nullptr
        && this->lang_ == nullptr && this->needStatistics_ == nullptr && this->pageSize_ == nullptr && this->remark_ == nullptr && this->sourceIp_ == nullptr
    ...
    inline int32_t getNeedStatistics() const { DARABONBA_PTR_GET_DEFAULT(needStatistics_, 0) };
  ...
  protected:
    ...
    // *   **0**: no
    // *   **1**: yes
    shared_ptr<int32_t> needStatistics_ {};
