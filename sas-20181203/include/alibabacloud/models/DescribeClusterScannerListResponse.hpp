...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClusterScannerListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeClusterScannerListResponseBody) };
    inline DescribeClusterScannerListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeClusterScannerListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeClusterScannerListResponseBody> body_ {};
  };
