...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageBuildRiskByKeyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeImageBuildRiskByKeyResponseBody) };
    inline DescribeImageBuildRiskByKeyResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeImageBuildRiskByKeyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeImageBuildRiskByKeyResponseBody> body_ {};
  };
