...
namespace Models
{
  ...
  public:
    ...
    inline const AddCheckResultWhiteListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddCheckResultWhiteListResponseBody) };
    inline AddCheckResultWhiteListResponseBody body() { DARABONBA_PTR_GET(body_, AddCheckResultWhiteListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddCheckResultWhiteListResponseBody> body_ = nullptr;
  };
