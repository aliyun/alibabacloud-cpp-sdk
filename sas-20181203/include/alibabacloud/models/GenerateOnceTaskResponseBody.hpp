...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->canCreate_ == nullptr
        && this->collectTime_ == nullptr && this->finishCount_ == nullptr && this->lastTask_ == nullptr && this->requestId_ == nullptr && this->taskId_ == nullptr
    ...
    inline string getLastTask() const { DARABONBA_PTR_GET_DEFAULT(lastTask_, "") };
