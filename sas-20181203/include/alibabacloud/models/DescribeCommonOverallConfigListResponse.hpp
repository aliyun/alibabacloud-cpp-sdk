...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCommonOverallConfigListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCommonOverallConfigListResponseBody) };
    inline DescribeCommonOverallConfigListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCommonOverallConfigListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCommonOverallConfigListResponseBody> body_ {};
  };
