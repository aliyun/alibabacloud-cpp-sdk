...
namespace Models
{
  ...
  public:
    ...
    inline const CreateContainerScanTaskByAppNameResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateContainerScanTaskByAppNameResponseBodyData) };
    inline CreateContainerScanTaskByAppNameResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateContainerScanTaskByAppNameResponseBodyData) };
    inline CreateContainerScanTaskByAppNameResponseBody& setData(const CreateContainerScanTaskByAppNameResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateContainerScanTaskByAppNameResponseBody& setData(CreateContainerScanTaskByAppNameResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateContainerScanTaskByAppNameResponseBodyData> data_ = nullptr;
