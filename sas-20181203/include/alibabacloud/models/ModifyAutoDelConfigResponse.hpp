...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAutoDelConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyAutoDelConfigResponseBody) };
    inline ModifyAutoDelConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyAutoDelConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyAutoDelConfigResponseBody> body_ {};
  };
