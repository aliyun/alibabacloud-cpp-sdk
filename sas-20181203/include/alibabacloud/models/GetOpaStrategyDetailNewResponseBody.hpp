...
#ifndef ALIBABACLOUD_MODELS_GETOPASTRATEGYDETAILNEWRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETOPASTRATEGYDETAILNEWRESPONSEBODY_HPP_
...
namespace Models
{
  class GetOpaStrategyDetailNewResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetOpaStrategyDetailNewResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetOpaStrategyDetailNewResponseBody& obj) { 
    ...
    GetOpaStrategyDetailNewResponseBody() = default ;
    GetOpaStrategyDetailNewResponseBody(const GetOpaStrategyDetailNewResponseBody &) = default ;
    GetOpaStrategyDetailNewResponseBody(GetOpaStrategyDetailNewResponseBody &&) = default ;
    GetOpaStrategyDetailNewResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetOpaStrategyDetailNewResponseBody() = default ;
    GetOpaStrategyDetailNewResponseBody& operator=(const GetOpaStrategyDetailNewResponseBody &) = default ;
    GetOpaStrategyDetailNewResponseBody& operator=(GetOpaStrategyDetailNewResponseBody &&) = default ;
    ...
    public:
      ...
      inline const vector<Data::Scopes> & getScopes() const { DARABONBA_PTR_GET_CONST(scopes_, vector<Data::Scopes>) };
      inline vector<Data::Scopes> getScopes() { DARABONBA_PTR_GET(scopes_, vector<Data::Scopes>) };
      inline Data& setScopes(const vector<Data::Scopes> & scopes) { DARABONBA_PTR_SET_VALUE(scopes_, scopes) };
      inline Data& setScopes(vector<Data::Scopes> && scopes) { DARABONBA_PTR_SET_RVALUE(scopes_, scopes) };
    ...
    inline GetOpaStrategyDetailNewResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetOpaStrategyDetailNewResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetOpaStrategyDetailNewResponseBody::Data) };
    inline GetOpaStrategyDetailNewResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetOpaStrategyDetailNewResponseBody::Data) };
    inline GetOpaStrategyDetailNewResponseBody& setData(const GetOpaStrategyDetailNewResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetOpaStrategyDetailNewResponseBody& setData(GetOpaStrategyDetailNewResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetOpaStrategyDetailNewResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline GetOpaStrategyDetailNewResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetOpaStrategyDetailNewResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetOpaStrategyDetailNewResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    // The data returned.
    shared_ptr<GetOpaStrategyDetailNewResponseBody::Data> data_ {};
