...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteContainerPluginRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteContainerPluginRuleResponseBody) };
    inline DeleteContainerPluginRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteContainerPluginRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteContainerPluginRuleResponseBody> body_ {};
  };
