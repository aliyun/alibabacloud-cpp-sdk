...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline string getBindIp() const { DARABONBA_PTR_GET_DEFAULT(bindIp_, "") };
      inline Propertys& setBindIp(string bindIp) { DARABONBA_PTR_SET_VALUE(bindIp_, bindIp) };
      ...
      inline string getProcName() const { DARABONBA_PTR_GET_DEFAULT(procName_, "") };
      inline Propertys& setProcName(string procName) { DARABONBA_PTR_SET_VALUE(procName_, procName) };
      ...
      inline Propertys& setProto(string proto) { DARABONBA_PTR_SET_VALUE(proto_, proto) };
    ...
    inline const DescribePropertyPortDetailResponseBody::PageInfo & getPageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, DescribePropertyPortDetailResponseBody::PageInfo) };
    inline DescribePropertyPortDetailResponseBody::PageInfo getPageInfo() { DARABONBA_PTR_GET(pageInfo_, DescribePropertyPortDetailResponseBody::PageInfo) };
    inline DescribePropertyPortDetailResponseBody& setPageInfo(const DescribePropertyPortDetailResponseBody::PageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline DescribePropertyPortDetailResponseBody& setPageInfo(DescribePropertyPortDetailResponseBody::PageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
    ...
    inline const vector<DescribePropertyPortDetailResponseBody::Propertys> & getPropertys() const { DARABONBA_PTR_GET_CONST(propertys_, vector<DescribePropertyPortDetailResponseBody::Propertys>) };
    inline vector<DescribePropertyPortDetailResponseBody::Propertys> getPropertys() { DARABONBA_PTR_GET(propertys_, vector<DescribePropertyPortDetailResponseBody::Propertys>) };
    inline DescribePropertyPortDetailResponseBody& setPropertys(const vector<DescribePropertyPortDetailResponseBody::Propertys> & propertys) { DARABONBA_PTR_SET_VALUE(propertys_, propertys) };
    inline DescribePropertyPortDetailResponseBody& setPropertys(vector<DescribePropertyPortDetailResponseBody::Propertys> && propertys) { DARABONBA_PTR_SET_RVALUE(propertys_, propertys) };
  ...
  protected:
    ...
    shared_ptr<DescribePropertyPortDetailResponseBody::PageInfo> pageInfo_ {};
    // The fingerprints of the ports.
    shared_ptr<vector<DescribePropertyPortDetailResponseBody::Propertys>> propertys_ {};
