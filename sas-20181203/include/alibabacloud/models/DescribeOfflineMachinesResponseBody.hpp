...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeOfflineMachinesResponseBody::MachineList> & getMachineList() const { DARABONBA_PTR_GET_CONST(machineList_, vector<DescribeOfflineMachinesResponseBody::MachineList>) };
    inline vector<DescribeOfflineMachinesResponseBody::MachineList> getMachineList() { DARABONBA_PTR_GET(machineList_, vector<DescribeOfflineMachinesResponseBody::MachineList>) };
    inline DescribeOfflineMachinesResponseBody& setMachineList(const vector<DescribeOfflineMachinesResponseBody::MachineList> & machineList) { DARABONBA_PTR_SET_VALUE(machineList_, machineList) };
    inline DescribeOfflineMachinesResponseBody& setMachineList(vector<DescribeOfflineMachinesResponseBody::MachineList> && machineList) { DARABONBA_PTR_SET_RVALUE(machineList_, machineList) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeOfflineMachinesResponseBody::MachineList>> machineList_ {};
