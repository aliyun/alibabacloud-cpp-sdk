...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetOpaClusterImageListResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetOpaClusterImageListResponseBodyData>) };
    inline vector<GetOpaClusterImageListResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetOpaClusterImageListResponseBodyData>) };
    inline GetOpaClusterImageListResponseBody& setData(const vector<GetOpaClusterImageListResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetOpaClusterImageListResponseBody& setData(vector<GetOpaClusterImageListResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetOpaClusterImageListResponseBodyData>> data_ = nullptr;
