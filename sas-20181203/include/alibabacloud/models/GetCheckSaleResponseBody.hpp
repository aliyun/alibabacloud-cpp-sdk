...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->checkSale_ != nullptr
    ...
    inline const GetCheckSaleResponseBodyCheckSale & checkSale() const { DARABONBA_PTR_GET_CONST(checkSale_, GetCheckSaleResponseBodyCheckSale) };
    inline GetCheckSaleResponseBodyCheckSale checkSale() { DARABONBA_PTR_GET(checkSale_, GetCheckSaleResponseBodyCheckSale) };
    inline GetCheckSaleResponseBody& setCheckSale(const GetCheckSaleResponseBodyCheckSale & checkSale) { DARABONBA_PTR_SET_VALUE(checkSale_, checkSale) };
    inline GetCheckSaleResponseBody& setCheckSale(GetCheckSaleResponseBodyCheckSale && checkSale) { DARABONBA_PTR_SET_RVALUE(checkSale_, checkSale) };
  ...
  protected:
    ...
    std::shared_ptr<GetCheckSaleResponseBodyCheckSale> checkSale_ = nullptr;
    // The request ID.
