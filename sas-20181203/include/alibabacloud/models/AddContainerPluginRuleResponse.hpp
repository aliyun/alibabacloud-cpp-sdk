...
namespace Models
{
  ...
  public:
    ...
    inline const AddContainerPluginRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddContainerPluginRuleResponseBody) };
    inline AddContainerPluginRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, AddContainerPluginRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddContainerPluginRuleResponseBody> body_ {};
  };
