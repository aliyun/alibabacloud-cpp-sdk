...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeCriteriaResponseBodyCriteriaList> & criteriaList() const { DARABONBA_PTR_GET_CONST(criteriaList_, vector<DescribeCriteriaResponseBodyCriteriaList>) };
    inline vector<DescribeCriteriaResponseBodyCriteriaList> criteriaList() { DARABONBA_PTR_GET(criteriaList_, vector<DescribeCriteriaResponseBodyCriteriaList>) };
    inline DescribeCriteriaResponseBody& setCriteriaList(const vector<DescribeCriteriaResponseBodyCriteriaList> & criteriaList) { DARABONBA_PTR_SET_VALUE(criteriaList_, criteriaList) };
    inline DescribeCriteriaResponseBody& setCriteriaList(vector<DescribeCriteriaResponseBodyCriteriaList> && criteriaList) { DARABONBA_PTR_SET_RVALUE(criteriaList_, criteriaList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeCriteriaResponseBodyCriteriaList>> criteriaList_ = nullptr;
