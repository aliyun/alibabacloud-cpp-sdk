...
namespace Models
{
  ...
  public:
    ...
    inline const CopyCustomizeReportConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CopyCustomizeReportConfigResponseBody) };
    inline CopyCustomizeReportConfigResponseBody body() { DARABONBA_PTR_GET(body_, CopyCustomizeReportConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CopyCustomizeReportConfigResponseBody> body_ = nullptr;
  };
