...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainSecureRiskListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainSecureRiskListResponseBody) };
    inline DescribeDomainSecureRiskListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainSecureRiskListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainSecureRiskListResponseBody> body_ {};
  };
