...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->criteria_ == nullptr
        && this->currentPage_ == nullptr && this->foundEndTime_ == nullptr && this->foundStartTime_ == nullptr && this->logicalExp_ == nullptr && this->pageSize_ == nullptr
    ...
    inline int64_t getFoundEndTime() const { DARABONBA_PTR_GET_DEFAULT(foundEndTime_, 0L) };
    ...
    inline int64_t getFoundStartTime() const { DARABONBA_PTR_GET_DEFAULT(foundStartTime_, 0L) };
