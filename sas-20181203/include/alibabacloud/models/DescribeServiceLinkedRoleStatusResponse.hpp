...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeServiceLinkedRoleStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeServiceLinkedRoleStatusResponseBody) };
    inline DescribeServiceLinkedRoleStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeServiceLinkedRoleStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeServiceLinkedRoleStatusResponseBody> body_ {};
  };
