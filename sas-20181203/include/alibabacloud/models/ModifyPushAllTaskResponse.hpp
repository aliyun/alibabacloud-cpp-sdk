...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyPushAllTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyPushAllTaskResponseBody) };
    inline ModifyPushAllTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyPushAllTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyPushAllTaskResponseBody> body_ {};
  };
