...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOssScanConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateOssScanConfigResponseBody) };
    inline CreateOssScanConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateOssScanConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateOssScanConfigResponseBody> body_ {};
  };
