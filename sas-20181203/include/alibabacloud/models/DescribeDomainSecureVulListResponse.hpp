...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainSecureVulListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainSecureVulListResponseBody) };
    inline DescribeDomainSecureVulListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDomainSecureVulListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDomainSecureVulListResponseBody> body_ = nullptr;
  };
