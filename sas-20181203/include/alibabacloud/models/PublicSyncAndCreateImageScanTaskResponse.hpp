...
namespace Models
{
  ...
  public:
    ...
    inline const PublicSyncAndCreateImageScanTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PublicSyncAndCreateImageScanTaskResponseBody) };
    inline PublicSyncAndCreateImageScanTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, PublicSyncAndCreateImageScanTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PublicSyncAndCreateImageScanTaskResponseBody> body_ {};
  };
