...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->defenceMode_ == nullptr
        && this->dir_ == nullptr && this->exclusiveDir_ == nullptr && this->exclusiveFile_ == nullptr && this->exclusiveFileType_ == nullptr && this->inclusiveFile_ == nullptr
        && this->inclusiveFileType_ == nullptr && this->lang_ == nullptr && this->localBackupDir_ == nullptr && this->mode_ == nullptr && this->sourceIp_ == nullptr
        && this->uuid_ == nullptr; };
