...
namespace Models
{
  ...
  public:
    ...
    inline const GetConsoleFuncGrayStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetConsoleFuncGrayStatusResponseBodyData) };
    inline GetConsoleFuncGrayStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, GetConsoleFuncGrayStatusResponseBodyData) };
    inline GetConsoleFuncGrayStatusResponseBody& setData(const GetConsoleFuncGrayStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetConsoleFuncGrayStatusResponseBody& setData(GetConsoleFuncGrayStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // Return result.
    std::shared_ptr<GetConsoleFuncGrayStatusResponseBodyData> data_ = nullptr;
