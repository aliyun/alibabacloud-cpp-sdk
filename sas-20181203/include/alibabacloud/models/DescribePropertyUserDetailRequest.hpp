...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->currentPage_ != nullptr
        && this->extend_ != nullptr && this->isRoot_ != nullptr && this->lastLoginTimeEnd_ != nullptr && this->lastLoginTimeStart_ != nullptr && this->pageSize_ != nullptr
        && this->remark_ != nullptr && this->user_ != nullptr && this->uuid_ != nullptr; };
