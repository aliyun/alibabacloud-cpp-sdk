...
namespace Models
{
  ...
  public:
    ...
    inline const AddSasModuleTrialResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AddSasModuleTrialResponseBodyData) };
    inline AddSasModuleTrialResponseBodyData data() { DARABONBA_PTR_GET(data_, AddSasModuleTrialResponseBodyData) };
    inline AddSasModuleTrialResponseBody& setData(const AddSasModuleTrialResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AddSasModuleTrialResponseBody& setData(AddSasModuleTrialResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<AddSasModuleTrialResponseBodyData> data_ = nullptr;
    // The request ID.
