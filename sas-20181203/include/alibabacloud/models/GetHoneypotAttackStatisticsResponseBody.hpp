...
namespace Models
{
  ...
  public:
    ...
    inline const GetHoneypotAttackStatisticsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetHoneypotAttackStatisticsResponseBodyData) };
    inline GetHoneypotAttackStatisticsResponseBodyData data() { DARABONBA_PTR_GET(data_, GetHoneypotAttackStatisticsResponseBodyData) };
    inline GetHoneypotAttackStatisticsResponseBody& setData(const GetHoneypotAttackStatisticsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHoneypotAttackStatisticsResponseBody& setData(GetHoneypotAttackStatisticsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The statistics.
    std::shared_ptr<GetHoneypotAttackStatisticsResponseBodyData> data_ = nullptr;
