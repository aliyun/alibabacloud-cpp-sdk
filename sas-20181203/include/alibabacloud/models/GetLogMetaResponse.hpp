...
namespace Models
{
  ...
  public:
    ...
    inline const GetLogMetaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLogMetaResponseBody) };
    inline GetLogMetaResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLogMetaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLogMetaResponseBody> body_ {};
  };
