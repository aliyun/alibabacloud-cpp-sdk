...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteImageVulWhitelistResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteImageVulWhitelistResponseBody) };
    inline DeleteImageVulWhitelistResponseBody body() { DARABONBA_PTR_GET(body_, DeleteImageVulWhitelistResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteImageVulWhitelistResponseBody> body_ = nullptr;
  };
