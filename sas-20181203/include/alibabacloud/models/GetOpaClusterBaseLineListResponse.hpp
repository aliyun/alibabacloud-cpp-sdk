...
namespace Models
{
  ...
  public:
    ...
    inline const GetOpaClusterBaseLineListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOpaClusterBaseLineListResponseBody) };
    inline GetOpaClusterBaseLineListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOpaClusterBaseLineListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOpaClusterBaseLineListResponseBody> body_ {};
  };
