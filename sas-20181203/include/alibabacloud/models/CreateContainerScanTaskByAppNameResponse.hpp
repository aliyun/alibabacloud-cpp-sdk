...
namespace Models
{
  ...
  public:
    ...
    inline const CreateContainerScanTaskByAppNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateContainerScanTaskByAppNameResponseBody) };
    inline CreateContainerScanTaskByAppNameResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateContainerScanTaskByAppNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateContainerScanTaskByAppNameResponseBody> body_ {};
  };
