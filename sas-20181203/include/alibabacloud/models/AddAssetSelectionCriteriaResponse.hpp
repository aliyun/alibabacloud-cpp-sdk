...
namespace Models
{
  ...
  public:
    ...
    inline const AddAssetSelectionCriteriaResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddAssetSelectionCriteriaResponseBody) };
    inline AddAssetSelectionCriteriaResponseBody body() { DARABONBA_PTR_GET(body_, AddAssetSelectionCriteriaResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddAssetSelectionCriteriaResponseBody> body_ = nullptr;
  };
