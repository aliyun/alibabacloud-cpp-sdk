...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHoneypotAttackerPortraitResponseBodyList> & list() const { DARABONBA_PTR_GET_CONST(list_, vector<ListHoneypotAttackerPortraitResponseBodyList>) };
    inline vector<ListHoneypotAttackerPortraitResponseBodyList> list() { DARABONBA_PTR_GET(list_, vector<ListHoneypotAttackerPortraitResponseBodyList>) };
    inline ListHoneypotAttackerPortraitResponseBody& setList(const vector<ListHoneypotAttackerPortraitResponseBodyList> & list) { DARABONBA_PTR_SET_VALUE(list_, list) };
    inline ListHoneypotAttackerPortraitResponseBody& setList(vector<ListHoneypotAttackerPortraitResponseBodyList> && list) { DARABONBA_PTR_SET_RVALUE(list_, list) };
    ...
    inline const ListHoneypotAttackerPortraitResponseBodyPageInfo & pageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, ListHoneypotAttackerPortraitResponseBodyPageInfo) };
    inline ListHoneypotAttackerPortraitResponseBodyPageInfo pageInfo() { DARABONBA_PTR_GET(pageInfo_, ListHoneypotAttackerPortraitResponseBodyPageInfo) };
    inline ListHoneypotAttackerPortraitResponseBody& setPageInfo(const ListHoneypotAttackerPortraitResponseBodyPageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline ListHoneypotAttackerPortraitResponseBody& setPageInfo(ListHoneypotAttackerPortraitResponseBodyPageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListHoneypotAttackerPortraitResponseBodyList>> list_ = nullptr;
    // The returned message.
    std::shared_ptr<string> message_ = nullptr;
    // The pagination information.
    std::shared_ptr<ListHoneypotAttackerPortraitResponseBodyPageInfo> pageInfo_ = nullptr;
    // The request ID.
