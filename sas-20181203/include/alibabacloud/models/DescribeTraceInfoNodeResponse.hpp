...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTraceInfoNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTraceInfoNodeResponseBody) };
    inline DescribeTraceInfoNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTraceInfoNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTraceInfoNodeResponseBody> body_ {};
  };
