...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteHoneypotPresetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteHoneypotPresetResponseBody) };
    inline DeleteHoneypotPresetResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteHoneypotPresetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteHoneypotPresetResponseBody> body_ {};
  };
