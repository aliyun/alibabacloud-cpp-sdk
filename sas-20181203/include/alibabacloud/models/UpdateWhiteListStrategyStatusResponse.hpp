...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateWhiteListStrategyStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateWhiteListStrategyStatusResponseBody) };
    inline UpdateWhiteListStrategyStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateWhiteListStrategyStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateWhiteListStrategyStatusResponseBody> body_ {};
  };
