...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeContainerInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeContainerInstancesResponseBody) };
    inline DescribeContainerInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeContainerInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeContainerInstancesResponseBody> body_ {};
  };
