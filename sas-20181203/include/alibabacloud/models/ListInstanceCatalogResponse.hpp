...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceCatalogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstanceCatalogResponseBody) };
    inline ListInstanceCatalogResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInstanceCatalogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInstanceCatalogResponseBody> body_ {};
  };
