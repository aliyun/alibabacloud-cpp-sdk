...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->baselineClassKey_ == nullptr
        && return this->baselineNameKey_ == nullptr && return this->currentPage_ == nullptr && return this->imageUuid_ == nullptr && return this->lang_ == nullptr && return this->pageSize_ == nullptr
        && return this->scanRange_ == nullptr && return this->status_ == nullptr && return this->uuids_ == nullptr; };
