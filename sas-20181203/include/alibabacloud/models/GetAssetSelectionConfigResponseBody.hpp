...
namespace Models
{
  ...
  public:
    ...
    inline const GetAssetSelectionConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAssetSelectionConfigResponseBodyData) };
    inline GetAssetSelectionConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAssetSelectionConfigResponseBodyData) };
    inline GetAssetSelectionConfigResponseBody& setData(const GetAssetSelectionConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAssetSelectionConfigResponseBody& setData(GetAssetSelectionConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<GetAssetSelectionConfigResponseBodyData> data_ = nullptr;
    // The request ID.
