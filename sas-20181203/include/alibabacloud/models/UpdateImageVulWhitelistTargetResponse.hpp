...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateImageVulWhitelistTargetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateImageVulWhitelistTargetResponseBody) };
    inline UpdateImageVulWhitelistTargetResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateImageVulWhitelistTargetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateImageVulWhitelistTargetResponseBody> body_ {};
  };
