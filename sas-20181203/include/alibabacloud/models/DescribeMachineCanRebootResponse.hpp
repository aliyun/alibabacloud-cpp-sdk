...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMachineCanRebootResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMachineCanRebootResponseBody) };
    inline DescribeMachineCanRebootResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMachineCanRebootResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMachineCanRebootResponseBody> body_ {};
  };
