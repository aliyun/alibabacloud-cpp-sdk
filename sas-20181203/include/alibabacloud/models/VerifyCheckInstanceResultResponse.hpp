...
namespace Models
{
  ...
  public:
    ...
    inline const VerifyCheckInstanceResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, VerifyCheckInstanceResultResponseBody) };
    inline VerifyCheckInstanceResultResponseBody getBody() { DARABONBA_PTR_GET(body_, VerifyCheckInstanceResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<VerifyCheckInstanceResultResponseBody> body_ {};
  };
