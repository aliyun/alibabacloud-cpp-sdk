...
namespace Models
{
  ...
  public:
    ...
    inline const ListAccountsInResourceDirectoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAccountsInResourceDirectoryResponseBody) };
    inline ListAccountsInResourceDirectoryResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAccountsInResourceDirectoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAccountsInResourceDirectoryResponseBody> body_ {};
  };
