...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateHoneypotNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateHoneypotNodeResponseBody) };
    inline UpdateHoneypotNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateHoneypotNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateHoneypotNodeResponseBody> body_ {};
  };
