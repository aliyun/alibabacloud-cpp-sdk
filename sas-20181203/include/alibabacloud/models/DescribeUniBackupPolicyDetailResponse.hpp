...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUniBackupPolicyDetailResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeUniBackupPolicyDetailResponseBody) };
    inline DescribeUniBackupPolicyDetailResponseBody body() { DARABONBA_PTR_GET(body_, DescribeUniBackupPolicyDetailResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeUniBackupPolicyDetailResponseBody> body_ = nullptr;
  };
