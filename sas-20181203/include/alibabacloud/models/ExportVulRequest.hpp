...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getCreateTsEnd() const { DARABONBA_PTR_GET_DEFAULT(createTsEnd_, 0L) };
    ...
    inline int64_t getCreateTsStart() const { DARABONBA_PTR_GET_DEFAULT(createTsStart_, 0L) };
