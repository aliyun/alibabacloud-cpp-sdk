...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAgentlessScanTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAgentlessScanTaskResponseBody) };
    inline CreateAgentlessScanTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAgentlessScanTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAgentlessScanTaskResponseBody> body_ {};
  };
