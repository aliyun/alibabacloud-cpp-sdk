...
namespace Models
{
  ...
  public:
    ...
    inline const GetOpaClusterNamespaceListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOpaClusterNamespaceListResponseBody) };
    inline GetOpaClusterNamespaceListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOpaClusterNamespaceListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOpaClusterNamespaceListResponseBody> body_ {};
  };
