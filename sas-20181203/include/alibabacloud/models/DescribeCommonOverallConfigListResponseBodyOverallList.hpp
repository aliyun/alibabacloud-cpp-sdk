...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECOMMONOVERALLCONFIGLISTRESPONSEBODYOVERALLLIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECOMMONOVERALLCONFIGLISTRESPONSEBODYOVERALLLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeCommonOverallConfigListResponseBodyOverallList& obj) { 
      DARABONBA_PTR_TO_JSON(AuthVersionList, authVersionList_);
      DARABONBA_PTR_TO_JSON(Config, config_);
      DARABONBA_PTR_TO_JSON(TotalCount, totalCount_);
      DARABONBA_PTR_TO_JSON(Type, type_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeCommonOverallConfigListResponseBodyOverallList& obj) { 
      DARABONBA_PTR_FROM_JSON(AuthVersionList, authVersionList_);
      DARABONBA_PTR_FROM_JSON(Config, config_);
      DARABONBA_PTR_FROM_JSON(TotalCount, totalCount_);
      DARABONBA_PTR_FROM_JSON(Type, type_);
    };
    DescribeCommonOverallConfigListResponseBodyOverallList() = default ;
    DescribeCommonOverallConfigListResponseBodyOverallList(const DescribeCommonOverallConfigListResponseBodyOverallList &) = default ;
    DescribeCommonOverallConfigListResponseBodyOverallList(DescribeCommonOverallConfigListResponseBodyOverallList &&) = default ;
    DescribeCommonOverallConfigListResponseBodyOverallList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeCommonOverallConfigListResponseBodyOverallList() = default ;
    DescribeCommonOverallConfigListResponseBodyOverallList& operator=(const DescribeCommonOverallConfigListResponseBodyOverallList &) = default ;
    DescribeCommonOverallConfigListResponseBodyOverallList& operator=(DescribeCommonOverallConfigListResponseBodyOverallList &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->authVersionList_ == nullptr
        && return this->config_ == nullptr && return this->totalCount_ == nullptr && return this->type_ == nullptr; };
    ...
    inline const vector<string> & authVersionList() const { DARABONBA_PTR_GET_CONST(authVersionList_, vector<string>) };
    inline vector<string> authVersionList() { DARABONBA_PTR_GET(authVersionList_, vector<string>) };
    inline DescribeCommonOverallConfigListResponseBodyOverallList& setAuthVersionList(const vector<string> & authVersionList) { DARABONBA_PTR_SET_VALUE(authVersionList_, authVersionList) };
    inline DescribeCommonOverallConfigListResponseBodyOverallList& setAuthVersionList(vector<string> && authVersionList) { DARABONBA_PTR_SET_RVALUE(authVersionList_, authVersionList) };
    ...
    inline DescribeCommonOverallConfigListResponseBodyOverallList& setConfig(string config) { DARABONBA_PTR_SET_VALUE(config_, config) };
    ...
    inline DescribeCommonOverallConfigListResponseBodyOverallList& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
    ...
    inline DescribeCommonOverallConfigListResponseBodyOverallList& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };


  protected:
    // The editions of Security Center.
    std::shared_ptr<vector<string>> authVersionList_ = nullptr;
