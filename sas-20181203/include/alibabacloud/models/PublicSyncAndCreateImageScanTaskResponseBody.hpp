...
namespace Models
{
  ...
  public:
    ...
    inline const PublicSyncAndCreateImageScanTaskResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, PublicSyncAndCreateImageScanTaskResponseBody::Data) };
    inline PublicSyncAndCreateImageScanTaskResponseBody::Data getData() { DARABONBA_PTR_GET(data_, PublicSyncAndCreateImageScanTaskResponseBody::Data) };
    inline PublicSyncAndCreateImageScanTaskResponseBody& setData(const PublicSyncAndCreateImageScanTaskResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline PublicSyncAndCreateImageScanTaskResponseBody& setData(PublicSyncAndCreateImageScanTaskResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<PublicSyncAndCreateImageScanTaskResponseBody::Data> data_ {};
