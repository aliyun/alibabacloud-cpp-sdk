...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->groupIdList_ == nullptr
        && this->resourceDirectoryAccountId_ == nullptr && this->sourceIp_ == nullptr && this->typeList_ == nullptr; };
    ...
    inline string getTypeList() const { DARABONBA_PTR_GET_DEFAULT(typeList_, "") };
