...
namespace Models
{
  ...
  public:
    ...
    inline string getInstanceIdKey() const { DARABONBA_PTR_GET_DEFAULT(instanceIdKey_, "") };
    ...
    inline string getInstanceNameKey() const { DARABONBA_PTR_GET_DEFAULT(instanceNameKey_, "") };
    ...
    inline string getRegionIdKey() const { DARABONBA_PTR_GET_DEFAULT(regionIdKey_, "") };
