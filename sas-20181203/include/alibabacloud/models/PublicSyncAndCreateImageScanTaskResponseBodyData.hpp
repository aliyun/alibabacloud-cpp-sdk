...
#ifndef ALIBABACLOUD_MODELS_PUBLICSYNCANDCREATEIMAGESCANTASKRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_PUBLICSYNCANDCREATEIMAGESCANTASKRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PublicSyncAndCreateImageScanTaskResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PublicSyncAndCreateImageScanTaskResponseBodyData& obj) { 
    ...
    PublicSyncAndCreateImageScanTaskResponseBodyData() = default ;
    PublicSyncAndCreateImageScanTaskResponseBodyData(const PublicSyncAndCreateImageScanTaskResponseBodyData &) = default ;
    PublicSyncAndCreateImageScanTaskResponseBodyData(PublicSyncAndCreateImageScanTaskResponseBodyData &&) = default ;
    PublicSyncAndCreateImageScanTaskResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PublicSyncAndCreateImageScanTaskResponseBodyData() = default ;
    PublicSyncAndCreateImageScanTaskResponseBodyData& operator=(const PublicSyncAndCreateImageScanTaskResponseBodyData &) = default ;
    PublicSyncAndCreateImageScanTaskResponseBodyData& operator=(PublicSyncAndCreateImageScanTaskResponseBodyData &&) = default ;
    ...
    inline PublicSyncAndCreateImageScanTaskResponseBodyData& setCanCreate(bool canCreate) { DARABONBA_PTR_SET_VALUE(canCreate_, canCreate) };
    ...
    inline PublicSyncAndCreateImageScanTaskResponseBodyData& setCollectTime(int64_t collectTime) { DARABONBA_PTR_SET_VALUE(collectTime_, collectTime) };
    ...
    inline PublicSyncAndCreateImageScanTaskResponseBodyData& setExecTime(int64_t execTime) { DARABONBA_PTR_SET_VALUE(execTime_, execTime) };
    ...
    inline PublicSyncAndCreateImageScanTaskResponseBodyData& setFinishCount(int32_t finishCount) { DARABONBA_PTR_SET_VALUE(finishCount_, finishCount) };
    ...
    inline PublicSyncAndCreateImageScanTaskResponseBodyData& setProgress(int32_t progress) { DARABONBA_PTR_SET_VALUE(progress_, progress) };
    ...
    inline PublicSyncAndCreateImageScanTaskResponseBodyData& setResult(string result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    ...
    inline PublicSyncAndCreateImageScanTaskResponseBodyData& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline PublicSyncAndCreateImageScanTaskResponseBodyData& setTaskId(string taskId) { DARABONBA_PTR_SET_VALUE(taskId_, taskId) };
    ...
    inline PublicSyncAndCreateImageScanTaskResponseBodyData& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
