...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClusterImageSecuritySummaryResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeClusterImageSecuritySummaryResponseBody) };
    inline DescribeClusterImageSecuritySummaryResponseBody body() { DARABONBA_PTR_GET(body_, DescribeClusterImageSecuritySummaryResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeClusterImageSecuritySummaryResponseBody> body_ = nullptr;
  };
