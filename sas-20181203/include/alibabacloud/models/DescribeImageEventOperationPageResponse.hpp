...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageEventOperationPageResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeImageEventOperationPageResponseBody) };
    inline DescribeImageEventOperationPageResponseBody body() { DARABONBA_PTR_GET(body_, DescribeImageEventOperationPageResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeImageEventOperationPageResponseBody> body_ = nullptr;
  };
