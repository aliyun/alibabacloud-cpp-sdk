...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aispmRiskAssetCnt_ == nullptr
        && return this->ecsAssetCnt_ == nullptr && return this->exposedRiskAssetCnt_ == nullptr && return this->imageAssetCnt_ == nullptr && return this->lingjunAssetCnt_ == nullptr && return this->paiContainerCnt_ == nullptr
        && return this->paiInstanceCnt_ == nullptr && return this->paiServerlessAssetCnt_ == nullptr && return this->sensitiveSummary_ == nullptr && return this->snapshotAssetCnt_ == nullptr && return this->totalAssetCnt_ == nullptr
        && return this->totalRiskCnt_ == nullptr && return this->vulRiskAssetCnt_ == nullptr; };
