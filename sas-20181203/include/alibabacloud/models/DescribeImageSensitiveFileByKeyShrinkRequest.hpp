...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEIMAGESENSITIVEFILEBYKEYSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEIMAGESENSITIVEFILEBYKEYSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeImageSensitiveFileByKeyShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeImageSensitiveFileByKeyShrinkRequest& obj) { 
    ...
    DescribeImageSensitiveFileByKeyShrinkRequest() = default ;
    DescribeImageSensitiveFileByKeyShrinkRequest(const DescribeImageSensitiveFileByKeyShrinkRequest &) = default ;
    DescribeImageSensitiveFileByKeyShrinkRequest(DescribeImageSensitiveFileByKeyShrinkRequest &&) = default ;
    DescribeImageSensitiveFileByKeyShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeImageSensitiveFileByKeyShrinkRequest() = default ;
    DescribeImageSensitiveFileByKeyShrinkRequest& operator=(const DescribeImageSensitiveFileByKeyShrinkRequest &) = default ;
    DescribeImageSensitiveFileByKeyShrinkRequest& operator=(DescribeImageSensitiveFileByKeyShrinkRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->currentPage_ == nullptr
        && return this->imageUuid_ == nullptr && return this->lang_ == nullptr && return this->pageSize_ == nullptr && return this->scanRangeShrink_ == nullptr && return this->sensitiveFileKey_ == nullptr; };
    // currentPage Field Functions 
    bool hasCurrentPage() const { return this->currentPage_ != nullptr;};
    void deleteCurrentPage() { this->currentPage_ = nullptr;};
    inline int32_t currentPage() const { DARABONBA_PTR_GET_DEFAULT(currentPage_, 0) };
    inline DescribeImageSensitiveFileByKeyShrinkRequest& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline DescribeImageSensitiveFileByKeyShrinkRequest& setImageUuid(string imageUuid) { DARABONBA_PTR_SET_VALUE(imageUuid_, imageUuid) };
    ...
    inline DescribeImageSensitiveFileByKeyShrinkRequest& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline DescribeImageSensitiveFileByKeyShrinkRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline DescribeImageSensitiveFileByKeyShrinkRequest& setScanRangeShrink(string scanRangeShrink) { DARABONBA_PTR_SET_VALUE(scanRangeShrink_, scanRangeShrink) };
    ...
    inline DescribeImageSensitiveFileByKeyShrinkRequest& setSensitiveFileKey(string sensitiveFileKey) { DARABONBA_PTR_SET_VALUE(sensitiveFileKey_, sensitiveFileKey) };
