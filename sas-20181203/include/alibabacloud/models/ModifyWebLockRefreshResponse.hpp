...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyWebLockRefreshResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyWebLockRefreshResponseBody) };
    inline ModifyWebLockRefreshResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyWebLockRefreshResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyWebLockRefreshResponseBody> body_ {};
  };
