...
namespace Models
{
  ...
  public:
    ...
    inline const OperationSuspEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OperationSuspEventsResponseBody) };
    inline OperationSuspEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, OperationSuspEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OperationSuspEventsResponseBody> body_ {};
  };
