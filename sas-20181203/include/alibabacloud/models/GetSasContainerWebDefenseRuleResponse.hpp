...
namespace Models
{
  ...
  public:
    ...
    inline const GetSasContainerWebDefenseRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSasContainerWebDefenseRuleResponseBody) };
    inline GetSasContainerWebDefenseRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSasContainerWebDefenseRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSasContainerWebDefenseRuleResponseBody> body_ {};
  };
