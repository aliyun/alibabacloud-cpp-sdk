...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageListByBuildRiskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeImageListByBuildRiskResponseBodyData) };
    inline DescribeImageListByBuildRiskResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeImageListByBuildRiskResponseBodyData) };
    inline DescribeImageListByBuildRiskResponseBody& setData(const DescribeImageListByBuildRiskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeImageListByBuildRiskResponseBody& setData(DescribeImageListByBuildRiskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<DescribeImageListByBuildRiskResponseBodyData> data_ = nullptr;
