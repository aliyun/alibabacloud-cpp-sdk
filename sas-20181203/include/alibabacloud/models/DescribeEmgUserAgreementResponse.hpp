...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEmgUserAgreementResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEmgUserAgreementResponseBody) };
    inline DescribeEmgUserAgreementResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEmgUserAgreementResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEmgUserAgreementResponseBody> body_ {};
  };
