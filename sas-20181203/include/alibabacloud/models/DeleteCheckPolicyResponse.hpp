...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCheckPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCheckPolicyResponseBody) };
    inline DeleteCheckPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCheckPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCheckPolicyResponseBody> body_ {};
  };
