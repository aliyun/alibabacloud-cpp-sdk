...
namespace Models
{
  ...
  public:
    ...
    inline const GetTenantCheckAvailableResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTenantCheckAvailableResponseBodyData) };
    inline GetTenantCheckAvailableResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTenantCheckAvailableResponseBodyData) };
    inline GetTenantCheckAvailableResponseBody& setData(const GetTenantCheckAvailableResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTenantCheckAvailableResponseBody& setData(GetTenantCheckAvailableResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetTenantCheckAvailableResponseBodyData> data_ = nullptr;
    // The request ID.
