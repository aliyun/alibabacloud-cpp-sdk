...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWebLockExclusiveFileTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeWebLockExclusiveFileTypeResponseBody) };
    inline DescribeWebLockExclusiveFileTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeWebLockExclusiveFileTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeWebLockExclusiveFileTypeResponseBody> body_ {};
  };
