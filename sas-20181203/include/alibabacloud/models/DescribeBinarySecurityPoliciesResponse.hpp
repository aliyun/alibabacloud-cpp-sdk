...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBinarySecurityPoliciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBinarySecurityPoliciesResponseBody) };
    inline DescribeBinarySecurityPoliciesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBinarySecurityPoliciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBinarySecurityPoliciesResponseBody> body_ {};
  };
