...
namespace Models
{
  ...
  public:
    ...
    inline const ListAssetSelectionTargetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAssetSelectionTargetResponseBody) };
    inline ListAssetSelectionTargetResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAssetSelectionTargetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAssetSelectionTargetResponseBody> body_ {};
  };
