...
namespace Models
{
  ...
  public:
    ...
    inline const BindHybridProxyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BindHybridProxyResponseBody) };
    inline BindHybridProxyResponseBody getBody() { DARABONBA_PTR_GET(body_, BindHybridProxyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BindHybridProxyResponseBody> body_ {};
  };
