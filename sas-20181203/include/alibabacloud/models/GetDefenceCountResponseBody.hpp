...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->defenceCount15Days_ == nullptr
    ...
    inline int32_t getDefenceCount15Days() const { DARABONBA_PTR_GET_DEFAULT(defenceCount15Days_, 0) };
    ...
    inline int32_t getDefenceCountTotal() const { DARABONBA_PTR_GET_DEFAULT(defenceCountTotal_, 0) };
    ...
    inline int32_t getSuspiciousDealtCount() const { DARABONBA_PTR_GET_DEFAULT(suspiciousDealtCount_, 0) };
    ...
    inline int32_t getTamperProof15Days() const { DARABONBA_PTR_GET_DEFAULT(tamperProof15Days_, 0) };
    ...
    inline int32_t getTamperProofTotal() const { DARABONBA_PTR_GET_DEFAULT(tamperProofTotal_, 0) };
