...
namespace Models
{
  ...
  public:
    ...
    inline const GetMaliciousFileWhitelistConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMaliciousFileWhitelistConfigResponseBodyData) };
    inline GetMaliciousFileWhitelistConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMaliciousFileWhitelistConfigResponseBodyData) };
    inline GetMaliciousFileWhitelistConfigResponseBody& setData(const GetMaliciousFileWhitelistConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMaliciousFileWhitelistConfigResponseBody& setData(GetMaliciousFileWhitelistConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetMaliciousFileWhitelistConfigResponseBodyData> data_ = nullptr;
