...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAttackPathWhitelistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAttackPathWhitelistResponseBody) };
    inline DeleteAttackPathWhitelistResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAttackPathWhitelistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAttackPathWhitelistResponseBody> body_ {};
  };
