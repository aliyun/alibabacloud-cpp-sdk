...
namespace Models
{
  ...
  public:
    ...
    inline const GetAlarmMachineCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAlarmMachineCountResponseBody) };
    inline GetAlarmMachineCountResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAlarmMachineCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAlarmMachineCountResponseBody> body_ {};
  };
