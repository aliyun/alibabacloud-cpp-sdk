...
namespace Models
{
  ...
  public:
    ...
    inline DescribeDomainSecureScoreRequest& setResourceDirectoryAccountId(int64_t resourceDirectoryAccountId) { DARABONBA_PTR_SET_VALUE(resourceDirectoryAccountId_, resourceDirectoryAccountId) };
