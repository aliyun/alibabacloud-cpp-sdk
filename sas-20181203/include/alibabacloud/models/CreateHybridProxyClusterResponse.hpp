...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHybridProxyClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateHybridProxyClusterResponseBody) };
    inline CreateHybridProxyClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateHybridProxyClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateHybridProxyClusterResponseBody> body_ {};
  };
