...
namespace Models
{
  ...
  public:
    ...
    inline const SetSensitiveDefineRuleConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SetSensitiveDefineRuleConfigResponseBodyData) };
    inline SetSensitiveDefineRuleConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, SetSensitiveDefineRuleConfigResponseBodyData) };
    inline SetSensitiveDefineRuleConfigResponseBody& setData(const SetSensitiveDefineRuleConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SetSensitiveDefineRuleConfigResponseBody& setData(SetSensitiveDefineRuleConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<SetSensitiveDefineRuleConfigResponseBodyData> data_ = nullptr;
