...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->installVersion_ == nullptr
    ...
    inline string getInstallVersion() const { DARABONBA_PTR_GET_DEFAULT(installVersion_, "") };
  ...
  protected:
    ...
    shared_ptr<string> installVersion_ {};
    // The request ID.
