...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->authIds_ == nullptr
        && return this->currentPage_ == nullptr && return this->lang_ == nullptr && return this->pageSize_ == nullptr && return this->status_ == nullptr && return this->subAccountName_ == nullptr
        && return this->vendorAuthAlias_ == nullptr; };
