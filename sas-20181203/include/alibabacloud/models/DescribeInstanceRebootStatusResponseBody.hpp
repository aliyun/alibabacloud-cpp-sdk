...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->rebootStatuses_ != nullptr
    ...
    inline const vector<DescribeInstanceRebootStatusResponseBodyRebootStatuses> & rebootStatuses() const { DARABONBA_PTR_GET_CONST(rebootStatuses_, vector<DescribeInstanceRebootStatusResponseBodyRebootStatuses>) };
    inline vector<DescribeInstanceRebootStatusResponseBodyRebootStatuses> rebootStatuses() { DARABONBA_PTR_GET(rebootStatuses_, vector<DescribeInstanceRebootStatusResponseBodyRebootStatuses>) };
    inline DescribeInstanceRebootStatusResponseBody& setRebootStatuses(const vector<DescribeInstanceRebootStatusResponseBodyRebootStatuses> & rebootStatuses) { DARABONBA_PTR_SET_VALUE(rebootStatuses_, rebootStatuses) };
    inline DescribeInstanceRebootStatusResponseBody& setRebootStatuses(vector<DescribeInstanceRebootStatusResponseBodyRebootStatuses> && rebootStatuses) { DARABONBA_PTR_SET_RVALUE(rebootStatuses_, rebootStatuses) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeInstanceRebootStatusResponseBodyRebootStatuses>> rebootStatuses_ = nullptr;
