...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteK8sAccessInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteK8sAccessInfoResponseBody) };
    inline DeleteK8sAccessInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteK8sAccessInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteK8sAccessInfoResponseBody> body_ {};
  };
