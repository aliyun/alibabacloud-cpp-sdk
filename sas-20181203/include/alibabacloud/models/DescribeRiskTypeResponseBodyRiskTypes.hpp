...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alias_ == nullptr
        && return this->authFlag_ == nullptr && return this->subTypes_ == nullptr && return this->typeName_ == nullptr; };
    ...
    inline DescribeRiskTypeResponseBodyRiskTypes& setTypeName(string typeName) { DARABONBA_PTR_SET_VALUE(typeName_, typeName) };
