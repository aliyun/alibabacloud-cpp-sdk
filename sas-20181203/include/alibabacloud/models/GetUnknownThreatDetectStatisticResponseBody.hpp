  ...
  public:
    ...
    public:
      friend void to_json(Darabonba::Json& j, const Data& obj) { 
        DARABONBA_PTR_TO_JSON(BlockEventMachineCount, blockEventMachineCount_);
      ...
      friend void from_json(const Darabonba::Json& j, Data& obj) { 
        DARABONBA_PTR_FROM_JSON(BlockEventMachineCount, blockEventMachineCount_);
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      virtual bool empty() const override { return this->blockEventMachineCount_ == nullptr
        && this->blockMachineCount_ == nullptr && this->machineCount_ == nullptr && this->monitorMachineCount_ == nullptr && this->openMachineCount_ == nullptr && this->studyingMachineCount_ == nullptr; };
      // blockEventMachineCount Field Functions 
      bool hasBlockEventMachineCount() const { return this->blockEventMachineCount_ != nullptr;};
      void deleteBlockEventMachineCount() { this->blockEventMachineCount_ = nullptr;};
      inline int32_t getBlockEventMachineCount() const { DARABONBA_PTR_GET_DEFAULT(blockEventMachineCount_, 0) };
      inline Data& setBlockEventMachineCount(int32_t blockEventMachineCount) { DARABONBA_PTR_SET_VALUE(blockEventMachineCount_, blockEventMachineCount) };
