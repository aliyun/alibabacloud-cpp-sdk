...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAttackPathSensitiveAssetConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAttackPathSensitiveAssetConfigResponseBody) };
    inline DeleteAttackPathSensitiveAssetConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAttackPathSensitiveAssetConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAttackPathSensitiveAssetConfigResponseBody> body_ {};
  };
