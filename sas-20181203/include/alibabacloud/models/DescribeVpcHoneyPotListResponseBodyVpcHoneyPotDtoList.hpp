...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cidrBlock_ == nullptr
        && return this->createTime_ == nullptr && return this->honeyPotEcsInstanceStatus_ == nullptr && return this->honeyPotEniInstanceId_ == nullptr && return this->honeyPotExistence_ == nullptr && return this->honeyPotInstanceStatus_ == nullptr
        && return this->honeyPotVpcSwitchId_ == nullptr && return this->vpcId_ == nullptr && return this->vpcName_ == nullptr && return this->vpcRegionId_ == nullptr && return this->vpcStatus_ == nullptr
        && return this->vpcSwitchIdList_ == nullptr; };
