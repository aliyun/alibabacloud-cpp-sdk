...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->assistInfoShrink_ == nullptr
        && return this->checkId_ == nullptr && return this->checkRule_ == nullptr && return this->checkShowName_ == nullptr && return this->descriptionShrink_ == nullptr && return this->instanceSubType_ == nullptr
        && return this->instanceType_ == nullptr && return this->remark_ == nullptr && return this->riskLevel_ == nullptr && return this->sectionIds_ == nullptr && return this->solutionShrink_ == nullptr
