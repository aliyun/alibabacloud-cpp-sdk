...
#ifndef ALIBABACLOUD_MODELS_SETIMAGESENSITIVEFILESTATUSSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SETIMAGESENSITIVEFILESTATUSSHRINKREQUEST_HPP_
...
namespace Models
{
  class SetImageSensitiveFileStatusShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const SetImageSensitiveFileStatusShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SetImageSensitiveFileStatusShrinkRequest& obj) { 
    ...
    SetImageSensitiveFileStatusShrinkRequest() = default ;
    SetImageSensitiveFileStatusShrinkRequest(const SetImageSensitiveFileStatusShrinkRequest &) = default ;
    SetImageSensitiveFileStatusShrinkRequest(SetImageSensitiveFileStatusShrinkRequest &&) = default ;
    SetImageSensitiveFileStatusShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SetImageSensitiveFileStatusShrinkRequest() = default ;
    SetImageSensitiveFileStatusShrinkRequest& operator=(const SetImageSensitiveFileStatusShrinkRequest &) = default ;
    SetImageSensitiveFileStatusShrinkRequest& operator=(SetImageSensitiveFileStatusShrinkRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->idList_ == nullptr
        && return this->imageUuids_ == nullptr && return this->scanRangeShrink_ == nullptr && return this->sensitiveFileKey_ == nullptr && return this->status_ == nullptr; };
    ...
    inline SetImageSensitiveFileStatusShrinkRequest& setIdList(const vector<int64_t> & idList) { DARABONBA_PTR_SET_VALUE(idList_, idList) };
    inline SetImageSensitiveFileStatusShrinkRequest& setIdList(vector<int64_t> && idList) { DARABONBA_PTR_SET_RVALUE(idList_, idList) };
    ...
    inline SetImageSensitiveFileStatusShrinkRequest& setImageUuids(string imageUuids) { DARABONBA_PTR_SET_VALUE(imageUuids_, imageUuids) };
    ...
    inline SetImageSensitiveFileStatusShrinkRequest& setScanRangeShrink(string scanRangeShrink) { DARABONBA_PTR_SET_VALUE(scanRangeShrink_, scanRangeShrink) };
    ...
    inline SetImageSensitiveFileStatusShrinkRequest& setSensitiveFileKey(string sensitiveFileKey) { DARABONBA_PTR_SET_VALUE(sensitiveFileKey_, sensitiveFileKey) };
    ...
    inline SetImageSensitiveFileStatusShrinkRequest& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
