...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWebLockFileChangeStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeWebLockFileChangeStatisticsResponseBody) };
    inline DescribeWebLockFileChangeStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeWebLockFileChangeStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeWebLockFileChangeStatisticsResponseBody> body_ {};
  };
