...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCloudVendorAccountAKResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ModifyCloudVendorAccountAKResponseBody::Data) };
    inline ModifyCloudVendorAccountAKResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ModifyCloudVendorAccountAKResponseBody::Data) };
    inline ModifyCloudVendorAccountAKResponseBody& setData(const ModifyCloudVendorAccountAKResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyCloudVendorAccountAKResponseBody& setData(ModifyCloudVendorAccountAKResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
