...
#ifndef ALIBABACLOUD_MODELS_LISTOSSSCANCONFIGRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_LISTOSSSCANCONFIGRESPONSEBODYDATA_HPP_
...
namespace Models
{
  class ListOssScanConfigResponseBodyData : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListOssScanConfigResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListOssScanConfigResponseBodyData& obj) { 
    ...
    ListOssScanConfigResponseBodyData() = default ;
    ListOssScanConfigResponseBodyData(const ListOssScanConfigResponseBodyData &) = default ;
    ListOssScanConfigResponseBodyData(ListOssScanConfigResponseBodyData &&) = default ;
    ListOssScanConfigResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListOssScanConfigResponseBodyData() = default ;
    ListOssScanConfigResponseBodyData& operator=(const ListOssScanConfigResponseBodyData &) = default ;
    ListOssScanConfigResponseBodyData& operator=(ListOssScanConfigResponseBodyData &&) = default ;
    ...
    inline ListOssScanConfigResponseBodyData& setAllKeyPrefix(bool allKeyPrefix) { DARABONBA_PTR_SET_VALUE(allKeyPrefix_, allKeyPrefix) };
    ...
    inline ListOssScanConfigResponseBodyData& setBucketCount(int32_t bucketCount) { DARABONBA_PTR_SET_VALUE(bucketCount_, bucketCount) };
    ...
    inline ListOssScanConfigResponseBodyData& setBucketNameList(const vector<string> & bucketNameList) { DARABONBA_PTR_SET_VALUE(bucketNameList_, bucketNameList) };
    inline ListOssScanConfigResponseBodyData& setBucketNameList(vector<string> && bucketNameList) { DARABONBA_PTR_SET_RVALUE(bucketNameList_, bucketNameList) };
    ...
    inline ListOssScanConfigResponseBodyData& setDecompressMaxFileCount(int32_t decompressMaxFileCount) { DARABONBA_PTR_SET_VALUE(decompressMaxFileCount_, decompressMaxFileCount) };
    ...
    inline ListOssScanConfigResponseBodyData& setDecompressMaxLayer(int32_t decompressMaxLayer) { DARABONBA_PTR_SET_VALUE(decompressMaxLayer_, decompressMaxLayer) };
    ...
    inline ListOssScanConfigResponseBodyData& setDecryptionList(const vector<string> & decryptionList) { DARABONBA_PTR_SET_VALUE(decryptionList_, decryptionList) };
    inline ListOssScanConfigResponseBodyData& setDecryptionList(vector<string> && decryptionList) { DARABONBA_PTR_SET_RVALUE(decryptionList_, decryptionList) };
    ...
    inline ListOssScanConfigResponseBodyData& setEnable(int32_t enable) { DARABONBA_PTR_SET_VALUE(enable_, enable) };
    ...
    inline ListOssScanConfigResponseBodyData& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline ListOssScanConfigResponseBodyData& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListOssScanConfigResponseBodyData& setKeyPrefixList(const vector<string> & keyPrefixList) { DARABONBA_PTR_SET_VALUE(keyPrefixList_, keyPrefixList) };
    inline ListOssScanConfigResponseBodyData& setKeyPrefixList(vector<string> && keyPrefixList) { DARABONBA_PTR_SET_RVALUE(keyPrefixList_, keyPrefixList) };
    ...
    inline ListOssScanConfigResponseBodyData& setKeySuffixList(const vector<string> & keySuffixList) { DARABONBA_PTR_SET_VALUE(keySuffixList_, keySuffixList) };
    inline ListOssScanConfigResponseBodyData& setKeySuffixList(vector<string> && keySuffixList) { DARABONBA_PTR_SET_RVALUE(keySuffixList_, keySuffixList) };
    ...
    inline ListOssScanConfigResponseBodyData& setLastModifiedStartTime(int64_t lastModifiedStartTime) { DARABONBA_PTR_SET_VALUE(lastModifiedStartTime_, lastModifiedStartTime) };
    ...
    inline ListOssScanConfigResponseBodyData& setLastUpdateTime(int64_t lastUpdateTime) { DARABONBA_PTR_SET_VALUE(lastUpdateTime_, lastUpdateTime) };
    ...
    inline ListOssScanConfigResponseBodyData& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListOssScanConfigResponseBodyData& setRealTimeIncr(bool realTimeIncr) { DARABONBA_PTR_SET_VALUE(realTimeIncr_, realTimeIncr) };
    ...
    inline ListOssScanConfigResponseBodyData& setScanDayList(const vector<int32_t> & scanDayList) { DARABONBA_PTR_SET_VALUE(scanDayList_, scanDayList) };
    inline ListOssScanConfigResponseBodyData& setScanDayList(vector<int32_t> && scanDayList) { DARABONBA_PTR_SET_RVALUE(scanDayList_, scanDayList) };
    ...
    inline ListOssScanConfigResponseBodyData& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
