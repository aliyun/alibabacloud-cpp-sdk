...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeContainerServiceK8sClustersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeContainerServiceK8sClustersResponseBody) };
    inline DescribeContainerServiceK8sClustersResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeContainerServiceK8sClustersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeContainerServiceK8sClustersResponseBody> body_ {};
  };
