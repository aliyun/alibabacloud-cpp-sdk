...
namespace Models
{
  ...
  public:
    ...
    inline const GetHoneypotNodeResponseBodyHoneypotNode & honeypotNode() const { DARABONBA_PTR_GET_CONST(honeypotNode_, GetHoneypotNodeResponseBodyHoneypotNode) };
    inline GetHoneypotNodeResponseBodyHoneypotNode honeypotNode() { DARABONBA_PTR_GET(honeypotNode_, GetHoneypotNodeResponseBodyHoneypotNode) };
    inline GetHoneypotNodeResponseBody& setHoneypotNode(const GetHoneypotNodeResponseBodyHoneypotNode & honeypotNode) { DARABONBA_PTR_SET_VALUE(honeypotNode_, honeypotNode) };
    inline GetHoneypotNodeResponseBody& setHoneypotNode(GetHoneypotNodeResponseBodyHoneypotNode && honeypotNode) { DARABONBA_PTR_SET_RVALUE(honeypotNode_, honeypotNode) };
  ...
  protected:
    ...
    std::shared_ptr<GetHoneypotNodeResponseBodyHoneypotNode> honeypotNode_ = nullptr;
