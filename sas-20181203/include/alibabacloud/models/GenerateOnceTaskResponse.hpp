...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateOnceTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateOnceTaskResponseBody) };
    inline GenerateOnceTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateOnceTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateOnceTaskResponseBody> body_ {};
  };
