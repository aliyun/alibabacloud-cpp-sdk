...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLoginBaseConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyLoginBaseConfigResponseBody) };
    inline ModifyLoginBaseConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyLoginBaseConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyLoginBaseConfigResponseBody> body_ {};
  };
