...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTotalStatisticsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeTotalStatisticsResponseBody) };
    inline DescribeTotalStatisticsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeTotalStatisticsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeTotalStatisticsResponseBody> body_ = nullptr;
  };
