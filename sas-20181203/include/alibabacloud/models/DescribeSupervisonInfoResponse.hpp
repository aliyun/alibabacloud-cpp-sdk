...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSupervisonInfoResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSupervisonInfoResponseBody) };
    inline DescribeSupervisonInfoResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSupervisonInfoResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSupervisonInfoResponseBody> body_ = nullptr;
  };
