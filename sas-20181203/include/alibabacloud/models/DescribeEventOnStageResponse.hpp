...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEventOnStageResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeEventOnStageResponseBody) };
    inline DescribeEventOnStageResponseBody body() { DARABONBA_PTR_GET(body_, DescribeEventOnStageResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeEventOnStageResponseBody> body_ = nullptr;
  };
