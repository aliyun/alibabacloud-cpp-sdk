...
namespace Models
{
  ...
  public:
    ...
    inline const StopHoneypotResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopHoneypotResponseBody) };
    inline StopHoneypotResponseBody getBody() { DARABONBA_PTR_GET(body_, StopHoneypotResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopHoneypotResponseBody> body_ {};
  };
