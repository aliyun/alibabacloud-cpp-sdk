...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSecurityEventMarkMissListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSecurityEventMarkMissListResponseBody) };
    inline DeleteSecurityEventMarkMissListResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSecurityEventMarkMissListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSecurityEventMarkMissListResponseBody> body_ {};
  };
