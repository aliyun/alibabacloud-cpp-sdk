...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->eventLevels_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const DescribeEventLevelCountResponseBodyEventLevels & eventLevels() const { DARABONBA_PTR_GET_CONST(eventLevels_, DescribeEventLevelCountResponseBodyEventLevels) };
    inline DescribeEventLevelCountResponseBodyEventLevels eventLevels() { DARABONBA_PTR_GET(eventLevels_, DescribeEventLevelCountResponseBodyEventLevels) };
    inline DescribeEventLevelCountResponseBody& setEventLevels(const DescribeEventLevelCountResponseBodyEventLevels & eventLevels) { DARABONBA_PTR_SET_VALUE(eventLevels_, eventLevels) };
    inline DescribeEventLevelCountResponseBody& setEventLevels(DescribeEventLevelCountResponseBodyEventLevels && eventLevels) { DARABONBA_PTR_SET_RVALUE(eventLevels_, eventLevels) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeEventLevelCountResponseBodyEventLevels> eventLevels_ = nullptr;
