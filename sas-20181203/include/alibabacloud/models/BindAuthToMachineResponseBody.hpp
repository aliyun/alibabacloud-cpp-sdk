...
namespace Models
{
  ...
  public:
    ...
    inline int32_t getInsufficientCoreCount() const { DARABONBA_PTR_GET_DEFAULT(insufficientCoreCount_, 0) };
    ...
    inline int32_t getInsufficientEcsCount() const { DARABONBA_PTR_GET_DEFAULT(insufficientEcsCount_, 0) };
    ...
    inline int32_t getUnBindCount() const { DARABONBA_PTR_GET_DEFAULT(unBindCount_, 0) };
  ...
  protected:
    ...
    shared_ptr<int32_t> insufficientCoreCount_ {};
    // The shortage in the quota for servers that can be protected.
    shared_ptr<int32_t> insufficientEcsCount_ {};
    ...
    shared_ptr<int32_t> unBindCount_ {};
  };
