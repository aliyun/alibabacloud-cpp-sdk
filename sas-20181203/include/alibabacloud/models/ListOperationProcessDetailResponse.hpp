...
namespace Models
{
  ...
  public:
    ...
    inline const ListOperationProcessDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOperationProcessDetailResponseBody) };
    inline ListOperationProcessDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOperationProcessDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOperationProcessDetailResponseBody> body_ {};
  };
