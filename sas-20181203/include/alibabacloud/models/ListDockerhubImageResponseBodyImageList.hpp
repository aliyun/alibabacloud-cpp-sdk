...
#ifndef ALIBABACLOUD_MODELS_LISTDOCKERHUBIMAGERESPONSEBODYIMAGELIST_HPP_
#define ALIBABACLOUD_MODELS_LISTDOCKERHUBIMAGERESPONSEBODYIMAGELIST_HPP_
...
namespace Models
{
  class ListDockerhubImageResponseBodyImageList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListDockerhubImageResponseBodyImageList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDockerhubImageResponseBodyImageList& obj) { 
    ...
    ListDockerhubImageResponseBodyImageList() = default ;
    ListDockerhubImageResponseBodyImageList(const ListDockerhubImageResponseBodyImageList &) = default ;
    ListDockerhubImageResponseBodyImageList(ListDockerhubImageResponseBodyImageList &&) = default ;
    ListDockerhubImageResponseBodyImageList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDockerhubImageResponseBodyImageList() = default ;
    ListDockerhubImageResponseBodyImageList& operator=(const ListDockerhubImageResponseBodyImageList &) = default ;
    ListDockerhubImageResponseBodyImageList& operator=(ListDockerhubImageResponseBodyImageList &&) = default ;
    ...
    inline ListDockerhubImageResponseBodyImageList& setDigest(string digest) { DARABONBA_PTR_SET_VALUE(digest_, digest) };
    ...
    inline ListDockerhubImageResponseBodyImageList& setHcCount(int32_t hcCount) { DARABONBA_PTR_SET_VALUE(hcCount_, hcCount) };
    ...
    inline ListDockerhubImageResponseBodyImageList& setImageId(string imageId) { DARABONBA_PTR_SET_VALUE(imageId_, imageId) };
    ...
    inline ListDockerhubImageResponseBodyImageList& setImageSize(int64_t imageSize) { DARABONBA_PTR_SET_VALUE(imageSize_, imageSize) };
    ...
    inline ListDockerhubImageResponseBodyImageList& setRepoName(string repoName) { DARABONBA_PTR_SET_VALUE(repoName_, repoName) };
    ...
    inline ListDockerhubImageResponseBodyImageList& setRepoNamespace(string repoNamespace) { DARABONBA_PTR_SET_VALUE(repoNamespace_, repoNamespace) };
    ...
    inline ListDockerhubImageResponseBodyImageList& setRiskLevelDetail(string riskLevelDetail) { DARABONBA_PTR_SET_VALUE(riskLevelDetail_, riskLevelDetail) };
    ...
    inline ListDockerhubImageResponseBodyImageList& setTag(string tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    ...
    inline ListDockerhubImageResponseBodyImageList& setUuid(string uuid) { DARABONBA_PTR_SET_VALUE(uuid_, uuid) };
    ...
    inline ListDockerhubImageResponseBodyImageList& setVulCount(int32_t vulCount) { DARABONBA_PTR_SET_VALUE(vulCount_, vulCount) };
