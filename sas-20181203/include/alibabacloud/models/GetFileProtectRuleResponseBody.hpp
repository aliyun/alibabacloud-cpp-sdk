...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileProtectRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetFileProtectRuleResponseBodyData) };
    inline GetFileProtectRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, GetFileProtectRuleResponseBodyData) };
    inline GetFileProtectRuleResponseBody& setData(const GetFileProtectRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetFileProtectRuleResponseBody& setData(GetFileProtectRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetFileProtectRuleResponseBodyData> data_ = nullptr;
    // The request ID.
