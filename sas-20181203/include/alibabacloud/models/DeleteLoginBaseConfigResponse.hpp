...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLoginBaseConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLoginBaseConfigResponseBody) };
    inline DeleteLoginBaseConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLoginBaseConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLoginBaseConfigResponseBody> body_ {};
  };
