...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClusterVulStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeClusterVulStatisticsResponseBody) };
    inline DescribeClusterVulStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeClusterVulStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeClusterVulStatisticsResponseBody> body_ {};
  };
