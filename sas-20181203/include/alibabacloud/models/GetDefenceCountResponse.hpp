...
namespace Models
{
  ...
  public:
    ...
    inline const GetDefenceCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDefenceCountResponseBody) };
    inline GetDefenceCountResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDefenceCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDefenceCountResponseBody> body_ {};
  };
