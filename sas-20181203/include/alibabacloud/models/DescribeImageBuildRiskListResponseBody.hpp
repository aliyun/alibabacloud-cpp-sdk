...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageBuildRiskListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeImageBuildRiskListResponseBodyData) };
    inline DescribeImageBuildRiskListResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeImageBuildRiskListResponseBodyData) };
    inline DescribeImageBuildRiskListResponseBody& setData(const DescribeImageBuildRiskListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeImageBuildRiskListResponseBody& setData(DescribeImageBuildRiskListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<DescribeImageBuildRiskListResponseBodyData> data_ = nullptr;
