...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentPage_ == nullptr
        && this->endTime_ == nullptr && this->pageSize_ == nullptr && this->startTime_ == nullptr && this->statusCodes_ == nullptr && this->taskIds_ == nullptr
        && this->taskSources_ == nullptr && this->taskTypes_ == nullptr; };
    ...
    inline const vector<int32_t> & getStatusCodes() const { DARABONBA_PTR_GET_CONST(statusCodes_, vector<int32_t>) };
    inline vector<int32_t> getStatusCodes() { DARABONBA_PTR_GET(statusCodes_, vector<int32_t>) };
