...
namespace Models
{
  ...
  public:
    ...
    inline int32_t getAppCnt() const { DARABONBA_PTR_GET_DEFAULT(appCnt_, 0) };
    ...
    inline int32_t getCmsDealedTotalNum() const { DARABONBA_PTR_GET_DEFAULT(cmsDealedTotalNum_, 0) };
    ...
    inline int32_t getVulDealedTotalNum() const { DARABONBA_PTR_GET_DEFAULT(vulDealedTotalNum_, 0) };
