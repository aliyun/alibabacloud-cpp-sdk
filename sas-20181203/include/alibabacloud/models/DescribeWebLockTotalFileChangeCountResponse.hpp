...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWebLockTotalFileChangeCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeWebLockTotalFileChangeCountResponseBody) };
    inline DescribeWebLockTotalFileChangeCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeWebLockTotalFileChangeCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeWebLockTotalFileChangeCountResponseBody> body_ {};
  };
