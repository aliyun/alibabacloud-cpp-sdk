...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetClusterStrategyCountResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetClusterStrategyCountResponseBodyData>) };
    inline vector<GetClusterStrategyCountResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetClusterStrategyCountResponseBodyData>) };
    inline GetClusterStrategyCountResponseBody& setData(const vector<GetClusterStrategyCountResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetClusterStrategyCountResponseBody& setData(vector<GetClusterStrategyCountResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<vector<GetClusterStrategyCountResponseBodyData>> data_ = nullptr;
