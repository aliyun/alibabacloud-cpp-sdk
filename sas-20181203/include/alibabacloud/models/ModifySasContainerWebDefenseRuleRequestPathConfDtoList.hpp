...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backupPath_ == nullptr
        ...
        && return this->guardType_ == nullptr && return this->includeFile_ == nullptr && return this->includeFileType_ == nullptr && return this->pathConfId_ == nullptr && return this->processPathList_ == nullptr; };
