...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInterceptionTargetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyInterceptionTargetResponseBody) };
    inline ModifyInterceptionTargetResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyInterceptionTargetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyInterceptionTargetResponseBody> body_ {};
  };
