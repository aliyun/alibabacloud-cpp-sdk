...
namespace Models
{
  ...
  public:
    ...
    inline const ListInterceptionHistoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInterceptionHistoryResponseBody) };
    inline ListInterceptionHistoryResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInterceptionHistoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInterceptionHistoryResponseBody> body_ {};
  };
