...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeGraph4InvestigationOnlineResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeGraph4InvestigationOnlineResponseBody) };
    inline DescribeGraph4InvestigationOnlineResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeGraph4InvestigationOnlineResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeGraph4InvestigationOnlineResponseBody> body_ {};
  };
