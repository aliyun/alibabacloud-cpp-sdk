...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyGroupPropertyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyGroupPropertyResponseBody) };
    inline ModifyGroupPropertyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyGroupPropertyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyGroupPropertyResponseBody> body_ {};
  };
