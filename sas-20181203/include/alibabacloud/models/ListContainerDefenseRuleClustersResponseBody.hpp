...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterList_ == nullptr
        && return this->code_ == nullptr && return this->count_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr
    ...
    inline const vector<ListContainerDefenseRuleClustersResponseBodyClusterList> & clusterList() const { DARABONBA_PTR_GET_CONST(clusterList_, vector<ListContainerDefenseRuleClustersResponseBodyClusterList>) };
    inline vector<ListContainerDefenseRuleClustersResponseBodyClusterList> clusterList() { DARABONBA_PTR_GET(clusterList_, vector<ListContainerDefenseRuleClustersResponseBodyClusterList>) };
    inline ListContainerDefenseRuleClustersResponseBody& setClusterList(const vector<ListContainerDefenseRuleClustersResponseBodyClusterList> & clusterList) { DARABONBA_PTR_SET_VALUE(clusterList_, clusterList) };
    inline ListContainerDefenseRuleClustersResponseBody& setClusterList(vector<ListContainerDefenseRuleClustersResponseBodyClusterList> && clusterList) { DARABONBA_PTR_SET_RVALUE(clusterList_, clusterList) };
  ...
  protected:
    // The clusters.
    std::shared_ptr<vector<ListContainerDefenseRuleClustersResponseBodyClusterList>> clusterList_ = nullptr;
