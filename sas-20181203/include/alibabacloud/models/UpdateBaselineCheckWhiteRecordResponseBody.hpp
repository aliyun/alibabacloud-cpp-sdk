...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateBaselineCheckWhiteRecordResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateBaselineCheckWhiteRecordResponseBody::Data) };
    inline UpdateBaselineCheckWhiteRecordResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateBaselineCheckWhiteRecordResponseBody::Data) };
    inline UpdateBaselineCheckWhiteRecordResponseBody& setData(const UpdateBaselineCheckWhiteRecordResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateBaselineCheckWhiteRecordResponseBody& setData(UpdateBaselineCheckWhiteRecordResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    shared_ptr<UpdateBaselineCheckWhiteRecordResponseBody::Data> data_ {};
    // The request ID.
