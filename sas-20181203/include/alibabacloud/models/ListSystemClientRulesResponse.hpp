...
namespace Models
{
  ...
  public:
    ...
    inline const ListSystemClientRulesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListSystemClientRulesResponseBody) };
    inline ListSystemClientRulesResponseBody body() { DARABONBA_PTR_GET(body_, ListSystemClientRulesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListSystemClientRulesResponseBody> body_ = nullptr;
  };
