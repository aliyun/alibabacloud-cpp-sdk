...
namespace Models
{
  ...
  public:
    ...
    inline const GetModuleConfigStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetModuleConfigStatusResponseBodyData) };
    inline GetModuleConfigStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, GetModuleConfigStatusResponseBodyData) };
    inline GetModuleConfigStatusResponseBody& setData(const GetModuleConfigStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetModuleConfigStatusResponseBody& setData(GetModuleConfigStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<GetModuleConfigStatusResponseBodyData> data_ = nullptr;
