...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFileProtectRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateFileProtectRuleResponseBody) };
    inline UpdateFileProtectRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateFileProtectRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateFileProtectRuleResponseBody> body_ {};
  };
