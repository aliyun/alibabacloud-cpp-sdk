...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline PropertyItems& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    ...
    inline const DescribePropertyCronItemResponseBody::PageInfo & getPageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, DescribePropertyCronItemResponseBody::PageInfo) };
    inline DescribePropertyCronItemResponseBody::PageInfo getPageInfo() { DARABONBA_PTR_GET(pageInfo_, DescribePropertyCronItemResponseBody::PageInfo) };
    inline DescribePropertyCronItemResponseBody& setPageInfo(const DescribePropertyCronItemResponseBody::PageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline DescribePropertyCronItemResponseBody& setPageInfo(DescribePropertyCronItemResponseBody::PageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
    ...
    inline const vector<DescribePropertyCronItemResponseBody::PropertyItems> & getPropertyItems() const { DARABONBA_PTR_GET_CONST(propertyItems_, vector<DescribePropertyCronItemResponseBody::PropertyItems>) };
    inline vector<DescribePropertyCronItemResponseBody::PropertyItems> getPropertyItems() { DARABONBA_PTR_GET(propertyItems_, vector<DescribePropertyCronItemResponseBody::PropertyItems>) };
    inline DescribePropertyCronItemResponseBody& setPropertyItems(const vector<DescribePropertyCronItemResponseBody::PropertyItems> & propertyItems) { DARABONBA_PTR_SET_VALUE(propertyItems_, propertyItems) };
    inline DescribePropertyCronItemResponseBody& setPropertyItems(vector<DescribePropertyCronItemResponseBody::PropertyItems> && propertyItems) { DARABONBA_PTR_SET_RVALUE(propertyItems_, propertyItems) };
  ...
  protected:
    ...
    shared_ptr<DescribePropertyCronItemResponseBody::PageInfo> pageInfo_ {};
    // An array that consists of scheduled tasks.
    shared_ptr<vector<DescribePropertyCronItemResponseBody::PropertyItems>> propertyItems_ {};
