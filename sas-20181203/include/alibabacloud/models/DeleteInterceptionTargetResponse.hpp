...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteInterceptionTargetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteInterceptionTargetResponseBody) };
    inline DeleteInterceptionTargetResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteInterceptionTargetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteInterceptionTargetResponseBody> body_ {};
  };
