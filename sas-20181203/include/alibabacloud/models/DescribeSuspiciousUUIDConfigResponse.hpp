...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSuspiciousUUIDConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSuspiciousUUIDConfigResponseBody) };
    inline DescribeSuspiciousUUIDConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSuspiciousUUIDConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSuspiciousUUIDConfigResponseBody> body_ {};
  };
