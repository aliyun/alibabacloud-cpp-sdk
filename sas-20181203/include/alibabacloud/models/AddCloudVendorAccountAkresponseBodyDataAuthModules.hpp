...
#ifndef ALIBABACLOUD_MODELS_ADDCLOUDVENDORACCOUNTAKRESPONSEBODYDATAAUTHMODULES_HPP_
#define ALIBABACLOUD_MODELS_ADDCLOUDVENDORACCOUNTAKRESPONSEBODYDATAAUTHMODULES_HPP_
...
namespace Models
{
  class AddCloudVendorAccountAKResponseBodyDataAuthModules : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const AddCloudVendorAccountAKResponseBodyDataAuthModules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddCloudVendorAccountAKResponseBodyDataAuthModules& obj) { 
    ...
    AddCloudVendorAccountAKResponseBodyDataAuthModules() = default ;
    AddCloudVendorAccountAKResponseBodyDataAuthModules(const AddCloudVendorAccountAKResponseBodyDataAuthModules &) = default ;
    AddCloudVendorAccountAKResponseBodyDataAuthModules(AddCloudVendorAccountAKResponseBodyDataAuthModules &&) = default ;
    AddCloudVendorAccountAKResponseBodyDataAuthModules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddCloudVendorAccountAKResponseBodyDataAuthModules() = default ;
    AddCloudVendorAccountAKResponseBodyDataAuthModules& operator=(const AddCloudVendorAccountAKResponseBodyDataAuthModules &) = default ;
    AddCloudVendorAccountAKResponseBodyDataAuthModules& operator=(AddCloudVendorAccountAKResponseBodyDataAuthModules &&) = default ;
    ...
    inline AddCloudVendorAccountAKResponseBodyDataAuthModules& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline AddCloudVendorAccountAKResponseBodyDataAuthModules& setModule(string module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    ...
    inline AddCloudVendorAccountAKResponseBodyDataAuthModules& setModuleAssetType(string moduleAssetType) { DARABONBA_PTR_SET_VALUE(moduleAssetType_, moduleAssetType) };
    ...
    inline AddCloudVendorAccountAKResponseBodyDataAuthModules& setModuleDisp(string moduleDisp) { DARABONBA_PTR_SET_VALUE(moduleDisp_, moduleDisp) };
    ...
    inline AddCloudVendorAccountAKResponseBodyDataAuthModules& setModuleServiceStatus(int32_t moduleServiceStatus) { DARABONBA_PTR_SET_VALUE(moduleServiceStatus_, moduleServiceStatus) };
    ...
    inline AddCloudVendorAccountAKResponseBodyDataAuthModules& setModuleStatement(string moduleStatement) { DARABONBA_PTR_SET_VALUE(moduleStatement_, moduleStatement) };
