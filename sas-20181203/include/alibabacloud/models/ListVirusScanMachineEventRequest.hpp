...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentPage_ == nullptr
        && return this->lang_ == nullptr && return this->operateTaskId_ == nullptr && return this->pageSize_ == nullptr && return this->uuid_ == nullptr; };
    ...
    inline string operateTaskId() const { DARABONBA_PTR_GET_DEFAULT(operateTaskId_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> operateTaskId_ = nullptr;
