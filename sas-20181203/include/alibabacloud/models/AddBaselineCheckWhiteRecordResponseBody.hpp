...
namespace Models
{
  ...
  public:
    ...
    inline const AddBaselineCheckWhiteRecordResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AddBaselineCheckWhiteRecordResponseBodyData) };
    inline AddBaselineCheckWhiteRecordResponseBodyData data() { DARABONBA_PTR_GET(data_, AddBaselineCheckWhiteRecordResponseBodyData) };
    inline AddBaselineCheckWhiteRecordResponseBody& setData(const AddBaselineCheckWhiteRecordResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AddBaselineCheckWhiteRecordResponseBody& setData(AddBaselineCheckWhiteRecordResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<AddBaselineCheckWhiteRecordResponseBodyData> data_ = nullptr;
    // The request ID.
