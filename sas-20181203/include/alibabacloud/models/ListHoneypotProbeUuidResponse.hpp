...
namespace Models
{
  ...
  public:
    ...
    inline const ListHoneypotProbeUuidResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHoneypotProbeUuidResponseBody) };
    inline ListHoneypotProbeUuidResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHoneypotProbeUuidResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHoneypotProbeUuidResponseBody> body_ {};
  };
