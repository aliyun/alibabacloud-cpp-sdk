...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyStrategyTargetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyStrategyTargetResponseBody) };
    inline ModifyStrategyTargetResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyStrategyTargetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyStrategyTargetResponseBody> body_ {};
  };
