...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alertLevel_ == nullptr
        && return this->cmdLine_ == nullptr && return this->filePath_ == nullptr && return this->handleTime_ == nullptr && return this->id_ == nullptr && return this->instanceName_ == nullptr
        && return this->internetIp_ == nullptr && return this->intranetIp_ == nullptr && return this->latestTime_ == nullptr && return this->operation_ == nullptr && return this->platform_ == nullptr
        && return this->procPath_ == nullptr && return this->procPermission_ == nullptr && return this->processId_ == nullptr && return this->remark_ == nullptr && return this->ruleName_ == nullptr
