...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOnceTaskLeafRecordPageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeOnceTaskLeafRecordPageResponseBody) };
    inline DescribeOnceTaskLeafRecordPageResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeOnceTaskLeafRecordPageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeOnceTaskLeafRecordPageResponseBody> body_ {};
  };
