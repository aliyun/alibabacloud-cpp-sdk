...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVulTargetConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVulTargetConfigResponseBody) };
    inline DescribeVulTargetConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVulTargetConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVulTargetConfigResponseBody> body_ {};
  };
