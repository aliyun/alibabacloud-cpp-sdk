...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUuidsByVulNamesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUuidsByVulNamesResponseBody) };
    inline DescribeUuidsByVulNamesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUuidsByVulNamesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUuidsByVulNamesResponseBody> body_ {};
  };
