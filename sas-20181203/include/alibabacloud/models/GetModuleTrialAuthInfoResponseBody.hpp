...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->canTry_ == nullptr
        && this->moduleCode_ == nullptr && this->trialRecordList_ == nullptr; };
    ...
    inline const GetModuleTrialAuthInfoResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetModuleTrialAuthInfoResponseBody::Data) };
    inline GetModuleTrialAuthInfoResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetModuleTrialAuthInfoResponseBody::Data) };
    inline GetModuleTrialAuthInfoResponseBody& setData(const GetModuleTrialAuthInfoResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetModuleTrialAuthInfoResponseBody& setData(GetModuleTrialAuthInfoResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    shared_ptr<GetModuleTrialAuthInfoResponseBody::Data> data_ {};
    // The request ID.
