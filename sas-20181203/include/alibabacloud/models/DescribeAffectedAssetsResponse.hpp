...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAffectedAssetsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAffectedAssetsResponseBody) };
    inline DescribeAffectedAssetsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAffectedAssetsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAffectedAssetsResponseBody> body_ {};
  };
