...
namespace Models
{
  ...
  public:
    ...
    inline const ListClientUserDefineRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListClientUserDefineRulesResponseBody) };
    inline ListClientUserDefineRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListClientUserDefineRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListClientUserDefineRulesResponseBody> body_ {};
  };
