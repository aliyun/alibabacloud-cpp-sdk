...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeChartDataResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeChartDataResponseBody) };
    inline DescribeChartDataResponseBody body() { DARABONBA_PTR_GET(body_, DescribeChartDataResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeChartDataResponseBody> body_ = nullptr;
  };
