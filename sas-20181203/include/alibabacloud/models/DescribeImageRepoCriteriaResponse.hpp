...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageRepoCriteriaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeImageRepoCriteriaResponseBody) };
    inline DescribeImageRepoCriteriaResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeImageRepoCriteriaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeImageRepoCriteriaResponseBody> body_ {};
  };
