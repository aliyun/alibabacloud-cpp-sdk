...
namespace Models
{
  ...
  public:
    ...
    inline const TriggerCheckResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TriggerCheckResponseBody) };
    inline TriggerCheckResponseBody getBody() { DARABONBA_PTR_GET(body_, TriggerCheckResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TriggerCheckResponseBody> body_ {};
  };
