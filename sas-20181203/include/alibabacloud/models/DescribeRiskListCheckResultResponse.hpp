...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRiskListCheckResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRiskListCheckResultResponseBody) };
    inline DescribeRiskListCheckResultResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRiskListCheckResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRiskListCheckResultResponseBody> body_ {};
  };
