...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOnceTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeOnceTaskResponseBody) };
    inline DescribeOnceTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeOnceTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeOnceTaskResponseBody> body_ {};
  };
