...
namespace Models
{
  ...
  public:
    ...
    inline const GetAssetSelectionConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAssetSelectionConfigResponseBody) };
    inline GetAssetSelectionConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAssetSelectionConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAssetSelectionConfigResponseBody> body_ {};
  };
