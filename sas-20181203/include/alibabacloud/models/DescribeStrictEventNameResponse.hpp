...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeStrictEventNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeStrictEventNameResponseBody) };
    inline DescribeStrictEventNameResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeStrictEventNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeStrictEventNameResponseBody> body_ {};
  };
