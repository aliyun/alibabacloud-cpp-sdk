...
namespace Models
{
  ...
  public:
    ...
    inline const ListAssetSelectionSelectedTargetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAssetSelectionSelectedTargetResponseBody) };
    inline ListAssetSelectionSelectedTargetResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAssetSelectionSelectedTargetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAssetSelectionSelectedTargetResponseBody> body_ {};
  };
