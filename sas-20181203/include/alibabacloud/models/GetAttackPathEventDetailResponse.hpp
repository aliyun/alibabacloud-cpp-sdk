...
namespace Models
{
  ...
  public:
    ...
    inline const GetAttackPathEventDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAttackPathEventDetailResponseBody) };
    inline GetAttackPathEventDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAttackPathEventDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAttackPathEventDetailResponseBody> body_ {};
  };
