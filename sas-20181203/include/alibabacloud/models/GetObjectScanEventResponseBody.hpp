...
namespace Models
{
  ...
  public:
    ...
    inline const GetObjectScanEventResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetObjectScanEventResponseBodyData) };
    inline GetObjectScanEventResponseBodyData data() { DARABONBA_PTR_GET(data_, GetObjectScanEventResponseBodyData) };
    inline GetObjectScanEventResponseBody& setData(const GetObjectScanEventResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetObjectScanEventResponseBody& setData(GetObjectScanEventResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetObjectScanEventResponseBodyData> data_ = nullptr;
    // The request ID.
