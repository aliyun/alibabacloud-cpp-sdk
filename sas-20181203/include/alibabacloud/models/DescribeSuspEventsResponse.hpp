...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSuspEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSuspEventsResponseBody) };
    inline DescribeSuspEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSuspEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSuspEventsResponseBody> body_ {};
  };
