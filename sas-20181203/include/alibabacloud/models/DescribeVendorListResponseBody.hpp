...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getVendorNameList() const { DARABONBA_PTR_GET_CONST(vendorNameList_, vector<string>) };
    inline vector<string> getVendorNameList() { DARABONBA_PTR_GET(vendorNameList_, vector<string>) };
