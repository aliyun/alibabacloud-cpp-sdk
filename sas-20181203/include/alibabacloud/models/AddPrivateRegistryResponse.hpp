...
namespace Models
{
  ...
  public:
    ...
    inline const AddPrivateRegistryResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddPrivateRegistryResponseBody) };
    inline AddPrivateRegistryResponseBody body() { DARABONBA_PTR_GET(body_, AddPrivateRegistryResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddPrivateRegistryResponseBody> body_ = nullptr;
  };
