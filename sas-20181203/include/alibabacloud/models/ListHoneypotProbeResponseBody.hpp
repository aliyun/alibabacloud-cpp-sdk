...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHoneypotProbeResponseBodyList> & list() const { DARABONBA_PTR_GET_CONST(list_, vector<ListHoneypotProbeResponseBodyList>) };
    inline vector<ListHoneypotProbeResponseBodyList> list() { DARABONBA_PTR_GET(list_, vector<ListHoneypotProbeResponseBodyList>) };
    inline ListHoneypotProbeResponseBody& setList(const vector<ListHoneypotProbeResponseBodyList> & list) { DARABONBA_PTR_SET_VALUE(list_, list) };
    inline ListHoneypotProbeResponseBody& setList(vector<ListHoneypotProbeResponseBodyList> && list) { DARABONBA_PTR_SET_RVALUE(list_, list) };
    ...
    inline const ListHoneypotProbeResponseBodyPageInfo & pageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, ListHoneypotProbeResponseBodyPageInfo) };
    inline ListHoneypotProbeResponseBodyPageInfo pageInfo() { DARABONBA_PTR_GET(pageInfo_, ListHoneypotProbeResponseBodyPageInfo) };
    inline ListHoneypotProbeResponseBody& setPageInfo(const ListHoneypotProbeResponseBodyPageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline ListHoneypotProbeResponseBody& setPageInfo(ListHoneypotProbeResponseBodyPageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListHoneypotProbeResponseBodyList>> list_ = nullptr;
    // The message returned.
    std::shared_ptr<string> message_ = nullptr;
    // The pagination information.
    std::shared_ptr<ListHoneypotProbeResponseBodyPageInfo> pageInfo_ = nullptr;
