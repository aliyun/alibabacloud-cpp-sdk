...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getEventNameList() const { DARABONBA_PTR_GET_CONST(eventNameList_, vector<string>) };
    inline vector<string> getEventNameList() { DARABONBA_PTR_GET(eventNameList_, vector<string>) };
