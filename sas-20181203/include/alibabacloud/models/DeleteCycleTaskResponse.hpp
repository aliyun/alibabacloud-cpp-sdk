...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCycleTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCycleTaskResponseBody) };
    inline DeleteCycleTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCycleTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCycleTaskResponseBody> body_ {};
  };
