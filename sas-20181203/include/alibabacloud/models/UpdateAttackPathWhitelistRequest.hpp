...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->attackPathAssetList_ == nullptr
        && this->attackPathWhitelistId_ == nullptr && this->pathName_ == nullptr && this->pathType_ == nullptr && this->remark_ == nullptr && this->whitelistName_ == nullptr
    ...
    inline const vector<UpdateAttackPathWhitelistRequest::AttackPathAssetList> & getAttackPathAssetList() const { DARABONBA_PTR_GET_CONST(attackPathAssetList_, vector<UpdateAttackPathWhitelistRequest::AttackPathAssetList>) };
    inline vector<UpdateAttackPathWhitelistRequest::AttackPathAssetList> getAttackPathAssetList() { DARABONBA_PTR_GET(attackPathAssetList_, vector<UpdateAttackPathWhitelistRequest::AttackPathAssetList>) };
    inline UpdateAttackPathWhitelistRequest& setAttackPathAssetList(const vector<UpdateAttackPathWhitelistRequest::AttackPathAssetList> & attackPathAssetList) { DARABONBA_PTR_SET_VALUE(attackPathAssetList_, attackPathAssetList) };
    inline UpdateAttackPathWhitelistRequest& setAttackPathAssetList(vector<UpdateAttackPathWhitelistRequest::AttackPathAssetList> && attackPathAssetList) { DARABONBA_PTR_SET_RVALUE(attackPathAssetList_, attackPathAssetList) };
  ...
  protected:
    ...
    shared_ptr<vector<UpdateAttackPathWhitelistRequest::AttackPathAssetList>> attackPathAssetList_ {};
