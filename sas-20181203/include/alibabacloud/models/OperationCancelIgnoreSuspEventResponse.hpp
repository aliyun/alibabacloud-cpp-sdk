...
namespace Models
{
  ...
  public:
    ...
    inline const OperationCancelIgnoreSuspEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OperationCancelIgnoreSuspEventResponseBody) };
    inline OperationCancelIgnoreSuspEventResponseBody getBody() { DARABONBA_PTR_GET(body_, OperationCancelIgnoreSuspEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OperationCancelIgnoreSuspEventResponseBody> body_ {};
  };
