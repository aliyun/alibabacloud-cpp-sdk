...
#ifndef ALIBABACLOUD_MODELS_GETSECURITYSCORERULERESPONSEBODYSECURITYSCORERULELISTSECURITYSCOREITEMLIST_HPP_
#define ALIBABACLOUD_MODELS_GETSECURITYSCORERULERESPONSEBODYSECURITYSCORERULELISTSECURITYSCOREITEMLIST_HPP_
...
namespace Models
{
  class GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList& obj) { 
      DARABONBA_PTR_TO_JSON(Score, score_);
      DARABONBA_PTR_TO_JSON(ScoreThreshold, scoreThreshold_);
      DARABONBA_PTR_TO_JSON(SubRuleType, subRuleType_);
      DARABONBA_PTR_TO_JSON(Title, title_);
    };
    friend void from_json(const Darabonba::Json& j, GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList& obj) { 
      DARABONBA_PTR_FROM_JSON(Score, score_);
      DARABONBA_PTR_FROM_JSON(ScoreThreshold, scoreThreshold_);
      DARABONBA_PTR_FROM_JSON(SubRuleType, subRuleType_);
      DARABONBA_PTR_FROM_JSON(Title, title_);
    };
    GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList() = default ;
    GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList(const GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList &) = default ;
    GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList(GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList &&) = default ;
    GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList() = default ;
    GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList& operator=(const GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList &) = default ;
    GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList& operator=(GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList &&) = default ;
    ...
    inline GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList& setScore(int32_t score) { DARABONBA_PTR_SET_VALUE(score_, score) };
    ...
    inline GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList& setScoreThreshold(int32_t scoreThreshold) { DARABONBA_PTR_SET_VALUE(scoreThreshold_, scoreThreshold) };
    ...
    inline GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList& setSubRuleType(string subRuleType) { DARABONBA_PTR_SET_VALUE(subRuleType_, subRuleType) };
    ...
    inline GetSecurityScoreRuleResponseBodySecurityScoreRuleListSecurityScoreItemList& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
