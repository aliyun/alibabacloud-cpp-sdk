...
namespace Models
{
  ...
  public:
    ...
    inline const ListSupportObjectSuffixResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSupportObjectSuffixResponseBody) };
    inline ListSupportObjectSuffixResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSupportObjectSuffixResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSupportObjectSuffixResponseBody> body_ {};
  };
