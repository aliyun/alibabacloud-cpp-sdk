...
namespace Models
{
  ...
  public:
    ...
    inline const BatchCreateMaliciousNoteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchCreateMaliciousNoteResponseBody) };
    inline BatchCreateMaliciousNoteResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchCreateMaliciousNoteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchCreateMaliciousNoteResponseBody> body_ {};
  };
