...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateOpaStrategyNewRequest::AlarmDetail & getAlarmDetail() const { DARABONBA_PTR_GET_CONST(alarmDetail_, UpdateOpaStrategyNewRequest::AlarmDetail) };
    inline UpdateOpaStrategyNewRequest::AlarmDetail getAlarmDetail() { DARABONBA_PTR_GET(alarmDetail_, UpdateOpaStrategyNewRequest::AlarmDetail) };
    inline UpdateOpaStrategyNewRequest& setAlarmDetail(const UpdateOpaStrategyNewRequest::AlarmDetail & alarmDetail) { DARABONBA_PTR_SET_VALUE(alarmDetail_, alarmDetail) };
    inline UpdateOpaStrategyNewRequest& setAlarmDetail(UpdateOpaStrategyNewRequest::AlarmDetail && alarmDetail) { DARABONBA_PTR_SET_RVALUE(alarmDetail_, alarmDetail) };
    ...
    inline const vector<UpdateOpaStrategyNewRequest::Scopes> & getScopes() const { DARABONBA_PTR_GET_CONST(scopes_, vector<UpdateOpaStrategyNewRequest::Scopes>) };
    inline vector<UpdateOpaStrategyNewRequest::Scopes> getScopes() { DARABONBA_PTR_GET(scopes_, vector<UpdateOpaStrategyNewRequest::Scopes>) };
    inline UpdateOpaStrategyNewRequest& setScopes(const vector<UpdateOpaStrategyNewRequest::Scopes> & scopes) { DARABONBA_PTR_SET_VALUE(scopes_, scopes) };
    inline UpdateOpaStrategyNewRequest& setScopes(vector<UpdateOpaStrategyNewRequest::Scopes> && scopes) { DARABONBA_PTR_SET_RVALUE(scopes_, scopes) };
