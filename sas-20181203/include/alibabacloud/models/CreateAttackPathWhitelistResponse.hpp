...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAttackPathWhitelistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAttackPathWhitelistResponseBody) };
    inline CreateAttackPathWhitelistResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAttackPathWhitelistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAttackPathWhitelistResponseBody> body_ {};
  };
