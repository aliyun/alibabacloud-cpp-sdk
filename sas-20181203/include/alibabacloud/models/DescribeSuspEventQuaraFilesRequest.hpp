...
namespace Models
{
  ...
  public:
    ...
    inline int64_t groupingId() const { DARABONBA_PTR_GET_DEFAULT(groupingId_, 0L) };
    ...
    inline string quaraTag() const { DARABONBA_PTR_GET_DEFAULT(quaraTag_, "") };
  ...
  protected:
    ...
    std::shared_ptr<int64_t> groupingId_ = nullptr;
    // The number of entries to return on each page.
    std::shared_ptr<string> pageSize_ = nullptr;
    // The unique ID of the quarantined file.
    std::shared_ptr<string> quaraTag_ = nullptr;
