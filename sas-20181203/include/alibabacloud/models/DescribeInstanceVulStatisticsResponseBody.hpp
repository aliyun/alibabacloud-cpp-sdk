...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceVulStatisticsResponseBody::VulStat & getVulStat() const { DARABONBA_PTR_GET_CONST(vulStat_, DescribeInstanceVulStatisticsResponseBody::VulStat) };
    inline DescribeInstanceVulStatisticsResponseBody::VulStat getVulStat() { DARABONBA_PTR_GET(vulStat_, DescribeInstanceVulStatisticsResponseBody::VulStat) };
    inline DescribeInstanceVulStatisticsResponseBody& setVulStat(const DescribeInstanceVulStatisticsResponseBody::VulStat & vulStat) { DARABONBA_PTR_SET_VALUE(vulStat_, vulStat) };
    inline DescribeInstanceVulStatisticsResponseBody& setVulStat(DescribeInstanceVulStatisticsResponseBody::VulStat && vulStat) { DARABONBA_PTR_SET_RVALUE(vulStat_, vulStat) };
