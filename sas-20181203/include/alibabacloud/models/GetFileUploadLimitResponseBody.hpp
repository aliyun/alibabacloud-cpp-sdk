...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileUploadLimitResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetFileUploadLimitResponseBodyData) };
    inline GetFileUploadLimitResponseBodyData data() { DARABONBA_PTR_GET(data_, GetFileUploadLimitResponseBodyData) };
    inline GetFileUploadLimitResponseBody& setData(const GetFileUploadLimitResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetFileUploadLimitResponseBody& setData(GetFileUploadLimitResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetFileUploadLimitResponseBodyData> data_ = nullptr;
    // The request ID.
