...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceVulStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceVulStatisticsResponseBody) };
    inline DescribeInstanceVulStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceVulStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceVulStatisticsResponseBody> body_ {};
  };
