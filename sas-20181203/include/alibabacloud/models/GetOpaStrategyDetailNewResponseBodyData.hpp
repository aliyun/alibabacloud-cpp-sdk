...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->alarmDetail_ != nullptr
        && this->clusterId_ != nullptr && this->clusterName_ != nullptr && this->currentPage_ != nullptr && this->description_ != nullptr && this->imageName_ != nullptr
        && this->label_ != nullptr && this->lang_ != nullptr && this->maliciousImage_ != nullptr && this->pageSize_ != nullptr && this->ruleAction_ != nullptr
        && this->scopes_ != nullptr && this->strategyId_ != nullptr && this->strategyName_ != nullptr && this->strategyTemplateId_ != nullptr && this->unScanedImage_ != nullptr
