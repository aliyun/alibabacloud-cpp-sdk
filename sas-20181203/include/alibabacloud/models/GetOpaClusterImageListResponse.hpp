...
namespace Models
{
  ...
  public:
    ...
    inline const GetOpaClusterImageListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOpaClusterImageListResponseBody) };
    inline GetOpaClusterImageListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOpaClusterImageListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOpaClusterImageListResponseBody> body_ {};
  };
