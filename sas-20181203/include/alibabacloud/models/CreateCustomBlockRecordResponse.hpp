...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCustomBlockRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCustomBlockRecordResponseBody) };
    inline CreateCustomBlockRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCustomBlockRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCustomBlockRecordResponseBody> body_ {};
  };
