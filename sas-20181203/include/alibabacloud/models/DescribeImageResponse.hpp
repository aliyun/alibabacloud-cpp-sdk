...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeImageResponseBody) };
    inline DescribeImageResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeImageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeImageResponseBody> body_ {};
  };
