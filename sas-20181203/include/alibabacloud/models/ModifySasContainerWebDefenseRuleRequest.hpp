...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline int64_t getPathConfId() const { DARABONBA_PTR_GET_DEFAULT(pathConfId_, 0L) };
      inline PathConfDTOList& setPathConfId(int64_t pathConfId) { DARABONBA_PTR_SET_VALUE(pathConfId_, pathConfId) };
    ...
    inline const vector<ModifySasContainerWebDefenseRuleRequest::PathConfDTOList> & getPathConfDTOList() const { DARABONBA_PTR_GET_CONST(pathConfDTOList_, vector<ModifySasContainerWebDefenseRuleRequest::PathConfDTOList>) };
    inline vector<ModifySasContainerWebDefenseRuleRequest::PathConfDTOList> getPathConfDTOList() { DARABONBA_PTR_GET(pathConfDTOList_, vector<ModifySasContainerWebDefenseRuleRequest::PathConfDTOList>) };
    inline ModifySasContainerWebDefenseRuleRequest& setPathConfDTOList(const vector<ModifySasContainerWebDefenseRuleRequest::PathConfDTOList> & pathConfDTOList) { DARABONBA_PTR_SET_VALUE(pathConfDTOList_, pathConfDTOList) };
    inline ModifySasContainerWebDefenseRuleRequest& setPathConfDTOList(vector<ModifySasContainerWebDefenseRuleRequest::PathConfDTOList> && pathConfDTOList) { DARABONBA_PTR_SET_RVALUE(pathConfDTOList_, pathConfDTOList) };
