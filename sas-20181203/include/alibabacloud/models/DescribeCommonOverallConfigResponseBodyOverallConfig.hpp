...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECOMMONOVERALLCONFIGRESPONSEBODYOVERALLCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECOMMONOVERALLCONFIGRESPONSEBODYOVERALLCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeCommonOverallConfigResponseBodyOverallConfig& obj) { 
      DARABONBA_PTR_TO_JSON(Config, config_);
      DARABONBA_PTR_TO_JSON(Type, type_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeCommonOverallConfigResponseBodyOverallConfig& obj) { 
      DARABONBA_PTR_FROM_JSON(Config, config_);
      DARABONBA_PTR_FROM_JSON(Type, type_);
    };
    DescribeCommonOverallConfigResponseBodyOverallConfig() = default ;
    DescribeCommonOverallConfigResponseBodyOverallConfig(const DescribeCommonOverallConfigResponseBodyOverallConfig &) = default ;
    DescribeCommonOverallConfigResponseBodyOverallConfig(DescribeCommonOverallConfigResponseBodyOverallConfig &&) = default ;
    DescribeCommonOverallConfigResponseBodyOverallConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeCommonOverallConfigResponseBodyOverallConfig() = default ;
    DescribeCommonOverallConfigResponseBodyOverallConfig& operator=(const DescribeCommonOverallConfigResponseBodyOverallConfig &) = default ;
    DescribeCommonOverallConfigResponseBodyOverallConfig& operator=(DescribeCommonOverallConfigResponseBodyOverallConfig &&) = default ;
    ...
    inline DescribeCommonOverallConfigResponseBodyOverallConfig& setConfig(string config) { DARABONBA_PTR_SET_VALUE(config_, config) };
    ...
    inline DescribeCommonOverallConfigResponseBodyOverallConfig& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
