...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyIdcProbeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyIdcProbeResponseBody) };
    inline ModifyIdcProbeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyIdcProbeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyIdcProbeResponseBody> body_ {};
  };
