...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentPage_ == nullptr
        ...
        && return this->pageSize_ == nullptr && return this->rootTask_ == nullptr && return this->rootTaskId_ == nullptr && return this->scanType_ == nullptr && return this->startTime_ == nullptr
        && return this->status_ == nullptr && return this->statusList_ == nullptr && return this->taskId_ == nullptr; };
    ...
    inline const vector<int32_t> & statusList() const { DARABONBA_PTR_GET_CONST(statusList_, vector<int32_t>) };
    inline vector<int32_t> statusList() { DARABONBA_PTR_GET(statusList_, vector<int32_t>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<int32_t>> statusList_ = nullptr;
