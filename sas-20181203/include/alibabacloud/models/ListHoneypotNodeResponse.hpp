...
namespace Models
{
  ...
  public:
    ...
    inline const ListHoneypotNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHoneypotNodeResponseBody) };
    inline ListHoneypotNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHoneypotNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHoneypotNodeResponseBody> body_ {};
  };
