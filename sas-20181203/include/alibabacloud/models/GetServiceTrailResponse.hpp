...
namespace Models
{
  ...
  public:
    ...
    inline const GetServiceTrailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetServiceTrailResponseBody) };
    inline GetServiceTrailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetServiceTrailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetServiceTrailResponseBody> body_ {};
  };
