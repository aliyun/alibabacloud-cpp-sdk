...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMaliciousNoteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMaliciousNoteResponseBody) };
    inline DeleteMaliciousNoteResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMaliciousNoteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMaliciousNoteResponseBody> body_ {};
  };
