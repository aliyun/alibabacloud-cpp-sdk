...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageVulWhiteListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeImageVulWhiteListResponseBody) };
    inline DescribeImageVulWhiteListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeImageVulWhiteListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeImageVulWhiteListResponseBody> body_ {};
  };
