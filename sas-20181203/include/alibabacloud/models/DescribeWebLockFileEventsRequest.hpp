...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentPage_ == nullptr
        && return this->dealed_ == nullptr && return this->pageSize_ == nullptr && return this->processName_ == nullptr && return this->remark_ == nullptr && return this->tsBegin_ == nullptr
    ...
    inline int64_t tsBegin() const { DARABONBA_PTR_GET_DEFAULT(tsBegin_, 0L) };
    ...
    inline int64_t tsEnd() const { DARABONBA_PTR_GET_DEFAULT(tsEnd_, 0L) };
  ...
  protected:
    ...
    std::shared_ptr<int64_t> tsBegin_ = nullptr;
    // The end of the time range to query. The value is a UNIX timestamp.
    std::shared_ptr<int64_t> tsEnd_ = nullptr;
  };
