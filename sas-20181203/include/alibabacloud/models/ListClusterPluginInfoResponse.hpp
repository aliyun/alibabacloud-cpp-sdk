...
namespace Models
{
  ...
  public:
    ...
    inline const ListClusterPluginInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListClusterPluginInfoResponseBody) };
    inline ListClusterPluginInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, ListClusterPluginInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListClusterPluginInfoResponseBody> body_ {};
  };
