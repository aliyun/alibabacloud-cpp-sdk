...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePluginSummaryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribePluginSummaryResponseBodyData) };
    inline DescribePluginSummaryResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribePluginSummaryResponseBodyData) };
    inline DescribePluginSummaryResponseBody& setData(const DescribePluginSummaryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribePluginSummaryResponseBody& setData(DescribePluginSummaryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribePluginSummaryResponseBodyData> data_ = nullptr;
    // The request ID.
