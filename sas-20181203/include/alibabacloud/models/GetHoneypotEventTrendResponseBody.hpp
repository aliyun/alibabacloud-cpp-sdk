...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetHoneypotEventTrendResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetHoneypotEventTrendResponseBodyData>) };
    inline vector<GetHoneypotEventTrendResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetHoneypotEventTrendResponseBodyData>) };
    inline GetHoneypotEventTrendResponseBody& setData(const vector<GetHoneypotEventTrendResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHoneypotEventTrendResponseBody& setData(vector<GetHoneypotEventTrendResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetHoneypotEventTrendResponseBodyData>> data_ = nullptr;
