...
namespace Models
{
  ...
  public:
    ...
    inline const ListHoneypotEventFlowsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListHoneypotEventFlowsResponseBody) };
    inline ListHoneypotEventFlowsResponseBody body() { DARABONBA_PTR_GET(body_, ListHoneypotEventFlowsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListHoneypotEventFlowsResponseBody> body_ = nullptr;
  };
