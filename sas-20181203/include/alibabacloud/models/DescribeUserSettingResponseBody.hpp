...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getAlertLevels() const { DARABONBA_PTR_GET_CONST(alertLevels_, vector<string>) };
    inline vector<string> getAlertLevels() { DARABONBA_PTR_GET(alertLevels_, vector<string>) };
