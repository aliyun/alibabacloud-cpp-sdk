...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCommonTargetResultListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCommonTargetResultListResponseBody) };
    inline DescribeCommonTargetResultListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCommonTargetResultListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCommonTargetResultListResponseBody> body_ {};
  };
