...
namespace Models
{
  ...
  public:
    ...
    inline const ListPluginForUuidResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPluginForUuidResponseBody) };
    inline ListPluginForUuidResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPluginForUuidResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPluginForUuidResponseBody> body_ {};
  };
