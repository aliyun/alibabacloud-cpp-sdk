...
namespace Models
{
  ...
  public:
    ...
    inline const GetStrategyTemplateDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetStrategyTemplateDetailResponseBodyData) };
    inline GetStrategyTemplateDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetStrategyTemplateDetailResponseBodyData) };
    inline GetStrategyTemplateDetailResponseBody& setData(const GetStrategyTemplateDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetStrategyTemplateDetailResponseBody& setData(GetStrategyTemplateDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetStrategyTemplateDetailResponseBodyData> data_ = nullptr;
