...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetAuthVersionStatisticResponseBodyStatistics> & statistics() const { DARABONBA_PTR_GET_CONST(statistics_, vector<GetAuthVersionStatisticResponseBodyStatistics>) };
    inline vector<GetAuthVersionStatisticResponseBodyStatistics> statistics() { DARABONBA_PTR_GET(statistics_, vector<GetAuthVersionStatisticResponseBodyStatistics>) };
    inline GetAuthVersionStatisticResponseBody& setStatistics(const vector<GetAuthVersionStatisticResponseBodyStatistics> & statistics) { DARABONBA_PTR_SET_VALUE(statistics_, statistics) };
    inline GetAuthVersionStatisticResponseBody& setStatistics(vector<GetAuthVersionStatisticResponseBodyStatistics> && statistics) { DARABONBA_PTR_SET_RVALUE(statistics_, statistics) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetAuthVersionStatisticResponseBodyStatistics>> statistics_ = nullptr;
  };
