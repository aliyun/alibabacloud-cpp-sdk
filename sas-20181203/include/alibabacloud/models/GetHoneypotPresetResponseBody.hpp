...
namespace Models
{
  ...
  public:
    ...
    inline const GetHoneypotPresetResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetHoneypotPresetResponseBodyData) };
    inline GetHoneypotPresetResponseBodyData data() { DARABONBA_PTR_GET(data_, GetHoneypotPresetResponseBodyData) };
    inline GetHoneypotPresetResponseBody& setData(const GetHoneypotPresetResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHoneypotPresetResponseBody& setData(GetHoneypotPresetResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetHoneypotPresetResponseBodyData> data_ = nullptr;
