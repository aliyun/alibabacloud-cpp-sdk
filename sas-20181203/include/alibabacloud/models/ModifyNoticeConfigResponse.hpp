...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyNoticeConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyNoticeConfigResponseBody) };
    inline ModifyNoticeConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyNoticeConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyNoticeConfigResponseBody> body_ {};
  };
