...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDomainSecureAlarmListResponseBodyAlarmList> & alarmList() const { DARABONBA_PTR_GET_CONST(alarmList_, vector<DescribeDomainSecureAlarmListResponseBodyAlarmList>) };
    inline vector<DescribeDomainSecureAlarmListResponseBodyAlarmList> alarmList() { DARABONBA_PTR_GET(alarmList_, vector<DescribeDomainSecureAlarmListResponseBodyAlarmList>) };
    inline DescribeDomainSecureAlarmListResponseBody& setAlarmList(const vector<DescribeDomainSecureAlarmListResponseBodyAlarmList> & alarmList) { DARABONBA_PTR_SET_VALUE(alarmList_, alarmList) };
    inline DescribeDomainSecureAlarmListResponseBody& setAlarmList(vector<DescribeDomainSecureAlarmListResponseBodyAlarmList> && alarmList) { DARABONBA_PTR_SET_RVALUE(alarmList_, alarmList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeDomainSecureAlarmListResponseBodyAlarmList>> alarmList_ = nullptr;
    // The request ID.
