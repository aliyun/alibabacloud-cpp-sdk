...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceRebootStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceRebootStatusResponseBody) };
    inline DescribeInstanceRebootStatusResponseBody body() { DARABONBA_PTR_GET(body_, DescribeInstanceRebootStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeInstanceRebootStatusResponseBody> body_ = nullptr;
  };
