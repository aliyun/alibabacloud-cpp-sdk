...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteBinarySecurityPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteBinarySecurityPolicyResponseBody) };
    inline DeleteBinarySecurityPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteBinarySecurityPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteBinarySecurityPolicyResponseBody> body_ {};
  };
