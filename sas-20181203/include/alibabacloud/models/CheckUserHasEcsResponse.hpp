...
namespace Models
{
  ...
  public:
    ...
    inline const CheckUserHasEcsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckUserHasEcsResponseBody) };
    inline CheckUserHasEcsResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckUserHasEcsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckUserHasEcsResponseBody> body_ {};
  };
