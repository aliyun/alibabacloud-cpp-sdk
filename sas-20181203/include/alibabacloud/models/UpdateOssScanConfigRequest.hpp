...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allKeyPrefix_ == nullptr
        ...
        && return this->endTime_ == nullptr && return this->id_ == nullptr && return this->keyPrefixList_ == nullptr && return this->keySuffixList_ == nullptr && return this->lastModifiedStartTime_ == nullptr
        && return this->name_ == nullptr && return this->realTimeIncr_ == nullptr && return this->scanDayList_ == nullptr && return this->startTime_ == nullptr; };
