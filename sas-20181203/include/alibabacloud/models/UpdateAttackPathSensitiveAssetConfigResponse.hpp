...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAttackPathSensitiveAssetConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateAttackPathSensitiveAssetConfigResponseBody) };
    inline UpdateAttackPathSensitiveAssetConfigResponseBody body() { DARABONBA_PTR_GET(body_, UpdateAttackPathSensitiveAssetConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateAttackPathSensitiveAssetConfigResponseBody> body_ = nullptr;
  };
