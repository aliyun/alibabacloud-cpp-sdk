...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateStrictEventNameResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateStrictEventNameResponseBody) };
    inline UpdateStrictEventNameResponseBody body() { DARABONBA_PTR_GET(body_, UpdateStrictEventNameResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateStrictEventNameResponseBody> body_ = nullptr;
  };
