...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getProcessStartedEnd() const { DARABONBA_PTR_GET_DEFAULT(processStartedEnd_, 0L) };
    ...
    inline int64_t getProcessStartedStart() const { DARABONBA_PTR_GET_DEFAULT(processStartedStart_, 0L) };
    ...
    inline string getScaName() const { DARABONBA_PTR_GET_DEFAULT(scaName_, "") };
    ...
    inline string getScaNamePattern() const { DARABONBA_PTR_GET_DEFAULT(scaNamePattern_, "") };
    ...
    inline string getScaVersion() const { DARABONBA_PTR_GET_DEFAULT(scaVersion_, "") };
    ...
    inline string getSearchInfoSub() const { DARABONBA_PTR_GET_DEFAULT(searchInfoSub_, "") };
    ...
    inline string getSearchItemSub() const { DARABONBA_PTR_GET_DEFAULT(searchItemSub_, "") };
