...
namespace Models
{
  ...
  public:
    ...
    inline const UnBindHybridProxyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UnBindHybridProxyResponseBody) };
    inline UnBindHybridProxyResponseBody body() { DARABONBA_PTR_GET(body_, UnBindHybridProxyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UnBindHybridProxyResponseBody> body_ = nullptr;
  };
