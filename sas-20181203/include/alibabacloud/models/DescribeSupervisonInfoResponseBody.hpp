...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->latestScanTime_ == nullptr
    ...
    inline int64_t getLatestScanTime() const { DARABONBA_PTR_GET_DEFAULT(latestScanTime_, 0L) };
