...
namespace Models
{
  ...
  public:
    ...
    inline const ListClusterInterceptionConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListClusterInterceptionConfigResponseBody) };
    inline ListClusterInterceptionConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ListClusterInterceptionConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListClusterInterceptionConfigResponseBody> body_ {};
  };
