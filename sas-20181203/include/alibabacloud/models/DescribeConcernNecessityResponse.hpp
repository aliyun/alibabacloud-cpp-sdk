...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeConcernNecessityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeConcernNecessityResponseBody) };
    inline DescribeConcernNecessityResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeConcernNecessityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeConcernNecessityResponseBody> body_ {};
  };
