...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeContainerCriteriaResponseBodyCriteriaList> & criteriaList() const { DARABONBA_PTR_GET_CONST(criteriaList_, vector<DescribeContainerCriteriaResponseBodyCriteriaList>) };
    inline vector<DescribeContainerCriteriaResponseBodyCriteriaList> criteriaList() { DARABONBA_PTR_GET(criteriaList_, vector<DescribeContainerCriteriaResponseBodyCriteriaList>) };
    inline DescribeContainerCriteriaResponseBody& setCriteriaList(const vector<DescribeContainerCriteriaResponseBodyCriteriaList> & criteriaList) { DARABONBA_PTR_SET_VALUE(criteriaList_, criteriaList) };
    inline DescribeContainerCriteriaResponseBody& setCriteriaList(vector<DescribeContainerCriteriaResponseBodyCriteriaList> && criteriaList) { DARABONBA_PTR_SET_RVALUE(criteriaList_, criteriaList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeContainerCriteriaResponseBodyCriteriaList>> criteriaList_ = nullptr;
