...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSearchConditionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSearchConditionResponseBody) };
    inline DeleteSearchConditionResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSearchConditionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSearchConditionResponseBody> body_ {};
  };
