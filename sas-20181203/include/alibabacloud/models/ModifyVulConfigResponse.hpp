...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVulConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyVulConfigResponseBody) };
    inline ModifyVulConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyVulConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyVulConfigResponseBody> body_ {};
  };
