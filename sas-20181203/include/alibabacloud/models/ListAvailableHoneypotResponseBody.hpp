...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAvailableHoneypotResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAvailableHoneypotResponseBodyData>) };
    inline vector<ListAvailableHoneypotResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAvailableHoneypotResponseBodyData>) };
    inline ListAvailableHoneypotResponseBody& setData(const vector<ListAvailableHoneypotResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAvailableHoneypotResponseBody& setData(vector<ListAvailableHoneypotResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAvailableHoneypotResponseBodyData>> data_ = nullptr;
