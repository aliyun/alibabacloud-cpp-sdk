...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRisksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRisksResponseBody) };
    inline DescribeRisksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRisksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRisksResponseBody> body_ {};
  };
