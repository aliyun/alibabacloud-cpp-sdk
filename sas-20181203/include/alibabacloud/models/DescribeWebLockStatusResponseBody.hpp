...
namespace Models
{
  ...
  public:
    ...
    inline int32_t getAuthCount() const { DARABONBA_PTR_GET_DEFAULT(authCount_, 0) };
    ...
    inline int32_t getBlockCount() const { DARABONBA_PTR_GET_DEFAULT(blockCount_, 0) };
    ...
    inline int32_t getDirCount() const { DARABONBA_PTR_GET_DEFAULT(dirCount_, 0) };
    ...
    inline int32_t getWhiteCount() const { DARABONBA_PTR_GET_DEFAULT(whiteCount_, 0) };
