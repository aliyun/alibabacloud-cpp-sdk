...
namespace Models
{
  ...
  public:
    ...
    inline const ValidateHcWarningsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ValidateHcWarningsResponseBody) };
    inline ValidateHcWarningsResponseBody getBody() { DARABONBA_PTR_GET(body_, ValidateHcWarningsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ValidateHcWarningsResponseBody> body_ {};
  };
