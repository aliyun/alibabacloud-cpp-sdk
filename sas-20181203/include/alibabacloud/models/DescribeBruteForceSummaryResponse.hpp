...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBruteForceSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBruteForceSummaryResponseBody) };
    inline DescribeBruteForceSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBruteForceSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBruteForceSummaryResponseBody> body_ {};
  };
