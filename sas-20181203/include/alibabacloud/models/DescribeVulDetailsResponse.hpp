...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVulDetailsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVulDetailsResponseBody) };
    inline DescribeVulDetailsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVulDetailsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVulDetailsResponseBody> body_ {};
  };
