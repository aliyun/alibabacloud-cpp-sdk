...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHoneypotResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateHoneypotResponseBodyData) };
    inline CreateHoneypotResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateHoneypotResponseBodyData) };
    inline CreateHoneypotResponseBody& setData(const CreateHoneypotResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateHoneypotResponseBody& setData(CreateHoneypotResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateHoneypotResponseBodyData> data_ = nullptr;
