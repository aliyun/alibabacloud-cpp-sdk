...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePropertyScheduleConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePropertyScheduleConfigResponseBody) };
    inline DescribePropertyScheduleConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePropertyScheduleConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePropertyScheduleConfigResponseBody> body_ {};
  };
