...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudProductFieldStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCloudProductFieldStatisticsResponseBody) };
    inline DescribeCloudProductFieldStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCloudProductFieldStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCloudProductFieldStatisticsResponseBody> body_ {};
  };
