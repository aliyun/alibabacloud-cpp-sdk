...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMaliciousFileWhitelistConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateMaliciousFileWhitelistConfigResponseBodyData) };
    inline CreateMaliciousFileWhitelistConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateMaliciousFileWhitelistConfigResponseBodyData) };
    inline CreateMaliciousFileWhitelistConfigResponseBody& setData(const CreateMaliciousFileWhitelistConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateMaliciousFileWhitelistConfigResponseBody& setData(CreateMaliciousFileWhitelistConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateMaliciousFileWhitelistConfigResponseBodyData> data_ = nullptr;
    // The HTTP status code.
