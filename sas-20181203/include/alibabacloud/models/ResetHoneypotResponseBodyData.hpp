...
#ifndef ALIBABACLOUD_MODELS_RESETHONEYPOTRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_RESETHONEYPOTRESPONSEBODYDATA_HPP_
...
namespace Models
{
  class ResetHoneypotResponseBodyData : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ResetHoneypotResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ResetHoneypotResponseBodyData& obj) { 
    ...
    ResetHoneypotResponseBodyData() = default ;
    ResetHoneypotResponseBodyData(const ResetHoneypotResponseBodyData &) = default ;
    ResetHoneypotResponseBodyData(ResetHoneypotResponseBodyData &&) = default ;
    ResetHoneypotResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ResetHoneypotResponseBodyData() = default ;
    ResetHoneypotResponseBodyData& operator=(const ResetHoneypotResponseBodyData &) = default ;
    ResetHoneypotResponseBodyData& operator=(ResetHoneypotResponseBodyData &&) = default ;
    ...
    inline ResetHoneypotResponseBodyData& setControlNodeName(string controlNodeName) { DARABONBA_PTR_SET_VALUE(controlNodeName_, controlNodeName) };
    ...
    inline ResetHoneypotResponseBodyData& setHoneypotId(string honeypotId) { DARABONBA_PTR_SET_VALUE(honeypotId_, honeypotId) };
    ...
    inline ResetHoneypotResponseBodyData& setHoneypotImageDisplayName(string honeypotImageDisplayName) { DARABONBA_PTR_SET_VALUE(honeypotImageDisplayName_, honeypotImageDisplayName) };
    ...
    inline ResetHoneypotResponseBodyData& setHoneypotImageName(string honeypotImageName) { DARABONBA_PTR_SET_VALUE(honeypotImageName_, honeypotImageName) };
    ...
    inline ResetHoneypotResponseBodyData& setHoneypotName(string honeypotName) { DARABONBA_PTR_SET_VALUE(honeypotName_, honeypotName) };
    ...
    inline ResetHoneypotResponseBodyData& setNodeId(string nodeId) { DARABONBA_PTR_SET_VALUE(nodeId_, nodeId) };
    ...
    inline ResetHoneypotResponseBodyData& setPresetId(string presetId) { DARABONBA_PTR_SET_VALUE(presetId_, presetId) };
    ...
    inline ResetHoneypotResponseBodyData& setState(const vector<string> & state) { DARABONBA_PTR_SET_VALUE(state_, state) };
    inline ResetHoneypotResponseBodyData& setState(vector<string> && state) { DARABONBA_PTR_SET_RVALUE(state_, state) };
