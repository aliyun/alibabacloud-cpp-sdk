...
#ifndef ALIBABACLOUD_MODELS_GETSENSITIVEDEFINERULECONFIGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETSENSITIVEDEFINERULECONFIGRESPONSEBODY_HPP_
...
namespace Models
{
  class GetSensitiveDefineRuleConfigResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetSensitiveDefineRuleConfigResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSensitiveDefineRuleConfigResponseBody& obj) { 
    ...
    GetSensitiveDefineRuleConfigResponseBody() = default ;
    GetSensitiveDefineRuleConfigResponseBody(const GetSensitiveDefineRuleConfigResponseBody &) = default ;
    GetSensitiveDefineRuleConfigResponseBody(GetSensitiveDefineRuleConfigResponseBody &&) = default ;
    GetSensitiveDefineRuleConfigResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSensitiveDefineRuleConfigResponseBody() = default ;
    GetSensitiveDefineRuleConfigResponseBody& operator=(const GetSensitiveDefineRuleConfigResponseBody &) = default ;
    GetSensitiveDefineRuleConfigResponseBody& operator=(GetSensitiveDefineRuleConfigResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->enableNewRule_ == nullptr
        && this->id_ == nullptr && this->ruleCount_ == nullptr && this->ruleTree_ == nullptr && this->selectedCount_ == nullptr; };
      ...
      inline Data& setEnableNewRule(int32_t enableNewRule) { DARABONBA_PTR_SET_VALUE(enableNewRule_, enableNewRule) };
    ...
    inline GetSensitiveDefineRuleConfigResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetSensitiveDefineRuleConfigResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetSensitiveDefineRuleConfigResponseBody::Data) };
    inline GetSensitiveDefineRuleConfigResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetSensitiveDefineRuleConfigResponseBody::Data) };
    inline GetSensitiveDefineRuleConfigResponseBody& setData(const GetSensitiveDefineRuleConfigResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSensitiveDefineRuleConfigResponseBody& setData(GetSensitiveDefineRuleConfigResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetSensitiveDefineRuleConfigResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetSensitiveDefineRuleConfigResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetSensitiveDefineRuleConfigResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
