...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDynamicDictResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDynamicDictResponseBody) };
    inline DescribeDynamicDictResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDynamicDictResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDynamicDictResponseBody> body_ {};
  };
