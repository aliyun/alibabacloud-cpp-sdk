...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alias_ == nullptr
        && return this->on_ == nullptr && return this->subTypes_ == nullptr && return this->typeName_ == nullptr; };
    ...
    inline DescribeStrategyDetailResponseBodyStrategyRiskTypeWhiteListQueryResultList& setTypeName(string typeName) { DARABONBA_PTR_SET_VALUE(typeName_, typeName) };
