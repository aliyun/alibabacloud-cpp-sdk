...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Data& setCompleteMachine(int32_t completeMachine) { DARABONBA_PTR_SET_VALUE(completeMachine_, completeMachine) };
      ...
      inline Data& setSafeMachine(int32_t safeMachine) { DARABONBA_PTR_SET_VALUE(safeMachine_, safeMachine) };
      ...
      inline Data& setScanMachine(int32_t scanMachine) { DARABONBA_PTR_SET_VALUE(scanMachine_, scanMachine) };
      ...
      inline Data& setScanTime(int64_t scanTime) { DARABONBA_PTR_SET_VALUE(scanTime_, scanTime) };
      ...
      inline Data& setSuspiciousMachine(int32_t suspiciousMachine) { DARABONBA_PTR_SET_VALUE(suspiciousMachine_, suspiciousMachine) };
      ...
      inline Data& setUnCompleteMachine(int32_t unCompleteMachine) { DARABONBA_PTR_SET_VALUE(unCompleteMachine_, unCompleteMachine) };
    ...
    inline const GetVirusScanLatestTaskStatisticResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetVirusScanLatestTaskStatisticResponseBody::Data) };
    inline GetVirusScanLatestTaskStatisticResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetVirusScanLatestTaskStatisticResponseBody::Data) };
    inline GetVirusScanLatestTaskStatisticResponseBody& setData(const GetVirusScanLatestTaskStatisticResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetVirusScanLatestTaskStatisticResponseBody& setData(GetVirusScanLatestTaskStatisticResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
