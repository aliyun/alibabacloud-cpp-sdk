...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHoneypotAttackerSourceResponseBodyList> & list() const { DARABONBA_PTR_GET_CONST(list_, vector<ListHoneypotAttackerSourceResponseBodyList>) };
    inline vector<ListHoneypotAttackerSourceResponseBodyList> list() { DARABONBA_PTR_GET(list_, vector<ListHoneypotAttackerSourceResponseBodyList>) };
    inline ListHoneypotAttackerSourceResponseBody& setList(const vector<ListHoneypotAttackerSourceResponseBodyList> & list) { DARABONBA_PTR_SET_VALUE(list_, list) };
    inline ListHoneypotAttackerSourceResponseBody& setList(vector<ListHoneypotAttackerSourceResponseBodyList> && list) { DARABONBA_PTR_SET_RVALUE(list_, list) };
    ...
    inline const ListHoneypotAttackerSourceResponseBodyPageInfo & pageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, ListHoneypotAttackerSourceResponseBodyPageInfo) };
    inline ListHoneypotAttackerSourceResponseBodyPageInfo pageInfo() { DARABONBA_PTR_GET(pageInfo_, ListHoneypotAttackerSourceResponseBodyPageInfo) };
    inline ListHoneypotAttackerSourceResponseBody& setPageInfo(const ListHoneypotAttackerSourceResponseBodyPageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline ListHoneypotAttackerSourceResponseBody& setPageInfo(ListHoneypotAttackerSourceResponseBodyPageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListHoneypotAttackerSourceResponseBodyList>> list_ = nullptr;
    // The returned message.
    std::shared_ptr<string> message_ = nullptr;
    // The pagination information.
    std::shared_ptr<ListHoneypotAttackerSourceResponseBodyPageInfo> pageInfo_ = nullptr;
    // The request ID.
