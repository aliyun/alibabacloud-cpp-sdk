...
namespace Models
{
  ...
  public:
    ...
    inline const HandleSimilarSecurityEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, HandleSimilarSecurityEventsResponseBody) };
    inline HandleSimilarSecurityEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, HandleSimilarSecurityEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<HandleSimilarSecurityEventsResponseBody> body_ {};
  };
