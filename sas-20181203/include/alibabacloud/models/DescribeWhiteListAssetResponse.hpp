...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWhiteListAssetResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeWhiteListAssetResponseBody) };
    inline DescribeWhiteListAssetResponseBody body() { DARABONBA_PTR_GET(body_, DescribeWhiteListAssetResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeWhiteListAssetResponseBody> body_ = nullptr;
  };
