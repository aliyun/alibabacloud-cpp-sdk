...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMonitorAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMonitorAccountResponseBody) };
    inline DeleteMonitorAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMonitorAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMonitorAccountResponseBody> body_ {};
  };
