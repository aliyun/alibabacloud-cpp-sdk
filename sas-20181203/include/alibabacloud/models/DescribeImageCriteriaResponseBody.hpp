...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeImageCriteriaResponseBodyCriteriaList> & criteriaList() const { DARABONBA_PTR_GET_CONST(criteriaList_, vector<DescribeImageCriteriaResponseBodyCriteriaList>) };
    inline vector<DescribeImageCriteriaResponseBodyCriteriaList> criteriaList() { DARABONBA_PTR_GET(criteriaList_, vector<DescribeImageCriteriaResponseBodyCriteriaList>) };
    inline DescribeImageCriteriaResponseBody& setCriteriaList(const vector<DescribeImageCriteriaResponseBodyCriteriaList> & criteriaList) { DARABONBA_PTR_SET_VALUE(criteriaList_, criteriaList) };
    inline DescribeImageCriteriaResponseBody& setCriteriaList(vector<DescribeImageCriteriaResponseBodyCriteriaList> && criteriaList) { DARABONBA_PTR_SET_RVALUE(criteriaList_, criteriaList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeImageCriteriaResponseBodyCriteriaList>> criteriaList_ = nullptr;
    // The request ID.
