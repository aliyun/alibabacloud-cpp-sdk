...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getSupportRegion() const { DARABONBA_PTR_GET_CONST(supportRegion_, vector<string>) };
    inline vector<string> getSupportRegion() { DARABONBA_PTR_GET(supportRegion_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> supportRegion_ {};
  };
