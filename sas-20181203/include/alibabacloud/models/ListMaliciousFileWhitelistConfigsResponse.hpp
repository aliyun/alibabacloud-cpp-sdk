...
namespace Models
{
  ...
  public:
    ...
    inline const ListMaliciousFileWhitelistConfigsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMaliciousFileWhitelistConfigsResponseBody) };
    inline ListMaliciousFileWhitelistConfigsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMaliciousFileWhitelistConfigsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMaliciousFileWhitelistConfigsResponseBody> body_ {};
  };
