...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudVendorAccountAKListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCloudVendorAccountAKListResponseBody) };
    inline DescribeCloudVendorAccountAKListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCloudVendorAccountAKListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCloudVendorAccountAKListResponseBody> body_ {};
  };
