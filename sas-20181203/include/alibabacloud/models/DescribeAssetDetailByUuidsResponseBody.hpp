...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline AssetList& setAuthModifyTime(int64_t authModifyTime) { DARABONBA_PTR_SET_VALUE(authModifyTime_, authModifyTime) };
      ...
      inline AssetList& setAuthVersion(int32_t authVersion) { DARABONBA_PTR_SET_VALUE(authVersion_, authVersion) };
      ...
      inline AssetList& setBind(bool bind) { DARABONBA_PTR_SET_VALUE(bind_, bind) };
      ...
      inline AssetList& setClientStatus(string clientStatus) { DARABONBA_PTR_SET_VALUE(clientStatus_, clientStatus) };
      ...
      inline AssetList& setClientVersion(string clientVersion) { DARABONBA_PTR_SET_VALUE(clientVersion_, clientVersion) };
      ...
      inline AssetList& setCpu(int32_t cpu) { DARABONBA_PTR_SET_VALUE(cpu_, cpu) };
      ...
      inline AssetList& setCpuInfo(string cpuInfo) { DARABONBA_PTR_SET_VALUE(cpuInfo_, cpuInfo) };
      ...
      inline AssetList& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
      ...
      inline const vector<string> & getDiskInfoList() const { DARABONBA_PTR_GET_CONST(diskInfoList_, vector<string>) };
      inline vector<string> getDiskInfoList() { DARABONBA_PTR_GET(diskInfoList_, vector<string>) };
      inline AssetList& setDiskInfoList(const vector<string> & diskInfoList) { DARABONBA_PTR_SET_VALUE(diskInfoList_, diskInfoList) };
      inline AssetList& setDiskInfoList(vector<string> && diskInfoList) { DARABONBA_PTR_SET_RVALUE(diskInfoList_, diskInfoList) };
      ...
      inline AssetList& setFlag(int32_t flag) { DARABONBA_PTR_SET_VALUE(flag_, flag) };
      ...
      inline AssetList& setGroupTrace(string groupTrace) { DARABONBA_PTR_SET_VALUE(groupTrace_, groupTrace) };
      ...
      inline AssetList& setHostName(string hostName) { DARABONBA_PTR_SET_VALUE(hostName_, hostName) };
      ...
      inline AssetList& setIpList(const vector<string> & ipList) { DARABONBA_PTR_SET_VALUE(ipList_, ipList) };
      inline AssetList& setIpList(vector<string> && ipList) { DARABONBA_PTR_SET_RVALUE(ipList_, ipList) };
      ...
      inline AssetList& setKernel(string kernel) { DARABONBA_PTR_SET_VALUE(kernel_, kernel) };
      ...
      inline AssetList& setMacList(const vector<string> & macList) { DARABONBA_PTR_SET_VALUE(macList_, macList) };
      inline AssetList& setMacList(vector<string> && macList) { DARABONBA_PTR_SET_RVALUE(macList_, macList) };
      ...
      inline AssetList& setMem(int32_t mem) { DARABONBA_PTR_SET_VALUE(mem_, mem) };
      ...
      inline AssetList& setMemory(int64_t memory) { DARABONBA_PTR_SET_VALUE(memory_, memory) };
      ...
      inline AssetList& setOs(string os) { DARABONBA_PTR_SET_VALUE(os_, os) };
      ...
      inline AssetList& setOsDetail(string osDetail) { DARABONBA_PTR_SET_VALUE(osDetail_, osDetail) };
      ...
      inline AssetList& setOsName(string osName) { DARABONBA_PTR_SET_VALUE(osName_, osName) };
      ...
      inline AssetList& setRegion(string region) { DARABONBA_PTR_SET_VALUE(region_, region) };
      ...
      inline AssetList& setRegionName(string regionName) { DARABONBA_PTR_SET_VALUE(regionName_, regionName) };
      ...
      inline AssetList& setSysInfo(string sysInfo) { DARABONBA_PTR_SET_VALUE(sysInfo_, sysInfo) };
      ...
      inline AssetList& setTag(string tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
      ...
      inline AssetList& setVpcInstanceId(string vpcInstanceId) { DARABONBA_PTR_SET_VALUE(vpcInstanceId_, vpcInstanceId) };
    ...
    protected:
      ...
      shared_ptr<vector<string>> diskInfoList_ {};
    ...
    inline const vector<DescribeAssetDetailByUuidsResponseBody::AssetList> & getAssetList() const { DARABONBA_PTR_GET_CONST(assetList_, vector<DescribeAssetDetailByUuidsResponseBody::AssetList>) };
    inline vector<DescribeAssetDetailByUuidsResponseBody::AssetList> getAssetList() { DARABONBA_PTR_GET(assetList_, vector<DescribeAssetDetailByUuidsResponseBody::AssetList>) };
    inline DescribeAssetDetailByUuidsResponseBody& setAssetList(const vector<DescribeAssetDetailByUuidsResponseBody::AssetList> & assetList) { DARABONBA_PTR_SET_VALUE(assetList_, assetList) };
    inline DescribeAssetDetailByUuidsResponseBody& setAssetList(vector<DescribeAssetDetailByUuidsResponseBody::AssetList> && assetList) { DARABONBA_PTR_SET_RVALUE(assetList_, assetList) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeAssetDetailByUuidsResponseBody::AssetList>> assetList_ {};
