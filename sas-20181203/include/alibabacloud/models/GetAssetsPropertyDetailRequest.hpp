...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->biz_ != nullptr
        && this->currentPage_ != nullptr && this->itemName_ != nullptr && this->lang_ != nullptr && this->pageSize_ != nullptr && this->remark_ != nullptr
        && this->searchCriteriaList_ != nullptr && this->uuid_ != nullptr; };
    // biz Field Functions 
