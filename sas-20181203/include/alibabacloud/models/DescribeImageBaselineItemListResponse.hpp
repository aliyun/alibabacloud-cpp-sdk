...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageBaselineItemListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeImageBaselineItemListResponseBody) };
    inline DescribeImageBaselineItemListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeImageBaselineItemListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeImageBaselineItemListResponseBody> body_ {};
  };
