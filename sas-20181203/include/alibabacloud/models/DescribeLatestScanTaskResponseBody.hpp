...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->lastCheckTime_ != nullptr
        && this->requestId_ != nullptr && this->riskNum_ != nullptr && this->targetInfo_ != nullptr && this->uuids_ != nullptr; };
