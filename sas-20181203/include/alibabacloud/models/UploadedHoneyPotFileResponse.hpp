...
namespace Models
{
  ...
  public:
    ...
    inline const UploadedHoneyPotFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UploadedHoneyPotFileResponseBody) };
    inline UploadedHoneyPotFileResponseBody getBody() { DARABONBA_PTR_GET(body_, UploadedHoneyPotFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UploadedHoneyPotFileResponseBody> body_ {};
  };
