...
namespace Models
{
  ...
  public:
    ...
    inline const ListPodRiskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPodRiskResponseBody) };
    inline ListPodRiskResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPodRiskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPodRiskResponseBody> body_ {};
  };
