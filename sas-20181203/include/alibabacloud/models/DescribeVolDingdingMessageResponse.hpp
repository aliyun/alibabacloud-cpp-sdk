...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVolDingdingMessageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVolDingdingMessageResponseBody) };
    inline DescribeVolDingdingMessageResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVolDingdingMessageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVolDingdingMessageResponseBody> body_ {};
  };
