...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeScreenScoreThreadResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeScreenScoreThreadResponseBody) };
    inline DescribeScreenScoreThreadResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeScreenScoreThreadResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeScreenScoreThreadResponseBody> body_ {};
  };
