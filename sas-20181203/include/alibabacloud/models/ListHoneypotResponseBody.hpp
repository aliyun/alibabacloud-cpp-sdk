...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHoneypotResponseBodyList> & list() const { DARABONBA_PTR_GET_CONST(list_, vector<ListHoneypotResponseBodyList>) };
    inline vector<ListHoneypotResponseBodyList> list() { DARABONBA_PTR_GET(list_, vector<ListHoneypotResponseBodyList>) };
    inline ListHoneypotResponseBody& setList(const vector<ListHoneypotResponseBodyList> & list) { DARABONBA_PTR_SET_VALUE(list_, list) };
    inline ListHoneypotResponseBody& setList(vector<ListHoneypotResponseBodyList> && list) { DARABONBA_PTR_SET_RVALUE(list_, list) };
    ...
    inline const ListHoneypotResponseBodyPageInfo & pageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, ListHoneypotResponseBodyPageInfo) };
    inline ListHoneypotResponseBodyPageInfo pageInfo() { DARABONBA_PTR_GET(pageInfo_, ListHoneypotResponseBodyPageInfo) };
    inline ListHoneypotResponseBody& setPageInfo(const ListHoneypotResponseBodyPageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline ListHoneypotResponseBody& setPageInfo(ListHoneypotResponseBodyPageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListHoneypotResponseBodyList>> list_ = nullptr;
    // The error message returned.
    std::shared_ptr<string> message_ = nullptr;
    // The pagination information.
    std::shared_ptr<ListHoneypotResponseBodyPageInfo> pageInfo_ = nullptr;
