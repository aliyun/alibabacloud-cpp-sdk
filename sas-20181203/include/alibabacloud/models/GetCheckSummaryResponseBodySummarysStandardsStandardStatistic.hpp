...
#ifndef ALIBABACLOUD_MODELS_GETCHECKSUMMARYRESPONSEBODYSUMMARYSSTANDARDSSTANDARDSTATISTIC_HPP_
#define ALIBABACLOUD_MODELS_GETCHECKSUMMARYRESPONSEBODYSUMMARYSSTANDARDSSTANDARDSTATISTIC_HPP_
...
namespace Models
{
  class GetCheckSummaryResponseBodySummarysStandardsStandardStatistic : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& obj) { 
    ...
    GetCheckSummaryResponseBodySummarysStandardsStandardStatistic() = default ;
    GetCheckSummaryResponseBodySummarysStandardsStandardStatistic(const GetCheckSummaryResponseBodySummarysStandardsStandardStatistic &) = default ;
    GetCheckSummaryResponseBodySummarysStandardsStandardStatistic(GetCheckSummaryResponseBodySummarysStandardsStandardStatistic &&) = default ;
    GetCheckSummaryResponseBodySummarysStandardsStandardStatistic(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetCheckSummaryResponseBodySummarysStandardsStandardStatistic() = default ;
    GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& operator=(const GetCheckSummaryResponseBodySummarysStandardsStandardStatistic &) = default ;
    GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& operator=(GetCheckSummaryResponseBodySummarysStandardsStandardStatistic &&) = default ;
    ...
    inline GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& setNotCheckCount(int32_t notCheckCount) { DARABONBA_PTR_SET_VALUE(notCheckCount_, notCheckCount) };
    ...
    inline GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& setNotCheckHighCount(int32_t notCheckHighCount) { DARABONBA_PTR_SET_VALUE(notCheckHighCount_, notCheckHighCount) };
    ...
    inline GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& setNotCheckLowCount(int32_t notCheckLowCount) { DARABONBA_PTR_SET_VALUE(notCheckLowCount_, notCheckLowCount) };
    ...
    inline GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& setNotCheckMediumCount(int32_t notCheckMediumCount) { DARABONBA_PTR_SET_VALUE(notCheckMediumCount_, notCheckMediumCount) };
    ...
    inline GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& setNotPassCount(int32_t notPassCount) { DARABONBA_PTR_SET_VALUE(notPassCount_, notPassCount) };
    ...
    inline GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& setNotPassHighCount(int32_t notPassHighCount) { DARABONBA_PTR_SET_VALUE(notPassHighCount_, notPassHighCount) };
    ...
    inline GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& setNotPassLowCount(int32_t notPassLowCount) { DARABONBA_PTR_SET_VALUE(notPassLowCount_, notPassLowCount) };
    ...
    inline GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& setNotPassMediumCount(int32_t notPassMediumCount) { DARABONBA_PTR_SET_VALUE(notPassMediumCount_, notPassMediumCount) };
    ...
    inline GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& setPassCount(int32_t passCount) { DARABONBA_PTR_SET_VALUE(passCount_, passCount) };
    ...
    inline GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& setPassHighCount(int32_t passHighCount) { DARABONBA_PTR_SET_VALUE(passHighCount_, passHighCount) };
    ...
    inline GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& setPassLowCount(int32_t passLowCount) { DARABONBA_PTR_SET_VALUE(passLowCount_, passLowCount) };
    ...
    inline GetCheckSummaryResponseBodySummarysStandardsStandardStatistic& setPassMediumCount(int32_t passMediumCount) { DARABONBA_PTR_SET_VALUE(passMediumCount_, passMediumCount) };
