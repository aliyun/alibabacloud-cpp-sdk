...
#ifndef ALIBABACLOUD_MODELS_GETCHECKSCOPECONFIGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETCHECKSCOPECONFIGRESPONSEBODY_HPP_
...
namespace Models
{
  class GetCheckScopeConfigResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetCheckScopeConfigResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetCheckScopeConfigResponseBody& obj) { 
    ...
    GetCheckScopeConfigResponseBody() = default ;
    GetCheckScopeConfigResponseBody(const GetCheckScopeConfigResponseBody &) = default ;
    GetCheckScopeConfigResponseBody(GetCheckScopeConfigResponseBody &&) = default ;
    GetCheckScopeConfigResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetCheckScopeConfigResponseBody() = default ;
    GetCheckScopeConfigResponseBody& operator=(const GetCheckScopeConfigResponseBody &) = default ;
    GetCheckScopeConfigResponseBody& operator=(GetCheckScopeConfigResponseBody &&) = default ;
    ...
    inline GetCheckScopeConfigResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetCheckScopeConfigResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetCheckScopeConfigResponseBody::Data) };
    inline GetCheckScopeConfigResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetCheckScopeConfigResponseBody::Data) };
    inline GetCheckScopeConfigResponseBody& setData(const GetCheckScopeConfigResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCheckScopeConfigResponseBody& setData(GetCheckScopeConfigResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetCheckScopeConfigResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetCheckScopeConfigResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetCheckScopeConfigResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    // The returned data.
    shared_ptr<GetCheckScopeConfigResponseBody::Data> data_ {};
