...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListUninstallAegisMachinesResponseBodyMachineList> & machineList() const { DARABONBA_PTR_GET_CONST(machineList_, vector<ListUninstallAegisMachinesResponseBodyMachineList>) };
    inline vector<ListUninstallAegisMachinesResponseBodyMachineList> machineList() { DARABONBA_PTR_GET(machineList_, vector<ListUninstallAegisMachinesResponseBodyMachineList>) };
    inline ListUninstallAegisMachinesResponseBody& setMachineList(const vector<ListUninstallAegisMachinesResponseBodyMachineList> & machineList) { DARABONBA_PTR_SET_VALUE(machineList_, machineList) };
    inline ListUninstallAegisMachinesResponseBody& setMachineList(vector<ListUninstallAegisMachinesResponseBodyMachineList> && machineList) { DARABONBA_PTR_SET_RVALUE(machineList_, machineList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListUninstallAegisMachinesResponseBodyMachineList>> machineList_ = nullptr;
