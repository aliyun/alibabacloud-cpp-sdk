...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentPage_ == nullptr
        && return this->imageName_ == nullptr && return this->label_ == nullptr && return this->pageSize_ == nullptr && return this->strategyName_ == nullptr; };
    ...
    inline const vector<string> & strategyName() const { DARABONBA_PTR_GET_CONST(strategyName_, vector<string>) };
    inline vector<string> strategyName() { DARABONBA_PTR_GET(strategyName_, vector<string>) };
  ...
  protected:
    ...
    // The rule names.
    std::shared_ptr<vector<string>> strategyName_ = nullptr;
  };
