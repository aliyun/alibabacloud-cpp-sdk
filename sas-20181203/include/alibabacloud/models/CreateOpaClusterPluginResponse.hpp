...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOpaClusterPluginResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateOpaClusterPluginResponseBody) };
    inline CreateOpaClusterPluginResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateOpaClusterPluginResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateOpaClusterPluginResponseBody> body_ {};
  };
