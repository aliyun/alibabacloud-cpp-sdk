...
namespace Models
{
  ...
  public:
    ...
    inline const GetInterceptionRuleDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInterceptionRuleDetailResponseBody) };
    inline GetInterceptionRuleDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInterceptionRuleDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInterceptionRuleDetailResponseBody> body_ {};
  };
