...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->count_ == nullptr && return this->data_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr
    ...
    inline const vector<ListCloudVendorRegionsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListCloudVendorRegionsResponseBodyData>) };
    inline vector<ListCloudVendorRegionsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListCloudVendorRegionsResponseBodyData>) };
    inline ListCloudVendorRegionsResponseBody& setData(const vector<ListCloudVendorRegionsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCloudVendorRegionsResponseBody& setData(vector<ListCloudVendorRegionsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListCloudVendorRegionsResponseBodyData>> data_ = nullptr;
