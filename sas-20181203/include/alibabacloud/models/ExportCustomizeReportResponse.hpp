...
namespace Models
{
  ...
  public:
    ...
    inline const ExportCustomizeReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExportCustomizeReportResponseBody) };
    inline ExportCustomizeReportResponseBody getBody() { DARABONBA_PTR_GET(body_, ExportCustomizeReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExportCustomizeReportResponseBody> body_ {};
  };
