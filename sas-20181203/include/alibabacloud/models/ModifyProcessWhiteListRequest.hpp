...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->lang_ == nullptr
        && return this->md5s_ == nullptr && return this->sourceIp_ == nullptr && return this->status_ == nullptr && return this->strategyId_ == nullptr; };
    ...
    inline string md5s() const { DARABONBA_PTR_GET_DEFAULT(md5s_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> md5s_ = nullptr;
