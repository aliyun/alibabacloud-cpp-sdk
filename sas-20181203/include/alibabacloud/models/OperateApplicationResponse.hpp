...
namespace Models
{
  ...
  public:
    ...
    inline const OperateApplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OperateApplicationResponseBody) };
    inline OperateApplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, OperateApplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OperateApplicationResponseBody> body_ {};
  };
