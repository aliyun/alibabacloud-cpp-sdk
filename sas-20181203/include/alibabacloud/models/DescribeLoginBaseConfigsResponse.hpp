...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLoginBaseConfigsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLoginBaseConfigsResponseBody) };
    inline DescribeLoginBaseConfigsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLoginBaseConfigsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLoginBaseConfigsResponseBody> body_ {};
  };
