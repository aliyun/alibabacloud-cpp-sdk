...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cmdline_ == nullptr
        && this->currentPage_ == nullptr && this->extend_ == nullptr && this->name_ == nullptr && this->nextToken_ == nullptr && this->pageSize_ == nullptr
        && this->procTimeEnd_ == nullptr && this->procTimeStart_ == nullptr && this->remark_ == nullptr && this->resourceDirectoryAccountId_ == nullptr && this->useNextToken_ == nullptr
    ...
    inline int64_t getProcTimeEnd() const { DARABONBA_PTR_GET_DEFAULT(procTimeEnd_, 0L) };
    ...
    inline int64_t getProcTimeStart() const { DARABONBA_PTR_GET_DEFAULT(procTimeStart_, 0L) };
  ...
  protected:
    ...
    shared_ptr<int64_t> procTimeEnd_ {};
    // The timestamp when the process starts. Unit: milliseconds.
    shared_ptr<int64_t> procTimeStart_ {};
