...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCycleTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCycleTaskResponseBody) };
    inline CreateCycleTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCycleTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCycleTaskResponseBody> body_ {};
  };
