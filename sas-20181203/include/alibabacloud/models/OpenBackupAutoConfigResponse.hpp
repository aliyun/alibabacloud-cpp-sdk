...
namespace Models
{
  ...
  public:
    ...
    inline const OpenBackupAutoConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenBackupAutoConfigResponseBody) };
    inline OpenBackupAutoConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenBackupAutoConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenBackupAutoConfigResponseBody> body_ {};
  };
