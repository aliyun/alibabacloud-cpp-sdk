...
#ifndef ALIBABACLOUD_MODELS_UPDATEOPASTRATEGYNEWREQUESTSCOPES_HPP_
#define ALIBABACLOUD_MODELS_UPDATEOPASTRATEGYNEWREQUESTSCOPES_HPP_
...
namespace Models
{
  class UpdateOpaStrategyNewRequestScopes : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateOpaStrategyNewRequestScopes& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateOpaStrategyNewRequestScopes& obj) { 
    ...
    UpdateOpaStrategyNewRequestScopes() = default ;
    UpdateOpaStrategyNewRequestScopes(const UpdateOpaStrategyNewRequestScopes &) = default ;
    UpdateOpaStrategyNewRequestScopes(UpdateOpaStrategyNewRequestScopes &&) = default ;
    UpdateOpaStrategyNewRequestScopes(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateOpaStrategyNewRequestScopes() = default ;
    UpdateOpaStrategyNewRequestScopes& operator=(const UpdateOpaStrategyNewRequestScopes &) = default ;
    UpdateOpaStrategyNewRequestScopes& operator=(UpdateOpaStrategyNewRequestScopes &&) = default ;
    ...
    inline UpdateOpaStrategyNewRequestScopes& setAckPolicyInstanceId(string ackPolicyInstanceId) { DARABONBA_PTR_SET_VALUE(ackPolicyInstanceId_, ackPolicyInstanceId) };
    ...
    inline UpdateOpaStrategyNewRequestScopes& setAllNamespace(int32_t allNamespace) { DARABONBA_PTR_SET_VALUE(allNamespace_, allNamespace) };
    ...
    inline UpdateOpaStrategyNewRequestScopes& setClusterId(string clusterId) { DARABONBA_PTR_SET_VALUE(clusterId_, clusterId) };
    ...
    inline UpdateOpaStrategyNewRequestScopes& setNamespaceList(const vector<string> & namespaceList) { DARABONBA_PTR_SET_VALUE(namespaceList_, namespaceList) };
    inline UpdateOpaStrategyNewRequestScopes& setNamespaceList(vector<string> && namespaceList) { DARABONBA_PTR_SET_RVALUE(namespaceList_, namespaceList) };
