...
namespace Models
{
  ...
  public:
    ...
    inline const ListContainerDefenseRuleClustersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListContainerDefenseRuleClustersResponseBody) };
    inline ListContainerDefenseRuleClustersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListContainerDefenseRuleClustersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListContainerDefenseRuleClustersResponseBody> body_ {};
  };
