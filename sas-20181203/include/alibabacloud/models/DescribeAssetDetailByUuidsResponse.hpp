...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAssetDetailByUuidsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAssetDetailByUuidsResponseBody) };
    inline DescribeAssetDetailByUuidsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAssetDetailByUuidsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAssetDetailByUuidsResponseBody> body_ {};
  };
