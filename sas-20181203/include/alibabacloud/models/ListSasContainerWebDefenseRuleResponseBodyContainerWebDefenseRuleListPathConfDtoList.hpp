...
#ifndef ALIBABACLOUD_MODELS_LISTSASCONTAINERWEBDEFENSERULERESPONSEBODYCONTAINERWEBDEFENSERULELISTPATHCONFDTOLIST_HPP_
#define ALIBABACLOUD_MODELS_LISTSASCONTAINERWEBDEFENSERULERESPONSEBODYCONTAINERWEBDEFENSERULELISTPATHCONFDTOLIST_HPP_
...
namespace Models
{
  class ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList& obj) { 
    ...
    ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList() = default ;
    ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList(const ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList &) = default ;
    ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList(ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList &&) = default ;
    ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList() = default ;
    ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList& operator=(const ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList &) = default ;
    ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList& operator=(ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList &&) = default ;
    ...
    inline ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList& setBackupPath(string backupPath) { DARABONBA_PTR_SET_VALUE(backupPath_, backupPath) };
    ...
    inline ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList& setDefenseMode(string defenseMode) { DARABONBA_PTR_SET_VALUE(defenseMode_, defenseMode) };
    ...
    inline ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList& setDefensePath(string defensePath) { DARABONBA_PTR_SET_VALUE(defensePath_, defensePath) };
    ...
    inline ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList& setExcludeFile(string excludeFile) { DARABONBA_PTR_SET_VALUE(excludeFile_, excludeFile) };
    ...
    inline ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList& setExcludeFilePath(string excludeFilePath) { DARABONBA_PTR_SET_VALUE(excludeFilePath_, excludeFilePath) };
    ...
    inline ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList& setExcludeFileType(string excludeFileType) { DARABONBA_PTR_SET_VALUE(excludeFileType_, excludeFileType) };
    ...
    inline ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList& setGuardType(int32_t guardType) { DARABONBA_PTR_SET_VALUE(guardType_, guardType) };
    ...
    inline ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList& setIncludeFile(string includeFile) { DARABONBA_PTR_SET_VALUE(includeFile_, includeFile) };
    ...
    inline ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList& setIncludeFileType(string includeFileType) { DARABONBA_PTR_SET_VALUE(includeFileType_, includeFileType) };
    ...
    inline ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList& setProcessPathList(const vector<string> & processPathList) { DARABONBA_PTR_SET_VALUE(processPathList_, processPathList) };
    inline ListSasContainerWebDefenseRuleResponseBodyContainerWebDefenseRuleListPathConfDTOList& setProcessPathList(vector<string> && processPathList) { DARABONBA_PTR_SET_RVALUE(processPathList_, processPathList) };
