...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSuspEventExportInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSuspEventExportInfoResponseBody) };
    inline DescribeSuspEventExportInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSuspEventExportInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSuspEventExportInfoResponseBody> body_ {};
  };
