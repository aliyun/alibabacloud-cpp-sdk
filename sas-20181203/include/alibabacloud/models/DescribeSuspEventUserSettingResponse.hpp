...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSuspEventUserSettingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSuspEventUserSettingResponseBody) };
    inline DescribeSuspEventUserSettingResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSuspEventUserSettingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSuspEventUserSettingResponseBody> body_ {};
  };
