...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteInterceptionRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteInterceptionRuleResponseBody) };
    inline DeleteInterceptionRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteInterceptionRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteInterceptionRuleResponseBody> body_ {};
  };
