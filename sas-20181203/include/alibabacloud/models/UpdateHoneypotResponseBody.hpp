...
#ifndef ALIBABACLOUD_MODELS_UPDATEHONEYPOTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATEHONEYPOTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateHoneypotResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateHoneypotResponseBody& obj) { 
    ...
    UpdateHoneypotResponseBody() = default ;
    UpdateHoneypotResponseBody(const UpdateHoneypotResponseBody &) = default ;
    UpdateHoneypotResponseBody(UpdateHoneypotResponseBody &&) = default ;
    UpdateHoneypotResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateHoneypotResponseBody() = default ;
    UpdateHoneypotResponseBody& operator=(const UpdateHoneypotResponseBody &) = default ;
    UpdateHoneypotResponseBody& operator=(UpdateHoneypotResponseBody &&) = default ;
    ...
    inline UpdateHoneypotResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const UpdateHoneypotResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateHoneypotResponseBody::Data) };
    inline UpdateHoneypotResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateHoneypotResponseBody::Data) };
    inline UpdateHoneypotResponseBody& setData(const UpdateHoneypotResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateHoneypotResponseBody& setData(UpdateHoneypotResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UpdateHoneypotResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline UpdateHoneypotResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UpdateHoneypotResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline UpdateHoneypotResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    shared_ptr<UpdateHoneypotResponseBody::Data> data_ {};
