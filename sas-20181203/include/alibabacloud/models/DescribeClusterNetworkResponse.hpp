...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClusterNetworkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeClusterNetworkResponseBody) };
    inline DescribeClusterNetworkResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeClusterNetworkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeClusterNetworkResponseBody> body_ {};
  };
