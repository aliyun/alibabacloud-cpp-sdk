...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRiskCheckItemResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRiskCheckItemResultResponseBody) };
    inline DescribeRiskCheckItemResultResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRiskCheckItemResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRiskCheckItemResultResponseBody> body_ {};
  };
