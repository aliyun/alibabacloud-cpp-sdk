...
namespace Models
{
  ...
  public:
    ...
    inline const OperateVulsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OperateVulsResponseBody) };
    inline OperateVulsResponseBody getBody() { DARABONBA_PTR_GET(body_, OperateVulsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OperateVulsResponseBody> body_ {};
  };
