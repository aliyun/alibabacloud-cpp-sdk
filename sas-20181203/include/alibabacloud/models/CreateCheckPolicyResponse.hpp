...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCheckPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCheckPolicyResponseBody) };
    inline CreateCheckPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCheckPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCheckPolicyResponseBody> body_ {};
  };
