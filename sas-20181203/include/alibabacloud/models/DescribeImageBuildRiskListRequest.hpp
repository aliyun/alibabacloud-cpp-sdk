...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->criteria_ == nullptr
        && return this->criteriaType_ == nullptr && return this->currentPage_ == nullptr && return this->lang_ == nullptr && return this->pageSize_ == nullptr && return this->riskLevel_ == nullptr; };
