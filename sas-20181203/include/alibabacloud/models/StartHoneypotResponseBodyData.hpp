...
#ifndef ALIBABACLOUD_MODELS_STARTHONEYPOTRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_STARTHONEYPOTRESPONSEBODYDATA_HPP_
...
namespace Models
{
  class StartHoneypotResponseBodyData : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const StartHoneypotResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartHoneypotResponseBodyData& obj) { 
    ...
    StartHoneypotResponseBodyData() = default ;
    StartHoneypotResponseBodyData(const StartHoneypotResponseBodyData &) = default ;
    StartHoneypotResponseBodyData(StartHoneypotResponseBodyData &&) = default ;
    StartHoneypotResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartHoneypotResponseBodyData() = default ;
    StartHoneypotResponseBodyData& operator=(const StartHoneypotResponseBodyData &) = default ;
    StartHoneypotResponseBodyData& operator=(StartHoneypotResponseBodyData &&) = default ;
    ...
    inline StartHoneypotResponseBodyData& setControlNodeName(string controlNodeName) { DARABONBA_PTR_SET_VALUE(controlNodeName_, controlNodeName) };
    ...
    inline StartHoneypotResponseBodyData& setHoneypotId(string honeypotId) { DARABONBA_PTR_SET_VALUE(honeypotId_, honeypotId) };
    ...
    inline StartHoneypotResponseBodyData& setHoneypotImageDisplayName(string honeypotImageDisplayName) { DARABONBA_PTR_SET_VALUE(honeypotImageDisplayName_, honeypotImageDisplayName) };
    ...
    inline StartHoneypotResponseBodyData& setHoneypotImageName(string honeypotImageName) { DARABONBA_PTR_SET_VALUE(honeypotImageName_, honeypotImageName) };
    ...
    inline StartHoneypotResponseBodyData& setHoneypotName(string honeypotName) { DARABONBA_PTR_SET_VALUE(honeypotName_, honeypotName) };
    ...
    inline StartHoneypotResponseBodyData& setNodeId(string nodeId) { DARABONBA_PTR_SET_VALUE(nodeId_, nodeId) };
    ...
    inline StartHoneypotResponseBodyData& setPresetId(string presetId) { DARABONBA_PTR_SET_VALUE(presetId_, presetId) };
    ...
    inline StartHoneypotResponseBodyData& setState(const vector<string> & state) { DARABONBA_PTR_SET_VALUE(state_, state) };
    inline StartHoneypotResponseBodyData& setState(vector<string> && state) { DARABONBA_PTR_SET_RVALUE(state_, state) };
