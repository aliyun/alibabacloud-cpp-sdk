...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSoarStrategyTaskDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSoarStrategyTaskDetailResponseBody) };
    inline DescribeSoarStrategyTaskDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSoarStrategyTaskDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSoarStrategyTaskDetailResponseBody> body_ {};
  };
