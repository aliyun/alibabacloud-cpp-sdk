...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->elementType_ != nullptr
        && this->nodeDetail_ != nullptr && this->nodeName_ != nullptr && this->nodeType_ != nullptr && this->nodeUuid_ != nullptr && this->sensitiveAssetFlag_ != nullptr; };
