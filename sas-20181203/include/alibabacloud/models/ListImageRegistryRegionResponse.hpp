...
namespace Models
{
  ...
  public:
    ...
    inline const ListImageRegistryRegionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListImageRegistryRegionResponseBody) };
    inline ListImageRegistryRegionResponseBody getBody() { DARABONBA_PTR_GET(body_, ListImageRegistryRegionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListImageRegistryRegionResponseBody> body_ {};
  };
