...
#ifndef ALIBABACLOUD_MODELS_CREATEUNIBACKUPPOLICYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEUNIBACKUPPOLICYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateUniBackupPolicyRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateUniBackupPolicyRequest& obj) { 
    ...
    CreateUniBackupPolicyRequest() = default ;
    CreateUniBackupPolicyRequest(const CreateUniBackupPolicyRequest &) = default ;
    CreateUniBackupPolicyRequest(CreateUniBackupPolicyRequest &&) = default ;
    CreateUniBackupPolicyRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateUniBackupPolicyRequest() = default ;
    CreateUniBackupPolicyRequest& operator=(const CreateUniBackupPolicyRequest &) = default ;
    CreateUniBackupPolicyRequest& operator=(CreateUniBackupPolicyRequest &&) = default ;
