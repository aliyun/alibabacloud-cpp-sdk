...
namespace Models
{
  ...
  public:
    ...
    inline const ListPrivateRegistryTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPrivateRegistryTypeResponseBody) };
    inline ListPrivateRegistryTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPrivateRegistryTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPrivateRegistryTypeResponseBody> body_ {};
  };
