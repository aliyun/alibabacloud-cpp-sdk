...
namespace Models
{
  ...
  public:
    ...
    inline const AddCloudVendorTrialConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddCloudVendorTrialConfigResponseBody) };
    inline AddCloudVendorTrialConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, AddCloudVendorTrialConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddCloudVendorTrialConfigResponseBody> body_ {};
  };
