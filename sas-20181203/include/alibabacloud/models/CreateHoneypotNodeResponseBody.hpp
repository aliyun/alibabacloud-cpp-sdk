...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->honeypotNode_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const CreateHoneypotNodeResponseBodyHoneypotNode & honeypotNode() const { DARABONBA_PTR_GET_CONST(honeypotNode_, CreateHoneypotNodeResponseBodyHoneypotNode) };
    inline CreateHoneypotNodeResponseBodyHoneypotNode honeypotNode() { DARABONBA_PTR_GET(honeypotNode_, CreateHoneypotNodeResponseBodyHoneypotNode) };
    inline CreateHoneypotNodeResponseBody& setHoneypotNode(const CreateHoneypotNodeResponseBodyHoneypotNode & honeypotNode) { DARABONBA_PTR_SET_VALUE(honeypotNode_, honeypotNode) };
    inline CreateHoneypotNodeResponseBody& setHoneypotNode(CreateHoneypotNodeResponseBodyHoneypotNode && honeypotNode) { DARABONBA_PTR_SET_RVALUE(honeypotNode_, honeypotNode) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<CreateHoneypotNodeResponseBodyHoneypotNode> honeypotNode_ = nullptr;
