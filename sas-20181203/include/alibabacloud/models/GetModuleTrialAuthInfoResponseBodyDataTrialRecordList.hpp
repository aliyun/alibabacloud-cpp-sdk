...
#ifndef ALIBABACLOUD_MODELS_GETMODULETRIALAUTHINFORESPONSEBODYDATATRIALRECORDLIST_HPP_
#define ALIBABACLOUD_MODELS_GETMODULETRIALAUTHINFORESPONSEBODYDATATRIALRECORDLIST_HPP_
...
namespace Models
{
  class GetModuleTrialAuthInfoResponseBodyDataTrialRecordList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetModuleTrialAuthInfoResponseBodyDataTrialRecordList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetModuleTrialAuthInfoResponseBodyDataTrialRecordList& obj) { 
    ...
    GetModuleTrialAuthInfoResponseBodyDataTrialRecordList() = default ;
    GetModuleTrialAuthInfoResponseBodyDataTrialRecordList(const GetModuleTrialAuthInfoResponseBodyDataTrialRecordList &) = default ;
    GetModuleTrialAuthInfoResponseBodyDataTrialRecordList(GetModuleTrialAuthInfoResponseBodyDataTrialRecordList &&) = default ;
    GetModuleTrialAuthInfoResponseBodyDataTrialRecordList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetModuleTrialAuthInfoResponseBodyDataTrialRecordList() = default ;
    GetModuleTrialAuthInfoResponseBodyDataTrialRecordList& operator=(const GetModuleTrialAuthInfoResponseBodyDataTrialRecordList &) = default ;
    GetModuleTrialAuthInfoResponseBodyDataTrialRecordList& operator=(GetModuleTrialAuthInfoResponseBodyDataTrialRecordList &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->authLimit_ != nullptr
    ...
    inline GetModuleTrialAuthInfoResponseBodyDataTrialRecordList& setAuthLimit(int64_t authLimit) { DARABONBA_PTR_SET_VALUE(authLimit_, authLimit) };
    ...
    inline GetModuleTrialAuthInfoResponseBodyDataTrialRecordList& setAuthLimitList(string authLimitList) { DARABONBA_PTR_SET_VALUE(authLimitList_, authLimitList) };
    ...
    inline GetModuleTrialAuthInfoResponseBodyDataTrialRecordList& setGmtEnd(int64_t gmtEnd) { DARABONBA_PTR_SET_VALUE(gmtEnd_, gmtEnd) };
    ...
    inline GetModuleTrialAuthInfoResponseBodyDataTrialRecordList& setGmtStart(int64_t gmtStart) { DARABONBA_PTR_SET_VALUE(gmtStart_, gmtStart) };
    ...
    inline GetModuleTrialAuthInfoResponseBodyDataTrialRecordList& setModuleCode(string moduleCode) { DARABONBA_PTR_SET_VALUE(moduleCode_, moduleCode) };
    ...
    inline GetModuleTrialAuthInfoResponseBodyDataTrialRecordList& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
