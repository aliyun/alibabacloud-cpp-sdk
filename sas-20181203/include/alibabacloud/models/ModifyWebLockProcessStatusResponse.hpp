...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyWebLockProcessStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyWebLockProcessStatusResponseBody) };
    inline ModifyWebLockProcessStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyWebLockProcessStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyWebLockProcessStatusResponseBody> body_ {};
  };
