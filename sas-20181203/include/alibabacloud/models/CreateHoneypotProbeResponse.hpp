...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHoneypotProbeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateHoneypotProbeResponseBody) };
    inline CreateHoneypotProbeResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateHoneypotProbeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateHoneypotProbeResponseBody> body_ {};
  };
