...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVpcHoneyPotResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteVpcHoneyPotResponseBody) };
    inline DeleteVpcHoneyPotResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteVpcHoneyPotResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteVpcHoneyPotResponseBody> body_ {};
  };
