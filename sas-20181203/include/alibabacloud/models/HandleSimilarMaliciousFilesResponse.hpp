...
namespace Models
{
  ...
  public:
    ...
    inline const HandleSimilarMaliciousFilesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, HandleSimilarMaliciousFilesResponseBody) };
    inline HandleSimilarMaliciousFilesResponseBody getBody() { DARABONBA_PTR_GET(body_, HandleSimilarMaliciousFilesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<HandleSimilarMaliciousFilesResponseBody> body_ {};
  };
