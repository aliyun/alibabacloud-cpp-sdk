...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageEventOperationConditionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeImageEventOperationConditionResponseBodyData) };
    inline DescribeImageEventOperationConditionResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeImageEventOperationConditionResponseBodyData) };
    inline DescribeImageEventOperationConditionResponseBody& setData(const DescribeImageEventOperationConditionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeImageEventOperationConditionResponseBody& setData(DescribeImageEventOperationConditionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<DescribeImageEventOperationConditionResponseBodyData> data_ = nullptr;
