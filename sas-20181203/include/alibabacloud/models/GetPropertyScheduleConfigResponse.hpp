...
namespace Models
{
  ...
  public:
    ...
    inline const GetPropertyScheduleConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPropertyScheduleConfigResponseBody) };
    inline GetPropertyScheduleConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPropertyScheduleConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPropertyScheduleConfigResponseBody> body_ {};
  };
