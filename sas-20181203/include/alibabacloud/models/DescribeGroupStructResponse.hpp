...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeGroupStructResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeGroupStructResponseBody) };
    inline DescribeGroupStructResponseBody body() { DARABONBA_PTR_GET(body_, DescribeGroupStructResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeGroupStructResponseBody> body_ = nullptr;
  };
