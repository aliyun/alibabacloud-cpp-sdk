...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeVpcHoneyPotCriteriaResponseBody::CriteriaList> & getCriteriaList() const { DARABONBA_PTR_GET_CONST(criteriaList_, vector<DescribeVpcHoneyPotCriteriaResponseBody::CriteriaList>) };
    inline vector<DescribeVpcHoneyPotCriteriaResponseBody::CriteriaList> getCriteriaList() { DARABONBA_PTR_GET(criteriaList_, vector<DescribeVpcHoneyPotCriteriaResponseBody::CriteriaList>) };
    inline DescribeVpcHoneyPotCriteriaResponseBody& setCriteriaList(const vector<DescribeVpcHoneyPotCriteriaResponseBody::CriteriaList> & criteriaList) { DARABONBA_PTR_SET_VALUE(criteriaList_, criteriaList) };
    inline DescribeVpcHoneyPotCriteriaResponseBody& setCriteriaList(vector<DescribeVpcHoneyPotCriteriaResponseBody::CriteriaList> && criteriaList) { DARABONBA_PTR_SET_RVALUE(criteriaList_, criteriaList) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeVpcHoneyPotCriteriaResponseBody::CriteriaList>> criteriaList_ {};
