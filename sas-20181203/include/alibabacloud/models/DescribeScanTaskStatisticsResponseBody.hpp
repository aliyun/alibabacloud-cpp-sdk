...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dealedRiskNum_ == nullptr
        && this->personalTaskNum_ == nullptr && this->requestId_ == nullptr && this->totalTaskNum_ == nullptr && this->userNum_ == nullptr; };
    ...
    inline int32_t getDealedRiskNum() const { DARABONBA_PTR_GET_DEFAULT(dealedRiskNum_, 0) };
    ...
    inline int64_t getPersonalTaskNum() const { DARABONBA_PTR_GET_DEFAULT(personalTaskNum_, 0L) };
    ...
    inline int64_t getTotalTaskNum() const { DARABONBA_PTR_GET_DEFAULT(totalTaskNum_, 0L) };
    ...
    inline int64_t getUserNum() const { DARABONBA_PTR_GET_DEFAULT(userNum_, 0L) };
