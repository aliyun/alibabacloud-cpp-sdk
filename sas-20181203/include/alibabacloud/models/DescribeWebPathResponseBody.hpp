...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeWebPathResponseBodyConfigList> & configList() const { DARABONBA_PTR_GET_CONST(configList_, vector<DescribeWebPathResponseBodyConfigList>) };
    inline vector<DescribeWebPathResponseBodyConfigList> configList() { DARABONBA_PTR_GET(configList_, vector<DescribeWebPathResponseBodyConfigList>) };
    inline DescribeWebPathResponseBody& setConfigList(const vector<DescribeWebPathResponseBodyConfigList> & configList) { DARABONBA_PTR_SET_VALUE(configList_, configList) };
    inline DescribeWebPathResponseBody& setConfigList(vector<DescribeWebPathResponseBodyConfigList> && configList) { DARABONBA_PTR_SET_RVALUE(configList_, configList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeWebPathResponseBodyConfigList>> configList_ = nullptr;
