...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVulTargetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyVulTargetResponseBody) };
    inline ModifyVulTargetResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyVulTargetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyVulTargetResponseBody> body_ {};
  };
