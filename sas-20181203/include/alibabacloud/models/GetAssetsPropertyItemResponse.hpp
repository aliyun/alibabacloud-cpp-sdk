...
namespace Models
{
  ...
  public:
    ...
    inline const GetAssetsPropertyItemResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAssetsPropertyItemResponseBody) };
    inline GetAssetsPropertyItemResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAssetsPropertyItemResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAssetsPropertyItemResponseBody> body_ {};
  };
