...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDefaultKeyInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDefaultKeyInfoResponseBody) };
    inline DescribeDefaultKeyInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDefaultKeyInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDefaultKeyInfoResponseBody> body_ {};
  };
