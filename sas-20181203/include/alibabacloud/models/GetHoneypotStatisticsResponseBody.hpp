...
namespace Models
{
  ...
  public:
    ...
    inline const GetHoneypotStatisticsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetHoneypotStatisticsResponseBodyData) };
    inline GetHoneypotStatisticsResponseBodyData data() { DARABONBA_PTR_GET(data_, GetHoneypotStatisticsResponseBodyData) };
    inline GetHoneypotStatisticsResponseBody& setData(const GetHoneypotStatisticsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHoneypotStatisticsResponseBody& setData(GetHoneypotStatisticsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetHoneypotStatisticsResponseBodyData> data_ = nullptr;
