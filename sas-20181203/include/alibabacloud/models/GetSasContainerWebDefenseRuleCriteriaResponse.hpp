...
namespace Models
{
  ...
  public:
    ...
    inline const GetSasContainerWebDefenseRuleCriteriaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSasContainerWebDefenseRuleCriteriaResponseBody) };
    inline GetSasContainerWebDefenseRuleCriteriaResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSasContainerWebDefenseRuleCriteriaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSasContainerWebDefenseRuleCriteriaResponseBody> body_ {};
  };
