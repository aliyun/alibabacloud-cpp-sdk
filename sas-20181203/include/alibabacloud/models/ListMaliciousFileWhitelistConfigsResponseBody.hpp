...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListMaliciousFileWhitelistConfigsResponseBodyList> & list() const { DARABONBA_PTR_GET_CONST(list_, vector<ListMaliciousFileWhitelistConfigsResponseBodyList>) };
    inline vector<ListMaliciousFileWhitelistConfigsResponseBodyList> list() { DARABONBA_PTR_GET(list_, vector<ListMaliciousFileWhitelistConfigsResponseBodyList>) };
    inline ListMaliciousFileWhitelistConfigsResponseBody& setList(const vector<ListMaliciousFileWhitelistConfigsResponseBodyList> & list) { DARABONBA_PTR_SET_VALUE(list_, list) };
    inline ListMaliciousFileWhitelistConfigsResponseBody& setList(vector<ListMaliciousFileWhitelistConfigsResponseBodyList> && list) { DARABONBA_PTR_SET_RVALUE(list_, list) };
    ...
    inline const ListMaliciousFileWhitelistConfigsResponseBodyPageInfo & pageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, ListMaliciousFileWhitelistConfigsResponseBodyPageInfo) };
    inline ListMaliciousFileWhitelistConfigsResponseBodyPageInfo pageInfo() { DARABONBA_PTR_GET(pageInfo_, ListMaliciousFileWhitelistConfigsResponseBodyPageInfo) };
    inline ListMaliciousFileWhitelistConfigsResponseBody& setPageInfo(const ListMaliciousFileWhitelistConfigsResponseBodyPageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline ListMaliciousFileWhitelistConfigsResponseBody& setPageInfo(ListMaliciousFileWhitelistConfigsResponseBodyPageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListMaliciousFileWhitelistConfigsResponseBodyList>> list_ = nullptr;
    // The returned message.
    std::shared_ptr<string> message_ = nullptr;
    // The pagination information.
    std::shared_ptr<ListMaliciousFileWhitelistConfigsResponseBodyPageInfo> pageInfo_ = nullptr;
    // The request ID.
