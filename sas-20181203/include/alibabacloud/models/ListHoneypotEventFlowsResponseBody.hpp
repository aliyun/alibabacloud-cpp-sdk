...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->honeypotEventFlows_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->pageInfo_ == nullptr && return this->requestId_ == nullptr
    ...
    inline const vector<ListHoneypotEventFlowsResponseBodyHoneypotEventFlows> & honeypotEventFlows() const { DARABONBA_PTR_GET_CONST(honeypotEventFlows_, vector<ListHoneypotEventFlowsResponseBodyHoneypotEventFlows>) };
    inline vector<ListHoneypotEventFlowsResponseBodyHoneypotEventFlows> honeypotEventFlows() { DARABONBA_PTR_GET(honeypotEventFlows_, vector<ListHoneypotEventFlowsResponseBodyHoneypotEventFlows>) };
    inline ListHoneypotEventFlowsResponseBody& setHoneypotEventFlows(const vector<ListHoneypotEventFlowsResponseBodyHoneypotEventFlows> & honeypotEventFlows) { DARABONBA_PTR_SET_VALUE(honeypotEventFlows_, honeypotEventFlows) };
    inline ListHoneypotEventFlowsResponseBody& setHoneypotEventFlows(vector<ListHoneypotEventFlowsResponseBodyHoneypotEventFlows> && honeypotEventFlows) { DARABONBA_PTR_SET_RVALUE(honeypotEventFlows_, honeypotEventFlows) };
    ...
    inline const ListHoneypotEventFlowsResponseBodyPageInfo & pageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, ListHoneypotEventFlowsResponseBodyPageInfo) };
    inline ListHoneypotEventFlowsResponseBodyPageInfo pageInfo() { DARABONBA_PTR_GET(pageInfo_, ListHoneypotEventFlowsResponseBodyPageInfo) };
    inline ListHoneypotEventFlowsResponseBody& setPageInfo(const ListHoneypotEventFlowsResponseBodyPageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline ListHoneypotEventFlowsResponseBody& setPageInfo(ListHoneypotEventFlowsResponseBodyPageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListHoneypotEventFlowsResponseBodyHoneypotEventFlows>> honeypotEventFlows_ = nullptr;
    // The HTTP status code.
    std::shared_ptr<int32_t> httpStatusCode_ = nullptr;
    // The returned message.
    std::shared_ptr<string> message_ = nullptr;
    // The pagination information.
    std::shared_ptr<ListHoneypotEventFlowsResponseBodyPageInfo> pageInfo_ = nullptr;
    // The request ID.
