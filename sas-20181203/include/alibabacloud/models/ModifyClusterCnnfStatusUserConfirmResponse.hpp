...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyClusterCnnfStatusUserConfirmResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyClusterCnnfStatusUserConfirmResponseBody) };
    inline ModifyClusterCnnfStatusUserConfirmResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyClusterCnnfStatusUserConfirmResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyClusterCnnfStatusUserConfirmResponseBody> body_ {};
  };
