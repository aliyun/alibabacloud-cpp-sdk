...
namespace Models
{
  ...
  public:
    ...
    inline const EnableCustomInstanceBlockRecordResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, EnableCustomInstanceBlockRecordResponseBody) };
    inline EnableCustomInstanceBlockRecordResponseBody body() { DARABONBA_PTR_GET(body_, EnableCustomInstanceBlockRecordResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<EnableCustomInstanceBlockRecordResponseBody> body_ = nullptr;
  };
