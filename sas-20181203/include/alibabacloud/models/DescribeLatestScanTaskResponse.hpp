...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLatestScanTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLatestScanTaskResponseBody) };
    inline DescribeLatestScanTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLatestScanTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLatestScanTaskResponseBody> body_ {};
  };
