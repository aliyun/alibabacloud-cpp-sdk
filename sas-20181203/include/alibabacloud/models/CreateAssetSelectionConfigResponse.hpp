...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAssetSelectionConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAssetSelectionConfigResponseBody) };
    inline CreateAssetSelectionConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAssetSelectionConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAssetSelectionConfigResponseBody> body_ {};
  };
