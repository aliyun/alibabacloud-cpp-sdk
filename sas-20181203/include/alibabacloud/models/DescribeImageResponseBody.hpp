...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeImageResponseBodyData) };
    inline DescribeImageResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeImageResponseBodyData) };
    inline DescribeImageResponseBody& setData(const DescribeImageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeImageResponseBody& setData(DescribeImageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeImageResponseBodyData> data_ = nullptr;
