...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline AssetDetail& setDiskInfoList(const vector<string> & diskInfoList) { DARABONBA_PTR_SET_VALUE(diskInfoList_, diskInfoList) };
      inline AssetDetail& setDiskInfoList(vector<string> && diskInfoList) { DARABONBA_PTR_SET_RVALUE(diskInfoList_, diskInfoList) };
    ...
    inline const DescribeAssetDetailByUuidResponseBody::AssetDetail & getAssetDetail() const { DARABONBA_PTR_GET_CONST(assetDetail_, DescribeAssetDetailByUuidResponseBody::AssetDetail) };
    inline DescribeAssetDetailByUuidResponseBody::AssetDetail getAssetDetail() { DARABONBA_PTR_GET(assetDetail_, DescribeAssetDetailByUuidResponseBody::AssetDetail) };
    inline DescribeAssetDetailByUuidResponseBody& setAssetDetail(const DescribeAssetDetailByUuidResponseBody::AssetDetail & assetDetail) { DARABONBA_PTR_SET_VALUE(assetDetail_, assetDetail) };
    inline DescribeAssetDetailByUuidResponseBody& setAssetDetail(DescribeAssetDetailByUuidResponseBody::AssetDetail && assetDetail) { DARABONBA_PTR_SET_RVALUE(assetDetail_, assetDetail) };
  ...
  protected:
    ...
    shared_ptr<DescribeAssetDetailByUuidResponseBody::AssetDetail> assetDetail_ {};
