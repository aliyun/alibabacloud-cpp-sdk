...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUniBackupPoliciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUniBackupPoliciesResponseBody) };
    inline DescribeUniBackupPoliciesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUniBackupPoliciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUniBackupPoliciesResponseBody> body_ {};
  };
