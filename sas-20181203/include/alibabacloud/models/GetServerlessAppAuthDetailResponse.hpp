...
namespace Models
{
  ...
  public:
    ...
    inline const GetServerlessAppAuthDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetServerlessAppAuthDetailResponseBody) };
    inline GetServerlessAppAuthDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetServerlessAppAuthDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetServerlessAppAuthDetailResponseBody> body_ {};
  };
