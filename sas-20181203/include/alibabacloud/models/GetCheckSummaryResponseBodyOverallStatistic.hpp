...
#ifndef ALIBABACLOUD_MODELS_GETCHECKSUMMARYRESPONSEBODYOVERALLSTATISTIC_HPP_
#define ALIBABACLOUD_MODELS_GETCHECKSUMMARYRESPONSEBODYOVERALLSTATISTIC_HPP_
...
namespace Models
{
  class GetCheckSummaryResponseBodyOverallStatistic : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetCheckSummaryResponseBodyOverallStatistic& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetCheckSummaryResponseBodyOverallStatistic& obj) { 
    ...
    GetCheckSummaryResponseBodyOverallStatistic() = default ;
    GetCheckSummaryResponseBodyOverallStatistic(const GetCheckSummaryResponseBodyOverallStatistic &) = default ;
    GetCheckSummaryResponseBodyOverallStatistic(GetCheckSummaryResponseBodyOverallStatistic &&) = default ;
    GetCheckSummaryResponseBodyOverallStatistic(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetCheckSummaryResponseBodyOverallStatistic() = default ;
    GetCheckSummaryResponseBodyOverallStatistic& operator=(const GetCheckSummaryResponseBodyOverallStatistic &) = default ;
    GetCheckSummaryResponseBodyOverallStatistic& operator=(GetCheckSummaryResponseBodyOverallStatistic &&) = default ;
    ...
    inline GetCheckSummaryResponseBodyOverallStatistic& setNotCheckCount(int32_t notCheckCount) { DARABONBA_PTR_SET_VALUE(notCheckCount_, notCheckCount) };
    ...
    inline GetCheckSummaryResponseBodyOverallStatistic& setNotCheckHighCount(int32_t notCheckHighCount) { DARABONBA_PTR_SET_VALUE(notCheckHighCount_, notCheckHighCount) };
    ...
    inline GetCheckSummaryResponseBodyOverallStatistic& setNotCheckLowCount(int32_t notCheckLowCount) { DARABONBA_PTR_SET_VALUE(notCheckLowCount_, notCheckLowCount) };
    ...
    inline GetCheckSummaryResponseBodyOverallStatistic& setNotCheckMediumCount(int32_t notCheckMediumCount) { DARABONBA_PTR_SET_VALUE(notCheckMediumCount_, notCheckMediumCount) };
    ...
    inline GetCheckSummaryResponseBodyOverallStatistic& setNotPassCount(int32_t notPassCount) { DARABONBA_PTR_SET_VALUE(notPassCount_, notPassCount) };
    ...
    inline GetCheckSummaryResponseBodyOverallStatistic& setNotPassHighCount(int32_t notPassHighCount) { DARABONBA_PTR_SET_VALUE(notPassHighCount_, notPassHighCount) };
    ...
    inline GetCheckSummaryResponseBodyOverallStatistic& setNotPassLowCount(int32_t notPassLowCount) { DARABONBA_PTR_SET_VALUE(notPassLowCount_, notPassLowCount) };
    ...
    inline GetCheckSummaryResponseBodyOverallStatistic& setNotPassMediumCount(int32_t notPassMediumCount) { DARABONBA_PTR_SET_VALUE(notPassMediumCount_, notPassMediumCount) };
    ...
    inline GetCheckSummaryResponseBodyOverallStatistic& setPassCount(int32_t passCount) { DARABONBA_PTR_SET_VALUE(passCount_, passCount) };
    ...
    inline GetCheckSummaryResponseBodyOverallStatistic& setPassHighCount(int32_t passHighCount) { DARABONBA_PTR_SET_VALUE(passHighCount_, passHighCount) };
    ...
    inline GetCheckSummaryResponseBodyOverallStatistic& setPassLowCount(int32_t passLowCount) { DARABONBA_PTR_SET_VALUE(passLowCount_, passLowCount) };
    ...
    inline GetCheckSummaryResponseBodyOverallStatistic& setPassMediumCount(int32_t passMediumCount) { DARABONBA_PTR_SET_VALUE(passMediumCount_, passMediumCount) };
