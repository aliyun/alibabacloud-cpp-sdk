...
namespace Models
{
  ...
  public:
    ...
    inline const GetContainerDefenseRuleDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetContainerDefenseRuleDetailResponseBodyData) };
    inline GetContainerDefenseRuleDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetContainerDefenseRuleDetailResponseBodyData) };
    inline GetContainerDefenseRuleDetailResponseBody& setData(const GetContainerDefenseRuleDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetContainerDefenseRuleDetailResponseBody& setData(GetContainerDefenseRuleDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetContainerDefenseRuleDetailResponseBodyData> data_ = nullptr;
