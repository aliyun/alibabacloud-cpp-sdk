...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileProtectEventCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetFileProtectEventCountResponseBody) };
    inline GetFileProtectEventCountResponseBody getBody() { DARABONBA_PTR_GET(body_, GetFileProtectEventCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetFileProtectEventCountResponseBody> body_ {};
  };
