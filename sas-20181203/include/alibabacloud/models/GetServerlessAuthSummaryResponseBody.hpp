...
namespace Models
{
  ...
  public:
    ...
    inline const GetServerlessAuthSummaryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetServerlessAuthSummaryResponseBodyData) };
    inline GetServerlessAuthSummaryResponseBodyData data() { DARABONBA_PTR_GET(data_, GetServerlessAuthSummaryResponseBodyData) };
    inline GetServerlessAuthSummaryResponseBody& setData(const GetServerlessAuthSummaryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetServerlessAuthSummaryResponseBody& setData(GetServerlessAuthSummaryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetServerlessAuthSummaryResponseBodyData> data_ = nullptr;
