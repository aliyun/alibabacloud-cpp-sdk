...
namespace Models
{
  ...
  public:
    ...
    inline const StartBaselineSecurityCheckResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartBaselineSecurityCheckResponseBody) };
    inline StartBaselineSecurityCheckResponseBody getBody() { DARABONBA_PTR_GET(body_, StartBaselineSecurityCheckResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartBaselineSecurityCheckResponseBody> body_ {};
  };
