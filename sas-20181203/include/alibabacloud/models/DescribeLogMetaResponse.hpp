...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLogMetaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLogMetaResponseBody) };
    inline DescribeLogMetaResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLogMetaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLogMetaResponseBody> body_ {};
  };
