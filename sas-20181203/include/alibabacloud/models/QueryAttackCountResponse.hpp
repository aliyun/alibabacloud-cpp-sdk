...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAttackCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryAttackCountResponseBody) };
    inline QueryAttackCountResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryAttackCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryAttackCountResponseBody> body_ {};
  };
