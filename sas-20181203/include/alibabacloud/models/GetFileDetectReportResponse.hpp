...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileDetectReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetFileDetectReportResponseBody) };
    inline GetFileDetectReportResponseBody getBody() { DARABONBA_PTR_GET(body_, GetFileDetectReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetFileDetectReportResponseBody> body_ {};
  };
