...
namespace Models
{
  ...
  public:
    ...
    inline const ListBaselineCheckWhiteRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListBaselineCheckWhiteRecordResponseBody) };
    inline ListBaselineCheckWhiteRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, ListBaselineCheckWhiteRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListBaselineCheckWhiteRecordResponseBody> body_ {};
  };
