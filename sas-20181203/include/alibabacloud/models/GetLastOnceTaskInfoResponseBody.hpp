...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetLastOnceTaskInfoResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetLastOnceTaskInfoResponseBody& obj) { 
    ...
    GetLastOnceTaskInfoResponseBody() = default ;
    GetLastOnceTaskInfoResponseBody(const GetLastOnceTaskInfoResponseBody &) = default ;
    GetLastOnceTaskInfoResponseBody(GetLastOnceTaskInfoResponseBody &&) = default ;
    GetLastOnceTaskInfoResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetLastOnceTaskInfoResponseBody() = default ;
    GetLastOnceTaskInfoResponseBody& operator=(const GetLastOnceTaskInfoResponseBody &) = default ;
    GetLastOnceTaskInfoResponseBody& operator=(GetLastOnceTaskInfoResponseBody &&) = default ;
