...
namespace Models
{
  ...
  public:
    ...
    inline const ListClusterCnnfStatusDetailResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListClusterCnnfStatusDetailResponseBody) };
    inline ListClusterCnnfStatusDetailResponseBody body() { DARABONBA_PTR_GET(body_, ListClusterCnnfStatusDetailResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListClusterCnnfStatusDetailResponseBody> body_ = nullptr;
  };
