...
namespace Models
{
  ...
  public:
    ...
    inline const SaveSuspEventUserSettingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveSuspEventUserSettingResponseBody) };
    inline SaveSuspEventUserSettingResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveSuspEventUserSettingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveSuspEventUserSettingResponseBody> body_ {};
  };
