...
namespace Models
{
  ...
  public:
    ...
    inline const ListVulAutoRepairConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListVulAutoRepairConfigResponseBody) };
    inline ListVulAutoRepairConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ListVulAutoRepairConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListVulAutoRepairConfigResponseBody> body_ {};
  };
