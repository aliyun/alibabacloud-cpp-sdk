...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeIdcProbeListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeIdcProbeListResponseBody) };
    inline DescribeIdcProbeListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeIdcProbeListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeIdcProbeListResponseBody> body_ {};
  };
