...
namespace Models
{
  ...
  public:
    ...
    inline const IgnoreCheckItemsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, IgnoreCheckItemsResponseBody) };
    inline IgnoreCheckItemsResponseBody getBody() { DARABONBA_PTR_GET(body_, IgnoreCheckItemsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<IgnoreCheckItemsResponseBody> body_ {};
  };
