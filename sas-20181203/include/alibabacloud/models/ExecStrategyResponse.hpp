...
namespace Models
{
  ...
  public:
    ...
    inline const ExecStrategyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExecStrategyResponseBody) };
    inline ExecStrategyResponseBody getBody() { DARABONBA_PTR_GET(body_, ExecStrategyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExecStrategyResponseBody> body_ {};
  };
