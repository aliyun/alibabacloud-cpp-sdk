...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePropertyProcItemResponseBody::PageInfo & getPageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, DescribePropertyProcItemResponseBody::PageInfo) };
    inline DescribePropertyProcItemResponseBody::PageInfo getPageInfo() { DARABONBA_PTR_GET(pageInfo_, DescribePropertyProcItemResponseBody::PageInfo) };
    inline DescribePropertyProcItemResponseBody& setPageInfo(const DescribePropertyProcItemResponseBody::PageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline DescribePropertyProcItemResponseBody& setPageInfo(DescribePropertyProcItemResponseBody::PageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
    ...
    inline const vector<DescribePropertyProcItemResponseBody::PropertyItems> & getPropertyItems() const { DARABONBA_PTR_GET_CONST(propertyItems_, vector<DescribePropertyProcItemResponseBody::PropertyItems>) };
    inline vector<DescribePropertyProcItemResponseBody::PropertyItems> getPropertyItems() { DARABONBA_PTR_GET(propertyItems_, vector<DescribePropertyProcItemResponseBody::PropertyItems>) };
    inline DescribePropertyProcItemResponseBody& setPropertyItems(const vector<DescribePropertyProcItemResponseBody::PropertyItems> & propertyItems) { DARABONBA_PTR_SET_VALUE(propertyItems_, propertyItems) };
    inline DescribePropertyProcItemResponseBody& setPropertyItems(vector<DescribePropertyProcItemResponseBody::PropertyItems> && propertyItems) { DARABONBA_PTR_SET_RVALUE(propertyItems_, propertyItems) };
  ...
  protected:
    ...
    shared_ptr<DescribePropertyProcItemResponseBody::PageInfo> pageInfo_ {};
    // An array that consists of the processes returned.
    shared_ptr<vector<DescribePropertyProcItemResponseBody::PropertyItems>> propertyItems_ {};
