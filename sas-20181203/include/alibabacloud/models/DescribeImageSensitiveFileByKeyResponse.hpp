...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageSensitiveFileByKeyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeImageSensitiveFileByKeyResponseBody) };
    inline DescribeImageSensitiveFileByKeyResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeImageSensitiveFileByKeyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeImageSensitiveFileByKeyResponseBody> body_ {};
  };
