...
namespace Models
{
  ...
  public:
    ...
    inline const ListAssetCleanConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAssetCleanConfigResponseBody) };
    inline ListAssetCleanConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAssetCleanConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAssetCleanConfigResponseBody> body_ {};
  };
