...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSearchConditionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSearchConditionResponseBody) };
    inline DescribeSearchConditionResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSearchConditionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSearchConditionResponseBody> body_ {};
  };
