...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dealAll_ == nullptr
        && return this->eventIds_ == nullptr && return this->operationCode_ == nullptr; };
    ...
    inline const vector<int64_t> & eventIds() const { DARABONBA_PTR_GET_CONST(eventIds_, vector<int64_t>) };
    inline vector<int64_t> eventIds() { DARABONBA_PTR_GET(eventIds_, vector<int64_t>) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<vector<int64_t>> eventIds_ = nullptr;
