...
namespace Models
{
  ...
  public:
    ...
    inline const GetInterceptionTargetDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInterceptionTargetDetailResponseBody) };
    inline GetInterceptionTargetDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInterceptionTargetDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInterceptionTargetDetailResponseBody> body_ {};
  };
