...
#ifndef ALIBABACLOUD_MODELS_MODIFYCLOUDVENDORACCOUNTAKRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_MODIFYCLOUDVENDORACCOUNTAKRESPONSEBODYDATA_HPP_
...
namespace Models
{
  class ModifyCloudVendorAccountAKResponseBodyData : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModifyCloudVendorAccountAKResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyCloudVendorAccountAKResponseBodyData& obj) { 
    ...
    ModifyCloudVendorAccountAKResponseBodyData() = default ;
    ModifyCloudVendorAccountAKResponseBodyData(const ModifyCloudVendorAccountAKResponseBodyData &) = default ;
    ModifyCloudVendorAccountAKResponseBodyData(ModifyCloudVendorAccountAKResponseBodyData &&) = default ;
    ModifyCloudVendorAccountAKResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyCloudVendorAccountAKResponseBodyData() = default ;
    ModifyCloudVendorAccountAKResponseBodyData& operator=(const ModifyCloudVendorAccountAKResponseBodyData &) = default ;
    ModifyCloudVendorAccountAKResponseBodyData& operator=(ModifyCloudVendorAccountAKResponseBodyData &&) = default ;
    ...
    inline ModifyCloudVendorAccountAKResponseBodyData& setAkType(string akType) { DARABONBA_PTR_SET_VALUE(akType_, akType) };
    ...
    inline ModifyCloudVendorAccountAKResponseBodyData& setAuthId(int64_t authId) { DARABONBA_PTR_SET_VALUE(authId_, authId) };
    ...
    inline const vector<Models::ModifyCloudVendorAccountAKResponseBodyDataAuthModules> & authModules() const { DARABONBA_PTR_GET_CONST(authModules_, vector<Models::ModifyCloudVendorAccountAKResponseBodyDataAuthModules>) };
    inline vector<Models::ModifyCloudVendorAccountAKResponseBodyDataAuthModules> authModules() { DARABONBA_PTR_GET(authModules_, vector<Models::ModifyCloudVendorAccountAKResponseBodyDataAuthModules>) };
    inline ModifyCloudVendorAccountAKResponseBodyData& setAuthModules(const vector<Models::ModifyCloudVendorAccountAKResponseBodyDataAuthModules> & authModules) { DARABONBA_PTR_SET_VALUE(authModules_, authModules) };
    inline ModifyCloudVendorAccountAKResponseBodyData& setAuthModules(vector<Models::ModifyCloudVendorAccountAKResponseBodyDataAuthModules> && authModules) { DARABONBA_PTR_SET_RVALUE(authModules_, authModules) };
    ...
    inline ModifyCloudVendorAccountAKResponseBodyData& setCtdrCloudUserId(string ctdrCloudUserId) { DARABONBA_PTR_SET_VALUE(ctdrCloudUserId_, ctdrCloudUserId) };
    ...
    inline ModifyCloudVendorAccountAKResponseBodyData& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ModifyCloudVendorAccountAKResponseBodyData& setSecretId(string secretId) { DARABONBA_PTR_SET_VALUE(secretId_, secretId) };
    ...
    inline ModifyCloudVendorAccountAKResponseBodyData& setServiceStatus(int32_t serviceStatus) { DARABONBA_PTR_SET_VALUE(serviceStatus_, serviceStatus) };
    ...
    inline ModifyCloudVendorAccountAKResponseBodyData& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ModifyCloudVendorAccountAKResponseBodyData& setVendor(string vendor) { DARABONBA_PTR_SET_VALUE(vendor_, vendor) };
    ...
    inline ModifyCloudVendorAccountAKResponseBodyData& setVendorAuthAlias(string vendorAuthAlias) { DARABONBA_PTR_SET_VALUE(vendorAuthAlias_, vendorAuthAlias) };
