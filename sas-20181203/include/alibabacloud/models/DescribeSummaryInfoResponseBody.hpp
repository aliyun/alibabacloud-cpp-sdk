...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aegisClientOfflineCount_ == nullptr
        && this->aegisClientOnlineCount_ == nullptr && this->requestId_ == nullptr && this->securityScore_ == nullptr && this->success_ == nullptr; };
    ...
    inline int32_t getAegisClientOfflineCount() const { DARABONBA_PTR_GET_DEFAULT(aegisClientOfflineCount_, 0) };
    ...
    inline int32_t getAegisClientOnlineCount() const { DARABONBA_PTR_GET_DEFAULT(aegisClientOnlineCount_, 0) };
  ...
  protected:
    ...
    shared_ptr<int32_t> aegisClientOfflineCount_ {};
    // The number of protected assets.
    shared_ptr<int32_t> aegisClientOnlineCount_ {};
