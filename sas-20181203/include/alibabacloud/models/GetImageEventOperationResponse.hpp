...
namespace Models
{
  ...
  public:
    ...
    inline const GetImageEventOperationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetImageEventOperationResponseBody) };
    inline GetImageEventOperationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetImageEventOperationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetImageEventOperationResponseBody> body_ {};
  };
