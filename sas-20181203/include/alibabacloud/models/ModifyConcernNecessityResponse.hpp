...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyConcernNecessityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyConcernNecessityResponseBody) };
    inline ModifyConcernNecessityResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyConcernNecessityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyConcernNecessityResponseBody> body_ {};
  };
