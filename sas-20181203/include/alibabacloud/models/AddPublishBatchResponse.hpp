...
namespace Models
{
  ...
  public:
    ...
    inline const AddPublishBatchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddPublishBatchResponseBody) };
    inline AddPublishBatchResponseBody getBody() { DARABONBA_PTR_GET(body_, AddPublishBatchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddPublishBatchResponseBody> body_ {};
  };
