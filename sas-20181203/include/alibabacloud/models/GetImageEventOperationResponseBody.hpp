...
namespace Models
{
  ...
  public:
    ...
    inline const GetImageEventOperationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetImageEventOperationResponseBodyData) };
    inline GetImageEventOperationResponseBodyData data() { DARABONBA_PTR_GET(data_, GetImageEventOperationResponseBodyData) };
    inline GetImageEventOperationResponseBody& setData(const GetImageEventOperationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetImageEventOperationResponseBody& setData(GetImageEventOperationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetImageEventOperationResponseBodyData> data_ = nullptr;
