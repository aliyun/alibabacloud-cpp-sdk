...
namespace Models
{
  ...
  public:
    ...
    inline const GetPassThroughAuthInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPassThroughAuthInfoResponseBody) };
    inline GetPassThroughAuthInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPassThroughAuthInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPassThroughAuthInfoResponseBody> body_ {};
  };
