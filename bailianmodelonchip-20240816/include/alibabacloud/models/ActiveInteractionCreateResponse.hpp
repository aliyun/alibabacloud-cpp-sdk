...
namespace Models
{
  ...
  public:
    ...
    inline const ActiveInteractionCreateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ActiveInteractionCreateResponseBody) };
    inline ActiveInteractionCreateResponseBody getBody() { DARABONBA_PTR_GET(body_, ActiveInteractionCreateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ActiveInteractionCreateResponseBody> body_ {};
  };
