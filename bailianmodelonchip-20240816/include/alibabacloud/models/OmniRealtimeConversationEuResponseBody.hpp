...
namespace Models
{
  ...
  public:
    ...
    inline const OmniRealtimeConversationEUResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, OmniRealtimeConversationEUResponseBodyData) };
    inline OmniRealtimeConversationEUResponseBodyData data() { DARABONBA_PTR_GET(data_, OmniRealtimeConversationEUResponseBodyData) };
    inline OmniRealtimeConversationEUResponseBody& setData(const OmniRealtimeConversationEUResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline OmniRealtimeConversationEUResponseBody& setData(OmniRealtimeConversationEUResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<OmniRealtimeConversationEUResponseBodyData> data_ = nullptr;
