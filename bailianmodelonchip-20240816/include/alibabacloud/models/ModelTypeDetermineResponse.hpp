...
namespace Models
{
  ...
  public:
    ...
    inline const ModelTypeDetermineResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModelTypeDetermineResponseBody) };
    inline ModelTypeDetermineResponseBody getBody() { DARABONBA_PTR_GET(body_, ModelTypeDetermineResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModelTypeDetermineResponseBody> body_ {};
  };
