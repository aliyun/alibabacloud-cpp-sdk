...
namespace Models
{
  ...
  public:
    ...
    inline const ModelTypeDetermineResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ModelTypeDetermineResponseBodyData) };
    inline ModelTypeDetermineResponseBodyData data() { DARABONBA_PTR_GET(data_, ModelTypeDetermineResponseBodyData) };
    inline ModelTypeDetermineResponseBody& setData(const ModelTypeDetermineResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModelTypeDetermineResponseBody& setData(ModelTypeDetermineResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ModelTypeDetermineResponseBodyData> data_ = nullptr;
