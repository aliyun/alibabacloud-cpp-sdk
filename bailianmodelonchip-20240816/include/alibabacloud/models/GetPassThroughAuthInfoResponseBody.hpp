...
namespace Models
{
  ...
  public:
    ...
    inline const GetPassThroughAuthInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetPassThroughAuthInfoResponseBodyData) };
    inline GetPassThroughAuthInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, GetPassThroughAuthInfoResponseBodyData) };
    inline GetPassThroughAuthInfoResponseBody& setData(const GetPassThroughAuthInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPassThroughAuthInfoResponseBody& setData(GetPassThroughAuthInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetPassThroughAuthInfoResponseBodyData> data_ = nullptr;
