...
namespace Models
{
  ...
  public:
    ...
    inline const DeviceRegisterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeviceRegisterResponseBody) };
    inline DeviceRegisterResponseBody getBody() { DARABONBA_PTR_GET(body_, DeviceRegisterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeviceRegisterResponseBody> body_ {};
  };
