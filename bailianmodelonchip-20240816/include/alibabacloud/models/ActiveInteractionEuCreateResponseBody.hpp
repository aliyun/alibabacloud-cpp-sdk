...
namespace Models
{
  ...
  public:
    ...
    inline const ActiveInteractionEuCreateResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ActiveInteractionEuCreateResponseBodyData) };
    inline ActiveInteractionEuCreateResponseBodyData data() { DARABONBA_PTR_GET(data_, ActiveInteractionEuCreateResponseBodyData) };
    inline ActiveInteractionEuCreateResponseBody& setData(const ActiveInteractionEuCreateResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ActiveInteractionEuCreateResponseBody& setData(ActiveInteractionEuCreateResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ActiveInteractionEuCreateResponseBodyData> data_ = nullptr;
