...
#ifndef ALIBABACLOUD_MODELS_MODIFYPOLICYCONTENTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MODIFYPOLICYCONTENTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyPolicyContentRequest& obj) { 
      DARABONBA_PTR_TO_JSON(Content, content_);
      DARABONBA_PTR_TO_JSON(Id, id_);
      DARABONBA_PTR_TO_JSON(Name, name_);
      DARABONBA_PTR_TO_JSON(PortVersion, portVersion_);
    };
    friend void from_json(const Darabonba::Json& j, ModifyPolicyContentRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(Content, content_);
      DARABONBA_PTR_FROM_JSON(Id, id_);
      DARABONBA_PTR_FROM_JSON(Name, name_);
      DARABONBA_PTR_FROM_JSON(PortVersion, portVersion_);
    };
    ModifyPolicyContentRequest() = default ;
    ModifyPolicyContentRequest(const ModifyPolicyContentRequest &) = default ;
    ModifyPolicyContentRequest(ModifyPolicyContentRequest &&) = default ;
    ModifyPolicyContentRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyPolicyContentRequest() = default ;
    ModifyPolicyContentRequest& operator=(const ModifyPolicyContentRequest &) = default ;
    ModifyPolicyContentRequest& operator=(ModifyPolicyContentRequest &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->blackIpListExpireAt_ == nullptr
        ...
        && this->l4RuleList_ == nullptr && this->portRuleList_ == nullptr && this->reflectBlockUdpPortList_ == nullptr && this->regionBlockCountryList_ == nullptr && this->regionBlockProvinceList_ == nullptr
        && this->sipDefense_ == nullptr && this->sourceBlockList_ == nullptr && this->sourceLimit_ == nullptr && this->whitenGfbrNets_ == nullptr; };
    ...
    bool hasContent() const { return this->content_ != nullptr;};
    void deleteContent() { this->content_ = nullptr;};
    inline const ModifyPolicyContentRequest::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, ModifyPolicyContentRequest::Content) };
    inline ModifyPolicyContentRequest::Content getContent() { DARABONBA_PTR_GET(content_, ModifyPolicyContentRequest::Content) };
    inline ModifyPolicyContentRequest& setContent(const ModifyPolicyContentRequest::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ModifyPolicyContentRequest& setContent(ModifyPolicyContentRequest::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
    ...
    void deleteId() { this->id_ = nullptr;};
    inline string getId() const { DARABONBA_PTR_GET_DEFAULT(id_, "") };
    inline ModifyPolicyContentRequest& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    void deleteName() { this->name_ = nullptr;};
    inline string getName() const { DARABONBA_PTR_GET_DEFAULT(name_, "") };
    inline ModifyPolicyContentRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ModifyPolicyContentRequest& setPortVersion(string portVersion) { DARABONBA_PTR_SET_VALUE(portVersion_, portVersion) };


  protected:
    // The policy content.
    shared_ptr<ModifyPolicyContentRequest::Content> content_ {};
    // The policy ID.
    // 
    // This parameter is required.
    shared_ptr<string> id_ {};
