  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->ip_ == nullptr
        ...
        && this->port_ == nullptr && this->portRange_ == nullptr && this->protocol_ == nullptr && this->region_ == nullptr && this->status_ == nullptr; };
      // ip Field Functions 
      ...
      inline AttachmentList& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
