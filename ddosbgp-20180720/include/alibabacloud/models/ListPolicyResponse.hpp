...
namespace Models
{
  ...
  public:
    ...
    inline const ListPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPolicyResponseBody) };
    inline ListPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPolicyResponseBody> body_ {};
  };
