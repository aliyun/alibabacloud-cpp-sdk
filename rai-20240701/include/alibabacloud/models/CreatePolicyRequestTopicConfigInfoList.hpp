...
#ifndef ALIBABACLOUD_MODELS_CREATEPOLICYREQUESTTOPICCONFIGINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_CREATEPOLICYREQUESTTOPICCONFIGINFOLIST_HPP_
...
namespace Models
{
  class CreatePolicyRequestTopicConfigInfoList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreatePolicyRequestTopicConfigInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePolicyRequestTopicConfigInfoList& obj) { 
    ...
    CreatePolicyRequestTopicConfigInfoList() = default ;
    CreatePolicyRequestTopicConfigInfoList(const CreatePolicyRequestTopicConfigInfoList &) = default ;
    CreatePolicyRequestTopicConfigInfoList(CreatePolicyRequestTopicConfigInfoList &&) = default ;
    CreatePolicyRequestTopicConfigInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePolicyRequestTopicConfigInfoList() = default ;
    CreatePolicyRequestTopicConfigInfoList& operator=(const CreatePolicyRequestTopicConfigInfoList &) = default ;
    CreatePolicyRequestTopicConfigInfoList& operator=(CreatePolicyRequestTopicConfigInfoList &&) = default ;
    ...
    inline CreatePolicyRequestTopicConfigInfoList& setCategoryType(int32_t categoryType) { DARABONBA_PTR_SET_VALUE(categoryType_, categoryType) };
    ...
    inline CreatePolicyRequestTopicConfigInfoList& setInputOutputType(int32_t inputOutputType) { DARABONBA_PTR_SET_VALUE(inputOutputType_, inputOutputType) };
    ...
    inline CreatePolicyRequestTopicConfigInfoList& setSecurityLevel(int32_t securityLevel) { DARABONBA_PTR_SET_VALUE(securityLevel_, securityLevel) };
    ...
    inline CreatePolicyRequestTopicConfigInfoList& setTopicId(int64_t topicId) { DARABONBA_PTR_SET_VALUE(topicId_, topicId) };
    ...
    inline CreatePolicyRequestTopicConfigInfoList& setTopicName(string topicName) { DARABONBA_PTR_SET_VALUE(topicName_, topicName) };
