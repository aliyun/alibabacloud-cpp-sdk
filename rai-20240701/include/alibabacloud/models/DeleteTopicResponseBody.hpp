...
namespace Models
{
  ...
  public:
    ...
    inline DeleteTopicResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DeleteTopicResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline DeleteTopicResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
