...
#ifndef ALIBABACLOUD_MODELS_UPDATEPOLICYREQUESTHARMFULCATEGORYCONFIGINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEPOLICYREQUESTHARMFULCATEGORYCONFIGINFOLIST_HPP_
...
namespace Models
{
  class UpdatePolicyRequestHarmfulCategoryConfigInfoList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdatePolicyRequestHarmfulCategoryConfigInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdatePolicyRequestHarmfulCategoryConfigInfoList& obj) { 
    ...
    UpdatePolicyRequestHarmfulCategoryConfigInfoList() = default ;
    UpdatePolicyRequestHarmfulCategoryConfigInfoList(const UpdatePolicyRequestHarmfulCategoryConfigInfoList &) = default ;
    UpdatePolicyRequestHarmfulCategoryConfigInfoList(UpdatePolicyRequestHarmfulCategoryConfigInfoList &&) = default ;
    UpdatePolicyRequestHarmfulCategoryConfigInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdatePolicyRequestHarmfulCategoryConfigInfoList() = default ;
    UpdatePolicyRequestHarmfulCategoryConfigInfoList& operator=(const UpdatePolicyRequestHarmfulCategoryConfigInfoList &) = default ;
    UpdatePolicyRequestHarmfulCategoryConfigInfoList& operator=(UpdatePolicyRequestHarmfulCategoryConfigInfoList &&) = default ;
    ...
    inline UpdatePolicyRequestHarmfulCategoryConfigInfoList& setCategoryConfigId(int64_t categoryConfigId) { DARABONBA_PTR_SET_VALUE(categoryConfigId_, categoryConfigId) };
    ...
    inline UpdatePolicyRequestHarmfulCategoryConfigInfoList& setCategoryId(int64_t categoryId) { DARABONBA_PTR_SET_VALUE(categoryId_, categoryId) };
    ...
    inline UpdatePolicyRequestHarmfulCategoryConfigInfoList& setCategoryLabel(string categoryLabel) { DARABONBA_PTR_SET_VALUE(categoryLabel_, categoryLabel) };
    ...
    inline UpdatePolicyRequestHarmfulCategoryConfigInfoList& setCategoryType(int32_t categoryType) { DARABONBA_PTR_SET_VALUE(categoryType_, categoryType) };
    ...
    inline UpdatePolicyRequestHarmfulCategoryConfigInfoList& setInputOutputType(int32_t inputOutputType) { DARABONBA_PTR_SET_VALUE(inputOutputType_, inputOutputType) };
    ...
    inline UpdatePolicyRequestHarmfulCategoryConfigInfoList& setIsEnabled(int32_t isEnabled) { DARABONBA_PTR_SET_VALUE(isEnabled_, isEnabled) };
    ...
    inline UpdatePolicyRequestHarmfulCategoryConfigInfoList& setSecurityLevel(int32_t securityLevel) { DARABONBA_PTR_SET_VALUE(securityLevel_, securityLevel) };
