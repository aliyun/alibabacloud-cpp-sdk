...
#ifndef ALIBABACLOUD_MODELS_UPDATEPOLICYREQUESTTOPICCONFIGINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEPOLICYREQUESTTOPICCONFIGINFOLIST_HPP_
...
namespace Models
{
  class UpdatePolicyRequestTopicConfigInfoList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdatePolicyRequestTopicConfigInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdatePolicyRequestTopicConfigInfoList& obj) { 
    ...
    UpdatePolicyRequestTopicConfigInfoList() = default ;
    UpdatePolicyRequestTopicConfigInfoList(const UpdatePolicyRequestTopicConfigInfoList &) = default ;
    UpdatePolicyRequestTopicConfigInfoList(UpdatePolicyRequestTopicConfigInfoList &&) = default ;
    UpdatePolicyRequestTopicConfigInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdatePolicyRequestTopicConfigInfoList() = default ;
    UpdatePolicyRequestTopicConfigInfoList& operator=(const UpdatePolicyRequestTopicConfigInfoList &) = default ;
    UpdatePolicyRequestTopicConfigInfoList& operator=(UpdatePolicyRequestTopicConfigInfoList &&) = default ;
    ...
    inline UpdatePolicyRequestTopicConfigInfoList& setCategoryType(int32_t categoryType) { DARABONBA_PTR_SET_VALUE(categoryType_, categoryType) };
    ...
    inline UpdatePolicyRequestTopicConfigInfoList& setInputOutputType(int32_t inputOutputType) { DARABONBA_PTR_SET_VALUE(inputOutputType_, inputOutputType) };
    ...
    inline UpdatePolicyRequestTopicConfigInfoList& setSecurityLevel(int32_t securityLevel) { DARABONBA_PTR_SET_VALUE(securityLevel_, securityLevel) };
    ...
    inline UpdatePolicyRequestTopicConfigInfoList& setTopicId(int64_t topicId) { DARABONBA_PTR_SET_VALUE(topicId_, topicId) };
    ...
    inline UpdatePolicyRequestTopicConfigInfoList& setTopicName(string topicName) { DARABONBA_PTR_SET_VALUE(topicName_, topicName) };
