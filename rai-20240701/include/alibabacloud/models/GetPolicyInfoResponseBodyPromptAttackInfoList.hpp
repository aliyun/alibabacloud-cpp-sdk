...
#ifndef ALIBABACLOUD_MODELS_GETPOLICYINFORESPONSEBODYPROMPTATTACKINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_GETPOLICYINFORESPONSEBODYPROMPTATTACKINFOLIST_HPP_
...
namespace Models
{
  class GetPolicyInfoResponseBodyPromptAttackInfoList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetPolicyInfoResponseBodyPromptAttackInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetPolicyInfoResponseBodyPromptAttackInfoList& obj) { 
    ...
    GetPolicyInfoResponseBodyPromptAttackInfoList() = default ;
    GetPolicyInfoResponseBodyPromptAttackInfoList(const GetPolicyInfoResponseBodyPromptAttackInfoList &) = default ;
    GetPolicyInfoResponseBodyPromptAttackInfoList(GetPolicyInfoResponseBodyPromptAttackInfoList &&) = default ;
    GetPolicyInfoResponseBodyPromptAttackInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetPolicyInfoResponseBodyPromptAttackInfoList() = default ;
    GetPolicyInfoResponseBodyPromptAttackInfoList& operator=(const GetPolicyInfoResponseBodyPromptAttackInfoList &) = default ;
    GetPolicyInfoResponseBodyPromptAttackInfoList& operator=(GetPolicyInfoResponseBodyPromptAttackInfoList &&) = default ;
    ...
    inline GetPolicyInfoResponseBodyPromptAttackInfoList& setCategoryConfigId(int64_t categoryConfigId) { DARABONBA_PTR_SET_VALUE(categoryConfigId_, categoryConfigId) };
    ...
    inline GetPolicyInfoResponseBodyPromptAttackInfoList& setCategoryId(int64_t categoryId) { DARABONBA_PTR_SET_VALUE(categoryId_, categoryId) };
    ...
    inline GetPolicyInfoResponseBodyPromptAttackInfoList& setCategoryLabel(string categoryLabel) { DARABONBA_PTR_SET_VALUE(categoryLabel_, categoryLabel) };
    ...
    inline GetPolicyInfoResponseBodyPromptAttackInfoList& setIsEnabled(int32_t isEnabled) { DARABONBA_PTR_SET_VALUE(isEnabled_, isEnabled) };
    ...
    inline GetPolicyInfoResponseBodyPromptAttackInfoList& setSecurityLevel(int32_t securityLevel) { DARABONBA_PTR_SET_VALUE(securityLevel_, securityLevel) };
