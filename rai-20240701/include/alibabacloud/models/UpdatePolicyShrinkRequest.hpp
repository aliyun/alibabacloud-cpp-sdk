...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->contentSafeModelInstanceId_ == nullptr
        ...
        && return this->promptAttackInfoShrink_ == nullptr && return this->promptAttackInfoListShrink_ == nullptr && return this->promptAttackModelInstanceId_ == nullptr && return this->regionId_ == nullptr && return this->regularExpressListShrink_ == nullptr
        && return this->sceneType_ == nullptr && return this->sensitiveConfigListShrink_ == nullptr && return this->sensitiveTopicListShrink_ == nullptr && return this->sensitiveTopicModelInstanceId_ == nullptr && return this->sensitiveWordListShrink_ == nullptr
        && return this->topicConfigInfoListShrink_ == nullptr && return this->wordGroupInfoListShrink_ == nullptr && return this->workspaceId_ == nullptr; };
    ...
    inline UpdatePolicyShrinkRequest& setContentSafeModelInstanceId(int64_t contentSafeModelInstanceId) { DARABONBA_PTR_SET_VALUE(contentSafeModelInstanceId_, contentSafeModelInstanceId) };
    ...
    inline UpdatePolicyShrinkRequest& setEnableSensitiveInputCheck(int32_t enableSensitiveInputCheck) { DARABONBA_PTR_SET_VALUE(enableSensitiveInputCheck_, enableSensitiveInputCheck) };
    ...
    inline UpdatePolicyShrinkRequest& setEnableSensitiveOutputCheck(int32_t enableSensitiveOutputCheck) { DARABONBA_PTR_SET_VALUE(enableSensitiveOutputCheck_, enableSensitiveOutputCheck) };
    ...
    inline UpdatePolicyShrinkRequest& setHarmfulCategoryConfigInfoListShrink(string harmfulCategoryConfigInfoListShrink) { DARABONBA_PTR_SET_VALUE(harmfulCategoryConfigInfoListShrink_, harmfulCategoryConfigInfoListShrink) };
    ...
    inline UpdatePolicyShrinkRequest& setInputSafeAnswer(string inputSafeAnswer) { DARABONBA_PTR_SET_VALUE(inputSafeAnswer_, inputSafeAnswer) };
    ...
    inline UpdatePolicyShrinkRequest& setInputSafeAnswerSwitch(int32_t inputSafeAnswerSwitch) { DARABONBA_PTR_SET_VALUE(inputSafeAnswerSwitch_, inputSafeAnswerSwitch) };
    ...
    inline UpdatePolicyShrinkRequest& setIsSidecarPolicy(int32_t isSidecarPolicy) { DARABONBA_PTR_SET_VALUE(isSidecarPolicy_, isSidecarPolicy) };
    ...
    inline UpdatePolicyShrinkRequest& setOutputSafeAnswer(string outputSafeAnswer) { DARABONBA_PTR_SET_VALUE(outputSafeAnswer_, outputSafeAnswer) };
    ...
    inline UpdatePolicyShrinkRequest& setOutputSafeAnswerSwitch(int32_t outputSafeAnswerSwitch) { DARABONBA_PTR_SET_VALUE(outputSafeAnswerSwitch_, outputSafeAnswerSwitch) };
    ...
    inline UpdatePolicyShrinkRequest& setPolicyId(int64_t policyId) { DARABONBA_PTR_SET_VALUE(policyId_, policyId) };
    ...
    inline UpdatePolicyShrinkRequest& setPromptAttackInfoShrink(string promptAttackInfoShrink) { DARABONBA_PTR_SET_VALUE(promptAttackInfoShrink_, promptAttackInfoShrink) };
    ...
    inline UpdatePolicyShrinkRequest& setPromptAttackInfoListShrink(string promptAttackInfoListShrink) { DARABONBA_PTR_SET_VALUE(promptAttackInfoListShrink_, promptAttackInfoListShrink) };
    ...
    inline UpdatePolicyShrinkRequest& setPromptAttackModelInstanceId(int64_t promptAttackModelInstanceId) { DARABONBA_PTR_SET_VALUE(promptAttackModelInstanceId_, promptAttackModelInstanceId) };
    ...
    inline UpdatePolicyShrinkRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline UpdatePolicyShrinkRequest& setRegularExpressListShrink(string regularExpressListShrink) { DARABONBA_PTR_SET_VALUE(regularExpressListShrink_, regularExpressListShrink) };
    ...
    inline UpdatePolicyShrinkRequest& setSceneType(int32_t sceneType) { DARABONBA_PTR_SET_VALUE(sceneType_, sceneType) };
    ...
    inline UpdatePolicyShrinkRequest& setSensitiveConfigListShrink(string sensitiveConfigListShrink) { DARABONBA_PTR_SET_VALUE(sensitiveConfigListShrink_, sensitiveConfigListShrink) };
    ...
    inline UpdatePolicyShrinkRequest& setSensitiveTopicListShrink(string sensitiveTopicListShrink) { DARABONBA_PTR_SET_VALUE(sensitiveTopicListShrink_, sensitiveTopicListShrink) };
    ...
    inline UpdatePolicyShrinkRequest& setSensitiveTopicModelInstanceId(int64_t sensitiveTopicModelInstanceId) { DARABONBA_PTR_SET_VALUE(sensitiveTopicModelInstanceId_, sensitiveTopicModelInstanceId) };
    ...
    inline UpdatePolicyShrinkRequest& setSensitiveWordListShrink(string sensitiveWordListShrink) { DARABONBA_PTR_SET_VALUE(sensitiveWordListShrink_, sensitiveWordListShrink) };
    ...
    inline UpdatePolicyShrinkRequest& setTopicConfigInfoListShrink(string topicConfigInfoListShrink) { DARABONBA_PTR_SET_VALUE(topicConfigInfoListShrink_, topicConfigInfoListShrink) };
    ...
    inline UpdatePolicyShrinkRequest& setWordGroupInfoListShrink(string wordGroupInfoListShrink) { DARABONBA_PTR_SET_VALUE(wordGroupInfoListShrink_, wordGroupInfoListShrink) };
    ...
    inline UpdatePolicyShrinkRequest& setWorkspaceId(int64_t workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
