...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->fromExecTime_ == nullptr
        && this->fromStartTime_ == nullptr && this->instanceId_ == nullptr && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr && this->resourceOwnerAccount_ == nullptr
        && this->resourceOwnerId_ == nullptr && this->status_ == nullptr && this->taskId_ == nullptr && this->taskType_ == nullptr && this->toExecTime_ == nullptr
        && this->toStartTime_ == nullptr; };
    ...
    inline DescribeHistoryTasksStatRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
