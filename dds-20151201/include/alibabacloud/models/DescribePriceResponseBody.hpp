  ...
  public:
    ...
    public:
      ...
      public:
        friend void to_json(Darabonba::Json& j, const SubOrder& obj) { 
          ...
          DARABONBA_PTR_TO_JSON(IsNewOfficialActivity, isNewOfficialActivity_);
        ...
        friend void from_json(const Darabonba::Json& j, SubOrder& obj) { 
          ...
          DARABONBA_PTR_FROM_JSON(IsNewOfficialActivity, isNewOfficialActivity_);
        ...
        public:
          ...
          public:
            friend void to_json(Darabonba::Json& j, const OptionalPromotion& obj) { 
              ...
              DARABONBA_PTR_TO_JSON(PromotionRuleIdList, promotionRuleIdList_);
              DARABONBA_PTR_TO_JSON(Selected, selected_);
              DARABONBA_PTR_TO_JSON(Show, show_);
              DARABONBA_PTR_TO_JSON(TargetArticleItemCodes, targetArticleItemCodes_);
            };
            friend void from_json(const Darabonba::Json& j, OptionalPromotion& obj) { 
              ...
              DARABONBA_PTR_FROM_JSON(PromotionRuleIdList, promotionRuleIdList_);
              DARABONBA_PTR_FROM_JSON(Selected, selected_);
              DARABONBA_PTR_FROM_JSON(Show, show_);
              DARABONBA_PTR_FROM_JSON(TargetArticleItemCodes, targetArticleItemCodes_);
            };
            ...
            virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
            virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
            class TargetArticleItemCodes : public Darabonba::Model {
            public:
              friend void to_json(Darabonba::Json& j, const TargetArticleItemCodes& obj) { 
                DARABONBA_PTR_TO_JSON(targetArticleItemCode, targetArticleItemCode_);
              };
              friend void from_json(const Darabonba::Json& j, TargetArticleItemCodes& obj) { 
                DARABONBA_PTR_FROM_JSON(targetArticleItemCode, targetArticleItemCode_);
              };
              TargetArticleItemCodes() = default ;
              TargetArticleItemCodes(const TargetArticleItemCodes &) = default ;
              TargetArticleItemCodes(TargetArticleItemCodes &&) = default ;
              TargetArticleItemCodes(const Darabonba::Json & obj) { from_json(obj, *this); };
              virtual ~TargetArticleItemCodes() = default ;
              TargetArticleItemCodes& operator=(const TargetArticleItemCodes &) = default ;
              TargetArticleItemCodes& operator=(TargetArticleItemCodes &&) = default ;
              virtual void validate() const override {
              };
              virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
              virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
              virtual bool empty() const override { return this->targetArticleItemCode_ == nullptr; };
              // targetArticleItemCode Field Functions 
              bool hasTargetArticleItemCode() const { return this->targetArticleItemCode_ != nullptr;};
              void deleteTargetArticleItemCode() { this->targetArticleItemCode_ = nullptr;};
              inline const vector<string> & getTargetArticleItemCode() const { DARABONBA_PTR_GET_CONST(targetArticleItemCode_, vector<string>) };
              inline vector<string> getTargetArticleItemCode() { DARABONBA_PTR_GET(targetArticleItemCode_, vector<string>) };
              inline TargetArticleItemCodes& setTargetArticleItemCode(const vector<string> & targetArticleItemCode) { DARABONBA_PTR_SET_VALUE(targetArticleItemCode_, targetArticleItemCode) };
              inline TargetArticleItemCodes& setTargetArticleItemCode(vector<string> && targetArticleItemCode) { DARABONBA_PTR_SET_RVALUE(targetArticleItemCode_, targetArticleItemCode) };


            protected:
              shared_ptr<vector<string>> targetArticleItemCode_ {};
            };

            class PromotionRuleIdList : public Darabonba::Model {
            public:
              friend void to_json(Darabonba::Json& j, const PromotionRuleIdList& obj) { 
                DARABONBA_PTR_TO_JSON(promotionRuleId, promotionRuleId_);
              };
              friend void from_json(const Darabonba::Json& j, PromotionRuleIdList& obj) { 
                DARABONBA_PTR_FROM_JSON(promotionRuleId, promotionRuleId_);
              };
              PromotionRuleIdList() = default ;
              PromotionRuleIdList(const PromotionRuleIdList &) = default ;
              PromotionRuleIdList(PromotionRuleIdList &&) = default ;
              PromotionRuleIdList(const Darabonba::Json & obj) { from_json(obj, *this); };
              virtual ~PromotionRuleIdList() = default ;
              PromotionRuleIdList& operator=(const PromotionRuleIdList &) = default ;
              PromotionRuleIdList& operator=(PromotionRuleIdList &&) = default ;
              virtual void validate() const override {
              };
              virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
              virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
              virtual bool empty() const override { return this->promotionRuleId_ == nullptr; };
              // promotionRuleId Field Functions 
              bool hasPromotionRuleId() const { return this->promotionRuleId_ != nullptr;};
              void deletePromotionRuleId() { this->promotionRuleId_ = nullptr;};
              inline const vector<string> & getPromotionRuleId() const { DARABONBA_PTR_GET_CONST(promotionRuleId_, vector<string>) };
              inline vector<string> getPromotionRuleId() { DARABONBA_PTR_GET(promotionRuleId_, vector<string>) };
              inline PromotionRuleIdList& setPromotionRuleId(const vector<string> & promotionRuleId) { DARABONBA_PTR_SET_VALUE(promotionRuleId_, promotionRuleId) };
              inline PromotionRuleIdList& setPromotionRuleId(vector<string> && promotionRuleId) { DARABONBA_PTR_SET_RVALUE(promotionRuleId_, promotionRuleId) };


            protected:
              shared_ptr<vector<string>> promotionRuleId_ {};
            };

            virtual bool empty() const override { return this->activityCategory_ == nullptr
        && this->activityExtInfo_ == nullptr && this->canPromFee_ == nullptr && this->optionCode_ == nullptr && this->promotionName_ == nullptr && this->promotionOptionNo_ == nullptr
        && this->promotionRuleIdList_ == nullptr && this->selected_ == nullptr && this->show_ == nullptr && this->targetArticleItemCodes_ == nullptr; };
            ...
            inline OptionalPromotion& setActivityCategory(string activityCategory) { DARABONBA_PTR_SET_VALUE(activityCategory_, activityCategory) };
            ...
            inline OptionalPromotion& setCanPromFee(double canPromFee) { DARABONBA_PTR_SET_VALUE(canPromFee_, canPromFee) };
            ...
            // promotionRuleIdList Field Functions 
            bool hasPromotionRuleIdList() const { return this->promotionRuleIdList_ != nullptr;};
            void deletePromotionRuleIdList() { this->promotionRuleIdList_ = nullptr;};
            inline const OptionalPromotion::PromotionRuleIdList & getPromotionRuleIdList() const { DARABONBA_PTR_GET_CONST(promotionRuleIdList_, OptionalPromotion::PromotionRuleIdList) };
            inline OptionalPromotion::PromotionRuleIdList getPromotionRuleIdList() { DARABONBA_PTR_GET(promotionRuleIdList_, OptionalPromotion::PromotionRuleIdList) };
            inline OptionalPromotion& setPromotionRuleIdList(const OptionalPromotion::PromotionRuleIdList & promotionRuleIdList) { DARABONBA_PTR_SET_VALUE(promotionRuleIdList_, promotionRuleIdList) };
            inline OptionalPromotion& setPromotionRuleIdList(OptionalPromotion::PromotionRuleIdList && promotionRuleIdList) { DARABONBA_PTR_SET_RVALUE(promotionRuleIdList_, promotionRuleIdList) };
            ...
            // targetArticleItemCodes Field Functions 
            bool hasTargetArticleItemCodes() const { return this->targetArticleItemCodes_ != nullptr;};
            void deleteTargetArticleItemCodes() { this->targetArticleItemCodes_ = nullptr;};
            inline const OptionalPromotion::TargetArticleItemCodes & getTargetArticleItemCodes() const { DARABONBA_PTR_GET_CONST(targetArticleItemCodes_, OptionalPromotion::TargetArticleItemCodes) };
            inline OptionalPromotion::TargetArticleItemCodes getTargetArticleItemCodes() { DARABONBA_PTR_GET(targetArticleItemCodes_, OptionalPromotion::TargetArticleItemCodes) };
            inline OptionalPromotion& setTargetArticleItemCodes(const OptionalPromotion::TargetArticleItemCodes & targetArticleItemCodes) { DARABONBA_PTR_SET_VALUE(targetArticleItemCodes_, targetArticleItemCodes) };
            inline OptionalPromotion& setTargetArticleItemCodes(OptionalPromotion::TargetArticleItemCodes && targetArticleItemCodes) { DARABONBA_PTR_SET_RVALUE(targetArticleItemCodes_, targetArticleItemCodes) };
        ...
        public:
          ...
          public:
            friend void to_json(Darabonba::Json& j, const ModuleInstanceItem& obj) { 
              DARABONBA_PTR_TO_JSON(ContractActivity, contractActivity_);
              DARABONBA_PTR_TO_JSON(CycleFee, cycleFee_);
              DARABONBA_PTR_TO_JSON(DepreciateInfo, depreciateInfo_);
              ...
              DARABONBA_PTR_TO_JSON(UnitPriceUnit4Buy, unitPriceUnit4Buy_);
            ...
            friend void from_json(const Darabonba::Json& j, ModuleInstanceItem& obj) { 
              DARABONBA_PTR_FROM_JSON(ContractActivity, contractActivity_);
              DARABONBA_PTR_FROM_JSON(CycleFee, cycleFee_);
              DARABONBA_PTR_FROM_JSON(DepreciateInfo, depreciateInfo_);
              ...
              DARABONBA_PTR_FROM_JSON(UnitPriceUnit4Buy, unitPriceUnit4Buy_);
        ...
        && this->name_ == nullptr && this->type_ == nullptr && this->value_ == nullptr; };
                ...
                inline ModuleAttr& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
        ...
        && this->listPrice_ == nullptr && this->monthPrice_ == nullptr && this->originalStandAmount_ == nullptr; };
              ...
              inline string getIsShow() const { DARABONBA_PTR_GET_DEFAULT(isShow_, "") };
              inline DepreciateInfo& setIsShow(string isShow) { DARABONBA_PTR_SET_VALUE(isShow_, isShow) };
        ...
        && this->cycleFee_ == nullptr && this->depreciateInfo_ == nullptr && this->discountFee_ == nullptr && this->moduleAttrs_ == nullptr && this->moduleCode_ == nullptr
        && this->moduleId_ == nullptr && this->moduleName_ == nullptr && this->needOrderPay_ == nullptr && this->payFee_ == nullptr && this->pricingModule_ == nullptr
        && this->promDetailList_ == nullptr && this->standDiscountPrice_ == nullptr && this->standPrice_ == nullptr && this->totalProductFee_ == nullptr && this->unitPriceUnit4Buy_ == nullptr
        && this->priceType_ == nullptr && this->priceUnit_ == nullptr; };
            ...
            // cycleFee Field Functions 
            bool hasCycleFee() const { return this->cycleFee_ != nullptr;};
            void deleteCycleFee() { this->cycleFee_ = nullptr;};
            inline string getCycleFee() const { DARABONBA_PTR_GET_DEFAULT(cycleFee_, "") };
            inline ModuleInstanceItem& setCycleFee(string cycleFee) { DARABONBA_PTR_SET_VALUE(cycleFee_, cycleFee) };
            ...
            inline string getDiscountFee() const { DARABONBA_PTR_GET_DEFAULT(discountFee_, "") };
            inline ModuleInstanceItem& setDiscountFee(string discountFee) { DARABONBA_PTR_SET_VALUE(discountFee_, discountFee) };
            ...
            inline ModuleInstanceItem& setModuleId(int64_t moduleId) { DARABONBA_PTR_SET_VALUE(moduleId_, moduleId) };
            ...
            inline const ModuleInstanceItem::PromDetailList & getPromDetailList() const { DARABONBA_PTR_GET_CONST(promDetailList_, ModuleInstanceItem::PromDetailList) };
            inline ModuleInstanceItem::PromDetailList getPromDetailList() { DARABONBA_PTR_GET(promDetailList_, ModuleInstanceItem::PromDetailList) };
            inline ModuleInstanceItem& setPromDetailList(const ModuleInstanceItem::PromDetailList & promDetailList) { DARABONBA_PTR_SET_VALUE(promDetailList_, promDetailList) };
            inline ModuleInstanceItem& setPromDetailList(ModuleInstanceItem::PromDetailList && promDetailList) { DARABONBA_PTR_SET_RVALUE(promDetailList_, promDetailList) };
            ...
            inline double getStandDiscountPrice() const { DARABONBA_PTR_GET_DEFAULT(standDiscountPrice_, 0.0) };
            inline ModuleInstanceItem& setStandDiscountPrice(double standDiscountPrice) { DARABONBA_PTR_SET_VALUE(standDiscountPrice_, standDiscountPrice) };
            ...
            // unitPriceUnit4Buy Field Functions 
            bool hasUnitPriceUnit4Buy() const { return this->unitPriceUnit4Buy_ != nullptr;};
            void deleteUnitPriceUnit4Buy() { this->unitPriceUnit4Buy_ = nullptr;};
            inline string getUnitPriceUnit4Buy() const { DARABONBA_PTR_GET_DEFAULT(unitPriceUnit4Buy_, "") };
            inline ModuleInstanceItem& setUnitPriceUnit4Buy(string unitPriceUnit4Buy) { DARABONBA_PTR_SET_VALUE(unitPriceUnit4Buy_, unitPriceUnit4Buy) };
            ...
            inline ModuleInstanceItem& setPriceType(string priceType) { DARABONBA_PTR_SET_VALUE(priceType_, priceType) };
            ...
            inline ModuleInstanceItem& setPriceUnit(string priceUnit) { DARABONBA_PTR_SET_VALUE(priceUnit_, priceUnit) };
        ...
        && this->isShow_ == nullptr && this->listPrice_ == nullptr && this->monthPrice_ == nullptr && this->originalStandAmount_ == nullptr && this->startTime_ == nullptr; };
          // cheapRate Field Functions 
          bool hasCheapRate() const { return this->cheapRate_ != nullptr;};
          void deleteCheapRate() { this->cheapRate_ = nullptr;};
          inline double getCheapRate() const { DARABONBA_PTR_GET_DEFAULT(cheapRate_, 0.0) };
        ...
        virtual bool empty() const override { return this->contractActivity_ == nullptr
        && this->depreciateInfo_ == nullptr && this->discountAmount_ == nullptr && this->instanceId_ == nullptr && this->isContractActivity_ == nullptr && this->isNewOfficialActivity_ == nullptr
        && this->moduleInstance_ == nullptr && this->optionalPromotions_ == nullptr && this->originalAmount_ == nullptr && this->promDetailList_ == nullptr && this->ruleIds_ == nullptr
        ...
        // isNewOfficialActivity Field Functions 
        bool hasIsNewOfficialActivity() const { return this->isNewOfficialActivity_ != nullptr;};
        void deleteIsNewOfficialActivity() { this->isNewOfficialActivity_ = nullptr;};
        inline string getIsNewOfficialActivity() const { DARABONBA_PTR_GET_DEFAULT(isNewOfficialActivity_, "") };
        inline SubOrder& setIsNewOfficialActivity(string isNewOfficialActivity) { DARABONBA_PTR_SET_VALUE(isNewOfficialActivity_, isNewOfficialActivity) };
        ...
        void deleteStandDiscountPrice() { this->standDiscountPrice_ = nullptr;};
        inline double getStandDiscountPrice() const { DARABONBA_PTR_GET_DEFAULT(standDiscountPrice_, 0.0) };
        inline SubOrder& setStandDiscountPrice(double standDiscountPrice) { DARABONBA_PTR_SET_VALUE(standDiscountPrice_, standDiscountPrice) };
        ...
        void deleteStandPrice() { this->standPrice_ = nullptr;};
        inline double getStandPrice() const { DARABONBA_PTR_GET_DEFAULT(standPrice_, 0.0) };
        inline SubOrder& setStandPrice(double standPrice) { DARABONBA_PTR_SET_VALUE(standPrice_, standPrice) };
    ...
    public:
      friend void to_json(Darabonba::Json& j, const Order& obj) { 
        ...
        DARABONBA_PTR_TO_JSON(StandDiscountPrice, standDiscountPrice_);
        DARABONBA_PTR_TO_JSON(StandPrice, standPrice_);
        DARABONBA_PTR_TO_JSON(TotalCostAmount, totalCostAmount_);
        DARABONBA_PTR_TO_JSON(TradeAmount, tradeAmount_);
      };
      friend void from_json(const Darabonba::Json& j, Order& obj) { 
        ...
        DARABONBA_PTR_FROM_JSON(StandDiscountPrice, standDiscountPrice_);
        DARABONBA_PTR_FROM_JSON(StandPrice, standPrice_);
        DARABONBA_PTR_FROM_JSON(TotalCostAmount, totalCostAmount_);
        DARABONBA_PTR_FROM_JSON(TradeAmount, tradeAmount_);
      };
      Order() = default ;
      ...
      public:
        ...
        public:
          ...
          public:
            ...
            bool hasPromotionRuleId() const { return this->promotionRuleId_ != nullptr;};
            void deletePromotionRuleId() { this->promotionRuleId_ = nullptr;};
            inline const vector<int64_t> & getPromotionRuleId() const { DARABONBA_PTR_GET_CONST(promotionRuleId_, vector<int64_t>) };
            inline vector<int64_t> getPromotionRuleId() { DARABONBA_PTR_GET(promotionRuleId_, vector<int64_t>) };
            inline PromotionRuleIdList& setPromotionRuleId(const vector<int64_t> & promotionRuleId) { DARABONBA_PTR_SET_VALUE(promotionRuleId_, promotionRuleId) };
            inline PromotionRuleIdList& setPromotionRuleId(vector<int64_t> && promotionRuleId) { DARABONBA_PTR_SET_RVALUE(promotionRuleId_, promotionRuleId) };


          protected:
            shared_ptr<vector<int64_t>> promotionRuleId_ {};
          };
        ...
        && this->promotionOptionCode_ == nullptr && this->promotionRuleIdList_ == nullptr; };
          ...
          void deleteOptionCode() { this->optionCode_ = nullptr;};
          inline string getOptionCode() const { DARABONBA_PTR_GET_DEFAULT(optionCode_, "") };
          inline Coupon& setOptionCode(string optionCode) { DARABONBA_PTR_SET_VALUE(optionCode_, optionCode) };
          ...
          inline Coupon& setPromotionOptionCode(string promotionOptionCode) { DARABONBA_PTR_SET_VALUE(promotionOptionCode_, promotionOptionCode) };


          // promotionRuleIdList Field Functions 
          bool hasPromotionRuleIdList() const { return this->promotionRuleIdList_ != nullptr;};
          void deletePromotionRuleIdList() { this->promotionRuleIdList_ = nullptr;};
          inline const Coupon::PromotionRuleIdList & getPromotionRuleIdList() const { DARABONBA_PTR_GET_CONST(promotionRuleIdList_, Coupon::PromotionRuleIdList) };
          inline Coupon::PromotionRuleIdList getPromotionRuleIdList() { DARABONBA_PTR_GET(promotionRuleIdList_, Coupon::PromotionRuleIdList) };
          inline Coupon& setPromotionRuleIdList(const Coupon::PromotionRuleIdList & promotionRuleIdList) { DARABONBA_PTR_SET_VALUE(promotionRuleIdList_, promotionRuleIdList) };
          inline Coupon& setPromotionRuleIdList(Coupon::PromotionRuleIdList && promotionRuleIdList) { DARABONBA_PTR_SET_RVALUE(promotionRuleIdList_, promotionRuleIdList) };
      ...
      virtual bool empty() const override { return this->code_ == nullptr
        && this->contractActivity_ == nullptr && this->coupons_ == nullptr && this->currency_ == nullptr && this->depreciateInfo_ == nullptr && this->discountAmount_ == nullptr
        && this->isContractActivity_ == nullptr && this->message_ == nullptr && this->optionalPromotions_ == nullptr && this->originalAmount_ == nullptr && this->promDetailList_ == nullptr
        && this->ruleIds_ == nullptr && this->showDiscountInfo_ == nullptr && this->standDiscountPrice_ == nullptr && this->standPrice_ == nullptr && this->totalCostAmount_ == nullptr
      ...
      void deleteContractActivity() { this->contractActivity_ = nullptr;};
      inline bool getContractActivity() const { DARABONBA_PTR_GET_DEFAULT(contractActivity_, false) };
      inline Order& setContractActivity(bool contractActivity) { DARABONBA_PTR_SET_VALUE(contractActivity_, contractActivity) };
      ...
      bool hasOptionalPromotions() const { return this->optionalPromotions_ != nullptr;};
      void deleteOptionalPromotions() { this->optionalPromotions_ = nullptr;};
      inline string getOptionalPromotions() const { DARABONBA_PTR_GET_DEFAULT(optionalPromotions_, "") };
      inline Order& setOptionalPromotions(string optionalPromotions) { DARABONBA_PTR_SET_VALUE(optionalPromotions_, optionalPromotions) };
      ...
      bool hasPromDetailList() const { return this->promDetailList_ != nullptr;};
      void deletePromDetailList() { this->promDetailList_ = nullptr;};
      inline string getPromDetailList() const { DARABONBA_PTR_GET_DEFAULT(promDetailList_, "") };
      inline Order& setPromDetailList(string promDetailList) { DARABONBA_PTR_SET_VALUE(promDetailList_, promDetailList) };
      ...
      void deleteStandDiscountPrice() { this->standDiscountPrice_ = nullptr;};
      inline double getStandDiscountPrice() const { DARABONBA_PTR_GET_DEFAULT(standDiscountPrice_, 0.0) };
      inline Order& setStandDiscountPrice(double standDiscountPrice) { DARABONBA_PTR_SET_VALUE(standDiscountPrice_, standDiscountPrice) };
      ...
      void deleteStandPrice() { this->standPrice_ = nullptr;};
      inline double getStandPrice() const { DARABONBA_PTR_GET_DEFAULT(standPrice_, 0.0) };
      inline Order& setStandPrice(double standPrice) { DARABONBA_PTR_SET_VALUE(standPrice_, standPrice) };


      // totalCostAmount Field Functions 
      bool hasTotalCostAmount() const { return this->totalCostAmount_ != nullptr;};
      void deleteTotalCostAmount() { this->totalCostAmount_ = nullptr;};
      inline double getTotalCostAmount() const { DARABONBA_PTR_GET_DEFAULT(totalCostAmount_, 0.0) };
      inline Order& setTotalCostAmount(double totalCostAmount) { DARABONBA_PTR_SET_VALUE(totalCostAmount_, totalCostAmount) };
    ...
    virtual bool empty() const override { return this->order_ == nullptr
        && this->orderParams_ == nullptr && this->requestId_ == nullptr && this->rules_ == nullptr && this->subOrders_ == nullptr && this->traceId_ == nullptr; };
    ...
    inline DescribePriceResponseBody& setTraceId(string traceId) { DARABONBA_PTR_SET_VALUE(traceId_, traceId) };
