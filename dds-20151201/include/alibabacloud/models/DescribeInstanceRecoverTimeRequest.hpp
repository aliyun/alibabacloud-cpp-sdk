...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceId_ == nullptr
        ...
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->securityToken_ == nullptr && this->srcRegion_ == nullptr; };
    ...
    inline DescribeInstanceRecoverTimeRequest& setOnlyDbTableRecovery(bool onlyDbTableRecovery) { DARABONBA_PTR_SET_VALUE(onlyDbTableRecovery_, onlyDbTableRecovery) };
