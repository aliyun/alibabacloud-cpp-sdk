...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBInstanceAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBInstanceAttributeResponseBody) };
    inline ModifyDBInstanceAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBInstanceAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBInstanceAttributeResponseBody> body_ {};
  };
