...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyBackupPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyBackupPolicyResponseBody) };
    inline ModifyBackupPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyBackupPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyBackupPolicyResponseBody> body_ {};
  };
