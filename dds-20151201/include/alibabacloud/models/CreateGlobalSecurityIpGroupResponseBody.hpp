...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup> & getGlobalSecurityIPGroup() const { DARABONBA_PTR_GET_CONST(globalSecurityIPGroup_, vector<CreateGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup>) };
    inline vector<CreateGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup> getGlobalSecurityIPGroup() { DARABONBA_PTR_GET(globalSecurityIPGroup_, vector<CreateGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup>) };
    inline CreateGlobalSecurityIPGroupResponseBody& setGlobalSecurityIPGroup(const vector<CreateGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup> & globalSecurityIPGroup) { DARABONBA_PTR_SET_VALUE(globalSecurityIPGroup_, globalSecurityIPGroup) };
    inline CreateGlobalSecurityIPGroupResponseBody& setGlobalSecurityIPGroup(vector<CreateGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup> && globalSecurityIPGroup) { DARABONBA_PTR_SET_RVALUE(globalSecurityIPGroup_, globalSecurityIPGroup) };
  ...
  protected:
    ...
    shared_ptr<vector<CreateGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup>> globalSecurityIPGroup_ {};
    // The request ID.
