  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->checkingCode_ == nullptr && this->forceRestart_ == nullptr && this->modifiableStatus_ == nullptr && this->parameterDescription_ == nullptr && this->parameterName_ == nullptr
        ...
        inline Parameter& setCharacterType(string characterType) { DARABONBA_PTR_SET_VALUE(characterType_, characterType) };
