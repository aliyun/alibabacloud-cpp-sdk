...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyDBInstanceConnectionStringResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(ModifiedConnectionString, modifiedConnectionString_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ModifyDBInstanceConnectionStringResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(ModifiedConnectionString, modifiedConnectionString_);
    ...
    virtual bool empty() const override { return this->modifiedConnectionString_ == nullptr
        && this->requestId_ == nullptr; };
    // modifiedConnectionString Field Functions 
    bool hasModifiedConnectionString() const { return this->modifiedConnectionString_ != nullptr;};
    void deleteModifiedConnectionString() { this->modifiedConnectionString_ = nullptr;};
    inline string getModifiedConnectionString() const { DARABONBA_PTR_GET_DEFAULT(modifiedConnectionString_, "") };
    inline ModifyDBInstanceConnectionStringResponseBody& setModifiedConnectionString(string modifiedConnectionString) { DARABONBA_PTR_SET_VALUE(modifiedConnectionString_, modifiedConnectionString) };
