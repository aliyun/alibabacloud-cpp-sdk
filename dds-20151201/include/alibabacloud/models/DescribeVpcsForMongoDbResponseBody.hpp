...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEVPCSFORMONGODBRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEVPCSFORMONGODBRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeVpcsForMongoDBResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeVpcsForMongoDBResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeVpcsForMongoDBResponseBody& obj) { 
    ...
    DescribeVpcsForMongoDBResponseBody() = default ;
    DescribeVpcsForMongoDBResponseBody(const DescribeVpcsForMongoDBResponseBody &) = default ;
    DescribeVpcsForMongoDBResponseBody(DescribeVpcsForMongoDBResponseBody &&) = default ;
    DescribeVpcsForMongoDBResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeVpcsForMongoDBResponseBody() = default ;
    DescribeVpcsForMongoDBResponseBody& operator=(const DescribeVpcsForMongoDBResponseBody &) = default ;
    DescribeVpcsForMongoDBResponseBody& operator=(DescribeVpcsForMongoDBResponseBody &&) = default ;
    ...
    inline DescribeVpcsForMongoDBResponseBody& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline DescribeVpcsForMongoDBResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline DescribeVpcsForMongoDBResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeVpcsForMongoDBResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };


    // vpcs Field Functions 
    bool hasVpcs() const { return this->vpcs_ != nullptr;};
    void deleteVpcs() { this->vpcs_ = nullptr;};
    inline const vector<DescribeVpcsForMongoDBResponseBody::Vpcs> & getVpcs() const { DARABONBA_PTR_GET_CONST(vpcs_, vector<DescribeVpcsForMongoDBResponseBody::Vpcs>) };
    inline vector<DescribeVpcsForMongoDBResponseBody::Vpcs> getVpcs() { DARABONBA_PTR_GET(vpcs_, vector<DescribeVpcsForMongoDBResponseBody::Vpcs>) };
    inline DescribeVpcsForMongoDBResponseBody& setVpcs(const vector<DescribeVpcsForMongoDBResponseBody::Vpcs> & vpcs) { DARABONBA_PTR_SET_VALUE(vpcs_, vpcs) };
    inline DescribeVpcsForMongoDBResponseBody& setVpcs(vector<DescribeVpcsForMongoDBResponseBody::Vpcs> && vpcs) { DARABONBA_PTR_SET_RVALUE(vpcs_, vpcs) };
