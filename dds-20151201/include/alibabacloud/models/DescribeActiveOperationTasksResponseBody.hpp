  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->allowCancel_ == nullptr
        ...
        && this->impactEn_ == nullptr && this->impactZh_ == nullptr && this->insComment_ == nullptr && this->insName_ == nullptr && this->modifiedTime_ == nullptr
        && this->prepareInterval_ == nullptr && this->region_ == nullptr && this->resultInfo_ == nullptr && this->startTime_ == nullptr && this->status_ == nullptr
        && this->subInsNames_ == nullptr && this->switchTime_ == nullptr && this->taskParams_ == nullptr && this->taskType_ == nullptr && this->taskTypeEn_ == nullptr
