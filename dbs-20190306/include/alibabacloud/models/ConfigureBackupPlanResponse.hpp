...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigureBackupPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigureBackupPlanResponseBody) };
    inline ConfigureBackupPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigureBackupPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigureBackupPlanResponseBody> body_ {};
  };
