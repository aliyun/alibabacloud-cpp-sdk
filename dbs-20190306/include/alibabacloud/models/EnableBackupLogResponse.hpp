...
namespace Models
{
  ...
  public:
    ...
    inline const EnableBackupLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableBackupLogResponseBody) };
    inline EnableBackupLogResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableBackupLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableBackupLogResponseBody> body_ {};
  };
