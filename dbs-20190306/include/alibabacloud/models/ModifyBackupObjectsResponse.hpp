...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyBackupObjectsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyBackupObjectsResponseBody) };
    inline ModifyBackupObjectsResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyBackupObjectsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyBackupObjectsResponseBody> body_ {};
  };
