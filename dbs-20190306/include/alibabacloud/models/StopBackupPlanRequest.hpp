...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backupPlanId_ == nullptr
        && return this->clientToken_ == nullptr && return this->ownerId_ == nullptr && return this->stopMethod_ == nullptr; };
    ...
    inline string stopMethod() const { DARABONBA_PTR_GET_DEFAULT(stopMethod_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> stopMethod_ = nullptr;
  };
