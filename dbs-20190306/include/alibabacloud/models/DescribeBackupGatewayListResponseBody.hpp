...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBackupGatewayListResponseBodyItems & items() const { DARABONBA_PTR_GET_CONST(items_, DescribeBackupGatewayListResponseBodyItems) };
    inline DescribeBackupGatewayListResponseBodyItems items() { DARABONBA_PTR_GET(items_, DescribeBackupGatewayListResponseBodyItems) };
    inline DescribeBackupGatewayListResponseBody& setItems(const DescribeBackupGatewayListResponseBodyItems & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeBackupGatewayListResponseBody& setItems(DescribeBackupGatewayListResponseBodyItems && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeBackupGatewayListResponseBodyItems> items_ = nullptr;
