...
namespace Models
{
  ...
  public:
    ...
    inline const RenewBackupPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RenewBackupPlanResponseBody) };
    inline RenewBackupPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, RenewBackupPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RenewBackupPlanResponseBody> body_ {};
  };
