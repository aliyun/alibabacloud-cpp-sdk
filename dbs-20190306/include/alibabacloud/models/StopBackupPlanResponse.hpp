...
namespace Models
{
  ...
  public:
    ...
    inline const StopBackupPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopBackupPlanResponseBody) };
    inline StopBackupPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, StopBackupPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopBackupPlanResponseBody> body_ {};
  };
