...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAndStartBackupPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAndStartBackupPlanResponseBody) };
    inline CreateAndStartBackupPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAndStartBackupPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAndStartBackupPlanResponseBody> body_ {};
  };
