...
namespace Models
{
  ...
  public:
    ...
    inline const GetDBListFromAgentResponseBodyDbList & dbList() const { DARABONBA_PTR_GET_CONST(dbList_, GetDBListFromAgentResponseBodyDbList) };
    inline GetDBListFromAgentResponseBodyDbList dbList() { DARABONBA_PTR_GET(dbList_, GetDBListFromAgentResponseBodyDbList) };
    inline GetDBListFromAgentResponseBody& setDbList(const GetDBListFromAgentResponseBodyDbList & dbList) { DARABONBA_PTR_SET_VALUE(dbList_, dbList) };
    inline GetDBListFromAgentResponseBody& setDbList(GetDBListFromAgentResponseBodyDbList && dbList) { DARABONBA_PTR_SET_RVALUE(dbList_, dbList) };
  ...
  protected:
    ...
    std::shared_ptr<GetDBListFromAgentResponseBodyDbList> dbList_ = nullptr;
    // The error code.
