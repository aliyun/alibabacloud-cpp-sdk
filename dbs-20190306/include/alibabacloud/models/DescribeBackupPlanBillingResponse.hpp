...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBackupPlanBillingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBackupPlanBillingResponseBody) };
    inline DescribeBackupPlanBillingResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBackupPlanBillingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBackupPlanBillingResponseBody> body_ {};
  };
