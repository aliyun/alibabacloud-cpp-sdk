...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backupGatewayId_ == nullptr
        && this->backupLogIntervalSeconds_ == nullptr && this->backupMethod_ == nullptr && this->backupObjects_ == nullptr && this->backupPeriod_ == nullptr && this->backupPlanId_ == nullptr
        ...
        && this->backupStorageType_ == nullptr && this->backupStrategyType_ == nullptr && this->clientToken_ == nullptr && this->crossAliyunId_ == nullptr && this->crossRoleName_ == nullptr
        && this->databaseRegion_ == nullptr && this->databaseType_ == nullptr && this->duplicationArchivePeriod_ == nullptr && this->duplicationInfrequentAccessPeriod_ == nullptr && this->enableBackupLog_ == nullptr
        && this->fromApp_ == nullptr && this->instanceClass_ == nullptr && this->instanceType_ == nullptr && this->OSSBucketName_ == nullptr && this->ownerId_ == nullptr
        && this->payType_ == nullptr && this->period_ == nullptr && this->region_ == nullptr && this->resourceGroupId_ == nullptr && this->sourceEndpointDatabaseName_ == nullptr
        ...
        && this->sourceEndpointPort_ == nullptr && this->sourceEndpointRegion_ == nullptr && this->sourceEndpointUserName_ == nullptr && this->storageRegion_ == nullptr && this->storageType_ == nullptr
