...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeJobErrorCodeResponseBodyItem & item() const { DARABONBA_PTR_GET_CONST(item_, DescribeJobErrorCodeResponseBodyItem) };
    inline DescribeJobErrorCodeResponseBodyItem item() { DARABONBA_PTR_GET(item_, DescribeJobErrorCodeResponseBodyItem) };
    inline DescribeJobErrorCodeResponseBody& setItem(const DescribeJobErrorCodeResponseBodyItem & item) { DARABONBA_PTR_SET_VALUE(item_, item) };
    inline DescribeJobErrorCodeResponseBody& setItem(DescribeJobErrorCodeResponseBodyItem && item) { DARABONBA_PTR_SET_RVALUE(item_, item) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeJobErrorCodeResponseBodyItem> item_ = nullptr;
