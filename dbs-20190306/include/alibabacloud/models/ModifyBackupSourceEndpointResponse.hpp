...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyBackupSourceEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyBackupSourceEndpointResponseBody) };
    inline ModifyBackupSourceEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyBackupSourceEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyBackupSourceEndpointResponseBody> body_ {};
  };
