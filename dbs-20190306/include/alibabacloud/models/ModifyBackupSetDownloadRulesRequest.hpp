...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backupGatewayId_ == nullptr
        && this->backupPlanId_ == nullptr && this->backupSetDownloadDir_ == nullptr && this->backupSetDownloadTargetType_ == nullptr && this->backupSetDownloadTargetTypeLocation_ == nullptr && this->clientToken_ == nullptr
        && this->fullDataFormat_ == nullptr && this->incrementDataFormat_ == nullptr && this->openAutoDownload_ == nullptr && this->ownerId_ == nullptr; };
    ...
    inline string getBackupSetDownloadTargetTypeLocation() const { DARABONBA_PTR_GET_DEFAULT(backupSetDownloadTargetTypeLocation_, "") };
    ...
    inline string getFullDataFormat() const { DARABONBA_PTR_GET_DEFAULT(fullDataFormat_, "") };
    ...
    inline string getIncrementDataFormat() const { DARABONBA_PTR_GET_DEFAULT(incrementDataFormat_, "") };
    ...
    inline bool getOpenAutoDownload() const { DARABONBA_PTR_GET_DEFAULT(openAutoDownload_, false) };
  ...
  protected:
    ...
    // 
    // > Default value: local.
    shared_ptr<string> backupSetDownloadTargetTypeLocation_ {};
    ...
    // 
    // > Default value: CSV.
    shared_ptr<string> fullDataFormat_ {};
