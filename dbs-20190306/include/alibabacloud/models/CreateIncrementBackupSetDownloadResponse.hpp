...
namespace Models
{
  ...
  public:
    ...
    inline const CreateIncrementBackupSetDownloadResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateIncrementBackupSetDownloadResponseBody) };
    inline CreateIncrementBackupSetDownloadResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateIncrementBackupSetDownloadResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateIncrementBackupSetDownloadResponseBody> body_ {};
  };
