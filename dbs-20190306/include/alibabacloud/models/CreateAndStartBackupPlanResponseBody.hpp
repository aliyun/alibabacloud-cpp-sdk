...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backupPlanId_ == nullptr
        && this->createBackupSet_ == nullptr && this->errCode_ == nullptr && this->errMessage_ == nullptr && this->httpStatusCode_ == nullptr && this->orderId_ == nullptr
    ...
    inline bool getCreateBackupSet() const { DARABONBA_PTR_GET_DEFAULT(createBackupSet_, false) };
  ...
  protected:
    ...
    // 
    // - **false**: Disabled
    shared_ptr<bool> createBackupSet_ {};
    // The error code.
