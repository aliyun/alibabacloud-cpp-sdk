...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyBackupStrategyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyBackupStrategyResponseBody) };
    inline ModifyBackupStrategyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyBackupStrategyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyBackupStrategyResponseBody> body_ {};
  };
