...
class ApplyForStreamAccessTokenRequest : public Darabonba::Model {
public:
  shared_ptr<string> agentKey{};

  ApplyForStreamAccessTokenRequest() {}

  explicit ApplyForStreamAccessTokenRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~ApplyForStreamAccessTokenRequest() = default;
};
...
public:
  ...
  shared_ptr<string> streamSecret{};

  ApplyForStreamAccessTokenResponseBody() {}

  explicit ApplyForStreamAccessTokenResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (streamSecret) {
      res["StreamSecret"] = boost::any(*streamSecret);
    }
    return res;
  }
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("StreamSecret") != m.end() && !m["StreamSecret"].empty()) {
      streamSecret = make_shared<string>(boost::any_cast<string>(m["StreamSecret"]));
    }
  }
...
public:
  ...
  shared_ptr<ApplyForStreamAccessTokenResponseBody> body{};

  ApplyForStreamAccessTokenResponse() {}

  explicit ApplyForStreamAccessTokenResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        ApplyForStreamAccessTokenResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<ApplyForStreamAccessTokenResponseBody>(model1);
      }
    }
  }
...
public:
  shared_ptr<long> asrMaxEndSilence{};
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("AsrMaxEndSilence") != m.end() && !m["AsrMaxEndSilence"].empty()) {
      asrMaxEndSilence = make_shared<long>(boost::any_cast<long>(m["AsrMaxEndSilence"]));
    }
...
public:
  ...
  explicit CreateDocRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  explicit CreateDocResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
class CreateDocResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<CreateDocResponseBody> body{};

  CreateDocResponse() {}

  explicit CreateDocResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        CreateDocResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<CreateDocResponseBody>(model1);
      }
    }
  }


  virtual ~CreateDocResponse() = default;
};
...
public:
  ...
  shared_ptr<long> paraNo{};
  shared_ptr<string> paraText{};
  shared_ptr<string> paraType{};

  DescribeDocResponseBodyDocInfoDocParas() {}

  explicit DescribeDocResponseBodyDocInfoDocParas(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (paraNo) {
      res["ParaNo"] = boost::any(*paraNo);
    }
    if (paraText) {
      res["ParaText"] = boost::any(*paraText);
    }
    if (paraType) {
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("ParaNo") != m.end() && !m["ParaNo"].empty()) {
      paraNo = make_shared<long>(boost::any_cast<long>(m["ParaNo"]));
    }
    if (m.find("ParaText") != m.end() && !m["ParaText"].empty()) {
      paraText = make_shared<string>(boost::any_cast<string>(m["ParaText"]));
    }
...
public:
  shared_ptr<vector<DescribeDocResponseBodyDocInfoDocParas>> docParas{};

  DescribeDocResponseBodyDocInfo() {}

  explicit DescribeDocResponseBodyDocInfo(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (docParas) {
      vector<boost::any> temp1;
      for(auto item1:*docParas){
        temp1.push_back(boost::any(item1.toMap()));
      }
      res["DocParas"] = boost::any(temp1);
    }
    return res;
  }

  void fromMap(map<string, boost::any> m) override {
    if (m.find("DocParas") != m.end() && !m["DocParas"].empty()) {
      if (typeid(vector<boost::any>) == m["DocParas"].type()) {
        vector<DescribeDocResponseBodyDocInfoDocParas> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["DocParas"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            DescribeDocResponseBodyDocInfoDocParas model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        docParas = make_shared<vector<DescribeDocResponseBodyDocInfoDocParas>>(expect1);
      }
    }
  }
...
public:
  ...
  shared_ptr<string> modifyUserName{};
  shared_ptr<bool> processCanRetry{};
  ...
  map<string, boost::any> toMap() override {
    ...
    if (processCanRetry) {
      res["ProcessCanRetry"] = boost::any(*processCanRetry);
    }
    if (processMessage) {
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("ProcessCanRetry") != m.end() && !m["ProcessCanRetry"].empty()) {
      processCanRetry = make_shared<bool>(boost::any_cast<bool>(m["ProcessCanRetry"]));
    }
...
public:
  ...
  explicit GetAgentInfoRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  GetAgentInfoResponseBodyData() {}

  explicit GetAgentInfoResponseBodyData(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
class GetAgentInfoResponseBody : public Darabonba::Model {
public:
  shared_ptr<GetAgentInfoResponseBodyData> data{};
  shared_ptr<string> message{};
  shared_ptr<string> requestId{};
  shared_ptr<bool> success{};
  ...
  explicit GetAgentInfoResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("Data") != m.end() && !m["Data"].empty()) {
      if (typeid(map<string, boost::any>) == m["Data"].type()) {
        GetAgentInfoResponseBodyData model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["Data"]));
        data = make_shared<GetAgentInfoResponseBodyData>(model1);
      }
    }
    if (m.find("Message") != m.end() && !m["Message"].empty()) {
      message = make_shared<string>(boost::any_cast<string>(m["Message"]));
  ...
  virtual ~GetAgentInfoResponseBody() = default;
};
class GetAgentInfoResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<GetAgentInfoResponseBody> body{};

  GetAgentInfoResponse() {}

  explicit GetAgentInfoResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        GetAgentInfoResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<GetAgentInfoResponseBody>(model1);
      }
    }
  }
...
public:
  ...
  shared_ptr<string> userAccessToken{};

  InitIMConnectRequest() {}

  explicit InitIMConnectRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (userAccessToken) {
      res["UserAccessToken"] = boost::any(*userAccessToken);
    }
    return res;
  }
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("UserAccessToken") != m.end() && !m["UserAccessToken"].empty()) {
      userAccessToken = make_shared<string>(boost::any_cast<string>(m["UserAccessToken"]));
    }
  }
...
public:
  ...
  InitIMConnectResponseBody() {}

  explicit InitIMConnectResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<InitIMConnectResponseBody> body{};

  InitIMConnectResponse() {}

  explicit InitIMConnectResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        InitIMConnectResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<InitIMConnectResponseBody>(model1);
      }
    }
  }
...
public:
  shared_ptr<string> agentKey{};
  shared_ptr<string> saasGroupCodes{};
  shared_ptr<string> saasName{};

  ListSaasInfoRequest() {}

  explicit ListSaasInfoRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (saasGroupCodes) {
      res["SaasGroupCodes"] = boost::any(*saasGroupCodes);
    }
    if (saasName) {
      res["SaasName"] = boost::any(*saasName);
    }
    return res;
  }
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("SaasGroupCodes") != m.end() && !m["SaasGroupCodes"].empty()) {
      saasGroupCodes = make_shared<string>(boost::any_cast<string>(m["SaasGroupCodes"]));
    }
    if (m.find("SaasName") != m.end() && !m["SaasName"].empty()) {
      saasName = make_shared<string>(boost::any_cast<string>(m["SaasName"]));
    }
  }
...
public:
  ...
  ListSaasInfoResponseBodyData() {}

  explicit ListSaasInfoResponseBodyData(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<vector<ListSaasInfoResponseBodyData>> data{};
  shared_ptr<string> requestId{};
  shared_ptr<string> saasToken{};

  ListSaasInfoResponseBody() {}

  explicit ListSaasInfoResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (saasToken) {
      res["SaasToken"] = boost::any(*saasToken);
    }
    return res;
  }
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("Data") != m.end() && !m["Data"].empty()) {
      if (typeid(vector<boost::any>) == m["Data"].type()) {
        vector<ListSaasInfoResponseBodyData> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["Data"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            ListSaasInfoResponseBodyData model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        data = make_shared<vector<ListSaasInfoResponseBodyData>>(expect1);
      }
    }
    if (m.find("RequestId") != m.end() && !m["RequestId"].empty()) {
      requestId = make_shared<string>(boost::any_cast<string>(m["RequestId"]));
    }
    if (m.find("SaasToken") != m.end() && !m["SaasToken"].empty()) {
      saasToken = make_shared<string>(boost::any_cast<string>(m["SaasToken"]));
    }
  }
...
class ListSaasInfoResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<ListSaasInfoResponseBody> body{};

  ListSaasInfoResponse() {}

  explicit ListSaasInfoResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        ListSaasInfoResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<ListSaasInfoResponseBody>(model1);
      }
    }
  }


  virtual ~ListSaasInfoResponse() = default;
};
...
public:
  ...
  explicit ListSaasPermissionGroupInfosRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<string> pgCode{};
  shared_ptr<string> pgEnName{};
  shared_ptr<string> pgName{};

  ListSaasPermissionGroupInfosResponseBodyDataPgInfos() {}

  explicit ListSaasPermissionGroupInfosResponseBodyDataPgInfos(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    map<string, boost::any> res;
    if (pgCode) {
      res["PgCode"] = boost::any(*pgCode);
    }
    if (pgEnName) {
      res["PgEnName"] = boost::any(*pgEnName);
    }
    if (pgName) {
      res["PgName"] = boost::any(*pgName);
    }
    return res;
  }

  void fromMap(map<string, boost::any> m) override {
    if (m.find("PgCode") != m.end() && !m["PgCode"].empty()) {
      pgCode = make_shared<string>(boost::any_cast<string>(m["PgCode"]));
    }
    if (m.find("PgEnName") != m.end() && !m["PgEnName"].empty()) {
      pgEnName = make_shared<string>(boost::any_cast<string>(m["PgEnName"]));
    }
    if (m.find("PgName") != m.end() && !m["PgName"].empty()) {
      pgName = make_shared<string>(boost::any_cast<string>(m["PgName"]));
    }
  }
...
public:
  shared_ptr<string> enName{};
  shared_ptr<string> name{};
  shared_ptr<vector<ListSaasPermissionGroupInfosResponseBodyDataPgInfos>> pgInfos{};
  shared_ptr<string> saasCode{};

  ListSaasPermissionGroupInfosResponseBodyData() {}

  explicit ListSaasPermissionGroupInfosResponseBodyData(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (pgInfos) {
      vector<boost::any> temp1;
      for(auto item1:*pgInfos){
        temp1.push_back(boost::any(item1.toMap()));
      }
      res["PgInfos"] = boost::any(temp1);
    }
    if (saasCode) {
      res["SaasCode"] = boost::any(*saasCode);
    }
    return res;
  }
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("PgInfos") != m.end() && !m["PgInfos"].empty()) {
      if (typeid(vector<boost::any>) == m["PgInfos"].type()) {
        vector<ListSaasPermissionGroupInfosResponseBodyDataPgInfos> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["PgInfos"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            ListSaasPermissionGroupInfosResponseBodyDataPgInfos model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        pgInfos = make_shared<vector<ListSaasPermissionGroupInfosResponseBodyDataPgInfos>>(expect1);
      }
    }
    if (m.find("SaasCode") != m.end() && !m["SaasCode"].empty()) {
      saasCode = make_shared<string>(boost::any_cast<string>(m["SaasCode"]));
    }
  }
...
public:
  shared_ptr<vector<ListSaasPermissionGroupInfosResponseBodyData>> data{};
  shared_ptr<string> requestId{};

  ListSaasPermissionGroupInfosResponseBody() {}

  explicit ListSaasPermissionGroupInfosResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("Data") != m.end() && !m["Data"].empty()) {
      if (typeid(vector<boost::any>) == m["Data"].type()) {
        vector<ListSaasPermissionGroupInfosResponseBodyData> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["Data"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            ListSaasPermissionGroupInfosResponseBodyData model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        data = make_shared<vector<ListSaasPermissionGroupInfosResponseBodyData>>(expect1);
      }
    }
    if (m.find("RequestId") != m.end() && !m["RequestId"].empty()) {
      requestId = make_shared<string>(boost::any_cast<string>(m["RequestId"]));
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<ListSaasPermissionGroupInfosResponseBody> body{};

  ListSaasPermissionGroupInfosResponse() {}

  explicit ListSaasPermissionGroupInfosResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        ListSaasPermissionGroupInfosResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<ListSaasPermissionGroupInfosResponseBody>(model1);
      }
    }
  }
...
public:
  ...
  explicit ListTongyiConversationLogsRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  ListTongyiConversationLogsResponseBody() {}

  explicit ListTongyiConversationLogsResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<ListTongyiConversationLogsResponseBody> body{};

  ListTongyiConversationLogsResponse() {}

  explicit ListTongyiConversationLogsResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        ListTongyiConversationLogsResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<ListTongyiConversationLogsResponseBody>(model1);
      }
    }
  }
...
public:
  ...
  explicit RetryDocRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  RetryDocResponseBody() {}

  explicit RetryDocResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
class RetryDocResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<RetryDocResponseBody> body{};

  RetryDocResponse() {}

  explicit RetryDocResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        RetryDocResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<RetryDocResponseBody>(model1);
      }
    }
  }


  virtual ~RetryDocResponse() = default;
};
...
public:
  ...
  explicit SearchDocRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  explicit SearchDocShrinkRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  SearchDocResponseBodyDocHits() {}

  explicit SearchDocResponseBodyDocHits(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<vector<SearchDocResponseBodyDocHits>> docHits{};
  shared_ptr<long> pageNumber{};
  shared_ptr<long> pageSize{};
  shared_ptr<string> requestId{};
  shared_ptr<long> totalCount{};

  SearchDocResponseBody() {}

  explicit SearchDocResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (docHits) {
      vector<boost::any> temp1;
      for(auto item1:*docHits){
        temp1.push_back(boost::any(item1.toMap()));
      }
      res["DocHits"] = boost::any(temp1);
    }
    if (pageNumber) {
      res["PageNumber"] = boost::any(*pageNumber);
    }
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("DocHits") != m.end() && !m["DocHits"].empty()) {
      if (typeid(vector<boost::any>) == m["DocHits"].type()) {
        vector<SearchDocResponseBodyDocHits> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["DocHits"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            SearchDocResponseBodyDocHits model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        docHits = make_shared<vector<SearchDocResponseBodyDocHits>>(expect1);
      }
    }
    if (m.find("PageNumber") != m.end() && !m["PageNumber"].empty()) {
      pageNumber = make_shared<long>(boost::any_cast<long>(m["PageNumber"]));
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<SearchDocResponseBody> body{};

  SearchDocResponse() {}

  explicit SearchDocResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        SearchDocResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<SearchDocResponseBody>(model1);
      }
    }
  }
...
public:
  ...
  explicit UpdateDocRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  explicit UpdateDocResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<UpdateDocResponseBody> body{};

  UpdateDocResponse() {}

  explicit UpdateDocResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        UpdateDocResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<UpdateDocResponseBody>(model1);
      }
    }
  }
...
public:
  ...
  ApplyForStreamAccessTokenResponse applyForStreamAccessTokenWithOptions(shared_ptr<ApplyForStreamAccessTokenRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  ApplyForStreamAccessTokenResponse applyForStreamAccessToken(shared_ptr<ApplyForStreamAccessTokenRequest> request);
  ...
  GetAgentInfoResponse getAgentInfoWithOptions(shared_ptr<GetAgentInfoRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  ...
  InitIMConnectResponse initIMConnectWithOptions(shared_ptr<InitIMConnectRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  InitIMConnectResponse initIMConnect(shared_ptr<InitIMConnectRequest> request);
  ...
  ListSaasInfoResponse listSaasInfoWithOptions(shared_ptr<ListSaasInfoRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  ListSaasInfoResponse listSaasInfo(shared_ptr<ListSaasInfoRequest> request);
  ListSaasPermissionGroupInfosResponse listSaasPermissionGroupInfosWithOptions(shared_ptr<ListSaasPermissionGroupInfosRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  ListSaasPermissionGroupInfosResponse listSaasPermissionGroupInfos(shared_ptr<ListSaasPermissionGroupInfosRequest> request);
  ...
  ListTongyiConversationLogsResponse listTongyiConversationLogsWithOptions(shared_ptr<ListTongyiConversationLogsRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  ListTongyiConversationLogsResponse listTongyiConversationLogs(shared_ptr<ListTongyiConversationLogsRequest> request);
  ...
  RetryDocResponse retryDocWithOptions(shared_ptr<RetryDocRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  RetryDocResponse retryDoc(shared_ptr<RetryDocRequest> request);
  SearchDocResponse searchDocWithOptions(shared_ptr<SearchDocRequest> tmpReq, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  SearchDocResponse searchDoc(shared_ptr<SearchDocRequest> request);
