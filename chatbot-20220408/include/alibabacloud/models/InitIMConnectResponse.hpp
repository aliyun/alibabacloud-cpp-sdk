...
namespace Models
{
  ...
  public:
    ...
    inline const InitIMConnectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InitIMConnectResponseBody) };
    inline InitIMConnectResponseBody getBody() { DARABONBA_PTR_GET(body_, InitIMConnectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InitIMConnectResponseBody> body_ {};
  };
