...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->createTime_ != nullptr
        && this->modifyTime_ != nullptr && this->name_ != nullptr && this->perspectiveCode_ != nullptr && this->perspectiveId_ != nullptr && this->requestId_ != nullptr
        && this->selfDefine_ != nullptr && this->status_ != nullptr; };
