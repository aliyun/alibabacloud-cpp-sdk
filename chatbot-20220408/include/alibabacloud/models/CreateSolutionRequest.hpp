...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentKey_ == nullptr
        && this->content_ == nullptr && this->contentType_ == nullptr && this->knowledgeId_ == nullptr && this->perspectiveCodes_ == nullptr && this->tagIdList_ == nullptr; };
    ...
    inline CreateSolutionRequest& setTagIdList(const vector<int64_t> & tagIdList) { DARABONBA_PTR_SET_VALUE(tagIdList_, tagIdList) };
    inline CreateSolutionRequest& setTagIdList(vector<int64_t> && tagIdList) { DARABONBA_PTR_SET_RVALUE(tagIdList_, tagIdList) };
