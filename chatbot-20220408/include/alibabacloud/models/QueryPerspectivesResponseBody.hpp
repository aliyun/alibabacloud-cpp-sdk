...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->perspectives_ != nullptr
    ...
    inline const vector<QueryPerspectivesResponseBodyPerspectives> & perspectives() const { DARABONBA_PTR_GET_CONST(perspectives_, vector<QueryPerspectivesResponseBodyPerspectives>) };
    inline vector<QueryPerspectivesResponseBodyPerspectives> perspectives() { DARABONBA_PTR_GET(perspectives_, vector<QueryPerspectivesResponseBodyPerspectives>) };
    inline QueryPerspectivesResponseBody& setPerspectives(const vector<QueryPerspectivesResponseBodyPerspectives> & perspectives) { DARABONBA_PTR_SET_VALUE(perspectives_, perspectives) };
    inline QueryPerspectivesResponseBody& setPerspectives(vector<QueryPerspectivesResponseBodyPerspectives> && perspectives) { DARABONBA_PTR_SET_RVALUE(perspectives_, perspectives) };
  ...
  protected:
    std::shared_ptr<vector<QueryPerspectivesResponseBodyPerspectives>> perspectives_ = nullptr;
