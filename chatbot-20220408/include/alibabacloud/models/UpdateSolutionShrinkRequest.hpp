...
#ifndef ALIBABACLOUD_MODELS_UPDATESOLUTIONSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATESOLUTIONSHRINKREQUEST_HPP_
...
namespace Models
{
  class UpdateSolutionShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateSolutionShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateSolutionShrinkRequest& obj) { 
    ...
    UpdateSolutionShrinkRequest() = default ;
    UpdateSolutionShrinkRequest(const UpdateSolutionShrinkRequest &) = default ;
    UpdateSolutionShrinkRequest(UpdateSolutionShrinkRequest &&) = default ;
    UpdateSolutionShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateSolutionShrinkRequest() = default ;
    UpdateSolutionShrinkRequest& operator=(const UpdateSolutionShrinkRequest &) = default ;
    UpdateSolutionShrinkRequest& operator=(UpdateSolutionShrinkRequest &&) = default ;
