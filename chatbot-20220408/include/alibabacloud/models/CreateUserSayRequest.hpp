...
namespace Models
{
  ...
  public:
    ...
    inline const CreateUserSayRequest::UserSayDefinition & getUserSayDefinition() const { DARABONBA_PTR_GET_CONST(userSayDefinition_, CreateUserSayRequest::UserSayDefinition) };
    inline CreateUserSayRequest::UserSayDefinition getUserSayDefinition() { DARABONBA_PTR_GET(userSayDefinition_, CreateUserSayRequest::UserSayDefinition) };
    inline CreateUserSayRequest& setUserSayDefinition(const CreateUserSayRequest::UserSayDefinition & userSayDefinition) { DARABONBA_PTR_SET_VALUE(userSayDefinition_, userSayDefinition) };
    inline CreateUserSayRequest& setUserSayDefinition(CreateUserSayRequest::UserSayDefinition && userSayDefinition) { DARABONBA_PTR_SET_RVALUE(userSayDefinition_, userSayDefinition) };
