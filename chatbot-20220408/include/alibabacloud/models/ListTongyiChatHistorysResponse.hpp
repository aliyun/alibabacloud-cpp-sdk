...
namespace Models
{
  ...
  public:
    ...
    inline const ListTongyiChatHistorysResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTongyiChatHistorysResponseBody) };
    inline ListTongyiChatHistorysResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTongyiChatHistorysResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTongyiChatHistorysResponseBody> body_ {};
  };
