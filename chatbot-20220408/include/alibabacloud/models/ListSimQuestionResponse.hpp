...
namespace Models
{
  ...
  public:
    ...
    inline const ListSimQuestionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSimQuestionResponseBody) };
    inline ListSimQuestionResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSimQuestionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSimQuestionResponseBody> body_ {};
  };
