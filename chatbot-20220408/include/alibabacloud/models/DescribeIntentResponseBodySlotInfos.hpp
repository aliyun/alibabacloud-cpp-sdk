...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEINTENTRESPONSEBODYSLOTINFOS_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEINTENTRESPONSEBODYSLOTINFOS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeIntentResponseBodySlotInfos& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeIntentResponseBodySlotInfos& obj) { 
    ...
    DescribeIntentResponseBodySlotInfos() = default ;
    DescribeIntentResponseBodySlotInfos(const DescribeIntentResponseBodySlotInfos &) = default ;
    DescribeIntentResponseBodySlotInfos(DescribeIntentResponseBodySlotInfos &&) = default ;
    DescribeIntentResponseBodySlotInfos(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeIntentResponseBodySlotInfos() = default ;
    DescribeIntentResponseBodySlotInfos& operator=(const DescribeIntentResponseBodySlotInfos &) = default ;
    DescribeIntentResponseBodySlotInfos& operator=(DescribeIntentResponseBodySlotInfos &&) = default ;
    ...
    inline DescribeIntentResponseBodySlotInfos& setArray(bool array) { DARABONBA_PTR_SET_VALUE(array_, array) };
    ...
    inline DescribeIntentResponseBodySlotInfos& setEncrypt(bool encrypt) { DARABONBA_PTR_SET_VALUE(encrypt_, encrypt) };
    ...
    inline DescribeIntentResponseBodySlotInfos& setInteractive(bool interactive) { DARABONBA_PTR_SET_VALUE(interactive_, interactive) };
    ...
    inline DescribeIntentResponseBodySlotInfos& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline DescribeIntentResponseBodySlotInfos& setSlotId(string slotId) { DARABONBA_PTR_SET_VALUE(slotId_, slotId) };
    ...
    inline DescribeIntentResponseBodySlotInfos& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
