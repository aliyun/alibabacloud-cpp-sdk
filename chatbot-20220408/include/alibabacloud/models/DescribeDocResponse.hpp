...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDocResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDocResponseBody) };
    inline DescribeDocResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDocResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDocResponseBody> body_ {};
  };
