...
namespace Models
{
  ...
  public:
    ...
    inline const TongyiChatDebugInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TongyiChatDebugInfoResponseBody) };
    inline TongyiChatDebugInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, TongyiChatDebugInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TongyiChatDebugInfoResponseBody> body_ {};
  };
