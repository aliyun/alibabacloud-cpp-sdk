...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->docHits_ != nullptr
    ...
    inline const vector<SearchDocResponseBodyDocHits> & docHits() const { DARABONBA_PTR_GET_CONST(docHits_, vector<SearchDocResponseBodyDocHits>) };
    inline vector<SearchDocResponseBodyDocHits> docHits() { DARABONBA_PTR_GET(docHits_, vector<SearchDocResponseBodyDocHits>) };
    inline SearchDocResponseBody& setDocHits(const vector<SearchDocResponseBodyDocHits> & docHits) { DARABONBA_PTR_SET_VALUE(docHits_, docHits) };
    inline SearchDocResponseBody& setDocHits(vector<SearchDocResponseBodyDocHits> && docHits) { DARABONBA_PTR_SET_RVALUE(docHits_, docHits) };
  ...
  protected:
    std::shared_ptr<vector<SearchDocResponseBodyDocHits>> docHits_ = nullptr;
