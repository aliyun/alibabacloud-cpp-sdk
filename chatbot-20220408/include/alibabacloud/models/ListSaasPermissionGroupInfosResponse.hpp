...
namespace Models
{
  ...
  public:
    ...
    inline const ListSaasPermissionGroupInfosResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSaasPermissionGroupInfosResponseBody) };
    inline ListSaasPermissionGroupInfosResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSaasPermissionGroupInfosResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSaasPermissionGroupInfosResponseBody> body_ {};
  };
