...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentKey_ == nullptr
        && this->categoryId_ == nullptr && this->config_ == nullptr && this->content_ == nullptr && this->docMetadata_ == nullptr && this->endDate_ == nullptr
        && this->meta_ == nullptr && this->startDate_ == nullptr && this->tagIds_ == nullptr && this->title_ == nullptr && this->url_ == nullptr; };
    ...
    inline const vector<CreateDocRequest::DocMetadata> & getDocMetadata() const { DARABONBA_PTR_GET_CONST(docMetadata_, vector<CreateDocRequest::DocMetadata>) };
    inline vector<CreateDocRequest::DocMetadata> getDocMetadata() { DARABONBA_PTR_GET(docMetadata_, vector<CreateDocRequest::DocMetadata>) };
    inline CreateDocRequest& setDocMetadata(const vector<CreateDocRequest::DocMetadata> & docMetadata) { DARABONBA_PTR_SET_VALUE(docMetadata_, docMetadata) };
    inline CreateDocRequest& setDocMetadata(vector<CreateDocRequest::DocMetadata> && docMetadata) { DARABONBA_PTR_SET_RVALUE(docMetadata_, docMetadata) };
