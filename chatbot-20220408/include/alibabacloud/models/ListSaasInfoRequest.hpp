...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentKey_ == nullptr
        && this->saasGroupCodes_ == nullptr && this->saasName_ == nullptr; };
    ...
    inline string getSaasGroupCodes() const { DARABONBA_PTR_GET_DEFAULT(saasGroupCodes_, "") };
    ...
    inline string getSaasName() const { DARABONBA_PTR_GET_DEFAULT(saasName_, "") };
