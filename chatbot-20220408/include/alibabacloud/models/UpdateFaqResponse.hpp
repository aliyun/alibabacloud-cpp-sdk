...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFaqResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateFaqResponseBody) };
    inline UpdateFaqResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateFaqResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateFaqResponseBody> body_ {};
  };
