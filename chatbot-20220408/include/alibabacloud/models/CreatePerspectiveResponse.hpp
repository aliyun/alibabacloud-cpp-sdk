...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePerspectiveResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePerspectiveResponseBody) };
    inline CreatePerspectiveResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePerspectiveResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePerspectiveResponseBody> body_ {};
  };
