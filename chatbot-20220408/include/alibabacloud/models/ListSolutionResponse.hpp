...
namespace Models
{
  ...
  public:
    ...
    inline const ListSolutionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSolutionResponseBody) };
    inline ListSolutionResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSolutionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSolutionResponseBody> body_ {};
  };
