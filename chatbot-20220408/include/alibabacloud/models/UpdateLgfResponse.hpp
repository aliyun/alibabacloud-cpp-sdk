...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLgfResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLgfResponseBody) };
    inline UpdateLgfResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLgfResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLgfResponseBody> body_ {};
  };
