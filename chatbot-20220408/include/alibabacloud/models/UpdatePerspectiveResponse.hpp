...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePerspectiveResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdatePerspectiveResponseBody) };
    inline UpdatePerspectiveResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdatePerspectiveResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdatePerspectiveResponseBody> body_ {};
  };
