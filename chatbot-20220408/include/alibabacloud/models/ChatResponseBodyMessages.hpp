...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->answerSource_ == nullptr
        && return this->answerType_ == nullptr && return this->knowledge_ == nullptr && return this->recommends_ == nullptr && return this->text_ == nullptr && return this->title_ == nullptr
        && return this->voiceTitle_ == nullptr; };
