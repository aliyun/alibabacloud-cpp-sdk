...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentKey_ == nullptr
        && this->name_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->robotType_ == nullptr && this->sandbox_ == nullptr; };
    ...
    inline ListInstanceRequest& setSandbox(bool sandbox) { DARABONBA_PTR_SET_VALUE(sandbox_, sandbox) };
