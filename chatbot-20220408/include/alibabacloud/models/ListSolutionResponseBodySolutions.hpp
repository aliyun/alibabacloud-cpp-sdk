...
namespace Models
{
  ...
  public:
    ...
    inline ListSolutionResponseBodySolutions& setTagIdList(const vector<int64_t> & tagIdList) { DARABONBA_PTR_SET_VALUE(tagIdList_, tagIdList) };
    inline ListSolutionResponseBodySolutions& setTagIdList(vector<int64_t> && tagIdList) { DARABONBA_PTR_SET_RVALUE(tagIdList_, tagIdList) };
