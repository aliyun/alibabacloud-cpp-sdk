...
namespace Models
{
  ...
  public:
    ...
    inline const ListDSEntityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDSEntityResponseBody) };
    inline ListDSEntityResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDSEntityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDSEntityResponseBody> body_ {};
  };
