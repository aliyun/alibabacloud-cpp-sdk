...
namespace Models
{
  ...
  public:
    ...
    inline const NluResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, NluResponseBody) };
    inline NluResponseBody getBody() { DARABONBA_PTR_GET(body_, NluResponseBody) };
  ...
  protected:
    ...
    shared_ptr<NluResponseBody> body_ {};
  };
