...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCategoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCategoryResponseBody) };
    inline CreateCategoryResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCategoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCategoryResponseBody> body_ {};
  };
