...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateIntentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateIntentResponseBody) };
    inline UpdateIntentResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateIntentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateIntentResponseBody> body_ {};
  };
