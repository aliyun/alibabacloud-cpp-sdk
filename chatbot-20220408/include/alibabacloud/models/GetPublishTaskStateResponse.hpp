...
namespace Models
{
  ...
  public:
    ...
    inline const GetPublishTaskStateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPublishTaskStateResponseBody) };
    inline GetPublishTaskStateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPublishTaskStateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPublishTaskStateResponseBody> body_ {};
  };
