...
namespace Models
{
  ...
  public:
    ...
    inline const SearchFaqResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchFaqResponseBody) };
    inline SearchFaqResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchFaqResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchFaqResponseBody> body_ {};
  };
