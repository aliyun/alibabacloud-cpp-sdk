...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->totalCount_ == nullptr && return this->userSays_ == nullptr; };
    ...
    inline const vector<ListUserSayResponseBodyUserSays> & userSays() const { DARABONBA_PTR_GET_CONST(userSays_, vector<ListUserSayResponseBodyUserSays>) };
    inline vector<ListUserSayResponseBodyUserSays> userSays() { DARABONBA_PTR_GET(userSays_, vector<ListUserSayResponseBodyUserSays>) };
    inline ListUserSayResponseBody& setUserSays(const vector<ListUserSayResponseBodyUserSays> & userSays) { DARABONBA_PTR_SET_VALUE(userSays_, userSays) };
    inline ListUserSayResponseBody& setUserSays(vector<ListUserSayResponseBodyUserSays> && userSays) { DARABONBA_PTR_SET_RVALUE(userSays_, userSays) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListUserSayResponseBodyUserSays>> userSays_ = nullptr;
  };
