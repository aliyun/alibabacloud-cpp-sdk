...
namespace Models
{
  ...
  public:
    ...
    inline const ListDSEntityValueResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDSEntityValueResponseBody) };
    inline ListDSEntityValueResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDSEntityValueResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDSEntityValueResponseBody> body_ {};
  };
