...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserSayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUserSayResponseBody) };
    inline ListUserSayResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUserSayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUserSayResponseBody> body_ {};
  };
