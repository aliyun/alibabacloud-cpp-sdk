...
namespace Models
{
  ...
  public:
    ...
    inline const ListTongyiConversationLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTongyiConversationLogsResponseBody) };
    inline ListTongyiConversationLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTongyiConversationLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTongyiConversationLogsResponseBody> body_ {};
  };
