...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeIntentResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeIntentResponseBody) };
    inline DescribeIntentResponseBody body() { DARABONBA_PTR_GET(body_, DescribeIntentResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeIntentResponseBody> body_ = nullptr;
  };
