...
namespace Models
{
  ...
  public:
    ...
    inline int32_t getAsrMaxEndSilence() const { DARABONBA_PTR_GET_DEFAULT(asrMaxEndSilence_, 0) };
    ...
    inline int32_t getSilenceReplyTimeout() const { DARABONBA_PTR_GET_DEFAULT(silenceReplyTimeout_, 0) };
    ...
    inline string getWelcomeMessage() const { DARABONBA_PTR_GET_DEFAULT(welcomeMessage_, "") };
