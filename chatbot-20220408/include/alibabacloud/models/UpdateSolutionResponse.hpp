...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSolutionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateSolutionResponseBody) };
    inline UpdateSolutionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateSolutionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateSolutionResponseBody> body_ {};
  };
