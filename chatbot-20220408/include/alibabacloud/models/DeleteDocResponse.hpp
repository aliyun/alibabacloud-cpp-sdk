...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDocResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDocResponseBody) };
    inline DeleteDocResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDocResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDocResponseBody> body_ {};
  };
