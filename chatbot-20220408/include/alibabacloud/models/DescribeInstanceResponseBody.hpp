...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->avatar_ == nullptr
        && return this->categories_ == nullptr && return this->createTime_ == nullptr && return this->editStatus_ == nullptr && return this->instanceId_ == nullptr && return this->introduction_ == nullptr
        && return this->languageCode_ == nullptr && return this->name_ == nullptr && return this->requestId_ == nullptr && return this->robotType_ == nullptr && return this->timeZone_ == nullptr; };
