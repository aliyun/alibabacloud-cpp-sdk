...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSolutionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSolutionResponseBody) };
    inline DeleteSolutionResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSolutionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSolutionResponseBody> body_ {};
  };
