...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessUnitId_ == nullptr
        && this->endpoint_ == nullptr && this->eventSubscriptionsShrink_ == nullptr && this->mqInstanceId_ == nullptr && this->mqType_ == nullptr && this->password_ == nullptr
    ...
    inline UpdateSubscriptionShrinkRequest& setBusinessUnitId(string businessUnitId) { DARABONBA_PTR_SET_VALUE(businessUnitId_, businessUnitId) };
