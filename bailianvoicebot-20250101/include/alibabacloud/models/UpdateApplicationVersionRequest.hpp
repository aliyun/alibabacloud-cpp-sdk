...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicationId_ == nullptr
        && this->businessUnitId_ == nullptr && this->interactionConfig_ == nullptr && this->labelConfig_ == nullptr && this->ragConfig_ == nullptr && this->scriptProfile_ == nullptr
        && this->synthesizerConfig_ == nullptr && this->toolConfig_ == nullptr && this->transcriberConfig_ == nullptr && this->versionId_ == nullptr; };
    ...
    inline const vector<UpdateApplicationVersionRequest::LabelConfig> & getLabelConfig() const { DARABONBA_PTR_GET_CONST(labelConfig_, vector<UpdateApplicationVersionRequest::LabelConfig>) };
    inline vector<UpdateApplicationVersionRequest::LabelConfig> getLabelConfig() { DARABONBA_PTR_GET(labelConfig_, vector<UpdateApplicationVersionRequest::LabelConfig>) };
    inline UpdateApplicationVersionRequest& setLabelConfig(const vector<UpdateApplicationVersionRequest::LabelConfig> & labelConfig) { DARABONBA_PTR_SET_VALUE(labelConfig_, labelConfig) };
    inline UpdateApplicationVersionRequest& setLabelConfig(vector<UpdateApplicationVersionRequest::LabelConfig> && labelConfig) { DARABONBA_PTR_SET_RVALUE(labelConfig_, labelConfig) };
    ...
    inline const UpdateApplicationVersionRequest::RagConfig & getRagConfig() const { DARABONBA_PTR_GET_CONST(ragConfig_, UpdateApplicationVersionRequest::RagConfig) };
    inline UpdateApplicationVersionRequest::RagConfig getRagConfig() { DARABONBA_PTR_GET(ragConfig_, UpdateApplicationVersionRequest::RagConfig) };
    inline UpdateApplicationVersionRequest& setRagConfig(const UpdateApplicationVersionRequest::RagConfig & ragConfig) { DARABONBA_PTR_SET_VALUE(ragConfig_, ragConfig) };
    inline UpdateApplicationVersionRequest& setRagConfig(UpdateApplicationVersionRequest::RagConfig && ragConfig) { DARABONBA_PTR_SET_RVALUE(ragConfig_, ragConfig) };
  ...
  protected:
    ...
    shared_ptr<vector<UpdateApplicationVersionRequest::LabelConfig>> labelConfig_ {};
    shared_ptr<UpdateApplicationVersionRequest::RagConfig> ragConfig_ {};
    // This parameter is required.
