...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessUnitId_ == nullptr
        && this->description_ == nullptr && this->name_ == nullptr && this->wordsShrink_ == nullptr; };
    ...
    inline CreateVocabularyShrinkRequest& setBusinessUnitId(string businessUnitId) { DARABONBA_PTR_SET_VALUE(businessUnitId_, businessUnitId) };
