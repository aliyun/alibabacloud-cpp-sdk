...
namespace Models
{
  ...
  public:
    ...
    inline UpdateApplicationResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline UpdateApplicationResponseBody& setData(string data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline UpdateApplicationResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline UpdateApplicationResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
