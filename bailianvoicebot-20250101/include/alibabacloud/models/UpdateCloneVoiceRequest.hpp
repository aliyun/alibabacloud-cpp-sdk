...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessUnitId_ == nullptr
        && this->cloneVoiceId_ == nullptr && this->name_ == nullptr; };
    ...
    inline UpdateCloneVoiceRequest& setBusinessUnitId(string businessUnitId) { DARABONBA_PTR_SET_VALUE(businessUnitId_, businessUnitId) };
