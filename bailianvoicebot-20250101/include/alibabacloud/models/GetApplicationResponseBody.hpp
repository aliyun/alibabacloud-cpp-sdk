  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->description_ == nullptr && this->name_ == nullptr && this->promptsJson_ == nullptr && this->scriptProfileTemplateId_ == nullptr; };
        ...
        && this->nluAccessType_ == nullptr && this->nluEngine_ == nullptr && this->omniModel_ == nullptr && this->temperature_ == nullptr && this->topP_ == nullptr; };
        ...
        && this->labelConfig_ == nullptr && this->ragConfig_ == nullptr && this->scriptProfile_ == nullptr && this->synthesizerConfig_ == nullptr && this->toolConfig_ == nullptr
        ...
        inline const PublishedVersion::RagConfig & getRagConfig() const { DARABONBA_PTR_GET_CONST(ragConfig_, PublishedVersion::RagConfig) };
        inline PublishedVersion::RagConfig getRagConfig() { DARABONBA_PTR_GET(ragConfig_, PublishedVersion::RagConfig) };
        inline PublishedVersion& setRagConfig(const PublishedVersion::RagConfig & ragConfig) { DARABONBA_PTR_SET_VALUE(ragConfig_, ragConfig) };
        inline PublishedVersion& setRagConfig(PublishedVersion::RagConfig && ragConfig) { DARABONBA_PTR_SET_RVALUE(ragConfig_, ragConfig) };
        ...
        inline const PublishedVersion::ToolConfig & getToolConfig() const { DARABONBA_PTR_GET_CONST(toolConfig_, PublishedVersion::ToolConfig) };
        inline PublishedVersion::ToolConfig getToolConfig() { DARABONBA_PTR_GET(toolConfig_, PublishedVersion::ToolConfig) };
        inline PublishedVersion& setToolConfig(const PublishedVersion::ToolConfig & toolConfig) { DARABONBA_PTR_SET_VALUE(toolConfig_, toolConfig) };
        inline PublishedVersion& setToolConfig(PublishedVersion::ToolConfig && toolConfig) { DARABONBA_PTR_SET_RVALUE(toolConfig_, toolConfig) };
      ...
      protected:
        ...
        shared_ptr<PublishedVersion::RagConfig> ragConfig_ {};
        ...
        shared_ptr<PublishedVersion::ToolConfig> toolConfig_ {};
      ...
      public:
        ...
        bool hasRagConfig() const { return this->ragConfig_ != nullptr;};
        void deleteRagConfig() { this->ragConfig_ = nullptr;};
        inline const DraftVersion::RagConfig & getRagConfig() const { DARABONBA_PTR_GET_CONST(ragConfig_, DraftVersion::RagConfig) };
        inline DraftVersion::RagConfig getRagConfig() { DARABONBA_PTR_GET(ragConfig_, DraftVersion::RagConfig) };
        inline DraftVersion& setRagConfig(const DraftVersion::RagConfig & ragConfig) { DARABONBA_PTR_SET_VALUE(ragConfig_, ragConfig) };
        inline DraftVersion& setRagConfig(DraftVersion::RagConfig && ragConfig) { DARABONBA_PTR_SET_RVALUE(ragConfig_, ragConfig) };
        ...
        bool hasToolConfig() const { return this->toolConfig_ != nullptr;};
        void deleteToolConfig() { this->toolConfig_ = nullptr;};
        inline const DraftVersion::ToolConfig & getToolConfig() const { DARABONBA_PTR_GET_CONST(toolConfig_, DraftVersion::ToolConfig) };
        inline DraftVersion::ToolConfig getToolConfig() { DARABONBA_PTR_GET(toolConfig_, DraftVersion::ToolConfig) };
        inline DraftVersion& setToolConfig(const DraftVersion::ToolConfig & toolConfig) { DARABONBA_PTR_SET_VALUE(toolConfig_, toolConfig) };
        inline DraftVersion& setToolConfig(DraftVersion::ToolConfig && toolConfig) { DARABONBA_PTR_SET_RVALUE(toolConfig_, toolConfig) };
      ...
      virtual bool empty() const override { return this->applicationId_ == nullptr
        ...
        && this->nluAccessType_ == nullptr && this->nluEngine_ == nullptr && this->publishedVersion_ == nullptr && this->status_ == nullptr && this->updatedTime_ == nullptr; };
    ...
    inline GetApplicationResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline GetApplicationResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
