...
namespace Models
{
  ...
  public:
    ...
    inline const GetApplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetApplicationResponseBody) };
    inline GetApplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetApplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetApplicationResponseBody> body_ {};
  };
