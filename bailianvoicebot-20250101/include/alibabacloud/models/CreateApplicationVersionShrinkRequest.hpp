...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicationId_ == nullptr
        ...
        && this->sourceVersionId_ == nullptr && this->synthesizerConfigShrink_ == nullptr && this->toolConfigShrink_ == nullptr && this->transcriberConfigShrink_ == nullptr; };
    ...
    inline CreateApplicationVersionShrinkRequest& setLabelConfigShrink(string labelConfigShrink) { DARABONBA_PTR_SET_VALUE(labelConfigShrink_, labelConfigShrink) };
    ...
    inline CreateApplicationVersionShrinkRequest& setRagConfigShrink(string ragConfigShrink) { DARABONBA_PTR_SET_VALUE(ragConfigShrink_, ragConfigShrink) };
