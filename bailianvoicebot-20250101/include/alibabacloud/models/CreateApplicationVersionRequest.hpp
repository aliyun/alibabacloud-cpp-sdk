...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicationId_ == nullptr
        ...
        && this->sourceVersionId_ == nullptr && this->synthesizerConfig_ == nullptr && this->toolConfig_ == nullptr && this->transcriberConfig_ == nullptr; };
    ...
    inline const vector<CreateApplicationVersionRequest::LabelConfig> & getLabelConfig() const { DARABONBA_PTR_GET_CONST(labelConfig_, vector<CreateApplicationVersionRequest::LabelConfig>) };
    inline vector<CreateApplicationVersionRequest::LabelConfig> getLabelConfig() { DARABONBA_PTR_GET(labelConfig_, vector<CreateApplicationVersionRequest::LabelConfig>) };
    inline CreateApplicationVersionRequest& setLabelConfig(const vector<CreateApplicationVersionRequest::LabelConfig> & labelConfig) { DARABONBA_PTR_SET_VALUE(labelConfig_, labelConfig) };
    inline CreateApplicationVersionRequest& setLabelConfig(vector<CreateApplicationVersionRequest::LabelConfig> && labelConfig) { DARABONBA_PTR_SET_RVALUE(labelConfig_, labelConfig) };
    ...
    inline const CreateApplicationVersionRequest::ToolConfig & getToolConfig() const { DARABONBA_PTR_GET_CONST(toolConfig_, CreateApplicationVersionRequest::ToolConfig) };
    inline CreateApplicationVersionRequest::ToolConfig getToolConfig() { DARABONBA_PTR_GET(toolConfig_, CreateApplicationVersionRequest::ToolConfig) };
    inline CreateApplicationVersionRequest& setToolConfig(const CreateApplicationVersionRequest::ToolConfig & toolConfig) { DARABONBA_PTR_SET_VALUE(toolConfig_, toolConfig) };
    inline CreateApplicationVersionRequest& setToolConfig(CreateApplicationVersionRequest::ToolConfig && toolConfig) { DARABONBA_PTR_SET_RVALUE(toolConfig_, toolConfig) };
  ...
  protected:
    ...
    shared_ptr<vector<CreateApplicationVersionRequest::LabelConfig>> labelConfig_ {};
    ...
    shared_ptr<CreateApplicationVersionRequest::ToolConfig> toolConfig_ {};
