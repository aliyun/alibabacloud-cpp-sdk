...
#ifndef ALIBABACLOUD_MODELS_UPDATESQLINSTANCECONTENTRESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_UPDATESQLINSTANCECONTENTRESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateSqlInstanceContentResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateSqlInstanceContentResponseBodyResult& obj) { 
    ...
    UpdateSqlInstanceContentResponseBodyResult() = default ;
    UpdateSqlInstanceContentResponseBodyResult(const UpdateSqlInstanceContentResponseBodyResult &) = default ;
    UpdateSqlInstanceContentResponseBodyResult(UpdateSqlInstanceContentResponseBodyResult &&) = default ;
    UpdateSqlInstanceContentResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateSqlInstanceContentResponseBodyResult() = default ;
    UpdateSqlInstanceContentResponseBodyResult& operator=(const UpdateSqlInstanceContentResponseBodyResult &) = default ;
    UpdateSqlInstanceContentResponseBodyResult& operator=(UpdateSqlInstanceContentResponseBodyResult &&) = default ;
    ...
    inline UpdateSqlInstanceContentResponseBodyResult& setCombineParams(string combineParams) { DARABONBA_PTR_SET_VALUE(combineParams_, combineParams) };
    ...
    inline UpdateSqlInstanceContentResponseBodyResult& setComment(string comment) { DARABONBA_PTR_SET_VALUE(comment_, comment) };
    ...
    inline UpdateSqlInstanceContentResponseBodyResult& setContent(string content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    ...
    inline UpdateSqlInstanceContentResponseBodyResult& setDynamicParams(string dynamicParams) { DARABONBA_PTR_SET_VALUE(dynamicParams_, dynamicParams) };
    ...
    inline UpdateSqlInstanceContentResponseBodyResult& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline UpdateSqlInstanceContentResponseBodyResult& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline UpdateSqlInstanceContentResponseBodyResult& setInstanceId(int64_t instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline UpdateSqlInstanceContentResponseBodyResult& setKvpairs(string kvpairs) { DARABONBA_PTR_SET_VALUE(kvpairs_, kvpairs) };
    ...
    inline UpdateSqlInstanceContentResponseBodyResult& setRelatedTemplateId(int64_t relatedTemplateId) { DARABONBA_PTR_SET_VALUE(relatedTemplateId_, relatedTemplateId) };
    ...
    inline UpdateSqlInstanceContentResponseBodyResult& setStaticParams(string staticParams) { DARABONBA_PTR_SET_VALUE(staticParams_, staticParams) };
    ...
    inline UpdateSqlInstanceContentResponseBodyResult& setTemplateParams(string templateParams) { DARABONBA_PTR_SET_VALUE(templateParams_, templateParams) };
    ...
    inline UpdateSqlInstanceContentResponseBodyResult& setVersion(int64_t version) { DARABONBA_PTR_SET_VALUE(version_, version) };
