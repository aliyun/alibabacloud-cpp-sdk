...
namespace Models
{
  ...
  public:
    ...
    inline DeleteInstanceResponseBody& setResult(const Darabonba::Json & result) { DARABONBA_SET_VALUE(result_, result) };
    inline DeleteInstanceResponseBody& setResult(Darabonba::Json & result) { DARABONBA_SET_RVALUE(result_, result) };
