...
namespace Models
{
  ...
  public:
    ...
    inline ModifyTableRequestDataSourceConfig& setFormat(string format) { DARABONBA_PTR_SET_VALUE(format_, format) };
    ...
    inline ModifyTableRequestDataSourceConfig& setPath(string path) { DARABONBA_PTR_SET_VALUE(path_, path) };
    ...
    inline ModifyTableRequestDataSourceConfig& setTableFormat(string tableFormat) { DARABONBA_PTR_SET_VALUE(tableFormat_, tableFormat) };
