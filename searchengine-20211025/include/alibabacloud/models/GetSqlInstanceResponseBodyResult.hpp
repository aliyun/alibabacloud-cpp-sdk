...
#ifndef ALIBABACLOUD_MODELS_GETSQLINSTANCERESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_GETSQLINSTANCERESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSqlInstanceResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSqlInstanceResponseBodyResult& obj) { 
    ...
    GetSqlInstanceResponseBodyResult() = default ;
    GetSqlInstanceResponseBodyResult(const GetSqlInstanceResponseBodyResult &) = default ;
    GetSqlInstanceResponseBodyResult(GetSqlInstanceResponseBodyResult &&) = default ;
    GetSqlInstanceResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSqlInstanceResponseBodyResult() = default ;
    GetSqlInstanceResponseBodyResult& operator=(const GetSqlInstanceResponseBodyResult &) = default ;
    GetSqlInstanceResponseBodyResult& operator=(GetSqlInstanceResponseBodyResult &&) = default ;
    ...
    inline GetSqlInstanceResponseBodyResult& setCombineParams(string combineParams) { DARABONBA_PTR_SET_VALUE(combineParams_, combineParams) };
    ...
    inline GetSqlInstanceResponseBodyResult& setComment(string comment) { DARABONBA_PTR_SET_VALUE(comment_, comment) };
    ...
    inline GetSqlInstanceResponseBodyResult& setContent(string content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    ...
    inline GetSqlInstanceResponseBodyResult& setDynamicParams(string dynamicParams) { DARABONBA_PTR_SET_VALUE(dynamicParams_, dynamicParams) };
    ...
    inline GetSqlInstanceResponseBodyResult& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline GetSqlInstanceResponseBodyResult& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline GetSqlInstanceResponseBodyResult& setInstanceId(int64_t instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetSqlInstanceResponseBodyResult& setKvpairs(string kvpairs) { DARABONBA_PTR_SET_VALUE(kvpairs_, kvpairs) };
    ...
    inline GetSqlInstanceResponseBodyResult& setRelatedTemplateId(int64_t relatedTemplateId) { DARABONBA_PTR_SET_VALUE(relatedTemplateId_, relatedTemplateId) };
    ...
    inline GetSqlInstanceResponseBodyResult& setStaticParams(string staticParams) { DARABONBA_PTR_SET_VALUE(staticParams_, staticParams) };
    ...
    inline GetSqlInstanceResponseBodyResult& setTemplateParams(string templateParams) { DARABONBA_PTR_SET_VALUE(templateParams_, templateParams) };
    ...
    inline GetSqlInstanceResponseBodyResult& setVersion(int64_t version) { DARABONBA_PTR_SET_VALUE(version_, version) };
