...
#ifndef ALIBABACLOUD_MODELS_MODIFYTABLEREQUESTVECTORINDEXADVANCEPARAMS_HPP_
#define ALIBABACLOUD_MODELS_MODIFYTABLEREQUESTVECTORINDEXADVANCEPARAMS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyTableRequestVectorIndexAdvanceParams& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyTableRequestVectorIndexAdvanceParams& obj) { 
    ...
    ModifyTableRequestVectorIndexAdvanceParams() = default ;
    ModifyTableRequestVectorIndexAdvanceParams(const ModifyTableRequestVectorIndexAdvanceParams &) = default ;
    ModifyTableRequestVectorIndexAdvanceParams(ModifyTableRequestVectorIndexAdvanceParams &&) = default ;
    ModifyTableRequestVectorIndexAdvanceParams(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyTableRequestVectorIndexAdvanceParams() = default ;
    ModifyTableRequestVectorIndexAdvanceParams& operator=(const ModifyTableRequestVectorIndexAdvanceParams &) = default ;
    ModifyTableRequestVectorIndexAdvanceParams& operator=(ModifyTableRequestVectorIndexAdvanceParams &&) = default ;
    ...
    inline ModifyTableRequestVectorIndexAdvanceParams& setBuildIndexParams(string buildIndexParams) { DARABONBA_PTR_SET_VALUE(buildIndexParams_, buildIndexParams) };
    ...
    inline ModifyTableRequestVectorIndexAdvanceParams& setLinearBuildThreshold(string linearBuildThreshold) { DARABONBA_PTR_SET_VALUE(linearBuildThreshold_, linearBuildThreshold) };
    ...
    inline ModifyTableRequestVectorIndexAdvanceParams& setMinScanDocCnt(string minScanDocCnt) { DARABONBA_PTR_SET_VALUE(minScanDocCnt_, minScanDocCnt) };
    ...
    inline ModifyTableRequestVectorIndexAdvanceParams& setSearchIndexParams(string searchIndexParams) { DARABONBA_PTR_SET_VALUE(searchIndexParams_, searchIndexParams) };
