...
namespace Models
{
  ...
  public:
    ...
    inline ListSchemasResponseBody& setResult(const Darabonba::Json & result) { DARABONBA_SET_VALUE(result_, result) };
    inline ListSchemasResponseBody& setResult(Darabonba::Json & result) { DARABONBA_SET_RVALUE(result_, result) };
