...
namespace Models
{
  ...
  public:
    ...
    inline ErrorResponse& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ErrorResponse& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
