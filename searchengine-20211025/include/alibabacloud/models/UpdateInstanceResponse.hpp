...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateInstanceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateInstanceResponseBody) };
    inline UpdateInstanceResponseBody body() { DARABONBA_PTR_GET(body_, UpdateInstanceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateInstanceResponseBody> body_ = nullptr;
  };
