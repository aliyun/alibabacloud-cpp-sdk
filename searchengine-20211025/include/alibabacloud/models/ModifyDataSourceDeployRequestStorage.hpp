...
#ifndef ALIBABACLOUD_MODELS_MODIFYDATASOURCEDEPLOYREQUESTSTORAGE_HPP_
#define ALIBABACLOUD_MODELS_MODIFYDATASOURCEDEPLOYREQUESTSTORAGE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyDataSourceDeployRequestStorage& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyDataSourceDeployRequestStorage& obj) { 
    ...
    ModifyDataSourceDeployRequestStorage() = default ;
    ModifyDataSourceDeployRequestStorage(const ModifyDataSourceDeployRequestStorage &) = default ;
    ModifyDataSourceDeployRequestStorage(ModifyDataSourceDeployRequestStorage &&) = default ;
    ModifyDataSourceDeployRequestStorage(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyDataSourceDeployRequestStorage() = default ;
    ModifyDataSourceDeployRequestStorage& operator=(const ModifyDataSourceDeployRequestStorage &) = default ;
    ModifyDataSourceDeployRequestStorage& operator=(ModifyDataSourceDeployRequestStorage &&) = default ;
    ...
    inline ModifyDataSourceDeployRequestStorage& setAccessKey(string accessKey) { DARABONBA_PTR_SET_VALUE(accessKey_, accessKey) };
    ...
    inline ModifyDataSourceDeployRequestStorage& setAccessSecret(string accessSecret) { DARABONBA_PTR_SET_VALUE(accessSecret_, accessSecret) };
    ...
    inline ModifyDataSourceDeployRequestStorage& setBucket(string bucket) { DARABONBA_PTR_SET_VALUE(bucket_, bucket) };
    ...
    inline ModifyDataSourceDeployRequestStorage& setCatalog(string catalog) { DARABONBA_PTR_SET_VALUE(catalog_, catalog) };
    ...
    inline ModifyDataSourceDeployRequestStorage& setDatabase(string database) { DARABONBA_PTR_SET_VALUE(database_, database) };
    ...
    inline ModifyDataSourceDeployRequestStorage& setEndpoint(string endpoint) { DARABONBA_PTR_SET_VALUE(endpoint_, endpoint) };
    ...
    inline ModifyDataSourceDeployRequestStorage& setNamespace(string _namespace) { DARABONBA_PTR_SET_VALUE(namespace_, _namespace) };
    ...
    inline ModifyDataSourceDeployRequestStorage& setOssPath(string ossPath) { DARABONBA_PTR_SET_VALUE(ossPath_, ossPath) };
    ...
    inline ModifyDataSourceDeployRequestStorage& setPartition(string partition) { DARABONBA_PTR_SET_VALUE(partition_, partition) };
    ...
    inline ModifyDataSourceDeployRequestStorage& setPath(string path) { DARABONBA_PTR_SET_VALUE(path_, path) };
    ...
    inline ModifyDataSourceDeployRequestStorage& setProject(string project) { DARABONBA_PTR_SET_VALUE(project_, project) };
    ...
    inline ModifyDataSourceDeployRequestStorage& setTable(string table) { DARABONBA_PTR_SET_VALUE(table_, table) };
    ...
    inline ModifyDataSourceDeployRequestStorage& setTableFormat(string tableFormat) { DARABONBA_PTR_SET_VALUE(tableFormat_, tableFormat) };
    ...
    inline ModifyDataSourceDeployRequestStorage& setTag(string tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
