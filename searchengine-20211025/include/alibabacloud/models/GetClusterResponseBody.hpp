...
namespace Models
{
  ...
  public:
    ...
    inline const GetClusterResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetClusterResponseBodyResult) };
    inline GetClusterResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetClusterResponseBodyResult) };
    inline GetClusterResponseBody& setResult(const GetClusterResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetClusterResponseBody& setResult(GetClusterResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The clusters.
    std::shared_ptr<GetClusterResponseBodyResult> result_ = nullptr;
  };
