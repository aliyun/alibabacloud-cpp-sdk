...
#ifndef ALIBABACLOUD_MODELS_CREATEDATASOURCEREQUESTCONFIG_HPP_
#define ALIBABACLOUD_MODELS_CREATEDATASOURCEREQUESTCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateDataSourceRequestConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateDataSourceRequestConfig& obj) { 
    ...
    CreateDataSourceRequestConfig() = default ;
    CreateDataSourceRequestConfig(const CreateDataSourceRequestConfig &) = default ;
    CreateDataSourceRequestConfig(CreateDataSourceRequestConfig &&) = default ;
    CreateDataSourceRequestConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateDataSourceRequestConfig() = default ;
    CreateDataSourceRequestConfig& operator=(const CreateDataSourceRequestConfig &) = default ;
    CreateDataSourceRequestConfig& operator=(CreateDataSourceRequestConfig &&) = default ;
    ...
    inline CreateDataSourceRequestConfig& setAccessKey(string accessKey) { DARABONBA_PTR_SET_VALUE(accessKey_, accessKey) };
    ...
    inline CreateDataSourceRequestConfig& setAccessSecret(string accessSecret) { DARABONBA_PTR_SET_VALUE(accessSecret_, accessSecret) };
    ...
    inline CreateDataSourceRequestConfig& setBucket(string bucket) { DARABONBA_PTR_SET_VALUE(bucket_, bucket) };
    ...
    inline CreateDataSourceRequestConfig& setCatalog(string catalog) { DARABONBA_PTR_SET_VALUE(catalog_, catalog) };
    ...
    inline CreateDataSourceRequestConfig& setDatabase(string database) { DARABONBA_PTR_SET_VALUE(database_, database) };
    ...
    inline CreateDataSourceRequestConfig& setEndpoint(string endpoint) { DARABONBA_PTR_SET_VALUE(endpoint_, endpoint) };
    ...
    inline CreateDataSourceRequestConfig& setNamespace(string _namespace) { DARABONBA_PTR_SET_VALUE(namespace_, _namespace) };
    ...
    inline CreateDataSourceRequestConfig& setOssPath(string ossPath) { DARABONBA_PTR_SET_VALUE(ossPath_, ossPath) };
    ...
    inline CreateDataSourceRequestConfig& setPartition(string partition) { DARABONBA_PTR_SET_VALUE(partition_, partition) };
    ...
    inline CreateDataSourceRequestConfig& setPath(string path) { DARABONBA_PTR_SET_VALUE(path_, path) };
    ...
    inline CreateDataSourceRequestConfig& setProject(string project) { DARABONBA_PTR_SET_VALUE(project_, project) };
    ...
    inline CreateDataSourceRequestConfig& setTable(string table) { DARABONBA_PTR_SET_VALUE(table_, table) };
    ...
    inline CreateDataSourceRequestConfig& setTag(string tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
