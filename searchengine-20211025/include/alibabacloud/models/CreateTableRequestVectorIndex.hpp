...
#ifndef ALIBABACLOUD_MODELS_CREATETABLEREQUESTVECTORINDEX_HPP_
#define ALIBABACLOUD_MODELS_CREATETABLEREQUESTVECTORINDEX_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateTableRequestVectorIndex& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateTableRequestVectorIndex& obj) { 
    ...
    CreateTableRequestVectorIndex() = default ;
    CreateTableRequestVectorIndex(const CreateTableRequestVectorIndex &) = default ;
    CreateTableRequestVectorIndex(CreateTableRequestVectorIndex &&) = default ;
    CreateTableRequestVectorIndex(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTableRequestVectorIndex() = default ;
    CreateTableRequestVectorIndex& operator=(const CreateTableRequestVectorIndex &) = default ;
    CreateTableRequestVectorIndex& operator=(CreateTableRequestVectorIndex &&) = default ;
    ...
    inline const Models::CreateTableRequestVectorIndexAdvanceParams & advanceParams() const { DARABONBA_PTR_GET_CONST(advanceParams_, Models::CreateTableRequestVectorIndexAdvanceParams) };
    inline Models::CreateTableRequestVectorIndexAdvanceParams advanceParams() { DARABONBA_PTR_GET(advanceParams_, Models::CreateTableRequestVectorIndexAdvanceParams) };
    inline CreateTableRequestVectorIndex& setAdvanceParams(const Models::CreateTableRequestVectorIndexAdvanceParams & advanceParams) { DARABONBA_PTR_SET_VALUE(advanceParams_, advanceParams) };
    inline CreateTableRequestVectorIndex& setAdvanceParams(Models::CreateTableRequestVectorIndexAdvanceParams && advanceParams) { DARABONBA_PTR_SET_RVALUE(advanceParams_, advanceParams) };
    ...
    inline CreateTableRequestVectorIndex& setDimension(string dimension) { DARABONBA_PTR_SET_VALUE(dimension_, dimension) };
    ...
    inline CreateTableRequestVectorIndex& setDistanceType(string distanceType) { DARABONBA_PTR_SET_VALUE(distanceType_, distanceType) };
    ...
    inline CreateTableRequestVectorIndex& setIndexName(string indexName) { DARABONBA_PTR_SET_VALUE(indexName_, indexName) };
    ...
    inline CreateTableRequestVectorIndex& setNamespace(string _namespace) { DARABONBA_PTR_SET_VALUE(namespace_, _namespace) };
    ...
    inline CreateTableRequestVectorIndex& setSparseIndexField(string sparseIndexField) { DARABONBA_PTR_SET_VALUE(sparseIndexField_, sparseIndexField) };
    ...
    inline CreateTableRequestVectorIndex& setSparseValueField(string sparseValueField) { DARABONBA_PTR_SET_VALUE(sparseValueField_, sparseValueField) };
    ...
    inline CreateTableRequestVectorIndex& setVectorField(string vectorField) { DARABONBA_PTR_SET_VALUE(vectorField_, vectorField) };
    ...
    inline CreateTableRequestVectorIndex& setVectorIndexType(string vectorIndexType) { DARABONBA_PTR_SET_VALUE(vectorIndexType_, vectorIndexType) };


  protected:
    // The configurations of the index schema.
    std::shared_ptr<Models::CreateTableRequestVectorIndexAdvanceParams> advanceParams_ = nullptr;
