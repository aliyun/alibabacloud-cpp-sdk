...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDataSourcesResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListDataSourcesResponseBodyResult>) };
    inline vector<ListDataSourcesResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListDataSourcesResponseBodyResult>) };
    inline ListDataSourcesResponseBody& setResult(const vector<ListDataSourcesResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListDataSourcesResponseBody& setResult(vector<ListDataSourcesResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListDataSourcesResponseBodyResult>> result_ = nullptr;
  };
