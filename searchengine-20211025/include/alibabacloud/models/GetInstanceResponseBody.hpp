...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetInstanceResponseBodyResult) };
    inline GetInstanceResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetInstanceResponseBodyResult) };
    inline GetInstanceResponseBody& setResult(const GetInstanceResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetInstanceResponseBody& setResult(GetInstanceResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // Response parameters
    std::shared_ptr<GetInstanceResponseBodyResult> result_ = nullptr;
  };
