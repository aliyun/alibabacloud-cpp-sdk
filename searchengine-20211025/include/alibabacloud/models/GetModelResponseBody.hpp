...
namespace Models
{
  ...
  public:
    ...
    inline const GetModelResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetModelResponseBodyResult) };
    inline GetModelResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetModelResponseBodyResult) };
    inline GetModelResponseBody& setResult(const GetModelResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetModelResponseBody& setResult(GetModelResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<GetModelResponseBodyResult> result_ = nullptr;
  };
