...
namespace Models
{
  ...
  public:
    ...
    inline ChatBIPatternIndexQueryTablesRequest& setAuthMessage(string authMessage) { DARABONBA_PTR_SET_VALUE(authMessage_, authMessage) };
    ...
    inline ChatBIPatternIndexQueryTablesRequest& setAuthType(string authType) { DARABONBA_PTR_SET_VALUE(authType_, authType) };
    ...
    inline ChatBIPatternIndexQueryTablesRequest& setSourceRegionId(string sourceRegionId) { DARABONBA_PTR_SET_VALUE(sourceRegionId_, sourceRegionId) };
