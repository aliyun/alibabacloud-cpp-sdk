...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->columnsExcluded_ == nullptr
        && this->dbName_ == nullptr && this->instanceName_ == nullptr && this->tableNameSuffix_ == nullptr && this->tablesIncluded_ == nullptr && this->toSample_ == nullptr; };
