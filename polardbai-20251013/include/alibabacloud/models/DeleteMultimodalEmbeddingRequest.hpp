...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        && this->embedding_ == nullptr && this->sourceRegionId_ == nullptr; };
    ...
    inline DeleteMultimodalEmbeddingRequest& setSourceRegionId(string sourceRegionId) { DARABONBA_PTR_SET_VALUE(sourceRegionId_, sourceRegionId) };
