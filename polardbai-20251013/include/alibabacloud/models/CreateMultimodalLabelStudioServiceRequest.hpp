...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        && this->datasetIds_ == nullptr && this->password_ == nullptr && this->sourceRegionId_ == nullptr && this->username_ == nullptr; };
    ...
    inline CreateMultimodalLabelStudioServiceRequest& setSourceRegionId(string sourceRegionId) { DARABONBA_PTR_SET_VALUE(sourceRegionId_, sourceRegionId) };
