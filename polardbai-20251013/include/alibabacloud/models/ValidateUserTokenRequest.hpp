...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->authMessage_ == nullptr
        && this->authType_ == nullptr && this->DBClusterId_ == nullptr && this->sourceRegionId_ == nullptr; };
    ...
    inline ValidateUserTokenRequest& setSourceRegionId(string sourceRegionId) { DARABONBA_PTR_SET_VALUE(sourceRegionId_, sourceRegionId) };
