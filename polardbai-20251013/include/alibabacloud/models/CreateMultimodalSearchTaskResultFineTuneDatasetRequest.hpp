...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        && this->datasetDescription_ == nullptr && this->datasetName_ == nullptr && this->resultIndex_ == nullptr && this->resultMode_ == nullptr && this->sourceRegionId_ == nullptr
    ...
    inline CreateMultimodalSearchTaskResultFineTuneDatasetRequest& setSourceRegionId(string sourceRegionId) { DARABONBA_PTR_SET_VALUE(sourceRegionId_, sourceRegionId) };
