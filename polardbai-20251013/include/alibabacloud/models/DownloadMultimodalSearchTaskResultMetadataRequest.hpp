...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        && this->sourceRegionId_ == nullptr && this->taskId_ == nullptr; };
    ...
    inline DownloadMultimodalSearchTaskResultMetadataRequest& setSourceRegionId(string sourceRegionId) { DARABONBA_PTR_SET_VALUE(sourceRegionId_, sourceRegionId) };
