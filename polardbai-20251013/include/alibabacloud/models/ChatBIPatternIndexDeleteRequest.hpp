...
namespace Models
{
  ...
  public:
    ...
    inline ChatBIPatternIndexDeleteRequest& setAuthMessage(string authMessage) { DARABONBA_PTR_SET_VALUE(authMessage_, authMessage) };
    ...
    inline ChatBIPatternIndexDeleteRequest& setAuthType(string authType) { DARABONBA_PTR_SET_VALUE(authType_, authType) };
    ...
    inline ChatBIPatternIndexDeleteRequest& setSourceRegionId(string sourceRegionId) { DARABONBA_PTR_SET_VALUE(sourceRegionId_, sourceRegionId) };
