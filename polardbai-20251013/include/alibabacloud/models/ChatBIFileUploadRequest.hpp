...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->authMessage_ == nullptr
        && this->authType_ == nullptr && this->fileName_ == nullptr && this->instanceName_ == nullptr && this->sourceRegionId_ == nullptr; };
    ...
    inline ChatBIFileUploadRequest& setSourceRegionId(string sourceRegionId) { DARABONBA_PTR_SET_VALUE(sourceRegionId_, sourceRegionId) };
