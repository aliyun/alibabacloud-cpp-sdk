...
namespace Models
{
  ...
  public:
    ...
    inline DisableSqlAuditResponseBody& setResult(bool result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    ...
    inline DisableSqlAuditResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
