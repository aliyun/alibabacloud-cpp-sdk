...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeTablesResponseBodyList> & list() const { DARABONBA_PTR_GET_CONST(list_, vector<DescribeTablesResponseBodyList>) };
    inline vector<DescribeTablesResponseBodyList> list() { DARABONBA_PTR_GET(list_, vector<DescribeTablesResponseBodyList>) };
    inline DescribeTablesResponseBody& setList(const vector<DescribeTablesResponseBodyList> & list) { DARABONBA_PTR_SET_VALUE(list_, list) };
    inline DescribeTablesResponseBody& setList(vector<DescribeTablesResponseBodyList> && list) { DARABONBA_PTR_SET_RVALUE(list_, list) };
    ...
    inline DescribeTablesResponseBody& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline DescribeTablesResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline DescribeTablesResponseBody& setTotal(int32_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };


  protected:
    // The list of returned tables.
    std::shared_ptr<vector<DescribeTablesResponseBodyList>> list_ = nullptr;
