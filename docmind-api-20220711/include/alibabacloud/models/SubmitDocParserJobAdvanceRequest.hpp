...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->customOssConfig_ == nullptr
        && return this->enableEventCallback_ == nullptr && return this->enhancementMode_ == nullptr && return this->fileName_ == nullptr && return this->fileNameExtension_ == nullptr && return this->fileUrlObject_ == nullptr
