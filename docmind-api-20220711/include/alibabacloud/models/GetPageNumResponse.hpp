...
namespace Models
{
  ...
  public:
    ...
    inline const GetPageNumResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPageNumResponseBody) };
    inline GetPageNumResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPageNumResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPageNumResponseBody> body_ {};
  };
