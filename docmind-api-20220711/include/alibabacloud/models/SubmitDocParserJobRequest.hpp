...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitDocParserJobRequest::CustomOssConfig & getCustomOssConfig() const { DARABONBA_PTR_GET_CONST(customOssConfig_, SubmitDocParserJobRequest::CustomOssConfig) };
    inline SubmitDocParserJobRequest::CustomOssConfig getCustomOssConfig() { DARABONBA_PTR_GET(customOssConfig_, SubmitDocParserJobRequest::CustomOssConfig) };
    inline SubmitDocParserJobRequest& setCustomOssConfig(const SubmitDocParserJobRequest::CustomOssConfig & customOssConfig) { DARABONBA_PTR_SET_VALUE(customOssConfig_, customOssConfig) };
    inline SubmitDocParserJobRequest& setCustomOssConfig(SubmitDocParserJobRequest::CustomOssConfig && customOssConfig) { DARABONBA_PTR_SET_RVALUE(customOssConfig_, customOssConfig) };
    ...
    inline SubmitDocParserJobRequest& setEnhancementMode(string enhancementMode) { DARABONBA_PTR_SET_VALUE(enhancementMode_, enhancementMode) };
    ...
    inline const SubmitDocParserJobRequest::LLMParam & getLLMParam() const { DARABONBA_PTR_GET_CONST(LLMParam_, SubmitDocParserJobRequest::LLMParam) };
    inline SubmitDocParserJobRequest::LLMParam getLLMParam() { DARABONBA_PTR_GET(LLMParam_, SubmitDocParserJobRequest::LLMParam) };
    inline SubmitDocParserJobRequest& setLLMParam(const SubmitDocParserJobRequest::LLMParam & lLMParam) { DARABONBA_PTR_SET_VALUE(LLMParam_, lLMParam) };
    inline SubmitDocParserJobRequest& setLLMParam(SubmitDocParserJobRequest::LLMParam && lLMParam) { DARABONBA_PTR_SET_RVALUE(LLMParam_, lLMParam) };
    ...
    inline const SubmitDocParserJobRequest::MultimediaParameters & getMultimediaParameters() const { DARABONBA_PTR_GET_CONST(multimediaParameters_, SubmitDocParserJobRequest::MultimediaParameters) };
    inline SubmitDocParserJobRequest::MultimediaParameters getMultimediaParameters() { DARABONBA_PTR_GET(multimediaParameters_, SubmitDocParserJobRequest::MultimediaParameters) };
    inline SubmitDocParserJobRequest& setMultimediaParameters(const SubmitDocParserJobRequest::MultimediaParameters & multimediaParameters) { DARABONBA_PTR_SET_VALUE(multimediaParameters_, multimediaParameters) };
    inline SubmitDocParserJobRequest& setMultimediaParameters(SubmitDocParserJobRequest::MultimediaParameters && multimediaParameters) { DARABONBA_PTR_SET_RVALUE(multimediaParameters_, multimediaParameters) };
    ...
    inline SubmitDocParserJobRequest& setOutputFormat(const vector<string> & outputFormat) { DARABONBA_PTR_SET_VALUE(outputFormat_, outputFormat) };
    inline SubmitDocParserJobRequest& setOutputFormat(vector<string> && outputFormat) { DARABONBA_PTR_SET_RVALUE(outputFormat_, outputFormat) };
  ...
  protected:
    shared_ptr<SubmitDocParserJobRequest::CustomOssConfig> customOssConfig_ {};
    ...
    shared_ptr<SubmitDocParserJobRequest::LLMParam> LLMParam_ {};
    shared_ptr<bool> llmEnhancement_ {};
    shared_ptr<SubmitDocParserJobRequest::MultimediaParameters> multimediaParameters_ {};
