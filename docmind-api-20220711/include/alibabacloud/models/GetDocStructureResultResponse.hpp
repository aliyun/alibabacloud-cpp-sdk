...
namespace Models
{
  ...
  public:
    ...
    inline const GetDocStructureResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDocStructureResultResponseBody) };
    inline GetDocStructureResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDocStructureResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDocStructureResultResponseBody> body_ {};
  };
