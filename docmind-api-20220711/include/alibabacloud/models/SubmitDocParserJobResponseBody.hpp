...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitDocParserJobResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SubmitDocParserJobResponseBodyData) };
    inline SubmitDocParserJobResponseBodyData data() { DARABONBA_PTR_GET(data_, SubmitDocParserJobResponseBodyData) };
    inline SubmitDocParserJobResponseBody& setData(const SubmitDocParserJobResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitDocParserJobResponseBody& setData(SubmitDocParserJobResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SubmitDocParserJobResponseBodyData> data_ = nullptr;
