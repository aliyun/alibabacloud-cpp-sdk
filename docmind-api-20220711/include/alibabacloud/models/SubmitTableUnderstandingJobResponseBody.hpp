...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitTableUnderstandingJobResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SubmitTableUnderstandingJobResponseBody::Data) };
    inline SubmitTableUnderstandingJobResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SubmitTableUnderstandingJobResponseBody::Data) };
    inline SubmitTableUnderstandingJobResponseBody& setData(const SubmitTableUnderstandingJobResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitTableUnderstandingJobResponseBody& setData(SubmitTableUnderstandingJobResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<SubmitTableUnderstandingJobResponseBody::Data> data_ {};
