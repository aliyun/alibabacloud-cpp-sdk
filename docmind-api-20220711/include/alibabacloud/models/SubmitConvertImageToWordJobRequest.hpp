...
#ifndef ALIBABACLOUD_MODELS_SUBMITCONVERTIMAGETOWORDJOBREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SUBMITCONVERTIMAGETOWORDJOBREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SubmitConvertImageToWordJobRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SubmitConvertImageToWordJobRequest& obj) { 
    ...
    SubmitConvertImageToWordJobRequest() = default ;
    SubmitConvertImageToWordJobRequest(const SubmitConvertImageToWordJobRequest &) = default ;
    SubmitConvertImageToWordJobRequest(SubmitConvertImageToWordJobRequest &&) = default ;
    SubmitConvertImageToWordJobRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SubmitConvertImageToWordJobRequest() = default ;
    SubmitConvertImageToWordJobRequest& operator=(const SubmitConvertImageToWordJobRequest &) = default ;
    SubmitConvertImageToWordJobRequest& operator=(SubmitConvertImageToWordJobRequest &&) = default ;
    ...
    inline SubmitConvertImageToWordJobRequest& setEnableEventCallback(bool enableEventCallback) { DARABONBA_PTR_SET_VALUE(enableEventCallback_, enableEventCallback) };
    ...
    inline SubmitConvertImageToWordJobRequest& setImageNameExtension(string imageNameExtension) { DARABONBA_PTR_SET_VALUE(imageNameExtension_, imageNameExtension) };
    ...
    inline SubmitConvertImageToWordJobRequest& setImageNames(const vector<string> & imageNames) { DARABONBA_PTR_SET_VALUE(imageNames_, imageNames) };
    inline SubmitConvertImageToWordJobRequest& setImageNames(vector<string> && imageNames) { DARABONBA_PTR_SET_RVALUE(imageNames_, imageNames) };
    ...
    inline SubmitConvertImageToWordJobRequest& setImageUrls(const vector<string> & imageUrls) { DARABONBA_PTR_SET_VALUE(imageUrls_, imageUrls) };
    inline SubmitConvertImageToWordJobRequest& setImageUrls(vector<string> && imageUrls) { DARABONBA_PTR_SET_RVALUE(imageUrls_, imageUrls) };
    ...
    inline SubmitConvertImageToWordJobRequest& setOssBucket(string ossBucket) { DARABONBA_PTR_SET_VALUE(ossBucket_, ossBucket) };
    ...
    inline SubmitConvertImageToWordJobRequest& setOssEndpoint(string ossEndpoint) { DARABONBA_PTR_SET_VALUE(ossEndpoint_, ossEndpoint) };
