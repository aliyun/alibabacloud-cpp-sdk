...
namespace Models
{
  ...
  public:
    ...
    inline const GetDocumentExtractResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDocumentExtractResultResponseBody) };
    inline GetDocumentExtractResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDocumentExtractResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDocumentExtractResultResponseBody> body_ {};
  };
