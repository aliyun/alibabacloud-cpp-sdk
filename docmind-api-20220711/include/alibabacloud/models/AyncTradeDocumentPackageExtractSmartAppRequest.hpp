...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->customExtractionRange_ == nullptr
    ...
    inline const vector<string> & getCustomExtractionRange() const { DARABONBA_PTR_GET_CONST(customExtractionRange_, vector<string>) };
    inline vector<string> getCustomExtractionRange() { DARABONBA_PTR_GET(customExtractionRange_, vector<string>) };
  ...
  protected:
    shared_ptr<vector<string>> customExtractionRange_ {};
