...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitConvertPdfToWordJobResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SubmitConvertPdfToWordJobResponseBodyData) };
    inline SubmitConvertPdfToWordJobResponseBodyData data() { DARABONBA_PTR_GET(data_, SubmitConvertPdfToWordJobResponseBodyData) };
    inline SubmitConvertPdfToWordJobResponseBody& setData(const SubmitConvertPdfToWordJobResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitConvertPdfToWordJobResponseBody& setData(SubmitConvertPdfToWordJobResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SubmitConvertPdfToWordJobResponseBodyData> data_ = nullptr;
