...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitConvertPdfToExcelJobResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SubmitConvertPdfToExcelJobResponseBody::Data) };
    inline SubmitConvertPdfToExcelJobResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SubmitConvertPdfToExcelJobResponseBody::Data) };
    inline SubmitConvertPdfToExcelJobResponseBody& setData(const SubmitConvertPdfToExcelJobResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitConvertPdfToExcelJobResponseBody& setData(SubmitConvertPdfToExcelJobResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<SubmitConvertPdfToExcelJobResponseBody::Data> data_ {};
