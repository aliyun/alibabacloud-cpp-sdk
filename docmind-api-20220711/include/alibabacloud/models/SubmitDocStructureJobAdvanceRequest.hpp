...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allowPptFormat_ == nullptr
        && return this->fileName_ == nullptr && return this->fileNameExtension_ == nullptr && return this->fileUrlObject_ == nullptr && return this->formulaEnhancement_ == nullptr && return this->ossBucket_ == nullptr
