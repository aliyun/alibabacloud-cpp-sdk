...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->enableEventCallback_ == nullptr
        && return this->forceMergeExcel_ == nullptr && return this->imageNameExtension_ == nullptr && return this->imageNamesShrink_ == nullptr && return this->imageUrlsShrink_ == nullptr && return this->ossBucket_ == nullptr
    ...
    inline SubmitConvertImageToExcelJobShrinkRequest& setEnableEventCallback(bool enableEventCallback) { DARABONBA_PTR_SET_VALUE(enableEventCallback_, enableEventCallback) };
