...
namespace Models
{
  ...
  public:
    ...
    inline string getCustomExtractionRangeShrink() const { DARABONBA_PTR_GET_DEFAULT(customExtractionRangeShrink_, "") };
  ...
  protected:
    shared_ptr<string> customExtractionRangeShrink_ {};
