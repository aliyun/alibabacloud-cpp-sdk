...
namespace Models
{
  ...
  public:
    ...
    inline const GetDocParserResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDocParserResultResponseBody) };
    inline GetDocParserResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDocParserResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDocParserResultResponseBody> body_ {};
  };
