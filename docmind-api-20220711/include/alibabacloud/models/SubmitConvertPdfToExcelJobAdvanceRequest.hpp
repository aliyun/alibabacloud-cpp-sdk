...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->enableEventCallback_ == nullptr
        && return this->fileName_ == nullptr && return this->fileUrlObject_ == nullptr && return this->forceExportInnerImage_ == nullptr && return this->forceMergeExcel_ == nullptr && return this->ossBucket_ == nullptr
    ...
    inline SubmitConvertPdfToExcelJobAdvanceRequest& setEnableEventCallback(bool enableEventCallback) { DARABONBA_PTR_SET_VALUE(enableEventCallback_, enableEventCallback) };
