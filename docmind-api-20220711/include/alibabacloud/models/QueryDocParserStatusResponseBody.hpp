...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDocParserStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryDocParserStatusResponseBodyData) };
    inline QueryDocParserStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryDocParserStatusResponseBodyData) };
    inline QueryDocParserStatusResponseBody& setData(const QueryDocParserStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryDocParserStatusResponseBody& setData(QueryDocParserStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryDocParserStatusResponseBodyData> data_ = nullptr;
