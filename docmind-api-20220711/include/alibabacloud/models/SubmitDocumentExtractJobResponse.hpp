...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitDocumentExtractJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitDocumentExtractJobResponseBody) };
    inline SubmitDocumentExtractJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitDocumentExtractJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitDocumentExtractJobResponseBody> body_ {};
  };
