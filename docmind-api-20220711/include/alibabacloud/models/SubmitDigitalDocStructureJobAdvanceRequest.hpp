...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->fileName_ != nullptr
        && this->fileNameExtension_ != nullptr && this->fileUrlObject_ != nullptr && this->imageStrategy_ != nullptr && this->ossBucket_ != nullptr && this->ossEndpoint_ != nullptr
        && this->revealMarkdown_ != nullptr && this->useUrlResponseBody_ != nullptr; };
