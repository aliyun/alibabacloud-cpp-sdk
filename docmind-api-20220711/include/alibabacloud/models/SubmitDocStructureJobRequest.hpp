...
#ifndef ALIBABACLOUD_MODELS_SUBMITDOCSTRUCTUREJOBREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SUBMITDOCSTRUCTUREJOBREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    ...
    SubmitDocStructureJobRequest() = default ;
    SubmitDocStructureJobRequest(const SubmitDocStructureJobRequest &) = default ;
    SubmitDocStructureJobRequest(SubmitDocStructureJobRequest &&) = default ;
    SubmitDocStructureJobRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SubmitDocStructureJobRequest() = default ;
    SubmitDocStructureJobRequest& operator=(const SubmitDocStructureJobRequest &) = default ;
    SubmitDocStructureJobRequest& operator=(SubmitDocStructureJobRequest &&) = default ;
    ...
    inline SubmitDocStructureJobRequest& setFileName(string fileName) { DARABONBA_PTR_SET_VALUE(fileName_, fileName) };
    ...
    inline SubmitDocStructureJobRequest& setFileNameExtension(string fileNameExtension) { DARABONBA_PTR_SET_VALUE(fileNameExtension_, fileNameExtension) };
    ...
    inline SubmitDocStructureJobRequest& setFileUrl(string fileUrl) { DARABONBA_PTR_SET_VALUE(fileUrl_, fileUrl) };
    ...
    inline SubmitDocStructureJobRequest& setFormulaEnhancement(bool formulaEnhancement) { DARABONBA_PTR_SET_VALUE(formulaEnhancement_, formulaEnhancement) };
    ...
    inline SubmitDocStructureJobRequest& setOssBucket(string ossBucket) { DARABONBA_PTR_SET_VALUE(ossBucket_, ossBucket) };
    ...
    inline SubmitDocStructureJobRequest& setOssEndpoint(string ossEndpoint) { DARABONBA_PTR_SET_VALUE(ossEndpoint_, ossEndpoint) };
    ...
    inline SubmitDocStructureJobRequest& setPageIndex(string pageIndex) { DARABONBA_PTR_SET_VALUE(pageIndex_, pageIndex) };
    ...
    inline SubmitDocStructureJobRequest& setStructureType(string structureType) { DARABONBA_PTR_SET_VALUE(structureType_, structureType) };
