...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitConvertImageToWordJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitConvertImageToWordJobResponseBody) };
    inline SubmitConvertImageToWordJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitConvertImageToWordJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitConvertImageToWordJobResponseBody> body_ {};
  };
