...
namespace Models
{
  ...
  public:
    ...
    inline const GetDocumentConvertResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDocumentConvertResultResponseBody) };
    inline GetDocumentConvertResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDocumentConvertResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDocumentConvertResultResponseBody> body_ {};
  };
