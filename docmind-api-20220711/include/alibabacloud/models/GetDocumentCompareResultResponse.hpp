...
namespace Models
{
  ...
  public:
    ...
    inline const GetDocumentCompareResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDocumentCompareResultResponseBody) };
    inline GetDocumentCompareResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDocumentCompareResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDocumentCompareResultResponseBody> body_ {};
  };
