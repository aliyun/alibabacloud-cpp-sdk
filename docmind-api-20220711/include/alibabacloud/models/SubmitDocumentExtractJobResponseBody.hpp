...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitDocumentExtractJobResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SubmitDocumentExtractJobResponseBody::Data) };
    inline SubmitDocumentExtractJobResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SubmitDocumentExtractJobResponseBody::Data) };
    inline SubmitDocumentExtractJobResponseBody& setData(const SubmitDocumentExtractJobResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitDocumentExtractJobResponseBody& setData(SubmitDocumentExtractJobResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<SubmitDocumentExtractJobResponseBody::Data> data_ {};
