...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLiveRealtimeLogDeliveryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLiveRealtimeLogDeliveryResponseBody) };
    inline DeleteLiveRealtimeLogDeliveryResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLiveRealtimeLogDeliveryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLiveRealtimeLogDeliveryResponseBody> body_ {};
  };
