...
namespace Models
{
  ...
  public:
    ...
    inline const MuteAllGroupUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MuteAllGroupUserResponseBody) };
    inline MuteAllGroupUserResponseBody getBody() { DARABONBA_PTR_GET(body_, MuteAllGroupUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MuteAllGroupUserResponseBody> body_ {};
  };
