...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLiveMessageUserInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyLiveMessageUserInfoResponseBody) };
    inline ModifyLiveMessageUserInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyLiveMessageUserInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyLiveMessageUserInfoResponseBody> body_ {};
  };
