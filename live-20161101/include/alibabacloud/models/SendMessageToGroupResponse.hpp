...
namespace Models
{
  ...
  public:
    ...
    inline const SendMessageToGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendMessageToGroupResponseBody) };
    inline SendMessageToGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, SendMessageToGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendMessageToGroupResponseBody> body_ {};
  };
