...
namespace Models
{
  ...
  public:
    ...
    inline const SetLiveStreamsNotifyUrlConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetLiveStreamsNotifyUrlConfigResponseBody) };
    inline SetLiveStreamsNotifyUrlConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, SetLiveStreamsNotifyUrlConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetLiveStreamsNotifyUrlConfigResponseBody> body_ {};
  };
