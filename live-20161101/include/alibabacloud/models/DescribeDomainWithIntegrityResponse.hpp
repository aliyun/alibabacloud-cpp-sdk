...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainWithIntegrityResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainWithIntegrityResponseBody) };
    inline DescribeDomainWithIntegrityResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDomainWithIntegrityResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDomainWithIntegrityResponseBody> body_ = nullptr;
  };
