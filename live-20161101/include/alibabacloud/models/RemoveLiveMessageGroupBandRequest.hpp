...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getUnbannedUsers() const { DARABONBA_PTR_GET_CONST(unbannedUsers_, vector<string>) };
    inline vector<string> getUnbannedUsers() { DARABONBA_PTR_GET(unbannedUsers_, vector<string>) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<string>> unbannedUsers_ {};
  };
