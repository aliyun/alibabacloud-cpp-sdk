...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->app_ == nullptr
        && this->description_ == nullptr && this->domain_ == nullptr && this->name_ == nullptr && this->ownerId_ == nullptr && this->regionId_ == nullptr
        && this->stream_ == nullptr && this->templateId_ == nullptr; };
    // app Field Functions 
