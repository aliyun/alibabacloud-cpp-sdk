...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLiveRealTimeLogLogstoreResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLiveRealTimeLogLogstoreResponseBody) };
    inline DeleteLiveRealTimeLogLogstoreResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLiveRealTimeLogLogstoreResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLiveRealTimeLogLogstoreResponseBody> body_ {};
  };
