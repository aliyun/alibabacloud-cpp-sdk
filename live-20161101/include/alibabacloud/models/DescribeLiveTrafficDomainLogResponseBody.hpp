...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveTrafficDomainLogResponseBody::DomainLogDetails & getDomainLogDetails() const { DARABONBA_PTR_GET_CONST(domainLogDetails_, DescribeLiveTrafficDomainLogResponseBody::DomainLogDetails) };
    inline DescribeLiveTrafficDomainLogResponseBody::DomainLogDetails getDomainLogDetails() { DARABONBA_PTR_GET(domainLogDetails_, DescribeLiveTrafficDomainLogResponseBody::DomainLogDetails) };
    inline DescribeLiveTrafficDomainLogResponseBody& setDomainLogDetails(const DescribeLiveTrafficDomainLogResponseBody::DomainLogDetails & domainLogDetails) { DARABONBA_PTR_SET_VALUE(domainLogDetails_, domainLogDetails) };
    inline DescribeLiveTrafficDomainLogResponseBody& setDomainLogDetails(DescribeLiveTrafficDomainLogResponseBody::DomainLogDetails && domainLogDetails) { DARABONBA_PTR_SET_RVALUE(domainLogDetails_, domainLogDetails) };
  ...
  protected:
    shared_ptr<DescribeLiveTrafficDomainLogResponseBody::DomainLogDetails> domainLogDetails_ {};
