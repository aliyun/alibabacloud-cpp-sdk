...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLiveMessageUserMessageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLiveMessageUserMessageResponseBody) };
    inline DeleteLiveMessageUserMessageResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLiveMessageUserMessageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLiveMessageUserMessageResponseBody> body_ {};
  };
