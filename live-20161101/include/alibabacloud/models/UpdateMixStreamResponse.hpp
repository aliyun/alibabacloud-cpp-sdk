...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMixStreamResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateMixStreamResponseBody) };
    inline UpdateMixStreamResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateMixStreamResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateMixStreamResponseBody> body_ {};
  };
