...
#ifndef ALIBABACLOUD_MODELS_DESCRIBELIVEDOMAINBYCERTIFICATERESPONSEBODYCERTINFOSCERTINFO_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBELIVEDOMAINBYCERTIFICATERESPONSEBODYCERTINFOSCERTINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo& obj) { 
    ...
    DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo() = default ;
    DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo(const DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo &) = default ;
    DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo(DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo &&) = default ;
    DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo() = default ;
    DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo& operator=(const DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo &) = default ;
    DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo& operator=(DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo &&) = default ;
    ...
    inline DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo& setCertCaIsLegacy(string certCaIsLegacy) { DARABONBA_PTR_SET_VALUE(certCaIsLegacy_, certCaIsLegacy) };
    ...
    inline DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo& setCertExpireTime(string certExpireTime) { DARABONBA_PTR_SET_VALUE(certExpireTime_, certExpireTime) };
    ...
    inline DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo& setCertExpired(string certExpired) { DARABONBA_PTR_SET_VALUE(certExpired_, certExpired) };
    ...
    inline DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo& setCertStartTime(string certStartTime) { DARABONBA_PTR_SET_VALUE(certStartTime_, certStartTime) };
    ...
    inline DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo& setCertSubjectCommonName(string certSubjectCommonName) { DARABONBA_PTR_SET_VALUE(certSubjectCommonName_, certSubjectCommonName) };
    ...
    inline DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo& setCertType(string certType) { DARABONBA_PTR_SET_VALUE(certType_, certType) };
    ...
    inline DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo& setDomainList(string domainList) { DARABONBA_PTR_SET_VALUE(domainList_, domainList) };
    ...
    inline DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo& setDomainNames(string domainNames) { DARABONBA_PTR_SET_VALUE(domainNames_, domainNames) };
    ...
    inline DescribeLiveDomainByCertificateResponseBodyCertInfosCertInfo& setIssuer(string issuer) { DARABONBA_PTR_SET_VALUE(issuer_, issuer) };
