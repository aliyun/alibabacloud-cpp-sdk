...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMessageGroupResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, UpdateMessageGroupResponseBodyResult) };
    inline UpdateMessageGroupResponseBodyResult result() { DARABONBA_PTR_GET(result_, UpdateMessageGroupResponseBodyResult) };
    inline UpdateMessageGroupResponseBody& setResult(const UpdateMessageGroupResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdateMessageGroupResponseBody& setResult(UpdateMessageGroupResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<UpdateMessageGroupResponseBodyResult> result_ = nullptr;
  };
