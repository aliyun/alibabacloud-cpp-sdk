...
namespace Models
{
  ...
  public:
    ...
    inline const GetMessageGroupResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetMessageGroupResponseBodyResult) };
    inline GetMessageGroupResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetMessageGroupResponseBodyResult) };
    inline GetMessageGroupResponseBody& setResult(const GetMessageGroupResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetMessageGroupResponseBody& setResult(GetMessageGroupResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<GetMessageGroupResponseBodyResult> result_ = nullptr;
  };
