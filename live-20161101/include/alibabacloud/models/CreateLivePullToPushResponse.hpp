...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLivePullToPushResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLivePullToPushResponseBody) };
    inline CreateLivePullToPushResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLivePullToPushResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLivePullToPushResponseBody> body_ {};
  };
