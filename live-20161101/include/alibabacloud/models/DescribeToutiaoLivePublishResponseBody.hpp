...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->content_ == nullptr
        && return this->description_ == nullptr && return this->requestId_ == nullptr; };
    // content Field Functions 
    bool hasContent() const { return this->content_ != nullptr;};
    void deleteContent() { this->content_ = nullptr;};
    inline const vector<DescribeToutiaoLivePublishResponseBodyContent> & content() const { DARABONBA_PTR_GET_CONST(content_, vector<DescribeToutiaoLivePublishResponseBodyContent>) };
    inline vector<DescribeToutiaoLivePublishResponseBodyContent> content() { DARABONBA_PTR_GET(content_, vector<DescribeToutiaoLivePublishResponseBodyContent>) };
    inline DescribeToutiaoLivePublishResponseBody& setContent(const vector<DescribeToutiaoLivePublishResponseBodyContent> & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline DescribeToutiaoLivePublishResponseBody& setContent(vector<DescribeToutiaoLivePublishResponseBodyContent> && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeToutiaoLivePublishResponseBodyContent>> content_ = nullptr;
