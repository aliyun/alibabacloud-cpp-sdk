...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveAIProduceRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveAIProduceRulesResponseBody) };
    inline DescribeLiveAIProduceRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveAIProduceRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveAIProduceRulesResponseBody> body_ {};
  };
