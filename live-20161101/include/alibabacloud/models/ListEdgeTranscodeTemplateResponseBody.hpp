...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->templateList_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const ListEdgeTranscodeTemplateResponseBodyTemplateList & templateList() const { DARABONBA_PTR_GET_CONST(templateList_, ListEdgeTranscodeTemplateResponseBodyTemplateList) };
    inline ListEdgeTranscodeTemplateResponseBodyTemplateList templateList() { DARABONBA_PTR_GET(templateList_, ListEdgeTranscodeTemplateResponseBodyTemplateList) };
    inline ListEdgeTranscodeTemplateResponseBody& setTemplateList(const ListEdgeTranscodeTemplateResponseBodyTemplateList & templateList) { DARABONBA_PTR_SET_VALUE(templateList_, templateList) };
    inline ListEdgeTranscodeTemplateResponseBody& setTemplateList(ListEdgeTranscodeTemplateResponseBodyTemplateList && templateList) { DARABONBA_PTR_SET_RVALUE(templateList_, templateList) };
  ...
  protected:
    ...
    std::shared_ptr<ListEdgeTranscodeTemplateResponseBodyTemplateList> templateList_ = nullptr;
