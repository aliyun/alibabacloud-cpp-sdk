...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->liveStreamMergeList_ != nullptr
    ...
    inline const DescribeLiveStreamMergeResponseBodyLiveStreamMergeList & liveStreamMergeList() const { DARABONBA_PTR_GET_CONST(liveStreamMergeList_, DescribeLiveStreamMergeResponseBodyLiveStreamMergeList) };
    inline DescribeLiveStreamMergeResponseBodyLiveStreamMergeList liveStreamMergeList() { DARABONBA_PTR_GET(liveStreamMergeList_, DescribeLiveStreamMergeResponseBodyLiveStreamMergeList) };
    inline DescribeLiveStreamMergeResponseBody& setLiveStreamMergeList(const DescribeLiveStreamMergeResponseBodyLiveStreamMergeList & liveStreamMergeList) { DARABONBA_PTR_SET_VALUE(liveStreamMergeList_, liveStreamMergeList) };
    inline DescribeLiveStreamMergeResponseBody& setLiveStreamMergeList(DescribeLiveStreamMergeResponseBodyLiveStreamMergeList && liveStreamMergeList) { DARABONBA_PTR_SET_RVALUE(liveStreamMergeList_, liveStreamMergeList) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLiveStreamMergeResponseBodyLiveStreamMergeList> liveStreamMergeList_ = nullptr;
