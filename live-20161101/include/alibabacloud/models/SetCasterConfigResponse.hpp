...
namespace Models
{
  ...
  public:
    ...
    inline const SetCasterConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetCasterConfigResponseBody) };
    inline SetCasterConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, SetCasterConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetCasterConfigResponseBody> body_ {};
  };
