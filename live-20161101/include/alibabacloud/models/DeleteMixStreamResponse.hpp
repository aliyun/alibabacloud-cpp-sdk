...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMixStreamResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteMixStreamResponseBody) };
    inline DeleteMixStreamResponseBody body() { DARABONBA_PTR_GET(body_, DeleteMixStreamResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteMixStreamResponseBody> body_ = nullptr;
  };
