...
namespace Models
{
  ...
  public:
    ...
    inline const StopLiveStreamMonitorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopLiveStreamMonitorResponseBody) };
    inline StopLiveStreamMonitorResponseBody getBody() { DARABONBA_PTR_GET(body_, StopLiveStreamMonitorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopLiveStreamMonitorResponseBody> body_ {};
  };
