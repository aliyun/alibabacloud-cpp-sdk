...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveDomainFrameRateAndBitRateDataResponseBody::FrameRateAndBitRateInfos & getFrameRateAndBitRateInfos() const { DARABONBA_PTR_GET_CONST(frameRateAndBitRateInfos_, DescribeLiveDomainFrameRateAndBitRateDataResponseBody::FrameRateAndBitRateInfos) };
    inline DescribeLiveDomainFrameRateAndBitRateDataResponseBody::FrameRateAndBitRateInfos getFrameRateAndBitRateInfos() { DARABONBA_PTR_GET(frameRateAndBitRateInfos_, DescribeLiveDomainFrameRateAndBitRateDataResponseBody::FrameRateAndBitRateInfos) };
    inline DescribeLiveDomainFrameRateAndBitRateDataResponseBody& setFrameRateAndBitRateInfos(const DescribeLiveDomainFrameRateAndBitRateDataResponseBody::FrameRateAndBitRateInfos & frameRateAndBitRateInfos) { DARABONBA_PTR_SET_VALUE(frameRateAndBitRateInfos_, frameRateAndBitRateInfos) };
    inline DescribeLiveDomainFrameRateAndBitRateDataResponseBody& setFrameRateAndBitRateInfos(DescribeLiveDomainFrameRateAndBitRateDataResponseBody::FrameRateAndBitRateInfos && frameRateAndBitRateInfos) { DARABONBA_PTR_SET_RVALUE(frameRateAndBitRateInfos_, frameRateAndBitRateInfos) };
