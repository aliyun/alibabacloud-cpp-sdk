...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLivePullToPushResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLivePullToPushResponseBody) };
    inline DescribeLivePullToPushResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLivePullToPushResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLivePullToPushResponseBody> body_ {};
  };
