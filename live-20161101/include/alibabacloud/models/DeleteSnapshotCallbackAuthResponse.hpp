...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSnapshotCallbackAuthResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSnapshotCallbackAuthResponseBody) };
    inline DeleteSnapshotCallbackAuthResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSnapshotCallbackAuthResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSnapshotCallbackAuthResponseBody> body_ {};
  };
