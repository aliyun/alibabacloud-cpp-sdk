...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMessageGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateMessageGroupResponseBody) };
    inline UpdateMessageGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateMessageGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateMessageGroupResponseBody> body_ {};
  };
