...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLiveAIStudioResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyLiveAIStudioResponseBody) };
    inline ModifyLiveAIStudioResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyLiveAIStudioResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyLiveAIStudioResponseBody> body_ {};
  };
