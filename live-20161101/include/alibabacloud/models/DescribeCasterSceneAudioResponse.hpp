...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCasterSceneAudioResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCasterSceneAudioResponseBody) };
    inline DescribeCasterSceneAudioResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCasterSceneAudioResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCasterSceneAudioResponseBody> body_ {};
  };
