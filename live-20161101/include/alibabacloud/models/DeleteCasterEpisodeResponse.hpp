...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCasterEpisodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCasterEpisodeResponseBody) };
    inline DeleteCasterEpisodeResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCasterEpisodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCasterEpisodeResponseBody> body_ {};
  };
