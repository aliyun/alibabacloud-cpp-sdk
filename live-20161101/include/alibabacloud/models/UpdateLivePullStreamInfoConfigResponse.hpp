...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLivePullStreamInfoConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLivePullStreamInfoConfigResponseBody) };
    inline UpdateLivePullStreamInfoConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLivePullStreamInfoConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLivePullStreamInfoConfigResponseBody> body_ {};
  };
