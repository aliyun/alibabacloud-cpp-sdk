...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePlaylistItemsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePlaylistItemsResponseBody) };
    inline DeletePlaylistItemsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePlaylistItemsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePlaylistItemsResponseBody> body_ {};
  };
