...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->app_ == nullptr
        ...
        && return this->monitorId_ == nullptr && return this->monitorName_ == nullptr && return this->outputTemplate_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr
