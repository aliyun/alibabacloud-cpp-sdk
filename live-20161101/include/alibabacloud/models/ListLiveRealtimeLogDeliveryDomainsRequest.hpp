...
#ifndef ALIBABACLOUD_MODELS_LISTLIVEREALTIMELOGDELIVERYDOMAINSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTLIVEREALTIMELOGDELIVERYDOMAINSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListLiveRealtimeLogDeliveryDomainsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListLiveRealtimeLogDeliveryDomainsRequest& obj) { 
    ...
    ListLiveRealtimeLogDeliveryDomainsRequest() = default ;
    ListLiveRealtimeLogDeliveryDomainsRequest(const ListLiveRealtimeLogDeliveryDomainsRequest &) = default ;
    ListLiveRealtimeLogDeliveryDomainsRequest(ListLiveRealtimeLogDeliveryDomainsRequest &&) = default ;
    ListLiveRealtimeLogDeliveryDomainsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListLiveRealtimeLogDeliveryDomainsRequest() = default ;
    ListLiveRealtimeLogDeliveryDomainsRequest& operator=(const ListLiveRealtimeLogDeliveryDomainsRequest &) = default ;
    ListLiveRealtimeLogDeliveryDomainsRequest& operator=(ListLiveRealtimeLogDeliveryDomainsRequest &&) = default ;
