...
namespace Models
{
  ...
  public:
    ...
    inline const MuteGroupUserResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, MuteGroupUserResponseBody::Result) };
    inline MuteGroupUserResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, MuteGroupUserResponseBody::Result) };
    inline MuteGroupUserResponseBody& setResult(const MuteGroupUserResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline MuteGroupUserResponseBody& setResult(MuteGroupUserResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
