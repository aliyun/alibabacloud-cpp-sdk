...
namespace Models
{
  ...
  public:
    ...
    inline const ListLiveTagResourcesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListLiveTagResourcesResponseBody) };
    inline ListLiveTagResourcesResponseBody body() { DARABONBA_PTR_GET(body_, ListLiveTagResourcesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListLiveTagResourcesResponseBody> body_ = nullptr;
  };
