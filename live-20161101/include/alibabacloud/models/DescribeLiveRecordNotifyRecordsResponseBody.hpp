...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeLiveRecordNotifyRecordsResponseBodyCallbackList> & callbackList() const { DARABONBA_PTR_GET_CONST(callbackList_, vector<DescribeLiveRecordNotifyRecordsResponseBodyCallbackList>) };
    inline vector<DescribeLiveRecordNotifyRecordsResponseBodyCallbackList> callbackList() { DARABONBA_PTR_GET(callbackList_, vector<DescribeLiveRecordNotifyRecordsResponseBodyCallbackList>) };
    inline DescribeLiveRecordNotifyRecordsResponseBody& setCallbackList(const vector<DescribeLiveRecordNotifyRecordsResponseBodyCallbackList> & callbackList) { DARABONBA_PTR_SET_VALUE(callbackList_, callbackList) };
    inline DescribeLiveRecordNotifyRecordsResponseBody& setCallbackList(vector<DescribeLiveRecordNotifyRecordsResponseBodyCallbackList> && callbackList) { DARABONBA_PTR_SET_RVALUE(callbackList_, callbackList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeLiveRecordNotifyRecordsResponseBodyCallbackList>> callbackList_ = nullptr;
    // The error code.
