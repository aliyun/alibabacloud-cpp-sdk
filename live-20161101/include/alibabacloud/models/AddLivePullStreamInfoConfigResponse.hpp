...
namespace Models
{
  ...
  public:
    ...
    inline const AddLivePullStreamInfoConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddLivePullStreamInfoConfigResponseBody) };
    inline AddLivePullStreamInfoConfigResponseBody body() { DARABONBA_PTR_GET(body_, AddLivePullStreamInfoConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddLivePullStreamInfoConfigResponseBody> body_ = nullptr;
  };
