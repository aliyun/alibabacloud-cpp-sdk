...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appName_ == nullptr
        && return this->delay_ == nullptr && return this->domainName_ == nullptr && return this->ownerId_ == nullptr && return this->pattern_ == nullptr && return this->regionId_ == nullptr
        && return this->repeat_ == nullptr && return this->streamName_ == nullptr && return this->text_ == nullptr; };
    ...
    inline int32_t repeat() const { DARABONBA_PTR_GET_DEFAULT(repeat_, 0) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<int32_t> repeat_ = nullptr;
