...
#ifndef ALIBABACLOUD_MODELS_UPDATELIVEPULLTOPUSHSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATELIVEPULLTOPUSHSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    ...
    UpdateLivePullToPushShrinkRequest() = default ;
    UpdateLivePullToPushShrinkRequest(const UpdateLivePullToPushShrinkRequest &) = default ;
    UpdateLivePullToPushShrinkRequest(UpdateLivePullToPushShrinkRequest &&) = default ;
    UpdateLivePullToPushShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateLivePullToPushShrinkRequest() = default ;
    UpdateLivePullToPushShrinkRequest& operator=(const UpdateLivePullToPushShrinkRequest &) = default ;
    UpdateLivePullToPushShrinkRequest& operator=(UpdateLivePullToPushShrinkRequest &&) = default ;
