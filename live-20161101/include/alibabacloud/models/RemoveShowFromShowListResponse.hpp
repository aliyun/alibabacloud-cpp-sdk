...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveShowFromShowListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveShowFromShowListResponseBody) };
    inline RemoveShowFromShowListResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveShowFromShowListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveShowFromShowListResponseBody> body_ {};
  };
