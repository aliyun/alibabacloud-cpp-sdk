...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateEdgeTranscodeJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateEdgeTranscodeJobResponseBody) };
    inline UpdateEdgeTranscodeJobResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateEdgeTranscodeJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateEdgeTranscodeJobResponseBody> body_ {};
  };
