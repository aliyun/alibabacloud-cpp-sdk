...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePlaylistResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeletePlaylistResponseBody) };
    inline DeletePlaylistResponseBody body() { DARABONBA_PTR_GET(body_, DeletePlaylistResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeletePlaylistResponseBody> body_ = nullptr;
  };
