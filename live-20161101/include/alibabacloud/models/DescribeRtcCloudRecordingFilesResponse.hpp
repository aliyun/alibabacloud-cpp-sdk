...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRtcCloudRecordingFilesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRtcCloudRecordingFilesResponseBody) };
    inline DescribeRtcCloudRecordingFilesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRtcCloudRecordingFilesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRtcCloudRecordingFilesResponseBody> body_ {};
  };
