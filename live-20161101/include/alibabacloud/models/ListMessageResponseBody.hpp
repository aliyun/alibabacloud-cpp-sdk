...
namespace Models
{
  ...
  public:
    ...
    inline const ListMessageResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListMessageResponseBodyResult) };
    inline ListMessageResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListMessageResponseBodyResult) };
    inline ListMessageResponseBody& setResult(const ListMessageResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListMessageResponseBody& setResult(ListMessageResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<ListMessageResponseBodyResult> result_ = nullptr;
  };
