...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveUserStreamMetricDataResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveUserStreamMetricDataResponseBody) };
    inline DescribeLiveUserStreamMetricDataResponseBody body() { DARABONBA_PTR_GET(body_, DescribeLiveUserStreamMetricDataResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLiveUserStreamMetricDataResponseBody> body_ = nullptr;
  };
