...
namespace Models
{
  ...
  public:
    ...
    inline const AddLiveSnapshotNotifyConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddLiveSnapshotNotifyConfigResponseBody) };
    inline AddLiveSnapshotNotifyConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, AddLiveSnapshotNotifyConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddLiveSnapshotNotifyConfigResponseBody> body_ {};
  };
