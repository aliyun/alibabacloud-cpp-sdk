...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataInterval_ == nullptr
        && return this->endTime_ == nullptr && return this->frameDelayData_ == nullptr && return this->requestId_ == nullptr && return this->startTime_ == nullptr; };
    ...
    inline const vector<DescribeRTSNativeSDKFirstFrameDelayResponseBodyFrameDelayData> & frameDelayData() const { DARABONBA_PTR_GET_CONST(frameDelayData_, vector<DescribeRTSNativeSDKFirstFrameDelayResponseBodyFrameDelayData>) };
    inline vector<DescribeRTSNativeSDKFirstFrameDelayResponseBodyFrameDelayData> frameDelayData() { DARABONBA_PTR_GET(frameDelayData_, vector<DescribeRTSNativeSDKFirstFrameDelayResponseBodyFrameDelayData>) };
    inline DescribeRTSNativeSDKFirstFrameDelayResponseBody& setFrameDelayData(const vector<DescribeRTSNativeSDKFirstFrameDelayResponseBodyFrameDelayData> & frameDelayData) { DARABONBA_PTR_SET_VALUE(frameDelayData_, frameDelayData) };
    inline DescribeRTSNativeSDKFirstFrameDelayResponseBody& setFrameDelayData(vector<DescribeRTSNativeSDKFirstFrameDelayResponseBodyFrameDelayData> && frameDelayData) { DARABONBA_PTR_SET_RVALUE(frameDelayData_, frameDelayData) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeRTSNativeSDKFirstFrameDelayResponseBodyFrameDelayData>> frameDelayData_ = nullptr;
