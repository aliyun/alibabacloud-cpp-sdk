...
#ifndef ALIBABACLOUD_MODELS_DESCRIBELIVEREALTIMEDELIVERYACCREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBELIVEREALTIMEDELIVERYACCREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeLiveRealtimeDeliveryAccRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeLiveRealtimeDeliveryAccRequest& obj) { 
    ...
    DescribeLiveRealtimeDeliveryAccRequest() = default ;
    DescribeLiveRealtimeDeliveryAccRequest(const DescribeLiveRealtimeDeliveryAccRequest &) = default ;
    DescribeLiveRealtimeDeliveryAccRequest(DescribeLiveRealtimeDeliveryAccRequest &&) = default ;
    DescribeLiveRealtimeDeliveryAccRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeLiveRealtimeDeliveryAccRequest() = default ;
    DescribeLiveRealtimeDeliveryAccRequest& operator=(const DescribeLiveRealtimeDeliveryAccRequest &) = default ;
    DescribeLiveRealtimeDeliveryAccRequest& operator=(DescribeLiveRealtimeDeliveryAccRequest &&) = default ;
