...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveDomainLogExTtlResponseBody::DomainLogDetails & getDomainLogDetails() const { DARABONBA_PTR_GET_CONST(domainLogDetails_, DescribeLiveDomainLogExTtlResponseBody::DomainLogDetails) };
    inline DescribeLiveDomainLogExTtlResponseBody::DomainLogDetails getDomainLogDetails() { DARABONBA_PTR_GET(domainLogDetails_, DescribeLiveDomainLogExTtlResponseBody::DomainLogDetails) };
    inline DescribeLiveDomainLogExTtlResponseBody& setDomainLogDetails(const DescribeLiveDomainLogExTtlResponseBody::DomainLogDetails & domainLogDetails) { DARABONBA_PTR_SET_VALUE(domainLogDetails_, domainLogDetails) };
    inline DescribeLiveDomainLogExTtlResponseBody& setDomainLogDetails(DescribeLiveDomainLogExTtlResponseBody::DomainLogDetails && domainLogDetails) { DARABONBA_PTR_SET_RVALUE(domainLogDetails_, domainLogDetails) };
  ...
  protected:
    shared_ptr<DescribeLiveDomainLogExTtlResponseBody::DomainLogDetails> domainLogDetails_ {};
