...
namespace Models
{
  ...
  public:
    ...
    inline const AddCasterEpisodeGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddCasterEpisodeGroupResponseBody) };
    inline AddCasterEpisodeGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, AddCasterEpisodeGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddCasterEpisodeGroupResponseBody> body_ {};
  };
