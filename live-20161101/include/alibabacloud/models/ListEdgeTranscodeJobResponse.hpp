...
namespace Models
{
  ...
  public:
    ...
    inline const ListEdgeTranscodeJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListEdgeTranscodeJobResponseBody) };
    inline ListEdgeTranscodeJobResponseBody body() { DARABONBA_PTR_GET(body_, ListEdgeTranscodeJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListEdgeTranscodeJobResponseBody> body_ = nullptr;
  };
