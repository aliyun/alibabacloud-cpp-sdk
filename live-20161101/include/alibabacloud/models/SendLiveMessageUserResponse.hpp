...
namespace Models
{
  ...
  public:
    ...
    inline const SendLiveMessageUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendLiveMessageUserResponseBody) };
    inline SendLiveMessageUserResponseBody getBody() { DARABONBA_PTR_GET(body_, SendLiveMessageUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendLiveMessageUserResponseBody> body_ {};
  };
