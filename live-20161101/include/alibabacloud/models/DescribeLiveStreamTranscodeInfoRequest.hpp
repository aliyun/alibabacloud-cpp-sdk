...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appName_ == nullptr
        && this->domainTranscodeName_ == nullptr && this->ownerId_ == nullptr && this->regionId_ == nullptr; };
    ...
    inline string getDomainTranscodeName() const { DARABONBA_PTR_GET_DEFAULT(domainTranscodeName_, "") };
