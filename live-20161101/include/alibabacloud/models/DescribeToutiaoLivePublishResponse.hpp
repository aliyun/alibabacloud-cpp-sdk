...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeToutiaoLivePublishResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeToutiaoLivePublishResponseBody) };
    inline DescribeToutiaoLivePublishResponseBody body() { DARABONBA_PTR_GET(body_, DescribeToutiaoLivePublishResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeToutiaoLivePublishResponseBody> body_ = nullptr;
  };
