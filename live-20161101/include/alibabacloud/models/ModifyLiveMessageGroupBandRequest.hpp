...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->bannedAll_ == nullptr && this->bannnedUsers_ == nullptr && this->dataCenter_ == nullptr && this->exceptUsers_ == nullptr && this->groupId_ == nullptr; };
    ...
    inline const vector<string> & getBannnedUsers() const { DARABONBA_PTR_GET_CONST(bannnedUsers_, vector<string>) };
    inline vector<string> getBannnedUsers() { DARABONBA_PTR_GET(bannnedUsers_, vector<string>) };
    ...
    inline const vector<string> & getExceptUsers() const { DARABONBA_PTR_GET_CONST(exceptUsers_, vector<string>) };
    inline vector<string> getExceptUsers() { DARABONBA_PTR_GET(exceptUsers_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> bannnedUsers_ {};
    ...
    shared_ptr<vector<string>> exceptUsers_ {};
    // The group ID.
    // 
    // This parameter is required.
