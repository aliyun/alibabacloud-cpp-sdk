...
namespace Models
{
  ...
  public:
    ...
    inline const HotLiveRtcStreamResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, HotLiveRtcStreamResponseBody) };
    inline HotLiveRtcStreamResponseBody getBody() { DARABONBA_PTR_GET(body_, HotLiveRtcStreamResponseBody) };
  ...
  protected:
    ...
    shared_ptr<HotLiveRtcStreamResponseBody> body_ {};
  };
