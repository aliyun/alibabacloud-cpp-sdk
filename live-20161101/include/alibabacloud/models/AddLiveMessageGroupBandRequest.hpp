...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getBannedUsers() const { DARABONBA_PTR_GET_CONST(bannedUsers_, vector<string>) };
    inline vector<string> getBannedUsers() { DARABONBA_PTR_GET(bannedUsers_, vector<string>) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<string>> bannedUsers_ {};
