...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveCertificateListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveCertificateListResponseBody) };
    inline DescribeLiveCertificateListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveCertificateListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveCertificateListResponseBody> body_ {};
  };
