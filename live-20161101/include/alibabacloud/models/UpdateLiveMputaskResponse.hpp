...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLiveMPUTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateLiveMPUTaskResponseBody) };
    inline UpdateLiveMPUTaskResponseBody body() { DARABONBA_PTR_GET(body_, UpdateLiveMPUTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateLiveMPUTaskResponseBody> body_ = nullptr;
  };
