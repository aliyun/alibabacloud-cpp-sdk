...
#ifndef ALIBABACLOUD_MODELS_CREATELIVEAISTUDIOSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATELIVEAISTUDIOSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateLiveAIStudioShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateLiveAIStudioShrinkRequest& obj) { 
    ...
    CreateLiveAIStudioShrinkRequest() = default ;
    CreateLiveAIStudioShrinkRequest(const CreateLiveAIStudioShrinkRequest &) = default ;
    CreateLiveAIStudioShrinkRequest(CreateLiveAIStudioShrinkRequest &&) = default ;
    CreateLiveAIStudioShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateLiveAIStudioShrinkRequest() = default ;
    CreateLiveAIStudioShrinkRequest& operator=(const CreateLiveAIStudioShrinkRequest &) = default ;
    CreateLiveAIStudioShrinkRequest& operator=(CreateLiveAIStudioShrinkRequest &&) = default ;
