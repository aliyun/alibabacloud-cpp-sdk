...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteChannelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteChannelResponseBody) };
    inline DeleteChannelResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteChannelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteChannelResponseBody> body_ {};
  };
