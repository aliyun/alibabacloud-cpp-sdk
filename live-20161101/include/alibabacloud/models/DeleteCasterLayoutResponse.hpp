...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCasterLayoutResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCasterLayoutResponseBody) };
    inline DeleteCasterLayoutResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCasterLayoutResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCasterLayoutResponseBody> body_ {};
  };
