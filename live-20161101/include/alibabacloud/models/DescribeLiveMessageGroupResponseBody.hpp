...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->adminList_ == nullptr
        && return this->createtime_ == nullptr && return this->creatorId_ == nullptr && return this->deletatime_ == nullptr && return this->delete_ == nullptr && return this->deletor_ == nullptr
        && return this->groupId_ == nullptr && return this->groupInfo_ == nullptr && return this->groupName_ == nullptr && return this->msgAmount_ == nullptr && return this->onlineUserCounts_ == nullptr
        && return this->requestId_ == nullptr && return this->superLargeGroup_ == nullptr && return this->totalTimes_ == nullptr; };
    ...
    inline int64_t deletatime() const { DARABONBA_PTR_GET_DEFAULT(deletatime_, 0L) };
    ...
    inline string deletor() const { DARABONBA_PTR_GET_DEFAULT(deletor_, "") };
    ...
    inline const map<string, int64_t> & msgAmount() const { DARABONBA_PTR_GET_CONST(msgAmount_, map<string, int64_t>) };
    inline map<string, int64_t> msgAmount() { DARABONBA_PTR_GET(msgAmount_, map<string, int64_t>) };
    ...
    inline int64_t onlineUserCounts() const { DARABONBA_PTR_GET_DEFAULT(onlineUserCounts_, 0L) };
    ...
    inline bool superLargeGroup() const { DARABONBA_PTR_GET_DEFAULT(superLargeGroup_, false) };
    ...
    inline int64_t totalTimes() const { DARABONBA_PTR_GET_DEFAULT(totalTimes_, 0L) };
  ...
  protected:
    ...
    std::shared_ptr<int64_t> deletatime_ = nullptr;
    ...
    std::shared_ptr<string> deletor_ = nullptr;
    // The group ID.
    ...
    std::shared_ptr<map<string, int64_t>> msgAmount_ = nullptr;
    // The number of online users in the group. This parameter is returned only if the group exists.
    std::shared_ptr<int64_t> onlineUserCounts_ = nullptr;
    // The request ID.
    ...
    // *   True
    // *   False
    std::shared_ptr<bool> superLargeGroup_ = nullptr;
    // The total number of sessions. This parameter is returned only if the group exists.
    std::shared_ptr<int64_t> totalTimes_ = nullptr;
  };
