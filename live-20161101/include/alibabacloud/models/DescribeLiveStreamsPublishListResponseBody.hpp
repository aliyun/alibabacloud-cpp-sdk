...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveStreamsPublishListResponseBodyPublishInfo & publishInfo() const { DARABONBA_PTR_GET_CONST(publishInfo_, DescribeLiveStreamsPublishListResponseBodyPublishInfo) };
    inline DescribeLiveStreamsPublishListResponseBodyPublishInfo publishInfo() { DARABONBA_PTR_GET(publishInfo_, DescribeLiveStreamsPublishListResponseBodyPublishInfo) };
    inline DescribeLiveStreamsPublishListResponseBody& setPublishInfo(const DescribeLiveStreamsPublishListResponseBodyPublishInfo & publishInfo) { DARABONBA_PTR_SET_VALUE(publishInfo_, publishInfo) };
    inline DescribeLiveStreamsPublishListResponseBody& setPublishInfo(DescribeLiveStreamsPublishListResponseBodyPublishInfo && publishInfo) { DARABONBA_PTR_SET_RVALUE(publishInfo_, publishInfo) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLiveStreamsPublishListResponseBodyPublishInfo> publishInfo_ = nullptr;
    // The request ID.
