...
namespace Models
{
  ...
  public:
    ...
    inline const StopRtcCloudRecordingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopRtcCloudRecordingResponseBody) };
    inline StopRtcCloudRecordingResponseBody getBody() { DARABONBA_PTR_GET(body_, StopRtcCloudRecordingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopRtcCloudRecordingResponseBody> body_ {};
  };
