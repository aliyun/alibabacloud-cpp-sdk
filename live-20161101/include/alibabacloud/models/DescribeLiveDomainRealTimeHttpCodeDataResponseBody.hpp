...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveDomainRealTimeHttpCodeDataResponseBody::RealTimeHttpCodeData & getRealTimeHttpCodeData() const { DARABONBA_PTR_GET_CONST(realTimeHttpCodeData_, DescribeLiveDomainRealTimeHttpCodeDataResponseBody::RealTimeHttpCodeData) };
    inline DescribeLiveDomainRealTimeHttpCodeDataResponseBody::RealTimeHttpCodeData getRealTimeHttpCodeData() { DARABONBA_PTR_GET(realTimeHttpCodeData_, DescribeLiveDomainRealTimeHttpCodeDataResponseBody::RealTimeHttpCodeData) };
    inline DescribeLiveDomainRealTimeHttpCodeDataResponseBody& setRealTimeHttpCodeData(const DescribeLiveDomainRealTimeHttpCodeDataResponseBody::RealTimeHttpCodeData & realTimeHttpCodeData) { DARABONBA_PTR_SET_VALUE(realTimeHttpCodeData_, realTimeHttpCodeData) };
    inline DescribeLiveDomainRealTimeHttpCodeDataResponseBody& setRealTimeHttpCodeData(DescribeLiveDomainRealTimeHttpCodeDataResponseBody::RealTimeHttpCodeData && realTimeHttpCodeData) { DARABONBA_PTR_SET_RVALUE(realTimeHttpCodeData_, realTimeHttpCodeData) };
