...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->domainName_ == nullptr
        && return this->endTime_ == nullptr && return this->interval_ == nullptr && return this->ownerId_ == nullptr && return this->precision_ == nullptr && return this->regionId_ == nullptr
        && return this->split_ == nullptr && return this->startTime_ == nullptr; };
    ...
    inline string precision() const { DARABONBA_PTR_GET_DEFAULT(precision_, "") };
    ...
    inline string split() const { DARABONBA_PTR_GET_DEFAULT(split_, "") };
  ...
  protected:
    ...
    // *   **sec**: in seconds.
    std::shared_ptr<string> precision_ = nullptr;
    ...
    std::shared_ptr<string> split_ = nullptr;
