...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveStreamPushMetricDetailDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveStreamPushMetricDetailDataResponseBody) };
    inline DescribeLiveStreamPushMetricDetailDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveStreamPushMetricDetailDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveStreamPushMetricDetailDataResponseBody> body_ {};
  };
