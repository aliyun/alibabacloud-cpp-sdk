...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUpBpsPeakDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUpBpsPeakDataResponseBody) };
    inline DescribeUpBpsPeakDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUpBpsPeakDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUpBpsPeakDataResponseBody> body_ {};
  };
