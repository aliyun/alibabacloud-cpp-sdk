...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLiveStreamsNotifyUrlConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLiveStreamsNotifyUrlConfigResponseBody) };
    inline DeleteLiveStreamsNotifyUrlConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLiveStreamsNotifyUrlConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLiveStreamsNotifyUrlConfigResponseBody> body_ {};
  };
