...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->channelId_ == nullptr && this->mixMode_ == nullptr && this->multiStreamURL_ == nullptr && this->seiParams_ == nullptr && this->singleSubParams_ == nullptr
        && this->streamURL_ == nullptr && this->taskId_ == nullptr && this->transcodeParams_ == nullptr; };
    ...
    inline const vector<UpdateLiveMPUTaskRequest::MultiStreamURL> & getMultiStreamURL() const { DARABONBA_PTR_GET_CONST(multiStreamURL_, vector<UpdateLiveMPUTaskRequest::MultiStreamURL>) };
    inline vector<UpdateLiveMPUTaskRequest::MultiStreamURL> getMultiStreamURL() { DARABONBA_PTR_GET(multiStreamURL_, vector<UpdateLiveMPUTaskRequest::MultiStreamURL>) };
    inline UpdateLiveMPUTaskRequest& setMultiStreamURL(const vector<UpdateLiveMPUTaskRequest::MultiStreamURL> & multiStreamURL) { DARABONBA_PTR_SET_VALUE(multiStreamURL_, multiStreamURL) };
    inline UpdateLiveMPUTaskRequest& setMultiStreamURL(vector<UpdateLiveMPUTaskRequest::MultiStreamURL> && multiStreamURL) { DARABONBA_PTR_SET_RVALUE(multiStreamURL_, multiStreamURL) };
    ...
    inline const UpdateLiveMPUTaskRequest::SeiParams & getSeiParams() const { DARABONBA_PTR_GET_CONST(seiParams_, UpdateLiveMPUTaskRequest::SeiParams) };
    inline UpdateLiveMPUTaskRequest::SeiParams getSeiParams() { DARABONBA_PTR_GET(seiParams_, UpdateLiveMPUTaskRequest::SeiParams) };
    inline UpdateLiveMPUTaskRequest& setSeiParams(const UpdateLiveMPUTaskRequest::SeiParams & seiParams) { DARABONBA_PTR_SET_VALUE(seiParams_, seiParams) };
    inline UpdateLiveMPUTaskRequest& setSeiParams(UpdateLiveMPUTaskRequest::SeiParams && seiParams) { DARABONBA_PTR_SET_RVALUE(seiParams_, seiParams) };
    ...
    inline const UpdateLiveMPUTaskRequest::SingleSubParams & getSingleSubParams() const { DARABONBA_PTR_GET_CONST(singleSubParams_, UpdateLiveMPUTaskRequest::SingleSubParams) };
    inline UpdateLiveMPUTaskRequest::SingleSubParams getSingleSubParams() { DARABONBA_PTR_GET(singleSubParams_, UpdateLiveMPUTaskRequest::SingleSubParams) };
    inline UpdateLiveMPUTaskRequest& setSingleSubParams(const UpdateLiveMPUTaskRequest::SingleSubParams & singleSubParams) { DARABONBA_PTR_SET_VALUE(singleSubParams_, singleSubParams) };
    inline UpdateLiveMPUTaskRequest& setSingleSubParams(UpdateLiveMPUTaskRequest::SingleSubParams && singleSubParams) { DARABONBA_PTR_SET_RVALUE(singleSubParams_, singleSubParams) };
    ...
    inline const UpdateLiveMPUTaskRequest::TranscodeParams & getTranscodeParams() const { DARABONBA_PTR_GET_CONST(transcodeParams_, UpdateLiveMPUTaskRequest::TranscodeParams) };
    inline UpdateLiveMPUTaskRequest::TranscodeParams getTranscodeParams() { DARABONBA_PTR_GET(transcodeParams_, UpdateLiveMPUTaskRequest::TranscodeParams) };
    inline UpdateLiveMPUTaskRequest& setTranscodeParams(const UpdateLiveMPUTaskRequest::TranscodeParams & transcodeParams) { DARABONBA_PTR_SET_VALUE(transcodeParams_, transcodeParams) };
    inline UpdateLiveMPUTaskRequest& setTranscodeParams(UpdateLiveMPUTaskRequest::TranscodeParams && transcodeParams) { DARABONBA_PTR_SET_RVALUE(transcodeParams_, transcodeParams) };
  ...
  protected:
    ...
    shared_ptr<UpdateLiveMPUTaskRequest::SeiParams> seiParams_ {};
    ...
    shared_ptr<UpdateLiveMPUTaskRequest::TranscodeParams> transcodeParams_ {};
  };
