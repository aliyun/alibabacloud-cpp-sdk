...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveVerifyContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveVerifyContentResponseBody) };
    inline DescribeLiveVerifyContentResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveVerifyContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveVerifyContentResponseBody> body_ {};
  };
