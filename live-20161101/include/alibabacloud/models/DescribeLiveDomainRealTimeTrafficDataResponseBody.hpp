...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveDomainRealTimeTrafficDataResponseBodyRealTimeTrafficDataPerInterval & realTimeTrafficDataPerInterval() const { DARABONBA_PTR_GET_CONST(realTimeTrafficDataPerInterval_, DescribeLiveDomainRealTimeTrafficDataResponseBodyRealTimeTrafficDataPerInterval) };
    inline DescribeLiveDomainRealTimeTrafficDataResponseBodyRealTimeTrafficDataPerInterval realTimeTrafficDataPerInterval() { DARABONBA_PTR_GET(realTimeTrafficDataPerInterval_, DescribeLiveDomainRealTimeTrafficDataResponseBodyRealTimeTrafficDataPerInterval) };
    inline DescribeLiveDomainRealTimeTrafficDataResponseBody& setRealTimeTrafficDataPerInterval(const DescribeLiveDomainRealTimeTrafficDataResponseBodyRealTimeTrafficDataPerInterval & realTimeTrafficDataPerInterval) { DARABONBA_PTR_SET_VALUE(realTimeTrafficDataPerInterval_, realTimeTrafficDataPerInterval) };
    inline DescribeLiveDomainRealTimeTrafficDataResponseBody& setRealTimeTrafficDataPerInterval(DescribeLiveDomainRealTimeTrafficDataResponseBodyRealTimeTrafficDataPerInterval && realTimeTrafficDataPerInterval) { DARABONBA_PTR_SET_RVALUE(realTimeTrafficDataPerInterval_, realTimeTrafficDataPerInterval) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLiveDomainRealTimeTrafficDataResponseBodyRealTimeTrafficDataPerInterval> realTimeTrafficDataPerInterval_ = nullptr;
    // The request ID.
