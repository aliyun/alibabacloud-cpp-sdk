...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->broadCastType_ == nullptr && this->cancelMuteUserListShrink_ == nullptr && this->groupId_ == nullptr && this->operatorUserId_ == nullptr; };
    ...
    inline string getCancelMuteUserListShrink() const { DARABONBA_PTR_GET_DEFAULT(cancelMuteUserListShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> cancelMuteUserListShrink_ {};
