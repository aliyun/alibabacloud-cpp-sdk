...
namespace Models
{
  ...
  public:
    ...
    inline const ListMessageGroupResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListMessageGroupResponseBodyResult) };
    inline ListMessageGroupResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListMessageGroupResponseBodyResult) };
    inline ListMessageGroupResponseBody& setResult(const ListMessageGroupResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListMessageGroupResponseBody& setResult(ListMessageGroupResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<ListMessageGroupResponseBodyResult> result_ = nullptr;
  };
