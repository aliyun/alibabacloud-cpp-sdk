...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLiveSnapshotDetectPornConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateLiveSnapshotDetectPornConfigResponseBody) };
    inline UpdateLiveSnapshotDetectPornConfigResponseBody body() { DARABONBA_PTR_GET(body_, UpdateLiveSnapshotDetectPornConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateLiveSnapshotDetectPornConfigResponseBody> body_ = nullptr;
  };
