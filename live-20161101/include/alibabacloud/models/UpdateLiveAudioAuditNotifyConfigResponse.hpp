...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLiveAudioAuditNotifyConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLiveAudioAuditNotifyConfigResponseBody) };
    inline UpdateLiveAudioAuditNotifyConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLiveAudioAuditNotifyConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLiveAudioAuditNotifyConfigResponseBody> body_ {};
  };
