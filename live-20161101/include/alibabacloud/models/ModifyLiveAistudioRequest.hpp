...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLiveAIStudioRequestMattingLayout & mattingLayout() const { DARABONBA_PTR_GET_CONST(mattingLayout_, ModifyLiveAIStudioRequestMattingLayout) };
    inline ModifyLiveAIStudioRequestMattingLayout mattingLayout() { DARABONBA_PTR_GET(mattingLayout_, ModifyLiveAIStudioRequestMattingLayout) };
    inline ModifyLiveAIStudioRequest& setMattingLayout(const ModifyLiveAIStudioRequestMattingLayout & mattingLayout) { DARABONBA_PTR_SET_VALUE(mattingLayout_, mattingLayout) };
    inline ModifyLiveAIStudioRequest& setMattingLayout(ModifyLiveAIStudioRequestMattingLayout && mattingLayout) { DARABONBA_PTR_SET_RVALUE(mattingLayout_, mattingLayout) };
    ...
    inline const ModifyLiveAIStudioRequestMediaLayout & mediaLayout() const { DARABONBA_PTR_GET_CONST(mediaLayout_, ModifyLiveAIStudioRequestMediaLayout) };
    inline ModifyLiveAIStudioRequestMediaLayout mediaLayout() { DARABONBA_PTR_GET(mediaLayout_, ModifyLiveAIStudioRequestMediaLayout) };
    inline ModifyLiveAIStudioRequest& setMediaLayout(const ModifyLiveAIStudioRequestMediaLayout & mediaLayout) { DARABONBA_PTR_SET_VALUE(mediaLayout_, mediaLayout) };
    inline ModifyLiveAIStudioRequest& setMediaLayout(ModifyLiveAIStudioRequestMediaLayout && mediaLayout) { DARABONBA_PTR_SET_RVALUE(mediaLayout_, mediaLayout) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyLiveAIStudioRequestMattingLayout> mattingLayout_ = nullptr;
    ...
    std::shared_ptr<ModifyLiveAIStudioRequestMediaLayout> mediaLayout_ = nullptr;
