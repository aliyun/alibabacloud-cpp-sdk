...
#ifndef ALIBABACLOUD_MODELS_STARTRTCCLOUDTRANSCODEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_STARTRTCCLOUDTRANSCODEREQUEST_HPP_
...
namespace Models
{
  class StartRtcCloudTranscodeRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const StartRtcCloudTranscodeRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartRtcCloudTranscodeRequest& obj) { 
    ...
    StartRtcCloudTranscodeRequest() = default ;
    StartRtcCloudTranscodeRequest(const StartRtcCloudTranscodeRequest &) = default ;
    StartRtcCloudTranscodeRequest(StartRtcCloudTranscodeRequest &&) = default ;
    StartRtcCloudTranscodeRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartRtcCloudTranscodeRequest() = default ;
    StartRtcCloudTranscodeRequest& operator=(const StartRtcCloudTranscodeRequest &) = default ;
    StartRtcCloudTranscodeRequest& operator=(StartRtcCloudTranscodeRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->channelId_ == nullptr && this->inputParam_ == nullptr && this->maxIdleTime_ == nullptr && this->outputParams_ == nullptr; };
    // appId Field Functions 
    bool hasAppId() const { return this->appId_ != nullptr;};
    void deleteAppId() { this->appId_ = nullptr;};
    inline string getAppId() const { DARABONBA_PTR_GET_DEFAULT(appId_, "") };
    inline StartRtcCloudTranscodeRequest& setAppId(string appId) { DARABONBA_PTR_SET_VALUE(appId_, appId) };
    ...
    void deleteChannelId() { this->channelId_ = nullptr;};
    inline string getChannelId() const { DARABONBA_PTR_GET_DEFAULT(channelId_, "") };
    inline StartRtcCloudTranscodeRequest& setChannelId(string channelId) { DARABONBA_PTR_SET_VALUE(channelId_, channelId) };
    ...
    inline const StartRtcCloudTranscodeRequest::InputParam & getInputParam() const { DARABONBA_PTR_GET_CONST(inputParam_, StartRtcCloudTranscodeRequest::InputParam) };
    inline StartRtcCloudTranscodeRequest::InputParam getInputParam() { DARABONBA_PTR_GET(inputParam_, StartRtcCloudTranscodeRequest::InputParam) };
    inline StartRtcCloudTranscodeRequest& setInputParam(const StartRtcCloudTranscodeRequest::InputParam & inputParam) { DARABONBA_PTR_SET_VALUE(inputParam_, inputParam) };
    inline StartRtcCloudTranscodeRequest& setInputParam(StartRtcCloudTranscodeRequest::InputParam && inputParam) { DARABONBA_PTR_SET_RVALUE(inputParam_, inputParam) };
    ...
    inline StartRtcCloudTranscodeRequest& setMaxIdleTime(int64_t maxIdleTime) { DARABONBA_PTR_SET_VALUE(maxIdleTime_, maxIdleTime) };
    ...
    inline const vector<StartRtcCloudTranscodeRequest::OutputParams> & getOutputParams() const { DARABONBA_PTR_GET_CONST(outputParams_, vector<StartRtcCloudTranscodeRequest::OutputParams>) };
    inline vector<StartRtcCloudTranscodeRequest::OutputParams> getOutputParams() { DARABONBA_PTR_GET(outputParams_, vector<StartRtcCloudTranscodeRequest::OutputParams>) };
    inline StartRtcCloudTranscodeRequest& setOutputParams(const vector<StartRtcCloudTranscodeRequest::OutputParams> & outputParams) { DARABONBA_PTR_SET_VALUE(outputParams_, outputParams) };
    inline StartRtcCloudTranscodeRequest& setOutputParams(vector<StartRtcCloudTranscodeRequest::OutputParams> && outputParams) { DARABONBA_PTR_SET_RVALUE(outputParams_, outputParams) };
