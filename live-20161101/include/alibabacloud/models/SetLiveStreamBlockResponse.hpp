...
namespace Models
{
  ...
  public:
    ...
    inline const SetLiveStreamBlockResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SetLiveStreamBlockResponseBody) };
    inline SetLiveStreamBlockResponseBody body() { DARABONBA_PTR_GET(body_, SetLiveStreamBlockResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SetLiveStreamBlockResponseBody> body_ = nullptr;
  };
