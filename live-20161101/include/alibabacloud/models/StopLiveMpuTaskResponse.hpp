...
namespace Models
{
  ...
  public:
    ...
    inline const StopLiveMPUTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopLiveMPUTaskResponseBody) };
    inline StopLiveMPUTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, StopLiveMPUTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopLiveMPUTaskResponseBody> body_ {};
  };
