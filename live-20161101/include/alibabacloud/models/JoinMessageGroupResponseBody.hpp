...
namespace Models
{
  ...
  public:
    ...
    inline const JoinMessageGroupResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, JoinMessageGroupResponseBodyResult) };
    inline JoinMessageGroupResponseBodyResult result() { DARABONBA_PTR_GET(result_, JoinMessageGroupResponseBodyResult) };
    inline JoinMessageGroupResponseBody& setResult(const JoinMessageGroupResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline JoinMessageGroupResponseBody& setResult(JoinMessageGroupResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<JoinMessageGroupResponseBodyResult> result_ = nullptr;
  };
