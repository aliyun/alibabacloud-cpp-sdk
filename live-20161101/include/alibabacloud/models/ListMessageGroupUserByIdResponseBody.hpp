...
namespace Models
{
  ...
  public:
    ...
    inline const ListMessageGroupUserByIdResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListMessageGroupUserByIdResponseBodyResult) };
    inline ListMessageGroupUserByIdResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListMessageGroupUserByIdResponseBodyResult) };
    inline ListMessageGroupUserByIdResponseBody& setResult(const ListMessageGroupUserByIdResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListMessageGroupUserByIdResponseBody& setResult(ListMessageGroupUserByIdResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<ListMessageGroupUserByIdResponseBodyResult> result_ = nullptr;
  };
