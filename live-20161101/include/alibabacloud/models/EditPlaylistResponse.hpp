...
namespace Models
{
  ...
  public:
    ...
    inline const EditPlaylistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EditPlaylistResponseBody) };
    inline EditPlaylistResponseBody getBody() { DARABONBA_PTR_GET(body_, EditPlaylistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EditPlaylistResponseBody> body_ {};
  };
