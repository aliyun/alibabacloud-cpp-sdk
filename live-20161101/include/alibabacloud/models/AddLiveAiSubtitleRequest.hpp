...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bgColor_ == nullptr
        ...
        && return this->ownerId_ == nullptr && return this->positionNormalized_ == nullptr && return this->regionId_ == nullptr && return this->showSourceLan_ == nullptr && return this->srcLanguage_ == nullptr
