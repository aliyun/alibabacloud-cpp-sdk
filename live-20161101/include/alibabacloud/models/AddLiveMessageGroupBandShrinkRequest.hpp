...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && return this->bannedUsersShrink_ == nullptr && return this->dataCenter_ == nullptr && return this->groupId_ == nullptr; };
    ...
    inline string bannedUsersShrink() const { DARABONBA_PTR_GET_DEFAULT(bannedUsersShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> bannedUsersShrink_ = nullptr;
