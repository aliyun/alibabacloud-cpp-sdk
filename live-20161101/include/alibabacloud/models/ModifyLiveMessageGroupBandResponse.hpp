...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLiveMessageGroupBandResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyLiveMessageGroupBandResponseBody) };
    inline ModifyLiveMessageGroupBandResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyLiveMessageGroupBandResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyLiveMessageGroupBandResponseBody> body_ {};
  };
