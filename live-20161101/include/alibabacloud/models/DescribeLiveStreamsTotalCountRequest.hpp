...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->domainName_ == nullptr
        && return this->endTime_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr && return this->startTime_ == nullptr && return this->typ_ == nullptr; };
    ...
    inline string typ() const { DARABONBA_PTR_GET_DEFAULT(typ_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> typ_ = nullptr;
  };
