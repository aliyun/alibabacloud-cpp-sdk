...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveStreamBitRateDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveStreamBitRateDataResponseBody) };
    inline DescribeLiveStreamBitRateDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveStreamBitRateDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveStreamBitRateDataResponseBody> body_ {};
  };
