...
namespace Models
{
  ...
  public:
    ...
    inline const CancelMuteGroupUserResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CancelMuteGroupUserResponseBody) };
    inline CancelMuteGroupUserResponseBody body() { DARABONBA_PTR_GET(body_, CancelMuteGroupUserResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CancelMuteGroupUserResponseBody> body_ = nullptr;
  };
