...
namespace Models
{
  ...
  public:
    ...
    inline const ListPlaylistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPlaylistResponseBody) };
    inline ListPlaylistResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPlaylistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPlaylistResponseBody> body_ {};
  };
