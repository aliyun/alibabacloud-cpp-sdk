...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLiveDomainSchdmByPropertyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyLiveDomainSchdmByPropertyResponseBody) };
    inline ModifyLiveDomainSchdmByPropertyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyLiveDomainSchdmByPropertyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyLiveDomainSchdmByPropertyResponseBody> body_ {};
  };
