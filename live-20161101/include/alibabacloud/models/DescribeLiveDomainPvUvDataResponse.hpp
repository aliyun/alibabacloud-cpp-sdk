...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveDomainPvUvDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveDomainPvUvDataResponseBody) };
    inline DescribeLiveDomainPvUvDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveDomainPvUvDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveDomainPvUvDataResponseBody> body_ {};
  };
