...
namespace Models
{
  ...
  public:
    ...
    class RecordIndexInfoList : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const RecordIndexInfoList& obj) { 
        DARABONBA_PTR_TO_JSON(RecordIndexInfo, recordIndexInfo_);
      };
      friend void from_json(const Darabonba::Json& j, RecordIndexInfoList& obj) { 
        DARABONBA_PTR_FROM_JSON(RecordIndexInfo, recordIndexInfo_);
      };
      RecordIndexInfoList() = default ;
      RecordIndexInfoList(const RecordIndexInfoList &) = default ;
      RecordIndexInfoList(RecordIndexInfoList &&) = default ;
      RecordIndexInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~RecordIndexInfoList() = default ;
      RecordIndexInfoList& operator=(const RecordIndexInfoList &) = default ;
      RecordIndexInfoList& operator=(RecordIndexInfoList &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline const vector<RecordIndexInfoList::RecordIndexInfo> & getRecordIndexInfo() const { DARABONBA_PTR_GET_CONST(recordIndexInfo_, vector<RecordIndexInfoList::RecordIndexInfo>) };
      inline vector<RecordIndexInfoList::RecordIndexInfo> getRecordIndexInfo() { DARABONBA_PTR_GET(recordIndexInfo_, vector<RecordIndexInfoList::RecordIndexInfo>) };
      inline RecordIndexInfoList& setRecordIndexInfo(const vector<RecordIndexInfoList::RecordIndexInfo> & recordIndexInfo) { DARABONBA_PTR_SET_VALUE(recordIndexInfo_, recordIndexInfo) };
      inline RecordIndexInfoList& setRecordIndexInfo(vector<RecordIndexInfoList::RecordIndexInfo> && recordIndexInfo) { DARABONBA_PTR_SET_RVALUE(recordIndexInfo_, recordIndexInfo) };


    protected:
      shared_ptr<vector<RecordIndexInfoList::RecordIndexInfo>> recordIndexInfo_ {};
    };

    virtual bool empty() const override { return this->order_ == nullptr
        && this->pageNum_ == nullptr && this->pageSize_ == nullptr && this->recordIndexInfoList_ == nullptr && this->requestId_ == nullptr && this->totalNum_ == nullptr
    ...
    inline const DescribeLiveStreamRecordIndexFilesResponseBody::RecordIndexInfoList & getRecordIndexInfoList() const { DARABONBA_PTR_GET_CONST(recordIndexInfoList_, DescribeLiveStreamRecordIndexFilesResponseBody::RecordIndexInfoList) };
    inline DescribeLiveStreamRecordIndexFilesResponseBody::RecordIndexInfoList getRecordIndexInfoList() { DARABONBA_PTR_GET(recordIndexInfoList_, DescribeLiveStreamRecordIndexFilesResponseBody::RecordIndexInfoList) };
    inline DescribeLiveStreamRecordIndexFilesResponseBody& setRecordIndexInfoList(const DescribeLiveStreamRecordIndexFilesResponseBody::RecordIndexInfoList & recordIndexInfoList) { DARABONBA_PTR_SET_VALUE(recordIndexInfoList_, recordIndexInfoList) };
    inline DescribeLiveStreamRecordIndexFilesResponseBody& setRecordIndexInfoList(DescribeLiveStreamRecordIndexFilesResponseBody::RecordIndexInfoList && recordIndexInfoList) { DARABONBA_PTR_SET_RVALUE(recordIndexInfoList_, recordIndexInfoList) };
