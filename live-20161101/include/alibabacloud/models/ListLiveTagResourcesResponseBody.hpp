...
namespace Models
{
  ...
  public:
    ...
    inline const ListLiveTagResourcesResponseBody::TagResources & getTagResources() const { DARABONBA_PTR_GET_CONST(tagResources_, ListLiveTagResourcesResponseBody::TagResources) };
    inline ListLiveTagResourcesResponseBody::TagResources getTagResources() { DARABONBA_PTR_GET(tagResources_, ListLiveTagResourcesResponseBody::TagResources) };
    inline ListLiveTagResourcesResponseBody& setTagResources(const ListLiveTagResourcesResponseBody::TagResources & tagResources) { DARABONBA_PTR_SET_VALUE(tagResources_, tagResources) };
    inline ListLiveTagResourcesResponseBody& setTagResources(ListLiveTagResourcesResponseBody::TagResources && tagResources) { DARABONBA_PTR_SET_RVALUE(tagResources_, tagResources) };
