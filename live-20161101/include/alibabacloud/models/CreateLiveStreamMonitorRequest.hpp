...
#ifndef ALIBABACLOUD_MODELS_CREATELIVESTREAMMONITORREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATELIVESTREAMMONITORREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateLiveStreamMonitorRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateLiveStreamMonitorRequest& obj) { 
    ...
    CreateLiveStreamMonitorRequest(const CreateLiveStreamMonitorRequest &) = default ;
    CreateLiveStreamMonitorRequest(CreateLiveStreamMonitorRequest &&) = default ;
    CreateLiveStreamMonitorRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateLiveStreamMonitorRequest() = default ;
    CreateLiveStreamMonitorRequest& operator=(const CreateLiveStreamMonitorRequest &) = default ;
    CreateLiveStreamMonitorRequest& operator=(CreateLiveStreamMonitorRequest &&) = default ;
