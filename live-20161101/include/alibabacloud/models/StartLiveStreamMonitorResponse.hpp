...
namespace Models
{
  ...
  public:
    ...
    inline const StartLiveStreamMonitorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartLiveStreamMonitorResponseBody) };
    inline StartLiveStreamMonitorResponseBody getBody() { DARABONBA_PTR_GET(body_, StartLiveStreamMonitorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartLiveStreamMonitorResponseBody> body_ {};
  };
