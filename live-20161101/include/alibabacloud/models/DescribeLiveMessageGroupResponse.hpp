...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveMessageGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveMessageGroupResponseBody) };
    inline DescribeLiveMessageGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveMessageGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveMessageGroupResponseBody> body_ {};
  };
