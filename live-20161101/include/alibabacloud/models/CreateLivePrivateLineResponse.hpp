...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLivePrivateLineResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateLivePrivateLineResponseBody) };
    inline CreateLivePrivateLineResponseBody body() { DARABONBA_PTR_GET(body_, CreateLivePrivateLineResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateLivePrivateLineResponseBody> body_ = nullptr;
  };
