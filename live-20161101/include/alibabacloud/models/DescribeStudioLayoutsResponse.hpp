...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeStudioLayoutsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeStudioLayoutsResponseBody) };
    inline DescribeStudioLayoutsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeStudioLayoutsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeStudioLayoutsResponseBody> body_ {};
  };
