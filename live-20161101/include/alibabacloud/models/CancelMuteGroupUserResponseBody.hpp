...
namespace Models
{
  ...
  public:
    ...
    inline const CancelMuteGroupUserResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, CancelMuteGroupUserResponseBodyResult) };
    inline CancelMuteGroupUserResponseBodyResult result() { DARABONBA_PTR_GET(result_, CancelMuteGroupUserResponseBodyResult) };
    inline CancelMuteGroupUserResponseBody& setResult(const CancelMuteGroupUserResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CancelMuteGroupUserResponseBody& setResult(CancelMuteGroupUserResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<CancelMuteGroupUserResponseBodyResult> result_ = nullptr;
  };
