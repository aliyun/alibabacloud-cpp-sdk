...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->audioLayer_ == nullptr
        && return this->blendList_ == nullptr && return this->casterId_ == nullptr && return this->mixList_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr
        && return this->videoLayer_ == nullptr; };
