...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLiveMessageAppDisableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyLiveMessageAppDisableResponseBody) };
    inline ModifyLiveMessageAppDisableResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyLiveMessageAppDisableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyLiveMessageAppDisableResponseBody> body_ {};
  };
