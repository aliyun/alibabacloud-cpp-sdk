...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cdnDomainsShrink_ == nullptr
        && return this->cdnIspsShrink_ == nullptr && return this->cdnProvincesShrink_ == nullptr && return this->endTime_ == nullptr && return this->kwaiSidcsShrink_ == nullptr && return this->kwaiTscShrink_ == nullptr
        && return this->ownerId_ == nullptr && return this->region_ == nullptr && return this->regionId_ == nullptr && return this->startTime_ == nullptr && return this->upstreamDomainsShrink_ == nullptr; };
