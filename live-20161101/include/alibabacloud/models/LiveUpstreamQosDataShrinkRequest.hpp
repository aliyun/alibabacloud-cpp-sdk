...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cdnDomainsShrink_ == nullptr
    ...
    inline string getCdnDomainsShrink() const { DARABONBA_PTR_GET_DEFAULT(cdnDomainsShrink_, "") };
    ...
    inline string getCdnIspsShrink() const { DARABONBA_PTR_GET_DEFAULT(cdnIspsShrink_, "") };
    ...
    inline string getCdnProvincesShrink() const { DARABONBA_PTR_GET_DEFAULT(cdnProvincesShrink_, "") };
    ...
    inline string getKwaiSidcsShrink() const { DARABONBA_PTR_GET_DEFAULT(kwaiSidcsShrink_, "") };
    ...
    inline string getKwaiTscShrink() const { DARABONBA_PTR_GET_DEFAULT(kwaiTscShrink_, "") };
    ...
    inline string getUpstreamDomainsShrink() const { DARABONBA_PTR_GET_DEFAULT(upstreamDomainsShrink_, "") };
  ...
  protected:
    shared_ptr<string> cdnDomainsShrink_ {};
    shared_ptr<string> cdnIspsShrink_ {};
    shared_ptr<string> cdnProvincesShrink_ {};
    // This parameter is required.
    shared_ptr<string> endTime_ {};
    shared_ptr<string> kwaiSidcsShrink_ {};
    shared_ptr<string> kwaiTscShrink_ {};
    shared_ptr<int64_t> ownerId_ {};
    shared_ptr<string> region_ {};
    shared_ptr<string> regionId_ {};
    // This parameter is required.
    shared_ptr<string> startTime_ {};
    shared_ptr<string> upstreamDomainsShrink_ {};
  };
