...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLiveDelayConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLiveDelayConfigResponseBody) };
    inline CreateLiveDelayConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLiveDelayConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLiveDelayConfigResponseBody> body_ {};
  };
