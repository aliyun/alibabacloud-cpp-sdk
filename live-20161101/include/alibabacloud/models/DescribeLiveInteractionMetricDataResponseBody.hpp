...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->nodes_ == nullptr
        && return this->requestId_ == nullptr && return this->summaryData_ == nullptr; };
    // nodes Field Functions 
    bool hasNodes() const { return this->nodes_ != nullptr;};
    void deleteNodes() { this->nodes_ = nullptr;};
    inline const vector<DescribeLiveInteractionMetricDataResponseBodyNodes> & nodes() const { DARABONBA_PTR_GET_CONST(nodes_, vector<DescribeLiveInteractionMetricDataResponseBodyNodes>) };
    inline vector<DescribeLiveInteractionMetricDataResponseBodyNodes> nodes() { DARABONBA_PTR_GET(nodes_, vector<DescribeLiveInteractionMetricDataResponseBodyNodes>) };
    inline DescribeLiveInteractionMetricDataResponseBody& setNodes(const vector<DescribeLiveInteractionMetricDataResponseBodyNodes> & nodes) { DARABONBA_PTR_SET_VALUE(nodes_, nodes) };
    inline DescribeLiveInteractionMetricDataResponseBody& setNodes(vector<DescribeLiveInteractionMetricDataResponseBodyNodes> && nodes) { DARABONBA_PTR_SET_RVALUE(nodes_, nodes) };
  ...
  protected:
    // The node data.
    std::shared_ptr<vector<DescribeLiveInteractionMetricDataResponseBodyNodes>> nodes_ = nullptr;
