...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECASTERLAYOUTSRESPONSEBODYLAYOUTSLAYOUTAUDIOLAYERSAUDIOLAYER_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECASTERLAYOUTSRESPONSEBODYLAYOUTSLAYOUTAUDIOLAYERSAUDIOLAYER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer& obj) { 
    ...
    DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer() = default ;
    DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer(const DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer &) = default ;
    DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer(DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer &&) = default ;
    DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer() = default ;
    DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer& operator=(const DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer &) = default ;
    DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer& operator=(DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->fixedDelayDuration_ == nullptr
        && return this->validChannel_ == nullptr && return this->volumeRate_ == nullptr; };
    ...
    inline DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer& setFixedDelayDuration(int32_t fixedDelayDuration) { DARABONBA_PTR_SET_VALUE(fixedDelayDuration_, fixedDelayDuration) };
    ...
    inline DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer& setValidChannel(string validChannel) { DARABONBA_PTR_SET_VALUE(validChannel_, validChannel) };
    ...
    inline DescribeCasterLayoutsResponseBodyLayoutsLayoutAudioLayersAudioLayer& setVolumeRate(float volumeRate) { DARABONBA_PTR_SET_VALUE(volumeRate_, volumeRate) };
