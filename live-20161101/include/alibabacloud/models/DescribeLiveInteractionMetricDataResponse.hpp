...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveInteractionMetricDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveInteractionMetricDataResponseBody) };
    inline DescribeLiveInteractionMetricDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveInteractionMetricDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveInteractionMetricDataResponseBody> body_ {};
  };
