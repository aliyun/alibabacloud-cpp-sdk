...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->data_ == nullptr && this->groupId_ == nullptr && this->operatorUserId_ == nullptr && this->receiverIdListShrink_ == nullptr && this->skipAudit_ == nullptr
        && this->type_ == nullptr; };
    ...
    inline string getReceiverIdListShrink() const { DARABONBA_PTR_GET_DEFAULT(receiverIdListShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> receiverIdListShrink_ {};
