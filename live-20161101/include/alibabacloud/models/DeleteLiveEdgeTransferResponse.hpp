...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLiveEdgeTransferResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLiveEdgeTransferResponseBody) };
    inline DeleteLiveEdgeTransferResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLiveEdgeTransferResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLiveEdgeTransferResponseBody> body_ {};
  };
