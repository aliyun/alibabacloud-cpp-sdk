...
namespace Models
{
  ...
  public:
    ...
    inline bool getEventCallbackNeedAuthentication() const { DARABONBA_PTR_GET_DEFAULT(eventCallbackNeedAuthentication_, false) };
  ...
  protected:
    ...
    shared_ptr<bool> eventCallbackNeedAuthentication_ {};
