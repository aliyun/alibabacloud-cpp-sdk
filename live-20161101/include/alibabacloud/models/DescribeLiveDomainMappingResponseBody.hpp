...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->liveDomainModels_ != nullptr
    ...
    inline const DescribeLiveDomainMappingResponseBodyLiveDomainModels & liveDomainModels() const { DARABONBA_PTR_GET_CONST(liveDomainModels_, DescribeLiveDomainMappingResponseBodyLiveDomainModels) };
    inline DescribeLiveDomainMappingResponseBodyLiveDomainModels liveDomainModels() { DARABONBA_PTR_GET(liveDomainModels_, DescribeLiveDomainMappingResponseBodyLiveDomainModels) };
    inline DescribeLiveDomainMappingResponseBody& setLiveDomainModels(const DescribeLiveDomainMappingResponseBodyLiveDomainModels & liveDomainModels) { DARABONBA_PTR_SET_VALUE(liveDomainModels_, liveDomainModels) };
    inline DescribeLiveDomainMappingResponseBody& setLiveDomainModels(DescribeLiveDomainMappingResponseBodyLiveDomainModels && liveDomainModels) { DARABONBA_PTR_SET_RVALUE(liveDomainModels_, liveDomainModels) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLiveDomainMappingResponseBodyLiveDomainModels> liveDomainModels_ = nullptr;
    // The request ID.
