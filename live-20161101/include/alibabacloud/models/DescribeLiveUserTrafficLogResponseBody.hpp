...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveUserTrafficLogResponseBody::DomainLogDetails & getDomainLogDetails() const { DARABONBA_PTR_GET_CONST(domainLogDetails_, DescribeLiveUserTrafficLogResponseBody::DomainLogDetails) };
    inline DescribeLiveUserTrafficLogResponseBody::DomainLogDetails getDomainLogDetails() { DARABONBA_PTR_GET(domainLogDetails_, DescribeLiveUserTrafficLogResponseBody::DomainLogDetails) };
    inline DescribeLiveUserTrafficLogResponseBody& setDomainLogDetails(const DescribeLiveUserTrafficLogResponseBody::DomainLogDetails & domainLogDetails) { DARABONBA_PTR_SET_VALUE(domainLogDetails_, domainLogDetails) };
    inline DescribeLiveUserTrafficLogResponseBody& setDomainLogDetails(DescribeLiveUserTrafficLogResponseBody::DomainLogDetails && domainLogDetails) { DARABONBA_PTR_SET_RVALUE(domainLogDetails_, domainLogDetails) };
  ...
  protected:
    shared_ptr<DescribeLiveUserTrafficLogResponseBody::DomainLogDetails> domainLogDetails_ {};
