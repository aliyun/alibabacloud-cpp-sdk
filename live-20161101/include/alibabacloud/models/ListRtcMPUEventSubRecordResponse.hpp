...
namespace Models
{
  ...
  public:
    ...
    inline const ListRtcMPUEventSubRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRtcMPUEventSubRecordResponseBody) };
    inline ListRtcMPUEventSubRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRtcMPUEventSubRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRtcMPUEventSubRecordResponseBody> body_ {};
  };
