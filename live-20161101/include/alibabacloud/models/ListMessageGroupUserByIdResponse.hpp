...
namespace Models
{
  ...
  public:
    ...
    inline const ListMessageGroupUserByIdResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListMessageGroupUserByIdResponseBody) };
    inline ListMessageGroupUserByIdResponseBody body() { DARABONBA_PTR_GET(body_, ListMessageGroupUserByIdResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListMessageGroupUserByIdResponseBody> body_ = nullptr;
  };
