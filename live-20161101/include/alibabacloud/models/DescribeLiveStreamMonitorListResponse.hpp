...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveStreamMonitorListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveStreamMonitorListResponseBody) };
    inline DescribeLiveStreamMonitorListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveStreamMonitorListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveStreamMonitorListResponseBody> body_ {};
  };
