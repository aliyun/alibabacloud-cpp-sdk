...
namespace Models
{
  ...
  public:
    ...
    inline int32_t getFlvDelay() const { DARABONBA_PTR_GET_DEFAULT(flvDelay_, 0) };
    ...
    inline string getFlvLevel() const { DARABONBA_PTR_GET_DEFAULT(flvLevel_, "") };
    ...
    inline int32_t getHlsDelay() const { DARABONBA_PTR_GET_DEFAULT(hlsDelay_, 0) };
    ...
    inline string getHlsLevel() const { DARABONBA_PTR_GET_DEFAULT(hlsLevel_, "") };
    ...
    inline int32_t getRtmpDelay() const { DARABONBA_PTR_GET_DEFAULT(rtmpDelay_, 0) };
    ...
    inline string getRtmpLevel() const { DARABONBA_PTR_GET_DEFAULT(rtmpLevel_, "") };
