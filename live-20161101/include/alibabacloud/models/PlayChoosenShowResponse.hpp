...
namespace Models
{
  ...
  public:
    ...
    inline const PlayChoosenShowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PlayChoosenShowResponseBody) };
    inline PlayChoosenShowResponseBody getBody() { DARABONBA_PTR_GET(body_, PlayChoosenShowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PlayChoosenShowResponseBody> body_ {};
  };
