...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveDomainCertificateInfoResponseBodyCertInfos & certInfos() const { DARABONBA_PTR_GET_CONST(certInfos_, DescribeLiveDomainCertificateInfoResponseBodyCertInfos) };
    inline DescribeLiveDomainCertificateInfoResponseBodyCertInfos certInfos() { DARABONBA_PTR_GET(certInfos_, DescribeLiveDomainCertificateInfoResponseBodyCertInfos) };
    inline DescribeLiveDomainCertificateInfoResponseBody& setCertInfos(const DescribeLiveDomainCertificateInfoResponseBodyCertInfos & certInfos) { DARABONBA_PTR_SET_VALUE(certInfos_, certInfos) };
    inline DescribeLiveDomainCertificateInfoResponseBody& setCertInfos(DescribeLiveDomainCertificateInfoResponseBodyCertInfos && certInfos) { DARABONBA_PTR_SET_RVALUE(certInfos_, certInfos) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLiveDomainCertificateInfoResponseBodyCertInfos> certInfos_ = nullptr;
    // The request ID.
