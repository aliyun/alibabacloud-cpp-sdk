...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeLiveUserTagsResponseBodyTags> & tags() const { DARABONBA_PTR_GET_CONST(tags_, vector<DescribeLiveUserTagsResponseBodyTags>) };
    inline vector<DescribeLiveUserTagsResponseBodyTags> tags() { DARABONBA_PTR_GET(tags_, vector<DescribeLiveUserTagsResponseBodyTags>) };
    inline DescribeLiveUserTagsResponseBody& setTags(const vector<DescribeLiveUserTagsResponseBodyTags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline DescribeLiveUserTagsResponseBody& setTags(vector<DescribeLiveUserTagsResponseBodyTags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    // The tags.
    std::shared_ptr<vector<DescribeLiveUserTagsResponseBodyTags>> tags_ = nullptr;
  };
