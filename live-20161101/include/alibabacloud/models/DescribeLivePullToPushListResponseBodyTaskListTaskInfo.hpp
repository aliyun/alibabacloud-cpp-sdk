...
#ifndef ALIBABACLOUD_MODELS_DESCRIBELIVEPULLTOPUSHLISTRESPONSEBODYTASKLISTTASKINFO_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBELIVEPULLTOPUSHLISTRESPONSEBODYTASKLISTTASKINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeLivePullToPushListResponseBodyTaskListTaskInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeLivePullToPushListResponseBodyTaskListTaskInfo& obj) { 
    ...
    DescribeLivePullToPushListResponseBodyTaskListTaskInfo() = default ;
    DescribeLivePullToPushListResponseBodyTaskListTaskInfo(const DescribeLivePullToPushListResponseBodyTaskListTaskInfo &) = default ;
    DescribeLivePullToPushListResponseBodyTaskListTaskInfo(DescribeLivePullToPushListResponseBodyTaskListTaskInfo &&) = default ;
    DescribeLivePullToPushListResponseBodyTaskListTaskInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeLivePullToPushListResponseBodyTaskListTaskInfo() = default ;
    DescribeLivePullToPushListResponseBodyTaskListTaskInfo& operator=(const DescribeLivePullToPushListResponseBodyTaskListTaskInfo &) = default ;
    DescribeLivePullToPushListResponseBodyTaskListTaskInfo& operator=(DescribeLivePullToPushListResponseBodyTaskListTaskInfo &&) = default ;
    ...
    inline DescribeLivePullToPushListResponseBodyTaskListTaskInfo& setCallbackURL(string callbackURL) { DARABONBA_PTR_SET_VALUE(callbackURL_, callbackURL) };
    ...
    inline DescribeLivePullToPushListResponseBodyTaskListTaskInfo& setDstUrl(string dstUrl) { DARABONBA_PTR_SET_VALUE(dstUrl_, dstUrl) };
    ...
    inline DescribeLivePullToPushListResponseBodyTaskListTaskInfo& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline DescribeLivePullToPushListResponseBodyTaskListTaskInfo& setFileIndex(int32_t fileIndex) { DARABONBA_PTR_SET_VALUE(fileIndex_, fileIndex) };
    ...
    inline DescribeLivePullToPushListResponseBodyTaskListTaskInfo& setOffset(int32_t offset) { DARABONBA_PTR_SET_VALUE(offset_, offset) };
    ...
    inline DescribeLivePullToPushListResponseBodyTaskListTaskInfo& setRepeatNumber(int32_t repeatNumber) { DARABONBA_PTR_SET_VALUE(repeatNumber_, repeatNumber) };
    ...
    inline DescribeLivePullToPushListResponseBodyTaskListTaskInfo& setRetryCount(int32_t retryCount) { DARABONBA_PTR_SET_VALUE(retryCount_, retryCount) };
    ...
    inline DescribeLivePullToPushListResponseBodyTaskListTaskInfo& setRetryInterval(int32_t retryInterval) { DARABONBA_PTR_SET_VALUE(retryInterval_, retryInterval) };
    ...
    inline DescribeLivePullToPushListResponseBodyTaskListTaskInfo& setSourceProtocol(string sourceProtocol) { DARABONBA_PTR_SET_VALUE(sourceProtocol_, sourceProtocol) };
    ...
    inline DescribeLivePullToPushListResponseBodyTaskListTaskInfo& setSourceType(string sourceType) { DARABONBA_PTR_SET_VALUE(sourceType_, sourceType) };
    ...
    inline DescribeLivePullToPushListResponseBodyTaskListTaskInfo& setSourceUrls(const vector<string> & sourceUrls) { DARABONBA_PTR_SET_VALUE(sourceUrls_, sourceUrls) };
    inline DescribeLivePullToPushListResponseBodyTaskListTaskInfo& setSourceUrls(vector<string> && sourceUrls) { DARABONBA_PTR_SET_RVALUE(sourceUrls_, sourceUrls) };
    ...
    inline DescribeLivePullToPushListResponseBodyTaskListTaskInfo& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline DescribeLivePullToPushListResponseBodyTaskListTaskInfo& setTaskId(string taskId) { DARABONBA_PTR_SET_VALUE(taskId_, taskId) };
    ...
    inline DescribeLivePullToPushListResponseBodyTaskListTaskInfo& setTaskName(string taskName) { DARABONBA_PTR_SET_VALUE(taskName_, taskName) };
