...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeStreamLocationBlockResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeStreamLocationBlockResponseBody) };
    inline DescribeStreamLocationBlockResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeStreamLocationBlockResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeStreamLocationBlockResponseBody> body_ {};
  };
