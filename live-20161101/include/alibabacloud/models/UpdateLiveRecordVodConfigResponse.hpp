...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLiveRecordVodConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLiveRecordVodConfigResponseBody) };
    inline UpdateLiveRecordVodConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLiveRecordVodConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLiveRecordVodConfigResponseBody> body_ {};
  };
