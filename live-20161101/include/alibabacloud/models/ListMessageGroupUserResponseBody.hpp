...
namespace Models
{
  ...
  public:
    ...
    inline const ListMessageGroupUserResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListMessageGroupUserResponseBodyResult) };
    inline ListMessageGroupUserResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListMessageGroupUserResponseBodyResult) };
    inline ListMessageGroupUserResponseBody& setResult(const ListMessageGroupUserResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListMessageGroupUserResponseBody& setResult(ListMessageGroupUserResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<ListMessageGroupUserResponseBodyResult> result_ = nullptr;
  };
