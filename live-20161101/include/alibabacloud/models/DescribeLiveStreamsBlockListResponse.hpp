...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveStreamsBlockListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveStreamsBlockListResponseBody) };
    inline DescribeLiveStreamsBlockListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeLiveStreamsBlockListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLiveStreamsBlockListResponseBody> body_ = nullptr;
  };
