...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMessageAppResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, DeleteMessageAppResponseBody::Result) };
    inline DeleteMessageAppResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, DeleteMessageAppResponseBody::Result) };
    inline DeleteMessageAppResponseBody& setResult(const DeleteMessageAppResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DeleteMessageAppResponseBody& setResult(DeleteMessageAppResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
