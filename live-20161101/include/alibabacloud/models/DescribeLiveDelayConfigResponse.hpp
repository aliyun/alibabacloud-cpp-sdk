...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveDelayConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveDelayConfigResponseBody) };
    inline DescribeLiveDelayConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveDelayConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveDelayConfigResponseBody> body_ {};
  };
