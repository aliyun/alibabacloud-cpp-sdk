...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveDetectNotifyConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveDetectNotifyConfigResponseBody) };
    inline DescribeLiveDetectNotifyConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveDetectNotifyConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveDetectNotifyConfigResponseBody> body_ {};
  };
