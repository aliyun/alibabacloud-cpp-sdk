...
namespace Models
{
  ...
  public:
    ...
    inline const StopPlaylistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopPlaylistResponseBody) };
    inline StopPlaylistResponseBody getBody() { DARABONBA_PTR_GET(body_, StopPlaylistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopPlaylistResponseBody> body_ {};
  };
