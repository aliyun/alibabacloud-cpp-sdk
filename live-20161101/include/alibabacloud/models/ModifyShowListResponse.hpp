...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyShowListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyShowListResponseBody) };
    inline ModifyShowListResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyShowListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyShowListResponseBody> body_ {};
  };
