...
namespace Models
{
  ...
  public:
    ...
    inline const AddLiveDomainMappingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddLiveDomainMappingResponseBody) };
    inline AddLiveDomainMappingResponseBody getBody() { DARABONBA_PTR_GET(body_, AddLiveDomainMappingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddLiveDomainMappingResponseBody> body_ {};
  };
