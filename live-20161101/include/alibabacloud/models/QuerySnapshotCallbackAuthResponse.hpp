...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySnapshotCallbackAuthResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QuerySnapshotCallbackAuthResponseBody) };
    inline QuerySnapshotCallbackAuthResponseBody getBody() { DARABONBA_PTR_GET(body_, QuerySnapshotCallbackAuthResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QuerySnapshotCallbackAuthResponseBody> body_ {};
  };
