...
namespace Models
{
  ...
  public:
    ...
    inline const AddPlaylistItemsResponseBody::Items & getItems() const { DARABONBA_PTR_GET_CONST(items_, AddPlaylistItemsResponseBody::Items) };
    inline AddPlaylistItemsResponseBody::Items getItems() { DARABONBA_PTR_GET(items_, AddPlaylistItemsResponseBody::Items) };
    inline AddPlaylistItemsResponseBody& setItems(const AddPlaylistItemsResponseBody::Items & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline AddPlaylistItemsResponseBody& setItems(AddPlaylistItemsResponseBody::Items && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
