...
namespace Models
{
  ...
  public:
    ...
    inline const AddLiveCenterTransferResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddLiveCenterTransferResponseBody) };
    inline AddLiveCenterTransferResponseBody getBody() { DARABONBA_PTR_GET(body_, AddLiveCenterTransferResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddLiveCenterTransferResponseBody> body_ {};
  };
