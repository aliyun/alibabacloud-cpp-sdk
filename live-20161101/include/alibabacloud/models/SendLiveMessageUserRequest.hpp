...
namespace Models
{
  ...
  public:
    ...
    inline bool getHighReliability() const { DARABONBA_PTR_GET_DEFAULT(highReliability_, false) };
    ...
    inline string getSenderInfo() const { DARABONBA_PTR_GET_DEFAULT(senderInfo_, "") };
    ...
    inline bool getStorage() const { DARABONBA_PTR_GET_DEFAULT(storage_, false) };
  ...
  protected:
    ...
    shared_ptr<bool> highReliability_ {};
