...
namespace Models
{
  ...
  public:
    ...
    inline bool autoSwitchUrgentOn() const { DARABONBA_PTR_GET_DEFAULT(autoSwitchUrgentOn_, false) };
    ...
    inline string recordConfig() const { DARABONBA_PTR_GET_DEFAULT(recordConfig_, "") };
    ...
    inline string syncGroupsConfig() const { DARABONBA_PTR_GET_DEFAULT(syncGroupsConfig_, "") };
  ...
  protected:
    ...
    // *   **true**
    // *   **false**
    std::shared_ptr<bool> autoSwitchUrgentOn_ = nullptr;
    ...
    std::shared_ptr<string> recordConfig_ = nullptr;
    ...
    std::shared_ptr<string> syncGroupsConfig_ = nullptr;
