...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveDomainConfigsResponseBody::DomainConfigs & getDomainConfigs() const { DARABONBA_PTR_GET_CONST(domainConfigs_, DescribeLiveDomainConfigsResponseBody::DomainConfigs) };
    inline DescribeLiveDomainConfigsResponseBody::DomainConfigs getDomainConfigs() { DARABONBA_PTR_GET(domainConfigs_, DescribeLiveDomainConfigsResponseBody::DomainConfigs) };
    inline DescribeLiveDomainConfigsResponseBody& setDomainConfigs(const DescribeLiveDomainConfigsResponseBody::DomainConfigs & domainConfigs) { DARABONBA_PTR_SET_VALUE(domainConfigs_, domainConfigs) };
    inline DescribeLiveDomainConfigsResponseBody& setDomainConfigs(DescribeLiveDomainConfigsResponseBody::DomainConfigs && domainConfigs) { DARABONBA_PTR_SET_RVALUE(domainConfigs_, domainConfigs) };
