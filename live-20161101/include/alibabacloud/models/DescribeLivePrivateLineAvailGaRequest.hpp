...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accelerationArea_ == nullptr
        && return this->appName_ == nullptr && return this->domainName_ == nullptr && return this->isGaInstance_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr
        && return this->streamName_ == nullptr && return this->videoCenter_ == nullptr; };
