...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveDomainStagingConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveDomainStagingConfigResponseBody) };
    inline DescribeLiveDomainStagingConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveDomainStagingConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveDomainStagingConfigResponseBody> body_ {};
  };
