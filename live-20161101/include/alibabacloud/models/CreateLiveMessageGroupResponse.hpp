...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLiveMessageGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLiveMessageGroupResponseBody) };
    inline CreateLiveMessageGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLiveMessageGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLiveMessageGroupResponseBody> body_ {};
  };
