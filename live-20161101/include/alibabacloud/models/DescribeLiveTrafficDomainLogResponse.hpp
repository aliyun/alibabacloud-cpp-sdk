...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveTrafficDomainLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveTrafficDomainLogResponseBody) };
    inline DescribeLiveTrafficDomainLogResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveTrafficDomainLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveTrafficDomainLogResponseBody> body_ {};
  };
