...
namespace Models
{
  ...
  public:
    ...
    inline const UnbanLiveMessageGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UnbanLiveMessageGroupResponseBody) };
    inline UnbanLiveMessageGroupResponseBody body() { DARABONBA_PTR_GET(body_, UnbanLiveMessageGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UnbanLiveMessageGroupResponseBody> body_ = nullptr;
  };
