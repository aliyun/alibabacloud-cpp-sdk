...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->dstUrl_ != nullptr
        && this->ownerId_ != nullptr && this->pageNumber_ != nullptr && this->pageSize_ != nullptr && this->region_ != nullptr && this->regionId_ != nullptr
