...
namespace Models
{
  ...
  public:
    ...
    inline const ListLiveRealtimeLogDeliveryDomainsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLiveRealtimeLogDeliveryDomainsResponseBody) };
    inline ListLiveRealtimeLogDeliveryDomainsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLiveRealtimeLogDeliveryDomainsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLiveRealtimeLogDeliveryDomainsResponseBody> body_ {};
  };
