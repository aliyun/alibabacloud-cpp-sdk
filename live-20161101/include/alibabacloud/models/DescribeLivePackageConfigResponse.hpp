...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLivePackageConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLivePackageConfigResponseBody) };
    inline DescribeLivePackageConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLivePackageConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLivePackageConfigResponseBody> body_ {};
  };
