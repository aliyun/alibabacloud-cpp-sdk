...
namespace Models
{
  ...
  public:
    ...
    inline const GetEdgeTranscodeTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetEdgeTranscodeTemplateResponseBody) };
    inline GetEdgeTranscodeTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetEdgeTranscodeTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetEdgeTranscodeTemplateResponseBody> body_ {};
  };
