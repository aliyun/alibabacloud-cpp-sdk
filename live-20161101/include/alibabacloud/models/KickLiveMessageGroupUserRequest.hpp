...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->dataCenter_ == nullptr && this->groupId_ == nullptr && this->kickoffUser_ == nullptr; };
    ...
    inline string getKickoffUser() const { DARABONBA_PTR_GET_DEFAULT(kickoffUser_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> kickoffUser_ {};
  };
