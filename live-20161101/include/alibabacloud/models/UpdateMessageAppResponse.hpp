...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMessageAppResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateMessageAppResponseBody) };
    inline UpdateMessageAppResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateMessageAppResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateMessageAppResponseBody> body_ {};
  };
