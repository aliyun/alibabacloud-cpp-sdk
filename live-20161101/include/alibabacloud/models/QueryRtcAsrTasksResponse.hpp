...
namespace Models
{
  ...
  public:
    ...
    inline const QueryRtcAsrTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryRtcAsrTasksResponseBody) };
    inline QueryRtcAsrTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryRtcAsrTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryRtcAsrTasksResponseBody> body_ {};
  };
