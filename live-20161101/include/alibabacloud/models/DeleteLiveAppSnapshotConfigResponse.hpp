...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLiveAppSnapshotConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLiveAppSnapshotConfigResponseBody) };
    inline DeleteLiveAppSnapshotConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLiveAppSnapshotConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLiveAppSnapshotConfigResponseBody> body_ {};
  };
