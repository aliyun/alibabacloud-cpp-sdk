...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->appName_ != nullptr
        && this->domainName_ != nullptr && this->ownerId_ != nullptr && this->pullAppName_ != nullptr && this->pullDomainName_ != nullptr && this->pullProtocol_ != nullptr
        && this->regionId_ != nullptr && this->transcodeLazy_ != nullptr; };
