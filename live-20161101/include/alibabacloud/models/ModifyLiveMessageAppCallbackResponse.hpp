...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLiveMessageAppCallbackResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyLiveMessageAppCallbackResponseBody) };
    inline ModifyLiveMessageAppCallbackResponseBody body() { DARABONBA_PTR_GET(body_, ModifyLiveMessageAppCallbackResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyLiveMessageAppCallbackResponseBody> body_ = nullptr;
  };
