...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLivePullStreamConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLivePullStreamConfigResponseBody) };
    inline DescribeLivePullStreamConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLivePullStreamConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLivePullStreamConfigResponseBody> body_ {};
  };
