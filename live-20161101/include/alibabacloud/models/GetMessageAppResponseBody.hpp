...
namespace Models
{
  ...
  public:
    ...
    inline const GetMessageAppResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetMessageAppResponseBodyResult) };
    inline GetMessageAppResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetMessageAppResponseBodyResult) };
    inline GetMessageAppResponseBody& setResult(const GetMessageAppResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetMessageAppResponseBody& setResult(GetMessageAppResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<GetMessageAppResponseBodyResult> result_ = nullptr;
  };
