...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveDomainRecordUsageDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveDomainRecordUsageDataResponseBody) };
    inline DescribeLiveDomainRecordUsageDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveDomainRecordUsageDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveDomainRecordUsageDataResponseBody> body_ {};
  };
