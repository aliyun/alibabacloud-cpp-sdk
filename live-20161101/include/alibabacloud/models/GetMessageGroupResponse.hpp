...
namespace Models
{
  ...
  public:
    ...
    inline const GetMessageGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMessageGroupResponseBody) };
    inline GetMessageGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMessageGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMessageGroupResponseBody> body_ {};
  };
