...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveStreamSnapshotInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveStreamSnapshotInfoResponseBody) };
    inline DescribeLiveStreamSnapshotInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveStreamSnapshotInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveStreamSnapshotInfoResponseBody> body_ {};
  };
