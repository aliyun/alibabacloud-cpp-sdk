...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeToutiaoLivePlayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeToutiaoLivePlayResponseBody) };
    inline DescribeToutiaoLivePlayResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeToutiaoLivePlayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeToutiaoLivePlayResponseBody> body_ {};
  };
