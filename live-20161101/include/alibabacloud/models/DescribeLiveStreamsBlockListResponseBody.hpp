...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->domainName_ == nullptr
        && return this->pageNum_ == nullptr && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->streamUrls_ == nullptr && return this->totalNum_ == nullptr
    ...
    inline const DescribeLiveStreamsBlockListResponseBodyStreamUrls & streamUrls() const { DARABONBA_PTR_GET_CONST(streamUrls_, DescribeLiveStreamsBlockListResponseBodyStreamUrls) };
    inline DescribeLiveStreamsBlockListResponseBodyStreamUrls streamUrls() { DARABONBA_PTR_GET(streamUrls_, DescribeLiveStreamsBlockListResponseBodyStreamUrls) };
    inline DescribeLiveStreamsBlockListResponseBody& setStreamUrls(const DescribeLiveStreamsBlockListResponseBodyStreamUrls & streamUrls) { DARABONBA_PTR_SET_VALUE(streamUrls_, streamUrls) };
    inline DescribeLiveStreamsBlockListResponseBody& setStreamUrls(DescribeLiveStreamsBlockListResponseBodyStreamUrls && streamUrls) { DARABONBA_PTR_SET_RVALUE(streamUrls_, streamUrls) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLiveStreamsBlockListResponseBodyStreamUrls> streamUrls_ = nullptr;
