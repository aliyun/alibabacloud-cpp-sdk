...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMessageAppResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, CreateMessageAppResponseBodyResult) };
    inline CreateMessageAppResponseBodyResult result() { DARABONBA_PTR_GET(result_, CreateMessageAppResponseBodyResult) };
    inline CreateMessageAppResponseBody& setResult(const CreateMessageAppResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CreateMessageAppResponseBody& setResult(CreateMessageAppResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<CreateMessageAppResponseBodyResult> result_ = nullptr;
  };
