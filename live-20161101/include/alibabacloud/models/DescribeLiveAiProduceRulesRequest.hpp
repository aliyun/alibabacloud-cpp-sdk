...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->app_ == nullptr
        && return this->domain_ == nullptr && return this->ownerId_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->regionId_ == nullptr
        && return this->rulesId_ == nullptr && return this->suffixName_ == nullptr; };
    // app Field Functions 
