...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCasterLayoutResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCasterLayoutResponseBody) };
    inline ModifyCasterLayoutResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCasterLayoutResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCasterLayoutResponseBody> body_ {};
  };
