...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveStreamsNotifyUrlConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveStreamsNotifyUrlConfigResponseBody) };
    inline DescribeLiveStreamsNotifyUrlConfigResponseBody body() { DARABONBA_PTR_GET(body_, DescribeLiveStreamsNotifyUrlConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLiveStreamsNotifyUrlConfigResponseBody> body_ = nullptr;
  };
