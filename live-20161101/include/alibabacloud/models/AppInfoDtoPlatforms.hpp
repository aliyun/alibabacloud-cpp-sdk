...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->itemId_ == nullptr
        && return this->licenseItemIds_ == nullptr && return this->pkgName_ == nullptr && return this->pkgSignature_ == nullptr && return this->platformType_ == nullptr && return this->type_ == nullptr; };
