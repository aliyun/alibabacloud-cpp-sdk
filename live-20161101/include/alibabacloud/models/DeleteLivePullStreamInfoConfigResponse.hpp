...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLivePullStreamInfoConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLivePullStreamInfoConfigResponseBody) };
    inline DeleteLivePullStreamInfoConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLivePullStreamInfoConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLivePullStreamInfoConfigResponseBody> body_ {};
  };
