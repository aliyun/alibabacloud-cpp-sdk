...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMessageGroupResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, CreateMessageGroupResponseBodyResult) };
    inline CreateMessageGroupResponseBodyResult result() { DARABONBA_PTR_GET(result_, CreateMessageGroupResponseBodyResult) };
    inline CreateMessageGroupResponseBody& setResult(const CreateMessageGroupResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CreateMessageGroupResponseBody& setResult(CreateMessageGroupResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<CreateMessageGroupResponseBodyResult> result_ = nullptr;
  };
