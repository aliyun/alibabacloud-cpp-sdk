...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->app_ == nullptr
        && return this->description_ == nullptr && return this->domain_ == nullptr && return this->gmtModifyTime_ == nullptr && return this->isLazy_ == nullptr && return this->liveTemplate_ == nullptr
        && return this->rulesId_ == nullptr && return this->studioName_ == nullptr && return this->subtitleName_ == nullptr && return this->suffixName_ == nullptr; };
    // app Field Functions 
