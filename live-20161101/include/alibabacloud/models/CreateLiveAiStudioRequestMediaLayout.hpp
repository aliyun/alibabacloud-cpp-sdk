...
#ifndef ALIBABACLOUD_MODELS_CREATELIVEAISTUDIOREQUESTMEDIALAYOUT_HPP_
#define ALIBABACLOUD_MODELS_CREATELIVEAISTUDIOREQUESTMEDIALAYOUT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateLiveAIStudioRequestMediaLayout& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateLiveAIStudioRequestMediaLayout& obj) { 
    ...
    CreateLiveAIStudioRequestMediaLayout() = default ;
    CreateLiveAIStudioRequestMediaLayout(const CreateLiveAIStudioRequestMediaLayout &) = default ;
    CreateLiveAIStudioRequestMediaLayout(CreateLiveAIStudioRequestMediaLayout &&) = default ;
    CreateLiveAIStudioRequestMediaLayout(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateLiveAIStudioRequestMediaLayout() = default ;
    CreateLiveAIStudioRequestMediaLayout& operator=(const CreateLiveAIStudioRequestMediaLayout &) = default ;
    CreateLiveAIStudioRequestMediaLayout& operator=(CreateLiveAIStudioRequestMediaLayout &&) = default ;
    ...
    inline CreateLiveAIStudioRequestMediaLayout& setHeightNormalized(float heightNormalized) { DARABONBA_PTR_SET_VALUE(heightNormalized_, heightNormalized) };
    ...
    inline CreateLiveAIStudioRequestMediaLayout& setPositionX(float positionX) { DARABONBA_PTR_SET_VALUE(positionX_, positionX) };
    ...
    inline CreateLiveAIStudioRequestMediaLayout& setPositionY(float positionY) { DARABONBA_PTR_SET_VALUE(positionY_, positionY) };
