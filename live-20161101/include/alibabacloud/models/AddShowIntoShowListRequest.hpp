...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline ShowList& setDuration(int64_t duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
      ...
      inline ShowList& setLiveInputType(int32_t liveInputType) { DARABONBA_PTR_SET_VALUE(liveInputType_, liveInputType) };
      ...
      inline ShowList& setRepeatTimes(int32_t repeatTimes) { DARABONBA_PTR_SET_VALUE(repeatTimes_, repeatTimes) };
      ...
      inline ShowList& setResourceId(string resourceId) { DARABONBA_PTR_SET_VALUE(resourceId_, resourceId) };
      ...
      inline ShowList& setResourceType(string resourceType) { DARABONBA_PTR_SET_VALUE(resourceType_, resourceType) };
      ...
      inline ShowList& setResourceUrl(string resourceUrl) { DARABONBA_PTR_SET_VALUE(resourceUrl_, resourceUrl) };
      ...
      inline ShowList& setShowName(string showName) { DARABONBA_PTR_SET_VALUE(showName_, showName) };
    ...
    inline const vector<AddShowIntoShowListRequest::ShowList> & getShowList() const { DARABONBA_PTR_GET_CONST(showList_, vector<AddShowIntoShowListRequest::ShowList>) };
    inline vector<AddShowIntoShowListRequest::ShowList> getShowList() { DARABONBA_PTR_GET(showList_, vector<AddShowIntoShowListRequest::ShowList>) };
    inline AddShowIntoShowListRequest& setShowList(const vector<AddShowIntoShowListRequest::ShowList> & showList) { DARABONBA_PTR_SET_VALUE(showList_, showList) };
    inline AddShowIntoShowListRequest& setShowList(vector<AddShowIntoShowListRequest::ShowList> && showList) { DARABONBA_PTR_SET_RVALUE(showList_, showList) };
  ...
  protected:
    ...
    shared_ptr<vector<AddShowIntoShowListRequest::ShowList>> showList_ {};
  };
