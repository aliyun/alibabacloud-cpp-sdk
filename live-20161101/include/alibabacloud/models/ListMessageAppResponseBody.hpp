...
namespace Models
{
  ...
  public:
    ...
    inline const ListMessageAppResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, ListMessageAppResponseBody::Result) };
    inline ListMessageAppResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, ListMessageAppResponseBody::Result) };
    inline ListMessageAppResponseBody& setResult(const ListMessageAppResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListMessageAppResponseBody& setResult(ListMessageAppResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
