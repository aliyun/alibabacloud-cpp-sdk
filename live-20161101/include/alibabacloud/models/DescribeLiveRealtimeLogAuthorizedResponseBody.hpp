...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->authorizedStatus_ == nullptr
    ...
    inline string getAuthorizedStatus() const { DARABONBA_PTR_GET_DEFAULT(authorizedStatus_, "") };
