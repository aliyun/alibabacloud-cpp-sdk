...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveCertificateListResponseBody::CertificateListModel & getCertificateListModel() const { DARABONBA_PTR_GET_CONST(certificateListModel_, DescribeLiveCertificateListResponseBody::CertificateListModel) };
    inline DescribeLiveCertificateListResponseBody::CertificateListModel getCertificateListModel() { DARABONBA_PTR_GET(certificateListModel_, DescribeLiveCertificateListResponseBody::CertificateListModel) };
    inline DescribeLiveCertificateListResponseBody& setCertificateListModel(const DescribeLiveCertificateListResponseBody::CertificateListModel & certificateListModel) { DARABONBA_PTR_SET_VALUE(certificateListModel_, certificateListModel) };
    inline DescribeLiveCertificateListResponseBody& setCertificateListModel(DescribeLiveCertificateListResponseBody::CertificateListModel && certificateListModel) { DARABONBA_PTR_SET_RVALUE(certificateListModel_, certificateListModel) };
  ...
  protected:
    // The details.
    shared_ptr<DescribeLiveCertificateListResponseBody::CertificateListModel> certificateListModel_ {};
    // The request ID.
