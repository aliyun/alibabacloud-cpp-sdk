...
namespace Models
{
  ...
  public:
    ...
    class MPUTasks : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const MPUTasks& obj) { 
      ...
      friend void from_json(const Darabonba::Json& j, MPUTasks& obj) { 
      ...
      MPUTasks() = default ;
      MPUTasks(const MPUTasks &) = default ;
      MPUTasks(MPUTasks &&) = default ;
      MPUTasks(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~MPUTasks() = default ;
      MPUTasks& operator=(const MPUTasks &) = default ;
      MPUTasks& operator=(MPUTasks &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline MPUTasks& setAppId(string appId) { DARABONBA_PTR_SET_VALUE(appId_, appId) };
      ...
      void deleteChannelId() { this->channelId_ = nullptr;};
      inline string getChannelId() const { DARABONBA_PTR_GET_DEFAULT(channelId_, "") };
      inline MPUTasks& setChannelId(string channelId) { DARABONBA_PTR_SET_VALUE(channelId_, channelId) };
      ...
      inline MPUTasks& setMaxIdleTime(string maxIdleTime) { DARABONBA_PTR_SET_VALUE(maxIdleTime_, maxIdleTime) };
      ...
      inline MPUTasks& setMixMode(string mixMode) { DARABONBA_PTR_SET_VALUE(mixMode_, mixMode) };
      ...
      inline const vector<MPUTasks::MultiStreamURL> & getMultiStreamURL() const { DARABONBA_PTR_GET_CONST(multiStreamURL_, vector<MPUTasks::MultiStreamURL>) };
      inline vector<MPUTasks::MultiStreamURL> getMultiStreamURL() { DARABONBA_PTR_GET(multiStreamURL_, vector<MPUTasks::MultiStreamURL>) };
      inline MPUTasks& setMultiStreamURL(const vector<MPUTasks::MultiStreamURL> & multiStreamURL) { DARABONBA_PTR_SET_VALUE(multiStreamURL_, multiStreamURL) };
      inline MPUTasks& setMultiStreamURL(vector<MPUTasks::MultiStreamURL> && multiStreamURL) { DARABONBA_PTR_SET_RVALUE(multiStreamURL_, multiStreamURL) };
      ...
      inline MPUTasks& setRegion(string region) { DARABONBA_PTR_SET_VALUE(region_, region) };
      ...
      inline const MPUTasks::SeiParams & getSeiParams() const { DARABONBA_PTR_GET_CONST(seiParams_, MPUTasks::SeiParams) };
      inline MPUTasks::SeiParams getSeiParams() { DARABONBA_PTR_GET(seiParams_, MPUTasks::SeiParams) };
      inline MPUTasks& setSeiParams(const MPUTasks::SeiParams & seiParams) { DARABONBA_PTR_SET_VALUE(seiParams_, seiParams) };
      inline MPUTasks& setSeiParams(MPUTasks::SeiParams && seiParams) { DARABONBA_PTR_SET_RVALUE(seiParams_, seiParams) };
      ...
      inline const MPUTasks::SingleSubParams & getSingleSubParams() const { DARABONBA_PTR_GET_CONST(singleSubParams_, MPUTasks::SingleSubParams) };
      inline MPUTasks::SingleSubParams getSingleSubParams() { DARABONBA_PTR_GET(singleSubParams_, MPUTasks::SingleSubParams) };
      inline MPUTasks& setSingleSubParams(const MPUTasks::SingleSubParams & singleSubParams) { DARABONBA_PTR_SET_VALUE(singleSubParams_, singleSubParams) };
      inline MPUTasks& setSingleSubParams(MPUTasks::SingleSubParams && singleSubParams) { DARABONBA_PTR_SET_RVALUE(singleSubParams_, singleSubParams) };
      ...
      inline MPUTasks& setStreamURL(string streamURL) { DARABONBA_PTR_SET_VALUE(streamURL_, streamURL) };
      ...
      inline MPUTasks& setTaskId(string taskId) { DARABONBA_PTR_SET_VALUE(taskId_, taskId) };
      ...
      inline const MPUTasks::TranscodeParams & getTranscodeParams() const { DARABONBA_PTR_GET_CONST(transcodeParams_, MPUTasks::TranscodeParams) };
      inline MPUTasks::TranscodeParams getTranscodeParams() { DARABONBA_PTR_GET(transcodeParams_, MPUTasks::TranscodeParams) };
      inline MPUTasks& setTranscodeParams(const MPUTasks::TranscodeParams & transcodeParams) { DARABONBA_PTR_SET_VALUE(transcodeParams_, transcodeParams) };
      inline MPUTasks& setTranscodeParams(MPUTasks::TranscodeParams && transcodeParams) { DARABONBA_PTR_SET_RVALUE(transcodeParams_, transcodeParams) };
    ...
    virtual bool empty() const override { return this->MPUTasks_ == nullptr
    ...
    inline const vector<ListRtcMPUTaskDetailResponseBody::MPUTasks> & getMPUTasks() const { DARABONBA_PTR_GET_CONST(MPUTasks_, vector<ListRtcMPUTaskDetailResponseBody::MPUTasks>) };
    inline vector<ListRtcMPUTaskDetailResponseBody::MPUTasks> getMPUTasks() { DARABONBA_PTR_GET(MPUTasks_, vector<ListRtcMPUTaskDetailResponseBody::MPUTasks>) };
    inline ListRtcMPUTaskDetailResponseBody& setMPUTasks(const vector<ListRtcMPUTaskDetailResponseBody::MPUTasks> & mPUTasks) { DARABONBA_PTR_SET_VALUE(MPUTasks_, mPUTasks) };
    inline ListRtcMPUTaskDetailResponseBody& setMPUTasks(vector<ListRtcMPUTaskDetailResponseBody::MPUTasks> && mPUTasks) { DARABONBA_PTR_SET_RVALUE(MPUTasks_, mPUTasks) };
