...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveDomainLogResponseBody::DomainLogDetails & getDomainLogDetails() const { DARABONBA_PTR_GET_CONST(domainLogDetails_, DescribeLiveDomainLogResponseBody::DomainLogDetails) };
    inline DescribeLiveDomainLogResponseBody::DomainLogDetails getDomainLogDetails() { DARABONBA_PTR_GET(domainLogDetails_, DescribeLiveDomainLogResponseBody::DomainLogDetails) };
    inline DescribeLiveDomainLogResponseBody& setDomainLogDetails(const DescribeLiveDomainLogResponseBody::DomainLogDetails & domainLogDetails) { DARABONBA_PTR_SET_VALUE(domainLogDetails_, domainLogDetails) };
    inline DescribeLiveDomainLogResponseBody& setDomainLogDetails(DescribeLiveDomainLogResponseBody::DomainLogDetails && domainLogDetails) { DARABONBA_PTR_SET_RVALUE(domainLogDetails_, domainLogDetails) };
