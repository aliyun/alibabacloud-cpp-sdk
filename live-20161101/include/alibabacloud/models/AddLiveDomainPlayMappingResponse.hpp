...
namespace Models
{
  ...
  public:
    ...
    inline const AddLiveDomainPlayMappingResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddLiveDomainPlayMappingResponseBody) };
    inline AddLiveDomainPlayMappingResponseBody body() { DARABONBA_PTR_GET(body_, AddLiveDomainPlayMappingResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddLiveDomainPlayMappingResponseBody> body_ = nullptr;
  };
