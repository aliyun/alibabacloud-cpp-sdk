...
#ifndef ALIBABACLOUD_MODELS_CREATELIVEDELAYCONFIGREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATELIVEDELAYCONFIGREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateLiveDelayConfigRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateLiveDelayConfigRequest& obj) { 
    ...
    CreateLiveDelayConfigRequest() = default ;
    CreateLiveDelayConfigRequest(const CreateLiveDelayConfigRequest &) = default ;
    CreateLiveDelayConfigRequest(CreateLiveDelayConfigRequest &&) = default ;
    CreateLiveDelayConfigRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateLiveDelayConfigRequest() = default ;
    CreateLiveDelayConfigRequest& operator=(const CreateLiveDelayConfigRequest &) = default ;
    CreateLiveDelayConfigRequest& operator=(CreateLiveDelayConfigRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->app_ == nullptr
        && return this->delayTime_ == nullptr && return this->domain_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr && return this->stream_ == nullptr
        && return this->taskTriggerMode_ == nullptr; };
    // app Field Functions 
    bool hasApp() const { return this->app_ != nullptr;};
    void deleteApp() { this->app_ = nullptr;};
    inline string app() const { DARABONBA_PTR_GET_DEFAULT(app_, "") };
    inline CreateLiveDelayConfigRequest& setApp(string app) { DARABONBA_PTR_SET_VALUE(app_, app) };
    ...
    inline CreateLiveDelayConfigRequest& setDelayTime(int32_t delayTime) { DARABONBA_PTR_SET_VALUE(delayTime_, delayTime) };
    ...
    inline CreateLiveDelayConfigRequest& setDomain(string domain) { DARABONBA_PTR_SET_VALUE(domain_, domain) };
    ...
    inline CreateLiveDelayConfigRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline CreateLiveDelayConfigRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline CreateLiveDelayConfigRequest& setStream(string stream) { DARABONBA_PTR_SET_VALUE(stream_, stream) };
    ...
    inline CreateLiveDelayConfigRequest& setTaskTriggerMode(string taskTriggerMode) { DARABONBA_PTR_SET_VALUE(taskTriggerMode_, taskTriggerMode) };
