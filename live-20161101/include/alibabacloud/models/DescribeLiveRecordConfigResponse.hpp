...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveRecordConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveRecordConfigResponseBody) };
    inline DescribeLiveRecordConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveRecordConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveRecordConfigResponseBody> body_ {};
  };
