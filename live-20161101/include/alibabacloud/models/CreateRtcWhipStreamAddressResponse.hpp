...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRTCWhipStreamAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRTCWhipStreamAddressResponseBody) };
    inline CreateRTCWhipStreamAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRTCWhipStreamAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRTCWhipStreamAddressResponseBody> body_ {};
  };
