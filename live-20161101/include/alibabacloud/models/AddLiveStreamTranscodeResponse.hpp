...
namespace Models
{
  ...
  public:
    ...
    inline const AddLiveStreamTranscodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddLiveStreamTranscodeResponseBody) };
    inline AddLiveStreamTranscodeResponseBody getBody() { DARABONBA_PTR_GET(body_, AddLiveStreamTranscodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddLiveStreamTranscodeResponseBody> body_ {};
  };
