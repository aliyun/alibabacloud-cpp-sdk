...
namespace Models
{
  ...
  public:
    ...
    inline const BatchSetLiveDomainConfigsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchSetLiveDomainConfigsResponseBody) };
    inline BatchSetLiveDomainConfigsResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchSetLiveDomainConfigsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchSetLiveDomainConfigsResponseBody> body_ {};
  };
