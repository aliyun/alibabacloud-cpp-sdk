...
#ifndef ALIBABACLOUD_MODELS_DESCRIBELIVEDOMAINEDGELOGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBELIVEDOMAINEDGELOGRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeLiveDomainEdgeLogResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(DomainLogDetails, domainLogDetails_);
      DARABONBA_PTR_TO_JSON(DomainName, domainName_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeLiveDomainEdgeLogResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(DomainLogDetails, domainLogDetails_);
      DARABONBA_PTR_FROM_JSON(DomainName, domainName_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DescribeLiveDomainEdgeLogResponseBody() = default ;
    DescribeLiveDomainEdgeLogResponseBody(const DescribeLiveDomainEdgeLogResponseBody &) = default ;
    DescribeLiveDomainEdgeLogResponseBody(DescribeLiveDomainEdgeLogResponseBody &&) = default ;
    DescribeLiveDomainEdgeLogResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeLiveDomainEdgeLogResponseBody() = default ;
    DescribeLiveDomainEdgeLogResponseBody& operator=(const DescribeLiveDomainEdgeLogResponseBody &) = default ;
    DescribeLiveDomainEdgeLogResponseBody& operator=(DescribeLiveDomainEdgeLogResponseBody &&) = default ;
    ...
    inline const DescribeLiveDomainEdgeLogResponseBody::DomainLogDetails & getDomainLogDetails() const { DARABONBA_PTR_GET_CONST(domainLogDetails_, DescribeLiveDomainEdgeLogResponseBody::DomainLogDetails) };
    inline DescribeLiveDomainEdgeLogResponseBody::DomainLogDetails getDomainLogDetails() { DARABONBA_PTR_GET(domainLogDetails_, DescribeLiveDomainEdgeLogResponseBody::DomainLogDetails) };
    inline DescribeLiveDomainEdgeLogResponseBody& setDomainLogDetails(const DescribeLiveDomainEdgeLogResponseBody::DomainLogDetails & domainLogDetails) { DARABONBA_PTR_SET_VALUE(domainLogDetails_, domainLogDetails) };
    inline DescribeLiveDomainEdgeLogResponseBody& setDomainLogDetails(DescribeLiveDomainEdgeLogResponseBody::DomainLogDetails && domainLogDetails) { DARABONBA_PTR_SET_RVALUE(domainLogDetails_, domainLogDetails) };
    ...
    inline DescribeLiveDomainEdgeLogResponseBody& setDomainName(string domainName) { DARABONBA_PTR_SET_VALUE(domainName_, domainName) };
    ...
    inline DescribeLiveDomainEdgeLogResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<DescribeLiveDomainEdgeLogResponseBody::DomainLogDetails> domainLogDetails_ {};
