...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLiveSpecificStagingConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLiveSpecificStagingConfigResponseBody) };
    inline DeleteLiveSpecificStagingConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLiveSpecificStagingConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLiveSpecificStagingConfigResponseBody> body_ {};
  };
