...
namespace Models
{
  ...
  public:
    ...
    inline const BatchDeleteLiveDomainConfigsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchDeleteLiveDomainConfigsResponseBody) };
    inline BatchDeleteLiveDomainConfigsResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchDeleteLiveDomainConfigsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchDeleteLiveDomainConfigsResponseBody> body_ {};
  };
