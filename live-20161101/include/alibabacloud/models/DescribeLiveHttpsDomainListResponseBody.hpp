...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveHttpsDomainListResponseBody::CertInfos & getCertInfos() const { DARABONBA_PTR_GET_CONST(certInfos_, DescribeLiveHttpsDomainListResponseBody::CertInfos) };
    inline DescribeLiveHttpsDomainListResponseBody::CertInfos getCertInfos() { DARABONBA_PTR_GET(certInfos_, DescribeLiveHttpsDomainListResponseBody::CertInfos) };
    inline DescribeLiveHttpsDomainListResponseBody& setCertInfos(const DescribeLiveHttpsDomainListResponseBody::CertInfos & certInfos) { DARABONBA_PTR_SET_VALUE(certInfos_, certInfos) };
    inline DescribeLiveHttpsDomainListResponseBody& setCertInfos(DescribeLiveHttpsDomainListResponseBody::CertInfos && certInfos) { DARABONBA_PTR_SET_RVALUE(certInfos_, certInfos) };
