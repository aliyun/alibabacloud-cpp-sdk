...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->all_ == nullptr
        && return this->ownerId_ == nullptr && return this->regionId_ == nullptr && return this->resourceId_ == nullptr && return this->resourceType_ == nullptr && return this->tagKey_ == nullptr; };
    // all Field Functions 
