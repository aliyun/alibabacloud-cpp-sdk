...
namespace Models
{
  ...
  public:
    ...
    inline bool getNoCache() const { DARABONBA_PTR_GET_DEFAULT(noCache_, false) };
    ...
    inline bool getNoStorage() const { DARABONBA_PTR_GET_DEFAULT(noStorage_, false) };
    ...
    inline string getSenderMetaInfo() const { DARABONBA_PTR_GET_DEFAULT(senderMetaInfo_, "") };
    ...
    inline int64_t getStaticsIncrease() const { DARABONBA_PTR_GET_DEFAULT(staticsIncrease_, 0L) };
