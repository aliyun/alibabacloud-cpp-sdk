...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCasterVideoResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCasterVideoResourcesResponseBody) };
    inline DescribeCasterVideoResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCasterVideoResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCasterVideoResourcesResponseBody> body_ {};
  };
