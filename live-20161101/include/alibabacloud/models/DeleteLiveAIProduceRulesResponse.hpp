...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLiveAIProduceRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLiveAIProduceRulesResponseBody) };
    inline DeleteLiveAIProduceRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLiveAIProduceRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLiveAIProduceRulesResponseBody> body_ {};
  };
