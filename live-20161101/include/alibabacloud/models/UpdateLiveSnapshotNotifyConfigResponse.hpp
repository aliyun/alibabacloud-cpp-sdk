...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLiveSnapshotNotifyConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLiveSnapshotNotifyConfigResponseBody) };
    inline UpdateLiveSnapshotNotifyConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLiveSnapshotNotifyConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLiveSnapshotNotifyConfigResponseBody> body_ {};
  };
