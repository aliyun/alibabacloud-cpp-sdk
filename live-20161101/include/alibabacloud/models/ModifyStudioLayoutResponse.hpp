...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyStudioLayoutResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyStudioLayoutResponseBody) };
    inline ModifyStudioLayoutResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyStudioLayoutResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyStudioLayoutResponseBody> body_ {};
  };
