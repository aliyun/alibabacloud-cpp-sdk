...
#ifndef ALIBABACLOUD_MODELS_DESCRIBELIVEDOMAINPUSHTRAFFICDATAREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBELIVEDOMAINPUSHTRAFFICDATAREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeLiveDomainPushTrafficDataRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeLiveDomainPushTrafficDataRequest& obj) { 
    ...
    DescribeLiveDomainPushTrafficDataRequest() = default ;
    DescribeLiveDomainPushTrafficDataRequest(const DescribeLiveDomainPushTrafficDataRequest &) = default ;
    DescribeLiveDomainPushTrafficDataRequest(DescribeLiveDomainPushTrafficDataRequest &&) = default ;
    DescribeLiveDomainPushTrafficDataRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeLiveDomainPushTrafficDataRequest() = default ;
    DescribeLiveDomainPushTrafficDataRequest& operator=(const DescribeLiveDomainPushTrafficDataRequest &) = default ;
    DescribeLiveDomainPushTrafficDataRequest& operator=(DescribeLiveDomainPushTrafficDataRequest &&) = default ;
    ...
    inline DescribeLiveDomainPushTrafficDataRequest& setDomainName(string domainName) { DARABONBA_PTR_SET_VALUE(domainName_, domainName) };
    ...
    inline DescribeLiveDomainPushTrafficDataRequest& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline DescribeLiveDomainPushTrafficDataRequest& setInterval(string interval) { DARABONBA_PTR_SET_VALUE(interval_, interval) };
    ...
    inline DescribeLiveDomainPushTrafficDataRequest& setIspNameEn(string ispNameEn) { DARABONBA_PTR_SET_VALUE(ispNameEn_, ispNameEn) };
    ...
    inline DescribeLiveDomainPushTrafficDataRequest& setLocationNameEn(string locationNameEn) { DARABONBA_PTR_SET_VALUE(locationNameEn_, locationNameEn) };
    ...
    inline DescribeLiveDomainPushTrafficDataRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline DescribeLiveDomainPushTrafficDataRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline DescribeLiveDomainPushTrafficDataRequest& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
