...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->beginOffset_ == nullptr
        && return this->casterId_ == nullptr && return this->endOffset_ == nullptr && return this->fixedDelayDuration_ == nullptr && return this->imageId_ == nullptr && return this->imageUrl_ == nullptr
        && return this->liveStreamUrl_ == nullptr && return this->locationId_ == nullptr && return this->materialId_ == nullptr && return this->ownerId_ == nullptr && return this->ptsCallbackInterval_ == nullptr
        && return this->regionId_ == nullptr && return this->repeatNum_ == nullptr && return this->resourceName_ == nullptr && return this->vodUrl_ == nullptr; };
