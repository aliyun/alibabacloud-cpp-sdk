...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveDomainPushTrafficDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveDomainPushTrafficDataResponseBody) };
    inline DescribeLiveDomainPushTrafficDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveDomainPushTrafficDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveDomainPushTrafficDataResponseBody> body_ {};
  };
