...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLivePushProxyLogResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeLivePushProxyLogResponseBody) };
    inline DescribeLivePushProxyLogResponseBody body() { DARABONBA_PTR_GET(body_, DescribeLivePushProxyLogResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLivePushProxyLogResponseBody> body_ = nullptr;
  };
