...
namespace Models
{
  ...
  public:
    ...
    inline const RestartLivePullToPushResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RestartLivePullToPushResponseBody) };
    inline RestartLivePullToPushResponseBody getBody() { DARABONBA_PTR_GET(body_, RestartLivePullToPushResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RestartLivePullToPushResponseBody> body_ {};
  };
