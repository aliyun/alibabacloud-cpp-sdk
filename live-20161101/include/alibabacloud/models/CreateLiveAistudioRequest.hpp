...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateLiveAIStudioRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateLiveAIStudioRequest& obj) { 
    ...
    CreateLiveAIStudioRequest() = default ;
    CreateLiveAIStudioRequest(const CreateLiveAIStudioRequest &) = default ;
    CreateLiveAIStudioRequest(CreateLiveAIStudioRequest &&) = default ;
    CreateLiveAIStudioRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateLiveAIStudioRequest() = default ;
    CreateLiveAIStudioRequest& operator=(const CreateLiveAIStudioRequest &) = default ;
    CreateLiveAIStudioRequest& operator=(CreateLiveAIStudioRequest &&) = default ;
