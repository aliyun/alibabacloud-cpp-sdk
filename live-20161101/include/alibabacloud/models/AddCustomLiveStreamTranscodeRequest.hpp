...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->app_ != nullptr
        ...
        && this->fpsWithSource_ != nullptr && this->gop_ != nullptr && this->height_ != nullptr && this->kmsKeyExpireInterval_ != nullptr && this->kmsKeyID_ != nullptr
        && this->kmsUID_ != nullptr && this->lazy_ != nullptr && this->ownerId_ != nullptr && this->profile_ != nullptr && this->regionId_ != nullptr
        && this->resWithSource_ != nullptr && this->template_ != nullptr && this->templateType_ != nullptr && this->videoBitrate_ != nullptr && this->width_ != nullptr; };
    // app Field Functions 
