...
namespace Models
{
  ...
  public:
    ...
    inline const RollbackLiveStagingConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RollbackLiveStagingConfigResponseBody) };
    inline RollbackLiveStagingConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, RollbackLiveStagingConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RollbackLiveStagingConfigResponseBody> body_ {};
  };
