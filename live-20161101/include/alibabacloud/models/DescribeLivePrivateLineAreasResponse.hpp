...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLivePrivateLineAreasResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeLivePrivateLineAreasResponseBody) };
    inline DescribeLivePrivateLineAreasResponseBody body() { DARABONBA_PTR_GET(body_, DescribeLivePrivateLineAreasResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLivePrivateLineAreasResponseBody> body_ = nullptr;
  };
