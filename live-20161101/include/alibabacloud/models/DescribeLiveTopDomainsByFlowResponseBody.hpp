...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveTopDomainsByFlowResponseBody::TopDomains & getTopDomains() const { DARABONBA_PTR_GET_CONST(topDomains_, DescribeLiveTopDomainsByFlowResponseBody::TopDomains) };
    inline DescribeLiveTopDomainsByFlowResponseBody::TopDomains getTopDomains() { DARABONBA_PTR_GET(topDomains_, DescribeLiveTopDomainsByFlowResponseBody::TopDomains) };
    inline DescribeLiveTopDomainsByFlowResponseBody& setTopDomains(const DescribeLiveTopDomainsByFlowResponseBody::TopDomains & topDomains) { DARABONBA_PTR_SET_VALUE(topDomains_, topDomains) };
    inline DescribeLiveTopDomainsByFlowResponseBody& setTopDomains(DescribeLiveTopDomainsByFlowResponseBody::TopDomains && topDomains) { DARABONBA_PTR_SET_RVALUE(topDomains_, topDomains) };
