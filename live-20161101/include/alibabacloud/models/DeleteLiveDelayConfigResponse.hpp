...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLiveDelayConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLiveDelayConfigResponseBody) };
    inline DeleteLiveDelayConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLiveDelayConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLiveDelayConfigResponseBody> body_ {};
  };
