...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->app_ == nullptr
        ...
        && return this->regionId_ == nullptr && return this->rulesId_ == nullptr && return this->studioName_ == nullptr && return this->subtitleId_ == nullptr && return this->subtitleName_ == nullptr
