...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCasterComponentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCasterComponentResponseBody) };
    inline DeleteCasterComponentResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCasterComponentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCasterComponentResponseBody> body_ {};
  };
