...
namespace Models
{
  ...
  public:
    ...
    inline const SendLiveMessageGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendLiveMessageGroupResponseBody) };
    inline SendLiveMessageGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, SendLiveMessageGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendLiveMessageGroupResponseBody> body_ {};
  };
