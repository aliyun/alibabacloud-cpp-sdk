...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->data_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->timestamp_ == nullptr; };
    ...
    inline const MiguLivePullToPushStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, MiguLivePullToPushStatusResponseBodyData) };
    inline MiguLivePullToPushStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, MiguLivePullToPushStatusResponseBodyData) };
    inline MiguLivePullToPushStatusResponseBody& setData(const MiguLivePullToPushStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline MiguLivePullToPushStatusResponseBody& setData(MiguLivePullToPushStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<MiguLivePullToPushStatusResponseBodyData> data_ = nullptr;
