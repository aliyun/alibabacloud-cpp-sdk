...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveTerminalsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveTerminalsResponseBody) };
    inline RemoveTerminalsResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveTerminalsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveTerminalsResponseBody> body_ {};
  };
