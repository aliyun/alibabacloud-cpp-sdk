...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRtcMPUEventSubResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteRtcMPUEventSubResponseBody) };
    inline DeleteRtcMPUEventSubResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteRtcMPUEventSubResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteRtcMPUEventSubResponseBody> body_ {};
  };
