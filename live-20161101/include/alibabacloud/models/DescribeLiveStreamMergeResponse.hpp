...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveStreamMergeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveStreamMergeResponseBody) };
    inline DescribeLiveStreamMergeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveStreamMergeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveStreamMergeResponseBody> body_ {};
  };
