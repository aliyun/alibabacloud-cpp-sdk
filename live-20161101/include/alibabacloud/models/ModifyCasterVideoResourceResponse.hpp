...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCasterVideoResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCasterVideoResourceResponseBody) };
    inline ModifyCasterVideoResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCasterVideoResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCasterVideoResourceResponseBody> body_ {};
  };
