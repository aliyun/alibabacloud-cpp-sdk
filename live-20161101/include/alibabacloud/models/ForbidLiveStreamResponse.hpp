...
namespace Models
{
  ...
  public:
    ...
    inline const ForbidLiveStreamResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ForbidLiveStreamResponseBody) };
    inline ForbidLiveStreamResponseBody getBody() { DARABONBA_PTR_GET(body_, ForbidLiveStreamResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ForbidLiveStreamResponseBody> body_ {};
  };
