...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bgColor_ == nullptr
        && return this->bgWidthNormalized_ == nullptr && return this->borderWidthNormalized_ == nullptr && return this->description_ == nullptr && return this->dstLanguage_ == nullptr && return this->fontColor_ == nullptr
        && return this->fontName_ == nullptr && return this->fontSizeNormalized_ == nullptr && return this->height_ == nullptr && return this->maxLines_ == nullptr && return this->ownerId_ == nullptr
        && return this->positionNormalizedShrink_ == nullptr && return this->regionId_ == nullptr && return this->showSourceLan_ == nullptr && return this->srcLanguage_ == nullptr && return this->subtitleId_ == nullptr
