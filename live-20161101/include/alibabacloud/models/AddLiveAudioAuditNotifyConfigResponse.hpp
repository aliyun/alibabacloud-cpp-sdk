...
namespace Models
{
  ...
  public:
    ...
    inline const AddLiveAudioAuditNotifyConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddLiveAudioAuditNotifyConfigResponseBody) };
    inline AddLiveAudioAuditNotifyConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, AddLiveAudioAuditNotifyConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddLiveAudioAuditNotifyConfigResponseBody> body_ {};
  };
