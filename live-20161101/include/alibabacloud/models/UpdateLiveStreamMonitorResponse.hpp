...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLiveStreamMonitorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLiveStreamMonitorResponseBody) };
    inline UpdateLiveStreamMonitorResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLiveStreamMonitorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLiveStreamMonitorResponseBody> body_ {};
  };
