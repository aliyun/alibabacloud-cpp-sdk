...
namespace Models
{
  ...
  public:
    ...
    inline const ListEdgeTranscodeJobResponseBody::JobList & getJobList() const { DARABONBA_PTR_GET_CONST(jobList_, ListEdgeTranscodeJobResponseBody::JobList) };
    inline ListEdgeTranscodeJobResponseBody::JobList getJobList() { DARABONBA_PTR_GET(jobList_, ListEdgeTranscodeJobResponseBody::JobList) };
    inline ListEdgeTranscodeJobResponseBody& setJobList(const ListEdgeTranscodeJobResponseBody::JobList & jobList) { DARABONBA_PTR_SET_VALUE(jobList_, jobList) };
    inline ListEdgeTranscodeJobResponseBody& setJobList(ListEdgeTranscodeJobResponseBody::JobList && jobList) { DARABONBA_PTR_SET_RVALUE(jobList_, jobList) };
