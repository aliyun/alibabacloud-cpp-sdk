...
namespace Models
{
  ...
  public:
    ...
    inline const ListLiveRealtimeLogDeliveryDomainsResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, ListLiveRealtimeLogDeliveryDomainsResponseBodyContent) };
    inline ListLiveRealtimeLogDeliveryDomainsResponseBodyContent content() { DARABONBA_PTR_GET(content_, ListLiveRealtimeLogDeliveryDomainsResponseBodyContent) };
    inline ListLiveRealtimeLogDeliveryDomainsResponseBody& setContent(const ListLiveRealtimeLogDeliveryDomainsResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListLiveRealtimeLogDeliveryDomainsResponseBody& setContent(ListLiveRealtimeLogDeliveryDomainsResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    // The domain names.
    std::shared_ptr<ListLiveRealtimeLogDeliveryDomainsResponseBodyContent> content_ = nullptr;
    // The request ID.
