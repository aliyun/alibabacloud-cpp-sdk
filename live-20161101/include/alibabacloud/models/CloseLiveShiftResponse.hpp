...
namespace Models
{
  ...
  public:
    ...
    inline const CloseLiveShiftResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CloseLiveShiftResponseBody) };
    inline CloseLiveShiftResponseBody body() { DARABONBA_PTR_GET(body_, CloseLiveShiftResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CloseLiveShiftResponseBody> body_ = nullptr;
  };
