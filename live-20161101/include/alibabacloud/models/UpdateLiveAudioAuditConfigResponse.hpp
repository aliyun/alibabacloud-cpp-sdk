...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLiveAudioAuditConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateLiveAudioAuditConfigResponseBody) };
    inline UpdateLiveAudioAuditConfigResponseBody body() { DARABONBA_PTR_GET(body_, UpdateLiveAudioAuditConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateLiveAudioAuditConfigResponseBody> body_ = nullptr;
  };
