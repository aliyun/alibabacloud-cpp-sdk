...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bgColor_ == nullptr
        ...
        && return this->fontName_ == nullptr && return this->fontSizeNormalized_ == nullptr && return this->height_ == nullptr && return this->maxLines_ == nullptr && return this->positionNormalized_ == nullptr
        && return this->rulesRefer_ == nullptr && return this->showSourceLan_ == nullptr && return this->srcLanguage_ == nullptr && return this->subtitleId_ == nullptr && return this->subtitleName_ == nullptr
        && return this->width_ == nullptr && return this->wordPerline_ == nullptr; };
