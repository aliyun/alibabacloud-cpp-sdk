...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->bannedAll_ == nullptr && this->bannnedUsersShrink_ == nullptr && this->dataCenter_ == nullptr && this->exceptUsersShrink_ == nullptr && this->groupId_ == nullptr; };
    ...
    inline bool getBannedAll() const { DARABONBA_PTR_GET_DEFAULT(bannedAll_, false) };
    ...
    inline string getBannnedUsersShrink() const { DARABONBA_PTR_GET_DEFAULT(bannnedUsersShrink_, "") };
    ...
    inline string getExceptUsersShrink() const { DARABONBA_PTR_GET_DEFAULT(exceptUsersShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> exceptUsersShrink_ {};
    // The group ID.
    // 
    // This parameter is required.
