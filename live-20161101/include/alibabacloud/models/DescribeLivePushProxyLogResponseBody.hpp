...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLivePushProxyLogResponseBody::DomainLogDetails & getDomainLogDetails() const { DARABONBA_PTR_GET_CONST(domainLogDetails_, DescribeLivePushProxyLogResponseBody::DomainLogDetails) };
    inline DescribeLivePushProxyLogResponseBody::DomainLogDetails getDomainLogDetails() { DARABONBA_PTR_GET(domainLogDetails_, DescribeLivePushProxyLogResponseBody::DomainLogDetails) };
    inline DescribeLivePushProxyLogResponseBody& setDomainLogDetails(const DescribeLivePushProxyLogResponseBody::DomainLogDetails & domainLogDetails) { DARABONBA_PTR_SET_VALUE(domainLogDetails_, domainLogDetails) };
    inline DescribeLivePushProxyLogResponseBody& setDomainLogDetails(DescribeLivePushProxyLogResponseBody::DomainLogDetails && domainLogDetails) { DARABONBA_PTR_SET_RVALUE(domainLogDetails_, domainLogDetails) };
