...
namespace Models
{
  ...
  public:
    ...
    inline const SetLiveStreamPreloadTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetLiveStreamPreloadTasksResponseBody) };
    inline SetLiveStreamPreloadTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, SetLiveStreamPreloadTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetLiveStreamPreloadTasksResponseBody> body_ {};
  };
