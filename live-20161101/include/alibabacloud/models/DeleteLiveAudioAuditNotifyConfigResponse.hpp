...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLiveAudioAuditNotifyConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLiveAudioAuditNotifyConfigResponseBody) };
    inline DeleteLiveAudioAuditNotifyConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLiveAudioAuditNotifyConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLiveAudioAuditNotifyConfigResponseBody> body_ {};
  };
