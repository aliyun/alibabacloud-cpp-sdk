...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->appId_ != nullptr
        && this->beginTime_ != nullptr && this->dataCenter_ != nullptr && this->endTime_ != nullptr && this->groupId_ != nullptr && this->msgType_ != nullptr
        && this->nextPageToken_ != nullptr && this->pageSize_ != nullptr && this->sortType_ != nullptr; };
