...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLiveDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLiveDomainResponseBody) };
    inline DeleteLiveDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLiveDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLiveDomainResponseBody> body_ {};
  };
