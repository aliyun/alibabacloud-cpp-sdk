...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ModifyCasterProgramRequestEpisode> & episode() const { DARABONBA_PTR_GET_CONST(episode_, vector<ModifyCasterProgramRequestEpisode>) };
    inline vector<ModifyCasterProgramRequestEpisode> episode() { DARABONBA_PTR_GET(episode_, vector<ModifyCasterProgramRequestEpisode>) };
    inline ModifyCasterProgramRequest& setEpisode(const vector<ModifyCasterProgramRequestEpisode> & episode) { DARABONBA_PTR_SET_VALUE(episode_, episode) };
    inline ModifyCasterProgramRequest& setEpisode(vector<ModifyCasterProgramRequestEpisode> && episode) { DARABONBA_PTR_SET_RVALUE(episode_, episode) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<vector<ModifyCasterProgramRequestEpisode>> episode_ = nullptr;
