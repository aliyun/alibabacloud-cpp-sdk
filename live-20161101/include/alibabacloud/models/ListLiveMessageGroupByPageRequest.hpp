...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->dataCenter_ == nullptr && this->groupStatus_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->sortType_ == nullptr; };
    ...
    inline int32_t getGroupStatus() const { DARABONBA_PTR_GET_DEFAULT(groupStatus_, 0) };
