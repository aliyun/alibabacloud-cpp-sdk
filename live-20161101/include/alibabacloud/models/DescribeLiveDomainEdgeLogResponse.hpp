...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveDomainEdgeLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveDomainEdgeLogResponseBody) };
    inline DescribeLiveDomainEdgeLogResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveDomainEdgeLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveDomainEdgeLogResponseBody> body_ {};
  };
