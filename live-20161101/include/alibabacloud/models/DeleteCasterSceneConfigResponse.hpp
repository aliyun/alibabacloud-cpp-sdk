...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCasterSceneConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCasterSceneConfigResponseBody) };
    inline DeleteCasterSceneConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCasterSceneConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCasterSceneConfigResponseBody> body_ {};
  };
