...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveStreamAuthCheckingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveStreamAuthCheckingResponseBody) };
    inline DescribeLiveStreamAuthCheckingResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveStreamAuthCheckingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveStreamAuthCheckingResponseBody> body_ {};
  };
