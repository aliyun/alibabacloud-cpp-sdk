...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLiveRealtimeLogAuthorizedResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLiveRealtimeLogAuthorizedResponseBody) };
    inline DescribeLiveRealtimeLogAuthorizedResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLiveRealtimeLogAuthorizedResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLiveRealtimeLogAuthorizedResponseBody> body_ {};
  };
