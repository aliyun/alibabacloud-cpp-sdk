...
namespace Models
{
  ...
  public:
    ...
    inline const ListMessageGroupUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMessageGroupUserResponseBody) };
    inline ListMessageGroupUserResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMessageGroupUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMessageGroupUserResponseBody> body_ {};
  };
