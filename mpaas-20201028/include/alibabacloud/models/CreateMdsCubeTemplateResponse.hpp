...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMdsCubeTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMdsCubeTemplateResponseBody) };
    inline CreateMdsCubeTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMdsCubeTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMdsCubeTemplateResponseBody> body_ {};
  };
