...
#ifndef ALIBABACLOUD_MODELS_QUERYPUSHSCHEDULERLISTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYPUSHSCHEDULERLISTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryPushSchedulerListResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryPushSchedulerListResponseBody& obj) { 
    ...
    QueryPushSchedulerListResponseBody() = default ;
    QueryPushSchedulerListResponseBody(const QueryPushSchedulerListResponseBody &) = default ;
    QueryPushSchedulerListResponseBody(QueryPushSchedulerListResponseBody &&) = default ;
    QueryPushSchedulerListResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryPushSchedulerListResponseBody() = default ;
    QueryPushSchedulerListResponseBody& operator=(const QueryPushSchedulerListResponseBody &) = default ;
    QueryPushSchedulerListResponseBody& operator=(QueryPushSchedulerListResponseBody &&) = default ;
    ...
    inline QueryPushSchedulerListResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline QueryPushSchedulerListResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryPushSchedulerListResponseBody& setResultCode(string resultCode) { DARABONBA_PTR_SET_VALUE(resultCode_, resultCode) };
    ...
    inline const QueryPushSchedulerListResponseBody::ResultContent & getResultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, QueryPushSchedulerListResponseBody::ResultContent) };
    inline QueryPushSchedulerListResponseBody::ResultContent getResultContent() { DARABONBA_PTR_GET(resultContent_, QueryPushSchedulerListResponseBody::ResultContent) };
    inline QueryPushSchedulerListResponseBody& setResultContent(const QueryPushSchedulerListResponseBody::ResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline QueryPushSchedulerListResponseBody& setResultContent(QueryPushSchedulerListResponseBody::ResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
    ...
    inline QueryPushSchedulerListResponseBody& setResultMessage(string resultMessage) { DARABONBA_PTR_SET_VALUE(resultMessage_, resultMessage) };
  ...
  protected:
    ...
    shared_ptr<QueryPushSchedulerListResponseBody::ResultContent> resultContent_ {};
