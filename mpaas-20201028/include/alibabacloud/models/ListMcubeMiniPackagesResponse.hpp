...
namespace Models
{
  ...
  public:
    ...
    inline const ListMcubeMiniPackagesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMcubeMiniPackagesResponseBody) };
    inline ListMcubeMiniPackagesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMcubeMiniPackagesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMcubeMiniPackagesResponseBody> body_ {};
  };
