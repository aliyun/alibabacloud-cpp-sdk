...
#ifndef ALIBABACLOUD_MODELS_GETUSERAPPUPLOADPROCESSINMSARESPONSEBODYRESULTCONTENTDATAAPKINFO_HPP_
#define ALIBABACLOUD_MODELS_GETUSERAPPUPLOADPROCESSINMSARESPONSEBODYRESULTCONTENTDATAAPKINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& obj) { 
    ...
    GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo() = default ;
    GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo(const GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo &) = default ;
    GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo(GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo &&) = default ;
    GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo() = default ;
    GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& operator=(const GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo &) = default ;
    GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& operator=(GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo &&) = default ;
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setAfterMd5(string afterMd5) { DARABONBA_PTR_SET_VALUE(afterMd5_, afterMd5) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setAfterSize(int64_t afterSize) { DARABONBA_PTR_SET_VALUE(afterSize_, afterSize) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setAppCode(string appCode) { DARABONBA_PTR_SET_VALUE(appCode_, appCode) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setAppPackage(string appPackage) { DARABONBA_PTR_SET_VALUE(appPackage_, appPackage) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setAssetsFileList(const vector<string> & assetsFileList) { DARABONBA_PTR_SET_VALUE(assetsFileList_, assetsFileList) };
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setAssetsFileList(vector<string> && assetsFileList) { DARABONBA_PTR_SET_RVALUE(assetsFileList_, assetsFileList) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setBeforeMd5(string beforeMd5) { DARABONBA_PTR_SET_VALUE(beforeMd5_, beforeMd5) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setBeforeSize(int64_t beforeSize) { DARABONBA_PTR_SET_VALUE(beforeSize_, beforeSize) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setClassForest(string classForest) { DARABONBA_PTR_SET_VALUE(classForest_, classForest) };
    ...
    inline const vector<Models::GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfoEnhanceMapping> & enhanceMapping() const { DARABONBA_PTR_GET_CONST(enhanceMapping_, vector<Models::GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfoEnhanceMapping>) };
    inline vector<Models::GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfoEnhanceMapping> enhanceMapping() { DARABONBA_PTR_GET(enhanceMapping_, vector<Models::GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfoEnhanceMapping>) };
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setEnhanceMapping(const vector<Models::GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfoEnhanceMapping> & enhanceMapping) { DARABONBA_PTR_SET_VALUE(enhanceMapping_, enhanceMapping) };
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setEnhanceMapping(vector<Models::GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfoEnhanceMapping> && enhanceMapping) { DARABONBA_PTR_SET_RVALUE(enhanceMapping_, enhanceMapping) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setEnhanceRules(const vector<string> & enhanceRules) { DARABONBA_PTR_SET_VALUE(enhanceRules_, enhanceRules) };
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setEnhanceRules(vector<string> && enhanceRules) { DARABONBA_PTR_SET_RVALUE(enhanceRules_, enhanceRules) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setEnhancedAssetsFiles(const vector<string> & enhancedAssetsFiles) { DARABONBA_PTR_SET_VALUE(enhancedAssetsFiles_, enhancedAssetsFiles) };
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setEnhancedAssetsFiles(vector<string> && enhancedAssetsFiles) { DARABONBA_PTR_SET_RVALUE(enhancedAssetsFiles_, enhancedAssetsFiles) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setEnhancedClasses(const vector<string> & enhancedClasses) { DARABONBA_PTR_SET_VALUE(enhancedClasses_, enhancedClasses) };
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setEnhancedClasses(vector<string> && enhancedClasses) { DARABONBA_PTR_SET_RVALUE(enhancedClasses_, enhancedClasses) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setEnhancedSoFiles(const vector<string> & enhancedSoFiles) { DARABONBA_PTR_SET_VALUE(enhancedSoFiles_, enhancedSoFiles) };
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setEnhancedSoFiles(vector<string> && enhancedSoFiles) { DARABONBA_PTR_SET_RVALUE(enhancedSoFiles_, enhancedSoFiles) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setLabel(string label) { DARABONBA_PTR_SET_VALUE(label_, label) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setProgress(int64_t progress) { DARABONBA_PTR_SET_VALUE(progress_, progress) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setSoFileList(const vector<string> & soFileList) { DARABONBA_PTR_SET_VALUE(soFileList_, soFileList) };
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setSoFileList(vector<string> && soFileList) { DARABONBA_PTR_SET_RVALUE(soFileList_, soFileList) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setStatus(int64_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setTaskType(string taskType) { DARABONBA_PTR_SET_VALUE(taskType_, taskType) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setVersionCode(string versionCode) { DARABONBA_PTR_SET_VALUE(versionCode_, versionCode) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo& setVersionName(string versionName) { DARABONBA_PTR_SET_VALUE(versionName_, versionName) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfoEnhanceMapping>> enhanceMapping_ = nullptr;
