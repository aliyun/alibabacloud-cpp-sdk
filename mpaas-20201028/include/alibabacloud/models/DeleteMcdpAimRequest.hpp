...
namespace Models
{
  ...
  public:
    ...
    inline string getMpaasMappcenterMcdpAimDeleteJsonStr() const { DARABONBA_PTR_GET_DEFAULT(mpaasMappcenterMcdpAimDeleteJsonStr_, "") };
  ...
  protected:
    ...
    shared_ptr<string> mpaasMappcenterMcdpAimDeleteJsonStr_ {};
