...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activityContentState_ == nullptr
        ...
        && this->targetMsg_ == nullptr && this->taskName_ == nullptr && this->templateName_ == nullptr && this->tenantId_ == nullptr && this->thirdChannelCategoryShrink_ == nullptr
    ...
    inline const vector<PushMultipleShrinkRequest::TargetMsg> & getTargetMsg() const { DARABONBA_PTR_GET_CONST(targetMsg_, vector<PushMultipleShrinkRequest::TargetMsg>) };
    inline vector<PushMultipleShrinkRequest::TargetMsg> getTargetMsg() { DARABONBA_PTR_GET(targetMsg_, vector<PushMultipleShrinkRequest::TargetMsg>) };
    inline PushMultipleShrinkRequest& setTargetMsg(const vector<PushMultipleShrinkRequest::TargetMsg> & targetMsg) { DARABONBA_PTR_SET_VALUE(targetMsg_, targetMsg) };
    inline PushMultipleShrinkRequest& setTargetMsg(vector<PushMultipleShrinkRequest::TargetMsg> && targetMsg) { DARABONBA_PTR_SET_RVALUE(targetMsg_, targetMsg) };
    ...
    inline PushMultipleShrinkRequest& setVendorTemplate(string vendorTemplate) { DARABONBA_PTR_SET_VALUE(vendorTemplate_, vendorTemplate) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<vector<PushMultipleShrinkRequest::TargetMsg>> targetMsg_ {};
