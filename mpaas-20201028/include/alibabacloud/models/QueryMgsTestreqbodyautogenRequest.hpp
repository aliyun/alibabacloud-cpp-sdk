...
#ifndef ALIBABACLOUD_MODELS_QUERYMGSTESTREQBODYAUTOGENREQUEST_HPP_
#define ALIBABACLOUD_MODELS_QUERYMGSTESTREQBODYAUTOGENREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryMgsTestreqbodyautogenRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AppId, appId_);
      DARABONBA_PTR_TO_JSON(Format, format_);
      DARABONBA_PTR_TO_JSON(MpaasMappcenterMgsTestreqbodyautogenQueryJsonStr, mpaasMappcenterMgsTestreqbodyautogenQueryJsonStr_);
      DARABONBA_PTR_TO_JSON(TenantId, tenantId_);
      DARABONBA_PTR_TO_JSON(WorkspaceId, workspaceId_);
    };
    friend void from_json(const Darabonba::Json& j, QueryMgsTestreqbodyautogenRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AppId, appId_);
      DARABONBA_PTR_FROM_JSON(Format, format_);
      DARABONBA_PTR_FROM_JSON(MpaasMappcenterMgsTestreqbodyautogenQueryJsonStr, mpaasMappcenterMgsTestreqbodyautogenQueryJsonStr_);
      DARABONBA_PTR_FROM_JSON(TenantId, tenantId_);
      DARABONBA_PTR_FROM_JSON(WorkspaceId, workspaceId_);
    };
    QueryMgsTestreqbodyautogenRequest() = default ;
    QueryMgsTestreqbodyautogenRequest(const QueryMgsTestreqbodyautogenRequest &) = default ;
    QueryMgsTestreqbodyautogenRequest(QueryMgsTestreqbodyautogenRequest &&) = default ;
    QueryMgsTestreqbodyautogenRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryMgsTestreqbodyautogenRequest() = default ;
    QueryMgsTestreqbodyautogenRequest& operator=(const QueryMgsTestreqbodyautogenRequest &) = default ;
    QueryMgsTestreqbodyautogenRequest& operator=(QueryMgsTestreqbodyautogenRequest &&) = default ;
