...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMcubeMiniTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMcubeMiniTaskResponseBody) };
    inline CreateMcubeMiniTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMcubeMiniTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMcubeMiniTaskResponseBody> body_ {};
  };
