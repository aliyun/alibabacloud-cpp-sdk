...
namespace Models
{
  ...
  public:
    ...
    inline const GetMcubeUpgradePackageInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMcubeUpgradePackageInfoResponseBody) };
    inline GetMcubeUpgradePackageInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMcubeUpgradePackageInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMcubeUpgradePackageInfoResponseBody> body_ {};
  };
