...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        ...
        && this->downloadUrl_ == nullptr && this->fileUrl_ == nullptr && this->harmonyLabel_ == nullptr && this->iconFileUrl_ == nullptr && this->installAmount_ == nullptr
        && this->iosSymbolfileUrl_ == nullptr && this->isEnterprise_ == nullptr && this->largeIconUrl_ == nullptr && this->needCheck_ == nullptr && this->onexFlag_ == nullptr
        && this->platform_ == nullptr && this->tenantId_ == nullptr && this->validDays_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline string getHarmonyLabel() const { DARABONBA_PTR_GET_DEFAULT(harmonyLabel_, "") };
    ...
    inline string getIosSymbolfileUrl() const { DARABONBA_PTR_GET_DEFAULT(iosSymbolfileUrl_, "") };
    ...
    inline string getLargeIconUrl() const { DARABONBA_PTR_GET_DEFAULT(largeIconUrl_, "") };
    ...
    inline int32_t getValidDays() const { DARABONBA_PTR_GET_DEFAULT(validDays_, 0) };
