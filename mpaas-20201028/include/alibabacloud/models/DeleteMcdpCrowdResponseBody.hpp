...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMcdpCrowdResponseBody::ResultContent & getResultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, DeleteMcdpCrowdResponseBody::ResultContent) };
    inline DeleteMcdpCrowdResponseBody::ResultContent getResultContent() { DARABONBA_PTR_GET(resultContent_, DeleteMcdpCrowdResponseBody::ResultContent) };
    inline DeleteMcdpCrowdResponseBody& setResultContent(const DeleteMcdpCrowdResponseBody::ResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline DeleteMcdpCrowdResponseBody& setResultContent(DeleteMcdpCrowdResponseBody::ResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    shared_ptr<DeleteMcdpCrowdResponseBody::ResultContent> resultContent_ {};
