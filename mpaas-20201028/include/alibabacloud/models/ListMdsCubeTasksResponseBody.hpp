...
#include <alibabacloud/models/ListMdsCubeTasksResponseBodyResultContent.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const ListMdsCubeTasksResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, ListMdsCubeTasksResponseBodyResultContent) };
    inline ListMdsCubeTasksResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, ListMdsCubeTasksResponseBodyResultContent) };
    inline ListMdsCubeTasksResponseBody& setResultContent(const ListMdsCubeTasksResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline ListMdsCubeTasksResponseBody& setResultContent(ListMdsCubeTasksResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<ListMdsCubeTasksResponseBodyResultContent> resultContent_ = nullptr;
