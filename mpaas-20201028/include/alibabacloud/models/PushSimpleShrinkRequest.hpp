...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activityContentState_ == nullptr
        ...
        && this->tenantId_ == nullptr && this->thirdChannelCategoryShrink_ == nullptr && this->title_ == nullptr && this->transparentMessagePayload_ == nullptr && this->transparentMessageUrgency_ == nullptr
    ...
    inline PushSimpleShrinkRequest& setSmsSignName(string smsSignName) { DARABONBA_PTR_SET_VALUE(smsSignName_, smsSignName) };
    ...
    inline PushSimpleShrinkRequest& setSmsStrategy(int32_t smsStrategy) { DARABONBA_PTR_SET_VALUE(smsStrategy_, smsStrategy) };
    ...
    inline PushSimpleShrinkRequest& setSmsTemplateCode(string smsTemplateCode) { DARABONBA_PTR_SET_VALUE(smsTemplateCode_, smsTemplateCode) };
    ...
    inline PushSimpleShrinkRequest& setSmsTemplateParam(string smsTemplateParam) { DARABONBA_PTR_SET_VALUE(smsTemplateParam_, smsTemplateParam) };
