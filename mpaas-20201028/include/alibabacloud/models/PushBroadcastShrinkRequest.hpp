...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->androidChannel_ == nullptr
        ...
        && this->msgkey_ == nullptr && this->notifyLevelShrink_ == nullptr && this->notifyType_ == nullptr && this->pushAction_ == nullptr && this->pushStatus_ == nullptr
        ...
        && this->templateName_ == nullptr && this->tenantId_ == nullptr && this->thirdChannelCategoryShrink_ == nullptr && this->timeMode_ == nullptr && this->transparentMessagePayload_ == nullptr
