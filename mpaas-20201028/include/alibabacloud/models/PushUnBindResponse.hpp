...
namespace Models
{
  ...
  public:
    ...
    inline const PushUnBindResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PushUnBindResponseBody) };
    inline PushUnBindResponseBody getBody() { DARABONBA_PTR_GET(body_, PushUnBindResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PushUnBindResponseBody> body_ {};
  };
