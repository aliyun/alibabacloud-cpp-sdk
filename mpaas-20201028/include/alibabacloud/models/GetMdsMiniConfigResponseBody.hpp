...
namespace Models
{
  ...
  public:
    ...
    inline const GetMdsMiniConfigResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, GetMdsMiniConfigResponseBodyResultContent) };
    inline GetMdsMiniConfigResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, GetMdsMiniConfigResponseBodyResultContent) };
    inline GetMdsMiniConfigResponseBody& setResultContent(const GetMdsMiniConfigResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline GetMdsMiniConfigResponseBody& setResultContent(GetMdsMiniConfigResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<GetMdsMiniConfigResponseBodyResultContent> resultContent_ = nullptr;
