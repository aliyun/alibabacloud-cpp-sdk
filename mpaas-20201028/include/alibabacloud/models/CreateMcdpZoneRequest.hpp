...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->mpaasMappcenterMcdpZoneCreateJsonStr_ == nullptr && this->tenantId_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline string getMpaasMappcenterMcdpZoneCreateJsonStr() const { DARABONBA_PTR_GET_DEFAULT(mpaasMappcenterMcdpZoneCreateJsonStr_, "") };
  ...
  protected:
    ...
    shared_ptr<string> mpaasMappcenterMcdpZoneCreateJsonStr_ {};
