...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserAppEnhanceProcessInMsaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUserAppEnhanceProcessInMsaResponseBody) };
    inline GetUserAppEnhanceProcessInMsaResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUserAppEnhanceProcessInMsaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUserAppEnhanceProcessInMsaResponseBody> body_ {};
  };
