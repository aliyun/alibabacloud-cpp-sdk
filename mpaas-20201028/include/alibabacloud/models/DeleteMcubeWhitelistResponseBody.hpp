...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->deleteWhitelistResult_ != nullptr
    ...
    inline const DeleteMcubeWhitelistResponseBodyDeleteWhitelistResult & deleteWhitelistResult() const { DARABONBA_PTR_GET_CONST(deleteWhitelistResult_, DeleteMcubeWhitelistResponseBodyDeleteWhitelistResult) };
    inline DeleteMcubeWhitelistResponseBodyDeleteWhitelistResult deleteWhitelistResult() { DARABONBA_PTR_GET(deleteWhitelistResult_, DeleteMcubeWhitelistResponseBodyDeleteWhitelistResult) };
    inline DeleteMcubeWhitelistResponseBody& setDeleteWhitelistResult(const DeleteMcubeWhitelistResponseBodyDeleteWhitelistResult & deleteWhitelistResult) { DARABONBA_PTR_SET_VALUE(deleteWhitelistResult_, deleteWhitelistResult) };
    inline DeleteMcubeWhitelistResponseBody& setDeleteWhitelistResult(DeleteMcubeWhitelistResponseBodyDeleteWhitelistResult && deleteWhitelistResult) { DARABONBA_PTR_SET_RVALUE(deleteWhitelistResult_, deleteWhitelistResult) };
  ...
  protected:
    std::shared_ptr<DeleteMcubeWhitelistResponseBodyDeleteWhitelistResult> deleteWhitelistResult_ = nullptr;
