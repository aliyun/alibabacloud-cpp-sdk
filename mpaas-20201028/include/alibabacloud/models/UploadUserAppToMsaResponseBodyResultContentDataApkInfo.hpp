...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->afterMd5_ == nullptr
        && return this->afterSize_ == nullptr && return this->appCode_ == nullptr && return this->appPackage_ == nullptr && return this->beforeMd5_ == nullptr && return this->beforeSize_ == nullptr
        && return this->classForest_ == nullptr && return this->enhanceMapping_ == nullptr && return this->enhanceRules_ == nullptr && return this->enhancedClasses_ == nullptr && return this->id_ == nullptr
        && return this->label_ == nullptr && return this->progress_ == nullptr && return this->status_ == nullptr && return this->taskType_ == nullptr && return this->versionCode_ == nullptr
