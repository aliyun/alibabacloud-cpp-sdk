...
#include <alibabacloud/models/CreateMdsCubeTaskResponseBodyResultContent.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMdsCubeTaskResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, CreateMdsCubeTaskResponseBodyResultContent) };
    inline CreateMdsCubeTaskResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, CreateMdsCubeTaskResponseBodyResultContent) };
    inline CreateMdsCubeTaskResponseBody& setResultContent(const CreateMdsCubeTaskResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline CreateMdsCubeTaskResponseBody& setResultContent(CreateMdsCubeTaskResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<CreateMdsCubeTaskResponseBodyResultContent> resultContent_ = nullptr;
