...
namespace Models
{
  ...
  public:
    ...
    inline PushQueryDeviceStateResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
