...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->mpaasMappcenterMsaDiffRunJsonStr_ == nullptr && this->tenantId_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline string getMpaasMappcenterMsaDiffRunJsonStr() const { DARABONBA_PTR_GET_DEFAULT(mpaasMappcenterMsaDiffRunJsonStr_, "") };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<string> mpaasMappcenterMsaDiffRunJsonStr_ {};
    // This parameter is required.
