...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMpsSchedulerListResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, QueryMpsSchedulerListResponseBodyResultContent) };
    inline QueryMpsSchedulerListResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, QueryMpsSchedulerListResponseBodyResultContent) };
    inline QueryMpsSchedulerListResponseBody& setResultContent(const QueryMpsSchedulerListResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline QueryMpsSchedulerListResponseBody& setResultContent(QueryMpsSchedulerListResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<QueryMpsSchedulerListResponseBodyResultContent> resultContent_ = nullptr;
