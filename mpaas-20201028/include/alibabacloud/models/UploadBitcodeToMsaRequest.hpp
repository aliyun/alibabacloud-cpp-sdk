...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->bitcode_ == nullptr && this->codeVersion_ == nullptr && this->license_ == nullptr && this->tenantId_ == nullptr && this->type_ == nullptr
    ...
    inline string getBitcode() const { DARABONBA_PTR_GET_DEFAULT(bitcode_, "") };
