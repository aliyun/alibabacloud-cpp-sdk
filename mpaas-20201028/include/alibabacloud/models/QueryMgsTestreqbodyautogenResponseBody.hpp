...
#ifndef ALIBABACLOUD_MODELS_QUERYMGSTESTREQBODYAUTOGENRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYMGSTESTREQBODYAUTOGENRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryMgsTestreqbodyautogenResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(ResultCode, resultCode_);
      DARABONBA_PTR_TO_JSON(ResultContent, resultContent_);
      DARABONBA_PTR_TO_JSON(ResultMessage, resultMessage_);
    };
    friend void from_json(const Darabonba::Json& j, QueryMgsTestreqbodyautogenResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(ResultCode, resultCode_);
      DARABONBA_PTR_FROM_JSON(ResultContent, resultContent_);
      DARABONBA_PTR_FROM_JSON(ResultMessage, resultMessage_);
    };
    QueryMgsTestreqbodyautogenResponseBody() = default ;
    QueryMgsTestreqbodyautogenResponseBody(const QueryMgsTestreqbodyautogenResponseBody &) = default ;
    QueryMgsTestreqbodyautogenResponseBody(QueryMgsTestreqbodyautogenResponseBody &&) = default ;
    QueryMgsTestreqbodyautogenResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryMgsTestreqbodyautogenResponseBody() = default ;
    QueryMgsTestreqbodyautogenResponseBody& operator=(const QueryMgsTestreqbodyautogenResponseBody &) = default ;
    QueryMgsTestreqbodyautogenResponseBody& operator=(QueryMgsTestreqbodyautogenResponseBody &&) = default ;
