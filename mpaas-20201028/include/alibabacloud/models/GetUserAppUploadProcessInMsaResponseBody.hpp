...
#ifndef ALIBABACLOUD_MODELS_GETUSERAPPUPLOADPROCESSINMSARESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETUSERAPPUPLOADPROCESSINMSARESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetUserAppUploadProcessInMsaResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(ResultCode, resultCode_);
      DARABONBA_PTR_TO_JSON(ResultContent, resultContent_);
      DARABONBA_PTR_TO_JSON(ResultMessage, resultMessage_);
    };
    friend void from_json(const Darabonba::Json& j, GetUserAppUploadProcessInMsaResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(ResultCode, resultCode_);
      DARABONBA_PTR_FROM_JSON(ResultContent, resultContent_);
      DARABONBA_PTR_FROM_JSON(ResultMessage, resultMessage_);
    };
    GetUserAppUploadProcessInMsaResponseBody() = default ;
    GetUserAppUploadProcessInMsaResponseBody(const GetUserAppUploadProcessInMsaResponseBody &) = default ;
    GetUserAppUploadProcessInMsaResponseBody(GetUserAppUploadProcessInMsaResponseBody &&) = default ;
    GetUserAppUploadProcessInMsaResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetUserAppUploadProcessInMsaResponseBody() = default ;
    GetUserAppUploadProcessInMsaResponseBody& operator=(const GetUserAppUploadProcessInMsaResponseBody &) = default ;
    GetUserAppUploadProcessInMsaResponseBody& operator=(GetUserAppUploadProcessInMsaResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->soFileList_ == nullptr && this->status_ == nullptr && this->taskType_ == nullptr && this->versionCode_ == nullptr && this->versionName_ == nullptr; };
          ...
          inline ApkInfo& setAssetsFileList(const vector<string> & assetsFileList) { DARABONBA_PTR_SET_VALUE(assetsFileList_, assetsFileList) };
          inline ApkInfo& setAssetsFileList(vector<string> && assetsFileList) { DARABONBA_PTR_SET_RVALUE(assetsFileList_, assetsFileList) };
          ...
          inline const vector<ApkInfo::EnhanceMapping> & getEnhanceMapping() const { DARABONBA_PTR_GET_CONST(enhanceMapping_, vector<ApkInfo::EnhanceMapping>) };
          inline vector<ApkInfo::EnhanceMapping> getEnhanceMapping() { DARABONBA_PTR_GET(enhanceMapping_, vector<ApkInfo::EnhanceMapping>) };
          inline ApkInfo& setEnhanceMapping(const vector<ApkInfo::EnhanceMapping> & enhanceMapping) { DARABONBA_PTR_SET_VALUE(enhanceMapping_, enhanceMapping) };
          inline ApkInfo& setEnhanceMapping(vector<ApkInfo::EnhanceMapping> && enhanceMapping) { DARABONBA_PTR_SET_RVALUE(enhanceMapping_, enhanceMapping) };
          ...
          inline ApkInfo& setEnhancedAssetsFiles(const vector<string> & enhancedAssetsFiles) { DARABONBA_PTR_SET_VALUE(enhancedAssetsFiles_, enhancedAssetsFiles) };
          inline ApkInfo& setEnhancedAssetsFiles(vector<string> && enhancedAssetsFiles) { DARABONBA_PTR_SET_RVALUE(enhancedAssetsFiles_, enhancedAssetsFiles) };
          ...
          inline ApkInfo& setEnhancedSoFiles(const vector<string> & enhancedSoFiles) { DARABONBA_PTR_SET_VALUE(enhancedSoFiles_, enhancedSoFiles) };
          inline ApkInfo& setEnhancedSoFiles(vector<string> && enhancedSoFiles) { DARABONBA_PTR_SET_RVALUE(enhancedSoFiles_, enhancedSoFiles) };
          ...
          inline ApkInfo& setSoFileList(const vector<string> & soFileList) { DARABONBA_PTR_SET_VALUE(soFileList_, soFileList) };
          inline ApkInfo& setSoFileList(vector<string> && soFileList) { DARABONBA_PTR_SET_RVALUE(soFileList_, soFileList) };
        ...
        protected:
          ...
          shared_ptr<vector<ApkInfo::EnhanceMapping>> enhanceMapping_ {};
    ...
    inline GetUserAppUploadProcessInMsaResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBody& setResultCode(string resultCode) { DARABONBA_PTR_SET_VALUE(resultCode_, resultCode) };
    ...
    inline const GetUserAppUploadProcessInMsaResponseBody::ResultContent & getResultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, GetUserAppUploadProcessInMsaResponseBody::ResultContent) };
    inline GetUserAppUploadProcessInMsaResponseBody::ResultContent getResultContent() { DARABONBA_PTR_GET(resultContent_, GetUserAppUploadProcessInMsaResponseBody::ResultContent) };
    inline GetUserAppUploadProcessInMsaResponseBody& setResultContent(const GetUserAppUploadProcessInMsaResponseBody::ResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline GetUserAppUploadProcessInMsaResponseBody& setResultContent(GetUserAppUploadProcessInMsaResponseBody::ResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
    ...
    inline GetUserAppUploadProcessInMsaResponseBody& setResultMessage(string resultMessage) { DARABONBA_PTR_SET_VALUE(resultMessage_, resultMessage) };


  protected:
    shared_ptr<string> requestId_ {};
    shared_ptr<string> resultCode_ {};
    shared_ptr<GetUserAppUploadProcessInMsaResponseBody::ResultContent> resultContent_ {};
