...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMcdpZoneResponseBody::ResultContent & getResultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, DeleteMcdpZoneResponseBody::ResultContent) };
    inline DeleteMcdpZoneResponseBody::ResultContent getResultContent() { DARABONBA_PTR_GET(resultContent_, DeleteMcdpZoneResponseBody::ResultContent) };
    inline DeleteMcdpZoneResponseBody& setResultContent(const DeleteMcdpZoneResponseBody::ResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline DeleteMcdpZoneResponseBody& setResultContent(DeleteMcdpZoneResponseBody::ResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    shared_ptr<DeleteMcdpZoneResponseBody::ResultContent> resultContent_ {};
