...
#ifndef ALIBABACLOUD_MODELS_QUERYMGSAPIPAGERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYMGSAPIPAGERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryMgsApipageResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(ResultCode, resultCode_);
      DARABONBA_PTR_TO_JSON(ResultContent, resultContent_);
      DARABONBA_PTR_TO_JSON(ResultMessage, resultMessage_);
    };
    friend void from_json(const Darabonba::Json& j, QueryMgsApipageResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(ResultCode, resultCode_);
      DARABONBA_PTR_FROM_JSON(ResultContent, resultContent_);
      DARABONBA_PTR_FROM_JSON(ResultMessage, resultMessage_);
    };
    QueryMgsApipageResponseBody() = default ;
    QueryMgsApipageResponseBody(const QueryMgsApipageResponseBody &) = default ;
    QueryMgsApipageResponseBody(QueryMgsApipageResponseBody &&) = default ;
    QueryMgsApipageResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryMgsApipageResponseBody() = default ;
    QueryMgsApipageResponseBody& operator=(const QueryMgsApipageResponseBody &) = default ;
    QueryMgsApipageResponseBody& operator=(QueryMgsApipageResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline const List::ApiInvoker & getApiInvoker() const { DARABONBA_PTR_GET_CONST(apiInvoker_, List::ApiInvoker) };
        inline List::ApiInvoker getApiInvoker() { DARABONBA_PTR_GET(apiInvoker_, List::ApiInvoker) };
        inline List& setApiInvoker(const List::ApiInvoker & apiInvoker) { DARABONBA_PTR_SET_VALUE(apiInvoker_, apiInvoker) };
        inline List& setApiInvoker(List::ApiInvoker && apiInvoker) { DARABONBA_PTR_SET_RVALUE(apiInvoker_, apiInvoker) };
        ...
        inline List& setApiName(string apiName) { DARABONBA_PTR_SET_VALUE(apiName_, apiName) };
        ...
        inline List& setApiStatus(string apiStatus) { DARABONBA_PTR_SET_VALUE(apiStatus_, apiStatus) };
        ...
        inline List& setApiType(string apiType) { DARABONBA_PTR_SET_VALUE(apiType_, apiType) };
        ...
        void deleteAppId() { this->appId_ = nullptr;};
        inline string getAppId() const { DARABONBA_PTR_GET_DEFAULT(appId_, "") };
        inline List& setAppId(string appId) { DARABONBA_PTR_SET_VALUE(appId_, appId) };
        ...
        inline List& setAuthRuleName(string authRuleName) { DARABONBA_PTR_SET_VALUE(authRuleName_, authRuleName) };
        ...
        inline const List::CacheRule & getCacheRule() const { DARABONBA_PTR_GET_CONST(cacheRule_, List::CacheRule) };
        inline List::CacheRule getCacheRule() { DARABONBA_PTR_GET(cacheRule_, List::CacheRule) };
        inline List& setCacheRule(const List::CacheRule & cacheRule) { DARABONBA_PTR_SET_VALUE(cacheRule_, cacheRule) };
        inline List& setCacheRule(List::CacheRule && cacheRule) { DARABONBA_PTR_SET_RVALUE(cacheRule_, cacheRule) };
        ...
        void deleteCharset() { this->charset_ = nullptr;};
        inline string getCharset() const { DARABONBA_PTR_GET_DEFAULT(charset_, "") };
        inline List& setCharset(string charset) { DARABONBA_PTR_SET_VALUE(charset_, charset) };
        ...
        inline const List::CircuitBreakerRule & getCircuitBreakerRule() const { DARABONBA_PTR_GET_CONST(circuitBreakerRule_, List::CircuitBreakerRule) };
        inline List::CircuitBreakerRule getCircuitBreakerRule() { DARABONBA_PTR_GET(circuitBreakerRule_, List::CircuitBreakerRule) };
        inline List& setCircuitBreakerRule(const List::CircuitBreakerRule & circuitBreakerRule) { DARABONBA_PTR_SET_VALUE(circuitBreakerRule_, circuitBreakerRule) };
        inline List& setCircuitBreakerRule(List::CircuitBreakerRule && circuitBreakerRule) { DARABONBA_PTR_SET_RVALUE(circuitBreakerRule_, circuitBreakerRule) };
        ...
        void deleteContentType() { this->contentType_ = nullptr;};
        inline string getContentType() const { DARABONBA_PTR_GET_DEFAULT(contentType_, "") };
        inline List& setContentType(string contentType) { DARABONBA_PTR_SET_VALUE(contentType_, contentType) };
        ...
        inline const vector<List::HeaderRule> & getHeaderRule() const { DARABONBA_PTR_GET_CONST(headerRule_, vector<List::HeaderRule>) };
        inline vector<List::HeaderRule> getHeaderRule() { DARABONBA_PTR_GET(headerRule_, vector<List::HeaderRule>) };
        inline List& setHeaderRule(const vector<List::HeaderRule> & headerRule) { DARABONBA_PTR_SET_VALUE(headerRule_, headerRule) };
        inline List& setHeaderRule(vector<List::HeaderRule> && headerRule) { DARABONBA_PTR_SET_RVALUE(headerRule_, headerRule) };
        ...
        inline const vector<List::HeaderRules> & getHeaderRules() const { DARABONBA_PTR_GET_CONST(headerRules_, vector<List::HeaderRules>) };
        inline vector<List::HeaderRules> getHeaderRules() { DARABONBA_PTR_GET(headerRules_, vector<List::HeaderRules>) };
        inline List& setHeaderRules(const vector<List::HeaderRules> & headerRules) { DARABONBA_PTR_SET_VALUE(headerRules_, headerRules) };
        inline List& setHeaderRules(vector<List::HeaderRules> && headerRules) { DARABONBA_PTR_SET_RVALUE(headerRules_, headerRules) };
        ...
        void deleteHost() { this->host_ = nullptr;};
        inline string getHost() const { DARABONBA_PTR_GET_DEFAULT(host_, "") };
        inline List& setHost(string host) { DARABONBA_PTR_SET_VALUE(host_, host) };
        ...
        inline List& setInterfaceType(string interfaceType) { DARABONBA_PTR_SET_VALUE(interfaceType_, interfaceType) };
        ...
        inline const List::LimitRule & getLimitRule() const { DARABONBA_PTR_GET_CONST(limitRule_, List::LimitRule) };
        inline List::LimitRule getLimitRule() { DARABONBA_PTR_GET(limitRule_, List::LimitRule) };
        inline List& setLimitRule(const List::LimitRule & limitRule) { DARABONBA_PTR_SET_VALUE(limitRule_, limitRule) };
        inline List& setLimitRule(List::LimitRule && limitRule) { DARABONBA_PTR_SET_RVALUE(limitRule_, limitRule) };
        ...
        inline List& setMethodName(string methodName) { DARABONBA_PTR_SET_VALUE(methodName_, methodName) };
        ...
        inline const List::MigrateRule & getMigrateRule() const { DARABONBA_PTR_GET_CONST(migrateRule_, List::MigrateRule) };
        inline List::MigrateRule getMigrateRule() { DARABONBA_PTR_GET(migrateRule_, List::MigrateRule) };
        inline List& setMigrateRule(const List::MigrateRule & migrateRule) { DARABONBA_PTR_SET_VALUE(migrateRule_, migrateRule) };
        inline List& setMigrateRule(List::MigrateRule && migrateRule) { DARABONBA_PTR_SET_RVALUE(migrateRule_, migrateRule) };


        // mockRule Field Functions 
        bool hasMockRule() const { return this->mockRule_ != nullptr;};
        void deleteMockRule() { this->mockRule_ = nullptr;};
        inline const List::MockRule & getMockRule() const { DARABONBA_PTR_GET_CONST(mockRule_, List::MockRule) };
        inline List::MockRule getMockRule() { DARABONBA_PTR_GET(mockRule_, List::MockRule) };
        inline List& setMockRule(const List::MockRule & mockRule) { DARABONBA_PTR_SET_VALUE(mockRule_, mockRule) };
        inline List& setMockRule(List::MockRule && mockRule) { DARABONBA_PTR_SET_RVALUE(mockRule_, mockRule) };
        ...
        inline List& setNeedETag(string needETag) { DARABONBA_PTR_SET_VALUE(needETag_, needETag) };
        ...
        inline List& setNeedEncrypt(string needEncrypt) { DARABONBA_PTR_SET_VALUE(needEncrypt_, needEncrypt) };
        ...
        inline List& setNeedJsonp(string needJsonp) { DARABONBA_PTR_SET_VALUE(needJsonp_, needJsonp) };
        ...
        inline List& setNeedSign(string needSign) { DARABONBA_PTR_SET_VALUE(needSign_, needSign) };
        ...
        inline List& setParamGetMethod(string paramGetMethod) { DARABONBA_PTR_SET_VALUE(paramGetMethod_, paramGetMethod) };
        ...
        inline List& setRequestBodyModel(string requestBodyModel) { DARABONBA_PTR_SET_VALUE(requestBodyModel_, requestBodyModel) };
        ...
        inline const vector<List::RequestParams> & getRequestParams() const { DARABONBA_PTR_GET_CONST(requestParams_, vector<List::RequestParams>) };
        inline vector<List::RequestParams> getRequestParams() { DARABONBA_PTR_GET(requestParams_, vector<List::RequestParams>) };
        inline List& setRequestParams(const vector<List::RequestParams> & requestParams) { DARABONBA_PTR_SET_VALUE(requestParams_, requestParams) };
        inline List& setRequestParams(vector<List::RequestParams> && requestParams) { DARABONBA_PTR_SET_RVALUE(requestParams_, requestParams) };
        ...
        inline List& setResponseBodyModel(string responseBodyModel) { DARABONBA_PTR_SET_VALUE(responseBodyModel_, responseBodyModel) };
        ...
        void deleteSysId() { this->sysId_ = nullptr;};
        inline int64_t getSysId() const { DARABONBA_PTR_GET_DEFAULT(sysId_, 0L) };
        inline List& setSysId(int64_t sysId) { DARABONBA_PTR_SET_VALUE(sysId_, sysId) };
        ...
        void deleteSysName() { this->sysName_ = nullptr;};
        inline string getSysName() const { DARABONBA_PTR_GET_DEFAULT(sysName_, "") };
        inline List& setSysName(string sysName) { DARABONBA_PTR_SET_VALUE(sysName_, sysName) };
      ...
      protected:
        shared_ptr<List::ApiInvoker> apiInvoker_ {};
        shared_ptr<string> apiName_ {};
        shared_ptr<string> apiStatus_ {};
        shared_ptr<string> apiType_ {};
        shared_ptr<string> appId_ {};
        shared_ptr<string> authRuleName_ {};
        shared_ptr<List::CacheRule> cacheRule_ {};
        shared_ptr<string> charset_ {};
        shared_ptr<List::CircuitBreakerRule> circuitBreakerRule_ {};
        shared_ptr<string> contentType_ {};
        shared_ptr<string> description_ {};
        shared_ptr<string> gmtCreate_ {};
        shared_ptr<string> gmtModified_ {};
        shared_ptr<vector<List::HeaderRule>> headerRule_ {};
        shared_ptr<vector<List::HeaderRules>> headerRules_ {};
        shared_ptr<string> host_ {};
        shared_ptr<int64_t> id_ {};
        shared_ptr<string> interfaceType_ {};
        shared_ptr<List::LimitRule> limitRule_ {};
        shared_ptr<string> method_ {};
        shared_ptr<string> methodName_ {};
        shared_ptr<List::MigrateRule> migrateRule_ {};
        shared_ptr<List::MockRule> mockRule_ {};
        ...
        shared_ptr<vector<List::RequestParams>> requestParams_ {};
      ...
      inline ResultContent& setCurrent(int64_t current) { DARABONBA_PTR_SET_VALUE(current_, current) };


      // list Field Functions 
      bool hasList() const { return this->list_ != nullptr;};
      void deleteList() { this->list_ = nullptr;};
      inline const vector<ResultContent::List> & getList() const { DARABONBA_PTR_GET_CONST(list_, vector<ResultContent::List>) };
      inline vector<ResultContent::List> getList() { DARABONBA_PTR_GET(list_, vector<ResultContent::List>) };
      inline ResultContent& setList(const vector<ResultContent::List> & list) { DARABONBA_PTR_SET_VALUE(list_, list) };
      inline ResultContent& setList(vector<ResultContent::List> && list) { DARABONBA_PTR_SET_RVALUE(list_, list) };
      ...
      inline ResultContent& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
      ...
      inline ResultContent& setTotal(int64_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };


    protected:
      shared_ptr<int64_t> current_ {};
      shared_ptr<vector<ResultContent::List>> list_ {};
    ...
    inline QueryMgsApipageResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryMgsApipageResponseBody& setResultCode(string resultCode) { DARABONBA_PTR_SET_VALUE(resultCode_, resultCode) };
    ...
    inline const QueryMgsApipageResponseBody::ResultContent & getResultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, QueryMgsApipageResponseBody::ResultContent) };
    inline QueryMgsApipageResponseBody::ResultContent getResultContent() { DARABONBA_PTR_GET(resultContent_, QueryMgsApipageResponseBody::ResultContent) };
    inline QueryMgsApipageResponseBody& setResultContent(const QueryMgsApipageResponseBody::ResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline QueryMgsApipageResponseBody& setResultContent(QueryMgsApipageResponseBody::ResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
    ...
    inline QueryMgsApipageResponseBody& setResultMessage(string resultMessage) { DARABONBA_PTR_SET_VALUE(resultMessage_, resultMessage) };


  protected:
    shared_ptr<string> requestId_ {};
    shared_ptr<string> resultCode_ {};
    shared_ptr<QueryMgsApipageResponseBody::ResultContent> resultContent_ {};
