...
namespace Models
{
  ...
  public:
    ...
    inline QueryPushAnalysisCoreIndexResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
