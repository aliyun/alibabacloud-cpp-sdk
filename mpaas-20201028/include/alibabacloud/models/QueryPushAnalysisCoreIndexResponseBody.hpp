...
namespace Models
{
  ...
  public:
    ...
    inline const QueryPushAnalysisCoreIndexResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, QueryPushAnalysisCoreIndexResponseBodyResultContent) };
    inline QueryPushAnalysisCoreIndexResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, QueryPushAnalysisCoreIndexResponseBodyResultContent) };
    inline QueryPushAnalysisCoreIndexResponseBody& setResultContent(const QueryPushAnalysisCoreIndexResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline QueryPushAnalysisCoreIndexResponseBody& setResultContent(QueryPushAnalysisCoreIndexResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<QueryPushAnalysisCoreIndexResponseBodyResultContent> resultContent_ = nullptr;
