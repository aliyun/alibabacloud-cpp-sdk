...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->mpaasMappcenterMcdpGroupCopyJsonStr_ == nullptr && this->tenantId_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline string getMpaasMappcenterMcdpGroupCopyJsonStr() const { DARABONBA_PTR_GET_DEFAULT(mpaasMappcenterMcdpGroupCopyJsonStr_, "") };
  ...
  protected:
    ...
    shared_ptr<string> mpaasMappcenterMcdpGroupCopyJsonStr_ {};
