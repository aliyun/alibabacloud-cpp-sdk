...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->activityContentState_ != nullptr
        ...
        && this->pushAction_ != nullptr && this->silent_ != nullptr && this->smsSignName_ != nullptr && this->smsStrategy_ != nullptr && this->smsTemplateCode_ != nullptr
        ...
        && this->templateKeyValue_ != nullptr && this->templateName_ != nullptr && this->tenantId_ != nullptr && this->thirdChannelCategory_ != nullptr && this->transparentMessagePayload_ != nullptr
