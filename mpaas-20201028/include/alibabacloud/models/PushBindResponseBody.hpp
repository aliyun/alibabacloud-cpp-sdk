...
namespace Models
{
  ...
  public:
    ...
    inline PushBindResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline const PushBindResponseBody::PushResult & getPushResult() const { DARABONBA_PTR_GET_CONST(pushResult_, PushBindResponseBody::PushResult) };
    inline PushBindResponseBody::PushResult getPushResult() { DARABONBA_PTR_GET(pushResult_, PushBindResponseBody::PushResult) };
    inline PushBindResponseBody& setPushResult(const PushBindResponseBody::PushResult & pushResult) { DARABONBA_PTR_SET_VALUE(pushResult_, pushResult) };
    inline PushBindResponseBody& setPushResult(PushBindResponseBody::PushResult && pushResult) { DARABONBA_PTR_SET_RVALUE(pushResult_, pushResult) };
  ...
  protected:
    ...
    shared_ptr<PushBindResponseBody::PushResult> pushResult_ {};
