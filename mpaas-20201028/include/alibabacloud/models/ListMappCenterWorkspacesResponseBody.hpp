...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->listMappCenterWorkspaceResult_ != nullptr
    ...
    inline const ListMappCenterWorkspacesResponseBodyListMappCenterWorkspaceResult & listMappCenterWorkspaceResult() const { DARABONBA_PTR_GET_CONST(listMappCenterWorkspaceResult_, ListMappCenterWorkspacesResponseBodyListMappCenterWorkspaceResult) };
    inline ListMappCenterWorkspacesResponseBodyListMappCenterWorkspaceResult listMappCenterWorkspaceResult() { DARABONBA_PTR_GET(listMappCenterWorkspaceResult_, ListMappCenterWorkspacesResponseBodyListMappCenterWorkspaceResult) };
    inline ListMappCenterWorkspacesResponseBody& setListMappCenterWorkspaceResult(const ListMappCenterWorkspacesResponseBodyListMappCenterWorkspaceResult & listMappCenterWorkspaceResult) { DARABONBA_PTR_SET_VALUE(listMappCenterWorkspaceResult_, listMappCenterWorkspaceResult) };
    inline ListMappCenterWorkspacesResponseBody& setListMappCenterWorkspaceResult(ListMappCenterWorkspacesResponseBodyListMappCenterWorkspaceResult && listMappCenterWorkspaceResult) { DARABONBA_PTR_SET_RVALUE(listMappCenterWorkspaceResult_, listMappCenterWorkspaceResult) };
  ...
  protected:
    std::shared_ptr<ListMappCenterWorkspacesResponseBodyListMappCenterWorkspaceResult> listMappCenterWorkspaceResult_ = nullptr;
