...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMcubeNebulaTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMcubeNebulaTaskResponseBody) };
    inline CreateMcubeNebulaTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMcubeNebulaTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMcubeNebulaTaskResponseBody> body_ {};
  };
