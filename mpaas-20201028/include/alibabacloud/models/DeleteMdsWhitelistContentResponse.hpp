...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMdsWhitelistContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMdsWhitelistContentResponseBody) };
    inline DeleteMdsWhitelistContentResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMdsWhitelistContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMdsWhitelistContentResponseBody> body_ {};
  };
