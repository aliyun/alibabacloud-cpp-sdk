...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMcubeMiniTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryMcubeMiniTaskResponseBody) };
    inline QueryMcubeMiniTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryMcubeMiniTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryMcubeMiniTaskResponseBody> body_ {};
  };
