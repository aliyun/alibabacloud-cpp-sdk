...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMdsCubeResourceResponseBody::ResultContent & getResultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, CreateMdsCubeResourceResponseBody::ResultContent) };
    inline CreateMdsCubeResourceResponseBody::ResultContent getResultContent() { DARABONBA_PTR_GET(resultContent_, CreateMdsCubeResourceResponseBody::ResultContent) };
    inline CreateMdsCubeResourceResponseBody& setResultContent(const CreateMdsCubeResourceResponseBody::ResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline CreateMdsCubeResourceResponseBody& setResultContent(CreateMdsCubeResourceResponseBody::ResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    shared_ptr<CreateMdsCubeResourceResponseBody::ResultContent> resultContent_ {};
