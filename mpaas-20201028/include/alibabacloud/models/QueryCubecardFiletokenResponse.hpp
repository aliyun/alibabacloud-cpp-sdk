...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCubecardFiletokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryCubecardFiletokenResponseBody) };
    inline QueryCubecardFiletokenResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryCubecardFiletokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryCubecardFiletokenResponseBody> body_ {};
  };
