...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->appCode_ != nullptr
        && this->autoInstall_ != nullptr && this->clientVersionMax_ != nullptr && this->clientVersionMin_ != nullptr && this->creator_ != nullptr && this->downloadUrl_ != nullptr
        && this->extendInfo_ != nullptr && this->extraData_ != nullptr && this->fallbackBaseUrl_ != nullptr && this->fileSize_ != nullptr && this->gmtCreate_ != nullptr
        && this->gmtModified_ != nullptr && this->h5Id_ != nullptr && this->h5Name_ != nullptr && this->h5Version_ != nullptr && this->id_ != nullptr
        && this->installType_ != nullptr && this->mainUrl_ != nullptr && this->memo_ != nullptr && this->metaId_ != nullptr && this->modifier_ != nullptr
        && this->packageType_ != nullptr && this->platform_ != nullptr && this->publishPeriod_ != nullptr && this->resourceType_ != nullptr && this->status_ != nullptr
        && this->vhost_ != nullptr; };
