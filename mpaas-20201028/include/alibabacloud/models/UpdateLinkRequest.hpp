...
namespace Models
{
  ...
  public:
    ...
    inline bool getCors() const { DARABONBA_PTR_GET_DEFAULT(cors_, false) };
    ...
    inline string getDynamicfield() const { DARABONBA_PTR_GET_DEFAULT(dynamicfield_, "") };
  ...
  protected:
    ...
    shared_ptr<bool> cors_ {};
    shared_ptr<string> domain_ {};
    shared_ptr<string> dynamicfield_ {};
    // This parameter is required.
