...
namespace Models
{
  ...
  public:
    ...
    inline const GetMcubeFileTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMcubeFileTokenResponseBody) };
    inline GetMcubeFileTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMcubeFileTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMcubeFileTokenResponseBody> body_ {};
  };
