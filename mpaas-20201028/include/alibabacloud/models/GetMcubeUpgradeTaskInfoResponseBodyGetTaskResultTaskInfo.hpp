...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appCode_ == nullptr
        && return this->appId_ == nullptr && return this->appstoreUrl_ == nullptr && return this->creater_ == nullptr && return this->creator_ == nullptr && return this->downloadUrl_ == nullptr
        && return this->greyConfigInfo_ == nullptr && return this->greyEndtimeData_ == nullptr && return this->greyNum_ == nullptr && return this->historyForce_ == nullptr && return this->id_ == nullptr
        && return this->isEnterprise_ == nullptr && return this->isOfficial_ == nullptr && return this->isRc_ == nullptr && return this->isRelease_ == nullptr && return this->memo_ == nullptr
        && return this->modifier_ == nullptr && return this->netType_ == nullptr && return this->osVersion_ == nullptr && return this->packageInfoId_ == nullptr && return this->packageType_ == nullptr
        && return this->platform_ == nullptr && return this->productId_ == nullptr && return this->publishMode_ == nullptr && return this->publishType_ == nullptr && return this->pushContent_ == nullptr
        && return this->qrcodeUrl_ == nullptr && return this->ruleJsonList_ == nullptr && return this->silentType_ == nullptr && return this->taskStatus_ == nullptr && return this->upgradeContent_ == nullptr
        && return this->upgradeType_ == nullptr && return this->upgradeValidTime_ == nullptr && return this->whitelist_ == nullptr && return this->whitelistIds_ == nullptr && return this->workspaceId_ == nullptr; };
