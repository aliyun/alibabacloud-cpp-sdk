...
#ifndef ALIBABACLOUD_MODELS_PUSHMULTIPLEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_PUSHMULTIPLEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PushMultipleRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PushMultipleRequest& obj) { 
    ...
    PushMultipleRequest() = default ;
    PushMultipleRequest(const PushMultipleRequest &) = default ;
    PushMultipleRequest(PushMultipleRequest &&) = default ;
    PushMultipleRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PushMultipleRequest() = default ;
    PushMultipleRequest& operator=(const PushMultipleRequest &) = default ;
    PushMultipleRequest& operator=(PushMultipleRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    class TargetMsg : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const TargetMsg& obj) { 
        DARABONBA_PTR_TO_JSON(ExtendedParams, extendedParams_);
        DARABONBA_PTR_TO_JSON(MsgKey, msgKey_);
        DARABONBA_PTR_TO_JSON(Target, target_);
        DARABONBA_PTR_TO_JSON(TemplateKeyValue, templateKeyValue_);
      };
      friend void from_json(const Darabonba::Json& j, TargetMsg& obj) { 
        DARABONBA_PTR_FROM_JSON(ExtendedParams, extendedParams_);
      ...
      TargetMsg() = default ;
      TargetMsg(const TargetMsg &) = default ;
      TargetMsg(TargetMsg &&) = default ;
      TargetMsg(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~TargetMsg() = default ;
      TargetMsg& operator=(const TargetMsg &) = default ;
      TargetMsg& operator=(TargetMsg &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline TargetMsg& setExtendedParams(string extendedParams) { DARABONBA_PTR_SET_VALUE(extendedParams_, extendedParams) };
      ...
      inline TargetMsg& setMsgKey(string msgKey) { DARABONBA_PTR_SET_VALUE(msgKey_, msgKey) };
      ...
      inline TargetMsg& setTarget(string target) { DARABONBA_PTR_SET_VALUE(target_, target) };
      ...
      inline TargetMsg& setTemplateKeyValue(string templateKeyValue) { DARABONBA_PTR_SET_VALUE(templateKeyValue_, templateKeyValue) };
    ...
    virtual bool empty() const override { return this->activityContentState_ == nullptr
        ...
        && this->targetMsg_ == nullptr && this->taskName_ == nullptr && this->templateName_ == nullptr && this->tenantId_ == nullptr && this->thirdChannelCategory_ == nullptr
    ...
    inline PushMultipleRequest& setActivityContentState(const Darabonba::Json & activityContentState) { DARABONBA_SET_VALUE(activityContentState_, activityContentState) };
    inline PushMultipleRequest& setActivityContentState(Darabonba::Json && activityContentState) { DARABONBA_SET_RVALUE(activityContentState_, activityContentState) };
    ...
    inline PushMultipleRequest& setActivityEvent(string activityEvent) { DARABONBA_PTR_SET_VALUE(activityEvent_, activityEvent) };
    ...
    inline PushMultipleRequest& setAppId(string appId) { DARABONBA_PTR_SET_VALUE(appId_, appId) };
    ...
    inline PushMultipleRequest& setChannelId(string channelId) { DARABONBA_PTR_SET_VALUE(channelId_, channelId) };
    ...
    inline PushMultipleRequest& setClassification(string classification) { DARABONBA_PTR_SET_VALUE(classification_, classification) };
    ...
    inline PushMultipleRequest& setDeliveryType(int64_t deliveryType) { DARABONBA_PTR_SET_VALUE(deliveryType_, deliveryType) };
    ...
    inline PushMultipleRequest& setDismissalDate(int64_t dismissalDate) { DARABONBA_PTR_SET_VALUE(dismissalDate_, dismissalDate) };
    ...
    inline PushMultipleRequest& setExpiredSeconds(int64_t expiredSeconds) { DARABONBA_PTR_SET_VALUE(expiredSeconds_, expiredSeconds) };
    ...
    void deleteExtendedParams() { this->extendedParams_ = nullptr;};
    inline string getExtendedParams() const { DARABONBA_PTR_GET_DEFAULT(extendedParams_, "") };
    inline PushMultipleRequest& setExtendedParams(string extendedParams) { DARABONBA_PTR_SET_VALUE(extendedParams_, extendedParams) };
    ...
    inline PushMultipleRequest& setMiChannelId(string miChannelId) { DARABONBA_PTR_SET_VALUE(miChannelId_, miChannelId) };
    ...
    inline PushMultipleRequest& setNotifyLevel(const Darabonba::Json & notifyLevel) { DARABONBA_SET_VALUE(notifyLevel_, notifyLevel) };
    inline PushMultipleRequest& setNotifyLevel(Darabonba::Json && notifyLevel) { DARABONBA_SET_RVALUE(notifyLevel_, notifyLevel) };
    ...
    inline PushMultipleRequest& setNotifyType(string notifyType) { DARABONBA_PTR_SET_VALUE(notifyType_, notifyType) };
    ...
    inline PushMultipleRequest& setPushAction(int64_t pushAction) { DARABONBA_PTR_SET_VALUE(pushAction_, pushAction) };
    ...
    inline PushMultipleRequest& setSilent(int64_t silent) { DARABONBA_PTR_SET_VALUE(silent_, silent) };
    ...
    inline PushMultipleRequest& setStrategyContent(string strategyContent) { DARABONBA_PTR_SET_VALUE(strategyContent_, strategyContent) };
    ...
    inline PushMultipleRequest& setStrategyType(int32_t strategyType) { DARABONBA_PTR_SET_VALUE(strategyType_, strategyType) };
    ...
    inline const vector<PushMultipleRequest::TargetMsg> & getTargetMsg() const { DARABONBA_PTR_GET_CONST(targetMsg_, vector<PushMultipleRequest::TargetMsg>) };
    inline vector<PushMultipleRequest::TargetMsg> getTargetMsg() { DARABONBA_PTR_GET(targetMsg_, vector<PushMultipleRequest::TargetMsg>) };
    inline PushMultipleRequest& setTargetMsg(const vector<PushMultipleRequest::TargetMsg> & targetMsg) { DARABONBA_PTR_SET_VALUE(targetMsg_, targetMsg) };
    inline PushMultipleRequest& setTargetMsg(vector<PushMultipleRequest::TargetMsg> && targetMsg) { DARABONBA_PTR_SET_RVALUE(targetMsg_, targetMsg) };
    ...
    inline PushMultipleRequest& setTaskName(string taskName) { DARABONBA_PTR_SET_VALUE(taskName_, taskName) };
    ...
    inline PushMultipleRequest& setTemplateName(string templateName) { DARABONBA_PTR_SET_VALUE(templateName_, templateName) };
    ...
    inline PushMultipleRequest& setTenantId(string tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
    ...
    inline PushMultipleRequest& setThirdChannelCategory(const Darabonba::Json & thirdChannelCategory) { DARABONBA_SET_VALUE(thirdChannelCategory_, thirdChannelCategory) };
    inline PushMultipleRequest& setThirdChannelCategory(Darabonba::Json && thirdChannelCategory) { DARABONBA_SET_RVALUE(thirdChannelCategory_, thirdChannelCategory) };
    ...
    inline PushMultipleRequest& setTransparentMessagePayload(const Darabonba::Json & transparentMessagePayload) { DARABONBA_SET_VALUE(transparentMessagePayload_, transparentMessagePayload) };
    inline PushMultipleRequest& setTransparentMessagePayload(Darabonba::Json && transparentMessagePayload) { DARABONBA_SET_RVALUE(transparentMessagePayload_, transparentMessagePayload) };
    ...
    inline PushMultipleRequest& setTransparentMessageUrgency(string transparentMessageUrgency) { DARABONBA_PTR_SET_VALUE(transparentMessageUrgency_, transparentMessageUrgency) };
    ...
    inline PushMultipleRequest& setVendorTemplate(string vendorTemplate) { DARABONBA_PTR_SET_VALUE(vendorTemplate_, vendorTemplate) };
    ...
    inline PushMultipleRequest& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<vector<PushMultipleRequest::TargetMsg>> targetMsg_ {};
