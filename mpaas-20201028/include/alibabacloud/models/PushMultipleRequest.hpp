...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activityContentState_ == nullptr
        ...
        && return this->targetMsg_ == nullptr && return this->taskName_ == nullptr && return this->templateName_ == nullptr && return this->tenantId_ == nullptr && return this->thirdChannelCategory_ == nullptr
    ...
    inline const vector<PushMultipleRequestTargetMsg> & targetMsg() const { DARABONBA_PTR_GET_CONST(targetMsg_, vector<PushMultipleRequestTargetMsg>) };
    inline vector<PushMultipleRequestTargetMsg> targetMsg() { DARABONBA_PTR_GET(targetMsg_, vector<PushMultipleRequestTargetMsg>) };
    inline PushMultipleRequest& setTargetMsg(const vector<PushMultipleRequestTargetMsg> & targetMsg) { DARABONBA_PTR_SET_VALUE(targetMsg_, targetMsg) };
    inline PushMultipleRequest& setTargetMsg(vector<PushMultipleRequestTargetMsg> && targetMsg) { DARABONBA_PTR_SET_RVALUE(targetMsg_, targetMsg) };
  ...
  protected:
    ...
    // This parameter is required.
    std::shared_ptr<vector<PushMultipleRequestTargetMsg>> targetMsg_ = nullptr;
