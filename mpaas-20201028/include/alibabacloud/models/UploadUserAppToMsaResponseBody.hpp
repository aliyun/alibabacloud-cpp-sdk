...
namespace Models
{
  ...
  public:
    ...
    inline const UploadUserAppToMsaResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, UploadUserAppToMsaResponseBodyResultContent) };
    inline UploadUserAppToMsaResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, UploadUserAppToMsaResponseBodyResultContent) };
    inline UploadUserAppToMsaResponseBody& setResultContent(const UploadUserAppToMsaResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline UploadUserAppToMsaResponseBody& setResultContent(UploadUserAppToMsaResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<UploadUserAppToMsaResponseBodyResultContent> resultContent_ = nullptr;
