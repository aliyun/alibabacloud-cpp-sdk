...
namespace Models
{
  ...
  public:
    ...
    inline const ExistMcubeRsaKeyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExistMcubeRsaKeyResponseBody) };
    inline ExistMcubeRsaKeyResponseBody getBody() { DARABONBA_PTR_GET(body_, ExistMcubeRsaKeyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExistMcubeRsaKeyResponseBody> body_ {};
  };
