...
#ifndef ALIBABACLOUD_MODELS_LISTMGSAPIRESPONSEBODYRESULTCONTENTVALUECIRCUITBREAKERRULE_HPP_
#define ALIBABACLOUD_MODELS_LISTMGSAPIRESPONSEBODYRESULTCONTENTVALUECIRCUITBREAKERRULE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListMgsApiResponseBodyResultContentValueCircuitBreakerRule& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListMgsApiResponseBodyResultContentValueCircuitBreakerRule& obj) { 
    ...
    ListMgsApiResponseBodyResultContentValueCircuitBreakerRule() = default ;
    ListMgsApiResponseBodyResultContentValueCircuitBreakerRule(const ListMgsApiResponseBodyResultContentValueCircuitBreakerRule &) = default ;
    ListMgsApiResponseBodyResultContentValueCircuitBreakerRule(ListMgsApiResponseBodyResultContentValueCircuitBreakerRule &&) = default ;
    ListMgsApiResponseBodyResultContentValueCircuitBreakerRule(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListMgsApiResponseBodyResultContentValueCircuitBreakerRule() = default ;
    ListMgsApiResponseBodyResultContentValueCircuitBreakerRule& operator=(const ListMgsApiResponseBodyResultContentValueCircuitBreakerRule &) = default ;
    ListMgsApiResponseBodyResultContentValueCircuitBreakerRule& operator=(ListMgsApiResponseBodyResultContentValueCircuitBreakerRule &&) = default ;
    ...
    inline ListMgsApiResponseBodyResultContentValueCircuitBreakerRule& setAppId(string appId) { DARABONBA_PTR_SET_VALUE(appId_, appId) };
    ...
    inline ListMgsApiResponseBodyResultContentValueCircuitBreakerRule& setDefaultResponse(string defaultResponse) { DARABONBA_PTR_SET_VALUE(defaultResponse_, defaultResponse) };
    ...
    inline ListMgsApiResponseBodyResultContentValueCircuitBreakerRule& setErrorThreshold(int64_t errorThreshold) { DARABONBA_PTR_SET_VALUE(errorThreshold_, errorThreshold) };
    ...
    inline ListMgsApiResponseBodyResultContentValueCircuitBreakerRule& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListMgsApiResponseBodyResultContentValueCircuitBreakerRule& setModel(string model) { DARABONBA_PTR_SET_VALUE(model_, model) };
    ...
    inline ListMgsApiResponseBodyResultContentValueCircuitBreakerRule& setOpenTimeoutSeconds(int64_t openTimeoutSeconds) { DARABONBA_PTR_SET_VALUE(openTimeoutSeconds_, openTimeoutSeconds) };
    ...
    inline ListMgsApiResponseBodyResultContentValueCircuitBreakerRule& setSlowRatioThreshold(double slowRatioThreshold) { DARABONBA_PTR_SET_VALUE(slowRatioThreshold_, slowRatioThreshold) };
    ...
    inline ListMgsApiResponseBodyResultContentValueCircuitBreakerRule& setSwitchStatus(string switchStatus) { DARABONBA_PTR_SET_VALUE(switchStatus_, switchStatus) };
    ...
    inline ListMgsApiResponseBodyResultContentValueCircuitBreakerRule& setWindowsInSeconds(int64_t windowsInSeconds) { DARABONBA_PTR_SET_VALUE(windowsInSeconds_, windowsInSeconds) };
    ...
    inline ListMgsApiResponseBodyResultContentValueCircuitBreakerRule& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
