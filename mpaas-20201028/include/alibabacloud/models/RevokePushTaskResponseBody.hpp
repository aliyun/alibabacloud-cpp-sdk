...
namespace Models
{
  ...
  public:
    ...
    inline RevokePushTaskResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline const RevokePushTaskResponseBody::PushResult & getPushResult() const { DARABONBA_PTR_GET_CONST(pushResult_, RevokePushTaskResponseBody::PushResult) };
    inline RevokePushTaskResponseBody::PushResult getPushResult() { DARABONBA_PTR_GET(pushResult_, RevokePushTaskResponseBody::PushResult) };
    inline RevokePushTaskResponseBody& setPushResult(const RevokePushTaskResponseBody::PushResult & pushResult) { DARABONBA_PTR_SET_VALUE(pushResult_, pushResult) };
    inline RevokePushTaskResponseBody& setPushResult(RevokePushTaskResponseBody::PushResult && pushResult) { DARABONBA_PTR_SET_RVALUE(pushResult_, pushResult) };
  ...
  protected:
    ...
    shared_ptr<RevokePushTaskResponseBody::PushResult> pushResult_ {};
