...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->activityContentState_ != nullptr
        ...
        && this->thirdChannelCategory_ != nullptr && this->title_ != nullptr && this->transparentMessagePayload_ != nullptr && this->transparentMessageUrgency_ != nullptr && this->uri_ != nullptr
