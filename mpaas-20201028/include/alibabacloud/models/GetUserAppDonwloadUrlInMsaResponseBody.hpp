...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserAppDonwloadUrlInMsaResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, GetUserAppDonwloadUrlInMsaResponseBodyResultContent) };
    inline GetUserAppDonwloadUrlInMsaResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, GetUserAppDonwloadUrlInMsaResponseBodyResultContent) };
    inline GetUserAppDonwloadUrlInMsaResponseBody& setResultContent(const GetUserAppDonwloadUrlInMsaResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline GetUserAppDonwloadUrlInMsaResponseBody& setResultContent(GetUserAppDonwloadUrlInMsaResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<GetUserAppDonwloadUrlInMsaResponseBodyResultContent> resultContent_ = nullptr;
