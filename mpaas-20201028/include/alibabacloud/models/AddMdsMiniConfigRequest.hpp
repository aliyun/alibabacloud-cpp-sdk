...
namespace Models
{
  ...
  public:
    ...
    inline string getMpaasMappcenterMiniConfigAddJsonStr() const { DARABONBA_PTR_GET_DEFAULT(mpaasMappcenterMiniConfigAddJsonStr_, "") };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<string> mpaasMappcenterMiniConfigAddJsonStr_ {};
    // This parameter is required.
