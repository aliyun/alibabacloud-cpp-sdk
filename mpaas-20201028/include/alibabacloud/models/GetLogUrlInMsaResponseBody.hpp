...
namespace Models
{
  ...
  public:
    ...
    inline const GetLogUrlInMsaResponseBody::ResultContent & getResultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, GetLogUrlInMsaResponseBody::ResultContent) };
    inline GetLogUrlInMsaResponseBody::ResultContent getResultContent() { DARABONBA_PTR_GET(resultContent_, GetLogUrlInMsaResponseBody::ResultContent) };
    inline GetLogUrlInMsaResponseBody& setResultContent(const GetLogUrlInMsaResponseBody::ResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline GetLogUrlInMsaResponseBody& setResultContent(GetLogUrlInMsaResponseBody::ResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    shared_ptr<GetLogUrlInMsaResponseBody::ResultContent> resultContent_ {};
