...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appCode_ == nullptr
        && return this->autoInstall_ == nullptr && return this->clientVersionMax_ == nullptr && return this->clientVersionMin_ == nullptr && return this->creator_ == nullptr && return this->debugUrl_ == nullptr
        && return this->downloadUrl_ == nullptr && return this->extendInfo_ == nullptr && return this->extraData_ == nullptr && return this->fallbackBaseUrl_ == nullptr && return this->fileSize_ == nullptr
        && return this->gmtCreate_ == nullptr && return this->gmtModified_ == nullptr && return this->h5Id_ == nullptr && return this->h5Name_ == nullptr && return this->h5Version_ == nullptr
        && return this->id_ == nullptr && return this->installType_ == nullptr && return this->lazyLoad_ == nullptr && return this->mainUrl_ == nullptr && return this->md5_ == nullptr
        && return this->memo_ == nullptr && return this->metaId_ == nullptr && return this->modifier_ == nullptr && return this->packageType_ == nullptr && return this->platform_ == nullptr
        && return this->publishPeriod_ == nullptr && return this->releaseVersion_ == nullptr && return this->resourceType_ == nullptr && return this->status_ == nullptr && return this->vhost_ == nullptr; };
