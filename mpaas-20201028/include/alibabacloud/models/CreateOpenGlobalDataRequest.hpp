...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getMaxUid() const { DARABONBA_PTR_GET_DEFAULT(maxUid_, 0L) };
    ...
    inline int64_t getMinUid() const { DARABONBA_PTR_GET_DEFAULT(minUid_, 0L) };
    ...
    inline string getUids() const { DARABONBA_PTR_GET_DEFAULT(uids_, "") };
  ...
  protected:
    ...
    shared_ptr<int64_t> maxUid_ {};
    shared_ptr<int64_t> minUid_ {};
