...
namespace Models
{
  ...
  public:
    ...
    inline const AddMdsMiniConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddMdsMiniConfigResponseBody) };
    inline AddMdsMiniConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, AddMdsMiniConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddMdsMiniConfigResponseBody> body_ {};
  };
