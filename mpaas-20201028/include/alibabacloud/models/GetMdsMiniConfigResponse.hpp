...
namespace Models
{
  ...
  public:
    ...
    inline const GetMdsMiniConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMdsMiniConfigResponseBody) };
    inline GetMdsMiniConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMdsMiniConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMdsMiniConfigResponseBody> body_ {};
  };
