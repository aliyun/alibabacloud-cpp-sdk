...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMgsApirestResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryMgsApirestResponseBody) };
    inline QueryMgsApirestResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryMgsApirestResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryMgsApirestResponseBody> body_ {};
  };
