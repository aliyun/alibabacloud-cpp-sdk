...
namespace Models
{
  ...
  public:
    ...
    inline const RevokePushTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RevokePushTaskResponseBody) };
    inline RevokePushTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, RevokePushTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RevokePushTaskResponseBody> body_ {};
  };
