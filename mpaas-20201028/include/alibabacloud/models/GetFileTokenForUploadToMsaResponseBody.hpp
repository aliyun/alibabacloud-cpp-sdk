...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileTokenForUploadToMsaResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, GetFileTokenForUploadToMsaResponseBodyResultContent) };
    inline GetFileTokenForUploadToMsaResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, GetFileTokenForUploadToMsaResponseBodyResultContent) };
    inline GetFileTokenForUploadToMsaResponseBody& setResultContent(const GetFileTokenForUploadToMsaResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline GetFileTokenForUploadToMsaResponseBody& setResultContent(GetFileTokenForUploadToMsaResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<GetFileTokenForUploadToMsaResponseBodyResultContent> resultContent_ = nullptr;
