...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activityContentState_ == nullptr
        ...
        && this->dismissalDate_ == nullptr && this->expiredSeconds_ == nullptr && this->extendedParams_ == nullptr && this->miChannelId_ == nullptr && this->notifyLevelShrink_ == nullptr
        ...
        && this->taskName_ == nullptr && this->templateKeyValue_ == nullptr && this->templateName_ == nullptr && this->tenantId_ == nullptr && this->thirdChannelCategoryShrink_ == nullptr
    ...
    inline string getNotifyLevelShrink() const { DARABONBA_PTR_GET_DEFAULT(notifyLevelShrink_, "") };
    ...
    inline string getThirdChannelCategoryShrink() const { DARABONBA_PTR_GET_DEFAULT(thirdChannelCategoryShrink_, "") };
    ...
    inline PushTemplateShrinkRequest& setVendorTemplate(string vendorTemplate) { DARABONBA_PTR_SET_VALUE(vendorTemplate_, vendorTemplate) };
  ...
  protected:
    ...
    shared_ptr<string> notifyLevelShrink_ {};
    ...
    shared_ptr<string> thirdChannelCategoryShrink_ {};
