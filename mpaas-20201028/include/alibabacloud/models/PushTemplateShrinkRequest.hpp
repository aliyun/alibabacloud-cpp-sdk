...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->activityContentState_ != nullptr
        ...
        && this->templateKeyValue_ != nullptr && this->templateName_ != nullptr && this->tenantId_ != nullptr && this->thirdChannelCategoryShrink_ != nullptr && this->transparentMessagePayload_ != nullptr
