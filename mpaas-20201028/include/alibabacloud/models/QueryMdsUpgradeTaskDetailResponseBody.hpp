...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMdsUpgradeTaskDetailResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, QueryMdsUpgradeTaskDetailResponseBodyResultContent) };
    inline QueryMdsUpgradeTaskDetailResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, QueryMdsUpgradeTaskDetailResponseBodyResultContent) };
    inline QueryMdsUpgradeTaskDetailResponseBody& setResultContent(const QueryMdsUpgradeTaskDetailResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline QueryMdsUpgradeTaskDetailResponseBody& setResultContent(QueryMdsUpgradeTaskDetailResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<QueryMdsUpgradeTaskDetailResponseBodyResultContent> resultContent_ = nullptr;
