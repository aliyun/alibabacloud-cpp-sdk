...
#include <alibabacloud/models/ListMdsCubeResourcesResponseBodyResultContent.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const ListMdsCubeResourcesResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, ListMdsCubeResourcesResponseBodyResultContent) };
    inline ListMdsCubeResourcesResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, ListMdsCubeResourcesResponseBodyResultContent) };
    inline ListMdsCubeResourcesResponseBody& setResultContent(const ListMdsCubeResourcesResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline ListMdsCubeResourcesResponseBody& setResultContent(ListMdsCubeResourcesResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<ListMdsCubeResourcesResponseBodyResultContent> resultContent_ = nullptr;
