...
namespace Models
{
  ...
  public:
    ...
    inline const UploadBitcodeToMsaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UploadBitcodeToMsaResponseBody) };
    inline UploadBitcodeToMsaResponseBody getBody() { DARABONBA_PTR_GET(body_, UploadBitcodeToMsaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UploadBitcodeToMsaResponseBody> body_ {};
  };
