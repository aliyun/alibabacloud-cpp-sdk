...
#include <alibabacloud/models/ListCubecardAppsResponseBodyResultContent.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const ListCubecardAppsResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, ListCubecardAppsResponseBodyResultContent) };
    inline ListCubecardAppsResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, ListCubecardAppsResponseBodyResultContent) };
    inline ListCubecardAppsResponseBody& setResultContent(const ListCubecardAppsResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline ListCubecardAppsResponseBody& setResultContent(ListCubecardAppsResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<ListCubecardAppsResponseBodyResultContent> resultContent_ = nullptr;
