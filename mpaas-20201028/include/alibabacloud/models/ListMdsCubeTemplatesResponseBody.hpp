...
#include <alibabacloud/models/ListMdsCubeTemplatesResponseBodyResultContent.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const ListMdsCubeTemplatesResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, ListMdsCubeTemplatesResponseBodyResultContent) };
    inline ListMdsCubeTemplatesResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, ListMdsCubeTemplatesResponseBodyResultContent) };
    inline ListMdsCubeTemplatesResponseBody& setResultContent(const ListMdsCubeTemplatesResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline ListMdsCubeTemplatesResponseBody& setResultContent(ListMdsCubeTemplatesResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<ListMdsCubeTemplatesResponseBodyResultContent> resultContent_ = nullptr;
