...
#ifndef ALIBABACLOUD_MODELS_PUSHMULTIPLEREQUESTTARGETMSG_HPP_
#define ALIBABACLOUD_MODELS_PUSHMULTIPLEREQUESTTARGETMSG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PushMultipleRequestTargetMsg& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PushMultipleRequestTargetMsg& obj) { 
    ...
    PushMultipleRequestTargetMsg() = default ;
    PushMultipleRequestTargetMsg(const PushMultipleRequestTargetMsg &) = default ;
    PushMultipleRequestTargetMsg(PushMultipleRequestTargetMsg &&) = default ;
    PushMultipleRequestTargetMsg(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PushMultipleRequestTargetMsg() = default ;
    PushMultipleRequestTargetMsg& operator=(const PushMultipleRequestTargetMsg &) = default ;
    PushMultipleRequestTargetMsg& operator=(PushMultipleRequestTargetMsg &&) = default ;
    ...
    inline PushMultipleRequestTargetMsg& setExtendedParams(string extendedParams) { DARABONBA_PTR_SET_VALUE(extendedParams_, extendedParams) };
    ...
    inline PushMultipleRequestTargetMsg& setMsgKey(string msgKey) { DARABONBA_PTR_SET_VALUE(msgKey_, msgKey) };
    ...
    inline PushMultipleRequestTargetMsg& setTarget(string target) { DARABONBA_PTR_SET_VALUE(target_, target) };
    ...
    inline PushMultipleRequestTargetMsg& setTemplateKeyValue(string templateKeyValue) { DARABONBA_PTR_SET_VALUE(templateKeyValue_, templateKeyValue) };
