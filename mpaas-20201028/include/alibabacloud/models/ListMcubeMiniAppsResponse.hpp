...
namespace Models
{
  ...
  public:
    ...
    inline const ListMcubeMiniAppsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMcubeMiniAppsResponseBody) };
    inline ListMcubeMiniAppsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMcubeMiniAppsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMcubeMiniAppsResponseBody> body_ {};
  };
