...
#ifndef ALIBABACLOUD_MODELS_STARTUSERAPPASYNCENHANCEINMSARESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_STARTUSERAPPASYNCENHANCEINMSARESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartUserAppAsyncEnhanceInMsaResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(ResultCode, resultCode_);
      DARABONBA_PTR_TO_JSON(ResultContent, resultContent_);
      DARABONBA_PTR_TO_JSON(ResultMessage, resultMessage_);
    };
    friend void from_json(const Darabonba::Json& j, StartUserAppAsyncEnhanceInMsaResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(ResultCode, resultCode_);
      DARABONBA_PTR_FROM_JSON(ResultContent, resultContent_);
      DARABONBA_PTR_FROM_JSON(ResultMessage, resultMessage_);
    };
    StartUserAppAsyncEnhanceInMsaResponseBody() = default ;
    StartUserAppAsyncEnhanceInMsaResponseBody(const StartUserAppAsyncEnhanceInMsaResponseBody &) = default ;
    StartUserAppAsyncEnhanceInMsaResponseBody(StartUserAppAsyncEnhanceInMsaResponseBody &&) = default ;
    StartUserAppAsyncEnhanceInMsaResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartUserAppAsyncEnhanceInMsaResponseBody() = default ;
    StartUserAppAsyncEnhanceInMsaResponseBody& operator=(const StartUserAppAsyncEnhanceInMsaResponseBody &) = default ;
    StartUserAppAsyncEnhanceInMsaResponseBody& operator=(StartUserAppAsyncEnhanceInMsaResponseBody &&) = default ;
    ...
    inline StartUserAppAsyncEnhanceInMsaResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline StartUserAppAsyncEnhanceInMsaResponseBody& setResultCode(string resultCode) { DARABONBA_PTR_SET_VALUE(resultCode_, resultCode) };
    ...
    inline const StartUserAppAsyncEnhanceInMsaResponseBody::ResultContent & getResultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, StartUserAppAsyncEnhanceInMsaResponseBody::ResultContent) };
    inline StartUserAppAsyncEnhanceInMsaResponseBody::ResultContent getResultContent() { DARABONBA_PTR_GET(resultContent_, StartUserAppAsyncEnhanceInMsaResponseBody::ResultContent) };
    inline StartUserAppAsyncEnhanceInMsaResponseBody& setResultContent(const StartUserAppAsyncEnhanceInMsaResponseBody::ResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline StartUserAppAsyncEnhanceInMsaResponseBody& setResultContent(StartUserAppAsyncEnhanceInMsaResponseBody::ResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
    ...
    inline StartUserAppAsyncEnhanceInMsaResponseBody& setResultMessage(string resultMessage) { DARABONBA_PTR_SET_VALUE(resultMessage_, resultMessage) };


  protected:
    shared_ptr<string> requestId_ {};
    shared_ptr<string> resultCode_ {};
    shared_ptr<StartUserAppAsyncEnhanceInMsaResponseBody::ResultContent> resultContent_ {};
