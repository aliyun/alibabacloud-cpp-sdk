...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMdsUpgradeTaskDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryMdsUpgradeTaskDetailResponseBody) };
    inline QueryMdsUpgradeTaskDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryMdsUpgradeTaskDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryMdsUpgradeTaskDetailResponseBody> body_ {};
  };
