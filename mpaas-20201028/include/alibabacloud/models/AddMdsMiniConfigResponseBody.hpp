...
namespace Models
{
  ...
  public:
    ...
    inline const AddMdsMiniConfigResponseBody::ResultContent & getResultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, AddMdsMiniConfigResponseBody::ResultContent) };
    inline AddMdsMiniConfigResponseBody::ResultContent getResultContent() { DARABONBA_PTR_GET(resultContent_, AddMdsMiniConfigResponseBody::ResultContent) };
    inline AddMdsMiniConfigResponseBody& setResultContent(const AddMdsMiniConfigResponseBody::ResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline AddMdsMiniConfigResponseBody& setResultContent(AddMdsMiniConfigResponseBody::ResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    shared_ptr<AddMdsMiniConfigResponseBody::ResultContent> resultContent_ {};
