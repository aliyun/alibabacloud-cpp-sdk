...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMcubeNebulaAppResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMcubeNebulaAppResponseBody) };
    inline DeleteMcubeNebulaAppResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMcubeNebulaAppResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMcubeNebulaAppResponseBody> body_ {};
  };
