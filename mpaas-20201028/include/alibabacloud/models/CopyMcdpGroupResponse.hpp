...
namespace Models
{
  ...
  public:
    ...
    inline const CopyMcdpGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CopyMcdpGroupResponseBody) };
    inline CopyMcdpGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CopyMcdpGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CopyMcdpGroupResponseBody> body_ {};
  };
