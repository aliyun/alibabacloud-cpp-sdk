...
namespace Models
{
  ...
  public:
    ...
    inline const QueryPushAnalysisTaskListResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, QueryPushAnalysisTaskListResponseBodyResultContent) };
    inline QueryPushAnalysisTaskListResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, QueryPushAnalysisTaskListResponseBodyResultContent) };
    inline QueryPushAnalysisTaskListResponseBody& setResultContent(const QueryPushAnalysisTaskListResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline QueryPushAnalysisTaskListResponseBody& setResultContent(QueryPushAnalysisTaskListResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<QueryPushAnalysisTaskListResponseBodyResultContent> resultContent_ = nullptr;
