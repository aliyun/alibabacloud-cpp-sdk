...
namespace Models
{
  ...
  public:
    ...
    inline const ListTemplatePageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTemplatePageResponseBody) };
    inline ListTemplatePageResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTemplatePageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTemplatePageResponseBody> body_ {};
  };
