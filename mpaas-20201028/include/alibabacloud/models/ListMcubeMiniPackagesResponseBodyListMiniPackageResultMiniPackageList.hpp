...
#ifndef ALIBABACLOUD_MODELS_LISTMCUBEMINIPACKAGESRESPONSEBODYLISTMINIPACKAGERESULTMINIPACKAGELIST_HPP_
#define ALIBABACLOUD_MODELS_LISTMCUBEMINIPACKAGESRESPONSEBODYLISTMINIPACKAGERESULTMINIPACKAGELIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& obj) { 
    ...
    ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList() = default ;
    ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList(const ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList &) = default ;
    ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList(ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList &&) = default ;
    ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList() = default ;
    ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& operator=(const ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList &) = default ;
    ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& operator=(ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList &&) = default ;
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setAppCode(string appCode) { DARABONBA_PTR_SET_VALUE(appCode_, appCode) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setAutoInstall(int64_t autoInstall) { DARABONBA_PTR_SET_VALUE(autoInstall_, autoInstall) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setClientVersionMax(string clientVersionMax) { DARABONBA_PTR_SET_VALUE(clientVersionMax_, clientVersionMax) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setClientVersionMin(string clientVersionMin) { DARABONBA_PTR_SET_VALUE(clientVersionMin_, clientVersionMin) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setDownloadUrl(string downloadUrl) { DARABONBA_PTR_SET_VALUE(downloadUrl_, downloadUrl) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setExtendInfo(string extendInfo) { DARABONBA_PTR_SET_VALUE(extendInfo_, extendInfo) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setExtraData(string extraData) { DARABONBA_PTR_SET_VALUE(extraData_, extraData) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setFallbackBaseUrl(string fallbackBaseUrl) { DARABONBA_PTR_SET_VALUE(fallbackBaseUrl_, fallbackBaseUrl) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setH5Id(string h5Id) { DARABONBA_PTR_SET_VALUE(h5Id_, h5Id) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setH5Name(string h5Name) { DARABONBA_PTR_SET_VALUE(h5Name_, h5Name) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setH5Version(string h5Version) { DARABONBA_PTR_SET_VALUE(h5Version_, h5Version) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setInstallType(int64_t installType) { DARABONBA_PTR_SET_VALUE(installType_, installType) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setMainUrl(string mainUrl) { DARABONBA_PTR_SET_VALUE(mainUrl_, mainUrl) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setMemo(string memo) { DARABONBA_PTR_SET_VALUE(memo_, memo) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setPackageType(int64_t packageType) { DARABONBA_PTR_SET_VALUE(packageType_, packageType) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setPlatform(string platform) { DARABONBA_PTR_SET_VALUE(platform_, platform) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setPublishPeriod(int64_t publishPeriod) { DARABONBA_PTR_SET_VALUE(publishPeriod_, publishPeriod) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setResourceType(int64_t resourceType) { DARABONBA_PTR_SET_VALUE(resourceType_, resourceType) };
    ...
    inline ListMcubeMiniPackagesResponseBodyListMiniPackageResultMiniPackageList& setStatus(int64_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
