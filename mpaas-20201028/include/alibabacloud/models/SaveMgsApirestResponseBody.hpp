...
namespace Models
{
  ...
  public:
    ...
    inline const SaveMgsApirestResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, SaveMgsApirestResponseBodyResultContent) };
    inline SaveMgsApirestResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, SaveMgsApirestResponseBodyResultContent) };
    inline SaveMgsApirestResponseBody& setResultContent(const SaveMgsApirestResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline SaveMgsApirestResponseBody& setResultContent(SaveMgsApirestResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<SaveMgsApirestResponseBodyResultContent> resultContent_ = nullptr;
