...
#ifndef ALIBABACLOUD_MODELS_GETUSERAPPENHANCEPROCESSINMSARESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETUSERAPPENHANCEPROCESSINMSARESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetUserAppEnhanceProcessInMsaResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(ResultCode, resultCode_);
      DARABONBA_PTR_TO_JSON(ResultContent, resultContent_);
      DARABONBA_PTR_TO_JSON(ResultMessage, resultMessage_);
    };
    friend void from_json(const Darabonba::Json& j, GetUserAppEnhanceProcessInMsaResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(ResultCode, resultCode_);
      DARABONBA_PTR_FROM_JSON(ResultContent, resultContent_);
      DARABONBA_PTR_FROM_JSON(ResultMessage, resultMessage_);
    };
    GetUserAppEnhanceProcessInMsaResponseBody() = default ;
    GetUserAppEnhanceProcessInMsaResponseBody(const GetUserAppEnhanceProcessInMsaResponseBody &) = default ;
    GetUserAppEnhanceProcessInMsaResponseBody(GetUserAppEnhanceProcessInMsaResponseBody &&) = default ;
    GetUserAppEnhanceProcessInMsaResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetUserAppEnhanceProcessInMsaResponseBody() = default ;
    GetUserAppEnhanceProcessInMsaResponseBody& operator=(const GetUserAppEnhanceProcessInMsaResponseBody &) = default ;
    GetUserAppEnhanceProcessInMsaResponseBody& operator=(GetUserAppEnhanceProcessInMsaResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline Data& setAfterMd5(string afterMd5) { DARABONBA_PTR_SET_VALUE(afterMd5_, afterMd5) };
        ...
        inline Data& setAfterSize(int64_t afterSize) { DARABONBA_PTR_SET_VALUE(afterSize_, afterSize) };
        ...
        inline Data& setAppCode(string appCode) { DARABONBA_PTR_SET_VALUE(appCode_, appCode) };
        ...
        inline Data& setAppPackage(string appPackage) { DARABONBA_PTR_SET_VALUE(appPackage_, appPackage) };
        ...
        inline const vector<string> & getAssetsFileList() const { DARABONBA_PTR_GET_CONST(assetsFileList_, vector<string>) };
        inline vector<string> getAssetsFileList() { DARABONBA_PTR_GET(assetsFileList_, vector<string>) };
        inline Data& setAssetsFileList(const vector<string> & assetsFileList) { DARABONBA_PTR_SET_VALUE(assetsFileList_, assetsFileList) };
        inline Data& setAssetsFileList(vector<string> && assetsFileList) { DARABONBA_PTR_SET_RVALUE(assetsFileList_, assetsFileList) };
        ...
        inline Data& setBeforeMd5(string beforeMd5) { DARABONBA_PTR_SET_VALUE(beforeMd5_, beforeMd5) };
        ...
        inline Data& setBeforeSize(int64_t beforeSize) { DARABONBA_PTR_SET_VALUE(beforeSize_, beforeSize) };
        ...
        inline Data& setClassForest(string classForest) { DARABONBA_PTR_SET_VALUE(classForest_, classForest) };
        ...
        inline const vector<Data::EnhanceMapping> & getEnhanceMapping() const { DARABONBA_PTR_GET_CONST(enhanceMapping_, vector<Data::EnhanceMapping>) };
        inline vector<Data::EnhanceMapping> getEnhanceMapping() { DARABONBA_PTR_GET(enhanceMapping_, vector<Data::EnhanceMapping>) };
        inline Data& setEnhanceMapping(const vector<Data::EnhanceMapping> & enhanceMapping) { DARABONBA_PTR_SET_VALUE(enhanceMapping_, enhanceMapping) };
        inline Data& setEnhanceMapping(vector<Data::EnhanceMapping> && enhanceMapping) { DARABONBA_PTR_SET_RVALUE(enhanceMapping_, enhanceMapping) };
        ...
        inline Data& setEnhanceRules(const vector<string> & enhanceRules) { DARABONBA_PTR_SET_VALUE(enhanceRules_, enhanceRules) };
        inline Data& setEnhanceRules(vector<string> && enhanceRules) { DARABONBA_PTR_SET_RVALUE(enhanceRules_, enhanceRules) };
        ...
        inline const vector<string> & getEnhancedAssetsFiles() const { DARABONBA_PTR_GET_CONST(enhancedAssetsFiles_, vector<string>) };
        inline vector<string> getEnhancedAssetsFiles() { DARABONBA_PTR_GET(enhancedAssetsFiles_, vector<string>) };
        inline Data& setEnhancedAssetsFiles(const vector<string> & enhancedAssetsFiles) { DARABONBA_PTR_SET_VALUE(enhancedAssetsFiles_, enhancedAssetsFiles) };
        inline Data& setEnhancedAssetsFiles(vector<string> && enhancedAssetsFiles) { DARABONBA_PTR_SET_RVALUE(enhancedAssetsFiles_, enhancedAssetsFiles) };
        ...
        inline Data& setEnhancedClasses(const vector<string> & enhancedClasses) { DARABONBA_PTR_SET_VALUE(enhancedClasses_, enhancedClasses) };
        inline Data& setEnhancedClasses(vector<string> && enhancedClasses) { DARABONBA_PTR_SET_RVALUE(enhancedClasses_, enhancedClasses) };
        ...
        inline const vector<string> & getEnhancedSoFiles() const { DARABONBA_PTR_GET_CONST(enhancedSoFiles_, vector<string>) };
        inline vector<string> getEnhancedSoFiles() { DARABONBA_PTR_GET(enhancedSoFiles_, vector<string>) };
        inline Data& setEnhancedSoFiles(const vector<string> & enhancedSoFiles) { DARABONBA_PTR_SET_VALUE(enhancedSoFiles_, enhancedSoFiles) };
        inline Data& setEnhancedSoFiles(vector<string> && enhancedSoFiles) { DARABONBA_PTR_SET_RVALUE(enhancedSoFiles_, enhancedSoFiles) };
        ...
        inline const vector<string> & getSoFileList() const { DARABONBA_PTR_GET_CONST(soFileList_, vector<string>) };
        inline vector<string> getSoFileList() { DARABONBA_PTR_GET(soFileList_, vector<string>) };
        inline Data& setSoFileList(const vector<string> & soFileList) { DARABONBA_PTR_SET_VALUE(soFileList_, soFileList) };
        inline Data& setSoFileList(vector<string> && soFileList) { DARABONBA_PTR_SET_RVALUE(soFileList_, soFileList) };
      ...
      protected:
        ...
        shared_ptr<vector<string>> assetsFileList_ {};
        shared_ptr<string> beforeMd5_ {};
        shared_ptr<int64_t> beforeSize_ {};
        shared_ptr<string> classForest_ {};
        shared_ptr<vector<Data::EnhanceMapping>> enhanceMapping_ {};
        shared_ptr<vector<string>> enhanceRules_ {};
        shared_ptr<vector<string>> enhancedAssetsFiles_ {};
        shared_ptr<vector<string>> enhancedClasses_ {};
        shared_ptr<vector<string>> enhancedSoFiles_ {};
        shared_ptr<int64_t> id_ {};
        shared_ptr<string> label_ {};
        shared_ptr<int64_t> progress_ {};
        shared_ptr<vector<string>> soFileList_ {};
    ...
    inline GetUserAppEnhanceProcessInMsaResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetUserAppEnhanceProcessInMsaResponseBody& setResultCode(string resultCode) { DARABONBA_PTR_SET_VALUE(resultCode_, resultCode) };
    ...
    inline const GetUserAppEnhanceProcessInMsaResponseBody::ResultContent & getResultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, GetUserAppEnhanceProcessInMsaResponseBody::ResultContent) };
    inline GetUserAppEnhanceProcessInMsaResponseBody::ResultContent getResultContent() { DARABONBA_PTR_GET(resultContent_, GetUserAppEnhanceProcessInMsaResponseBody::ResultContent) };
    inline GetUserAppEnhanceProcessInMsaResponseBody& setResultContent(const GetUserAppEnhanceProcessInMsaResponseBody::ResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline GetUserAppEnhanceProcessInMsaResponseBody& setResultContent(GetUserAppEnhanceProcessInMsaResponseBody::ResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
    ...
    inline GetUserAppEnhanceProcessInMsaResponseBody& setResultMessage(string resultMessage) { DARABONBA_PTR_SET_VALUE(resultMessage_, resultMessage) };


  protected:
    shared_ptr<string> requestId_ {};
    shared_ptr<string> resultCode_ {};
    shared_ptr<GetUserAppEnhanceProcessInMsaResponseBody::ResultContent> resultContent_ {};
