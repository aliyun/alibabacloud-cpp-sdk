...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->mpaasMappcenterMcdpGroupCreateJsonStr_ == nullptr && this->tenantId_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline string getMpaasMappcenterMcdpGroupCreateJsonStr() const { DARABONBA_PTR_GET_DEFAULT(mpaasMappcenterMcdpGroupCreateJsonStr_, "") };
  ...
  protected:
    ...
    shared_ptr<string> mpaasMappcenterMcdpGroupCreateJsonStr_ {};
