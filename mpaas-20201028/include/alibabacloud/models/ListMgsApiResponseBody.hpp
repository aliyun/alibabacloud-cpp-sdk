...
#ifndef ALIBABACLOUD_MODELS_LISTMGSAPIRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTMGSAPIRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListMgsApiResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(ResultCode, resultCode_);
      DARABONBA_PTR_TO_JSON(ResultContent, resultContent_);
      DARABONBA_PTR_TO_JSON(ResultMessage, resultMessage_);
    };
    friend void from_json(const Darabonba::Json& j, ListMgsApiResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(ResultCode, resultCode_);
      DARABONBA_PTR_FROM_JSON(ResultContent, resultContent_);
      DARABONBA_PTR_FROM_JSON(ResultMessage, resultMessage_);
    };
    ListMgsApiResponseBody() = default ;
    ListMgsApiResponseBody(const ListMgsApiResponseBody &) = default ;
    ListMgsApiResponseBody(ListMgsApiResponseBody &&) = default ;
    ListMgsApiResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListMgsApiResponseBody() = default ;
    ListMgsApiResponseBody& operator=(const ListMgsApiResponseBody &) = default ;
    ListMgsApiResponseBody& operator=(ListMgsApiResponseBody &&) = default ;
    ...
    public:
      ...
      bool hasValue() const { return this->value_ != nullptr;};
      void deleteValue() { this->value_ = nullptr;};
      inline const vector<ResultContent::Value> & getValue() const { DARABONBA_PTR_GET_CONST(value_, vector<ResultContent::Value>) };
      inline vector<ResultContent::Value> getValue() { DARABONBA_PTR_GET(value_, vector<ResultContent::Value>) };
      inline ResultContent& setValue(const vector<ResultContent::Value> & value) { DARABONBA_PTR_SET_VALUE(value_, value) };
      inline ResultContent& setValue(vector<ResultContent::Value> && value) { DARABONBA_PTR_SET_RVALUE(value_, value) };


    protected:
      shared_ptr<string> errorMessage_ {};
      shared_ptr<bool> success_ {};
      shared_ptr<vector<ResultContent::Value>> value_ {};
    };
    ...
    inline ListMgsApiResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListMgsApiResponseBody& setResultCode(string resultCode) { DARABONBA_PTR_SET_VALUE(resultCode_, resultCode) };
    ...
    inline const ListMgsApiResponseBody::ResultContent & getResultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, ListMgsApiResponseBody::ResultContent) };
    inline ListMgsApiResponseBody::ResultContent getResultContent() { DARABONBA_PTR_GET(resultContent_, ListMgsApiResponseBody::ResultContent) };
    inline ListMgsApiResponseBody& setResultContent(const ListMgsApiResponseBody::ResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline ListMgsApiResponseBody& setResultContent(ListMgsApiResponseBody::ResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
    ...
    inline ListMgsApiResponseBody& setResultMessage(string resultMessage) { DARABONBA_PTR_SET_VALUE(resultMessage_, resultMessage) };


  protected:
    shared_ptr<string> requestId_ {};
    shared_ptr<string> resultCode_ {};
    shared_ptr<ListMgsApiResponseBody::ResultContent> resultContent_ {};
