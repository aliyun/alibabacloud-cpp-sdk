...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMcubeUpgradePackageResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, CreateMcubeUpgradePackageResponseBodyResultContent) };
    inline CreateMcubeUpgradePackageResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, CreateMcubeUpgradePackageResponseBodyResultContent) };
    inline CreateMcubeUpgradePackageResponseBody& setResultContent(const CreateMcubeUpgradePackageResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline CreateMcubeUpgradePackageResponseBody& setResultContent(CreateMcubeUpgradePackageResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<CreateMcubeUpgradePackageResponseBodyResultContent> resultContent_ = nullptr;
