...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMcubeUpgradePackageResponseBody::ResultContent & getResultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, CreateMcubeUpgradePackageResponseBody::ResultContent) };
    inline CreateMcubeUpgradePackageResponseBody::ResultContent getResultContent() { DARABONBA_PTR_GET(resultContent_, CreateMcubeUpgradePackageResponseBody::ResultContent) };
    inline CreateMcubeUpgradePackageResponseBody& setResultContent(const CreateMcubeUpgradePackageResponseBody::ResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline CreateMcubeUpgradePackageResponseBody& setResultContent(CreateMcubeUpgradePackageResponseBody::ResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    shared_ptr<CreateMcubeUpgradePackageResponseBody::ResultContent> resultContent_ {};
