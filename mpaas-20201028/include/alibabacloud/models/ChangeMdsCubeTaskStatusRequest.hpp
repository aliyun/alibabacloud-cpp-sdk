...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->taskStatus_ == nullptr && this->templateResourceId_ == nullptr && this->templateTaskId_ == nullptr && this->tenantId_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline int64_t getTemplateTaskId() const { DARABONBA_PTR_GET_DEFAULT(templateTaskId_, 0L) };
  ...
  protected:
    ...
    shared_ptr<int64_t> templateTaskId_ {};
