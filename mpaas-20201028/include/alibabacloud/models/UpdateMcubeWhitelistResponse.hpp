...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMcubeWhitelistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateMcubeWhitelistResponseBody) };
    inline UpdateMcubeWhitelistResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateMcubeWhitelistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateMcubeWhitelistResponseBody> body_ {};
  };
