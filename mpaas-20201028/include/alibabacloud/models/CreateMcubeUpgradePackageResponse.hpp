...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMcubeUpgradePackageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMcubeUpgradePackageResponseBody) };
    inline CreateMcubeUpgradePackageResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMcubeUpgradePackageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMcubeUpgradePackageResponseBody> body_ {};
  };
