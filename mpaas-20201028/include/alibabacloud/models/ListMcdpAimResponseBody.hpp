...
namespace Models
{
  ...
  public:
    ...
    inline const ListMcdpAimResponseBody::ResultContent & getResultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, ListMcdpAimResponseBody::ResultContent) };
    inline ListMcdpAimResponseBody::ResultContent getResultContent() { DARABONBA_PTR_GET(resultContent_, ListMcdpAimResponseBody::ResultContent) };
    inline ListMcdpAimResponseBody& setResultContent(const ListMcdpAimResponseBody::ResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline ListMcdpAimResponseBody& setResultContent(ListMcdpAimResponseBody::ResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    shared_ptr<ListMcdpAimResponseBody::ResultContent> resultContent_ {};
