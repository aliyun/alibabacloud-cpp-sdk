...
#include <alibabacloud/models/QueryCubecardFiletokenResponseBodyResultContent.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCubecardFiletokenResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, QueryCubecardFiletokenResponseBodyResultContent) };
    inline QueryCubecardFiletokenResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, QueryCubecardFiletokenResponseBodyResultContent) };
    inline QueryCubecardFiletokenResponseBody& setResultContent(const QueryCubecardFiletokenResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline QueryCubecardFiletokenResponseBody& setResultContent(QueryCubecardFiletokenResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<QueryCubecardFiletokenResponseBodyResultContent> resultContent_ = nullptr;
