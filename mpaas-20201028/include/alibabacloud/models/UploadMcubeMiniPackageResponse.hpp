...
namespace Models
{
  ...
  public:
    ...
    inline const UploadMcubeMiniPackageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UploadMcubeMiniPackageResponseBody) };
    inline UploadMcubeMiniPackageResponseBody getBody() { DARABONBA_PTR_GET(body_, UploadMcubeMiniPackageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UploadMcubeMiniPackageResponseBody> body_ {};
  };
