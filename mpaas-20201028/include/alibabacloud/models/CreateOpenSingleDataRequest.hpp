...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->appMaxVersion_ == nullptr && this->appMinVersion_ == nullptr && this->bizType_ == nullptr && this->checkOnline_ == nullptr && this->extAttrStr_ == nullptr
        && this->linkToken_ == nullptr && this->osType_ == nullptr && this->payload_ == nullptr && this->tenantId_ == nullptr && this->thirdMsgId_ == nullptr
        && this->validTimeEnd_ == nullptr && this->validTimeStart_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline string getAppMaxVersion() const { DARABONBA_PTR_GET_DEFAULT(appMaxVersion_, "") };
    ...
    inline string getAppMinVersion() const { DARABONBA_PTR_GET_DEFAULT(appMinVersion_, "") };
    ...
    inline bool getCheckOnline() const { DARABONBA_PTR_GET_DEFAULT(checkOnline_, false) };
    ...
    inline string getExtAttrStr() const { DARABONBA_PTR_GET_DEFAULT(extAttrStr_, "") };
    ...
    inline string getLinkToken() const { DARABONBA_PTR_GET_DEFAULT(linkToken_, "") };
    ...
    inline string getThirdMsgId() const { DARABONBA_PTR_GET_DEFAULT(thirdMsgId_, "") };
    ...
    inline int64_t getValidTimeEnd() const { DARABONBA_PTR_GET_DEFAULT(validTimeEnd_, 0L) };
    ...
    inline int64_t getValidTimeStart() const { DARABONBA_PTR_GET_DEFAULT(validTimeStart_, 0L) };
  ...
  protected:
    ...
    shared_ptr<string> appMaxVersion_ {};
    shared_ptr<string> appMinVersion_ {};
    // This parameter is required.
    shared_ptr<string> bizType_ {};
    shared_ptr<bool> checkOnline_ {};
    shared_ptr<string> extAttrStr_ {};
    // This parameter is required.
    shared_ptr<string> linkToken_ {};
    shared_ptr<string> osType_ {};
    // This parameter is required.
    shared_ptr<string> payload_ {};
    shared_ptr<string> tenantId_ {};
    // This parameter is required.
    shared_ptr<string> thirdMsgId_ {};
    shared_ptr<int64_t> validTimeEnd_ {};
    shared_ptr<int64_t> validTimeStart_ {};
    // This parameter is required.
