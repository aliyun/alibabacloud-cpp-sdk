...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMdsCubeTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMdsCubeTaskResponseBody) };
    inline CreateMdsCubeTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMdsCubeTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMdsCubeTaskResponseBody> body_ {};
  };
