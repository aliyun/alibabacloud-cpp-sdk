  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->internetEndpoint_ == nullptr
        && this->localName_ == nullptr && this->regionId_ == nullptr && this->vpcEndpoint_ == nullptr; };
      ...
      inline Regions& setInternetEndpoint(string internetEndpoint) { DARABONBA_PTR_SET_VALUE(internetEndpoint_, internetEndpoint) };
      ...
      inline Regions& setVpcEndpoint(string vpcEndpoint) { DARABONBA_PTR_SET_VALUE(vpcEndpoint_, vpcEndpoint) };
    ...
    virtual bool empty() const override { return this->maxResults_ == nullptr
        && this->nextToken_ == nullptr && this->regions_ == nullptr && this->requestId_ == nullptr; };
    // maxResults Field Functions 
    bool hasMaxResults() const { return this->maxResults_ != nullptr;};
    void deleteMaxResults() { this->maxResults_ = nullptr;};
    inline int32_t getMaxResults() const { DARABONBA_PTR_GET_DEFAULT(maxResults_, 0) };
    inline DescribeRegionsResponseBody& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline DescribeRegionsResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
