...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDatasetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDatasetResponseBody) };
    inline DeleteDatasetResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDatasetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDatasetResponseBody> body_ {};
  };
