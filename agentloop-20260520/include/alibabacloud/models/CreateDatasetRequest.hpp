...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->datasetName_ == nullptr
        && this->description_ == nullptr && this->schema_ == nullptr && this->clientToken_ == nullptr; };
    ...
    inline CreateDatasetRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
