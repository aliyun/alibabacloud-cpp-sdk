...
namespace Models
{
  ...
  public:
    ...
    inline const ListPipelinesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPipelinesResponseBody) };
    inline ListPipelinesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPipelinesResponseBody) };
    inline ListPipelinesResponse& setBody(const ListPipelinesResponseBody & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline ListPipelinesResponse& setBody(ListPipelinesResponseBody && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<map<string, string>> headers_ {};
    shared_ptr<int32_t> statusCode_ {};
    shared_ptr<ListPipelinesResponseBody> body_ {};
  };
