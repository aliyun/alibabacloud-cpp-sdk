...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateAgentSpaceRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(trajectoryStoreEnabled, trajectoryStoreEnabled_);
    ...
    friend void from_json(const Darabonba::Json& j, CreateAgentSpaceRequest& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(trajectoryStoreEnabled, trajectoryStoreEnabled_);
    ...
    virtual bool empty() const override { return this->agentSpace_ == nullptr
        && this->cmsWorkspace_ == nullptr && this->description_ == nullptr && this->mseNamespaceId_ == nullptr && this->trajectoryStoreEnabled_ == nullptr && this->clientToken_ == nullptr; };
    ...
    inline CreateAgentSpaceRequest& setMseNamespaceId(string mseNamespaceId) { DARABONBA_PTR_SET_VALUE(mseNamespaceId_, mseNamespaceId) };


    // trajectoryStoreEnabled Field Functions 
    bool hasTrajectoryStoreEnabled() const { return this->trajectoryStoreEnabled_ != nullptr;};
    void deleteTrajectoryStoreEnabled() { this->trajectoryStoreEnabled_ = nullptr;};
    inline bool getTrajectoryStoreEnabled() const { DARABONBA_PTR_GET_DEFAULT(trajectoryStoreEnabled_, false) };
    inline CreateAgentSpaceRequest& setTrajectoryStoreEnabled(bool trajectoryStoreEnabled) { DARABONBA_PTR_SET_VALUE(trajectoryStoreEnabled_, trajectoryStoreEnabled) };
  ...
  protected:
    ...
    // Specifies whether to enable trajectory cleaning.
    shared_ptr<bool> trajectoryStoreEnabled_ {};
