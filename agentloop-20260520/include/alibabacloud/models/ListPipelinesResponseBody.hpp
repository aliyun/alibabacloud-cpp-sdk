  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->createTime_ == nullptr
        ...
        && this->scheduleType_ == nullptr && this->sink_ == nullptr && this->source_ == nullptr && this->updateTime_ == nullptr && this->workspace_ == nullptr; };
      ...
      bool hasSink() const { return this->sink_ != nullptr;};
      void deleteSink() { this->sink_ = nullptr;};
      inline const Pipelines::Sink & getSink() const { DARABONBA_PTR_GET_CONST(sink_, Pipelines::Sink) };
      inline Pipelines::Sink getSink() { DARABONBA_PTR_GET(sink_, Pipelines::Sink) };
      inline Pipelines& setSink(const Pipelines::Sink & sink) { DARABONBA_PTR_SET_VALUE(sink_, sink) };
      inline Pipelines& setSink(Pipelines::Sink && sink) { DARABONBA_PTR_SET_RVALUE(sink_, sink) };
