...
namespace Models
{
  ...
  public:
    ...
    inline GetPipelineResponseBody& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline GetPipelineResponseBody& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline const GetPipelineResponseBody::ExecutePolicy & getExecutePolicy() const { DARABONBA_PTR_GET_CONST(executePolicy_, GetPipelineResponseBody::ExecutePolicy) };
    ...
    inline GetPipelineResponseBody& setPipelineName(string pipelineName) { DARABONBA_PTR_SET_VALUE(pipelineName_, pipelineName) };
    ...
    inline GetPipelineResponseBody& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline const GetPipelineResponseBody::Sink & getSink() const { DARABONBA_PTR_GET_CONST(sink_, GetPipelineResponseBody::Sink) };
    inline GetPipelineResponseBody::Sink getSink() { DARABONBA_PTR_GET(sink_, GetPipelineResponseBody::Sink) };
    inline GetPipelineResponseBody& setSink(const GetPipelineResponseBody::Sink & sink) { DARABONBA_PTR_SET_VALUE(sink_, sink) };
    inline GetPipelineResponseBody& setSink(GetPipelineResponseBody::Sink && sink) { DARABONBA_PTR_SET_RVALUE(sink_, sink) };


    // source Field Functions 
    bool hasSource() const { return this->source_ != nullptr;};
    void deleteSource() { this->source_ = nullptr;};
    inline const GetPipelineResponseBody::Source & getSource() const { DARABONBA_PTR_GET_CONST(source_, GetPipelineResponseBody::Source) };
    inline GetPipelineResponseBody::Source getSource() { DARABONBA_PTR_GET(source_, GetPipelineResponseBody::Source) };
    inline GetPipelineResponseBody& setSource(const GetPipelineResponseBody::Source & source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    inline GetPipelineResponseBody& setSource(GetPipelineResponseBody::Source && source) { DARABONBA_PTR_SET_RVALUE(source_, source) };
    ...
    inline GetPipelineResponseBody& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
    ...
    inline GetPipelineResponseBody& setWorkspace(string workspace) { DARABONBA_PTR_SET_VALUE(workspace_, workspace) };
