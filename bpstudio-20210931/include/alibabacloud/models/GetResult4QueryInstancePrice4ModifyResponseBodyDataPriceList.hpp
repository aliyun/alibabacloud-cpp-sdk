...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->discountAmount_ == nullptr
        && return this->error_ == nullptr && return this->nodeType_ == nullptr && return this->originalAmount_ == nullptr && return this->priceUnit_ == nullptr && return this->promotionName_ == nullptr
        && return this->tradeAmount_ == nullptr; };
