...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->areaId_ == nullptr
        && return this->clientToken_ == nullptr && return this->configurationShrink_ == nullptr && return this->createAsync_ == nullptr && return this->instancesShrink_ == nullptr && return this->name_ == nullptr
        && return this->processVariablesShrink_ == nullptr && return this->resourceGroupId_ == nullptr && return this->templateId_ == nullptr && return this->variablesShrink_ == nullptr; };
