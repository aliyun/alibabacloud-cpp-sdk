...
namespace Models
{
  ...
  public:
    ...
    inline const GetTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTaskResponseBodyData) };
    inline GetTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTaskResponseBodyData) };
    inline GetTaskResponseBody& setData(const GetTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTaskResponseBody& setData(GetTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetTaskResponseBodyData> data_ = nullptr;
