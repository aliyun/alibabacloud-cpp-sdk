...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->discountAmount_ != nullptr
        && this->error_ != nullptr && this->nodeType_ != nullptr && this->originalPrice_ != nullptr && this->priceUnit_ != nullptr && this->promotionName_ != nullptr
        && this->resourceId_ != nullptr && this->tradePrice_ != nullptr && this->type_ != nullptr; };
