...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->lifecycle_ != nullptr
        && this->region_ != nullptr && this->remark_ != nullptr && this->resourceCode_ != nullptr && this->resourceName_ != nullptr && this->result_ != nullptr
