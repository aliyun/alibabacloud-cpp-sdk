...
namespace Models
{
  ...
  public:
    ...
    inline const GetApplicationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetApplicationResponseBodyData) };
    inline GetApplicationResponseBodyData data() { DARABONBA_PTR_GET(data_, GetApplicationResponseBodyData) };
    inline GetApplicationResponseBody& setData(const GetApplicationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetApplicationResponseBody& setData(GetApplicationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetApplicationResponseBodyData> data_ = nullptr;
