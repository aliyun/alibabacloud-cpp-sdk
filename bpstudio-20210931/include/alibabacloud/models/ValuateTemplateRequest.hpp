...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->areaId_ == nullptr
        && return this->clientToken_ == nullptr && return this->instances_ == nullptr && return this->resourceGroupId_ == nullptr && return this->templateId_ == nullptr && return this->variables_ == nullptr; };
