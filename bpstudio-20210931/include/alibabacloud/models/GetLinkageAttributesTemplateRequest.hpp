...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->areaId_ == nullptr
        && return this->instances_ == nullptr && return this->maxResults_ == nullptr && return this->nextToken_ == nullptr && return this->targetVariable_ == nullptr && return this->templateId_ == nullptr
