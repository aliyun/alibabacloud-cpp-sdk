...
namespace Models
{
  ...
  public:
    ...
    inline DeployApplicationResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DeployApplicationResponseBody& setData(int64_t data) { DARABONBA_PTR_SET_VALUE(data_, data) };
