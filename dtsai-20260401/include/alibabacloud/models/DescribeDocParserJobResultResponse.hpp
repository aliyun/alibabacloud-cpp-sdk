...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDocParserJobResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDocParserJobResultResponseBody) };
    inline DescribeDocParserJobResultResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDocParserJobResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDocParserJobResultResponseBody> body_ {};
  };
