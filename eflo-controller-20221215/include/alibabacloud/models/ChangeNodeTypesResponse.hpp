...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeNodeTypesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ChangeNodeTypesResponseBody) };
    inline ChangeNodeTypesResponseBody getBody() { DARABONBA_PTR_GET(body_, ChangeNodeTypesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ChangeNodeTypesResponseBody> body_ {};
  };
