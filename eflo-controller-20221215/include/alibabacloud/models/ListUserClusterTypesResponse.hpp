...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserClusterTypesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUserClusterTypesResponseBody) };
    inline ListUserClusterTypesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUserClusterTypesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUserClusterTypesResponseBody> body_ {};
  };
