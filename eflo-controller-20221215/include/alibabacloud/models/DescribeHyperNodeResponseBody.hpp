...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterId_ == nullptr
        ...
        && return this->nodes_ == nullptr && return this->operatingState_ == nullptr && return this->requestId_ == nullptr && return this->resourceGroupId_ == nullptr && return this->status_ == nullptr
    ...
    inline const vector<DescribeHyperNodeResponseBodyNodes> & nodes() const { DARABONBA_PTR_GET_CONST(nodes_, vector<DescribeHyperNodeResponseBodyNodes>) };
    inline vector<DescribeHyperNodeResponseBodyNodes> nodes() { DARABONBA_PTR_GET(nodes_, vector<DescribeHyperNodeResponseBodyNodes>) };
    inline DescribeHyperNodeResponseBody& setNodes(const vector<DescribeHyperNodeResponseBodyNodes> & nodes) { DARABONBA_PTR_SET_VALUE(nodes_, nodes) };
    inline DescribeHyperNodeResponseBody& setNodes(vector<DescribeHyperNodeResponseBodyNodes> && nodes) { DARABONBA_PTR_SET_RVALUE(nodes_, nodes) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeHyperNodeResponseBodyNodes>> nodes_ = nullptr;
