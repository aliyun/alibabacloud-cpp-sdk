...
namespace Models
{
  ...
  public:
    ...
    inline CreateClusterRequestNodeGroupsHyperNodesDataDisk& setBurstingEnabled(bool burstingEnabled) { DARABONBA_PTR_SET_VALUE(burstingEnabled_, burstingEnabled) };
    ...
    inline CreateClusterRequestNodeGroupsHyperNodesDataDisk& setProvisionedIops(int64_t provisionedIops) { DARABONBA_PTR_SET_VALUE(provisionedIops_, provisionedIops) };
