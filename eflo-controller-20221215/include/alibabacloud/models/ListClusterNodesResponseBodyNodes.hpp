...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->commodityCode_ != nullptr
        ...
        && this->imageId_ != nullptr && this->imageName_ != nullptr && this->machineType_ != nullptr && this->networks_ != nullptr && this->nodeGroupId_ != nullptr
        && this->nodeGroupName_ != nullptr && this->nodeId_ != nullptr && this->operatingState_ != nullptr && this->sn_ != nullptr && this->tags_ != nullptr
        && this->taskId_ != nullptr && this->vSwitchId_ != nullptr && this->vpcId_ != nullptr && this->zoneId_ != nullptr; };
