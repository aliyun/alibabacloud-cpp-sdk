...
namespace Models
{
  ...
  public:
    ...
    inline const ListDiagnosticResultsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDiagnosticResultsResponseBody) };
    inline ListDiagnosticResultsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDiagnosticResultsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDiagnosticResultsResponseBody> body_ {};
  };
