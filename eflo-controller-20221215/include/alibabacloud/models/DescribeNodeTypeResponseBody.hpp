...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->diskQuantity_ == nullptr
        && this->eniHighDenseQuantity_ == nullptr && this->eniIpv6AddressQuantity_ == nullptr && this->eniPrivateIpAddressQuantity_ == nullptr && this->eniQuantity_ == nullptr && this->requestId_ == nullptr; };
    ...
    inline int32_t getEniHighDenseQuantity() const { DARABONBA_PTR_GET_DEFAULT(eniHighDenseQuantity_, 0) };
