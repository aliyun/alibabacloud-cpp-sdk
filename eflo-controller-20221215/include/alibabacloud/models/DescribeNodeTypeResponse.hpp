...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNodeTypeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeNodeTypeResponseBody) };
    inline DescribeNodeTypeResponseBody body() { DARABONBA_PTR_GET(body_, DescribeNodeTypeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeNodeTypeResponseBody> body_ = nullptr;
  };
