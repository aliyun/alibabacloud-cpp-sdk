...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aiJobLogInfoShrink_ == nullptr
        && this->clusterId_ == nullptr && this->diagnosticType_ == nullptr && this->nodeIdsShrink_ == nullptr; };
    ...
    inline string getAiJobLogInfoShrink() const { DARABONBA_PTR_GET_DEFAULT(aiJobLogInfoShrink_, "") };
  ...
  protected:
    // The log information.
    shared_ptr<string> aiJobLogInfoShrink_ {};
    // The cluster ID.
