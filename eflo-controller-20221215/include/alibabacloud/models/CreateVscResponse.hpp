...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVscResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateVscResponseBody) };
    inline CreateVscResponseBody body() { DARABONBA_PTR_GET(body_, CreateVscResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateVscResponseBody> body_ = nullptr;
  };
