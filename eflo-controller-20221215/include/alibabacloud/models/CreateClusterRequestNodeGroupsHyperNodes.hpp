...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataDisk_ == nullptr
        && return this->hostname_ == nullptr && return this->hyperNodeId_ == nullptr && return this->loginPassword_ == nullptr && return this->vSwitchId_ == nullptr && return this->vpcId_ == nullptr; };
