...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteNodeResponseBody) };
    inline DeleteNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteNodeResponseBody> body_ {};
  };
