...
namespace Models
{
  ...
  public:
    ...
    inline const ExtendClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExtendClusterResponseBody) };
    inline ExtendClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, ExtendClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExtendClusterResponseBody> body_ {};
  };
