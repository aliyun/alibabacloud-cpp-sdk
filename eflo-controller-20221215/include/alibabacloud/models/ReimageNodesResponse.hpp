...
namespace Models
{
  ...
  public:
    ...
    inline const ReimageNodesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReimageNodesResponseBody) };
    inline ReimageNodesResponseBody getBody() { DARABONBA_PTR_GET(body_, ReimageNodesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReimageNodesResponseBody> body_ {};
  };
