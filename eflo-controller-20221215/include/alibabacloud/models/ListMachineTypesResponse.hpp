...
namespace Models
{
  ...
  public:
    ...
    inline const ListMachineTypesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListMachineTypesResponseBody) };
    inline ListMachineTypesResponseBody body() { DARABONBA_PTR_GET(body_, ListMachineTypesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListMachineTypesResponseBody> body_ = nullptr;
  };
