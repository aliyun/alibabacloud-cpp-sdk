...
namespace Models
{
  ...
  public:
    ...
    inline string getIpAllocationPolicyShrink() const { DARABONBA_PTR_GET_DEFAULT(ipAllocationPolicyShrink_, "") };
    ...
    inline string getVpdSubnetsShrink() const { DARABONBA_PTR_GET_DEFAULT(vpdSubnetsShrink_, "") };
