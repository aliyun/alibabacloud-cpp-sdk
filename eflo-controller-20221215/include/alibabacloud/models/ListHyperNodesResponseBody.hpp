...
#include <vector>
#include <alibabacloud/models/ListHyperNodesResponseBodyHyperNodes.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHyperNodesResponseBodyHyperNodes> & hyperNodes() const { DARABONBA_PTR_GET_CONST(hyperNodes_, vector<ListHyperNodesResponseBodyHyperNodes>) };
    inline vector<ListHyperNodesResponseBodyHyperNodes> hyperNodes() { DARABONBA_PTR_GET(hyperNodes_, vector<ListHyperNodesResponseBodyHyperNodes>) };
    inline ListHyperNodesResponseBody& setHyperNodes(const vector<ListHyperNodesResponseBodyHyperNodes> & hyperNodes) { DARABONBA_PTR_SET_VALUE(hyperNodes_, hyperNodes) };
    inline ListHyperNodesResponseBody& setHyperNodes(vector<ListHyperNodesResponseBodyHyperNodes> && hyperNodes) { DARABONBA_PTR_SET_RVALUE(hyperNodes_, hyperNodes) };
  ...
  protected:
    std::shared_ptr<vector<ListHyperNodesResponseBodyHyperNodes>> hyperNodes_ = nullptr;
