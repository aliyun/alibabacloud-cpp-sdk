...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeClusterResponseBody) };
    inline DescribeClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeClusterResponseBody> body_ {};
  };
