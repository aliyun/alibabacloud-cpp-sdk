...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVscResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteVscResponseBody) };
    inline DeleteVscResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteVscResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteVscResponseBody> body_ {};
  };
