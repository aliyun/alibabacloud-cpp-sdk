...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSessionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSessionResponseBody) };
    inline CreateSessionResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSessionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSessionResponseBody> body_ {};
  };
