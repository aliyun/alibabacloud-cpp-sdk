...
namespace Models
{
  ...
  public:
    ...
    inline const CloseSessionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CloseSessionResponseBody) };
    inline CloseSessionResponseBody getBody() { DARABONBA_PTR_GET(body_, CloseSessionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CloseSessionResponseBody> body_ {};
  };
