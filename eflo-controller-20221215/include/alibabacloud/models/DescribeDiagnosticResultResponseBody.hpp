...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterId_ == nullptr
        && return this->createdTime_ == nullptr && return this->diagnosticId_ == nullptr && return this->diagnosticResults_ == nullptr && return this->diagnosticState_ == nullptr && return this->diagnosticType_ == nullptr
        && return this->endTime_ == nullptr && return this->nodeIds_ == nullptr && return this->requestId_ == nullptr; };
    ...
    inline const vector<Darabonba::Json> & diagnosticResults() const { DARABONBA_PTR_GET_CONST(diagnosticResults_, vector<Darabonba::Json>) };
    inline vector<Darabonba::Json> diagnosticResults() { DARABONBA_PTR_GET(diagnosticResults_, vector<Darabonba::Json>) };
    ...
    inline string diagnosticState() const { DARABONBA_PTR_GET_DEFAULT(diagnosticState_, "") };
  ...
  protected:
    ...
    std::shared_ptr<vector<Darabonba::Json>> diagnosticResults_ = nullptr;
    // The diagnostic status.
    std::shared_ptr<string> diagnosticState_ = nullptr;
