...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteNodeGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteNodeGroupResponseBody) };
    inline DeleteNodeGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteNodeGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteNodeGroupResponseBody> body_ {};
  };
