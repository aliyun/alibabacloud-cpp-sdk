...
namespace Models
{
  ...
  public:
    ...
    inline const ApproveOperationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ApproveOperationResponseBody) };
    inline ApproveOperationResponseBody getBody() { DARABONBA_PTR_GET(body_, ApproveOperationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ApproveOperationResponseBody> body_ {};
  };
