...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListClusterNodesResponseBodyNodes> & nodes() const { DARABONBA_PTR_GET_CONST(nodes_, vector<ListClusterNodesResponseBodyNodes>) };
    inline vector<ListClusterNodesResponseBodyNodes> nodes() { DARABONBA_PTR_GET(nodes_, vector<ListClusterNodesResponseBodyNodes>) };
    inline ListClusterNodesResponseBody& setNodes(const vector<ListClusterNodesResponseBodyNodes> & nodes) { DARABONBA_PTR_SET_VALUE(nodes_, nodes) };
    inline ListClusterNodesResponseBody& setNodes(vector<ListClusterNodesResponseBodyNodes> && nodes) { DARABONBA_PTR_SET_RVALUE(nodes_, nodes) };
  ...
  protected:
    ...
    // The nodes.
    std::shared_ptr<vector<ListClusterNodesResponseBodyNodes>> nodes_ = nullptr;
    // The request ID.
