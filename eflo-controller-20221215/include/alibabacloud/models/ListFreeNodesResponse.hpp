...
namespace Models
{
  ...
  public:
    ...
    inline const ListFreeNodesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFreeNodesResponseBody) };
    inline ListFreeNodesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFreeNodesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFreeNodesResponseBody> body_ {};
  };
