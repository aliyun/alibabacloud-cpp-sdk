...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ignoreFailedNodeTasks_ == nullptr
        && return this->nodesShrink_ == nullptr && return this->targetNodeGroupId_ == nullptr; };
    ...
    inline string targetNodeGroupId() const { DARABONBA_PTR_GET_DEFAULT(targetNodeGroupId_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> targetNodeGroupId_ = nullptr;
  };
