...
namespace Models
{
  ...
  public:
    ...
    inline const RebootNodesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RebootNodesResponseBody) };
    inline RebootNodesResponseBody getBody() { DARABONBA_PTR_GET(body_, RebootNodesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RebootNodesResponseBody> body_ {};
  };
