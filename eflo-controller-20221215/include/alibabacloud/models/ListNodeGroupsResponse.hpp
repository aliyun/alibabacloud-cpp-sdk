...
namespace Models
{
  ...
  public:
    ...
    inline const ListNodeGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNodeGroupsResponseBody) };
    inline ListNodeGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNodeGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNodeGroupsResponseBody> body_ {};
  };
