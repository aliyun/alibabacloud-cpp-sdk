...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeNodeResponseBody) };
    inline DescribeNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeNodeResponseBody> body_ {};
  };
