...
namespace Models
{
  ...
  public:
    ...
    inline string getCommTestShrink() const { DARABONBA_PTR_GET_DEFAULT(commTestShrink_, "") };
    ...
    inline string getDelayTestShrink() const { DARABONBA_PTR_GET_DEFAULT(delayTestShrink_, "") };
    ...
    inline string getTrafficTestShrink() const { DARABONBA_PTR_GET_DEFAULT(trafficTestShrink_, "") };
