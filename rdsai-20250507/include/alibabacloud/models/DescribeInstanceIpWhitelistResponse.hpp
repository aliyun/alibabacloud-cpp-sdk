...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceIpWhitelistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceIpWhitelistResponseBody) };
    inline DescribeInstanceIpWhitelistResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceIpWhitelistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceIpWhitelistResponseBody> body_ {};
  };
