...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAppInstanceAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAppInstanceAttributeResponseBody) };
    inline DescribeAppInstanceAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAppInstanceAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAppInstanceAttributeResponseBody> body_ {};
  };
