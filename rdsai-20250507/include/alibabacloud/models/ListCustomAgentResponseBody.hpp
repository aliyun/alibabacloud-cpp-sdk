...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListCustomAgentResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListCustomAgentResponseBodyData>) };
    inline vector<ListCustomAgentResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListCustomAgentResponseBodyData>) };
    inline ListCustomAgentResponseBody& setData(const vector<ListCustomAgentResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCustomAgentResponseBody& setData(vector<ListCustomAgentResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<ListCustomAgentResponseBodyData>> data_ = nullptr;
