  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->dailyTokenQuota_ == nullptr && this->keyName_ == nullptr && this->limitRate_ == nullptr && this->limitType_ == nullptr && this->tokenQuota_ == nullptr; };
      ...
      virtual bool empty() const override { return this->baseUrl_ == nullptr
        && this->customKeyList_ == nullptr && this->systemApiKey_ == nullptr; };
    ...
    inline const CreateApiKeyResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateApiKeyResponseBody::Data) };
    inline CreateApiKeyResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateApiKeyResponseBody::Data) };
    inline CreateApiKeyResponseBody& setData(const CreateApiKeyResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateApiKeyResponseBody& setData(CreateApiKeyResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
