...
namespace Models
{
  ...
  public:
    ...
    inline ModifyInstanceSSLResponseBody& setBranchName(string branchName) { DARABONBA_PTR_SET_VALUE(branchName_, branchName) };
    ...
    inline ModifyInstanceSSLResponseBody& setInstanceName(string instanceName) { DARABONBA_PTR_SET_VALUE(instanceName_, instanceName) };
