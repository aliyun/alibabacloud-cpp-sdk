...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->CAType_ == nullptr
        && return this->instanceName_ == nullptr && return this->requestId_ == nullptr && return this->SSLEnabled_ == nullptr && return this->serverCert_ == nullptr && return this->serverKey_ == nullptr; };
