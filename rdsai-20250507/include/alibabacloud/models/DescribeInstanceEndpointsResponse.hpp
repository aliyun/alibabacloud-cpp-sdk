...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceEndpointsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceEndpointsResponseBody) };
    inline DescribeInstanceEndpointsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceEndpointsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceEndpointsResponseBody> body_ {};
  };
