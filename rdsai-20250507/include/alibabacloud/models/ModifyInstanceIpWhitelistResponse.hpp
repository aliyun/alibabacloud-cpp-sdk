...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceIpWhitelistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyInstanceIpWhitelistResponseBody) };
    inline ModifyInstanceIpWhitelistResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyInstanceIpWhitelistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyInstanceIpWhitelistResponseBody> body_ {};
  };
