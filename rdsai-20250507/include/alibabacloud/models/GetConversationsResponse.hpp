...
namespace Models
{
  ...
  public:
    ...
    inline const GetConversationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetConversationsResponseBody) };
    inline GetConversationsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetConversationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetConversationsResponseBody> body_ {};
  };
