...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceAuthInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceAuthInfoResponseBody) };
    inline DescribeInstanceAuthInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceAuthInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceAuthInfoResponseBody> body_ {};
  };
