...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->createdAt_ == nullptr
        && return this->enableTools_ == nullptr && return this->id_ == nullptr && return this->name_ == nullptr && return this->systemPrompt_ == nullptr && return this->tools_ == nullptr
        && return this->updatedAt_ == nullptr; };
    // createdAt Field Functions 
    bool hasCreatedAt() const { return this->createdAt_ != nullptr;};
    void deleteCreatedAt() { this->createdAt_ = nullptr;};
    inline string createdAt() const { DARABONBA_PTR_GET_DEFAULT(createdAt_, "") };
    inline ListCustomAgentResponseBodyData& setCreatedAt(string createdAt) { DARABONBA_PTR_SET_VALUE(createdAt_, createdAt) };
    ...
    inline ListCustomAgentResponseBodyData& setEnableTools(bool enableTools) { DARABONBA_PTR_SET_VALUE(enableTools_, enableTools) };
    ...
    inline ListCustomAgentResponseBodyData& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListCustomAgentResponseBodyData& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListCustomAgentResponseBodyData& setSystemPrompt(string systemPrompt) { DARABONBA_PTR_SET_VALUE(systemPrompt_, systemPrompt) };
    ...
    inline ListCustomAgentResponseBodyData& setTools(const vector<string> & tools) { DARABONBA_PTR_SET_VALUE(tools_, tools) };
    inline ListCustomAgentResponseBodyData& setTools(vector<string> && tools) { DARABONBA_PTR_SET_RVALUE(tools_, tools) };
    ...
    inline ListCustomAgentResponseBodyData& setUpdatedAt(string updatedAt) { DARABONBA_PTR_SET_VALUE(updatedAt_, updatedAt) };
