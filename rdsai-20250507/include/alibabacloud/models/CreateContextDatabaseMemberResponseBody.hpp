...
#ifndef ALIBABACLOUD_MODELS_CREATECONTEXTDATABASEMEMBERRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATECONTEXTDATABASEMEMBERRESPONSEBODY_HPP_
...
namespace Models
{
  class CreateContextDatabaseMemberResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateContextDatabaseMemberResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(ApiKey, apiKey_);
      DARABONBA_PTR_TO_JSON(Member, member_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, CreateContextDatabaseMemberResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(ApiKey, apiKey_);
      DARABONBA_PTR_FROM_JSON(Member, member_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    CreateContextDatabaseMemberResponseBody() = default ;
    CreateContextDatabaseMemberResponseBody(const CreateContextDatabaseMemberResponseBody &) = default ;
    CreateContextDatabaseMemberResponseBody(CreateContextDatabaseMemberResponseBody &&) = default ;
    CreateContextDatabaseMemberResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateContextDatabaseMemberResponseBody() = default ;
    CreateContextDatabaseMemberResponseBody& operator=(const CreateContextDatabaseMemberResponseBody &) = default ;
    CreateContextDatabaseMemberResponseBody& operator=(CreateContextDatabaseMemberResponseBody &&) = default ;
    ...
    public:
      ...
      void deleteCreatedAt() { this->createdAt_ = nullptr;};
      inline string getCreatedAt() const { DARABONBA_PTR_GET_DEFAULT(createdAt_, "") };
      inline Member& setCreatedAt(string createdAt) { DARABONBA_PTR_SET_VALUE(createdAt_, createdAt) };


      // keys Field Functions 
      bool hasKeys() const { return this->keys_ != nullptr;};
      void deleteKeys() { this->keys_ = nullptr;};
      inline const vector<Member::Keys> & getKeys() const { DARABONBA_PTR_GET_CONST(keys_, vector<Member::Keys>) };
      inline vector<Member::Keys> getKeys() { DARABONBA_PTR_GET(keys_, vector<Member::Keys>) };
      inline Member& setKeys(const vector<Member::Keys> & keys) { DARABONBA_PTR_SET_VALUE(keys_, keys) };
      inline Member& setKeys(vector<Member::Keys> && keys) { DARABONBA_PTR_SET_RVALUE(keys_, keys) };
      ...
      inline Member& setMemberName(string memberName) { DARABONBA_PTR_SET_VALUE(memberName_, memberName) };
      ...
      void deleteStatus() { this->status_ = nullptr;};
      inline string getStatus() const { DARABONBA_PTR_GET_DEFAULT(status_, "") };
      inline Member& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };


    protected:
      shared_ptr<string> createdAt_ {};
      shared_ptr<vector<Member::Keys>> keys_ {};
    ...
    virtual bool empty() const override { return this->apiKey_ == nullptr
        && this->member_ == nullptr && this->requestId_ == nullptr; };
    // apiKey Field Functions 
    bool hasApiKey() const { return this->apiKey_ != nullptr;};
    void deleteApiKey() { this->apiKey_ = nullptr;};
    inline string getApiKey() const { DARABONBA_PTR_GET_DEFAULT(apiKey_, "") };
    inline CreateContextDatabaseMemberResponseBody& setApiKey(string apiKey) { DARABONBA_PTR_SET_VALUE(apiKey_, apiKey) };


    // member Field Functions 
    bool hasMember() const { return this->member_ != nullptr;};
    void deleteMember() { this->member_ = nullptr;};
    inline const CreateContextDatabaseMemberResponseBody::Member & getMember() const { DARABONBA_PTR_GET_CONST(member_, CreateContextDatabaseMemberResponseBody::Member) };
    inline CreateContextDatabaseMemberResponseBody::Member getMember() { DARABONBA_PTR_GET(member_, CreateContextDatabaseMemberResponseBody::Member) };
    inline CreateContextDatabaseMemberResponseBody& setMember(const CreateContextDatabaseMemberResponseBody::Member & member) { DARABONBA_PTR_SET_VALUE(member_, member) };
    inline CreateContextDatabaseMemberResponseBody& setMember(CreateContextDatabaseMemberResponseBody::Member && member) { DARABONBA_PTR_SET_RVALUE(member_, member) };
    ...
    inline CreateContextDatabaseMemberResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> apiKey_ {};
    shared_ptr<CreateContextDatabaseMemberResponseBody::Member> member_ {};
