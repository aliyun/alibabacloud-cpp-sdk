...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceRAGConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceRAGConfigResponseBody) };
    inline DescribeInstanceRAGConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceRAGConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceRAGConfigResponseBody> body_ {};
  };
