...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEMOUSAGEDETAILEXPORTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEMOUSAGEDETAILEXPORTRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeMOUsageDetailExportResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeMOUsageDetailExportResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(Message, message_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Success, success_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeMOUsageDetailExportResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(Message, message_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
    };
    DescribeMOUsageDetailExportResponseBody() = default ;
    DescribeMOUsageDetailExportResponseBody(const DescribeMOUsageDetailExportResponseBody &) = default ;
    DescribeMOUsageDetailExportResponseBody(DescribeMOUsageDetailExportResponseBody &&) = default ;
    DescribeMOUsageDetailExportResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeMOUsageDetailExportResponseBody() = default ;
    DescribeMOUsageDetailExportResponseBody& operator=(const DescribeMOUsageDetailExportResponseBody &) = default ;
    DescribeMOUsageDetailExportResponseBody& operator=(DescribeMOUsageDetailExportResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->completedAt_ == nullptr
        ...
        && this->filters_ == nullptr && this->format_ == nullptr && this->rowCount_ == nullptr && this->status_ == nullptr; };
    ...
    inline const DescribeMOUsageDetailExportResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeMOUsageDetailExportResponseBody::Data) };
    inline DescribeMOUsageDetailExportResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeMOUsageDetailExportResponseBody::Data) };
    inline DescribeMOUsageDetailExportResponseBody& setData(const DescribeMOUsageDetailExportResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeMOUsageDetailExportResponseBody& setData(DescribeMOUsageDetailExportResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeMOUsageDetailExportResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DescribeMOUsageDetailExportResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeMOUsageDetailExportResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<DescribeMOUsageDetailExportResponseBody::Data> data_ {};
