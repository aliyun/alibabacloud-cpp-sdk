...
#ifndef ALIBABACLOUD_MODELS_LISTCONTEXTDATABASEAPIKEYSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTCONTEXTDATABASEAPIKEYSRESPONSEBODY_HPP_
...
namespace Models
{
  class ListContextDatabaseApiKeysResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListContextDatabaseApiKeysResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Keys, keys_);
      DARABONBA_PTR_TO_JSON(MaxResults, maxResults_);
      DARABONBA_PTR_TO_JSON(NextToken, nextToken_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListContextDatabaseApiKeysResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Keys, keys_);
      DARABONBA_PTR_FROM_JSON(MaxResults, maxResults_);
      DARABONBA_PTR_FROM_JSON(NextToken, nextToken_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ListContextDatabaseApiKeysResponseBody() = default ;
    ListContextDatabaseApiKeysResponseBody(const ListContextDatabaseApiKeysResponseBody &) = default ;
    ListContextDatabaseApiKeysResponseBody(ListContextDatabaseApiKeysResponseBody &&) = default ;
    ListContextDatabaseApiKeysResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListContextDatabaseApiKeysResponseBody() = default ;
    ListContextDatabaseApiKeysResponseBody& operator=(const ListContextDatabaseApiKeysResponseBody &) = default ;
    ListContextDatabaseApiKeysResponseBody& operator=(ListContextDatabaseApiKeysResponseBody &&) = default ;
    ...
    inline const vector<ListContextDatabaseApiKeysResponseBody::Keys> & getKeys() const { DARABONBA_PTR_GET_CONST(keys_, vector<ListContextDatabaseApiKeysResponseBody::Keys>) };
    inline vector<ListContextDatabaseApiKeysResponseBody::Keys> getKeys() { DARABONBA_PTR_GET(keys_, vector<ListContextDatabaseApiKeysResponseBody::Keys>) };
    inline ListContextDatabaseApiKeysResponseBody& setKeys(const vector<ListContextDatabaseApiKeysResponseBody::Keys> & keys) { DARABONBA_PTR_SET_VALUE(keys_, keys) };
    inline ListContextDatabaseApiKeysResponseBody& setKeys(vector<ListContextDatabaseApiKeysResponseBody::Keys> && keys) { DARABONBA_PTR_SET_RVALUE(keys_, keys) };
    ...
    inline ListContextDatabaseApiKeysResponseBody& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline ListContextDatabaseApiKeysResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ListContextDatabaseApiKeysResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
