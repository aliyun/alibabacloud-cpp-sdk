...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeInstanceStorageConfigResponseBodyConfigList> & configList() const { DARABONBA_PTR_GET_CONST(configList_, vector<DescribeInstanceStorageConfigResponseBodyConfigList>) };
    inline vector<DescribeInstanceStorageConfigResponseBodyConfigList> configList() { DARABONBA_PTR_GET(configList_, vector<DescribeInstanceStorageConfigResponseBodyConfigList>) };
    inline DescribeInstanceStorageConfigResponseBody& setConfigList(const vector<DescribeInstanceStorageConfigResponseBodyConfigList> & configList) { DARABONBA_PTR_SET_VALUE(configList_, configList) };
    inline DescribeInstanceStorageConfigResponseBody& setConfigList(vector<DescribeInstanceStorageConfigResponseBodyConfigList> && configList) { DARABONBA_PTR_SET_RVALUE(configList_, configList) };
  ...
  protected:
    std::shared_ptr<vector<DescribeInstanceStorageConfigResponseBodyConfigList>> configList_ = nullptr;
