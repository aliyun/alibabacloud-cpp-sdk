...
namespace Models
{
  ...
  public:
    ...
    inline const ResetInstancePasswordResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ResetInstancePasswordResponseBody) };
    inline ResetInstancePasswordResponseBody body() { DARABONBA_PTR_GET(body_, ResetInstancePasswordResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ResetInstancePasswordResponseBody> body_ = nullptr;
  };
