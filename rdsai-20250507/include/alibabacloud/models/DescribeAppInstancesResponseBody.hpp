  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->appName_ == nullptr
        && this->appType_ == nullptr && this->components_ == nullptr && this->DBInstanceName_ == nullptr && this->instanceClass_ == nullptr && this->instanceMinorVersion_ == nullptr
        && this->instanceName_ == nullptr && this->publicConnectionString_ == nullptr && this->regionId_ == nullptr && this->status_ == nullptr && this->vSwitchId_ == nullptr
        && this->vpcConnectionString_ == nullptr; };
      ...
      inline const vector<Instances::Components> & getComponents() const { DARABONBA_PTR_GET_CONST(components_, vector<Instances::Components>) };
      inline vector<Instances::Components> getComponents() { DARABONBA_PTR_GET(components_, vector<Instances::Components>) };
      inline Instances& setComponents(const vector<Instances::Components> & components) { DARABONBA_PTR_SET_VALUE(components_, components) };
      inline Instances& setComponents(vector<Instances::Components> && components) { DARABONBA_PTR_SET_RVALUE(components_, components) };
