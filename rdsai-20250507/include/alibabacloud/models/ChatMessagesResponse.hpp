...
namespace Models
{
  ...
  public:
    ...
    inline const ChatMessagesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ChatMessagesResponseBody) };
    inline ChatMessagesResponseBody body() { DARABONBA_PTR_GET(body_, ChatMessagesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ChatMessagesResponseBody> body_ = nullptr;
  };
