...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomAgentToolsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCustomAgentToolsResponseBody) };
    inline ListCustomAgentToolsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCustomAgentToolsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCustomAgentToolsResponseBody> body_ {};
  };
