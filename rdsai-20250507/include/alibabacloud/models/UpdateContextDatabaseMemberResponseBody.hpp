...
#ifndef ALIBABACLOUD_MODELS_UPDATECONTEXTDATABASEMEMBERRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATECONTEXTDATABASEMEMBERRESPONSEBODY_HPP_
...
namespace Models
{
  class UpdateContextDatabaseMemberResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateContextDatabaseMemberResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateContextDatabaseMemberResponseBody& obj) { 
    ...
    UpdateContextDatabaseMemberResponseBody() = default ;
    UpdateContextDatabaseMemberResponseBody(const UpdateContextDatabaseMemberResponseBody &) = default ;
    UpdateContextDatabaseMemberResponseBody(UpdateContextDatabaseMemberResponseBody &&) = default ;
    UpdateContextDatabaseMemberResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateContextDatabaseMemberResponseBody() = default ;
    UpdateContextDatabaseMemberResponseBody& operator=(const UpdateContextDatabaseMemberResponseBody &) = default ;
    UpdateContextDatabaseMemberResponseBody& operator=(UpdateContextDatabaseMemberResponseBody &&) = default ;
    ...
    void deleteCreatedAt() { this->createdAt_ = nullptr;};
    inline string getCreatedAt() const { DARABONBA_PTR_GET_DEFAULT(createdAt_, "") };
    inline UpdateContextDatabaseMemberResponseBody& setCreatedAt(string createdAt) { DARABONBA_PTR_SET_VALUE(createdAt_, createdAt) };


    // keys Field Functions 
    bool hasKeys() const { return this->keys_ != nullptr;};
    void deleteKeys() { this->keys_ = nullptr;};
    inline const vector<UpdateContextDatabaseMemberResponseBody::Keys> & getKeys() const { DARABONBA_PTR_GET_CONST(keys_, vector<UpdateContextDatabaseMemberResponseBody::Keys>) };
    inline vector<UpdateContextDatabaseMemberResponseBody::Keys> getKeys() { DARABONBA_PTR_GET(keys_, vector<UpdateContextDatabaseMemberResponseBody::Keys>) };
    inline UpdateContextDatabaseMemberResponseBody& setKeys(const vector<UpdateContextDatabaseMemberResponseBody::Keys> & keys) { DARABONBA_PTR_SET_VALUE(keys_, keys) };
    inline UpdateContextDatabaseMemberResponseBody& setKeys(vector<UpdateContextDatabaseMemberResponseBody::Keys> && keys) { DARABONBA_PTR_SET_RVALUE(keys_, keys) };
    ...
    inline UpdateContextDatabaseMemberResponseBody& setMemberId(string memberId) { DARABONBA_PTR_SET_VALUE(memberId_, memberId) };
    ...
    inline UpdateContextDatabaseMemberResponseBody& setMemberName(string memberName) { DARABONBA_PTR_SET_VALUE(memberName_, memberName) };
    ...
    inline UpdateContextDatabaseMemberResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline UpdateContextDatabaseMemberResponseBody& setRole(string role) { DARABONBA_PTR_SET_VALUE(role_, role) };
    ...
    void deleteStatus() { this->status_ = nullptr;};
    inline string getStatus() const { DARABONBA_PTR_GET_DEFAULT(status_, "") };
    inline UpdateContextDatabaseMemberResponseBody& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
