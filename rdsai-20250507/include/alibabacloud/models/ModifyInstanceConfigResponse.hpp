...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyInstanceConfigResponseBody) };
    inline ModifyInstanceConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyInstanceConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyInstanceConfigResponseBody> body_ {};
  };
