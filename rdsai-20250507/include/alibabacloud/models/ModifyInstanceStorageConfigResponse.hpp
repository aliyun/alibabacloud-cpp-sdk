...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceStorageConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyInstanceStorageConfigResponseBody) };
    inline ModifyInstanceStorageConfigResponseBody body() { DARABONBA_PTR_GET(body_, ModifyInstanceStorageConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyInstanceStorageConfigResponseBody> body_ = nullptr;
  };
