...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAndroidInstanceGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAndroidInstanceGroupResponseBody) };
    inline CreateAndroidInstanceGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAndroidInstanceGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAndroidInstanceGroupResponseBody> body_ {};
  };
