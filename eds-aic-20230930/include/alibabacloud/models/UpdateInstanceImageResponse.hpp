...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateInstanceImageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateInstanceImageResponseBody) };
    inline UpdateInstanceImageResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateInstanceImageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateInstanceImageResponseBody> body_ {};
  };
