...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & taskStatuses() const { DARABONBA_PTR_GET_CONST(taskStatuses_, vector<string>) };
    inline vector<string> taskStatuses() { DARABONBA_PTR_GET(taskStatuses_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> taskStatuses_ = nullptr;
