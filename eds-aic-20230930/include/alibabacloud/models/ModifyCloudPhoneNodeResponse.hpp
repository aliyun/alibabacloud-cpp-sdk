...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCloudPhoneNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCloudPhoneNodeResponseBody) };
    inline ModifyCloudPhoneNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCloudPhoneNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCloudPhoneNodeResponseBody> body_ {};
  };
