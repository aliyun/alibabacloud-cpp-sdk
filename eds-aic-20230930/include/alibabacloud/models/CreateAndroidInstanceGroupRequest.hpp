...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->amount_ != nullptr
        && this->autoPay_ != nullptr && this->autoRenew_ != nullptr && this->bizRegionId_ != nullptr && this->chargeType_ != nullptr && this->clientToken_ != nullptr
        && this->enableIpv6_ != nullptr && this->gpuAcceleration_ != nullptr && this->imageId_ != nullptr && this->instanceGroupName_ != nullptr && this->instanceGroupSpec_ != nullptr
        && this->ipv6Bandwidth_ != nullptr && this->keyPairId_ != nullptr && this->numberOfInstances_ != nullptr && this->officeSiteId_ != nullptr && this->period_ != nullptr
        && this->periodUnit_ != nullptr && this->policyGroupId_ != nullptr && this->tag_ != nullptr && this->vSwitchId_ != nullptr; };
