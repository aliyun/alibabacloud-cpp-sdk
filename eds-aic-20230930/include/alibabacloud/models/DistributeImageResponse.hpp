...
namespace Models
{
  ...
  public:
    ...
    inline const DistributeImageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DistributeImageResponseBody) };
    inline DistributeImageResponseBody getBody() { DARABONBA_PTR_GET(body_, DistributeImageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DistributeImageResponseBody> body_ {};
  };
