...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAndroidInstanceGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAndroidInstanceGroupsResponseBody) };
    inline DescribeAndroidInstanceGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAndroidInstanceGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAndroidInstanceGroupsResponseBody> body_ {};
  };
