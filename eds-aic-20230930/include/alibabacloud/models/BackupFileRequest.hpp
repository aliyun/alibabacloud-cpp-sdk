...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->androidInstanceIdList_ == nullptr
        && return this->backupAll_ == nullptr && return this->backupFileName_ == nullptr && return this->backupFilePath_ == nullptr && return this->description_ == nullptr && return this->excludeSourceFilePathList_ == nullptr
        && return this->sourceAppList_ == nullptr && return this->sourceFilePathList_ == nullptr && return this->uploadEndpoint_ == nullptr && return this->uploadType_ == nullptr; };
