...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getExcludeSourceFilePathList() const { DARABONBA_PTR_GET_CONST(excludeSourceFilePathList_, vector<string>) };
    inline vector<string> getExcludeSourceFilePathList() { DARABONBA_PTR_GET(excludeSourceFilePathList_, vector<string>) };
