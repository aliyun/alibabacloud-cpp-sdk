...
namespace Models
{
  ...
  public:
    ...
    inline const ListPolicyGroupsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListPolicyGroupsResponseBody) };
    inline ListPolicyGroupsResponseBody body() { DARABONBA_PTR_GET(body_, ListPolicyGroupsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListPolicyGroupsResponseBody> body_ = nullptr;
  };
