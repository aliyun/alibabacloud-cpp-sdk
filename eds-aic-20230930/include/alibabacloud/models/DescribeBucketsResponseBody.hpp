...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeBucketsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeBucketsResponseBodyData>) };
    inline vector<DescribeBucketsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeBucketsResponseBodyData>) };
    inline DescribeBucketsResponseBody& setData(const vector<DescribeBucketsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeBucketsResponseBody& setData(vector<DescribeBucketsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeBucketsResponseBodyData>> data_ = nullptr;
