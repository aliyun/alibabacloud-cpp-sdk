...
#ifndef ALIBABACLOUD_MODELS_BACKUPANDROIDINSTANCEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_BACKUPANDROIDINSTANCEREQUEST_HPP_
...
namespace Models
{
  class BackupAndroidInstanceRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const BackupAndroidInstanceRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, BackupAndroidInstanceRequest& obj) { 
    ...
    BackupAndroidInstanceRequest(const BackupAndroidInstanceRequest &) = default ;
    BackupAndroidInstanceRequest(BackupAndroidInstanceRequest &&) = default ;
    BackupAndroidInstanceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BackupAndroidInstanceRequest() = default ;
    BackupAndroidInstanceRequest& operator=(const BackupAndroidInstanceRequest &) = default ;
    BackupAndroidInstanceRequest& operator=(BackupAndroidInstanceRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->androidInstanceIdList_ == nullptr
        && this->backupFileName_ == nullptr && this->backupFilePath_ == nullptr && this->description_ == nullptr && this->uploadEndpoint_ == nullptr; };
    ...
    inline BackupAndroidInstanceRequest& setAndroidInstanceIdList(const vector<string> & androidInstanceIdList) { DARABONBA_PTR_SET_VALUE(androidInstanceIdList_, androidInstanceIdList) };
    inline BackupAndroidInstanceRequest& setAndroidInstanceIdList(vector<string> && androidInstanceIdList) { DARABONBA_PTR_SET_RVALUE(androidInstanceIdList_, androidInstanceIdList) };
    ...
    inline BackupAndroidInstanceRequest& setBackupFileName(string backupFileName) { DARABONBA_PTR_SET_VALUE(backupFileName_, backupFileName) };
    ...
    inline BackupAndroidInstanceRequest& setBackupFilePath(string backupFilePath) { DARABONBA_PTR_SET_VALUE(backupFilePath_, backupFilePath) };
    ...
    inline BackupAndroidInstanceRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline BackupAndroidInstanceRequest& setUploadEndpoint(string uploadEndpoint) { DARABONBA_PTR_SET_VALUE(uploadEndpoint_, uploadEndpoint) };
