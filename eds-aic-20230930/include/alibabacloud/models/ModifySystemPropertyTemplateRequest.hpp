...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->enableAuto_ == nullptr
        && this->filePath_ == nullptr && this->systemPropertyInfo_ == nullptr && this->templateId_ == nullptr && this->templateName_ == nullptr; };
    ...
    inline const ModifySystemPropertyTemplateRequest::SystemPropertyInfo & getSystemPropertyInfo() const { DARABONBA_PTR_GET_CONST(systemPropertyInfo_, ModifySystemPropertyTemplateRequest::SystemPropertyInfo) };
    inline ModifySystemPropertyTemplateRequest::SystemPropertyInfo getSystemPropertyInfo() { DARABONBA_PTR_GET(systemPropertyInfo_, ModifySystemPropertyTemplateRequest::SystemPropertyInfo) };
    inline ModifySystemPropertyTemplateRequest& setSystemPropertyInfo(const ModifySystemPropertyTemplateRequest::SystemPropertyInfo & systemPropertyInfo) { DARABONBA_PTR_SET_VALUE(systemPropertyInfo_, systemPropertyInfo) };
    inline ModifySystemPropertyTemplateRequest& setSystemPropertyInfo(ModifySystemPropertyTemplateRequest::SystemPropertyInfo && systemPropertyInfo) { DARABONBA_PTR_SET_RVALUE(systemPropertyInfo_, systemPropertyInfo) };
