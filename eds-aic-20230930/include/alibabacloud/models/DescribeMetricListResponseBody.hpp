...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->count_ == nullptr
        && return this->metricTotalModel_ == nullptr && return this->nextToken_ == nullptr && return this->requestId_ == nullptr; };
    ...
    inline const vector<DescribeMetricListResponseBodyMetricTotalModel> & metricTotalModel() const { DARABONBA_PTR_GET_CONST(metricTotalModel_, vector<DescribeMetricListResponseBodyMetricTotalModel>) };
    inline vector<DescribeMetricListResponseBodyMetricTotalModel> metricTotalModel() { DARABONBA_PTR_GET(metricTotalModel_, vector<DescribeMetricListResponseBodyMetricTotalModel>) };
    inline DescribeMetricListResponseBody& setMetricTotalModel(const vector<DescribeMetricListResponseBodyMetricTotalModel> & metricTotalModel) { DARABONBA_PTR_SET_VALUE(metricTotalModel_, metricTotalModel) };
    inline DescribeMetricListResponseBody& setMetricTotalModel(vector<DescribeMetricListResponseBodyMetricTotalModel> && metricTotalModel) { DARABONBA_PTR_SET_RVALUE(metricTotalModel_, metricTotalModel) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeMetricListResponseBodyMetricTotalModel>> metricTotalModel_ = nullptr;
