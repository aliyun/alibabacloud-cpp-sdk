...
#ifndef ALIBABACLOUD_MODELS_LISTPOLICYGROUPSRESPONSEBODYPOLICYGROUPMODELWATERMARK_HPP_
#define ALIBABACLOUD_MODELS_LISTPOLICYGROUPSRESPONSEBODYPOLICYGROUPMODELWATERMARK_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListPolicyGroupsResponseBodyPolicyGroupModelWatermark& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListPolicyGroupsResponseBodyPolicyGroupModelWatermark& obj) { 
    ...
    ListPolicyGroupsResponseBodyPolicyGroupModelWatermark() = default ;
    ListPolicyGroupsResponseBodyPolicyGroupModelWatermark(const ListPolicyGroupsResponseBodyPolicyGroupModelWatermark &) = default ;
    ListPolicyGroupsResponseBodyPolicyGroupModelWatermark(ListPolicyGroupsResponseBodyPolicyGroupModelWatermark &&) = default ;
    ListPolicyGroupsResponseBodyPolicyGroupModelWatermark(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPolicyGroupsResponseBodyPolicyGroupModelWatermark() = default ;
    ListPolicyGroupsResponseBodyPolicyGroupModelWatermark& operator=(const ListPolicyGroupsResponseBodyPolicyGroupModelWatermark &) = default ;
    ListPolicyGroupsResponseBodyPolicyGroupModelWatermark& operator=(ListPolicyGroupsResponseBodyPolicyGroupModelWatermark &&) = default ;
    ...
    inline ListPolicyGroupsResponseBodyPolicyGroupModelWatermark& setWatermarkColor(int32_t watermarkColor) { DARABONBA_PTR_SET_VALUE(watermarkColor_, watermarkColor) };
    ...
    inline ListPolicyGroupsResponseBodyPolicyGroupModelWatermark& setWatermarkCustomText(string watermarkCustomText) { DARABONBA_PTR_SET_VALUE(watermarkCustomText_, watermarkCustomText) };
    ...
    inline ListPolicyGroupsResponseBodyPolicyGroupModelWatermark& setWatermarkFontSize(int32_t watermarkFontSize) { DARABONBA_PTR_SET_VALUE(watermarkFontSize_, watermarkFontSize) };
    ...
    inline ListPolicyGroupsResponseBodyPolicyGroupModelWatermark& setWatermarkSwitch(string watermarkSwitch) { DARABONBA_PTR_SET_VALUE(watermarkSwitch_, watermarkSwitch) };
    ...
    inline ListPolicyGroupsResponseBodyPolicyGroupModelWatermark& setWatermarkTransparencyValue(int32_t watermarkTransparencyValue) { DARABONBA_PTR_SET_VALUE(watermarkTransparencyValue_, watermarkTransparencyValue) };
    ...
    inline ListPolicyGroupsResponseBodyPolicyGroupModelWatermark& setWatermarkTypes(const vector<string> & watermarkTypes) { DARABONBA_PTR_SET_VALUE(watermarkTypes_, watermarkTypes) };
    inline ListPolicyGroupsResponseBodyPolicyGroupModelWatermark& setWatermarkTypes(vector<string> && watermarkTypes) { DARABONBA_PTR_SET_RVALUE(watermarkTypes_, watermarkTypes) };
