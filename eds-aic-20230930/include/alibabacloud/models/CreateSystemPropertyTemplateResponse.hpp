...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSystemPropertyTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSystemPropertyTemplateResponseBody) };
    inline CreateSystemPropertyTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSystemPropertyTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSystemPropertyTemplateResponseBody> body_ {};
  };
