...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstancePropertiesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetInstancePropertiesResponseBody) };
    inline GetInstancePropertiesResponseBody body() { DARABONBA_PTR_GET(body_, GetInstancePropertiesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetInstancePropertiesResponseBody> body_ = nullptr;
  };
