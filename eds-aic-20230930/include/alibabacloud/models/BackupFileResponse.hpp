...
namespace Models
{
  ...
  public:
    ...
    inline const BackupFileResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, BackupFileResponseBody) };
    inline BackupFileResponseBody body() { DARABONBA_PTR_GET(body_, BackupFileResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<BackupFileResponseBody> body_ = nullptr;
  };
