...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySystemPropertyTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifySystemPropertyTemplateResponseBody) };
    inline ModifySystemPropertyTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifySystemPropertyTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifySystemPropertyTemplateResponseBody> body_ {};
  };
