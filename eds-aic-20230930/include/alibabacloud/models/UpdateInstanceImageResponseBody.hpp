...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateInstanceImageResponseBody::Tasks & getTasks() const { DARABONBA_PTR_GET_CONST(tasks_, UpdateInstanceImageResponseBody::Tasks) };
    inline UpdateInstanceImageResponseBody::Tasks getTasks() { DARABONBA_PTR_GET(tasks_, UpdateInstanceImageResponseBody::Tasks) };
    inline UpdateInstanceImageResponseBody& setTasks(const UpdateInstanceImageResponseBody::Tasks & tasks) { DARABONBA_PTR_SET_VALUE(tasks_, tasks) };
    inline UpdateInstanceImageResponseBody& setTasks(UpdateInstanceImageResponseBody::Tasks && tasks) { DARABONBA_PTR_SET_RVALUE(tasks_, tasks) };
