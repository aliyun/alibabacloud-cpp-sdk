...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->enableAuto_ == nullptr
        && return this->filePath_ == nullptr && return this->status_ == nullptr && return this->systemPropertyInfo_ == nullptr && return this->templateId_ == nullptr && return this->templateName_ == nullptr; };
