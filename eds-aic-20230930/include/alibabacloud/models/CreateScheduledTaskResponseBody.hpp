  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->instanceResults_ == nullptr
        && this->scheduledId_ == nullptr && this->taskConfigId_ == nullptr; };
    ...
    inline const vector<CreateScheduledTaskResponseBody::Tasks> & getTasks() const { DARABONBA_PTR_GET_CONST(tasks_, vector<CreateScheduledTaskResponseBody::Tasks>) };
    inline vector<CreateScheduledTaskResponseBody::Tasks> getTasks() { DARABONBA_PTR_GET(tasks_, vector<CreateScheduledTaskResponseBody::Tasks>) };
    inline CreateScheduledTaskResponseBody& setTasks(const vector<CreateScheduledTaskResponseBody::Tasks> & tasks) { DARABONBA_PTR_SET_VALUE(tasks_, tasks) };
    inline CreateScheduledTaskResponseBody& setTasks(vector<CreateScheduledTaskResponseBody::Tasks> && tasks) { DARABONBA_PTR_SET_RVALUE(tasks_, tasks) };
    ...
    inline CreateScheduledTaskResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
