...
namespace Models
{
  ...
  public:
    ...
    inline const StartAndroidInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartAndroidInstanceResponseBody) };
    inline StartAndroidInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, StartAndroidInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartAndroidInstanceResponseBody> body_ {};
  };
