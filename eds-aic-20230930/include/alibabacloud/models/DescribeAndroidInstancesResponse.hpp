...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAndroidInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAndroidInstancesResponseBody) };
    inline DescribeAndroidInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAndroidInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAndroidInstancesResponseBody> body_ {};
  };
