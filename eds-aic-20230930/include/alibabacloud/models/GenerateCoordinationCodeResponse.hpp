...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateCoordinationCodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateCoordinationCodeResponseBody) };
    inline GenerateCoordinationCodeResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateCoordinationCodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateCoordinationCodeResponseBody> body_ {};
  };
