...
namespace Models
{
  ...
  public:
    ...
    inline const InstanceHealerResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, InstanceHealerResponseBody) };
    inline InstanceHealerResponseBody body() { DARABONBA_PTR_GET(body_, InstanceHealerResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<InstanceHealerResponseBody> body_ = nullptr;
  };
