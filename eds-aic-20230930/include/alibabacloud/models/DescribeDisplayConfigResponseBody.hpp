...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->displayConfigModel_ != nullptr
    ...
    inline const vector<DescribeDisplayConfigResponseBodyDisplayConfigModel> & displayConfigModel() const { DARABONBA_PTR_GET_CONST(displayConfigModel_, vector<DescribeDisplayConfigResponseBodyDisplayConfigModel>) };
    inline vector<DescribeDisplayConfigResponseBodyDisplayConfigModel> displayConfigModel() { DARABONBA_PTR_GET(displayConfigModel_, vector<DescribeDisplayConfigResponseBodyDisplayConfigModel>) };
    inline DescribeDisplayConfigResponseBody& setDisplayConfigModel(const vector<DescribeDisplayConfigResponseBodyDisplayConfigModel> & displayConfigModel) { DARABONBA_PTR_SET_VALUE(displayConfigModel_, displayConfigModel) };
    inline DescribeDisplayConfigResponseBody& setDisplayConfigModel(vector<DescribeDisplayConfigResponseBodyDisplayConfigModel> && displayConfigModel) { DARABONBA_PTR_SET_RVALUE(displayConfigModel_, displayConfigModel) };
  ...
  protected:
    std::shared_ptr<vector<DescribeDisplayConfigResponseBodyDisplayConfigModel>> displayConfigModel_ = nullptr;
