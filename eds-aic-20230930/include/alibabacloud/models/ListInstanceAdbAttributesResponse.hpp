...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceAdbAttributesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListInstanceAdbAttributesResponseBody) };
    inline ListInstanceAdbAttributesResponseBody body() { DARABONBA_PTR_GET(body_, ListInstanceAdbAttributesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListInstanceAdbAttributesResponseBody> body_ = nullptr;
  };
