...
namespace Models
{
  ...
  public:
    ...
    inline const ExpandDataVolumeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ExpandDataVolumeResponseBody) };
    inline ExpandDataVolumeResponseBody body() { DARABONBA_PTR_GET(body_, ExpandDataVolumeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ExpandDataVolumeResponseBody> body_ = nullptr;
  };
