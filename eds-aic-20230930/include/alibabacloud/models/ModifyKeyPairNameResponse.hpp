...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyKeyPairNameResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyKeyPairNameResponseBody) };
    inline ModifyKeyPairNameResponseBody body() { DARABONBA_PTR_GET(body_, ModifyKeyPairNameResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyKeyPairNameResponseBody> body_ = nullptr;
  };
