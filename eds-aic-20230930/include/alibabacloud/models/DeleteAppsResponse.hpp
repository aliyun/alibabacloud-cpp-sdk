...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAppsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAppsResponseBody) };
    inline DeleteAppsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAppsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAppsResponseBody> body_ {};
  };
