...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteImagesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteImagesResponseBody) };
    inline DeleteImagesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteImagesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteImagesResponseBody> body_ {};
  };
