...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->coordinatorCode_ == nullptr
    ...
    inline string getCoordinatorCode() const { DARABONBA_PTR_GET_DEFAULT(coordinatorCode_, "") };
  ...
  protected:
    ...
    shared_ptr<string> coordinatorCode_ {};
    // The request ID.
