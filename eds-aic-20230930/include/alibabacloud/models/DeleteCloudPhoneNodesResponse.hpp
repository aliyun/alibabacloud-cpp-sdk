...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCloudPhoneNodesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCloudPhoneNodesResponseBody) };
    inline DeleteCloudPhoneNodesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCloudPhoneNodesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCloudPhoneNodesResponseBody> body_ {};
  };
