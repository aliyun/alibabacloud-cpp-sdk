...
#ifndef ALIBABACLOUD_MODELS_PULLRPAMODELREQUEST_HPP_
#define ALIBABACLOUD_MODELS_PULLRPAMODELREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PullRpaModelRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PullRpaModelRequest& obj) { 
    ...
    PullRpaModelRequest() = default ;
    PullRpaModelRequest(const PullRpaModelRequest &) = default ;
    PullRpaModelRequest(PullRpaModelRequest &&) = default ;
    PullRpaModelRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PullRpaModelRequest() = default ;
    PullRpaModelRequest& operator=(const PullRpaModelRequest &) = default ;
    PullRpaModelRequest& operator=(PullRpaModelRequest &&) = default ;
    ...
    inline PullRpaModelRequest& setAliyunKp(string aliyunKp) { DARABONBA_PTR_SET_VALUE(aliyunKp_, aliyunKp) };
    ...
    inline PullRpaModelRequest& setApiType(string apiType) { DARABONBA_PTR_SET_VALUE(apiType_, apiType) };
    ...
    inline PullRpaModelRequest& setBid(string bid) { DARABONBA_PTR_SET_VALUE(bid_, bid) };
    ...
    inline PullRpaModelRequest& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline PullRpaModelRequest& setOriginalRequest(string originalRequest) { DARABONBA_PTR_SET_VALUE(originalRequest_, originalRequest) };
    ...
    inline PullRpaModelRequest& setTemplateId(int64_t templateId) { DARABONBA_PTR_SET_VALUE(templateId_, templateId) };
    ...
    inline PullRpaModelRequest& setUserAccessKeyId(string userAccessKeyId) { DARABONBA_PTR_SET_VALUE(userAccessKeyId_, userAccessKeyId) };
    ...
    inline PullRpaModelRequest& setUserBid(string userBid) { DARABONBA_PTR_SET_VALUE(userBid_, userBid) };
    ...
    inline PullRpaModelRequest& setUserCallerParentId(int64_t userCallerParentId) { DARABONBA_PTR_SET_VALUE(userCallerParentId_, userCallerParentId) };
    ...
    inline PullRpaModelRequest& setUserCallerType(string userCallerType) { DARABONBA_PTR_SET_VALUE(userCallerType_, userCallerType) };
    ...
    inline PullRpaModelRequest& setUserClientIp(string userClientIp) { DARABONBA_PTR_SET_VALUE(userClientIp_, userClientIp) };
    ...
    inline PullRpaModelRequest& setUserKp(string userKp) { DARABONBA_PTR_SET_VALUE(userKp_, userKp) };
    ...
    inline PullRpaModelRequest& setUserMfaPresent(bool userMfaPresent) { DARABONBA_PTR_SET_VALUE(userMfaPresent_, userMfaPresent) };
    ...
    inline PullRpaModelRequest& setUserSecurityToken(string userSecurityToken) { DARABONBA_PTR_SET_VALUE(userSecurityToken_, userSecurityToken) };
