...
#ifndef ALIBABACLOUD_MODELS_GETPROXYBYTYPEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETPROXYBYTYPEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetProxyByTypeRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetProxyByTypeRequest& obj) { 
    ...
    GetProxyByTypeRequest() = default ;
    GetProxyByTypeRequest(const GetProxyByTypeRequest &) = default ;
    GetProxyByTypeRequest(GetProxyByTypeRequest &&) = default ;
    GetProxyByTypeRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetProxyByTypeRequest() = default ;
    GetProxyByTypeRequest& operator=(const GetProxyByTypeRequest &) = default ;
    GetProxyByTypeRequest& operator=(GetProxyByTypeRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->aliyunKp_ == nullptr
        && return this->apiType_ == nullptr && return this->bid_ == nullptr && return this->lang_ == nullptr && return this->originalRequest_ == nullptr && return this->type_ == nullptr
    ...
    inline GetProxyByTypeRequest& setAliyunKp(string aliyunKp) { DARABONBA_PTR_SET_VALUE(aliyunKp_, aliyunKp) };
    ...
    inline GetProxyByTypeRequest& setApiType(string apiType) { DARABONBA_PTR_SET_VALUE(apiType_, apiType) };
    ...
    inline GetProxyByTypeRequest& setBid(string bid) { DARABONBA_PTR_SET_VALUE(bid_, bid) };
    ...
    inline GetProxyByTypeRequest& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline GetProxyByTypeRequest& setOriginalRequest(string originalRequest) { DARABONBA_PTR_SET_VALUE(originalRequest_, originalRequest) };
    ...
    inline GetProxyByTypeRequest& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline GetProxyByTypeRequest& setUserAccessKeyId(string userAccessKeyId) { DARABONBA_PTR_SET_VALUE(userAccessKeyId_, userAccessKeyId) };
    ...
    inline GetProxyByTypeRequest& setUserBid(string userBid) { DARABONBA_PTR_SET_VALUE(userBid_, userBid) };
    ...
    inline GetProxyByTypeRequest& setUserCallerParentId(int64_t userCallerParentId) { DARABONBA_PTR_SET_VALUE(userCallerParentId_, userCallerParentId) };
    ...
    inline GetProxyByTypeRequest& setUserCallerSecurityTransport(bool userCallerSecurityTransport) { DARABONBA_PTR_SET_VALUE(userCallerSecurityTransport_, userCallerSecurityTransport) };
    ...
    inline GetProxyByTypeRequest& setUserCallerType(string userCallerType) { DARABONBA_PTR_SET_VALUE(userCallerType_, userCallerType) };
    ...
    inline GetProxyByTypeRequest& setUserClientIp(string userClientIp) { DARABONBA_PTR_SET_VALUE(userClientIp_, userClientIp) };
    ...
    inline GetProxyByTypeRequest& setUserKp(string userKp) { DARABONBA_PTR_SET_VALUE(userKp_, userKp) };
    ...
    inline GetProxyByTypeRequest& setUserMfaPresent(bool userMfaPresent) { DARABONBA_PTR_SET_VALUE(userMfaPresent_, userMfaPresent) };
    ...
    inline GetProxyByTypeRequest& setUserSecurityToken(string userSecurityToken) { DARABONBA_PTR_SET_VALUE(userSecurityToken_, userSecurityToken) };
