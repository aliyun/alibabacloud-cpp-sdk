...
#ifndef ALIBABACLOUD_MODELS_GETNODEBYTEMPLATEIDREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETNODEBYTEMPLATEIDREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetNodeByTemplateIdRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetNodeByTemplateIdRequest& obj) { 
    ...
    GetNodeByTemplateIdRequest() = default ;
    GetNodeByTemplateIdRequest(const GetNodeByTemplateIdRequest &) = default ;
    GetNodeByTemplateIdRequest(GetNodeByTemplateIdRequest &&) = default ;
    GetNodeByTemplateIdRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetNodeByTemplateIdRequest() = default ;
    GetNodeByTemplateIdRequest& operator=(const GetNodeByTemplateIdRequest &) = default ;
    GetNodeByTemplateIdRequest& operator=(GetNodeByTemplateIdRequest &&) = default ;
    ...
    inline GetNodeByTemplateIdRequest& setAliyunKp(string aliyunKp) { DARABONBA_PTR_SET_VALUE(aliyunKp_, aliyunKp) };
    ...
    inline GetNodeByTemplateIdRequest& setApiType(string apiType) { DARABONBA_PTR_SET_VALUE(apiType_, apiType) };
    ...
    inline GetNodeByTemplateIdRequest& setBid(string bid) { DARABONBA_PTR_SET_VALUE(bid_, bid) };
    ...
    inline GetNodeByTemplateIdRequest& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline GetNodeByTemplateIdRequest& setOriginalRequest(string originalRequest) { DARABONBA_PTR_SET_VALUE(originalRequest_, originalRequest) };
    ...
    inline GetNodeByTemplateIdRequest& setTemplateId(int64_t templateId) { DARABONBA_PTR_SET_VALUE(templateId_, templateId) };
    ...
    inline GetNodeByTemplateIdRequest& setUserAccessKeyId(string userAccessKeyId) { DARABONBA_PTR_SET_VALUE(userAccessKeyId_, userAccessKeyId) };
    ...
    inline GetNodeByTemplateIdRequest& setUserBid(string userBid) { DARABONBA_PTR_SET_VALUE(userBid_, userBid) };
    ...
    inline GetNodeByTemplateIdRequest& setUserCallerParentId(int64_t userCallerParentId) { DARABONBA_PTR_SET_VALUE(userCallerParentId_, userCallerParentId) };
    ...
    inline GetNodeByTemplateIdRequest& setUserCallerSecurityTransport(bool userCallerSecurityTransport) { DARABONBA_PTR_SET_VALUE(userCallerSecurityTransport_, userCallerSecurityTransport) };
    ...
    inline GetNodeByTemplateIdRequest& setUserCallerType(string userCallerType) { DARABONBA_PTR_SET_VALUE(userCallerType_, userCallerType) };
    ...
    inline GetNodeByTemplateIdRequest& setUserClientIp(string userClientIp) { DARABONBA_PTR_SET_VALUE(userClientIp_, userClientIp) };
    ...
    inline GetNodeByTemplateIdRequest& setUserKp(string userKp) { DARABONBA_PTR_SET_VALUE(userKp_, userKp) };
    ...
    inline GetNodeByTemplateIdRequest& setUserMfaPresent(bool userMfaPresent) { DARABONBA_PTR_SET_VALUE(userMfaPresent_, userMfaPresent) };
    ...
    inline GetNodeByTemplateIdRequest& setUserSecurityToken(string userSecurityToken) { DARABONBA_PTR_SET_VALUE(userSecurityToken_, userSecurityToken) };
