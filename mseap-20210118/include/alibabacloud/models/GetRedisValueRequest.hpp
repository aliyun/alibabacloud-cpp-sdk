...
#ifndef ALIBABACLOUD_MODELS_GETREDISVALUEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETREDISVALUEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetRedisValueRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetRedisValueRequest& obj) { 
    ...
    GetRedisValueRequest() = default ;
    GetRedisValueRequest(const GetRedisValueRequest &) = default ;
    GetRedisValueRequest(GetRedisValueRequest &&) = default ;
    GetRedisValueRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetRedisValueRequest() = default ;
    GetRedisValueRequest& operator=(const GetRedisValueRequest &) = default ;
    GetRedisValueRequest& operator=(GetRedisValueRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->aliyunKp_ == nullptr
        ...
        && return this->timeout_ == nullptr && return this->userAccessKeyId_ == nullptr && return this->userBid_ == nullptr && return this->userCallerParentId_ == nullptr && return this->userCallerSecurityTransport_ == nullptr
    ...
    inline GetRedisValueRequest& setAliyunKp(string aliyunKp) { DARABONBA_PTR_SET_VALUE(aliyunKp_, aliyunKp) };
    ...
    inline GetRedisValueRequest& setApiType(string apiType) { DARABONBA_PTR_SET_VALUE(apiType_, apiType) };
    ...
    inline GetRedisValueRequest& setBid(string bid) { DARABONBA_PTR_SET_VALUE(bid_, bid) };
    ...
    inline GetRedisValueRequest& setKey(string key) { DARABONBA_PTR_SET_VALUE(key_, key) };
    ...
    inline GetRedisValueRequest& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline GetRedisValueRequest& setOriginalRequest(string originalRequest) { DARABONBA_PTR_SET_VALUE(originalRequest_, originalRequest) };
    ...
    inline GetRedisValueRequest& setTimeout(int64_t timeout) { DARABONBA_PTR_SET_VALUE(timeout_, timeout) };
    ...
    inline GetRedisValueRequest& setUserAccessKeyId(string userAccessKeyId) { DARABONBA_PTR_SET_VALUE(userAccessKeyId_, userAccessKeyId) };
    ...
    inline GetRedisValueRequest& setUserBid(string userBid) { DARABONBA_PTR_SET_VALUE(userBid_, userBid) };
    ...
    inline GetRedisValueRequest& setUserCallerParentId(int64_t userCallerParentId) { DARABONBA_PTR_SET_VALUE(userCallerParentId_, userCallerParentId) };
    ...
    inline GetRedisValueRequest& setUserCallerSecurityTransport(bool userCallerSecurityTransport) { DARABONBA_PTR_SET_VALUE(userCallerSecurityTransport_, userCallerSecurityTransport) };
    ...
    inline GetRedisValueRequest& setUserCallerType(string userCallerType) { DARABONBA_PTR_SET_VALUE(userCallerType_, userCallerType) };
    ...
    inline GetRedisValueRequest& setUserClientIp(string userClientIp) { DARABONBA_PTR_SET_VALUE(userClientIp_, userClientIp) };
    ...
    inline GetRedisValueRequest& setUserKp(string userKp) { DARABONBA_PTR_SET_VALUE(userKp_, userKp) };
    ...
    inline GetRedisValueRequest& setUserMfaPresent(bool userMfaPresent) { DARABONBA_PTR_SET_VALUE(userMfaPresent_, userMfaPresent) };
    ...
    inline GetRedisValueRequest& setUserSecurityToken(string userSecurityToken) { DARABONBA_PTR_SET_VALUE(userSecurityToken_, userSecurityToken) };
    ...
    inline GetRedisValueRequest& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
