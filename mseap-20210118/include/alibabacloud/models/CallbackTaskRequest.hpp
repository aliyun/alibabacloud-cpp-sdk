...
#ifndef ALIBABACLOUD_MODELS_CALLBACKTASKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CALLBACKTASKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CallbackTaskRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CallbackTaskRequest& obj) { 
    ...
    CallbackTaskRequest() = default ;
    CallbackTaskRequest(const CallbackTaskRequest &) = default ;
    CallbackTaskRequest(CallbackTaskRequest &&) = default ;
    CallbackTaskRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CallbackTaskRequest() = default ;
    CallbackTaskRequest& operator=(const CallbackTaskRequest &) = default ;
    CallbackTaskRequest& operator=(CallbackTaskRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->aliyunKp_ == nullptr
        ...
        && return this->originalRequest_ == nullptr && return this->outTaskId_ == nullptr && return this->principalKey_ == nullptr && return this->taskData_ == nullptr && return this->taskId_ == nullptr
        && return this->taskType_ == nullptr && return this->userAccessKeyId_ == nullptr && return this->userBid_ == nullptr && return this->userCallerParentId_ == nullptr && return this->userCallerSecurityTransport_ == nullptr
    ...
    inline CallbackTaskRequest& setAliyunKp(string aliyunKp) { DARABONBA_PTR_SET_VALUE(aliyunKp_, aliyunKp) };
    ...
    inline CallbackTaskRequest& setApiType(string apiType) { DARABONBA_PTR_SET_VALUE(apiType_, apiType) };
    ...
    inline CallbackTaskRequest& setBid(string bid) { DARABONBA_PTR_SET_VALUE(bid_, bid) };
    ...
    inline CallbackTaskRequest& setBizCode(string bizCode) { DARABONBA_PTR_SET_VALUE(bizCode_, bizCode) };
    ...
    inline CallbackTaskRequest& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline CallbackTaskRequest& setOrderId(string orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline CallbackTaskRequest& setOriginalRequest(string originalRequest) { DARABONBA_PTR_SET_VALUE(originalRequest_, originalRequest) };
    ...
    inline CallbackTaskRequest& setOutTaskId(string outTaskId) { DARABONBA_PTR_SET_VALUE(outTaskId_, outTaskId) };
    ...
    inline CallbackTaskRequest& setPrincipalKey(string principalKey) { DARABONBA_PTR_SET_VALUE(principalKey_, principalKey) };
    ...
    inline CallbackTaskRequest& setTaskData(string taskData) { DARABONBA_PTR_SET_VALUE(taskData_, taskData) };
    ...
    inline CallbackTaskRequest& setTaskId(string taskId) { DARABONBA_PTR_SET_VALUE(taskId_, taskId) };
    ...
    inline CallbackTaskRequest& setTaskType(string taskType) { DARABONBA_PTR_SET_VALUE(taskType_, taskType) };
    ...
    inline CallbackTaskRequest& setUserAccessKeyId(string userAccessKeyId) { DARABONBA_PTR_SET_VALUE(userAccessKeyId_, userAccessKeyId) };
    ...
    inline CallbackTaskRequest& setUserBid(string userBid) { DARABONBA_PTR_SET_VALUE(userBid_, userBid) };
    ...
    inline CallbackTaskRequest& setUserCallerParentId(int64_t userCallerParentId) { DARABONBA_PTR_SET_VALUE(userCallerParentId_, userCallerParentId) };
    ...
    inline CallbackTaskRequest& setUserCallerSecurityTransport(bool userCallerSecurityTransport) { DARABONBA_PTR_SET_VALUE(userCallerSecurityTransport_, userCallerSecurityTransport) };
    ...
    inline CallbackTaskRequest& setUserCallerType(string userCallerType) { DARABONBA_PTR_SET_VALUE(userCallerType_, userCallerType) };
    ...
    inline CallbackTaskRequest& setUserClientIp(string userClientIp) { DARABONBA_PTR_SET_VALUE(userClientIp_, userClientIp) };
    ...
    inline CallbackTaskRequest& setUserKp(string userKp) { DARABONBA_PTR_SET_VALUE(userKp_, userKp) };
    ...
    inline CallbackTaskRequest& setUserMfaPresent(bool userMfaPresent) { DARABONBA_PTR_SET_VALUE(userMfaPresent_, userMfaPresent) };
    ...
    inline CallbackTaskRequest& setUserSecurityToken(string userSecurityToken) { DARABONBA_PTR_SET_VALUE(userSecurityToken_, userSecurityToken) };
