...
#ifndef ALIBABACLOUD_MODELS_GETSOWLISTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETSOWLISTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSowListRequest& obj) { 
      DARABONBA_PTR_TO_JSON(DateType, dateType_);
      DARABONBA_PTR_TO_JSON(EndDate, endDate_);
      DARABONBA_PTR_TO_JSON(StartDate, startDate_);
      DARABONBA_PTR_TO_JSON(SuspEventSource, suspEventSource_);
    };
    friend void from_json(const Darabonba::Json& j, GetSowListRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(DateType, dateType_);
      DARABONBA_PTR_FROM_JSON(EndDate, endDate_);
      DARABONBA_PTR_FROM_JSON(StartDate, startDate_);
      DARABONBA_PTR_FROM_JSON(SuspEventSource, suspEventSource_);
    };
    GetSowListRequest() = default ;
    GetSowListRequest(const GetSowListRequest &) = default ;
    GetSowListRequest(GetSowListRequest &&) = default ;
    GetSowListRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSowListRequest() = default ;
    GetSowListRequest& operator=(const GetSowListRequest &) = default ;
    GetSowListRequest& operator=(GetSowListRequest &&) = default ;
    ...
    inline GetSowListRequest& setDateType(string dateType) { DARABONBA_PTR_SET_VALUE(dateType_, dateType) };
    ...
    inline GetSowListRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetSowListRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
    ...
    inline GetSowListRequest& setSuspEventSource(string suspEventSource) { DARABONBA_PTR_SET_VALUE(suspEventSource_, suspEventSource) };
