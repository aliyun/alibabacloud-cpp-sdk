...
#ifndef ALIBABACLOUD_MODELS_GETSAFETYCOVERRESPONSEBODYDATACFWPROTECTION_HPP_
#define ALIBABACLOUD_MODELS_GETSAFETYCOVERRESPONSEBODYDATACFWPROTECTION_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSafetyCoverResponseBodyDataCfwProtection& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSafetyCoverResponseBodyDataCfwProtection& obj) { 
    ...
    GetSafetyCoverResponseBodyDataCfwProtection() = default ;
    GetSafetyCoverResponseBodyDataCfwProtection(const GetSafetyCoverResponseBodyDataCfwProtection &) = default ;
    GetSafetyCoverResponseBodyDataCfwProtection(GetSafetyCoverResponseBodyDataCfwProtection &&) = default ;
    GetSafetyCoverResponseBodyDataCfwProtection(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSafetyCoverResponseBodyDataCfwProtection() = default ;
    GetSafetyCoverResponseBodyDataCfwProtection& operator=(const GetSafetyCoverResponseBodyDataCfwProtection &) = default ;
    GetSafetyCoverResponseBodyDataCfwProtection& operator=(GetSafetyCoverResponseBodyDataCfwProtection &&) = default ;
    ...
    inline GetSafetyCoverResponseBodyDataCfwProtection& setNoProtectionCount(int64_t noProtectionCount) { DARABONBA_PTR_SET_VALUE(noProtectionCount_, noProtectionCount) };
    ...
    inline GetSafetyCoverResponseBodyDataCfwProtection& setProtectionCount(int64_t protectionCount) { DARABONBA_PTR_SET_VALUE(protectionCount_, protectionCount) };
    ...
    inline GetSafetyCoverResponseBodyDataCfwProtection& setProtectionGrowthRate(string protectionGrowthRate) { DARABONBA_PTR_SET_VALUE(protectionGrowthRate_, protectionGrowthRate) };
    ...
    inline GetSafetyCoverResponseBodyDataCfwProtection& setProtectionRate(string protectionRate) { DARABONBA_PTR_SET_VALUE(protectionRate_, protectionRate) };
    ...
    inline GetSafetyCoverResponseBodyDataCfwProtection& setTotalCount(int64_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
