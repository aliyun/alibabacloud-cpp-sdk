...
#ifndef ALIBABACLOUD_MODELS_GETATTACKEDASSETDEALREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETATTACKEDASSETDEALREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAttackedAssetDealRequest& obj) { 
      DARABONBA_PTR_TO_JSON(DateType, dateType_);
      DARABONBA_PTR_TO_JSON(EndDate, endDate_);
      DARABONBA_PTR_TO_JSON(StartDate, startDate_);
      DARABONBA_PTR_TO_JSON(SuspEventSource, suspEventSource_);
    };
    friend void from_json(const Darabonba::Json& j, GetAttackedAssetDealRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(DateType, dateType_);
      DARABONBA_PTR_FROM_JSON(EndDate, endDate_);
      DARABONBA_PTR_FROM_JSON(StartDate, startDate_);
      DARABONBA_PTR_FROM_JSON(SuspEventSource, suspEventSource_);
    };
    GetAttackedAssetDealRequest() = default ;
    GetAttackedAssetDealRequest(const GetAttackedAssetDealRequest &) = default ;
    GetAttackedAssetDealRequest(GetAttackedAssetDealRequest &&) = default ;
    GetAttackedAssetDealRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAttackedAssetDealRequest() = default ;
    GetAttackedAssetDealRequest& operator=(const GetAttackedAssetDealRequest &) = default ;
    GetAttackedAssetDealRequest& operator=(GetAttackedAssetDealRequest &&) = default ;
    ...
    inline GetAttackedAssetDealRequest& setDateType(string dateType) { DARABONBA_PTR_SET_VALUE(dateType_, dateType) };
    ...
    inline GetAttackedAssetDealRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetAttackedAssetDealRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
    ...
    inline GetAttackedAssetDealRequest& setSuspEventSource(string suspEventSource) { DARABONBA_PTR_SET_VALUE(suspEventSource_, suspEventSource) };
