...
#ifndef ALIBABACLOUD_MODELS_GETSAFETYCOVERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETSAFETYCOVERREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSafetyCoverRequest& obj) { 
      DARABONBA_PTR_TO_JSON(DateType, dateType_);
      DARABONBA_PTR_TO_JSON(EndDate, endDate_);
      DARABONBA_PTR_TO_JSON(StartDate, startDate_);
      DARABONBA_PTR_TO_JSON(SuspEventSource, suspEventSource_);
    };
    friend void from_json(const Darabonba::Json& j, GetSafetyCoverRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(DateType, dateType_);
      DARABONBA_PTR_FROM_JSON(EndDate, endDate_);
      DARABONBA_PTR_FROM_JSON(StartDate, startDate_);
      DARABONBA_PTR_FROM_JSON(SuspEventSource, suspEventSource_);
    };
    GetSafetyCoverRequest() = default ;
    GetSafetyCoverRequest(const GetSafetyCoverRequest &) = default ;
    GetSafetyCoverRequest(GetSafetyCoverRequest &&) = default ;
    GetSafetyCoverRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSafetyCoverRequest() = default ;
    GetSafetyCoverRequest& operator=(const GetSafetyCoverRequest &) = default ;
    GetSafetyCoverRequest& operator=(GetSafetyCoverRequest &&) = default ;
    ...
    inline GetSafetyCoverRequest& setDateType(string dateType) { DARABONBA_PTR_SET_VALUE(dateType_, dateType) };
    ...
    inline GetSafetyCoverRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetSafetyCoverRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
    ...
    inline GetSafetyCoverRequest& setSuspEventSource(string suspEventSource) { DARABONBA_PTR_SET_VALUE(suspEventSource_, suspEventSource) };
