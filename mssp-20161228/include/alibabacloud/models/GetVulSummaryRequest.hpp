...
#ifndef ALIBABACLOUD_MODELS_GETVULSUMMARYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETVULSUMMARYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetVulSummaryRequest& obj) { 
      DARABONBA_PTR_TO_JSON(DateType, dateType_);
      DARABONBA_PTR_TO_JSON(EndDate, endDate_);
      DARABONBA_PTR_TO_JSON(StartDate, startDate_);
      DARABONBA_PTR_TO_JSON(SuspEventSource, suspEventSource_);
    };
    friend void from_json(const Darabonba::Json& j, GetVulSummaryRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(DateType, dateType_);
      DARABONBA_PTR_FROM_JSON(EndDate, endDate_);
      DARABONBA_PTR_FROM_JSON(StartDate, startDate_);
      DARABONBA_PTR_FROM_JSON(SuspEventSource, suspEventSource_);
    };
    GetVulSummaryRequest() = default ;
    GetVulSummaryRequest(const GetVulSummaryRequest &) = default ;
    GetVulSummaryRequest(GetVulSummaryRequest &&) = default ;
    GetVulSummaryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetVulSummaryRequest() = default ;
    GetVulSummaryRequest& operator=(const GetVulSummaryRequest &) = default ;
    GetVulSummaryRequest& operator=(GetVulSummaryRequest &&) = default ;
    ...
    inline GetVulSummaryRequest& setDateType(string dateType) { DARABONBA_PTR_SET_VALUE(dateType_, dateType) };
    ...
    inline GetVulSummaryRequest& setEndDate(int64_t endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline GetVulSummaryRequest& setStartDate(int64_t startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
    ...
    inline GetVulSummaryRequest& setSuspEventSource(string suspEventSource) { DARABONBA_PTR_SET_VALUE(suspEventSource_, suspEventSource) };
