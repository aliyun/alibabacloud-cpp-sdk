 ...
 */
AddKnowledgeFileResponse Client::addKnowledgeFileWithOptions(const AddKnowledgeFileRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  ...
  if (!!request.hasUploadUser()) {
    query["UploadUser"] = request.getUploadUser();
  }
  ...
  return json(callApi(params, req, runtime)).get<AddKnowledgeFileResponse>();
}
...
ApplyAdviceByIdResponse Client::applyAdviceByIdWithOptions(const ApplyAdviceByIdRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasAdviceDate()) {
    query["AdviceDate"] = request.getAdviceDate();
  }
  ...
  if (!!request.hasBuildImmediately()) {
    query["BuildImmediately"] = request.getBuildImmediately();
  }
...
BatchApplyAdviceByIdListResponse Client::batchApplyAdviceByIdListWithOptions(const BatchApplyAdviceByIdListRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasAdviceIdList()) {
    query["AdviceIdList"] = request.getAdviceIdList();
  }
 ...
 */
BindAccountResponse Client::bindAccountWithOptions(const BindAccountRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  tmpReq.validate();
  BindAccountShrinkRequest request = BindAccountShrinkRequest();
  ...
  if (!!request.hasRamUser()) {
    query["RamUser"] = request.getRamUser();
  }
...
BindDBResourceGroupWithUserResponse Client::bindDBResourceGroupWithUserWithOptions(const BindDBResourceGroupWithUserRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasGroupUser()) {
    query["GroupUser"] = request.getGroupUser();
  }
...
CancelSparkReplStatementResponse Client::cancelSparkReplStatementWithOptions(const CancelSparkReplStatementRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasStatementId()) {
    body["StatementId"] = request.getStatementId();
  }
...
CancelSparkWarehouseBatchSQLResponse Client::cancelSparkWarehouseBatchSQLWithOptions(const CancelSparkWarehouseBatchSQLRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasAgency()) {
    body["Agency"] = request.getAgency();
  }

  if (!!request.hasDBClusterId()) {
    body["DBClusterId"] = request.getDBClusterId();
  }

  if (!!request.hasQueryId()) {
    body["QueryId"] = request.getQueryId();
  }
 ...
 */
CheckFormationSchemaExistsResponse Client::checkFormationSchemaExistsWithOptions(const CheckFormationSchemaExistsRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasDBClusterId()) {
    body["DBClusterId"] = request.getDBClusterId();
  ...
  if (!!request.hasPrefixMode()) {
    body["PrefixMode"] = request.getPrefixMode();
  }
  ...
  return json(callApi(params, req, runtime)).get<CheckFormationSchemaExistsResponse>();
}
 ...
 * @return CheckFormationSchemaExistsResponse
 */
CheckFormationSchemaExistsResponse Client::checkFormationSchemaExists(const CheckFormationSchemaExistsRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return checkFormationSchemaExistsWithOptions(request, runtime);
}
...
ConfigureResultExportResponse Client::configureResultExportWithOptions(const ConfigureResultExportRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!tmpReq.hasOssInfo()) {
    request.setOssInfoShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getOssInfo(), "OssInfo", "json"));
  }

  if (!!tmpReq.hasSlsInfo()) {
    request.setSlsInfoShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getSlsInfo(), "SlsInfo", "json"));
  }
  ...
  if (!!request.hasOssInfoShrink()) {
    body["OssInfo"] = request.getOssInfoShrink();
  }
  ...
  if (!!request.hasSlsInfoShrink()) {
    body["SlsInfo"] = request.getSlsInfoShrink();
  }
...
CreateAPSJobResponse Client::createAPSJobWithOptions(const CreateAPSJobRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasApsJobName()) {
    body["ApsJobName"] = request.getApsJobName();
  }
  ...
  if (!!request.hasDestinationEndpointInstanceID()) {
    body["DestinationEndpointInstanceID"] = request.getDestinationEndpointInstanceID();
  }

  if (!!request.hasDestinationEndpointPassword()) {
    body["DestinationEndpointPassword"] = request.getDestinationEndpointPassword();
  }

  if (!!request.hasDestinationEndpointUserName()) {
    body["DestinationEndpointUserName"] = request.getDestinationEndpointUserName();
  }

  if (!!request.hasPartitionList()) {
    body["PartitionList"] = request.getPartitionList();
  }
  ...
  if (!!request.hasSourceEndpointInstanceID()) {
    body["SourceEndpointInstanceID"] = request.getSourceEndpointInstanceID();
  }

  if (!!request.hasSourceEndpointPassword()) {
    body["SourceEndpointPassword"] = request.getSourceEndpointPassword();
  }

  if (!!request.hasSourceEndpointRegion()) {
    body["SourceEndpointRegion"] = request.getSourceEndpointRegion();
  }

  if (!!request.hasSourceEndpointUserName()) {
    body["SourceEndpointUserName"] = request.getSourceEndpointUserName();
  }

  if (!!request.hasTargetTableMode()) {
    body["TargetTableMode"] = request.getTargetTableMode();
  }
...
CreateApsCopyWorkloadResponse Client::createApsCopyWorkloadWithOptions(const CreateApsCopyWorkloadRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasWorkloadId()) {
    body["WorkloadId"] = request.getWorkloadId();
  }

  if (!!request.hasWorkloadType()) {
    body["WorkloadType"] = request.getWorkloadType();
  }
...
CreateApsDatasoureResponse Client::createApsDatasoureWithOptions(const CreateApsDatasoureRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!tmpReq.hasDatabricksInfo()) {
    request.setDatabricksInfoShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getDatabricksInfo(), "DatabricksInfo", "json"));
  }

  if (!!tmpReq.hasHiveInfo()) {
    request.setHiveInfoShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getHiveInfo(), "HiveInfo", "json"));
  }

  if (!!tmpReq.hasKafkaInfo()) {
    request.setKafkaInfoShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getKafkaInfo(), "KafkaInfo", "json"));
  }

  if (!!tmpReq.hasPolarDBMysqlInfo()) {
    request.setPolarDBMysqlInfoShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getPolarDBMysqlInfo(), "PolarDBMysqlInfo", "json"));
  }

  if (!!tmpReq.hasPolarDBXInfo()) {
    request.setPolarDBXInfoShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getPolarDBXInfo(), "PolarDBXInfo", "json"));
  }

  if (!!tmpReq.hasRdsMysqlInfo()) {
    request.setRdsMysqlInfoShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getRdsMysqlInfo(), "RdsMysqlInfo", "json"));
  }
  ...
  if (!!request.hasDatabricksInfoShrink()) {
    body["DatabricksInfo"] = request.getDatabricksInfoShrink();
  }

  if (!!request.hasDatasourceDescription()) {
    body["DatasourceDescription"] = request.getDatasourceDescription();
  }
  ...
  if (!!request.hasHiveInfoShrink()) {
    body["HiveInfo"] = request.getHiveInfoShrink();
  }

  if (!!request.hasKafkaInfoShrink()) {
    body["KafkaInfo"] = request.getKafkaInfoShrink();
  }
  ...
  if (!!request.hasPolarDBMysqlInfoShrink()) {
    body["PolarDBMysqlInfo"] = request.getPolarDBMysqlInfoShrink();
  }

  if (!!request.hasPolarDBXInfoShrink()) {
    body["PolarDBXInfo"] = request.getPolarDBXInfoShrink();
  }

  if (!!request.hasRdsMysqlInfoShrink()) {
    body["RdsMysqlInfo"] = request.getRdsMysqlInfoShrink();
  }
...
CreateApsHiveJobResponse Client::createApsHiveJobWithOptions(const CreateApsHiveJobRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasConflictStrategy()) {
    body["ConflictStrategy"] = request.getConflictStrategy();
  }
  ...
  if (!!request.hasFullComputeUnit()) {
    body["FullComputeUnit"] = request.getFullComputeUnit();
  }

  if (!!request.hasOssLocation()) {
    body["OssLocation"] = request.getOssLocation();
  }
  ...
  if (!!request.hasResourceGroup()) {
    body["ResourceGroup"] = request.getResourceGroup();
  }

  if (!!request.hasSyncAllowExpression()) {
    body["SyncAllowExpression"] = request.getSyncAllowExpression();
  }

  if (!!request.hasSyncDenyExpression()) {
    body["SyncDenyExpression"] = request.getSyncDenyExpression();
  }
  ...
  if (!!request.hasWorkloadName()) {
    body["WorkloadName"] = request.getWorkloadName();
  }
...
CreateApsKafkaHudiJobResponse Client::createApsKafkaHudiJobWithOptions(const CreateApsKafkaHudiJobRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!tmpReq.hasPartitionSpecs()) {
    request.setPartitionSpecsShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getPartitionSpecs(), "PartitionSpecs", "json"));
  }

  json body = {};
  if (!!request.hasAcrossRole()) {
    body["AcrossRole"] = request.getAcrossRole();
  }

  if (!!request.hasAcrossUid()) {
    body["AcrossUid"] = request.getAcrossUid();
  }
  ...
  if (!!request.hasColumnsShrink()) {
    body["Columns"] = request.getColumnsShrink();
  }
  ...
  if (!!request.hasDataFormatType()) {
    body["DataFormatType"] = request.getDataFormatType();
  }

  if (!!request.hasDataOutputFormat()) {
    body["DataOutputFormat"] = request.getDataOutputFormat();
  }
  ...
  if (!!request.hasHudiAdvancedConfig()) {
    body["HudiAdvancedConfig"] = request.getHudiAdvancedConfig();
  }

  if (!!request.hasIncrementalComputeUnit()) {
    body["IncrementalComputeUnit"] = request.getIncrementalComputeUnit();
  }

  if (!!request.hasJsonParseLevel()) {
    body["JsonParseLevel"] = request.getJsonParseLevel();
  }

  if (!!request.hasKafkaClusterId()) {
    body["KafkaClusterId"] = request.getKafkaClusterId();
  }

  if (!!request.hasKafkaTopic()) {
    body["KafkaTopic"] = request.getKafkaTopic();
  }

  if (!!request.hasLakehouseId()) {
    body["LakehouseId"] = request.getLakehouseId();
  }

  if (!!request.hasMaxOffsetsPerTrigger()) {
    body["MaxOffsetsPerTrigger"] = request.getMaxOffsetsPerTrigger();
  }
  ...
  if (!!request.hasPartitionSpecsShrink()) {
    body["PartitionSpecs"] = request.getPartitionSpecsShrink();
  }

  if (!!request.hasPrimaryKeyDefinition()) {
    body["PrimaryKeyDefinition"] = request.getPrimaryKeyDefinition();
  }
  ...
  if (!!request.hasSourceRegionId()) {
    body["SourceRegionId"] = request.getSourceRegionId();
  }

  if (!!request.hasStartingOffsets()) {
    body["StartingOffsets"] = request.getStartingOffsets();
  }
  ...
  if (!!request.hasTargetGenerateRule()) {
    body["TargetGenerateRule"] = request.getTargetGenerateRule();
  }
...
CreateApsSlsADBJobResponse Client::createApsSlsADBJobWithOptions(const CreateApsSlsADBJobRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!tmpReq.hasUnixTimestampConvert()) {
    request.setUnixTimestampConvertShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getUnixTimestampConvert(), "UnixTimestampConvert", "json"));
  }
  ...
  if (!!request.hasDirtyDataHandleMode()) {
    body["DirtyDataHandleMode"] = request.getDirtyDataHandleMode();
  }

  if (!!request.hasDirtyDataProcessPattern()) {
    body["DirtyDataProcessPattern"] = request.getDirtyDataProcessPattern();
  }

  if (!!request.hasExactlyOnce()) {
    body["ExactlyOnce"] = request.getExactlyOnce();
  }
  ...
  if (!!request.hasUnixTimestampConvertShrink()) {
    body["UnixTimestampConvert"] = request.getUnixTimestampConvertShrink();
  }
...
CreateApsWebhookResponse Client::createApsWebhookWithOptions(const CreateApsWebhookRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!tmpReq.hasWebhook()) {
    request.setWebhookShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getWebhook(), "Webhook", "json"));
  }
  ...
  if (!!request.hasWebhookShrink()) {
    body["Webhook"] = request.getWebhookShrink();
  }
...
CreateDBClusterResponse Client::createDBClusterWithOptions(const CreateDBClusterRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasAINodeNumber()) {
    query["AINodeNumber"] = request.getAINodeNumber();
  }

  if (!!request.hasAINodeSpec()) {
    query["AINodeSpec"] = request.getAINodeSpec();
  }
  ...
  if (!!request.hasCloneSourceRegionId()) {
    query["CloneSourceRegionId"] = request.getCloneSourceRegionId();
  }

  if (!!request.hasComputeResource()) {
    query["ComputeResource"] = request.getComputeResource();
  }
  ...
  if (!!request.hasDBClusterNetworkType()) {
    query["DBClusterNetworkType"] = request.getDBClusterNetworkType();
  }

  if (!!request.hasDBClusterVersion()) {
    query["DBClusterVersion"] = request.getDBClusterVersion();
  }

  if (!!request.hasDiskEncryption()) {
    query["DiskEncryption"] = request.getDiskEncryption();
  }

  if (!!request.hasEnableDefaultResourcePool()) {
    query["EnableDefaultResourcePool"] = request.getEnableDefaultResourcePool();
  }
  ...
  if (!!request.hasProductForm()) {
    query["ProductForm"] = request.getProductForm();
  }
  ...
  if (!!request.hasReservedNodeCount()) {
    query["ReservedNodeCount"] = request.getReservedNodeCount();
  }

  if (!!request.hasReservedNodeSize()) {
    query["ReservedNodeSize"] = request.getReservedNodeSize();
  }
  ...
  if (!!request.hasRestoreToTime()) {
    query["RestoreToTime"] = request.getRestoreToTime();
  }
  ...
  if (!!request.hasSecondaryVSwitchId()) {
    query["SecondaryVSwitchId"] = request.getSecondaryVSwitchId();
  }
  ...
  if (!!request.hasStorageResource()) {
    query["StorageResource"] = request.getStorageResource();
  }
...
CreateDBResourceGroupResponse Client::createDBResourceGroupWithOptions(const CreateDBResourceGroupRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  Utils::Utils::convert(tmpReq, request);
  if (!!tmpReq.hasAtmConfig()) {
    request.setAtmConfigShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getAtmConfig(), "AtmConfig", "json"));
  }

  if (!!tmpReq.hasEngineParams()) {
    request.setEngineParamsShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getEngineParams(), "EngineParams", "json"));
  }

  if (!!tmpReq.hasGpuElasticPlan()) {
    request.setGpuElasticPlanShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getGpuElasticPlan(), "GpuElasticPlan", "json"));
  }
  ...
  json query = {};
  if (!!request.hasAtmConfigShrink()) {
    query["AtmConfig"] = request.getAtmConfigShrink();
  }

  if (!!request.hasAutoStopInterval()) {
    query["AutoStopInterval"] = request.getAutoStopInterval();
  }

  if (!!request.hasClassification()) {
    query["Classification"] = request.getClassification();
  }
  ...
  if (!!request.hasClusterSizeResource()) {
    query["ClusterSizeResource"] = request.getClusterSizeResource();
  }
  ...
  if (!!request.hasEnableSpot()) {
    query["EnableSpot"] = request.getEnableSpot();
  }
  ...
  if (!!request.hasEngineParamsShrink()) {
    query["EngineParams"] = request.getEngineParamsShrink();
  }

  if (!!request.hasGpuElasticPlanShrink()) {
    query["GpuElasticPlan"] = request.getGpuElasticPlanShrink();
  }
  ...
  if (!!request.hasMaxClusterCount()) {
    query["MaxClusterCount"] = request.getMaxClusterCount();
  }

  if (!!request.hasMaxComputeResource()) {
    query["MaxComputeResource"] = request.getMaxComputeResource();
  }

  if (!!request.hasMaxGpuQuantity()) {
    query["MaxGpuQuantity"] = request.getMaxGpuQuantity();
  }

  if (!!request.hasMinClusterCount()) {
    query["MinClusterCount"] = request.getMinClusterCount();
  }

  if (!!request.hasMinComputeResource()) {
    query["MinComputeResource"] = request.getMinComputeResource();
  }

  if (!!request.hasMinGpuQuantity()) {
    query["MinGpuQuantity"] = request.getMinGpuQuantity();
  }
  ...
  if (!!request.hasScalePolicy()) {
    query["ScalePolicy"] = request.getScalePolicy();
  }

  if (!!request.hasSpecName()) {
    query["SpecName"] = request.getSpecName();
  }

  if (!!request.hasTargetResourceGroupName()) {
    query["TargetResourceGroupName"] = request.getTargetResourceGroupName();
  }
...
CreateElasticPlanResponse Client::createElasticPlanWithOptions(const CreateElasticPlanRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasElasticPlanName()) {
    query["ElasticPlanName"] = request.getElasticPlanName();
  }
  ...
  if (!!request.hasTargetSize()) {
    query["TargetSize"] = request.getTargetSize();
  }
 ...
 */
CreateFormationCrawlerResponse Client::createFormationCrawlerWithOptions(const CreateFormationCrawlerRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasCrawlerInfo()) {
    body["CrawlerInfo"] = request.getCrawlerInfo();
  }
  ...
  return json(callApi(params, req, runtime)).get<CreateFormationCrawlerResponse>();
}
 ...
 * @return CreateFormationCrawlerResponse
 */
CreateFormationCrawlerResponse Client::createFormationCrawler(const CreateFormationCrawlerRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return createFormationCrawlerWithOptions(request, runtime);
}
...
CreateMaterializedViewRecommendResponse Client::createMaterializedViewRecommendWithOptions(const CreateMaterializedViewRecommendRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasMinRewriteQueryCount()) {
    query["MinRewriteQueryCount"] = request.getMinRewriteQueryCount();
  }

  if (!!request.hasMinRewriteQueryPattern()) {
    query["MinRewriteQueryPattern"] = request.getMinRewriteQueryPattern();
  }
  ...
  if (!!request.hasScanQueriesRange()) {
    query["ScanQueriesRange"] = request.getScanQueriesRange();
  }

  if (!!request.hasSchedulingDay()) {
    query["SchedulingDay"] = request.getSchedulingDay();
  }

  if (!!request.hasSchedulingPolicy()) {
    query["SchedulingPolicy"] = request.getSchedulingPolicy();
  }

  if (!!request.hasSlowQueryThreshold()) {
    query["SlowQueryThreshold"] = request.getSlowQueryThreshold();
  }
...
CreatePerformanceViewResponse Client::createPerformanceViewWithOptions(const CreatePerformanceViewRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!tmpReq.hasViewDetail()) {
    request.setViewDetailShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getViewDetail(), "ViewDetail", "json"));
  }

  json query = {};
  if (!!request.hasCreateFromViewType()) {
    query["CreateFromViewType"] = request.getCreateFromViewType();
  }
  ...
  if (!!request.hasFillOriginViewKeys()) {
    query["FillOriginViewKeys"] = request.getFillOriginViewKeys();
  }
  ...
  if (!!request.hasViewDetailShrink()) {
    query["ViewDetail"] = request.getViewDetailShrink();
  }

  if (!!request.hasViewName()) {
    query["ViewName"] = request.getViewName();
  }
 ...
 */
CreateSemanticViewResponse Client::createSemanticViewWithOptions(const CreateSemanticViewRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasDBClusterId()) {
    query["DBClusterId"] = request.getDBClusterId();
  ...
  return json(callApi(params, req, runtime)).get<CreateSemanticViewResponse>();
}
 ...
 * @return CreateSemanticViewResponse
 */
CreateSemanticViewResponse Client::createSemanticView(const CreateSemanticViewRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return createSemanticViewWithOptions(request, runtime);
}
...
DeleteApsJobResponse Client::deleteApsJobWithOptions(const DeleteApsJobRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasApsJobId()) {
    body["ApsJobId"] = request.getApsJobId();
  }
...
DeleteBackupsResponse Client::deleteBackupsWithOptions(const DeleteBackupsRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasBackupIds()) {
    query["BackupIds"] = request.getBackupIds();
  }
 ...
 */
DeleteFormationCrawlerResponse Client::deleteFormationCrawlerWithOptions(const DeleteFormationCrawlerRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasCrawlerTaskId()) {
    body["CrawlerTaskId"] = request.getCrawlerTaskId();
  }

  if (!!request.hasCrawlerTaskName()) {
    body["CrawlerTaskName"] = request.getCrawlerTaskName();
  }
  ...
  return json(callApi(params, req, runtime)).get<DeleteFormationCrawlerResponse>();
}
...
DeleteLakeStorageResponse Client::deleteLakeStorageWithOptions(const DeleteLakeStorageRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasLakeStorageId()) {
    body["LakeStorageId"] = request.getLakeStorageId();
  }
 ...
 */
DeleteSemanticViewResponse Client::deleteSemanticViewWithOptions(const DeleteSemanticViewRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasDBClusterId()) {
    query["DBClusterId"] = request.getDBClusterId();
  ...
  return json(callApi(params, req, runtime)).get<DeleteSemanticViewResponse>();
}
 ...
 * @return DeleteSemanticViewResponse
 */
DeleteSemanticViewResponse Client::deleteSemanticView(const DeleteSemanticViewRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return deleteSemanticViewWithOptions(request, runtime);
}
...
DescribeAccountPrivilegeObjectsResponse Client::describeAccountPrivilegeObjectsWithOptions(const DescribeAccountPrivilegeObjectsRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasColumnPrivilegeObject()) {
    query["ColumnPrivilegeObject"] = request.getColumnPrivilegeObject();
  }
  ...
  if (!!request.hasDatabasePrivilegeObject()) {
    query["DatabasePrivilegeObject"] = request.getDatabasePrivilegeObject();
  }
  ...
  if (!!request.hasTablePrivilegeObject()) {
    query["TablePrivilegeObject"] = request.getTablePrivilegeObject();
  }
...
DescribeAppliedAdvicesResponse Client::describeAppliedAdvicesWithOptions(const DescribeAppliedAdvicesRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasAdviceType()) {
    query["AdviceType"] = request.getAdviceType();
  }
  ...
  if (!!request.hasSchemaTableName()) {
    query["SchemaTableName"] = request.getSchemaTableName();
  }
...
DescribeApsActionLogsResponse Client::describeApsActionLogsWithOptions(const DescribeApsActionLogsRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasWorkloadId()) {
    query["WorkloadId"] = request.getWorkloadId();
  }
...
DescribeAuditLogRecordsResponse Client::describeAuditLogRecordsWithOptions(const DescribeAuditLogRecordsRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasSucceed()) {
    query["Succeed"] = request.getSucceed();
  }
...
DescribeAutoRenewalAttributeResponse Client::describeAutoRenewalAttributeWithOptions(const DescribeAutoRenewalAttributeRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!tmpReq.hasDBClusterId()) {
    request.setDBClusterIdShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getDBClusterId(), "DBClusterId", "json"));
  }

  json query = {};
  if (!!request.hasDBClusterIdShrink()) {
    query["DBClusterId"] = request.getDBClusterIdShrink();
  }
...
DescribeDBClusterPerformanceResponse Client::describeDBClusterPerformanceWithOptions(const DescribeDBClusterPerformanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasResourcePools()) {
    query["ResourcePools"] = request.getResourcePools();
  }
...
DescribeDiagnosisRecordsResponse Client::describeDiagnosisRecordsWithOptions(const DescribeDiagnosisRecordsRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasMaxPeakMemory()) {
    query["MaxPeakMemory"] = request.getMaxPeakMemory();
  }

  if (!!request.hasMaxScanSize()) {
    query["MaxScanSize"] = request.getMaxScanSize();
  }

  if (!!request.hasMinPeakMemory()) {
    query["MinPeakMemory"] = request.getMinPeakMemory();
  }

  if (!!request.hasMinScanSize()) {
    query["MinScanSize"] = request.getMinScanSize();
  }
  ...
  if (!!request.hasPatternId()) {
    query["PatternId"] = request.getPatternId();
  }
...
DescribeDiagnosisSQLInfoResponse Client::describeDiagnosisSQLInfoWithOptions(const DescribeDiagnosisSQLInfoRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasProcessRcHost()) {
    query["ProcessRcHost"] = request.getProcessRcHost();
  }

  if (!!request.hasProcessStartTime()) {
    query["ProcessStartTime"] = request.getProcessStartTime();
  }

  if (!!request.hasProcessState()) {
    query["ProcessState"] = request.getProcessState();
  }
...
DescribeJobResourceUsageResponse Client::describeJobResourceUsageWithOptions(const DescribeJobResourceUsageRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasSparkAppName()) {
    query["SparkAppName"] = request.getSparkAppName();
  }
...
DescribeMVRecommendResultsResponse Client::describeMVRecommendResultsWithOptions(const DescribeMVRecommendResultsRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasActionInner()) {
    query["ActionInner"] = request.getActionInner();
  }
  ...
  if (!!request.hasSubQueryId()) {
    query["SubQueryId"] = request.getSubQueryId();
  }
...
DescribeProcessListResponse Client::describeProcessListWithOptions(const DescribeProcessListRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasRunningTime()) {
    query["RunningTime"] = request.getRunningTime();
  }

  if (!!request.hasShowFull()) {
    query["ShowFull"] = request.getShowFull();
  }
...
DescribeSQLPatternsResponse Client::describeSQLPatternsWithOptions(const DescribeSQLPatternsRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasSqlPatternHash()) {
    query["SqlPatternHash"] = request.getSqlPatternHash();
  }
...
DescribeSparkAuditLogRecordsResponse Client::describeSparkAuditLogRecordsWithOptions(const DescribeSparkAuditLogRecordsRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasStatementId()) {
    query["StatementId"] = request.getStatementId();
  }

  if (!!request.hasStatementSource()) {
    query["StatementSource"] = request.getStatementSource();
  }
...
DescribeSparkSQLDiagnosisAttributeResponse Client::describeSparkSQLDiagnosisAttributeWithOptions(const DescribeSparkSQLDiagnosisAttributeRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasInnerQueryId()) {
    query["InnerQueryId"] = request.getInnerQueryId();
  }
...
DescribeSparkSQLDiagnosisListResponse Client::describeSparkSQLDiagnosisListWithOptions(const DescribeSparkSQLDiagnosisListRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasMaxStartTime()) {
    query["MaxStartTime"] = request.getMaxStartTime();
  }

  if (!!request.hasMinStartTime()) {
    query["MinStartTime"] = request.getMinStartTime();
  }
...
DescribeSqlPatternResponse Client::describeSqlPatternWithOptions(const DescribeSqlPatternRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasSqlPattern()) {
    query["SqlPattern"] = request.getSqlPattern();
  }
...
DescribeViewJobsResponse Client::describeViewJobsWithOptions(const DescribeViewJobsRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasFilterOwner()) {
    query["FilterOwner"] = request.getFilterOwner();
  }

  if (!!request.hasFilterViewName()) {
    query["FilterViewName"] = request.getFilterViewName();
  }

  if (!!request.hasFilterViewType()) {
    query["FilterViewType"] = request.getFilterViewType();
  }
...
ExecuteSparkWarehouseBatchSQLResponse Client::executeSparkWarehouseBatchSQLWithOptions(const ExecuteSparkWarehouseBatchSQLRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasExecuteResultLimit()) {
    body["ExecuteResultLimit"] = request.getExecuteResultLimit();
  }

  if (!!request.hasExecuteTimeLimitInSeconds()) {
    body["ExecuteTimeLimitInSeconds"] = request.getExecuteTimeLimitInSeconds();
  }
  ...
  if (!!request.hasResourceGroupName()) {
    body["ResourceGroupName"] = request.getResourceGroupName();
  }

  if (!!request.hasRuntimeConfig()) {
    body["RuntimeConfig"] = request.getRuntimeConfig();
  }
 ...
 */
GenerateSqlBySemanticSqlResponse Client::generateSqlBySemanticSqlWithOptions(const GenerateSqlBySemanticSqlRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasDBClusterId()) {
    query["DBClusterId"] = request.getDBClusterId();
  ...
  return json(callApi(params, req, runtime)).get<GenerateSqlBySemanticSqlResponse>();
}
 ...
 * @return GenerateSqlBySemanticSqlResponse
 */
GenerateSqlBySemanticSqlResponse Client::generateSqlBySemanticSql(const GenerateSqlBySemanticSqlRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return generateSqlBySemanticSqlWithOptions(request, runtime);
}
...
GetDatabaseObjectsResponse Client::getDatabaseObjectsWithOptions(const GetDatabaseObjectsRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasFilterSchemaName()) {
    query["FilterSchemaName"] = request.getFilterSchemaName();
  }
 ...
 */
GetFormationCrawlerResponse Client::getFormationCrawlerWithOptions(const GetFormationCrawlerRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasCrawlerTaskId()) {
    body["CrawlerTaskId"] = request.getCrawlerTaskId();
  ...
  return json(callApi(params, req, runtime)).get<GetFormationCrawlerResponse>();
}
 ...
 * @return GetFormationCrawlerResponse
 */
GetFormationCrawlerResponse Client::getFormationCrawler(const GetFormationCrawlerRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return getFormationCrawlerWithOptions(request, runtime);
}
 ...
 */
GetKnowledgeRecallResponse Client::getKnowledgeRecallWithOptions(const GetKnowledgeRecallRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasDBClusterId()) {
    query["DBClusterId"] = request.getDBClusterId();
  ...
  return json(callApi(params, req, runtime)).get<GetKnowledgeRecallResponse>();
}
 ...
 * @return GetKnowledgeRecallResponse
 */
GetKnowledgeRecallResponse Client::getKnowledgeRecall(const GetKnowledgeRecallRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return getKnowledgeRecallWithOptions(request, runtime);
}
...
GetLakeStorageResponse Client::getLakeStorageWithOptions(const GetLakeStorageRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasLakeStorageId()) {
    query["LakeStorageId"] = request.getLakeStorageId();
  }
 ...
 */
GetSemanticViewResponse Client::getSemanticViewWithOptions(const GetSemanticViewRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasDBClusterId()) {
    query["DBClusterId"] = request.getDBClusterId();
  ...
  return json(callApi(params, req, runtime)).get<GetSemanticViewResponse>();
}
 ...
 * @return GetSemanticViewResponse
 */
GetSemanticViewResponse Client::getSemanticView(const GetSemanticViewRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return getSemanticViewWithOptions(request, runtime);
}
...
GetSparkAppAttemptLogResponse Client::getSparkAppAttemptLogWithOptions(const GetSparkAppAttemptLogRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasAttemptId()) {
    body["AttemptId"] = request.getAttemptId();
  }

  if (!!request.hasLogLength()) {
    body["LogLength"] = request.getLogLength();
  }
...
GetTableObjectsResponse Client::getTableObjectsWithOptions(const GetTableObjectsRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasFilterDescription()) {
    query["FilterDescription"] = request.getFilterDescription();
  }
  ...
  if (!!request.hasFilterTblName()) {
    query["FilterTblName"] = request.getFilterTblName();
  }

  if (!!request.hasFilterTblType()) {
    query["FilterTblType"] = request.getFilterTblType();
  }
...
GetViewObjectsResponse Client::getViewObjectsWithOptions(const GetViewObjectsRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasShowMvBaseTable()) {
    query["ShowMvBaseTable"] = request.getShowMvBaseTable();
  }
...
ListResultExportJobHistoryResponse Client::listResultExportJobHistoryWithOptions(const ListResultExportJobHistoryRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  Utils::Utils::convert(tmpReq, request);
  if (!!tmpReq.hasOrder()) {
    request.setOrderShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getOrder(), "Order", "json"));
  }
  ...
  if (!!request.hasDatabaseUser()) {
    body["DatabaseUser"] = request.getDatabaseUser();
  }
  ...
  if (!!request.hasOrderShrink()) {
    body["Order"] = request.getOrderShrink();
  }
  ...
  if (!!request.hasStatusListShrink()) {
    body["StatusList"] = request.getStatusListShrink();
  }
 ...
 */
ListSemanticViewNamesResponse Client::listSemanticViewNamesWithOptions(const ListSemanticViewNamesRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasDBClusterId()) {
    query["DBClusterId"] = request.getDBClusterId();
  ...
  return json(callApi(params, req, runtime)).get<ListSemanticViewNamesResponse>();
}
 ...
 * @return ListSemanticViewNamesResponse
 */
ListSemanticViewNamesResponse Client::listSemanticViewNames(const ListSemanticViewNamesRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return listSemanticViewNamesWithOptions(request, runtime);
}
...
ModifyAccountPrivilegesResponse Client::modifyAccountPrivilegesWithOptions(const ModifyAccountPrivilegesRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasAccountPrivilegesShrink()) {
    query["AccountPrivileges"] = request.getAccountPrivilegesShrink();
  }
...
ModifyApsDatasoureResponse Client::modifyApsDatasoureWithOptions(const ModifyApsDatasoureRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!tmpReq.hasLakehouseId()) {
    request.setLakehouseIdShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getLakehouseId(), "LakehouseId", "json"));
  }
  ...
  if (!!request.hasLakehouseIdShrink()) {
    body["LakehouseId"] = request.getLakehouseIdShrink();
  }
...
ModifyApsSlsADBJobResponse Client::modifyApsSlsADBJobWithOptions(const ModifyApsSlsADBJobRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasUnixTimestampConvert()) {
    body["UnixTimestampConvert"] = request.getUnixTimestampConvert();
  }
...
ModifyAuditLogConfigResponse Client::modifyAuditLogConfigWithOptions(const ModifyAuditLogConfigRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasAuditLogStatus()) {
    query["AuditLogStatus"] = request.getAuditLogStatus();
  }
...
ModifyAutoRenewalAttributeResponse Client::modifyAutoRenewalAttributeWithOptions(const ModifyAutoRenewalAttributeRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasAutoRenewalPeriod()) {
    query["AutoRenewalPeriod"] = request.getAutoRenewalPeriod();
  }

  if (!!request.hasAutoRenewalPeriodUnit()) {
    query["AutoRenewalPeriodUnit"] = request.getAutoRenewalPeriodUnit();
  }

  if (!!request.hasAutoRenewalStatus()) {
    query["AutoRenewalStatus"] = request.getAutoRenewalStatus();
  }
...
ModifyCompactionServiceSwitchResponse Client::modifyCompactionServiceSwitchWithOptions(const ModifyCompactionServiceSwitchRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasEnableCompactionService()) {
    query["EnableCompactionService"] = request.getEnableCompactionService();
  }
...
ModifyDBClusterVipResponse Client::modifyDBClusterVipWithOptions(const ModifyDBClusterVipRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasConnectString()) {
    query["ConnectString"] = request.getConnectString();
  }
...
ModifyEssdCacheConfigResponse Client::modifyEssdCacheConfigWithOptions(const ModifyEssdCacheConfigRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasEnableEssdCache()) {
    query["EnableEssdCache"] = request.getEnableEssdCache();
  }

  if (!!request.hasEssdCacheSize()) {
    query["EssdCacheSize"] = request.getEssdCacheSize();
  }
...
ModifyLakeCacheSizeResponse Client::modifyLakeCacheSizeWithOptions(const ModifyLakeCacheSizeRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasEnableLakeCache()) {
    query["EnableLakeCache"] = request.getEnableLakeCache();
  }
...
ModifyMaterializedViewResponse Client::modifyMaterializedViewWithOptions(const ModifyMaterializedViewRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasEnableDelayAlert()) {
    query["EnableDelayAlert"] = request.getEnableDelayAlert();
  }

  if (!!request.hasEnableFailureAlert()) {
    query["EnableFailureAlert"] = request.getEnableFailureAlert();
  }
  ...
  if (!!request.hasLatencyTolerance()) {
    query["LatencyTolerance"] = request.getLatencyTolerance();
  }
  ...
  if (!!request.hasQueryWrite()) {
    query["QueryWrite"] = request.getQueryWrite();
  }
...
ModifySqlTemplatePositionResponse Client::modifySqlTemplatePositionWithOptions(const ModifySqlTemplatePositionRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasTargetTemplateGroupId()) {
    query["TargetTemplateGroupId"] = request.getTargetTemplateGroupId();
  }
...
ModifyUserEniVswitchOptionsResponse Client::modifyUserEniVswitchOptionsWithOptions(const ModifyUserEniVswitchOptionsRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasVSwitchOptions()) {
    body["VSwitchOptions"] = request.getVSwitchOptions();
  }
 ...
 */
QueryFormationInstsByTaskIDResponse Client::queryFormationInstsByTaskIDWithOptions(const QueryFormationInstsByTaskIDRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasDBClusterId()) {
    body["DBClusterId"] = request.getDBClusterId();
  ...
  return json(callApi(params, req, runtime)).get<QueryFormationInstsByTaskIDResponse>();
}
 ...
 * @return QueryFormationInstsByTaskIDResponse
 */
QueryFormationInstsByTaskIDResponse Client::queryFormationInstsByTaskID(const QueryFormationInstsByTaskIDRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return queryFormationInstsByTaskIDWithOptions(request, runtime);
}
 ...
 */
QueryFormationTaskByIDResponse Client::queryFormationTaskByIDWithOptions(const QueryFormationTaskByIDRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasDBClusterId()) {
    body["DBClusterId"] = request.getDBClusterId();
  ...
  return json(callApi(params, req, runtime)).get<QueryFormationTaskByIDResponse>();
}
 ...
 * @return QueryFormationTaskByIDResponse
 */
QueryFormationTaskByIDResponse Client::queryFormationTaskByID(const QueryFormationTaskByIDRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return queryFormationTaskByIDWithOptions(request, runtime);
}
 ...
 */
QueryFormationTasksByTypeResponse Client::queryFormationTasksByTypeWithOptions(const QueryFormationTasksByTypeRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasDBClusterId()) {
    body["DBClusterId"] = request.getDBClusterId();
  ...
  return json(callApi(params, req, runtime)).get<QueryFormationTasksByTypeResponse>();
}
 ...
 * @return QueryFormationTasksByTypeResponse
 */
QueryFormationTasksByTypeResponse Client::queryFormationTasksByType(const QueryFormationTasksByTypeRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return queryFormationTasksByTypeWithOptions(request, runtime);
}
 ...
 */
RenameSemanticViewResponse Client::renameSemanticViewWithOptions(const RenameSemanticViewRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasDBClusterId()) {
    query["DBClusterId"] = request.getDBClusterId();
  ...
  if (!!request.hasNewSchemaName()) {
    query["NewSchemaName"] = request.getNewSchemaName();
  }

  if (!!request.hasNewViewName()) {
    query["NewViewName"] = request.getNewViewName();
  }

  if (!!request.hasOldSchemaName()) {
    query["OldSchemaName"] = request.getOldSchemaName();
  }

  if (!!request.hasOldViewName()) {
    query["OldViewName"] = request.getOldViewName();
  }
  ...
  return json(callApi(params, req, runtime)).get<RenameSemanticViewResponse>();
}
 ...
 * @return RenameSemanticViewResponse
 */
RenameSemanticViewResponse Client::renameSemanticView(const RenameSemanticViewRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return renameSemanticViewWithOptions(request, runtime);
}
 ...
 */
ReplaceSemanticViewResponse Client::replaceSemanticViewWithOptions(const ReplaceSemanticViewRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasDBClusterId()) {
    query["DBClusterId"] = request.getDBClusterId();
  ...
  return json(callApi(params, req, runtime)).get<ReplaceSemanticViewResponse>();
}
 ...
 * @return ReplaceSemanticViewResponse
 */
ReplaceSemanticViewResponse Client::replaceSemanticView(const ReplaceSemanticViewRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return replaceSemanticViewWithOptions(request, runtime);
}
 ...
 */
RunMaterializedViewRecommendResponse Client::runMaterializedViewRecommendWithOptions(const RunMaterializedViewRecommendRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasDBClusterId()) {
    query["DBClusterId"] = request.getDBClusterId();
  ...
  return json(callApi(params, req, runtime)).get<RunMaterializedViewRecommendResponse>();
}
 ...
 * @return RunMaterializedViewRecommendResponse
 */
RunMaterializedViewRecommendResponse Client::runMaterializedViewRecommend(const RunMaterializedViewRecommendRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return runMaterializedViewRecommendWithOptions(request, runtime);
}
 ...
 */
SearchSemanticViewsResponse Client::searchSemanticViewsWithOptions(const SearchSemanticViewsRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasDBClusterId()) {
    query["DBClusterId"] = request.getDBClusterId();
  ...
  return json(callApi(params, req, runtime)).get<SearchSemanticViewsResponse>();
}
 ...
 * @return SearchSemanticViewsResponse
 */
SearchSemanticViewsResponse Client::searchSemanticViews(const SearchSemanticViewsRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return searchSemanticViewsWithOptions(request, runtime);
}
...
SetSparkAppLogRootPathResponse Client::setSparkAppLogRootPathWithOptions(const SetSparkAppLogRootPathRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasOssLogPath()) {
    body["OssLogPath"] = request.getOssLogPath();
  }

  if (!!request.hasUseDefaultOss()) {
    body["UseDefaultOss"] = request.getUseDefaultOss();
  }
 ...
 */
StartFormationCrawlerResponse Client::startFormationCrawlerWithOptions(const StartFormationCrawlerRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasCrawlerTaskId()) {
    body["CrawlerTaskId"] = request.getCrawlerTaskId();
  ...
  return json(callApi(params, req, runtime)).get<StartFormationCrawlerResponse>();
}
 ...
 * @return StartFormationCrawlerResponse
 */
StartFormationCrawlerResponse Client::startFormationCrawler(const StartFormationCrawlerRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return startFormationCrawlerWithOptions(request, runtime);
}
...
StartSparkSQLEngineResponse Client::startSparkSQLEngineWithOptions(const StartSparkSQLEngineRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasJars()) {
    body["Jars"] = request.getJars();
  }

  if (!!request.hasMaxExecutor()) {
    body["MaxExecutor"] = request.getMaxExecutor();
  }

  if (!!request.hasMinExecutor()) {
    body["MinExecutor"] = request.getMinExecutor();
  }
  ...
  if (!!request.hasSlotNum()) {
    body["SlotNum"] = request.getSlotNum();
  }
 ...
 */
StopFormationCrawlerResponse Client::stopFormationCrawlerWithOptions(const StopFormationCrawlerRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasCrawlerTaskId()) {
    body["CrawlerTaskId"] = request.getCrawlerTaskId();
  ...
  return json(callApi(params, req, runtime)).get<StopFormationCrawlerResponse>();
}
 ...
 * @return StopFormationCrawlerResponse
 */
StopFormationCrawlerResponse Client::stopFormationCrawler(const StopFormationCrawlerRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return stopFormationCrawlerWithOptions(request, runtime);
}
...
SubmitSparkAppResponse Client::submitSparkAppWithOptions(const SubmitSparkAppRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasAgentSource()) {
    body["AgentSource"] = request.getAgentSource();
  }
  ...
  if (!!request.hasTemplateFileId()) {
    body["TemplateFileId"] = request.getTemplateFileId();
  }
 ...
 */
UpdateFormationCrawlerResponse Client::updateFormationCrawlerWithOptions(const UpdateFormationCrawlerRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasCrawlerInfo()) {
    body["CrawlerInfo"] = request.getCrawlerInfo();
  ...
  return json(callApi(params, req, runtime)).get<UpdateFormationCrawlerResponse>();
}
 ...
 * @return UpdateFormationCrawlerResponse
 */
UpdateFormationCrawlerResponse Client::updateFormationCrawler(const UpdateFormationCrawlerRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return updateFormationCrawlerWithOptions(request, runtime);
}
 ...
 */
UpdateFormationCrawlerScheduleStateResponse Client::updateFormationCrawlerScheduleStateWithOptions(const UpdateFormationCrawlerScheduleStateRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasCrawlerTaskId()) {
    body["CrawlerTaskId"] = request.getCrawlerTaskId();
  ...
  if (!!request.hasScheduleState()) {
    body["ScheduleState"] = request.getScheduleState();
  }
  ...
  return json(callApi(params, req, runtime)).get<UpdateFormationCrawlerScheduleStateResponse>();
}
 ...
 * @return UpdateFormationCrawlerScheduleStateResponse
 */
UpdateFormationCrawlerScheduleStateResponse Client::updateFormationCrawlerScheduleState(const UpdateFormationCrawlerScheduleStateRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return updateFormationCrawlerScheduleStateWithOptions(request, runtime);
}
