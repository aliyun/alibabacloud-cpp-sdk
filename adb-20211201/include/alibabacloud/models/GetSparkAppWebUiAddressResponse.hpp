...
namespace Models
{
  ...
  public:
    ...
    inline const GetSparkAppWebUiAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSparkAppWebUiAddressResponseBody) };
    inline GetSparkAppWebUiAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSparkAppWebUiAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSparkAppWebUiAddressResponseBody> body_ {};
  };
