...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApsMigrationWorkloadsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApsMigrationWorkloadsResponseBody) };
    inline DescribeApsMigrationWorkloadsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApsMigrationWorkloadsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApsMigrationWorkloadsResponseBody> body_ {};
  };
