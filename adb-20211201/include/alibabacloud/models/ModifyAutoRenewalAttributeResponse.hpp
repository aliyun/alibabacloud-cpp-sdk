...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAutoRenewalAttributeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyAutoRenewalAttributeResponseBody) };
    inline ModifyAutoRenewalAttributeResponseBody body() { DARABONBA_PTR_GET(body_, ModifyAutoRenewalAttributeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyAutoRenewalAttributeResponseBody> body_ = nullptr;
  };
