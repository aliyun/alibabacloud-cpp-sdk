...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApsJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApsJobsResponseBody) };
    inline DescribeApsJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApsJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApsJobsResponseBody> body_ {};
  };
