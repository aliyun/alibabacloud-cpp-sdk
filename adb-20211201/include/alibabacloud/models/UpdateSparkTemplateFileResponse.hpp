...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSparkTemplateFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateSparkTemplateFileResponseBody) };
    inline UpdateSparkTemplateFileResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateSparkTemplateFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateSparkTemplateFileResponseBody> body_ {};
  };
