...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBadSqlDetectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBadSqlDetectionResponseBody) };
    inline DescribeBadSqlDetectionResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBadSqlDetectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBadSqlDetectionResponseBody> body_ {};
  };
