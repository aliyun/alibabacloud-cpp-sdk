...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->catalog_ == nullptr
        && this->columns_ == nullptr && this->createTime_ == nullptr && this->createdBySource_ == nullptr && this->createdByUser_ == nullptr && this->description_ == nullptr
        && this->location_ == nullptr && this->owner_ == nullptr && this->parameters_ == nullptr && this->schemaName_ == nullptr && this->tableName_ == nullptr
        && this->tableType_ == nullptr && this->updateTime_ == nullptr; };
    ...
    inline const vector<ColDetailModel> & getColumns() const { DARABONBA_PTR_GET_CONST(columns_, vector<ColDetailModel>) };
    inline vector<ColDetailModel> getColumns() { DARABONBA_PTR_GET(columns_, vector<ColDetailModel>) };
