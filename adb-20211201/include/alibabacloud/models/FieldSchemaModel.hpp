...
namespace Models
{
  ...
  public:
    ...
    inline string getColumnRawName() const { DARABONBA_PTR_GET_DEFAULT(columnRawName_, "") };
    ...
    inline bool getCompressFloatUseShort() const { DARABONBA_PTR_GET_DEFAULT(compressFloatUseShort_, false) };
    ...
    inline bool getIsPartitionKey() const { DARABONBA_PTR_GET_DEFAULT(isPartitionKey_, false) };
    ...
    inline string getMappedName() const { DARABONBA_PTR_GET_DEFAULT(mappedName_, "") };
    ...
    inline string getOnUpdate() const { DARABONBA_PTR_GET_DEFAULT(onUpdate_, "") };
    ...
    inline int64_t getOrdinalPosition() const { DARABONBA_PTR_GET_DEFAULT(ordinalPosition_, 0L) };
    ...
    inline string getPhysicalColumnName() const { DARABONBA_PTR_GET_DEFAULT(physicalColumnName_, "") };
    ...
    inline int64_t getPkPosition() const { DARABONBA_PTR_GET_DEFAULT(pkPosition_, 0L) };
    ...
    inline int64_t getPrecision() const { DARABONBA_PTR_GET_DEFAULT(precision_, 0L) };
    ...
    inline int64_t getScale() const { DARABONBA_PTR_GET_DEFAULT(scale_, 0L) };
    ...
    inline string getTokenizer() const { DARABONBA_PTR_GET_DEFAULT(tokenizer_, "") };
