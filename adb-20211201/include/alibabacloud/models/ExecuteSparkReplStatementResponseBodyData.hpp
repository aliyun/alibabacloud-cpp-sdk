...
#ifndef ALIBABACLOUD_MODELS_EXECUTESPARKREPLSTATEMENTRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_EXECUTESPARKREPLSTATEMENTRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ExecuteSparkReplStatementResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ExecuteSparkReplStatementResponseBodyData& obj) { 
    ...
    ExecuteSparkReplStatementResponseBodyData() = default ;
    ExecuteSparkReplStatementResponseBodyData(const ExecuteSparkReplStatementResponseBodyData &) = default ;
    ExecuteSparkReplStatementResponseBodyData(ExecuteSparkReplStatementResponseBodyData &&) = default ;
    ExecuteSparkReplStatementResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ExecuteSparkReplStatementResponseBodyData() = default ;
    ExecuteSparkReplStatementResponseBodyData& operator=(const ExecuteSparkReplStatementResponseBodyData &) = default ;
    ExecuteSparkReplStatementResponseBodyData& operator=(ExecuteSparkReplStatementResponseBodyData &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->aliyunUid_ == nullptr
        && return this->code_ == nullptr && return this->codeState_ == nullptr && return this->codeType_ == nullptr && return this->columns_ == nullptr && return this->endTime_ == nullptr
        && return this->error_ == nullptr && return this->output_ == nullptr && return this->outputType_ == nullptr && return this->startTime_ == nullptr && return this->statementId_ == nullptr; };
    ...
    inline ExecuteSparkReplStatementResponseBodyData& setAliyunUid(int64_t aliyunUid) { DARABONBA_PTR_SET_VALUE(aliyunUid_, aliyunUid) };
    ...
    inline ExecuteSparkReplStatementResponseBodyData& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ExecuteSparkReplStatementResponseBodyData& setCodeState(string codeState) { DARABONBA_PTR_SET_VALUE(codeState_, codeState) };
    ...
    inline ExecuteSparkReplStatementResponseBodyData& setCodeType(string codeType) { DARABONBA_PTR_SET_VALUE(codeType_, codeType) };
    ...
    inline ExecuteSparkReplStatementResponseBodyData& setColumns(const vector<string> & columns) { DARABONBA_PTR_SET_VALUE(columns_, columns) };
    inline ExecuteSparkReplStatementResponseBodyData& setColumns(vector<string> && columns) { DARABONBA_PTR_SET_RVALUE(columns_, columns) };
    ...
    inline ExecuteSparkReplStatementResponseBodyData& setEndTime(int64_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline ExecuteSparkReplStatementResponseBodyData& setError(string error) { DARABONBA_PTR_SET_VALUE(error_, error) };
    ...
    inline ExecuteSparkReplStatementResponseBodyData& setOutput(string output) { DARABONBA_PTR_SET_VALUE(output_, output) };
    ...
    inline ExecuteSparkReplStatementResponseBodyData& setOutputType(string outputType) { DARABONBA_PTR_SET_VALUE(outputType_, outputType) };
    ...
    inline ExecuteSparkReplStatementResponseBodyData& setStartTime(int64_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ExecuteSparkReplStatementResponseBodyData& setStatementId(int64_t statementId) { DARABONBA_PTR_SET_VALUE(statementId_, statementId) };
