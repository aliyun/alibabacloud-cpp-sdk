...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyEssdCacheConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyEssdCacheConfigResponseBody) };
    inline ModifyEssdCacheConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyEssdCacheConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyEssdCacheConfigResponseBody> body_ {};
  };
