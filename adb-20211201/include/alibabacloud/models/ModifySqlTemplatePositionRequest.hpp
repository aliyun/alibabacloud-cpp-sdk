...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        && this->regionId_ == nullptr && this->targetTemplateGroupId_ == nullptr && this->templateId_ == nullptr; };
    ...
    inline int64_t getTargetTemplateGroupId() const { DARABONBA_PTR_GET_DEFAULT(targetTemplateGroupId_, 0L) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<int64_t> targetTemplateGroupId_ {};
    // The template ID.
    // 
    // This parameter is required.
