...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->AINodeNumber_ == nullptr
        && return this->AINodeSpec_ == nullptr && return this->category_ == nullptr && return this->commodityCode_ == nullptr && return this->computeResource_ == nullptr && return this->connectionString_ == nullptr
        ...
        && return this->DBClusterType_ == nullptr && return this->DBNodeClass_ == nullptr && return this->DBNodeCount_ == nullptr && return this->DBNodeStorage_ == nullptr && return this->DBVersion_ == nullptr
        && return this->diskType_ == nullptr && return this->dtsJobId_ == nullptr && return this->elasticIOResource_ == nullptr && return this->engine_ == nullptr && return this->executorCount_ == nullptr
        && return this->expireTime_ == nullptr && return this->expired_ == nullptr && return this->innerIp_ == nullptr && return this->innerPort_ == nullptr && return this->lockMode_ == nullptr
        && return this->lockReason_ == nullptr && return this->mode_ == nullptr && return this->payType_ == nullptr && return this->port_ == nullptr && return this->productForm_ == nullptr
        && return this->productVersion_ == nullptr && return this->rdsInstanceId_ == nullptr && return this->regionId_ == nullptr && return this->reservedACU_ == nullptr && return this->reservedNodeCount_ == nullptr
        && return this->reservedNodeSize_ == nullptr && return this->resourceGroupId_ == nullptr && return this->storageResource_ == nullptr && return this->tags_ == nullptr && return this->taskInfo_ == nullptr
        && return this->VPCCloudInstanceId_ == nullptr && return this->VPCId_ == nullptr && return this->vSwitchId_ == nullptr && return this->zoneId_ == nullptr; };
