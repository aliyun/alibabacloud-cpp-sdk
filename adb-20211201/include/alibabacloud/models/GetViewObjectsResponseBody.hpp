...
namespace Models
{
  ...
  public:
    ...
    inline const GetViewObjectsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetViewObjectsResponseBody::Data) };
    inline GetViewObjectsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetViewObjectsResponseBody::Data) };
    inline GetViewObjectsResponseBody& setData(const GetViewObjectsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetViewObjectsResponseBody& setData(GetViewObjectsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
