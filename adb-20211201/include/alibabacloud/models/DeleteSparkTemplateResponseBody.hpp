...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSparkTemplateResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteSparkTemplateResponseBody::Data) };
    inline DeleteSparkTemplateResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteSparkTemplateResponseBody::Data) };
    inline DeleteSparkTemplateResponseBody& setData(const DeleteSparkTemplateResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteSparkTemplateResponseBody& setData(DeleteSparkTemplateResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned result.
    shared_ptr<DeleteSparkTemplateResponseBody::Data> data_ {};
    // The request ID.
