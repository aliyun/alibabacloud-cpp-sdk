...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyApsSlsADBJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyApsSlsADBJobResponseBody) };
    inline ModifyApsSlsADBJobResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyApsSlsADBJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyApsSlsADBJobResponseBody> body_ {};
  };
