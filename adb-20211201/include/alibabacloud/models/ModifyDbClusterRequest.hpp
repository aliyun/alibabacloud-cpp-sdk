...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->computeResource_ == nullptr
        && return this->DBClusterId_ == nullptr && return this->enableDefaultResourcePool_ == nullptr && return this->productForm_ == nullptr && return this->regionId_ == nullptr && return this->reservedNodeCount_ == nullptr
        && return this->reservedNodeSize_ == nullptr && return this->storageResource_ == nullptr; };
