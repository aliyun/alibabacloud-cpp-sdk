...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->columnOrds_ == nullptr
    ...
    inline const vector<string> & getColumnOrds() const { DARABONBA_PTR_GET_CONST(columnOrds_, vector<string>) };
    inline vector<string> getColumnOrds() { DARABONBA_PTR_GET(columnOrds_, vector<string>) };
    ...
    inline const vector<FieldSchemaModel> & getIndexColumns() const { DARABONBA_PTR_GET_CONST(indexColumns_, vector<FieldSchemaModel>) };
    inline vector<FieldSchemaModel> getIndexColumns() { DARABONBA_PTR_GET(indexColumns_, vector<FieldSchemaModel>) };
