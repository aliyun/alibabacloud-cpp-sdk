...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClusterResourceDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeClusterResourceDetailResponseBodyData) };
    inline DescribeClusterResourceDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeClusterResourceDetailResponseBodyData) };
    inline DescribeClusterResourceDetailResponseBody& setData(const DescribeClusterResourceDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeClusterResourceDetailResponseBody& setData(DescribeClusterResourceDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeClusterResourceDetailResponseBodyData> data_ = nullptr;
    // The request ID.
