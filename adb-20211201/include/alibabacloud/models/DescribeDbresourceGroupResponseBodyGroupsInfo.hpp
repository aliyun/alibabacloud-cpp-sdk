...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->autoStopInterval_ != nullptr
        ...
        && this->engine_ != nullptr && this->engineParams_ != nullptr && this->groupName_ != nullptr && this->groupType_ != nullptr && this->groupUsers_ != nullptr
        && this->maxClusterCount_ != nullptr && this->maxComputeResource_ != nullptr && this->maxGpuQuantity_ != nullptr && this->message_ != nullptr && this->minClusterCount_ != nullptr
        && this->minComputeResource_ != nullptr && this->minGpuQuantity_ != nullptr && this->rayConfig_ != nullptr && this->rules_ != nullptr && this->runningClusterCount_ != nullptr
        && this->specName_ != nullptr && this->status_ != nullptr && this->targetResourceGroupName_ != nullptr && this->updateTime_ != nullptr; };
