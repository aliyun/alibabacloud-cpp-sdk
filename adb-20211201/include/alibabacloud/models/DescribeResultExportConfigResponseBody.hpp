...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResultExportConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeResultExportConfigResponseBodyData) };
    inline DescribeResultExportConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeResultExportConfigResponseBodyData) };
    inline DescribeResultExportConfigResponseBody& setData(const DescribeResultExportConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeResultExportConfigResponseBody& setData(DescribeResultExportConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
