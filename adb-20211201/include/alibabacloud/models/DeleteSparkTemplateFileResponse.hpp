...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSparkTemplateFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSparkTemplateFileResponseBody) };
    inline DeleteSparkTemplateFileResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSparkTemplateFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSparkTemplateFileResponseBody> body_ {};
  };
