...
namespace Models
{
  ...
  public:
    ...
    inline const GetSparkTemplateFileContentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSparkTemplateFileContentResponseBodyData) };
    inline GetSparkTemplateFileContentResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSparkTemplateFileContentResponseBodyData) };
    inline GetSparkTemplateFileContentResponseBody& setData(const GetSparkTemplateFileContentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSparkTemplateFileContentResponseBody& setData(GetSparkTemplateFileContentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<GetSparkTemplateFileContentResponseBodyData> data_ = nullptr;
    // The request ID.
