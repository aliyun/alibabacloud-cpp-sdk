...
namespace Models
{
  ...
  public:
    ...
    inline const ListApsOptimizationStrategyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApsOptimizationStrategyResponseBody) };
    inline ListApsOptimizationStrategyResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApsOptimizationStrategyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApsOptimizationStrategyResponseBody> body_ {};
  };
