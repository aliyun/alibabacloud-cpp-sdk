...
namespace Models
{
  ...
  public:
    ...
    inline const GetSparkAppLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSparkAppLogResponseBody) };
    inline GetSparkAppLogResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSparkAppLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSparkAppLogResponseBody> body_ {};
  };
