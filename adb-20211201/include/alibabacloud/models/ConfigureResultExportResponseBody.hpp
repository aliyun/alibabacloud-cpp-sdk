...
#ifndef ALIBABACLOUD_MODELS_CONFIGURERESULTEXPORTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CONFIGURERESULTEXPORTRESPONSEBODY_HPP_
...
namespace Models
{
  class ConfigureResultExportResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ConfigureResultExportResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ConfigureResultExportResponseBody& obj) { 
    ...
    ConfigureResultExportResponseBody() = default ;
    ConfigureResultExportResponseBody(const ConfigureResultExportResponseBody &) = default ;
    ConfigureResultExportResponseBody(ConfigureResultExportResponseBody &&) = default ;
    ConfigureResultExportResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ConfigureResultExportResponseBody() = default ;
    ConfigureResultExportResponseBody& operator=(const ConfigureResultExportResponseBody &) = default ;
    ConfigureResultExportResponseBody& operator=(ConfigureResultExportResponseBody &&) = default ;
    ...
    inline ConfigureResultExportResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ConfigureResultExportResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ConfigureResultExportResponseBody::Data) };
    inline ConfigureResultExportResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ConfigureResultExportResponseBody::Data) };
    inline ConfigureResultExportResponseBody& setData(const ConfigureResultExportResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ConfigureResultExportResponseBody& setData(ConfigureResultExportResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ConfigureResultExportResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ConfigureResultExportResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ConfigureResultExportResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ConfigureResultExportResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    shared_ptr<ConfigureResultExportResponseBody::Data> data_ {};
