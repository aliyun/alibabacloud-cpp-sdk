...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeEnabledPrivilegesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeEnabledPrivilegesResponseBodyData>) };
    inline vector<DescribeEnabledPrivilegesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeEnabledPrivilegesResponseBodyData>) };
    inline DescribeEnabledPrivilegesResponseBody& setData(const vector<DescribeEnabledPrivilegesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEnabledPrivilegesResponseBody& setData(vector<DescribeEnabledPrivilegesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeEnabledPrivilegesResponseBodyData>> data_ = nullptr;
    // The request ID.
