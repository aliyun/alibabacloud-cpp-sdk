...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->active_ == nullptr
        && this->aliyunUid_ == nullptr && this->attemptId_ == nullptr && this->error_ == nullptr && this->sessionId_ == nullptr && this->state_ == nullptr
        && this->webUiAddress_ == nullptr; };
      // active Field Functions 
      bool hasActive() const { return this->active_ != nullptr;};
      void deleteActive() { this->active_ = nullptr;};
      inline string getActive() const { DARABONBA_PTR_GET_DEFAULT(active_, "") };
      inline Data& setActive(string active) { DARABONBA_PTR_SET_VALUE(active_, active) };
    ...
    inline const GetSparkReplSessionResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetSparkReplSessionResponseBody::Data) };
    inline GetSparkReplSessionResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetSparkReplSessionResponseBody::Data) };
    inline GetSparkReplSessionResponseBody& setData(const GetSparkReplSessionResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSparkReplSessionResponseBody& setData(GetSparkReplSessionResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    shared_ptr<GetSparkReplSessionResponseBody::Data> data_ {};
    // The request ID.
