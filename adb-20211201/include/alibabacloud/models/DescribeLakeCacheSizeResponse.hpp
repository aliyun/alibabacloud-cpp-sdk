...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLakeCacheSizeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLakeCacheSizeResponseBody) };
    inline DescribeLakeCacheSizeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLakeCacheSizeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLakeCacheSizeResponseBody> body_ {};
  };
