...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCompactionServiceSwitchResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeCompactionServiceSwitchResponseBodyData) };
    inline DescribeCompactionServiceSwitchResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeCompactionServiceSwitchResponseBodyData) };
    inline DescribeCompactionServiceSwitchResponseBody& setData(const DescribeCompactionServiceSwitchResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCompactionServiceSwitchResponseBody& setData(DescribeCompactionServiceSwitchResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<DescribeCompactionServiceSwitchResponseBodyData> data_ = nullptr;
    // The request ID.
