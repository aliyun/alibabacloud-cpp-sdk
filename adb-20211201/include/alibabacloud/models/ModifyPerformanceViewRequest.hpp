...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        ...
        && return this->viewDetail_ == nullptr && return this->viewName_ == nullptr; };
    ...
    inline const ModifyPerformanceViewRequestViewDetail & viewDetail() const { DARABONBA_PTR_GET_CONST(viewDetail_, ModifyPerformanceViewRequestViewDetail) };
    inline ModifyPerformanceViewRequestViewDetail viewDetail() { DARABONBA_PTR_GET(viewDetail_, ModifyPerformanceViewRequestViewDetail) };
    inline ModifyPerformanceViewRequest& setViewDetail(const ModifyPerformanceViewRequestViewDetail & viewDetail) { DARABONBA_PTR_SET_VALUE(viewDetail_, viewDetail) };
    inline ModifyPerformanceViewRequest& setViewDetail(ModifyPerformanceViewRequestViewDetail && viewDetail) { DARABONBA_PTR_SET_RVALUE(viewDetail_, viewDetail) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<ModifyPerformanceViewRequestViewDetail> viewDetail_ = nullptr;
