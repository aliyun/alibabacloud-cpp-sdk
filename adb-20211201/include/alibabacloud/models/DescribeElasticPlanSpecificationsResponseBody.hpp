...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNumber_ == nullptr
        && this->pageSize_ == nullptr && this->requestId_ == nullptr && this->specifications_ == nullptr && this->totalCount_ == nullptr; };
    ...
    inline const vector<string> & getSpecifications() const { DARABONBA_PTR_GET_CONST(specifications_, vector<string>) };
    inline vector<string> getSpecifications() { DARABONBA_PTR_GET(specifications_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> specifications_ {};
