...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAccountPrivilegeObjectsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeAccountPrivilegeObjectsResponseBodyData>) };
    inline vector<DescribeAccountPrivilegeObjectsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeAccountPrivilegeObjectsResponseBodyData>) };
    inline DescribeAccountPrivilegeObjectsResponseBody& setData(const vector<DescribeAccountPrivilegeObjectsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAccountPrivilegeObjectsResponseBody& setData(vector<DescribeAccountPrivilegeObjectsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The permissions.
    std::shared_ptr<vector<DescribeAccountPrivilegeObjectsResponseBodyData>> data_ = nullptr;
    // The page number.
