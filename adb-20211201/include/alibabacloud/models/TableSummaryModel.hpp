...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->createTime_ == nullptr
        && this->createdBySource_ == nullptr && this->createdByUser_ == nullptr && this->description_ == nullptr && this->mvDetailModel_ == nullptr && this->owner_ == nullptr
        && this->SQL_ == nullptr && this->schemaName_ == nullptr && this->tableName_ == nullptr && this->tableSize_ == nullptr && this->tableType_ == nullptr
    ...
    inline const OpenStructMvDetailModel & getMvDetailModel() const { DARABONBA_PTR_GET_CONST(mvDetailModel_, OpenStructMvDetailModel) };
    inline OpenStructMvDetailModel getMvDetailModel() { DARABONBA_PTR_GET(mvDetailModel_, OpenStructMvDetailModel) };
    ...
    inline int64_t getTableSize() const { DARABONBA_PTR_GET_DEFAULT(tableSize_, 0L) };
