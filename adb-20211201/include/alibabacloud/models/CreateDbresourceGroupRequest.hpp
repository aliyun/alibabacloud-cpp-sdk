...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->autoStopInterval_ != nullptr
        ...
        && this->engineParams_ != nullptr && this->groupName_ != nullptr && this->groupType_ != nullptr && this->maxClusterCount_ != nullptr && this->maxComputeResource_ != nullptr
        ...
        && this->regionId_ != nullptr && this->rules_ != nullptr && this->specName_ != nullptr && this->targetResourceGroupName_ != nullptr; };
