...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateApsWebhookResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateApsWebhookResponseBody) };
    inline UpdateApsWebhookResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateApsWebhookResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateApsWebhookResponseBody> body_ {};
  };
