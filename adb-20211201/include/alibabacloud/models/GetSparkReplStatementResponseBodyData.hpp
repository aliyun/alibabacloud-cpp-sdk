...
#ifndef ALIBABACLOUD_MODELS_GETSPARKREPLSTATEMENTRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_GETSPARKREPLSTATEMENTRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSparkReplStatementResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSparkReplStatementResponseBodyData& obj) { 
    ...
    GetSparkReplStatementResponseBodyData() = default ;
    GetSparkReplStatementResponseBodyData(const GetSparkReplStatementResponseBodyData &) = default ;
    GetSparkReplStatementResponseBodyData(GetSparkReplStatementResponseBodyData &&) = default ;
    GetSparkReplStatementResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSparkReplStatementResponseBodyData() = default ;
    GetSparkReplStatementResponseBodyData& operator=(const GetSparkReplStatementResponseBodyData &) = default ;
    GetSparkReplStatementResponseBodyData& operator=(GetSparkReplStatementResponseBodyData &&) = default ;
    ...
    inline GetSparkReplStatementResponseBodyData& setAliyunUid(int64_t aliyunUid) { DARABONBA_PTR_SET_VALUE(aliyunUid_, aliyunUid) };
    ...
    inline GetSparkReplStatementResponseBodyData& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline GetSparkReplStatementResponseBodyData& setCodeState(string codeState) { DARABONBA_PTR_SET_VALUE(codeState_, codeState) };
    ...
    inline GetSparkReplStatementResponseBodyData& setCodeType(string codeType) { DARABONBA_PTR_SET_VALUE(codeType_, codeType) };
    ...
    inline GetSparkReplStatementResponseBodyData& setColumns(const vector<string> & columns) { DARABONBA_PTR_SET_VALUE(columns_, columns) };
    inline GetSparkReplStatementResponseBodyData& setColumns(vector<string> && columns) { DARABONBA_PTR_SET_RVALUE(columns_, columns) };
    ...
    inline GetSparkReplStatementResponseBodyData& setEndTime(int64_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline GetSparkReplStatementResponseBodyData& setError(string error) { DARABONBA_PTR_SET_VALUE(error_, error) };
    ...
    inline GetSparkReplStatementResponseBodyData& setOutput(string output) { DARABONBA_PTR_SET_VALUE(output_, output) };
    ...
    inline GetSparkReplStatementResponseBodyData& setOutputType(string outputType) { DARABONBA_PTR_SET_VALUE(outputType_, outputType) };
    ...
    inline GetSparkReplStatementResponseBodyData& setStartTime(int64_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline GetSparkReplStatementResponseBodyData& setStatementId(int64_t statementId) { DARABONBA_PTR_SET_VALUE(statementId_, statementId) };
