...
namespace Models
{
  ...
  public:
    ...
    inline const PreloadSparkAppMetricsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PreloadSparkAppMetricsResponseBody) };
    inline PreloadSparkAppMetricsResponseBody getBody() { DARABONBA_PTR_GET(body_, PreloadSparkAppMetricsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PreloadSparkAppMetricsResponseBody> body_ {};
  };
