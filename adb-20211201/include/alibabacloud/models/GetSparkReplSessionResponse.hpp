...
namespace Models
{
  ...
  public:
    ...
    inline const GetSparkReplSessionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSparkReplSessionResponseBody) };
    inline GetSparkReplSessionResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSparkReplSessionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSparkReplSessionResponseBody> body_ {};
  };
