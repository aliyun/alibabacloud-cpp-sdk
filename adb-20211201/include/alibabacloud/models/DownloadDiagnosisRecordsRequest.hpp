...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientIp_ == nullptr
        ...
        && return this->maxPeakMemory_ == nullptr && return this->maxScanSize_ == nullptr && return this->minPeakMemory_ == nullptr && return this->minScanSize_ == nullptr && return this->queryCondition_ == nullptr
        && return this->regionId_ == nullptr && return this->resourceGroup_ == nullptr && return this->startTime_ == nullptr && return this->userName_ == nullptr; };
