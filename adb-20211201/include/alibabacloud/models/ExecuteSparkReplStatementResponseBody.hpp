...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteSparkReplStatementResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ExecuteSparkReplStatementResponseBodyData) };
    inline ExecuteSparkReplStatementResponseBodyData data() { DARABONBA_PTR_GET(data_, ExecuteSparkReplStatementResponseBodyData) };
    inline ExecuteSparkReplStatementResponseBody& setData(const ExecuteSparkReplStatementResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ExecuteSparkReplStatementResponseBody& setData(ExecuteSparkReplStatementResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<ExecuteSparkReplStatementResponseBodyData> data_ = nullptr;
    // The request ID.
