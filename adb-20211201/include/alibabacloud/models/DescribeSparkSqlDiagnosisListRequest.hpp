...
namespace Models
{
  ...
  public:
    ...
    inline string getMaxStartTime() const { DARABONBA_PTR_GET_DEFAULT(maxStartTime_, "") };
    ...
    inline string getMinStartTime() const { DARABONBA_PTR_GET_DEFAULT(minStartTime_, "") };
  ...
  protected:
    ...
    shared_ptr<string> maxStartTime_ {};
    // The earliest start time.
    shared_ptr<string> minStartTime_ {};
