...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeViewJobsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeViewJobsResponseBodyData) };
    inline DescribeViewJobsResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeViewJobsResponseBodyData) };
    inline DescribeViewJobsResponseBody& setData(const DescribeViewJobsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeViewJobsResponseBody& setData(DescribeViewJobsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<DescribeViewJobsResponseBodyData> data_ = nullptr;
    // The page number.
