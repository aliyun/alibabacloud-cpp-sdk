...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->computeResource_ == nullptr
        && return this->DBClusterDescription_ == nullptr && return this->DBClusterId_ == nullptr && return this->DBClusterStatus_ == nullptr && return this->reservedACU_ == nullptr && return this->storageResource_ == nullptr
