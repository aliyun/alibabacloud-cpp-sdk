...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->executionType_ == nullptr
        && return this->inputDataSize_ == nullptr && return this->inputRows_ == nullptr && return this->operatorCost_ == nullptr && return this->outputDataSize_ == nullptr && return this->outputRows_ == nullptr
        && return this->peakMemory_ == nullptr && return this->progress_ == nullptr && return this->stageId_ == nullptr && return this->state_ == nullptr; };
