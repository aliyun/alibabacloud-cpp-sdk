...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCompactionServiceSwitchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCompactionServiceSwitchResponseBody) };
    inline ModifyCompactionServiceSwitchResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCompactionServiceSwitchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCompactionServiceSwitchResponseBody> body_ {};
  };
