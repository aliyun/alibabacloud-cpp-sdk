...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSparkAuditLogRecordsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSparkAuditLogRecordsResponseBody) };
    inline DescribeSparkAuditLogRecordsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSparkAuditLogRecordsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSparkAuditLogRecordsResponseBody> body_ {};
  };
