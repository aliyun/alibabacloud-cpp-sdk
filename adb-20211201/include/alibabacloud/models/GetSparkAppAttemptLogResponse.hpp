...
namespace Models
{
  ...
  public:
    ...
    inline const GetSparkAppAttemptLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSparkAppAttemptLogResponseBody) };
    inline GetSparkAppAttemptLogResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSparkAppAttemptLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSparkAppAttemptLogResponseBody> body_ {};
  };
