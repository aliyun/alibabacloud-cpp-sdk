...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyMaterializedViewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyMaterializedViewResponseBody) };
    inline ModifyMaterializedViewResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyMaterializedViewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyMaterializedViewResponseBody> body_ {};
  };
