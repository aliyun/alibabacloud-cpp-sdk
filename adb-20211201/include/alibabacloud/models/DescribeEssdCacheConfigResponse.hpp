...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEssdCacheConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEssdCacheConfigResponseBody) };
    inline DescribeEssdCacheConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEssdCacheConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEssdCacheConfigResponseBody> body_ {};
  };
