...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMVRecommendResultsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMVRecommendResultsResponseBody) };
    inline DescribeMVRecommendResultsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMVRecommendResultsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMVRecommendResultsResponseBody> body_ {};
  };
