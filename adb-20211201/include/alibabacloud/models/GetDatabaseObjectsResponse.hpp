...
namespace Models
{
  ...
  public:
    ...
    inline const GetDatabaseObjectsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDatabaseObjectsResponseBody) };
    inline GetDatabaseObjectsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDatabaseObjectsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDatabaseObjectsResponseBody> body_ {};
  };
