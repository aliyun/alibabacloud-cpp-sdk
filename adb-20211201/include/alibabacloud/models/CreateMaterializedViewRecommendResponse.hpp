...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMaterializedViewRecommendResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMaterializedViewRecommendResponseBody) };
    inline CreateMaterializedViewRecommendResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMaterializedViewRecommendResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMaterializedViewRecommendResponseBody> body_ {};
  };
