...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSQLPatternsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSQLPatternsResponseBody) };
    inline DescribeSQLPatternsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSQLPatternsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSQLPatternsResponseBody> body_ {};
  };
