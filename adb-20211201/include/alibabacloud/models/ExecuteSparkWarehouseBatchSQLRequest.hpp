...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agency_ == nullptr
        && this->DBClusterId_ == nullptr && this->executeResultLimit_ == nullptr && this->executeTimeLimitInSeconds_ == nullptr && this->query_ == nullptr && this->resourceGroupName_ == nullptr
        && this->runtimeConfig_ == nullptr && this->schema_ == nullptr; };
    ...
    inline int64_t getExecuteResultLimit() const { DARABONBA_PTR_GET_DEFAULT(executeResultLimit_, 0L) };
    ...
    inline int64_t getExecuteTimeLimitInSeconds() const { DARABONBA_PTR_GET_DEFAULT(executeTimeLimitInSeconds_, 0L) };
    ...
    inline string getRuntimeConfig() const { DARABONBA_PTR_GET_DEFAULT(runtimeConfig_, "") };
  ...
  protected:
    ...
    shared_ptr<int64_t> executeResultLimit_ {};
    ...
    shared_ptr<int64_t> executeTimeLimitInSeconds_ {};
    ...
    shared_ptr<string> runtimeConfig_ {};
