...
#ifndef ALIBABACLOUD_MODELS_GETSPARKCONFIGLOGPATHRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_GETSPARKCONFIGLOGPATHRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSparkConfigLogPathResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSparkConfigLogPathResponseBodyData& obj) { 
    ...
    GetSparkConfigLogPathResponseBodyData() = default ;
    GetSparkConfigLogPathResponseBodyData(const GetSparkConfigLogPathResponseBodyData &) = default ;
    GetSparkConfigLogPathResponseBodyData(GetSparkConfigLogPathResponseBodyData &&) = default ;
    GetSparkConfigLogPathResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSparkConfigLogPathResponseBodyData() = default ;
    GetSparkConfigLogPathResponseBodyData& operator=(const GetSparkConfigLogPathResponseBodyData &) = default ;
    GetSparkConfigLogPathResponseBodyData& operator=(GetSparkConfigLogPathResponseBodyData &&) = default ;
    ...
    inline GetSparkConfigLogPathResponseBodyData& setDefaultLogPath(string defaultLogPath) { DARABONBA_PTR_SET_VALUE(defaultLogPath_, defaultLogPath) };
    ...
    inline GetSparkConfigLogPathResponseBodyData& setIsLogPathExists(bool isLogPathExists) { DARABONBA_PTR_SET_VALUE(isLogPathExists_, isLogPathExists) };
    ...
    inline GetSparkConfigLogPathResponseBodyData& setModifiedTimestamp(string modifiedTimestamp) { DARABONBA_PTR_SET_VALUE(modifiedTimestamp_, modifiedTimestamp) };
    ...
    inline GetSparkConfigLogPathResponseBodyData& setModifiedUid(string modifiedUid) { DARABONBA_PTR_SET_VALUE(modifiedUid_, modifiedUid) };
    ...
    inline GetSparkConfigLogPathResponseBodyData& setRecordedLogPath(string recordedLogPath) { DARABONBA_PTR_SET_VALUE(recordedLogPath_, recordedLogPath) };
