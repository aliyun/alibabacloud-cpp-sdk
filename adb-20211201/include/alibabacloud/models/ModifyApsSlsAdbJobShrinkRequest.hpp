...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->columnsShrink_ == nullptr
        && return this->DBClusterId_ == nullptr && return this->dbName_ == nullptr && return this->dirtyDataProcessPattern_ == nullptr && return this->exactlyOnce_ == nullptr && return this->password_ == nullptr
        && return this->regionId_ == nullptr && return this->startingOffsets_ == nullptr && return this->tableName_ == nullptr && return this->unixTimestampConvert_ == nullptr && return this->userName_ == nullptr
        && return this->workloadId_ == nullptr && return this->workloadName_ == nullptr; };
