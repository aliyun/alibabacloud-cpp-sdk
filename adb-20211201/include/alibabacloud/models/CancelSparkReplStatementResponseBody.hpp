...
namespace Models
{
  ...
  public:
    ...
    inline const CancelSparkReplStatementResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CancelSparkReplStatementResponseBody::Data) };
    inline CancelSparkReplStatementResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CancelSparkReplStatementResponseBody::Data) };
    inline CancelSparkReplStatementResponseBody& setData(const CancelSparkReplStatementResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CancelSparkReplStatementResponseBody& setData(CancelSparkReplStatementResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    shared_ptr<CancelSparkReplStatementResponseBody::Data> data_ {};
    // The request ID.
