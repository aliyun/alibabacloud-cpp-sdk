...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResultExportConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeResultExportConfigResponseBody) };
    inline DescribeResultExportConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeResultExportConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeResultExportConfigResponseBody> body_ {};
  };
