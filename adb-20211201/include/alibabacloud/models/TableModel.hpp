...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->archiveType_ == nullptr
        ...
        && this->compression_ == nullptr && this->createTime_ == nullptr && this->createdBySource_ == nullptr && this->createdByUser_ == nullptr && this->currentVersion_ == nullptr
        && this->dbName_ == nullptr && this->dictEncode_ == nullptr && this->distributeColumns_ == nullptr && this->distributeType_ == nullptr && this->enableDfs_ == nullptr
        && this->hotPartitionCount_ == nullptr && this->indexes_ == nullptr && this->isAllIndex_ == nullptr && this->isFulltextDict_ == nullptr && this->maxColumnId_ == nullptr
        && this->parameters_ == nullptr && this->partitionColumn_ == nullptr && this->partitionCount_ == nullptr && this->partitionKeys_ == nullptr && this->partitionType_ == nullptr
        && this->physicalDatabaseName_ == nullptr && this->physicalTableName_ == nullptr && this->previousVersion_ == nullptr && this->rawTableName_ == nullptr && this->routeColumns_ == nullptr
        && this->routeEffectiveColumn_ == nullptr && this->routeType_ == nullptr && this->rtEngineType_ == nullptr && this->rtIndexAll_ == nullptr && this->rtModeType_ == nullptr
        && this->sd_ == nullptr && this->storagePolicy_ == nullptr && this->subpartitionColumn_ == nullptr && this->subpartitionCount_ == nullptr && this->subpartitionType_ == nullptr
        && this->tableEngineName_ == nullptr && this->tableName_ == nullptr && this->tableType_ == nullptr && this->tblId_ == nullptr && this->temporary_ == nullptr
        && this->updateTime_ == nullptr && this->viewExpandedText_ == nullptr && this->viewOriginalText_ == nullptr && this->viewSecurityMode_ == nullptr; };
    ...
    inline int64_t getBlockSize() const { DARABONBA_PTR_GET_DEFAULT(blockSize_, 0L) };
    ...
    inline int64_t getBucket() const { DARABONBA_PTR_GET_DEFAULT(bucket_, 0L) };
    ...
    inline int64_t getBucketCount() const { DARABONBA_PTR_GET_DEFAULT(bucketCount_, 0L) };
    ...
    inline const vector<FieldSchemaModel> & getCols() const { DARABONBA_PTR_GET_CONST(cols_, vector<FieldSchemaModel>) };
    inline vector<FieldSchemaModel> getCols() { DARABONBA_PTR_GET(cols_, vector<FieldSchemaModel>) };
    ...
    inline string getCompression() const { DARABONBA_PTR_GET_DEFAULT(compression_, "") };
    ...
    inline bool getDictEncode() const { DARABONBA_PTR_GET_DEFAULT(dictEncode_, false) };
    ...
    inline const vector<FieldSchemaModel> & getDistributeColumns() const { DARABONBA_PTR_GET_CONST(distributeColumns_, vector<FieldSchemaModel>) };
    inline vector<FieldSchemaModel> getDistributeColumns() { DARABONBA_PTR_GET(distributeColumns_, vector<FieldSchemaModel>) };
    ...
    inline bool getEnableDfs() const { DARABONBA_PTR_GET_DEFAULT(enableDfs_, false) };
    ...
    inline int64_t getHotPartitionCount() const { DARABONBA_PTR_GET_DEFAULT(hotPartitionCount_, 0L) };
    ...
    inline const vector<CstoreIndexModel> & getIndexes() const { DARABONBA_PTR_GET_CONST(indexes_, vector<CstoreIndexModel>) };
    inline vector<CstoreIndexModel> getIndexes() { DARABONBA_PTR_GET(indexes_, vector<CstoreIndexModel>) };
    ...
    inline int64_t getMaxColumnId() const { DARABONBA_PTR_GET_DEFAULT(maxColumnId_, 0L) };
    ...
    inline const vector<FieldSchemaModel> & getPartitionKeys() const { DARABONBA_PTR_GET_CONST(partitionKeys_, vector<FieldSchemaModel>) };
    inline vector<FieldSchemaModel> getPartitionKeys() { DARABONBA_PTR_GET(partitionKeys_, vector<FieldSchemaModel>) };
    ...
    inline string getPhysicalDatabaseName() const { DARABONBA_PTR_GET_DEFAULT(physicalDatabaseName_, "") };
    ...
    inline string getPhysicalTableName() const { DARABONBA_PTR_GET_DEFAULT(physicalTableName_, "") };
    ...
    inline int64_t getPreviousVersion() const { DARABONBA_PTR_GET_DEFAULT(previousVersion_, 0L) };
    ...
    inline string getRawTableName() const { DARABONBA_PTR_GET_DEFAULT(rawTableName_, "") };
    ...
    inline const vector<FieldSchemaModel> & getRouteColumns() const { DARABONBA_PTR_GET_CONST(routeColumns_, vector<FieldSchemaModel>) };
    inline vector<FieldSchemaModel> getRouteColumns() { DARABONBA_PTR_GET(routeColumns_, vector<FieldSchemaModel>) };
    ...
    inline const FieldSchemaModel & getRouteEffectiveColumn() const { DARABONBA_PTR_GET_CONST(routeEffectiveColumn_, FieldSchemaModel) };
    inline FieldSchemaModel getRouteEffectiveColumn() { DARABONBA_PTR_GET(routeEffectiveColumn_, FieldSchemaModel) };
    ...
    inline string getRtEngineType() const { DARABONBA_PTR_GET_DEFAULT(rtEngineType_, "") };
    ...
    inline bool getRtIndexAll() const { DARABONBA_PTR_GET_DEFAULT(rtIndexAll_, false) };
    ...
    inline string getRtModeType() const { DARABONBA_PTR_GET_DEFAULT(rtModeType_, "") };
    ...
    inline const StorageDescriptorModel & getSd() const { DARABONBA_PTR_GET_CONST(sd_, StorageDescriptorModel) };
    inline StorageDescriptorModel getSd() { DARABONBA_PTR_GET(sd_, StorageDescriptorModel) };
    ...
    inline string getStoragePolicy() const { DARABONBA_PTR_GET_DEFAULT(storagePolicy_, "") };
    ...
    inline string getSubpartitionColumn() const { DARABONBA_PTR_GET_DEFAULT(subpartitionColumn_, "") };
    ...
    inline int64_t getSubpartitionCount() const { DARABONBA_PTR_GET_DEFAULT(subpartitionCount_, 0L) };
    ...
    inline string getSubpartitionType() const { DARABONBA_PTR_GET_DEFAULT(subpartitionType_, "") };
    ...
    inline string getTableEngineName() const { DARABONBA_PTR_GET_DEFAULT(tableEngineName_, "") };
    ...
    inline int64_t getTblId() const { DARABONBA_PTR_GET_DEFAULT(tblId_, 0L) };
    ...
    inline bool getTemporary() const { DARABONBA_PTR_GET_DEFAULT(temporary_, false) };
    ...
    inline string getViewSecurityMode() const { DARABONBA_PTR_GET_DEFAULT(viewSecurityMode_, "") };
