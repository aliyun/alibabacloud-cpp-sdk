...
namespace Models
{
  ...
  public:
    ...
    inline const GetSparkTemplateFullTreeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSparkTemplateFullTreeResponseBody) };
    inline GetSparkTemplateFullTreeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSparkTemplateFullTreeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSparkTemplateFullTreeResponseBody> body_ {};
  };
