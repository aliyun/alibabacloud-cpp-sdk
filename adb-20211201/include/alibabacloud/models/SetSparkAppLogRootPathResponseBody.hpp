...
#ifndef ALIBABACLOUD_MODELS_SETSPARKAPPLOGROOTPATHRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_SETSPARKAPPLOGROOTPATHRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SetSparkAppLogRootPathResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, SetSparkAppLogRootPathResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    SetSparkAppLogRootPathResponseBody() = default ;
    SetSparkAppLogRootPathResponseBody(const SetSparkAppLogRootPathResponseBody &) = default ;
    SetSparkAppLogRootPathResponseBody(SetSparkAppLogRootPathResponseBody &&) = default ;
    SetSparkAppLogRootPathResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SetSparkAppLogRootPathResponseBody() = default ;
    SetSparkAppLogRootPathResponseBody& operator=(const SetSparkAppLogRootPathResponseBody &) = default ;
    SetSparkAppLogRootPathResponseBody& operator=(SetSparkAppLogRootPathResponseBody &&) = default ;
    ...
    inline const SetSparkAppLogRootPathResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SetSparkAppLogRootPathResponseBody::Data) };
    inline SetSparkAppLogRootPathResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SetSparkAppLogRootPathResponseBody::Data) };
    inline SetSparkAppLogRootPathResponseBody& setData(const SetSparkAppLogRootPathResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SetSparkAppLogRootPathResponseBody& setData(SetSparkAppLogRootPathResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline SetSparkAppLogRootPathResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The returned data.
    shared_ptr<SetSparkAppLogRootPathResponseBody::Data> data_ {};
    // The request ID.
