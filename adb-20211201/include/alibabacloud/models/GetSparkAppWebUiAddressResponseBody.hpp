...
namespace Models
{
  ...
  public:
    ...
    inline const GetSparkAppWebUiAddressResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSparkAppWebUiAddressResponseBodyData) };
    inline GetSparkAppWebUiAddressResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSparkAppWebUiAddressResponseBodyData) };
    inline GetSparkAppWebUiAddressResponseBody& setData(const GetSparkAppWebUiAddressResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSparkAppWebUiAddressResponseBody& setData(GetSparkAppWebUiAddressResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<GetSparkAppWebUiAddressResponseBodyData> data_ = nullptr;
    // The request ID.
