...
namespace Models
{
  ...
  public:
    ...
    inline const ListSparkAppAttemptsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSparkAppAttemptsResponseBody) };
    inline ListSparkAppAttemptsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSparkAppAttemptsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSparkAppAttemptsResponseBody> body_ {};
  };
