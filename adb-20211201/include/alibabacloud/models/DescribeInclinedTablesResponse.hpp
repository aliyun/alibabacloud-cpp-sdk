...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInclinedTablesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInclinedTablesResponseBody) };
    inline DescribeInclinedTablesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInclinedTablesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInclinedTablesResponseBody> body_ {};
  };
