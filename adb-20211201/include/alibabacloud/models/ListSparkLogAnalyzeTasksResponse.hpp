...
namespace Models
{
  ...
  public:
    ...
    inline const ListSparkLogAnalyzeTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSparkLogAnalyzeTasksResponseBody) };
    inline ListSparkLogAnalyzeTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSparkLogAnalyzeTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSparkLogAnalyzeTasksResponseBody> body_ {};
  };
