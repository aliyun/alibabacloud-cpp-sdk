...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSparkCodeOutputResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSparkCodeOutputResponseBody) };
    inline DescribeSparkCodeOutputResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSparkCodeOutputResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSparkCodeOutputResponseBody> body_ {};
  };
