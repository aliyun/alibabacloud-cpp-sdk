...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->AINodeNumber_ == nullptr
        && return this->AINodeSpec_ == nullptr && return this->clickhouseEngineCacheSize_ == nullptr && return this->clickhouseEngineEnabled_ == nullptr && return this->commodityCode_ == nullptr && return this->computeResource_ == nullptr
        && return this->computeResourceTotal_ == nullptr && return this->connectionString_ == nullptr && return this->creationTime_ == nullptr && return this->DBClusterDescription_ == nullptr && return this->DBClusterId_ == nullptr
        && return this->DBClusterNetworkType_ == nullptr && return this->DBClusterStatus_ == nullptr && return this->DBClusterType_ == nullptr && return this->DBVersion_ == nullptr && return this->diskEncryption_ == nullptr
        && return this->engine_ == nullptr && return this->engineVersion_ == nullptr && return this->expireTime_ == nullptr && return this->expired_ == nullptr && return this->kmsId_ == nullptr
        && return this->lockMode_ == nullptr && return this->lockReason_ == nullptr && return this->maintainTime_ == nullptr && return this->mode_ == nullptr && return this->payType_ == nullptr
        && return this->port_ == nullptr && return this->productForm_ == nullptr && return this->productVersion_ == nullptr && return this->regionId_ == nullptr && return this->reservedACU_ == nullptr
        && return this->reservedNodeCount_ == nullptr && return this->reservedNodeSize_ == nullptr && return this->resourceGroupId_ == nullptr && return this->secondaryVSwitchId_ == nullptr && return this->secondaryZoneId_ == nullptr
        && return this->storageResource_ == nullptr && return this->storageResourceTotal_ == nullptr && return this->supportedFeatures_ == nullptr && return this->tags_ == nullptr && return this->taskInfo_ == nullptr
        && return this->userENIStatus_ == nullptr && return this->userENIVSwitchOptions_ == nullptr && return this->userENIVpcId_ == nullptr && return this->userENIZoneOptions_ == nullptr && return this->VPCId_ == nullptr
