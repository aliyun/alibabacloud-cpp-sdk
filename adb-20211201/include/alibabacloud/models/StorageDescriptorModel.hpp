...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->compressed_ == nullptr
        && this->inputFormat_ == nullptr && this->location_ == nullptr && this->numBuckets_ == nullptr && this->outputFormat_ == nullptr && this->parameters_ == nullptr
        && this->sdId_ == nullptr && this->serDeInfo_ == nullptr && this->storedAsSubDirectories_ == nullptr; };
    ...
    inline int64_t getNumBuckets() const { DARABONBA_PTR_GET_DEFAULT(numBuckets_, 0L) };
    ...
    inline int64_t getSdId() const { DARABONBA_PTR_GET_DEFAULT(sdId_, 0L) };
    ...
    inline const SerDeInfoModel & getSerDeInfo() const { DARABONBA_PTR_GET_CONST(serDeInfo_, SerDeInfoModel) };
    inline SerDeInfoModel getSerDeInfo() { DARABONBA_PTR_GET(serDeInfo_, SerDeInfoModel) };
    ...
    inline bool getStoredAsSubDirectories() const { DARABONBA_PTR_GET_DEFAULT(storedAsSubDirectories_, false) };
