...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClusterNetInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeClusterNetInfoResponseBody) };
    inline DescribeClusterNetInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeClusterNetInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeClusterNetInfoResponseBody> body_ {};
  };
