...
namespace Models
{
  ...
  public:
    ...
    inline const GetSparkReplStatementResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetSparkReplStatementResponseBody::Data) };
    inline GetSparkReplStatementResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetSparkReplStatementResponseBody::Data) };
    inline GetSparkReplStatementResponseBody& setData(const GetSparkReplStatementResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSparkReplStatementResponseBody& setData(GetSparkReplStatementResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    shared_ptr<GetSparkReplStatementResponseBody::Data> data_ {};
    // The request ID.
