...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->acuInfo_ == nullptr
        && this->DBClusterId_ == nullptr && this->endTime_ == nullptr && this->resourceGroupName_ == nullptr && this->resourceGroupType_ == nullptr && this->startTime_ == nullptr; };
    ...
    inline const DescribeComputeResourceUsageResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeComputeResourceUsageResponseBody::Data) };
    inline DescribeComputeResourceUsageResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeComputeResourceUsageResponseBody::Data) };
    inline DescribeComputeResourceUsageResponseBody& setData(const DescribeComputeResourceUsageResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeComputeResourceUsageResponseBody& setData(DescribeComputeResourceUsageResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<DescribeComputeResourceUsageResponseBody::Data> data_ {};
    // The request ID.
