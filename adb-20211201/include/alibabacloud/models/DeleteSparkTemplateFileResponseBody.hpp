...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSparkTemplateFileResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteSparkTemplateFileResponseBody::Data) };
    inline DeleteSparkTemplateFileResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteSparkTemplateFileResponseBody::Data) };
    inline DeleteSparkTemplateFileResponseBody& setData(const DeleteSparkTemplateFileResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteSparkTemplateFileResponseBody& setData(DeleteSparkTemplateFileResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The deletion result.
    shared_ptr<DeleteSparkTemplateFileResponseBody::Data> data_ {};
    // The request ID.
