...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAutoRenewalAttributeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeAutoRenewalAttributeResponseBody) };
    inline DescribeAutoRenewalAttributeResponseBody body() { DARABONBA_PTR_GET(body_, DescribeAutoRenewalAttributeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAutoRenewalAttributeResponseBody> body_ = nullptr;
  };
