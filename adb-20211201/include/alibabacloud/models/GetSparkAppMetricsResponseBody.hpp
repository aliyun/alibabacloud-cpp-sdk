...
namespace Models
{
  ...
  public:
    ...
    inline const GetSparkAppMetricsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSparkAppMetricsResponseBodyData) };
    inline GetSparkAppMetricsResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSparkAppMetricsResponseBodyData) };
    inline GetSparkAppMetricsResponseBody& setData(const GetSparkAppMetricsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSparkAppMetricsResponseBody& setData(GetSparkAppMetricsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<GetSparkAppMetricsResponseBodyData> data_ = nullptr;
    // The request ID.
