...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApsProgressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApsProgressResponseBody) };
    inline DescribeApsProgressResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApsProgressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApsProgressResponseBody> body_ {};
  };
