...
namespace Models
{
  ...
  public:
    ...
    inline const GetADBSparkNecessaryRAMPermissionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetADBSparkNecessaryRAMPermissionsResponseBody) };
    inline GetADBSparkNecessaryRAMPermissionsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetADBSparkNecessaryRAMPermissionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetADBSparkNecessaryRAMPermissionsResponseBody> body_ {};
  };
