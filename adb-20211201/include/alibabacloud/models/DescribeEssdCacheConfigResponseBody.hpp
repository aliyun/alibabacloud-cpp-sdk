...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEssdCacheConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeEssdCacheConfigResponseBodyData) };
    inline DescribeEssdCacheConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeEssdCacheConfigResponseBodyData) };
    inline DescribeEssdCacheConfigResponseBody& setData(const DescribeEssdCacheConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEssdCacheConfigResponseBody& setData(DescribeEssdCacheConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<DescribeEssdCacheConfigResponseBodyData> data_ = nullptr;
    // The request ID.
