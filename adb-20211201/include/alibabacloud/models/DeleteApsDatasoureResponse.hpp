...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteApsDatasoureResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteApsDatasoureResponseBody) };
    inline DeleteApsDatasoureResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteApsDatasoureResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteApsDatasoureResponseBody> body_ {};
  };
