...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBClusterSSLResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBClusterSSLResponseBody) };
    inline ModifyDBClusterSSLResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBClusterSSLResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBClusterSSLResponseBody> body_ {};
  };
