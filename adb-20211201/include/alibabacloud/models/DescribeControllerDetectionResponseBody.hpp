...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeControllerDetectionResponseBodyDetectionItems> & detectionItems() const { DARABONBA_PTR_GET_CONST(detectionItems_, vector<DescribeControllerDetectionResponseBodyDetectionItems>) };
    inline vector<DescribeControllerDetectionResponseBodyDetectionItems> detectionItems() { DARABONBA_PTR_GET(detectionItems_, vector<DescribeControllerDetectionResponseBodyDetectionItems>) };
    inline DescribeControllerDetectionResponseBody& setDetectionItems(const vector<DescribeControllerDetectionResponseBodyDetectionItems> & detectionItems) { DARABONBA_PTR_SET_VALUE(detectionItems_, detectionItems) };
    inline DescribeControllerDetectionResponseBody& setDetectionItems(vector<DescribeControllerDetectionResponseBodyDetectionItems> && detectionItems) { DARABONBA_PTR_SET_RVALUE(detectionItems_, detectionItems) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeControllerDetectionResponseBodyDetectionItems>> detectionItems_ = nullptr;
    // The request ID.
