...
namespace Models
{
  ...
  public:
    ...
    class StageInfos : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const StageInfos& obj) { 
      ...
      friend void from_json(const Darabonba::Json& j, StageInfos& obj) { 
      ...
      StageInfos() = default ;
      StageInfos(const StageInfos &) = default ;
      StageInfos(StageInfos &&) = default ;
      StageInfos(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~StageInfos() = default ;
      StageInfos& operator=(const StageInfos &) = default ;
      StageInfos& operator=(StageInfos &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      virtual bool empty() const override { return this->executionType_ == nullptr
      ...
      inline StageInfos& setExecutionType(string executionType) { DARABONBA_PTR_SET_VALUE(executionType_, executionType) };
      ...
      inline StageInfos& setInputDataSize(int64_t inputDataSize) { DARABONBA_PTR_SET_VALUE(inputDataSize_, inputDataSize) };
      ...
      inline StageInfos& setInputRows(int64_t inputRows) { DARABONBA_PTR_SET_VALUE(inputRows_, inputRows) };
      ...
      inline StageInfos& setOperatorCost(int64_t operatorCost) { DARABONBA_PTR_SET_VALUE(operatorCost_, operatorCost) };
      ...
      inline StageInfos& setOutputDataSize(int64_t outputDataSize) { DARABONBA_PTR_SET_VALUE(outputDataSize_, outputDataSize) };
      ...
      inline StageInfos& setOutputRows(int64_t outputRows) { DARABONBA_PTR_SET_VALUE(outputRows_, outputRows) };
      ...
      inline StageInfos& setPeakMemory(int64_t peakMemory) { DARABONBA_PTR_SET_VALUE(peakMemory_, peakMemory) };
      ...
      inline StageInfos& setProgress(double progress) { DARABONBA_PTR_SET_VALUE(progress_, progress) };
      ...
      inline StageInfos& setStageId(string stageId) { DARABONBA_PTR_SET_VALUE(stageId_, stageId) };
      ...
      inline StageInfos& setState(string state) { DARABONBA_PTR_SET_VALUE(state_, state) };
    ...
    virtual bool empty() const override { return this->diagnosisSQLInfo_ == nullptr
        && this->requestId_ == nullptr && this->stageInfos_ == nullptr; };
    ...
    inline string getDiagnosisSQLInfo() const { DARABONBA_PTR_GET_DEFAULT(diagnosisSQLInfo_, "") };
    ...
    inline const vector<DescribeDiagnosisSQLInfoResponseBody::StageInfos> & getStageInfos() const { DARABONBA_PTR_GET_CONST(stageInfos_, vector<DescribeDiagnosisSQLInfoResponseBody::StageInfos>) };
    inline vector<DescribeDiagnosisSQLInfoResponseBody::StageInfos> getStageInfos() { DARABONBA_PTR_GET(stageInfos_, vector<DescribeDiagnosisSQLInfoResponseBody::StageInfos>) };
    inline DescribeDiagnosisSQLInfoResponseBody& setStageInfos(const vector<DescribeDiagnosisSQLInfoResponseBody::StageInfos> & stageInfos) { DARABONBA_PTR_SET_VALUE(stageInfos_, stageInfos) };
    inline DescribeDiagnosisSQLInfoResponseBody& setStageInfos(vector<DescribeDiagnosisSQLInfoResponseBody::StageInfos> && stageInfos) { DARABONBA_PTR_SET_RVALUE(stageInfos_, stageInfos) };


  protected:
    // The queried execution information, including the SQL statement, statistics, execution plan, and operator information.
    shared_ptr<string> diagnosisSQLInfo_ {};
    // The request ID.
    shared_ptr<string> requestId_ {};
    // The queried execution information by stage.
    shared_ptr<vector<DescribeDiagnosisSQLInfoResponseBody::StageInfos>> stageInfos_ {};
  };
