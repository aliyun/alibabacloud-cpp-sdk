...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMvRecommendTasksResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeMvRecommendTasksResponseBodyData) };
    inline DescribeMvRecommendTasksResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeMvRecommendTasksResponseBodyData) };
    inline DescribeMvRecommendTasksResponseBody& setData(const DescribeMvRecommendTasksResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeMvRecommendTasksResponseBody& setData(DescribeMvRecommendTasksResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<DescribeMvRecommendTasksResponseBodyData> data_ = nullptr;
    // The page number.
