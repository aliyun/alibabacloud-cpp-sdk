...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSparkAppLogResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetSparkAppLogResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    GetSparkAppLogResponseBody() = default ;
    GetSparkAppLogResponseBody(const GetSparkAppLogResponseBody &) = default ;
    GetSparkAppLogResponseBody(GetSparkAppLogResponseBody &&) = default ;
    GetSparkAppLogResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSparkAppLogResponseBody() = default ;
    GetSparkAppLogResponseBody& operator=(const GetSparkAppLogResponseBody &) = default ;
    GetSparkAppLogResponseBody& operator=(GetSparkAppLogResponseBody &&) = default ;
