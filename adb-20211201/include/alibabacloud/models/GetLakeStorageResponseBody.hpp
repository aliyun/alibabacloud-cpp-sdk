...
namespace Models
{
  ...
  public:
    ...
    inline const GetLakeStorageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetLakeStorageResponseBodyData) };
    inline GetLakeStorageResponseBodyData data() { DARABONBA_PTR_GET(data_, GetLakeStorageResponseBodyData) };
    inline GetLakeStorageResponseBody& setData(const GetLakeStorageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetLakeStorageResponseBody& setData(GetLakeStorageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetLakeStorageResponseBodyData> data_ = nullptr;
