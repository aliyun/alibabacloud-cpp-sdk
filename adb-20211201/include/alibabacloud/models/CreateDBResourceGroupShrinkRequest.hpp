...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateDBResourceGroupShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AtmConfig, atmConfigShrink_);
    ...
    friend void from_json(const Darabonba::Json& j, CreateDBResourceGroupShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AtmConfig, atmConfigShrink_);
    ...
    virtual bool empty() const override { return this->atmConfigShrink_ == nullptr
        ...
        && this->enableSpot_ == nullptr && this->engine_ == nullptr && this->engineParamsShrink_ == nullptr && this->gpuElasticPlanShrink_ == nullptr && this->groupName_ == nullptr
        ...
        && this->minComputeResource_ == nullptr && this->minGpuQuantity_ == nullptr && this->rayConfigShrink_ == nullptr && this->regionId_ == nullptr && this->rulesShrink_ == nullptr
        && this->scalePolicy_ == nullptr && this->specName_ == nullptr && this->targetResourceGroupName_ == nullptr; };
    // atmConfigShrink Field Functions 
    bool hasAtmConfigShrink() const { return this->atmConfigShrink_ != nullptr;};
    void deleteAtmConfigShrink() { this->atmConfigShrink_ = nullptr;};
    inline string getAtmConfigShrink() const { DARABONBA_PTR_GET_DEFAULT(atmConfigShrink_, "") };
    inline CreateDBResourceGroupShrinkRequest& setAtmConfigShrink(string atmConfigShrink) { DARABONBA_PTR_SET_VALUE(atmConfigShrink_, atmConfigShrink) };
    ...
    inline CreateDBResourceGroupShrinkRequest& setClassification(string classification) { DARABONBA_PTR_SET_VALUE(classification_, classification) };
    ...
    inline CreateDBResourceGroupShrinkRequest& setScalePolicy(string scalePolicy) { DARABONBA_PTR_SET_VALUE(scalePolicy_, scalePolicy) };
