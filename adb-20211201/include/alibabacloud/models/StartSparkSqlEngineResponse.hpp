...
namespace Models
{
  ...
  public:
    ...
    inline const StartSparkSQLEngineResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartSparkSQLEngineResponseBody) };
    inline StartSparkSQLEngineResponseBody getBody() { DARABONBA_PTR_GET(body_, StartSparkSQLEngineResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartSparkSQLEngineResponseBody> body_ {};
  };
