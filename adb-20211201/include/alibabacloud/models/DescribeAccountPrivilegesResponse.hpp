...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAccountPrivilegesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAccountPrivilegesResponseBody) };
    inline DescribeAccountPrivilegesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAccountPrivilegesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAccountPrivilegesResponseBody> body_ {};
  };
