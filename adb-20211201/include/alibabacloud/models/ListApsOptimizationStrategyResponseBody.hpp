...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListApsOptimizationStrategyResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListApsOptimizationStrategyResponseBodyData>) };
    inline vector<ListApsOptimizationStrategyResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListApsOptimizationStrategyResponseBodyData>) };
    inline ListApsOptimizationStrategyResponseBody& setData(const vector<ListApsOptimizationStrategyResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListApsOptimizationStrategyResponseBody& setData(vector<ListApsOptimizationStrategyResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<vector<ListApsOptimizationStrategyResponseBodyData>> data_ = nullptr;
