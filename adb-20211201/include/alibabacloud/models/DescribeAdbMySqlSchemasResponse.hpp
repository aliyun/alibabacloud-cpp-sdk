...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAdbMySqlSchemasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAdbMySqlSchemasResponseBody) };
    inline DescribeAdbMySqlSchemasResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAdbMySqlSchemasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAdbMySqlSchemasResponseBody> body_ {};
  };
