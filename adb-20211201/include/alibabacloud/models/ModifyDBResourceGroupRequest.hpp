  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->appConfig_ == nullptr
        ...
        && this->headSpecType_ == nullptr && this->storageMounts_ == nullptr && this->userDefinedRequirements_ == nullptr && this->workerGroups_ == nullptr; };
    ...
    virtual bool empty() const override { return this->atmConfig_ == nullptr
        && this->autoStopInterval_ == nullptr && this->clusterMode_ == nullptr && this->clusterSizeResource_ == nullptr && this->DBClusterId_ == nullptr && this->enableSpot_ == nullptr
        ...
        && this->rayConfig_ == nullptr && this->regionId_ == nullptr && this->rules_ == nullptr && this->specName_ == nullptr && this->status_ == nullptr
        && this->targetResourceGroupName_ == nullptr; };
    ...
    inline const ModifyDBResourceGroupRequest::AtmConfig & getAtmConfig() const { DARABONBA_PTR_GET_CONST(atmConfig_, ModifyDBResourceGroupRequest::AtmConfig) };
    inline ModifyDBResourceGroupRequest::AtmConfig getAtmConfig() { DARABONBA_PTR_GET(atmConfig_, ModifyDBResourceGroupRequest::AtmConfig) };
    inline ModifyDBResourceGroupRequest& setAtmConfig(const ModifyDBResourceGroupRequest::AtmConfig & atmConfig) { DARABONBA_PTR_SET_VALUE(atmConfig_, atmConfig) };
    inline ModifyDBResourceGroupRequest& setAtmConfig(ModifyDBResourceGroupRequest::AtmConfig && atmConfig) { DARABONBA_PTR_SET_RVALUE(atmConfig_, atmConfig) };
