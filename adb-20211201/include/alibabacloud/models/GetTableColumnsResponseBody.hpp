...
namespace Models
{
  ...
  public:
    ...
    inline const GetTableColumnsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTableColumnsResponseBodyData) };
    inline GetTableColumnsResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTableColumnsResponseBodyData) };
    inline GetTableColumnsResponseBody& setData(const GetTableColumnsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTableColumnsResponseBody& setData(GetTableColumnsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<GetTableColumnsResponseBodyData> data_ = nullptr;
