...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLakeStorageResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateLakeStorageResponseBody::Data) };
    inline UpdateLakeStorageResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateLakeStorageResponseBody::Data) };
    inline UpdateLakeStorageResponseBody& setData(const UpdateLakeStorageResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateLakeStorageResponseBody& setData(UpdateLakeStorageResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    shared_ptr<UpdateLakeStorageResponseBody::Data> data_ {};
