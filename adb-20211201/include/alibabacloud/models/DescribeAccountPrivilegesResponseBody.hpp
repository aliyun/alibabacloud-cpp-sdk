...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAccountPrivilegesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeAccountPrivilegesResponseBodyData>) };
    inline vector<DescribeAccountPrivilegesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeAccountPrivilegesResponseBodyData>) };
    inline DescribeAccountPrivilegesResponseBody& setData(const vector<DescribeAccountPrivilegesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAccountPrivilegesResponseBody& setData(vector<DescribeAccountPrivilegesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeAccountPrivilegesResponseBodyData>> data_ = nullptr;
