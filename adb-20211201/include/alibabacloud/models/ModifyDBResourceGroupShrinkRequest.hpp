...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->atmConfigShrink_ == nullptr
        ...
        && this->rayConfigShrink_ == nullptr && this->regionId_ == nullptr && this->rulesShrink_ == nullptr && this->specName_ == nullptr && this->status_ == nullptr
    ...
    inline ModifyDBResourceGroupShrinkRequest& setAtmConfigShrink(string atmConfigShrink) { DARABONBA_PTR_SET_VALUE(atmConfigShrink_, atmConfigShrink) };
