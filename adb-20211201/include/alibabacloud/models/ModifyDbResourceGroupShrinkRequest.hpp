...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoStopInterval_ == nullptr
        && this->clusterMode_ == nullptr && this->clusterSizeResource_ == nullptr && this->DBClusterId_ == nullptr && this->enableSpot_ == nullptr && this->engineParamsShrink_ == nullptr
        && this->gpuElasticPlanShrink_ == nullptr && this->groupName_ == nullptr && this->groupType_ == nullptr && this->maxClusterCount_ == nullptr && this->maxComputeResource_ == nullptr
        && this->maxGpuQuantity_ == nullptr && this->minClusterCount_ == nullptr && this->minComputeResource_ == nullptr && this->minGpuQuantity_ == nullptr && this->rayConfigShrink_ == nullptr
        && this->regionId_ == nullptr && this->rulesShrink_ == nullptr && this->specName_ == nullptr && this->status_ == nullptr && this->targetResourceGroupName_ == nullptr; };
