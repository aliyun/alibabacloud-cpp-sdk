...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->autoStopInterval_ != nullptr
        ...
        && this->minClusterCount_ != nullptr && this->minComputeResource_ != nullptr && this->minGpuQuantity_ != nullptr && this->rayConfigShrink_ != nullptr && this->regionId_ != nullptr
        && this->rulesShrink_ != nullptr && this->specName_ != nullptr && this->status_ != nullptr && this->targetResourceGroupName_ != nullptr; };
