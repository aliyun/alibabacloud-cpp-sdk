...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAccountAllPrivilegesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAccountAllPrivilegesResponseBody) };
    inline DescribeAccountAllPrivilegesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAccountAllPrivilegesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAccountAllPrivilegesResponseBody> body_ {};
  };
