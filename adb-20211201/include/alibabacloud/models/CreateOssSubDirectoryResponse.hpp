...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOssSubDirectoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateOssSubDirectoryResponseBody) };
    inline CreateOssSubDirectoryResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateOssSubDirectoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateOssSubDirectoryResponseBody> body_ {};
  };
