...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSparkSQLDiagnosisListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSparkSQLDiagnosisListResponseBody) };
    inline DescribeSparkSQLDiagnosisListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSparkSQLDiagnosisListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSparkSQLDiagnosisListResponseBody> body_ {};
  };
