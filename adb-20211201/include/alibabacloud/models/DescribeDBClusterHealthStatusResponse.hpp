...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClusterHealthStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBClusterHealthStatusResponseBody) };
    inline DescribeDBClusterHealthStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBClusterHealthStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBClusterHealthStatusResponseBody> body_ {};
  };
