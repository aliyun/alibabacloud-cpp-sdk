...
namespace Models
{
  ...
  public:
    ...
    inline const KillSparkAppResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, KillSparkAppResponseBodyData) };
    inline KillSparkAppResponseBodyData data() { DARABONBA_PTR_GET(data_, KillSparkAppResponseBodyData) };
    inline KillSparkAppResponseBody& setData(const KillSparkAppResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline KillSparkAppResponseBody& setData(KillSparkAppResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<KillSparkAppResponseBodyData> data_ = nullptr;
    // The request ID.
