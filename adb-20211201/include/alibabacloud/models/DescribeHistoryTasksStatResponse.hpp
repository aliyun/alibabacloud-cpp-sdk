...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHistoryTasksStatResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHistoryTasksStatResponseBody) };
    inline DescribeHistoryTasksStatResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHistoryTasksStatResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHistoryTasksStatResponseBody> body_ {};
  };
