...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExcessivePrimaryKeysResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeExcessivePrimaryKeysResponseBody) };
    inline DescribeExcessivePrimaryKeysResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeExcessivePrimaryKeysResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeExcessivePrimaryKeysResponseBody> body_ {};
  };
