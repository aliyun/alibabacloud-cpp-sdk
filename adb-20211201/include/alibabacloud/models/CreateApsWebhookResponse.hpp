...
namespace Models
{
  ...
  public:
    ...
    inline const CreateApsWebhookResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateApsWebhookResponseBody) };
    inline CreateApsWebhookResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateApsWebhookResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateApsWebhookResponseBody> body_ {};
  };
