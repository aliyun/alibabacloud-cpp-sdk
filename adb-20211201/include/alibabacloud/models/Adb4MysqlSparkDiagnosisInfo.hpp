...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->diagnosisCode_ == nullptr
    ...
    inline string getDiagnosisCode() const { DARABONBA_PTR_GET_DEFAULT(diagnosisCode_, "") };
    ...
    inline string getDiagnosisCodeLabel() const { DARABONBA_PTR_GET_DEFAULT(diagnosisCodeLabel_, "") };
    ...
    inline string getDiagnosisMsg() const { DARABONBA_PTR_GET_DEFAULT(diagnosisMsg_, "") };
    ...
    inline string getDiagnosisType() const { DARABONBA_PTR_GET_DEFAULT(diagnosisType_, "") };
  ...
  protected:
    shared_ptr<string> diagnosisCode_ {};
    shared_ptr<string> diagnosisCodeLabel_ {};
    shared_ptr<string> diagnosisMsg_ {};
    shared_ptr<string> diagnosisType_ {};
  };
