...
namespace Models
{
  ...
  public:
    ...
    inline const DisableElasticPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableElasticPlanResponseBody) };
    inline DisableElasticPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableElasticPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableElasticPlanResponseBody> body_ {};
  };
