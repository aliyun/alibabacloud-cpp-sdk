...
#ifndef ALIBABACLOUD_MODELS_PRELOADSPARKAPPMETRICSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_PRELOADSPARKAPPMETRICSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PreloadSparkAppMetricsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, PreloadSparkAppMetricsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    PreloadSparkAppMetricsResponseBody() = default ;
    PreloadSparkAppMetricsResponseBody(const PreloadSparkAppMetricsResponseBody &) = default ;
    PreloadSparkAppMetricsResponseBody(PreloadSparkAppMetricsResponseBody &&) = default ;
    PreloadSparkAppMetricsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PreloadSparkAppMetricsResponseBody() = default ;
    PreloadSparkAppMetricsResponseBody& operator=(const PreloadSparkAppMetricsResponseBody &) = default ;
    PreloadSparkAppMetricsResponseBody& operator=(PreloadSparkAppMetricsResponseBody &&) = default ;
    ...
    inline const PreloadSparkAppMetricsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, PreloadSparkAppMetricsResponseBody::Data) };
    inline PreloadSparkAppMetricsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, PreloadSparkAppMetricsResponseBody::Data) };
    inline PreloadSparkAppMetricsResponseBody& setData(const PreloadSparkAppMetricsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline PreloadSparkAppMetricsResponseBody& setData(PreloadSparkAppMetricsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline PreloadSparkAppMetricsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The returned data.
    shared_ptr<PreloadSparkAppMetricsResponseBody::Data> data_ {};
    // The request ID.
