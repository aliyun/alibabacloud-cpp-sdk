...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acrossRole_ == nullptr
        && return this->acrossUid_ == nullptr && return this->advancedConfig_ == nullptr && return this->columns_ == nullptr && return this->DBClusterId_ == nullptr && return this->dataOutputFormat_ == nullptr
        ...
        && return this->ossLocation_ == nullptr && return this->outputFormat_ == nullptr && return this->partitionSpecs_ == nullptr && return this->primaryKeyDefinition_ == nullptr && return this->regionId_ == nullptr
