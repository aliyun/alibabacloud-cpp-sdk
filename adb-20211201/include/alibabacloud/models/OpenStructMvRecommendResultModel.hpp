...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceleratedQueriesCount_ == nullptr
        && this->baseTables_ == nullptr && this->savedScanbytes_ == nullptr && this->subquery_ == nullptr && this->subqueryId_ == nullptr && this->supportIncrementalRefresh_ == nullptr; };
    ...
    inline int64_t getAcceleratedQueriesCount() const { DARABONBA_PTR_GET_DEFAULT(acceleratedQueriesCount_, 0L) };
    ...
    inline const vector<OpenStructMvBaseTableDetailModel> & getBaseTables() const { DARABONBA_PTR_GET_CONST(baseTables_, vector<OpenStructMvBaseTableDetailModel>) };
    inline vector<OpenStructMvBaseTableDetailModel> getBaseTables() { DARABONBA_PTR_GET(baseTables_, vector<OpenStructMvBaseTableDetailModel>) };
    ...
    inline int64_t getSavedScanbytes() const { DARABONBA_PTR_GET_DEFAULT(savedScanbytes_, 0L) };
    ...
    inline string getSubquery() const { DARABONBA_PTR_GET_DEFAULT(subquery_, "") };
    ...
    inline bool getSupportIncrementalRefresh() const { DARABONBA_PTR_GET_DEFAULT(supportIncrementalRefresh_, false) };
  ...
  protected:
    shared_ptr<int64_t> acceleratedQueriesCount_ {};
    shared_ptr<vector<OpenStructMvBaseTableDetailModel>> baseTables_ {};
    shared_ptr<int64_t> savedScanbytes_ {};
    shared_ptr<string> subquery_ {};
    shared_ptr<int64_t> subqueryId_ {};
    shared_ptr<bool> supportIncrementalRefresh_ {};
  };
