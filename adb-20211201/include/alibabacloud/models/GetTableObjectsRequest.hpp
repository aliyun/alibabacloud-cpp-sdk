...
namespace Models
{
  ...
  public:
    ...
    inline string getFilterDescription() const { DARABONBA_PTR_GET_DEFAULT(filterDescription_, "") };
    ...
    inline string getFilterTblName() const { DARABONBA_PTR_GET_DEFAULT(filterTblName_, "") };
    ...
    inline string getFilterTblType() const { DARABONBA_PTR_GET_DEFAULT(filterTblType_, "") };
