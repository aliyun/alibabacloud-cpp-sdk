...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAdviceServiceEnabledResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAdviceServiceEnabledResponseBody) };
    inline DescribeAdviceServiceEnabledResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAdviceServiceEnabledResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAdviceServiceEnabledResponseBody> body_ {};
  };
