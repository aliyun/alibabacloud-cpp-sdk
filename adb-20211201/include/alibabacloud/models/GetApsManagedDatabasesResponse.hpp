...
namespace Models
{
  ...
  public:
    ...
    inline const GetApsManagedDatabasesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetApsManagedDatabasesResponseBody) };
    inline GetApsManagedDatabasesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetApsManagedDatabasesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetApsManagedDatabasesResponseBody> body_ {};
  };
