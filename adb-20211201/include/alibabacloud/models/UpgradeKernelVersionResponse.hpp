...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeKernelVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeKernelVersionResponseBody) };
    inline UpgradeKernelVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeKernelVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeKernelVersionResponseBody> body_ {};
  };
