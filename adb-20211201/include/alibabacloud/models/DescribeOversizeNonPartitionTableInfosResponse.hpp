...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOversizeNonPartitionTableInfosResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeOversizeNonPartitionTableInfosResponseBody) };
    inline DescribeOversizeNonPartitionTableInfosResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeOversizeNonPartitionTableInfosResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeOversizeNonPartitionTableInfosResponseBody> body_ {};
  };
