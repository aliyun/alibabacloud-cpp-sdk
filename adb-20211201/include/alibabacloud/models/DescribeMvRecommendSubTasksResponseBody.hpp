...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMvRecommendSubTasksResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeMvRecommendSubTasksResponseBodyData) };
    inline DescribeMvRecommendSubTasksResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeMvRecommendSubTasksResponseBodyData) };
    inline DescribeMvRecommendSubTasksResponseBody& setData(const DescribeMvRecommendSubTasksResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeMvRecommendSubTasksResponseBody& setData(DescribeMvRecommendSubTasksResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<DescribeMvRecommendSubTasksResponseBodyData> data_ = nullptr;
    // The page number.
