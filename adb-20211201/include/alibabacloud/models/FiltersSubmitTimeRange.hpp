...
#ifndef ALIBABACLOUD_MODELS_FILTERSSUBMITTIMERANGE_HPP_
#define ALIBABACLOUD_MODELS_FILTERSSUBMITTIMERANGE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FiltersSubmitTimeRange& obj) { 
      DARABONBA_PTR_TO_JSON(MaxTimeInMills, maxTimeInMills_);
      DARABONBA_PTR_TO_JSON(MinTimeInMills, minTimeInMills_);
    };
    friend void from_json(const Darabonba::Json& j, FiltersSubmitTimeRange& obj) { 
      DARABONBA_PTR_FROM_JSON(MaxTimeInMills, maxTimeInMills_);
      DARABONBA_PTR_FROM_JSON(MinTimeInMills, minTimeInMills_);
    };
    FiltersSubmitTimeRange() = default ;
    FiltersSubmitTimeRange(const FiltersSubmitTimeRange &) = default ;
    FiltersSubmitTimeRange(FiltersSubmitTimeRange &&) = default ;
    FiltersSubmitTimeRange(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FiltersSubmitTimeRange() = default ;
    FiltersSubmitTimeRange& operator=(const FiltersSubmitTimeRange &) = default ;
    FiltersSubmitTimeRange& operator=(FiltersSubmitTimeRange &&) = default ;
    ...
    inline FiltersSubmitTimeRange& setMaxTimeInMills(int64_t maxTimeInMills) { DARABONBA_PTR_SET_VALUE(maxTimeInMills_, maxTimeInMills) };
    ...
    inline FiltersSubmitTimeRange& setMinTimeInMills(int64_t minTimeInMills) { DARABONBA_PTR_SET_VALUE(minTimeInMills_, minTimeInMills) };
