...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dbList_ == nullptr
        && return this->destinationEndpointInstanceID_ == nullptr && return this->destinationEndpointRegion_ == nullptr && return this->partitionList_ == nullptr && return this->sourceEndpointInstanceID_ == nullptr && return this->sourceEndpointRegion_ == nullptr
        && return this->status_ == nullptr && return this->targetTableMode_ == nullptr; };
