...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyUserEniVswitchOptionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyUserEniVswitchOptionsResponseBody) };
    inline ModifyUserEniVswitchOptionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyUserEniVswitchOptionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyUserEniVswitchOptionsResponseBody> body_ {};
  };
