...
namespace Models
{
  ...
  public:
    ...
    inline string getAgentSource() const { DARABONBA_PTR_GET_DEFAULT(agentSource_, "") };
    ...
    inline int64_t getTemplateFileId() const { DARABONBA_PTR_GET_DEFAULT(templateFileId_, 0L) };
  ...
  protected:
    ...
    shared_ptr<string> agentSource_ {};
    ...
    shared_ptr<int64_t> templateFileId_ {};
  };
