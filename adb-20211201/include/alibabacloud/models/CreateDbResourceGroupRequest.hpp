...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoStopInterval_ == nullptr
        ...
        && return this->engineParams_ == nullptr && return this->gpuElasticPlan_ == nullptr && return this->groupName_ == nullptr && return this->groupType_ == nullptr && return this->maxClusterCount_ == nullptr
        ...
        && return this->rayConfig_ == nullptr && return this->regionId_ == nullptr && return this->rules_ == nullptr && return this->specName_ == nullptr && return this->targetResourceGroupName_ == nullptr; };
    ...
    inline const CreateDBResourceGroupRequestGpuElasticPlan & gpuElasticPlan() const { DARABONBA_PTR_GET_CONST(gpuElasticPlan_, CreateDBResourceGroupRequestGpuElasticPlan) };
    inline CreateDBResourceGroupRequestGpuElasticPlan gpuElasticPlan() { DARABONBA_PTR_GET(gpuElasticPlan_, CreateDBResourceGroupRequestGpuElasticPlan) };
    inline CreateDBResourceGroupRequest& setGpuElasticPlan(const CreateDBResourceGroupRequestGpuElasticPlan & gpuElasticPlan) { DARABONBA_PTR_SET_VALUE(gpuElasticPlan_, gpuElasticPlan) };
    inline CreateDBResourceGroupRequest& setGpuElasticPlan(CreateDBResourceGroupRequestGpuElasticPlan && gpuElasticPlan) { DARABONBA_PTR_SET_RVALUE(gpuElasticPlan_, gpuElasticPlan) };
    ...
    inline const CreateDBResourceGroupRequestRayConfig & rayConfig() const { DARABONBA_PTR_GET_CONST(rayConfig_, CreateDBResourceGroupRequestRayConfig) };
    inline CreateDBResourceGroupRequestRayConfig rayConfig() { DARABONBA_PTR_GET(rayConfig_, CreateDBResourceGroupRequestRayConfig) };
    inline CreateDBResourceGroupRequest& setRayConfig(const CreateDBResourceGroupRequestRayConfig & rayConfig) { DARABONBA_PTR_SET_VALUE(rayConfig_, rayConfig) };
    inline CreateDBResourceGroupRequest& setRayConfig(CreateDBResourceGroupRequestRayConfig && rayConfig) { DARABONBA_PTR_SET_RVALUE(rayConfig_, rayConfig) };
    ...
    inline const vector<CreateDBResourceGroupRequestRules> & rules() const { DARABONBA_PTR_GET_CONST(rules_, vector<CreateDBResourceGroupRequestRules>) };
    inline vector<CreateDBResourceGroupRequestRules> rules() { DARABONBA_PTR_GET(rules_, vector<CreateDBResourceGroupRequestRules>) };
    inline CreateDBResourceGroupRequest& setRules(const vector<CreateDBResourceGroupRequestRules> & rules) { DARABONBA_PTR_SET_VALUE(rules_, rules) };
    inline CreateDBResourceGroupRequest& setRules(vector<CreateDBResourceGroupRequestRules> && rules) { DARABONBA_PTR_SET_RVALUE(rules_, rules) };
  ...
  protected:
    ...
    std::shared_ptr<CreateDBResourceGroupRequestGpuElasticPlan> gpuElasticPlan_ = nullptr;
    ...
    std::shared_ptr<CreateDBResourceGroupRequestRayConfig> rayConfig_ = nullptr;
    // The region ID of the cluster.
    // 
    // >  You can call the [DescribeRegions](https://help.aliyun.com/document_detail/612393.html) operation to query the most recent region list.
    std::shared_ptr<string> regionId_ = nullptr;
    // The job resubmission rules.
    std::shared_ptr<vector<CreateDBResourceGroupRequestRules>> rules_ = nullptr;
    // A reserved parameter.
