...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePerformanceViewsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePerformanceViewsResponseBody) };
    inline DescribePerformanceViewsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePerformanceViewsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePerformanceViewsResponseBody> body_ {};
  };
