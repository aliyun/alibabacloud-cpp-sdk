...
namespace Models
{
  ...
  public:
    ...
    inline const GetADBSparkNecessaryRAMPermissionsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetADBSparkNecessaryRAMPermissionsResponseBodyData) };
    inline GetADBSparkNecessaryRAMPermissionsResponseBodyData data() { DARABONBA_PTR_GET(data_, GetADBSparkNecessaryRAMPermissionsResponseBodyData) };
    inline GetADBSparkNecessaryRAMPermissionsResponseBody& setData(const GetADBSparkNecessaryRAMPermissionsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetADBSparkNecessaryRAMPermissionsResponseBody& setData(GetADBSparkNecessaryRAMPermissionsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
