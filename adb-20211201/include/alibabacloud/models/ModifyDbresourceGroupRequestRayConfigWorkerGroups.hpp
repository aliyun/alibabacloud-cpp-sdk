...
#ifndef ALIBABACLOUD_MODELS_MODIFYDBRESOURCEGROUPREQUESTRAYCONFIGWORKERGROUPS_HPP_
#define ALIBABACLOUD_MODELS_MODIFYDBRESOURCEGROUPREQUESTRAYCONFIGWORKERGROUPS_HPP_
...
namespace Models
{
  class ModifyDBResourceGroupRequestRayConfigWorkerGroups : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModifyDBResourceGroupRequestRayConfigWorkerGroups& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyDBResourceGroupRequestRayConfigWorkerGroups& obj) { 
    ...
    ModifyDBResourceGroupRequestRayConfigWorkerGroups() = default ;
    ModifyDBResourceGroupRequestRayConfigWorkerGroups(const ModifyDBResourceGroupRequestRayConfigWorkerGroups &) = default ;
    ModifyDBResourceGroupRequestRayConfigWorkerGroups(ModifyDBResourceGroupRequestRayConfigWorkerGroups &&) = default ;
    ModifyDBResourceGroupRequestRayConfigWorkerGroups(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyDBResourceGroupRequestRayConfigWorkerGroups() = default ;
    ModifyDBResourceGroupRequestRayConfigWorkerGroups& operator=(const ModifyDBResourceGroupRequestRayConfigWorkerGroups &) = default ;
    ModifyDBResourceGroupRequestRayConfigWorkerGroups& operator=(ModifyDBResourceGroupRequestRayConfigWorkerGroups &&) = default ;
    ...
    inline ModifyDBResourceGroupRequestRayConfigWorkerGroups& setAllocateUnit(string allocateUnit) { DARABONBA_PTR_SET_VALUE(allocateUnit_, allocateUnit) };
    ...
    inline ModifyDBResourceGroupRequestRayConfigWorkerGroups& setGroupName(string groupName) { DARABONBA_PTR_SET_VALUE(groupName_, groupName) };
    ...
    inline ModifyDBResourceGroupRequestRayConfigWorkerGroups& setMaxWorkerQuantity(int32_t maxWorkerQuantity) { DARABONBA_PTR_SET_VALUE(maxWorkerQuantity_, maxWorkerQuantity) };
    ...
    inline ModifyDBResourceGroupRequestRayConfigWorkerGroups& setMinWorkerQuantity(int32_t minWorkerQuantity) { DARABONBA_PTR_SET_VALUE(minWorkerQuantity_, minWorkerQuantity) };
    ...
    inline ModifyDBResourceGroupRequestRayConfigWorkerGroups& setWorkerDiskCapacity(string workerDiskCapacity) { DARABONBA_PTR_SET_VALUE(workerDiskCapacity_, workerDiskCapacity) };
    ...
    inline ModifyDBResourceGroupRequestRayConfigWorkerGroups& setWorkerSpecName(string workerSpecName) { DARABONBA_PTR_SET_VALUE(workerSpecName_, workerSpecName) };
    ...
    inline ModifyDBResourceGroupRequestRayConfigWorkerGroups& setWorkerSpecType(string workerSpecType) { DARABONBA_PTR_SET_VALUE(workerSpecType_, workerSpecType) };
