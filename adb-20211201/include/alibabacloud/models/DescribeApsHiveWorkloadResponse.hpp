...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApsHiveWorkloadResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApsHiveWorkloadResponseBody) };
    inline DescribeApsHiveWorkloadResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApsHiveWorkloadResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApsHiveWorkloadResponseBody> body_ {};
  };
