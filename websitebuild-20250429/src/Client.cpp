...
GrantPromotionOfferForPartnerResponse Client::grantPromotionOfferForPartnerWithOptions(const GrantPromotionOfferForPartnerRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasEmployeeCode()) {
    query["EmployeeCode"] = request.getEmployeeCode();
  }
  ...
  return json(callApi(params, req, runtime)).get<GrantPromotionOfferForPartnerResponse>();
}
 ...
 * @return GrantPromotionOfferForPartnerResponse
 */
GrantPromotionOfferForPartnerResponse Client::grantPromotionOfferForPartner(const GrantPromotionOfferForPartnerRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return grantPromotionOfferForPartnerWithOptions(request, runtime);
}
 ...
 */
ListPromotionActivitiesForPartnerResponse Client::listPromotionActivitiesForPartnerWithOptions(const ListPromotionActivitiesForPartnerRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasChannel()) {
    query["Channel"] = request.getChannel();
  ...
  return json(callApi(params, req, runtime)).get<ListPromotionActivitiesForPartnerResponse>();
}
 ...
 * @return ListPromotionActivitiesForPartnerResponse
 */
ListPromotionActivitiesForPartnerResponse Client::listPromotionActivitiesForPartner(const ListPromotionActivitiesForPartnerRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return listPromotionActivitiesForPartnerWithOptions(request, runtime);
}
 ...
 */
ListPromotionOfferRecordsForPartnerResponse Client::listPromotionOfferRecordsForPartnerWithOptions(const ListPromotionOfferRecordsForPartnerRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasActivityCode()) {
    query["ActivityCode"] = request.getActivityCode();
  ...
  return json(callApi(params, req, runtime)).get<ListPromotionOfferRecordsForPartnerResponse>();
}
 ...
 * @return ListPromotionOfferRecordsForPartnerResponse
 */
ListPromotionOfferRecordsForPartnerResponse Client::listPromotionOfferRecordsForPartner(const ListPromotionOfferRecordsForPartnerRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return listPromotionOfferRecordsForPartnerWithOptions(request, runtime);
}
