...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->liveToken_ == nullptr
        && this->operation_ == nullptr && this->params_ == nullptr && this->product_ == nullptr && this->siteHost_ == nullptr; };
    ...
    inline string getLiveToken() const { DARABONBA_PTR_GET_DEFAULT(liveToken_, "") };
