...
#ifndef ALIBABACLOUD_MODELS_MODULENEXTCOMPONENTSVALUE_HPP_
#define ALIBABACLOUD_MODELS_MODULENEXTCOMPONENTSVALUE_HPP_
...
namespace Models
{
  class ModuleNextComponentsValue : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModuleNextComponentsValue& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleNextComponentsValue& obj) { 
    ...
    ModuleNextComponentsValue() = default ;
    ModuleNextComponentsValue(const ModuleNextComponentsValue &) = default ;
    ModuleNextComponentsValue(ModuleNextComponentsValue &&) = default ;
    ModuleNextComponentsValue(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleNextComponentsValue() = default ;
    ModuleNextComponentsValue& operator=(const ModuleNextComponentsValue &) = default ;
    ModuleNextComponentsValue& operator=(ModuleNextComponentsValue &&) = default ;
    ...
    void deleteCode() { this->code_ = nullptr;};
    inline string getCode() const { DARABONBA_PTR_GET_DEFAULT(code_, "") };
    inline ModuleNextComponentsValue& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    void deleteName() { this->name_ = nullptr;};
    inline string getName() const { DARABONBA_PTR_GET_DEFAULT(name_, "") };
    inline ModuleNextComponentsValue& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline const vector<ModuleNextComponentsValue::InstanceProperty> & getInstanceProperty() const { DARABONBA_PTR_GET_CONST(instanceProperty_, vector<ModuleNextComponentsValue::InstanceProperty>) };
    inline vector<ModuleNextComponentsValue::InstanceProperty> getInstanceProperty() { DARABONBA_PTR_GET(instanceProperty_, vector<ModuleNextComponentsValue::InstanceProperty>) };
    inline ModuleNextComponentsValue& setInstanceProperty(const vector<ModuleNextComponentsValue::InstanceProperty> & instanceProperty) { DARABONBA_PTR_SET_VALUE(instanceProperty_, instanceProperty) };
    inline ModuleNextComponentsValue& setInstanceProperty(vector<ModuleNextComponentsValue::InstanceProperty> && instanceProperty) { DARABONBA_PTR_SET_RVALUE(instanceProperty_, instanceProperty) };


    // properties Field Functions 
    bool hasProperties() const { return this->properties_ != nullptr;};
    void deleteProperties() { this->properties_ = nullptr;};
    inline const map<string, ModuleNextComponentsValuePropertiesValue> & getProperties() const { DARABONBA_PTR_GET_CONST(properties_, map<string, ModuleNextComponentsValuePropertiesValue>) };
    inline map<string, ModuleNextComponentsValuePropertiesValue> getProperties() { DARABONBA_PTR_GET(properties_, map<string, ModuleNextComponentsValuePropertiesValue>) };
    inline ModuleNextComponentsValue& setProperties(const map<string, ModuleNextComponentsValuePropertiesValue> & properties) { DARABONBA_PTR_SET_VALUE(properties_, properties) };
    inline ModuleNextComponentsValue& setProperties(map<string, ModuleNextComponentsValuePropertiesValue> && properties) { DARABONBA_PTR_SET_RVALUE(properties_, properties) };
    ...
    inline ModuleNextComponentsValue& setModuleAttrStatus(int32_t moduleAttrStatus) { DARABONBA_PTR_SET_VALUE(moduleAttrStatus_, moduleAttrStatus) };
