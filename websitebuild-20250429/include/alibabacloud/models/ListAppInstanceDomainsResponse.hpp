...
namespace Models
{
  ...
  public:
    ...
    inline const ListAppInstanceDomainsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAppInstanceDomainsResponseBody) };
    inline ListAppInstanceDomainsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAppInstanceDomainsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAppInstanceDomainsResponseBody> body_ {};
  };
