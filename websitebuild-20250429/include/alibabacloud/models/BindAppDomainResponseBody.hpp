...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        protected:
          ...
          // The status of the conflicting DNS record. A value of ENABLE indicates that the record is enabled.
      ...
      protected:
        // Indicates whether automatic overwrite is supported. A value of true indicates the current Alibaba Cloud account, and a value of false indicates other accounts.
        ...
        // The list of conflicting DNS records. This reuses the existing AppDomainDnsRecordDTO.
    ...
    inline const BindAppDomainResponseBody::Module & getModule() const { DARABONBA_PTR_GET_CONST(module_, BindAppDomainResponseBody::Module) };
    inline BindAppDomainResponseBody::Module getModule() { DARABONBA_PTR_GET(module_, BindAppDomainResponseBody::Module) };
    inline BindAppDomainResponseBody& setModule(const BindAppDomainResponseBody::Module & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline BindAppDomainResponseBody& setModule(BindAppDomainResponseBody::Module && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
