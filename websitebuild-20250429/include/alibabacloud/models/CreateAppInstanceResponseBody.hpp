...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAppInstanceResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, CreateAppInstanceResponseBodyModule) };
    inline CreateAppInstanceResponseBodyModule module() { DARABONBA_PTR_GET(module_, CreateAppInstanceResponseBodyModule) };
    inline CreateAppInstanceResponseBody& setModule(const CreateAppInstanceResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline CreateAppInstanceResponseBody& setModule(CreateAppInstanceResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<CreateAppInstanceResponseBodyModule> module_ = nullptr;
    // Id of the request
