...
#ifndef ALIBABACLOUD_MODELS_QUERYINSPIRATIONBALANCEFORPARTNERRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYINSPIRATIONBALANCEFORPARTNERRESPONSEBODY_HPP_
...
namespace Models
{
  class QueryInspirationBalanceForPartnerResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryInspirationBalanceForPartnerResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryInspirationBalanceForPartnerResponseBody& obj) { 
    ...
    QueryInspirationBalanceForPartnerResponseBody() = default ;
    QueryInspirationBalanceForPartnerResponseBody(const QueryInspirationBalanceForPartnerResponseBody &) = default ;
    QueryInspirationBalanceForPartnerResponseBody(QueryInspirationBalanceForPartnerResponseBody &&) = default ;
    QueryInspirationBalanceForPartnerResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryInspirationBalanceForPartnerResponseBody() = default ;
    QueryInspirationBalanceForPartnerResponseBody& operator=(const QueryInspirationBalanceForPartnerResponseBody &) = default ;
    QueryInspirationBalanceForPartnerResponseBody& operator=(QueryInspirationBalanceForPartnerResponseBody &&) = default ;
    ...
    inline QueryInspirationBalanceForPartnerResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline QueryInspirationBalanceForPartnerResponseBody& setAllowRetry(bool allowRetry) { DARABONBA_PTR_SET_VALUE(allowRetry_, allowRetry) };
    ...
    inline QueryInspirationBalanceForPartnerResponseBody& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline QueryInspirationBalanceForPartnerResponseBody& setDynamicCode(string dynamicCode) { DARABONBA_PTR_SET_VALUE(dynamicCode_, dynamicCode) };
    ...
    inline QueryInspirationBalanceForPartnerResponseBody& setDynamicMessage(string dynamicMessage) { DARABONBA_PTR_SET_VALUE(dynamicMessage_, dynamicMessage) };
    ...
    inline QueryInspirationBalanceForPartnerResponseBody& setErrorArgs(const vector<Darabonba::Json> & errorArgs) { DARABONBA_PTR_SET_VALUE(errorArgs_, errorArgs) };
    inline QueryInspirationBalanceForPartnerResponseBody& setErrorArgs(vector<Darabonba::Json> && errorArgs) { DARABONBA_PTR_SET_RVALUE(errorArgs_, errorArgs) };


    // module Field Functions 
    bool hasModule() const { return this->module_ != nullptr;};
    void deleteModule() { this->module_ = nullptr;};
    inline const QueryInspirationBalanceForPartnerResponseBody::Module & getModule() const { DARABONBA_PTR_GET_CONST(module_, QueryInspirationBalanceForPartnerResponseBody::Module) };
    inline QueryInspirationBalanceForPartnerResponseBody::Module getModule() { DARABONBA_PTR_GET(module_, QueryInspirationBalanceForPartnerResponseBody::Module) };
    inline QueryInspirationBalanceForPartnerResponseBody& setModule(const QueryInspirationBalanceForPartnerResponseBody::Module & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline QueryInspirationBalanceForPartnerResponseBody& setModule(QueryInspirationBalanceForPartnerResponseBody::Module && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
    ...
    inline QueryInspirationBalanceForPartnerResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryInspirationBalanceForPartnerResponseBody& setRootErrorCode(string rootErrorCode) { DARABONBA_PTR_SET_VALUE(rootErrorCode_, rootErrorCode) };
    ...
    inline QueryInspirationBalanceForPartnerResponseBody& setRootErrorMsg(string rootErrorMsg) { DARABONBA_PTR_SET_VALUE(rootErrorMsg_, rootErrorMsg) };
    ...
    inline QueryInspirationBalanceForPartnerResponseBody& setSynchro(bool synchro) { DARABONBA_PTR_SET_VALUE(synchro_, synchro) };
