...
namespace Models
{
  ...
  public:
    ...
    inline const SetAppDomainCertificateResponseBody::Module & getModule() const { DARABONBA_PTR_GET_CONST(module_, SetAppDomainCertificateResponseBody::Module) };
    inline SetAppDomainCertificateResponseBody::Module getModule() { DARABONBA_PTR_GET(module_, SetAppDomainCertificateResponseBody::Module) };
    inline SetAppDomainCertificateResponseBody& setModule(const SetAppDomainCertificateResponseBody::Module & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline SetAppDomainCertificateResponseBody& setModule(SetAppDomainCertificateResponseBody::Module && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
