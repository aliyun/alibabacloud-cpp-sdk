...
namespace Models
{
  ...
  public:
    ...
    inline const RefreshAppInstanceTicketResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, RefreshAppInstanceTicketResponseBodyModule) };
    inline RefreshAppInstanceTicketResponseBodyModule module() { DARABONBA_PTR_GET(module_, RefreshAppInstanceTicketResponseBodyModule) };
    inline RefreshAppInstanceTicketResponseBody& setModule(const RefreshAppInstanceTicketResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline RefreshAppInstanceTicketResponseBody& setModule(RefreshAppInstanceTicketResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<RefreshAppInstanceTicketResponseBodyModule> module_ = nullptr;
    // Id of the request
