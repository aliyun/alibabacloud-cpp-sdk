...
namespace Models
{
  ...
  public:
    ...
    inline const GetDomainInfoForPartnerResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDomainInfoForPartnerResponseBodyData) };
    inline GetDomainInfoForPartnerResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDomainInfoForPartnerResponseBodyData) };
    inline GetDomainInfoForPartnerResponseBody& setData(const GetDomainInfoForPartnerResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDomainInfoForPartnerResponseBody& setData(GetDomainInfoForPartnerResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<GetDomainInfoForPartnerResponseBodyData> data_ = nullptr;
    // Id of the request
