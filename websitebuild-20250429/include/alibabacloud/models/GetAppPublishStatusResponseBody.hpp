  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->canQuickRevert_ == nullptr
        && this->currentStep_ == nullptr && this->currentStepCode_ == nullptr && this->deployChannel_ == nullptr && this->description_ == nullptr && this->errorStep_ == nullptr
        && this->errorStepCode_ == nullptr && this->isFinish_ == nullptr && this->isSuccess_ == nullptr && this->msg_ == nullptr && this->orderType_ == nullptr
        && this->orderTypeCode_ == nullptr && this->percent_ == nullptr && this->publishNumber_ == nullptr && this->publishOrderId_ == nullptr && this->publishTime_ == nullptr
        && this->siteId_ == nullptr && this->stepCodes_ == nullptr && this->steps_ == nullptr && this->subchannel_ == nullptr; };
      ...
      inline Module& setCurrentStepCode(string currentStepCode) { DARABONBA_PTR_SET_VALUE(currentStepCode_, currentStepCode) };
      ...
      inline Module& setErrorStepCode(string errorStepCode) { DARABONBA_PTR_SET_VALUE(errorStepCode_, errorStepCode) };
      ...
      inline Module& setOrderTypeCode(string orderTypeCode) { DARABONBA_PTR_SET_VALUE(orderTypeCode_, orderTypeCode) };
      ...
      inline Module& setStepCodes(const vector<string> & stepCodes) { DARABONBA_PTR_SET_VALUE(stepCodes_, stepCodes) };
      inline Module& setStepCodes(vector<string> && stepCodes) { DARABONBA_PTR_SET_RVALUE(stepCodes_, stepCodes) };
