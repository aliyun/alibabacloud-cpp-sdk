...
namespace Models
{
  ...
  public:
    ...
    inline const BindAppDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BindAppDomainResponseBody) };
    inline BindAppDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, BindAppDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BindAppDomainResponseBody> body_ {};
  };
