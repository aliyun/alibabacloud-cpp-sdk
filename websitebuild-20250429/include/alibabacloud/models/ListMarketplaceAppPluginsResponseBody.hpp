...
#ifndef ALIBABACLOUD_MODELS_LISTMARKETPLACEAPPPLUGINSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTMARKETPLACEAPPPLUGINSRESPONSEBODY_HPP_
...
namespace Models
{
  class ListMarketplaceAppPluginsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListMarketplaceAppPluginsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListMarketplaceAppPluginsResponseBody& obj) { 
    ...
    ListMarketplaceAppPluginsResponseBody() = default ;
    ListMarketplaceAppPluginsResponseBody(const ListMarketplaceAppPluginsResponseBody &) = default ;
    ListMarketplaceAppPluginsResponseBody(ListMarketplaceAppPluginsResponseBody &&) = default ;
    ListMarketplaceAppPluginsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListMarketplaceAppPluginsResponseBody() = default ;
    ListMarketplaceAppPluginsResponseBody& operator=(const ListMarketplaceAppPluginsResponseBody &) = default ;
    ListMarketplaceAppPluginsResponseBody& operator=(ListMarketplaceAppPluginsResponseBody &&) = default ;
    ...
    inline ListMarketplaceAppPluginsResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ListMarketplaceAppPluginsResponseBody& setAllowRetry(bool allowRetry) { DARABONBA_PTR_SET_VALUE(allowRetry_, allowRetry) };
    ...
    inline ListMarketplaceAppPluginsResponseBody& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline ListMarketplaceAppPluginsResponseBody& setDynamicCode(string dynamicCode) { DARABONBA_PTR_SET_VALUE(dynamicCode_, dynamicCode) };
    ...
    inline ListMarketplaceAppPluginsResponseBody& setDynamicMessage(string dynamicMessage) { DARABONBA_PTR_SET_VALUE(dynamicMessage_, dynamicMessage) };
    ...
    inline ListMarketplaceAppPluginsResponseBody& setErrorArgs(const vector<Darabonba::Json> & errorArgs) { DARABONBA_PTR_SET_VALUE(errorArgs_, errorArgs) };
    inline ListMarketplaceAppPluginsResponseBody& setErrorArgs(vector<Darabonba::Json> && errorArgs) { DARABONBA_PTR_SET_RVALUE(errorArgs_, errorArgs) };


    // module Field Functions 
    bool hasModule() const { return this->module_ != nullptr;};
    void deleteModule() { this->module_ = nullptr;};
    inline const ListMarketplaceAppPluginsResponseBody::Module & getModule() const { DARABONBA_PTR_GET_CONST(module_, ListMarketplaceAppPluginsResponseBody::Module) };
    inline ListMarketplaceAppPluginsResponseBody::Module getModule() { DARABONBA_PTR_GET(module_, ListMarketplaceAppPluginsResponseBody::Module) };
    inline ListMarketplaceAppPluginsResponseBody& setModule(const ListMarketplaceAppPluginsResponseBody::Module & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline ListMarketplaceAppPluginsResponseBody& setModule(ListMarketplaceAppPluginsResponseBody::Module && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
    ...
    inline ListMarketplaceAppPluginsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListMarketplaceAppPluginsResponseBody& setRootErrorCode(string rootErrorCode) { DARABONBA_PTR_SET_VALUE(rootErrorCode_, rootErrorCode) };
    ...
    inline ListMarketplaceAppPluginsResponseBody& setRootErrorMsg(string rootErrorMsg) { DARABONBA_PTR_SET_VALUE(rootErrorMsg_, rootErrorMsg) };
    ...
    inline ListMarketplaceAppPluginsResponseBody& setSynchro(bool synchro) { DARABONBA_PTR_SET_VALUE(synchro_, synchro) };
  ...
  protected:
    ...
    // The response data.
    shared_ptr<ListMarketplaceAppPluginsResponseBody::Module> module_ {};
    // Id of the request
