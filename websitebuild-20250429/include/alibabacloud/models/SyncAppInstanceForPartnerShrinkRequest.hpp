...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appInstanceShrink_ == nullptr
    ...
    inline string getAppInstanceShrink() const { DARABONBA_PTR_GET_DEFAULT(appInstanceShrink_, "") };
