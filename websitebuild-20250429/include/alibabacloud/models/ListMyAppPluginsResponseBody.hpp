...
#ifndef ALIBABACLOUD_MODELS_LISTMYAPPPLUGINSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTMYAPPPLUGINSRESPONSEBODY_HPP_
...
namespace Models
{
  class ListMyAppPluginsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListMyAppPluginsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListMyAppPluginsResponseBody& obj) { 
    ...
    ListMyAppPluginsResponseBody() = default ;
    ListMyAppPluginsResponseBody(const ListMyAppPluginsResponseBody &) = default ;
    ListMyAppPluginsResponseBody(ListMyAppPluginsResponseBody &&) = default ;
    ListMyAppPluginsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListMyAppPluginsResponseBody() = default ;
    ListMyAppPluginsResponseBody& operator=(const ListMyAppPluginsResponseBody &) = default ;
    ListMyAppPluginsResponseBody& operator=(ListMyAppPluginsResponseBody &&) = default ;
    ...
    inline ListMyAppPluginsResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ListMyAppPluginsResponseBody& setAllowRetry(bool allowRetry) { DARABONBA_PTR_SET_VALUE(allowRetry_, allowRetry) };
    ...
    inline ListMyAppPluginsResponseBody& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline ListMyAppPluginsResponseBody& setDynamicCode(string dynamicCode) { DARABONBA_PTR_SET_VALUE(dynamicCode_, dynamicCode) };
    ...
    inline ListMyAppPluginsResponseBody& setDynamicMessage(string dynamicMessage) { DARABONBA_PTR_SET_VALUE(dynamicMessage_, dynamicMessage) };
    ...
    inline ListMyAppPluginsResponseBody& setErrorArgs(const vector<Darabonba::Json> & errorArgs) { DARABONBA_PTR_SET_VALUE(errorArgs_, errorArgs) };
    inline ListMyAppPluginsResponseBody& setErrorArgs(vector<Darabonba::Json> && errorArgs) { DARABONBA_PTR_SET_RVALUE(errorArgs_, errorArgs) };


    // module Field Functions 
    bool hasModule() const { return this->module_ != nullptr;};
    void deleteModule() { this->module_ = nullptr;};
    inline const ListMyAppPluginsResponseBody::Module & getModule() const { DARABONBA_PTR_GET_CONST(module_, ListMyAppPluginsResponseBody::Module) };
    inline ListMyAppPluginsResponseBody::Module getModule() { DARABONBA_PTR_GET(module_, ListMyAppPluginsResponseBody::Module) };
    inline ListMyAppPluginsResponseBody& setModule(const ListMyAppPluginsResponseBody::Module & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline ListMyAppPluginsResponseBody& setModule(ListMyAppPluginsResponseBody::Module && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
    ...
    inline ListMyAppPluginsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListMyAppPluginsResponseBody& setRootErrorCode(string rootErrorCode) { DARABONBA_PTR_SET_VALUE(rootErrorCode_, rootErrorCode) };
    ...
    inline ListMyAppPluginsResponseBody& setRootErrorMsg(string rootErrorMsg) { DARABONBA_PTR_SET_VALUE(rootErrorMsg_, rootErrorMsg) };
    ...
    inline ListMyAppPluginsResponseBody& setSynchro(bool synchro) { DARABONBA_PTR_SET_VALUE(synchro_, synchro) };
  ...
  protected:
    ...
    // The task object.
    shared_ptr<ListMyAppPluginsResponseBody::Module> module_ {};
    // The request ID.
