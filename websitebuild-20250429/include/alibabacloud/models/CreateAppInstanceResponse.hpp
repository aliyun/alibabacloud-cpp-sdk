...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAppInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAppInstanceResponseBody) };
    inline CreateAppInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAppInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAppInstanceResponseBody> body_ {};
  };
