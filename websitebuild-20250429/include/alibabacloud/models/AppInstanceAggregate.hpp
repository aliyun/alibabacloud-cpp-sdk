...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aiStaffList_ == nullptr
        && return this->appOperationAddress_ == nullptr && return this->appServiceList_ == nullptr && return this->appSubType_ == nullptr && return this->appType_ == nullptr && return this->bizId_ == nullptr
        && return this->buildType_ == nullptr && return this->createTime_ == nullptr && return this->deleted_ == nullptr && return this->description_ == nullptr && return this->designSpecBizId_ == nullptr
        && return this->designSpecId_ == nullptr && return this->domain_ == nullptr && return this->endTime_ == nullptr && return this->espBizId_ == nullptr && return this->gmtDelete_ == nullptr
        && return this->gmtModified_ == nullptr && return this->gmtPublish_ == nullptr && return this->iconUrl_ == nullptr && return this->name_ == nullptr && return this->profile_ == nullptr
        && return this->siteHost_ == nullptr && return this->slug_ == nullptr && return this->sourceType_ == nullptr && return this->startTime_ == nullptr && return this->status_ == nullptr
        && return this->statusText_ == nullptr && return this->thumbnailUrl_ == nullptr && return this->userId_ == nullptr; };
    ...
    inline const vector<AppAiStaff> & aiStaffList() const { DARABONBA_PTR_GET_CONST(aiStaffList_, vector<AppAiStaff>) };
    inline vector<AppAiStaff> aiStaffList() { DARABONBA_PTR_GET(aiStaffList_, vector<AppAiStaff>) };
    ...
    inline const AppOperationAddress & appOperationAddress() const { DARABONBA_PTR_GET_CONST(appOperationAddress_, AppOperationAddress) };
    inline AppOperationAddress appOperationAddress() { DARABONBA_PTR_GET(appOperationAddress_, AppOperationAddress) };
    ...
    inline const vector<AppServiceAggregate> & appServiceList() const { DARABONBA_PTR_GET_CONST(appServiceList_, vector<AppServiceAggregate>) };
    inline vector<AppServiceAggregate> appServiceList() { DARABONBA_PTR_GET(appServiceList_, vector<AppServiceAggregate>) };
  ...
  protected:
    std::shared_ptr<vector<AppAiStaff>> aiStaffList_ = nullptr;
    std::shared_ptr<AppOperationAddress> appOperationAddress_ = nullptr;
    std::shared_ptr<vector<AppServiceAggregate>> appServiceList_ = nullptr;
