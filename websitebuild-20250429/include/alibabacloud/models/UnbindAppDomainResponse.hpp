...
namespace Models
{
  ...
  public:
    ...
    inline const UnbindAppDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnbindAppDomainResponseBody) };
    inline UnbindAppDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, UnbindAppDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnbindAppDomainResponseBody> body_ {};
  };
