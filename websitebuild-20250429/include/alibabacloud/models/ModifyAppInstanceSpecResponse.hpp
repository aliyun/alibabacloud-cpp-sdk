...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAppInstanceSpecResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyAppInstanceSpecResponseBody) };
    inline ModifyAppInstanceSpecResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyAppInstanceSpecResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyAppInstanceSpecResponseBody> body_ {};
  };
