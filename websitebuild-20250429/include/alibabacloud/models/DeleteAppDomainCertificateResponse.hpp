...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAppDomainCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAppDomainCertificateResponseBody) };
    inline DeleteAppDomainCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAppDomainCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAppDomainCertificateResponseBody> body_ {};
  };
