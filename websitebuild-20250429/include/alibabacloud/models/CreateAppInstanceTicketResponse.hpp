...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAppInstanceTicketResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAppInstanceTicketResponseBody) };
    inline CreateAppInstanceTicketResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAppInstanceTicketResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAppInstanceTicketResponseBody> body_ {};
  };
