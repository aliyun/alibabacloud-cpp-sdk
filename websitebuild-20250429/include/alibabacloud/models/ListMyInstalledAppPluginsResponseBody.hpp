...
#ifndef ALIBABACLOUD_MODELS_LISTMYINSTALLEDAPPPLUGINSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTMYINSTALLEDAPPPLUGINSRESPONSEBODY_HPP_
...
namespace Models
{
  class ListMyInstalledAppPluginsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListMyInstalledAppPluginsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListMyInstalledAppPluginsResponseBody& obj) { 
    ...
    ListMyInstalledAppPluginsResponseBody() = default ;
    ListMyInstalledAppPluginsResponseBody(const ListMyInstalledAppPluginsResponseBody &) = default ;
    ListMyInstalledAppPluginsResponseBody(ListMyInstalledAppPluginsResponseBody &&) = default ;
    ListMyInstalledAppPluginsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListMyInstalledAppPluginsResponseBody() = default ;
    ListMyInstalledAppPluginsResponseBody& operator=(const ListMyInstalledAppPluginsResponseBody &) = default ;
    ListMyInstalledAppPluginsResponseBody& operator=(ListMyInstalledAppPluginsResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->description_ == nullptr && this->gmtCreate_ == nullptr && this->gmtModified_ == nullptr && this->icon_ == nullptr && this->pluginId_ == nullptr
        && this->pluginName_ == nullptr && this->status_ == nullptr && this->version_ == nullptr && this->visibility_ == nullptr; };
        // category Field Functions 
        bool hasCategory() const { return this->category_ != nullptr;};
        void deleteCategory() { this->category_ = nullptr;};
        inline string getCategory() const { DARABONBA_PTR_GET_DEFAULT(category_, "") };
        inline Next& setCategory(string category) { DARABONBA_PTR_SET_VALUE(category_, category) };
        ...
        inline Next& setIcon(string icon) { DARABONBA_PTR_SET_VALUE(icon_, icon) };
        ...
        inline Next& setPluginId(string pluginId) { DARABONBA_PTR_SET_VALUE(pluginId_, pluginId) };
        ...
        inline Next& setPluginName(string pluginName) { DARABONBA_PTR_SET_VALUE(pluginName_, pluginName) };
        ...
        inline Next& setVisibility(string visibility) { DARABONBA_PTR_SET_VALUE(visibility_, visibility) };
      ...
      protected:
        ...
        // Filters by visibility level. Multiple values can be specified.
      ...
      public:
        ...
        inline Data& setHotCount(int32_t hotCount) { DARABONBA_PTR_SET_VALUE(hotCount_, hotCount) };
        ...
        void deleteVisibility() { this->visibility_ = nullptr;};
        inline string getVisibility() const { DARABONBA_PTR_GET_DEFAULT(visibility_, "") };
        inline Data& setVisibility(string visibility) { DARABONBA_PTR_SET_VALUE(visibility_, visibility) };
    ...
    protected:
      ...
      // Apart from pagination limits, the server processes a maximum of 1000 recent records for the current query. If the results exceed 1000 entries, **ResultLimit** is **true**. Narrow the time range and search again. Otherwise, **ResultLimit** is **false**.
    ...
    inline ListMyInstalledAppPluginsResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ListMyInstalledAppPluginsResponseBody& setAllowRetry(bool allowRetry) { DARABONBA_PTR_SET_VALUE(allowRetry_, allowRetry) };
    ...
    inline ListMyInstalledAppPluginsResponseBody& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline ListMyInstalledAppPluginsResponseBody& setDynamicCode(string dynamicCode) { DARABONBA_PTR_SET_VALUE(dynamicCode_, dynamicCode) };
    ...
    inline ListMyInstalledAppPluginsResponseBody& setDynamicMessage(string dynamicMessage) { DARABONBA_PTR_SET_VALUE(dynamicMessage_, dynamicMessage) };
    ...
    inline ListMyInstalledAppPluginsResponseBody& setErrorArgs(const vector<Darabonba::Json> & errorArgs) { DARABONBA_PTR_SET_VALUE(errorArgs_, errorArgs) };
    inline ListMyInstalledAppPluginsResponseBody& setErrorArgs(vector<Darabonba::Json> && errorArgs) { DARABONBA_PTR_SET_RVALUE(errorArgs_, errorArgs) };


    // module Field Functions 
    bool hasModule() const { return this->module_ != nullptr;};
    void deleteModule() { this->module_ = nullptr;};
    inline const ListMyInstalledAppPluginsResponseBody::Module & getModule() const { DARABONBA_PTR_GET_CONST(module_, ListMyInstalledAppPluginsResponseBody::Module) };
    inline ListMyInstalledAppPluginsResponseBody::Module getModule() { DARABONBA_PTR_GET(module_, ListMyInstalledAppPluginsResponseBody::Module) };
    inline ListMyInstalledAppPluginsResponseBody& setModule(const ListMyInstalledAppPluginsResponseBody::Module & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline ListMyInstalledAppPluginsResponseBody& setModule(ListMyInstalledAppPluginsResponseBody::Module && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
    ...
    inline ListMyInstalledAppPluginsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListMyInstalledAppPluginsResponseBody& setRootErrorCode(string rootErrorCode) { DARABONBA_PTR_SET_VALUE(rootErrorCode_, rootErrorCode) };
    ...
    inline ListMyInstalledAppPluginsResponseBody& setRootErrorMsg(string rootErrorMsg) { DARABONBA_PTR_SET_VALUE(rootErrorMsg_, rootErrorMsg) };
    ...
    inline ListMyInstalledAppPluginsResponseBody& setSynchro(bool synchro) { DARABONBA_PTR_SET_VALUE(synchro_, synchro) };
  ...
  protected:
    ...
    // The response data.
    shared_ptr<ListMyInstalledAppPluginsResponseBody::Module> module_ {};
    // Id of the request
