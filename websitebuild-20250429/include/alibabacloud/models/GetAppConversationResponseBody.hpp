...
#ifndef ALIBABACLOUD_MODELS_GETAPPCONVERSATIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETAPPCONVERSATIONRESPONSEBODY_HPP_
...
namespace Models
{
  class GetAppConversationResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetAppConversationResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAppConversationResponseBody& obj) { 
    ...
    GetAppConversationResponseBody() = default ;
    GetAppConversationResponseBody(const GetAppConversationResponseBody &) = default ;
    GetAppConversationResponseBody(GetAppConversationResponseBody &&) = default ;
    GetAppConversationResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAppConversationResponseBody() = default ;
    GetAppConversationResponseBody& operator=(const GetAppConversationResponseBody &) = default ;
    GetAppConversationResponseBody& operator=(GetAppConversationResponseBody &&) = default ;
    ...
    inline GetAppConversationResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline GetAppConversationResponseBody& setAllowRetry(bool allowRetry) { DARABONBA_PTR_SET_VALUE(allowRetry_, allowRetry) };
    ...
    inline GetAppConversationResponseBody& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline GetAppConversationResponseBody& setDynamicCode(string dynamicCode) { DARABONBA_PTR_SET_VALUE(dynamicCode_, dynamicCode) };
    ...
    inline GetAppConversationResponseBody& setDynamicMessage(string dynamicMessage) { DARABONBA_PTR_SET_VALUE(dynamicMessage_, dynamicMessage) };
    ...
    inline GetAppConversationResponseBody& setErrorArgs(const vector<Darabonba::Json> & errorArgs) { DARABONBA_PTR_SET_VALUE(errorArgs_, errorArgs) };
    inline GetAppConversationResponseBody& setErrorArgs(vector<Darabonba::Json> && errorArgs) { DARABONBA_PTR_SET_RVALUE(errorArgs_, errorArgs) };


    // module Field Functions 
    bool hasModule() const { return this->module_ != nullptr;};
    void deleteModule() { this->module_ = nullptr;};
    inline const GetAppConversationResponseBody::Module & getModule() const { DARABONBA_PTR_GET_CONST(module_, GetAppConversationResponseBody::Module) };
    inline GetAppConversationResponseBody::Module getModule() { DARABONBA_PTR_GET(module_, GetAppConversationResponseBody::Module) };
    inline GetAppConversationResponseBody& setModule(const GetAppConversationResponseBody::Module & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline GetAppConversationResponseBody& setModule(GetAppConversationResponseBody::Module && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
    ...
    inline GetAppConversationResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetAppConversationResponseBody& setRootErrorCode(string rootErrorCode) { DARABONBA_PTR_SET_VALUE(rootErrorCode_, rootErrorCode) };
    ...
    inline GetAppConversationResponseBody& setRootErrorMsg(string rootErrorMsg) { DARABONBA_PTR_SET_VALUE(rootErrorMsg_, rootErrorMsg) };
    ...
    inline GetAppConversationResponseBody& setSynchro(bool synchro) { DARABONBA_PTR_SET_VALUE(synchro_, synchro) };
