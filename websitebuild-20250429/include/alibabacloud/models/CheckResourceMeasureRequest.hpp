...
#ifndef ALIBABACLOUD_MODELS_CHECKRESOURCEMEASUREREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CHECKRESOURCEMEASUREREQUEST_HPP_
...
namespace Models
{
  class CheckResourceMeasureRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CheckResourceMeasureRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CheckResourceMeasureRequest& obj) { 
    ...
    CheckResourceMeasureRequest() = default ;
    CheckResourceMeasureRequest(const CheckResourceMeasureRequest &) = default ;
    CheckResourceMeasureRequest(CheckResourceMeasureRequest &&) = default ;
    CheckResourceMeasureRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CheckResourceMeasureRequest() = default ;
    CheckResourceMeasureRequest& operator=(const CheckResourceMeasureRequest &) = default ;
    CheckResourceMeasureRequest& operator=(CheckResourceMeasureRequest &&) = default ;
    ...
    inline CheckResourceMeasureRequest& setBelongId(string belongId) { DARABONBA_PTR_SET_VALUE(belongId_, belongId) };
    ...
    inline CheckResourceMeasureRequest& setBelongIdType(string belongIdType) { DARABONBA_PTR_SET_VALUE(belongIdType_, belongIdType) };
    ...
    inline CheckResourceMeasureRequest& setBizType(string bizType) { DARABONBA_PTR_SET_VALUE(bizType_, bizType) };
    ...
    inline CheckResourceMeasureRequest& setEspBizId(string espBizId) { DARABONBA_PTR_SET_VALUE(espBizId_, espBizId) };
    ...
    inline CheckResourceMeasureRequest& setOrderComponentParams(string orderComponentParams) { DARABONBA_PTR_SET_VALUE(orderComponentParams_, orderComponentParams) };
    ...
    inline CheckResourceMeasureRequest& setResourceCode(string resourceCode) { DARABONBA_PTR_SET_VALUE(resourceCode_, resourceCode) };
    ...
    inline CheckResourceMeasureRequest& setResourceValue(int64_t resourceValue) { DARABONBA_PTR_SET_VALUE(resourceValue_, resourceValue) };
