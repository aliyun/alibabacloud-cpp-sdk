...
namespace Models
{
  ...
  public:
    ...
    inline const AppOperationAddress & getOperationAddress() const { DARABONBA_PTR_GET_CONST(operationAddress_, AppOperationAddress) };
    inline AppOperationAddress getOperationAddress() { DARABONBA_PTR_GET(operationAddress_, AppOperationAddress) };
