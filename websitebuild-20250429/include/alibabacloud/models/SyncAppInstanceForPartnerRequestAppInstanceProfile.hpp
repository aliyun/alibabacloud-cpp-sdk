...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->deployArea_ == nullptr
        && return this->lxInstanceId_ == nullptr && return this->orderId_ == nullptr && return this->siteVersion_ == nullptr && return this->templateEtag_ == nullptr && return this->templateId_ == nullptr; };
