...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserTmpIdentityForPartnerResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetUserTmpIdentityForPartnerResponseBodyData) };
    inline GetUserTmpIdentityForPartnerResponseBodyData data() { DARABONBA_PTR_GET(data_, GetUserTmpIdentityForPartnerResponseBodyData) };
    inline GetUserTmpIdentityForPartnerResponseBody& setData(const GetUserTmpIdentityForPartnerResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetUserTmpIdentityForPartnerResponseBody& setData(GetUserTmpIdentityForPartnerResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<GetUserTmpIdentityForPartnerResponseBodyData> data_ = nullptr;
