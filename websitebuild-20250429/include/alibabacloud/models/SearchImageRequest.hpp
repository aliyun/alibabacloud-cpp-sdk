...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->colorHex_ == nullptr
        ...
        && this->size_ == nullptr && this->start_ == nullptr && this->tags_ == nullptr && this->text_ == nullptr; };
    // colorHex Field Functions 
    bool hasColorHex() const { return this->colorHex_ != nullptr;};
    void deleteColorHex() { this->colorHex_ = nullptr;};
    inline string getColorHex() const { DARABONBA_PTR_GET_DEFAULT(colorHex_, "") };
    ...
    inline bool getHasPerson() const { DARABONBA_PTR_GET_DEFAULT(hasPerson_, false) };
    ...
    inline int32_t getMaxHeight() const { DARABONBA_PTR_GET_DEFAULT(maxHeight_, 0) };
    ...
    inline int32_t getMinHeight() const { DARABONBA_PTR_GET_DEFAULT(minHeight_, 0) };
