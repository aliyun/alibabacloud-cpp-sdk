...
namespace Models
{
  ...
  public:
    ...
    inline const RefreshAppInstanceTicketResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RefreshAppInstanceTicketResponseBody) };
    inline RefreshAppInstanceTicketResponseBody getBody() { DARABONBA_PTR_GET(body_, RefreshAppInstanceTicketResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RefreshAppInstanceTicketResponseBody> body_ {};
  };
