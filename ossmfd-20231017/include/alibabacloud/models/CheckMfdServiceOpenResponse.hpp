...
namespace Models
{
  ...
  public:
    ...
    inline const CheckMfdServiceOpenResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CheckMfdServiceOpenResponseBody) };
    inline CheckMfdServiceOpenResponseBody body() { DARABONBA_PTR_GET(body_, CheckMfdServiceOpenResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CheckMfdServiceOpenResponseBody> body_ = nullptr;
  };
