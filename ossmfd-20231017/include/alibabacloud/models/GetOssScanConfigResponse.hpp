...
namespace Models
{
  ...
  public:
    ...
    inline const GetOssScanConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOssScanConfigResponseBody) };
    inline GetOssScanConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOssScanConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOssScanConfigResponseBody> body_ {};
  };
