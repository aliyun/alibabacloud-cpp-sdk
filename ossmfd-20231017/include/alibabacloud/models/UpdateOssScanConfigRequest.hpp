...
namespace Models
{
  ...
  public:
    ...
    inline UpdateOssScanConfigRequest& setAllKeyPrefix(string allKeyPrefix) { DARABONBA_PTR_SET_VALUE(allKeyPrefix_, allKeyPrefix) };
    ...
    inline UpdateOssScanConfigRequest& setBucketName(string bucketName) { DARABONBA_PTR_SET_VALUE(bucketName_, bucketName) };
