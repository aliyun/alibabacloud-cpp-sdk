...
namespace Models
{
  ...
  public:
    ...
    inline const ExportRecordResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ExportRecordResponseBody) };
    inline ExportRecordResponseBody body() { DARABONBA_PTR_GET(body_, ExportRecordResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ExportRecordResponseBody> body_ = nullptr;
  };
