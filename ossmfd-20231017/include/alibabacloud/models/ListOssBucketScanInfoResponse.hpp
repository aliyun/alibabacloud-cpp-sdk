...
namespace Models
{
  ...
  public:
    ...
    inline const ListOssBucketScanInfoResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListOssBucketScanInfoResponseBody) };
    inline ListOssBucketScanInfoResponseBody body() { DARABONBA_PTR_GET(body_, ListOssBucketScanInfoResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListOssBucketScanInfoResponseBody> body_ = nullptr;
  };
