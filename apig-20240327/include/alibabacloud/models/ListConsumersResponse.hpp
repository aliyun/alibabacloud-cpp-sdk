...
namespace Models
{
  ...
  public:
    ...
    inline const ListConsumersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListConsumersResponseBody) };
    inline ListConsumersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListConsumersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListConsumersResponseBody> body_ {};
  };
