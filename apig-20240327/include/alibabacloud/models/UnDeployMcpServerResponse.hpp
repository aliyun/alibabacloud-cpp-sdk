...
namespace Models
{
  ...
  public:
    ...
    inline const UnDeployMcpServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnDeployMcpServerResponseBody) };
    inline UnDeployMcpServerResponseBody getBody() { DARABONBA_PTR_GET(body_, UnDeployMcpServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnDeployMcpServerResponseBody> body_ {};
  };
