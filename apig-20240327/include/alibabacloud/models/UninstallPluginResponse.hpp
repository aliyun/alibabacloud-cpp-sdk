...
namespace Models
{
  ...
  public:
    ...
    inline const UninstallPluginResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UninstallPluginResponseBody) };
    inline UninstallPluginResponseBody body() { DARABONBA_PTR_GET(body_, UninstallPluginResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UninstallPluginResponseBody> body_ = nullptr;
  };
