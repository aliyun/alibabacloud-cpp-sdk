...
#ifndef ALIBABACLOUD_MODELS_GETAIMODELPROVIDERRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETAIMODELPROVIDERRESPONSEBODY_HPP_
...
namespace Models
{
  class GetAiModelProviderResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetAiModelProviderResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(code, code_);
      DARABONBA_PTR_TO_JSON(data, data_);
      DARABONBA_PTR_TO_JSON(message, message_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetAiModelProviderResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(code, code_);
      DARABONBA_PTR_FROM_JSON(data, data_);
      DARABONBA_PTR_FROM_JSON(message, message_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    GetAiModelProviderResponseBody() = default ;
    GetAiModelProviderResponseBody(const GetAiModelProviderResponseBody &) = default ;
    GetAiModelProviderResponseBody(GetAiModelProviderResponseBody &&) = default ;
    GetAiModelProviderResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAiModelProviderResponseBody() = default ;
    GetAiModelProviderResponseBody& operator=(const GetAiModelProviderResponseBody &) = default ;
    GetAiModelProviderResponseBody& operator=(GetAiModelProviderResponseBody &&) = default ;
    ...
    inline GetAiModelProviderResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetAiModelProviderResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetAiModelProviderResponseBody::Data) };
    inline GetAiModelProviderResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetAiModelProviderResponseBody::Data) };
    inline GetAiModelProviderResponseBody& setData(const GetAiModelProviderResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAiModelProviderResponseBody& setData(GetAiModelProviderResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetAiModelProviderResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetAiModelProviderResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<GetAiModelProviderResponseBody::Data> data_ {};
