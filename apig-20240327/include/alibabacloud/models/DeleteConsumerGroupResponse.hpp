...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteConsumerGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteConsumerGroupResponseBody) };
    inline DeleteConsumerGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteConsumerGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteConsumerGroupResponseBody> body_ {};
  };
