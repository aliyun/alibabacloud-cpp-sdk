...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateConsumerResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateConsumerResponseBody) };
    inline UpdateConsumerResponseBody body() { DARABONBA_PTR_GET(body_, UpdateConsumerResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateConsumerResponseBody> body_ = nullptr;
  };
