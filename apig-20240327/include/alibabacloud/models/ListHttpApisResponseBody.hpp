...
namespace Models
{
  ...
  public:
    ...
    inline const ListHttpApisResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListHttpApisResponseBodyData) };
    inline ListHttpApisResponseBodyData data() { DARABONBA_PTR_GET(data_, ListHttpApisResponseBodyData) };
    inline ListHttpApisResponseBody& setData(const ListHttpApisResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListHttpApisResponseBody& setData(ListHttpApisResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The APIs.
    std::shared_ptr<ListHttpApisResponseBodyData> data_ = nullptr;
