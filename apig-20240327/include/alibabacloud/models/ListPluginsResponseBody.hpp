...
namespace Models
{
  ...
  public:
    ...
    inline const ListPluginsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListPluginsResponseBodyData) };
    inline ListPluginsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListPluginsResponseBodyData) };
    inline ListPluginsResponseBody& setData(const ListPluginsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListPluginsResponseBody& setData(ListPluginsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListPluginsResponseBodyData> data_ = nullptr;
    // The status message.
