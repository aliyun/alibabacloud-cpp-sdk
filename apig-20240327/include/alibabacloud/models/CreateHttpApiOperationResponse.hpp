...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHttpApiOperationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateHttpApiOperationResponseBody) };
    inline CreateHttpApiOperationResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateHttpApiOperationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateHttpApiOperationResponseBody> body_ {};
  };
