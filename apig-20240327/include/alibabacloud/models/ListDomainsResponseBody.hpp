...
namespace Models
{
  ...
  public:
    ...
    inline const ListDomainsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListDomainsResponseBodyData) };
    inline ListDomainsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListDomainsResponseBodyData) };
    inline ListDomainsResponseBody& setData(const ListDomainsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDomainsResponseBody& setData(ListDomainsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The response data.
    std::shared_ptr<ListDomainsResponseBodyData> data_ = nullptr;
