...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHttpApiRouteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateHttpApiRouteResponseBody) };
    inline CreateHttpApiRouteResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateHttpApiRouteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateHttpApiRouteResponseBody> body_ {};
  };
