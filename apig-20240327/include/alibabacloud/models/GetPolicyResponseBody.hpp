...
namespace Models
{
  ...
  public:
    ...
    inline GetPolicyResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const PolicyDetailInfo & data() const { DARABONBA_PTR_GET_CONST(data_, PolicyDetailInfo) };
    inline PolicyDetailInfo data() { DARABONBA_PTR_GET(data_, PolicyDetailInfo) };
    inline GetPolicyResponseBody& setData(const PolicyDetailInfo & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPolicyResponseBody& setData(PolicyDetailInfo && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetPolicyResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<PolicyDetailInfo> data_ = nullptr;
