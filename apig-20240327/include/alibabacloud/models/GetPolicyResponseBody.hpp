...
namespace Models
{
  ...
  public:
    ...
    inline const PolicyDetailInfo & getData() const { DARABONBA_PTR_GET_CONST(data_, PolicyDetailInfo) };
    inline PolicyDetailInfo getData() { DARABONBA_PTR_GET(data_, PolicyDetailInfo) };
  ...
  protected:
    ...
    // The data returned.
    shared_ptr<PolicyDetailInfo> data_ {};
