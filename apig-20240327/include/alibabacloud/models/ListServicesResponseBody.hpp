...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const vector<Service> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<Service>) };
      inline vector<Service> getItems() { DARABONBA_PTR_GET(items_, vector<Service>) };
      inline Data& setItems(const vector<Service> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
      inline Data& setItems(vector<Service> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
    ...
    inline const ListServicesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListServicesResponseBody::Data) };
    inline ListServicesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListServicesResponseBody::Data) };
    inline ListServicesResponseBody& setData(const ListServicesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListServicesResponseBody& setData(ListServicesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
