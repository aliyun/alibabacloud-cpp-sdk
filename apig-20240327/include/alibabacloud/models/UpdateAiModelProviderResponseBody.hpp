...
#ifndef ALIBABACLOUD_MODELS_UPDATEAIMODELPROVIDERRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATEAIMODELPROVIDERRESPONSEBODY_HPP_
...
namespace Models
{
  class UpdateAiModelProviderResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateAiModelProviderResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(code, code_);
      DARABONBA_PTR_TO_JSON(data, data_);
      DARABONBA_PTR_TO_JSON(message, message_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateAiModelProviderResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(code, code_);
      DARABONBA_PTR_FROM_JSON(data, data_);
      DARABONBA_PTR_FROM_JSON(message, message_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    UpdateAiModelProviderResponseBody() = default ;
    UpdateAiModelProviderResponseBody(const UpdateAiModelProviderResponseBody &) = default ;
    UpdateAiModelProviderResponseBody(UpdateAiModelProviderResponseBody &&) = default ;
    UpdateAiModelProviderResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateAiModelProviderResponseBody() = default ;
    UpdateAiModelProviderResponseBody& operator=(const UpdateAiModelProviderResponseBody &) = default ;
    UpdateAiModelProviderResponseBody& operator=(UpdateAiModelProviderResponseBody &&) = default ;
    ...
    inline UpdateAiModelProviderResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const UpdateAiModelProviderResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateAiModelProviderResponseBody::Data) };
    inline UpdateAiModelProviderResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateAiModelProviderResponseBody::Data) };
    inline UpdateAiModelProviderResponseBody& setData(const UpdateAiModelProviderResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateAiModelProviderResponseBody& setData(UpdateAiModelProviderResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UpdateAiModelProviderResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UpdateAiModelProviderResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<UpdateAiModelProviderResponseBody::Data> data_ {};
