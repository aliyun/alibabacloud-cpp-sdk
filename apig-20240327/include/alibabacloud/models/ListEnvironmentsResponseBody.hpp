...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const vector<EnvironmentInfo> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<EnvironmentInfo>) };
      inline vector<EnvironmentInfo> getItems() { DARABONBA_PTR_GET(items_, vector<EnvironmentInfo>) };
      inline Data& setItems(const vector<EnvironmentInfo> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
      inline Data& setItems(vector<EnvironmentInfo> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
