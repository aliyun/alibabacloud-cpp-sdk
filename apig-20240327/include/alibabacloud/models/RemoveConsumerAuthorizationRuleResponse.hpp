...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveConsumerAuthorizationRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveConsumerAuthorizationRuleResponseBody) };
    inline RemoveConsumerAuthorizationRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveConsumerAuthorizationRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveConsumerAuthorizationRuleResponseBody> body_ {};
  };
