...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteServiceVersionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteServiceVersionResponseBody) };
    inline DeleteServiceVersionResponseBody body() { DARABONBA_PTR_GET(body_, DeleteServiceVersionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteServiceVersionResponseBody> body_ = nullptr;
  };
