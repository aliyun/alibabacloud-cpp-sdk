...
namespace Models
{
  ...
  public:
    ...
    inline const CreateConsumerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateConsumerResponseBody) };
    inline CreateConsumerResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateConsumerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateConsumerResponseBody> body_ {};
  };
