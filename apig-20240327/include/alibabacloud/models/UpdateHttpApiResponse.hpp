...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateHttpApiResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateHttpApiResponseBody) };
    inline UpdateHttpApiResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateHttpApiResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateHttpApiResponseBody> body_ {};
  };
