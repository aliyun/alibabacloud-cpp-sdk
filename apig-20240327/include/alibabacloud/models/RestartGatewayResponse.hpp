...
namespace Models
{
  ...
  public:
    ...
    inline const RestartGatewayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RestartGatewayResponseBody) };
    inline RestartGatewayResponseBody getBody() { DARABONBA_PTR_GET(body_, RestartGatewayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RestartGatewayResponseBody> body_ {};
  };
