...
namespace Models
{
  ...
  public:
    ...
    inline const GetConsumerAuthorizationRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetConsumerAuthorizationRuleResponseBody) };
    inline GetConsumerAuthorizationRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, GetConsumerAuthorizationRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetConsumerAuthorizationRuleResponseBody> body_ {};
  };
