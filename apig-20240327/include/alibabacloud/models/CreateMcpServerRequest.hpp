...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->assembledSources_ != nullptr
        && this->backendConfig_ != nullptr && this->description_ != nullptr && this->domainIds_ != nullptr && this->exposedUriPath_ != nullptr && this->gatewayId_ != nullptr
        && this->match_ != nullptr && this->mcpStatisticsEnable_ != nullptr && this->name_ != nullptr && this->protocol_ != nullptr && this->type_ != nullptr; };
