...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->authConfig_ == nullptr
        && this->deployConfigs_ == nullptr && this->description_ == nullptr && this->enableAuth_ == nullptr && this->method_ == nullptr && this->mock_ == nullptr
        && this->name_ == nullptr && this->path_ == nullptr && this->request_ == nullptr && this->response_ == nullptr; };
