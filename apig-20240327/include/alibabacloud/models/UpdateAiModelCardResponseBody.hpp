...
#ifndef ALIBABACLOUD_MODELS_UPDATEAIMODELCARDRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATEAIMODELCARDRESPONSEBODY_HPP_
...
namespace Models
{
  class UpdateAiModelCardResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateAiModelCardResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(code, code_);
      DARABONBA_PTR_TO_JSON(data, data_);
      DARABONBA_PTR_TO_JSON(message, message_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateAiModelCardResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(code, code_);
      DARABONBA_PTR_FROM_JSON(data, data_);
      DARABONBA_PTR_FROM_JSON(message, message_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    UpdateAiModelCardResponseBody() = default ;
    UpdateAiModelCardResponseBody(const UpdateAiModelCardResponseBody &) = default ;
    UpdateAiModelCardResponseBody(UpdateAiModelCardResponseBody &&) = default ;
    UpdateAiModelCardResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateAiModelCardResponseBody() = default ;
    UpdateAiModelCardResponseBody& operator=(const UpdateAiModelCardResponseBody &) = default ;
    UpdateAiModelCardResponseBody& operator=(UpdateAiModelCardResponseBody &&) = default ;
    ...
    inline UpdateAiModelCardResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const UpdateAiModelCardResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateAiModelCardResponseBody::Data) };
    inline UpdateAiModelCardResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateAiModelCardResponseBody::Data) };
    inline UpdateAiModelCardResponseBody& setData(const UpdateAiModelCardResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateAiModelCardResponseBody& setData(UpdateAiModelCardResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UpdateAiModelCardResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UpdateAiModelCardResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<UpdateAiModelCardResponseBody::Data> data_ {};
