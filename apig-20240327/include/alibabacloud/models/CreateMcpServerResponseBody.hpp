...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMcpServerResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateMcpServerResponseBodyData) };
    inline CreateMcpServerResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateMcpServerResponseBodyData) };
    inline CreateMcpServerResponseBody& setData(const CreateMcpServerResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateMcpServerResponseBody& setData(CreateMcpServerResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateMcpServerResponseBodyData> data_ = nullptr;
