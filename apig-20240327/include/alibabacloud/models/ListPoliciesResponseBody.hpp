...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const vector<PolicyInfo> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<PolicyInfo>) };
      inline vector<PolicyInfo> getItems() { DARABONBA_PTR_GET(items_, vector<PolicyInfo>) };
      inline Data& setItems(const vector<PolicyInfo> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
      inline Data& setItems(vector<PolicyInfo> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
    ...
    inline const ListPoliciesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListPoliciesResponseBody::Data) };
    inline ListPoliciesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListPoliciesResponseBody::Data) };
    inline ListPoliciesResponseBody& setData(const ListPoliciesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListPoliciesResponseBody& setData(ListPoliciesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
