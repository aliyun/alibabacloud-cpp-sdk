...
namespace Models
{
  ...
  public:
    ...
    inline const GetPluginAttachmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPluginAttachmentResponseBody) };
    inline GetPluginAttachmentResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPluginAttachmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPluginAttachmentResponseBody> body_ {};
  };
