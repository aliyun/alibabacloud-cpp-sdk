...
namespace Models
{
  ...
  public:
    ...
    inline const GetSourceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSourceResponseBodyData) };
    inline GetSourceResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSourceResponseBodyData) };
    inline GetSourceResponseBody& setData(const GetSourceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSourceResponseBody& setData(GetSourceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
