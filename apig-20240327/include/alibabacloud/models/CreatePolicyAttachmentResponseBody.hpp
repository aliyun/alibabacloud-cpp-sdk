...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePolicyAttachmentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreatePolicyAttachmentResponseBodyData) };
    inline CreatePolicyAttachmentResponseBodyData data() { DARABONBA_PTR_GET(data_, CreatePolicyAttachmentResponseBodyData) };
    inline CreatePolicyAttachmentResponseBody& setData(const CreatePolicyAttachmentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreatePolicyAttachmentResponseBody& setData(CreatePolicyAttachmentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // Response data.
    std::shared_ptr<CreatePolicyAttachmentResponseBodyData> data_ = nullptr;
    // Response message.
