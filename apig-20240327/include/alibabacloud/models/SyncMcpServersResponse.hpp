...
namespace Models
{
  ...
  public:
    ...
    inline const SyncMCPServersResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SyncMCPServersResponseBody) };
    inline SyncMCPServersResponseBody body() { DARABONBA_PTR_GET(body_, SyncMCPServersResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SyncMCPServersResponseBody> body_ = nullptr;
  };
