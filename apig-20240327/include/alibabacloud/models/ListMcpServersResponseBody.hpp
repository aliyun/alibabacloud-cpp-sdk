...
namespace Models
{
  ...
  public:
    ...
    inline const ListMcpServersResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListMcpServersResponseBodyData) };
    inline ListMcpServersResponseBodyData data() { DARABONBA_PTR_GET(data_, ListMcpServersResponseBodyData) };
    inline ListMcpServersResponseBody& setData(const ListMcpServersResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListMcpServersResponseBody& setData(ListMcpServersResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
