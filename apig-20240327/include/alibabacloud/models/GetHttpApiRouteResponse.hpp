...
namespace Models
{
  ...
  public:
    ...
    inline const GetHttpApiRouteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHttpApiRouteResponseBody) };
    inline GetHttpApiRouteResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHttpApiRouteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHttpApiRouteResponseBody> body_ {};
  };
