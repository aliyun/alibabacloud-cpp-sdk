...
namespace Models
{
  ...
  public:
    ...
    inline const GetPolicyAttachmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPolicyAttachmentResponseBody) };
    inline GetPolicyAttachmentResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPolicyAttachmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPolicyAttachmentResponseBody> body_ {};
  };
