...
namespace Models
{
  ...
  public:
    ...
    inline const ListZonesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListZonesResponseBodyData) };
    inline ListZonesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListZonesResponseBodyData) };
    inline ListZonesResponseBody& setData(const ListZonesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListZonesResponseBody& setData(ListZonesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // Returned data.
    std::shared_ptr<ListZonesResponseBodyData> data_ = nullptr;
    // Response message.
