...
namespace Models
{
  ...
  public:
    ...
    inline const GetHttpApiOperationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHttpApiOperationResponseBody) };
    inline GetHttpApiOperationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHttpApiOperationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHttpApiOperationResponseBody> body_ {};
  };
