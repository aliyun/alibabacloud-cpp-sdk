...
namespace Models
{
  ...
  public:
    ...
    inline const GetTraceConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTraceConfigResponseBodyData) };
    inline GetTraceConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTraceConfigResponseBodyData) };
    inline GetTraceConfigResponseBody& setData(const GetTraceConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTraceConfigResponseBody& setData(GetTraceConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // Response Data
    std::shared_ptr<GetTraceConfigResponseBodyData> data_ = nullptr;
    // Error Message
