...
namespace Models
{
  ...
  public:
    ...
    inline const DeployMcpServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeployMcpServerResponseBody) };
    inline DeployMcpServerResponseBody getBody() { DARABONBA_PTR_GET(body_, DeployMcpServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeployMcpServerResponseBody> body_ {};
  };
