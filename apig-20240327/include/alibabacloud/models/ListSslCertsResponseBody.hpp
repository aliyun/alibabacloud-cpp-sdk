...
namespace Models
{
  ...
  public:
    ...
    inline const ListSslCertsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListSslCertsResponseBodyData) };
    inline ListSslCertsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListSslCertsResponseBodyData) };
    inline ListSslCertsResponseBody& setData(const ListSslCertsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListSslCertsResponseBody& setData(ListSslCertsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // Returned data
    std::shared_ptr<ListSslCertsResponseBodyData> data_ = nullptr;
    // Response message.
