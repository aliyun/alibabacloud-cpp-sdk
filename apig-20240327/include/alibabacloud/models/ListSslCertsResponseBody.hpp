...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const vector<SslCertMetaInfo> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<SslCertMetaInfo>) };
      inline vector<SslCertMetaInfo> getItems() { DARABONBA_PTR_GET(items_, vector<SslCertMetaInfo>) };
      inline Data& setItems(const vector<SslCertMetaInfo> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
      inline Data& setItems(vector<SslCertMetaInfo> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
    ...
    inline const ListSslCertsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListSslCertsResponseBody::Data) };
    inline ListSslCertsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListSslCertsResponseBody::Data) };
    inline ListSslCertsResponseBody& setData(const ListSslCertsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListSslCertsResponseBody& setData(ListSslCertsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
