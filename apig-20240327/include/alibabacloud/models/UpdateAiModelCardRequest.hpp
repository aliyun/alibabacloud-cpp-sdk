...
#ifndef ALIBABACLOUD_MODELS_UPDATEAIMODELCARDREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEAIMODELCARDREQUEST_HPP_
...
namespace Models
{
  class UpdateAiModelCardRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateAiModelCardRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateAiModelCardRequest& obj) { 
    ...
    UpdateAiModelCardRequest() = default ;
    UpdateAiModelCardRequest(const UpdateAiModelCardRequest &) = default ;
    UpdateAiModelCardRequest(UpdateAiModelCardRequest &&) = default ;
    UpdateAiModelCardRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateAiModelCardRequest() = default ;
    UpdateAiModelCardRequest& operator=(const UpdateAiModelCardRequest &) = default ;
    UpdateAiModelCardRequest& operator=(UpdateAiModelCardRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->availablePaths_ == nullptr
        && this->credit_ == nullptr && this->features_ == nullptr && this->meta_ == nullptr && this->modelName_ == nullptr && this->modelProvider_ == nullptr; };
    ...
    inline const vector<UpdateAiModelCardRequest::AvailablePaths> & getAvailablePaths() const { DARABONBA_PTR_GET_CONST(availablePaths_, vector<UpdateAiModelCardRequest::AvailablePaths>) };
    inline vector<UpdateAiModelCardRequest::AvailablePaths> getAvailablePaths() { DARABONBA_PTR_GET(availablePaths_, vector<UpdateAiModelCardRequest::AvailablePaths>) };
    inline UpdateAiModelCardRequest& setAvailablePaths(const vector<UpdateAiModelCardRequest::AvailablePaths> & availablePaths) { DARABONBA_PTR_SET_VALUE(availablePaths_, availablePaths) };
    inline UpdateAiModelCardRequest& setAvailablePaths(vector<UpdateAiModelCardRequest::AvailablePaths> && availablePaths) { DARABONBA_PTR_SET_RVALUE(availablePaths_, availablePaths) };


    // credit Field Functions 
    bool hasCredit() const { return this->credit_ != nullptr;};
    void deleteCredit() { this->credit_ = nullptr;};
    inline const UpdateAiModelCardRequest::Credit & getCredit() const { DARABONBA_PTR_GET_CONST(credit_, UpdateAiModelCardRequest::Credit) };
    inline UpdateAiModelCardRequest::Credit getCredit() { DARABONBA_PTR_GET(credit_, UpdateAiModelCardRequest::Credit) };
    inline UpdateAiModelCardRequest& setCredit(const UpdateAiModelCardRequest::Credit & credit) { DARABONBA_PTR_SET_VALUE(credit_, credit) };
    inline UpdateAiModelCardRequest& setCredit(UpdateAiModelCardRequest::Credit && credit) { DARABONBA_PTR_SET_RVALUE(credit_, credit) };
    ...
    inline UpdateAiModelCardRequest& setFeatures(const Darabonba::Json & features) { DARABONBA_SET_VALUE(features_, features) };
    inline UpdateAiModelCardRequest& setFeatures(Darabonba::Json && features) { DARABONBA_SET_RVALUE(features_, features) };


    // meta Field Functions 
    bool hasMeta() const { return this->meta_ != nullptr;};
    void deleteMeta() { this->meta_ = nullptr;};
    inline const UpdateAiModelCardRequest::Meta & getMeta() const { DARABONBA_PTR_GET_CONST(meta_, UpdateAiModelCardRequest::Meta) };
    inline UpdateAiModelCardRequest::Meta getMeta() { DARABONBA_PTR_GET(meta_, UpdateAiModelCardRequest::Meta) };
    inline UpdateAiModelCardRequest& setMeta(const UpdateAiModelCardRequest::Meta & meta) { DARABONBA_PTR_SET_VALUE(meta_, meta) };
    inline UpdateAiModelCardRequest& setMeta(UpdateAiModelCardRequest::Meta && meta) { DARABONBA_PTR_SET_RVALUE(meta_, meta) };
    ...
    inline UpdateAiModelCardRequest& setModelName(string modelName) { DARABONBA_PTR_SET_VALUE(modelName_, modelName) };
    ...
    inline UpdateAiModelCardRequest& setModelProvider(string modelProvider) { DARABONBA_PTR_SET_VALUE(modelProvider_, modelProvider) };
