...
namespace Models
{
  ...
  public:
    ...
    inline CreateGatewayResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateGatewayResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateGatewayResponseBodyData) };
    inline CreateGatewayResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateGatewayResponseBodyData) };
    inline CreateGatewayResponseBody& setData(const CreateGatewayResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateGatewayResponseBody& setData(CreateGatewayResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateGatewayResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
  ...
  protected:
    ...
    std::shared_ptr<CreateGatewayResponseBodyData> data_ = nullptr;
    // The status message.
