...
namespace Models
{
  ...
  public:
    ...
    inline const CreateGatewayResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateGatewayResponseBody::Data) };
    inline CreateGatewayResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateGatewayResponseBody::Data) };
    inline CreateGatewayResponseBody& setData(const CreateGatewayResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateGatewayResponseBody& setData(CreateGatewayResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
