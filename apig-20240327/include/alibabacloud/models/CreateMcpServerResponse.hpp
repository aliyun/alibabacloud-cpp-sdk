...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMcpServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMcpServerResponseBody) };
    inline CreateMcpServerResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMcpServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMcpServerResponseBody> body_ {};
  };
