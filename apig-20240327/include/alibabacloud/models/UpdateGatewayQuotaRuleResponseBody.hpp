...
#ifndef ALIBABACLOUD_MODELS_UPDATEGATEWAYQUOTARULERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATEGATEWAYQUOTARULERESPONSEBODY_HPP_
...
namespace Models
{
  class UpdateGatewayQuotaRuleResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateGatewayQuotaRuleResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(code, code_);
      DARABONBA_PTR_TO_JSON(data, data_);
      DARABONBA_PTR_TO_JSON(message, message_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateGatewayQuotaRuleResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(code, code_);
      DARABONBA_PTR_FROM_JSON(data, data_);
      DARABONBA_PTR_FROM_JSON(message, message_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    UpdateGatewayQuotaRuleResponseBody() = default ;
    UpdateGatewayQuotaRuleResponseBody(const UpdateGatewayQuotaRuleResponseBody &) = default ;
    UpdateGatewayQuotaRuleResponseBody(UpdateGatewayQuotaRuleResponseBody &&) = default ;
    UpdateGatewayQuotaRuleResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateGatewayQuotaRuleResponseBody() = default ;
    UpdateGatewayQuotaRuleResponseBody& operator=(const UpdateGatewayQuotaRuleResponseBody &) = default ;
    UpdateGatewayQuotaRuleResponseBody& operator=(UpdateGatewayQuotaRuleResponseBody &&) = default ;
    ...
    inline UpdateGatewayQuotaRuleResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const UpdateGatewayQuotaRuleResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateGatewayQuotaRuleResponseBody::Data) };
    inline UpdateGatewayQuotaRuleResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateGatewayQuotaRuleResponseBody::Data) };
    inline UpdateGatewayQuotaRuleResponseBody& setData(const UpdateGatewayQuotaRuleResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateGatewayQuotaRuleResponseBody& setData(UpdateGatewayQuotaRuleResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UpdateGatewayQuotaRuleResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UpdateGatewayQuotaRuleResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<UpdateGatewayQuotaRuleResponseBody::Data> data_ {};
