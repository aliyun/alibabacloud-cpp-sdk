...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceOverviewResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetResourceOverviewResponseBodyData) };
    inline GetResourceOverviewResponseBodyData data() { DARABONBA_PTR_GET(data_, GetResourceOverviewResponseBodyData) };
    inline GetResourceOverviewResponseBody& setData(const GetResourceOverviewResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetResourceOverviewResponseBody& setData(GetResourceOverviewResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetResourceOverviewResponseBodyData> data_ = nullptr;
    // Response message.
