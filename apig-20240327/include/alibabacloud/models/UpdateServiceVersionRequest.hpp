...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateServiceVersionRequest::Labels> & getLabels() const { DARABONBA_PTR_GET_CONST(labels_, vector<UpdateServiceVersionRequest::Labels>) };
    inline vector<UpdateServiceVersionRequest::Labels> getLabels() { DARABONBA_PTR_GET(labels_, vector<UpdateServiceVersionRequest::Labels>) };
    inline UpdateServiceVersionRequest& setLabels(const vector<UpdateServiceVersionRequest::Labels> & labels) { DARABONBA_PTR_SET_VALUE(labels_, labels) };
    inline UpdateServiceVersionRequest& setLabels(vector<UpdateServiceVersionRequest::Labels> && labels) { DARABONBA_PTR_SET_RVALUE(labels_, labels) };
