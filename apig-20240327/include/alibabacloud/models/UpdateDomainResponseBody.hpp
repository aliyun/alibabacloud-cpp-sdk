...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDomainResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateDomainResponseBodyData) };
    inline UpdateDomainResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateDomainResponseBodyData) };
    inline UpdateDomainResponseBody& setData(const UpdateDomainResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateDomainResponseBody& setData(UpdateDomainResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateDomainResponseBodyData> data_ = nullptr;
