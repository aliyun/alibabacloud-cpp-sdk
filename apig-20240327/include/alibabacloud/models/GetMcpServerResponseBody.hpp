...
namespace Models
{
  ...
  public:
    ...
    inline const GetMcpServerResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMcpServerResponseBodyData) };
    inline GetMcpServerResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMcpServerResponseBodyData) };
    inline GetMcpServerResponseBody& setData(const GetMcpServerResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMcpServerResponseBody& setData(GetMcpServerResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetMcpServerResponseBodyData> data_ = nullptr;
    // The status message.
