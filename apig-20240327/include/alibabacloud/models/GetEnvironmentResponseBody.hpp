...
namespace Models
{
  ...
  public:
    ...
    inline const GetEnvironmentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetEnvironmentResponseBodyData) };
    inline GetEnvironmentResponseBodyData data() { DARABONBA_PTR_GET(data_, GetEnvironmentResponseBodyData) };
    inline GetEnvironmentResponseBody& setData(const GetEnvironmentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetEnvironmentResponseBody& setData(GetEnvironmentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // Response data.
    std::shared_ptr<GetEnvironmentResponseBodyData> data_ = nullptr;
    // Response message.
