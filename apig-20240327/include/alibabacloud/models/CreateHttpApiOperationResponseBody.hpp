...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHttpApiOperationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateHttpApiOperationResponseBodyData) };
    inline CreateHttpApiOperationResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateHttpApiOperationResponseBodyData) };
    inline CreateHttpApiOperationResponseBody& setData(const CreateHttpApiOperationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateHttpApiOperationResponseBody& setData(CreateHttpApiOperationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateHttpApiOperationResponseBodyData> data_ = nullptr;
    // Response message.
