...
namespace Models
{
  ...
  public:
    ...
    inline const ListSslCertsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSslCertsResponseBody) };
    inline ListSslCertsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSslCertsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSslCertsResponseBody> body_ {};
  };
