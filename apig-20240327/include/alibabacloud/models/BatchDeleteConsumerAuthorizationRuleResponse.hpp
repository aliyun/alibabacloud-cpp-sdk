...
namespace Models
{
  ...
  public:
    ...
    inline const BatchDeleteConsumerAuthorizationRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchDeleteConsumerAuthorizationRuleResponseBody) };
    inline BatchDeleteConsumerAuthorizationRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchDeleteConsumerAuthorizationRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchDeleteConsumerAuthorizationRuleResponseBody> body_ {};
  };
