...
namespace Models
{
  ...
  public:
    ...
    inline GetServiceResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const Service & data() const { DARABONBA_PTR_GET_CONST(data_, Service) };
    inline Service data() { DARABONBA_PTR_GET(data_, Service) };
    inline GetServiceResponseBody& setData(const Service & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetServiceResponseBody& setData(Service && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetServiceResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
  ...
  protected:
    ...
    // The service details.
    std::shared_ptr<Service> data_ = nullptr;
