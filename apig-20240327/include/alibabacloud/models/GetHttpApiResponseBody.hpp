...
namespace Models
{
  ...
  public:
    ...
    inline const HttpApiApiInfo & data() const { DARABONBA_PTR_GET_CONST(data_, HttpApiApiInfo) };
    inline HttpApiApiInfo data() { DARABONBA_PTR_GET(data_, HttpApiApiInfo) };
  ...
  protected:
    ...
    // API information.
    std::shared_ptr<HttpApiApiInfo> data_ = nullptr;
    // Response message.
