...
namespace Models
{
  ...
  public:
    ...
    inline const ListConsumersResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListConsumersResponseBodyData) };
    inline ListConsumersResponseBodyData data() { DARABONBA_PTR_GET(data_, ListConsumersResponseBodyData) };
    inline ListConsumersResponseBody& setData(const ListConsumersResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListConsumersResponseBody& setData(ListConsumersResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListConsumersResponseBodyData> data_ = nullptr;
