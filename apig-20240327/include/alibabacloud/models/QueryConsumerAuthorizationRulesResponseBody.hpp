...
namespace Models
{
  ...
  public:
    ...
    inline const QueryConsumerAuthorizationRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryConsumerAuthorizationRulesResponseBodyData) };
    inline QueryConsumerAuthorizationRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryConsumerAuthorizationRulesResponseBodyData) };
    inline QueryConsumerAuthorizationRulesResponseBody& setData(const QueryConsumerAuthorizationRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryConsumerAuthorizationRulesResponseBody& setData(QueryConsumerAuthorizationRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryConsumerAuthorizationRulesResponseBodyData> data_ = nullptr;
