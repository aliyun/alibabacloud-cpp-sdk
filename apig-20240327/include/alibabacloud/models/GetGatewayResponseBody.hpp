...
namespace Models
{
  ...
  public:
    ...
    inline const GetGatewayResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetGatewayResponseBodyData) };
    inline GetGatewayResponseBodyData data() { DARABONBA_PTR_GET(data_, GetGatewayResponseBodyData) };
    inline GetGatewayResponseBody& setData(const GetGatewayResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetGatewayResponseBody& setData(GetGatewayResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetGatewayResponseBodyData> data_ = nullptr;
