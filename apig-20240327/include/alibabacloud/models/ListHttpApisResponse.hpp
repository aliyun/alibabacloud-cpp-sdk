...
namespace Models
{
  ...
  public:
    ...
    inline const ListHttpApisResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHttpApisResponseBody) };
    inline ListHttpApisResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHttpApisResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHttpApisResponseBody> body_ {};
  };
