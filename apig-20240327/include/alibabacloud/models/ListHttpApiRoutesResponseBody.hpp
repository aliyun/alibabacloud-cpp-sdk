...
namespace Models
{
  ...
  public:
    ...
    inline const ListHttpApiRoutesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListHttpApiRoutesResponseBodyData) };
    inline ListHttpApiRoutesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListHttpApiRoutesResponseBodyData) };
    inline ListHttpApiRoutesResponseBody& setData(const ListHttpApiRoutesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListHttpApiRoutesResponseBody& setData(ListHttpApiRoutesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListHttpApiRoutesResponseBodyData> data_ = nullptr;
