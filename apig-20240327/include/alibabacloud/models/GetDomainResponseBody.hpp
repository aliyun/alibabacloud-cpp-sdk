...
namespace Models
{
  ...
  public:
    ...
    inline const GetDomainResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDomainResponseBodyData) };
    inline GetDomainResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDomainResponseBodyData) };
    inline GetDomainResponseBody& setData(const GetDomainResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDomainResponseBody& setData(GetDomainResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetDomainResponseBodyData> data_ = nullptr;
