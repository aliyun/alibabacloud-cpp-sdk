...
namespace Models
{
  ...
  public:
    ...
    inline CreateConsumerGroupResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateConsumerGroupResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateConsumerGroupResponseBody::Data) };
    inline CreateConsumerGroupResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateConsumerGroupResponseBody::Data) };
    inline CreateConsumerGroupResponseBody& setData(const CreateConsumerGroupResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateConsumerGroupResponseBody& setData(CreateConsumerGroupResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateConsumerGroupResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
