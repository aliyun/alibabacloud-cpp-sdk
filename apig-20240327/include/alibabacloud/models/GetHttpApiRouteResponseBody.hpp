...
namespace Models
{
  ...
  public:
    ...
    inline const HttpRoute & getData() const { DARABONBA_PTR_GET_CONST(data_, HttpRoute) };
    inline HttpRoute getData() { DARABONBA_PTR_GET(data_, HttpRoute) };
