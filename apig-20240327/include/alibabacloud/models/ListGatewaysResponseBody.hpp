...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewaysResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListGatewaysResponseBodyData) };
    inline ListGatewaysResponseBodyData data() { DARABONBA_PTR_GET(data_, ListGatewaysResponseBodyData) };
    inline ListGatewaysResponseBody& setData(const ListGatewaysResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGatewaysResponseBody& setData(ListGatewaysResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The instances.
    std::shared_ptr<ListGatewaysResponseBodyData> data_ = nullptr;
