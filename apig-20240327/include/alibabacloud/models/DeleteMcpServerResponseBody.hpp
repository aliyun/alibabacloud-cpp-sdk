...
namespace Models
{
  ...
  public:
    ...
    inline DeleteMcpServerResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DeleteMcpServerResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
