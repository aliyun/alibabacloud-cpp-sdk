...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHttpApiResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateHttpApiResponseBody) };
    inline CreateHttpApiResponseBody body() { DARABONBA_PTR_GET(body_, CreateHttpApiResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateHttpApiResponseBody> body_ = nullptr;
  };
