...
namespace Models
{
  ...
  public:
    ...
    inline const ListMcpServersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMcpServersResponseBody) };
    inline ListMcpServersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMcpServersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMcpServersResponseBody> body_ {};
  };
