...
#ifndef ALIBABACLOUD_MODELS_LISTCONSUMERAUTHORIZATIONRULESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTCONSUMERAUTHORIZATIONRULESRESPONSEBODY_HPP_
...
namespace Models
{
  class ListConsumerAuthorizationRulesResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListConsumerAuthorizationRulesResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(code, code_);
      DARABONBA_PTR_TO_JSON(data, data_);
      DARABONBA_PTR_TO_JSON(message, message_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListConsumerAuthorizationRulesResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(code, code_);
      DARABONBA_PTR_FROM_JSON(data, data_);
      DARABONBA_PTR_FROM_JSON(message, message_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    ListConsumerAuthorizationRulesResponseBody() = default ;
    ListConsumerAuthorizationRulesResponseBody(const ListConsumerAuthorizationRulesResponseBody &) = default ;
    ListConsumerAuthorizationRulesResponseBody(ListConsumerAuthorizationRulesResponseBody &&) = default ;
    ListConsumerAuthorizationRulesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListConsumerAuthorizationRulesResponseBody() = default ;
    ListConsumerAuthorizationRulesResponseBody& operator=(const ListConsumerAuthorizationRulesResponseBody &) = default ;
    ListConsumerAuthorizationRulesResponseBody& operator=(ListConsumerAuthorizationRulesResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->consumerAuthorizationRuleId_ == nullptr && this->consumerId_ == nullptr && this->createTimestamp_ == nullptr && this->deployStatus_ == nullptr && this->environmentInfo_ == nullptr
        && this->expireMode_ == nullptr && this->expireStatus_ == nullptr && this->expireTimestamp_ == nullptr && this->gatewayInfo_ == nullptr && this->resourceId_ == nullptr
    ...
    inline ListConsumerAuthorizationRulesResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ListConsumerAuthorizationRulesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListConsumerAuthorizationRulesResponseBody::Data) };
    inline ListConsumerAuthorizationRulesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListConsumerAuthorizationRulesResponseBody::Data) };
    inline ListConsumerAuthorizationRulesResponseBody& setData(const ListConsumerAuthorizationRulesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListConsumerAuthorizationRulesResponseBody& setData(ListConsumerAuthorizationRulesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListConsumerAuthorizationRulesResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListConsumerAuthorizationRulesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
