...
#ifndef ALIBABACLOUD_MODELS_LISTCONSUMERGROUPQUOTARULESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTCONSUMERGROUPQUOTARULESRESPONSEBODY_HPP_
...
namespace Models
{
  class ListConsumerGroupQuotaRulesResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListConsumerGroupQuotaRulesResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(code, code_);
      DARABONBA_PTR_TO_JSON(data, data_);
      DARABONBA_PTR_TO_JSON(message, message_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListConsumerGroupQuotaRulesResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(code, code_);
      DARABONBA_PTR_FROM_JSON(data, data_);
      DARABONBA_PTR_FROM_JSON(message, message_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    ListConsumerGroupQuotaRulesResponseBody() = default ;
    ListConsumerGroupQuotaRulesResponseBody(const ListConsumerGroupQuotaRulesResponseBody &) = default ;
    ListConsumerGroupQuotaRulesResponseBody(ListConsumerGroupQuotaRulesResponseBody &&) = default ;
    ListConsumerGroupQuotaRulesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListConsumerGroupQuotaRulesResponseBody() = default ;
    ListConsumerGroupQuotaRulesResponseBody& operator=(const ListConsumerGroupQuotaRulesResponseBody &) = default ;
    ListConsumerGroupQuotaRulesResponseBody& operator=(ListConsumerGroupQuotaRulesResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline Items& setPeriodMultiplier(int64_t periodMultiplier) { DARABONBA_PTR_SET_VALUE(periodMultiplier_, periodMultiplier) };
    ...
    inline ListConsumerGroupQuotaRulesResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ListConsumerGroupQuotaRulesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListConsumerGroupQuotaRulesResponseBody::Data) };
    inline ListConsumerGroupQuotaRulesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListConsumerGroupQuotaRulesResponseBody::Data) };
    inline ListConsumerGroupQuotaRulesResponseBody& setData(const ListConsumerGroupQuotaRulesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListConsumerGroupQuotaRulesResponseBody& setData(ListConsumerGroupQuotaRulesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListConsumerGroupQuotaRulesResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListConsumerGroupQuotaRulesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<ListConsumerGroupQuotaRulesResponseBody::Data> data_ {};
