...
namespace Models
{
  ...
  public:
    ...
    inline const ListPluginAttachmentsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListPluginAttachmentsResponseBodyData) };
    inline ListPluginAttachmentsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListPluginAttachmentsResponseBodyData) };
    inline ListPluginAttachmentsResponseBody& setData(const ListPluginAttachmentsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListPluginAttachmentsResponseBody& setData(ListPluginAttachmentsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListPluginAttachmentsResponseBodyData> data_ = nullptr;
