...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeGatewayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeGatewayResponseBody) };
    inline UpgradeGatewayResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeGatewayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeGatewayResponseBody> body_ {};
  };
