...
#ifndef ALIBABACLOUD_MODELS_CREATEAIMODELCARDRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEAIMODELCARDRESPONSEBODY_HPP_
...
namespace Models
{
  class CreateAiModelCardResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateAiModelCardResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(code, code_);
      DARABONBA_PTR_TO_JSON(data, data_);
      DARABONBA_PTR_TO_JSON(message, message_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, CreateAiModelCardResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(code, code_);
      DARABONBA_PTR_FROM_JSON(data, data_);
      DARABONBA_PTR_FROM_JSON(message, message_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    CreateAiModelCardResponseBody() = default ;
    CreateAiModelCardResponseBody(const CreateAiModelCardResponseBody &) = default ;
    CreateAiModelCardResponseBody(CreateAiModelCardResponseBody &&) = default ;
    CreateAiModelCardResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAiModelCardResponseBody() = default ;
    CreateAiModelCardResponseBody& operator=(const CreateAiModelCardResponseBody &) = default ;
    CreateAiModelCardResponseBody& operator=(CreateAiModelCardResponseBody &&) = default ;
    ...
    inline CreateAiModelCardResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateAiModelCardResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateAiModelCardResponseBody::Data) };
    inline CreateAiModelCardResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateAiModelCardResponseBody::Data) };
    inline CreateAiModelCardResponseBody& setData(const CreateAiModelCardResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateAiModelCardResponseBody& setData(CreateAiModelCardResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateAiModelCardResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateAiModelCardResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
