...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePolicyAttachmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePolicyAttachmentResponseBody) };
    inline CreatePolicyAttachmentResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePolicyAttachmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePolicyAttachmentResponseBody> body_ {};
  };
