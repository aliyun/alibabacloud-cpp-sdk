...
#ifndef ALIBABACLOUD_MODELS_BATCHREMOVECONSUMERGROUPCONSUMERSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_BATCHREMOVECONSUMERGROUPCONSUMERSRESPONSEBODY_HPP_
...
namespace Models
{
  class BatchRemoveConsumerGroupConsumersResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const BatchRemoveConsumerGroupConsumersResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(code, code_);
      DARABONBA_PTR_TO_JSON(data, data_);
      DARABONBA_PTR_TO_JSON(message, message_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, BatchRemoveConsumerGroupConsumersResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(code, code_);
      DARABONBA_PTR_FROM_JSON(data, data_);
      DARABONBA_PTR_FROM_JSON(message, message_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    BatchRemoveConsumerGroupConsumersResponseBody() = default ;
    BatchRemoveConsumerGroupConsumersResponseBody(const BatchRemoveConsumerGroupConsumersResponseBody &) = default ;
    BatchRemoveConsumerGroupConsumersResponseBody(BatchRemoveConsumerGroupConsumersResponseBody &&) = default ;
    BatchRemoveConsumerGroupConsumersResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BatchRemoveConsumerGroupConsumersResponseBody() = default ;
    BatchRemoveConsumerGroupConsumersResponseBody& operator=(const BatchRemoveConsumerGroupConsumersResponseBody &) = default ;
    BatchRemoveConsumerGroupConsumersResponseBody& operator=(BatchRemoveConsumerGroupConsumersResponseBody &&) = default ;
    ...
    inline BatchRemoveConsumerGroupConsumersResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const BatchRemoveConsumerGroupConsumersResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, BatchRemoveConsumerGroupConsumersResponseBody::Data) };
    inline BatchRemoveConsumerGroupConsumersResponseBody::Data getData() { DARABONBA_PTR_GET(data_, BatchRemoveConsumerGroupConsumersResponseBody::Data) };
    inline BatchRemoveConsumerGroupConsumersResponseBody& setData(const BatchRemoveConsumerGroupConsumersResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BatchRemoveConsumerGroupConsumersResponseBody& setData(BatchRemoveConsumerGroupConsumersResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline BatchRemoveConsumerGroupConsumersResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline BatchRemoveConsumerGroupConsumersResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<BatchRemoveConsumerGroupConsumersResponseBody::Data> data_ {};
