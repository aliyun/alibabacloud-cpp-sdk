...
namespace Models
{
  ...
  public:
    ...
    inline const SyncMCPServersResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SyncMCPServersResponseBodyData) };
    inline SyncMCPServersResponseBodyData data() { DARABONBA_PTR_GET(data_, SyncMCPServersResponseBodyData) };
    inline SyncMCPServersResponseBody& setData(const SyncMCPServersResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SyncMCPServersResponseBody& setData(SyncMCPServersResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SyncMCPServersResponseBodyData> data_ = nullptr;
