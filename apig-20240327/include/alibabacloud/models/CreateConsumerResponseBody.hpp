...
namespace Models
{
  ...
  public:
    ...
    inline const CreateConsumerResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateConsumerResponseBodyData) };
    inline CreateConsumerResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateConsumerResponseBodyData) };
    inline CreateConsumerResponseBody& setData(const CreateConsumerResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateConsumerResponseBody& setData(CreateConsumerResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateConsumerResponseBodyData> data_ = nullptr;
