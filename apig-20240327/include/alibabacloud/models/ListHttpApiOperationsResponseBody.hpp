...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListHttpApiOperationsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(code, code_);
      DARABONBA_PTR_TO_JSON(data, data_);
      DARABONBA_PTR_TO_JSON(message, message_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListHttpApiOperationsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(code, code_);
      DARABONBA_PTR_FROM_JSON(data, data_);
      DARABONBA_PTR_FROM_JSON(message, message_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    ListHttpApiOperationsResponseBody() = default ;
    ListHttpApiOperationsResponseBody(const ListHttpApiOperationsResponseBody &) = default ;
    ListHttpApiOperationsResponseBody(ListHttpApiOperationsResponseBody &&) = default ;
    ListHttpApiOperationsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListHttpApiOperationsResponseBody() = default ;
    ListHttpApiOperationsResponseBody& operator=(const ListHttpApiOperationsResponseBody &) = default ;
    ListHttpApiOperationsResponseBody& operator=(ListHttpApiOperationsResponseBody &&) = default ;
