...
namespace Models
{
  ...
  public:
    ...
    inline const GetConsumerResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetConsumerResponseBodyData) };
    inline GetConsumerResponseBodyData data() { DARABONBA_PTR_GET(data_, GetConsumerResponseBodyData) };
    inline GetConsumerResponseBody& setData(const GetConsumerResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetConsumerResponseBody& setData(GetConsumerResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetConsumerResponseBodyData> data_ = nullptr;
