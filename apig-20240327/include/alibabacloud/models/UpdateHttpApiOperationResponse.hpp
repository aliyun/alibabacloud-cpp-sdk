...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateHttpApiOperationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateHttpApiOperationResponseBody) };
    inline UpdateHttpApiOperationResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateHttpApiOperationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateHttpApiOperationResponseBody> body_ {};
  };
