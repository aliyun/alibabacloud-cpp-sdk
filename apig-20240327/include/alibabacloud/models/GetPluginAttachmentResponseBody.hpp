...
namespace Models
{
  ...
  public:
    ...
    inline const GetPluginAttachmentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetPluginAttachmentResponseBodyData) };
    inline GetPluginAttachmentResponseBodyData data() { DARABONBA_PTR_GET(data_, GetPluginAttachmentResponseBodyData) };
    inline GetPluginAttachmentResponseBody& setData(const GetPluginAttachmentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPluginAttachmentResponseBody& setData(GetPluginAttachmentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetPluginAttachmentResponseBodyData> data_ = nullptr;
