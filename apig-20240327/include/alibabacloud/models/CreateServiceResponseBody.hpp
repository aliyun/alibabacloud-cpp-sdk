...
namespace Models
{
  ...
  public:
    ...
    inline const CreateServiceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateServiceResponseBodyData) };
    inline CreateServiceResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateServiceResponseBodyData) };
    inline CreateServiceResponseBody& setData(const CreateServiceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateServiceResponseBody& setData(CreateServiceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The response data.
    std::shared_ptr<CreateServiceResponseBodyData> data_ = nullptr;
