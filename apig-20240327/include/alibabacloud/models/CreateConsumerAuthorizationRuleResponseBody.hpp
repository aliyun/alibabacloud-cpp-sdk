...
namespace Models
{
  ...
  public:
    ...
    inline const CreateConsumerAuthorizationRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateConsumerAuthorizationRuleResponseBodyData) };
    inline CreateConsumerAuthorizationRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateConsumerAuthorizationRuleResponseBodyData) };
    inline CreateConsumerAuthorizationRuleResponseBody& setData(const CreateConsumerAuthorizationRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateConsumerAuthorizationRuleResponseBody& setData(CreateConsumerAuthorizationRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
