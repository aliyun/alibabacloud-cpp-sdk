...
namespace Models
{
  ...
  public:
    ...
    inline const ImportHttpApiResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ImportHttpApiResponseBodyData) };
    inline ImportHttpApiResponseBodyData data() { DARABONBA_PTR_GET(data_, ImportHttpApiResponseBodyData) };
    inline ImportHttpApiResponseBody& setData(const ImportHttpApiResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ImportHttpApiResponseBody& setData(ImportHttpApiResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The API information.
    std::shared_ptr<ImportHttpApiResponseBodyData> data_ = nullptr;
