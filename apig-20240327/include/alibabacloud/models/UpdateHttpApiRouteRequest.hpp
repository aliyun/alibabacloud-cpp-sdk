...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backendConfig_ == nullptr
        && this->description_ == nullptr && this->domainIds_ == nullptr && this->environmentId_ == nullptr && this->match_ == nullptr && this->mcpRouteConfig_ == nullptr
        && this->policyConfigs_ == nullptr; };
    ...
    inline UpdateHttpApiRouteRequest& setPolicyConfigs(const vector<HttpApiPolicyConfigs> & policyConfigs) { DARABONBA_PTR_SET_VALUE(policyConfigs_, policyConfigs) };
    inline UpdateHttpApiRouteRequest& setPolicyConfigs(vector<HttpApiPolicyConfigs> && policyConfigs) { DARABONBA_PTR_SET_RVALUE(policyConfigs_, policyConfigs) };
