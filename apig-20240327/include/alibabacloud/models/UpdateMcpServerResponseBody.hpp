...
namespace Models
{
  ...
  public:
    ...
    inline UpdateMcpServerResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline UpdateMcpServerResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
