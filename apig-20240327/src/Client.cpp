 ...
 */
DeletePluginClassResponse Client::deletePluginClassWithOptions(const string &pluginClassId, const DeletePluginClassRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  OpenApiRequest req = OpenApiRequest(json({
    {"headers" , headers}
  }).get<map<string, map<string, string>>>());
  ...
  return json(callApi(params, req, runtime)).get<DeletePluginClassResponse>();
}
 ...
 * @return DeletePluginClassResponse
 */
DeletePluginClassResponse Client::deletePluginClass(const string &pluginClassId, const DeletePluginClassRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
  return deletePluginClassWithOptions(pluginClassId, request, headers, runtime);
}
 ...
 */
GetGatewayResourceQuotaUsageResponse Client::getGatewayResourceQuotaUsageWithOptions(const string &gatewayId, const GetGatewayResourceQuotaUsageRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  OpenApiRequest req = OpenApiRequest(json({
    {"headers" , headers}
  }).get<map<string, map<string, string>>>());
  Params params = Params(json({
    ...
    {"version" , "2024-03-27"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/v1/gateways/" , Darabonba::Encode::Encoder::percentEncode(gatewayId) , "/resource-quota-usage")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetGatewayResourceQuotaUsageResponse>();
}
 ...
 * @return GetGatewayResourceQuotaUsageResponse
 */
GetGatewayResourceQuotaUsageResponse Client::getGatewayResourceQuotaUsage(const string &gatewayId, const GetGatewayResourceQuotaUsageRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ListZonesResponse Client::listZonesWithOptions(const ListZonesRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasGatewayEdition()) {
    query["gatewayEdition"] = request.getGatewayEdition();
  }
