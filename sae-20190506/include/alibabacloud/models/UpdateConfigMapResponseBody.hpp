...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateConfigMapResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateConfigMapResponseBodyData) };
    inline UpdateConfigMapResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateConfigMapResponseBodyData) };
    inline UpdateConfigMapResponseBody& setData(const UpdateConfigMapResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateConfigMapResponseBody& setData(UpdateConfigMapResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateConfigMapResponseBodyData> data_ = nullptr;
