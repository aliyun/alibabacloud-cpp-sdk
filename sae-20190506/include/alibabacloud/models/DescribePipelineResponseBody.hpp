...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePipelineResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribePipelineResponseBodyData) };
    inline DescribePipelineResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribePipelineResponseBodyData) };
    inline DescribePipelineResponseBody& setData(const DescribePipelineResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribePipelineResponseBody& setData(DescribePipelineResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribePipelineResponseBodyData> data_ = nullptr;
