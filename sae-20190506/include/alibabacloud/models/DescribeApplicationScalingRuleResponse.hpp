...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApplicationScalingRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApplicationScalingRuleResponseBody) };
    inline DescribeApplicationScalingRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApplicationScalingRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApplicationScalingRuleResponseBody> body_ {};
  };
