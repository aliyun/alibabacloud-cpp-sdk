...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const BindSlbResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, BindSlbResponseBody& obj) { 
    ...
    BindSlbResponseBody() = default ;
    BindSlbResponseBody(const BindSlbResponseBody &) = default ;
    BindSlbResponseBody(BindSlbResponseBody &&) = default ;
    BindSlbResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BindSlbResponseBody() = default ;
    BindSlbResponseBody& operator=(const BindSlbResponseBody &) = default ;
    BindSlbResponseBody& operator=(BindSlbResponseBody &&) = default ;
