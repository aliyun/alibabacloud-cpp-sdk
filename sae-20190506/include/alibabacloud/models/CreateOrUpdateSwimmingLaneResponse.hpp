...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOrUpdateSwimmingLaneResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateOrUpdateSwimmingLaneResponseBody) };
    inline CreateOrUpdateSwimmingLaneResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateOrUpdateSwimmingLaneResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateOrUpdateSwimmingLaneResponseBody> body_ {};
  };
