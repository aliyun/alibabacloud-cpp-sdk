...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ExecJobResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ExecJobResponseBody& obj) { 
    ...
    ExecJobResponseBody() = default ;
    ExecJobResponseBody(const ExecJobResponseBody &) = default ;
    ExecJobResponseBody(ExecJobResponseBody &&) = default ;
    ExecJobResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ExecJobResponseBody() = default ;
    ExecJobResponseBody& operator=(const ExecJobResponseBody &) = default ;
    ExecJobResponseBody& operator=(ExecJobResponseBody &&) = default ;
