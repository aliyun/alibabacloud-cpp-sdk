...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEAPPLICATIONSCALINGRULESRESPONSEBODYDATAAPPLICATIONSCALINGRULESMETRICMETRICS_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEAPPLICATIONSCALINGRULESRESPONSEBODYDATAAPPLICATIONSCALINGRULESMETRICMETRICS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics& obj) { 
    ...
    DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics() = default ;
    DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics(const DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics &) = default ;
    DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics(DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics &&) = default ;
    DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics() = default ;
    DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics& operator=(const DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics &) = default ;
    DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics& operator=(DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics &&) = default ;
    ...
    inline DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics& setMetricTargetAverageUtilization(int32_t metricTargetAverageUtilization) { DARABONBA_PTR_SET_VALUE(metricTargetAverageUtilization_, metricTargetAverageUtilization) };
    ...
    inline DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics& setMetricType(string metricType) { DARABONBA_PTR_SET_VALUE(metricType_, metricType) };
    ...
    inline DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics& setSlbId(string slbId) { DARABONBA_PTR_SET_VALUE(slbId_, slbId) };
    ...
    inline DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics& setSlbLogstore(string slbLogstore) { DARABONBA_PTR_SET_VALUE(slbLogstore_, slbLogstore) };
    ...
    inline DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics& setSlbProject(string slbProject) { DARABONBA_PTR_SET_VALUE(slbProject_, slbProject) };
    ...
    inline DescribeApplicationScalingRulesResponseBodyDataApplicationScalingRulesMetricMetrics& setVport(string vport) { DARABONBA_PTR_SET_VALUE(vport_, vport) };
