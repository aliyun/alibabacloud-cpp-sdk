...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateApplicationScalingRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateApplicationScalingRuleResponseBodyData) };
    inline UpdateApplicationScalingRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateApplicationScalingRuleResponseBodyData) };
    inline UpdateApplicationScalingRuleResponseBody& setData(const UpdateApplicationScalingRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateApplicationScalingRuleResponseBody& setData(UpdateApplicationScalingRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<UpdateApplicationScalingRuleResponseBodyData> data_ = nullptr;
