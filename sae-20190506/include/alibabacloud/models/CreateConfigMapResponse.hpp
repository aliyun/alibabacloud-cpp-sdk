...
namespace Models
{
  ...
  public:
    ...
    inline const CreateConfigMapResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateConfigMapResponseBody) };
    inline CreateConfigMapResponseBody body() { DARABONBA_PTR_GET(body_, CreateConfigMapResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateConfigMapResponseBody> body_ = nullptr;
  };
