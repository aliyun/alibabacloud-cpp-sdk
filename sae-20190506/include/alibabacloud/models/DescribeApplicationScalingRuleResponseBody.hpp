...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApplicationScalingRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeApplicationScalingRuleResponseBodyData) };
    inline DescribeApplicationScalingRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeApplicationScalingRuleResponseBodyData) };
    inline DescribeApplicationScalingRuleResponseBody& setData(const DescribeApplicationScalingRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeApplicationScalingRuleResponseBody& setData(DescribeApplicationScalingRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeApplicationScalingRuleResponseBodyData> data_ = nullptr;
