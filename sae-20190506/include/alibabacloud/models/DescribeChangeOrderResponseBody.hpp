...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeChangeOrderResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeChangeOrderResponseBodyData) };
    inline DescribeChangeOrderResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeChangeOrderResponseBodyData) };
    inline DescribeChangeOrderResponseBody& setData(const DescribeChangeOrderResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeChangeOrderResponseBody& setData(DescribeChangeOrderResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeChangeOrderResponseBodyData> data_ = nullptr;
