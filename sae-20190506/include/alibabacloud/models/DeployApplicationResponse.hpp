...
namespace Models
{
  ...
  public:
    ...
    inline const DeployApplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeployApplicationResponseBody) };
    inline DeployApplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, DeployApplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeployApplicationResponseBody> body_ {};
  };
