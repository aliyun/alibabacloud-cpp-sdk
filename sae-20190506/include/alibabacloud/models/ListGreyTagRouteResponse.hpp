...
namespace Models
{
  ...
  public:
    ...
    inline const ListGreyTagRouteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListGreyTagRouteResponseBody) };
    inline ListGreyTagRouteResponseBody getBody() { DARABONBA_PTR_GET(body_, ListGreyTagRouteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListGreyTagRouteResponseBody> body_ {};
  };
