...
namespace Models
{
  ...
  public:
    ...
    inline const BindNlbResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BindNlbResponseBody) };
    inline BindNlbResponseBody getBody() { DARABONBA_PTR_GET(body_, BindNlbResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BindNlbResponseBody> body_ {};
  };
