...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceLogResponseBody) };
    inline DescribeInstanceLogResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceLogResponseBody> body_ {};
  };
