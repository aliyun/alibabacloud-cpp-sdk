...
namespace Models
{
  ...
  public:
    ...
    inline const QueryResourceStaticsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryResourceStaticsResponseBodyData) };
    inline QueryResourceStaticsResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryResourceStaticsResponseBodyData) };
    inline QueryResourceStaticsResponseBody& setData(const QueryResourceStaticsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryResourceStaticsResponseBody& setData(QueryResourceStaticsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The resource usage.
    std::shared_ptr<QueryResourceStaticsResponseBodyData> data_ = nullptr;
    // The error code. 
    // 
