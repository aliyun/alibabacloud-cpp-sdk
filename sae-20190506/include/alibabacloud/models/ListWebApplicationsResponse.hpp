...
namespace Models
{
  ...
  public:
    ...
    inline const ListWebApplicationsBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListWebApplicationsBody) };
    inline ListWebApplicationsBody body() { DARABONBA_PTR_GET(body_, ListWebApplicationsBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListWebApplicationsBody> body_ = nullptr;
  };
