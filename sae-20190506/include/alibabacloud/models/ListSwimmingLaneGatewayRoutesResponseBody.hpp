...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListSwimmingLaneGatewayRoutesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListSwimmingLaneGatewayRoutesResponseBodyData>) };
    inline vector<ListSwimmingLaneGatewayRoutesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListSwimmingLaneGatewayRoutesResponseBodyData>) };
    inline ListSwimmingLaneGatewayRoutesResponseBody& setData(const vector<ListSwimmingLaneGatewayRoutesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListSwimmingLaneGatewayRoutesResponseBody& setData(vector<ListSwimmingLaneGatewayRoutesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListSwimmingLaneGatewayRoutesResponseBodyData>> data_ = nullptr;
