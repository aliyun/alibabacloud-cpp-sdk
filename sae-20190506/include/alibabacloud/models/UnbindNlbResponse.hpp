...
namespace Models
{
  ...
  public:
    ...
    inline const UnbindNlbResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UnbindNlbResponseBody) };
    inline UnbindNlbResponseBody body() { DARABONBA_PTR_GET(body_, UnbindNlbResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UnbindNlbResponseBody> body_ = nullptr;
  };
