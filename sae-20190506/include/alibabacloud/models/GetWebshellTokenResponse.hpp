...
namespace Models
{
  ...
  public:
    ...
    inline const GetWebshellTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetWebshellTokenResponseBody) };
    inline GetWebshellTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, GetWebshellTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetWebshellTokenResponseBody> body_ {};
  };
