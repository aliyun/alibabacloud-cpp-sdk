...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSecretResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateSecretResponseBodyData) };
    inline UpdateSecretResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateSecretResponseBodyData) };
    inline UpdateSecretResponseBody& setData(const UpdateSecretResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateSecretResponseBody& setData(UpdateSecretResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateSecretResponseBodyData> data_ = nullptr;
