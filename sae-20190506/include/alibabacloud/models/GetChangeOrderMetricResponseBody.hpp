...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetChangeOrderMetricResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetChangeOrderMetricResponseBodyData>) };
    inline vector<GetChangeOrderMetricResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetChangeOrderMetricResponseBodyData>) };
    inline GetChangeOrderMetricResponseBody& setData(const vector<GetChangeOrderMetricResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetChangeOrderMetricResponseBody& setData(vector<GetChangeOrderMetricResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetChangeOrderMetricResponseBodyData>> data_ = nullptr;
