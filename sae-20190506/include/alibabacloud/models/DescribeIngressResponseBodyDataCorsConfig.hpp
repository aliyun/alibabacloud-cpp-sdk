...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEINGRESSRESPONSEBODYDATACORSCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEINGRESSRESPONSEBODYDATACORSCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeIngressResponseBodyDataCorsConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeIngressResponseBodyDataCorsConfig& obj) { 
    ...
    DescribeIngressResponseBodyDataCorsConfig() = default ;
    DescribeIngressResponseBodyDataCorsConfig(const DescribeIngressResponseBodyDataCorsConfig &) = default ;
    DescribeIngressResponseBodyDataCorsConfig(DescribeIngressResponseBodyDataCorsConfig &&) = default ;
    DescribeIngressResponseBodyDataCorsConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeIngressResponseBodyDataCorsConfig() = default ;
    DescribeIngressResponseBodyDataCorsConfig& operator=(const DescribeIngressResponseBodyDataCorsConfig &) = default ;
    DescribeIngressResponseBodyDataCorsConfig& operator=(DescribeIngressResponseBodyDataCorsConfig &&) = default ;
    ...
    inline DescribeIngressResponseBodyDataCorsConfig& setAllowCredentials(string allowCredentials) { DARABONBA_PTR_SET_VALUE(allowCredentials_, allowCredentials) };
    ...
    inline DescribeIngressResponseBodyDataCorsConfig& setAllowHeaders(string allowHeaders) { DARABONBA_PTR_SET_VALUE(allowHeaders_, allowHeaders) };
    ...
    inline DescribeIngressResponseBodyDataCorsConfig& setAllowMethods(string allowMethods) { DARABONBA_PTR_SET_VALUE(allowMethods_, allowMethods) };
    ...
    inline DescribeIngressResponseBodyDataCorsConfig& setAllowOrigin(string allowOrigin) { DARABONBA_PTR_SET_VALUE(allowOrigin_, allowOrigin) };
    ...
    inline DescribeIngressResponseBodyDataCorsConfig& setEnable(string enable) { DARABONBA_PTR_SET_VALUE(enable_, enable) };
    ...
    inline DescribeIngressResponseBodyDataCorsConfig& setExposeHeaders(string exposeHeaders) { DARABONBA_PTR_SET_VALUE(exposeHeaders_, exposeHeaders) };
    ...
    inline DescribeIngressResponseBodyDataCorsConfig& setMaxAge(string maxAge) { DARABONBA_PTR_SET_VALUE(maxAge_, maxAge) };
