...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateJobResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateJobResponseBodyData) };
    inline UpdateJobResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateJobResponseBodyData) };
    inline UpdateJobResponseBody& setData(const UpdateJobResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateJobResponseBody& setData(UpdateJobResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The response.
    std::shared_ptr<UpdateJobResponseBodyData> data_ = nullptr;
