...
namespace Models
{
  ...
  public:
    ...
    inline UpdateJobResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const UpdateJobResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateJobResponseBody::Data) };
    inline UpdateJobResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateJobResponseBody::Data) };
    inline UpdateJobResponseBody& setData(const UpdateJobResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateJobResponseBody& setData(UpdateJobResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UpdateJobResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline UpdateJobResponseBody& setTraceId(string traceId) { DARABONBA_PTR_SET_VALUE(traceId_, traceId) };
  ...
  protected:
    ...
    // The response.
    shared_ptr<UpdateJobResponseBody::Data> data_ {};
