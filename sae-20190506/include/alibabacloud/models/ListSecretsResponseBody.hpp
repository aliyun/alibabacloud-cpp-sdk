...
namespace Models
{
  ...
  public:
    ...
    inline const ListSecretsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListSecretsResponseBodyData) };
    inline ListSecretsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListSecretsResponseBodyData) };
    inline ListSecretsResponseBody& setData(const ListSecretsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListSecretsResponseBody& setData(ListSecretsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<ListSecretsResponseBodyData> data_ = nullptr;
