...
namespace Models
{
  ...
  public:
    ...
    inline const DeployApplicationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DeployApplicationResponseBodyData) };
    inline DeployApplicationResponseBodyData data() { DARABONBA_PTR_GET(data_, DeployApplicationResponseBodyData) };
    inline DeployApplicationResponseBody& setData(const DeployApplicationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeployApplicationResponseBody& setData(DeployApplicationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The response.
    std::shared_ptr<DeployApplicationResponseBodyData> data_ = nullptr;
