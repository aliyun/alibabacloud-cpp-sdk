...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApplicationInstancesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeApplicationInstancesResponseBodyData) };
    inline DescribeApplicationInstancesResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeApplicationInstancesResponseBodyData) };
    inline DescribeApplicationInstancesResponseBody& setData(const DescribeApplicationInstancesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeApplicationInstancesResponseBody& setData(DescribeApplicationInstancesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeApplicationInstancesResponseBodyData> data_ = nullptr;
    // The error code. 
    // 
