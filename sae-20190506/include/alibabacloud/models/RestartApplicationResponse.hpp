...
namespace Models
{
  ...
  public:
    ...
    inline const RestartApplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RestartApplicationResponseBody) };
    inline RestartApplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, RestartApplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RestartApplicationResponseBody> body_ {};
  };
