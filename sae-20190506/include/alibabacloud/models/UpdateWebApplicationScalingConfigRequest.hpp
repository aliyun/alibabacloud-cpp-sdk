...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateWebApplicationScalingConfigInput & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateWebApplicationScalingConfigInput) };
    inline UpdateWebApplicationScalingConfigInput getBody() { DARABONBA_PTR_GET(body_, UpdateWebApplicationScalingConfigInput) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<UpdateWebApplicationScalingConfigInput> body_ {};
  };
