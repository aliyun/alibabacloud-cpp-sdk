...
namespace Models
{
  ...
  public:
    ...
    inline const ListConsumedServicesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListConsumedServicesResponseBody) };
    inline ListConsumedServicesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListConsumedServicesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListConsumedServicesResponseBody> body_ {};
  };
