...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteInstancesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteInstancesResponseBody::Data) };
    inline DeleteInstancesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteInstancesResponseBody::Data) };
    inline DeleteInstancesResponseBody& setData(const DeleteInstancesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteInstancesResponseBody& setData(DeleteInstancesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // Responses.
    shared_ptr<DeleteInstancesResponseBody::Data> data_ {};
