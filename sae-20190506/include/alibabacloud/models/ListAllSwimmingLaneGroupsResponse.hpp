...
namespace Models
{
  ...
  public:
    ...
    inline const ListAllSwimmingLaneGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAllSwimmingLaneGroupsResponseBody) };
    inline ListAllSwimmingLaneGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAllSwimmingLaneGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAllSwimmingLaneGroupsResponseBody> body_ {};
  };
