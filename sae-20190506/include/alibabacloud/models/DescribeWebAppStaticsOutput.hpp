...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEWEBAPPSTATICSOUTPUT_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEWEBAPPSTATICSOUTPUT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeWebAppStaticsOutput& obj) { 
      DARABONBA_PTR_TO_JSON(Length, length_);
      DARABONBA_PTR_TO_JSON(WebAppStatics, webAppStatics_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeWebAppStaticsOutput& obj) { 
      DARABONBA_PTR_FROM_JSON(Length, length_);
      DARABONBA_PTR_FROM_JSON(WebAppStatics, webAppStatics_);
    };
    DescribeWebAppStaticsOutput() = default ;
    DescribeWebAppStaticsOutput(const DescribeWebAppStaticsOutput &) = default ;
    DescribeWebAppStaticsOutput(DescribeWebAppStaticsOutput &&) = default ;
    DescribeWebAppStaticsOutput(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeWebAppStaticsOutput() = default ;
    DescribeWebAppStaticsOutput& operator=(const DescribeWebAppStaticsOutput &) = default ;
    DescribeWebAppStaticsOutput& operator=(DescribeWebAppStaticsOutput &&) = default ;
