...
namespace Models
{
  ...
  public:
    ...
    inline const ListNamespacedConfigMapsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNamespacedConfigMapsResponseBody) };
    inline ListNamespacedConfigMapsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNamespacedConfigMapsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNamespacedConfigMapsResponseBody> body_ {};
  };
