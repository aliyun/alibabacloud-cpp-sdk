...
namespace Models
{
  ...
  public:
    ...
    inline const ListNamespaceChangeOrdersResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListNamespaceChangeOrdersResponseBodyData) };
    inline ListNamespaceChangeOrdersResponseBodyData data() { DARABONBA_PTR_GET(data_, ListNamespaceChangeOrdersResponseBodyData) };
    inline ListNamespaceChangeOrdersResponseBody& setData(const ListNamespaceChangeOrdersResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListNamespaceChangeOrdersResponseBody& setData(ListNamespaceChangeOrdersResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<ListNamespaceChangeOrdersResponseBodyData> data_ = nullptr;
    // The error code.
    // 
