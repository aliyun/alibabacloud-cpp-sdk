...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeComponentsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeComponentsResponseBody) };
    inline DescribeComponentsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeComponentsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeComponentsResponseBody> body_ = nullptr;
  };
