...
namespace Models
{
  ...
  public:
    ...
    inline const QueryArmsEnableResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryArmsEnableResponseBodyData) };
    inline QueryArmsEnableResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryArmsEnableResponseBodyData) };
    inline QueryArmsEnableResponseBody& setData(const QueryArmsEnableResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryArmsEnableResponseBody& setData(QueryArmsEnableResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
