...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListPublishedServicesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListPublishedServicesResponseBodyData>) };
    inline vector<ListPublishedServicesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListPublishedServicesResponseBodyData>) };
    inline ListPublishedServicesResponseBody& setData(const vector<ListPublishedServicesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListPublishedServicesResponseBody& setData(vector<ListPublishedServicesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListPublishedServicesResponseBodyData>> data_ = nullptr;
