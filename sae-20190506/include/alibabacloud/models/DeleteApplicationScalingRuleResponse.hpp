...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteApplicationScalingRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteApplicationScalingRuleResponseBody) };
    inline DeleteApplicationScalingRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteApplicationScalingRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteApplicationScalingRuleResponseBody> body_ {};
  };
