...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateNamespaceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateNamespaceResponseBodyData) };
    inline UpdateNamespaceResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateNamespaceResponseBodyData) };
    inline UpdateNamespaceResponseBody& setData(const UpdateNamespaceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateNamespaceResponseBody& setData(UpdateNamespaceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateNamespaceResponseBodyData> data_ = nullptr;
