...
namespace Models
{
  ...
  public:
    ...
    inline const RescaleApplicationResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, RescaleApplicationResponseBody::Data) };
    inline RescaleApplicationResponseBody::Data getData() { DARABONBA_PTR_GET(data_, RescaleApplicationResponseBody::Data) };
    inline RescaleApplicationResponseBody& setData(const RescaleApplicationResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RescaleApplicationResponseBody& setData(RescaleApplicationResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
