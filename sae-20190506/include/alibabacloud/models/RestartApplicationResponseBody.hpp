...
namespace Models
{
  ...
  public:
    ...
    inline const RestartApplicationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, RestartApplicationResponseBodyData) };
    inline RestartApplicationResponseBodyData data() { DARABONBA_PTR_GET(data_, RestartApplicationResponseBodyData) };
    inline RestartApplicationResponseBody& setData(const RestartApplicationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RestartApplicationResponseBody& setData(RestartApplicationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The response.
    std::shared_ptr<RestartApplicationResponseBodyData> data_ = nullptr;
