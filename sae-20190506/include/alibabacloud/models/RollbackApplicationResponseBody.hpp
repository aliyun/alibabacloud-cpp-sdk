...
namespace Models
{
  ...
  public:
    ...
    inline const RollbackApplicationResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, RollbackApplicationResponseBody::Data) };
    inline RollbackApplicationResponseBody::Data getData() { DARABONBA_PTR_GET(data_, RollbackApplicationResponseBody::Data) };
    inline RollbackApplicationResponseBody& setData(const RollbackApplicationResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RollbackApplicationResponseBody& setData(RollbackApplicationResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
