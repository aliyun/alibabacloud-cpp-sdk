...
namespace Models
{
  ...
  public:
    ...
    inline const ListLogConfigsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListLogConfigsResponseBodyData) };
    inline ListLogConfigsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListLogConfigsResponseBodyData) };
    inline ListLogConfigsResponseBody& setData(const ListLogConfigsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListLogConfigsResponseBody& setData(ListLogConfigsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListLogConfigsResponseBodyData> data_ = nullptr;
