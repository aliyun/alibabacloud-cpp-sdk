...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAllSwimmingLanesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAllSwimmingLanesResponseBodyData>) };
    inline vector<ListAllSwimmingLanesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAllSwimmingLanesResponseBodyData>) };
    inline ListAllSwimmingLanesResponseBody& setData(const vector<ListAllSwimmingLanesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAllSwimmingLanesResponseBody& setData(vector<ListAllSwimmingLanesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAllSwimmingLanesResponseBodyData>> data_ = nullptr;
