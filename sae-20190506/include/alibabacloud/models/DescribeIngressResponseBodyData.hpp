...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->certId_ != nullptr
        ...
        && this->name_ != nullptr && this->namespaceId_ != nullptr && this->requestTimeout_ != nullptr && this->rules_ != nullptr && this->securityPolicyId_ != nullptr
        && this->slbId_ != nullptr && this->slbType_ != nullptr; };
