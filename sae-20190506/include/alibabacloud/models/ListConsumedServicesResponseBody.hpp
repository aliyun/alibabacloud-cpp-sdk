...
namespace Models
{
  ...
  public:
    ...
    inline ListConsumedServicesResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<ListConsumedServicesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListConsumedServicesResponseBodyData>) };
    inline vector<ListConsumedServicesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListConsumedServicesResponseBodyData>) };
    inline ListConsumedServicesResponseBody& setData(const vector<ListConsumedServicesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListConsumedServicesResponseBody& setData(vector<ListConsumedServicesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListConsumedServicesResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline ListConsumedServicesResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline ListConsumedServicesResponseBody& setTraceId(string traceId) { DARABONBA_PTR_SET_VALUE(traceId_, traceId) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListConsumedServicesResponseBodyData>> data_ = nullptr;
