...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListConsumedServicesResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListConsumedServicesResponseBody::Data>) };
    inline vector<ListConsumedServicesResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListConsumedServicesResponseBody::Data>) };
    inline ListConsumedServicesResponseBody& setData(const vector<ListConsumedServicesResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListConsumedServicesResponseBody& setData(vector<ListConsumedServicesResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
