...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Organizations& setAvatarUrl(string avatarUrl) { DARABONBA_PTR_SET_VALUE(avatarUrl_, avatarUrl) };
      ...
      inline Organizations& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline const vector<SourceCodeAccount::Organizations> & getOrganizations() const { DARABONBA_PTR_GET_CONST(organizations_, vector<SourceCodeAccount::Organizations>) };
    inline vector<SourceCodeAccount::Organizations> getOrganizations() { DARABONBA_PTR_GET(organizations_, vector<SourceCodeAccount::Organizations>) };
    inline SourceCodeAccount& setOrganizations(const vector<SourceCodeAccount::Organizations> & organizations) { DARABONBA_PTR_SET_VALUE(organizations_, organizations) };
    inline SourceCodeAccount& setOrganizations(vector<SourceCodeAccount::Organizations> && organizations) { DARABONBA_PTR_SET_RVALUE(organizations_, organizations) };
  ...
  protected:
    ...
    shared_ptr<string> id_ {};
    shared_ptr<string> name_ {};
    shared_ptr<vector<SourceCodeAccount::Organizations>> organizations_ {};
  };
