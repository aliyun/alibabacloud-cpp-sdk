...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeApplicationGroupsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeApplicationGroupsResponseBodyData>) };
    inline vector<DescribeApplicationGroupsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeApplicationGroupsResponseBodyData>) };
    inline DescribeApplicationGroupsResponseBody& setData(const vector<DescribeApplicationGroupsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeApplicationGroupsResponseBody& setData(vector<DescribeApplicationGroupsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeApplicationGroupsResponseBodyData>> data_ = nullptr;
