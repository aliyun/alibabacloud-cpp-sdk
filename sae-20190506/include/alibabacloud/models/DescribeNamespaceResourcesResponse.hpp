...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNamespaceResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeNamespaceResourcesResponseBody) };
    inline DescribeNamespaceResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeNamespaceResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeNamespaceResourcesResponseBody> body_ {};
  };
