...
namespace Models
{
  ...
  public:
    ...
    inline const ConfirmPipelineBatchResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ConfirmPipelineBatchResponseBodyData) };
    inline ConfirmPipelineBatchResponseBodyData data() { DARABONBA_PTR_GET(data_, ConfirmPipelineBatchResponseBodyData) };
    inline ConfirmPipelineBatchResponseBody& setData(const ConfirmPipelineBatchResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ConfirmPipelineBatchResponseBody& setData(ConfirmPipelineBatchResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ConfirmPipelineBatchResponseBodyData> data_ = nullptr;
    // The error code.
    // 
