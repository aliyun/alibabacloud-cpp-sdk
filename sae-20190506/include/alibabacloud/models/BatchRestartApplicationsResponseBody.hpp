...
namespace Models
{
  ...
  public:
    ...
    inline const BatchRestartApplicationsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, BatchRestartApplicationsResponseBodyData) };
    inline BatchRestartApplicationsResponseBodyData data() { DARABONBA_PTR_GET(data_, BatchRestartApplicationsResponseBodyData) };
    inline BatchRestartApplicationsResponseBody& setData(const BatchRestartApplicationsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BatchRestartApplicationsResponseBody& setData(BatchRestartApplicationsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
