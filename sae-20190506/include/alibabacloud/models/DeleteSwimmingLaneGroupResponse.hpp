...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSwimmingLaneGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSwimmingLaneGroupResponseBody) };
    inline DeleteSwimmingLaneGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSwimmingLaneGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSwimmingLaneGroupResponseBody> body_ {};
  };
