...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNamespaceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeNamespaceResponseBody::Data) };
    inline DescribeNamespaceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeNamespaceResponseBody::Data) };
    inline DescribeNamespaceResponseBody& setData(const DescribeNamespaceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeNamespaceResponseBody& setData(DescribeNamespaceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
