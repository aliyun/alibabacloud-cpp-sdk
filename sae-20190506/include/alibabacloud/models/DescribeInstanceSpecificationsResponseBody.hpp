...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeInstanceSpecificationsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeInstanceSpecificationsResponseBodyData>) };
    inline vector<DescribeInstanceSpecificationsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeInstanceSpecificationsResponseBodyData>) };
    inline DescribeInstanceSpecificationsResponseBody& setData(const vector<DescribeInstanceSpecificationsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeInstanceSpecificationsResponseBody& setData(vector<DescribeInstanceSpecificationsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeInstanceSpecificationsResponseBodyData>> data_ = nullptr;
