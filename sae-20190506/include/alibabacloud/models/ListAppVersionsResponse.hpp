...
namespace Models
{
  ...
  public:
    ...
    inline const ListAppVersionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAppVersionsResponseBody) };
    inline ListAppVersionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAppVersionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAppVersionsResponseBody> body_ {};
  };
