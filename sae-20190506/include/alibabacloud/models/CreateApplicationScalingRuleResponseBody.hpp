...
namespace Models
{
  ...
  public:
    ...
    inline const CreateApplicationScalingRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateApplicationScalingRuleResponseBodyData) };
    inline CreateApplicationScalingRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateApplicationScalingRuleResponseBodyData) };
    inline CreateApplicationScalingRuleResponseBody& setData(const CreateApplicationScalingRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateApplicationScalingRuleResponseBody& setData(CreateApplicationScalingRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
