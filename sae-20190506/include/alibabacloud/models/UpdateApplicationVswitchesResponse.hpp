...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateApplicationVswitchesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateApplicationVswitchesResponseBody) };
    inline UpdateApplicationVswitchesResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateApplicationVswitchesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateApplicationVswitchesResponseBody> body_ {};
  };
