...
namespace Models
{
  ...
  public:
    ...
    inline const GetScaleAppMetricResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetScaleAppMetricResponseBody) };
    inline GetScaleAppMetricResponseBody getBody() { DARABONBA_PTR_GET(body_, GetScaleAppMetricResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetScaleAppMetricResponseBody> body_ {};
  };
