...
namespace Models
{
  ...
  public:
    ...
    inline const BindNlbResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, BindNlbResponseBodyData) };
    inline BindNlbResponseBodyData data() { DARABONBA_PTR_GET(data_, BindNlbResponseBodyData) };
    inline BindNlbResponseBody& setData(const BindNlbResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BindNlbResponseBody& setData(BindNlbResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<BindNlbResponseBodyData> data_ = nullptr;
