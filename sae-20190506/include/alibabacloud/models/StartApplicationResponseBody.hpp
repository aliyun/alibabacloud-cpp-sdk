...
namespace Models
{
  ...
  public:
    ...
    inline const StartApplicationResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, StartApplicationResponseBody::Data) };
    inline StartApplicationResponseBody::Data getData() { DARABONBA_PTR_GET(data_, StartApplicationResponseBody::Data) };
    inline StartApplicationResponseBody& setData(const StartApplicationResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline StartApplicationResponseBody& setData(StartApplicationResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
