...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApplicationStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeApplicationStatusResponseBodyData) };
    inline DescribeApplicationStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeApplicationStatusResponseBodyData) };
    inline DescribeApplicationStatusResponseBody& setData(const DescribeApplicationStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeApplicationStatusResponseBody& setData(DescribeApplicationStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<DescribeApplicationStatusResponseBodyData> data_ = nullptr;
