...
namespace Models
{
  ...
  public:
    ...
    inline const BatchStartApplicationsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, BatchStartApplicationsResponseBodyData) };
    inline BatchStartApplicationsResponseBodyData data() { DARABONBA_PTR_GET(data_, BatchStartApplicationsResponseBodyData) };
    inline BatchStartApplicationsResponseBody& setData(const BatchStartApplicationsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BatchStartApplicationsResponseBody& setData(BatchStartApplicationsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<BatchStartApplicationsResponseBodyData> data_ = nullptr;
