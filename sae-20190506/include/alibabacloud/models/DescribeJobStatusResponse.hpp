...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeJobStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeJobStatusResponseBody) };
    inline DescribeJobStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeJobStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeJobStatusResponseBody> body_ {};
  };
