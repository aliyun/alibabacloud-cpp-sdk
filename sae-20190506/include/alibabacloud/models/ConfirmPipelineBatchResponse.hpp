...
namespace Models
{
  ...
  public:
    ...
    inline const ConfirmPipelineBatchResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ConfirmPipelineBatchResponseBody) };
    inline ConfirmPipelineBatchResponseBody body() { DARABONBA_PTR_GET(body_, ConfirmPipelineBatchResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ConfirmPipelineBatchResponseBody> body_ = nullptr;
  };
