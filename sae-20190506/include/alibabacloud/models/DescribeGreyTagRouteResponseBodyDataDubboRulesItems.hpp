...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEGREYTAGROUTERESPONSEBODYDATADUBBORULESITEMS_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEGREYTAGROUTERESPONSEBODYDATADUBBORULESITEMS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeGreyTagRouteResponseBodyDataDubboRulesItems& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeGreyTagRouteResponseBodyDataDubboRulesItems& obj) { 
    ...
    DescribeGreyTagRouteResponseBodyDataDubboRulesItems() = default ;
    DescribeGreyTagRouteResponseBodyDataDubboRulesItems(const DescribeGreyTagRouteResponseBodyDataDubboRulesItems &) = default ;
    DescribeGreyTagRouteResponseBodyDataDubboRulesItems(DescribeGreyTagRouteResponseBodyDataDubboRulesItems &&) = default ;
    DescribeGreyTagRouteResponseBodyDataDubboRulesItems(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeGreyTagRouteResponseBodyDataDubboRulesItems() = default ;
    DescribeGreyTagRouteResponseBodyDataDubboRulesItems& operator=(const DescribeGreyTagRouteResponseBodyDataDubboRulesItems &) = default ;
    DescribeGreyTagRouteResponseBodyDataDubboRulesItems& operator=(DescribeGreyTagRouteResponseBodyDataDubboRulesItems &&) = default ;
    ...
    inline DescribeGreyTagRouteResponseBodyDataDubboRulesItems& setCond(string cond) { DARABONBA_PTR_SET_VALUE(cond_, cond) };
    ...
    inline DescribeGreyTagRouteResponseBodyDataDubboRulesItems& setExpr(string expr) { DARABONBA_PTR_SET_VALUE(expr_, expr) };
    ...
    inline DescribeGreyTagRouteResponseBodyDataDubboRulesItems& setIndex(int32_t index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline DescribeGreyTagRouteResponseBodyDataDubboRulesItems& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline DescribeGreyTagRouteResponseBodyDataDubboRulesItems& setOperator(string _operator) { DARABONBA_PTR_SET_VALUE(operator_, _operator) };
    ...
    inline DescribeGreyTagRouteResponseBodyDataDubboRulesItems& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DescribeGreyTagRouteResponseBodyDataDubboRulesItems& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
