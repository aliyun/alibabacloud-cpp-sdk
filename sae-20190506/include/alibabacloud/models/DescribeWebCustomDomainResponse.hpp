...
namespace Models
{
  ...
  public:
    ...
    inline const WebCustomDomain & getBody() const { DARABONBA_PTR_GET_CONST(body_, WebCustomDomain) };
    inline WebCustomDomain getBody() { DARABONBA_PTR_GET(body_, WebCustomDomain) };
  ...
  protected:
    ...
    shared_ptr<WebCustomDomain> body_ {};
  };
