...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNamespacesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeNamespacesResponseBodyData) };
    inline DescribeNamespacesResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeNamespacesResponseBodyData) };
    inline DescribeNamespacesResponseBody& setData(const DescribeNamespacesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeNamespacesResponseBody& setData(DescribeNamespacesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeNamespacesResponseBodyData> data_ = nullptr;
