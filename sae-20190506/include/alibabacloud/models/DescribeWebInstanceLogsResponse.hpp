...
namespace Models
{
  ...
  public:
    ...
    inline const WebApplicationInstanceLogsBody & body() const { DARABONBA_PTR_GET_CONST(body_, WebApplicationInstanceLogsBody) };
    inline WebApplicationInstanceLogsBody body() { DARABONBA_PTR_GET(body_, WebApplicationInstanceLogsBody) };
  ...
  protected:
    ...
    std::shared_ptr<WebApplicationInstanceLogsBody> body_ = nullptr;
  };
