...
namespace Models
{
  ...
  public:
    ...
    inline const RescaleApplicationVerticallyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RescaleApplicationVerticallyResponseBody) };
    inline RescaleApplicationVerticallyResponseBody getBody() { DARABONBA_PTR_GET(body_, RescaleApplicationVerticallyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RescaleApplicationVerticallyResponseBody> body_ {};
  };
