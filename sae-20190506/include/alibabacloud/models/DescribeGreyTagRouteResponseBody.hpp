...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeGreyTagRouteResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeGreyTagRouteResponseBodyData) };
    inline DescribeGreyTagRouteResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeGreyTagRouteResponseBodyData) };
    inline DescribeGreyTagRouteResponseBody& setData(const DescribeGreyTagRouteResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeGreyTagRouteResponseBody& setData(DescribeGreyTagRouteResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeGreyTagRouteResponseBodyData> data_ = nullptr;
