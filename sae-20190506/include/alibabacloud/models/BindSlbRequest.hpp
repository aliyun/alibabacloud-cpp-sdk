...
namespace Models
{
  ...
  public:
    ...
    inline string getInternet() const { DARABONBA_PTR_GET_DEFAULT(internet_, "") };
    ...
    inline string getIntranet() const { DARABONBA_PTR_GET_DEFAULT(intranet_, "") };
