...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeGreyTagRouteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeGreyTagRouteResponseBody) };
    inline DescribeGreyTagRouteResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeGreyTagRouteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeGreyTagRouteResponseBody> body_ {};
  };
