...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNamespaceListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeNamespaceListResponseBody) };
    inline DescribeNamespaceListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeNamespaceListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeNamespaceListResponseBody> body_ {};
  };
