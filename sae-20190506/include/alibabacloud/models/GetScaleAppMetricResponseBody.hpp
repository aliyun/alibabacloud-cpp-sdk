...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetScaleAppMetricResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetScaleAppMetricResponseBodyData>) };
    inline vector<GetScaleAppMetricResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetScaleAppMetricResponseBodyData>) };
    inline GetScaleAppMetricResponseBody& setData(const vector<GetScaleAppMetricResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetScaleAppMetricResponseBody& setData(vector<GetScaleAppMetricResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetScaleAppMetricResponseBodyData>> data_ = nullptr;
