...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECONFIGURATIONPRICERESPONSEBODYDATACPUMEMPRICEORDER_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECONFIGURATIONPRICERESPONSEBODYDATACPUMEMPRICEORDER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder& obj) { 
    ...
    DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder() = default ;
    DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder(const DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder &) = default ;
    DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder(DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder &&) = default ;
    DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder() = default ;
    DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder& operator=(const DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder &) = default ;
    DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder& operator=(DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder &&) = default ;
    ...
    inline DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder& setDiscountAmount(float discountAmount) { DARABONBA_PTR_SET_VALUE(discountAmount_, discountAmount) };
    ...
    inline DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder& setOriginalAmount(float originalAmount) { DARABONBA_PTR_SET_VALUE(originalAmount_, originalAmount) };
    ...
    inline DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder& setRuleIds(const vector<string> & ruleIds) { DARABONBA_PTR_SET_VALUE(ruleIds_, ruleIds) };
    inline DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder& setRuleIds(vector<string> && ruleIds) { DARABONBA_PTR_SET_RVALUE(ruleIds_, ruleIds) };
    ...
    inline DescribeConfigurationPriceResponseBodyDataCpuMemPriceOrder& setTradeAmount(float tradeAmount) { DARABONBA_PTR_SET_VALUE(tradeAmount_, tradeAmount) };
