...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSwimmingLaneResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeSwimmingLaneResponseBody::Data) };
    inline DescribeSwimmingLaneResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeSwimmingLaneResponseBody::Data) };
    inline DescribeSwimmingLaneResponseBody& setData(const DescribeSwimmingLaneResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSwimmingLaneResponseBody& setData(DescribeSwimmingLaneResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
