...
namespace Models
{
  ...
  public:
    ...
    inline const StopApplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopApplicationResponseBody) };
    inline StopApplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, StopApplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopApplicationResponseBody> body_ {};
  };
