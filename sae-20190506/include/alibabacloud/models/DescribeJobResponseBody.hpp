...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeJobResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeJobResponseBodyData) };
    inline DescribeJobResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeJobResponseBodyData) };
    inline DescribeJobResponseBody& setData(const DescribeJobResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeJobResponseBody& setData(DescribeJobResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeJobResponseBodyData> data_ = nullptr;
