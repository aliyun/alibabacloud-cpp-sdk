...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceLogsOutput & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeInstanceLogsOutput) };
    inline DescribeInstanceLogsOutput getData() { DARABONBA_PTR_GET(data_, DescribeInstanceLogsOutput) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceLogsOutput> data_ {};
