...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->average_ == nullptr
        && this->count_ == nullptr && this->maximum_ == nullptr && this->minimum_ == nullptr && this->sum_ == nullptr && this->timestamp_ == nullptr
        && this->value_ == nullptr; };
    // average Field Functions 
    bool hasAverage() const { return this->average_ != nullptr;};
    void deleteAverage() { this->average_ = nullptr;};
    inline float getAverage() const { DARABONBA_PTR_GET_DEFAULT(average_, 0.0) };
    ...
    inline float getMaximum() const { DARABONBA_PTR_GET_DEFAULT(maximum_, 0.0) };
    ...
    inline float getMinimum() const { DARABONBA_PTR_GET_DEFAULT(minimum_, 0.0) };
    ...
    inline float getSum() const { DARABONBA_PTR_GET_DEFAULT(sum_, 0.0) };
  ...
  protected:
    shared_ptr<float> average_ {};
    shared_ptr<float> count_ {};
    shared_ptr<float> maximum_ {};
    shared_ptr<float> minimum_ {};
    shared_ptr<float> sum_ {};
