...
#ifndef ALIBABACLOUD_MODELS_BUILDPIPELINERUNDEPLOYCONFIG_HPP_
#define ALIBABACLOUD_MODELS_BUILDPIPELINERUNDEPLOYCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const BuildPipelineRunDeployConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, BuildPipelineRunDeployConfig& obj) { 
    ...
    BuildPipelineRunDeployConfig() = default ;
    BuildPipelineRunDeployConfig(const BuildPipelineRunDeployConfig &) = default ;
    BuildPipelineRunDeployConfig(BuildPipelineRunDeployConfig &&) = default ;
    BuildPipelineRunDeployConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BuildPipelineRunDeployConfig() = default ;
    BuildPipelineRunDeployConfig& operator=(const BuildPipelineRunDeployConfig &) = default ;
    BuildPipelineRunDeployConfig& operator=(BuildPipelineRunDeployConfig &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->alwaysAllocateCPU_ == nullptr
        && return this->maximumInstanceCount_ == nullptr && return this->minimumInstanceCount_ == nullptr && return this->updateApplicationInput_ == nullptr && return this->updateTraffic_ == nullptr; };
    ...
    inline BuildPipelineRunDeployConfig& setAlwaysAllocateCPU(bool alwaysAllocateCPU) { DARABONBA_PTR_SET_VALUE(alwaysAllocateCPU_, alwaysAllocateCPU) };
    ...
    inline BuildPipelineRunDeployConfig& setMaximumInstanceCount(int32_t maximumInstanceCount) { DARABONBA_PTR_SET_VALUE(maximumInstanceCount_, maximumInstanceCount) };
    ...
    inline BuildPipelineRunDeployConfig& setMinimumInstanceCount(int32_t minimumInstanceCount) { DARABONBA_PTR_SET_VALUE(minimumInstanceCount_, minimumInstanceCount) };
    ...
    inline BuildPipelineRunDeployConfig& setUpdateApplicationInput(string updateApplicationInput) { DARABONBA_PTR_SET_VALUE(updateApplicationInput_, updateApplicationInput) };
    ...
    inline BuildPipelineRunDeployConfig& setUpdateTraffic(bool updateTraffic) { DARABONBA_PTR_SET_VALUE(updateTraffic_, updateTraffic) };
