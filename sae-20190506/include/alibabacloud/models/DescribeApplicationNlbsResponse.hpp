...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApplicationNlbsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeApplicationNlbsResponseBody) };
    inline DescribeApplicationNlbsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeApplicationNlbsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeApplicationNlbsResponseBody> body_ = nullptr;
  };
