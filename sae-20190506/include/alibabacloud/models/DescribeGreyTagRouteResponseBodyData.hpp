...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->albRules_ == nullptr
        && return this->appId_ == nullptr && return this->createTime_ == nullptr && return this->description_ == nullptr && return this->dubboRules_ == nullptr && return this->greyTagRouteId_ == nullptr
        && return this->name_ == nullptr && return this->scRules_ == nullptr && return this->updateTime_ == nullptr; };
