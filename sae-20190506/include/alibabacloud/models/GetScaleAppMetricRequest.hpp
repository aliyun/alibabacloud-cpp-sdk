...
#ifndef ALIBABACLOUD_MODELS_GETSCALEAPPMETRICREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETSCALEAPPMETRICREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetScaleAppMetricRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AppSource, appSource_);
      DARABONBA_PTR_TO_JSON(CpuStrategy, cpuStrategy_);
      DARABONBA_PTR_TO_JSON(Limit, limit_);
      DARABONBA_PTR_TO_JSON(RegionId, regionId_);
    };
    friend void from_json(const Darabonba::Json& j, GetScaleAppMetricRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AppSource, appSource_);
      DARABONBA_PTR_FROM_JSON(CpuStrategy, cpuStrategy_);
      DARABONBA_PTR_FROM_JSON(Limit, limit_);
      DARABONBA_PTR_FROM_JSON(RegionId, regionId_);
    };
    GetScaleAppMetricRequest() = default ;
    GetScaleAppMetricRequest(const GetScaleAppMetricRequest &) = default ;
    GetScaleAppMetricRequest(GetScaleAppMetricRequest &&) = default ;
    GetScaleAppMetricRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetScaleAppMetricRequest() = default ;
    GetScaleAppMetricRequest& operator=(const GetScaleAppMetricRequest &) = default ;
    GetScaleAppMetricRequest& operator=(GetScaleAppMetricRequest &&) = default ;
    ...
    inline GetScaleAppMetricRequest& setAppSource(string appSource) { DARABONBA_PTR_SET_VALUE(appSource_, appSource) };
    ...
    inline GetScaleAppMetricRequest& setCpuStrategy(string cpuStrategy) { DARABONBA_PTR_SET_VALUE(cpuStrategy_, cpuStrategy) };
    ...
    inline GetScaleAppMetricRequest& setLimit(int64_t limit) { DARABONBA_PTR_SET_VALUE(limit_, limit) };
    ...
    inline GetScaleAppMetricRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
