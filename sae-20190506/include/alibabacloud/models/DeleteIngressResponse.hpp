...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteIngressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteIngressResponseBody) };
    inline DeleteIngressResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteIngressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteIngressResponseBody> body_ {};
  };
