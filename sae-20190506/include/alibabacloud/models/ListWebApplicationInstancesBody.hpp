...
namespace Models
{
  ...
  public:
    ...
    inline const ListWebInstancesOutput & data() const { DARABONBA_PTR_GET_CONST(data_, ListWebInstancesOutput) };
    inline ListWebInstancesOutput data() { DARABONBA_PTR_GET(data_, ListWebInstancesOutput) };
  ...
  protected:
    ...
    std::shared_ptr<ListWebInstancesOutput> data_ = nullptr;
