...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->enableMicroRegistration_ == nullptr
        && return this->nameSpaceShortId_ == nullptr && return this->namespaceDescription_ == nullptr && return this->namespaceId_ == nullptr && return this->namespaceName_ == nullptr && return this->regionId_ == nullptr; };
