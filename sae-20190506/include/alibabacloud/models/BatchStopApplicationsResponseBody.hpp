...
namespace Models
{
  ...
  public:
    ...
    inline const BatchStopApplicationsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, BatchStopApplicationsResponseBodyData) };
    inline BatchStopApplicationsResponseBodyData data() { DARABONBA_PTR_GET(data_, BatchStopApplicationsResponseBodyData) };
    inline BatchStopApplicationsResponseBody& setData(const BatchStopApplicationsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BatchStopApplicationsResponseBody& setData(BatchStopApplicationsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<BatchStopApplicationsResponseBodyData> data_ = nullptr;
