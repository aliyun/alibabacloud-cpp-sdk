...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSecretResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateSecretResponseBody) };
    inline UpdateSecretResponseBody body() { DARABONBA_PTR_GET(body_, UpdateSecretResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateSecretResponseBody> body_ = nullptr;
  };
