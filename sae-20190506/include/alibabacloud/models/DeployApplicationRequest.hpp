...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acrAssumeRoleArn_ == nullptr
        ...
        && return this->sidecarContainersConfig_ == nullptr && return this->slsConfigs_ == nullptr && return this->startupProbe_ == nullptr && return this->swimlanePvtzDiscoverySvc_ == nullptr && return this->terminationGracePeriodSeconds_ == nullptr
