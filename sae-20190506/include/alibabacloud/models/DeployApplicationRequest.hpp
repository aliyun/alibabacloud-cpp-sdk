...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acrAssumeRoleArn_ == nullptr
        ...
        && return this->html_ == nullptr && return this->imagePullSecrets_ == nullptr && return this->imageUrl_ == nullptr && return this->initContainersConfig_ == nullptr && return this->jarStartArgs_ == nullptr
