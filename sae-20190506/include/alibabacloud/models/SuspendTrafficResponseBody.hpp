...
namespace Models
{
  ...
  public:
    ...
    inline const SuspendTrafficResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SuspendTrafficResponseBodyData) };
    inline SuspendTrafficResponseBodyData data() { DARABONBA_PTR_GET(data_, SuspendTrafficResponseBodyData) };
    inline SuspendTrafficResponseBody& setData(const SuspendTrafficResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SuspendTrafficResponseBody& setData(SuspendTrafficResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SuspendTrafficResponseBodyData> data_ = nullptr;
