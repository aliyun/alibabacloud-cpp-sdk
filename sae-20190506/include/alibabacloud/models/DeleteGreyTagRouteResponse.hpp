...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteGreyTagRouteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteGreyTagRouteResponseBody) };
    inline DeleteGreyTagRouteResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteGreyTagRouteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteGreyTagRouteResponseBody> body_ {};
  };
