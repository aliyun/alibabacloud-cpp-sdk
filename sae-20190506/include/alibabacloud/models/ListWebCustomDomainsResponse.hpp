...
namespace Models
{
  ...
  public:
    ...
    inline const ListWebCustomDomainBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListWebCustomDomainBody) };
    inline ListWebCustomDomainBody getBody() { DARABONBA_PTR_GET(body_, ListWebCustomDomainBody) };
  ...
  protected:
    ...
    shared_ptr<ListWebCustomDomainBody> body_ {};
  };
