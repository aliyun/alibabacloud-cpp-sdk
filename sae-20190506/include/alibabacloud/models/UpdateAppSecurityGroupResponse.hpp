...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAppSecurityGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAppSecurityGroupResponseBody) };
    inline UpdateAppSecurityGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAppSecurityGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAppSecurityGroupResponseBody> body_ {};
  };
