...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicationID_ == nullptr
        && this->cpuPercent_ == nullptr && this->cpuQuotaPercent_ == nullptr && this->instanceID_ == nullptr && this->memoryLimitMB_ == nullptr && this->memoryUsageMB_ == nullptr
    ...
    inline float getCpuPercent() const { DARABONBA_PTR_GET_DEFAULT(cpuPercent_, 0.0) };
    ...
    inline float getCpuQuotaPercent() const { DARABONBA_PTR_GET_DEFAULT(cpuQuotaPercent_, 0.0) };
    ...
    inline float getMemoryLimitMB() const { DARABONBA_PTR_GET_DEFAULT(memoryLimitMB_, 0.0) };
    ...
    inline float getMemoryUsageMB() const { DARABONBA_PTR_GET_DEFAULT(memoryUsageMB_, 0.0) };
  ...
  protected:
    ...
    shared_ptr<float> cpuPercent_ {};
    shared_ptr<float> cpuQuotaPercent_ {};
    shared_ptr<string> instanceID_ {};
    shared_ptr<float> memoryLimitMB_ {};
    shared_ptr<float> memoryUsageMB_ {};
