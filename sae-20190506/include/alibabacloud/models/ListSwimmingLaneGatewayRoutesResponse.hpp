...
namespace Models
{
  ...
  public:
    ...
    inline const ListSwimmingLaneGatewayRoutesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSwimmingLaneGatewayRoutesResponseBody) };
    inline ListSwimmingLaneGatewayRoutesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSwimmingLaneGatewayRoutesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSwimmingLaneGatewayRoutesResponseBody> body_ {};
  };
