...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const map<string, string> & getSecretData() const { DARABONBA_PTR_GET_CONST(secretData_, map<string, string>) };
      inline map<string, string> getSecretData() { DARABONBA_PTR_GET(secretData_, map<string, string>) };
      inline Data& setSecretData(const map<string, string> & secretData) { DARABONBA_PTR_SET_VALUE(secretData_, secretData) };
      inline Data& setSecretData(map<string, string> && secretData) { DARABONBA_PTR_SET_RVALUE(secretData_, secretData) };
      ...
      inline Data& setSecretName(string secretName) { DARABONBA_PTR_SET_VALUE(secretName_, secretName) };
      ...
      inline Data& setSecretType(string secretType) { DARABONBA_PTR_SET_VALUE(secretType_, secretType) };
    ...
    protected:
      ...
      shared_ptr<map<string, string>> secretData_ {};
    ...
    inline const DescribeSecretResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeSecretResponseBody::Data) };
    inline DescribeSecretResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeSecretResponseBody::Data) };
    inline DescribeSecretResponseBody& setData(const DescribeSecretResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSecretResponseBody& setData(DescribeSecretResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The response.
    shared_ptr<DescribeSecretResponseBody::Data> data_ {};
