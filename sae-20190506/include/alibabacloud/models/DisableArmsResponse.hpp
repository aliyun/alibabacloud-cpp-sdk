...
namespace Models
{
  ...
  public:
    ...
    inline const DisableArmsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableArmsResponseBody) };
    inline DisableArmsResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableArmsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableArmsResponseBody> body_ {};
  };
