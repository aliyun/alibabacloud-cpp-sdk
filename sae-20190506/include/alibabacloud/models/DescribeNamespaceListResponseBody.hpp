...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeNamespaceListResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeNamespaceListResponseBodyData>) };
    inline vector<DescribeNamespaceListResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeNamespaceListResponseBodyData>) };
    inline DescribeNamespaceListResponseBody& setData(const vector<DescribeNamespaceListResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeNamespaceListResponseBody& setData(vector<DescribeNamespaceListResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeNamespaceListResponseBodyData>> data_ = nullptr;
