...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const VPCConfig& obj) { 
      DARABONBA_PTR_TO_JSON(anytunnelViaENI, anytunnelViaENI_);
    ...
    friend void from_json(const Darabonba::Json& j, VPCConfig& obj) { 
      DARABONBA_PTR_FROM_JSON(anytunnelViaENI, anytunnelViaENI_);
    ...
    virtual bool empty() const override { return this->anytunnelViaENI_ == nullptr
        && return this->role_ == nullptr && return this->securityGroupId_ == nullptr && return this->vSwitchIds_ == nullptr && return this->vpcId_ == nullptr; };
    // anytunnelViaENI Field Functions 
    bool hasAnytunnelViaENI() const { return this->anytunnelViaENI_ != nullptr;};
    void deleteAnytunnelViaENI() { this->anytunnelViaENI_ = nullptr;};
    inline bool anytunnelViaENI() const { DARABONBA_PTR_GET_DEFAULT(anytunnelViaENI_, false) };
    inline VPCConfig& setAnytunnelViaENI(bool anytunnelViaENI) { DARABONBA_PTR_SET_VALUE(anytunnelViaENI_, anytunnelViaENI) };
  ...
  protected:
    std::shared_ptr<bool> anytunnelViaENI_ = nullptr;
