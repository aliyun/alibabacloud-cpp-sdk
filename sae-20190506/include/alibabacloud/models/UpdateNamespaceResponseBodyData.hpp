...
#ifndef ALIBABACLOUD_MODELS_UPDATENAMESPACERESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_UPDATENAMESPACERESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateNamespaceResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateNamespaceResponseBodyData& obj) { 
    ...
    UpdateNamespaceResponseBodyData() = default ;
    UpdateNamespaceResponseBodyData(const UpdateNamespaceResponseBodyData &) = default ;
    UpdateNamespaceResponseBodyData(UpdateNamespaceResponseBodyData &&) = default ;
    UpdateNamespaceResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateNamespaceResponseBodyData() = default ;
    UpdateNamespaceResponseBodyData& operator=(const UpdateNamespaceResponseBodyData &) = default ;
    UpdateNamespaceResponseBodyData& operator=(UpdateNamespaceResponseBodyData &&) = default ;
    ...
    inline UpdateNamespaceResponseBodyData& setEnableMicroRegistration(bool enableMicroRegistration) { DARABONBA_PTR_SET_VALUE(enableMicroRegistration_, enableMicroRegistration) };
    ...
    inline UpdateNamespaceResponseBodyData& setNameSpaceShortId(string nameSpaceShortId) { DARABONBA_PTR_SET_VALUE(nameSpaceShortId_, nameSpaceShortId) };
    ...
    inline UpdateNamespaceResponseBodyData& setNamespaceDescription(string namespaceDescription) { DARABONBA_PTR_SET_VALUE(namespaceDescription_, namespaceDescription) };
    ...
    inline UpdateNamespaceResponseBodyData& setNamespaceId(string namespaceId) { DARABONBA_PTR_SET_VALUE(namespaceId_, namespaceId) };
    ...
    inline UpdateNamespaceResponseBodyData& setNamespaceName(string namespaceName) { DARABONBA_PTR_SET_VALUE(namespaceName_, namespaceName) };
    ...
    inline UpdateNamespaceResponseBodyData& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
