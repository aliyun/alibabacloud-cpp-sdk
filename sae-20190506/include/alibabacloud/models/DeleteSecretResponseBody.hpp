...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSecretResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteSecretResponseBody::Data) };
    inline DeleteSecretResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteSecretResponseBody::Data) };
    inline DeleteSecretResponseBody& setData(const DeleteSecretResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteSecretResponseBody& setData(DeleteSecretResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The response.
    shared_ptr<DeleteSecretResponseBody::Data> data_ {};
