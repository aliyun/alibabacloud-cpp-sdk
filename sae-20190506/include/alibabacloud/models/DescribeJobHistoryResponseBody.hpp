...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeJobHistoryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeJobHistoryResponseBodyData) };
    inline DescribeJobHistoryResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeJobHistoryResponseBodyData) };
    inline DescribeJobHistoryResponseBody& setData(const DescribeJobHistoryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeJobHistoryResponseBody& setData(DescribeJobHistoryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<DescribeJobHistoryResponseBodyData> data_ = nullptr;
