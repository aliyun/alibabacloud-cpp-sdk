...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApplicationGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApplicationGroupsResponseBody) };
    inline DescribeApplicationGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApplicationGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApplicationGroupsResponseBody> body_ {};
  };
