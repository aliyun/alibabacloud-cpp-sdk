...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeConfigMapResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeConfigMapResponseBodyData) };
    inline DescribeConfigMapResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeConfigMapResponseBodyData) };
    inline DescribeConfigMapResponseBody& setData(const DescribeConfigMapResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeConfigMapResponseBody& setData(DescribeConfigMapResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<DescribeConfigMapResponseBodyData> data_ = nullptr;
