...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->length_ == nullptr
        && this->sort_ == nullptr && this->statics_ == nullptr; };
    ...
    inline const vector<StaticsInfo> & getStatics() const { DARABONBA_PTR_GET_CONST(statics_, vector<StaticsInfo>) };
    inline vector<StaticsInfo> getStatics() { DARABONBA_PTR_GET(statics_, vector<StaticsInfo>) };
  ...
  protected:
    ...
    shared_ptr<vector<StaticsInfo>> statics_ {};
  };
