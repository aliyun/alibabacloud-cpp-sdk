...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApplicationScalingRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApplicationScalingRulesResponseBody) };
    inline DescribeApplicationScalingRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApplicationScalingRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApplicationScalingRulesResponseBody> body_ {};
  };
