...
namespace Models
{
  ...
  public:
    ...
    inline const map<string, vector<MetricInfo>> & getMetrics() const { DARABONBA_PTR_GET_CONST(metrics_, map<string, vector<MetricInfo>>) };
    inline map<string, vector<MetricInfo>> getMetrics() { DARABONBA_PTR_GET(metrics_, map<string, vector<MetricInfo>>) };
  ...
  protected:
    ...
    shared_ptr<map<string, vector<MetricInfo>>> metrics_ {};
  };
