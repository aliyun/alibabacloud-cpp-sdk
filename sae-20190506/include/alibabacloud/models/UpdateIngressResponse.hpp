...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateIngressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateIngressResponseBody) };
    inline UpdateIngressResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateIngressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateIngressResponseBody> body_ {};
  };
