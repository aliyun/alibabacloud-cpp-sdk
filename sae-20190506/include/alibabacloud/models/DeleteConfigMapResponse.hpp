...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteConfigMapResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteConfigMapResponseBody) };
    inline DeleteConfigMapResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteConfigMapResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteConfigMapResponseBody> body_ {};
  };
