...
namespace Models
{
  ...
  public:
    ...
    inline const ListGreyTagRouteResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListGreyTagRouteResponseBodyData) };
    inline ListGreyTagRouteResponseBodyData data() { DARABONBA_PTR_GET(data_, ListGreyTagRouteResponseBodyData) };
    inline ListGreyTagRouteResponseBody& setData(const ListGreyTagRouteResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGreyTagRouteResponseBody& setData(ListGreyTagRouteResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListGreyTagRouteResponseBodyData> data_ = nullptr;
