...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->containers_ == nullptr
        && this->description_ == nullptr && this->enableArmsMetrics_ == nullptr && this->takeEffect_ == nullptr; };
    ...
    inline const vector<Container> & getContainers() const { DARABONBA_PTR_GET_CONST(containers_, vector<Container>) };
    inline vector<Container> getContainers() { DARABONBA_PTR_GET(containers_, vector<Container>) };
    ...
    inline bool getEnableArmsMetrics() const { DARABONBA_PTR_GET_DEFAULT(enableArmsMetrics_, false) };
    ...
    inline bool getTakeEffect() const { DARABONBA_PTR_GET_DEFAULT(takeEffect_, false) };
