...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApplicationStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApplicationStatusResponseBody) };
    inline DescribeApplicationStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApplicationStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApplicationStatusResponseBody> body_ {};
  };
