...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->defaultForwardingAppName_ == nullptr
        && return this->domainName_ == nullptr && return this->protocol_ == nullptr && return this->routeConfig_ == nullptr && return this->webCertConfig_ == nullptr && return this->webTLSConfig_ == nullptr
        && return this->webWAFConfig_ == nullptr; };
