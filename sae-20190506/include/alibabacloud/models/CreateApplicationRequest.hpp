...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acrAssumeRoleArn_ == nullptr
        ...
        && this->pvtzDiscoverySvc_ == nullptr && this->python_ == nullptr && this->pythonModules_ == nullptr && this->raspConfig_ == nullptr && this->readiness_ == nullptr
    ...
    inline const CreateApplicationRequest::RaspConfig & getRaspConfig() const { DARABONBA_PTR_GET_CONST(raspConfig_, CreateApplicationRequest::RaspConfig) };
    inline CreateApplicationRequest::RaspConfig getRaspConfig() { DARABONBA_PTR_GET(raspConfig_, CreateApplicationRequest::RaspConfig) };
    inline CreateApplicationRequest& setRaspConfig(const CreateApplicationRequest::RaspConfig & raspConfig) { DARABONBA_PTR_SET_VALUE(raspConfig_, raspConfig) };
    inline CreateApplicationRequest& setRaspConfig(CreateApplicationRequest::RaspConfig && raspConfig) { DARABONBA_PTR_SET_RVALUE(raspConfig_, raspConfig) };
  ...
  protected:
    ...
    shared_ptr<CreateApplicationRequest::RaspConfig> raspConfig_ {};
