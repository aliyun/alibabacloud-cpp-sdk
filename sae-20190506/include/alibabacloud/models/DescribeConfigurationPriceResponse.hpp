...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeConfigurationPriceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeConfigurationPriceResponseBody) };
    inline DescribeConfigurationPriceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeConfigurationPriceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeConfigurationPriceResponseBody> body_ {};
  };
