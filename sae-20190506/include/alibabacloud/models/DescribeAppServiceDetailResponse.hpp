...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAppServiceDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAppServiceDetailResponseBody) };
    inline DescribeAppServiceDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAppServiceDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAppServiceDetailResponseBody> body_ {};
  };
