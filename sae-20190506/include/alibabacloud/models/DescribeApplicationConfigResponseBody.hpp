...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApplicationConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeApplicationConfigResponseBodyData) };
    inline DescribeApplicationConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeApplicationConfigResponseBodyData) };
    inline DescribeApplicationConfigResponseBody& setData(const DescribeApplicationConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeApplicationConfigResponseBody& setData(DescribeApplicationConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeApplicationConfigResponseBodyData> data_ = nullptr;
