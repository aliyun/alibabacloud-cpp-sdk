...
namespace Models
{
  ...
  public:
    ...
    inline const UnbindNlbResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UnbindNlbResponseBodyData) };
    inline UnbindNlbResponseBodyData data() { DARABONBA_PTR_GET(data_, UnbindNlbResponseBodyData) };
    inline UnbindNlbResponseBody& setData(const UnbindNlbResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UnbindNlbResponseBody& setData(UnbindNlbResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<UnbindNlbResponseBodyData> data_ = nullptr;
