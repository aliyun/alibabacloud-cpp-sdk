...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEKNOWLEDGEBASEUPLOADSIGNATURERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEKNOWLEDGEBASEUPLOADSIGNATURERESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeKnowledgeBaseUploadSignatureResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeKnowledgeBaseUploadSignatureResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeKnowledgeBaseUploadSignatureResponseBody& obj) { 
    ...
    DescribeKnowledgeBaseUploadSignatureResponseBody() = default ;
    DescribeKnowledgeBaseUploadSignatureResponseBody(const DescribeKnowledgeBaseUploadSignatureResponseBody &) = default ;
    DescribeKnowledgeBaseUploadSignatureResponseBody(DescribeKnowledgeBaseUploadSignatureResponseBody &&) = default ;
    DescribeKnowledgeBaseUploadSignatureResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeKnowledgeBaseUploadSignatureResponseBody() = default ;
    DescribeKnowledgeBaseUploadSignatureResponseBody& operator=(const DescribeKnowledgeBaseUploadSignatureResponseBody &) = default ;
    DescribeKnowledgeBaseUploadSignatureResponseBody& operator=(DescribeKnowledgeBaseUploadSignatureResponseBody &&) = default ;
    ...
    inline const DescribeKnowledgeBaseUploadSignatureResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeKnowledgeBaseUploadSignatureResponseBody::Data) };
    inline DescribeKnowledgeBaseUploadSignatureResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeKnowledgeBaseUploadSignatureResponseBody::Data) };
    inline DescribeKnowledgeBaseUploadSignatureResponseBody& setData(const DescribeKnowledgeBaseUploadSignatureResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeKnowledgeBaseUploadSignatureResponseBody& setData(DescribeKnowledgeBaseUploadSignatureResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeKnowledgeBaseUploadSignatureResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline DescribeKnowledgeBaseUploadSignatureResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline DescribeKnowledgeBaseUploadSignatureResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeKnowledgeBaseUploadSignatureResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
