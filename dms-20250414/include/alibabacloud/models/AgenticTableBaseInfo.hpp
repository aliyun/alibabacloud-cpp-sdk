...
#ifndef ALIBABACLOUD_MODELS_AGENTICTABLEBASEINFO_HPP_
#define ALIBABACLOUD_MODELS_AGENTICTABLEBASEINFO_HPP_
...
namespace Models
{
  class AgenticTableBaseInfo : public Darabonba::Model {
  public:
    ...
    AgenticTableBaseInfo(AgenticTableBaseInfo &&) = default ;
    AgenticTableBaseInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AgenticTableBaseInfo() = default ;
    AgenticTableBaseInfo& operator=(const AgenticTableBaseInfo &) = default ;
    AgenticTableBaseInfo& operator=(AgenticTableBaseInfo &&) = default ;
    ...
    inline AgenticTableBaseInfo& setDatabaseUuid(string databaseUuid) { DARABONBA_PTR_SET_VALUE(databaseUuid_, databaseUuid) };
    ...
    inline AgenticTableBaseInfo& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline const AgenticTableEngineMeta & getEngineMeta() const { DARABONBA_PTR_GET_CONST(engineMeta_, AgenticTableEngineMeta) };
    inline AgenticTableEngineMeta getEngineMeta() { DARABONBA_PTR_GET(engineMeta_, AgenticTableEngineMeta) };
    inline AgenticTableBaseInfo& setEngineMeta(const AgenticTableEngineMeta & engineMeta) { DARABONBA_PTR_SET_VALUE(engineMeta_, engineMeta) };
    inline AgenticTableBaseInfo& setEngineMeta(AgenticTableEngineMeta && engineMeta) { DARABONBA_PTR_SET_RVALUE(engineMeta_, engineMeta) };
    ...
    inline AgenticTableBaseInfo& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline AgenticTableBaseInfo& setQualifiedName(string qualifiedName) { DARABONBA_PTR_SET_VALUE(qualifiedName_, qualifiedName) };
