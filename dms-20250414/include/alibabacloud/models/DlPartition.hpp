...
namespace Models
{
  ...
  public:
    ...
    inline const DLStorageDescriptor & getSd() const { DARABONBA_PTR_GET_CONST(sd_, DLStorageDescriptor) };
    inline DLStorageDescriptor getSd() { DARABONBA_PTR_GET(sd_, DLStorageDescriptor) };
