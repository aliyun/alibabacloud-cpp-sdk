...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->airflowId_ == nullptr
        && this->airflowName_ == nullptr && this->appSpec_ == nullptr && this->clientToken_ == nullptr && this->dagsDir_ == nullptr && this->dataMountInfoList_ == nullptr
    ...
    inline UpdateAirflowRequest& setDataMountInfoList(const vector<DataMountInfo> & dataMountInfoList) { DARABONBA_PTR_SET_VALUE(dataMountInfoList_, dataMountInfoList) };
    inline UpdateAirflowRequest& setDataMountInfoList(vector<DataMountInfo> && dataMountInfoList) { DARABONBA_PTR_SET_RVALUE(dataMountInfoList_, dataMountInfoList) };
    ...
    inline UpdateAirflowRequest& setEnableServerless(bool enableServerless) { DARABONBA_PTR_SET_VALUE(enableServerless_, enableServerless) };
    ...
    inline UpdateAirflowRequest& setGracefulShutdownTimeout(int32_t gracefulShutdownTimeout) { DARABONBA_PTR_SET_VALUE(gracefulShutdownTimeout_, gracefulShutdownTimeout) };
