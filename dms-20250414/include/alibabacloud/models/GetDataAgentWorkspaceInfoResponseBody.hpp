...
#ifndef ALIBABACLOUD_MODELS_GETDATAAGENTWORKSPACEINFORESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETDATAAGENTWORKSPACEINFORESPONSEBODY_HPP_
...
namespace Models
{
  class GetDataAgentWorkspaceInfoResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetDataAgentWorkspaceInfoResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetDataAgentWorkspaceInfoResponseBody& obj) { 
    ...
    GetDataAgentWorkspaceInfoResponseBody() = default ;
    GetDataAgentWorkspaceInfoResponseBody(const GetDataAgentWorkspaceInfoResponseBody &) = default ;
    GetDataAgentWorkspaceInfoResponseBody(GetDataAgentWorkspaceInfoResponseBody &&) = default ;
    GetDataAgentWorkspaceInfoResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDataAgentWorkspaceInfoResponseBody() = default ;
    GetDataAgentWorkspaceInfoResponseBody& operator=(const GetDataAgentWorkspaceInfoResponseBody &) = default ;
    GetDataAgentWorkspaceInfoResponseBody& operator=(GetDataAgentWorkspaceInfoResponseBody &&) = default ;
    ...
    inline const GetDataAgentWorkspaceInfoResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetDataAgentWorkspaceInfoResponseBody::Data) };
    inline GetDataAgentWorkspaceInfoResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetDataAgentWorkspaceInfoResponseBody::Data) };
    inline GetDataAgentWorkspaceInfoResponseBody& setData(const GetDataAgentWorkspaceInfoResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDataAgentWorkspaceInfoResponseBody& setData(GetDataAgentWorkspaceInfoResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetDataAgentWorkspaceInfoResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline GetDataAgentWorkspaceInfoResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline GetDataAgentWorkspaceInfoResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetDataAgentWorkspaceInfoResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<GetDataAgentWorkspaceInfoResponseBody::Data> data_ {};
