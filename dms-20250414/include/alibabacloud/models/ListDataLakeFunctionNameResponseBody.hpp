...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getFunctionNameList() const { DARABONBA_PTR_GET_CONST(functionNameList_, vector<string>) };
    inline vector<string> getFunctionNameList() { DARABONBA_PTR_GET(functionNameList_, vector<string>) };
