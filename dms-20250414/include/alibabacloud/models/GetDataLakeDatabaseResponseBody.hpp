...
namespace Models
{
  ...
  public:
    ...
    inline const DLDatabase & getDatabase() const { DARABONBA_PTR_GET_CONST(database_, DLDatabase) };
    inline DLDatabase getDatabase() { DARABONBA_PTR_GET(database_, DLDatabase) };
  ...
  protected:
    shared_ptr<DLDatabase> database_ {};
