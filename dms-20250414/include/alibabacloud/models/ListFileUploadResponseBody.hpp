...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListFileUploadResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListFileUploadResponseBodyData>) };
    inline vector<ListFileUploadResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListFileUploadResponseBodyData>) };
    inline ListFileUploadResponseBody& setData(const vector<ListFileUploadResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListFileUploadResponseBody& setData(vector<ListFileUploadResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<ListFileUploadResponseBodyData>> data_ = nullptr;
