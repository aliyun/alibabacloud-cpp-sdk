...
#ifndef ALIBABACLOUD_MODELS_UPDATEONEMETAOSSIEMODELREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEONEMETAOSSIEMODELREQUEST_HPP_
...
namespace Models
{
  class UpdateOneMetaOssieModelRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateOneMetaOssieModelRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateOneMetaOssieModelRequest& obj) { 
    ...
    UpdateOneMetaOssieModelRequest() = default ;
    UpdateOneMetaOssieModelRequest(const UpdateOneMetaOssieModelRequest &) = default ;
    UpdateOneMetaOssieModelRequest(UpdateOneMetaOssieModelRequest &&) = default ;
    UpdateOneMetaOssieModelRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateOneMetaOssieModelRequest() = default ;
    UpdateOneMetaOssieModelRequest& operator=(const UpdateOneMetaOssieModelRequest &) = default ;
    UpdateOneMetaOssieModelRequest& operator=(UpdateOneMetaOssieModelRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->catalogUuid_ == nullptr
        && this->databaseUuid_ == nullptr && this->description_ == nullptr && this->docFormat_ == nullptr && this->document_ == nullptr && this->knowledgeUuid_ == nullptr
    ...
    inline UpdateOneMetaOssieModelRequest& setCatalogUuid(string catalogUuid) { DARABONBA_PTR_SET_VALUE(catalogUuid_, catalogUuid) };
    ...
    inline UpdateOneMetaOssieModelRequest& setDatabaseUuid(string databaseUuid) { DARABONBA_PTR_SET_VALUE(databaseUuid_, databaseUuid) };
    ...
    inline UpdateOneMetaOssieModelRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline UpdateOneMetaOssieModelRequest& setDocFormat(string docFormat) { DARABONBA_PTR_SET_VALUE(docFormat_, docFormat) };
    ...
    inline UpdateOneMetaOssieModelRequest& setDocument(string document) { DARABONBA_PTR_SET_VALUE(document_, document) };
    ...
    inline UpdateOneMetaOssieModelRequest& setKnowledgeUuid(string knowledgeUuid) { DARABONBA_PTR_SET_VALUE(knowledgeUuid_, knowledgeUuid) };
    ...
    inline UpdateOneMetaOssieModelRequest& setTag(string tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    ...
    inline UpdateOneMetaOssieModelRequest& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
