...
namespace Models
{
  ...
  public:
    ...
    inline CreateDataAgentSessionResponseBodyDataSessionConfig& setMcpServerIds(const vector<string> & mcpServerIds) { DARABONBA_PTR_SET_VALUE(mcpServerIds_, mcpServerIds) };
    inline CreateDataAgentSessionResponseBodyDataSessionConfig& setMcpServerIds(vector<string> && mcpServerIds) { DARABONBA_PTR_SET_RVALUE(mcpServerIds_, mcpServerIds) };
