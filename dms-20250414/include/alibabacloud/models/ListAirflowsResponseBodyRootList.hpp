...
#ifndef ALIBABACLOUD_MODELS_LISTAIRFLOWSRESPONSEBODYROOTLIST_HPP_
#define ALIBABACLOUD_MODELS_LISTAIRFLOWSRESPONSEBODYROOTLIST_HPP_
...
namespace Models
{
  class ListAirflowsResponseBodyRootList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListAirflowsResponseBodyRootList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListAirflowsResponseBodyRootList& obj) { 
    ...
    ListAirflowsResponseBodyRootList() = default ;
    ListAirflowsResponseBodyRootList(const ListAirflowsResponseBodyRootList &) = default ;
    ListAirflowsResponseBodyRootList(ListAirflowsResponseBodyRootList &&) = default ;
    ListAirflowsResponseBodyRootList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAirflowsResponseBodyRootList() = default ;
    ListAirflowsResponseBodyRootList& operator=(const ListAirflowsResponseBodyRootList &) = default ;
    ListAirflowsResponseBodyRootList& operator=(ListAirflowsResponseBodyRootList &&) = default ;
    ...
    inline ListAirflowsResponseBodyRootList& setAirflowId(string airflowId) { DARABONBA_PTR_SET_VALUE(airflowId_, airflowId) };
    ...
    inline ListAirflowsResponseBodyRootList& setAirflowName(string airflowName) { DARABONBA_PTR_SET_VALUE(airflowName_, airflowName) };
    ...
    inline ListAirflowsResponseBodyRootList& setAppSpec(string appSpec) { DARABONBA_PTR_SET_VALUE(appSpec_, appSpec) };
    ...
    inline ListAirflowsResponseBodyRootList& setAppType(string appType) { DARABONBA_PTR_SET_VALUE(appType_, appType) };
    ...
    inline ListAirflowsResponseBodyRootList& setCustomAirflowCfg(const vector<string> & customAirflowCfg) { DARABONBA_PTR_SET_VALUE(customAirflowCfg_, customAirflowCfg) };
    inline ListAirflowsResponseBodyRootList& setCustomAirflowCfg(vector<string> && customAirflowCfg) { DARABONBA_PTR_SET_RVALUE(customAirflowCfg_, customAirflowCfg) };
    ...
    inline ListAirflowsResponseBodyRootList& setDagsDir(string dagsDir) { DARABONBA_PTR_SET_VALUE(dagsDir_, dagsDir) };
    ...
    inline ListAirflowsResponseBodyRootList& setDeployErrorMsg(string deployErrorMsg) { DARABONBA_PTR_SET_VALUE(deployErrorMsg_, deployErrorMsg) };
    ...
    inline ListAirflowsResponseBodyRootList& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListAirflowsResponseBodyRootList& setGmtCreated(string gmtCreated) { DARABONBA_PTR_SET_VALUE(gmtCreated_, gmtCreated) };
    ...
    inline ListAirflowsResponseBodyRootList& setOssBucketName(string ossBucketName) { DARABONBA_PTR_SET_VALUE(ossBucketName_, ossBucketName) };
    ...
    inline ListAirflowsResponseBodyRootList& setOssPath(string ossPath) { DARABONBA_PTR_SET_VALUE(ossPath_, ossPath) };
    ...
    inline ListAirflowsResponseBodyRootList& setPluginsDir(string pluginsDir) { DARABONBA_PTR_SET_VALUE(pluginsDir_, pluginsDir) };
    ...
    inline ListAirflowsResponseBodyRootList& setRequirementFile(string requirementFile) { DARABONBA_PTR_SET_VALUE(requirementFile_, requirementFile) };
    ...
    inline ListAirflowsResponseBodyRootList& setSecurityGroupId(string securityGroupId) { DARABONBA_PTR_SET_VALUE(securityGroupId_, securityGroupId) };
    ...
    inline ListAirflowsResponseBodyRootList& setStartupFile(string startupFile) { DARABONBA_PTR_SET_VALUE(startupFile_, startupFile) };
    ...
    inline ListAirflowsResponseBodyRootList& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ListAirflowsResponseBodyRootList& setVSwitchId(string vSwitchId) { DARABONBA_PTR_SET_VALUE(vSwitchId_, vSwitchId) };
    ...
    inline ListAirflowsResponseBodyRootList& setVpcId(string vpcId) { DARABONBA_PTR_SET_VALUE(vpcId_, vpcId) };
    ...
    inline ListAirflowsResponseBodyRootList& setWorkerServerlessReplicas(int32_t workerServerlessReplicas) { DARABONBA_PTR_SET_VALUE(workerServerlessReplicas_, workerServerlessReplicas) };
    ...
    inline ListAirflowsResponseBodyRootList& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
    ...
    inline ListAirflowsResponseBodyRootList& setZoneId(string zoneId) { DARABONBA_PTR_SET_VALUE(zoneId_, zoneId) };
