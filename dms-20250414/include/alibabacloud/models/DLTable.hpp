...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->catalogName_ == nullptr
        ...
        && this->ownerType_ == nullptr && this->parameters_ == nullptr && this->partitionKeys_ == nullptr && this->retention_ == nullptr && this->storageDescriptor_ == nullptr
        && this->tableType_ == nullptr && this->viewExpandedText_ == nullptr && this->viewOriginalText_ == nullptr; };
    ...
    inline int32_t getLastAccessTime() const { DARABONBA_PTR_GET_DEFAULT(lastAccessTime_, 0) };
    ...
    inline const vector<DLColumn> & getPartitionKeys() const { DARABONBA_PTR_GET_CONST(partitionKeys_, vector<DLColumn>) };
    inline vector<DLColumn> getPartitionKeys() { DARABONBA_PTR_GET(partitionKeys_, vector<DLColumn>) };
    ...
    inline const DLStorageDescriptor & getStorageDescriptor() const { DARABONBA_PTR_GET_CONST(storageDescriptor_, DLStorageDescriptor) };
    inline DLStorageDescriptor getStorageDescriptor() { DARABONBA_PTR_GET(storageDescriptor_, DLStorageDescriptor) };
    ...
    inline string getViewExpandedText() const { DARABONBA_PTR_GET_DEFAULT(viewExpandedText_, "") };
    ...
    inline string getViewOriginalText() const { DARABONBA_PTR_GET_DEFAULT(viewOriginalText_, "") };
