...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getPartNames() const { DARABONBA_PTR_GET_CONST(partNames_, vector<string>) };
    inline vector<string> getPartNames() { DARABONBA_PTR_GET(partNames_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> partNames_ {};
    // This parameter is required.
