...
#ifndef ALIBABACLOUD_MODELS_CONFIGAIRFLOWRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CONFIGAIRFLOWRESPONSEBODY_HPP_
...
namespace Models
{
  class ConfigAirflowResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ConfigAirflowResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ConfigAirflowResponseBody& obj) { 
    ...
    ConfigAirflowResponseBody() = default ;
    ConfigAirflowResponseBody(const ConfigAirflowResponseBody &) = default ;
    ConfigAirflowResponseBody(ConfigAirflowResponseBody &&) = default ;
    ConfigAirflowResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ConfigAirflowResponseBody() = default ;
    ConfigAirflowResponseBody& operator=(const ConfigAirflowResponseBody &) = default ;
    ConfigAirflowResponseBody& operator=(ConfigAirflowResponseBody &&) = default ;
    ...
    public:
      ...
      inline Root& setCustomAirflowCfg(const vector<string> & customAirflowCfg) { DARABONBA_PTR_SET_VALUE(customAirflowCfg_, customAirflowCfg) };
      inline Root& setCustomAirflowCfg(vector<string> && customAirflowCfg) { DARABONBA_PTR_SET_RVALUE(customAirflowCfg_, customAirflowCfg) };
    ...
    inline ConfigAirflowResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ConfigAirflowResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline ConfigAirflowResponseBody& setHttpStatusCode(int64_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ConfigAirflowResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ConfigAirflowResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // root Field Functions 
    bool hasRoot() const { return this->root_ != nullptr;};
    void deleteRoot() { this->root_ = nullptr;};
    inline const ConfigAirflowResponseBody::Root & getRoot() const { DARABONBA_PTR_GET_CONST(root_, ConfigAirflowResponseBody::Root) };
    inline ConfigAirflowResponseBody::Root getRoot() { DARABONBA_PTR_GET(root_, ConfigAirflowResponseBody::Root) };
    inline ConfigAirflowResponseBody& setRoot(const ConfigAirflowResponseBody::Root & root) { DARABONBA_PTR_SET_VALUE(root_, root) };
    inline ConfigAirflowResponseBody& setRoot(ConfigAirflowResponseBody::Root && root) { DARABONBA_PTR_SET_RVALUE(root_, root) };
    ...
    inline ConfigAirflowResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
