...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->airflowName_ != nullptr
        && this->appSpec_ != nullptr && this->clientToken_ != nullptr && this->dagsDir_ != nullptr && this->description_ != nullptr && this->ossBucketName_ != nullptr
        && this->ossPath_ != nullptr && this->pluginsDir_ != nullptr && this->requirementFile_ != nullptr && this->securityGroupId_ != nullptr && this->startupFile_ != nullptr
