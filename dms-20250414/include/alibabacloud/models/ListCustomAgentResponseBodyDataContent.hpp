...
#ifndef ALIBABACLOUD_MODELS_LISTCUSTOMAGENTRESPONSEBODYDATACONTENT_HPP_
#define ALIBABACLOUD_MODELS_LISTCUSTOMAGENTRESPONSEBODYDATACONTENT_HPP_
...
namespace Models
{
  class ListCustomAgentResponseBodyDataContent : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListCustomAgentResponseBodyDataContent& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListCustomAgentResponseBodyDataContent& obj) { 
    ...
    ListCustomAgentResponseBodyDataContent() = default ;
    ListCustomAgentResponseBodyDataContent(const ListCustomAgentResponseBodyDataContent &) = default ;
    ListCustomAgentResponseBodyDataContent(ListCustomAgentResponseBodyDataContent &&) = default ;
    ListCustomAgentResponseBodyDataContent(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListCustomAgentResponseBodyDataContent() = default ;
    ListCustomAgentResponseBodyDataContent& operator=(const ListCustomAgentResponseBodyDataContent &) = default ;
    ListCustomAgentResponseBodyDataContent& operator=(ListCustomAgentResponseBodyDataContent &&) = default ;
    ...
    inline string aliyunParentId() const { DARABONBA_PTR_GET_DEFAULT(aliyunParentId_, "") };
    inline ListCustomAgentResponseBodyDataContent& setAliyunParentId(string aliyunParentId) { DARABONBA_PTR_SET_VALUE(aliyunParentId_, aliyunParentId) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setAliyunUid(string aliyunUid) { DARABONBA_PTR_SET_VALUE(aliyunUid_, aliyunUid) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setCreatorUserName(string creatorUserName) { DARABONBA_PTR_SET_VALUE(creatorUserName_, creatorUserName) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setCustomAgentId(string customAgentId) { DARABONBA_PTR_SET_VALUE(customAgentId_, customAgentId) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setDataJson(string dataJson) { DARABONBA_PTR_SET_VALUE(dataJson_, dataJson) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setDmsUnit(string dmsUnit) { DARABONBA_PTR_SET_VALUE(dmsUnit_, dmsUnit) };
    ...
    inline const Models::ListCustomAgentResponseBodyDataContentExecutionConfig & executionConfig() const { DARABONBA_PTR_GET_CONST(executionConfig_, Models::ListCustomAgentResponseBodyDataContentExecutionConfig) };
    inline Models::ListCustomAgentResponseBodyDataContentExecutionConfig executionConfig() { DARABONBA_PTR_GET(executionConfig_, Models::ListCustomAgentResponseBodyDataContentExecutionConfig) };
    inline ListCustomAgentResponseBodyDataContent& setExecutionConfig(const Models::ListCustomAgentResponseBodyDataContentExecutionConfig & executionConfig) { DARABONBA_PTR_SET_VALUE(executionConfig_, executionConfig) };
    inline ListCustomAgentResponseBodyDataContent& setExecutionConfig(Models::ListCustomAgentResponseBodyDataContentExecutionConfig && executionConfig) { DARABONBA_PTR_SET_RVALUE(executionConfig_, executionConfig) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setGmtCreated(string gmtCreated) { DARABONBA_PTR_SET_VALUE(gmtCreated_, gmtCreated) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setInstruction(string instruction) { DARABONBA_PTR_SET_VALUE(instruction_, instruction) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setKnowledge(string knowledge) { DARABONBA_PTR_SET_VALUE(knowledge_, knowledge) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setModifier(string modifier) { DARABONBA_PTR_SET_VALUE(modifier_, modifier) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setModifierUserName(string modifierUserName) { DARABONBA_PTR_SET_VALUE(modifierUserName_, modifierUserName) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setOfflineTime(string offlineTime) { DARABONBA_PTR_SET_VALUE(offlineTime_, offlineTime) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setRegion(string region) { DARABONBA_PTR_SET_VALUE(region_, region) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setReleaseTime(string releaseTime) { DARABONBA_PTR_SET_VALUE(releaseTime_, releaseTime) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setTextReportConfig(string textReportConfig) { DARABONBA_PTR_SET_VALUE(textReportConfig_, textReportConfig) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setWebReportConfig(string webReportConfig) { DARABONBA_PTR_SET_VALUE(webReportConfig_, webReportConfig) };
    ...
    inline ListCustomAgentResponseBodyDataContent& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };


  protected:
    std::shared_ptr<string> aliyunParentId_ = nullptr;
    ...
    std::shared_ptr<Models::ListCustomAgentResponseBodyDataContentExecutionConfig> executionConfig_ = nullptr;
