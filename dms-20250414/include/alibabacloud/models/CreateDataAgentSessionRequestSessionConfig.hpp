...
namespace Models
{
  class CreateDataAgentSessionRequestSessionConfig : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateDataAgentSessionRequestSessionConfig& obj) { 
    ...
    CreateDataAgentSessionRequestSessionConfig(const CreateDataAgentSessionRequestSessionConfig &) = default ;
    CreateDataAgentSessionRequestSessionConfig(CreateDataAgentSessionRequestSessionConfig &&) = default ;
    CreateDataAgentSessionRequestSessionConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateDataAgentSessionRequestSessionConfig() = default ;
    CreateDataAgentSessionRequestSessionConfig& operator=(const CreateDataAgentSessionRequestSessionConfig &) = default ;
    CreateDataAgentSessionRequestSessionConfig& operator=(CreateDataAgentSessionRequestSessionConfig &&) = default ;
    ...
    inline CreateDataAgentSessionRequestSessionConfig& setCustomAgentId(string customAgentId) { DARABONBA_PTR_SET_VALUE(customAgentId_, customAgentId) };
    ...
    inline CreateDataAgentSessionRequestSessionConfig& setCustomAgentStage(string customAgentStage) { DARABONBA_PTR_SET_VALUE(customAgentStage_, customAgentStage) };
    ...
    inline CreateDataAgentSessionRequestSessionConfig& setEnableSearch(bool enableSearch) { DARABONBA_PTR_SET_VALUE(enableSearch_, enableSearch) };
    ...
    inline CreateDataAgentSessionRequestSessionConfig& setMode(string mode) { DARABONBA_PTR_SET_VALUE(mode_, mode) };
