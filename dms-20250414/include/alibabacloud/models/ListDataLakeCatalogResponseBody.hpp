...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DLCatalog> & getCataLogList() const { DARABONBA_PTR_GET_CONST(cataLogList_, vector<DLCatalog>) };
    inline vector<DLCatalog> getCataLogList() { DARABONBA_PTR_GET(cataLogList_, vector<DLCatalog>) };
