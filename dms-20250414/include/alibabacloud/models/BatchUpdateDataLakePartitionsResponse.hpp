...
namespace Models
{
  ...
  public:
    ...
    inline const BatchUpdateDataLakePartitionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchUpdateDataLakePartitionsResponseBody) };
    inline BatchUpdateDataLakePartitionsResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchUpdateDataLakePartitionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchUpdateDataLakePartitionsResponseBody> body_ {};
  };
