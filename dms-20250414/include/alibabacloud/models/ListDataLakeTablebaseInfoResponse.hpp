...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataLakeTablebaseInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataLakeTablebaseInfoResponseBody) };
    inline ListDataLakeTablebaseInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataLakeTablebaseInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataLakeTablebaseInfoResponseBody> body_ {};
  };
