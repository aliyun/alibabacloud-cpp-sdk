...
namespace Models
{
  ...
  public:
    ...
    inline GetChatContentResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GetChatContentResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const GetChatContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetChatContentResponseBody) };
    inline GetChatContentResponseBody getBody() { DARABONBA_PTR_GET(body_, GetChatContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetChatContentResponseBody> body_ {};
  };
