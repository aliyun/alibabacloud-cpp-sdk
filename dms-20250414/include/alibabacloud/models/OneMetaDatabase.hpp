...
#ifndef ALIBABACLOUD_MODELS_ONEMETADATABASE_HPP_
#define ALIBABACLOUD_MODELS_ONEMETADATABASE_HPP_
...
namespace Models
{
  class OneMetaDatabase : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const OneMetaDatabase& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, OneMetaDatabase& obj) { 
    ...
    OneMetaDatabase() = default ;
    OneMetaDatabase(const OneMetaDatabase &) = default ;
    OneMetaDatabase(OneMetaDatabase &&) = default ;
    OneMetaDatabase(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~OneMetaDatabase() = default ;
    OneMetaDatabase& operator=(const OneMetaDatabase &) = default ;
    OneMetaDatabase& operator=(OneMetaDatabase &&) = default ;
    ...
    inline OneMetaDatabase& setCatalogName(string catalogName) { DARABONBA_PTR_SET_VALUE(catalogName_, catalogName) };
    ...
    inline OneMetaDatabase& setCatalogType(string catalogType) { DARABONBA_PTR_SET_VALUE(catalogType_, catalogType) };
    ...
    inline OneMetaDatabase& setCatalogUuid(string catalogUuid) { DARABONBA_PTR_SET_VALUE(catalogUuid_, catalogUuid) };
    ...
    inline OneMetaDatabase& setDataSourceType(string dataSourceType) { DARABONBA_PTR_SET_VALUE(dataSourceType_, dataSourceType) };
    ...
    inline OneMetaDatabase& setDatabaseBizAttrs(const Darabonba::Json & databaseBizAttrs) { DARABONBA_SET_VALUE(databaseBizAttrs_, databaseBizAttrs) };
    inline OneMetaDatabase& setDatabaseBizAttrs(Darabonba::Json && databaseBizAttrs) { DARABONBA_SET_RVALUE(databaseBizAttrs_, databaseBizAttrs) };
    ...
    inline OneMetaDatabase& setDatabaseUuid(string databaseUuid) { DARABONBA_PTR_SET_VALUE(databaseUuid_, databaseUuid) };
    ...
    inline OneMetaDatabase& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline const OneMetaDatabaseEngineMeta & getEngineMeta() const { DARABONBA_PTR_GET_CONST(engineMeta_, OneMetaDatabaseEngineMeta) };
    inline OneMetaDatabaseEngineMeta getEngineMeta() { DARABONBA_PTR_GET(engineMeta_, OneMetaDatabaseEngineMeta) };
    inline OneMetaDatabase& setEngineMeta(const OneMetaDatabaseEngineMeta & engineMeta) { DARABONBA_PTR_SET_VALUE(engineMeta_, engineMeta) };
    inline OneMetaDatabase& setEngineMeta(OneMetaDatabaseEngineMeta && engineMeta) { DARABONBA_PTR_SET_RVALUE(engineMeta_, engineMeta) };
    ...
    inline OneMetaDatabase& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline OneMetaDatabase& setProperties(const Darabonba::Json & properties) { DARABONBA_SET_VALUE(properties_, properties) };
    inline OneMetaDatabase& setProperties(Darabonba::Json && properties) { DARABONBA_SET_RVALUE(properties_, properties) };
    ...
    inline OneMetaDatabase& setQualifiedName(string qualifiedName) { DARABONBA_PTR_SET_VALUE(qualifiedName_, qualifiedName) };
    ...
    inline OneMetaDatabase& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline OneMetaDatabase& setSearchName(string searchName) { DARABONBA_PTR_SET_VALUE(searchName_, searchName) };
    ...
    inline OneMetaDatabase& setState(int32_t state) { DARABONBA_PTR_SET_VALUE(state_, state) };
    ...
    inline OneMetaDatabase& setStorageLocation(string storageLocation) { DARABONBA_PTR_SET_VALUE(storageLocation_, storageLocation) };
  ...
  protected:
    ...
    shared_ptr<OneMetaDatabaseEngineMeta> engineMeta_ {};
