...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline string getEnvironments() const { DARABONBA_PTR_GET_DEFAULT(environments_, "") };
      inline Root& setEnvironments(string environments) { DARABONBA_PTR_SET_VALUE(environments_, environments) };
      ...
      inline string getRequirements() const { DARABONBA_PTR_GET_DEFAULT(requirements_, "") };
      inline Root& setRequirements(string requirements) { DARABONBA_PTR_SET_VALUE(requirements_, requirements) };
      ...
      inline Root& setUuid(string uuid) { DARABONBA_PTR_SET_VALUE(uuid_, uuid) };
    ...
    inline const UpdateAirflowResponseBody::Root & getRoot() const { DARABONBA_PTR_GET_CONST(root_, UpdateAirflowResponseBody::Root) };
    inline UpdateAirflowResponseBody::Root getRoot() { DARABONBA_PTR_GET(root_, UpdateAirflowResponseBody::Root) };
    inline UpdateAirflowResponseBody& setRoot(const UpdateAirflowResponseBody::Root & root) { DARABONBA_PTR_SET_VALUE(root_, root) };
    inline UpdateAirflowResponseBody& setRoot(UpdateAirflowResponseBody::Root && root) { DARABONBA_PTR_SET_RVALUE(root_, root) };
