...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomAgentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListCustomAgentResponseBodyData) };
    inline ListCustomAgentResponseBodyData data() { DARABONBA_PTR_GET(data_, ListCustomAgentResponseBodyData) };
    inline ListCustomAgentResponseBody& setData(const ListCustomAgentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCustomAgentResponseBody& setData(ListCustomAgentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<ListCustomAgentResponseBodyData> data_ = nullptr;
