  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline const Content::CallbackConfig & getCallbackConfig() const { DARABONBA_PTR_GET_CONST(callbackConfig_, Content::CallbackConfig) };
        inline Content::CallbackConfig getCallbackConfig() { DARABONBA_PTR_GET(callbackConfig_, Content::CallbackConfig) };
        inline Content& setCallbackConfig(const Content::CallbackConfig & callbackConfig) { DARABONBA_PTR_SET_VALUE(callbackConfig_, callbackConfig) };
        inline Content& setCallbackConfig(Content::CallbackConfig && callbackConfig) { DARABONBA_PTR_SET_RVALUE(callbackConfig_, callbackConfig) };
        ...
        inline Content& setDefaultAgent(int32_t defaultAgent) { DARABONBA_PTR_SET_VALUE(defaultAgent_, defaultAgent) };
        ...
        inline Content& setIsScheduleTask(bool isScheduleTask) { DARABONBA_PTR_SET_VALUE(isScheduleTask_, isScheduleTask) };
        ...
        inline const vector<Content::KnowledgeSemanticConfigList> & getKnowledgeSemanticConfigList() const { DARABONBA_PTR_GET_CONST(knowledgeSemanticConfigList_, vector<Content::KnowledgeSemanticConfigList>) };
        inline vector<Content::KnowledgeSemanticConfigList> getKnowledgeSemanticConfigList() { DARABONBA_PTR_GET(knowledgeSemanticConfigList_, vector<Content::KnowledgeSemanticConfigList>) };
        inline Content& setKnowledgeSemanticConfigList(const vector<Content::KnowledgeSemanticConfigList> & knowledgeSemanticConfigList) { DARABONBA_PTR_SET_VALUE(knowledgeSemanticConfigList_, knowledgeSemanticConfigList) };
        inline Content& setKnowledgeSemanticConfigList(vector<Content::KnowledgeSemanticConfigList> && knowledgeSemanticConfigList) { DARABONBA_PTR_SET_RVALUE(knowledgeSemanticConfigList_, knowledgeSemanticConfigList) };
        ...
        inline Content& setNextRuntime(int64_t nextRuntime) { DARABONBA_PTR_SET_VALUE(nextRuntime_, nextRuntime) };
        ...
        void deleteRelatedSessionId() { this->relatedSessionId_ = nullptr;};
        inline string getRelatedSessionId() const { DARABONBA_PTR_GET_DEFAULT(relatedSessionId_, "") };
        inline Content& setRelatedSessionId(string relatedSessionId) { DARABONBA_PTR_SET_VALUE(relatedSessionId_, relatedSessionId) };
        ...
        inline const Content::ScheduleTaskConfig & getScheduleTaskConfig() const { DARABONBA_PTR_GET_CONST(scheduleTaskConfig_, Content::ScheduleTaskConfig) };
        inline Content::ScheduleTaskConfig getScheduleTaskConfig() { DARABONBA_PTR_GET(scheduleTaskConfig_, Content::ScheduleTaskConfig) };
        inline Content& setScheduleTaskConfig(const Content::ScheduleTaskConfig & scheduleTaskConfig) { DARABONBA_PTR_SET_VALUE(scheduleTaskConfig_, scheduleTaskConfig) };
        inline Content& setScheduleTaskConfig(Content::ScheduleTaskConfig && scheduleTaskConfig) { DARABONBA_PTR_SET_RVALUE(scheduleTaskConfig_, scheduleTaskConfig) };
