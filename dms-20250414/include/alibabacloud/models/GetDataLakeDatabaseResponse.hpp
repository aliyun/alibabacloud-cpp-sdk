...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataLakeDatabaseResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetDataLakeDatabaseResponseBody) };
    inline GetDataLakeDatabaseResponseBody body() { DARABONBA_PTR_GET(body_, GetDataLakeDatabaseResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetDataLakeDatabaseResponseBody> body_ = nullptr;
  };
