  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->airflowId_ == nullptr
        ...
        && this->pluginsDir_ == nullptr && this->regionId_ == nullptr && this->requirementFile_ == nullptr && this->securityGroupId_ == nullptr && this->startupFile_ == nullptr
        && this->status_ == nullptr && this->vSwitchId_ == nullptr && this->vpcId_ == nullptr && this->workerServerlessReplicas_ == nullptr && this->workspaceId_ == nullptr
    ...
    inline const GetAirflowResponseBody::Root & getRoot() const { DARABONBA_PTR_GET_CONST(root_, GetAirflowResponseBody::Root) };
    inline GetAirflowResponseBody::Root getRoot() { DARABONBA_PTR_GET(root_, GetAirflowResponseBody::Root) };
    inline GetAirflowResponseBody& setRoot(const GetAirflowResponseBody::Root & root) { DARABONBA_PTR_SET_VALUE(root_, root) };
    inline GetAirflowResponseBody& setRoot(GetAirflowResponseBody::Root && root) { DARABONBA_PTR_SET_RVALUE(root_, root) };
