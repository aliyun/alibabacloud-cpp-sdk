...
namespace Models
{
  ...
  public:
    ...
    inline const SendChatMessageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SendChatMessageResponseBodyData) };
    inline SendChatMessageResponseBodyData data() { DARABONBA_PTR_GET(data_, SendChatMessageResponseBodyData) };
    inline SendChatMessageResponseBody& setData(const SendChatMessageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SendChatMessageResponseBody& setData(SendChatMessageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<SendChatMessageResponseBodyData> data_ = nullptr;
