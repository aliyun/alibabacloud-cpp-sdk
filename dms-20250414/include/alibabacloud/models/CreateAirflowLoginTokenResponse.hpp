...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAirflowLoginTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAirflowLoginTokenResponseBody) };
    inline CreateAirflowLoginTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAirflowLoginTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAirflowLoginTokenResponseBody> body_ {};
  };
