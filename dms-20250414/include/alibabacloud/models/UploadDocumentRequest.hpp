...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->chunkOverlap_ == nullptr
        ...
        && this->location_ == nullptr && this->separators_ == nullptr && this->splitterModel_ == nullptr && this->textSplitterName_ == nullptr && this->vlEnhance_ == nullptr
    ...
    inline UploadDocumentRequest& setChunkOverlap(int64_t chunkOverlap) { DARABONBA_PTR_SET_VALUE(chunkOverlap_, chunkOverlap) };
    ...
    inline UploadDocumentRequest& setChunkSize(int64_t chunkSize) { DARABONBA_PTR_SET_VALUE(chunkSize_, chunkSize) };
    ...
    inline UploadDocumentRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline UploadDocumentRequest& setDocumentLoaderName(string documentLoaderName) { DARABONBA_PTR_SET_VALUE(documentLoaderName_, documentLoaderName) };
    ...
    inline UploadDocumentRequest& setKbUuid(string kbUuid) { DARABONBA_PTR_SET_VALUE(kbUuid_, kbUuid) };
    ...
    inline UploadDocumentRequest& setLocation(string location) { DARABONBA_PTR_SET_VALUE(location_, location) };
    ...
    inline UploadDocumentRequest& setSeparators(const vector<string> & separators) { DARABONBA_PTR_SET_VALUE(separators_, separators) };
    inline UploadDocumentRequest& setSeparators(vector<string> && separators) { DARABONBA_PTR_SET_RVALUE(separators_, separators) };
    ...
    inline UploadDocumentRequest& setSplitterModel(string splitterModel) { DARABONBA_PTR_SET_VALUE(splitterModel_, splitterModel) };
    ...
    inline UploadDocumentRequest& setTextSplitterName(string textSplitterName) { DARABONBA_PTR_SET_VALUE(textSplitterName_, textSplitterName) };
    ...
    inline UploadDocumentRequest& setVlEnhance(bool vlEnhance) { DARABONBA_PTR_SET_VALUE(vlEnhance_, vlEnhance) };
    ...
    inline UploadDocumentRequest& setZhTitleEnhance(bool zhTitleEnhance) { DARABONBA_PTR_SET_VALUE(zhTitleEnhance_, zhTitleEnhance) };
