...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DMSUnit_ == nullptr
        && this->isSessionShareEnabled_ == nullptr && this->workspaceDesc_ == nullptr && this->workspaceId_ == nullptr && this->workspaceName_ == nullptr; };
    ...
    inline UpdateDataAgentSpaceInfoRequest& setIsSessionShareEnabled(bool isSessionShareEnabled) { DARABONBA_PTR_SET_VALUE(isSessionShareEnabled_, isSessionShareEnabled) };
