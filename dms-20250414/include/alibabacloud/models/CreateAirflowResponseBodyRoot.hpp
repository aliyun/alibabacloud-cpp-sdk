...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->airflowId_ == nullptr
        && return this->airflowName_ == nullptr && return this->appSpec_ == nullptr && return this->appType_ == nullptr && return this->dagsDir_ == nullptr && return this->deployErrorMsg_ == nullptr
        && return this->description_ == nullptr && return this->gmtCreated_ == nullptr && return this->ossBucketName_ == nullptr && return this->ossPath_ == nullptr && return this->pluginsDir_ == nullptr
        && return this->requirementFile_ == nullptr && return this->securityGroupId_ == nullptr && return this->startupFile_ == nullptr && return this->status_ == nullptr && return this->vSwitchId_ == nullptr
        && return this->vpcId_ == nullptr && return this->workerServerlessReplicas_ == nullptr && return this->workspaceId_ == nullptr && return this->zoneId_ == nullptr; };
