...
#ifndef ALIBABACLOUD_MODELS_DESCRIBESKILLFILEUPLOADSIGNATURERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBESKILLFILEUPLOADSIGNATURERESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeSkillFileUploadSignatureResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeSkillFileUploadSignatureResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeSkillFileUploadSignatureResponseBody& obj) { 
    ...
    DescribeSkillFileUploadSignatureResponseBody() = default ;
    DescribeSkillFileUploadSignatureResponseBody(const DescribeSkillFileUploadSignatureResponseBody &) = default ;
    DescribeSkillFileUploadSignatureResponseBody(DescribeSkillFileUploadSignatureResponseBody &&) = default ;
    DescribeSkillFileUploadSignatureResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeSkillFileUploadSignatureResponseBody() = default ;
    DescribeSkillFileUploadSignatureResponseBody& operator=(const DescribeSkillFileUploadSignatureResponseBody &) = default ;
    DescribeSkillFileUploadSignatureResponseBody& operator=(DescribeSkillFileUploadSignatureResponseBody &&) = default ;
    ...
    inline const DescribeSkillFileUploadSignatureResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeSkillFileUploadSignatureResponseBody::Data) };
    inline DescribeSkillFileUploadSignatureResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeSkillFileUploadSignatureResponseBody::Data) };
    inline DescribeSkillFileUploadSignatureResponseBody& setData(const DescribeSkillFileUploadSignatureResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSkillFileUploadSignatureResponseBody& setData(DescribeSkillFileUploadSignatureResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeSkillFileUploadSignatureResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline DescribeSkillFileUploadSignatureResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline DescribeSkillFileUploadSignatureResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeSkillFileUploadSignatureResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // The response struct.
    shared_ptr<DescribeSkillFileUploadSignatureResponseBody::Data> data_ {};
    // The error code.
