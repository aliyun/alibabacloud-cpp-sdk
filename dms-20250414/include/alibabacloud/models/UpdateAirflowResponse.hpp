...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAirflowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAirflowResponseBody) };
    inline UpdateAirflowResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAirflowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAirflowResponseBody> body_ {};
  };
