...
namespace Models
{
  ...
  public:
    ...
    inline const DLCatalog & getCatalog() const { DARABONBA_PTR_GET_CONST(catalog_, DLCatalog) };
    inline DLCatalog getCatalog() { DARABONBA_PTR_GET(catalog_, DLCatalog) };
