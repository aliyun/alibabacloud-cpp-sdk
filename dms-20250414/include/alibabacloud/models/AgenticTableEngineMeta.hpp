...
#ifndef ALIBABACLOUD_MODELS_AGENTICTABLEENGINEMETA_HPP_
#define ALIBABACLOUD_MODELS_AGENTICTABLEENGINEMETA_HPP_
...
namespace Models
{
  class AgenticTableEngineMeta : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const AgenticTableEngineMeta& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(FullChecksum, fullChecksum_);
    ...
    friend void from_json(const Darabonba::Json& j, AgenticTableEngineMeta& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(FullChecksum, fullChecksum_);
    ...
    AgenticTableEngineMeta() = default ;
    AgenticTableEngineMeta(const AgenticTableEngineMeta &) = default ;
    AgenticTableEngineMeta(AgenticTableEngineMeta &&) = default ;
    AgenticTableEngineMeta(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AgenticTableEngineMeta() = default ;
    AgenticTableEngineMeta& operator=(const AgenticTableEngineMeta &) = default ;
    AgenticTableEngineMeta& operator=(AgenticTableEngineMeta &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->checksum_ == nullptr
        && this->createTime_ == nullptr && this->dataBytes_ == nullptr && this->encoding_ == nullptr && this->engine_ == nullptr && this->fullChecksum_ == nullptr
        && this->indexBytes_ == nullptr && this->lastDdlTime_ == nullptr && this->numRows_ == nullptr && this->refInfo_ == nullptr && this->storageCapacity_ == nullptr
        && this->tableSchemaName_ == nullptr; };
    ...
    inline AgenticTableEngineMeta& setChecksum(string checksum) { DARABONBA_PTR_SET_VALUE(checksum_, checksum) };
    ...
    inline AgenticTableEngineMeta& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline AgenticTableEngineMeta& setDataBytes(int64_t dataBytes) { DARABONBA_PTR_SET_VALUE(dataBytes_, dataBytes) };
    ...
    inline AgenticTableEngineMeta& setEncoding(string encoding) { DARABONBA_PTR_SET_VALUE(encoding_, encoding) };
    ...
    inline AgenticTableEngineMeta& setEngine(string engine) { DARABONBA_PTR_SET_VALUE(engine_, engine) };


    // fullChecksum Field Functions 
    bool hasFullChecksum() const { return this->fullChecksum_ != nullptr;};
    void deleteFullChecksum() { this->fullChecksum_ = nullptr;};
    inline string getFullChecksum() const { DARABONBA_PTR_GET_DEFAULT(fullChecksum_, "") };
    inline AgenticTableEngineMeta& setFullChecksum(string fullChecksum) { DARABONBA_PTR_SET_VALUE(fullChecksum_, fullChecksum) };
    ...
    inline AgenticTableEngineMeta& setIndexBytes(int64_t indexBytes) { DARABONBA_PTR_SET_VALUE(indexBytes_, indexBytes) };
    ...
    inline AgenticTableEngineMeta& setLastDdlTime(string lastDdlTime) { DARABONBA_PTR_SET_VALUE(lastDdlTime_, lastDdlTime) };
    ...
    inline AgenticTableEngineMeta& setNumRows(int64_t numRows) { DARABONBA_PTR_SET_VALUE(numRows_, numRows) };
    ...
    inline AgenticTableEngineMeta& setRefInfo(string refInfo) { DARABONBA_PTR_SET_VALUE(refInfo_, refInfo) };
    ...
    inline AgenticTableEngineMeta& setStorageCapacity(int64_t storageCapacity) { DARABONBA_PTR_SET_VALUE(storageCapacity_, storageCapacity) };
    ...
    inline AgenticTableEngineMeta& setTableSchemaName(string tableSchemaName) { DARABONBA_PTR_SET_VALUE(tableSchemaName_, tableSchemaName) };
