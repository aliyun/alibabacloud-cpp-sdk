...
namespace Models
{
  ...
  public:
    ...
    inline const OneMetaKnowledgeBase & getData() const { DARABONBA_PTR_GET_CONST(data_, OneMetaKnowledgeBase) };
    inline OneMetaKnowledgeBase getData() { DARABONBA_PTR_GET(data_, OneMetaKnowledgeBase) };
    inline UpdateKnowledgeBaseResponseBody& setData(const OneMetaKnowledgeBase & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateKnowledgeBaseResponseBody& setData(OneMetaKnowledgeBase && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UpdateKnowledgeBaseResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline UpdateKnowledgeBaseResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline UpdateKnowledgeBaseResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<OneMetaKnowledgeBase> data_ {};
