...
namespace Models
{
  ...
  public:
    ...
    inline const GetNotebookTaskStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetNotebookTaskStatusResponseBodyData) };
    inline GetNotebookTaskStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, GetNotebookTaskStatusResponseBodyData) };
    inline GetNotebookTaskStatusResponseBody& setData(const GetNotebookTaskStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetNotebookTaskStatusResponseBody& setData(GetNotebookTaskStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetNotebookTaskStatusResponseBodyData> data_ = nullptr;
