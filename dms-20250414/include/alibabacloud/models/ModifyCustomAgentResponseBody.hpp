...
#ifndef ALIBABACLOUD_MODELS_MODIFYCUSTOMAGENTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_MODIFYCUSTOMAGENTRESPONSEBODY_HPP_
...
namespace Models
{
  class ModifyCustomAgentResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModifyCustomAgentResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyCustomAgentResponseBody& obj) { 
    ...
    ModifyCustomAgentResponseBody() = default ;
    ModifyCustomAgentResponseBody(const ModifyCustomAgentResponseBody &) = default ;
    ModifyCustomAgentResponseBody(ModifyCustomAgentResponseBody &&) = default ;
    ModifyCustomAgentResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyCustomAgentResponseBody() = default ;
    ModifyCustomAgentResponseBody& operator=(const ModifyCustomAgentResponseBody &) = default ;
    ModifyCustomAgentResponseBody& operator=(ModifyCustomAgentResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->aliyunParentUid_ == nullptr
        ...
        && this->instruction_ == nullptr && this->isScheduleTask_ == nullptr && this->knowledge_ == nullptr && this->knowledgeConfigList_ == nullptr && this->modifier_ == nullptr
        && this->modifierUserName_ == nullptr && this->name_ == nullptr && this->nextRuntime_ == nullptr && this->offlineTime_ == nullptr && this->region_ == nullptr
        && this->releaseTime_ == nullptr && this->scheduleTaskConfig_ == nullptr && this->status_ == nullptr && this->textReportConfig_ == nullptr && this->webReportConfig_ == nullptr
      ...
      inline const vector<Data::KnowledgeConfigList> & getKnowledgeConfigList() const { DARABONBA_PTR_GET_CONST(knowledgeConfigList_, vector<Data::KnowledgeConfigList>) };
      inline vector<Data::KnowledgeConfigList> getKnowledgeConfigList() { DARABONBA_PTR_GET(knowledgeConfigList_, vector<Data::KnowledgeConfigList>) };
      inline Data& setKnowledgeConfigList(const vector<Data::KnowledgeConfigList> & knowledgeConfigList) { DARABONBA_PTR_SET_VALUE(knowledgeConfigList_, knowledgeConfigList) };
    ...
    inline const ModifyCustomAgentResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ModifyCustomAgentResponseBody::Data) };
    inline ModifyCustomAgentResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ModifyCustomAgentResponseBody::Data) };
    inline ModifyCustomAgentResponseBody& setData(const ModifyCustomAgentResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyCustomAgentResponseBody& setData(ModifyCustomAgentResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ModifyCustomAgentResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline ModifyCustomAgentResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline ModifyCustomAgentResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ModifyCustomAgentResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
