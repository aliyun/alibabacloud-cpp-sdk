 ...
 */
ResetAgenticApiKeyResponse Client::resetAgenticApiKeyWithOptions(const ResetAgenticApiKeyRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasExpireAfterSeconds()) {
    query["ExpireAfterSeconds"] = request.getExpireAfterSeconds();
  ...
  return json(callApi(params, req, runtime)).get<ResetAgenticApiKeyResponse>();
}
 ...
 * @return ResetAgenticApiKeyResponse
 */
ResetAgenticApiKeyResponse Client::resetAgenticApiKey(const ResetAgenticApiKeyRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return resetAgenticApiKeyWithOptions(request, runtime);
}
