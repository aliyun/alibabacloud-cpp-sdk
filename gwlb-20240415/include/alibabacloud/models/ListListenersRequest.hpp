...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->listenerIds_ == nullptr
        && this->loadBalancerIds_ == nullptr && this->maxResults_ == nullptr && this->nextToken_ == nullptr && this->skip_ == nullptr && this->tag_ == nullptr; };
    ...
    inline ListListenersRequest& setSkip(int32_t skip) { DARABONBA_PTR_SET_VALUE(skip_, skip) };
