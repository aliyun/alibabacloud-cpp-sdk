...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVpcFirewallIPSWhitelistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVpcFirewallIPSWhitelistResponseBody) };
    inline DescribeVpcFirewallIPSWhitelistResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVpcFirewallIPSWhitelistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVpcFirewallIPSWhitelistResponseBody> body_ {};
  };
