...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAccessInstanceVSwitchListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeAccessInstanceVSwitchListResponseBody) };
    inline DescribeAccessInstanceVSwitchListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeAccessInstanceVSwitchListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAccessInstanceVSwitchListResponseBody> body_ = nullptr;
  };
