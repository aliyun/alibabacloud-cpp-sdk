...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->internetInAclCount_ == nullptr
        && this->internetOutAclCount_ == nullptr && this->natInAclCount_ == nullptr && this->natOutAclCount_ == nullptr && this->requestId_ == nullptr && this->totalAclCount_ == nullptr
        && this->vpcAclCount_ == nullptr; };
    ...
    inline int32_t getInternetInAclCount() const { DARABONBA_PTR_GET_DEFAULT(internetInAclCount_, 0) };
    ...
    inline int32_t getInternetOutAclCount() const { DARABONBA_PTR_GET_DEFAULT(internetOutAclCount_, 0) };
    ...
    inline int32_t getNatInAclCount() const { DARABONBA_PTR_GET_DEFAULT(natInAclCount_, 0) };
    ...
    inline int32_t getNatOutAclCount() const { DARABONBA_PTR_GET_DEFAULT(natOutAclCount_, 0) };
    ...
    inline int32_t getTotalAclCount() const { DARABONBA_PTR_GET_DEFAULT(totalAclCount_, 0) };
    ...
    inline int32_t getVpcAclCount() const { DARABONBA_PTR_GET_DEFAULT(vpcAclCount_, 0) };
