...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTrFirewallPolicyBackUpAssociationListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeTrFirewallPolicyBackUpAssociationListResponseBody) };
    inline DescribeTrFirewallPolicyBackUpAssociationListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeTrFirewallPolicyBackUpAssociationListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeTrFirewallPolicyBackUpAssociationListResponseBody> body_ = nullptr;
  };
