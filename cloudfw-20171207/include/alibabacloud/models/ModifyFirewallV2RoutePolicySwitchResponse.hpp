...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyFirewallV2RoutePolicySwitchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyFirewallV2RoutePolicySwitchResponseBody) };
    inline ModifyFirewallV2RoutePolicySwitchResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyFirewallV2RoutePolicySwitchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyFirewallV2RoutePolicySwitchResponseBody> body_ {};
  };
