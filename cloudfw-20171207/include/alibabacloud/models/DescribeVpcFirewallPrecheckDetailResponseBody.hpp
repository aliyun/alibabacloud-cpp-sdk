...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVpcFirewallPrecheckDetailResponseBody::PrecheckDetail & getPrecheckDetail() const { DARABONBA_PTR_GET_CONST(precheckDetail_, DescribeVpcFirewallPrecheckDetailResponseBody::PrecheckDetail) };
    inline DescribeVpcFirewallPrecheckDetailResponseBody::PrecheckDetail getPrecheckDetail() { DARABONBA_PTR_GET(precheckDetail_, DescribeVpcFirewallPrecheckDetailResponseBody::PrecheckDetail) };
    inline DescribeVpcFirewallPrecheckDetailResponseBody& setPrecheckDetail(const DescribeVpcFirewallPrecheckDetailResponseBody::PrecheckDetail & precheckDetail) { DARABONBA_PTR_SET_VALUE(precheckDetail_, precheckDetail) };
    inline DescribeVpcFirewallPrecheckDetailResponseBody& setPrecheckDetail(DescribeVpcFirewallPrecheckDetailResponseBody::PrecheckDetail && precheckDetail) { DARABONBA_PTR_SET_RVALUE(precheckDetail_, precheckDetail) };
