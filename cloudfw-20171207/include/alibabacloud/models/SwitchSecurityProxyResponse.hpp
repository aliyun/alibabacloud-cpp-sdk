...
namespace Models
{
  ...
  public:
    ...
    inline const SwitchSecurityProxyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SwitchSecurityProxyResponseBody) };
    inline SwitchSecurityProxyResponseBody getBody() { DARABONBA_PTR_GET(body_, SwitchSecurityProxyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SwitchSecurityProxyResponseBody> body_ {};
  };
