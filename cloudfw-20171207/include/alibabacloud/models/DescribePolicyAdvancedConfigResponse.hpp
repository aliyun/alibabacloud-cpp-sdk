...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePolicyAdvancedConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePolicyAdvancedConfigResponseBody) };
    inline DescribePolicyAdvancedConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePolicyAdvancedConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePolicyAdvancedConfigResponseBody> body_ {};
  };
