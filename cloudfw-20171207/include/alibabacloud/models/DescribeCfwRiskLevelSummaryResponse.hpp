...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCfwRiskLevelSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCfwRiskLevelSummaryResponseBody) };
    inline DescribeCfwRiskLevelSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCfwRiskLevelSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCfwRiskLevelSummaryResponseBody> body_ {};
  };
