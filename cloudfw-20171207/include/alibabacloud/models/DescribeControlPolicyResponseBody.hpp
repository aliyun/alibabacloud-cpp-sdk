...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Policys& setSpreadCnt(int32_t spreadCnt) { DARABONBA_PTR_SET_VALUE(spreadCnt_, spreadCnt) };
    ...
    inline const vector<DescribeControlPolicyResponseBody::Policys> & getPolicys() const { DARABONBA_PTR_GET_CONST(policys_, vector<DescribeControlPolicyResponseBody::Policys>) };
    inline vector<DescribeControlPolicyResponseBody::Policys> getPolicys() { DARABONBA_PTR_GET(policys_, vector<DescribeControlPolicyResponseBody::Policys>) };
    inline DescribeControlPolicyResponseBody& setPolicys(const vector<DescribeControlPolicyResponseBody::Policys> & policys) { DARABONBA_PTR_SET_VALUE(policys_, policys) };
    inline DescribeControlPolicyResponseBody& setPolicys(vector<DescribeControlPolicyResponseBody::Policys> && policys) { DARABONBA_PTR_SET_RVALUE(policys_, policys) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeControlPolicyResponseBody::Policys>> policys_ {};
