...
namespace Models
{
  ...
  public:
    ...
    inline int64_t totalAssets() const { DARABONBA_PTR_GET_DEFAULT(totalAssets_, 0L) };
    ...
    inline int64_t totalBillTraffic() const { DARABONBA_PTR_GET_DEFAULT(totalBillTraffic_, 0L) };
    ...
    inline int64_t totalInternetAssets() const { DARABONBA_PTR_GET_DEFAULT(totalInternetAssets_, 0L) };
    ...
    inline int64_t totalInternetTraffic() const { DARABONBA_PTR_GET_DEFAULT(totalInternetTraffic_, 0L) };
    ...
    inline int64_t totalNatAssets() const { DARABONBA_PTR_GET_DEFAULT(totalNatAssets_, 0L) };
    ...
    inline int64_t totalNatTraffic() const { DARABONBA_PTR_GET_DEFAULT(totalNatTraffic_, 0L) };
    ...
    inline int64_t totalSdlBillTraffic() const { DARABONBA_PTR_GET_DEFAULT(totalSdlBillTraffic_, 0L) };
    ...
    inline int64_t totalSdlFreeTraffic() const { DARABONBA_PTR_GET_DEFAULT(totalSdlFreeTraffic_, 0L) };
    ...
    inline int64_t totalVpcAssets() const { DARABONBA_PTR_GET_DEFAULT(totalVpcAssets_, 0L) };
    ...
    inline int64_t totalVpcTraffic() const { DARABONBA_PTR_GET_DEFAULT(totalVpcTraffic_, 0L) };
  ...
  protected:
    ...
    std::shared_ptr<int64_t> totalAssets_ = nullptr;
    // The volume of burstable protected traffic for which fees are generated. Unit: bytes.
    std::shared_ptr<int64_t> totalBillTraffic_ = nullptr;
    // The total number of assets protected by the Internet firewall.
    std::shared_ptr<int64_t> totalInternetAssets_ = nullptr;
    ...
    std::shared_ptr<int64_t> totalInternetTraffic_ = nullptr;
    // The total number of assets protected by NAT firewalls.
    std::shared_ptr<int64_t> totalNatAssets_ = nullptr;
    ...
    std::shared_ptr<int64_t> totalNatTraffic_ = nullptr;
    // Data Leak Detection Total Fee Flow.
    std::shared_ptr<int64_t> totalSdlBillTraffic_ = nullptr;
    // Data Leak Detection Total free usage traffic.
    std::shared_ptr<int64_t> totalSdlFreeTraffic_ = nullptr;
    ...
    std::shared_ptr<int64_t> totalVpcAssets_ = nullptr;
    ...
    std::shared_ptr<int64_t> totalVpcTraffic_ = nullptr;
  };
