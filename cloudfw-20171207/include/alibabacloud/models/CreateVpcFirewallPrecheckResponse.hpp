...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVpcFirewallPrecheckResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVpcFirewallPrecheckResponseBody) };
    inline CreateVpcFirewallPrecheckResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVpcFirewallPrecheckResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVpcFirewallPrecheckResponseBody> body_ {};
  };
