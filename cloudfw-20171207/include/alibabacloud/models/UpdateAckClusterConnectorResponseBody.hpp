...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAckClusterConnectorResponseBody::AckClusterConnector & getAckClusterConnector() const { DARABONBA_PTR_GET_CONST(ackClusterConnector_, UpdateAckClusterConnectorResponseBody::AckClusterConnector) };
    inline UpdateAckClusterConnectorResponseBody::AckClusterConnector getAckClusterConnector() { DARABONBA_PTR_GET(ackClusterConnector_, UpdateAckClusterConnectorResponseBody::AckClusterConnector) };
    inline UpdateAckClusterConnectorResponseBody& setAckClusterConnector(const UpdateAckClusterConnectorResponseBody::AckClusterConnector & ackClusterConnector) { DARABONBA_PTR_SET_VALUE(ackClusterConnector_, ackClusterConnector) };
    inline UpdateAckClusterConnectorResponseBody& setAckClusterConnector(UpdateAckClusterConnectorResponseBody::AckClusterConnector && ackClusterConnector) { DARABONBA_PTR_SET_RVALUE(ackClusterConnector_, ackClusterConnector) };
  ...
  protected:
    shared_ptr<UpdateAckClusterConnectorResponseBody::AckClusterConnector> ackClusterConnector_ {};
