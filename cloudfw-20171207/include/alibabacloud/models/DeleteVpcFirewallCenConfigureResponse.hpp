...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVpcFirewallCenConfigureResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteVpcFirewallCenConfigureResponseBody) };
    inline DeleteVpcFirewallCenConfigureResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteVpcFirewallCenConfigureResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteVpcFirewallCenConfigureResponseBody> body_ {};
  };
