...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTrFirewallsV2ListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTrFirewallsV2ListResponseBody) };
    inline DescribeTrFirewallsV2ListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTrFirewallsV2ListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTrFirewallsV2ListResponseBody> body_ {};
  };
