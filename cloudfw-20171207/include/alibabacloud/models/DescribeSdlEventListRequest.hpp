...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentPage_ == nullptr
        && this->dstIp_ == nullptr && this->endTime_ == nullptr && this->lang_ == nullptr && this->location_ == nullptr && this->onlyAiEvt_ == nullptr
        && this->order_ == nullptr && this->pageSize_ == nullptr && this->sensitiveLevel_ == nullptr && this->sort_ == nullptr && this->srcIp_ == nullptr
    ...
    inline int32_t getOnlyAiEvt() const { DARABONBA_PTR_GET_DEFAULT(onlyAiEvt_, 0) };
