...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOutgoingDestinationIPResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeOutgoingDestinationIPResponseBody) };
    inline DescribeOutgoingDestinationIPResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeOutgoingDestinationIPResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeOutgoingDestinationIPResponseBody> body_ {};
  };
