...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->assetsRegion_ == nullptr
        && this->currentPage_ == nullptr && this->endTime_ == nullptr && this->groupName_ == nullptr && this->IPType_ == nullptr && this->lang_ == nullptr
        && this->natGatewayId_ == nullptr && this->natGatewayName_ == nullptr && this->order_ == nullptr && this->pageSize_ == nullptr && this->privateIP_ == nullptr
        && this->publicIP_ == nullptr && this->resourceType_ == nullptr && this->securityRisk_ == nullptr && this->sort_ == nullptr && this->startTime_ == nullptr; };
