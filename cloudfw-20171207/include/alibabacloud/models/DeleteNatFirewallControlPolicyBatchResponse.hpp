...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteNatFirewallControlPolicyBatchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteNatFirewallControlPolicyBatchResponseBody) };
    inline DeleteNatFirewallControlPolicyBatchResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteNatFirewallControlPolicyBatchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteNatFirewallControlPolicyBatchResponseBody> body_ {};
  };
