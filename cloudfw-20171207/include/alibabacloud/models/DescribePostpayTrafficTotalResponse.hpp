...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePostpayTrafficTotalResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePostpayTrafficTotalResponseBody) };
    inline DescribePostpayTrafficTotalResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePostpayTrafficTotalResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePostpayTrafficTotalResponseBody> body_ {};
  };
