...
namespace Models
{
  ...
  public:
    ...
    inline const ListTlsInspectCACertificatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTlsInspectCACertificatesResponseBody) };
    inline ListTlsInspectCACertificatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTlsInspectCACertificatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTlsInspectCACertificatesResponseBody> body_ {};
  };
