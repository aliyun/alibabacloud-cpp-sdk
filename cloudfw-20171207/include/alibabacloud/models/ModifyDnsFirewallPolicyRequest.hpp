...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aclAction_ == nullptr
        && return this->aclUuid_ == nullptr && return this->description_ == nullptr && return this->destination_ == nullptr && return this->destinationType_ == nullptr && return this->lang_ == nullptr
        && return this->priority_ == nullptr && return this->release_ == nullptr && return this->source_ == nullptr && return this->sourceIp_ == nullptr && return this->sourceType_ == nullptr; };
