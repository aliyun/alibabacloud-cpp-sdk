...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataType_ == nullptr
        && return this->direction_ == nullptr && return this->endTime_ == nullptr && return this->lang_ == nullptr && return this->limit_ == nullptr && return this->ruleResult_ == nullptr
        && return this->ruleSource_ == nullptr && return this->showCountryName_ == nullptr && return this->sort_ == nullptr && return this->sourceCode_ == nullptr && return this->sourceIp_ == nullptr
    ...
    inline string showCountryName() const { DARABONBA_PTR_GET_DEFAULT(showCountryName_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> showCountryName_ = nullptr;
