...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInvadeEventStatisticResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInvadeEventStatisticResponseBody) };
    inline DescribeInvadeEventStatisticResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInvadeEventStatisticResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInvadeEventStatisticResponseBody> body_ {};
  };
