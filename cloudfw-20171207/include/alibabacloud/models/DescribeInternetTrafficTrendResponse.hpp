...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInternetTrafficTrendResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeInternetTrafficTrendResponseBody) };
    inline DescribeInternetTrafficTrendResponseBody body() { DARABONBA_PTR_GET(body_, DescribeInternetTrafficTrendResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeInternetTrafficTrendResponseBody> body_ = nullptr;
  };
