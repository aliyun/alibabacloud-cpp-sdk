...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->totalCount_ == nullptr && return this->vpcFirewalls_ == nullptr; };
    ...
    inline const vector<DescribeVpcFirewallCenListResponseBodyVpcFirewalls> & vpcFirewalls() const { DARABONBA_PTR_GET_CONST(vpcFirewalls_, vector<DescribeVpcFirewallCenListResponseBodyVpcFirewalls>) };
    inline vector<DescribeVpcFirewallCenListResponseBodyVpcFirewalls> vpcFirewalls() { DARABONBA_PTR_GET(vpcFirewalls_, vector<DescribeVpcFirewallCenListResponseBodyVpcFirewalls>) };
    inline DescribeVpcFirewallCenListResponseBody& setVpcFirewalls(const vector<DescribeVpcFirewallCenListResponseBodyVpcFirewalls> & vpcFirewalls) { DARABONBA_PTR_SET_VALUE(vpcFirewalls_, vpcFirewalls) };
    inline DescribeVpcFirewallCenListResponseBody& setVpcFirewalls(vector<DescribeVpcFirewallCenListResponseBodyVpcFirewalls> && vpcFirewalls) { DARABONBA_PTR_SET_RVALUE(vpcFirewalls_, vpcFirewalls) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeVpcFirewallCenListResponseBodyVpcFirewalls>> vpcFirewalls_ = nullptr;
  };
