...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aclType_ == nullptr
        && return this->checkNames_ == nullptr && return this->lang_ == nullptr; };
    ...
    inline const vector<string> & checkNames() const { DARABONBA_PTR_GET_CONST(checkNames_, vector<string>) };
    inline vector<string> checkNames() { DARABONBA_PTR_GET(checkNames_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> checkNames_ = nullptr;
