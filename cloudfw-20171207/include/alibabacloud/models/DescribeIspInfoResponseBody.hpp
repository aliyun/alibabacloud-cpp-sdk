...
#include <vector>
#include <alibabacloud/models/DescribeIspInfoResponseBodyDataList.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeIspInfoResponseBodyDataList> & dataList() const { DARABONBA_PTR_GET_CONST(dataList_, vector<DescribeIspInfoResponseBodyDataList>) };
    inline vector<DescribeIspInfoResponseBodyDataList> dataList() { DARABONBA_PTR_GET(dataList_, vector<DescribeIspInfoResponseBodyDataList>) };
    inline DescribeIspInfoResponseBody& setDataList(const vector<DescribeIspInfoResponseBodyDataList> & dataList) { DARABONBA_PTR_SET_VALUE(dataList_, dataList) };
    inline DescribeIspInfoResponseBody& setDataList(vector<DescribeIspInfoResponseBodyDataList> && dataList) { DARABONBA_PTR_SET_RVALUE(dataList_, dataList) };
  ...
  protected:
    std::shared_ptr<vector<DescribeIspInfoResponseBodyDataList>> dataList_ = nullptr;
