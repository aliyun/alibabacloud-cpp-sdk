...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->instanceMemberCount_ == nullptr
        && return this->maxInstanceMemberNum_ == nullptr && return this->requestId_ == nullptr; };
    ...
    inline int64_t instanceMemberCount() const { DARABONBA_PTR_GET_DEFAULT(instanceMemberCount_, 0L) };
    ...
    inline int64_t maxInstanceMemberNum() const { DARABONBA_PTR_GET_DEFAULT(maxInstanceMemberNum_, 0L) };
  ...
  protected:
    std::shared_ptr<int64_t> instanceMemberCount_ = nullptr;
    std::shared_ptr<int64_t> maxInstanceMemberNum_ = nullptr;
