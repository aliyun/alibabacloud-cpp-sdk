...
namespace Models
{
  ...
  public:
    ...
    inline const DisableSdlProtectedAssetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableSdlProtectedAssetResponseBody) };
    inline DisableSdlProtectedAssetResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableSdlProtectedAssetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableSdlProtectedAssetResponseBody> body_ {};
  };
