...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteIpsPrivateAssocResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteIpsPrivateAssocResponseBody) };
    inline DeleteIpsPrivateAssocResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteIpsPrivateAssocResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteIpsPrivateAssocResponseBody> body_ {};
  };
