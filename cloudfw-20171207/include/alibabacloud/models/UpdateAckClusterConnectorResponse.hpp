...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAckClusterConnectorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAckClusterConnectorResponseBody) };
    inline UpdateAckClusterConnectorResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAckClusterConnectorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAckClusterConnectorResponseBody> body_ {};
  };
