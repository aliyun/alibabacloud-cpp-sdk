...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMemberInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMemberInfoResponseBody) };
    inline DescribeMemberInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMemberInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMemberInfoResponseBody> body_ {};
  };
