...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyControlPolicyPriorityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyControlPolicyPriorityResponseBody) };
    inline ModifyControlPolicyPriorityResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyControlPolicyPriorityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyControlPolicyPriorityResponseBody> body_ {};
  };
