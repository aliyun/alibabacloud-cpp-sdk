...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->basicRules_ == nullptr
        && return this->ctiRules_ == nullptr && return this->maxSdl_ == nullptr && return this->patchRules_ == nullptr && return this->requestId_ == nullptr && return this->ruleClass_ == nullptr
