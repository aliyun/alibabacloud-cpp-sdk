...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTrFirewallV2RoutePolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTrFirewallV2RoutePolicyResponseBody) };
    inline CreateTrFirewallV2RoutePolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTrFirewallV2RoutePolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTrFirewallV2RoutePolicyResponseBody> body_ {};
  };
