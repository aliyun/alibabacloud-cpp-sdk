...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->firewallId_ == nullptr
        && this->lang_ == nullptr && this->shouldRecover_ == nullptr && this->trFirewallRoutePolicyId_ == nullptr && this->trFirewallRoutePolicySwitchStatus_ == nullptr; };
    ...
    inline string getTrFirewallRoutePolicySwitchStatus() const { DARABONBA_PTR_GET_DEFAULT(trFirewallRoutePolicySwitchStatus_, "") };
