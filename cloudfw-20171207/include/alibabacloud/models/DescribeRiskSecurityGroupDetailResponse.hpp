...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRiskSecurityGroupDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRiskSecurityGroupDetailResponseBody) };
    inline DescribeRiskSecurityGroupDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRiskSecurityGroupDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRiskSecurityGroupDetailResponseBody> body_ {};
  };
