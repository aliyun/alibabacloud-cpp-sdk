...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAccessInstanceVpcListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAccessInstanceVpcListResponseBody) };
    inline DescribeAccessInstanceVpcListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAccessInstanceVpcListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAccessInstanceVpcListResponseBody> body_ {};
  };
