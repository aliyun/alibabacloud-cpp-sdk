...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->highOpenEventCnt_ == nullptr
        && this->lowOpenEventCnt_ == nullptr && this->middleOpenEventCnt_ == nullptr && this->requestId_ == nullptr && this->totalOpenEventCnt_ == nullptr; };
    ...
    inline int32_t getHighOpenEventCnt() const { DARABONBA_PTR_GET_DEFAULT(highOpenEventCnt_, 0) };
    ...
    inline int32_t getLowOpenEventCnt() const { DARABONBA_PTR_GET_DEFAULT(lowOpenEventCnt_, 0) };
    ...
    inline int32_t getMiddleOpenEventCnt() const { DARABONBA_PTR_GET_DEFAULT(middleOpenEventCnt_, 0) };
    ...
    inline int32_t getTotalOpenEventCnt() const { DARABONBA_PTR_GET_DEFAULT(totalOpenEventCnt_, 0) };
