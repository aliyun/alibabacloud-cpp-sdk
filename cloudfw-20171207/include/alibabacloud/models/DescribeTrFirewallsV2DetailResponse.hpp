...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTrFirewallsV2DetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTrFirewallsV2DetailResponseBody) };
    inline DescribeTrFirewallsV2DetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTrFirewallsV2DetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTrFirewallsV2DetailResponseBody> body_ {};
  };
