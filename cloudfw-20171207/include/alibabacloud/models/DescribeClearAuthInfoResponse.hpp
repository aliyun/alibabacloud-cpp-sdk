...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClearAuthInfoResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeClearAuthInfoResponseBody) };
    inline DescribeClearAuthInfoResponseBody body() { DARABONBA_PTR_GET(body_, DescribeClearAuthInfoResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeClearAuthInfoResponseBody> body_ = nullptr;
  };
