...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNatFirewallAclGroupListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeNatFirewallAclGroupListResponseBody) };
    inline DescribeNatFirewallAclGroupListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeNatFirewallAclGroupListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeNatFirewallAclGroupListResponseBody> body_ = nullptr;
  };
