...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePrivateDnsEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePrivateDnsEndpointResponseBody) };
    inline DeletePrivateDnsEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePrivateDnsEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePrivateDnsEndpointResponseBody> body_ {};
  };
