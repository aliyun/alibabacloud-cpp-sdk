...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->aclAction_ != nullptr
        ...
        && this->destination_ != nullptr && this->destinationGroupCidrs_ != nullptr && this->destinationGroupType_ != nullptr && this->destinationType_ != nullptr && this->domainResolveType_ != nullptr
        && this->endTime_ != nullptr && this->hitLastTime_ != nullptr && this->hitTimes_ != nullptr && this->memberUid_ != nullptr && this->modifyTime_ != nullptr
