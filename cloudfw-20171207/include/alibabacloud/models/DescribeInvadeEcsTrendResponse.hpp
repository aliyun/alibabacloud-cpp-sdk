...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInvadeEcsTrendResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeInvadeEcsTrendResponseBody) };
    inline DescribeInvadeEcsTrendResponseBody body() { DARABONBA_PTR_GET(body_, DescribeInvadeEcsTrendResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeInvadeEcsTrendResponseBody> body_ = nullptr;
  };
