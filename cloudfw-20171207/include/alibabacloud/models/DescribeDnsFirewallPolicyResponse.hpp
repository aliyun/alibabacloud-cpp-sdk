...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDnsFirewallPolicyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDnsFirewallPolicyResponseBody) };
    inline DescribeDnsFirewallPolicyResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDnsFirewallPolicyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDnsFirewallPolicyResponseBody> body_ = nullptr;
  };
