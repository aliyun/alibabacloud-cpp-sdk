...
namespace Models
{
  ...
  public:
    ...
    inline const PutEnableAllFwSwitchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PutEnableAllFwSwitchResponseBody) };
    inline PutEnableAllFwSwitchResponseBody getBody() { DARABONBA_PTR_GET(body_, PutEnableAllFwSwitchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PutEnableAllFwSwitchResponseBody> body_ {};
  };
