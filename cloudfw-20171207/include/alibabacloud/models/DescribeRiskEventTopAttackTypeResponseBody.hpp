...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->topAttackTypeList_ == nullptr && return this->totalAttackCnt_ == nullptr && return this->totalProtectCnt_ == nullptr; };
    ...
    inline const vector<DescribeRiskEventTopAttackTypeResponseBodyTopAttackTypeList> & topAttackTypeList() const { DARABONBA_PTR_GET_CONST(topAttackTypeList_, vector<DescribeRiskEventTopAttackTypeResponseBodyTopAttackTypeList>) };
    inline vector<DescribeRiskEventTopAttackTypeResponseBodyTopAttackTypeList> topAttackTypeList() { DARABONBA_PTR_GET(topAttackTypeList_, vector<DescribeRiskEventTopAttackTypeResponseBodyTopAttackTypeList>) };
    inline DescribeRiskEventTopAttackTypeResponseBody& setTopAttackTypeList(const vector<DescribeRiskEventTopAttackTypeResponseBodyTopAttackTypeList> & topAttackTypeList) { DARABONBA_PTR_SET_VALUE(topAttackTypeList_, topAttackTypeList) };
    inline DescribeRiskEventTopAttackTypeResponseBody& setTopAttackTypeList(vector<DescribeRiskEventTopAttackTypeResponseBodyTopAttackTypeList> && topAttackTypeList) { DARABONBA_PTR_SET_RVALUE(topAttackTypeList_, topAttackTypeList) };
    ...
    inline int64_t totalAttackCnt() const { DARABONBA_PTR_GET_DEFAULT(totalAttackCnt_, 0L) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeRiskEventTopAttackTypeResponseBodyTopAttackTypeList>> topAttackTypeList_ = nullptr;
    std::shared_ptr<int64_t> totalAttackCnt_ = nullptr;
