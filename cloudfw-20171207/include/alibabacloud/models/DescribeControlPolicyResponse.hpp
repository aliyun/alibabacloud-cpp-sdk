...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeControlPolicyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeControlPolicyResponseBody) };
    inline DescribeControlPolicyResponseBody body() { DARABONBA_PTR_GET(body_, DescribeControlPolicyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeControlPolicyResponseBody> body_ = nullptr;
  };
