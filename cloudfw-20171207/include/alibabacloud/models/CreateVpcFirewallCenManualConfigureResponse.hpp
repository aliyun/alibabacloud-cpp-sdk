...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVpcFirewallCenManualConfigureResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateVpcFirewallCenManualConfigureResponseBody) };
    inline CreateVpcFirewallCenManualConfigureResponseBody body() { DARABONBA_PTR_GET(body_, CreateVpcFirewallCenManualConfigureResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateVpcFirewallCenManualConfigureResponseBody> body_ = nullptr;
  };
