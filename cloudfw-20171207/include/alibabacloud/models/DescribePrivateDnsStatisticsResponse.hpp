...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePrivateDnsStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePrivateDnsStatisticsResponseBody) };
    inline DescribePrivateDnsStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePrivateDnsStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePrivateDnsStatisticsResponseBody> body_ {};
  };
