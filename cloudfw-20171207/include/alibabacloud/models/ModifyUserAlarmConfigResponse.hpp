...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyUserAlarmConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyUserAlarmConfigResponseBody) };
    inline ModifyUserAlarmConfigResponseBody body() { DARABONBA_PTR_GET(body_, ModifyUserAlarmConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyUserAlarmConfigResponseBody> body_ = nullptr;
  };
