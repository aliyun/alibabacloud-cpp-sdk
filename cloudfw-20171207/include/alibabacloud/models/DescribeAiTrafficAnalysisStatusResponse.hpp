...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAITrafficAnalysisStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAITrafficAnalysisStatusResponseBody) };
    inline DescribeAITrafficAnalysisStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAITrafficAnalysisStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAITrafficAnalysisStatusResponseBody> body_ {};
  };
