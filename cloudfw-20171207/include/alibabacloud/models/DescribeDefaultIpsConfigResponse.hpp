...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDefaultIPSConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDefaultIPSConfigResponseBody) };
    inline DescribeDefaultIPSConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDefaultIPSConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDefaultIPSConfigResponseBody> body_ {};
  };
