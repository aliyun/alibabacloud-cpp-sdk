...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVpcFirewallAssetListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVpcFirewallAssetListResponseBody) };
    inline DescribeVpcFirewallAssetListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVpcFirewallAssetListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVpcFirewallAssetListResponseBody> body_ {};
  };
