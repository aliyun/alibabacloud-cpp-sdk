...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAclCheckDetailStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateAclCheckDetailStatusResponseBody) };
    inline UpdateAclCheckDetailStatusResponseBody body() { DARABONBA_PTR_GET(body_, UpdateAclCheckDetailStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateAclCheckDetailStatusResponseBody> body_ = nullptr;
  };
