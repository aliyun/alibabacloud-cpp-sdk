...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAssetRiskListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAssetRiskListResponseBody) };
    inline DescribeAssetRiskListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAssetRiskListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAssetRiskListResponseBody> body_ {};
  };
