...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVpcFirewallControlPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteVpcFirewallControlPolicyResponseBody) };
    inline DeleteVpcFirewallControlPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteVpcFirewallControlPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteVpcFirewallControlPolicyResponseBody> body_ {};
  };
