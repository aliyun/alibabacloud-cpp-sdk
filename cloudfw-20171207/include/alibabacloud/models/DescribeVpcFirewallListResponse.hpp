...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVpcFirewallListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeVpcFirewallListResponseBody) };
    inline DescribeVpcFirewallListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeVpcFirewallListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVpcFirewallListResponseBody> body_ = nullptr;
  };
