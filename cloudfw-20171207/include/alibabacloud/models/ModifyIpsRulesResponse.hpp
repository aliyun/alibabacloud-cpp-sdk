...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyIpsRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyIpsRulesResponseBody) };
    inline ModifyIpsRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyIpsRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyIpsRulesResponseBody> body_ {};
  };
