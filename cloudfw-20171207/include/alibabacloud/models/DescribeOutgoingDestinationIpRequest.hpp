...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicationName_ == nullptr
        && return this->categoryId_ == nullptr && return this->currentPage_ == nullptr && return this->dstIP_ == nullptr && return this->endTime_ == nullptr && return this->lang_ == nullptr
        && return this->order_ == nullptr && return this->pageSize_ == nullptr && return this->port_ == nullptr && return this->privateIP_ == nullptr && return this->publicIP_ == nullptr
        && return this->sort_ == nullptr && return this->startTime_ == nullptr && return this->tagIdNew_ == nullptr; };
