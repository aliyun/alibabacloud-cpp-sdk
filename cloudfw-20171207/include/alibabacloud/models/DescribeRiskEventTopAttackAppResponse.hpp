...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRiskEventTopAttackAppResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeRiskEventTopAttackAppResponseBody) };
    inline DescribeRiskEventTopAttackAppResponseBody body() { DARABONBA_PTR_GET(body_, DescribeRiskEventTopAttackAppResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeRiskEventTopAttackAppResponseBody> body_ = nullptr;
  };
