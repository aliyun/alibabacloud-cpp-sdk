...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteFirewallV2RoutePoliciesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteFirewallV2RoutePoliciesResponseBody) };
    inline DeleteFirewallV2RoutePoliciesResponseBody body() { DARABONBA_PTR_GET(body_, DeleteFirewallV2RoutePoliciesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteFirewallV2RoutePoliciesResponseBody> body_ = nullptr;
  };
