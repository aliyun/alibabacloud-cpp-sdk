...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVpcFirewallCenConfigureResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyVpcFirewallCenConfigureResponseBody) };
    inline ModifyVpcFirewallCenConfigureResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyVpcFirewallCenConfigureResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyVpcFirewallCenConfigureResponseBody> body_ {};
  };
