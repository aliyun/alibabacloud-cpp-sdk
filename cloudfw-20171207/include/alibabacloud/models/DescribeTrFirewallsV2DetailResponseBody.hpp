...
namespace Models
{
  ...
  public:
    ...
    class TrAttachmentZones : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const TrAttachmentZones& obj) { 
        DARABONBA_PTR_TO_JSON(VSwitchCidr, vSwitchCidr_);
        DARABONBA_PTR_TO_JSON(VSwitchZoneId, vSwitchZoneId_);
      };
      friend void from_json(const Darabonba::Json& j, TrAttachmentZones& obj) { 
        DARABONBA_PTR_FROM_JSON(VSwitchCidr, vSwitchCidr_);
        DARABONBA_PTR_FROM_JSON(VSwitchZoneId, vSwitchZoneId_);
      };
      TrAttachmentZones() = default ;
      TrAttachmentZones(const TrAttachmentZones &) = default ;
      TrAttachmentZones(TrAttachmentZones &&) = default ;
      TrAttachmentZones(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~TrAttachmentZones() = default ;
      TrAttachmentZones& operator=(const TrAttachmentZones &) = default ;
      TrAttachmentZones& operator=(TrAttachmentZones &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      virtual bool empty() const override { return this->vSwitchCidr_ == nullptr
        && this->vSwitchZoneId_ == nullptr; };
      ...
      inline TrAttachmentZones& setVSwitchCidr(string vSwitchCidr) { DARABONBA_PTR_SET_VALUE(vSwitchCidr_, vSwitchCidr) };
      ...
      inline TrAttachmentZones& setVSwitchZoneId(string vSwitchZoneId) { DARABONBA_PTR_SET_VALUE(vSwitchZoneId_, vSwitchZoneId) };
    ...
    virtual bool empty() const override { return this->cenId_ == nullptr
        && this->firewallAttachmentZone_ == nullptr && this->firewallDescription_ == nullptr && this->firewallEniId_ == nullptr && this->firewallEniVpcId_ == nullptr && this->firewallEniVswitchId_ == nullptr
        && this->firewallId_ == nullptr && this->firewallName_ == nullptr && this->firewallServiceMode_ == nullptr && this->firewallServiceZones_ == nullptr && this->firewallStatus_ == nullptr
        && this->firewallSubnetCidr_ == nullptr && this->firewallSwitchStatus_ == nullptr && this->firewallVpcCidr_ == nullptr && this->regionNo_ == nullptr && this->requestId_ == nullptr
        && this->routeMode_ == nullptr && this->trAttachmentId_ == nullptr && this->trAttachmentMasterCidr_ == nullptr && this->trAttachmentMasterZone_ == nullptr && this->trAttachmentSlaveCidr_ == nullptr
    ...
    inline DescribeTrFirewallsV2DetailResponseBody& setFirewallAttachmentZone(string firewallAttachmentZone) { DARABONBA_PTR_SET_VALUE(firewallAttachmentZone_, firewallAttachmentZone) };
    ...
    inline DescribeTrFirewallsV2DetailResponseBody& setFirewallServiceMode(string firewallServiceMode) { DARABONBA_PTR_SET_VALUE(firewallServiceMode_, firewallServiceMode) };
    ...
    inline DescribeTrFirewallsV2DetailResponseBody& setFirewallServiceZones(const vector<string> & firewallServiceZones) { DARABONBA_PTR_SET_VALUE(firewallServiceZones_, firewallServiceZones) };
    inline DescribeTrFirewallsV2DetailResponseBody& setFirewallServiceZones(vector<string> && firewallServiceZones) { DARABONBA_PTR_SET_RVALUE(firewallServiceZones_, firewallServiceZones) };
    ...
    inline const vector<DescribeTrFirewallsV2DetailResponseBody::TrAttachmentZones> & getTrAttachmentZones() const { DARABONBA_PTR_GET_CONST(trAttachmentZones_, vector<DescribeTrFirewallsV2DetailResponseBody::TrAttachmentZones>) };
    inline vector<DescribeTrFirewallsV2DetailResponseBody::TrAttachmentZones> getTrAttachmentZones() { DARABONBA_PTR_GET(trAttachmentZones_, vector<DescribeTrFirewallsV2DetailResponseBody::TrAttachmentZones>) };
    inline DescribeTrFirewallsV2DetailResponseBody& setTrAttachmentZones(const vector<DescribeTrFirewallsV2DetailResponseBody::TrAttachmentZones> & trAttachmentZones) { DARABONBA_PTR_SET_VALUE(trAttachmentZones_, trAttachmentZones) };
    inline DescribeTrFirewallsV2DetailResponseBody& setTrAttachmentZones(vector<DescribeTrFirewallsV2DetailResponseBody::TrAttachmentZones> && trAttachmentZones) { DARABONBA_PTR_SET_RVALUE(trAttachmentZones_, trAttachmentZones) };
