...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && this->riskDomainCount_ == nullptr && this->riskIpCount_ == nullptr && this->totalCount_ == nullptr; };
    ...
    inline int64_t getRiskDomainCount() const { DARABONBA_PTR_GET_DEFAULT(riskDomainCount_, 0L) };
    ...
    inline int64_t getRiskIpCount() const { DARABONBA_PTR_GET_DEFAULT(riskIpCount_, 0L) };
