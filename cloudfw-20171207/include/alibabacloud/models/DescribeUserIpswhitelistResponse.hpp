...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserIPSWhitelistResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeUserIPSWhitelistResponseBody) };
    inline DescribeUserIPSWhitelistResponseBody body() { DARABONBA_PTR_GET(body_, DescribeUserIPSWhitelistResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeUserIPSWhitelistResponseBody> body_ = nullptr;
  };
