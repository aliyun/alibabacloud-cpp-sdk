...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aclConfig_ == nullptr
        && return this->cenId_ == nullptr && return this->cenName_ == nullptr && return this->cloudFirewallVpcOrderType_ == nullptr && return this->firewallId_ == nullptr && return this->firewallSwitchStatus_ == nullptr
        && return this->ipsConfig_ == nullptr && return this->ownerId_ == nullptr && return this->precheckStatus_ == nullptr && return this->protectedResource_ == nullptr && return this->regionNo_ == nullptr
        && return this->regionStatus_ == nullptr && return this->resultCode_ == nullptr && return this->routeMode_ == nullptr && return this->transitRouterId_ == nullptr && return this->unprotectedResource_ == nullptr
