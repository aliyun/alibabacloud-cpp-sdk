...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAckClusterConnectorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAckClusterConnectorResponseBody) };
    inline DeleteAckClusterConnectorResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAckClusterConnectorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAckClusterConnectorResponseBody> body_ {};
  };
