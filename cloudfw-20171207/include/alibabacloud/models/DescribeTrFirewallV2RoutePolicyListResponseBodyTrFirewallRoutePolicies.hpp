...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->destCandidateList_ == nullptr
        && return this->policyDescription_ == nullptr && return this->policyName_ == nullptr && return this->policyStatus_ == nullptr && return this->policyType_ == nullptr && return this->srcCandidateList_ == nullptr
        && return this->trFirewallRoutePolicyId_ == nullptr; };
