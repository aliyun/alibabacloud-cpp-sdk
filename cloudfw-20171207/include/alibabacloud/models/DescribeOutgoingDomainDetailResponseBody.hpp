  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->aclCoverage_ == nullptr
        && this->domain_ == nullptr && this->firstTime_ == nullptr && this->inBytes_ == nullptr && this->ipsHitCnt_ == nullptr && this->lastTime_ == nullptr
      ...
      inline AssetList& setDomain(string domain) { DARABONBA_PTR_SET_VALUE(domain_, domain) };
    ...
    virtual bool empty() const override { return this->applicationNameList_ == nullptr
        && this->assetList_ == nullptr && this->requestId_ == nullptr && this->totalCount_ == nullptr; };
    ...
    inline const vector<DescribeOutgoingDomainDetailResponseBody::AssetList> & getAssetList() const { DARABONBA_PTR_GET_CONST(assetList_, vector<DescribeOutgoingDomainDetailResponseBody::AssetList>) };
    inline vector<DescribeOutgoingDomainDetailResponseBody::AssetList> getAssetList() { DARABONBA_PTR_GET(assetList_, vector<DescribeOutgoingDomainDetailResponseBody::AssetList>) };
    inline DescribeOutgoingDomainDetailResponseBody& setAssetList(const vector<DescribeOutgoingDomainDetailResponseBody::AssetList> & assetList) { DARABONBA_PTR_SET_VALUE(assetList_, assetList) };
    inline DescribeOutgoingDomainDetailResponseBody& setAssetList(vector<DescribeOutgoingDomainDetailResponseBody::AssetList> && assetList) { DARABONBA_PTR_SET_RVALUE(assetList_, assetList) };
