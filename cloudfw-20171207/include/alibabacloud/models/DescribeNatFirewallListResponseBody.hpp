...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->natFirewallList_ != nullptr
    ...
    inline const vector<DescribeNatFirewallListResponseBodyNatFirewallList> & natFirewallList() const { DARABONBA_PTR_GET_CONST(natFirewallList_, vector<DescribeNatFirewallListResponseBodyNatFirewallList>) };
    inline vector<DescribeNatFirewallListResponseBodyNatFirewallList> natFirewallList() { DARABONBA_PTR_GET(natFirewallList_, vector<DescribeNatFirewallListResponseBodyNatFirewallList>) };
    inline DescribeNatFirewallListResponseBody& setNatFirewallList(const vector<DescribeNatFirewallListResponseBodyNatFirewallList> & natFirewallList) { DARABONBA_PTR_SET_VALUE(natFirewallList_, natFirewallList) };
    inline DescribeNatFirewallListResponseBody& setNatFirewallList(vector<DescribeNatFirewallListResponseBodyNatFirewallList> && natFirewallList) { DARABONBA_PTR_SET_RVALUE(natFirewallList_, natFirewallList) };
  ...
  protected:
    // The NAT firewalls.
    std::shared_ptr<vector<DescribeNatFirewallListResponseBodyNatFirewallList>> natFirewallList_ = nullptr;
    // The request ID.
