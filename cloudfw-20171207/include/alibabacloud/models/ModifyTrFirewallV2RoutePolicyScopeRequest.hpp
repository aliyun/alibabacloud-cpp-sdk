...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->destCandidateList_ == nullptr
        && return this->firewallId_ == nullptr && return this->lang_ == nullptr && return this->shouldRecover_ == nullptr && return this->srcCandidateList_ == nullptr && return this->trFirewallRoutePolicyId_ == nullptr; };
