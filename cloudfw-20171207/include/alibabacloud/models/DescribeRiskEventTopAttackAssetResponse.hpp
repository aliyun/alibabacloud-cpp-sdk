...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRiskEventTopAttackAssetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRiskEventTopAttackAssetResponseBody) };
    inline DescribeRiskEventTopAttackAssetResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRiskEventTopAttackAssetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRiskEventTopAttackAssetResponseBody> body_ {};
  };
