...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVpcZoneResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeVpcZoneResponseBody) };
    inline DescribeVpcZoneResponseBody body() { DARABONBA_PTR_GET(body_, DescribeVpcZoneResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVpcZoneResponseBody> body_ = nullptr;
  };
