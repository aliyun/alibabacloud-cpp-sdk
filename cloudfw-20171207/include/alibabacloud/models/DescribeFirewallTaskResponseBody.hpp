  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->stepInfo_ == nullptr
        && this->stepName_ == nullptr && this->stepProgress_ == nullptr && this->stepStatus_ == nullptr; };
      // stepInfo Field Functions 
      bool hasStepInfo() const { return this->stepInfo_ != nullptr;};
      void deleteStepInfo() { this->stepInfo_ = nullptr;};
      inline string getStepInfo() const { DARABONBA_PTR_GET_DEFAULT(stepInfo_, "") };
      inline TaskSteps& setStepInfo(string stepInfo) { DARABONBA_PTR_SET_VALUE(stepInfo_, stepInfo) };
    ...
    virtual bool empty() const override { return this->isFound_ == nullptr
        ...
        && this->taskStatus_ == nullptr && this->taskSteps_ == nullptr && this->taskWaitingTime_ == nullptr; };
    ...
    inline string getTaskFinishTimestamp() const { DARABONBA_PTR_GET_DEFAULT(taskFinishTimestamp_, "") };
    ...
    inline string getTaskStartTimestamp() const { DARABONBA_PTR_GET_DEFAULT(taskStartTimestamp_, "") };
    ...
    inline const vector<DescribeFirewallTaskResponseBody::TaskSteps> & getTaskSteps() const { DARABONBA_PTR_GET_CONST(taskSteps_, vector<DescribeFirewallTaskResponseBody::TaskSteps>) };
    inline vector<DescribeFirewallTaskResponseBody::TaskSteps> getTaskSteps() { DARABONBA_PTR_GET(taskSteps_, vector<DescribeFirewallTaskResponseBody::TaskSteps>) };
    inline DescribeFirewallTaskResponseBody& setTaskSteps(const vector<DescribeFirewallTaskResponseBody::TaskSteps> & taskSteps) { DARABONBA_PTR_SET_VALUE(taskSteps_, taskSteps) };
    inline DescribeFirewallTaskResponseBody& setTaskSteps(vector<DescribeFirewallTaskResponseBody::TaskSteps> && taskSteps) { DARABONBA_PTR_SET_RVALUE(taskSteps_, taskSteps) };
    ...
    inline string getTaskWaitingTime() const { DARABONBA_PTR_GET_DEFAULT(taskWaitingTime_, "") };
