...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeVpcFirewallCenSummaryListResponseBodyCenList> & cenList() const { DARABONBA_PTR_GET_CONST(cenList_, vector<DescribeVpcFirewallCenSummaryListResponseBodyCenList>) };
    inline vector<DescribeVpcFirewallCenSummaryListResponseBodyCenList> cenList() { DARABONBA_PTR_GET(cenList_, vector<DescribeVpcFirewallCenSummaryListResponseBodyCenList>) };
    inline DescribeVpcFirewallCenSummaryListResponseBody& setCenList(const vector<DescribeVpcFirewallCenSummaryListResponseBodyCenList> & cenList) { DARABONBA_PTR_SET_VALUE(cenList_, cenList) };
    inline DescribeVpcFirewallCenSummaryListResponseBody& setCenList(vector<DescribeVpcFirewallCenSummaryListResponseBodyCenList> && cenList) { DARABONBA_PTR_SET_RVALUE(cenList_, cenList) };
  ...
  protected:
    std::shared_ptr<vector<DescribeVpcFirewallCenSummaryListResponseBodyCenList>> cenList_ = nullptr;
