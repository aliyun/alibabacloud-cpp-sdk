...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVpcFirewallTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVpcFirewallTaskResponseBody) };
    inline CreateVpcFirewallTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVpcFirewallTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVpcFirewallTaskResponseBody> body_ {};
  };
