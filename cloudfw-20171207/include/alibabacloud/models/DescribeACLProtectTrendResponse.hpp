...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeACLProtectTrendResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeACLProtectTrendResponseBody) };
    inline DescribeACLProtectTrendResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeACLProtectTrendResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeACLProtectTrendResponseBody> body_ {};
  };
