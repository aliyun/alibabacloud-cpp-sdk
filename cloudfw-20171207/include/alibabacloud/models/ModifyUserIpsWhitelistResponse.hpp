...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyUserIPSWhitelistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyUserIPSWhitelistResponseBody) };
    inline ModifyUserIPSWhitelistResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyUserIPSWhitelistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyUserIPSWhitelistResponseBody> body_ {};
  };
