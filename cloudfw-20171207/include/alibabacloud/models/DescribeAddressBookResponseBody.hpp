  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->ackClusterConnectorId_ == nullptr
        ...
        && this->addresses_ == nullptr && this->assetMemberUids_ == nullptr && this->assetRegionResourceTypes_ == nullptr && this->autoAddTagEcs_ == nullptr && this->description_ == nullptr
        && this->groupName_ == nullptr && this->groupType_ == nullptr && this->groupUuid_ == nullptr && this->referenceCount_ == nullptr && this->regionNo_ == nullptr
        && this->tagList_ == nullptr && this->tagRelation_ == nullptr; };
      ...
      inline Acls& setAssetMemberUids(const vector<int64_t> & assetMemberUids) { DARABONBA_PTR_SET_VALUE(assetMemberUids_, assetMemberUids) };
      inline Acls& setAssetMemberUids(vector<int64_t> && assetMemberUids) { DARABONBA_PTR_SET_RVALUE(assetMemberUids_, assetMemberUids) };
      ...
      inline const vector<Acls::AssetRegionResourceTypes> & getAssetRegionResourceTypes() const { DARABONBA_PTR_GET_CONST(assetRegionResourceTypes_, vector<Acls::AssetRegionResourceTypes>) };
      inline vector<Acls::AssetRegionResourceTypes> getAssetRegionResourceTypes() { DARABONBA_PTR_GET(assetRegionResourceTypes_, vector<Acls::AssetRegionResourceTypes>) };
      inline Acls& setAssetRegionResourceTypes(const vector<Acls::AssetRegionResourceTypes> & assetRegionResourceTypes) { DARABONBA_PTR_SET_VALUE(assetRegionResourceTypes_, assetRegionResourceTypes) };
      inline Acls& setAssetRegionResourceTypes(vector<Acls::AssetRegionResourceTypes> && assetRegionResourceTypes) { DARABONBA_PTR_SET_RVALUE(assetRegionResourceTypes_, assetRegionResourceTypes) };
    ...
    protected:
      ...
      shared_ptr<vector<Acls::AssetRegionResourceTypes>> assetRegionResourceTypes_ {};
