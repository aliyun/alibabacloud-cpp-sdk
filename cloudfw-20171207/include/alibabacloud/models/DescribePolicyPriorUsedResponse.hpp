...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePolicyPriorUsedResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePolicyPriorUsedResponseBody) };
    inline DescribePolicyPriorUsedResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePolicyPriorUsedResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePolicyPriorUsedResponseBody> body_ {};
  };
