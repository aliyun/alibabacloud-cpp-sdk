...
#ifndef ALIBABACLOUD_MODELS_UPDATEACLCHECKDETAILSTATUSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATEACLCHECKDETAILSTATUSRESPONSEBODY_HPP_
...
namespace Models
{
  class UpdateAclCheckDetailStatusResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateAclCheckDetailStatusResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(CheckRecord, checkRecord_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateAclCheckDetailStatusResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(CheckRecord, checkRecord_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    UpdateAclCheckDetailStatusResponseBody() = default ;
    UpdateAclCheckDetailStatusResponseBody(const UpdateAclCheckDetailStatusResponseBody &) = default ;
    UpdateAclCheckDetailStatusResponseBody(UpdateAclCheckDetailStatusResponseBody &&) = default ;
    UpdateAclCheckDetailStatusResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateAclCheckDetailStatusResponseBody() = default ;
    UpdateAclCheckDetailStatusResponseBody& operator=(const UpdateAclCheckDetailStatusResponseBody &) = default ;
    UpdateAclCheckDetailStatusResponseBody& operator=(UpdateAclCheckDetailStatusResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->aclUuid_ == nullptr && this->addressList_ == nullptr && this->addressListCount_ == nullptr && this->applicationId_ == nullptr && this->applicationName_ == nullptr
        && this->applicationNameList_ == nullptr && this->autoAddTagEcs_ == nullptr && this->createTime_ == nullptr && this->description_ == nullptr && this->destPort_ == nullptr
        ...
        && this->destinationGroupType_ == nullptr && this->destinationType_ == nullptr && this->direction_ == nullptr && this->dnsResult_ == nullptr && this->dnsResultTime_ == nullptr
        && this->domainResolveType_ == nullptr && this->endTime_ == nullptr && this->groupName_ == nullptr && this->groupType_ == nullptr && this->groupUuid_ == nullptr
        && this->hitLastTime_ == nullptr && this->hitTimes_ == nullptr && this->ipVersion_ == nullptr && this->modifyTime_ == nullptr && this->natGatewayId_ == nullptr
        && this->order_ == nullptr && this->proto_ == nullptr && this->referenceCount_ == nullptr && this->release_ == nullptr && this->repeatDays_ == nullptr
        && this->repeatEndTime_ == nullptr && this->repeatStartTime_ == nullptr && this->repeatType_ == nullptr && this->source_ == nullptr && this->sourceGroupCidrs_ == nullptr
        && this->sourceGroupType_ == nullptr && this->sourceType_ == nullptr && this->spreadCnt_ == nullptr && this->startTime_ == nullptr && this->tagList_ == nullptr
        && this->tagRelation_ == nullptr && this->vpcFirewallId_ == nullptr; };
      ...
      virtual bool empty() const override { return this->acls_ == nullptr
        && this->checkName_ == nullptr && this->description_ == nullptr && this->lastCheckTime_ == nullptr && this->level_ == nullptr && this->policyTotalCount_ == nullptr
      ...
      inline int64_t getPolicyTotalCount() const { DARABONBA_PTR_GET_DEFAULT(policyTotalCount_, 0L) };
      inline CheckRecord& setPolicyTotalCount(int64_t policyTotalCount) { DARABONBA_PTR_SET_VALUE(policyTotalCount_, policyTotalCount) };
    ...
    protected:
      ...
      shared_ptr<int64_t> policyTotalCount_ {};
    ...
    inline const UpdateAclCheckDetailStatusResponseBody::CheckRecord & getCheckRecord() const { DARABONBA_PTR_GET_CONST(checkRecord_, UpdateAclCheckDetailStatusResponseBody::CheckRecord) };
    inline UpdateAclCheckDetailStatusResponseBody::CheckRecord getCheckRecord() { DARABONBA_PTR_GET(checkRecord_, UpdateAclCheckDetailStatusResponseBody::CheckRecord) };
    inline UpdateAclCheckDetailStatusResponseBody& setCheckRecord(const UpdateAclCheckDetailStatusResponseBody::CheckRecord & checkRecord) { DARABONBA_PTR_SET_VALUE(checkRecord_, checkRecord) };
    inline UpdateAclCheckDetailStatusResponseBody& setCheckRecord(UpdateAclCheckDetailStatusResponseBody::CheckRecord && checkRecord) { DARABONBA_PTR_SET_RVALUE(checkRecord_, checkRecord) };
    ...
    inline UpdateAclCheckDetailStatusResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<UpdateAclCheckDetailStatusResponseBody::CheckRecord> checkRecord_ {};
