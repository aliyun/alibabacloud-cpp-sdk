...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAclChecksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAclChecksResponseBody) };
    inline DescribeAclChecksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAclChecksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAclChecksResponseBody> body_ {};
  };
