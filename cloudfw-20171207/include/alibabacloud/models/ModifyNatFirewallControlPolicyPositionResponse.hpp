...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyNatFirewallControlPolicyPositionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyNatFirewallControlPolicyPositionResponseBody) };
    inline ModifyNatFirewallControlPolicyPositionResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyNatFirewallControlPolicyPositionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyNatFirewallControlPolicyPositionResponseBody> body_ {};
  };
