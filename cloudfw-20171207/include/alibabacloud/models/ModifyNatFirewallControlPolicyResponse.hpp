...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyNatFirewallControlPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyNatFirewallControlPolicyResponseBody) };
    inline ModifyNatFirewallControlPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyNatFirewallControlPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyNatFirewallControlPolicyResponseBody> body_ {};
  };
