...
namespace Models
{
  ...
  public:
    ...
    inline ModifyAddressBookRequest& setAssetMemberUids(const vector<int64_t> & assetMemberUids) { DARABONBA_PTR_SET_VALUE(assetMemberUids_, assetMemberUids) };
    inline ModifyAddressBookRequest& setAssetMemberUids(vector<int64_t> && assetMemberUids) { DARABONBA_PTR_SET_RVALUE(assetMemberUids_, assetMemberUids) };
    ...
    inline const vector<ModifyAddressBookRequest::AssetRegionResourceTypes> & getAssetRegionResourceTypes() const { DARABONBA_PTR_GET_CONST(assetRegionResourceTypes_, vector<ModifyAddressBookRequest::AssetRegionResourceTypes>) };
    inline vector<ModifyAddressBookRequest::AssetRegionResourceTypes> getAssetRegionResourceTypes() { DARABONBA_PTR_GET(assetRegionResourceTypes_, vector<ModifyAddressBookRequest::AssetRegionResourceTypes>) };
    inline ModifyAddressBookRequest& setAssetRegionResourceTypes(const vector<ModifyAddressBookRequest::AssetRegionResourceTypes> & assetRegionResourceTypes) { DARABONBA_PTR_SET_VALUE(assetRegionResourceTypes_, assetRegionResourceTypes) };
    inline ModifyAddressBookRequest& setAssetRegionResourceTypes(vector<ModifyAddressBookRequest::AssetRegionResourceTypes> && assetRegionResourceTypes) { DARABONBA_PTR_SET_RVALUE(assetRegionResourceTypes_, assetRegionResourceTypes) };
