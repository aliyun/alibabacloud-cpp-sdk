...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAclAppsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAclAppsResponseBody) };
    inline DescribeAclAppsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAclAppsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAclAppsResponseBody> body_ {};
  };
