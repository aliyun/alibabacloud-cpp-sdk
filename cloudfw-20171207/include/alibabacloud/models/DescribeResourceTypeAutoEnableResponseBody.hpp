...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->resourceTypeAutoEnable_ == nullptr; };
    ...
    inline const map<string, bool> & resourceTypeAutoEnable() const { DARABONBA_PTR_GET_CONST(resourceTypeAutoEnable_, map<string, bool>) };
    inline map<string, bool> resourceTypeAutoEnable() { DARABONBA_PTR_GET(resourceTypeAutoEnable_, map<string, bool>) };
  ...
  protected:
    ...
    std::shared_ptr<map<string, bool>> resourceTypeAutoEnable_ = nullptr;
  };
