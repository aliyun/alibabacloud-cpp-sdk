...
namespace Models
{
  ...
  public:
    ...
    inline const AddControlPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddControlPolicyResponseBody) };
    inline AddControlPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, AddControlPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddControlPolicyResponseBody> body_ {};
  };
