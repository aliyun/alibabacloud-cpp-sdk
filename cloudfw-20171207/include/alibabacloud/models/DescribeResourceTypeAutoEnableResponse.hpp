...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourceTypeAutoEnableResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeResourceTypeAutoEnableResponseBody) };
    inline DescribeResourceTypeAutoEnableResponseBody body() { DARABONBA_PTR_GET(body_, DescribeResourceTypeAutoEnableResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeResourceTypeAutoEnableResponseBody> body_ = nullptr;
  };
