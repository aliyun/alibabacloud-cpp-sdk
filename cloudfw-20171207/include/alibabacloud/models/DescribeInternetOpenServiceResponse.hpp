...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInternetOpenServiceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeInternetOpenServiceResponseBody) };
    inline DescribeInternetOpenServiceResponseBody body() { DARABONBA_PTR_GET(body_, DescribeInternetOpenServiceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeInternetOpenServiceResponseBody> body_ = nullptr;
  };
