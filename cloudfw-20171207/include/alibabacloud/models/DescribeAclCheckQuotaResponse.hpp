...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAclCheckQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAclCheckQuotaResponseBody) };
    inline DescribeAclCheckQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAclCheckQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAclCheckQuotaResponseBody> body_ {};
  };
