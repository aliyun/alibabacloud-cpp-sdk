...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->aclConfig_ != nullptr
        && this->bandwidth_ != nullptr && this->connectSubType_ != nullptr && this->connectType_ != nullptr && this->firewallSwitchStatus_ != nullptr && this->ipsConfig_ != nullptr
        && this->localVpc_ != nullptr && this->memberUid_ != nullptr && this->peerVpc_ != nullptr && this->regionStatus_ != nullptr && this->resultCode_ != nullptr
