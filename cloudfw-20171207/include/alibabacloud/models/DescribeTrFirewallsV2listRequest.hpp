...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->cenId_ != nullptr
        && this->currentPage_ != nullptr && this->firewallId_ != nullptr && this->firewallName_ != nullptr && this->firewallSwitchStatus_ != nullptr && this->lang_ != nullptr
        && this->ownerId_ != nullptr && this->pageSize_ != nullptr && this->regionNo_ != nullptr && this->routeMode_ != nullptr && this->transitRouterId_ != nullptr; };
