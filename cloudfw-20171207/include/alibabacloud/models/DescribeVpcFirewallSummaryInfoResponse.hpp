...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVpcFirewallSummaryInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVpcFirewallSummaryInfoResponseBody) };
    inline DescribeVpcFirewallSummaryInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVpcFirewallSummaryInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVpcFirewallSummaryInfoResponseBody> body_ {};
  };
