...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->assetsIP_ == nullptr
    ...
    inline string getAssetsIP() const { DARABONBA_PTR_GET_DEFAULT(assetsIP_, "") };
    ...
    inline string getIsIgnore() const { DARABONBA_PTR_GET_DEFAULT(isIgnore_, "") };
    ...
    inline const vector<int32_t> & getProcessStatusList() const { DARABONBA_PTR_GET_CONST(processStatusList_, vector<int32_t>) };
    inline vector<int32_t> getProcessStatusList() { DARABONBA_PTR_GET(processStatusList_, vector<int32_t>) };
    ...
    inline const vector<int32_t> & getRiskLevel() const { DARABONBA_PTR_GET_CONST(riskLevel_, vector<int32_t>) };
    inline vector<int32_t> getRiskLevel() { DARABONBA_PTR_GET(riskLevel_, vector<int32_t>) };
