...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteInstanceMembersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteInstanceMembersResponseBody) };
    inline DeleteInstanceMembersResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteInstanceMembersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteInstanceMembersResponseBody> body_ {};
  };
