...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessInstanceId_ == nullptr
        && return this->accessInstanceName_ == nullptr && return this->firewallType_ == nullptr && return this->memberUid_ == nullptr && return this->pageNo_ == nullptr && return this->pageSize_ == nullptr
        && return this->regionNo_ == nullptr && return this->status_ == nullptr && return this->vpcId_ == nullptr; };
