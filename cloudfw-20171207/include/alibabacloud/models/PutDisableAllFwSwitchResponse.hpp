...
namespace Models
{
  ...
  public:
    ...
    inline const PutDisableAllFwSwitchResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, PutDisableAllFwSwitchResponseBody) };
    inline PutDisableAllFwSwitchResponseBody body() { DARABONBA_PTR_GET(body_, PutDisableAllFwSwitchResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<PutDisableAllFwSwitchResponseBody> body_ = nullptr;
  };
