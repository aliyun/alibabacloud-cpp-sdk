...
#ifndef ALIBABACLOUD_MODELS_UPDATEACLCHECKDETAILSTATUSRESPONSEBODYCHECKRECORDACLSACL_HPP_
#define ALIBABACLOUD_MODELS_UPDATEACLCHECKDETAILSTATUSRESPONSEBODYCHECKRECORDACLSACL_HPP_
...
namespace Models
{
  class UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& obj) { 
    ...
    UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl() = default ;
    UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl(const UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl &) = default ;
    UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl(UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl &&) = default ;
    UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl() = default ;
    UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& operator=(const UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl &) = default ;
    UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& operator=(UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->aclAction_ == nullptr
        && return this->aclUuid_ == nullptr && return this->addressList_ == nullptr && return this->addressListCount_ == nullptr && return this->applicationId_ == nullptr && return this->applicationName_ == nullptr
        && return this->applicationNameList_ == nullptr && return this->autoAddTagEcs_ == nullptr && return this->createTime_ == nullptr && return this->description_ == nullptr && return this->destPort_ == nullptr
        ...
        && return this->destinationGroupType_ == nullptr && return this->destinationType_ == nullptr && return this->direction_ == nullptr && return this->dnsResult_ == nullptr && return this->dnsResultTime_ == nullptr
        && return this->domainResolveType_ == nullptr && return this->endTime_ == nullptr && return this->groupName_ == nullptr && return this->groupType_ == nullptr && return this->groupUuid_ == nullptr
        && return this->hitLastTime_ == nullptr && return this->hitTimes_ == nullptr && return this->ipVersion_ == nullptr && return this->modifyTime_ == nullptr && return this->natGatewayId_ == nullptr
        && return this->order_ == nullptr && return this->proto_ == nullptr && return this->referenceCount_ == nullptr && return this->release_ == nullptr && return this->repeatDays_ == nullptr
        && return this->repeatEndTime_ == nullptr && return this->repeatStartTime_ == nullptr && return this->repeatType_ == nullptr && return this->source_ == nullptr && return this->sourceGroupCidrs_ == nullptr
        && return this->sourceGroupType_ == nullptr && return this->sourceType_ == nullptr && return this->spreadCnt_ == nullptr && return this->startTime_ == nullptr && return this->tagList_ == nullptr
        && return this->tagRelation_ == nullptr && return this->vpcFirewallId_ == nullptr; };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setAclAction(string aclAction) { DARABONBA_PTR_SET_VALUE(aclAction_, aclAction) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setAclUuid(string aclUuid) { DARABONBA_PTR_SET_VALUE(aclUuid_, aclUuid) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setAddressList(const vector<string> & addressList) { DARABONBA_PTR_SET_VALUE(addressList_, addressList) };
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setAddressList(vector<string> && addressList) { DARABONBA_PTR_SET_RVALUE(addressList_, addressList) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setAddressListCount(int32_t addressListCount) { DARABONBA_PTR_SET_VALUE(addressListCount_, addressListCount) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setApplicationId(string applicationId) { DARABONBA_PTR_SET_VALUE(applicationId_, applicationId) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setApplicationName(string applicationName) { DARABONBA_PTR_SET_VALUE(applicationName_, applicationName) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setApplicationNameList(const vector<string> & applicationNameList) { DARABONBA_PTR_SET_VALUE(applicationNameList_, applicationNameList) };
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setApplicationNameList(vector<string> && applicationNameList) { DARABONBA_PTR_SET_RVALUE(applicationNameList_, applicationNameList) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setAutoAddTagEcs(int32_t autoAddTagEcs) { DARABONBA_PTR_SET_VALUE(autoAddTagEcs_, autoAddTagEcs) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setDestPort(string destPort) { DARABONBA_PTR_SET_VALUE(destPort_, destPort) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setDestPortGroup(string destPortGroup) { DARABONBA_PTR_SET_VALUE(destPortGroup_, destPortGroup) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setDestPortGroupPorts(const vector<string> & destPortGroupPorts) { DARABONBA_PTR_SET_VALUE(destPortGroupPorts_, destPortGroupPorts) };
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setDestPortGroupPorts(vector<string> && destPortGroupPorts) { DARABONBA_PTR_SET_RVALUE(destPortGroupPorts_, destPortGroupPorts) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setDestPortType(string destPortType) { DARABONBA_PTR_SET_VALUE(destPortType_, destPortType) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setDestination(string destination) { DARABONBA_PTR_SET_VALUE(destination_, destination) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setDestinationGroupCidrs(const vector<string> & destinationGroupCidrs) { DARABONBA_PTR_SET_VALUE(destinationGroupCidrs_, destinationGroupCidrs) };
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setDestinationGroupCidrs(vector<string> && destinationGroupCidrs) { DARABONBA_PTR_SET_RVALUE(destinationGroupCidrs_, destinationGroupCidrs) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setDestinationGroupType(string destinationGroupType) { DARABONBA_PTR_SET_VALUE(destinationGroupType_, destinationGroupType) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setDestinationType(string destinationType) { DARABONBA_PTR_SET_VALUE(destinationType_, destinationType) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setDirection(string direction) { DARABONBA_PTR_SET_VALUE(direction_, direction) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setDnsResult(string dnsResult) { DARABONBA_PTR_SET_VALUE(dnsResult_, dnsResult) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setDnsResultTime(int64_t dnsResultTime) { DARABONBA_PTR_SET_VALUE(dnsResultTime_, dnsResultTime) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setDomainResolveType(int32_t domainResolveType) { DARABONBA_PTR_SET_VALUE(domainResolveType_, domainResolveType) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setEndTime(int64_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setGroupName(string groupName) { DARABONBA_PTR_SET_VALUE(groupName_, groupName) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setGroupType(string groupType) { DARABONBA_PTR_SET_VALUE(groupType_, groupType) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setGroupUuid(string groupUuid) { DARABONBA_PTR_SET_VALUE(groupUuid_, groupUuid) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setHitLastTime(int64_t hitLastTime) { DARABONBA_PTR_SET_VALUE(hitLastTime_, hitLastTime) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setHitTimes(int64_t hitTimes) { DARABONBA_PTR_SET_VALUE(hitTimes_, hitTimes) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setIpVersion(int32_t ipVersion) { DARABONBA_PTR_SET_VALUE(ipVersion_, ipVersion) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setModifyTime(int64_t modifyTime) { DARABONBA_PTR_SET_VALUE(modifyTime_, modifyTime) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setNatGatewayId(string natGatewayId) { DARABONBA_PTR_SET_VALUE(natGatewayId_, natGatewayId) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setOrder(int32_t order) { DARABONBA_PTR_SET_VALUE(order_, order) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setProto(string proto) { DARABONBA_PTR_SET_VALUE(proto_, proto) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setReferenceCount(int32_t referenceCount) { DARABONBA_PTR_SET_VALUE(referenceCount_, referenceCount) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setRelease(string release) { DARABONBA_PTR_SET_VALUE(release_, release) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setRepeatDays(const vector<int64_t> & repeatDays) { DARABONBA_PTR_SET_VALUE(repeatDays_, repeatDays) };
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setRepeatDays(vector<int64_t> && repeatDays) { DARABONBA_PTR_SET_RVALUE(repeatDays_, repeatDays) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setRepeatEndTime(string repeatEndTime) { DARABONBA_PTR_SET_VALUE(repeatEndTime_, repeatEndTime) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setRepeatStartTime(string repeatStartTime) { DARABONBA_PTR_SET_VALUE(repeatStartTime_, repeatStartTime) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setRepeatType(string repeatType) { DARABONBA_PTR_SET_VALUE(repeatType_, repeatType) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setSourceGroupCidrs(const vector<string> & sourceGroupCidrs) { DARABONBA_PTR_SET_VALUE(sourceGroupCidrs_, sourceGroupCidrs) };
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setSourceGroupCidrs(vector<string> && sourceGroupCidrs) { DARABONBA_PTR_SET_RVALUE(sourceGroupCidrs_, sourceGroupCidrs) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setSourceGroupType(string sourceGroupType) { DARABONBA_PTR_SET_VALUE(sourceGroupType_, sourceGroupType) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setSourceType(string sourceType) { DARABONBA_PTR_SET_VALUE(sourceType_, sourceType) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setSpreadCnt(int32_t spreadCnt) { DARABONBA_PTR_SET_VALUE(spreadCnt_, spreadCnt) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setStartTime(int64_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };


    // tagList Field Functions 
    bool hasTagList() const { return this->tagList_ != nullptr;};
    void deleteTagList() { this->tagList_ = nullptr;};
    inline const vector<Models::UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAclTagList> & tagList() const { DARABONBA_PTR_GET_CONST(tagList_, vector<Models::UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAclTagList>) };
    inline vector<Models::UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAclTagList> tagList() { DARABONBA_PTR_GET(tagList_, vector<Models::UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAclTagList>) };
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setTagList(const vector<Models::UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAclTagList> & tagList) { DARABONBA_PTR_SET_VALUE(tagList_, tagList) };
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setTagList(vector<Models::UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAclTagList> && tagList) { DARABONBA_PTR_SET_RVALUE(tagList_, tagList) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setTagRelation(string tagRelation) { DARABONBA_PTR_SET_VALUE(tagRelation_, tagRelation) };
    ...
    inline UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAcl& setVpcFirewallId(string vpcFirewallId) { DARABONBA_PTR_SET_VALUE(vpcFirewallId_, vpcFirewallId) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::UpdateAclCheckDetailStatusResponseBodyCheckRecordAclsAclTagList>> tagList_ = nullptr;
