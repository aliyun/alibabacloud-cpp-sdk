...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Policys& setApplicationId(string applicationId) { DARABONBA_PTR_SET_VALUE(applicationId_, applicationId) };
      ...
      inline Policys& setApplicationName(string applicationName) { DARABONBA_PTR_SET_VALUE(applicationName_, applicationName) };
      ...
      inline Policys& setDomainResolveType(string domainResolveType) { DARABONBA_PTR_SET_VALUE(domainResolveType_, domainResolveType) };
      ...
      inline Policys& setMemberUid(string memberUid) { DARABONBA_PTR_SET_VALUE(memberUid_, memberUid) };
      ...
      inline int64_t getSpreadCnt() const { DARABONBA_PTR_GET_DEFAULT(spreadCnt_, 0L) };
      inline Policys& setSpreadCnt(int64_t spreadCnt) { DARABONBA_PTR_SET_VALUE(spreadCnt_, spreadCnt) };
    ...
    inline const vector<DescribeVpcFirewallControlPolicyResponseBody::Policys> & getPolicys() const { DARABONBA_PTR_GET_CONST(policys_, vector<DescribeVpcFirewallControlPolicyResponseBody::Policys>) };
    inline vector<DescribeVpcFirewallControlPolicyResponseBody::Policys> getPolicys() { DARABONBA_PTR_GET(policys_, vector<DescribeVpcFirewallControlPolicyResponseBody::Policys>) };
    inline DescribeVpcFirewallControlPolicyResponseBody& setPolicys(const vector<DescribeVpcFirewallControlPolicyResponseBody::Policys> & policys) { DARABONBA_PTR_SET_VALUE(policys_, policys) };
    inline DescribeVpcFirewallControlPolicyResponseBody& setPolicys(vector<DescribeVpcFirewallControlPolicyResponseBody::Policys> && policys) { DARABONBA_PTR_SET_RVALUE(policys_, policys) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeVpcFirewallControlPolicyResponseBody::Policys>> policys_ {};
