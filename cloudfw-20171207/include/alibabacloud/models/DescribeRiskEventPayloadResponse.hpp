...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRiskEventPayloadResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRiskEventPayloadResponseBody) };
    inline DescribeRiskEventPayloadResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRiskEventPayloadResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRiskEventPayloadResponseBody> body_ {};
  };
