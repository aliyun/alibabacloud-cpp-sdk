...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRiskEventGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRiskEventGroupResponseBody) };
    inline DescribeRiskEventGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRiskEventGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRiskEventGroupResponseBody> body_ {};
  };
