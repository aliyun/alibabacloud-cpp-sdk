...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSignatureLibVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSignatureLibVersionResponseBody) };
    inline DescribeSignatureLibVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSignatureLibVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSignatureLibVersionResponseBody> body_ {};
  };
