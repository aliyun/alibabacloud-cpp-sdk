...
namespace Models
{
  ...
  public:
    ...
    inline const AddInstanceMembersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddInstanceMembersResponseBody) };
    inline AddInstanceMembersResponseBody getBody() { DARABONBA_PTR_GET(body_, AddInstanceMembersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddInstanceMembersResponseBody> body_ {};
  };
