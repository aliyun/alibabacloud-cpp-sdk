...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVpcFirewallAccessDetailResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeVpcFirewallAccessDetailResponseBody) };
    inline DescribeVpcFirewallAccessDetailResponseBody body() { DARABONBA_PTR_GET(body_, DescribeVpcFirewallAccessDetailResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVpcFirewallAccessDetailResponseBody> body_ = nullptr;
  };
