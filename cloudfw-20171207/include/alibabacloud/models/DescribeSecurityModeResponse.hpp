...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecurityModeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSecurityModeResponseBody) };
    inline DescribeSecurityModeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSecurityModeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSecurityModeResponseBody> body_ {};
  };
