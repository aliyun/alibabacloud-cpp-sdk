...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTrFirewallsV2RouteListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTrFirewallsV2RouteListResponseBody) };
    inline DescribeTrFirewallsV2RouteListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTrFirewallsV2RouteListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTrFirewallsV2RouteListResponseBody> body_ {};
  };
