...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVpcFirewallCenConfigureResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVpcFirewallCenConfigureResponseBody) };
    inline CreateVpcFirewallCenConfigureResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVpcFirewallCenConfigureResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVpcFirewallCenConfigureResponseBody> body_ {};
  };
