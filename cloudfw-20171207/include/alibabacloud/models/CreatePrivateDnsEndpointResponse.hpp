...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePrivateDnsEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePrivateDnsEndpointResponseBody) };
    inline CreatePrivateDnsEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePrivateDnsEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePrivateDnsEndpointResponseBody> body_ {};
  };
