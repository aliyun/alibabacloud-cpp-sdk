...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyControlPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyControlPolicyResponseBody) };
    inline ModifyControlPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyControlPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyControlPolicyResponseBody> body_ {};
  };
