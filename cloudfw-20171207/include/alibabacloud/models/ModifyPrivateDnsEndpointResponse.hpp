...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyPrivateDnsEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyPrivateDnsEndpointResponseBody) };
    inline ModifyPrivateDnsEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyPrivateDnsEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyPrivateDnsEndpointResponseBody> body_ {};
  };
