...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserBuyVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUserBuyVersionResponseBody) };
    inline DescribeUserBuyVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUserBuyVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUserBuyVersionResponseBody> body_ {};
  };
