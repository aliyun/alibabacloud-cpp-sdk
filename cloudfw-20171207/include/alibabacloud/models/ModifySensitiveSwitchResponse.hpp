...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySensitiveSwitchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifySensitiveSwitchResponseBody) };
    inline ModifySensitiveSwitchResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifySensitiveSwitchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifySensitiveSwitchResponseBody> body_ {};
  };
