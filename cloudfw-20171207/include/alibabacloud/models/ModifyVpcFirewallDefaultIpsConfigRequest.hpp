...
namespace Models
{
  ...
  public:
    ...
    inline string getBasicRules() const { DARABONBA_PTR_GET_DEFAULT(basicRules_, "") };
    ...
    inline string getEnableAllPatch() const { DARABONBA_PTR_GET_DEFAULT(enableAllPatch_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> enableAllPatch_ {};
