...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->basicRules_ == nullptr
        && return this->enableAllPatch_ == nullptr && return this->lang_ == nullptr && return this->memberUid_ == nullptr && return this->ruleClass_ == nullptr && return this->runMode_ == nullptr
        && return this->sourceIp_ == nullptr && return this->vpcFirewallId_ == nullptr; };
