...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAclRuleCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAclRuleCountResponseBody) };
    inline DescribeAclRuleCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAclRuleCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAclRuleCountResponseBody> body_ {};
  };
