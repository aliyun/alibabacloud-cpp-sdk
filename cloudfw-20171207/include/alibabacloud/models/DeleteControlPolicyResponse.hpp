...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteControlPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteControlPolicyResponseBody) };
    inline DeleteControlPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteControlPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteControlPolicyResponseBody> body_ {};
  };
