...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->internetIpNum_ == nullptr
        && this->internetPortNum_ == nullptr && this->internetRiskIpNum_ == nullptr && this->internetRiskPortNum_ == nullptr && this->internetRiskServiceNum_ == nullptr && this->internetServiceNum_ == nullptr
        && this->internetSlbIpNum_ == nullptr && this->internetSlbIpPortNum_ == nullptr && this->internetUnprotectedPortNum_ == nullptr && this->requestId_ == nullptr; };
    ...
    inline int32_t getInternetIpNum() const { DARABONBA_PTR_GET_DEFAULT(internetIpNum_, 0) };
    ...
    inline int32_t getInternetPortNum() const { DARABONBA_PTR_GET_DEFAULT(internetPortNum_, 0) };
    ...
    inline int32_t getInternetRiskIpNum() const { DARABONBA_PTR_GET_DEFAULT(internetRiskIpNum_, 0) };
    ...
    inline int32_t getInternetRiskPortNum() const { DARABONBA_PTR_GET_DEFAULT(internetRiskPortNum_, 0) };
    ...
    inline int32_t getInternetRiskServiceNum() const { DARABONBA_PTR_GET_DEFAULT(internetRiskServiceNum_, 0) };
    ...
    inline int32_t getInternetServiceNum() const { DARABONBA_PTR_GET_DEFAULT(internetServiceNum_, 0) };
    ...
    inline int32_t getInternetSlbIpNum() const { DARABONBA_PTR_GET_DEFAULT(internetSlbIpNum_, 0) };
    ...
    inline int32_t getInternetSlbIpPortNum() const { DARABONBA_PTR_GET_DEFAULT(internetSlbIpPortNum_, 0) };
    ...
    inline int32_t getInternetUnprotectedPortNum() const { DARABONBA_PTR_GET_DEFAULT(internetUnprotectedPortNum_, 0) };
