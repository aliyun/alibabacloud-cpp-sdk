...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInternetTrafficTopResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInternetTrafficTopResponseBody) };
    inline DescribeInternetTrafficTopResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInternetTrafficTopResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInternetTrafficTopResponseBody> body_ {};
  };
