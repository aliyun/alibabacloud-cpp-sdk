...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAckClusterPodLabelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAckClusterPodLabelsResponseBody) };
    inline DescribeAckClusterPodLabelsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAckClusterPodLabelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAckClusterPodLabelsResponseBody> body_ {};
  };
