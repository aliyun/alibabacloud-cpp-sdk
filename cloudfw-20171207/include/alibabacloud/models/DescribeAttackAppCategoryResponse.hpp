...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAttackAppCategoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAttackAppCategoryResponseBody) };
    inline DescribeAttackAppCategoryResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAttackAppCategoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAttackAppCategoryResponseBody> body_ {};
  };
