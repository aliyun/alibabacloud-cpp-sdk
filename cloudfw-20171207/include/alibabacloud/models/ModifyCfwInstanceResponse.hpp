...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCfwInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCfwInstanceResponseBody) };
    inline ModifyCfwInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCfwInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCfwInstanceResponseBody> body_ {};
  };
