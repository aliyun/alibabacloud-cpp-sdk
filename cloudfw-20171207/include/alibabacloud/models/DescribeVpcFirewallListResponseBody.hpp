  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline PeerVpc& setAuthorizationStatus(string authorizationStatus) { DARABONBA_PTR_SET_VALUE(authorizationStatus_, authorizationStatus) };
        ...
        inline PeerVpc& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
      ...
      inline VpcFirewalls& setBandwidth(int32_t bandwidth) { DARABONBA_PTR_SET_VALUE(bandwidth_, bandwidth) };
      ...
      inline VpcFirewalls& setConnectSubType(string connectSubType) { DARABONBA_PTR_SET_VALUE(connectSubType_, connectSubType) };
      ...
      inline const VpcFirewalls::PeerVpc & getPeerVpc() const { DARABONBA_PTR_GET_CONST(peerVpc_, VpcFirewalls::PeerVpc) };
      inline VpcFirewalls::PeerVpc getPeerVpc() { DARABONBA_PTR_GET(peerVpc_, VpcFirewalls::PeerVpc) };
      inline VpcFirewalls& setPeerVpc(const VpcFirewalls::PeerVpc & peerVpc) { DARABONBA_PTR_SET_VALUE(peerVpc_, peerVpc) };
      inline VpcFirewalls& setPeerVpc(VpcFirewalls::PeerVpc && peerVpc) { DARABONBA_PTR_SET_RVALUE(peerVpc_, peerVpc) };
    ...
    inline const vector<DescribeVpcFirewallListResponseBody::VpcFirewalls> & getVpcFirewalls() const { DARABONBA_PTR_GET_CONST(vpcFirewalls_, vector<DescribeVpcFirewallListResponseBody::VpcFirewalls>) };
    inline vector<DescribeVpcFirewallListResponseBody::VpcFirewalls> getVpcFirewalls() { DARABONBA_PTR_GET(vpcFirewalls_, vector<DescribeVpcFirewallListResponseBody::VpcFirewalls>) };
    inline DescribeVpcFirewallListResponseBody& setVpcFirewalls(const vector<DescribeVpcFirewallListResponseBody::VpcFirewalls> & vpcFirewalls) { DARABONBA_PTR_SET_VALUE(vpcFirewalls_, vpcFirewalls) };
    inline DescribeVpcFirewallListResponseBody& setVpcFirewalls(vector<DescribeVpcFirewallListResponseBody::VpcFirewalls> && vpcFirewalls) { DARABONBA_PTR_SET_RVALUE(vpcFirewalls_, vpcFirewalls) };
