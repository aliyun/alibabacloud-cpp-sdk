...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAddressBookResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAddressBookResponseBody) };
    inline DeleteAddressBookResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAddressBookResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAddressBookResponseBody> body_ {};
  };
