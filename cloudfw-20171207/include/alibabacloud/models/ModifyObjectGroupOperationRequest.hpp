...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->comment_ == nullptr
        && return this->direction_ == nullptr && return this->lang_ == nullptr && return this->objectList_ == nullptr && return this->objectOperation_ == nullptr && return this->objectType_ == nullptr
    ...
    inline const vector<string> & objectList() const { DARABONBA_PTR_GET_CONST(objectList_, vector<string>) };
    inline vector<string> objectList() { DARABONBA_PTR_GET(objectList_, vector<string>) };
    ...
    inline string objectOperation() const { DARABONBA_PTR_GET_DEFAULT(objectOperation_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<vector<string>> objectList_ = nullptr;
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> objectOperation_ = nullptr;
