...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNetworkInstanceListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeNetworkInstanceListResponseBody) };
    inline DescribeNetworkInstanceListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeNetworkInstanceListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeNetworkInstanceListResponseBody> body_ = nullptr;
  };
