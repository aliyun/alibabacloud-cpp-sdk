...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOutgoingRiskDomainAndIpCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeOutgoingRiskDomainAndIpCountResponseBody) };
    inline DescribeOutgoingRiskDomainAndIpCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeOutgoingRiskDomainAndIpCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeOutgoingRiskDomainAndIpCountResponseBody> body_ {};
  };
