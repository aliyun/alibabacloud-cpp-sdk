...
#ifndef ALIBABACLOUD_MODELS_MODIFYADDRESSBOOKSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MODIFYADDRESSBOOKSHRINKREQUEST_HPP_
...
namespace Models
{
  class ModifyAddressBookShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModifyAddressBookShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyAddressBookShrinkRequest& obj) { 
    ...
    ModifyAddressBookShrinkRequest() = default ;
    ModifyAddressBookShrinkRequest(const ModifyAddressBookShrinkRequest &) = default ;
    ModifyAddressBookShrinkRequest(ModifyAddressBookShrinkRequest &&) = default ;
    ModifyAddressBookShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyAddressBookShrinkRequest() = default ;
    ModifyAddressBookShrinkRequest& operator=(const ModifyAddressBookShrinkRequest &) = default ;
    ModifyAddressBookShrinkRequest& operator=(ModifyAddressBookShrinkRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->ackLabels_ == nullptr
        && this->ackNamespaces_ == nullptr && this->addressList_ == nullptr && this->assetMemberUidsShrink_ == nullptr && this->assetRegionResourceTypesShrink_ == nullptr && this->autoAddTagEcs_ == nullptr
    ...
    inline const vector<ModifyAddressBookShrinkRequest::AckLabels> & getAckLabels() const { DARABONBA_PTR_GET_CONST(ackLabels_, vector<ModifyAddressBookShrinkRequest::AckLabels>) };
    inline vector<ModifyAddressBookShrinkRequest::AckLabels> getAckLabels() { DARABONBA_PTR_GET(ackLabels_, vector<ModifyAddressBookShrinkRequest::AckLabels>) };
    inline ModifyAddressBookShrinkRequest& setAckLabels(const vector<ModifyAddressBookShrinkRequest::AckLabels> & ackLabels) { DARABONBA_PTR_SET_VALUE(ackLabels_, ackLabels) };
    inline ModifyAddressBookShrinkRequest& setAckLabels(vector<ModifyAddressBookShrinkRequest::AckLabels> && ackLabels) { DARABONBA_PTR_SET_RVALUE(ackLabels_, ackLabels) };
    ...
    inline ModifyAddressBookShrinkRequest& setAckNamespaces(const vector<string> & ackNamespaces) { DARABONBA_PTR_SET_VALUE(ackNamespaces_, ackNamespaces) };
    inline ModifyAddressBookShrinkRequest& setAckNamespaces(vector<string> && ackNamespaces) { DARABONBA_PTR_SET_RVALUE(ackNamespaces_, ackNamespaces) };
    ...
    inline ModifyAddressBookShrinkRequest& setAddressList(string addressList) { DARABONBA_PTR_SET_VALUE(addressList_, addressList) };
    ...
    inline ModifyAddressBookShrinkRequest& setAssetMemberUidsShrink(string assetMemberUidsShrink) { DARABONBA_PTR_SET_VALUE(assetMemberUidsShrink_, assetMemberUidsShrink) };
    ...
    inline ModifyAddressBookShrinkRequest& setAssetRegionResourceTypesShrink(string assetRegionResourceTypesShrink) { DARABONBA_PTR_SET_VALUE(assetRegionResourceTypesShrink_, assetRegionResourceTypesShrink) };
    ...
    inline ModifyAddressBookShrinkRequest& setAutoAddTagEcs(string autoAddTagEcs) { DARABONBA_PTR_SET_VALUE(autoAddTagEcs_, autoAddTagEcs) };
    ...
    inline ModifyAddressBookShrinkRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline ModifyAddressBookShrinkRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ModifyAddressBookShrinkRequest& setDryRun(bool dryRun) { DARABONBA_PTR_SET_VALUE(dryRun_, dryRun) };
    ...
    inline ModifyAddressBookShrinkRequest& setGroupName(string groupName) { DARABONBA_PTR_SET_VALUE(groupName_, groupName) };
    ...
    inline ModifyAddressBookShrinkRequest& setGroupUuid(string groupUuid) { DARABONBA_PTR_SET_VALUE(groupUuid_, groupUuid) };
    ...
    inline ModifyAddressBookShrinkRequest& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline ModifyAddressBookShrinkRequest& setModifyMode(string modifyMode) { DARABONBA_PTR_SET_VALUE(modifyMode_, modifyMode) };
    ...
    inline ModifyAddressBookShrinkRequest& setSourceIp(string sourceIp) { DARABONBA_PTR_SET_VALUE(sourceIp_, sourceIp) };


    // tagList Field Functions 
    bool hasTagList() const { return this->tagList_ != nullptr;};
    void deleteTagList() { this->tagList_ = nullptr;};
    inline const vector<ModifyAddressBookShrinkRequest::TagList> & getTagList() const { DARABONBA_PTR_GET_CONST(tagList_, vector<ModifyAddressBookShrinkRequest::TagList>) };
    inline vector<ModifyAddressBookShrinkRequest::TagList> getTagList() { DARABONBA_PTR_GET(tagList_, vector<ModifyAddressBookShrinkRequest::TagList>) };
    inline ModifyAddressBookShrinkRequest& setTagList(const vector<ModifyAddressBookShrinkRequest::TagList> & tagList) { DARABONBA_PTR_SET_VALUE(tagList_, tagList) };
    inline ModifyAddressBookShrinkRequest& setTagList(vector<ModifyAddressBookShrinkRequest::TagList> && tagList) { DARABONBA_PTR_SET_RVALUE(tagList_, tagList) };
    ...
    inline ModifyAddressBookShrinkRequest& setTagRelation(string tagRelation) { DARABONBA_PTR_SET_VALUE(tagRelation_, tagRelation) };


  protected:
    // The list of labels for pods in the ACK cluster.
    shared_ptr<vector<ModifyAddressBookShrinkRequest::AckLabels>> ackLabels_ {};
    ...
    shared_ptr<vector<ModifyAddressBookShrinkRequest::TagList>> tagList_ {};
