...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInvadeEventListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeInvadeEventListResponseBody) };
    inline DescribeInvadeEventListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeInvadeEventListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeInvadeEventListResponseBody> body_ = nullptr;
  };
