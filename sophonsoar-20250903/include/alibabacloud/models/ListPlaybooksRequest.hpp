...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->lang_ == nullptr
        ...
        && return this->pageSize_ == nullptr && return this->playbookExecutionEndTime_ == nullptr && return this->playbookExecutionStartTime_ == nullptr && return this->playbookName_ == nullptr && return this->playbookParamTypes_ == nullptr
        && return this->playbookStatus_ == nullptr && return this->playbookType_ == nullptr && return this->playbookUuids_ == nullptr && return this->roleFor_ == nullptr; };
    ...
    inline const vector<string> & playbookParamTypes() const { DARABONBA_PTR_GET_CONST(playbookParamTypes_, vector<string>) };
    inline vector<string> playbookParamTypes() { DARABONBA_PTR_GET(playbookParamTypes_, vector<string>) };
    ...
    inline const vector<string> & playbookUuids() const { DARABONBA_PTR_GET_CONST(playbookUuids_, vector<string>) };
    inline vector<string> playbookUuids() { DARABONBA_PTR_GET(playbookUuids_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> playbookParamTypes_ = nullptr;
    ...
    std::shared_ptr<vector<string>> playbookUuids_ = nullptr;
