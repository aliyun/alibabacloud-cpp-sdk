...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->lang_ == nullptr
        ...
        && this->pageSize_ == nullptr && this->playbookExecutionEndTime_ == nullptr && this->playbookExecutionStartTime_ == nullptr && this->playbookName_ == nullptr && this->playbookParamTypesShrink_ == nullptr
        && this->playbookStatus_ == nullptr && this->playbookType_ == nullptr && this->playbookUuidsShrink_ == nullptr && this->roleFor_ == nullptr; };
    ...
    inline string getPlaybookParamTypesShrink() const { DARABONBA_PTR_GET_DEFAULT(playbookParamTypesShrink_, "") };
    ...
    inline string getPlaybookUuidsShrink() const { DARABONBA_PTR_GET_DEFAULT(playbookUuidsShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> playbookParamTypesShrink_ {};
    ...
    shared_ptr<string> playbookUuidsShrink_ {};
