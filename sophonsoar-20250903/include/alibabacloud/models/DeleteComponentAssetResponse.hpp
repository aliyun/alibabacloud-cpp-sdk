...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteComponentAssetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteComponentAssetResponseBody) };
    inline DeleteComponentAssetResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteComponentAssetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteComponentAssetResponseBody> body_ {};
  };
