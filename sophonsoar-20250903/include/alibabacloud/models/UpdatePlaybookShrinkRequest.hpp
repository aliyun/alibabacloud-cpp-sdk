...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->lang_ == nullptr
        && this->playbookDescription_ == nullptr && this->playbookInputConfigsShrink_ == nullptr && this->playbookName_ == nullptr && this->playbookOutputConfigsShrink_ == nullptr && this->playbookParamType_ == nullptr
    ...
    inline string getPlaybookInputConfigsShrink() const { DARABONBA_PTR_GET_DEFAULT(playbookInputConfigsShrink_, "") };
    ...
    inline string getPlaybookOutputConfigsShrink() const { DARABONBA_PTR_GET_DEFAULT(playbookOutputConfigsShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> playbookInputConfigsShrink_ {};
    // The name of the playbook.
    shared_ptr<string> playbookName_ {};
    // List of output parameter configurations for the playbook.
    shared_ptr<string> playbookOutputConfigsShrink_ {};
