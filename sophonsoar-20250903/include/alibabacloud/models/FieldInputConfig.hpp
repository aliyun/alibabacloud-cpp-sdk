...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->arrayed_ == nullptr
        && this->defaultValue_ == nullptr && this->fieldCheckRegex_ == nullptr && this->fieldClass_ == nullptr && this->fieldConfigs_ == nullptr && this->fieldDescription_ == nullptr
        && this->fieldExample_ == nullptr && this->fieldName_ == nullptr && this->fieldPath_ == nullptr && this->fieldType_ == nullptr && this->required_ == nullptr; };
    // arrayed Field Functions 
    bool hasArrayed() const { return this->arrayed_ != nullptr;};
    void deleteArrayed() { this->arrayed_ = nullptr;};
    inline bool getArrayed() const { DARABONBA_PTR_GET_DEFAULT(arrayed_, false) };
    ...
    inline string getFieldCheckRegex() const { DARABONBA_PTR_GET_DEFAULT(fieldCheckRegex_, "") };
    ...
    inline string getFieldClass() const { DARABONBA_PTR_GET_DEFAULT(fieldClass_, "") };
    ...
    inline const vector<FieldInputConfig> & getFieldConfigs() const { DARABONBA_PTR_GET_CONST(fieldConfigs_, vector<FieldInputConfig>) };
    inline vector<FieldInputConfig> getFieldConfigs() { DARABONBA_PTR_GET(fieldConfigs_, vector<FieldInputConfig>) };
