...
CreateChatFlowResponse Client::createChatFlowWithOptions(const CreateChatFlowRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!tmpReq.hasLifeCycleExtendData()) {
    request.setLifeCycleExtendDataShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getLifeCycleExtendData(), "LifeCycleExtendData", "json"));
  }
  ...
  if (!!request.hasCreateFromFlowCode()) {
    query["CreateFromFlowCode"] = request.getCreateFromFlowCode();
  }

  if (!!request.hasCreateFromFlowVersion()) {
    query["CreateFromFlowVersion"] = request.getCreateFromFlowVersion();
  }
  ...
  if (!!request.hasLifeCycleExtendDataShrink()) {
    query["LifeCycleExtendData"] = request.getLifeCycleExtendDataShrink();
  }
...
CreateChatappTemplateResponse Client::createChatappTemplateWithOptions(const CreateChatappTemplateRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasAllowCategoryChange()) {
    query["AllowCategoryChange"] = request.getAllowCategoryChange();
  }
  ...
  if (!!request.hasExampleShrink()) {
    query["Example"] = request.getExampleShrink();
  }
  ...
  if (!!request.hasMessageSendTtlSeconds()) {
    query["MessageSendTtlSeconds"] = request.getMessageSendTtlSeconds();
  }
  ...
  if (!!request.hasProductSetId()) {
    query["ProductSetId"] = request.getProductSetId();
  }
...
FlowBindPhoneResponse Client::flowBindPhoneWithOptions(const FlowBindPhoneRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  Utils::Utils::convert(tmpReq, request);
  if (!!tmpReq.hasMultiWabaPhoneNumbers()) {
    request.setMultiWabaPhoneNumbersShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getMultiWabaPhoneNumbers(), "MultiWabaPhoneNumbers", "json"));
  }
  ...
  if (!!request.hasMultiWabaPhoneNumbersShrink()) {
    query["MultiWabaPhoneNumbers"] = request.getMultiWabaPhoneNumbersShrink();
  }
...
ListInstanceResponse Client::listInstanceWithOptions(const ListInstanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasBindId()) {
    query["BindId"] = request.getBindId();
  }
