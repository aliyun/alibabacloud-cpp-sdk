...
namespace Models
{
  ...
  public:
    ...
    inline DeleteFlowVersionResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline DeleteFlowVersionResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DeleteFlowVersionResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DeleteFlowVersionResponseBody& setResponse(const Darabonba::Json & response) { DARABONBA_SET_VALUE(response_, response) };
    inline DeleteFlowVersionResponseBody& setResponse(Darabonba::Json && response) { DARABONBA_SET_RVALUE(response_, response) };
    ...
    inline DeleteFlowVersionResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
