  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->ageLimit_ == nullptr
        ...
        && this->completeAddressOfHeadquarters_ == nullptr && this->contactEmail_ == nullptr && this->contactMail_ == nullptr && this->contactName_ == nullptr && this->contactPhone_ == nullptr
        && this->contactPosition_ == nullptr && this->enableAutoReply_ == nullptr && this->industryDescription_ == nullptr && this->industryInvolved_ == nullptr && this->letterGuarantee_ == nullptr
        ...
        && this->messageSessionName_ == nullptr && this->otherLetterGuarantee_ == nullptr && this->recoveryDate_ == nullptr && this->replyContent_ == nullptr && this->suspensionDate_ == nullptr
        && this->webAddress_ == nullptr; };
