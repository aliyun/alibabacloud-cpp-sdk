  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->channelType_ == nullptr
        && this->instanceDescription_ == nullptr && this->instanceId_ == nullptr && this->instanceName_ == nullptr && this->resourceRegionId_ == nullptr && this->submitTime_ == nullptr; };
      ...
      inline int64_t getInstanceName() const { DARABONBA_PTR_GET_DEFAULT(instanceName_, 0L) };
      inline Data& setInstanceName(int64_t instanceName) { DARABONBA_PTR_SET_VALUE(instanceName_, instanceName) };
    ...
    inline CreateInstanceResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
