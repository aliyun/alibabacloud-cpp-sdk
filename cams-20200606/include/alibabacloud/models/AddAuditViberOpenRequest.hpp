...
#ifndef ALIBABACLOUD_MODELS_ADDAUDITVIBEROPENREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ADDAUDITVIBEROPENREQUEST_HPP_
...
namespace Models
{
  class AddAuditViberOpenRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const AddAuditViberOpenRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddAuditViberOpenRequest& obj) { 
    ...
    AddAuditViberOpenRequest() = default ;
    AddAuditViberOpenRequest(const AddAuditViberOpenRequest &) = default ;
    AddAuditViberOpenRequest(AddAuditViberOpenRequest &&) = default ;
    AddAuditViberOpenRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddAuditViberOpenRequest() = default ;
    AddAuditViberOpenRequest& operator=(const AddAuditViberOpenRequest &) = default ;
    AddAuditViberOpenRequest& operator=(AddAuditViberOpenRequest &&) = default ;
    ...
    inline const AddAuditViberOpenRequest::AuditRecord & getAuditRecord() const { DARABONBA_PTR_GET_CONST(auditRecord_, AddAuditViberOpenRequest::AuditRecord) };
    inline AddAuditViberOpenRequest::AuditRecord getAuditRecord() { DARABONBA_PTR_GET(auditRecord_, AddAuditViberOpenRequest::AuditRecord) };
    inline AddAuditViberOpenRequest& setAuditRecord(const AddAuditViberOpenRequest::AuditRecord & auditRecord) { DARABONBA_PTR_SET_VALUE(auditRecord_, auditRecord) };
    inline AddAuditViberOpenRequest& setAuditRecord(AddAuditViberOpenRequest::AuditRecord && auditRecord) { DARABONBA_PTR_SET_RVALUE(auditRecord_, auditRecord) };
    ...
    inline AddAuditViberOpenRequest& setAuditResult(string auditResult) { DARABONBA_PTR_SET_VALUE(auditResult_, auditResult) };
    ...
    inline AddAuditViberOpenRequest& setCustSpaceId(string custSpaceId) { DARABONBA_PTR_SET_VALUE(custSpaceId_, custSpaceId) };
    ...
    inline AddAuditViberOpenRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline AddAuditViberOpenRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline AddAuditViberOpenRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
