  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->channelType_ == nullptr
        && this->contactMail_ == nullptr && this->countryId_ == nullptr && this->custType_ == nullptr && this->facebookBmId_ == nullptr && this->instanceDescription_ == nullptr
        ...
        && this->resourceRegionId_ == nullptr && this->submitTime_ == nullptr; };
      ...
      inline string getCustType() const { DARABONBA_PTR_GET_DEFAULT(custType_, "") };
      inline Data& setCustType(string custType) { DARABONBA_PTR_SET_VALUE(custType_, custType) };
    ...
    inline QueryInstanceResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline QueryInstanceResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const QueryInstanceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryInstanceResponseBody::Data) };
    inline QueryInstanceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryInstanceResponseBody::Data) };
    inline QueryInstanceResponseBody& setData(const QueryInstanceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryInstanceResponseBody& setData(QueryInstanceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryInstanceResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline QueryInstanceResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
