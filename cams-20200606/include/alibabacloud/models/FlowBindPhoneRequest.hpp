...
namespace Models
{
  ...
  public:
    ...
    inline const vector<FlowBindPhoneRequest::MultiWabaPhoneNumbers> & getMultiWabaPhoneNumbers() const { DARABONBA_PTR_GET_CONST(multiWabaPhoneNumbers_, vector<FlowBindPhoneRequest::MultiWabaPhoneNumbers>) };
    inline vector<FlowBindPhoneRequest::MultiWabaPhoneNumbers> getMultiWabaPhoneNumbers() { DARABONBA_PTR_GET(multiWabaPhoneNumbers_, vector<FlowBindPhoneRequest::MultiWabaPhoneNumbers>) };
    inline FlowBindPhoneRequest& setMultiWabaPhoneNumbers(const vector<FlowBindPhoneRequest::MultiWabaPhoneNumbers> & multiWabaPhoneNumbers) { DARABONBA_PTR_SET_VALUE(multiWabaPhoneNumbers_, multiWabaPhoneNumbers) };
    inline FlowBindPhoneRequest& setMultiWabaPhoneNumbers(vector<FlowBindPhoneRequest::MultiWabaPhoneNumbers> && multiWabaPhoneNumbers) { DARABONBA_PTR_SET_RVALUE(multiWabaPhoneNumbers_, multiWabaPhoneNumbers) };
  ...
  protected:
    ...
    shared_ptr<vector<FlowBindPhoneRequest::MultiWabaPhoneNumbers>> multiWabaPhoneNumbers_ {};
