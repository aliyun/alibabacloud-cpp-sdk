...
#ifndef ALIBABACLOUD_MODELS_CHATAPPSYNCPHONENUMBERRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CHATAPPSYNCPHONENUMBERRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChatappSyncPhoneNumberResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChatappSyncPhoneNumberResponseBody& obj) { 
    ...
    ChatappSyncPhoneNumberResponseBody() = default ;
    ChatappSyncPhoneNumberResponseBody(const ChatappSyncPhoneNumberResponseBody &) = default ;
    ChatappSyncPhoneNumberResponseBody(ChatappSyncPhoneNumberResponseBody &&) = default ;
    ChatappSyncPhoneNumberResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChatappSyncPhoneNumberResponseBody() = default ;
    ChatappSyncPhoneNumberResponseBody& operator=(const ChatappSyncPhoneNumberResponseBody &) = default ;
    ChatappSyncPhoneNumberResponseBody& operator=(ChatappSyncPhoneNumberResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->endTime_ == nullptr && this->startTime_ == nullptr; };
            ...
            virtual bool empty() const override { return this->holidaySchedule_ == nullptr
        && this->status_ == nullptr && this->timezoneId_ == nullptr && this->weeklyOperatingHours_ == nullptr; };
        ...
        && this->callIconVisibility_ == nullptr && this->callbackPermissionStatus_ == nullptr && this->status_ == nullptr; };
          ...
          inline Calling& setCallIconVisibility(string callIconVisibility) { DARABONBA_PTR_SET_VALUE(callIconVisibility_, callIconVisibility) };
          ...
          inline Calling& setCallbackPermissionStatus(string callbackPermissionStatus) { DARABONBA_PTR_SET_VALUE(callbackPermissionStatus_, callbackPermissionStatus) };
    ...
    inline ChatappSyncPhoneNumberResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ChatappSyncPhoneNumberResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ChatappSyncPhoneNumberResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline const vector<ChatappSyncPhoneNumberResponseBody::PhoneNumbers> & getPhoneNumbers() const { DARABONBA_PTR_GET_CONST(phoneNumbers_, vector<ChatappSyncPhoneNumberResponseBody::PhoneNumbers>) };
    inline vector<ChatappSyncPhoneNumberResponseBody::PhoneNumbers> getPhoneNumbers() { DARABONBA_PTR_GET(phoneNumbers_, vector<ChatappSyncPhoneNumberResponseBody::PhoneNumbers>) };
    inline ChatappSyncPhoneNumberResponseBody& setPhoneNumbers(const vector<ChatappSyncPhoneNumberResponseBody::PhoneNumbers> & phoneNumbers) { DARABONBA_PTR_SET_VALUE(phoneNumbers_, phoneNumbers) };
    inline ChatappSyncPhoneNumberResponseBody& setPhoneNumbers(vector<ChatappSyncPhoneNumberResponseBody::PhoneNumbers> && phoneNumbers) { DARABONBA_PTR_SET_RVALUE(phoneNumbers_, phoneNumbers) };
    ...
    inline ChatappSyncPhoneNumberResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ChatappSyncPhoneNumberResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
