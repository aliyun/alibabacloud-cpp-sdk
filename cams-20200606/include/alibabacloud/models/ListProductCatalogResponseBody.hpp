...
#ifndef ALIBABACLOUD_MODELS_LISTPRODUCTCATALOGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTPRODUCTCATALOGRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListProductCatalogResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListProductCatalogResponseBody& obj) { 
    ...
    ListProductCatalogResponseBody() = default ;
    ListProductCatalogResponseBody(const ListProductCatalogResponseBody &) = default ;
    ListProductCatalogResponseBody(ListProductCatalogResponseBody &&) = default ;
    ListProductCatalogResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListProductCatalogResponseBody() = default ;
    ListProductCatalogResponseBody& operator=(const ListProductCatalogResponseBody &) = default ;
    ListProductCatalogResponseBody& operator=(ListProductCatalogResponseBody &&) = default ;
    ...
    inline ListProductCatalogResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ListProductCatalogResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ListProductCatalogResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };


    // model Field Functions 
    bool hasModel() const { return this->model_ != nullptr;};
    void deleteModel() { this->model_ = nullptr;};
    inline const ListProductCatalogResponseBody::Model & getModel() const { DARABONBA_PTR_GET_CONST(model_, ListProductCatalogResponseBody::Model) };
    inline ListProductCatalogResponseBody::Model getModel() { DARABONBA_PTR_GET(model_, ListProductCatalogResponseBody::Model) };
    inline ListProductCatalogResponseBody& setModel(const ListProductCatalogResponseBody::Model & model) { DARABONBA_PTR_SET_VALUE(model_, model) };
    inline ListProductCatalogResponseBody& setModel(ListProductCatalogResponseBody::Model && model) { DARABONBA_PTR_SET_RVALUE(model_, model) };
    ...
    inline ListProductCatalogResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListProductCatalogResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
