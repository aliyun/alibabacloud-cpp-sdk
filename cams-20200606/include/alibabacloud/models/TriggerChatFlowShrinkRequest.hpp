...
#ifndef ALIBABACLOUD_MODELS_TRIGGERCHATFLOWSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_TRIGGERCHATFLOWSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TriggerChatFlowShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TriggerChatFlowShrinkRequest& obj) { 
    ...
    TriggerChatFlowShrinkRequest() = default ;
    TriggerChatFlowShrinkRequest(const TriggerChatFlowShrinkRequest &) = default ;
    TriggerChatFlowShrinkRequest(TriggerChatFlowShrinkRequest &&) = default ;
    TriggerChatFlowShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TriggerChatFlowShrinkRequest() = default ;
    TriggerChatFlowShrinkRequest& operator=(const TriggerChatFlowShrinkRequest &) = default ;
    TriggerChatFlowShrinkRequest& operator=(TriggerChatFlowShrinkRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->claimTimeMillis_ == nullptr
        && this->dataShrink_ == nullptr && this->discardTimeMillis_ == nullptr && this->flowCode_ == nullptr && this->outId_ == nullptr && this->ownerId_ == nullptr
    ...
    inline TriggerChatFlowShrinkRequest& setClaimTimeMillis(int64_t claimTimeMillis) { DARABONBA_PTR_SET_VALUE(claimTimeMillis_, claimTimeMillis) };
    ...
    inline TriggerChatFlowShrinkRequest& setDataShrink(string dataShrink) { DARABONBA_PTR_SET_VALUE(dataShrink_, dataShrink) };
    ...
    inline TriggerChatFlowShrinkRequest& setDiscardTimeMillis(int64_t discardTimeMillis) { DARABONBA_PTR_SET_VALUE(discardTimeMillis_, discardTimeMillis) };
    ...
    inline TriggerChatFlowShrinkRequest& setFlowCode(string flowCode) { DARABONBA_PTR_SET_VALUE(flowCode_, flowCode) };
    ...
    inline TriggerChatFlowShrinkRequest& setOutId(string outId) { DARABONBA_PTR_SET_VALUE(outId_, outId) };
    ...
    inline TriggerChatFlowShrinkRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline TriggerChatFlowShrinkRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline TriggerChatFlowShrinkRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline TriggerChatFlowShrinkRequest& setUuid(string uuid) { DARABONBA_PTR_SET_VALUE(uuid_, uuid) };
