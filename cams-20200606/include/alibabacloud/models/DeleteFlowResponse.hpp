...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteFlowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteFlowResponseBody) };
    inline DeleteFlowResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteFlowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteFlowResponseBody> body_ {};
  };
