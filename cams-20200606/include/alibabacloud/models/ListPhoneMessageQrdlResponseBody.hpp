...
#ifndef ALIBABACLOUD_MODELS_LISTPHONEMESSAGEQRDLRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTPHONEMESSAGEQRDLRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListPhoneMessageQrdlResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListPhoneMessageQrdlResponseBody& obj) { 
    ...
    ListPhoneMessageQrdlResponseBody() = default ;
    ListPhoneMessageQrdlResponseBody(const ListPhoneMessageQrdlResponseBody &) = default ;
    ListPhoneMessageQrdlResponseBody(ListPhoneMessageQrdlResponseBody &&) = default ;
    ListPhoneMessageQrdlResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPhoneMessageQrdlResponseBody() = default ;
    ListPhoneMessageQrdlResponseBody& operator=(const ListPhoneMessageQrdlResponseBody &) = default ;
    ListPhoneMessageQrdlResponseBody& operator=(ListPhoneMessageQrdlResponseBody &&) = default ;
    ...
    inline ListPhoneMessageQrdlResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ListPhoneMessageQrdlResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<ListPhoneMessageQrdlResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListPhoneMessageQrdlResponseBody::Data>) };
    inline vector<ListPhoneMessageQrdlResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListPhoneMessageQrdlResponseBody::Data>) };
    inline ListPhoneMessageQrdlResponseBody& setData(const vector<ListPhoneMessageQrdlResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListPhoneMessageQrdlResponseBody& setData(vector<ListPhoneMessageQrdlResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListPhoneMessageQrdlResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListPhoneMessageQrdlResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
