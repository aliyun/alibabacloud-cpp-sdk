...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessNumber_ == nullptr
        ...
        && this->ownerId_ == nullptr && this->pageShrink_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->subject_ == nullptr; };
    ...
    inline ListChatGroupShrinkRequest& setGroupLink(string groupLink) { DARABONBA_PTR_SET_VALUE(groupLink_, groupLink) };
    ...
    inline ListChatGroupShrinkRequest& setGroupType(string groupType) { DARABONBA_PTR_SET_VALUE(groupType_, groupType) };
