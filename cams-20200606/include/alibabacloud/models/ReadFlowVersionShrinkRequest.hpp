...
#ifndef ALIBABACLOUD_MODELS_READFLOWVERSIONSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_READFLOWVERSIONSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ReadFlowVersionShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ReadFlowVersionShrinkRequest& obj) { 
    ...
    ReadFlowVersionShrinkRequest() = default ;
    ReadFlowVersionShrinkRequest(const ReadFlowVersionShrinkRequest &) = default ;
    ReadFlowVersionShrinkRequest(ReadFlowVersionShrinkRequest &&) = default ;
    ReadFlowVersionShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReadFlowVersionShrinkRequest() = default ;
    ReadFlowVersionShrinkRequest& operator=(const ReadFlowVersionShrinkRequest &) = default ;
    ReadFlowVersionShrinkRequest& operator=(ReadFlowVersionShrinkRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->bizCode_ == nullptr
        && this->bizExtendShrink_ == nullptr && this->draftVersion_ == nullptr && this->flowCode_ == nullptr && this->flowVersion_ == nullptr && this->ownerId_ == nullptr
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->status_ == nullptr; };
    // bizCode Field Functions 
    bool hasBizCode() const { return this->bizCode_ != nullptr;};
    void deleteBizCode() { this->bizCode_ = nullptr;};
    inline string getBizCode() const { DARABONBA_PTR_GET_DEFAULT(bizCode_, "") };
    inline ReadFlowVersionShrinkRequest& setBizCode(string bizCode) { DARABONBA_PTR_SET_VALUE(bizCode_, bizCode) };
    ...
    inline ReadFlowVersionShrinkRequest& setBizExtendShrink(string bizExtendShrink) { DARABONBA_PTR_SET_VALUE(bizExtendShrink_, bizExtendShrink) };
    ...
    inline ReadFlowVersionShrinkRequest& setDraftVersion(string draftVersion) { DARABONBA_PTR_SET_VALUE(draftVersion_, draftVersion) };
    ...
    inline ReadFlowVersionShrinkRequest& setFlowCode(string flowCode) { DARABONBA_PTR_SET_VALUE(flowCode_, flowCode) };
    ...
    inline ReadFlowVersionShrinkRequest& setFlowVersion(string flowVersion) { DARABONBA_PTR_SET_VALUE(flowVersion_, flowVersion) };
    ...
    inline ReadFlowVersionShrinkRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline ReadFlowVersionShrinkRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline ReadFlowVersionShrinkRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline ReadFlowVersionShrinkRequest& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
