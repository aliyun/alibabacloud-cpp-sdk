...
#ifndef ALIBABACLOUD_MODELS_FLOWREBINDPHONESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_FLOWREBINDPHONESHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlowRebindPhoneShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlowRebindPhoneShrinkRequest& obj) { 
    ...
    FlowRebindPhoneShrinkRequest() = default ;
    FlowRebindPhoneShrinkRequest(const FlowRebindPhoneShrinkRequest &) = default ;
    FlowRebindPhoneShrinkRequest(FlowRebindPhoneShrinkRequest &&) = default ;
    FlowRebindPhoneShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlowRebindPhoneShrinkRequest() = default ;
    FlowRebindPhoneShrinkRequest& operator=(const FlowRebindPhoneShrinkRequest &) = default ;
    FlowRebindPhoneShrinkRequest& operator=(FlowRebindPhoneShrinkRequest &&) = default ;
    ...
    inline FlowRebindPhoneShrinkRequest& setChannelCode(string channelCode) { DARABONBA_PTR_SET_VALUE(channelCode_, channelCode) };
    ...
    inline FlowRebindPhoneShrinkRequest& setChannelType(string channelType) { DARABONBA_PTR_SET_VALUE(channelType_, channelType) };
    ...
    inline FlowRebindPhoneShrinkRequest& setFlowCode(string flowCode) { DARABONBA_PTR_SET_VALUE(flowCode_, flowCode) };
    ...
    inline FlowRebindPhoneShrinkRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline FlowRebindPhoneShrinkRequest& setPhoneNumbersShrink(string phoneNumbersShrink) { DARABONBA_PTR_SET_VALUE(phoneNumbersShrink_, phoneNumbersShrink) };
    ...
    inline FlowRebindPhoneShrinkRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline FlowRebindPhoneShrinkRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline FlowRebindPhoneShrinkRequest& setWabaId(string wabaId) { DARABONBA_PTR_SET_VALUE(wabaId_, wabaId) };
