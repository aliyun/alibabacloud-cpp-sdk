...
#ifndef ALIBABACLOUD_MODELS_GETVIBERBYREQUESTNORESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETVIBERBYREQUESTNORESPONSEBODY_HPP_
...
namespace Models
{
  class GetViberByRequestNoResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetViberByRequestNoResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetViberByRequestNoResponseBody& obj) { 
    ...
    GetViberByRequestNoResponseBody() = default ;
    GetViberByRequestNoResponseBody(const GetViberByRequestNoResponseBody &) = default ;
    GetViberByRequestNoResponseBody(GetViberByRequestNoResponseBody &&) = default ;
    GetViberByRequestNoResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetViberByRequestNoResponseBody() = default ;
    GetViberByRequestNoResponseBody& operator=(const GetViberByRequestNoResponseBody &) = default ;
    GetViberByRequestNoResponseBody& operator=(GetViberByRequestNoResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->messageEnableDate_ == nullptr && this->messageSessionName_ == nullptr && this->nowRecovery_ == nullptr && this->otherLetterGuarantee_ == nullptr && this->recoveryDate_ == nullptr
        && this->replyContent_ == nullptr && this->suspensionDate_ == nullptr && this->webAddress_ == nullptr; };
      ...
      virtual bool empty() const override { return this->auditRecord_ == nullptr
        && this->auditResult_ == nullptr && this->auditTime_ == nullptr && this->creator_ == nullptr && this->gmtCreate_ == nullptr && this->gmtModifier_ == nullptr
        && this->id_ == nullptr && this->maapServiceNo_ == nullptr && this->modifier_ == nullptr && this->reason_ == nullptr && this->requestNo_ == nullptr
    ...
    inline GetViberByRequestNoResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline GetViberByRequestNoResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetViberByRequestNoResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetViberByRequestNoResponseBody::Data) };
    inline GetViberByRequestNoResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetViberByRequestNoResponseBody::Data) };
    inline GetViberByRequestNoResponseBody& setData(const GetViberByRequestNoResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetViberByRequestNoResponseBody& setData(GetViberByRequestNoResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetViberByRequestNoResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetViberByRequestNoResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetViberByRequestNoResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
