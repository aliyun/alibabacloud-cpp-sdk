...
#ifndef ALIBABACLOUD_MODELS_READFLOWVERSIONREQUEST_HPP_
#define ALIBABACLOUD_MODELS_READFLOWVERSIONREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    ...
    ReadFlowVersionRequest() = default ;
    ReadFlowVersionRequest(const ReadFlowVersionRequest &) = default ;
    ReadFlowVersionRequest(ReadFlowVersionRequest &&) = default ;
    ReadFlowVersionRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReadFlowVersionRequest() = default ;
    ReadFlowVersionRequest& operator=(const ReadFlowVersionRequest &) = default ;
    ReadFlowVersionRequest& operator=(ReadFlowVersionRequest &&) = default ;
    ...
    inline ReadFlowVersionRequest& setBizCode(string bizCode) { DARABONBA_PTR_SET_VALUE(bizCode_, bizCode) };
    ...
    inline ReadFlowVersionRequest& setFlowCode(string flowCode) { DARABONBA_PTR_SET_VALUE(flowCode_, flowCode) };
    ...
    inline ReadFlowVersionRequest& setFlowVersion(string flowVersion) { DARABONBA_PTR_SET_VALUE(flowVersion_, flowVersion) };
    ...
    inline ReadFlowVersionRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline ReadFlowVersionRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline ReadFlowVersionRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline ReadFlowVersionRequest& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
