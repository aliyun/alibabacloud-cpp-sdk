...
#ifndef ALIBABACLOUD_MODELS_ADDMARKETINGFLOWSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ADDMARKETINGFLOWSHRINKREQUEST_HPP_
...
namespace Models
{
  class AddMarketingFlowShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const AddMarketingFlowShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddMarketingFlowShrinkRequest& obj) { 
    ...
    AddMarketingFlowShrinkRequest() = default ;
    AddMarketingFlowShrinkRequest(const AddMarketingFlowShrinkRequest &) = default ;
    AddMarketingFlowShrinkRequest(AddMarketingFlowShrinkRequest &&) = default ;
    AddMarketingFlowShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddMarketingFlowShrinkRequest() = default ;
    AddMarketingFlowShrinkRequest& operator=(const AddMarketingFlowShrinkRequest &) = default ;
    AddMarketingFlowShrinkRequest& operator=(AddMarketingFlowShrinkRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->activityDesc_ == nullptr
        && this->activityName_ == nullptr && this->bizCode_ == nullptr && this->bizExtendShrink_ == nullptr && this->cronExpression_ == nullptr && this->endDate_ == nullptr
    ...
    inline AddMarketingFlowShrinkRequest& setActivityDesc(string activityDesc) { DARABONBA_PTR_SET_VALUE(activityDesc_, activityDesc) };
    ...
    inline AddMarketingFlowShrinkRequest& setActivityName(string activityName) { DARABONBA_PTR_SET_VALUE(activityName_, activityName) };
    ...
    inline AddMarketingFlowShrinkRequest& setBizCode(string bizCode) { DARABONBA_PTR_SET_VALUE(bizCode_, bizCode) };
    ...
    inline AddMarketingFlowShrinkRequest& setBizExtendShrink(string bizExtendShrink) { DARABONBA_PTR_SET_VALUE(bizExtendShrink_, bizExtendShrink) };
    ...
    inline AddMarketingFlowShrinkRequest& setCronExpression(string cronExpression) { DARABONBA_PTR_SET_VALUE(cronExpression_, cronExpression) };
    ...
    inline AddMarketingFlowShrinkRequest& setEndDate(string endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline AddMarketingFlowShrinkRequest& setExecutionType(string executionType) { DARABONBA_PTR_SET_VALUE(executionType_, executionType) };
    ...
    inline AddMarketingFlowShrinkRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline AddMarketingFlowShrinkRequest& setParamFlag(string paramFlag) { DARABONBA_PTR_SET_VALUE(paramFlag_, paramFlag) };
    ...
    inline AddMarketingFlowShrinkRequest& setParamsShrink(string paramsShrink) { DARABONBA_PTR_SET_VALUE(paramsShrink_, paramsShrink) };
    ...
    inline AddMarketingFlowShrinkRequest& setRelatedFlowCode(string relatedFlowCode) { DARABONBA_PTR_SET_VALUE(relatedFlowCode_, relatedFlowCode) };
    ...
    inline AddMarketingFlowShrinkRequest& setRelatedFlowName(string relatedFlowName) { DARABONBA_PTR_SET_VALUE(relatedFlowName_, relatedFlowName) };
    ...
    inline AddMarketingFlowShrinkRequest& setRelatedGroupId(int64_t relatedGroupId) { DARABONBA_PTR_SET_VALUE(relatedGroupId_, relatedGroupId) };
    ...
    inline AddMarketingFlowShrinkRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline AddMarketingFlowShrinkRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline AddMarketingFlowShrinkRequest& setStartDate(string startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
