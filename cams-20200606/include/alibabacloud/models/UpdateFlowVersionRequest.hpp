...
#ifndef ALIBABACLOUD_MODELS_UPDATEFLOWVERSIONREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEFLOWVERSIONREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateFlowVersionRequest& obj) { 
    ...
    UpdateFlowVersionRequest(UpdateFlowVersionRequest &&) = default ;
    UpdateFlowVersionRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateFlowVersionRequest() = default ;
    UpdateFlowVersionRequest& operator=(const UpdateFlowVersionRequest &) = default ;
    UpdateFlowVersionRequest& operator=(UpdateFlowVersionRequest &&) = default ;
    ...
    inline UpdateFlowVersionRequest& setBizCode(string bizCode) { DARABONBA_PTR_SET_VALUE(bizCode_, bizCode) };
    ...
    inline UpdateFlowVersionRequest& setBizExtend(const Darabonba::Json & bizExtend) { DARABONBA_SET_VALUE(bizExtend_, bizExtend) };
    inline UpdateFlowVersionRequest& setBizExtend(Darabonba::Json && bizExtend) { DARABONBA_SET_RVALUE(bizExtend_, bizExtend) };
    ...
    inline UpdateFlowVersionRequest& setFlowCode(string flowCode) { DARABONBA_PTR_SET_VALUE(flowCode_, flowCode) };
    ...
    inline UpdateFlowVersionRequest& setFlowVersion(string flowVersion) { DARABONBA_PTR_SET_VALUE(flowVersion_, flowVersion) };
    ...
    inline UpdateFlowVersionRequest& setFlowViewModel(string flowViewModel) { DARABONBA_PTR_SET_VALUE(flowViewModel_, flowViewModel) };
    ...
    inline UpdateFlowVersionRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline UpdateFlowVersionRequest& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline UpdateFlowVersionRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
