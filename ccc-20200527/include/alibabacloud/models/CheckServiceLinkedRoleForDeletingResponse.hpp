...
namespace Models
{
  ...
  public:
    ...
    inline const CheckServiceLinkedRoleForDeletingResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CheckServiceLinkedRoleForDeletingResponseBody) };
    inline CheckServiceLinkedRoleForDeletingResponseBody body() { DARABONBA_PTR_GET(body_, CheckServiceLinkedRoleForDeletingResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CheckServiceLinkedRoleForDeletingResponseBody> body_ = nullptr;
  };
