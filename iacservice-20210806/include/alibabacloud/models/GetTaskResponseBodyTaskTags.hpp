...
namespace Models
{
  ...
  public:
    ...
    inline GetTaskResponseBodyTaskTags& setTagKey(string tagKey) { DARABONBA_PTR_SET_VALUE(tagKey_, tagKey) };
    ...
    inline GetTaskResponseBodyTaskTags& setTagValue(string tagValue) { DARABONBA_PTR_SET_VALUE(tagValue_, tagValue) };
