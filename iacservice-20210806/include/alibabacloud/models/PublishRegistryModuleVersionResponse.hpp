...
namespace Models
{
  ...
  public:
    ...
    inline const PublishRegistryModuleVersionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, PublishRegistryModuleVersionResponseBody) };
    inline PublishRegistryModuleVersionResponseBody body() { DARABONBA_PTR_GET(body_, PublishRegistryModuleVersionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<PublishRegistryModuleVersionResponseBody> body_ = nullptr;
  };
