...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourceExportTaskVersionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListResourceExportTaskVersionsResponseBody) };
    inline ListResourceExportTaskVersionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListResourceExportTaskVersionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListResourceExportTaskVersionsResponseBody> body_ {};
  };
