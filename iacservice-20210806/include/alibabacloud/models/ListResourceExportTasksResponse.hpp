...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourceExportTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListResourceExportTasksResponseBody) };
    inline ListResourceExportTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListResourceExportTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListResourceExportTasksResponseBody> body_ {};
  };
