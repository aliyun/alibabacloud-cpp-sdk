...
namespace Models
{
  ...
  public:
    ...
    inline const GetRegistryModuleVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRegistryModuleVersionResponseBody) };
    inline GetRegistryModuleVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRegistryModuleVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRegistryModuleVersionResponseBody> body_ {};
  };
