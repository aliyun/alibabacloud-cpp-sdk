...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRegistryNamespaceAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateRegistryNamespaceAttributeResponseBody) };
    inline UpdateRegistryNamespaceAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateRegistryNamespaceAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateRegistryNamespaceAttributeResponseBody> body_ {};
  };
