...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRegistryNamespaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteRegistryNamespaceResponseBody) };
    inline DeleteRegistryNamespaceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteRegistryNamespaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteRegistryNamespaceResponseBody> body_ {};
  };
