...
namespace Models
{
  ...
  public:
    ...
    inline const ValidateModuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ValidateModuleResponseBody) };
    inline ValidateModuleResponseBody body() { DARABONBA_PTR_GET(body_, ValidateModuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ValidateModuleResponseBody> body_ = nullptr;
  };
