...
namespace Models
{
  ...
  public:
    ...
    inline ValidateModuleResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ValidateModuleResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };
