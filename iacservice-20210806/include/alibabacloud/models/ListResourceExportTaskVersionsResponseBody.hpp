  ...
  public:
    ...
    public:
      friend void to_json(Darabonba::Json& j, const ExportTasks& obj) { 
        ...
        DARABONBA_PTR_TO_JSON(managedTaskId, managedTaskId_);
      ...
      friend void from_json(const Darabonba::Json& j, ExportTasks& obj) { 
        ...
        DARABONBA_PTR_FROM_JSON(managedTaskId, managedTaskId_);
      ...
      inline ExportTasks& setFailedReason(string failedReason) { DARABONBA_PTR_SET_VALUE(failedReason_, failedReason) };
      ...
      // managedTaskId Field Functions 
      bool hasManagedTaskId() const { return this->managedTaskId_ != nullptr;};
      void deleteManagedTaskId() { this->managedTaskId_ = nullptr;};
      inline string getManagedTaskId() const { DARABONBA_PTR_GET_DEFAULT(managedTaskId_, "") };
      inline ExportTasks& setManagedTaskId(string managedTaskId) { DARABONBA_PTR_SET_VALUE(managedTaskId_, managedTaskId) };
    ...
    inline const vector<ListResourceExportTaskVersionsResponseBody::ExportTasks> & getExportTasks() const { DARABONBA_PTR_GET_CONST(exportTasks_, vector<ListResourceExportTaskVersionsResponseBody::ExportTasks>) };
    inline vector<ListResourceExportTaskVersionsResponseBody::ExportTasks> getExportTasks() { DARABONBA_PTR_GET(exportTasks_, vector<ListResourceExportTaskVersionsResponseBody::ExportTasks>) };
    inline ListResourceExportTaskVersionsResponseBody& setExportTasks(const vector<ListResourceExportTaskVersionsResponseBody::ExportTasks> & exportTasks) { DARABONBA_PTR_SET_VALUE(exportTasks_, exportTasks) };
    inline ListResourceExportTaskVersionsResponseBody& setExportTasks(vector<ListResourceExportTaskVersionsResponseBody::ExportTasks> && exportTasks) { DARABONBA_PTR_SET_RVALUE(exportTasks_, exportTasks) };
