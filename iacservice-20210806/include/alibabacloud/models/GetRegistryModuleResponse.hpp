...
namespace Models
{
  ...
  public:
    ...
    inline const GetRegistryModuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRegistryModuleResponseBody) };
    inline GetRegistryModuleResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRegistryModuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRegistryModuleResponseBody> body_ {};
  };
