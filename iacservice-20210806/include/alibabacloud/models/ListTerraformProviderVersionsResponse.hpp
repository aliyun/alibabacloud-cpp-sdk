...
namespace Models
{
  ...
  public:
    ...
    inline const ListTerraformProviderVersionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTerraformProviderVersionsResponseBody) };
    inline ListTerraformProviderVersionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTerraformProviderVersionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTerraformProviderVersionsResponseBody> body_ {};
  };
