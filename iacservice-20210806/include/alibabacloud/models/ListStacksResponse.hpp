...
namespace Models
{
  ...
  public:
    ...
    inline const ListStacksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListStacksResponseBody) };
    inline ListStacksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListStacksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListStacksResponseBody> body_ {};
  };
