...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRegistryModuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteRegistryModuleResponseBody) };
    inline DeleteRegistryModuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteRegistryModuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteRegistryModuleResponseBody> body_ {};
  };
