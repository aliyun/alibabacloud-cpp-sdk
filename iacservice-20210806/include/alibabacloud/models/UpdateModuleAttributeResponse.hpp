...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateModuleAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateModuleAttributeResponseBody) };
    inline UpdateModuleAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateModuleAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateModuleAttributeResponseBody> body_ {};
  };
