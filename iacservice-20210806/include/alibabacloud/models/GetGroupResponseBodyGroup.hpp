...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoDestroy_ == nullptr
        && return this->autoTrigger_ == nullptr && return this->createTime_ == nullptr && return this->description_ == nullptr && return this->forcedSetting_ == nullptr && return this->groupId_ == nullptr
        && return this->name_ == nullptr && return this->notifyConfig_ == nullptr && return this->notifyOperationTypes_ == nullptr && return this->projectId_ == nullptr && return this->ramRole_ == nullptr
        && return this->reportExportField_ == nullptr && return this->reportExportPath_ == nullptr && return this->taskCnt_ == nullptr && return this->terraformProviderVersion_ == nullptr && return this->triggerConfig_ == nullptr
        && return this->triggerResourceType_ == nullptr; };
