...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        ...
        && this->status_ == nullptr && this->subcategory_ == nullptr && this->supportTerraformer_ == nullptr && this->terraformProviderVersion_ == nullptr && this->terraformResourceTypes_ == nullptr; };
    ...
    inline const vector<string> & getTerraformResourceTypes() const { DARABONBA_PTR_GET_CONST(terraformResourceTypes_, vector<string>) };
    inline vector<string> getTerraformResourceTypes() { DARABONBA_PTR_GET(terraformResourceTypes_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> terraformResourceTypes_ {};
  };
