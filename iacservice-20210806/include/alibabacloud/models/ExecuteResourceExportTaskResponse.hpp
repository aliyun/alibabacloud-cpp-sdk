...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteResourceExportTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExecuteResourceExportTaskResponseBody) };
    inline ExecuteResourceExportTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, ExecuteResourceExportTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExecuteResourceExportTaskResponseBody> body_ {};
  };
