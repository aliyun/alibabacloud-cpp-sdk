...
namespace Models
{
  ...
  public:
    ...
    inline const CreateJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateJobResponseBody) };
    inline CreateJobResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateJobResponseBody> body_ {};
  };
