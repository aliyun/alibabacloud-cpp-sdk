...
namespace Models
{
  ...
  public:
    ...
    inline const CancelResourceExportTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelResourceExportTaskResponseBody) };
    inline CancelResourceExportTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelResourceExportTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelResourceExportTaskResponseBody> body_ {};
  };
