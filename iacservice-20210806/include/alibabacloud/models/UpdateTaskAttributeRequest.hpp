...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoApply_ == nullptr
        ...
        && return this->moduleVersion_ == nullptr && return this->name_ == nullptr && return this->protectionStrategy_ == nullptr && return this->ramRole_ == nullptr && return this->skipPropertyValidation_ == nullptr
        && return this->tags_ == nullptr && return this->terraformVersion_ == nullptr && return this->triggerStrategy_ == nullptr; };
