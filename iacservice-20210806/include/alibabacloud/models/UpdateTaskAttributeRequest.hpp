...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoApply_ == nullptr
        ...
        && this->skipRegionValidation_ == nullptr && this->tags_ == nullptr && this->terraformProviderVersion_ == nullptr && this->terraformVersion_ == nullptr && this->triggerStrategy_ == nullptr; };
    ...
    inline UpdateTaskAttributeRequest& setSkipRegionValidation(bool skipRegionValidation) { DARABONBA_PTR_SET_VALUE(skipRegionValidation_, skipRegionValidation) };
    ...
    inline UpdateTaskAttributeRequest& setTerraformProviderVersion(string terraformProviderVersion) { DARABONBA_PTR_SET_VALUE(terraformProviderVersion_, terraformProviderVersion) };
