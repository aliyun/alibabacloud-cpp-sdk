...
namespace Models
{
  ...
  public:
    ...
    inline const ListExplorerRegistryModuleExamplesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListExplorerRegistryModuleExamplesResponseBody) };
    inline ListExplorerRegistryModuleExamplesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListExplorerRegistryModuleExamplesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListExplorerRegistryModuleExamplesResponseBody> body_ {};
  };
