...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoDestroy_ == nullptr
        ...
        && this->notifyConfig_ == nullptr && this->notifyOperationTypes_ == nullptr && this->projectId_ == nullptr && this->ramRole_ == nullptr && this->reportExportField_ == nullptr
        && this->reportExportPath_ == nullptr && this->terraformProviderVersion_ == nullptr && this->triggerConfig_ == nullptr && this->triggerResourceType_ == nullptr; };
    ...
    inline const vector<CreateGroupRequest::NotifyConfig> & getNotifyConfig() const { DARABONBA_PTR_GET_CONST(notifyConfig_, vector<CreateGroupRequest::NotifyConfig>) };
    inline vector<CreateGroupRequest::NotifyConfig> getNotifyConfig() { DARABONBA_PTR_GET(notifyConfig_, vector<CreateGroupRequest::NotifyConfig>) };
    inline CreateGroupRequest& setNotifyConfig(const vector<CreateGroupRequest::NotifyConfig> & notifyConfig) { DARABONBA_PTR_SET_VALUE(notifyConfig_, notifyConfig) };
    inline CreateGroupRequest& setNotifyConfig(vector<CreateGroupRequest::NotifyConfig> && notifyConfig) { DARABONBA_PTR_SET_RVALUE(notifyConfig_, notifyConfig) };
    ...
    inline const vector<CreateGroupRequest::TriggerConfig> & getTriggerConfig() const { DARABONBA_PTR_GET_CONST(triggerConfig_, vector<CreateGroupRequest::TriggerConfig>) };
    inline vector<CreateGroupRequest::TriggerConfig> getTriggerConfig() { DARABONBA_PTR_GET(triggerConfig_, vector<CreateGroupRequest::TriggerConfig>) };
    inline CreateGroupRequest& setTriggerConfig(const vector<CreateGroupRequest::TriggerConfig> & triggerConfig) { DARABONBA_PTR_SET_VALUE(triggerConfig_, triggerConfig) };
    inline CreateGroupRequest& setTriggerConfig(vector<CreateGroupRequest::TriggerConfig> && triggerConfig) { DARABONBA_PTR_SET_RVALUE(triggerConfig_, triggerConfig) };
