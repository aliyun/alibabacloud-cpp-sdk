...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteTerraformApplyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExecuteTerraformApplyResponseBody) };
    inline ExecuteTerraformApplyResponseBody getBody() { DARABONBA_PTR_GET(body_, ExecuteTerraformApplyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExecuteTerraformApplyResponseBody> body_ {};
  };
