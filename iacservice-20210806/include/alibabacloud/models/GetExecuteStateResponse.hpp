...
namespace Models
{
  ...
  public:
    ...
    inline const GetExecuteStateResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetExecuteStateResponseBody) };
    inline GetExecuteStateResponseBody body() { DARABONBA_PTR_GET(body_, GetExecuteStateResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetExecuteStateResponseBody> body_ = nullptr;
  };
