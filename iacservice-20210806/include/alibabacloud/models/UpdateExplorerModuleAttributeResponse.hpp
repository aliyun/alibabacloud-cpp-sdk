...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateExplorerModuleAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateExplorerModuleAttributeResponseBody) };
    inline UpdateExplorerModuleAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateExplorerModuleAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateExplorerModuleAttributeResponseBody> body_ {};
  };
