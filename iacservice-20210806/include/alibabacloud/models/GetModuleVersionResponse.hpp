...
namespace Models
{
  ...
  public:
    ...
    inline const GetModuleVersionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetModuleVersionResponseBody) };
    inline GetModuleVersionResponseBody body() { DARABONBA_PTR_GET(body_, GetModuleVersionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetModuleVersionResponseBody> body_ = nullptr;
  };
