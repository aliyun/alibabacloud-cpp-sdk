...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateGroupResponseBody) };
    inline UpdateGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateGroupResponseBody> body_ {};
  };
