...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveSharedAccountsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RemoveSharedAccountsResponseBody) };
    inline RemoveSharedAccountsResponseBody body() { DARABONBA_PTR_GET(body_, RemoveSharedAccountsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RemoveSharedAccountsResponseBody> body_ = nullptr;
  };
