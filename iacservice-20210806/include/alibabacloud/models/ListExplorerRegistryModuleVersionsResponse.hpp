...
namespace Models
{
  ...
  public:
    ...
    inline const ListExplorerRegistryModuleVersionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListExplorerRegistryModuleVersionsResponseBody) };
    inline ListExplorerRegistryModuleVersionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListExplorerRegistryModuleVersionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListExplorerRegistryModuleVersionsResponseBody> body_ {};
  };
