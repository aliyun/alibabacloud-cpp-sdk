...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTaskAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTaskAttributeResponseBody) };
    inline UpdateTaskAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTaskAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTaskAttributeResponseBody> body_ {};
  };
