...
namespace Models
{
  ...
  public:
    ...
    inline const ListRegistryNamespacesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListRegistryNamespacesResponseBody) };
    inline ListRegistryNamespacesResponseBody body() { DARABONBA_PTR_GET(body_, ListRegistryNamespacesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListRegistryNamespacesResponseBody> body_ = nullptr;
  };
