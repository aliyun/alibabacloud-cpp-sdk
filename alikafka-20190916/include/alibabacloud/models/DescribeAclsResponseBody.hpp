...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->kafkaAclList_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const DescribeAclsResponseBodyKafkaAclList & kafkaAclList() const { DARABONBA_PTR_GET_CONST(kafkaAclList_, DescribeAclsResponseBodyKafkaAclList) };
    inline DescribeAclsResponseBodyKafkaAclList kafkaAclList() { DARABONBA_PTR_GET(kafkaAclList_, DescribeAclsResponseBodyKafkaAclList) };
    inline DescribeAclsResponseBody& setKafkaAclList(const DescribeAclsResponseBodyKafkaAclList & kafkaAclList) { DARABONBA_PTR_SET_VALUE(kafkaAclList_, kafkaAclList) };
    inline DescribeAclsResponseBody& setKafkaAclList(DescribeAclsResponseBodyKafkaAclList && kafkaAclList) { DARABONBA_PTR_SET_RVALUE(kafkaAclList_, kafkaAclList) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAclsResponseBodyKafkaAclList> kafkaAclList_ = nullptr;
