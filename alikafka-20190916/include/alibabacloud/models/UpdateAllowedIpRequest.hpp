...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allowedListIp_ == nullptr
        && this->allowedListType_ == nullptr && this->description_ == nullptr && this->instanceId_ == nullptr && this->portRange_ == nullptr && this->regionId_ == nullptr
        && this->updateType_ == nullptr; };
    ...
    inline string getAllowedListIp() const { DARABONBA_PTR_GET_DEFAULT(allowedListIp_, "") };
    ...
    inline string getAllowedListType() const { DARABONBA_PTR_GET_DEFAULT(allowedListType_, "") };
  ...
  protected:
    ...
    shared_ptr<string> allowedListIp_ {};
    ...
    // 
    // This parameter is required.
    shared_ptr<string> allowedListType_ {};
