...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyTopicRemarkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyTopicRemarkResponseBody) };
    inline ModifyTopicRemarkResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyTopicRemarkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyTopicRemarkResponseBody> body_ {};
  };
