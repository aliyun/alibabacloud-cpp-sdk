...
namespace Models
{
  ...
  public:
    ...
    inline const FailoverTestResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FailoverTestResponseBody) };
    inline FailoverTestResponseBody getBody() { DARABONBA_PTR_GET(body_, FailoverTestResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FailoverTestResponseBody> body_ {};
  };
