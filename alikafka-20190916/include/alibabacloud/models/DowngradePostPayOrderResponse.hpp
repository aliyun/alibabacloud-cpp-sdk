...
namespace Models
{
  ...
  public:
    ...
    inline const DowngradePostPayOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DowngradePostPayOrderResponseBody) };
    inline DowngradePostPayOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, DowngradePostPayOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DowngradePostPayOrderResponseBody> body_ {};
  };
