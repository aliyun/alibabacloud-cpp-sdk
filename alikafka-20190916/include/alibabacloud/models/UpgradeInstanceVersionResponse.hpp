...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeInstanceVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeInstanceVersionResponseBody) };
    inline UpgradeInstanceVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeInstanceVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeInstanceVersionResponseBody> body_ {};
  };
