...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTopicResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTopicResponseBody) };
    inline CreateTopicResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTopicResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTopicResponseBody> body_ {};
  };
