...
namespace Models
{
  ...
  public:
    ...
    inline const ListRebalanceInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRebalanceInfoResponseBody) };
    inline ListRebalanceInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRebalanceInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRebalanceInfoResponseBody> body_ {};
  };
