...
#ifndef ALIBABACLOUD_MODELS_CREATEPREPAYORDERREQUESTCONFLUENTCONFIG_HPP_
#define ALIBABACLOUD_MODELS_CREATEPREPAYORDERREQUESTCONFLUENTCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePrePayOrderRequestConfluentConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePrePayOrderRequestConfluentConfig& obj) { 
    ...
    CreatePrePayOrderRequestConfluentConfig() = default ;
    CreatePrePayOrderRequestConfluentConfig(const CreatePrePayOrderRequestConfluentConfig &) = default ;
    CreatePrePayOrderRequestConfluentConfig(CreatePrePayOrderRequestConfluentConfig &&) = default ;
    CreatePrePayOrderRequestConfluentConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePrePayOrderRequestConfluentConfig() = default ;
    CreatePrePayOrderRequestConfluentConfig& operator=(const CreatePrePayOrderRequestConfluentConfig &) = default ;
    CreatePrePayOrderRequestConfluentConfig& operator=(CreatePrePayOrderRequestConfluentConfig &&) = default ;
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setConnectCU(int32_t connectCU) { DARABONBA_PTR_SET_VALUE(connectCU_, connectCU) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setConnectReplica(int32_t connectReplica) { DARABONBA_PTR_SET_VALUE(connectReplica_, connectReplica) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setControlCenterCU(int32_t controlCenterCU) { DARABONBA_PTR_SET_VALUE(controlCenterCU_, controlCenterCU) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setControlCenterReplica(int32_t controlCenterReplica) { DARABONBA_PTR_SET_VALUE(controlCenterReplica_, controlCenterReplica) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setControlCenterStorage(int32_t controlCenterStorage) { DARABONBA_PTR_SET_VALUE(controlCenterStorage_, controlCenterStorage) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setKafkaCU(int32_t kafkaCU) { DARABONBA_PTR_SET_VALUE(kafkaCU_, kafkaCU) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setKafkaReplica(int32_t kafkaReplica) { DARABONBA_PTR_SET_VALUE(kafkaReplica_, kafkaReplica) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setKafkaRestProxyCU(int32_t kafkaRestProxyCU) { DARABONBA_PTR_SET_VALUE(kafkaRestProxyCU_, kafkaRestProxyCU) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setKafkaRestProxyReplica(int32_t kafkaRestProxyReplica) { DARABONBA_PTR_SET_VALUE(kafkaRestProxyReplica_, kafkaRestProxyReplica) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setKafkaStorage(int32_t kafkaStorage) { DARABONBA_PTR_SET_VALUE(kafkaStorage_, kafkaStorage) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setKsqlCU(int32_t ksqlCU) { DARABONBA_PTR_SET_VALUE(ksqlCU_, ksqlCU) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setKsqlReplica(int32_t ksqlReplica) { DARABONBA_PTR_SET_VALUE(ksqlReplica_, ksqlReplica) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setKsqlStorage(int32_t ksqlStorage) { DARABONBA_PTR_SET_VALUE(ksqlStorage_, ksqlStorage) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setSchemaRegistryCU(int32_t schemaRegistryCU) { DARABONBA_PTR_SET_VALUE(schemaRegistryCU_, schemaRegistryCU) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setSchemaRegistryReplica(int32_t schemaRegistryReplica) { DARABONBA_PTR_SET_VALUE(schemaRegistryReplica_, schemaRegistryReplica) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setZooKeeperCU(int32_t zooKeeperCU) { DARABONBA_PTR_SET_VALUE(zooKeeperCU_, zooKeeperCU) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setZooKeeperReplica(int32_t zooKeeperReplica) { DARABONBA_PTR_SET_VALUE(zooKeeperReplica_, zooKeeperReplica) };
    ...
    inline CreatePrePayOrderRequestConfluentConfig& setZooKeeperStorage(int32_t zooKeeperStorage) { DARABONBA_PTR_SET_VALUE(zooKeeperStorage_, zooKeeperStorage) };
