...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->deployType_ == nullptr
        ...
        && return this->paidType_ == nullptr && return this->partitionNum_ == nullptr && return this->regionId_ == nullptr && return this->resourceGroupId_ == nullptr && return this->serverlessConfigShrink_ == nullptr
