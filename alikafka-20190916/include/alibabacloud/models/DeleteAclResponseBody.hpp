...
namespace Models
{
  ...
  public:
    ...
    inline DeleteAclResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DeleteAclResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DeleteAclResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
