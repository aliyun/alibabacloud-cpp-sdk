...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->durationMinutes_ == nullptr
        ...
        && this->weeklyTypesShrink_ == nullptr; };
    ...
    inline int32_t getDurationMinutes() const { DARABONBA_PTR_GET_DEFAULT(durationMinutes_, 0) };
    ...
    inline int32_t getReservedPubFlow() const { DARABONBA_PTR_GET_DEFAULT(reservedPubFlow_, 0) };
    ...
    inline int32_t getReservedSubFlow() const { DARABONBA_PTR_GET_DEFAULT(reservedSubFlow_, 0) };
    ...
    inline string getWeeklyTypesShrink() const { DARABONBA_PTR_GET_DEFAULT(weeklyTypesShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> weeklyTypesShrink_ {};
  };
