...
namespace Models
{
  ...
  public:
    ...
    inline const DowngradePrePayOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DowngradePrePayOrderResponseBody) };
    inline DowngradePrePayOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, DowngradePrePayOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DowngradePrePayOrderResponseBody> body_ {};
  };
