...
namespace Models
{
  ...
  public:
    ...
    inline const GetAllowedIpListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAllowedIpListResponseBody) };
    inline GetAllowedIpListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAllowedIpListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAllowedIpListResponseBody> body_ {};
  };
