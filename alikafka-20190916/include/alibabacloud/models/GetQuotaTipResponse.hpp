...
namespace Models
{
  ...
  public:
    ...
    inline const GetQuotaTipResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetQuotaTipResponseBody) };
    inline GetQuotaTipResponseBody getBody() { DARABONBA_PTR_GET(body_, GetQuotaTipResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetQuotaTipResponseBody> body_ {};
  };
