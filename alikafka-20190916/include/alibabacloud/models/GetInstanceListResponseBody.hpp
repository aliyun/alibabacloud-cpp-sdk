...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->instanceList_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const GetInstanceListResponseBodyInstanceList & instanceList() const { DARABONBA_PTR_GET_CONST(instanceList_, GetInstanceListResponseBodyInstanceList) };
    inline GetInstanceListResponseBodyInstanceList instanceList() { DARABONBA_PTR_GET(instanceList_, GetInstanceListResponseBodyInstanceList) };
    inline GetInstanceListResponseBody& setInstanceList(const GetInstanceListResponseBodyInstanceList & instanceList) { DARABONBA_PTR_SET_VALUE(instanceList_, instanceList) };
    inline GetInstanceListResponseBody& setInstanceList(GetInstanceListResponseBodyInstanceList && instanceList) { DARABONBA_PTR_SET_RVALUE(instanceList_, instanceList) };
  ...
  protected:
    ...
    // The instances.
    std::shared_ptr<GetInstanceListResponseBodyInstanceList> instanceList_ = nullptr;
