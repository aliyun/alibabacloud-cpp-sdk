...
#ifndef ALIBABACLOUD_MODELS_DOWNGRADEPREPAYORDERREQUESTCONFLUENTCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DOWNGRADEPREPAYORDERREQUESTCONFLUENTCONFIG_HPP_
...
namespace Models
{
  class DowngradePrePayOrderRequestConfluentConfig : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DowngradePrePayOrderRequestConfluentConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DowngradePrePayOrderRequestConfluentConfig& obj) { 
    ...
    DowngradePrePayOrderRequestConfluentConfig() = default ;
    DowngradePrePayOrderRequestConfluentConfig(const DowngradePrePayOrderRequestConfluentConfig &) = default ;
    DowngradePrePayOrderRequestConfluentConfig(DowngradePrePayOrderRequestConfluentConfig &&) = default ;
    DowngradePrePayOrderRequestConfluentConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DowngradePrePayOrderRequestConfluentConfig() = default ;
    DowngradePrePayOrderRequestConfluentConfig& operator=(const DowngradePrePayOrderRequestConfluentConfig &) = default ;
    DowngradePrePayOrderRequestConfluentConfig& operator=(DowngradePrePayOrderRequestConfluentConfig &&) = default ;
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setConnectCU(int32_t connectCU) { DARABONBA_PTR_SET_VALUE(connectCU_, connectCU) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setConnectReplica(int32_t connectReplica) { DARABONBA_PTR_SET_VALUE(connectReplica_, connectReplica) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setControlCenterCU(int32_t controlCenterCU) { DARABONBA_PTR_SET_VALUE(controlCenterCU_, controlCenterCU) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setControlCenterReplica(int32_t controlCenterReplica) { DARABONBA_PTR_SET_VALUE(controlCenterReplica_, controlCenterReplica) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setControlCenterStorage(int32_t controlCenterStorage) { DARABONBA_PTR_SET_VALUE(controlCenterStorage_, controlCenterStorage) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setKafkaCU(int32_t kafkaCU) { DARABONBA_PTR_SET_VALUE(kafkaCU_, kafkaCU) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setKafkaReplica(int32_t kafkaReplica) { DARABONBA_PTR_SET_VALUE(kafkaReplica_, kafkaReplica) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setKafkaRestProxyCU(int32_t kafkaRestProxyCU) { DARABONBA_PTR_SET_VALUE(kafkaRestProxyCU_, kafkaRestProxyCU) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setKafkaRestProxyReplica(int32_t kafkaRestProxyReplica) { DARABONBA_PTR_SET_VALUE(kafkaRestProxyReplica_, kafkaRestProxyReplica) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setKafkaStorage(int32_t kafkaStorage) { DARABONBA_PTR_SET_VALUE(kafkaStorage_, kafkaStorage) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setKsqlCU(int32_t ksqlCU) { DARABONBA_PTR_SET_VALUE(ksqlCU_, ksqlCU) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setKsqlReplica(int32_t ksqlReplica) { DARABONBA_PTR_SET_VALUE(ksqlReplica_, ksqlReplica) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setKsqlStorage(int32_t ksqlStorage) { DARABONBA_PTR_SET_VALUE(ksqlStorage_, ksqlStorage) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setSchemaRegistryCU(int32_t schemaRegistryCU) { DARABONBA_PTR_SET_VALUE(schemaRegistryCU_, schemaRegistryCU) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setSchemaRegistryReplica(int32_t schemaRegistryReplica) { DARABONBA_PTR_SET_VALUE(schemaRegistryReplica_, schemaRegistryReplica) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setZooKeeperCU(int32_t zooKeeperCU) { DARABONBA_PTR_SET_VALUE(zooKeeperCU_, zooKeeperCU) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setZooKeeperReplica(int32_t zooKeeperReplica) { DARABONBA_PTR_SET_VALUE(zooKeeperReplica_, zooKeeperReplica) };
    ...
    inline DowngradePrePayOrderRequestConfluentConfig& setZooKeeperStorage(int32_t zooKeeperStorage) { DARABONBA_PTR_SET_VALUE(zooKeeperStorage_, zooKeeperStorage) };
