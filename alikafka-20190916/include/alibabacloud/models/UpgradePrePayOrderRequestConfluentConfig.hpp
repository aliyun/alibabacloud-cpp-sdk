...
#ifndef ALIBABACLOUD_MODELS_UPGRADEPREPAYORDERREQUESTCONFLUENTCONFIG_HPP_
#define ALIBABACLOUD_MODELS_UPGRADEPREPAYORDERREQUESTCONFLUENTCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpgradePrePayOrderRequestConfluentConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpgradePrePayOrderRequestConfluentConfig& obj) { 
    ...
    UpgradePrePayOrderRequestConfluentConfig() = default ;
    UpgradePrePayOrderRequestConfluentConfig(const UpgradePrePayOrderRequestConfluentConfig &) = default ;
    UpgradePrePayOrderRequestConfluentConfig(UpgradePrePayOrderRequestConfluentConfig &&) = default ;
    UpgradePrePayOrderRequestConfluentConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpgradePrePayOrderRequestConfluentConfig() = default ;
    UpgradePrePayOrderRequestConfluentConfig& operator=(const UpgradePrePayOrderRequestConfluentConfig &) = default ;
    UpgradePrePayOrderRequestConfluentConfig& operator=(UpgradePrePayOrderRequestConfluentConfig &&) = default ;
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setConnectCU(int32_t connectCU) { DARABONBA_PTR_SET_VALUE(connectCU_, connectCU) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setConnectReplica(int32_t connectReplica) { DARABONBA_PTR_SET_VALUE(connectReplica_, connectReplica) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setControlCenterCU(int32_t controlCenterCU) { DARABONBA_PTR_SET_VALUE(controlCenterCU_, controlCenterCU) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setControlCenterReplica(int32_t controlCenterReplica) { DARABONBA_PTR_SET_VALUE(controlCenterReplica_, controlCenterReplica) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setControlCenterStorage(int32_t controlCenterStorage) { DARABONBA_PTR_SET_VALUE(controlCenterStorage_, controlCenterStorage) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setKafkaCU(int32_t kafkaCU) { DARABONBA_PTR_SET_VALUE(kafkaCU_, kafkaCU) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setKafkaReplica(int32_t kafkaReplica) { DARABONBA_PTR_SET_VALUE(kafkaReplica_, kafkaReplica) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setKafkaRestProxyCU(int32_t kafkaRestProxyCU) { DARABONBA_PTR_SET_VALUE(kafkaRestProxyCU_, kafkaRestProxyCU) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setKafkaRestProxyReplica(int32_t kafkaRestProxyReplica) { DARABONBA_PTR_SET_VALUE(kafkaRestProxyReplica_, kafkaRestProxyReplica) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setKafkaStorage(int32_t kafkaStorage) { DARABONBA_PTR_SET_VALUE(kafkaStorage_, kafkaStorage) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setKsqlCU(int32_t ksqlCU) { DARABONBA_PTR_SET_VALUE(ksqlCU_, ksqlCU) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setKsqlReplica(int32_t ksqlReplica) { DARABONBA_PTR_SET_VALUE(ksqlReplica_, ksqlReplica) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setKsqlStorage(int32_t ksqlStorage) { DARABONBA_PTR_SET_VALUE(ksqlStorage_, ksqlStorage) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setSchemaRegistryCU(int32_t schemaRegistryCU) { DARABONBA_PTR_SET_VALUE(schemaRegistryCU_, schemaRegistryCU) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setSchemaRegistryReplica(int32_t schemaRegistryReplica) { DARABONBA_PTR_SET_VALUE(schemaRegistryReplica_, schemaRegistryReplica) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setZooKeeperCU(int32_t zooKeeperCU) { DARABONBA_PTR_SET_VALUE(zooKeeperCU_, zooKeeperCU) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setZooKeeperReplica(int32_t zooKeeperReplica) { DARABONBA_PTR_SET_VALUE(zooKeeperReplica_, zooKeeperReplica) };
    ...
    inline UpgradePrePayOrderRequestConfluentConfig& setZooKeeperStorage(int32_t zooKeeperStorage) { DARABONBA_PTR_SET_VALUE(zooKeeperStorage_, zooKeeperStorage) };
