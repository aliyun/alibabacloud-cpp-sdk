...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePostPayInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePostPayInstanceResponseBody) };
    inline CreatePostPayInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePostPayInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePostPayInstanceResponseBody> body_ {};
  };
