...
namespace Models
{
  ...
  public:
    ...
    inline const GetRiskListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRiskListResponseBodyData) };
    inline GetRiskListResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRiskListResponseBodyData) };
    inline GetRiskListResponseBody& setData(const GetRiskListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRiskListResponseBody& setData(GetRiskListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetRiskListResponseBodyData> data_ = nullptr;
