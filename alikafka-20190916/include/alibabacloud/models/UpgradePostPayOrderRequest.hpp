...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradePostPayOrderRequest::ServerlessConfig & getServerlessConfig() const { DARABONBA_PTR_GET_CONST(serverlessConfig_, UpgradePostPayOrderRequest::ServerlessConfig) };
    inline UpgradePostPayOrderRequest::ServerlessConfig getServerlessConfig() { DARABONBA_PTR_GET(serverlessConfig_, UpgradePostPayOrderRequest::ServerlessConfig) };
    inline UpgradePostPayOrderRequest& setServerlessConfig(const UpgradePostPayOrderRequest::ServerlessConfig & serverlessConfig) { DARABONBA_PTR_SET_VALUE(serverlessConfig_, serverlessConfig) };
    inline UpgradePostPayOrderRequest& setServerlessConfig(UpgradePostPayOrderRequest::ServerlessConfig && serverlessConfig) { DARABONBA_PTR_SET_RVALUE(serverlessConfig_, serverlessConfig) };
