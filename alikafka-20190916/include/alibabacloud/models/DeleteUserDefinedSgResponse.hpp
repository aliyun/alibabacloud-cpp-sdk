...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteUserDefinedSgResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteUserDefinedSgResponseBody) };
    inline DeleteUserDefinedSgResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteUserDefinedSgResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteUserDefinedSgResponseBody> body_ {};
  };
