...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->brokerOffset_ != nullptr
        && this->clientId_ != nullptr && this->clientIp_ != nullptr && this->consumerOffset_ != nullptr && this->lastTimestamp_ != nullptr && this->memberId_ != nullptr
