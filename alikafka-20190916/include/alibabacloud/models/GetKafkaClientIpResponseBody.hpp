...
namespace Models
{
  ...
  public:
    ...
    inline const GetKafkaClientIpResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetKafkaClientIpResponseBodyData) };
    inline GetKafkaClientIpResponseBodyData data() { DARABONBA_PTR_GET(data_, GetKafkaClientIpResponseBodyData) };
    inline GetKafkaClientIpResponseBody& setData(const GetKafkaClientIpResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetKafkaClientIpResponseBody& setData(GetKafkaClientIpResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetKafkaClientIpResponseBodyData> data_ = nullptr;
