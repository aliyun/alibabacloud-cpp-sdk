...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSaslUsersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSaslUsersResponseBody) };
    inline DescribeSaslUsersResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSaslUsersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSaslUsersResponseBody> body_ {};
  };
