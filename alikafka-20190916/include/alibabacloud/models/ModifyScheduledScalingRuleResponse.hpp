...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyScheduledScalingRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyScheduledScalingRuleResponseBody) };
    inline ModifyScheduledScalingRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyScheduledScalingRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyScheduledScalingRuleResponseBody> body_ {};
  };
