...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTopicConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTopicConfigResponseBody) };
    inline UpdateTopicConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTopicConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTopicConfigResponseBody> body_ {};
  };
