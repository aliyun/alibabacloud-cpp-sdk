...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteScheduledScalingRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteScheduledScalingRuleResponseBody) };
    inline DeleteScheduledScalingRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteScheduledScalingRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteScheduledScalingRuleResponseBody> body_ {};
  };
