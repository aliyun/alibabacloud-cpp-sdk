...
namespace Models
{
  ...
  public:
    ...
    inline const ListRebalanceInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListRebalanceInfoResponseBodyData) };
    inline ListRebalanceInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, ListRebalanceInfoResponseBodyData) };
    inline ListRebalanceInfoResponseBody& setData(const ListRebalanceInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListRebalanceInfoResponseBody& setData(ListRebalanceInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListRebalanceInfoResponseBodyData> data_ = nullptr;
