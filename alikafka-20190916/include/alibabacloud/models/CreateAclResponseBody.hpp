...
namespace Models
{
  ...
  public:
    ...
    inline CreateAclResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline CreateAclResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateAclResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
