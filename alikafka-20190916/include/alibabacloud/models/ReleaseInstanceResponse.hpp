...
namespace Models
{
  ...
  public:
    ...
    inline const ReleaseInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReleaseInstanceResponseBody) };
    inline ReleaseInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, ReleaseInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReleaseInstanceResponseBody> body_ {};
  };
