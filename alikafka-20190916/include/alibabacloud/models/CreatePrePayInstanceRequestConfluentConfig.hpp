...
#ifndef ALIBABACLOUD_MODELS_CREATEPREPAYINSTANCEREQUESTCONFLUENTCONFIG_HPP_
#define ALIBABACLOUD_MODELS_CREATEPREPAYINSTANCEREQUESTCONFLUENTCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePrePayInstanceRequestConfluentConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePrePayInstanceRequestConfluentConfig& obj) { 
    ...
    CreatePrePayInstanceRequestConfluentConfig() = default ;
    CreatePrePayInstanceRequestConfluentConfig(const CreatePrePayInstanceRequestConfluentConfig &) = default ;
    CreatePrePayInstanceRequestConfluentConfig(CreatePrePayInstanceRequestConfluentConfig &&) = default ;
    CreatePrePayInstanceRequestConfluentConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePrePayInstanceRequestConfluentConfig() = default ;
    CreatePrePayInstanceRequestConfluentConfig& operator=(const CreatePrePayInstanceRequestConfluentConfig &) = default ;
    CreatePrePayInstanceRequestConfluentConfig& operator=(CreatePrePayInstanceRequestConfluentConfig &&) = default ;
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setConnectCU(int32_t connectCU) { DARABONBA_PTR_SET_VALUE(connectCU_, connectCU) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setConnectReplica(int32_t connectReplica) { DARABONBA_PTR_SET_VALUE(connectReplica_, connectReplica) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setControlCenterCU(int32_t controlCenterCU) { DARABONBA_PTR_SET_VALUE(controlCenterCU_, controlCenterCU) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setControlCenterReplica(int32_t controlCenterReplica) { DARABONBA_PTR_SET_VALUE(controlCenterReplica_, controlCenterReplica) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setControlCenterStorage(int32_t controlCenterStorage) { DARABONBA_PTR_SET_VALUE(controlCenterStorage_, controlCenterStorage) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setKafkaCU(int32_t kafkaCU) { DARABONBA_PTR_SET_VALUE(kafkaCU_, kafkaCU) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setKafkaReplica(int32_t kafkaReplica) { DARABONBA_PTR_SET_VALUE(kafkaReplica_, kafkaReplica) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setKafkaRestProxyCU(int32_t kafkaRestProxyCU) { DARABONBA_PTR_SET_VALUE(kafkaRestProxyCU_, kafkaRestProxyCU) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setKafkaRestProxyReplica(int32_t kafkaRestProxyReplica) { DARABONBA_PTR_SET_VALUE(kafkaRestProxyReplica_, kafkaRestProxyReplica) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setKafkaStorage(int32_t kafkaStorage) { DARABONBA_PTR_SET_VALUE(kafkaStorage_, kafkaStorage) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setKsqlCU(int32_t ksqlCU) { DARABONBA_PTR_SET_VALUE(ksqlCU_, ksqlCU) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setKsqlReplica(int32_t ksqlReplica) { DARABONBA_PTR_SET_VALUE(ksqlReplica_, ksqlReplica) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setKsqlStorage(int32_t ksqlStorage) { DARABONBA_PTR_SET_VALUE(ksqlStorage_, ksqlStorage) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setSchemaRegistryCU(int32_t schemaRegistryCU) { DARABONBA_PTR_SET_VALUE(schemaRegistryCU_, schemaRegistryCU) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setSchemaRegistryReplica(int32_t schemaRegistryReplica) { DARABONBA_PTR_SET_VALUE(schemaRegistryReplica_, schemaRegistryReplica) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setZooKeeperCU(int32_t zooKeeperCU) { DARABONBA_PTR_SET_VALUE(zooKeeperCU_, zooKeeperCU) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setZooKeeperReplica(int32_t zooKeeperReplica) { DARABONBA_PTR_SET_VALUE(zooKeeperReplica_, zooKeeperReplica) };
    ...
    inline CreatePrePayInstanceRequestConfluentConfig& setZooKeeperStorage(int32_t zooKeeperStorage) { DARABONBA_PTR_SET_VALUE(zooKeeperStorage_, zooKeeperStorage) };
