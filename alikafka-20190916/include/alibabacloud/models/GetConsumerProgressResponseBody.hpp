...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->consumerProgress_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const GetConsumerProgressResponseBodyConsumerProgress & consumerProgress() const { DARABONBA_PTR_GET_CONST(consumerProgress_, GetConsumerProgressResponseBodyConsumerProgress) };
    inline GetConsumerProgressResponseBodyConsumerProgress consumerProgress() { DARABONBA_PTR_GET(consumerProgress_, GetConsumerProgressResponseBodyConsumerProgress) };
    inline GetConsumerProgressResponseBody& setConsumerProgress(const GetConsumerProgressResponseBodyConsumerProgress & consumerProgress) { DARABONBA_PTR_SET_VALUE(consumerProgress_, consumerProgress) };
    inline GetConsumerProgressResponseBody& setConsumerProgress(GetConsumerProgressResponseBodyConsumerProgress && consumerProgress) { DARABONBA_PTR_SET_RVALUE(consumerProgress_, consumerProgress) };
  ...
  protected:
    ...
    std::shared_ptr<GetConsumerProgressResponseBodyConsumerProgress> consumerProgress_ = nullptr;
