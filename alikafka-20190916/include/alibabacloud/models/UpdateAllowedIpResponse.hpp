...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAllowedIpResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAllowedIpResponseBody) };
    inline UpdateAllowedIpResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAllowedIpResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAllowedIpResponseBody> body_ {};
  };
