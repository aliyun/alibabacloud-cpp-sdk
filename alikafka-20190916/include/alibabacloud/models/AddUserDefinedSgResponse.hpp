...
namespace Models
{
  ...
  public:
    ...
    inline const AddUserDefinedSgResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddUserDefinedSgResponseBody) };
    inline AddUserDefinedSgResponseBody getBody() { DARABONBA_PTR_GET(body_, AddUserDefinedSgResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddUserDefinedSgResponseBody> body_ {};
  };
