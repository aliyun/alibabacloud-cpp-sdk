...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradePrePayOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradePrePayOrderResponseBody) };
    inline UpgradePrePayOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradePrePayOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradePrePayOrderResponseBody> body_ {};
  };
