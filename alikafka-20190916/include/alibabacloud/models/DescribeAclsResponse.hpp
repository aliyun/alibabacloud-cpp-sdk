...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAclsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeAclsResponseBody) };
    inline DescribeAclsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeAclsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAclsResponseBody> body_ = nullptr;
  };
