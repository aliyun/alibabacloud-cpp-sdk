...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAclResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteAclResponseBody) };
    inline DeleteAclResponseBody body() { DARABONBA_PTR_GET(body_, DeleteAclResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteAclResponseBody> body_ = nullptr;
  };
