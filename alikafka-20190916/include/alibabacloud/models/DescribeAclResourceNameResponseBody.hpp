...
namespace Models
{
  ...
  public:
    ...
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DescribeAclResourceNameResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeAclResourceNameResponseBody::Data) };
    inline DescribeAclResourceNameResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeAclResourceNameResponseBody::Data) };
    inline DescribeAclResourceNameResponseBody& setData(const DescribeAclResourceNameResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAclResourceNameResponseBody& setData(DescribeAclResourceNameResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
