...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->saslUserList_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const DescribeSaslUsersResponseBodySaslUserList & saslUserList() const { DARABONBA_PTR_GET_CONST(saslUserList_, DescribeSaslUsersResponseBodySaslUserList) };
    inline DescribeSaslUsersResponseBodySaslUserList saslUserList() { DARABONBA_PTR_GET(saslUserList_, DescribeSaslUsersResponseBodySaslUserList) };
    inline DescribeSaslUsersResponseBody& setSaslUserList(const DescribeSaslUsersResponseBodySaslUserList & saslUserList) { DARABONBA_PTR_SET_VALUE(saslUserList_, saslUserList) };
    inline DescribeSaslUsersResponseBody& setSaslUserList(DescribeSaslUsersResponseBodySaslUserList && saslUserList) { DARABONBA_PTR_SET_RVALUE(saslUserList_, saslUserList) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSaslUsersResponseBodySaslUserList> saslUserList_ = nullptr;
