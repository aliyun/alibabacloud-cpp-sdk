...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePostPayOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePostPayOrderResponseBody) };
    inline CreatePostPayOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePostPayOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePostPayOrderResponseBody> body_ {};
  };
