...
JyQueryAppInfoBySceneCodeResponse Alibabacloud_Dypnsapi20170525::Client::jyQueryAppInfoBySceneCodeWithOptions(shared_ptr<JyQueryAppInfoBySceneCodeRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<long>(request->ownerId)) {
    query->insert(pair<string, long>("OwnerId", *request->ownerId));
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("JyQueryAppInfoBySceneCode"))},
    {"version", boost::any(string("2017-05-25"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return JyQueryAppInfoBySceneCodeResponse(callApi(params, req, runtime));
}

JyQueryAppInfoBySceneCodeResponse Alibabacloud_Dypnsapi20170525::Client::jyQueryAppInfoBySceneCode(shared_ptr<JyQueryAppInfoBySceneCodeRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
