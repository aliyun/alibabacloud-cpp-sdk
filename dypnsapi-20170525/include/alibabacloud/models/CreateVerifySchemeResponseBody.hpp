...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVerifySchemeResponseBodyGateVerifySchemeDTO & gateVerifySchemeDTO() const { DARABONBA_PTR_GET_CONST(gateVerifySchemeDTO_, CreateVerifySchemeResponseBodyGateVerifySchemeDTO) };
    inline CreateVerifySchemeResponseBodyGateVerifySchemeDTO gateVerifySchemeDTO() { DARABONBA_PTR_GET(gateVerifySchemeDTO_, CreateVerifySchemeResponseBodyGateVerifySchemeDTO) };
    inline CreateVerifySchemeResponseBody& setGateVerifySchemeDTO(const CreateVerifySchemeResponseBodyGateVerifySchemeDTO & gateVerifySchemeDTO) { DARABONBA_PTR_SET_VALUE(gateVerifySchemeDTO_, gateVerifySchemeDTO) };
    inline CreateVerifySchemeResponseBody& setGateVerifySchemeDTO(CreateVerifySchemeResponseBodyGateVerifySchemeDTO && gateVerifySchemeDTO) { DARABONBA_PTR_SET_RVALUE(gateVerifySchemeDTO_, gateVerifySchemeDTO) };
  ...
  protected:
    ...
    std::shared_ptr<CreateVerifySchemeResponseBodyGateVerifySchemeDTO> gateVerifySchemeDTO_ = nullptr;
