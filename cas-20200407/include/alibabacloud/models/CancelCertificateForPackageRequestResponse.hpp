...
namespace Models
{
  ...
  public:
    ...
    inline const CancelCertificateForPackageRequestResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelCertificateForPackageRequestResponseBody) };
    inline CancelCertificateForPackageRequestResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelCertificateForPackageRequestResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelCertificateForPackageRequestResponseBody> body_ {};
  };
