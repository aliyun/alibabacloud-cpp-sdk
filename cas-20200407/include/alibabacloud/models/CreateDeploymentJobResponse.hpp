...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDeploymentJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDeploymentJobResponseBody) };
    inline CreateDeploymentJobResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDeploymentJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDeploymentJobResponseBody> body_ {};
  };
