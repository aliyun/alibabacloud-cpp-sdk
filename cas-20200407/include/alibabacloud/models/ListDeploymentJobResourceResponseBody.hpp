...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDeploymentJobResourceResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListDeploymentJobResourceResponseBody::Data>) };
    inline vector<ListDeploymentJobResourceResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListDeploymentJobResourceResponseBody::Data>) };
    inline ListDeploymentJobResourceResponseBody& setData(const vector<ListDeploymentJobResourceResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDeploymentJobResourceResponseBody& setData(vector<ListDeploymentJobResourceResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<vector<ListDeploymentJobResourceResponseBody::Data>> data_ {};
    // The request ID.
