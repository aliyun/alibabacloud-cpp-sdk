...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cloudProduct_ == nullptr
        && return this->currentPage_ == nullptr && return this->jobId_ == nullptr && return this->showSize_ == nullptr && return this->status_ == nullptr; };
