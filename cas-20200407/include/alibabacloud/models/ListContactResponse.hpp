...
namespace Models
{
  ...
  public:
    ...
    inline const ListContactResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListContactResponseBody) };
    inline ListContactResponseBody getBody() { DARABONBA_PTR_GET(body_, ListContactResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListContactResponseBody> body_ {};
  };
