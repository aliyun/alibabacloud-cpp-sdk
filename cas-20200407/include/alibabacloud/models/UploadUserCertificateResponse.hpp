...
namespace Models
{
  ...
  public:
    ...
    inline const UploadUserCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UploadUserCertificateResponseBody) };
    inline UploadUserCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, UploadUserCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UploadUserCertificateResponseBody> body_ {};
  };
