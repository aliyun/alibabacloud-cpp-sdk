...
namespace Models
{
  ...
  public:
    ...
    inline const ListCsrResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCsrResponseBody) };
    inline ListCsrResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCsrResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCsrResponseBody> body_ {};
  };
