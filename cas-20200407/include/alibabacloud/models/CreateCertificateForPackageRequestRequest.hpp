...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateCertificateForPackageRequestRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<CreateCertificateForPackageRequestRequest::Tags>) };
    inline vector<CreateCertificateForPackageRequestRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<CreateCertificateForPackageRequestRequest::Tags>) };
    inline CreateCertificateForPackageRequestRequest& setTags(const vector<CreateCertificateForPackageRequestRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline CreateCertificateForPackageRequestRequest& setTags(vector<CreateCertificateForPackageRequestRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    // The list of tags.
    shared_ptr<vector<CreateCertificateForPackageRequestRequest::Tags>> tags_ {};
