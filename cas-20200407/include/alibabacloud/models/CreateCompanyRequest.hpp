...
#ifndef ALIBABACLOUD_MODELS_CREATECOMPANYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATECOMPANYREQUEST_HPP_
...
namespace Models
{
  class CreateCompanyRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateCompanyRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateCompanyRequest& obj) { 
    ...
    CreateCompanyRequest(const CreateCompanyRequest &) = default ;
    CreateCompanyRequest(CreateCompanyRequest &&) = default ;
    CreateCompanyRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateCompanyRequest() = default ;
    CreateCompanyRequest& operator=(const CreateCompanyRequest &) = default ;
    CreateCompanyRequest& operator=(CreateCompanyRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->city_ == nullptr
        && this->companyAddress_ == nullptr && this->companyCode_ == nullptr && this->companyEmail_ == nullptr && this->companyName_ == nullptr && this->companyPhone_ == nullptr
        && this->companyType_ == nullptr && this->countryCode_ == nullptr && this->department_ == nullptr && this->lang_ == nullptr && this->postCode_ == nullptr
        && this->province_ == nullptr; };
    // city Field Functions 
    bool hasCity() const { return this->city_ != nullptr;};
    void deleteCity() { this->city_ = nullptr;};
    inline string getCity() const { DARABONBA_PTR_GET_DEFAULT(city_, "") };
    inline CreateCompanyRequest& setCity(string city) { DARABONBA_PTR_SET_VALUE(city_, city) };
    ...
    inline CreateCompanyRequest& setCompanyAddress(string companyAddress) { DARABONBA_PTR_SET_VALUE(companyAddress_, companyAddress) };
    ...
    inline CreateCompanyRequest& setCompanyCode(string companyCode) { DARABONBA_PTR_SET_VALUE(companyCode_, companyCode) };
    ...
    inline CreateCompanyRequest& setCompanyEmail(string companyEmail) { DARABONBA_PTR_SET_VALUE(companyEmail_, companyEmail) };
    ...
    inline CreateCompanyRequest& setCompanyName(string companyName) { DARABONBA_PTR_SET_VALUE(companyName_, companyName) };
    ...
    inline CreateCompanyRequest& setCompanyPhone(string companyPhone) { DARABONBA_PTR_SET_VALUE(companyPhone_, companyPhone) };
    ...
    inline CreateCompanyRequest& setCompanyType(int32_t companyType) { DARABONBA_PTR_SET_VALUE(companyType_, companyType) };
    ...
    inline CreateCompanyRequest& setCountryCode(string countryCode) { DARABONBA_PTR_SET_VALUE(countryCode_, countryCode) };
    ...
    inline CreateCompanyRequest& setDepartment(string department) { DARABONBA_PTR_SET_VALUE(department_, department) };
    ...
    inline CreateCompanyRequest& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline CreateCompanyRequest& setPostCode(string postCode) { DARABONBA_PTR_SET_VALUE(postCode_, postCode) };
    ...
    inline CreateCompanyRequest& setProvince(string province) { DARABONBA_PTR_SET_VALUE(province_, province) };
