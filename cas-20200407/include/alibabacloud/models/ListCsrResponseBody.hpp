...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->csrList_ != nullptr
    ...
    inline const vector<ListCsrResponseBodyCsrList> & csrList() const { DARABONBA_PTR_GET_CONST(csrList_, vector<ListCsrResponseBodyCsrList>) };
    inline vector<ListCsrResponseBodyCsrList> csrList() { DARABONBA_PTR_GET(csrList_, vector<ListCsrResponseBodyCsrList>) };
    inline ListCsrResponseBody& setCsrList(const vector<ListCsrResponseBodyCsrList> & csrList) { DARABONBA_PTR_SET_VALUE(csrList_, csrList) };
    inline ListCsrResponseBody& setCsrList(vector<ListCsrResponseBodyCsrList> && csrList) { DARABONBA_PTR_SET_RVALUE(csrList_, csrList) };
  ...
  protected:
    // The CSRs.
    std::shared_ptr<vector<ListCsrResponseBodyCsrList>> csrList_ = nullptr;
    // The page number.
