...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserCertificateOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUserCertificateOrderResponseBody) };
    inline ListUserCertificateOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUserCertificateOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUserCertificateOrderResponseBody> body_ {};
  };
