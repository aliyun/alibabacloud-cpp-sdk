...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListCertResponseBodyCertList> & certList() const { DARABONBA_PTR_GET_CONST(certList_, vector<ListCertResponseBodyCertList>) };
    inline vector<ListCertResponseBodyCertList> certList() { DARABONBA_PTR_GET(certList_, vector<ListCertResponseBodyCertList>) };
    inline ListCertResponseBody& setCertList(const vector<ListCertResponseBodyCertList> & certList) { DARABONBA_PTR_SET_VALUE(certList_, certList) };
    inline ListCertResponseBody& setCertList(vector<ListCertResponseBodyCertList> && certList) { DARABONBA_PTR_SET_RVALUE(certList_, certList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListCertResponseBodyCertList>> certList_ = nullptr;
