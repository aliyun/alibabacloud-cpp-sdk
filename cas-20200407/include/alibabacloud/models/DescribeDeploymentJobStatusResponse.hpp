...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDeploymentJobStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDeploymentJobStatusResponseBody) };
    inline DescribeDeploymentJobStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDeploymentJobStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDeploymentJobStatusResponseBody> body_ {};
  };
