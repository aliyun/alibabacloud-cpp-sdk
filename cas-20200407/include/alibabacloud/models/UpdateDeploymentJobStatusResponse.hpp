...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDeploymentJobStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateDeploymentJobStatusResponseBody) };
    inline UpdateDeploymentJobStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateDeploymentJobStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateDeploymentJobStatusResponseBody> body_ {};
  };
