...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCertificateForPackageRequestResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCertificateForPackageRequestResponseBody) };
    inline CreateCertificateForPackageRequestResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCertificateForPackageRequestResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCertificateForPackageRequestResponseBody> body_ {};
  };
