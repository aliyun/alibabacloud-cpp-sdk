...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDeploymentJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDeploymentJobResponseBody) };
    inline DescribeDeploymentJobResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDeploymentJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDeploymentJobResponseBody> body_ {};
  };
