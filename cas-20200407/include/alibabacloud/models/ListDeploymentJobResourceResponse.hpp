...
namespace Models
{
  ...
  public:
    ...
    inline const ListDeploymentJobResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDeploymentJobResourceResponseBody) };
    inline ListDeploymentJobResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDeploymentJobResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDeploymentJobResourceResponseBody> body_ {};
  };
