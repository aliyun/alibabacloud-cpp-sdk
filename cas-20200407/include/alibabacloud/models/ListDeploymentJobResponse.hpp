...
namespace Models
{
  ...
  public:
    ...
    inline const ListDeploymentJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDeploymentJobResponseBody) };
    inline ListDeploymentJobResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDeploymentJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDeploymentJobResponseBody> body_ {};
  };
