...
namespace Models
{
  ...
  public:
    ...
    inline const DecryptResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DecryptResponseBody) };
    inline DecryptResponseBody getBody() { DARABONBA_PTR_GET(body_, DecryptResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DecryptResponseBody> body_ {};
  };
