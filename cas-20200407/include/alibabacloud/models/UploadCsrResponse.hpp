...
namespace Models
{
  ...
  public:
    ...
    inline const UploadCsrResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UploadCsrResponseBody) };
    inline UploadCsrResponseBody getBody() { DARABONBA_PTR_GET(body_, UploadCsrResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UploadCsrResponseBody> body_ {};
  };
