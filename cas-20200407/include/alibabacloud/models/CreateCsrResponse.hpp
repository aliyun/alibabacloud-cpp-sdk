...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCsrResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCsrResponseBody) };
    inline CreateCsrResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCsrResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCsrResponseBody> body_ {};
  };
