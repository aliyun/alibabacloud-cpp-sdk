...
namespace Models
{
  ...
  public:
    ...
    inline const GetCsrDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCsrDetailResponseBody) };
    inline GetCsrDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCsrDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCsrDetailResponseBody> body_ {};
  };
