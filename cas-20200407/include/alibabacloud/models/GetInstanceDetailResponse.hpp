...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceDetailResponseBody) };
    inline GetInstanceDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInstanceDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInstanceDetailResponseBody> body_ {};
  };
