...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDeploymentJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDeploymentJobResponseBody) };
    inline DeleteDeploymentJobResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDeploymentJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDeploymentJobResponseBody> body_ {};
  };
