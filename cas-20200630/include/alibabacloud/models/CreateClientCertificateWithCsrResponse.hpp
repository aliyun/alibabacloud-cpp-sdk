...
namespace Models
{
  ...
  public:
    ...
    inline const CreateClientCertificateWithCsrResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateClientCertificateWithCsrResponseBody) };
    inline CreateClientCertificateWithCsrResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateClientCertificateWithCsrResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateClientCertificateWithCsrResponseBody> body_ {};
  };
