...
namespace Models
{
  ...
  public:
    ...
    inline DescribeCACertificateResponseBodyCertificate& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline const vector<Models::DescribeCACertificateResponseBodyCertificateTags> & tags() const { DARABONBA_PTR_GET_CONST(tags_, vector<Models::DescribeCACertificateResponseBodyCertificateTags>) };
    inline vector<Models::DescribeCACertificateResponseBodyCertificateTags> tags() { DARABONBA_PTR_GET(tags_, vector<Models::DescribeCACertificateResponseBodyCertificateTags>) };
    inline DescribeCACertificateResponseBodyCertificate& setTags(const vector<Models::DescribeCACertificateResponseBodyCertificateTags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline DescribeCACertificateResponseBodyCertificate& setTags(vector<Models::DescribeCACertificateResponseBodyCertificateTags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::DescribeCACertificateResponseBodyCertificateTags>> tags_ = nullptr;
