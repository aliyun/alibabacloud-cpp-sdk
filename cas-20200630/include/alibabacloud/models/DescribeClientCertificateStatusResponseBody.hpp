...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeClientCertificateStatusResponseBody::CertificateStatus> & getCertificateStatus() const { DARABONBA_PTR_GET_CONST(certificateStatus_, vector<DescribeClientCertificateStatusResponseBody::CertificateStatus>) };
    inline vector<DescribeClientCertificateStatusResponseBody::CertificateStatus> getCertificateStatus() { DARABONBA_PTR_GET(certificateStatus_, vector<DescribeClientCertificateStatusResponseBody::CertificateStatus>) };
    inline DescribeClientCertificateStatusResponseBody& setCertificateStatus(const vector<DescribeClientCertificateStatusResponseBody::CertificateStatus> & certificateStatus) { DARABONBA_PTR_SET_VALUE(certificateStatus_, certificateStatus) };
    inline DescribeClientCertificateStatusResponseBody& setCertificateStatus(vector<DescribeClientCertificateStatusResponseBody::CertificateStatus> && certificateStatus) { DARABONBA_PTR_SET_RVALUE(certificateStatus_, certificateStatus) };
