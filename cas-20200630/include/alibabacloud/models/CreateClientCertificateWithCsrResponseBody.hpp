...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->certKmcRep1_ == nullptr
        && return this->certSignBufKmc_ == nullptr && return this->certificateChain_ == nullptr && return this->identifier_ == nullptr && return this->requestId_ == nullptr && return this->serialNumber_ == nullptr
        && return this->x509Certificate_ == nullptr; };
    ...
    inline string certKmcRep1() const { DARABONBA_PTR_GET_DEFAULT(certKmcRep1_, "") };
    ...
    inline string certSignBufKmc() const { DARABONBA_PTR_GET_DEFAULT(certSignBufKmc_, "") };
  ...
  protected:
    // CertKmcRep1.
    std::shared_ptr<string> certKmcRep1_ = nullptr;
    // Cert Sign Buf Kmc.
    std::shared_ptr<string> certSignBufKmc_ = nullptr;
