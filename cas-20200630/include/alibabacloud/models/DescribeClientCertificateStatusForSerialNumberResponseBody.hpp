...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeClientCertificateStatusForSerialNumberResponseBodyCertificateStatus> & certificateStatus() const { DARABONBA_PTR_GET_CONST(certificateStatus_, vector<DescribeClientCertificateStatusForSerialNumberResponseBodyCertificateStatus>) };
    inline vector<DescribeClientCertificateStatusForSerialNumberResponseBodyCertificateStatus> certificateStatus() { DARABONBA_PTR_GET(certificateStatus_, vector<DescribeClientCertificateStatusForSerialNumberResponseBodyCertificateStatus>) };
    inline DescribeClientCertificateStatusForSerialNumberResponseBody& setCertificateStatus(const vector<DescribeClientCertificateStatusForSerialNumberResponseBodyCertificateStatus> & certificateStatus) { DARABONBA_PTR_SET_VALUE(certificateStatus_, certificateStatus) };
    inline DescribeClientCertificateStatusForSerialNumberResponseBody& setCertificateStatus(vector<DescribeClientCertificateStatusForSerialNumberResponseBodyCertificateStatus> && certificateStatus) { DARABONBA_PTR_SET_RVALUE(certificateStatus_, certificateStatus) };
  ...
  protected:
    // The object.
    std::shared_ptr<vector<DescribeClientCertificateStatusForSerialNumberResponseBodyCertificateStatus>> certificateStatus_ = nullptr;
    // The request ID.
