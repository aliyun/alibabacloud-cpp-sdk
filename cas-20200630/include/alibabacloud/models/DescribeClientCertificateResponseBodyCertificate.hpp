...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeClientCertificateResponseBodyCertificate& obj) { 
    ...
    DescribeClientCertificateResponseBodyCertificate(const DescribeClientCertificateResponseBodyCertificate &) = default ;
    DescribeClientCertificateResponseBodyCertificate(DescribeClientCertificateResponseBodyCertificate &&) = default ;
    DescribeClientCertificateResponseBodyCertificate(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeClientCertificateResponseBodyCertificate() = default ;
    DescribeClientCertificateResponseBodyCertificate& operator=(const DescribeClientCertificateResponseBodyCertificate &) = default ;
    DescribeClientCertificateResponseBodyCertificate& operator=(DescribeClientCertificateResponseBodyCertificate &&) = default ;
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setAfterDate(int64_t afterDate) { DARABONBA_PTR_SET_VALUE(afterDate_, afterDate) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setAlgorithm(string algorithm) { DARABONBA_PTR_SET_VALUE(algorithm_, algorithm) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setCertificateType(string certificateType) { DARABONBA_PTR_SET_VALUE(certificateType_, certificateType) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setCommonName(string commonName) { DARABONBA_PTR_SET_VALUE(commonName_, commonName) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setDays(int32_t days) { DARABONBA_PTR_SET_VALUE(days_, days) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setIdentifier(string identifier) { DARABONBA_PTR_SET_VALUE(identifier_, identifier) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setKeySize(int32_t keySize) { DARABONBA_PTR_SET_VALUE(keySize_, keySize) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setLocality(string locality) { DARABONBA_PTR_SET_VALUE(locality_, locality) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setMd5(string md5) { DARABONBA_PTR_SET_VALUE(md5_, md5) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setOrganization(string organization) { DARABONBA_PTR_SET_VALUE(organization_, organization) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setOrganizationUnit(string organizationUnit) { DARABONBA_PTR_SET_VALUE(organizationUnit_, organizationUnit) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setSans(string sans) { DARABONBA_PTR_SET_VALUE(sans_, sans) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setSerialNumber(string serialNumber) { DARABONBA_PTR_SET_VALUE(serialNumber_, serialNumber) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setSha2(string sha2) { DARABONBA_PTR_SET_VALUE(sha2_, sha2) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setSignAlgorithm(string signAlgorithm) { DARABONBA_PTR_SET_VALUE(signAlgorithm_, signAlgorithm) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setState(string state) { DARABONBA_PTR_SET_VALUE(state_, state) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline DescribeClientCertificateResponseBodyCertificate& setX509Certificate(string x509Certificate) { DARABONBA_PTR_SET_VALUE(x509Certificate_, x509Certificate) };
