  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->afterDate_ == nullptr
        ...
        && this->status_ == nullptr && this->subjectDN_ == nullptr && this->trial_ == nullptr && this->x509Certificate_ == nullptr && this->years_ == nullptr; };
      ...
      inline CertificateList& setAlias(string alias) { DARABONBA_PTR_SET_VALUE(alias_, alias) };
      ...
      inline int32_t getGift() const { DARABONBA_PTR_GET_DEFAULT(gift_, 0) };
      inline CertificateList& setGift(int32_t gift) { DARABONBA_PTR_SET_VALUE(gift_, gift) };
      ...
      inline int32_t getTrial() const { DARABONBA_PTR_GET_DEFAULT(trial_, 0) };
      inline CertificateList& setTrial(int32_t trial) { DARABONBA_PTR_SET_VALUE(trial_, trial) };
    ...
    inline const vector<DescribeCACertificateListResponseBody::CertificateList> & getCertificateList() const { DARABONBA_PTR_GET_CONST(certificateList_, vector<DescribeCACertificateListResponseBody::CertificateList>) };
    inline vector<DescribeCACertificateListResponseBody::CertificateList> getCertificateList() { DARABONBA_PTR_GET(certificateList_, vector<DescribeCACertificateListResponseBody::CertificateList>) };
    inline DescribeCACertificateListResponseBody& setCertificateList(const vector<DescribeCACertificateListResponseBody::CertificateList> & certificateList) { DARABONBA_PTR_SET_VALUE(certificateList_, certificateList) };
    inline DescribeCACertificateListResponseBody& setCertificateList(vector<DescribeCACertificateListResponseBody::CertificateList> && certificateList) { DARABONBA_PTR_SET_RVALUE(certificateList_, certificateList) };
