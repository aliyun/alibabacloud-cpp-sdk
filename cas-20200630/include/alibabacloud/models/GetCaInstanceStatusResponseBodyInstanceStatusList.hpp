...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->afterTime_ == nullptr
        && return this->beforeTime_ == nullptr && return this->certIssuedCount_ == nullptr && return this->certTotalCount_ == nullptr && return this->identifier_ == nullptr && return this->instanceId_ == nullptr
        && return this->status_ == nullptr && return this->type_ == nullptr && return this->useExpireTime_ == nullptr; };
