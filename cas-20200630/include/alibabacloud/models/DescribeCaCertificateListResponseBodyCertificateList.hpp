...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->afterDate_ == nullptr
        && return this->algorithm_ == nullptr && return this->alias_ == nullptr && return this->beforeDate_ == nullptr && return this->certificateType_ == nullptr && return this->commonName_ == nullptr
        && return this->countryCode_ == nullptr && return this->gift_ == nullptr && return this->identifier_ == nullptr && return this->keySize_ == nullptr && return this->locality_ == nullptr
        && return this->md5_ == nullptr && return this->organization_ == nullptr && return this->organizationUnit_ == nullptr && return this->parentIdentifier_ == nullptr && return this->resourceGroupId_ == nullptr
        && return this->sans_ == nullptr && return this->serialNumber_ == nullptr && return this->sha2_ == nullptr && return this->signAlgorithm_ == nullptr && return this->state_ == nullptr
        && return this->status_ == nullptr && return this->subjectDN_ == nullptr && return this->trial_ == nullptr && return this->x509Certificate_ == nullptr && return this->years_ == nullptr; };
    ...
    inline DescribeCACertificateListResponseBodyCertificateList& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
