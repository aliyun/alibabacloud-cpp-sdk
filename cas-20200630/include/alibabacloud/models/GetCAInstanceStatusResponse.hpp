...
namespace Models
{
  ...
  public:
    ...
    inline const GetCAInstanceStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCAInstanceStatusResponseBody) };
    inline GetCAInstanceStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCAInstanceStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCAInstanceStatusResponseBody> body_ {};
  };
