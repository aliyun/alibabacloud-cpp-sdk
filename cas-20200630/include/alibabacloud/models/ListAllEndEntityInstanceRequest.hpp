...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentPage_ == nullptr
        && return this->maxResults_ == nullptr && return this->nextToken_ == nullptr && return this->parentId_ == nullptr && return this->recursiveChildren_ == nullptr && return this->showSize_ == nullptr; };
    ...
    inline int32_t recursiveChildren() const { DARABONBA_PTR_GET_DEFAULT(recursiveChildren_, 0) };
  ...
  protected:
    ...
    std::shared_ptr<int32_t> recursiveChildren_ = nullptr;
