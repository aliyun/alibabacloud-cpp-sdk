...
namespace Models
{
  ...
  public:
    ...
    inline const ListRevokeCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRevokeCertificateResponseBody) };
    inline ListRevokeCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRevokeCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRevokeCertificateResponseBody> body_ {};
  };
