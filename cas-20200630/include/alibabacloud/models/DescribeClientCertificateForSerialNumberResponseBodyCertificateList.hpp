...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECLIENTCERTIFICATEFORSERIALNUMBERRESPONSEBODYCERTIFICATELIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECLIENTCERTIFICATEFORSERIALNUMBERRESPONSEBODYCERTIFICATELIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeClientCertificateForSerialNumberResponseBodyCertificateList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeClientCertificateForSerialNumberResponseBodyCertificateList& obj) { 
    ...
    DescribeClientCertificateForSerialNumberResponseBodyCertificateList() = default ;
    DescribeClientCertificateForSerialNumberResponseBodyCertificateList(const DescribeClientCertificateForSerialNumberResponseBodyCertificateList &) = default ;
    DescribeClientCertificateForSerialNumberResponseBodyCertificateList(DescribeClientCertificateForSerialNumberResponseBodyCertificateList &&) = default ;
    DescribeClientCertificateForSerialNumberResponseBodyCertificateList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeClientCertificateForSerialNumberResponseBodyCertificateList() = default ;
    DescribeClientCertificateForSerialNumberResponseBodyCertificateList& operator=(const DescribeClientCertificateForSerialNumberResponseBodyCertificateList &) = default ;
    DescribeClientCertificateForSerialNumberResponseBodyCertificateList& operator=(DescribeClientCertificateForSerialNumberResponseBodyCertificateList &&) = default ;
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setAfterDate(string afterDate) { DARABONBA_PTR_SET_VALUE(afterDate_, afterDate) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setAlgorithm(string algorithm) { DARABONBA_PTR_SET_VALUE(algorithm_, algorithm) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setBeforeDate(string beforeDate) { DARABONBA_PTR_SET_VALUE(beforeDate_, beforeDate) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setCertificateType(string certificateType) { DARABONBA_PTR_SET_VALUE(certificateType_, certificateType) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setCommonName(string commonName) { DARABONBA_PTR_SET_VALUE(commonName_, commonName) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setCountryCode(string countryCode) { DARABONBA_PTR_SET_VALUE(countryCode_, countryCode) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setIdentifier(string identifier) { DARABONBA_PTR_SET_VALUE(identifier_, identifier) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setKeySize(int32_t keySize) { DARABONBA_PTR_SET_VALUE(keySize_, keySize) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setLocality(string locality) { DARABONBA_PTR_SET_VALUE(locality_, locality) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setMd5(string md5) { DARABONBA_PTR_SET_VALUE(md5_, md5) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setOrganization(string organization) { DARABONBA_PTR_SET_VALUE(organization_, organization) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setOrganizationUnit(string organizationUnit) { DARABONBA_PTR_SET_VALUE(organizationUnit_, organizationUnit) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setParentIdentifier(string parentIdentifier) { DARABONBA_PTR_SET_VALUE(parentIdentifier_, parentIdentifier) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setSans(string sans) { DARABONBA_PTR_SET_VALUE(sans_, sans) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setSerialNumber(string serialNumber) { DARABONBA_PTR_SET_VALUE(serialNumber_, serialNumber) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setSha2(string sha2) { DARABONBA_PTR_SET_VALUE(sha2_, sha2) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setSignAlgorithm(string signAlgorithm) { DARABONBA_PTR_SET_VALUE(signAlgorithm_, signAlgorithm) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setState(string state) { DARABONBA_PTR_SET_VALUE(state_, state) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setSubjectDN(string subjectDN) { DARABONBA_PTR_SET_VALUE(subjectDN_, subjectDN) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setX509Certificate(string x509Certificate) { DARABONBA_PTR_SET_VALUE(x509Certificate_, x509Certificate) };
    ...
    inline DescribeClientCertificateForSerialNumberResponseBodyCertificateList& setYears(int32_t years) { DARABONBA_PTR_SET_VALUE(years_, years) };
