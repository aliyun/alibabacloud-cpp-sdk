...
#ifndef ALIBABACLOUD_MODELS_LISTREVOKECERTIFICATERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTREVOKECERTIFICATERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListRevokeCertificateResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListRevokeCertificateResponseBody& obj) { 
    ...
    ListRevokeCertificateResponseBody() = default ;
    ListRevokeCertificateResponseBody(const ListRevokeCertificateResponseBody &) = default ;
    ListRevokeCertificateResponseBody(ListRevokeCertificateResponseBody &&) = default ;
    ListRevokeCertificateResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListRevokeCertificateResponseBody() = default ;
    ListRevokeCertificateResponseBody& operator=(const ListRevokeCertificateResponseBody &) = default ;
    ListRevokeCertificateResponseBody& operator=(ListRevokeCertificateResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->afterDate_ == nullptr
        ...
        && this->customIdentifier_ == nullptr && this->identifier_ == nullptr && this->keySize_ == nullptr && this->locality_ == nullptr && this->md5_ == nullptr
        && this->organization_ == nullptr && this->organizationUnit_ == nullptr && this->parentIdentifier_ == nullptr && this->revokeDate_ == nullptr && this->sans_ == nullptr
        && this->serialNumber_ == nullptr && this->sha2_ == nullptr && this->signAlgorithm_ == nullptr && this->state_ == nullptr && this->status_ == nullptr
        && this->subjectDN_ == nullptr; };
      ...
      inline string getRevokeDate() const { DARABONBA_PTR_GET_DEFAULT(revokeDate_, "") };
      inline CertificateList& setRevokeDate(string revokeDate) { DARABONBA_PTR_SET_VALUE(revokeDate_, revokeDate) };
    ...
    inline const vector<ListRevokeCertificateResponseBody::CertificateList> & getCertificateList() const { DARABONBA_PTR_GET_CONST(certificateList_, vector<ListRevokeCertificateResponseBody::CertificateList>) };
    inline vector<ListRevokeCertificateResponseBody::CertificateList> getCertificateList() { DARABONBA_PTR_GET(certificateList_, vector<ListRevokeCertificateResponseBody::CertificateList>) };
    inline ListRevokeCertificateResponseBody& setCertificateList(const vector<ListRevokeCertificateResponseBody::CertificateList> & certificateList) { DARABONBA_PTR_SET_VALUE(certificateList_, certificateList) };
    inline ListRevokeCertificateResponseBody& setCertificateList(vector<ListRevokeCertificateResponseBody::CertificateList> && certificateList) { DARABONBA_PTR_SET_RVALUE(certificateList_, certificateList) };
    ...
    inline ListRevokeCertificateResponseBody& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline ListRevokeCertificateResponseBody& setPageCount(int32_t pageCount) { DARABONBA_PTR_SET_VALUE(pageCount_, pageCount) };
    ...
    inline ListRevokeCertificateResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListRevokeCertificateResponseBody& setShowSize(int32_t showSize) { DARABONBA_PTR_SET_VALUE(showSize_, showSize) };
    ...
    inline ListRevokeCertificateResponseBody& setTotalCount(int64_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
