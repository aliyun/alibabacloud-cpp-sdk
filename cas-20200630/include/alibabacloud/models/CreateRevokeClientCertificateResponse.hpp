...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRevokeClientCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRevokeClientCertificateResponseBody) };
    inline CreateRevokeClientCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRevokeClientCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRevokeClientCertificateResponseBody> body_ {};
  };
