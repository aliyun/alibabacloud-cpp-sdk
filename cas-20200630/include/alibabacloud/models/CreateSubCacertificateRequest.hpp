...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->algorithm_ != nullptr
        && this->commonName_ != nullptr && this->countryCode_ != nullptr && this->crlDay_ != nullptr && this->enableCrl_ != nullptr && this->extendedKeyUsages_ != nullptr
        && this->locality_ != nullptr && this->organization_ != nullptr && this->organizationUnit_ != nullptr && this->parentIdentifier_ != nullptr && this->pathLenConstraint_ != nullptr
        && this->state_ != nullptr && this->years_ != nullptr; };
