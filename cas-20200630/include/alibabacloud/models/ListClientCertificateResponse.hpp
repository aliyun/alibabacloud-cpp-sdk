...
namespace Models
{
  ...
  public:
    ...
    inline const ListClientCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListClientCertificateResponseBody) };
    inline ListClientCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, ListClientCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListClientCertificateResponseBody> body_ {};
  };
