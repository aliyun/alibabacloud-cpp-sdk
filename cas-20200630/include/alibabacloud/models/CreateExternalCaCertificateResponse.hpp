...
namespace Models
{
  ...
  public:
    ...
    inline const CreateExternalCACertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateExternalCACertificateResponseBody) };
    inline CreateExternalCACertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateExternalCACertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateExternalCACertificateResponseBody> body_ {};
  };
