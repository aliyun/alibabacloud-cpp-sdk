...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->afterTime_ == nullptr
        ...
        && return this->customIdentifier_ == nullptr && return this->days_ == nullptr && return this->enableCrl_ == nullptr && return this->immediately_ == nullptr && return this->locality_ == nullptr
        ...
        && return this->sanType_ == nullptr && return this->sanValue_ == nullptr && return this->state_ == nullptr && return this->tags_ == nullptr && return this->years_ == nullptr; };
    ...
    inline const vector<CreateClientCertificateWithCsrRequestTags> & tags() const { DARABONBA_PTR_GET_CONST(tags_, vector<CreateClientCertificateWithCsrRequestTags>) };
    inline vector<CreateClientCertificateWithCsrRequestTags> tags() { DARABONBA_PTR_GET(tags_, vector<CreateClientCertificateWithCsrRequestTags>) };
    inline CreateClientCertificateWithCsrRequest& setTags(const vector<CreateClientCertificateWithCsrRequestTags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline CreateClientCertificateWithCsrRequest& setTags(vector<CreateClientCertificateWithCsrRequestTags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    std::shared_ptr<vector<CreateClientCertificateWithCsrRequestTags>> tags_ = nullptr;
