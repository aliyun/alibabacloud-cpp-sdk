...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->afterTime_ == nullptr
        ...
        && this->customIdentifier_ == nullptr && this->days_ == nullptr && this->enableCrl_ == nullptr && this->immediately_ == nullptr && this->locality_ == nullptr
        ...
        && this->sanType_ == nullptr && this->sanValue_ == nullptr && this->state_ == nullptr && this->tags_ == nullptr && this->years_ == nullptr; };
