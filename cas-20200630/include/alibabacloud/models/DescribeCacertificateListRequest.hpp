...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->caStatus_ != nullptr
        && this->certType_ != nullptr && this->currentPage_ != nullptr && this->identifier_ != nullptr && this->issuerType_ != nullptr && this->showSize_ != nullptr
