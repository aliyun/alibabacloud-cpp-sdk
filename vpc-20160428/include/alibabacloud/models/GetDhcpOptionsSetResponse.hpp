...
namespace Models
{
  ...
  public:
    ...
    inline const GetDhcpOptionsSetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDhcpOptionsSetResponseBody) };
    inline GetDhcpOptionsSetResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDhcpOptionsSetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDhcpOptionsSetResponseBody> body_ {};
  };
