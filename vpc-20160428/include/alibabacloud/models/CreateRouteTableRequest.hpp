...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->associateType_ == nullptr
        && return this->clientToken_ == nullptr && return this->description_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr
        && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->routeTableName_ == nullptr && return this->tag_ == nullptr && return this->vpcId_ == nullptr; };
