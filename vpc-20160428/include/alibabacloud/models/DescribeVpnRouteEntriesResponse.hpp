...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVpnRouteEntriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVpnRouteEntriesResponseBody) };
    inline DescribeVpnRouteEntriesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVpnRouteEntriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVpnRouteEntriesResponseBody> body_ {};
  };
