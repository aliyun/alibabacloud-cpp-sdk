...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTrafficMirrorFilterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTrafficMirrorFilterResponseBody) };
    inline DeleteTrafficMirrorFilterResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTrafficMirrorFilterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTrafficMirrorFilterResponseBody> body_ {};
  };
