...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->bgpNetworks_ != nullptr
    ...
    inline const DescribeBgpNetworksResponseBodyBgpNetworks & bgpNetworks() const { DARABONBA_PTR_GET_CONST(bgpNetworks_, DescribeBgpNetworksResponseBodyBgpNetworks) };
    inline DescribeBgpNetworksResponseBodyBgpNetworks bgpNetworks() { DARABONBA_PTR_GET(bgpNetworks_, DescribeBgpNetworksResponseBodyBgpNetworks) };
    inline DescribeBgpNetworksResponseBody& setBgpNetworks(const DescribeBgpNetworksResponseBodyBgpNetworks & bgpNetworks) { DARABONBA_PTR_SET_VALUE(bgpNetworks_, bgpNetworks) };
    inline DescribeBgpNetworksResponseBody& setBgpNetworks(DescribeBgpNetworksResponseBodyBgpNetworks && bgpNetworks) { DARABONBA_PTR_SET_RVALUE(bgpNetworks_, bgpNetworks) };
  ...
  protected:
    // BGP networks.
    std::shared_ptr<DescribeBgpNetworksResponseBodyBgpNetworks> bgpNetworks_ = nullptr;
    // The page number.
