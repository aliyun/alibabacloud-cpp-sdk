...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVpcPrefixListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyVpcPrefixListResponseBody) };
    inline ModifyVpcPrefixListResponseBody body() { DARABONBA_PTR_GET(body_, ModifyVpcPrefixListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyVpcPrefixListResponseBody> body_ = nullptr;
  };
