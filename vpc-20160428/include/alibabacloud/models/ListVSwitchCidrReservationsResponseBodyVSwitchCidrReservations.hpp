...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->assignedCidrCount_ == nullptr
        && return this->availableCidrCount_ == nullptr && return this->creationTime_ == nullptr && return this->ipVersion_ == nullptr && return this->status_ == nullptr && return this->tags_ == nullptr
        && return this->type_ == nullptr && return this->vSwitchCidrReservationCidr_ == nullptr && return this->vSwitchCidrReservationDescription_ == nullptr && return this->vSwitchCidrReservationId_ == nullptr && return this->vSwitchCidrReservationName_ == nullptr
