...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getTrafficMirrorFilterRuleIds() const { DARABONBA_PTR_GET_CONST(trafficMirrorFilterRuleIds_, vector<string>) };
    inline vector<string> getTrafficMirrorFilterRuleIds() { DARABONBA_PTR_GET(trafficMirrorFilterRuleIds_, vector<string>) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<string>> trafficMirrorFilterRuleIds_ {};
  };
