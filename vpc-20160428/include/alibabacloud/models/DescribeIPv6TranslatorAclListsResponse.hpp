...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeIPv6TranslatorAclListsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeIPv6TranslatorAclListsResponseBody) };
    inline DescribeIPv6TranslatorAclListsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeIPv6TranslatorAclListsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeIPv6TranslatorAclListsResponseBody> body_ {};
  };
