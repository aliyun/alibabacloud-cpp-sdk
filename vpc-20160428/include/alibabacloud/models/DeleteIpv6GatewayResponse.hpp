...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteIpv6GatewayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteIpv6GatewayResponseBody) };
    inline DeleteIpv6GatewayResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteIpv6GatewayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteIpv6GatewayResponseBody> body_ {};
  };
