...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSnatTableEntriesResponseBodySnatTableEntries & snatTableEntries() const { DARABONBA_PTR_GET_CONST(snatTableEntries_, DescribeSnatTableEntriesResponseBodySnatTableEntries) };
    inline DescribeSnatTableEntriesResponseBodySnatTableEntries snatTableEntries() { DARABONBA_PTR_GET(snatTableEntries_, DescribeSnatTableEntriesResponseBodySnatTableEntries) };
    inline DescribeSnatTableEntriesResponseBody& setSnatTableEntries(const DescribeSnatTableEntriesResponseBodySnatTableEntries & snatTableEntries) { DARABONBA_PTR_SET_VALUE(snatTableEntries_, snatTableEntries) };
    inline DescribeSnatTableEntriesResponseBody& setSnatTableEntries(DescribeSnatTableEntriesResponseBodySnatTableEntries && snatTableEntries) { DARABONBA_PTR_SET_RVALUE(snatTableEntries_, snatTableEntries) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSnatTableEntriesResponseBodySnatTableEntries> snatTableEntries_ = nullptr;
