...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRouteEntriesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateRouteEntriesResponseBody) };
    inline CreateRouteEntriesResponseBody body() { DARABONBA_PTR_GET(body_, CreateRouteEntriesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateRouteEntriesResponseBody> body_ = nullptr;
  };
