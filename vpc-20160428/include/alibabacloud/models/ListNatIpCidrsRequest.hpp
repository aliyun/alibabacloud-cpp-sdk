...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->dryRun_ == nullptr && this->maxResults_ == nullptr && this->natGatewayId_ == nullptr && this->natIpCidr_ == nullptr && this->natIpCidrName_ == nullptr
        && this->natIpCidrStatus_ == nullptr && this->natIpCidrs_ == nullptr && this->nextToken_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr
    ...
    inline const vector<string> & getNatIpCidrName() const { DARABONBA_PTR_GET_CONST(natIpCidrName_, vector<string>) };
    inline vector<string> getNatIpCidrName() { DARABONBA_PTR_GET(natIpCidrName_, vector<string>) };
    ...
    inline const vector<string> & getNatIpCidrs() const { DARABONBA_PTR_GET_CONST(natIpCidrs_, vector<string>) };
    inline vector<string> getNatIpCidrs() { DARABONBA_PTR_GET(natIpCidrs_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> natIpCidrName_ {};
    ...
    shared_ptr<vector<string>> natIpCidrs_ {};
