...
namespace Models
{
  ...
  public:
    ...
    inline const DownloadVpnConnectionConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DownloadVpnConnectionConfigResponseBody) };
    inline DownloadVpnConnectionConfigResponseBody body() { DARABONBA_PTR_GET(body_, DownloadVpnConnectionConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DownloadVpnConnectionConfigResponseBody> body_ = nullptr;
  };
