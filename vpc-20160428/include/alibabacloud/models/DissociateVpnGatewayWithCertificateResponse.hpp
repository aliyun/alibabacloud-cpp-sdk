...
namespace Models
{
  ...
  public:
    ...
    inline const DissociateVpnGatewayWithCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DissociateVpnGatewayWithCertificateResponseBody) };
    inline DissociateVpnGatewayWithCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, DissociateVpnGatewayWithCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DissociateVpnGatewayWithCertificateResponseBody> body_ {};
  };
