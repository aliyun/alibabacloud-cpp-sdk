...
namespace Models
{
  ...
  public:
    ...
    inline const AddGlobalAccelerationInstanceIpResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddGlobalAccelerationInstanceIpResponseBody) };
    inline AddGlobalAccelerationInstanceIpResponseBody getBody() { DARABONBA_PTR_GET(body_, AddGlobalAccelerationInstanceIpResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddGlobalAccelerationInstanceIpResponseBody> body_ {};
  };
