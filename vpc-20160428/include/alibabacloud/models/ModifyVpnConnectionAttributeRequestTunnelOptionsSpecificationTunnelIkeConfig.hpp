...
#ifndef ALIBABACLOUD_MODELS_MODIFYVPNCONNECTIONATTRIBUTEREQUESTTUNNELOPTIONSSPECIFICATIONTUNNELIKECONFIG_HPP_
#define ALIBABACLOUD_MODELS_MODIFYVPNCONNECTIONATTRIBUTEREQUESTTUNNELOPTIONSSPECIFICATIONTUNNELIKECONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig& obj) { 
    ...
    ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig() = default ;
    ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig(const ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig &) = default ;
    ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig(ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig &&) = default ;
    ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig() = default ;
    ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig& operator=(const ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig &) = default ;
    ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig& operator=(ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig &&) = default ;
    ...
    inline ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig& setIkeAuthAlg(string ikeAuthAlg) { DARABONBA_PTR_SET_VALUE(ikeAuthAlg_, ikeAuthAlg) };
    ...
    inline ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig& setIkeEncAlg(string ikeEncAlg) { DARABONBA_PTR_SET_VALUE(ikeEncAlg_, ikeEncAlg) };
    ...
    inline ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig& setIkeLifetime(int64_t ikeLifetime) { DARABONBA_PTR_SET_VALUE(ikeLifetime_, ikeLifetime) };
    ...
    inline ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig& setIkeMode(string ikeMode) { DARABONBA_PTR_SET_VALUE(ikeMode_, ikeMode) };
    ...
    inline ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig& setIkePfs(string ikePfs) { DARABONBA_PTR_SET_VALUE(ikePfs_, ikePfs) };
    ...
    inline ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig& setIkeVersion(string ikeVersion) { DARABONBA_PTR_SET_VALUE(ikeVersion_, ikeVersion) };
    ...
    inline ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig& setLocalId(string localId) { DARABONBA_PTR_SET_VALUE(localId_, localId) };
    ...
    inline ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig& setPsk(string psk) { DARABONBA_PTR_SET_VALUE(psk_, psk) };
    ...
    inline ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig& setRemoteId(string remoteId) { DARABONBA_PTR_SET_VALUE(remoteId_, remoteId) };
