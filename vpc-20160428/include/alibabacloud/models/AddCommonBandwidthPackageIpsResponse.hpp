...
namespace Models
{
  ...
  public:
    ...
    inline const AddCommonBandwidthPackageIpsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddCommonBandwidthPackageIpsResponseBody) };
    inline AddCommonBandwidthPackageIpsResponseBody getBody() { DARABONBA_PTR_GET(body_, AddCommonBandwidthPackageIpsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddCommonBandwidthPackageIpsResponseBody> body_ {};
  };
