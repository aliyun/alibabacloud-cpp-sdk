...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getDhcpOptionsSetId() const { DARABONBA_PTR_GET_CONST(dhcpOptionsSetId_, vector<string>) };
    inline vector<string> getDhcpOptionsSetId() { DARABONBA_PTR_GET(dhcpOptionsSetId_, vector<string>) };
    ...
    inline const vector<ListDhcpOptionsSetsRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<ListDhcpOptionsSetsRequest::Tags>) };
    inline vector<ListDhcpOptionsSetsRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<ListDhcpOptionsSetsRequest::Tags>) };
    inline ListDhcpOptionsSetsRequest& setTags(const vector<ListDhcpOptionsSetsRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline ListDhcpOptionsSetsRequest& setTags(vector<ListDhcpOptionsSetsRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
