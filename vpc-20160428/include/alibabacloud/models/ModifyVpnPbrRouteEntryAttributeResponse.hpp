...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVpnPbrRouteEntryAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyVpnPbrRouteEntryAttributeResponseBody) };
    inline ModifyVpnPbrRouteEntryAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyVpnPbrRouteEntryAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyVpnPbrRouteEntryAttributeResponseBody> body_ {};
  };
