...
namespace Models
{
  ...
  public:
    ...
    inline const UnassociateHaVipResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnassociateHaVipResponseBody) };
    inline UnassociateHaVipResponseBody getBody() { DARABONBA_PTR_GET(body_, UnassociateHaVipResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnassociateHaVipResponseBody> body_ {};
  };
