...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ipVersion_ == nullptr
        ...
        && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->tags_ == nullptr && return this->vSwitchCidrReservationIds_ == nullptr && return this->vSwitchCidrReservationType_ == nullptr
