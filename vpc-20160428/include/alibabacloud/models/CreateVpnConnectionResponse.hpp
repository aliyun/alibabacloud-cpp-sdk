...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVpnConnectionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateVpnConnectionResponseBody) };
    inline CreateVpnConnectionResponseBody body() { DARABONBA_PTR_GET(body_, CreateVpnConnectionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateVpnConnectionResponseBody> body_ = nullptr;
  };
