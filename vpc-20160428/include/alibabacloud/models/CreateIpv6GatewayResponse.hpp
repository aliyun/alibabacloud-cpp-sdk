...
namespace Models
{
  ...
  public:
    ...
    inline const CreateIpv6GatewayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateIpv6GatewayResponseBody) };
    inline CreateIpv6GatewayResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateIpv6GatewayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateIpv6GatewayResponseBody> body_ {};
  };
