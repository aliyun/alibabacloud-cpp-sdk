...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addressType_ == nullptr
        && this->associatedInstanceId_ == nullptr && this->associatedInstanceType_ == nullptr && this->includeReservationData_ == nullptr && this->ipv6Address_ == nullptr && this->ipv6AddressId_ == nullptr
        && this->ipv6InternetBandwidthId_ == nullptr && this->name_ == nullptr && this->networkType_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr
        ...
        && this->resourceOwnerId_ == nullptr && this->serviceManaged_ == nullptr && this->tag_ == nullptr && this->vSwitchId_ == nullptr && this->vpcId_ == nullptr; };
    ...
    inline const vector<DescribeIpv6AddressesRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<DescribeIpv6AddressesRequest::Tag>) };
    inline vector<DescribeIpv6AddressesRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<DescribeIpv6AddressesRequest::Tag>) };
    inline DescribeIpv6AddressesRequest& setTag(const vector<DescribeIpv6AddressesRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline DescribeIpv6AddressesRequest& setTag(vector<DescribeIpv6AddressesRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
