...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySslVpnServerResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifySslVpnServerResponseBody) };
    inline ModifySslVpnServerResponseBody body() { DARABONBA_PTR_GET(body_, ModifySslVpnServerResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifySslVpnServerResponseBody> body_ = nullptr;
  };
