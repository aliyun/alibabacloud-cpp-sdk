...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->authKey_ == nullptr
        && return this->clientToken_ == nullptr && return this->customerGatewayId_ == nullptr && return this->description_ == nullptr && return this->name_ == nullptr && return this->ownerAccount_ == nullptr
