...
namespace Models
{
  ...
  public:
    ...
    inline const UnassociateVpcCidrBlockResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnassociateVpcCidrBlockResponseBody) };
    inline UnassociateVpcCidrBlockResponseBody getBody() { DARABONBA_PTR_GET(body_, UnassociateVpcCidrBlockResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnassociateVpcCidrBlockResponseBody> body_ {};
  };
