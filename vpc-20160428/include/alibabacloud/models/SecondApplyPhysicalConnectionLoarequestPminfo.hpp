...
#ifndef ALIBABACLOUD_MODELS_SECONDAPPLYPHYSICALCONNECTIONLOAREQUESTPMINFO_HPP_
#define ALIBABACLOUD_MODELS_SECONDAPPLYPHYSICALCONNECTIONLOAREQUESTPMINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SecondApplyPhysicalConnectionLOARequestPMInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SecondApplyPhysicalConnectionLOARequestPMInfo& obj) { 
    ...
    SecondApplyPhysicalConnectionLOARequestPMInfo() = default ;
    SecondApplyPhysicalConnectionLOARequestPMInfo(const SecondApplyPhysicalConnectionLOARequestPMInfo &) = default ;
    SecondApplyPhysicalConnectionLOARequestPMInfo(SecondApplyPhysicalConnectionLOARequestPMInfo &&) = default ;
    SecondApplyPhysicalConnectionLOARequestPMInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SecondApplyPhysicalConnectionLOARequestPMInfo() = default ;
    SecondApplyPhysicalConnectionLOARequestPMInfo& operator=(const SecondApplyPhysicalConnectionLOARequestPMInfo &) = default ;
    SecondApplyPhysicalConnectionLOARequestPMInfo& operator=(SecondApplyPhysicalConnectionLOARequestPMInfo &&) = default ;
    ...
    inline SecondApplyPhysicalConnectionLOARequestPMInfo& setPMCertificateNo(string PMCertificateNo) { DARABONBA_PTR_SET_VALUE(PMCertificateNo_, PMCertificateNo) };
    ...
    inline SecondApplyPhysicalConnectionLOARequestPMInfo& setPMCertificateType(string PMCertificateType) { DARABONBA_PTR_SET_VALUE(PMCertificateType_, PMCertificateType) };
    ...
    inline SecondApplyPhysicalConnectionLOARequestPMInfo& setPMContactInfo(string PMContactInfo) { DARABONBA_PTR_SET_VALUE(PMContactInfo_, PMContactInfo) };
    ...
    inline SecondApplyPhysicalConnectionLOARequestPMInfo& setPMGender(string PMGender) { DARABONBA_PTR_SET_VALUE(PMGender_, PMGender) };
    ...
    inline SecondApplyPhysicalConnectionLOARequestPMInfo& setPMName(string PMName) { DARABONBA_PTR_SET_VALUE(PMName_, PMName) };
