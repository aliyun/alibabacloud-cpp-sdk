...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVpnRouteEntryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVpnRouteEntryResponseBody) };
    inline CreateVpnRouteEntryResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVpnRouteEntryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVpnRouteEntryResponseBody> body_ {};
  };
