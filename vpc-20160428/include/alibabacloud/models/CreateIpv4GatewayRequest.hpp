...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->dryRun_ == nullptr && this->ipv4GatewayDescription_ == nullptr && this->ipv4GatewayName_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr
    ...
    inline const vector<CreateIpv4GatewayRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateIpv4GatewayRequest::Tag>) };
    inline vector<CreateIpv4GatewayRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateIpv4GatewayRequest::Tag>) };
    inline CreateIpv4GatewayRequest& setTag(const vector<CreateIpv4GatewayRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateIpv4GatewayRequest& setTag(vector<CreateIpv4GatewayRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    shared_ptr<vector<CreateIpv4GatewayRequest::Tag>> tag_ {};
