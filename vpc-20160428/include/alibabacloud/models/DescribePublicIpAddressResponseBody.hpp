...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getPublicIpAddress() const { DARABONBA_PTR_GET_CONST(publicIpAddress_, vector<string>) };
    inline vector<string> getPublicIpAddress() { DARABONBA_PTR_GET(publicIpAddress_, vector<string>) };
