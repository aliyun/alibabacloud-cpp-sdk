...
#ifndef ALIBABACLOUD_MODELS_CREATETRAFFICMIRRORFILTERREQUESTEGRESSRULES_HPP_
#define ALIBABACLOUD_MODELS_CREATETRAFFICMIRRORFILTERREQUESTEGRESSRULES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateTrafficMirrorFilterRequestEgressRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateTrafficMirrorFilterRequestEgressRules& obj) { 
    ...
    CreateTrafficMirrorFilterRequestEgressRules() = default ;
    CreateTrafficMirrorFilterRequestEgressRules(const CreateTrafficMirrorFilterRequestEgressRules &) = default ;
    CreateTrafficMirrorFilterRequestEgressRules(CreateTrafficMirrorFilterRequestEgressRules &&) = default ;
    CreateTrafficMirrorFilterRequestEgressRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTrafficMirrorFilterRequestEgressRules() = default ;
    CreateTrafficMirrorFilterRequestEgressRules& operator=(const CreateTrafficMirrorFilterRequestEgressRules &) = default ;
    CreateTrafficMirrorFilterRequestEgressRules& operator=(CreateTrafficMirrorFilterRequestEgressRules &&) = default ;
    ...
    inline CreateTrafficMirrorFilterRequestEgressRules& setAction(string action) { DARABONBA_PTR_SET_VALUE(action_, action) };
    ...
    inline CreateTrafficMirrorFilterRequestEgressRules& setDestinationCidrBlock(string destinationCidrBlock) { DARABONBA_PTR_SET_VALUE(destinationCidrBlock_, destinationCidrBlock) };
    ...
    inline CreateTrafficMirrorFilterRequestEgressRules& setDestinationPortRange(string destinationPortRange) { DARABONBA_PTR_SET_VALUE(destinationPortRange_, destinationPortRange) };
    ...
    inline CreateTrafficMirrorFilterRequestEgressRules& setIpVersion(string ipVersion) { DARABONBA_PTR_SET_VALUE(ipVersion_, ipVersion) };
    ...
    inline CreateTrafficMirrorFilterRequestEgressRules& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline CreateTrafficMirrorFilterRequestEgressRules& setProtocol(string protocol) { DARABONBA_PTR_SET_VALUE(protocol_, protocol) };
    ...
    inline CreateTrafficMirrorFilterRequestEgressRules& setSourceCidrBlock(string sourceCidrBlock) { DARABONBA_PTR_SET_VALUE(sourceCidrBlock_, sourceCidrBlock) };
    ...
    inline CreateTrafficMirrorFilterRequestEgressRules& setSourcePortRange(string sourcePortRange) { DARABONBA_PTR_SET_VALUE(sourcePortRange_, sourcePortRange) };
