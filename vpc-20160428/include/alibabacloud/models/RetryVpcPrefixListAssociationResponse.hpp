...
namespace Models
{
  ...
  public:
    ...
    inline const RetryVpcPrefixListAssociationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RetryVpcPrefixListAssociationResponseBody) };
    inline RetryVpcPrefixListAssociationResponseBody getBody() { DARABONBA_PTR_GET(body_, RetryVpcPrefixListAssociationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RetryVpcPrefixListAssociationResponseBody> body_ {};
  };
