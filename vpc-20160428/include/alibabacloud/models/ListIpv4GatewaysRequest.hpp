...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ipv4GatewayId_ == nullptr
        && return this->ipv4GatewayName_ == nullptr && return this->maxResults_ == nullptr && return this->nextToken_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr
