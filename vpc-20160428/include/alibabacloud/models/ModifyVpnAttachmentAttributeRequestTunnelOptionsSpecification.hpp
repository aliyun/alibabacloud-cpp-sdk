...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->customerGatewayId_ == nullptr
        && return this->enableDpd_ == nullptr && return this->enableNatTraversal_ == nullptr && return this->tunnelBgpConfig_ == nullptr && return this->tunnelId_ == nullptr && return this->tunnelIkeConfig_ == nullptr
        && return this->tunnelIndex_ == nullptr && return this->tunnelIpsecConfig_ == nullptr; };
