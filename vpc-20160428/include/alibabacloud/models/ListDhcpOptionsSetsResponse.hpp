...
namespace Models
{
  ...
  public:
    ...
    inline const ListDhcpOptionsSetsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDhcpOptionsSetsResponseBody) };
    inline ListDhcpOptionsSetsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDhcpOptionsSetsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDhcpOptionsSetsResponseBody> body_ {};
  };
