...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVcoRouteEntriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVcoRouteEntriesResponseBody) };
    inline DescribeVcoRouteEntriesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVcoRouteEntriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVcoRouteEntriesResponseBody> body_ {};
  };
