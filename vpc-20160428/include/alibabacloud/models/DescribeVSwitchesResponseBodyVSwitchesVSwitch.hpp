...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->availableIpAddressCount_ == nullptr
        ...
        && return this->isDefault_ == nullptr && return this->networkAclId_ == nullptr && return this->ownerId_ == nullptr && return this->resourceGroupId_ == nullptr && return this->routeTable_ == nullptr
        && return this->shareType_ == nullptr && return this->status_ == nullptr && return this->tags_ == nullptr && return this->vSwitchId_ == nullptr && return this->vSwitchName_ == nullptr
