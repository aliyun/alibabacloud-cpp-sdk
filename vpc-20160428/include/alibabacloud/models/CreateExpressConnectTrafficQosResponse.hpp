...
namespace Models
{
  ...
  public:
    ...
    inline const CreateExpressConnectTrafficQosResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateExpressConnectTrafficQosResponseBody) };
    inline CreateExpressConnectTrafficQosResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateExpressConnectTrafficQosResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateExpressConnectTrafficQosResponseBody> body_ {};
  };
