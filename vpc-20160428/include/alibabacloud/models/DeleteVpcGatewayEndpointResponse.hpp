...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVpcGatewayEndpointResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteVpcGatewayEndpointResponseBody) };
    inline DeleteVpcGatewayEndpointResponseBody body() { DARABONBA_PTR_GET(body_, DeleteVpcGatewayEndpointResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteVpcGatewayEndpointResponseBody> body_ = nullptr;
  };
