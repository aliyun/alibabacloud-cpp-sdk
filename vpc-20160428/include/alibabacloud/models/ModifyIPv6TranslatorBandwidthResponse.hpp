...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyIPv6TranslatorBandwidthResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyIPv6TranslatorBandwidthResponseBody) };
    inline ModifyIPv6TranslatorBandwidthResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyIPv6TranslatorBandwidthResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyIPv6TranslatorBandwidthResponseBody> body_ {};
  };
