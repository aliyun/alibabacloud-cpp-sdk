...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessPointId_ == nullptr
        && return this->bandwidth_ == nullptr && return this->businessStatus_ == nullptr && return this->chargeType_ == nullptr && return this->connectedTime_ == nullptr && return this->creationTime_ == nullptr
        && return this->crossBorder_ == nullptr && return this->description_ == nullptr && return this->endTime_ == nullptr && return this->fastLinkMode_ == nullptr && return this->hasReservationData_ == nullptr
        && return this->hcRate_ == nullptr && return this->hcThreshold_ == nullptr && return this->healthCheckSourceIp_ == nullptr && return this->healthCheckTargetIp_ == nullptr && return this->ipv6Status_ == nullptr
        && return this->name_ == nullptr && return this->oppositeAccessPointId_ == nullptr && return this->oppositeBandwidth_ == nullptr && return this->oppositeInterfaceBusinessStatus_ == nullptr && return this->oppositeInterfaceId_ == nullptr
        && return this->oppositeInterfaceOwnerId_ == nullptr && return this->oppositeInterfaceSpec_ == nullptr && return this->oppositeInterfaceStatus_ == nullptr && return this->oppositeRegionId_ == nullptr && return this->oppositeRouterId_ == nullptr
        && return this->oppositeRouterType_ == nullptr && return this->oppositeVpcInstanceId_ == nullptr && return this->reservationActiveTime_ == nullptr && return this->reservationBandwidth_ == nullptr && return this->reservationInternetChargeType_ == nullptr
        && return this->reservationOrderType_ == nullptr && return this->resourceGroupId_ == nullptr && return this->role_ == nullptr && return this->routerId_ == nullptr && return this->routerInterfaceId_ == nullptr
        && return this->routerType_ == nullptr && return this->spec_ == nullptr && return this->status_ == nullptr && return this->tags_ == nullptr && return this->vpcInstanceId_ == nullptr; };
