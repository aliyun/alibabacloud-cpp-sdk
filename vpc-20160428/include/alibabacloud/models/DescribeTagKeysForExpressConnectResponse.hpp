...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTagKeysForExpressConnectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTagKeysForExpressConnectResponseBody) };
    inline DescribeTagKeysForExpressConnectResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTagKeysForExpressConnectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTagKeysForExpressConnectResponseBody> body_ {};
  };
