...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVpnRouteEntryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteVpnRouteEntryResponseBody) };
    inline DeleteVpnRouteEntryResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteVpnRouteEntryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteVpnRouteEntryResponseBody> body_ {};
  };
