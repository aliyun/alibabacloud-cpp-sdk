...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cipher_ == nullptr
        ...
        && this->IDaaSApplicationId_ == nullptr && this->IDaaSInstanceId_ == nullptr && this->IDaaSInstanceVersion_ == nullptr && this->internetIp_ == nullptr && this->localSubnet_ == nullptr
        && this->maxConnections_ == nullptr && this->name_ == nullptr && this->port_ == nullptr && this->proto_ == nullptr && this->regionId_ == nullptr
        && this->requestId_ == nullptr && this->resourceGroupId_ == nullptr && this->sslVpnServerId_ == nullptr && this->vpnGatewayId_ == nullptr; };
