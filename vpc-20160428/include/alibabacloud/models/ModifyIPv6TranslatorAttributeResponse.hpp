...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyIPv6TranslatorAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyIPv6TranslatorAttributeResponseBody) };
    inline ModifyIPv6TranslatorAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyIPv6TranslatorAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyIPv6TranslatorAttributeResponseBody> body_ {};
  };
