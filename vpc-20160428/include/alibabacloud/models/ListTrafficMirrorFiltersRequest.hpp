...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListTrafficMirrorFiltersRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<ListTrafficMirrorFiltersRequest::Tags>) };
    inline vector<ListTrafficMirrorFiltersRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<ListTrafficMirrorFiltersRequest::Tags>) };
    inline ListTrafficMirrorFiltersRequest& setTags(const vector<ListTrafficMirrorFiltersRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline ListTrafficMirrorFiltersRequest& setTags(vector<ListTrafficMirrorFiltersRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
    ...
    inline const vector<string> & getTrafficMirrorFilterIds() const { DARABONBA_PTR_GET_CONST(trafficMirrorFilterIds_, vector<string>) };
    inline vector<string> getTrafficMirrorFilterIds() { DARABONBA_PTR_GET(trafficMirrorFilterIds_, vector<string>) };
