...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allocationId_ == nullptr
        && return this->clientToken_ == nullptr && return this->instanceId_ == nullptr && return this->instanceRegionId_ == nullptr && return this->instanceType_ == nullptr && return this->mode_ == nullptr
        && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->privateIpAddress_ == nullptr && return this->regionId_ == nullptr && return this->resourceOwnerAccount_ == nullptr
