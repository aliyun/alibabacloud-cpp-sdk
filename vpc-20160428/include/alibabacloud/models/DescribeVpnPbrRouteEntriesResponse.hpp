...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVpnPbrRouteEntriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVpnPbrRouteEntriesResponseBody) };
    inline DescribeVpnPbrRouteEntriesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVpnPbrRouteEntriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVpnPbrRouteEntriesResponseBody> body_ {};
  };
