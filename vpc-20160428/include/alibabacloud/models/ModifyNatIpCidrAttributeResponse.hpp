...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyNatIpCidrAttributeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyNatIpCidrAttributeResponseBody) };
    inline ModifyNatIpCidrAttributeResponseBody body() { DARABONBA_PTR_GET(body_, ModifyNatIpCidrAttributeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyNatIpCidrAttributeResponseBody> body_ = nullptr;
  };
