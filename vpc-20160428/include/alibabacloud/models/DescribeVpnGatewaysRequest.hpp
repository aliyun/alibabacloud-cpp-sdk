...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeVpnGatewaysRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<DescribeVpnGatewaysRequest::Tag>) };
    inline vector<DescribeVpnGatewaysRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<DescribeVpnGatewaysRequest::Tag>) };
    inline DescribeVpnGatewaysRequest& setTag(const vector<DescribeVpnGatewaysRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline DescribeVpnGatewaysRequest& setTag(vector<DescribeVpnGatewaysRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
