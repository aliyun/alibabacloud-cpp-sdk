...
namespace Models
{
  ...
  public:
    ...
    inline const ListVirtualPhysicalConnectionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListVirtualPhysicalConnectionsResponseBody) };
    inline ListVirtualPhysicalConnectionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListVirtualPhysicalConnectionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListVirtualPhysicalConnectionsResponseBody> body_ {};
  };
