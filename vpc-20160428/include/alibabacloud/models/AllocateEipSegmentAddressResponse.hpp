...
namespace Models
{
  ...
  public:
    ...
    inline const AllocateEipSegmentAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AllocateEipSegmentAddressResponseBody) };
    inline AllocateEipSegmentAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, AllocateEipSegmentAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AllocateEipSegmentAddressResponseBody> body_ {};
  };
