...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeFailoverTestJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeFailoverTestJobResponseBody) };
    inline DescribeFailoverTestJobResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeFailoverTestJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeFailoverTestJobResponseBody> body_ {};
  };
