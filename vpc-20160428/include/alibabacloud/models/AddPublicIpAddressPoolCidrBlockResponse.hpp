...
namespace Models
{
  ...
  public:
    ...
    inline const AddPublicIpAddressPoolCidrBlockResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddPublicIpAddressPoolCidrBlockResponseBody) };
    inline AddPublicIpAddressPoolCidrBlockResponseBody getBody() { DARABONBA_PTR_GET(body_, AddPublicIpAddressPoolCidrBlockResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddPublicIpAddressPoolCidrBlockResponseBody> body_ {};
  };
