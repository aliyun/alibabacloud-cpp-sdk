...
#ifndef ALIBABACLOUD_MODELS_MODIFYVPNATTACHMENTATTRIBUTERESPONSEBODYVPNBGPCONFIG_HPP_
#define ALIBABACLOUD_MODELS_MODIFYVPNATTACHMENTATTRIBUTERESPONSEBODYVPNBGPCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig& obj) { 
    ...
    ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig() = default ;
    ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig(const ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig &) = default ;
    ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig(ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig &&) = default ;
    ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig() = default ;
    ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig& operator=(const ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig &) = default ;
    ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig& operator=(ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig &&) = default ;
    ...
    inline ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig& setEnableBgp(string enableBgp) { DARABONBA_PTR_SET_VALUE(enableBgp_, enableBgp) };
    ...
    inline ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig& setLocalAsn(int64_t localAsn) { DARABONBA_PTR_SET_VALUE(localAsn_, localAsn) };
    ...
    inline ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig& setLocalBgpIp(string localBgpIp) { DARABONBA_PTR_SET_VALUE(localBgpIp_, localBgpIp) };
    ...
    inline ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig& setPeerAsn(int64_t peerAsn) { DARABONBA_PTR_SET_VALUE(peerAsn_, peerAsn) };
    ...
    inline ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig& setPeerBgpIp(string peerBgpIp) { DARABONBA_PTR_SET_VALUE(peerBgpIp_, peerBgpIp) };
    ...
    inline ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ModifyVpnAttachmentAttributeResponseBodyVpnBgpConfig& setTunnelCidr(string tunnelCidr) { DARABONBA_PTR_SET_VALUE(tunnelCidr_, tunnelCidr) };
