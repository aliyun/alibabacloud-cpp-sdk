...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyNatGatewaySpecResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyNatGatewaySpecResponseBody) };
    inline ModifyNatGatewaySpecResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyNatGatewaySpecResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyNatGatewaySpecResponseBody> body_ {};
  };
