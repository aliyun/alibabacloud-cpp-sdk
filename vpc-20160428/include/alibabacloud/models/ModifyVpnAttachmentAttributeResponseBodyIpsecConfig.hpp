...
#ifndef ALIBABACLOUD_MODELS_MODIFYVPNATTACHMENTATTRIBUTERESPONSEBODYIPSECCONFIG_HPP_
#define ALIBABACLOUD_MODELS_MODIFYVPNATTACHMENTATTRIBUTERESPONSEBODYIPSECCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyVpnAttachmentAttributeResponseBodyIpsecConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyVpnAttachmentAttributeResponseBodyIpsecConfig& obj) { 
    ...
    ModifyVpnAttachmentAttributeResponseBodyIpsecConfig() = default ;
    ModifyVpnAttachmentAttributeResponseBodyIpsecConfig(const ModifyVpnAttachmentAttributeResponseBodyIpsecConfig &) = default ;
    ModifyVpnAttachmentAttributeResponseBodyIpsecConfig(ModifyVpnAttachmentAttributeResponseBodyIpsecConfig &&) = default ;
    ModifyVpnAttachmentAttributeResponseBodyIpsecConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyVpnAttachmentAttributeResponseBodyIpsecConfig() = default ;
    ModifyVpnAttachmentAttributeResponseBodyIpsecConfig& operator=(const ModifyVpnAttachmentAttributeResponseBodyIpsecConfig &) = default ;
    ModifyVpnAttachmentAttributeResponseBodyIpsecConfig& operator=(ModifyVpnAttachmentAttributeResponseBodyIpsecConfig &&) = default ;
    ...
    inline ModifyVpnAttachmentAttributeResponseBodyIpsecConfig& setIpsecAuthAlg(string ipsecAuthAlg) { DARABONBA_PTR_SET_VALUE(ipsecAuthAlg_, ipsecAuthAlg) };
    ...
    inline ModifyVpnAttachmentAttributeResponseBodyIpsecConfig& setIpsecEncAlg(string ipsecEncAlg) { DARABONBA_PTR_SET_VALUE(ipsecEncAlg_, ipsecEncAlg) };
    ...
    inline ModifyVpnAttachmentAttributeResponseBodyIpsecConfig& setIpsecLifetime(int64_t ipsecLifetime) { DARABONBA_PTR_SET_VALUE(ipsecLifetime_, ipsecLifetime) };
    ...
    inline ModifyVpnAttachmentAttributeResponseBodyIpsecConfig& setIpsecPfs(string ipsecPfs) { DARABONBA_PTR_SET_VALUE(ipsecPfs_, ipsecPfs) };
