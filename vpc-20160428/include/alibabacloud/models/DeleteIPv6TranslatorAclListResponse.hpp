...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteIPv6TranslatorAclListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteIPv6TranslatorAclListResponseBody) };
    inline DeleteIPv6TranslatorAclListResponseBody body() { DARABONBA_PTR_GET(body_, DeleteIPv6TranslatorAclListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteIPv6TranslatorAclListResponseBody> body_ = nullptr;
  };
