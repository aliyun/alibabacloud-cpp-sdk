...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCustomerGatewaysResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeCustomerGatewaysResponseBody) };
    inline DescribeCustomerGatewaysResponseBody body() { DARABONBA_PTR_GET(body_, DescribeCustomerGatewaysResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCustomerGatewaysResponseBody> body_ = nullptr;
  };
