...
#ifndef ALIBABACLOUD_MODELS_MODIFYVPNCONNECTIONATTRIBUTERESPONSEBODYIKECONFIG_HPP_
#define ALIBABACLOUD_MODELS_MODIFYVPNCONNECTIONATTRIBUTERESPONSEBODYIKECONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyVpnConnectionAttributeResponseBodyIkeConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyVpnConnectionAttributeResponseBodyIkeConfig& obj) { 
    ...
    ModifyVpnConnectionAttributeResponseBodyIkeConfig() = default ;
    ModifyVpnConnectionAttributeResponseBodyIkeConfig(const ModifyVpnConnectionAttributeResponseBodyIkeConfig &) = default ;
    ModifyVpnConnectionAttributeResponseBodyIkeConfig(ModifyVpnConnectionAttributeResponseBodyIkeConfig &&) = default ;
    ModifyVpnConnectionAttributeResponseBodyIkeConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyVpnConnectionAttributeResponseBodyIkeConfig() = default ;
    ModifyVpnConnectionAttributeResponseBodyIkeConfig& operator=(const ModifyVpnConnectionAttributeResponseBodyIkeConfig &) = default ;
    ModifyVpnConnectionAttributeResponseBodyIkeConfig& operator=(ModifyVpnConnectionAttributeResponseBodyIkeConfig &&) = default ;
    ...
    inline ModifyVpnConnectionAttributeResponseBodyIkeConfig& setIkeAuthAlg(string ikeAuthAlg) { DARABONBA_PTR_SET_VALUE(ikeAuthAlg_, ikeAuthAlg) };
    ...
    inline ModifyVpnConnectionAttributeResponseBodyIkeConfig& setIkeEncAlg(string ikeEncAlg) { DARABONBA_PTR_SET_VALUE(ikeEncAlg_, ikeEncAlg) };
    ...
    inline ModifyVpnConnectionAttributeResponseBodyIkeConfig& setIkeLifetime(int64_t ikeLifetime) { DARABONBA_PTR_SET_VALUE(ikeLifetime_, ikeLifetime) };
    ...
    inline ModifyVpnConnectionAttributeResponseBodyIkeConfig& setIkeMode(string ikeMode) { DARABONBA_PTR_SET_VALUE(ikeMode_, ikeMode) };
    ...
    inline ModifyVpnConnectionAttributeResponseBodyIkeConfig& setIkePfs(string ikePfs) { DARABONBA_PTR_SET_VALUE(ikePfs_, ikePfs) };
    ...
    inline ModifyVpnConnectionAttributeResponseBodyIkeConfig& setIkeVersion(string ikeVersion) { DARABONBA_PTR_SET_VALUE(ikeVersion_, ikeVersion) };
    ...
    inline ModifyVpnConnectionAttributeResponseBodyIkeConfig& setLocalId(string localId) { DARABONBA_PTR_SET_VALUE(localId_, localId) };
    ...
    inline ModifyVpnConnectionAttributeResponseBodyIkeConfig& setPsk(string psk) { DARABONBA_PTR_SET_VALUE(psk_, psk) };
    ...
    inline ModifyVpnConnectionAttributeResponseBodyIkeConfig& setRemoteId(string remoteId) { DARABONBA_PTR_SET_VALUE(remoteId_, remoteId) };
