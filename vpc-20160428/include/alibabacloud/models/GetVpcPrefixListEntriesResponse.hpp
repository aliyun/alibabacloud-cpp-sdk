...
namespace Models
{
  ...
  public:
    ...
    inline const GetVpcPrefixListEntriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetVpcPrefixListEntriesResponseBody) };
    inline GetVpcPrefixListEntriesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetVpcPrefixListEntriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetVpcPrefixListEntriesResponseBody> body_ {};
  };
