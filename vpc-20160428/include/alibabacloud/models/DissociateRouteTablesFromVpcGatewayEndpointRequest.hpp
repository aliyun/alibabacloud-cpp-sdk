...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && return this->dryRun_ == nullptr && return this->endpointId_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr
        && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->routeTableIds_ == nullptr; };
    ...
    inline const vector<string> & routeTableIds() const { DARABONBA_PTR_GET_CONST(routeTableIds_, vector<string>) };
    inline vector<string> routeTableIds() { DARABONBA_PTR_GET(routeTableIds_, vector<string>) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<vector<string>> routeTableIds_ = nullptr;
  };
