...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewayRouteTableEntriesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListGatewayRouteTableEntriesResponseBody) };
    inline ListGatewayRouteTableEntriesResponseBody body() { DARABONBA_PTR_GET(body_, ListGatewayRouteTableEntriesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListGatewayRouteTableEntriesResponseBody> body_ = nullptr;
  };
