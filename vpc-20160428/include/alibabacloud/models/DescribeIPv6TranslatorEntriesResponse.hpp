...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeIPv6TranslatorEntriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeIPv6TranslatorEntriesResponseBody) };
    inline DescribeIPv6TranslatorEntriesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeIPv6TranslatorEntriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeIPv6TranslatorEntriesResponseBody> body_ {};
  };
