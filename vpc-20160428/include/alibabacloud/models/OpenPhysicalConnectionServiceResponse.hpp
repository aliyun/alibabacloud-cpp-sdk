...
namespace Models
{
  ...
  public:
    ...
    inline const OpenPhysicalConnectionServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenPhysicalConnectionServiceResponseBody) };
    inline OpenPhysicalConnectionServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenPhysicalConnectionServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenPhysicalConnectionServiceResponseBody> body_ {};
  };
