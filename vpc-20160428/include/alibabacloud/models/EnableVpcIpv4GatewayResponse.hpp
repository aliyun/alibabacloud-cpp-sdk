...
namespace Models
{
  ...
  public:
    ...
    inline const EnableVpcIpv4GatewayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableVpcIpv4GatewayResponseBody) };
    inline EnableVpcIpv4GatewayResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableVpcIpv4GatewayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableVpcIpv4GatewayResponseBody> body_ {};
  };
