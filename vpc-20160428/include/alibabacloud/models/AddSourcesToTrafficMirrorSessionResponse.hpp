...
namespace Models
{
  ...
  public:
    ...
    inline const AddSourcesToTrafficMirrorSessionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddSourcesToTrafficMirrorSessionResponseBody) };
    inline AddSourcesToTrafficMirrorSessionResponseBody getBody() { DARABONBA_PTR_GET(body_, AddSourcesToTrafficMirrorSessionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddSourcesToTrafficMirrorSessionResponseBody> body_ {};
  };
