...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSslVpnServersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSslVpnServersResponseBody) };
    inline DescribeSslVpnServersResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSslVpnServersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSslVpnServersResponseBody> body_ {};
  };
