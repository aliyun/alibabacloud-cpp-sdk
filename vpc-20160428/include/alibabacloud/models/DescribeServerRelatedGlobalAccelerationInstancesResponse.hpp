...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeServerRelatedGlobalAccelerationInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeServerRelatedGlobalAccelerationInstancesResponseBody) };
    inline DescribeServerRelatedGlobalAccelerationInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeServerRelatedGlobalAccelerationInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeServerRelatedGlobalAccelerationInstancesResponseBody> body_ {};
  };
