...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteIpv6EgressOnlyRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteIpv6EgressOnlyRuleResponseBody) };
    inline DeleteIpv6EgressOnlyRuleResponseBody body() { DARABONBA_PTR_GET(body_, DeleteIpv6EgressOnlyRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteIpv6EgressOnlyRuleResponseBody> body_ = nullptr;
  };
