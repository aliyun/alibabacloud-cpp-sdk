...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteIPv6TranslatorEntryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteIPv6TranslatorEntryResponseBody) };
    inline DeleteIPv6TranslatorEntryResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteIPv6TranslatorEntryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteIPv6TranslatorEntryResponseBody> body_ {};
  };
