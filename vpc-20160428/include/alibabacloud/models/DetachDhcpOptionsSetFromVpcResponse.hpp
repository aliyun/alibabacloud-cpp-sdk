...
namespace Models
{
  ...
  public:
    ...
    inline const DetachDhcpOptionsSetFromVpcResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachDhcpOptionsSetFromVpcResponseBody) };
    inline DetachDhcpOptionsSetFromVpcResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachDhcpOptionsSetFromVpcResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachDhcpOptionsSetFromVpcResponseBody> body_ {};
  };
