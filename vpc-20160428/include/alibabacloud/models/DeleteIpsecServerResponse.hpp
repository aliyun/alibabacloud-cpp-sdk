...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteIpsecServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteIpsecServerResponseBody) };
    inline DeleteIpsecServerResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteIpsecServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteIpsecServerResponseBody> body_ {};
  };
