...
namespace Models
{
  ...
  public:
    ...
    inline const GetVpcPrefixListAssociationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetVpcPrefixListAssociationsResponseBody) };
    inline GetVpcPrefixListAssociationsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetVpcPrefixListAssociationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetVpcPrefixListAssociationsResponseBody> body_ {};
  };
