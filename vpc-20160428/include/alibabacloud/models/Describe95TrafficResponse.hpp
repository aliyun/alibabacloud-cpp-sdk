...
namespace Models
{
  ...
  public:
    ...
    inline const Describe95TrafficResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, Describe95TrafficResponseBody) };
    inline Describe95TrafficResponseBody getBody() { DARABONBA_PTR_GET(body_, Describe95TrafficResponseBody) };
  ...
  protected:
    ...
    shared_ptr<Describe95TrafficResponseBody> body_ {};
  };
