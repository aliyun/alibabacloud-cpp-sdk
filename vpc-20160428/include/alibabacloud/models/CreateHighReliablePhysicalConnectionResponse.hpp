...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHighReliablePhysicalConnectionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateHighReliablePhysicalConnectionResponseBody) };
    inline CreateHighReliablePhysicalConnectionResponseBody body() { DARABONBA_PTR_GET(body_, CreateHighReliablePhysicalConnectionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateHighReliablePhysicalConnectionResponseBody> body_ = nullptr;
  };
