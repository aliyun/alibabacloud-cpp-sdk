...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBgpGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBgpGroupsResponseBody) };
    inline DescribeBgpGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBgpGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBgpGroupsResponseBody> body_ {};
  };
