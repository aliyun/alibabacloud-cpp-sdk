...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getFullNatEntryNames() const { DARABONBA_PTR_GET_CONST(fullNatEntryNames_, vector<string>) };
    inline vector<string> getFullNatEntryNames() { DARABONBA_PTR_GET(fullNatEntryNames_, vector<string>) };
