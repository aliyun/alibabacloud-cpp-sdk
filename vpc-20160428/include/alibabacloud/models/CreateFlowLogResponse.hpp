...
namespace Models
{
  ...
  public:
    ...
    inline const CreateFlowLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateFlowLogResponseBody) };
    inline CreateFlowLogResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateFlowLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateFlowLogResponseBody> body_ {};
  };
