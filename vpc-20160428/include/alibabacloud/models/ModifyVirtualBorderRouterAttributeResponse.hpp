...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVirtualBorderRouterAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyVirtualBorderRouterAttributeResponseBody) };
    inline ModifyVirtualBorderRouterAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyVirtualBorderRouterAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyVirtualBorderRouterAttributeResponseBody> body_ {};
  };
