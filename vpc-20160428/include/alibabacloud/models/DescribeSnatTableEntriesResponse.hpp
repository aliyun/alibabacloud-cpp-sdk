...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSnatTableEntriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSnatTableEntriesResponseBody) };
    inline DescribeSnatTableEntriesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSnatTableEntriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSnatTableEntriesResponseBody> body_ {};
  };
