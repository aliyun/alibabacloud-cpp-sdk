...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateVpcGatewayEndpointAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateVpcGatewayEndpointAttributeResponseBody) };
    inline UpdateVpcGatewayEndpointAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateVpcGatewayEndpointAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateVpcGatewayEndpointAttributeResponseBody> body_ {};
  };
