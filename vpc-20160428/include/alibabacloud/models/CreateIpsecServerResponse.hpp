...
namespace Models
{
  ...
  public:
    ...
    inline const CreateIpsecServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateIpsecServerResponseBody) };
    inline CreateIpsecServerResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateIpsecServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateIpsecServerResponseBody> body_ {};
  };
