...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteBgpNetworkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteBgpNetworkResponseBody) };
    inline DeleteBgpNetworkResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteBgpNetworkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteBgpNetworkResponseBody> body_ {};
  };
