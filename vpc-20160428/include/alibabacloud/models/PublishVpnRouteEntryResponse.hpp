...
namespace Models
{
  ...
  public:
    ...
    inline const PublishVpnRouteEntryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PublishVpnRouteEntryResponseBody) };
    inline PublishVpnRouteEntryResponseBody getBody() { DARABONBA_PTR_GET(body_, PublishVpnRouteEntryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PublishVpnRouteEntryResponseBody> body_ {};
  };
