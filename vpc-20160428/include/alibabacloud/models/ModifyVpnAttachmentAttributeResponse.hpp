...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVpnAttachmentAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyVpnAttachmentAttributeResponseBody) };
    inline ModifyVpnAttachmentAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyVpnAttachmentAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyVpnAttachmentAttributeResponseBody> body_ {};
  };
