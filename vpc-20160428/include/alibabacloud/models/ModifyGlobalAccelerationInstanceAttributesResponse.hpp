...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyGlobalAccelerationInstanceAttributesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyGlobalAccelerationInstanceAttributesResponseBody) };
    inline ModifyGlobalAccelerationInstanceAttributesResponseBody body() { DARABONBA_PTR_GET(body_, ModifyGlobalAccelerationInstanceAttributesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyGlobalAccelerationInstanceAttributesResponseBody> body_ = nullptr;
  };
