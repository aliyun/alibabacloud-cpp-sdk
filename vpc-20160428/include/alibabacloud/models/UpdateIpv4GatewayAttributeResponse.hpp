...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateIpv4GatewayAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateIpv4GatewayAttributeResponseBody) };
    inline UpdateIpv4GatewayAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateIpv4GatewayAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateIpv4GatewayAttributeResponseBody> body_ {};
  };
