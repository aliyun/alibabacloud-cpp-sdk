...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNetworkAclsResponseBodyNetworkAcls & networkAcls() const { DARABONBA_PTR_GET_CONST(networkAcls_, DescribeNetworkAclsResponseBodyNetworkAcls) };
    inline DescribeNetworkAclsResponseBodyNetworkAcls networkAcls() { DARABONBA_PTR_GET(networkAcls_, DescribeNetworkAclsResponseBodyNetworkAcls) };
    inline DescribeNetworkAclsResponseBody& setNetworkAcls(const DescribeNetworkAclsResponseBodyNetworkAcls & networkAcls) { DARABONBA_PTR_SET_VALUE(networkAcls_, networkAcls) };
    inline DescribeNetworkAclsResponseBody& setNetworkAcls(DescribeNetworkAclsResponseBodyNetworkAcls && networkAcls) { DARABONBA_PTR_SET_RVALUE(networkAcls_, networkAcls) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeNetworkAclsResponseBodyNetworkAcls> networkAcls_ = nullptr;
    // The page number.
