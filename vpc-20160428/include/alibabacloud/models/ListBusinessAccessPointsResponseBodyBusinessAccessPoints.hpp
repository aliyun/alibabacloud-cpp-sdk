...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->accessPointId_ != nullptr
        && this->accessPointName_ != nullptr && this->cloudBoxInstanceIds_ != nullptr && this->latitude_ != nullptr && this->longitude_ != nullptr && this->supportLineOperator_ != nullptr
        && this->supportPortTypes_ != nullptr; };
