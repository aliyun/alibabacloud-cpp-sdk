...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVpnAttachmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVpnAttachmentResponseBody) };
    inline CreateVpnAttachmentResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVpnAttachmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVpnAttachmentResponseBody> body_ {};
  };
