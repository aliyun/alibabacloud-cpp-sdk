...
namespace Models
{
  ...
  public:
    ...
    inline const CreateExpressConnectTrafficQosRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateExpressConnectTrafficQosRuleResponseBody) };
    inline CreateExpressConnectTrafficQosRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateExpressConnectTrafficQosRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateExpressConnectTrafficQosRuleResponseBody> body_ {};
  };
