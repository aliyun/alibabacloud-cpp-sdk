...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateRouterInterfaceRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<CreateRouterInterfaceRequest::Tags>) };
    inline vector<CreateRouterInterfaceRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<CreateRouterInterfaceRequest::Tags>) };
    inline CreateRouterInterfaceRequest& setTags(const vector<CreateRouterInterfaceRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline CreateRouterInterfaceRequest& setTags(vector<CreateRouterInterfaceRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    shared_ptr<vector<CreateRouterInterfaceRequest::Tags>> tags_ {};
  };
