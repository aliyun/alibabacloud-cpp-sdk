...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->eipSegmentInstanceId_ == nullptr
    ...
    inline string getEipSegmentInstanceId() const { DARABONBA_PTR_GET_DEFAULT(eipSegmentInstanceId_, "") };
