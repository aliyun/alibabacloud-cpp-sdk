...
#ifndef ALIBABACLOUD_MODELS_CREATETRAFFICMIRRORFILTERREQUESTINGRESSRULES_HPP_
#define ALIBABACLOUD_MODELS_CREATETRAFFICMIRRORFILTERREQUESTINGRESSRULES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateTrafficMirrorFilterRequestIngressRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateTrafficMirrorFilterRequestIngressRules& obj) { 
    ...
    CreateTrafficMirrorFilterRequestIngressRules() = default ;
    CreateTrafficMirrorFilterRequestIngressRules(const CreateTrafficMirrorFilterRequestIngressRules &) = default ;
    CreateTrafficMirrorFilterRequestIngressRules(CreateTrafficMirrorFilterRequestIngressRules &&) = default ;
    CreateTrafficMirrorFilterRequestIngressRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTrafficMirrorFilterRequestIngressRules() = default ;
    CreateTrafficMirrorFilterRequestIngressRules& operator=(const CreateTrafficMirrorFilterRequestIngressRules &) = default ;
    CreateTrafficMirrorFilterRequestIngressRules& operator=(CreateTrafficMirrorFilterRequestIngressRules &&) = default ;
    ...
    inline CreateTrafficMirrorFilterRequestIngressRules& setAction(string action) { DARABONBA_PTR_SET_VALUE(action_, action) };
    ...
    inline CreateTrafficMirrorFilterRequestIngressRules& setDestinationCidrBlock(string destinationCidrBlock) { DARABONBA_PTR_SET_VALUE(destinationCidrBlock_, destinationCidrBlock) };
    ...
    inline CreateTrafficMirrorFilterRequestIngressRules& setDestinationPortRange(string destinationPortRange) { DARABONBA_PTR_SET_VALUE(destinationPortRange_, destinationPortRange) };
    ...
    inline CreateTrafficMirrorFilterRequestIngressRules& setIpVersion(string ipVersion) { DARABONBA_PTR_SET_VALUE(ipVersion_, ipVersion) };
    ...
    inline CreateTrafficMirrorFilterRequestIngressRules& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline CreateTrafficMirrorFilterRequestIngressRules& setProtocol(string protocol) { DARABONBA_PTR_SET_VALUE(protocol_, protocol) };
    ...
    inline CreateTrafficMirrorFilterRequestIngressRules& setSourceCidrBlock(string sourceCidrBlock) { DARABONBA_PTR_SET_VALUE(sourceCidrBlock_, sourceCidrBlock) };
    ...
    inline CreateTrafficMirrorFilterRequestIngressRules& setSourcePortRange(string sourcePortRange) { DARABONBA_PTR_SET_VALUE(sourcePortRange_, sourcePortRange) };
