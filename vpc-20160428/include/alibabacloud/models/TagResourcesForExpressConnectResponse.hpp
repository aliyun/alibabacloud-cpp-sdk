...
namespace Models
{
  ...
  public:
    ...
    inline const TagResourcesForExpressConnectResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, TagResourcesForExpressConnectResponseBody) };
    inline TagResourcesForExpressConnectResponseBody body() { DARABONBA_PTR_GET(body_, TagResourcesForExpressConnectResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<TagResourcesForExpressConnectResponseBody> body_ = nullptr;
  };
