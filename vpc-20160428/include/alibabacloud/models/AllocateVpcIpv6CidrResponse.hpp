...
namespace Models
{
  ...
  public:
    ...
    inline const AllocateVpcIpv6CidrResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AllocateVpcIpv6CidrResponseBody) };
    inline AllocateVpcIpv6CidrResponseBody getBody() { DARABONBA_PTR_GET(body_, AllocateVpcIpv6CidrResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AllocateVpcIpv6CidrResponseBody> body_ {};
  };
