...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        ...
        && this->resourceOwnerId_ == nullptr && this->resourceUid_ == nullptr; };
    ...
    inline int64_t getResourceUid() const { DARABONBA_PTR_GET_DEFAULT(resourceUid_, 0L) };
  ...
  protected:
    ...
    shared_ptr<int64_t> resourceUid_ {};
  };
