...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVirtualPhysicalConnectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVirtualPhysicalConnectionResponseBody) };
    inline CreateVirtualPhysicalConnectionResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVirtualPhysicalConnectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVirtualPhysicalConnectionResponseBody> body_ {};
  };
