...
namespace Models
{
  ...
  public:
    ...
    inline const UnassociateGlobalAccelerationInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnassociateGlobalAccelerationInstanceResponseBody) };
    inline UnassociateGlobalAccelerationInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, UnassociateGlobalAccelerationInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnassociateGlobalAccelerationInstanceResponseBody> body_ {};
  };
