...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bfdMultiHop_ == nullptr
        && return this->bgpGroupId_ == nullptr && return this->bgpPeerId_ == nullptr && return this->clientToken_ == nullptr && return this->enableBfd_ == nullptr && return this->ownerAccount_ == nullptr
