...
namespace Models
{
  ...
  public:
    ...
    inline const OpenPublicIpAddressPoolServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenPublicIpAddressPoolServiceResponseBody) };
    inline OpenPublicIpAddressPoolServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenPublicIpAddressPoolServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenPublicIpAddressPoolServiceResponseBody> body_ {};
  };
