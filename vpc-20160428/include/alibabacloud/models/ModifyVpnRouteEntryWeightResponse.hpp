...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVpnRouteEntryWeightResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyVpnRouteEntryWeightResponseBody) };
    inline ModifyVpnRouteEntryWeightResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyVpnRouteEntryWeightResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyVpnRouteEntryWeightResponseBody> body_ {};
  };
