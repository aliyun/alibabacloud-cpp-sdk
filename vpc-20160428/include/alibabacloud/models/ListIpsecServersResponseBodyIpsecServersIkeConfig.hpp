...
#ifndef ALIBABACLOUD_MODELS_LISTIPSECSERVERSRESPONSEBODYIPSECSERVERSIKECONFIG_HPP_
#define ALIBABACLOUD_MODELS_LISTIPSECSERVERSRESPONSEBODYIPSECSERVERSIKECONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListIpsecServersResponseBodyIpsecServersIkeConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListIpsecServersResponseBodyIpsecServersIkeConfig& obj) { 
    ...
    ListIpsecServersResponseBodyIpsecServersIkeConfig() = default ;
    ListIpsecServersResponseBodyIpsecServersIkeConfig(const ListIpsecServersResponseBodyIpsecServersIkeConfig &) = default ;
    ListIpsecServersResponseBodyIpsecServersIkeConfig(ListIpsecServersResponseBodyIpsecServersIkeConfig &&) = default ;
    ListIpsecServersResponseBodyIpsecServersIkeConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListIpsecServersResponseBodyIpsecServersIkeConfig() = default ;
    ListIpsecServersResponseBodyIpsecServersIkeConfig& operator=(const ListIpsecServersResponseBodyIpsecServersIkeConfig &) = default ;
    ListIpsecServersResponseBodyIpsecServersIkeConfig& operator=(ListIpsecServersResponseBodyIpsecServersIkeConfig &&) = default ;
    ...
    virtual bool empty() const override { return this->ikeAuthAlg_ == nullptr
        ...
        && return this->localId_ == nullptr && return this->remoteId_ == nullptr; };
    ...
    inline ListIpsecServersResponseBodyIpsecServersIkeConfig& setIkeAuthAlg(string ikeAuthAlg) { DARABONBA_PTR_SET_VALUE(ikeAuthAlg_, ikeAuthAlg) };
    ...
    inline ListIpsecServersResponseBodyIpsecServersIkeConfig& setIkeEncAlg(string ikeEncAlg) { DARABONBA_PTR_SET_VALUE(ikeEncAlg_, ikeEncAlg) };
    ...
    inline ListIpsecServersResponseBodyIpsecServersIkeConfig& setIkeLifetime(int64_t ikeLifetime) { DARABONBA_PTR_SET_VALUE(ikeLifetime_, ikeLifetime) };
    ...
    inline ListIpsecServersResponseBodyIpsecServersIkeConfig& setIkeMode(string ikeMode) { DARABONBA_PTR_SET_VALUE(ikeMode_, ikeMode) };
    ...
    inline ListIpsecServersResponseBodyIpsecServersIkeConfig& setIkePfs(string ikePfs) { DARABONBA_PTR_SET_VALUE(ikePfs_, ikePfs) };
    ...
    inline ListIpsecServersResponseBodyIpsecServersIkeConfig& setIkeVersion(string ikeVersion) { DARABONBA_PTR_SET_VALUE(ikeVersion_, ikeVersion) };
    ...
    inline ListIpsecServersResponseBodyIpsecServersIkeConfig& setLocalId(string localId) { DARABONBA_PTR_SET_VALUE(localId_, localId) };
    ...
    inline ListIpsecServersResponseBodyIpsecServersIkeConfig& setRemoteId(string remoteId) { DARABONBA_PTR_SET_VALUE(remoteId_, remoteId) };
