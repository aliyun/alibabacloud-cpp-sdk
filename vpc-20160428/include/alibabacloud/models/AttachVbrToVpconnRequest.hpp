...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dryRun_ == nullptr
        && return this->regionId_ == nullptr && return this->token_ == nullptr && return this->vbrId_ == nullptr && return this->vpconnId_ == nullptr; };
    ...
    inline string vpconnId() const { DARABONBA_PTR_GET_DEFAULT(vpconnId_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> vpconnId_ = nullptr;
  };
