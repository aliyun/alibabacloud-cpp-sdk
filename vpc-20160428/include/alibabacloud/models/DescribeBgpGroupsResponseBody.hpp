...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->bgpGroups_ != nullptr
    ...
    inline const DescribeBgpGroupsResponseBodyBgpGroups & bgpGroups() const { DARABONBA_PTR_GET_CONST(bgpGroups_, DescribeBgpGroupsResponseBodyBgpGroups) };
    inline DescribeBgpGroupsResponseBodyBgpGroups bgpGroups() { DARABONBA_PTR_GET(bgpGroups_, DescribeBgpGroupsResponseBodyBgpGroups) };
    inline DescribeBgpGroupsResponseBody& setBgpGroups(const DescribeBgpGroupsResponseBodyBgpGroups & bgpGroups) { DARABONBA_PTR_SET_VALUE(bgpGroups_, bgpGroups) };
    inline DescribeBgpGroupsResponseBody& setBgpGroups(DescribeBgpGroupsResponseBodyBgpGroups && bgpGroups) { DARABONBA_PTR_SET_RVALUE(bgpGroups_, bgpGroups) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeBgpGroupsResponseBodyBgpGroups> bgpGroups_ = nullptr;
    // The page number.
