...
namespace Models
{
  ...
  public:
    ...
    inline const RecoverPhysicalConnectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RecoverPhysicalConnectionResponseBody) };
    inline RecoverPhysicalConnectionResponseBody getBody() { DARABONBA_PTR_GET(body_, RecoverPhysicalConnectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RecoverPhysicalConnectionResponseBody> body_ {};
  };
