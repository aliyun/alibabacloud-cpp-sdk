...
namespace Models
{
  ...
  public:
    ...
    inline const AddBgpNetworkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddBgpNetworkResponseBody) };
    inline AddBgpNetworkResponseBody getBody() { DARABONBA_PTR_GET(body_, AddBgpNetworkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddBgpNetworkResponseBody> body_ {};
  };
