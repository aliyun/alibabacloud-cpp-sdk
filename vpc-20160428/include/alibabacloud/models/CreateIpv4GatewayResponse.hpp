...
namespace Models
{
  ...
  public:
    ...
    inline const CreateIpv4GatewayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateIpv4GatewayResponseBody) };
    inline CreateIpv4GatewayResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateIpv4GatewayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateIpv4GatewayResponseBody> body_ {};
  };
