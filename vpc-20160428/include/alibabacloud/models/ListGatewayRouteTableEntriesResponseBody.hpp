...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->gatewayRouteEntryModels_ != nullptr
    ...
    inline const vector<ListGatewayRouteTableEntriesResponseBodyGatewayRouteEntryModels> & gatewayRouteEntryModels() const { DARABONBA_PTR_GET_CONST(gatewayRouteEntryModels_, vector<ListGatewayRouteTableEntriesResponseBodyGatewayRouteEntryModels>) };
    inline vector<ListGatewayRouteTableEntriesResponseBodyGatewayRouteEntryModels> gatewayRouteEntryModels() { DARABONBA_PTR_GET(gatewayRouteEntryModels_, vector<ListGatewayRouteTableEntriesResponseBodyGatewayRouteEntryModels>) };
    inline ListGatewayRouteTableEntriesResponseBody& setGatewayRouteEntryModels(const vector<ListGatewayRouteTableEntriesResponseBodyGatewayRouteEntryModels> & gatewayRouteEntryModels) { DARABONBA_PTR_SET_VALUE(gatewayRouteEntryModels_, gatewayRouteEntryModels) };
    inline ListGatewayRouteTableEntriesResponseBody& setGatewayRouteEntryModels(vector<ListGatewayRouteTableEntriesResponseBodyGatewayRouteEntryModels> && gatewayRouteEntryModels) { DARABONBA_PTR_SET_RVALUE(gatewayRouteEntryModels_, gatewayRouteEntryModels) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListGatewayRouteTableEntriesResponseBodyGatewayRouteEntryModels>> gatewayRouteEntryModels_ = nullptr;
