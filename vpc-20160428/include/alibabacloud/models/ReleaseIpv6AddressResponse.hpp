...
namespace Models
{
  ...
  public:
    ...
    inline const ReleaseIpv6AddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReleaseIpv6AddressResponseBody) };
    inline ReleaseIpv6AddressResponseBody getBody() { DARABONBA_PTR_GET(body_, ReleaseIpv6AddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReleaseIpv6AddressResponseBody> body_ {};
  };
