...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessStatus_ == nullptr
        && return this->creationTime_ == nullptr && return this->description_ == nullptr && return this->expiredTime_ == nullptr && return this->gatewayRouteTableId_ == nullptr && return this->instanceChargeType_ == nullptr
        && return this->ipv6GatewayId_ == nullptr && return this->name_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr && return this->requestId_ == nullptr
