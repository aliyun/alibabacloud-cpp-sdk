...
namespace Models
{
  ...
  public:
    ...
    inline const CreateForwardEntryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateForwardEntryResponseBody) };
    inline CreateForwardEntryResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateForwardEntryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateForwardEntryResponseBody> body_ {};
  };
