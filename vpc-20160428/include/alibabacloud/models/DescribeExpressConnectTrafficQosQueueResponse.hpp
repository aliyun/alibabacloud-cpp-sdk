...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExpressConnectTrafficQosQueueResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeExpressConnectTrafficQosQueueResponseBody) };
    inline DescribeExpressConnectTrafficQosQueueResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeExpressConnectTrafficQosQueueResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeExpressConnectTrafficQosQueueResponseBody> body_ {};
  };
