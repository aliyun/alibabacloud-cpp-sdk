...
namespace Models
{
  ...
  public:
    ...
    inline const WithdrawVpcPublishedRouteEntriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, WithdrawVpcPublishedRouteEntriesResponseBody) };
    inline WithdrawVpcPublishedRouteEntriesResponseBody getBody() { DARABONBA_PTR_GET(body_, WithdrawVpcPublishedRouteEntriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<WithdrawVpcPublishedRouteEntriesResponseBody> body_ {};
  };
