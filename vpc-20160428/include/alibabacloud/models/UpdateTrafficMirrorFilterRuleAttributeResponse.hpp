...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTrafficMirrorFilterRuleAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTrafficMirrorFilterRuleAttributeResponseBody) };
    inline UpdateTrafficMirrorFilterRuleAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTrafficMirrorFilterRuleAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTrafficMirrorFilterRuleAttributeResponseBody> body_ {};
  };
