...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->convertInstanceId_ == nullptr
    ...
    inline string getConvertInstanceId() const { DARABONBA_PTR_GET_DEFAULT(convertInstanceId_, "") };
  ...
  protected:
    ...
    shared_ptr<string> convertInstanceId_ {};
    // The request ID.
