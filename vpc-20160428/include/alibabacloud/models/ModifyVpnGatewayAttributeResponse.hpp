...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVpnGatewayAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyVpnGatewayAttributeResponseBody) };
    inline ModifyVpnGatewayAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyVpnGatewayAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyVpnGatewayAttributeResponseBody> body_ {};
  };
