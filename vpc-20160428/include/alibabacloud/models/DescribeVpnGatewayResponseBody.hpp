...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoPropagate_ == nullptr
        ...
        && return this->ipsecVpn_ == nullptr && return this->name_ == nullptr && return this->networkType_ == nullptr && return this->requestId_ == nullptr && return this->reservationData_ == nullptr
        && return this->resourceGroupId_ == nullptr && return this->spec_ == nullptr && return this->sslMaxConnections_ == nullptr && return this->sslVpn_ == nullptr && return this->sslVpnInternetIp_ == nullptr
        && return this->status_ == nullptr && return this->tag_ == nullptr && return this->tags_ == nullptr && return this->vSwitchId_ == nullptr && return this->vpcId_ == nullptr
        && return this->vpnGatewayId_ == nullptr && return this->vpnType_ == nullptr; };
