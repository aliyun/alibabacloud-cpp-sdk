...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        ...
        && return this->resourceOwnerAccount_ == nullptr && return this->ruleIdList_ == nullptr && return this->ruleNameList_ == nullptr; };
    ...
    inline const vector<string> & ruleIdList() const { DARABONBA_PTR_GET_CONST(ruleIdList_, vector<string>) };
    inline vector<string> ruleIdList() { DARABONBA_PTR_GET(ruleIdList_, vector<string>) };
    ...
    inline const vector<string> & ruleNameList() const { DARABONBA_PTR_GET_CONST(ruleNameList_, vector<string>) };
    inline vector<string> ruleNameList() { DARABONBA_PTR_GET(ruleNameList_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> ruleIdList_ = nullptr;
    // The list of QoS rule names.
    std::shared_ptr<vector<string>> ruleNameList_ = nullptr;
  };
