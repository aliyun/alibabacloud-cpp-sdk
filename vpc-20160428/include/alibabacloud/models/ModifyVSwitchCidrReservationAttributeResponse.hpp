...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVSwitchCidrReservationAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyVSwitchCidrReservationAttributeResponseBody) };
    inline ModifyVSwitchCidrReservationAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyVSwitchCidrReservationAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyVSwitchCidrReservationAttributeResponseBody> body_ {};
  };
