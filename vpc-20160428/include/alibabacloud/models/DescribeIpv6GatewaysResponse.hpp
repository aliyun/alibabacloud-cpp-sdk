...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeIpv6GatewaysResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeIpv6GatewaysResponseBody) };
    inline DescribeIpv6GatewaysResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeIpv6GatewaysResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeIpv6GatewaysResponseBody> body_ {};
  };
