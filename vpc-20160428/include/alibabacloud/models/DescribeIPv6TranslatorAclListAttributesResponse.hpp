...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeIPv6TranslatorAclListAttributesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeIPv6TranslatorAclListAttributesResponseBody) };
    inline DescribeIPv6TranslatorAclListAttributesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeIPv6TranslatorAclListAttributesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeIPv6TranslatorAclListAttributesResponseBody> body_ {};
  };
