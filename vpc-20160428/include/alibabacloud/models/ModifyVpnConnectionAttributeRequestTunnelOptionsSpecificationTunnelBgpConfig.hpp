...
#ifndef ALIBABACLOUD_MODELS_MODIFYVPNCONNECTIONATTRIBUTEREQUESTTUNNELOPTIONSSPECIFICATIONTUNNELBGPCONFIG_HPP_
#define ALIBABACLOUD_MODELS_MODIFYVPNCONNECTIONATTRIBUTEREQUESTTUNNELOPTIONSSPECIFICATIONTUNNELBGPCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig& obj) { 
    ...
    ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig() = default ;
    ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig(const ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig &) = default ;
    ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig(ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig &&) = default ;
    ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig() = default ;
    ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig& operator=(const ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig &) = default ;
    ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig& operator=(ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig &&) = default ;
    ...
    inline ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig& setLocalAsn(int64_t localAsn) { DARABONBA_PTR_SET_VALUE(localAsn_, localAsn) };
    ...
    inline ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig& setLocalBgpIp(string localBgpIp) { DARABONBA_PTR_SET_VALUE(localBgpIp_, localBgpIp) };
    ...
    inline ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig& setTunnelCidr(string tunnelCidr) { DARABONBA_PTR_SET_VALUE(tunnelCidr_, tunnelCidr) };
