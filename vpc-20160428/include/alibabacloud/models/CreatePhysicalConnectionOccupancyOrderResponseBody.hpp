...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePhysicalConnectionOccupancyOrderResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreatePhysicalConnectionOccupancyOrderResponseBodyData) };
    inline CreatePhysicalConnectionOccupancyOrderResponseBodyData data() { DARABONBA_PTR_GET(data_, CreatePhysicalConnectionOccupancyOrderResponseBodyData) };
    inline CreatePhysicalConnectionOccupancyOrderResponseBody& setData(const CreatePhysicalConnectionOccupancyOrderResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreatePhysicalConnectionOccupancyOrderResponseBody& setData(CreatePhysicalConnectionOccupancyOrderResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The details.
    std::shared_ptr<CreatePhysicalConnectionOccupancyOrderResponseBodyData> data_ = nullptr;
    // The request ID.
