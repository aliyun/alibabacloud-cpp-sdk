...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateNatGatewayNatTypeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateNatGatewayNatTypeResponseBody) };
    inline UpdateNatGatewayNatTypeResponseBody body() { DARABONBA_PTR_GET(body_, UpdateNatGatewayNatTypeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateNatGatewayNatTypeResponseBody> body_ = nullptr;
  };
