...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AssociateNetworkAclRequestResource> & resource() const { DARABONBA_PTR_GET_CONST(resource_, vector<AssociateNetworkAclRequestResource>) };
    inline vector<AssociateNetworkAclRequestResource> resource() { DARABONBA_PTR_GET(resource_, vector<AssociateNetworkAclRequestResource>) };
    inline AssociateNetworkAclRequest& setResource(const vector<AssociateNetworkAclRequestResource> & resource) { DARABONBA_PTR_SET_VALUE(resource_, resource) };
    inline AssociateNetworkAclRequest& setResource(vector<AssociateNetworkAclRequestResource> && resource) { DARABONBA_PTR_SET_RVALUE(resource_, resource) };
  ...
  protected:
    ...
    std::shared_ptr<vector<AssociateNetworkAclRequestResource>> resource_ = nullptr;
