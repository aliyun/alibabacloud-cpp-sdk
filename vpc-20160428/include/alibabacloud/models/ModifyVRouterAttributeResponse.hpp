...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVRouterAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyVRouterAttributeResponseBody) };
    inline ModifyVRouterAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyVRouterAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyVRouterAttributeResponseBody> body_ {};
  };
