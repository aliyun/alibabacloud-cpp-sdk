...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCommonBandwidthPackageIpBandwidthResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCommonBandwidthPackageIpBandwidthResponseBody) };
    inline ModifyCommonBandwidthPackageIpBandwidthResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCommonBandwidthPackageIpBandwidthResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCommonBandwidthPackageIpBandwidthResponseBody> body_ {};
  };
