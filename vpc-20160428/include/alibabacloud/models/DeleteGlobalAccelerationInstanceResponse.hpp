...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteGlobalAccelerationInstanceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteGlobalAccelerationInstanceResponseBody) };
    inline DeleteGlobalAccelerationInstanceResponseBody body() { DARABONBA_PTR_GET(body_, DeleteGlobalAccelerationInstanceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteGlobalAccelerationInstanceResponseBody> body_ = nullptr;
  };
