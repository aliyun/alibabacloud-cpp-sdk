...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoConfigRoute_ == nullptr
        ...
        && return this->ipsecConfig_ == nullptr && return this->localSubnet_ == nullptr && return this->name_ == nullptr && return this->networkType_ == nullptr && return this->ownerAccount_ == nullptr
        && return this->regionId_ == nullptr && return this->remoteCaCert_ == nullptr && return this->remoteSubnet_ == nullptr && return this->resourceGroupId_ == nullptr && return this->resourceOwnerAccount_ == nullptr
        && return this->resourceOwnerId_ == nullptr && return this->tags_ == nullptr && return this->tunnelOptionsSpecification_ == nullptr; };
