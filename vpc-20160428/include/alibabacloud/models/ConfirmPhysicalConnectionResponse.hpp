...
namespace Models
{
  ...
  public:
    ...
    inline const ConfirmPhysicalConnectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfirmPhysicalConnectionResponseBody) };
    inline ConfirmPhysicalConnectionResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfirmPhysicalConnectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfirmPhysicalConnectionResponseBody> body_ {};
  };
