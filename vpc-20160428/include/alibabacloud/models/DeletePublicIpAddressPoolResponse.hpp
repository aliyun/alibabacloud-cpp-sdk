...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePublicIpAddressPoolResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePublicIpAddressPoolResponseBody) };
    inline DeletePublicIpAddressPoolResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePublicIpAddressPoolResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePublicIpAddressPoolResponseBody> body_ {};
  };
