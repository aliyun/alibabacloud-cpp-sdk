...
#ifndef ALIBABACLOUD_MODELS_CREATEVPNCONNECTIONREQUESTTUNNELOPTIONSSPECIFICATIONTUNNELIPSECCONFIG_HPP_
#define ALIBABACLOUD_MODELS_CREATEVPNCONNECTIONREQUESTTUNNELOPTIONSSPECIFICATIONTUNNELIPSECCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig& obj) { 
    ...
    CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig() = default ;
    CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig(const CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig &) = default ;
    CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig(CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig &&) = default ;
    CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig() = default ;
    CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig& operator=(const CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig &) = default ;
    CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig& operator=(CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig &&) = default ;
    ...
    inline CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig& setIpsecAuthAlg(string ipsecAuthAlg) { DARABONBA_PTR_SET_VALUE(ipsecAuthAlg_, ipsecAuthAlg) };
    ...
    inline CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig& setIpsecEncAlg(string ipsecEncAlg) { DARABONBA_PTR_SET_VALUE(ipsecEncAlg_, ipsecEncAlg) };
    ...
    inline CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig& setIpsecLifetime(int64_t ipsecLifetime) { DARABONBA_PTR_SET_VALUE(ipsecLifetime_, ipsecLifetime) };
    ...
    inline CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig& setIpsecPfs(string ipsecPfs) { DARABONBA_PTR_SET_VALUE(ipsecPfs_, ipsecPfs) };
