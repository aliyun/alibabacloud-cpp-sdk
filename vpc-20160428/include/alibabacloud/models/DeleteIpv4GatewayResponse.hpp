...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteIpv4GatewayResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteIpv4GatewayResponseBody) };
    inline DeleteIpv4GatewayResponseBody body() { DARABONBA_PTR_GET(body_, DeleteIpv4GatewayResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteIpv4GatewayResponseBody> body_ = nullptr;
  };
