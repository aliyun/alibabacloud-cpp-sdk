...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEcGrantRelationResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeEcGrantRelationResponseBody) };
    inline DescribeEcGrantRelationResponseBody body() { DARABONBA_PTR_GET(body_, DescribeEcGrantRelationResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeEcGrantRelationResponseBody> body_ = nullptr;
  };
