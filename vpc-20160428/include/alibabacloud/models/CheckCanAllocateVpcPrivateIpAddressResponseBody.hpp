...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->canAllocate_ != nullptr
    ...
    inline bool canAllocate() const { DARABONBA_PTR_GET_DEFAULT(canAllocate_, false) };
  ...
  protected:
    ...
    // *   **true**
    // *   **false**
    std::shared_ptr<bool> canAllocate_ = nullptr;
    // The request ID.
