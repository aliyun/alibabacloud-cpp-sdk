...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTrafficMirrorFilterRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTrafficMirrorFilterRulesResponseBody) };
    inline DeleteTrafficMirrorFilterRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTrafficMirrorFilterRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTrafficMirrorFilterRulesResponseBody> body_ {};
  };
