...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEVPNCONNECTIONRESPONSEBODYIKECONFIG_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEVPNCONNECTIONRESPONSEBODYIKECONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeVpnConnectionResponseBodyIkeConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeVpnConnectionResponseBodyIkeConfig& obj) { 
    ...
    DescribeVpnConnectionResponseBodyIkeConfig() = default ;
    DescribeVpnConnectionResponseBodyIkeConfig(const DescribeVpnConnectionResponseBodyIkeConfig &) = default ;
    DescribeVpnConnectionResponseBodyIkeConfig(DescribeVpnConnectionResponseBodyIkeConfig &&) = default ;
    DescribeVpnConnectionResponseBodyIkeConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeVpnConnectionResponseBodyIkeConfig() = default ;
    DescribeVpnConnectionResponseBodyIkeConfig& operator=(const DescribeVpnConnectionResponseBodyIkeConfig &) = default ;
    DescribeVpnConnectionResponseBodyIkeConfig& operator=(DescribeVpnConnectionResponseBodyIkeConfig &&) = default ;
    ...
    inline DescribeVpnConnectionResponseBodyIkeConfig& setIkeAuthAlg(string ikeAuthAlg) { DARABONBA_PTR_SET_VALUE(ikeAuthAlg_, ikeAuthAlg) };
    ...
    inline DescribeVpnConnectionResponseBodyIkeConfig& setIkeEncAlg(string ikeEncAlg) { DARABONBA_PTR_SET_VALUE(ikeEncAlg_, ikeEncAlg) };
    ...
    inline DescribeVpnConnectionResponseBodyIkeConfig& setIkeLifetime(int64_t ikeLifetime) { DARABONBA_PTR_SET_VALUE(ikeLifetime_, ikeLifetime) };
    ...
    inline DescribeVpnConnectionResponseBodyIkeConfig& setIkeMode(string ikeMode) { DARABONBA_PTR_SET_VALUE(ikeMode_, ikeMode) };
    ...
    inline DescribeVpnConnectionResponseBodyIkeConfig& setIkePfs(string ikePfs) { DARABONBA_PTR_SET_VALUE(ikePfs_, ikePfs) };
    ...
    inline DescribeVpnConnectionResponseBodyIkeConfig& setIkeVersion(string ikeVersion) { DARABONBA_PTR_SET_VALUE(ikeVersion_, ikeVersion) };
    ...
    inline DescribeVpnConnectionResponseBodyIkeConfig& setLocalId(string localId) { DARABONBA_PTR_SET_VALUE(localId_, localId) };
    ...
    inline DescribeVpnConnectionResponseBodyIkeConfig& setPsk(string psk) { DARABONBA_PTR_SET_VALUE(psk_, psk) };
    ...
    inline DescribeVpnConnectionResponseBodyIkeConfig& setRemoteId(string remoteId) { DARABONBA_PTR_SET_VALUE(remoteId_, remoteId) };
