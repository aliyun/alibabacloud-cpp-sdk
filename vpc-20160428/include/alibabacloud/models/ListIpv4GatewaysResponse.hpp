...
namespace Models
{
  ...
  public:
    ...
    inline const ListIpv4GatewaysResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListIpv4GatewaysResponseBody) };
    inline ListIpv4GatewaysResponseBody getBody() { DARABONBA_PTR_GET(body_, ListIpv4GatewaysResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListIpv4GatewaysResponseBody> body_ {};
  };
