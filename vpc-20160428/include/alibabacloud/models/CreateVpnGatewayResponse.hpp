...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVpnGatewayResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateVpnGatewayResponseBody) };
    inline CreateVpnGatewayResponseBody body() { DARABONBA_PTR_GET(body_, CreateVpnGatewayResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateVpnGatewayResponseBody> body_ = nullptr;
  };
