...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTrafficMirrorFilterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTrafficMirrorFilterResponseBody) };
    inline CreateTrafficMirrorFilterResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTrafficMirrorFilterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTrafficMirrorFilterResponseBody> body_ {};
  };
