...
namespace Models
{
  ...
  public:
    ...
    inline const CreateIpv6EgressOnlyRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateIpv6EgressOnlyRuleResponseBody) };
    inline CreateIpv6EgressOnlyRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateIpv6EgressOnlyRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateIpv6EgressOnlyRuleResponseBody> body_ {};
  };
