...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSslVpnClientCertResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSslVpnClientCertResponseBody) };
    inline DeleteSslVpnClientCertResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSslVpnClientCertResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSslVpnClientCertResponseBody> body_ {};
  };
