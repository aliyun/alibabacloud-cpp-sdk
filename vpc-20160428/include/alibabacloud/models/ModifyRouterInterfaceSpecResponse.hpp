...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyRouterInterfaceSpecResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyRouterInterfaceSpecResponseBody) };
    inline ModifyRouterInterfaceSpecResponseBody body() { DARABONBA_PTR_GET(body_, ModifyRouterInterfaceSpecResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyRouterInterfaceSpecResponseBody> body_ = nullptr;
  };
