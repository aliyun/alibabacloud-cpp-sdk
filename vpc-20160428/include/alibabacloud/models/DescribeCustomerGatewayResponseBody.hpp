...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->asn_ == nullptr
        && return this->authKey_ == nullptr && return this->createTime_ == nullptr && return this->customerGatewayId_ == nullptr && return this->description_ == nullptr && return this->ipAddress_ == nullptr
        && return this->name_ == nullptr && return this->requestId_ == nullptr && return this->resourceGroupId_ == nullptr && return this->tags_ == nullptr; };
    // asn Field Functions 
