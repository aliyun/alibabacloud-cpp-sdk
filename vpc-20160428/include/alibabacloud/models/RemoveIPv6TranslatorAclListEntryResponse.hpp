...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveIPv6TranslatorAclListEntryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveIPv6TranslatorAclListEntryResponseBody) };
    inline RemoveIPv6TranslatorAclListEntryResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveIPv6TranslatorAclListEntryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveIPv6TranslatorAclListEntryResponseBody> body_ {};
  };
