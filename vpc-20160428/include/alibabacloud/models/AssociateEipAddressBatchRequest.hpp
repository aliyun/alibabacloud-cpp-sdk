...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bindedInstanceId_ == nullptr
        && this->bindedInstanceType_ == nullptr && this->clientToken_ == nullptr && this->instanceIds_ == nullptr && this->mode_ == nullptr && this->ownerId_ == nullptr
    ...
    inline string getBindedInstanceId() const { DARABONBA_PTR_GET_DEFAULT(bindedInstanceId_, "") };
    ...
    inline string getBindedInstanceType() const { DARABONBA_PTR_GET_DEFAULT(bindedInstanceType_, "") };
  ...
  protected:
    ...
    shared_ptr<string> bindedInstanceId_ {};
    ...
    // 
    // This parameter is required.
    shared_ptr<string> bindedInstanceType_ {};
