...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTrafficMirrorFilterAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTrafficMirrorFilterAttributeResponseBody) };
    inline UpdateTrafficMirrorFilterAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTrafficMirrorFilterAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTrafficMirrorFilterAttributeResponseBody> body_ {};
  };
