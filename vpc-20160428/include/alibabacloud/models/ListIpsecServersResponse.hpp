...
namespace Models
{
  ...
  public:
    ...
    inline const ListIpsecServersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListIpsecServersResponseBody) };
    inline ListIpsecServersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListIpsecServersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListIpsecServersResponseBody> body_ {};
  };
