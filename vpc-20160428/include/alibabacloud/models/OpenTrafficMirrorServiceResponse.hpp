...
namespace Models
{
  ...
  public:
    ...
    inline const OpenTrafficMirrorServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenTrafficMirrorServiceResponseBody) };
    inline OpenTrafficMirrorServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenTrafficMirrorServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenTrafficMirrorServiceResponseBody> body_ {};
  };
