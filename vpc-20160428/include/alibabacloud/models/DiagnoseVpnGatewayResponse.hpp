...
namespace Models
{
  ...
  public:
    ...
    inline const DiagnoseVpnGatewayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DiagnoseVpnGatewayResponseBody) };
    inline DiagnoseVpnGatewayResponseBody getBody() { DARABONBA_PTR_GET(body_, DiagnoseVpnGatewayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DiagnoseVpnGatewayResponseBody> body_ {};
  };
