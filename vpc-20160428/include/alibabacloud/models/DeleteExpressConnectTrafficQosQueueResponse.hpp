...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteExpressConnectTrafficQosQueueResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteExpressConnectTrafficQosQueueResponseBody) };
    inline DeleteExpressConnectTrafficQosQueueResponseBody body() { DARABONBA_PTR_GET(body_, DeleteExpressConnectTrafficQosQueueResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteExpressConnectTrafficQosQueueResponseBody> body_ = nullptr;
  };
