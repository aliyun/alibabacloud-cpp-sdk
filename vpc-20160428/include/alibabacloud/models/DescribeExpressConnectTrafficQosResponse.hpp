...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExpressConnectTrafficQosResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeExpressConnectTrafficQosResponseBody) };
    inline DescribeExpressConnectTrafficQosResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeExpressConnectTrafficQosResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeExpressConnectTrafficQosResponseBody> body_ {};
  };
