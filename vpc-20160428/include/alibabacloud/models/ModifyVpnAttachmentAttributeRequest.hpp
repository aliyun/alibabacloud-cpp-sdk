...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoConfigRoute_ == nullptr
        && return this->bgpConfig_ == nullptr && return this->clientToken_ == nullptr && return this->customerGatewayId_ == nullptr && return this->effectImmediately_ == nullptr && return this->enableDpd_ == nullptr
        && return this->enableNatTraversal_ == nullptr && return this->enableTunnelsBgp_ == nullptr && return this->healthCheckConfig_ == nullptr && return this->ikeConfig_ == nullptr && return this->ipsecConfig_ == nullptr
        && return this->localSubnet_ == nullptr && return this->name_ == nullptr && return this->networkType_ == nullptr && return this->ownerAccount_ == nullptr && return this->regionId_ == nullptr
        && return this->remoteCaCert_ == nullptr && return this->remoteSubnet_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->tunnelOptionsSpecification_ == nullptr
