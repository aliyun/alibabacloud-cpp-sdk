...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->totalCount_ == nullptr && return this->vpnPbrRouteEntries_ == nullptr; };
    ...
    inline const DescribeVpnPbrRouteEntriesResponseBodyVpnPbrRouteEntries & vpnPbrRouteEntries() const { DARABONBA_PTR_GET_CONST(vpnPbrRouteEntries_, DescribeVpnPbrRouteEntriesResponseBodyVpnPbrRouteEntries) };
    inline DescribeVpnPbrRouteEntriesResponseBodyVpnPbrRouteEntries vpnPbrRouteEntries() { DARABONBA_PTR_GET(vpnPbrRouteEntries_, DescribeVpnPbrRouteEntriesResponseBodyVpnPbrRouteEntries) };
    inline DescribeVpnPbrRouteEntriesResponseBody& setVpnPbrRouteEntries(const DescribeVpnPbrRouteEntriesResponseBodyVpnPbrRouteEntries & vpnPbrRouteEntries) { DARABONBA_PTR_SET_VALUE(vpnPbrRouteEntries_, vpnPbrRouteEntries) };
    inline DescribeVpnPbrRouteEntriesResponseBody& setVpnPbrRouteEntries(DescribeVpnPbrRouteEntriesResponseBodyVpnPbrRouteEntries && vpnPbrRouteEntries) { DARABONBA_PTR_SET_RVALUE(vpnPbrRouteEntries_, vpnPbrRouteEntries) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVpnPbrRouteEntriesResponseBodyVpnPbrRouteEntries> vpnPbrRouteEntries_ = nullptr;
  };
