...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRouteTablesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRouteTablesResponseBody) };
    inline DescribeRouteTablesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRouteTablesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRouteTablesResponseBody> body_ {};
  };
