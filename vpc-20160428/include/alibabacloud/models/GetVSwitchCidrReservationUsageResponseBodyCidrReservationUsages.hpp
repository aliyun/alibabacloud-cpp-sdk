...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ipPrefixCidr_ == nullptr
        && return this->ipPrefixId_ == nullptr && return this->resourceId_ == nullptr && return this->resourceType_ == nullptr && return this->vSwitchCidrReservationId_ == nullptr && return this->vSwitchId_ == nullptr; };
