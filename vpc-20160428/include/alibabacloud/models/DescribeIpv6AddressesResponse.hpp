...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeIpv6AddressesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeIpv6AddressesResponseBody) };
    inline DescribeIpv6AddressesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeIpv6AddressesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeIpv6AddressesResponseBody> body_ {};
  };
