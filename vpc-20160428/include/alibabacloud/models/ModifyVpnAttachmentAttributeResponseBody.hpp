...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->customerGatewayId_ == nullptr
        && this->enableDpd_ == nullptr && this->enableNatTraversal_ == nullptr && this->internetIp_ == nullptr && this->role_ == nullptr && this->state_ == nullptr
        && this->tunnelBgpConfig_ == nullptr && this->tunnelId_ == nullptr && this->tunnelIkeConfig_ == nullptr && this->tunnelIndex_ == nullptr && this->tunnelIpsecConfig_ == nullptr; };
      ...
      inline TunnelOptionsSpecification& setInternetIp(string internetIp) { DARABONBA_PTR_SET_VALUE(internetIp_, internetIp) };
      ...
      inline TunnelOptionsSpecification& setState(string state) { DARABONBA_PTR_SET_VALUE(state_, state) };
    ...
    inline const ModifyVpnAttachmentAttributeResponseBody::IkeConfig & getIkeConfig() const { DARABONBA_PTR_GET_CONST(ikeConfig_, ModifyVpnAttachmentAttributeResponseBody::IkeConfig) };
    inline ModifyVpnAttachmentAttributeResponseBody::IkeConfig getIkeConfig() { DARABONBA_PTR_GET(ikeConfig_, ModifyVpnAttachmentAttributeResponseBody::IkeConfig) };
    inline ModifyVpnAttachmentAttributeResponseBody& setIkeConfig(const ModifyVpnAttachmentAttributeResponseBody::IkeConfig & ikeConfig) { DARABONBA_PTR_SET_VALUE(ikeConfig_, ikeConfig) };
    inline ModifyVpnAttachmentAttributeResponseBody& setIkeConfig(ModifyVpnAttachmentAttributeResponseBody::IkeConfig && ikeConfig) { DARABONBA_PTR_SET_RVALUE(ikeConfig_, ikeConfig) };
    ...
    inline const ModifyVpnAttachmentAttributeResponseBody::IpsecConfig & getIpsecConfig() const { DARABONBA_PTR_GET_CONST(ipsecConfig_, ModifyVpnAttachmentAttributeResponseBody::IpsecConfig) };
    inline ModifyVpnAttachmentAttributeResponseBody::IpsecConfig getIpsecConfig() { DARABONBA_PTR_GET(ipsecConfig_, ModifyVpnAttachmentAttributeResponseBody::IpsecConfig) };
    inline ModifyVpnAttachmentAttributeResponseBody& setIpsecConfig(const ModifyVpnAttachmentAttributeResponseBody::IpsecConfig & ipsecConfig) { DARABONBA_PTR_SET_VALUE(ipsecConfig_, ipsecConfig) };
    inline ModifyVpnAttachmentAttributeResponseBody& setIpsecConfig(ModifyVpnAttachmentAttributeResponseBody::IpsecConfig && ipsecConfig) { DARABONBA_PTR_SET_RVALUE(ipsecConfig_, ipsecConfig) };
    ...
    inline const vector<ModifyVpnAttachmentAttributeResponseBody::TunnelOptionsSpecification> & getTunnelOptionsSpecification() const { DARABONBA_PTR_GET_CONST(tunnelOptionsSpecification_, vector<ModifyVpnAttachmentAttributeResponseBody::TunnelOptionsSpecification>) };
    inline vector<ModifyVpnAttachmentAttributeResponseBody::TunnelOptionsSpecification> getTunnelOptionsSpecification() { DARABONBA_PTR_GET(tunnelOptionsSpecification_, vector<ModifyVpnAttachmentAttributeResponseBody::TunnelOptionsSpecification>) };
    inline ModifyVpnAttachmentAttributeResponseBody& setTunnelOptionsSpecification(const vector<ModifyVpnAttachmentAttributeResponseBody::TunnelOptionsSpecification> & tunnelOptionsSpecification) { DARABONBA_PTR_SET_VALUE(tunnelOptionsSpecification_, tunnelOptionsSpecification) };
    inline ModifyVpnAttachmentAttributeResponseBody& setTunnelOptionsSpecification(vector<ModifyVpnAttachmentAttributeResponseBody::TunnelOptionsSpecification> && tunnelOptionsSpecification) { DARABONBA_PTR_SET_RVALUE(tunnelOptionsSpecification_, tunnelOptionsSpecification) };
    ...
    inline const ModifyVpnAttachmentAttributeResponseBody::VcoHealthCheck & getVcoHealthCheck() const { DARABONBA_PTR_GET_CONST(vcoHealthCheck_, ModifyVpnAttachmentAttributeResponseBody::VcoHealthCheck) };
    inline ModifyVpnAttachmentAttributeResponseBody::VcoHealthCheck getVcoHealthCheck() { DARABONBA_PTR_GET(vcoHealthCheck_, ModifyVpnAttachmentAttributeResponseBody::VcoHealthCheck) };
    inline ModifyVpnAttachmentAttributeResponseBody& setVcoHealthCheck(const ModifyVpnAttachmentAttributeResponseBody::VcoHealthCheck & vcoHealthCheck) { DARABONBA_PTR_SET_VALUE(vcoHealthCheck_, vcoHealthCheck) };
    inline ModifyVpnAttachmentAttributeResponseBody& setVcoHealthCheck(ModifyVpnAttachmentAttributeResponseBody::VcoHealthCheck && vcoHealthCheck) { DARABONBA_PTR_SET_RVALUE(vcoHealthCheck_, vcoHealthCheck) };
    ...
    inline const ModifyVpnAttachmentAttributeResponseBody::VpnBgpConfig & getVpnBgpConfig() const { DARABONBA_PTR_GET_CONST(vpnBgpConfig_, ModifyVpnAttachmentAttributeResponseBody::VpnBgpConfig) };
    inline ModifyVpnAttachmentAttributeResponseBody::VpnBgpConfig getVpnBgpConfig() { DARABONBA_PTR_GET(vpnBgpConfig_, ModifyVpnAttachmentAttributeResponseBody::VpnBgpConfig) };
    inline ModifyVpnAttachmentAttributeResponseBody& setVpnBgpConfig(const ModifyVpnAttachmentAttributeResponseBody::VpnBgpConfig & vpnBgpConfig) { DARABONBA_PTR_SET_VALUE(vpnBgpConfig_, vpnBgpConfig) };
    inline ModifyVpnAttachmentAttributeResponseBody& setVpnBgpConfig(ModifyVpnAttachmentAttributeResponseBody::VpnBgpConfig && vpnBgpConfig) { DARABONBA_PTR_SET_RVALUE(vpnBgpConfig_, vpnBgpConfig) };
  ...
  protected:
    ...
    shared_ptr<ModifyVpnAttachmentAttributeResponseBody::IkeConfig> ikeConfig_ {};
    // The configuration of Phase 2 negotiations.
    // 
    // **IpsecConfig** parameters are returned only for single-tunnel IPsec-VPN connections.
    shared_ptr<ModifyVpnAttachmentAttributeResponseBody::IpsecConfig> ipsecConfig_ {};
    ...
    shared_ptr<vector<ModifyVpnAttachmentAttributeResponseBody::TunnelOptionsSpecification>> tunnelOptionsSpecification_ {};
    ...
    shared_ptr<ModifyVpnAttachmentAttributeResponseBody::VcoHealthCheck> vcoHealthCheck_ {};
    ...
    shared_ptr<ModifyVpnAttachmentAttributeResponseBody::VpnBgpConfig> vpnBgpConfig_ {};
