...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getNatIpIds() const { DARABONBA_PTR_GET_CONST(natIpIds_, vector<string>) };
    inline vector<string> getNatIpIds() { DARABONBA_PTR_GET(natIpIds_, vector<string>) };
    ...
    inline const vector<string> & getNatIpName() const { DARABONBA_PTR_GET_CONST(natIpName_, vector<string>) };
    inline vector<string> getNatIpName() { DARABONBA_PTR_GET(natIpName_, vector<string>) };
