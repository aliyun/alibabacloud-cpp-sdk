...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBgpPeersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBgpPeersResponseBody) };
    inline DescribeBgpPeersResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBgpPeersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBgpPeersResponseBody> body_ {};
  };
