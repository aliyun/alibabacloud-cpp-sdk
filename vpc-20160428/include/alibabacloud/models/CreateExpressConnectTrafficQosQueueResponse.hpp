...
namespace Models
{
  ...
  public:
    ...
    inline const CreateExpressConnectTrafficQosQueueResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateExpressConnectTrafficQosQueueResponseBody) };
    inline CreateExpressConnectTrafficQosQueueResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateExpressConnectTrafficQosQueueResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateExpressConnectTrafficQosQueueResponseBody> body_ {};
  };
