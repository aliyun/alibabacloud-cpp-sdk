...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateNetworkAclEntriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateNetworkAclEntriesResponseBody) };
    inline UpdateNetworkAclEntriesResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateNetworkAclEntriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateNetworkAclEntriesResponseBody> body_ {};
  };
