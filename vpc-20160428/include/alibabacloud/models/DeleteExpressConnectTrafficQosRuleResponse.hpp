...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteExpressConnectTrafficQosRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteExpressConnectTrafficQosRuleResponseBody) };
    inline DeleteExpressConnectTrafficQosRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteExpressConnectTrafficQosRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteExpressConnectTrafficQosRuleResponseBody> body_ {};
  };
