...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->newPriority_ == nullptr && this->nextHop_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->priority_ == nullptr
    ...
    inline int32_t getNewPriority() const { DARABONBA_PTR_GET_DEFAULT(newPriority_, 0) };
