...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeCustomerGatewaysRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<DescribeCustomerGatewaysRequest::Tag>) };
    inline vector<DescribeCustomerGatewaysRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<DescribeCustomerGatewaysRequest::Tag>) };
    inline DescribeCustomerGatewaysRequest& setTag(const vector<DescribeCustomerGatewaysRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline DescribeCustomerGatewaysRequest& setTag(vector<DescribeCustomerGatewaysRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeCustomerGatewaysRequest::Tag>> tag_ {};
  };
