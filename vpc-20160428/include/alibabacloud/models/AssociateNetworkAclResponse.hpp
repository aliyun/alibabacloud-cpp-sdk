...
namespace Models
{
  ...
  public:
    ...
    inline const AssociateNetworkAclResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AssociateNetworkAclResponseBody) };
    inline AssociateNetworkAclResponseBody getBody() { DARABONBA_PTR_GET(body_, AssociateNetworkAclResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AssociateNetworkAclResponseBody> body_ {};
  };
