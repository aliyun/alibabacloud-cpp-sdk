...
#ifndef ALIBABACLOUD_MODELS_MODIFYVPNCONNECTIONATTRIBUTERESPONSEBODYIPSECCONFIG_HPP_
#define ALIBABACLOUD_MODELS_MODIFYVPNCONNECTIONATTRIBUTERESPONSEBODYIPSECCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyVpnConnectionAttributeResponseBodyIpsecConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyVpnConnectionAttributeResponseBodyIpsecConfig& obj) { 
    ...
    ModifyVpnConnectionAttributeResponseBodyIpsecConfig() = default ;
    ModifyVpnConnectionAttributeResponseBodyIpsecConfig(const ModifyVpnConnectionAttributeResponseBodyIpsecConfig &) = default ;
    ModifyVpnConnectionAttributeResponseBodyIpsecConfig(ModifyVpnConnectionAttributeResponseBodyIpsecConfig &&) = default ;
    ModifyVpnConnectionAttributeResponseBodyIpsecConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyVpnConnectionAttributeResponseBodyIpsecConfig() = default ;
    ModifyVpnConnectionAttributeResponseBodyIpsecConfig& operator=(const ModifyVpnConnectionAttributeResponseBodyIpsecConfig &) = default ;
    ModifyVpnConnectionAttributeResponseBodyIpsecConfig& operator=(ModifyVpnConnectionAttributeResponseBodyIpsecConfig &&) = default ;
    ...
    inline ModifyVpnConnectionAttributeResponseBodyIpsecConfig& setIpsecAuthAlg(string ipsecAuthAlg) { DARABONBA_PTR_SET_VALUE(ipsecAuthAlg_, ipsecAuthAlg) };
    ...
    inline ModifyVpnConnectionAttributeResponseBodyIpsecConfig& setIpsecEncAlg(string ipsecEncAlg) { DARABONBA_PTR_SET_VALUE(ipsecEncAlg_, ipsecEncAlg) };
    ...
    inline ModifyVpnConnectionAttributeResponseBodyIpsecConfig& setIpsecLifetime(int64_t ipsecLifetime) { DARABONBA_PTR_SET_VALUE(ipsecLifetime_, ipsecLifetime) };
    ...
    inline ModifyVpnConnectionAttributeResponseBodyIpsecConfig& setIpsecPfs(string ipsecPfs) { DARABONBA_PTR_SET_VALUE(ipsecPfs_, ipsecPfs) };
