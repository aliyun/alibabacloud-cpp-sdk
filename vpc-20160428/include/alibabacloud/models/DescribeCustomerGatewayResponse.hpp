...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCustomerGatewayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCustomerGatewayResponseBody) };
    inline DescribeCustomerGatewayResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCustomerGatewayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCustomerGatewayResponseBody> body_ {};
  };
