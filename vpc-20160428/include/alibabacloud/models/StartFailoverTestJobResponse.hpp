...
namespace Models
{
  ...
  public:
    ...
    inline const StartFailoverTestJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartFailoverTestJobResponseBody) };
    inline StartFailoverTestJobResponseBody getBody() { DARABONBA_PTR_GET(body_, StartFailoverTestJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartFailoverTestJobResponseBody> body_ {};
  };
