...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVpnPbrRouteEntryPriorityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyVpnPbrRouteEntryPriorityResponseBody) };
    inline ModifyVpnPbrRouteEntryPriorityResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyVpnPbrRouteEntryPriorityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyVpnPbrRouteEntryPriorityResponseBody> body_ {};
  };
