...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->destinationCidrBlock_ == nullptr
        && this->dryRun_ == nullptr && this->nextHopId_ == nullptr && this->nextHopList_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr
        && this->regionId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->routeEntryId_ == nullptr && this->routeTableId_ == nullptr; };
    ...
    inline const vector<DeleteRouteEntryRequest::NextHopList> & getNextHopList() const { DARABONBA_PTR_GET_CONST(nextHopList_, vector<DeleteRouteEntryRequest::NextHopList>) };
    inline vector<DeleteRouteEntryRequest::NextHopList> getNextHopList() { DARABONBA_PTR_GET(nextHopList_, vector<DeleteRouteEntryRequest::NextHopList>) };
    inline DeleteRouteEntryRequest& setNextHopList(const vector<DeleteRouteEntryRequest::NextHopList> & nextHopList) { DARABONBA_PTR_SET_VALUE(nextHopList_, nextHopList) };
    inline DeleteRouteEntryRequest& setNextHopList(vector<DeleteRouteEntryRequest::NextHopList> && nextHopList) { DARABONBA_PTR_SET_RVALUE(nextHopList_, nextHopList) };
