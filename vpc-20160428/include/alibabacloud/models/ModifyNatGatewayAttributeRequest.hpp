...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && return this->eipBindMode_ == nullptr && return this->enableSessionLog_ == nullptr && return this->icmpReplyEnabled_ == nullptr && return this->logDelivery_ == nullptr && return this->name_ == nullptr
    ...
    inline const ModifyNatGatewayAttributeRequestLogDelivery & logDelivery() const { DARABONBA_PTR_GET_CONST(logDelivery_, ModifyNatGatewayAttributeRequestLogDelivery) };
    inline ModifyNatGatewayAttributeRequestLogDelivery logDelivery() { DARABONBA_PTR_GET(logDelivery_, ModifyNatGatewayAttributeRequestLogDelivery) };
    inline ModifyNatGatewayAttributeRequest& setLogDelivery(const ModifyNatGatewayAttributeRequestLogDelivery & logDelivery) { DARABONBA_PTR_SET_VALUE(logDelivery_, logDelivery) };
    inline ModifyNatGatewayAttributeRequest& setLogDelivery(ModifyNatGatewayAttributeRequestLogDelivery && logDelivery) { DARABONBA_PTR_SET_RVALUE(logDelivery_, logDelivery) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyNatGatewayAttributeRequestLogDelivery> logDelivery_ = nullptr;
