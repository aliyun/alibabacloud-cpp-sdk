...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePublicIpAddressPoolAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdatePublicIpAddressPoolAttributeResponseBody) };
    inline UpdatePublicIpAddressPoolAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdatePublicIpAddressPoolAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdatePublicIpAddressPoolAttributeResponseBody> body_ {};
  };
