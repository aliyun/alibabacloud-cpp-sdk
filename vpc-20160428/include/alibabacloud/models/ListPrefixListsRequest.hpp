...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->maxResults_ == nullptr
        && this->nextToken_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->prefixListIds_ == nullptr && this->prefixListName_ == nullptr
    ...
    inline const vector<string> & getPrefixListIds() const { DARABONBA_PTR_GET_CONST(prefixListIds_, vector<string>) };
    inline vector<string> getPrefixListIds() { DARABONBA_PTR_GET(prefixListIds_, vector<string>) };
    ...
    inline const vector<ListPrefixListsRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<ListPrefixListsRequest::Tags>) };
    inline vector<ListPrefixListsRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<ListPrefixListsRequest::Tags>) };
    inline ListPrefixListsRequest& setTags(const vector<ListPrefixListsRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline ListPrefixListsRequest& setTags(vector<ListPrefixListsRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> prefixListIds_ {};
    ...
    // The tags.
    shared_ptr<vector<ListPrefixListsRequest::Tags>> tags_ {};
  };
