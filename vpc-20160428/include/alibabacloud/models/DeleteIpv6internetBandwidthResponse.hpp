...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteIpv6InternetBandwidthResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteIpv6InternetBandwidthResponseBody) };
    inline DeleteIpv6InternetBandwidthResponseBody body() { DARABONBA_PTR_GET(body_, DeleteIpv6InternetBandwidthResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteIpv6InternetBandwidthResponseBody> body_ = nullptr;
  };
