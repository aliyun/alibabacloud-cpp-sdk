...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVbrHaResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeVbrHaResponseBody) };
    inline DescribeVbrHaResponseBody body() { DARABONBA_PTR_GET(body_, DescribeVbrHaResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVbrHaResponseBody> body_ = nullptr;
  };
