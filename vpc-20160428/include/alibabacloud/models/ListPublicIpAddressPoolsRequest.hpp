...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dryRun_ == nullptr
        && this->isp_ == nullptr && this->maxResults_ == nullptr && this->name_ == nullptr && this->nextToken_ == nullptr && this->ownerAccount_ == nullptr
        && this->ownerId_ == nullptr && this->publicIpAddressPoolIds_ == nullptr && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr && this->resourceOwnerAccount_ == nullptr
        && this->resourceOwnerId_ == nullptr && this->securityProtectionEnabled_ == nullptr && this->status_ == nullptr && this->tags_ == nullptr; };
    ...
    inline const vector<string> & getPublicIpAddressPoolIds() const { DARABONBA_PTR_GET_CONST(publicIpAddressPoolIds_, vector<string>) };
    inline vector<string> getPublicIpAddressPoolIds() { DARABONBA_PTR_GET(publicIpAddressPoolIds_, vector<string>) };
    ...
    inline const vector<ListPublicIpAddressPoolsRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<ListPublicIpAddressPoolsRequest::Tags>) };
    inline vector<ListPublicIpAddressPoolsRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<ListPublicIpAddressPoolsRequest::Tags>) };
    inline ListPublicIpAddressPoolsRequest& setTags(const vector<ListPublicIpAddressPoolsRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline ListPublicIpAddressPoolsRequest& setTags(vector<ListPublicIpAddressPoolsRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> publicIpAddressPoolIds_ {};
    ...
    shared_ptr<vector<ListPublicIpAddressPoolsRequest::Tags>> tags_ {};
  };
