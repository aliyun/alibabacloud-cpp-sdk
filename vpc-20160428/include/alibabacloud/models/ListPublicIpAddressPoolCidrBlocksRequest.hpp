...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cidrBlock_ == nullptr
        && return this->dryRun_ == nullptr && return this->maxResults_ == nullptr && return this->nextToken_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr
