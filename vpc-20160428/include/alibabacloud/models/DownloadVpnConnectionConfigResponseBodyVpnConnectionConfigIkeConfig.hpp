...
#ifndef ALIBABACLOUD_MODELS_DOWNLOADVPNCONNECTIONCONFIGRESPONSEBODYVPNCONNECTIONCONFIGIKECONFIG_HPP_
#define ALIBABACLOUD_MODELS_DOWNLOADVPNCONNECTIONCONFIGRESPONSEBODYVPNCONNECTIONCONFIGIKECONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig& obj) { 
    ...
    DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig() = default ;
    DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig(const DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig &) = default ;
    DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig(DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig &&) = default ;
    DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig() = default ;
    DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig& operator=(const DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig &) = default ;
    DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig& operator=(DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig &&) = default ;
    ...
    inline DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig& setIkeAuthAlg(string ikeAuthAlg) { DARABONBA_PTR_SET_VALUE(ikeAuthAlg_, ikeAuthAlg) };
    ...
    inline DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig& setIkeEncAlg(string ikeEncAlg) { DARABONBA_PTR_SET_VALUE(ikeEncAlg_, ikeEncAlg) };
    ...
    inline DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig& setIkeLifetime(int64_t ikeLifetime) { DARABONBA_PTR_SET_VALUE(ikeLifetime_, ikeLifetime) };
    ...
    inline DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig& setIkeMode(string ikeMode) { DARABONBA_PTR_SET_VALUE(ikeMode_, ikeMode) };
    ...
    inline DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig& setIkePfs(string ikePfs) { DARABONBA_PTR_SET_VALUE(ikePfs_, ikePfs) };
    ...
    inline DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig& setIkeVersion(string ikeVersion) { DARABONBA_PTR_SET_VALUE(ikeVersion_, ikeVersion) };
    ...
    inline DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig& setLocalId(string localId) { DARABONBA_PTR_SET_VALUE(localId_, localId) };
    ...
    inline DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig& setPsk(string psk) { DARABONBA_PTR_SET_VALUE(psk_, psk) };
    ...
    inline DownloadVpnConnectionConfigResponseBodyVpnConnectionConfigIkeConfig& setRemoteId(string remoteId) { DARABONBA_PTR_SET_VALUE(remoteId_, remoteId) };
