...
namespace Models
{
  ...
  public:
    ...
    inline const CreateIPv6TranslatorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateIPv6TranslatorResponseBody) };
    inline CreateIPv6TranslatorResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateIPv6TranslatorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateIPv6TranslatorResponseBody> body_ {};
  };
