...
namespace Models
{
  ...
  public:
    ...
    inline bool getDeleteHealthCheckIp() const { DARABONBA_PTR_GET_DEFAULT(deleteHealthCheckIp_, false) };
    ...
    inline int64_t getOppositeInterfaceOwnerId() const { DARABONBA_PTR_GET_DEFAULT(oppositeInterfaceOwnerId_, 0L) };
  ...
  protected:
    ...
    // *   **true**
    // *   **false** (default)
    shared_ptr<bool> deleteHealthCheckIp_ {};
