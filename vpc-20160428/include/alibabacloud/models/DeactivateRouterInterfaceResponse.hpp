...
namespace Models
{
  ...
  public:
    ...
    inline const DeactivateRouterInterfaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeactivateRouterInterfaceResponseBody) };
    inline DeactivateRouterInterfaceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeactivateRouterInterfaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeactivateRouterInterfaceResponseBody> body_ {};
  };
