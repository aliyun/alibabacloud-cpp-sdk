...
namespace Models
{
  ...
  public:
    ...
    inline const AllocateIpv6InternetBandwidthResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AllocateIpv6InternetBandwidthResponseBody) };
    inline AllocateIpv6InternetBandwidthResponseBody getBody() { DARABONBA_PTR_GET(body_, AllocateIpv6InternetBandwidthResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AllocateIpv6InternetBandwidthResponseBody> body_ {};
  };
