...
#ifndef ALIBABACLOUD_MODELS_CREATEVPNCONNECTIONREQUESTTUNNELOPTIONSSPECIFICATIONTUNNELIKECONFIG_HPP_
#define ALIBABACLOUD_MODELS_CREATEVPNCONNECTIONREQUESTTUNNELOPTIONSSPECIFICATIONTUNNELIKECONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig& obj) { 
    ...
    CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig() = default ;
    CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig(const CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig &) = default ;
    CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig(CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig &&) = default ;
    CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig() = default ;
    CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig& operator=(const CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig &) = default ;
    CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig& operator=(CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig &&) = default ;
    ...
    inline CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig& setIkeAuthAlg(string ikeAuthAlg) { DARABONBA_PTR_SET_VALUE(ikeAuthAlg_, ikeAuthAlg) };
    ...
    inline CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig& setIkeEncAlg(string ikeEncAlg) { DARABONBA_PTR_SET_VALUE(ikeEncAlg_, ikeEncAlg) };
    ...
    inline CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig& setIkeLifetime(int64_t ikeLifetime) { DARABONBA_PTR_SET_VALUE(ikeLifetime_, ikeLifetime) };
    ...
    inline CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig& setIkeMode(string ikeMode) { DARABONBA_PTR_SET_VALUE(ikeMode_, ikeMode) };
    ...
    inline CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig& setIkePfs(string ikePfs) { DARABONBA_PTR_SET_VALUE(ikePfs_, ikePfs) };
    ...
    inline CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig& setIkeVersion(string ikeVersion) { DARABONBA_PTR_SET_VALUE(ikeVersion_, ikeVersion) };
    ...
    inline CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig& setLocalId(string localId) { DARABONBA_PTR_SET_VALUE(localId_, localId) };
    ...
    inline CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig& setPsk(string psk) { DARABONBA_PTR_SET_VALUE(psk_, psk) };
    ...
    inline CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig& setRemoteId(string remoteId) { DARABONBA_PTR_SET_VALUE(remoteId_, remoteId) };
