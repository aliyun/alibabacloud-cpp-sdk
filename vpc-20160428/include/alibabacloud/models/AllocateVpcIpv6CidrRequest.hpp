...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addressPoolType_ == nullptr
        && return this->clientToken_ == nullptr && return this->ipv6CidrBlock_ == nullptr && return this->ipv6Isp_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr
