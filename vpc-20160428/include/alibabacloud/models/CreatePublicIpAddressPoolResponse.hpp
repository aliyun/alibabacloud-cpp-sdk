...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePublicIpAddressPoolResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePublicIpAddressPoolResponseBody) };
    inline CreatePublicIpAddressPoolResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePublicIpAddressPoolResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePublicIpAddressPoolResponseBody> body_ {};
  };
