...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBgpGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBgpGroupResponseBody) };
    inline CreateBgpGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBgpGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBgpGroupResponseBody> body_ {};
  };
