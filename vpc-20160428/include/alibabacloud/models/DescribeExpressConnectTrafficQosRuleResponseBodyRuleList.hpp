...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEEXPRESSCONNECTTRAFFICQOSRULERESPONSEBODYRULELIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEEXPRESSCONNECTTRAFFICQOSRULERESPONSEBODYRULELIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& obj) { 
    ...
    DescribeExpressConnectTrafficQosRuleResponseBodyRuleList() = default ;
    DescribeExpressConnectTrafficQosRuleResponseBodyRuleList(const DescribeExpressConnectTrafficQosRuleResponseBodyRuleList &) = default ;
    DescribeExpressConnectTrafficQosRuleResponseBodyRuleList(DescribeExpressConnectTrafficQosRuleResponseBodyRuleList &&) = default ;
    DescribeExpressConnectTrafficQosRuleResponseBodyRuleList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeExpressConnectTrafficQosRuleResponseBodyRuleList() = default ;
    DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& operator=(const DescribeExpressConnectTrafficQosRuleResponseBodyRuleList &) = default ;
    DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& operator=(DescribeExpressConnectTrafficQosRuleResponseBodyRuleList &&) = default ;
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setDstCidr(string dstCidr) { DARABONBA_PTR_SET_VALUE(dstCidr_, dstCidr) };
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setDstIPv6Cidr(string dstIPv6Cidr) { DARABONBA_PTR_SET_VALUE(dstIPv6Cidr_, dstIPv6Cidr) };
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setDstPortRange(string dstPortRange) { DARABONBA_PTR_SET_VALUE(dstPortRange_, dstPortRange) };
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setMatchDscp(int32_t matchDscp) { DARABONBA_PTR_SET_VALUE(matchDscp_, matchDscp) };
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setProtocol(string protocol) { DARABONBA_PTR_SET_VALUE(protocol_, protocol) };
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setQosId(string qosId) { DARABONBA_PTR_SET_VALUE(qosId_, qosId) };
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setQueueId(string queueId) { DARABONBA_PTR_SET_VALUE(queueId_, queueId) };
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setRemarkingDscp(int32_t remarkingDscp) { DARABONBA_PTR_SET_VALUE(remarkingDscp_, remarkingDscp) };
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setRuleDescription(string ruleDescription) { DARABONBA_PTR_SET_VALUE(ruleDescription_, ruleDescription) };
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setRuleId(string ruleId) { DARABONBA_PTR_SET_VALUE(ruleId_, ruleId) };
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setRuleName(string ruleName) { DARABONBA_PTR_SET_VALUE(ruleName_, ruleName) };
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setSrcCidr(string srcCidr) { DARABONBA_PTR_SET_VALUE(srcCidr_, srcCidr) };
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setSrcIPv6Cidr(string srcIPv6Cidr) { DARABONBA_PTR_SET_VALUE(srcIPv6Cidr_, srcIPv6Cidr) };
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setSrcPortRange(string srcPortRange) { DARABONBA_PTR_SET_VALUE(srcPortRange_, srcPortRange) };
    ...
    inline DescribeExpressConnectTrafficQosRuleResponseBodyRuleList& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
