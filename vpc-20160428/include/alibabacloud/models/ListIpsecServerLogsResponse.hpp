...
namespace Models
{
  ...
  public:
    ...
    inline const ListIpsecServerLogsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListIpsecServerLogsResponseBody) };
    inline ListIpsecServerLogsResponseBody body() { DARABONBA_PTR_GET(body_, ListIpsecServerLogsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListIpsecServerLogsResponseBody> body_ = nullptr;
  };
