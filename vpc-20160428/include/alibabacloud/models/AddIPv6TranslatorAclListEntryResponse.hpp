...
namespace Models
{
  ...
  public:
    ...
    inline const AddIPv6TranslatorAclListEntryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddIPv6TranslatorAclListEntryResponseBody) };
    inline AddIPv6TranslatorAclListEntryResponseBody getBody() { DARABONBA_PTR_GET(body_, AddIPv6TranslatorAclListEntryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddIPv6TranslatorAclListEntryResponseBody> body_ {};
  };
