...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ApplyPhysicalConnectionLOARequest::PMInfo> & getPMInfo() const { DARABONBA_PTR_GET_CONST(PMInfo_, vector<ApplyPhysicalConnectionLOARequest::PMInfo>) };
    inline vector<ApplyPhysicalConnectionLOARequest::PMInfo> getPMInfo() { DARABONBA_PTR_GET(PMInfo_, vector<ApplyPhysicalConnectionLOARequest::PMInfo>) };
    inline ApplyPhysicalConnectionLOARequest& setPMInfo(const vector<ApplyPhysicalConnectionLOARequest::PMInfo> & pMInfo) { DARABONBA_PTR_SET_VALUE(PMInfo_, pMInfo) };
    inline ApplyPhysicalConnectionLOARequest& setPMInfo(vector<ApplyPhysicalConnectionLOARequest::PMInfo> && pMInfo) { DARABONBA_PTR_SET_RVALUE(PMInfo_, pMInfo) };
  ...
  protected:
    ...
    shared_ptr<vector<ApplyPhysicalConnectionLOARequest::PMInfo>> PMInfo_ {};
