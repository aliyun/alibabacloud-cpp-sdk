...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEVPNCONNECTIONSRESPONSEBODYVPNCONNECTIONSVPNCONNECTIONIKECONFIG_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEVPNCONNECTIONSRESPONSEBODYVPNCONNECTIONSVPNCONNECTIONIKECONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig& obj) { 
    ...
    DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig() = default ;
    DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig(const DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig &) = default ;
    DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig(DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig &&) = default ;
    DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig() = default ;
    DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig& operator=(const DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig &) = default ;
    DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig& operator=(DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig &&) = default ;
    ...
    inline DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig& setIkeAuthAlg(string ikeAuthAlg) { DARABONBA_PTR_SET_VALUE(ikeAuthAlg_, ikeAuthAlg) };
    ...
    inline DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig& setIkeEncAlg(string ikeEncAlg) { DARABONBA_PTR_SET_VALUE(ikeEncAlg_, ikeEncAlg) };
    ...
    inline DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig& setIkeLifetime(int64_t ikeLifetime) { DARABONBA_PTR_SET_VALUE(ikeLifetime_, ikeLifetime) };
    ...
    inline DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig& setIkeMode(string ikeMode) { DARABONBA_PTR_SET_VALUE(ikeMode_, ikeMode) };
    ...
    inline DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig& setIkePfs(string ikePfs) { DARABONBA_PTR_SET_VALUE(ikePfs_, ikePfs) };
    ...
    inline DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig& setIkeVersion(string ikeVersion) { DARABONBA_PTR_SET_VALUE(ikeVersion_, ikeVersion) };
    ...
    inline DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig& setLocalId(string localId) { DARABONBA_PTR_SET_VALUE(localId_, localId) };
    ...
    inline DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig& setPsk(string psk) { DARABONBA_PTR_SET_VALUE(psk_, psk) };
    ...
    inline DescribeVpnConnectionsResponseBodyVpnConnectionsVpnConnectionIkeConfig& setRemoteId(string remoteId) { DARABONBA_PTR_SET_VALUE(remoteId_, remoteId) };
