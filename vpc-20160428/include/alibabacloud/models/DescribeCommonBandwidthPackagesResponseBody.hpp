...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->commonBandwidthPackages_ != nullptr
    ...
    inline const DescribeCommonBandwidthPackagesResponseBodyCommonBandwidthPackages & commonBandwidthPackages() const { DARABONBA_PTR_GET_CONST(commonBandwidthPackages_, DescribeCommonBandwidthPackagesResponseBodyCommonBandwidthPackages) };
    inline DescribeCommonBandwidthPackagesResponseBodyCommonBandwidthPackages commonBandwidthPackages() { DARABONBA_PTR_GET(commonBandwidthPackages_, DescribeCommonBandwidthPackagesResponseBodyCommonBandwidthPackages) };
    inline DescribeCommonBandwidthPackagesResponseBody& setCommonBandwidthPackages(const DescribeCommonBandwidthPackagesResponseBodyCommonBandwidthPackages & commonBandwidthPackages) { DARABONBA_PTR_SET_VALUE(commonBandwidthPackages_, commonBandwidthPackages) };
    inline DescribeCommonBandwidthPackagesResponseBody& setCommonBandwidthPackages(DescribeCommonBandwidthPackagesResponseBodyCommonBandwidthPackages && commonBandwidthPackages) { DARABONBA_PTR_SET_RVALUE(commonBandwidthPackages_, commonBandwidthPackages) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCommonBandwidthPackagesResponseBodyCommonBandwidthPackages> commonBandwidthPackages_ = nullptr;
    // The page number.
