...
namespace Models
{
  ...
  public:
    ...
    inline const ListTagResourcesForExpressConnectResponseBody::TagResources & getTagResources() const { DARABONBA_PTR_GET_CONST(tagResources_, ListTagResourcesForExpressConnectResponseBody::TagResources) };
    inline ListTagResourcesForExpressConnectResponseBody::TagResources getTagResources() { DARABONBA_PTR_GET(tagResources_, ListTagResourcesForExpressConnectResponseBody::TagResources) };
    inline ListTagResourcesForExpressConnectResponseBody& setTagResources(const ListTagResourcesForExpressConnectResponseBody::TagResources & tagResources) { DARABONBA_PTR_SET_VALUE(tagResources_, tagResources) };
    inline ListTagResourcesForExpressConnectResponseBody& setTagResources(ListTagResourcesForExpressConnectResponseBody::TagResources && tagResources) { DARABONBA_PTR_SET_RVALUE(tagResources_, tagResources) };
