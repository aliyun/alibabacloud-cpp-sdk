...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTrafficMirrorSessionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTrafficMirrorSessionResponseBody) };
    inline DeleteTrafficMirrorSessionResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTrafficMirrorSessionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTrafficMirrorSessionResponseBody> body_ {};
  };
