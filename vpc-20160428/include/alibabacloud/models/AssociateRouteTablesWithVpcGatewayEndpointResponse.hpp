...
namespace Models
{
  ...
  public:
    ...
    inline const AssociateRouteTablesWithVpcGatewayEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AssociateRouteTablesWithVpcGatewayEndpointResponseBody) };
    inline AssociateRouteTablesWithVpcGatewayEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, AssociateRouteTablesWithVpcGatewayEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AssociateRouteTablesWithVpcGatewayEndpointResponseBody> body_ {};
  };
