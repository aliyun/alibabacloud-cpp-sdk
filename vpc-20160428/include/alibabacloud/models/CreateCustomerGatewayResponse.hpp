...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCustomerGatewayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCustomerGatewayResponseBody) };
    inline CreateCustomerGatewayResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCustomerGatewayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCustomerGatewayResponseBody> body_ {};
  };
