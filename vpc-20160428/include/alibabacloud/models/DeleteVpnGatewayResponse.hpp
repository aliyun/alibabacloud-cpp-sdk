...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVpnGatewayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteVpnGatewayResponseBody) };
    inline DeleteVpnGatewayResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteVpnGatewayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteVpnGatewayResponseBody> body_ {};
  };
