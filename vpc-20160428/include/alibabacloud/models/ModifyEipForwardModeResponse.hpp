...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyEipForwardModeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyEipForwardModeResponseBody) };
    inline ModifyEipForwardModeResponseBody body() { DARABONBA_PTR_GET(body_, ModifyEipForwardModeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyEipForwardModeResponseBody> body_ = nullptr;
  };
