...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRouteEntriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteRouteEntriesResponseBody) };
    inline DeleteRouteEntriesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteRouteEntriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteRouteEntriesResponseBody> body_ {};
  };
