...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allocateIpv4Addr_ == nullptr
        && return this->allocateIpv6Addr_ == nullptr && return this->businessStatus_ == nullptr && return this->ipv6TranslatorId_ == nullptr && return this->name_ == nullptr && return this->ownerAccount_ == nullptr
        && return this->ownerId_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->payType_ == nullptr && return this->regionId_ == nullptr
        && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->spec_ == nullptr && return this->status_ == nullptr; };
