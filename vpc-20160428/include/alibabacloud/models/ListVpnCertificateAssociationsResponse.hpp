...
namespace Models
{
  ...
  public:
    ...
    inline const ListVpnCertificateAssociationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListVpnCertificateAssociationsResponseBody) };
    inline ListVpnCertificateAssociationsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListVpnCertificateAssociationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListVpnCertificateAssociationsResponseBody> body_ {};
  };
