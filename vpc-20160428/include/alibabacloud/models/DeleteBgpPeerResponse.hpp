...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteBgpPeerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteBgpPeerResponseBody) };
    inline DeleteBgpPeerResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteBgpPeerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteBgpPeerResponseBody> body_ {};
  };
