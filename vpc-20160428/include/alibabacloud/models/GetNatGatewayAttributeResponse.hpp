...
namespace Models
{
  ...
  public:
    ...
    inline const GetNatGatewayAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetNatGatewayAttributeResponseBody) };
    inline GetNatGatewayAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetNatGatewayAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetNatGatewayAttributeResponseBody> body_ {};
  };
