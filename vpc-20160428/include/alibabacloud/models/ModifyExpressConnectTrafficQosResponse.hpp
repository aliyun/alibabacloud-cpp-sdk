...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyExpressConnectTrafficQosResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyExpressConnectTrafficQosResponseBody) };
    inline ModifyExpressConnectTrafficQosResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyExpressConnectTrafficQosResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyExpressConnectTrafficQosResponseBody> body_ {};
  };
