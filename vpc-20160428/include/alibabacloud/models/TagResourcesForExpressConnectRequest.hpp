...
namespace Models
{
  ...
  public:
    ...
    inline const vector<TagResourcesForExpressConnectRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<TagResourcesForExpressConnectRequest::Tag>) };
    inline vector<TagResourcesForExpressConnectRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<TagResourcesForExpressConnectRequest::Tag>) };
    inline TagResourcesForExpressConnectRequest& setTag(const vector<TagResourcesForExpressConnectRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline TagResourcesForExpressConnectRequest& setTag(vector<TagResourcesForExpressConnectRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<TagResourcesForExpressConnectRequest::Tag>> tag_ {};
  };
