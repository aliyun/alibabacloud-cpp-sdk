...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline NetworkAclAttribute& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
      ...
      inline const NetworkAclAttribute::Tags & getTags() const { DARABONBA_PTR_GET_CONST(tags_, NetworkAclAttribute::Tags) };
      inline NetworkAclAttribute::Tags getTags() { DARABONBA_PTR_GET(tags_, NetworkAclAttribute::Tags) };
      inline NetworkAclAttribute& setTags(const NetworkAclAttribute::Tags & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
      inline NetworkAclAttribute& setTags(NetworkAclAttribute::Tags && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
    ...
    inline const DescribeNetworkAclAttributesResponseBody::NetworkAclAttribute & getNetworkAclAttribute() const { DARABONBA_PTR_GET_CONST(networkAclAttribute_, DescribeNetworkAclAttributesResponseBody::NetworkAclAttribute) };
    inline DescribeNetworkAclAttributesResponseBody::NetworkAclAttribute getNetworkAclAttribute() { DARABONBA_PTR_GET(networkAclAttribute_, DescribeNetworkAclAttributesResponseBody::NetworkAclAttribute) };
    inline DescribeNetworkAclAttributesResponseBody& setNetworkAclAttribute(const DescribeNetworkAclAttributesResponseBody::NetworkAclAttribute & networkAclAttribute) { DARABONBA_PTR_SET_VALUE(networkAclAttribute_, networkAclAttribute) };
    inline DescribeNetworkAclAttributesResponseBody& setNetworkAclAttribute(DescribeNetworkAclAttributesResponseBody::NetworkAclAttribute && networkAclAttribute) { DARABONBA_PTR_SET_RVALUE(networkAclAttribute_, networkAclAttribute) };
