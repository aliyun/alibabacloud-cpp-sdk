...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTrafficMirrorSessionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTrafficMirrorSessionResponseBody) };
    inline CreateTrafficMirrorSessionResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTrafficMirrorSessionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTrafficMirrorSessionResponseBody> body_ {};
  };
