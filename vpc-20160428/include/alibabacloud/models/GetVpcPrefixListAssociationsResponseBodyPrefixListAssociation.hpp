...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cidrList_ == nullptr
        && return this->ownerId_ == nullptr && return this->prefixListId_ == nullptr && return this->reason_ == nullptr && return this->regionId_ == nullptr && return this->resourceId_ == nullptr
        && return this->resourceType_ == nullptr && return this->resourceUid_ == nullptr && return this->status_ == nullptr; };
