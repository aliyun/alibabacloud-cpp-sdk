...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRouteTableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteRouteTableResponseBody) };
    inline DeleteRouteTableResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteRouteTableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteRouteTableResponseBody> body_ {};
  };
