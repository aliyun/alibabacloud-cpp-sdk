...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEVPNCONNECTIONRESPONSEBODYIPSECCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEVPNCONNECTIONRESPONSEBODYIPSECCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeVpnConnectionResponseBodyIpsecConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeVpnConnectionResponseBodyIpsecConfig& obj) { 
    ...
    DescribeVpnConnectionResponseBodyIpsecConfig() = default ;
    DescribeVpnConnectionResponseBodyIpsecConfig(const DescribeVpnConnectionResponseBodyIpsecConfig &) = default ;
    DescribeVpnConnectionResponseBodyIpsecConfig(DescribeVpnConnectionResponseBodyIpsecConfig &&) = default ;
    DescribeVpnConnectionResponseBodyIpsecConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeVpnConnectionResponseBodyIpsecConfig() = default ;
    DescribeVpnConnectionResponseBodyIpsecConfig& operator=(const DescribeVpnConnectionResponseBodyIpsecConfig &) = default ;
    DescribeVpnConnectionResponseBodyIpsecConfig& operator=(DescribeVpnConnectionResponseBodyIpsecConfig &&) = default ;
    ...
    inline DescribeVpnConnectionResponseBodyIpsecConfig& setIpsecAuthAlg(string ipsecAuthAlg) { DARABONBA_PTR_SET_VALUE(ipsecAuthAlg_, ipsecAuthAlg) };
    ...
    inline DescribeVpnConnectionResponseBodyIpsecConfig& setIpsecEncAlg(string ipsecEncAlg) { DARABONBA_PTR_SET_VALUE(ipsecEncAlg_, ipsecEncAlg) };
    ...
    inline DescribeVpnConnectionResponseBodyIpsecConfig& setIpsecLifetime(int64_t ipsecLifetime) { DARABONBA_PTR_SET_VALUE(ipsecLifetime_, ipsecLifetime) };
    ...
    inline DescribeVpnConnectionResponseBodyIpsecConfig& setIpsecPfs(string ipsecPfs) { DARABONBA_PTR_SET_VALUE(ipsecPfs_, ipsecPfs) };
