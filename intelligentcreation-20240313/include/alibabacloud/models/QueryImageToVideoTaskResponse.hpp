...
namespace Models
{
  ...
  public:
    ...
    inline const QueryImageToVideoTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, QueryImageToVideoTaskResponseBody) };
    inline QueryImageToVideoTaskResponseBody body() { DARABONBA_PTR_GET(body_, QueryImageToVideoTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<QueryImageToVideoTaskResponseBody> body_ = nullptr;
  };
