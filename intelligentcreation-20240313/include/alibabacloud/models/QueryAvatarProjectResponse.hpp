...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAvatarProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryAvatarProjectResponseBody) };
    inline QueryAvatarProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryAvatarProjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryAvatarProjectResponseBody> body_ {};
  };
