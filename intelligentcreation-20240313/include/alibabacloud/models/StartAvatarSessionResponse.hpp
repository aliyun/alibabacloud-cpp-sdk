...
namespace Models
{
  ...
  public:
    ...
    inline const StartAvatarSessionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartAvatarSessionResponseBody) };
    inline StartAvatarSessionResponseBody getBody() { DARABONBA_PTR_GET(body_, StartAvatarSessionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartAvatarSessionResponseBody> body_ {};
  };
