...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->gmtCreate_ == nullptr
        && this->gmtModified_ == nullptr && this->illustrationIds_ == nullptr && this->illustrationTaskId_ == nullptr && this->taskStatus_ == nullptr && this->textId_ == nullptr; };
    ...
    inline const vector<int64_t> & getIllustrationIds() const { DARABONBA_PTR_GET_CONST(illustrationIds_, vector<int64_t>) };
    inline vector<int64_t> getIllustrationIds() { DARABONBA_PTR_GET(illustrationIds_, vector<int64_t>) };
    ...
    inline int64_t getIllustrationTaskId() const { DARABONBA_PTR_GET_DEFAULT(illustrationTaskId_, 0L) };
  ...
  protected:
    ...
    shared_ptr<vector<int64_t>> illustrationIds_ {};
    shared_ptr<int64_t> illustrationTaskId_ {};
