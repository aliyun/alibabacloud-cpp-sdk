...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAICoachTaskSessionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAICoachTaskSessionResponseBody) };
    inline CreateAICoachTaskSessionResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAICoachTaskSessionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAICoachTaskSessionResponseBody> body_ {};
  };
