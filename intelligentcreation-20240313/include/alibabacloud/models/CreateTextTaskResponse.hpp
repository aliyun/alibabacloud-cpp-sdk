...
namespace Models
{
  ...
  public:
    ...
    inline const TextTaskResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, TextTaskResult) };
    inline TextTaskResult getBody() { DARABONBA_PTR_GET(body_, TextTaskResult) };
  ...
  protected:
    ...
    shared_ptr<TextTaskResult> body_ {};
  };
