...
namespace Models
{
  ...
  public:
    ...
    inline const CreateIndividuationTextTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateIndividuationTextTaskResponseBody) };
    inline CreateIndividuationTextTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateIndividuationTextTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateIndividuationTextTaskResponseBody> body_ {};
  };
