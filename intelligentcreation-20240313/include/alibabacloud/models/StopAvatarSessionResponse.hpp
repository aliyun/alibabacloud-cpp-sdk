...
namespace Models
{
  ...
  public:
    ...
    inline const StopAvatarSessionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, StopAvatarSessionResponseBody) };
    inline StopAvatarSessionResponseBody body() { DARABONBA_PTR_GET(body_, StopAvatarSessionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<StopAvatarSessionResponseBody> body_ = nullptr;
  };
