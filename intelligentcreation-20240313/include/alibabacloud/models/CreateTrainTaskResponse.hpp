...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTrainTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTrainTaskResponseBody) };
    inline CreateTrainTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTrainTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTrainTaskResponseBody> body_ {};
  };
