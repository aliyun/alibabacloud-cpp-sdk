...
namespace Models
{
  ...
  public:
    ...
    inline const GetAICoachTaskSessionResourceUsageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAICoachTaskSessionResourceUsageResponseBody) };
    inline GetAICoachTaskSessionResourceUsageResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAICoachTaskSessionResourceUsageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAICoachTaskSessionResourceUsageResponseBody> body_ {};
  };
