...
namespace Models
{
  ...
  public:
    ...
    inline string getEvaluationRating() const { DARABONBA_PTR_GET_DEFAULT(evaluationRating_, "") };
    ...
    inline bool getFeedback() const { DARABONBA_PTR_GET_DEFAULT(feedback_, false) };
