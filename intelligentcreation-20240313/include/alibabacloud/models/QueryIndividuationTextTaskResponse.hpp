...
namespace Models
{
  ...
  public:
    ...
    inline const QueryIndividuationTextTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryIndividuationTextTaskResponseBody) };
    inline QueryIndividuationTextTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryIndividuationTextTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryIndividuationTextTaskResponseBody> body_ {};
  };
