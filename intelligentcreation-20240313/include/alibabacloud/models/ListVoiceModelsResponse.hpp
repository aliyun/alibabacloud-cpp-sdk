...
namespace Models
{
  ...
  public:
    ...
    inline const ListVoiceModelsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListVoiceModelsResponseBody) };
    inline ListVoiceModelsResponseBody body() { DARABONBA_PTR_GET(body_, ListVoiceModelsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListVoiceModelsResponseBody> body_ = nullptr;
  };
