...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->audioUsage_ == nullptr
        && return this->deductionStatus_ == nullptr && return this->errorCode_ == nullptr && return this->errorMessage_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr
        && return this->tokenUsage_ == nullptr; };
    ...
    inline int32_t audioUsage() const { DARABONBA_PTR_GET_DEFAULT(audioUsage_, 0) };
    ...
    inline int32_t deductionStatus() const { DARABONBA_PTR_GET_DEFAULT(deductionStatus_, 0) };
    ...
    inline int32_t tokenUsage() const { DARABONBA_PTR_GET_DEFAULT(tokenUsage_, 0) };
  ...
  protected:
    std::shared_ptr<int32_t> audioUsage_ = nullptr;
    std::shared_ptr<int32_t> deductionStatus_ = nullptr;
    std::shared_ptr<string> errorCode_ = nullptr;
    std::shared_ptr<string> errorMessage_ = nullptr;
    // Id of the request
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<bool> success_ = nullptr;
    std::shared_ptr<int32_t> tokenUsage_ = nullptr;
  };
