...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAICoachTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAICoachTaskResponseBody) };
    inline CreateAICoachTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAICoachTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAICoachTaskResponseBody> body_ {};
  };
