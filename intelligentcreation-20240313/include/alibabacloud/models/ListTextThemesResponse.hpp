...
namespace Models
{
  ...
  public:
    ...
    inline const TextThemeListResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, TextThemeListResult) };
    inline TextThemeListResult getBody() { DARABONBA_PTR_GET(body_, TextThemeListResult) };
  ...
  protected:
    ...
    shared_ptr<TextThemeListResult> body_ {};
  };
