...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->anchorCategory_ == nullptr
        && this->anchorId_ == nullptr && this->anchorType_ == nullptr && this->coverRate_ == nullptr && this->digitalHumanType_ == nullptr && this->pageNumber_ == nullptr
        && this->pageSize_ == nullptr && this->resSpecType_ == nullptr && this->useScene_ == nullptr; };
