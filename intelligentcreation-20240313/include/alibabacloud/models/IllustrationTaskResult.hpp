...
namespace Models
{
  ...
  public:
    ...
    inline const IllustrationTask & getIllustrationTask() const { DARABONBA_PTR_GET_CONST(illustrationTask_, IllustrationTask) };
    inline IllustrationTask getIllustrationTask() { DARABONBA_PTR_GET(illustrationTask_, IllustrationTask) };
  ...
  protected:
    shared_ptr<IllustrationTask> illustrationTask_ {};
