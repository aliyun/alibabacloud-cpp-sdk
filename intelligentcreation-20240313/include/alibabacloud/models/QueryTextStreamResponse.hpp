...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTextStreamResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, QueryTextStreamResponseBody) };
    inline QueryTextStreamResponseBody body() { DARABONBA_PTR_GET(body_, QueryTextStreamResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<QueryTextStreamResponseBody> body_ = nullptr;
  };
