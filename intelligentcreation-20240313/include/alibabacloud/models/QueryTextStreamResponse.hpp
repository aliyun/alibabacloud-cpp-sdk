...
namespace Models
{
  ...
  public:
    ...
    inline QueryTextStreamResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline QueryTextStreamResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };
