...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->projectInfo_ == nullptr
        && this->projectName_ == nullptr && this->purpose_ == nullptr && this->sceneId_ == nullptr; };
    ...
    inline string getProjectInfo() const { DARABONBA_PTR_GET_DEFAULT(projectInfo_, "") };
  ...
  protected:
    shared_ptr<string> projectInfo_ {};
