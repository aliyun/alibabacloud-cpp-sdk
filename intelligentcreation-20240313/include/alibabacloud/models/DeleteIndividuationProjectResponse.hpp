...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteIndividuationProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteIndividuationProjectResponseBody) };
    inline DeleteIndividuationProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteIndividuationProjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteIndividuationProjectResponseBody> body_ {};
  };
