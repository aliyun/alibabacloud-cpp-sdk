...
namespace Models
{
  ...
  public:
    ...
    inline const GetAICoachCheatDetectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAICoachCheatDetectionResponseBody) };
    inline GetAICoachCheatDetectionResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAICoachCheatDetectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAICoachCheatDetectionResponseBody> body_ {};
  };
