...
namespace Models
{
  ...
  public:
    ...
    inline SendSdkStreamMessageResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline SendSdkStreamMessageResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };
