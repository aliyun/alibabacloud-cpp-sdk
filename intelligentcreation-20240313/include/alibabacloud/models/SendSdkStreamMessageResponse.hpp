...
namespace Models
{
  ...
  public:
    ...
    inline const SendSdkStreamMessageResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SendSdkStreamMessageResponseBody) };
    inline SendSdkStreamMessageResponseBody body() { DARABONBA_PTR_GET(body_, SendSdkStreamMessageResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SendSdkStreamMessageResponseBody> body_ = nullptr;
  };
