...
namespace Models
{
  ...
  public:
    ...
    inline const AddTextFeedbackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddTextFeedbackResponseBody) };
    inline AddTextFeedbackResponseBody getBody() { DARABONBA_PTR_GET(body_, AddTextFeedbackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddTextFeedbackResponseBody> body_ {};
  };
