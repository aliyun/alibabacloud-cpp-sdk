...
namespace Models
{
  ...
  public:
    ...
    inline const vector<BatchGetVideoClipTaskResponseBodyTaskList> & taskList() const { DARABONBA_PTR_GET_CONST(taskList_, vector<BatchGetVideoClipTaskResponseBodyTaskList>) };
    inline vector<BatchGetVideoClipTaskResponseBodyTaskList> taskList() { DARABONBA_PTR_GET(taskList_, vector<BatchGetVideoClipTaskResponseBodyTaskList>) };
    inline BatchGetVideoClipTaskResponseBody& setTaskList(const vector<BatchGetVideoClipTaskResponseBodyTaskList> & taskList) { DARABONBA_PTR_SET_VALUE(taskList_, taskList) };
    inline BatchGetVideoClipTaskResponseBody& setTaskList(vector<BatchGetVideoClipTaskResponseBodyTaskList> && taskList) { DARABONBA_PTR_SET_RVALUE(taskList_, taskList) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<vector<BatchGetVideoClipTaskResponseBodyTaskList>> taskList_ = nullptr;
  };
