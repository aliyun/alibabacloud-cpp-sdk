...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->anchorCategory_ == nullptr
        && this->anchorId_ == nullptr && this->anchorMaterialName_ == nullptr && this->anchorType_ == nullptr && this->coverHeight_ == nullptr && this->coverRate_ == nullptr
        && this->coverThumbnailUrl_ == nullptr && this->coverUrl_ == nullptr && this->coverWeight_ == nullptr && this->digitalHumanType_ == nullptr && this->gender_ == nullptr
        && this->resourceTypeDesc_ == nullptr && this->status_ == nullptr && this->supportBgChange_ == nullptr && this->useScene_ == nullptr; };
    ...
    inline string getAnchorType() const { DARABONBA_PTR_GET_DEFAULT(anchorType_, "") };
    ...
    inline int32_t getCoverHeight() const { DARABONBA_PTR_GET_DEFAULT(coverHeight_, 0) };
    ...
    inline string getCoverRate() const { DARABONBA_PTR_GET_DEFAULT(coverRate_, "") };
    ...
    inline string getCoverThumbnailUrl() const { DARABONBA_PTR_GET_DEFAULT(coverThumbnailUrl_, "") };
    ...
    inline int32_t getCoverWeight() const { DARABONBA_PTR_GET_DEFAULT(coverWeight_, 0) };
    ...
    inline int32_t getSupportBgChange() const { DARABONBA_PTR_GET_DEFAULT(supportBgChange_, 0) };
  ...
  protected:
    ...
    shared_ptr<string> anchorType_ {};
    shared_ptr<int32_t> coverHeight_ {};
    shared_ptr<string> coverRate_ {};
    shared_ptr<string> coverThumbnailUrl_ {};
    shared_ptr<string> coverUrl_ {};
    shared_ptr<int32_t> coverWeight_ {};
    shared_ptr<string> digitalHumanType_ {};
    shared_ptr<string> gender_ {};
    shared_ptr<string> resourceTypeDesc_ {};
    shared_ptr<string> status_ {};
    shared_ptr<int32_t> supportBgChange_ {};
