...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRealisticPortraitResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRealisticPortraitResponseBody) };
    inline CreateRealisticPortraitResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRealisticPortraitResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRealisticPortraitResponseBody> body_ {};
  };
