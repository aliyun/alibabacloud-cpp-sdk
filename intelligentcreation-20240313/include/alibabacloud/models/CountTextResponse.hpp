...
namespace Models
{
  ...
  public:
    ...
    inline const CountTextResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CountTextResponseBody) };
    inline CountTextResponseBody body() { DARABONBA_PTR_GET(body_, CountTextResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CountTextResponseBody> body_ = nullptr;
  };
