...
namespace Models
{
  ...
  public:
    ...
    inline const SendSdkMessageResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SendSdkMessageResponseBody) };
    inline SendSdkMessageResponseBody body() { DARABONBA_PTR_GET(body_, SendSdkMessageResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SendSdkMessageResponseBody> body_ = nullptr;
  };
