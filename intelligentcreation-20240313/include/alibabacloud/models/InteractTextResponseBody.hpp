...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->end_ == nullptr
        && this->index_ == nullptr && this->message_ == nullptr && this->relatedImages_ == nullptr && this->relatedVideos_ == nullptr && this->sessionId_ == nullptr
        && this->type_ == nullptr; };
    // end Field Functions 
    ...
    inline const vector<string> & getRelatedImages() const { DARABONBA_PTR_GET_CONST(relatedImages_, vector<string>) };
    inline vector<string> getRelatedImages() { DARABONBA_PTR_GET(relatedImages_, vector<string>) };
    ...
    inline const vector<string> & getRelatedVideos() const { DARABONBA_PTR_GET_CONST(relatedVideos_, vector<string>) };
    inline vector<string> getRelatedVideos() { DARABONBA_PTR_GET(relatedVideos_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> relatedImages_ {};
    shared_ptr<vector<string>> relatedVideos_ {};
