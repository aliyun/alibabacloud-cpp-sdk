...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ages_ == nullptr
        && this->cloth_ == nullptr && this->color_ == nullptr && this->custom_ == nullptr && this->face_ == nullptr && this->figure_ == nullptr
        && this->gender_ == nullptr && this->hairColor_ == nullptr && this->hairstyle_ == nullptr && this->height_ == nullptr && this->imageUrl_ == nullptr
        && this->numbers_ == nullptr && this->ratio_ == nullptr && this->width_ == nullptr; };
    // ages Field Functions 
    bool hasAges() const { return this->ages_ != nullptr;};
    void deleteAges() { this->ages_ = nullptr;};
    inline const vector<int32_t> & getAges() const { DARABONBA_PTR_GET_CONST(ages_, vector<int32_t>) };
    inline vector<int32_t> getAges() { DARABONBA_PTR_GET(ages_, vector<int32_t>) };
    ...
    inline int32_t getCloth() const { DARABONBA_PTR_GET_DEFAULT(cloth_, 0) };
    ...
    inline int32_t getColor() const { DARABONBA_PTR_GET_DEFAULT(color_, 0) };
    ...
    inline const vector<int32_t> & getFace() const { DARABONBA_PTR_GET_CONST(face_, vector<int32_t>) };
    inline vector<int32_t> getFace() { DARABONBA_PTR_GET(face_, vector<int32_t>) };
    ...
    inline int32_t getFigure() const { DARABONBA_PTR_GET_DEFAULT(figure_, 0) };
    ...
    inline int32_t getHairColor() const { DARABONBA_PTR_GET_DEFAULT(hairColor_, 0) };
    ...
    inline int32_t getHairstyle() const { DARABONBA_PTR_GET_DEFAULT(hairstyle_, 0) };
  ...
  protected:
    shared_ptr<vector<int32_t>> ages_ {};
    shared_ptr<int32_t> cloth_ {};
    shared_ptr<int32_t> color_ {};
    shared_ptr<string> custom_ {};
    shared_ptr<vector<int32_t>> face_ {};
    shared_ptr<int32_t> figure_ {};
    shared_ptr<int32_t> gender_ {};
    shared_ptr<int32_t> hairColor_ {};
    shared_ptr<int32_t> hairstyle_ {};
