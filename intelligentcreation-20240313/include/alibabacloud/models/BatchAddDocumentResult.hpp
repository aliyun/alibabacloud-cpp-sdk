...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AddDocumentResult> & addDocumentResults() const { DARABONBA_PTR_GET_CONST(addDocumentResults_, vector<AddDocumentResult>) };
    inline vector<AddDocumentResult> addDocumentResults() { DARABONBA_PTR_GET(addDocumentResults_, vector<AddDocumentResult>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<AddDocumentResult>> addDocumentResults_ = nullptr;
