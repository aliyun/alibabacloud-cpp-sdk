...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitImageToVideoTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitImageToVideoTaskResponseBody) };
    inline SubmitImageToVideoTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitImageToVideoTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitImageToVideoTaskResponseBody> body_ {};
  };
