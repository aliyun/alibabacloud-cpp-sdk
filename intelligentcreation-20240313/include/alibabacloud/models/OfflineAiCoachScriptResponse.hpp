...
namespace Models
{
  ...
  public:
    ...
    inline const OfflineAICoachScriptResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, OfflineAICoachScriptResponseBody) };
    inline OfflineAICoachScriptResponseBody body() { DARABONBA_PTR_GET(body_, OfflineAICoachScriptResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<OfflineAICoachScriptResponseBody> body_ = nullptr;
  };
