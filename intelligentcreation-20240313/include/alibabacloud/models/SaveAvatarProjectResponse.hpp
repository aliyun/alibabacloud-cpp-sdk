...
namespace Models
{
  ...
  public:
    ...
    inline const SaveAvatarProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveAvatarProjectResponseBody) };
    inline SaveAvatarProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveAvatarProjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveAvatarProjectResponseBody> body_ {};
  };
