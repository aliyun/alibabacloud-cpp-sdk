...
namespace Models
{
  ...
  public:
    ...
    inline const GetTextTemplateResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetTextTemplateResponseBody) };
    inline GetTextTemplateResponseBody body() { DARABONBA_PTR_GET(body_, GetTextTemplateResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetTextTemplateResponseBody> body_ = nullptr;
  };
