...
namespace Models
{
  ...
  public:
    ...
    inline const vector<KnowledgeBaseInfo> & knowledgeBases() const { DARABONBA_PTR_GET_CONST(knowledgeBases_, vector<KnowledgeBaseInfo>) };
    inline vector<KnowledgeBaseInfo> knowledgeBases() { DARABONBA_PTR_GET(knowledgeBases_, vector<KnowledgeBaseInfo>) };
  ...
  protected:
    std::shared_ptr<vector<KnowledgeBaseInfo>> knowledgeBases_ = nullptr;
