...
namespace Models
{
  ...
  public:
    ...
    inline GetImageResponseBodyImage& setBackupId(string backupId) { DARABONBA_PTR_SET_VALUE(backupId_, backupId) };


    // copyTime Field Functions 
    bool hasCopyTime() const { return this->copyTime_ != nullptr;};
    void deleteCopyTime() { this->copyTime_ = nullptr;};
    inline int64_t copyTime() const { DARABONBA_PTR_GET_DEFAULT(copyTime_, 0L) };
    inline GetImageResponseBodyImage& setCopyTime(int64_t copyTime) { DARABONBA_PTR_SET_VALUE(copyTime_, copyTime) };
    ...
    inline GetImageResponseBodyImage& setExportTime(int64_t exportTime) { DARABONBA_PTR_SET_VALUE(exportTime_, exportTime) };
    ...
    inline GetImageResponseBodyImage& setImageId(string imageId) { DARABONBA_PTR_SET_VALUE(imageId_, imageId) };
    ...
    inline GetImageResponseBodyImage& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetImageResponseBodyImage& setMode(string mode) { DARABONBA_PTR_SET_VALUE(mode_, mode) };
    ...
    inline GetImageResponseBodyImage& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline GetImageResponseBodyImage& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline GetImageResponseBodyImage& setSourceBackupUid(string sourceBackupUid) { DARABONBA_PTR_SET_VALUE(sourceBackupUid_, sourceBackupUid) };
    ...
    inline GetImageResponseBodyImage& setSourceImageUid(string sourceImageUid) { DARABONBA_PTR_SET_VALUE(sourceImageUid_, sourceImageUid) };
    ...
    inline GetImageResponseBodyImage& setSourceInstanceId(string sourceInstanceId) { DARABONBA_PTR_SET_VALUE(sourceInstanceId_, sourceInstanceId) };
    ...
    inline GetImageResponseBodyImage& setSourceRegionId(string sourceRegionId) { DARABONBA_PTR_SET_VALUE(sourceRegionId_, sourceRegionId) };
    ...
    inline GetImageResponseBodyImage& setVsmDigest(string vsmDigest) { DARABONBA_PTR_SET_VALUE(vsmDigest_, vsmDigest) };
  ...
  protected:
    ...
    std::shared_ptr<int64_t> copyTime_ = nullptr;
