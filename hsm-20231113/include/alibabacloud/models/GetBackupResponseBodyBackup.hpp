...
#ifndef ALIBABACLOUD_MODELS_GETBACKUPRESPONSEBODYBACKUP_HPP_
#define ALIBABACLOUD_MODELS_GETBACKUPRESPONSEBODYBACKUP_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetBackupResponseBodyBackup& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetBackupResponseBodyBackup& obj) { 
    ...
    GetBackupResponseBodyBackup() = default ;
    GetBackupResponseBodyBackup(const GetBackupResponseBodyBackup &) = default ;
    GetBackupResponseBodyBackup(GetBackupResponseBodyBackup &&) = default ;
    GetBackupResponseBodyBackup(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetBackupResponseBodyBackup() = default ;
    GetBackupResponseBodyBackup& operator=(const GetBackupResponseBodyBackup &) = default ;
    GetBackupResponseBodyBackup& operator=(GetBackupResponseBodyBackup &&) = default ;
    ...
    inline GetBackupResponseBodyBackup& setAutoImageCount(int64_t autoImageCount) { DARABONBA_PTR_SET_VALUE(autoImageCount_, autoImageCount) };
    ...
    inline GetBackupResponseBodyBackup& setBackupHourInDay(string backupHourInDay) { DARABONBA_PTR_SET_VALUE(backupHourInDay_, backupHourInDay) };
    ...
    inline GetBackupResponseBodyBackup& setBackupId(string backupId) { DARABONBA_PTR_SET_VALUE(backupId_, backupId) };
    ...
    inline GetBackupResponseBodyBackup& setBackupPeriod(int64_t backupPeriod) { DARABONBA_PTR_SET_VALUE(backupPeriod_, backupPeriod) };
    ...
    inline GetBackupResponseBodyBackup& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline GetBackupResponseBodyBackup& setExpireTime(int64_t expireTime) { DARABONBA_PTR_SET_VALUE(expireTime_, expireTime) };
    ...
    inline GetBackupResponseBodyBackup& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetBackupResponseBodyBackup& setMaxImageCount(string maxImageCount) { DARABONBA_PTR_SET_VALUE(maxImageCount_, maxImageCount) };
    ...
    inline GetBackupResponseBodyBackup& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetBackupResponseBodyBackup& setNextImageCreateTime(int64_t nextImageCreateTime) { DARABONBA_PTR_SET_VALUE(nextImageCreateTime_, nextImageCreateTime) };
    ...
    inline GetBackupResponseBodyBackup& setOwnerInstanceId(string ownerInstanceId) { DARABONBA_PTR_SET_VALUE(ownerInstanceId_, ownerInstanceId) };
    ...
    inline GetBackupResponseBodyBackup& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline GetBackupResponseBodyBackup& setReleaseTime(int64_t releaseTime) { DARABONBA_PTR_SET_VALUE(releaseTime_, releaseTime) };
    ...
    inline GetBackupResponseBodyBackup& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline GetBackupResponseBodyBackup& setSpInstanceId(string spInstanceId) { DARABONBA_PTR_SET_VALUE(spInstanceId_, spInstanceId) };
    ...
    inline GetBackupResponseBodyBackup& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetBackupResponseBodyBackup& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
