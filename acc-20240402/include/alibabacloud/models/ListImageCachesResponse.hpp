...
namespace Models
{
  ...
  public:
    ...
    inline const ListImageCachesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListImageCachesResponseBody) };
    inline ListImageCachesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListImageCachesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListImageCachesResponseBody> body_ {};
  };
