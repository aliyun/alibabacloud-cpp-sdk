...
namespace Models
{
  ...
  public:
    ...
    inline const GetImageCacheResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetImageCacheResponseBody) };
    inline GetImageCacheResponseBody getBody() { DARABONBA_PTR_GET(body_, GetImageCacheResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetImageCacheResponseBody> body_ {};
  };
