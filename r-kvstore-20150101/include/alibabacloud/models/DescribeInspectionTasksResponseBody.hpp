...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEINSPECTIONTASKSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEINSPECTIONTASKSRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeInspectionTasksResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeInspectionTasksResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Success, success_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeInspectionTasksResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
    };
    DescribeInspectionTasksResponseBody() = default ;
    DescribeInspectionTasksResponseBody(const DescribeInspectionTasksResponseBody &) = default ;
    DescribeInspectionTasksResponseBody(DescribeInspectionTasksResponseBody &&) = default ;
    DescribeInspectionTasksResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeInspectionTasksResponseBody() = default ;
    DescribeInspectionTasksResponseBody& operator=(const DescribeInspectionTasksResponseBody &) = default ;
    DescribeInspectionTasksResponseBody& operator=(DescribeInspectionTasksResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->endTime_ == nullptr && this->finishTime_ == nullptr && this->inspectionItems_ == nullptr && this->instanceIds_ == nullptr && this->reportLanguage_ == nullptr
        && this->scheduleId_ == nullptr && this->source_ == nullptr && this->startTime_ == nullptr && this->status_ == nullptr && this->taskId_ == nullptr; };
    ...
    inline const DescribeInspectionTasksResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeInspectionTasksResponseBody::Data) };
    inline DescribeInspectionTasksResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeInspectionTasksResponseBody::Data) };
    inline DescribeInspectionTasksResponseBody& setData(const DescribeInspectionTasksResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeInspectionTasksResponseBody& setData(DescribeInspectionTasksResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeInspectionTasksResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeInspectionTasksResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<DescribeInspectionTasksResponseBody::Data> data_ {};
