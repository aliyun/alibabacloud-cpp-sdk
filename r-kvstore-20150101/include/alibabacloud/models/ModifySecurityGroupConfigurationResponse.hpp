...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySecurityGroupConfigurationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifySecurityGroupConfigurationResponseBody) };
    inline ModifySecurityGroupConfigurationResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifySecurityGroupConfigurationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifySecurityGroupConfigurationResponseBody> body_ {};
  };
