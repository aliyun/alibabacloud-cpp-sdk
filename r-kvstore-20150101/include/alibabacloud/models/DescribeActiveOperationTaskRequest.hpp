...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->isHistory_ == nullptr
        ...
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->securityToken_ == nullptr && this->taskType_ == nullptr; };
    ...
    inline DescribeActiveOperationTaskRequest& setSecurityToken(string securityToken) { DARABONBA_PTR_SET_VALUE(securityToken_, securityToken) };
