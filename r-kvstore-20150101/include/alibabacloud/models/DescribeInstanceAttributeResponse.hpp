...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceAttributeResponseBody) };
    inline DescribeInstanceAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceAttributeResponseBody> body_ {};
  };
