...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->endTime_ == nullptr
        && this->inspectionItems_ == nullptr && this->instanceId_ == nullptr && this->instanceIds_ == nullptr && this->reportLanguage_ == nullptr && this->startTime_ == nullptr; };
    ...
    inline CreateInspectionTaskRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
