...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeAccountsRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(SearchAccountName, searchAccountName_);
    ...
    friend void from_json(const Darabonba::Json& j, DescribeAccountsRequest& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(SearchAccountName, searchAccountName_);
    ...
    virtual bool empty() const override { return this->accountName_ == nullptr
        ...
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->searchAccountName_ == nullptr && this->securityToken_ == nullptr; };
    ...
    inline DescribeAccountsRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    // searchAccountName Field Functions 
    bool hasSearchAccountName() const { return this->searchAccountName_ != nullptr;};
    void deleteSearchAccountName() { this->searchAccountName_ = nullptr;};
    inline string getSearchAccountName() const { DARABONBA_PTR_GET_DEFAULT(searchAccountName_, "") };
    inline DescribeAccountsRequest& setSearchAccountName(string searchAccountName) { DARABONBA_PTR_SET_VALUE(searchAccountName_, searchAccountName) };
    ...
    inline DescribeAccountsRequest& setSecurityToken(string securityToken) { DARABONBA_PTR_SET_VALUE(securityToken_, securityToken) };
  ...
  protected:
    ...
    shared_ptr<string> searchAccountName_ {};
