  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->forceModify_ == nullptr && this->forceRestart_ == nullptr && this->parameterDescription_ == nullptr && this->parameterName_ == nullptr && this->parameterValue_ == nullptr; };
        ...
        inline bool getForceModify() const { DARABONBA_PTR_GET_DEFAULT(forceModify_, false) };
        inline TemplateRecord& setForceModify(bool forceModify) { DARABONBA_PTR_SET_VALUE(forceModify_, forceModify) };
        ...
        inline TemplateRecord& setForceRestart(bool forceRestart) { DARABONBA_PTR_SET_VALUE(forceRestart_, forceRestart) };
    ...
    virtual bool empty() const override { return this->engine_ == nullptr
        && this->engineVersion_ == nullptr && this->parameterCount_ == nullptr && this->parameters_ == nullptr && this->requestId_ == nullptr; };
