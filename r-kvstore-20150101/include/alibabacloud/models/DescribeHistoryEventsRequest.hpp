...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->archiveStatus_ == nullptr
        ...
        && this->fromStartTime_ == nullptr && this->instanceId_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->pageNumber_ == nullptr
        ...
        && this->resourceType_ == nullptr && this->securityToken_ == nullptr && this->taskId_ == nullptr && this->toStartTime_ == nullptr; };
    ...
    inline DescribeHistoryEventsRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline DescribeHistoryEventsRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline DescribeHistoryEventsRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline DescribeHistoryEventsRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
