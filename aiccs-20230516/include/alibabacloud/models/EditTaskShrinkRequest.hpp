...
#ifndef ALIBABACLOUD_MODELS_EDITTASKSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_EDITTASKSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    ...
    EditTaskShrinkRequest() = default ;
    EditTaskShrinkRequest(const EditTaskShrinkRequest &) = default ;
    EditTaskShrinkRequest(EditTaskShrinkRequest &&) = default ;
    EditTaskShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EditTaskShrinkRequest() = default ;
    EditTaskShrinkRequest& operator=(const EditTaskShrinkRequest &) = default ;
    EditTaskShrinkRequest& operator=(EditTaskShrinkRequest &&) = default ;
    ...
    inline EditTaskShrinkRequest& setCallbackUrl(string callbackUrl) { DARABONBA_PTR_SET_VALUE(callbackUrl_, callbackUrl) };
    ...
    inline EditTaskShrinkRequest& setFlashSmsTemplateId(int64_t flashSmsTemplateId) { DARABONBA_PTR_SET_VALUE(flashSmsTemplateId_, flashSmsTemplateId) };
    ...
    inline EditTaskShrinkRequest& setFlashSmsType(int64_t flashSmsType) { DARABONBA_PTR_SET_VALUE(flashSmsType_, flashSmsType) };
    ...
    inline EditTaskShrinkRequest& setMaxConcurrency(int64_t maxConcurrency) { DARABONBA_PTR_SET_VALUE(maxConcurrency_, maxConcurrency) };
    ...
    inline EditTaskShrinkRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline EditTaskShrinkRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline EditTaskShrinkRequest& setPlaySleepVal(int64_t playSleepVal) { DARABONBA_PTR_SET_VALUE(playSleepVal_, playSleepVal) };
    ...
    inline EditTaskShrinkRequest& setPlayTimes(int64_t playTimes) { DARABONBA_PTR_SET_VALUE(playTimes_, playTimes) };
    ...
    inline EditTaskShrinkRequest& setRecallType(int64_t recallType) { DARABONBA_PTR_SET_VALUE(recallType_, recallType) };
    ...
    inline EditTaskShrinkRequest& setRecordPath(string recordPath) { DARABONBA_PTR_SET_VALUE(recordPath_, recordPath) };
    ...
    inline EditTaskShrinkRequest& setRepeatCount(int64_t repeatCount) { DARABONBA_PTR_SET_VALUE(repeatCount_, repeatCount) };
    ...
    inline EditTaskShrinkRequest& setRepeatInterval(int64_t repeatInterval) { DARABONBA_PTR_SET_VALUE(repeatInterval_, repeatInterval) };
    ...
    inline EditTaskShrinkRequest& setRepeatReasonShrink(string repeatReasonShrink) { DARABONBA_PTR_SET_VALUE(repeatReasonShrink_, repeatReasonShrink) };
    ...
    inline EditTaskShrinkRequest& setRepeatTimesShrink(string repeatTimesShrink) { DARABONBA_PTR_SET_VALUE(repeatTimesShrink_, repeatTimesShrink) };
    ...
    inline EditTaskShrinkRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline EditTaskShrinkRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline EditTaskShrinkRequest& setSendSmsPlanShrink(string sendSmsPlanShrink) { DARABONBA_PTR_SET_VALUE(sendSmsPlanShrink_, sendSmsPlanShrink) };
    ...
    inline EditTaskShrinkRequest& setStatus(int64_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline EditTaskShrinkRequest& setTaskId(int64_t taskId) { DARABONBA_PTR_SET_VALUE(taskId_, taskId) };
    ...
    inline EditTaskShrinkRequest& setTemplateId(int64_t templateId) { DARABONBA_PTR_SET_VALUE(templateId_, templateId) };
    ...
    inline EditTaskShrinkRequest& setTemplateType(int64_t templateType) { DARABONBA_PTR_SET_VALUE(templateType_, templateType) };
    ...
    inline EditTaskShrinkRequest& setWeekTagShrink(string weekTagShrink) { DARABONBA_PTR_SET_VALUE(weekTagShrink_, weekTagShrink) };
