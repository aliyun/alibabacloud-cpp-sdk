...
#ifndef ALIBABACLOUD_MODELS_IMPORTNUMBERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_IMPORTNUMBERREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ImportNumberRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ImportNumberRequest& obj) { 
    ...
    ImportNumberRequest() = default ;
    ImportNumberRequest(const ImportNumberRequest &) = default ;
    ImportNumberRequest(ImportNumberRequest &&) = default ;
    ImportNumberRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ImportNumberRequest() = default ;
    ImportNumberRequest& operator=(const ImportNumberRequest &) = default ;
    ImportNumberRequest& operator=(ImportNumberRequest &&) = default ;
    ...
    inline const vector<ImportNumberRequest::Customers> & getCustomers() const { DARABONBA_PTR_GET_CONST(customers_, vector<ImportNumberRequest::Customers>) };
    inline vector<ImportNumberRequest::Customers> getCustomers() { DARABONBA_PTR_GET(customers_, vector<ImportNumberRequest::Customers>) };
    inline ImportNumberRequest& setCustomers(const vector<ImportNumberRequest::Customers> & customers) { DARABONBA_PTR_SET_VALUE(customers_, customers) };
    inline ImportNumberRequest& setCustomers(vector<ImportNumberRequest::Customers> && customers) { DARABONBA_PTR_SET_RVALUE(customers_, customers) };
    ...
    inline ImportNumberRequest& setFailReturn(int64_t failReturn) { DARABONBA_PTR_SET_VALUE(failReturn_, failReturn) };
    ...
    inline ImportNumberRequest& setOutId(string outId) { DARABONBA_PTR_SET_VALUE(outId_, outId) };
    ...
    inline ImportNumberRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline ImportNumberRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline ImportNumberRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline ImportNumberRequest& setTaskId(int64_t taskId) { DARABONBA_PTR_SET_VALUE(taskId_, taskId) };


  protected:
    // This parameter is required.
    shared_ptr<vector<ImportNumberRequest::Customers>> customers_ {};
