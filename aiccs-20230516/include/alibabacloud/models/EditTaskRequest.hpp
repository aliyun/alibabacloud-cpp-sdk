...
namespace Models
{
  ...
  public:
    ...
    inline const vector<EditTaskRequest::CallTimeStrList> & getCallTimeStrList() const { DARABONBA_PTR_GET_CONST(callTimeStrList_, vector<EditTaskRequest::CallTimeStrList>) };
    inline vector<EditTaskRequest::CallTimeStrList> getCallTimeStrList() { DARABONBA_PTR_GET(callTimeStrList_, vector<EditTaskRequest::CallTimeStrList>) };
    inline EditTaskRequest& setCallTimeStrList(const vector<EditTaskRequest::CallTimeStrList> & callTimeStrList) { DARABONBA_PTR_SET_VALUE(callTimeStrList_, callTimeStrList) };
    inline EditTaskRequest& setCallTimeStrList(vector<EditTaskRequest::CallTimeStrList> && callTimeStrList) { DARABONBA_PTR_SET_RVALUE(callTimeStrList_, callTimeStrList) };
  ...
  protected:
    ...
    shared_ptr<vector<EditTaskRequest::CallTimeStrList>> callTimeStrList_ {};
    // 回调地址
