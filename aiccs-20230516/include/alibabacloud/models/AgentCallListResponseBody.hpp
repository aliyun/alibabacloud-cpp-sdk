...
#ifndef ALIBABACLOUD_MODELS_AGENTCALLLISTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_AGENTCALLLISTRESPONSEBODY_HPP_
...
namespace Models
{
  class AgentCallListResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const AgentCallListResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AgentCallListResponseBody& obj) { 
    ...
    AgentCallListResponseBody() = default ;
    AgentCallListResponseBody(const AgentCallListResponseBody &) = default ;
    AgentCallListResponseBody(AgentCallListResponseBody &&) = default ;
    AgentCallListResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AgentCallListResponseBody() = default ;
    AgentCallListResponseBody& operator=(const AgentCallListResponseBody &) = default ;
    AgentCallListResponseBody& operator=(AgentCallListResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        friend void to_json(Darabonba::Json& j, const List& obj) { 
          ...
          DARABONBA_PTR_TO_JSON(TransferTime, transferTime_);
        };
        friend void from_json(const Darabonba::Json& j, List& obj) { 
          ...
          DARABONBA_PTR_FROM_JSON(TransferTime, transferTime_);
        };
        List() = default ;
        ...
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        virtual bool empty() const override { return this->agentExtension_ == nullptr
        && this->agentId_ == nullptr && this->agentSpeakingDuration_ == nullptr && this->agentSpeakingTime_ == nullptr && this->agentTag_ == nullptr && this->answerTime_ == nullptr
        && this->batchId_ == nullptr && this->callBeginTime_ == nullptr && this->callId_ == nullptr && this->callType_ == nullptr && this->chatRecord_ == nullptr
        ...
        && this->speakingTime_ == nullptr && this->speakingTurns_ == nullptr && this->statusCode_ == nullptr && this->statusDescription_ == nullptr && this->tag_ == nullptr
        && this->taskId_ == nullptr && this->templateId_ == nullptr && this->transferStatus_ == nullptr && this->transferStatusCode_ == nullptr && this->transferTime_ == nullptr; };
        ...
        inline List& setTransferTime(string transferTime) { DARABONBA_PTR_SET_VALUE(transferTime_, transferTime) };
    ...
    inline AgentCallListResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline AgentCallListResponseBody& setCode(int64_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline AgentCallListResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };


    // model Field Functions 
    bool hasModel() const { return this->model_ != nullptr;};
    void deleteModel() { this->model_ = nullptr;};
    inline const AgentCallListResponseBody::Model & getModel() const { DARABONBA_PTR_GET_CONST(model_, AgentCallListResponseBody::Model) };
    inline AgentCallListResponseBody::Model getModel() { DARABONBA_PTR_GET(model_, AgentCallListResponseBody::Model) };
    inline AgentCallListResponseBody& setModel(const AgentCallListResponseBody::Model & model) { DARABONBA_PTR_SET_VALUE(model_, model) };
    inline AgentCallListResponseBody& setModel(AgentCallListResponseBody::Model && model) { DARABONBA_PTR_SET_RVALUE(model_, model) };
    ...
    inline AgentCallListResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline AgentCallListResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline AgentCallListResponseBody& setTimestamp(int64_t timestamp) { DARABONBA_PTR_SET_VALUE(timestamp_, timestamp) };
  ...
  protected:
    ...
    shared_ptr<AgentCallListResponseBody::Model> model_ {};
