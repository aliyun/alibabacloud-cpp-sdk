...
namespace Models
{
  ...
  public:
    ...
    inline AddTaskShrinkRequest& setCallTimeStrListShrink(string callTimeStrListShrink) { DARABONBA_PTR_SET_VALUE(callTimeStrListShrink_, callTimeStrListShrink) };
