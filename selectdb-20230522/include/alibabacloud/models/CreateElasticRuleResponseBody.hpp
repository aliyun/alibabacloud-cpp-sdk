...
namespace Models
{
  ...
  public:
    ...
    inline const CreateElasticRuleResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateElasticRuleResponseBody::Data) };
    inline CreateElasticRuleResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateElasticRuleResponseBody::Data) };
    inline CreateElasticRuleResponseBody& setData(const CreateElasticRuleResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateElasticRuleResponseBody& setData(CreateElasticRuleResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
