...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDBClusterResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateDBClusterResponseBodyData) };
    inline CreateDBClusterResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateDBClusterResponseBodyData) };
    inline CreateDBClusterResponseBody& setData(const CreateDBClusterResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateDBClusterResponseBody& setData(CreateDBClusterResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<CreateDBClusterResponseBodyData> data_ = nullptr;
