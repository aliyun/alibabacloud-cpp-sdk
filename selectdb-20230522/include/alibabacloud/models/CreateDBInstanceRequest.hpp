...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateDBInstanceRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(FEClassCode, FEClassCode_);
      DARABONBA_PTR_TO_JSON(FENodeCount, FENodeCount_);
    ...
    friend void from_json(const Darabonba::Json& j, CreateDBInstanceRequest& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(FEClassCode, FEClassCode_);
      DARABONBA_PTR_FROM_JSON(FENodeCount, FENodeCount_);
    ...
    virtual bool empty() const override { return this->addVPCIPs_ == nullptr
        ...
        && this->engine_ == nullptr && this->engineVersion_ == nullptr && this->FEClassCode_ == nullptr && this->FENodeCount_ == nullptr && this->multiZone_ == nullptr
        && this->period_ == nullptr && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr && this->resourceOwnerId_ == nullptr && this->scaleMax_ == nullptr
        && this->scaleMin_ == nullptr && this->securityIPList_ == nullptr && this->tag_ == nullptr && this->usedTime_ == nullptr && this->vSwitchId_ == nullptr
    ...
    inline CreateDBInstanceRequest& setConfigPatternType(string configPatternType) { DARABONBA_PTR_SET_VALUE(configPatternType_, configPatternType) };
    ...
    // FEClassCode Field Functions 
    bool hasFEClassCode() const { return this->FEClassCode_ != nullptr;};
    void deleteFEClassCode() { this->FEClassCode_ = nullptr;};
    inline string getFEClassCode() const { DARABONBA_PTR_GET_DEFAULT(FEClassCode_, "") };
    inline CreateDBInstanceRequest& setFEClassCode(string FEClassCode) { DARABONBA_PTR_SET_VALUE(FEClassCode_, FEClassCode) };


    // FENodeCount Field Functions 
    bool hasFENodeCount() const { return this->FENodeCount_ != nullptr;};
    void deleteFENodeCount() { this->FENodeCount_ = nullptr;};
    inline string getFENodeCount() const { DARABONBA_PTR_GET_DEFAULT(FENodeCount_, "") };
    inline CreateDBInstanceRequest& setFENodeCount(string FENodeCount) { DARABONBA_PTR_SET_VALUE(FENodeCount_, FENodeCount) };
  ...
  protected:
    ...
    shared_ptr<string> FEClassCode_ {};
    ...
    shared_ptr<string> FENodeCount_ {};
