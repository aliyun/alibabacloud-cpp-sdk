...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cacheSize_ == nullptr
        && return this->chargeType_ == nullptr && return this->clusterId_ == nullptr && return this->commodityCode_ == nullptr && return this->computeSize_ == nullptr && return this->dbInstanceId_ == nullptr
        && return this->modifyClusterChargeType_ == nullptr && return this->preCacheSize_ == nullptr && return this->preComputeSize_ == nullptr && return this->pricingCycle_ == nullptr && return this->promotionOptionNo_ == nullptr
        && return this->quantity_ == nullptr && return this->regionId_ == nullptr && return this->resourceOwnerId_ == nullptr; };
