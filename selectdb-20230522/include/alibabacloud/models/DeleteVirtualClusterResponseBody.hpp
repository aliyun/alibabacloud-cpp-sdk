...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVirtualClusterResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteVirtualClusterResponseBody::Data) };
    inline DeleteVirtualClusterResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteVirtualClusterResponseBody::Data) };
    inline DeleteVirtualClusterResponseBody& setData(const DeleteVirtualClusterResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteVirtualClusterResponseBody& setData(DeleteVirtualClusterResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
