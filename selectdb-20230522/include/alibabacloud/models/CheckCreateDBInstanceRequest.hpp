...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cacheSize_ == nullptr
        && this->chargeType_ == nullptr && this->clientToken_ == nullptr && this->connectionString_ == nullptr && this->DBInstanceClass_ == nullptr && this->DBInstanceDescription_ == nullptr
        && this->engine_ == nullptr && this->engineVersion_ == nullptr && this->period_ == nullptr && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr
        && this->resourceOwnerId_ == nullptr && this->securityIPList_ == nullptr && this->usedTime_ == nullptr && this->vSwitchId_ == nullptr && this->vpcId_ == nullptr
