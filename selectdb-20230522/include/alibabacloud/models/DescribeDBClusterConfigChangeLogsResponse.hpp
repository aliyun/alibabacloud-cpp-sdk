...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClusterConfigChangeLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBClusterConfigChangeLogsResponseBody) };
    inline DescribeDBClusterConfigChangeLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBClusterConfigChangeLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBClusterConfigChangeLogsResponseBody> body_ {};
  };
