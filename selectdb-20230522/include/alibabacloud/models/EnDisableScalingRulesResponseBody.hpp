...
namespace Models
{
  ...
  public:
    ...
    inline const EnDisableScalingRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, EnDisableScalingRulesResponseBodyData) };
    inline EnDisableScalingRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, EnDisableScalingRulesResponseBodyData) };
    inline EnDisableScalingRulesResponseBody& setData(const EnDisableScalingRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline EnDisableScalingRulesResponseBody& setData(EnDisableScalingRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<EnDisableScalingRulesResponseBodyData> data_ = nullptr;
    // The request ID.
