...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeElasticRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeElasticRulesResponseBody) };
    inline DescribeElasticRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeElasticRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeElasticRulesResponseBody> body_ {};
  };
