...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->cacheSize_ != nullptr
        && this->clusterNodeCount_ != nullptr && this->clusterNodeType_ != nullptr && this->DBClusterClass_ != nullptr && this->DBClusterId_ != nullptr && this->DBInstanceId_ != nullptr
        && this->engine_ != nullptr && this->regionId_ != nullptr && this->resourceOwnerId_ != nullptr && this->scaleMax_ != nullptr && this->scaleMin_ != nullptr; };
