...
namespace Models
{
  ...
  public:
    ...
    inline const StopBEClusterResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, StopBEClusterResponseBody) };
    inline StopBEClusterResponseBody body() { DARABONBA_PTR_GET(body_, StopBEClusterResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<StopBEClusterResponseBody> body_ = nullptr;
  };
