...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDBClusterResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteDBClusterResponseBody::Data) };
    inline DeleteDBClusterResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteDBClusterResponseBody::Data) };
    inline DeleteDBClusterResponseBody& setData(const DeleteDBClusterResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteDBClusterResponseBody& setData(DeleteDBClusterResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
