...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cacheStorageSizeGB_ == nullptr
        && return this->cacheStorageType_ == nullptr && return this->chargeType_ == nullptr && return this->clusterBinding_ == nullptr && return this->clusterNodeCount_ == nullptr && return this->clusterNodeType_ == nullptr
        && return this->cpuCores_ == nullptr && return this->createdTime_ == nullptr && return this->dbClusterClass_ == nullptr && return this->dbClusterId_ == nullptr && return this->dbClusterName_ == nullptr
        && return this->dbInstanceName_ == nullptr && return this->memory_ == nullptr && return this->modifiedTime_ == nullptr && return this->performanceLevel_ == nullptr && return this->scaleMax_ == nullptr
        && return this->scaleMin_ == nullptr && return this->scalingRulesEnable_ == nullptr && return this->startTime_ == nullptr && return this->status_ == nullptr && return this->subDomain_ == nullptr
