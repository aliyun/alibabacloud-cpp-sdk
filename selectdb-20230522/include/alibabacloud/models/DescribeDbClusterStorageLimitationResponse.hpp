...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClusterStorageLimitationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBClusterStorageLimitationResponseBody) };
    inline DescribeDBClusterStorageLimitationResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBClusterStorageLimitationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBClusterStorageLimitationResponseBody> body_ {};
  };
