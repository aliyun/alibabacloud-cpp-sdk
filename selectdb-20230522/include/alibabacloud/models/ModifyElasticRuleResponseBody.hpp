...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyElasticRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ModifyElasticRuleResponseBodyData) };
    inline ModifyElasticRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, ModifyElasticRuleResponseBodyData) };
    inline ModifyElasticRuleResponseBody& setData(const ModifyElasticRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyElasticRuleResponseBody& setData(ModifyElasticRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<ModifyElasticRuleResponseBodyData> data_ = nullptr;
    // The request ID.
