...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addVPCIPs_ == nullptr
        ...
        && this->engine_ == nullptr && this->engineVersion_ == nullptr && this->FEClassCode_ == nullptr && this->FENodeCount_ == nullptr && this->multiZoneShrink_ == nullptr
        ...
        && this->scaleMin_ == nullptr && this->securityIPList_ == nullptr && this->tagShrink_ == nullptr && this->usedTime_ == nullptr && this->vSwitchId_ == nullptr
    ...
    inline CreateDBInstanceShrinkRequest& setFEClassCode(string FEClassCode) { DARABONBA_PTR_SET_VALUE(FEClassCode_, FEClassCode) };
    ...
    inline CreateDBInstanceShrinkRequest& setFENodeCount(string FENodeCount) { DARABONBA_PTR_SET_VALUE(FENodeCount_, FENodeCount) };
