...
#include <alibabacloud/models/DescribeDBInstanceAttributeResponseBodyVirtualClusterList.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->canUpgradeVersions_ == nullptr
        && return this->chargeType_ == nullptr && return this->createTime_ == nullptr && return this->DBClusterList_ == nullptr && return this->DBInstanceId_ == nullptr && return this->deployScheme_ == nullptr
        && return this->description_ == nullptr && return this->engine_ == nullptr && return this->engineMinorVersion_ == nullptr && return this->engineVersion_ == nullptr && return this->expireTime_ == nullptr
        && return this->gmtModified_ == nullptr && return this->lockMode_ == nullptr && return this->lockReason_ == nullptr && return this->maintainEndtime_ == nullptr && return this->maintainStarttime_ == nullptr
        && return this->multiZone_ == nullptr && return this->objectStoreSize_ == nullptr && return this->regionId_ == nullptr && return this->requestId_ == nullptr && return this->resourceCpu_ == nullptr
        && return this->resourceGroupId_ == nullptr && return this->secGroupConnValid_ == nullptr && return this->serverless_ == nullptr && return this->status_ == nullptr && return this->storageSize_ == nullptr
        && return this->subDomain_ == nullptr && return this->tags_ == nullptr && return this->vSwitchId_ == nullptr && return this->virtualClusterList_ == nullptr && return this->vpcId_ == nullptr
    ...
    inline const vector<DescribeDBInstanceAttributeResponseBodyVirtualClusterList> & virtualClusterList() const { DARABONBA_PTR_GET_CONST(virtualClusterList_, vector<DescribeDBInstanceAttributeResponseBodyVirtualClusterList>) };
    inline vector<DescribeDBInstanceAttributeResponseBodyVirtualClusterList> virtualClusterList() { DARABONBA_PTR_GET(virtualClusterList_, vector<DescribeDBInstanceAttributeResponseBodyVirtualClusterList>) };
    inline DescribeDBInstanceAttributeResponseBody& setVirtualClusterList(const vector<DescribeDBInstanceAttributeResponseBodyVirtualClusterList> & virtualClusterList) { DARABONBA_PTR_SET_VALUE(virtualClusterList_, virtualClusterList) };
    inline DescribeDBInstanceAttributeResponseBody& setVirtualClusterList(vector<DescribeDBInstanceAttributeResponseBodyVirtualClusterList> && virtualClusterList) { DARABONBA_PTR_SET_RVALUE(virtualClusterList_, virtualClusterList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeDBInstanceAttributeResponseBodyVirtualClusterList>> virtualClusterList_ = nullptr;
    // The VPC ID.
