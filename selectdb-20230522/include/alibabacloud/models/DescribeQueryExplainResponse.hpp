...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeQueryExplainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeQueryExplainResponseBody) };
    inline DescribeQueryExplainResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeQueryExplainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeQueryExplainResponseBody> body_ {};
  };
