...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addVPCIPs_ == nullptr
        ...
        && return this->engineVersion_ == nullptr && return this->multiZone_ == nullptr && return this->period_ == nullptr && return this->regionId_ == nullptr && return this->resourceGroupId_ == nullptr
        && return this->resourceOwnerId_ == nullptr && return this->scaleMax_ == nullptr && return this->scaleMin_ == nullptr && return this->securityIPList_ == nullptr && return this->tag_ == nullptr
