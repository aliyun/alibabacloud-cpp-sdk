...
#ifndef ALIBABACLOUD_MODELS_GETCREATEBECLUSTERINQUIRYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETCREATEBECLUSTERINQUIRYRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetCreateBEClusterInquiryResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetCreateBEClusterInquiryResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    GetCreateBEClusterInquiryResponseBody() = default ;
    GetCreateBEClusterInquiryResponseBody(const GetCreateBEClusterInquiryResponseBody &) = default ;
    GetCreateBEClusterInquiryResponseBody(GetCreateBEClusterInquiryResponseBody &&) = default ;
    GetCreateBEClusterInquiryResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetCreateBEClusterInquiryResponseBody() = default ;
    GetCreateBEClusterInquiryResponseBody& operator=(const GetCreateBEClusterInquiryResponseBody &) = default ;
    GetCreateBEClusterInquiryResponseBody& operator=(GetCreateBEClusterInquiryResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->currency_ == nullptr
        && this->optionalPromotions_ == nullptr && this->pricingRules_ == nullptr && this->tradeAmount_ == nullptr; };
    ...
    inline const GetCreateBEClusterInquiryResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetCreateBEClusterInquiryResponseBody::Data) };
    inline GetCreateBEClusterInquiryResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetCreateBEClusterInquiryResponseBody::Data) };
    inline GetCreateBEClusterInquiryResponseBody& setData(const GetCreateBEClusterInquiryResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCreateBEClusterInquiryResponseBody& setData(GetCreateBEClusterInquiryResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetCreateBEClusterInquiryResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
