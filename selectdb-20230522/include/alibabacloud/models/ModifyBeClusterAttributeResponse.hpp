...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyBEClusterAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyBEClusterAttributeResponseBody) };
    inline ModifyBEClusterAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyBEClusterAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyBEClusterAttributeResponseBody> body_ {};
  };
