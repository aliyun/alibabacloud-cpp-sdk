...
namespace Models
{
  ...
  public:
    ...
    inline const HotUpdateJobResult & getData() const { DARABONBA_PTR_GET_CONST(data_, HotUpdateJobResult) };
    inline HotUpdateJobResult getData() { DARABONBA_PTR_GET(data_, HotUpdateJobResult) };
