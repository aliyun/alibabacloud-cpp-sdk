...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->flinkApiPath_ == nullptr
        && this->namespace_ == nullptr && this->resourceId_ == nullptr && this->resourceType_ == nullptr; };
    ...
    inline string getFlinkApiPath() const { DARABONBA_PTR_GET_DEFAULT(flinkApiPath_, "") };
  ...
  protected:
    ...
    shared_ptr<string> flinkApiPath_ {};
