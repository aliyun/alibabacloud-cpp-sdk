...
namespace Models
{
  ...
  public:
    ...
    inline const CreateUdfArtifactResult & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateUdfArtifactResult) };
    inline CreateUdfArtifactResult getData() { DARABONBA_PTR_GET(data_, CreateUdfArtifactResult) };
  ...
  protected:
    ...
    shared_ptr<CreateUdfArtifactResult> data_ {};
