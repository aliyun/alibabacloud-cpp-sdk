...
namespace Models
{
  ...
  public:
    ...
    inline const GetLineageInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLineageInfoResponseBody) };
    inline GetLineageInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLineageInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLineageInfoResponseBody> body_ {};
  };
