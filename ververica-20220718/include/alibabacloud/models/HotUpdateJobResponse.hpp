...
namespace Models
{
  ...
  public:
    ...
    inline const HotUpdateJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, HotUpdateJobResponseBody) };
    inline HotUpdateJobResponseBody getBody() { DARABONBA_PTR_GET(body_, HotUpdateJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<HotUpdateJobResponseBody> body_ {};
  };
