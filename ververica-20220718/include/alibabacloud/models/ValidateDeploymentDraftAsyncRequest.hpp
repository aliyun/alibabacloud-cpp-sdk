...
namespace Models
{
  ...
  public:
    ...
    inline const DraftValidateParams & getBody() const { DARABONBA_PTR_GET_CONST(body_, DraftValidateParams) };
    inline DraftValidateParams getBody() { DARABONBA_PTR_GET(body_, DraftValidateParams) };
