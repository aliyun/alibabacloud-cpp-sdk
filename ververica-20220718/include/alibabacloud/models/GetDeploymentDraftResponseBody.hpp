...
namespace Models
{
  ...
  public:
    ...
    inline const DeploymentDraft & getData() const { DARABONBA_PTR_GET_CONST(data_, DeploymentDraft) };
    inline DeploymentDraft getData() { DARABONBA_PTR_GET(data_, DeploymentDraft) };
