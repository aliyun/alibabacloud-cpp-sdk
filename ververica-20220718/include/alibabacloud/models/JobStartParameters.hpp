...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->deploymentId_ == nullptr
        && this->jobId_ == nullptr && this->localVariables_ == nullptr && this->resourceQueueName_ == nullptr && this->restoreStrategy_ == nullptr; };
    ...
    inline string getResourceQueueName() const { DARABONBA_PTR_GET_DEFAULT(resourceQueueName_, "") };
