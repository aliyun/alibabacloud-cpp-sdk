...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UdfArtifact> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<UdfArtifact>) };
    inline vector<UdfArtifact> getData() { DARABONBA_PTR_GET(data_, vector<UdfArtifact>) };
  ...
  protected:
    ...
    shared_ptr<vector<UdfArtifact>> data_ {};
