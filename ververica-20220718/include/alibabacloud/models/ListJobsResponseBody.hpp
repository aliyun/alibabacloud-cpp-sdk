...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessDeniedDetail_ == nullptr
        && this->data_ == nullptr && this->errorCode_ == nullptr && this->errorMessage_ == nullptr && this->httpCode_ == nullptr && this->pageIndex_ == nullptr
        && this->pageSize_ == nullptr && this->requestId_ == nullptr && this->success_ == nullptr && this->totalSize_ == nullptr; };
    ...
    inline const vector<Job> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<Job>) };
    inline vector<Job> getData() { DARABONBA_PTR_GET(data_, vector<Job>) };
