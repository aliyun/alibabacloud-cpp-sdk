...
namespace Models
{
  ...
  public:
    ...
    inline const UdfFunction & getData() const { DARABONBA_PTR_GET_CONST(data_, UdfFunction) };
    inline UdfFunction getData() { DARABONBA_PTR_GET(data_, UdfFunction) };
