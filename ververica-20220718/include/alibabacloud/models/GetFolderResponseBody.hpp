...
namespace Models
{
  ...
  public:
    ...
    inline GetFolderResponseBody& setData(const Folder & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetFolderResponseBody& setData(Folder && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetFolderResponseBody& setHttpCode(int32_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
