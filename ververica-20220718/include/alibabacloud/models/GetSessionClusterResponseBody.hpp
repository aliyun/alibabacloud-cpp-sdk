...
namespace Models
{
  ...
  public:
    ...
    inline GetSessionClusterResponseBody& setData(const SessionCluster & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSessionClusterResponseBody& setData(SessionCluster && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetSessionClusterResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline GetSessionClusterResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline GetSessionClusterResponseBody& setHttpCode(int32_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
    ...
    inline GetSessionClusterResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
