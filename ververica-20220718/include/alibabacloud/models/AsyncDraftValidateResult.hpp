...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->draftValidationDetail_ == nullptr
        && this->message_ == nullptr && this->success_ == nullptr && this->ticketStatus_ == nullptr; };
    ...
    inline const DraftValidationDetail & getDraftValidationDetail() const { DARABONBA_PTR_GET_CONST(draftValidationDetail_, DraftValidationDetail) };
    inline DraftValidationDetail getDraftValidationDetail() { DARABONBA_PTR_GET(draftValidationDetail_, DraftValidationDetail) };
  ...
  protected:
    shared_ptr<DraftValidationDetail> draftValidationDetail_ {};
