...
namespace Models
{
  ...
  public:
    ...
    inline const GetCatalogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCatalogsResponseBody) };
    inline GetCatalogsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCatalogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCatalogsResponseBody> body_ {};
  };
