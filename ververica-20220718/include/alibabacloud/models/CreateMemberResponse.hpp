...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMemberResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMemberResponseBody) };
    inline CreateMemberResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMemberResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMemberResponseBody> body_ {};
  };
