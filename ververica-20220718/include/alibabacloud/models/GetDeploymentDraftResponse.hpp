...
namespace Models
{
  ...
  public:
    ...
    inline const GetDeploymentDraftResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDeploymentDraftResponseBody) };
    inline GetDeploymentDraftResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDeploymentDraftResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDeploymentDraftResponseBody> body_ {};
  };
