...
namespace Models
{
  ...
  public:
    ...
    inline const ListDeploymentsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDeploymentsResponseBody) };
    inline ListDeploymentsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDeploymentsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDeploymentsResponseBody> body_ {};
  };
