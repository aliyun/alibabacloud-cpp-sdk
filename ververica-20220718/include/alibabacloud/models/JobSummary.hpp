...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cancelled_ == nullptr
        && this->cancelling_ == nullptr && this->failed_ == nullptr && this->finished_ == nullptr && this->running_ == nullptr && this->starting_ == nullptr; };
    ...
    inline int32_t getCancelling() const { DARABONBA_PTR_GET_DEFAULT(cancelling_, 0) };
    ...
    inline int32_t getStarting() const { DARABONBA_PTR_GET_DEFAULT(starting_, 0) };
  ...
  protected:
    ...
    shared_ptr<int32_t> cancelling_ {};
