...
namespace Models
{
  ...
  public:
    ...
    inline ResourceSpec& setCpu(double cpu) { DARABONBA_PTR_SET_VALUE(cpu_, cpu) };
    ...
    inline ResourceSpec& setMemory(string memory) { DARABONBA_PTR_SET_VALUE(memory_, memory) };
