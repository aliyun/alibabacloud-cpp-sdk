...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSessionClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateSessionClusterResponseBody) };
    inline UpdateSessionClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateSessionClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateSessionClusterResponseBody> body_ {};
  };
