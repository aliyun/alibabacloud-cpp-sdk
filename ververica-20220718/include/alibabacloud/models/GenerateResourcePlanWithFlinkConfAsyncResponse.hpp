...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateResourcePlanWithFlinkConfAsyncResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateResourcePlanWithFlinkConfAsyncResponseBody) };
    inline GenerateResourcePlanWithFlinkConfAsyncResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateResourcePlanWithFlinkConfAsyncResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateResourcePlanWithFlinkConfAsyncResponseBody> body_ {};
  };
