...
namespace Models
{
  ...
  public:
    ...
    inline const GetPreSignedUrlForPutObjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPreSignedUrlForPutObjectResponseBody) };
    inline GetPreSignedUrlForPutObjectResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPreSignedUrlForPutObjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPreSignedUrlForPutObjectResponseBody> body_ {};
  };
