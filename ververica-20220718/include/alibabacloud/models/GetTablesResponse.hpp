...
namespace Models
{
  ...
  public:
    ...
    inline const GetTablesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTablesResponseBody) };
    inline GetTablesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTablesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTablesResponseBody> body_ {};
  };
