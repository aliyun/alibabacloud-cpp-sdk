...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateScheduledPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateScheduledPlanResponseBody) };
    inline UpdateScheduledPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateScheduledPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateScheduledPlanResponseBody> body_ {};
  };
