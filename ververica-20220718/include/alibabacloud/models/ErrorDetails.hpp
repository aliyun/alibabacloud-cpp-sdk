...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->columnNumber_ == nullptr
        && this->endColumnNumber_ == nullptr && this->endLineNumber_ == nullptr && this->invalidflinkConf_ == nullptr && this->lineNumber_ == nullptr && this->message_ == nullptr; };
    ...
    inline const vector<string> & getInvalidflinkConf() const { DARABONBA_PTR_GET_CONST(invalidflinkConf_, vector<string>) };
    inline vector<string> getInvalidflinkConf() { DARABONBA_PTR_GET(invalidflinkConf_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> invalidflinkConf_ {};
