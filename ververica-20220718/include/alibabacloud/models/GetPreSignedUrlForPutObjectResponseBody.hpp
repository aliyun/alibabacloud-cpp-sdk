...
namespace Models
{
  ...
  public:
    ...
    inline const GetPreSignedUrlForObjectResult & getData() const { DARABONBA_PTR_GET_CONST(data_, GetPreSignedUrlForObjectResult) };
    inline GetPreSignedUrlForObjectResult getData() { DARABONBA_PTR_GET(data_, GetPreSignedUrlForObjectResult) };
  ...
  protected:
    shared_ptr<GetPreSignedUrlForObjectResult> data_ {};
