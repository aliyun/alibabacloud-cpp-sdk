...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomConnectorsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCustomConnectorsResponseBody) };
    inline ListCustomConnectorsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCustomConnectorsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCustomConnectorsResponseBody> body_ {};
  };
