...
namespace Models
{
  ...
  public:
    ...
    inline const ScheduledPlanAppliedInfo & getData() const { DARABONBA_PTR_GET_CONST(data_, ScheduledPlanAppliedInfo) };
    inline ScheduledPlanAppliedInfo getData() { DARABONBA_PTR_GET(data_, ScheduledPlanAppliedInfo) };
