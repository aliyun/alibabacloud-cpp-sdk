...
namespace Models
{
  ...
  public:
    ...
    inline const ListDeploymentTargetsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDeploymentTargetsResponseBody) };
    inline ListDeploymentTargetsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDeploymentTargetsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDeploymentTargetsResponseBody> body_ {};
  };
