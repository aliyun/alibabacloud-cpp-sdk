...
namespace Models
{
  ...
  public:
    ...
    inline const vector<SessionCluster> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<SessionCluster>) };
    inline vector<SessionCluster> data() { DARABONBA_PTR_GET(data_, vector<SessionCluster>) };
  ...
  protected:
    std::shared_ptr<vector<SessionCluster>> data_ = nullptr;
