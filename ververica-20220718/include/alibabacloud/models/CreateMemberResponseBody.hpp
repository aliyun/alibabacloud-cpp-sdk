...
namespace Models
{
  ...
  public:
    ...
    inline CreateMemberResponseBody& setData(const Member & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateMemberResponseBody& setData(Member && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateMemberResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline CreateMemberResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline CreateMemberResponseBody& setHttpCode(int32_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
    ...
    inline CreateMemberResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
