...
namespace Models
{
  ...
  public:
    ...
    inline const StartJobWithParamsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartJobWithParamsResponseBody) };
    inline StartJobWithParamsResponseBody getBody() { DARABONBA_PTR_GET(body_, StartJobWithParamsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartJobWithParamsResponseBody> body_ {};
  };
