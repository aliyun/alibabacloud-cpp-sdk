...
namespace Models
{
  ...
  public:
    ...
    inline const GetUdfArtifactsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUdfArtifactsResponseBody) };
    inline GetUdfArtifactsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUdfArtifactsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUdfArtifactsResponseBody> body_ {};
  };
