...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->observedFlinkJobRestarts_ == nullptr
        && this->observedFlinkJobStatus_ == nullptr; };
    ...
    inline int64_t getObservedFlinkJobRestarts() const { DARABONBA_PTR_GET_DEFAULT(observedFlinkJobRestarts_, 0L) };
    ...
    inline string getObservedFlinkJobStatus() const { DARABONBA_PTR_GET_DEFAULT(observedFlinkJobStatus_, "") };
  ...
  protected:
    ...
    shared_ptr<int64_t> observedFlinkJobRestarts_ {};
    // The status of the Flink job.
    shared_ptr<string> observedFlinkJobStatus_ {};
  };
