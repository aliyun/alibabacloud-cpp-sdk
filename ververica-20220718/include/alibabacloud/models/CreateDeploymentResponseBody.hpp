...
namespace Models
{
  ...
  public:
    ...
    inline CreateDeploymentResponseBody& setData(const Deployment & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateDeploymentResponseBody& setData(Deployment && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateDeploymentResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline CreateDeploymentResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline CreateDeploymentResponseBody& setHttpCode(int32_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
    ...
    inline CreateDeploymentResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
