...
namespace Models
{
  ...
  public:
    ...
    inline const SessionCluster & getData() const { DARABONBA_PTR_GET_CONST(data_, SessionCluster) };
    inline SessionCluster getData() { DARABONBA_PTR_GET(data_, SessionCluster) };
