...
namespace Models
{
  ...
  public:
    ...
    inline const SessionCluster & data() const { DARABONBA_PTR_GET_CONST(data_, SessionCluster) };
    inline SessionCluster data() { DARABONBA_PTR_GET(data_, SessionCluster) };
    inline CreateSessionClusterResponseBody& setData(const SessionCluster & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateSessionClusterResponseBody& setData(SessionCluster && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateSessionClusterResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline CreateSessionClusterResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline CreateSessionClusterResponseBody& setHttpCode(int32_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
    ...
    inline CreateSessionClusterResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    std::shared_ptr<SessionCluster> data_ = nullptr;
