...
namespace Models
{
  ...
  public:
    ...
    inline const GetSavepointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSavepointResponseBody) };
    inline GetSavepointResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSavepointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSavepointResponseBody> body_ {};
  };
