...
namespace Models
{
  ...
  public:
    ...
    inline const DeployDeploymentDraftAsyncResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DeployDeploymentDraftAsyncResponseBodyData) };
    inline DeployDeploymentDraftAsyncResponseBodyData data() { DARABONBA_PTR_GET(data_, DeployDeploymentDraftAsyncResponseBodyData) };
    inline DeployDeploymentDraftAsyncResponseBody& setData(const DeployDeploymentDraftAsyncResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeployDeploymentDraftAsyncResponseBody& setData(DeployDeploymentDraftAsyncResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DeployDeploymentDraftAsyncResponseBodyData> data_ = nullptr;
