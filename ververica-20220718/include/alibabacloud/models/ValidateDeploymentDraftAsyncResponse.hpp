...
namespace Models
{
  ...
  public:
    ...
    inline const ValidateDeploymentDraftAsyncResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ValidateDeploymentDraftAsyncResponseBody) };
    inline ValidateDeploymentDraftAsyncResponseBody getBody() { DARABONBA_PTR_GET(body_, ValidateDeploymentDraftAsyncResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ValidateDeploymentDraftAsyncResponseBody> body_ {};
  };
