...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCustomConnectorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCustomConnectorResponseBody) };
    inline DeleteCustomConnectorResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCustomConnectorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCustomConnectorResponseBody> body_ {};
  };
