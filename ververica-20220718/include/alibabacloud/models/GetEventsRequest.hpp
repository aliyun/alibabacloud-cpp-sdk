...
#ifndef ALIBABACLOUD_MODELS_GETEVENTSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETEVENTSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    ...
    GetEventsRequest(const GetEventsRequest &) = default ;
    GetEventsRequest(GetEventsRequest &&) = default ;
    GetEventsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetEventsRequest() = default ;
    GetEventsRequest& operator=(const GetEventsRequest &) = default ;
    GetEventsRequest& operator=(GetEventsRequest &&) = default ;
