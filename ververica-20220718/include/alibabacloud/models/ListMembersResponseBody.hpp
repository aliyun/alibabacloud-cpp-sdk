...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Member> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<Member>) };
    inline vector<Member> getData() { DARABONBA_PTR_GET(data_, vector<Member>) };
  ...
  protected:
    ...
    shared_ptr<vector<Member>> data_ {};
