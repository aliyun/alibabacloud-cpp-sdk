...
namespace Models
{
  ...
  public:
    ...
    inline const StopApplyScheduledPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopApplyScheduledPlanResponseBody) };
    inline StopApplyScheduledPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, StopApplyScheduledPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopApplyScheduledPlanResponseBody> body_ {};
  };
