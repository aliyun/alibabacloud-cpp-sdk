...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->creator_ == nullptr
        && this->executionMode_ == nullptr && this->labelKey_ == nullptr && this->labelValueArray_ == nullptr && this->modifier_ == nullptr && this->name_ == nullptr
        && this->pageIndex_ == nullptr && this->pageSize_ == nullptr && this->sortName_ == nullptr && this->status_ == nullptr; };
    ...
    inline string getLabelValueArray() const { DARABONBA_PTR_GET_DEFAULT(labelValueArray_, "") };
