...
namespace Models
{
  ...
  public:
    ...
    inline StartJobResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline StartJobResponseBody& setData(const Job & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline StartJobResponseBody& setData(Job && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline StartJobResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline StartJobResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline StartJobResponseBody& setHttpCode(int32_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
