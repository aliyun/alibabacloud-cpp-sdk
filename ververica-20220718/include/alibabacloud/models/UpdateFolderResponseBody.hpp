...
namespace Models
{
  ...
  public:
    ...
    inline const Folder & data() const { DARABONBA_PTR_GET_CONST(data_, Folder) };
    inline Folder data() { DARABONBA_PTR_GET(data_, Folder) };
    inline UpdateFolderResponseBody& setData(const Folder & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateFolderResponseBody& setData(Folder && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UpdateFolderResponseBody& setHttpCode(int32_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
  ...
  protected:
    std::shared_ptr<Folder> data_ = nullptr;
