...
namespace Models
{
  ...
  public:
    ...
    inline GetJobResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline GetJobResponseBody& setData(const Job & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetJobResponseBody& setData(Job && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetJobResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline GetJobResponseBody& setHttpCode(int32_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
