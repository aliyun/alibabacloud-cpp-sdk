...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->columnName_ == nullptr
        && this->columnNativeType_ == nullptr && this->columnType_ == nullptr && this->createdAt_ == nullptr && this->creator_ == nullptr && this->description_ == nullptr
        && this->id_ == nullptr && this->modifiedAt_ == nullptr && this->modifier_ == nullptr && this->nullable_ == nullptr; };
    ...
    inline string getColumnNativeType() const { DARABONBA_PTR_GET_DEFAULT(columnNativeType_, "") };
  ...
  protected:
    ...
    shared_ptr<string> columnNativeType_ {};
    // The column type.
