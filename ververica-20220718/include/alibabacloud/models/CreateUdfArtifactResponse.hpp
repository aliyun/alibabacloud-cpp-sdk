...
namespace Models
{
  ...
  public:
    ...
    inline const CreateUdfArtifactResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateUdfArtifactResponseBody) };
    inline CreateUdfArtifactResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateUdfArtifactResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateUdfArtifactResponseBody> body_ {};
  };
