...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->createdAt_ == nullptr
        && this->folderId_ == nullptr && this->modifiedAt_ == nullptr && this->name_ == nullptr && this->namespace_ == nullptr && this->parentId_ == nullptr
        && this->subFolder_ == nullptr && this->workspace_ == nullptr; };
    ...
    inline const vector<SubFolder> & getSubFolder() const { DARABONBA_PTR_GET_CONST(subFolder_, vector<SubFolder>) };
    inline vector<SubFolder> getSubFolder() { DARABONBA_PTR_GET(subFolder_, vector<SubFolder>) };
  ...
  protected:
    ...
    shared_ptr<vector<SubFolder>> subFolder_ {};
    // The workspace ID.
