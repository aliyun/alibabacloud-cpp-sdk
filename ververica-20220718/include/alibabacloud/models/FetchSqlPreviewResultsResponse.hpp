...
namespace Models
{
  ...
  public:
    ...
    inline const FetchSqlPreviewResultsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FetchSqlPreviewResultsResponseBody) };
    inline FetchSqlPreviewResultsResponseBody getBody() { DARABONBA_PTR_GET(body_, FetchSqlPreviewResultsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FetchSqlPreviewResultsResponseBody> body_ {};
  };
