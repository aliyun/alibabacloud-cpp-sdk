...
namespace Models
{
  ...
  public:
    ...
    inline const SqlStatementValidationResult & getData() const { DARABONBA_PTR_GET_CONST(data_, SqlStatementValidationResult) };
    inline SqlStatementValidationResult getData() { DARABONBA_PTR_GET(data_, SqlStatementValidationResult) };
  ...
  protected:
    ...
    shared_ptr<SqlStatementValidationResult> data_ {};
