...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DeploymentDraft> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<DeploymentDraft>) };
    inline vector<DeploymentDraft> getData() { DARABONBA_PTR_GET(data_, vector<DeploymentDraft>) };
