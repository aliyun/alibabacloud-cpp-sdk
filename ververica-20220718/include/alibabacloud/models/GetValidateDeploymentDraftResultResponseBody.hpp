...
namespace Models
{
  ...
  public:
    ...
    inline const AsyncDraftValidateResult & getData() const { DARABONBA_PTR_GET_CONST(data_, AsyncDraftValidateResult) };
    inline AsyncDraftValidateResult getData() { DARABONBA_PTR_GET(data_, AsyncDraftValidateResult) };
