...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDeploymentTargetV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateDeploymentTargetV2ResponseBody) };
    inline UpdateDeploymentTargetV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateDeploymentTargetV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateDeploymentTargetV2ResponseBody> body_ {};
  };
