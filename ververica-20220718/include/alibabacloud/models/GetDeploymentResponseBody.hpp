...
namespace Models
{
  ...
  public:
    ...
    inline GetDeploymentResponseBody& setData(const Deployment & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDeploymentResponseBody& setData(Deployment && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetDeploymentResponseBody& setHttpCode(int32_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
