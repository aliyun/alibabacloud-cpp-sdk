...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentSessionClusterStatus_ == nullptr
        && this->failure_ == nullptr && this->running_ == nullptr; };
    ...
    inline string getCurrentSessionClusterStatus() const { DARABONBA_PTR_GET_DEFAULT(currentSessionClusterStatus_, "") };
    ...
    inline const SessionClusterFailureInfo & getFailure() const { DARABONBA_PTR_GET_CONST(failure_, SessionClusterFailureInfo) };
    inline SessionClusterFailureInfo getFailure() { DARABONBA_PTR_GET(failure_, SessionClusterFailureInfo) };
    ...
    inline const SessionClusterRunningInfo & getRunning() const { DARABONBA_PTR_GET_CONST(running_, SessionClusterRunningInfo) };
    inline SessionClusterRunningInfo getRunning() { DARABONBA_PTR_GET(running_, SessionClusterRunningInfo) };
  ...
  protected:
    shared_ptr<string> currentSessionClusterStatus_ {};
    shared_ptr<SessionClusterFailureInfo> failure_ {};
    shared_ptr<SessionClusterRunningInfo> running_ {};
  };
