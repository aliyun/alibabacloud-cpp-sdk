...
namespace Models
{
  ...
  public:
    ...
    inline const GetEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetEventsResponseBody) };
    inline GetEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetEventsResponseBody> body_ {};
  };
