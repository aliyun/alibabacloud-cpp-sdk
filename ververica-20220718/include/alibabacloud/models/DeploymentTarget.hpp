...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->name_ == nullptr
        && this->namespace_ == nullptr && this->quota_ == nullptr; };
    ...
    inline const ResourceQuota & getQuota() const { DARABONBA_PTR_GET_CONST(quota_, ResourceQuota) };
    inline ResourceQuota getQuota() { DARABONBA_PTR_GET(quota_, ResourceQuota) };
