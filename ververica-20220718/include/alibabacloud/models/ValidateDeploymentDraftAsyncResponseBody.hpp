...
namespace Models
{
  ...
  public:
    ...
    inline const ValidateDeploymentDraftAsyncResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ValidateDeploymentDraftAsyncResponseBodyData) };
    inline ValidateDeploymentDraftAsyncResponseBodyData data() { DARABONBA_PTR_GET(data_, ValidateDeploymentDraftAsyncResponseBodyData) };
    inline ValidateDeploymentDraftAsyncResponseBody& setData(const ValidateDeploymentDraftAsyncResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ValidateDeploymentDraftAsyncResponseBody& setData(ValidateDeploymentDraftAsyncResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<ValidateDeploymentDraftAsyncResponseBodyData> data_ = nullptr;
