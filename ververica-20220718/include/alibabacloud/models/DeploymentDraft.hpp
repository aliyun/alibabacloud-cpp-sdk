...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->artifact_ == nullptr
        && this->createdAt_ == nullptr && this->creator_ == nullptr && this->creatorName_ == nullptr && this->deploymentDraftId_ == nullptr && this->engineVersion_ == nullptr
        && this->executionMode_ == nullptr && this->labels_ == nullptr && this->localVariables_ == nullptr && this->lock_ == nullptr && this->modifiedAt_ == nullptr
        && this->modifier_ == nullptr && this->modifierName_ == nullptr && this->name_ == nullptr && this->namespace_ == nullptr && this->parentId_ == nullptr
        && this->referencedDeploymentId_ == nullptr && this->workspace_ == nullptr; };
    ...
    inline const Lock & getLock() const { DARABONBA_PTR_GET_CONST(lock_, Lock) };
    inline Lock getLock() { DARABONBA_PTR_GET(lock_, Lock) };
    ...
    inline string getReferencedDeploymentId() const { DARABONBA_PTR_GET_DEFAULT(referencedDeploymentId_, "") };
