...
namespace Models
{
  ...
  public:
    ...
    inline const GetHotUpdateJobResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHotUpdateJobResultResponseBody) };
    inline GetHotUpdateJobResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHotUpdateJobResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHotUpdateJobResultResponseBody> body_ {};
  };
