...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateUdfArtifactResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateUdfArtifactResponseBody) };
    inline UpdateUdfArtifactResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateUdfArtifactResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateUdfArtifactResponseBody> body_ {};
  };
