...
#ifndef ALIBABACLOUD_MODELS_UPDATEPATROLCONFIGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATEPATROLCONFIGRESPONSEBODY_HPP_
...
namespace Models
{
  class UpdatePatrolConfigResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdatePatrolConfigResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdatePatrolConfigResponseBody& obj) { 
    ...
    UpdatePatrolConfigResponseBody() = default ;
    UpdatePatrolConfigResponseBody(const UpdatePatrolConfigResponseBody &) = default ;
    UpdatePatrolConfigResponseBody(UpdatePatrolConfigResponseBody &&) = default ;
    UpdatePatrolConfigResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdatePatrolConfigResponseBody() = default ;
    UpdatePatrolConfigResponseBody& operator=(const UpdatePatrolConfigResponseBody &) = default ;
    UpdatePatrolConfigResponseBody& operator=(UpdatePatrolConfigResponseBody &&) = default ;
    ...
    inline const UpdatePatrolConfigResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdatePatrolConfigResponseBody::Data) };
    inline UpdatePatrolConfigResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdatePatrolConfigResponseBody::Data) };
    inline UpdatePatrolConfigResponseBody& setData(const UpdatePatrolConfigResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdatePatrolConfigResponseBody& setData(UpdatePatrolConfigResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UpdatePatrolConfigResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline UpdatePatrolConfigResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline UpdatePatrolConfigResponseBody& setHttpCode(int32_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
    ...
    inline UpdatePatrolConfigResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline UpdatePatrolConfigResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // The inspection configuration response data.
    shared_ptr<UpdatePatrolConfigResponseBody::Data> data_ {};
