...
namespace Models
{
  ...
  public:
    ...
    inline GetMemberResponseBody& setData(const Member & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMemberResponseBody& setData(Member && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetMemberResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline GetMemberResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline GetMemberResponseBody& setHttpCode(int32_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
    ...
    inline GetMemberResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
