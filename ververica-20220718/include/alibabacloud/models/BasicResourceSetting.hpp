...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->jobmanagerResourceSettingSpec_ == nullptr
        && this->parallelism_ == nullptr && this->taskmanagerResourceSettingSpec_ == nullptr; };
    ...
    inline const BasicResourceSettingSpec & getTaskmanagerResourceSettingSpec() const { DARABONBA_PTR_GET_CONST(taskmanagerResourceSettingSpec_, BasicResourceSettingSpec) };
    inline BasicResourceSettingSpec getTaskmanagerResourceSettingSpec() { DARABONBA_PTR_GET(taskmanagerResourceSettingSpec_, BasicResourceSettingSpec) };
