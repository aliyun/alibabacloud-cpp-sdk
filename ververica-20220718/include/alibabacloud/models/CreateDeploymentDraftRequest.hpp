...
namespace Models
{
  ...
  public:
    ...
    inline const DeploymentDraft & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeploymentDraft) };
    inline DeploymentDraft getBody() { DARABONBA_PTR_GET(body_, DeploymentDraft) };
