...
namespace Models
{
  ...
  public:
    ...
    inline const SetResellerUserQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetResellerUserQuotaResponseBody) };
    inline SetResellerUserQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, SetResellerUserQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetResellerUserQuotaResponseBody> body_ {};
  };
