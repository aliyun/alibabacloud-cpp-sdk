...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeProductAmortizedCostByAmortizationPeriodResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeProductAmortizedCostByAmortizationPeriodResponseBody::Data) };
    inline DescribeProductAmortizedCostByAmortizationPeriodResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeProductAmortizedCostByAmortizationPeriodResponseBody::Data) };
    inline DescribeProductAmortizedCostByAmortizationPeriodResponseBody& setData(const DescribeProductAmortizedCostByAmortizationPeriodResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeProductAmortizedCostByAmortizationPeriodResponseBody& setData(DescribeProductAmortizedCostByAmortizationPeriodResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    shared_ptr<DescribeProductAmortizedCostByAmortizationPeriodResponseBody::Data> data_ {};
