...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSavingsPlansUsageTotalResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSavingsPlansUsageTotalResponseBodyData) };
    inline DescribeSavingsPlansUsageTotalResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSavingsPlansUsageTotalResponseBodyData) };
    inline DescribeSavingsPlansUsageTotalResponseBody& setData(const DescribeSavingsPlansUsageTotalResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSavingsPlansUsageTotalResponseBody& setData(DescribeSavingsPlansUsageTotalResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The return data.
    std::shared_ptr<DescribeSavingsPlansUsageTotalResponseBodyData> data_ = nullptr;
