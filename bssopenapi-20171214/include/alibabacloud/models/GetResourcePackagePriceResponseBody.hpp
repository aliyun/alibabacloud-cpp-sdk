...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourcePackagePriceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetResourcePackagePriceResponseBodyData) };
    inline GetResourcePackagePriceResponseBodyData data() { DARABONBA_PTR_GET(data_, GetResourcePackagePriceResponseBodyData) };
    inline GetResourcePackagePriceResponseBody& setData(const GetResourcePackagePriceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetResourcePackagePriceResponseBody& setData(GetResourcePackagePriceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetResourcePackagePriceResponseBodyData> data_ = nullptr;
