...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceBillResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeInstanceBillResponseBodyData) };
    inline DescribeInstanceBillResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeInstanceBillResponseBodyData) };
    inline DescribeInstanceBillResponseBody& setData(const DescribeInstanceBillResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeInstanceBillResponseBody& setData(DescribeInstanceBillResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeInstanceBillResponseBodyData> data_ = nullptr;
