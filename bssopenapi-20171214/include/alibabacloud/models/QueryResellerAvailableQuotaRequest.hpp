...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->itemCodes_ == nullptr
    ...
    inline string getItemCodes() const { DARABONBA_PTR_GET_DEFAULT(itemCodes_, "") };
