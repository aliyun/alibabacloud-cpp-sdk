...
namespace Models
{
  ...
  public:
    ...
    inline const QueryBillOverviewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryBillOverviewResponseBody) };
    inline QueryBillOverviewResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryBillOverviewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryBillOverviewResponseBody> body_ {};
  };
