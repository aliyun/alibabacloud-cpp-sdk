...
namespace Models
{
  ...
  public:
    ...
    inline const QueryRedeemResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryRedeemResponseBody) };
    inline QueryRedeemResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryRedeemResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryRedeemResponseBody> body_ {};
  };
