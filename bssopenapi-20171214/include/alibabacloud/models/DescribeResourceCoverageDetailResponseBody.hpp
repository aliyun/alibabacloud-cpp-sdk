...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourceCoverageDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeResourceCoverageDetailResponseBodyData) };
    inline DescribeResourceCoverageDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeResourceCoverageDetailResponseBodyData) };
    inline DescribeResourceCoverageDetailResponseBody& setData(const DescribeResourceCoverageDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeResourceCoverageDetailResponseBody& setData(DescribeResourceCoverageDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<DescribeResourceCoverageDetailResponseBodyData> data_ = nullptr;
