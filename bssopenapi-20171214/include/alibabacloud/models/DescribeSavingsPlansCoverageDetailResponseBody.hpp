...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSavingsPlansCoverageDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSavingsPlansCoverageDetailResponseBodyData) };
    inline DescribeSavingsPlansCoverageDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSavingsPlansCoverageDetailResponseBodyData) };
    inline DescribeSavingsPlansCoverageDetailResponseBody& setData(const DescribeSavingsPlansCoverageDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSavingsPlansCoverageDetailResponseBody& setData(DescribeSavingsPlansCoverageDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The return data.
    std::shared_ptr<DescribeSavingsPlansCoverageDetailResponseBodyData> data_ = nullptr;
