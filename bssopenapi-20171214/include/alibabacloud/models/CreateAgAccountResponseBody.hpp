...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->agRelationDto_ != nullptr
    ...
    inline const CreateAgAccountResponseBodyAgRelationDto & agRelationDto() const { DARABONBA_PTR_GET_CONST(agRelationDto_, CreateAgAccountResponseBodyAgRelationDto) };
    inline CreateAgAccountResponseBodyAgRelationDto agRelationDto() { DARABONBA_PTR_GET(agRelationDto_, CreateAgAccountResponseBodyAgRelationDto) };
    inline CreateAgAccountResponseBody& setAgRelationDto(const CreateAgAccountResponseBodyAgRelationDto & agRelationDto) { DARABONBA_PTR_SET_VALUE(agRelationDto_, agRelationDto) };
    inline CreateAgAccountResponseBody& setAgRelationDto(CreateAgAccountResponseBodyAgRelationDto && agRelationDto) { DARABONBA_PTR_SET_RVALUE(agRelationDto_, agRelationDto) };
  ...
  protected:
    ...
    std::shared_ptr<CreateAgAccountResponseBodyAgRelationDto> agRelationDto_ = nullptr;
