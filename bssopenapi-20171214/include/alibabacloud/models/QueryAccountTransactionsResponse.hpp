...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAccountTransactionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryAccountTransactionsResponseBody) };
    inline QueryAccountTransactionsResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryAccountTransactionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryAccountTransactionsResponseBody> body_ {};
  };
