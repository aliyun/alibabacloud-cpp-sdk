...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateResourcePackageResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateResourcePackageResponseBody& obj) { 
    ...
    CreateResourcePackageResponseBody() = default ;
    CreateResourcePackageResponseBody(const CreateResourcePackageResponseBody &) = default ;
    CreateResourcePackageResponseBody(CreateResourcePackageResponseBody &&) = default ;
    CreateResourcePackageResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateResourcePackageResponseBody() = default ;
    CreateResourcePackageResponseBody& operator=(const CreateResourcePackageResponseBody &) = default ;
    CreateResourcePackageResponseBody& operator=(CreateResourcePackageResponseBody &&) = default ;
