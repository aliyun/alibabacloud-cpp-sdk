...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ModifyCostUnitResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ModifyCostUnitResponseBodyData>) };
    inline vector<ModifyCostUnitResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ModifyCostUnitResponseBodyData>) };
    inline ModifyCostUnitResponseBody& setData(const vector<ModifyCostUnitResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyCostUnitResponseBody& setData(vector<ModifyCostUnitResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<vector<ModifyCostUnitResponseBodyData>> data_ = nullptr;
