...
namespace Models
{
  ...
  public:
    ...
    inline const CancelOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelOrderResponseBody) };
    inline CancelOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelOrderResponseBody> body_ {};
  };
