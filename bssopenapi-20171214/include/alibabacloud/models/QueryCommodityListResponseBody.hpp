...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCommodityListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryCommodityListResponseBodyData) };
    inline QueryCommodityListResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryCommodityListResponseBodyData) };
    inline QueryCommodityListResponseBody& setData(const QueryCommodityListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryCommodityListResponseBody& setData(QueryCommodityListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<QueryCommodityListResponseBodyData> data_ = nullptr;
