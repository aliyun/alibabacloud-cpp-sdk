...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceBillResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceBillResponseBody) };
    inline DescribeInstanceBillResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceBillResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceBillResponseBody> body_ {};
  };
