...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEINSTANCEDEDUCTAMORTIZEDCOSTBYAMORTIZATIONPERIODRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEINSTANCEDEDUCTAMORTIZEDCOSTBYAMORTIZATIONPERIODRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody& obj) { 
    ...
    DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody() = default ;
    DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody(const DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody &) = default ;
    DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody(DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody &&) = default ;
    DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody() = default ;
    DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody& operator=(const DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody &) = default ;
    DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody& operator=(DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline string getReferFrInstanceID() const { DARABONBA_PTR_GET_DEFAULT(referFrInstanceID_, "") };
        inline Items& setReferFrInstanceID(string referFrInstanceID) { DARABONBA_PTR_SET_VALUE(referFrInstanceID_, referFrInstanceID) };
        ...
        inline string getReferFrOwnerID() const { DARABONBA_PTR_GET_DEFAULT(referFrOwnerID_, "") };
        inline Items& setReferFrOwnerID(string referFrOwnerID) { DARABONBA_PTR_SET_VALUE(referFrOwnerID_, referFrOwnerID) };
        ...
        inline string getReferFrProductDetailCode() const { DARABONBA_PTR_GET_DEFAULT(referFrProductDetailCode_, "") };
        inline Items& setReferFrProductDetailCode(string referFrProductDetailCode) { DARABONBA_PTR_SET_VALUE(referFrProductDetailCode_, referFrProductDetailCode) };
        ...
        inline double getUnusedAmortizationDeductedByCoupons() const { DARABONBA_PTR_GET_DEFAULT(unusedAmortizationDeductedByCoupons_, 0.0) };
        inline Items& setUnusedAmortizationDeductedByCoupons(double unusedAmortizationDeductedByCoupons) { DARABONBA_PTR_SET_VALUE(unusedAmortizationDeductedByCoupons_, unusedAmortizationDeductedByCoupons) };
        ...
        inline double getUnusedAmortizationInvoiceDiscount() const { DARABONBA_PTR_GET_DEFAULT(unusedAmortizationInvoiceDiscount_, 0.0) };
        inline Items& setUnusedAmortizationInvoiceDiscount(double unusedAmortizationInvoiceDiscount) { DARABONBA_PTR_SET_VALUE(unusedAmortizationInvoiceDiscount_, unusedAmortizationInvoiceDiscount) };
        ...
        inline double getUnusedAmortizationPretaxAmount() const { DARABONBA_PTR_GET_DEFAULT(unusedAmortizationPretaxAmount_, 0.0) };
        inline Items& setUnusedAmortizationPretaxAmount(double unusedAmortizationPretaxAmount) { DARABONBA_PTR_SET_VALUE(unusedAmortizationPretaxAmount_, unusedAmortizationPretaxAmount) };
        ...
        inline double getUnusedAmortizationPretaxGrossAmount() const { DARABONBA_PTR_GET_DEFAULT(unusedAmortizationPretaxGrossAmount_, 0.0) };
        inline Items& setUnusedAmortizationPretaxGrossAmount(double unusedAmortizationPretaxGrossAmount) { DARABONBA_PTR_SET_VALUE(unusedAmortizationPretaxGrossAmount_, unusedAmortizationPretaxGrossAmount) };
        ...
        inline double getUnusedAmortizationRoundDownDiscount() const { DARABONBA_PTR_GET_DEFAULT(unusedAmortizationRoundDownDiscount_, 0.0) };
        inline Items& setUnusedAmortizationRoundDownDiscount(double unusedAmortizationRoundDownDiscount) { DARABONBA_PTR_SET_VALUE(unusedAmortizationRoundDownDiscount_, unusedAmortizationRoundDownDiscount) };
      ...
      protected:
        ...
        shared_ptr<string> referFrInstanceID_ {};
        shared_ptr<string> referFrOwnerID_ {};
        shared_ptr<string> referFrProductDetailCode_ {};
        ...
        shared_ptr<double> unusedAmortizationDeductedByCoupons_ {};
        shared_ptr<double> unusedAmortizationInvoiceDiscount_ {};
        shared_ptr<double> unusedAmortizationPretaxAmount_ {};
        shared_ptr<double> unusedAmortizationPretaxGrossAmount_ {};
        shared_ptr<double> unusedAmortizationRoundDownDiscount_ {};
    ...
    inline DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody::Data) };
    inline DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody::Data) };
    inline DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody& setData(const DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody& setData(DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<DescribeInstanceDeductAmortizedCostByAmortizationPeriodResponseBody::Data> data_ {};
