...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeProductAmortizedCostByConsumePeriodResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeProductAmortizedCostByConsumePeriodResponseBodyData) };
    inline DescribeProductAmortizedCostByConsumePeriodResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeProductAmortizedCostByConsumePeriodResponseBodyData) };
    inline DescribeProductAmortizedCostByConsumePeriodResponseBody& setData(const DescribeProductAmortizedCostByConsumePeriodResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeProductAmortizedCostByConsumePeriodResponseBody& setData(DescribeProductAmortizedCostByConsumePeriodResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeProductAmortizedCostByConsumePeriodResponseBodyData> data_ = nullptr;
