...
namespace Models
{
  ...
  public:
    ...
    inline const QueryRelationListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryRelationListResponseBody) };
    inline QueryRelationListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryRelationListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryRelationListResponseBody> body_ {};
  };
