...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySavingsPlansDiscountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QuerySavingsPlansDiscountResponseBody) };
    inline QuerySavingsPlansDiscountResponseBody getBody() { DARABONBA_PTR_GET(body_, QuerySavingsPlansDiscountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QuerySavingsPlansDiscountResponseBody> body_ {};
  };
