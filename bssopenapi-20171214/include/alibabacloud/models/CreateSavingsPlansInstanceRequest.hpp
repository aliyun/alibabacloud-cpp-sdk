...
namespace Models
{
  ...
  public:
    ...
    inline const map<string, string> & extendMap() const { DARABONBA_PTR_GET_CONST(extendMap_, map<string, string>) };
    inline map<string, string> extendMap() { DARABONBA_PTR_GET(extendMap_, map<string, string>) };
  ...
  protected:
    ...
    std::shared_ptr<map<string, string>> extendMap_ = nullptr;
