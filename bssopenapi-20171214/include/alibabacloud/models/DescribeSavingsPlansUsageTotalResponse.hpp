...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSavingsPlansUsageTotalResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSavingsPlansUsageTotalResponseBody) };
    inline DescribeSavingsPlansUsageTotalResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSavingsPlansUsageTotalResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSavingsPlansUsageTotalResponseBody> body_ {};
  };
