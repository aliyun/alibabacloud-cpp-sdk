...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryInstanceByTagRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<QueryInstanceByTagRequest::Tag>) };
    inline vector<QueryInstanceByTagRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<QueryInstanceByTagRequest::Tag>) };
    inline QueryInstanceByTagRequest& setTag(const vector<QueryInstanceByTagRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline QueryInstanceByTagRequest& setTag(vector<QueryInstanceByTagRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // The tags.
    shared_ptr<vector<QueryInstanceByTagRequest::Tag>> tag_ {};
  };
