...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCostUnitResourceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryCostUnitResourceResponseBodyData) };
    inline QueryCostUnitResourceResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryCostUnitResourceResponseBodyData) };
    inline QueryCostUnitResourceResponseBody& setData(const QueryCostUnitResourceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryCostUnitResourceResponseBody& setData(QueryCostUnitResourceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryCostUnitResourceResponseBodyData> data_ = nullptr;
    // The error message.
