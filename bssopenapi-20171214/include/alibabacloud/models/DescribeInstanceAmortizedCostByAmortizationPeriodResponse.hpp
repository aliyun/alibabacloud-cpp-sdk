...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody) };
    inline DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody> body_ {};
  };
