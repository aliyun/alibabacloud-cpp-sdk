...
namespace Models
{
  ...
  public:
    ...
    inline const QueryPriceEntityListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryPriceEntityListResponseBodyData) };
    inline QueryPriceEntityListResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryPriceEntityListResponseBodyData) };
    inline QueryPriceEntityListResponseBody& setData(const QueryPriceEntityListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryPriceEntityListResponseBody& setData(QueryPriceEntityListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryPriceEntityListResponseBodyData> data_ = nullptr;
