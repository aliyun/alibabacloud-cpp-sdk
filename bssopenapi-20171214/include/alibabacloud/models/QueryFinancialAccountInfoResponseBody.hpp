...
namespace Models
{
  ...
  public:
    ...
    inline const QueryFinancialAccountInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryFinancialAccountInfoResponseBodyData) };
    inline QueryFinancialAccountInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryFinancialAccountInfoResponseBodyData) };
    inline QueryFinancialAccountInfoResponseBody& setData(const QueryFinancialAccountInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryFinancialAccountInfoResponseBody& setData(QueryFinancialAccountInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryFinancialAccountInfoResponseBodyData> data_ = nullptr;
