...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEINSTANCEAMORTIZEDCOSTBYCONSUMEPERIODRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEINSTANCEAMORTIZEDCOSTBYCONSUMEPERIODRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeInstanceAmortizedCostByConsumePeriodResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeInstanceAmortizedCostByConsumePeriodResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeInstanceAmortizedCostByConsumePeriodResponseBody& obj) { 
    ...
    DescribeInstanceAmortizedCostByConsumePeriodResponseBody() = default ;
    DescribeInstanceAmortizedCostByConsumePeriodResponseBody(const DescribeInstanceAmortizedCostByConsumePeriodResponseBody &) = default ;
    DescribeInstanceAmortizedCostByConsumePeriodResponseBody(DescribeInstanceAmortizedCostByConsumePeriodResponseBody &&) = default ;
    DescribeInstanceAmortizedCostByConsumePeriodResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeInstanceAmortizedCostByConsumePeriodResponseBody() = default ;
    DescribeInstanceAmortizedCostByConsumePeriodResponseBody& operator=(const DescribeInstanceAmortizedCostByConsumePeriodResponseBody &) = default ;
    DescribeInstanceAmortizedCostByConsumePeriodResponseBody& operator=(DescribeInstanceAmortizedCostByConsumePeriodResponseBody &&) = default ;
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DescribeInstanceAmortizedCostByConsumePeriodResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeInstanceAmortizedCostByConsumePeriodResponseBody::Data) };
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeInstanceAmortizedCostByConsumePeriodResponseBody::Data) };
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBody& setData(const DescribeInstanceAmortizedCostByConsumePeriodResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBody& setData(DescribeInstanceAmortizedCostByConsumePeriodResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<DescribeInstanceAmortizedCostByConsumePeriodResponseBody::Data> data_ {};
