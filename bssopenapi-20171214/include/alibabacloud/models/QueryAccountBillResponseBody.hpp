...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAccountBillResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryAccountBillResponseBodyData) };
    inline QueryAccountBillResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryAccountBillResponseBodyData) };
    inline QueryAccountBillResponseBody& setData(const QueryAccountBillResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryAccountBillResponseBody& setData(QueryAccountBillResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryAccountBillResponseBodyData> data_ = nullptr;
