...
#ifndef ALIBABACLOUD_MODELS_QUERYCOSTUNITRESOURCERESPONSEBODYDATACOSTUNIT_HPP_
#define ALIBABACLOUD_MODELS_QUERYCOSTUNITRESOURCERESPONSEBODYDATACOSTUNIT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryCostUnitResourceResponseBodyDataCostUnit& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryCostUnitResourceResponseBodyDataCostUnit& obj) { 
    ...
    QueryCostUnitResourceResponseBodyDataCostUnit() = default ;
    QueryCostUnitResourceResponseBodyDataCostUnit(const QueryCostUnitResourceResponseBodyDataCostUnit &) = default ;
    QueryCostUnitResourceResponseBodyDataCostUnit(QueryCostUnitResourceResponseBodyDataCostUnit &&) = default ;
    QueryCostUnitResourceResponseBodyDataCostUnit(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryCostUnitResourceResponseBodyDataCostUnit() = default ;
    QueryCostUnitResourceResponseBodyDataCostUnit& operator=(const QueryCostUnitResourceResponseBodyDataCostUnit &) = default ;
    QueryCostUnitResourceResponseBodyDataCostUnit& operator=(QueryCostUnitResourceResponseBodyDataCostUnit &&) = default ;
    ...
    inline QueryCostUnitResourceResponseBodyDataCostUnit& setOwnerUid(int64_t ownerUid) { DARABONBA_PTR_SET_VALUE(ownerUid_, ownerUid) };
    ...
    inline QueryCostUnitResourceResponseBodyDataCostUnit& setParentUnitId(int64_t parentUnitId) { DARABONBA_PTR_SET_VALUE(parentUnitId_, parentUnitId) };
    ...
    inline QueryCostUnitResourceResponseBodyDataCostUnit& setUnitId(int64_t unitId) { DARABONBA_PTR_SET_VALUE(unitId_, unitId) };
    ...
    inline QueryCostUnitResourceResponseBodyDataCostUnit& setUnitName(string unitName) { DARABONBA_PTR_SET_VALUE(unitName_, unitName) };
