...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alarmThresholds_ == nullptr
    ...
    inline string getAlarmThresholds() const { DARABONBA_PTR_GET_DEFAULT(alarmThresholds_, "") };
  ...
  protected:
    shared_ptr<string> alarmThresholds_ {};
