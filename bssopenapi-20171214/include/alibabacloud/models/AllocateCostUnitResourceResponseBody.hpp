...
namespace Models
{
  ...
  public:
    ...
    inline const AllocateCostUnitResourceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AllocateCostUnitResourceResponseBodyData) };
    inline AllocateCostUnitResourceResponseBodyData data() { DARABONBA_PTR_GET(data_, AllocateCostUnitResourceResponseBodyData) };
    inline AllocateCostUnitResourceResponseBody& setData(const AllocateCostUnitResourceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AllocateCostUnitResourceResponseBody& setData(AllocateCostUnitResourceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<AllocateCostUnitResourceResponseBodyData> data_ = nullptr;
