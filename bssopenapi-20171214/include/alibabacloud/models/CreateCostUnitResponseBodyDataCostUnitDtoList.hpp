...
#ifndef ALIBABACLOUD_MODELS_CREATECOSTUNITRESPONSEBODYDATACOSTUNITDTOLIST_HPP_
#define ALIBABACLOUD_MODELS_CREATECOSTUNITRESPONSEBODYDATACOSTUNITDTOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateCostUnitResponseBodyDataCostUnitDtoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateCostUnitResponseBodyDataCostUnitDtoList& obj) { 
    ...
    CreateCostUnitResponseBodyDataCostUnitDtoList() = default ;
    CreateCostUnitResponseBodyDataCostUnitDtoList(const CreateCostUnitResponseBodyDataCostUnitDtoList &) = default ;
    CreateCostUnitResponseBodyDataCostUnitDtoList(CreateCostUnitResponseBodyDataCostUnitDtoList &&) = default ;
    CreateCostUnitResponseBodyDataCostUnitDtoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateCostUnitResponseBodyDataCostUnitDtoList() = default ;
    CreateCostUnitResponseBodyDataCostUnitDtoList& operator=(const CreateCostUnitResponseBodyDataCostUnitDtoList &) = default ;
    CreateCostUnitResponseBodyDataCostUnitDtoList& operator=(CreateCostUnitResponseBodyDataCostUnitDtoList &&) = default ;
    ...
    inline CreateCostUnitResponseBodyDataCostUnitDtoList& setOwnerUid(int64_t ownerUid) { DARABONBA_PTR_SET_VALUE(ownerUid_, ownerUid) };
    ...
    inline CreateCostUnitResponseBodyDataCostUnitDtoList& setParentUnitId(int64_t parentUnitId) { DARABONBA_PTR_SET_VALUE(parentUnitId_, parentUnitId) };
    ...
    inline CreateCostUnitResponseBodyDataCostUnitDtoList& setUnitId(int64_t unitId) { DARABONBA_PTR_SET_VALUE(unitId_, unitId) };
    ...
    inline CreateCostUnitResponseBodyDataCostUnitDtoList& setUnitName(string unitName) { DARABONBA_PTR_SET_VALUE(unitName_, unitName) };
