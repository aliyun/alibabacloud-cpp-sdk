...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourceUsageTotalResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeResourceUsageTotalResponseBody) };
    inline DescribeResourceUsageTotalResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeResourceUsageTotalResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeResourceUsageTotalResponseBody> body_ {};
  };
