...
namespace Models
{
  ...
  public:
    ...
    inline const QueryBillOverviewResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryBillOverviewResponseBodyData) };
    inline QueryBillOverviewResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryBillOverviewResponseBodyData) };
    inline QueryBillOverviewResponseBody& setData(const QueryBillOverviewResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryBillOverviewResponseBody& setData(QueryBillOverviewResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryBillOverviewResponseBodyData> data_ = nullptr;
