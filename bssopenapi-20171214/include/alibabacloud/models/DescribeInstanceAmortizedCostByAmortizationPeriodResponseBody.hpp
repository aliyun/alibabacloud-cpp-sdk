...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEINSTANCEAMORTIZEDCOSTBYAMORTIZATIONPERIODRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEINSTANCEAMORTIZEDCOSTBYAMORTIZATIONPERIODRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody& obj) { 
    ...
    DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody() = default ;
    DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody(const DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody &) = default ;
    DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody(DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody &&) = default ;
    DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody() = default ;
    DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody& operator=(const DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody &) = default ;
    DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody& operator=(DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody &&) = default ;
    ...
    inline DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody::Data) };
    inline DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody::Data) };
    inline DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody& setData(const DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody& setData(DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    // The data returned.
    shared_ptr<DescribeInstanceAmortizedCostByAmortizationPeriodResponseBody::Data> data_ {};
