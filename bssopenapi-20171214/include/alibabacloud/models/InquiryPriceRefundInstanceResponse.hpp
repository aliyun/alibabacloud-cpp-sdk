...
namespace Models
{
  ...
  public:
    ...
    inline const InquiryPriceRefundInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InquiryPriceRefundInstanceResponseBody) };
    inline InquiryPriceRefundInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, InquiryPriceRefundInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InquiryPriceRefundInstanceResponseBody> body_ {};
  };
