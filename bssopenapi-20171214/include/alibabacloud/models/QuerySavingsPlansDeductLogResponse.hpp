...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySavingsPlansDeductLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QuerySavingsPlansDeductLogResponseBody) };
    inline QuerySavingsPlansDeductLogResponseBody getBody() { DARABONBA_PTR_GET(body_, QuerySavingsPlansDeductLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QuerySavingsPlansDeductLogResponseBody> body_ {};
  };
