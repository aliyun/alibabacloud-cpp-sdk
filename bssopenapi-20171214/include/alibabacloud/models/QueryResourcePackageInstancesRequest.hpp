...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->expiryTimeEnd_ == nullptr
    ...
    inline bool getIncludePartner() const { DARABONBA_PTR_GET_DEFAULT(includePartner_, false) };
  ...
  protected:
    ...
    shared_ptr<bool> includePartner_ {};
