...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourceUsageDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeResourceUsageDetailResponseBodyData) };
    inline DescribeResourceUsageDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeResourceUsageDetailResponseBodyData) };
    inline DescribeResourceUsageDetailResponseBody& setData(const DescribeResourceUsageDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeResourceUsageDetailResponseBody& setData(DescribeResourceUsageDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<DescribeResourceUsageDetailResponseBodyData> data_ = nullptr;
