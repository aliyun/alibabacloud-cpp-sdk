...
namespace Models
{
  ...
  public:
    ...
    inline const QueryPrepaidCardsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryPrepaidCardsResponseBodyData) };
    inline QueryPrepaidCardsResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryPrepaidCardsResponseBodyData) };
    inline QueryPrepaidCardsResponseBody& setData(const QueryPrepaidCardsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryPrepaidCardsResponseBody& setData(QueryPrepaidCardsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryPrepaidCardsResponseBodyData> data_ = nullptr;
