...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySavingsPlansDeductLogResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QuerySavingsPlansDeductLogResponseBodyData) };
    inline QuerySavingsPlansDeductLogResponseBodyData data() { DARABONBA_PTR_GET(data_, QuerySavingsPlansDeductLogResponseBodyData) };
    inline QuerySavingsPlansDeductLogResponseBody& setData(const QuerySavingsPlansDeductLogResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QuerySavingsPlansDeductLogResponseBody& setData(QuerySavingsPlansDeductLogResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The return data.
    std::shared_ptr<QuerySavingsPlansDeductLogResponseBodyData> data_ = nullptr;
