...
namespace Models
{
  ...
  public:
    ...
    inline const QueryBillToOSSSubscriptionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryBillToOSSSubscriptionResponseBodyData) };
    inline QueryBillToOSSSubscriptionResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryBillToOSSSubscriptionResponseBodyData) };
    inline QueryBillToOSSSubscriptionResponseBody& setData(const QueryBillToOSSSubscriptionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryBillToOSSSubscriptionResponseBody& setData(QueryBillToOSSSubscriptionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<QueryBillToOSSSubscriptionResponseBodyData> data_ = nullptr;
