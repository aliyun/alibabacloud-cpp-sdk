...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySkuPriceListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QuerySkuPriceListResponseBodyData) };
    inline QuerySkuPriceListResponseBodyData data() { DARABONBA_PTR_GET(data_, QuerySkuPriceListResponseBodyData) };
    inline QuerySkuPriceListResponseBody& setData(const QuerySkuPriceListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QuerySkuPriceListResponseBody& setData(QuerySkuPriceListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QuerySkuPriceListResponseBodyData> data_ = nullptr;
