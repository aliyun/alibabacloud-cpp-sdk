...
namespace Models
{
  ...
  public:
    ...
    inline const GetSubscriptionPriceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSubscriptionPriceResponseBodyData) };
    inline GetSubscriptionPriceResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSubscriptionPriceResponseBodyData) };
    inline GetSubscriptionPriceResponseBody& setData(const GetSubscriptionPriceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSubscriptionPriceResponseBody& setData(GetSubscriptionPriceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetSubscriptionPriceResponseBodyData> data_ = nullptr;
