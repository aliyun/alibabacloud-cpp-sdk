...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSavingsPlansCoverageDetailRequest::FilterParam & getFilterParam() const { DARABONBA_PTR_GET_CONST(filterParam_, DescribeSavingsPlansCoverageDetailRequest::FilterParam) };
    inline DescribeSavingsPlansCoverageDetailRequest::FilterParam getFilterParam() { DARABONBA_PTR_GET(filterParam_, DescribeSavingsPlansCoverageDetailRequest::FilterParam) };
    inline DescribeSavingsPlansCoverageDetailRequest& setFilterParam(const DescribeSavingsPlansCoverageDetailRequest::FilterParam & filterParam) { DARABONBA_PTR_SET_VALUE(filterParam_, filterParam) };
    inline DescribeSavingsPlansCoverageDetailRequest& setFilterParam(DescribeSavingsPlansCoverageDetailRequest::FilterParam && filterParam) { DARABONBA_PTR_SET_RVALUE(filterParam_, filterParam) };
  ...
  protected:
    ...
    shared_ptr<DescribeSavingsPlansCoverageDetailRequest::FilterParam> filterParam_ {};
