...
namespace Models
{
  ...
  public:
    ...
    inline const QueryRelationListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryRelationListResponseBodyData) };
    inline QueryRelationListResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryRelationListResponseBodyData) };
    inline QueryRelationListResponseBody& setData(const QueryRelationListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryRelationListResponseBody& setData(QueryRelationListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryRelationListResponseBodyData> data_ = nullptr;
