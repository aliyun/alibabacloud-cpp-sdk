...
namespace Models
{
  ...
  public:
    ...
    inline const CancelOrderResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CancelOrderResponseBodyData) };
    inline CancelOrderResponseBodyData data() { DARABONBA_PTR_GET(data_, CancelOrderResponseBodyData) };
    inline CancelOrderResponseBody& setData(const CancelOrderResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CancelOrderResponseBody& setData(CancelOrderResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<CancelOrderResponseBodyData> data_ = nullptr;
    // The error message.
