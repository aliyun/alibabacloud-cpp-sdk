...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSavingsPlansUsageTotalRequest::FilterParam & getFilterParam() const { DARABONBA_PTR_GET_CONST(filterParam_, DescribeSavingsPlansUsageTotalRequest::FilterParam) };
    inline DescribeSavingsPlansUsageTotalRequest::FilterParam getFilterParam() { DARABONBA_PTR_GET(filterParam_, DescribeSavingsPlansUsageTotalRequest::FilterParam) };
    inline DescribeSavingsPlansUsageTotalRequest& setFilterParam(const DescribeSavingsPlansUsageTotalRequest::FilterParam & filterParam) { DARABONBA_PTR_SET_VALUE(filterParam_, filterParam) };
    inline DescribeSavingsPlansUsageTotalRequest& setFilterParam(DescribeSavingsPlansUsageTotalRequest::FilterParam && filterParam) { DARABONBA_PTR_SET_RVALUE(filterParam_, filterParam) };
  ...
  protected:
    ...
    shared_ptr<DescribeSavingsPlansUsageTotalRequest::FilterParam> filterParam_ {};
