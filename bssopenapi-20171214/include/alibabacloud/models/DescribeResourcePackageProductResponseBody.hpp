...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourcePackageProductResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeResourcePackageProductResponseBodyData) };
    inline DescribeResourcePackageProductResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeResourcePackageProductResponseBodyData) };
    inline DescribeResourcePackageProductResponseBody& setData(const DescribeResourcePackageProductResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeResourcePackageProductResponseBody& setData(DescribeResourcePackageProductResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeResourcePackageProductResponseBodyData> data_ = nullptr;
