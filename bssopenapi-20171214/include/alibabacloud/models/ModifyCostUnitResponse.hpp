...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCostUnitResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCostUnitResponseBody) };
    inline ModifyCostUnitResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCostUnitResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCostUnitResponseBody> body_ {};
  };
