...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySavingsPlansInstanceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QuerySavingsPlansInstanceResponseBodyData) };
    inline QuerySavingsPlansInstanceResponseBodyData data() { DARABONBA_PTR_GET(data_, QuerySavingsPlansInstanceResponseBodyData) };
    inline QuerySavingsPlansInstanceResponseBody& setData(const QuerySavingsPlansInstanceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QuerySavingsPlansInstanceResponseBody& setData(QuerySavingsPlansInstanceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The return data.
    std::shared_ptr<QuerySavingsPlansInstanceResponseBodyData> data_ = nullptr;
