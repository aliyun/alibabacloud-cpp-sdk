...
namespace Models
{
  ...
  public:
    ...
    inline const RenewResourcePackageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RenewResourcePackageResponseBody) };
    inline RenewResourcePackageResponseBody getBody() { DARABONBA_PTR_GET(body_, RenewResourcePackageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RenewResourcePackageResponseBody> body_ {};
  };
