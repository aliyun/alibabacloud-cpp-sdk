...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEINSTANCEAMORTIZEDCOSTBYCONSUMEPERIODRESPONSEBODYDATAITEMS_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEINSTANCEAMORTIZEDCOSTBYCONSUMEPERIODRESPONSEBODYDATAITEMS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& obj) { 
    ...
    DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems() = default ;
    DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems(const DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems &) = default ;
    DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems(DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems &&) = default ;
    DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems() = default ;
    DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& operator=(const DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems &) = default ;
    DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& operator=(DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems &&) = default ;
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setAfterDiscountAmount(double afterDiscountAmount) { DARABONBA_PTR_SET_VALUE(afterDiscountAmount_, afterDiscountAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setAmortizationPeriod(string amortizationPeriod) { DARABONBA_PTR_SET_VALUE(amortizationPeriod_, amortizationPeriod) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setAmortizationStatus(string amortizationStatus) { DARABONBA_PTR_SET_VALUE(amortizationStatus_, amortizationStatus) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setBillAccountID(int64_t billAccountID) { DARABONBA_PTR_SET_VALUE(billAccountID_, billAccountID) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setBillAccountName(string billAccountName) { DARABONBA_PTR_SET_VALUE(billAccountName_, billAccountName) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setBillOwnerID(int64_t billOwnerID) { DARABONBA_PTR_SET_VALUE(billOwnerID_, billOwnerID) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setBillOwnerName(string billOwnerName) { DARABONBA_PTR_SET_VALUE(billOwnerName_, billOwnerName) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setBizType(string bizType) { DARABONBA_PTR_SET_VALUE(bizType_, bizType) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setConsumePeriod(string consumePeriod) { DARABONBA_PTR_SET_VALUE(consumePeriod_, consumePeriod) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setCostUnit(string costUnit) { DARABONBA_PTR_SET_VALUE(costUnit_, costUnit) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setCostUnitCode(string costUnitCode) { DARABONBA_PTR_SET_VALUE(costUnitCode_, costUnitCode) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setCurrentAmortizationAfterDiscountAmount(double currentAmortizationAfterDiscountAmount) { DARABONBA_PTR_SET_VALUE(currentAmortizationAfterDiscountAmount_, currentAmortizationAfterDiscountAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setCurrentAmortizationDeductedByCashCoupons(double currentAmortizationDeductedByCashCoupons) { DARABONBA_PTR_SET_VALUE(currentAmortizationDeductedByCashCoupons_, currentAmortizationDeductedByCashCoupons) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setCurrentAmortizationDeductedByCoupons(double currentAmortizationDeductedByCoupons) { DARABONBA_PTR_SET_VALUE(currentAmortizationDeductedByCoupons_, currentAmortizationDeductedByCoupons) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setCurrentAmortizationDeductedByPrepaidCard(double currentAmortizationDeductedByPrepaidCard) { DARABONBA_PTR_SET_VALUE(currentAmortizationDeductedByPrepaidCard_, currentAmortizationDeductedByPrepaidCard) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setCurrentAmortizationExpenditureAmount(double currentAmortizationExpenditureAmount) { DARABONBA_PTR_SET_VALUE(currentAmortizationExpenditureAmount_, currentAmortizationExpenditureAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setCurrentAmortizationInvoiceDiscount(double currentAmortizationInvoiceDiscount) { DARABONBA_PTR_SET_VALUE(currentAmortizationInvoiceDiscount_, currentAmortizationInvoiceDiscount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setCurrentAmortizationPretaxAmount(double currentAmortizationPretaxAmount) { DARABONBA_PTR_SET_VALUE(currentAmortizationPretaxAmount_, currentAmortizationPretaxAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setCurrentAmortizationPretaxGrossAmount(double currentAmortizationPretaxGrossAmount) { DARABONBA_PTR_SET_VALUE(currentAmortizationPretaxGrossAmount_, currentAmortizationPretaxGrossAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setCurrentAmortizationRoundDownDiscount(double currentAmortizationRoundDownDiscount) { DARABONBA_PTR_SET_VALUE(currentAmortizationRoundDownDiscount_, currentAmortizationRoundDownDiscount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setDeductedByCashCoupons(double deductedByCashCoupons) { DARABONBA_PTR_SET_VALUE(deductedByCashCoupons_, deductedByCashCoupons) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setDeductedByCoupons(double deductedByCoupons) { DARABONBA_PTR_SET_VALUE(deductedByCoupons_, deductedByCoupons) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setDeductedByPrepaidCard(double deductedByPrepaidCard) { DARABONBA_PTR_SET_VALUE(deductedByPrepaidCard_, deductedByPrepaidCard) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setExpenditureAmount(double expenditureAmount) { DARABONBA_PTR_SET_VALUE(expenditureAmount_, expenditureAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setInstanceID(string instanceID) { DARABONBA_PTR_SET_VALUE(instanceID_, instanceID) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setInternetIP(string internetIP) { DARABONBA_PTR_SET_VALUE(internetIP_, internetIP) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setIntranetIP(string intranetIP) { DARABONBA_PTR_SET_VALUE(intranetIP_, intranetIP) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setInvoiceDiscount(double invoiceDiscount) { DARABONBA_PTR_SET_VALUE(invoiceDiscount_, invoiceDiscount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setPretaxAmount(double pretaxAmount) { DARABONBA_PTR_SET_VALUE(pretaxAmount_, pretaxAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setPretaxGrossAmount(double pretaxGrossAmount) { DARABONBA_PTR_SET_VALUE(pretaxGrossAmount_, pretaxGrossAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setPreviouslyAmortizedAfterDiscountAmount(double previouslyAmortizedAfterDiscountAmount) { DARABONBA_PTR_SET_VALUE(previouslyAmortizedAfterDiscountAmount_, previouslyAmortizedAfterDiscountAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setPreviouslyAmortizedDeductedByCashCoupons(double previouslyAmortizedDeductedByCashCoupons) { DARABONBA_PTR_SET_VALUE(previouslyAmortizedDeductedByCashCoupons_, previouslyAmortizedDeductedByCashCoupons) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setPreviouslyAmortizedDeductedByCoupons(double previouslyAmortizedDeductedByCoupons) { DARABONBA_PTR_SET_VALUE(previouslyAmortizedDeductedByCoupons_, previouslyAmortizedDeductedByCoupons) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setPreviouslyAmortizedDeductedByPrepaidCard(double previouslyAmortizedDeductedByPrepaidCard) { DARABONBA_PTR_SET_VALUE(previouslyAmortizedDeductedByPrepaidCard_, previouslyAmortizedDeductedByPrepaidCard) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setPreviouslyAmortizedExpenditureAmount(double previouslyAmortizedExpenditureAmount) { DARABONBA_PTR_SET_VALUE(previouslyAmortizedExpenditureAmount_, previouslyAmortizedExpenditureAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setPreviouslyAmortizedInvoiceDiscount(double previouslyAmortizedInvoiceDiscount) { DARABONBA_PTR_SET_VALUE(previouslyAmortizedInvoiceDiscount_, previouslyAmortizedInvoiceDiscount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setPreviouslyAmortizedPretaxAmount(double previouslyAmortizedPretaxAmount) { DARABONBA_PTR_SET_VALUE(previouslyAmortizedPretaxAmount_, previouslyAmortizedPretaxAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setPreviouslyAmortizedPretaxGrossAmount(double previouslyAmortizedPretaxGrossAmount) { DARABONBA_PTR_SET_VALUE(previouslyAmortizedPretaxGrossAmount_, previouslyAmortizedPretaxGrossAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setPreviouslyAmortizedRoundDownDiscount(double previouslyAmortizedRoundDownDiscount) { DARABONBA_PTR_SET_VALUE(previouslyAmortizedRoundDownDiscount_, previouslyAmortizedRoundDownDiscount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setProductCode(string productCode) { DARABONBA_PTR_SET_VALUE(productCode_, productCode) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setProductDetail(string productDetail) { DARABONBA_PTR_SET_VALUE(productDetail_, productDetail) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setProductDetailCode(string productDetailCode) { DARABONBA_PTR_SET_VALUE(productDetailCode_, productDetailCode) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setProductName(string productName) { DARABONBA_PTR_SET_VALUE(productName_, productName) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setRegion(string region) { DARABONBA_PTR_SET_VALUE(region_, region) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setRemainingAmortizationAfterDiscountAmount(double remainingAmortizationAfterDiscountAmount) { DARABONBA_PTR_SET_VALUE(remainingAmortizationAfterDiscountAmount_, remainingAmortizationAfterDiscountAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setRemainingAmortizationDeductedByCashCoupons(double remainingAmortizationDeductedByCashCoupons) { DARABONBA_PTR_SET_VALUE(remainingAmortizationDeductedByCashCoupons_, remainingAmortizationDeductedByCashCoupons) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setRemainingAmortizationDeductedByCoupons(double remainingAmortizationDeductedByCoupons) { DARABONBA_PTR_SET_VALUE(remainingAmortizationDeductedByCoupons_, remainingAmortizationDeductedByCoupons) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setRemainingAmortizationDeductedByPrepaidCard(double remainingAmortizationDeductedByPrepaidCard) { DARABONBA_PTR_SET_VALUE(remainingAmortizationDeductedByPrepaidCard_, remainingAmortizationDeductedByPrepaidCard) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setRemainingAmortizationExpenditureAmount(double remainingAmortizationExpenditureAmount) { DARABONBA_PTR_SET_VALUE(remainingAmortizationExpenditureAmount_, remainingAmortizationExpenditureAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setRemainingAmortizationInvoiceDiscount(double remainingAmortizationInvoiceDiscount) { DARABONBA_PTR_SET_VALUE(remainingAmortizationInvoiceDiscount_, remainingAmortizationInvoiceDiscount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setRemainingAmortizationPretaxAmount(double remainingAmortizationPretaxAmount) { DARABONBA_PTR_SET_VALUE(remainingAmortizationPretaxAmount_, remainingAmortizationPretaxAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setRemainingAmortizationPretaxGrossAmount(double remainingAmortizationPretaxGrossAmount) { DARABONBA_PTR_SET_VALUE(remainingAmortizationPretaxGrossAmount_, remainingAmortizationPretaxGrossAmount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setRemainingAmortizationRoundDownDiscount(double remainingAmortizationRoundDownDiscount) { DARABONBA_PTR_SET_VALUE(remainingAmortizationRoundDownDiscount_, remainingAmortizationRoundDownDiscount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setResourceGroup(string resourceGroup) { DARABONBA_PTR_SET_VALUE(resourceGroup_, resourceGroup) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setRoundDownDiscount(double roundDownDiscount) { DARABONBA_PTR_SET_VALUE(roundDownDiscount_, roundDownDiscount) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setSplitAccountName(string splitAccountName) { DARABONBA_PTR_SET_VALUE(splitAccountName_, splitAccountName) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setSplitItemID(string splitItemID) { DARABONBA_PTR_SET_VALUE(splitItemID_, splitItemID) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setSplitItemName(string splitItemName) { DARABONBA_PTR_SET_VALUE(splitItemName_, splitItemName) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setSplitProductDetail(string splitProductDetail) { DARABONBA_PTR_SET_VALUE(splitProductDetail_, splitProductDetail) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setSubscriptionType(string subscriptionType) { DARABONBA_PTR_SET_VALUE(subscriptionType_, subscriptionType) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setTag(string tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    ...
    inline DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems& setZone(string zone) { DARABONBA_PTR_SET_VALUE(zone_, zone) };
