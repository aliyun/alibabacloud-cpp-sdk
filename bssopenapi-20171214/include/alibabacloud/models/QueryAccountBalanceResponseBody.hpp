...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAccountBalanceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryAccountBalanceResponseBodyData) };
    inline QueryAccountBalanceResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryAccountBalanceResponseBodyData) };
    inline QueryAccountBalanceResponseBody& setData(const QueryAccountBalanceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryAccountBalanceResponseBody& setData(QueryAccountBalanceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryAccountBalanceResponseBodyData> data_ = nullptr;
