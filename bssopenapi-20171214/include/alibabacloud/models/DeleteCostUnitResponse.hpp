...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCostUnitResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCostUnitResponseBody) };
    inline DeleteCostUnitResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCostUnitResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCostUnitResponseBody> body_ {};
  };
