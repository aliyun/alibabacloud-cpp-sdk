...
namespace Models
{
  ...
  public:
    ...
    inline string getAdjustType() const { DARABONBA_PTR_GET_DEFAULT(adjustType_, "") };
    ...
    inline string getExtendMap() const { DARABONBA_PTR_GET_DEFAULT(extendMap_, "") };
