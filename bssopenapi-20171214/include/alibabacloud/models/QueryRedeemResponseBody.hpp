...
namespace Models
{
  ...
  public:
    ...
    inline const QueryRedeemResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryRedeemResponseBodyData) };
    inline QueryRedeemResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryRedeemResponseBodyData) };
    inline QueryRedeemResponseBody& setData(const QueryRedeemResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryRedeemResponseBody& setData(QueryRedeemResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryRedeemResponseBodyData> data_ = nullptr;
