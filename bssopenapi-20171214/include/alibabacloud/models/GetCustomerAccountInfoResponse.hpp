...
namespace Models
{
  ...
  public:
    ...
    inline const GetCustomerAccountInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCustomerAccountInfoResponseBody) };
    inline GetCustomerAccountInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCustomerAccountInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCustomerAccountInfoResponseBody> body_ {};
  };
