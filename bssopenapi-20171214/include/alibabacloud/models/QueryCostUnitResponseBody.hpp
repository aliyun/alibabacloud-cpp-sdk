...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryCostUnitResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryCostUnitResponseBody& obj) { 
    ...
    QueryCostUnitResponseBody() = default ;
    QueryCostUnitResponseBody(const QueryCostUnitResponseBody &) = default ;
    QueryCostUnitResponseBody(QueryCostUnitResponseBody &&) = default ;
    QueryCostUnitResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryCostUnitResponseBody() = default ;
    QueryCostUnitResponseBody& operator=(const QueryCostUnitResponseBody &) = default ;
    QueryCostUnitResponseBody& operator=(QueryCostUnitResponseBody &&) = default ;
