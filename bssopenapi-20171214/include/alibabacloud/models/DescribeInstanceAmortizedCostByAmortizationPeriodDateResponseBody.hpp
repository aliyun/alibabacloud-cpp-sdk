...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBodyData) };
    inline DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBodyData) };
    inline DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBody& setData(const DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBody& setData(DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBodyData> data_ = nullptr;
