...
namespace Models
{
  ...
  public:
    ...
    inline const UnsubscribeBillToOSSResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnsubscribeBillToOSSResponseBody) };
    inline UnsubscribeBillToOSSResponseBody getBody() { DARABONBA_PTR_GET(body_, UnsubscribeBillToOSSResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnsubscribeBillToOSSResponseBody> body_ {};
  };
