...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSavingsPlansCoverageTotalResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSavingsPlansCoverageTotalResponseBodyData) };
    inline DescribeSavingsPlansCoverageTotalResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSavingsPlansCoverageTotalResponseBodyData) };
    inline DescribeSavingsPlansCoverageTotalResponseBody& setData(const DescribeSavingsPlansCoverageTotalResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSavingsPlansCoverageTotalResponseBody& setData(DescribeSavingsPlansCoverageTotalResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The return data.
    std::shared_ptr<DescribeSavingsPlansCoverageTotalResponseBodyData> data_ = nullptr;
