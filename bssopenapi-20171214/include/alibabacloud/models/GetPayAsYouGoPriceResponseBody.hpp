...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetPayAsYouGoPriceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetPayAsYouGoPriceResponseBody& obj) { 
    ...
    GetPayAsYouGoPriceResponseBody() = default ;
    GetPayAsYouGoPriceResponseBody(const GetPayAsYouGoPriceResponseBody &) = default ;
    GetPayAsYouGoPriceResponseBody(GetPayAsYouGoPriceResponseBody &&) = default ;
    GetPayAsYouGoPriceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetPayAsYouGoPriceResponseBody() = default ;
    GetPayAsYouGoPriceResponseBody& operator=(const GetPayAsYouGoPriceResponseBody &) = default ;
    GetPayAsYouGoPriceResponseBody& operator=(GetPayAsYouGoPriceResponseBody &&) = default ;
