...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAccountTransactionDetailsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryAccountTransactionDetailsResponseBody) };
    inline QueryAccountTransactionDetailsResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryAccountTransactionDetailsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryAccountTransactionDetailsResponseBody> body_ {};
  };
