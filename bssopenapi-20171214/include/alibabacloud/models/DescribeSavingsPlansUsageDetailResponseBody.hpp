...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSavingsPlansUsageDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSavingsPlansUsageDetailResponseBodyData) };
    inline DescribeSavingsPlansUsageDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSavingsPlansUsageDetailResponseBodyData) };
    inline DescribeSavingsPlansUsageDetailResponseBody& setData(const DescribeSavingsPlansUsageDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSavingsPlansUsageDetailResponseBody& setData(DescribeSavingsPlansUsageDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The return data.
    std::shared_ptr<DescribeSavingsPlansUsageDetailResponseBodyData> data_ = nullptr;
