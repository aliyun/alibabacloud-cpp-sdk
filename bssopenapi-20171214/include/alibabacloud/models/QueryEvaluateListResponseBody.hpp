...
namespace Models
{
  ...
  public:
    ...
    inline const QueryEvaluateListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryEvaluateListResponseBodyData) };
    inline QueryEvaluateListResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryEvaluateListResponseBodyData) };
    inline QueryEvaluateListResponseBody& setData(const QueryEvaluateListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryEvaluateListResponseBody& setData(QueryEvaluateListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryEvaluateListResponseBodyData> data_ = nullptr;
