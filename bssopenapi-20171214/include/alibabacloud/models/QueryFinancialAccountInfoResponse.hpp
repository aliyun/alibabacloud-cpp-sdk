...
namespace Models
{
  ...
  public:
    ...
    inline const QueryFinancialAccountInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryFinancialAccountInfoResponseBody) };
    inline QueryFinancialAccountInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryFinancialAccountInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryFinancialAccountInfoResponseBody> body_ {};
  };
