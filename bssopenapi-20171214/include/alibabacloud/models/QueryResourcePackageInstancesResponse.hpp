...
namespace Models
{
  ...
  public:
    ...
    inline const QueryResourcePackageInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryResourcePackageInstancesResponseBody) };
    inline QueryResourcePackageInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryResourcePackageInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryResourcePackageInstancesResponseBody> body_ {};
  };
