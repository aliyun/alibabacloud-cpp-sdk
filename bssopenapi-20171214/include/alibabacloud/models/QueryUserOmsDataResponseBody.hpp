...
namespace Models
{
  ...
  public:
    ...
    inline const QueryUserOmsDataResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryUserOmsDataResponseBodyData) };
    inline QueryUserOmsDataResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryUserOmsDataResponseBodyData) };
    inline QueryUserOmsDataResponseBody& setData(const QueryUserOmsDataResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryUserOmsDataResponseBody& setData(QueryUserOmsDataResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryUserOmsDataResponseBodyData> data_ = nullptr;
