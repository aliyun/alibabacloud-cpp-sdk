...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourcePackageProductResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeResourcePackageProductResponseBody) };
    inline DescribeResourcePackageProductResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeResourcePackageProductResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeResourcePackageProductResponseBody> body_ {};
  };
