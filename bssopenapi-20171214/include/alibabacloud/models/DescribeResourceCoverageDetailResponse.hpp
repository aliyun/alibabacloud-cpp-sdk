...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourceCoverageDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeResourceCoverageDetailResponseBody) };
    inline DescribeResourceCoverageDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeResourceCoverageDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeResourceCoverageDetailResponseBody> body_ {};
  };
