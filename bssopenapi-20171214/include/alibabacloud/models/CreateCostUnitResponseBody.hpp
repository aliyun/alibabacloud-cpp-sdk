...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCostUnitResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateCostUnitResponseBodyData) };
    inline CreateCostUnitResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateCostUnitResponseBodyData) };
    inline CreateCostUnitResponseBody& setData(const CreateCostUnitResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateCostUnitResponseBody& setData(CreateCostUnitResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<CreateCostUnitResponseBodyData> data_ = nullptr;
