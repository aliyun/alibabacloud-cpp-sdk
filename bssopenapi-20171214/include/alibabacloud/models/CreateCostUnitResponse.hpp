...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCostUnitResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCostUnitResponseBody) };
    inline CreateCostUnitResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCostUnitResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCostUnitResponseBody> body_ {};
  };
