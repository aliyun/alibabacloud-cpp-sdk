...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourceUsageTotalResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeResourceUsageTotalResponseBodyData) };
    inline DescribeResourceUsageTotalResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeResourceUsageTotalResponseBodyData) };
    inline DescribeResourceUsageTotalResponseBody& setData(const DescribeResourceUsageTotalResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeResourceUsageTotalResponseBody& setData(DescribeResourceUsageTotalResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The queried data.
    std::shared_ptr<DescribeResourceUsageTotalResponseBodyData> data_ = nullptr;
