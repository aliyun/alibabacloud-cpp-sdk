...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDPUtilizationDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryDPUtilizationDetailResponseBodyData) };
    inline QueryDPUtilizationDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryDPUtilizationDetailResponseBodyData) };
    inline QueryDPUtilizationDetailResponseBody& setData(const QueryDPUtilizationDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryDPUtilizationDetailResponseBody& setData(QueryDPUtilizationDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<QueryDPUtilizationDetailResponseBodyData> data_ = nullptr;
    // The error message.
