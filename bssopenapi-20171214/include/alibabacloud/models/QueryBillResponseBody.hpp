...
namespace Models
{
  ...
  public:
    ...
    inline const QueryBillResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryBillResponseBodyData) };
    inline QueryBillResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryBillResponseBodyData) };
    inline QueryBillResponseBody& setData(const QueryBillResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryBillResponseBody& setData(QueryBillResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<QueryBillResponseBodyData> data_ = nullptr;
