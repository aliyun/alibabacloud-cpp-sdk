...
namespace Models
{
  ...
  public:
    ...
    inline const QueryBillToOSSSubscriptionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryBillToOSSSubscriptionResponseBody) };
    inline QueryBillToOSSSubscriptionResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryBillToOSSSubscriptionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryBillToOSSSubscriptionResponseBody> body_ {};
  };
