...
namespace Models
{
  class InquiryPriceRefundInstanceResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const InquiryPriceRefundInstanceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, InquiryPriceRefundInstanceResponseBody& obj) { 
    ...
    InquiryPriceRefundInstanceResponseBody() = default ;
    InquiryPriceRefundInstanceResponseBody(const InquiryPriceRefundInstanceResponseBody &) = default ;
    InquiryPriceRefundInstanceResponseBody(InquiryPriceRefundInstanceResponseBody &&) = default ;
    InquiryPriceRefundInstanceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~InquiryPriceRefundInstanceResponseBody() = default ;
    InquiryPriceRefundInstanceResponseBody& operator=(const InquiryPriceRefundInstanceResponseBody &) = default ;
    InquiryPriceRefundInstanceResponseBody& operator=(InquiryPriceRefundInstanceResponseBody &&) = default ;
