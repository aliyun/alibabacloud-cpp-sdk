...
namespace Models
{
  ...
  public:
    ...
    inline const QueryInvoicingCustomerListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryInvoicingCustomerListResponseBodyData) };
    inline QueryInvoicingCustomerListResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryInvoicingCustomerListResponseBodyData) };
    inline QueryInvoicingCustomerListResponseBody& setData(const QueryInvoicingCustomerListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryInvoicingCustomerListResponseBody& setData(QueryInvoicingCustomerListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryInvoicingCustomerListResponseBodyData> data_ = nullptr;
