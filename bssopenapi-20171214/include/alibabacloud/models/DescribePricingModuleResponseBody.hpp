...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePricingModuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribePricingModuleResponseBodyData) };
    inline DescribePricingModuleResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribePricingModuleResponseBodyData) };
    inline DescribePricingModuleResponseBody& setData(const DescribePricingModuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribePricingModuleResponseBody& setData(DescribePricingModuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribePricingModuleResponseBodyData> data_ = nullptr;
