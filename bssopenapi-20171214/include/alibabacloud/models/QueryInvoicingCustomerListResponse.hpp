...
namespace Models
{
  ...
  public:
    ...
    inline const QueryInvoicingCustomerListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryInvoicingCustomerListResponseBody) };
    inline QueryInvoicingCustomerListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryInvoicingCustomerListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryInvoicingCustomerListResponseBody> body_ {};
  };
