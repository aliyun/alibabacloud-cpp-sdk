...
namespace Models
{
  ...
  public:
    ...
    inline const QueryRIUtilizationDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryRIUtilizationDetailResponseBodyData) };
    inline QueryRIUtilizationDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryRIUtilizationDetailResponseBodyData) };
    inline QueryRIUtilizationDetailResponseBody& setData(const QueryRIUtilizationDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryRIUtilizationDetailResponseBody& setData(QueryRIUtilizationDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryRIUtilizationDetailResponseBodyData> data_ = nullptr;
