...
namespace Models
{
  ...
  public:
    ...
    inline const GetAccountRelationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAccountRelationResponseBody) };
    inline GetAccountRelationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAccountRelationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAccountRelationResponseBody> body_ {};
  };
