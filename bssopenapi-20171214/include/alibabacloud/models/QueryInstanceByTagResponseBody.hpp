...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryInstanceByTagResponseBodyTagResource> & tagResource() const { DARABONBA_PTR_GET_CONST(tagResource_, vector<QueryInstanceByTagResponseBodyTagResource>) };
    inline vector<QueryInstanceByTagResponseBodyTagResource> tagResource() { DARABONBA_PTR_GET(tagResource_, vector<QueryInstanceByTagResponseBodyTagResource>) };
    inline QueryInstanceByTagResponseBody& setTagResource(const vector<QueryInstanceByTagResponseBodyTagResource> & tagResource) { DARABONBA_PTR_SET_VALUE(tagResource_, tagResource) };
    inline QueryInstanceByTagResponseBody& setTagResource(vector<QueryInstanceByTagResponseBodyTagResource> && tagResource) { DARABONBA_PTR_SET_RVALUE(tagResource_, tagResource) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryInstanceByTagResponseBodyTagResource>> tagResource_ = nullptr;
  };
