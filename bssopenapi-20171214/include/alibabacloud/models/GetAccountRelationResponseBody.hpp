...
namespace Models
{
  ...
  public:
    ...
    inline const GetAccountRelationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAccountRelationResponseBodyData) };
    inline GetAccountRelationResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAccountRelationResponseBodyData) };
    inline GetAccountRelationResponseBody& setData(const GetAccountRelationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAccountRelationResponseBody& setData(GetAccountRelationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // data
    std::shared_ptr<GetAccountRelationResponseBodyData> data_ = nullptr;
