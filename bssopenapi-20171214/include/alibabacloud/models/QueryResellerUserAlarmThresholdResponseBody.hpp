...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryResellerUserAlarmThresholdResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryResellerUserAlarmThresholdResponseBodyData>) };
    inline vector<QueryResellerUserAlarmThresholdResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryResellerUserAlarmThresholdResponseBodyData>) };
    inline QueryResellerUserAlarmThresholdResponseBody& setData(const vector<QueryResellerUserAlarmThresholdResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryResellerUserAlarmThresholdResponseBody& setData(vector<QueryResellerUserAlarmThresholdResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryResellerUserAlarmThresholdResponseBodyData>> data_ = nullptr;
