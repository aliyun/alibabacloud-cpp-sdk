...
namespace Models
{
  ...
  public:
    ...
    inline const QueryInstanceBillResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryInstanceBillResponseBodyData) };
    inline QueryInstanceBillResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryInstanceBillResponseBodyData) };
    inline QueryInstanceBillResponseBody& setData(const QueryInstanceBillResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryInstanceBillResponseBody& setData(QueryInstanceBillResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryInstanceBillResponseBodyData> data_ = nullptr;
