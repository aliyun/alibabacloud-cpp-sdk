...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAccountTransactionDetailsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryAccountTransactionDetailsResponseBodyData) };
    inline QueryAccountTransactionDetailsResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryAccountTransactionDetailsResponseBodyData) };
    inline QueryAccountTransactionDetailsResponseBody& setData(const QueryAccountTransactionDetailsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryAccountTransactionDetailsResponseBody& setData(QueryAccountTransactionDetailsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryAccountTransactionDetailsResponseBodyData> data_ = nullptr;
