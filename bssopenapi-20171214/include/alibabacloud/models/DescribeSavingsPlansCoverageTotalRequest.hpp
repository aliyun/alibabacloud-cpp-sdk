...
#ifndef ALIBABACLOUD_MODELS_DESCRIBESAVINGSPLANSCOVERAGETOTALREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBESAVINGSPLANSCOVERAGETOTALREQUEST_HPP_
...
namespace Models
{
  class DescribeSavingsPlansCoverageTotalRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeSavingsPlansCoverageTotalRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeSavingsPlansCoverageTotalRequest& obj) { 
    ...
    DescribeSavingsPlansCoverageTotalRequest() = default ;
    DescribeSavingsPlansCoverageTotalRequest(const DescribeSavingsPlansCoverageTotalRequest &) = default ;
    DescribeSavingsPlansCoverageTotalRequest(DescribeSavingsPlansCoverageTotalRequest &&) = default ;
    DescribeSavingsPlansCoverageTotalRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeSavingsPlansCoverageTotalRequest() = default ;
    DescribeSavingsPlansCoverageTotalRequest& operator=(const DescribeSavingsPlansCoverageTotalRequest &) = default ;
    DescribeSavingsPlansCoverageTotalRequest& operator=(DescribeSavingsPlansCoverageTotalRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->billOwnerId_ == nullptr
        && this->endPeriod_ == nullptr && this->filterParam_ == nullptr && this->periodType_ == nullptr && this->startPeriod_ == nullptr; };
    ...
    inline DescribeSavingsPlansCoverageTotalRequest& setBillOwnerId(int64_t billOwnerId) { DARABONBA_PTR_SET_VALUE(billOwnerId_, billOwnerId) };
    ...
    inline DescribeSavingsPlansCoverageTotalRequest& setEndPeriod(string endPeriod) { DARABONBA_PTR_SET_VALUE(endPeriod_, endPeriod) };
    ...
    inline const DescribeSavingsPlansCoverageTotalRequest::FilterParam & getFilterParam() const { DARABONBA_PTR_GET_CONST(filterParam_, DescribeSavingsPlansCoverageTotalRequest::FilterParam) };
    inline DescribeSavingsPlansCoverageTotalRequest::FilterParam getFilterParam() { DARABONBA_PTR_GET(filterParam_, DescribeSavingsPlansCoverageTotalRequest::FilterParam) };
    inline DescribeSavingsPlansCoverageTotalRequest& setFilterParam(const DescribeSavingsPlansCoverageTotalRequest::FilterParam & filterParam) { DARABONBA_PTR_SET_VALUE(filterParam_, filterParam) };
    inline DescribeSavingsPlansCoverageTotalRequest& setFilterParam(DescribeSavingsPlansCoverageTotalRequest::FilterParam && filterParam) { DARABONBA_PTR_SET_RVALUE(filterParam_, filterParam) };
    ...
    inline DescribeSavingsPlansCoverageTotalRequest& setPeriodType(string periodType) { DARABONBA_PTR_SET_VALUE(periodType_, periodType) };
    ...
    inline DescribeSavingsPlansCoverageTotalRequest& setStartPeriod(string startPeriod) { DARABONBA_PTR_SET_VALUE(startPeriod_, startPeriod) };
  ...
  protected:
    ...
    shared_ptr<DescribeSavingsPlansCoverageTotalRequest::FilterParam> filterParam_ {};
