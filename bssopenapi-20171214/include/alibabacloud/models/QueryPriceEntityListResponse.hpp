...
namespace Models
{
  ...
  public:
    ...
    inline const QueryPriceEntityListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryPriceEntityListResponseBody) };
    inline QueryPriceEntityListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryPriceEntityListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryPriceEntityListResponseBody> body_ {};
  };
