...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCostBudgetsSummaryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeCostBudgetsSummaryResponseBodyData) };
    inline DescribeCostBudgetsSummaryResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeCostBudgetsSummaryResponseBodyData) };
    inline DescribeCostBudgetsSummaryResponseBody& setData(const DescribeCostBudgetsSummaryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCostBudgetsSummaryResponseBody& setData(DescribeCostBudgetsSummaryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCostBudgetsSummaryResponseBodyData> data_ = nullptr;
    // The error message.
