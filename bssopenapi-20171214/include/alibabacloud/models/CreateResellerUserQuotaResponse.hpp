...
namespace Models
{
  ...
  public:
    ...
    inline const CreateResellerUserQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateResellerUserQuotaResponseBody) };
    inline CreateResellerUserQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateResellerUserQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateResellerUserQuotaResponseBody> body_ {};
  };
