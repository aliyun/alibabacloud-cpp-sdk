...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCashCouponsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryCashCouponsResponseBodyData) };
    inline QueryCashCouponsResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryCashCouponsResponseBodyData) };
    inline QueryCashCouponsResponseBody& setData(const QueryCashCouponsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryCashCouponsResponseBody& setData(QueryCashCouponsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryCashCouponsResponseBodyData> data_ = nullptr;
