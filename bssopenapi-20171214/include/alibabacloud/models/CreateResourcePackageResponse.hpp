...
namespace Models
{
  ...
  public:
    ...
    inline const CreateResourcePackageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateResourcePackageResponseBody) };
    inline CreateResourcePackageResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateResourcePackageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateResourcePackageResponseBody> body_ {};
  };
