...
namespace Models
{
  ...
  public:
    ...
    inline const QueryInstanceGaapCostResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryInstanceGaapCostResponseBodyData) };
    inline QueryInstanceGaapCostResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryInstanceGaapCostResponseBodyData) };
    inline QueryInstanceGaapCostResponseBody& setData(const QueryInstanceGaapCostResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryInstanceGaapCostResponseBody& setData(QueryInstanceGaapCostResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryInstanceGaapCostResponseBodyData> data_ = nullptr;
