...
namespace Models
{
  ...
  public:
    ...
    inline const RelieveAccountRelationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, RelieveAccountRelationResponseBodyData) };
    inline RelieveAccountRelationResponseBodyData data() { DARABONBA_PTR_GET(data_, RelieveAccountRelationResponseBodyData) };
    inline RelieveAccountRelationResponseBody& setData(const RelieveAccountRelationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RelieveAccountRelationResponseBody& setData(RelieveAccountRelationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<RelieveAccountRelationResponseBodyData> data_ = nullptr;
