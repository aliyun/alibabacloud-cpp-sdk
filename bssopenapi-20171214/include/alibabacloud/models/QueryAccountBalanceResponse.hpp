...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAccountBalanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryAccountBalanceResponseBody) };
    inline QueryAccountBalanceResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryAccountBalanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryAccountBalanceResponseBody> body_ {};
  };
