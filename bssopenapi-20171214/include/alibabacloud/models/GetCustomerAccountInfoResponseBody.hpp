...
namespace Models
{
  ...
  public:
    ...
    inline const GetCustomerAccountInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetCustomerAccountInfoResponseBodyData) };
    inline GetCustomerAccountInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, GetCustomerAccountInfoResponseBodyData) };
    inline GetCustomerAccountInfoResponseBody& setData(const GetCustomerAccountInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCustomerAccountInfoResponseBody& setData(GetCustomerAccountInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetCustomerAccountInfoResponseBodyData> data_ = nullptr;
