...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAccountTransactionsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryAccountTransactionsResponseBodyData) };
    inline QueryAccountTransactionsResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryAccountTransactionsResponseBodyData) };
    inline QueryAccountTransactionsResponseBody& setData(const QueryAccountTransactionsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryAccountTransactionsResponseBody& setData(QueryAccountTransactionsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryAccountTransactionsResponseBodyData> data_ = nullptr;
