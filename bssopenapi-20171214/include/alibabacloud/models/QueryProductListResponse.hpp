...
namespace Models
{
  ...
  public:
    ...
    inline const QueryProductListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryProductListResponseBody) };
    inline QueryProductListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryProductListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryProductListResponseBody> body_ {};
  };
