...
namespace Models
{
  ...
  public:
    ...
    inline const GetCustomerListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetCustomerListResponseBodyData) };
    inline GetCustomerListResponseBodyData data() { DARABONBA_PTR_GET(data_, GetCustomerListResponseBodyData) };
    inline GetCustomerListResponseBody& setData(const GetCustomerListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCustomerListResponseBody& setData(GetCustomerListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetCustomerListResponseBodyData> data_ = nullptr;
