...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->amortizationDateEnd_ == nullptr
    ...
    inline string getAmortizationDateEnd() const { DARABONBA_PTR_GET_DEFAULT(amortizationDateEnd_, "") };
    ...
    inline string getAmortizationDateStart() const { DARABONBA_PTR_GET_DEFAULT(amortizationDateStart_, "") };
  ...
  protected:
    ...
    shared_ptr<string> amortizationDateEnd_ {};
    // This parameter is required.
    shared_ptr<string> amortizationDateStart_ {};
