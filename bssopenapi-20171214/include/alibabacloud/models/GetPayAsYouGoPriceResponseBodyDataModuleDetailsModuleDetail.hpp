...
#ifndef ALIBABACLOUD_MODELS_GETPAYASYOUGOPRICERESPONSEBODYDATAMODULEDETAILSMODULEDETAIL_HPP_
#define ALIBABACLOUD_MODELS_GETPAYASYOUGOPRICERESPONSEBODYDATAMODULEDETAILSMODULEDETAIL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail& obj) { 
    ...
    GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail() = default ;
    GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail(const GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail &) = default ;
    GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail(GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail &&) = default ;
    GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail() = default ;
    GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail& operator=(const GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail &) = default ;
    GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail& operator=(GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail &&) = default ;
    ...
    inline GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail& setCostAfterDiscount(float costAfterDiscount) { DARABONBA_PTR_SET_VALUE(costAfterDiscount_, costAfterDiscount) };
    ...
    inline GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail& setInvoiceDiscount(float invoiceDiscount) { DARABONBA_PTR_SET_VALUE(invoiceDiscount_, invoiceDiscount) };
    ...
    inline GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail& setModuleCode(string moduleCode) { DARABONBA_PTR_SET_VALUE(moduleCode_, moduleCode) };
    ...
    inline GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail& setOriginalCost(float originalCost) { DARABONBA_PTR_SET_VALUE(originalCost_, originalCost) };
    ...
    inline GetPayAsYouGoPriceResponseBodyDataModuleDetailsModuleDetail& setUnitPrice(float unitPrice) { DARABONBA_PTR_SET_VALUE(unitPrice_, unitPrice) };
