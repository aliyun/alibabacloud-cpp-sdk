...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeScreenScoreThreadResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeScreenScoreThreadResponseBodyData) };
    inline DescribeScreenScoreThreadResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeScreenScoreThreadResponseBodyData) };
    inline DescribeScreenScoreThreadResponseBody& setData(const DescribeScreenScoreThreadResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeScreenScoreThreadResponseBody& setData(DescribeScreenScoreThreadResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeScreenScoreThreadResponseBodyData> data_ = nullptr;
