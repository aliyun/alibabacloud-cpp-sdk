...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLogicDatabaseResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteLogicDatabaseResponseBody) };
    inline DeleteLogicDatabaseResponseBody body() { DARABONBA_PTR_GET(body_, DeleteLogicDatabaseResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteLogicDatabaseResponseBody> body_ = nullptr;
  };
