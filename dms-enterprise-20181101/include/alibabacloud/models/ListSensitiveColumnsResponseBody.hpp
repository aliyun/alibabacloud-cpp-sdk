...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorCode_ == nullptr
        && return this->errorMessage_ == nullptr && return this->requestId_ == nullptr && return this->sensitiveColumnList_ == nullptr && return this->success_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const ListSensitiveColumnsResponseBodySensitiveColumnList & sensitiveColumnList() const { DARABONBA_PTR_GET_CONST(sensitiveColumnList_, ListSensitiveColumnsResponseBodySensitiveColumnList) };
    inline ListSensitiveColumnsResponseBodySensitiveColumnList sensitiveColumnList() { DARABONBA_PTR_GET(sensitiveColumnList_, ListSensitiveColumnsResponseBodySensitiveColumnList) };
    inline ListSensitiveColumnsResponseBody& setSensitiveColumnList(const ListSensitiveColumnsResponseBodySensitiveColumnList & sensitiveColumnList) { DARABONBA_PTR_SET_VALUE(sensitiveColumnList_, sensitiveColumnList) };
    inline ListSensitiveColumnsResponseBody& setSensitiveColumnList(ListSensitiveColumnsResponseBodySensitiveColumnList && sensitiveColumnList) { DARABONBA_PTR_SET_RVALUE(sensitiveColumnList_, sensitiveColumnList) };
  ...
  protected:
    ...
    std::shared_ptr<ListSensitiveColumnsResponseBodySensitiveColumnList> sensitiveColumnList_ = nullptr;
