...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->attachmentKey_ == nullptr
        && this->comment_ == nullptr && this->pluginParamShrink_ == nullptr && this->pluginType_ == nullptr && this->realLoginUserUid_ == nullptr && this->relatedUserList_ == nullptr
        && this->tid_ == nullptr; };
    ...
    inline CreateOrderShrinkRequest& setRealLoginUserUid(string realLoginUserUid) { DARABONBA_PTR_SET_VALUE(realLoginUserUid_, realLoginUserUid) };
