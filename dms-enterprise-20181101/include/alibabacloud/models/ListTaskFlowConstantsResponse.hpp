...
namespace Models
{
  ...
  public:
    ...
    inline const ListTaskFlowConstantsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListTaskFlowConstantsResponseBody) };
    inline ListTaskFlowConstantsResponseBody body() { DARABONBA_PTR_GET(body_, ListTaskFlowConstantsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListTaskFlowConstantsResponseBody> body_ = nullptr;
  };
