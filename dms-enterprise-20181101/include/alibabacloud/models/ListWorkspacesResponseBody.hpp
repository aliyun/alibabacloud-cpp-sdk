...
namespace Models
{
  ...
  public:
    ...
    inline const ListWorkspacesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListWorkspacesResponseBodyData) };
    inline ListWorkspacesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListWorkspacesResponseBodyData) };
    inline ListWorkspacesResponseBody& setData(const ListWorkspacesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListWorkspacesResponseBody& setData(ListWorkspacesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
