...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataCronClearConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDataCronClearConfigResponseBody) };
    inline GetDataCronClearConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDataCronClearConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDataCronClearConfigResponseBody> body_ {};
  };
