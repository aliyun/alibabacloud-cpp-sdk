...
#ifndef ALIBABACLOUD_MODELS_GETTASKINSTANCERELATIONREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETTASKINSTANCERELATIONREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetTaskInstanceRelationRequest& obj) { 
      DARABONBA_PTR_TO_JSON(DagId, dagId_);
      DARABONBA_PTR_TO_JSON(DagInstanceId, dagInstanceId_);
      DARABONBA_PTR_TO_JSON(Tid, tid_);
    };
    friend void from_json(const Darabonba::Json& j, GetTaskInstanceRelationRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(DagId, dagId_);
      DARABONBA_PTR_FROM_JSON(DagInstanceId, dagInstanceId_);
      DARABONBA_PTR_FROM_JSON(Tid, tid_);
    };
    GetTaskInstanceRelationRequest() = default ;
    GetTaskInstanceRelationRequest(const GetTaskInstanceRelationRequest &) = default ;
    GetTaskInstanceRelationRequest(GetTaskInstanceRelationRequest &&) = default ;
    GetTaskInstanceRelationRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetTaskInstanceRelationRequest() = default ;
    GetTaskInstanceRelationRequest& operator=(const GetTaskInstanceRelationRequest &) = default ;
    GetTaskInstanceRelationRequest& operator=(GetTaskInstanceRelationRequest &&) = default ;
    ...
    inline GetTaskInstanceRelationRequest& setDagId(int64_t dagId) { DARABONBA_PTR_SET_VALUE(dagId_, dagId) };
    ...
    inline GetTaskInstanceRelationRequest& setDagInstanceId(int64_t dagInstanceId) { DARABONBA_PTR_SET_VALUE(dagInstanceId_, dagInstanceId) };
    ...
    inline GetTaskInstanceRelationRequest& setTid(int64_t tid) { DARABONBA_PTR_SET_VALUE(tid_, tid) };
