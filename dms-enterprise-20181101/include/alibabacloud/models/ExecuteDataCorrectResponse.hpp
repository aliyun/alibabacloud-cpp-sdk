...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteDataCorrectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExecuteDataCorrectResponseBody) };
    inline ExecuteDataCorrectResponseBody getBody() { DARABONBA_PTR_GET(body_, ExecuteDataCorrectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExecuteDataCorrectResponseBody> body_ {};
  };
