...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dagIdListShrink_ == nullptr
    ...
    inline string getDagIdListShrink() const { DARABONBA_PTR_GET_DEFAULT(dagIdListShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> dagIdListShrink_ {};
