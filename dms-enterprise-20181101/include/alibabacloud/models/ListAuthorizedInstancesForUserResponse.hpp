...
namespace Models
{
  ...
  public:
    ...
    inline const ListAuthorizedInstancesForUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAuthorizedInstancesForUserResponseBody) };
    inline ListAuthorizedInstancesForUserResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAuthorizedInstancesForUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAuthorizedInstancesForUserResponseBody> body_ {};
  };
