...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->affectRows_ == nullptr
        && return this->currentSql_ == nullptr && return this->dbId_ == nullptr && return this->endTime_ == nullptr && return this->executeCount_ == nullptr && return this->jobDetailId_ == nullptr
        && return this->jobId_ == nullptr && return this->log_ == nullptr && return this->logic_ == nullptr && return this->skip_ == nullptr && return this->sqlType_ == nullptr
        && return this->startTime_ == nullptr && return this->status_ == nullptr && return this->timeDelay_ == nullptr; };
