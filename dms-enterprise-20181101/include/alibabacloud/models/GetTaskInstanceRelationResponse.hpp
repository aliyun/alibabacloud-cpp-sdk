...
namespace Models
{
  ...
  public:
    ...
    inline const GetTaskInstanceRelationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTaskInstanceRelationResponseBody) };
    inline GetTaskInstanceRelationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTaskInstanceRelationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTaskInstanceRelationResponseBody> body_ {};
  };
