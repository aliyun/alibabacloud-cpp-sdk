...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceUserPermissionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstanceUserPermissionsResponseBody) };
    inline ListInstanceUserPermissionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInstanceUserPermissionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInstanceUserPermissionsResponseBody> body_ {};
  };
