...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePublishGroupTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreatePublishGroupTaskResponseBody) };
    inline CreatePublishGroupTaskResponseBody body() { DARABONBA_PTR_GET(body_, CreatePublishGroupTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreatePublishGroupTaskResponseBody> body_ = nullptr;
  };
