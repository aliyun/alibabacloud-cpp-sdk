...
namespace Models
{
  ...
  public:
    ...
    inline const GetAbacPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAbacPolicyResponseBody) };
    inline GetAbacPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAbacPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAbacPolicyResponseBody> body_ {};
  };
