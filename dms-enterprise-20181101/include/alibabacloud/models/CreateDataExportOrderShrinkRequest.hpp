...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->attachmentKey_ == nullptr
        && return this->comment_ == nullptr && return this->parentId_ == nullptr && return this->pluginParamShrink_ == nullptr && return this->realLoginUserUid_ == nullptr && return this->relatedUserListShrink_ == nullptr
