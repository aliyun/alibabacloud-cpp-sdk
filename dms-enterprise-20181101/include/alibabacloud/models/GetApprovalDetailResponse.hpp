...
namespace Models
{
  ...
  public:
    ...
    inline const GetApprovalDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetApprovalDetailResponseBody) };
    inline GetApprovalDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetApprovalDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetApprovalDetailResponseBody> body_ {};
  };
