...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTaskOutputResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTaskOutputResponseBody) };
    inline UpdateTaskOutputResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTaskOutputResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTaskOutputResponseBody> body_ {};
  };
