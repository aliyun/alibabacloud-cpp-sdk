...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataCorrectRollbackFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDataCorrectRollbackFileResponseBody) };
    inline GetDataCorrectRollbackFileResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDataCorrectRollbackFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDataCorrectRollbackFileResponseBody> body_ {};
  };
