...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDataTrackResultDownloadStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryDataTrackResultDownloadStatusResponseBody) };
    inline QueryDataTrackResultDownloadStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryDataTrackResultDownloadStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryDataTrackResultDownloadStatusResponseBody> body_ {};
  };
