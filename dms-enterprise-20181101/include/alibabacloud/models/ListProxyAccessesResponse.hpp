...
namespace Models
{
  ...
  public:
    ...
    inline const ListProxyAccessesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListProxyAccessesResponseBody) };
    inline ListProxyAccessesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListProxyAccessesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListProxyAccessesResponseBody> body_ {};
  };
