...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->asc_ == nullptr
        && return this->backFillDate_ == nullptr && return this->backFillDateBegin_ == nullptr && return this->backFillDateEnd_ == nullptr && return this->dagId_ == nullptr && return this->filterNodeIds_ == nullptr
        && return this->historyDagId_ == nullptr && return this->interval_ == nullptr && return this->isTriggerSubTree_ == nullptr && return this->startNodeIds_ == nullptr && return this->tid_ == nullptr; };
    // asc Field Functions 
    ...
    inline const vector<int64_t> & filterNodeIds() const { DARABONBA_PTR_GET_CONST(filterNodeIds_, vector<int64_t>) };
    inline vector<int64_t> filterNodeIds() { DARABONBA_PTR_GET(filterNodeIds_, vector<int64_t>) };
    ...
    inline const vector<int64_t> & startNodeIds() const { DARABONBA_PTR_GET_CONST(startNodeIds_, vector<int64_t>) };
    inline vector<int64_t> startNodeIds() { DARABONBA_PTR_GET(startNodeIds_, vector<int64_t>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<int64_t>> filterNodeIds_ = nullptr;
    ...
    std::shared_ptr<vector<int64_t>> startNodeIds_ = nullptr;
