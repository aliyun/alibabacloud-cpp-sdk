...
namespace Models
{
  ...
  public:
    ...
    inline const GetOwnerApplyOrderDetailResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetOwnerApplyOrderDetailResponseBody) };
    inline GetOwnerApplyOrderDetailResponseBody body() { DARABONBA_PTR_GET(body_, GetOwnerApplyOrderDetailResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetOwnerApplyOrderDetailResponseBody> body_ = nullptr;
  };
