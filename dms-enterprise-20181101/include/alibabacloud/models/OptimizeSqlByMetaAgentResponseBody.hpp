...
namespace Models
{
  ...
  public:
    ...
    inline const OptimizeSqlByMetaAgentResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, OptimizeSqlByMetaAgentResponseBody::Data) };
    inline OptimizeSqlByMetaAgentResponseBody::Data getData() { DARABONBA_PTR_GET(data_, OptimizeSqlByMetaAgentResponseBody::Data) };
    inline OptimizeSqlByMetaAgentResponseBody& setData(const OptimizeSqlByMetaAgentResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline OptimizeSqlByMetaAgentResponseBody& setData(OptimizeSqlByMetaAgentResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    shared_ptr<OptimizeSqlByMetaAgentResponseBody::Data> data_ {};
