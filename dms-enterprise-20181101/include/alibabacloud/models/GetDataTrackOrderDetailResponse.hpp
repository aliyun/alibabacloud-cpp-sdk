...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataTrackOrderDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDataTrackOrderDetailResponseBody) };
    inline GetDataTrackOrderDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDataTrackOrderDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDataTrackOrderDetailResponseBody> body_ {};
  };
