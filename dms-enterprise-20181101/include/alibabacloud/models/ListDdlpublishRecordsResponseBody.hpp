...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->DDLPublishRecordList_ != nullptr
    ...
    inline const vector<ListDDLPublishRecordsResponseBodyDDLPublishRecordList> & DDLPublishRecordList() const { DARABONBA_PTR_GET_CONST(DDLPublishRecordList_, vector<ListDDLPublishRecordsResponseBodyDDLPublishRecordList>) };
    inline vector<ListDDLPublishRecordsResponseBodyDDLPublishRecordList> DDLPublishRecordList() { DARABONBA_PTR_GET(DDLPublishRecordList_, vector<ListDDLPublishRecordsResponseBodyDDLPublishRecordList>) };
    inline ListDDLPublishRecordsResponseBody& setDDLPublishRecordList(const vector<ListDDLPublishRecordsResponseBodyDDLPublishRecordList> & DDLPublishRecordList) { DARABONBA_PTR_SET_VALUE(DDLPublishRecordList_, DDLPublishRecordList) };
    inline ListDDLPublishRecordsResponseBody& setDDLPublishRecordList(vector<ListDDLPublishRecordsResponseBodyDDLPublishRecordList> && DDLPublishRecordList) { DARABONBA_PTR_SET_RVALUE(DDLPublishRecordList_, DDLPublishRecordList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListDDLPublishRecordsResponseBodyDDLPublishRecordList>> DDLPublishRecordList_ = nullptr;
