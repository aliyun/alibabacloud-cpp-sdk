...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDatabaseExportOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDatabaseExportOrderResponseBody) };
    inline CreateDatabaseExportOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDatabaseExportOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDatabaseExportOrderResponseBody> body_ {};
  };
