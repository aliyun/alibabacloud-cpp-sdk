...
namespace Models
{
  ...
  public:
    ...
    inline const GetPhysicalDatabaseResponseBodyDatabase & database() const { DARABONBA_PTR_GET_CONST(database_, GetPhysicalDatabaseResponseBodyDatabase) };
    inline GetPhysicalDatabaseResponseBodyDatabase database() { DARABONBA_PTR_GET(database_, GetPhysicalDatabaseResponseBodyDatabase) };
    inline GetPhysicalDatabaseResponseBody& setDatabase(const GetPhysicalDatabaseResponseBodyDatabase & database) { DARABONBA_PTR_SET_VALUE(database_, database) };
    inline GetPhysicalDatabaseResponseBody& setDatabase(GetPhysicalDatabaseResponseBodyDatabase && database) { DARABONBA_PTR_SET_RVALUE(database_, database) };
  ...
  protected:
    ...
    std::shared_ptr<GetPhysicalDatabaseResponseBodyDatabase> database_ = nullptr;
