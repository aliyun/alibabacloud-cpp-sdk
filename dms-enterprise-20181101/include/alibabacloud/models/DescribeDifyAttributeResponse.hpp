...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDifyAttributeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDifyAttributeResponseBody) };
    inline DescribeDifyAttributeResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDifyAttributeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDifyAttributeResponseBody> body_ = nullptr;
  };
