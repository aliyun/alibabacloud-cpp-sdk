...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->indepAccount_ == nullptr
        && return this->indepPassword_ == nullptr && return this->proxyId_ == nullptr && return this->tid_ == nullptr && return this->userId_ == nullptr; };
