...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dagId_ == nullptr
        && return this->graphParam_ == nullptr && return this->nodeConfig_ == nullptr && return this->nodeContent_ == nullptr && return this->nodeId_ == nullptr && return this->nodeName_ == nullptr
