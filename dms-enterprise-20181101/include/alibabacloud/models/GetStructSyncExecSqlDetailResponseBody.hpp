...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorCode_ == nullptr
        && return this->errorMessage_ == nullptr && return this->requestId_ == nullptr && return this->structSyncExecSqlDetail_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const GetStructSyncExecSqlDetailResponseBodyStructSyncExecSqlDetail & structSyncExecSqlDetail() const { DARABONBA_PTR_GET_CONST(structSyncExecSqlDetail_, GetStructSyncExecSqlDetailResponseBodyStructSyncExecSqlDetail) };
    inline GetStructSyncExecSqlDetailResponseBodyStructSyncExecSqlDetail structSyncExecSqlDetail() { DARABONBA_PTR_GET(structSyncExecSqlDetail_, GetStructSyncExecSqlDetailResponseBodyStructSyncExecSqlDetail) };
    inline GetStructSyncExecSqlDetailResponseBody& setStructSyncExecSqlDetail(const GetStructSyncExecSqlDetailResponseBodyStructSyncExecSqlDetail & structSyncExecSqlDetail) { DARABONBA_PTR_SET_VALUE(structSyncExecSqlDetail_, structSyncExecSqlDetail) };
    inline GetStructSyncExecSqlDetailResponseBody& setStructSyncExecSqlDetail(GetStructSyncExecSqlDetailResponseBodyStructSyncExecSqlDetail && structSyncExecSqlDetail) { DARABONBA_PTR_SET_RVALUE(structSyncExecSqlDetail_, structSyncExecSqlDetail) };
  ...
  protected:
    ...
    std::shared_ptr<GetStructSyncExecSqlDetailResponseBodyStructSyncExecSqlDetail> structSyncExecSqlDetail_ = nullptr;
