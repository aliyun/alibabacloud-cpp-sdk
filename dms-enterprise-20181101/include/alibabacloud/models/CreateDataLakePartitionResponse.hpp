...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDataLakePartitionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDataLakePartitionResponseBody) };
    inline CreateDataLakePartitionResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDataLakePartitionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDataLakePartitionResponseBody> body_ {};
  };
