...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorCode_ == nullptr
        && return this->errorMessage_ == nullptr && return this->indexList_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const ListIndexesResponseBodyIndexList & indexList() const { DARABONBA_PTR_GET_CONST(indexList_, ListIndexesResponseBodyIndexList) };
    inline ListIndexesResponseBodyIndexList indexList() { DARABONBA_PTR_GET(indexList_, ListIndexesResponseBodyIndexList) };
    inline ListIndexesResponseBody& setIndexList(const ListIndexesResponseBodyIndexList & indexList) { DARABONBA_PTR_SET_VALUE(indexList_, indexList) };
    inline ListIndexesResponseBody& setIndexList(ListIndexesResponseBodyIndexList && indexList) { DARABONBA_PTR_SET_RVALUE(indexList_, indexList) };
  ...
  protected:
    ...
    std::shared_ptr<ListIndexesResponseBodyIndexList> indexList_ = nullptr;
