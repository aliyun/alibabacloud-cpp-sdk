...
namespace Models
{
  ...
  public:
    ...
    inline const ResumeTaskFlowInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResumeTaskFlowInstanceResponseBody) };
    inline ResumeTaskFlowInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, ResumeTaskFlowInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResumeTaskFlowInstanceResponseBody> body_ {};
  };
