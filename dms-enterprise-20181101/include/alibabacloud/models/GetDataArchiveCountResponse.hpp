...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataArchiveCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDataArchiveCountResponseBody) };
    inline GetDataArchiveCountResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDataArchiveCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDataArchiveCountResponseBody> body_ {};
  };
