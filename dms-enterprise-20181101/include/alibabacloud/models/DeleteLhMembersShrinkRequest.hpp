...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->memberIdsShrink_ != nullptr
    ...
    inline string memberIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(memberIdsShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> memberIdsShrink_ = nullptr;
