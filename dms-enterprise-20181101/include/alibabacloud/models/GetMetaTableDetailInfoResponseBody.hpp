...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaTableDetailInfoResponseBodyDetailInfo & detailInfo() const { DARABONBA_PTR_GET_CONST(detailInfo_, GetMetaTableDetailInfoResponseBodyDetailInfo) };
    inline GetMetaTableDetailInfoResponseBodyDetailInfo detailInfo() { DARABONBA_PTR_GET(detailInfo_, GetMetaTableDetailInfoResponseBodyDetailInfo) };
    inline GetMetaTableDetailInfoResponseBody& setDetailInfo(const GetMetaTableDetailInfoResponseBodyDetailInfo & detailInfo) { DARABONBA_PTR_SET_VALUE(detailInfo_, detailInfo) };
    inline GetMetaTableDetailInfoResponseBody& setDetailInfo(GetMetaTableDetailInfoResponseBodyDetailInfo && detailInfo) { DARABONBA_PTR_SET_RVALUE(detailInfo_, detailInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetMetaTableDetailInfoResponseBodyDetailInfo> detailInfo_ = nullptr;
