...
namespace Models
{
  ...
  public:
    ...
    inline const ListStandardGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListStandardGroupsResponseBody) };
    inline ListStandardGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListStandardGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListStandardGroupsResponseBody> body_ {};
  };
