...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataLakeCatalogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataLakeCatalogResponseBody) };
    inline ListDataLakeCatalogResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataLakeCatalogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataLakeCatalogResponseBody> body_ {};
  };
