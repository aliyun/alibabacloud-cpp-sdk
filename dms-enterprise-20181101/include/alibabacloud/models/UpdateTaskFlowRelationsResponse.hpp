...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTaskFlowRelationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTaskFlowRelationsResponseBody) };
    inline UpdateTaskFlowRelationsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTaskFlowRelationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTaskFlowRelationsResponseBody> body_ {};
  };
