...
namespace Models
{
  ...
  public:
    ...
    inline const GetDBTaskSQLJobLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDBTaskSQLJobLogResponseBody) };
    inline GetDBTaskSQLJobLogResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDBTaskSQLJobLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDBTaskSQLJobLogResponseBody> body_ {};
  };
