...
namespace Models
{
  ...
  public:
    ...
    inline const GetProxyAccessResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetProxyAccessResponseBody) };
    inline GetProxyAccessResponseBody getBody() { DARABONBA_PTR_GET(body_, GetProxyAccessResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetProxyAccessResponseBody> body_ {};
  };
