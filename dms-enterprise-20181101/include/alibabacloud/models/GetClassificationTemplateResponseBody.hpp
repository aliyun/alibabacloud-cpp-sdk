...
namespace Models
{
  ...
  public:
    ...
    inline const GetClassificationTemplateResponseBodyClassificationResourceTemplateMap & classificationResourceTemplateMap() const { DARABONBA_PTR_GET_CONST(classificationResourceTemplateMap_, GetClassificationTemplateResponseBodyClassificationResourceTemplateMap) };
    inline GetClassificationTemplateResponseBodyClassificationResourceTemplateMap classificationResourceTemplateMap() { DARABONBA_PTR_GET(classificationResourceTemplateMap_, GetClassificationTemplateResponseBodyClassificationResourceTemplateMap) };
    inline GetClassificationTemplateResponseBody& setClassificationResourceTemplateMap(const GetClassificationTemplateResponseBodyClassificationResourceTemplateMap & classificationResourceTemplateMap) { DARABONBA_PTR_SET_VALUE(classificationResourceTemplateMap_, classificationResourceTemplateMap) };
    inline GetClassificationTemplateResponseBody& setClassificationResourceTemplateMap(GetClassificationTemplateResponseBodyClassificationResourceTemplateMap && classificationResourceTemplateMap) { DARABONBA_PTR_SET_RVALUE(classificationResourceTemplateMap_, classificationResourceTemplateMap) };
