...
namespace Models
{
  ...
  public:
    ...
    inline const ListDatabasesResponseBody::DatabaseList & getDatabaseList() const { DARABONBA_PTR_GET_CONST(databaseList_, ListDatabasesResponseBody::DatabaseList) };
    inline ListDatabasesResponseBody::DatabaseList getDatabaseList() { DARABONBA_PTR_GET(databaseList_, ListDatabasesResponseBody::DatabaseList) };
    inline ListDatabasesResponseBody& setDatabaseList(const ListDatabasesResponseBody::DatabaseList & databaseList) { DARABONBA_PTR_SET_VALUE(databaseList_, databaseList) };
    inline ListDatabasesResponseBody& setDatabaseList(ListDatabasesResponseBody::DatabaseList && databaseList) { DARABONBA_PTR_SET_RVALUE(databaseList_, databaseList) };
