...
namespace Models
{
  ...
  public:
    ...
    inline const ListDatabasesResponseBodyDatabaseList & databaseList() const { DARABONBA_PTR_GET_CONST(databaseList_, ListDatabasesResponseBodyDatabaseList) };
    inline ListDatabasesResponseBodyDatabaseList databaseList() { DARABONBA_PTR_GET(databaseList_, ListDatabasesResponseBodyDatabaseList) };
    inline ListDatabasesResponseBody& setDatabaseList(const ListDatabasesResponseBodyDatabaseList & databaseList) { DARABONBA_PTR_SET_VALUE(databaseList_, databaseList) };
    inline ListDatabasesResponseBody& setDatabaseList(ListDatabasesResponseBodyDatabaseList && databaseList) { DARABONBA_PTR_SET_RVALUE(databaseList_, databaseList) };
  ...
  protected:
    ...
    std::shared_ptr<ListDatabasesResponseBodyDatabaseList> databaseList_ = nullptr;
