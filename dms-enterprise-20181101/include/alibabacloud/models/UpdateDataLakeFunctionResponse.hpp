...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDataLakeFunctionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateDataLakeFunctionResponseBody) };
    inline UpdateDataLakeFunctionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateDataLakeFunctionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateDataLakeFunctionResponseBody> body_ {};
  };
