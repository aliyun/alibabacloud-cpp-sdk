...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeColumnSecurityLevelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ChangeColumnSecurityLevelResponseBody) };
    inline ChangeColumnSecurityLevelResponseBody getBody() { DARABONBA_PTR_GET(body_, ChangeColumnSecurityLevelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ChangeColumnSecurityLevelResponseBody> body_ {};
  };
