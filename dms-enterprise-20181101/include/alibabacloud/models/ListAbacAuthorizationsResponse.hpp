...
namespace Models
{
  ...
  public:
    ...
    inline const ListAbacAuthorizationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAbacAuthorizationsResponseBody) };
    inline ListAbacAuthorizationsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAbacAuthorizationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAbacAuthorizationsResponseBody> body_ {};
  };
