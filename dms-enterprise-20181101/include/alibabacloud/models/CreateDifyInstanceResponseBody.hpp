...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDifyInstanceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateDifyInstanceResponseBodyData) };
    inline CreateDifyInstanceResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateDifyInstanceResponseBodyData) };
    inline CreateDifyInstanceResponseBody& setData(const CreateDifyInstanceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateDifyInstanceResponseBody& setData(CreateDifyInstanceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateDifyInstanceResponseBodyData> data_ = nullptr;
