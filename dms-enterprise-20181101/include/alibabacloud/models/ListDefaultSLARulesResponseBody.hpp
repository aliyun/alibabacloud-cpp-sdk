...
namespace Models
{
  ...
  public:
    ...
    inline const ListDefaultSLARulesResponseBody::SLARuleList & getSLARuleList() const { DARABONBA_PTR_GET_CONST(SLARuleList_, ListDefaultSLARulesResponseBody::SLARuleList) };
    inline ListDefaultSLARulesResponseBody::SLARuleList getSLARuleList() { DARABONBA_PTR_GET(SLARuleList_, ListDefaultSLARulesResponseBody::SLARuleList) };
    inline ListDefaultSLARulesResponseBody& setSLARuleList(const ListDefaultSLARulesResponseBody::SLARuleList & sLARuleList) { DARABONBA_PTR_SET_VALUE(SLARuleList_, sLARuleList) };
    inline ListDefaultSLARulesResponseBody& setSLARuleList(ListDefaultSLARulesResponseBody::SLARuleList && sLARuleList) { DARABONBA_PTR_SET_RVALUE(SLARuleList_, sLARuleList) };
  ...
  protected:
    ...
    shared_ptr<ListDefaultSLARulesResponseBody::SLARuleList> SLARuleList_ {};
