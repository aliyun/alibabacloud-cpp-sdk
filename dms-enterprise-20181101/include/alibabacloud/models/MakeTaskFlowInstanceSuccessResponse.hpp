...
namespace Models
{
  ...
  public:
    ...
    inline const MakeTaskFlowInstanceSuccessResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MakeTaskFlowInstanceSuccessResponseBody) };
    inline MakeTaskFlowInstanceSuccessResponseBody getBody() { DARABONBA_PTR_GET(body_, MakeTaskFlowInstanceSuccessResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MakeTaskFlowInstanceSuccessResponseBody> body_ {};
  };
