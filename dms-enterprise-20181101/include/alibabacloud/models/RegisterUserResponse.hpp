...
namespace Models
{
  ...
  public:
    ...
    inline const RegisterUserResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RegisterUserResponseBody) };
    inline RegisterUserResponseBody body() { DARABONBA_PTR_GET(body_, RegisterUserResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RegisterUserResponseBody> body_ = nullptr;
  };
