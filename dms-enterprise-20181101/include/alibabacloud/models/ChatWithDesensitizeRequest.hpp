...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->audioJson_ == nullptr
        ...
        && return this->logprobs_ == nullptr && return this->maxTokens_ == nullptr && return this->messages_ == nullptr && return this->modalitiesList_ == nullptr && return this->model_ == nullptr
        && return this->needDesensitization_ == nullptr && return this->presencePenalty_ == nullptr && return this->responseFormat_ == nullptr && return this->searchOptions_ == nullptr && return this->seed_ == nullptr
        && return this->stop_ == nullptr && return this->temperature_ == nullptr && return this->thinkingBudget_ == nullptr && return this->topK_ == nullptr && return this->topLogprobs_ == nullptr
    ...
    inline ChatWithDesensitizeRequest& setAudioJson(string audioJson) { DARABONBA_PTR_SET_VALUE(audioJson_, audioJson) };
    ...
    inline ChatWithDesensitizeRequest& setEnableCodeInterpreter(bool enableCodeInterpreter) { DARABONBA_PTR_SET_VALUE(enableCodeInterpreter_, enableCodeInterpreter) };
    ...
    inline ChatWithDesensitizeRequest& setEnableSearch(bool enableSearch) { DARABONBA_PTR_SET_VALUE(enableSearch_, enableSearch) };
    ...
    inline ChatWithDesensitizeRequest& setLogprobs(bool logprobs) { DARABONBA_PTR_SET_VALUE(logprobs_, logprobs) };
    ...
    inline ChatWithDesensitizeRequest& setModalitiesList(const vector<string> & modalitiesList) { DARABONBA_PTR_SET_VALUE(modalitiesList_, modalitiesList) };
    inline ChatWithDesensitizeRequest& setModalitiesList(vector<string> && modalitiesList) { DARABONBA_PTR_SET_RVALUE(modalitiesList_, modalitiesList) };
    ...
    inline ChatWithDesensitizeRequest& setPresencePenalty(string presencePenalty) { DARABONBA_PTR_SET_VALUE(presencePenalty_, presencePenalty) };
    ...
    inline ChatWithDesensitizeRequest& setSearchOptions(const map<string, string> & searchOptions) { DARABONBA_PTR_SET_VALUE(searchOptions_, searchOptions) };
    inline ChatWithDesensitizeRequest& setSearchOptions(map<string, string> && searchOptions) { DARABONBA_PTR_SET_RVALUE(searchOptions_, searchOptions) };
    ...
    inline ChatWithDesensitizeRequest& setTemperature(string temperature) { DARABONBA_PTR_SET_VALUE(temperature_, temperature) };
    ...
    inline ChatWithDesensitizeRequest& setTopP(string topP) { DARABONBA_PTR_SET_VALUE(topP_, topP) };
    ...
    inline ChatWithDesensitizeRequest& setVlHighResolutionImages(bool vlHighResolutionImages) { DARABONBA_PTR_SET_VALUE(vlHighResolutionImages_, vlHighResolutionImages) };
    ...
    inline ChatWithDesensitizeRequest& setXDashScopeDataInspection(string XDashScopeDataInspection) { DARABONBA_PTR_SET_VALUE(XDashScopeDataInspection_, XDashScopeDataInspection) };
