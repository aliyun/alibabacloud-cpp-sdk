...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->databaseName_ == nullptr
        && this->dbType_ == nullptr && this->envType_ == nullptr && this->logic_ == nullptr && this->ownerType_ == nullptr && this->pageNumber_ == nullptr
        && this->pageSize_ == nullptr && this->tid_ == nullptr && this->userId_ == nullptr; };
