...
namespace Models
{
  ...
  public:
    ...
    inline const GetLogicDatabaseResponseBody::LogicDatabase & getLogicDatabase() const { DARABONBA_PTR_GET_CONST(logicDatabase_, GetLogicDatabaseResponseBody::LogicDatabase) };
    inline GetLogicDatabaseResponseBody::LogicDatabase getLogicDatabase() { DARABONBA_PTR_GET(logicDatabase_, GetLogicDatabaseResponseBody::LogicDatabase) };
    inline GetLogicDatabaseResponseBody& setLogicDatabase(const GetLogicDatabaseResponseBody::LogicDatabase & logicDatabase) { DARABONBA_PTR_SET_VALUE(logicDatabase_, logicDatabase) };
    inline GetLogicDatabaseResponseBody& setLogicDatabase(GetLogicDatabaseResponseBody::LogicDatabase && logicDatabase) { DARABONBA_PTR_SET_RVALUE(logicDatabase_, logicDatabase) };
  ...
  protected:
    ...
    shared_ptr<GetLogicDatabaseResponseBody::LogicDatabase> logicDatabase_ {};
