...
namespace Models
{
  ...
  public:
    ...
    inline const RevokeUserPermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RevokeUserPermissionResponseBody) };
    inline RevokeUserPermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, RevokeUserPermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RevokeUserPermissionResponseBody> body_ {};
  };
