...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAuthorityTemplateResponseBody::AuthorityTemplateView & getAuthorityTemplateView() const { DARABONBA_PTR_GET_CONST(authorityTemplateView_, CreateAuthorityTemplateResponseBody::AuthorityTemplateView) };
    inline CreateAuthorityTemplateResponseBody::AuthorityTemplateView getAuthorityTemplateView() { DARABONBA_PTR_GET(authorityTemplateView_, CreateAuthorityTemplateResponseBody::AuthorityTemplateView) };
    inline CreateAuthorityTemplateResponseBody& setAuthorityTemplateView(const CreateAuthorityTemplateResponseBody::AuthorityTemplateView & authorityTemplateView) { DARABONBA_PTR_SET_VALUE(authorityTemplateView_, authorityTemplateView) };
    inline CreateAuthorityTemplateResponseBody& setAuthorityTemplateView(CreateAuthorityTemplateResponseBody::AuthorityTemplateView && authorityTemplateView) { DARABONBA_PTR_SET_RVALUE(authorityTemplateView_, authorityTemplateView) };
  ...
  protected:
    ...
    shared_ptr<CreateAuthorityTemplateResponseBody::AuthorityTemplateView> authorityTemplateView_ {};
    // The error code.
