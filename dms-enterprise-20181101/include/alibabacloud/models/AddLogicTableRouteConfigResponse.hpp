...
namespace Models
{
  ...
  public:
    ...
    inline const AddLogicTableRouteConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddLogicTableRouteConfigResponseBody) };
    inline AddLogicTableRouteConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, AddLogicTableRouteConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddLogicTableRouteConfigResponseBody> body_ {};
  };
