...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaTableDetailInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMetaTableDetailInfoResponseBody) };
    inline GetMetaTableDetailInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMetaTableDetailInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMetaTableDetailInfoResponseBody> body_ {};
  };
