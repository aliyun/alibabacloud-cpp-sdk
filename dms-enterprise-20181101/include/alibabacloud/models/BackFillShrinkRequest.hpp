...
namespace Models
{
  ...
  public:
    ...
    inline string getFilterNodeIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(filterNodeIdsShrink_, "") };
    ...
    inline string getStartNodeIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(startNodeIdsShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> filterNodeIdsShrink_ {};
    ...
    shared_ptr<string> startNodeIdsShrink_ {};
