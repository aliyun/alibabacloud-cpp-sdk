...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDataLakeTableResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteDataLakeTableResponseBody) };
    inline DeleteDataLakeTableResponseBody body() { DARABONBA_PTR_GET(body_, DeleteDataLakeTableResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteDataLakeTableResponseBody> body_ = nullptr;
  };
