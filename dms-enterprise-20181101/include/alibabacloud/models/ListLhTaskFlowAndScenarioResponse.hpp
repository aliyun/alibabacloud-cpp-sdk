...
namespace Models
{
  ...
  public:
    ...
    inline const ListLhTaskFlowAndScenarioResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLhTaskFlowAndScenarioResponseBody) };
    inline ListLhTaskFlowAndScenarioResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLhTaskFlowAndScenarioResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLhTaskFlowAndScenarioResponseBody> body_ {};
  };
