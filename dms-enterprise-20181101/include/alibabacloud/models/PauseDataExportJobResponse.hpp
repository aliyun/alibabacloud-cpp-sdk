...
namespace Models
{
  ...
  public:
    ...
    inline const PauseDataExportJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PauseDataExportJobResponseBody) };
    inline PauseDataExportJobResponseBody getBody() { DARABONBA_PTR_GET(body_, PauseDataExportJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PauseDataExportJobResponseBody> body_ {};
  };
