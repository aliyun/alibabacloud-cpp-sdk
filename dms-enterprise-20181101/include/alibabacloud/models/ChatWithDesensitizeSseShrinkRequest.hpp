...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->audioJson_ == nullptr
        ...
        && return this->instanceId_ == nullptr && return this->logprobs_ == nullptr && return this->maxTokens_ == nullptr && return this->messagesShrink_ == nullptr && return this->modalitiesListShrink_ == nullptr
        && return this->model_ == nullptr && return this->needDesensitization_ == nullptr && return this->presencePenalty_ == nullptr && return this->responseFormat_ == nullptr && return this->searchOptionsShrink_ == nullptr
        && return this->seed_ == nullptr && return this->stopShrink_ == nullptr && return this->stream_ == nullptr && return this->temperature_ == nullptr && return this->thinkingBudget_ == nullptr
