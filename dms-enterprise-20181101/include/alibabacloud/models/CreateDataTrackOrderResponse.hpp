...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDataTrackOrderResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateDataTrackOrderResponseBody) };
    inline CreateDataTrackOrderResponseBody body() { DARABONBA_PTR_GET(body_, CreateDataTrackOrderResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateDataTrackOrderResponseBody> body_ = nullptr;
  };
