...
namespace Models
{
  ...
  public:
    ...
    inline const GetOrderBaseInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOrderBaseInfoResponseBody) };
    inline GetOrderBaseInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOrderBaseInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOrderBaseInfoResponseBody> body_ {};
  };
