...
namespace Models
{
  ...
  public:
    ...
    inline const ListLogicTableRouteConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLogicTableRouteConfigResponseBody) };
    inline ListLogicTableRouteConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLogicTableRouteConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLogicTableRouteConfigResponseBody> body_ {};
  };
