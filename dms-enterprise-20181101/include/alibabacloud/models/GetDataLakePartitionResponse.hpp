...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataLakePartitionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetDataLakePartitionResponseBody) };
    inline GetDataLakePartitionResponseBody body() { DARABONBA_PTR_GET(body_, GetDataLakePartitionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetDataLakePartitionResponseBody> body_ = nullptr;
  };
