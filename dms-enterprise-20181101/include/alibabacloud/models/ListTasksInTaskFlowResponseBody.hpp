...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorCode_ == nullptr
        && return this->errorMessage_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr && return this->tasks_ == nullptr; };
    ...
    inline const ListTasksInTaskFlowResponseBodyTasks & tasks() const { DARABONBA_PTR_GET_CONST(tasks_, ListTasksInTaskFlowResponseBodyTasks) };
    inline ListTasksInTaskFlowResponseBodyTasks tasks() { DARABONBA_PTR_GET(tasks_, ListTasksInTaskFlowResponseBodyTasks) };
    inline ListTasksInTaskFlowResponseBody& setTasks(const ListTasksInTaskFlowResponseBodyTasks & tasks) { DARABONBA_PTR_SET_VALUE(tasks_, tasks) };
    inline ListTasksInTaskFlowResponseBody& setTasks(ListTasksInTaskFlowResponseBodyTasks && tasks) { DARABONBA_PTR_SET_RVALUE(tasks_, tasks) };
  ...
  protected:
    ...
    std::shared_ptr<ListTasksInTaskFlowResponseBodyTasks> tasks_ = nullptr;
  };
