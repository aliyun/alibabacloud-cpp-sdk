...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline string getSellSitd() const { DARABONBA_PTR_GET_DEFAULT(sellSitd_, "") };
      inline Instance& setSellSitd(string sellSitd) { DARABONBA_PTR_SET_VALUE(sellSitd_, sellSitd) };
