...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dagInstanceId_ == nullptr
        && return this->errorCode_ == nullptr && return this->errorMessage_ == nullptr && return this->nodeId_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
