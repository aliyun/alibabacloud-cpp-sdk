...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateScenarioResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateScenarioResponseBody) };
    inline UpdateScenarioResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateScenarioResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateScenarioResponseBody> body_ {};
  };
