...
namespace Models
{
  ...
  public:
    ...
    inline const ListSensitivityLevelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSensitivityLevelResponseBody) };
    inline ListSensitivityLevelResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSensitivityLevelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSensitivityLevelResponseBody> body_ {};
  };
