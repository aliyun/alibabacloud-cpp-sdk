...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->funcType_ == nullptr
        && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->ruleId_ == nullptr && this->ruleName_ == nullptr && this->ruleType_ == nullptr
        && this->tid_ == nullptr; };
    // funcType Field Functions 
    bool hasFuncType() const { return this->funcType_ != nullptr;};
    void deleteFuncType() { this->funcType_ = nullptr;};
    inline string getFuncType() const { DARABONBA_PTR_GET_DEFAULT(funcType_, "") };
