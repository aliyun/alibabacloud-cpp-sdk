...
namespace Models
{
  ...
  public:
    ...
    inline const GetSQLReviewOptimizeDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSQLReviewOptimizeDetailResponseBody) };
    inline GetSQLReviewOptimizeDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSQLReviewOptimizeDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSQLReviewOptimizeDetailResponseBody> body_ {};
  };
