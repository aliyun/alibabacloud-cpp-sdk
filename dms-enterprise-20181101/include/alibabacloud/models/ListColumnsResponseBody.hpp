...
namespace Models
{
  ...
  public:
    ...
    inline const ListColumnsResponseBody::ColumnList & getColumnList() const { DARABONBA_PTR_GET_CONST(columnList_, ListColumnsResponseBody::ColumnList) };
    inline ListColumnsResponseBody::ColumnList getColumnList() { DARABONBA_PTR_GET(columnList_, ListColumnsResponseBody::ColumnList) };
    inline ListColumnsResponseBody& setColumnList(const ListColumnsResponseBody::ColumnList & columnList) { DARABONBA_PTR_SET_VALUE(columnList_, columnList) };
    inline ListColumnsResponseBody& setColumnList(ListColumnsResponseBody::ColumnList && columnList) { DARABONBA_PTR_SET_RVALUE(columnList_, columnList) };
