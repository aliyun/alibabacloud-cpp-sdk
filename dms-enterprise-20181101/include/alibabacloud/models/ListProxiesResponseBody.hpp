...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorCode_ == nullptr
        && return this->errorMessage_ == nullptr && return this->proxyList_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const vector<ListProxiesResponseBodyProxyList> & proxyList() const { DARABONBA_PTR_GET_CONST(proxyList_, vector<ListProxiesResponseBodyProxyList>) };
    inline vector<ListProxiesResponseBodyProxyList> proxyList() { DARABONBA_PTR_GET(proxyList_, vector<ListProxiesResponseBodyProxyList>) };
    inline ListProxiesResponseBody& setProxyList(const vector<ListProxiesResponseBodyProxyList> & proxyList) { DARABONBA_PTR_SET_VALUE(proxyList_, proxyList) };
    inline ListProxiesResponseBody& setProxyList(vector<ListProxiesResponseBodyProxyList> && proxyList) { DARABONBA_PTR_SET_RVALUE(proxyList_, proxyList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListProxiesResponseBodyProxyList>> proxyList_ = nullptr;
