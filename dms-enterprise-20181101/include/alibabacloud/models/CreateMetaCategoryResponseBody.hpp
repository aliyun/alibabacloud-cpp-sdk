...
namespace Models
{
  ...
  public:
    ...
    inline const MetaCategory & getCategory() const { DARABONBA_PTR_GET_CONST(category_, MetaCategory) };
    inline MetaCategory getCategory() { DARABONBA_PTR_GET(category_, MetaCategory) };
  ...
  protected:
    ...
    shared_ptr<MetaCategory> category_ {};
