...
namespace Models
{
  ...
  public:
    ...
    inline const ListWorkFlowTemplatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListWorkFlowTemplatesResponseBody) };
    inline ListWorkFlowTemplatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListWorkFlowTemplatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListWorkFlowTemplatesResponseBody> body_ {};
  };
