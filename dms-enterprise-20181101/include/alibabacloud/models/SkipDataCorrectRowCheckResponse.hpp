...
namespace Models
{
  ...
  public:
    ...
    inline const SkipDataCorrectRowCheckResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SkipDataCorrectRowCheckResponseBody) };
    inline SkipDataCorrectRowCheckResponseBody getBody() { DARABONBA_PTR_GET(body_, SkipDataCorrectRowCheckResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SkipDataCorrectRowCheckResponseBody> body_ {};
  };
