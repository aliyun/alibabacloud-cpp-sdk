...
namespace Models
{
  ...
  public:
    ...
    inline const EnableUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableUserResponseBody) };
    inline EnableUserResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableUserResponseBody> body_ {};
  };
