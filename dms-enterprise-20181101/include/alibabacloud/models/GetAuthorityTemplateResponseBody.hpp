...
namespace Models
{
  ...
  public:
    ...
    inline const GetAuthorityTemplateResponseBodyAuthorityTemplateView & authorityTemplateView() const { DARABONBA_PTR_GET_CONST(authorityTemplateView_, GetAuthorityTemplateResponseBodyAuthorityTemplateView) };
    inline GetAuthorityTemplateResponseBodyAuthorityTemplateView authorityTemplateView() { DARABONBA_PTR_GET(authorityTemplateView_, GetAuthorityTemplateResponseBodyAuthorityTemplateView) };
    inline GetAuthorityTemplateResponseBody& setAuthorityTemplateView(const GetAuthorityTemplateResponseBodyAuthorityTemplateView & authorityTemplateView) { DARABONBA_PTR_SET_VALUE(authorityTemplateView_, authorityTemplateView) };
    inline GetAuthorityTemplateResponseBody& setAuthorityTemplateView(GetAuthorityTemplateResponseBodyAuthorityTemplateView && authorityTemplateView) { DARABONBA_PTR_SET_RVALUE(authorityTemplateView_, authorityTemplateView) };
  ...
  protected:
    ...
    std::shared_ptr<GetAuthorityTemplateResponseBodyAuthorityTemplateView> authorityTemplateView_ = nullptr;
