...
namespace Models
{
  ...
  public:
    ...
    inline const AddDesensitizationRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddDesensitizationRuleResponseBody) };
    inline AddDesensitizationRuleResponseBody body() { DARABONBA_PTR_GET(body_, AddDesensitizationRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddDesensitizationRuleResponseBody> body_ = nullptr;
  };
