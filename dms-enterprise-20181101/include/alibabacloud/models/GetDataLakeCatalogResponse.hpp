...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataLakeCatalogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDataLakeCatalogResponseBody) };
    inline GetDataLakeCatalogResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDataLakeCatalogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDataLakeCatalogResponseBody> body_ {};
  };
