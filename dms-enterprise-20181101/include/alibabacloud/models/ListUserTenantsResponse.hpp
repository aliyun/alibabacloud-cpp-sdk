...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserTenantsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUserTenantsResponseBody) };
    inline ListUserTenantsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUserTenantsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUserTenantsResponseBody> body_ {};
  };
