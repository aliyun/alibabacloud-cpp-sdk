...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && this->devDbId_ == nullptr && this->dwDbType_ == nullptr && this->mode_ == nullptr && this->prodDbId_ == nullptr && this->spaceConfig_ == nullptr
        && this->spaceName_ == nullptr && this->tid_ == nullptr; };
    ...
    inline string getDevDbId() const { DARABONBA_PTR_GET_DEFAULT(devDbId_, "") };
    ...
    inline string getProdDbId() const { DARABONBA_PTR_GET_DEFAULT(prodDbId_, "") };
