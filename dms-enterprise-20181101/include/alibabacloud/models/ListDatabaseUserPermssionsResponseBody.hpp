...
namespace Models
{
  ...
  public:
    ...
    inline const ListDatabaseUserPermssionsResponseBodyUserPermissions & userPermissions() const { DARABONBA_PTR_GET_CONST(userPermissions_, ListDatabaseUserPermssionsResponseBodyUserPermissions) };
    inline ListDatabaseUserPermssionsResponseBodyUserPermissions userPermissions() { DARABONBA_PTR_GET(userPermissions_, ListDatabaseUserPermssionsResponseBodyUserPermissions) };
    inline ListDatabaseUserPermssionsResponseBody& setUserPermissions(const ListDatabaseUserPermssionsResponseBodyUserPermissions & userPermissions) { DARABONBA_PTR_SET_VALUE(userPermissions_, userPermissions) };
    inline ListDatabaseUserPermssionsResponseBody& setUserPermissions(ListDatabaseUserPermssionsResponseBodyUserPermissions && userPermissions) { DARABONBA_PTR_SET_RVALUE(userPermissions_, userPermissions) };
  ...
  protected:
    ...
    std::shared_ptr<ListDatabaseUserPermssionsResponseBodyUserPermissions> userPermissions_ = nullptr;
  };
