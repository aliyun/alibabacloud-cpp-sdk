...
namespace Models
{
  ...
  public:
    ...
    inline const TryRunTaskFlowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TryRunTaskFlowResponseBody) };
    inline TryRunTaskFlowResponseBody getBody() { DARABONBA_PTR_GET(body_, TryRunTaskFlowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TryRunTaskFlowResponseBody> body_ {};
  };
