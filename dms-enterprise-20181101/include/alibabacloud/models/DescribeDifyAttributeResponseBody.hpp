...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDifyAttributeResponseBodyRoot & root() const { DARABONBA_PTR_GET_CONST(root_, DescribeDifyAttributeResponseBodyRoot) };
    inline DescribeDifyAttributeResponseBodyRoot root() { DARABONBA_PTR_GET(root_, DescribeDifyAttributeResponseBodyRoot) };
    inline DescribeDifyAttributeResponseBody& setRoot(const DescribeDifyAttributeResponseBodyRoot & root) { DARABONBA_PTR_SET_VALUE(root_, root) };
    inline DescribeDifyAttributeResponseBody& setRoot(DescribeDifyAttributeResponseBodyRoot && root) { DARABONBA_PTR_SET_RVALUE(root_, root) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDifyAttributeResponseBodyRoot> root_ = nullptr;
