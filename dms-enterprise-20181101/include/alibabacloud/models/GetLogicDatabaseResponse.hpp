...
namespace Models
{
  ...
  public:
    ...
    inline const GetLogicDatabaseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLogicDatabaseResponseBody) };
    inline GetLogicDatabaseResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLogicDatabaseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLogicDatabaseResponseBody> body_ {};
  };
