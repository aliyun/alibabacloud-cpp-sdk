...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataLakeFunctionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataLakeFunctionResponseBody) };
    inline ListDataLakeFunctionResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataLakeFunctionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataLakeFunctionResponseBody> body_ {};
  };
