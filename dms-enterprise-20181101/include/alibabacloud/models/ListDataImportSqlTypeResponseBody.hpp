...
#ifndef ALIBABACLOUD_MODELS_LISTDATAIMPORTSQLTYPERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTDATAIMPORTSQLTYPERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDataImportSQLTypeResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(ErrorCode, errorCode_);
      DARABONBA_PTR_TO_JSON(ErrorMessage, errorMessage_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(SqlTypeResult, sqlTypeResult_);
      DARABONBA_PTR_TO_JSON(Success, success_);
    };
    friend void from_json(const Darabonba::Json& j, ListDataImportSQLTypeResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(ErrorCode, errorCode_);
      DARABONBA_PTR_FROM_JSON(ErrorMessage, errorMessage_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(SqlTypeResult, sqlTypeResult_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
    };
    ListDataImportSQLTypeResponseBody() = default ;
    ListDataImportSQLTypeResponseBody(const ListDataImportSQLTypeResponseBody &) = default ;
    ListDataImportSQLTypeResponseBody(ListDataImportSQLTypeResponseBody &&) = default ;
    ListDataImportSQLTypeResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDataImportSQLTypeResponseBody() = default ;
    ListDataImportSQLTypeResponseBody& operator=(const ListDataImportSQLTypeResponseBody &) = default ;
    ListDataImportSQLTypeResponseBody& operator=(ListDataImportSQLTypeResponseBody &&) = default ;
