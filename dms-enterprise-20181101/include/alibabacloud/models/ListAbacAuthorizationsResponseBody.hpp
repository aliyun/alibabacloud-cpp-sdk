...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->authorizationList_ != nullptr
    ...
    inline const vector<ListAbacAuthorizationsResponseBodyAuthorizationList> & authorizationList() const { DARABONBA_PTR_GET_CONST(authorizationList_, vector<ListAbacAuthorizationsResponseBodyAuthorizationList>) };
    inline vector<ListAbacAuthorizationsResponseBodyAuthorizationList> authorizationList() { DARABONBA_PTR_GET(authorizationList_, vector<ListAbacAuthorizationsResponseBodyAuthorizationList>) };
    inline ListAbacAuthorizationsResponseBody& setAuthorizationList(const vector<ListAbacAuthorizationsResponseBodyAuthorizationList> & authorizationList) { DARABONBA_PTR_SET_VALUE(authorizationList_, authorizationList) };
    inline ListAbacAuthorizationsResponseBody& setAuthorizationList(vector<ListAbacAuthorizationsResponseBodyAuthorizationList> && authorizationList) { DARABONBA_PTR_SET_RVALUE(authorizationList_, authorizationList) };
  ...
  protected:
    std::shared_ptr<vector<ListAbacAuthorizationsResponseBodyAuthorizationList>> authorizationList_ = nullptr;
