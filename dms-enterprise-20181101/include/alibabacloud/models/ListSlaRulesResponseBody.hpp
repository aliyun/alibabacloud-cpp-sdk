...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorCode_ == nullptr
        && return this->errorMessage_ == nullptr && return this->requestId_ == nullptr && return this->SLARuleList_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const ListSLARulesResponseBodySLARuleList & SLARuleList() const { DARABONBA_PTR_GET_CONST(SLARuleList_, ListSLARulesResponseBodySLARuleList) };
    inline ListSLARulesResponseBodySLARuleList SLARuleList() { DARABONBA_PTR_GET(SLARuleList_, ListSLARulesResponseBodySLARuleList) };
    inline ListSLARulesResponseBody& setSLARuleList(const ListSLARulesResponseBodySLARuleList & SLARuleList) { DARABONBA_PTR_SET_VALUE(SLARuleList_, SLARuleList) };
    inline ListSLARulesResponseBody& setSLARuleList(ListSLARulesResponseBodySLARuleList && SLARuleList) { DARABONBA_PTR_SET_RVALUE(SLARuleList_, SLARuleList) };
  ...
  protected:
    ...
    std::shared_ptr<ListSLARulesResponseBodySLARuleList> SLARuleList_ = nullptr;
