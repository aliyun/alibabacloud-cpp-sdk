...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDataImportOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDataImportOrderResponseBody) };
    inline CreateDataImportOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDataImportOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDataImportOrderResponseBody> body_ {};
  };
