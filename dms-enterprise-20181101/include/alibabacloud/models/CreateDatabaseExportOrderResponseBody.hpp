...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateDatabaseExportOrderResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateDatabaseExportOrderResponseBody& obj) { 
    ...
    CreateDatabaseExportOrderResponseBody() = default ;
    CreateDatabaseExportOrderResponseBody(const CreateDatabaseExportOrderResponseBody &) = default ;
    CreateDatabaseExportOrderResponseBody(CreateDatabaseExportOrderResponseBody &&) = default ;
    CreateDatabaseExportOrderResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateDatabaseExportOrderResponseBody() = default ;
    CreateDatabaseExportOrderResponseBody& operator=(const CreateDatabaseExportOrderResponseBody &) = default ;
    CreateDatabaseExportOrderResponseBody& operator=(CreateDatabaseExportOrderResponseBody &&) = default ;
