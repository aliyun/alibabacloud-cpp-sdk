...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTaskFlowNameAndDescResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTaskFlowNameAndDescResponseBody) };
    inline UpdateTaskFlowNameAndDescResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTaskFlowNameAndDescResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTaskFlowNameAndDescResponseBody> body_ {};
  };
