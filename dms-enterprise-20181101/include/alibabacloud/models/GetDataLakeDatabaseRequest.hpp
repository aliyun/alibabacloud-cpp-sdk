...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->catalogName_ == nullptr
        && return this->dataRegion_ == nullptr && return this->name_ == nullptr && return this->tid_ == nullptr && return this->workspaceId_ == nullptr; };
    ...
    inline GetDataLakeDatabaseRequest& setDataRegion(string dataRegion) { DARABONBA_PTR_SET_VALUE(dataRegion_, dataRegion) };
