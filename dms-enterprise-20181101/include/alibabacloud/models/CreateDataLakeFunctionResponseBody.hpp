...
#ifndef ALIBABACLOUD_MODELS_CREATEDATALAKEFUNCTIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEDATALAKEFUNCTIONRESPONSEBODY_HPP_
...
namespace Models
{
  class CreateDataLakeFunctionResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateDataLakeFunctionResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateDataLakeFunctionResponseBody& obj) { 
    ...
    CreateDataLakeFunctionResponseBody() = default ;
    CreateDataLakeFunctionResponseBody(const CreateDataLakeFunctionResponseBody &) = default ;
    CreateDataLakeFunctionResponseBody(CreateDataLakeFunctionResponseBody &&) = default ;
    CreateDataLakeFunctionResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateDataLakeFunctionResponseBody() = default ;
    CreateDataLakeFunctionResponseBody& operator=(const CreateDataLakeFunctionResponseBody &) = default ;
    CreateDataLakeFunctionResponseBody& operator=(CreateDataLakeFunctionResponseBody &&) = default ;
