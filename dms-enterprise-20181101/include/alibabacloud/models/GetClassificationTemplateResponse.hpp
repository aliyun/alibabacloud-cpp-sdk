...
namespace Models
{
  ...
  public:
    ...
    inline const GetClassificationTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetClassificationTemplateResponseBody) };
    inline GetClassificationTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetClassificationTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetClassificationTemplateResponseBody> body_ {};
  };
