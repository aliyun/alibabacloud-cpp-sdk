...
namespace Models
{
  ...
  public:
    ...
    inline const ListLogicDatabasesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLogicDatabasesResponseBody) };
    inline ListLogicDatabasesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLogicDatabasesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLogicDatabasesResponseBody> body_ {};
  };
