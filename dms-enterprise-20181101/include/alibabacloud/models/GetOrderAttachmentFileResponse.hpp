...
namespace Models
{
  ...
  public:
    ...
    inline const GetOrderAttachmentFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOrderAttachmentFileResponseBody) };
    inline GetOrderAttachmentFileResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOrderAttachmentFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOrderAttachmentFileResponseBody> body_ {};
  };
