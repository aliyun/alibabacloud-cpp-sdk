...
namespace Models
{
  ...
  public:
    ...
    inline const ListDifyInstancesResponseBodyRoot & root() const { DARABONBA_PTR_GET_CONST(root_, ListDifyInstancesResponseBodyRoot) };
    inline ListDifyInstancesResponseBodyRoot root() { DARABONBA_PTR_GET(root_, ListDifyInstancesResponseBodyRoot) };
    inline ListDifyInstancesResponseBody& setRoot(const ListDifyInstancesResponseBodyRoot & root) { DARABONBA_PTR_SET_VALUE(root_, root) };
    inline ListDifyInstancesResponseBody& setRoot(ListDifyInstancesResponseBodyRoot && root) { DARABONBA_PTR_SET_RVALUE(root_, root) };
  ...
  protected:
    ...
    std::shared_ptr<ListDifyInstancesResponseBodyRoot> root_ = nullptr;
