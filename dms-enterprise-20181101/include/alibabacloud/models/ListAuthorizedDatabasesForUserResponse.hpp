...
namespace Models
{
  ...
  public:
    ...
    inline const ListAuthorizedDatabasesForUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAuthorizedDatabasesForUserResponseBody) };
    inline ListAuthorizedDatabasesForUserResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAuthorizedDatabasesForUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAuthorizedDatabasesForUserResponseBody> body_ {};
  };
