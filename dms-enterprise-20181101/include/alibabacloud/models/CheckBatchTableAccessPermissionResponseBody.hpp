...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->data_ == nullptr
        && return this->errorCode_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<CheckBatchTableAccessPermissionResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<CheckBatchTableAccessPermissionResponseBodyData>) };
    inline vector<CheckBatchTableAccessPermissionResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<CheckBatchTableAccessPermissionResponseBodyData>) };
    inline CheckBatchTableAccessPermissionResponseBody& setData(const vector<CheckBatchTableAccessPermissionResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CheckBatchTableAccessPermissionResponseBody& setData(vector<CheckBatchTableAccessPermissionResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<CheckBatchTableAccessPermissionResponseBodyData>> data_ = nullptr;
