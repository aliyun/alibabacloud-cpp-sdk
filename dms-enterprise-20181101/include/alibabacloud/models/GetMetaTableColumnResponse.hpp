...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaTableColumnResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMetaTableColumnResponseBody) };
    inline GetMetaTableColumnResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMetaTableColumnResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMetaTableColumnResponseBody> body_ {};
  };
