...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline int64_t getParentUid() const { DARABONBA_PTR_GET_DEFAULT(parentUid_, 0L) };
      inline User& setParentUid(int64_t parentUid) { DARABONBA_PTR_SET_VALUE(parentUid_, parentUid) };
    ...
    virtual bool empty() const override { return this->errorCode_ == nullptr
        && this->errorMessage_ == nullptr && this->requestId_ == nullptr && this->success_ == nullptr && this->user_ == nullptr; };
