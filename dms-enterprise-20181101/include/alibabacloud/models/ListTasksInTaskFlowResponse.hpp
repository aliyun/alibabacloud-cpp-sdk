...
namespace Models
{
  ...
  public:
    ...
    inline const ListTasksInTaskFlowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTasksInTaskFlowResponseBody) };
    inline ListTasksInTaskFlowResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTasksInTaskFlowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTasksInTaskFlowResponseBody> body_ {};
  };
