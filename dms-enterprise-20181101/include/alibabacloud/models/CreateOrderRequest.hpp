...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->attachmentKey_ == nullptr
        && return this->comment_ == nullptr && return this->pluginParam_ == nullptr && return this->pluginType_ == nullptr && return this->relatedUserList_ == nullptr && return this->tid_ == nullptr; };
    ...
    inline     const Darabonba::Json & pluginParam() const { DARABONBA_GET(pluginParam_) };
    Darabonba::Json & pluginParam() { DARABONBA_GET(pluginParam_) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    Darabonba::Json pluginParam_ = nullptr;
