...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorCode_ == nullptr
        && return this->errorMessage_ == nullptr && return this->lineageResult_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const AnalyzeSQLLineageResponseBodyLineageResult & lineageResult() const { DARABONBA_PTR_GET_CONST(lineageResult_, AnalyzeSQLLineageResponseBodyLineageResult) };
    inline AnalyzeSQLLineageResponseBodyLineageResult lineageResult() { DARABONBA_PTR_GET(lineageResult_, AnalyzeSQLLineageResponseBodyLineageResult) };
    inline AnalyzeSQLLineageResponseBody& setLineageResult(const AnalyzeSQLLineageResponseBodyLineageResult & lineageResult) { DARABONBA_PTR_SET_VALUE(lineageResult_, lineageResult) };
    inline AnalyzeSQLLineageResponseBody& setLineageResult(AnalyzeSQLLineageResponseBodyLineageResult && lineageResult) { DARABONBA_PTR_SET_RVALUE(lineageResult_, lineageResult) };
  ...
  protected:
    ...
    std::shared_ptr<AnalyzeSQLLineageResponseBodyLineageResult> lineageResult_ = nullptr;
    // The request ID.
