...
namespace Models
{
  ...
  public:
    ...
    inline const ReRunTaskFlowInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReRunTaskFlowInstanceResponseBody) };
    inline ReRunTaskFlowInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, ReRunTaskFlowInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReRunTaskFlowInstanceResponseBody> body_ {};
  };
