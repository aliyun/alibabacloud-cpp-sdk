...
namespace Models
{
  ...
  public:
    ...
    inline const GetStandardGroupResponseBody::StandardGroup & getStandardGroup() const { DARABONBA_PTR_GET_CONST(standardGroup_, GetStandardGroupResponseBody::StandardGroup) };
    inline GetStandardGroupResponseBody::StandardGroup getStandardGroup() { DARABONBA_PTR_GET(standardGroup_, GetStandardGroupResponseBody::StandardGroup) };
    inline GetStandardGroupResponseBody& setStandardGroup(const GetStandardGroupResponseBody::StandardGroup & standardGroup) { DARABONBA_PTR_SET_VALUE(standardGroup_, standardGroup) };
    inline GetStandardGroupResponseBody& setStandardGroup(GetStandardGroupResponseBody::StandardGroup && standardGroup) { DARABONBA_PTR_SET_RVALUE(standardGroup_, standardGroup) };
  ...
  protected:
    ...
    shared_ptr<GetStandardGroupResponseBody::StandardGroup> standardGroup_ {};
