...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataImportSQLPreCheckDetailResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListDataImportSQLPreCheckDetailResponseBody) };
    inline ListDataImportSQLPreCheckDetailResponseBody body() { DARABONBA_PTR_GET(body_, ListDataImportSQLPreCheckDetailResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataImportSQLPreCheckDetailResponseBody> body_ = nullptr;
  };
