...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteInstanceResponseBody) };
    inline DeleteInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteInstanceResponseBody> body_ {};
  };
