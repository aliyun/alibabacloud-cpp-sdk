...
namespace Models
{
  ...
  public:
    ...
    inline const ListTableColumnsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTableColumnsResponseBody) };
    inline ListTableColumnsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTableColumnsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTableColumnsResponseBody> body_ {};
  };
