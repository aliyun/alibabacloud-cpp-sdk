...
namespace Models
{
  ...
  public:
    ...
    inline DeleteScenarioResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline DeleteScenarioResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline DeleteScenarioResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
