...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->columnName_ == nullptr
        && return this->instanceId_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->schemaName_ == nullptr && return this->tableName_ == nullptr
