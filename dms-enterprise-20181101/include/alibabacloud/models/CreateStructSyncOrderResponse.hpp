...
namespace Models
{
  ...
  public:
    ...
    inline const CreateStructSyncOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateStructSyncOrderResponseBody) };
    inline CreateStructSyncOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateStructSyncOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateStructSyncOrderResponseBody> body_ {};
  };
