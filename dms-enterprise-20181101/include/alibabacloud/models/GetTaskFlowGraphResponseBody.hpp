...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorCode_ == nullptr
        && return this->errorMessage_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr && return this->taskFlowGraph_ == nullptr; };
    ...
    inline const GetTaskFlowGraphResponseBodyTaskFlowGraph & taskFlowGraph() const { DARABONBA_PTR_GET_CONST(taskFlowGraph_, GetTaskFlowGraphResponseBodyTaskFlowGraph) };
    inline GetTaskFlowGraphResponseBodyTaskFlowGraph taskFlowGraph() { DARABONBA_PTR_GET(taskFlowGraph_, GetTaskFlowGraphResponseBodyTaskFlowGraph) };
    inline GetTaskFlowGraphResponseBody& setTaskFlowGraph(const GetTaskFlowGraphResponseBodyTaskFlowGraph & taskFlowGraph) { DARABONBA_PTR_SET_VALUE(taskFlowGraph_, taskFlowGraph) };
    inline GetTaskFlowGraphResponseBody& setTaskFlowGraph(GetTaskFlowGraphResponseBodyTaskFlowGraph && taskFlowGraph) { DARABONBA_PTR_SET_RVALUE(taskFlowGraph_, taskFlowGraph) };
  ...
  protected:
    ...
    std::shared_ptr<GetTaskFlowGraphResponseBodyTaskFlowGraph> taskFlowGraph_ = nullptr;
  };
