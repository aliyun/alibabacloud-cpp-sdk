...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorCode_ == nullptr
        && return this->errorMessage_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr && return this->workflowNodes_ == nullptr; };
    ...
    inline const ListWorkFlowNodesResponseBodyWorkflowNodes & workflowNodes() const { DARABONBA_PTR_GET_CONST(workflowNodes_, ListWorkFlowNodesResponseBodyWorkflowNodes) };
    inline ListWorkFlowNodesResponseBodyWorkflowNodes workflowNodes() { DARABONBA_PTR_GET(workflowNodes_, ListWorkFlowNodesResponseBodyWorkflowNodes) };
    inline ListWorkFlowNodesResponseBody& setWorkflowNodes(const ListWorkFlowNodesResponseBodyWorkflowNodes & workflowNodes) { DARABONBA_PTR_SET_VALUE(workflowNodes_, workflowNodes) };
    inline ListWorkFlowNodesResponseBody& setWorkflowNodes(ListWorkFlowNodesResponseBodyWorkflowNodes && workflowNodes) { DARABONBA_PTR_SET_RVALUE(workflowNodes_, workflowNodes) };
  ...
  protected:
    ...
    std::shared_ptr<ListWorkFlowNodesResponseBodyWorkflowNodes> workflowNodes_ = nullptr;
  };
