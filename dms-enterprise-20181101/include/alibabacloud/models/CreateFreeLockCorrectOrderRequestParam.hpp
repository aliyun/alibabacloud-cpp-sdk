...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->attachmentName_ == nullptr
        && return this->classify_ == nullptr && return this->dbItemList_ == nullptr && return this->execMode_ == nullptr && return this->execSQL_ == nullptr && return this->rollbackAttachmentName_ == nullptr
        && return this->rollbackSQL_ == nullptr && return this->rollbackSqlType_ == nullptr && return this->sqlType_ == nullptr; };
