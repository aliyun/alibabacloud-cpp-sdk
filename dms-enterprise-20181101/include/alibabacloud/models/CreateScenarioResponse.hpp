...
namespace Models
{
  ...
  public:
    ...
    inline const CreateScenarioResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateScenarioResponseBody) };
    inline CreateScenarioResponseBody body() { DARABONBA_PTR_GET(body_, CreateScenarioResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateScenarioResponseBody> body_ = nullptr;
  };
