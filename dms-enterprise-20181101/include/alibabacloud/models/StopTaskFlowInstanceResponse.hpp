...
namespace Models
{
  ...
  public:
    ...
    inline const StopTaskFlowInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopTaskFlowInstanceResponseBody) };
    inline StopTaskFlowInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, StopTaskFlowInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopTaskFlowInstanceResponseBody> body_ {};
  };
