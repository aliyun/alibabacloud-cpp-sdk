...
namespace Models
{
  ...
  public:
    ...
    inline const ListDAGVersionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDAGVersionsResponseBody) };
    inline ListDAGVersionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDAGVersionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDAGVersionsResponseBody> body_ {};
  };
