...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataArchiveCountResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDataArchiveCountResponseBodyData) };
    inline GetDataArchiveCountResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDataArchiveCountResponseBodyData) };
    inline GetDataArchiveCountResponseBody& setData(const GetDataArchiveCountResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDataArchiveCountResponseBody& setData(GetDataArchiveCountResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<GetDataArchiveCountResponseBodyData> data_ = nullptr;
    // The request ID.
