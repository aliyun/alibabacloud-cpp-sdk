...
namespace Models
{
  ...
  public:
    ...
    inline const SearchDataTrackResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchDataTrackResultResponseBody) };
    inline SearchDataTrackResultResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchDataTrackResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchDataTrackResultResponseBody> body_ {};
  };
