...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->dataLinkName_ != nullptr
        ...
        && this->ecsRegion_ != nullptr && this->enableSellSitd_ != nullptr && this->envType_ != nullptr && this->exportTimeout_ != nullptr && this->host_ != nullptr
        && this->instanceAlias_ != nullptr && this->instanceId_ != nullptr && this->instanceSource_ != nullptr && this->instanceType_ != nullptr && this->port_ != nullptr
        && this->queryTimeout_ != nullptr && this->safeRuleId_ != nullptr && this->sid_ != nullptr && this->skipTest_ != nullptr && this->templateId_ != nullptr
        && this->templateType_ != nullptr && this->tid_ != nullptr && this->useDsql_ != nullptr && this->vpcId_ != nullptr; };
