...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getDbaUid() const { DARABONBA_PTR_GET_DEFAULT(dbaUid_, 0L) };
    ...
    inline string getDbaUidByString() const { DARABONBA_PTR_GET_DEFAULT(dbaUidByString_, "") };
  ...
  protected:
    ...
    shared_ptr<string> dbaUidByString_ {};
