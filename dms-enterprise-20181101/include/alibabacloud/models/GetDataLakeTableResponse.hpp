...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataLakeTableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDataLakeTableResponseBody) };
    inline GetDataLakeTableResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDataLakeTableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDataLakeTableResponseBody> body_ {};
  };
