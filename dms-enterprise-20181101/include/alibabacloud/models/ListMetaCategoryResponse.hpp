...
namespace Models
{
  ...
  public:
    ...
    inline const ListMetaCategoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMetaCategoryResponseBody) };
    inline ListMetaCategoryResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMetaCategoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMetaCategoryResponseBody> body_ {};
  };
