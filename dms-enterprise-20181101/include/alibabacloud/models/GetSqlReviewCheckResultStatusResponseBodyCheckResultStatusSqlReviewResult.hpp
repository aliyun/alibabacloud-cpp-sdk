...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->mustImprove_ == nullptr
        && return this->potentialIssue_ == nullptr && return this->suggestImprove_ == nullptr && return this->tableIndexSuggest_ == nullptr && return this->useDmsDmlUnlock_ == nullptr && return this->useDmsToolkit_ == nullptr; };
