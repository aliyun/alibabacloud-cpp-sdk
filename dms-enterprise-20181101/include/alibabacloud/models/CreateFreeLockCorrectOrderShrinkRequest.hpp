...
#ifndef ALIBABACLOUD_MODELS_CREATEFREELOCKCORRECTORDERSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEFREELOCKCORRECTORDERSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateFreeLockCorrectOrderShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateFreeLockCorrectOrderShrinkRequest& obj) { 
    ...
    CreateFreeLockCorrectOrderShrinkRequest() = default ;
    CreateFreeLockCorrectOrderShrinkRequest(const CreateFreeLockCorrectOrderShrinkRequest &) = default ;
    CreateFreeLockCorrectOrderShrinkRequest(CreateFreeLockCorrectOrderShrinkRequest &&) = default ;
    CreateFreeLockCorrectOrderShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateFreeLockCorrectOrderShrinkRequest() = default ;
    CreateFreeLockCorrectOrderShrinkRequest& operator=(const CreateFreeLockCorrectOrderShrinkRequest &) = default ;
    CreateFreeLockCorrectOrderShrinkRequest& operator=(CreateFreeLockCorrectOrderShrinkRequest &&) = default ;
    ...
    inline CreateFreeLockCorrectOrderShrinkRequest& setAttachmentKey(string attachmentKey) { DARABONBA_PTR_SET_VALUE(attachmentKey_, attachmentKey) };
    ...
    inline CreateFreeLockCorrectOrderShrinkRequest& setComment(string comment) { DARABONBA_PTR_SET_VALUE(comment_, comment) };
    ...
    inline CreateFreeLockCorrectOrderShrinkRequest& setParamShrink(string paramShrink) { DARABONBA_PTR_SET_VALUE(paramShrink_, paramShrink) };
    ...
    inline CreateFreeLockCorrectOrderShrinkRequest& setRealLoginUserUid(string realLoginUserUid) { DARABONBA_PTR_SET_VALUE(realLoginUserUid_, realLoginUserUid) };
    ...
    inline CreateFreeLockCorrectOrderShrinkRequest& setRelatedUserListShrink(string relatedUserListShrink) { DARABONBA_PTR_SET_VALUE(relatedUserListShrink_, relatedUserListShrink) };
    ...
    inline CreateFreeLockCorrectOrderShrinkRequest& setTid(int64_t tid) { DARABONBA_PTR_SET_VALUE(tid_, tid) };
