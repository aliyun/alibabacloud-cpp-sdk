...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataLakePartitionByFilterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataLakePartitionByFilterResponseBody) };
    inline ListDataLakePartitionByFilterResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataLakePartitionByFilterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataLakePartitionByFilterResponseBody> body_ {};
  };
