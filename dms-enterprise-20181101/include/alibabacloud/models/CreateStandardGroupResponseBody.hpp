...
namespace Models
{
  ...
  public:
    ...
    inline const CreateStandardGroupResponseBodyStandardGroup & standardGroup() const { DARABONBA_PTR_GET_CONST(standardGroup_, CreateStandardGroupResponseBodyStandardGroup) };
    inline CreateStandardGroupResponseBodyStandardGroup standardGroup() { DARABONBA_PTR_GET(standardGroup_, CreateStandardGroupResponseBodyStandardGroup) };
    inline CreateStandardGroupResponseBody& setStandardGroup(const CreateStandardGroupResponseBodyStandardGroup & standardGroup) { DARABONBA_PTR_SET_VALUE(standardGroup_, standardGroup) };
    inline CreateStandardGroupResponseBody& setStandardGroup(CreateStandardGroupResponseBodyStandardGroup && standardGroup) { DARABONBA_PTR_SET_RVALUE(standardGroup_, standardGroup) };
  ...
  protected:
    ...
    std::shared_ptr<CreateStandardGroupResponseBodyStandardGroup> standardGroup_ = nullptr;
