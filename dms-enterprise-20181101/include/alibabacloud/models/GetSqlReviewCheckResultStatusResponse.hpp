...
namespace Models
{
  ...
  public:
    ...
    inline const GetSQLReviewCheckResultStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSQLReviewCheckResultStatusResponseBody) };
    inline GetSQLReviewCheckResultStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSQLReviewCheckResultStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSQLReviewCheckResultStatusResponseBody> body_ {};
  };
