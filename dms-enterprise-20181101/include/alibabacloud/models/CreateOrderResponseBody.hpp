...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOrderResponseBodyCreateOrderResult & createOrderResult() const { DARABONBA_PTR_GET_CONST(createOrderResult_, CreateOrderResponseBodyCreateOrderResult) };
    inline CreateOrderResponseBodyCreateOrderResult createOrderResult() { DARABONBA_PTR_GET(createOrderResult_, CreateOrderResponseBodyCreateOrderResult) };
    inline CreateOrderResponseBody& setCreateOrderResult(const CreateOrderResponseBodyCreateOrderResult & createOrderResult) { DARABONBA_PTR_SET_VALUE(createOrderResult_, createOrderResult) };
    inline CreateOrderResponseBody& setCreateOrderResult(CreateOrderResponseBodyCreateOrderResult && createOrderResult) { DARABONBA_PTR_SET_RVALUE(createOrderResult_, createOrderResult) };
  ...
  protected:
    ...
    std::shared_ptr<CreateOrderResponseBodyCreateOrderResult> createOrderResult_ = nullptr;
    // The error code.
