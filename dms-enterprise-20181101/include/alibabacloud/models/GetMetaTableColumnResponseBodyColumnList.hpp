...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoIncrement_ == nullptr
        ...
        && return this->dataScale_ == nullptr && return this->description_ == nullptr && return this->nullable_ == nullptr && return this->position_ == nullptr && return this->primaryKey_ == nullptr
