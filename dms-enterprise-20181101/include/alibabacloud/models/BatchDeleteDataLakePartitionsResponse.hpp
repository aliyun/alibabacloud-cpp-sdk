...
namespace Models
{
  ...
  public:
    ...
    inline const BatchDeleteDataLakePartitionsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, BatchDeleteDataLakePartitionsResponseBody) };
    inline BatchDeleteDataLakePartitionsResponseBody body() { DARABONBA_PTR_GET(body_, BatchDeleteDataLakePartitionsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<BatchDeleteDataLakePartitionsResponseBody> body_ = nullptr;
  };
