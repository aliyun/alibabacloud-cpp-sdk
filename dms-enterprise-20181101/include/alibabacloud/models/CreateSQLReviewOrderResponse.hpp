...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSQLReviewOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSQLReviewOrderResponseBody) };
    inline CreateSQLReviewOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSQLReviewOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSQLReviewOrderResponseBody> body_ {};
  };
