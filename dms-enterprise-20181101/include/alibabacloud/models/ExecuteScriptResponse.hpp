...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteScriptResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExecuteScriptResponseBody) };
    inline ExecuteScriptResponseBody getBody() { DARABONBA_PTR_GET(body_, ExecuteScriptResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExecuteScriptResponseBody> body_ {};
  };
