...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteProxyAccessResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteProxyAccessResponseBody) };
    inline DeleteProxyAccessResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteProxyAccessResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteProxyAccessResponseBody> body_ {};
  };
