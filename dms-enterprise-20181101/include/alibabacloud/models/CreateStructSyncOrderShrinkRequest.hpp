...
#ifndef ALIBABACLOUD_MODELS_CREATESTRUCTSYNCORDERSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATESTRUCTSYNCORDERSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateStructSyncOrderShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateStructSyncOrderShrinkRequest& obj) { 
    ...
    CreateStructSyncOrderShrinkRequest() = default ;
    CreateStructSyncOrderShrinkRequest(const CreateStructSyncOrderShrinkRequest &) = default ;
    CreateStructSyncOrderShrinkRequest(CreateStructSyncOrderShrinkRequest &&) = default ;
    CreateStructSyncOrderShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateStructSyncOrderShrinkRequest() = default ;
    CreateStructSyncOrderShrinkRequest& operator=(const CreateStructSyncOrderShrinkRequest &) = default ;
    CreateStructSyncOrderShrinkRequest& operator=(CreateStructSyncOrderShrinkRequest &&) = default ;
    ...
    inline CreateStructSyncOrderShrinkRequest& setAttachmentKey(string attachmentKey) { DARABONBA_PTR_SET_VALUE(attachmentKey_, attachmentKey) };
    ...
    inline CreateStructSyncOrderShrinkRequest& setComment(string comment) { DARABONBA_PTR_SET_VALUE(comment_, comment) };
    ...
    inline CreateStructSyncOrderShrinkRequest& setParamShrink(string paramShrink) { DARABONBA_PTR_SET_VALUE(paramShrink_, paramShrink) };
    ...
    inline CreateStructSyncOrderShrinkRequest& setRelatedUserListShrink(string relatedUserListShrink) { DARABONBA_PTR_SET_VALUE(relatedUserListShrink_, relatedUserListShrink) };
    ...
    inline CreateStructSyncOrderShrinkRequest& setTid(int64_t tid) { DARABONBA_PTR_SET_VALUE(tid_, tid) };
