...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteStandardGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteStandardGroupResponseBody) };
    inline DeleteStandardGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteStandardGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteStandardGroupResponseBody> body_ {};
  };
