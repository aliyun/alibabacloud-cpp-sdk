...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDataLakeTableResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateDataLakeTableResponseBody) };
    inline UpdateDataLakeTableResponseBody body() { DARABONBA_PTR_GET(body_, UpdateDataLakeTableResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateDataLakeTableResponseBody> body_ = nullptr;
  };
