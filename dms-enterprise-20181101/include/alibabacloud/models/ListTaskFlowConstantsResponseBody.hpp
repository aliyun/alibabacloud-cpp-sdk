...
namespace Models
{
  ...
  public:
    ...
    inline const ListTaskFlowConstantsResponseBodyDagConstants & dagConstants() const { DARABONBA_PTR_GET_CONST(dagConstants_, ListTaskFlowConstantsResponseBodyDagConstants) };
    inline ListTaskFlowConstantsResponseBodyDagConstants dagConstants() { DARABONBA_PTR_GET(dagConstants_, ListTaskFlowConstantsResponseBodyDagConstants) };
    inline ListTaskFlowConstantsResponseBody& setDagConstants(const ListTaskFlowConstantsResponseBodyDagConstants & dagConstants) { DARABONBA_PTR_SET_VALUE(dagConstants_, dagConstants) };
    inline ListTaskFlowConstantsResponseBody& setDagConstants(ListTaskFlowConstantsResponseBodyDagConstants && dagConstants) { DARABONBA_PTR_SET_RVALUE(dagConstants_, dagConstants) };
  ...
  protected:
    ...
    std::shared_ptr<ListTaskFlowConstantsResponseBodyDagConstants> dagConstants_ = nullptr;
