...
namespace Models
{
  ...
  public:
    ...
    inline const ListTaskFlowsByPageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTaskFlowsByPageResponseBody) };
    inline ListTaskFlowsByPageResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTaskFlowsByPageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTaskFlowsByPageResponseBody> body_ {};
  };
