...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveTableFromCategoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveTableFromCategoryResponseBody) };
    inline RemoveTableFromCategoryResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveTableFromCategoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveTableFromCategoryResponseBody> body_ {};
  };
