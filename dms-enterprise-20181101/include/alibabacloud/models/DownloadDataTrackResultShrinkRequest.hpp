...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->columnFilterShrink_ == nullptr
        && return this->eventIdListShrink_ == nullptr && return this->filterEndTime_ == nullptr && return this->filterStartTime_ == nullptr && return this->filterTableListShrink_ == nullptr && return this->filterTypeListShrink_ == nullptr
