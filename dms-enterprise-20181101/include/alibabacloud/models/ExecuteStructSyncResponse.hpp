...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteStructSyncResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExecuteStructSyncResponseBody) };
    inline ExecuteStructSyncResponseBody getBody() { DARABONBA_PTR_GET(body_, ExecuteStructSyncResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExecuteStructSyncResponseBody> body_ {};
  };
