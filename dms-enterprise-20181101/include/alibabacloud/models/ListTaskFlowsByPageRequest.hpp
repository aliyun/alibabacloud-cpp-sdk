...
namespace Models
{
  ...
  public:
    ...
    inline const vector<int64_t> & getDagIdList() const { DARABONBA_PTR_GET_CONST(dagIdList_, vector<int64_t>) };
    inline vector<int64_t> getDagIdList() { DARABONBA_PTR_GET(dagIdList_, vector<int64_t>) };
  ...
  protected:
    ...
    shared_ptr<vector<int64_t>> dagIdList_ {};
