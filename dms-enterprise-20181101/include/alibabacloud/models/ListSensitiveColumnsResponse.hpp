...
namespace Models
{
  ...
  public:
    ...
    inline const ListSensitiveColumnsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListSensitiveColumnsResponseBody) };
    inline ListSensitiveColumnsResponseBody body() { DARABONBA_PTR_GET(body_, ListSensitiveColumnsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListSensitiveColumnsResponseBody> body_ = nullptr;
  };
