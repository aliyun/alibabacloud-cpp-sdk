...
namespace Models
{
  ...
  public:
    ...
    inline const InspectProxyAccessSecretResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InspectProxyAccessSecretResponseBody) };
    inline InspectProxyAccessSecretResponseBody getBody() { DARABONBA_PTR_GET(body_, InspectProxyAccessSecretResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InspectProxyAccessSecretResponseBody> body_ {};
  };
