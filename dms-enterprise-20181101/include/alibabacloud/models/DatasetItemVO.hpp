...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AsyncTaskVO> & getAsyncTaskList() const { DARABONBA_PTR_GET_CONST(asyncTaskList_, vector<AsyncTaskVO>) };
    inline vector<AsyncTaskVO> getAsyncTaskList() { DARABONBA_PTR_GET(asyncTaskList_, vector<AsyncTaskVO>) };
    ...
    inline string getMoreInfo() const { DARABONBA_PTR_GET_DEFAULT(moreInfo_, "") };
    ...
    inline const vector<ProjectDetailsLiteVO> & getProjectsLinked() const { DARABONBA_PTR_GET_CONST(projectsLinked_, vector<ProjectDetailsLiteVO>) };
    inline vector<ProjectDetailsLiteVO> getProjectsLinked() { DARABONBA_PTR_GET(projectsLinked_, vector<ProjectDetailsLiteVO>) };
    ...
    inline int32_t getRecentTaskStatus() const { DARABONBA_PTR_GET_DEFAULT(recentTaskStatus_, 0) };
  ...
  protected:
    shared_ptr<vector<AsyncTaskVO>> asyncTaskList_ {};
    ...
    shared_ptr<string> moreInfo_ {};
    shared_ptr<string> path_ {};
    shared_ptr<vector<ProjectDetailsLiteVO>> projectsLinked_ {};
    shared_ptr<int32_t> recentTaskStatus_ {};
