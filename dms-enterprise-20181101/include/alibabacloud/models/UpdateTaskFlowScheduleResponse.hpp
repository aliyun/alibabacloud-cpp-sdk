...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTaskFlowScheduleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateTaskFlowScheduleResponseBody) };
    inline UpdateTaskFlowScheduleResponseBody body() { DARABONBA_PTR_GET(body_, UpdateTaskFlowScheduleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateTaskFlowScheduleResponseBody> body_ = nullptr;
  };
