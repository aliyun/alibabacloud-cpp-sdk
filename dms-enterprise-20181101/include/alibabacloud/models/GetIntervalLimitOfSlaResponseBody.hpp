...
#ifndef ALIBABACLOUD_MODELS_GETINTERVALLIMITOFSLARESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETINTERVALLIMITOFSLARESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetIntervalLimitOfSLAResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(ErrorCode, errorCode_);
      DARABONBA_PTR_TO_JSON(ErrorMessage, errorMessage_);
      DARABONBA_PTR_TO_JSON(IntervalLimit, intervalLimit_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Success, success_);
    };
    friend void from_json(const Darabonba::Json& j, GetIntervalLimitOfSLAResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(ErrorCode, errorCode_);
      DARABONBA_PTR_FROM_JSON(ErrorMessage, errorMessage_);
      DARABONBA_PTR_FROM_JSON(IntervalLimit, intervalLimit_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
    };
    GetIntervalLimitOfSLAResponseBody() = default ;
    GetIntervalLimitOfSLAResponseBody(const GetIntervalLimitOfSLAResponseBody &) = default ;
    GetIntervalLimitOfSLAResponseBody(GetIntervalLimitOfSLAResponseBody &&) = default ;
    GetIntervalLimitOfSLAResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetIntervalLimitOfSLAResponseBody() = default ;
    GetIntervalLimitOfSLAResponseBody& operator=(const GetIntervalLimitOfSLAResponseBody &) = default ;
    GetIntervalLimitOfSLAResponseBody& operator=(GetIntervalLimitOfSLAResponseBody &&) = default ;
