...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dbType_ == nullptr
        && this->envType_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->returnGuid_ == nullptr && this->searchKey_ == nullptr
    ...
    inline bool getReturnGuid() const { DARABONBA_PTR_GET_DEFAULT(returnGuid_, false) };
    ...
    inline string getSearchRange() const { DARABONBA_PTR_GET_DEFAULT(searchRange_, "") };
    ...
    inline string getSearchTarget() const { DARABONBA_PTR_GET_DEFAULT(searchTarget_, "") };
  ...
  protected:
    ...
    // *   **UNKNOWN**: all tables.
    shared_ptr<string> searchRange_ {};
    ...
    shared_ptr<string> searchTarget_ {};
