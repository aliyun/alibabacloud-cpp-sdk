...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataLakeDatabaseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataLakeDatabaseResponseBody) };
    inline ListDataLakeDatabaseResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataLakeDatabaseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataLakeDatabaseResponseBody> body_ {};
  };
