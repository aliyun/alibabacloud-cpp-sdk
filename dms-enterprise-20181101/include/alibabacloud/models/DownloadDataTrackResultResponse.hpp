...
namespace Models
{
  ...
  public:
    ...
    inline const DownloadDataTrackResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DownloadDataTrackResultResponseBody) };
    inline DownloadDataTrackResultResponseBody getBody() { DARABONBA_PTR_GET(body_, DownloadDataTrackResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DownloadDataTrackResultResponseBody> body_ {};
  };
