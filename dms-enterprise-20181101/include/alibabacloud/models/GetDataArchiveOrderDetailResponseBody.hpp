...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataArchiveOrderDetail_ == nullptr
        && return this->errorCode_ == nullptr && return this->errorMessage_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr && return this->traceId_ == nullptr; };
