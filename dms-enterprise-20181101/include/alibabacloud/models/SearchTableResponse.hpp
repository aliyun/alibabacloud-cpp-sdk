...
namespace Models
{
  ...
  public:
    ...
    inline const SearchTableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchTableResponseBody) };
    inline SearchTableResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchTableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchTableResponseBody> body_ {};
  };
