...
namespace Models
{
  ...
  public:
    ...
    inline const EditMetaKnowledgeAssetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EditMetaKnowledgeAssetResponseBody) };
    inline EditMetaKnowledgeAssetResponseBody getBody() { DARABONBA_PTR_GET(body_, EditMetaKnowledgeAssetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EditMetaKnowledgeAssetResponseBody> body_ {};
  };
