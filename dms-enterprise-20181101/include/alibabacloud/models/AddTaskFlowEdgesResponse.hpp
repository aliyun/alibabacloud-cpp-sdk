...
namespace Models
{
  ...
  public:
    ...
    inline const AddTaskFlowEdgesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddTaskFlowEdgesResponseBody) };
    inline AddTaskFlowEdgesResponseBody body() { DARABONBA_PTR_GET(body_, AddTaskFlowEdgesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddTaskFlowEdgesResponseBody> body_ = nullptr;
  };
