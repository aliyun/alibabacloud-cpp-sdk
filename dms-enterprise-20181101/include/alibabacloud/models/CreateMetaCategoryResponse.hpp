...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMetaCategoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMetaCategoryResponseBody) };
    inline CreateMetaCategoryResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMetaCategoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMetaCategoryResponseBody> body_ {};
  };
