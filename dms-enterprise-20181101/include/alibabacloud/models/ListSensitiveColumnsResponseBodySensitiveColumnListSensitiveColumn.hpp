...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->columnCount_ == nullptr
        && return this->columnName_ == nullptr && return this->functionType_ == nullptr && return this->schemaName_ == nullptr && return this->securityLevel_ == nullptr && return this->tableName_ == nullptr; };
