...
namespace Models
{
  ...
  public:
    ...
    inline const ListLogicTablesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLogicTablesResponseBody) };
    inline ListLogicTablesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLogicTablesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLogicTablesResponseBody> body_ {};
  };
