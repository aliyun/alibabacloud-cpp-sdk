...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->cooperatorIdsShrink_ != nullptr
    ...
    inline string cooperatorIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(cooperatorIdsShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> cooperatorIdsShrink_ = nullptr;
