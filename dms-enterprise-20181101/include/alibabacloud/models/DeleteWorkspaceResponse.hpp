...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWorkspaceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteWorkspaceResponseBody) };
    inline DeleteWorkspaceResponseBody body() { DARABONBA_PTR_GET(body_, DeleteWorkspaceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteWorkspaceResponseBody> body_ = nullptr;
  };
