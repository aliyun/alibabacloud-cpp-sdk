...
namespace Models
{
  ...
  public:
    ...
    inline const ListAuthorityTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAuthorityTemplateResponseBody) };
    inline ListAuthorityTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAuthorityTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAuthorityTemplateResponseBody> body_ {};
  };
