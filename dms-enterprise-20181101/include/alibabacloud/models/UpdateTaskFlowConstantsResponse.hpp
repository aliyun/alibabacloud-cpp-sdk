...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTaskFlowConstantsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTaskFlowConstantsResponseBody) };
    inline UpdateTaskFlowConstantsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTaskFlowConstantsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTaskFlowConstantsResponseBody> body_ {};
  };
