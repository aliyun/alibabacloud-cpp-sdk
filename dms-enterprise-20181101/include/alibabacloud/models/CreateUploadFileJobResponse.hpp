...
namespace Models
{
  ...
  public:
    ...
    inline const CreateUploadFileJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateUploadFileJobResponseBody) };
    inline CreateUploadFileJobResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateUploadFileJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateUploadFileJobResponseBody> body_ {};
  };
