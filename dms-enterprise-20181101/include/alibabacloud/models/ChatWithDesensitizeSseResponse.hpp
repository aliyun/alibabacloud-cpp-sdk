...
namespace Models
{
  ...
  public:
    ...
    inline const ChatWithDesensitizeSSEResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ChatWithDesensitizeSSEResponseBody) };
    inline ChatWithDesensitizeSSEResponseBody body() { DARABONBA_PTR_GET(body_, ChatWithDesensitizeSSEResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ChatWithDesensitizeSSEResponseBody> body_ = nullptr;
  };
