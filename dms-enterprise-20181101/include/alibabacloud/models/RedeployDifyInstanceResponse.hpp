...
namespace Models
{
  ...
  public:
    ...
    inline const RedeployDifyInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RedeployDifyInstanceResponseBody) };
    inline RedeployDifyInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, RedeployDifyInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RedeployDifyInstanceResponseBody> body_ {};
  };
