...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAuthorityTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAuthorityTemplateResponseBody) };
    inline UpdateAuthorityTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAuthorityTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAuthorityTemplateResponseBody> body_ {};
  };
