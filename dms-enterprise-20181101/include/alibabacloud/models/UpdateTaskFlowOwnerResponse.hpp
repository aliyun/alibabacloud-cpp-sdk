...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTaskFlowOwnerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTaskFlowOwnerResponseBody) };
    inline UpdateTaskFlowOwnerResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTaskFlowOwnerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTaskFlowOwnerResponseBody> body_ {};
  };
