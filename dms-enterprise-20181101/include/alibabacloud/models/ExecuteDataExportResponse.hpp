...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteDataExportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExecuteDataExportResponseBody) };
    inline ExecuteDataExportResponseBody getBody() { DARABONBA_PTR_GET(body_, ExecuteDataExportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExecuteDataExportResponseBody> body_ {};
  };
