...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTaskConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTaskConfigResponseBody) };
    inline UpdateTaskConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTaskConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTaskConfigResponseBody> body_ {};
  };
