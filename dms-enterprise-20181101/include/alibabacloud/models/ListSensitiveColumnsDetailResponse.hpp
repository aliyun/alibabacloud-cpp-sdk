...
namespace Models
{
  ...
  public:
    ...
    inline const ListSensitiveColumnsDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSensitiveColumnsDetailResponseBody) };
    inline ListSensitiveColumnsDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSensitiveColumnsDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSensitiveColumnsDetailResponseBody> body_ {};
  };
