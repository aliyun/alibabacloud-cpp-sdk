...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorCode_ == nullptr
        && return this->errorMessage_ == nullptr && return this->projectFlow_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const GetTableDesignProjectFlowResponseBodyProjectFlow & projectFlow() const { DARABONBA_PTR_GET_CONST(projectFlow_, GetTableDesignProjectFlowResponseBodyProjectFlow) };
    inline GetTableDesignProjectFlowResponseBodyProjectFlow projectFlow() { DARABONBA_PTR_GET(projectFlow_, GetTableDesignProjectFlowResponseBodyProjectFlow) };
    inline GetTableDesignProjectFlowResponseBody& setProjectFlow(const GetTableDesignProjectFlowResponseBodyProjectFlow & projectFlow) { DARABONBA_PTR_SET_VALUE(projectFlow_, projectFlow) };
    inline GetTableDesignProjectFlowResponseBody& setProjectFlow(GetTableDesignProjectFlowResponseBodyProjectFlow && projectFlow) { DARABONBA_PTR_SET_RVALUE(projectFlow_, projectFlow) };
  ...
  protected:
    ...
    std::shared_ptr<GetTableDesignProjectFlowResponseBodyProjectFlow> projectFlow_ = nullptr;
