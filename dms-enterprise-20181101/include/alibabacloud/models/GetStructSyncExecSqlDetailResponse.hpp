...
namespace Models
{
  ...
  public:
    ...
    inline const GetStructSyncExecSqlDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetStructSyncExecSqlDetailResponseBody) };
    inline GetStructSyncExecSqlDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetStructSyncExecSqlDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetStructSyncExecSqlDetailResponseBody> body_ {};
  };
