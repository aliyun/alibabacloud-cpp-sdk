...
namespace Models
{
  ...
  public:
    ...
    inline const GetLhSpaceByNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLhSpaceByNameResponseBody) };
    inline GetLhSpaceByNameResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLhSpaceByNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLhSpaceByNameResponseBody> body_ {};
  };
