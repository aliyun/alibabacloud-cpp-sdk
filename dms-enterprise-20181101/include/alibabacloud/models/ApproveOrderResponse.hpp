...
namespace Models
{
  ...
  public:
    ...
    inline const ApproveOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ApproveOrderResponseBody) };
    inline ApproveOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, ApproveOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ApproveOrderResponseBody> body_ {};
  };
