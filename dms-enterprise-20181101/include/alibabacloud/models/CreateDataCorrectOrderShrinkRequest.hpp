...
#ifndef ALIBABACLOUD_MODELS_CREATEDATACORRECTORDERSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEDATACORRECTORDERSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateDataCorrectOrderShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateDataCorrectOrderShrinkRequest& obj) { 
    ...
    CreateDataCorrectOrderShrinkRequest() = default ;
    CreateDataCorrectOrderShrinkRequest(const CreateDataCorrectOrderShrinkRequest &) = default ;
    CreateDataCorrectOrderShrinkRequest(CreateDataCorrectOrderShrinkRequest &&) = default ;
    CreateDataCorrectOrderShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateDataCorrectOrderShrinkRequest() = default ;
    CreateDataCorrectOrderShrinkRequest& operator=(const CreateDataCorrectOrderShrinkRequest &) = default ;
    CreateDataCorrectOrderShrinkRequest& operator=(CreateDataCorrectOrderShrinkRequest &&) = default ;
