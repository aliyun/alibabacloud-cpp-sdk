...
namespace Models
{
  ...
  public:
    ...
    inline const ListSensitiveColumnInfoResponseBodySensitiveColumnList & sensitiveColumnList() const { DARABONBA_PTR_GET_CONST(sensitiveColumnList_, ListSensitiveColumnInfoResponseBodySensitiveColumnList) };
    inline ListSensitiveColumnInfoResponseBodySensitiveColumnList sensitiveColumnList() { DARABONBA_PTR_GET(sensitiveColumnList_, ListSensitiveColumnInfoResponseBodySensitiveColumnList) };
    inline ListSensitiveColumnInfoResponseBody& setSensitiveColumnList(const ListSensitiveColumnInfoResponseBodySensitiveColumnList & sensitiveColumnList) { DARABONBA_PTR_SET_VALUE(sensitiveColumnList_, sensitiveColumnList) };
    inline ListSensitiveColumnInfoResponseBody& setSensitiveColumnList(ListSensitiveColumnInfoResponseBodySensitiveColumnList && sensitiveColumnList) { DARABONBA_PTR_SET_RVALUE(sensitiveColumnList_, sensitiveColumnList) };
  ...
  protected:
    ...
    std::shared_ptr<ListSensitiveColumnInfoResponseBodySensitiveColumnList> sensitiveColumnList_ = nullptr;
