...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeLhDagOwnerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ChangeLhDagOwnerResponseBody) };
    inline ChangeLhDagOwnerResponseBody getBody() { DARABONBA_PTR_GET(body_, ChangeLhDagOwnerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ChangeLhDagOwnerResponseBody> body_ {};
  };
