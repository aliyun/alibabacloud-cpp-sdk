...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateSqlFromNLResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GenerateSqlFromNLResponseBodyData) };
    inline GenerateSqlFromNLResponseBodyData data() { DARABONBA_PTR_GET(data_, GenerateSqlFromNLResponseBodyData) };
    inline GenerateSqlFromNLResponseBody& setData(const GenerateSqlFromNLResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GenerateSqlFromNLResponseBody& setData(GenerateSqlFromNLResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<GenerateSqlFromNLResponseBodyData> data_ = nullptr;
