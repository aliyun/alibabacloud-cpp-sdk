...
#ifndef ALIBABACLOUD_MODELS_LISTLHTASKFLOWANDSCENARIORESPONSEBODYRAWDAGLISTDAG_HPP_
#define ALIBABACLOUD_MODELS_LISTLHTASKFLOWANDSCENARIORESPONSEBODYRAWDAGLISTDAG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& obj) { 
    ...
    ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag() = default ;
    ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag(const ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag &) = default ;
    ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag(ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag &&) = default ;
    ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag() = default ;
    ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& operator=(const ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag &) = default ;
    ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& operator=(ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag &&) = default ;
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setCanEdit(bool canEdit) { DARABONBA_PTR_SET_VALUE(canEdit_, canEdit) };
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setCreatorId(string creatorId) { DARABONBA_PTR_SET_VALUE(creatorId_, creatorId) };
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setCreatorNickName(string creatorNickName) { DARABONBA_PTR_SET_VALUE(creatorNickName_, creatorNickName) };
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setDagName(string dagName) { DARABONBA_PTR_SET_VALUE(dagName_, dagName) };
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setDagOwnerId(string dagOwnerId) { DARABONBA_PTR_SET_VALUE(dagOwnerId_, dagOwnerId) };
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setDagOwnerNickName(string dagOwnerNickName) { DARABONBA_PTR_SET_VALUE(dagOwnerNickName_, dagOwnerNickName) };
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setDataFlowId(int64_t dataFlowId) { DARABONBA_PTR_SET_VALUE(dataFlowId_, dataFlowId) };
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setDemoId(string demoId) { DARABONBA_PTR_SET_VALUE(demoId_, demoId) };
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setDeployId(int64_t deployId) { DARABONBA_PTR_SET_VALUE(deployId_, deployId) };
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setIsDeleted(bool isDeleted) { DARABONBA_PTR_SET_VALUE(isDeleted_, isDeleted) };
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setLatestInstanceStatus(int32_t latestInstanceStatus) { DARABONBA_PTR_SET_VALUE(latestInstanceStatus_, latestInstanceStatus) };
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setLatestInstanceTime(int32_t latestInstanceTime) { DARABONBA_PTR_SET_VALUE(latestInstanceTime_, latestInstanceTime) };
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setScenarioId(int64_t scenarioId) { DARABONBA_PTR_SET_VALUE(scenarioId_, scenarioId) };
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setSpaceId(int64_t spaceId) { DARABONBA_PTR_SET_VALUE(spaceId_, spaceId) };
    ...
    inline ListLhTaskFlowAndScenarioResponseBodyRawDAGListDag& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
