...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->affectRows_ == nullptr
        && return this->checkSQL_ == nullptr && return this->dbId_ == nullptr && return this->SQLReviewQueryKey_ == nullptr && return this->sqlReviewStatus_ == nullptr && return this->sqlType_ == nullptr
