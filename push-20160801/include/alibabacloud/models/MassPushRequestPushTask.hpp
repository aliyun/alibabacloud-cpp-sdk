...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->androidActivity_ != nullptr
        ...
        && this->harmonyExtensionPush_ != nullptr && this->harmonyImageUrl_ != nullptr && this->harmonyInboxContent_ != nullptr && this->harmonyNotificationSlotType_ != nullptr && this->harmonyNotifyId_ != nullptr
