...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->androidActivity_ == nullptr
        ...
        && return this->androidXiaomiBigPictureUrl_ == nullptr && return this->androidXiaomiImageUrl_ == nullptr && return this->body_ == nullptr && return this->deviceType_ == nullptr && return this->expireTime_ == nullptr
        && return this->harmonyAction_ == nullptr && return this->harmonyActionType_ == nullptr && return this->harmonyBadgeAddNum_ == nullptr && return this->harmonyBadgeSetNum_ == nullptr && return this->harmonyCategory_ == nullptr
        && return this->harmonyExtParameters_ == nullptr && return this->harmonyExtensionExtraData_ == nullptr && return this->harmonyExtensionPush_ == nullptr && return this->harmonyImageUrl_ == nullptr && return this->harmonyInboxContent_ == nullptr
        && return this->harmonyLiveViewPayload_ == nullptr && return this->harmonyNotificationSlotType_ == nullptr && return this->harmonyNotifyId_ == nullptr && return this->harmonyReceiptId_ == nullptr && return this->harmonyRemind_ == nullptr
        && return this->harmonyRemindBody_ == nullptr && return this->harmonyRemindTitle_ == nullptr && return this->harmonyRenderStyle_ == nullptr && return this->harmonyTestMessage_ == nullptr && return this->harmonyUri_ == nullptr
        && return this->jobKey_ == nullptr && return this->pushTime_ == nullptr && return this->pushType_ == nullptr && return this->sendChannels_ == nullptr && return this->sendSpeed_ == nullptr
        && return this->storeOffline_ == nullptr && return this->target_ == nullptr && return this->targetValue_ == nullptr && return this->title_ == nullptr && return this->trim_ == nullptr
        && return this->iOSApnsEnv_ == nullptr && return this->iOSBadge_ == nullptr && return this->iOSBadgeAutoIncrement_ == nullptr && return this->iOSExtParameters_ == nullptr && return this->iOSInterruptionLevel_ == nullptr
        && return this->iOSLiveActivityAttributes_ == nullptr && return this->iOSLiveActivityAttributesType_ == nullptr && return this->iOSLiveActivityContentState_ == nullptr && return this->iOSLiveActivityDismissalDate_ == nullptr && return this->iOSLiveActivityEvent_ == nullptr
        && return this->iOSLiveActivityId_ == nullptr && return this->iOSLiveActivityStaleDate_ == nullptr && return this->iOSMusic_ == nullptr && return this->iOSMutableContent_ == nullptr && return this->iOSNotificationCategory_ == nullptr
        && return this->iOSNotificationCollapseId_ == nullptr && return this->iOSNotificationThreadId_ == nullptr && return this->iOSRelevanceScore_ == nullptr && return this->iOSRemind_ == nullptr && return this->iOSRemindBody_ == nullptr
        && return this->iOSSilentNotification_ == nullptr && return this->iOSSubtitle_ == nullptr; };
    ...
    inline MassPushRequestPushTask& setAndroidOppoDeleteIntentData(string androidOppoDeleteIntentData) { DARABONBA_PTR_SET_VALUE(androidOppoDeleteIntentData_, androidOppoDeleteIntentData) };
    ...
    inline MassPushRequestPushTask& setAndroidOppoIntelligentIntent(string androidOppoIntelligentIntent) { DARABONBA_PTR_SET_VALUE(androidOppoIntelligentIntent_, androidOppoIntelligentIntent) };
    ...
    inline MassPushRequestPushTask& setAndroidOppoIntentEnv(int32_t androidOppoIntentEnv) { DARABONBA_PTR_SET_VALUE(androidOppoIntentEnv_, androidOppoIntentEnv) };
