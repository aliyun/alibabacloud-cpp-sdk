...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptCount_ == nullptr
        && return this->deletedCount_ == nullptr && return this->messageId_ == nullptr && return this->openedCount_ == nullptr && return this->receivedCount_ == nullptr && return this->sentCount_ == nullptr
        && return this->smsFailedCount_ == nullptr && return this->smsReceiveFailedCount_ == nullptr && return this->smsReceiveSuccessCount_ == nullptr && return this->smsSentCount_ == nullptr && return this->smsSkipCount_ == nullptr; };
