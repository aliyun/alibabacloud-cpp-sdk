...
namespace Models
{
  ...
  public:
    ...
    inline const CheckDevicesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckDevicesResponseBody) };
    inline CheckDevicesResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckDevicesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckDevicesResponseBody> body_ {};
  };
