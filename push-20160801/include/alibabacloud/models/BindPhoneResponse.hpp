...
namespace Models
{
  ...
  public:
    ...
    inline const BindPhoneResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BindPhoneResponseBody) };
    inline BindPhoneResponseBody getBody() { DARABONBA_PTR_GET(body_, BindPhoneResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BindPhoneResponseBody> body_ {};
  };
