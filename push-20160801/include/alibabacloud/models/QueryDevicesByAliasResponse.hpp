...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDevicesByAliasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryDevicesByAliasResponseBody) };
    inline QueryDevicesByAliasResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryDevicesByAliasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryDevicesByAliasResponseBody> body_ {};
  };
