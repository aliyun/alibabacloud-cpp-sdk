...
namespace Models
{
  ...
  public:
    ...
    inline const MassPushV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MassPushV2ResponseBody) };
    inline MassPushV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, MassPushV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MassPushV2ResponseBody> body_ {};
  };
