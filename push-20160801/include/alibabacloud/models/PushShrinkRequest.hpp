...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->androidActivity_ != nullptr
        ...
        && this->androidNotifyType_ != nullptr && this->androidOpenType_ != nullptr && this->androidOpenUrl_ != nullptr && this->androidOppoPrivateContentParametersShrink_ != nullptr && this->androidOppoPrivateMsgTemplateId_ != nullptr
        && this->androidOppoPrivateTitleParametersShrink_ != nullptr && this->androidPopupActivity_ != nullptr && this->androidPopupBody_ != nullptr && this->androidPopupTitle_ != nullptr && this->androidRemind_ != nullptr
