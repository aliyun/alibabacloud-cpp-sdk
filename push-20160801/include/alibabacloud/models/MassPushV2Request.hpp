...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appKey_ == nullptr
        && this->idempotentToken_ == nullptr && this->pushTasks_ == nullptr; };
    ...
    inline const vector<PushTask> & getPushTasks() const { DARABONBA_PTR_GET_CONST(pushTasks_, vector<PushTask>) };
    inline vector<PushTask> getPushTasks() { DARABONBA_PTR_GET(pushTasks_, vector<PushTask>) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<vector<PushTask>> pushTasks_ {};
  };
