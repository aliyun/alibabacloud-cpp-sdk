...
namespace Models
{
  ...
  public:
    ...
    inline const BindTagResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BindTagResponseBody) };
    inline BindTagResponseBody getBody() { DARABONBA_PTR_GET(body_, BindTagResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BindTagResponseBody> body_ {};
  };
