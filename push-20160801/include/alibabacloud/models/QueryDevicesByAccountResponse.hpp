...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDevicesByAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryDevicesByAccountResponseBody) };
    inline QueryDevicesByAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryDevicesByAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryDevicesByAccountResponseBody> body_ {};
  };
