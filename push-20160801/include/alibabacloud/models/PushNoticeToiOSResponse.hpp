...
namespace Models
{
  ...
  public:
    ...
    inline const PushNoticeToiOSResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PushNoticeToiOSResponseBody) };
    inline PushNoticeToiOSResponseBody getBody() { DARABONBA_PTR_GET(body_, PushNoticeToiOSResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PushNoticeToiOSResponseBody> body_ {};
  };
