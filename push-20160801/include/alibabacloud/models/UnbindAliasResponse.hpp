...
namespace Models
{
  ...
  public:
    ...
    inline const UnbindAliasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnbindAliasResponseBody) };
    inline UnbindAliasResponseBody getBody() { DARABONBA_PTR_GET(body_, UnbindAliasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnbindAliasResponseBody> body_ {};
  };
