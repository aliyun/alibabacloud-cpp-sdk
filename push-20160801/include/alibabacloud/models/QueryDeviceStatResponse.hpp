...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDeviceStatResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryDeviceStatResponseBody) };
    inline QueryDeviceStatResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryDeviceStatResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryDeviceStatResponseBody> body_ {};
  };
