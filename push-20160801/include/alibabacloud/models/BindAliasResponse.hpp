...
namespace Models
{
  ...
  public:
    ...
    inline const BindAliasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BindAliasResponseBody) };
    inline BindAliasResponseBody getBody() { DARABONBA_PTR_GET(body_, BindAliasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BindAliasResponseBody> body_ {};
  };
