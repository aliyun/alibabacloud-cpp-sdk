...
namespace Models
{
  ...
  public:
    ...
    inline const CancelPushResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelPushResponseBody) };
    inline CancelPushResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelPushResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelPushResponseBody> body_ {};
  };
