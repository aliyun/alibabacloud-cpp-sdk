...
namespace Models
{
  ...
  public:
    ...
    inline const GetDoctorHDFSClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDoctorHDFSClusterResponseBody) };
    inline GetDoctorHDFSClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDoctorHDFSClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDoctorHDFSClusterResponseBody> body_ {};
  };
