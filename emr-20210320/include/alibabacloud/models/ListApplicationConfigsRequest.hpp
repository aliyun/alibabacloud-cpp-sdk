...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicationName_ == nullptr
        && return this->clusterId_ == nullptr && return this->configFileName_ == nullptr && return this->configItemKey_ == nullptr && return this->configItemValue_ == nullptr && return this->maxResults_ == nullptr
        && return this->nextToken_ == nullptr && return this->nodeGroupId_ == nullptr && return this->nodeId_ == nullptr && return this->regionId_ == nullptr; };
