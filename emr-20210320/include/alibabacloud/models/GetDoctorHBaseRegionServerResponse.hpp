...
namespace Models
{
  ...
  public:
    ...
    inline const GetDoctorHBaseRegionServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDoctorHBaseRegionServerResponseBody) };
    inline GetDoctorHBaseRegionServerResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDoctorHBaseRegionServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDoctorHBaseRegionServerResponseBody> body_ {};
  };
