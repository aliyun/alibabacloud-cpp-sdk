...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->metrics_ == nullptr
        && this->regionServerHost_ == nullptr; };
    ...
    inline const vector<ListDoctorHBaseRegionServersResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListDoctorHBaseRegionServersResponseBody::Data>) };
    inline vector<ListDoctorHBaseRegionServersResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListDoctorHBaseRegionServersResponseBody::Data>) };
    inline ListDoctorHBaseRegionServersResponseBody& setData(const vector<ListDoctorHBaseRegionServersResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDoctorHBaseRegionServersResponseBody& setData(vector<ListDoctorHBaseRegionServersResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    shared_ptr<vector<ListDoctorHBaseRegionServersResponseBody::Data>> data_ {};
