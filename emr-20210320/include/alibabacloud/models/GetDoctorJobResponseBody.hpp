...
namespace Models
{
  ...
  public:
    ...
    inline const GetDoctorJobResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDoctorJobResponseBodyData) };
    inline GetDoctorJobResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDoctorJobResponseBodyData) };
    inline GetDoctorJobResponseBody& setData(const GetDoctorJobResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDoctorJobResponseBody& setData(GetDoctorJobResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDoctorJobResponseBodyData> data_ = nullptr;
    // The request ID.
