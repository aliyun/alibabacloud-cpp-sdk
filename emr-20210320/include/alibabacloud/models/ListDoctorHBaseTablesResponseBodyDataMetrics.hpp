...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->coldAccessDay_ == nullptr
        && return this->coldConfigDay_ == nullptr && return this->coldDataSize_ == nullptr && return this->dailyReadRequest_ == nullptr && return this->dailyReadRequestDayGrowthRatio_ == nullptr && return this->dailyWriteRequest_ == nullptr
        && return this->dailyWriteRequestDayGrowthRatio_ == nullptr && return this->freezeConfigDay_ == nullptr && return this->freezeDataSize_ == nullptr && return this->hotDataSize_ == nullptr && return this->locality_ == nullptr
        && return this->readRequestBalance_ == nullptr && return this->regionBalance_ == nullptr && return this->regionCount_ == nullptr && return this->regionCountDayGrowthRatio_ == nullptr && return this->regionServerCount_ == nullptr
        && return this->requestBalance_ == nullptr && return this->storeFileCount_ == nullptr && return this->storeFileCountDayGrowthRatio_ == nullptr && return this->tableSize_ == nullptr && return this->tableSizeDayGrowthRatio_ == nullptr
        && return this->warmConfigDay_ == nullptr && return this->warmDataSize_ == nullptr && return this->writeRequestBalance_ == nullptr; };
