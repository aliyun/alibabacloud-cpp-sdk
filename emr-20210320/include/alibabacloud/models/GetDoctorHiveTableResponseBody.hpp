...
#ifndef ALIBABACLOUD_MODELS_GETDOCTORHIVETABLERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETDOCTORHIVETABLERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetDoctorHiveTableResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetDoctorHiveTableResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    GetDoctorHiveTableResponseBody() = default ;
    GetDoctorHiveTableResponseBody(const GetDoctorHiveTableResponseBody &) = default ;
    GetDoctorHiveTableResponseBody(GetDoctorHiveTableResponseBody &&) = default ;
    GetDoctorHiveTableResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDoctorHiveTableResponseBody() = default ;
    GetDoctorHiveTableResponseBody& operator=(const GetDoctorHiveTableResponseBody &) = default ;
    GetDoctorHiveTableResponseBody& operator=(GetDoctorHiveTableResponseBody &&) = default ;
    ...
    inline const GetDoctorHiveTableResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetDoctorHiveTableResponseBody::Data) };
    inline GetDoctorHiveTableResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetDoctorHiveTableResponseBody::Data) };
    inline GetDoctorHiveTableResponseBody& setData(const GetDoctorHiveTableResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDoctorHiveTableResponseBody& setData(GetDoctorHiveTableResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetDoctorHiveTableResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The analysis results of the Hive table.
    shared_ptr<GetDoctorHiveTableResponseBody::Data> data_ {};
    // The request ID.
