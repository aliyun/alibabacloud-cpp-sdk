...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicationNames_ == nullptr
        && this->clusterId_ == nullptr && this->componentNames_ == nullptr && this->componentStates_ == nullptr && this->maxResults_ == nullptr && this->nextToken_ == nullptr
        && this->nodeIds_ == nullptr && this->nodeNames_ == nullptr && this->regionId_ == nullptr && this->zoneId_ == nullptr; };
    ...
    inline const vector<string> & getApplicationNames() const { DARABONBA_PTR_GET_CONST(applicationNames_, vector<string>) };
    inline vector<string> getApplicationNames() { DARABONBA_PTR_GET(applicationNames_, vector<string>) };
    ...
    inline const vector<string> & getComponentNames() const { DARABONBA_PTR_GET_CONST(componentNames_, vector<string>) };
    inline vector<string> getComponentNames() { DARABONBA_PTR_GET(componentNames_, vector<string>) };
    ...
    inline const vector<string> & getComponentStates() const { DARABONBA_PTR_GET_CONST(componentStates_, vector<string>) };
    inline vector<string> getComponentStates() { DARABONBA_PTR_GET(componentStates_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> applicationNames_ {};
    // The cluster ID.
    // 
    // This parameter is required.
    shared_ptr<string> clusterId_ {};
    // The list of component names.
    shared_ptr<vector<string>> componentNames_ {};
    // The list of component status.
    shared_ptr<vector<string>> componentStates_ {};
