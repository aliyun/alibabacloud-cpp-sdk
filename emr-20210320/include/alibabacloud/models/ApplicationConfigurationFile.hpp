...
namespace Models
{
  ...
  public:
    ...
    inline string getConfigFileFormat() const { DARABONBA_PTR_GET_DEFAULT(configFileFormat_, "") };
    ...
    inline string getConfigFileGroup() const { DARABONBA_PTR_GET_DEFAULT(configFileGroup_, "") };
    ...
    inline string getConfigFileLink() const { DARABONBA_PTR_GET_DEFAULT(configFileLink_, "") };
    ...
    inline string getConfigFileMode() const { DARABONBA_PTR_GET_DEFAULT(configFileMode_, "") };
    ...
    inline string getConfigFileOwner() const { DARABONBA_PTR_GET_DEFAULT(configFileOwner_, "") };
    ...
    inline string getConfigFilePath() const { DARABONBA_PTR_GET_DEFAULT(configFilePath_, "") };
  ...
  protected:
    ...
    shared_ptr<string> configFileFormat_ {};
    shared_ptr<string> configFileGroup_ {};
    shared_ptr<string> configFileLink_ {};
    shared_ptr<string> configFileMode_ {};
    shared_ptr<string> configFileName_ {};
    shared_ptr<string> configFileOwner_ {};
    shared_ptr<string> configFilePath_ {};
