...
namespace Models
{
  ...
  public:
    ...
    inline const GetDoctorHDFSDirectoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDoctorHDFSDirectoryResponseBody) };
    inline GetDoctorHDFSDirectoryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDoctorHDFSDirectoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDoctorHDFSDirectoryResponseBody> body_ {};
  };
