...
namespace Models
{
  ...
  public:
    ...
    inline const GetDoctorHBaseTableResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetDoctorHBaseTableResponseBody::Data) };
    inline GetDoctorHBaseTableResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetDoctorHBaseTableResponseBody::Data) };
    inline GetDoctorHBaseTableResponseBody& setData(const GetDoctorHBaseTableResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDoctorHBaseTableResponseBody& setData(GetDoctorHBaseTableResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // Returned data.
    shared_ptr<GetDoctorHBaseTableResponseBody::Data> data_ {};
    // Request ID.
