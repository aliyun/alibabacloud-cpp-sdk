...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ClusterSummary> & getClusters() const { DARABONBA_PTR_GET_CONST(clusters_, vector<ClusterSummary>) };
    inline vector<ClusterSummary> getClusters() { DARABONBA_PTR_GET(clusters_, vector<ClusterSummary>) };
  ...
  protected:
    ...
    shared_ptr<vector<ClusterSummary>> clusters_ {};
