...
namespace Models
{
  ...
  public:
    ...
    inline const GetDoctorComputeSummaryResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetDoctorComputeSummaryResponseBody::Data) };
    inline GetDoctorComputeSummaryResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetDoctorComputeSummaryResponseBody::Data) };
    inline GetDoctorComputeSummaryResponseBody& setData(const GetDoctorComputeSummaryResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDoctorComputeSummaryResponseBody& setData(GetDoctorComputeSummaryResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<GetDoctorComputeSummaryResponseBody::Data> data_ {};
    // The request ID.
