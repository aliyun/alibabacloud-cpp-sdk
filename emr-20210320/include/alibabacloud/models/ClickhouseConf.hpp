...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->initialReplica_ == nullptr
    ...
    inline int32_t getInitialReplica() const { DARABONBA_PTR_GET_DEFAULT(initialReplica_, 0) };
    ...
    inline int32_t getInitialShard() const { DARABONBA_PTR_GET_DEFAULT(initialShard_, 0) };
    ...
    inline int32_t getNewNodeCount() const { DARABONBA_PTR_GET_DEFAULT(newNodeCount_, 0) };
    ...
    inline string getResizeType() const { DARABONBA_PTR_GET_DEFAULT(resizeType_, "") };
    inline ClickhouseConf& setResizeType(string resizeType) { DARABONBA_PTR_SET_VALUE(resizeType_, resizeType) };


  protected:
    shared_ptr<int32_t> initialReplica_ {};
    shared_ptr<int32_t> initialShard_ {};
    shared_ptr<int32_t> newNodeCount_ {};
    shared_ptr<string> resizeType_ {};
  };
