...
namespace Models
{
  ...
  public:
    ...
    inline const ListApplicationConfigsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApplicationConfigsResponseBody) };
    inline ListApplicationConfigsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApplicationConfigsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApplicationConfigsResponseBody> body_ {};
  };
