...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDoctorHiveDatabasesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListDoctorHiveDatabasesResponseBodyData>) };
    inline vector<ListDoctorHiveDatabasesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListDoctorHiveDatabasesResponseBodyData>) };
    inline ListDoctorHiveDatabasesResponseBody& setData(const vector<ListDoctorHiveDatabasesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDoctorHiveDatabasesResponseBody& setData(vector<ListDoctorHiveDatabasesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListDoctorHiveDatabasesResponseBodyData>> data_ = nullptr;
