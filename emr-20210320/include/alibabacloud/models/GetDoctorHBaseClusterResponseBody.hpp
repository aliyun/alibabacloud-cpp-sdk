...
namespace Models
{
  ...
  public:
    ...
    inline const GetDoctorHBaseClusterResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDoctorHBaseClusterResponseBodyData) };
    inline GetDoctorHBaseClusterResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDoctorHBaseClusterResponseBodyData) };
    inline GetDoctorHBaseClusterResponseBody& setData(const GetDoctorHBaseClusterResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDoctorHBaseClusterResponseBody& setData(GetDoctorHBaseClusterResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<GetDoctorHBaseClusterResponseBodyData> data_ = nullptr;
    // The request ID.
