...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Data& setDirPath(string dirPath) { DARABONBA_PTR_SET_VALUE(dirPath_, dirPath) };
    ...
    inline const vector<ListDoctorHDFSDirectoriesResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListDoctorHDFSDirectoriesResponseBody::Data>) };
    inline vector<ListDoctorHDFSDirectoriesResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListDoctorHDFSDirectoriesResponseBody::Data>) };
    inline ListDoctorHDFSDirectoriesResponseBody& setData(const vector<ListDoctorHDFSDirectoriesResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDoctorHDFSDirectoriesResponseBody& setData(vector<ListDoctorHDFSDirectoriesResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<vector<ListDoctorHDFSDirectoriesResponseBody::Data>> data_ {};
