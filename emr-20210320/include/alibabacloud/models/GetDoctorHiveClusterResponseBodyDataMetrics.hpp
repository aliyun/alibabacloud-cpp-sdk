...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->coldDataDayGrowthSize_ != nullptr
        && this->coldDataRatio_ != nullptr && this->coldDataSize_ != nullptr && this->coldDataSizeDayGrowthRatio_ != nullptr && this->databaseCount_ != nullptr && this->emptyFileCount_ != nullptr
        && this->emptyFileCountDayGrowthRatio_ != nullptr && this->emptyFileDayGrowthCount_ != nullptr && this->emptyFileRatio_ != nullptr && this->freezeDataDayGrowthSize_ != nullptr && this->freezeDataRatio_ != nullptr
        && this->freezeDataSize_ != nullptr && this->freezeDataSizeDayGrowthRatio_ != nullptr && this->hotDataDayGrowthSize_ != nullptr && this->hotDataRatio_ != nullptr && this->hotDataSize_ != nullptr
        && this->hotDataSizeDayGrowthRatio_ != nullptr && this->largeFileCount_ != nullptr && this->largeFileCountDayGrowthRatio_ != nullptr && this->largeFileDayGrowthCount_ != nullptr && this->largeFileRatio_ != nullptr
        && this->mediumFileCount_ != nullptr && this->mediumFileCountDayGrowthRatio_ != nullptr && this->mediumFileDayGrowthCount_ != nullptr && this->mediumFileRatio_ != nullptr && this->partitionNum_ != nullptr
        && this->smallFileCount_ != nullptr && this->smallFileCountDayGrowthRatio_ != nullptr && this->smallFileDayGrowthCount_ != nullptr && this->smallFileRatio_ != nullptr && this->tableCount_ != nullptr
        && this->tinyFileCount_ != nullptr && this->tinyFileCountDayGrowthRatio_ != nullptr && this->tinyFileDayGrowthCount_ != nullptr && this->tinyFileRatio_ != nullptr && this->totalDataDayGrowthSize_ != nullptr
        && this->totalDataSize_ != nullptr && this->totalDataSizeDayGrowthRatio_ != nullptr && this->totalFileCount_ != nullptr && this->totalFileCountDayGrowthRatio_ != nullptr && this->totalFileDayGrowthCount_ != nullptr
        && this->warmDataDayGrowthSize_ != nullptr && this->warmDataRatio_ != nullptr && this->warmDataSize_ != nullptr && this->warmDataSizeDayGrowthRatio_ != nullptr; };
