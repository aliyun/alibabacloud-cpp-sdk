...
namespace Models
{
  ...
  public:
    ...
    inline const Operation & getOperation() const { DARABONBA_PTR_GET_CONST(operation_, Operation) };
    inline Operation getOperation() { DARABONBA_PTR_GET(operation_, Operation) };
