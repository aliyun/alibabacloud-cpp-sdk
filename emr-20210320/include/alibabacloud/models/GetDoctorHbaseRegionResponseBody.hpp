...
namespace Models
{
  ...
  public:
    ...
    inline const GetDoctorHBaseRegionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDoctorHBaseRegionResponseBodyData) };
    inline GetDoctorHBaseRegionResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDoctorHBaseRegionResponseBodyData) };
    inline GetDoctorHBaseRegionResponseBody& setData(const GetDoctorHBaseRegionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDoctorHBaseRegionResponseBody& setData(GetDoctorHBaseRegionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // Returned data.
    std::shared_ptr<GetDoctorHBaseRegionResponseBodyData> data_ = nullptr;
    // Request ID.
