...
#ifndef ALIBABACLOUD_MODELS_LISTDOCTORHIVETABLESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTDOCTORHIVETABLESRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDoctorHiveTablesResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDoctorHiveTablesResponseBody& obj) { 
    ...
    ListDoctorHiveTablesResponseBody() = default ;
    ListDoctorHiveTablesResponseBody(const ListDoctorHiveTablesResponseBody &) = default ;
    ListDoctorHiveTablesResponseBody(ListDoctorHiveTablesResponseBody &&) = default ;
    ListDoctorHiveTablesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDoctorHiveTablesResponseBody() = default ;
    ListDoctorHiveTablesResponseBody& operator=(const ListDoctorHiveTablesResponseBody &) = default ;
    ListDoctorHiveTablesResponseBody& operator=(ListDoctorHiveTablesResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->analysis_ == nullptr
        && this->formats_ == nullptr && this->metrics_ == nullptr && this->owner_ == nullptr && this->tableName_ == nullptr; };
    ...
    inline const vector<ListDoctorHiveTablesResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListDoctorHiveTablesResponseBody::Data>) };
    inline vector<ListDoctorHiveTablesResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListDoctorHiveTablesResponseBody::Data>) };
    inline ListDoctorHiveTablesResponseBody& setData(const vector<ListDoctorHiveTablesResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDoctorHiveTablesResponseBody& setData(vector<ListDoctorHiveTablesResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListDoctorHiveTablesResponseBody& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline ListDoctorHiveTablesResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ListDoctorHiveTablesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListDoctorHiveTablesResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };


  protected:
    // The analysis results of Hive tables.
    shared_ptr<vector<ListDoctorHiveTablesResponseBody::Data>> data_ {};
