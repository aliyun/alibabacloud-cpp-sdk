...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteApiTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteApiTemplateResponseBody) };
    inline DeleteApiTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteApiTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteApiTemplateResponseBody> body_ {};
  };
