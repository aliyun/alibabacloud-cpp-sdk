...
namespace Models
{
  ...
  public:
    ...
    inline const CreateApiTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateApiTemplateResponseBody) };
    inline CreateApiTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateApiTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateApiTemplateResponseBody> body_ {};
  };
