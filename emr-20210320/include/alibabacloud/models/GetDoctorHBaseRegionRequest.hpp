...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterId_ == nullptr
        && this->dateTime_ == nullptr && this->hbaseRegionId_ == nullptr && this->regionId_ == nullptr; };
    ...
    inline string getHbaseRegionId() const { DARABONBA_PTR_GET_DEFAULT(hbaseRegionId_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> hbaseRegionId_ {};
    // Region ID.
    // 
    // This parameter is required.
