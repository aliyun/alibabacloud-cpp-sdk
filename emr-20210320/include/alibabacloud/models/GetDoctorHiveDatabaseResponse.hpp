...
namespace Models
{
  ...
  public:
    ...
    inline const GetDoctorHiveDatabaseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDoctorHiveDatabaseResponseBody) };
    inline GetDoctorHiveDatabaseResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDoctorHiveDatabaseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDoctorHiveDatabaseResponseBody> body_ {};
  };
