...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activityId_ == nullptr
        && return this->activityState_ == nullptr && return this->activityType_ == nullptr && return this->clusterId_ == nullptr && return this->description_ == nullptr && return this->endTime_ == nullptr
        && return this->expectNum_ == nullptr && return this->instanceTypeDetails_ == nullptr && return this->instanceTypeToNum_ == nullptr && return this->nodeGroupId_ == nullptr && return this->nodeGroupName_ == nullptr
        && return this->operationId_ == nullptr && return this->policyType_ == nullptr && return this->ruleName_ == nullptr && return this->startTime_ == nullptr; };
