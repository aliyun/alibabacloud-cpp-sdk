...
namespace Models
{
  ...
  public:
    ...
    inline bool getDataDiskEncrypted() const { DARABONBA_PTR_GET_DEFAULT(dataDiskEncrypted_, false) };
    ...
    inline string getDataDiskKMSKeyId() const { DARABONBA_PTR_GET_DEFAULT(dataDiskKMSKeyId_, "") };
    ...
    inline string getMasterRootPassword() const { DARABONBA_PTR_GET_DEFAULT(masterRootPassword_, "") };
  ...
  protected:
    ...
    shared_ptr<bool> dataDiskEncrypted_ {};
    // The ID of the KMS key for the data disk.
    shared_ptr<string> dataDiskKMSKeyId_ {};
    ...
    shared_ptr<string> masterRootPassword_ {};
