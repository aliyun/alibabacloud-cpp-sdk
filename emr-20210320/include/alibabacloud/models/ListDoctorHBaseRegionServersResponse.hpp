...
namespace Models
{
  ...
  public:
    ...
    inline const ListDoctorHBaseRegionServersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDoctorHBaseRegionServersResponseBody) };
    inline ListDoctorHBaseRegionServersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDoctorHBaseRegionServersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDoctorHBaseRegionServersResponseBody> body_ {};
  };
