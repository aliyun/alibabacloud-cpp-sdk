...
namespace Models
{
  ...
  public:
    ...
    inline float getActualUsage() const { DARABONBA_PTR_GET_DEFAULT(actualUsage_, 0.0) };
    ...
    inline float getIdealUsage() const { DARABONBA_PTR_GET_DEFAULT(idealUsage_, 0.0) };
    ...
    inline int32_t getReleaseCores() const { DARABONBA_PTR_GET_DEFAULT(releaseCores_, 0) };
    ...
    inline int32_t getReservedCores() const { DARABONBA_PTR_GET_DEFAULT(reservedCores_, 0) };
    inline ScalingAnalyzeResult& setReservedCores(int32_t reservedCores) { DARABONBA_PTR_SET_VALUE(reservedCores_, reservedCores) };


  protected:
    // 实际资源利用率。
    shared_ptr<float> actualUsage_ {};
    // 理想资源用量。
    shared_ptr<float> idealUsage_ {};
    // 固定资源释放核数（非master）core。
    shared_ptr<int32_t> releaseCores_ {};
    // 固定资源保留核数（非master）core。
    shared_ptr<int32_t> reservedCores_ {};
  };
