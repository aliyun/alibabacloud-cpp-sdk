...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->comparisonOperator_ == nullptr
        && return this->evaluationCount_ == nullptr && return this->metricName_ == nullptr && return this->statistics_ == nullptr && return this->threshold_ == nullptr && return this->timeWindow_ == nullptr; };
