...
namespace Models
{
  ...
  public:
    ...
    inline const GetNodeGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetNodeGroupResponseBody) };
    inline GetNodeGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, GetNodeGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetNodeGroupResponseBody> body_ {};
  };
