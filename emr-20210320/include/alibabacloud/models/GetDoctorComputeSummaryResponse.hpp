...
namespace Models
{
  ...
  public:
    ...
    inline const GetDoctorComputeSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDoctorComputeSummaryResponseBody) };
    inline GetDoctorComputeSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDoctorComputeSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDoctorComputeSummaryResponseBody> body_ {};
  };
