...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateUserAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateUserAttributeResponseBody) };
    inline UpdateUserAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateUserAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateUserAttributeResponseBody> body_ {};
  };
