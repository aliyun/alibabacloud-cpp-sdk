...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->scalingActivity_ == nullptr; };
    ...
    inline const GetAutoScalingActivityResponseBodyScalingActivity & scalingActivity() const { DARABONBA_PTR_GET_CONST(scalingActivity_, GetAutoScalingActivityResponseBodyScalingActivity) };
    inline GetAutoScalingActivityResponseBodyScalingActivity scalingActivity() { DARABONBA_PTR_GET(scalingActivity_, GetAutoScalingActivityResponseBodyScalingActivity) };
    inline GetAutoScalingActivityResponseBody& setScalingActivity(const GetAutoScalingActivityResponseBodyScalingActivity & scalingActivity) { DARABONBA_PTR_SET_VALUE(scalingActivity_, scalingActivity) };
    inline GetAutoScalingActivityResponseBody& setScalingActivity(GetAutoScalingActivityResponseBodyScalingActivity && scalingActivity) { DARABONBA_PTR_SET_RVALUE(scalingActivity_, scalingActivity) };
  ...
  protected:
    ...
    std::shared_ptr<GetAutoScalingActivityResponseBodyScalingActivity> scalingActivity_ = nullptr;
  };
