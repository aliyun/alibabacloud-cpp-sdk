...
#ifndef ALIBABACLOUD_MODELS_GETDOCTORHIVEDATABASERESPONSEBODYDATAFORMATS_HPP_
#define ALIBABACLOUD_MODELS_GETDOCTORHIVEDATABASERESPONSEBODYDATAFORMATS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetDoctorHiveDatabaseResponseBodyDataFormats& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetDoctorHiveDatabaseResponseBodyDataFormats& obj) { 
    ...
    GetDoctorHiveDatabaseResponseBodyDataFormats() = default ;
    GetDoctorHiveDatabaseResponseBodyDataFormats(const GetDoctorHiveDatabaseResponseBodyDataFormats &) = default ;
    GetDoctorHiveDatabaseResponseBodyDataFormats(GetDoctorHiveDatabaseResponseBodyDataFormats &&) = default ;
    GetDoctorHiveDatabaseResponseBodyDataFormats(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDoctorHiveDatabaseResponseBodyDataFormats() = default ;
    GetDoctorHiveDatabaseResponseBodyDataFormats& operator=(const GetDoctorHiveDatabaseResponseBodyDataFormats &) = default ;
    GetDoctorHiveDatabaseResponseBodyDataFormats& operator=(GetDoctorHiveDatabaseResponseBodyDataFormats &&) = default ;
    ...
    inline GetDoctorHiveDatabaseResponseBodyDataFormats& setFormatDayGrowthSize(int64_t formatDayGrowthSize) { DARABONBA_PTR_SET_VALUE(formatDayGrowthSize_, formatDayGrowthSize) };
    ...
    inline GetDoctorHiveDatabaseResponseBodyDataFormats& setFormatName(string formatName) { DARABONBA_PTR_SET_VALUE(formatName_, formatName) };
    ...
    inline GetDoctorHiveDatabaseResponseBodyDataFormats& setFormatRatio(float formatRatio) { DARABONBA_PTR_SET_VALUE(formatRatio_, formatRatio) };
    ...
    inline GetDoctorHiveDatabaseResponseBodyDataFormats& setFormatSize(int64_t formatSize) { DARABONBA_PTR_SET_VALUE(formatSize_, formatSize) };
    ...
    inline GetDoctorHiveDatabaseResponseBodyDataFormats& setFormatSizeDayGrowthRatio(float formatSizeDayGrowthRatio) { DARABONBA_PTR_SET_VALUE(formatSizeDayGrowthRatio_, formatSizeDayGrowthRatio) };
    ...
    inline GetDoctorHiveDatabaseResponseBodyDataFormats& setFormatSizeUnit(string formatSizeUnit) { DARABONBA_PTR_SET_VALUE(formatSizeUnit_, formatSizeUnit) };
