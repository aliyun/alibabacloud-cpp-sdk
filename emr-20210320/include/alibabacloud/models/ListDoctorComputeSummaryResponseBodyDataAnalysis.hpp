...
#ifndef ALIBABACLOUD_MODELS_LISTDOCTORCOMPUTESUMMARYRESPONSEBODYDATAANALYSIS_HPP_
#define ALIBABACLOUD_MODELS_LISTDOCTORCOMPUTESUMMARYRESPONSEBODYDATAANALYSIS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDoctorComputeSummaryResponseBodyDataAnalysis& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDoctorComputeSummaryResponseBodyDataAnalysis& obj) { 
    ...
    ListDoctorComputeSummaryResponseBodyDataAnalysis() = default ;
    ListDoctorComputeSummaryResponseBodyDataAnalysis(const ListDoctorComputeSummaryResponseBodyDataAnalysis &) = default ;
    ListDoctorComputeSummaryResponseBodyDataAnalysis(ListDoctorComputeSummaryResponseBodyDataAnalysis &&) = default ;
    ListDoctorComputeSummaryResponseBodyDataAnalysis(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDoctorComputeSummaryResponseBodyDataAnalysis() = default ;
    ListDoctorComputeSummaryResponseBodyDataAnalysis& operator=(const ListDoctorComputeSummaryResponseBodyDataAnalysis &) = default ;
    ListDoctorComputeSummaryResponseBodyDataAnalysis& operator=(ListDoctorComputeSummaryResponseBodyDataAnalysis &&) = default ;
    ...
    inline ListDoctorComputeSummaryResponseBodyDataAnalysis& setHealthyJobCount(int64_t healthyJobCount) { DARABONBA_PTR_SET_VALUE(healthyJobCount_, healthyJobCount) };
    ...
    inline ListDoctorComputeSummaryResponseBodyDataAnalysis& setNeedAttentionJobCount(int64_t needAttentionJobCount) { DARABONBA_PTR_SET_VALUE(needAttentionJobCount_, needAttentionJobCount) };
    ...
    inline ListDoctorComputeSummaryResponseBodyDataAnalysis& setScore(int32_t score) { DARABONBA_PTR_SET_VALUE(score_, score) };
    ...
    inline ListDoctorComputeSummaryResponseBodyDataAnalysis& setScoreDayGrowthRatio(float scoreDayGrowthRatio) { DARABONBA_PTR_SET_VALUE(scoreDayGrowthRatio_, scoreDayGrowthRatio) };
    ...
    inline ListDoctorComputeSummaryResponseBodyDataAnalysis& setSubHealthyJobCount(int64_t subHealthyJobCount) { DARABONBA_PTR_SET_VALUE(subHealthyJobCount_, subHealthyJobCount) };
    ...
    inline ListDoctorComputeSummaryResponseBodyDataAnalysis& setUnhealthyJobCount(int64_t unhealthyJobCount) { DARABONBA_PTR_SET_VALUE(unhealthyJobCount_, unhealthyJobCount) };
