...
namespace Models
{
  ...
  public:
    ...
    inline const ListDoctorHiveTablesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDoctorHiveTablesResponseBody) };
    inline ListDoctorHiveTablesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDoctorHiveTablesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDoctorHiveTablesResponseBody> body_ {};
  };
