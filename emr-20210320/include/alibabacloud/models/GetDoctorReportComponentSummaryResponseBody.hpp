...
namespace Models
{
  ...
  public:
    ...
    inline const GetDoctorReportComponentSummaryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDoctorReportComponentSummaryResponseBodyData) };
    inline GetDoctorReportComponentSummaryResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDoctorReportComponentSummaryResponseBodyData) };
    inline GetDoctorReportComponentSummaryResponseBody& setData(const GetDoctorReportComponentSummaryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDoctorReportComponentSummaryResponseBody& setData(GetDoctorReportComponentSummaryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDoctorReportComponentSummaryResponseBodyData> data_ = nullptr;
    // Request ID.
