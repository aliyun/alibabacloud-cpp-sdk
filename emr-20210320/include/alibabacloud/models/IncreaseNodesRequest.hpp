...
namespace Models
{
  ...
  public:
    ...
    inline int32_t getIncreaseNodeCount() const { DARABONBA_PTR_GET_DEFAULT(increaseNodeCount_, 0) };
    ...
    inline int32_t getMinIncreaseNodeCount() const { DARABONBA_PTR_GET_DEFAULT(minIncreaseNodeCount_, 0) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<int32_t> increaseNodeCount_ {};
    ...
    shared_ptr<int32_t> minIncreaseNodeCount_ {};
