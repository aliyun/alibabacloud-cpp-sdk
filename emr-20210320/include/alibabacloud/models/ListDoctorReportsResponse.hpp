...
namespace Models
{
  ...
  public:
    ...
    inline const ListDoctorReportsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDoctorReportsResponseBody) };
    inline ListDoctorReportsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDoctorReportsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDoctorReportsResponseBody> body_ {};
  };
