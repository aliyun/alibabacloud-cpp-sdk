...
#ifndef ALIBABACLOUD_MODELS_LISTDOCTORHIVETABLESRESPONSEBODYDATAANALYSIS_HPP_
#define ALIBABACLOUD_MODELS_LISTDOCTORHIVETABLESRESPONSEBODYDATAANALYSIS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDoctorHiveTablesResponseBodyDataAnalysis& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDoctorHiveTablesResponseBodyDataAnalysis& obj) { 
    ...
    ListDoctorHiveTablesResponseBodyDataAnalysis() = default ;
    ListDoctorHiveTablesResponseBodyDataAnalysis(const ListDoctorHiveTablesResponseBodyDataAnalysis &) = default ;
    ListDoctorHiveTablesResponseBodyDataAnalysis(ListDoctorHiveTablesResponseBodyDataAnalysis &&) = default ;
    ListDoctorHiveTablesResponseBodyDataAnalysis(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDoctorHiveTablesResponseBodyDataAnalysis() = default ;
    ListDoctorHiveTablesResponseBodyDataAnalysis& operator=(const ListDoctorHiveTablesResponseBodyDataAnalysis &) = default ;
    ListDoctorHiveTablesResponseBodyDataAnalysis& operator=(ListDoctorHiveTablesResponseBodyDataAnalysis &&) = default ;
    ...
    inline ListDoctorHiveTablesResponseBodyDataAnalysis& setHiveDistributionScore(int32_t hiveDistributionScore) { DARABONBA_PTR_SET_VALUE(hiveDistributionScore_, hiveDistributionScore) };
    ...
    inline ListDoctorHiveTablesResponseBodyDataAnalysis& setHiveFormatScore(int32_t hiveFormatScore) { DARABONBA_PTR_SET_VALUE(hiveFormatScore_, hiveFormatScore) };
    ...
    inline ListDoctorHiveTablesResponseBodyDataAnalysis& setHiveFrequencyScore(int32_t hiveFrequencyScore) { DARABONBA_PTR_SET_VALUE(hiveFrequencyScore_, hiveFrequencyScore) };
    ...
    inline ListDoctorHiveTablesResponseBodyDataAnalysis& setHiveScore(int32_t hiveScore) { DARABONBA_PTR_SET_VALUE(hiveScore_, hiveScore) };
