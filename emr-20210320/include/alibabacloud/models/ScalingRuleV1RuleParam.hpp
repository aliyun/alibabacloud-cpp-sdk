...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->comparisonOperator_ == nullptr
        && return this->evaluationCount_ == nullptr && return this->launchExpirationTime_ == nullptr && return this->launchTime_ == nullptr && return this->metricName_ == nullptr && return this->period_ == nullptr
        && return this->recurrenceEndTime_ == nullptr && return this->recurrenceType_ == nullptr && return this->recurrenceValue_ == nullptr && return this->statistics_ == nullptr && return this->threshold_ == nullptr; };
