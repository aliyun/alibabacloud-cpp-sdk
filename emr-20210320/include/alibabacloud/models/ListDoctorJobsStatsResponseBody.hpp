...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDoctorJobsStatsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListDoctorJobsStatsResponseBodyData>) };
    inline vector<ListDoctorJobsStatsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListDoctorJobsStatsResponseBodyData>) };
    inline ListDoctorJobsStatsResponseBody& setData(const vector<ListDoctorJobsStatsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDoctorJobsStatsResponseBody& setData(vector<ListDoctorJobsStatsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListDoctorJobsStatsResponseBodyData>> data_ = nullptr;
