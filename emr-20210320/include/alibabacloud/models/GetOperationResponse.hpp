...
namespace Models
{
  ...
  public:
    ...
    inline const GetOperationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOperationResponseBody) };
    inline GetOperationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOperationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOperationResponseBody> body_ {};
  };
