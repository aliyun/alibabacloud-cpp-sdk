...
namespace Models
{
  ...
  public:
    ...
    inline const ListDoctorHDFSUGIResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDoctorHDFSUGIResponseBody) };
    inline ListDoctorHDFSUGIResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDoctorHDFSUGIResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDoctorHDFSUGIResponseBody> body_ {};
  };
