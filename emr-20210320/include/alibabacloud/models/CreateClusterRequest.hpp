...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->applicationConfigs_ != nullptr
        ...
        && this->paymentType_ != nullptr && this->regionId_ != nullptr && this->releaseVersion_ != nullptr && this->resourceGroupId_ != nullptr && this->securityMode_ != nullptr
        && this->subscriptionConfig_ != nullptr && this->tags_ != nullptr; };
