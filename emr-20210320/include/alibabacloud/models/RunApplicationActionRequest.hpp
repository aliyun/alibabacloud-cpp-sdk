...
namespace Models
{
  ...
  public:
    ...
    inline const ComponentInstanceSelector & getComponentInstanceSelector() const { DARABONBA_PTR_GET_CONST(componentInstanceSelector_, ComponentInstanceSelector) };
    inline ComponentInstanceSelector getComponentInstanceSelector() { DARABONBA_PTR_GET(componentInstanceSelector_, ComponentInstanceSelector) };
    ...
    inline string getExecuteStrategy() const { DARABONBA_PTR_GET_DEFAULT(executeStrategy_, "") };
    ...
    inline bool getRollingExecute() const { DARABONBA_PTR_GET_DEFAULT(rollingExecute_, false) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<ComponentInstanceSelector> componentInstanceSelector_ {};
    ...
    shared_ptr<string> executeStrategy_ {};
    ...
    shared_ptr<bool> rollingExecute_ {};
  };
