...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activityType_ == nullptr
        && return this->adjustmentValue_ == nullptr && return this->metricsTrigger_ == nullptr && return this->ruleName_ == nullptr && return this->timeTrigger_ == nullptr && return this->triggerType_ == nullptr; };
