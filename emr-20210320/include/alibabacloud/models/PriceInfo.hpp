...
namespace Models
{
  ...
  public:
    ...
    inline const vector<PromotionInfo> & getPromotionResults() const { DARABONBA_PTR_GET_CONST(promotionResults_, vector<PromotionInfo>) };
    inline vector<PromotionInfo> getPromotionResults() { DARABONBA_PTR_GET(promotionResults_, vector<PromotionInfo>) };
    ...
    inline string getSpotInstanceTypeOriginalPrice() const { DARABONBA_PTR_GET_DEFAULT(spotInstanceTypeOriginalPrice_, "") };
    ...
    inline string getSpotInstanceTypePrice() const { DARABONBA_PTR_GET_DEFAULT(spotInstanceTypePrice_, "") };
    ...
    inline string getSpotOriginalPrice() const { DARABONBA_PTR_GET_DEFAULT(spotOriginalPrice_, "") };
    ...
    inline string getSpotPrice() const { DARABONBA_PTR_GET_DEFAULT(spotPrice_, "") };
    ...
    inline string getTaxPrice() const { DARABONBA_PTR_GET_DEFAULT(taxPrice_, "") };
  ...
  protected:
    ...
    shared_ptr<vector<PromotionInfo>> promotionResults_ {};
    shared_ptr<string> resourceType_ {};
    shared_ptr<string> spotInstanceTypeOriginalPrice_ {};
    shared_ptr<string> spotInstanceTypePrice_ {};
    shared_ptr<string> spotOriginalPrice_ {};
    shared_ptr<string> spotPrice_ {};
    shared_ptr<string> taxPrice_ {};
