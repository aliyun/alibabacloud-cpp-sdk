...
#ifndef ALIBABACLOUD_MODELS_LISTDOCTORJOBSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTDOCTORJOBSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDoctorJobsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDoctorJobsResponseBody& obj) { 
    ...
    ListDoctorJobsResponseBody() = default ;
    ListDoctorJobsResponseBody(const ListDoctorJobsResponseBody &) = default ;
    ListDoctorJobsResponseBody(ListDoctorJobsResponseBody &&) = default ;
    ListDoctorJobsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDoctorJobsResponseBody() = default ;
    ListDoctorJobsResponseBody& operator=(const ListDoctorJobsResponseBody &) = default ;
    ListDoctorJobsResponseBody& operator=(ListDoctorJobsResponseBody &&) = default ;
    ...
    inline const vector<ListDoctorJobsResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListDoctorJobsResponseBody::Data>) };
    inline vector<ListDoctorJobsResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListDoctorJobsResponseBody::Data>) };
    inline ListDoctorJobsResponseBody& setData(const vector<ListDoctorJobsResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDoctorJobsResponseBody& setData(vector<ListDoctorJobsResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListDoctorJobsResponseBody& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline ListDoctorJobsResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ListDoctorJobsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListDoctorJobsResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };


  protected:
    // The information about the jobs.
    shared_ptr<vector<ListDoctorJobsResponseBody::Data>> data_ {};
