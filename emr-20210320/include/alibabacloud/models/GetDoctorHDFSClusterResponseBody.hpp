...
#ifndef ALIBABACLOUD_MODELS_GETDOCTORHDFSCLUSTERRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETDOCTORHDFSCLUSTERRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetDoctorHDFSClusterResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetDoctorHDFSClusterResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    GetDoctorHDFSClusterResponseBody() = default ;
    GetDoctorHDFSClusterResponseBody(const GetDoctorHDFSClusterResponseBody &) = default ;
    GetDoctorHDFSClusterResponseBody(GetDoctorHDFSClusterResponseBody &&) = default ;
    GetDoctorHDFSClusterResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDoctorHDFSClusterResponseBody() = default ;
    GetDoctorHDFSClusterResponseBody& operator=(const GetDoctorHDFSClusterResponseBody &) = default ;
    GetDoctorHDFSClusterResponseBody& operator=(GetDoctorHDFSClusterResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->mediumFileCountDayGrowthRatio_ == nullptr && this->mediumFileDayGrowthCount_ == nullptr && this->mediumFileRatio_ == nullptr && this->smallFileCount_ == nullptr && this->smallFileCountDayGrowthRatio_ == nullptr
        && this->smallFileDayGrowthCount_ == nullptr && this->smallFileRatio_ == nullptr && this->tinyFileCount_ == nullptr && this->tinyFileCountDayGrowthRatio_ == nullptr && this->tinyFileDayGrowthCount_ == nullptr
        && this->tinyFileRatio_ == nullptr && this->totalDataDayGrowthSize_ == nullptr && this->totalDataSize_ == nullptr && this->totalDataSizeDayGrowthRatio_ == nullptr && this->totalFileCount_ == nullptr
        && this->totalFileCountDayGrowthRatio_ == nullptr && this->totalFileDayGrowthCount_ == nullptr && this->warmDataDayGrowthSize_ == nullptr && this->warmDataRatio_ == nullptr && this->warmDataSize_ == nullptr
        && this->warmDataSizeDayGrowthRatio_ == nullptr; };
      ...
      public:
        ...
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        virtual bool empty() const override { return this->hdfsScore_ == nullptr; };
        ...
        inline int32_t getHdfsScore() const { DARABONBA_PTR_GET_DEFAULT(hdfsScore_, 0) };
        inline Analysis& setHdfsScore(int32_t hdfsScore) { DARABONBA_PTR_SET_VALUE(hdfsScore_, hdfsScore) };


      protected:
        // The overall score of HDFS storage resources.
        shared_ptr<int32_t> hdfsScore_ {};
      };
    ...
    inline const GetDoctorHDFSClusterResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetDoctorHDFSClusterResponseBody::Data) };
    inline GetDoctorHDFSClusterResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetDoctorHDFSClusterResponseBody::Data) };
    inline GetDoctorHDFSClusterResponseBody& setData(const GetDoctorHDFSClusterResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDoctorHDFSClusterResponseBody& setData(GetDoctorHDFSClusterResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetDoctorHDFSClusterResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The HDFS analysis results.
    shared_ptr<GetDoctorHDFSClusterResponseBody::Data> data_ {};
    // The request ID.
