...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateClusterAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateClusterAttributeResponseBody) };
    inline UpdateClusterAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateClusterAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateClusterAttributeResponseBody> body_ {};
  };
