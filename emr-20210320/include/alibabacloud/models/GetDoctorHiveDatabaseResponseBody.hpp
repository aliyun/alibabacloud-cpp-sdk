...
namespace Models
{
  ...
  public:
    ...
    inline const GetDoctorHiveDatabaseResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetDoctorHiveDatabaseResponseBody::Data) };
    inline GetDoctorHiveDatabaseResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetDoctorHiveDatabaseResponseBody::Data) };
    inline GetDoctorHiveDatabaseResponseBody& setData(const GetDoctorHiveDatabaseResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDoctorHiveDatabaseResponseBody& setData(GetDoctorHiveDatabaseResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<GetDoctorHiveDatabaseResponseBody::Data> data_ {};
    // The request ID.
