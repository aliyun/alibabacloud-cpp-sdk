...
namespace Models
{
  ...
  public:
    ...
    inline const ListApiTemplatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApiTemplatesResponseBody) };
    inline ListApiTemplatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApiTemplatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApiTemplatesResponseBody> body_ {};
  };
