...
#include <alibabacloud/milvus_20231012.hpp>
...
using namespace Alibabacloud_Milvus20231012;

Alibabacloud_Milvus20231012::Client::Client(const shared_ptr<Alibabacloud_OpenApi::Config>& config) : Alibabacloud_OpenApi::Client(config) {
  _endpointRule = make_shared<string>("");
  checkConfig(config);
  _endpoint = make_shared<string>(getEndpoint(make_shared<string>("milvus"), _regionId, _endpointRule, _network, _suffix, _endpointMap, _endpoint));
};

string Alibabacloud_Milvus20231012::Client::getEndpoint(shared_ptr<string> productId,
...
DescribeAccessControlListResponse Alibabacloud_Milvus20231012::Client::describeAccessControlListWithOptions(shared_ptr<DescribeAccessControlListRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("DescribeAccessControlList"))},
    {"version", boost::any(string("2023-10-12"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/webapi/milvus/describe_access_control_list"))},
    {"method", boost::any(string("POST"))},
    {"authType", boost::any(string("AK"))},
    {"style", boost::any(string("ROA"))},
    {"reqBodyType", boost::any(string("json"))},
...
DescribeInstanceConfigsResponse Alibabacloud_Milvus20231012::Client::describeInstanceConfigsWithOptions(shared_ptr<DescribeInstanceConfigsRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<string>(request->instanceId)) {
    query->insert(pair<string, string>("InstanceId", *request->instanceId));
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("DescribeInstanceConfigs"))},
    {"version", boost::any(string("2023-10-12"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/webapi/config/describe_milvus_user_config"))},
    {"method", boost::any(string("POST"))},
    {"authType", boost::any(string("AK"))},
    {"style", boost::any(string("ROA"))},
    {"reqBodyType", boost::any(string("json"))},
...
GetInstanceDetailResponse Alibabacloud_Milvus20231012::Client::getInstanceDetailWithOptions(shared_ptr<GetInstanceDetailRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<string>(request->instanceId)) {
    query->insert(pair<string, string>("InstanceId", *request->instanceId));
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("GetInstanceDetail"))},
    {"version", boost::any(string("2023-10-12"))},
    {"protocol", boost::any(string("HTTPS"))},
...
ModifyInstanceConfigResponse Alibabacloud_Milvus20231012::Client::modifyInstanceConfigWithOptions(shared_ptr<ModifyInstanceConfigRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<string>(request->instanceId)) {
    query->insert(pair<string, string>("InstanceId", *request->instanceId));
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("ModifyInstanceConfig"))},
    {"version", boost::any(string("2023-10-12"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/webapi/config/modify_milvus_config"))},
    {"method", boost::any(string("POST"))},
    {"authType", boost::any(string("AK"))},
    {"style", boost::any(string("ROA"))},
    {"reqBodyType", boost::any(string("json"))},
...
UpdateAccessControlListResponse Alibabacloud_Milvus20231012::Client::updateAccessControlListWithOptions(shared_ptr<UpdateAccessControlListRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("UpdateAccessControlList"))},
    {"version", boost::any(string("2023-10-12"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/webapi/milvus/update_access_control_list"))},
    {"method", boost::any(string("POST"))},
    {"authType", boost::any(string("AK"))},
    {"style", boost::any(string("ROA"))},
    {"reqBodyType", boost::any(string("json"))},
...
UpdateInstanceNameResponse Alibabacloud_Milvus20231012::Client::updateInstanceNameWithOptions(shared_ptr<UpdateInstanceNameRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<string>(request->clusterName)) {
    query->insert(pair<string, string>("ClusterName", *request->clusterName));
...
UpdatePublicNetworkStatusResponse Alibabacloud_Milvus20231012::Client::updatePublicNetworkStatusWithOptions(shared_ptr<UpdatePublicNetworkStatusRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  if (!Darabonba_Util::Client::isUnset<bool>(request->publicNetworkEnabled)) {
    query->insert(pair<string, bool>("PublicNetworkEnabled", *request->publicNetworkEnabled));
  }
  shared_ptr<Alibabacloud_OpenApi::OpenApiRequest> req = make_shared<Alibabacloud_OpenApi::OpenApiRequest>(map<string, boost::any>({
    {"headers", !headers ? boost::any() : boost::any(*headers)},
    {"query", boost::any(Alibabacloud_OpenApiUtil::Client::query(query))}
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("UpdatePublicNetworkStatus"))},
    {"version", boost::any(string("2023-10-12"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/webapi/network/updatePublicNetworkStatus"))},
    {"method", boost::any(string("POST"))},
    {"authType", boost::any(string("AK"))},
    {"style", boost::any(string("ROA"))},
    {"reqBodyType", boost::any(string("json"))},
