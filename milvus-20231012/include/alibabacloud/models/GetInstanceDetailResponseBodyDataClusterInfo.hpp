...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->attuPort_ == nullptr
        && return this->internetUrl_ == nullptr && return this->intranetUrl_ == nullptr && return this->milvusResourceInfoList_ == nullptr && return this->ossStorageSize_ == nullptr && return this->ossStorageTimestamp_ == nullptr
        && return this->proxyPort_ == nullptr && return this->totalCuNum_ == nullptr && return this->totalDiskSize_ == nullptr; };
