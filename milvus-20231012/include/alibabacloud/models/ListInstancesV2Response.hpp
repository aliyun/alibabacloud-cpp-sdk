...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstancesV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstancesV2ResponseBody) };
    inline ListInstancesV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInstancesV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInstancesV2ResponseBody> body_ {};
  };
