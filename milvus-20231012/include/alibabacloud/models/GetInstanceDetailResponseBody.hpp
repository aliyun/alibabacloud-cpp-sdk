...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetInstanceDetailResponseBodyData) };
    inline GetInstanceDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetInstanceDetailResponseBodyData) };
    inline GetInstanceDetailResponseBody& setData(const GetInstanceDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetInstanceDetailResponseBody& setData(GetInstanceDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<GetInstanceDetailResponseBodyData> data_ = nullptr;
