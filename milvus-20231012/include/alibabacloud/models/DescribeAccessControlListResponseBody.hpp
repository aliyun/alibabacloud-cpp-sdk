...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAccessControlListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeAccessControlListResponseBodyData) };
    inline DescribeAccessControlListResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeAccessControlListResponseBodyData) };
    inline DescribeAccessControlListResponseBody& setData(const DescribeAccessControlListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAccessControlListResponseBody& setData(DescribeAccessControlListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<DescribeAccessControlListResponseBodyData> data_ = nullptr;
    // The error message.
