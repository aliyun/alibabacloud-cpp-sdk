...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDefaultRoleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDefaultRoleResponseBody) };
    inline CreateDefaultRoleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDefaultRoleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDefaultRoleResponseBody> body_ {};
  };
