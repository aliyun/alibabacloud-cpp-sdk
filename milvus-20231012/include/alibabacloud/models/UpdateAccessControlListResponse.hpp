...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAccessControlListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAccessControlListResponseBody) };
    inline UpdateAccessControlListResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAccessControlListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAccessControlListResponseBody> body_ {};
  };
