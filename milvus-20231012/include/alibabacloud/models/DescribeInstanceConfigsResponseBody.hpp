...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessDeniedDetail_ == nullptr
        && this->data_.empty() && this->errCode_ == nullptr && this->errMessage_ == nullptr && this->httpStatusCode_ == nullptr && this->requestId_ == nullptr
    ...
    bool hasData() const { return !this->data_.empty();};
    void deleteData() { this->data_.clear();};
    inline Darabonba::Bytes getData() const { DARABONBA_GET(data_) };
    inline DescribeInstanceConfigsResponseBody& setData(Darabonba::Bytes data) { DARABONBA_SET_VALUE(data_, data) };
