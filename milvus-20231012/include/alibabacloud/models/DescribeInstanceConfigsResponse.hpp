...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceConfigsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceConfigsResponseBody) };
    inline DescribeInstanceConfigsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceConfigsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceConfigsResponseBody> body_ {};
  };
