...
namespace Models
{
  ...
  public:
    ...
    inline const CreateFlowAliasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateFlowAliasResponseBody) };
    inline CreateFlowAliasResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateFlowAliasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateFlowAliasResponseBody> body_ {};
  };
