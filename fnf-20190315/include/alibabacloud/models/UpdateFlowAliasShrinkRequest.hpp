...
#ifndef ALIBABACLOUD_MODELS_UPDATEFLOWALIASSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEFLOWALIASSHRINKREQUEST_HPP_
...
namespace Models
{
  class UpdateFlowAliasShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateFlowAliasShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(Description, description_);
      DARABONBA_PTR_TO_JSON(FlowName, flowName_);
      DARABONBA_PTR_TO_JSON(Name, name_);
      DARABONBA_PTR_TO_JSON(RoutingConfigurations, routingConfigurationsShrink_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateFlowAliasShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(Description, description_);
      DARABONBA_PTR_FROM_JSON(FlowName, flowName_);
      DARABONBA_PTR_FROM_JSON(Name, name_);
      DARABONBA_PTR_FROM_JSON(RoutingConfigurations, routingConfigurationsShrink_);
    };
    UpdateFlowAliasShrinkRequest() = default ;
    UpdateFlowAliasShrinkRequest(const UpdateFlowAliasShrinkRequest &) = default ;
    UpdateFlowAliasShrinkRequest(UpdateFlowAliasShrinkRequest &&) = default ;
    UpdateFlowAliasShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateFlowAliasShrinkRequest() = default ;
    UpdateFlowAliasShrinkRequest& operator=(const UpdateFlowAliasShrinkRequest &) = default ;
    UpdateFlowAliasShrinkRequest& operator=(UpdateFlowAliasShrinkRequest &&) = default ;
