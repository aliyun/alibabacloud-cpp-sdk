...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->definition_ == nullptr
        && this->description_ == nullptr && this->environmentShrink_ == nullptr && this->executionMode_ == nullptr && this->externalStorageLocation_ == nullptr && this->name_ == nullptr
    ...
    inline string getEnvironmentShrink() const { DARABONBA_PTR_GET_DEFAULT(environmentShrink_, "") };
    ...
    inline CreateFlowShrinkRequest& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
  ...
  protected:
    ...
    shared_ptr<string> environmentShrink_ {};
