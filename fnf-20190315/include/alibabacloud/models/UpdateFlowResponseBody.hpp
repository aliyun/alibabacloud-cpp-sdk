...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->createdTime_ == nullptr
        && this->definition_ == nullptr && this->description_ == nullptr && this->environment_ == nullptr && this->externalStorageLocation_ == nullptr && this->id_ == nullptr
    ...
    inline const UpdateFlowResponseBody::Environment & getEnvironment() const { DARABONBA_PTR_GET_CONST(environment_, UpdateFlowResponseBody::Environment) };
    inline UpdateFlowResponseBody::Environment getEnvironment() { DARABONBA_PTR_GET(environment_, UpdateFlowResponseBody::Environment) };
    inline UpdateFlowResponseBody& setEnvironment(const UpdateFlowResponseBody::Environment & environment) { DARABONBA_PTR_SET_VALUE(environment_, environment) };
    inline UpdateFlowResponseBody& setEnvironment(UpdateFlowResponseBody::Environment && environment) { DARABONBA_PTR_SET_RVALUE(environment_, environment) };
    ...
    inline UpdateFlowResponseBody& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
  ...
  protected:
    ...
    shared_ptr<string> description_ {};
    shared_ptr<UpdateFlowResponseBody::Environment> environment_ {};
