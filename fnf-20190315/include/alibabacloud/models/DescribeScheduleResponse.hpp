...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeScheduleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeScheduleResponseBody) };
    inline DescribeScheduleResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeScheduleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeScheduleResponseBody> body_ {};
  };
