...
namespace Models
{
  ...
  public:
    ...
    inline const CreateFlowResponseBody::Environment & getEnvironment() const { DARABONBA_PTR_GET_CONST(environment_, CreateFlowResponseBody::Environment) };
    inline CreateFlowResponseBody::Environment getEnvironment() { DARABONBA_PTR_GET(environment_, CreateFlowResponseBody::Environment) };
    inline CreateFlowResponseBody& setEnvironment(const CreateFlowResponseBody::Environment & environment) { DARABONBA_PTR_SET_VALUE(environment_, environment) };
    inline CreateFlowResponseBody& setEnvironment(CreateFlowResponseBody::Environment && environment) { DARABONBA_PTR_SET_RVALUE(environment_, environment) };
    ...
    inline CreateFlowResponseBody& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
  ...
  protected:
    ...
    shared_ptr<string> description_ {};
    shared_ptr<CreateFlowResponseBody::Environment> environment_ {};
