...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeFlowAliasResponseBody::Alias & getAlias() const { DARABONBA_PTR_GET_CONST(alias_, DescribeFlowAliasResponseBody::Alias) };
    inline DescribeFlowAliasResponseBody::Alias getAlias() { DARABONBA_PTR_GET(alias_, DescribeFlowAliasResponseBody::Alias) };
    inline DescribeFlowAliasResponseBody& setAlias(const DescribeFlowAliasResponseBody::Alias & alias) { DARABONBA_PTR_SET_VALUE(alias_, alias) };
    inline DescribeFlowAliasResponseBody& setAlias(DescribeFlowAliasResponseBody::Alias && alias) { DARABONBA_PTR_SET_RVALUE(alias_, alias) };
  ...
  protected:
    shared_ptr<DescribeFlowAliasResponseBody::Alias> alias_ {};
    // Id of the request
