...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeFlowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeFlowResponseBody) };
    inline DescribeFlowResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeFlowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeFlowResponseBody> body_ {};
  };
