...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateScheduleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateScheduleResponseBody) };
    inline UpdateScheduleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateScheduleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateScheduleResponseBody> body_ {};
  };
