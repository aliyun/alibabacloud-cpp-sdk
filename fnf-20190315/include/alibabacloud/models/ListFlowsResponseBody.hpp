  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->createdTime_ == nullptr
        ...
        && this->lastModifiedTime_ == nullptr && this->name_ == nullptr && this->resourceGroupId_ == nullptr && this->roleArn_ == nullptr && this->type_ == nullptr; };
      // createdTime Field Functions 
      bool hasCreatedTime() const { return this->createdTime_ != nullptr;};
      void deleteCreatedTime() { this->createdTime_ = nullptr;};
      inline string getCreatedTime() const { DARABONBA_PTR_GET_DEFAULT(createdTime_, "") };
      inline Flows& setCreatedTime(string createdTime) { DARABONBA_PTR_SET_VALUE(createdTime_, createdTime) };
      ...
      inline Flows& setDefinition(string definition) { DARABONBA_PTR_SET_VALUE(definition_, definition) };
      ...
      void deleteDescription() { this->description_ = nullptr;};
      inline string getDescription() const { DARABONBA_PTR_GET_DEFAULT(description_, "") };
      inline Flows& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };


      // environment Field Functions 
      bool hasEnvironment() const { return this->environment_ != nullptr;};
      void deleteEnvironment() { this->environment_ = nullptr;};
      inline const Flows::Environment & getEnvironment() const { DARABONBA_PTR_GET_CONST(environment_, Flows::Environment) };
      inline Flows::Environment getEnvironment() { DARABONBA_PTR_GET(environment_, Flows::Environment) };
      inline Flows& setEnvironment(const Flows::Environment & environment) { DARABONBA_PTR_SET_VALUE(environment_, environment) };
      inline Flows& setEnvironment(Flows::Environment && environment) { DARABONBA_PTR_SET_RVALUE(environment_, environment) };
      ...
      inline Flows& setExecutionMode(string executionMode) { DARABONBA_PTR_SET_VALUE(executionMode_, executionMode) };
      ...
      inline Flows& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
      ...
      inline Flows& setLastModifiedTime(string lastModifiedTime) { DARABONBA_PTR_SET_VALUE(lastModifiedTime_, lastModifiedTime) };
      ...
      void deleteName() { this->name_ = nullptr;};
      inline string getName() const { DARABONBA_PTR_GET_DEFAULT(name_, "") };
      inline Flows& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
      ...
      inline Flows& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
      ...
      inline Flows& setRoleArn(string roleArn) { DARABONBA_PTR_SET_VALUE(roleArn_, roleArn) };
      ...
      inline Flows& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    protected:
      ...
      shared_ptr<string> description_ {};
      shared_ptr<Flows::Environment> environment_ {};
