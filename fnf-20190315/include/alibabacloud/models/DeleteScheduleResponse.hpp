...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteScheduleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteScheduleResponseBody) };
    inline DeleteScheduleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteScheduleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteScheduleResponseBody> body_ {};
  };
