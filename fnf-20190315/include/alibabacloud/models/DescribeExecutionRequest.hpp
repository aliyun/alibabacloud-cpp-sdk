...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->executionName_ == nullptr
        && this->flowName_ == nullptr && this->waitTimeSeconds_ == nullptr; };
    ...
    inline int32_t getWaitTimeSeconds() const { DARABONBA_PTR_GET_DEFAULT(waitTimeSeconds_, 0) };
  ...
  protected:
    ...
    shared_ptr<int32_t> waitTimeSeconds_ {};
  };
