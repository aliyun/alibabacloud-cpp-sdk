...
namespace Models
{
  ...
  public:
    ...
    inline const ReportTaskFailedResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReportTaskFailedResponseBody) };
    inline ReportTaskFailedResponseBody getBody() { DARABONBA_PTR_GET(body_, ReportTaskFailedResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReportTaskFailedResponseBody> body_ {};
  };
