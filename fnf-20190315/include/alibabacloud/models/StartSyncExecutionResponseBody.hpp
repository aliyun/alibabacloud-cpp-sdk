...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->environment_ == nullptr
        && return this->errorCode_ == nullptr && return this->errorMessage_ == nullptr && return this->flowName_ == nullptr && return this->name_ == nullptr && return this->output_ == nullptr
    ...
    inline const StartSyncExecutionResponseBodyEnvironment & environment() const { DARABONBA_PTR_GET_CONST(environment_, StartSyncExecutionResponseBodyEnvironment) };
    inline StartSyncExecutionResponseBodyEnvironment environment() { DARABONBA_PTR_GET(environment_, StartSyncExecutionResponseBodyEnvironment) };
    inline StartSyncExecutionResponseBody& setEnvironment(const StartSyncExecutionResponseBodyEnvironment & environment) { DARABONBA_PTR_SET_VALUE(environment_, environment) };
    inline StartSyncExecutionResponseBody& setEnvironment(StartSyncExecutionResponseBodyEnvironment && environment) { DARABONBA_PTR_SET_RVALUE(environment_, environment) };
  ...
  protected:
    std::shared_ptr<StartSyncExecutionResponseBodyEnvironment> environment_ = nullptr;
