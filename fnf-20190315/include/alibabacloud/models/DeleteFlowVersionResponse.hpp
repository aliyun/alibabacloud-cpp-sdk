...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteFlowVersionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteFlowVersionResponseBody) };
    inline DeleteFlowVersionResponseBody body() { DARABONBA_PTR_GET(body_, DeleteFlowVersionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteFlowVersionResponseBody> body_ = nullptr;
  };
