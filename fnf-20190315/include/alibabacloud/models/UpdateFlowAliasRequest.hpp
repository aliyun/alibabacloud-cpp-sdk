...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateFlowAliasRequest::RoutingConfigurations> & getRoutingConfigurations() const { DARABONBA_PTR_GET_CONST(routingConfigurations_, vector<UpdateFlowAliasRequest::RoutingConfigurations>) };
    inline vector<UpdateFlowAliasRequest::RoutingConfigurations> getRoutingConfigurations() { DARABONBA_PTR_GET(routingConfigurations_, vector<UpdateFlowAliasRequest::RoutingConfigurations>) };
    inline UpdateFlowAliasRequest& setRoutingConfigurations(const vector<UpdateFlowAliasRequest::RoutingConfigurations> & routingConfigurations) { DARABONBA_PTR_SET_VALUE(routingConfigurations_, routingConfigurations) };
    inline UpdateFlowAliasRequest& setRoutingConfigurations(vector<UpdateFlowAliasRequest::RoutingConfigurations> && routingConfigurations) { DARABONBA_PTR_SET_RVALUE(routingConfigurations_, routingConfigurations) };
  ...
  protected:
    ...
    shared_ptr<vector<UpdateFlowAliasRequest::RoutingConfigurations>> routingConfigurations_ {};
  };
