...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFlowAliasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateFlowAliasResponseBody) };
    inline UpdateFlowAliasResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateFlowAliasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateFlowAliasResponseBody> body_ {};
  };
