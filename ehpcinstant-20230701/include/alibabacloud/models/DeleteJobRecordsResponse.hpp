...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteJobRecordsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteJobRecordsResponseBody) };
    inline DeleteJobRecordsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteJobRecordsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteJobRecordsResponseBody> body_ {};
  };
