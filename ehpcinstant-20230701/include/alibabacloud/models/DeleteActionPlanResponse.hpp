...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteActionPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteActionPlanResponseBody) };
    inline DeleteActionPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteActionPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteActionPlanResponseBody> body_ {};
  };
