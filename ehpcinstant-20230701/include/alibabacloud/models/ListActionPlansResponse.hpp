...
namespace Models
{
  ...
  public:
    ...
    inline const ListActionPlansResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListActionPlansResponseBody) };
    inline ListActionPlansResponseBody body() { DARABONBA_PTR_GET(body_, ListActionPlansResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListActionPlansResponseBody> body_ = nullptr;
  };
