...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteJobsResponseBody) };
    inline DeleteJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteJobsResponseBody> body_ {};
  };
