...
namespace Models
{
  ...
  public:
    ...
    inline const CreateActionPlanResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateActionPlanResponseBody) };
    inline CreateActionPlanResponseBody body() { DARABONBA_PTR_GET(body_, CreateActionPlanResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateActionPlanResponseBody> body_ = nullptr;
  };
