...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateActionPlanResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateActionPlanResponseBody) };
    inline UpdateActionPlanResponseBody body() { DARABONBA_PTR_GET(body_, UpdateActionPlanResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateActionPlanResponseBody> body_ = nullptr;
  };
