...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePoolResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePoolResponseBody) };
    inline CreatePoolResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePoolResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePoolResponseBody> body_ {};
  };
