...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeJobMetricDataResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeJobMetricDataResponseBody) };
    inline DescribeJobMetricDataResponseBody body() { DARABONBA_PTR_GET(body_, DescribeJobMetricDataResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeJobMetricDataResponseBody> body_ = nullptr;
  };
