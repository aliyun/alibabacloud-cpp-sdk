...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdatePoolRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdatePoolRequest& obj) { 
    ...
    UpdatePoolRequest(const UpdatePoolRequest &) = default ;
    UpdatePoolRequest(UpdatePoolRequest &&) = default ;
    UpdatePoolRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdatePoolRequest() = default ;
    UpdatePoolRequest& operator=(const UpdatePoolRequest &) = default ;
    UpdatePoolRequest& operator=(UpdatePoolRequest &&) = default ;
    ...
    inline UpdatePoolRequest& setSchedulingPolicyId(string schedulingPolicyId) { DARABONBA_PTR_SET_VALUE(schedulingPolicyId_, schedulingPolicyId) };
