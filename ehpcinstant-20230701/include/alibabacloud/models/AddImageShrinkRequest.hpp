...
namespace Models
{
  ...
  public:
    ...
    inline string getContainerImageSpecShrink() const { DARABONBA_PTR_GET_DEFAULT(containerImageSpecShrink_, "") };
    ...
    inline string getVMImageSpecShrink() const { DARABONBA_PTR_GET_DEFAULT(VMImageSpecShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> containerImageSpecShrink_ {};
    ...
    shared_ptr<string> VMImageSpecShrink_ {};
  };
