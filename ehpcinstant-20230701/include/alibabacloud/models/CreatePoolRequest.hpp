...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePoolRequestResourceLimits & resourceLimits() const { DARABONBA_PTR_GET_CONST(resourceLimits_, CreatePoolRequestResourceLimits) };
    inline CreatePoolRequestResourceLimits resourceLimits() { DARABONBA_PTR_GET(resourceLimits_, CreatePoolRequestResourceLimits) };
    inline CreatePoolRequest& setResourceLimits(const CreatePoolRequestResourceLimits & resourceLimits) { DARABONBA_PTR_SET_VALUE(resourceLimits_, resourceLimits) };
    inline CreatePoolRequest& setResourceLimits(CreatePoolRequestResourceLimits && resourceLimits) { DARABONBA_PTR_SET_RVALUE(resourceLimits_, resourceLimits) };
  ...
  protected:
    ...
    std::shared_ptr<CreatePoolRequestResourceLimits> resourceLimits_ = nullptr;
  };
