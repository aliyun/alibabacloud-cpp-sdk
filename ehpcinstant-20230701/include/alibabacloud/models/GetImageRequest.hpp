...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getAdditionalRegionIds() const { DARABONBA_PTR_GET_CONST(additionalRegionIds_, vector<string>) };
    inline vector<string> getAdditionalRegionIds() { DARABONBA_PTR_GET(additionalRegionIds_, vector<string>) };
  ...
  protected:
    shared_ptr<vector<string>> additionalRegionIds_ {};
