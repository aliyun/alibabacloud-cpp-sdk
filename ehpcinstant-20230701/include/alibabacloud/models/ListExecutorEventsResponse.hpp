...
namespace Models
{
  ...
  public:
    ...
    inline const ListExecutorEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListExecutorEventsResponseBody) };
    inline ListExecutorEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListExecutorEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListExecutorEventsResponseBody> body_ {};
  };
