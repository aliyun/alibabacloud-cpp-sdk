...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClusterNodePoolsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeClusterNodePoolsResponseBody) };
    inline DescribeClusterNodePoolsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeClusterNodePoolsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeClusterNodePoolsResponseBody> body_ = nullptr;
  };
