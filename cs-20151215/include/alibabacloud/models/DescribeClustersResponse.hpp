...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECLUSTERSRESPONSE_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECLUSTERSRESPONSE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeClustersResponse& obj) { 
      DARABONBA_PTR_TO_JSON(headers, headers_);
      DARABONBA_PTR_TO_JSON(statusCode, statusCode_);
      DARABONBA_PTR_TO_JSON(body, body_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeClustersResponse& obj) { 
      DARABONBA_PTR_FROM_JSON(headers, headers_);
      DARABONBA_PTR_FROM_JSON(statusCode, statusCode_);
      DARABONBA_PTR_FROM_JSON(body, body_);
    };
    DescribeClustersResponse() = default ;
    DescribeClustersResponse(const DescribeClustersResponse &) = default ;
    DescribeClustersResponse(DescribeClustersResponse &&) = default ;
    DescribeClustersResponse(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeClustersResponse() = default ;
    DescribeClustersResponse& operator=(const DescribeClustersResponse &) = default ;
    DescribeClustersResponse& operator=(DescribeClustersResponse &&) = default ;
    ...
    public:
      ...
      inline Body& setClusterType(string clusterType) { DARABONBA_PTR_SET_VALUE(clusterType_, clusterType) };
      ...
      inline Body& setCurrentVersion(string currentVersion) { DARABONBA_PTR_SET_VALUE(currentVersion_, currentVersion) };
      ...
      inline Body& setDataDiskCategory(string dataDiskCategory) { DARABONBA_PTR_SET_VALUE(dataDiskCategory_, dataDiskCategory) };
      ...
      inline Body& setDataDiskSize(int64_t dataDiskSize) { DARABONBA_PTR_SET_VALUE(dataDiskSize_, dataDiskSize) };
      ...
      inline Body& setDeletionProtection(bool deletionProtection) { DARABONBA_PTR_SET_VALUE(deletionProtection_, deletionProtection) };
      ...
      inline Body& setDockerVersion(string dockerVersion) { DARABONBA_PTR_SET_VALUE(dockerVersion_, dockerVersion) };
      ...
      inline Body& setExternalLoadbalancerId(string externalLoadbalancerId) { DARABONBA_PTR_SET_VALUE(externalLoadbalancerId_, externalLoadbalancerId) };
      ...
      inline Body& setInitVersion(string initVersion) { DARABONBA_PTR_SET_VALUE(initVersion_, initVersion) };
      ...
      inline Body& setMasterUrl(string masterUrl) { DARABONBA_PTR_SET_VALUE(masterUrl_, masterUrl) };
      ...
      inline Body& setNetworkMode(string networkMode) { DARABONBA_PTR_SET_VALUE(networkMode_, networkMode) };
      ...
      inline Body& setPrivateZone(bool privateZone) { DARABONBA_PTR_SET_VALUE(privateZone_, privateZone) };
      ...
      inline Body& setProfile(string profile) { DARABONBA_PTR_SET_VALUE(profile_, profile) };
      ...
      inline Body& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
      ...
      inline Body& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
      ...
      inline Body& setSecurityGroupId(string securityGroupId) { DARABONBA_PTR_SET_VALUE(securityGroupId_, securityGroupId) };
      ...
      inline Body& setSize(int64_t size) { DARABONBA_PTR_SET_VALUE(size_, size) };
      ...
      inline Body& setSubnetCidr(string subnetCidr) { DARABONBA_PTR_SET_VALUE(subnetCidr_, subnetCidr) };


      // tags Field Functions 
      bool hasTags() const { return this->tags_ != nullptr;};
      void deleteTags() { this->tags_ = nullptr;};
      inline const vector<Body::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<Body::Tags>) };
      inline vector<Body::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<Body::Tags>) };
      inline Body& setTags(const vector<Body::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
      inline Body& setTags(vector<Body::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
      ...
      inline Body& setVswitchCidr(string vswitchCidr) { DARABONBA_PTR_SET_VALUE(vswitchCidr_, vswitchCidr) };
      ...
      inline Body& setVswitchId(string vswitchId) { DARABONBA_PTR_SET_VALUE(vswitchId_, vswitchId) };
      ...
      inline Body& setWorkerRamRoleName(string workerRamRoleName) { DARABONBA_PTR_SET_VALUE(workerRamRoleName_, workerRamRoleName) };
    ...
    protected:
      ...
      shared_ptr<vector<Body::Tags>> tags_ {};
    ...
    inline DescribeClustersResponse& setHeaders(const map<string, string> & headers) { DARABONBA_PTR_SET_VALUE(headers_, headers) };
    inline DescribeClustersResponse& setHeaders(map<string, string> && headers) { DARABONBA_PTR_SET_RVALUE(headers_, headers) };
    ...
    inline DescribeClustersResponse& setStatusCode(int32_t statusCode) { DARABONBA_PTR_SET_VALUE(statusCode_, statusCode) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const vector<DescribeClustersResponse::Body> & getBody() const { DARABONBA_PTR_GET_CONST(body_, vector<DescribeClustersResponse::Body>) };
    inline vector<DescribeClustersResponse::Body> getBody() { DARABONBA_PTR_GET(body_, vector<DescribeClustersResponse::Body>) };
    inline DescribeClustersResponse& setBody(const vector<DescribeClustersResponse::Body> & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline DescribeClustersResponse& setBody(vector<DescribeClustersResponse::Body> && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<map<string, string>> headers_ {};
    shared_ptr<int32_t> statusCode_ {};
    shared_ptr<vector<DescribeClustersResponse::Body>> body_ {};
  };
