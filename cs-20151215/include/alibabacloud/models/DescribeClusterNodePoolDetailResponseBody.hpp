...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->autoMode_ != nullptr
        ...
        && this->kubernetesConfig_ != nullptr && this->management_ != nullptr && this->maxNodes_ != nullptr && this->nodeConfig_ != nullptr && this->nodepoolInfo_ != nullptr
