...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEAUTOREPAIRPOLICYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEAUTOREPAIRPOLICYRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeAutoRepairPolicyResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeAutoRepairPolicyResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(id, id_);
      DARABONBA_PTR_TO_JSON(name, name_);
      DARABONBA_PTR_TO_JSON(resource_ids, resourceIds_);
      DARABONBA_PTR_TO_JSON(resource_sub_type, resourceSubType_);
      DARABONBA_PTR_TO_JSON(resource_type, resourceType_);
      DARABONBA_PTR_TO_JSON(rules, rules_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeAutoRepairPolicyResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(id, id_);
      DARABONBA_PTR_FROM_JSON(name, name_);
      DARABONBA_PTR_FROM_JSON(resource_ids, resourceIds_);
      DARABONBA_PTR_FROM_JSON(resource_sub_type, resourceSubType_);
      DARABONBA_PTR_FROM_JSON(resource_type, resourceType_);
      DARABONBA_PTR_FROM_JSON(rules, rules_);
    };
    DescribeAutoRepairPolicyResponseBody() = default ;
    DescribeAutoRepairPolicyResponseBody(const DescribeAutoRepairPolicyResponseBody &) = default ;
    DescribeAutoRepairPolicyResponseBody(DescribeAutoRepairPolicyResponseBody &&) = default ;
    DescribeAutoRepairPolicyResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeAutoRepairPolicyResponseBody() = default ;
    DescribeAutoRepairPolicyResponseBody& operator=(const DescribeAutoRepairPolicyResponseBody &) = default ;
    DescribeAutoRepairPolicyResponseBody& operator=(DescribeAutoRepairPolicyResponseBody &&) = default ;
    ...
    virtual bool empty() const override { return this->id_ == nullptr
        && this->name_ == nullptr && this->resourceIds_ == nullptr && this->resourceSubType_ == nullptr && this->resourceType_ == nullptr && this->rules_ == nullptr; };
    // id Field Functions 
    bool hasId() const { return this->id_ != nullptr;};
    void deleteId() { this->id_ = nullptr;};
    inline string getId() const { DARABONBA_PTR_GET_DEFAULT(id_, "") };
    inline DescribeAutoRepairPolicyResponseBody& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    void deleteName() { this->name_ = nullptr;};
    inline string getName() const { DARABONBA_PTR_GET_DEFAULT(name_, "") };
    inline DescribeAutoRepairPolicyResponseBody& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline DescribeAutoRepairPolicyResponseBody& setResourceIds(const vector<string> & resourceIds) { DARABONBA_PTR_SET_VALUE(resourceIds_, resourceIds) };
    inline DescribeAutoRepairPolicyResponseBody& setResourceIds(vector<string> && resourceIds) { DARABONBA_PTR_SET_RVALUE(resourceIds_, resourceIds) };


    // resourceSubType Field Functions 
    bool hasResourceSubType() const { return this->resourceSubType_ != nullptr;};
    void deleteResourceSubType() { this->resourceSubType_ = nullptr;};
    inline string getResourceSubType() const { DARABONBA_PTR_GET_DEFAULT(resourceSubType_, "") };
    inline DescribeAutoRepairPolicyResponseBody& setResourceSubType(string resourceSubType) { DARABONBA_PTR_SET_VALUE(resourceSubType_, resourceSubType) };
    ...
    inline DescribeAutoRepairPolicyResponseBody& setResourceType(string resourceType) { DARABONBA_PTR_SET_VALUE(resourceType_, resourceType) };


    // rules Field Functions 
    bool hasRules() const { return this->rules_ != nullptr;};
    void deleteRules() { this->rules_ = nullptr;};
    inline const vector<DescribeAutoRepairPolicyResponseBody::Rules> & getRules() const { DARABONBA_PTR_GET_CONST(rules_, vector<DescribeAutoRepairPolicyResponseBody::Rules>) };
    inline vector<DescribeAutoRepairPolicyResponseBody::Rules> getRules() { DARABONBA_PTR_GET(rules_, vector<DescribeAutoRepairPolicyResponseBody::Rules>) };
    inline DescribeAutoRepairPolicyResponseBody& setRules(const vector<DescribeAutoRepairPolicyResponseBody::Rules> & rules) { DARABONBA_PTR_SET_VALUE(rules_, rules) };
    inline DescribeAutoRepairPolicyResponseBody& setRules(vector<DescribeAutoRepairPolicyResponseBody::Rules> && rules) { DARABONBA_PTR_SET_RVALUE(rules_, rules) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeAutoRepairPolicyResponseBody::Rules>> rules_ {};
  };
