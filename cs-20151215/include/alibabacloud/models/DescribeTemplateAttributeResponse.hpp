...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeTemplateAttributeResponseBody> & body() const { DARABONBA_PTR_GET_CONST(body_, vector<DescribeTemplateAttributeResponseBody>) };
    inline vector<DescribeTemplateAttributeResponseBody> body() { DARABONBA_PTR_GET(body_, vector<DescribeTemplateAttributeResponseBody>) };
    inline DescribeTemplateAttributeResponse& setBody(const vector<DescribeTemplateAttributeResponseBody> & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline DescribeTemplateAttributeResponse& setBody(vector<DescribeTemplateAttributeResponseBody> && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<vector<DescribeTemplateAttributeResponseBody>> body_ = nullptr;
  };
