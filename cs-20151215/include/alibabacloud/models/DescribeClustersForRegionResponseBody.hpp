...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeClustersForRegionResponseBody::Clusters> & getClusters() const { DARABONBA_PTR_GET_CONST(clusters_, vector<DescribeClustersForRegionResponseBody::Clusters>) };
    inline vector<DescribeClustersForRegionResponseBody::Clusters> getClusters() { DARABONBA_PTR_GET(clusters_, vector<DescribeClustersForRegionResponseBody::Clusters>) };
    inline DescribeClustersForRegionResponseBody& setClusters(const vector<DescribeClustersForRegionResponseBody::Clusters> & clusters) { DARABONBA_PTR_SET_VALUE(clusters_, clusters) };
    inline DescribeClustersForRegionResponseBody& setClusters(vector<DescribeClustersForRegionResponseBody::Clusters> && clusters) { DARABONBA_PTR_SET_RVALUE(clusters_, clusters) };


    // pageInfo Field Functions 
    bool hasPageInfo() const { return this->pageInfo_ != nullptr;};
    void deletePageInfo() { this->pageInfo_ = nullptr;};
    inline const DescribeClustersForRegionResponseBody::PageInfo & getPageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, DescribeClustersForRegionResponseBody::PageInfo) };
    inline DescribeClustersForRegionResponseBody::PageInfo getPageInfo() { DARABONBA_PTR_GET(pageInfo_, DescribeClustersForRegionResponseBody::PageInfo) };
    inline DescribeClustersForRegionResponseBody& setPageInfo(const DescribeClustersForRegionResponseBody::PageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline DescribeClustersForRegionResponseBody& setPageInfo(DescribeClustersForRegionResponseBody::PageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
