...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveNodePoolNodesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveNodePoolNodesResponseBody) };
    inline RemoveNodePoolNodesResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveNodePoolNodesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveNodePoolNodesResponseBody> body_ {};
  };
