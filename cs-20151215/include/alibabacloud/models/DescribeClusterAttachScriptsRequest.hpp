...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->arch_ != nullptr
        && this->expired_ != nullptr && this->formatDisk_ != nullptr && this->keepInstanceName_ != nullptr && this->nodepoolId_ != nullptr && this->options_ != nullptr
        && this->rdsInstances_ != nullptr; };
