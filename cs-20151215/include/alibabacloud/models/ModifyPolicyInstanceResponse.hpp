...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyPolicyInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyPolicyInstanceResponseBody) };
    inline ModifyPolicyInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyPolicyInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyPolicyInstanceResponseBody> body_ {};
  };
