...
namespace Models
{
  ...
  public:
    ...
    inline const DeployPolicyInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeployPolicyInstanceResponseBody) };
    inline DeployPolicyInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeployPolicyInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeployPolicyInstanceResponseBody> body_ {};
  };
