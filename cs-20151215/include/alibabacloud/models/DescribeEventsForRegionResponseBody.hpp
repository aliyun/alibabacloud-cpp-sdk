...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeEventsForRegionResponseBody::Events> & getEvents() const { DARABONBA_PTR_GET_CONST(events_, vector<DescribeEventsForRegionResponseBody::Events>) };
    ...
    inline const DescribeEventsForRegionResponseBody::PageInfo & getPageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, DescribeEventsForRegionResponseBody::PageInfo) };
    inline DescribeEventsForRegionResponseBody::PageInfo getPageInfo() { DARABONBA_PTR_GET(pageInfo_, DescribeEventsForRegionResponseBody::PageInfo) };
    inline DescribeEventsForRegionResponseBody& setPageInfo(const DescribeEventsForRegionResponseBody::PageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline DescribeEventsForRegionResponseBody& setPageInfo(DescribeEventsForRegionResponseBody::PageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
