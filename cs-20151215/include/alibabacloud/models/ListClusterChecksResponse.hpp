...
namespace Models
{
  ...
  public:
    ...
    inline const ListClusterChecksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListClusterChecksResponseBody) };
    inline ListClusterChecksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListClusterChecksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListClusterChecksResponseBody> body_ {};
  };
