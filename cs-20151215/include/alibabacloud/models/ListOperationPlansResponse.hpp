...
namespace Models
{
  ...
  public:
    ...
    inline const ListOperationPlansResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOperationPlansResponseBody) };
    inline ListOperationPlansResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOperationPlansResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOperationPlansResponseBody> body_ {};
  };
