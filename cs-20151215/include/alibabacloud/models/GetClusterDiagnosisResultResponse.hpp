...
namespace Models
{
  ...
  public:
    ...
    inline const GetClusterDiagnosisResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetClusterDiagnosisResultResponseBody) };
    inline GetClusterDiagnosisResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetClusterDiagnosisResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetClusterDiagnosisResultResponseBody> body_ {};
  };
