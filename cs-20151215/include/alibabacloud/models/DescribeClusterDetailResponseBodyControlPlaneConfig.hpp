...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECLUSTERDETAILRESPONSEBODYCONTROLPLANECONFIG_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECLUSTERDETAILRESPONSEBODYCONTROLPLANECONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeClusterDetailResponseBodyControlPlaneConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeClusterDetailResponseBodyControlPlaneConfig& obj) { 
    ...
    DescribeClusterDetailResponseBodyControlPlaneConfig() = default ;
    DescribeClusterDetailResponseBodyControlPlaneConfig(const DescribeClusterDetailResponseBodyControlPlaneConfig &) = default ;
    DescribeClusterDetailResponseBodyControlPlaneConfig(DescribeClusterDetailResponseBodyControlPlaneConfig &&) = default ;
    DescribeClusterDetailResponseBodyControlPlaneConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeClusterDetailResponseBodyControlPlaneConfig() = default ;
    DescribeClusterDetailResponseBodyControlPlaneConfig& operator=(const DescribeClusterDetailResponseBodyControlPlaneConfig &) = default ;
    DescribeClusterDetailResponseBodyControlPlaneConfig& operator=(DescribeClusterDetailResponseBodyControlPlaneConfig &&) = default ;
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setAutoRenew(bool autoRenew) { DARABONBA_PTR_SET_VALUE(autoRenew_, autoRenew) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setAutoRenewPeriod(int64_t autoRenewPeriod) { DARABONBA_PTR_SET_VALUE(autoRenewPeriod_, autoRenewPeriod) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setChargeType(string chargeType) { DARABONBA_PTR_SET_VALUE(chargeType_, chargeType) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setCloudMonitorFlags(bool cloudMonitorFlags) { DARABONBA_PTR_SET_VALUE(cloudMonitorFlags_, cloudMonitorFlags) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setCpuPolicy(string cpuPolicy) { DARABONBA_PTR_SET_VALUE(cpuPolicy_, cpuPolicy) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setDeploymentsetId(string deploymentsetId) { DARABONBA_PTR_SET_VALUE(deploymentsetId_, deploymentsetId) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setImageId(string imageId) { DARABONBA_PTR_SET_VALUE(imageId_, imageId) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setImageType(string imageType) { DARABONBA_PTR_SET_VALUE(imageType_, imageType) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setInstanceMetadataOptions(const Models::InstanceMetadataOptions & instanceMetadataOptions) { DARABONBA_PTR_SET_VALUE(instanceMetadataOptions_, instanceMetadataOptions) };
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setInstanceMetadataOptions(Models::InstanceMetadataOptions && instanceMetadataOptions) { DARABONBA_PTR_SET_RVALUE(instanceMetadataOptions_, instanceMetadataOptions) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setInstanceTypes(const vector<string> & instanceTypes) { DARABONBA_PTR_SET_VALUE(instanceTypes_, instanceTypes) };
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setInstanceTypes(vector<string> && instanceTypes) { DARABONBA_PTR_SET_RVALUE(instanceTypes_, instanceTypes) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setKeyPair(string keyPair) { DARABONBA_PTR_SET_VALUE(keyPair_, keyPair) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setNodePortRange(string nodePortRange) { DARABONBA_PTR_SET_VALUE(nodePortRange_, nodePortRange) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setPeriod(int64_t period) { DARABONBA_PTR_SET_VALUE(period_, period) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setPeriodUnit(string periodUnit) { DARABONBA_PTR_SET_VALUE(periodUnit_, periodUnit) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setRuntime(string runtime) { DARABONBA_PTR_SET_VALUE(runtime_, runtime) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setSecurityHardeningOs(bool securityHardeningOs) { DARABONBA_PTR_SET_VALUE(securityHardeningOs_, securityHardeningOs) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setSize(int64_t size) { DARABONBA_PTR_SET_VALUE(size_, size) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setSocEnabled(bool socEnabled) { DARABONBA_PTR_SET_VALUE(socEnabled_, socEnabled) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setSystemDiskBurstingEnabled(bool systemDiskBurstingEnabled) { DARABONBA_PTR_SET_VALUE(systemDiskBurstingEnabled_, systemDiskBurstingEnabled) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setSystemDiskCategory(string systemDiskCategory) { DARABONBA_PTR_SET_VALUE(systemDiskCategory_, systemDiskCategory) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setSystemDiskPerformanceLevel(string systemDiskPerformanceLevel) { DARABONBA_PTR_SET_VALUE(systemDiskPerformanceLevel_, systemDiskPerformanceLevel) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setSystemDiskProvisionedIops(int64_t systemDiskProvisionedIops) { DARABONBA_PTR_SET_VALUE(systemDiskProvisionedIops_, systemDiskProvisionedIops) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setSystemDiskSize(int64_t systemDiskSize) { DARABONBA_PTR_SET_VALUE(systemDiskSize_, systemDiskSize) };
    ...
    inline DescribeClusterDetailResponseBodyControlPlaneConfig& setSystemDiskSnapshotPolicyId(string systemDiskSnapshotPolicyId) { DARABONBA_PTR_SET_VALUE(systemDiskSnapshotPolicyId_, systemDiskSnapshotPolicyId) };
