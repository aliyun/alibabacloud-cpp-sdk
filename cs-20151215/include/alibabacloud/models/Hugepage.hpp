...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getKhugepagedAllocSleepMillisecs() const { DARABONBA_PTR_GET_DEFAULT(khugepagedAllocSleepMillisecs_, 0L) };
    ...
    inline int64_t getKhugepagedDefrag() const { DARABONBA_PTR_GET_DEFAULT(khugepagedDefrag_, 0L) };
    ...
    inline int64_t getKhugepagedPagesToScan() const { DARABONBA_PTR_GET_DEFAULT(khugepagedPagesToScan_, 0L) };
    ...
    inline int64_t getKhugepagedScanSleepMillisecs() const { DARABONBA_PTR_GET_DEFAULT(khugepagedScanSleepMillisecs_, 0L) };
    ...
    inline string getTransparentDefrag() const { DARABONBA_PTR_GET_DEFAULT(transparentDefrag_, "") };
    ...
    inline string getTransparentEnabled() const { DARABONBA_PTR_GET_DEFAULT(transparentEnabled_, "") };
  ...
  protected:
    shared_ptr<int64_t> khugepagedAllocSleepMillisecs_ {};
    shared_ptr<int64_t> khugepagedDefrag_ {};
    shared_ptr<int64_t> khugepagedPagesToScan_ {};
    shared_ptr<int64_t> khugepagedScanSleepMillisecs_ {};
    shared_ptr<string> transparentDefrag_ {};
    shared_ptr<string> transparentEnabled_ {};
  };
