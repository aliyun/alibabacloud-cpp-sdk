...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteClusterNodepoolResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteClusterNodepoolResponseBody) };
    inline DeleteClusterNodepoolResponseBody body() { DARABONBA_PTR_GET(body_, DeleteClusterNodepoolResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteClusterNodepoolResponseBody> body_ = nullptr;
  };
