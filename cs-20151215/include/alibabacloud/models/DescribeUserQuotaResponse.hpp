...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUserQuotaResponseBody) };
    inline DescribeUserQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUserQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUserQuotaResponseBody> body_ {};
  };
