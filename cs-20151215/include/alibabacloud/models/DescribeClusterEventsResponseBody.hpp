...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeClusterEventsResponseBody::Events> & getEvents() const { DARABONBA_PTR_GET_CONST(events_, vector<DescribeClusterEventsResponseBody::Events>) };
    ...
    inline const DescribeClusterEventsResponseBody::PageInfo & getPageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, DescribeClusterEventsResponseBody::PageInfo) };
    inline DescribeClusterEventsResponseBody::PageInfo getPageInfo() { DARABONBA_PTR_GET(pageInfo_, DescribeClusterEventsResponseBody::PageInfo) };
    inline DescribeClusterEventsResponseBody& setPageInfo(const DescribeClusterEventsResponseBody::PageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline DescribeClusterEventsResponseBody& setPageInfo(DescribeClusterEventsResponseBody::PageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
