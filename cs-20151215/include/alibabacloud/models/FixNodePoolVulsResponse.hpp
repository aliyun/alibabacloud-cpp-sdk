...
namespace Models
{
  ...
  public:
    ...
    inline const FixNodePoolVulsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, FixNodePoolVulsResponseBody) };
    inline FixNodePoolVulsResponseBody body() { DARABONBA_PTR_GET(body_, FixNodePoolVulsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<FixNodePoolVulsResponseBody> body_ = nullptr;
  };
