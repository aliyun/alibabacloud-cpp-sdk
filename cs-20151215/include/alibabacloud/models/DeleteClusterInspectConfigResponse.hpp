...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteClusterInspectConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteClusterInspectConfigResponseBody) };
    inline DeleteClusterInspectConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteClusterInspectConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteClusterInspectConfigResponseBody> body_ {};
  };
