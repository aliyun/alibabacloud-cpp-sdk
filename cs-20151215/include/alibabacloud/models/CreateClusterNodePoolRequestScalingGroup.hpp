...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoRenew_ == nullptr
        && return this->autoRenewPeriod_ == nullptr && return this->cisEnabled_ == nullptr && return this->compensateWithOnDemand_ == nullptr && return this->dataDisks_ == nullptr && return this->deploymentsetId_ == nullptr
        && return this->desiredSize_ == nullptr && return this->imageId_ == nullptr && return this->imageType_ == nullptr && return this->instanceChargeType_ == nullptr && return this->instanceMetadataOptions_ == nullptr
        && return this->instancePatterns_ == nullptr && return this->instanceTypes_ == nullptr && return this->internetChargeType_ == nullptr && return this->internetMaxBandwidthOut_ == nullptr && return this->keyPair_ == nullptr
        && return this->loginAsNonRoot_ == nullptr && return this->loginPassword_ == nullptr && return this->multiAzPolicy_ == nullptr && return this->onDemandBaseCapacity_ == nullptr && return this->onDemandPercentageAboveBaseCapacity_ == nullptr
        && return this->period_ == nullptr && return this->periodUnit_ == nullptr && return this->platform_ == nullptr && return this->privatePoolOptions_ == nullptr && return this->ramRoleName_ == nullptr
        && return this->rdsInstances_ == nullptr && return this->resourcePoolOptions_ == nullptr && return this->scalingPolicy_ == nullptr && return this->securityGroupId_ == nullptr && return this->securityGroupIds_ == nullptr
