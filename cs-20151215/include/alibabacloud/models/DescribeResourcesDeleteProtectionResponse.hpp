...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeResourcesDeleteProtectionResponseBody> & body() const { DARABONBA_PTR_GET_CONST(body_, vector<DescribeResourcesDeleteProtectionResponseBody>) };
    inline vector<DescribeResourcesDeleteProtectionResponseBody> body() { DARABONBA_PTR_GET(body_, vector<DescribeResourcesDeleteProtectionResponseBody>) };
    inline DescribeResourcesDeleteProtectionResponse& setBody(const vector<DescribeResourcesDeleteProtectionResponseBody> & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline DescribeResourcesDeleteProtectionResponse& setBody(vector<DescribeResourcesDeleteProtectionResponseBody> && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<vector<DescribeResourcesDeleteProtectionResponseBody>> body_ = nullptr;
  };
