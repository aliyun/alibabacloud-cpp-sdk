...
namespace Models
{
  ...
  public:
    ...
    inline const GetClusterInspectReportDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetClusterInspectReportDetailResponseBody) };
    inline GetClusterInspectReportDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetClusterInspectReportDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetClusterInspectReportDetailResponseBody> body_ {};
  };
