...
namespace Models
{
  ...
  public:
    ...
    inline const GetClusterInspectConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetClusterInspectConfigResponseBody) };
    inline GetClusterInspectConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetClusterInspectConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetClusterInspectConfigResponseBody> body_ {};
  };
