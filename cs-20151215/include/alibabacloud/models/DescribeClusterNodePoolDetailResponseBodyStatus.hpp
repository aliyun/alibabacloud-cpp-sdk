...
namespace Models
{
  ...
  public:
    ...
    DescribeClusterNodePoolDetailResponseBodyStatus() = default ;
    DescribeClusterNodePoolDetailResponseBodyStatus(const DescribeClusterNodePoolDetailResponseBodyStatus &) = default ;
    DescribeClusterNodePoolDetailResponseBodyStatus(DescribeClusterNodePoolDetailResponseBodyStatus &&) = default ;
    DescribeClusterNodePoolDetailResponseBodyStatus(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeClusterNodePoolDetailResponseBodyStatus() = default ;
    DescribeClusterNodePoolDetailResponseBodyStatus& operator=(const DescribeClusterNodePoolDetailResponseBodyStatus &) = default ;
    DescribeClusterNodePoolDetailResponseBodyStatus& operator=(DescribeClusterNodePoolDetailResponseBodyStatus &&) = default ;
    ...
    inline DescribeClusterNodePoolDetailResponseBodyStatus& setFailedNodes(int64_t failedNodes) { DARABONBA_PTR_SET_VALUE(failedNodes_, failedNodes) };
    ...
    inline DescribeClusterNodePoolDetailResponseBodyStatus& setHealthyNodes(int64_t healthyNodes) { DARABONBA_PTR_SET_VALUE(healthyNodes_, healthyNodes) };
    ...
    inline DescribeClusterNodePoolDetailResponseBodyStatus& setInitialNodes(int64_t initialNodes) { DARABONBA_PTR_SET_VALUE(initialNodes_, initialNodes) };
    ...
    inline DescribeClusterNodePoolDetailResponseBodyStatus& setOfflineNodes(int64_t offlineNodes) { DARABONBA_PTR_SET_VALUE(offlineNodes_, offlineNodes) };
    ...
    inline DescribeClusterNodePoolDetailResponseBodyStatus& setRemovingNodes(int64_t removingNodes) { DARABONBA_PTR_SET_VALUE(removingNodes_, removingNodes) };
    ...
    inline DescribeClusterNodePoolDetailResponseBodyStatus& setServingNodes(int64_t servingNodes) { DARABONBA_PTR_SET_VALUE(servingNodes_, servingNodes) };
    ...
    inline DescribeClusterNodePoolDetailResponseBodyStatus& setState(string state) { DARABONBA_PTR_SET_VALUE(state_, state) };
    ...
    inline DescribeClusterNodePoolDetailResponseBodyStatus& setTotalNodes(int64_t totalNodes) { DARABONBA_PTR_SET_VALUE(totalNodes_, totalNodes) };
