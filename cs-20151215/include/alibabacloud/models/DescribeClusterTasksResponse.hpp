...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClusterTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeClusterTasksResponseBody) };
    inline DescribeClusterTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeClusterTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeClusterTasksResponseBody> body_ {};
  };
