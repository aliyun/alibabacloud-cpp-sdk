...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeClusterNodepoolResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeClusterNodepoolResponseBody) };
    inline UpgradeClusterNodepoolResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeClusterNodepoolResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeClusterNodepoolResponseBody> body_ {};
  };
