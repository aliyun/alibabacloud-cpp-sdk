...
namespace Models
{
  ...
  public:
    ...
    inline const CreateClusterNodePoolResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateClusterNodePoolResponseBody) };
    inline CreateClusterNodePoolResponseBody body() { DARABONBA_PTR_GET(body_, CreateClusterNodePoolResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateClusterNodePoolResponseBody> body_ = nullptr;
  };
