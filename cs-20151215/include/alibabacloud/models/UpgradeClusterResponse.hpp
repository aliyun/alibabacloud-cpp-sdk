...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeClusterResponseBody) };
    inline UpgradeClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeClusterResponseBody> body_ {};
  };
