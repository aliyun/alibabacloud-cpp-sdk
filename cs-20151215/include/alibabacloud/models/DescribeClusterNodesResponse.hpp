...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClusterNodesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeClusterNodesResponseBody) };
    inline DescribeClusterNodesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeClusterNodesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeClusterNodesResponseBody> body_ {};
  };
