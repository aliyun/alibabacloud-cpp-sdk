...
namespace Models
{
  ...
  public:
    ...
    inline const CheckServiceRoleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckServiceRoleResponseBody) };
    inline CheckServiceRoleResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckServiceRoleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckServiceRoleResponseBody> body_ {};
  };
