...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEventsForRegionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEventsForRegionResponseBody) };
    inline DescribeEventsForRegionResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEventsForRegionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEventsForRegionResponseBody> body_ {};
  };
