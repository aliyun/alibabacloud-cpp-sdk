...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeUserPermissionResponseBody> & body() const { DARABONBA_PTR_GET_CONST(body_, vector<DescribeUserPermissionResponseBody>) };
    inline vector<DescribeUserPermissionResponseBody> body() { DARABONBA_PTR_GET(body_, vector<DescribeUserPermissionResponseBody>) };
    inline DescribeUserPermissionResponse& setBody(const vector<DescribeUserPermissionResponseBody> & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline DescribeUserPermissionResponse& setBody(vector<DescribeUserPermissionResponseBody> && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<vector<DescribeUserPermissionResponseBody>> body_ = nullptr;
  };
