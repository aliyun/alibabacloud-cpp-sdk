...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserKubeConfigStatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUserKubeConfigStatesResponseBody) };
    inline ListUserKubeConfigStatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUserKubeConfigStatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUserKubeConfigStatesResponseBody> body_ {};
  };
