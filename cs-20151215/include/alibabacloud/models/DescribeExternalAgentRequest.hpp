...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->agentMode_ != nullptr
    ...
    inline string agentMode() const { DARABONBA_PTR_GET_DEFAULT(agentMode_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> agentMode_ = nullptr;
