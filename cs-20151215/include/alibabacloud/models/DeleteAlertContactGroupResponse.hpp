...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DeleteAlertContactGroupResponseBody> & body() const { DARABONBA_PTR_GET_CONST(body_, vector<DeleteAlertContactGroupResponseBody>) };
    inline vector<DeleteAlertContactGroupResponseBody> body() { DARABONBA_PTR_GET(body_, vector<DeleteAlertContactGroupResponseBody>) };
    inline DeleteAlertContactGroupResponse& setBody(const vector<DeleteAlertContactGroupResponseBody> & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline DeleteAlertContactGroupResponse& setBody(vector<DeleteAlertContactGroupResponseBody> && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<vector<DeleteAlertContactGroupResponseBody>> body_ = nullptr;
  };
