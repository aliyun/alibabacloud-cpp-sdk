...
namespace Models
{
  ...
  public:
    ...
    inline const CleanUserPermissionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CleanUserPermissionsResponseBody) };
    inline CleanUserPermissionsResponseBody getBody() { DARABONBA_PTR_GET(body_, CleanUserPermissionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CleanUserPermissionsResponseBody> body_ {};
  };
