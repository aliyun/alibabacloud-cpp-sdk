...
#ifndef ALIBABACLOUD_MODELS_CREATECLUSTERNODEPOOLREQUESTMANAGEMENTAUTOVULFIXPOLICY_HPP_
#define ALIBABACLOUD_MODELS_CREATECLUSTERNODEPOOLREQUESTMANAGEMENTAUTOVULFIXPOLICY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateClusterNodePoolRequestManagementAutoVulFixPolicy& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateClusterNodePoolRequestManagementAutoVulFixPolicy& obj) { 
    ...
    CreateClusterNodePoolRequestManagementAutoVulFixPolicy() = default ;
    CreateClusterNodePoolRequestManagementAutoVulFixPolicy(const CreateClusterNodePoolRequestManagementAutoVulFixPolicy &) = default ;
    CreateClusterNodePoolRequestManagementAutoVulFixPolicy(CreateClusterNodePoolRequestManagementAutoVulFixPolicy &&) = default ;
    CreateClusterNodePoolRequestManagementAutoVulFixPolicy(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateClusterNodePoolRequestManagementAutoVulFixPolicy() = default ;
    CreateClusterNodePoolRequestManagementAutoVulFixPolicy& operator=(const CreateClusterNodePoolRequestManagementAutoVulFixPolicy &) = default ;
    CreateClusterNodePoolRequestManagementAutoVulFixPolicy& operator=(CreateClusterNodePoolRequestManagementAutoVulFixPolicy &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->excludePackages_ != nullptr
    ...
    inline CreateClusterNodePoolRequestManagementAutoVulFixPolicy& setExcludePackages(string excludePackages) { DARABONBA_PTR_SET_VALUE(excludePackages_, excludePackages) };
    ...
    inline CreateClusterNodePoolRequestManagementAutoVulFixPolicy& setRestartNode(bool restartNode) { DARABONBA_PTR_SET_VALUE(restartNode_, restartNode) };
    ...
    inline CreateClusterNodePoolRequestManagementAutoVulFixPolicy& setVulLevel(string vulLevel) { DARABONBA_PTR_SET_VALUE(vulLevel_, vulLevel) };
