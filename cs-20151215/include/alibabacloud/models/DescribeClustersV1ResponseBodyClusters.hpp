...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterDomain_ == nullptr
        ...
        && return this->currentVersion_ == nullptr && return this->deletionProtection_ == nullptr && return this->dockerVersion_ == nullptr && return this->externalLoadbalancerId_ == nullptr && return this->initVersion_ == nullptr
        && return this->ipStack_ == nullptr && return this->maintenanceWindow_ == nullptr && return this->masterUrl_ == nullptr && return this->metaData_ == nullptr && return this->name_ == nullptr
        && return this->networkMode_ == nullptr && return this->nextVersion_ == nullptr && return this->operationPolicy_ == nullptr && return this->privateZone_ == nullptr && return this->profile_ == nullptr
        && return this->proxyMode_ == nullptr && return this->regionId_ == nullptr && return this->resourceGroupId_ == nullptr && return this->securityGroupId_ == nullptr && return this->serviceCidr_ == nullptr
        && return this->size_ == nullptr && return this->state_ == nullptr && return this->subnetCidr_ == nullptr && return this->tags_ == nullptr && return this->timezone_ == nullptr
        && return this->updated_ == nullptr && return this->vpcId_ == nullptr && return this->vswitchId_ == nullptr && return this->vswitchIds_ == nullptr && return this->workerRamRoleName_ == nullptr
