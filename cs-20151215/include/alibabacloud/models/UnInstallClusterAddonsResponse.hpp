...
namespace Models
{
  ...
  public:
    ...
    inline const UnInstallClusterAddonsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnInstallClusterAddonsResponseBody) };
    inline UnInstallClusterAddonsResponseBody getBody() { DARABONBA_PTR_GET(body_, UnInstallClusterAddonsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnInstallClusterAddonsResponseBody> body_ {};
  };
