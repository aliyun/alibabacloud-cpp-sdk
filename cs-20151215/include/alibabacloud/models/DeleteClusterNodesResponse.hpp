...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteClusterNodesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteClusterNodesResponseBody) };
    inline DeleteClusterNodesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteClusterNodesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteClusterNodesResponseBody> body_ {};
  };
