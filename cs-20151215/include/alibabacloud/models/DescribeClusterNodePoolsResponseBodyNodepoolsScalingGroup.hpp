...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoRenew_ == nullptr
        ...
        && return this->desiredSize_ == nullptr && return this->imageId_ == nullptr && return this->imageType_ == nullptr && return this->instanceChargeType_ == nullptr && return this->instancePatterns_ == nullptr
        && return this->instanceTypes_ == nullptr && return this->internetChargeType_ == nullptr && return this->internetMaxBandwidthOut_ == nullptr && return this->keyPair_ == nullptr && return this->loginAsNonRoot_ == nullptr
        && return this->loginPassword_ == nullptr && return this->multiAzPolicy_ == nullptr && return this->onDemandBaseCapacity_ == nullptr && return this->onDemandPercentageAboveBaseCapacity_ == nullptr && return this->period_ == nullptr
        && return this->periodUnit_ == nullptr && return this->platform_ == nullptr && return this->privatePoolOptions_ == nullptr && return this->ramPolicy_ == nullptr && return this->ramRoleName_ == nullptr
        && return this->rdsInstances_ == nullptr && return this->resourcePoolOptions_ == nullptr && return this->scalingGroupId_ == nullptr && return this->scalingPolicy_ == nullptr && return this->securityGroupId_ == nullptr
        && return this->securityGroupIds_ == nullptr && return this->securityHardeningOs_ == nullptr && return this->socEnabled_ == nullptr && return this->spotInstancePools_ == nullptr && return this->spotInstanceRemedy_ == nullptr
        ...
        && return this->systemDiskSize_ == nullptr && return this->systemDiskSnapshotPolicyId_ == nullptr && return this->tags_ == nullptr && return this->vswitchIds_ == nullptr; };
    ...
    inline const Models::DescribeClusterNodePoolsResponseBodyNodepoolsScalingGroupResourcePoolOptions & resourcePoolOptions() const { DARABONBA_PTR_GET_CONST(resourcePoolOptions_, Models::DescribeClusterNodePoolsResponseBodyNodepoolsScalingGroupResourcePoolOptions) };
    inline Models::DescribeClusterNodePoolsResponseBodyNodepoolsScalingGroupResourcePoolOptions resourcePoolOptions() { DARABONBA_PTR_GET(resourcePoolOptions_, Models::DescribeClusterNodePoolsResponseBodyNodepoolsScalingGroupResourcePoolOptions) };
    inline DescribeClusterNodePoolsResponseBodyNodepoolsScalingGroup& setResourcePoolOptions(const Models::DescribeClusterNodePoolsResponseBodyNodepoolsScalingGroupResourcePoolOptions & resourcePoolOptions) { DARABONBA_PTR_SET_VALUE(resourcePoolOptions_, resourcePoolOptions) };
    inline DescribeClusterNodePoolsResponseBodyNodepoolsScalingGroup& setResourcePoolOptions(Models::DescribeClusterNodePoolsResponseBodyNodepoolsScalingGroupResourcePoolOptions && resourcePoolOptions) { DARABONBA_PTR_SET_RVALUE(resourcePoolOptions_, resourcePoolOptions) };
    ...
    inline DescribeClusterNodePoolsResponseBodyNodepoolsScalingGroup& setSystemDiskSnapshotPolicyId(string systemDiskSnapshotPolicyId) { DARABONBA_PTR_SET_VALUE(systemDiskSnapshotPolicyId_, systemDiskSnapshotPolicyId) };
  ...
  protected:
    ...
    std::shared_ptr<Models::DescribeClusterNodePoolsResponseBodyNodepoolsScalingGroupResourcePoolOptions> resourcePoolOptions_ = nullptr;
