...
#ifndef ALIBABACLOUD_MODELS_CREATEAUTOREPAIRPOLICYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEAUTOREPAIRPOLICYREQUEST_HPP_
...
namespace Models
{
  class CreateAutoRepairPolicyRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateAutoRepairPolicyRequest& obj) { 
      DARABONBA_PTR_TO_JSON(name, name_);
      DARABONBA_PTR_TO_JSON(resource_sub_type, resourceSubType_);
      DARABONBA_PTR_TO_JSON(resource_type, resourceType_);
      DARABONBA_PTR_TO_JSON(rules, rules_);
    };
    friend void from_json(const Darabonba::Json& j, CreateAutoRepairPolicyRequest& obj) { 
    ...
    CreateAutoRepairPolicyRequest() = default ;
    CreateAutoRepairPolicyRequest(const CreateAutoRepairPolicyRequest &) = default ;
    CreateAutoRepairPolicyRequest(CreateAutoRepairPolicyRequest &&) = default ;
    CreateAutoRepairPolicyRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAutoRepairPolicyRequest() = default ;
    CreateAutoRepairPolicyRequest& operator=(const CreateAutoRepairPolicyRequest &) = default ;
    CreateAutoRepairPolicyRequest& operator=(CreateAutoRepairPolicyRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->name_ == nullptr
        && this->resourceSubType_ == nullptr && this->resourceType_ == nullptr && this->rules_ == nullptr; };
    // name Field Functions 
    bool hasName() const { return this->name_ != nullptr;};
    void deleteName() { this->name_ = nullptr;};
    inline string getName() const { DARABONBA_PTR_GET_DEFAULT(name_, "") };
    inline CreateAutoRepairPolicyRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline CreateAutoRepairPolicyRequest& setResourceSubType(string resourceSubType) { DARABONBA_PTR_SET_VALUE(resourceSubType_, resourceSubType) };
    ...
    inline CreateAutoRepairPolicyRequest& setResourceType(string resourceType) { DARABONBA_PTR_SET_VALUE(resourceType_, resourceType) };


    // rules Field Functions 
    bool hasRules() const { return this->rules_ != nullptr;};
    void deleteRules() { this->rules_ = nullptr;};
    inline const vector<CreateAutoRepairPolicyRequest::Rules> & getRules() const { DARABONBA_PTR_GET_CONST(rules_, vector<CreateAutoRepairPolicyRequest::Rules>) };
    inline vector<CreateAutoRepairPolicyRequest::Rules> getRules() { DARABONBA_PTR_GET(rules_, vector<CreateAutoRepairPolicyRequest::Rules>) };
    inline CreateAutoRepairPolicyRequest& setRules(const vector<CreateAutoRepairPolicyRequest::Rules> & rules) { DARABONBA_PTR_SET_VALUE(rules_, rules) };
    inline CreateAutoRepairPolicyRequest& setRules(vector<CreateAutoRepairPolicyRequest::Rules> && rules) { DARABONBA_PTR_SET_RVALUE(rules_, rules) };
