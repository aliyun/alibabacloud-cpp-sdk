...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteClusterResponseBody) };
    inline DeleteClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteClusterResponseBody> body_ {};
  };
