...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoRenew_ == nullptr
        ...
        && return this->imageId_ == nullptr && return this->imageType_ == nullptr && return this->instanceChargeType_ == nullptr && return this->instanceMetadataOptions_ == nullptr && return this->instanceTypes_ == nullptr
        && return this->internetChargeType_ == nullptr && return this->internetMaxBandwidthOut_ == nullptr && return this->keyPair_ == nullptr && return this->loginAsNonRoot_ == nullptr && return this->loginPassword_ == nullptr
        && return this->multiAzPolicy_ == nullptr && return this->onDemandBaseCapacity_ == nullptr && return this->onDemandPercentageAboveBaseCapacity_ == nullptr && return this->period_ == nullptr && return this->periodUnit_ == nullptr
        && return this->platform_ == nullptr && return this->privatePoolOptions_ == nullptr && return this->ramRoleName_ == nullptr && return this->rdsInstances_ == nullptr && return this->resourcePoolOptions_ == nullptr
        && return this->scalingPolicy_ == nullptr && return this->securityGroupId_ == nullptr && return this->securityGroupIds_ == nullptr && return this->spotInstancePools_ == nullptr && return this->spotInstanceRemedy_ == nullptr
        && return this->spotPriceLimit_ == nullptr && return this->spotStrategy_ == nullptr && return this->systemDiskBurstingEnabled_ == nullptr && return this->systemDiskCategories_ == nullptr && return this->systemDiskCategory_ == nullptr
        && return this->systemDiskEncryptAlgorithm_ == nullptr && return this->systemDiskEncrypted_ == nullptr && return this->systemDiskKmsKeyId_ == nullptr && return this->systemDiskPerformanceLevel_ == nullptr && return this->systemDiskProvisionedIops_ == nullptr
        && return this->systemDiskSize_ == nullptr && return this->tags_ == nullptr && return this->vswitchIds_ == nullptr; };
