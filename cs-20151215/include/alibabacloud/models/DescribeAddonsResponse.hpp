...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAddonsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAddonsResponseBody) };
    inline DescribeAddonsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAddonsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAddonsResponseBody> body_ {};
  };
