...
namespace Models
{
  ...
  public:
    ...
    inline const CheckControlPlaneLogEnableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckControlPlaneLogEnableResponseBody) };
    inline CheckControlPlaneLogEnableResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckControlPlaneLogEnableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckControlPlaneLogEnableResponseBody> body_ {};
  };
