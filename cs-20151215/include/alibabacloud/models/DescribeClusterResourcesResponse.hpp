...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeClusterResourcesResponseBody> & body() const { DARABONBA_PTR_GET_CONST(body_, vector<DescribeClusterResourcesResponseBody>) };
    inline vector<DescribeClusterResourcesResponseBody> body() { DARABONBA_PTR_GET(body_, vector<DescribeClusterResourcesResponseBody>) };
    inline DescribeClusterResourcesResponse& setBody(const vector<DescribeClusterResourcesResponseBody> & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline DescribeClusterResourcesResponse& setBody(vector<DescribeClusterResourcesResponseBody> && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<vector<DescribeClusterResourcesResponseBody>> body_ = nullptr;
  };
