...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoRenew_ == nullptr
        ...
        && return this->period_ == nullptr && return this->periodUnit_ == nullptr && return this->platform_ == nullptr && return this->privatePoolOptions_ == nullptr && return this->ramPolicy_ == nullptr
        && return this->ramRoleName_ == nullptr && return this->rdsInstances_ == nullptr && return this->resourcePoolOptions_ == nullptr && return this->scalingGroupId_ == nullptr && return this->scalingPolicy_ == nullptr
        && return this->securityGroupId_ == nullptr && return this->securityGroupIds_ == nullptr && return this->securityHardeningOs_ == nullptr && return this->socEnabled_ == nullptr && return this->spotInstancePools_ == nullptr
        && return this->spotInstanceRemedy_ == nullptr && return this->spotPriceLimit_ == nullptr && return this->spotStrategy_ == nullptr && return this->systemDiskBurstingEnabled_ == nullptr && return this->systemDiskCategories_ == nullptr
        && return this->systemDiskCategory_ == nullptr && return this->systemDiskEncryptAlgorithm_ == nullptr && return this->systemDiskEncrypted_ == nullptr && return this->systemDiskKmsKeyId_ == nullptr && return this->systemDiskPerformanceLevel_ == nullptr
        && return this->systemDiskProvisionedIops_ == nullptr && return this->systemDiskSize_ == nullptr && return this->systemDiskSnapshotPolicyId_ == nullptr && return this->tags_ == nullptr && return this->vswitchIds_ == nullptr; };
    ...
    inline DescribeClusterNodePoolDetailResponseBodyScalingGroup& setSystemDiskSnapshotPolicyId(string systemDiskSnapshotPolicyId) { DARABONBA_PTR_SET_VALUE(systemDiskSnapshotPolicyId_, systemDiskSnapshotPolicyId) };
