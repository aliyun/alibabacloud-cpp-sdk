...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClusterV2UserKubeconfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeClusterV2UserKubeconfigResponseBody) };
    inline DescribeClusterV2UserKubeconfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeClusterV2UserKubeconfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeClusterV2UserKubeconfigResponseBody> body_ {};
  };
