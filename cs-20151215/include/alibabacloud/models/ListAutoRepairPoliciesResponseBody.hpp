...
#ifndef ALIBABACLOUD_MODELS_LISTAUTOREPAIRPOLICIESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTAUTOREPAIRPOLICIESRESPONSEBODY_HPP_
...
namespace Models
{
  class ListAutoRepairPoliciesResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListAutoRepairPoliciesResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(items, items_);
    };
    friend void from_json(const Darabonba::Json& j, ListAutoRepairPoliciesResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(items, items_);
    };
    ListAutoRepairPoliciesResponseBody() = default ;
    ListAutoRepairPoliciesResponseBody(const ListAutoRepairPoliciesResponseBody &) = default ;
    ListAutoRepairPoliciesResponseBody(ListAutoRepairPoliciesResponseBody &&) = default ;
    ListAutoRepairPoliciesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAutoRepairPoliciesResponseBody() = default ;
    ListAutoRepairPoliciesResponseBody& operator=(const ListAutoRepairPoliciesResponseBody &) = default ;
    ListAutoRepairPoliciesResponseBody& operator=(ListAutoRepairPoliciesResponseBody &&) = default ;
    ...
    public:
      ...
      inline Items& setResourceIds(const vector<string> & resourceIds) { DARABONBA_PTR_SET_VALUE(resourceIds_, resourceIds) };
      inline Items& setResourceIds(vector<string> && resourceIds) { DARABONBA_PTR_SET_RVALUE(resourceIds_, resourceIds) };
      ...
      inline Items& setResourceSubType(string resourceSubType) { DARABONBA_PTR_SET_VALUE(resourceSubType_, resourceSubType) };
      ...
      inline const vector<Items::Rules> & getRules() const { DARABONBA_PTR_GET_CONST(rules_, vector<Items::Rules>) };
      inline vector<Items::Rules> getRules() { DARABONBA_PTR_GET(rules_, vector<Items::Rules>) };
      inline Items& setRules(const vector<Items::Rules> & rules) { DARABONBA_PTR_SET_VALUE(rules_, rules) };
      inline Items& setRules(vector<Items::Rules> && rules) { DARABONBA_PTR_SET_RVALUE(rules_, rules) };
    ...
    protected:
      ...
      shared_ptr<vector<Items::Rules>> rules_ {};
    };
    ...
    inline const vector<ListAutoRepairPoliciesResponseBody::Items> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<ListAutoRepairPoliciesResponseBody::Items>) };
    inline vector<ListAutoRepairPoliciesResponseBody::Items> getItems() { DARABONBA_PTR_GET(items_, vector<ListAutoRepairPoliciesResponseBody::Items>) };
    inline ListAutoRepairPoliciesResponseBody& setItems(const vector<ListAutoRepairPoliciesResponseBody::Items> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline ListAutoRepairPoliciesResponseBody& setItems(vector<ListAutoRepairPoliciesResponseBody::Items> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };


  protected:
    shared_ptr<vector<ListAutoRepairPoliciesResponseBody::Items>> items_ {};
  };
