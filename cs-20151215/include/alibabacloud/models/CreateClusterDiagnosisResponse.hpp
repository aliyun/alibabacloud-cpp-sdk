...
namespace Models
{
  ...
  public:
    ...
    inline const CreateClusterDiagnosisResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateClusterDiagnosisResponseBody) };
    inline CreateClusterDiagnosisResponseBody body() { DARABONBA_PTR_GET(body_, CreateClusterDiagnosisResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateClusterDiagnosisResponseBody> body_ = nullptr;
  };
