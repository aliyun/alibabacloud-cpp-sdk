...
namespace Models
{
  ...
  public:
    ...
    inline const ListClusterInspectReportsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListClusterInspectReportsResponseBody) };
    inline ListClusterInspectReportsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListClusterInspectReportsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListClusterInspectReportsResponseBody> body_ {};
  };
