...
#ifndef ALIBABACLOUD_MODELS_CREATEKUBERNETESTRIGGERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEKUBERNETESTRIGGERREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateKubernetesTriggerRequest& obj) { 
      DARABONBA_PTR_TO_JSON(action, action_);
      DARABONBA_PTR_TO_JSON(cluster_id, clusterId_);
      DARABONBA_PTR_TO_JSON(project_id, projectId_);
      DARABONBA_PTR_TO_JSON(type, type_);
    };
    friend void from_json(const Darabonba::Json& j, CreateKubernetesTriggerRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(action, action_);
      DARABONBA_PTR_FROM_JSON(cluster_id, clusterId_);
      DARABONBA_PTR_FROM_JSON(project_id, projectId_);
      DARABONBA_PTR_FROM_JSON(type, type_);
    };
    CreateKubernetesTriggerRequest() = default ;
    CreateKubernetesTriggerRequest(const CreateKubernetesTriggerRequest &) = default ;
    CreateKubernetesTriggerRequest(CreateKubernetesTriggerRequest &&) = default ;
    CreateKubernetesTriggerRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateKubernetesTriggerRequest() = default ;
    CreateKubernetesTriggerRequest& operator=(const CreateKubernetesTriggerRequest &) = default ;
    CreateKubernetesTriggerRequest& operator=(CreateKubernetesTriggerRequest &&) = default ;
