...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->checkId_ == nullptr
        && this->checkItems_ == nullptr && this->createdAt_ == nullptr && this->finishedAt_ == nullptr && this->message_ == nullptr && this->status_ == nullptr
        && this->type_ == nullptr; };
    ...
    inline const map<string, vector<Darabonba::Json>> & getCheckItems() const { DARABONBA_PTR_GET_CONST(checkItems_, map<string, vector<Darabonba::Json>>) };
    inline map<string, vector<Darabonba::Json>> getCheckItems() { DARABONBA_PTR_GET(checkItems_, map<string, vector<Darabonba::Json>>) };
