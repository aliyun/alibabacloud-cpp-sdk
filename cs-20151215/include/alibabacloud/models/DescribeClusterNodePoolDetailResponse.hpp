...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClusterNodePoolDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeClusterNodePoolDetailResponseBody) };
    inline DescribeClusterNodePoolDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeClusterNodePoolDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeClusterNodePoolDetailResponseBody> body_ {};
  };
