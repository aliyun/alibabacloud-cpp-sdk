...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterId_ == nullptr
        && this->created_ == nullptr && this->currentStage_ == nullptr && this->error_ == nullptr && this->events_ == nullptr && this->outputs_ == nullptr
        && this->parameters_ == nullptr && this->stages_ == nullptr && this->state_ == nullptr && this->target_ == nullptr && this->taskId_ == nullptr
        && this->taskResult_ == nullptr && this->taskType_ == nullptr && this->updated_ == nullptr; };
    ...
    inline     const Darabonba::Json & getOutputs() const { DARABONBA_GET(outputs_) };
    Darabonba::Json & getOutputs() { DARABONBA_GET(outputs_) };
    inline DescribeTaskInfoResponseBody& setOutputs(const Darabonba::Json & outputs) { DARABONBA_SET_VALUE(outputs_, outputs) };
    inline DescribeTaskInfoResponseBody& setOutputs(Darabonba::Json && outputs) { DARABONBA_SET_RVALUE(outputs_, outputs) };
