...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeKubernetesVersionMetadataResponseBody> & body() const { DARABONBA_PTR_GET_CONST(body_, vector<DescribeKubernetesVersionMetadataResponseBody>) };
    inline vector<DescribeKubernetesVersionMetadataResponseBody> body() { DARABONBA_PTR_GET(body_, vector<DescribeKubernetesVersionMetadataResponseBody>) };
    inline DescribeKubernetesVersionMetadataResponse& setBody(const vector<DescribeKubernetesVersionMetadataResponseBody> & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline DescribeKubernetesVersionMetadataResponse& setBody(vector<DescribeKubernetesVersionMetadataResponseBody> && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<vector<DescribeKubernetesVersionMetadataResponseBody>> body_ = nullptr;
  };
