...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->deleteOptions_ == nullptr
        && return this->keepSlb_ == nullptr && return this->retainAllResources_ == nullptr && return this->retainResources_ == nullptr; };
    ...
    inline const vector<DeleteClusterRequestDeleteOptions> & deleteOptions() const { DARABONBA_PTR_GET_CONST(deleteOptions_, vector<DeleteClusterRequestDeleteOptions>) };
    inline vector<DeleteClusterRequestDeleteOptions> deleteOptions() { DARABONBA_PTR_GET(deleteOptions_, vector<DeleteClusterRequestDeleteOptions>) };
    inline DeleteClusterRequest& setDeleteOptions(const vector<DeleteClusterRequestDeleteOptions> & deleteOptions) { DARABONBA_PTR_SET_VALUE(deleteOptions_, deleteOptions) };
    inline DeleteClusterRequest& setDeleteOptions(vector<DeleteClusterRequestDeleteOptions> && deleteOptions) { DARABONBA_PTR_SET_RVALUE(deleteOptions_, deleteOptions) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DeleteClusterRequestDeleteOptions>> deleteOptions_ = nullptr;
