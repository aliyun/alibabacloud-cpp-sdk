...
namespace Models
{
  ...
  public:
    ...
    inline DescribeSuspEventsShrinkRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline DescribeSuspEventsShrinkRequest& setSdkRequestShrink(string sdkRequestShrink) { DARABONBA_PTR_SET_VALUE(sdkRequestShrink_, sdkRequestShrink) };
