...
#ifndef ALIBABACLOUD_MODELS_DOWNLOADRESOURCECONTROLEVENTSSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DOWNLOADRESOURCECONTROLEVENTSSHRINKREQUEST_HPP_
...
namespace Models
{
  class DownloadResourceControlEventsShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DownloadResourceControlEventsShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DownloadResourceControlEventsShrinkRequest& obj) { 
    ...
    DownloadResourceControlEventsShrinkRequest() = default ;
    DownloadResourceControlEventsShrinkRequest(const DownloadResourceControlEventsShrinkRequest &) = default ;
    DownloadResourceControlEventsShrinkRequest(DownloadResourceControlEventsShrinkRequest &&) = default ;
    DownloadResourceControlEventsShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DownloadResourceControlEventsShrinkRequest() = default ;
    DownloadResourceControlEventsShrinkRequest& operator=(const DownloadResourceControlEventsShrinkRequest &) = default ;
    DownloadResourceControlEventsShrinkRequest& operator=(DownloadResourceControlEventsShrinkRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->actionCode_ == nullptr
        ...
        && this->domain_ == nullptr && this->eventCode_ == nullptr && this->eventCodesShrink_ == nullptr && this->eventId_ == nullptr && this->excludeActionCodesShrink_ == nullptr
        && this->excludeEventCodesShrink_ == nullptr && this->excludeReasonsShrink_ == nullptr && this->includeReasonsShrink_ == nullptr && this->instanceId_ == nullptr && this->ip_ == nullptr
        && this->pageSize_ == nullptr && this->punishEndTime_ == nullptr && this->punishStartTime_ == nullptr && this->reason_ == nullptr && this->sourceCodesShrink_ == nullptr
        && this->status_ == nullptr && this->statusListShrink_ == nullptr && this->url_ == nullptr; };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setActionCode(string actionCode) { DARABONBA_PTR_SET_VALUE(actionCode_, actionCode) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setActionCodesShrink(string actionCodesShrink) { DARABONBA_PTR_SET_VALUE(actionCodesShrink_, actionCodesShrink) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setAliyunLang(string aliyunLang) { DARABONBA_PTR_SET_VALUE(aliyunLang_, aliyunLang) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setBusinessCode(string businessCode) { DARABONBA_PTR_SET_VALUE(businessCode_, businessCode) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setCaseCodesPrefixShrink(string caseCodesPrefixShrink) { DARABONBA_PTR_SET_VALUE(caseCodesPrefixShrink_, caseCodesPrefixShrink) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setCurrent(int32_t current) { DARABONBA_PTR_SET_VALUE(current_, current) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setDomain(string domain) { DARABONBA_PTR_SET_VALUE(domain_, domain) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setEventCode(string eventCode) { DARABONBA_PTR_SET_VALUE(eventCode_, eventCode) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setEventCodesShrink(string eventCodesShrink) { DARABONBA_PTR_SET_VALUE(eventCodesShrink_, eventCodesShrink) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setEventId(string eventId) { DARABONBA_PTR_SET_VALUE(eventId_, eventId) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setExcludeActionCodesShrink(string excludeActionCodesShrink) { DARABONBA_PTR_SET_VALUE(excludeActionCodesShrink_, excludeActionCodesShrink) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setExcludeEventCodesShrink(string excludeEventCodesShrink) { DARABONBA_PTR_SET_VALUE(excludeEventCodesShrink_, excludeEventCodesShrink) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setExcludeReasonsShrink(string excludeReasonsShrink) { DARABONBA_PTR_SET_VALUE(excludeReasonsShrink_, excludeReasonsShrink) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setIncludeReasonsShrink(string includeReasonsShrink) { DARABONBA_PTR_SET_VALUE(includeReasonsShrink_, includeReasonsShrink) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setIp(string ip) { DARABONBA_PTR_SET_VALUE(ip_, ip) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setPunishEndTime(string punishEndTime) { DARABONBA_PTR_SET_VALUE(punishEndTime_, punishEndTime) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setPunishStartTime(string punishStartTime) { DARABONBA_PTR_SET_VALUE(punishStartTime_, punishStartTime) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setReason(string reason) { DARABONBA_PTR_SET_VALUE(reason_, reason) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setSourceCodesShrink(string sourceCodesShrink) { DARABONBA_PTR_SET_VALUE(sourceCodesShrink_, sourceCodesShrink) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setStatusListShrink(string statusListShrink) { DARABONBA_PTR_SET_VALUE(statusListShrink_, statusListShrink) };
    ...
    inline DownloadResourceControlEventsShrinkRequest& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
