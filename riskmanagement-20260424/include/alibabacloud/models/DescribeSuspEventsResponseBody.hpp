  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->appName_ == nullptr && this->autoBreaking_ == nullptr && this->canBeDealOnLine_ == nullptr && this->canCancelFault_ == nullptr && this->clusterId_ == nullptr
        && this->containHwMode_ == nullptr && this->containerId_ == nullptr && this->containerImageId_ == nullptr && this->containerImageName_ == nullptr && this->dataSource_ == nullptr
        ...
        inline Body& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
        ...
        inline Body& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
        ...
        inline const vector<Body::SuspEvents> & getSuspEvents() const { DARABONBA_PTR_GET_CONST(suspEvents_, vector<Body::SuspEvents>) };
        inline vector<Body::SuspEvents> getSuspEvents() { DARABONBA_PTR_GET(suspEvents_, vector<Body::SuspEvents>) };
        inline Body& setSuspEvents(const vector<Body::SuspEvents> & suspEvents) { DARABONBA_PTR_SET_VALUE(suspEvents_, suspEvents) };
        inline Body& setSuspEvents(vector<Body::SuspEvents> && suspEvents) { DARABONBA_PTR_SET_RVALUE(suspEvents_, suspEvents) };
        ...
        inline Body& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
    ...
    inline DescribeSuspEventsResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DescribeSuspEventsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeSuspEventsResponseBody::Data) };
    inline DescribeSuspEventsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeSuspEventsResponseBody::Data) };
    inline DescribeSuspEventsResponseBody& setData(const DescribeSuspEventsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSuspEventsResponseBody& setData(DescribeSuspEventsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeSuspEventsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DescribeSuspEventsResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
