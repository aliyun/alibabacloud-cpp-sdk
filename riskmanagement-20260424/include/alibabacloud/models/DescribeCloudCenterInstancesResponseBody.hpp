...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->vendorUserName_ == nullptr && this->vpcInstanceId_ == nullptr && this->vulCount_ == nullptr && this->vulStatus_ == nullptr; };
          ...
          inline Instances& setMem(string mem) { DARABONBA_PTR_SET_VALUE(mem_, mem) };
          ...
          inline string getSafeEventCount() const { DARABONBA_PTR_GET_DEFAULT(safeEventCount_, "") };
          inline Instances& setSafeEventCount(string safeEventCount) { DARABONBA_PTR_SET_VALUE(safeEventCount_, safeEventCount) };
        ...
        inline const vector<Body::Instances> & getInstances() const { DARABONBA_PTR_GET_CONST(instances_, vector<Body::Instances>) };
        inline vector<Body::Instances> getInstances() { DARABONBA_PTR_GET(instances_, vector<Body::Instances>) };
        inline Body& setInstances(const vector<Body::Instances> & instances) { DARABONBA_PTR_SET_VALUE(instances_, instances) };
        inline Body& setInstances(vector<Body::Instances> && instances) { DARABONBA_PTR_SET_RVALUE(instances_, instances) };


        // pageInfo Field Functions 
        bool hasPageInfo() const { return this->pageInfo_ != nullptr;};
        void deletePageInfo() { this->pageInfo_ = nullptr;};
        inline const Body::PageInfo & getPageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, Body::PageInfo) };
        inline Body::PageInfo getPageInfo() { DARABONBA_PTR_GET(pageInfo_, Body::PageInfo) };
        inline Body& setPageInfo(const Body::PageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
        inline Body& setPageInfo(Body::PageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
    ...
    inline DescribeCloudCenterInstancesResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DescribeCloudCenterInstancesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeCloudCenterInstancesResponseBody::Data) };
    inline DescribeCloudCenterInstancesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeCloudCenterInstancesResponseBody::Data) };
    inline DescribeCloudCenterInstancesResponseBody& setData(const DescribeCloudCenterInstancesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCloudCenterInstancesResponseBody& setData(DescribeCloudCenterInstancesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeCloudCenterInstancesResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
