  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline Body& setBindCount(int32_t bindCount) { DARABONBA_PTR_SET_VALUE(bindCount_, bindCount) };
        ...
        inline Body& setInsufficientCoreCount(int32_t insufficientCoreCount) { DARABONBA_PTR_SET_VALUE(insufficientCoreCount_, insufficientCoreCount) };
        ...
        inline Body& setInsufficientEcsCount(int32_t insufficientEcsCount) { DARABONBA_PTR_SET_VALUE(insufficientEcsCount_, insufficientEcsCount) };
        ...
        inline Body& setUnBindCount(int32_t unBindCount) { DARABONBA_PTR_SET_VALUE(unBindCount_, unBindCount) };
    ...
    inline BindAuthToMachineResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const BindAuthToMachineResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, BindAuthToMachineResponseBody::Data) };
    inline BindAuthToMachineResponseBody::Data getData() { DARABONBA_PTR_GET(data_, BindAuthToMachineResponseBody::Data) };
    inline BindAuthToMachineResponseBody& setData(const BindAuthToMachineResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BindAuthToMachineResponseBody& setData(BindAuthToMachineResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline BindAuthToMachineResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline BindAuthToMachineResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<BindAuthToMachineResponseBody::Data> data_ {};
