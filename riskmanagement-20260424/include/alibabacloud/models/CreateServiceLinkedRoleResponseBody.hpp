...
namespace Models
{
  ...
  public:
    ...
    inline CreateServiceLinkedRoleResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateServiceLinkedRoleResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateServiceLinkedRoleResponseBody::Data) };
    inline CreateServiceLinkedRoleResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateServiceLinkedRoleResponseBody::Data) };
    inline CreateServiceLinkedRoleResponseBody& setData(const CreateServiceLinkedRoleResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateServiceLinkedRoleResponseBody& setData(CreateServiceLinkedRoleResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateServiceLinkedRoleResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
  ...
  protected:
    ...
    shared_ptr<CreateServiceLinkedRoleResponseBody::Data> data_ {};
