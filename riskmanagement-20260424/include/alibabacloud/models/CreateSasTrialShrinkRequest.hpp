...
namespace Models
{
  ...
  public:
    ...
    inline CreateSasTrialShrinkRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline CreateSasTrialShrinkRequest& setSdkRequestShrink(string sdkRequestShrink) { DARABONBA_PTR_SET_VALUE(sdkRequestShrink_, sdkRequestShrink) };
