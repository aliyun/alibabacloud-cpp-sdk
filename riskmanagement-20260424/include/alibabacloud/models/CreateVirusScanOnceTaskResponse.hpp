...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVirusScanOnceTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVirusScanOnceTaskResponseBody) };
    inline CreateVirusScanOnceTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVirusScanOnceTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVirusScanOnceTaskResponseBody> body_ {};
  };
