...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateScriptResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateScriptResponseBody) };
    inline UpdateScriptResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateScriptResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateScriptResponseBody> body_ {};
  };
