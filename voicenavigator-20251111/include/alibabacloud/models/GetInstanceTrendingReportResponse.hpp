...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceTrendingReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceTrendingReportResponseBody) };
    inline GetInstanceTrendingReportResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInstanceTrendingReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInstanceTrendingReportResponseBody> body_ {};
  };
