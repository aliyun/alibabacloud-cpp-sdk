...
namespace Models
{
  ...
  public:
    ...
    inline BeginSessionResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const BeginSessionResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, BeginSessionResponseBody::Data) };
    inline BeginSessionResponseBody::Data getData() { DARABONBA_PTR_GET(data_, BeginSessionResponseBody::Data) };
    inline BeginSessionResponseBody& setData(const BeginSessionResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BeginSessionResponseBody& setData(BeginSessionResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline BeginSessionResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline BeginSessionResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline BeginSessionResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline BeginSessionResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
  ...
  protected:
    ...
    shared_ptr<BeginSessionResponseBody::Data> data_ {};
