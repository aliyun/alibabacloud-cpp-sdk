...
#ifndef ALIBABACLOUD_MODELS_LISTHISTORICALINSTANCEREPORTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTHISTORICALINSTANCEREPORTRESPONSEBODY_HPP_
...
namespace Models
{
  class ListHistoricalInstanceReportResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListHistoricalInstanceReportResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListHistoricalInstanceReportResponseBody& obj) { 
    ...
    ListHistoricalInstanceReportResponseBody() = default ;
    ListHistoricalInstanceReportResponseBody(const ListHistoricalInstanceReportResponseBody &) = default ;
    ListHistoricalInstanceReportResponseBody(ListHistoricalInstanceReportResponseBody &&) = default ;
    ListHistoricalInstanceReportResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListHistoricalInstanceReportResponseBody() = default ;
    ListHistoricalInstanceReportResponseBody& operator=(const ListHistoricalInstanceReportResponseBody &) = default ;
    ListHistoricalInstanceReportResponseBody& operator=(ListHistoricalInstanceReportResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->callsOffered_ == nullptr && this->callsRejected_ == nullptr && this->callsResolved_ == nullptr && this->configuredConcurrency_ == nullptr && this->instanceId_ == nullptr
        && this->labelBreakdown_ == nullptr && this->maxTalkTime_ == nullptr && this->rejectionBreakdown_ == nullptr && this->releaseReasonBreakdown_ == nullptr && this->talkTurnsDistribution_ == nullptr
        ...
        inline List& setLabelBreakdown(string labelBreakdown) { DARABONBA_PTR_SET_VALUE(labelBreakdown_, labelBreakdown) };
    ...
    inline ListHistoricalInstanceReportResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ListHistoricalInstanceReportResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListHistoricalInstanceReportResponseBody::Data) };
    inline ListHistoricalInstanceReportResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListHistoricalInstanceReportResponseBody::Data) };
    inline ListHistoricalInstanceReportResponseBody& setData(const ListHistoricalInstanceReportResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListHistoricalInstanceReportResponseBody& setData(ListHistoricalInstanceReportResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListHistoricalInstanceReportResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ListHistoricalInstanceReportResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListHistoricalInstanceReportResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline ListHistoricalInstanceReportResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline ListHistoricalInstanceReportResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<ListHistoricalInstanceReportResponseBody::Data> data_ {};
