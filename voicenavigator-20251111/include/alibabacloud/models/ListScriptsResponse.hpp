...
namespace Models
{
  ...
  public:
    ...
    inline const ListScriptsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListScriptsResponseBody) };
    inline ListScriptsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListScriptsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListScriptsResponseBody> body_ {};
  };
