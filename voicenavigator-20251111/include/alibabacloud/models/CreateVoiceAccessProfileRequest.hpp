...
#ifndef ALIBABACLOUD_MODELS_CREATEVOICEACCESSPROFILEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEVOICEACCESSPROFILEREQUEST_HPP_
...
namespace Models
{
  class CreateVoiceAccessProfileRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateVoiceAccessProfileRequest& obj) { 
      DARABONBA_PTR_TO_JSON(InstanceId, instanceId_);
      DARABONBA_PTR_TO_JSON(NlsEngine, nlsEngine_);
      DARABONBA_PTR_TO_JSON(Profile, profile_);
    };
    friend void from_json(const Darabonba::Json& j, CreateVoiceAccessProfileRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(InstanceId, instanceId_);
      DARABONBA_PTR_FROM_JSON(NlsEngine, nlsEngine_);
      DARABONBA_PTR_FROM_JSON(Profile, profile_);
    };
    CreateVoiceAccessProfileRequest() = default ;
    CreateVoiceAccessProfileRequest(const CreateVoiceAccessProfileRequest &) = default ;
    CreateVoiceAccessProfileRequest(CreateVoiceAccessProfileRequest &&) = default ;
    CreateVoiceAccessProfileRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateVoiceAccessProfileRequest() = default ;
    CreateVoiceAccessProfileRequest& operator=(const CreateVoiceAccessProfileRequest &) = default ;
    CreateVoiceAccessProfileRequest& operator=(CreateVoiceAccessProfileRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->instanceId_ == nullptr
        && this->nlsEngine_ == nullptr && this->profile_ == nullptr; };
    // instanceId Field Functions 
    bool hasInstanceId() const { return this->instanceId_ != nullptr;};
    void deleteInstanceId() { this->instanceId_ = nullptr;};
    inline string getInstanceId() const { DARABONBA_PTR_GET_DEFAULT(instanceId_, "") };
    inline CreateVoiceAccessProfileRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline CreateVoiceAccessProfileRequest& setNlsEngine(string nlsEngine) { DARABONBA_PTR_SET_VALUE(nlsEngine_, nlsEngine) };


    // profile Field Functions 
    bool hasProfile() const { return this->profile_ != nullptr;};
    void deleteProfile() { this->profile_ = nullptr;};
    inline const CreateVoiceAccessProfileRequest::Profile & getProfile() const { DARABONBA_PTR_GET_CONST(profile_, CreateVoiceAccessProfileRequest::Profile) };
    inline CreateVoiceAccessProfileRequest::Profile getProfile() { DARABONBA_PTR_GET(profile_, CreateVoiceAccessProfileRequest::Profile) };
    inline CreateVoiceAccessProfileRequest& setProfile(const CreateVoiceAccessProfileRequest::Profile & profile) { DARABONBA_PTR_SET_VALUE(profile_, profile) };
    inline CreateVoiceAccessProfileRequest& setProfile(CreateVoiceAccessProfileRequest::Profile && profile) { DARABONBA_PTR_SET_RVALUE(profile_, profile) };
