...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetInstanceTrendingReportResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<GetInstanceTrendingReportResponseBody::Data>) };
    inline vector<GetInstanceTrendingReportResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<GetInstanceTrendingReportResponseBody::Data>) };
    inline GetInstanceTrendingReportResponseBody& setData(const vector<GetInstanceTrendingReportResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetInstanceTrendingReportResponseBody& setData(vector<GetInstanceTrendingReportResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetInstanceTrendingReportResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline GetInstanceTrendingReportResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
  ...
  protected:
    ...
    shared_ptr<vector<GetInstanceTrendingReportResponseBody::Data>> data_ {};
