...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVariableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVariableResponseBody) };
    inline CreateVariableResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVariableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVariableResponseBody> body_ {};
  };
