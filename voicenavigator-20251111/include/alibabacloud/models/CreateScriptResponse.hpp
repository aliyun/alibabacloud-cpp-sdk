...
namespace Models
{
  ...
  public:
    ...
    inline const CreateScriptResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateScriptResponseBody) };
    inline CreateScriptResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateScriptResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateScriptResponseBody> body_ {};
  };
