...
public:
  ...
  map<string, boost::any> toMap() override {
    map<string, boost::any> res;
    if (bindToken) {
      res["BindToken"] = boost::any(*bindToken);
    }
    if (ownerId) {
      res["OwnerId"] = boost::any(*ownerId);
    }
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("BindToken") != m.end() && !m["BindToken"].empty()) {
      bindToken = make_shared<string>(boost::any_cast<string>(m["BindToken"]));
    }
    if (m.find("OwnerId") != m.end() && !m["OwnerId"].empty()) {
      ownerId = make_shared<long>(boost::any_cast<long>(m["OwnerId"]));
    }
...
class GetFaceVerifyRequest : public Darabonba::Model {
public:
  shared_ptr<long> ownerId{};
  shared_ptr<string> resourceOwnerAccount{};
  shared_ptr<long> resourceOwnerId{};
  ...
  explicit GetFaceVerifyRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~GetFaceVerifyRequest() = default;
};
class GetFaceVerifyResponseBodyData : public Darabonba::Model {
public:
  shared_ptr<string> verifyResult{};

  GetFaceVerifyResponseBodyData() {}

  explicit GetFaceVerifyResponseBodyData(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~GetFaceVerifyResponseBodyData() = default;
};
class GetFaceVerifyResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> code{};
  shared_ptr<GetFaceVerifyResponseBodyData> data{};
  shared_ptr<string> message{};
  shared_ptr<string> requestId{};

  GetFaceVerifyResponseBody() {}

  explicit GetFaceVerifyResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("Data") != m.end() && !m["Data"].empty()) {
      if (typeid(map<string, boost::any>) == m["Data"].type()) {
        GetFaceVerifyResponseBodyData model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["Data"]));
        data = make_shared<GetFaceVerifyResponseBodyData>(model1);
      }
    }
    if (m.find("Message") != m.end() && !m["Message"].empty()) {
      message = make_shared<string>(boost::any_cast<string>(m["Message"]));
  ...
  virtual ~GetFaceVerifyResponseBody() = default;
};
class GetFaceVerifyResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<GetFaceVerifyResponseBody> body{};

  GetFaceVerifyResponse() {}

  explicit GetFaceVerifyResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        GetFaceVerifyResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<GetFaceVerifyResponseBody>(model1);
      }
    }
  }


  virtual ~GetFaceVerifyResponse() = default;
};
...
class InitFaceVerifyResponseBodyData : public Darabonba::Model {
public:
  shared_ptr<string> certifyId{};

  InitFaceVerifyResponseBodyData() {}

  explicit InitFaceVerifyResponseBodyData(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~InitFaceVerifyResponseBodyData() = default;
};
class InitFaceVerifyResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> code{};
  shared_ptr<InitFaceVerifyResponseBodyData> data{};
  shared_ptr<string> message{};
  shared_ptr<string> requestId{};
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("Data") != m.end() && !m["Data"].empty()) {
      if (typeid(map<string, boost::any>) == m["Data"].type()) {
        InitFaceVerifyResponseBodyData model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["Data"]));
        data = make_shared<InitFaceVerifyResponseBodyData>(model1);
      }
    }
    if (m.find("Message") != m.end() && !m["Message"].empty()) {
      message = make_shared<string>(boost::any_cast<string>(m["Message"]));
...
class UpdateDefaultBRequest : public Darabonba::Model {
public:
  shared_ptr<long> ownerId{};
  shared_ptr<string> phoneNo{};
  shared_ptr<string> poolKey{};
  ...
  explicit UpdateDefaultBRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~UpdateDefaultBRequest() = default;
};
class UpdateDefaultBResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> code{};
  shared_ptr<string> data{};
  shared_ptr<string> message{};
  ...
  UpdateDefaultBResponseBody() {}

  explicit UpdateDefaultBResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~UpdateDefaultBResponseBody() = default;
};
class UpdateDefaultBResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<UpdateDefaultBResponseBody> body{};

  UpdateDefaultBResponse() {}

  explicit UpdateDefaultBResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        UpdateDefaultBResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<UpdateDefaultBResponseBody>(model1);
      }
    }
  }


  virtual ~UpdateDefaultBResponse() = default;
};
class UpdatePhoneNumberRequest : public Darabonba::Model {
public:
  shared_ptr<string> bindToken{};
  shared_ptr<string> newPhoneNo{};
  shared_ptr<long> ownerId{};
  shared_ptr<string> poolKey{};
  shared_ptr<string> resourceOwnerAccount{};
  shared_ptr<long> resourceOwnerId{};
  ...
  explicit UpdatePhoneNumberRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (newPhoneNo) {
      res["NewPhoneNo"] = boost::any(*newPhoneNo);
    }
    if (ownerId) {
      res["OwnerId"] = boost::any(*ownerId);
    }
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("NewPhoneNo") != m.end() && !m["NewPhoneNo"].empty()) {
      newPhoneNo = make_shared<string>(boost::any_cast<string>(m["NewPhoneNo"]));
    }
    if (m.find("OwnerId") != m.end() && !m["OwnerId"].empty()) {
      ownerId = make_shared<long>(boost::any_cast<long>(m["OwnerId"]));
    }
  ...
  virtual ~UpdatePhoneNumberRequest() = default;
};
class UpdatePhoneNumberResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> code{};
  shared_ptr<string> data{};
  shared_ptr<string> message{};
  ...
  UpdatePhoneNumberResponseBody() {}

  explicit UpdatePhoneNumberResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~UpdatePhoneNumberResponseBody() = default;
};
class UpdatePhoneNumberResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<UpdatePhoneNumberResponseBody> body{};

  UpdatePhoneNumberResponse() {}

  explicit UpdatePhoneNumberResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        UpdatePhoneNumberResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<UpdatePhoneNumberResponseBody>(model1);
      }
    }
  }


  virtual ~UpdatePhoneNumberResponse() = default;
};
class UpdatePhoneSwitchRequest : public Darabonba::Model {
public:
  shared_ptr<long> ownerId{};
  shared_ptr<string> poolKey{};
  shared_ptr<string> resourceOwnerAccount{};
  ...
  explicit UpdatePhoneSwitchRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~UpdatePhoneSwitchRequest() = default;
};
class UpdatePhoneSwitchResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> code{};
  shared_ptr<string> data{};
  shared_ptr<string> message{};
  ...
  UpdatePhoneSwitchResponseBody() {}

  explicit UpdatePhoneSwitchResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~UpdatePhoneSwitchResponseBody() = default;
};
class UpdatePhoneSwitchResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<UpdatePhoneSwitchResponseBody> body{};

  UpdatePhoneSwitchResponse() {}

  explicit UpdatePhoneSwitchResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        UpdatePhoneSwitchResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<UpdatePhoneSwitchResponseBody>(model1);
      }
    }
  }


  virtual ~UpdatePhoneSwitchResponse() = default;
};
...
public:
  ...
  GetFaceVerifyResponse getFaceVerifyWithOptions(shared_ptr<GetFaceVerifyRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  GetFaceVerifyResponse getFaceVerify(shared_ptr<GetFaceVerifyRequest> request);
  ...
  UpdateDefaultBResponse updateDefaultBWithOptions(shared_ptr<UpdateDefaultBRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  UpdateDefaultBResponse updateDefaultB(shared_ptr<UpdateDefaultBRequest> request);
  UpdatePhoneNumberResponse updatePhoneNumberWithOptions(shared_ptr<UpdatePhoneNumberRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  UpdatePhoneNumberResponse updatePhoneNumber(shared_ptr<UpdatePhoneNumberRequest> request);
  UpdatePhoneSwitchResponse updatePhoneSwitchWithOptions(shared_ptr<UpdatePhoneSwitchRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  UpdatePhoneSwitchResponse updatePhoneSwitch(shared_ptr<UpdatePhoneSwitchRequest> request);
