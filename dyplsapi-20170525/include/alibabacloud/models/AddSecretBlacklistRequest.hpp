...
#ifndef ALIBABACLOUD_MODELS_ADDSECRETBLACKLISTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ADDSECRETBLACKLISTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddSecretBlacklistRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddSecretBlacklistRequest& obj) { 
    ...
    AddSecretBlacklistRequest() = default ;
    AddSecretBlacklistRequest(const AddSecretBlacklistRequest &) = default ;
    AddSecretBlacklistRequest(AddSecretBlacklistRequest &&) = default ;
    AddSecretBlacklistRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddSecretBlacklistRequest() = default ;
    AddSecretBlacklistRequest& operator=(const AddSecretBlacklistRequest &) = default ;
    AddSecretBlacklistRequest& operator=(AddSecretBlacklistRequest &&) = default ;
    ...
    inline AddSecretBlacklistRequest& setBlackNo(string blackNo) { DARABONBA_PTR_SET_VALUE(blackNo_, blackNo) };
    ...
    inline AddSecretBlacklistRequest& setBlackType(string blackType) { DARABONBA_PTR_SET_VALUE(blackType_, blackType) };
    ...
    inline AddSecretBlacklistRequest& setPoolKey(string poolKey) { DARABONBA_PTR_SET_VALUE(poolKey_, poolKey) };
    ...
    inline AddSecretBlacklistRequest& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline AddSecretBlacklistRequest& setWayControl(string wayControl) { DARABONBA_PTR_SET_VALUE(wayControl_, wayControl) };
