...
#ifndef ALIBABACLOUD_MODELS_CREATEPICKUPWAYBILLPREQUERYREQUESTCONSIGNEEINFOADDRESSINFO_HPP_
#define ALIBABACLOUD_MODELS_CREATEPICKUPWAYBILLPREQUERYREQUESTCONSIGNEEINFOADDRESSINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo& obj) { 
    ...
    CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo() = default ;
    CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo(const CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo &) = default ;
    CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo(CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo &&) = default ;
    CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo() = default ;
    CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo& operator=(const CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo &) = default ;
    CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo& operator=(CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo &&) = default ;
    ...
    inline CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo& setAddressDetail(string addressDetail) { DARABONBA_PTR_SET_VALUE(addressDetail_, addressDetail) };
    ...
    inline CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo& setAreaName(string areaName) { DARABONBA_PTR_SET_VALUE(areaName_, areaName) };
    ...
    inline CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo& setCityName(string cityName) { DARABONBA_PTR_SET_VALUE(cityName_, cityName) };
    ...
    inline CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo& setProvinceName(string provinceName) { DARABONBA_PTR_SET_VALUE(provinceName_, provinceName) };
    ...
    inline CreatePickUpWaybillPreQueryRequestConsigneeInfoAddressInfo& setTownName(string townName) { DARABONBA_PTR_SET_VALUE(townName_, townName) };
