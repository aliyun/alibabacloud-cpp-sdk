...
#ifndef ALIBABACLOUD_MODELS_BINDAXNFIXEDLINEREQUESTEXTRA_HPP_
#define ALIBABACLOUD_MODELS_BINDAXNFIXEDLINEREQUESTEXTRA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const BindAxnFixedLineRequestExtra& obj) { 
      DARABONBA_PTR_TO_JSON(Callback, callback_);
      DARABONBA_PTR_TO_JSON(Callrecording, callrecording_);
    };
    friend void from_json(const Darabonba::Json& j, BindAxnFixedLineRequestExtra& obj) { 
      DARABONBA_PTR_FROM_JSON(Callback, callback_);
      DARABONBA_PTR_FROM_JSON(Callrecording, callrecording_);
    };
    BindAxnFixedLineRequestExtra() = default ;
    BindAxnFixedLineRequestExtra(const BindAxnFixedLineRequestExtra &) = default ;
    BindAxnFixedLineRequestExtra(BindAxnFixedLineRequestExtra &&) = default ;
    BindAxnFixedLineRequestExtra(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BindAxnFixedLineRequestExtra() = default ;
    BindAxnFixedLineRequestExtra& operator=(const BindAxnFixedLineRequestExtra &) = default ;
    BindAxnFixedLineRequestExtra& operator=(BindAxnFixedLineRequestExtra &&) = default ;
    ...
    inline BindAxnFixedLineRequestExtra& setCallback(string callback) { DARABONBA_PTR_SET_VALUE(callback_, callback) };
    ...
    inline BindAxnFixedLineRequestExtra& setCallrecording(string callrecording) { DARABONBA_PTR_SET_VALUE(callrecording_, callrecording) };
