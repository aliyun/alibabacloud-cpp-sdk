...
#ifndef ALIBABACLOUD_MODELS_CREATEPICKUPWAYBILLREQUESTSENDADDRESS_HPP_
#define ALIBABACLOUD_MODELS_CREATEPICKUPWAYBILLREQUESTSENDADDRESS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePickUpWaybillRequestSendAddress& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePickUpWaybillRequestSendAddress& obj) { 
    ...
    CreatePickUpWaybillRequestSendAddress() = default ;
    CreatePickUpWaybillRequestSendAddress(const CreatePickUpWaybillRequestSendAddress &) = default ;
    CreatePickUpWaybillRequestSendAddress(CreatePickUpWaybillRequestSendAddress &&) = default ;
    CreatePickUpWaybillRequestSendAddress(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePickUpWaybillRequestSendAddress() = default ;
    CreatePickUpWaybillRequestSendAddress& operator=(const CreatePickUpWaybillRequestSendAddress &) = default ;
    CreatePickUpWaybillRequestSendAddress& operator=(CreatePickUpWaybillRequestSendAddress &&) = default ;
    ...
    inline CreatePickUpWaybillRequestSendAddress& setAddressDetail(string addressDetail) { DARABONBA_PTR_SET_VALUE(addressDetail_, addressDetail) };
    ...
    inline CreatePickUpWaybillRequestSendAddress& setAreaName(string areaName) { DARABONBA_PTR_SET_VALUE(areaName_, areaName) };
    ...
    inline CreatePickUpWaybillRequestSendAddress& setCityName(string cityName) { DARABONBA_PTR_SET_VALUE(cityName_, cityName) };
    ...
    inline CreatePickUpWaybillRequestSendAddress& setProvinceName(string provinceName) { DARABONBA_PTR_SET_VALUE(provinceName_, provinceName) };
    ...
    inline CreatePickUpWaybillRequestSendAddress& setTownName(string townName) { DARABONBA_PTR_SET_VALUE(townName_, townName) };
