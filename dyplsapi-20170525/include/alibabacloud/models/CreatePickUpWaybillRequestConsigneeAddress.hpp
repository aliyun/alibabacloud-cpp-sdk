...
#ifndef ALIBABACLOUD_MODELS_CREATEPICKUPWAYBILLREQUESTCONSIGNEEADDRESS_HPP_
#define ALIBABACLOUD_MODELS_CREATEPICKUPWAYBILLREQUESTCONSIGNEEADDRESS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePickUpWaybillRequestConsigneeAddress& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePickUpWaybillRequestConsigneeAddress& obj) { 
    ...
    CreatePickUpWaybillRequestConsigneeAddress() = default ;
    CreatePickUpWaybillRequestConsigneeAddress(const CreatePickUpWaybillRequestConsigneeAddress &) = default ;
    CreatePickUpWaybillRequestConsigneeAddress(CreatePickUpWaybillRequestConsigneeAddress &&) = default ;
    CreatePickUpWaybillRequestConsigneeAddress(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePickUpWaybillRequestConsigneeAddress() = default ;
    CreatePickUpWaybillRequestConsigneeAddress& operator=(const CreatePickUpWaybillRequestConsigneeAddress &) = default ;
    CreatePickUpWaybillRequestConsigneeAddress& operator=(CreatePickUpWaybillRequestConsigneeAddress &&) = default ;
    ...
    inline CreatePickUpWaybillRequestConsigneeAddress& setAddressDetail(string addressDetail) { DARABONBA_PTR_SET_VALUE(addressDetail_, addressDetail) };
    ...
    inline CreatePickUpWaybillRequestConsigneeAddress& setAreaName(string areaName) { DARABONBA_PTR_SET_VALUE(areaName_, areaName) };
    ...
    inline CreatePickUpWaybillRequestConsigneeAddress& setCityName(string cityName) { DARABONBA_PTR_SET_VALUE(cityName_, cityName) };
    ...
    inline CreatePickUpWaybillRequestConsigneeAddress& setProvinceName(string provinceName) { DARABONBA_PTR_SET_VALUE(provinceName_, provinceName) };
    ...
    inline CreatePickUpWaybillRequestConsigneeAddress& setTownName(string townName) { DARABONBA_PTR_SET_VALUE(townName_, townName) };
