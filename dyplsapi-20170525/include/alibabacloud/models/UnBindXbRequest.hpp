...
#ifndef ALIBABACLOUD_MODELS_UNBINDXBREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UNBINDXBREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UnBindXBRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UnBindXBRequest& obj) { 
    ...
    UnBindXBRequest() = default ;
    UnBindXBRequest(const UnBindXBRequest &) = default ;
    UnBindXBRequest(UnBindXBRequest &&) = default ;
    UnBindXBRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UnBindXBRequest() = default ;
    UnBindXBRequest& operator=(const UnBindXBRequest &) = default ;
    UnBindXBRequest& operator=(UnBindXBRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->authId_ == nullptr
        ...
        && return this->resourceOwnerId_ == nullptr && return this->telX_ == nullptr; };
    ...
    inline UnBindXBRequest& setAuthId(string authId) { DARABONBA_PTR_SET_VALUE(authId_, authId) };
    ...
    inline UnBindXBRequest& setCallerParentId(int64_t callerParentId) { DARABONBA_PTR_SET_VALUE(callerParentId_, callerParentId) };
    ...
    inline UnBindXBRequest& setCustomerPoolKey(string customerPoolKey) { DARABONBA_PTR_SET_VALUE(customerPoolKey_, customerPoolKey) };
    ...
    inline UnBindXBRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline UnBindXBRequest& setReqId(string reqId) { DARABONBA_PTR_SET_VALUE(reqId_, reqId) };
    ...
    inline UnBindXBRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline UnBindXBRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline UnBindXBRequest& setTelX(string telX) { DARABONBA_PTR_SET_VALUE(telX_, telX) };
