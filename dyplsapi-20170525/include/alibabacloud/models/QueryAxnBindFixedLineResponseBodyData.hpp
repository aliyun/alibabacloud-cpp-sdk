...
#ifndef ALIBABACLOUD_MODELS_QUERYAXNBINDFIXEDLINERESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_QUERYAXNBINDFIXEDLINERESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryAxnBindFixedLineResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryAxnBindFixedLineResponseBodyData& obj) { 
    ...
    QueryAxnBindFixedLineResponseBodyData() = default ;
    QueryAxnBindFixedLineResponseBodyData(const QueryAxnBindFixedLineResponseBodyData &) = default ;
    QueryAxnBindFixedLineResponseBodyData(QueryAxnBindFixedLineResponseBodyData &&) = default ;
    QueryAxnBindFixedLineResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryAxnBindFixedLineResponseBodyData() = default ;
    QueryAxnBindFixedLineResponseBodyData& operator=(const QueryAxnBindFixedLineResponseBodyData &) = default ;
    QueryAxnBindFixedLineResponseBodyData& operator=(QueryAxnBindFixedLineResponseBodyData &&) = default ;
    ...
    inline QueryAxnBindFixedLineResponseBodyData& setAnucode(string anucode) { DARABONBA_PTR_SET_VALUE(anucode_, anucode) };
    ...
    inline QueryAxnBindFixedLineResponseBodyData& setAnucodecalled(string anucodecalled) { DARABONBA_PTR_SET_VALUE(anucodecalled_, anucodecalled) };
    ...
    inline QueryAxnBindFixedLineResponseBodyData& setAreacode(string areacode) { DARABONBA_PTR_SET_VALUE(areacode_, areacode) };
    ...
    inline QueryAxnBindFixedLineResponseBodyData& setExpiration(string expiration) { DARABONBA_PTR_SET_VALUE(expiration_, expiration) };


    // extra Field Functions 
    bool hasExtra() const { return this->extra_ != nullptr;};
    void deleteExtra() { this->extra_ = nullptr;};
    inline const Models::QueryAxnBindFixedLineResponseBodyDataExtra & extra() const { DARABONBA_PTR_GET_CONST(extra_, Models::QueryAxnBindFixedLineResponseBodyDataExtra) };
    inline Models::QueryAxnBindFixedLineResponseBodyDataExtra extra() { DARABONBA_PTR_GET(extra_, Models::QueryAxnBindFixedLineResponseBodyDataExtra) };
    inline QueryAxnBindFixedLineResponseBodyData& setExtra(const Models::QueryAxnBindFixedLineResponseBodyDataExtra & extra) { DARABONBA_PTR_SET_VALUE(extra_, extra) };
    inline QueryAxnBindFixedLineResponseBodyData& setExtra(Models::QueryAxnBindFixedLineResponseBodyDataExtra && extra) { DARABONBA_PTR_SET_RVALUE(extra_, extra) };
    ...
    inline QueryAxnBindFixedLineResponseBodyData& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline QueryAxnBindFixedLineResponseBodyData& setSubid(string subid) { DARABONBA_PTR_SET_VALUE(subid_, subid) };
    ...
    inline QueryAxnBindFixedLineResponseBodyData& setSubts(string subts) { DARABONBA_PTR_SET_VALUE(subts_, subts) };
    ...
    inline QueryAxnBindFixedLineResponseBodyData& setTAnucodeConnect(string TAnucodeConnect) { DARABONBA_PTR_SET_VALUE(TAnucodeConnect_, TAnucodeConnect) };
    ...
    inline QueryAxnBindFixedLineResponseBodyData& setTelA(string telA) { DARABONBA_PTR_SET_VALUE(telA_, telA) };
    ...
    inline QueryAxnBindFixedLineResponseBodyData& setTelB(string telB) { DARABONBA_PTR_SET_VALUE(telB_, telB) };
    ...
    inline QueryAxnBindFixedLineResponseBodyData& setTelX(string telX) { DARABONBA_PTR_SET_VALUE(telX_, telX) };
  ...
  protected:
    ...
    // 额外字段
    std::shared_ptr<Models::QueryAxnBindFixedLineResponseBodyDataExtra> extra_ = nullptr;
    // 接入商自有字段，最大250字符长度
