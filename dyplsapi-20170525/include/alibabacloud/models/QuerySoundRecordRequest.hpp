...
#ifndef ALIBABACLOUD_MODELS_QUERYSOUNDRECORDREQUEST_HPP_
#define ALIBABACLOUD_MODELS_QUERYSOUNDRECORDREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QuerySoundRecordRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QuerySoundRecordRequest& obj) { 
    ...
    QuerySoundRecordRequest() = default ;
    QuerySoundRecordRequest(const QuerySoundRecordRequest &) = default ;
    QuerySoundRecordRequest(QuerySoundRecordRequest &&) = default ;
    QuerySoundRecordRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QuerySoundRecordRequest() = default ;
    QuerySoundRecordRequest& operator=(const QuerySoundRecordRequest &) = default ;
    QuerySoundRecordRequest& operator=(QuerySoundRecordRequest &&) = default ;
    ...
    inline QuerySoundRecordRequest& setCallId(string callId) { DARABONBA_PTR_SET_VALUE(callId_, callId) };
    ...
    inline QuerySoundRecordRequest& setCallerParentId(int64_t callerParentId) { DARABONBA_PTR_SET_VALUE(callerParentId_, callerParentId) };
    ...
    inline QuerySoundRecordRequest& setCustomerPoolKey(string customerPoolKey) { DARABONBA_PTR_SET_VALUE(customerPoolKey_, customerPoolKey) };
    ...
    inline QuerySoundRecordRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline QuerySoundRecordRequest& setReqId(string reqId) { DARABONBA_PTR_SET_VALUE(reqId_, reqId) };
    ...
    inline QuerySoundRecordRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline QuerySoundRecordRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
