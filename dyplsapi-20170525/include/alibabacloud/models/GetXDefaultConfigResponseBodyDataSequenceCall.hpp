...
#ifndef ALIBABACLOUD_MODELS_GETXDEFAULTCONFIGRESPONSEBODYDATASEQUENCECALL_HPP_
#define ALIBABACLOUD_MODELS_GETXDEFAULTCONFIGRESPONSEBODYDATASEQUENCECALL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetXDefaultConfigResponseBodyDataSequenceCall& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetXDefaultConfigResponseBodyDataSequenceCall& obj) { 
    ...
    GetXDefaultConfigResponseBodyDataSequenceCall() = default ;
    GetXDefaultConfigResponseBodyDataSequenceCall(const GetXDefaultConfigResponseBodyDataSequenceCall &) = default ;
    GetXDefaultConfigResponseBodyDataSequenceCall(GetXDefaultConfigResponseBodyDataSequenceCall &&) = default ;
    GetXDefaultConfigResponseBodyDataSequenceCall(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetXDefaultConfigResponseBodyDataSequenceCall() = default ;
    GetXDefaultConfigResponseBodyDataSequenceCall& operator=(const GetXDefaultConfigResponseBodyDataSequenceCall &) = default ;
    GetXDefaultConfigResponseBodyDataSequenceCall& operator=(GetXDefaultConfigResponseBodyDataSequenceCall &&) = default ;
    ...
    inline GetXDefaultConfigResponseBodyDataSequenceCall& setSequenceCallNoPlayCode(string sequenceCallNoPlayCode) { DARABONBA_PTR_SET_VALUE(sequenceCallNoPlayCode_, sequenceCallNoPlayCode) };
    ...
    inline GetXDefaultConfigResponseBodyDataSequenceCall& setSequenceCalledNo(string sequenceCalledNo) { DARABONBA_PTR_SET_VALUE(sequenceCalledNo_, sequenceCalledNo) };
    ...
    inline GetXDefaultConfigResponseBodyDataSequenceCall& setSequenceCalledPlayCode(string sequenceCalledPlayCode) { DARABONBA_PTR_SET_VALUE(sequenceCalledPlayCode_, sequenceCalledPlayCode) };
