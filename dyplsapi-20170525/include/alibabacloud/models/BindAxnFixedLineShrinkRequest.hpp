...
#ifndef ALIBABACLOUD_MODELS_BINDAXNFIXEDLINESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_BINDAXNFIXEDLINESHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const BindAxnFixedLineShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, BindAxnFixedLineShrinkRequest& obj) { 
    ...
    BindAxnFixedLineShrinkRequest() = default ;
    BindAxnFixedLineShrinkRequest(const BindAxnFixedLineShrinkRequest &) = default ;
    BindAxnFixedLineShrinkRequest(BindAxnFixedLineShrinkRequest &&) = default ;
    BindAxnFixedLineShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BindAxnFixedLineShrinkRequest() = default ;
    BindAxnFixedLineShrinkRequest& operator=(const BindAxnFixedLineShrinkRequest &) = default ;
    BindAxnFixedLineShrinkRequest& operator=(BindAxnFixedLineShrinkRequest &&) = default ;
    ...
    inline BindAxnFixedLineShrinkRequest& setAnucode(string anucode) { DARABONBA_PTR_SET_VALUE(anucode_, anucode) };
    ...
    inline BindAxnFixedLineShrinkRequest& setAnucodecalled(string anucodecalled) { DARABONBA_PTR_SET_VALUE(anucodecalled_, anucodecalled) };
    ...
    inline BindAxnFixedLineShrinkRequest& setAppId(string appId) { DARABONBA_PTR_SET_VALUE(appId_, appId) };
    ...
    inline BindAxnFixedLineShrinkRequest& setAreacode(string areacode) { DARABONBA_PTR_SET_VALUE(areacode_, areacode) };
    ...
    inline BindAxnFixedLineShrinkRequest& setBindType(string bindType) { DARABONBA_PTR_SET_VALUE(bindType_, bindType) };
    ...
    inline BindAxnFixedLineShrinkRequest& setExpiration(string expiration) { DARABONBA_PTR_SET_VALUE(expiration_, expiration) };
    ...
    inline BindAxnFixedLineShrinkRequest& setExtraShrink(string extraShrink) { DARABONBA_PTR_SET_VALUE(extraShrink_, extraShrink) };
    ...
    inline BindAxnFixedLineShrinkRequest& setOrderId(string orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline BindAxnFixedLineShrinkRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline BindAxnFixedLineShrinkRequest& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline BindAxnFixedLineShrinkRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline BindAxnFixedLineShrinkRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline BindAxnFixedLineShrinkRequest& setSubts(string subts) { DARABONBA_PTR_SET_VALUE(subts_, subts) };
    ...
    inline BindAxnFixedLineShrinkRequest& setTAnucodeConnect(string TAnucodeConnect) { DARABONBA_PTR_SET_VALUE(TAnucodeConnect_, TAnucodeConnect) };
    ...
    inline BindAxnFixedLineShrinkRequest& setTelA(string telA) { DARABONBA_PTR_SET_VALUE(telA_, telA) };
    ...
    inline BindAxnFixedLineShrinkRequest& setTelB(string telB) { DARABONBA_PTR_SET_VALUE(telB_, telB) };
    ...
    inline BindAxnFixedLineShrinkRequest& setTelX(string telX) { DARABONBA_PTR_SET_VALUE(telX_, telX) };
    ...
    inline BindAxnFixedLineShrinkRequest& setTs(string ts) { DARABONBA_PTR_SET_VALUE(ts_, ts) };
