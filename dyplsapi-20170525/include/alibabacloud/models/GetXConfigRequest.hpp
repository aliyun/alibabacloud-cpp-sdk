...
#ifndef ALIBABACLOUD_MODELS_GETXCONFIGREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETXCONFIGREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetXConfigRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetXConfigRequest& obj) { 
    ...
    GetXConfigRequest() = default ;
    GetXConfigRequest(const GetXConfigRequest &) = default ;
    GetXConfigRequest(GetXConfigRequest &&) = default ;
    GetXConfigRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetXConfigRequest() = default ;
    GetXConfigRequest& operator=(const GetXConfigRequest &) = default ;
    GetXConfigRequest& operator=(GetXConfigRequest &&) = default ;
    ...
    inline GetXConfigRequest& setCallerParentId(int64_t callerParentId) { DARABONBA_PTR_SET_VALUE(callerParentId_, callerParentId) };
    ...
    inline GetXConfigRequest& setCustomerPoolKey(string customerPoolKey) { DARABONBA_PTR_SET_VALUE(customerPoolKey_, customerPoolKey) };
    ...
    inline GetXConfigRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline GetXConfigRequest& setReqId(string reqId) { DARABONBA_PTR_SET_VALUE(reqId_, reqId) };
    ...
    inline GetXConfigRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline GetXConfigRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline GetXConfigRequest& setTelX(string telX) { DARABONBA_PTR_SET_VALUE(telX_, telX) };
