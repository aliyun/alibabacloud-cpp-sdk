...
#ifndef ALIBABACLOUD_MODELS_GETXDEFAULTCONFIGRESPONSEBODYDATAREACHJSON_HPP_
#define ALIBABACLOUD_MODELS_GETXDEFAULTCONFIGRESPONSEBODYDATAREACHJSON_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetXDefaultConfigResponseBodyDataReachJson& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetXDefaultConfigResponseBodyDataReachJson& obj) { 
    ...
    GetXDefaultConfigResponseBodyDataReachJson() = default ;
    GetXDefaultConfigResponseBodyDataReachJson(const GetXDefaultConfigResponseBodyDataReachJson &) = default ;
    GetXDefaultConfigResponseBodyDataReachJson(GetXDefaultConfigResponseBodyDataReachJson &&) = default ;
    GetXDefaultConfigResponseBodyDataReachJson(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetXDefaultConfigResponseBodyDataReachJson() = default ;
    GetXDefaultConfigResponseBodyDataReachJson& operator=(const GetXDefaultConfigResponseBodyDataReachJson &) = default ;
    GetXDefaultConfigResponseBodyDataReachJson& operator=(GetXDefaultConfigResponseBodyDataReachJson &&) = default ;
    ...
    inline GetXDefaultConfigResponseBodyDataReachJson& setCallDir(string callDir) { DARABONBA_PTR_SET_VALUE(callDir_, callDir) };
    ...
    inline GetXDefaultConfigResponseBodyDataReachJson& setCallStatus(string callStatus) { DARABONBA_PTR_SET_VALUE(callStatus_, callStatus) };
    ...
    inline GetXDefaultConfigResponseBodyDataReachJson& setReceiveDir(string receiveDir) { DARABONBA_PTR_SET_VALUE(receiveDir_, receiveDir) };
    ...
    inline GetXDefaultConfigResponseBodyDataReachJson& setRuleId(string ruleId) { DARABONBA_PTR_SET_VALUE(ruleId_, ruleId) };
    ...
    inline GetXDefaultConfigResponseBodyDataReachJson& setRuleName(string ruleName) { DARABONBA_PTR_SET_VALUE(ruleName_, ruleName) };
    ...
    inline GetXDefaultConfigResponseBodyDataReachJson& setRuleType(string ruleType) { DARABONBA_PTR_SET_VALUE(ruleType_, ruleType) };
    ...
    inline GetXDefaultConfigResponseBodyDataReachJson& setTempId(string tempId) { DARABONBA_PTR_SET_VALUE(tempId_, tempId) };
