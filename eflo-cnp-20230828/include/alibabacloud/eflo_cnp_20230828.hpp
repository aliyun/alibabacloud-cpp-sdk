...
class CheckServiceLinkedRoleEfloCnpForDeletingRequest : public Darabonba::Model {
public:
  ...
  explicit CheckServiceLinkedRoleEfloCnpForDeletingRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~CheckServiceLinkedRoleEfloCnpForDeletingRequest() = default;
};
class CheckServiceLinkedRoleEfloCnpForDeletingResponseBodyResources : public Darabonba::Model {
public:
  shared_ptr<string> region{};
  shared_ptr<vector<string>> resources{};

  CheckServiceLinkedRoleEfloCnpForDeletingResponseBodyResources() {}

  explicit CheckServiceLinkedRoleEfloCnpForDeletingResponseBodyResources(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~CheckServiceLinkedRoleEfloCnpForDeletingResponseBodyResources() = default;
};
class CheckServiceLinkedRoleEfloCnpForDeletingResponseBody : public Darabonba::Model {
public:
  shared_ptr<bool> deletable{};
  shared_ptr<string> requestId{};
  shared_ptr<vector<CheckServiceLinkedRoleEfloCnpForDeletingResponseBodyResources>> resources{};

  CheckServiceLinkedRoleEfloCnpForDeletingResponseBody() {}

  explicit CheckServiceLinkedRoleEfloCnpForDeletingResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("Resources") != m.end() && !m["Resources"].empty()) {
      if (typeid(vector<boost::any>) == m["Resources"].type()) {
        vector<CheckServiceLinkedRoleEfloCnpForDeletingResponseBodyResources> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["Resources"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            CheckServiceLinkedRoleEfloCnpForDeletingResponseBodyResources model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        resources = make_shared<vector<CheckServiceLinkedRoleEfloCnpForDeletingResponseBodyResources>>(expect1);
      }
    }
  }


  virtual ~CheckServiceLinkedRoleEfloCnpForDeletingResponseBody() = default;
};
class CheckServiceLinkedRoleEfloCnpForDeletingResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<CheckServiceLinkedRoleEfloCnpForDeletingResponseBody> body{};

  CheckServiceLinkedRoleEfloCnpForDeletingResponse() {}

  explicit CheckServiceLinkedRoleEfloCnpForDeletingResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        CheckServiceLinkedRoleEfloCnpForDeletingResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<CheckServiceLinkedRoleEfloCnpForDeletingResponseBody>(model1);
      }
    }
  }


  virtual ~CheckServiceLinkedRoleEfloCnpForDeletingResponse() = default;
};
...
public:
  ...
  CheckServiceLinkedRoleEfloCnpForDeletingResponse checkServiceLinkedRoleEfloCnpForDeletingWithOptions(shared_ptr<CheckServiceLinkedRoleEfloCnpForDeletingRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  CheckServiceLinkedRoleEfloCnpForDeletingResponse checkServiceLinkedRoleEfloCnpForDeleting(shared_ptr<CheckServiceLinkedRoleEfloCnpForDeletingRequest> request);
