...
CheckServiceLinkedRoleEfloCnpForDeletingResponse Alibabacloud_Eflo-cnp20230828::Client::checkServiceLinkedRoleEfloCnpForDeletingWithOptions(shared_ptr<CheckServiceLinkedRoleEfloCnpForDeletingRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("CheckServiceLinkedRoleEfloCnpForDeleting"))},
    {"version", boost::any(string("2023-08-28"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return CheckServiceLinkedRoleEfloCnpForDeletingResponse(callApi(params, req, runtime));
}

CheckServiceLinkedRoleEfloCnpForDeletingResponse Alibabacloud_Eflo-cnp20230828::Client::checkServiceLinkedRoleEfloCnpForDeleting(shared_ptr<CheckServiceLinkedRoleEfloCnpForDeletingRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
