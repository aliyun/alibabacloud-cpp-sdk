...
namespace Models
{
  ...
  public:
    ...
    inline const VerifyMaterialResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, VerifyMaterialResponseBody) };
    inline VerifyMaterialResponseBody getBody() { DARABONBA_PTR_GET(body_, VerifyMaterialResponseBody) };
  ...
  protected:
    ...
    shared_ptr<VerifyMaterialResponseBody> body_ {};
  };
