...
#ifndef ALIBABACLOUD_MODELS_MOBILE3METASIMPLEVERIFYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MOBILE3METASIMPLEVERIFYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const Mobile3MetaSimpleVerifyRequest& obj) { 
      DARABONBA_PTR_TO_JSON(IdentifyNum, identifyNum_);
      DARABONBA_PTR_TO_JSON(Mobile, mobile_);
      DARABONBA_PTR_TO_JSON(ParamType, paramType_);
      DARABONBA_PTR_TO_JSON(UserName, userName_);
    };
    friend void from_json(const Darabonba::Json& j, Mobile3MetaSimpleVerifyRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(IdentifyNum, identifyNum_);
      DARABONBA_PTR_FROM_JSON(Mobile, mobile_);
      DARABONBA_PTR_FROM_JSON(ParamType, paramType_);
      DARABONBA_PTR_FROM_JSON(UserName, userName_);
    };
    Mobile3MetaSimpleVerifyRequest() = default ;
    Mobile3MetaSimpleVerifyRequest(const Mobile3MetaSimpleVerifyRequest &) = default ;
    Mobile3MetaSimpleVerifyRequest(Mobile3MetaSimpleVerifyRequest &&) = default ;
    Mobile3MetaSimpleVerifyRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~Mobile3MetaSimpleVerifyRequest() = default ;
    Mobile3MetaSimpleVerifyRequest& operator=(const Mobile3MetaSimpleVerifyRequest &) = default ;
    Mobile3MetaSimpleVerifyRequest& operator=(Mobile3MetaSimpleVerifyRequest &&) = default ;
    ...
    inline Mobile3MetaSimpleVerifyRequest& setIdentifyNum(string identifyNum) { DARABONBA_PTR_SET_VALUE(identifyNum_, identifyNum) };
    ...
    inline Mobile3MetaSimpleVerifyRequest& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline Mobile3MetaSimpleVerifyRequest& setParamType(string paramType) { DARABONBA_PTR_SET_VALUE(paramType_, paramType) };
    ...
    inline Mobile3MetaSimpleVerifyRequest& setUserName(string userName) { DARABONBA_PTR_SET_VALUE(userName_, userName) };
