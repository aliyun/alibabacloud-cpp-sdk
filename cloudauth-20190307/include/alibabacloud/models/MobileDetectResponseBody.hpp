...
namespace Models
{
  ...
  public:
    ...
    inline const MobileDetectResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, MobileDetectResponseBodyResultObject) };
    inline MobileDetectResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, MobileDetectResponseBodyResultObject) };
    inline MobileDetectResponseBody& setResultObject(const MobileDetectResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline MobileDetectResponseBody& setResultObject(MobileDetectResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    std::shared_ptr<MobileDetectResponseBodyResultObject> resultObject_ = nullptr;
  };
