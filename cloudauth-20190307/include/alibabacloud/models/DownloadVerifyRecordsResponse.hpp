...
namespace Models
{
  ...
  public:
    ...
    inline const DownloadVerifyRecordsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DownloadVerifyRecordsResponseBody) };
    inline DownloadVerifyRecordsResponseBody getBody() { DARABONBA_PTR_GET(body_, DownloadVerifyRecordsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DownloadVerifyRecordsResponseBody> body_ {};
  };
