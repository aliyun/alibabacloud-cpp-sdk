...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAllCustomizeFlowStrategyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteAllCustomizeFlowStrategyResponseBody) };
    inline DeleteAllCustomizeFlowStrategyResponseBody body() { DARABONBA_PTR_GET(body_, DeleteAllCustomizeFlowStrategyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteAllCustomizeFlowStrategyResponseBody> body_ = nullptr;
  };
