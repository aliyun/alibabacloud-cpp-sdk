...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSceneConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteSceneConfigResponseBody) };
    inline DeleteSceneConfigResponseBody body() { DARABONBA_PTR_GET(body_, DeleteSceneConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteSceneConfigResponseBody> body_ = nullptr;
  };
