...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryBlackListStrategyResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<QueryBlackListStrategyResponseBodyResultObject>) };
    inline vector<QueryBlackListStrategyResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<QueryBlackListStrategyResponseBodyResultObject>) };
    inline QueryBlackListStrategyResponseBody& setResultObject(const vector<QueryBlackListStrategyResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline QueryBlackListStrategyResponseBody& setResultObject(vector<QueryBlackListStrategyResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryBlackListStrategyResponseBodyResultObject>> resultObject_ = nullptr;
  };
