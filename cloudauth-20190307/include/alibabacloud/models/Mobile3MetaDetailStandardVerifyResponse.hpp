...
namespace Models
{
  ...
  public:
    ...
    inline const Mobile3MetaDetailStandardVerifyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, Mobile3MetaDetailStandardVerifyResponseBody) };
    inline Mobile3MetaDetailStandardVerifyResponseBody getBody() { DARABONBA_PTR_GET(body_, Mobile3MetaDetailStandardVerifyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<Mobile3MetaDetailStandardVerifyResponseBody> body_ {};
  };
