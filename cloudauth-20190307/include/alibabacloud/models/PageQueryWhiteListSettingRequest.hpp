...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->certNo_ == nullptr
        && return this->certifyId_ == nullptr && return this->currentPage_ == nullptr && return this->pageSize_ == nullptr && return this->sceneId_ == nullptr && return this->serviceCode_ == nullptr
        && return this->status_ == nullptr && return this->validEndDate_ == nullptr && return this->validStartDate_ == nullptr; };
