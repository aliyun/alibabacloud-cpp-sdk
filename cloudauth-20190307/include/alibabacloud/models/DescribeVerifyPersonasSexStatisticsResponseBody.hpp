...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVerifyPersonasSexStatisticsResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeVerifyPersonasSexStatisticsResponseBodyResultObject) };
    inline DescribeVerifyPersonasSexStatisticsResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeVerifyPersonasSexStatisticsResponseBodyResultObject) };
    inline DescribeVerifyPersonasSexStatisticsResponseBody& setResultObject(const DescribeVerifyPersonasSexStatisticsResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeVerifyPersonasSexStatisticsResponseBody& setResultObject(DescribeVerifyPersonasSexStatisticsResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned data.
    std::shared_ptr<DescribeVerifyPersonasSexStatisticsResponseBodyResultObject> resultObject_ = nullptr;
  };
