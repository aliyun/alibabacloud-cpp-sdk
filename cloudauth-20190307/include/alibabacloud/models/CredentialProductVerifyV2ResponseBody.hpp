...
namespace Models
{
  ...
  public:
    ...
    inline const CredentialProductVerifyV2ResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, CredentialProductVerifyV2ResponseBodyResultObject) };
    inline CredentialProductVerifyV2ResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, CredentialProductVerifyV2ResponseBodyResultObject) };
    inline CredentialProductVerifyV2ResponseBody& setResultObject(const CredentialProductVerifyV2ResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline CredentialProductVerifyV2ResponseBody& setResultObject(CredentialProductVerifyV2ResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Result object.
    std::shared_ptr<CredentialProductVerifyV2ResponseBodyResultObject> resultObject_ = nullptr;
  };
