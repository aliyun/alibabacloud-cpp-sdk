...
namespace Models
{
  ...
  public:
    ...
    inline const DeepfakeDetectResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DeepfakeDetectResponseBodyResultObject) };
    inline DeepfakeDetectResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DeepfakeDetectResponseBodyResultObject) };
    inline DeepfakeDetectResponseBody& setResultObject(const DeepfakeDetectResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DeepfakeDetectResponseBody& setResultObject(DeepfakeDetectResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    std::shared_ptr<DeepfakeDetectResponseBodyResultObject> resultObject_ = nullptr;
  };
