...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVerifyFailStatisticsResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeVerifyFailStatisticsResponseBodyResultObject) };
    inline DescribeVerifyFailStatisticsResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeVerifyFailStatisticsResponseBodyResultObject) };
    inline DescribeVerifyFailStatisticsResponseBody& setResultObject(const DescribeVerifyFailStatisticsResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeVerifyFailStatisticsResponseBody& setResultObject(DescribeVerifyFailStatisticsResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVerifyFailStatisticsResponseBodyResultObject> resultObject_ = nullptr;
  };
