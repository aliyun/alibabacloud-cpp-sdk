...
namespace Models
{
  ...
  public:
    ...
    inline const Id2MetaVerifyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, Id2MetaVerifyResponseBody) };
    inline Id2MetaVerifyResponseBody body() { DARABONBA_PTR_GET(body_, Id2MetaVerifyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<Id2MetaVerifyResponseBody> body_ = nullptr;
  };
