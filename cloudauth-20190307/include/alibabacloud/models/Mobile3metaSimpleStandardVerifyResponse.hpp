...
namespace Models
{
  ...
  public:
    ...
    inline const Mobile3MetaSimpleStandardVerifyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, Mobile3MetaSimpleStandardVerifyResponseBody) };
    inline Mobile3MetaSimpleStandardVerifyResponseBody body() { DARABONBA_PTR_GET(body_, Mobile3MetaSimpleStandardVerifyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<Mobile3MetaSimpleStandardVerifyResponseBody> body_ = nullptr;
  };
