...
namespace Models
{
  ...
  public:
    ...
    inline const AIGCFaceVerifyResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, AIGCFaceVerifyResponseBodyResultObject) };
    inline AIGCFaceVerifyResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, AIGCFaceVerifyResponseBodyResultObject) };
    inline AIGCFaceVerifyResponseBody& setResultObject(const AIGCFaceVerifyResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline AIGCFaceVerifyResponseBody& setResultObject(AIGCFaceVerifyResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned result
    std::shared_ptr<AIGCFaceVerifyResponseBodyResultObject> resultObject_ = nullptr;
  };
