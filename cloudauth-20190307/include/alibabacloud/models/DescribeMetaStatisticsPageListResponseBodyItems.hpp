...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEMETASTATISTICSPAGELISTRESPONSEBODYITEMS_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEMETASTATISTICSPAGELISTRESPONSEBODYITEMS_HPP_
...
namespace Models
{
  class DescribeMetaStatisticsPageListResponseBodyItems : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeMetaStatisticsPageListResponseBodyItems& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeMetaStatisticsPageListResponseBodyItems& obj) { 
    ...
    DescribeMetaStatisticsPageListResponseBodyItems() = default ;
    DescribeMetaStatisticsPageListResponseBodyItems(const DescribeMetaStatisticsPageListResponseBodyItems &) = default ;
    DescribeMetaStatisticsPageListResponseBodyItems(DescribeMetaStatisticsPageListResponseBodyItems &&) = default ;
    DescribeMetaStatisticsPageListResponseBodyItems(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeMetaStatisticsPageListResponseBodyItems() = default ;
    DescribeMetaStatisticsPageListResponseBodyItems& operator=(const DescribeMetaStatisticsPageListResponseBodyItems &) = default ;
    DescribeMetaStatisticsPageListResponseBodyItems& operator=(DescribeMetaStatisticsPageListResponseBodyItems &&) = default ;
    ...
    inline DescribeMetaStatisticsPageListResponseBodyItems& setApi(string api) { DARABONBA_PTR_SET_VALUE(api_, api) };
    ...
    inline DescribeMetaStatisticsPageListResponseBodyItems& setApiName(string apiName) { DARABONBA_PTR_SET_VALUE(apiName_, apiName) };
    ...
    inline DescribeMetaStatisticsPageListResponseBodyItems& setBillCount(int64_t billCount) { DARABONBA_PTR_SET_VALUE(billCount_, billCount) };
    ...
    inline DescribeMetaStatisticsPageListResponseBodyItems& setBillRate(string billRate) { DARABONBA_PTR_SET_VALUE(billRate_, billRate) };
    ...
    inline DescribeMetaStatisticsPageListResponseBodyItems& setChargeCount(int64_t chargeCount) { DARABONBA_PTR_SET_VALUE(chargeCount_, chargeCount) };
    ...
    inline DescribeMetaStatisticsPageListResponseBodyItems& setDate(string date) { DARABONBA_PTR_SET_VALUE(date_, date) };
    ...
    inline DescribeMetaStatisticsPageListResponseBodyItems& setIspName(string ispName) { DARABONBA_PTR_SET_VALUE(ispName_, ispName) };
    ...
    inline DescribeMetaStatisticsPageListResponseBodyItems& setNoRecordCount(int64_t noRecordCount) { DARABONBA_PTR_SET_VALUE(noRecordCount_, noRecordCount) };
    ...
    inline DescribeMetaStatisticsPageListResponseBodyItems& setPassedCount(int64_t passedCount) { DARABONBA_PTR_SET_VALUE(passedCount_, passedCount) };
    ...
    inline DescribeMetaStatisticsPageListResponseBodyItems& setPassedRate(string passedRate) { DARABONBA_PTR_SET_VALUE(passedRate_, passedRate) };
    ...
    inline DescribeMetaStatisticsPageListResponseBodyItems& setSuccessCount(int64_t successCount) { DARABONBA_PTR_SET_VALUE(successCount_, successCount) };
    ...
    inline DescribeMetaStatisticsPageListResponseBodyItems& setSuccessRate(string successRate) { DARABONBA_PTR_SET_VALUE(successRate_, successRate) };
    ...
    inline DescribeMetaStatisticsPageListResponseBodyItems& setTotalCount(int64_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
    ...
    inline DescribeMetaStatisticsPageListResponseBodyItems& setUnpassedCount(int64_t unpassedCount) { DARABONBA_PTR_SET_VALUE(unpassedCount_, unpassedCount) };
