...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ContrastFaceVerifyAdvanceRequest& obj) { 
      ...
      // faceContrastFileObject_ is stream
    ...
    inline shared_ptr<Darabonba::IStream> getFaceContrastFileObject() const { DARABONBA_GET(faceContrastFileObject_) };
  ...
  protected:
    ...
    // Local video file.
    shared_ptr<Darabonba::IStream> faceContrastFileObject_ {};
