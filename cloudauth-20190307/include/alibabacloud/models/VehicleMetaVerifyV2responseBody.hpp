...
namespace Models
{
  ...
  public:
    ...
    inline const VehicleMetaVerifyV2ResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, VehicleMetaVerifyV2ResponseBodyResultObject) };
    inline VehicleMetaVerifyV2ResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, VehicleMetaVerifyV2ResponseBodyResultObject) };
    inline VehicleMetaVerifyV2ResponseBody& setResultObject(const VehicleMetaVerifyV2ResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline VehicleMetaVerifyV2ResponseBody& setResultObject(VehicleMetaVerifyV2ResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned result
    std::shared_ptr<VehicleMetaVerifyV2ResponseBodyResultObject> resultObject_ = nullptr;
  };
