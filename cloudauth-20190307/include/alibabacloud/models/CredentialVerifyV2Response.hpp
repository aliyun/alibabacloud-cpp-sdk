...
namespace Models
{
  ...
  public:
    ...
    inline const CredentialVerifyV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CredentialVerifyV2ResponseBody) };
    inline CredentialVerifyV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, CredentialVerifyV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CredentialVerifyV2ResponseBody> body_ {};
  };
