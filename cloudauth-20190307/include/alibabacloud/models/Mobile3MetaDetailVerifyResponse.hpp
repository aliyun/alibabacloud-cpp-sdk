...
namespace Models
{
  ...
  public:
    ...
    inline const Mobile3MetaDetailVerifyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, Mobile3MetaDetailVerifyResponseBody) };
    inline Mobile3MetaDetailVerifyResponseBody body() { DARABONBA_PTR_GET(body_, Mobile3MetaDetailVerifyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<Mobile3MetaDetailVerifyResponseBody> body_ = nullptr;
  };
