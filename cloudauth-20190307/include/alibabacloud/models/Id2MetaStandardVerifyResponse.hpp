...
namespace Models
{
  ...
  public:
    ...
    inline const Id2MetaStandardVerifyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, Id2MetaStandardVerifyResponseBody) };
    inline Id2MetaStandardVerifyResponseBody getBody() { DARABONBA_PTR_GET(body_, Id2MetaStandardVerifyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<Id2MetaStandardVerifyResponseBody> body_ {};
  };
