...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInfoCheckExportRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInfoCheckExportRecordResponseBody) };
    inline DescribeInfoCheckExportRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInfoCheckExportRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInfoCheckExportRecordResponseBody> body_ {};
  };
