...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CredentialVerifyV2Request::MerchantDetail> & getMerchantDetail() const { DARABONBA_PTR_GET_CONST(merchantDetail_, vector<CredentialVerifyV2Request::MerchantDetail>) };
    inline vector<CredentialVerifyV2Request::MerchantDetail> getMerchantDetail() { DARABONBA_PTR_GET(merchantDetail_, vector<CredentialVerifyV2Request::MerchantDetail>) };
    inline CredentialVerifyV2Request& setMerchantDetail(const vector<CredentialVerifyV2Request::MerchantDetail> & merchantDetail) { DARABONBA_PTR_SET_VALUE(merchantDetail_, merchantDetail) };
    inline CredentialVerifyV2Request& setMerchantDetail(vector<CredentialVerifyV2Request::MerchantDetail> && merchantDetail) { DARABONBA_PTR_SET_RVALUE(merchantDetail_, merchantDetail) };
  ...
  protected:
    ...
    shared_ptr<vector<CredentialVerifyV2Request::MerchantDetail>> merchantDetail_ {};
