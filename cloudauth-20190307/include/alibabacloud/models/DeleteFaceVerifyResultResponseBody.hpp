...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteFaceVerifyResultResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DeleteFaceVerifyResultResponseBodyResultObject) };
    inline DeleteFaceVerifyResultResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DeleteFaceVerifyResultResponseBodyResultObject) };
    inline DeleteFaceVerifyResultResponseBody& setResultObject(const DeleteFaceVerifyResultResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DeleteFaceVerifyResultResponseBody& setResultObject(DeleteFaceVerifyResultResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteFaceVerifyResultResponseBodyResultObject> resultObject_ = nullptr;
  };
