...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeCloudauthstSceneListResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeCloudauthstSceneListResponseBodyItems>) };
    inline vector<DescribeCloudauthstSceneListResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeCloudauthstSceneListResponseBodyItems>) };
    inline DescribeCloudauthstSceneListResponseBody& setItems(const vector<DescribeCloudauthstSceneListResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeCloudauthstSceneListResponseBody& setItems(vector<DescribeCloudauthstSceneListResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    // Scene list
    std::shared_ptr<vector<DescribeCloudauthstSceneListResponseBodyItems>> items_ = nullptr;
