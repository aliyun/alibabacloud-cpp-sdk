...
namespace Models
{
  ...
  public:
    ...
    inline const Vehicle5ItemQueryResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, Vehicle5ItemQueryResponseBody::ResultObject) };
    inline Vehicle5ItemQueryResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, Vehicle5ItemQueryResponseBody::ResultObject) };
    inline Vehicle5ItemQueryResponseBody& setResultObject(const Vehicle5ItemQueryResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline Vehicle5ItemQueryResponseBody& setResultObject(Vehicle5ItemQueryResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
