...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ageGt_ == nullptr
        && return this->api_ == nullptr && return this->deviceType_ == nullptr && return this->endDate_ == nullptr && return this->productCode_ == nullptr && return this->serviceCode_ == nullptr
