...
namespace Models
{
  ...
  public:
    ...
    inline const Id3MetaVerifyWithOCRResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, Id3MetaVerifyWithOCRResponseBodyResultObject) };
    inline Id3MetaVerifyWithOCRResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, Id3MetaVerifyWithOCRResponseBodyResultObject) };
    inline Id3MetaVerifyWithOCRResponseBody& setResultObject(const Id3MetaVerifyWithOCRResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline Id3MetaVerifyWithOCRResponseBody& setResultObject(Id3MetaVerifyWithOCRResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Result object.
    std::shared_ptr<Id3MetaVerifyWithOCRResponseBodyResultObject> resultObject_ = nullptr;
  };
