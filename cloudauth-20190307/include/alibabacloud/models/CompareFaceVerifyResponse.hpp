...
namespace Models
{
  ...
  public:
    ...
    inline const CompareFaceVerifyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CompareFaceVerifyResponseBody) };
    inline CompareFaceVerifyResponseBody body() { DARABONBA_PTR_GET(body_, CompareFaceVerifyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CompareFaceVerifyResponseBody> body_ = nullptr;
  };
