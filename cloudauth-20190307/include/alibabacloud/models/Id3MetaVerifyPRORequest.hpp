...
#ifndef ALIBABACLOUD_MODELS_ID3METAVERIFYPROREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ID3METAVERIFYPROREQUEST_HPP_
...
namespace Models
{
  class Id3MetaVerifyPRORequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const Id3MetaVerifyPRORequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, Id3MetaVerifyPRORequest& obj) { 
    ...
    Id3MetaVerifyPRORequest() = default ;
    Id3MetaVerifyPRORequest(const Id3MetaVerifyPRORequest &) = default ;
    Id3MetaVerifyPRORequest(Id3MetaVerifyPRORequest &&) = default ;
    Id3MetaVerifyPRORequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~Id3MetaVerifyPRORequest() = default ;
    Id3MetaVerifyPRORequest& operator=(const Id3MetaVerifyPRORequest &) = default ;
    Id3MetaVerifyPRORequest& operator=(Id3MetaVerifyPRORequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->crop_ == nullptr
        && this->enableFallback_ == nullptr && this->faceFile_ == nullptr && this->facePicture_ == nullptr && this->faceUrl_ == nullptr && this->identifyNum_ == nullptr
    ...
    inline Id3MetaVerifyPRORequest& setCrop(string crop) { DARABONBA_PTR_SET_VALUE(crop_, crop) };
    ...
    inline Id3MetaVerifyPRORequest& setEnableFallback(string enableFallback) { DARABONBA_PTR_SET_VALUE(enableFallback_, enableFallback) };
    ...
    inline Id3MetaVerifyPRORequest& setFaceFile(string faceFile) { DARABONBA_PTR_SET_VALUE(faceFile_, faceFile) };
    ...
    inline Id3MetaVerifyPRORequest& setFacePicture(string facePicture) { DARABONBA_PTR_SET_VALUE(facePicture_, facePicture) };
    ...
    inline Id3MetaVerifyPRORequest& setFaceUrl(string faceUrl) { DARABONBA_PTR_SET_VALUE(faceUrl_, faceUrl) };
    ...
    inline Id3MetaVerifyPRORequest& setIdentifyNum(string identifyNum) { DARABONBA_PTR_SET_VALUE(identifyNum_, identifyNum) };
    ...
    inline Id3MetaVerifyPRORequest& setLivenessCheck(string livenessCheck) { DARABONBA_PTR_SET_VALUE(livenessCheck_, livenessCheck) };
    ...
    inline Id3MetaVerifyPRORequest& setParamType(string paramType) { DARABONBA_PTR_SET_VALUE(paramType_, paramType) };
    ...
    inline Id3MetaVerifyPRORequest& setUserName(string userName) { DARABONBA_PTR_SET_VALUE(userName_, userName) };
