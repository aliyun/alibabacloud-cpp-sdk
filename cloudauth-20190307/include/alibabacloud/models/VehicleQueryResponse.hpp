...
namespace Models
{
  ...
  public:
    ...
    inline const VehicleQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, VehicleQueryResponseBody) };
    inline VehicleQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, VehicleQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<VehicleQueryResponseBody> body_ {};
  };
