...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryControlStrategyResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<QueryControlStrategyResponseBodyResultObject>) };
    inline vector<QueryControlStrategyResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<QueryControlStrategyResponseBodyResultObject>) };
    inline QueryControlStrategyResponseBody& setResultObject(const vector<QueryControlStrategyResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline QueryControlStrategyResponseBody& setResultObject(vector<QueryControlStrategyResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Processing result.
    std::shared_ptr<vector<QueryControlStrategyResponseBodyResultObject>> resultObject_ = nullptr;
  };
