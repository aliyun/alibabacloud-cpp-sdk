...
namespace Models
{
  ...
  public:
    ...
    inline const Id2MetaPeriodVerifyResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, Id2MetaPeriodVerifyResponseBodyResultObject) };
    inline Id2MetaPeriodVerifyResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, Id2MetaPeriodVerifyResponseBodyResultObject) };
    inline Id2MetaPeriodVerifyResponseBody& setResultObject(const Id2MetaPeriodVerifyResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline Id2MetaPeriodVerifyResponseBody& setResultObject(Id2MetaPeriodVerifyResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    std::shared_ptr<Id2MetaPeriodVerifyResponseBodyResultObject> resultObject_ = nullptr;
  };
