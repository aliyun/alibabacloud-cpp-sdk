...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bindMiniProgram_ == nullptr
        && return this->checkFileBody_ == nullptr && return this->checkFileName_ == nullptr && return this->miniProgramName_ == nullptr && return this->platform_ == nullptr && return this->sceneName_ == nullptr
