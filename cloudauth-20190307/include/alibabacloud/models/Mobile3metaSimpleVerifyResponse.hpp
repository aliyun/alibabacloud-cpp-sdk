...
namespace Models
{
  ...
  public:
    ...
    inline const Mobile3MetaSimpleVerifyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, Mobile3MetaSimpleVerifyResponseBody) };
    inline Mobile3MetaSimpleVerifyResponseBody body() { DARABONBA_PTR_GET(body_, Mobile3MetaSimpleVerifyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<Mobile3MetaSimpleVerifyResponseBody> body_ = nullptr;
  };
