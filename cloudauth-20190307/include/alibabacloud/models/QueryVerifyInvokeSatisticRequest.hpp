...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentPage_ == nullptr
        && return this->endDate_ == nullptr && return this->pageSize_ == nullptr && return this->productProgramList_ == nullptr && return this->productType_ == nullptr && return this->sceneIdList_ == nullptr
        && return this->startDate_ == nullptr && return this->statisticsType_ == nullptr; };
    ...
    inline string productProgramList() const { DARABONBA_PTR_GET_DEFAULT(productProgramList_, "") };
    ...
    inline string sceneIdList() const { DARABONBA_PTR_GET_DEFAULT(sceneIdList_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> productProgramList_ = nullptr;
    // Product type:
    ...
    std::shared_ptr<string> sceneIdList_ = nullptr;
