...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVerifyStatisticsResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeVerifyStatisticsResponseBodyResultObject) };
    inline DescribeVerifyStatisticsResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeVerifyStatisticsResponseBodyResultObject) };
    inline DescribeVerifyStatisticsResponseBody& setResultObject(const DescribeVerifyStatisticsResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeVerifyStatisticsResponseBody& setResultObject(DescribeVerifyStatisticsResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Statistical results
    std::shared_ptr<DescribeVerifyStatisticsResponseBodyResultObject> resultObject_ = nullptr;
  };
