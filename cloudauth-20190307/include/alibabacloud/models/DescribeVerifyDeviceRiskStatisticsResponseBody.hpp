...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVerifyDeviceRiskStatisticsResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeVerifyDeviceRiskStatisticsResponseBodyResultObject) };
    inline DescribeVerifyDeviceRiskStatisticsResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeVerifyDeviceRiskStatisticsResponseBodyResultObject) };
    inline DescribeVerifyDeviceRiskStatisticsResponseBody& setResultObject(const DescribeVerifyDeviceRiskStatisticsResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeVerifyDeviceRiskStatisticsResponseBody& setResultObject(DescribeVerifyDeviceRiskStatisticsResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVerifyDeviceRiskStatisticsResponseBodyResultObject> resultObject_ = nullptr;
  };
