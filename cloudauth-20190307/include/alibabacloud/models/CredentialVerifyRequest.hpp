...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->certNum_ == nullptr
        ...
        && return this->isCheck_ == nullptr && return this->isOCR_ == nullptr && return this->merchantDetail_ == nullptr && return this->merchantId_ == nullptr && return this->productCode_ == nullptr
