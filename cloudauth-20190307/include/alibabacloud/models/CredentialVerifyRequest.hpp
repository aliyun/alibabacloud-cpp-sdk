...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CredentialVerifyRequest::MerchantDetail> & getMerchantDetail() const { DARABONBA_PTR_GET_CONST(merchantDetail_, vector<CredentialVerifyRequest::MerchantDetail>) };
    inline vector<CredentialVerifyRequest::MerchantDetail> getMerchantDetail() { DARABONBA_PTR_GET(merchantDetail_, vector<CredentialVerifyRequest::MerchantDetail>) };
    inline CredentialVerifyRequest& setMerchantDetail(const vector<CredentialVerifyRequest::MerchantDetail> & merchantDetail) { DARABONBA_PTR_SET_VALUE(merchantDetail_, merchantDetail) };
    inline CredentialVerifyRequest& setMerchantDetail(vector<CredentialVerifyRequest::MerchantDetail> && merchantDetail) { DARABONBA_PTR_SET_RVALUE(merchantDetail_, merchantDetail) };
