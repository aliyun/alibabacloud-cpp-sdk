...
#ifndef ALIBABACLOUD_MODELS_CREATEAUTHKEYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEAUTHKEYRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateAuthKeyResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AuthKey, authKey_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, CreateAuthKeyResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AuthKey, authKey_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    CreateAuthKeyResponseBody() = default ;
    CreateAuthKeyResponseBody(const CreateAuthKeyResponseBody &) = default ;
    CreateAuthKeyResponseBody(CreateAuthKeyResponseBody &&) = default ;
    CreateAuthKeyResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAuthKeyResponseBody() = default ;
    CreateAuthKeyResponseBody& operator=(const CreateAuthKeyResponseBody &) = default ;
    CreateAuthKeyResponseBody& operator=(CreateAuthKeyResponseBody &&) = default ;
