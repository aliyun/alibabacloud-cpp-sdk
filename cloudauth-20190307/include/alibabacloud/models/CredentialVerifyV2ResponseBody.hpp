...
namespace Models
{
  ...
  public:
    ...
    inline const CredentialVerifyV2ResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, CredentialVerifyV2ResponseBody::ResultObject) };
    inline CredentialVerifyV2ResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, CredentialVerifyV2ResponseBody::ResultObject) };
    inline CredentialVerifyV2ResponseBody& setResultObject(const CredentialVerifyV2ResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline CredentialVerifyV2ResponseBody& setResultObject(CredentialVerifyV2ResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
