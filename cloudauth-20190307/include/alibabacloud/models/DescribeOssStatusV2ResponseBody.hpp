...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOssStatusV2ResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeOssStatusV2ResponseBodyResultObject) };
    inline DescribeOssStatusV2ResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeOssStatusV2ResponseBodyResultObject) };
    inline DescribeOssStatusV2ResponseBody& setResultObject(const DescribeOssStatusV2ResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeOssStatusV2ResponseBody& setResultObject(DescribeOssStatusV2ResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeOssStatusV2ResponseBodyResultObject> resultObject_ = nullptr;
