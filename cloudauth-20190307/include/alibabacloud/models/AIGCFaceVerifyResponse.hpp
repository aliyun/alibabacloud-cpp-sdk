...
namespace Models
{
  ...
  public:
    ...
    inline const AIGCFaceVerifyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AIGCFaceVerifyResponseBody) };
    inline AIGCFaceVerifyResponseBody getBody() { DARABONBA_PTR_GET(body_, AIGCFaceVerifyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AIGCFaceVerifyResponseBody> body_ {};
  };
