...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->crop_ == nullptr
        && return this->faceFile_ == nullptr && return this->faceUrl_ == nullptr && return this->identifyNum_ == nullptr && return this->paramType_ == nullptr && return this->userName_ == nullptr; };
