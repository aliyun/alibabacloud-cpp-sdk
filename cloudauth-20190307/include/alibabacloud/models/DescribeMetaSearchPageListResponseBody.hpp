...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeMetaSearchPageListResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeMetaSearchPageListResponseBodyItems>) };
    inline vector<DescribeMetaSearchPageListResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeMetaSearchPageListResponseBodyItems>) };
    inline DescribeMetaSearchPageListResponseBody& setItems(const vector<DescribeMetaSearchPageListResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeMetaSearchPageListResponseBody& setItems(vector<DescribeMetaSearchPageListResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeMetaSearchPageListResponseBodyItems>> items_ = nullptr;
