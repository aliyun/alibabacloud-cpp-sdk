...
namespace Models
{
  ...
  public:
    ...
    inline const Id3MetaVerifyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, Id3MetaVerifyResponseBody) };
    inline Id3MetaVerifyResponseBody getBody() { DARABONBA_PTR_GET(body_, Id3MetaVerifyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<Id3MetaVerifyResponseBody> body_ {};
  };
