...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWhitelistSettingResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateWhitelistSettingResponseBody) };
    inline CreateWhitelistSettingResponseBody body() { DARABONBA_PTR_GET(body_, CreateWhitelistSettingResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateWhitelistSettingResponseBody> body_ = nullptr;
  };
