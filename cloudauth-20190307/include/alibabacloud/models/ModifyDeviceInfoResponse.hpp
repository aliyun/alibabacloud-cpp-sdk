...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDeviceInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDeviceInfoResponseBody) };
    inline ModifyDeviceInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDeviceInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDeviceInfoResponseBody> body_ {};
  };
