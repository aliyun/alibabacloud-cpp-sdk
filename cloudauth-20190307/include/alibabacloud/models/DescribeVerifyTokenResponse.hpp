...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVerifyTokenResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeVerifyTokenResponseBody) };
    inline DescribeVerifyTokenResponseBody body() { DARABONBA_PTR_GET(body_, DescribeVerifyTokenResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVerifyTokenResponseBody> body_ = nullptr;
  };
