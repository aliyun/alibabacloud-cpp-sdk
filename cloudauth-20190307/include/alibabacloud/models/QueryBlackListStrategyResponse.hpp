...
namespace Models
{
  ...
  public:
    ...
    inline const QueryBlackListStrategyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryBlackListStrategyResponseBody) };
    inline QueryBlackListStrategyResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryBlackListStrategyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryBlackListStrategyResponseBody> body_ {};
  };
