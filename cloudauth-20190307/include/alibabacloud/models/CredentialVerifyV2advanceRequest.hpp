...
#ifndef ALIBABACLOUD_MODELS_CREDENTIALVERIFYV2ADVANCEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CredentialVerifyV2AdvanceRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CredentialVerifyV2AdvanceRequest& obj) { 
    ...
    CredentialVerifyV2AdvanceRequest() = default ;
    CredentialVerifyV2AdvanceRequest(const CredentialVerifyV2AdvanceRequest &) = default ;
    CredentialVerifyV2AdvanceRequest(CredentialVerifyV2AdvanceRequest &&) = default ;
    CredentialVerifyV2AdvanceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CredentialVerifyV2AdvanceRequest() = default ;
    CredentialVerifyV2AdvanceRequest& operator=(const CredentialVerifyV2AdvanceRequest &) = default ;
    CredentialVerifyV2AdvanceRequest& operator=(CredentialVerifyV2AdvanceRequest &&) = default ;
