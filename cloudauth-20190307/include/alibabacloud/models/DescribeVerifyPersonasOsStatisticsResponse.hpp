...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVerifyPersonasOsStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVerifyPersonasOsStatisticsResponseBody) };
    inline DescribeVerifyPersonasOsStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVerifyPersonasOsStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVerifyPersonasOsStatisticsResponseBody> body_ {};
  };
