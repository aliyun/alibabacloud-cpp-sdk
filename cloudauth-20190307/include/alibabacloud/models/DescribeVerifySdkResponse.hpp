...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVerifySDKResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVerifySDKResponseBody) };
    inline DescribeVerifySDKResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVerifySDKResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVerifySDKResponseBody> body_ {};
  };
