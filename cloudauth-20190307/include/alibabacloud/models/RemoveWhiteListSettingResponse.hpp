...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveWhiteListSettingResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RemoveWhiteListSettingResponseBody) };
    inline RemoveWhiteListSettingResponseBody body() { DARABONBA_PTR_GET(body_, RemoveWhiteListSettingResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RemoveWhiteListSettingResponseBody> body_ = nullptr;
  };
