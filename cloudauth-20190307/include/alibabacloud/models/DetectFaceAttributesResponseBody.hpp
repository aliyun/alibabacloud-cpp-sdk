...
namespace Models
{
  ...
  public:
    ...
    inline const DetectFaceAttributesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DetectFaceAttributesResponseBodyData) };
    inline DetectFaceAttributesResponseBodyData data() { DARABONBA_PTR_GET(data_, DetectFaceAttributesResponseBodyData) };
    inline DetectFaceAttributesResponseBody& setData(const DetectFaceAttributesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DetectFaceAttributesResponseBody& setData(DetectFaceAttributesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
