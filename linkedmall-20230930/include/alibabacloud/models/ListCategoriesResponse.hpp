...
namespace Models
{
  ...
  public:
    ...
    inline const CategoryListResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, CategoryListResult) };
    inline CategoryListResult getBody() { DARABONBA_PTR_GET(body_, CategoryListResult) };
    inline ListCategoriesResponse& setBody(const CategoryListResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline ListCategoriesResponse& setBody(CategoryListResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<map<string, string>> headers_ {};
    shared_ptr<int32_t> statusCode_ {};
    shared_ptr<CategoryListResult> body_ {};
  };
