...
#ifndef ALIBABACLOUD_MODELS_DISTRIBUTIONMAXREFUNDFEE_HPP_
#define ALIBABACLOUD_MODELS_DISTRIBUTIONMAXREFUNDFEE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DistributionMaxRefundFee& obj) { 
      DARABONBA_PTR_TO_JSON(maxRefundFee, maxRefundFee_);
      DARABONBA_PTR_TO_JSON(minRefundFee, minRefundFee_);
    };
    friend void from_json(const Darabonba::Json& j, DistributionMaxRefundFee& obj) { 
      DARABONBA_PTR_FROM_JSON(maxRefundFee, maxRefundFee_);
      DARABONBA_PTR_FROM_JSON(minRefundFee, minRefundFee_);
    };
    DistributionMaxRefundFee() = default ;
    DistributionMaxRefundFee(const DistributionMaxRefundFee &) = default ;
    DistributionMaxRefundFee(DistributionMaxRefundFee &&) = default ;
    DistributionMaxRefundFee(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DistributionMaxRefundFee() = default ;
    DistributionMaxRefundFee& operator=(const DistributionMaxRefundFee &) = default ;
    DistributionMaxRefundFee& operator=(DistributionMaxRefundFee &&) = default ;
    ...
    inline DistributionMaxRefundFee& setMaxRefundFee(int64_t maxRefundFee) { DARABONBA_PTR_SET_VALUE(maxRefundFee_, maxRefundFee) };
    ...
    inline DistributionMaxRefundFee& setMinRefundFee(int64_t minRefundFee) { DARABONBA_PTR_SET_VALUE(minRefundFee_, minRefundFee) };
