...
#ifndef ALIBABACLOUD_MODELS_SHOP_HPP_
#define ALIBABACLOUD_MODELS_SHOP_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const Shop& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, Shop& obj) { 
    ...
    Shop(Shop &&) = default ;
    Shop(const Darabonba::Json & obj) { from_json(obj, *this); };
    ...
    virtual bool empty() const override { return this->cooperationShops_ == nullptr
        && this->distributorId_ == nullptr && this->endDate_ == nullptr && this->purchaserId_ == nullptr && this->requestId_ == nullptr && this->shopId_ == nullptr
        && this->shopName_ == nullptr && this->shopType_ == nullptr && this->startDate_ == nullptr && this->status_ == nullptr; };
    ...
    inline Shop& setCooperationShops(const vector<CooperationShop> & cooperationShops) { DARABONBA_PTR_SET_VALUE(cooperationShops_, cooperationShops) };
    inline Shop& setCooperationShops(vector<CooperationShop> && cooperationShops) { DARABONBA_PTR_SET_RVALUE(cooperationShops_, cooperationShops) };
    ...
    inline Shop& setDistributorId(string distributorId) { DARABONBA_PTR_SET_VALUE(distributorId_, distributorId) };
    ...
    inline Shop& setEndDate(string endDate) { DARABONBA_PTR_SET_VALUE(endDate_, endDate) };
    ...
    inline Shop& setPurchaserId(string purchaserId) { DARABONBA_PTR_SET_VALUE(purchaserId_, purchaserId) };
    ...
    inline Shop& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline Shop& setShopId(string shopId) { DARABONBA_PTR_SET_VALUE(shopId_, shopId) };
    ...
    inline Shop& setShopName(string shopName) { DARABONBA_PTR_SET_VALUE(shopName_, shopName) };
    ...
    inline Shop& setShopType(string shopType) { DARABONBA_PTR_SET_VALUE(shopType_, shopType) };
    ...
    inline Shop& setStartDate(string startDate) { DARABONBA_PTR_SET_VALUE(startDate_, startDate) };
    ...
    inline Shop& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
