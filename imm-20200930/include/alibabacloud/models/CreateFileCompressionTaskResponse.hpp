...
namespace Models
{
  ...
  public:
    ...
    inline const CreateFileCompressionTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateFileCompressionTaskResponseBody) };
    inline CreateFileCompressionTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateFileCompressionTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateFileCompressionTaskResponseBody> body_ {};
  };
