...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->datasetName_ == nullptr
        && this->from_ == nullptr && this->fromsShrink_ == nullptr && this->notificationShrink_ == nullptr && this->projectName_ == nullptr && this->tagsShrink_ == nullptr
    ...
    inline string getFromsShrink() const { DARABONBA_PTR_GET_DEFAULT(fromsShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> fromsShrink_ {};
