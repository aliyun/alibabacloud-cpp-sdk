...
namespace Models
{
  ...
  public:
    ...
    inline const TimeRange & getUpdateTimeRange() const { DARABONBA_PTR_GET_CONST(updateTimeRange_, TimeRange) };
    inline TimeRange getUpdateTimeRange() { DARABONBA_PTR_GET(updateTimeRange_, TimeRange) };
  ...
  protected:
    ...
    shared_ptr<TimeRange> updateTimeRange_ {};
