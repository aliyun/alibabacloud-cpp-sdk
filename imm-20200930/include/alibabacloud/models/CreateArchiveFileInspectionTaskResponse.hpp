...
namespace Models
{
  ...
  public:
    ...
    inline const CreateArchiveFileInspectionTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateArchiveFileInspectionTaskResponseBody) };
    inline CreateArchiveFileInspectionTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateArchiveFileInspectionTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateArchiveFileInspectionTaskResponseBody> body_ {};
  };
