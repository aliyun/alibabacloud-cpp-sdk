...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->credentialConfig_ == nullptr
        ...
        && this->notification_ == nullptr && this->pages_ == nullptr && this->paperHorizontal_ == nullptr && this->paperSize_ == nullptr && this->password_ == nullptr
        ...
        && this->showComments_ == nullptr && this->sourceType_ == nullptr && this->sourceURI_ == nullptr && this->sources_ == nullptr && this->startPage_ == nullptr
        && this->tags_ == nullptr && this->targetType_ == nullptr && this->targetURI_ == nullptr && this->targetURIPrefix_ == nullptr && this->trimPolicy_ == nullptr
    ...
    inline const vector<CreateOfficeConversionTaskRequest::Sources> & getSources() const { DARABONBA_PTR_GET_CONST(sources_, vector<CreateOfficeConversionTaskRequest::Sources>) };
    inline vector<CreateOfficeConversionTaskRequest::Sources> getSources() { DARABONBA_PTR_GET(sources_, vector<CreateOfficeConversionTaskRequest::Sources>) };
    inline CreateOfficeConversionTaskRequest& setSources(const vector<CreateOfficeConversionTaskRequest::Sources> & sources) { DARABONBA_PTR_SET_VALUE(sources_, sources) };
    inline CreateOfficeConversionTaskRequest& setSources(vector<CreateOfficeConversionTaskRequest::Sources> && sources) { DARABONBA_PTR_SET_RVALUE(sources_, sources) };
    ...
    inline const TrimPolicy & getTrimPolicy() const { DARABONBA_PTR_GET_CONST(trimPolicy_, TrimPolicy) };
    inline TrimPolicy getTrimPolicy() { DARABONBA_PTR_GET(trimPolicy_, TrimPolicy) };
  ...
  protected:
    ...
    shared_ptr<vector<CreateOfficeConversionTaskRequest::Sources>> sources_ {};
    ...
    shared_ptr<TrimPolicy> trimPolicy_ {};
