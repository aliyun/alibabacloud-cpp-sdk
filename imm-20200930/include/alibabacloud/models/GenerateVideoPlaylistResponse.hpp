...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateVideoPlaylistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateVideoPlaylistResponseBody) };
    inline GenerateVideoPlaylistResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateVideoPlaylistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateVideoPlaylistResponseBody> body_ {};
  };
