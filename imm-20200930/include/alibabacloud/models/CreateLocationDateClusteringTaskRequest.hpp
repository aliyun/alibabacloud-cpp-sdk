...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->datasetName_ == nullptr
        && return this->dateOptions_ == nullptr && return this->locationOptions_ == nullptr && return this->notification_ == nullptr && return this->projectName_ == nullptr && return this->tags_ == nullptr
    ...
    inline const CreateLocationDateClusteringTaskRequestDateOptions & dateOptions() const { DARABONBA_PTR_GET_CONST(dateOptions_, CreateLocationDateClusteringTaskRequestDateOptions) };
    inline CreateLocationDateClusteringTaskRequestDateOptions dateOptions() { DARABONBA_PTR_GET(dateOptions_, CreateLocationDateClusteringTaskRequestDateOptions) };
    inline CreateLocationDateClusteringTaskRequest& setDateOptions(const CreateLocationDateClusteringTaskRequestDateOptions & dateOptions) { DARABONBA_PTR_SET_VALUE(dateOptions_, dateOptions) };
    inline CreateLocationDateClusteringTaskRequest& setDateOptions(CreateLocationDateClusteringTaskRequestDateOptions && dateOptions) { DARABONBA_PTR_SET_RVALUE(dateOptions_, dateOptions) };
    ...
    inline const CreateLocationDateClusteringTaskRequestLocationOptions & locationOptions() const { DARABONBA_PTR_GET_CONST(locationOptions_, CreateLocationDateClusteringTaskRequestLocationOptions) };
    inline CreateLocationDateClusteringTaskRequestLocationOptions locationOptions() { DARABONBA_PTR_GET(locationOptions_, CreateLocationDateClusteringTaskRequestLocationOptions) };
    inline CreateLocationDateClusteringTaskRequest& setLocationOptions(const CreateLocationDateClusteringTaskRequestLocationOptions & locationOptions) { DARABONBA_PTR_SET_VALUE(locationOptions_, locationOptions) };
    inline CreateLocationDateClusteringTaskRequest& setLocationOptions(CreateLocationDateClusteringTaskRequestLocationOptions && locationOptions) { DARABONBA_PTR_SET_RVALUE(locationOptions_, locationOptions) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<CreateLocationDateClusteringTaskRequestDateOptions> dateOptions_ = nullptr;
    // The geolocation configurations for clustering.
    // 
    // >  Adjusting these configurations affects existing spatiotemporal clusters for the dataset.
    // 
    // This parameter is required.
    std::shared_ptr<CreateLocationDateClusteringTaskRequestLocationOptions> locationOptions_ = nullptr;
