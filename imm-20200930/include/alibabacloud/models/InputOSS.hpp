...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getMatchExpressions() const { DARABONBA_PTR_GET_CONST(matchExpressions_, vector<string>) };
    inline vector<string> getMatchExpressions() { DARABONBA_PTR_GET(matchExpressions_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> matchExpressions_ {};
