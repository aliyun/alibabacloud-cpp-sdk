...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->hyperparameters_ == nullptr
    ...
    inline const Hyperparameters & getHyperparameters() const { DARABONBA_PTR_GET_CONST(hyperparameters_, Hyperparameters) };
    inline Hyperparameters getHyperparameters() { DARABONBA_PTR_GET(hyperparameters_, Hyperparameters) };
    ...
    inline const Resource & getResource() const { DARABONBA_PTR_GET_CONST(resource_, Resource) };
    inline Resource getResource() { DARABONBA_PTR_GET(resource_, Resource) };
  ...
  protected:
    ...
    shared_ptr<Hyperparameters> hyperparameters_ {};
    // The resource.
    // 
    // This parameter is required.
