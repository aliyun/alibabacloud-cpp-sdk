...
namespace Models
{
  ...
  public:
    ...
    inline const IndexFileMetaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, IndexFileMetaResponseBody) };
    inline IndexFileMetaResponseBody getBody() { DARABONBA_PTR_GET(body_, IndexFileMetaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<IndexFileMetaResponseBody> body_ {};
  };
