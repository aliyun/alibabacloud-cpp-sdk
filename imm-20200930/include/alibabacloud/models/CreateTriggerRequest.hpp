...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->actions_ == nullptr
        && return this->input_ == nullptr && return this->notification_ == nullptr && return this->projectName_ == nullptr && return this->serviceRole_ == nullptr && return this->tags_ == nullptr; };
