...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->datasetName_ == nullptr
        && this->figureClusterShrink_ == nullptr && this->projectName_ == nullptr; };
    ...
    inline string getFigureClusterShrink() const { DARABONBA_PTR_GET_DEFAULT(figureClusterShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> figureClusterShrink_ {};
