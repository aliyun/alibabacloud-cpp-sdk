...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLocationDateClusteringTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLocationDateClusteringTaskResponseBody) };
    inline CreateLocationDateClusteringTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLocationDateClusteringTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLocationDateClusteringTaskResponseBody> body_ {};
  };
