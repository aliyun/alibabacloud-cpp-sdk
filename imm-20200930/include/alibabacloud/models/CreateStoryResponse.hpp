...
namespace Models
{
  ...
  public:
    ...
    inline const CreateStoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateStoryResponseBody) };
    inline CreateStoryResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateStoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateStoryResponseBody> body_ {};
  };
