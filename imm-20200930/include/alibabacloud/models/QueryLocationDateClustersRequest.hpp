...
namespace Models
{
  ...
  public:
    ...
    inline const Address & getAddress() const { DARABONBA_PTR_GET_CONST(address_, Address) };
    inline Address getAddress() { DARABONBA_PTR_GET(address_, Address) };
    ...
    inline const TimeRange & getLocationDateClusterEndTimeRange() const { DARABONBA_PTR_GET_CONST(locationDateClusterEndTimeRange_, TimeRange) };
    inline TimeRange getLocationDateClusterEndTimeRange() { DARABONBA_PTR_GET(locationDateClusterEndTimeRange_, TimeRange) };
    ...
    inline const TimeRange & getLocationDateClusterStartTimeRange() const { DARABONBA_PTR_GET_CONST(locationDateClusterStartTimeRange_, TimeRange) };
    inline TimeRange getLocationDateClusterStartTimeRange() { DARABONBA_PTR_GET(locationDateClusterStartTimeRange_, TimeRange) };
  ...
  protected:
    ...
    shared_ptr<TimeRange> locationDateClusterEndTimeRange_ {};
    ...
    shared_ptr<TimeRange> locationDateClusterStartTimeRange_ {};
