...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->keyId_ == nullptr
        && this->notifyEndpoint_ == nullptr && this->notifyTopicName_ == nullptr && this->projectName_ == nullptr && this->protectionSystem_ == nullptr; };
    ...
    inline string getNotifyEndpoint() const { DARABONBA_PTR_GET_DEFAULT(notifyEndpoint_, "") };
    ...
    inline string getProtectionSystem() const { DARABONBA_PTR_GET_DEFAULT(protectionSystem_, "") };
  ...
  protected:
    ...
    shared_ptr<string> notifyEndpoint_ {};
    shared_ptr<string> notifyTopicName_ {};
    shared_ptr<string> projectName_ {};
    shared_ptr<string> protectionSystem_ {};
  };
