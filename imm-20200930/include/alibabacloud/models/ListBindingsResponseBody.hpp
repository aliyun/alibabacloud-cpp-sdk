...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Binding> & getBindings() const { DARABONBA_PTR_GET_CONST(bindings_, vector<Binding>) };
    inline vector<Binding> getBindings() { DARABONBA_PTR_GET(bindings_, vector<Binding>) };
  ...
  protected:
    ...
    shared_ptr<vector<Binding>> bindings_ {};
