...
namespace Models
{
  ...
  public:
    ...
    inline CreateProjectResponseBody& setProject(const Project & project) { DARABONBA_PTR_SET_VALUE(project_, project) };
    inline CreateProjectResponseBody& setProject(Project && project) { DARABONBA_PTR_SET_RVALUE(project_, project) };
