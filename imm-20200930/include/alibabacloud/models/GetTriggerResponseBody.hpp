...
namespace Models
{
  ...
  public:
    ...
    inline const DataIngestion & getTrigger() const { DARABONBA_PTR_GET_CONST(trigger_, DataIngestion) };
    inline DataIngestion getTrigger() { DARABONBA_PTR_GET(trigger_, DataIngestion) };
  ...
  protected:
    ...
    shared_ptr<DataIngestion> trigger_ {};
  };
