...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->datasetName_ == nullptr
        && this->dateOptionsShrink_ == nullptr && this->locationOptionsShrink_ == nullptr && this->notificationShrink_ == nullptr && this->projectName_ == nullptr && this->tagsShrink_ == nullptr
    ...
    inline string getDateOptionsShrink() const { DARABONBA_PTR_GET_DEFAULT(dateOptionsShrink_, "") };
    ...
    inline string getLocationOptionsShrink() const { DARABONBA_PTR_GET_DEFAULT(locationOptionsShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> dateOptionsShrink_ {};
    // The geolocation configurations for clustering.
    // 
    // >  Adjusting these configurations affects existing spatiotemporal clusters for the dataset.
    // 
    // This parameter is required.
    shared_ptr<string> locationOptionsShrink_ {};
