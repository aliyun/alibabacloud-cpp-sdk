...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBatchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBatchResponseBody) };
    inline CreateBatchResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBatchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBatchResponseBody> body_ {};
  };
