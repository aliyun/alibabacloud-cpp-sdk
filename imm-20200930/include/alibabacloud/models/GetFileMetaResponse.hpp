...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileMetaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetFileMetaResponseBody) };
    inline GetFileMetaResponseBody getBody() { DARABONBA_PTR_GET(body_, GetFileMetaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetFileMetaResponseBody> body_ {};
  };
