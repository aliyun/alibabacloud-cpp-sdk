...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCompressPointCloudTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCompressPointCloudTaskResponseBody) };
    inline CreateCompressPointCloudTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCompressPointCloudTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCompressPointCloudTaskResponseBody> body_ {};
  };
