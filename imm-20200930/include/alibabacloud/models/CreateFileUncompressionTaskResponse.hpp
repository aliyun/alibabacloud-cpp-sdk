...
namespace Models
{
  ...
  public:
    ...
    inline const CreateFileUncompressionTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateFileUncompressionTaskResponseBody) };
    inline CreateFileUncompressionTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateFileUncompressionTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateFileUncompressionTaskResponseBody> body_ {};
  };
