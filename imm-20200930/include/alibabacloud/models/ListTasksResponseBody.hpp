...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->maxResults_ == nullptr
        && this->nextToken_ == nullptr && this->projectName_ == nullptr && this->requestId_ == nullptr && this->tasks_ == nullptr; };
    ...
    inline const vector<TaskInfo> & getTasks() const { DARABONBA_PTR_GET_CONST(tasks_, vector<TaskInfo>) };
    inline vector<TaskInfo> getTasks() { DARABONBA_PTR_GET(tasks_, vector<TaskInfo>) };
  ...
  protected:
    ...
    // The tasks.
    shared_ptr<vector<TaskInfo>> tasks_ {};
  };
