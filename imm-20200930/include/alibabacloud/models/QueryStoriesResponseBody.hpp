...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->nextToken_ == nullptr
        && this->requestId_ == nullptr && this->stories_ == nullptr; };
    ...
    inline const vector<Story> & getStories() const { DARABONBA_PTR_GET_CONST(stories_, vector<Story>) };
    inline vector<Story> getStories() { DARABONBA_PTR_GET(stories_, vector<Story>) };
