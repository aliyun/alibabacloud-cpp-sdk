...
namespace Models
{
  ...
  public:
    ...
    inline const AttachOSSBucketResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachOSSBucketResponseBody) };
    inline AttachOSSBucketResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachOSSBucketResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachOSSBucketResponseBody> body_ {};
  };
