...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLocationDateClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLocationDateClusterResponseBody) };
    inline UpdateLocationDateClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLocationDateClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLocationDateClusterResponseBody> body_ {};
  };
