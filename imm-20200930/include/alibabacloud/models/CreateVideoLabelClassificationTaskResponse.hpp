...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVideoLabelClassificationTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVideoLabelClassificationTaskResponseBody) };
    inline CreateVideoLabelClassificationTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVideoLabelClassificationTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVideoLabelClassificationTaskResponseBody> body_ {};
  };
