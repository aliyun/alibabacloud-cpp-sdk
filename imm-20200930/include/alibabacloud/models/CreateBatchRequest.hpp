...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateBatchRequestActions> & actions() const { DARABONBA_PTR_GET_CONST(actions_, vector<CreateBatchRequestActions>) };
    inline vector<CreateBatchRequestActions> actions() { DARABONBA_PTR_GET(actions_, vector<CreateBatchRequestActions>) };
    inline CreateBatchRequest& setActions(const vector<CreateBatchRequestActions> & actions) { DARABONBA_PTR_SET_VALUE(actions_, actions) };
    inline CreateBatchRequest& setActions(vector<CreateBatchRequestActions> && actions) { DARABONBA_PTR_SET_RVALUE(actions_, actions) };
    ...
    inline const CreateBatchRequestNotification & notification() const { DARABONBA_PTR_GET_CONST(notification_, CreateBatchRequestNotification) };
    inline CreateBatchRequestNotification notification() { DARABONBA_PTR_GET(notification_, CreateBatchRequestNotification) };
    inline CreateBatchRequest& setNotification(const CreateBatchRequestNotification & notification) { DARABONBA_PTR_SET_VALUE(notification_, notification) };
    inline CreateBatchRequest& setNotification(CreateBatchRequestNotification && notification) { DARABONBA_PTR_SET_RVALUE(notification_, notification) };
  ...
  protected:
    ...
    std::shared_ptr<vector<CreateBatchRequestActions>> actions_ = nullptr;
    ...
    std::shared_ptr<CreateBatchRequestNotification> notification_ = nullptr;
