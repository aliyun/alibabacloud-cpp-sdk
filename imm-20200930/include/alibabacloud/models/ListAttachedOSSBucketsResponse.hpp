...
namespace Models
{
  ...
  public:
    ...
    inline const ListAttachedOSSBucketsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAttachedOSSBucketsResponseBody) };
    inline ListAttachedOSSBucketsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAttachedOSSBucketsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAttachedOSSBucketsResponseBody> body_ {};
  };
