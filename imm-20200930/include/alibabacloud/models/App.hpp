...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appDescription_ == nullptr
        && this->appId_ == nullptr && this->appKey_ == nullptr && this->appName_ == nullptr && this->appRegion_ == nullptr && this->appType_ == nullptr
        && this->englishName_ == nullptr && this->ownerId_ == nullptr && this->packageName_ == nullptr; };
    ...
    inline int64_t getAppRegion() const { DARABONBA_PTR_GET_DEFAULT(appRegion_, 0L) };
    ...
    inline int64_t getAppType() const { DARABONBA_PTR_GET_DEFAULT(appType_, 0L) };
  ...
  protected:
    ...
    // AppRegion
    shared_ptr<int64_t> appRegion_ {};
    // AppType
    shared_ptr<int64_t> appType_ {};
    // EnglishName
