...
namespace Models
{
  ...
  public:
    ...
    inline UpdateDatasetResponseBody& setDataset(const Dataset & dataset) { DARABONBA_PTR_SET_VALUE(dataset_, dataset) };
    inline UpdateDatasetResponseBody& setDataset(Dataset && dataset) { DARABONBA_PTR_SET_RVALUE(dataset_, dataset) };
