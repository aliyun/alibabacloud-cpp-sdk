...
namespace Models
{
  ...
  public:
    ...
    inline const RefreshWebofficeTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RefreshWebofficeTokenResponseBody) };
    inline RefreshWebofficeTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, RefreshWebofficeTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RefreshWebofficeTokenResponseBody> body_ {};
  };
