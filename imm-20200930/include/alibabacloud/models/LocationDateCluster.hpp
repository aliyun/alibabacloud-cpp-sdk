...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addresses_ == nullptr
        && this->createTime_ == nullptr && this->customId_ == nullptr && this->customLabels_ == nullptr && this->locationDateClusterEndTime_ == nullptr && this->locationDateClusterLevel_ == nullptr
        && this->locationDateClusterStartTime_ == nullptr && this->objectId_ == nullptr && this->title_ == nullptr && this->updateTime_ == nullptr; };
    ...
    inline string getLocationDateClusterEndTime() const { DARABONBA_PTR_GET_DEFAULT(locationDateClusterEndTime_, "") };
    ...
    inline string getLocationDateClusterLevel() const { DARABONBA_PTR_GET_DEFAULT(locationDateClusterLevel_, "") };
    ...
    inline string getLocationDateClusterStartTime() const { DARABONBA_PTR_GET_DEFAULT(locationDateClusterStartTime_, "") };
  ...
  protected:
    ...
    shared_ptr<string> locationDateClusterEndTime_ {};
    ...
    // *   district
    // *   township
    shared_ptr<string> locationDateClusterLevel_ {};
    // The start time of the spatiotemporal cluster.
    shared_ptr<string> locationDateClusterStartTime_ {};
    // The cluster ID.
