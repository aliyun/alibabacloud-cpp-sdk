...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->compressMethod_ == nullptr
        && return this->credentialConfigShrink_ == nullptr && return this->kdtreeOptionShrink_ == nullptr && return this->notificationShrink_ == nullptr && return this->octreeOptionShrink_ == nullptr && return this->pointCloudFieldsShrink_ == nullptr
        && return this->pointCloudFileFormat_ == nullptr && return this->projectName_ == nullptr && return this->sourceURI_ == nullptr && return this->tagsShrink_ == nullptr && return this->targetURI_ == nullptr
