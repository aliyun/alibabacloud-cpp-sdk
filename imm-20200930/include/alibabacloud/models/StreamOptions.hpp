...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->incrementalOutput_ == nullptr
        && this->needReturnFinalResult_ == nullptr; };
    ...
    inline bool getIncrementalOutput() const { DARABONBA_PTR_GET_DEFAULT(incrementalOutput_, false) };
    ...
    inline bool getNeedReturnFinalResult() const { DARABONBA_PTR_GET_DEFAULT(needReturnFinalResult_, false) };
  ...
  protected:
    shared_ptr<bool> incrementalOutput_ {};
    shared_ptr<bool> needReturnFinalResult_ {};
  };
