...
namespace Models
{
  ...
  public:
    ...
    inline const TimeRange & getCreateTimeRange() const { DARABONBA_PTR_GET_CONST(createTimeRange_, TimeRange) };
    inline TimeRange getCreateTimeRange() { DARABONBA_PTR_GET(createTimeRange_, TimeRange) };
    ...
    inline const TimeRange & getStoryEndTimeRange() const { DARABONBA_PTR_GET_CONST(storyEndTimeRange_, TimeRange) };
    inline TimeRange getStoryEndTimeRange() { DARABONBA_PTR_GET(storyEndTimeRange_, TimeRange) };
    ...
    inline const TimeRange & getStoryStartTimeRange() const { DARABONBA_PTR_GET_CONST(storyStartTimeRange_, TimeRange) };
    inline TimeRange getStoryStartTimeRange() { DARABONBA_PTR_GET(storyStartTimeRange_, TimeRange) };
  ...
  protected:
    ...
    shared_ptr<TimeRange> createTimeRange_ {};
    ...
    shared_ptr<TimeRange> storyStartTimeRange_ {};
