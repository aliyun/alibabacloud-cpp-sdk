...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->datasetName_ == nullptr
        && this->endpoint_ == nullptr && this->modelSpecification_ == nullptr && this->runtime_ == nullptr && this->sourceURI_ == nullptr && this->targetURI_ == nullptr
        && this->transforms_ == nullptr && this->validationSourceURI_ == nullptr && this->validationSplit_ == nullptr; };
    ...
    inline const ModelSpecification & getModelSpecification() const { DARABONBA_PTR_GET_CONST(modelSpecification_, ModelSpecification) };
    inline ModelSpecification getModelSpecification() { DARABONBA_PTR_GET(modelSpecification_, ModelSpecification) };
    ...
    inline const vector<CustomParams> & getTransforms() const { DARABONBA_PTR_GET_CONST(transforms_, vector<CustomParams>) };
    inline vector<CustomParams> getTransforms() { DARABONBA_PTR_GET(transforms_, vector<CustomParams>) };
    ...
    inline string getValidationSourceURI() const { DARABONBA_PTR_GET_DEFAULT(validationSourceURI_, "") };
    ...
    inline float getValidationSplit() const { DARABONBA_PTR_GET_DEFAULT(validationSplit_, 0.0) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<ModelSpecification> modelSpecification_ {};
    ...
    shared_ptr<float> validationSplit_ {};
  };
