...
namespace Models
{
  ...
  public:
    ...
    inline const GetTriggerResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetTriggerResponseBody) };
    inline GetTriggerResponseBody body() { DARABONBA_PTR_GET(body_, GetTriggerResponseBody) };
    inline GetTriggerResponse& setBody(const GetTriggerResponseBody & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline GetTriggerResponse& setBody(GetTriggerResponseBody && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<GetTriggerResponseBody> body_ = nullptr;
  };
