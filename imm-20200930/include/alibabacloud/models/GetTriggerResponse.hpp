...
namespace Models
{
  ...
  public:
    ...
    inline const GetTriggerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTriggerResponseBody) };
    inline GetTriggerResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTriggerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTriggerResponseBody> body_ {};
  };
