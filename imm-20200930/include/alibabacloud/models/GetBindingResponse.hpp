...
namespace Models
{
  ...
  public:
    ...
    inline const GetBindingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetBindingResponseBody) };
    inline GetBindingResponseBody getBody() { DARABONBA_PTR_GET(body_, GetBindingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetBindingResponseBody> body_ {};
  };
