...
namespace Models
{
  ...
  public:
    ...
    inline const DetectImageCarsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetectImageCarsResponseBody) };
    inline DetectImageCarsResponseBody getBody() { DARABONBA_PTR_GET(body_, DetectImageCarsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetectImageCarsResponseBody> body_ {};
  };
