...
namespace Models
{
  ...
  public:
    ...
    inline const GetImageModerationResultResponseBody::ModerationResult & getModerationResult() const { DARABONBA_PTR_GET_CONST(moderationResult_, GetImageModerationResultResponseBody::ModerationResult) };
    inline GetImageModerationResultResponseBody::ModerationResult getModerationResult() { DARABONBA_PTR_GET(moderationResult_, GetImageModerationResultResponseBody::ModerationResult) };
    inline GetImageModerationResultResponseBody& setModerationResult(const GetImageModerationResultResponseBody::ModerationResult & moderationResult) { DARABONBA_PTR_SET_VALUE(moderationResult_, moderationResult) };
    inline GetImageModerationResultResponseBody& setModerationResult(GetImageModerationResultResponseBody::ModerationResult && moderationResult) { DARABONBA_PTR_SET_RVALUE(moderationResult_, moderationResult) };
