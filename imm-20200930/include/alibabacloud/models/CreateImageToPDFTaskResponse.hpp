...
namespace Models
{
  ...
  public:
    ...
    inline const CreateImageToPDFTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateImageToPDFTaskResponseBody) };
    inline CreateImageToPDFTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateImageToPDFTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateImageToPDFTaskResponseBody> body_ {};
  };
