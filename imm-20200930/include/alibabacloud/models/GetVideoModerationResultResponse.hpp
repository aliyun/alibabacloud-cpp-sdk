...
namespace Models
{
  ...
  public:
    ...
    inline const GetVideoModerationResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetVideoModerationResultResponseBody) };
    inline GetVideoModerationResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetVideoModerationResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetVideoModerationResultResponseBody> body_ {};
  };
