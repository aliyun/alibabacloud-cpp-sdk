...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOfficeConversionTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateOfficeConversionTaskResponseBody) };
    inline CreateOfficeConversionTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateOfficeConversionTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateOfficeConversionTaskResponseBody> body_ {};
  };
