...
namespace Models
{
  ...
  public:
    ...
    inline const ResumeTriggerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResumeTriggerResponseBody) };
    inline ResumeTriggerResponseBody getBody() { DARABONBA_PTR_GET(body_, ResumeTriggerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResumeTriggerResponseBody> body_ {};
  };
