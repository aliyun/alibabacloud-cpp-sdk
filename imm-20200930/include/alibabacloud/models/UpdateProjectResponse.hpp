...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateProjectResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateProjectResponseBody) };
    inline UpdateProjectResponseBody body() { DARABONBA_PTR_GET(body_, UpdateProjectResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateProjectResponseBody> body_ = nullptr;
  };
