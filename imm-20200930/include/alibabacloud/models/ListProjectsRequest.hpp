...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListProjectsRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<ListProjectsRequest::Tag>) };
    inline vector<ListProjectsRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<ListProjectsRequest::Tag>) };
    inline ListProjectsRequest& setTag(const vector<ListProjectsRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline ListProjectsRequest& setTag(vector<ListProjectsRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // The tags.
    shared_ptr<vector<ListProjectsRequest::Tag>> tag_ {};
  };
