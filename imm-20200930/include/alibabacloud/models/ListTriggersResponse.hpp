...
namespace Models
{
  ...
  public:
    ...
    inline const ListTriggersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTriggersResponseBody) };
    inline ListTriggersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTriggersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTriggersResponseBody> body_ {};
  };
