...
namespace Models
{
  ...
  public:
    ...
    inline const ListTriggersResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListTriggersResponseBody) };
    inline ListTriggersResponseBody body() { DARABONBA_PTR_GET(body_, ListTriggersResponseBody) };
    inline ListTriggersResponse& setBody(const ListTriggersResponseBody & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline ListTriggersResponse& setBody(ListTriggersResponseBody && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<ListTriggersResponseBody> body_ = nullptr;
  };
