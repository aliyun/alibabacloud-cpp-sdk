...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateStoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateStoryResponseBody) };
    inline UpdateStoryResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateStoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateStoryResponseBody> body_ {};
  };
