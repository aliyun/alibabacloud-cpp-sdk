...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTriggerResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteTriggerResponseBody) };
    inline DeleteTriggerResponseBody body() { DARABONBA_PTR_GET(body_, DeleteTriggerResponseBody) };
    inline DeleteTriggerResponse& setBody(const DeleteTriggerResponseBody & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline DeleteTriggerResponse& setBody(DeleteTriggerResponseBody && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<DeleteTriggerResponseBody> body_ = nullptr;
  };
