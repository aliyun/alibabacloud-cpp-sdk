...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTriggerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTriggerResponseBody) };
    inline DeleteTriggerResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTriggerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTriggerResponseBody> body_ {};
  };
