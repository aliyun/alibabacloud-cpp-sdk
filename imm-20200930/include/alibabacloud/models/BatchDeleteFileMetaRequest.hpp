...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->datasetName_ == nullptr
        && this->projectName_ == nullptr && this->URIs_ == nullptr; };
    ...
    inline const vector<string> & getURIs() const { DARABONBA_PTR_GET_CONST(URIs_, vector<string>) };
    inline vector<string> getURIs() { DARABONBA_PTR_GET(URIs_, vector<string>) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<string>> URIs_ {};
  };
