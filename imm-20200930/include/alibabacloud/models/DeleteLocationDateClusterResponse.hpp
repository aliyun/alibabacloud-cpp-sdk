...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLocationDateClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLocationDateClusterResponseBody) };
    inline DeleteLocationDateClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLocationDateClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLocationDateClusterResponseBody> body_ {};
  };
