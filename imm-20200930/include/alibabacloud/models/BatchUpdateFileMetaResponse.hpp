...
namespace Models
{
  ...
  public:
    ...
    inline const BatchUpdateFileMetaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchUpdateFileMetaResponseBody) };
    inline BatchUpdateFileMetaResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchUpdateFileMetaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchUpdateFileMetaResponseBody> body_ {};
  };
