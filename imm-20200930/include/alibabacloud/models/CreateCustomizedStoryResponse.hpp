...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCustomizedStoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCustomizedStoryResponseBody) };
    inline CreateCustomizedStoryResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCustomizedStoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCustomizedStoryResponseBody> body_ {};
  };
