...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteStoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteStoryResponseBody) };
    inline DeleteStoryResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteStoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteStoryResponseBody> body_ {};
  };
