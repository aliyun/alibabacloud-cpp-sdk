...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->certId_ == nullptr
        && return this->certName_ == nullptr && return this->certRegion_ == nullptr && return this->certType_ == nullptr && return this->domainName_ == nullptr && return this->env_ == nullptr
        && return this->ownerId_ == nullptr && return this->SSLPri_ == nullptr && return this->SSLProtocol_ == nullptr && return this->SSLPub_ == nullptr && return this->securityToken_ == nullptr; };
