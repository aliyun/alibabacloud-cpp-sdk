...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodSSLCertificateListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodSSLCertificateListResponseBody) };
    inline DescribeVodSSLCertificateListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVodSSLCertificateListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodSSLCertificateListResponseBody> body_ {};
  };
