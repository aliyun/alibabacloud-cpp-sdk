...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAuditResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAuditResponseBody) };
    inline CreateAuditResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAuditResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAuditResponseBody> body_ {};
  };
