...
namespace Models
{
  ...
  public:
    ...
    inline const GetJobDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetJobDetailResponseBody) };
    inline GetJobDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetJobDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetJobDetailResponseBody> body_ {};
  };
