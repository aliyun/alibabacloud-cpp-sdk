...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->forceDelGroup_ == nullptr
    ...
    inline string getForceDelGroup() const { DARABONBA_PTR_GET_DEFAULT(forceDelGroup_, "") };
    ...
    inline string getTranscodeTemplateIds() const { DARABONBA_PTR_GET_DEFAULT(transcodeTemplateIds_, "") };
