...
namespace Models
{
  ...
  public:
    ...
    inline const BatchStartVodDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchStartVodDomainResponseBody) };
    inline BatchStartVodDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchStartVodDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchStartVodDomainResponseBody> body_ {};
  };
