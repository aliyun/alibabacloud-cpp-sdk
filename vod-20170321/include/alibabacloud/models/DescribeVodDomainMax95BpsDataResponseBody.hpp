...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->detailData_ == nullptr
        && return this->domainName_ == nullptr && return this->domesticMax95Bps_ == nullptr && return this->endTime_ == nullptr && return this->max95Bps_ == nullptr && return this->overseasMax95Bps_ == nullptr
