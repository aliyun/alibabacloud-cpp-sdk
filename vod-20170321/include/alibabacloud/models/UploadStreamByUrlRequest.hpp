...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->definition_ == nullptr
        && return this->fileExtension_ == nullptr && return this->HDRType_ == nullptr && return this->mediaId_ == nullptr && return this->streamURL_ == nullptr && return this->uploadMetadata_ == nullptr
    ...
    inline string uploadMetadata() const { DARABONBA_PTR_GET_DEFAULT(uploadMetadata_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> uploadMetadata_ = nullptr;
