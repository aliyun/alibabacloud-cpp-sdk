...
namespace Models
{
  ...
  public:
    ...
    inline const GetEditingProjectMaterialsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetEditingProjectMaterialsResponseBody) };
    inline GetEditingProjectMaterialsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetEditingProjectMaterialsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetEditingProjectMaterialsResponseBody> body_ {};
  };
