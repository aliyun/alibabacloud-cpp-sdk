...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateEditingProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateEditingProjectResponseBody) };
    inline UpdateEditingProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateEditingProjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateEditingProjectResponseBody> body_ {};
  };
