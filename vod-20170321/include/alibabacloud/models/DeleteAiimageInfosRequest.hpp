...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->AIImageInfoIds_ != nullptr; };
    ...
    inline string AIImageInfoIds() const { DARABONBA_PTR_GET_DEFAULT(AIImageInfoIds_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> AIImageInfoIds_ = nullptr;
  };
