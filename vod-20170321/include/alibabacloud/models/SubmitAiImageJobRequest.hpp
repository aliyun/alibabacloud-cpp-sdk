...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->AIPipelineId_ == nullptr
        && return this->AITemplateId_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr
    ...
    inline string AITemplateId() const { DARABONBA_PTR_GET_DEFAULT(AITemplateId_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> AITemplateId_ = nullptr;
