...
namespace Models
{
  ...
  public:
    ...
    inline const SearchEditingProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchEditingProjectResponseBody) };
    inline SearchEditingProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchEditingProjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchEditingProjectResponseBody> body_ {};
  };
