...
namespace Models
{
  ...
  public:
    ...
    inline const ListVodTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListVodTemplateResponseBody) };
    inline ListVodTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, ListVodTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListVodTemplateResponseBody> body_ {};
  };
