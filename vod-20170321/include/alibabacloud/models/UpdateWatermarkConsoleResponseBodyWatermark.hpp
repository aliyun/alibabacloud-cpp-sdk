...
#ifndef ALIBABACLOUD_MODELS_UPDATEWATERMARKCONSOLERESPONSEBODYWATERMARK_HPP_
#define ALIBABACLOUD_MODELS_UPDATEWATERMARKCONSOLERESPONSEBODYWATERMARK_HPP_
...
namespace Models
{
  class UpdateWatermarkConsoleResponseBodyWatermark : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateWatermarkConsoleResponseBodyWatermark& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateWatermarkConsoleResponseBodyWatermark& obj) { 
    ...
    UpdateWatermarkConsoleResponseBodyWatermark() = default ;
    UpdateWatermarkConsoleResponseBodyWatermark(const UpdateWatermarkConsoleResponseBodyWatermark &) = default ;
    UpdateWatermarkConsoleResponseBodyWatermark(UpdateWatermarkConsoleResponseBodyWatermark &&) = default ;
    UpdateWatermarkConsoleResponseBodyWatermark(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateWatermarkConsoleResponseBodyWatermark() = default ;
    UpdateWatermarkConsoleResponseBodyWatermark& operator=(const UpdateWatermarkConsoleResponseBodyWatermark &) = default ;
    UpdateWatermarkConsoleResponseBodyWatermark& operator=(UpdateWatermarkConsoleResponseBodyWatermark &&) = default ;
    ...
    inline UpdateWatermarkConsoleResponseBodyWatermark& setCreateTime(int32_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline UpdateWatermarkConsoleResponseBodyWatermark& setHeight(string height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline UpdateWatermarkConsoleResponseBodyWatermark& setHorizontalOffset(string horizontalOffset) { DARABONBA_PTR_SET_VALUE(horizontalOffset_, horizontalOffset) };
    ...
    inline UpdateWatermarkConsoleResponseBodyWatermark& setIsDefault(string isDefault) { DARABONBA_PTR_SET_VALUE(isDefault_, isDefault) };
    ...
    inline UpdateWatermarkConsoleResponseBodyWatermark& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline UpdateWatermarkConsoleResponseBodyWatermark& setPosition(string position) { DARABONBA_PTR_SET_VALUE(position_, position) };
    ...
    inline UpdateWatermarkConsoleResponseBodyWatermark& setScreenMode(string screenMode) { DARABONBA_PTR_SET_VALUE(screenMode_, screenMode) };
    ...
    inline UpdateWatermarkConsoleResponseBodyWatermark& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
    ...
    inline UpdateWatermarkConsoleResponseBodyWatermark& setVerticalOffset(string verticalOffset) { DARABONBA_PTR_SET_VALUE(verticalOffset_, verticalOffset) };
    ...
    inline UpdateWatermarkConsoleResponseBodyWatermark& setVideoHeight(int32_t videoHeight) { DARABONBA_PTR_SET_VALUE(videoHeight_, videoHeight) };
    ...
    inline UpdateWatermarkConsoleResponseBodyWatermark& setVideoWidth(int32_t videoWidth) { DARABONBA_PTR_SET_VALUE(videoWidth_, videoWidth) };
    ...
    inline UpdateWatermarkConsoleResponseBodyWatermark& setWatermarkId(string watermarkId) { DARABONBA_PTR_SET_VALUE(watermarkId_, watermarkId) };
    ...
    inline UpdateWatermarkConsoleResponseBodyWatermark& setWidth(string width) { DARABONBA_PTR_SET_VALUE(width_, width) };
