...
#ifndef ALIBABACLOUD_MODELS_GETPLAYINFORESPONSEBODYPLAYINFOLISTPLAYINFO_HPP_
#define ALIBABACLOUD_MODELS_GETPLAYINFORESPONSEBODYPLAYINFOLISTPLAYINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetPlayInfoResponseBodyPlayInfoListPlayInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetPlayInfoResponseBodyPlayInfoListPlayInfo& obj) { 
    ...
    GetPlayInfoResponseBodyPlayInfoListPlayInfo() = default ;
    GetPlayInfoResponseBodyPlayInfoListPlayInfo(const GetPlayInfoResponseBodyPlayInfoListPlayInfo &) = default ;
    GetPlayInfoResponseBodyPlayInfoListPlayInfo(GetPlayInfoResponseBodyPlayInfoListPlayInfo &&) = default ;
    GetPlayInfoResponseBodyPlayInfoListPlayInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetPlayInfoResponseBodyPlayInfoListPlayInfo() = default ;
    GetPlayInfoResponseBodyPlayInfoListPlayInfo& operator=(const GetPlayInfoResponseBodyPlayInfoListPlayInfo &) = default ;
    GetPlayInfoResponseBodyPlayInfoListPlayInfo& operator=(GetPlayInfoResponseBodyPlayInfoListPlayInfo &&) = default ;
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setBitDepth(int32_t bitDepth) { DARABONBA_PTR_SET_VALUE(bitDepth_, bitDepth) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setBitrate(string bitrate) { DARABONBA_PTR_SET_VALUE(bitrate_, bitrate) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setCodecName(string codecName) { DARABONBA_PTR_SET_VALUE(codecName_, codecName) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setCreationTime(string creationTime) { DARABONBA_PTR_SET_VALUE(creationTime_, creationTime) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setDefinition(string definition) { DARABONBA_PTR_SET_VALUE(definition_, definition) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setDuration(string duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setEncrypt(int64_t encrypt) { DARABONBA_PTR_SET_VALUE(encrypt_, encrypt) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setEncryptMode(string encryptMode) { DARABONBA_PTR_SET_VALUE(encryptMode_, encryptMode) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setEncryptType(string encryptType) { DARABONBA_PTR_SET_VALUE(encryptType_, encryptType) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setFormat(string format) { DARABONBA_PTR_SET_VALUE(format_, format) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setFps(string fps) { DARABONBA_PTR_SET_VALUE(fps_, fps) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setHDRType(string HDRType) { DARABONBA_PTR_SET_VALUE(HDRType_, HDRType) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setHeight(int64_t height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setJobExt(string jobExt) { DARABONBA_PTR_SET_VALUE(jobExt_, jobExt) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setJobType(int32_t jobType) { DARABONBA_PTR_SET_VALUE(jobType_, jobType) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setModificationTime(string modificationTime) { DARABONBA_PTR_SET_VALUE(modificationTime_, modificationTime) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setNarrowBandType(string narrowBandType) { DARABONBA_PTR_SET_VALUE(narrowBandType_, narrowBandType) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setPlayURL(string playURL) { DARABONBA_PTR_SET_VALUE(playURL_, playURL) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setSize(int64_t size) { DARABONBA_PTR_SET_VALUE(size_, size) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setSpecification(string specification) { DARABONBA_PTR_SET_VALUE(specification_, specification) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setStreamType(string streamType) { DARABONBA_PTR_SET_VALUE(streamType_, streamType) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setWatermarkId(string watermarkId) { DARABONBA_PTR_SET_VALUE(watermarkId_, watermarkId) };
    ...
    inline GetPlayInfoResponseBodyPlayInfoListPlayInfo& setWidth(int64_t width) { DARABONBA_PTR_SET_VALUE(width_, width) };
