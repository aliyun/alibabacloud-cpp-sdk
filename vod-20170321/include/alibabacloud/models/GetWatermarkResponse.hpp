...
namespace Models
{
  ...
  public:
    ...
    inline const GetWatermarkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetWatermarkResponseBody) };
    inline GetWatermarkResponseBody getBody() { DARABONBA_PTR_GET(body_, GetWatermarkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetWatermarkResponseBody> body_ {};
  };
