...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEVODDOMAINSUSAGEBYDAYRESPONSEBODYUSAGEBYDAYSUSAGEBYDAY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEVODDOMAINSUSAGEBYDAYRESPONSEBODYUSAGEBYDAYSUSAGEBYDAY_HPP_
...
namespace Models
{
  class DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay& obj) { 
    ...
    DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay() = default ;
    DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay(const DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay &) = default ;
    DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay(DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay &&) = default ;
    DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay() = default ;
    DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay& operator=(const DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay &) = default ;
    DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay& operator=(DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay &&) = default ;
    ...
    inline DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay& setBytesHitRate(string bytesHitRate) { DARABONBA_PTR_SET_VALUE(bytesHitRate_, bytesHitRate) };
    ...
    inline DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay& setMaxBps(string maxBps) { DARABONBA_PTR_SET_VALUE(maxBps_, maxBps) };
    ...
    inline DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay& setMaxBpsTime(string maxBpsTime) { DARABONBA_PTR_SET_VALUE(maxBpsTime_, maxBpsTime) };
    ...
    inline DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay& setMaxSrcBps(string maxSrcBps) { DARABONBA_PTR_SET_VALUE(maxSrcBps_, maxSrcBps) };
    ...
    inline DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay& setMaxSrcBpsTime(string maxSrcBpsTime) { DARABONBA_PTR_SET_VALUE(maxSrcBpsTime_, maxSrcBpsTime) };
    ...
    inline DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay& setQps(string qps) { DARABONBA_PTR_SET_VALUE(qps_, qps) };
    ...
    inline DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay& setRequestHitRate(string requestHitRate) { DARABONBA_PTR_SET_VALUE(requestHitRate_, requestHitRate) };
    ...
    inline DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay& setTimeStamp(string timeStamp) { DARABONBA_PTR_SET_VALUE(timeStamp_, timeStamp) };
    ...
    inline DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay& setTotalAccess(string totalAccess) { DARABONBA_PTR_SET_VALUE(totalAccess_, totalAccess) };
    ...
    inline DescribeVodDomainsUsageByDayResponseBodyUsageByDaysUsageByDay& setTotalTraffic(string totalTraffic) { DARABONBA_PTR_SET_VALUE(totalTraffic_, totalTraffic) };
