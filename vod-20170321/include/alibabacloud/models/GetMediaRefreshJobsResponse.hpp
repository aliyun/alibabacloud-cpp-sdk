...
namespace Models
{
  ...
  public:
    ...
    inline const GetMediaRefreshJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMediaRefreshJobsResponseBody) };
    inline GetMediaRefreshJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMediaRefreshJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMediaRefreshJobsResponseBody> body_ {};
  };
