...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateWatermarkResponseBody::WatermarkInfo & getWatermarkInfo() const { DARABONBA_PTR_GET_CONST(watermarkInfo_, UpdateWatermarkResponseBody::WatermarkInfo) };
    inline UpdateWatermarkResponseBody::WatermarkInfo getWatermarkInfo() { DARABONBA_PTR_GET(watermarkInfo_, UpdateWatermarkResponseBody::WatermarkInfo) };
    inline UpdateWatermarkResponseBody& setWatermarkInfo(const UpdateWatermarkResponseBody::WatermarkInfo & watermarkInfo) { DARABONBA_PTR_SET_VALUE(watermarkInfo_, watermarkInfo) };
    inline UpdateWatermarkResponseBody& setWatermarkInfo(UpdateWatermarkResponseBody::WatermarkInfo && watermarkInfo) { DARABONBA_PTR_SET_RVALUE(watermarkInfo_, watermarkInfo) };
  ...
  protected:
    ...
    shared_ptr<UpdateWatermarkResponseBody::WatermarkInfo> watermarkInfo_ {};
  };
