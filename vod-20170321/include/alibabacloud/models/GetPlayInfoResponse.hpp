...
namespace Models
{
  ...
  public:
    ...
    inline const GetPlayInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPlayInfoResponseBody) };
    inline GetPlayInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPlayInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPlayInfoResponseBody> body_ {};
  };
