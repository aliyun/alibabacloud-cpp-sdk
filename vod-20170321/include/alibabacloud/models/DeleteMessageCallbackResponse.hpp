...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMessageCallbackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMessageCallbackResponseBody) };
    inline DeleteMessageCallbackResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMessageCallbackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMessageCallbackResponseBody> body_ {};
  };
