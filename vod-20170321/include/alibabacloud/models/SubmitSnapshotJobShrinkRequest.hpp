...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->count_ == nullptr
        && return this->height_ == nullptr && return this->interval_ == nullptr && return this->snapshotTemplateId_ == nullptr && return this->specifiedOffsetTime_ == nullptr && return this->specifiedOffsetTimesShrink_ == nullptr
    ...
    inline string specifiedOffsetTimesShrink() const { DARABONBA_PTR_GET_DEFAULT(specifiedOffsetTimesShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> specifiedOffsetTimesShrink_ = nullptr;
