...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->transcodeTaskList_ == nullptr; };
    ...
    inline const vector<ListTranscodeTaskResponseBodyTranscodeTaskList> & transcodeTaskList() const { DARABONBA_PTR_GET_CONST(transcodeTaskList_, vector<ListTranscodeTaskResponseBodyTranscodeTaskList>) };
    inline vector<ListTranscodeTaskResponseBodyTranscodeTaskList> transcodeTaskList() { DARABONBA_PTR_GET(transcodeTaskList_, vector<ListTranscodeTaskResponseBodyTranscodeTaskList>) };
    inline ListTranscodeTaskResponseBody& setTranscodeTaskList(const vector<ListTranscodeTaskResponseBodyTranscodeTaskList> & transcodeTaskList) { DARABONBA_PTR_SET_VALUE(transcodeTaskList_, transcodeTaskList) };
    inline ListTranscodeTaskResponseBody& setTranscodeTaskList(vector<ListTranscodeTaskResponseBodyTranscodeTaskList> && transcodeTaskList) { DARABONBA_PTR_SET_RVALUE(transcodeTaskList_, transcodeTaskList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListTranscodeTaskResponseBodyTranscodeTaskList>> transcodeTaskList_ = nullptr;
  };
