...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodDomainRealTimeReqHitRateDataResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeVodDomainRealTimeReqHitRateDataResponseBody::Data) };
    inline DescribeVodDomainRealTimeReqHitRateDataResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeVodDomainRealTimeReqHitRateDataResponseBody::Data) };
    inline DescribeVodDomainRealTimeReqHitRateDataResponseBody& setData(const DescribeVodDomainRealTimeReqHitRateDataResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeVodDomainRealTimeReqHitRateDataResponseBody& setData(DescribeVodDomainRealTimeReqHitRateDataResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
