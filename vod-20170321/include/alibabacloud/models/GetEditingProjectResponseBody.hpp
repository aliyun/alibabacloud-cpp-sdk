...
namespace Models
{
  ...
  public:
    ...
    inline const GetEditingProjectResponseBodyProject & project() const { DARABONBA_PTR_GET_CONST(project_, GetEditingProjectResponseBodyProject) };
    inline GetEditingProjectResponseBodyProject project() { DARABONBA_PTR_GET(project_, GetEditingProjectResponseBodyProject) };
    inline GetEditingProjectResponseBody& setProject(const GetEditingProjectResponseBodyProject & project) { DARABONBA_PTR_SET_VALUE(project_, project) };
    inline GetEditingProjectResponseBody& setProject(GetEditingProjectResponseBodyProject && project) { DARABONBA_PTR_SET_RVALUE(project_, project) };
  ...
  protected:
    ...
    std::shared_ptr<GetEditingProjectResponseBodyProject> project_ = nullptr;
