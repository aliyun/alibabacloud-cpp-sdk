...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->forbiddenList_ == nullptr
        && this->ignoredList_ == nullptr && this->requestId_ == nullptr && this->success_ == nullptr; };
    ...
    inline const RestoreMediaResponseBody::ForbiddenList & getForbiddenList() const { DARABONBA_PTR_GET_CONST(forbiddenList_, RestoreMediaResponseBody::ForbiddenList) };
    inline RestoreMediaResponseBody::ForbiddenList getForbiddenList() { DARABONBA_PTR_GET(forbiddenList_, RestoreMediaResponseBody::ForbiddenList) };
    inline RestoreMediaResponseBody& setForbiddenList(const RestoreMediaResponseBody::ForbiddenList & forbiddenList) { DARABONBA_PTR_SET_VALUE(forbiddenList_, forbiddenList) };
    inline RestoreMediaResponseBody& setForbiddenList(RestoreMediaResponseBody::ForbiddenList && forbiddenList) { DARABONBA_PTR_SET_RVALUE(forbiddenList_, forbiddenList) };
    ...
    inline const RestoreMediaResponseBody::IgnoredList & getIgnoredList() const { DARABONBA_PTR_GET_CONST(ignoredList_, RestoreMediaResponseBody::IgnoredList) };
    inline RestoreMediaResponseBody::IgnoredList getIgnoredList() { DARABONBA_PTR_GET(ignoredList_, RestoreMediaResponseBody::IgnoredList) };
    inline RestoreMediaResponseBody& setIgnoredList(const RestoreMediaResponseBody::IgnoredList & ignoredList) { DARABONBA_PTR_SET_VALUE(ignoredList_, ignoredList) };
    inline RestoreMediaResponseBody& setIgnoredList(RestoreMediaResponseBody::IgnoredList && ignoredList) { DARABONBA_PTR_SET_RVALUE(ignoredList_, ignoredList) };
