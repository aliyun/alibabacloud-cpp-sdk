...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEPLAYQOSLISTSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEPLAYQOSLISTSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribePlayQosListShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribePlayQosListShrinkRequest& obj) { 
    ...
    DescribePlayQosListShrinkRequest() = default ;
    DescribePlayQosListShrinkRequest(const DescribePlayQosListShrinkRequest &) = default ;
    DescribePlayQosListShrinkRequest(DescribePlayQosListShrinkRequest &&) = default ;
    DescribePlayQosListShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribePlayQosListShrinkRequest() = default ;
    DescribePlayQosListShrinkRequest& operator=(const DescribePlayQosListShrinkRequest &) = default ;
    DescribePlayQosListShrinkRequest& operator=(DescribePlayQosListShrinkRequest &&) = default ;
    ...
    inline DescribePlayQosListShrinkRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline DescribePlayQosListShrinkRequest& setBeginTs(int64_t beginTs) { DARABONBA_PTR_SET_VALUE(beginTs_, beginTs) };
    ...
    inline DescribePlayQosListShrinkRequest& setDefinition(string definition) { DARABONBA_PTR_SET_VALUE(definition_, definition) };
    ...
    inline DescribePlayQosListShrinkRequest& setEndTs(int64_t endTs) { DARABONBA_PTR_SET_VALUE(endTs_, endTs) };
    ...
    inline DescribePlayQosListShrinkRequest& setItemConfigs(string itemConfigs) { DARABONBA_PTR_SET_VALUE(itemConfigs_, itemConfigs) };
    ...
    inline DescribePlayQosListShrinkRequest& setMetricTypesShrink(string metricTypesShrink) { DARABONBA_PTR_SET_VALUE(metricTypesShrink_, metricTypesShrink) };
    ...
    inline DescribePlayQosListShrinkRequest& setNetwork(string network) { DARABONBA_PTR_SET_VALUE(network_, network) };
    ...
    inline DescribePlayQosListShrinkRequest& setOrderName(string orderName) { DARABONBA_PTR_SET_VALUE(orderName_, orderName) };
    ...
    inline DescribePlayQosListShrinkRequest& setOrderType(string orderType) { DARABONBA_PTR_SET_VALUE(orderType_, orderType) };
    ...
    inline DescribePlayQosListShrinkRequest& setOs(string os) { DARABONBA_PTR_SET_VALUE(os_, os) };
    ...
    inline DescribePlayQosListShrinkRequest& setPageNo(int64_t pageNo) { DARABONBA_PTR_SET_VALUE(pageNo_, pageNo) };
    ...
    inline DescribePlayQosListShrinkRequest& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline DescribePlayQosListShrinkRequest& setTerminalType(string terminalType) { DARABONBA_PTR_SET_VALUE(terminalType_, terminalType) };
