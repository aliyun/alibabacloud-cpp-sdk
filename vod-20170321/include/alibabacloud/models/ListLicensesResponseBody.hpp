...
namespace Models
{
  ...
  public:
    ...
    inline const ListLicensesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListLicensesResponseBodyData) };
    inline ListLicensesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListLicensesResponseBodyData) };
    inline ListLicensesResponseBody& setData(const ListLicensesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListLicensesResponseBody& setData(ListLicensesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListLicensesResponseBody& setPageNo(int64_t pageNo) { DARABONBA_PTR_SET_VALUE(pageNo_, pageNo) };
    ...
    inline ListLicensesResponseBody& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
  ...
  protected:
    ...
    std::shared_ptr<ListLicensesResponseBodyData> data_ = nullptr;
