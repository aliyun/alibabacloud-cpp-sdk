...
namespace Models
{
  ...
  public:
    ...
    inline const GetMessageCallbackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMessageCallbackResponseBody) };
    inline GetMessageCallbackResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMessageCallbackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMessageCallbackResponseBody> body_ {};
  };
