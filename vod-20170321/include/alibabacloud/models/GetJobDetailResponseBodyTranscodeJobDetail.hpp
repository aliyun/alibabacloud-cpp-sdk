...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->completeTime_ == nullptr
        && return this->createTime_ == nullptr && return this->definition_ == nullptr && return this->jobId_ == nullptr && return this->status_ == nullptr && return this->templateId_ == nullptr
        && return this->userId_ == nullptr && return this->videoId_ == nullptr; };
