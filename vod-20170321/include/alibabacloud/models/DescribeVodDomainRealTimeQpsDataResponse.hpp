...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodDomainRealTimeQpsDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodDomainRealTimeQpsDataResponseBody) };
    inline DescribeVodDomainRealTimeQpsDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVodDomainRealTimeQpsDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodDomainRealTimeQpsDataResponseBody> body_ {};
  };
