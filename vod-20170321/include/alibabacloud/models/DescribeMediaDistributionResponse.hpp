...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMediaDistributionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeMediaDistributionResponseBody) };
    inline DescribeMediaDistributionResponseBody body() { DARABONBA_PTR_GET(body_, DescribeMediaDistributionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeMediaDistributionResponseBody> body_ = nullptr;
  };
