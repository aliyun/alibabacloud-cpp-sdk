...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodDomainConfigsResponseBody::DomainConfigs & getDomainConfigs() const { DARABONBA_PTR_GET_CONST(domainConfigs_, DescribeVodDomainConfigsResponseBody::DomainConfigs) };
    inline DescribeVodDomainConfigsResponseBody::DomainConfigs getDomainConfigs() { DARABONBA_PTR_GET(domainConfigs_, DescribeVodDomainConfigsResponseBody::DomainConfigs) };
    inline DescribeVodDomainConfigsResponseBody& setDomainConfigs(const DescribeVodDomainConfigsResponseBody::DomainConfigs & domainConfigs) { DARABONBA_PTR_SET_VALUE(domainConfigs_, domainConfigs) };
    inline DescribeVodDomainConfigsResponseBody& setDomainConfigs(DescribeVodDomainConfigsResponseBody::DomainConfigs && domainConfigs) { DARABONBA_PTR_SET_RVALUE(domainConfigs_, domainConfigs) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodDomainConfigsResponseBody::DomainConfigs> domainConfigs_ {};
    // The request ID.
