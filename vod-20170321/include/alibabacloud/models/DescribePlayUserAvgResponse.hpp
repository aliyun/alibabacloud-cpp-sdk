...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePlayUserAvgResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePlayUserAvgResponseBody) };
    inline DescribePlayUserAvgResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePlayUserAvgResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePlayUserAvgResponseBody> body_ {};
  };
