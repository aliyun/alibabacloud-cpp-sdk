...
namespace Models
{
  ...
  public:
    ...
    inline const SearchMediaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchMediaResponseBody) };
    inline SearchMediaResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchMediaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchMediaResponseBody> body_ {};
  };
