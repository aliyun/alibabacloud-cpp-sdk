...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetImageInfosResponseBody::ImageInfo> & getImageInfo() const { DARABONBA_PTR_GET_CONST(imageInfo_, vector<GetImageInfosResponseBody::ImageInfo>) };
    inline vector<GetImageInfosResponseBody::ImageInfo> getImageInfo() { DARABONBA_PTR_GET(imageInfo_, vector<GetImageInfosResponseBody::ImageInfo>) };
    inline GetImageInfosResponseBody& setImageInfo(const vector<GetImageInfosResponseBody::ImageInfo> & imageInfo) { DARABONBA_PTR_SET_VALUE(imageInfo_, imageInfo) };
    inline GetImageInfosResponseBody& setImageInfo(vector<GetImageInfosResponseBody::ImageInfo> && imageInfo) { DARABONBA_PTR_SET_RVALUE(imageInfo_, imageInfo) };
    ...
    inline const vector<string> & getNonExistImageIds() const { DARABONBA_PTR_GET_CONST(nonExistImageIds_, vector<string>) };
    inline vector<string> getNonExistImageIds() { DARABONBA_PTR_GET(nonExistImageIds_, vector<string>) };
