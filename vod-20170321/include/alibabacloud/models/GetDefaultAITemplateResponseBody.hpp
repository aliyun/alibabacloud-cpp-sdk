...
namespace Models
{
  ...
  public:
    ...
    inline const GetDefaultAITemplateResponseBody::TemplateInfo & getTemplateInfo() const { DARABONBA_PTR_GET_CONST(templateInfo_, GetDefaultAITemplateResponseBody::TemplateInfo) };
    inline GetDefaultAITemplateResponseBody::TemplateInfo getTemplateInfo() { DARABONBA_PTR_GET(templateInfo_, GetDefaultAITemplateResponseBody::TemplateInfo) };
    inline GetDefaultAITemplateResponseBody& setTemplateInfo(const GetDefaultAITemplateResponseBody::TemplateInfo & templateInfo) { DARABONBA_PTR_SET_VALUE(templateInfo_, templateInfo) };
    inline GetDefaultAITemplateResponseBody& setTemplateInfo(GetDefaultAITemplateResponseBody::TemplateInfo && templateInfo) { DARABONBA_PTR_SET_RVALUE(templateInfo_, templateInfo) };
  ...
  protected:
    ...
    shared_ptr<GetDefaultAITemplateResponseBody::TemplateInfo> templateInfo_ {};
  };
