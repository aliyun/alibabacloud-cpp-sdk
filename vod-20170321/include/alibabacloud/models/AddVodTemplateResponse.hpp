...
namespace Models
{
  ...
  public:
    ...
    inline const AddVodTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddVodTemplateResponseBody) };
    inline AddVodTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, AddVodTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddVodTemplateResponseBody> body_ {};
  };
