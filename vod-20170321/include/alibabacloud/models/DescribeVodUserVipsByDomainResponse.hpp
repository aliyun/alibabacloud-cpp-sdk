...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodUserVipsByDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodUserVipsByDomainResponseBody) };
    inline DescribeVodUserVipsByDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVodUserVipsByDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodUserVipsByDomainResponseBody> body_ {};
  };
