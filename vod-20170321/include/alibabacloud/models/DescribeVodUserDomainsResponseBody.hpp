  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->port_ == nullptr && this->priority_ == nullptr && this->type_ == nullptr; };
    ...
    inline const DescribeVodUserDomainsResponseBody::Domains & getDomains() const { DARABONBA_PTR_GET_CONST(domains_, DescribeVodUserDomainsResponseBody::Domains) };
    inline DescribeVodUserDomainsResponseBody::Domains getDomains() { DARABONBA_PTR_GET(domains_, DescribeVodUserDomainsResponseBody::Domains) };
    inline DescribeVodUserDomainsResponseBody& setDomains(const DescribeVodUserDomainsResponseBody::Domains & domains) { DARABONBA_PTR_SET_VALUE(domains_, domains) };
    inline DescribeVodUserDomainsResponseBody& setDomains(DescribeVodUserDomainsResponseBody::Domains && domains) { DARABONBA_PTR_SET_RVALUE(domains_, domains) };
