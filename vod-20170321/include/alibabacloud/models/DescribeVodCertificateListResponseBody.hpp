...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodCertificateListResponseBodyCertificateListModel & certificateListModel() const { DARABONBA_PTR_GET_CONST(certificateListModel_, DescribeVodCertificateListResponseBodyCertificateListModel) };
    inline DescribeVodCertificateListResponseBodyCertificateListModel certificateListModel() { DARABONBA_PTR_GET(certificateListModel_, DescribeVodCertificateListResponseBodyCertificateListModel) };
    inline DescribeVodCertificateListResponseBody& setCertificateListModel(const DescribeVodCertificateListResponseBodyCertificateListModel & certificateListModel) { DARABONBA_PTR_SET_VALUE(certificateListModel_, certificateListModel) };
    inline DescribeVodCertificateListResponseBody& setCertificateListModel(DescribeVodCertificateListResponseBodyCertificateListModel && certificateListModel) { DARABONBA_PTR_SET_RVALUE(certificateListModel_, certificateListModel) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVodCertificateListResponseBodyCertificateListModel> certificateListModel_ = nullptr;
