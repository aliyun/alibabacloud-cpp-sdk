...
namespace Models
{
  ...
  public:
    ...
    inline const DecryptKMSDataKeyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DecryptKMSDataKeyResponseBody) };
    inline DecryptKMSDataKeyResponseBody getBody() { DARABONBA_PTR_GET(body_, DecryptKMSDataKeyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DecryptKMSDataKeyResponseBody> body_ {};
  };
