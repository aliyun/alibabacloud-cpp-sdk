...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataInterval_ == nullptr
        && return this->domainName_ == nullptr && return this->endTime_ == nullptr && return this->requestId_ == nullptr && return this->srcBpsDataPerInterval_ == nullptr && return this->startTime_ == nullptr; };
    ...
    inline const DescribeVodDomainSrcBpsDataResponseBodySrcBpsDataPerInterval & srcBpsDataPerInterval() const { DARABONBA_PTR_GET_CONST(srcBpsDataPerInterval_, DescribeVodDomainSrcBpsDataResponseBodySrcBpsDataPerInterval) };
    inline DescribeVodDomainSrcBpsDataResponseBodySrcBpsDataPerInterval srcBpsDataPerInterval() { DARABONBA_PTR_GET(srcBpsDataPerInterval_, DescribeVodDomainSrcBpsDataResponseBodySrcBpsDataPerInterval) };
    inline DescribeVodDomainSrcBpsDataResponseBody& setSrcBpsDataPerInterval(const DescribeVodDomainSrcBpsDataResponseBodySrcBpsDataPerInterval & srcBpsDataPerInterval) { DARABONBA_PTR_SET_VALUE(srcBpsDataPerInterval_, srcBpsDataPerInterval) };
    inline DescribeVodDomainSrcBpsDataResponseBody& setSrcBpsDataPerInterval(DescribeVodDomainSrcBpsDataResponseBodySrcBpsDataPerInterval && srcBpsDataPerInterval) { DARABONBA_PTR_SET_RVALUE(srcBpsDataPerInterval_, srcBpsDataPerInterval) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVodDomainSrcBpsDataResponseBodySrcBpsDataPerInterval> srcBpsDataPerInterval_ = nullptr;
