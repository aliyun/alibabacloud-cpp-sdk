...
namespace Models
{
  ...
  public:
    ...
    inline const SetCrossdomainContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetCrossdomainContentResponseBody) };
    inline SetCrossdomainContentResponseBody getBody() { DARABONBA_PTR_GET(body_, SetCrossdomainContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetCrossdomainContentResponseBody> body_ {};
  };
