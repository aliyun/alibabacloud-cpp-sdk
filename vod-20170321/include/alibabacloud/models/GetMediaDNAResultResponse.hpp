...
namespace Models
{
  ...
  public:
    ...
    inline const GetMediaDNAResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMediaDNAResultResponseBody) };
    inline GetMediaDNAResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMediaDNAResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMediaDNAResultResponseBody> body_ {};
  };
