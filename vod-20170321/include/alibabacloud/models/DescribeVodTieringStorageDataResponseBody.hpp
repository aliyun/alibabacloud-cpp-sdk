...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->storageData_ == nullptr; };
    ...
    inline const vector<DescribeVodTieringStorageDataResponseBodyStorageData> & storageData() const { DARABONBA_PTR_GET_CONST(storageData_, vector<DescribeVodTieringStorageDataResponseBodyStorageData>) };
    inline vector<DescribeVodTieringStorageDataResponseBodyStorageData> storageData() { DARABONBA_PTR_GET(storageData_, vector<DescribeVodTieringStorageDataResponseBodyStorageData>) };
    inline DescribeVodTieringStorageDataResponseBody& setStorageData(const vector<DescribeVodTieringStorageDataResponseBodyStorageData> & storageData) { DARABONBA_PTR_SET_VALUE(storageData_, storageData) };
    inline DescribeVodTieringStorageDataResponseBody& setStorageData(vector<DescribeVodTieringStorageDataResponseBodyStorageData> && storageData) { DARABONBA_PTR_SET_RVALUE(storageData_, storageData) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeVodTieringStorageDataResponseBodyStorageData>> storageData_ = nullptr;
  };
