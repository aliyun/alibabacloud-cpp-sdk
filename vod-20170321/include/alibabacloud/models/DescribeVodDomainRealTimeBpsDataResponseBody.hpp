...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodDomainRealTimeBpsDataResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeVodDomainRealTimeBpsDataResponseBody::Data) };
    inline DescribeVodDomainRealTimeBpsDataResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeVodDomainRealTimeBpsDataResponseBody::Data) };
    inline DescribeVodDomainRealTimeBpsDataResponseBody& setData(const DescribeVodDomainRealTimeBpsDataResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeVodDomainRealTimeBpsDataResponseBody& setData(DescribeVodDomainRealTimeBpsDataResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    shared_ptr<DescribeVodDomainRealTimeBpsDataResponseBody::Data> data_ {};
