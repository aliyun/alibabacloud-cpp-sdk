...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataList_ == nullptr
        && return this->extend_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->totalCnt_ == nullptr; };
    // dataList Field Functions 
    bool hasDataList() const { return this->dataList_ != nullptr;};
    void deleteDataList() { this->dataList_ = nullptr;};
    inline const vector<DescribeVodPlayerMetricDataResponseBodyDataList> & dataList() const { DARABONBA_PTR_GET_CONST(dataList_, vector<DescribeVodPlayerMetricDataResponseBodyDataList>) };
    inline vector<DescribeVodPlayerMetricDataResponseBodyDataList> dataList() { DARABONBA_PTR_GET(dataList_, vector<DescribeVodPlayerMetricDataResponseBodyDataList>) };
    inline DescribeVodPlayerMetricDataResponseBody& setDataList(const vector<DescribeVodPlayerMetricDataResponseBodyDataList> & dataList) { DARABONBA_PTR_SET_VALUE(dataList_, dataList) };
    inline DescribeVodPlayerMetricDataResponseBody& setDataList(vector<DescribeVodPlayerMetricDataResponseBodyDataList> && dataList) { DARABONBA_PTR_SET_RVALUE(dataList_, dataList) };


    // extend Field Functions 
    bool hasExtend() const { return this->extend_ != nullptr;};
    void deleteExtend() { this->extend_ = nullptr;};
    inline const DescribeVodPlayerMetricDataResponseBodyExtend & extend() const { DARABONBA_PTR_GET_CONST(extend_, DescribeVodPlayerMetricDataResponseBodyExtend) };
    inline DescribeVodPlayerMetricDataResponseBodyExtend extend() { DARABONBA_PTR_GET(extend_, DescribeVodPlayerMetricDataResponseBodyExtend) };
    inline DescribeVodPlayerMetricDataResponseBody& setExtend(const DescribeVodPlayerMetricDataResponseBodyExtend & extend) { DARABONBA_PTR_SET_VALUE(extend_, extend) };
    inline DescribeVodPlayerMetricDataResponseBody& setExtend(DescribeVodPlayerMetricDataResponseBodyExtend && extend) { DARABONBA_PTR_SET_RVALUE(extend_, extend) };
  ...
  protected:
    std::shared_ptr<vector<DescribeVodPlayerMetricDataResponseBodyDataList>> dataList_ = nullptr;
    std::shared_ptr<DescribeVodPlayerMetricDataResponseBodyExtend> extend_ = nullptr;
