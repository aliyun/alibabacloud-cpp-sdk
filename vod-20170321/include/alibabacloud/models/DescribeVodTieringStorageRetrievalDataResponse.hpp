...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodTieringStorageRetrievalDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodTieringStorageRetrievalDataResponseBody) };
    inline DescribeVodTieringStorageRetrievalDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVodTieringStorageRetrievalDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodTieringStorageRetrievalDataResponseBody> body_ {};
  };
