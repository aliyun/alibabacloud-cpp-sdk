...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodDomainHitRateDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodDomainHitRateDataResponseBody) };
    inline DescribeVodDomainHitRateDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVodDomainHitRateDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodDomainHitRateDataResponseBody> body_ {};
  };
