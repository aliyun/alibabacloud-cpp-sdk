...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePlayTopVideosResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePlayTopVideosResponseBody) };
    inline DescribePlayTopVideosResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePlayTopVideosResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePlayTopVideosResponseBody> body_ {};
  };
