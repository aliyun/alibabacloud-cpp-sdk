...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodDomainCertificateInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodDomainCertificateInfoResponseBody) };
    inline DescribeVodDomainCertificateInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVodDomainCertificateInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodDomainCertificateInfoResponseBody> body_ {};
  };
