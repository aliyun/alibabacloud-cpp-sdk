...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodDomainRealTimeQpsDataResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeVodDomainRealTimeQpsDataResponseBody::Data) };
    inline DescribeVodDomainRealTimeQpsDataResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeVodDomainRealTimeQpsDataResponseBody::Data) };
    inline DescribeVodDomainRealTimeQpsDataResponseBody& setData(const DescribeVodDomainRealTimeQpsDataResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeVodDomainRealTimeQpsDataResponseBody& setData(DescribeVodDomainRealTimeQpsDataResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
