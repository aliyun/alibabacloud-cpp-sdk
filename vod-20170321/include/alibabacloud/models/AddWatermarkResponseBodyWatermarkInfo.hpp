...
#ifndef ALIBABACLOUD_MODELS_ADDWATERMARKRESPONSEBODYWATERMARKINFO_HPP_
#define ALIBABACLOUD_MODELS_ADDWATERMARKRESPONSEBODYWATERMARKINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddWatermarkResponseBodyWatermarkInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddWatermarkResponseBodyWatermarkInfo& obj) { 
    ...
    AddWatermarkResponseBodyWatermarkInfo() = default ;
    AddWatermarkResponseBodyWatermarkInfo(const AddWatermarkResponseBodyWatermarkInfo &) = default ;
    AddWatermarkResponseBodyWatermarkInfo(AddWatermarkResponseBodyWatermarkInfo &&) = default ;
    AddWatermarkResponseBodyWatermarkInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddWatermarkResponseBodyWatermarkInfo() = default ;
    AddWatermarkResponseBodyWatermarkInfo& operator=(const AddWatermarkResponseBodyWatermarkInfo &) = default ;
    AddWatermarkResponseBodyWatermarkInfo& operator=(AddWatermarkResponseBodyWatermarkInfo &&) = default ;
    ...
    inline AddWatermarkResponseBodyWatermarkInfo& setCreationTime(string creationTime) { DARABONBA_PTR_SET_VALUE(creationTime_, creationTime) };
    ...
    inline AddWatermarkResponseBodyWatermarkInfo& setFileUrl(string fileUrl) { DARABONBA_PTR_SET_VALUE(fileUrl_, fileUrl) };
    ...
    inline AddWatermarkResponseBodyWatermarkInfo& setIsDefault(string isDefault) { DARABONBA_PTR_SET_VALUE(isDefault_, isDefault) };
    ...
    inline AddWatermarkResponseBodyWatermarkInfo& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline AddWatermarkResponseBodyWatermarkInfo& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline AddWatermarkResponseBodyWatermarkInfo& setWatermarkConfig(string watermarkConfig) { DARABONBA_PTR_SET_VALUE(watermarkConfig_, watermarkConfig) };
    ...
    inline AddWatermarkResponseBodyWatermarkInfo& setWatermarkId(string watermarkId) { DARABONBA_PTR_SET_VALUE(watermarkId_, watermarkId) };
