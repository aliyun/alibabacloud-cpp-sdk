...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodDomainRealTimeByteHitRateDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodDomainRealTimeByteHitRateDataResponseBody) };
    inline DescribeVodDomainRealTimeByteHitRateDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVodDomainRealTimeByteHitRateDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodDomainRealTimeByteHitRateDataResponseBody> body_ {};
  };
