...
namespace Models
{
  ...
  public:
    ...
    inline const GetTranscodeSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTranscodeSummaryResponseBody) };
    inline GetTranscodeSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTranscodeSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTranscodeSummaryResponseBody> body_ {};
  };
