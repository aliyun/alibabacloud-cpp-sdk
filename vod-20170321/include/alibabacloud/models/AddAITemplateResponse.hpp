...
namespace Models
{
  ...
  public:
    ...
    inline const AddAITemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddAITemplateResponseBody) };
    inline AddAITemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, AddAITemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddAITemplateResponseBody> body_ {};
  };
