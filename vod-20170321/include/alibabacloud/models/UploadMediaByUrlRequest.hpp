...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && return this->sessionId_ == nullptr && return this->storageLocation_ == nullptr && return this->templateGroupId_ == nullptr && return this->uploadMetadatas_ == nullptr && return this->uploadURLs_ == nullptr
    ...
    inline string uploadMetadatas() const { DARABONBA_PTR_GET_DEFAULT(uploadMetadatas_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> uploadMetadatas_ = nullptr;
