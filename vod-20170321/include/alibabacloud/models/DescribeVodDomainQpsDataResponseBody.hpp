...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodDomainQpsDataResponseBodyQpsDataInterval & qpsDataInterval() const { DARABONBA_PTR_GET_CONST(qpsDataInterval_, DescribeVodDomainQpsDataResponseBodyQpsDataInterval) };
    inline DescribeVodDomainQpsDataResponseBodyQpsDataInterval qpsDataInterval() { DARABONBA_PTR_GET(qpsDataInterval_, DescribeVodDomainQpsDataResponseBodyQpsDataInterval) };
    inline DescribeVodDomainQpsDataResponseBody& setQpsDataInterval(const DescribeVodDomainQpsDataResponseBodyQpsDataInterval & qpsDataInterval) { DARABONBA_PTR_SET_VALUE(qpsDataInterval_, qpsDataInterval) };
    inline DescribeVodDomainQpsDataResponseBody& setQpsDataInterval(DescribeVodDomainQpsDataResponseBodyQpsDataInterval && qpsDataInterval) { DARABONBA_PTR_SET_RVALUE(qpsDataInterval_, qpsDataInterval) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVodDomainQpsDataResponseBodyQpsDataInterval> qpsDataInterval_ = nullptr;
