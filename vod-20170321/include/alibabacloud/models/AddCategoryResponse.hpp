...
namespace Models
{
  ...
  public:
    ...
    inline const AddCategoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddCategoryResponseBody) };
    inline AddCategoryResponseBody getBody() { DARABONBA_PTR_GET(body_, AddCategoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddCategoryResponseBody> body_ {};
  };
