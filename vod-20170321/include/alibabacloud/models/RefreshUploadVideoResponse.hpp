...
namespace Models
{
  ...
  public:
    ...
    inline const RefreshUploadVideoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RefreshUploadVideoResponseBody) };
    inline RefreshUploadVideoResponseBody getBody() { DARABONBA_PTR_GET(body_, RefreshUploadVideoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RefreshUploadVideoResponseBody> body_ {};
  };
