...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cycle_ == nullptr
        && return this->domainName_ == nullptr && return this->endTime_ == nullptr && return this->ownerId_ == nullptr && return this->startTime_ == nullptr && return this->timePoint_ == nullptr; };
