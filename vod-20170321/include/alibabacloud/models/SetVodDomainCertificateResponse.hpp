...
namespace Models
{
  ...
  public:
    ...
    inline const SetVodDomainCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetVodDomainCertificateResponseBody) };
    inline SetVodDomainCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, SetVodDomainCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetVodDomainCertificateResponseBody> body_ {};
  };
