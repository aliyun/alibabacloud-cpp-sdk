...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodAIDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodAIDataResponseBody) };
    inline DescribeVodAIDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVodAIDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodAIDataResponseBody> body_ {};
  };
