...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodSSLCertificateListResponseBody::CertificateListModel & getCertificateListModel() const { DARABONBA_PTR_GET_CONST(certificateListModel_, DescribeVodSSLCertificateListResponseBody::CertificateListModel) };
    inline DescribeVodSSLCertificateListResponseBody::CertificateListModel getCertificateListModel() { DARABONBA_PTR_GET(certificateListModel_, DescribeVodSSLCertificateListResponseBody::CertificateListModel) };
    inline DescribeVodSSLCertificateListResponseBody& setCertificateListModel(const DescribeVodSSLCertificateListResponseBody::CertificateListModel & certificateListModel) { DARABONBA_PTR_SET_VALUE(certificateListModel_, certificateListModel) };
    inline DescribeVodSSLCertificateListResponseBody& setCertificateListModel(DescribeVodSSLCertificateListResponseBody::CertificateListModel && certificateListModel) { DARABONBA_PTR_SET_RVALUE(certificateListModel_, certificateListModel) };
