...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodRefreshQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodRefreshQuotaResponseBody) };
    inline DescribeVodRefreshQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVodRefreshQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodRefreshQuotaResponseBody> body_ {};
  };
