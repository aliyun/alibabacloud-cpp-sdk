...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitAIMediaAuditJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SubmitAIMediaAuditJobResponseBody) };
    inline SubmitAIMediaAuditJobResponseBody body() { DARABONBA_PTR_GET(body_, SubmitAIMediaAuditJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SubmitAIMediaAuditJobResponseBody> body_ = nullptr;
  };
