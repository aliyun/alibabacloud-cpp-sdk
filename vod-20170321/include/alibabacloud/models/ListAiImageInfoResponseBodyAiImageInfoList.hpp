...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->AIImageInfoId_ == nullptr
        && return this->creationTime_ == nullptr && return this->fileURL_ == nullptr && return this->format_ == nullptr && return this->jobId_ == nullptr && return this->score_ == nullptr
        && return this->version_ == nullptr && return this->videoId_ == nullptr; };
