...
namespace Models
{
  ...
  public:
    ...
    inline const AddEditingProjectResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddEditingProjectResponseBody) };
    inline AddEditingProjectResponseBody body() { DARABONBA_PTR_GET(body_, AddEditingProjectResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddEditingProjectResponseBody> body_ = nullptr;
  };
