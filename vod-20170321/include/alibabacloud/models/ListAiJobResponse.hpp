...
namespace Models
{
  ...
  public:
    ...
    inline const ListAIJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListAIJobResponseBody) };
    inline ListAIJobResponseBody body() { DARABONBA_PTR_GET(body_, ListAIJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListAIJobResponseBody> body_ = nullptr;
  };
