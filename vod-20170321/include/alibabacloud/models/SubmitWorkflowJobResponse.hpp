...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitWorkflowJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitWorkflowJobResponseBody) };
    inline SubmitWorkflowJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitWorkflowJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitWorkflowJobResponseBody> body_ {};
  };
