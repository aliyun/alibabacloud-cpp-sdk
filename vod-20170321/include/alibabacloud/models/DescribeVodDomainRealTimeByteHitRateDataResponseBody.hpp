...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEVODDOMAINREALTIMEBYTEHITRATEDATARESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEVODDOMAINREALTIMEBYTEHITRATEDATARESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeVodDomainRealTimeByteHitRateDataResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeVodDomainRealTimeByteHitRateDataResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeVodDomainRealTimeByteHitRateDataResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DescribeVodDomainRealTimeByteHitRateDataResponseBody() = default ;
    DescribeVodDomainRealTimeByteHitRateDataResponseBody(const DescribeVodDomainRealTimeByteHitRateDataResponseBody &) = default ;
    DescribeVodDomainRealTimeByteHitRateDataResponseBody(DescribeVodDomainRealTimeByteHitRateDataResponseBody &&) = default ;
    DescribeVodDomainRealTimeByteHitRateDataResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeVodDomainRealTimeByteHitRateDataResponseBody() = default ;
    DescribeVodDomainRealTimeByteHitRateDataResponseBody& operator=(const DescribeVodDomainRealTimeByteHitRateDataResponseBody &) = default ;
    DescribeVodDomainRealTimeByteHitRateDataResponseBody& operator=(DescribeVodDomainRealTimeByteHitRateDataResponseBody &&) = default ;
    ...
    inline const DescribeVodDomainRealTimeByteHitRateDataResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeVodDomainRealTimeByteHitRateDataResponseBody::Data) };
    inline DescribeVodDomainRealTimeByteHitRateDataResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeVodDomainRealTimeByteHitRateDataResponseBody::Data) };
    inline DescribeVodDomainRealTimeByteHitRateDataResponseBody& setData(const DescribeVodDomainRealTimeByteHitRateDataResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeVodDomainRealTimeByteHitRateDataResponseBody& setData(DescribeVodDomainRealTimeByteHitRateDataResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeVodDomainRealTimeByteHitRateDataResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The returned data.
    shared_ptr<DescribeVodDomainRealTimeByteHitRateDataResponseBody::Data> data_ {};
