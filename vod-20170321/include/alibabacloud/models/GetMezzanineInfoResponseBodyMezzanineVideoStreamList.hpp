...
#ifndef ALIBABACLOUD_MODELS_GETMEZZANINEINFORESPONSEBODYMEZZANINEVIDEOSTREAMLIST_HPP_
#define ALIBABACLOUD_MODELS_GETMEZZANINEINFORESPONSEBODYMEZZANINEVIDEOSTREAMLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetMezzanineInfoResponseBodyMezzanineVideoStreamList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetMezzanineInfoResponseBodyMezzanineVideoStreamList& obj) { 
    ...
    GetMezzanineInfoResponseBodyMezzanineVideoStreamList() = default ;
    GetMezzanineInfoResponseBodyMezzanineVideoStreamList(const GetMezzanineInfoResponseBodyMezzanineVideoStreamList &) = default ;
    GetMezzanineInfoResponseBodyMezzanineVideoStreamList(GetMezzanineInfoResponseBodyMezzanineVideoStreamList &&) = default ;
    GetMezzanineInfoResponseBodyMezzanineVideoStreamList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetMezzanineInfoResponseBodyMezzanineVideoStreamList() = default ;
    GetMezzanineInfoResponseBodyMezzanineVideoStreamList& operator=(const GetMezzanineInfoResponseBodyMezzanineVideoStreamList &) = default ;
    GetMezzanineInfoResponseBodyMezzanineVideoStreamList& operator=(GetMezzanineInfoResponseBodyMezzanineVideoStreamList &&) = default ;
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setAvgFPS(string avgFPS) { DARABONBA_PTR_SET_VALUE(avgFPS_, avgFPS) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setBitrate(string bitrate) { DARABONBA_PTR_SET_VALUE(bitrate_, bitrate) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setCodecLongName(string codecLongName) { DARABONBA_PTR_SET_VALUE(codecLongName_, codecLongName) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setCodecName(string codecName) { DARABONBA_PTR_SET_VALUE(codecName_, codecName) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setCodecTag(string codecTag) { DARABONBA_PTR_SET_VALUE(codecTag_, codecTag) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setCodecTagString(string codecTagString) { DARABONBA_PTR_SET_VALUE(codecTagString_, codecTagString) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setCodecTimeBase(string codecTimeBase) { DARABONBA_PTR_SET_VALUE(codecTimeBase_, codecTimeBase) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setDar(string dar) { DARABONBA_PTR_SET_VALUE(dar_, dar) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setDuration(string duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setFps(string fps) { DARABONBA_PTR_SET_VALUE(fps_, fps) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setHDRType(string HDRType) { DARABONBA_PTR_SET_VALUE(HDRType_, HDRType) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setHasBFrames(string hasBFrames) { DARABONBA_PTR_SET_VALUE(hasBFrames_, hasBFrames) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setHeight(string height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setIndex(string index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setLevel(string level) { DARABONBA_PTR_SET_VALUE(level_, level) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setNumFrames(string numFrames) { DARABONBA_PTR_SET_VALUE(numFrames_, numFrames) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setPixFmt(string pixFmt) { DARABONBA_PTR_SET_VALUE(pixFmt_, pixFmt) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setProfile(string profile) { DARABONBA_PTR_SET_VALUE(profile_, profile) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setRotate(string rotate) { DARABONBA_PTR_SET_VALUE(rotate_, rotate) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setSar(string sar) { DARABONBA_PTR_SET_VALUE(sar_, sar) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setTimebase(string timebase) { DARABONBA_PTR_SET_VALUE(timebase_, timebase) };
    ...
    inline GetMezzanineInfoResponseBodyMezzanineVideoStreamList& setWidth(string width) { DARABONBA_PTR_SET_VALUE(width_, width) };
