...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->completeTime_ == nullptr
        && return this->creationTime_ == nullptr && return this->taskStatus_ == nullptr && return this->transcodeTaskId_ == nullptr && return this->transcodeTemplateGroupId_ == nullptr && return this->trigger_ == nullptr
