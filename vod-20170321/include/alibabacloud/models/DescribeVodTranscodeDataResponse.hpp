...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodTranscodeDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodTranscodeDataResponseBody) };
    inline DescribeVodTranscodeDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVodTranscodeDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodTranscodeDataResponseBody> body_ {};
  };
