...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->resourceIds_ == nullptr
        && return this->resourceType_ == nullptr && return this->targetAppId_ == nullptr; };
    ...
    inline string targetAppId() const { DARABONBA_PTR_GET_DEFAULT(targetAppId_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> targetAppId_ = nullptr;
  };
