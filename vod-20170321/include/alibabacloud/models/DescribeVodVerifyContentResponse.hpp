...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodVerifyContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodVerifyContentResponseBody) };
    inline DescribeVodVerifyContentResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVodVerifyContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodVerifyContentResponseBody> body_ {};
  };
