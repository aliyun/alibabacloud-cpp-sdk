...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->mezzanine_ != nullptr
    ...
    inline const GetMezzanineInfoResponseBodyMezzanine & mezzanine() const { DARABONBA_PTR_GET_CONST(mezzanine_, GetMezzanineInfoResponseBodyMezzanine) };
    inline GetMezzanineInfoResponseBodyMezzanine mezzanine() { DARABONBA_PTR_GET(mezzanine_, GetMezzanineInfoResponseBodyMezzanine) };
    inline GetMezzanineInfoResponseBody& setMezzanine(const GetMezzanineInfoResponseBodyMezzanine & mezzanine) { DARABONBA_PTR_SET_VALUE(mezzanine_, mezzanine) };
    inline GetMezzanineInfoResponseBody& setMezzanine(GetMezzanineInfoResponseBodyMezzanine && mezzanine) { DARABONBA_PTR_SET_RVALUE(mezzanine_, mezzanine) };
  ...
  protected:
    ...
    std::shared_ptr<GetMezzanineInfoResponseBodyMezzanine> mezzanine_ = nullptr;
