...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodUserVipsByDomainResponseBody::Vips & getVips() const { DARABONBA_PTR_GET_CONST(vips_, DescribeVodUserVipsByDomainResponseBody::Vips) };
    inline DescribeVodUserVipsByDomainResponseBody::Vips getVips() { DARABONBA_PTR_GET(vips_, DescribeVodUserVipsByDomainResponseBody::Vips) };
    inline DescribeVodUserVipsByDomainResponseBody& setVips(const DescribeVodUserVipsByDomainResponseBody::Vips & vips) { DARABONBA_PTR_SET_VALUE(vips_, vips) };
    inline DescribeVodUserVipsByDomainResponseBody& setVips(DescribeVodUserVipsByDomainResponseBody::Vips && vips) { DARABONBA_PTR_SET_RVALUE(vips_, vips) };
