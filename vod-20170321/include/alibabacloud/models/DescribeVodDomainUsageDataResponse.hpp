...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodDomainUsageDataResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodDomainUsageDataResponseBody) };
    inline DescribeVodDomainUsageDataResponseBody body() { DARABONBA_PTR_GET(body_, DescribeVodDomainUsageDataResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVodDomainUsageDataResponseBody> body_ = nullptr;
  };
