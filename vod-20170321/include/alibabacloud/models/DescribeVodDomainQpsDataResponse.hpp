...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodDomainQpsDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodDomainQpsDataResponseBody) };
    inline DescribeVodDomainQpsDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVodDomainQpsDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodDomainQpsDataResponseBody> body_ {};
  };
