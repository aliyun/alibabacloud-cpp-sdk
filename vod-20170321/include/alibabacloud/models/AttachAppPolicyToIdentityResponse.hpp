...
namespace Models
{
  ...
  public:
    ...
    inline const AttachAppPolicyToIdentityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachAppPolicyToIdentityResponseBody) };
    inline AttachAppPolicyToIdentityResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachAppPolicyToIdentityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachAppPolicyToIdentityResponseBody> body_ {};
  };
