  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->duration_ == nullptr && this->modificationTime_ == nullptr && this->referenceId_ == nullptr && this->restoreExpiration_ == nullptr && this->restoreStatus_ == nullptr
        && this->size_ == nullptr && this->snapshots_ == nullptr && this->status_ == nullptr && this->storageClass_ == nullptr && this->storageLocation_ == nullptr
        && this->tags_ == nullptr && this->title_ == nullptr && this->userData_ == nullptr && this->videoId_ == nullptr; };
      ...
      inline const vector<VideoList::Video> & getVideo() const { DARABONBA_PTR_GET_CONST(video_, vector<VideoList::Video>) };
      inline vector<VideoList::Video> getVideo() { DARABONBA_PTR_GET(video_, vector<VideoList::Video>) };
      inline VideoList& setVideo(const vector<VideoList::Video> & video) { DARABONBA_PTR_SET_VALUE(video_, video) };
      inline VideoList& setVideo(vector<VideoList::Video> && video) { DARABONBA_PTR_SET_RVALUE(video_, video) };


    protected:
      shared_ptr<vector<VideoList::Video>> video_ {};
    };

    virtual bool empty() const override { return this->requestId_ == nullptr
        && this->total_ == nullptr && this->videoList_ == nullptr; };
    ...
    inline const GetVideoListResponseBody::VideoList & getVideoList() const { DARABONBA_PTR_GET_CONST(videoList_, GetVideoListResponseBody::VideoList) };
    inline GetVideoListResponseBody::VideoList getVideoList() { DARABONBA_PTR_GET(videoList_, GetVideoListResponseBody::VideoList) };
    inline GetVideoListResponseBody& setVideoList(const GetVideoListResponseBody::VideoList & videoList) { DARABONBA_PTR_SET_VALUE(videoList_, videoList) };
    inline GetVideoListResponseBody& setVideoList(GetVideoListResponseBody::VideoList && videoList) { DARABONBA_PTR_SET_RVALUE(videoList_, videoList) };
