...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->fileURL_ == nullptr
        && return this->imageId_ == nullptr && return this->imageURL_ == nullptr && return this->requestId_ == nullptr && return this->uploadAddress_ == nullptr && return this->uploadAuth_ == nullptr; };
