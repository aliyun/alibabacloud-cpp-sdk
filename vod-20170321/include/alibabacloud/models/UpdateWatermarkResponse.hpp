...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateWatermarkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateWatermarkResponseBody) };
    inline UpdateWatermarkResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateWatermarkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateWatermarkResponseBody> body_ {};
  };
