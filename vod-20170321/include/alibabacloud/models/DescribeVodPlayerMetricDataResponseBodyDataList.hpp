...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEVODPLAYERMETRICDATARESPONSEBODYDATALIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEVODPLAYERMETRICDATARESPONSEBODYDATALIST_HPP_
...
namespace Models
{
  class DescribeVodPlayerMetricDataResponseBodyDataList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeVodPlayerMetricDataResponseBodyDataList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeVodPlayerMetricDataResponseBodyDataList& obj) { 
    ...
    DescribeVodPlayerMetricDataResponseBodyDataList() = default ;
    DescribeVodPlayerMetricDataResponseBodyDataList(const DescribeVodPlayerMetricDataResponseBodyDataList &) = default ;
    DescribeVodPlayerMetricDataResponseBodyDataList(DescribeVodPlayerMetricDataResponseBodyDataList &&) = default ;
    DescribeVodPlayerMetricDataResponseBodyDataList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeVodPlayerMetricDataResponseBodyDataList() = default ;
    DescribeVodPlayerMetricDataResponseBodyDataList& operator=(const DescribeVodPlayerMetricDataResponseBodyDataList &) = default ;
    DescribeVodPlayerMetricDataResponseBodyDataList& operator=(DescribeVodPlayerMetricDataResponseBodyDataList &&) = default ;
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setAvgPerCompletionVv(double avgPerCompletionVv) { DARABONBA_PTR_SET_VALUE(avgPerCompletionVv_, avgPerCompletionVv) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setAvgPerPlayDuration(double avgPerPlayDuration) { DARABONBA_PTR_SET_VALUE(avgPerPlayDuration_, avgPerPlayDuration) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setAvgPerVv(double avgPerVv) { DARABONBA_PTR_SET_VALUE(avgPerVv_, avgPerVv) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setAvgPlayBitrate(double avgPlayBitrate) { DARABONBA_PTR_SET_VALUE(avgPlayBitrate_, avgPlayBitrate) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setAvgPlayDuration(double avgPlayDuration) { DARABONBA_PTR_SET_VALUE(avgPlayDuration_, avgPlayDuration) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setAvgStartBitrate(double avgStartBitrate) { DARABONBA_PTR_SET_VALUE(avgStartBitrate_, avgStartBitrate) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setAvgVideoDuration(double avgVideoDuration) { DARABONBA_PTR_SET_VALUE(avgVideoDuration_, avgVideoDuration) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setCompletionRate(double completionRate) { DARABONBA_PTR_SET_VALUE(completionRate_, completionRate) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setCompletionVv(double completionVv) { DARABONBA_PTR_SET_VALUE(completionVv_, completionVv) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setDimension(string dimension) { DARABONBA_PTR_SET_VALUE(dimension_, dimension) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setErrorCount100s(double errorCount100s) { DARABONBA_PTR_SET_VALUE(errorCount100s_, errorCount100s) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setFirstFrame(double firstFrame) { DARABONBA_PTR_SET_VALUE(firstFrame_, firstFrame) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setJumpRate5s(double jumpRate5s) { DARABONBA_PTR_SET_VALUE(jumpRate5s_, jumpRate5s) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setPlayFailRate(double playFailRate) { DARABONBA_PTR_SET_VALUE(playFailRate_, playFailRate) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setRealVv(double realVv) { DARABONBA_PTR_SET_VALUE(realVv_, realVv) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setSecondPlayRate(double secondPlayRate) { DARABONBA_PTR_SET_VALUE(secondPlayRate_, secondPlayRate) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setSeedFailRate(double seedFailRate) { DARABONBA_PTR_SET_VALUE(seedFailRate_, seedFailRate) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setSeekDuration(double seekDuration) { DARABONBA_PTR_SET_VALUE(seekDuration_, seekDuration) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setSlowPlayRate(double slowPlayRate) { DARABONBA_PTR_SET_VALUE(slowPlayRate_, slowPlayRate) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setStuckCount100s(string stuckCount100s) { DARABONBA_PTR_SET_VALUE(stuckCount100s_, stuckCount100s) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setStuckCountRate(double stuckCountRate) { DARABONBA_PTR_SET_VALUE(stuckCountRate_, stuckCountRate) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setStuckDuration100s(double stuckDuration100s) { DARABONBA_PTR_SET_VALUE(stuckDuration100s_, stuckDuration100s) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setTimeStamp(string timeStamp) { DARABONBA_PTR_SET_VALUE(timeStamp_, timeStamp) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setTotalPlayDuration(double totalPlayDuration) { DARABONBA_PTR_SET_VALUE(totalPlayDuration_, totalPlayDuration) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setUv(double uv) { DARABONBA_PTR_SET_VALUE(uv_, uv) };
    ...
    inline DescribeVodPlayerMetricDataResponseBodyDataList& setVv(double vv) { DARABONBA_PTR_SET_VALUE(vv_, vv) };
