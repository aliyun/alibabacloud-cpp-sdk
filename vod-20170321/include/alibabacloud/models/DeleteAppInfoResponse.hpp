...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAppInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAppInfoResponseBody) };
    inline DeleteAppInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAppInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAppInfoResponseBody> body_ {};
  };
