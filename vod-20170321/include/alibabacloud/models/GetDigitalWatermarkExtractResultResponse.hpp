...
namespace Models
{
  ...
  public:
    ...
    inline const GetDigitalWatermarkExtractResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDigitalWatermarkExtractResultResponseBody) };
    inline GetDigitalWatermarkExtractResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDigitalWatermarkExtractResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDigitalWatermarkExtractResultResponseBody> body_ {};
  };
