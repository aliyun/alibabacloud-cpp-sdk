...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->extractType_ == nullptr
        && return this->jobId_ == nullptr && return this->mediaId_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->resourceOwnerAccount_ == nullptr
