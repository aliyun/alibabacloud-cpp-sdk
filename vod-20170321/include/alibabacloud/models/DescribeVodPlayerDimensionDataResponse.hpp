...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodPlayerDimensionDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodPlayerDimensionDataResponseBody) };
    inline DescribeVodPlayerDimensionDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVodPlayerDimensionDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodPlayerDimensionDataResponseBody> body_ {};
  };
