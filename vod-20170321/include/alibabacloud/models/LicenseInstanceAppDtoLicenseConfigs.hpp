...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessType_ == nullptr
        && return this->featureIds_ == nullptr && return this->isTrial_ == nullptr && return this->sdkId_ == nullptr && return this->sdkName_ == nullptr && return this->subscription_ == nullptr
        && return this->subscriptionImp_ == nullptr && return this->subscriptionPkg_ == nullptr; };
