...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->apiVersion_ == nullptr
        && this->authInfoTimeout_ == nullptr && this->referenceId_ == nullptr && this->videoId_ == nullptr; };
    ...
    inline int64_t getAuthInfoTimeout() const { DARABONBA_PTR_GET_DEFAULT(authInfoTimeout_, 0L) };
  ...
  protected:
    ...
    shared_ptr<int64_t> authInfoTimeout_ {};
