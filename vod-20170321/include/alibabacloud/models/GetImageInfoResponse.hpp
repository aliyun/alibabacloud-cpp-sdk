...
namespace Models
{
  ...
  public:
    ...
    inline const GetImageInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetImageInfoResponseBody) };
    inline GetImageInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetImageInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetImageInfoResponseBody> body_ {};
  };
