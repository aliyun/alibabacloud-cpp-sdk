...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateImageInfosResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateImageInfosResponseBody) };
    inline UpdateImageInfosResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateImageInfosResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateImageInfosResponseBody> body_ {};
  };
