...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDOMAINFLOWDATAREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDOMAINFLOWDATAREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDomainFlowDataRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDomainFlowDataRequest& obj) { 
    ...
    DescribeDomainFlowDataRequest() = default ;
    DescribeDomainFlowDataRequest(const DescribeDomainFlowDataRequest &) = default ;
    DescribeDomainFlowDataRequest(DescribeDomainFlowDataRequest &&) = default ;
    DescribeDomainFlowDataRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDomainFlowDataRequest() = default ;
    DescribeDomainFlowDataRequest& operator=(const DescribeDomainFlowDataRequest &) = default ;
    DescribeDomainFlowDataRequest& operator=(DescribeDomainFlowDataRequest &&) = default ;
    ...
    inline DescribeDomainFlowDataRequest& setDomainName(string domainName) { DARABONBA_PTR_SET_VALUE(domainName_, domainName) };
    ...
    inline DescribeDomainFlowDataRequest& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline DescribeDomainFlowDataRequest& setInterval(string interval) { DARABONBA_PTR_SET_VALUE(interval_, interval) };
    ...
    inline DescribeDomainFlowDataRequest& setIspNameEn(string ispNameEn) { DARABONBA_PTR_SET_VALUE(ispNameEn_, ispNameEn) };
    ...
    inline DescribeDomainFlowDataRequest& setLocationNameEn(string locationNameEn) { DARABONBA_PTR_SET_VALUE(locationNameEn_, locationNameEn) };
    ...
    inline DescribeDomainFlowDataRequest& setOwnerId(string ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline DescribeDomainFlowDataRequest& setResourceOwnerId(string resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline DescribeDomainFlowDataRequest& setResourceRealOwnerId(string resourceRealOwnerId) { DARABONBA_PTR_SET_VALUE(resourceRealOwnerId_, resourceRealOwnerId) };
    ...
    inline DescribeDomainFlowDataRequest& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline DescribeDomainFlowDataRequest& setTimeMerge(string timeMerge) { DARABONBA_PTR_SET_VALUE(timeMerge_, timeMerge) };
