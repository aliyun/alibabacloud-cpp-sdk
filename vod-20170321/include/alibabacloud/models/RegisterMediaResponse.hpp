...
namespace Models
{
  ...
  public:
    ...
    inline const RegisterMediaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RegisterMediaResponseBody) };
    inline RegisterMediaResponseBody getBody() { DARABONBA_PTR_GET(body_, RegisterMediaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RegisterMediaResponseBody> body_ {};
  };
