...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->completeTime_ == nullptr
        && return this->createTime_ == nullptr && return this->jobId_ == nullptr && return this->jobType_ == nullptr && return this->mediaId_ == nullptr && return this->status_ == nullptr
        && return this->templateConfig_ == nullptr && return this->trigger_ == nullptr && return this->userId_ == nullptr; };
