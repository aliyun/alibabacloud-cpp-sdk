...
namespace Models
{
  ...
  public:
    ...
    inline const GetWatermarkResponseBodyWatermarkInfo & watermarkInfo() const { DARABONBA_PTR_GET_CONST(watermarkInfo_, GetWatermarkResponseBodyWatermarkInfo) };
    inline GetWatermarkResponseBodyWatermarkInfo watermarkInfo() { DARABONBA_PTR_GET(watermarkInfo_, GetWatermarkResponseBodyWatermarkInfo) };
    inline GetWatermarkResponseBody& setWatermarkInfo(const GetWatermarkResponseBodyWatermarkInfo & watermarkInfo) { DARABONBA_PTR_SET_VALUE(watermarkInfo_, watermarkInfo) };
    inline GetWatermarkResponseBody& setWatermarkInfo(GetWatermarkResponseBodyWatermarkInfo && watermarkInfo) { DARABONBA_PTR_SET_RVALUE(watermarkInfo_, watermarkInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetWatermarkResponseBodyWatermarkInfo> watermarkInfo_ = nullptr;
  };
