...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodDomainSrcTrafficDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodDomainSrcTrafficDataResponseBody) };
    inline DescribeVodDomainSrcTrafficDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVodDomainSrcTrafficDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodDomainSrcTrafficDataResponseBody> body_ {};
  };
