...
namespace Models
{
  ...
  public:
    ...
    inline const GetVodTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetVodTemplateResponseBody) };
    inline GetVodTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetVodTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetVodTemplateResponseBody> body_ {};
  };
