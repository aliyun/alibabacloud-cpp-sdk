...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      void deleteWeight() { this->weight_ = nullptr;};
      inline string getWeight() const { DARABONBA_PTR_GET_DEFAULT(weight_, "") };
      inline DomainDetail& setWeight(string weight) { DARABONBA_PTR_SET_VALUE(weight_, weight) };
    ...
    inline const DescribeVodDomainDetailResponseBody::DomainDetail & getDomainDetail() const { DARABONBA_PTR_GET_CONST(domainDetail_, DescribeVodDomainDetailResponseBody::DomainDetail) };
    inline DescribeVodDomainDetailResponseBody::DomainDetail getDomainDetail() { DARABONBA_PTR_GET(domainDetail_, DescribeVodDomainDetailResponseBody::DomainDetail) };
    inline DescribeVodDomainDetailResponseBody& setDomainDetail(const DescribeVodDomainDetailResponseBody::DomainDetail & domainDetail) { DARABONBA_PTR_SET_VALUE(domainDetail_, domainDetail) };
    inline DescribeVodDomainDetailResponseBody& setDomainDetail(DescribeVodDomainDetailResponseBody::DomainDetail && domainDetail) { DARABONBA_PTR_SET_RVALUE(domainDetail_, domainDetail) };
