...
namespace Models
{
  ...
  public:
    ...
    inline const GetMediaAuditResultDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMediaAuditResultDetailResponseBody) };
    inline GetMediaAuditResultDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMediaAuditResultDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMediaAuditResultDetailResponseBody> body_ {};
  };
