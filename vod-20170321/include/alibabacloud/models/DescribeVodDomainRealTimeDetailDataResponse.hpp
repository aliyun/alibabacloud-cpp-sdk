...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodDomainRealTimeDetailDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVodDomainRealTimeDetailDataResponseBody) };
    inline DescribeVodDomainRealTimeDetailDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVodDomainRealTimeDetailDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVodDomainRealTimeDetailDataResponseBody> body_ {};
  };
