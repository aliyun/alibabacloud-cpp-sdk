...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAppInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAppInfoResponseBody) };
    inline UpdateAppInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAppInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAppInfoResponseBody> body_ {};
  };
