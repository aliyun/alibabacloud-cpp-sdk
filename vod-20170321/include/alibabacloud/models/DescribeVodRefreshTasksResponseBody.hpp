...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVodRefreshTasksResponseBody::Tasks & getTasks() const { DARABONBA_PTR_GET_CONST(tasks_, DescribeVodRefreshTasksResponseBody::Tasks) };
    inline DescribeVodRefreshTasksResponseBody::Tasks getTasks() { DARABONBA_PTR_GET(tasks_, DescribeVodRefreshTasksResponseBody::Tasks) };
    inline DescribeVodRefreshTasksResponseBody& setTasks(const DescribeVodRefreshTasksResponseBody::Tasks & tasks) { DARABONBA_PTR_SET_VALUE(tasks_, tasks) };
    inline DescribeVodRefreshTasksResponseBody& setTasks(DescribeVodRefreshTasksResponseBody::Tasks && tasks) { DARABONBA_PTR_SET_RVALUE(tasks_, tasks) };
