...
namespace Models
{
  ...
  public:
    ...
    inline const BatchSetVodDomainConfigsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchSetVodDomainConfigsResponseBody) };
    inline BatchSetVodDomainConfigsResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchSetVodDomainConfigsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchSetVodDomainConfigsResponseBody> body_ {};
  };
