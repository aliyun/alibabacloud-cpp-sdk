...
namespace Models
{
  ...
  public:
    ...
    inline const ListAppInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAppInfoResponseBody) };
    inline ListAppInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAppInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAppInfoResponseBody> body_ {};
  };
