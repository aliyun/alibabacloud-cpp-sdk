...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitAIJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitAIJobResponseBody) };
    inline SubmitAIJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitAIJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitAIJobResponseBody> body_ {};
  };
