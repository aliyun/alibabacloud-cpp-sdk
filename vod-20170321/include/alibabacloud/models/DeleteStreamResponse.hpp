...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteStreamResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteStreamResponseBody) };
    inline DeleteStreamResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteStreamResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteStreamResponseBody> body_ {};
  };
