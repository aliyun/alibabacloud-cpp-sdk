...
namespace Models
{
  ...
  public:
    ...
    inline const GetCategoriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCategoriesResponseBody) };
    inline GetCategoriesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCategoriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCategoriesResponseBody> body_ {};
  };
