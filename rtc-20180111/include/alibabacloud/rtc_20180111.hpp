...
class CreateRecordIndexFileRequest : public Darabonba::Model {
public:
  shared_ptr<string> appId{};
  shared_ptr<string> channelId{};
  ...
  explicit CreateRecordIndexFileRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~CreateRecordIndexFileRequest() = default;
};
class CreateRecordIndexFileResponseBody : public Darabonba::Model {
public:
  ...
  CreateRecordIndexFileResponseBody() {}

  explicit CreateRecordIndexFileResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~CreateRecordIndexFileResponseBody() = default;
};
class CreateRecordIndexFileResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<CreateRecordIndexFileResponseBody> body{};

  CreateRecordIndexFileResponse() {}

  explicit CreateRecordIndexFileResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        CreateRecordIndexFileResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<CreateRecordIndexFileResponseBody>(model1);
      }
    }
  }


  virtual ~CreateRecordIndexFileResponse() = default;
};
...
class DescribeRecordTasksRequest : public Darabonba::Model {
public:
  shared_ptr<string> appId{};
  shared_ptr<string> channelId{};
  shared_ptr<string> endTime{};
  ...
  explicit DescribeRecordTasksRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DescribeRecordTasksRequest() = default;
};
class DescribeRecordTasksResponseBodyRecordTasksUserPanes : public Darabonba::Model {
public:
  shared_ptr<long> paneId{};
  shared_ptr<string> source{};
  shared_ptr<string> userId{};

  DescribeRecordTasksResponseBodyRecordTasksUserPanes() {}

  explicit DescribeRecordTasksResponseBodyRecordTasksUserPanes(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DescribeRecordTasksResponseBodyRecordTasksUserPanes() = default;
};
class DescribeRecordTasksResponseBodyRecordTasks : public Darabonba::Model {
public:
  shared_ptr<string> appId{};
  shared_ptr<string> channelId{};
  shared_ptr<string> createTime{};
  ...
  shared_ptr<string> taskId{};
  shared_ptr<string> templateId{};
  shared_ptr<vector<DescribeRecordTasksResponseBodyRecordTasksUserPanes>> userPanes{};

  DescribeRecordTasksResponseBodyRecordTasks() {}

  explicit DescribeRecordTasksResponseBodyRecordTasks(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("UserPanes") != m.end() && !m["UserPanes"].empty()) {
      if (typeid(vector<boost::any>) == m["UserPanes"].type()) {
        vector<DescribeRecordTasksResponseBodyRecordTasksUserPanes> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["UserPanes"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            DescribeRecordTasksResponseBodyRecordTasksUserPanes model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        userPanes = make_shared<vector<DescribeRecordTasksResponseBodyRecordTasksUserPanes>>(expect1);
      }
    }
  }


  virtual ~DescribeRecordTasksResponseBodyRecordTasks() = default;
};
class DescribeRecordTasksResponseBody : public Darabonba::Model {
public:
  shared_ptr<vector<DescribeRecordTasksResponseBodyRecordTasks>> recordTasks{};
  shared_ptr<string> requestId{};
  shared_ptr<long> totalNum{};
  shared_ptr<long> totalPage{};

  DescribeRecordTasksResponseBody() {}

  explicit DescribeRecordTasksResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (recordTasks) {
      vector<boost::any> temp1;
      for(auto item1:*recordTasks){
        temp1.push_back(boost::any(item1.toMap()));
      }
      res["RecordTasks"] = boost::any(temp1);
    }
    if (requestId) {
      res["RequestId"] = boost::any(*requestId);
    }
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("RecordTasks") != m.end() && !m["RecordTasks"].empty()) {
      if (typeid(vector<boost::any>) == m["RecordTasks"].type()) {
        vector<DescribeRecordTasksResponseBodyRecordTasks> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["RecordTasks"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            DescribeRecordTasksResponseBodyRecordTasks model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        recordTasks = make_shared<vector<DescribeRecordTasksResponseBodyRecordTasks>>(expect1);
      }
    }
    if (m.find("RequestId") != m.end() && !m["RequestId"].empty()) {
      requestId = make_shared<string>(boost::any_cast<string>(m["RequestId"]));
  ...
  virtual ~DescribeRecordTasksResponseBody() = default;
};
class DescribeRecordTasksResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<DescribeRecordTasksResponseBody> body{};

  DescribeRecordTasksResponse() {}

  explicit DescribeRecordTasksResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        DescribeRecordTasksResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<DescribeRecordTasksResponseBody>(model1);
      }
    }
  }


  virtual ~DescribeRecordTasksResponse() = default;
};
...
class StopChannelUserPublishRequest : public Darabonba::Model {
public:
  shared_ptr<string> appId{};
  shared_ptr<string> channelId{};
  shared_ptr<long> ownerId{};
  ...
  explicit StopChannelUserPublishRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~StopChannelUserPublishRequest() = default;
};
class StopChannelUserPublishResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> requestId{};

  StopChannelUserPublishResponseBody() {}

  explicit StopChannelUserPublishResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~StopChannelUserPublishResponseBody() = default;
};
class StopChannelUserPublishResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<StopChannelUserPublishResponseBody> body{};

  StopChannelUserPublishResponse() {}

  explicit StopChannelUserPublishResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        StopChannelUserPublishResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<StopChannelUserPublishResponseBody>(model1);
      }
    }
  }


  virtual ~StopChannelUserPublishResponse() = default;
};
...
public:
  ...
  CreateRecordIndexFileResponse createRecordIndexFileWithOptions(shared_ptr<CreateRecordIndexFileRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  CreateRecordIndexFileResponse createRecordIndexFile(shared_ptr<CreateRecordIndexFileRequest> request);
  ...
  DescribeRecordTasksResponse describeRecordTasksWithOptions(shared_ptr<DescribeRecordTasksRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  DescribeRecordTasksResponse describeRecordTasks(shared_ptr<DescribeRecordTasksRequest> request);
  ...
  StopChannelUserPublishResponse stopChannelUserPublishWithOptions(shared_ptr<StopChannelUserPublishRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  StopChannelUserPublishResponse stopChannelUserPublish(shared_ptr<StopChannelUserPublishRequest> request);
