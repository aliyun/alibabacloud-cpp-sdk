...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSystemLayoutListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSystemLayoutListResponseBody) };
    inline DescribeSystemLayoutListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSystemLayoutListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSystemLayoutListResponseBody> body_ {};
  };
