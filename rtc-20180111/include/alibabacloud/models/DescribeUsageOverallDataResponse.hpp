...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUsageOverallDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUsageOverallDataResponseBody) };
    inline DescribeUsageOverallDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUsageOverallDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUsageOverallDataResponseBody> body_ {};
  };
