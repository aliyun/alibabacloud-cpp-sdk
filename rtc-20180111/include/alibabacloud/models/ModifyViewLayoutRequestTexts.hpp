...
#ifndef ALIBABACLOUD_MODELS_MODIFYVIEWLAYOUTREQUESTTEXTS_HPP_
#define ALIBABACLOUD_MODELS_MODIFYVIEWLAYOUTREQUESTTEXTS_HPP_
#include <darabonba/Core.hpp>
#include <alibabacloud/models/ModifyViewLayoutRequestTextsBoxColor.hpp>
#include <alibabacloud/models/ModifyViewLayoutRequestTextsFontColor.hpp>
using namespace std;
...
namespace Models
{
  class ModifyViewLayoutRequestTexts : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModifyViewLayoutRequestTexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyViewLayoutRequestTexts& obj) { 
    ...
    ModifyViewLayoutRequestTexts() = default ;
    ModifyViewLayoutRequestTexts(const ModifyViewLayoutRequestTexts &) = default ;
    ModifyViewLayoutRequestTexts(ModifyViewLayoutRequestTexts &&) = default ;
    ModifyViewLayoutRequestTexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyViewLayoutRequestTexts() = default ;
    ModifyViewLayoutRequestTexts& operator=(const ModifyViewLayoutRequestTexts &) = default ;
    ModifyViewLayoutRequestTexts& operator=(ModifyViewLayoutRequestTexts &&) = default ;
    ...
    inline ModifyViewLayoutRequestTexts& setAlpha(double alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline ModifyViewLayoutRequestTexts& setBoxAlpha(double boxAlpha) { DARABONBA_PTR_SET_VALUE(boxAlpha_, boxAlpha) };
    ...
    inline ModifyViewLayoutRequestTexts& setBoxBorderw(int32_t boxBorderw) { DARABONBA_PTR_SET_VALUE(boxBorderw_, boxBorderw) };


    // boxColor Field Functions 
    bool hasBoxColor() const { return this->boxColor_ != nullptr;};
    void deleteBoxColor() { this->boxColor_ = nullptr;};
    inline const Models::ModifyViewLayoutRequestTextsBoxColor & boxColor() const { DARABONBA_PTR_GET_CONST(boxColor_, Models::ModifyViewLayoutRequestTextsBoxColor) };
    inline Models::ModifyViewLayoutRequestTextsBoxColor boxColor() { DARABONBA_PTR_GET(boxColor_, Models::ModifyViewLayoutRequestTextsBoxColor) };
    inline ModifyViewLayoutRequestTexts& setBoxColor(const Models::ModifyViewLayoutRequestTextsBoxColor & boxColor) { DARABONBA_PTR_SET_VALUE(boxColor_, boxColor) };
    inline ModifyViewLayoutRequestTexts& setBoxColor(Models::ModifyViewLayoutRequestTextsBoxColor && boxColor) { DARABONBA_PTR_SET_RVALUE(boxColor_, boxColor) };
    ...
    inline ModifyViewLayoutRequestTexts& setFont(int32_t font) { DARABONBA_PTR_SET_VALUE(font_, font) };
    ...
    inline const Models::ModifyViewLayoutRequestTextsFontColor & fontColor() const { DARABONBA_PTR_GET_CONST(fontColor_, Models::ModifyViewLayoutRequestTextsFontColor) };
    inline Models::ModifyViewLayoutRequestTextsFontColor fontColor() { DARABONBA_PTR_GET(fontColor_, Models::ModifyViewLayoutRequestTextsFontColor) };
    inline ModifyViewLayoutRequestTexts& setFontColor(const Models::ModifyViewLayoutRequestTextsFontColor & fontColor) { DARABONBA_PTR_SET_VALUE(fontColor_, fontColor) };
    inline ModifyViewLayoutRequestTexts& setFontColor(Models::ModifyViewLayoutRequestTextsFontColor && fontColor) { DARABONBA_PTR_SET_RVALUE(fontColor_, fontColor) };
    ...
    inline ModifyViewLayoutRequestTexts& setFontSize(int32_t fontSize) { DARABONBA_PTR_SET_VALUE(fontSize_, fontSize) };
    ...
    inline ModifyViewLayoutRequestTexts& setHasBox(bool hasBox) { DARABONBA_PTR_SET_VALUE(hasBox_, hasBox) };
    ...
    inline ModifyViewLayoutRequestTexts& setLayer(int32_t layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline ModifyViewLayoutRequestTexts& setTexture(string texture) { DARABONBA_PTR_SET_VALUE(texture_, texture) };
    ...
    inline ModifyViewLayoutRequestTexts& setX(double x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline ModifyViewLayoutRequestTexts& setY(double y) { DARABONBA_PTR_SET_VALUE(y_, y) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ModifyViewLayoutRequestTextsBoxColor> boxColor_ = nullptr;
    std::shared_ptr<int32_t> font_ = nullptr;
    std::shared_ptr<Models::ModifyViewLayoutRequestTextsFontColor> fontColor_ = nullptr;
