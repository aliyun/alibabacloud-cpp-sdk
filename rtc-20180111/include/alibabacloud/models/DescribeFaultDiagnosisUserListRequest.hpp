...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->channelId_ == nullptr && this->endTs_ == nullptr && this->faultTypes_ == nullptr && this->pageNo_ == nullptr && this->pageSize_ == nullptr
        && this->startTs_ == nullptr && this->userId_ == nullptr; };
    ...
    inline string getFaultTypes() const { DARABONBA_PTR_GET_DEFAULT(faultTypes_, "") };
