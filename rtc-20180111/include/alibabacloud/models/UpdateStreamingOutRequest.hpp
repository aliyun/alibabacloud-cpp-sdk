...
namespace Models
{
  ...
  public:
    ...
    bool hasBackgrounds() const { return this->backgrounds_ != nullptr;};
    void deleteBackgrounds() { this->backgrounds_ = nullptr;};
    inline const vector<UpdateStreamingOutRequest::Backgrounds> & getBackgrounds() const { DARABONBA_PTR_GET_CONST(backgrounds_, vector<UpdateStreamingOutRequest::Backgrounds>) };
    inline vector<UpdateStreamingOutRequest::Backgrounds> getBackgrounds() { DARABONBA_PTR_GET(backgrounds_, vector<UpdateStreamingOutRequest::Backgrounds>) };
    inline UpdateStreamingOutRequest& setBackgrounds(const vector<UpdateStreamingOutRequest::Backgrounds> & backgrounds) { DARABONBA_PTR_SET_VALUE(backgrounds_, backgrounds) };
    inline UpdateStreamingOutRequest& setBackgrounds(vector<UpdateStreamingOutRequest::Backgrounds> && backgrounds) { DARABONBA_PTR_SET_RVALUE(backgrounds_, backgrounds) };


    // bgColor Field Functions 
    bool hasBgColor() const { return this->bgColor_ != nullptr;};
    void deleteBgColor() { this->bgColor_ = nullptr;};
    inline const UpdateStreamingOutRequest::BgColor & getBgColor() const { DARABONBA_PTR_GET_CONST(bgColor_, UpdateStreamingOutRequest::BgColor) };
    inline UpdateStreamingOutRequest::BgColor getBgColor() { DARABONBA_PTR_GET(bgColor_, UpdateStreamingOutRequest::BgColor) };
    inline UpdateStreamingOutRequest& setBgColor(const UpdateStreamingOutRequest::BgColor & bgColor) { DARABONBA_PTR_SET_VALUE(bgColor_, bgColor) };
    inline UpdateStreamingOutRequest& setBgColor(UpdateStreamingOutRequest::BgColor && bgColor) { DARABONBA_PTR_SET_RVALUE(bgColor_, bgColor) };
    ...
    inline const vector<UpdateStreamingOutRequest::ClockWidgets> & getClockWidgets() const { DARABONBA_PTR_GET_CONST(clockWidgets_, vector<UpdateStreamingOutRequest::ClockWidgets>) };
    inline vector<UpdateStreamingOutRequest::ClockWidgets> getClockWidgets() { DARABONBA_PTR_GET(clockWidgets_, vector<UpdateStreamingOutRequest::ClockWidgets>) };
    inline UpdateStreamingOutRequest& setClockWidgets(const vector<UpdateStreamingOutRequest::ClockWidgets> & clockWidgets) { DARABONBA_PTR_SET_VALUE(clockWidgets_, clockWidgets) };
    inline UpdateStreamingOutRequest& setClockWidgets(vector<UpdateStreamingOutRequest::ClockWidgets> && clockWidgets) { DARABONBA_PTR_SET_RVALUE(clockWidgets_, clockWidgets) };
    ...
    bool hasImages() const { return this->images_ != nullptr;};
    void deleteImages() { this->images_ = nullptr;};
    inline const vector<UpdateStreamingOutRequest::Images> & getImages() const { DARABONBA_PTR_GET_CONST(images_, vector<UpdateStreamingOutRequest::Images>) };
    inline vector<UpdateStreamingOutRequest::Images> getImages() { DARABONBA_PTR_GET(images_, vector<UpdateStreamingOutRequest::Images>) };
    inline UpdateStreamingOutRequest& setImages(const vector<UpdateStreamingOutRequest::Images> & images) { DARABONBA_PTR_SET_VALUE(images_, images) };
    inline UpdateStreamingOutRequest& setImages(vector<UpdateStreamingOutRequest::Images> && images) { DARABONBA_PTR_SET_RVALUE(images_, images) };
    ...
    inline const UpdateStreamingOutRequest::LayoutSpecifiedUsers & getLayoutSpecifiedUsers() const { DARABONBA_PTR_GET_CONST(layoutSpecifiedUsers_, UpdateStreamingOutRequest::LayoutSpecifiedUsers) };
    inline UpdateStreamingOutRequest::LayoutSpecifiedUsers getLayoutSpecifiedUsers() { DARABONBA_PTR_GET(layoutSpecifiedUsers_, UpdateStreamingOutRequest::LayoutSpecifiedUsers) };
    inline UpdateStreamingOutRequest& setLayoutSpecifiedUsers(const UpdateStreamingOutRequest::LayoutSpecifiedUsers & layoutSpecifiedUsers) { DARABONBA_PTR_SET_VALUE(layoutSpecifiedUsers_, layoutSpecifiedUsers) };
    inline UpdateStreamingOutRequest& setLayoutSpecifiedUsers(UpdateStreamingOutRequest::LayoutSpecifiedUsers && layoutSpecifiedUsers) { DARABONBA_PTR_SET_RVALUE(layoutSpecifiedUsers_, layoutSpecifiedUsers) };


    // panes Field Functions 
    bool hasPanes() const { return this->panes_ != nullptr;};
    void deletePanes() { this->panes_ = nullptr;};
    inline const vector<UpdateStreamingOutRequest::Panes> & getPanes() const { DARABONBA_PTR_GET_CONST(panes_, vector<UpdateStreamingOutRequest::Panes>) };
    inline vector<UpdateStreamingOutRequest::Panes> getPanes() { DARABONBA_PTR_GET(panes_, vector<UpdateStreamingOutRequest::Panes>) };
    inline UpdateStreamingOutRequest& setPanes(const vector<UpdateStreamingOutRequest::Panes> & panes) { DARABONBA_PTR_SET_VALUE(panes_, panes) };
    inline UpdateStreamingOutRequest& setPanes(vector<UpdateStreamingOutRequest::Panes> && panes) { DARABONBA_PTR_SET_RVALUE(panes_, panes) };
    ...
    inline const UpdateStreamingOutRequest::RegionColor & getRegionColor() const { DARABONBA_PTR_GET_CONST(regionColor_, UpdateStreamingOutRequest::RegionColor) };
    inline UpdateStreamingOutRequest::RegionColor getRegionColor() { DARABONBA_PTR_GET(regionColor_, UpdateStreamingOutRequest::RegionColor) };
    inline UpdateStreamingOutRequest& setRegionColor(const UpdateStreamingOutRequest::RegionColor & regionColor) { DARABONBA_PTR_SET_VALUE(regionColor_, regionColor) };
    inline UpdateStreamingOutRequest& setRegionColor(UpdateStreamingOutRequest::RegionColor && regionColor) { DARABONBA_PTR_SET_RVALUE(regionColor_, regionColor) };
    ...
    bool hasTexts() const { return this->texts_ != nullptr;};
    void deleteTexts() { this->texts_ = nullptr;};
    inline const vector<UpdateStreamingOutRequest::Texts> & getTexts() const { DARABONBA_PTR_GET_CONST(texts_, vector<UpdateStreamingOutRequest::Texts>) };
    inline vector<UpdateStreamingOutRequest::Texts> getTexts() { DARABONBA_PTR_GET(texts_, vector<UpdateStreamingOutRequest::Texts>) };
    inline UpdateStreamingOutRequest& setTexts(const vector<UpdateStreamingOutRequest::Texts> & texts) { DARABONBA_PTR_SET_VALUE(texts_, texts) };
    inline UpdateStreamingOutRequest& setTexts(vector<UpdateStreamingOutRequest::Texts> && texts) { DARABONBA_PTR_SET_RVALUE(texts_, texts) };


  protected:
    // This parameter is required.
    shared_ptr<string> appId_ {};
    shared_ptr<vector<UpdateStreamingOutRequest::Backgrounds>> backgrounds_ {};
    shared_ptr<UpdateStreamingOutRequest::BgColor> bgColor_ {};
    // This parameter is required.
    shared_ptr<string> channelId_ {};
    shared_ptr<vector<UpdateStreamingOutRequest::ClockWidgets>> clockWidgets_ {};
    shared_ptr<int32_t> cropMode_ {};
    shared_ptr<vector<UpdateStreamingOutRequest::Images>> images_ {};
    shared_ptr<UpdateStreamingOutRequest::LayoutSpecifiedUsers> layoutSpecifiedUsers_ {};
    shared_ptr<vector<UpdateStreamingOutRequest::Panes>> panes_ {};
    shared_ptr<UpdateStreamingOutRequest::RegionColor> regionColor_ {};
    shared_ptr<vector<string>> specMixedUserList_ {};
    // This parameter is required.
    shared_ptr<string> taskId_ {};
    // This parameter is required.
    shared_ptr<string> templateId_ {};
    shared_ptr<vector<UpdateStreamingOutRequest::Texts>> texts_ {};
  };
