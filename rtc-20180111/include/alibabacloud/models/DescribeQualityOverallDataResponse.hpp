...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeQualityOverallDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeQualityOverallDataResponseBody) };
    inline DescribeQualityOverallDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeQualityOverallDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeQualityOverallDataResponseBody> body_ {};
  };
