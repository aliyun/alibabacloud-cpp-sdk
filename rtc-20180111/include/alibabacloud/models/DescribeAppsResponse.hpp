...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAppsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeAppsResponseBody) };
    inline DescribeAppsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeAppsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAppsResponseBody> body_ = nullptr;
  };
