...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->channelId_ == nullptr && this->createdTs_ == nullptr && this->destroyedTs_ == nullptr && this->extDataType_ == nullptr && this->queryExpInfo_ == nullptr; };
    ...
    inline string getExtDataType() const { DARABONBA_PTR_GET_DEFAULT(extDataType_, "") };
    ...
    inline bool getQueryExpInfo() const { DARABONBA_PTR_GET_DEFAULT(queryExpInfo_, false) };
  ...
  protected:
    ...
    shared_ptr<string> extDataType_ {};
    shared_ptr<bool> queryExpInfo_ {};
  };
