...
#ifndef ALIBABACLOUD_MODELS_UPDATEMPUTASKREQUESTWATERMARKS_HPP_
#define ALIBABACLOUD_MODELS_UPDATEMPUTASKREQUESTWATERMARKS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateMPUTaskRequestWatermarks& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateMPUTaskRequestWatermarks& obj) { 
    ...
    UpdateMPUTaskRequestWatermarks() = default ;
    UpdateMPUTaskRequestWatermarks(const UpdateMPUTaskRequestWatermarks &) = default ;
    UpdateMPUTaskRequestWatermarks(UpdateMPUTaskRequestWatermarks &&) = default ;
    UpdateMPUTaskRequestWatermarks(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateMPUTaskRequestWatermarks() = default ;
    UpdateMPUTaskRequestWatermarks& operator=(const UpdateMPUTaskRequestWatermarks &) = default ;
    UpdateMPUTaskRequestWatermarks& operator=(UpdateMPUTaskRequestWatermarks &&) = default ;
    ...
    inline UpdateMPUTaskRequestWatermarks& setAlpha(float alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline UpdateMPUTaskRequestWatermarks& setDisplay(int32_t display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline UpdateMPUTaskRequestWatermarks& setHeight(float height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline UpdateMPUTaskRequestWatermarks& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
    ...
    inline UpdateMPUTaskRequestWatermarks& setWidth(float width) { DARABONBA_PTR_SET_VALUE(width_, width) };
    ...
    inline UpdateMPUTaskRequestWatermarks& setX(float x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline UpdateMPUTaskRequestWatermarks& setY(float y) { DARABONBA_PTR_SET_VALUE(y_, y) };
    ...
    inline UpdateMPUTaskRequestWatermarks& setZOrder(int32_t ZOrder) { DARABONBA_PTR_SET_VALUE(ZOrder_, ZOrder) };
