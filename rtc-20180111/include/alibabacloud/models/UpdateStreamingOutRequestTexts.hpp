...
#ifndef ALIBABACLOUD_MODELS_UPDATESTREAMINGOUTREQUESTTEXTS_HPP_
#define ALIBABACLOUD_MODELS_UPDATESTREAMINGOUTREQUESTTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateStreamingOutRequestTexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateStreamingOutRequestTexts& obj) { 
    ...
    UpdateStreamingOutRequestTexts() = default ;
    UpdateStreamingOutRequestTexts(const UpdateStreamingOutRequestTexts &) = default ;
    UpdateStreamingOutRequestTexts(UpdateStreamingOutRequestTexts &&) = default ;
    UpdateStreamingOutRequestTexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateStreamingOutRequestTexts() = default ;
    UpdateStreamingOutRequestTexts& operator=(const UpdateStreamingOutRequestTexts &) = default ;
    UpdateStreamingOutRequestTexts& operator=(UpdateStreamingOutRequestTexts &&) = default ;
    ...
    inline UpdateStreamingOutRequestTexts& setAlpha(double alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline UpdateStreamingOutRequestTexts& setBoxAlpha(double boxAlpha) { DARABONBA_PTR_SET_VALUE(boxAlpha_, boxAlpha) };
    ...
    inline UpdateStreamingOutRequestTexts& setBoxBorderw(int32_t boxBorderw) { DARABONBA_PTR_SET_VALUE(boxBorderw_, boxBorderw) };


    // boxColor Field Functions 
    bool hasBoxColor() const { return this->boxColor_ != nullptr;};
    void deleteBoxColor() { this->boxColor_ = nullptr;};
    inline const Models::UpdateStreamingOutRequestTextsBoxColor & boxColor() const { DARABONBA_PTR_GET_CONST(boxColor_, Models::UpdateStreamingOutRequestTextsBoxColor) };
    inline Models::UpdateStreamingOutRequestTextsBoxColor boxColor() { DARABONBA_PTR_GET(boxColor_, Models::UpdateStreamingOutRequestTextsBoxColor) };
    inline UpdateStreamingOutRequestTexts& setBoxColor(const Models::UpdateStreamingOutRequestTextsBoxColor & boxColor) { DARABONBA_PTR_SET_VALUE(boxColor_, boxColor) };
    inline UpdateStreamingOutRequestTexts& setBoxColor(Models::UpdateStreamingOutRequestTextsBoxColor && boxColor) { DARABONBA_PTR_SET_RVALUE(boxColor_, boxColor) };
    ...
    inline UpdateStreamingOutRequestTexts& setFont(int32_t font) { DARABONBA_PTR_SET_VALUE(font_, font) };
    ...
    inline const Models::UpdateStreamingOutRequestTextsFontColor & fontColor() const { DARABONBA_PTR_GET_CONST(fontColor_, Models::UpdateStreamingOutRequestTextsFontColor) };
    inline Models::UpdateStreamingOutRequestTextsFontColor fontColor() { DARABONBA_PTR_GET(fontColor_, Models::UpdateStreamingOutRequestTextsFontColor) };
    inline UpdateStreamingOutRequestTexts& setFontColor(const Models::UpdateStreamingOutRequestTextsFontColor & fontColor) { DARABONBA_PTR_SET_VALUE(fontColor_, fontColor) };
    inline UpdateStreamingOutRequestTexts& setFontColor(Models::UpdateStreamingOutRequestTextsFontColor && fontColor) { DARABONBA_PTR_SET_RVALUE(fontColor_, fontColor) };
    ...
    inline UpdateStreamingOutRequestTexts& setFontSize(int32_t fontSize) { DARABONBA_PTR_SET_VALUE(fontSize_, fontSize) };
    ...
    inline UpdateStreamingOutRequestTexts& setHasBox(bool hasBox) { DARABONBA_PTR_SET_VALUE(hasBox_, hasBox) };
    ...
    inline UpdateStreamingOutRequestTexts& setLayer(int32_t layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline UpdateStreamingOutRequestTexts& setTexture(string texture) { DARABONBA_PTR_SET_VALUE(texture_, texture) };
    ...
    inline UpdateStreamingOutRequestTexts& setX(double x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline UpdateStreamingOutRequestTexts& setY(double y) { DARABONBA_PTR_SET_VALUE(y_, y) };
  ...
  protected:
    ...
    std::shared_ptr<Models::UpdateStreamingOutRequestTextsBoxColor> boxColor_ = nullptr;
    std::shared_ptr<int32_t> font_ = nullptr;
    std::shared_ptr<Models::UpdateStreamingOutRequestTextsFontColor> fontColor_ = nullptr;
