...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAppLiveStreamStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAppLiveStreamStatusResponseBody) };
    inline DescribeAppLiveStreamStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAppLiveStreamStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAppLiveStreamStatusResponseBody> body_ {};
  };
