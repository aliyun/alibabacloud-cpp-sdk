...
#ifndef ALIBABACLOUD_MODELS_STARTSTREAMINGOUTREQUESTPANESTEXTS_HPP_
#define ALIBABACLOUD_MODELS_STARTSTREAMINGOUTREQUESTPANESTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartStreamingOutRequestPanesTexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartStreamingOutRequestPanesTexts& obj) { 
    ...
    StartStreamingOutRequestPanesTexts() = default ;
    StartStreamingOutRequestPanesTexts(const StartStreamingOutRequestPanesTexts &) = default ;
    StartStreamingOutRequestPanesTexts(StartStreamingOutRequestPanesTexts &&) = default ;
    StartStreamingOutRequestPanesTexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartStreamingOutRequestPanesTexts() = default ;
    StartStreamingOutRequestPanesTexts& operator=(const StartStreamingOutRequestPanesTexts &) = default ;
    StartStreamingOutRequestPanesTexts& operator=(StartStreamingOutRequestPanesTexts &&) = default ;
    ...
    inline StartStreamingOutRequestPanesTexts& setAlpha(double alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline StartStreamingOutRequestPanesTexts& setBoxAlpha(double boxAlpha) { DARABONBA_PTR_SET_VALUE(boxAlpha_, boxAlpha) };
    ...
    inline StartStreamingOutRequestPanesTexts& setBoxBorderw(int32_t boxBorderw) { DARABONBA_PTR_SET_VALUE(boxBorderw_, boxBorderw) };


    // boxColor Field Functions 
    bool hasBoxColor() const { return this->boxColor_ != nullptr;};
    void deleteBoxColor() { this->boxColor_ = nullptr;};
    inline const Models::StartStreamingOutRequestPanesTextsBoxColor & boxColor() const { DARABONBA_PTR_GET_CONST(boxColor_, Models::StartStreamingOutRequestPanesTextsBoxColor) };
    inline Models::StartStreamingOutRequestPanesTextsBoxColor boxColor() { DARABONBA_PTR_GET(boxColor_, Models::StartStreamingOutRequestPanesTextsBoxColor) };
    inline StartStreamingOutRequestPanesTexts& setBoxColor(const Models::StartStreamingOutRequestPanesTextsBoxColor & boxColor) { DARABONBA_PTR_SET_VALUE(boxColor_, boxColor) };
    inline StartStreamingOutRequestPanesTexts& setBoxColor(Models::StartStreamingOutRequestPanesTextsBoxColor && boxColor) { DARABONBA_PTR_SET_RVALUE(boxColor_, boxColor) };
    ...
    inline StartStreamingOutRequestPanesTexts& setDisplay(string display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline StartStreamingOutRequestPanesTexts& setFont(int32_t font) { DARABONBA_PTR_SET_VALUE(font_, font) };
    ...
    inline const Models::StartStreamingOutRequestPanesTextsFontColor & fontColor() const { DARABONBA_PTR_GET_CONST(fontColor_, Models::StartStreamingOutRequestPanesTextsFontColor) };
    inline Models::StartStreamingOutRequestPanesTextsFontColor fontColor() { DARABONBA_PTR_GET(fontColor_, Models::StartStreamingOutRequestPanesTextsFontColor) };
    inline StartStreamingOutRequestPanesTexts& setFontColor(const Models::StartStreamingOutRequestPanesTextsFontColor & fontColor) { DARABONBA_PTR_SET_VALUE(fontColor_, fontColor) };
    inline StartStreamingOutRequestPanesTexts& setFontColor(Models::StartStreamingOutRequestPanesTextsFontColor && fontColor) { DARABONBA_PTR_SET_RVALUE(fontColor_, fontColor) };
    ...
    inline StartStreamingOutRequestPanesTexts& setFontSize(int32_t fontSize) { DARABONBA_PTR_SET_VALUE(fontSize_, fontSize) };
    ...
    inline StartStreamingOutRequestPanesTexts& setHasBox(bool hasBox) { DARABONBA_PTR_SET_VALUE(hasBox_, hasBox) };
    ...
    inline StartStreamingOutRequestPanesTexts& setLayer(int32_t layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline StartStreamingOutRequestPanesTexts& setTexture(string texture) { DARABONBA_PTR_SET_VALUE(texture_, texture) };
    ...
    inline StartStreamingOutRequestPanesTexts& setX(double x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline StartStreamingOutRequestPanesTexts& setY(double y) { DARABONBA_PTR_SET_VALUE(y_, y) };
  ...
  protected:
    ...
    std::shared_ptr<Models::StartStreamingOutRequestPanesTextsBoxColor> boxColor_ = nullptr;
    std::shared_ptr<string> display_ = nullptr;
    std::shared_ptr<int32_t> font_ = nullptr;
    std::shared_ptr<Models::StartStreamingOutRequestPanesTextsFontColor> fontColor_ = nullptr;
