...
namespace Models
{
  ...
  public:
    ...
    inline const StartStreamingOutResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartStreamingOutResponseBody) };
    inline StartStreamingOutResponseBody getBody() { DARABONBA_PTR_GET(body_, StartStreamingOutResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartStreamingOutResponseBody> body_ {};
  };
