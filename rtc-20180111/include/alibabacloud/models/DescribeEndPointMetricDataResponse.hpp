...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEndPointMetricDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEndPointMetricDataResponseBody) };
    inline DescribeEndPointMetricDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEndPointMetricDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEndPointMetricDataResponseBody> body_ {};
  };
