...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->channelProfile_ == nullptr
        && this->commTotalNum_ == nullptr && this->interactiveUserList_ == nullptr && this->interactiveUserNum_ == nullptr && this->isChannelExist_ == nullptr && this->liveUserList_ == nullptr
        && this->liveUserNum_ == nullptr && this->requestId_ == nullptr && this->timestamp_ == nullptr && this->userList_ == nullptr; };
    ...
    inline int32_t getChannelProfile() const { DARABONBA_PTR_GET_DEFAULT(channelProfile_, 0) };
    ...
    inline int32_t getCommTotalNum() const { DARABONBA_PTR_GET_DEFAULT(commTotalNum_, 0) };
    ...
    inline int32_t getInteractiveUserNum() const { DARABONBA_PTR_GET_DEFAULT(interactiveUserNum_, 0) };
    ...
    inline int32_t getLiveUserNum() const { DARABONBA_PTR_GET_DEFAULT(liveUserNum_, 0) };
  ...
  protected:
    shared_ptr<int32_t> channelProfile_ {};
    shared_ptr<int32_t> commTotalNum_ {};
    shared_ptr<vector<string>> interactiveUserList_ {};
    shared_ptr<int32_t> interactiveUserNum_ {};
    shared_ptr<bool> isChannelExist_ {};
    shared_ptr<vector<string>> liveUserList_ {};
    shared_ptr<int32_t> liveUserNum_ {};
