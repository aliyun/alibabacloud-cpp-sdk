...
#ifndef ALIBABACLOUD_MODELS_UPDATECLOUDRECORDREQUESTIMAGES_HPP_
#define ALIBABACLOUD_MODELS_UPDATECLOUDRECORDREQUESTIMAGES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateCloudRecordRequestImages& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateCloudRecordRequestImages& obj) { 
    ...
    UpdateCloudRecordRequestImages() = default ;
    UpdateCloudRecordRequestImages(const UpdateCloudRecordRequestImages &) = default ;
    UpdateCloudRecordRequestImages(UpdateCloudRecordRequestImages &&) = default ;
    UpdateCloudRecordRequestImages(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateCloudRecordRequestImages() = default ;
    UpdateCloudRecordRequestImages& operator=(const UpdateCloudRecordRequestImages &) = default ;
    UpdateCloudRecordRequestImages& operator=(UpdateCloudRecordRequestImages &&) = default ;
    ...
    inline UpdateCloudRecordRequestImages& setAlpha(double alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline UpdateCloudRecordRequestImages& setHeight(double height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline UpdateCloudRecordRequestImages& setImageCropMode(int32_t imageCropMode) { DARABONBA_PTR_SET_VALUE(imageCropMode_, imageCropMode) };
    ...
    inline UpdateCloudRecordRequestImages& setLayer(int32_t layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline UpdateCloudRecordRequestImages& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
    ...
    inline UpdateCloudRecordRequestImages& setWidth(double width) { DARABONBA_PTR_SET_VALUE(width_, width) };
    ...
    inline UpdateCloudRecordRequestImages& setX(double x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline UpdateCloudRecordRequestImages& setY(double y) { DARABONBA_PTR_SET_VALUE(y_, y) };
