...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAppLayoutResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAppLayoutResponseBody) };
    inline DeleteAppLayoutResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAppLayoutResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAppLayoutResponseBody> body_ {};
  };
