...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->callExp_ == nullptr
        && return this->createdTs_ == nullptr && return this->destroyedTs_ == nullptr && return this->durMetricStatData_ == nullptr && return this->duration_ == nullptr && return this->location_ == nullptr
