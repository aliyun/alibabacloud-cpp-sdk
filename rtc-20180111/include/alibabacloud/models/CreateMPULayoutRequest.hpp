...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateMPULayoutRequest::Panes> & getPanes() const { DARABONBA_PTR_GET_CONST(panes_, vector<CreateMPULayoutRequest::Panes>) };
    inline vector<CreateMPULayoutRequest::Panes> getPanes() { DARABONBA_PTR_GET(panes_, vector<CreateMPULayoutRequest::Panes>) };
    inline CreateMPULayoutRequest& setPanes(const vector<CreateMPULayoutRequest::Panes> & panes) { DARABONBA_PTR_SET_VALUE(panes_, panes) };
    inline CreateMPULayoutRequest& setPanes(vector<CreateMPULayoutRequest::Panes> && panes) { DARABONBA_PTR_SET_RVALUE(panes_, panes) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<vector<CreateMPULayoutRequest::Panes>> panes_ {};
  };
