...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAppViewTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyAppViewTemplateResponseBody) };
    inline ModifyAppViewTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyAppViewTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyAppViewTemplateResponseBody> body_ {};
  };
