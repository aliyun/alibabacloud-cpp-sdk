...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        ...
        && this->startWithoutChannelWaitTime_ == nullptr && this->taskId_ == nullptr && this->templateId_ == nullptr && this->viewContent_ == nullptr && this->viewSubscribers_ == nullptr; };
    ...
    inline const StartViewRequest::BgColor & getBgColor() const { DARABONBA_PTR_GET_CONST(bgColor_, StartViewRequest::BgColor) };
    inline StartViewRequest::BgColor getBgColor() { DARABONBA_PTR_GET(bgColor_, StartViewRequest::BgColor) };
    inline StartViewRequest& setBgColor(const StartViewRequest::BgColor & bgColor) { DARABONBA_PTR_SET_VALUE(bgColor_, bgColor) };
    inline StartViewRequest& setBgColor(StartViewRequest::BgColor && bgColor) { DARABONBA_PTR_SET_RVALUE(bgColor_, bgColor) };
    ...
    inline const StartViewRequest::RegionColor & getRegionColor() const { DARABONBA_PTR_GET_CONST(regionColor_, StartViewRequest::RegionColor) };
    inline StartViewRequest::RegionColor getRegionColor() { DARABONBA_PTR_GET(regionColor_, StartViewRequest::RegionColor) };
    inline StartViewRequest& setRegionColor(const StartViewRequest::RegionColor & regionColor) { DARABONBA_PTR_SET_VALUE(regionColor_, regionColor) };
    inline StartViewRequest& setRegionColor(StartViewRequest::RegionColor && regionColor) { DARABONBA_PTR_SET_RVALUE(regionColor_, regionColor) };
  ...
  protected:
    ...
    shared_ptr<StartViewRequest::BgColor> bgColor_ {};
    // This parameter is required.
    shared_ptr<string> channelId_ {};
    shared_ptr<int32_t> cropMode_ {};
    shared_ptr<StartViewRequest::RegionColor> regionColor_ {};
