...
#ifndef ALIBABACLOUD_MODELS_STARTCLOUDRECORDREQUESTPANESIMAGES_HPP_
#define ALIBABACLOUD_MODELS_STARTCLOUDRECORDREQUESTPANESIMAGES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartCloudRecordRequestPanesImages& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartCloudRecordRequestPanesImages& obj) { 
    ...
    StartCloudRecordRequestPanesImages() = default ;
    StartCloudRecordRequestPanesImages(const StartCloudRecordRequestPanesImages &) = default ;
    StartCloudRecordRequestPanesImages(StartCloudRecordRequestPanesImages &&) = default ;
    StartCloudRecordRequestPanesImages(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartCloudRecordRequestPanesImages() = default ;
    StartCloudRecordRequestPanesImages& operator=(const StartCloudRecordRequestPanesImages &) = default ;
    StartCloudRecordRequestPanesImages& operator=(StartCloudRecordRequestPanesImages &&) = default ;
    ...
    inline StartCloudRecordRequestPanesImages& setAlpha(double alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline StartCloudRecordRequestPanesImages& setDisplay(string display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline StartCloudRecordRequestPanesImages& setHeight(double height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline StartCloudRecordRequestPanesImages& setLayer(int32_t layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline StartCloudRecordRequestPanesImages& setPaneImageCropMode(int32_t paneImageCropMode) { DARABONBA_PTR_SET_VALUE(paneImageCropMode_, paneImageCropMode) };
    ...
    inline StartCloudRecordRequestPanesImages& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
    ...
    inline StartCloudRecordRequestPanesImages& setWidth(double width) { DARABONBA_PTR_SET_VALUE(width_, width) };
    ...
    inline StartCloudRecordRequestPanesImages& setX(double x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline StartCloudRecordRequestPanesImages& setY(double y) { DARABONBA_PTR_SET_VALUE(y_, y) };
