...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->channelId_ == nullptr && this->taskId_ == nullptr && this->viewContent_ == nullptr && this->viewSubscribers_ == nullptr; };
    ...
    inline const vector<string> & getViewSubscribers() const { DARABONBA_PTR_GET_CONST(viewSubscribers_, vector<string>) };
    inline vector<string> getViewSubscribers() { DARABONBA_PTR_GET(viewSubscribers_, vector<string>) };
  ...
  protected:
    ...
    // ViewSubscribers。
    shared_ptr<vector<string>> viewSubscribers_ {};
  };
