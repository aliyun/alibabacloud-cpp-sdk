...
#ifndef ALIBABACLOUD_MODELS_UPDATECLOUDRECORDREQUESTPANESTEXTS_HPP_
#define ALIBABACLOUD_MODELS_UPDATECLOUDRECORDREQUESTPANESTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateCloudRecordRequestPanesTexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateCloudRecordRequestPanesTexts& obj) { 
    ...
    UpdateCloudRecordRequestPanesTexts() = default ;
    UpdateCloudRecordRequestPanesTexts(const UpdateCloudRecordRequestPanesTexts &) = default ;
    UpdateCloudRecordRequestPanesTexts(UpdateCloudRecordRequestPanesTexts &&) = default ;
    UpdateCloudRecordRequestPanesTexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateCloudRecordRequestPanesTexts() = default ;
    UpdateCloudRecordRequestPanesTexts& operator=(const UpdateCloudRecordRequestPanesTexts &) = default ;
    UpdateCloudRecordRequestPanesTexts& operator=(UpdateCloudRecordRequestPanesTexts &&) = default ;
    ...
    inline UpdateCloudRecordRequestPanesTexts& setAlpha(double alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline UpdateCloudRecordRequestPanesTexts& setBoxAlpha(double boxAlpha) { DARABONBA_PTR_SET_VALUE(boxAlpha_, boxAlpha) };
    ...
    inline UpdateCloudRecordRequestPanesTexts& setBoxBorderw(int32_t boxBorderw) { DARABONBA_PTR_SET_VALUE(boxBorderw_, boxBorderw) };


    // boxColor Field Functions 
    bool hasBoxColor() const { return this->boxColor_ != nullptr;};
    void deleteBoxColor() { this->boxColor_ = nullptr;};
    inline const Models::UpdateCloudRecordRequestPanesTextsBoxColor & boxColor() const { DARABONBA_PTR_GET_CONST(boxColor_, Models::UpdateCloudRecordRequestPanesTextsBoxColor) };
    inline Models::UpdateCloudRecordRequestPanesTextsBoxColor boxColor() { DARABONBA_PTR_GET(boxColor_, Models::UpdateCloudRecordRequestPanesTextsBoxColor) };
    inline UpdateCloudRecordRequestPanesTexts& setBoxColor(const Models::UpdateCloudRecordRequestPanesTextsBoxColor & boxColor) { DARABONBA_PTR_SET_VALUE(boxColor_, boxColor) };
    inline UpdateCloudRecordRequestPanesTexts& setBoxColor(Models::UpdateCloudRecordRequestPanesTextsBoxColor && boxColor) { DARABONBA_PTR_SET_RVALUE(boxColor_, boxColor) };
    ...
    inline UpdateCloudRecordRequestPanesTexts& setDisplay(string display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline UpdateCloudRecordRequestPanesTexts& setFont(int32_t font) { DARABONBA_PTR_SET_VALUE(font_, font) };
    ...
    inline const Models::UpdateCloudRecordRequestPanesTextsFontColor & fontColor() const { DARABONBA_PTR_GET_CONST(fontColor_, Models::UpdateCloudRecordRequestPanesTextsFontColor) };
    inline Models::UpdateCloudRecordRequestPanesTextsFontColor fontColor() { DARABONBA_PTR_GET(fontColor_, Models::UpdateCloudRecordRequestPanesTextsFontColor) };
    inline UpdateCloudRecordRequestPanesTexts& setFontColor(const Models::UpdateCloudRecordRequestPanesTextsFontColor & fontColor) { DARABONBA_PTR_SET_VALUE(fontColor_, fontColor) };
    inline UpdateCloudRecordRequestPanesTexts& setFontColor(Models::UpdateCloudRecordRequestPanesTextsFontColor && fontColor) { DARABONBA_PTR_SET_RVALUE(fontColor_, fontColor) };
    ...
    inline UpdateCloudRecordRequestPanesTexts& setFontSize(int32_t fontSize) { DARABONBA_PTR_SET_VALUE(fontSize_, fontSize) };
    ...
    inline UpdateCloudRecordRequestPanesTexts& setHasBox(bool hasBox) { DARABONBA_PTR_SET_VALUE(hasBox_, hasBox) };
    ...
    inline UpdateCloudRecordRequestPanesTexts& setLayer(int32_t layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline UpdateCloudRecordRequestPanesTexts& setTexture(string texture) { DARABONBA_PTR_SET_VALUE(texture_, texture) };
    ...
    inline UpdateCloudRecordRequestPanesTexts& setX(double x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline UpdateCloudRecordRequestPanesTexts& setY(double y) { DARABONBA_PTR_SET_VALUE(y_, y) };
  ...
  protected:
    ...
    std::shared_ptr<Models::UpdateCloudRecordRequestPanesTextsBoxColor> boxColor_ = nullptr;
    std::shared_ptr<string> display_ = nullptr;
    std::shared_ptr<int32_t> font_ = nullptr;
    std::shared_ptr<Models::UpdateCloudRecordRequestPanesTextsFontColor> fontColor_ = nullptr;
