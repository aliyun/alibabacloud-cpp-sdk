...
#include <alibabacloud/models/DeleteAppViewTemplateRequestTemplate.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAppViewTemplateRequestTemplate & _template() const { DARABONBA_PTR_GET_CONST(template_, DeleteAppViewTemplateRequestTemplate) };
    inline DeleteAppViewTemplateRequestTemplate _template() { DARABONBA_PTR_GET(template_, DeleteAppViewTemplateRequestTemplate) };
    inline DeleteAppViewTemplateRequest& setTemplate(const DeleteAppViewTemplateRequestTemplate & _template) { DARABONBA_PTR_SET_VALUE(template_, _template) };
    inline DeleteAppViewTemplateRequest& setTemplate(DeleteAppViewTemplateRequestTemplate && _template) { DARABONBA_PTR_SET_RVALUE(template_, _template) };
  ...
  protected:
    ...
    // This parameter is required.
    std::shared_ptr<DeleteAppViewTemplateRequestTemplate> template_ = nullptr;
  };
