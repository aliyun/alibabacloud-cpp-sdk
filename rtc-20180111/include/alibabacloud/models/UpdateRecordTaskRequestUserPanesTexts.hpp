...
#ifndef ALIBABACLOUD_MODELS_UPDATERECORDTASKREQUESTUSERPANESTEXTS_HPP_
#define ALIBABACLOUD_MODELS_UPDATERECORDTASKREQUESTUSERPANESTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateRecordTaskRequestUserPanesTexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateRecordTaskRequestUserPanesTexts& obj) { 
    ...
    UpdateRecordTaskRequestUserPanesTexts() = default ;
    UpdateRecordTaskRequestUserPanesTexts(const UpdateRecordTaskRequestUserPanesTexts &) = default ;
    UpdateRecordTaskRequestUserPanesTexts(UpdateRecordTaskRequestUserPanesTexts &&) = default ;
    UpdateRecordTaskRequestUserPanesTexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateRecordTaskRequestUserPanesTexts() = default ;
    UpdateRecordTaskRequestUserPanesTexts& operator=(const UpdateRecordTaskRequestUserPanesTexts &) = default ;
    UpdateRecordTaskRequestUserPanesTexts& operator=(UpdateRecordTaskRequestUserPanesTexts &&) = default ;
    ...
    inline UpdateRecordTaskRequestUserPanesTexts& setFontColor(int32_t fontColor) { DARABONBA_PTR_SET_VALUE(fontColor_, fontColor) };
    ...
    inline UpdateRecordTaskRequestUserPanesTexts& setFontSize(int32_t fontSize) { DARABONBA_PTR_SET_VALUE(fontSize_, fontSize) };
    ...
    inline UpdateRecordTaskRequestUserPanesTexts& setFontType(int32_t fontType) { DARABONBA_PTR_SET_VALUE(fontType_, fontType) };
    ...
    inline UpdateRecordTaskRequestUserPanesTexts& setText(string text) { DARABONBA_PTR_SET_VALUE(text_, text) };
    ...
    inline UpdateRecordTaskRequestUserPanesTexts& setX(float x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline UpdateRecordTaskRequestUserPanesTexts& setY(float y) { DARABONBA_PTR_SET_VALUE(y_, y) };
    ...
    inline UpdateRecordTaskRequestUserPanesTexts& setZOrder(int32_t ZOrder) { DARABONBA_PTR_SET_VALUE(ZOrder_, ZOrder) };
