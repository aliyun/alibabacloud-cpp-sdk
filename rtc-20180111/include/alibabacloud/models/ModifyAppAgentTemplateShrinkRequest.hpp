...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentSilenceConfigShrink_ == nullptr
        ...
        && this->enableVideoUnderstanding_ == nullptr && this->greeting_ == nullptr && this->id_ == nullptr && this->interruptConfigShrink_ == nullptr && this->interruptMode_ == nullptr
        && this->llmConfigShrink_ == nullptr && this->name_ == nullptr && this->preferVideo_ == nullptr && this->ttsConfigShrink_ == nullptr && this->type_ == nullptr; };
    ...
    inline string getAgentSilenceConfigShrink() const { DARABONBA_PTR_GET_DEFAULT(agentSilenceConfigShrink_, "") };
    ...
    inline string getAmbientSoundConfigShrink() const { DARABONBA_PTR_GET_DEFAULT(ambientSoundConfigShrink_, "") };
    ...
    inline string getAsrConfigShrink() const { DARABONBA_PTR_GET_DEFAULT(asrConfigShrink_, "") };
    ...
    inline string getBackChannelConfigShrink() const { DARABONBA_PTR_GET_DEFAULT(backChannelConfigShrink_, "") };
    ...
    inline ModifyAppAgentTemplateShrinkRequest& setEnableVideoUnderstanding(bool enableVideoUnderstanding) { DARABONBA_PTR_SET_VALUE(enableVideoUnderstanding_, enableVideoUnderstanding) };
    ...
    inline string getLlmConfigShrink() const { DARABONBA_PTR_GET_DEFAULT(llmConfigShrink_, "") };
    ...
    inline ModifyAppAgentTemplateShrinkRequest& setPreferVideo(int32_t preferVideo) { DARABONBA_PTR_SET_VALUE(preferVideo_, preferVideo) };
  ...
  protected:
    shared_ptr<string> agentSilenceConfigShrink_ {};
    shared_ptr<string> ambientSoundConfigShrink_ {};
