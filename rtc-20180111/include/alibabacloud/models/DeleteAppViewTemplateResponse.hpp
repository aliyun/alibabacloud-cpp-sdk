...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAppViewTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAppViewTemplateResponseBody) };
    inline DeleteAppViewTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAppViewTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAppViewTemplateResponseBody> body_ {};
  };
