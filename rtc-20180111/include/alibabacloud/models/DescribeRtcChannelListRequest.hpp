...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->appId_ != nullptr
        && this->channelId_ != nullptr && this->ownerId_ != nullptr && this->pageNo_ != nullptr && this->pageSize_ != nullptr && this->serviceArea_ != nullptr
        && this->sortType_ != nullptr && this->timePoint_ != nullptr && this->userId_ != nullptr; };
