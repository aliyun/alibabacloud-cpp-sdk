...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeFaultDiagnosisOverallDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeFaultDiagnosisOverallDataResponseBody) };
    inline DescribeFaultDiagnosisOverallDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeFaultDiagnosisOverallDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeFaultDiagnosisOverallDataResponseBody> body_ {};
  };
