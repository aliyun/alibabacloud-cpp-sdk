...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCloudNotePhrasesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCloudNotePhrasesResponseBody) };
    inline ModifyCloudNotePhrasesResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCloudNotePhrasesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCloudNotePhrasesResponseBody> body_ {};
  };
