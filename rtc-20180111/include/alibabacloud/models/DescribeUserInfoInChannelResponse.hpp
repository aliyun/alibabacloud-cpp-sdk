...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserInfoInChannelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUserInfoInChannelResponseBody) };
    inline DescribeUserInfoInChannelResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUserInfoInChannelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUserInfoInChannelResponseBody> body_ {};
  };
