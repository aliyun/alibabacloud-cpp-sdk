...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ModifyViewLayoutShrinkRequest::Backgrounds> & getBackgrounds() const { DARABONBA_PTR_GET_CONST(backgrounds_, vector<ModifyViewLayoutShrinkRequest::Backgrounds>) };
    inline vector<ModifyViewLayoutShrinkRequest::Backgrounds> getBackgrounds() { DARABONBA_PTR_GET(backgrounds_, vector<ModifyViewLayoutShrinkRequest::Backgrounds>) };
    inline ModifyViewLayoutShrinkRequest& setBackgrounds(const vector<ModifyViewLayoutShrinkRequest::Backgrounds> & backgrounds) { DARABONBA_PTR_SET_VALUE(backgrounds_, backgrounds) };
    inline ModifyViewLayoutShrinkRequest& setBackgrounds(vector<ModifyViewLayoutShrinkRequest::Backgrounds> && backgrounds) { DARABONBA_PTR_SET_RVALUE(backgrounds_, backgrounds) };
    ...
    inline const vector<ModifyViewLayoutShrinkRequest::ClockWidgets> & getClockWidgets() const { DARABONBA_PTR_GET_CONST(clockWidgets_, vector<ModifyViewLayoutShrinkRequest::ClockWidgets>) };
    inline vector<ModifyViewLayoutShrinkRequest::ClockWidgets> getClockWidgets() { DARABONBA_PTR_GET(clockWidgets_, vector<ModifyViewLayoutShrinkRequest::ClockWidgets>) };
    inline ModifyViewLayoutShrinkRequest& setClockWidgets(const vector<ModifyViewLayoutShrinkRequest::ClockWidgets> & clockWidgets) { DARABONBA_PTR_SET_VALUE(clockWidgets_, clockWidgets) };
    inline ModifyViewLayoutShrinkRequest& setClockWidgets(vector<ModifyViewLayoutShrinkRequest::ClockWidgets> && clockWidgets) { DARABONBA_PTR_SET_RVALUE(clockWidgets_, clockWidgets) };


    // images Field Functions 
    bool hasImages() const { return this->images_ != nullptr;};
    void deleteImages() { this->images_ = nullptr;};
    inline const vector<ModifyViewLayoutShrinkRequest::Images> & getImages() const { DARABONBA_PTR_GET_CONST(images_, vector<ModifyViewLayoutShrinkRequest::Images>) };
    inline vector<ModifyViewLayoutShrinkRequest::Images> getImages() { DARABONBA_PTR_GET(images_, vector<ModifyViewLayoutShrinkRequest::Images>) };
    inline ModifyViewLayoutShrinkRequest& setImages(const vector<ModifyViewLayoutShrinkRequest::Images> & images) { DARABONBA_PTR_SET_VALUE(images_, images) };
    inline ModifyViewLayoutShrinkRequest& setImages(vector<ModifyViewLayoutShrinkRequest::Images> && images) { DARABONBA_PTR_SET_RVALUE(images_, images) };
    ...
    inline const vector<ModifyViewLayoutShrinkRequest::Panes> & getPanes() const { DARABONBA_PTR_GET_CONST(panes_, vector<ModifyViewLayoutShrinkRequest::Panes>) };
    inline vector<ModifyViewLayoutShrinkRequest::Panes> getPanes() { DARABONBA_PTR_GET(panes_, vector<ModifyViewLayoutShrinkRequest::Panes>) };
    inline ModifyViewLayoutShrinkRequest& setPanes(const vector<ModifyViewLayoutShrinkRequest::Panes> & panes) { DARABONBA_PTR_SET_VALUE(panes_, panes) };
    inline ModifyViewLayoutShrinkRequest& setPanes(vector<ModifyViewLayoutShrinkRequest::Panes> && panes) { DARABONBA_PTR_SET_RVALUE(panes_, panes) };
    ...
    bool hasTexts() const { return this->texts_ != nullptr;};
    void deleteTexts() { this->texts_ = nullptr;};
    inline const vector<ModifyViewLayoutShrinkRequest::Texts> & getTexts() const { DARABONBA_PTR_GET_CONST(texts_, vector<ModifyViewLayoutShrinkRequest::Texts>) };
    inline vector<ModifyViewLayoutShrinkRequest::Texts> getTexts() { DARABONBA_PTR_GET(texts_, vector<ModifyViewLayoutShrinkRequest::Texts>) };
    inline ModifyViewLayoutShrinkRequest& setTexts(const vector<ModifyViewLayoutShrinkRequest::Texts> & texts) { DARABONBA_PTR_SET_VALUE(texts_, texts) };
    inline ModifyViewLayoutShrinkRequest& setTexts(vector<ModifyViewLayoutShrinkRequest::Texts> && texts) { DARABONBA_PTR_SET_RVALUE(texts_, texts) };


  protected:
    // This parameter is required.
    shared_ptr<string> appId_ {};
    shared_ptr<vector<ModifyViewLayoutShrinkRequest::Backgrounds>> backgrounds_ {};
    // This parameter is required.
    shared_ptr<string> channelId_ {};
    shared_ptr<vector<ModifyViewLayoutShrinkRequest::ClockWidgets>> clockWidgets_ {};
    shared_ptr<vector<ModifyViewLayoutShrinkRequest::Images>> images_ {};
    shared_ptr<string> layoutSpecifiedUsersShrink_ {};
    shared_ptr<vector<ModifyViewLayoutShrinkRequest::Panes>> panes_ {};
    // This parameter is required.
    shared_ptr<string> taskId_ {};
    // This parameter is required.
    shared_ptr<string> templateId_ {};
    shared_ptr<vector<ModifyViewLayoutShrinkRequest::Texts>> texts_ {};
  };
