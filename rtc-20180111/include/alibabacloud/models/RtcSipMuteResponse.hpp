...
namespace Models
{
  ...
  public:
    ...
    inline const RtcSipMuteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RtcSipMuteResponseBody) };
    inline RtcSipMuteResponseBody getBody() { DARABONBA_PTR_GET(body_, RtcSipMuteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RtcSipMuteResponseBody> body_ {};
  };
