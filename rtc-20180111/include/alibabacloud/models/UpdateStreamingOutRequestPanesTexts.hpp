...
#ifndef ALIBABACLOUD_MODELS_UPDATESTREAMINGOUTREQUESTPANESTEXTS_HPP_
#define ALIBABACLOUD_MODELS_UPDATESTREAMINGOUTREQUESTPANESTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateStreamingOutRequestPanesTexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateStreamingOutRequestPanesTexts& obj) { 
    ...
    UpdateStreamingOutRequestPanesTexts() = default ;
    UpdateStreamingOutRequestPanesTexts(const UpdateStreamingOutRequestPanesTexts &) = default ;
    UpdateStreamingOutRequestPanesTexts(UpdateStreamingOutRequestPanesTexts &&) = default ;
    UpdateStreamingOutRequestPanesTexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateStreamingOutRequestPanesTexts() = default ;
    UpdateStreamingOutRequestPanesTexts& operator=(const UpdateStreamingOutRequestPanesTexts &) = default ;
    UpdateStreamingOutRequestPanesTexts& operator=(UpdateStreamingOutRequestPanesTexts &&) = default ;
    ...
    inline UpdateStreamingOutRequestPanesTexts& setAlpha(double alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline UpdateStreamingOutRequestPanesTexts& setBoxAlpha(double boxAlpha) { DARABONBA_PTR_SET_VALUE(boxAlpha_, boxAlpha) };
    ...
    inline UpdateStreamingOutRequestPanesTexts& setBoxBorderw(int32_t boxBorderw) { DARABONBA_PTR_SET_VALUE(boxBorderw_, boxBorderw) };


    // boxColor Field Functions 
    bool hasBoxColor() const { return this->boxColor_ != nullptr;};
    void deleteBoxColor() { this->boxColor_ = nullptr;};
    inline const Models::UpdateStreamingOutRequestPanesTextsBoxColor & boxColor() const { DARABONBA_PTR_GET_CONST(boxColor_, Models::UpdateStreamingOutRequestPanesTextsBoxColor) };
    inline Models::UpdateStreamingOutRequestPanesTextsBoxColor boxColor() { DARABONBA_PTR_GET(boxColor_, Models::UpdateStreamingOutRequestPanesTextsBoxColor) };
    inline UpdateStreamingOutRequestPanesTexts& setBoxColor(const Models::UpdateStreamingOutRequestPanesTextsBoxColor & boxColor) { DARABONBA_PTR_SET_VALUE(boxColor_, boxColor) };
    inline UpdateStreamingOutRequestPanesTexts& setBoxColor(Models::UpdateStreamingOutRequestPanesTextsBoxColor && boxColor) { DARABONBA_PTR_SET_RVALUE(boxColor_, boxColor) };
    ...
    inline UpdateStreamingOutRequestPanesTexts& setDisplay(string display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline UpdateStreamingOutRequestPanesTexts& setFont(int32_t font) { DARABONBA_PTR_SET_VALUE(font_, font) };
    ...
    inline const Models::UpdateStreamingOutRequestPanesTextsFontColor & fontColor() const { DARABONBA_PTR_GET_CONST(fontColor_, Models::UpdateStreamingOutRequestPanesTextsFontColor) };
    inline Models::UpdateStreamingOutRequestPanesTextsFontColor fontColor() { DARABONBA_PTR_GET(fontColor_, Models::UpdateStreamingOutRequestPanesTextsFontColor) };
    inline UpdateStreamingOutRequestPanesTexts& setFontColor(const Models::UpdateStreamingOutRequestPanesTextsFontColor & fontColor) { DARABONBA_PTR_SET_VALUE(fontColor_, fontColor) };
    inline UpdateStreamingOutRequestPanesTexts& setFontColor(Models::UpdateStreamingOutRequestPanesTextsFontColor && fontColor) { DARABONBA_PTR_SET_RVALUE(fontColor_, fontColor) };
    ...
    inline UpdateStreamingOutRequestPanesTexts& setFontSize(int32_t fontSize) { DARABONBA_PTR_SET_VALUE(fontSize_, fontSize) };
    ...
    inline UpdateStreamingOutRequestPanesTexts& setHasBox(bool hasBox) { DARABONBA_PTR_SET_VALUE(hasBox_, hasBox) };
    ...
    inline UpdateStreamingOutRequestPanesTexts& setLayer(int32_t layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline UpdateStreamingOutRequestPanesTexts& setTexture(string texture) { DARABONBA_PTR_SET_VALUE(texture_, texture) };
    ...
    inline UpdateStreamingOutRequestPanesTexts& setX(double x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline UpdateStreamingOutRequestPanesTexts& setY(double y) { DARABONBA_PTR_SET_VALUE(y_, y) };
  ...
  protected:
    ...
    std::shared_ptr<Models::UpdateStreamingOutRequestPanesTextsBoxColor> boxColor_ = nullptr;
    std::shared_ptr<string> display_ = nullptr;
    std::shared_ptr<int32_t> font_ = nullptr;
    std::shared_ptr<Models::UpdateStreamingOutRequestPanesTextsFontColor> fontColor_ = nullptr;
