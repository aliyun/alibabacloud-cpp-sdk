...
namespace Models
{
  ...
  public:
    ...
    inline const DisableAutoLiveStreamRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableAutoLiveStreamRuleResponseBody) };
    inline DisableAutoLiveStreamRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableAutoLiveStreamRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableAutoLiveStreamRuleResponseBody> body_ {};
  };
