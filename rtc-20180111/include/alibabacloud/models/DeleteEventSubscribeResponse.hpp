...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteEventSubscribeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteEventSubscribeResponseBody) };
    inline DeleteEventSubscribeResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteEventSubscribeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteEventSubscribeResponseBody> body_ {};
  };
