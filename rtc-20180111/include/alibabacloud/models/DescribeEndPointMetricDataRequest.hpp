...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->channelId_ == nullptr && this->createdTs_ == nullptr && this->destroyedTs_ == nullptr && this->metrics_ == nullptr && this->pubCallIdList_ == nullptr
        && this->pubUserId_ == nullptr && this->subUserId_ == nullptr; };
    ...
    inline string getPubCallIdList() const { DARABONBA_PTR_GET_DEFAULT(pubCallIdList_, "") };
    ...
    inline string getPubUserId() const { DARABONBA_PTR_GET_DEFAULT(pubUserId_, "") };
  ...
  protected:
    ...
    shared_ptr<string> pubCallIdList_ {};
    shared_ptr<string> pubUserId_ {};
