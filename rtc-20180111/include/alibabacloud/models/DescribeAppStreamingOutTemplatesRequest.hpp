...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAppStreamingOutTemplatesRequest::Condition & getCondition() const { DARABONBA_PTR_GET_CONST(condition_, DescribeAppStreamingOutTemplatesRequest::Condition) };
    inline DescribeAppStreamingOutTemplatesRequest::Condition getCondition() { DARABONBA_PTR_GET(condition_, DescribeAppStreamingOutTemplatesRequest::Condition) };
    inline DescribeAppStreamingOutTemplatesRequest& setCondition(const DescribeAppStreamingOutTemplatesRequest::Condition & condition) { DARABONBA_PTR_SET_VALUE(condition_, condition) };
    inline DescribeAppStreamingOutTemplatesRequest& setCondition(DescribeAppStreamingOutTemplatesRequest::Condition && condition) { DARABONBA_PTR_SET_RVALUE(condition_, condition) };
  ...
  protected:
    ...
    shared_ptr<DescribeAppStreamingOutTemplatesRequest::Condition> condition_ {};
