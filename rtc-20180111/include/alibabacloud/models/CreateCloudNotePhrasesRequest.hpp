...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCloudNotePhrasesRequest::Phrase & getPhrase() const { DARABONBA_PTR_GET_CONST(phrase_, CreateCloudNotePhrasesRequest::Phrase) };
    inline CreateCloudNotePhrasesRequest::Phrase getPhrase() { DARABONBA_PTR_GET(phrase_, CreateCloudNotePhrasesRequest::Phrase) };
    inline CreateCloudNotePhrasesRequest& setPhrase(const CreateCloudNotePhrasesRequest::Phrase & phrase) { DARABONBA_PTR_SET_VALUE(phrase_, phrase) };
    inline CreateCloudNotePhrasesRequest& setPhrase(CreateCloudNotePhrasesRequest::Phrase && phrase) { DARABONBA_PTR_SET_RVALUE(phrase_, phrase) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<CreateCloudNotePhrasesRequest::Phrase> phrase_ {};
  };
