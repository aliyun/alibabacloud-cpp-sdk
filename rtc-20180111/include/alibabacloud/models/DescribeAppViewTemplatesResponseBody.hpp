...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAppViewTemplatesResponseBody::Templates> & getTemplates() const { DARABONBA_PTR_GET_CONST(templates_, vector<DescribeAppViewTemplatesResponseBody::Templates>) };
    inline vector<DescribeAppViewTemplatesResponseBody::Templates> getTemplates() { DARABONBA_PTR_GET(templates_, vector<DescribeAppViewTemplatesResponseBody::Templates>) };
    inline DescribeAppViewTemplatesResponseBody& setTemplates(const vector<DescribeAppViewTemplatesResponseBody::Templates> & templates) { DARABONBA_PTR_SET_VALUE(templates_, templates) };
    inline DescribeAppViewTemplatesResponseBody& setTemplates(vector<DescribeAppViewTemplatesResponseBody::Templates> && templates) { DARABONBA_PTR_SET_RVALUE(templates_, templates) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeAppViewTemplatesResponseBody::Templates>> templates_ {};
