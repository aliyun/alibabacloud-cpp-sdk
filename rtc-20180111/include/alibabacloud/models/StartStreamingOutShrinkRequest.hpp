...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->annotation_ == nullptr
        ...
        && return this->cropMode_ == nullptr && return this->images_ == nullptr && return this->layoutSpecifiedUsersShrink_ == nullptr && return this->panes_ == nullptr && return this->regionColor_ == nullptr
