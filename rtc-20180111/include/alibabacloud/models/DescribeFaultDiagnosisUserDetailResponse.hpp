...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeFaultDiagnosisUserDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeFaultDiagnosisUserDetailResponseBody) };
    inline DescribeFaultDiagnosisUserDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeFaultDiagnosisUserDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeFaultDiagnosisUserDetailResponseBody> body_ {};
  };
