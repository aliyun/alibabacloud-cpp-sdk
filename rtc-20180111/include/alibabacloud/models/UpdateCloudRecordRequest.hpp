...
namespace Models
{
  ...
  public:
    ...
    bool hasBackgrounds() const { return this->backgrounds_ != nullptr;};
    void deleteBackgrounds() { this->backgrounds_ = nullptr;};
    inline const vector<UpdateCloudRecordRequest::Backgrounds> & getBackgrounds() const { DARABONBA_PTR_GET_CONST(backgrounds_, vector<UpdateCloudRecordRequest::Backgrounds>) };
    inline vector<UpdateCloudRecordRequest::Backgrounds> getBackgrounds() { DARABONBA_PTR_GET(backgrounds_, vector<UpdateCloudRecordRequest::Backgrounds>) };
    inline UpdateCloudRecordRequest& setBackgrounds(const vector<UpdateCloudRecordRequest::Backgrounds> & backgrounds) { DARABONBA_PTR_SET_VALUE(backgrounds_, backgrounds) };
    inline UpdateCloudRecordRequest& setBackgrounds(vector<UpdateCloudRecordRequest::Backgrounds> && backgrounds) { DARABONBA_PTR_SET_RVALUE(backgrounds_, backgrounds) };
    ...
    inline const vector<UpdateCloudRecordRequest::ClockWidgets> & getClockWidgets() const { DARABONBA_PTR_GET_CONST(clockWidgets_, vector<UpdateCloudRecordRequest::ClockWidgets>) };
    inline vector<UpdateCloudRecordRequest::ClockWidgets> getClockWidgets() { DARABONBA_PTR_GET(clockWidgets_, vector<UpdateCloudRecordRequest::ClockWidgets>) };
    inline UpdateCloudRecordRequest& setClockWidgets(const vector<UpdateCloudRecordRequest::ClockWidgets> & clockWidgets) { DARABONBA_PTR_SET_VALUE(clockWidgets_, clockWidgets) };
    inline UpdateCloudRecordRequest& setClockWidgets(vector<UpdateCloudRecordRequest::ClockWidgets> && clockWidgets) { DARABONBA_PTR_SET_RVALUE(clockWidgets_, clockWidgets) };


    // images Field Functions 
    bool hasImages() const { return this->images_ != nullptr;};
    void deleteImages() { this->images_ = nullptr;};
    inline const vector<UpdateCloudRecordRequest::Images> & getImages() const { DARABONBA_PTR_GET_CONST(images_, vector<UpdateCloudRecordRequest::Images>) };
    inline vector<UpdateCloudRecordRequest::Images> getImages() { DARABONBA_PTR_GET(images_, vector<UpdateCloudRecordRequest::Images>) };
    inline UpdateCloudRecordRequest& setImages(const vector<UpdateCloudRecordRequest::Images> & images) { DARABONBA_PTR_SET_VALUE(images_, images) };
    inline UpdateCloudRecordRequest& setImages(vector<UpdateCloudRecordRequest::Images> && images) { DARABONBA_PTR_SET_RVALUE(images_, images) };
    ...
    inline const UpdateCloudRecordRequest::LayoutSpecifiedUsers & getLayoutSpecifiedUsers() const { DARABONBA_PTR_GET_CONST(layoutSpecifiedUsers_, UpdateCloudRecordRequest::LayoutSpecifiedUsers) };
    inline UpdateCloudRecordRequest::LayoutSpecifiedUsers getLayoutSpecifiedUsers() { DARABONBA_PTR_GET(layoutSpecifiedUsers_, UpdateCloudRecordRequest::LayoutSpecifiedUsers) };
    inline UpdateCloudRecordRequest& setLayoutSpecifiedUsers(const UpdateCloudRecordRequest::LayoutSpecifiedUsers & layoutSpecifiedUsers) { DARABONBA_PTR_SET_VALUE(layoutSpecifiedUsers_, layoutSpecifiedUsers) };
    inline UpdateCloudRecordRequest& setLayoutSpecifiedUsers(UpdateCloudRecordRequest::LayoutSpecifiedUsers && layoutSpecifiedUsers) { DARABONBA_PTR_SET_RVALUE(layoutSpecifiedUsers_, layoutSpecifiedUsers) };


    // panes Field Functions 
    bool hasPanes() const { return this->panes_ != nullptr;};
    void deletePanes() { this->panes_ = nullptr;};
    inline const vector<UpdateCloudRecordRequest::Panes> & getPanes() const { DARABONBA_PTR_GET_CONST(panes_, vector<UpdateCloudRecordRequest::Panes>) };
    inline vector<UpdateCloudRecordRequest::Panes> getPanes() { DARABONBA_PTR_GET(panes_, vector<UpdateCloudRecordRequest::Panes>) };
    inline UpdateCloudRecordRequest& setPanes(const vector<UpdateCloudRecordRequest::Panes> & panes) { DARABONBA_PTR_SET_VALUE(panes_, panes) };
    inline UpdateCloudRecordRequest& setPanes(vector<UpdateCloudRecordRequest::Panes> && panes) { DARABONBA_PTR_SET_RVALUE(panes_, panes) };
    ...
    bool hasTexts() const { return this->texts_ != nullptr;};
    void deleteTexts() { this->texts_ = nullptr;};
    inline const vector<UpdateCloudRecordRequest::Texts> & getTexts() const { DARABONBA_PTR_GET_CONST(texts_, vector<UpdateCloudRecordRequest::Texts>) };
    inline vector<UpdateCloudRecordRequest::Texts> getTexts() { DARABONBA_PTR_GET(texts_, vector<UpdateCloudRecordRequest::Texts>) };
    inline UpdateCloudRecordRequest& setTexts(const vector<UpdateCloudRecordRequest::Texts> & texts) { DARABONBA_PTR_SET_VALUE(texts_, texts) };
    inline UpdateCloudRecordRequest& setTexts(vector<UpdateCloudRecordRequest::Texts> && texts) { DARABONBA_PTR_SET_RVALUE(texts_, texts) };


  protected:
    // This parameter is required.
    shared_ptr<string> appId_ {};
    shared_ptr<vector<UpdateCloudRecordRequest::Backgrounds>> backgrounds_ {};
    // This parameter is required.
    shared_ptr<string> channelId_ {};
    shared_ptr<vector<UpdateCloudRecordRequest::ClockWidgets>> clockWidgets_ {};
    shared_ptr<vector<UpdateCloudRecordRequest::Images>> images_ {};
    shared_ptr<UpdateCloudRecordRequest::LayoutSpecifiedUsers> layoutSpecifiedUsers_ {};
    shared_ptr<vector<UpdateCloudRecordRequest::Panes>> panes_ {};
    // This parameter is required.
    shared_ptr<string> taskId_ {};
    // This parameter is required.
    shared_ptr<string> templateId_ {};
    shared_ptr<vector<UpdateCloudRecordRequest::Texts>> texts_ {};
  };
