...
#ifndef ALIBABACLOUD_MODELS_CREATEAPPSTREAMINGOUTTEMPLATESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEAPPSTREAMINGOUTTEMPLATESHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateAppStreamingOutTemplateShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AppId, appId_);
      DARABONBA_PTR_TO_JSON(StreamingOutTemplate, streamingOutTemplateShrink_);
    };
    friend void from_json(const Darabonba::Json& j, CreateAppStreamingOutTemplateShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AppId, appId_);
      DARABONBA_PTR_FROM_JSON(StreamingOutTemplate, streamingOutTemplateShrink_);
    };
    CreateAppStreamingOutTemplateShrinkRequest() = default ;
    CreateAppStreamingOutTemplateShrinkRequest(const CreateAppStreamingOutTemplateShrinkRequest &) = default ;
    CreateAppStreamingOutTemplateShrinkRequest(CreateAppStreamingOutTemplateShrinkRequest &&) = default ;
    CreateAppStreamingOutTemplateShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAppStreamingOutTemplateShrinkRequest() = default ;
    CreateAppStreamingOutTemplateShrinkRequest& operator=(const CreateAppStreamingOutTemplateShrinkRequest &) = default ;
    CreateAppStreamingOutTemplateShrinkRequest& operator=(CreateAppStreamingOutTemplateShrinkRequest &&) = default ;
