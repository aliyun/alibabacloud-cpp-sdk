...
#ifndef ALIBABACLOUD_MODELS_STARTMPUTASKREQUESTWATERMARKS_HPP_
#define ALIBABACLOUD_MODELS_STARTMPUTASKREQUESTWATERMARKS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartMPUTaskRequestWatermarks& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartMPUTaskRequestWatermarks& obj) { 
    ...
    StartMPUTaskRequestWatermarks() = default ;
    StartMPUTaskRequestWatermarks(const StartMPUTaskRequestWatermarks &) = default ;
    StartMPUTaskRequestWatermarks(StartMPUTaskRequestWatermarks &&) = default ;
    StartMPUTaskRequestWatermarks(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartMPUTaskRequestWatermarks() = default ;
    StartMPUTaskRequestWatermarks& operator=(const StartMPUTaskRequestWatermarks &) = default ;
    StartMPUTaskRequestWatermarks& operator=(StartMPUTaskRequestWatermarks &&) = default ;
    ...
    inline StartMPUTaskRequestWatermarks& setAlpha(float alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline StartMPUTaskRequestWatermarks& setDisplay(int32_t display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline StartMPUTaskRequestWatermarks& setHeight(float height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline StartMPUTaskRequestWatermarks& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
    ...
    inline StartMPUTaskRequestWatermarks& setWidth(float width) { DARABONBA_PTR_SET_VALUE(width_, width) };
    ...
    inline StartMPUTaskRequestWatermarks& setX(float x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline StartMPUTaskRequestWatermarks& setY(float y) { DARABONBA_PTR_SET_VALUE(y_, y) };
    ...
    inline StartMPUTaskRequestWatermarks& setZOrder(int32_t ZOrder) { DARABONBA_PTR_SET_VALUE(ZOrder_, ZOrder) };
