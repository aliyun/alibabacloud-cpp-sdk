...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRecordTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateRecordTaskResponseBody) };
    inline UpdateRecordTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateRecordTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateRecordTaskResponseBody> body_ {};
  };
