...
#ifndef ALIBABACLOUD_MODELS_UPDATEMPUTASKREQUESTCLOCKWIDGETS_HPP_
#define ALIBABACLOUD_MODELS_UPDATEMPUTASKREQUESTCLOCKWIDGETS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateMPUTaskRequestClockWidgets& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateMPUTaskRequestClockWidgets& obj) { 
    ...
    UpdateMPUTaskRequestClockWidgets() = default ;
    UpdateMPUTaskRequestClockWidgets(const UpdateMPUTaskRequestClockWidgets &) = default ;
    UpdateMPUTaskRequestClockWidgets(UpdateMPUTaskRequestClockWidgets &&) = default ;
    UpdateMPUTaskRequestClockWidgets(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateMPUTaskRequestClockWidgets() = default ;
    UpdateMPUTaskRequestClockWidgets& operator=(const UpdateMPUTaskRequestClockWidgets &) = default ;
    UpdateMPUTaskRequestClockWidgets& operator=(UpdateMPUTaskRequestClockWidgets &&) = default ;
    ...
    virtual bool empty() const override { return this->alpha_ == nullptr
        ...
        && return this->fontColor_ == nullptr && return this->fontSize_ == nullptr && return this->fontType_ == nullptr && return this->x_ == nullptr && return this->y_ == nullptr
    ...
    inline UpdateMPUTaskRequestClockWidgets& setAlpha(float alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline UpdateMPUTaskRequestClockWidgets& setBorderColor(int64_t borderColor) { DARABONBA_PTR_SET_VALUE(borderColor_, borderColor) };
    ...
    inline UpdateMPUTaskRequestClockWidgets& setBorderWidth(int32_t borderWidth) { DARABONBA_PTR_SET_VALUE(borderWidth_, borderWidth) };
    ...
    inline UpdateMPUTaskRequestClockWidgets& setBox(bool box) { DARABONBA_PTR_SET_VALUE(box_, box) };
    ...
    inline UpdateMPUTaskRequestClockWidgets& setBoxBorderWidth(int32_t boxBorderWidth) { DARABONBA_PTR_SET_VALUE(boxBorderWidth_, boxBorderWidth) };
    ...
    inline UpdateMPUTaskRequestClockWidgets& setBoxColor(int64_t boxColor) { DARABONBA_PTR_SET_VALUE(boxColor_, boxColor) };
    ...
    inline UpdateMPUTaskRequestClockWidgets& setFontColor(int32_t fontColor) { DARABONBA_PTR_SET_VALUE(fontColor_, fontColor) };
    ...
    inline UpdateMPUTaskRequestClockWidgets& setFontSize(int32_t fontSize) { DARABONBA_PTR_SET_VALUE(fontSize_, fontSize) };
    ...
    inline UpdateMPUTaskRequestClockWidgets& setFontType(int32_t fontType) { DARABONBA_PTR_SET_VALUE(fontType_, fontType) };
    ...
    inline UpdateMPUTaskRequestClockWidgets& setX(float x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline UpdateMPUTaskRequestClockWidgets& setY(float y) { DARABONBA_PTR_SET_VALUE(y_, y) };
    ...
    inline UpdateMPUTaskRequestClockWidgets& setZOrder(int32_t ZOrder) { DARABONBA_PTR_SET_VALUE(ZOrder_, ZOrder) };
