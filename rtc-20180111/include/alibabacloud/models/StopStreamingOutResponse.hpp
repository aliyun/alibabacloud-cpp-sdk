...
namespace Models
{
  ...
  public:
    ...
    inline const StopStreamingOutResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopStreamingOutResponseBody) };
    inline StopStreamingOutResponseBody getBody() { DARABONBA_PTR_GET(body_, StopStreamingOutResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopStreamingOutResponseBody> body_ {};
  };
