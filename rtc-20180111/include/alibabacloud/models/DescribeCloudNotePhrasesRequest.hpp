...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Condition& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline const DescribeCloudNotePhrasesRequest::Condition & getCondition() const { DARABONBA_PTR_GET_CONST(condition_, DescribeCloudNotePhrasesRequest::Condition) };
    inline DescribeCloudNotePhrasesRequest::Condition getCondition() { DARABONBA_PTR_GET(condition_, DescribeCloudNotePhrasesRequest::Condition) };
    inline DescribeCloudNotePhrasesRequest& setCondition(const DescribeCloudNotePhrasesRequest::Condition & condition) { DARABONBA_PTR_SET_VALUE(condition_, condition) };
    inline DescribeCloudNotePhrasesRequest& setCondition(DescribeCloudNotePhrasesRequest::Condition && condition) { DARABONBA_PTR_SET_RVALUE(condition_, condition) };
  ...
  protected:
    ...
    shared_ptr<DescribeCloudNotePhrasesRequest::Condition> condition_ {};
