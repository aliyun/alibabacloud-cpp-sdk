...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudNotePhrasesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCloudNotePhrasesResponseBody) };
    inline DescribeCloudNotePhrasesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCloudNotePhrasesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCloudNotePhrasesResponseBody> body_ {};
  };
