...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSystemLayoutListResponseBodyLayouts & layouts() const { DARABONBA_PTR_GET_CONST(layouts_, DescribeSystemLayoutListResponseBodyLayouts) };
    inline DescribeSystemLayoutListResponseBodyLayouts layouts() { DARABONBA_PTR_GET(layouts_, DescribeSystemLayoutListResponseBodyLayouts) };
    inline DescribeSystemLayoutListResponseBody& setLayouts(const DescribeSystemLayoutListResponseBodyLayouts & layouts) { DARABONBA_PTR_SET_VALUE(layouts_, layouts) };
    inline DescribeSystemLayoutListResponseBody& setLayouts(DescribeSystemLayoutListResponseBodyLayouts && layouts) { DARABONBA_PTR_SET_RVALUE(layouts_, layouts) };
  ...
  protected:
    std::shared_ptr<DescribeSystemLayoutListResponseBodyLayouts> layouts_ = nullptr;
