...
#ifndef ALIBABACLOUD_MODELS_STARTCLOUDRECORDREQUESTIMAGES_HPP_
#define ALIBABACLOUD_MODELS_STARTCLOUDRECORDREQUESTIMAGES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartCloudRecordRequestImages& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartCloudRecordRequestImages& obj) { 
    ...
    StartCloudRecordRequestImages() = default ;
    StartCloudRecordRequestImages(const StartCloudRecordRequestImages &) = default ;
    StartCloudRecordRequestImages(StartCloudRecordRequestImages &&) = default ;
    StartCloudRecordRequestImages(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartCloudRecordRequestImages() = default ;
    StartCloudRecordRequestImages& operator=(const StartCloudRecordRequestImages &) = default ;
    StartCloudRecordRequestImages& operator=(StartCloudRecordRequestImages &&) = default ;
    ...
    inline StartCloudRecordRequestImages& setAlpha(double alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline StartCloudRecordRequestImages& setHeight(double height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline StartCloudRecordRequestImages& setImageCropMode(int32_t imageCropMode) { DARABONBA_PTR_SET_VALUE(imageCropMode_, imageCropMode) };
    ...
    inline StartCloudRecordRequestImages& setLayer(int32_t layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline StartCloudRecordRequestImages& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
    ...
    inline StartCloudRecordRequestImages& setWidth(double width) { DARABONBA_PTR_SET_VALUE(width_, width) };
    ...
    inline StartCloudRecordRequestImages& setX(double x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline StartCloudRecordRequestImages& setY(double y) { DARABONBA_PTR_SET_VALUE(y_, y) };
