...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateCloudRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateCloudRecordResponseBody) };
    inline UpdateCloudRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateCloudRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateCloudRecordResponseBody> body_ {};
  };
