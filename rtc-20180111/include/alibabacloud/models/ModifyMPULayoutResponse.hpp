...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyMPULayoutResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyMPULayoutResponseBody) };
    inline ModifyMPULayoutResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyMPULayoutResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyMPULayoutResponseBody> body_ {};
  };
