...
namespace Models
{
  ...
  public:
    ...
    bool hasBackgrounds() const { return this->backgrounds_ != nullptr;};
    void deleteBackgrounds() { this->backgrounds_ = nullptr;};
    inline const vector<UpdateCloudRecordShrinkRequest::Backgrounds> & getBackgrounds() const { DARABONBA_PTR_GET_CONST(backgrounds_, vector<UpdateCloudRecordShrinkRequest::Backgrounds>) };
    inline vector<UpdateCloudRecordShrinkRequest::Backgrounds> getBackgrounds() { DARABONBA_PTR_GET(backgrounds_, vector<UpdateCloudRecordShrinkRequest::Backgrounds>) };
    inline UpdateCloudRecordShrinkRequest& setBackgrounds(const vector<UpdateCloudRecordShrinkRequest::Backgrounds> & backgrounds) { DARABONBA_PTR_SET_VALUE(backgrounds_, backgrounds) };
    inline UpdateCloudRecordShrinkRequest& setBackgrounds(vector<UpdateCloudRecordShrinkRequest::Backgrounds> && backgrounds) { DARABONBA_PTR_SET_RVALUE(backgrounds_, backgrounds) };
    ...
    inline const vector<UpdateCloudRecordShrinkRequest::ClockWidgets> & getClockWidgets() const { DARABONBA_PTR_GET_CONST(clockWidgets_, vector<UpdateCloudRecordShrinkRequest::ClockWidgets>) };
    inline vector<UpdateCloudRecordShrinkRequest::ClockWidgets> getClockWidgets() { DARABONBA_PTR_GET(clockWidgets_, vector<UpdateCloudRecordShrinkRequest::ClockWidgets>) };
    inline UpdateCloudRecordShrinkRequest& setClockWidgets(const vector<UpdateCloudRecordShrinkRequest::ClockWidgets> & clockWidgets) { DARABONBA_PTR_SET_VALUE(clockWidgets_, clockWidgets) };
    inline UpdateCloudRecordShrinkRequest& setClockWidgets(vector<UpdateCloudRecordShrinkRequest::ClockWidgets> && clockWidgets) { DARABONBA_PTR_SET_RVALUE(clockWidgets_, clockWidgets) };


    // images Field Functions 
    bool hasImages() const { return this->images_ != nullptr;};
    void deleteImages() { this->images_ = nullptr;};
    inline const vector<UpdateCloudRecordShrinkRequest::Images> & getImages() const { DARABONBA_PTR_GET_CONST(images_, vector<UpdateCloudRecordShrinkRequest::Images>) };
    inline vector<UpdateCloudRecordShrinkRequest::Images> getImages() { DARABONBA_PTR_GET(images_, vector<UpdateCloudRecordShrinkRequest::Images>) };
    inline UpdateCloudRecordShrinkRequest& setImages(const vector<UpdateCloudRecordShrinkRequest::Images> & images) { DARABONBA_PTR_SET_VALUE(images_, images) };
    inline UpdateCloudRecordShrinkRequest& setImages(vector<UpdateCloudRecordShrinkRequest::Images> && images) { DARABONBA_PTR_SET_RVALUE(images_, images) };
    ...
    inline const vector<UpdateCloudRecordShrinkRequest::Panes> & getPanes() const { DARABONBA_PTR_GET_CONST(panes_, vector<UpdateCloudRecordShrinkRequest::Panes>) };
    inline vector<UpdateCloudRecordShrinkRequest::Panes> getPanes() { DARABONBA_PTR_GET(panes_, vector<UpdateCloudRecordShrinkRequest::Panes>) };
    inline UpdateCloudRecordShrinkRequest& setPanes(const vector<UpdateCloudRecordShrinkRequest::Panes> & panes) { DARABONBA_PTR_SET_VALUE(panes_, panes) };
    inline UpdateCloudRecordShrinkRequest& setPanes(vector<UpdateCloudRecordShrinkRequest::Panes> && panes) { DARABONBA_PTR_SET_RVALUE(panes_, panes) };
    ...
    bool hasTexts() const { return this->texts_ != nullptr;};
    void deleteTexts() { this->texts_ = nullptr;};
    inline const vector<UpdateCloudRecordShrinkRequest::Texts> & getTexts() const { DARABONBA_PTR_GET_CONST(texts_, vector<UpdateCloudRecordShrinkRequest::Texts>) };
    inline vector<UpdateCloudRecordShrinkRequest::Texts> getTexts() { DARABONBA_PTR_GET(texts_, vector<UpdateCloudRecordShrinkRequest::Texts>) };
    inline UpdateCloudRecordShrinkRequest& setTexts(const vector<UpdateCloudRecordShrinkRequest::Texts> & texts) { DARABONBA_PTR_SET_VALUE(texts_, texts) };
    inline UpdateCloudRecordShrinkRequest& setTexts(vector<UpdateCloudRecordShrinkRequest::Texts> && texts) { DARABONBA_PTR_SET_RVALUE(texts_, texts) };


  protected:
    // This parameter is required.
    shared_ptr<string> appId_ {};
    shared_ptr<vector<UpdateCloudRecordShrinkRequest::Backgrounds>> backgrounds_ {};
    // This parameter is required.
    shared_ptr<string> channelId_ {};
    shared_ptr<vector<UpdateCloudRecordShrinkRequest::ClockWidgets>> clockWidgets_ {};
    shared_ptr<vector<UpdateCloudRecordShrinkRequest::Images>> images_ {};
    shared_ptr<string> layoutSpecifiedUsersShrink_ {};
    shared_ptr<vector<UpdateCloudRecordShrinkRequest::Panes>> panes_ {};
    // This parameter is required.
    shared_ptr<string> taskId_ {};
    // This parameter is required.
    shared_ptr<string> templateId_ {};
    shared_ptr<vector<UpdateCloudRecordShrinkRequest::Texts>> texts_ {};
  };
