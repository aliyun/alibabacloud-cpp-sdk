...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUsageOsSdkVersionDistributionStatDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUsageOsSdkVersionDistributionStatDataResponseBody) };
    inline DescribeUsageOsSdkVersionDistributionStatDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUsageOsSdkVersionDistributionStatDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUsageOsSdkVersionDistributionStatDataResponseBody> body_ {};
  };
