...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeCloudNotesResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeCloudNotesResponseBodyItems>) };
    inline vector<DescribeCloudNotesResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeCloudNotesResponseBodyItems>) };
    inline DescribeCloudNotesResponseBody& setItems(const vector<DescribeCloudNotesResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeCloudNotesResponseBody& setItems(vector<DescribeCloudNotesResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    std::shared_ptr<vector<DescribeCloudNotesResponseBodyItems>> items_ = nullptr;
