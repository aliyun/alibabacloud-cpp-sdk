...
#ifndef ALIBABACLOUD_MODELS_MODIFYAPPLAYOUTSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MODIFYAPPLAYOUTSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyAppLayoutShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AppId, appId_);
      DARABONBA_PTR_TO_JSON(ClientToken, clientToken_);
      DARABONBA_PTR_TO_JSON(Layout, layoutShrink_);
    };
    friend void from_json(const Darabonba::Json& j, ModifyAppLayoutShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AppId, appId_);
      DARABONBA_PTR_FROM_JSON(ClientToken, clientToken_);
      DARABONBA_PTR_FROM_JSON(Layout, layoutShrink_);
    };
    ModifyAppLayoutShrinkRequest() = default ;
    ModifyAppLayoutShrinkRequest(const ModifyAppLayoutShrinkRequest &) = default ;
    ModifyAppLayoutShrinkRequest(ModifyAppLayoutShrinkRequest &&) = default ;
    ModifyAppLayoutShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyAppLayoutShrinkRequest() = default ;
    ModifyAppLayoutShrinkRequest& operator=(const ModifyAppLayoutShrinkRequest &) = default ;
    ModifyAppLayoutShrinkRequest& operator=(ModifyAppLayoutShrinkRequest &&) = default ;
