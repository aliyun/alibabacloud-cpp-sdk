...
namespace Models
{
  ...
  public:
    ...
    inline const StartCategoryCallbackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartCategoryCallbackResponseBody) };
    inline StartCategoryCallbackResponseBody getBody() { DARABONBA_PTR_GET(body_, StartCategoryCallbackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartCategoryCallbackResponseBody> body_ {};
  };
