...
#ifndef ALIBABACLOUD_MODELS_CREATEMPULAYOUTREQUESTPANES_HPP_
#define ALIBABACLOUD_MODELS_CREATEMPULAYOUTREQUESTPANES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateMPULayoutRequestPanes& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateMPULayoutRequestPanes& obj) { 
    ...
    CreateMPULayoutRequestPanes() = default ;
    CreateMPULayoutRequestPanes(const CreateMPULayoutRequestPanes &) = default ;
    CreateMPULayoutRequestPanes(CreateMPULayoutRequestPanes &&) = default ;
    CreateMPULayoutRequestPanes(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateMPULayoutRequestPanes() = default ;
    CreateMPULayoutRequestPanes& operator=(const CreateMPULayoutRequestPanes &) = default ;
    CreateMPULayoutRequestPanes& operator=(CreateMPULayoutRequestPanes &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->height_ == nullptr
        && return this->majorPane_ == nullptr && return this->paneId_ == nullptr && return this->width_ == nullptr && return this->x_ == nullptr && return this->y_ == nullptr
        && return this->ZOrder_ == nullptr; };
    // height Field Functions 
    bool hasHeight() const { return this->height_ != nullptr;};
    void deleteHeight() { this->height_ = nullptr;};
    inline float height() const { DARABONBA_PTR_GET_DEFAULT(height_, 0.0) };
    inline CreateMPULayoutRequestPanes& setHeight(float height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline CreateMPULayoutRequestPanes& setMajorPane(int32_t majorPane) { DARABONBA_PTR_SET_VALUE(majorPane_, majorPane) };
    ...
    inline CreateMPULayoutRequestPanes& setPaneId(int32_t paneId) { DARABONBA_PTR_SET_VALUE(paneId_, paneId) };
    ...
    inline CreateMPULayoutRequestPanes& setWidth(float width) { DARABONBA_PTR_SET_VALUE(width_, width) };
    ...
    inline CreateMPULayoutRequestPanes& setX(float x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline CreateMPULayoutRequestPanes& setY(float y) { DARABONBA_PTR_SET_VALUE(y_, y) };
    ...
    inline CreateMPULayoutRequestPanes& setZOrder(int32_t ZOrder) { DARABONBA_PTR_SET_VALUE(ZOrder_, ZOrder) };
