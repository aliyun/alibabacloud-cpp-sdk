...
#ifndef ALIBABACLOUD_MODELS_STARTCLOUDRECORDREQUESTPANESTEXTS_HPP_
#define ALIBABACLOUD_MODELS_STARTCLOUDRECORDREQUESTPANESTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartCloudRecordRequestPanesTexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartCloudRecordRequestPanesTexts& obj) { 
    ...
    StartCloudRecordRequestPanesTexts() = default ;
    StartCloudRecordRequestPanesTexts(const StartCloudRecordRequestPanesTexts &) = default ;
    StartCloudRecordRequestPanesTexts(StartCloudRecordRequestPanesTexts &&) = default ;
    StartCloudRecordRequestPanesTexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartCloudRecordRequestPanesTexts() = default ;
    StartCloudRecordRequestPanesTexts& operator=(const StartCloudRecordRequestPanesTexts &) = default ;
    StartCloudRecordRequestPanesTexts& operator=(StartCloudRecordRequestPanesTexts &&) = default ;
    ...
    inline StartCloudRecordRequestPanesTexts& setAlpha(double alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline StartCloudRecordRequestPanesTexts& setBoxAlpha(double boxAlpha) { DARABONBA_PTR_SET_VALUE(boxAlpha_, boxAlpha) };
    ...
    inline StartCloudRecordRequestPanesTexts& setBoxBorderw(int32_t boxBorderw) { DARABONBA_PTR_SET_VALUE(boxBorderw_, boxBorderw) };


    // boxColor Field Functions 
    bool hasBoxColor() const { return this->boxColor_ != nullptr;};
    void deleteBoxColor() { this->boxColor_ = nullptr;};
    inline const Models::StartCloudRecordRequestPanesTextsBoxColor & boxColor() const { DARABONBA_PTR_GET_CONST(boxColor_, Models::StartCloudRecordRequestPanesTextsBoxColor) };
    inline Models::StartCloudRecordRequestPanesTextsBoxColor boxColor() { DARABONBA_PTR_GET(boxColor_, Models::StartCloudRecordRequestPanesTextsBoxColor) };
    inline StartCloudRecordRequestPanesTexts& setBoxColor(const Models::StartCloudRecordRequestPanesTextsBoxColor & boxColor) { DARABONBA_PTR_SET_VALUE(boxColor_, boxColor) };
    inline StartCloudRecordRequestPanesTexts& setBoxColor(Models::StartCloudRecordRequestPanesTextsBoxColor && boxColor) { DARABONBA_PTR_SET_RVALUE(boxColor_, boxColor) };
    ...
    inline StartCloudRecordRequestPanesTexts& setDisplay(string display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline StartCloudRecordRequestPanesTexts& setFont(int32_t font) { DARABONBA_PTR_SET_VALUE(font_, font) };
    ...
    inline const Models::StartCloudRecordRequestPanesTextsFontColor & fontColor() const { DARABONBA_PTR_GET_CONST(fontColor_, Models::StartCloudRecordRequestPanesTextsFontColor) };
    inline Models::StartCloudRecordRequestPanesTextsFontColor fontColor() { DARABONBA_PTR_GET(fontColor_, Models::StartCloudRecordRequestPanesTextsFontColor) };
    inline StartCloudRecordRequestPanesTexts& setFontColor(const Models::StartCloudRecordRequestPanesTextsFontColor & fontColor) { DARABONBA_PTR_SET_VALUE(fontColor_, fontColor) };
    inline StartCloudRecordRequestPanesTexts& setFontColor(Models::StartCloudRecordRequestPanesTextsFontColor && fontColor) { DARABONBA_PTR_SET_RVALUE(fontColor_, fontColor) };
    ...
    inline StartCloudRecordRequestPanesTexts& setFontSize(int32_t fontSize) { DARABONBA_PTR_SET_VALUE(fontSize_, fontSize) };
    ...
    inline StartCloudRecordRequestPanesTexts& setHasBox(bool hasBox) { DARABONBA_PTR_SET_VALUE(hasBox_, hasBox) };
    ...
    inline StartCloudRecordRequestPanesTexts& setLayer(int32_t layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline StartCloudRecordRequestPanesTexts& setTexture(string texture) { DARABONBA_PTR_SET_VALUE(texture_, texture) };
    ...
    inline StartCloudRecordRequestPanesTexts& setX(double x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline StartCloudRecordRequestPanesTexts& setY(double y) { DARABONBA_PTR_SET_VALUE(y_, y) };
  ...
  protected:
    ...
    std::shared_ptr<Models::StartCloudRecordRequestPanesTextsBoxColor> boxColor_ = nullptr;
    std::shared_ptr<string> display_ = nullptr;
    std::shared_ptr<int32_t> font_ = nullptr;
    std::shared_ptr<Models::StartCloudRecordRequestPanesTextsFontColor> fontColor_ = nullptr;
