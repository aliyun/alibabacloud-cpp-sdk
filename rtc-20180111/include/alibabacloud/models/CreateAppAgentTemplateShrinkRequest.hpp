...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentSilenceConfigShrink_ == nullptr
        ...
        && return this->greeting_ == nullptr && return this->interruptConfigShrink_ == nullptr && return this->interruptMode_ == nullptr && return this->llmConfigShrink_ == nullptr && return this->name_ == nullptr
        && return this->ttsConfigShrink_ == nullptr && return this->type_ == nullptr; };
