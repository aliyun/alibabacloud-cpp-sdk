...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyStreamingPropertyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyStreamingPropertyResponseBody) };
    inline ModifyStreamingPropertyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyStreamingPropertyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyStreamingPropertyResponseBody> body_ {};
  };
