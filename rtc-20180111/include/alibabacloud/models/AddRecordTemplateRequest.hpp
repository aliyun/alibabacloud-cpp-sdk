...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        ...
        && return this->ownerId_ == nullptr && return this->taskProfile_ == nullptr && return this->watermarks_ == nullptr; };
    ...
    inline const vector<AddRecordTemplateRequestBackgrounds> & backgrounds() const { DARABONBA_PTR_GET_CONST(backgrounds_, vector<AddRecordTemplateRequestBackgrounds>) };
    inline vector<AddRecordTemplateRequestBackgrounds> backgrounds() { DARABONBA_PTR_GET(backgrounds_, vector<AddRecordTemplateRequestBackgrounds>) };
    inline AddRecordTemplateRequest& setBackgrounds(const vector<AddRecordTemplateRequestBackgrounds> & backgrounds) { DARABONBA_PTR_SET_VALUE(backgrounds_, backgrounds) };
    inline AddRecordTemplateRequest& setBackgrounds(vector<AddRecordTemplateRequestBackgrounds> && backgrounds) { DARABONBA_PTR_SET_RVALUE(backgrounds_, backgrounds) };
    ...
    inline const vector<AddRecordTemplateRequestClockWidgets> & clockWidgets() const { DARABONBA_PTR_GET_CONST(clockWidgets_, vector<AddRecordTemplateRequestClockWidgets>) };
    inline vector<AddRecordTemplateRequestClockWidgets> clockWidgets() { DARABONBA_PTR_GET(clockWidgets_, vector<AddRecordTemplateRequestClockWidgets>) };
    inline AddRecordTemplateRequest& setClockWidgets(const vector<AddRecordTemplateRequestClockWidgets> & clockWidgets) { DARABONBA_PTR_SET_VALUE(clockWidgets_, clockWidgets) };
    inline AddRecordTemplateRequest& setClockWidgets(vector<AddRecordTemplateRequestClockWidgets> && clockWidgets) { DARABONBA_PTR_SET_RVALUE(clockWidgets_, clockWidgets) };
    ...
    inline const vector<AddRecordTemplateRequestWatermarks> & watermarks() const { DARABONBA_PTR_GET_CONST(watermarks_, vector<AddRecordTemplateRequestWatermarks>) };
    inline vector<AddRecordTemplateRequestWatermarks> watermarks() { DARABONBA_PTR_GET(watermarks_, vector<AddRecordTemplateRequestWatermarks>) };
    inline AddRecordTemplateRequest& setWatermarks(const vector<AddRecordTemplateRequestWatermarks> & watermarks) { DARABONBA_PTR_SET_VALUE(watermarks_, watermarks) };
    inline AddRecordTemplateRequest& setWatermarks(vector<AddRecordTemplateRequestWatermarks> && watermarks) { DARABONBA_PTR_SET_RVALUE(watermarks_, watermarks) };
  ...
  protected:
    ...
    std::shared_ptr<vector<AddRecordTemplateRequestBackgrounds>> backgrounds_ = nullptr;
    std::shared_ptr<vector<AddRecordTemplateRequestClockWidgets>> clockWidgets_ = nullptr;
    ...
    std::shared_ptr<vector<AddRecordTemplateRequestWatermarks>> watermarks_ = nullptr;
  };
