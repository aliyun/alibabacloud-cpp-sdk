...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAppAgentTemplatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAppAgentTemplatesResponseBody) };
    inline DescribeAppAgentTemplatesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAppAgentTemplatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAppAgentTemplatesResponseBody> body_ {};
  };
