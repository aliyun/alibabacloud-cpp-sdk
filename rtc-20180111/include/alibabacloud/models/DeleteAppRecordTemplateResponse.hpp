...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAppRecordTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAppRecordTemplateResponseBody) };
    inline DeleteAppRecordTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAppRecordTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAppRecordTemplateResponseBody> body_ {};
  };
