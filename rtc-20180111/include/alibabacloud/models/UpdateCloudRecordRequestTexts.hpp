...
#ifndef ALIBABACLOUD_MODELS_UPDATECLOUDRECORDREQUESTTEXTS_HPP_
#define ALIBABACLOUD_MODELS_UPDATECLOUDRECORDREQUESTTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateCloudRecordRequestTexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateCloudRecordRequestTexts& obj) { 
    ...
    UpdateCloudRecordRequestTexts() = default ;
    UpdateCloudRecordRequestTexts(const UpdateCloudRecordRequestTexts &) = default ;
    UpdateCloudRecordRequestTexts(UpdateCloudRecordRequestTexts &&) = default ;
    UpdateCloudRecordRequestTexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateCloudRecordRequestTexts() = default ;
    UpdateCloudRecordRequestTexts& operator=(const UpdateCloudRecordRequestTexts &) = default ;
    UpdateCloudRecordRequestTexts& operator=(UpdateCloudRecordRequestTexts &&) = default ;
    ...
    inline UpdateCloudRecordRequestTexts& setAlpha(double alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline UpdateCloudRecordRequestTexts& setBoxAlpha(double boxAlpha) { DARABONBA_PTR_SET_VALUE(boxAlpha_, boxAlpha) };
    ...
    inline UpdateCloudRecordRequestTexts& setBoxBorderw(int32_t boxBorderw) { DARABONBA_PTR_SET_VALUE(boxBorderw_, boxBorderw) };


    // boxColor Field Functions 
    bool hasBoxColor() const { return this->boxColor_ != nullptr;};
    void deleteBoxColor() { this->boxColor_ = nullptr;};
    inline const Models::UpdateCloudRecordRequestTextsBoxColor & boxColor() const { DARABONBA_PTR_GET_CONST(boxColor_, Models::UpdateCloudRecordRequestTextsBoxColor) };
    inline Models::UpdateCloudRecordRequestTextsBoxColor boxColor() { DARABONBA_PTR_GET(boxColor_, Models::UpdateCloudRecordRequestTextsBoxColor) };
    inline UpdateCloudRecordRequestTexts& setBoxColor(const Models::UpdateCloudRecordRequestTextsBoxColor & boxColor) { DARABONBA_PTR_SET_VALUE(boxColor_, boxColor) };
    inline UpdateCloudRecordRequestTexts& setBoxColor(Models::UpdateCloudRecordRequestTextsBoxColor && boxColor) { DARABONBA_PTR_SET_RVALUE(boxColor_, boxColor) };
    ...
    inline UpdateCloudRecordRequestTexts& setFont(int32_t font) { DARABONBA_PTR_SET_VALUE(font_, font) };
    ...
    inline const Models::UpdateCloudRecordRequestTextsFontColor & fontColor() const { DARABONBA_PTR_GET_CONST(fontColor_, Models::UpdateCloudRecordRequestTextsFontColor) };
    inline Models::UpdateCloudRecordRequestTextsFontColor fontColor() { DARABONBA_PTR_GET(fontColor_, Models::UpdateCloudRecordRequestTextsFontColor) };
    inline UpdateCloudRecordRequestTexts& setFontColor(const Models::UpdateCloudRecordRequestTextsFontColor & fontColor) { DARABONBA_PTR_SET_VALUE(fontColor_, fontColor) };
    inline UpdateCloudRecordRequestTexts& setFontColor(Models::UpdateCloudRecordRequestTextsFontColor && fontColor) { DARABONBA_PTR_SET_RVALUE(fontColor_, fontColor) };
    ...
    inline UpdateCloudRecordRequestTexts& setFontSize(int32_t fontSize) { DARABONBA_PTR_SET_VALUE(fontSize_, fontSize) };
    ...
    inline UpdateCloudRecordRequestTexts& setHasBox(bool hasBox) { DARABONBA_PTR_SET_VALUE(hasBox_, hasBox) };
    ...
    inline UpdateCloudRecordRequestTexts& setLayer(int32_t layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline UpdateCloudRecordRequestTexts& setTexture(string texture) { DARABONBA_PTR_SET_VALUE(texture_, texture) };
    ...
    inline UpdateCloudRecordRequestTexts& setX(double x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline UpdateCloudRecordRequestTexts& setY(double y) { DARABONBA_PTR_SET_VALUE(y_, y) };
  ...
  protected:
    ...
    std::shared_ptr<Models::UpdateCloudRecordRequestTextsBoxColor> boxColor_ = nullptr;
    std::shared_ptr<int32_t> font_ = nullptr;
    std::shared_ptr<Models::UpdateCloudRecordRequestTextsFontColor> fontColor_ = nullptr;
