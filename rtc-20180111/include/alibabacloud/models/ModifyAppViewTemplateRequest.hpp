...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAppViewTemplateRequest::Template & getTemplate() const { DARABONBA_PTR_GET_CONST(template_, ModifyAppViewTemplateRequest::Template) };
    inline ModifyAppViewTemplateRequest::Template getTemplate() { DARABONBA_PTR_GET(template_, ModifyAppViewTemplateRequest::Template) };
    inline ModifyAppViewTemplateRequest& setTemplate(const ModifyAppViewTemplateRequest::Template & _template) { DARABONBA_PTR_SET_VALUE(template_, _template) };
    inline ModifyAppViewTemplateRequest& setTemplate(ModifyAppViewTemplateRequest::Template && _template) { DARABONBA_PTR_SET_RVALUE(template_, _template) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<ModifyAppViewTemplateRequest::Template> template_ {};
  };
