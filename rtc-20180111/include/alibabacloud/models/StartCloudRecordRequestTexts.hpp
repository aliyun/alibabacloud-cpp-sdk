...
#ifndef ALIBABACLOUD_MODELS_STARTCLOUDRECORDREQUESTTEXTS_HPP_
#define ALIBABACLOUD_MODELS_STARTCLOUDRECORDREQUESTTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartCloudRecordRequestTexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartCloudRecordRequestTexts& obj) { 
    ...
    StartCloudRecordRequestTexts() = default ;
    StartCloudRecordRequestTexts(const StartCloudRecordRequestTexts &) = default ;
    StartCloudRecordRequestTexts(StartCloudRecordRequestTexts &&) = default ;
    StartCloudRecordRequestTexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartCloudRecordRequestTexts() = default ;
    StartCloudRecordRequestTexts& operator=(const StartCloudRecordRequestTexts &) = default ;
    StartCloudRecordRequestTexts& operator=(StartCloudRecordRequestTexts &&) = default ;
    ...
    inline StartCloudRecordRequestTexts& setAlpha(double alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline StartCloudRecordRequestTexts& setBoxAlpha(double boxAlpha) { DARABONBA_PTR_SET_VALUE(boxAlpha_, boxAlpha) };
    ...
    inline StartCloudRecordRequestTexts& setBoxBorderw(int32_t boxBorderw) { DARABONBA_PTR_SET_VALUE(boxBorderw_, boxBorderw) };


    // boxColor Field Functions 
    bool hasBoxColor() const { return this->boxColor_ != nullptr;};
    void deleteBoxColor() { this->boxColor_ = nullptr;};
    inline const Models::StartCloudRecordRequestTextsBoxColor & boxColor() const { DARABONBA_PTR_GET_CONST(boxColor_, Models::StartCloudRecordRequestTextsBoxColor) };
    inline Models::StartCloudRecordRequestTextsBoxColor boxColor() { DARABONBA_PTR_GET(boxColor_, Models::StartCloudRecordRequestTextsBoxColor) };
    inline StartCloudRecordRequestTexts& setBoxColor(const Models::StartCloudRecordRequestTextsBoxColor & boxColor) { DARABONBA_PTR_SET_VALUE(boxColor_, boxColor) };
    inline StartCloudRecordRequestTexts& setBoxColor(Models::StartCloudRecordRequestTextsBoxColor && boxColor) { DARABONBA_PTR_SET_RVALUE(boxColor_, boxColor) };
    ...
    inline StartCloudRecordRequestTexts& setFont(int32_t font) { DARABONBA_PTR_SET_VALUE(font_, font) };
    ...
    inline const Models::StartCloudRecordRequestTextsFontColor & fontColor() const { DARABONBA_PTR_GET_CONST(fontColor_, Models::StartCloudRecordRequestTextsFontColor) };
    inline Models::StartCloudRecordRequestTextsFontColor fontColor() { DARABONBA_PTR_GET(fontColor_, Models::StartCloudRecordRequestTextsFontColor) };
    inline StartCloudRecordRequestTexts& setFontColor(const Models::StartCloudRecordRequestTextsFontColor & fontColor) { DARABONBA_PTR_SET_VALUE(fontColor_, fontColor) };
    inline StartCloudRecordRequestTexts& setFontColor(Models::StartCloudRecordRequestTextsFontColor && fontColor) { DARABONBA_PTR_SET_RVALUE(fontColor_, fontColor) };
    ...
    inline StartCloudRecordRequestTexts& setFontSize(int32_t fontSize) { DARABONBA_PTR_SET_VALUE(fontSize_, fontSize) };
    ...
    inline StartCloudRecordRequestTexts& setHasBox(bool hasBox) { DARABONBA_PTR_SET_VALUE(hasBox_, hasBox) };
    ...
    inline StartCloudRecordRequestTexts& setLayer(int32_t layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline StartCloudRecordRequestTexts& setTexture(string texture) { DARABONBA_PTR_SET_VALUE(texture_, texture) };
    ...
    inline StartCloudRecordRequestTexts& setX(double x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline StartCloudRecordRequestTexts& setY(double y) { DARABONBA_PTR_SET_VALUE(y_, y) };
  ...
  protected:
    ...
    std::shared_ptr<Models::StartCloudRecordRequestTextsBoxColor> boxColor_ = nullptr;
    std::shared_ptr<int32_t> font_ = nullptr;
    std::shared_ptr<Models::StartCloudRecordRequestTextsFontColor> fontColor_ = nullptr;
