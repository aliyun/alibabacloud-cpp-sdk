...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeChannelTopPubUserListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeChannelTopPubUserListResponseBody) };
    inline DescribeChannelTopPubUserListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeChannelTopPubUserListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeChannelTopPubUserListResponseBody> body_ {};
  };
