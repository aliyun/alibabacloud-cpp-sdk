...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAppLayoutResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyAppLayoutResponseBody) };
    inline ModifyAppLayoutResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyAppLayoutResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyAppLayoutResponseBody> body_ {};
  };
