...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCloudNotePhrasesRequestPhrase & phrase() const { DARABONBA_PTR_GET_CONST(phrase_, DeleteCloudNotePhrasesRequestPhrase) };
    inline DeleteCloudNotePhrasesRequestPhrase phrase() { DARABONBA_PTR_GET(phrase_, DeleteCloudNotePhrasesRequestPhrase) };
    inline DeleteCloudNotePhrasesRequest& setPhrase(const DeleteCloudNotePhrasesRequestPhrase & phrase) { DARABONBA_PTR_SET_VALUE(phrase_, phrase) };
    inline DeleteCloudNotePhrasesRequest& setPhrase(DeleteCloudNotePhrasesRequestPhrase && phrase) { DARABONBA_PTR_SET_RVALUE(phrase_, phrase) };
  ...
  protected:
    ...
    // This parameter is required.
    std::shared_ptr<DeleteCloudNotePhrasesRequestPhrase> phrase_ = nullptr;
  };
