...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEQUALITYDISTRIBUTIONSTATDATARESPONSEBODYQUALITYSTATDATALIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEQUALITYDISTRIBUTIONSTATDATARESPONSEBODYQUALITYSTATDATALIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeQualityDistributionStatDataResponseBodyQualityStatDataList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeQualityDistributionStatDataResponseBodyQualityStatDataList& obj) { 
    ...
    DescribeQualityDistributionStatDataResponseBodyQualityStatDataList() = default ;
    DescribeQualityDistributionStatDataResponseBodyQualityStatDataList(const DescribeQualityDistributionStatDataResponseBodyQualityStatDataList &) = default ;
    DescribeQualityDistributionStatDataResponseBodyQualityStatDataList(DescribeQualityDistributionStatDataResponseBodyQualityStatDataList &&) = default ;
    DescribeQualityDistributionStatDataResponseBodyQualityStatDataList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeQualityDistributionStatDataResponseBodyQualityStatDataList() = default ;
    DescribeQualityDistributionStatDataResponseBodyQualityStatDataList& operator=(const DescribeQualityDistributionStatDataResponseBodyQualityStatDataList &) = default ;
    DescribeQualityDistributionStatDataResponseBodyQualityStatDataList& operator=(DescribeQualityDistributionStatDataResponseBodyQualityStatDataList &&) = default ;
    ...
    virtual bool empty() const override { return this->audioDelay_ == nullptr
        ...
        && return this->name_ == nullptr && return this->videoDelay_ == nullptr && return this->videoFirstPicDuration_ == nullptr && return this->videoHighQualityTransmissionRate_ == nullptr && return this->videoStuckRate_ == nullptr; };
    ...
    inline DescribeQualityDistributionStatDataResponseBodyQualityStatDataList& setAudioDelay(int64_t audioDelay) { DARABONBA_PTR_SET_VALUE(audioDelay_, audioDelay) };
    ...
    inline DescribeQualityDistributionStatDataResponseBodyQualityStatDataList& setAudioHighQualityTransmissionRate(string audioHighQualityTransmissionRate) { DARABONBA_PTR_SET_VALUE(audioHighQualityTransmissionRate_, audioHighQualityTransmissionRate) };
    ...
    inline DescribeQualityDistributionStatDataResponseBodyQualityStatDataList& setAudioStuckRate(string audioStuckRate) { DARABONBA_PTR_SET_VALUE(audioStuckRate_, audioStuckRate) };
    ...
    inline DescribeQualityDistributionStatDataResponseBodyQualityStatDataList& setCallDurationRatio(string callDurationRatio) { DARABONBA_PTR_SET_VALUE(callDurationRatio_, callDurationRatio) };
    ...
    inline DescribeQualityDistributionStatDataResponseBodyQualityStatDataList& setJoinChannelSucFiveSecRate(string joinChannelSucFiveSecRate) { DARABONBA_PTR_SET_VALUE(joinChannelSucFiveSecRate_, joinChannelSucFiveSecRate) };
    ...
    inline DescribeQualityDistributionStatDataResponseBodyQualityStatDataList& setJoinChannelSucRate(string joinChannelSucRate) { DARABONBA_PTR_SET_VALUE(joinChannelSucRate_, joinChannelSucRate) };
    ...
    inline DescribeQualityDistributionStatDataResponseBodyQualityStatDataList& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline DescribeQualityDistributionStatDataResponseBodyQualityStatDataList& setVideoDelay(int64_t videoDelay) { DARABONBA_PTR_SET_VALUE(videoDelay_, videoDelay) };
    ...
    inline DescribeQualityDistributionStatDataResponseBodyQualityStatDataList& setVideoFirstPicDuration(int64_t videoFirstPicDuration) { DARABONBA_PTR_SET_VALUE(videoFirstPicDuration_, videoFirstPicDuration) };
    ...
    inline DescribeQualityDistributionStatDataResponseBodyQualityStatDataList& setVideoHighQualityTransmissionRate(string videoHighQualityTransmissionRate) { DARABONBA_PTR_SET_VALUE(videoHighQualityTransmissionRate_, videoHighQualityTransmissionRate) };
    ...
    inline DescribeQualityDistributionStatDataResponseBodyQualityStatDataList& setVideoStuckRate(string videoStuckRate) { DARABONBA_PTR_SET_VALUE(videoStuckRate_, videoStuckRate) };
