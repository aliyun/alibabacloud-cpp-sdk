...
#ifndef ALIBABACLOUD_MODELS_ADDRECORDTEMPLATEREQUESTWATERMARKS_HPP_
#define ALIBABACLOUD_MODELS_ADDRECORDTEMPLATEREQUESTWATERMARKS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddRecordTemplateRequestWatermarks& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddRecordTemplateRequestWatermarks& obj) { 
    ...
    AddRecordTemplateRequestWatermarks() = default ;
    AddRecordTemplateRequestWatermarks(const AddRecordTemplateRequestWatermarks &) = default ;
    AddRecordTemplateRequestWatermarks(AddRecordTemplateRequestWatermarks &&) = default ;
    AddRecordTemplateRequestWatermarks(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddRecordTemplateRequestWatermarks() = default ;
    AddRecordTemplateRequestWatermarks& operator=(const AddRecordTemplateRequestWatermarks &) = default ;
    AddRecordTemplateRequestWatermarks& operator=(AddRecordTemplateRequestWatermarks &&) = default ;
    ...
    inline AddRecordTemplateRequestWatermarks& setAlpha(float alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline AddRecordTemplateRequestWatermarks& setDisplay(int32_t display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline AddRecordTemplateRequestWatermarks& setHeight(float height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline AddRecordTemplateRequestWatermarks& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
    ...
    inline AddRecordTemplateRequestWatermarks& setWidth(float width) { DARABONBA_PTR_SET_VALUE(width_, width) };
    ...
    inline AddRecordTemplateRequestWatermarks& setX(float x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline AddRecordTemplateRequestWatermarks& setY(float y) { DARABONBA_PTR_SET_VALUE(y_, y) };
    ...
    inline AddRecordTemplateRequestWatermarks& setZOrder(int32_t ZOrder) { DARABONBA_PTR_SET_VALUE(ZOrder_, ZOrder) };
