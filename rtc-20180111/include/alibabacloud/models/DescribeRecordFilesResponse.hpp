...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRecordFilesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRecordFilesResponseBody) };
    inline DescribeRecordFilesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRecordFilesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRecordFilesResponseBody> body_ {};
  };
