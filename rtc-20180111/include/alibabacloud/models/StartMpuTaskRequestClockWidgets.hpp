...
#ifndef ALIBABACLOUD_MODELS_STARTMPUTASKREQUESTCLOCKWIDGETS_HPP_
#define ALIBABACLOUD_MODELS_STARTMPUTASKREQUESTCLOCKWIDGETS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartMPUTaskRequestClockWidgets& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartMPUTaskRequestClockWidgets& obj) { 
    ...
    StartMPUTaskRequestClockWidgets() = default ;
    StartMPUTaskRequestClockWidgets(const StartMPUTaskRequestClockWidgets &) = default ;
    StartMPUTaskRequestClockWidgets(StartMPUTaskRequestClockWidgets &&) = default ;
    StartMPUTaskRequestClockWidgets(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartMPUTaskRequestClockWidgets() = default ;
    StartMPUTaskRequestClockWidgets& operator=(const StartMPUTaskRequestClockWidgets &) = default ;
    StartMPUTaskRequestClockWidgets& operator=(StartMPUTaskRequestClockWidgets &&) = default ;
    ...
    inline StartMPUTaskRequestClockWidgets& setAlpha(float alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline StartMPUTaskRequestClockWidgets& setBorderColor(int64_t borderColor) { DARABONBA_PTR_SET_VALUE(borderColor_, borderColor) };
    ...
    inline StartMPUTaskRequestClockWidgets& setBorderWidth(int32_t borderWidth) { DARABONBA_PTR_SET_VALUE(borderWidth_, borderWidth) };
    ...
    inline StartMPUTaskRequestClockWidgets& setBox(bool box) { DARABONBA_PTR_SET_VALUE(box_, box) };
    ...
    inline StartMPUTaskRequestClockWidgets& setBoxBorderWidth(int32_t boxBorderWidth) { DARABONBA_PTR_SET_VALUE(boxBorderWidth_, boxBorderWidth) };
    ...
    inline StartMPUTaskRequestClockWidgets& setBoxColor(int64_t boxColor) { DARABONBA_PTR_SET_VALUE(boxColor_, boxColor) };
    ...
    inline StartMPUTaskRequestClockWidgets& setFontColor(int32_t fontColor) { DARABONBA_PTR_SET_VALUE(fontColor_, fontColor) };
    ...
    inline StartMPUTaskRequestClockWidgets& setFontSize(int32_t fontSize) { DARABONBA_PTR_SET_VALUE(fontSize_, fontSize) };
    ...
    inline StartMPUTaskRequestClockWidgets& setFontType(int32_t fontType) { DARABONBA_PTR_SET_VALUE(fontType_, fontType) };
    ...
    inline StartMPUTaskRequestClockWidgets& setX(float x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline StartMPUTaskRequestClockWidgets& setY(float y) { DARABONBA_PTR_SET_VALUE(y_, y) };
    ...
    inline StartMPUTaskRequestClockWidgets& setZOrder(int32_t ZOrder) { DARABONBA_PTR_SET_VALUE(ZOrder_, ZOrder) };
