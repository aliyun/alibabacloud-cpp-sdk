...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAppStreamingOutTemplatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAppStreamingOutTemplatesResponseBody) };
    inline DescribeAppStreamingOutTemplatesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAppStreamingOutTemplatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAppStreamingOutTemplatesResponseBody> body_ {};
  };
