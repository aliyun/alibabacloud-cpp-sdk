...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->createTime_ == nullptr
        && this->delayStopTime_ == nullptr && this->filePrefix_ == nullptr && this->fileSplitInterval_ == nullptr && this->formats_ == nullptr && this->layoutIds_ == nullptr
      ...
      inline int64_t getDelayStopTime() const { DARABONBA_PTR_GET_DEFAULT(delayStopTime_, 0L) };
      inline Templates& setDelayStopTime(int64_t delayStopTime) { DARABONBA_PTR_SET_VALUE(delayStopTime_, delayStopTime) };
      ...
      inline Templates& setFilePrefix(string filePrefix) { DARABONBA_PTR_SET_VALUE(filePrefix_, filePrefix) };
      ...
      inline int64_t getFileSplitInterval() const { DARABONBA_PTR_GET_DEFAULT(fileSplitInterval_, 0L) };
      inline Templates& setFileSplitInterval(int64_t fileSplitInterval) { DARABONBA_PTR_SET_VALUE(fileSplitInterval_, fileSplitInterval) };
    ...
    protected:
      ...
      shared_ptr<int64_t> delayStopTime_ {};
      shared_ptr<string> filePrefix_ {};
      shared_ptr<int64_t> fileSplitInterval_ {};
    ...
    inline const vector<DescribeAppRecordTemplatesResponseBody::Templates> & getTemplates() const { DARABONBA_PTR_GET_CONST(templates_, vector<DescribeAppRecordTemplatesResponseBody::Templates>) };
    inline vector<DescribeAppRecordTemplatesResponseBody::Templates> getTemplates() { DARABONBA_PTR_GET(templates_, vector<DescribeAppRecordTemplatesResponseBody::Templates>) };
    inline DescribeAppRecordTemplatesResponseBody& setTemplates(const vector<DescribeAppRecordTemplatesResponseBody::Templates> & templates) { DARABONBA_PTR_SET_VALUE(templates_, templates) };
    inline DescribeAppRecordTemplatesResponseBody& setTemplates(vector<DescribeAppRecordTemplatesResponseBody::Templates> && templates) { DARABONBA_PTR_SET_RVALUE(templates_, templates) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeAppRecordTemplatesResponseBody::Templates>> templates_ {};
