...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->channelId_ == nullptr && this->cropMode_ == nullptr && this->layoutIds_ == nullptr && this->mediaEncode_ == nullptr && this->ownerId_ == nullptr
        ...
        && this->taskProfile_ == nullptr && this->templateId_ == nullptr && this->unsubSpecAudioUsers_ == nullptr && this->unsubSpecCameraUsers_ == nullptr && this->unsubSpecShareScreenUsers_ == nullptr
    ...
    inline int64_t getMediaEncode() const { DARABONBA_PTR_GET_DEFAULT(mediaEncode_, 0L) };
    ...
    inline const vector<UpdateRecordTaskRequest::UserPanes> & getUserPanes() const { DARABONBA_PTR_GET_CONST(userPanes_, vector<UpdateRecordTaskRequest::UserPanes>) };
    inline vector<UpdateRecordTaskRequest::UserPanes> getUserPanes() { DARABONBA_PTR_GET(userPanes_, vector<UpdateRecordTaskRequest::UserPanes>) };
    inline UpdateRecordTaskRequest& setUserPanes(const vector<UpdateRecordTaskRequest::UserPanes> & userPanes) { DARABONBA_PTR_SET_VALUE(userPanes_, userPanes) };
    inline UpdateRecordTaskRequest& setUserPanes(vector<UpdateRecordTaskRequest::UserPanes> && userPanes) { DARABONBA_PTR_SET_RVALUE(userPanes_, userPanes) };
  ...
  protected:
    ...
    shared_ptr<int64_t> mediaEncode_ {};
    ...
    shared_ptr<vector<UpdateRecordTaskRequest::UserPanes>> userPanes_ {};
  };
