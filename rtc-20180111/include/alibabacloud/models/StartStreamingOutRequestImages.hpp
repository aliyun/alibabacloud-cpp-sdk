...
#ifndef ALIBABACLOUD_MODELS_STARTSTREAMINGOUTREQUESTIMAGES_HPP_
#define ALIBABACLOUD_MODELS_STARTSTREAMINGOUTREQUESTIMAGES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartStreamingOutRequestImages& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartStreamingOutRequestImages& obj) { 
    ...
    StartStreamingOutRequestImages() = default ;
    StartStreamingOutRequestImages(const StartStreamingOutRequestImages &) = default ;
    StartStreamingOutRequestImages(StartStreamingOutRequestImages &&) = default ;
    StartStreamingOutRequestImages(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartStreamingOutRequestImages() = default ;
    StartStreamingOutRequestImages& operator=(const StartStreamingOutRequestImages &) = default ;
    StartStreamingOutRequestImages& operator=(StartStreamingOutRequestImages &&) = default ;
    ...
    inline StartStreamingOutRequestImages& setAlpha(double alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline StartStreamingOutRequestImages& setHeight(double height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline StartStreamingOutRequestImages& setImageCropMode(int32_t imageCropMode) { DARABONBA_PTR_SET_VALUE(imageCropMode_, imageCropMode) };
    ...
    inline StartStreamingOutRequestImages& setLayer(int32_t layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline StartStreamingOutRequestImages& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
    ...
    inline StartStreamingOutRequestImages& setWidth(double width) { DARABONBA_PTR_SET_VALUE(width_, width) };
    ...
    inline StartStreamingOutRequestImages& setX(double x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline StartStreamingOutRequestImages& setY(double y) { DARABONBA_PTR_SET_VALUE(y_, y) };
