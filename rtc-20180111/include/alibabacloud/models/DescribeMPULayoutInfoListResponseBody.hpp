...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMPULayoutInfoListResponseBody::Layouts & getLayouts() const { DARABONBA_PTR_GET_CONST(layouts_, DescribeMPULayoutInfoListResponseBody::Layouts) };
    inline DescribeMPULayoutInfoListResponseBody::Layouts getLayouts() { DARABONBA_PTR_GET(layouts_, DescribeMPULayoutInfoListResponseBody::Layouts) };
    inline DescribeMPULayoutInfoListResponseBody& setLayouts(const DescribeMPULayoutInfoListResponseBody::Layouts & layouts) { DARABONBA_PTR_SET_VALUE(layouts_, layouts) };
    inline DescribeMPULayoutInfoListResponseBody& setLayouts(DescribeMPULayoutInfoListResponseBody::Layouts && layouts) { DARABONBA_PTR_SET_RVALUE(layouts_, layouts) };
  ...
  protected:
    shared_ptr<DescribeMPULayoutInfoListResponseBody::Layouts> layouts_ {};
