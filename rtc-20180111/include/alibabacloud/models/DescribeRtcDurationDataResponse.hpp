...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRtcDurationDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRtcDurationDataResponseBody) };
    inline DescribeRtcDurationDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRtcDurationDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRtcDurationDataResponseBody> body_ {};
  };
