...
namespace Models
{
  ...
  public:
    ...
    inline const EnableAutoLiveStreamRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableAutoLiveStreamRuleResponseBody) };
    inline EnableAutoLiveStreamRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableAutoLiveStreamRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableAutoLiveStreamRuleResponseBody> body_ {};
  };
