...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAppLayoutRequestLayout & layout() const { DARABONBA_PTR_GET_CONST(layout_, ModifyAppLayoutRequestLayout) };
    inline ModifyAppLayoutRequestLayout layout() { DARABONBA_PTR_GET(layout_, ModifyAppLayoutRequestLayout) };
    inline ModifyAppLayoutRequest& setLayout(const ModifyAppLayoutRequestLayout & layout) { DARABONBA_PTR_SET_VALUE(layout_, layout) };
    inline ModifyAppLayoutRequest& setLayout(ModifyAppLayoutRequestLayout && layout) { DARABONBA_PTR_SET_RVALUE(layout_, layout) };
  ...
  protected:
    ...
    // This parameter is required.
    std::shared_ptr<ModifyAppLayoutRequestLayout> layout_ = nullptr;
  };
