...
#ifndef ALIBABACLOUD_MODELS_UPDATERECORDTEMPLATEREQUESTCLOCKWIDGETS_HPP_
#define ALIBABACLOUD_MODELS_UPDATERECORDTEMPLATEREQUESTCLOCKWIDGETS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateRecordTemplateRequestClockWidgets& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateRecordTemplateRequestClockWidgets& obj) { 
    ...
    UpdateRecordTemplateRequestClockWidgets() = default ;
    UpdateRecordTemplateRequestClockWidgets(const UpdateRecordTemplateRequestClockWidgets &) = default ;
    UpdateRecordTemplateRequestClockWidgets(UpdateRecordTemplateRequestClockWidgets &&) = default ;
    UpdateRecordTemplateRequestClockWidgets(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateRecordTemplateRequestClockWidgets() = default ;
    UpdateRecordTemplateRequestClockWidgets& operator=(const UpdateRecordTemplateRequestClockWidgets &) = default ;
    UpdateRecordTemplateRequestClockWidgets& operator=(UpdateRecordTemplateRequestClockWidgets &&) = default ;
    ...
    inline UpdateRecordTemplateRequestClockWidgets& setFontColor(int32_t fontColor) { DARABONBA_PTR_SET_VALUE(fontColor_, fontColor) };
    ...
    inline UpdateRecordTemplateRequestClockWidgets& setFontSize(int32_t fontSize) { DARABONBA_PTR_SET_VALUE(fontSize_, fontSize) };
    ...
    inline UpdateRecordTemplateRequestClockWidgets& setFontType(int32_t fontType) { DARABONBA_PTR_SET_VALUE(fontType_, fontType) };
    ...
    inline UpdateRecordTemplateRequestClockWidgets& setX(float x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline UpdateRecordTemplateRequestClockWidgets& setY(float y) { DARABONBA_PTR_SET_VALUE(y_, y) };
    ...
    inline UpdateRecordTemplateRequestClockWidgets& setZOrder(int32_t ZOrder) { DARABONBA_PTR_SET_VALUE(ZOrder_, ZOrder) };
