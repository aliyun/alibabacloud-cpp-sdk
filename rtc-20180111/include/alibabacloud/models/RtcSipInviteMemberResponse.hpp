...
namespace Models
{
  ...
  public:
    ...
    inline const RtcSipInviteMemberResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RtcSipInviteMemberResponseBody) };
    inline RtcSipInviteMemberResponseBody getBody() { DARABONBA_PTR_GET(body_, RtcSipInviteMemberResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RtcSipInviteMemberResponseBody> body_ {};
  };
