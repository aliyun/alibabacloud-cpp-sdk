...
namespace Models
{
  ...
  public:
    ...
    inline const StopAgentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopAgentResponseBody) };
    inline StopAgentResponseBody getBody() { DARABONBA_PTR_GET(body_, StopAgentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopAgentResponseBody> body_ {};
  };
