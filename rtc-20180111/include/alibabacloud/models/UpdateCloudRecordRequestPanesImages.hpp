...
#ifndef ALIBABACLOUD_MODELS_UPDATECLOUDRECORDREQUESTPANESIMAGES_HPP_
#define ALIBABACLOUD_MODELS_UPDATECLOUDRECORDREQUESTPANESIMAGES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateCloudRecordRequestPanesImages& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateCloudRecordRequestPanesImages& obj) { 
    ...
    UpdateCloudRecordRequestPanesImages() = default ;
    UpdateCloudRecordRequestPanesImages(const UpdateCloudRecordRequestPanesImages &) = default ;
    UpdateCloudRecordRequestPanesImages(UpdateCloudRecordRequestPanesImages &&) = default ;
    UpdateCloudRecordRequestPanesImages(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateCloudRecordRequestPanesImages() = default ;
    UpdateCloudRecordRequestPanesImages& operator=(const UpdateCloudRecordRequestPanesImages &) = default ;
    UpdateCloudRecordRequestPanesImages& operator=(UpdateCloudRecordRequestPanesImages &&) = default ;
    ...
    inline UpdateCloudRecordRequestPanesImages& setAlpha(double alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline UpdateCloudRecordRequestPanesImages& setDisplay(string display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline UpdateCloudRecordRequestPanesImages& setHeight(double height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline UpdateCloudRecordRequestPanesImages& setLayer(int32_t layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline UpdateCloudRecordRequestPanesImages& setPaneImageCropMode(int32_t paneImageCropMode) { DARABONBA_PTR_SET_VALUE(paneImageCropMode_, paneImageCropMode) };
    ...
    inline UpdateCloudRecordRequestPanesImages& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
    ...
    inline UpdateCloudRecordRequestPanesImages& setWidth(double width) { DARABONBA_PTR_SET_VALUE(width_, width) };
    ...
    inline UpdateCloudRecordRequestPanesImages& setX(double x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline UpdateCloudRecordRequestPanesImages& setY(double y) { DARABONBA_PTR_SET_VALUE(y_, y) };
