...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAllCallbackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAllCallbackResponseBody) };
    inline DescribeAllCallbackResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAllCallbackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAllCallbackResponseBody> body_ {};
  };
