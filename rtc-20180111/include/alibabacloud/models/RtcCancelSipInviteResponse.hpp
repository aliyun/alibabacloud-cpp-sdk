...
namespace Models
{
  ...
  public:
    ...
    inline const RtcCancelSipInviteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RtcCancelSipInviteResponseBody) };
    inline RtcCancelSipInviteResponseBody getBody() { DARABONBA_PTR_GET(body_, RtcCancelSipInviteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RtcCancelSipInviteResponseBody> body_ {};
  };
