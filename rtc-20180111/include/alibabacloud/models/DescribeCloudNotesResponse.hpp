...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudNotesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCloudNotesResponseBody) };
    inline DescribeCloudNotesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCloudNotesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCloudNotesResponseBody> body_ {};
  };
