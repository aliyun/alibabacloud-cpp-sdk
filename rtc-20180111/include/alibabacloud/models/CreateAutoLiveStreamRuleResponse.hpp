...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAutoLiveStreamRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAutoLiveStreamRuleResponseBody) };
    inline CreateAutoLiveStreamRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAutoLiveStreamRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAutoLiveStreamRuleResponseBody> body_ {};
  };
