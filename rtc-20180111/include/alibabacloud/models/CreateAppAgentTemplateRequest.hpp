...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->maxSentenceSilence_ == nullptr
        && this->name_ == nullptr && this->vadConfig_ == nullptr && this->wordWeights_ == nullptr; };
    ...
    virtual bool empty() const override { return this->agentSilenceConfig_ == nullptr
        ...
        && this->enableVideoUnderstanding_ == nullptr && this->greeting_ == nullptr && this->interruptConfig_ == nullptr && this->interruptMode_ == nullptr && this->llmConfig_ == nullptr
        && this->name_ == nullptr && this->preferVideo_ == nullptr && this->ttsConfig_ == nullptr && this->type_ == nullptr; };
    ...
    inline const CreateAppAgentTemplateRequest::AgentSilenceConfig & getAgentSilenceConfig() const { DARABONBA_PTR_GET_CONST(agentSilenceConfig_, CreateAppAgentTemplateRequest::AgentSilenceConfig) };
    inline CreateAppAgentTemplateRequest::AgentSilenceConfig getAgentSilenceConfig() { DARABONBA_PTR_GET(agentSilenceConfig_, CreateAppAgentTemplateRequest::AgentSilenceConfig) };
    inline CreateAppAgentTemplateRequest& setAgentSilenceConfig(const CreateAppAgentTemplateRequest::AgentSilenceConfig & agentSilenceConfig) { DARABONBA_PTR_SET_VALUE(agentSilenceConfig_, agentSilenceConfig) };
    inline CreateAppAgentTemplateRequest& setAgentSilenceConfig(CreateAppAgentTemplateRequest::AgentSilenceConfig && agentSilenceConfig) { DARABONBA_PTR_SET_RVALUE(agentSilenceConfig_, agentSilenceConfig) };
    ...
    inline const CreateAppAgentTemplateRequest::AmbientSoundConfig & getAmbientSoundConfig() const { DARABONBA_PTR_GET_CONST(ambientSoundConfig_, CreateAppAgentTemplateRequest::AmbientSoundConfig) };
    inline CreateAppAgentTemplateRequest::AmbientSoundConfig getAmbientSoundConfig() { DARABONBA_PTR_GET(ambientSoundConfig_, CreateAppAgentTemplateRequest::AmbientSoundConfig) };
    inline CreateAppAgentTemplateRequest& setAmbientSoundConfig(const CreateAppAgentTemplateRequest::AmbientSoundConfig & ambientSoundConfig) { DARABONBA_PTR_SET_VALUE(ambientSoundConfig_, ambientSoundConfig) };
    inline CreateAppAgentTemplateRequest& setAmbientSoundConfig(CreateAppAgentTemplateRequest::AmbientSoundConfig && ambientSoundConfig) { DARABONBA_PTR_SET_RVALUE(ambientSoundConfig_, ambientSoundConfig) };
    ...
    inline const CreateAppAgentTemplateRequest::AsrConfig & getAsrConfig() const { DARABONBA_PTR_GET_CONST(asrConfig_, CreateAppAgentTemplateRequest::AsrConfig) };
    inline CreateAppAgentTemplateRequest::AsrConfig getAsrConfig() { DARABONBA_PTR_GET(asrConfig_, CreateAppAgentTemplateRequest::AsrConfig) };
    inline CreateAppAgentTemplateRequest& setAsrConfig(const CreateAppAgentTemplateRequest::AsrConfig & asrConfig) { DARABONBA_PTR_SET_VALUE(asrConfig_, asrConfig) };
    inline CreateAppAgentTemplateRequest& setAsrConfig(CreateAppAgentTemplateRequest::AsrConfig && asrConfig) { DARABONBA_PTR_SET_RVALUE(asrConfig_, asrConfig) };
    ...
    inline const CreateAppAgentTemplateRequest::BackChannelConfig & getBackChannelConfig() const { DARABONBA_PTR_GET_CONST(backChannelConfig_, CreateAppAgentTemplateRequest::BackChannelConfig) };
    inline CreateAppAgentTemplateRequest::BackChannelConfig getBackChannelConfig() { DARABONBA_PTR_GET(backChannelConfig_, CreateAppAgentTemplateRequest::BackChannelConfig) };
    inline CreateAppAgentTemplateRequest& setBackChannelConfig(const CreateAppAgentTemplateRequest::BackChannelConfig & backChannelConfig) { DARABONBA_PTR_SET_VALUE(backChannelConfig_, backChannelConfig) };
    inline CreateAppAgentTemplateRequest& setBackChannelConfig(CreateAppAgentTemplateRequest::BackChannelConfig && backChannelConfig) { DARABONBA_PTR_SET_RVALUE(backChannelConfig_, backChannelConfig) };
    ...
    inline CreateAppAgentTemplateRequest& setEnableVideoUnderstanding(bool enableVideoUnderstanding) { DARABONBA_PTR_SET_VALUE(enableVideoUnderstanding_, enableVideoUnderstanding) };
    ...
    inline const CreateAppAgentTemplateRequest::InterruptConfig & getInterruptConfig() const { DARABONBA_PTR_GET_CONST(interruptConfig_, CreateAppAgentTemplateRequest::InterruptConfig) };
    inline CreateAppAgentTemplateRequest::InterruptConfig getInterruptConfig() { DARABONBA_PTR_GET(interruptConfig_, CreateAppAgentTemplateRequest::InterruptConfig) };
    inline CreateAppAgentTemplateRequest& setInterruptConfig(const CreateAppAgentTemplateRequest::InterruptConfig & interruptConfig) { DARABONBA_PTR_SET_VALUE(interruptConfig_, interruptConfig) };
    inline CreateAppAgentTemplateRequest& setInterruptConfig(CreateAppAgentTemplateRequest::InterruptConfig && interruptConfig) { DARABONBA_PTR_SET_RVALUE(interruptConfig_, interruptConfig) };
    ...
    inline const CreateAppAgentTemplateRequest::LlmConfig & getLlmConfig() const { DARABONBA_PTR_GET_CONST(llmConfig_, CreateAppAgentTemplateRequest::LlmConfig) };
    inline CreateAppAgentTemplateRequest::LlmConfig getLlmConfig() { DARABONBA_PTR_GET(llmConfig_, CreateAppAgentTemplateRequest::LlmConfig) };
    inline CreateAppAgentTemplateRequest& setLlmConfig(const CreateAppAgentTemplateRequest::LlmConfig & llmConfig) { DARABONBA_PTR_SET_VALUE(llmConfig_, llmConfig) };
    inline CreateAppAgentTemplateRequest& setLlmConfig(CreateAppAgentTemplateRequest::LlmConfig && llmConfig) { DARABONBA_PTR_SET_RVALUE(llmConfig_, llmConfig) };
    ...
    inline CreateAppAgentTemplateRequest& setPreferVideo(int32_t preferVideo) { DARABONBA_PTR_SET_VALUE(preferVideo_, preferVideo) };
    ...
    inline const CreateAppAgentTemplateRequest::TtsConfig & getTtsConfig() const { DARABONBA_PTR_GET_CONST(ttsConfig_, CreateAppAgentTemplateRequest::TtsConfig) };
    inline CreateAppAgentTemplateRequest::TtsConfig getTtsConfig() { DARABONBA_PTR_GET(ttsConfig_, CreateAppAgentTemplateRequest::TtsConfig) };
    inline CreateAppAgentTemplateRequest& setTtsConfig(const CreateAppAgentTemplateRequest::TtsConfig & ttsConfig) { DARABONBA_PTR_SET_VALUE(ttsConfig_, ttsConfig) };
    inline CreateAppAgentTemplateRequest& setTtsConfig(CreateAppAgentTemplateRequest::TtsConfig && ttsConfig) { DARABONBA_PTR_SET_RVALUE(ttsConfig_, ttsConfig) };
  ...
  protected:
    shared_ptr<CreateAppAgentTemplateRequest::AgentSilenceConfig> agentSilenceConfig_ {};
    shared_ptr<CreateAppAgentTemplateRequest::AmbientSoundConfig> ambientSoundConfig_ {};
    // This parameter is required.
    shared_ptr<string> appId_ {};
    shared_ptr<CreateAppAgentTemplateRequest::AsrConfig> asrConfig_ {};
    shared_ptr<CreateAppAgentTemplateRequest::BackChannelConfig> backChannelConfig_ {};
    shared_ptr<int32_t> chatMode_ {};
    shared_ptr<bool> enableVideoUnderstanding_ {};
    shared_ptr<string> greeting_ {};
    shared_ptr<CreateAppAgentTemplateRequest::InterruptConfig> interruptConfig_ {};
    shared_ptr<int32_t> interruptMode_ {};
    shared_ptr<CreateAppAgentTemplateRequest::LlmConfig> llmConfig_ {};
    // This parameter is required.
    shared_ptr<string> name_ {};
    shared_ptr<int32_t> preferVideo_ {};
    shared_ptr<CreateAppAgentTemplateRequest::TtsConfig> ttsConfig_ {};
