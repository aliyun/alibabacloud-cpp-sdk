...
#ifndef ALIBABACLOUD_MODELS_UPDATESTREAMINGOUTREQUESTIMAGES_HPP_
#define ALIBABACLOUD_MODELS_UPDATESTREAMINGOUTREQUESTIMAGES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateStreamingOutRequestImages& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateStreamingOutRequestImages& obj) { 
    ...
    UpdateStreamingOutRequestImages() = default ;
    UpdateStreamingOutRequestImages(const UpdateStreamingOutRequestImages &) = default ;
    UpdateStreamingOutRequestImages(UpdateStreamingOutRequestImages &&) = default ;
    UpdateStreamingOutRequestImages(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateStreamingOutRequestImages() = default ;
    UpdateStreamingOutRequestImages& operator=(const UpdateStreamingOutRequestImages &) = default ;
    UpdateStreamingOutRequestImages& operator=(UpdateStreamingOutRequestImages &&) = default ;
    ...
    inline UpdateStreamingOutRequestImages& setAlpha(double alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline UpdateStreamingOutRequestImages& setHeight(double height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline UpdateStreamingOutRequestImages& setImageCropMode(int32_t imageCropMode) { DARABONBA_PTR_SET_VALUE(imageCropMode_, imageCropMode) };
    ...
    inline UpdateStreamingOutRequestImages& setLayer(int32_t layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline UpdateStreamingOutRequestImages& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
    ...
    inline UpdateStreamingOutRequestImages& setWidth(double width) { DARABONBA_PTR_SET_VALUE(width_, width) };
    ...
    inline UpdateStreamingOutRequestImages& setX(double x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline UpdateStreamingOutRequestImages& setY(double y) { DARABONBA_PTR_SET_VALUE(y_, y) };
