...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAppLayoutRequest::Layout & getLayout() const { DARABONBA_PTR_GET_CONST(layout_, CreateAppLayoutRequest::Layout) };
    inline CreateAppLayoutRequest::Layout getLayout() { DARABONBA_PTR_GET(layout_, CreateAppLayoutRequest::Layout) };
    inline CreateAppLayoutRequest& setLayout(const CreateAppLayoutRequest::Layout & layout) { DARABONBA_PTR_SET_VALUE(layout_, layout) };
    inline CreateAppLayoutRequest& setLayout(CreateAppLayoutRequest::Layout && layout) { DARABONBA_PTR_SET_RVALUE(layout_, layout) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<CreateAppLayoutRequest::Layout> layout_ {};
  };
