...
#ifndef ALIBABACLOUD_MODELS_STARTSTREAMINGOUTREQUESTPANESIMAGES_HPP_
#define ALIBABACLOUD_MODELS_STARTSTREAMINGOUTREQUESTPANESIMAGES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartStreamingOutRequestPanesImages& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartStreamingOutRequestPanesImages& obj) { 
    ...
    StartStreamingOutRequestPanesImages() = default ;
    StartStreamingOutRequestPanesImages(const StartStreamingOutRequestPanesImages &) = default ;
    StartStreamingOutRequestPanesImages(StartStreamingOutRequestPanesImages &&) = default ;
    StartStreamingOutRequestPanesImages(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartStreamingOutRequestPanesImages() = default ;
    StartStreamingOutRequestPanesImages& operator=(const StartStreamingOutRequestPanesImages &) = default ;
    StartStreamingOutRequestPanesImages& operator=(StartStreamingOutRequestPanesImages &&) = default ;
    ...
    inline StartStreamingOutRequestPanesImages& setAlpha(double alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };
    ...
    inline StartStreamingOutRequestPanesImages& setDisplay(string display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline StartStreamingOutRequestPanesImages& setHeight(double height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline StartStreamingOutRequestPanesImages& setLayer(int32_t layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline StartStreamingOutRequestPanesImages& setPaneImageCropMode(int32_t paneImageCropMode) { DARABONBA_PTR_SET_VALUE(paneImageCropMode_, paneImageCropMode) };
    ...
    inline StartStreamingOutRequestPanesImages& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
    ...
    inline StartStreamingOutRequestPanesImages& setWidth(double width) { DARABONBA_PTR_SET_VALUE(width_, width) };
    ...
    inline StartStreamingOutRequestPanesImages& setX(double x) { DARABONBA_PTR_SET_VALUE(x_, x) };
    ...
    inline StartStreamingOutRequestPanesImages& setY(double y) { DARABONBA_PTR_SET_VALUE(y_, y) };
