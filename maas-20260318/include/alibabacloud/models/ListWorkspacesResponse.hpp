...
namespace Models
{
  ...
  public:
    ...
    inline const ListWorkspacesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListWorkspacesResponseBody) };
    inline ListWorkspacesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListWorkspacesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListWorkspacesResponseBody> body_ {};
  };
