...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->archiveDays_ == nullptr
        && return this->backupType_ == nullptr && return this->coldArchiveDays_ == nullptr && return this->dataSourceFilters_ == nullptr && return this->immutable_ == nullptr && return this->keepLatestSnapshots_ == nullptr
        && return this->replicationRegionId_ == nullptr && return this->retention_ == nullptr && return this->retentionRules_ == nullptr && return this->ruleId_ == nullptr && return this->ruleType_ == nullptr
        && return this->schedule_ == nullptr && return this->tagFilters_ == nullptr && return this->vaultId_ == nullptr; };
