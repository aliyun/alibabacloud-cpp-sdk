...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteUdmEcsInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteUdmEcsInstanceResponseBody) };
    inline DeleteUdmEcsInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteUdmEcsInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteUdmEcsInstanceResponseBody> body_ {};
  };
