...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateClientSettingsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateClientSettingsResponseBody) };
    inline UpdateClientSettingsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateClientSettingsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateClientSettingsResponseBody> body_ {};
  };
