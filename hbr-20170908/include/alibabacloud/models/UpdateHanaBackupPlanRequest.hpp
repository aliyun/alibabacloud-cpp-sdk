...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backupPrefix_ == nullptr
        && return this->clusterId_ == nullptr && return this->planId_ == nullptr && return this->planName_ == nullptr && return this->resourceGroupId_ == nullptr && return this->schedule_ == nullptr
