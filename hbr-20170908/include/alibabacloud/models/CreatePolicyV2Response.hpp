...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePolicyV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePolicyV2ResponseBody) };
    inline CreatePolicyV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePolicyV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePolicyV2ResponseBody> body_ {};
  };
