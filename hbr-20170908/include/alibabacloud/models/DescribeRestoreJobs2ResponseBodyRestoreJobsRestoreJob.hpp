...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->actualBytes_ == nullptr
        && return this->actualItems_ == nullptr && return this->bytesDone_ == nullptr && return this->bytesTotal_ == nullptr && return this->clusterId_ == nullptr && return this->completeTime_ == nullptr
        && return this->createdTime_ == nullptr && return this->crossAccountRoleName_ == nullptr && return this->crossAccountType_ == nullptr && return this->crossAccountUserId_ == nullptr && return this->errorFile_ == nullptr
        && return this->errorMessage_ == nullptr && return this->exclude_ == nullptr && return this->expireTime_ == nullptr && return this->failbackDetail_ == nullptr && return this->include_ == nullptr
        && return this->itemsDone_ == nullptr && return this->itemsTotal_ == nullptr && return this->meteringBytesDone_ == nullptr && return this->meteringBytesTotal_ == nullptr && return this->options_ == nullptr
        && return this->otsDetail_ == nullptr && return this->parentId_ == nullptr && return this->progress_ == nullptr && return this->report_ == nullptr && return this->restoreId_ == nullptr
        && return this->restoreType_ == nullptr && return this->snapshotHash_ == nullptr && return this->snapshotId_ == nullptr && return this->sourceInstanceId_ == nullptr && return this->sourceType_ == nullptr
        && return this->speed_ == nullptr && return this->startTime_ == nullptr && return this->status_ == nullptr && return this->storageClass_ == nullptr && return this->targetBucket_ == nullptr
        && return this->targetClientId_ == nullptr && return this->targetCreateTime_ == nullptr && return this->targetDataSourceId_ == nullptr && return this->targetFileSystemId_ == nullptr && return this->targetInstanceId_ == nullptr
        && return this->targetInstanceName_ == nullptr && return this->targetPath_ == nullptr && return this->targetPrefix_ == nullptr && return this->targetTableName_ == nullptr && return this->targetTime_ == nullptr
        && return this->udmDetail_ == nullptr && return this->updatedTime_ == nullptr && return this->vaultId_ == nullptr; };
