...
namespace Models
{
  ...
  public:
    ...
    inline const EnableBackupPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableBackupPlanResponseBody) };
    inline EnableBackupPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableBackupPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableBackupPlanResponseBody> body_ {};
  };
