...
#ifndef ALIBABACLOUD_MODELS_UPDATEPOLICYBINDINGREQUESTADVANCEDOPTIONSUDMDETAIL_HPP_
#define ALIBABACLOUD_MODELS_UPDATEPOLICYBINDINGREQUESTADVANCEDOPTIONSUDMDETAIL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& obj) { 
    ...
    UpdatePolicyBindingRequestAdvancedOptionsUdmDetail() = default ;
    UpdatePolicyBindingRequestAdvancedOptionsUdmDetail(const UpdatePolicyBindingRequestAdvancedOptionsUdmDetail &) = default ;
    UpdatePolicyBindingRequestAdvancedOptionsUdmDetail(UpdatePolicyBindingRequestAdvancedOptionsUdmDetail &&) = default ;
    UpdatePolicyBindingRequestAdvancedOptionsUdmDetail(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdatePolicyBindingRequestAdvancedOptionsUdmDetail() = default ;
    UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& operator=(const UpdatePolicyBindingRequestAdvancedOptionsUdmDetail &) = default ;
    UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& operator=(UpdatePolicyBindingRequestAdvancedOptionsUdmDetail &&) = default ;
    ...
    inline UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& setAppConsistent(bool appConsistent) { DARABONBA_PTR_SET_VALUE(appConsistent_, appConsistent) };
    ...
    inline UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& setDiskIdList(const vector<string> & diskIdList) { DARABONBA_PTR_SET_VALUE(diskIdList_, diskIdList) };
    inline UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& setDiskIdList(vector<string> && diskIdList) { DARABONBA_PTR_SET_RVALUE(diskIdList_, diskIdList) };
    ...
    inline UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& setEnableFsFreeze(bool enableFsFreeze) { DARABONBA_PTR_SET_VALUE(enableFsFreeze_, enableFsFreeze) };
    ...
    inline UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& setEnableWriters(bool enableWriters) { DARABONBA_PTR_SET_VALUE(enableWriters_, enableWriters) };
    ...
    inline UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& setExcludeDiskIdList(const vector<string> & excludeDiskIdList) { DARABONBA_PTR_SET_VALUE(excludeDiskIdList_, excludeDiskIdList) };
    inline UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& setExcludeDiskIdList(vector<string> && excludeDiskIdList) { DARABONBA_PTR_SET_RVALUE(excludeDiskIdList_, excludeDiskIdList) };
    ...
    inline UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& setPostScriptPath(string postScriptPath) { DARABONBA_PTR_SET_VALUE(postScriptPath_, postScriptPath) };
    ...
    inline UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& setPreScriptPath(string preScriptPath) { DARABONBA_PTR_SET_VALUE(preScriptPath_, preScriptPath) };
    ...
    inline UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& setRamRoleName(string ramRoleName) { DARABONBA_PTR_SET_VALUE(ramRoleName_, ramRoleName) };
    ...
    inline UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& setSnapshotGroup(bool snapshotGroup) { DARABONBA_PTR_SET_VALUE(snapshotGroup_, snapshotGroup) };
    ...
    inline UpdatePolicyBindingRequestAdvancedOptionsUdmDetail& setTimeoutInSeconds(int64_t timeoutInSeconds) { DARABONBA_PTR_SET_VALUE(timeoutInSeconds_, timeoutInSeconds) };
