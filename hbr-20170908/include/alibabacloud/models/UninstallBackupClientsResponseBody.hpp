...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UninstallBackupClientsResponseBodyInstanceStatuses> & instanceStatuses() const { DARABONBA_PTR_GET_CONST(instanceStatuses_, vector<UninstallBackupClientsResponseBodyInstanceStatuses>) };
    inline vector<UninstallBackupClientsResponseBodyInstanceStatuses> instanceStatuses() { DARABONBA_PTR_GET(instanceStatuses_, vector<UninstallBackupClientsResponseBodyInstanceStatuses>) };
    inline UninstallBackupClientsResponseBody& setInstanceStatuses(const vector<UninstallBackupClientsResponseBodyInstanceStatuses> & instanceStatuses) { DARABONBA_PTR_SET_VALUE(instanceStatuses_, instanceStatuses) };
    inline UninstallBackupClientsResponseBody& setInstanceStatuses(vector<UninstallBackupClientsResponseBodyInstanceStatuses> && instanceStatuses) { DARABONBA_PTR_SET_RVALUE(instanceStatuses_, instanceStatuses) };
  ...
  protected:
    ...
    std::shared_ptr<vector<UninstallBackupClientsResponseBodyInstanceStatuses>> instanceStatuses_ = nullptr;
