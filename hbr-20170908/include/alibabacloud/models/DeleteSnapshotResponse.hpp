...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSnapshotResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSnapshotResponseBody) };
    inline DeleteSnapshotResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSnapshotResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSnapshotResponseBody> body_ {};
  };
