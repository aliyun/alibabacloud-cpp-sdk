...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRestoreJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRestoreJobResponseBody) };
    inline CreateRestoreJobResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRestoreJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRestoreJobResponseBody> body_ {};
  };
