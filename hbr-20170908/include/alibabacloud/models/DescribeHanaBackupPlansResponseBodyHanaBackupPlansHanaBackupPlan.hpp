...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backupPrefix_ == nullptr
        && return this->backupType_ == nullptr && return this->businessStatus_ == nullptr && return this->clusterId_ == nullptr && return this->databaseName_ == nullptr && return this->disabled_ == nullptr
        && return this->planId_ == nullptr && return this->planName_ == nullptr && return this->schedule_ == nullptr && return this->vaultId_ == nullptr; };
