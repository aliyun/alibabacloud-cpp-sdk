...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePolicyBindingsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePolicyBindingsResponseBody) };
    inline CreatePolicyBindingsResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePolicyBindingsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePolicyBindingsResponseBody> body_ {};
  };
