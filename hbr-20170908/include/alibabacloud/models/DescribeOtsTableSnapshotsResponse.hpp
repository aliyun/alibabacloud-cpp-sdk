...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOtsTableSnapshotsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeOtsTableSnapshotsResponseBody) };
    inline DescribeOtsTableSnapshotsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeOtsTableSnapshotsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeOtsTableSnapshotsResponseBody> body_ {};
  };
