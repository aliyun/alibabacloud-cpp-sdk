...
namespace Models
{
  ...
  public:
    ...
    inline const StartHanaDatabaseAsyncResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartHanaDatabaseAsyncResponseBody) };
    inline StartHanaDatabaseAsyncResponseBody getBody() { DARABONBA_PTR_GET(body_, StartHanaDatabaseAsyncResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartHanaDatabaseAsyncResponseBody> body_ {};
  };
