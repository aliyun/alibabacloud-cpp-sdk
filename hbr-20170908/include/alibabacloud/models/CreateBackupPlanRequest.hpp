...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backupType_ == nullptr
        ...
        && this->destSourceType_ == nullptr && this->detail_ == nullptr && this->disabled_ == nullptr && this->edition_ == nullptr && this->exclude_ == nullptr
        ...
        && this->options_ == nullptr && this->otsDetail_ == nullptr && this->path_ == nullptr && this->planName_ == nullptr && this->prefix_ == nullptr
    ...
    inline CreateBackupPlanRequest& setEdition(string edition) { DARABONBA_PTR_SET_VALUE(edition_, edition) };
