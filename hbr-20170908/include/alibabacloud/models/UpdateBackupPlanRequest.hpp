...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->changeListPath_ == nullptr
        && return this->detail_ == nullptr && return this->edition_ == nullptr && return this->exclude_ == nullptr && return this->include_ == nullptr && return this->keepLatestSnapshots_ == nullptr
        && return this->options_ == nullptr && return this->otsDetail_ == nullptr && return this->path_ == nullptr && return this->planId_ == nullptr && return this->planName_ == nullptr
