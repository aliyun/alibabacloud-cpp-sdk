...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVaultReplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVaultReplicationResponseBody) };
    inline CreateVaultReplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVaultReplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVaultReplicationResponseBody> body_ {};
  };
