...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRecoverableOtsInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRecoverableOtsInstancesResponseBody) };
    inline DescribeRecoverableOtsInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRecoverableOtsInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRecoverableOtsInstancesResponseBody> body_ {};
  };
