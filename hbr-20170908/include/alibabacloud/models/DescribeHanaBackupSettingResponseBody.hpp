...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->hanaBackupSetting_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const DescribeHanaBackupSettingResponseBodyHanaBackupSetting & hanaBackupSetting() const { DARABONBA_PTR_GET_CONST(hanaBackupSetting_, DescribeHanaBackupSettingResponseBodyHanaBackupSetting) };
    inline DescribeHanaBackupSettingResponseBodyHanaBackupSetting hanaBackupSetting() { DARABONBA_PTR_GET(hanaBackupSetting_, DescribeHanaBackupSettingResponseBodyHanaBackupSetting) };
    inline DescribeHanaBackupSettingResponseBody& setHanaBackupSetting(const DescribeHanaBackupSettingResponseBodyHanaBackupSetting & hanaBackupSetting) { DARABONBA_PTR_SET_VALUE(hanaBackupSetting_, hanaBackupSetting) };
    inline DescribeHanaBackupSettingResponseBody& setHanaBackupSetting(DescribeHanaBackupSettingResponseBodyHanaBackupSetting && hanaBackupSetting) { DARABONBA_PTR_SET_RVALUE(hanaBackupSetting_, hanaBackupSetting) };
  ...
  protected:
    ...
    // The backup settings.
    std::shared_ptr<DescribeHanaBackupSettingResponseBodyHanaBackupSetting> hanaBackupSetting_ = nullptr;
