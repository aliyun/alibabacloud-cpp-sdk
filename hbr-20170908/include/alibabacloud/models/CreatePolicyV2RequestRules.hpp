...
#ifndef ALIBABACLOUD_MODELS_CREATEPOLICYV2REQUESTRULES_HPP_
#define ALIBABACLOUD_MODELS_CREATEPOLICYV2REQUESTRULES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePolicyV2RequestRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePolicyV2RequestRules& obj) { 
    ...
    CreatePolicyV2RequestRules() = default ;
    CreatePolicyV2RequestRules(const CreatePolicyV2RequestRules &) = default ;
    CreatePolicyV2RequestRules(CreatePolicyV2RequestRules &&) = default ;
    CreatePolicyV2RequestRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePolicyV2RequestRules() = default ;
    CreatePolicyV2RequestRules& operator=(const CreatePolicyV2RequestRules &) = default ;
    CreatePolicyV2RequestRules& operator=(CreatePolicyV2RequestRules &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->backupType_ == nullptr
        && return this->dataSourceFilters_ == nullptr && return this->immutable_ == nullptr && return this->keepLatestSnapshots_ == nullptr && return this->replicationRegionId_ == nullptr && return this->retention_ == nullptr
        && return this->retentionRules_ == nullptr && return this->ruleType_ == nullptr && return this->schedule_ == nullptr && return this->tagFilters_ == nullptr && return this->vaultId_ == nullptr; };
    // backupType Field Functions 
    bool hasBackupType() const { return this->backupType_ != nullptr;};
    void deleteBackupType() { this->backupType_ = nullptr;};
    inline string backupType() const { DARABONBA_PTR_GET_DEFAULT(backupType_, "") };
    inline CreatePolicyV2RequestRules& setBackupType(string backupType) { DARABONBA_PTR_SET_VALUE(backupType_, backupType) };
    ...
    inline const vector<Models::CreatePolicyV2RequestRulesDataSourceFilters> & dataSourceFilters() const { DARABONBA_PTR_GET_CONST(dataSourceFilters_, vector<Models::CreatePolicyV2RequestRulesDataSourceFilters>) };
    inline vector<Models::CreatePolicyV2RequestRulesDataSourceFilters> dataSourceFilters() { DARABONBA_PTR_GET(dataSourceFilters_, vector<Models::CreatePolicyV2RequestRulesDataSourceFilters>) };
    inline CreatePolicyV2RequestRules& setDataSourceFilters(const vector<Models::CreatePolicyV2RequestRulesDataSourceFilters> & dataSourceFilters) { DARABONBA_PTR_SET_VALUE(dataSourceFilters_, dataSourceFilters) };
    inline CreatePolicyV2RequestRules& setDataSourceFilters(vector<Models::CreatePolicyV2RequestRulesDataSourceFilters> && dataSourceFilters) { DARABONBA_PTR_SET_RVALUE(dataSourceFilters_, dataSourceFilters) };
    ...
    inline CreatePolicyV2RequestRules& setImmutable(bool immutable) { DARABONBA_PTR_SET_VALUE(immutable_, immutable) };
    ...
    inline CreatePolicyV2RequestRules& setKeepLatestSnapshots(int64_t keepLatestSnapshots) { DARABONBA_PTR_SET_VALUE(keepLatestSnapshots_, keepLatestSnapshots) };
    ...
    inline CreatePolicyV2RequestRules& setReplicationRegionId(string replicationRegionId) { DARABONBA_PTR_SET_VALUE(replicationRegionId_, replicationRegionId) };
    ...
    inline CreatePolicyV2RequestRules& setRetention(int64_t retention) { DARABONBA_PTR_SET_VALUE(retention_, retention) };
    ...
    inline const vector<Models::CreatePolicyV2RequestRulesRetentionRules> & retentionRules() const { DARABONBA_PTR_GET_CONST(retentionRules_, vector<Models::CreatePolicyV2RequestRulesRetentionRules>) };
    inline vector<Models::CreatePolicyV2RequestRulesRetentionRules> retentionRules() { DARABONBA_PTR_GET(retentionRules_, vector<Models::CreatePolicyV2RequestRulesRetentionRules>) };
    inline CreatePolicyV2RequestRules& setRetentionRules(const vector<Models::CreatePolicyV2RequestRulesRetentionRules> & retentionRules) { DARABONBA_PTR_SET_VALUE(retentionRules_, retentionRules) };
    inline CreatePolicyV2RequestRules& setRetentionRules(vector<Models::CreatePolicyV2RequestRulesRetentionRules> && retentionRules) { DARABONBA_PTR_SET_RVALUE(retentionRules_, retentionRules) };
    ...
    inline CreatePolicyV2RequestRules& setRuleType(string ruleType) { DARABONBA_PTR_SET_VALUE(ruleType_, ruleType) };
    ...
    inline CreatePolicyV2RequestRules& setSchedule(string schedule) { DARABONBA_PTR_SET_VALUE(schedule_, schedule) };
    ...
    inline const vector<Models::CreatePolicyV2RequestRulesTagFilters> & tagFilters() const { DARABONBA_PTR_GET_CONST(tagFilters_, vector<Models::CreatePolicyV2RequestRulesTagFilters>) };
    inline vector<Models::CreatePolicyV2RequestRulesTagFilters> tagFilters() { DARABONBA_PTR_GET(tagFilters_, vector<Models::CreatePolicyV2RequestRulesTagFilters>) };
    inline CreatePolicyV2RequestRules& setTagFilters(const vector<Models::CreatePolicyV2RequestRulesTagFilters> & tagFilters) { DARABONBA_PTR_SET_VALUE(tagFilters_, tagFilters) };
    inline CreatePolicyV2RequestRules& setTagFilters(vector<Models::CreatePolicyV2RequestRulesTagFilters> && tagFilters) { DARABONBA_PTR_SET_RVALUE(tagFilters_, tagFilters) };
    ...
    inline CreatePolicyV2RequestRules& setVaultId(string vaultId) { DARABONBA_PTR_SET_VALUE(vaultId_, vaultId) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::CreatePolicyV2RequestRulesDataSourceFilters>> dataSourceFilters_ = nullptr;
    ...
    std::shared_ptr<vector<Models::CreatePolicyV2RequestRulesRetentionRules>> retentionRules_ = nullptr;
    ...
    std::shared_ptr<vector<Models::CreatePolicyV2RequestRulesTagFilters>> tagFilters_ = nullptr;
