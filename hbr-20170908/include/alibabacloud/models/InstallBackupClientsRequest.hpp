...
#ifndef ALIBABACLOUD_MODELS_INSTALLBACKUPCLIENTSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_INSTALLBACKUPCLIENTSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const InstallBackupClientsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, InstallBackupClientsRequest& obj) { 
    ...
    InstallBackupClientsRequest() = default ;
    InstallBackupClientsRequest(const InstallBackupClientsRequest &) = default ;
    InstallBackupClientsRequest(InstallBackupClientsRequest &&) = default ;
    InstallBackupClientsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~InstallBackupClientsRequest() = default ;
    InstallBackupClientsRequest& operator=(const InstallBackupClientsRequest &) = default ;
    InstallBackupClientsRequest& operator=(InstallBackupClientsRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->crossAccountRoleName_ == nullptr
        && return this->crossAccountType_ == nullptr && return this->crossAccountUserId_ == nullptr && return this->instanceIds_ == nullptr; };
    ...
    inline InstallBackupClientsRequest& setCrossAccountRoleName(string crossAccountRoleName) { DARABONBA_PTR_SET_VALUE(crossAccountRoleName_, crossAccountRoleName) };
    ...
    inline InstallBackupClientsRequest& setCrossAccountType(string crossAccountType) { DARABONBA_PTR_SET_VALUE(crossAccountType_, crossAccountType) };
    ...
    inline InstallBackupClientsRequest& setCrossAccountUserId(int64_t crossAccountUserId) { DARABONBA_PTR_SET_VALUE(crossAccountUserId_, crossAccountUserId) };
    ...
    inline InstallBackupClientsRequest& setInstanceIds(const Darabonba::Json & instanceIds) { DARABONBA_SET_VALUE(instanceIds_, instanceIds) };
    inline InstallBackupClientsRequest& setInstanceIds(Darabonba::Json & instanceIds) { DARABONBA_SET_RVALUE(instanceIds_, instanceIds) };
