...
namespace Models
{
  ...
  public:
    ...
    inline const vector<InstallBackupClientsResponseBody::InstanceStatuses> & getInstanceStatuses() const { DARABONBA_PTR_GET_CONST(instanceStatuses_, vector<InstallBackupClientsResponseBody::InstanceStatuses>) };
    inline vector<InstallBackupClientsResponseBody::InstanceStatuses> getInstanceStatuses() { DARABONBA_PTR_GET(instanceStatuses_, vector<InstallBackupClientsResponseBody::InstanceStatuses>) };
    inline InstallBackupClientsResponseBody& setInstanceStatuses(const vector<InstallBackupClientsResponseBody::InstanceStatuses> & instanceStatuses) { DARABONBA_PTR_SET_VALUE(instanceStatuses_, instanceStatuses) };
    inline InstallBackupClientsResponseBody& setInstanceStatuses(vector<InstallBackupClientsResponseBody::InstanceStatuses> && instanceStatuses) { DARABONBA_PTR_SET_RVALUE(instanceStatuses_, instanceStatuses) };
  ...
  protected:
    ...
    shared_ptr<vector<InstallBackupClientsResponseBody::InstanceStatuses>> instanceStatuses_ {};
