...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHanaRetentionSettingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHanaRetentionSettingResponseBody) };
    inline DescribeHanaRetentionSettingResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHanaRetentionSettingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHanaRetentionSettingResponseBody> body_ {};
  };
