...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteClientResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteClientResponseBody) };
    inline DeleteClientResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteClientResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteClientResponseBody> body_ {};
  };
