...
namespace Models
{
  ...
  public:
    ...
    inline string getIndexNameSuffix() const { DARABONBA_PTR_GET_DEFAULT(indexNameSuffix_, "") };
    ...
    inline bool getReGenerateAutoIncrementPK() const { DARABONBA_PTR_GET_DEFAULT(reGenerateAutoIncrementPK_, false) };
    ...
    inline bool getRestoreIndex() const { DARABONBA_PTR_GET_DEFAULT(restoreIndex_, false) };
    ...
    inline bool getRestoreSearchIndex() const { DARABONBA_PTR_GET_DEFAULT(restoreSearchIndex_, false) };
    ...
    inline string getSearchIndexNameSuffix() const { DARABONBA_PTR_GET_DEFAULT(searchIndexNameSuffix_, "") };
