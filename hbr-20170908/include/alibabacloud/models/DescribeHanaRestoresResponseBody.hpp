...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->hanaRestore_ == nullptr && return this->message_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->requestId_ == nullptr
    ...
    inline const DescribeHanaRestoresResponseBodyHanaRestore & hanaRestore() const { DARABONBA_PTR_GET_CONST(hanaRestore_, DescribeHanaRestoresResponseBodyHanaRestore) };
    inline DescribeHanaRestoresResponseBodyHanaRestore hanaRestore() { DARABONBA_PTR_GET(hanaRestore_, DescribeHanaRestoresResponseBodyHanaRestore) };
    inline DescribeHanaRestoresResponseBody& setHanaRestore(const DescribeHanaRestoresResponseBodyHanaRestore & hanaRestore) { DARABONBA_PTR_SET_VALUE(hanaRestore_, hanaRestore) };
    inline DescribeHanaRestoresResponseBody& setHanaRestore(DescribeHanaRestoresResponseBodyHanaRestore && hanaRestore) { DARABONBA_PTR_SET_RVALUE(hanaRestore_, hanaRestore) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeHanaRestoresResponseBodyHanaRestore> hanaRestore_ = nullptr;
