...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePolicyV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePolicyV2ResponseBody) };
    inline DeletePolicyV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePolicyV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePolicyV2ResponseBody> body_ {};
  };
