...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHanaInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHanaInstancesResponseBody) };
    inline DescribeHanaInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHanaInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHanaInstancesResponseBody> body_ {};
  };
