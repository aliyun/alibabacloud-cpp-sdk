...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteBackupClientResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteBackupClientResponseBody) };
    inline DeleteBackupClientResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteBackupClientResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteBackupClientResponseBody> body_ {};
  };
