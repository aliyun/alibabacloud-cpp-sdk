...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->crossAccountRoleName_ != nullptr
        && this->crossAccountType_ != nullptr && this->crossAccountUserId_ != nullptr && this->exclude_ != nullptr && this->failbackDetailShrink_ != nullptr && this->include_ != nullptr
        && this->initiatedByAck_ != nullptr && this->options_ != nullptr && this->otsDetailShrink_ != nullptr && this->restoreType_ != nullptr && this->snapshotHash_ != nullptr
        ...
        && this->targetPrefix_ != nullptr && this->targetTableName_ != nullptr && this->targetTime_ != nullptr && this->udmDetailShrink_ != nullptr && this->udmRegionId_ != nullptr
