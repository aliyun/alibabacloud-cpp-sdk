...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCrossAccountsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCrossAccountsResponseBody) };
    inline DescribeCrossAccountsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCrossAccountsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCrossAccountsResponseBody> body_ {};
  };
