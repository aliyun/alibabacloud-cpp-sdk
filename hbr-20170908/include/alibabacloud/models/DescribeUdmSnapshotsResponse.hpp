...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUdmSnapshotsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUdmSnapshotsResponseBody) };
    inline DescribeUdmSnapshotsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUdmSnapshotsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUdmSnapshotsResponseBody> body_ {};
  };
