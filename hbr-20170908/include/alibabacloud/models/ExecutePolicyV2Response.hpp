...
namespace Models
{
  ...
  public:
    ...
    inline const ExecutePolicyV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExecutePolicyV2ResponseBody) };
    inline ExecutePolicyV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, ExecutePolicyV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExecutePolicyV2ResponseBody> body_ {};
  };
