...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeClientResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeClientResponseBody) };
    inline UpgradeClientResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeClientResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeClientResponseBody> body_ {};
  };
