...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateHanaRetentionSettingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateHanaRetentionSettingResponseBody) };
    inline UpdateHanaRetentionSettingResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateHanaRetentionSettingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateHanaRetentionSettingResponseBody> body_ {};
  };
