...
namespace Models
{
  ...
  public:
    ...
    inline const InstallBackupClientsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InstallBackupClientsResponseBody) };
    inline InstallBackupClientsResponseBody getBody() { DARABONBA_PTR_GET(body_, InstallBackupClientsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InstallBackupClientsResponseBody> body_ {};
  };
