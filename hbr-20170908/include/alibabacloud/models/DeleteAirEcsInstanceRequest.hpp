...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getUninstallClientSourceTypes() const { DARABONBA_PTR_GET_CONST(uninstallClientSourceTypes_, vector<string>) };
    inline vector<string> getUninstallClientSourceTypes() { DARABONBA_PTR_GET(uninstallClientSourceTypes_, vector<string>) };
