...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterId_ == nullptr
        && this->description_ == nullptr && this->name_ == nullptr && this->networkType_ == nullptr && this->renewToken_ == nullptr; };
    ...
    inline bool getRenewToken() const { DARABONBA_PTR_GET_DEFAULT(renewToken_, false) };
