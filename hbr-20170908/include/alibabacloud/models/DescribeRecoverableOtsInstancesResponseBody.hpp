...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->message_ == nullptr && return this->otsInstances_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const vector<DescribeRecoverableOtsInstancesResponseBodyOtsInstances> & otsInstances() const { DARABONBA_PTR_GET_CONST(otsInstances_, vector<DescribeRecoverableOtsInstancesResponseBodyOtsInstances>) };
    inline vector<DescribeRecoverableOtsInstancesResponseBodyOtsInstances> otsInstances() { DARABONBA_PTR_GET(otsInstances_, vector<DescribeRecoverableOtsInstancesResponseBodyOtsInstances>) };
    inline DescribeRecoverableOtsInstancesResponseBody& setOtsInstances(const vector<DescribeRecoverableOtsInstancesResponseBodyOtsInstances> & otsInstances) { DARABONBA_PTR_SET_VALUE(otsInstances_, otsInstances) };
    inline DescribeRecoverableOtsInstancesResponseBody& setOtsInstances(vector<DescribeRecoverableOtsInstancesResponseBodyOtsInstances> && otsInstances) { DARABONBA_PTR_SET_RVALUE(otsInstances_, otsInstances) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeRecoverableOtsInstancesResponseBodyOtsInstances>> otsInstances_ = nullptr;
    // The request ID.
