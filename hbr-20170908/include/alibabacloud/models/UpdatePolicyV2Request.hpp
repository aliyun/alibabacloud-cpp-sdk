...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline int64_t getColdArchiveDays() const { DARABONBA_PTR_GET_DEFAULT(coldArchiveDays_, 0L) };
      inline Rules& setColdArchiveDays(int64_t coldArchiveDays) { DARABONBA_PTR_SET_VALUE(coldArchiveDays_, coldArchiveDays) };
    ...
    protected:
      ...
      shared_ptr<int64_t> coldArchiveDays_ {};
    ...
    inline const vector<UpdatePolicyV2Request::Rules> & getRules() const { DARABONBA_PTR_GET_CONST(rules_, vector<UpdatePolicyV2Request::Rules>) };
    inline vector<UpdatePolicyV2Request::Rules> getRules() { DARABONBA_PTR_GET(rules_, vector<UpdatePolicyV2Request::Rules>) };
    inline UpdatePolicyV2Request& setRules(const vector<UpdatePolicyV2Request::Rules> & rules) { DARABONBA_PTR_SET_VALUE(rules_, rules) };
    inline UpdatePolicyV2Request& setRules(vector<UpdatePolicyV2Request::Rules> && rules) { DARABONBA_PTR_SET_RVALUE(rules_, rules) };
  ...
  protected:
    ...
    shared_ptr<vector<UpdatePolicyV2Request::Rules>> rules_ {};
  };
