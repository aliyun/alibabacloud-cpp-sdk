...
#ifndef ALIBABACLOUD_MODELS_UPDATEPOLICYBINDINGREQUESTADVANCEDOPTIONSOSSDETAIL_HPP_
#define ALIBABACLOUD_MODELS_UPDATEPOLICYBINDINGREQUESTADVANCEDOPTIONSOSSDETAIL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdatePolicyBindingRequestAdvancedOptionsOssDetail& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdatePolicyBindingRequestAdvancedOptionsOssDetail& obj) { 
    ...
    UpdatePolicyBindingRequestAdvancedOptionsOssDetail() = default ;
    UpdatePolicyBindingRequestAdvancedOptionsOssDetail(const UpdatePolicyBindingRequestAdvancedOptionsOssDetail &) = default ;
    UpdatePolicyBindingRequestAdvancedOptionsOssDetail(UpdatePolicyBindingRequestAdvancedOptionsOssDetail &&) = default ;
    UpdatePolicyBindingRequestAdvancedOptionsOssDetail(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdatePolicyBindingRequestAdvancedOptionsOssDetail() = default ;
    UpdatePolicyBindingRequestAdvancedOptionsOssDetail& operator=(const UpdatePolicyBindingRequestAdvancedOptionsOssDetail &) = default ;
    UpdatePolicyBindingRequestAdvancedOptionsOssDetail& operator=(UpdatePolicyBindingRequestAdvancedOptionsOssDetail &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->ignoreArchiveObject_ == nullptr
        && return this->inventoryCleanupPolicy_ == nullptr && return this->inventoryId_ == nullptr; };
    ...
    inline UpdatePolicyBindingRequestAdvancedOptionsOssDetail& setIgnoreArchiveObject(bool ignoreArchiveObject) { DARABONBA_PTR_SET_VALUE(ignoreArchiveObject_, ignoreArchiveObject) };
    ...
    inline UpdatePolicyBindingRequestAdvancedOptionsOssDetail& setInventoryCleanupPolicy(string inventoryCleanupPolicy) { DARABONBA_PTR_SET_VALUE(inventoryCleanupPolicy_, inventoryCleanupPolicy) };
    ...
    inline UpdatePolicyBindingRequestAdvancedOptionsOssDetail& setInventoryId(string inventoryId) { DARABONBA_PTR_SET_VALUE(inventoryId_, inventoryId) };
