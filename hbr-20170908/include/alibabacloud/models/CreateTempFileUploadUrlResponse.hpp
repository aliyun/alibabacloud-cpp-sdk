...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTempFileUploadUrlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTempFileUploadUrlResponseBody) };
    inline CreateTempFileUploadUrlResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTempFileUploadUrlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTempFileUploadUrlResponseBody> body_ {};
  };
