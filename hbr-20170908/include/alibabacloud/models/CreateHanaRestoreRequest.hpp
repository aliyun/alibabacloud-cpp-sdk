...
namespace Models
{
  ...
  public:
    ...
    inline string masterClientId() const { DARABONBA_PTR_GET_DEFAULT(masterClientId_, "") };
    ...
    inline string sidAdmin() const { DARABONBA_PTR_GET_DEFAULT(sidAdmin_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> masterClientId_ = nullptr;
    ...
    std::shared_ptr<string> sidAdmin_ = nullptr;
