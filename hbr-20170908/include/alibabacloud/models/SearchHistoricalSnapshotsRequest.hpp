...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Darabonba::Json> & getQuery() const { DARABONBA_PTR_GET_CONST(query_, vector<Darabonba::Json>) };
    inline vector<Darabonba::Json> getQuery() { DARABONBA_PTR_GET(query_, vector<Darabonba::Json>) };
