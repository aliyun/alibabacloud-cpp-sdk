...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHanaBackupSettingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHanaBackupSettingResponseBody) };
    inline DescribeHanaBackupSettingResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHanaBackupSettingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHanaBackupSettingResponseBody> body_ {};
  };
