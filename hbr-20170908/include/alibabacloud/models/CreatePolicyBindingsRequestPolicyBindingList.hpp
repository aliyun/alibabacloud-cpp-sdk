...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->advancedOptions_ == nullptr
        && return this->crossAccountRoleName_ == nullptr && return this->crossAccountType_ == nullptr && return this->crossAccountUserId_ == nullptr && return this->dataSourceId_ == nullptr && return this->disabled_ == nullptr
        && return this->exclude_ == nullptr && return this->include_ == nullptr && return this->policyBindingDescription_ == nullptr && return this->source_ == nullptr && return this->sourceType_ == nullptr
        && return this->speedLimit_ == nullptr; };
