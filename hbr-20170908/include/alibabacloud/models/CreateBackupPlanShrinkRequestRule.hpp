...
#ifndef ALIBABACLOUD_MODELS_CREATEBACKUPPLANSHRINKREQUESTRULE_HPP_
#define ALIBABACLOUD_MODELS_CREATEBACKUPPLANSHRINKREQUESTRULE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateBackupPlanShrinkRequestRule& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateBackupPlanShrinkRequestRule& obj) { 
    ...
    CreateBackupPlanShrinkRequestRule() = default ;
    CreateBackupPlanShrinkRequestRule(const CreateBackupPlanShrinkRequestRule &) = default ;
    CreateBackupPlanShrinkRequestRule(CreateBackupPlanShrinkRequestRule &&) = default ;
    CreateBackupPlanShrinkRequestRule(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateBackupPlanShrinkRequestRule() = default ;
    CreateBackupPlanShrinkRequestRule& operator=(const CreateBackupPlanShrinkRequestRule &) = default ;
    CreateBackupPlanShrinkRequestRule& operator=(CreateBackupPlanShrinkRequestRule &&) = default ;
    ...
    inline CreateBackupPlanShrinkRequestRule& setBackupType(string backupType) { DARABONBA_PTR_SET_VALUE(backupType_, backupType) };
    ...
    inline CreateBackupPlanShrinkRequestRule& setDestinationRegionId(string destinationRegionId) { DARABONBA_PTR_SET_VALUE(destinationRegionId_, destinationRegionId) };
    ...
    inline CreateBackupPlanShrinkRequestRule& setDestinationRetention(int64_t destinationRetention) { DARABONBA_PTR_SET_VALUE(destinationRetention_, destinationRetention) };
    ...
    inline CreateBackupPlanShrinkRequestRule& setDisabled(bool disabled) { DARABONBA_PTR_SET_VALUE(disabled_, disabled) };
    ...
    inline CreateBackupPlanShrinkRequestRule& setDoCopy(bool doCopy) { DARABONBA_PTR_SET_VALUE(doCopy_, doCopy) };
    ...
    inline CreateBackupPlanShrinkRequestRule& setRetention(int64_t retention) { DARABONBA_PTR_SET_VALUE(retention_, retention) };
    ...
    inline CreateBackupPlanShrinkRequestRule& setRuleName(string ruleName) { DARABONBA_PTR_SET_VALUE(ruleName_, ruleName) };
    ...
    inline CreateBackupPlanShrinkRequestRule& setSchedule(string schedule) { DARABONBA_PTR_SET_VALUE(schedule_, schedule) };
