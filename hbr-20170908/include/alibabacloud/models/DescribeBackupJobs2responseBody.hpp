...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->backupJobs_ != nullptr
    ...
    inline const DescribeBackupJobs2ResponseBodyBackupJobs & backupJobs() const { DARABONBA_PTR_GET_CONST(backupJobs_, DescribeBackupJobs2ResponseBodyBackupJobs) };
    inline DescribeBackupJobs2ResponseBodyBackupJobs backupJobs() { DARABONBA_PTR_GET(backupJobs_, DescribeBackupJobs2ResponseBodyBackupJobs) };
    inline DescribeBackupJobs2ResponseBody& setBackupJobs(const DescribeBackupJobs2ResponseBodyBackupJobs & backupJobs) { DARABONBA_PTR_SET_VALUE(backupJobs_, backupJobs) };
    inline DescribeBackupJobs2ResponseBody& setBackupJobs(DescribeBackupJobs2ResponseBodyBackupJobs && backupJobs) { DARABONBA_PTR_SET_RVALUE(backupJobs_, backupJobs) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeBackupJobs2ResponseBodyBackupJobs> backupJobs_ = nullptr;
