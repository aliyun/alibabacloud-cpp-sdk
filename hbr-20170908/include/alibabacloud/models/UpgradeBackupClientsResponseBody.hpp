...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpgradeBackupClientsResponseBody::InstanceStatuses> & getInstanceStatuses() const { DARABONBA_PTR_GET_CONST(instanceStatuses_, vector<UpgradeBackupClientsResponseBody::InstanceStatuses>) };
    inline vector<UpgradeBackupClientsResponseBody::InstanceStatuses> getInstanceStatuses() { DARABONBA_PTR_GET(instanceStatuses_, vector<UpgradeBackupClientsResponseBody::InstanceStatuses>) };
    inline UpgradeBackupClientsResponseBody& setInstanceStatuses(const vector<UpgradeBackupClientsResponseBody::InstanceStatuses> & instanceStatuses) { DARABONBA_PTR_SET_VALUE(instanceStatuses_, instanceStatuses) };
    inline UpgradeBackupClientsResponseBody& setInstanceStatuses(vector<UpgradeBackupClientsResponseBody::InstanceStatuses> && instanceStatuses) { DARABONBA_PTR_SET_RVALUE(instanceStatuses_, instanceStatuses) };
  ...
  protected:
    ...
    shared_ptr<vector<UpgradeBackupClientsResponseBody::InstanceStatuses>> instanceStatuses_ {};
