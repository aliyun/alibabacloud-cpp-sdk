...
namespace Models
{
  ...
  public:
    ...
    inline const DisableHanaBackupPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableHanaBackupPlanResponseBody) };
    inline DisableHanaBackupPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableHanaBackupPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableHanaBackupPlanResponseBody> body_ {};
  };
