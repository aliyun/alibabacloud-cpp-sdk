...
namespace Models
{
  ...
  public:
    ...
    inline const DeactiveAggregateConfigRulesResponseBody::OperateRuleResult & getOperateRuleResult() const { DARABONBA_PTR_GET_CONST(operateRuleResult_, DeactiveAggregateConfigRulesResponseBody::OperateRuleResult) };
    inline DeactiveAggregateConfigRulesResponseBody::OperateRuleResult getOperateRuleResult() { DARABONBA_PTR_GET(operateRuleResult_, DeactiveAggregateConfigRulesResponseBody::OperateRuleResult) };
    inline DeactiveAggregateConfigRulesResponseBody& setOperateRuleResult(const DeactiveAggregateConfigRulesResponseBody::OperateRuleResult & operateRuleResult) { DARABONBA_PTR_SET_VALUE(operateRuleResult_, operateRuleResult) };
    inline DeactiveAggregateConfigRulesResponseBody& setOperateRuleResult(DeactiveAggregateConfigRulesResponseBody::OperateRuleResult && operateRuleResult) { DARABONBA_PTR_SET_RVALUE(operateRuleResult_, operateRuleResult) };
  ...
  protected:
    ...
    shared_ptr<DeactiveAggregateConfigRulesResponseBody::OperateRuleResult> operateRuleResult_ {};
    // The request ID.
