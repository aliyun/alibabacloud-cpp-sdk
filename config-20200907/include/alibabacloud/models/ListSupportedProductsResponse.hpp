...
namespace Models
{
  ...
  public:
    ...
    inline const ListSupportedProductsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListSupportedProductsResponseBody) };
    inline ListSupportedProductsResponseBody body() { DARABONBA_PTR_GET(body_, ListSupportedProductsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListSupportedProductsResponseBody> body_ = nullptr;
  };
