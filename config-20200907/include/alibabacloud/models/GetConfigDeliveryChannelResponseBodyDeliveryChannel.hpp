...
#ifndef ALIBABACLOUD_MODELS_GETCONFIGDELIVERYCHANNELRESPONSEBODYDELIVERYCHANNEL_HPP_
#define ALIBABACLOUD_MODELS_GETCONFIGDELIVERYCHANNELRESPONSEBODYDELIVERYCHANNEL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetConfigDeliveryChannelResponseBodyDeliveryChannel& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetConfigDeliveryChannelResponseBodyDeliveryChannel& obj) { 
    ...
    GetConfigDeliveryChannelResponseBodyDeliveryChannel() = default ;
    GetConfigDeliveryChannelResponseBodyDeliveryChannel(const GetConfigDeliveryChannelResponseBodyDeliveryChannel &) = default ;
    GetConfigDeliveryChannelResponseBodyDeliveryChannel(GetConfigDeliveryChannelResponseBodyDeliveryChannel &&) = default ;
    GetConfigDeliveryChannelResponseBodyDeliveryChannel(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetConfigDeliveryChannelResponseBodyDeliveryChannel() = default ;
    GetConfigDeliveryChannelResponseBodyDeliveryChannel& operator=(const GetConfigDeliveryChannelResponseBodyDeliveryChannel &) = default ;
    GetConfigDeliveryChannelResponseBodyDeliveryChannel& operator=(GetConfigDeliveryChannelResponseBodyDeliveryChannel &&) = default ;
    ...
    inline GetConfigDeliveryChannelResponseBodyDeliveryChannel& setAccountId(int64_t accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
    ...
    inline GetConfigDeliveryChannelResponseBodyDeliveryChannel& setCompliantSnapshot(bool compliantSnapshot) { DARABONBA_PTR_SET_VALUE(compliantSnapshot_, compliantSnapshot) };
    ...
    inline GetConfigDeliveryChannelResponseBodyDeliveryChannel& setConfigurationItemChangeNotification(bool configurationItemChangeNotification) { DARABONBA_PTR_SET_VALUE(configurationItemChangeNotification_, configurationItemChangeNotification) };
    ...
    inline GetConfigDeliveryChannelResponseBodyDeliveryChannel& setConfigurationSnapshot(bool configurationSnapshot) { DARABONBA_PTR_SET_VALUE(configurationSnapshot_, configurationSnapshot) };
    ...
    inline GetConfigDeliveryChannelResponseBodyDeliveryChannel& setDeliveryChannelAssumeRoleArn(string deliveryChannelAssumeRoleArn) { DARABONBA_PTR_SET_VALUE(deliveryChannelAssumeRoleArn_, deliveryChannelAssumeRoleArn) };
    ...
    inline GetConfigDeliveryChannelResponseBodyDeliveryChannel& setDeliveryChannelCondition(string deliveryChannelCondition) { DARABONBA_PTR_SET_VALUE(deliveryChannelCondition_, deliveryChannelCondition) };
    ...
    inline GetConfigDeliveryChannelResponseBodyDeliveryChannel& setDeliveryChannelId(string deliveryChannelId) { DARABONBA_PTR_SET_VALUE(deliveryChannelId_, deliveryChannelId) };
    ...
    inline GetConfigDeliveryChannelResponseBodyDeliveryChannel& setDeliveryChannelName(string deliveryChannelName) { DARABONBA_PTR_SET_VALUE(deliveryChannelName_, deliveryChannelName) };
    ...
    inline GetConfigDeliveryChannelResponseBodyDeliveryChannel& setDeliveryChannelTargetArn(string deliveryChannelTargetArn) { DARABONBA_PTR_SET_VALUE(deliveryChannelTargetArn_, deliveryChannelTargetArn) };
    ...
    inline GetConfigDeliveryChannelResponseBodyDeliveryChannel& setDeliveryChannelType(string deliveryChannelType) { DARABONBA_PTR_SET_VALUE(deliveryChannelType_, deliveryChannelType) };
    ...
    inline GetConfigDeliveryChannelResponseBodyDeliveryChannel& setDeliverySnapshotTime(string deliverySnapshotTime) { DARABONBA_PTR_SET_VALUE(deliverySnapshotTime_, deliverySnapshotTime) };
    ...
    inline GetConfigDeliveryChannelResponseBodyDeliveryChannel& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline GetConfigDeliveryChannelResponseBodyDeliveryChannel& setNonCompliantNotification(bool nonCompliantNotification) { DARABONBA_PTR_SET_VALUE(nonCompliantNotification_, nonCompliantNotification) };
    ...
    inline GetConfigDeliveryChannelResponseBodyDeliveryChannel& setOversizedDataOSSTargetArn(string oversizedDataOSSTargetArn) { DARABONBA_PTR_SET_VALUE(oversizedDataOSSTargetArn_, oversizedDataOSSTargetArn) };
    ...
    inline GetConfigDeliveryChannelResponseBodyDeliveryChannel& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
