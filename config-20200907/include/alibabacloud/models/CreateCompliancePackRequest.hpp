...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->compliancePackName_ == nullptr && this->compliancePackTemplateId_ == nullptr && this->configRules_ == nullptr && this->defaultEnable_ == nullptr && this->description_ == nullptr
        ...
        && this->tagValueScope_ == nullptr && this->tagsScope_ == nullptr && this->templateContent_ == nullptr; };
    ...
    inline const vector<CreateCompliancePackRequest::ConfigRules> & getConfigRules() const { DARABONBA_PTR_GET_CONST(configRules_, vector<CreateCompliancePackRequest::ConfigRules>) };
    inline vector<CreateCompliancePackRequest::ConfigRules> getConfigRules() { DARABONBA_PTR_GET(configRules_, vector<CreateCompliancePackRequest::ConfigRules>) };
    inline CreateCompliancePackRequest& setConfigRules(const vector<CreateCompliancePackRequest::ConfigRules> & configRules) { DARABONBA_PTR_SET_VALUE(configRules_, configRules) };
    inline CreateCompliancePackRequest& setConfigRules(vector<CreateCompliancePackRequest::ConfigRules> && configRules) { DARABONBA_PTR_SET_RVALUE(configRules_, configRules) };
    ...
    inline const vector<CreateCompliancePackRequest::ExcludeTagsScope> & getExcludeTagsScope() const { DARABONBA_PTR_GET_CONST(excludeTagsScope_, vector<CreateCompliancePackRequest::ExcludeTagsScope>) };
    inline vector<CreateCompliancePackRequest::ExcludeTagsScope> getExcludeTagsScope() { DARABONBA_PTR_GET(excludeTagsScope_, vector<CreateCompliancePackRequest::ExcludeTagsScope>) };
    inline CreateCompliancePackRequest& setExcludeTagsScope(const vector<CreateCompliancePackRequest::ExcludeTagsScope> & excludeTagsScope) { DARABONBA_PTR_SET_VALUE(excludeTagsScope_, excludeTagsScope) };
    inline CreateCompliancePackRequest& setExcludeTagsScope(vector<CreateCompliancePackRequest::ExcludeTagsScope> && excludeTagsScope) { DARABONBA_PTR_SET_RVALUE(excludeTagsScope_, excludeTagsScope) };
    ...
    inline const vector<CreateCompliancePackRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateCompliancePackRequest::Tag>) };
    inline vector<CreateCompliancePackRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateCompliancePackRequest::Tag>) };
    inline CreateCompliancePackRequest& setTag(const vector<CreateCompliancePackRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateCompliancePackRequest& setTag(vector<CreateCompliancePackRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
    ...
    inline const vector<CreateCompliancePackRequest::TagsScope> & getTagsScope() const { DARABONBA_PTR_GET_CONST(tagsScope_, vector<CreateCompliancePackRequest::TagsScope>) };
    inline vector<CreateCompliancePackRequest::TagsScope> getTagsScope() { DARABONBA_PTR_GET(tagsScope_, vector<CreateCompliancePackRequest::TagsScope>) };
    inline CreateCompliancePackRequest& setTagsScope(const vector<CreateCompliancePackRequest::TagsScope> & tagsScope) { DARABONBA_PTR_SET_VALUE(tagsScope_, tagsScope) };
    inline CreateCompliancePackRequest& setTagsScope(vector<CreateCompliancePackRequest::TagsScope> && tagsScope) { DARABONBA_PTR_SET_RVALUE(tagsScope_, tagsScope) };
