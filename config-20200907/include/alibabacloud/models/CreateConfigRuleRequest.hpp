...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        ...
        && return this->excludeResourceIdsScope_ == nullptr && return this->excludeTagsScope_ == nullptr && return this->extendContent_ == nullptr && return this->inputParameters_ == nullptr && return this->maximumExecutionFrequency_ == nullptr
    ...
    inline const vector<CreateConfigRuleRequestExcludeTagsScope> & excludeTagsScope() const { DARABONBA_PTR_GET_CONST(excludeTagsScope_, vector<CreateConfigRuleRequestExcludeTagsScope>) };
    inline vector<CreateConfigRuleRequestExcludeTagsScope> excludeTagsScope() { DARABONBA_PTR_GET(excludeTagsScope_, vector<CreateConfigRuleRequestExcludeTagsScope>) };
    inline CreateConfigRuleRequest& setExcludeTagsScope(const vector<CreateConfigRuleRequestExcludeTagsScope> & excludeTagsScope) { DARABONBA_PTR_SET_VALUE(excludeTagsScope_, excludeTagsScope) };
    inline CreateConfigRuleRequest& setExcludeTagsScope(vector<CreateConfigRuleRequestExcludeTagsScope> && excludeTagsScope) { DARABONBA_PTR_SET_RVALUE(excludeTagsScope_, excludeTagsScope) };
    ...
    inline const vector<CreateConfigRuleRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateConfigRuleRequestTag>) };
    inline vector<CreateConfigRuleRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<CreateConfigRuleRequestTag>) };
    inline CreateConfigRuleRequest& setTag(const vector<CreateConfigRuleRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateConfigRuleRequest& setTag(vector<CreateConfigRuleRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
    ...
    inline const vector<CreateConfigRuleRequestTagsScope> & tagsScope() const { DARABONBA_PTR_GET_CONST(tagsScope_, vector<CreateConfigRuleRequestTagsScope>) };
    inline vector<CreateConfigRuleRequestTagsScope> tagsScope() { DARABONBA_PTR_GET(tagsScope_, vector<CreateConfigRuleRequestTagsScope>) };
    inline CreateConfigRuleRequest& setTagsScope(const vector<CreateConfigRuleRequestTagsScope> & tagsScope) { DARABONBA_PTR_SET_VALUE(tagsScope_, tagsScope) };
    inline CreateConfigRuleRequest& setTagsScope(vector<CreateConfigRuleRequestTagsScope> && tagsScope) { DARABONBA_PTR_SET_RVALUE(tagsScope_, tagsScope) };
  ...
  protected:
    ...
    // ExcludeTagsScope
    std::shared_ptr<vector<CreateConfigRuleRequestExcludeTagsScope>> excludeTagsScope_ = nullptr;
    ...
    // rule attached tags
    std::shared_ptr<vector<CreateConfigRuleRequestTag>> tag_ = nullptr;
    ...
    // TagsScope
    std::shared_ptr<vector<CreateConfigRuleRequestTagsScope>> tagsScope_ = nullptr;
  };
