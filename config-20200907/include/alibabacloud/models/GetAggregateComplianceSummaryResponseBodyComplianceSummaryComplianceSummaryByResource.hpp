...
#ifndef ALIBABACLOUD_MODELS_GETAGGREGATECOMPLIANCESUMMARYRESPONSEBODYCOMPLIANCESUMMARYCOMPLIANCESUMMARYBYRESOURCE_HPP_
#define ALIBABACLOUD_MODELS_GETAGGREGATECOMPLIANCESUMMARYRESPONSEBODYCOMPLIANCESUMMARYCOMPLIANCESUMMARYBYRESOURCE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource& obj) { 
    ...
    GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource() = default ;
    GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource(const GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource &) = default ;
    GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource(GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource &&) = default ;
    GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource() = default ;
    GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource& operator=(const GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource &) = default ;
    GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource& operator=(GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource &&) = default ;
    ...
    inline GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource& setComplianceSummaryTimestamp(int64_t complianceSummaryTimestamp) { DARABONBA_PTR_SET_VALUE(complianceSummaryTimestamp_, complianceSummaryTimestamp) };
    ...
    inline GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource& setCompliantCount(int32_t compliantCount) { DARABONBA_PTR_SET_VALUE(compliantCount_, compliantCount) };
    ...
    inline GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource& setHighRiskRuleNonCompliantResourceCount(int32_t highRiskRuleNonCompliantResourceCount) { DARABONBA_PTR_SET_VALUE(highRiskRuleNonCompliantResourceCount_, highRiskRuleNonCompliantResourceCount) };
    ...
    inline GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource& setLowRiskRuleNonCompliantResourceCount(int32_t lowRiskRuleNonCompliantResourceCount) { DARABONBA_PTR_SET_VALUE(lowRiskRuleNonCompliantResourceCount_, lowRiskRuleNonCompliantResourceCount) };
    ...
    inline GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource& setMediumRiskRuleNonCompliantResourceCount(int32_t mediumRiskRuleNonCompliantResourceCount) { DARABONBA_PTR_SET_VALUE(mediumRiskRuleNonCompliantResourceCount_, mediumRiskRuleNonCompliantResourceCount) };
    ...
    inline GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource& setNonCompliantCount(int32_t nonCompliantCount) { DARABONBA_PTR_SET_VALUE(nonCompliantCount_, nonCompliantCount) };
    ...
    inline GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource& setTotalCount(int64_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
