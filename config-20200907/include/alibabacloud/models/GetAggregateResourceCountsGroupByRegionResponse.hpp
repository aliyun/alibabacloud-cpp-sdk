...
namespace Models
{
  ...
  public:
    ...
    inline const GetAggregateResourceCountsGroupByRegionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetAggregateResourceCountsGroupByRegionResponseBody) };
    inline GetAggregateResourceCountsGroupByRegionResponseBody body() { DARABONBA_PTR_GET(body_, GetAggregateResourceCountsGroupByRegionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetAggregateResourceCountsGroupByRegionResponseBody> body_ = nullptr;
  };
