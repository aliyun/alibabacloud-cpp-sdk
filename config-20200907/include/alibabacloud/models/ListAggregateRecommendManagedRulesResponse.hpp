...
namespace Models
{
  ...
  public:
    ...
    inline const ListAggregateRecommendManagedRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAggregateRecommendManagedRulesResponseBody) };
    inline ListAggregateRecommendManagedRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAggregateRecommendManagedRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAggregateRecommendManagedRulesResponseBody> body_ {};
  };
