...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAggregateCompliancePackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAggregateCompliancePackResponseBody) };
    inline UpdateAggregateCompliancePackResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAggregateCompliancePackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAggregateCompliancePackResponseBody> body_ {};
  };
