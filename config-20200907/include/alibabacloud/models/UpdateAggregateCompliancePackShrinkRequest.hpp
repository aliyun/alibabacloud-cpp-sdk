...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aggregatorId_ == nullptr
        && this->clientToken_ == nullptr && this->compliancePackId_ == nullptr && this->compliancePackName_ == nullptr && this->configRulesShrink_ == nullptr && this->description_ == nullptr
        ...
        && this->resourceGroupIdsScope_ == nullptr && this->resourceIdsScope_ == nullptr && this->riskLevel_ == nullptr && this->tagShrink_ == nullptr && this->tagKeyScope_ == nullptr
    ...
    inline const vector<UpdateAggregateCompliancePackShrinkRequest::ExcludeTagsScope> & getExcludeTagsScope() const { DARABONBA_PTR_GET_CONST(excludeTagsScope_, vector<UpdateAggregateCompliancePackShrinkRequest::ExcludeTagsScope>) };
    inline vector<UpdateAggregateCompliancePackShrinkRequest::ExcludeTagsScope> getExcludeTagsScope() { DARABONBA_PTR_GET(excludeTagsScope_, vector<UpdateAggregateCompliancePackShrinkRequest::ExcludeTagsScope>) };
    inline UpdateAggregateCompliancePackShrinkRequest& setExcludeTagsScope(const vector<UpdateAggregateCompliancePackShrinkRequest::ExcludeTagsScope> & excludeTagsScope) { DARABONBA_PTR_SET_VALUE(excludeTagsScope_, excludeTagsScope) };
    inline UpdateAggregateCompliancePackShrinkRequest& setExcludeTagsScope(vector<UpdateAggregateCompliancePackShrinkRequest::ExcludeTagsScope> && excludeTagsScope) { DARABONBA_PTR_SET_RVALUE(excludeTagsScope_, excludeTagsScope) };
    ...
    inline const vector<UpdateAggregateCompliancePackShrinkRequest::TagsScope> & getTagsScope() const { DARABONBA_PTR_GET_CONST(tagsScope_, vector<UpdateAggregateCompliancePackShrinkRequest::TagsScope>) };
    inline vector<UpdateAggregateCompliancePackShrinkRequest::TagsScope> getTagsScope() { DARABONBA_PTR_GET(tagsScope_, vector<UpdateAggregateCompliancePackShrinkRequest::TagsScope>) };
    inline UpdateAggregateCompliancePackShrinkRequest& setTagsScope(const vector<UpdateAggregateCompliancePackShrinkRequest::TagsScope> & tagsScope) { DARABONBA_PTR_SET_VALUE(tagsScope_, tagsScope) };
    inline UpdateAggregateCompliancePackShrinkRequest& setTagsScope(vector<UpdateAggregateCompliancePackShrinkRequest::TagsScope> && tagsScope) { DARABONBA_PTR_SET_RVALUE(tagsScope_, tagsScope) };
