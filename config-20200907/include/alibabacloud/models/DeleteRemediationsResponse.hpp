...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRemediationsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteRemediationsResponseBody) };
    inline DeleteRemediationsResponseBody body() { DARABONBA_PTR_GET(body_, DeleteRemediationsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteRemediationsResponseBody> body_ = nullptr;
  };
