...
#ifndef ALIBABACLOUD_MODELS_LISTCONFIGDELIVERYCHANNELSRESPONSEBODYDELIVERYCHANNELS_HPP_
#define ALIBABACLOUD_MODELS_LISTCONFIGDELIVERYCHANNELSRESPONSEBODYDELIVERYCHANNELS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListConfigDeliveryChannelsResponseBodyDeliveryChannels& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListConfigDeliveryChannelsResponseBodyDeliveryChannels& obj) { 
    ...
    ListConfigDeliveryChannelsResponseBodyDeliveryChannels() = default ;
    ListConfigDeliveryChannelsResponseBodyDeliveryChannels(const ListConfigDeliveryChannelsResponseBodyDeliveryChannels &) = default ;
    ListConfigDeliveryChannelsResponseBodyDeliveryChannels(ListConfigDeliveryChannelsResponseBodyDeliveryChannels &&) = default ;
    ListConfigDeliveryChannelsResponseBodyDeliveryChannels(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListConfigDeliveryChannelsResponseBodyDeliveryChannels() = default ;
    ListConfigDeliveryChannelsResponseBodyDeliveryChannels& operator=(const ListConfigDeliveryChannelsResponseBodyDeliveryChannels &) = default ;
    ListConfigDeliveryChannelsResponseBodyDeliveryChannels& operator=(ListConfigDeliveryChannelsResponseBodyDeliveryChannels &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->accountId_ == nullptr
        && return this->compliantSnapshot_ == nullptr && return this->configurationItemChangeNotification_ == nullptr && return this->configurationSnapshot_ == nullptr && return this->deliveryChannelAssumeRoleArn_ == nullptr && return this->deliveryChannelCondition_ == nullptr
        && return this->deliveryChannelId_ == nullptr && return this->deliveryChannelName_ == nullptr && return this->deliveryChannelTargetArn_ == nullptr && return this->deliveryChannelType_ == nullptr && return this->deliverySnapshotTime_ == nullptr
        && return this->description_ == nullptr && return this->nonCompliantNotification_ == nullptr && return this->oversizedDataOSSTargetArn_ == nullptr && return this->status_ == nullptr; };
    // accountId Field Functions 
    bool hasAccountId() const { return this->accountId_ != nullptr;};
    void deleteAccountId() { this->accountId_ = nullptr;};
    inline int64_t accountId() const { DARABONBA_PTR_GET_DEFAULT(accountId_, 0L) };
    inline ListConfigDeliveryChannelsResponseBodyDeliveryChannels& setAccountId(int64_t accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
    ...
    inline ListConfigDeliveryChannelsResponseBodyDeliveryChannels& setCompliantSnapshot(bool compliantSnapshot) { DARABONBA_PTR_SET_VALUE(compliantSnapshot_, compliantSnapshot) };
    ...
    inline ListConfigDeliveryChannelsResponseBodyDeliveryChannels& setConfigurationItemChangeNotification(bool configurationItemChangeNotification) { DARABONBA_PTR_SET_VALUE(configurationItemChangeNotification_, configurationItemChangeNotification) };
    ...
    inline ListConfigDeliveryChannelsResponseBodyDeliveryChannels& setConfigurationSnapshot(bool configurationSnapshot) { DARABONBA_PTR_SET_VALUE(configurationSnapshot_, configurationSnapshot) };
    ...
    inline ListConfigDeliveryChannelsResponseBodyDeliveryChannels& setDeliveryChannelAssumeRoleArn(string deliveryChannelAssumeRoleArn) { DARABONBA_PTR_SET_VALUE(deliveryChannelAssumeRoleArn_, deliveryChannelAssumeRoleArn) };
    ...
    inline ListConfigDeliveryChannelsResponseBodyDeliveryChannels& setDeliveryChannelCondition(string deliveryChannelCondition) { DARABONBA_PTR_SET_VALUE(deliveryChannelCondition_, deliveryChannelCondition) };
    ...
    inline ListConfigDeliveryChannelsResponseBodyDeliveryChannels& setDeliveryChannelId(string deliveryChannelId) { DARABONBA_PTR_SET_VALUE(deliveryChannelId_, deliveryChannelId) };
    ...
    inline ListConfigDeliveryChannelsResponseBodyDeliveryChannels& setDeliveryChannelName(string deliveryChannelName) { DARABONBA_PTR_SET_VALUE(deliveryChannelName_, deliveryChannelName) };
    ...
    inline ListConfigDeliveryChannelsResponseBodyDeliveryChannels& setDeliveryChannelTargetArn(string deliveryChannelTargetArn) { DARABONBA_PTR_SET_VALUE(deliveryChannelTargetArn_, deliveryChannelTargetArn) };
    ...
    inline ListConfigDeliveryChannelsResponseBodyDeliveryChannels& setDeliveryChannelType(string deliveryChannelType) { DARABONBA_PTR_SET_VALUE(deliveryChannelType_, deliveryChannelType) };
    ...
    inline ListConfigDeliveryChannelsResponseBodyDeliveryChannels& setDeliverySnapshotTime(string deliverySnapshotTime) { DARABONBA_PTR_SET_VALUE(deliverySnapshotTime_, deliverySnapshotTime) };
    ...
    inline ListConfigDeliveryChannelsResponseBodyDeliveryChannels& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListConfigDeliveryChannelsResponseBodyDeliveryChannels& setNonCompliantNotification(bool nonCompliantNotification) { DARABONBA_PTR_SET_VALUE(nonCompliantNotification_, nonCompliantNotification) };
    ...
    inline ListConfigDeliveryChannelsResponseBodyDeliveryChannels& setOversizedDataOSSTargetArn(string oversizedDataOSSTargetArn) { DARABONBA_PTR_SET_VALUE(oversizedDataOSSTargetArn_, oversizedDataOSSTargetArn) };
    ...
    inline ListConfigDeliveryChannelsResponseBodyDeliveryChannels& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
