...
namespace Models
{
  ...
  public:
    ...
    inline const AttachAggregateConfigRuleToCompliancePackResponseBody::OperateRuleResult & getOperateRuleResult() const { DARABONBA_PTR_GET_CONST(operateRuleResult_, AttachAggregateConfigRuleToCompliancePackResponseBody::OperateRuleResult) };
    inline AttachAggregateConfigRuleToCompliancePackResponseBody::OperateRuleResult getOperateRuleResult() { DARABONBA_PTR_GET(operateRuleResult_, AttachAggregateConfigRuleToCompliancePackResponseBody::OperateRuleResult) };
    inline AttachAggregateConfigRuleToCompliancePackResponseBody& setOperateRuleResult(const AttachAggregateConfigRuleToCompliancePackResponseBody::OperateRuleResult & operateRuleResult) { DARABONBA_PTR_SET_VALUE(operateRuleResult_, operateRuleResult) };
    inline AttachAggregateConfigRuleToCompliancePackResponseBody& setOperateRuleResult(AttachAggregateConfigRuleToCompliancePackResponseBody::OperateRuleResult && operateRuleResult) { DARABONBA_PTR_SET_RVALUE(operateRuleResult_, operateRuleResult) };
  ...
  protected:
    ...
    shared_ptr<AttachAggregateConfigRuleToCompliancePackResponseBody::OperateRuleResult> operateRuleResult_ {};
    // The request ID.
