...
namespace Models
{
  ...
  public:
    ...
    inline const ListAggregateResourcesByAdvancedSearchResponseBody::QueryResults & getQueryResults() const { DARABONBA_PTR_GET_CONST(queryResults_, ListAggregateResourcesByAdvancedSearchResponseBody::QueryResults) };
    inline ListAggregateResourcesByAdvancedSearchResponseBody::QueryResults getQueryResults() { DARABONBA_PTR_GET(queryResults_, ListAggregateResourcesByAdvancedSearchResponseBody::QueryResults) };
    inline ListAggregateResourcesByAdvancedSearchResponseBody& setQueryResults(const ListAggregateResourcesByAdvancedSearchResponseBody::QueryResults & queryResults) { DARABONBA_PTR_SET_VALUE(queryResults_, queryResults) };
    inline ListAggregateResourcesByAdvancedSearchResponseBody& setQueryResults(ListAggregateResourcesByAdvancedSearchResponseBody::QueryResults && queryResults) { DARABONBA_PTR_SET_RVALUE(queryResults_, queryResults) };
