...
namespace Models
{
  ...
  public:
    ...
    inline const ListConfigDeliveryChannelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListConfigDeliveryChannelsResponseBody) };
    inline ListConfigDeliveryChannelsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListConfigDeliveryChannelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListConfigDeliveryChannelsResponseBody> body_ {};
  };
