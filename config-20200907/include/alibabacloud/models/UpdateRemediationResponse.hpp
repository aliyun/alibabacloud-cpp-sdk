...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRemediationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateRemediationResponseBody) };
    inline UpdateRemediationResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateRemediationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateRemediationResponseBody> body_ {};
  };
