...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceTypePropertiesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetResourceTypePropertiesResponseBody) };
    inline GetResourceTypePropertiesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetResourceTypePropertiesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetResourceTypePropertiesResponseBody> body_ {};
  };
