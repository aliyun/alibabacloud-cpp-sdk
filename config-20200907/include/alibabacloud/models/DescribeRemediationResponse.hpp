...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRemediationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRemediationResponseBody) };
    inline DescribeRemediationResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRemediationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRemediationResponseBody> body_ {};
  };
