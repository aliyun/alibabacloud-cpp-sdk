...
namespace Models
{
  ...
  public:
    ...
    inline const DetachConfigRuleToCompliancePackResponseBody::OperateRuleResult & getOperateRuleResult() const { DARABONBA_PTR_GET_CONST(operateRuleResult_, DetachConfigRuleToCompliancePackResponseBody::OperateRuleResult) };
    inline DetachConfigRuleToCompliancePackResponseBody::OperateRuleResult getOperateRuleResult() { DARABONBA_PTR_GET(operateRuleResult_, DetachConfigRuleToCompliancePackResponseBody::OperateRuleResult) };
    inline DetachConfigRuleToCompliancePackResponseBody& setOperateRuleResult(const DetachConfigRuleToCompliancePackResponseBody::OperateRuleResult & operateRuleResult) { DARABONBA_PTR_SET_VALUE(operateRuleResult_, operateRuleResult) };
    inline DetachConfigRuleToCompliancePackResponseBody& setOperateRuleResult(DetachConfigRuleToCompliancePackResponseBody::OperateRuleResult && operateRuleResult) { DARABONBA_PTR_SET_RVALUE(operateRuleResult_, operateRuleResult) };
