...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceComplianceByConfigRuleResponseBody::ComplianceResult & getComplianceResult() const { DARABONBA_PTR_GET_CONST(complianceResult_, GetResourceComplianceByConfigRuleResponseBody::ComplianceResult) };
    inline GetResourceComplianceByConfigRuleResponseBody::ComplianceResult getComplianceResult() { DARABONBA_PTR_GET(complianceResult_, GetResourceComplianceByConfigRuleResponseBody::ComplianceResult) };
    inline GetResourceComplianceByConfigRuleResponseBody& setComplianceResult(const GetResourceComplianceByConfigRuleResponseBody::ComplianceResult & complianceResult) { DARABONBA_PTR_SET_VALUE(complianceResult_, complianceResult) };
    inline GetResourceComplianceByConfigRuleResponseBody& setComplianceResult(GetResourceComplianceByConfigRuleResponseBody::ComplianceResult && complianceResult) { DARABONBA_PTR_SET_RVALUE(complianceResult_, complianceResult) };
