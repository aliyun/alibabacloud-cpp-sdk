...
namespace Models
{
  ...
  public:
    ...
    inline const GetAggregateResourceComplianceGroupByResourceTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAggregateResourceComplianceGroupByResourceTypeResponseBody) };
    inline GetAggregateResourceComplianceGroupByResourceTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAggregateResourceComplianceGroupByResourceTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAggregateResourceComplianceGroupByResourceTypeResponseBody> body_ {};
  };
