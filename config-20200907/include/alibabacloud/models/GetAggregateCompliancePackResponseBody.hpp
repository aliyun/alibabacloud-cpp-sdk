...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->accountId_ == nullptr
        && this->aggregatorId_ == nullptr && this->compliancePackId_ == nullptr && this->compliancePackName_ == nullptr && this->compliancePackTemplateId_ == nullptr && this->configRules_ == nullptr
        && this->createTimestamp_ == nullptr && this->description_ == nullptr && this->riskLevel_ == nullptr && this->scope_ == nullptr && this->status_ == nullptr
        && this->tags_ == nullptr && this->templateContent_ == nullptr; };
      ...
      inline CompliancePack& setAggregatorId(string aggregatorId) { DARABONBA_PTR_SET_VALUE(aggregatorId_, aggregatorId) };
    ...
    inline const GetAggregateCompliancePackResponseBody::CompliancePack & getCompliancePack() const { DARABONBA_PTR_GET_CONST(compliancePack_, GetAggregateCompliancePackResponseBody::CompliancePack) };
    inline GetAggregateCompliancePackResponseBody::CompliancePack getCompliancePack() { DARABONBA_PTR_GET(compliancePack_, GetAggregateCompliancePackResponseBody::CompliancePack) };
    inline GetAggregateCompliancePackResponseBody& setCompliancePack(const GetAggregateCompliancePackResponseBody::CompliancePack & compliancePack) { DARABONBA_PTR_SET_VALUE(compliancePack_, compliancePack) };
    inline GetAggregateCompliancePackResponseBody& setCompliancePack(GetAggregateCompliancePackResponseBody::CompliancePack && compliancePack) { DARABONBA_PTR_SET_RVALUE(compliancePack_, compliancePack) };
  ...
  protected:
    ...
    shared_ptr<GetAggregateCompliancePackResponseBody::CompliancePack> compliancePack_ {};
    // The request ID.
