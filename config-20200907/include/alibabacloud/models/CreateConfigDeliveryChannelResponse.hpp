...
namespace Models
{
  ...
  public:
    ...
    inline const CreateConfigDeliveryChannelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateConfigDeliveryChannelResponseBody) };
    inline CreateConfigDeliveryChannelResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateConfigDeliveryChannelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateConfigDeliveryChannelResponseBody> body_ {};
  };
