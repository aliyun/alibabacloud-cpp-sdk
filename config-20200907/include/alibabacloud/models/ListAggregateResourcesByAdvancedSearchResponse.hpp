...
namespace Models
{
  ...
  public:
    ...
    inline const ListAggregateResourcesByAdvancedSearchResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListAggregateResourcesByAdvancedSearchResponseBody) };
    inline ListAggregateResourcesByAdvancedSearchResponseBody body() { DARABONBA_PTR_GET(body_, ListAggregateResourcesByAdvancedSearchResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListAggregateResourcesByAdvancedSearchResponseBody> body_ = nullptr;
  };
