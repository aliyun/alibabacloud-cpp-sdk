...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourceEvaluationResultsResponseBody::EvaluationResults & getEvaluationResults() const { DARABONBA_PTR_GET_CONST(evaluationResults_, ListResourceEvaluationResultsResponseBody::EvaluationResults) };
    inline ListResourceEvaluationResultsResponseBody::EvaluationResults getEvaluationResults() { DARABONBA_PTR_GET(evaluationResults_, ListResourceEvaluationResultsResponseBody::EvaluationResults) };
    inline ListResourceEvaluationResultsResponseBody& setEvaluationResults(const ListResourceEvaluationResultsResponseBody::EvaluationResults & evaluationResults) { DARABONBA_PTR_SET_VALUE(evaluationResults_, evaluationResults) };
    inline ListResourceEvaluationResultsResponseBody& setEvaluationResults(ListResourceEvaluationResultsResponseBody::EvaluationResults && evaluationResults) { DARABONBA_PTR_SET_RVALUE(evaluationResults_, evaluationResults) };
