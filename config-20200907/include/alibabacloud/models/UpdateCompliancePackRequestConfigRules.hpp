...
#ifndef ALIBABACLOUD_MODELS_UPDATECOMPLIANCEPACKREQUESTCONFIGRULES_HPP_
#define ALIBABACLOUD_MODELS_UPDATECOMPLIANCEPACKREQUESTCONFIGRULES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateCompliancePackRequestConfigRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateCompliancePackRequestConfigRules& obj) { 
    ...
    UpdateCompliancePackRequestConfigRules() = default ;
    UpdateCompliancePackRequestConfigRules(const UpdateCompliancePackRequestConfigRules &) = default ;
    UpdateCompliancePackRequestConfigRules(UpdateCompliancePackRequestConfigRules &&) = default ;
    UpdateCompliancePackRequestConfigRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateCompliancePackRequestConfigRules() = default ;
    UpdateCompliancePackRequestConfigRules& operator=(const UpdateCompliancePackRequestConfigRules &) = default ;
    UpdateCompliancePackRequestConfigRules& operator=(UpdateCompliancePackRequestConfigRules &&) = default ;
    ...
    inline UpdateCompliancePackRequestConfigRules& setConfigRuleId(string configRuleId) { DARABONBA_PTR_SET_VALUE(configRuleId_, configRuleId) };
    ...
    inline UpdateCompliancePackRequestConfigRules& setConfigRuleName(string configRuleName) { DARABONBA_PTR_SET_VALUE(configRuleName_, configRuleName) };
    ...
    inline const vector<Models::UpdateCompliancePackRequestConfigRulesConfigRuleParameters> & configRuleParameters() const { DARABONBA_PTR_GET_CONST(configRuleParameters_, vector<Models::UpdateCompliancePackRequestConfigRulesConfigRuleParameters>) };
    inline vector<Models::UpdateCompliancePackRequestConfigRulesConfigRuleParameters> configRuleParameters() { DARABONBA_PTR_GET(configRuleParameters_, vector<Models::UpdateCompliancePackRequestConfigRulesConfigRuleParameters>) };
    inline UpdateCompliancePackRequestConfigRules& setConfigRuleParameters(const vector<Models::UpdateCompliancePackRequestConfigRulesConfigRuleParameters> & configRuleParameters) { DARABONBA_PTR_SET_VALUE(configRuleParameters_, configRuleParameters) };
    inline UpdateCompliancePackRequestConfigRules& setConfigRuleParameters(vector<Models::UpdateCompliancePackRequestConfigRulesConfigRuleParameters> && configRuleParameters) { DARABONBA_PTR_SET_RVALUE(configRuleParameters_, configRuleParameters) };
    ...
    inline UpdateCompliancePackRequestConfigRules& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline UpdateCompliancePackRequestConfigRules& setManagedRuleIdentifier(string managedRuleIdentifier) { DARABONBA_PTR_SET_VALUE(managedRuleIdentifier_, managedRuleIdentifier) };
    ...
    inline UpdateCompliancePackRequestConfigRules& setRiskLevel(int32_t riskLevel) { DARABONBA_PTR_SET_VALUE(riskLevel_, riskLevel) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::UpdateCompliancePackRequestConfigRulesConfigRuleParameters>> configRuleParameters_ = nullptr;
