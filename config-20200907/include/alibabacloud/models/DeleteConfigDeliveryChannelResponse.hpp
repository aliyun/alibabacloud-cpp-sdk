...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteConfigDeliveryChannelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteConfigDeliveryChannelResponseBody) };
    inline DeleteConfigDeliveryChannelResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteConfigDeliveryChannelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteConfigDeliveryChannelResponseBody> body_ {};
  };
