...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->desAggregatorIds_ == nullptr
        && this->srcAggregatorId_ == nullptr && this->srcConfigRuleIds_ == nullptr; };
    ...
    inline string getSrcConfigRuleIds() const { DARABONBA_PTR_GET_DEFAULT(srcConfigRuleIds_, "") };
  ...
  protected:
    ...
    shared_ptr<string> srcConfigRuleIds_ {};
  };
