...
namespace Models
{
  ...
  public:
    ...
    inline const GetAggregateResourceInventoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAggregateResourceInventoryResponseBody) };
    inline GetAggregateResourceInventoryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAggregateResourceInventoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAggregateResourceInventoryResponseBody> body_ {};
  };
