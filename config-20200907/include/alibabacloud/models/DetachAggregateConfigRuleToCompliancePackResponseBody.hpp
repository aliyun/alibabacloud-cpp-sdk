...
namespace Models
{
  ...
  public:
    ...
    inline const DetachAggregateConfigRuleToCompliancePackResponseBody::OperateRuleResult & getOperateRuleResult() const { DARABONBA_PTR_GET_CONST(operateRuleResult_, DetachAggregateConfigRuleToCompliancePackResponseBody::OperateRuleResult) };
    inline DetachAggregateConfigRuleToCompliancePackResponseBody::OperateRuleResult getOperateRuleResult() { DARABONBA_PTR_GET(operateRuleResult_, DetachAggregateConfigRuleToCompliancePackResponseBody::OperateRuleResult) };
    inline DetachAggregateConfigRuleToCompliancePackResponseBody& setOperateRuleResult(const DetachAggregateConfigRuleToCompliancePackResponseBody::OperateRuleResult & operateRuleResult) { DARABONBA_PTR_SET_VALUE(operateRuleResult_, operateRuleResult) };
    inline DetachAggregateConfigRuleToCompliancePackResponseBody& setOperateRuleResult(DetachAggregateConfigRuleToCompliancePackResponseBody::OperateRuleResult && operateRuleResult) { DARABONBA_PTR_SET_RVALUE(operateRuleResult_, operateRuleResult) };
