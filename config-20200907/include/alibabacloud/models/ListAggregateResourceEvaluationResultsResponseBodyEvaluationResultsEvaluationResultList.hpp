...
#ifndef ALIBABACLOUD_MODELS_LISTAGGREGATERESOURCEEVALUATIONRESULTSRESPONSEBODYEVALUATIONRESULTSEVALUATIONRESULTLIST_HPP_
#define ALIBABACLOUD_MODELS_LISTAGGREGATERESOURCEEVALUATIONRESULTSRESPONSEBODYEVALUATIONRESULTSEVALUATIONRESULTLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& obj) { 
    ...
    ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList() = default ;
    ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList(const ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList &) = default ;
    ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList(ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList &&) = default ;
    ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList() = default ;
    ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& operator=(const ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList &) = default ;
    ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& operator=(ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList &&) = default ;
    ...
    inline ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setAnnotation(string annotation) { DARABONBA_PTR_SET_VALUE(annotation_, annotation) };
    ...
    inline ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setComplianceType(string complianceType) { DARABONBA_PTR_SET_VALUE(complianceType_, complianceType) };
    ...
    inline ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setConfigRuleInvokedTimestamp(int64_t configRuleInvokedTimestamp) { DARABONBA_PTR_SET_VALUE(configRuleInvokedTimestamp_, configRuleInvokedTimestamp) };
    ...
    inline ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setEvaluationId(string evaluationId) { DARABONBA_PTR_SET_VALUE(evaluationId_, evaluationId) };
    ...
    inline const Models::ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier & evaluationResultIdentifier() const { DARABONBA_PTR_GET_CONST(evaluationResultIdentifier_, Models::ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier) };
    inline Models::ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier evaluationResultIdentifier() { DARABONBA_PTR_GET(evaluationResultIdentifier_, Models::ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier) };
    inline ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setEvaluationResultIdentifier(const Models::ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier & evaluationResultIdentifier) { DARABONBA_PTR_SET_VALUE(evaluationResultIdentifier_, evaluationResultIdentifier) };
    inline ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setEvaluationResultIdentifier(Models::ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier && evaluationResultIdentifier) { DARABONBA_PTR_SET_RVALUE(evaluationResultIdentifier_, evaluationResultIdentifier) };
    ...
    inline ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setInvokingEventMessageType(string invokingEventMessageType) { DARABONBA_PTR_SET_VALUE(invokingEventMessageType_, invokingEventMessageType) };
    ...
    inline ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setLastNonCompliantRecordTimestamp(int64_t lastNonCompliantRecordTimestamp) { DARABONBA_PTR_SET_VALUE(lastNonCompliantRecordTimestamp_, lastNonCompliantRecordTimestamp) };
    ...
    inline ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setRemediationEnabled(bool remediationEnabled) { DARABONBA_PTR_SET_VALUE(remediationEnabled_, remediationEnabled) };
    ...
    inline ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setResultRecordedTimestamp(int64_t resultRecordedTimestamp) { DARABONBA_PTR_SET_VALUE(resultRecordedTimestamp_, resultRecordedTimestamp) };
    ...
    inline ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setRiskLevel(int32_t riskLevel) { DARABONBA_PTR_SET_VALUE(riskLevel_, riskLevel) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier> evaluationResultIdentifier_ = nullptr;
