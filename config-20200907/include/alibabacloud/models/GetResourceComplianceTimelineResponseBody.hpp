...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceComplianceTimelineResponseBody::ResourceComplianceTimeline & getResourceComplianceTimeline() const { DARABONBA_PTR_GET_CONST(resourceComplianceTimeline_, GetResourceComplianceTimelineResponseBody::ResourceComplianceTimeline) };
    inline GetResourceComplianceTimelineResponseBody::ResourceComplianceTimeline getResourceComplianceTimeline() { DARABONBA_PTR_GET(resourceComplianceTimeline_, GetResourceComplianceTimelineResponseBody::ResourceComplianceTimeline) };
    inline GetResourceComplianceTimelineResponseBody& setResourceComplianceTimeline(const GetResourceComplianceTimelineResponseBody::ResourceComplianceTimeline & resourceComplianceTimeline) { DARABONBA_PTR_SET_VALUE(resourceComplianceTimeline_, resourceComplianceTimeline) };
    inline GetResourceComplianceTimelineResponseBody& setResourceComplianceTimeline(GetResourceComplianceTimelineResponseBody::ResourceComplianceTimeline && resourceComplianceTimeline) { DARABONBA_PTR_SET_RVALUE(resourceComplianceTimeline_, resourceComplianceTimeline) };
