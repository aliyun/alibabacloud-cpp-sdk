...
namespace Models
{
  ...
  public:
    ...
    inline const GetAggregateDiscoveredResourceResponseBody::DiscoveredResourceDetail & getDiscoveredResourceDetail() const { DARABONBA_PTR_GET_CONST(discoveredResourceDetail_, GetAggregateDiscoveredResourceResponseBody::DiscoveredResourceDetail) };
    inline GetAggregateDiscoveredResourceResponseBody::DiscoveredResourceDetail getDiscoveredResourceDetail() { DARABONBA_PTR_GET(discoveredResourceDetail_, GetAggregateDiscoveredResourceResponseBody::DiscoveredResourceDetail) };
    inline GetAggregateDiscoveredResourceResponseBody& setDiscoveredResourceDetail(const GetAggregateDiscoveredResourceResponseBody::DiscoveredResourceDetail & discoveredResourceDetail) { DARABONBA_PTR_SET_VALUE(discoveredResourceDetail_, discoveredResourceDetail) };
    inline GetAggregateDiscoveredResourceResponseBody& setDiscoveredResourceDetail(GetAggregateDiscoveredResourceResponseBody::DiscoveredResourceDetail && discoveredResourceDetail) { DARABONBA_PTR_SET_RVALUE(discoveredResourceDetail_, discoveredResourceDetail) };
  ...
  protected:
    ...
    shared_ptr<GetAggregateDiscoveredResourceResponseBody::DiscoveredResourceDetail> discoveredResourceDetail_ {};
    // The request ID.
