...
namespace Models
{
  ...
  public:
    ...
    inline const AttachConfigRuleToCompliancePackResponseBody::OperateRuleResult & getOperateRuleResult() const { DARABONBA_PTR_GET_CONST(operateRuleResult_, AttachConfigRuleToCompliancePackResponseBody::OperateRuleResult) };
    inline AttachConfigRuleToCompliancePackResponseBody::OperateRuleResult getOperateRuleResult() { DARABONBA_PTR_GET(operateRuleResult_, AttachConfigRuleToCompliancePackResponseBody::OperateRuleResult) };
    inline AttachConfigRuleToCompliancePackResponseBody& setOperateRuleResult(const AttachConfigRuleToCompliancePackResponseBody::OperateRuleResult & operateRuleResult) { DARABONBA_PTR_SET_VALUE(operateRuleResult_, operateRuleResult) };
    inline AttachConfigRuleToCompliancePackResponseBody& setOperateRuleResult(AttachConfigRuleToCompliancePackResponseBody::OperateRuleResult && operateRuleResult) { DARABONBA_PTR_SET_RVALUE(operateRuleResult_, operateRuleResult) };
  ...
  protected:
    ...
    shared_ptr<AttachConfigRuleToCompliancePackResponseBody::OperateRuleResult> operateRuleResult_ {};
    // The request ID.
