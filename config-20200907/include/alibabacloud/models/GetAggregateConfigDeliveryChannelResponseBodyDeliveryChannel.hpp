...
#ifndef ALIBABACLOUD_MODELS_GETAGGREGATECONFIGDELIVERYCHANNELRESPONSEBODYDELIVERYCHANNEL_HPP_
#define ALIBABACLOUD_MODELS_GETAGGREGATECONFIGDELIVERYCHANNELRESPONSEBODYDELIVERYCHANNEL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& obj) { 
    ...
    GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel() = default ;
    GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel(const GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel &) = default ;
    GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel(GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel &&) = default ;
    GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel() = default ;
    GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& operator=(const GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel &) = default ;
    GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& operator=(GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel &&) = default ;
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setAccountId(string accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setAggregatorId(string aggregatorId) { DARABONBA_PTR_SET_VALUE(aggregatorId_, aggregatorId) };
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setCompliantSnapshot(bool compliantSnapshot) { DARABONBA_PTR_SET_VALUE(compliantSnapshot_, compliantSnapshot) };
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setConfigurationItemChangeNotification(bool configurationItemChangeNotification) { DARABONBA_PTR_SET_VALUE(configurationItemChangeNotification_, configurationItemChangeNotification) };
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setConfigurationSnapshot(bool configurationSnapshot) { DARABONBA_PTR_SET_VALUE(configurationSnapshot_, configurationSnapshot) };
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setDeliveryChannelAssumeRoleArn(string deliveryChannelAssumeRoleArn) { DARABONBA_PTR_SET_VALUE(deliveryChannelAssumeRoleArn_, deliveryChannelAssumeRoleArn) };
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setDeliveryChannelCondition(string deliveryChannelCondition) { DARABONBA_PTR_SET_VALUE(deliveryChannelCondition_, deliveryChannelCondition) };
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setDeliveryChannelId(string deliveryChannelId) { DARABONBA_PTR_SET_VALUE(deliveryChannelId_, deliveryChannelId) };
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setDeliveryChannelName(string deliveryChannelName) { DARABONBA_PTR_SET_VALUE(deliveryChannelName_, deliveryChannelName) };
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setDeliveryChannelTargetArn(string deliveryChannelTargetArn) { DARABONBA_PTR_SET_VALUE(deliveryChannelTargetArn_, deliveryChannelTargetArn) };
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setDeliveryChannelType(string deliveryChannelType) { DARABONBA_PTR_SET_VALUE(deliveryChannelType_, deliveryChannelType) };
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setDeliverySnapshotTime(string deliverySnapshotTime) { DARABONBA_PTR_SET_VALUE(deliverySnapshotTime_, deliverySnapshotTime) };
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setNonCompliantNotification(bool nonCompliantNotification) { DARABONBA_PTR_SET_VALUE(nonCompliantNotification_, nonCompliantNotification) };
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setOversizedDataOSSTargetArn(string oversizedDataOSSTargetArn) { DARABONBA_PTR_SET_VALUE(oversizedDataOSSTargetArn_, oversizedDataOSSTargetArn) };
    ...
    inline GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
