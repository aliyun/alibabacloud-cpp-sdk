...
namespace Models
{
  ...
  public:
    ...
    class DeliveryChannel : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const DeliveryChannel& obj) { 
      ...
      friend void from_json(const Darabonba::Json& j, DeliveryChannel& obj) { 
      ...
      DeliveryChannel(const DeliveryChannel &) = default ;
      DeliveryChannel(DeliveryChannel &&) = default ;
      DeliveryChannel(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~DeliveryChannel() = default ;
      DeliveryChannel& operator=(const DeliveryChannel &) = default ;
      DeliveryChannel& operator=(DeliveryChannel &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      virtual bool empty() const override { return this->accountId_ == nullptr
        && this->compliantSnapshot_ == nullptr && this->configurationItemChangeNotification_ == nullptr && this->configurationSnapshot_ == nullptr && this->deliveryChannelAssumeRoleArn_ == nullptr && this->deliveryChannelCondition_ == nullptr
        && this->deliveryChannelId_ == nullptr && this->deliveryChannelName_ == nullptr && this->deliveryChannelTargetArn_ == nullptr && this->deliveryChannelType_ == nullptr && this->deliverySnapshotTime_ == nullptr
        && this->description_ == nullptr && this->nonCompliantNotification_ == nullptr && this->oversizedDataOSSTargetArn_ == nullptr && this->status_ == nullptr; };
      // accountId Field Functions 
      bool hasAccountId() const { return this->accountId_ != nullptr;};
      void deleteAccountId() { this->accountId_ = nullptr;};
      inline int64_t getAccountId() const { DARABONBA_PTR_GET_DEFAULT(accountId_, 0L) };
      inline DeliveryChannel& setAccountId(int64_t accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
      ...
      inline DeliveryChannel& setCompliantSnapshot(bool compliantSnapshot) { DARABONBA_PTR_SET_VALUE(compliantSnapshot_, compliantSnapshot) };
      ...
      inline DeliveryChannel& setConfigurationItemChangeNotification(bool configurationItemChangeNotification) { DARABONBA_PTR_SET_VALUE(configurationItemChangeNotification_, configurationItemChangeNotification) };
      ...
      inline DeliveryChannel& setConfigurationSnapshot(bool configurationSnapshot) { DARABONBA_PTR_SET_VALUE(configurationSnapshot_, configurationSnapshot) };
      ...
      inline DeliveryChannel& setDeliveryChannelAssumeRoleArn(string deliveryChannelAssumeRoleArn) { DARABONBA_PTR_SET_VALUE(deliveryChannelAssumeRoleArn_, deliveryChannelAssumeRoleArn) };
      ...
      inline DeliveryChannel& setDeliveryChannelCondition(string deliveryChannelCondition) { DARABONBA_PTR_SET_VALUE(deliveryChannelCondition_, deliveryChannelCondition) };
      ...
      inline DeliveryChannel& setDeliveryChannelId(string deliveryChannelId) { DARABONBA_PTR_SET_VALUE(deliveryChannelId_, deliveryChannelId) };
      ...
      inline DeliveryChannel& setDeliveryChannelName(string deliveryChannelName) { DARABONBA_PTR_SET_VALUE(deliveryChannelName_, deliveryChannelName) };
      ...
      inline DeliveryChannel& setDeliveryChannelTargetArn(string deliveryChannelTargetArn) { DARABONBA_PTR_SET_VALUE(deliveryChannelTargetArn_, deliveryChannelTargetArn) };
      ...
      inline DeliveryChannel& setDeliveryChannelType(string deliveryChannelType) { DARABONBA_PTR_SET_VALUE(deliveryChannelType_, deliveryChannelType) };
      ...
      inline DeliveryChannel& setDeliverySnapshotTime(string deliverySnapshotTime) { DARABONBA_PTR_SET_VALUE(deliverySnapshotTime_, deliverySnapshotTime) };
      ...
      inline DeliveryChannel& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
      ...
      inline DeliveryChannel& setNonCompliantNotification(bool nonCompliantNotification) { DARABONBA_PTR_SET_VALUE(nonCompliantNotification_, nonCompliantNotification) };
      ...
      inline DeliveryChannel& setOversizedDataOSSTargetArn(string oversizedDataOSSTargetArn) { DARABONBA_PTR_SET_VALUE(oversizedDataOSSTargetArn_, oversizedDataOSSTargetArn) };
      ...
      inline DeliveryChannel& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline const GetConfigDeliveryChannelResponseBody::DeliveryChannel & getDeliveryChannel() const { DARABONBA_PTR_GET_CONST(deliveryChannel_, GetConfigDeliveryChannelResponseBody::DeliveryChannel) };
    inline GetConfigDeliveryChannelResponseBody::DeliveryChannel getDeliveryChannel() { DARABONBA_PTR_GET(deliveryChannel_, GetConfigDeliveryChannelResponseBody::DeliveryChannel) };
    inline GetConfigDeliveryChannelResponseBody& setDeliveryChannel(const GetConfigDeliveryChannelResponseBody::DeliveryChannel & deliveryChannel) { DARABONBA_PTR_SET_VALUE(deliveryChannel_, deliveryChannel) };
    inline GetConfigDeliveryChannelResponseBody& setDeliveryChannel(GetConfigDeliveryChannelResponseBody::DeliveryChannel && deliveryChannel) { DARABONBA_PTR_SET_RVALUE(deliveryChannel_, deliveryChannel) };
  ...
  protected:
    ...
    shared_ptr<GetConfigDeliveryChannelResponseBody::DeliveryChannel> deliveryChannel_ {};
    // The request ID.
