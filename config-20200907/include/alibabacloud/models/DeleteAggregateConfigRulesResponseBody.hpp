...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAggregateConfigRulesResponseBodyOperateRuleResult & operateRuleResult() const { DARABONBA_PTR_GET_CONST(operateRuleResult_, DeleteAggregateConfigRulesResponseBodyOperateRuleResult) };
    inline DeleteAggregateConfigRulesResponseBodyOperateRuleResult operateRuleResult() { DARABONBA_PTR_GET(operateRuleResult_, DeleteAggregateConfigRulesResponseBodyOperateRuleResult) };
    inline DeleteAggregateConfigRulesResponseBody& setOperateRuleResult(const DeleteAggregateConfigRulesResponseBodyOperateRuleResult & operateRuleResult) { DARABONBA_PTR_SET_VALUE(operateRuleResult_, operateRuleResult) };
    inline DeleteAggregateConfigRulesResponseBody& setOperateRuleResult(DeleteAggregateConfigRulesResponseBodyOperateRuleResult && operateRuleResult) { DARABONBA_PTR_SET_RVALUE(operateRuleResult_, operateRuleResult) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteAggregateConfigRulesResponseBodyOperateRuleResult> operateRuleResult_ = nullptr;
    // The request ID.
