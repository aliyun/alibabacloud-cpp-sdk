...
#ifndef ALIBABACLOUD_MODELS_LISTRESOURCEEVALUATIONRESULTSRESPONSEBODYEVALUATIONRESULTSEVALUATIONRESULTLIST_HPP_
#define ALIBABACLOUD_MODELS_LISTRESOURCEEVALUATIONRESULTSRESPONSEBODYEVALUATIONRESULTSEVALUATIONRESULTLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& obj) { 
    ...
    ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList() = default ;
    ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList(const ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList &) = default ;
    ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList(ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList &&) = default ;
    ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList() = default ;
    ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& operator=(const ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList &) = default ;
    ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& operator=(ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList &&) = default ;
    ...
    inline ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setAnnotation(string annotation) { DARABONBA_PTR_SET_VALUE(annotation_, annotation) };
    ...
    inline ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setComplianceType(string complianceType) { DARABONBA_PTR_SET_VALUE(complianceType_, complianceType) };
    ...
    inline ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setConfigRuleInvokedTimestamp(int64_t configRuleInvokedTimestamp) { DARABONBA_PTR_SET_VALUE(configRuleInvokedTimestamp_, configRuleInvokedTimestamp) };
    ...
    inline ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setEvaluationId(string evaluationId) { DARABONBA_PTR_SET_VALUE(evaluationId_, evaluationId) };
    ...
    inline ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setEvaluationResultIdentifier(Models::ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier && evaluationResultIdentifier) { DARABONBA_PTR_SET_RVALUE(evaluationResultIdentifier_, evaluationResultIdentifier) };
    ...
    inline ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setInvokingEventMessageType(string invokingEventMessageType) { DARABONBA_PTR_SET_VALUE(invokingEventMessageType_, invokingEventMessageType) };
    ...
    inline ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setLastNonCompliantRecordTimestamp(int64_t lastNonCompliantRecordTimestamp) { DARABONBA_PTR_SET_VALUE(lastNonCompliantRecordTimestamp_, lastNonCompliantRecordTimestamp) };
    ...
    inline ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setRemediationEnabled(bool remediationEnabled) { DARABONBA_PTR_SET_VALUE(remediationEnabled_, remediationEnabled) };
    ...
    inline ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setResultRecordedTimestamp(int64_t resultRecordedTimestamp) { DARABONBA_PTR_SET_VALUE(resultRecordedTimestamp_, resultRecordedTimestamp) };
    ...
    inline ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setRiskLevel(int32_t riskLevel) { DARABONBA_PTR_SET_VALUE(riskLevel_, riskLevel) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier> evaluationResultIdentifier_ = nullptr;
