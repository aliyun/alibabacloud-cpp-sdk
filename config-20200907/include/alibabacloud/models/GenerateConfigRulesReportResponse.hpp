...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateConfigRulesReportResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GenerateConfigRulesReportResponseBody) };
    inline GenerateConfigRulesReportResponseBody body() { DARABONBA_PTR_GET(body_, GenerateConfigRulesReportResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GenerateConfigRulesReportResponseBody> body_ = nullptr;
  };
