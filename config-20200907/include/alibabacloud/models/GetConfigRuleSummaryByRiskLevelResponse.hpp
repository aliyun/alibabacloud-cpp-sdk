...
namespace Models
{
  ...
  public:
    ...
    inline const GetConfigRuleSummaryByRiskLevelResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetConfigRuleSummaryByRiskLevelResponseBody) };
    inline GetConfigRuleSummaryByRiskLevelResponseBody body() { DARABONBA_PTR_GET(body_, GetConfigRuleSummaryByRiskLevelResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetConfigRuleSummaryByRiskLevelResponseBody> body_ = nullptr;
  };
