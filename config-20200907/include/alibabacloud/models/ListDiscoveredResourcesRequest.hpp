...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->endUpdateTimestamp_ == nullptr
        && return this->excludeResourceTypes_ == nullptr && return this->maxResults_ == nullptr && return this->nextToken_ == nullptr && return this->regions_ == nullptr && return this->resourceDeleted_ == nullptr
        && return this->resourceId_ == nullptr && return this->resourceName_ == nullptr && return this->resourceTypes_ == nullptr && return this->startUpdateTimestamp_ == nullptr; };
