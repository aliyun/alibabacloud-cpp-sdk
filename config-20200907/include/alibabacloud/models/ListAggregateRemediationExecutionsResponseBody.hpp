...
namespace Models
{
  ...
  public:
    ...
    inline const ListAggregateRemediationExecutionsResponseBody::RemediationExecutionData & getRemediationExecutionData() const { DARABONBA_PTR_GET_CONST(remediationExecutionData_, ListAggregateRemediationExecutionsResponseBody::RemediationExecutionData) };
    inline ListAggregateRemediationExecutionsResponseBody::RemediationExecutionData getRemediationExecutionData() { DARABONBA_PTR_GET(remediationExecutionData_, ListAggregateRemediationExecutionsResponseBody::RemediationExecutionData) };
    inline ListAggregateRemediationExecutionsResponseBody& setRemediationExecutionData(const ListAggregateRemediationExecutionsResponseBody::RemediationExecutionData & remediationExecutionData) { DARABONBA_PTR_SET_VALUE(remediationExecutionData_, remediationExecutionData) };
    inline ListAggregateRemediationExecutionsResponseBody& setRemediationExecutionData(ListAggregateRemediationExecutionsResponseBody::RemediationExecutionData && remediationExecutionData) { DARABONBA_PTR_SET_RVALUE(remediationExecutionData_, remediationExecutionData) };
  ...
  protected:
    // The queried remediation records.
    shared_ptr<ListAggregateRemediationExecutionsResponseBody::RemediationExecutionData> remediationExecutionData_ {};
    // The request ID.
