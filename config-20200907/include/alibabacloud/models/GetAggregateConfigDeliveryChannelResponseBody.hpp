...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline DeliveryChannel& setAccountId(string accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
      ...
      inline DeliveryChannel& setAggregatorId(string aggregatorId) { DARABONBA_PTR_SET_VALUE(aggregatorId_, aggregatorId) };
    ...
    inline const GetAggregateConfigDeliveryChannelResponseBody::DeliveryChannel & getDeliveryChannel() const { DARABONBA_PTR_GET_CONST(deliveryChannel_, GetAggregateConfigDeliveryChannelResponseBody::DeliveryChannel) };
    inline GetAggregateConfigDeliveryChannelResponseBody::DeliveryChannel getDeliveryChannel() { DARABONBA_PTR_GET(deliveryChannel_, GetAggregateConfigDeliveryChannelResponseBody::DeliveryChannel) };
    inline GetAggregateConfigDeliveryChannelResponseBody& setDeliveryChannel(const GetAggregateConfigDeliveryChannelResponseBody::DeliveryChannel & deliveryChannel) { DARABONBA_PTR_SET_VALUE(deliveryChannel_, deliveryChannel) };
    inline GetAggregateConfigDeliveryChannelResponseBody& setDeliveryChannel(GetAggregateConfigDeliveryChannelResponseBody::DeliveryChannel && deliveryChannel) { DARABONBA_PTR_SET_RVALUE(deliveryChannel_, deliveryChannel) };
  ...
  protected:
    ...
    shared_ptr<GetAggregateConfigDeliveryChannelResponseBody::DeliveryChannel> deliveryChannel_ {};
    // The request ID.
