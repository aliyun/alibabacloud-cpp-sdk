...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->compliancePackId_ == nullptr
        ...
        && return this->pageSize_ == nullptr && return this->resourceTypes_ == nullptr && return this->riskLevel_ == nullptr && return this->sortBy_ == nullptr && return this->tagShrink_ == nullptr; };
