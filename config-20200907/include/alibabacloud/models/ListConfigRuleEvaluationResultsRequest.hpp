...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->compliancePackId_ == nullptr
        && this->complianceType_ == nullptr && this->configRuleId_ == nullptr && this->maxResults_ == nullptr && this->nextToken_ == nullptr && this->regions_ == nullptr
        && this->resourceGroupIds_ == nullptr && this->resourceTypes_ == nullptr; };
