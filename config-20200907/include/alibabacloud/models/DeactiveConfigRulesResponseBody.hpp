...
namespace Models
{
  ...
  public:
    ...
    inline const DeactiveConfigRulesResponseBody::OperateRuleResult & getOperateRuleResult() const { DARABONBA_PTR_GET_CONST(operateRuleResult_, DeactiveConfigRulesResponseBody::OperateRuleResult) };
    inline DeactiveConfigRulesResponseBody::OperateRuleResult getOperateRuleResult() { DARABONBA_PTR_GET(operateRuleResult_, DeactiveConfigRulesResponseBody::OperateRuleResult) };
    inline DeactiveConfigRulesResponseBody& setOperateRuleResult(const DeactiveConfigRulesResponseBody::OperateRuleResult & operateRuleResult) { DARABONBA_PTR_SET_VALUE(operateRuleResult_, operateRuleResult) };
    inline DeactiveConfigRulesResponseBody& setOperateRuleResult(DeactiveConfigRulesResponseBody::OperateRuleResult && operateRuleResult) { DARABONBA_PTR_SET_RVALUE(operateRuleResult_, operateRuleResult) };
