...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourceRelationsResponseBody::ResourceRelations & getResourceRelations() const { DARABONBA_PTR_GET_CONST(resourceRelations_, ListResourceRelationsResponseBody::ResourceRelations) };
    inline ListResourceRelationsResponseBody::ResourceRelations getResourceRelations() { DARABONBA_PTR_GET(resourceRelations_, ListResourceRelationsResponseBody::ResourceRelations) };
    inline ListResourceRelationsResponseBody& setResourceRelations(const ListResourceRelationsResponseBody::ResourceRelations & resourceRelations) { DARABONBA_PTR_SET_VALUE(resourceRelations_, resourceRelations) };
    inline ListResourceRelationsResponseBody& setResourceRelations(ListResourceRelationsResponseBody::ResourceRelations && resourceRelations) { DARABONBA_PTR_SET_RVALUE(resourceRelations_, resourceRelations) };
  ...
  protected:
    ...
    shared_ptr<ListResourceRelationsResponseBody::ResourceRelations> resourceRelations_ {};
  };
