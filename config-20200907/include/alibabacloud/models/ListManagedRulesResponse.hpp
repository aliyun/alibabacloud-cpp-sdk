...
namespace Models
{
  ...
  public:
    ...
    inline const ListManagedRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListManagedRulesResponseBody) };
    inline ListManagedRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListManagedRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListManagedRulesResponseBody> body_ {};
  };
