...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteConfigRulesResponseBody::OperateRuleResult & getOperateRuleResult() const { DARABONBA_PTR_GET_CONST(operateRuleResult_, DeleteConfigRulesResponseBody::OperateRuleResult) };
    inline DeleteConfigRulesResponseBody::OperateRuleResult getOperateRuleResult() { DARABONBA_PTR_GET(operateRuleResult_, DeleteConfigRulesResponseBody::OperateRuleResult) };
    inline DeleteConfigRulesResponseBody& setOperateRuleResult(const DeleteConfigRulesResponseBody::OperateRuleResult & operateRuleResult) { DARABONBA_PTR_SET_VALUE(operateRuleResult_, operateRuleResult) };
    inline DeleteConfigRulesResponseBody& setOperateRuleResult(DeleteConfigRulesResponseBody::OperateRuleResult && operateRuleResult) { DARABONBA_PTR_SET_RVALUE(operateRuleResult_, operateRuleResult) };
  ...
  protected:
    ...
    shared_ptr<DeleteConfigRulesResponseBody::OperateRuleResult> operateRuleResult_ {};
    // The request ID.
