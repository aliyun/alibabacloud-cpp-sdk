...
#ifndef ALIBABACLOUD_MODELS_GETCONFIGRULESREPORTRESPONSEBODYCONFIGRULESREPORT_HPP_
#define ALIBABACLOUD_MODELS_GETCONFIGRULESREPORTRESPONSEBODYCONFIGRULESREPORT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetConfigRulesReportResponseBodyConfigRulesReport& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetConfigRulesReportResponseBodyConfigRulesReport& obj) { 
    ...
    GetConfigRulesReportResponseBodyConfigRulesReport() = default ;
    GetConfigRulesReportResponseBodyConfigRulesReport(const GetConfigRulesReportResponseBodyConfigRulesReport &) = default ;
    GetConfigRulesReportResponseBodyConfigRulesReport(GetConfigRulesReportResponseBodyConfigRulesReport &&) = default ;
    GetConfigRulesReportResponseBodyConfigRulesReport(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetConfigRulesReportResponseBodyConfigRulesReport() = default ;
    GetConfigRulesReportResponseBodyConfigRulesReport& operator=(const GetConfigRulesReportResponseBodyConfigRulesReport &) = default ;
    GetConfigRulesReportResponseBodyConfigRulesReport& operator=(GetConfigRulesReportResponseBodyConfigRulesReport &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->accountId_ == nullptr
        && return this->reportCreateTimestamp_ == nullptr && return this->reportId_ == nullptr && return this->reportStatus_ == nullptr && return this->reportUrl_ == nullptr; };
    // accountId Field Functions 
    bool hasAccountId() const { return this->accountId_ != nullptr;};
    void deleteAccountId() { this->accountId_ = nullptr;};
    inline int64_t accountId() const { DARABONBA_PTR_GET_DEFAULT(accountId_, 0L) };
    inline GetConfigRulesReportResponseBodyConfigRulesReport& setAccountId(int64_t accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
    ...
    inline GetConfigRulesReportResponseBodyConfigRulesReport& setReportCreateTimestamp(int64_t reportCreateTimestamp) { DARABONBA_PTR_SET_VALUE(reportCreateTimestamp_, reportCreateTimestamp) };
    ...
    inline GetConfigRulesReportResponseBodyConfigRulesReport& setReportId(string reportId) { DARABONBA_PTR_SET_VALUE(reportId_, reportId) };
    ...
    inline GetConfigRulesReportResponseBodyConfigRulesReport& setReportStatus(string reportStatus) { DARABONBA_PTR_SET_VALUE(reportStatus_, reportStatus) };
    ...
    inline GetConfigRulesReportResponseBodyConfigRulesReport& setReportUrl(string reportUrl) { DARABONBA_PTR_SET_VALUE(reportUrl_, reportUrl) };
