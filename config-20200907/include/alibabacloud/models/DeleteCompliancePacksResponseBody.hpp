...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCompliancePacksResponseBody::OperateCompliancePacksResult & getOperateCompliancePacksResult() const { DARABONBA_PTR_GET_CONST(operateCompliancePacksResult_, DeleteCompliancePacksResponseBody::OperateCompliancePacksResult) };
    inline DeleteCompliancePacksResponseBody::OperateCompliancePacksResult getOperateCompliancePacksResult() { DARABONBA_PTR_GET(operateCompliancePacksResult_, DeleteCompliancePacksResponseBody::OperateCompliancePacksResult) };
    inline DeleteCompliancePacksResponseBody& setOperateCompliancePacksResult(const DeleteCompliancePacksResponseBody::OperateCompliancePacksResult & operateCompliancePacksResult) { DARABONBA_PTR_SET_VALUE(operateCompliancePacksResult_, operateCompliancePacksResult) };
    inline DeleteCompliancePacksResponseBody& setOperateCompliancePacksResult(DeleteCompliancePacksResponseBody::OperateCompliancePacksResult && operateCompliancePacksResult) { DARABONBA_PTR_SET_RVALUE(operateCompliancePacksResult_, operateCompliancePacksResult) };
  ...
  protected:
    // The returned result.
    shared_ptr<DeleteCompliancePacksResponseBody::OperateCompliancePacksResult> operateCompliancePacksResult_ {};
    // The request ID.
