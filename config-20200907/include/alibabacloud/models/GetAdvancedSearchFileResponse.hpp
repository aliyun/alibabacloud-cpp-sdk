...
namespace Models
{
  ...
  public:
    ...
    inline const GetAdvancedSearchFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAdvancedSearchFileResponseBody) };
    inline GetAdvancedSearchFileResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAdvancedSearchFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAdvancedSearchFileResponseBody> body_ {};
  };
