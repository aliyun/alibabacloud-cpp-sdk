...
namespace Models
{
  ...
  public:
    ...
    inline const GetManagedRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetManagedRuleResponseBody) };
    inline GetManagedRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, GetManagedRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetManagedRuleResponseBody> body_ {};
  };
