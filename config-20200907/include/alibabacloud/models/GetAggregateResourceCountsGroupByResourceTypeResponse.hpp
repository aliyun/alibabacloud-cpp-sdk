...
namespace Models
{
  ...
  public:
    ...
    inline const GetAggregateResourceCountsGroupByResourceTypeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetAggregateResourceCountsGroupByResourceTypeResponseBody) };
    inline GetAggregateResourceCountsGroupByResourceTypeResponseBody body() { DARABONBA_PTR_GET(body_, GetAggregateResourceCountsGroupByResourceTypeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetAggregateResourceCountsGroupByResourceTypeResponseBody> body_ = nullptr;
  };
