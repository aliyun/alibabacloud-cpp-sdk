...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->complianceType_ == nullptr
        && return this->requestId_ == nullptr && return this->ruleConditionContext_ == nullptr; };
    ...
    inline string ruleConditionContext() const { DARABONBA_PTR_GET_DEFAULT(ruleConditionContext_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> ruleConditionContext_ = nullptr;
  };
