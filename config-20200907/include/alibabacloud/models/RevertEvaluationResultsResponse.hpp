...
namespace Models
{
  ...
  public:
    ...
    inline const RevertEvaluationResultsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RevertEvaluationResultsResponseBody) };
    inline RevertEvaluationResultsResponseBody getBody() { DARABONBA_PTR_GET(body_, RevertEvaluationResultsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RevertEvaluationResultsResponseBody> body_ {};
  };
