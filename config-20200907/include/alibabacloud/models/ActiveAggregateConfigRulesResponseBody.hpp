...
namespace Models
{
  ...
  public:
    ...
    inline const ActiveAggregateConfigRulesResponseBody::OperateRuleResult & getOperateRuleResult() const { DARABONBA_PTR_GET_CONST(operateRuleResult_, ActiveAggregateConfigRulesResponseBody::OperateRuleResult) };
    inline ActiveAggregateConfigRulesResponseBody::OperateRuleResult getOperateRuleResult() { DARABONBA_PTR_GET(operateRuleResult_, ActiveAggregateConfigRulesResponseBody::OperateRuleResult) };
    inline ActiveAggregateConfigRulesResponseBody& setOperateRuleResult(const ActiveAggregateConfigRulesResponseBody::OperateRuleResult & operateRuleResult) { DARABONBA_PTR_SET_VALUE(operateRuleResult_, operateRuleResult) };
    inline ActiveAggregateConfigRulesResponseBody& setOperateRuleResult(ActiveAggregateConfigRulesResponseBody::OperateRuleResult && operateRuleResult) { DARABONBA_PTR_SET_RVALUE(operateRuleResult_, operateRuleResult) };
