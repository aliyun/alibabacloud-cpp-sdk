...
namespace Models
{
  ...
  public:
    ...
    inline const ListAggregateConfigDeliveryChannelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAggregateConfigDeliveryChannelsResponseBody) };
    inline ListAggregateConfigDeliveryChannelsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAggregateConfigDeliveryChannelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAggregateConfigDeliveryChannelsResponseBody> body_ {};
  };
