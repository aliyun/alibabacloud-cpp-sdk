...
namespace Models
{
  ...
  public:
    ...
    inline const ListAggregateDiscoveredResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAggregateDiscoveredResourcesResponseBody) };
    inline ListAggregateDiscoveredResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAggregateDiscoveredResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAggregateDiscoveredResourcesResponseBody> body_ {};
  };
