  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->availabilityZone_ == nullptr && this->region_ == nullptr && this->resourceCreationTime_ == nullptr && this->resourceDeleted_ == nullptr && this->resourceId_ == nullptr
        && this->resourceName_ == nullptr && this->resourceOwnerId_ == nullptr && this->resourceStatus_ == nullptr && this->resourceType_ == nullptr && this->tags_ == nullptr
        ...
        inline DiscoveredResourceProfileList& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline const ListAggregateDiscoveredResourcesResponseBody::DiscoveredResourceProfiles & getDiscoveredResourceProfiles() const { DARABONBA_PTR_GET_CONST(discoveredResourceProfiles_, ListAggregateDiscoveredResourcesResponseBody::DiscoveredResourceProfiles) };
    inline ListAggregateDiscoveredResourcesResponseBody::DiscoveredResourceProfiles getDiscoveredResourceProfiles() { DARABONBA_PTR_GET(discoveredResourceProfiles_, ListAggregateDiscoveredResourcesResponseBody::DiscoveredResourceProfiles) };
    inline ListAggregateDiscoveredResourcesResponseBody& setDiscoveredResourceProfiles(const ListAggregateDiscoveredResourcesResponseBody::DiscoveredResourceProfiles & discoveredResourceProfiles) { DARABONBA_PTR_SET_VALUE(discoveredResourceProfiles_, discoveredResourceProfiles) };
    inline ListAggregateDiscoveredResourcesResponseBody& setDiscoveredResourceProfiles(ListAggregateDiscoveredResourcesResponseBody::DiscoveredResourceProfiles && discoveredResourceProfiles) { DARABONBA_PTR_SET_RVALUE(discoveredResourceProfiles_, discoveredResourceProfiles) };
