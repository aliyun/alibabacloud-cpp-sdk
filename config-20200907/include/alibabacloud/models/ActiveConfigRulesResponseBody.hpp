...
namespace Models
{
  ...
  public:
    ...
    inline const ActiveConfigRulesResponseBody::OperateRuleResult & getOperateRuleResult() const { DARABONBA_PTR_GET_CONST(operateRuleResult_, ActiveConfigRulesResponseBody::OperateRuleResult) };
    inline ActiveConfigRulesResponseBody::OperateRuleResult getOperateRuleResult() { DARABONBA_PTR_GET(operateRuleResult_, ActiveConfigRulesResponseBody::OperateRuleResult) };
    inline ActiveConfigRulesResponseBody& setOperateRuleResult(const ActiveConfigRulesResponseBody::OperateRuleResult & operateRuleResult) { DARABONBA_PTR_SET_VALUE(operateRuleResult_, operateRuleResult) };
    inline ActiveConfigRulesResponseBody& setOperateRuleResult(ActiveConfigRulesResponseBody::OperateRuleResult && operateRuleResult) { DARABONBA_PTR_SET_RVALUE(operateRuleResult_, operateRuleResult) };
