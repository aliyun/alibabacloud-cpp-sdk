...
#ifndef ALIBABACLOUD_MODELS_GETCONFIGRULERESPONSEBODYCONFIGRULECONFIGRULEEVALUATIONSTATUS_HPP_
#define ALIBABACLOUD_MODELS_GETCONFIGRULERESPONSEBODYCONFIGRULECONFIGRULEEVALUATIONSTATUS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus& obj) { 
    ...
    GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus() = default ;
    GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus(const GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus &) = default ;
    GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus(GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus &&) = default ;
    GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus() = default ;
    GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus& operator=(const GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus &) = default ;
    GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus& operator=(GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus &&) = default ;
    ...
    inline GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus& setFirstActivatedTimestamp(int64_t firstActivatedTimestamp) { DARABONBA_PTR_SET_VALUE(firstActivatedTimestamp_, firstActivatedTimestamp) };
    ...
    inline GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus& setFirstEvaluationStarted(bool firstEvaluationStarted) { DARABONBA_PTR_SET_VALUE(firstEvaluationStarted_, firstEvaluationStarted) };
    ...
    inline GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus& setLastErrorCode(string lastErrorCode) { DARABONBA_PTR_SET_VALUE(lastErrorCode_, lastErrorCode) };
    ...
    inline GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus& setLastErrorMessage(string lastErrorMessage) { DARABONBA_PTR_SET_VALUE(lastErrorMessage_, lastErrorMessage) };
    ...
    inline GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus& setLastFailedEvaluationTimestamp(int64_t lastFailedEvaluationTimestamp) { DARABONBA_PTR_SET_VALUE(lastFailedEvaluationTimestamp_, lastFailedEvaluationTimestamp) };
    ...
    inline GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus& setLastFailedInvocationTimestamp(int64_t lastFailedInvocationTimestamp) { DARABONBA_PTR_SET_VALUE(lastFailedInvocationTimestamp_, lastFailedInvocationTimestamp) };
    ...
    inline GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus& setLastSuccessfulEvaluationTimestamp(int64_t lastSuccessfulEvaluationTimestamp) { DARABONBA_PTR_SET_VALUE(lastSuccessfulEvaluationTimestamp_, lastSuccessfulEvaluationTimestamp) };
    ...
    inline GetConfigRuleResponseBodyConfigRuleConfigRuleEvaluationStatus& setLastSuccessfulInvocationTimestamp(int64_t lastSuccessfulInvocationTimestamp) { DARABONBA_PTR_SET_VALUE(lastSuccessfulInvocationTimestamp_, lastSuccessfulInvocationTimestamp) };
