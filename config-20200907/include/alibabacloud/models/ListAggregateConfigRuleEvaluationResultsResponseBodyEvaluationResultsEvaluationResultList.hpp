...
#ifndef ALIBABACLOUD_MODELS_LISTAGGREGATECONFIGRULEEVALUATIONRESULTSRESPONSEBODYEVALUATIONRESULTSEVALUATIONRESULTLIST_HPP_
#define ALIBABACLOUD_MODELS_LISTAGGREGATECONFIGRULEEVALUATIONRESULTSRESPONSEBODYEVALUATIONRESULTSEVALUATIONRESULTLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& obj) { 
    ...
    ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList() = default ;
    ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList(const ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList &) = default ;
    ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList(ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList &&) = default ;
    ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList() = default ;
    ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& operator=(const ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList &) = default ;
    ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& operator=(ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList &&) = default ;
    ...
    inline ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setAnnotation(string annotation) { DARABONBA_PTR_SET_VALUE(annotation_, annotation) };
    ...
    inline ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setComplianceType(string complianceType) { DARABONBA_PTR_SET_VALUE(complianceType_, complianceType) };
    ...
    inline ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setConfigRuleInvokedTimestamp(int64_t configRuleInvokedTimestamp) { DARABONBA_PTR_SET_VALUE(configRuleInvokedTimestamp_, configRuleInvokedTimestamp) };
    ...
    inline ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setEvaluationId(string evaluationId) { DARABONBA_PTR_SET_VALUE(evaluationId_, evaluationId) };
    ...
    inline const Models::ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier & evaluationResultIdentifier() const { DARABONBA_PTR_GET_CONST(evaluationResultIdentifier_, Models::ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier) };
    inline Models::ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier evaluationResultIdentifier() { DARABONBA_PTR_GET(evaluationResultIdentifier_, Models::ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier) };
    inline ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setEvaluationResultIdentifier(const Models::ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier & evaluationResultIdentifier) { DARABONBA_PTR_SET_VALUE(evaluationResultIdentifier_, evaluationResultIdentifier) };
    inline ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setEvaluationResultIdentifier(Models::ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier && evaluationResultIdentifier) { DARABONBA_PTR_SET_RVALUE(evaluationResultIdentifier_, evaluationResultIdentifier) };
    ...
    inline ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setInvokingEventMessageType(string invokingEventMessageType) { DARABONBA_PTR_SET_VALUE(invokingEventMessageType_, invokingEventMessageType) };
    ...
    inline ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setLastNonCompliantRecordTimestamp(int64_t lastNonCompliantRecordTimestamp) { DARABONBA_PTR_SET_VALUE(lastNonCompliantRecordTimestamp_, lastNonCompliantRecordTimestamp) };
    ...
    inline ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setRemediationEnabled(bool remediationEnabled) { DARABONBA_PTR_SET_VALUE(remediationEnabled_, remediationEnabled) };
    ...
    inline ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setResultRecordedTimestamp(int64_t resultRecordedTimestamp) { DARABONBA_PTR_SET_VALUE(resultRecordedTimestamp_, resultRecordedTimestamp) };
    ...
    inline ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList& setRiskLevel(int32_t riskLevel) { DARABONBA_PTR_SET_VALUE(riskLevel_, riskLevel) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ListAggregateConfigRuleEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier> evaluationResultIdentifier_ = nullptr;
