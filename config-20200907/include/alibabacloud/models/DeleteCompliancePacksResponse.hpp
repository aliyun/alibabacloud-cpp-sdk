...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCompliancePacksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCompliancePacksResponseBody) };
    inline DeleteCompliancePacksResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCompliancePacksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCompliancePacksResponseBody> body_ {};
  };
