...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountIdsScope_ == nullptr
        ...
        && return this->excludeResourceIdsScope_ == nullptr && return this->excludeTagsScope_ == nullptr && return this->folderIdsScope_ == nullptr && return this->inputParameters_ == nullptr && return this->maximumExecutionFrequency_ == nullptr
        ...
        && return this->riskLevel_ == nullptr && return this->tag_ == nullptr && return this->tagKeyLogicScope_ == nullptr && return this->tagKeyScope_ == nullptr && return this->tagValueScope_ == nullptr
    ...
    inline const vector<UpdateAggregateConfigRuleRequestExcludeTagsScope> & excludeTagsScope() const { DARABONBA_PTR_GET_CONST(excludeTagsScope_, vector<UpdateAggregateConfigRuleRequestExcludeTagsScope>) };
    inline vector<UpdateAggregateConfigRuleRequestExcludeTagsScope> excludeTagsScope() { DARABONBA_PTR_GET(excludeTagsScope_, vector<UpdateAggregateConfigRuleRequestExcludeTagsScope>) };
    inline UpdateAggregateConfigRuleRequest& setExcludeTagsScope(const vector<UpdateAggregateConfigRuleRequestExcludeTagsScope> & excludeTagsScope) { DARABONBA_PTR_SET_VALUE(excludeTagsScope_, excludeTagsScope) };
    inline UpdateAggregateConfigRuleRequest& setExcludeTagsScope(vector<UpdateAggregateConfigRuleRequestExcludeTagsScope> && excludeTagsScope) { DARABONBA_PTR_SET_RVALUE(excludeTagsScope_, excludeTagsScope) };
    ...
    inline const vector<UpdateAggregateConfigRuleRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<UpdateAggregateConfigRuleRequestTag>) };
    inline vector<UpdateAggregateConfigRuleRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<UpdateAggregateConfigRuleRequestTag>) };
    inline UpdateAggregateConfigRuleRequest& setTag(const vector<UpdateAggregateConfigRuleRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline UpdateAggregateConfigRuleRequest& setTag(vector<UpdateAggregateConfigRuleRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
    ...
    inline const vector<UpdateAggregateConfigRuleRequestTagsScope> & tagsScope() const { DARABONBA_PTR_GET_CONST(tagsScope_, vector<UpdateAggregateConfigRuleRequestTagsScope>) };
    inline vector<UpdateAggregateConfigRuleRequestTagsScope> tagsScope() { DARABONBA_PTR_GET(tagsScope_, vector<UpdateAggregateConfigRuleRequestTagsScope>) };
    inline UpdateAggregateConfigRuleRequest& setTagsScope(const vector<UpdateAggregateConfigRuleRequestTagsScope> & tagsScope) { DARABONBA_PTR_SET_VALUE(tagsScope_, tagsScope) };
    inline UpdateAggregateConfigRuleRequest& setTagsScope(vector<UpdateAggregateConfigRuleRequestTagsScope> && tagsScope) { DARABONBA_PTR_SET_RVALUE(tagsScope_, tagsScope) };
  ...
  protected:
    ...
    std::shared_ptr<vector<UpdateAggregateConfigRuleRequestExcludeTagsScope>> excludeTagsScope_ = nullptr;
    ...
    std::shared_ptr<vector<UpdateAggregateConfigRuleRequestTag>> tag_ = nullptr;
    ...
    std::shared_ptr<vector<UpdateAggregateConfigRuleRequestTagsScope>> tagsScope_ = nullptr;
  };
