...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        friend void to_json(Darabonba::Json& j, const EvaluationResultList& obj) { 
          ...
          DARABONBA_PTR_TO_JSON(LastCompliantFixedTimestamp, lastCompliantFixedTimestamp_);
        ...
        friend void from_json(const Darabonba::Json& j, EvaluationResultList& obj) { 
          ...
          DARABONBA_PTR_FROM_JSON(LastCompliantFixedTimestamp, lastCompliantFixedTimestamp_);
        ...
        && this->configRuleArn_ == nullptr && this->configRuleId_ == nullptr && this->configRuleName_ == nullptr && this->ignoreDate_ == nullptr && this->regionId_ == nullptr
        && this->resourceGroupId_ == nullptr && this->resourceId_ == nullptr && this->resourceName_ == nullptr && this->resourceOwnerId_ == nullptr && this->resourceType_ == nullptr; };
            // compliancePackId Field Functions 
            bool hasCompliancePackId() const { return this->compliancePackId_ != nullptr;};
            void deleteCompliancePackId() { this->compliancePackId_ = nullptr;};
            inline string getCompliancePackId() const { DARABONBA_PTR_GET_DEFAULT(compliancePackId_, "") };
            inline EvaluationResultQualifier& setCompliancePackId(string compliancePackId) { DARABONBA_PTR_SET_VALUE(compliancePackId_, compliancePackId) };
            ...
            inline EvaluationResultQualifier& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
            ...
            inline EvaluationResultQualifier& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
        ...
        && this->lastCompliantFixedTimestamp_ == nullptr && this->lastNonCompliantRecordTimestamp_ == nullptr && this->remediationEnabled_ == nullptr && this->resultRecordedTimestamp_ == nullptr && this->riskLevel_ == nullptr; };
        ...
        // lastCompliantFixedTimestamp Field Functions 
        bool hasLastCompliantFixedTimestamp() const { return this->lastCompliantFixedTimestamp_ != nullptr;};
        void deleteLastCompliantFixedTimestamp() { this->lastCompliantFixedTimestamp_ = nullptr;};
        inline int64_t getLastCompliantFixedTimestamp() const { DARABONBA_PTR_GET_DEFAULT(lastCompliantFixedTimestamp_, 0L) };
        inline EvaluationResultList& setLastCompliantFixedTimestamp(int64_t lastCompliantFixedTimestamp) { DARABONBA_PTR_SET_VALUE(lastCompliantFixedTimestamp_, lastCompliantFixedTimestamp) };
    ...
    inline const ListConfigRuleEvaluationResultsResponseBody::EvaluationResults & getEvaluationResults() const { DARABONBA_PTR_GET_CONST(evaluationResults_, ListConfigRuleEvaluationResultsResponseBody::EvaluationResults) };
    inline ListConfigRuleEvaluationResultsResponseBody::EvaluationResults getEvaluationResults() { DARABONBA_PTR_GET(evaluationResults_, ListConfigRuleEvaluationResultsResponseBody::EvaluationResults) };
    inline ListConfigRuleEvaluationResultsResponseBody& setEvaluationResults(const ListConfigRuleEvaluationResultsResponseBody::EvaluationResults & evaluationResults) { DARABONBA_PTR_SET_VALUE(evaluationResults_, evaluationResults) };
    inline ListConfigRuleEvaluationResultsResponseBody& setEvaluationResults(ListConfigRuleEvaluationResultsResponseBody::EvaluationResults && evaluationResults) { DARABONBA_PTR_SET_RVALUE(evaluationResults_, evaluationResults) };
  ...
  protected:
    ...
    shared_ptr<ListConfigRuleEvaluationResultsResponseBody::EvaluationResults> evaluationResults_ {};
    // The request ID.
