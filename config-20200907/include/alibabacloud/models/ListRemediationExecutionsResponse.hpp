...
namespace Models
{
  ...
  public:
    ...
    inline const ListRemediationExecutionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRemediationExecutionsResponseBody) };
    inline ListRemediationExecutionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRemediationExecutionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRemediationExecutionsResponseBody> body_ {};
  };
