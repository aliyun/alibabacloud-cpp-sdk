...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aggregatorId_ == nullptr
        && this->configRuleId_ == nullptr && this->tag_ == nullptr; };
    ...
    inline const vector<GetAggregateConfigRuleRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<GetAggregateConfigRuleRequest::Tag>) };
    inline vector<GetAggregateConfigRuleRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<GetAggregateConfigRuleRequest::Tag>) };
    inline GetAggregateConfigRuleRequest& setTag(const vector<GetAggregateConfigRuleRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline GetAggregateConfigRuleRequest& setTag(vector<GetAggregateConfigRuleRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
