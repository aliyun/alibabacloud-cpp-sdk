...
namespace Models
{
  ...
  public:
    ...
    inline const GetCompliancePackReportResponseBody::CompliancePackReport & getCompliancePackReport() const { DARABONBA_PTR_GET_CONST(compliancePackReport_, GetCompliancePackReportResponseBody::CompliancePackReport) };
    inline GetCompliancePackReportResponseBody::CompliancePackReport getCompliancePackReport() { DARABONBA_PTR_GET(compliancePackReport_, GetCompliancePackReportResponseBody::CompliancePackReport) };
    inline GetCompliancePackReportResponseBody& setCompliancePackReport(const GetCompliancePackReportResponseBody::CompliancePackReport & compliancePackReport) { DARABONBA_PTR_SET_VALUE(compliancePackReport_, compliancePackReport) };
    inline GetCompliancePackReportResponseBody& setCompliancePackReport(GetCompliancePackReportResponseBody::CompliancePackReport && compliancePackReport) { DARABONBA_PTR_SET_RVALUE(compliancePackReport_, compliancePackReport) };
  ...
  protected:
    ...
    shared_ptr<GetCompliancePackReportResponseBody::CompliancePackReport> compliancePackReport_ {};
    // The request ID.
