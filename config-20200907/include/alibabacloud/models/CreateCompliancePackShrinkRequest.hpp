...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->compliancePackName_ == nullptr && this->compliancePackTemplateId_ == nullptr && this->configRulesShrink_ == nullptr && this->defaultEnable_ == nullptr && this->description_ == nullptr
    ...
    inline const vector<CreateCompliancePackShrinkRequest::ExcludeTagsScope> & getExcludeTagsScope() const { DARABONBA_PTR_GET_CONST(excludeTagsScope_, vector<CreateCompliancePackShrinkRequest::ExcludeTagsScope>) };
    inline vector<CreateCompliancePackShrinkRequest::ExcludeTagsScope> getExcludeTagsScope() { DARABONBA_PTR_GET(excludeTagsScope_, vector<CreateCompliancePackShrinkRequest::ExcludeTagsScope>) };
    inline CreateCompliancePackShrinkRequest& setExcludeTagsScope(const vector<CreateCompliancePackShrinkRequest::ExcludeTagsScope> & excludeTagsScope) { DARABONBA_PTR_SET_VALUE(excludeTagsScope_, excludeTagsScope) };
    inline CreateCompliancePackShrinkRequest& setExcludeTagsScope(vector<CreateCompliancePackShrinkRequest::ExcludeTagsScope> && excludeTagsScope) { DARABONBA_PTR_SET_RVALUE(excludeTagsScope_, excludeTagsScope) };
    ...
    inline const vector<CreateCompliancePackShrinkRequest::TagsScope> & getTagsScope() const { DARABONBA_PTR_GET_CONST(tagsScope_, vector<CreateCompliancePackShrinkRequest::TagsScope>) };
    inline vector<CreateCompliancePackShrinkRequest::TagsScope> getTagsScope() { DARABONBA_PTR_GET(tagsScope_, vector<CreateCompliancePackShrinkRequest::TagsScope>) };
    inline CreateCompliancePackShrinkRequest& setTagsScope(const vector<CreateCompliancePackShrinkRequest::TagsScope> & tagsScope) { DARABONBA_PTR_SET_VALUE(tagsScope_, tagsScope) };
    inline CreateCompliancePackShrinkRequest& setTagsScope(vector<CreateCompliancePackShrinkRequest::TagsScope> && tagsScope) { DARABONBA_PTR_SET_RVALUE(tagsScope_, tagsScope) };
  ...
  protected:
    ...
    // ExcludeTagsScope
    shared_ptr<vector<CreateCompliancePackShrinkRequest::ExcludeTagsScope>> excludeTagsScope_ {};
    ...
    // TagsScope
    shared_ptr<vector<CreateCompliancePackShrinkRequest::TagsScope>> tagsScope_ {};
