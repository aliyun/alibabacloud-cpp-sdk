...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->compliancePackId_ == nullptr
        && return this->complianceType_ == nullptr && return this->configRuleName_ == nullptr && return this->configRuleState_ == nullptr && return this->keyword_ == nullptr && return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->resourceTypes_ == nullptr && return this->riskLevel_ == nullptr && return this->sortBy_ == nullptr && return this->tag_ == nullptr; };
    ...
    inline const vector<ListConfigRulesRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<ListConfigRulesRequestTag>) };
    inline vector<ListConfigRulesRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<ListConfigRulesRequestTag>) };
    inline ListConfigRulesRequest& setTag(const vector<ListConfigRulesRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline ListConfigRulesRequest& setTag(vector<ListConfigRulesRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListConfigRulesRequestTag>> tag_ = nullptr;
  };
