...
#ifndef ALIBABACLOUD_MODELS_GETDISCOVEREDRESOURCERESPONSEBODYDISCOVEREDRESOURCEDETAIL_HPP_
#define ALIBABACLOUD_MODELS_GETDISCOVEREDRESOURCERESPONSEBODYDISCOVEREDRESOURCEDETAIL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& obj) { 
    ...
    GetDiscoveredResourceResponseBodyDiscoveredResourceDetail() = default ;
    GetDiscoveredResourceResponseBodyDiscoveredResourceDetail(const GetDiscoveredResourceResponseBodyDiscoveredResourceDetail &) = default ;
    GetDiscoveredResourceResponseBodyDiscoveredResourceDetail(GetDiscoveredResourceResponseBodyDiscoveredResourceDetail &&) = default ;
    GetDiscoveredResourceResponseBodyDiscoveredResourceDetail(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDiscoveredResourceResponseBodyDiscoveredResourceDetail() = default ;
    GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& operator=(const GetDiscoveredResourceResponseBodyDiscoveredResourceDetail &) = default ;
    GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& operator=(GetDiscoveredResourceResponseBodyDiscoveredResourceDetail &&) = default ;
    ...
    inline GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& setAccountId(int64_t accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
    ...
    inline GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& setAvailabilityZone(string availabilityZone) { DARABONBA_PTR_SET_VALUE(availabilityZone_, availabilityZone) };
    ...
    inline GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& setComplianceType(string complianceType) { DARABONBA_PTR_SET_VALUE(complianceType_, complianceType) };
    ...
    inline GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& setConfiguration(string configuration) { DARABONBA_PTR_SET_VALUE(configuration_, configuration) };
    ...
    inline GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& setRegion(string region) { DARABONBA_PTR_SET_VALUE(region_, region) };
    ...
    inline GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& setResourceCreationTime(int64_t resourceCreationTime) { DARABONBA_PTR_SET_VALUE(resourceCreationTime_, resourceCreationTime) };
    ...
    inline GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& setResourceDeleted(int32_t resourceDeleted) { DARABONBA_PTR_SET_VALUE(resourceDeleted_, resourceDeleted) };
    ...
    inline GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& setResourceId(string resourceId) { DARABONBA_PTR_SET_VALUE(resourceId_, resourceId) };
    ...
    inline GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& setResourceName(string resourceName) { DARABONBA_PTR_SET_VALUE(resourceName_, resourceName) };
    ...
    inline GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& setResourceStatus(string resourceStatus) { DARABONBA_PTR_SET_VALUE(resourceStatus_, resourceStatus) };
    ...
    inline GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& setResourceType(string resourceType) { DARABONBA_PTR_SET_VALUE(resourceType_, resourceType) };
    ...
    inline GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& setTags(string tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    ...
    inline GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& setVSwitchId(string vSwitchId) { DARABONBA_PTR_SET_VALUE(vSwitchId_, vSwitchId) };
    ...
    inline GetDiscoveredResourceResponseBodyDiscoveredResourceDetail& setVpcId(string vpcId) { DARABONBA_PTR_SET_VALUE(vpcId_, vpcId) };
