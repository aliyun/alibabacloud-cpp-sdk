...
namespace Models
{
  ...
  public:
    ...
    inline const ListCompliancePackTemplatesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListCompliancePackTemplatesResponseBody) };
    inline ListCompliancePackTemplatesResponseBody body() { DARABONBA_PTR_GET(body_, ListCompliancePackTemplatesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListCompliancePackTemplatesResponseBody> body_ = nullptr;
  };
