...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->compliancePackTemplateId_ == nullptr
        && return this->filterType_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->resourceTypes_ == nullptr && return this->ruleRiskLevel_ == nullptr; };
    ...
    inline int32_t ruleRiskLevel() const { DARABONBA_PTR_GET_DEFAULT(ruleRiskLevel_, 0) };
  ...
  protected:
    ...
    std::shared_ptr<int32_t> ruleRiskLevel_ = nullptr;
  };
