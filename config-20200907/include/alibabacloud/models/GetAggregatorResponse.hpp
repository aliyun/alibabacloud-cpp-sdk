...
namespace Models
{
  ...
  public:
    ...
    inline const GetAggregatorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAggregatorResponseBody) };
    inline GetAggregatorResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAggregatorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAggregatorResponseBody> body_ {};
  };
