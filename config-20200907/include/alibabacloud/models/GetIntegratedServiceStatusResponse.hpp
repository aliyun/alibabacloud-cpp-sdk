...
namespace Models
{
  ...
  public:
    ...
    inline const GetIntegratedServiceStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetIntegratedServiceStatusResponseBody) };
    inline GetIntegratedServiceStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetIntegratedServiceStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetIntegratedServiceStatusResponseBody> body_ {};
  };
