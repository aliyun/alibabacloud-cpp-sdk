...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceComplianceByPackResponseBodyResourceComplianceResult & resourceComplianceResult() const { DARABONBA_PTR_GET_CONST(resourceComplianceResult_, GetResourceComplianceByPackResponseBodyResourceComplianceResult) };
    inline GetResourceComplianceByPackResponseBodyResourceComplianceResult resourceComplianceResult() { DARABONBA_PTR_GET(resourceComplianceResult_, GetResourceComplianceByPackResponseBodyResourceComplianceResult) };
    inline GetResourceComplianceByPackResponseBody& setResourceComplianceResult(const GetResourceComplianceByPackResponseBodyResourceComplianceResult & resourceComplianceResult) { DARABONBA_PTR_SET_VALUE(resourceComplianceResult_, resourceComplianceResult) };
    inline GetResourceComplianceByPackResponseBody& setResourceComplianceResult(GetResourceComplianceByPackResponseBodyResourceComplianceResult && resourceComplianceResult) { DARABONBA_PTR_SET_RVALUE(resourceComplianceResult_, resourceComplianceResult) };
  ...
  protected:
    ...
    std::shared_ptr<GetResourceComplianceByPackResponseBodyResourceComplianceResult> resourceComplianceResult_ = nullptr;
  };
