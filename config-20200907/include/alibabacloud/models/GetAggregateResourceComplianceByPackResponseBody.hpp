...
namespace Models
{
  ...
  public:
    ...
    inline const GetAggregateResourceComplianceByPackResponseBody::ResourceComplianceResult & getResourceComplianceResult() const { DARABONBA_PTR_GET_CONST(resourceComplianceResult_, GetAggregateResourceComplianceByPackResponseBody::ResourceComplianceResult) };
    inline GetAggregateResourceComplianceByPackResponseBody::ResourceComplianceResult getResourceComplianceResult() { DARABONBA_PTR_GET(resourceComplianceResult_, GetAggregateResourceComplianceByPackResponseBody::ResourceComplianceResult) };
    inline GetAggregateResourceComplianceByPackResponseBody& setResourceComplianceResult(const GetAggregateResourceComplianceByPackResponseBody::ResourceComplianceResult & resourceComplianceResult) { DARABONBA_PTR_SET_VALUE(resourceComplianceResult_, resourceComplianceResult) };
    inline GetAggregateResourceComplianceByPackResponseBody& setResourceComplianceResult(GetAggregateResourceComplianceByPackResponseBody::ResourceComplianceResult && resourceComplianceResult) { DARABONBA_PTR_SET_RVALUE(resourceComplianceResult_, resourceComplianceResult) };
