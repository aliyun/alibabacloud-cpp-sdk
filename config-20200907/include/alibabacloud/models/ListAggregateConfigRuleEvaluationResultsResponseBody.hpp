...
namespace Models
{
  ...
  public:
    ...
    inline const ListAggregateConfigRuleEvaluationResultsResponseBody::EvaluationResults & getEvaluationResults() const { DARABONBA_PTR_GET_CONST(evaluationResults_, ListAggregateConfigRuleEvaluationResultsResponseBody::EvaluationResults) };
    inline ListAggregateConfigRuleEvaluationResultsResponseBody::EvaluationResults getEvaluationResults() { DARABONBA_PTR_GET(evaluationResults_, ListAggregateConfigRuleEvaluationResultsResponseBody::EvaluationResults) };
    inline ListAggregateConfigRuleEvaluationResultsResponseBody& setEvaluationResults(const ListAggregateConfigRuleEvaluationResultsResponseBody::EvaluationResults & evaluationResults) { DARABONBA_PTR_SET_VALUE(evaluationResults_, evaluationResults) };
    inline ListAggregateConfigRuleEvaluationResultsResponseBody& setEvaluationResults(ListAggregateConfigRuleEvaluationResultsResponseBody::EvaluationResults && evaluationResults) { DARABONBA_PTR_SET_RVALUE(evaluationResults_, evaluationResults) };
