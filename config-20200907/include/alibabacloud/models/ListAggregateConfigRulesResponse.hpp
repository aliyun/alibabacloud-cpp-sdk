...
namespace Models
{
  ...
  public:
    ...
    inline const ListAggregateConfigRulesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListAggregateConfigRulesResponseBody) };
    inline ListAggregateConfigRulesResponseBody body() { DARABONBA_PTR_GET(body_, ListAggregateConfigRulesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListAggregateConfigRulesResponseBody> body_ = nullptr;
  };
