...
namespace Models
{
  ...
  public:
    ...
    inline const ListAggregateConfigRuleEvaluationResultsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAggregateConfigRuleEvaluationResultsResponseBody) };
    inline ListAggregateConfigRuleEvaluationResultsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAggregateConfigRuleEvaluationResultsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAggregateConfigRuleEvaluationResultsResponseBody> body_ {};
  };
