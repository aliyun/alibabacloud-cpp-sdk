  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->aggregatorId_ == nullptr && this->compliancePackId_ == nullptr && this->compliancePackName_ == nullptr && this->compliancePackTemplateId_ == nullptr && this->createTimestamp_ == nullptr
        && this->description_ == nullptr && this->riskLevel_ == nullptr && this->status_ == nullptr && this->tags_ == nullptr; };
        ...
        inline CompliancePacks& setAggregatorId(string aggregatorId) { DARABONBA_PTR_SET_VALUE(aggregatorId_, aggregatorId) };
    ...
    inline const ListAggregateCompliancePacksResponseBody::CompliancePacksResult & getCompliancePacksResult() const { DARABONBA_PTR_GET_CONST(compliancePacksResult_, ListAggregateCompliancePacksResponseBody::CompliancePacksResult) };
    inline ListAggregateCompliancePacksResponseBody::CompliancePacksResult getCompliancePacksResult() { DARABONBA_PTR_GET(compliancePacksResult_, ListAggregateCompliancePacksResponseBody::CompliancePacksResult) };
    inline ListAggregateCompliancePacksResponseBody& setCompliancePacksResult(const ListAggregateCompliancePacksResponseBody::CompliancePacksResult & compliancePacksResult) { DARABONBA_PTR_SET_VALUE(compliancePacksResult_, compliancePacksResult) };
    inline ListAggregateCompliancePacksResponseBody& setCompliancePacksResult(ListAggregateCompliancePacksResponseBody::CompliancePacksResult && compliancePacksResult) { DARABONBA_PTR_SET_RVALUE(compliancePacksResult_, compliancePacksResult) };
