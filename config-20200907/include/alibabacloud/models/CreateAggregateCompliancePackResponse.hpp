...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAggregateCompliancePackResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateAggregateCompliancePackResponseBody) };
    inline CreateAggregateCompliancePackResponseBody body() { DARABONBA_PTR_GET(body_, CreateAggregateCompliancePackResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateAggregateCompliancePackResponseBody> body_ = nullptr;
  };
