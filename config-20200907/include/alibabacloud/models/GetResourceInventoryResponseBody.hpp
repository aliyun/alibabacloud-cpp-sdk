...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceInventoryResponseBody::ResourceInventory & getResourceInventory() const { DARABONBA_PTR_GET_CONST(resourceInventory_, GetResourceInventoryResponseBody::ResourceInventory) };
    inline GetResourceInventoryResponseBody::ResourceInventory getResourceInventory() { DARABONBA_PTR_GET(resourceInventory_, GetResourceInventoryResponseBody::ResourceInventory) };
    inline GetResourceInventoryResponseBody& setResourceInventory(const GetResourceInventoryResponseBody::ResourceInventory & resourceInventory) { DARABONBA_PTR_SET_VALUE(resourceInventory_, resourceInventory) };
    inline GetResourceInventoryResponseBody& setResourceInventory(GetResourceInventoryResponseBody::ResourceInventory && resourceInventory) { DARABONBA_PTR_SET_RVALUE(resourceInventory_, resourceInventory) };
