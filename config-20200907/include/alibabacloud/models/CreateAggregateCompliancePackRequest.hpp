...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aggregatorId_ == nullptr
        && return this->clientToken_ == nullptr && return this->compliancePackName_ == nullptr && return this->compliancePackTemplateId_ == nullptr && return this->configRules_ == nullptr && return this->defaultEnable_ == nullptr
        ...
        && return this->regionIdsScope_ == nullptr && return this->resourceGroupIdsScope_ == nullptr && return this->resourceIdsScope_ == nullptr && return this->riskLevel_ == nullptr && return this->tag_ == nullptr
    ...
    inline const vector<CreateAggregateCompliancePackRequestConfigRules> & configRules() const { DARABONBA_PTR_GET_CONST(configRules_, vector<CreateAggregateCompliancePackRequestConfigRules>) };
    inline vector<CreateAggregateCompliancePackRequestConfigRules> configRules() { DARABONBA_PTR_GET(configRules_, vector<CreateAggregateCompliancePackRequestConfigRules>) };
    inline CreateAggregateCompliancePackRequest& setConfigRules(const vector<CreateAggregateCompliancePackRequestConfigRules> & configRules) { DARABONBA_PTR_SET_VALUE(configRules_, configRules) };
    inline CreateAggregateCompliancePackRequest& setConfigRules(vector<CreateAggregateCompliancePackRequestConfigRules> && configRules) { DARABONBA_PTR_SET_RVALUE(configRules_, configRules) };
    ...
    inline const vector<CreateAggregateCompliancePackRequestExcludeTagsScope> & excludeTagsScope() const { DARABONBA_PTR_GET_CONST(excludeTagsScope_, vector<CreateAggregateCompliancePackRequestExcludeTagsScope>) };
    inline vector<CreateAggregateCompliancePackRequestExcludeTagsScope> excludeTagsScope() { DARABONBA_PTR_GET(excludeTagsScope_, vector<CreateAggregateCompliancePackRequestExcludeTagsScope>) };
    inline CreateAggregateCompliancePackRequest& setExcludeTagsScope(const vector<CreateAggregateCompliancePackRequestExcludeTagsScope> & excludeTagsScope) { DARABONBA_PTR_SET_VALUE(excludeTagsScope_, excludeTagsScope) };
    inline CreateAggregateCompliancePackRequest& setExcludeTagsScope(vector<CreateAggregateCompliancePackRequestExcludeTagsScope> && excludeTagsScope) { DARABONBA_PTR_SET_RVALUE(excludeTagsScope_, excludeTagsScope) };
    ...
    inline const vector<CreateAggregateCompliancePackRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateAggregateCompliancePackRequestTag>) };
    inline vector<CreateAggregateCompliancePackRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<CreateAggregateCompliancePackRequestTag>) };
    inline CreateAggregateCompliancePackRequest& setTag(const vector<CreateAggregateCompliancePackRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateAggregateCompliancePackRequest& setTag(vector<CreateAggregateCompliancePackRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
    ...
    inline const vector<CreateAggregateCompliancePackRequestTagsScope> & tagsScope() const { DARABONBA_PTR_GET_CONST(tagsScope_, vector<CreateAggregateCompliancePackRequestTagsScope>) };
    inline vector<CreateAggregateCompliancePackRequestTagsScope> tagsScope() { DARABONBA_PTR_GET(tagsScope_, vector<CreateAggregateCompliancePackRequestTagsScope>) };
    inline CreateAggregateCompliancePackRequest& setTagsScope(const vector<CreateAggregateCompliancePackRequestTagsScope> & tagsScope) { DARABONBA_PTR_SET_VALUE(tagsScope_, tagsScope) };
    inline CreateAggregateCompliancePackRequest& setTagsScope(vector<CreateAggregateCompliancePackRequestTagsScope> && tagsScope) { DARABONBA_PTR_SET_RVALUE(tagsScope_, tagsScope) };
  ...
  protected:
    ...
    std::shared_ptr<vector<CreateAggregateCompliancePackRequestConfigRules>> configRules_ = nullptr;
    ...
    std::shared_ptr<vector<CreateAggregateCompliancePackRequestExcludeTagsScope>> excludeTagsScope_ = nullptr;
    ...
    std::shared_ptr<vector<CreateAggregateCompliancePackRequestTag>> tag_ = nullptr;
    ...
    // The tag scope.
    std::shared_ptr<vector<CreateAggregateCompliancePackRequestTagsScope>> tagsScope_ = nullptr;
