...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->resourceEvaluations_ == nullptr; };
    ...
    inline const vector<EvaluatePreConfigRulesResponseBodyResourceEvaluations> & resourceEvaluations() const { DARABONBA_PTR_GET_CONST(resourceEvaluations_, vector<EvaluatePreConfigRulesResponseBodyResourceEvaluations>) };
    inline vector<EvaluatePreConfigRulesResponseBodyResourceEvaluations> resourceEvaluations() { DARABONBA_PTR_GET(resourceEvaluations_, vector<EvaluatePreConfigRulesResponseBodyResourceEvaluations>) };
    inline EvaluatePreConfigRulesResponseBody& setResourceEvaluations(const vector<EvaluatePreConfigRulesResponseBodyResourceEvaluations> & resourceEvaluations) { DARABONBA_PTR_SET_VALUE(resourceEvaluations_, resourceEvaluations) };
    inline EvaluatePreConfigRulesResponseBody& setResourceEvaluations(vector<EvaluatePreConfigRulesResponseBodyResourceEvaluations> && resourceEvaluations) { DARABONBA_PTR_SET_RVALUE(resourceEvaluations_, resourceEvaluations) };
  ...
  protected:
    ...
    std::shared_ptr<vector<EvaluatePreConfigRulesResponseBodyResourceEvaluations>> resourceEvaluations_ = nullptr;
  };
