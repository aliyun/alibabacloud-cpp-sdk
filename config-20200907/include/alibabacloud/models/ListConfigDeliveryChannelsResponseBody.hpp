...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListConfigDeliveryChannelsResponseBody::DeliveryChannels> & getDeliveryChannels() const { DARABONBA_PTR_GET_CONST(deliveryChannels_, vector<ListConfigDeliveryChannelsResponseBody::DeliveryChannels>) };
    inline vector<ListConfigDeliveryChannelsResponseBody::DeliveryChannels> getDeliveryChannels() { DARABONBA_PTR_GET(deliveryChannels_, vector<ListConfigDeliveryChannelsResponseBody::DeliveryChannels>) };
    inline ListConfigDeliveryChannelsResponseBody& setDeliveryChannels(const vector<ListConfigDeliveryChannelsResponseBody::DeliveryChannels> & deliveryChannels) { DARABONBA_PTR_SET_VALUE(deliveryChannels_, deliveryChannels) };
    inline ListConfigDeliveryChannelsResponseBody& setDeliveryChannels(vector<ListConfigDeliveryChannelsResponseBody::DeliveryChannels> && deliveryChannels) { DARABONBA_PTR_SET_RVALUE(deliveryChannels_, deliveryChannels) };
  ...
  protected:
    ...
    shared_ptr<vector<ListConfigDeliveryChannelsResponseBody::DeliveryChannels>> deliveryChannels_ {};
    // The request ID.
