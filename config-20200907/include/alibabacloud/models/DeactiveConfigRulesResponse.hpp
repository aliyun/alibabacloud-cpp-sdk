...
namespace Models
{
  ...
  public:
    ...
    inline const DeactiveConfigRulesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeactiveConfigRulesResponseBody) };
    inline DeactiveConfigRulesResponseBody body() { DARABONBA_PTR_GET(body_, DeactiveConfigRulesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeactiveConfigRulesResponseBody> body_ = nullptr;
  };
