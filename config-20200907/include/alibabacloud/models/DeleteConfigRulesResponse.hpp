...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteConfigRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteConfigRulesResponseBody) };
    inline DeleteConfigRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteConfigRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteConfigRulesResponseBody> body_ {};
  };
