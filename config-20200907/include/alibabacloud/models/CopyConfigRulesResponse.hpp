...
namespace Models
{
  ...
  public:
    ...
    inline const CopyConfigRulesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CopyConfigRulesResponseBody) };
    inline CopyConfigRulesResponseBody body() { DARABONBA_PTR_GET(body_, CopyConfigRulesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CopyConfigRulesResponseBody> body_ = nullptr;
  };
