...
#ifndef ALIBABACLOUD_MODELS_LISTREMEDIATIONEXECUTIONSRESPONSEBODYREMEDIATIONEXECUTIONDATAREMEDIATIONEXECUTIONS_HPP_
#define ALIBABACLOUD_MODELS_LISTREMEDIATIONEXECUTIONSRESPONSEBODYREMEDIATIONEXECUTIONDATAREMEDIATIONEXECUTIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions& obj) { 
    ...
    ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions() = default ;
    ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions(const ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions &) = default ;
    ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions(ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions &&) = default ;
    ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions() = default ;
    ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions& operator=(const ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions &) = default ;
    ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions& operator=(ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions &&) = default ;
    ...
    inline ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions& setExecutionCreateDate(string executionCreateDate) { DARABONBA_PTR_SET_VALUE(executionCreateDate_, executionCreateDate) };
    ...
    inline ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions& setExecutionInvocationId(string executionInvocationId) { DARABONBA_PTR_SET_VALUE(executionInvocationId_, executionInvocationId) };
    ...
    inline ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions& setExecutionResourceIds(string executionResourceIds) { DARABONBA_PTR_SET_VALUE(executionResourceIds_, executionResourceIds) };
    ...
    inline ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions& setExecutionResourceType(string executionResourceType) { DARABONBA_PTR_SET_VALUE(executionResourceType_, executionResourceType) };
    ...
    inline ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions& setExecutionStatus(string executionStatus) { DARABONBA_PTR_SET_VALUE(executionStatus_, executionStatus) };
    ...
    inline ListRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions& setExecutionStatusMessage(string executionStatusMessage) { DARABONBA_PTR_SET_VALUE(executionStatusMessage_, executionStatusMessage) };
