...
namespace Models
{
  ...
  public:
    ...
    inline const EvaluatePreConfigRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EvaluatePreConfigRulesResponseBody) };
    inline EvaluatePreConfigRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, EvaluatePreConfigRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EvaluatePreConfigRulesResponseBody> body_ {};
  };
