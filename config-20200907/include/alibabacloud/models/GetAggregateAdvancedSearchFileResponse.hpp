...
namespace Models
{
  ...
  public:
    ...
    inline const GetAggregateAdvancedSearchFileResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetAggregateAdvancedSearchFileResponseBody) };
    inline GetAggregateAdvancedSearchFileResponseBody body() { DARABONBA_PTR_GET(body_, GetAggregateAdvancedSearchFileResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetAggregateAdvancedSearchFileResponseBody> body_ = nullptr;
  };
