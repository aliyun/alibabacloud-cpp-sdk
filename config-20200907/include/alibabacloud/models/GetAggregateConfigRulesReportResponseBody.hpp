  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->accountId_ == nullptr
        && this->aggregatorId_ == nullptr && this->reportCreateTimestamp_ == nullptr && this->reportId_ == nullptr && this->reportStatus_ == nullptr && this->reportUrl_ == nullptr; };
      ...
      inline ConfigRulesReport& setAggregatorId(string aggregatorId) { DARABONBA_PTR_SET_VALUE(aggregatorId_, aggregatorId) };
    ...
    inline const GetAggregateConfigRulesReportResponseBody::ConfigRulesReport & getConfigRulesReport() const { DARABONBA_PTR_GET_CONST(configRulesReport_, GetAggregateConfigRulesReportResponseBody::ConfigRulesReport) };
    inline GetAggregateConfigRulesReportResponseBody::ConfigRulesReport getConfigRulesReport() { DARABONBA_PTR_GET(configRulesReport_, GetAggregateConfigRulesReportResponseBody::ConfigRulesReport) };
    inline GetAggregateConfigRulesReportResponseBody& setConfigRulesReport(const GetAggregateConfigRulesReportResponseBody::ConfigRulesReport & configRulesReport) { DARABONBA_PTR_SET_VALUE(configRulesReport_, configRulesReport) };
    inline GetAggregateConfigRulesReportResponseBody& setConfigRulesReport(GetAggregateConfigRulesReportResponseBody::ConfigRulesReport && configRulesReport) { DARABONBA_PTR_SET_RVALUE(configRulesReport_, configRulesReport) };
