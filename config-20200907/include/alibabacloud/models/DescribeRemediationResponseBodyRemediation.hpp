...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEREMEDIATIONRESPONSEBODYREMEDIATION_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEREMEDIATIONRESPONSEBODYREMEDIATION_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeRemediationResponseBodyRemediation& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeRemediationResponseBodyRemediation& obj) { 
    ...
    DescribeRemediationResponseBodyRemediation() = default ;
    DescribeRemediationResponseBodyRemediation(const DescribeRemediationResponseBodyRemediation &) = default ;
    DescribeRemediationResponseBodyRemediation(DescribeRemediationResponseBodyRemediation &&) = default ;
    DescribeRemediationResponseBodyRemediation(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeRemediationResponseBodyRemediation() = default ;
    DescribeRemediationResponseBodyRemediation& operator=(const DescribeRemediationResponseBodyRemediation &) = default ;
    DescribeRemediationResponseBodyRemediation& operator=(DescribeRemediationResponseBodyRemediation &&) = default ;
    ...
    inline DescribeRemediationResponseBodyRemediation& setAccountId(int64_t accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
    ...
    inline DescribeRemediationResponseBodyRemediation& setConfigRuleId(string configRuleId) { DARABONBA_PTR_SET_VALUE(configRuleId_, configRuleId) };
    ...
    inline DescribeRemediationResponseBodyRemediation& setInvokeType(string invokeType) { DARABONBA_PTR_SET_VALUE(invokeType_, invokeType) };
    ...
    inline DescribeRemediationResponseBodyRemediation& setLastSuccessfulInvocationId(string lastSuccessfulInvocationId) { DARABONBA_PTR_SET_VALUE(lastSuccessfulInvocationId_, lastSuccessfulInvocationId) };
    ...
    inline DescribeRemediationResponseBodyRemediation& setLastSuccessfulInvocationTime(int64_t lastSuccessfulInvocationTime) { DARABONBA_PTR_SET_VALUE(lastSuccessfulInvocationTime_, lastSuccessfulInvocationTime) };
    ...
    inline DescribeRemediationResponseBodyRemediation& setLastSuccessfulInvocationType(string lastSuccessfulInvocationType) { DARABONBA_PTR_SET_VALUE(lastSuccessfulInvocationType_, lastSuccessfulInvocationType) };
    ...
    inline DescribeRemediationResponseBodyRemediation& setRemediationId(string remediationId) { DARABONBA_PTR_SET_VALUE(remediationId_, remediationId) };
    ...
    inline DescribeRemediationResponseBodyRemediation& setRemediationOriginParams(string remediationOriginParams) { DARABONBA_PTR_SET_VALUE(remediationOriginParams_, remediationOriginParams) };
    ...
    inline DescribeRemediationResponseBodyRemediation& setRemediationSourceType(string remediationSourceType) { DARABONBA_PTR_SET_VALUE(remediationSourceType_, remediationSourceType) };
    ...
    inline DescribeRemediationResponseBodyRemediation& setRemediationTemplateId(string remediationTemplateId) { DARABONBA_PTR_SET_VALUE(remediationTemplateId_, remediationTemplateId) };
    ...
    inline DescribeRemediationResponseBodyRemediation& setRemediationType(string remediationType) { DARABONBA_PTR_SET_VALUE(remediationType_, remediationType) };
