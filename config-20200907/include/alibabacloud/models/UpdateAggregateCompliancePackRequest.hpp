...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aggregatorId_ == nullptr
        && return this->clientToken_ == nullptr && return this->compliancePackId_ == nullptr && return this->compliancePackName_ == nullptr && return this->configRules_ == nullptr && return this->description_ == nullptr
    ...
    inline const vector<UpdateAggregateCompliancePackRequestConfigRules> & configRules() const { DARABONBA_PTR_GET_CONST(configRules_, vector<UpdateAggregateCompliancePackRequestConfigRules>) };
    inline vector<UpdateAggregateCompliancePackRequestConfigRules> configRules() { DARABONBA_PTR_GET(configRules_, vector<UpdateAggregateCompliancePackRequestConfigRules>) };
    inline UpdateAggregateCompliancePackRequest& setConfigRules(const vector<UpdateAggregateCompliancePackRequestConfigRules> & configRules) { DARABONBA_PTR_SET_VALUE(configRules_, configRules) };
    inline UpdateAggregateCompliancePackRequest& setConfigRules(vector<UpdateAggregateCompliancePackRequestConfigRules> && configRules) { DARABONBA_PTR_SET_RVALUE(configRules_, configRules) };
    ...
    inline const vector<UpdateAggregateCompliancePackRequestExcludeTagsScope> & excludeTagsScope() const { DARABONBA_PTR_GET_CONST(excludeTagsScope_, vector<UpdateAggregateCompliancePackRequestExcludeTagsScope>) };
    inline vector<UpdateAggregateCompliancePackRequestExcludeTagsScope> excludeTagsScope() { DARABONBA_PTR_GET(excludeTagsScope_, vector<UpdateAggregateCompliancePackRequestExcludeTagsScope>) };
    inline UpdateAggregateCompliancePackRequest& setExcludeTagsScope(const vector<UpdateAggregateCompliancePackRequestExcludeTagsScope> & excludeTagsScope) { DARABONBA_PTR_SET_VALUE(excludeTagsScope_, excludeTagsScope) };
    inline UpdateAggregateCompliancePackRequest& setExcludeTagsScope(vector<UpdateAggregateCompliancePackRequestExcludeTagsScope> && excludeTagsScope) { DARABONBA_PTR_SET_RVALUE(excludeTagsScope_, excludeTagsScope) };
    ...
    inline const vector<UpdateAggregateCompliancePackRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<UpdateAggregateCompliancePackRequestTag>) };
    inline vector<UpdateAggregateCompliancePackRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<UpdateAggregateCompliancePackRequestTag>) };
    inline UpdateAggregateCompliancePackRequest& setTag(const vector<UpdateAggregateCompliancePackRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline UpdateAggregateCompliancePackRequest& setTag(vector<UpdateAggregateCompliancePackRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
    ...
    inline const vector<UpdateAggregateCompliancePackRequestTagsScope> & tagsScope() const { DARABONBA_PTR_GET_CONST(tagsScope_, vector<UpdateAggregateCompliancePackRequestTagsScope>) };
    inline vector<UpdateAggregateCompliancePackRequestTagsScope> tagsScope() { DARABONBA_PTR_GET(tagsScope_, vector<UpdateAggregateCompliancePackRequestTagsScope>) };
    inline UpdateAggregateCompliancePackRequest& setTagsScope(const vector<UpdateAggregateCompliancePackRequestTagsScope> & tagsScope) { DARABONBA_PTR_SET_VALUE(tagsScope_, tagsScope) };
    inline UpdateAggregateCompliancePackRequest& setTagsScope(vector<UpdateAggregateCompliancePackRequestTagsScope> && tagsScope) { DARABONBA_PTR_SET_RVALUE(tagsScope_, tagsScope) };
  ...
  protected:
    ...
    std::shared_ptr<vector<UpdateAggregateCompliancePackRequestConfigRules>> configRules_ = nullptr;
    ...
    // ExcludeTagsScope
    std::shared_ptr<vector<UpdateAggregateCompliancePackRequestExcludeTagsScope>> excludeTagsScope_ = nullptr;
    ...
    std::shared_ptr<vector<UpdateAggregateCompliancePackRequestTag>> tag_ = nullptr;
    ...
    // TagsScope
    std::shared_ptr<vector<UpdateAggregateCompliancePackRequestTagsScope>> tagsScope_ = nullptr;
  };
