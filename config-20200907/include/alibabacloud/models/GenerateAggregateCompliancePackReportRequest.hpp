...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aggregatorId_ == nullptr
        && this->clientToken_ == nullptr && this->compliancePackId_ == nullptr && this->multiFiles_ == nullptr; };
    ...
    inline bool getMultiFiles() const { DARABONBA_PTR_GET_DEFAULT(multiFiles_, false) };
