...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceComplianceGroupByRegionResponseBody::ComplianceResult & getComplianceResult() const { DARABONBA_PTR_GET_CONST(complianceResult_, GetResourceComplianceGroupByRegionResponseBody::ComplianceResult) };
    inline GetResourceComplianceGroupByRegionResponseBody::ComplianceResult getComplianceResult() { DARABONBA_PTR_GET(complianceResult_, GetResourceComplianceGroupByRegionResponseBody::ComplianceResult) };
    inline GetResourceComplianceGroupByRegionResponseBody& setComplianceResult(const GetResourceComplianceGroupByRegionResponseBody::ComplianceResult & complianceResult) { DARABONBA_PTR_SET_VALUE(complianceResult_, complianceResult) };
    inline GetResourceComplianceGroupByRegionResponseBody& setComplianceResult(GetResourceComplianceGroupByRegionResponseBody::ComplianceResult && complianceResult) { DARABONBA_PTR_SET_RVALUE(complianceResult_, complianceResult) };
