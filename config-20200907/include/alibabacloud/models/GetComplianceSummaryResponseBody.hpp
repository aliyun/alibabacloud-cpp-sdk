...
namespace Models
{
  ...
  public:
    ...
    inline const GetComplianceSummaryResponseBody::ComplianceSummary & getComplianceSummary() const { DARABONBA_PTR_GET_CONST(complianceSummary_, GetComplianceSummaryResponseBody::ComplianceSummary) };
    inline GetComplianceSummaryResponseBody::ComplianceSummary getComplianceSummary() { DARABONBA_PTR_GET(complianceSummary_, GetComplianceSummaryResponseBody::ComplianceSummary) };
    inline GetComplianceSummaryResponseBody& setComplianceSummary(const GetComplianceSummaryResponseBody::ComplianceSummary & complianceSummary) { DARABONBA_PTR_SET_VALUE(complianceSummary_, complianceSummary) };
    inline GetComplianceSummaryResponseBody& setComplianceSummary(GetComplianceSummaryResponseBody::ComplianceSummary && complianceSummary) { DARABONBA_PTR_SET_RVALUE(complianceSummary_, complianceSummary) };
