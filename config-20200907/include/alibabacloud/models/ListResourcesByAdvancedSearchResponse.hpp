...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourcesByAdvancedSearchResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListResourcesByAdvancedSearchResponseBody) };
    inline ListResourcesByAdvancedSearchResponseBody body() { DARABONBA_PTR_GET(body_, ListResourcesByAdvancedSearchResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListResourcesByAdvancedSearchResponseBody> body_ = nullptr;
  };
