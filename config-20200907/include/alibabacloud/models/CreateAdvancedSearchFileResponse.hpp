...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAdvancedSearchFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAdvancedSearchFileResponseBody) };
    inline CreateAdvancedSearchFileResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAdvancedSearchFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAdvancedSearchFileResponseBody> body_ {};
  };
