...
#ifndef ALIBABACLOUD_MODELS_GETAGGREGATERESOURCECOMPLIANCEBYPACKRESPONSEBODYRESOURCECOMPLIANCERESULT_HPP_
#define ALIBABACLOUD_MODELS_GETAGGREGATERESOURCECOMPLIANCEBYPACKRESPONSEBODYRESOURCECOMPLIANCERESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult& obj) { 
    ...
    GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult() = default ;
    GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult(const GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult &) = default ;
    GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult(GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult &&) = default ;
    GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult() = default ;
    GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult& operator=(const GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult &) = default ;
    GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult& operator=(GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult &&) = default ;
    ...
    inline GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult& setCompliancePackId(string compliancePackId) { DARABONBA_PTR_SET_VALUE(compliancePackId_, compliancePackId) };
    ...
    inline GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult& setCompliantCount(int32_t compliantCount) { DARABONBA_PTR_SET_VALUE(compliantCount_, compliantCount) };
    ...
    inline GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult& setIgnoredCount(int32_t ignoredCount) { DARABONBA_PTR_SET_VALUE(ignoredCount_, ignoredCount) };
    ...
    inline GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult& setInsufficientDataCount(int32_t insufficientDataCount) { DARABONBA_PTR_SET_VALUE(insufficientDataCount_, insufficientDataCount) };
    ...
    inline GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult& setNonCompliantCount(int32_t nonCompliantCount) { DARABONBA_PTR_SET_VALUE(nonCompliantCount_, nonCompliantCount) };
    ...
    inline GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult& setNotApplicableCount(int32_t notApplicableCount) { DARABONBA_PTR_SET_VALUE(notApplicableCount_, notApplicableCount) };
    ...
    inline GetAggregateResourceComplianceByPackResponseBodyResourceComplianceResult& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
