...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceComplianceGroupByResourceTypeResponseBody::ComplianceResult & getComplianceResult() const { DARABONBA_PTR_GET_CONST(complianceResult_, GetResourceComplianceGroupByResourceTypeResponseBody::ComplianceResult) };
    inline GetResourceComplianceGroupByResourceTypeResponseBody::ComplianceResult getComplianceResult() { DARABONBA_PTR_GET(complianceResult_, GetResourceComplianceGroupByResourceTypeResponseBody::ComplianceResult) };
    inline GetResourceComplianceGroupByResourceTypeResponseBody& setComplianceResult(const GetResourceComplianceGroupByResourceTypeResponseBody::ComplianceResult & complianceResult) { DARABONBA_PTR_SET_VALUE(complianceResult_, complianceResult) };
    inline GetResourceComplianceGroupByResourceTypeResponseBody& setComplianceResult(GetResourceComplianceGroupByResourceTypeResponseBody::ComplianceResult && complianceResult) { DARABONBA_PTR_SET_RVALUE(complianceResult_, complianceResult) };
  ...
  protected:
    // The queried evaluation results.
    shared_ptr<GetResourceComplianceGroupByResourceTypeResponseBody::ComplianceResult> complianceResult_ {};
    // The request ID.
