...
namespace Models
{
  ...
  public:
    ...
    inline const GetConfigRulesReportResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetConfigRulesReportResponseBody) };
    inline GetConfigRulesReportResponseBody body() { DARABONBA_PTR_GET(body_, GetConfigRulesReportResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetConfigRulesReportResponseBody> body_ = nullptr;
  };
