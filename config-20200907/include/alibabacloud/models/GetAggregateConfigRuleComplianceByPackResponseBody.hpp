...
namespace Models
{
  ...
  public:
    ...
    inline const GetAggregateConfigRuleComplianceByPackResponseBody::ConfigRuleComplianceResult & getConfigRuleComplianceResult() const { DARABONBA_PTR_GET_CONST(configRuleComplianceResult_, GetAggregateConfigRuleComplianceByPackResponseBody::ConfigRuleComplianceResult) };
    inline GetAggregateConfigRuleComplianceByPackResponseBody::ConfigRuleComplianceResult getConfigRuleComplianceResult() { DARABONBA_PTR_GET(configRuleComplianceResult_, GetAggregateConfigRuleComplianceByPackResponseBody::ConfigRuleComplianceResult) };
    inline GetAggregateConfigRuleComplianceByPackResponseBody& setConfigRuleComplianceResult(const GetAggregateConfigRuleComplianceByPackResponseBody::ConfigRuleComplianceResult & configRuleComplianceResult) { DARABONBA_PTR_SET_VALUE(configRuleComplianceResult_, configRuleComplianceResult) };
    inline GetAggregateConfigRuleComplianceByPackResponseBody& setConfigRuleComplianceResult(GetAggregateConfigRuleComplianceByPackResponseBody::ConfigRuleComplianceResult && configRuleComplianceResult) { DARABONBA_PTR_SET_RVALUE(configRuleComplianceResult_, configRuleComplianceResult) };
  ...
  protected:
    ...
    shared_ptr<GetAggregateConfigRuleComplianceByPackResponseBody::ConfigRuleComplianceResult> configRuleComplianceResult_ {};
