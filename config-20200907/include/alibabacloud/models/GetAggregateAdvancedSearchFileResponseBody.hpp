...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAggregateAdvancedSearchFileResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(ResourceSearch, resourceSearch_);
    };
    friend void from_json(const Darabonba::Json& j, GetAggregateAdvancedSearchFileResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(ResourceSearch, resourceSearch_);
    };
    GetAggregateAdvancedSearchFileResponseBody() = default ;
    GetAggregateAdvancedSearchFileResponseBody(const GetAggregateAdvancedSearchFileResponseBody &) = default ;
    GetAggregateAdvancedSearchFileResponseBody(GetAggregateAdvancedSearchFileResponseBody &&) = default ;
    GetAggregateAdvancedSearchFileResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAggregateAdvancedSearchFileResponseBody() = default ;
    GetAggregateAdvancedSearchFileResponseBody& operator=(const GetAggregateAdvancedSearchFileResponseBody &) = default ;
    GetAggregateAdvancedSearchFileResponseBody& operator=(GetAggregateAdvancedSearchFileResponseBody &&) = default ;
