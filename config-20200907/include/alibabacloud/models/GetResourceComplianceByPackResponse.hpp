...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceComplianceByPackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetResourceComplianceByPackResponseBody) };
    inline GetResourceComplianceByPackResponseBody getBody() { DARABONBA_PTR_GET(body_, GetResourceComplianceByPackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetResourceComplianceByPackResponseBody> body_ {};
  };
