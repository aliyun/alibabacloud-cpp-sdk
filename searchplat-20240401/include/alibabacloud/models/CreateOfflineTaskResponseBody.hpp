...
#ifndef ALIBABACLOUD_MODELS_CREATEOFFLINETASKRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEOFFLINETASKRESPONSEBODY_HPP_
...
namespace Models
{
  class CreateOfflineTaskResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateOfflineTaskResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
      DARABONBA_PTR_TO_JSON(result, result_);
    };
    friend void from_json(const Darabonba::Json& j, CreateOfflineTaskResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
      DARABONBA_PTR_FROM_JSON(result, result_);
    };
    CreateOfflineTaskResponseBody() = default ;
    CreateOfflineTaskResponseBody(const CreateOfflineTaskResponseBody &) = default ;
    CreateOfflineTaskResponseBody(CreateOfflineTaskResponseBody &&) = default ;
    CreateOfflineTaskResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateOfflineTaskResponseBody() = default ;
    CreateOfflineTaskResponseBody& operator=(const CreateOfflineTaskResponseBody &) = default ;
    CreateOfflineTaskResponseBody& operator=(CreateOfflineTaskResponseBody &&) = default ;
    ...
    inline CreateOfflineTaskResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const CreateOfflineTaskResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, CreateOfflineTaskResponseBody::Result) };
    inline CreateOfflineTaskResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, CreateOfflineTaskResponseBody::Result) };
    inline CreateOfflineTaskResponseBody& setResult(const CreateOfflineTaskResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CreateOfflineTaskResponseBody& setResult(CreateOfflineTaskResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The response result.
    shared_ptr<CreateOfflineTaskResponseBody::Result> result_ {};
  };
