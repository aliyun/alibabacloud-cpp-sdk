...
#ifndef ALIBABACLOUD_MODELS_STOPOFFLINETASKRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_STOPOFFLINETASKRESPONSEBODY_HPP_
...
namespace Models
{
  class StopOfflineTaskResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const StopOfflineTaskResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
      DARABONBA_PTR_TO_JSON(result, result_);
    };
    friend void from_json(const Darabonba::Json& j, StopOfflineTaskResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
      DARABONBA_PTR_FROM_JSON(result, result_);
    };
    StopOfflineTaskResponseBody() = default ;
    StopOfflineTaskResponseBody(const StopOfflineTaskResponseBody &) = default ;
    StopOfflineTaskResponseBody(StopOfflineTaskResponseBody &&) = default ;
    StopOfflineTaskResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StopOfflineTaskResponseBody() = default ;
    StopOfflineTaskResponseBody& operator=(const StopOfflineTaskResponseBody &) = default ;
    StopOfflineTaskResponseBody& operator=(StopOfflineTaskResponseBody &&) = default ;
    ...
    inline StopOfflineTaskResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const StopOfflineTaskResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, StopOfflineTaskResponseBody::Result) };
    inline StopOfflineTaskResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, StopOfflineTaskResponseBody::Result) };
    inline StopOfflineTaskResponseBody& setResult(const StopOfflineTaskResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline StopOfflineTaskResponseBody& setResult(StopOfflineTaskResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    shared_ptr<StopOfflineTaskResponseBody::Result> result_ {};
  };
