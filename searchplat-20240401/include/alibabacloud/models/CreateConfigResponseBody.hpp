...
namespace Models
{
  ...
  public:
    ...
    inline const CreateConfigResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, CreateConfigResponseBody::Result) };
    inline CreateConfigResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, CreateConfigResponseBody::Result) };
    inline CreateConfigResponseBody& setResult(const CreateConfigResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CreateConfigResponseBody& setResult(CreateConfigResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The result object.
    shared_ptr<CreateConfigResponseBody::Result> result_ {};
  };
