...
#ifndef ALIBABACLOUD_MODELS_STARTOFFLINETASKRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_STARTOFFLINETASKRESPONSEBODY_HPP_
...
namespace Models
{
  class StartOfflineTaskResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const StartOfflineTaskResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
      DARABONBA_PTR_TO_JSON(result, result_);
    };
    friend void from_json(const Darabonba::Json& j, StartOfflineTaskResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
      DARABONBA_PTR_FROM_JSON(result, result_);
    };
    StartOfflineTaskResponseBody() = default ;
    StartOfflineTaskResponseBody(const StartOfflineTaskResponseBody &) = default ;
    StartOfflineTaskResponseBody(StartOfflineTaskResponseBody &&) = default ;
    StartOfflineTaskResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartOfflineTaskResponseBody() = default ;
    StartOfflineTaskResponseBody& operator=(const StartOfflineTaskResponseBody &) = default ;
    StartOfflineTaskResponseBody& operator=(StartOfflineTaskResponseBody &&) = default ;
    ...
    inline StartOfflineTaskResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const StartOfflineTaskResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, StartOfflineTaskResponseBody::Result) };
    inline StartOfflineTaskResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, StartOfflineTaskResponseBody::Result) };
    inline StartOfflineTaskResponseBody& setResult(const StartOfflineTaskResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline StartOfflineTaskResponseBody& setResult(StartOfflineTaskResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    shared_ptr<StartOfflineTaskResponseBody::Result> result_ {};
  };
