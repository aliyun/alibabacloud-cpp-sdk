...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const vector<Darabonba::Json> & getUsageParameters() const { DARABONBA_PTR_GET_CONST(usageParameters_, vector<Darabonba::Json>) };
      inline vector<Darabonba::Json> getUsageParameters() { DARABONBA_PTR_GET(usageParameters_, vector<Darabonba::Json>) };
      inline Result& setUsageParameters(const vector<Darabonba::Json> & usageParameters) { DARABONBA_PTR_SET_VALUE(usageParameters_, usageParameters) };
      inline Result& setUsageParameters(vector<Darabonba::Json> && usageParameters) { DARABONBA_PTR_SET_RVALUE(usageParameters_, usageParameters) };
    ...
    protected:
      ...
      // usageParameters
      shared_ptr<vector<Darabonba::Json>> usageParameters_ {};
      // The version ID.
