...
#ifndef ALIBABACLOUD_MODELS_MODIFYOFFLINETASKRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_MODIFYOFFLINETASKRESPONSEBODY_HPP_
...
namespace Models
{
  class ModifyOfflineTaskResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModifyOfflineTaskResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
      DARABONBA_PTR_TO_JSON(result, result_);
    };
    friend void from_json(const Darabonba::Json& j, ModifyOfflineTaskResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
      DARABONBA_PTR_FROM_JSON(result, result_);
    };
    ModifyOfflineTaskResponseBody() = default ;
    ModifyOfflineTaskResponseBody(const ModifyOfflineTaskResponseBody &) = default ;
    ModifyOfflineTaskResponseBody(ModifyOfflineTaskResponseBody &&) = default ;
    ModifyOfflineTaskResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyOfflineTaskResponseBody() = default ;
    ModifyOfflineTaskResponseBody& operator=(const ModifyOfflineTaskResponseBody &) = default ;
    ModifyOfflineTaskResponseBody& operator=(ModifyOfflineTaskResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline Status& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
        ...
        inline Status& setDeleteTime(string deleteTime) { DARABONBA_PTR_SET_VALUE(deleteTime_, deleteTime) };
    ...
    inline ModifyOfflineTaskResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const ModifyOfflineTaskResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, ModifyOfflineTaskResponseBody::Result) };
    inline ModifyOfflineTaskResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, ModifyOfflineTaskResponseBody::Result) };
    inline ModifyOfflineTaskResponseBody& setResult(const ModifyOfflineTaskResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ModifyOfflineTaskResponseBody& setResult(ModifyOfflineTaskResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    shared_ptr<ModifyOfflineTaskResponseBody::Result> result_ {};
  };
