...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->chargeType_ == nullptr
        && this->commodityCode_ == nullptr && this->description_ == nullptr && this->domainName_ == nullptr && this->engineType_ == nullptr && this->id_ == nullptr
    ...
    inline const CreateWorkspaceResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, CreateWorkspaceResponseBody::Result) };
    inline CreateWorkspaceResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, CreateWorkspaceResponseBody::Result) };
    inline CreateWorkspaceResponseBody& setResult(const CreateWorkspaceResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CreateWorkspaceResponseBody& setResult(CreateWorkspaceResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // Response result
    shared_ptr<CreateWorkspaceResponseBody::Result> result_ {};
  };
