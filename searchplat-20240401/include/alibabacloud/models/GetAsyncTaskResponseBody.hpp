...
namespace Models
{
  ...
  public:
    ...
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const GetAsyncTaskResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, GetAsyncTaskResponseBody::Result) };
    inline GetAsyncTaskResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, GetAsyncTaskResponseBody::Result) };
    inline GetAsyncTaskResponseBody& setResult(const GetAsyncTaskResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetAsyncTaskResponseBody& setResult(GetAsyncTaskResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The response result.
    shared_ptr<GetAsyncTaskResponseBody::Result> result_ {};
  };
