...
namespace Models
{
  ...
  public:
    ...
    inline const ListOrganizationMembersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOrganizationMembersResponseBody) };
    inline ListOrganizationMembersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOrganizationMembersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOrganizationMembersResponseBody> body_ {};
  };
