  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->apiKeyId_ == nullptr
        && this->apiKeyValue_ == nullptr && this->createdBy_ == nullptr && this->description_ == nullptr && this->gmtCreate_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline const CreateApiKeyResponseBody::ApiKey & getApiKey() const { DARABONBA_PTR_GET_CONST(apiKey_, CreateApiKeyResponseBody::ApiKey) };
    inline CreateApiKeyResponseBody::ApiKey getApiKey() { DARABONBA_PTR_GET(apiKey_, CreateApiKeyResponseBody::ApiKey) };
    inline CreateApiKeyResponseBody& setApiKey(const CreateApiKeyResponseBody::ApiKey & apiKey) { DARABONBA_PTR_SET_VALUE(apiKey_, apiKey) };
    inline CreateApiKeyResponseBody& setApiKey(CreateApiKeyResponseBody::ApiKey && apiKey) { DARABONBA_PTR_SET_RVALUE(apiKey_, apiKey) };
    ...
    inline CreateApiKeyResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline CreateApiKeyResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline CreateApiKeyResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateApiKeyResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
