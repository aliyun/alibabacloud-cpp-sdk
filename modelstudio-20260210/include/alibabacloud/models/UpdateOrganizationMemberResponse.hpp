...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateOrganizationMemberResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateOrganizationMemberResponseBody) };
    inline UpdateOrganizationMemberResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateOrganizationMemberResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateOrganizationMemberResponseBody> body_ {};
  };
