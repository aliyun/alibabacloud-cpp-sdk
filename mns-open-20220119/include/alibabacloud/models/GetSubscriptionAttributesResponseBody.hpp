...
namespace Models
{
  ...
  public:
    ...
    inline const GetSubscriptionAttributesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSubscriptionAttributesResponseBodyData) };
    inline GetSubscriptionAttributesResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSubscriptionAttributesResponseBodyData) };
    inline GetSubscriptionAttributesResponseBody& setData(const GetSubscriptionAttributesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSubscriptionAttributesResponseBody& setData(GetSubscriptionAttributesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetSubscriptionAttributesResponseBodyData> data_ = nullptr;
