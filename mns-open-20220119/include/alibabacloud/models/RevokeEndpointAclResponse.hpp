...
namespace Models
{
  ...
  public:
    ...
    inline const RevokeEndpointAclResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RevokeEndpointAclResponseBody) };
    inline RevokeEndpointAclResponseBody getBody() { DARABONBA_PTR_GET(body_, RevokeEndpointAclResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RevokeEndpointAclResponseBody> body_ {};
  };
