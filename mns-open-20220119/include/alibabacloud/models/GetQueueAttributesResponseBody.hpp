...
namespace Models
{
  ...
  public:
    ...
    inline const GetQueueAttributesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQueueAttributesResponseBodyData) };
    inline GetQueueAttributesResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQueueAttributesResponseBodyData) };
    inline GetQueueAttributesResponseBody& setData(const GetQueueAttributesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQueueAttributesResponseBody& setData(GetQueueAttributesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetQueueAttributesResponseBodyData> data_ = nullptr;
