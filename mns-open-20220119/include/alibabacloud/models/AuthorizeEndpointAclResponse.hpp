...
namespace Models
{
  ...
  public:
    ...
    inline const AuthorizeEndpointAclResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AuthorizeEndpointAclResponseBody) };
    inline AuthorizeEndpointAclResponseBody getBody() { DARABONBA_PTR_GET(body_, AuthorizeEndpointAclResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AuthorizeEndpointAclResponseBody> body_ {};
  };
