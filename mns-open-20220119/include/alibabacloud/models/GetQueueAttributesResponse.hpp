...
namespace Models
{
  ...
  public:
    ...
    inline const GetQueueAttributesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetQueueAttributesResponseBody) };
    inline GetQueueAttributesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetQueueAttributesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetQueueAttributesResponseBody> body_ {};
  };
