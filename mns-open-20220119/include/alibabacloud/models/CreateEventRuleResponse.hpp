...
namespace Models
{
  ...
  public:
    ...
    inline const CreateEventRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateEventRuleResponseBody) };
    inline CreateEventRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateEventRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateEventRuleResponseBody> body_ {};
  };
