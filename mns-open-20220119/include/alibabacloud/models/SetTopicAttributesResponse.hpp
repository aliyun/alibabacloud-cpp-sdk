...
namespace Models
{
  ...
  public:
    ...
    inline const SetTopicAttributesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetTopicAttributesResponseBody) };
    inline SetTopicAttributesResponseBody getBody() { DARABONBA_PTR_GET(body_, SetTopicAttributesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetTopicAttributesResponseBody> body_ {};
  };
