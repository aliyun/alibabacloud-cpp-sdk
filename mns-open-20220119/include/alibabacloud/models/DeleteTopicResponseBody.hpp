...
namespace Models
{
  ...
  public:
    ...
    inline DeleteTopicResponseBody& setCode(int64_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DeleteTopicResponseBody& setData(const Darabonba::Json & data) { DARABONBA_SET_VALUE(data_, data) };
    inline DeleteTopicResponseBody& setData(Darabonba::Json & data) { DARABONBA_SET_RVALUE(data_, data) };
    ...
    inline DeleteTopicResponseBody& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
