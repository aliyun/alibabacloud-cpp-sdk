...
namespace Models
{
  ...
  public:
    ...
    inline const SubscribeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubscribeResponseBody) };
    inline SubscribeResponseBody getBody() { DARABONBA_PTR_GET(body_, SubscribeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubscribeResponseBody> body_ {};
  };
