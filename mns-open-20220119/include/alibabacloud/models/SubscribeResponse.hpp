...
namespace Models
{
  ...
  public:
    ...
    inline const SubscribeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SubscribeResponseBody) };
    inline SubscribeResponseBody body() { DARABONBA_PTR_GET(body_, SubscribeResponseBody) };
    inline SubscribeResponse& setBody(const SubscribeResponseBody & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline SubscribeResponse& setBody(SubscribeResponseBody && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<SubscribeResponseBody> body_ = nullptr;
  };
