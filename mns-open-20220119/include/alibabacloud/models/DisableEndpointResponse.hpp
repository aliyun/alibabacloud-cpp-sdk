...
namespace Models
{
  ...
  public:
    ...
    inline const DisableEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableEndpointResponseBody) };
    inline DisableEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableEndpointResponseBody> body_ {};
  };
