...
#ifndef ALIBABACLOUD_MODELS_GETQUEUEATTRIBUTESRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_GETQUEUEATTRIBUTESRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetQueueAttributesResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetQueueAttributesResponseBodyData& obj) { 
    ...
    GetQueueAttributesResponseBodyData() = default ;
    GetQueueAttributesResponseBodyData(const GetQueueAttributesResponseBodyData &) = default ;
    GetQueueAttributesResponseBodyData(GetQueueAttributesResponseBodyData &&) = default ;
    GetQueueAttributesResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetQueueAttributesResponseBodyData() = default ;
    GetQueueAttributesResponseBodyData& operator=(const GetQueueAttributesResponseBodyData &) = default ;
    GetQueueAttributesResponseBodyData& operator=(GetQueueAttributesResponseBodyData &&) = default ;
    ...
    virtual bool empty() const override { return this->activeMessages_ == nullptr
        ...
        && return this->queueName_ == nullptr && return this->queueType_ == nullptr && return this->tags_ == nullptr && return this->tenantRateLimitPolicy_ == nullptr && return this->visibilityTimeout_ == nullptr; };
    ...
    inline GetQueueAttributesResponseBodyData& setActiveMessages(int64_t activeMessages) { DARABONBA_PTR_SET_VALUE(activeMessages_, activeMessages) };
    ...
    inline GetQueueAttributesResponseBodyData& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline GetQueueAttributesResponseBodyData& setDelayMessages(int64_t delayMessages) { DARABONBA_PTR_SET_VALUE(delayMessages_, delayMessages) };
    ...
    inline GetQueueAttributesResponseBodyData& setDelaySeconds(int64_t delaySeconds) { DARABONBA_PTR_SET_VALUE(delaySeconds_, delaySeconds) };
    ...
    inline const Models::GetQueueAttributesResponseBodyDataDlqPolicy & dlqPolicy() const { DARABONBA_PTR_GET_CONST(dlqPolicy_, Models::GetQueueAttributesResponseBodyDataDlqPolicy) };
    inline Models::GetQueueAttributesResponseBodyDataDlqPolicy dlqPolicy() { DARABONBA_PTR_GET(dlqPolicy_, Models::GetQueueAttributesResponseBodyDataDlqPolicy) };
    inline GetQueueAttributesResponseBodyData& setDlqPolicy(const Models::GetQueueAttributesResponseBodyDataDlqPolicy & dlqPolicy) { DARABONBA_PTR_SET_VALUE(dlqPolicy_, dlqPolicy) };
    inline GetQueueAttributesResponseBodyData& setDlqPolicy(Models::GetQueueAttributesResponseBodyDataDlqPolicy && dlqPolicy) { DARABONBA_PTR_SET_RVALUE(dlqPolicy_, dlqPolicy) };
    ...
    inline GetQueueAttributesResponseBodyData& setInactiveMessages(int64_t inactiveMessages) { DARABONBA_PTR_SET_VALUE(inactiveMessages_, inactiveMessages) };
    ...
    inline GetQueueAttributesResponseBodyData& setLastModifyTime(int64_t lastModifyTime) { DARABONBA_PTR_SET_VALUE(lastModifyTime_, lastModifyTime) };
    ...
    inline GetQueueAttributesResponseBodyData& setLoggingEnabled(bool loggingEnabled) { DARABONBA_PTR_SET_VALUE(loggingEnabled_, loggingEnabled) };
    ...
    inline GetQueueAttributesResponseBodyData& setMaximumMessageSize(int64_t maximumMessageSize) { DARABONBA_PTR_SET_VALUE(maximumMessageSize_, maximumMessageSize) };
    ...
    inline GetQueueAttributesResponseBodyData& setMessageRetentionPeriod(int64_t messageRetentionPeriod) { DARABONBA_PTR_SET_VALUE(messageRetentionPeriod_, messageRetentionPeriod) };
    ...
    inline GetQueueAttributesResponseBodyData& setPollingWaitSeconds(int64_t pollingWaitSeconds) { DARABONBA_PTR_SET_VALUE(pollingWaitSeconds_, pollingWaitSeconds) };
    ...
    inline const vector<Models::GetQueueAttributesResponseBodyDataTags> & tags() const { DARABONBA_PTR_GET_CONST(tags_, vector<Models::GetQueueAttributesResponseBodyDataTags>) };
    inline vector<Models::GetQueueAttributesResponseBodyDataTags> tags() { DARABONBA_PTR_GET(tags_, vector<Models::GetQueueAttributesResponseBodyDataTags>) };
    inline GetQueueAttributesResponseBodyData& setTags(const vector<Models::GetQueueAttributesResponseBodyDataTags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline GetQueueAttributesResponseBodyData& setTags(vector<Models::GetQueueAttributesResponseBodyDataTags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
    ...
    inline const Models::GetQueueAttributesResponseBodyDataTenantRateLimitPolicy & tenantRateLimitPolicy() const { DARABONBA_PTR_GET_CONST(tenantRateLimitPolicy_, Models::GetQueueAttributesResponseBodyDataTenantRateLimitPolicy) };
    inline Models::GetQueueAttributesResponseBodyDataTenantRateLimitPolicy tenantRateLimitPolicy() { DARABONBA_PTR_GET(tenantRateLimitPolicy_, Models::GetQueueAttributesResponseBodyDataTenantRateLimitPolicy) };
    inline GetQueueAttributesResponseBodyData& setTenantRateLimitPolicy(const Models::GetQueueAttributesResponseBodyDataTenantRateLimitPolicy & tenantRateLimitPolicy) { DARABONBA_PTR_SET_VALUE(tenantRateLimitPolicy_, tenantRateLimitPolicy) };
    inline GetQueueAttributesResponseBodyData& setTenantRateLimitPolicy(Models::GetQueueAttributesResponseBodyDataTenantRateLimitPolicy && tenantRateLimitPolicy) { DARABONBA_PTR_SET_RVALUE(tenantRateLimitPolicy_, tenantRateLimitPolicy) };
    ...
    inline GetQueueAttributesResponseBodyData& setVisibilityTimeout(int64_t visibilityTimeout) { DARABONBA_PTR_SET_VALUE(visibilityTimeout_, visibilityTimeout) };
  ...
  protected:
    ...
    std::shared_ptr<Models::GetQueueAttributesResponseBodyDataDlqPolicy> dlqPolicy_ = nullptr;
