...
namespace Models
{
  ...
  public:
    ...
    inline const ListSubscriptionByTopicResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListSubscriptionByTopicResponseBodyData) };
    inline ListSubscriptionByTopicResponseBodyData data() { DARABONBA_PTR_GET(data_, ListSubscriptionByTopicResponseBodyData) };
    inline ListSubscriptionByTopicResponseBody& setData(const ListSubscriptionByTopicResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListSubscriptionByTopicResponseBody& setData(ListSubscriptionByTopicResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<ListSubscriptionByTopicResponseBodyData> data_ = nullptr;
