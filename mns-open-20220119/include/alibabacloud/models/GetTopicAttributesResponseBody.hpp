...
namespace Models
{
  ...
  public:
    ...
    inline const GetTopicAttributesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTopicAttributesResponseBodyData) };
    inline GetTopicAttributesResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTopicAttributesResponseBodyData) };
    inline GetTopicAttributesResponseBody& setData(const GetTopicAttributesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTopicAttributesResponseBody& setData(GetTopicAttributesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetTopicAttributesResponseBodyData> data_ = nullptr;
