...
#ifndef ALIBABACLOUD_MODELS_REVOKEENDPOINTACLSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_REVOKEENDPOINTACLSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RevokeEndpointAclShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AclStrategy, aclStrategy_);
      DARABONBA_PTR_TO_JSON(CidrList, cidrListShrink_);
      DARABONBA_PTR_TO_JSON(EndpointType, endpointType_);
    };
    friend void from_json(const Darabonba::Json& j, RevokeEndpointAclShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AclStrategy, aclStrategy_);
      DARABONBA_PTR_FROM_JSON(CidrList, cidrListShrink_);
      DARABONBA_PTR_FROM_JSON(EndpointType, endpointType_);
    };
    RevokeEndpointAclShrinkRequest() = default ;
    RevokeEndpointAclShrinkRequest(const RevokeEndpointAclShrinkRequest &) = default ;
    RevokeEndpointAclShrinkRequest(RevokeEndpointAclShrinkRequest &&) = default ;
    RevokeEndpointAclShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RevokeEndpointAclShrinkRequest() = default ;
    RevokeEndpointAclShrinkRequest& operator=(const RevokeEndpointAclShrinkRequest &) = default ;
    RevokeEndpointAclShrinkRequest& operator=(RevokeEndpointAclShrinkRequest &&) = default ;
    ...
    inline RevokeEndpointAclShrinkRequest& setAclStrategy(string aclStrategy) { DARABONBA_PTR_SET_VALUE(aclStrategy_, aclStrategy) };
    ...
    inline RevokeEndpointAclShrinkRequest& setCidrListShrink(string cidrListShrink) { DARABONBA_PTR_SET_VALUE(cidrListShrink_, cidrListShrink) };
    ...
    inline RevokeEndpointAclShrinkRequest& setEndpointType(string endpointType) { DARABONBA_PTR_SET_VALUE(endpointType_, endpointType) };
