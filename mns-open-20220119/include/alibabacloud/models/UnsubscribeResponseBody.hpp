...
namespace Models
{
  ...
  public:
    ...
    inline const UnsubscribeResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UnsubscribeResponseBody::Data) };
    inline UnsubscribeResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UnsubscribeResponseBody::Data) };
    inline UnsubscribeResponseBody& setData(const UnsubscribeResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UnsubscribeResponseBody& setData(UnsubscribeResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<int64_t> code_ {};
    // The response data.
    shared_ptr<UnsubscribeResponseBody::Data> data_ {};
    // The response message.
    shared_ptr<string> message_ {};
