...
namespace Models
{
  ...
  public:
    ...
    inline const GetSubscriptionAttributesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSubscriptionAttributesResponseBody) };
    inline GetSubscriptionAttributesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSubscriptionAttributesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSubscriptionAttributesResponseBody> body_ {};
  };
