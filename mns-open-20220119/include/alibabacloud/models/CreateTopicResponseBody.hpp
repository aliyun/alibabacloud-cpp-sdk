...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTopicResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateTopicResponseBodyData) };
    inline CreateTopicResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateTopicResponseBodyData) };
    inline CreateTopicResponseBody& setData(const CreateTopicResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateTopicResponseBody& setData(CreateTopicResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<CreateTopicResponseBodyData> data_ = nullptr;
