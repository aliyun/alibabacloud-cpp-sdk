...
namespace Models
{
  ...
  public:
    ...
    void deleteCode() { this->code_ = nullptr;};
    inline int64_t getCode() const { DARABONBA_PTR_GET_DEFAULT(code_, 0L) };
    inline CreateTopicResponseBody& setCode(int64_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateTopicResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateTopicResponseBody::Data) };
    inline CreateTopicResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateTopicResponseBody::Data) };
    inline CreateTopicResponseBody& setData(const CreateTopicResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateTopicResponseBody& setData(CreateTopicResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateTopicResponseBody& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
  ...
  protected:
    ...
    shared_ptr<int64_t> code_ {};
    // The response data.
    shared_ptr<CreateTopicResponseBody::Data> data_ {};
    // The response message.
    shared_ptr<string> message_ {};
    // The request ID.
