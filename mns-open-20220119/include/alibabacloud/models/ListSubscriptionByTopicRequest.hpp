...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->endpointType_ == nullptr
        && return this->endpointValue_ == nullptr && return this->pageNum_ == nullptr && return this->pageSize_ == nullptr && return this->subscriptionName_ == nullptr && return this->topicName_ == nullptr; };
