...
namespace Models
{
  ...
  public:
    ...
    inline const CreateQueueResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateQueueResponseBody::Data) };
    inline CreateQueueResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateQueueResponseBody::Data) };
    inline CreateQueueResponseBody& setData(const CreateQueueResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateQueueResponseBody& setData(CreateQueueResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<int64_t> code_ {};
    // The response data.
    shared_ptr<CreateQueueResponseBody::Data> data_ {};
    // The response message.
    shared_ptr<string> message_ {};
    // The request ID.
