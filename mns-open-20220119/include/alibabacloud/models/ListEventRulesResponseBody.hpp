...
namespace Models
{
  ...
  public:
    ...
    inline const ListEventRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListEventRulesResponseBodyData) };
    inline ListEventRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListEventRulesResponseBodyData) };
    inline ListEventRulesResponseBody& setData(const ListEventRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListEventRulesResponseBody& setData(ListEventRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListEventRulesResponseBodyData> data_ = nullptr;
