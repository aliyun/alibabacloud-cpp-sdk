  ...
  public:
    ...
    public:
      friend void to_json(Darabonba::Json& j, const Data& obj) { 
        ...
        DARABONBA_PTR_TO_JSON(HighFrequencyBakInterval, highFrequencyBakInterval_);
        ...
        DARABONBA_PTR_TO_JSON(LogBackupRetention, logBackupRetention_);
        DARABONBA_PTR_TO_JSON(PreferredBackupDate, preferredBackupDate_);
      ...
      friend void from_json(const Darabonba::Json& j, Data& obj) { 
        ...
        DARABONBA_PTR_FROM_JSON(HighFrequencyBakInterval, highFrequencyBakInterval_);
        ...
        DARABONBA_PTR_FROM_JSON(LogBackupRetention, logBackupRetention_);
        DARABONBA_PTR_FROM_JSON(PreferredBackupDate, preferredBackupDate_);
      ...
      public:
        ...
        && this->filterType_ == nullptr && this->filterValue_ == nullptr && this->policyId_ == nullptr && this->retentionType_ == nullptr && this->retentionValue_ == nullptr
      ...
      public:
        ...
        && this->bakType_ == nullptr && this->destRegion_ == nullptr && this->destType_ == nullptr && this->dumpAction_ == nullptr && this->filterKey_ == nullptr
        && this->filterType_ == nullptr && this->filterValue_ == nullptr && this->policyId_ == nullptr && this->retentionType_ == nullptr && this->retentionValue_ == nullptr
        && this->srcRegion_ == nullptr && this->srcType_ == nullptr && this->storageClass_ == nullptr; };
        // autoCreated Field Functions 
        bool hasAutoCreated() const { return this->autoCreated_ != nullptr;};
        void deleteAutoCreated() { this->autoCreated_ = nullptr;};
        inline bool getAutoCreated() const { DARABONBA_PTR_GET_DEFAULT(autoCreated_, false) };
      ...
      virtual bool empty() const override { return this->advanceDataPolicies_ == nullptr
        && this->advanceIncPolicies_ == nullptr && this->advanceLogPolicies_ == nullptr && this->backupMethod_ == nullptr && this->backupPriority_ == nullptr && this->backupRetentionPeriod_ == nullptr
        && this->backupRetentionPolicyOnClusterDeletion_ == nullptr && this->category_ == nullptr && this->enableBackup_ == nullptr && this->enableIncBackup_ == nullptr && this->enableLogBackup_ == nullptr
        && this->highFrequencyBakInterval_ == nullptr && this->highSpaceUsageProtection_ == nullptr && this->incBackupInterval_ == nullptr && this->localLogRetentionSpace_ == nullptr && this->logBackupLocalRetentionNumber_ == nullptr
        && this->logBackupRetention_ == nullptr && this->preferredBackupDate_ == nullptr && this->preferredBackupWindow_ == nullptr && this->preferredBackupWindowBegin_ == nullptr; };
      ...
      inline Data& setBackupRetentionPeriod(int32_t backupRetentionPeriod) { DARABONBA_PTR_SET_VALUE(backupRetentionPeriod_, backupRetentionPeriod) };
      ...
      inline int32_t getEnableBackup() const { DARABONBA_PTR_GET_DEFAULT(enableBackup_, 0) };
      inline Data& setEnableBackup(int32_t enableBackup) { DARABONBA_PTR_SET_VALUE(enableBackup_, enableBackup) };
      ...
      inline int32_t getEnableIncBackup() const { DARABONBA_PTR_GET_DEFAULT(enableIncBackup_, 0) };
      inline Data& setEnableIncBackup(int32_t enableIncBackup) { DARABONBA_PTR_SET_VALUE(enableIncBackup_, enableIncBackup) };
      ...
      inline Data& setEnableLogBackup(int32_t enableLogBackup) { DARABONBA_PTR_SET_VALUE(enableLogBackup_, enableLogBackup) };


      // highFrequencyBakInterval Field Functions 
      bool hasHighFrequencyBakInterval() const { return this->highFrequencyBakInterval_ != nullptr;};
      void deleteHighFrequencyBakInterval() { this->highFrequencyBakInterval_ = nullptr;};
      inline int32_t getHighFrequencyBakInterval() const { DARABONBA_PTR_GET_DEFAULT(highFrequencyBakInterval_, 0) };
      inline Data& setHighFrequencyBakInterval(int32_t highFrequencyBakInterval) { DARABONBA_PTR_SET_VALUE(highFrequencyBakInterval_, highFrequencyBakInterval) };
      ...
      inline Data& setHighSpaceUsageProtection(string highSpaceUsageProtection) { DARABONBA_PTR_SET_VALUE(highSpaceUsageProtection_, highSpaceUsageProtection) };
      ...
      inline Data& setIncBackupInterval(int32_t incBackupInterval) { DARABONBA_PTR_SET_VALUE(incBackupInterval_, incBackupInterval) };
      ...
      inline int32_t getLocalLogRetentionSpace() const { DARABONBA_PTR_GET_DEFAULT(localLogRetentionSpace_, 0) };
      inline Data& setLocalLogRetentionSpace(int32_t localLogRetentionSpace) { DARABONBA_PTR_SET_VALUE(localLogRetentionSpace_, localLogRetentionSpace) };
      ...
      inline string getLogBackupLocalRetentionNumber() const { DARABONBA_PTR_GET_DEFAULT(logBackupLocalRetentionNumber_, "") };
      inline Data& setLogBackupLocalRetentionNumber(string logBackupLocalRetentionNumber) { DARABONBA_PTR_SET_VALUE(logBackupLocalRetentionNumber_, logBackupLocalRetentionNumber) };


      // logBackupRetention Field Functions 
      bool hasLogBackupRetention() const { return this->logBackupRetention_ != nullptr;};
      void deleteLogBackupRetention() { this->logBackupRetention_ = nullptr;};
      inline int32_t getLogBackupRetention() const { DARABONBA_PTR_GET_DEFAULT(logBackupRetention_, 0) };
      inline Data& setLogBackupRetention(int32_t logBackupRetention) { DARABONBA_PTR_SET_VALUE(logBackupRetention_, logBackupRetention) };


      // preferredBackupDate Field Functions 
      bool hasPreferredBackupDate() const { return this->preferredBackupDate_ != nullptr;};
      void deletePreferredBackupDate() { this->preferredBackupDate_ = nullptr;};
      inline string getPreferredBackupDate() const { DARABONBA_PTR_GET_DEFAULT(preferredBackupDate_, "") };
      inline Data& setPreferredBackupDate(string preferredBackupDate) { DARABONBA_PTR_SET_VALUE(preferredBackupDate_, preferredBackupDate) };
    ...
    protected:
      ...
      shared_ptr<int32_t> enableBackup_ {};
      // Indicates whether the incremental backup feature is enabled.
      shared_ptr<int32_t> enableIncBackup_ {};
      ...
      shared_ptr<int32_t> highFrequencyBakInterval_ {};
      ...
      shared_ptr<int32_t> localLogRetentionSpace_ {};
      // The number of local binary log files that are retained.
      shared_ptr<string> logBackupLocalRetentionNumber_ {};
      // The retention period of log backups.
      shared_ptr<int32_t> logBackupRetention_ {};
      ...
      shared_ptr<string> preferredBackupDate_ {};
    ...
    inline DescribeBackupPolicyResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DescribeBackupPolicyResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline DescribeBackupPolicyResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline DescribeBackupPolicyResponseBody& setSuccess(string success) { DARABONBA_PTR_SET_VALUE(success_, success) };
