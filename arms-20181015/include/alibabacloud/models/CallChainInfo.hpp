...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CallChainInfo> & getChildren() const { DARABONBA_PTR_GET_CONST(children_, vector<CallChainInfo>) };
    inline vector<CallChainInfo> getChildren() { DARABONBA_PTR_GET(children_, vector<CallChainInfo>) };
    ...
    inline bool getHaveSpan() const { DARABONBA_PTR_GET_DEFAULT(haveSpan_, false) };
    ...
    inline const map<string, Darabonba::Json> & getLogMap() const { DARABONBA_PTR_GET_CONST(logMap_, map<string, Darabonba::Json>) };
    inline map<string, Darabonba::Json> getLogMap() { DARABONBA_PTR_GET(logMap_, map<string, Darabonba::Json>) };
    ...
    inline string getRpc() const { DARABONBA_PTR_GET_DEFAULT(rpc_, "") };
    ...
    inline int64_t getSpan() const { DARABONBA_PTR_GET_DEFAULT(span_, 0L) };
    ...
    inline const map<string, string> & getTagMap() const { DARABONBA_PTR_GET_CONST(tagMap_, map<string, string>) };
    inline map<string, string> getTagMap() { DARABONBA_PTR_GET(tagMap_, map<string, string>) };
  ...
  protected:
    ...
    shared_ptr<vector<CallChainInfo>> children_ {};
    shared_ptr<bool> haveSpan_ {};
    shared_ptr<map<string, Darabonba::Json>> logMap_ {};
    shared_ptr<int64_t> logTime_ {};
    shared_ptr<string> parentSpanId_ {};
    shared_ptr<string> pid_ {};
    shared_ptr<string> regionId_ {};
    shared_ptr<string> resultCode_ {};
    shared_ptr<string> rpc_ {};
    shared_ptr<string> rpcId_ {};
    shared_ptr<int64_t> rpcType_ {};
    shared_ptr<string> serverIp_ {};
    shared_ptr<int64_t> span_ {};
    shared_ptr<string> spanId_ {};
    shared_ptr<map<string, string>> tagMap_ {};
