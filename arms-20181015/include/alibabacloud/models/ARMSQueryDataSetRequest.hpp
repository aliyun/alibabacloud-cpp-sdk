...
#ifndef ALIBABACLOUD_MODELS_ARMSQUERYDATASETREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ARMSQUERYDATASETREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ARMSQueryDataSetRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ARMSQueryDataSetRequest& obj) { 
    ...
    ARMSQueryDataSetRequest() = default ;
    ARMSQueryDataSetRequest(const ARMSQueryDataSetRequest &) = default ;
    ARMSQueryDataSetRequest(ARMSQueryDataSetRequest &&) = default ;
    ARMSQueryDataSetRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ARMSQueryDataSetRequest() = default ;
    ARMSQueryDataSetRequest& operator=(const ARMSQueryDataSetRequest &) = default ;
    ARMSQueryDataSetRequest& operator=(ARMSQueryDataSetRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->datasetId_ == nullptr
        && this->dateStr_ == nullptr && this->dimensions_ == nullptr && this->hackerUserId_ == nullptr && this->hungryMode_ == nullptr && this->intervalInSec_ == nullptr
        && this->isDrillDown_ == nullptr && this->limit_ == nullptr && this->maxTime_ == nullptr && this->measures_ == nullptr && this->minTime_ == nullptr
        && this->optionalDims_ == nullptr && this->orderByKey_ == nullptr && this->reduceTail_ == nullptr && this->requiredDims_ == nullptr && this->securityToken_ == nullptr; };
    // datasetId Field Functions 
    bool hasDatasetId() const { return this->datasetId_ != nullptr;};
    void deleteDatasetId() { this->datasetId_ = nullptr;};
    inline int64_t getDatasetId() const { DARABONBA_PTR_GET_DEFAULT(datasetId_, 0L) };
    inline ARMSQueryDataSetRequest& setDatasetId(int64_t datasetId) { DARABONBA_PTR_SET_VALUE(datasetId_, datasetId) };
    ...
    inline ARMSQueryDataSetRequest& setDateStr(string dateStr) { DARABONBA_PTR_SET_VALUE(dateStr_, dateStr) };


    // dimensions Field Functions 
    bool hasDimensions() const { return this->dimensions_ != nullptr;};
    void deleteDimensions() { this->dimensions_ = nullptr;};
    inline const vector<ARMSQueryDataSetRequest::Dimensions> & getDimensions() const { DARABONBA_PTR_GET_CONST(dimensions_, vector<ARMSQueryDataSetRequest::Dimensions>) };
    inline vector<ARMSQueryDataSetRequest::Dimensions> getDimensions() { DARABONBA_PTR_GET(dimensions_, vector<ARMSQueryDataSetRequest::Dimensions>) };
    inline ARMSQueryDataSetRequest& setDimensions(const vector<ARMSQueryDataSetRequest::Dimensions> & dimensions) { DARABONBA_PTR_SET_VALUE(dimensions_, dimensions) };
    inline ARMSQueryDataSetRequest& setDimensions(vector<ARMSQueryDataSetRequest::Dimensions> && dimensions) { DARABONBA_PTR_SET_RVALUE(dimensions_, dimensions) };
    ...
    inline ARMSQueryDataSetRequest& setHackerUserId(string hackerUserId) { DARABONBA_PTR_SET_VALUE(hackerUserId_, hackerUserId) };
    ...
    inline ARMSQueryDataSetRequest& setHungryMode(bool hungryMode) { DARABONBA_PTR_SET_VALUE(hungryMode_, hungryMode) };
    ...
    inline ARMSQueryDataSetRequest& setIntervalInSec(int32_t intervalInSec) { DARABONBA_PTR_SET_VALUE(intervalInSec_, intervalInSec) };
    ...
    inline ARMSQueryDataSetRequest& setIsDrillDown(bool isDrillDown) { DARABONBA_PTR_SET_VALUE(isDrillDown_, isDrillDown) };
    ...
    inline ARMSQueryDataSetRequest& setLimit(int32_t limit) { DARABONBA_PTR_SET_VALUE(limit_, limit) };
    ...
    inline ARMSQueryDataSetRequest& setMaxTime(int64_t maxTime) { DARABONBA_PTR_SET_VALUE(maxTime_, maxTime) };
    ...
    inline ARMSQueryDataSetRequest& setMeasures(const vector<string> & measures) { DARABONBA_PTR_SET_VALUE(measures_, measures) };
    inline ARMSQueryDataSetRequest& setMeasures(vector<string> && measures) { DARABONBA_PTR_SET_RVALUE(measures_, measures) };
    ...
    inline ARMSQueryDataSetRequest& setMinTime(int64_t minTime) { DARABONBA_PTR_SET_VALUE(minTime_, minTime) };
    ...
    inline const vector<ARMSQueryDataSetRequest::OptionalDims> & getOptionalDims() const { DARABONBA_PTR_GET_CONST(optionalDims_, vector<ARMSQueryDataSetRequest::OptionalDims>) };
    inline vector<ARMSQueryDataSetRequest::OptionalDims> getOptionalDims() { DARABONBA_PTR_GET(optionalDims_, vector<ARMSQueryDataSetRequest::OptionalDims>) };
    inline ARMSQueryDataSetRequest& setOptionalDims(const vector<ARMSQueryDataSetRequest::OptionalDims> & optionalDims) { DARABONBA_PTR_SET_VALUE(optionalDims_, optionalDims) };
    inline ARMSQueryDataSetRequest& setOptionalDims(vector<ARMSQueryDataSetRequest::OptionalDims> && optionalDims) { DARABONBA_PTR_SET_RVALUE(optionalDims_, optionalDims) };
    ...
    inline ARMSQueryDataSetRequest& setOrderByKey(string orderByKey) { DARABONBA_PTR_SET_VALUE(orderByKey_, orderByKey) };
    ...
    inline ARMSQueryDataSetRequest& setReduceTail(bool reduceTail) { DARABONBA_PTR_SET_VALUE(reduceTail_, reduceTail) };
    ...
    inline const vector<ARMSQueryDataSetRequest::RequiredDims> & getRequiredDims() const { DARABONBA_PTR_GET_CONST(requiredDims_, vector<ARMSQueryDataSetRequest::RequiredDims>) };
    inline vector<ARMSQueryDataSetRequest::RequiredDims> getRequiredDims() { DARABONBA_PTR_GET(requiredDims_, vector<ARMSQueryDataSetRequest::RequiredDims>) };
    inline ARMSQueryDataSetRequest& setRequiredDims(const vector<ARMSQueryDataSetRequest::RequiredDims> & requiredDims) { DARABONBA_PTR_SET_VALUE(requiredDims_, requiredDims) };
    inline ARMSQueryDataSetRequest& setRequiredDims(vector<ARMSQueryDataSetRequest::RequiredDims> && requiredDims) { DARABONBA_PTR_SET_RVALUE(requiredDims_, requiredDims) };
    ...
    inline ARMSQueryDataSetRequest& setSecurityToken(string securityToken) { DARABONBA_PTR_SET_VALUE(securityToken_, securityToken) };
  ...
  protected:
    ...
    shared_ptr<vector<ARMSQueryDataSetRequest::Dimensions>> dimensions_ {};
    ...
    shared_ptr<vector<ARMSQueryDataSetRequest::OptionalDims>> optionalDims_ {};
    shared_ptr<string> orderByKey_ {};
    shared_ptr<bool> reduceTail_ {};
    shared_ptr<vector<ARMSQueryDataSetRequest::RequiredDims>> requiredDims_ {};
