...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dashboardAmount_ == nullptr
    ...
    inline int32_t getDashboardAmount() const { DARABONBA_PTR_GET_DEFAULT(dashboardAmount_, 0) };
    ...
    inline int32_t getDataSourceAmount() const { DARABONBA_PTR_GET_DEFAULT(dataSourceAmount_, 0) };
    ...
    inline int64_t getOriginal() const { DARABONBA_PTR_GET_DEFAULT(original_, 0L) };
    ...
    inline string getOriginalName() const { DARABONBA_PTR_GET_DEFAULT(originalName_, "") };
  ...
  protected:
    shared_ptr<int32_t> dashboardAmount_ {};
    shared_ptr<int32_t> dataSourceAmount_ {};
    shared_ptr<int64_t> original_ {};
    shared_ptr<string> originalName_ {};
