...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->fcConfig_ == nullptr
        && this->id_ == nullptr && this->installMsg_ == nullptr && this->installStatus_ == nullptr && this->name_ == nullptr && this->regionId_ == nullptr
        && this->securityGroupId_ == nullptr && this->userId_ == nullptr && this->vSwitchId_ == nullptr && this->vpcId_ == nullptr; };
    // fcConfig Field Functions 
    bool hasFcConfig() const { return this->fcConfig_ != nullptr;};
    void deleteFcConfig() { this->fcConfig_ = nullptr;};
    inline string getFcConfig() const { DARABONBA_PTR_GET_DEFAULT(fcConfig_, "") };
    ...
    inline string getInstallMsg() const { DARABONBA_PTR_GET_DEFAULT(installMsg_, "") };
  ...
  protected:
    shared_ptr<string> fcConfig_ {};
    shared_ptr<int64_t> id_ {};
    shared_ptr<string> installMsg_ {};
