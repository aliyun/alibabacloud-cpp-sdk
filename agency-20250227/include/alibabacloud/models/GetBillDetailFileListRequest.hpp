...
#ifndef ALIBABACLOUD_MODELS_GETBILLDETAILFILELISTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETBILLDETAILFILELISTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetBillDetailFileListRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetBillDetailFileListRequest& obj) { 
    ...
    GetBillDetailFileListRequest() = default ;
    GetBillDetailFileListRequest(const GetBillDetailFileListRequest &) = default ;
    GetBillDetailFileListRequest(GetBillDetailFileListRequest &&) = default ;
    GetBillDetailFileListRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetBillDetailFileListRequest() = default ;
    GetBillDetailFileListRequest& operator=(const GetBillDetailFileListRequest &) = default ;
    GetBillDetailFileListRequest& operator=(GetBillDetailFileListRequest &&) = default ;
    ...
    inline GetBillDetailFileListRequest& setBillMonth(string billMonth) { DARABONBA_PTR_SET_VALUE(billMonth_, billMonth) };
    ...
    inline GetBillDetailFileListRequest& setOssAccessKeyId(string ossAccessKeyId) { DARABONBA_PTR_SET_VALUE(ossAccessKeyId_, ossAccessKeyId) };
    ...
    inline GetBillDetailFileListRequest& setOssAccessKeySecret(string ossAccessKeySecret) { DARABONBA_PTR_SET_VALUE(ossAccessKeySecret_, ossAccessKeySecret) };
    ...
    inline GetBillDetailFileListRequest& setOssBucketName(string ossBucketName) { DARABONBA_PTR_SET_VALUE(ossBucketName_, ossBucketName) };
    ...
    inline GetBillDetailFileListRequest& setOssEndpoint(string ossEndpoint) { DARABONBA_PTR_SET_VALUE(ossEndpoint_, ossEndpoint) };
    ...
    inline GetBillDetailFileListRequest& setOssRegion(string ossRegion) { DARABONBA_PTR_SET_VALUE(ossRegion_, ossRegion) };
    ...
    inline GetBillDetailFileListRequest& setOssSecurityToken(string ossSecurityToken) { DARABONBA_PTR_SET_VALUE(ossSecurityToken_, ossSecurityToken) };
