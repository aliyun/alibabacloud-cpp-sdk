...
#ifndef ALIBABACLOUD_MODELS_GETSUBPARTNERORDERLISTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETSUBPARTNERORDERLISTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSubPartnerOrderListRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSubPartnerOrderListRequest& obj) { 
    ...
    GetSubPartnerOrderListRequest() = default ;
    GetSubPartnerOrderListRequest(const GetSubPartnerOrderListRequest &) = default ;
    GetSubPartnerOrderListRequest(GetSubPartnerOrderListRequest &&) = default ;
    GetSubPartnerOrderListRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSubPartnerOrderListRequest() = default ;
    GetSubPartnerOrderListRequest& operator=(const GetSubPartnerOrderListRequest &) = default ;
    GetSubPartnerOrderListRequest& operator=(GetSubPartnerOrderListRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->orderCreateAfter_ == nullptr
        ...
        && this->orderTypeList_ == nullptr && this->pageNo_ == nullptr && this->pageSize_ == nullptr && this->payAmountAfter_ == nullptr && this->payAmountBefore_ == nullptr
    ...
    inline GetSubPartnerOrderListRequest& setOrderCreateAfter(int64_t orderCreateAfter) { DARABONBA_PTR_SET_VALUE(orderCreateAfter_, orderCreateAfter) };
    ...
    inline GetSubPartnerOrderListRequest& setOrderCreateBefore(int64_t orderCreateBefore) { DARABONBA_PTR_SET_VALUE(orderCreateBefore_, orderCreateBefore) };
    ...
    inline GetSubPartnerOrderListRequest& setOrderId(int64_t orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline GetSubPartnerOrderListRequest& setOrderPayAfter(int64_t orderPayAfter) { DARABONBA_PTR_SET_VALUE(orderPayAfter_, orderPayAfter) };
    ...
    inline GetSubPartnerOrderListRequest& setOrderPayBefore(int64_t orderPayBefore) { DARABONBA_PTR_SET_VALUE(orderPayBefore_, orderPayBefore) };
    ...
    inline GetSubPartnerOrderListRequest& setOrderStatus(int64_t orderStatus) { DARABONBA_PTR_SET_VALUE(orderStatus_, orderStatus) };
    ...
    inline GetSubPartnerOrderListRequest& setOrderTypeList(const vector<string> & orderTypeList) { DARABONBA_PTR_SET_VALUE(orderTypeList_, orderTypeList) };
    inline GetSubPartnerOrderListRequest& setOrderTypeList(vector<string> && orderTypeList) { DARABONBA_PTR_SET_RVALUE(orderTypeList_, orderTypeList) };
    ...
    inline GetSubPartnerOrderListRequest& setPageNo(int32_t pageNo) { DARABONBA_PTR_SET_VALUE(pageNo_, pageNo) };
    ...
    inline GetSubPartnerOrderListRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetSubPartnerOrderListRequest& setPayAmountAfter(int64_t payAmountAfter) { DARABONBA_PTR_SET_VALUE(payAmountAfter_, payAmountAfter) };
    ...
    inline GetSubPartnerOrderListRequest& setPayAmountBefore(int64_t payAmountBefore) { DARABONBA_PTR_SET_VALUE(payAmountBefore_, payAmountBefore) };
    ...
    inline GetSubPartnerOrderListRequest& setPayType(int64_t payType) { DARABONBA_PTR_SET_VALUE(payType_, payType) };
    ...
    inline GetSubPartnerOrderListRequest& setProductCode(string productCode) { DARABONBA_PTR_SET_VALUE(productCode_, productCode) };
    ...
    inline GetSubPartnerOrderListRequest& setProductName(string productName) { DARABONBA_PTR_SET_VALUE(productName_, productName) };
    ...
    inline GetSubPartnerOrderListRequest& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline GetSubPartnerOrderListRequest& setSubPartnerName(string subPartnerName) { DARABONBA_PTR_SET_VALUE(subPartnerName_, subPartnerName) };
    ...
    inline GetSubPartnerOrderListRequest& setSubPartnerUid(int64_t subPartnerUid) { DARABONBA_PTR_SET_VALUE(subPartnerUid_, subPartnerUid) };
